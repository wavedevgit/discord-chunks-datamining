...
function k(e) {
  let {
    ...
    width: (0, h.px)(n),
    height: (0, h.px)(n)
  }, N = null == p || m ? void 0 : P(p, E, y), A = S.size * g.hs, C = R(E, n, y, v), w = null != O && (0, r.jsx)("svg", {
    width: A + I,
    height: A,
...
function U(e) {
  let {
    ...
    "aria-label": S,
    imageClassName: T
  } = e, N = n !== m.Skl.UNKNOWN ? n : null, A = (0, h.UC)(i), C = null != N ? Math.ceil((A.status * h.D6 - A.status) / 2) : 0, P = A.size + C, R = (0, u.vj)(N, o);
...
function V(e) {
  let {
    ...
    fill: $
  } = K, ee = S(K, ["avatarCutoutX", "avatarCutoutY", "avatarCutoutWidth", "avatarCutoutHeight", "avatarCutoutRadius", "fill"]), et = (0, h.px)(E), en = (0, h.UC)(E), er = en.status * h.D6, ei = en.status * h.EW, eo = null != O ? (en.status * h.D6 - en.status) / 2 : 0, ea = en.size + Math.ceil(eo), [es, el, ec] = (0, f.q_F)({
    config: {
      tension: 450,
      friction: 20,
      clamp: !0
