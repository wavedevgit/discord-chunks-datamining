...
function U(e) {
  let {
    ...
    imageClassName: A,
    ref: N
  } = e, C = n !== m.Skl.UNKNOWN ? n : null, P = (0, h.UC)(i), R = null != C ? Math.ceil((P.status * h.D6 - P.status) / 2) : 0, L = P.size + R, k = (0, u.vj)(C, o);
...
function F(e) {
  let {
    ...
    fill: $
  } = K, ee = S(K, ["avatarCutoutX", "avatarCutoutY", "avatarCutoutWidth", "avatarCutoutHeight", "avatarCutoutRadius", "fill"]), et = (0, h.px)(E), en = (0, h.UC)(E), er = en.status * h.D6, ei = en.status * h.EW, eo = null != v ? (en.status * h.D6 - en.status) / 2 : 0, ea = en.size + Math.ceil(eo), [es, el, ec] = (0, f.q_F)({
    config: {
      tension: 450,
      friction: 20,
      clamp: !0
...
let Z = i.memo(function(e) {
  ...
  }, [n, a, d, p]), null != n && null != l.current && p ? (0, r.jsx)(F, I(O({}, o), {
    status: n,
    statusColor: d,
