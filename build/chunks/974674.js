...
function k(e) {
  let {
    ...
    width: (0, h.px)(n),
    height: (0, h.px)(n)
  }, A = null == p || m ? void 0 : R(p, E, y), N = T.size * g.hs, C = P(E, n, y, O), w = null != v && (0, r.jsx)("svg", {
    width: N + I,
    height: N,
  ...
  return null != i || null != a ? (0, r.jsxs)(l.P, {
    className: o()(b.wrapper, b.pointer, _),
    style: S,
    onClick: i,
    tabIndex: f,
    onContextMenu: c,
...
function V(e) {
  let {
    ...
    fill: $
  } = K, ee = T(K, ["avatarCutoutX", "avatarCutoutY", "avatarCutoutWidth", "avatarCutoutHeight", "avatarCutoutRadius", "fill"]), et = (0, h.px)(E), en = (0, h.UC)(E), er = en.status * h.D6, ei = en.status * h.EW, ea = null != v ? (en.status * h.D6 - en.status) / 2 : 0, eo = en.size + Math.ceil(ea), [es, el, ec] = (0, _.q_F)({
    config: {
      tension: 450,
      friction: 20,
      clamp: !0
  ...
  return (0, r.jsx)(k, I(O({}, e), {
    ...
    children: (0, r.jsxs)("svg", {
      ...
      children: [(0, r.jsxs)("mask", {
        ...
        "aria-label": !1,
        position: "top",
        spacing: G(en.status, en.stroke, l, f),
        delay: P,
...
let Z = i.memo(function(e) {
  ...
  let {
    isMobile: o = !1,
    isTyping: s = !1
  } = a, l = i.useRef(n), c = i.useRef(o), d = (0, u.vj)(n, t), _ = i.useRef(d), f = i.useRef(!1), p = f.current || F(s, n, l.current, o, c.current);
  return i.useLayoutEffect(() => {
    f.current = p, l.current = n, c.current = o, _.current = d
