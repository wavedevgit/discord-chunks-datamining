...
let ec = (e, t) => {
  ...
  eg = function(e, t) {
    ...
    let {
      ...
      diversitySurrogate: y.ZP.diversitySurrogate
    })), e1 = (0, j.DV)(eU, c, l, eP), e2 = null == e1 ? 0 : e1.locked.length + e1.unlocked.length, e3 = w.d4.useSetting(), e4 = i.useMemo(() => new Set(e3), [e3]), e5 = i.useCallback(e => {
    ...
    ed(ec, eB), ef(ec, e0, eF, eD), i.useEffect(() => {
      eg || (0, S.ql)("")
    }, [eg]), i.useEffect(() => (x.default.track(Q.rMx.OPEN_POPOUT, {
      type: null != eX ? eX : "Emoji Picker",
      guild_id: eV
    }), I.kJ.resetStoreState), [eX, eV]), i.useEffect(() => () => (0, P.Kw)(P.v6.FAVORITE_EMOJI_TOOLTIP), []), i.useLayoutEffect(() => {
      var e;
      let {
        columnIndex: t,
        rowIndex: n
    ...
    if ((null == ek ? void 0 : ek.type) === H.Bg.PREMIUM) {
      let e = R.p.NONE;
      2 === M ? e = R.p.PARENT_CONTAINER : 1 === M && (e = R.p.TAB_PARENT_CONTAINER), s = (0, r.jsx)(z.Z, {
        onLearnMore: ti,
    ...
    } else(null == ek ? void 0 : ek.type) === H.Bg.ROLE_SUBSCRIPTION ? s = (0, r.jsx)(N.Z, {
      onClose: () => eM(null),
      guildId: ek.guildId,
      emojiId: ek.emojiId
    }) : eZ && !eW && (s = (0, r.jsx)(B.Z, {
      ...
      children: (0, r.jsxs)(tu, {
        ...
        children: [C ? null : tp, (0, r.jsxs)("div", {
          ...
          children: [C ? tp : null, (0, r.jsxs)("div", {
            ...
            }), eI ? null : (0, r.jsx)("div", er(et({
              className: $.emojiPickerListWrapper,
              id: q.Vr
            }, ts), {
              children: td ? (0, r.jsx)(W.Z, {
                collapsedSections: e4,
                diversitySurrogate: e0,
                emojiGrid: e9,
                emojiListRef: eB,
