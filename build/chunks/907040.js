...
let eu = (e, t) => {
  ...
  ed = e => {
    let {
      ...
      channelGuildId: l,
      isBurstReaction: d
    } = e, _ = (0, u.e7)([O.ZP], () => O.ZP.getDisambiguatedEmojiContext(l), [l]), f = i.useCallback((e, r) => {
      switch (e.type) {
        case Y.ld.CREATE_EMOJI:
          ...
          return;
        case Y.ld.EMOJI: {
          if (null != e.emoji && r.altKey) return void(_.isFavoriteEmojiWithoutFetchingLatest(e.emoji) ? (0, p.Xe)(e.emoji) : ((0, U.J1)({
            emoji: e.emoji,
            location: ei(en({}, t), {
              object: Q.qAy.EMOJI
            })
  ...
  eE = function(e, t) {
    ...
    let {
      ...
      openPopoutType: eJ,
      popoutLocation: e$
    } = eO, e0 = i.useMemo(() => ei(en({}, ez), {
      section: null != eX ? eX : Q.jXE.EMOJI_PICKER_POPOUT
    }), [ez, eX]), {
    ...
    })), e3 = (0, U.DV)(eG, c, l, eP), e4 = null == e3 ? 0 : e3.locked.length + e3.unlocked.length, e5 = D.d4.useSetting(), e6 = i.useMemo(() => new Set(e5), [e5]), e8 = i.useCallback(e => {
    ...
    e_(eu, eV), ef(eu, e2, eF, eL), i.useEffect(() => {
      eE || (0, S.ql)("")
    }, [eE]), i.useEffect(() => (M.default.track(Q.rMx.OPEN_POPOUT, en({
      type: null != eJ ? eJ : "Emoji Picker",
      guild_id: eZ,
      location: e$
    }, (0, E.v_)(c))), T.kJ.resetStoreState), [eJ, eZ, e$, c]), i.useEffect(() => () => (0, P.Kw)(P.v6.FAVORITE_EMOJI_TOOLTIP), []), i.useLayoutEffect(() => {
      var e;
      let {
        columnIndex: t,
        rowIndex: n
    ...
    } else(null == ek ? void 0 : ek.type) === Y.Bg.ROLE_SUBSCRIPTION ? s = (0, r.jsx)(C.Z, {
      onClose: () => ej(null),
      guildId: ek.guildId,
      emojiId: ek.emojiId
    }) : eH && !eK && (s = (0, r.jsx)(V.Z, {
    ...
    let tE = (0, r.jsx)(h.Z, ei(en({}, e0), {
      children: (0, r.jsxs)(t_, {
        ...
        children: [R ? null : tm, (0, r.jsxs)("div", {
          className: o()(ee.emojiPicker, eb),
          onScroll: el,
          children: [R ? tm : null, (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)(z.Z, {
              ...
              children: e => {
                ...
                if (t === d.z.EMOJI_PICKER_FAVORITE_EMOJIS_TIP) return (0, r.jsx)(Z.Z, {
