...
let eu = (e, t) => {
  ...
  eE = function(e, t) {
    ...
    let s, {
        ...
        shouldShowSoundmojiInEmojiPicker: ew = !1,
        showOnlyUnicode: eR = !1,
        showAddEmojiButton: eP = !1
      } = e,
      {
        onFocus: eD,
        onKeyDown: eL,
    ...
    })), e5 = (0, U.DV)(eB, c, l, eR), e4 = null == e5 ? 0 : e5.locked.length + e5.unlocked.length, e6 = D.d4.useSetting(), e8 = i.useMemo(() => new Set(e6), [e6]), e7 = i.useCallback(e => {
    ...
    ef(eu, eF), e_(eu, e3, eV, ex), i.useEffect(() => {
      ...
      guild_id: eH,
      location: e0
    }, (0, E.v_)(c))), T.kJ.resetStoreState), [eJ, eH, e0, c]), i.useEffect(() => () => (0, R.Kw)(R.v6.FAVORITE_EMOJI_TOOLTIP), []), i.useLayoutEffect(() => {
      var e;
      let {
        columnIndex: t,
        rowIndex: n
    ...
    if ((null == eM ? void 0 : eM.type) === Y.Bg.PREMIUM) {
      let e = P.p.NONE;
      2 === M ? e = P.p.PARENT_CONTAINER : 1 === M && (e = P.p.TAB_PARENT_CONTAINER), s = (0, r.jsx)(q.Z, {
        onLearnMore: ts,
    ...
    let tb = (0, r.jsx)(h.Z, ei(en({}, e1), {
      children: (0, r.jsxs)(t_, {
        ...
        children: [w ? null : tg, (0, r.jsxs)("div", {
          className: o()(ee.emojiPicker, eb),
          onScroll: el,
          children: [w ? tg : null, (0, r.jsxs)("div", {
