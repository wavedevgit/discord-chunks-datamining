...
let ec = (e, t) => {
      ...
      switch (e.type) {
        ...
        case H.ld.EMOJI: {
          if (null != e.emoji && r.altKey) {
            f.isFavoriteEmojiWithoutFetchingLatest(e.emoji) ? (0, _.Xe)(e.emoji) : ((0, j.J1)({
              emoji: e.emoji,
              location: er(et({}, t), {
                object: Q.qAy.EMOJI
              })
  ...
  eg = function(e, t) {
    ...
    let td = (e, t) => {
      ...
      t_ = [];
    l === J.Hz.REACTION && t_.push(d.z.SUPER_REACTIONS_NITRO_MARKETING), b.ZP.hasFavoriteEmojis(eV) || t_.push(d.z.EMOJI_PICKER_FAVORITE_EMOJIS_TIP);
