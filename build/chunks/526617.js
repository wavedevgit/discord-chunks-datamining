...
function eu(e) {
  ...
  }), [eb]), [eO, ev] = i.useState(null), eI = (0, l.e7)([C.default], () => C.default.getCurrentUser()), eT = (0, D.I5)(eI, W.p9.TIER_2), eS = (0, l.e7)([R.Z], () => {
    var e;
    return R.Z.getVoiceState(t, null != (e = null == eI ? void 0 : eI.id) ? e : Y.lds)
  }), eA = (null == eS ? void 0 : eS.selfDeaf) || (null == eS ? void 0 : eS.mute) || (null == eS ? void 0 : eS.suppress), eN = (0, b.Iu)(e => e.searchQuery), eC = null != eN && "" !== eN, eR = (0, m.Dt)(), eP = L.C.useExperiment({
    location: "SoundboardSoundGrid"
  }), {
    categories: ew,
    allSounds: eD,
    soundCounts: eL
  } = (0, B.ZP)(a, {}, e_), [ex, ek] = i.useState([]), [eM, ej] = i.useState(!1), eU = (0, B.FS)(ew, ex, eN), eG = (0, b.Iu)(e => e.isNitroLockedSectionVisible), eB = eU.filter(e => e.items.length > 0), eV = eB.findLastIndex(e => !!(0, D._O)(e.categoryInfo) && e.categoryInfo.isNitroLocked), eF = !eT && Q && -1 !== eV, eZ = A.T4.useSetting(), eH = i.useMemo(() => new Set(eZ), [eZ]), eY = null == a, eW = D.ZP.canUseCustomCallSounds(eI), eK = i.useCallback(e => {
  ...
  }, [q, eI, a, Q, eC, eN, I, P]), eq = i.useCallback((e, t) => {
    switch (e.item.type) {
      case k.vB.SOUND:
  ...
  }, [eg, ez, g]), eX = i.useCallback((e, n, i, s, l) => {
  ...
  }, [eB, Q, eT, t, q, eq, a, eY, eW, eA, eg, eu, eF, ep]), eQ = i.useCallback((e, t) => {
    if (e <= 0 || !Q) return !1;
    let n = eB[e],
      r = eB[e - 1],
  ...
  }, [eJ]), e0 = i.useCallback(e => 0 === e ? ei : eQ(e, t) ? er : en, [t, eQ]), e1 = i.useCallback(e => {
    let t = e === eB.length - 1;
  ...
  }, [eH, eK, t, eQ, Q, eT, eF]), e3 = i.useCallback((e, t) => {
    let n = t === eB.length - 1,
      i = t === eV;
  ...
  }, [eV, eF, eB.length]), e4 = i.useCallback(e => ek((0, G.cK)(e, Array.from(eD.values()).flat(), eI, a, eg)), [a, eI, eD, eg]), e5 = i.useCallback(e => {
    (0, u.jW)(e, async () => {
      let {
        default: e
  ...
  }, [eg]), e6 = i.useCallback(() => ep ? (0, r.jsx)(O.Hh, {
  ...
  }), [ep, e5]), e8 = i.useCallback(e => (0, r.jsx)(V.Z, {
    soundboardListRef: e,
    categories: ew,
  ...
  }) : null, [e$, eF, eP.alwaysStickyUpsell, eM, eG, eP.moveDefaultToBottom]), e9 = i.useCallback(e => {
    var t;
  ...
  }, [em]), tn = (0, l.e7)([N.Z], () => N.Z.getMediaSessionId());
  return (0, h.Z)({
