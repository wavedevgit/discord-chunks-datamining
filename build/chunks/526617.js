...
let ee = 16,
  ...
  es = "3",
  el = {
    [k.bg.SEARCH]: f.Z.SOUNDBOARD_SEARCH_RESULTS_SECTION,
    [k.bg.DEFAULTS]: f.Z.SOUNDBOARD_DEFAULT_SOUNDS_SECTION,
    [k.bg.GUILD]: f.Z.SOUNDBOARD_GUILD_SOUNDS_SECTION,
    [k.bg.FAVORITES]: f.Z.SOUNDBOARD_FAVORITES_SECTION,
    [k.bg.RECENTLY_HEARD]: f.Z.SOUNDBOARD_RECENTLY_HEARD_SECTION,
    [k.bg.FREQUENTLY_USED]: f.Z.SOUNDBOARD_FREQUENTLY_USED_SECTION
  };
...
function e_(e) {
  let {
  ...
  } = (0, p.ZP)(f.Z.PREMIUM_UPSELL), {
    location: eO
  } = (0, _.O)(), ev = i.useMemo(() => $(Q({}, eO), {
    ...
    allSounds: ex,
    soundCounts: ek
  } = (0, B.ZP)(a, {}, eh), [eM, ej] = i.useState([]), eU = (0, B.FS)(eL, eM, eR), eG = (0, b.Iu)(e => e.isNitroLockedSectionVisible), eB = eU.filter(e => e.items.length > 0), eV = eB.findLastIndex(e => !!(0, D._O)(e.categoryInfo) && e.categoryInfo.isNitroLocked), eF = !eA && J && -1 !== eV, eZ = A.T4.useSetting(), eH = i.useMemo(() => new Set(eZ), [eZ]), eY = null == a, eW = D.ZP.canUseCustomCallSounds(eS), eK = i.useCallback(e => {
    ...
    if (null != I && P && r) I(e, n);
      ...
      var i;
      (0, M.GN)(e, null != (i = null == a ? void 0 : a.id) ? i : Y.lds, t), eP && w.default.track(Y.rMx.SEARCH_RESULT_SELECTED, {
  ...
  }, [eB, J, eA, t, X, eq, a, eY, eW, eC, eb, e_, eF, em]), eQ = i.useCallback((e, t) => {
    if (e <= 0 || !J) return !1;
    let n = eB[e],
      r = eB[e - 1],
  ...
  }, [eJ]), e0 = i.useCallback(e => 0 === e ? ea : eQ(e, t) ? ei : er, [t, eQ]), e1 = i.useCallback(e => {
    let t = e === eB.length - 1;
    return eF && t ? 60 : eF && e === eV ? 20 : 0
  }, [eB.length, eF, eV]), e2 = i.useCallback((e, n) => {
    let i = "".concat(e.key),
    ...
    guildId: t,
    inExpressionPicker: em
  }), [eL, eF, ef, t, em]), e7 = i.useCallback(() => eF ? (0, r.jsx)(v.p, {
