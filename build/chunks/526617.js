...
function ef(e) {
  let {
  ...
  }), [eO]), [eS, eT] = i.useState(null), eA = (0, l.e7)([C.default], () => C.default.getCurrentUser()), eN = (0, D.I5)(eA, W.p9.TIER_2), eC = (0, l.e7)([R.Z], () => {
    var e;
    ...
    shownAllGuildIds: eL
  }, eh), [ek, ej] = i.useState([]), [eU, eG] = i.useState(!1), eB = (0, G.FS)(ex, ek, eP).filter(e => e.items.length > 0), eF = eB.some(e => !!(0, D._O)(e.categoryInfo) && e.categoryInfo.isNitroLocked), eV = !eN && Q && eF, eZ = A.T4.useSetting(), eH = i.useMemo(() => new Set(eZ), [eZ]), eW = null == o, eY = D.ZP.canUseCustomCallSounds(eA), eK = i.useCallback(e => {
  ...
  }, [eB, Q, eN, t, z, eq, o, eW, eY, eR, ev, ef, eV, eg, em]), eX = i.useCallback((e, t) => {
    if (e <= 0 || !Q) return !1;
    let n = eB[e],
      r = eB[e - 1],
  ...
  }, [eB, eV]), e2 = i.useCallback(e => ej((0, U.YM)(e, ex, eA, o, ev)), [o, eA, ex, ev]), e3 = i.useCallback(e => {
    (0, u.jW)(e, async () => {
      let {
        default: e
  ...
  }), [em, e3]), e6 = i.useCallback(e => (0, r.jsx)(B.Z, {
    soundboardListRef: e,
    categories: ex,
  ...
  }, []), e8 = i.useCallback(() => eV ? (0, r.jsx)(O.p, {
    showUpsell: eU,
    text: e7(),
