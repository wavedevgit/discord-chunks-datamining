...
function eu(e) {
  let {
    ...
    allSounds: eD,
    soundCounts: eL
  } = (0, B.ZP)(a, {}, e_), [ex, ek] = i.useState([]), [eM, ej] = i.useState(!1), eU = (0, B.FS)(ew, ex, eN).filter(e => e.items.length > 0), eG = eU.findLastIndex(e => !!(0, D._O)(e.categoryInfo) && e.categoryInfo.isNitroLocked), eB = !eT && Q && -1 !== eG, eV = A.T4.useSetting(), eF = i.useMemo(() => new Set(eV), [eV]), eZ = null == a, eH = D.ZP.canUseCustomCallSounds(eI), eY = i.useCallback(e => {
    eF.has(e) ? eF.delete(e) : eF.add(e), A.T4.updateSetting(Array.from(eF))
  }, [eF]), eW = i.useCallback((e, t, n) => {
  ...
  }, [eG, eB, eU.length]), e2 = i.useCallback(e => ek((0, G.cK)(e, Array.from(eD.values()).flat(), eI, a, eg)), [a, eI, eD, eg]), e3 = i.useCallback(e => {
    (0, u.jW)(e, async () => {
      let {
        default: e
  ...
  }), [ep, e3]), e5 = i.useCallback(e => (0, r.jsx)(V.Z, {
    soundboardListRef: e,
    categories: ew,
    ...
    showUpsell: eP.alwaysStickyUpsell || eM,
    text: eQ(),
    button: K.intl.string(K.t.pj0XBA),
    buttonAnalyticsObject: {
      section: Y.jXE.SOUND_PICKER_FLOATING_UPSELL
    }
  }) : null, [eQ, eB, eP.alwaysStickyUpsell, eM]), e8 = i.useCallback(e => {
    var t;
