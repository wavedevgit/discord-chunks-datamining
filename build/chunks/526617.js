...
function ef(e) {
  let {
    ...
    location: eO
  } = (0, f.O)(), ev = i.useMemo(() => J(X({}, eO), {
    section: Y.jXE.SOUNDBOARD_SOUND_PICKER
  }), [eO]), [eI, eT] = i.useState(null), eS = (0, l.e7)([C.default], () => C.default.getCurrentUser()), eA = (0, D.I5)(eS, K.p9.TIER_2), eN = (0, l.e7)([w.Z], () => {
    var e;
    return w.Z.getVoiceState(t, null != (e = null == eS ? void 0 : eS.id) ? e : Y.lds)
  }), eC = (null == eN ? void 0 : eN.selfDeaf) || (null == eN ? void 0 : eN.mute) || (null == eN ? void 0 : eN.suppress), ew = (0, b.Iu)(e => e.searchQuery), eR = null != ew && "" !== ew, eP = (0, m.Dt)(), eD = L.C.useExperiment({
    location: "SoundboardSoundGrid"
  }), {
    categories: eL,
    allSounds: ex,
    soundCounts: ek
  } = (0, B.ZP)(a, {}, eh), [ej, eM] = i.useState([]), eU = (0, B.FS)(eL, ej, ew), eG = (0, b.Iu)(e => e.isNitroLockedSectionVisible), eB = eU.filter(e => e.items.length > 0), eZ = eB.findLastIndex(e => !!(0, D._O)(e.categoryInfo) && e.categoryInfo.isNitroLocked), eF = !eA && Q && -1 !== eZ, eV = A.T4.useSetting(), eH = i.useMemo(() => new Set(eV), [eV]), eY = null == a, eW = D.ZP.canUseCustomCallSounds(eS), eK = i.useCallback(e => {
    ...
    if (null != I && R && r) I(e, n);
      ...
      var i;
      (0, j.GN)(e, null != (i = null == a ? void 0 : a.id) ? i : Y.lds, t), eR && P.default.track(Y.rMx.SEARCH_RESULT_SELECTED, {
  ...
  }, [$, eS, a, Q, eR, ew, I, R]), eq = i.useCallback((e, t) => {
    switch (e.item.type) {
      case k.vB.SOUND:
        var n;
  ...
  }, [eb, ez, g]), e$ = i.useCallback((e, n, i, s, l) => {
  ...
  }, [eB, Q, eA, t, $, eq, a, eY, eW, eC, eb, ef, eF, em]), eX = i.useCallback((e, t) => {
    if (e <= 0 || !Q) return !1;
    let n = eB[e],
      r = eB[e - 1],
  ...
  }, [eQ]), e0 = i.useCallback(e => 0 === e ? ea : eX(e, t) ? ei : er, [t, eX]), e1 = i.useCallback(e => {
    let t = e === eB.length - 1;
  ...
  }, [eH, eK, t, eX, Q, eA, eF]), e3 = i.useCallback((e, t) => {
    let n = t === eB.length - 1,
      i = t === eZ;
  ...
  }, [eZ, eF, eB.length]), e5 = i.useCallback(e => eM((0, G.cK)(e, Array.from(ex.values()).flat(), eS, a, eb)), [a, eS, ex, eb]), e4 = i.useCallback(e => {
    (0, u.jW)(e, async () => {
      let {
        default: e
  ...
  }) : null, [eJ, eF, eD.alwaysStickyUpsell, eG]), e9 = i.useCallback(e => {
    var t;
