...
n.d(t, {
  O: () => es,
  Z: () => eu
}), n(388685), n(856094), n(472816), n(794429);
var r = n(255367),
  i = n(73800),
  a = n(120356),
  o = n.n(a),
...
function el(e) {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [l && (0, r.jsx)(I.ZP, {
      ...
      className: o()(z.sectionContainer, {
        [z.sectionContainerNitroLocked]: s
      }),
      children: (0, r.jsx)(c.P3F, {
        className: o()(z.sectionHeader, {
          [z.notFirstSectionHeader]: 0 !== a
        }),
        onClick: i,
        "aria-expanded": !n,
...
function ec() {
  return (0, r.jsx)(d.Z, {
    message: K.intl.string(K.t.bgDdND)
  })
}
...
function eu(e) {
  let {
    ...
    location: eb
  } = (0, f.O)(), ey = i.useMemo(() => J(Q({}, eb), {
    section: Y.jXE.SOUNDBOARD_SOUND_PICKER
  }), [eb]), [eO, ev] = i.useState(null), eI = (0, l.e7)([C.default], () => C.default.getCurrentUser()), eS = (0, D.I5)(eI, W.p9.TIER_2), eT = (0, l.e7)([P.Z], () => {
    var e;
    return P.Z.getVoiceState(t, null != (e = null == eI ? void 0 : eI.id) ? e : Y.lds)
  }), eA = (null == eT ? void 0 : eT.selfDeaf) || (null == eT ? void 0 : eT.mute) || (null == eT ? void 0 : eT.suppress), eN = (0, b.Iu)(e => e.searchQuery), eC = null != eN && "" !== eN, eP = (0, m.Dt)(), eR = L.C.useExperiment({
    location: "SoundboardSoundGrid"
  }), {
    categories: ew,
    allSounds: eD,
    soundCounts: eL
  } = (0, B.ZP)(a, {}, e_), [ex, ek] = i.useState([]), [eM, ej] = i.useState(!1), eU = (0, B.FS)(ew, ex, eN).filter(e => e.items.length > 0), eG = eU.findLastIndex(e => !!(0, D._O)(e.categoryInfo) && e.categoryInfo.isNitroLocked), eB = !eS && X && -1 !== eG, eF = A.T4.useSetting(), eV = i.useMemo(() => new Set(eF), [eF]), eZ = null == a, eH = D.ZP.canUseCustomCallSounds(eI), eY = i.useCallback(e => {
    eV.has(e) ? eV.delete(e) : eV.add(e), A.T4.updateSetting(Array.from(eV))
  }, [eV]), eW = i.useCallback((e, t, n) => {
    if (null != I && !R) return I(e, n);
    let r = (0, M.Nq)(eI, e, a, !1);
    if (null != I && R && r) I(e, n);
    else if (!q && r && (0, M.C0)(a)) {
      var i;
      (0, M.GN)(e, null != (i = null == a ? void 0 : a.id) ? i : Y.lds, t), eC && w.default.track(Y.rMx.SEARCH_RESULT_SELECTED, {
  ...
  }, [q, eI, a, X, eC, eN, I, R]), eK = i.useCallback((e, t) => {
    switch (e.item.type) {
      case k.vB.SOUND:
  ...
  }, [eU, X, eS, t, q, eK, a, eZ, eH, eA, eg, eu, eB, ep]), eq = i.useCallback((e, t) => {
    if (e <= 0 || !X) return !1;
    let n = eU[e],
      r = eU[e - 1],
  ...
  }, [eQ]), eJ = i.useCallback(e => 0 === e ? ei : eq(e, t) ? er : en, [t, eq]), e$ = i.useCallback(e => {
    let t = e === eU.length - 1;
    return eB && e === eG ? t ? 60 : 20 : eB && t && eR.enabled ? 70 : 0
  }, [eU.length, eB, eG, eR.enabled]), e0 = i.useCallback((e, n) => {
    let i = "".concat(e.key),
  ...
  }, [eV, eY, t, eq, X, eS, eB]), e1 = i.useCallback((e, t) => {
    let n = t === eU.length - 1;
    return eB && t === eG ? (0, r.jsx)("div", {
      className: o()(z.nitroFooter, {
        [z.lastSection]: n
      })
    }) : eB && n && eR.enabled ? (0, r.jsx)("div", {
      className: z.nonNitroFooter
    }) : null
  }, [eG, eB, eU.length, eR.enabled]), e2 = i.useCallback(e => ek((0, G.cK)(e, Array.from(eD.values()).flat(), eI, a, eg)), [a, eI, eD, eg]), e3 = i.useCallback(e => {
    (0, u.jW)(e, async () => {
      let {
        default: e
  ...
  }, [eg]), e4 = i.useCallback(() => ep ? (0, r.jsx)(O.Hh, {
  ...
  }), [ep, e3]), e5 = i.useCallback(e => (0, r.jsx)(F.Z, {
    soundboardListRef: e,
    categories: ew,
  ...
  }) : null, [eX, eB, eR.enabled, eM]), e8 = i.useCallback(e => {
    var t;
    return (null == e ? void 0 : e.item.type) !== k.vB.SOUND ? null : (0, r.jsx)(V.Z, {
      closePicker: g,
      soundboardSound: null != (t = null == e ? void 0 : e.item.sound) ? t : null
    })
  }, [g]), e7 = "https://cdn.discordapp.com/assets/premium/roadblocks/soundboard_dark.png", e9 = i.useCallback(() => {
    var e;
  ...
  }, [em]), te = (0, l.e7)([N.Z], () => N.Z.getMediaSessionId());
  return (0, h.Z)({
