...
function ed() {
  return (0, r.jsx)(d.Z, {
    message: z.intl.string(z.t.bgDdND)
  })
}
...
function ef(e) {
  let {
  ...
  }), eC = (null == eN ? void 0 : eN.selfDeaf) || (null == eN ? void 0 : eN.mute) || (null == eN ? void 0 : eN.suppress), eR = (0, b.Iu)(e => e.searchQuery), eP = null != eR && "" !== eR, ew = (0, m.Dt)(), eD = L.C.useExperiment({
    location: "SoundboardSoundGrid"
  }), {
    categories: eL,
    allSounds: ex,
    soundCounts: eM
  } = (0, B.ZP)(o, {}, eh), [ek, ej] = i.useState([]), eU = (0, B.FS)(eL, ek, eR), eG = (0, b.Iu)(e => e.isNitroLockedSectionVisible), eB = eU.filter(e => e.items.length > 0), eZ = eB.findLastIndex(e => !!(0, D._O)(e.categoryInfo) && e.categoryInfo.isNitroLocked), eF = !eA && J && -1 !== eZ, eV = A.T4.useSetting(), eH = i.useMemo(() => new Set(eV), [eV]), eY = null == o, eW = D.ZP.canUseCustomCallSounds(eS), eK = i.useCallback(e => {
    ...
    if (null != I && P && r) I(e, n);
      ...
      var i;
      (0, k.GN)(e, null != (i = null == o ? void 0 : o.id) ? i : Y.lds, t), eP && w.default.track(Y.rMx.SEARCH_RESULT_SELECTED, {
