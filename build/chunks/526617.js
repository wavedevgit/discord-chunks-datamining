...
function eu(e) {
  let {
    ...
    allSounds: eD,
    soundCounts: eL
  } = (0, B.ZP)(a, {}, ef), [ex, eM] = i.useState([]), [ek, ej] = i.useState(!1), eU = (0, B.FS)(ew, ex, eN).filter(e => e.items.length > 0), eG = eU.findLastIndex(e => !!(0, D._O)(e.categoryInfo) && e.categoryInfo.isNitroLocked), eB = !eT && Q && -1 !== eG, eV = A.T4.useSetting(), eF = i.useMemo(() => new Set(eV), [eV]), eZ = null == a, eH = D.ZP.canUseCustomCallSounds(eI), eY = i.useCallback(e => {
