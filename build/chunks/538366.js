...
function g(e) {
  let {
    ...
    tagFilter: f,
    channel: x
  } = e, p = (0, c.r_)(x), b = (0, l.cD)(x), j = x.isMediaChannel(), v = i.useCallback(() => {
  ...
  }, [g]), _ = f.size > 0, C = b || p, y = !_ && p && !j, O = i.useCallback(() => y ? v() : b ? void o.S.dispatch(u.CkL.FOCUS_COMPOSER_TITLE) : (0, u.VqG)(), [v, y, b]);
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: [y ? m.intl.string(m.t.DgatTU) : m.intl.string(m.t.wOKE8P), (0, r.jsx)(a.Fbu, {
        size: "custom",
        color: "currentColor",
        width: 12
      })]
