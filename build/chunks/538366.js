...
function g(e) {
  let {
    ...
    tagFilter: f,
    channel: p
  } = e, x = (0, c.r_)(p), b = (0, l.cD)(p), j = p.isMediaChannel(), v = a.useCallback(() => {
  ...
  }, [g]), C = f.size > 0, _ = b || x, y = !C && x && !j, N = a.useCallback(() => y ? v() : b ? void o.S.dispatch(u.CkL.FOCUS_COMPOSER_TITLE) : (0, u.VqG)(), [v, y, b]);
  return (0, r.jsxs)("div", {
