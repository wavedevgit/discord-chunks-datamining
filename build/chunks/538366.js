...
function g(e) {
  let {
    ...
    tagFilter: f,
    channel: x
  } = e, p = (0, c.r_)(x), b = (0, i.cD)(x), j = x.isMediaChannel(), v = a.useCallback(() => {
  ...
  }, [g]), C = f.size > 0, _ = b || p, y = !C && p && !j, O = a.useCallback(() => y ? v() : b ? void o.S.dispatch(u.CkL.FOCUS_COMPOSER_TITLE) : (0, u.VqG)(), [v, y, b]);
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: [y ? m.intl.string(m.t.DgatTU) : m.intl.string(m.t.wOKE8P), (0, r.jsx)(l.Fbu, {
        size: "custom",
        color: "currentColor",
        width: 12
      })]
