...
class g extends r.Component {
  componentDidUpdate(A, e) {
    ...
    null !== this.props.value && this.props.value !== A.value && this.props.value !== this.state.value && v(this.props.value, this.props, this.state) && this.setState({
  ...
  render() {
    ...
    return this.state.focused ? A = {
      visibility: "hidden",
      pointerEvents: "none"
    } : o.opacity = 0, (0, n.jsx)("div", {
  ...
  constructor(...A) {
    super(...A), o(this, "inputRef", r.createRef()), o(this, "state", {
      focused: !1,
