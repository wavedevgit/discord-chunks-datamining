...
let m = 50,
  ...
  E = Chunk73800.memo(function(e) {
    ...
    return <div className={a()(_.emoji, l)} onAnimationEnd={c}><d.Z emojiId={n.id} emojiName={n.name} animated={null != (t = n.animated) && t} /></div>
  });
...
function b(e) {
  ...
  return o ? null : <div className={_.container} style={{
      top: n - m,
      left: "52%"
    }} aria-hidden={true}>{a.map(e => (0, r.jsx)(E, {
      emoji: e,
      onAnimationEnd: d
    }, e.key))}</div>
}