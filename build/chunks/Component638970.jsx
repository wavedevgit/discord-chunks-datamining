...
function M(e) {
  ...
  }), V = F && null == k && null == G && null != U, H = (0, b.yi)(), Y = (null == H ? true : H.interactionSource) === I.n_.ACTIVITY, W = i.useRef(null), K = i.useRef(null), z = i.useRef(null), q = i.useRef(null), [X, Q] = i.useReducer(L, x), {
    height: J,
    animationPhase: $
