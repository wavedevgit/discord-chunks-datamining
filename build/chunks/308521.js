...
function m(e, t) {
  ...
  var o, s, l, c = r.useRef(new f((o = function(e) {
    p && a({
...
function b(e) {
  ...
  }, [i, a, w, D, M, S, A, O, v, p, h, l, C, N, R, n]), r.useEffect(function() {
    I({
      width: 0,
      height: 0
    })
...
function A(e, t) {
  ...
  r.useEffect(function() {
    ...
    return s && !1 !== h.shouldUseIntersectionObserver && I(s, function(r) {
  ...
  }, [I, A, _, s, h.shouldUseIntersectionObserver]), r.useEffect(function() {
    return function() {
      _ && (_.cleanup(), f(null))
    }
  }, [_, s]);
...
function N(e, t, n) {
  ...
  var g = r.useCallback(function() {
    var e = p.current,
      t = h.current,
      n = m.current;
    if (!e || !t) return s(null), u(n.defaultValue), f(null),
      function() {};
