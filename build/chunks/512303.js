...
function v(e) {
  ...
  } = (0, u.ZP)(), E = null == (t = e.interactionMetadata) ? void 0 : t.authorizing_integration_owners[l.Y.USER_INSTALL], _ = null == (n = e.interactionMetadata) ? void 0 : n.authorizing_integration_owners[l.Y.GUILD_INSTALL], P = null == (v = e.interactionMetadata) ? void 0 : v.user.id, Z = (0, a.e7)([O.default], () => O.default.getUser(E)), T = (0, a.e7)([m.Z], () => m.Z.getGuild(_)), I = p.Z.getChannel(e.channel_id), A = null == I ? void 0 : I.getGuildId(), N = (0, a.e7)([O.default], () => O.default.getUser(P));
  if (i.useEffect(() => {
  ...
  return null != T ? w = (0, r.jsx)(o.sNh, {
    ...
    children: [w, null != N ? (0, r.jsx)(o.sNh, {
      action: () => (0, g.openUserProfileModal)({
        userId: N.id,
        guildId: A,
        channelId: e.channel_id,
