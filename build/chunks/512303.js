...
function E(e) {
  ...
  return null != _ ? T = (0, r.jsx)(o.sNh, {
    ...
    label: _.name,
    subtext: O.NW.formatToPlainString(O.t.ShLXXF, {
    ...
    action: () => (0, f.openUserProfileModal)({
      ...
      analyticsLocation: {
        object: p.qAy.MESSAGE_ACTION_SHEET
      }
    }),
    className: y.interactionInfoMenuItem,
    ...
    children: [T, null != x ? (0, r.jsx)(o.sNh, {
      action: () => (0, f.openUserProfileModal)({
        userId: x.id,
        guildId: I,
        channelId: e.channel_id,
