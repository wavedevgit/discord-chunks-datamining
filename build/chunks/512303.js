...
function E(e) {
  ...
  } = (0, u.ZP)(), S = null == (t = e.interactionMetadata) ? void 0 : t.authorizing_integration_owners[l.Y.USER_INSTALL], P = null == (n = e.interactionMetadata) ? void 0 : n.authorizing_integration_owners[l.Y.GUILD_INSTALL], _ = null == (E = e.interactionMetadata) ? void 0 : E.user.id, N = (0, a.e7)([p.default], () => p.default.getUser(S)), Z = (0, a.e7)([h.Z], () => h.Z.getGuild(P)), I = b.Z.getChannel(e.channel_id), x = null == I ? void 0 : I.getGuildId(), T = (0, a.e7)([p.default], () => p.default.getUser(_));
  if (r.useEffect(() => {
      null == N && null != S && (0, s.PR)(S)
    }, [N, S]), !(0, d.a)(e)) return null;
  null == T && (T = new m.Z(null == (v = e.interactionMetadata) ? void 0 : v.user));
  let A = null;
  return null != Z ? A = (0, i.jsx)(o.sNh, {
    ...
    children: [A, null != T ? (0, i.jsx)(o.sNh, {
      action: () => (0, g.openUserProfileModal)({
        userId: T.id,
        guildId: x,
        channelId: e.channel_id,
