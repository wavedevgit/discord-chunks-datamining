/** Chunk was on web.js **/
/** chunk id: 231338, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  $R: () => l,
  $V: () => Q,
...
let v = new Map([
  ...
  T = new Set([7, 9, 3, 5, 4, 14, 15, 16]),
  C = new Set([1, 2, 6, 8, 10, 11, 13, 12, 17]),
  A = new Set([3, 4, 5, 14, 15, 16, 7, 9, 12]),
  N = new Set([6]);
var P = function(e) {
...
let k = Object.freeze({
    CREATE_INSTANT_INVITE: Chunk149765.r0(0),
    KICK_MEMBERS: Chunk149765.r0(1),
    BAN_MEMBERS: Chunk149765.r0(2),
    ADMINISTRATOR: Chunk149765.r0(3),
    MANAGE_CHANNELS: Chunk149765.r0(4),
    MANAGE_GUILD: Chunk149765.r0(5),
    CHANGE_NICKNAME: Chunk149765.r0(26),
    MANAGE_NICKNAMES: Chunk149765.r0(27),
    MANAGE_ROLES: Chunk149765.r0(28),
    MANAGE_WEBHOOKS: Chunk149765.r0(29),
    MANAGE_GUILD_EXPRESSIONS: Chunk149765.r0(30),
    CREATE_GUILD_EXPRESSIONS: Chunk149765.r0(43),
    VIEW_AUDIT_LOG: Chunk149765.r0(7),
    VIEW_CHANNEL: Chunk149765.r0(10),
    VIEW_GUILD_ANALYTICS: Chunk149765.r0(19),
    VIEW_CREATOR_MONETIZATION_ANALYTICS: Chunk149765.r0(41),
    MODERATE_MEMBERS: Chunk149765.r0(40),
    USE_EMBEDDED_ACTIVITIES: Chunk149765.r0(39),
    USE_EXTERNAL_APPS: Chunk149765.r0(50),
    SEND_MESSAGES: Chunk149765.r0(11),
    SEND_TTS_MESSAGES: Chunk149765.r0(12),
    MANAGE_MESSAGES: Chunk149765.r0(13),
    EMBED_LINKS: Chunk149765.r0(14),
    ATTACH_FILES: Chunk149765.r0(15),
    READ_MESSAGE_HISTORY: Chunk149765.r0(16),
    MENTION_EVERYONE: Chunk149765.r0(17),
    USE_EXTERNAL_EMOJIS: Chunk149765.r0(18),
    ADD_REACTIONS: Chunk149765.r0(6),
    USE_APPLICATION_COMMANDS: Chunk149765.r0(31),
    MANAGE_THREADS: Chunk149765.r0(34),
    CREATE_PUBLIC_THREADS: Chunk149765.r0(35),
    CREATE_PRIVATE_THREADS: Chunk149765.r0(36),
    USE_EXTERNAL_STICKERS: Chunk149765.r0(37),
    SEND_MESSAGES_IN_THREADS: Chunk149765.r0(38),
    ...
    DEAFEN_MEMBERS: Chunk149765.r0(23),
    MOVE_MEMBERS: Chunk149765.r0(24),
    USE_VAD: Chunk149765.r0(25),
    PRIORITY_SPEAKER: Chunk149765.r0(8),
    STREAM: Chunk149765.r0(9),
    USE_SOUNDBOARD: Chunk149765.r0(42),
    USE_EXTERNAL_SOUNDS: Chunk149765.r0(45),
    SET_VOICE_CHANNEL_STATUS: Chunk149765.r0(48),
    REQUEST_TO_SPEAK: Chunk149765.r0(32),
    MANAGE_EVENTS: Chunk149765.r0(33),
...
let X = 250,
  ...
  ei = Object.freeze({
    WELCOME: "".concat(a, "/welcome/"),
    ME: "".concat(a, "/channels/@me"),
    SETTINGS: (e, t) => "".concat(a, "/settings/").concat(e).concat(t ? "/".concat(t) : ""),
    CONNECTION: e => "".concat(a, "/connections/").concat(e),
    CHANGELOGS: "".concat(a, "/settings/changelogs"),
    LOGIN: "".concat(a, "/login"),
    LOGIN_WITH_REDIRECT: e => "".concat(a, "/login?redirect_to=").concat(e),
    REGISTER: "".concat(a, "/register"),
    REGISTER_WITH_REDIRECT: e => "".concat(a, "/register?redirect_to=").concat(e),
    CREATE_GUILD: "".concat(a, "/guilds/create"),
    VANITY_INVITE: e => "".concat(s, "/").concat(e),
    HYPESQUAD_ONLINE: "".concat(a, "/settings/hypesquad-online"),
    BROWSE_NITRO_TITLES: "".concat(a, "/store/browse?type=nitro"),
    SKU_DETAILS: (e, t) => "".concat(a, "/store/skus/").concat(e).concat(null != t ? "?store_listing_id=".concat(t) : ""),
    MESSAGE: (e, t, n) => "/channels/".concat(e, "/").concat(t, "/").concat(n),
    CHANNEL: (e, t) => "/channels/".concat(e, "/").concat(t),
    REPORT: "".concat(a, "/report"),
    QUEST_PREVIEW_TOOL_2: e => "".concat(a, "/quest-preview/").concat(e)
  });
var eo = function(e) {
...
let ea = (0, Chunk860911.Ft)(ei),
  es = (0, Chunk860911.Ft)(eo),
  el = Object.freeze({
