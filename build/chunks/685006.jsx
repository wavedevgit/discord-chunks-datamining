...
function A(e) {
  ...
  return (i.useEffect(() => (T(S), () => {
    T(false)
  }), [S]), S) ? <N context={t} application={s} primaryEntryPointCommand={l} onOpenButtonPress={v} entryPointCommandButtonRef={n} type={o} /> : null
}
...
function N(e) {
  ...
  return <c.zx className={a()(v.entryPointAppCommandButton, O.Id)} size={c.zx.Sizes.SMALL} color={T} submitting={d} onClick={I} buttonRef={s}>{f}</c.zx>
}