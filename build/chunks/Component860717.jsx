...
let et = Object.assign(function(e) {
  let {
    ...
    game: y,
    config: O
  } = J(l), v = null == h ? true : h.getIconURL(16), x = (0, P.O)(n.id).data, w = null == x ? true : x.find(e => e.application_id === l.applicationId), T = (0, m.Z)({
    ...
    onClick: T,
    children: H
  }), K = (0, o.e7)([_.default], () => _.default.locale), q = i.useMemo(() => {
