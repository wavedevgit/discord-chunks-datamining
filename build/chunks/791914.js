    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: (0, r.jsxs)(a.njP, {
        ...
        children: [(0, r.jsxs)(a.njP.Item, {
          ...
          className: _.tab,
          children: [g.intl.string(g.t["En+D+v"]), (null == x ? void 0 : x.badgeForYou) ? (0, r.jsx)(a.fWl, {
        ...
        }), C ? (0, r.jsxs)(a.njP.Item, {
          "aria-label": "game_invites",
          id: l.X.GAME_INVITES,
          className: _.tab,
          children: [g.intl.string(g.t.apq3cX), S > 0 ? (0, r.jsx)(a.fWl, {
            color: s.Z.STATUS_DANGER,
            className: _.iconBadge
          }) : null]
        }) : null, v && O ? (0, r.jsx)(a.njP.Item, {
          "aria-label": g.intl.string(g.t["2pAkDA"]),
          id: l.X.BOOKMARKS,
          className: _.tab,
          children: 0 === I ? g.intl.string(g.t["2pAkDA"]) : g.intl.formatToPlainString(g.t.I4fryM, {
            count: I
          })
        }) : null, E && !v ? (0, r.jsx)(a.njP.Item, {
          "aria-label": "todos",
          id: l.X.TODOS,
          className: _.tab,
          children: 0 === I ? g.intl.string(g.t.aUXxzc) : g.intl.formatToPlainString(g.t["5en8yc"], {
            count: I
          })
        }) : null, j ? (0, r.jsx)(a.njP.Item, {
