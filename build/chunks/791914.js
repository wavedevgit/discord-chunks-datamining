  ...
  return (0, r.jsxs)(o.h4, {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: (0, r.jsxs)(l.njP, {
        ...
        onItemSelect: n,
        className: _.tabBar,
        children: [(0, r.jsxs)(l.njP.Item, {
          id: a.X.FOR_YOU,
          "aria-label": g.NW.string(g.t["En+D+v"]),
          className: _.tab,
          children: [g.NW.string(g.t["En+D+v"]), (null == x ? void 0 : x.badgeForYou) ? (0, r.jsx)(l.fWl, {
        ...
        }), j ? (0, r.jsxs)(l.njP.Item, {
          "aria-label": "game_invites",
          id: a.X.GAME_INVITES,
          className: _.tab,
          children: [g.NW.string(g.t.apq3cX), C > 0 ? (0, r.jsx)(l.fWl, {
            color: s.Z.STATUS_DANGER,
            className: _.iconBadge
          }) : null]
