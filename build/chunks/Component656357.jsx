...
function Q(e) {
  ...
  let {
    ...
    quest: en,
    videoSessionId: er
  } = o.useContext(T.VideoQuestModalContext), eo = (0, S.km)(e => e.transcriptEnabled), el = (0, S.km)(e => e.setTranscriptEnabled), ei = (0, S.km)(e => e.captionEnabled), ea = (0, S.km)(e => e.setCaptionEnabled), es = (0, S.km)(e => e.fullScreenEnabled), ec = (0, S.km)(e => e.setFullScreenEnabled), {
    enabled: eu,
    variant: ed
  } = _.EO.useConfig({
    ...
    visibleChanged: eE,
    targetRef: eg
  } = (0, L.Yy)(), [eO, eh] = o.useState(true === X ? w.rq.PLAYING : w.rq.PAUSED), [eb, eC] = o.useState(false), [eS, e_] = o.useState(false), ey = (0, C.il)(en), [ex, ej] = o.useState(ey.percentComplete), eP = o.useCallback(e => {
    eG(null), ej(e)
  }, []), [eD, eR] = o.useState(false), [eT, eI] = o.useState(true), [eN, eA] = o.useState(false), [ew, ek] = o.useState([]), [eL, eM] = o.useState(E.Z.getEffectiveConnectionSpeed()), [eV, eZ] = o.useState(0), [eF, eB] = o.useState(0), [eU, eq] = o.useState(false), [eY, eH] = o.useState(false), [eQ, eG] = o.useState(null), eK = o.useRef(true), eW = o.useRef(null), ez = o.useRef(null), eX = (0, S.km)(e => {
    var t;
    return null != (t = e.videoProgress[en.id]) ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, s.X), eJ = (0, S.km)(e => e.setVideoProgress), e$ = (0, S.km)(e => e.muted), e0 = (0, S.km)(e => e.volume), e1 = (0, c.e7)([f.Z], () => f.Z.useReducedMotion), e2 = (0, o.useRef)(null), e4 = (0, o.useRef)(null), e3 = o.useRef(true), e7 = (null == (t = en.userStatus) ? true : t.completedAt) != null, [e8, e9] = o.useState(null), [e6, e5] = o.useState(false), [te, tt] = o.useState(false), [tn, tr] = o.useState(null), to = e7 ? null != (v = null == (n = e2.current) ? true : n.duration) ? v : 0 : Math.max(eX.maxTimestampSec, ey.progressSeconds), tl = o.useMemo(() => (0, y.T)({
    quest: en,
    location: F.dr.VIDEO_MODAL
  }), [en]), ti = (0, k.$R)(e7, eX, ey), [ta, ts] = o.useState(w._H.MD), tc = {
    [w._H.MD]: 50,
    [w._H.LG]: 58
  };
  (0, m.Ng)(() => {
    e3.current && (e3.current = false, eM(E.Z.getEffectiveConnectionSpeed()), e7 && eX.timestampSec >= eX.duration && eJ(en.id, 0, eX.duration))
  });
  let {
    videoAsset: tu,
    videoAssetType: td,
  ...
  let tD = o.useCallback(() => {
    ...
    tT = o.useCallback(e => {
      if (tl.info("[QV] | updatePlayerState | playerState: ".concat(e)), eh(e), null != e2.current) switch (e) {
        case w.rq.PLAYING:
          e2.current.paused && tg(e8), e9(null), e2.current.play();
          break;
        case w.rq.PAUSED:
  ...
  let tI = o.useCallback(e => {
    var t;
    e7 || (null == (t = en.userStatus) ? true : t.enrolledAt) == null || (tl.info("[QV] sendServerProgressUpdate: ".concat(e)), (0, P.FI)(en, e)), tE()
  }, [e7, en, tl, tE]);
  o.useEffect(() => {
    J !== d.Dvm.HIDDEN && J !== d.Dvm.EXITING && J !== d.Dvm.EXITED && (null == J || !eE || ev || e7) && (!ep || ef || e7) || null == e2.current || eO !== w.rq.PLAYING || (tl.info("[QV] | Pausing video | playerState: ".concat(eO, ", parentTransitionState: ").concat(J, ", visible: ").concat(ev, ", focused: ").concat(ef, ", isQuestCompleted: ").concat(e7)), tT(w.rq.PAUSED), e7 || e9(b.yE.LOST_FOCUS))
  }, [J, ef, ep, ev, eE, eO, e7, tT, tI, tl]);
  let [tN, tA] = o.useState(false), tw = o.useRef(null), tk = o.useRef(performance.now()), tL = o.useCallback(() => {
    ...
    tA(false), tk.current = performance.now(), tL()
  };
  o.useEffect(() => {
    if (eO !== w.rq.PLAYING) {
  ...
  let tU = o.useCallback(e => {
      var t;
      null != e2.current && (tl.info("[QV] | seekTimeline | timeSec: ".concat(e)), eG(e / (null != (t = e2.current.duration) ? t : 1) * 100), tR(), eR(true), tt(false), e2.current.currentTime = e, eJ(en.id, e, e2.current.duration))
    }, [e2, eJ, en.id, tR, tl]),
    tq = () => {
  ...
  let t0 = eO === w.rq.ENDED,
    ...
    t4 = e7 || eX.maxTimestampSec >= (null != (U = null == (l = e2.current) ? true : l.currentTime) ? U : 0) + 1,
  ...
  return (0, r.jsx)(d.P3F, {
    ...
    tabIndex: false,
    onMouseEnter: () => {
      eC(true), tA(false), tk.current = performance.now(), null != tw.current && clearTimeout(tw.current)
    },
    onMouseLeave: () => {
      eC(false), tA(false)
    },
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [t0 && (0, r.jsx)(R.Z, {
        ...
        onTimeUpdate: e => {
          null != e2.current && (e2.current.currentTime >= eV && (tl.info("[QV] | handleTimeUpdate: capturing server time update: currentTime: ".concat(e2.current.currentTime)), eZ(e2.current.currentTime + 6 + 2 * Math.random()), tI(e2.current.currentTime)), e2.current.currentTime >= eF && (eB(e2.current.currentTime + 1), (0, O.qm)(en.id, ey.taskType, e2.current.currentTime), z(e2.current.currentTime)), eJ(en.id, e2.current.currentTime, e2.current.duration), eP(e2.current.currentTime / e2.current.duration * 100))
        },
        onEnded: e => {
          null != e2.current && (tI(e2.current.duration + 1), tl.info("[QV] | handleEnded: sending progress update: ".concat(e2.current.duration + 1)), eJ(en.id, e2.current.duration, e2.current.duration)), tT(w.rq.ENDED), eA(false)
        },
        onLoadedData: e => {
        ...
        onLoadedMetadata: e => {
          null != e2.current && (tl.info("[QV] | handleLoadedMetadata | videoAssetId: ".concat(td)), e5(true), td !== j.eC.VIDEO_PLAYER_VIDEO_HLS && tU(ti), e$ ? e2.current.volume = 0 : e2.current.volume = e0)
        },
        onLoadStart: () => {
          eW.current = performance.now(), tp(eL), tl.info("[QV] | handleLoadStart | loadingStartTime: ".concat(eW.current))
        },
        onPlaying: () => {
        ...
        children: [null != t2 && (0, r.jsx)("track", {
          ...
          srcLang: "en",
          default: true
        }), null != tu && td !== j.eC.VIDEO_PLAYER_VIDEO_HLS && null != tu.mimetype && (0, r.jsx)("source", {
      ...
      }), eO === w.rq.PAUSED && e8 === b.yE.LOST_FOCUS && (0, r.jsx)(H, {}), em && (0, r.jsx)(a.animated.div, {
