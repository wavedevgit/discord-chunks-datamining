...
function K() {
  ...
  return (0, Chunk54381.jsx)("div", {
    className: Chunk290691.pauseText,
    style: {
...
function $(e) {
  ...
  let {
    ...
    e0(null), eA(e)
  }, []), [ek, eM] = o.useState(false), [eL, eV] = o.useState(true), [eZ, eF] = o.useState(false), [eB, eH] = o.useState([]), [eU, eq] = o.useState(h.Z.getEffectiveConnectionSpeed()), [eY, eG] = o.useState(0), [eQ, eW] = o.useState(0), [ez, eK] = o.useState(false), [eX, eJ] = o.useState(false), [e$, e0] = o.useState(null), e1 = o.useRef(true), e2 = o.useRef(null), e4 = o.useRef(null), e9 = (0, x.km)(e => {
    var t;
    return null != (t = e.videoProgress[es.id]) ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), e8 = (0, x.km)(e => e.setVideoProgress), e7 = (0, x.km)(e => e.muted), e3 = (0, x.km)(e => e.volume), e6 = (0, d.e7)([v.Z], () => v.Z.useReducedMotion), e5 = (0, o.useRef)(null), te = (0, o.useRef)(null), tt = o.useRef(true), tn = (null == (t = es.userStatus) ? true : t.completedAt) != null, [tr, to] = o.useState(null), [tl, ti] = o.useState(false), [ta, ts] = o.useState(false), [tc, tu] = o.useState(null), td = tn ? null != (I = null == (n = e5.current) ? true : n.duration) ? I : 0 : Math.max(e9.maxTimestampSec, eI.progressSeconds), tm = o.useMemo(() => (0, P.T)({
    quest: es,
    location: U.dr.VIDEO_MODAL
  }), [es]), {
    title: tp,
  ...
  }(es), tv = tn ? e9.timestampSec >= e9.duration ? 0 : e9.timestampSec : Math.max(e9.timestampSec, eI.progressSeconds), [tE, tg] = o.useState(L._H.MD), tO = {
    [L._H.MD]: 50,
    [L._H.LG]: 58
  };
  (0, f.Ng)(() => {
    tt.current && (tt.current = false, eq(h.Z.getEffectiveConnectionSpeed()), tn && e9.timestampSec >= e9.duration && e8(es.id, 0, e9.duration))
  });
  let {
    videoVariant: th,
    videoAsset: tb,
  ...
  let t4 = o.useCallback(e => {
      var t;
      null != e5.current && (tm.info("[QV] | seekTimeline | timeSec: ".concat(e)), e0(e / (null != (t = e5.current.duration) ? t : 1) * 100), tq(), eM(true), ts(false), e5.current.currentTime = e, e8(es.id, e, e5.current.duration))
    }, [e5, e8, es.id, tq, tm]),
    t9 = () => {
    ...
    t3 = o.useCallback(() => {
      ...
      if (e.mode = "hidden", null != e.cues)
        for (let t = 0; t < e.cues.length; t++) {
          let n = e.cues[t];
          (0, V.JC)(n) && (n.id = "cue-".concat(t), n.onenter = () => t8(n), n.onexit = () => t7(n))
        }
    }, [e5, tm]);
  o.useEffect(() => {
  ...
  let nl = ex === L.rq.ENDED,
    ...
    nu = tn || e9.maxTimestampSec >= (null != (Z = null == (m = e5.current) ? true : m.currentTime) ? Z : 0) + 1,
  ...
  return (0, r.jsx)(p.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [nl && (0, r.jsxs)(r.Fragment, {
        ...
        onLoadedMetadata: e => {
          null != e5.current && (tm.info("[QV] | handleLoadedMetadata | videoAssetId: ".concat(tC)), ti(true), th !== R.n1.VIDEO_HLS && t4(tv), e7 ? e5.current.volume = 0 : e5.current.volume = e3)
        },
        onLoadStart: () => {
        ...
        onClick: () => {
          tm.info("[QV] | handleVideoClick"), t9()
        },
