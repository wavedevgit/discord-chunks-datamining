...
function g() {
  ...
  return <Chunk907995.f label={Chunk388032.t.EUo0ys} labelHook={() => {
      window.open(Chunk63063.Z.getArticleURL(module), "_blank")
    }} noticeType={Chunk484710.nq.SENSITIVE_CONTENT_FILTER_TEEN_NOTICE} />
}

function h() {
  return <Chunk907995.f label={Chunk388032.t.OX4ybm} labelHook={() => {
...
function f() {
  ...
  let t = null == (e = (0, Chunk880257.Z)()) || module,
    n = (0, Chunk81643.l6)();
  return (0, Chunk128064.pY)("ContentAndSocialNotice") && !require ? <h /> : exports ? null : <g />
}