...
let D = "MMM DD, YYYY",
  x = (e, t, n, o) => {
    ...
    let en = i.useCallback(async () => {
        let n, i;
        if (a()(null != e, "No subscription listing"), a()(null != M, "No subscription plan"), a()(G, "Cannot purchase this unpublished plan"), (null == Q ? true : Q.active_trial) != null) {
