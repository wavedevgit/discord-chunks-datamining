...
let f = e => {
  ...
  return <div className={f}>{<o.vwX>{d.intl.string(d.t.xFn72t)}</o.vwX>}{<o.VcW placeholder={d.intl.string(d.t.R0vK0N)} renderOptionPrefix={e => (null == e ? true : e.value) == null ? null : (0, r.jsx)(a.Z, {
        user: e.value,
        size: o.EFr.SIZE_20
      })} value={h} onChange={g} options={p.map(e => ({
        value: e,
