/** Chunk was on web.js **/
/** chunk id: 483517, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  A: () => h
});
  ...
  constructor(e) {
    super(e), u(this, "_ref", a.createRef()), u(this, "_height", 0), u(this, "_width", 0), u(this, "_dragStart", {
      ...
      !i && f(this._dragStart, {
        x: e.clientX,
        y: e.clientY
      }) > p && (o = true), o && (this.animateToPosition(e.clientX - this._offsetX, e.clientY - this._offsetY, {
        tension: 80,
        friction: 8
      }, null, false), (0, s.flushSync)(() => {
        this.setState({
          dragging: o
