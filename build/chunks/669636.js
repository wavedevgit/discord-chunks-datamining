...
let T = e => {
    let {
      product: t,
      pairedProduct: n
    } = e, [i] = t.items, a = null == n ? void 0 : n.items[0], s = (0, u.e7)([_.default], () => {
      let e = _.default.getCurrentUser();
      return o()(null != e, "User cannot be undefined"), e
    });
    return (0, l.EQ)(t.type).with(c.Z.PROFILE_EFFECT, () => (0, r.jsx)("div", {
      className: b.profileEffectShopPreview,
      children: (0, r.jsx)(f.Z, {
        forCollectedModal: !0,
        profileEffectId: i.id
      })
    })).with(c.Z.AVATAR_DECORATION, () => (o()(i.type === c.Z.AVATAR_DECORATION, "ts-match already checked the type"), null != a && a.type === c.Z.AVATAR_DECORATION) ? (0, r.jsxs)("div", {
    ...
    })).with(c.Z.NAMEPLATE, () => (0, r.jsx)("div", {
    ...
    })).with(c.Z.EXTERNAL_SKU, () => (0, r.jsx)("div", {
      className: b.avatarDecoration,
