...
let ea = Chunk474936.Xh.NONE_MONTH,
...
async function eu(e, t) {
  ...
  return (0, E.W3)(e, n.map(e => e.id), t)
}
...
function ep(e) {
  let t, {
    ...
    ej = (0, u.e7)([x.Z], () => null != em ? x.Z.getGuild(em) : true, [em]),
    ...
    [eX, eK] = l.useState(false),
    eq = (0, u.e7)([B.Z], () => B.Z.popupCallbackCalled),
    e$ = (0, I.V)(),
    eQ = l.useMemo(() => null != eg && ex && e$ ? (0, v.g)(eg, eH) : [{
    ...
    } = (0, y.ZP)(E, S.Z.GUILD_BOOST_PURCHASE_MODAL),
    e4 = l.useMemo(() => {
      var e, t;
      return {
        load_id: e0,
        ...
        subscription_plan_id: null != (t = null == (e = eQ.find(e => {
          let {
            planId: t
          } = e;
          return et.Z1.has(t)
  ...
  let [e1, e7] = l.useState(L.h8.PLAN_SELECT), e5 = l.useMemo(() => Date.now(), [e1]), e2 = l.useCallback((e, t) => {
    e7(e), eD(null);
    let n = Date.now();
    H.default.track(ee.rMx.PAYMENT_FLOW_STEP, eo(er({}, e4), {
  ...
  l.useEffect(() => {
    ...
    (async () => {
      if (true === eq) try {
        ...
        await (0, _.OP)(B.Z.redirectedPaymentId), i(L.h8.CONFIRM), ti(C.A.COMPLETED), null != n && await eu(n, null != eh), null == l || l()
      } catch (n) {
        ti(C.A.FAIL), a(n), H.default.track(ee.rMx.PAYMENT_FLOW_FAILED, eo(er({}, e), {
    ...
    Y.Z.hasFetchedSubscriptions() || (0, _.jg)(), null == em || null != G.Z.getGuild(em) || null != x.Z.getGuild(em) || x.Z.isGuildFetching(em) || (0, T.Q)(em), (0, M.U)(eo(er({}, e4), {
      guild_id: em,
      application_id: ef,
  ...
  let [te, tt] = l.useState(es), [tn, ti] = l.useState(C.A.WAITING), [tl, tr] = l.useState(true), to = () => {
    r(tn === C.A.COMPLETED)
  }, ta = null != eg && eg.isPurchasedExternally;
  l.useEffect(() => {
    eU !== D.wr.PENDING && e1 !== L.h8.CONFIRM && null != eM && (te !== es && tt(es), es.includes(e1) || e1 === L.h8.PREMIUM_UPSELL || e2(L.h8.REVIEW)), e1 === L.h8.ADD_PAYMENT_STEPS && te !== ec && tt(ec), ta && e1 !== L.h8.PLAN_SELECT && e7(L.h8.PLAN_SELECT)
  }, [e1, e2, ta, eU, eg, eM, te]), (0, D.bp)(e1, eU, e2, ti), (0, L.dZ)(e1, tn, ti);
  let ts = l.useRef(null),
    [tc, tu] = (0, g.Z)(false, 500),
    [tp, td] = l.useState(null),
    [tm, tb] = l.useState([]),
    [t_, tE] = l.useState(false),
    tP = l.useMemo(() => JSON.stringify(tm), [tm]);
  l.useEffect(() => {
    let e;
    e$ && (null != z.Z.get(et.Xh.PREMIUM_MONTH_GUILD) && tb(e = (0, K.DE)(et.Xh.PREMIUM_MONTH_GUILD, ew, false)), null == ew && null != eg && null != eg.paymentSourceId ? td(eg.currency) : null != e && td(e[0]))
  }, [ew, eg, e$, tP]);
  let tf = (0, w.vP)({
    paymentModalArgs: eR,
  ...
  if (eS) t = (0, i.jsx)(N.Vq, {
    onClose: to
  });
  else if (eO && ex && e$ && null != tp && "" !== tp)
    if ((null == eg ? true : eg.isPausedOrPausePending) && !eg.isPausedAllowsUpdatesButNotResume) t = (0, i.jsx)(b.hzk, {
    ...
    else if (null != eg && null != eg.renewalMutations) t = (0, i.jsx)(b.hzk, {
    "data-migration-pending": true,
    children: (0, i.jsx)("p", {
      className: el.copy,
    ...
    switch (e1) {
      case L.h8.PLAN_SELECT:
        s()(null != em, "Missing guildId"), s()(null != ek, "Missing nextPremiumSubscriptionPlan"), e = (0, i.jsx)(Q.CP, {
          premiumSubscriptionPlan: ek,
          numGuildBoosts: eH,
          ...
          priceOptions: o
        }), ta && null != eg && null != eg.paymentGateway ? e = (0, i.jsxs)("div", {
          className: el.externalErrorBlock,
          children: [(0, i.jsx)(b.M14, {
            type: "critical",
            children: ei.intl.format(ei.t["/m3Y3s"], {
              paymentGatewayName: en.Vz[eg.paymentGateway]
            })
          }), e]
        }) : !x.Z.isGuildFetching(em) && u && (e = (0, i.jsxs)(i.Fragment, {
          children: [(0, i.jsx)(b.Wn, {
          ...
          onClick: () => {
            if (!eE && (null == eT || eT.premiumSubscriptionType !== et.PremiumTypes.TIER_2)) return void e2(L.h8.PREMIUM_UPSELL);
      ...
      case L.h8.AWAITING_AUTHENTICATION:
        ...
        break;
      case L.h8.REVIEW:
        s()(null != ek, "Missing nextPremiumSubscriptionPlan"), e = (0, i.jsx)(Q.Gq, {
          paymentSources: ev,
          priceOptions: o,
        ...
        }), n = L.h8.PLAN_SELECT, r = eX ? (0, i.jsx)(b.Button, {
          variant: "active",
          ...
          onClick: async () => {
            ...
            eD(null);
            try {
              ti(C.A.PURCHASING), eZ(true), s()(null != ew, "Missing paymentSourceId"), s()(null != eI, "Missing invoicePreview");
              let t = {
                  amount: eI.total,
                  currency: eI.currency
                },
                n = (0, X.sG)(eg, eQ, o.currency.toLowerCase(), o.paymentSourceId);
              if (H.default.track(ee.rMx.PAYMENT_FLOW_COMPLETED, eo(er({}, e4), {
              ...
              if (null == eg || null == eT) {
                ...
                i.currency = eg.currency, null == i.currency && (i.currency = o.currency), i.paymentSource = null != eM ? ev[eM] : true, null == i.paymentSource && (s()(null != e, "Missing paymentSource"), i.paymentSource = e, i.currency = o.currency);
                let l = await (0, _.Mg)(eg, i, t, n, e8);
                if (l.redirectConfirmation) return void tE(null != l.redirectURL)
              }
              null == eh && e2(L.h8.CONFIRM), ti(C.A.COMPLETED), null != em && await eu(em, null != eh), null != eh && to(), null == eb || eb()
            } catch (t) {
              ti(C.A.FAIL), eD(t), H.default.track(ee.rMx.PAYMENT_FLOW_FAILED, eo(er({}, e4), {
          ...
          children: (0, i.jsx)(b.Button, {
            ...
            text: ei.intl.string(ei.t.eUEeCt),
            onClick: () => {
              null != ts.current && (ts.current.scrollIntoView({
                behavior: "smooth"
              }), tu(true))
            },
            type: "submit"
      ...
      case L.h8.CONFIRM:
        var th;
        let E = null != (th = null == c ? true : c.name) ? th : null == ej ? true : ej.name,
          f = (0, j.$)(ev, ew),
    ...
    t = e1 === L.h8.ADD_PAYMENT_STEPS ? tf : (0, i.jsx)(Z.Z, {
      ...
      body: e,
      footer: e1 !== L.h8.CONFIRM ? (0, i.jsxs)(b.mzw, {
        "data-migration-pending": true,
  ...
  let tg = null;
  return eS || e1 === L.h8.PREMIUM_UPSELL || (tg = (0, i.jsx)($.Z, {
    onClose: to,
    currentStep: e1,
    purchaseState: tn
  })), (0, i.jsxs)(b.Y0X, {
    ...
    transitionState: n,
    className: o()({
      [el.planSelectStep]: e1 === L.h8.PLAN_SELECT
    }),
...
function ed(e) {
  let t = (0, u.e7)([Y.Z], () => Y.Z.getPremiumTypeSubscription()),
    ...
    } = (0, y.ZP)(S.Z.GUILD_BOOST_PURCHASE_MODAL);
  return (0, i.jsx)(y.Gt, {
    value: n,
