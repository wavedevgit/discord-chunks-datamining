          ...
          onClick: async () => {
            ...
            try {
              ...
              if (null == e_ || null == eN) {
                ...
                l.currency = e_.currency, null == l.currency && (l.currency = o.currency), l.paymentSource = null != ef ? eT[ef] : true, null == l.paymentSource && (c()(null != e, "Missing paymentSource"), l.paymentSource = e, l.currency = o.currency);
