...
! function(r, n) {
  ...
  var i = "function",
    ...
    H = function(t, e) {
      return typeof t === s && false !== W(e).indexOf(W(t))
    },
    W = function(t) {
    ...
    G = function(t, e) {
      for (var r, n, o, s, u, c, l = 0; l < e.length && !u;) {
        ...
        for (r = n = 0; r < f.length && !u && f[r];)
          if (u = f[r++].exec(t))
            for (o = 0; o < p.length; o++) c = u[++n], typeof(s = p[o]) === a && s.length > 0 ? 2 === s.length ? typeof s[1] == i ? this[s[0]] = s[1].call(this, c) : this[s[0]] = s[1] : 3 === s.length ? typeof s[1] !== i || s[1].exec && s[1].test ? this[s[0]] = c ? c.replace(s[1], s[2]) : true : this[s[0]] = c ? s[1].call(this, c, s[2]) : true : 4 === s.length && (this[s[0]] = c ? s[3].call(this, c.replace(s[1], s[2])) : true) : this[s] = c || true;
        l += 2
      }
    },
    J = function(t, e) {
      for (var r in e)
        if (typeof e[r] === a && e[r].length > 0) {
          for (var n = 0; n < e[r].length; n++)
            if (H(e[r][n], t)) return "?" === r ? true : r
        } else if (H(e[r], t)) return "?" === r ? true : r;
    ...
    $ = function(t, e) {
      if (typeof t === a && (e = t, t = true), !(this instanceof $)) return new $(t, e).getResult();
      var n = typeof r !== o && r.navigator ? r.navigator : true,
        g = t || (n && n.userAgent ? n.userAgent : ""),
        m = n && n.userAgentData ? n.userAgentData : true,
        _ = e ? U(Y, e) : Y,
        b = n && n.userAgent == g;
      return this.getBrowser = function() {
        var t, e = {};
        return e[l] = true, e[h] = true, G.call(e, g, _.browser), e[u] = typeof(t = e[h]) === s ? t.replace(/[^\d\.]/g, "").split(".")[0] : true, b && n && n.brave && typeof n.brave.isBrave == i && (e[l] = "Brave"), e
      }, this.getCPU = function() {
        var t = {};
        return t[d] = true, G.call(t, g, _.cpu), t
      }, this.getDevice = function() {
        var t = {};
        return t[p] = true, t[c] = true, t[f] = true, G.call(t, g, _.device), b && !t[f] && m && m.mobile && (t[f] = y), b && "Macintosh" == t[c] && n && typeof n.standalone !== o && n.maxTouchPoints && n.maxTouchPoints > 2 && (t[c] = "iPad", t[f] = v), t
      }, this.getEngine = function() {
        var t = {};
        return t[l] = true, t[h] = true, G.call(t, g, _.engine), t
      }, this.getOS = function() {
        var t = {};
        return t[l] = true, t[h] = true, G.call(t, g, _.os), b && !t[l] && m && m.platform && "Unknown" != m.platform && (t[l] = m.platform.replace(/chrome os/i, z).replace(/macos/i, P)), t
