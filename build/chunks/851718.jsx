...
class f extends Chunk73800.PureComponent {
  ...
  render() {
    return this.state.hasError ? <Chunk481060.qXd color={Chunk481060.DM8.DANGER} style={{
        borderRadius: 0
      }}>{Chunk388032.intl.format(Chunk388032.t.IIHUUF, {
      ...
      })}</Chunk481060.qXd> : this.props.children
  }
  constructor(...e) {
