...
var Chunk271830 = require("./271830.js"),
  ...
  _ = require.n(Chunk907014),
  Chunk70986 = require("./70986.js"),
  A = require.n(Chunk70986),
  Chunk1214 = require("./1214.js"),
  O = require.n(Chunk1214);
...
function j(e, t) {
  ...
  return l.findEntityRanges(e => null !== e.getEntity(), (e, t) => {
    ...
    if (a.forEach(r => {
        ...
        !r.processed && (r.type === l && r.start === s && r.text === i ? (r.processed = true, n = true) : (s >= r.start && s < r.end || a > r.start && a <= r.end) && (r.processed = true, t = R(null, r.start, r.end, t)))
      }), n) return;
    let l = r[e.type];
