...
let c = e => {
  ...
  d = e => {
    ...
    }), h = d ? u.find(e => e.currency === a.pKx.DISCORD_ORB) : void 0, p = u.find(e => e.currency !== a.pKx.DISCORD_ORB), f = [], g = [], E = 1 === u.length && null != h, b = null != h && null != o && o >= h.amount;
    ...
    let m = f.length > 0 && (null == (t = f[0]) ? void 0 : t.currency) === a.pKx.DISCORD_ORB;
    return {
      displayPrices: g,
