...
let c = e => {
  ...
  d = e => {
    ...
    }), p = d ? u.find(e => e.currency === a.pKx.DISCORD_ORB) : void 0, _ = u.find(e => e.currency !== a.pKx.DISCORD_ORB), h = [], f = [], m = 1 === u.length && null != p, b = null != p && null != l && l >= p.amount;
  ...
  p = e => {
    let {
      tab: t,
      product: n
    } = e, i = (0, r.z)(), s = o.default.getCurrentUser(), {
