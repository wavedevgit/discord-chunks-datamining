...
let c = e => {
  ...
  u = e => {
    ...
    }), a = s ? i.find(e => e.currency === o.pKx.DISCORD_ORB) : void 0, l = i.find(e => e.currency !== o.pKx.DISCORD_ORB), d = 1 === i.length && null != a;
    return {
      orbPrice: a,
      fiatPrice: l,
      isOrbExclusive: d
  ...
  m = e => {
    ...
    return i === l.AW.ORBS ? null != r && (o = [r]) : (null != s && o.push(s), null != r && o.push(r)), {
      orbPrice: r,
      fiatPrice: s,
      isOrbExclusive: a,
      displayPrices: o
