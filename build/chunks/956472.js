...
let c = e => {
  ...
  d = e => {
    ...
    }), o = l ? r.find(e => e.currency === s.pKx.DISCORD_ORB) : void 0, a = r.find(e => e.currency !== s.pKx.DISCORD_ORB), u = 1 === r.length && null != o;
    return {
      orbPrice: o,
      fiatPrice: a,
      isOrbExclusive: u
  ...
  h = e => {
    ...
    return r === a.AW.ORBS ? null != i && (s = [i]) : (null != l && s.push(l), null != i && s.push(i)), {
      orbPrice: i,
      fiatPrice: l,
      isOrbExclusive: o,
      displayPrices: s
