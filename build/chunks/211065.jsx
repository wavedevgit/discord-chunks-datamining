...
function D(t) {
  return <div className={P.statusOptionItem}>{<u.qbd status={t.value} size={10} className={P.statusIcon} />}{t.label}</div>
}
class I extends Chunk73800.PureComponent {
  ...
  getEmojiButtonRenderer() {
    ...
    return null == module ? null : () => <Chunk596454.Z className={Chunk403773.emoji} emojiId={module.id} emojiName={module.name} animated={!!module.animated} />
  }
  renderCustomStatusInput() {
    ...
    return <Chunk481060.hjN className={Chunk403773.formGroup} title={Chunk388032.intl.formatToPlainString(Chunk388032.t["/w9pHx"], {
        username: module.username
      })}><div className={Chunk403773.inputContainer}>{<div className={Chunk403773.emojiButtonContainer}><Chunk481060.yRy targetElementRef={this.emojiButtonRef} renderPopout={this.renderEmojiPicker} position={"left"} animation={Chunk481060.yRy.Animation.NONE} align={"top"}>{(t, e) => {
              let {
                isShown: n
              } = e;
            ...
            }}</Chunk481060.yRy></div>}{<Chunk755721.Is maxLength={Chunk875425.s0} value={exports} inputClassName={Chunk403773.input} placeholder={Chunk388032.intl.string(Chunk388032.t["zYR38/"])} onChange={this.handleStatusChange} onKeyPress={this.handleKeyPress} autoFocus={true} />}{exports.length > 0 || null != require ? <Chunk481060.P3F focusProps={{
            offset: {
              top: 8,
              bottom: 8,
              left: false,
          ...
          }} className={Chunk403773.clearButton} onClick={this.handleClearStatus}><Chunk481060.k$p size={"md"} color={"currentColor"} className={Chunk403773.clearIcon} /></Chunk481060.P3F> : null}</div></Chunk481060.hjN>
  }
  renderClearAfter() {
    let {
      clearAfter: t
    } = this.state;
    return <Chunk481060.hjN className={Chunk403773.formGroup} title={Chunk388032.intl.string(Chunk388032.t.E45wvL)}><Chunk481060.q4e placeholder={Chunk388032.intl.string(Chunk388032.t.E45wvL)} maxVisibleItems={Chunk875425.wS.length} value={module} options={Chunk875425.wS.map(t => ({
          value: t,
          key: t,
          label: (0, x.Z)(t)
        }))} onChange={this.handleChangeClearAfter} /></Chunk481060.hjN>
  }
  renderStatusInput() {
    let {
      status: t
    } = this.state;
    return <Chunk481060.hjN className={Chunk403773.formGroup} title={Chunk388032.intl.string(Chunk388032.t.zOdg0N)}><Chunk481060.q4e maxVisibleItems={4} value={module} options={Chunk875425.Df.map(t => E(N({}, t), {
          value: t.value,
          key: t.value,
          label: t.label()
        }))} onChange={this.handleChangeStatus} renderOptionLabel={D} /></Chunk481060.hjN>
  }
  render() {
    let {
      transitionState: t,
    ...
    return <Chunk410575.Z{...E(N({}, this.analyticsLocation), {
  ...
  constructor(...t) {
    super(...t), w(this, "emojiButtonRef", a.createRef()), w(this, "state", {
      ...
      return <f.Z closePopout={e} onSelectEmoji={t => {
          let {
            emoji: n,
            willClose: l
          } = t;
          this.handleEmojiChange(n), l && e()
        }} pickerIntention={T.Hz.STATUS} onNavigateAway={n} />
    })
  }
}
