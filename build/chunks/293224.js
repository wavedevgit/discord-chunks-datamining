...
function ei(e) {
  let {
    ...
    selfMute: a,
    mute: c
  } = (0, k.Z)(t), u = a || c || l, d = (0, O.Z)(a, c, l, !1), {
    Component: h,
    play: f,
    events: m
  } = (0, s.O)(u ? "unmute" : "mute");
  ...
  return (0, i.jsx)(p.yRy, {
    ...
    children: (e, t) => {
      ...
      return (0, i.jsx)(en, {
        ...
        tooltip: d,
        onClick: () => {
          (0, _.Z)(c, l, J.jXE.OVERLAY), (0, Q.Ws)(J.Odu.QUICK_ACTIONS, {
            type: Q.Qu.MICROPHONE,
...
function er(e) {
  ...
  r.useEffect(() => () => d(), [c, d]);
  let g = () => {
      (0, E.Z)(s, J.jXE.OVERLAY), (0, Q.Ws)(J.Odu.QUICK_ACTIONS, {
        type: Q.Qu.AUDIO,
...
function eo(e) {
  ...
  let {
    voiceChannel: n,
    locked: l
  } = e, a = r.useRef(null), s = (0, o.e7)([W.Z], () => W.Z.isVideoEnabled()), c = (0, o.e7)([W.Z], () => Object.values(W.Z.getVideoDevices())[0]), u = null == (t = null == c ? void 0 : c.disabled) || t, f = !1 === u, m = (0, T.Z)(n), g = e => {
    ...
    u ? y() : g(!s), (0, Q.Ws)(J.Odu.QUICK_ACTIONS, {
      type: Q.Qu.CAMERA,
  ...
  } = (0, d.o)(s ? "disable" : "enable"), I = null != n ? (0, D.X)({
    enabled: s,
    cameraUnavailable: u,
    hasPermission: m,
    channel: n
...
function el(e) {
  ...
  if (g) t = q.intl.string(q.t.S5anIS);
    ...
    let e = (0, K.pL)();
    t = u ? null != e ? q.intl.format(q.t.AB5gT0, {
      game: e.name
...
function ea(e) {
  ...
  let {
    ...
    mute: d,
    suppress: h
  } = (0, k.Z)(l), m = (0, o.e7)([W.Z], () => W.Z.isDeaf()), y = null == l || d || h || m, {
    analyticsLocations: O
  } = (0, g.ZP)();

  function v(e) {
    null != c && ((0, Q.Ws)(J.Odu.QUICK_ACTIONS, {
  ...
  } = (0, u.j)(), S = et(a), I = (0, o.e7)([w.Z, U.default], () => w.Z.isUserPlayingSounds(U.default.getId()), []) ? "green" : void 0;
  return (0, i.jsx)(p.yRy, {
    targetElementRef: s,
    renderPopout: e => {
      let {
...
function es(e) {
  let {
    voiceChannel: t,
    locked: n
  } = e, a = r.useRef(null), s = (0, o.e7)([F.Z], () => F.Z.getVoiceChannelId() === (null == t ? void 0 : t.id)), c = () => {
