...
function es(e) {
  ...
  let {
    voiceChannel: n,
    locked: l
  } = e, a = r.useRef(null), s = (0, o.e7)([G.Z], () => G.Z.isVideoEnabled()), c = (0, o.e7)([G.Z], () => Object.values(G.Z.getVideoDevices())[0]), f = null == (t = null == c ? void 0 : c.disabled) || t, h = !1 === f, m = (0, T.Z)(n), g = e => {
...
function eu(e) {
  ...
  } = (0, c.j)(), S = er(a), I = (0, o.e7)([w.Z, W.default], () => w.Z.isUserPlayingSounds(W.default.getId()), []) ? "green" : void 0;
  return (0, i.jsx)(d.yRy, {
    targetElementRef: s,
    renderPopout: e => {
      let {
    ...
    children: (e, t) => {
      ...
      return (0, i.jsx)(eo, {
        ref: s,
        iconComponent: v,
        tooltip: p ? et.intl.string(et.t["Ox4/zc"]) : h ? et.intl.string(et.t["+YBKYG"]) : m ? et.intl.string(et.t.X1lQlp) : void 0,
        onClick: e => {
...
function ed(e) {
  let {
    voiceChannel: t,
    locked: n
  } = e, a = r.useRef(null), s = (0, o.e7)([H.Z], () => H.Z.getVoiceChannelId() === (null == t ? void 0 : t.id)), c = () => {
...
function eh(e) {
  ...
  let {
    voiceChannel: r
  } = e, l = null == r ? void 0 : r.id, a = (0, o.cj)([B.Z], () => ({
