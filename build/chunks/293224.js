...
function ei(e) {
  let {
    ...
    selfMute: l,
    mute: a
  } = (0, k.Z)(t), c = l || a || o, u = (0, y.Z)(l, a, o, !1), {
    Component: d,
    play: h,
    events: f
  } = (0, s.O)(c ? "unmute" : "mute");
...
function eo(e) {
  ...
  let {
    voiceChannel: n,
    locked: l
  } = e, a = (0, o.e7)([U.Z], () => U.Z.isVideoEnabled()), s = (0, o.e7)([U.Z], () => Object.values(U.Z.getVideoDevices())[0]), c = null === (t = null == s ? void 0 : s.disabled) || void 0 === t || t, u = !1 === c, f = (0, T.Z)(n), m = e => {
...
function ea(e) {
  ...
  } = (0, u.j)(), E = et(l), x = (0, o.e7)([Z.Z, V.default], () => Z.Z.isUserPlayingSounds(V.default.getId()), []) ? "green" : void 0;
  return (0, i.jsx)(p.yRy, {
    renderPopout: e => {
      let {
        closePopout: t
