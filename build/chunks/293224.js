...
function er(e) {
  let {
    ...
    selfMute: a,
    mute: c
  } = (0, D.Z)(t), u = a || c || l, d = (0, O.Z)(a, c, l, !1), {
    Component: h,
    play: f,
    events: m
  } = (0, s.O)(u ? "unmute" : "mute");
  ...
  return (0, i.jsx)(p.yRy, {
    ...
    children: (e, t) => {
      ...
      return (0, i.jsx)(ei, {
        ...
        tooltip: d,
        onClick: () => {
          (0, _.Z)(c, l, q.jXE.OVERLAY), (0, K.Ws)(q.Odu.QUICK_ACTIONS, {
            type: K.Qu.MICROPHONE,
...
function eo(e) {
  ...
  } = (0, a.l)(c ? "undeafen" : "deafen"), m = s ? p.Vm4 : u;
  r.useEffect(() => () => d(), [c, d]);
  let g = () => {
      (0, E.Z)(s, q.jXE.OVERLAY), (0, K.Ws)(q.Odu.QUICK_ACTIONS, {
        type: K.Qu.AUDIO,
...
function el(e) {
  ...
  let {
    voiceChannel: n,
    locked: l
  } = e, a = r.useRef(null), s = (0, o.e7)([G.Z], () => G.Z.isVideoEnabled()), c = (0, o.e7)([G.Z], () => Object.values(G.Z.getVideoDevices())[0]), u = null == (t = null == c ? void 0 : c.disabled) || t, f = !1 === u, m = (0, k.Z)(n), g = e => {
    ...
    u ? y() : g(!s), (0, K.Ws)(q.Odu.QUICK_ACTIONS, {
      type: K.Qu.CAMERA,
  ...
  } = (0, d.o)(s ? "disable" : "enable"), I = null != n ? (0, A.X)({
    enabled: s,
    cameraUnavailable: u,
    hasPermission: m,
    channel: n
...
function ea(e) {
  ...
  if (g) t = $.intl.string($.t.S5anIS);
    ...
    let e = (0, X.pL)();
    t = u ? null != e ? $.intl.format($.t.AB5gT0, {
      game: e.name
    }) : $.intl.string($.t.FeUKeH) : $.intl.string($.t.uQn9Bw)
  }
  let y = () => {
      if (g) return (0, K.Ws)(q.Odu.QUICK_ACTIONS, {
        type: K.Qu.GO_LIVE,
        value: K.bk.DISABLED,
        userId: V.default.getId()
      }), (0, j.Z)(h, !1);
...
function es(e) {
  ...
  let {
    voiceChannel: l,
    locked: a
  } = e, s = r.useRef(null), c = null != (t = null == l ? void 0 : l.getGuildId()) ? t : null, {
    mute: d,
    suppress: h
  } = (0, D.Z)(l), m = (0, o.e7)([G.Z], () => G.Z.isDeaf()), y = null == l || d || h || m, {
    analyticsLocations: O
  } = (0, g.ZP)();

  function v(e) {
    null != c && ((0, K.Ws)(q.Odu.QUICK_ACTIONS, {
  ...
  } = (0, u.j)(), S = en(a), I = (0, o.e7)([Z.Z, V.default], () => Z.Z.isUserPlayingSounds(V.default.getId()), []) ? "green" : void 0;
  return (0, i.jsx)(p.yRy, {
    targetElementRef: s,
    renderPopout: e => {
      let {
...
function ec(e) {
  let {
    voiceChannel: t,
    locked: n
  } = e, a = r.useRef(null), s = (0, o.e7)([B.Z], () => B.Z.getVoiceChannelId() === (null == t ? void 0 : t.id)), {
    ...
    m.default.selectVoiceChannel(e), (0, K.Ws)(q.Odu.QUICK_ACTIONS, {
      type: K.Qu.CALL_BUTTON,
      value: K.bk.ENABLED,
      userId: V.default.getId()
    })
  }, [h, f] = r.useTransition(), g = e => t => {
    f(() => {
      e(t)
    }), (0, K.Ws)(q.Odu.QUICK_ACTIONS, {
      type: K.Qu.CALL_BUTTON,
...
function eu(e) {
  let {
    voiceChannel: t
  } = e, n = (0, o.e7)([W.Z], () => W.Z.getGuild(t.getGuildId()), [t]);
  switch (!0) {
...
function ep(e) {
  ...
  })), s = null != l, c = (0, o.e7)([Y.Z], () => null != l && Y.Z.hasVideo(l), [l]);
