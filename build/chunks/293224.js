...
function eo(e) {
  ...
  } = (0, d.o)(a ? "disable" : "enable"), I = null != n ? (0, A.X)({
    enabled: a,
    cameraUnavailable: c,
    hasPermission: f,
    channel: n
...
function ea(e) {
  ...
  } = (0, u.j)(), E = et(l), x = (0, o.e7)([N.Z, z.default], () => N.Z.isUserPlayingSounds(z.default.getId()), []) ? "green" : void 0;
  return (0, i.jsx)(p.yRy, {
    renderPopout: e => {
      let {
        closePopout: t
...
function es(e) {
  let {
    voiceChannel: t,
    locked: n
  } = e, a = (0, o.e7)([B.Z], () => B.Z.getVoiceChannelId() === (null == t ? void 0 : t.id)), s = () => {
