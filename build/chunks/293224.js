...
function ea(e) {
  ...
  let {
    ...
    selfMute: c,
    mute: u
  } = (0, D.Z)(n), p = c || u || s, h = (0, O.Z)(c, u, s, !1), {
    Component: f,
    play: g,
    events: y
  } = (0, V.b)(p);
...
function ec(e) {
  ...
  let {
    voiceChannel: n,
    locked: l
  } = e, a = r.useRef(null), s = (0, o.e7)([B.Z], () => B.Z.isVideoEnabled()), c = (0, o.e7)([B.Z], () => Object.values(B.Z.getVideoDevices())[0]), h = null == (t = null == c ? void 0 : c.disabled) || t, f = !1 === h, m = (0, k.Z)(n), g = e => {
    ...
    h ? y() : g(!s), (0, J.Ws)(et.Odu.QUICK_ACTIONS, {
      type: J.Qu.CAMERA,
  ...
  } = (0, u.o)(s ? "disable" : "enable"), I = null != n ? (0, A.X)({
    enabled: s,
    cameraUnavailable: h,
    hasPermission: m,
    channel: n
...
function ed(e) {
  ...
  let {
    ...
    mute: p,
    suppress: f
  } = (0, D.Z)(l), m = (0, o.e7)([B.Z], () => B.Z.isDeaf()), y = null == l || p || f || m, {
  ...
  } = (0, c.j)(), S = eo(a), I = (0, o.e7)([Z.Z, G.default], () => Z.Z.isUserPlayingSounds(G.default.getId()), []) ? "green" : void 0;
  return (0, i.jsx)(d.yRy, {
    targetElementRef: s,
    renderPopout: e => {
      let {
    ...
    children: (e, t) => {
      ...
      return (0, i.jsx)(el, {
        ref: s,
        iconComponent: b,
        tooltip: p ? en.intl.string(en.t["Ox4/zc"]) : f ? en.intl.string(en.t["+YBKYG"]) : m ? en.intl.string(en.t.X1lQlp) : void 0,
        onClick: e => {
...
function ep(e) {
  let {
    ...
    f.default.selectVoiceChannel(e), (0, J.Ws)(et.Odu.QUICK_ACTIONS, {
      type: J.Qu.CALL_BUTTON,
      value: J.bk.ENABLED,
      userId: G.default.getId()
    })
  }, [h, m] = r.useTransition(), g = e => t => {
    m(() => {
      e(t)
    }), (0, J.Ws)(et.Odu.QUICK_ACTIONS, {
      type: J.Qu.CALL_BUTTON,
