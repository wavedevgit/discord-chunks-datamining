...
function el(e) {
  let {
    ...
    selfMute: a,
    mute: c
  } = (0, A.Z)(t), u = a || c || l, d = (0, v.Z)(a, c, l, !1), {
    Component: h,
    play: f,
    events: m
  } = (0, s.O)(u ? "unmute" : "mute");
  ...
  let y = er(n),
    O = e => t => {
      e(t), (0, J.Ws)(ee.Odu.QUICK_ACTIONS, {
  ...
  return (0, i.jsx)(p.yRy, {
    ...
    children: (e, t) => {
      ...
      return (0, i.jsx)(eo, {
        ...
        tooltip: d,
        onClick: () => {
          (0, x.Z)(c, l, ee.jXE.OVERLAY), (0, J.Ws)(ee.Odu.QUICK_ACTIONS, {
            type: J.Qu.MICROPHONE,
...
function ea(e) {
  ...
  r.useEffect(() => () => d(), [c, d]);
  let g = () => {
      (0, _.Z)(s, ee.jXE.OVERLAY), (0, J.Ws)(ee.Odu.QUICK_ACTIONS, {
        type: J.Qu.AUDIO,
...
function es(e) {
  ...
  let {
    voiceChannel: n,
    locked: l
  } = e, a = r.useRef(null), s = (0, o.e7)([B.Z], () => B.Z.isVideoEnabled()), c = (0, o.e7)([B.Z], () => Object.values(B.Z.getVideoDevices())[0]), u = null == (t = null == c ? void 0 : c.disabled) || t, f = !1 === u, m = (0, D.Z)(n), g = e => {
    ...
    u ? y() : g(!s), (0, J.Ws)(ee.Odu.QUICK_ACTIONS, {
      type: J.Qu.CAMERA,
  ...
  } = (0, d.o)(s ? "disable" : "enable"), I = null != n ? (0, R.X)({
    enabled: s,
    cameraUnavailable: u,
    hasPermission: m,
    channel: n
...
function ec(e) {
  ...
  let y = () => {
      if (g) return (0, J.Ws)(ee.Odu.QUICK_ACTIONS, {
        type: J.Qu.GO_LIVE,
        value: J.bk.DISABLED,
        userId: G.default.getId()
      }), (0, C.Z)(h, !1);
...
function eu(e) {
  ...
  let {
    ...
    mute: d,
    suppress: h
  } = (0, A.Z)(l), m = (0, o.e7)([B.Z], () => B.Z.isDeaf()), g = null == l || d || h || m, {
    analyticsLocations: O
  } = (0, y.ZP)();

  function v(e) {
    null != c && ((0, J.Ws)(ee.Odu.QUICK_ACTIONS, {
  ...
  } = (0, u.j)(), S = er(a), I = (0, o.e7)([P.Z, G.default], () => P.Z.isUserPlayingSounds(G.default.getId()), []) ? "green" : void 0;
  return (0, i.jsx)(p.yRy, {
    targetElementRef: s,
    renderPopout: e => {
      let {
      ...
      return g || null == l ? (0, i.jsx)(i.Fragment, {}) : (0, i.jsx)(T.Z, {
        guildId: c,
        channel: l,
        onClose: S(t),
...
function ed(e) {
  let {
    ...
    m.default.selectVoiceChannel(e), (0, J.Ws)(ee.Odu.QUICK_ACTIONS, {
      type: J.Qu.CALL_BUTTON,
      value: J.bk.ENABLED,
      userId: G.default.getId()
    })
...
function ef(e) {
  ...
  return s && null != r && (0, i.jsxs)(i.Fragment, {
    children: [(0, i.jsx)(Z.Z, (t = ei({}, a), n = n = {
      hasVideo: c,
