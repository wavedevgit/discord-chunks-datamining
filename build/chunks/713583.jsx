...
function g(e) {
  ...
  return <div className={a()(g, f.bar)} onContextMenu={v}>{<div className={f.commandInfo}>{<span className={f.name}>{o}</span>}{null != h ? <span className={f.error}>{h}</span> : <span className={f.description}>{_}</span>}</div>}{<div className={f.actions}><l.B onClick={I} /></div>}</div>
}