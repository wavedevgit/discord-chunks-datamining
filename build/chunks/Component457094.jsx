...
(0, Chunk912471.DL)(), Chunk442837.ZP.initialize(), Chunk298969.Z.loadServer(), Chunk358085.isPlatformEmbedded && (Chunk998502.ZP.on("USER_SETTINGS_OPEN", (e, t) => {
  eq.Z.getLayers().includes(e5.S9g.USER_SETTINGS) || (0, eU.openUserSettings)()
...
let tn = (0, Chunk951752.l)(e => {
  ...
  tr = Chunk442837.ZP.connectStores([Chunk38618.Z, Chunk896797.Z, Chunk314897.default], () => ({
    ...
    render() {
      ...
      if (null == require) return (0, Chunk951288.jsx)(Chunk843611.l_, {
        to: Chunk981631.Z5c.DEFAULT_LOGGED_OUT
      });
      if (module) {
        let e = tc(exports);
        return null == module || (module.params.guildId === Chunk981631.ME || null != Chunk430824.Z.getGuild(module.params.guildId)) && null != Chunk592125.Z.getChannel(module.params.channelId) ? (0, Chunk951288.jsx)(Chunk843611.l_, {
          to: exports
  ...
  ti = (0, Chunk951752.l)((0, Chunk77987.e)(Chunk491575.Z, null, {
    passProps: false
  })),
  tl = (0, Chunk77987.e)(Chunk684572.default, null, {
    passProps: false
  }),
  ta = [Chunk981631.Z5c.GUILD_BOOSTING_MARKETING(Chunk893607.Hw.guildId()), ...Array.from(Chunk176505.Vg).map(e => e5.Z5c.CHANNEL(ey.Hw.guildId(), e))];
...
let ts = [{
  ...
  render: function(e) {
    ...
    return (0, Q.h)(() => {
      (0, s.ZDy)(async () => {
        let {
          default: e
        } = await Promise.all([n.e("15076"), n.e("37554")]).then(n.bind(n, 907941));
        return t => {
          var n, l;
          return (0, r.jsx)(e, (n = te({}, t), l = l = {
            guildId: i
  ...
  render: function(e) {
    ...
    return (0, Q.h)(() => {
      ee.Z.open(n, (0, et.Z)(e5.pNK, i), true, (0, et.Z)(e5.KsC, l))
    }), (0, r.jsx)(a.l_, {
      to: e5.Z5c.CHANNEL(n)
    })
  },
...
function tu(e) {
  ...
  i.pathname === r && (null == eF.Z.getChannel(t) ? (0, ev.dL)(e5.Z5c.CHANNEL(n)) : (0, ev.dL)(r))
}
class td extends Chunk647438.PureComponent {
  componentDidMount() {
  ...
  handleHistoryChange(e, t) {
    ...
    function(e, t) {
      ...
      let {
        ...
        messageId: o,
        threadId: s
      } = to(n), c = (0, ey.Ss)(r), u = (0, ey.cq)(i), d = (0, ey.cq)(s), h = eQ.Z.getGuildId(), g = h !== r;
      if (c && g && p.Z.selectGuild(r), c && u) {
        let n = eK.Z.getChannelId(h),
          a = n !== i;
        if (!tt || g || a || null != o) {
          tt = true, f.default.selectChannel({
            guildId: r,
            channelId: i,
            messageId: o
          });
        ...
        if (null != s && d) {
          ...
          if (null != i && null != s && e)
            if (t)(0, ev.dL)(e5.Z5c.CHANNEL(r, s, o));
            else {
              let e = {
                type: eT.Ff.THREAD
              };
    ...
    }(n, r), (0, U.pN)(n, i, o), n !== e5.Z5c.ME || o || e$.ZP.getState().section !== e5.pJs.YOU || d.Z.setSection(e5.pJs.ONLINE)
  }
  ensureChannelMatchesGuild(e) {
    ...
    let {
      ...
      channelId: i,
      threadId: l
    } = to(n), a = (0, ey.Ss)(r) && r !== e5.ME && r !== e5.I_8;
    if (null != i && (0, ey.cq)(i) && !(0, e2.AB)(i) && a) {
      let n = eF.Z.getChannel(i);
      if (null == n) eA.Z.loadThread(i).then(() => tu({
        channelId: i,
        guildId: r,
        pathname: t
      }));
      else if (n.guild_id !== r && r !== e5.STv) return {
        path: e5.Z5c.CHANNEL(r),
        state: e.state
      };
      if (null != l) {
        if (!((0, ey.cq)(l) && !(0, e2.AB)(i))) return null;
        let n = eF.Z.getChannel(l);
        if (null == n) eA.Z.loadThread(l).then(() => tu({
          channelId: l,
          guildId: r,
          pathname: t
        }));
  ...
  render() {
    return (0, Chunk951288.jsxs)(Chunk647438.Fragment, {
      ...
      }), (0, Chunk951288.jsx)(Chunk935347.Z, {})]
    })
  }
  constructor(...e) {
