...
let ti = (0, Chunk951752.l)(e => {
  ...
  ts = [Chunk981631.Z5c.GUILD_BOOSTING_MARKETING(Chunk893607.Hw.guildId()), ...Array.from(Chunk176505.Vg).map(e => e6.Z5c.CHANNEL(eI.Hw.guildId(), e))];
...
let tu = [{
  ...
  render: function(e) {
    ...
    return (0, J.h)(() => (0, eR.openUserProfileModal)({
      userId: n,
  ...
  render: function(e) {
    ...
    return (0, J.h)(() => {
      en.Z.open(n, (0, er.Z)(e6.pNK, i), true, (0, er.Z)(e6.KsC, l))
    }), (0, r.jsx)(a.l_, {
      to: e6.Z5c.CHANNEL(n)
    })
  },
...
class tf extends Chunk647438.PureComponent {
  componentDidMount() {
  ...
  handleHistoryChange(e, t) {
    ...
    function(e, t) {
      ...
      let {
        ...
        messageId: o,
        threadId: s
      } = tc(n), c = (0, eI.Ss)(r), u = (0, eI.cq)(i), d = (0, eI.cq)(s), h = eJ.Z.getGuildId(), g = h !== r;
    ...
    }(n, r), (0, B.pN)(n, i, o), n !== e6.Z5c.ME || o || e1.ZP.getState().section !== e6.pJs.YOU || d.Z.setSection(e6.pJs.ONLINE)
  }
  ensureChannelMatchesGuild(e) {
    ...
    let {
      ...
      channelId: i,
      threadId: l
    } = tc(n), a = (0, eI.Ss)(r) && r !== e6.ME && r !== e6.I_8;
    if (null != i && (0, eI.cq)(i) && !(0, e7.AB)(i) && a) {
      let n = eW.Z.getChannel(i);
      if (null == n) ew.Z.loadThread(i).then(() => tp({
        channelId: i,
        guildId: r,
        pathname: t
      }));
      else if (n.guild_id !== r && r !== e6.STv) return {
      ...
      if (null != l) {
        ...
        if (null == n) ew.Z.loadThread(l).then(() => tp({
          channelId: l,
          guildId: r,
          pathname: t
        }));
