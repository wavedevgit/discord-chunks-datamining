...
let te = (0, Chunk951752.l)(e => {
  ...
  ti = [Chunk981631.Z5c.GUILD_BOOSTING_MARKETING(Chunk893607.Hw.guildId()), ...Array.from(Chunk176505.Vg).map(e => e4.Z5c.CHANNEL(ev.Hw.guildId(), e))];
...
let ta = [{
  ...
  render: function(e) {
    ...
    return (0, X.h)(() => {
      et.Z.open(n, (0, en.Z)(e4.pNK, i), true, (0, en.Z)(e4.KsC, l))
    }), (0, r.jsx)(a.l_, {
      to: e4.Z5c.CHANNEL(n)
    })
  },
...
class tc extends Chunk647438.PureComponent {
  ...
  handleHistoryChange(e, t) {
    ...
    function(e, t) {
      ...
      let {
        ...
        messageId: o,
        threadId: s
      } = tl(n), c = (0, ev.Ss)(r), u = (0, ev.cq)(i), f = (0, ev.cq)(s), h = eq.Z.getGuildId(), g = h !== r;
  ...
  ensureChannelMatchesGuild(e) {
    ...
    let {
      ...
      channelId: i,
      threadId: l
    } = tl(n), a = (0, ev.Ss)(r) && r !== e4.ME && r !== e4.I_8;
    if (null != i && (0, ev.cq)(i) && !(0, e3.AB)(i) && a) {
      let n = eH.Z.getChannel(i);
      if (null == n) eZ.Z.loadThread(i).then(() => ts({
        channelId: i,
        guildId: r,
        pathname: t
      }));
      ...
      if (null != l) {
        ...
        if (null == n) eZ.Z.loadThread(l).then(() => ts({
          channelId: l,
          guildId: r,
          pathname: t
        }));
