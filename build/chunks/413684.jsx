...
function h(e) {
  ...
  return <div>{<g value={n.suppressEveryone} title={c.intl.format(c.t.OWiWAg, {})} onChange={e => h(t, {
        suppress_everyone: e
      }, o.UE.suppressEveryone(e))} />}{<g value={n.suppressRoles} title={c.intl.string(c.t["O/QdoK"])} onChange={e => h(t, {
        suppress_roles: e
      }, o.UE.suppressRoles(e))} />}{<g title={(0, i.jsxs)("div", {
      ...
      })} value={n.highligths === d.gLR.ENABLED} onChange={e => h(t, {
        notify_highlights: e ? d.gLR.ENABLED : d.gLR.DISABLED
      }, o.UE.highlights(e))} />}{<g value={n.muteScheduledEvents} title={c.intl.string(c.t.ONG3Y2)} onChange={e => h(t, {
        mute_scheduled_events: e
      }, o.UE.mutedEvents(e))} />}{<g value={n.mobilePush} title={c.intl.string(c.t["h1DL6+"])} onChange={e => h(t, {
        mobile_push: e
      }, o.UE.mobilePush(e))} />}</div>
}

function g(e) {
  return <l.j7V hideBorder={true} className={u.advanceSetting} value={e.value} onChange={e.onChange} note={e.subtitle}>{e.title}</l.j7V>
}