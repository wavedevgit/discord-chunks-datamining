...
function w(e) {
  ...
  } = (0, d.ZP)([...U, u.Z.COLLECTIBLES_PAYMENT_MODAL]), F = i.useRef(new s.qA), [V, Z] = i.useState(null), [H, W] = i.useState(!1), Y = i.useMemo(() => (0, T.UY)(L), [L]), K = (0, l.Wu)([f.Z], () => f.Z.recommendedGiftSkuIds, []), z = null != L ? [L] : K, q = null !== (t = z[0]) && void 0 !== t ? t : null, Q = null != L && _.Rm.has(L), X = i.useCallback(() => {
    W(!0), null == o || o()
  }, [o]), J = i.useCallback(e => {
