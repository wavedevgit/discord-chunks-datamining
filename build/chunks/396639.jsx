...
let N = {
  ...
  D = e => {
    ...
    if (null == a || null == O) return <i.$jN type={i.$jN.Type.WANDERING_CUBES} />;
    let L = null != (t = v.current) ? t : A,
      k = null != h ? h.orbPriceAmount : null;
    return <n.Fragment>{<y.Z />}{<m.C3>{<f.gY error={g} />}{<f.A3 skuId={E} orbPriceAmount={k} orbBalance={L} />}</m.C3>}{<m.O3><f.f9 orbPriceAmount={k} orbBalance={L} isSubmitting={C} onClickCheckout={N} /></m.O3>}</n.Fragment>
  },
  S = [{
    key: null,
    renderStep: e => <k{...h({}, e)} />
  ...
  T = (e, t, r) => <O.Z isOrbCheckout={true} step={r} onClose={() => t(false)} />,
  I = e => {
    var {
      skuId: t,
    ...
    return <b.PaymentModal applicationId={(0, _.N)(t)} transitionState={i.transitionState} analyticsDataOverride={s} onClose={c} hideShadow={true} skuId={t} renderHeader={T} initialPlanId={null} analyticsLocations={r} />
  },
  w = e => {
    var {
      skuId: t,
    ...
    return <u.PaymentContextProvider applicationId={(0, _.N)(t)} activeSubscription={null} loadId={r} stepConfigs={S} purchaseType={P.GZQ.ONE_TIME} skuIDs={[t]} excludeSubscriptionPlansBySKU={true} excludeSKUPurchasePreviews={true}><j.d skuId={t} loadId={r} onCheckoutSuccess={l} analyticsLocations={o} analyticsSourceLocation={i}><c.b6><I{...h({
            skuId: t,
            analyticsLocations: o
          }, a)} /></c.b6></j.d></u.PaymentContextProvider>
  }