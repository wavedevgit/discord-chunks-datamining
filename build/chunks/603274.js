...
function N() {
  let e = (0, a.Wu)([O.Z, m.Z], () => v.default.keys(O.Z.getFavoriteChannels()).map(e => m.Z.getChannel(e)).filter(y.lm)),
    t = e.map(e => e.id),
    ...
    P = x(c.gj8, l.filter(e => !S.includes(e.id) && !E.includes(e.id))),
    ...
    Z = x(c.hGI, I.filter(e => null != e && !E.includes(e.id))),
    T = x(c.nG3, N);
