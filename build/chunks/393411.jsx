...
function U(e) {
  ...
  return <div className={s()(Z.banner, a)}>{<div className={Z.bannerBackgroundImage} />}{<div className={Z.detailsContainer}>{<div className={Z.image} />}{<div className={Z.details}>{<div className={Z.headerLabel}>{t}{l && null != o && <N.Cy text={D.intl.formatToPlainString(D.t.iiLbvr, {
              percent: o
            })} className={Z.discountPill} colorOptions={N.VE.PREMIUM_TIER_2_WHITE_FILL} isPillOnBorder={false} />}</div>}{n}</div>}</div>}{<div className={Z.buttons}>{r}</div>}</div>
}
...
function V(e) {
  ...
  return <div className={s()(Z.banner, a, Z.repositioned)}>{<div className={Z.bannerBackgroundImage} />}{<div className={Z.detailsContainer}><div className={Z.details}><div className={Z.headerLabel}>{<div className={Z.image} />}{<div className={Z.headerColumnB}>{t}{l && null != o && <N.Cy text={D.intl.formatToPlainString(D.t.iiLbvr, {
                percent: o
              })} className={Z.discountPill} colorOptions={N.VE.PREMIUM_TIER_2_WHITE_FILL} isPillOnBorder={false} />}{n}</div>}</div></div></div>}{<div className={Z.buttons}>{r}</div>}</div>
}

function G() {
  return <div className={Chunk4856.wordMark}>{<Chunk754347.Z className={Chunk4856.discordWordmark} aria-label={Chunk388032.intl.string(Chunk388032.t["FSOz7+"])} />}{<div className={Chunk4856.classicWordmark} />}</div>
}
...
function F() {
  ...
  return <U wordMark={(0, Chunk255367.jsx)(G, {})} subscriptionInfo={(0, Chunk255367.jsx)("div", {
...
let H = function(e) {
  ...
  switch (ec) {
    case P.p9.TIER_0:
      eu = <div className={Z.wordMark}>{<_.Z className={Z.discordWordmark} aria-label={D.intl.string(D.t["t9uG/v"])} />}{<div className={Z.basicWordmark} />}</div>;
      break;
    case P.p9.TIER_1:
      eu = <G />;
      break;
    case P.p9.TIER_2:
      eu = <x.Z className={Z.planName} aria-label={D.intl.string(D.t.lpNrPj)} />
  }
  let em = B.includes(r.status) && !W ? V : U;
  return <em wordMark={eu} subscriptionInfo={l()(null != a, "Expected renewalInvoicePreview"), (0, i.jsx)("div", {
    ...
    })()} statusClasses={ed} shouldUseDiscountMarketing={X} discountAmount={q} />
}