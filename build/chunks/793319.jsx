...
function eC(e) {
  let {
    ...
    if (O && 0 === p.length) return <R.ZP contentTypes={[d.z.TRIAL_NUX_STREAM_COACH_MARK]} bypassAutoDismiss={true}>{e => {
        let {
          visibleContent: t,
          markAsDismissed: n
        } = e;
  ...
  return <r.Fragment>{P()}{<Z.Z><f.yRy targetElementRef={g} renderPopout={e => {
          let {
            closePopout: i
          } = e;
          return (0, r.jsx)(F.Z, {
        ...
        }} position={"top"} align={"center"} spacing={16} animation={f.yRy.Animation.FADE}>{(e, t) => {
          var n = ey({}, eO(e)),
            {
              isShown: i
            } = t;
...
function eR(e) {
  ...
  return (0, y.Z)(a, t.id) ? <div className={eE.buttonContainer}><el.M channel={t} idle={n} whichPopoutIsOpen={i} setWhichPopoutIsOpen={o} /></div> : null
}
  ...
  let P = i.useCallback(() => {
    ...
    w = (e, i) => {
      ...
      switch (A) {
        ...
        case "EVENT":
          return <k.Z channelId={o.id} onClick={() => {
              (0, N.v)(s, N.d.DISCONNECT), h.default.disconnect(), null == n || n()
            }} />
      }
    };
  return <f.yRy targetElementRef={T} renderPopout={e => {
      let {
        closePopout: n
      } = e;
      return (0, r.jsx)(eu.Z, {
    ...
    }} position={"top"} align={"center"} animation={f.yRy.Animation.FADE}>{(e, t) => {
      let {
        onClick: n
      } = e, {
        isShown: i
...
function ew(e) {
  ...
  return <div className={eE.wrapper}>{<X.C enabled={true} centerButton={true} join={true} color={"join"} channelLimitReached={c} channelLimit={d} channel={t} cameraUnavailable={n} hasPermission={o} onCameraUnavailable={_} className={eE.controlButton} onChange={f} />}{<H.Z centerButton={true} color={"join"} channel={t} className={eE.controlButton} />}{p ? <V.Z color={"disconnect"} channel={t} className={eE.controlButton} isTrayButton={false} /> : null}</div>
}
...
let eL = function(e) {
  ...
  let {
  ...
  })), M = (0, w.Z)(), k = (0, u.e7)([P.Z], () => null != P.Z.getAwaitingRemoteSessionInfo()), U = null != M, G = (0, u.e7)([en.Z], () => {
    var e;
    ...
    (0, p.jW)(e, () => Promise.resolve(() => <T.default onClose={p.Zy} renderInputDevices={true} renderOutputDevices={true} renderInputModes={true} renderInputVolume={true} renderOutputVolume={true} renderDeafen={true} minimal={true} onInteraction={eD("AudioDeviceMenu")} />))
  } : true;
  return G ? <v.Gt value={Y}><g.Z section={eh.jXE.VOICE_CONTROL_TRAY}>{<div className={eE.eventPromptsContainer}><j.Z channelId={n.id} /></div>}{<div ref={_} className={a()(eE.wrapper, o)}>{<div className={eE.buttonSection}>{<f.yRy targetElementRef={$} renderPopout={e => {
              let {
                closePopout: t
              } = e;
              return (0, r.jsx)(F.Z, {
            ...
            }} align={"center"} position={"top"} animation={f.yRy.Animation.FADE} spacing={8}>{(e, t) => {
              let {
                onClick: n
              } = e, {
                isShown: i
            ...
            }}</f.yRy>}{!U && <f.yRy targetElementRef={ee} renderPopout={e => {
              let {
                closePopout: t
              } = e;
              return (0, r.jsx)(F.Z, {
            ...
            }} position={"top"} align={"right"} spacing={16} animation={f.yRy.Animation.FADE}>{(e, t) => {
              let {
                onClick: n
              } = e, {
                isShown: i
            ...
            }}</f.yRy>}</div>}{<div className={eE.buttonSection}>{!U && <eC channel={n} currentUser={E} exitFullScreen={c} canGoLive={x} hasPermission={N} />}{!U && <eR channel={n} idle={null == (t = null == d ? true : d.idle) || t} whichPopoutIsOpen={h} setWhichPopoutIsOpen={m} />}{q && <z.Z channel={n} themeable={true} whichPopoutIsOpen={h} setWhichPopoutIsOpen={m} />}{<ec.Z channel={n} whichPopoutIsOpen={h} setWhichPopoutIsOpen={m} remoteMode={U} />}</div>}{<eP connectedEmbeddedActivity={Z} currentUser={E} channel={n} onDisconnectCall={s} />}</div>}</g.Z></v.Gt> : <v.Gt value={Y}><ew channel={n} cameraUnavailable={y} hasCameraPermission={N} currentUser={E} /></v.Gt>
}