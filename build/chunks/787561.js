...
let w = "dismissedCommunityFeaturesUpsell",
  R = () => {
    ...
    return e = "rules_channel_id" === s ? I.intl.string(I.t["7IrBYm"]) : null != s ? i[s] : void 0, (0, r.jsx)(u.Z, {
      submitting: n,
      onReset: () => {
  ...
  Z = e => {
    let {
      ...
      onboardingEnabled: n,
      guild: l
    } = e, [s, u] = i.useState(!0 === c.K.get(w)), g = (0, a.e7)([f.Z], () => {
      var e;
  ...
  D = () => {
    ...
    let p = () => {
      ...
      x = () => {
        e.features.has(N.oNc.DISCOVERABLE) && e.features.has(N.oNc.PARTNERED) ? (0, d.h7j)(e => (0, r.jsx)(d.ConfirmModal, P(T({}, e), {
        ...
        }))) : e.features.has(N.oNc.DISCOVERABLE) ? (0, d.h7j)(e => (0, r.jsx)(d.ConfirmModal, P(T({}, e), {
          header: I.intl.string(I.t.iBnVHR),
          confirmText: I.intl.string(I.t["cY+Ooa"]),
          cancelText: I.intl.string(I.t.oEAioK),
          onConfirm: p,
        ...
        }))) : e.features.has(N.oNc.PARTNERED) ? (0, d.h7j)(e => (0, r.jsx)(d.ConfirmModal, P(T({}, e), {
          header: I.intl.string(I.t.iBnVHR),
          confirmText: I.intl.string(I.t["cY+Ooa"]),
          cancelText: I.intl.string(I.t.oEAioK),
          onConfirm: p,
