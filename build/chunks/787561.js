...
let w = "dismissedCommunityFeaturesUpsell",
  R = () => {
    ...
    return e = "rules_channel_id" === s ? I.intl.string(I.t["7IrBYm"]) : null != s ? i[s] : void 0, (0, r.jsx)(d.Z, {
      submitting: n,
      onReset: () => {
  ...
  Z = e => {
    let {
      ...
      onboardingEnabled: n,
      guild: l
    } = e, [s, d] = i.useState(!0 === c.K.get(w)), g = (0, a.e7)([f.Z], () => {
      var e;
    ...
    let j = (0, a.e7)([x.Z], () => x.Z.getGuild("942897714956472401")),
      _ = l.isCommunity() && g >= 1e3 && h && null == j;
  ...
  D = () => {
    ...
    let p = () => {
        ...
        t.delete(N.oNc.COMMUNITY), t.delete(N.oNc.DISCOVERABLE), t.delete(N.oNc.PREVIEW_ENABLED), v.Z.updateGuild({
          features: t,
          rulesChannelId: null,
      ...
      x = () => {
        e.features.has(N.oNc.DISCOVERABLE) && e.features.has(N.oNc.PARTNERED) ? (0, u.h7j)(e => (0, r.jsx)(u.ConfirmModal, P(T({}, e), {
        ...
        }))) : e.features.has(N.oNc.DISCOVERABLE) ? (0, u.h7j)(e => (0, r.jsx)(u.ConfirmModal, P(T({}, e), {
          header: I.intl.string(I.t.iBnVHR),
          confirmText: I.intl.string(I.t["cY+Ooa"]),
          cancelText: I.intl.string(I.t.oEAioK),
          onConfirm: p,
        ...
        }))) : e.features.has(N.oNc.PARTNERED) ? (0, u.h7j)(e => (0, r.jsx)(u.ConfirmModal, P(T({}, e), {
          header: I.intl.string(I.t.iBnVHR),
          confirmText: I.intl.string(I.t["cY+Ooa"]),
          cancelText: I.intl.string(I.t.oEAioK),
          onConfirm: p,
    ...
    return (0, r.jsxs)(u.hjN, {
      ...
      children: [d ? (0, r.jsx)(Z, {
        ...
        var n;
        if (null != e) return (0, r.jsxs)(u.hjN, {
          children: [(0, r.jsx)(u.vwX, {
            className: E.formTitle,
  ...
  k = () => {
    let e = (0, a.e7)([O.Z], () => O.Z.getGuild());
    return null == e ? null : e.features.has(N.oNc.COMMUNITY) ? (0, r.jsx)(D, {}) : (0, r.jsx)(C.Z, {
      guild: e
    })
  }