...
class O extends(r = s.Component) {
  ...
  renderTierMarkerTooltip(e) {
    ...
    return (0, i.jsx)("div", {
      children: this.getTierDisabled(e) ? (0, i.jsx)("div", {
        children: h.NW.formatToPlainString(f.Z["9CtPjo"], {
          perk: e.name
        })
      }) : (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)("div", {
  ...
  constructor(...e) {
    ...
    }), x(this, "foregroundTooltipElementRef", s.createRef()), x(this, "tierMarkerMaskId", (0, c.Z)()), x(this, "handleForegroundMouseEnter", e => {
      this.setState({
