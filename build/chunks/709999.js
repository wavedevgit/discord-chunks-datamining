...
let em = e => {
  ...
  eN = 12633 == n.j ? function(e) {
    ...
    } = (0, b.ZP)([...q ? [N.Z.COLLECTIBLES_SHOP_HOME_SCREEN] : [], N.Z.COLLECTIBLES_SHOP_CARD]), eu = i.useRef(null), ef = (0, f.Z)(eu), [eN, eb] = i.useState(!1), e_ = ef || eN, eE = (0, et.f)(t), {
      previewingVariantIndex: ej
    } = eE, eC = (0, L.T)(t), eO = (0, g.e7)([x.Z], () => x.Z.useReducedMotion), ev = y.ZP.canUseCollectibles(n), eS = i.useMemo(() => (0, D.BH)(t, ev), [t, ev]), eT = (0, D.G1)(t), eI = (0, D.rN)(t), [ey, eA, eP] = (0, g.Wu)([P.Z], () => [P.Z.isClaiming === t.skuId, null != P.Z.isClaiming && P.Z.isClaiming !== t.skuId, P.Z.purchases]), eR = (0, ee.o)(t, eP, ej), eD = (0, g.e7)([O.Z], () => (0, h.wjy)(O.Z.theme)), eZ = (0, D.Yq)(t.skuId), ew = s.skuId === u.T.ANIME_V3 && (0, D.WW)(t.skuId), {
      hoverVariant: ek
    } = (0, Z.E)("CollectiblesShopTallCard"), eW = s.skuId === u.T.STORM && "1268362891946627103" === t.skuId, eL = (0, k.hv)("CollectiblesShopTallCard"), eB = (0, R.o)(t, eP), eM = (0, $.W)(t, eB), eU = (0, D.XM)(eM, ev, !1), {
      isPurchased: eV,
    ...
    let eQ = i.useRef(null),
      ...
      e4 = e => n => {
        eQ.current = n.currentTarget, (0, H.T)({
          product: t,
          category: s,
          shouldCheckoutWithOrbs: e3,
          analyticsLocations: es,
    ...
    let te = () => eT || d.tq || e6 || t.type === m.Z.NAMEPLATE || !eF || J === ei.AW.ORBS ? null : eI ? (0, r.jsx)(eg, {
        onClick: e9
      }) : (0, r.jsx)(G.Z, {
        product: t,
      ...
      tn = () => (0, r.jsx)(em, {
        ...
        children: el.NW.formatToPlainString(el.t["cNSL/v"], {
          price: eU
        })
      }),
      tr = () => (0, r.jsx)(em, {
      ...
      children: (0, r.jsx)(h.tEY, {
        children: (0, r.jsxs)(h.kL8, {
          ...
          children: [eT && (0, r.jsx)(h.ua7, {
            ...
            children: (0, c.EQ)(t.type).with(m.Z.PROFILE_EFFECT, () => (0, r.jsx)(ep, {
              isHighlighted: e_,
              profileEffectId: eR.id,
              isPurchased: eV
            })).with(m.Z.AVATAR_DECORATION, () => (o()(eR.type === m.Z.AVATAR_DECORATION, "ts-match already checked the type"), (0, r.jsx)(eh, {
              item: eR,
              user: n,
              isStormMysteryItem: eW,
              isHighlighted: e_,
              isPurchased: eV
            }))).with(m.Z.NAMEPLATE, () => (0, r.jsx)(ex, {
              user: n,
              nameplate: eR,
              isHighlighted: e_,
              isPurchased: eV
            })).with(m.Z.BUNDLE, () => (0, r.jsx)(X.d, {
              product: t,
              user: n,
              isPurchased: eV,
              isHighlighted: e_
              ...
              return null == e ? null : (0, c.EQ)(e.type).with(m.Z.PROFILE_EFFECT, () => {
                ...
                let [t] = e.items;
                return o()(t.type === m.Z.AVATAR_DECORATION, "ts-match already checked the type"), (0, r.jsx)(eh, {
                  item: t,
                  user: n,
                  isStormMysteryItem: eW,
                  isHighlighted: e_,
            ...
            }).with(m.Z.EXTERNAL_SKU, () => (0, r.jsx)(z.b, {
              product: t,
            ...
            className: a()(eo.cardText, eD ? eo.darkCardBackground : eo.lightCardBackground, {
              [eo.variantsGroup]: t.type === m.Z.VARIANTS_GROUP
            }),
            children: [(0, r.jsx)(h.Text, {
              variant: "text-lg/bold",
              className: eo.productName,
              children: eC
            }), t.type === m.Z.VARIANTS_GROUP ? (0, r.jsx)(K.P, {
            ...
            disableColor: !0,
            className: eo.badge
          }) : s.skuId === u.T.NAMEPLATE && eq ? (0, r.jsx)(h.IGR, {
