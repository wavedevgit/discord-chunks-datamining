...
let ep = e => {
    var {
      children: t,
      onClick: i
    } = e, l = eu(e, ["children", "onClick"]);
    return (0, r.jsx)(m.zxk, ed(ec({
      fullWidth: !0,
  ...
  eO = e => {
    ...
    } = (0, B.E)(i.skuId, t === el.AW.CATALOG ? "full" : t);
    return (0, r.jsx)(g.$, {
      innerRef: l,
      onChange: s,
      threshold: 0,
  ...
  ef = 12633 == i.j ? l.memo(function(e) {
    var {
      tab: t,
      product: i,
      onMount: n
    } = e, s = eu(e, ["tab", "product", "onMount"]);
...
function ex(e) {
  let {
    ...
    isDisabled: b,
    discount: f
  } = e, j = (0, k.sp)(), y = (0, T.rN)(t), [S, L] = (0, h.Wu)([w.Z], () => [w.Z.isClaiming === t.skuId, null != w.Z.isClaiming && w.Z.isClaiming !== t.skuId]), N = (0, R.hv)("CollectiblesShopTallCard"), W = (0, T.XM)(l, c, !1), H = (0, T.ne)({
    product: l,
    isPartiallyOwnedBundle: v,
    isPurchased: g
  }), {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)("div", {
      ...
      children: (0, r.jsxs)("div", {
        ...
        })(), u || d.tq || Q || !H || i === el.AW.ORBS ? null : y ? (0, r.jsx)(eh, {
          onClick: F
        }) : (0, r.jsx)(k.k0, {
          newValue: {
            pageCategory: i === el.AW.HOME || null == j ? void 0 : j.pageCategory
          },
...
let eC = 12633 == i.j ? l.memo(function(e) {
    let {
      product: t,
      user: i,
      category: n,
      ...
      analyticsLocations: A
    } = (0, f.ZP)([O.Z.COLLECTIBLES_SHOP_CARD]), w = (0, k.sp)(), L = (0, v.Z)(d), [R, Z] = l.useState(!1), B = L || R, M = (0, H.T)(t), V = (0, h.e7)([b.Z], () => b.Z.useReducedMotion), z = S.ZP.canUseCollectibles(i), K = l.useMemo(() => (0, T.BH)(t, z), [t, z]), Q = (0, T.G1)(t), Y = (0, h.e7)([y.Z], () => (0, m.wjy)(y.Z.theme)), J = (0, T.Yq)(t.skuId), $ = n.skuId === u.T.ANIME_V3 && (0, T.WW)(t.skuId), {
      hoverVariant: ee
      ...
      isDisabled: es
    } = (0, W.G)(g.skuId), eu = null !== E ? E : C, [ep, eh] = l.useState(!1);
    l.useEffect(() => {
      let {
        current: e
      } = d;
    ...
    let ev = l.useRef(null),
      ...
      eC = l.useCallback(e => i => {
        let r = (0, ei.oQ)({
          product: t
        });
        ev.current = i.currentTarget, I.default.track(en.rMx.COLLECTIBLES_SHOP_ELEMENT_CLICKED, {
          ...
          page_index: a === el.AW.CATALOG ? null == w ? void 0 : w.pageIndex : void 0,
          page_size: a === el.AW.CATALOG ? null == w ? void 0 : w.pageSize : void 0,
          tile_type: p.Z[t.type],
    ...
    return 0 === eO.length || (0, T.x6)(t) && null != K && K.discountPercentage < 0 ? null : (0, r.jsx)(m.tEY, {
      children: (0, r.jsxs)(m.kL8, {
        className: s()(P, Y ? eo.shopCardDark : eo.shopCard, {
          [eo.partiallyOwned]: er && !B,
          [eo.shopCardAnimation]: !V && ee !== N.D.NO_MOVEMENT,
        ...
        children: [Q && (0, r.jsx)(m.ua7, {
          ...
          children: e => (0, r.jsx)(m.IGR, ed(ec({}, e), {
          ...
          children: (0, c.EQ)(t.type).with(p.Z.PROFILE_EFFECT, () => (0, r.jsx)(eg, {
            isHighlighted: B,
            profileEffectId: x.id,
            isPurchased: et
          })).with(p.Z.AVATAR_DECORATION, () => (o()(x.type === p.Z.AVATAR_DECORATION, "ts-match already checked the type"), (0, r.jsx)(em, {
            item: x,
            user: i,
            isHighlighted: B,
            isPurchased: et
          }))).with(p.Z.NAMEPLATE, () => (0, r.jsx)(eb, {
            user: i,
            nameplate: x,
            isHighlighted: B,
            isPurchased: et
          })).with(p.Z.BUNDLE, () => (0, r.jsx)(X.d, {
            product: t,
            user: i,
            isPurchased: et,
            isHighlighted: B
            ...
            return null == e ? null : (0, c.EQ)(e.type).with(p.Z.PROFILE_EFFECT, () => {
              ...
              let [t] = e.items;
              return o()(t.type === p.Z.AVATAR_DECORATION, "ts-match already checked the type"), (0, r.jsx)(em, {
                item: t,
                user: i,
                isHighlighted: B,
                isPurchased: et
          ...
          }).with(p.Z.EXTERNAL_SKU, () => (0, r.jsx)(U.b, {
            product: t,
          ...
          return null == e ? null : (0, r.jsx)("div", {
            ...
            children: (0, r.jsx)(e, {
              ...
              width: 38,
              height: 38,
              className: s()(eo.cardStateIcon, {
                [eo.checkmark]: et
              })
            })
          })
        })(), (0, r.jsxs)("div", {
          className: s()(eo.cardText, Y ? eo.darkCardBackground : eo.lightCardBackground, {
            [eo.variantsGroup]: t.type === p.Z.VARIANTS_GROUP
          }),
          children: [(0, r.jsx)(m.Text, {
            variant: "text-lg/bold",
            className: eo.productName,
            children: M
          }), t.type === p.Z.VARIANTS_GROUP ? (0, r.jsx)(q.P, {
