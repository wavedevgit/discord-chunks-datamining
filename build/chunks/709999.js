...
let eu = e => {
  ...
  em = 12633 == s.j ? function(e) {
    ...
    } = (0, g.ZP)([m.Z.COLLECTIBLES_SHOP_CARD]), ec = i.useRef(null), ef = (0, f.Z)(ec), [em, eg] = i.useState(!1), eL = ef || em, ev = (0, et.f)(t), {
      previewingVariantIndex: eF
    } = ev, eZ = (0, T.T)(t), eE = (0, p.e7)([j.Z], () => j.Z.useReducedMotion), eb = y.ZP.canUseCollectibles(s), ew = i.useMemo(() => (0, _.BH)(t, eb), [t, eb]), eO = (0, _.G1)(t), ey = (0, _.rN)(t), [ek, eP, eN] = (0, p.Wu)([P.Z], () => [P.Z.isClaiming === t.skuId, null != P.Z.isClaiming && P.Z.isClaiming !== t.skuId, P.Z.purchases]), e_ = (0, ee.o)(t, eN, eF), eR = (0, p.e7)([E.Z], () => (0, x.wjy)(E.Z.theme)), eS = (0, _.Yq)(t.skuId), eI = r.skuId === c.T.ANIME_V3 && (0, _.WW)(t.skuId), {
      hoverVariant: eM
    } = (0, R.E)("CollectiblesShopTallCard"), eA = (0, I.hv)("CollectiblesShopTallCard"), eT = (0, N.o)(t, eN), eH = (0, $.W)(t, eT), eB = (0, _.XM)(eH, eb, !1), {
      isPurchased: eD,
      isPartiallyOwnedBundle: eV
    } = (0, H.L)(eH), {
      isDisabled: eU
    } = (0, A.G)(eH.skuId), eG = (0, _.ne)({
      product: eH,
      isPartiallyOwnedBundle: eV,
      isPurchased: eD
    }), eW = null !== eF ? eF : eT, [ez, eq] = i.useState(!1), {
      enabled: eK
    } = (0, b.W)({
      location: "collectibles_shop_tall_card"
    }), eY = (0, L.N)("CollectiblesShopTallCard"), {
      handleCardVisibilityChange: eX
    } = (0, B.E)(eH.skuId, Y === ei.AW.CATALOG ? "full" : Y), eQ = (0, S.E)("shop_tall_card");
    i.useEffect(() => {
      let {
        current: e
      } = ec;
    ...
    let eJ = i.useRef(null),
      ...
      e7 = e => s => {
        eJ.current = s.currentTarget, (0, W.T)({
          product: t,
          category: r,
          shouldCheckoutWithOrbs: e9,
          analyticsLocations: er,
    ...
    let te = () => eO || d.tq || e8 || t.type === u.Z.NAMEPLATE || !eG || Y === ei.AW.ORBS ? null : ey ? (0, l.jsx)(ep, {
        onClick: e6
      }) : (0, l.jsx)(U.Z, {
        product: t,
    ...
    return (0, _.x6)(t) && null != ew && ew.discountPercentage < 0 ? null : (0, l.jsx)(h.$, {
      innerRef: ec,
      onChange: eX,
      threshold: 0,
      children: (0, l.jsx)(x.tEY, {
        children: (0, l.jsxs)(x.kL8, {
          ...
          children: [eO && (0, l.jsx)(x.ua7, {
            ...
            children: e => (0, l.jsx)(x.IGR, ed(eC({}, e), {
            ...
            children: (0, C.EQ)(t.type).with(u.Z.PROFILE_EFFECT, () => (0, l.jsx)(eh, {
              isHighlighted: eL,
              profileEffectId: e_.id,
              isPurchased: eD
            })).with(u.Z.AVATAR_DECORATION, () => (a()(e_.type === u.Z.AVATAR_DECORATION, "ts-match already checked the type"), (0, l.jsx)(ex, {
              item: e_,
              user: s,
              isHighlighted: eL,
              isPurchased: eD
            }))).with(u.Z.NAMEPLATE, () => (0, l.jsx)(ej, {
              user: s,
              nameplate: e_,
              isHighlighted: eL,
              isPurchased: eD
            })).with(u.Z.BUNDLE, () => (0, l.jsx)(X.d, {
              product: t,
              user: s,
              isPurchased: eD,
              isHighlighted: eL
              ...
              return null == e ? null : (0, C.EQ)(e.type).with(u.Z.PROFILE_EFFECT, () => {
                ...
                let [t] = e.items;
                return a()(t.type === u.Z.AVATAR_DECORATION, "ts-match already checked the type"), (0, l.jsx)(ex, {
                  item: t,
                  user: s,
                  isHighlighted: eL,
                  isPurchased: eD
            ...
            }).with(u.Z.EXTERNAL_SKU, () => (0, l.jsx)(z.b, {
              product: t,
            ...
            return null == e ? null : (0, l.jsx)("div", {
              ...
              children: (0, l.jsx)(e, {
                ...
                width: 38,
                height: 38,
                className: n()(ea.cardStateIcon, {
                  [ea.checkmark]: eD
                })
              })
            })
          })(), (0, l.jsxs)("div", {
            className: n()(ea.cardText, eR ? ea.darkCardBackground : ea.lightCardBackground, {
            ...
            children: [(0, l.jsx)(x.Text, {
              ...
              children: eZ
            }), t.type === u.Z.VARIANTS_GROUP ? (0, l.jsx)(K.P, {
            ...
            disableColor: !0,
            className: ea.badge
          }) : r.skuId === c.T.NAMEPLATE && eY ? (0, l.jsx)(x.IGR, {
