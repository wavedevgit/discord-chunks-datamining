...
let ed = e => {
  ...
  ef = 12633 == n.j ? function(e) {
    let {
      ...
      isPartiallyOwnedBundle: eU,
      isPurchased: eM
    }), eG = null !== e_ ? e_ : eW, [eF, eH] = i.useState(!1), {
      enabled: ez
    } = (0, v.W)({
      location: "collectibles_shop_tall_card"
    }), eY = (0, _.N)("CollectiblesShopTallCard"), {
      handleCardVisibilityChange: eK
    } = (0, L.E)(eL.skuId, Y ? "home" : "full"), eq = (0, D.E)("shop_tall_card");
    i.useEffect(() => {
      let {
        current: e
      } = ec;
      ...
      children: (0, r.jsx)(h.tEY, {
        children: (0, r.jsxs)(h.kL8, {
          ...
          children: [ev && (0, r.jsx)(h.ua7, {
            ...
            children: e => (0, r.jsx)(h.IGR, eo(el({}, e), {
            ...
            children: (0, c.EQ)(t.type).with(m.Z.PROFILE_EFFECT, () => (0, r.jsx)(em, {
              ...
              return null == e ? null : (0, c.EQ)(e.type).with(m.Z.PROFILE_EFFECT, () => {
                ...
                let [t] = e.items;
                return o()(t.type === m.Z.AVATAR_DECORATION, "ts-match already checked the type"), (0, r.jsx)(eg, {
                  item: t,
                  user: n,
                  isStormMysteryItem: ew,
                  isHighlighted: eb,
            ...
            className: a()(ea.cardText, eP ? ea.darkCardBackground : ea.lightCardBackground, {
              [ea.variantsGroup]: t.type === m.Z.VARIANTS_GROUP
            }),
            ...
            disableColor: !0,
            className: ea.badge
          }) : s.skuId === u.T.NAMEPLATE && eY ? (0, r.jsx)(h.IGR, {
