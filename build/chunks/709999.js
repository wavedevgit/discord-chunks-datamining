...
let eu = e => {
  ...
  em = 12633 == s.j ? function(e) {
    ...
    } = (0, g.ZP)([m.Z.COLLECTIBLES_SHOP_CARD]), er = i.useRef(null), ec = (0, f.Z)(er), [ef, em] = i.useState(!1), eg = ec || ef, eL = (0, et.f)(t), {
      previewingVariantIndex: ev
    } = eL, eF = (0, T.T)(t), eZ = (0, p.e7)([j.Z], () => j.Z.useReducedMotion), eE = y.ZP.canUseCollectibles(s), eb = i.useMemo(() => (0, _.BH)(t, eE), [t, eE]), ew = (0, _.G1)(t), eO = (0, _.rN)(t), [ey, ek, eP] = (0, p.Wu)([P.Z], () => [P.Z.isClaiming === t.skuId, null != P.Z.isClaiming && P.Z.isClaiming !== t.skuId, P.Z.purchases]), eN = (0, ee.o)(t, eP, ev), e_ = (0, p.e7)([E.Z], () => (0, x.wjy)(E.Z.theme)), eR = (0, _.Yq)(t.skuId), eS = r.skuId === c.T.ANIME_V3 && (0, _.WW)(t.skuId), {
      hoverVariant: eI
    } = (0, R.E)("CollectiblesShopTallCard"), eM = (0, I.hv)("CollectiblesShopTallCard"), eA = (0, N.o)(t, eP), eT = (0, $.W)(t, eA), eH = (0, _.XM)(eT, eE, !1), {
      isPurchased: eB,
      isPartiallyOwnedBundle: eD
    } = (0, H.L)(eT), {
      isDisabled: eV
    } = (0, A.G)(eT.skuId), eU = (0, _.ne)({
      product: eT,
      isPartiallyOwnedBundle: eD,
      isPurchased: eB
    }), eG = null !== ev ? ev : eA, [eW, ez] = i.useState(!1), {
      enabled: eq
    } = (0, b.W)({
      location: "collectibles_shop_tall_card"
    }), eK = (0, L.N)("CollectiblesShopTallCard"), {
      handleCardVisibilityChange: eY
    } = (0, B.E)(eT.skuId, Y === ei.AW.CATALOG ? "full" : Y), eX = (0, S.E)("shop_tall_card");
    i.useEffect(() => {
      let {
        current: e
      } = er;
    ...
    let eQ = i.useRef(null),
      ...
      e0 = e => s => {
        eQ.current = s.currentTarget, (0, W.T)({
          product: t,
          category: r,
          shouldCheckoutWithOrbs: e8,
          analyticsLocations: Q,
    ...
    let e4 = () => ew || d.tq || e5 || t.type === u.Z.NAMEPLATE || !eU || Y === ei.AW.ORBS ? null : eO ? (0, l.jsx)(ep, {
        onClick: e3
      }) : (0, l.jsx)(U.Z, {
        product: t,
    ...
    return (0, _.x6)(t) && null != eb && eb.discountPercentage < 0 ? null : (0, l.jsx)(h.$, {
      innerRef: er,
      onChange: eY,
      threshold: 0,
        ...
        children: (0, l.jsxs)(x.kL8, {
          ...
          children: [ew && (0, l.jsx)(x.ua7, {
            ...
            children: (0, C.EQ)(t.type).with(u.Z.PROFILE_EFFECT, () => (0, l.jsx)(eh, {
              ...
              isPurchased: eB
            })).with(u.Z.AVATAR_DECORATION, () => (a()(eN.type === u.Z.AVATAR_DECORATION, "ts-match already checked the type"), (0, l.jsx)(ex, {
              item: eN,
              user: s,
              isHighlighted: eg,
              isPurchased: eB
            ...
            className: n()(ea.cardText, e_ ? ea.darkCardBackground : ea.lightCardBackground, {
            ...
            disableColor: !0,
            className: ea.badge
          }) : r.skuId === c.T.NAMEPLATE && eK ? (0, l.jsx)(x.IGR, {
