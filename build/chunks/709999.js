...
let eu = e => {
  ...
  em = e => {
    ...
    } = (0, B.E)(i.skuId, t === ea.AW.CATALOG ? "full" : t);
    return (0, r.jsx)(g.$, {
      innerRef: l,
      onChange: s,
      threshold: 0,
...
function ex(e) {
  let {
    ...
    isDisabled: x,
    discount: C
  } = e, E = (0, k.sp)(), P = (0, L.rN)(t), [I, N] = (0, h.Wu)([T.Z], () => [T.Z.isClaiming === t.skuId, null != T.Z.isClaiming && T.Z.isClaiming !== t.skuId]), w = (0, R.hv)("CollectiblesShopTallCard"), W = (0, L.XM)(l, d, !1), H = (0, L.ne)({
    product: l,
    isPartiallyOwnedBundle: v,
    isPurchased: g
  }), {
    ...
    product: l
  }), U = o(f.Z.COLLECTIBLES_SHOP_CARD_PREVIEW_BUTTON), q = (0, F._)(t.eligibleOffers), Q = null != q, {
    displayPrices: X,
  ...
  let ei = () => (0, r.jsx)("div", {
    ...
    eu = () => {
      let e = () => {
        ...
        l = Q ? eo.intl.formatToPlainString(eo.t["5U5RBw"], {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)("div", {
      ...
      children: (0, r.jsxs)("div", {
        ...
        children: [(() => {
        ...
        })(), u || c.tq || J || !H || i === ea.AW.ORBS ? null : P ? (0, r.jsx)(m.hU, {
          variant: "primary",
          ...
          newValue: {
            pageCategory: i === ea.AW.HOME || null == E ? void 0 : E.pageCategory
          },
...
let ef = 12633 == i.j ? l.memo(function(e) {
    let {
      product: t,
      user: i,
      category: a,
    ...
    } = (0, C.ZP)([f.Z.COLLECTIBLES_SHOP_CARD]), T = (0, k.sp)(), N = (0, v.Z)(c), [R, Z] = l.useState(!1), B = N || R, G = (0, H.T)(t), z = (0, h.e7)([x.Z], () => x.Z.useReducedMotion), V = I.ZP.canUseCollectibles(i), F = l.useMemo(() => (0, L.BH)(t, V), [t, V]), K = (0, L.G1)(t), X = (0, h.e7)([P.Z], () => (0, m.wjy)(P.Z.theme)), J = (0, L.Yq)(t.skuId), $ = a.skuId === u.T.ANIME_V3 && (0, L.WW)(t.skuId), {
      hoverVariant: ee
    } = (0, w.E)("CollectiblesShopTallCard"), {
      isPurchased: et,
      isPartiallyOwnedBundle: ei
    } = (0, M.L)(g), {
      isDisabled: el
    } = (0, W.G)(g.skuId), en = null !== y ? y : O, [eh, em] = l.useState(!1);
    l.useEffect(() => {
      let {
        current: e
      } = c;
    ...
    let ev = l.useRef(null),
      ...
      e_ = l.useCallback(e => i => {
        ...
        ev.current = i.currentTarget, A.default.track(es.rMx.COLLECTIBLES_SHOP_ELEMENT_CLICKED, {
    ...
    return 0 === ef.length || (0, L.x6)(t) && null != F && F.discountPercentage < 0 ? null : (0, r.jsx)(m.tEY, {
      children: (0, r.jsxs)(m.kL8, {
        ...
        children: [K && (0, r.jsx)(m.ua7, {
          ...
          children: (0, d.EQ)(t.type).with(p.Z.PROFILE_EFFECT, () => (0, r.jsx)(eu, {
            isHighlighted: B,
            profileEffectId: _.id,
            isPurchased: et
          })).with(p.Z.AVATAR_DECORATION, () => (o()(_.type === p.Z.AVATAR_DECORATION, "ts-match already checked the type"), (0, r.jsx)(ep, {
            item: _,
            user: i,
            isHighlighted: B,
            isPurchased: et
          }))).with(p.Z.NAMEPLATE, () => (0, r.jsx)(eg, {
            user: i,
            nameplate: _,
            isHighlighted: B,
            isPurchased: et
            ...
            return null == e ? null : (0, d.EQ)(e.type).with(p.Z.PROFILE_EFFECT, () => {
              ...
              let [t] = e.items;
              return o()(t.type === p.Z.AVATAR_DECORATION, "ts-match already checked the type"), (0, r.jsx)(ep, {
                item: t,
                user: i,
                isHighlighted: B,
                isPurchased: et
          ...
          }).with(p.Z.EXTERNAL_SKU, () => (0, r.jsx)(q.b, {
            product: t,
          ...
          return null == e ? null : (0, r.jsx)("div", {
            ...
            children: (0, r.jsx)(e, {
              ...
              width: 38,
              height: 38,
              className: s()(ed.cardStateIcon, {
                [ed.checkmark]: et
              })
            })
          })
        })(), (0, r.jsxs)("div", {
          className: s()(ed.cardText, X ? ed.darkCardBackground : ed.lightCardBackground, {
