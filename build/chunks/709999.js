...
let eh = e => {
  ...
  eL = 12633 == s.j ? function(e) {
    let {
      ...
      analyticsLocations: $
    } = (0, g.ZP)([m.Z.COLLECTIBLES_SHOP_CARD]), eo = i.useRef(null), ep = (0, f.Z)(eo), [em, eL] = i.useState(!1), ev = ep || em, eF = (0, el.f)(t), {
      previewingVariantIndex: eZ
    } = eF, eE = (0, B.T)(t), eb = (0, p.e7)([j.Z], () => j.Z.useReducedMotion), ew = P.ZP.canUseCollectibles(s), ey = i.useMemo(() => (0, S.BH)(t, ew), [t, ew]), eO = (0, S.G1)(t), ek = (0, S.rN)(t), [eP, eN, e_] = (0, p.Wu)([_.Z], () => [_.Z.isClaiming === t.skuId, null != _.Z.isClaiming && _.Z.isClaiming !== t.skuId, _.Z.purchases]), eR = (0, es.o)(t, e_, eZ), eS = (0, p.e7)([E.Z], () => (0, x.wjy)(E.Z.theme)), eI = (0, S.Yq)(t.skuId), eM = r.skuId === c.T.ANIME_V3 && (0, S.WW)(t.skuId), {
      hoverVariant: eA
    } = (0, I.E)("CollectiblesShopTallCard"), eT = (0, A.hv)("CollectiblesShopTallCard"), eH = (0, R.o)(t, e_), eB = (0, et.W)(t, eH), eD = (0, S.XM)(eB, ew, !1), {
      isPurchased: eV,
      isPartiallyOwnedBundle: eU
    } = (0, D.L)(eB), {
      isDisabled: eG
    } = (0, H.G)(eB.skuId), eW = (0, S.ne)({
      product: eB,
      isPartiallyOwnedBundle: eU,
      isPurchased: eV
    ...
    } = (0, V.E)(eB.skuId, Q === en.AW.CATALOG ? "full" : Q), eJ = (0, M.E)("shop_tall_card");
    i.useEffect(() => {
      let {
        current: e
      } = eo;
    ...
    let e$ = i.useRef(null),
      ...
      e3 = e => s => {
        e$.current = s.currentTarget, (0, q.T)({
          product: t,
          category: r,
          shouldCheckoutWithOrbs: e0,
          analyticsLocations: $,
    ...
    let tt = () => eO || d.tq || e9 || t.type === u.Z.NAMEPLATE || !eW || Q === en.AW.ORBS ? null : ek ? (0, l.jsx)(ex, {
        onClick: e4
      }) : (0, l.jsx)(W.Z, {
        product: t,
    ...
    return (0, S.x6)(t) && null != ey && ey.discountPercentage < 0 ? null : (0, l.jsx)(h.$, {
      innerRef: eo,
      onChange: eQ,
      threshold: 0,
      children: (0, l.jsx)(x.tEY, {
        children: (0, l.jsxs)(x.kL8, {
          ...
          children: [eO && (0, l.jsx)(x.ua7, {
            ...
            className: n()(ed.cardText, eS ? ed.darkCardBackground : ed.lightCardBackground, {
