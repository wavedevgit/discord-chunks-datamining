...
let v = function() {
  ...
  return <Chunk255367.Fragment>{(T === Chunk550385.wh.CLIENT_THEMES || R) && <Chunk724145.Z markAsDismissed={R ? C : () => {
        (0, Chunk266454.Q3)(Chunk704215.z.CLIENT_THEMES_COACHMARK, {
          dismissAction: Chunk921944.L.INDIRECT_ACTION,
          forceTrack: true
        })
      }} showClientThemesCoachmark={R} />}{T === Chunk550385.wh.APP_ICON && <Chunk907459.Z isCoachmark={false} markAsDismissed={C} />}{(T === Chunk550385.wh.CUSTOM_THEME || P) && <w metadata={null != S ? S : {}} markAsDismissed={C} isCoachmark={P} />}</Chunk255367.Fragment>
}