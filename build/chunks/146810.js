        ...
        onKeyDown(t) {
          if (R(t.nativeEvent, t.currentTarget) && (0, _.bE)(t.currentTarget, (0, _.NI)(t.nativeEvent))) {
            ...
            if (!e.isPressed && !t.repeat) {
              ...
              G((0, p.r3)(t.currentTarget), "keyup", (0, h.t)(o, n), true)
            }
          ...
          if ((!t || (0, _.bE)(t.currentTarget, (0, _.NI)(t.nativeEvent))) && t && 0 === t.button && !e.isTriggeringEvent && !g.nG.isOpening) {
            ...
            if (u && t.preventDefault(), !e.ignoreEmulatedMouseEvents && !e.isPressed && ("virtual" === e.pointerType || (0, E.Z)(t.nativeEvent))) {
              ...
              let r = e.pointerType || t.nativeEvent.pointerType || "virtual",
                ...
                o = F(P(t.currentTarget, t), r, true);
    ...
    if ("undefined" != typeof PointerEvent) {
      t.onPointerDown = t => {
        ...
        if (!e.isPressed) {
          ...
          let a = (0, _.NI)(t.nativeEvent);
          "releasePointerCapture" in a && a.releasePointerCapture(t.pointerId), G((0, p.r3)(t.currentTarget), "pointerup", n, false), G((0, p.r3)(t.currentTarget), "pointercancel", o, false)
        }
        r && t.stopPropagation()
      }, t.onMouseDown = t => {
...
function R(e, t) {
  ...
  return ("Enter" === n || " " === n || "Spacebar" === n || "Space" === r) && !(i instanceof(0, p.kR)(i).HTMLInputElement && !L(i, n) || i instanceof(0, p.kR)(i).HTMLTextAreaElement || i.isContentEditable) && !(("link" === o || !o && N(i)) && "Enter" !== n)
}
