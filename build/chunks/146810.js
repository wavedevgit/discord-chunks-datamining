/** Chunk was on web.js **/
/** chunk id: 146810, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  r: () => C
});
var Chunk500260 = require("./500260.js"),
  Chunk830044 = require("./830044.js"),
  Chunk217012 = require("./217012.js"),
...
function C(e) {
  let {
    ...
    ref: L,
    ...j
  } = O(e), [k, M] = (0, y.useState)(false), U = (0, y.useRef)({
    isPressed: false,
    ...
    return n && n(true), r.isTriggeringEvent = false, r.didFirePressStart = true, M(true), i
  }), V = (0, f.i)((e, r, i = true) => {
    let a = U.current;
    ...
    if (t.isPressed && t.target) {
      for (let n of (t.didFirePressStart && null != t.pointerType && V(P(t.target, e), t.pointerType, false), t.isPressed = false, t.isOverTarget = false, t.activePointerId = null, t.pointerType = null, B(), x || (0, i.A)(t.target), t.disposables)) n();
      t.disposables = []
    }
  }), Y = (0, f.i)(e => {
    w && H(e)
    ...
    let e = U.current,
          ...
          if (R(t.nativeEvent, t.currentTarget) && (0, _.bE)(t.currentTarget, (0, _.NI)(t.nativeEvent))) {
            ...
            if (!e.isPressed && !t.repeat) {
              ...
              let r = t.currentTarget,
                a = t => {
                  R(t, r) && !t.repeat && (0, _.bE)(r, (0, _.NI)(t)) && e.target && F(P(e.target, t), "keyboard")
                };
          ...
          if ((!t || (0, _.bE)(t.currentTarget, (0, _.NI)(t.nativeEvent))) && t && 0 === t.button && !e.isTriggeringEvent && !g.nG.isOpening) {
            ...
            if (u && t.preventDefault(), !e.ignoreEmulatedMouseEvents && !e.isPressed && ("virtual" === e.pointerType || (0, E.Z)(t.nativeEvent))) {
              ...
              let r = e.pointerType || t.nativeEvent.pointerType || "virtual",
                i = F(P(t.currentTarget, t), r),
                a = V(P(t.currentTarget, t), r, true);
      ...
      n = t => {
        ...
        if (e.isPressed && e.target && R(t, e.target)) {
          ...
          V(P(e.target, t), "keyboard", i), i && K(t, e.target), B(), "Enter" !== t.key && N(e.target) && (0, _.bE)(e.target, n) && !t[T] && (t[T] = true, (0, g.nG)(e.target, t, false)), e.isPressed = false, null == (r = e.metaKeyEvents) || r.delete(t.key)
    ...
    if ("undefined" != typeof PointerEvent) {
      t.onPointerDown = t => {
        ...
        (0, _.bE)(t.currentTarget, (0, _.NI)(t.nativeEvent)) && "virtual" !== e.pointerType && (0 !== t.button || e.isPressed || F(t, e.pointerType || t.pointerType))
      }, t.onPointerEnter = t => {
        ...
        t.pointerId === e.activePointerId && e.target && e.isOverTarget && null != e.pointerType && (e.isOverTarget = false, V(P(e.target, t), e.pointerType, false), Y(t))
      };
      let n = t => {
