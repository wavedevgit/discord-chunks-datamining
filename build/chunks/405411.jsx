...
function d(e) {
  ...
  return 0 === n.length ? null : <div className={c.sectionContainer}>{<i.X6q variant={"heading-lg/semibold"} color={"header-primary"}>{o.intl.string(o.t.swIgTE)}</i.X6q>}{<div className={c.contentContainer}>{n.map(e => (0, r.jsxs)("div", {
