...
let U = Chunk73800.memo(function() {
  return <svg width={"184"} height={"428"} viewBox={"0 0 184 428"} className={Chunk555614.empty}>{<rect x={40} y={6} width={144} height={20} rx={10} />}{<circle cx={16} cy={16} r={16} />}{<rect x={40} y={50} width={144} height={20} rx={10} opacity={.9} />}{<circle cx={16} cy={60} r={16} opacity={.9} />}{<rect x={40} y={94} width={144} height={20} rx={10} opacity={.8} />}{<circle cx={16} cy={104} r={16} opacity={.8} />}{<rect x={40} y={138} width={144} height={20} rx={10} opacity={.7} />}{<circle cx={16} cy={148} r={16} opacity={.7} />}{<rect x={40} y={182} width={144} height={20} rx={10} opacity={.6} />}{<circle cx={16} cy={192} r={16} opacity={.6} />}{<rect x={40} y={226} width={144} height={20} rx={10} opacity={.5} />}{<circle cx={16} cy={236} r={16} opacity={.5} />}{<rect x={40} y={270} width={144} height={20} rx={10} opacity={.4} />}{<circle cx={16} cy={280} r={16} opacity={.4} />}{<rect x={40} y={314} width={144} height={20} rx={10} opacity={.3} />}{<circle cx={16} cy={324} r={16} opacity={.3} />}{<rect x={40} y={358} width={144} height={20} rx={10} opacity={.2} />}{<circle cx={16} cy={368} r={16} opacity={.2} />}{<rect x={40} y={402} width={144} height={20} rx={10} opacity={.1} />}{<circle cx={16} cy={412} r={16} opacity={.1} />}</svg>
});
class G extends(r = Chunk73800.Component) {
  ...
  constructor(...e) {
    super(...e), L(this, "state", {
      ...
      this.hasReportedAnalytics = true, m.ZP.trackWithMetadata(A.rMx.DM_LIST_VIEWED, k(M({}, u, (0, O.X)()), {
      ...
      return null == a ? null : <y.W channel={a} selected={a.id === l} aria-posinset={s + t + 1} aria-setsize={o} />
      ...
      return 0 === t ? this.renderChild(n) : 0 === n && 0 === r.length ? <U /> : this.renderDM(t, n)
      ...
      return 0 !== t && n ? <C.Z className={D.privateChannelsHeaderContainer}>{<span className={D.headerText}>{R.intl.string(R.t.YUU0RE)}</span>}{<S.Z location={"PrivateChannelsList-CreateDMButton"} tooltip={R.intl.string(R.t["6Urw1t"])} tooltipPosition={"top"} popoutAlign={"left"} className={D.privateChannelRecipientsInviteButtonIconContainer} iconClassName={D.privateChannelRecipientsInviteButtonIcon} icon={h.BRu} subscribeToGlobalHotkey={true} />}</C.Z> : null
...
let B = e => {
  ...
  return <b.Gt value={y}><a.bG navigator={V}><G{...k(M({}, e), {
        density: t,
        channels: O,
        privateChannelIds: _,
        listRef: R,
