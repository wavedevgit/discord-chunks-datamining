...
function p(e) {
  ...
  let {
    ...
    if (null != A && null !== m && (null != A.avatar || null != m)) return <l.Z user={n} nickname={P} />
  };
  return <div className={_.body} inert={true}>{<a.Z user={n} usernameIcon={w()} nickname={P} pronouns={R} isTryItOut={I} tags={(0, r.jsx)(o.Z, {
        displayProfile: p,
        themeType: f.lY.POPOUT,
        pendingLegacyUsernameDisabled: O,
        pendingBadges: v,
        shouldOpenBadgeTooltip: S
      })} />}{!T && null != C && "" !== C && <s.Z user={n} bio={C} hidePersonalInformation={N} viewFullBioDisabled={true} />}</div>
}