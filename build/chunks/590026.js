...
let p = new Set([Chunk876215.s.PLAYED_GAME, Chunk876215.s.WATCHED_MEDIA, Chunk876215.s.TOP_GAME, Chunk876215.s.TOP_ARTIST, Chunk876215.s.LISTENED_SESSION, Chunk876215.s.LAUNCHED_ACTIVITY]);
...
function h(e) {
  ...
  t = (0, o.Z)({
    ...
    entries: t
  }), t = r.useMemo(() => null == t ? true : t.filter(e => p.has(e.content_type)), [t]);
  let {
    entries: n,
    filteredIds: i
  } = (0, c.Z)(t);
