...
function E(e, t) {
  if (e.length > t) throw Error(u.intl.formatToPlainString(u.t.mee4qa, {
    limit: t
  }));
  e.forEach(e => {
    if (e.length > c.hu || e.length < c.Vk) throw new o.V6(u.intl.formatToPlainString(u.t.rbRvGR, {
      keyword: e,
      max: c.hu,
      min: c.Vk
    }))
...
function b(e) {
  if (e.length > c.VW) throw Error(u.intl.formatToPlainString(u.t.tDjhFx, {
    limit: c.VW
  }));
  e.forEach(e => {
    if (e.length > c.aj || e.length < c.uE) throw new o.uS(u.intl.formatToPlainString(u.t["WR0m9/"], {
      regex: e,
      max: c.aj,
      min: c.uE
    }))
