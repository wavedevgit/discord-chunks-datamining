...
function f(e) {
  ...
  return <div className={s.container} style={{
      width: "".concat(m, "px"),
      height: "".concat(m, "px")
    }}>{<img className={s.frame} src={h} style={{
        width: m + 8,
        height: m + 8
      }} alt={""} />}{<o.Z className={_} user={t} size={p} />}{"hidden" !== f && <div className={s.rankBadge}><a._ rank={n} hideInnerBorder={"visibleWithoutBorder" === f} /></div>}</div>
}