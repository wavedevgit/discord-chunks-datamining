...
function T(e) {
  let {
    ...
    null != T && (N ? ((0, l.hg)(T.id), (0, o.OoC)((0, E.n)(w, null == C ? true : C.guild_id)), null == n || n(), p.default.track(b.HAw.APP_PROFILE_OPEN_APP_BUTTON_CLICKED, {
      application_id: T.id
    })) : (0, m.o)(A({
      applicationId: T.id
    }, T)))
  ...
  let {
    customInstallUrl: D
  } = T, L = null == D || h.A.isDiscordUrl(D) ? o.j96 : o.I9m, x = N ? true : L;
