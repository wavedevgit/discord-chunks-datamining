...
function x(e) {
    ...
    N = (0, l.NX)(P),
    {
      ...
      return {
        guildHasVoice: (() => {
          if (E) return !1;
          for (let e in l)
            if (S(g.Z.getBasicChannel(l[e].channelId), null != r ? r : void 0, b.Z)) return !0;
          return !1
        })(),
        guildHasVideo: (() => {
          if (E) return !1;
          for (let t of i) {
            var e;
            if (S(g.Z.getBasicChannel(null == (e = l[t]) ? void 0 : e.channelId), null != r ? r : void 0, b.Z)) return !0
          }
          return !1
        })(),
  ...
  return (0, i.cj)([_.Z, g.Z, o.ZP, d.Z, p.Z, b.Z], () => {
    ...
    return l ? (c = !0, f = (null == x ? void 0 : x.channel_id) === i, m = S, O = D, y = P, C = M) : (c = w, f = null != x, m = j, O = Z, y = R, C = L), {
      audio: c,
      video: O,
      screenshare: y,
      liveStage: m,
