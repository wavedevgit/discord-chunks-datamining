...
function E(e) {
    ...
    x = (0, l.NX)(E),
    {
      ...
      return {
        guildHasVoice: (() => {
          if (n) return !1;
          for (let e in o)
            if (j(g.Z.getBasicChannel(o[e].channelId), null != i ? i : void 0, b.Z)) return !0;
          return !1
        })(),
        guildHasVideo: (() => {
          if (n) return !1;
  ...
  return (0, i.cj)([y.Z, g.Z, o.ZP, d.Z, p.Z, b.Z], () => {
    ...
    return f ? (m = !0, _ = (null == r ? void 0 : r.channel_id) === c, v = T, O = D, j = A, E = k) : (m = N, _ = null != r, v = Z, O = I, j = R, E = L), {
      audio: m,
      video: O,
      screenshare: j,
      liveStage: v,
