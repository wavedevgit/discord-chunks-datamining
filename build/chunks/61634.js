...
function E(e) {
    ...
    x = (0, l.NX)(E),
    {
      ...
      return {
        guildHasVoice: (() => {
          if (n) return !1;
          for (let e in o)
            if (S(g.Z.getBasicChannel(o[e].channelId), null != i ? i : void 0, b.Z)) return !0;
          return !1
        })(),
        guildHasVideo: (() => {
          if (n) return !1;
  ...
  return (0, i.cj)([O.Z, g.Z, o.ZP, d.Z, p.Z, b.Z], () => {
    ...
    return f ? (m = !0, y = (null == r ? void 0 : r.channel_id) === c, v = T, _ = D, S = A, E = k) : (m = P, y = null != r, v = Z, _ = I, S = R, E = L), {
      audio: m,
      video: _,
      screenshare: S,
      liveStage: v,
