...
function x(e) {
  ...
  let n = (0, i.e7)([O.ZP], () => O.ZP.isMuted(e)),
    ...
    x = (0, i.Wu)([o.ZP, _.Z], () => {
      ...
      return j ? t.filter(e => !(0, a.BA)([...e.userIds], _.Z.getBlockedOrIgnoredIDs())) : t
    }),
    ...
    I = (0, l.NX)(N),
    {
      ...
      return {
        guildHasVoice: (() => {
          if (n) return !1;
          for (let e in o)
            if (E(m.Z.getBasicChannel(o[e].channelId), null != i ? i : void 0, y.Z)) return !0;
          return !1
        })(),
        guildHasVideo: (() => {
          if (n) return !1;
          for (let t of l) {
            var e;
            if (E(m.Z.getBasicChannel(null == (e = o[t]) ? void 0 : e.channelId), null != i ? i : void 0, y.Z)) return !0
          }
          return !1
        })(),
    ...
    T = g.default.getId();
  return (0, i.cj)([v.Z, m.Z, o.ZP, h.Z, f.Z, y.Z], () => {
    var t, i, l;
    ...
    return u ? (g = !0, b = (null == r ? void 0 : r.channel_id) === c, _ = A, O = L, C = R, E = M) : (g = P, b = null != r, _ = N, O = w, C = D, E = k), {
      audio: g,
      video: O,
      screenshare: C,
      liveStage: _,
