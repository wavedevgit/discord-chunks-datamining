...
function S(e) {
    ...
    E = (0, l.NX)(S),
    {
      ...
      return {
        guildHasVoice: (() => {
          if (n) return !1;
          for (let e in o)
            if (x(g.Z.getBasicChannel(o[e].channelId), null != i ? i : void 0, b.Z)) return !0;
          return !1
        })(),
        guildHasVideo: (() => {
          if (n) return !1;
  ...
  return (0, i.cj)([_.Z, g.Z, o.ZP, d.Z, p.Z, b.Z], () => {
    ...
    return f ? (m = !0, y = (null == r ? void 0 : r.channel_id) === c, O = T, v = D, x = A, S = k) : (m = I, y = null != r, O = Z, v = P, x = R, S = L), {
      audio: m,
      video: v,
      screenshare: x,
      liveStage: O,
