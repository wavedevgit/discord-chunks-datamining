...
function P(e) {
  ...
  let n = (0, i.e7)([O.ZP], () => O.ZP.isMuted(e)),
    ...
    N = (0, l.NX)(I),
    {
      ...
      return {
        guildHasVoice: (() => {
          if (n) return !1;
          for (let e in o)
            if (S(m.Z.getBasicChannel(o[e].channelId), null != i ? i : void 0, y.Z)) return !0;
          return !1
        })(),
        guildHasVideo: (() => {
          if (n) return !1;
    ...
    T = g.default.getId();
  return (0, i.cj)([v.Z, m.Z, o.ZP, p.Z, f.Z, y.Z], () => {
    var t, i, l;
    ...
    return u ? (g = !0, b = (null == r ? void 0 : r.channel_id) === c, _ = A, O = L, j = D, S = M) : (g = Z, b = null != r, _ = I, O = w, j = R, S = k), {
      audio: g,
      video: O,
      screenshare: j,
      liveStage: _,
