...
function S(e) {
    ...
    x = (0, l.NX)(S),
    {
      ...
      return {
        guildHasVoice: (() => {
          if (n) return !1;
          for (let e in o)
            if (E(g.Z.getBasicChannel(o[e].channelId), null != i ? i : void 0, b.Z)) return !0;
          return !1
        })(),
        guildHasVideo: (() => {
          if (n) return !1;
  ...
  return (0, i.cj)([O.Z, g.Z, o.ZP, d.Z, p.Z, b.Z], () => {
    ...
    return f ? (m = !0, _ = (null == r ? void 0 : r.channel_id) === c, y = T, v = D, E = A, S = M) : (m = I, _ = null != r, y = Z, v = P, E = R, S = L), {
      audio: m,
      video: v,
      screenshare: E,
      liveStage: y,
