...
function x(e) {
  ...
  let n = (0, i.e7)([O.ZP], () => O.ZP.isMuted(e)),
    ...
    I = (0, l.NX)(N),
    {
      ...
      return {
        guildHasVoice: (() => {
          if (n) return !1;
          for (let e in o)
            if (E(m.Z.getBasicChannel(o[e].channelId), null != i ? i : void 0, _.Z)) return !0;
          return !1
        })(),
        guildHasVideo: (() => {
          if (n) return !1;
    ...
    T = g.default.getId();
  return (0, i.cj)([v.Z, m.Z, o.ZP, h.Z, f.Z, _.Z], () => {
    var t, i, l;
    ...
    return u ? (g = !0, b = (null == r ? void 0 : r.channel_id) === c, y = A, O = L, C = R, E = M) : (g = P, b = null != r, y = N, O = w, C = D, E = k), {
      audio: g,
      video: O,
      screenshare: C,
      liveStage: y,
