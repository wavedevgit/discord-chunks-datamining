...
let U = {
    ...
    parse(e, t, n) {
      ...
      return null == i ? j(null, r, null, S(n.channelId)) : M(i, null, S(n.channelId))
    }
  },
  G = {
    channelMention: U,
    channelOrMessageUrl: {
      ...
      parse(e, t, n) {
        ...
        let s = P(a, null);
        return null == s ? j(i, a, o, S(n.channelId), r) : M(s, o, S(n.channelId), r)
      }
    },
    mediaPostLink: {
      order: i().defaultRules.url.order - .5,
      ...
      parse(e, t, n) {
        ...
        let c = P(a, null);
        return null != c ? M(c, s, S(n.channelId), r) : j(i, a, s, S(n.channelId), r)
      }
    }
  }