...
function x(e) {
  ...
  }), x = (0, a.e7)([g.Z], () => g.Z.getGuild(n.guild_id)), j = null != x ? x.getIconURL(32, !0) : null, O = !s || u && !m;
  return ((0, d.Z)({
...
function v(e) {
  let {
    ...
    recipientUserId: n,
    isUserRinging: i
  } = e, l = i ? y.intl.string(y.t.ygslb2) : y.intl.string(y.t["3Hv9qa"]), o = i ? () => u.Z.stopRinging(t, [n]) : () => {
