...
function x(e) {
  ...
  }), g = (0, a.e7)([b.Z], () => b.Z.getGuild(n.guild_id)), x = null != g ? g.getIconURL(32, !0) : null, O = !s || u && !m;
  return ((0, d.Z)({
...
function j(e) {
  let {
    ...
    recipientUserId: n,
    isUserRinging: i
  } = e, o = (0, m.Q3)("RingUserButton"), a = i ? v.NW.string(v.t.ygslb2) : v.NW.string(v.t["3Hv9qa"]), d = i ? () => u.Z.stopRinging(t, [n]) : () => {
