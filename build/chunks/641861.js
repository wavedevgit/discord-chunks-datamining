...
function v(e) {
  ...
  }), v = (0, s.e7)([g.Z], () => g.Z.getGuild(n.guild_id)), T = null != v ? (0, m.EB)(v, 32, !0) : null, S = !l || u && !h;
  return ((0, d.Z)({
...
function I(e) {
  let {
    ...
    recipientUserId: n,
    isUserRinging: i
  } = e, a = i ? "critical-secondary" : "secondary", o = i ? y.intl.string(y.t.ygslb2) : y.intl.string(y.t["3Hv9qa"]), s = i ? () => u.Z.stopRinging(t, [n]) : () => {
