...
function v(e) {
  ...
  }), v = (0, a.e7)([b.Z], () => b.Z.getGuild(n.guild_id)), O = null != v ? (0, g.EB)(v, 32, !0) : null, E = !s || u && !m;
  return ((0, d.Z)({
...
function j(e) {
  let {
    ...
    recipientUserId: n,
    isUserRinging: i
  } = e, l = i ? C.intl.string(C.t.ygslb2) : C.intl.string(C.t["3Hv9qa"]), o = i ? () => u.Z.stopRinging(t, [n]) : () => {
