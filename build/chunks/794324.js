...
let f = e => {
    ...
    return r.useMemo(() => {
      ...
      let u = (0, d.ZS)(e.categorySkuId),
        f = null != n || null != i,
        _ = null != n && null == i,
        p = null != e.responsive || null != e.backgroundStyle ? {
  ...
  _ = (e, t) => {
    ...
    return r.useMemo(() => {
      ...
      return {
        featuredBlockBanner: null != (r = null != n ? n : null == t ? void 0 : t.bannerUrl) ? r : o
      }
    }, [n, e, t])
  },
  p = e => {
  ...
  m = e => {
    let {
      category: t
    } = (0, o.l)(e.skuId), n = (0, c.zL)(u.jE.COLLECTED_MODAL_BG);
    return r.useMemo(() => {
      var r;
      return {
  ...
  g = e => {
    ...
    return r.useMemo(() => {
      ...
      if ((null == e ? void 0 : e.type) === i.Z.COACHMARK) return {
        hasPreviewAssets: !1
      };
