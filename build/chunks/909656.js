...
function k(e) {
  let {
    ...
    ref: o,
    width: c
  } = (0, h.ZP)(), u = (0, f.Z)(D), d = i.useMemo(() => u.map(e => R(w({}, e), {
    icon: function() {
      let {
        icon: t
      } = e;
...
function A(e) {
  ...
  let {
    ...
    format: s
  } = (0, N.Z)(n.id), a = (0, O.YB)(n.id), c = i.useCallback(() => {
    var e;
  ...
  }, [a]), [m, h] = i.useState(s), [f, v] = i.useState(null != (t = null == a ? void 0 : a.description) ? t : ""), [D, A] = i.useState(c), [L, M] = i.useState(null == a ? void 0 : a.store_page_guild_products_default_sort), [G, U] = i.useState(null == a ? void 0 : a.server_shop_tab_order), {
    loading: B,
    error: F,
    ...
    imageAriaLabel: W,
    setFilename: V
  } = (0, y.Z)(null == a ? void 0 : a.cover_image_asset), Y = (0, x.Dt)(), K = (0, x.Dt)(), X = (0, x.Dt)();
    ...
    children: [null != F && (0, r.jsxs)(r.Fragment, {
      ...
      children: [(0, r.jsxs)(g.hjN, {
        ...
        children: [(0, r.jsx)(g.R94, {
          ...
          value: m,
          onChange: e => {
            s !== e && e === E.e3.ALL_CHANNELS && (0, g.h7j)(e => (0, r.jsx)(g.ConfirmModal, R(w({}, e), {
