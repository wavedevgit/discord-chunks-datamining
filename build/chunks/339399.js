...
var r = n(796774),
  ...
  f = function(e, t, n) {
    var r, i, f, _ = o(n),
      ...
      E = +(e < 0 || 0 === e && 1 / e < 0),
      v = 0;
    for ((e = a(e)) != e || e === 1 / 0 ? (i = +(e != e), r = h) : (f = s(2, -(r = l(c(e) / u))), e * f < 1 && (r--, f *= 2), r + m >= 1 ? e += g / f : e += g * s(2, 1 - m), e * f >= 2 && (r++, f /= 2), r + m >= h ? (i = 0, r = h) : r + m >= 1 ? (i = d((e * f - 1) * s(2, t)), r += m) : (i = d(e * s(2, m - 1) * s(2, t)), r = 0)); t >= 8;) _[v++] = 255 & i, i /= 256, t -= 8;
