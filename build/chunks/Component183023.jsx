...
let J = 32,
  ...
  ei = e => {
    ...
    let {
      ...
      demoMode: L = false,
      nonce: U
    } = e, G = (0, l.e7)([M.default], () => M.default.getCurrentUser()), z = (0, l.e7)([j.Z], () => j.Z.getGuildId()), q = Z.ZP.isPremium(G), X = null != z && (z === (null == v ? true : v.id) || z === (null == T ? true : T.id)), Q = null != T, J = null != (t = null == v ? true : v.isDiscoverable()) && t;
