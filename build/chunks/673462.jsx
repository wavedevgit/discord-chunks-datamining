...
function u(e) {
  ...
  return <audio id={"ClipsPlayerAudioTrack:".concat(n)} className={s.hidden} ref={o} src={l} muted={i} preload={"auto"} onLoadedMetadata={u} />
}
let c = Chunk73800.forwardRef(function(e, t) {
  ...
  })), null == n) ? null : <a.Fragment>{<o.Z onClick={P} className={p ? s.hidden : s.displayVideo} ref={k} src={n} muted={true} onLoadedData={f} preload={"auto"} />}{<audio id={"ClipsPlayerAudioTrack:application"} src={c} muted={!d} preload={"auto"} className={s.hidden} ref={e => S(e, "application")} onLoadedMetadata={O} />}{x.map(e => <u audioTrackLabel={e} setRef={S} src={c} muted={!m} />)}</a.Fragment>
})