...
let I = e => {
  ...
  return O && null != S && (null == T ? true : T.type) === p.B.CONFETTI ? <o.P3F onFocus={A} onClick={N} aria-label={g.intl.string(g.t.Mp5k6O)}><o.ua7 text={g.intl.formatToPlainString(g.t["FE++aG"], {
        user: S
      })}>{e => (0, r.jsxs)("div", v(y({
        ref: b,
