...
let E = e => {
  ...
  C = e => {
    ...
    } = e, I = r.useRef(null), N = (0, u.Er)(), y = (0, m.v)(N), A = s === f.R0.WHATS_NEW, P = (0, u.IY)(), R = (0, g.x)();
    r.useEffect(() => {
      A && !y && (P(), R())
    }, [P, R, A, y]);
    let D = () => {
    ...
    return (0, i.jsxs)(i.Fragment, {
      children: [(null == k || null == (t = k.tenureRewardCollectible) ? void 0 : t.name) === h.u.TENURE_REWARD_COLLECTIBLE && (0, i.jsx)(a.O_, {
        ref: F,
