...
let _ = e => {
  ...
  E = e => {
    ...
    } = e, T = i.useRef(null), I = (0, u.Er)(), y = (0, m.v)(I), A = s === f.R0.WHATS_NEW, P = (0, u.IY)(), R = (0, g.x)();
    i.useEffect(() => {
      A && !y && (P(), R())
    }, [P, R, A, y]);
    let D = () => {
        ...
        children: [(0, r.jsx)(_, {
          ...
          children: M.map((e, t) => {
            ...
            return (0, r.jsx)(N.Z, (n = function(e) {
              ...
              confettiCanvas: e.name === h.u.TENURE_REWARD_COLLECTIBLE ? V : void 0
            }, e), i = i = {
              forceShadow: E
