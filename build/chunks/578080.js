...
let M = s.forwardRef(function(e, t) {
  ...
  }, [J, K]), ec = ee.features.has(B.S7.POST_ENROLLMENT_CTA), eu = (0, b.Rf)(K), ed = (0, b.Jf)(K), ep = null != ed ? ed.progress > 0 : eu.progressSeconds > 0, em = (null == (n = K.userStatus) ? void 0 : n.enrolledAt) != null, eg = (null == (o = K.userStatus) ? void 0 : o.completedAt) != null, ef = s.useMemo(() => (0, j.Xv)(K.config), [K.config]), ex = U && H, eh = (0, O.DD)({
    quest: K,
    taskDetails: eu,
    location: B.dr.QUESTS_BAR,
    questContent: C.jn.QUEST_BAR,
