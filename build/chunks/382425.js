...
function q(e) {
  let {
  ...
  } = (0, P.Xo)(), er = (0, s.e7)([S.Z], () => S.Z.getGuild(null == a ? void 0 : a.guildId)), ei = (0, s.e7)([I.Z], () => I.Z.getChannel(null == a ? void 0 : a.channelId)), ea = (0, s.Wu)([N.ZP], () => null != ei ? N.ZP.getVoiceStatesForChannel(ei).map(e => {
    let {
      user: t
    } = e;
    return t
  ...
  } = (0, h.ZP)(p.Z.USER_PROFILE_LIVE_ACTIVITY_CARD), el = (0, C.Z)({
    display: "live",
    ...
    previewUrl: ef,
    isLoading: e_
  } = (0, E.Z)(a.guildId, a.channelId, a.ownerId), ep = (0, s.e7)([T.Z], () => null != ei && T.Z.canBasicChannel(Z.S7T.CONNECT, ei)), eh = (0, d.Z)(e_ ? null : ef), em = e_ || null == ef ? eh : ef;
  ...
  let eg = () => {
      ...
      return null == em && e_ ? (0, r.jsx)("div", {
        className: W.preview,
        children: (0, r.jsx)(l.$jN, {})
      }) : null == em ? (0, r.jsxs)(l.P3F, {
        className: o()(W.preview, W.overlay, {
          [W.clickable]: eu
        }),
        onClick: eu ? e : void 0,
    ...
    eE = () => {
      ...
      let e = e => {
          ...
          }), ei.isGuildStageVoice() ? (0, O.Cq)(ei) : (c.default.selectVoiceChannel(ei.id), (0, y.Kh)(ei.id)), null == Q || Q()
        },
        n = e => {
          e.stopPropagation(), el({
            action: "OPEN_VOICE_GUILD"
          }), (0, v.X)(er.id), null == Q || Q()
        };
      return (0, r.jsxs)("div", {
        className: Y.details,
        children: [(0, r.jsxs)("div", {
          ...
          size: l.EFr.SIZE_16,
          onClick: e => {
            null == e || e.stopPropagation(), null == el || el({
    ...
    eb = () => $ === F.lY.MODAL ? null : (0, r.jsx)(U.Z, {
      user: t,
      guild: er,
      channel: ei,
      onAction: el,
    ...
    eI = null != eo ? H.intl.formatToPlainString(H.t["4CQq9f"], {
      name: eo.name
