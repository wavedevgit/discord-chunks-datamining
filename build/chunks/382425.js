...
function Y(e) {
  let {
  ...
  } = (0, N.Xo)(), $ = (0, s.e7)([v.Z], () => v.Z.getGuild(null == a ? void 0 : a.guildId)), ee = (0, s.e7)([y.Z], () => y.Z.getChannel(null == a ? void 0 : a.channelId)), et = (0, s.Wu)([S.ZP], () => null != ee ? S.ZP.getVoiceStatesForChannel(ee).map(e => {
    let {
      user: t
    } = e;
    return t
    ...
    previewUrl: el,
    isLoading: ec
  } = (0, E.Z)(a.guildId, a.channelId, a.ownerId), eu = (0, s.e7)([O.Z], () => null != ee && O.Z.canBasicChannel(G.S7T.CONNECT, ee)), ed = (0, d.Z)(ec ? null : el), ef = ec || null == el ? ed : el;
  ...
  let e_ = () => {
      ...
      return null == ef && ec ? (0, r.jsx)("div", {
        ...
        className: o()(F.preview, F.overlay, {
          [F.clickable]: eo
        }),
        onClick: eo ? e : void 0,
