...
function W(e) {
  let {
    ...
    interactionSource: J,
    interactionSourceId: $
  } = (0, C.Xo)(), ee = (0, s.e7)([v.Z], () => v.Z.getGuild(null == o ? void 0 : o.guildId)), et = (0, s.e7)([O.Z], () => O.Z.getChannel(null == o ? void 0 : o.channelId)), en = (0, s.Wu)([S.ZP], () => null != et ? S.ZP.getVoiceStatesForChannel(et).map(e => {
    let {
      user: t
    } = e;
    return t
