...
function S(e) {
  ...
  })), E = new p.Z(n), S = N && (null == i ? void 0 : i.id) === E.id, T = n.tokenStatus === C.q.INVALID, P = l || E.isPomelo() ? null : "#".concat(E.discriminator), w = null;
  return S ? w = (0, s.jsx)(u.Text, {
    ...
    children: (0, s.jsxs)("div", {
      ...
      children: [(0, s.jsx)(u.qEK, {
        src: E.getAvatarURL(void 0, 40),
        size: u.EFr.SIZE_40,
        "aria-label": n.username
      }), (0, s.jsxs)("div", {
        className: a()(y.usernameSection, {
          [y.hasActionMaxWidth]: !S
        }),
        children: [(0, s.jsxs)("div", {
        ...
        children: [!S && (0, s.jsx)(u.zxk, {
          variant: "secondary",
          text: T ? b.intl.string(b.t["DSN+h4"]) : t,
          onClick: function() {
            if (T) return void r(0, n.id);
            g.default.track(O.rMx.MULTI_ACCOUNT_SWITCH_ATTEMPT, {
              location: {
                section: O.jXE.MANAGE_ACCOUNTS_MODAL
              }
            }), v.yD(n.id), r(1, n.id)
          }
        }), (0, s.jsx)(c.zx, {
              ...
              return (0, s.jsx)(u.v2r, {
                ...
                children: (0, s.jsx)(u.sNh, {
                  ...
                  action: () => {
                    ...
                    let e = {};
                    null != i ? e.section = O.jXE.MANAGE_ACCOUNTS_MODAL : e.page = O.Usc.LOGIN, g.default.track(O.rMx.MULTI_ACCOUNT_ACCOUNT_REMOVE, {
                      location: e
                    }), r(2, n.id), null != t && t()
                  },
                  color: "danger"
...
function T(e) {
  ...
  return (0, s.jsx)("div", {
    className: y.list,
    children: r ? (0, s.jsx)(u.$jN, {}) : l.map((e, r) => (0, s.jsxs)(i.Fragment, {
      children: [(0, s.jsx)(S, {
        user: e,
        actionText: t,
        onAction: n
