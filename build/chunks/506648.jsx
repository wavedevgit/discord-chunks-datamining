...
let h = [{
  ...
  g = e => {
    ...
    return <div className={f.row}>{<l.ua7 text={i}>{e => (0, r.jsx)(t, function(e) {
        ...
        }, e))}</l.ua7>}{<span className={f.featureText}>{n}</span>}{<l.dz2 size={"md"} color={"currentColor"} className={f.checkmarkIcon} />}</div>
  };
class m extends Chunk73800.PureComponent {
  render() {
    let {
      ...
      return <g IconComponent={n} text={i()} tooltip={l()} />
    });
    return 0 === exports.length ? null : <div className={Chunk46703.features}>{<Chunk770146.Z>{Chunk388032.intl.string(Chunk388032.t.XXENra)}</Chunk770146.Z>}{exports}</div>
  }
}
let b = m