...
function R() {
  ...
  c.useEffect(() => {
    if (null != b) return (0, _.wH)(i.z.NITRO_TENURE_BADGE_LEVEL_UP, (0, p.q)(b), {
...
function Z(e) {
  let {
    onVideoLoaded: t,
    levelUpData: d
  } = e, [n, i] = c.useState(!1), _ = (0, E.GG)(), u = c.useRef(null), p = c.useRef(null), {
    currentBadge: m,
    prevBadge: g,
    levelUpVideoSrc: R
  } = d;
  ...
  let Z = c.useCallback(() => {
    i(!1), p.current.play(), u.current.style.display = "none", u.current.offsetWidth, u.current.style.display = "", U.default.track(h.rMx.TIERED_TENURE_BADGE_LEVEL_UP_REPLAY_CLICKED, {
      new_badge_id: m.id
    })
  }, [m.id]);
  return (0, a.jsxs)("div", {
