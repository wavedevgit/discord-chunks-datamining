...
function h(e) {
  ...
  let {
    levelUpData: n
  } = e, s = d.useRef(null), [r, i] = d.useState(!1), c = d.useCallback(() => {
    i(!0)
  }, []), _ = d.useCallback(() => {
    u.Z.setState({
...
function b(e) {
  let {
    onVideoLoaded: t,
    levelUpData: n
  } = e, [s, u] = d.useState(!1), [h, b] = d.useState(!1), [v, N] = d.useState(!1), [y, R] = d.useState(!1), j = (0, x.GG)(), B = d.useRef(null), C = d.useRef(null), {
    currentBadge: L,
    prevBadge: U,
    levelUpVideoSrc: k
  } = n, w = L.id === p.VU.PREMIUM_TENURE_1_MONTH;
  d.useEffect(() => {
  ...
  let S = d.useCallback(() => {
    u(!1), C.current.play(), B.current.style.display = "none", B.current.offsetWidth, B.current.style.display = "", T.default.track(m.rMx.TIERED_TENURE_BADGE_LEVEL_UP_REPLAY_CLICKED, {
      new_badge_id: L.id
    })
  }, [L.id]);
  return (0, a.jsxs)("div", {
