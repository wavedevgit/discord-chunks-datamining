...
function v(e) {
  ...
  let {
    levelUpData: n
  } = e, s = d.useRef(null), [o, c] = d.useState(!0), [u, T] = d.useState(!1), [g, E] = d.useState(!1);
  d.useEffect(() => {
    let e = setTimeout(() => {
      E(!0)
    }, 1e3);
    return () => clearTimeout(e)
  }, []), d.useEffect(() => ((0, _.wH)(l.z.NITRO_TENURE_BADGE_LEVEL_UP, (0, m.q)(n.currentBadge.id), {
...
function B(e) {
  let {
    onVideoLoaded: t,
    levelUpData: n
  } = e, [s, l] = d.useState(!1), _ = (0, g.GG)(), x = d.useRef(null), m = d.useRef(null), {
    currentBadge: h,
    prevBadge: v,
    levelUpVideoSrc: B
  } = n;
  ...
  let C = d.useCallback(() => {
    l(!1), m.current.play(), x.current.style.display = "none", x.current.offsetWidth, x.current.style.display = "", p.default.track(f.rMx.TIERED_TENURE_BADGE_LEVEL_UP_REPLAY_CLICKED, {
      new_badge_id: h.id
    })
  }, [h.id]);
  return (0, a.jsxs)("div", {
