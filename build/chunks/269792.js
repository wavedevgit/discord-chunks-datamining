...
function R() {
  ...
  n.useEffect(() => {
    if (null != u) return (0, _.wH)(i.z.NITRO_TENURE_BADGE_LEVEL_UP, (0, b.q)(u), {
...
function x(e) {
  let {
    onVideoLoaded: t,
    levelUpData: d
  } = e, [c, i] = n.useState(!1), _ = (0, E.GG)(), p = n.useRef(null), b = n.useRef(null), {
    currentBadge: m,
    prevBadge: g,
    levelUpVideoSrc: R
  } = d;
  ...
  let x = n.useCallback(() => {
    i(!1), b.current.play(), p.current.style.display = "none", p.current.offsetWidth, p.current.style.display = "", h.default.track(U.rMx.TIERED_TENURE_BADGE_LEVEL_UP_REPLAY_CLICKED, {
      new_badge_id: m.id
    })
  }, [m.id]);
  return (0, a.jsxs)("div", {
