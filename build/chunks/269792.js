...
function h(e) {
  ...
  let {
    levelUpData: a
  } = e, [r, h] = d.useState(!1), [f, b] = d.useState(!1), [v, N] = d.useState(!1), C = (0, _.GG)(), w = d.useRef(null), y = d.useRef(null), {
    currentBadge: B,
    prevBadge: R,
    levelUpVideoSrc: U
  } = a, j = d.useCallback(() => {
  ...
  let k = d.useCallback(() => {
      b(!1), N(!1), j(), w.current.style.display = "none", w.current.offsetWidth, w.current.style.display = "", m.default.track(T.rMx.TIERED_TENURE_BADGE_LEVEL_UP_REPLAY_CLICKED, {
        new_badge_id: B.id
      })
    }, [B.id, j]),
    I = {
