...
function h(e) {
  ...
  let {
    levelUpData: n
  } = e, r = d.useRef(null), [o, i] = d.useState(!0), [c, _] = d.useState(!1);
  d.useEffect(() => () => u.Z.setState({
...
function b(e) {
  let {
    onVideoLoaded: t,
    levelUpData: n
  } = e, [r, u] = d.useState(!1), [h, b] = d.useState(!1), [v, N] = d.useState(!1), [y, B] = d.useState(!1), R = (0, x.GG)(), j = d.useRef(null), C = d.useRef(null), {
    currentBadge: L,
    prevBadge: U,
    levelUpVideoSrc: S
  } = n, k = L.id === p.VU.PREMIUM_TENURE_1_MONTH;
  d.useEffect(() => {
    let e = setTimeout(() => b(!0), 1e3);
    return () => clearTimeout(e)
  }, []), d.useEffect(() => {
    v && h && (t(), C.current.currentTime = 0, setTimeout(() => {
      B(!0), C.current.play()
    }, 1e3 * !k))
  }, [v, h, k, t]), (0, i.Z)({
  ...
  let w = d.useCallback(() => {
    u(!1), C.current.play(), j.current.style.display = "none", j.current.offsetWidth, j.current.style.display = "", T.default.track(m.rMx.TIERED_TENURE_BADGE_LEVEL_UP_REPLAY_CLICKED, {
      new_badge_id: L.id
    })
  }, [L.id]);
  return (0, a.jsxs)("div", {
