...
function b(e) {
  let {
    onVideoLoaded: t,
    levelUpData: a
  } = e, [s, u] = d.useState(!1), [h, b] = d.useState(!1), [v, N] = d.useState(!1), [C, R] = d.useState(!1), j = (0, x.GG)(), B = d.useRef(null), L = d.useRef(null), {
    currentBadge: U,
    prevBadge: k,
    levelUpVideoSrc: w
  } = a;
  ...
  let y = d.useCallback(() => {
    let e = 1e3 * (U.id !== E.VU.PREMIUM_TENURE_1_MONTH);
    L.current.currentTime = 0, setTimeout(() => {
      R(!0), L.current.play()
    }, e)
  }, [U.id]);
  d.useEffect(() => {
  ...
  let S = d.useCallback(() => {
    u(!1), R(!1), y(), B.current.style.display = "none", B.current.offsetWidth, B.current.style.display = "", m.default.track(g.rMx.TIERED_TENURE_BADGE_LEVEL_UP_REPLAY_CLICKED, {
      new_badge_id: U.id
    })
  }, [U.id, y]);
  return (0, n.jsxs)("div", {
