...
function b() {
  let [e, t] = n.useState(!1), [a, c] = n.useState(!0), i = (0, p.Z)(), l = n.useCallback(() => {
    t(!0)
  }, []);
...
function h(e) {
  let {
    onVideoLoaded: t,
    levelUpData: a
  } = e, [c, p] = n.useState(!1), b = (0, r.GG)(), h = n.useRef(null), E = n.useRef(null), T = n.useCallback(() => {
