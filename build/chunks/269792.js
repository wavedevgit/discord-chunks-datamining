...
function E(e) {
  ...
  let {
    levelUpData: n
  } = e, o = d.useRef(null), [s, i] = d.useState(!0), [c, _] = d.useState(!1), [x, g] = d.useState(!1);
  d.useEffect(() => {
    let e = setTimeout(() => {
      g(!0)
    }, 1e3);
...
function h(e) {
  let {
    onVideoLoaded: t,
    levelUpData: n
  } = e, [o, u] = d.useState(!1), E = (0, x.GG)(), h = d.useRef(null), b = d.useRef(null), {
    currentBadge: v,
    prevBadge: B,
    levelUpVideoSrc: N
  } = n;
  ...
  let j = d.useCallback(() => {
    u(!1), b.current.play(), h.current.style.display = "none", h.current.offsetWidth, h.current.style.display = "", m.default.track(p.rMx.TIERED_TENURE_BADGE_LEVEL_UP_REPLAY_CLICKED, {
      new_badge_id: v.id
    })
  }, [v.id]);
  return (0, a.jsxs)("div", {
