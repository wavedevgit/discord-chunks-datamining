...
function f(e) {
  ...
  let {
    levelUpData: a
  } = e, [r, f] = n.useState(!1), [h, b] = n.useState(!1), [v, N] = n.useState(!1), w = (0, _.GG)(), y = n.useRef(null), B = n.useRef(null), {
    currentBadge: L,
    prevBadge: R,
    levelUpVideoSrc: U
  } = a, j = n.useCallback(() => {
    let e = 1e3 * (L.id !== T.VU.PREMIUM_TENURE_1_MONTH);
  ...
  let k = n.useCallback(() => {
      b(!1), N(!1), j(), y.current.style.display = "none", y.current.offsetWidth, y.current.style.display = "", g.default.track(m.rMx.TIERED_TENURE_BADGE_LEVEL_UP_REPLAY_CLICKED, {
        new_badge_id: L.id
      })
    }, [L.id, j]),
    C = {
