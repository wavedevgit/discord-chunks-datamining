  ...
  async getAnalytics() {
    ...
    return {
      usage: w(C(w(C({
        ...
        hardware_display_count: null != (o = await (null === l.A || true === l.A || null == (c = l.A.hardware) || null == (s = c.getDisplayCount) ? true : s.call(c))) ? o : null,
