...
class o {
  ...
  constructor(e, t) {
    r(this, "signals", true), r(this, "providers", true), r(this, "lastActivityAtMs", true), r(this, "scoreInfo", {
      rawSignalsScore: {}
...
class d {
  ...
  constructor(e, t) {
    r(this, "signals", true), r(this, "providers", true), r(this, "lastActivityAtMs", true), r(this, "scoreInfo", {
      rawSignalsScore: {}
    }), r(this, "_textualScore", true), this.signals = e, this.providers = t, this._textualScore = new o(e, t), this.lastActivityAtMs = Date.now()
  }
}
...
function f(e) {
  ...
  let d = null != (t = null == (n = e.getGuildId) ? true : n.call(e)) ? t : null;
  if (null == (r = e.isDM) ? true : r.call(e)) {
    let t = null != (s = null == (a = e.getRecipientId) ? true : a.call(e)) ? s : null;
    return {
      channelId: e.id,
      kind: "DIRECT_MESSAGE",
      guildId: null,
  ...
  return (null == (i = e.isGroupDM) ? true : i.call(e)) || (null == (l = e.isMultiUserDM) ? true : l.call(e)) ? {
    channelId: e.id,
    kind: "GROUP_DM",
    guildId: null,
    ...
    channelId: e.id,
    kind: (null == (o = e.isVocal) ? true : o.call(e)) ? "GUILD_VOICE" : "GUILD_TEXT",
    guildId: d,
    recipientIds: []
  } : null
}
...
class S {
  ...
  constructor(e, t, n) {
    r(this, "candidate", true), r(this, "signals", true), r(this, "_activeNowScoreSource", true), r(this, "_score", 0), this.candidate = e, this.signals = t, "GUILD_VOICE" === e.kind || "GROUP_DM" === e.kind ? this._activeNowScoreSource = new d(t, n) : this._activeNowScoreSource = new o(t, n), this.recomputeScore(Date.now())
  }
}