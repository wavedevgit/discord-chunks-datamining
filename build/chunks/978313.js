...
function b(e) {
  let {
    detectedGame: t,
    trackAction: r
  } = e, [i, b] = a.useState((null == t ? void 0 : t.summaryLocalized) != null), [h, O] = a.useState(!0), [y, v] = a.useState(!1), j = a.useRef(null), {
    width: x,
    height: P
  } = (0, d.Z)();
  return (a.useEffect(() => {
    ...
    className: o()(g.column, g.gapMd),
    children: [null != t.summaryLocalized && (0, n.jsxs)("div", {
      className: o()(g.row, g.gapSm),
      children: [(0, n.jsx)(l.SxY, {
        ...
        children: i ? f.NW.format(f.t.aZ2iIi, {
          onShowOriginal: () => b(!1)
        }) : f.NW.format(f.t["/2ylFx"], {
          onShowTranslated: () => b(!0)
        })
      })]
    }), (0, n.jsx)(s.xv, {
      ref: j,
