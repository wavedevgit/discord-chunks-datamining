...
function C(e) {
  let {
    ...
    "aria-labelledby": l,
    onSelectEmoji: s
  } = e, o = i.useRef(null), u = (0, a.e7)([p.ZP], () => null != n.id ? p.ZP.getCustomEmojiById(n.id) : void 0), x = (0, a.e7)([h.ZP], () => h.ZP.getDefaultChannel(t)), C = i.useCallback(e => {
    let {
      closePopout: t
    } = e;
    return (0, r.jsx)(g.Z, {
  ...
  return null != u ? N = ":".concat(u.name, ":") : null != n.name && (N = f.ZP.convertSurrogateToName(n.name)), (0, r.jsx)(c.yRy, {
    targetElementRef: o,
...
function y(e) {
  ...
  let {
    ...
    transitionState: p,
    onClose: f
  } = e, h = (0, u.Dt)(), x = (0, u.Dt)(), [b, _] = i.useState(null != (t = null == l ? void 0 : l.description) ? t : ""), [v, O] = i.useState(() => ({
    id: null == l ? void 0 : l.emoji_id,
    name: null == l ? void 0 : l.emoji_name
  })), y = d && "" !== b && (null != v.id || null != v.name);

  function N(e) {
    e.preventDefault(), y && (m({
      description: b,
      emojiId: v.id,
      emojiName: v.name
    }), f())
...
function I(e) {
  ...
  let {
    ...
    onDelete: d,
    guildId: m
  } = e, [g, p] = i.useState(null != (t = null == n ? void 0 : n.name) ? t : ""), f = (0, u.Dt)(), h = (0, r.jsx)(c.hjN, {
