...
function C(e) {
  let {
    ...
    "aria-labelledby": l,
    onSelectEmoji: s
  } = e, u = (0, a.e7)([p.ZP], () => null != n.id ? p.ZP.getCustomEmojiById(n.id) : void 0), d = (0, a.e7)([f.ZP], () => f.ZP.getDefaultChannel(t)), x = i.useCallback(e => {
    let {
      closePopout: t
    } = e;
    return (0, r.jsx)(g.Z, {
  ...
  }, [s, d]), C = i.useMemo(() => null == u && null == n.name ? null : function() {
    return (0, r.jsx)(c.Z, {
      className: _.emoji,
      emojiId: n.id,
      emojiName: n.name,
  ...
  return null != u ? y = ":".concat(u.name, ":") : null != n.name && (y = h.ZP.convertSurrogateToName(n.name)), (0, r.jsx)(o.yRy, {
...
function y(e) {
  ...
  let {
    ...
    transitionState: p,
    onClose: h
  } = e, f = (0, d.Dt)(), x = (0, d.Dt)(), b = (0, d.Dt)(), [v, O] = i.useState(null != (t = null == l ? void 0 : l.description) ? t : ""), [y, N] = i.useState(() => ({
...
function N(e) {
  let {
    ...
    transitionState: u,
    onClose: m
  } = e, [g, p] = i.useState(null == l ? void 0 : l.ref_id), h = (0, d.Dt)(), f = (0, r.jsxs)(r.Fragment, {
  ...
  return (0, r.jsx)(y, {
    ...
    canSubmit: null != g,
    onSave: function(e) {
      s()(null != g, "Cannot submit null channel"), a(O(v({}, e), {
        channelId: g
      }))
    },
    transitionState: u,
...
function I(e) {
  ...
  let {
    ...
    onDelete: u,
    guildId: m
  } = e, [g, p] = i.useState(null != (t = null == n ? void 0 : n.name) ? t : ""), h = (0, d.Dt)(), f = (0, r.jsx)(o.hjN, {
  ...
  return (0, r.jsx)(y, {
    ...
    canSubmit: "" !== g,
    onSave: function(e) {
      s()("" !== g, "Cannot submit empty name"), l(O(v({}, e), {
        name: g
      }))
    },
    transitionState: a,
