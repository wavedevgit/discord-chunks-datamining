...
function y(e) {
  ...
  }, [s, b]), N = i.useMemo(() => null == m && null == n.name ? null : function() {
    return (0, r.jsx)(u.Z, {
      className: v.emoji,
      emojiId: n.id,
      emojiName: n.name,
  ...
  return null != m ? I = ":".concat(m.name, ":") : null != n.name && (I = h.ZP.convertSurrogateToName(n.name)), (0, r.jsx)(d.yRy, {
    targetElementRef: o,
...
function N(e) {
  ...
  let {
    ...
    transitionState: p,
    onClose: f
  } = e, h = (0, m.Dt)(), x = (0, m.Dt)(), [b, j] = i.useState(null != (t = null == l ? void 0 : l.description) ? t : ""), [v, O] = i.useState(() => ({
...
function E(e) {
  ...
  let {
    ...
    onDelete: c,
    guildId: u
  } = e, [g, p] = i.useState(null != (t = null == n ? void 0 : n.name) ? t : ""), f = (0, m.Dt)(), h = (0, r.jsx)(d.hjN, {
