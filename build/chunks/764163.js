...
function O(e) {
  ...
  }, [l, u]), O = i.useMemo(() => null == d && null == n.name ? null : function() {
    return (0, r.jsx)(c.Z, {
      className: N.emoji,
      emojiId: n.id,
      emojiName: n.name,
...
function C(e) {
  ...
  let {
    ...
    transitionState: p,
    onClose: h
  } = e, f = (0, u.Dt)(), x = (0, u.Dt)(), b = (0, u.Dt)(), [_, v] = i.useState(null != (t = null == s ? void 0 : s.description) ? t : ""), [C, y] = i.useState(() => ({
...
function y(e) {
  ...
  return (0, r.jsx)(C, {
    ...
    canSubmit: null != g,
    onSave: function(e) {
      l()(null != g, "Cannot submit null channel"), a(v(_({}, e), {
        channelId: g
      }))
    },
    transitionState: d,
...
function I(e) {
  ...
  return (0, r.jsx)(C, {
    ...
    canSubmit: "" !== g,
    onSave: function(e) {
      l()("" !== g, "Cannot submit empty name"), s(v(_({}, e), {
        name: g
      }))
    },
    transitionState: a,
