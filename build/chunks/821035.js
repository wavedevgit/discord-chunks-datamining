...
function x(e) {
  ...
  return x && (S.unshift(T), v.unshift(T)), (0, i.jsx)(g.U, {
    ...
    children: n ? (0, i.jsxs)(i.Fragment, {
      ...
      children: [(0, i.jsx)(g.H, {
        ...
        description: b.intl.format(b.t.ZUvrwM, {
          learnMoreLink: m.Z.getArticleURL(f.BhN.EXPLICIT_MEDIA_REDACTION)
        })
      }), (0, i.jsx)(s.xJW, {
        tag: s.RB0.H3,
