...
let S = e => {
  ...
  N = e => {
    ...
    } = e, o = null == (t = (0, f.WD)()) ? void 0 : t.getId();
    return (0, n.jsx)(c.zx, {
      fullWidth: !0,
      className: O.cta,
      onClick: () => (0, j.gI)({
  ...
  E = e => {
    let {
      quest: t
    } = e, r = (0, j.Vl)(t), s = t.config.features.includes(m.S7.START_QUEST_CTA), o = (0, g.CR)({
      quest: t
    }), {
  ...
  A = e => {
    var t, r, o, {
        ...
        ctaLabel: b,
        onClick: m,
        questContent: v = x.jn.QUEST_BAR_V2,
        sourceQuestContent: S
      } = e,
      N = function(e, t) {
        if (null == e) return {};
    ...
    let E = (0, h.hf)({
      ...
      A = s.useCallback(e => {
        var t;
        null == m || m(e), (0, j.xN)(d.config) && (null == (t = d.userStatus) ? void 0 : t.claimedAt) != null ? (0, u.mK)({
          openInLayer: !1,
          tab: y.AW.ORBS,
          analyticsLocations: [],
    ...
    return (0, n.jsx)(i.gtL, (t = k({
      ...
      children: null != b ? b : C.intl.string(C.t.cfY4PD)
  ...
  z = e => {
    ...
    let {
      ...
      activeScreen: u,
      taskDetails: d
    } = e, f = (null == (t = r.userStatus) ? void 0 : t.completedAt) != null, p = (0, j.q8)(r), g = (0, j.Vl)(r);
    ...
    if (u === x.LI.CONSOLE && c) return (0, n.jsx)(N, {
      quest: r,
      sourceQuestContent: s
    });
    if (u !== x.LI.SELECT && !i && !a) return (0, n.jsx)(S, {
      quest: r,
      sourceQuestContent: s
    });
    return null
