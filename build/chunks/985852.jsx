...
function p(e) {
  ...
  }, [t]), <r.Fragment>{<a.Z ref={n} className={m ? d.videoFullscreen : d.video} src={f.Z} loop={true} muted={true} playsInline={true} autoPlay={true} />}{<l.Z itemId={u.yN.AT_SOMEONE} pointsPerInterval={g} interval={1e3} isPaused={t} />}</r.Fragment>
}