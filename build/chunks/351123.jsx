...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk903386 = require("./903386.js"),
  Chunk700785 = require("./700785.js"),
  Chunk605436 = require("./605436.js"),
  Chunk27544 = require("./27544.jsx"),
  Chunk415236 = require("./415236.js"),
...
function W(e) {
  ...
  return <c.aVo className={V.roleMemberList} sections={[n.length, l.length]} renderRow={function(e) {
      let o, h, j, {
          section: b,
          row: v
        } = e,
    ...
    }} rowHeight={40} renderSection={function(e) {
      let {
        section: t
      } = e;
      switch (t) {
...
function G(e) {
  ...
  return <div className={s()(V.settingCard, V.active)}>{<A.Z label={B.intl.string(B.t.StpcFR)} description={B.intl.string(B.t.f7VbhI)} icon={(0, i.jsx)(c.ewx, {
        size: "custom",
        color: "currentColor",
        className: V.cardIcon,
        height: 20,
        width: 20
      })} id={"StageModeratorSettingCard"} />}{<div className={V.cardFolder}>{<x.Z justify={x.Z.Justify.BETWEEN} align={x.Z.Align.CENTER} className={V.folderHeader}>{<c.vwX tag={"h5"} className={V.folderTitle}>{B.intl.string(B.t["7BWDRU"])}</c.vwX>}{<c.ua7 text={B.intl.string(B.t.arRuER)} shouldShow={!h}>{e => (0, i.jsx)(c.zxk, H(U({
            variant: "primary",
            size: "sm",
            ...
            onClick: g,
            disabled: !h
          }))}</c.ua7>}</x.Z>}{<W channel={l} roles={d} members={u} disabledReason={h ? null : B.intl.string(B.t.arRuER)} getRemoveTooltipHint={N.kk} />}</div>}</div>
}
...
function F(e) {
  ...
  return l.isCategory() ? (f.title = B.intl.string(B.t.lEPAZ2), f.subtitle = B.intl.string(B.t["RQUk6+"]), f.formLabel = B.intl.string(B.t["8VIxJi"])) : l.type === M.d4z.GUILD_VOICE && (f.subtitle = B.intl.string(B.t.cLjvKi)), <div className={s()(V.settingCard, {
      [V.active]: r
    })}>{<A.Z description={f.subtitle} icon={(0, i.jsx)(c.mBM, {
        size: "custom",
        color: "currentColor",
        className: V.cardIcon,
        height: 20,
        width: 20
      })} id={"PrivateChannelSettingCard"} label={f.title} onChange={p} value={r} />}{<div className={V.cardFolder}>{m && <div className={V.adminWarning}><c.Wn messageType={c.QYI.WARNING}>{B.intl.string(B.t["5f3HIC"])}</c.Wn></div>}{!g && !m && !r && <div className={V.adminWarning}><c.Wn messageType={c.QYI.WARNING}>{B.intl.string(B.t.ZAk4Q0)}</c.Wn></div>}{r && <i.Fragment>{<x.Z justify={x.Z.Justify.BETWEEN} align={x.Z.Align.CENTER} className={V.folderHeader}>{<c.vwX tag={"h5"} className={V.folderTitle}>{f.formLabel}</c.vwX>}{<c.zxk variant={"primary"} size={"sm"} text={B.intl.string(B.t.dMJ3Y2)} onClick={function() {
              (0, c.ZDy)(async () => {
                let {
                  default: e
            ...
            }} />}</x.Z>}{<W channel={l} roles={d} members={u} getRemoveTooltipHint={I.yv} />}</i.Fragment>}</div>}</div>
}
...
function z(e) {
  ...
  return <div>{<c.$i$ className={V.divider} />}{<c.vwX className={s()(V.folderTitle, V.sectionTitle)} tag={"h5"}>{t}</c.vwX>}</div>
}
let X = Chunk442837.ZP.connectStores([Chunk277053.Z, Chunk496675.Z, Chunk271383.ZP, Chunk430824.Z, Chunk485386.Z], () => {
  ...
  return s.isCategory() && (x.title = B.intl.string(B.t["/uELTk"]), x.subtitle = B.intl.string(B.t["8iAg3d"])), <i.Fragment>{<c.vwX tag={"h1"}>{x.title}</c.vwX>}{<c.R94>{x.subtitle}</c.R94>}{null != r && t ? g ? <L.Z canSync={false} icon={c.DuK} noticeText={B.intl.format(B.t.ETJqLi, {
        categoryName: r.name
      })} /> : <L.Z buttonText={B.intl.string(B.t.NVwuHh)} canSync={true} icon={(0, c.GSL)(R.Z)} noticeText={B.intl.format(B.t.OIhm0N, {
        categoryName: r.name
      })} onClick={function() {
      ...
      }} /> : null}{s.isGuildStageVoice() ? <G guild={d} channel={s} permissionUpdates={m} /> : null}{<F channel={s} guild={d} isPrivateGuildChannel={u} roles={o} members={a} />}{false}{<P.Z />}</i.Fragment>
})