...
function p(e, t, n) {
  ...
  for (let [e, n] of Object.entries(t)) {
    let t = r.Questions[e];
    null != t && (t.QuestionType === l.S.MULTIPLE_CHOICE && t.Selector === l.E_.MULTIPLE_ANSWER ? (i[e] = n.split(","), null != t.ChoiceOrder && (i["".concat(e, "_DO")] = t.ChoiceOrder)) : t.QuestionType === l.S.MULTIPLE_CHOICE && t.Selector === l.E_.SINGLE_ANSWER ? (i[e] = parseInt(n), null != t.ChoiceOrder && (i["".concat(e, "_DO")] = t.ChoiceOrder)) : t.QuestionType === l.S.TEXT_ENTRY ? i["".concat(e, "_TEXT")] = n : i[e] = n)
  }
  let a = Object.keys(t);
  return n.forEach(e => {
    if (!a.includes(e)) {
