...
function j(e) {
  var t;
  null == i[e.ownerId] && (i[e.ownerId] = {}), i[e.ownerId][null !== (t = e.guildId) && void 0 !== t ? t : N.kod] = e
}
...
function er(e) {
  ...
  return null != t && (0, h.p9)(t, A.Z, y.Z, I.Z, f.Z)[0]
}
k();
class ei extends(c = u.ZP.PersistedStore) {
  ...
  getStreamForUser(e, t) {
    var n;
    if (!(0, m.Z)(O.Z)) return null;
    let r = null === (n = i[e]) || void 0 === n ? void 0 : n[null != t ? t : N.kod];
