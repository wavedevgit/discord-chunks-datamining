...
function v(e) {
  let {
    ...
    headingColor: R
  } = e, P = (0, l.e7)([d.Z], () => d.Z.getPremiumTypeSubscription()), D = (0, l.e7)([u.default], () => u.default.getCurrentUser()), w = (0, _.t7)(), x = (0, _.lr)(), L = n === E.PremiumTypes.TIER_0 ? E.Si.TIER_0 : E.Si.TIER_2, M = (null == P ? true : P.hasActiveTrial) ? null == D ? true : D.premiumType : w ? E.PremiumTypes.TIER_2 : null, j = (0, h.N)(), k = (0, p.N)(), U = null == j ? true : j.subscription_trial;
