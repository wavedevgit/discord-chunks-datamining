...
let y = Chunk473749.memo(function(e) {
  let {
    channel: t
  } = e, y = (0, d.h)(t.id), O = (0, u.o)(t.id), j = (0, p.M)(t.id), x = (0, a.useHasAnyModalOpen)(), v = (0, l.e7)([f.Z], () => f.Z.hasLayers()), C = i.useCallback(() => O ? b.intl.string(b.t["16QyDv"]) : null != j ? b.intl.string(b.t.kCN9i0) : null, [O, j]), I = i.useMemo(() => (O || null != j) && !x && !v, [O, j, x, v]), [S, E] = i.useState(C());
  i.useEffect(() => {
