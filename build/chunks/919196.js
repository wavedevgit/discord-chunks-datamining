...
function N(e) {
  ...
  let {
    ...
    integration: T,
    webhooks: w
  } = a, [P, Z] = (0, l.Wu)([p.Z], () => [p.Z.can(O.Plq.MANAGE_ROLES, n), null == S.bot || p.Z.canManageUser(O.Plq.MANAGE_GUILD, S.bot.id, n)], [S.bot, n]), k = (0, l.e7)([p.Z], () => p.Z.can(O.Plq.MANAGE_WEBHOOKS, n), [n]), A = i.useCallback(() => {
