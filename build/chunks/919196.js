...
function N(e) {
  ...
  let {
    ...
    integration: T,
    webhooks: w
  } = a, [P, Z] = (0, l.Wu)([p.Z], () => [p.Z.can(O.Plq.MANAGE_ROLES, n), null == S.bot || p.Z.canManageUser(O.Plq.MANAGE_GUILD, S.bot.id, n)], [S.bot, n]), A = (0, l.e7)([p.Z], () => p.Z.can(O.Plq.MANAGE_WEBHOOKS, n), [n]), k = i.useCallback(() => {
    E() && (0, o.h7j)(e => (0, r.jsx)(C, _({
      guild: n,
      application: S,
      integration: T
    }, e)))
    ...
    let e = [{
      ...
      text: v.intl.formatToPlainString(v.t.gcdJ8P, {
        timestamp: b.default.extractTimestamp(T.id)
      })
    }];
    return null != T.user && e.push({
      icon: o.tBG,
      text: v.intl.formatToPlainString(v.t.qE7oqq, {
        user: g.ZP.getUserTag(T.user)
      })
    }), e
  }, [T.id, T.user]), R = i.useMemo(() => null != S.bot ? (0, r.jsx)(x.Z, {
    guild: n,
    applicationIntegration: a
  }) : (0, r.jsx)(o.Zbd, {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(f.Z, {
      name: S.name,
      imageSrc: null != (t = S.getIconURL(32)) ? t : m.pK["0"],
      details: D,
      isHeader: !0
      ...
      children: [(0, r.jsx)(h.Z, {
        ...
        children: (0, r.jsx)(o.Text, {
          color: "text-muted",
          variant: "text-sm/normal",
          children: A ? v.intl.string(v.t.ahPd2d) : v.intl.string(v.t.axqYMj)
        })
      })]
    }), (0, r.jsx)(o.$i$, {
      className: y.headerDivider
