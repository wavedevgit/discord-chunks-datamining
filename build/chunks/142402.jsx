...
function j(e) {
  ...
  if (k) {
    ...
    return <b.Z onSubmit={P} onClose={S} ratingHeader={T} ratingEmojiKind={C} ratingBody={t ? N : L} categoriesHeader={y.intl.string(h.default["tq859/"])} optionsTree={[e, n, l, o, i]} impression={F} transitionState={w} />
  }
  return <m.Z modalType={"stream"} header={T} ratingEmojiKind={C} impression={F} body={t ? N : L} problemTitle={y.intl.string(y.t["6Y1t5O"])} problems={(0, d.Z)({
      isStreamer: t,
      isEndStream: true,
      showVibesHoneypot: R
    })} freeformNeededProblems={v} onSubmit={P} onClose={S} transitionState={w} otherKey={g.kr.OTHER} />
}