...
function v(e) {
  let {
    ...
    width: v,
    height: y
  } = (0, c.Z)(), I = (0, p.Q3)("GuildOnboardingBlockedPage"), C = i.useCallback(() => {
    null != t && null != n && ((0, b.I1)(t), (0, _.default)({
      guildId: t,
      returnChannelId: n
    }))
  }, [t, n]), S = (0, a.e7)([f.Z], () => f.Z.getGuild(t)), T = i.useMemo(() => null == S ? null : g.ZP.getGuildSplashURL({
    id: S.id,
    splash: S.splash
  }), [S]), P = (0, d.N)(T);
  return I ? (0, r.jsxs)("div", {
    className: o()(O.outerWrapping, N.main, {
