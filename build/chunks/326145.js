...
function I(e) {
  let {
    ...
    width: I,
    height: v
  } = (0, u.ZP)(), C = i.useCallback(() => {
    null != t && null != n && ((0, b.I1)(t), (0, _.default)({
      guildId: t,
      returnChannelId: n
    }))
  }, [t, n]), S = (0, o.e7)([f.Z], () => f.Z.getGuild(t)), N = i.useMemo(() => null == S ? null : g.ZP.getGuildSplashURL({
    id: S.id,
    splash: S.splash
  }), [S]), T = (0, p.N)(N);
  return (0, r.jsxs)("div", {
    className: a()(O.outerWrapping, y.main, {
      [y.fullBorderWithGradient]: null == N
    }),
    ref: l,
    ...
    }) : (0, r.jsx)(h.Z, {}), null != T && null != N && (0, r.jsx)("div", {
