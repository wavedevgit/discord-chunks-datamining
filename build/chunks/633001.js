...
let M = r.memo(function(e) {
    let {
      trackedGame: t
    } = e, a = (0, o.e7)([h.ZP], () => h.ZP.getGameForPID(t.pid)), r = (0, o.e7)([_.Z], () => _.Z.getGameForPID(t.pid)), l = (0, o.e7)([h.ZP], () => null == a ? null : h.ZP.getGameOverlayStatus(a));
    return (0, n.jsxs)("div", {
      ...
      children: [(0, n.jsx)(d.Text, {
      ...
      }), null != t.applicationId && (0, n.jsx)(d.Text, {
        variant: "text-md/bold",
        color: "text-primary",
        children: (0, n.jsx)(L, {
          id: t.applicationId
        ...
        children: [(0, n.jsxs)(d.Text, {
          ...
          variant: "text-sm/normal",
          color: "text-default",
          children: ["raw overlayMethod: ", (0, b.P_)(l.overlayMethod)]
        })]
      }), (0, n.jsxs)(d.Text, {
        variant: "text-sm/normal",
        color: "text-default",
  ...
  B = r.memo(function(e) {
    let {
      pid: t
    } = e, a = (0, o.cj)([y.default], () => y.default.getOverlayPIDStatuses()), r = (0, o.cj)([f.default], () => f.default.getTrackedGames()), l = (0, o.e7)([y.default], () => y.default.isInputLocked(t), [t]), i = (0, o.e7)([y.default], () => y.default.DEV_isInputLockedV3(t), [t]), s = (0, o.e7)([y.default], () => y.default.DEV_isInputLocked(t), [t]), c = (0, o.e7)([y.default], () => y.default.isReady(t), [t]);
    return (0, n.jsxs)("div", {
      className: w.panelGroup,
      children: [(0, n.jsx)(d.Text, {
...
function U(e) {
  let t = D(Object.values((0, o.Wu)([g.Z], () => g.Z.getWidgetsForLayout(S.$S))), e);
  return [t, () => {
...
function G() {
  let e = (0, o.e7)([v.ZP], () => v.ZP.hasRenderDebugMode(p.GO.TrackFocusPIDs)),
    t = (0, o.Wu)([f.default], () => f.default.getDevToolsFocusedPidsWithTimestamp(), []),
    a = () => {
      m.Z.setRenderDebugMode(!v.ZP.hasRenderDebugMode(p.GO.TrackFocusPIDs), p.GO.TrackFocusPIDs)
    };
  return (0, n.jsxs)("div", {
    className: w.panelGroup,
      ...
      children: [0 === t.length && (0, n.jsx)(d.Text, {
        ...
        return (0, n.jsx)(r.Fragment, {
          children: (0, n.jsx)(d.ua7, {
            position: "left",
            text: l === p.d5.TRACK_FOCUS ? "Tracked Focus Event" : "Clear Focus Event",
            children: e => {
              var r;
              return (0, n.jsx)("div", k(R({}, e), {
                children: (0, n.jsxs)(d.Text, {
                  variant: "text-sm/medium",
                  color: l === p.d5.TRACK_FOCUS ? "text-default" : "text-danger",
                  children: [(0, n.jsx)(z, {
                    pid: a,
                    tag: "span"
                  }), " - ", null != (r = null == a ? void 0 : a.toString()) ? r : "null", " @ ", F(t, !0)]
                })
              }))
            }
          })
...
let V = r.memo(function(e) {
    let {
      pid: t
    } = e, a = (0, o.e7)([f.default, h.ZP], () => {
      var e, a, n;
      if (null == t) return null;
      let r = null == (e = f.default.getTrackedGameByPid(t)) ? void 0 : e.fullscreenType;
      return null != r ? r : null != (n = null == (a = h.ZP.getGameForPID(t)) ? void 0 : a.fullscreenType) ? n : x.Jx.UNKNOWN
    }, [t]);
    return (0, n.jsxs)(d.Text, {
      variant: "text-sm/normal",
      color: "text-secondary",
      tag: "span",
      children: ["Original Screen Type: ", null != a ? (0, b.sS)(a) : "Unknown"]
    })
  }),
  H = r.memo(function() {
          ...
          children: [0 === Object.keys(e).length && (0, n.jsx)(d.Text, {
            ...
            children: [(0, n.jsx)(z, {
              ...
              return (0, n.jsx)(d.Text, {
                ...
                color: "text-default",
                children: "".concat(a, ":").concat((0, b.sS)(a), " @ ").concat(F(r))
  ...
  K = r.memo(function() {
    let [e, t] = U(T.Odu.CLICK_ZONE_DEBUG), [a, r] = U(T.Odu.PERFORMANCE_DEBUG), l = (0, o.e7)([v.ZP], () => v.ZP.hasRenderDebugMode(p.GO.ClickZones)), i = (0, o.e7)([v.ZP], () => v.ZP.hasRenderDebugMode(p.GO.WidgetAreas)), s = (0, o.e7)([v.ZP], () => v.ZP.hasRenderDebugMode(p.GO.DisabledGPUBoost)), c = (0, o.e7)([v.ZP], () => v.ZP.hasRenderDebugMode(p.GO.ForceGPUBoost)), u = e => {
      ...
      u(p.GO.DisabledGPUBoost)
    }, b = () => {
      u(p.GO.ForceGPUBoost)
    };
    return (0, n.jsxs)("div", {
      className: w.panelGroup,
      children: [(0, n.jsx)(d.ua7, {
      ...
      children: [t.length > 0 && (0, n.jsx)(d.ua7, {
        ...
        children: t => (0, n.jsx)("div", k(R({}, t), {
          children: (0, n.jsxs)("div", {
            ...
            }), Object.values(e).map(e => (0, n.jsx)(M, {
              trackedGame: e
            }, e.pid))]
          })
        }))
  ...
  Y = r.memo(function() {
    let e = (0, o.e7)([f.default], () => f.default.getForcedRenderMode()),
      ...
      i = [{
        ...
        label: p.R5.IN_PROCESS_V2,
        value: p.R5.IN_PROCESS_V2
      }, {
        label: p.R5.OUT_OF_PROCESS_V3,
        value: p.R5.OUT_OF_PROCESS_V3
      }, {
        label: p.R5.OUT_OF_PROCESS_V3_LIMITED_INTERACTION,
        value: p.R5.OUT_OF_PROCESS_V3_LIMITED_INTERACTION
      }].map(t => k(R({}, t), {
