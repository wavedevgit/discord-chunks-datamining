...
let B = r.memo(function(e) {
    let {
      trackedGame: t
    } = e, a = (0, o.e7)([h.ZP], () => h.ZP.getGameForPID(t.pid)), r = (0, o.e7)([y.Z], () => y.Z.getGameForPID(t.pid));
    return (0, n.jsxs)("div", {
      ...
      children: [t.length > 0 && (0, n.jsx)(d.ua7, {
        ...
        children: e => (0, n.jsx)("div", Z(k({}, e), {
          children: (0, n.jsxs)("div", {
            ...
            }), t.map(e => (0, n.jsxs)(d.Text, {
              variant: "text-sm/normal",
              color: "text-danger",
              children: ["".concat(e.pid, " - ").concat(e.name, " (").concat(e.exeName, ")"), (0, n.jsx)(H, {
                pid: e.pid
              })]
            }, e.pid))]
          })
