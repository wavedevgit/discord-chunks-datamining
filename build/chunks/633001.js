...
function A(e) {
  let {
    trackedGame: t
  } = e, n = (0, s.e7)([x.ZP], () => x.ZP.getGameForPID(t.pid)), r = (0, s.e7)([g.Z], () => g.Z.getGameForPID(t.pid));
  return (0, a.jsxs)("div", {
...
function D(e) {
  let {
    pid: t
  } = e, n = (0, s.cj)([_.default], () => _.default.getOverlayPIDStatuses()), r = (0, s.cj)([p.default], () => p.default.getTrackedGames()), l = (0, s.e7)([_.default], () => _.default.isInputLocked(t), [t]), i = (0, s.e7)([_.default], () => _.default.DEV_isInputLockedV3(t), [t]), o = (0, s.e7)([_.default], () => _.default.DEV_isInputLocked(t), [t]), d = (0, s.e7)([_.default], () => _.default.isReady(t), [t]);
  return (0, a.jsxs)("div", {
    children: [(0, a.jsx)(c.Text, {
...
function M() {
  var e, t;
  let [n, l] = z(N.Odu.CLICK_ZONE_DEBUG), [o, d] = z(N.Odu.PERFORMANCE_DEBUG), j = (0, s.e7)([f.ZP], () => f.ZP.hasRenderDebugMode(h.G.ClickZones)), g = (0, s.e7)([f.ZP], () => f.ZP.hasRenderDebugMode(h.G.WidgetAreas)), y = (0, s.e7)([f.ZP], () => f.ZP.hasRenderDebugMode(h.G.DisabledGPUBoost)), T = (0, s.e7)([f.ZP], () => f.ZP.hasRenderDebugMode(h.G.ForceGPUBoost)), S = (0, s.e7)([p.default], () => p.default.getForcedRenderMode()), [R, Z] = r.useState({}), [L, M] = r.useState(S), B = e => {
  ...
  })), G = (0, s.cj)([p.default], () => p.default.getTrackedGames()), F = (0, s.e7)([_.default], () => _.default.getFocusedPID()), V = (0, s.e7)([_.default], () => _.default.isFocusedPidOutOfProcess()), H = (0, O.getPID)(), W = (0, s.e7)([p.default], () => p.default.isOverlayOOPEnabledForPid(H), [H]), [X, K] = (0, s.Wu)([v.Z], () => [v.Z.enabled, v.Z.keepOpen]), Y = (0, s.e7)([x.ZP], () => x.ZP.getRunningGames());
  r.useEffect(() => {
    Z(e => {
    ...
    children: (0, a.jsxs)("div", {
      ...
      children: [(0, a.jsxs)("div", {
        ...
        children: e => (0, a.jsx)("div", I(k({}, e), {
          children: (0, a.jsxs)("div", {
            className: P.panelGroup,
            children: [0 === Object.keys(G).length && (0, a.jsx)(c.Text, {
              variant: "text-sm/normal",
              color: "text-normal",
              children: "No running games"
            }), Object.values(G).map(e => (0, a.jsx)(A, {
              trackedGame: e
            }, e.pid))]
          })
        }))
        ...
        }), Object.values(G).map(e => (0, a.jsx)(D, {
          pid: e.pid
        }, e.pid)), (0, a.jsxs)("div", {
