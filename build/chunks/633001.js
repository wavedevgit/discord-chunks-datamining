...
function ea() {
  let e = (0, d.e7)([C.ZP], () => C.ZP.hasRenderDebugMode(g.GO.TrackFocusPIDs)),
    ...
    a = () => {
      h.Z.setRenderDebugMode(!C.ZP.hasRenderDebugMode(g.GO.TrackFocusPIDs), g.GO.TrackFocusPIDs)
    };
  return (0, n.jsxs)("div", {
    className: G.panelGroup,
...
let en = r.memo(function(e) {
    let {
      ...
      return null != r ? r : null != (n = null == (a = f.ZP.getGameForPID(t)) ? void 0 : a.fullscreenType) ? n : p.Jx.UNKNOWN
    }, [t]);
  ...
  er = r.memo(function() {
    ...
    }, +k.Z.Millis.SECOND), () => clearInterval(l.current)), []), (0, n.jsx)(m.ua7, {
      position: "left",
  ...
  ei = r.memo(function() {
    let [e, t] = Q(F.Odu.CLICK_ZONE_DEBUG), [a, r] = Q(F.Odu.PERFORMANCE_DEBUG), l = (0, d.e7)([C.ZP], () => C.ZP.hasRenderDebugMode(g.GO.ClickZones)), i = (0, d.e7)([C.ZP], () => C.ZP.hasRenderDebugMode(g.GO.WidgetAreas)), s = (0, d.e7)([C.ZP], () => C.ZP.hasRenderDebugMode(g.GO.DisabledGPUBoost)), o = (0, d.e7)([C.ZP], () => C.ZP.hasRenderDebugMode(g.GO.ForceGPUBoost)), c = e => {
...
function ev() {
  let [e, t] = (0, d.e7)([C.ZP], () => C.ZP.DEV_getOverlayLoggingBreadcrumbs(), [], R.Q), {
    ref: a,
    height: l
  } = (0, b.ZP)(), s = (0, d.e7)([C.ZP], () => C.ZP.DEV_isOverlayModuleLoggingEnabled()), [o, c] = r.useState(s), [u, x] = r.useState(Object.keys(ec)), p = e => {
    x(t => t.includes(e) ? t.filter(t => t !== e) : [...t, e])
  }, [f, v] = r.useState(""), j = r.useMemo(() => 0 === t ? [] : e.filter(e => {
    for (let t of u) {
      let {
        filter: a
      } = ec[t];
  ...
  let [I, k] = r.useState(!1), Z = r.useRef(null), A = r.useCallback(() => {
...
function eg() {
  ...
  return (0, n.jsxs)("div", {
    ...
    }), "state" === e && (0, n.jsx)(ej, {}), "logging" === e && (0, n.jsx)(ev, {})]
  })
}