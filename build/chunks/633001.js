...
let R = {
    ...
    }, _.Z.getWidgetDefaultSettings(E.Odu.CLICK_ZONE_DEBUG)), {
      pinned: !0
    }),
    [E.Odu.PERFORMANCE_DEBUG]: e => k(w({
    ...
    }, _.Z.getWidgetDefaultSettings(E.Odu.PERFORMANCE_DEBUG)), {
      pinned: !0
    })
  },
  A = (e, t) => e.find(e => e.type === t);
...
function L(e) {
  let {
    trackedGame: t
  } = e, n = (0, o.e7)([p.ZP], () => p.ZP.getGameForPID(t.pid)), r = (0, o.e7)([g.Z], () => g.Z.getGameForPID(t.pid));
  return (0, a.jsxs)("div", {
...
function D(e) {
  let {
    pid: t
  } = e, n = (0, o.cj)([j.default], () => j.default.getOverlayPIDStatuses()), r = (0, o.cj)([h.default], () => h.default.getTrackedGames()), l = (0, o.e7)([j.default], () => j.default.isInputLocked(t), [t]), i = (0, o.e7)([j.default], () => j.default.DEV_isInputLockedV3(t), [t]), s = (0, o.e7)([j.default], () => j.default.DEV_isInputLocked(t), [t]), d = (0, o.e7)([j.default], () => j.default.isReady(t), [t]);
  return (0, a.jsxs)("div", {
    children: [(0, a.jsx)(c.Text, {
...
function M(e) {
  let t = A(Object.values((0, o.Wu)([_.Z], () => _.Z.getWidgetsForLayout(T.$S))), e);
  return [t, () => {
...
function B() {
  var e, t;
  let [n, l] = M(E.Odu.CLICK_ZONE_DEBUG), [s, d] = M(E.Odu.PERFORMANCE_DEBUG), _ = (0, o.e7)([f.ZP], () => f.ZP.hasRenderDebugMode(x.G.ClickZones)), g = (0, o.e7)([f.ZP], () => f.ZP.hasRenderDebugMode(x.G.WidgetAreas)), y = (0, o.e7)([f.ZP], () => f.ZP.hasRenderDebugMode(x.G.DisabledGPUBoost)), T = (0, o.e7)([f.ZP], () => f.ZP.hasRenderDebugMode(x.G.ForceGPUBoost)), S = (0, o.e7)([h.default], () => h.default.getForcedRenderMode()), [R, A] = r.useState({}), [Z, B] = r.useState(S), z = e => {
  ...
  })), F = (0, o.cj)([h.default], () => h.default.getTrackedGames()), G = (0, o.e7)([j.default], () => j.default.getFocusedPID()), V = (0, o.e7)([j.default], () => j.default.isFocusedPidOutOfProcess()), H = (0, N.getPID)(), W = (0, o.e7)([h.default], () => h.default.isOverlayOOPEnabledForPid(H), [H]), [K, X] = (0, o.Wu)([v.Z], () => [v.Z.enabled, v.Z.keepOpen]), Y = (0, o.e7)([p.ZP], () => p.ZP.getRunningGames());
  r.useEffect(() => {
    A(e => {
  ...
  r.useEffect(() => ($.current = setInterval(async () => {
    ...
    J(e => a.reduce((e, t) => {
      ...
      let i = null != (n = e[a]) ? n : [];
      return (0 === i.length || i[i.length - 1].screenType !== r) && (e[a] = [...i, {
        pid: a,
        screenType: r,
        timestamp: l
      }]), e
