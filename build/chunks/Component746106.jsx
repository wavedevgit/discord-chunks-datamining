  ...
  let s = i.useContext(p.Z),
    l = i.useCallback(() => ({
      i18n: {
        ...
        LISTBOX_EMPTY_STATE_WITH_QUERY: e => A.intl.formatToPlainString(C.default.bPKiId, {
          query: e
        }),
        ...
        STEP_INDICATOR: (e, t) => A.intl.formatToPlainString(C.default["v2YSk/"], {
          stepNumber: e,
          stepCount: t
        })
      },
...
function P(e) {
  ...
  }).enabled, Z = (0, h.Z)(A, __OVERLAY__ || C), F = 0;
  ...
  let B = (0, I.A)(),
    ...
    z = N(E, D, i.useMemo(() => {
      let e = [];
      return V && e.push("refresh-fast-follow-avatars"), H && e.push("refresh-fast-follow-guild-bg"), Y && e.push("refresh-fast-follow-distinct-borders"), W && e.push("mana-toggle-inputs"), e
    }, [V, H, Y, W]), C, p);
