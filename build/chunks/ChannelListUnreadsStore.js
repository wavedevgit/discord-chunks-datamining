...
function I(e) {
  ...
  return !(null == t || null == t.getGuildId() || t.isGuildVocal()) && !(t.isThread() ? h.Z.isMuted(t.id) : O.ZP.isChannelMuted(t.getGuildId(), t.id)) && (0, u.d)(t)
}
...
function Z(e) {
  ...
  if (p || d)
    for (let e = 0; e < y.length; e++) {
      let t = y[e];
      if (!p && !d) break;
      (I(t.id) || a().some(t.threadIds, I)) && (null == u && (u = t.id), S = true), (N(t.id) || a().some(t.threadIds, N)) && (null == c && (c = t.id), x += m.ZP.getMentionCount(t.id), x += a().sumBy(t.threadIds, m.ZP.getMentionCount))
    }
  let Z = null,
    T = null,
