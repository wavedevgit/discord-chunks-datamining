...
let m = e => {
  ...
  return null != t && x ? <s.JZ title={u.intl.string(u.t.c9BHLy)} description={u.intl.string(u.t.dK8S09)} buttonText={m ? u.intl.string(u.t.f3pnLC) : u.intl.string(u.t.ch2xbm)} buttonDisabled={m} buttonVariant={"critical-primary"} onButtonPress={g} /> : null
}