...
function x(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), _ = g.jU.useSetting(), E = (0, h.P1)(l), x = !1, I = 0 === i.messages.length || o()(i.messages[0].timestamp).isSame(o()(), "day"), P = null != (n = null == (t = b.default.getUser(m.default.getId())) ? void 0 : t.hasFlag(C.xW$.SPAMMER)) && n, N = [];
  if (!i.collapsed) {
    let e = null,
      t = null,
