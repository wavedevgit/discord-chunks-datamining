...
function E(e) {
  ...
  let {
    ...
    treatSpam: h,
    gotoChannel: f
  } = e, g = (0, s.JA)(null != (t = c.id) ? t : ""), m = i.useCallback(e => {
    if ("ArrowLeft" === e.key) {
      var t;
...
function S(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), _ = f.jU.useSetting(), j = (0, d.P1)(l), S = !1, x = 0 === i.messages.length || o()(i.messages[0].timestamp).isSame(o()(), "day"), I = null != (n = null == (t = m.default.getUser(g.default.getId())) ? void 0 : t.hasFlag(y.xW$.SPAMMER)) && n, P = [];
  if (!i.collapsed) {
    let e = null,
      t = null,
    ...
    n.forEach(n => {
      ...
      t = n, S = S || (0, d.DQ)(n), P.push((0, r.jsx)(E, {
        channel: l,
        message: n,
        compact: _,
        isGroupStart: i,
    ...
    }), i.messages.length >= O.hC && P.push((0, r.jsxs)(a.zxk, {
      color: a.zxk.Colors.LINK,
      look: a.zxk.Looks.LINK,
      onClick: e => s(e, n[n.length - 1].id),
      children: [v.intl.string(v.t["9OB9ho"]), " ›"]
    }, "view-all")), 0 === P.length && (P = [(0, r.jsx)(a.$jN, {}, "spinner")])
  }
  return S && j && c.Z.trackExposure({
    location: "20e3b0_2"
  }), (0, r.jsx)("div", {
