...
function E(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), _ = f.jU.useSetting(), j = (0, d.P1)(l), E = !1, x = 0 === i.messages.length || o()(i.messages[0].timestamp).isSame(o()(), "day"), I = null != (n = null == (t = m.default.getUser(g.default.getId())) ? void 0 : t.hasFlag(y.xW$.SPAMMER)) && n, P = [];
  if (!i.collapsed) {
    let e = null,
      t = null,
