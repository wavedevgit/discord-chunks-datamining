...
function X() {
  ...
  !(0, g.m1)() || !e && null != t || v.Z.isHandoffAvailable() || Q({
...
function eg(e) {
  ...
  }), x = t, k = t, c.K.set(C, x)) : X() : null != t && x !== t && b.default.track(T.rMx.EXTERNAL_FINGERPRINT_DROPPED, {
    fingerprint: (0, o.s)(x),
...
function eS(e) {
  ...
  $("handleLogout called.");
  let n = en();
  null != (t = null == e ? void 0 : e.isSwitchingAccount) && t || (n && J(), X()), s.ZP.PersistedStore.clearAll({
  ...
  }), I.Z.clearAll(), h.ZH(), O.Z.clearUser(), c.K.remove(w), R = null, P = null, M = (null == e ? void 0 : e.isSwitchingAccount) ? T.u34.LOGGING_IN : T.u34.NONE, B = "", F = null, Z = !1, K = !1, z = !1, eu()
}
