...
function d(e) {
  ...
  }, [t]), <r.Fragment>{<o.Z ref={n} className={l.video} src={u.Z} loop={true} muted={true} playsInline={true} autoPlay={true} />}{<i.Z itemId={c.yN.AT_SOMEONE} pointsPerInterval={d} interval={1e3} isPaused={t} />}</r.Fragment>
}