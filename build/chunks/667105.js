...
function w(e) {
  ...
  return i.useCallback(() => {
    null != t && (l({
      ...
      questContentPosition: r,
      questContentRowIndex: o
    }), s ? (0, v.Bg)(t.config) ? (0, S.openQuestsNitroRewardModal)(t, n) : (0, v.Xv)(t.config) ? (0, O.m)(t, n) : (0, v.vQ)(t.config) ? (0, S.openQuestInGameRewardModal)(t, n) : (0, v.xN)(t.config) ? (0, S.openQuestOrbsRewardModal)(t, n) : (0, S.openQuestsRewardCodeModal)({
      questId: t.id,
      location: n,
      questContentPosition: r
    }) : (0, I.B)())
  ...
  return i.useMemo(() => {
    switch (r) {
      ...
      case g.OH.IN_PROGRESS:
        ...
        return {
          text: N.NW.string(N.t.cfY4PD), tooltipText: N.NW.string(N.t.hsbwjo), onClick: null
        };
      case g.OH.COMPLETED:
        return {
          text: N.NW.string(N.t.cfY4PD), tooltipText: null, onClick: E
        };
      case g.OH.CLAIMED:
        let i = {
          tooltipText: null,
        ...
        if (o) return P(C({}, i), {
          text: N.NW.string(N.t.MAS7uL)
        });
        if ((0, v.vQ)(n.config)) return P(C({}, i), {
          text: N.NW.string(N.t.vTgCW1)
        });
