...
function M(e) {
  ...
  } = e, l = (0, a.e7)([_.default], () => _.default.getCurrentUser()), c = null == l ? void 0 : l.hasVerifiedEmailOrPhone(), u = null == l ? void 0 : l.verified, d = (0, h.O5)();
  return i.useCallback(() => {
    null != t && (d({
      ...
      questContentRowIndex: o,
      sourceQuestContent: s
    }), (0, g.xN)(t.config) && !u ? (0, A.B)() : c ? (0, g.Bg)(t.config) ? (0, T.openQuestsNitroRewardModal)(t, n) : (0, g.Xv)(t.config) ? (0, S.m)(t, n) : (0, g.vQ)(t.config) ? (0, T.openQuestInGameRewardModal)(t, n, s) : (0, g.xN)(t.config) ? (0, T.openQuestOrbsRewardModal)(t, n) : (0, T.openQuestsRewardCodeModal)({
      questId: t.id,
      questContent: n,
      questContentPosition: r,
      sourceQuestContent: s
...
let j = e => {
  ...
  U = (e, t, n) => {
    let {
      ...
      var i;
      let s = r.target;
      (null == s || null == (i = s.tagName) ? void 0 : i.toLowerCase()) === "a" && a({
        questId: e,
        questContent: t,
        questContentCTA: s.getAttribute("href") === o ? h.jZ.HOW_TO_HELP_ARTICLE_XBOX : h.jZ.HOW_TO_HELP_ARTICLE_PLAYSTATION,
...
function B(e) {
    ...
    switch (r) {
      case b.OH.UNACCEPTED:
        let e = P.intl.string(P.t.kUQLMD),
          t = h.jZ.ACCEPT_QUEST;
        return p && (e = P.intl.string(P.t.umdNio), t = h.jZ.START_QUEST), y && ({
          text: e,
          questContentCTA: t
        } = G(n)), {
          text: e,
      ...
      case b.OH.COMPLETED:
        return {
          text: P.intl.string(P.t.cfY4PD), tooltipText: null, onClick: v
        };
      case b.OH.CLAIMED:
        let i = {
          tooltipText: null,
        ...
        if ((0, g.vQ)(n.config)) return x(D({}, i), {
  ...
  }, [r, p, I, _, v, o, n, a, s, u, L, S, A, w, y, k, O])
}
...
function F(e) {
  ...
  if ((0, g.Bg)(r.config)) {
    ...
    if (null == l ? void 0 : l.isPurchasedExternally) return {
      isQuestBarVisible: !1,
