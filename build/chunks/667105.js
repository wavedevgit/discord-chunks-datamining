...
let M = e => {
    let {
      useReducedMotion: t,
      className: n
    } = e, [o, l] = (0, s.q_F)(() => ({})), c = i.useRef(!1), u = e => {
      c.current = !0, l({
        from: {
          rotate: "0deg"
        },
  ...
  U = (e, t, n) => {
    let {
      ...
      var i;
      let s = r.target;
      (null == s || null == (i = s.tagName) ? void 0 : i.toLowerCase()) === "a" && o({
        questId: e,
        questContent: t,
...
function B(e) {
    ...
    switch (r) {
      case b.OH.UNACCEPTED:
        let e = R.intl.string(R.t.kUQLMD),
          t = h.jZ.ACCEPT_QUEST;
        return p && (e = R.intl.string(R.t.umdNio), t = h.jZ.START_QUEST), y && ({
          text: e,
          questContentCTA: t
        } = G(n)), {
          text: e,
          ...
          onClick: () => {
            ...
            }) : y && n.config.features.includes(N.S7.START_QUEST_CTA) && j()
          }
        };
      case b.OH.ACCEPTED:
      case b.OH.IN_PROGRESS:
        ...
        if (y && n.config.features.includes(N.S7.START_QUEST_CTA)) {
          ...
          return {
            ...
            tooltipText: R.intl.string(R.t.hsbwjo),
            onClick: () => {
              n.config.features.includes(N.S7.START_QUEST_CTA) && j()
            }
          }
        }
        return {
      ...
      case b.OH.COMPLETED:
        return {
          text: R.intl.string(R.t.cfY4PD), tooltipText: null, onClick: v
        };
      case b.OH.CLAIMED:
        let i = {
          tooltipText: null,
  ...
  }, [r, p, I, _, v, a, n, o, s, u, L, S, A, P, y, j, O])
}
