...
function x(e) {
  ...
  return i.useCallback(() => {
    null != t && (l({
      ...
      questContentPosition: r,
      questContentRowIndex: o
    }), s ? (0, v.Bg)(t.config) ? (0, T.openQuestsNitroRewardModal)(t, n) : (0, v.Xv)(t.config) ? (0, I.m)(t, n) : (0, v.vQ)(t.config) ? (0, T.openQuestInGameRewardModal)(t, n) : (0, v.xN)(t.config) ? (0, T.openQuestOrbsRewardModal)(t, n) : (0, T.openQuestsRewardCodeModal)({
      questId: t.id,
      location: n,
      questContentPosition: r
    }) : (0, S.B)())
...
function G(e) {
  ...
  return i.useMemo(() => {
    switch (r) {
        ...
        return p && (e = R.NW.string(R.t.umdNio), t = h.jZ.START_QUEST), b && ({
          ...
          onClick: () => {
            (0, g.AH)(n.id, {
              ...
              questContentPosition: s,
              questContentRowIndex: u
            }), p ? (0, T.openVideoQuestModal)(n) : b && n.config.features.includes(N.S7.START_QUEST_CTA) && M()
          }
        };
      case E.OH.ACCEPTED:
      ...
      case E.OH.COMPLETED:
        return {
          text: R.NW.string(R.t.cfY4PD), tooltipText: null, onClick: y
        };
      case E.OH.CLAIMED:
        let i = {
          tooltipText: null,
  ...
  }, [r, p, O, _, y, o, n, a, s, u, D, I, S, P, b, M])
}
