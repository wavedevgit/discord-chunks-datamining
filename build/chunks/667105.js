...
function D(e) {
  ...
  return i.useCallback(() => {
    null != t && (l({
      ...
      questContentPosition: r,
      questContentRowIndex: o
    }), s ? (0, y.Bg)(t.config) ? (0, S.openQuestsNitroRewardModal)(t, n) : (0, y.Xv)(t.config) ? (0, O.m)(t, n) : (0, y.vQ)(t.config) ? (0, S.openQuestInGameRewardModal)(t, n) : (0, y.xN)(t.config) ? (0, S.openQuestOrbsRewardModal)(t, n) : (0, S.openQuestsRewardCodeModal)({
      questId: t.id,
      location: n,
      questContentPosition: r
    }) : (0, I.B)())
...
let x = e => {
  ...
  M = (e, t) => {
    let {
      ...
      var r;
      let a = n.target;
      (null == a || null == (r = a.tagName) ? void 0 : r.toLowerCase()) === "a" && o({
        questId: e,
        questContent: t,
    ...
    switch (r) {
      case g.OH.UNACCEPTED:
        let e = A.NW.string(A.t.kUQLMD),
          t = p.jZ.ACCEPT_QUEST;
        return _ && (e = A.NW.string(A.t.umdNio), t = p.jZ.START_QUEST), E && ({
          text: e,
          questContentCTA: t
        } = k(n)), {
          text: e,
      ...
      case g.OH.IN_PROGRESS:
        ...
        return {
          text: A.NW.string(A.t.cfY4PD), tooltipText: A.NW.string(A.t.hsbwjo), onClick: null
        };
      case g.OH.COMPLETED:
        return {
          text: A.NW.string(A.t.cfY4PD), tooltipText: null, onClick: b
        };
      case g.OH.CLAIMED:
        let i = {
          tooltipText: null,
        ...
        else if ((0, y.xN)(n.config)) return {
          tooltipText: null,
