...
let y = (e, t) => {
  ...
  O = e => {
    let {
      ...
      selectedChannelId: O
    }), P = S === c.FN.CONTEXT_MENU, [I, N] = (0, a.US)(j && P && x && C ? [i.z.CHAT_WALLPAPERS_DM_LIST_COACHMARK] : []), Z = (0, s.m)(f.p9.TIER_2), w = (0, d.Z)(n), E = I === i.z.CHAT_WALLPAPERS_DM_LIST_COACHMARK;
    if (!E) return t;
    let T = () => {
        N(h.L.USER_DISMISS)
      },
