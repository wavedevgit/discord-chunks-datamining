...
let b = (e, t) => {
  ...
  _ = e => {
    let {
      ...
      channelId: n,
      selectedChannelId: _
    } = e, O = (0, l.wE)(i.z.CHAT_WALLPAPERS_PICKER_COACHMARK), j = (0, c.sX)({
      location: "channel_context_menu"
    }).entryPoint === c.FN.CONTEXT_MENU, x = _ === n, [C, S] = (0, a.US)(O && j && x ? [i.z.CHAT_WALLPAPERS_DM_LIST_COACHMARK] : []), P = (0, s.m)(h.p9.TIER_2), I = (0, u.Z)(n), N = C === i.z.CHAT_WALLPAPERS_DM_LIST_COACHMARK;
    if (!N) return t;
    let Z = () => {
        S(p.L.USER_DISMISS)
      },
