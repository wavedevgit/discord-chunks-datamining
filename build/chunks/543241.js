...
let P = function(e, t) {
    ...
    return r.useMemo(() => {
      ...
      })(o, I.En.GUILD), l.ZP.categories.reduce((t, r) => {
  ...
  L = e => {
    ...
    let {
      ...
      intention: d,
      index: f
    } = e, _ = null != (r = i.uniqueName) ? r : i.name, p = (0, a.EQ)(d).with(T.Hz.REACTION, () => S.aib.EMOJI_REACTION).with(T.Hz.AUTO_SUGGESTION, () => S.aib.EMOJI_AUTO_SUGGESTION).otherwise(() => S.aib.EMOJI);
