...
let R = function(e, t) {
  ...
  k = e => {
    ...
    let {
      ...
      intention: d,
      index: f
    } = e, _ = null != (r = i.uniqueName) ? r : i.name, p = (0, o.EQ)(d).with(A.Hz.REACTION, () => T.aib.EMOJI_REACTION).with(A.Hz.AUTO_SUGGESTION, () => T.aib.EMOJI_AUTO_SUGGESTION).otherwise(() => T.aib.EMOJI);
