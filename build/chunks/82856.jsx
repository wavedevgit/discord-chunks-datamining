...
function O(e) {
  ...
  return <i.yRy fixed={true} autoInvert={false} renderPopout={() => p} position={"bottom"} align={"right"} shouldShow={g} spacing={-_} animation={i.yRy.Animation.NONE} targetElementRef={o} positionKey={"".concat(h.balance, "-").concat(O)}>{() => y}</i.yRy>
}