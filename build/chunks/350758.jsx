...
function d(t) {
  ...
  return n && !e && d ? <l.sNh id={"repair"} label={s.intl.string(s.t.CKCcd3)} action={() => o.repairApplication(t.id, t.branchId, u.Sbl.APPLICATION_CONTEXT_MENU_TOGGLE_INSTALL)} /> : null
}