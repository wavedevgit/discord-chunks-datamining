...
function g(e, t) {
  let {
    ...
    markers: I,
    onBeforeDismount: T
  } = e, [S, A] = i.useState(null), N = i.useRef(null), C = i.useRef(null), w = i.useRef(null), R = "custom" === g ? {
    width: E,
    height: b
  } : (0, u.m)(g), P = !(0, _.Z)("lottie_hover_multiple_loop"), D = i.useContext(c.S).reducedMotion.enabled, {
    enabled: L
  } = d.Z.useExperiment({
  ...
  return (0, f.zq)(() => {
    var e, t;
    null == T || T({
      finalFrame: null != (t = null == (e = w.current) ? void 0 : e.currentFrame) ? t : null
    })
    ...
    null != N.current && (w.current = i.loadAnimation({
      container: N.current,
      renderer: "svg",
      loop: !1,
      autoplay: !1,
