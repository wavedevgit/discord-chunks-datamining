...
function I(e) {
  let {
    ...
    selectedSkuId: I
  } = (0, p.JL)(), [T, S] = i.useState(n), [A, N] = i.useState(), [C, R] = i.useState(!1), P = (0, f.pO)(T), w = (0, l.TX)(), {
    enabled: D
  } = c.O.useExperiment({
    location: "gift card"
  }), L = b;
  P && (L = w ? m.Cj.SEASONAL_STANDARD_BOX : null != h ? h : E, D && (L = m.Cj.NITROWEEN_STANDARD));
  let [x, M] = i.useState(L), k = (0, d.iE)(), [j, U] = i.useState(), [G, B] = i.useState(t && (0, f.MY)(T) === f.xr.CUSTOM_MESSAGE_EMOJI_SOUNDBOARD && null == _ ? g.intl.string(g.t.ZkOo1d) : _), [V, F] = i.useState(void 0), [Z, H] = i.useState(void 0), Y = (0, f.E5)(I, t), [W, K] = i.useState(!1), [z, q] = i.useState(!1), [X, Q] = i.useState(), J = i.useCallback(e => {
    let {
