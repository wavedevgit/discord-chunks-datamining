...
function O(e) {
  ...
  let [w, D] = i.useState(P), L = (0, c.iE)(), [x, M] = i.useState(), [k, j] = i.useState(t && (0, d.MY)(v) === d.xr.CUSTOM_MESSAGE_EMOJI_SOUNDBOARD && null == u ? h.intl.string(h.t.ZkOo1d) : u), [U, G] = i.useState(void 0), [B, Z] = i.useState(void 0), F = (0, d.E5)(O, t), [V, H] = i.useState(!1), [Y, W] = i.useState(!1), [K, z] = i.useState(), q = i.useCallback(e => {
    let {
