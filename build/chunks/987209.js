...
function I(e) {
  let {
    ...
    selectedSkuId: I
  } = (0, p.JL)(), [T, S] = i.useState(n), [A, N] = i.useState(), [C, R] = i.useState(!1), P = (0, _.pO)(T), w = (0, l.TX)(), {
    enabled: D
  } = c.O.useExperiment({
    location: "gift card"
  }), L = b;
  P && (L = w ? m.Cj.SEASONAL_STANDARD_BOX : null != h ? h : E, D && (L = m.Cj.NITROWEEN_STANDARD));
  let [x, k] = i.useState(L), M = (0, d.iE)(), [j, U] = i.useState(), [G, B] = i.useState(t && (0, _.MY)(T) === _.xr.CUSTOM_MESSAGE_EMOJI_SOUNDBOARD && null == f ? g.intl.string(g.t.ZkOo1d) : f), [V, F] = i.useState(void 0), [Z, H] = i.useState(void 0), Y = (0, _.E5)(I, t), [W, K] = i.useState(!1), [z, q] = i.useState(!1), [X, Q] = i.useState(), J = i.useCallback(e => {
    let {
      onSubscriptionConfirmation: t
    } = e;
    return q(!0), (0, s.YD)(T, Y).then(() => {
      q(!1), null == t || t(), K(!0)
    }).catch(e => {
      q(!1), Q(e), K(!0)
    })
  }, [T, Y, q, K, Q]), $ = (0, u.x8)(), ee = (0, a.Wu)([o.Z], () => o.Z.recommendedGiftSkuIds);
