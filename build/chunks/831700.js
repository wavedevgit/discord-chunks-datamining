              ...
              return (0, r.jsx)(N.Z, {
                ...
                children: (0, r.jsxs)(H.ZP, et(ee({
                  ...
                  children: [x && (0, r.jsxs)(r.Fragment, {
                    ...
                    children: [this.renderOpenChatButton(), this.renderInviteButton(), E ? this.renderOptionsButton({
...
function ei(e) {
  ...
  } = (0, x.Z)(n.id), j = (0, O.Z)(), C = (0, a.e7)([G.ZP], () => G.ZP.isFavorite(t.id, n.id)), P = e.connected || (null == j ? void 0 : j.channelId) === n.id, I = (0, F.Z)({
    channel: n,
    isChannelSelected: o,
