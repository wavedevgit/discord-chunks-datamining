...
class ee extends B.ZP {
  ...
  render() {
    ...
    return O && (A = f(A)), _ && (A = h(p(A))), y && (A = (0, r.jsx)(w.Z, {
      childRef: this.ref,
...
function en(e) {
  ...
  } = (0, E.Z)(n.id), C = (0, v.Z)(), j = (0, s.e7)([M.ZP], () => M.ZP.isFavorite(t.id, n.id)), S = e.connected || (null == C ? void 0 : C.channelId) === n.id, I = (0, V.Z)({
    channel: n,
    isChannelSelected: o,
