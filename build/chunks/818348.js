...
var Chunk812743 = require("./812743.js"),
...
let k = Object.freeze({
    CREATE_INSTANT_INVITE: Chunk136722.jB(0),
    KICK_MEMBERS: Chunk136722.jB(1),
    BAN_MEMBERS: Chunk136722.jB(2),
    ADMINISTRATOR: Chunk136722.jB(3),
    MANAGE_CHANNELS: Chunk136722.jB(4),
    MANAGE_GUILD: Chunk136722.jB(5),
    CHANGE_NICKNAME: Chunk136722.jB(26),
    MANAGE_NICKNAMES: Chunk136722.jB(27),
    MANAGE_ROLES: Chunk136722.jB(28),
    MANAGE_WEBHOOKS: Chunk136722.jB(29),
    MANAGE_GUILD_EXPRESSIONS: Chunk136722.jB(30),
    CREATE_GUILD_EXPRESSIONS: Chunk136722.jB(43),
    VIEW_AUDIT_LOG: Chunk136722.jB(7),
    VIEW_CHANNEL: Chunk136722.jB(10),
    VIEW_GUILD_ANALYTICS: Chunk136722.jB(19),
    VIEW_CREATOR_MONETIZATION_ANALYTICS: Chunk136722.jB(41),
    MODERATE_MEMBERS: Chunk136722.jB(40),
    USE_EMBEDDED_ACTIVITIES: Chunk136722.jB(39),
    USE_EXTERNAL_APPS: Chunk136722.jB(50),
    SEND_MESSAGES: Chunk136722.jB(11),
    SEND_TTS_MESSAGES: Chunk136722.jB(12),
    MANAGE_MESSAGES: Chunk136722.jB(13),
    EMBED_LINKS: Chunk136722.jB(14),
    ATTACH_FILES: Chunk136722.jB(15),
    READ_MESSAGE_HISTORY: Chunk136722.jB(16),
    MENTION_EVERYONE: Chunk136722.jB(17),
    USE_EXTERNAL_EMOJIS: Chunk136722.jB(18),
    ADD_REACTIONS: Chunk136722.jB(6),
    USE_APPLICATION_COMMANDS: Chunk136722.jB(31),
    MANAGE_THREADS: Chunk136722.jB(34),
    CREATE_PUBLIC_THREADS: Chunk136722.jB(35),
    CREATE_PRIVATE_THREADS: Chunk136722.jB(36),
    USE_EXTERNAL_STICKERS: Chunk136722.jB(37),
    SEND_MESSAGES_IN_THREADS: Chunk136722.jB(38),
    SEND_VOICE_MESSAGES: Chunk136722.jB(46),
    SEND_POLLS: Chunk136722.jB(49),
    PIN_MESSAGES: Chunk136722.jB(51),
    BYPASS_SLOWMODE: Chunk136722.jB(52),
    CONNECT: Chunk136722.jB(20),
    SPEAK: Chunk136722.jB(21),
    MUTE_MEMBERS: Chunk136722.jB(22),
    DEAFEN_MEMBERS: Chunk136722.jB(23),
    MOVE_MEMBERS: Chunk136722.jB(24),
    USE_VAD: Chunk136722.jB(25),
    PRIORITY_SPEAKER: Chunk136722.jB(8),
    STREAM: Chunk136722.jB(9),
    USE_SOUNDBOARD: Chunk136722.jB(42),
    USE_EXTERNAL_SOUNDS: Chunk136722.jB(45),
    SET_VOICE_CHANNEL_STATUS: Chunk136722.jB(48),
    REQUEST_TO_SPEAK: Chunk136722.jB(32),
    MANAGE_EVENTS: Chunk136722.jB(33),
    CREATE_EVENTS: Chunk136722.jB(44)
  }),
  U = function() {
...
let X = 250,
  ...
  en = {
    ...
    VIRTUAL_GOODS_TERMS: "/terms/paid-services-terms#:~:text=one%2Dtime%20purchases.-,VIRTUAL%20GOODS,-You%20may%20be"
  },
  er = Object.freeze({
...
let eo = (0, Chunk323125.dN)(ei),
  es = (0, Chunk323125.dN)(ea),
  el = Object.freeze({
