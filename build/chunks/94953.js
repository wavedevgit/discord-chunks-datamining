...
function O(e) {
  let {
    ...
    context: h,
    icon: y
  } = e, j = (0, s.e7)([b.Z], () => b.Z.getGuild(t), [t]), _ = (0, s.e7)([d.default], () => d.default.getId()), P = (0, s.e7)([f.default], () => f.default.getUser(n)), v = (0, s.e7)([g.ZP], () => g.ZP.isGuestOrLurker(t, n), [t, n]), A = r.useMemo(() => ({
    [t]: [n]
  }), [t, n]), m = (0, u.EJ)(j);
  (0, a.$)(A);
