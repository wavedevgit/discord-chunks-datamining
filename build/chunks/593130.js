...
function b(e) {
  let {
    ...
    className: n,
    onClose: l
  } = e, b = (0, i.e7)([d.Z], () => d.Z.can(v.Plq.READ_MESSAGE_HISTORY, t)), T = (0, h.cD)(t), y = () => {
    l(), (0, x.R6)(t, void 0, "Thread Browser Empty State")
  }, P = a.useCallback((e, t) => {
    l(), (0, x.ok)(e, !t, j.on.BROWSER)
  }, [l]), C = function(e, t) {
    let [n, r] = a.useState(""), [l, s] = a.useState(!1), [i, o] = a.useState(!1), [c, d] = a.useState([]), h = async () => {
      if (null != n && "" !== n && !l) {
        s(!0);
        try {
  ...
  return a.useEffect(() => {
    ...
    children: (0, r.jsx)(c.y5t, {
      ...
      children: C.hasResults ? (0, r.jsx)(m.Z, {
        channel: t,
        startThread: y,
        goToThread: P,
        threadIds: C.results
