...
let P = Chunk64700.memo(function(e) {
  let {
    ...
    onClick: c,
    onContextMenu: d
  } = e, [f, p] = i.useState(false), [_, m] = i.useState(n.split(".").slice(false)[0]), [g, E] = i.useState(false), {
    fileContents: y,
    bytesLeft: b,
    hadError: O
  } = v(t, s);
