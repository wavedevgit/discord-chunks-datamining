...
function W() {
  ...
  }, []), [F, z] = Chunk647438.useState(Chunk899457.a.UNENROLLED), [X, G] = Chunk647438.useState(false), [K, Y] = Chunk647438.useState(false), [J, $] = Chunk647438.useState(null), ee = (M = W.config, (0, Chunk278074.EQ)(M).with({
    configVersion: 2
