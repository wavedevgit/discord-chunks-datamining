...
let j = (0, Chunk108843.Z)((0, Chunk883385.Z)(function(e) {
  let {
    ...
    return i ? <c.sNh id={"edit-soundboard-sound"} label={m.intl.string(m.t.ponZcH)} action={u} /> : null
  }(s, t), j = function(e) {
    let {
      soundId: t
    ...
    return e.guildId === v.X8 ? null : <c.sNh id={"download-soundboard-sound"} label={m.intl.string(m.t["/fzLLC"])} action={n} />
  }(s), S = (0, g.Z)(s, d), P = (0, b.Z)({
    id: s.soundId,
    label: m.intl.string(m.t.HJikXl)
  });
  return <c.v2r navId={"sound-button-context"} onClose={l.Zy} aria-label={m.intl.string(m.t.liqwPD)} onSelect={f}><c.kSQ>{h}{S}{j}{P}</c.kSQ></c.v2r>
}, {
