...
let d = Chunk73800.forwardRef(function(e, t) {
  ...
  return <div className={u.wrapper}><s.E1j autoFocus={d} disabled={!d} query={E} ref={g} placeholder={T()} onClear={I} onKeyDown={f} onChange={v} className={u.__invalid_searchBar} inputProps={{
        "aria-haspopup": "grid",
        "aria-controls": _,
        "aria-expanded": true,
