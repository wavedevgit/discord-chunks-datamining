...
function H(e) {
  ...
  if (i.useEffect(() => {
      y === L.d4z.DM && null == M && null != P && a.Z.wait(() => (0, _.Z)(p.getRecipientId(), P.getAvatarURL(null, 80), {
        withMutualGuilds: !0
      }))
    }, [M, y, p, P]), i.useEffect(() => {
      (null == P ? void 0 : P.bot) && z === v.M.NOT_FETCHED && s.Z.fetch()
    }, [null == P ? void 0 : P.bot, z]), p.isSystemDM()) return H ? (0, r.jsx)(w.Z, {
    channel: p
  }) : (0, r.jsx)(T.Z, {
    channel: p,
  ...
  if (y === L.d4z.DM) {
    let e;
    return null != P && null != G ? null != V && (e = (0, r.jsxs)("div", {
  ...
  }) : p.hasFlag(D.zZ.IS_JOIN_REQUEST_INTERVIEW_CHANNEL) ? (0, r.jsx)(I.Z, {
    channel: p
  }) : (0, r.jsx)(T.Z, {
    channel: p,
