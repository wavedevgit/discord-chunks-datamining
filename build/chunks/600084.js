...
function G(e) {
  ...
  if (i.useEffect(() => {
      x === D.d4z.DM && null == M && null != I && a.Z.wait(() => (0, _.Z)(p.getRecipientId(), I.getAvatarURL(null, 80), {
        withMutualGuilds: !0
      }))
    }, [M, x, p, I]), i.useEffect(() => {
      (null == I ? void 0 : I.bot) && W === C.M.NOT_FETCHED && s.Z.fetch()
    }, [null == I ? void 0 : I.bot, W]), p.isSystemDM()) return G ? (0, r.jsx)(w.Z, {
    channel: p
  }) : (0, r.jsx)(T.Z, {
    channel: p,
  ...
  if (x === D.d4z.DM) {
    ...
    return null != I && null != V ? null != z && (e = (0, r.jsxs)("div", {
      ...
      children: [null != I && !I.isProvisional && (0, r.jsx)(o.X6q, {
        ...
        username: y
      }), (null == I ? void 0 : I.isProvisional) && (0, r.jsx)(m.q, {
        userId: I.id
      }), e]
    })
  }
