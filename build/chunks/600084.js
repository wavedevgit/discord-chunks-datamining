...
function F(e) {
  let {
    canManageRoles: t,
    channel: n
  } = e, i = t && (0, p.Yk)(n), o = (0, l.e7)([C.ZP], () => null != n.guild_id && n === C.ZP.getDefaultChannel(n.guild_id), [n]);
  if ((0, h.Z)(n.id)) return null;
  if (n.isForumPost()) return (0, r.jsx)(S.Z, {
    channel: n
  });
...
function H(e) {
  ...
  let {
    ...
    type: C
  } = p, S = (0, l.e7)([j.default], () => p.isPrivate() ? j.default.getUser(p.getRecipientId()) : null), A = O.ZP.useUserTag(S), {
    canManageRoles: R,
  ...
  if (i.useEffect(() => {
      C === L.d4z.DM && null == M && null != S && a.Z.wait(() => (0, _.Z)(p.getRecipientId(), S.getAvatarURL(null, 80), {
        withMutualGuilds: !0
      }))
    }, [M, C, p, S]), i.useEffect(() => {
      (null == S ? void 0 : S.bot) && W === y.M.NOT_FETCHED && s.Z.fetch()
    }, [null == S ? void 0 : S.bot, W]), p.isSystemDM()) return H ? (0, r.jsx)(w.Z, {
    channel: p
  }) : (0, r.jsx)(T.Z, {
    channel: p,
  ...
  if (C === L.d4z.DM) {
    let e;
    return null != S && null != V ? null != z && (e = (0, r.jsxs)("div", {
      ...
      channel: p,
      user: S,
      children: [null != S && !S.isProvisional && (0, r.jsx)(o.X6q, {
        variant: "heading-xl/medium",
        className: G.marginBottom20,
        children: A
      }), U.intl.format(U.t["Qvg+6+"], {
        username: x
      }), (null == S ? void 0 : S.isProvisional) && (0, r.jsx)(m.qE, {
        userId: S.id
      }), e]
    })
  }
  if (p.isMultiUserDM())
    if (p.isManaged()) return (0, r.jsxs)(I.ZP, {
      channelId: p.id,
