...
let y = 1e3,
  b = e => {
    ...
    let {
      mediaUrls: w,
      isSuccess: R
    } = (0, _.A)(!b && a && C), P = (0, i.useRef)(null), [D, L] = (0, i.useState)(false), [x, M] = (0, i.useState)(false), [j, k] = (0, i.useState)("none"), [U, G] = (0, i.useState)(false);
    if ((0, i.useEffect)(() => {
        let e;
        a && n && !U && "none" === j && (b || !R ? (k("static"), b || (G(true), f.default.track(h.HAw.PREMIUM_BRAND_REFRESH_WOW_MOMENT_ASSETS_NOT_LOADED_ON_CONFIRMATION)), e = false) : (k("animated"), M(true), e = true), c.h.dispatch({
