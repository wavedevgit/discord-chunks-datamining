...
function P(e) {
  ...
  let {
    ...
    return ""
  }((0, y.getOS)())), [$, ee] = i.useState(""), [et, en] = i.useState(""), [er, ei] = i.useState(""), [el, ea] = i.useState(""), [eo, es] = i.useState(false), [eu, ec] = i.useState(false), [ed, em] = i.useState(false), [eh, ep] = i.useState(null);
  i.useEffect(() => {
    ...
    o.tn.get({
      ...
      if (null != e.body && "d38c76c0b5eb5098a13ab6bb292c9641a156fdbb" !== e.body.hash) {
        let e = new Date("1757454273156"),
          t = new Date,
          n = (0, b.TD)(t, e);
