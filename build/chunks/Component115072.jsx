...
function k(e) {
  ...
  let {
    transitionState: N,
    onClose: I
  } = e, A = i.useRef(null), R = i.useRef(null), [L, W] = i.useState(""), [Z, q] = i.useState(""), [z, M] = i.useState(), [B, V] = i.useState(""), [G, H] = i.useState([]), [U, X] = i.useState(), [J, Y] = i.useState(), [K, Q] = i.useState(false), [F, $] = i.useState(""), [ee, et] = i.useState(function(e) {
    switch (e) {
      case "windows":
        return "Windows";
      case "macos":
    ...
    return ""
  }((0, O.getOS)())), [en, er] = i.useState(""), [ei, el] = i.useState(""), [ea, eo] = i.useState(""), [es, eu] = i.useState(""), [ec, ed] = i.useState(false), [em, ep] = i.useState(false), [eh, ef] = i.useState(false), [ev, ex] = i.useState(null);
  i.useEffect(() => {
    ...
    o.tn.get({
      ...
      if (null != e.body && "a9e1ddceaf60221a8dc60da15089a07cc8952750" !== e.body.hash) {
        let e = new Date("1758562196898"),
          t = new Date,
          n = (0, b.TD)(t, e);
  ...
  async function eS() {
    var e, t;
    if (ef(false), "" === L || "" === Z || null == z) return void ed(true);
    let i = null == U || null == (e = U.features) ? true : e.find(e => (0, _.pD)(e) === J);
    ep(true), ed(false);
    let l = (0, S.D)(G.map(e => {
        let {
          item: t
      ...
      children: (0, r.jsxs)("form", {
        ...
        children: [null != ey && (0, r.jsx)(u.ToO, {
          ...
          children: [(0, r.jsx)(u.oil, {
            ...
            error: ec && true === z ? w.intl.string(w.t.EkokLy) : null,
