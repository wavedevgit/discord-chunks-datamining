...
function E(e) {
  ...
  let {
    transitionState: I,
    onClose: N
  } = e, L = r.useRef(null), A = r.useRef(null), [Z, M] = r.useState(""), [R, W] = r.useState(""), [V, q] = r.useState(), [B, H] = r.useState(""), [z, G] = r.useState([]), [U, X] = r.useState(), [Y, F] = r.useState(), [K, J] = r.useState(false), [Q, $] = r.useState(""), [ee, et] = r.useState(function(e) {
    switch (e) {
      case "windows":
        return "Windows";
      case "macos":
  ...
  r.useEffect(() => {
    ...
    o.tn.get({
      ...
      if (null != e.body && "3590ea571789afe7f78a95d441fe028c33aa894d" !== e.body.hash) {
        let e = new Date("1760744092031"),
          t = new Date,
          n = (0, j.TD)(t, e);
  ...
  async function eO() {
    ...
    ep(false), null != l && l.ok ? (ex && window.open(l.body.permalink_url, "_blank"), N(), (0, u.ZDy)(async () => {
      let {
        default: e
    ...
    children: (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsxs)(u.Kqy, {
        ...
        children: [null != ey && (0, i.jsxs)(u.M14, {
          ...
          children: [(0, i.jsx)(u.Heading, {
            variant: "heading-md/medium",
            children: w.intl.formatToPlainString(w.t["ql2Q/f"], {
              hours: eh
            })
          }), (0, i.jsx)(u.Text, {
            variant: "text-sm/normal",
