...
function s(e, t, n, r, i, o) {
  let s = e[t++] ^ n[r++],
    ...
    M = O,
    U = v;
  for (let e = 0; e < 8; e += 2) C ^= (0, a.XG)(I + j | 0, 7), w ^= (0, a.XG)(C + I | 0, 9), j ^= (0, a.XG)(w + C | 0, 13), I ^= (0, a.XG)(j + w | 0, 18), D ^= (0, a.XG)(N + T | 0, 7), k ^= (0, a.XG)(D + N | 0, 9), T ^= (0, a.XG)(k + D | 0, 13), N ^= (0, a.XG)(T + k | 0, 18), M ^= (0, a.XG)(x + R | 0, 7), S ^= (0, a.XG)(M + x | 0, 9), R ^= (0, a.XG)(S + M | 0, 13), x ^= (0, a.XG)(R + S | 0, 18), A ^= (0, a.XG)(U + L | 0, 7), P ^= (0, a.XG)(A + U | 0, 9), L ^= (0, a.XG)(P + A | 0, 13), U ^= (0, a.XG)(L + P | 0, 18), T ^= (0, a.XG)(I + A | 0, 7), S ^= (0, a.XG)(T + I | 0, 9), A ^= (0, a.XG)(S + T | 0, 13), I ^= (0, a.XG)(A + S | 0, 18), R ^= (0, a.XG)(N + C | 0, 7), P ^= (0, a.XG)(R + N | 0, 9), C ^= (0, a.XG)(P + R | 0, 13), N ^= (0, a.XG)(C + P | 0, 18), L ^= (0, a.XG)(x + D | 0, 7), w ^= (0, a.XG)(L + x | 0, 9), D ^= (0, a.XG)(w + L | 0, 13), x ^= (0, a.XG)(D + w | 0, 18), j ^= (0, a.XG)(U + M | 0, 7), k ^= (0, a.XG)(j + U | 0, 9), M ^= (0, a.XG)(k + j | 0, 13), U ^= (0, a.XG)(M + k | 0, 18);
  i[o++] = s + I | 0, i[o++] = l + T | 0, i[o++] = c + S | 0, i[o++] = u + A | 0, i[o++] = d + C | 0, i[o++] = f + N | 0, i[o++] = _ + R | 0, i[o++] = p + P | 0, i[o++] = h + w | 0, i[o++] = m + D | 0, i[o++] = g + x | 0, i[o++] = E + L | 0, i[o++] = b + j | 0, i[o++] = y + k | 0, i[o++] = O + M | 0, i[o++] = v + U | 0
}
...
async function d(e, t, n) {
  ...
  for (let e = 0; e < o; e++) {
    ...
    await (0, a.oY)(r - 1, g, () => {
      l(f, n, f, n += d, i), m()
    }), l(f, (r - 1) * d, _, t, i), m(), await (0, a.oY)(r, g, () => {
      let e = _[t + d - 16] % r;
