...
function I(e) {
  ...
  } = e, L = (0, i.e7)([h.ZP], () => h.ZP.getMentionCount(n.id)), k = (0, i.e7)([h.ZP], () => h.ZP.getIsMentionLowImportance(n.id)), U = (0, a.ZP)(n), G = (0, i.e7)([f.Z], () => !f.Z.can(C.Plq.CONNECT, n)), B = (0, i.e7)([g.Z], () => g.Z.hasVideo(n.id)), V = (0, u.PK)(n.id) && n.isGuildStageVoice(), F = (0, _.ZP)({
    channel: n,
    locked: G,
    video: B || V,
    selected: I
  ...
  if (!D && M === x.i.ALL_MESSAGES && n.isForumLikeChannel() && null != H && H > 0) return (0, r.jsx)(o.Text, {
