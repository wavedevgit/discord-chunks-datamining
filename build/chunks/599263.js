...
function P(e) {
  let {
    ...
    width: o,
    height: P
  } = (0, d.ZP)(), w = (0, a.Wu)([N.Z], () => N.Z.getOnboardingPromptsForOnboarding(t)), D = (0, a.e7)([N.Z], () => N.Z.getEnabled(t)), T = l.useCallback((e, n, r) => {
  ...
  return (0, r.jsxs)("div", {
    className: i()(y.main, {
      [y.fullBorderWithGradient]: null == S
    }),
    ref: n,
