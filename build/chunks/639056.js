...
let C = function(e) {
  ...
  }).groupBy(e => e.subscriptionPlanId).value(), l = (0, o.Wu)([m.Z], () => m.Z.getUnactivatedFractionalPremiumUnits()), u = (0, o.e7)([g.ZP], () => g.ZP.getPremiumSubscription()), p = (0, o.e7)([g.ZP], () => null == g.ZP.getPremiumTypeSubscription()), b = Object.keys(r).some(e => e === f.Xh.PREMIUM_MONTH_TIER_1), C = (0, o.e7)([d.default], () => d.default.getCurrentUser());
