...
let G = new A.Z("AuditLogUtils"),
  ...
  J = () => y({
    [M.zUn.NAME]: eb(P.t.ahU1o6, P.t["wxs+vb"])
  }, F()),
  X = () => y({
    ...
    let r = function(e, t) {
        switch (e.targetType) {
          ...
          case M.KFR.CHANNEL_OVERWRITE:
            return eS(e, M.zUn.NAME, e => N.Z.getChannel(e), e => (0, _.F6)(e, S.default, R.Z, !0));
          case M.KFR.USER:
            return eS(e, M.zUn.NICK, e => S.default.getUser(e), e => e);
          case M.KFR.ROLE:
            return eS(e, M.zUn.NAME, e => p.Z.getRole(t.id, e), e => e.name);
          case M.KFR.ONBOARDING_PROMPT:
            let n = eS(e, M.zUn.ID, e => f.Z.getOnboardingPrompt(e), e => e.title);
          ...
          case M.KFR.INTEGRATION:
            return eS(e, M.zUn.TYPE, e => x.Z.integrations.find(t => t.id === e), e => e.name);
          case M.KFR.WEBHOOK:
            return eS(e, M.zUn.NAME, e => x.Z.webhooks.find(t => t.id === e), e => e.name);
          case M.KFR.EMOJI:
            return eS(e, M.zUn.NAME, e => m.ZP.getGuildEmoji(t.id).find(t => t.id === e), e => e.name);
          case M.KFR.STICKER:
            return eS(e, M.zUn.NAME, e => h.Z.getStickerById(e), e => e.name);
          ...
          case M.KFR.GUILD_SCHEDULED_EVENT_EXCEPTION:
            return eS(e, M.zUn.NAME, e => x.Z.guildScheduledEvents.find(t => t.id === e), e => e.name);
          case M.KFR.THREAD:
            return eS(e, M.zUn.NAME, e => x.Z.threads.find(t => t.id === e), e => e.name);
          case M.KFR.APPLICATION_COMMAND:
            ...
            return eS(e, M.zUn.NAME, e => x.Z.applicationCommands.find(t => t.id === e), e => {
          ...
          case M.KFR.AUTO_MODERATION_RULE:
            return eS(e, M.zUn.NAME, e => x.Z.automodRules.find(t => t.id === e), e => e.name);
          case M.KFR.GUILD_SOUNDBOARD:
            return eS(e, M.zUn.NAME, M.VqG);
          case M.KFR.HOME_SETTINGS:
            return eS(e, M.zUn.GUILD_ID, e => g.Z.getSettings(e), () => P.intl.string(P.t.VbpLyc), t.id);
          case M.KFR.VOICE_CHANNEL_STATUS:
            return eS(e, M.zUn.STATUS, e => N.Z.getChannel(e), e => (0, _.F6)(e, S.default, R.Z, !0));
          default:
    ...
    if (null != r || [M.rsA.MEMBER_PRUNE, M.rsA.MEMBER_DISCONNECT, M.rsA.MEMBER_MOVE, M.rsA.CREATOR_MONETIZATION_REQUEST_CREATED, M.rsA.CREATOR_MONETIZATION_TERMS_ACCEPTED].includes(e.action)) {
      if (null != (e = (e = (e = e.set("user", i)).set("target", r)).set("options", function(e) {
          if (null != e.options) {
            ...
            if (null != e.options.channel_id && (n.channel = eS(e, "", e => N.Z.getChannel(e), e => e, e.options.channel_id)), null != e.options.members_removed && 0 !== e.options.members_removed && (n.count = e.options.members_removed), null != e.options.event_exception_id) {
              var t;
            ...
            if (t.action === M.rsA.APPLICATION_COMMAND_PERMISSION_UPDATE) {
              ...
              switch (t.type) {
                ...
                case M.ecB.USER:
                  ...
                  break;
                case M.ecB.CHANNEL:
                  t.id === l()(n.id).subtract(1).toString() ? e.subtarget = P.intl.string(P.t.MSYhgo) : e.subtarget = eC(t.id, e => N.Z.getChannel(e), e => (0, _.F6)(e, S.default, R.Z, !0))
              }
              return e
            }
            switch (e.key) {
              ...
              case M.zUn.PUBLIC_UPDATES_CHANNEL_ID:
                return eR(e, e => N.Z.getChannel(e), e => (0, _.F6)(e, S.default, R.Z, !0));
              ...
              case M.zUn.AUTO_MODERATION_ACTIONS:
                if (t.targetType === M.KFR.AUTO_MODERATION_RULE) return eR(e, e => e.map(e => e.type), e => e.map(T.ZF).join(", "));
                break;
              ...
              case M.zUn.AUTO_MODERATION_TRIGGER_METADATA:
                if (t.targetType === M.KFR.AUTO_MODERATION_RULE) return eR(e, e => null != e && "object" == typeof e ? null != e.keyword_filter && Array.isArray(e.keyword_filter) ? P.intl.formatToMarkdownString(P.t.y91UXV, {
              ...
              case M.zUn.AUTO_MODERATION_EXEMPT_CHANNELS:
                if (t.targetType === M.KFR.AUTO_MODERATION_RULE) return eR(e, e => e.map(N.Z.getChannel).filter(e => null != e).map(e => (0, _.F6)(e, S.default, R.Z, !0)), e => null != e && e.length > 0 ? e.join(", ") : P.intl.string(P.t["K/EdV1"]));
                break;
              case M.zUn.AUTO_MODERATION_EXEMPT_ROLES:
                if (t.targetType === M.KFR.AUTO_MODERATION_RULE) return eR(e, e => e.map(e => p.Z.getRole(n.id, e)).filter(e => null != e).map(e => e.name), e => null != e && e.length > 0 ? e.join(", ") : P.intl.string(P.t["K/EdV1"]));
                break;
              case M.zUn.AVAILABLE_TAGS:
                return function(e) {
                  ...
                  if (r.forEach(e => {
                    ...
                    for (let e in s)
                      if (null == i[e]) return new O.ms(M.zUn.AVAILABLE_TAG_ADD, null, ep(s[e]))
                  }
                  if (r.length > l.length) {
                    for (let e in i)
                      if (null == s[e]) return new O.ms(M.zUn.AVAILABLE_TAG_DELETE, null, ep(i[e]))
                  }
                  for (let e in i) {
                    let t = i[e],
                      n = s[e];
