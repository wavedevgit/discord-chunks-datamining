...
let w = new A.Z("AuditLogUtils"),
  ...
  J = () => y({
    [b.zUn.NAME]: eD(j.t.ahU1o6, j.t["wxs+vb"])
  }, B()),
  X = () => y({
    ...
    let r = function(e, t) {
        switch (e.targetType) {
          ...
          case b.KFR.CHANNEL_OVERWRITE:
            return eh(e, b.zUn.NAME, e => R.Z.getChannel(e), e => (0, _.F6)(e, h.default, C.Z, !0));
          case b.KFR.USER:
            return eh(e, b.zUn.NICK, e => h.default.getUser(e), e => e);
          case b.KFR.ROLE:
            return eh(e, b.zUn.NAME, e => S.Z.getRole(t.id, e), e => e.name);
          case b.KFR.ONBOARDING_PROMPT:
            let n = eh(e, b.zUn.ID, e => g.Z.getOnboardingPrompt(e), e => e.title);
          ...
          case b.KFR.INTEGRATION:
            return eh(e, b.zUn.TYPE, e => v.Z.integrations.find(t => t.id === e), e => e.name);
          case b.KFR.WEBHOOK:
            return eh(e, b.zUn.NAME, e => v.Z.webhooks.find(t => t.id === e), e => e.name);
          case b.KFR.EMOJI:
            return eh(e, b.zUn.NAME, e => T.ZP.getGuildEmoji(t.id).find(t => t.id === e), e => e.name);
          case b.KFR.STICKER:
            return eh(e, b.zUn.NAME, e => O.Z.getStickerById(e), e => e.name);
          case b.KFR.STAGE_INSTANCE:
            return eh(e, b.zUn.TOPIC, e => {
              var n;
          ...
          case b.KFR.GUILD_SCHEDULED_EVENT_EXCEPTION:
            return eh(e, b.zUn.NAME, e => v.Z.guildScheduledEvents.find(t => t.id === e), e => e.name);
          case b.KFR.THREAD:
            return eh(e, b.zUn.NAME, e => v.Z.threads.find(t => t.id === e), e => e.name);
          case b.KFR.APPLICATION_COMMAND:
            ...
            return eh(e, b.zUn.NAME, e => v.Z.applicationCommands.find(t => t.id === e), e => {
          ...
          case b.KFR.AUTO_MODERATION_RULE:
            return eh(e, b.zUn.NAME, e => v.Z.automodRules.find(t => t.id === e), e => e.name);
          case b.KFR.GUILD_SOUNDBOARD:
            return eh(e, b.zUn.NAME, b.VqG);
          case b.KFR.HOME_SETTINGS:
            return eh(e, b.zUn.GUILD_ID, e => m.Z.getSettings(e), () => j.intl.string(j.t.VbpLyc), t.id);
          case b.KFR.VOICE_CHANNEL_STATUS:
            return eh(e, b.zUn.STATUS, e => R.Z.getChannel(e), e => (0, _.F6)(e, h.default, C.Z, !0));
          default:
      ...
      if (null != (e = (e = (e = e.set("user", i)).set("target", r)).set("options", function(e) {
          if (null != e.options) {
            ...
            switch (e.options.type) {
              case b.jwA.USER:
                n.subtarget = ep(e.options.id, e => h.default.getUser(e), e => e.tag);
                break;
              case b.jwA.ROLE:
                n.subtarget = ep(e.options.role_name, b.VqG)
            }
            if (null != e.options.channel_id && (n.channel = eh(e, "", e => R.Z.getChannel(e), e => e, e.options.channel_id)), null != e.options.members_removed && 0 !== e.options.members_removed && (n.count = e.options.members_removed), null != e.options.event_exception_id) {
              var t;
        ...
        e.changes.forEach(r => {
          let i = function(e, t, n) {
            if (t.action === b.rsA.APPLICATION_COMMAND_PERMISSION_UPDATE) {
              ...
              switch (t.type) {
                case b.ecB.ROLE:
                  e.subtarget = ep(t.id, e => S.Z.getRole(n.id, e), e => e.name);
                  break;
                case b.ecB.USER:
                  e.subtarget = ep(t.id, e => h.default.getUser(e), e => e.tag);
                  break;
                case b.ecB.CHANNEL:
                  t.id === l()(n.id).subtract(1).toString() ? e.subtarget = j.intl.string(j.t.MSYhgo) : e.subtarget = ep(t.id, e => R.Z.getChannel(e), e => (0, _.F6)(e, h.default, C.Z, !0))
              }
              return e
            }
            switch (e.key) {
              ...
              case b.zUn.PUBLIC_UPDATES_CHANNEL_ID:
                return eC(e, e => R.Z.getChannel(e), e => (0, _.F6)(e, h.default, C.Z, !0));
              ...
              case b.zUn.AUTO_MODERATION_ACTIONS:
                if (t.targetType === b.KFR.AUTO_MODERATION_RULE) return eC(e, e => e.map(e => e.type), e => e.map(I.ZF).join(", "));
                break;
              ...
              case b.zUn.AUTO_MODERATION_TRIGGER_METADATA:
                if (t.targetType === b.KFR.AUTO_MODERATION_RULE) return eC(e, e => null != e && "object" == typeof e ? null != e.keyword_filter && Array.isArray(e.keyword_filter) ? j.intl.formatToMarkdownString(j.t.y91UXV, {
              ...
              case b.zUn.AUTO_MODERATION_EXEMPT_CHANNELS:
                if (t.targetType === b.KFR.AUTO_MODERATION_RULE) return eC(e, e => e.map(R.Z.getChannel).filter(e => null != e).map(e => (0, _.F6)(e, h.default, C.Z, !0)), e => null != e && e.length > 0 ? e.join(", ") : j.intl.string(j.t["K/EdV1"]));
                break;
              case b.zUn.AUTO_MODERATION_EXEMPT_ROLES:
                if (t.targetType === b.KFR.AUTO_MODERATION_RULE) return eC(e, e => e.map(e => S.Z.getRole(n.id, e)).filter(e => null != e).map(e => e.name), e => null != e && e.length > 0 ? e.join(", ") : j.intl.string(j.t["K/EdV1"]));
                break;
              case b.zUn.AVAILABLE_TAGS:
                return function(e) {
                  ...
                  if (r.forEach(e => {
                    ...
                    for (let e in s)
                      if (null == i[e]) return new f.ms(b.zUn.AVAILABLE_TAG_ADD, null, eS(s[e]))
                  }
                  if (r.length > l.length) {
                    for (let e in i)
                      if (null == s[e]) return new f.ms(b.zUn.AVAILABLE_TAG_DELETE, null, eS(i[e]))
                  }
                  for (let e in i) {
                    let t = i[e],
                      n = s[e];
