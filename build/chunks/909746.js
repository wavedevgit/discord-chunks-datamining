...
let G = new A.Z("AuditLogUtils"),
  ...
  J = () => y({
    [M.zUn.NAME]: eb(j.t.ahU1o6, j.t["wxs+vb"])
  }, F()),
  X = () => y({
    ...
    let r = function(e, t) {
        switch (e.targetType) {
          ...
          case M.KFR.HOME_SETTINGS:
            return eS(e, M.zUn.GUILD_ID, e => g.Z.getSettings(e), () => j.intl.string(j.t.VbpLyc), t.id);
            ...
            if (t.action === M.rsA.APPLICATION_COMMAND_PERMISSION_UPDATE) {
              ...
              switch (t.type) {
                ...
                case M.ecB.USER:
                  ...
                  break;
                case M.ecB.CHANNEL:
                  t.id === l()(n.id).subtract(1).toString() ? e.subtarget = j.intl.string(j.t.MSYhgo) : e.subtarget = eC(t.id, e => N.Z.getChannel(e), e => (0, _.F6)(e, S.default, R.Z, !0))
              }
              return e
            }
            switch (e.key) {
              ...
              case M.zUn.AUTO_MODERATION_EXEMPT_CHANNELS:
                if (t.targetType === M.KFR.AUTO_MODERATION_RULE) return eR(e, e => e.map(N.Z.getChannel).filter(e => null != e).map(e => (0, _.F6)(e, S.default, R.Z, !0)), e => null != e && e.length > 0 ? e.join(", ") : j.intl.string(j.t["K/EdV1"]));
                break;
              case M.zUn.AUTO_MODERATION_EXEMPT_ROLES:
                if (t.targetType === M.KFR.AUTO_MODERATION_RULE) return eR(e, e => e.map(e => p.Z.getRole(n.id, e)).filter(e => null != e).map(e => e.name), e => null != e && e.length > 0 ? e.join(", ") : j.intl.string(j.t["K/EdV1"]));
                break;
