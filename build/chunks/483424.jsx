...
function p(e) {
  ...
  return I || null == b ? I || null == y ? T && !I && null != O ? <f.Z user={t} currentUser={n} voiceChannel={O} className={m} onClose={g} /> : null : <u.Z user={t} currentUser={n} activity={y} profileGuildId={null == p ? true : p.guildId} className={m} onClose={g} /> : <d.Z location={"UserProfileFeaturedActivity"} user={t} currentUser={n} stream={b} profileGuildId={null == p ? true : p.guildId} className={m} onClose={g} />
}