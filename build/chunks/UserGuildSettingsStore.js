...
function J(e) {
  null != e.userGuildSettings && 0 !== e.userGuildSettings.length && (T = {}, x = {}, M = {}, e.userGuildSettings.forEach(e => {
    let t = e.guild_id;
    T[t] = e;
    let n = new Set,
      r = new Set;
...
function $(e) {
  en(e.notificationSettings), P.reset(), w.reset(), e.userGuildSettings.partial || (T = {}, x = {}, M = {});
  let t = new Set;
...
function ee(e) {
  ...
  T = v({}, n), x = {}, M = {}, _.default.keys(r).forEach(e => {
    x[e] = new Set(r[e])
