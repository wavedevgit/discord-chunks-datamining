...
function $(e) {
  null != e.userGuildSettings && 0 !== e.userGuildSettings.length && (A = {}, j = {}, k = {}, e.userGuildSettings.forEach(e => {
    let t = e.guild_id;
    A[t] = e;
    let n = new Set,
      r = new Set;
...
function ee(e) {
  er(e.notificationSettings), w.reset(), D.reset(), e.userGuildSettings.partial || (A = {}, j = {}, k = {});
  let t = new Set;
...
function et(e) {
  ...
  A = I({}, n), j = {}, k = {}, p.default.keys(r).forEach(e => {
    j[e] = new Set(r[e])
...
function eu(e) {
  ...
  return !(null == t || c.Z.isFullServerPreview(t)) && (K(t, n), true)
}
...
function ep() {
  return N && Chunk312400.xT.getCurrentConfig({
    location: "UserGuildSettingsStore"
  }, {
    autoTrackExposure: false
  }).enabled
}
class eh extends(r = Chunk442837.ZP.PersistedStore) {
  initialize(e) {
    if (this.waitFor(g.default, m.Z, c.Z, d.Z), null != e) {
      var t, n;
      N = null != (t = e.useNewNotifications) && t, "userGuildSettings" in e && (A = e.userGuildSettings, k = o().mapValues(null != (n = e.optedInChannelsByGuild) ? n : {}, e => new Set(e)), o().forEach(A, (e, t) => {
        j[t] = ef(e)
      }))
    }
  }
  ...
  isGuildCollapsed(e) {
    var t;
    return (null == (t = A[e]) ? true : t.hide_muted_channels) === true
  }
  getAllSettings() {
    return {
      userGuildSettings: A,
  ...
  getNewForumThreadsCreated(e) {
    ...
    if (null != t && null != t.flags) {
      if (_.yE(t.flags, O.ic.NEW_FORUM_THREADS_ON)) returntrue;
      if (_.yE(t.flags, O.ic.NEW_FORUM_THREADS_OFF)) returnfalse
    }
  ...
  getGuildFavorites(e) {
    ...
    if (null == C[e]) {
      let t = o().filter(this.getChannelOverrides(e), t => {
        var n, r;
        return _.yE(null != (r = t.flags) ? r : 0, O.ic.FAVORITED) && (null == (n = h.Z.getChannel(t.channel_id)) ? true : n.guild_id) === e
      });
