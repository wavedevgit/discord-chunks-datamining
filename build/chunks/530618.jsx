...
let h = function(e) {
  let {
    ...
    sprites: l,
    colors: c
  } = e, [u, h] = i.useState(null), m = (0, o.uR)(n, u), [g, E] = i.useState(false);
  return i.useEffect(() => {
  ...
  }, [m, t, g, s]), <o.Ji ref={h} sprites={null != l ? l : a.CA} colors={null != c ? c : a.Br} spriteWidth={a.Ko} spriteHeight={a.Ko} />
}