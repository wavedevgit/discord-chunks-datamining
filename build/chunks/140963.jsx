...
class v extends Chunk73800.PureComponent {
  ...
  render() {
    ...
    return <Chunk255367.Fragment>{<Chunk459273.d9 event={Chunk981631.CkL.GLOBAL_CLIPBOARD_PASTE} handler={this.handleGlobalPaste} />}{<Chunk481060.lcI ref={this.handleSetRef} className={a()(Chunk239091, Chunk358085)} id={Chunk555573} rows={1} fontWidthEstimate={6} placeholder={require} disabled={exports || Chunk998698} required={Chunk73800} onChange={this.handleOnChange} onResize={Chunk120356} onKeyPress={this.handleKeyPress} onKeyDown={this.handleKeyDown} onKeyUp={this.handleKeyUp} onFocus={this.props.onFocus} onBlur={this.props.onBlur} onPaste={this.handlePaste} onClick={this.handleClick} onContextMenu={this.handleContextMenu} value={exports ? "" : module} tabIndex={0} spellCheck={Chunk62883} aria-controls={Chunk752305} aria-expanded={m} aria-activedescendant={g} aria-haspopup={"listbox"} aria-autocomplete={"list"} aria-multiline={true} />}</Chunk255367.Fragment>
  }
