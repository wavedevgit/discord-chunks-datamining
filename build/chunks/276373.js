...
require.d(exports, {
  ...
  yy: () => eN,
  z3: () => ea
}), require("./65821.js"), require("./321073.js"), require("./457529.js");
var Chunk824120 = require("./824120.js"),
  r = require.n(Chunk824120),
  Chunk989349 = require("./989349.js"),
  i = require.n(Chunk989349),
  Chunk794174 = require("./794174.js"),
...
let k = new Chunk626584.A("AuditLogUtils"),
  F = [Chunk499979.pJ.DAYS, Chunk499979.pJ.HOURS, Chunk499979.pJ.MINUTES, Chunk499979.pJ.SECONDS],
  w = () => ({
  ...
  er = () => y({
    ...
    [C.gGk.AUTO_MODERATION_ENABLED]: e => {
      var t;
      returntrue === (null != (t = e.newValue) ? t : e.oldValue) ? U.t.fCmxC2 : U.t.Wrg9Jn
    },
  ...
  ei = () => y({
    [C.gGk.VERIFICATION_ENABLED]: e => true === e.newValue ? U.t.fnkzDY : U.t.WYT6ka,
    [C.gGk.MANUAL_APPROVAL_ENABLED]: e => true === e.newValue ? U.t.jzSvVd : U.t.WxyOtj
  }, w()),
  es = () => y({
  ...
  ec = {
    [Chunk652215.GaG.CHANNEL]: {
      [Chunk652215.gGk.ID]: true,
      [Chunk652215.gGk.PERMISSION_OVERWRITES]: true
    },
    [Chunk652215.GaG.CHANNEL_OVERWRITE]: {
      [Chunk652215.gGk.TYPE]: true,
      [Chunk652215.gGk.ID]: true,
      [Chunk652215.gGk.PERMISSION_OVERWRITES]: true
    },
    [Chunk652215.GaG.INVITE]: {
      [Chunk652215.gGk.INVITER_ID]: true,
      [Chunk652215.gGk.USES]: true
    },
    [Chunk652215.GaG.WEBHOOK]: {
      [Chunk652215.gGk.TYPE]: true,
      [Chunk652215.gGk.APPLICATION_ID]: true
    },
    [Chunk652215.GaG.INTEGRATION]: {
      [Chunk652215.gGk.TYPE]: true
    },
    [Chunk652215.GaG.THREAD]: {
      [Chunk652215.gGk.ID]: true,
      [Chunk652215.gGk.TYPE]: true
    },
    [Chunk652215.GaG.STICKER]: {
      [Chunk652215.gGk.ID]: true,
      [Chunk652215.gGk.TYPE]: true,
      [Chunk652215.gGk.ASSET]: true,
      [Chunk652215.gGk.FORMAT_TYPE]: true,
      [Chunk652215.gGk.AVAILABLE]: true,
      [Chunk652215.gGk.GUILD_ID]: true
    },
    [Chunk652215.GaG.GUILD_HOME]: {
      [Chunk652215.gGk.ENTITY_TYPE]: true
    },
    [Chunk652215.GaG.GUILD_ONBOARDING]: {
      [Chunk652215.gGk.PROMPTS]: true
    },
    [Chunk652215.GaG.GUILD_SOUNDBOARD]: {
      [Chunk652215.gGk.ID]: true,
      [Chunk652215.gGk.SOUND_ID]: true
    }
  },
  eu = () => [{
    value: C.F_X.ALL,
...
function e_(e) {
  ...
  return null != eE(C.gGk.COMMUNICATION_DISABLED_UNTIL, e) ? U.intl.string(U.t.z3wbj8) : null != (t = null == n ? true : n.label) ? t : null
}
let eg = {
  [Chunk499979.pJ.SECONDS]: e => U.intl.formatToPlainString(U.t.geSp4K, {
    seconds: e
  }),
  [Chunk499979.pJ.MINUTES]: e => U.intl.formatToPlainString(U.t.iXLF9W, {
    minutes: e
  }),
  [Chunk499979.pJ.HOURS]: e => U.intl.formatToPlainString(U.t.xCjYxK, {
    hours: e
  }),
  [Chunk499979.pJ.DAYS]: e => U.intl.formatToPlainString(U.t["k2UNz+"], {
    days: e
  })
};
...
function eA(e) {
  ...
  if (null != t) {
    ...
    } else if ((null == t ? true : t.oldValue) != null) return U.intl.string(U.t.MA1ltr)
...
function ef(e) {
  switch (e.action) {
    ...
    case C.F_X.AUTO_MODERATION_FLAG_TO_CHANNEL:
      var l;
      if ((null == (l = e.options) ? true : l.auto_moderation_rule_trigger_type) === v.uh.USER_PROFILE.toString()) return U.t.YQsjej;
      return U.t.SD0PwJ;
...
function eO(e, t) {
  switch (e) {
    ...
    case C.xBc.MANAGE_CHANNELS:
      if (t.targetType === C.GaG.CHANNEL || t.targetType === C.GaG.CHANNEL_OVERWRITE) return U.intl.string(U.t.nAw15L);
    ...
    case C.xBc.VIEW_CHANNEL:
      if (t.targetType === C.GaG.CHANNEL || t.targetType === C.GaG.CHANNEL_OVERWRITE) return U.intl.string(U.t["W/A4Qp"]);
    ...
    let l = function(e, t) {
        switch (e.targetType) {
          ...
          case C.GaG.CHANNEL_OVERWRITE:
            return eb(e, C.gGk.NAME, e => S.A.getChannel(e), e => (0, g.m1)(e, G.default, b.A, true));
          case C.GaG.USER:
            return eb(e, C.gGk.NICK, e => G.default.getUser(e), e => e);
          case C.GaG.ROLE:
            return eb(e, C.gGk.NAME, e => p.A.getRole(t.id, e), e => e.name);
          case C.GaG.ONBOARDING_PROMPT:
            let n = eb(e, C.gGk.ID, e => h.A.getOnboardingPrompt(e), e => e.title);
          ...
          case C.GaG.INTEGRATION:
            return eb(e, C.gGk.TYPE, e => x.A.integrations.find(t => t.id === e), e => e.name);
          case C.GaG.WEBHOOK:
            return eb(e, C.gGk.NAME, e => x.A.webhooks.find(t => t.id === e), e => e.name);
          case C.GaG.EMOJI:
            return eb(e, C.gGk.NAME, e => T.Ay.getGuildEmoji(t.id).find(t => t.id === e), e => e.name);
          case C.GaG.STICKER:
            return eb(e, C.gGk.NAME, e => N.A.getStickerById(e), e => e.name);
          case C.GaG.STAGE_INSTANCE:
            return eb(e, C.gGk.TOPIC, e => {
              var n;
              return null == (n = Object.values(O.A.getStageInstancesByGuild(t.id))) ? true : n.find(t => t.id === e)
            }, e => e.topic);
          case C.GaG.GUILD_SCHEDULED_EVENT:
          case C.GaG.GUILD_SCHEDULED_EVENT_EXCEPTION:
            return eb(e, C.gGk.NAME, e => x.A.guildScheduledEvents.find(t => t.id === e), e => e.name);
          case C.GaG.THREAD:
            return eb(e, C.gGk.NAME, e => x.A.threads.find(t => t.id === e), e => e.name);
          case C.GaG.APPLICATION_COMMAND:
            ...
            return eb(e, C.gGk.NAME, e => x.A.applicationCommands.find(t => t.id === e), e => {
          ...
          case C.GaG.AUTO_MODERATION_RULE:
            return eb(e, C.gGk.NAME, e => x.A.automodRules.find(t => t.id === e), e => e.name);
          case C.GaG.GUILD_SOUNDBOARD:
            return eb(e, C.gGk.NAME, C.FXj);
          case C.GaG.HOME_SETTINGS:
            return eb(e, C.gGk.GUILD_ID, e => I.h.getSettings(e), () => U.intl.string(U.t.VbpLyU), t.id);
          case C.GaG.VOICE_CHANNEL_STATUS:
            return eb(e, C.gGk.STATUS, e => S.A.getChannel(e), e => (0, g.m1)(e, G.default, b.A, true));
          default:
            return k.warn("Unknown targetType for log", e), null
        }
      }(e, t),
      a = G.default.getUser(e.userId);
    if (null != l || [C.F_X.MEMBER_PRUNE, C.F_X.MEMBER_DISCONNECT, C.F_X.MEMBER_MOVE, C.F_X.CREATOR_MONETIZATION_REQUEST_CREATED, C.F_X.CREATOR_MONETIZATION_TERMS_ACCEPTED].includes(e.action)) {
      if (null != (e = (e = (e = e.set("user", a)).set("target", l)).set("options", function(e) {
          if (null != e.options) {
            let n = y({}, e.options);
            switch (e.options.type) {
              case C.AO_.USER:
                n.subtarget = eG(e.options.id, e => G.default.getUser(e), e => e.tag);
                break;
              case C.AO_.ROLE:
                n.subtarget = eG(e.options.role_name, C.FXj)
            }
            if (null != e.options.channel_id && (n.channel = eb(e, "", e => S.A.getChannel(e), e => e, e.options.channel_id)), null != e.options.members_removed && 0 !== e.options.members_removed && (n.count = e.options.members_removed), null != e.options.event_exception_id) {
              var t;
              let l = x.A.guildScheduledEvents.find(t => t.id === e.targetId),
                r = null == l ? true : l.guild_scheduled_event_exceptions.find(t => t.event_exception_id === e.options.event_exception_id);
              n.subtarget = (0, R.i$)(i()(L.default.extractTimestamp(null != (t = null == r ? true : r.event_exception_id) ? t : "0")), "LL")
            }
            return n
          }
          return e.options
        ...
        e.changes.forEach(l => {
          let a = function(e, t, n) {
            if (t.action === C.F_X.APPLICATION_COMMAND_PERMISSION_UPDATE) {
              ...
              switch (t.type) {
                case C.g0g.ROLE:
                  e.subtarget = eG(t.id, e => p.A.getRole(n.id, e), e => e.name);
                  break;
                case C.g0g.USER:
                  e.subtarget = eG(t.id, e => G.default.getUser(e), e => e.tag);
                  break;
                case C.g0g.CHANNEL:
                  t.id === r()(n.id).subtract(1).toString() ? e.subtarget = U.intl.string(U.t.MSYhgh) : e.subtarget = eG(t.id, e => S.A.getChannel(e), e => (0, g.m1)(e, G.default, b.A, true))
              }
              return e
            }
            switch (e.key) {
              ...
              case C.gGk.PUBLIC_UPDATES_CHANNEL_ID:
                return ep(e, e => S.A.getChannel(e), e => (0, g.m1)(e, G.default, b.A, true));
              ...
              case C.gGk.THEME_COLORS:
                return ep(e, e => "".concat((0, u.Hl)(e[0]).toUpperCase(), ", ").concat((0, u.Hl)(e[1]).toUpperCase()));
              case C.gGk.MAX_AGE:
                return ep(e, e => {
              ...
              case C.gGk.VIDEO_QUALITY_MODE:
                return ep(e, e => e === C.K3c.FULL ? U.intl.string(U.t["7jOoJE"]) : U.intl.string(U.t.jjKYpu));
              case C.gGk.SYSTEM_CHANNEL_FLAGS:
                let l, a;
                return l = {
                  [C.ogj.SUPPRESS_JOIN_NOTIFICATIONS]: C.gGk.SYSTEM_CHANNEL_FLAG_JOIN_NOTIFICATIONS,
                  [C.ogj.SUPPRESS_PREMIUM_SUBSCRIPTIONS]: C.gGk.SYSTEM_CHANNEL_FLAG_PREMIUM_SUBSCRIPTIONS,
                  [C.ogj.SUPPRESS_GUILD_REMINDER_NOTIFICATIONS]: C.gGk.SYSTEM_CHANNEL_FLAG_REMINDER_NOTIFICATIONS,
                  [C.ogj.SUPPRESS_JOIN_NOTIFICATION_REPLIES]: C.gGk.SYSTEM_CHANNEL_FLAG_JOIN_NOTIFICATION_REPLIES
                }, a = [], Object.values(C.ogj).forEach(t => {
              ...
              case C.gGk.AUTO_MODERATION_ACTIONS:
                if (t.targetType === C.GaG.AUTO_MODERATION_RULE) return ep(e, e => e.map(e => e.type), e => e.map(f.PZ).join(", "));
                break;
              ...
              case C.gGk.AUTO_MODERATION_TRIGGER_METADATA:
                if (t.targetType === C.GaG.AUTO_MODERATION_RULE) return ep(e, e => null != e && "object" == typeof e ? null != e.keyword_filter && Array.isArray(e.keyword_filter) ? U.intl.formatToMarkdownString(U.t.y91UXV, {
              ...
              case C.gGk.AUTO_MODERATION_REMOVE_ALLOW_LIST:
                if (t.targetType === C.GaG.AUTO_MODERATION_RULE) return ep(e, e => null != e && Array.isArray(e) ? e.map(e => "'".concat(e, "'")).join(", ") : JSON.stringify(e));
                break;
              case C.gGk.AUTO_MODERATION_EXEMPT_CHANNELS:
                if (t.targetType === C.GaG.AUTO_MODERATION_RULE) return ep(e, e => e.map(S.A.getChannel).filter(e => null != e).map(e => (0, g.m1)(e, G.default, b.A, true)), e => null != e && e.length > 0 ? e.join(", ") : U.intl.string(U.t["K/EdV8"]));
                break;
              case C.gGk.AUTO_MODERATION_EXEMPT_ROLES:
                if (t.targetType === C.GaG.AUTO_MODERATION_RULE) return ep(e, e => e.map(e => p.A.getRole(n.id, e)).filter(e => null != e).map(e => e.name), e => null != e && e.length > 0 ? e.join(", ") : U.intl.string(U.t["K/EdV8"]));
                break;
              case C.gGk.AVAILABLE_TAGS:
                return function(e) {
                  ...
                  if (l.forEach(e => {
                    ...
                    for (let e in i)
                      if (null == a[e]) return new m.QO(C.gGk.AVAILABLE_TAG_ADD, null, eS(i[e]))
                  }
                  if (l.length > r.length) {
                    for (let e in a)
                      if (null == i[e]) return new m.QO(C.gGk.AVAILABLE_TAG_DELETE, null, eS(a[e]))
                  }
                  for (let e in a) {
                    let t = a[e],
                      n = i[e];
                    if ((null == n ? true : n.name) !== t.name || (null == n ? true : n.emoji_id) !== t.emoji_id || (null == n ? true : n.emoji_name) !== t.emoji_name) return new m.QO(C.gGk.AVAILABLE_TAG_EDIT, eS(t), eS(n))
                  }
                  return e
                }(e);
...
function ep(e, t, n) {
  let l = e.newValue,
    r = e.oldValue;
  return null != e.newValue && (l = t(e.newValue), null != n && null != l && (l = n(l))), null != e.oldValue && (r = t(e.oldValue), null != n && null != r && (r = n(r))), new m.QO(e.key, r || e.oldValue, l || e.newValue)
}
