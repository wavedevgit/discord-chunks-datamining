/** Chunk was on web.js **/
/** chunk id: 796873, original params: e,t (module,exports,re quire) **/
(function() {
  var n = this,
    r = n.humanize,
    i = {};
  ...
  i.date = function(e, t) {
    ...
    return (t = true === t ? 1024 : t, e <= 0) ? "0 bytes" : (e < t && true === n && (n = 0), true === s && (s = " "), i.intword(e, ["bytes", "KB", "MB", "GB", "TB", "PB"], t, n, r, a, s))
