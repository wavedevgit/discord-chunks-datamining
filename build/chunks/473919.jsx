...
function _(e) {
  ...
  return null == n ? <t size={"custom"} color={_} className={o()(l.icon, c)} /> : <a.ua7 text={n} aria-label={i} tooltipContentClassName={l.container} delay={s.X} onTooltipShow={d}>{e => (0, r.jsx)(t, f(u({}, e), {
      size: "custom",
      color: _,
