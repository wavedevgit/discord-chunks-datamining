...
function _(t) {
  let {
    ...
    hasFooter: e = !0,
    onClose: _,
    onChannelPromptCompleted: g,
    isSlideReady: x
  } = t, [T, E] = l.useState(""), [h, I] = l.useState(null), [G, D] = l.useState(!1), y = (0, o.Dt)(), U = (0, s.e7)([p.Z], () => p.Z.getGuild(n), [n]), z = l.useRef(null);
  l.useEffect(() => {
    var t;
  ...
  let N = l.useCallback(async t => {
      ...
      try {
        let t = u.intl.formatToPlainString(u.t.V4lepK, {
          topic: T
        });
  ...
  return {
    content: (0, i.jsxs)(i.Fragment, {
      children: [(0, i.jsxs)(a.xBx, {
        ...
        }), null != h && 0 === Object.keys(h.fields).length && (0, i.jsx)(a.Text, {
