...
function E(e) {
  let t, {
    ...
    P = <r.Fragment>{(0, o._0)(E, b, y, n, false)}</r.Fragment>;
  return R ? t = g.intl.string(m.default.u4QmWl) : null != N ? t = g.intl.string(m.default.P0wwmJ) : C !== y.id ? t = g.intl.string(m.default.qRXatr) : null == A && (t = g.intl.string(m.default["43zohI"])), <a.W header={g.intl.string(m.default.DKHheX)} title={b.name} staticBannerSrc={v} videoBannerSrc={I} bannerAspectRatio={T} iconSrc={null != S ? S : true} info={P} actions={E.author.id === n ? [] : [{
