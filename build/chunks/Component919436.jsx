...
class R extends(r = Chunk647438.PureComponent) {
  ...
  render() {
    ...
    return (0, Chunk951288.jsx)(Chunk202841.animated.div, {
  ...
  constructor(...e) {
    super(...e), N(this, "state", {
      ...
      let {
        channel: t
      } = this.props, r = t.type === E.d4z.DM ? _.default.getUser(t.getRecipientId()) : null;
...
let D = Chunk647438.forwardRef(function(e, t) {
  let n = e.channel.id,
    ...
    x = false,
    C = false;
  j && (x = u === E.WtW.VOICE, C = u === E.WtW.VIDEO);
