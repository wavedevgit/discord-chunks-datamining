...
function I(n, e) {
  let [t, i] = (0, u.Wu)([Z.Z], () => [null != e ? Z.Z.getParticipants(e) : null, null != e ? Z.Z.getParticipant(e, n.id) : null], [e, n.id]), s = (0, u.e7)([h.Z], () => h.Z.getChannel(e)), N = (0, b.s)(n, "context_menu", e), {
    enabled: I
  } = v.Z.useExperiment({
    guildId: null == s ? void 0 : s.guild_id,
    location: "useRingHangupItem"
  }), C = !N || (null == t ? void 0 : t.length) === 0 || null == e, E = I && (null == s ? void 0 : s.guild_id) != null, W = null == i, T = null != i && i.type === x.fO.USER && i.ringing, U = [];
  E && !C && (W || T) && U.push(o.z.RING_USER_TO_VC_NEW_BADGE);
  let [k, A] = (0, p.US)(U), S = k === o.z.RING_USER_TO_VC_NEW_BADGE, {
  ...
  return ((0, f.Z)({
    ...
    subtext: E ? (0, l.jsx)(c.Text, {
      ...
      children: O.NW.format(O.t.dwfzZm, {
