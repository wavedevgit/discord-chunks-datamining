...
function I(n, e) {
  let [t, i] = (0, u.Wu)([Z.Z], () => [null != e ? Z.Z.getParticipants(e) : null, null != e ? Z.Z.getParticipant(e, n.id) : null], [e, n.id]), s = (0, u.e7)([x.Z], () => x.Z.getChannel(e)), p = (0, b.s)(n, "context_menu", e), {
    enabled: I
  } = h.Z.useExperiment({
    guildId: null == s ? void 0 : s.guild_id,
    location: "useRingHangupItem"
  }), C = !p || (null == t ? void 0 : t.length) === 0 || null == e, E = I && (null == s ? void 0 : s.guild_id) != null, T = null == i, U = null != i && i.type === _.fO.USER && i.ringing, k = [];
  E && !C && (T || U) && k.push(o.z.RING_USER_TO_VC_NEW_BADGE);
  let [A, S] = (0, m.US)(k), w = A === o.z.RING_USER_TO_VC_NEW_BADGE, {
  ...
  return ((0, f.Z)({
    ...
    subtext: E ? (0, l.jsx)(c.Text, {
      variant: "text-xs/medium",
      className: r()(j.subtext, j.ringing),
      children: N.intl.format(N.t.dwfzZm, {
        channelName: (0, l.jsx)(y, {
          channel: s
        })
      })
    }) : null,
