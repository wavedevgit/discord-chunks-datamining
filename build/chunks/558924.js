...
function y(e, t) {
  ...
  }), I = !N || (null == n ? void 0 : n.length) === 0 || null == t, W = y && (null == o ? void 0 : o.guild_id) != null, A = null == l, S = null != l && l.type === h.fO.USER && l.ringing, C = [];
  W && !I && (A || S) && C.push(u.z.RING_USER_TO_VC_NEW_BADGE);
  let [U, D] = (0, m.US)(C), L = U === u.z.RING_USER_TO_VC_NEW_BADGE, {
