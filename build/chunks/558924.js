...
function j(e, t) {
  let [n, i] = (0, o.Wu)([d.Z], () => [null != t ? d.Z.getParticipants(t) : null, null != t ? d.Z.getParticipant(t, e.id) : null], [t, e.id]), a = (0, o.e7)([m.Z], () => m.Z.getChannel(t)), f = (0, g.s)(e, "context_menu", t), {
    enabled: j
  } = N.Z.useExperiment({
    guildId: null == a ? void 0 : a.guild_id,
    location: "useRingHangupItem"
  }), _ = !f || (null == n ? void 0 : n.length) === 0 || null == t, P = j && (null == a ? void 0 : a.guild_id) != null, E = null == i, W = null != i && i.type === v.fO.USER && i.ringing, I = [];
  P && !_ && (E || W) && I.push(s.z.RING_USER_TO_VC_NEW_BADGE);
  let [A, S] = (0, b.US)(I), C = A === s.z.RING_USER_TO_VC_NEW_BADGE;
  return _ ? null : E ? (0, l.jsx)(u.sNh, {
    id: "ring",
