...
function m(e) {
  ...
  let k = l.useCallback(e => {
    ...
    B = l.useMemo(() => _.map(e => <b.ZP interactive={T} className={E.soundButton} sound={e} focused={A === e.soundId} channel={n} />), [A, n, T, _]);
  return 0 === _.length ? null : <a.Gt value={D}><y.Z wheelWidth={m} wheelHeight={C} itemWidth={96} itemHeight={52} showDeadZoneIndicator={!v} activeItem={A} onItemSelect={M} onItemAction={U} onClose={I} interactive={T}>{B}</y.Z></a.Gt>
}