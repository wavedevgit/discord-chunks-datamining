...
let H = u.EFr.SIZE_32,
  ...
  K = r.memo(e => {
    ...
    }, [t, l, ei, er, ee, o]), eu = r.useCallback(e => {
      (0, g.jW)(e, async () => {
        let {
          default: e
    ...
    }, [t, P]), ed = r.useCallback(() => (0, x.Z)(t), [t]), ep = r.useCallback(e => {
      e.preventDefault(), e.stopPropagation(), (0, h.i)(P, !0), p.Z.openPrivateChannel(t.id), null != f && f()
    }, [t.id, f, P]), eg = r.useCallback(e => {
      e.preventDefault(), e.stopPropagation(), N.Z.addRelationship({
        userId: t.id,
        context: {
          location: "friends-popout"
        }
      })
    }, [t.id]), ef = r.useCallback(e => (0, i.jsx)(A.Z, Y(z({}, e), {
      userId: t.id
    })), [t.id]), eN = async (e, n) => {
      if (e.preventDefault(), e.stopPropagation(), null != n.application_id && "" !== n.application_id && !K[n.application_id]) try {
        Q(e => Y(z({}, e), {
          [n.application_id]: !0
    ...
    }, ey = () => E || et === L.OGo.PENDING_INCOMING ? (0, i.jsxs)(i.Fragment, {
      children: [(0, i.jsx)(Z.sF, {
        label: W.NW.string(W.t.MMlhsr),
        icon: u.dz2,
        onClick: e => {
          e.preventDefault(), e.stopPropagation(), N.Z.addRelationship({
            userId: t.id,
        ...
        label: W.NW.string(W.t.ytCpKi),
        icon: u.Dio,
        onClick: e => {
          e.preventDefault(), e.stopPropagation(), N.Z.removeRelationship(t.id, {
            location: "friends-popout"
          })
        }
      })]
    }) : y ? et === L.OGo.PENDING_OUTGOING ? (0, i.jsx)(Z.sF, {
      label: W.NW.string(W.t["bTfA//"]),
      icon: u.iHX,
      onClick: e => {
        e.preventDefault(), e.stopPropagation(), N.Z.cancelFriendRequest(t.id, {
          location: "friends-popout"
        })
      }
    }) : (0, i.jsx)(Z.sF, {
      label: W.NW.string(W.t.w5uwoK),
      icon: u.oLu,
      onClick: eg
    }) : null, em = () => (0, i.jsxs)(i.Fragment, {
      children: [X.map(e => (0, i.jsx)(Z.sF, {
        label: K[e.application_id] ? W.NW.string(W.t["8BEiNj"]) : W.NW.string(W.t.OKsSCQ),
        icon: K[e.application_id] ? u.dz2 : u.V9,
        onClick: t => eh(t, e)
      }, e.application_id)), $.map(e => {
        var n;
        return (0, i.jsx)(Z.sF, {
    ...
    return (0, i.jsx)(u.yRy, {
      ...
      children: (e, n) => {
        ...
        return (0, i.jsxs)("div", {
          className: V.row,
          children: [(0, i.jsx)(j.Z, z({
            innerClassName: V.rowInner,
            onContextMenu: eu,
            onMouseEnter: es,
            onMouseLeave: ea,
            avatar: (0, i.jsx)(u.qEK, Y(z({}, R), {
              size: H,
              src: F,
              isMobile: el,
              isTyping: !1,
            ...
            children: [ey(), em(), !E && (0, i.jsx)(Z.sF, {
              label: W.NW.string(W.t["g33r/P"]),
              icon: u.kBi,
              onClick: ep
            }), (0, i.jsx)(Z.sF, {
              label: W.NW.string(W.t.UKOtz8),
              icon: u.xhG,
              onClick: eu
            })]
          })]
...
K.displayName = "FriendRow";
let Q = () => (0, c.e7)([U.Z, F.default, G.Z], () => {
    let e = U.Z.getRelationships(),
      t = [];
    for (let [n, i] of Object.entries(e)) {
      if (i !== L.OGo.PENDING_INCOMING) continue;
      let e = F.default.getUser(n);
      if (null != e) {
        let i = U.Z.getSince(n),
  ...
  X = () => (0, c.e7)([T.Z, F.default, G.Z, U.Z, R.Z], () => {
    let e = T.Z.getUserAffinitiesMap(),
      t = [];
    for (let [n, i] of e.entries()) {
      if (U.Z.isFriend(n) || i.affinity <= 10) continue;
      let e = F.default.getUser(n);
      if (null != e) {
        let r = G.Z.getActivities(n),
          l = R.Z.getVoiceStateForUser(n),
  ...
  $ = () => {
    let e = (0, c.e7)([D.Z], () => D.Z.getPrimaryActivity()),
      t = null == e ? void 0 : e.application_id,
      n = (0, P.Ns)(t);
    return (0, c.e7)([U.Z, F.default, G.Z, R.Z], () => {
      ...
      for (let e of (i && null != t && null != n && n.length > 0 && n.forEach(e => {
        ...
        let o = G.Z.getStatus(e),
          ...
          a = R.Z.getVoiceStateForUser(e),
          c = (null == a ? void 0 : a.channelId) != null,
          u = s.filter(e => e.type === L.IIU.PLAYING || e.type === L.IIU.LISTENING || e.type === L.IIU.WATCHING || e.type === L.IIU.STREAMING),
          d = u.filter(e => e.application_id === t);
        i && d.length > 0 ? (r.sameActivity.push({
          user: n,
          activities: d
        }), l.delete(e)) : u.length > 0 ? r.activities.push({
          user: n,
          activities: u
        }) : c ? r.activities.push({
          user: n,
          activities: s
        }) : o === L.Skl.ONLINE || o === L.Skl.IDLE || o === L.Skl.DND ? r.online.push({
          user: n,
          activities: s
        }) : r.offline.push({
          user: n,
  ...
  ee = () => {
    let e = Q(),
      t = X(),
      n = $(),
      i = (0, c.e7)([D.Z], () => D.Z.getPrimaryActivity());
    return r.useMemo(() => {
      var r;
      return {
        incoming: e,
    ...
    let {
      ...
      switch (t) {
        ...
        case J.SUGGESTIONS:
          ...
          break;
        case J.ACTIVITIES:
          n = W.NW.string(W.t.TxqPQU), r = P.activities.length;
          break;
        case J.ONLINE:
          n = W.NW.string(W.t.WbGtnJ), r = P.online.length;
          break;
        case J.OFFLINE:
          n = W.NW.string(W.t.Vv0abG), r = P.offline.length
      }
      let l = (t === J.SUGGESTIONS || t === J.INCOMING) && r > 3,
        o = N.includes(t);
      return (0, i.jsxs)(E.Z, {
        className: V.section,
        children: [(0, i.jsx)(u.nn4, {
          children: W.NW.format(W.t.UaqbkZ, {
            title: n,
            count: r
          })
        }), (0, i.jsxs)(u.P3F, {
          ...
          children: [n, " — ", r, l ? o ? (0, i.jsx)(u.Fbu, {
            size: "md",
            color: "currentColor",
      ...
      return (e.section === J.INCOMING ? (t = P.incoming[e.row], n = !0) : t = e.section === J.SAME_ACTIVITY ? P.sameActivity[e.row] : e.section === J.SUGGESTIONS ? P.suggestions[e.row] : e.section === J.ACTIVITIES ? P.activities[e.row] : e.section === J.ONLINE ? P.online[e.row] : P.offline[e.row], null == t || null == t.user) ? null : (0, i.jsx)(K, Y(z({}, t), {
        index: e.row,
        closeParentPopout: o,
        isSuggestion: e.section === J.SUGGESTIONS || n,
        isIncomingRequest: n,
        appContext: p
      }), t.user.id)
    }, [P, o, p]), {
      ...
      let e = x ? N.includes(J.SUGGESTIONS) ? Math.min(3, P.suggestions.length) : P.suggestions.length : 0;
      return [N.includes(J.INCOMING) ? Math.min(3, P.incoming.length) : P.incoming.length, P.sameActivity.length, P.activities.length, e, P.online.length, P.offline.length]
    }, [P, N, x]), k = Object.values(P).every(e => 0 === e.length);
    return (0, i.jsxs)(u.VqE, {
      ...
      children: [null != c ? (0, i.jsx)("div", {
        ...
        children: [(0, i.jsx)(u.X6q, {
          ...
          children: W.NW.string(W.t.TdEu5e)
        }), (0, i.jsxs)("div", {
          className: V.controlButtons,
          children: [(0, i.jsx)(u.M0o, {
            tooltip: W.NW.string(W.t.w5uwoK),
            color: u.YX$.TERTIARY,
            icon: (0, i.jsx)(u.oLu, {
              size: "xs",
              color: "currentColor"
        ...
        children: (0, i.jsx)(u.Text, {
          ...
          color: "text-muted",
          children: W.NW.string(W.t["7sW4h4"])
        })
      }) : (0, i.jsx)(a.bG, {
        navigator: O,
...
function ei(e) {
  let {
    ...
    popoutPosition: o,
    popoutAlign: s
  } = e, [a, c] = r.useState(!1), d = r.useCallback(() => {
    c(!1), null == n || n()
  }, [n]), p = r.useCallback(() => {
    c(e => {
      let i = !e;
  ...
  }, [n, t]), g = r.useCallback(() => (0, i.jsx)(en, {
