...
class u {
  ...
  static extractTimeComponent(e, t) {
    ...
    if (n >= 12 && (a = r.GG.PM), null != t[c]) {
      ...
      e.match(/morgen|vormittag/) && (a = r.GG.AM, 12 == n && (n = 0)), e.match(/nachmittag|abend/) && (a = r.GG.PM, 12 != n && (n += 12)), e.match(/nacht/) && (12 == n ? (a = r.GG.AM, n = 0) : n < 6 ? a = r.GG.AM : (a = r.GG.PM, n += 12))
    }
    if (e.assign("hour", n), e.assign("minute", i), null !== a ? e.assign("meridiem", a) : n < 12 ? e.imply("meridiem", r.GG.AM) : e.imply("meridiem", r.GG.PM), null != t[l]) {
      let n = parseInt(t[l]);
      if (n >= 60) return null;
      e.assign("second", n)
    }
