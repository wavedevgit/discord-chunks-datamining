...
class m extends Chunk317770.Z {
  ...
  handleOpenChannelCallPopout(e) {
    ...
    c.bA(u.KJ3.CHANNEL_CALL_POPOUT, e => t.isGuildStageVoice() ? <f windowKey={e} channelId={t.id} /> : <p windowKey={e} channelId={t.id} />, {
      defaultWidth: 854,
      defaultHeight: 480
    })
  }
  ...
  handleOpenRTCDebugPopout() {
    Chunk788983.bA(Chunk981631.KJ3.RTC_DEBUG_POPOUT, e => <h windowKey={e} />, {
      defaultWidth: 854,
      defaultHeight: 480
    })
  }
  handleOpenActivityPopout() {
    (0, Chunk765250.te)(Chunk757744.$S, Chunk355863.Z.getDefaultLayout(Chunk757744.$S, Chunk757744.HN), Chunk757744.HN), Chunk788983.bA(Chunk981631.KJ3.ACTIVITY_POPOUT, e => <g windowKey={e} />, {
      defaultWidth: 854,
      defaultHeight: 480
    })
  }
