...
class x extends r.PureComponent {
  render() {
    let e, t, n = g.Z.getCurrentConfig({
  ...
  constructor(...e) {
    super(...e), N(this, "state", {
      ...
      e ? (0, h.ak)(i, "message_delete_alert", () => u.Z.deleteMessage(n.id, i.id).then(() => {
        if (null != l) {
          var e, n;
...
let D = {
  confirmPin: function(e, t) {
    (0, s.h7j)(n => {
      let r, l = (0, d.F6)(e, E.default, O.Z);
      return r = e.isPrivate() ? S.intl.string(S.t.hMRngI) : S.intl.formatToPlainString(S.t["3IRluL"], {
        channelName: l
      }), (0, i.jsx)(m.Z.Provider, {
        value: e.guild_id,
        children: (0, i.jsxs)(s.ConfirmModal, Z(I({
  ...
  confirmUnpin: function(e, t) {
    (0, s.h7j)(n => (0, i.jsx)(m.Z.Provider, {
      value: e.guild_id,
      children: (0, i.jsxs)(s.ConfirmModal, Z(I({
  ...
  confirmEdit: function(e, t, n) {
    (0, s.h7j)(r => (0, i.jsx)(s.ConfirmModal, Z(I({
