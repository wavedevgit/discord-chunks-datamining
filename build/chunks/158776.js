...
function w(e) {
  ...
  n.status !== h.Skl.OFFLINE || null != n.hiddenActivities && n.hiddenActivities.length > 0 ? (b[e] = n.status, y[e] = n.activities, O[e] = D(Object.values(t).flatMap(e => {
    var t;
    return null != (t = e.hiddenActivities) ? t : []
  })), null != n.clientStatus && (v[e] = n.clientStatus)) : s().every(E[e], e => e.status === h.Skl.OFFLINE && (null == e.hiddenActivities || 0 === e.hiddenActivities.length)) ? delete E[e] : n.status === h.Skl.OFFLINE && t.some(e => null != e.hiddenActivities && e.hiddenActivities.length > 0) && (O[e] = D(Object.values(t).flatMap(e => {
    var t;
    return null != (t = e.hiddenActivities) ? t : []
  })))
}
