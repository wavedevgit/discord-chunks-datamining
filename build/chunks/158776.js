...
n.d(t, {
  Z: () => $,
  f: () => w
}), n(539854), n(388685), n(361932), n(187205), n(583741), n(642613);
var r, i = n(348327),
  a = n.n(i),
  o = n(392711),
  s = n.n(o),
...
function D(e, t) {
  ...
  if (!n.filterGamePresence && !n.filterRichPresence) return {
    visible: e,
    hidden: []
  };
  let r = [],
...
function L(e) {
  ...
  n.status !== m.Skl.OFFLINE || null != n.hiddenActivities && n.hiddenActivities.length > 0 ? (y[e] = n.status, O[e] = n.activities, v[e] = x(Object.values(t).flatMap(e => {
    var t;
    return null != (t = e.hiddenActivities) ? t : []
  })), null != n.clientStatus && (I[e] = n.clientStatus)) : s().every(b[e], e => e.status === m.Skl.OFFLINE && (null == e.hiddenActivities || 0 === e.hiddenActivities.length)) ? delete b[e] : n.status === m.Skl.OFFLINE && t.some(e => null != e.hiddenActivities && e.hiddenActivities.length > 0) && (v[e] = x(Object.values(t).flatMap(e => {
    var t;
    return null != (t = e.hiddenActivities) ? t : []
  })))
}
...
function j(e) {
  ...
  if (l) c[t] = {
    ...
    let {
      visible: e,
      hidden: l
    } = D(a.length > 1 ? [...a].sort(w) : a, n), u = x([...null != o ? o : [], ...l]);
    c[t] = {
      status: r,
      clientStatus: i,
      activities: e,
