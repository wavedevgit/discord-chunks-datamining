...
function N(e) {
  ...
  } = e, T = (0, u.Wu)([b.Z], () => b.Z.getAllActiveStreams()), A = (0, u.e7)([y.default], () => y.default.getCurrentUser()), w = null != T.find(e => e.ownerId === (null == A ? void 0 : A.id)), R = (0, u.e7)([v.Z], () => v.Z.getPreviousGoLiveSettings()), M = w && null != R && R.resolution !== O.LY.RESOLUTION_1440 && R.frameRate !== O.ws.FPS_60, [D, L] = (0, i.useState)(!1);
  (0, i.useEffect)(() => {
    L(!0)
  }, []);
  ...
  let z = s()(V).diff(s()(), "hours"),
    W = N ? E.intl.format(E.t["6LrV9f"], {
      username: H,
      num: z,
      helpCenterLink: C.Z.getArticleURL(j.BhN.HD_STREAMING_POTION)
    }) : l.id === A.id ? E.intl.string(E.t.IjKvNT) : !0 === w ? E.intl.format(E.t.JkWoqK, {
      username: H,
      helpCenterLink: C.Z.getArticleURL(j.BhN.HD_STREAMING_POTION)
    }) : E.intl.formatToPlainString(E.t.vNbVXF, {
      username: H
    }),
    Y = M ? E.intl.string(E.t.o7NIjY) : G ? E.intl.string(E.t.r6xhBw) : E.intl.string(E.t.yKw8Dg);
  return null == l || null == A ? null : (0, r.jsxs)(c.animated.div, {
    style: U,
    className: S.banner,
    children: [(0, r.jsxs)("div", {
      children: [(0, r.jsx)(p.qEK, I({
        src: B,
