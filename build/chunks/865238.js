...
function Z(e) {
  ...
  } = e, N = (0, u.Wu)([g.Z], () => g.Z.getAllActiveStreams()), T = (0, u.e7)([_.default], () => _.default.getCurrentUser()), A = null != N.find(e => e.ownerId === (null == T ? void 0 : T.id)), w = (0, u.e7)([y.Z], () => y.Z.getPreviousGoLiveSettings()), R = A && null != w && w.resolution !== j.LY.RESOLUTION_1440 && w.frameRate !== j.ws.FPS_60, [M, k] = (0, i.useState)(!1);
  (0, i.useEffect)(() => {
    k(!0)
  }, []);
  ...
  let V = s()(H).diff(s()(), "hours"),
    ...
    }) : l.id === T.id ? O.intl.string(O.t.IjKvNT) : !0 === A ? O.intl.format(O.t.JkWoqK, {
      username: G,
      helpCenterLink: x.Z.getArticleURL(v.BhN.HD_STREAMING_POTION)
