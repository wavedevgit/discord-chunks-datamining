...
function Z(e) {
  ...
  } = e, N = (0, u.Wu)([g.Z], () => g.Z.getAllActiveStreams()), T = (0, u.e7)([_.default], () => _.default.getCurrentUser()), A = null != N.find(e => e.ownerId === (null == T ? void 0 : T.id)), w = (0, u.e7)([x.Z], () => x.Z.getPreviousGoLiveSettings()), R = A && null != w && w.resolution !== O.LY.RESOLUTION_1440 && w.frameRate !== O.ws.FPS_60, [k, M] = (0, i.useState)(!1);
  (0, i.useEffect)(() => {
    M(!0)
  }, []);
  ...
  let V = s()(G).diff(s()(), "hours"),
    z = Z ? j.intl.format(j.t["6LrV9f"], {
      username: F,
      num: V,
      helpCenterLink: y.Z.getArticleURL(v.BhN.HD_STREAMING_POTION)
    }) : l.id === T.id ? j.intl.string(j.t.IjKvNT) : !0 === A ? j.intl.format(j.t.JkWoqK, {
      username: F,
      helpCenterLink: y.Z.getArticleURL(v.BhN.HD_STREAMING_POTION)
    }) : j.intl.formatToPlainString(j.t.vNbVXF, {
      username: F
    }),
