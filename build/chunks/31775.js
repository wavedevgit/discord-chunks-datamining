...
r = "function" == typeof Symbol ? function(e) {
  ...
  return l(this, "lruList").forEach(function(e) {
    ...
    e.maxAge !== a && (l.maxAge = e.maxAge), s !== c && (l.length = e.length), _(this, e) && (l.stale = true), l = o.inspect(l, t).split("\n").join("\n  "), n += i + " => " + l
  }), (u || r) && (n += "\n"), n += "}"
  ...
  if (l(this, "cache").has(e)) {
    ...
    return l(this, "dispose") && l(this, "dispose").call(this, e, o.value), o.now = r, o.maxAge = n, o.value = t, l(this, "length", l(this, "length") + (i - o.length)), o.length = i, this.get(e), p(this), true
  }
  var a = new m(e, t, i, r, n);
  return a.length > l(this, "max") ? (l(this, "dispose") && l(this, "dispose").call(this, e, t), false) : (l(this, "length", l(this, "length") + a.length), l(this, "lruList").unshift(a), l(this, "cache").set(e, l(this, "lruList").head), p(this), true)
