...
function f(e) {
  let {
    userId: t,
    guildId: n
  } = e, f = (0, l.e7)([o.ZP], () => o.ZP.getGuildSidebarState(n), [n]), {
    messagesCount: m,
    linksCount: g,
    mediaCount: b
  } = (0, c.P2)(t, n), _ = new Intl.NumberFormat(p.intl.currentLocale).format(m), y = new Intl.NumberFormat(p.intl.currentLocale).format(g), x = new Intl.NumberFormat(p.intl.currentLocale).format(b), C = i.useCallback(async e => {
    if (null == f) return;
    let r = (0, c.Ow)(t, e, {
      include_nsfw: !0
    });
