...
function h(A) {
  let {
    ...
    linksCount: E,
    mediaCount: d
  } = (0, o.P2)(e, t), C = new Intl.NumberFormat(c.intl.currentLocale).format(u), B = new Intl.NumberFormat(c.intl.currentLocale).format(E), w = new Intl.NumberFormat(c.intl.currentLocale).format(d), D = r.useCallback(async A => {
    if (null == h) return;
    let n = (0, o.Ow)(e, A, {
      include_nsfw: !0
    });
