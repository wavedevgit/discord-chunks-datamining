...
function f(e) {
  let {
    ...
    linksCount: g,
    mediaCount: b
  } = (0, c.P2)(t, n), _ = new Intl.NumberFormat(p.intl.currentLocale).format(m), x = new Intl.NumberFormat(p.intl.currentLocale).format(g), C = new Intl.NumberFormat(p.intl.currentLocale).format(b), y = i.useCallback(async e => {
    if (null == f) return;
    let r = (0, c.Ow)(t, e, {
      include_nsfw: !0
    });
