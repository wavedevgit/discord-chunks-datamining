...
function h(A) {
  let {
    ...
    linksCount: u,
    mediaCount: d
  } = (0, o.P2)(e, t), C = new Intl.NumberFormat(v.intl.currentLocale).format(E), B = new Intl.NumberFormat(v.intl.currentLocale).format(u), w = new Intl.NumberFormat(v.intl.currentLocale).format(d), D = r.useCallback(async A => {
    if (null == h) return;
    let n = (0, o.Ow)(e, A, {
      include_nsfw: !0
    });
  ...
  return (0, n.jsx)(i.xJW, {
    title: v.intl.string(v.t.vCn2Tk),
    ...
    children: (0, n.jsxs)(g.WM, {
      children: [(0, n.jsx)(g._2, {
        ...
        name: (0, n.jsx)(i.Text, {
          ...
          color: "text-default",
          children: v.intl.string(v.t.OIgYlZ)
        }),
        ...
        onNavigate: E > 0 ? () => D(o.mw.MESSAGES) : void 0
      }), (0, n.jsx)(g._2, {
        icon: (0, n.jsx)(i.xPt, {
          size: "custom",
          width: g.Mn,
        ...
        name: (0, n.jsx)(i.Text, {
          variant: "text-sm/semibold",
          color: "text-default",
          children: v.intl.string(v.t.DFSvTk)
        }),
        ...
        onNavigate: u > 0 ? () => D(o.mw.LINKS) : void 0
      }), (0, n.jsx)(g._2, {
        icon: (0, n.jsx)(i.Ka2, {
          size: "custom",
          width: g.Mn,
        ...
        name: (0, n.jsx)(i.Text, {
          variant: "text-sm/semibold",
          color: "text-default",
          children: v.intl.string(v.t["Aw9+/P"])
        }),
