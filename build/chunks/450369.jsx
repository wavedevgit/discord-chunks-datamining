...
let M = 16 / 9,
  U = e => {
    ...
    return <C.Z targetElementRef={p} user={s} guildId={a} channelId={l.id} clickTrap={true}>{e => (0, r.jsx)(c.P3F, L(k({
        innerRef: p,
  ...
  F = e => {
    ...
    return <N.Z participant={n} aspectRatio={M} fit={n.type === A.fO.USER ? O.L.COVER : true} blocked={m} ignored={y} channel={l} className={D.tile} inCall={true} inPopout={p} onClick={T} onContextMenu={d} pulseSpeakingIndicator={!f.enabled} width={a}>{s && n.type === A.fO.USER && (0, r.jsx)(R.Z, {})}</N.Z>
  },
  H = Chunk73800.memo(function(e) {
    ...
    return O.type !== A.fO.USER || (null == (t = O.voiceState) ? true : t.selfVideo) ? <F stageParticipant={i} rtcParticipant={O} channel={l} guildId={x} user={j} width={c} isModerator={C} onContextMenu={I} inPopout={h === w.IlC.POPOUT} /> : <U stageParticipant={i} rtcParticipant={O} channel={l} guildId={x} user={j} width={c} isModerator={C} onContextMenu={I} inPopout={h === w.IlC.POPOUT} />
  })