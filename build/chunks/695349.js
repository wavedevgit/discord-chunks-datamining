...
async function h(e) {
  ...
  return !(!(!n && null != r && null != r.endsAt && r.endsAt.getTime() < Date.now()) || r.endsAt.getTime() < Date.now() - p) && r.sourceType === f.kNB.REVERSE_TRIAL && (null == e && await (0, d.T)(), null != l.Z.getUserTrialOffer(_.Rt)) || !1
}
