...
function f(e) {
  let {
    ...
    skipForceHide: h = !1
  } = e, m = i.useContext(c.h9), [g, E] = i.useState(""), [b, y] = i.useState(!1), O = (0, o.e7)([l.ZP], () => l.ZP.callHeaderHeight), v = i.useRef(null), I = i.useRef(0);
  i.useEffect(() => {
    let e = t.current;
  ...
  return (null == t ? void 0 : t.current) == null ? null : (0, r.jsx)(s.ZP, {
