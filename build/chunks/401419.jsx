...
function m(e) {
  ...
  let c = h(i, s);
  return null == c ? null : <iframe src={c.embedUrl} className={o()(l.embedIFrame, e.className)} style={c.style} sandbox={"allow-forms allow-modals allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"} />
}