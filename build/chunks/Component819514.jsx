  ...
  render() {
    ...
    if ((null == Chunk933557 ? true : Chunk933557.moderatorReportChannelId) != null) {
      ...
      return (0, Chunk54381.jsx)(Chunk372900.Z.Provider, {
        value: o.guild_id,
        children: (0, Chunk54381.jsx)(Chunk793030.Modal, I(S({
          ...
          actionBarInput: module ? true : (0, Chunk54381.jsx)(Chunk481060.Checkbox, {
            checked: Chunk473749,
            label: Chunk388032.intl.string(Chunk342153.default["8yIKem"]),
...
let N = {
  ...
  confirmUnpin: function(e, t) {
    (0, c.h7j)(n => (0, r.jsx)(p.Z.Provider, {
      value: e.guild_id,
      children: (0, r.jsxs)(s.Modal, I(S({
