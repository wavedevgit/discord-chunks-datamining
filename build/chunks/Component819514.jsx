...
class Z extends Chunk473749.PureComponent {
  render() {
    let e, t, {
      ...
      f = o.type === Chunk981631.d4z.GUILD_ANNOUNCEMENT && (0, Chunk630388.yE)(Chunk332148.flags, Chunk981631.iLy.CROSSPOSTED);
      ...
      return (0, Chunk54381.jsx)(Chunk372900.Z.Provider, {
        ...
        children: (0, Chunk54381.jsx)(Chunk793030.Modal, S(k({
          ...
          actionBarInput: module ? true : (0, Chunk54381.jsx)(Chunk481060.Checkbox, {
            checked: Chunk473749,
            label: Chunk388032.intl.string(Chunk826688.default["8yIKem"]),
  ...
  constructor(...e) {
    super(...e), P(this, "state", {
      ...
      e ? (0, h.ak)(r, "message_delete_alert", () => d.Z.deleteMessage(n.id, r.id).then(() => {
        if (null != a) {
          var e, n;
          t && !o && f.Z.resolveFlag(a), null == (e = (n = this.props).onClose) || e.call(n)
        }
...
let w = {
  confirmPin: function(e, t) {
    (0, s.h7j)(n => {
      let i, a = (0, u.F6)(e, m.default, g.Z);
      return i = e.isPrivate() ? _.intl.string(_.t.hMRngA) : _.intl.formatToPlainString(_.t["3IRluI"], {
        channelName: a
      }), (0, r.jsx)(b.Z.Provider, {
        value: e.guild_id,
        children: (0, r.jsx)(l.Modal, S(k({
  ...
  confirmUnpin: function(e, t) {
    (0, s.h7j)(n => (0, r.jsx)(b.Z.Provider, {
      value: e.guild_id,
      children: (0, r.jsxs)(l.Modal, S(k({
  ...
  confirmEdit: function(e, t, n) {
    (0, s.h7j)(i => (0, r.jsx)(l.Modal, S(k({
      ...
      children: (0, r.jsx)(s.Text, {
        ...
        className: C.spacing,
        children: _.intl.string(_.t.grBcM8)
      })
    })))
  }
}