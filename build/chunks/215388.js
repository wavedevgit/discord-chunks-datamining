...
function q(e) {
  ...
  let {
    ...
    parentModalKey: V
  } = e, y = (0, i.Gc0)(), [N, I] = A.useState(() => (0, s.JM)(U)), T = A.useRef(!0 === d), F = null != n ? n : null == y ? void 0 : y.titleId, Z = null != (t = null == y ? void 0 : y.errorId) ? t : h, K = A.useMemo(() => ({
  ...
  return (0, r.jsxs)(c.Z, {
    ...
    children: [!0 === x && (0, r.jsx)(C, {
      hasError: null != y.error || null != g && U.length > g,
      text: U,
      maxLength: g
    }), null != g && (0, r.jsx)(i.nn4, {
      id: h,
