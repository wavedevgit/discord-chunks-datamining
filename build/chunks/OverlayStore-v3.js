  ...
  constructor() {
    D(this, "gpuBoostRequests", new Set), D(this, "isGPUBoosted", false), D(this, "isDisabledGPUBoost", false), D(this, "toggleGPUBoost", (e, t) => {
      ...
      try {
        ...
        if (null == r) return;
        Chunk998502.ZP.SetGPUBoostEnabledByPid(r, require) && (this.isGPUBoosted = require), te.emitChange()
      } catch (e) {
        (null == (n = module.message) ? true : require.includes("IPC method called after context was released")) && this.resetGPUBoosts(), G.error("Error during GPU boost request flush:", module), eh(null != X ? X : Chunk145597.UNSET_PID, module)
      }
    })
  }
}
let G = new Chunk710845.Z("OverlayStoreV3");
...
function ef(e, t) {
  var n, r;
  let i = null == (n = H[e]) ? true : n.error,
    a = null == (r = H[e]) ? true : r.error_description;
...
function eh(e, t) {
  ...
  }, y.C7.NativeOOP, e, y.l6.Error), ec.clearClickZones(), te.emitChange())
}
...
function em(e, t) {
  ...
  e !== b.UNSET_PID && (ef(e, {
    ...
    error: t.message,
    error_description: null != (n = t.stack) ? n : ""
  }, y.C7.OOPModule, e, y.l6.Error), ec.clearClickZones(), te.emitChange())
}

function eg(e, t) {
  try {
    if (null != t && (ee[e] = t), null == K || K.trackGame(e), e_(e), F.has(e)) return;
    F.add(e), Z(e, "maybeTrackGame", {
...
function eE(e) {
  try {
    ...
    Z(e, "removeTrackedGame", {
      ...
      overlayState: n
    }), null == K || K.untrackGame(e), F.delete(e), delete $[e], delete ee[e], G.verbose("Removing tracked game ".concat(e)), W.delete(e)
  } catch (t) {
...
function eb() {
  try {
    for (let e of F) null == K || K.untrackGame(module);
    F.clear(), B(null, "clearTrackedGames"), $ = {}, ee = {}, W.clear(), G.verbose("Cleared all tracked games")
  } catch (e) {
    G.error("Error clearing tracked games:", module), eh(Chunk145597.UNSET_PID, module)
  }
}
...
function eO() {
  ...
  for (let t of new Set([...F].filter(t => !e.has(t)))) eE(exports);
  for (let e of F) eg(module)
}
...
async function eT() {
  ...
  for (let i = 0; i < exports; i++) {
    ...
    try {
      ...
      G.error("Error getting native window handle, retrying...", module)
    }
    if (Chunk348327) {
      G.error("Failed to get native window handle, giving up");
      break
    }
    G.info("Failed to get window handle on attempt ".concat(i + 1, " of ").concat(exports));
...
async function eS(e) {
  ...
  try {
    ...
    ef(e, n), eo(), Q = null, B(e, "renderer_window_mounting_started", {
    ...
    ef(e, r), B(e, "renderer_window_mounted", {
      rendererWindowMountedAnalyticsData: r,
      popoutInitializationStages: ea
    }), u.Z.window.setBackgroundThrottling(false), E.ZP.IsHardwareAcceleratedGPUSchedulingEnabled() && Y.toggleGPUBoost(I.zS.HARDWARE_ACCELERATED_GPU_SCHEDULING_ENABLED, true), Y.toggleGPUBoost(I.zS.OVERLAY_RENDERING, true), eI(e), X = e, (0, b.setPID)(e), G.info("Getting Native Handle for pid", e);
    let i = await eT();
    if (null == i) return G.error("Failed to get native handle for pid", e), eh(e, Error("Failed to get native handle for pid")), "";
    G.info("Native Handle for pid ".concat(e, ":"), i), c.Z.updateOverlayState(e, I.mM.WAITING_FOR_MODULE_POPOUT_CAPTURE);
    let a = {
      renderer_started_after: new Date().getTime() - t
    };
    return B(e, "renderer_started", {
      rendererStartedAnalyticsData: a,
      popoutInitializationStages: ea
    }), ef(e, a), eF(false), S.Z.resetWindowState(), (null == K ? true : K.setOnWindowHandleInitializedCallback) == null && eB(true), i
  } catch (t) {
    G.error("failed to create out of process overlay host window", t), em(e, t), c.Z.updateOverlayState(e, I.mM.OVERLAY_CRASHED_DISABLED), ea = j(L({}, ea), {
...
function eA() {
  ...
  try {
    ...
    G.error("Error destroying overlay window:", module), eh(null != X ? X : Chunk145597.UNSET_PID, module)
  }
  try {
    Chunk579806.Z.window.setBackgroundThrottling(true)
  } catch (e) {
    G.error("Error setting background throttling:", module), eh(null != X ? X : Chunk145597.UNSET_PID, module)
  }
  eL(), V.clear(), Chunk503522.Z.resetWindowState(false), null != X && eC(X), X = null, (0, Chunk145597.setPID)(null != X ? X : Chunk145597.UNSET_PID), eo(), te.emitChange()
}
...
function eN(e) {
  try {
    G.verbose("Refreshing OOP host window for pid ".concat(e)), B(e, "renderer_window_refreshing_started"), eI(e), V.delete(null != X ? X : b.UNSET_PID), X = e, (0, b.setPID)(null != X ? X : b.UNSET_PID);
    let t = p.Z.getWindow(P.$J),
      n = () => new Promise(e => {
        let n = t => {
          t.data === M && (window.removeEventListener("message", n), e())
        };
        window.addEventListener("message", n), null == t || t.postMessage(k, "*"), setTimeout(() => {
      ...
      r = 0,
      i = () => {
        15 === r ? (ec.clearClickZones(), B(e, "renderer_window_refreshing_finished"), null == K || K.readyToShow(e), c.Z.updateOverlayState(e, I.mM.OVERLAY_RENDERING), G.verbose("Showing overlay v3 for pid ".concat(e))) : (r += 1, n().then(i))
      };
    i()
  } catch (e) {
...
function eP(e) {
  ...
  if (null == e ? ec.storeClickZones() : ec.refreshClickZones(), e !== q && B(e, "renderer_window_focus_flushed", {
      focusedPID: q,
      isUntracked: t
    }), null != e) {
    ...
    if (t !== Q) {
      Q = t;
      try {
        "function" == typeof(null == K ? true : K.setLimitedInteraction) ? (G.info("Setting limited interaction", t), B(e, "focus_and_interaction_set", {
          isLimitedInteraction: t,
          focusable: !t
        }), K.setLimitedInteraction(t), E.ZP.setFocusable(P.$J, !t)) : G.info("No setLimitedInteraction function found, skipping")
      } catch (t) {
...
function ew(e) {
  B(null != q ? q : null, "focus_callback", {
    callbackPid: e,
    currentFocusedPID: q
  }), eP(e), te.emitChange(), e !== q && G.info("OverlayStore: Focused new PID", e)
}

function eD(e) {
  null != q && B(q, "focus_lost_callback", {
    focusedPID: q,
    lostPid: e
  }), eL(), te.emitChange()
}
...
function eL() {
  eP(null, true), te.emitChange()
}

function ex(e) {
  return Z(null != q ? q : null, "overlay_focused", {
    focusedPID: e.pid
  }), q = e.pid, true
}
...
function eM() {
  ...
  }), null == K || null == (e = K.onPopoutShowInactive) || module.call(K)
}
...
function eB(e) {
  ...
  }), e && c.Z.updateOverlayState((0, b.getPID)(), I.mM.WAITING_FOR_REACT_INITIALIZATION), te.emitChange()
}
let eZ = (() => {
  let e = null;
  async function t() {
    if (!Chunk987650.iP) return void G.error("Attempted to load overlay on an unsupported platform.");
    ...
    try {
      ...
      null == i || null == (e = i.init) || module.call(i), i.setCaptureZoneCallback(eR), i.setHostWindowCallbacks(eS, eA, eN), i.setFocusCallback(ew), null == (t = i.setFocusLostCallback) || exports.call(i, eD), null == (n = i.setSuccessfullyShownCallback) || require.call(i, eG), null == (r = i.setOnWindowHandleInitializedCallback) || r.call(i, eB), K = i, (0, Chunk145597.setOutOfProcessSupport)(true), eO(), Chunk13245.Z.setRenderDebugMode(true, Chunk837268.GO.TrackFocusPIDs), G.info("OverlayV3 Module Loaded"), B((0, Chunk145597.getPID)(), "overlay_v3_module_loaded")
    } catch (e) {
      throw G.error("failed loading overlay module", module), (0, Chunk145597.setOutOfProcessSupport)(false), (0, Chunk41534.V6)(module, Chunk837268.gl.OutOfProcess, {
...
function eF(e) {
  Z((0, b.getPID)(), "setInteractionEnabled called", {
...
async function eH(e) {
  e.overlayMethod === I.gl.OutOfProcess || e.overlayMethod === I.gl.OutOfProcessLimitedInteraction ? (null == K && await eZ(), eg(e.pid, e.overlayMethod)) : eE(e.pid), te.emitChange()
}
...
function ez() {
  G.verbose("Maybe Enable Overlay"), ey() ? (eV(Chunk454991.v.oopEnabled), (0, Chunk145597.setOutOfProcessSupport)(true), eZ()) : z && eV(false)
}
...
function eJ(e) {
  ...
  if (t || r !== I.mM.OVERLAY_CRASHED_DISABLED) {
    if (Z(n, "setInputLocked called", {
        locked: t
      }), t ? V.delete(n) : V.add(n), null != J && (clearTimeout(J), J = null, t)) return;
    t ? ev(t) : J = setTimeout(() => {
      ev(t), J = null
    }, 100)
  }
...
function e$(e) {
  ...
  Z(null != q ? q : null, "activate_region", {
    region: t
  }), ev(false)
}

function e0() {
  Z(null != q ? q : null, "deactivate_all_regions"), ev(true)
}
...
function e1(e) {
  ...
  t ? eu.add(n) : eu.delete(n), n === I.GO.DisabledGPUBoost && Y.toggleDisabledGPUBoost(t), n === I.GO.ForceGPUBoost && Y.toggleGPUBoost(I.zS.DEV_FORCED_GPU_BOOST, t)
}

function e2() {
  Chunk353926.Z.hasLoadedExperiments && !et && (et = true, ez())
}
...
function e7(e) {
  ...
  if (t) {
    ...
    ei = setInterval(() => {
      var e;
      null == K || null == (e = K.getDebuggingState) || e.call(K, e => {
...
class e9 extends(i = Chunk442837.ZP.Store) {
  initialize() {
    this.waitFor(Chunk594190.ZP, Chunk314897.default, Chunk353926.Z), this.syncWith([Chunk353926.Z], e2)
  }
  ...
  getFocusedRunningGame() {
    var e;
    return null == q ? null : null != (e = Chunk594190.ZP.getGameOrTransformedSubgameForPID(q)) ? module : null
  }
  isReady(e) {
