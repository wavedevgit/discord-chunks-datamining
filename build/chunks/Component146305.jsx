  ...
  getSectionDefinition: function(e, t) {
    ...
    switch (e) {
      ...
      case ef.pNK.APP_DIRECTORY:
        return {
          section: ef.pNK.APP_DIRECTORY, label: (0, r.jsx)(w.K, {}), ariaLabel: ex.intl.string(ex.t.AKcFUl), onClick: () => {
            (0, w.O)({
              guildId: t.guild.id,
              section: e
            })
      ...
      case ef.pNK.AUDIT_LOG:
        return {
          section: ef.pNK.AUDIT_LOG, impressionName: i.ImpressionNames.GUILD_SETTINGS_AUDIT_LOG, label: ex.intl.string(ex.t.SPWLyc), element: R.Z, type: o.bT.CUSTOM, predicate: () => t.canViewAuditLog
        };
      case ef.pNK.BANS:
        return {
