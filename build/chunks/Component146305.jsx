...
let e_ = {
  getSectionDefinition: function(e, t) {
    ...
    switch (e) {
      case ef.pNK.PROFILE:
        return {
          section: ef.pNK.PROFILE, impressionName: i.ImpressionNames.GUILD_SETTINGS_PROFILE, label: eb.intl.string(eb.t.txdaxc), ariaLabel: eb.intl.string(eb.t.txdaxc), element: eg.Z, type: o.bT.SCROLLABLE_CUSTOM, notice: {
            stores: [T.Z],
            element: ep.Z
          }
        };
      case ef.pNK.TAG:
        return {
          section: ef.pNK.TAG, impressionName: i.ImpressionNames.GUILD_SETTINGS_TAG, label: eb.intl.string(eb.t["2QmKZ2"]), ariaLabel: eb.intl.string(eb.t["2QmKZ2"]), element: $.Z, predicate: () => t.canManageGuild, notice: {
            stores: [T.Z],
            element: ee.Z
      ...
      case ef.pNK.ENGAGEMENT:
        return {
          section: ef.pNK.ENGAGEMENT, impressionName: i.ImpressionNames.GUILD_SETTINGS_ENGAGEMENT, label: eb.intl.string(eb.t["6TAHb2"]), ariaLabel: eb.intl.string(eb.t["6TAHb2"]), element: ea.Z, notice: {
            stores: [T.Z],
            element: eo.R
          }
        };
      case ef.pNK.BOOST_PERKS:
        return {
          section: ef.pNK.BOOST_PERKS, impressionName: i.ImpressionNames.GUILD_SETTINGS_BOOST_PERKS, label: eb.intl.string(eb.t.UKgg5O), ariaLabel: eb.intl.string(eb.t.UKgg5O), element: q.I, notice: {
            stores: [T.Z, Y.Z],
            element: X.C
          }
        };
      case ef.pNK.INVITES:
        return {
          section: ef.pNK.INVITES, impressionName: i.ImpressionNames.GUILD_SETTINGS_INVITES_V2, label: eb.intl.string(eb.t.YOt3Oj), ariaLabel: eb.intl.string(eb.t.YOt3Oj), element: ec.Z, type: o.bT.CUSTOM, predicate: () => t.canManageGuild
        };
      case ef.pNK.ROLES:
        return {
          section: ef.pNK.ROLES, impressionName: i.ImpressionNames.GUILD_SETTINGS_ROLES, label: eb.intl.string(eb.t.LPJmLy), element: z.Z, type: o.bT.MINIMAL, ariaLabel: eb.intl.string(eb.t.KXcECw), notice: {
            stores: [H.Z],
            element: z._
      ...
      case ef.pNK.EMOJI:
        return {
          section: ef.pNK.EMOJI, impressionName: i.ImpressionNames.GUILD_SETTINGS_EMOJI, label: eb.intl.string(eb.t.sMOuub), element: en.ZP, predicate: () => t.canManageGuildExpressions
        };
      case ef.pNK.STICKERS:
        return {
          section: ef.pNK.STICKERS, impressionName: i.ImpressionNames.GUILD_SETTINGS_STICKERS, label: eb.intl.string(eb.t.R5nQkZ), ariaLabel: eb.intl.string(eb.t.R5nQkZ), element: J.Z, predicate: () => t.canManageGuildExpressions
        };
      case ef.pNK.SOUNDBOARD:
        return {
          section: ef.pNK.SOUNDBOARD, impressionName: i.ImpressionNames.GUILD_SETTINGS_SOUNDBOARD, label: eb.intl.string(eb.t.OWQNYm), ariaLabel: eb.intl.string(eb.t.OWQNYm), element: Q.Z, predicate: () => t.canManageGuildExpressions
        };
      case ef.pNK.GUILD_TEMPLATES:
        return {
          ...
          }), ariaLabel: eb.intl.string(eb.t.KUw7Sk), element: el.ZP, notice: {
            stores: [el.Sf],
            element: el.Q5
      ...
      case ef.pNK.ACCESS:
        return {
          section: ef.pNK.ACCESS, impressionName: i.ImpressionNames.GUILD_SETTINGS_ACCESS, label: eb.intl.string(eb.t.YJlvBA), element: ed.O, notice: {
            stores: [em.Z],
            element: eu.w
      ...
      case ef.pNK.INTEGRATIONS:
        return {
          section: ef.pNK.INTEGRATIONS, impressionName: i.ImpressionNames.GUILD_SETTINGS_INTEGRATION, label: eb.intl.string(eb.t.CIsNZ2), ariaLabel: eb.intl.string(eb.t.CIsNZ2), element: L.Z, notice: {
      ...
      case ef.pNK.APP_DIRECTORY:
        return {
          section: ef.pNK.APP_DIRECTORY, label: (0, r.jsx)(P.K, {}), ariaLabel: eb.intl.string(eb.t.AKcFUl), onClick: () => {
            (0, P.O)({
              guildId: t.guild.id,
              section: e
            })
      ...
      case ef.pNK.SAFETY:
        return {
          section: ef.pNK.SAFETY, impressionName: i.ImpressionNames.GUILD_SETTINGS_SAFETY, label: eb.intl.string(eb.t["suhY+f"]), ariaLabel: eb.intl.string(eb.t["suhY+f"]), element: W.Z, newIndicatorDismissibleContentTypes: [l.z.COMMUNITY_GUILD_SETTINGS_SAFETY], predicate: () => t.canManageGuild && t.guild.features.has(ef.oNc.COMMUNITY)
        };
      case ef.pNK.MODERATION:
        return {
          section: ef.pNK.MODERATION, impressionName: i.ImpressionNames.GUILD_SETTINGS_MODERATION, label: eb.intl.string(eb.t["suhY+f"]), element: K.ZP, predicate: () => t.canManageGuild && !t.guild.features.has(ef.oNc.COMMUNITY)
        };
      ...
      case ef.pNK.AUDIT_LOG:
        return {
          section: ef.pNK.AUDIT_LOG, impressionName: i.ImpressionNames.GUILD_SETTINGS_AUDIT_LOG, label: eb.intl.string(eb.t.SPWLyc), element: w.Z, type: o.bT.CUSTOM, predicate: () => t.canViewAuditLog
        };
      case ef.pNK.BANS:
        return {
      ...
      case ef.pNK.ONBOARDING:
        return {
          section: ef.pNK.ONBOARDING, label: eb.intl.string(eb.t.LdxCKy), element: B.Z, ariaLabel: eb.intl.string(eb.t.LdxCKy), newIndicatorDismissibleContentTypes: t.onboardingEnabled ? null : [l.z.COMMUNITY_ONBOARDING_NEW_BADGE], notice: {
            stores: [G.Z, k.Z],
            element: F.Z
      ...
      case ef.pNK.ANALYTICS:
        return {
          section: ef.pNK.ANALYTICS, impressionName: i.ImpressionNames.GUILD_SETTINGS_ANALYTICS, label: eb.intl.string(eb.t["0wWfUF"]), ariaLabel: eb.intl.string(eb.t["0wWfUF"]), element: et.Z, predicate: () => eN
        };
      case ef.pNK.DISCOVERY_LANDING_PAGE:
        return {
          ...
          }), ariaLabel: eb.intl.string(eb.t.kGlQGB), element: Z.Z, notice: {
            stores: [T.Z],
            element: Z.J
      ...
      case ef.pNK.COMMUNITY_WELCOME:
        return {
          section: ef.pNK.COMMUNITY_WELCOME, impressionName: i.ImpressionNames.GUILD_SETTINGS_COMMUNITY_WELCOME, label: eb.intl.string(eb.t["2rkmDg"]), ariaLabel: eb.intl.string(eb.t["2rkmDg"]), element: D.Z, notice: {
            stores: [y.Z],
            element: C.Z
      ...
      case ef.pNK.GUILD_PREMIUM:
        return {
          section: ef.pNK.GUILD_PREMIUM, impressionName: i.ImpressionNames.GUILD_SETTINGS_BOOST_STATUS, label: eb.intl.string(eb.t["8+VX4+"]), ariaLabel: eb.intl.string(eb.t["8+VX4+"]), element: ei.Z, className: ex.serverBoostTabItem, icon: (0, r.jsx)(s.$Eu, {
      ...
      case ef.pNK.MEMBERS:
        return {
          section: ef.pNK.MEMBERS, impressionName: i.ImpressionNames.GUILD_SETTINGS_MEMBERS, label: (0, r.jsx)(er.$r, {}), ariaLabel: eb.intl.string(eb.t["9Oq93t"]), element: er.ZP, type: o.bT.CUSTOM, predicate: () => t.canAccessMembersPage, onClick: () => {
            (0, er.JA)()
          }
        };
      case ef.pNK.DELETE:
