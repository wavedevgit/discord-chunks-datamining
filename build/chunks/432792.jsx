...
let j = () => (0, Chunk930153.Lk)(document.body.style.getPropertyValue("--custom-app-panels-height"), 56) + 8,
  ...
  x = e => {
    ...
    return n || null == i ? <img src={o} className={y.orbAsset} alt={"Orb"} /> : <d.Z autoPlay={true} loop={true} className={y.orbAsset}>{<source src={v.Z} type={"video/webm"} />}{<img src={C.Z} className={y.orbAsset} alt={"Orb"} />}</d.Z>
  },
  I = e => {
    let {
      titleText: t,
    ...
    return <f.Z data-migration-pending={true} dismissibleContent={o.z.COLLECTIBLES_NAMEPLATE_SHOP_COACHMARK} inlineArt={true} tryItText={i} onTryFeature={l} header={(0, r.jsx)(a.X6q, {
        className: y.title,
        ...
        children: n
      })} position={d} align={h} hideDismissButton={true} dismissIcon={(0, r.jsx)(O.s, {})} onDismissIconClick={c} contentClassName={y.container} pointerClassName={y.coachmarkPointer} tryItButtonColor={s.zx.Colors.BRAND} art={(0, r.jsx)(x, {
        customIconSrcs: u
      })} />
  };
...
function P(e) {
  ...
  return <a.yRy autoInvert={false} renderPopout={() => N} position={f} align={I} nudgeAlignIntoViewport={false} shouldShow={P} spacing={p} positionKey={y} animation={a.yRy.Animation.TRANSLATE} targetElementRef={s}>{() => n}</a.yRy>
}