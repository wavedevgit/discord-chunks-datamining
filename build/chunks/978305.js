...
let O = e => {
  let {
    transitionState: r,
    onClose: t
  } = e, s = (0, p.Z)(), [l, O] = o.useState(!1), {
    getLinkCode: j,
    isGetLinkCodeLoading: z
  } = (0, m.G)({}), N = (0, x.rW)(), q = (0, x.gU)(), S = o.useRef(q);
  i()(!s, "FamilyCenterQRCodeModal should only be rendered for teens.");
  let w = () => {
    O(e => (C.default.track(g.rMx.FAMILY_CENTER_ACTION, {
  ...
  return (0, n.jsxs)(d.Y0X, {
    ...
    children: [(0, n.jsxs)(d.qXd, {
      className: _.notice,
      color: d.DM8.WARNING,
      children: [(0, n.jsx)(d.d3s, {
        size: "sm",
        color: "currentColor"
      ...
      children: [(0, n.jsx)(d.Text, {
        ...
        children: y.intl.format(h.default.LyyCsL, {
          link: "https://support.discord.com/hc/articles/14155060633623"
        })
      }), (0, n.jsx)("div", {
        className: _.qrCodeContainer,
        children: (0, n.jsx)(d.P3F, {
          className: a()(_.qrCodeObscure, {
            [_.visible]: E
          }),
          onClick: w,
