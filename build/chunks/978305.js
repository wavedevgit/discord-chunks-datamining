...
let y = e => {
  let {
    transitionState: r,
    onClose: t
  } = e, s = (0, m.Z)(), [l, y] = o.useState(!1), {
    getLinkCode: O,
    isGetLinkCodeLoading: j
  } = (0, C.G)({}), z = (0, x.rW)(), N = (0, x.gU)(), q = o.useRef(N);
  i()(!s, "FamilyCenterQRCodeModal should only be rendered for teens.");
  let k = () => {
    y(e => (f.default.track(b.rMx.FAMILY_CENTER_ACTION, {
      action: l ? p.YC.HideQRCode : p.YC.RevealQRCode
    }), !e)), l || setTimeout(() => {
      t()
    }, p.f2)
  };
