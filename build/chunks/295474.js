...
function O(e) {
  return (0, r.cj)([s.default, a.ZP, d.Z, c.Z], () => {
    let t = {
        nick: void 0,
        bio: void 0
      },
...
function g(e) {
  ...
  } = e, _ = (0, r.e7)([c.Z], () => c.Z.getGuild(t), [t]), E = (0, r.e7)([u.Z], () => null != _ && u.Z.can(h.Plq.CHANGE_NICKNAME, _), [_]);
  return [i.useCallback(() => {
    if (null == _) return;
    let e = h.oAB.PROFILE_CUSTOMIZATION,
      t = I.NB.GUILD;
    E ? (0, o.Fq)(_) : t = I.NB.USER_PROFILE, l.Z.open(e, t, {
      scrollPosition: n,
      analyticsLocation: s,
      analyticsLocations: a,
      openWithoutBackstack: d
