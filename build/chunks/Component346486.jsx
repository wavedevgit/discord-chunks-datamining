...
class u extends(r = Chunk647438.PureComponent) {
  ...
  defaultRender(e) {
    let {
      ...
      showUnits: n,
      className: r
    } = this.props, o = [e.days, e.hours, e.minutes, e.seconds], a = [c.intl.string(c.t["6m/6nM"]), c.intl.string(c.t.n7dksO), c.intl.string(c.t["1LyF1h"]), c.intl.string(c.t.QJyuxY)];
    if (0 === e.days) o.shift();
    else if (!t) {
      let e = o.shift();
      o[0] += 24 * e
    }
    let s = l()(o).map(e => e < 10 ? "0".concat(e) : e).map((e, t) => [t > 0 && !n ? ":" : " ", (0, i.jsxs)("span", {
