...
function R(e, t, n, r) {
  let l = b.Z.getGuild(n),
    a = e.replace(L, j.NW.string(j.t["F+x38P"])).replace(/<@!?(\d+)>/g, (e, t) => {
      var r;
...
function W(e) {
  ...
  let {
    message: i,
    channel: l
  } = e, a = i.type === P.uaV.REPLY ? u.Z.getMessageByReference(i.messageReference) : null, o = (null == a ? void 0 : a.state) === u.Y.LOADED ? null == a ? void 0 : null === (t = a.message) || void 0 === t ? void 0 : t.author : null, s = null != o ? null !== (n = m.ZP.getNick(l.guild_id, null == o ? void 0 : o.id)) && void 0 !== n ? n : I.ZP.getName(o) : null, c = l.getGuildId(), d = null !== (r = m.ZP.getNick(c, i.author.id)) && void 0 !== r ? r : I.ZP.getName(i.author);
...
function V(e) {
  ...
  if ((C || j) && !O.Z.isBlockedOrIgnoredForMessage(s)) {
    ...
    let t = null !== (l = null !== (i = m.ZP.getNick(e, null === (n = s.author) || void 0 === n ? void 0 : n.id)) && void 0 !== i ? i : I.ZP.getName(s.author)) && void 0 !== l ? l : "",
      ...
      d = null != c ? null !== (a = m.ZP.getNick(e, null == c ? void 0 : c.id)) && void 0 !== a ? a : I.ZP.getName(c) : null;
