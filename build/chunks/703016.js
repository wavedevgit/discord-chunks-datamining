...
function V(e) {
  ...
  let {
    message: i,
    channel: l
  } = e, a = i.type === P.uaV.REPLY ? u.Z.getMessageByReference(i.messageReference) : null, o = (null == a ? void 0 : a.state) === u.Y.LOADED ? null == a || null == (t = a.message) ? void 0 : t.author : null, s = null != o ? null != (n = m.ZP.getNick(l.guild_id, null == o ? void 0 : o.id)) ? n : C.ZP.getName(o) : null, c = l.getGuildId(), d = null != (r = m.ZP.getNick(c, i.author.id)) ? r : C.ZP.getName(i.author);
