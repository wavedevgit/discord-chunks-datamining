...
class v extends Chunk473749.PureComponent {
  ...
  renderConflict() {
    ...
    return (0, Chunk54381.jsxs)(Chunk481060.hzk, {
      ...
      }), this.renderConflictButton(Chunk388032.intl.string(Chunk388032.t.AQUmkr), exports.remote.timestamp, Chunk755802.conflictDownloadArt, this.handleChooseDownload), (0, Chunk54381.jsxs)(Chunk600164.Z, {
