...
class v extends Chunk647438.PureComponent {
  ...
  renderConflict() {
    ...
    return (0, Chunk951288.jsxs)(Chunk481060.hzk, {
      ...
      }), this.renderConflictButton(Chunk388032.intl.string(Chunk388032.t.AQUmkp), exports.remote.timestamp, Chunk755802.conflictDownloadArt, this.handleChooseDownload), (0, Chunk951288.jsxs)(Chunk600164.Z, {
      ...
      }), this.renderConflictButton(Chunk388032.intl.string(Chunk388032.t.AXVws7), exports.next.timestamp, Chunk755802.conflictUploadArt, this.handleChooseUpload)]
    })
  }
  render() {
    let {
