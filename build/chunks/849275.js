...
function _(e, t) {
  ...
  let k = r.useMemo(() => {
    let e = [];
    return E === s.m.RECENT ? e = x : E === s.m.PRICE_LOW_TO_HIGH ? e = (0, d.hC)([...x], t) : E === s.m.RECOMMENDED ? e = n ? (0, d.Qf)(v(_), O) : v(_) : E === s.m.POPULAR ? e = n ? (0, d.Qf)(v(m), O) : v(m) : E === s.m.RANDOM && (e = y), T(e)
  }, [E, T, x, y, t, v, _, m, O, n]);
  return {
    sortType: E,
    setSortType: S,
