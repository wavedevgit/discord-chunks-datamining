...
function m(e) {
  ...
  }, [t]), x = v.length > 0 && b, [O, S] = r.useState(x ? s.m.RECOMMENDED : s.m.POPULAR), y = (0, h.Z)(), j = (0, a.e7)([c.Z], () => c.Z.productsWithVariantsAsGroup), k = (0, a.e7)([u.Z], () => u.Z.getUserDiscounts()), T = (0, g.a)(), [I, L] = r.useState([]), B = r.useCallback(() => {
