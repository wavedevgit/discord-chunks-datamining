...
function h(e) {
  let {
    ...
    orbsSupportedOnly: h
  } = e, v = (0, i.e7)([s.Z], () => s.Z.hasConsented(m.pjP.PERSONALIZATION)), E = r.useMemo(() => {
    var e;
    return null != (e = null == t ? true : t[o.m.RECOMMENDED]) ? e : []
  }, [t]), S = r.useMemo(() => {
    var e;
    return null != (e = null == t ? true : t[o.m.POPULAR]) ? e : []
  }, [t]), _ = E.length > 0 && v, [O, x] = r.useState(_ ? o.m.RECOMMENDED : o.m.POPULAR), y = (0, i.e7)([c.Z], () => c.Z.productsWithVariantsAsGroup), j = r.useMemo(() => (0, d.wO)(y), [y]), k = (0, i.e7)([u.Z], () => u.Z.getUserDiscounts()), T = (0, b.Z)(), I = (0, f.a)(), [L, B] = r.useState([]), A = r.useCallback(() => {
  ...
  let N = r.useMemo(() => {
    ...
    return h ? (0, p.cf)(I(e)) : I(e)
  }, [O, h, I, n, j, T, E, l, k, S, L]);
  return {
    sortType: O,
    setSortType: x,
    sortedItems: (0, g.l)(N),
