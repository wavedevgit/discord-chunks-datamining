...
let Z = u.ZP.connectStores([E.Z], e => {
  ...
  return {
    canManageMessages: null != t && E.Z.can(j.Plq.MANAGE_MESSAGES, t)
  }
})(w);
...
function R(e) {
  let {
    ...
    className: E,
    listName: P
  } = e, A = i.useRef(null), w = (0, m.Z)(P, A), Z = (0, u.e7)([y.ZP], () => y.ZP.hasNotice()), R = (0, u.e7)([v.Z], () => v.Z.windowSize());
  i.useEffect(() => {
  ...
  null == n || o && 0 === n.length ? L = [(0, r.jsx)("div", {
    ...
    children: g()
  }, "empty-state")) : (D = !1, L = [], s().each(n, e => {
    L.push(..._(e))
  }));
  let M = null;
  null != n && n.length > 0 && null != p && (M = o ? (0, r.jsx)("div", {
...
function k(e) {
  ...
  let A = i.useMemo(() => null == a ? void 0 : a.map(e => ({
    message: e,
    channel: l
  })), [a, l]);
  return (0, r.jsx)(R, {
