...
let N = e => {
    ...
    return (0, n.jsxs)("div", {
      ...
      children: [(0, n.jsxs)("div", {
        ...
        }) : null, null == t ? null : (0, n.jsx)(h.Text, {
...
class Z extends s.PureComponent {
  ...
  renderCloseButton() {
    ...
    return null != e && (t || r || null != s && s.isPrivate()) ? (0, n.jsx)(d.zx, {
...
let k = u.ZP.connectStores([x.Z], e => {
  ...
  return {
    canManageMessages: null != t && x.Z.can(v.Plq.MANAGE_MESSAGES, t)
  }
})(Z);
...
function M(e) {
  ...
  s.useEffect(() => {
    O.default.track(v.rMx.OPEN_POPOUT, {
      type: t
    })
  }, [t]), s.useEffect(() => {
    function e() {
    ...
    return I.S.subscribe(v.CkL.SCROLL_PAGE_DOWN, t), I.S.subscribe(v.CkL.SCROLL_PAGE_UP, e), () => {
  ...
  let L = s.useCallback(() => {
    ...
    w = [],
    F = !0;
  null == r || i && 0 === r.length ? w = [(0, n.jsx)("div", {
    className: a()(R.emptyPlaceholder, R.loadingPlaceholder),
    children: (0, n.jsx)(h.$jN, {})
  }, "spinner")] : 0 === r.length ? w.push((0, n.jsx)(s.Fragment, {
    children: _()
  }, "empty-state")) : (F = !1, w = [], o().each(r, e => {
    w.push(...S(e))
  }));
  let D = null;
