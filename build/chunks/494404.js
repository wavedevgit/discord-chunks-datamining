...
class F extends i.PureComponent {
  ...
  renderCloseButton() {
    ...
    return null != e && (t || n || null != i && i.isPrivate()) ? (0, r.jsx)(d.zx, {
  ...
  constructor(...e) {
    super(...e), w(this, "handleClickJump", e => {
      let {
        jumpTo: t,
        message: n
      } = this.props;
...
function H(e) {
  let {
    ...
    className: O,
    listName: w
  } = e, P = i.useRef(null), x = (0, p.Z)(w, P), B = (0, u.e7)([v.ZP], () => v.ZP.hasNotice()), Z = (0, u.e7)([I.Z], () => I.Z.windowSize());
  i.useEffect(() => {
...
function Y(e) {
  ...
  let D = i.useMemo(() => null == o ? void 0 : o.map(e => ({
    message: e,
    channel: a
  })), [o, a]);
  return (0, r.jsx)(H, {
