...
let O = function() {
  let {
    pathname: e
  } = (0, o.TH)(), [t, n] = (0, a.Wu)([f.Z], () => [f.Z.isEditorOpen, f.Z.isCoachmark]), O = (0, a.e7)([u.Z], () => u.Z.isEditorOpen), v = (0, a.e7)([m.Z], () => m.Z.getLayers().includes(b.S9g.USER_SETTINGS)), I = (0, a.e7)([g.default], () => E.ZP.canUseClientThemes(g.default.getCurrentUser())), S = t && !v, T = O && !v, A = [];
