...
let a = [0, 1, 2, 4, 6, 5];
var s = ((r = {})[r.TOGGLE_ENABLED = 0] = "TOGGLE_ENABLED", r[r.TOGGLE_DISABLED = 1] = "TOGGLE_DISABLED", r[r.PREVIEW = 2] = "PREVIEW", r[r.EDIT_DEFAULT_CHANNELS = 3] = "EDIT_DEFAULT_CHANNELS", r[r.EDIT_CUSTOMIZATION_QUESTIONS = 4] = "EDIT_CUSTOMIZATION_QUESTIONS", r[r.EDIT_HOME_SETTINGS = 5] = "EDIT_HOME_SETTINGS", r[r.EDIT_CONNECTIONS = 6] = "EDIT_CONNECTIONS", r);
