...
let L = Chunk73800.forwardRef(function(e, t) {
  ...
  return <s.ua7 text={n} position={"bottom"}>{e => {
...
function M() {
  ...
  return <L onClick={() => {
    ...
    }} tooltipText={module ? Chunk388032.intl.string(Chunk388032.t.vOFof3) : Chunk388032.intl.string(Chunk388032.t.Kt4gZ2)} icon={module ? Chunk481060.BlJ : Chunk481060.OyE} />
}
...
function D(e) {
  ...
  return null != l && null != a && (0, d.h)(l) ? <L onClick={c} tooltipText={T.intl.string(T.t.I3ltXF)} icon={s.WZu} /> : null
}
...
function I(e) {
  ...
  return <L onClick={a} tooltipText={T.intl.string("VIDEO" === t.type ? T.t.JVuuz8 : T.t["S/xNKS"])} loading={n} icon={s._8t} />
}
...
function N(e) {
  ...
  return <L onClick={() => {
    ...
    }} tooltipText={T.intl.string(T.t.q5jLJC)} icon={s.rgF} />
}
...
function Z(e) {
  ...
  let {
    ...
    return <s.sNh id={"media-viewer-details"} label={T.intl.string(T.t.sqBLa2)}>{a(d)}{c(T.intl.formatToPlainString(T.t.DTdonJ, {
        width: o,
        height: l,
        fileSize: p
      }))}{u(n)}</s.sNh>
  ...
  return <s.v2r navId={"image-menu"} aria-label={"placeholder"} onClose={a} onSelect={c}>{<s.kSQ>{o && <s.sNh label={T.intl.string(T.t.tvUqWl)} id={"media-viewer-copy-image"} icon={s.TIy} action={h} />}{l && <s.sNh id={"media-viewer-copy-link"} label={T.intl.string(T.t.WqhZsr)} icon={s.xPt} action={function() {
          var e;
...
function k(e) {
  ...
  return u || d || p || (null == (n = o.sourceMetadata) || null == (t = n.identifier) ? true : t.type) === "attachment" ? <s.yRy targetElementRef={l} shouldShow={a} align={"left"} position={"top"} spacing={18} onRequestClose={() => c(false)} animation={s.yRy.Animation.NONE} renderPopout={() => (0, r.jsx)(Z, {
      item: o,
      canCopyImage: d,
      canCopyLink: p,
      onClose: () => c(false)
...
let A = Chunk73800.memo(function(e) {
  ...
  return ("IMAGE" === t.type || !n) && <j.ZP mode={j.lx.FOCUS_SENSITIVE}>{e => (0, r.jsxs)("div", {
      ref: s,
