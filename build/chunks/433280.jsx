...
function m(e) {
  ...
  return (0, a.Z)({
    ...
    properties: {
  ...
  }), <div className={h.container}><s.ZP header={f.intl.string(f.t.C0m4ra)} content={f.intl.string(f.t.zOHfER)} asset={(0, r.jsx)("div", {
        className: h.image,
      ...
      })} buttonCTA={f.intl.string(f.t.OgQQbG)} onClick={() => {
        o.Z.open(t, p.pNK.ROLE_SUBSCRIPTIONS)
      }} secondaryButtonCTA={f.intl.string(f.t.WAI6xs)} markAsDismissed={n} /></div>
}