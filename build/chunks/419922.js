...
function P(e) {
  ...
  return y.NW.formatToPlainString(y.t.rk6pOz, {
    stickerName: t
  })
}
let R = e => {
  ...
  w = e => {
    ...
    return (l()(null != A, "Unable to determine sticker asset URL. Sticker ID: ".concat(a.id)), i.useEffect(() => {
      ...
      role: "img",
      className: d,
      "aria-label": S ? y.NW.string(y.t.yEvsKy) : P(a),
      ref: _,
      children: (0, r.jsx)(R, {
        hasError: S,
        isLoading: O,
  ...
  D = e => {
    let {
      ...
      fileUri: _
    } = e, [p, h] = i.useState(!1), [m, g] = i.useState(!0), [E, y] = i.useState(!1), S = i.useRef(null), T = i.useRef(null), N = null != _ ? _ : (0, b.Q6)(n, {
      isPreview: !t || !p || !o,
      size: s
    }), A = i.useCallback(() => {
      g(!1)
  ...
  x = e => {
    let {
      ...
      fileUri: p,
      onError: h
    } = e, b = (0, m.n)(), y = (0, g.t$)(t) && !n, v = i.useRef(null);
