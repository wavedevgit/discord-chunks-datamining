...
function h(e) {
  let {
    isActive: t,
    index: n
  } = e, i = (0, f.d)(t), s = (0, f.u)(t), l = o.useMemo(() => {
    let e = c.C[n];
    if (null == e) return [];
...
function C(e) {
  let {
    ...
    powerup: i,
    nextPowerup: s
  } = e, l = (0, u.Z)(t, i), c = (0, u.Z)(t, s), x = l.type !== _.A3.INACTIVE, v = c.type !== _.A3.INACTIVE, g = l.type === _.A3.TIER_OVERRIDE_ACTIVATED, [C, I] = o.useState(void 0);
  (0, m.KT)(C);
  let N = (0, f.d)(x);
  return (0, r.jsxs)(d.Z, {
    guildId: t,
