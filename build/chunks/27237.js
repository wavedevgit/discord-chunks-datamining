...
function E(e) {
  ...
  return t = n && !1 !== o ? "full" : n && !1 === o ? "half" : "none", (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)("div", {
      className: s()(b.progress, b[i], b[t])
    }), (0, r.jsx)("div", {
...
function h(e) {
  let {
    isActive: t,
    index: n
  } = e, i = (0, _.d)(t), s = (0, _.u)(t), l = o.useMemo(() => {
    let e = c.C[n];
    if (null == e) return [];
...
function C(e) {
  let {
    ...
    powerup: i,
    nextPowerup: s
  } = e, l = (0, u.Z)(t, i), c = (0, u.Z)(t, s), x = l.type !== f.A3.INACTIVE, v = c.type !== f.A3.INACTIVE, g = l.type === f.A3.TIER_OVERRIDE_ACTIVATED, [C, I] = o.useState(void 0);
  (0, m.KT)(C);
  let N = (0, _.d)(x);
  return (0, r.jsxs)(d.Z, {
    guildId: t,
