...
let b = [],
  j = function(e) {
    let {
      guildId: t
    } = e, n = (0, l.e7)([d.Z], () => d.Z.getGuild(t)), j = (0, l.Wu)([g.Z], () => {
      var e, t;
      return null != (t = null == (e = g.Z.getSettings().resourceChannels) ? void 0 : e.map(e => e.channelId)) ? t : b
    }), N = (0, l.Wu)([g.Z], () => g.Z.getDismissedSuggestedChannelIds(t)), _ = (0, l.e7)([c.ZP], () => c.ZP.getSelectableChannels(t)), v = i.useMemo(() => (0, s.chain)(_).filter(e => e.channel.type === h.d4z.GUILD_TEXT && e.channel.id !== (null == n ? void 0 : n.rulesChannelId) && !N.includes(e.channel.id) && !j.includes(e.channel.id) && u.Uu(h.Plq.VIEW_CHANNEL, e.channel) && !u.Uu(h.Plq.SEND_MESSAGES, e.channel)).take(5).value(), [_, N, null == n ? void 0 : n.rulesChannelId, j]), O = i.useCallback(() => {
      let e = v.map(e => e.channel.id);
      (0, m.q6)(t, e)
    }, [t, v]);
    return v.length <= 0 || j.length >= o.x3 ? null : (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(a.Text, {
          ...
          children: v.map((e, t) => (0, r.jsx)(p.Z, {
            channel: e.channel,
            end: t < v.length - 1
          }, e.channel.id))
        })]
