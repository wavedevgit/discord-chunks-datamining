...
let x = [],
  j = function(e) {
    ...
    }), N = (0, a.Wu)([g.Z], () => g.Z.getDismissedSuggestedChannelIds(t)), v = (0, a.e7)([c.ZP], () => c.ZP.getSelectableChannels(t)), _ = i.useMemo(() => (0, s.chain)(v).filter(e => e.channel.type === f.d4z.GUILD_TEXT && e.channel.id !== (null == n ? void 0 : n.rulesChannelId) && !N.includes(e.channel.id) && !j.includes(e.channel.id) && u.Uu(f.Plq.VIEW_CHANNEL, e.channel) && !u.Uu(f.Plq.SEND_MESSAGES, e.channel)).take(5).value(), [v, N, null == n ? void 0 : n.rulesChannelId, j]), y = i.useCallback(() => {
