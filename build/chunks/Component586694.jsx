...
function g(e) {
  let {
    ...
    width: (0, s.pxk)(n),
    height: (0, s.pxk)(n)
  }, S = (0, i.useId)(), P = y.size * u.hs, I = null != O && (0, r.jsxs)("svg", {
    width: P,
    height: P,
...
function b(e) {
  ...
  } = e, b = (0, i.useId)(), y = (0, i.useId)(), v = (0, d.UC)(n), j = v.size + u, C = v.size + m, E = _(v, u, m), x = O(v, u, m);
  return (0, r.jsx)(g, h(f({}, e), {
    ariaLabel: a,
    ariaHidden: l,
    specs: v,
    children: (0, r.jsxs)("svg", {
      ...
      }), null != s && (0, r.jsx)("foreignObject", h(f({}, x), {
        mask: "url(#".concat(y, ")"),
        children: (0, r.jsx)("img", {
          src: s,
          height: 16,
