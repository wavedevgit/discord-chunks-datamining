...
function g(e) {
  let {
    ...
    width: (0, s.pxk)(n),
    height: (0, s.pxk)(n)
  }, E = (0, i.useId)(), P = _.size * u.hs, I = null != O && (0, r.jsxs)("svg", {
    width: P,
    height: P,
...
function m(e) {
  ...
  return (0, r.jsx)(g, f(h({}, e), {
    ...
    children: (0, r.jsxs)("svg", {
      ...
      }), null != m && (0, r.jsx)("foreignObject", f(h({}, O(v, b, _)), {
        mask: "url(#".concat(c.QS.SQUIRCLE, ")"),
        children: (0, r.jsx)("img", {
          src: m,
          height: 16,
...
function b(e) {
  ...
  } = e, b = (0, i.useId)(), _ = (0, i.useId)(), v = (0, d.UC)(n), j = v.size + u, x = v.size + m, C = y(v, u, m), S = O(v, u, m);
  return (0, r.jsx)(g, f(h({}, e), {
    ariaLabel: a,
    ariaHidden: l,
    specs: v,
    children: (0, r.jsxs)("svg", {
      ...
      }), null != s && (0, r.jsx)("foreignObject", f(h({}, S), {
        mask: "url(#".concat(_, ")"),
        children: (0, r.jsx)("img", {
          src: s,
          height: 16,
