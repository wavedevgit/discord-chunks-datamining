...
function v(e) {
  ...
  }, n.addEventListener("keydown", g, true), n.addEventListener("keyup", g, true), n.addEventListener("click", b, true), t.addEventListener("focus", y, true), t.addEventListener("blur", O, false), "undefined" != typeof PointerEvent ? (n.addEventListener("pointerdown", E, true), n.addEventListener("pointermove", E, true), n.addEventListener("pointerup", E, true)) : (n.addEventListener("mousedown", E, true), n.addEventListener("mousemove", E, true), n.addEventListener("mouseup", E, true)), t.addEventListener("beforeunload", () => {
    I(e)
  }, {
    once: true
  }), d.set(t, {
