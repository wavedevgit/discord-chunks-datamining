...
function b(e) {
  ...
  return <div className={m.container}>{<f.Z otherUser={n} channel={b} active={t} />}{<div className={m.actions}>{<a.zxk variant={"secondary"} size={"sm"} text={g.intl.string(g.t.vicfl5)} onClick={e => {
          v(b.id), e.stopPropagation()
        }} disabled={T} loading={N} />}{<h.Z channel={b} />}</div>}</div>
}