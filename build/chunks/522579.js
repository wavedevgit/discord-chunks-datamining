/** Chunk was on web.js **/
/** chunk id: 522579, original params: e (module,exports,re quire) **/
var t = t || function(e) {
  "use strict";
    ...
    var t = e.document,
      ...
      m = function(t, c, f) {
        ...
        var m, g, E = this,
          ...
          A = function() {
            if (g && s && "u" > typeof FileReader) {
              ...
              return
            }(y || !m) && (m = n().createObjectURL(t)), g ? g.location.href = m : true === e.open(m, "_blank") && s && (e.location.href = m), E.readyState = E.DONE, O(), p(m)
          },
          v = function(e) {
            return function() {
        ...
        if (E.readyState = E.INIT, c || (c = "download"), i) {
          ...
          return
        }(e.chrome && b && b !== u && (t = (t.slice || t.webkitSlice).call(t, 0, t.size, u), y = true), o && "download" !== c && (c += ".download"), (b === u || o) && (g = e), l) ? (d += t.size, l(e.TEMPORARY, d, v(function(e) {
          e.root.getDirectory("saved", S, v(function(e) {
            var n = function() {
              e.getFile(c, S, v(function(e) {
...
module.exports ? module.exports.saveAs = t : "u" > typeof define && null !== define && null !== define.amd && define([], function() {
  return t
})