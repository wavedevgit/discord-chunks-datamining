...
class L extends _.Z {
  ...
  initialize(e) {
      ...
      i = (i, o) => {
        ...
        this.logger.info("Connected with local address ".concat(s, ":").concat(l, " and protocol: ").concat(a)), r(r => {
          ...
          this.logger.info("Experimental codecs: ".concat(JSON.stringify(i))), this.codecs = [{
            ...
            this.logger.info("Encryption modes: ".concat(r)), t.setTransportOptions(this.getConnectionTransportOptions()), t.setSelfMute(this.selfMute || this.context === O.Yn.STREAM), t.setSelfDeafen(this.selfDeaf), t.setOnSpeakingCallback(this.handleSpeakingNative), null == (i = t.setOnNativeMuteToggleCallback) || i.call(t, this.handleNativeMuteToggled), null == (o = t.setOnNativeMuteChangedCallback) || o.call(t, this.handleNativeMuteChanged), null == (c = t.setOnSpeakingWhileMutedCallback) || c.call(t, this.handleSpeakingWhileMuted), null == (u = t.setPingInterval) || u.call(t, O.$B), t.setPingCallback(this.handlePing), null == (d = t.setPingTimeoutCallback) || d.call(t, this.handlePingTimeout), null == (f = t.setOnVideoEncoderFallbackCallback) || f.call(t, this.handleVideoEncoderFallback), null == (_ = t.setOnRtcpMessageCallback) || _.call(t, this.handleRTCPMessage), n.setTransportOptions({
            ...
            }), n.setNoInputThreshold(-100), n.setNoInputCallback(this.handleNoInput), this.videoSupported && (t.setOnVideoCallback(this.handleVideo), null == (h = t.setOnFirstFrameCallback) || h.call(t, this.handleFirstFrame), null == (g = t.setOnDesktopSourceEnded) || g.call(t, this.handleDesktopSourceEnded), null == (E = t.setOnSoundshare) || E.call(t, this.handleSoundshare), null == (b = t.setOnSoundshareEnded) || b.call(t, this.handleSoundshareEnded), null == (y = t.setOnSoundshareFailed) || y.call(t, this.handleSoundshareFailed)), null == (p = t.setOnMLSFailureCallback) || p.call(t, this.handleMLSFailure), this.setConnectionState(O.$j.CONNECTED), this.emit(m.Sh.Connected, a, {
              address: s,
              port: l,
    ...
    if (null != n.createOwnStreamConnectionWithOptions) s = this.context === O.Yn.STREAM && this.streamUserId === this.userId ? n.createOwnStreamConnectionWithOptions : n.createVoiceConnectionWithOptions;
      ...
      var o, a, s, l = this.context === O.Yn.STREAM && this.streamUserId === this.userId ? n.createOwnStreamConnection : n.createVoiceConnection;
    ...
    null == (o = (t = this.conn = s(this.userId, e, i)).setSecureFramesStateUpdateCallback) || o.call(t, e => {
  ...
  setDesktopEncodingOptions(e, t, n) {
    ...
    let r = 0 === t && n >= 10 || t > 720 || n > 30 ? v.yf : v.YE,
      ...
      s = this.videoStreamParameters.findIndex(e => e.quality === v.y7); - 1 === s && (s = 0), a && (this.videoQualityManager.setGoliveQuality({
      capture: i,
      encode: i,
      bitrateMax: r
