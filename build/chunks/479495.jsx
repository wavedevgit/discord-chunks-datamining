...
class P extends(n = Chunk73800.PureComponent) {
  ...
  renderPasswordReset() {
    ...
    return <Chunk388905.ZP onSubmit={this.handleSubmit} tag={"form"} theme={Chunk120356} className={o}>{<img alt={""} src={null == Chunk593473 ? require("./26230.js") : require("./935227.js")} className={Chunk20493.marginBottom20} />}{<Chunk388905.Dx>{Chunk388032.intl.string(Chunk388032.t["1LV6Ki"])}</Chunk388905.Dx>}{<Chunk388905.gO className={Chunk20493.marginTop20}>{<Chunk388905.II label={Chunk388032.intl.string(Chunk388032.t["8dM4FB"])} className={Chunk20493.marginBottom20} name={"password"} value={module} onChange={e => this.setState({
            password: e
          })} error={Chunk593473} type={"password"} />}{<Chunk388905.zx type={"submit"} submitting={Chunk73800}>{Chunk388032.intl.string(Chunk388032.t["FRep5+"])}</Chunk388905.zx>}{n ? <Chunk388905.zx className={Chunk20493.marginTop8} onClick={this.handleGoToLogin} submitting={Chunk73800} color={Chunk388905.zx.Colors.PRIMARY}>{Chunk388032.intl.string(Chunk388032.t["ETE/oK"])}</Chunk388905.zx> : null}</Chunk388905.gO>}</Chunk388905.ZP>
  }
  renderMFA() {
    let {
      mfaTicket: e,
    ...
    return <Chunk388905.ZP style={{
        padding: 0
      }} theme={require} className={n}><Chunk124860.Cd mfaFinish={e => {
          let {
            mfaType: t,
            data: r
          } = e;
        ...
        }} width={null != Chunk73800 ? Chunk73800 : 480} /></Chunk388905.ZP>
  }
  renderSucceeded() {
    let {
      theme: e,
    ...
    return <Chunk388905.ZP theme={module} className={exports}>{<img alt={""} src={require("./26230.js")} className={o()(Chunk20493.marginBottom20, Chunk873546.tq ? Chunk20493.marginTop20 : "")} />}{<Chunk388905.Dx className={Chunk20493.marginBottom40}>{Chunk388032.intl.string(Chunk388032.t.WAUOoK)}</Chunk388905.Dx>}{<Chunk388905.zx onClick={this.handleOpenApp}>{Chunk388032.intl.string(Chunk388032.t.uJWIj4)}</Chunk388905.zx>}</Chunk388905.ZP>
  }
  render() {
