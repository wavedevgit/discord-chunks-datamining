...
function M() {
  ...
  return (0, r.jsxs)("svg", {
    ...
    children: [(0, r.jsx)("path", {
      ...
      "aria-label": P.NW.formatToPlainString(_.Z.HB1We3, {
        thanksHook: e => e.join()
      }),
      shouldShow: e,
      forceOpen: e,
...
function R() {
  let e = (0, c.e7)([p.default], () => p.default.locale),
    [t, n, s] = (0, c.Wu)([y.Z], () => [(0, f.m)((y.Z.endTime - y.Z.startTime) / 1e3), (0, h.u)(y.Z.getContributionsForItem(Z.yN.CLICKER_BUTTON), e), (0, h.u)(Math.floor(y.Z.lifetimePoints), e)], [e]),
    o = W({
      playTime: t,
      timesClicked: n,
      lifetimePoints: s
