...
function M() {
  ...
  return (0, r.jsxs)("svg", {
    ...
    children: [(0, r.jsx)("path", {
      ...
      "aria-label": C.intl.formatToPlainString(P.default.HB1We3, {
        thanksHook: e => e.join()
      }),
      shouldShow: e,
      forceOpen: e,
...
function T(e) {
  ...
  } = (0, d.ZP)(), [f, p] = (0, s.useState)(!1), h = (0, c.e7)([y.Z], () => y.Z.isRedeemingPrize), v = (0, c.e7)([m.default], () => m.default.getCurrentUser()), [N, R] = (0, c.Wu)([g.Z], () => [g.Z.isEntitledToSku(v, _.VU, _.oK), g.Z.isFetchingForApplication(_.oK)]);
