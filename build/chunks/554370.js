...
function ei(e) {
  ...
  "alt" !== e.key.toLowerCase() || t || ("keyup" === e.type.toLowerCase() ? S.S.dispatch(Y.CkL.OVERLAY_V3_SHOW_WIDGETS, {
    show: !0
  }) : "keydown" === e.type.toLowerCase() && S.S.dispatch(Y.CkL.OVERLAY_V3_SHOW_WIDGETS, {
    show: !1
  }))
}
...
function er(e) {
  ...
  return ! function(e, t) {
    ...
    if (S.S.dispatch(Y.CkL.OVERLAY_V3_SHOW_WIDGETS, {
        show: !0
      }), l) {
    ...
    value: L,
    children: N || f ? null : (0, i.jsx)(c.f6W, {
