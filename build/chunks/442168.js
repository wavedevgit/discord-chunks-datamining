...
function b(e) {
  let {
    ...
    reducedMotion: b
  } = l.useContext(o.Sf), y = (0, l.useRef)(null), O = d.n.getState().clipsButtonRef, Z = (0, f.V9)(t), j = (0, a.e7)([s.Z], () => s.Z.getActiveAnimation()), _ = (0, a.Wu)([s.Z], () => s.Z.getStreamClipAnimations(Z)), I = (0, l.useRef)(void 0);
  l.useEffect(() => () => {
    (0, c.Gh)(Z)
  }, [Z]);
  let w = () => {
