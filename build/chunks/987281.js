...
function _(e) {
  let {
    ...
    return (n = f ? T.NW.string(T.t.S5anIS) : u ? T.NW.string(T.t.q3O3Jy) : T.NW.string(T.t["7Xq/nZ"]), o || !f && u && (null == a ? void 0 : a.isGuildStageVoice())) ? null : (0, r.jsx)(i.sNh, {
      id: "watch",
      label: n,
      action: u ? function() {
        (0, s.g)((0, M.V9)(e))
    ...
    return n || !t || !a || (0, k.isWeb)() ? null : (0, r.jsxs)(i.kSQ, {
  ...
  }(t), q = (0, p.Z)(t, C, _), X = (0, b.Z)(t.channelId, t.ownerId), H = (0, g.Z)(t.channelId), K = (0, l.e7)([P.Z], () => P.Z.getChannel(t.channelId), [t.channelId]), $ = (0, h.G)({
    stream: t,
