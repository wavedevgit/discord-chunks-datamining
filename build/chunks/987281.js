...
function T(e) {
  let {
    ...
    return (n = f ? A.NW.string(A.t.S5anIS) : u ? A.NW.string(A.t.q3O3Jy) : A.NW.string(A.t["7Xq/nZ"]), o || !f && u && (null == a ? void 0 : a.isGuildStageVoice())) ? null : (0, r.jsx)(l.sNh, {
      id: "watch",
      label: n,
      action: u ? function() {
        (0, s.g)((0, k.V9)(e))
  ...
  }(t), z = (0, g.Z)(t, w, T), B = (0, f.Z)(t.channelId, t.ownerId), q = (0, d.Z)(t.channelId), H = (0, i.e7)([C.Z], () => C.Z.getChannel(t.channelId), [t.channelId]), X = (0, b.G)({
    stream: t,
