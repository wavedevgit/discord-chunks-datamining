...
function D(e) {
  let {
    ...
    return (n = f ? U.intl.string(U.t.S5anIS) : u ? U.intl.string(U.t.q3O3Jy) : U.intl.string(U.t["7Xq/nZ"]), o || !f && u && (null == a ? void 0 : a.isGuildStageVoice())) ? null : (0, r.jsx)(i.sNh, {
      id: "watch",
      label: n,
      action: u ? function() {
        (0, s.g)((0, V.V9)(e))
    ...
    return n || !t || !a || (0, A.isWeb)() ? null : (0, r.jsxs)(i.kSQ, {
