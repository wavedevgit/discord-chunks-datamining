...
function B(e) {
  ...
  let d = I.ZP.getApplicationIconURL({
    ...
    [f, _] = function() {
      return a !== l.z.CHANNEL_LINKED_LOBBY_EDUCATION_TOOLTIP ? [L.intl.string(L.t.XJVlf3), true] : [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(c.Text, {
          ...
          children: L.intl.format(L.t["16agur"], {
...
function Z(e) {
  let {
    ...
    prefix: E,
    level: b
  } = K(t.type, s), O = (0, r.jsxs)(r.Fragment, {
    children: [null != E ? (0, r.jsxs)(c.nn4, {
      children: [E, ":"]
    }) : null, " ", n]
  });
  switch (t.type) {
    ...
    case w.d4z.GROUP_DM:
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(c.nn4, {
          children: L.intl.string(L.t["e5y+go"])
        }), (0, r.jsx)(N.j, {
          channel: t
        }, "channel-".concat(t.id))]
      });
    ...
    case w.d4z.GUILD_MEDIA:
      return null != t.linkedLobby ? (0, r.jsxs)(B, {
        channel: t,
        children: [Y(g, t.type === w.d4z.GUILD_ANNOUNCEMENT ? L.intl.string(L.t.l1dkSE) : L.intl.string(L.t.Pnajj4)), (0, r.jsx)(R.Z.Title, {
          level: b,
          onContextMenu: d,
          onClick: u,
          children: O
    ...
    case w.d4z.GUILD_VOICE:
      return (0, r.jsxs)(i.Fragment, {
        children: [Y(g, L.intl.string(L.t.BVZqJi)), (0, r.jsx)(R.Z.Title, {
          level: b,
          onContextMenu: d,
          onClick: u,
          children: O
    ...
    case w.d4z.GUILD_STAGE_VOICE:
      return (0, r.jsxs)(i.Fragment, {
        children: [Y(g, L.intl.string(L.t.EErMzM)), (0, r.jsx)(R.Z.Title, {
          level: b,
          onContextMenu: d,
          onClick: u,
          children: O
    ...
    case w.d4z.PRIVATE_THREAD:
      ...
      if (!l && null != o) {
        ...
        I = (0, r.jsxs)(i.Fragment, {
          children: [Y(e, L.intl.string(L.t.Pnajj4)), (0, r.jsx)(R.Z.Title, {
            level: b,
            onContextMenu: h,
            onClick: p,
      ...
      return (0, r.jsxs)(i.Fragment, {
        children: [I, Y(T ? null : g, L.intl.string(L.t["7Xm5QE"])), (0, r.jsx)(R.Z.Title, {
          level: b,
          onContextMenu: d,
          onClick: u,
          className: a()({
    ...
    case w.d4z.GUILD_DIRECTORY:
      ...
      return (0, r.jsxs)(i.Fragment, {
        children: [null !== g ? (0, r.jsx)(R.Z.ChannelIcon, {
          icon: g,
          "aria-hidden": true
        }) : null, (0, r.jsxs)(R.Z.Title, {
          level: b,
          onContextMenu: d,
          onClick: u,
          children: [null != E ? (0, r.jsxs)(c.nn4, {
...
let V = e => {
  ...
  }, [o, a]), n.isDM() && (null == o ? true : o.isStaff()) && null != a) ? a.isStaff() ? (0, r.jsx)(d.Z, {
...
function Y(e, t) {
  return (0, r.jsxs)(r.Fragment, {
    children: [null !== e && (0, r.jsx)(R.Z.ChannelIcon, {
      icon: e,
      "aria-hidden": true
    }), (0, r.jsx)(c.nn4, {
      children: t
