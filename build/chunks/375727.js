...
let O = new o.Z("EmojiStudio"),
  j = e => {
    ...
    }), [N, I] = a.useState(null != n ? n : j), [D, S] = a.useState(null), [y, C] = a.useState(""), [w, A] = a.useState(null), M = async () => {
    ...
    }, k = a.useRef(0), R = a.useCallback(e => {
      let {
        imageData: t,
