...
let E = new u.Z("EmojiStudio"),
  N = e => {
    let {
      userImage: t,
      guildId: n
    } = e, [a, u] = l.useState(t), N = (0, i.e7)([d.Z, p.Z, h.Z], () => {
      let e = p.Z.getGuildId(),
        t = d.Z.getGuild(e);
      return h.Z.can(_.Plq.CREATE_GUILD_EXPRESSIONS, t) && null != t ? t.id : null
    }), [I, C] = l.useState(null != n ? n : N), [y, S] = l.useState(null), [w, A] = l.useState(""), [k, M] = l.useState(null), T = l.useCallback(async () => {
      ...
      children: [(0, r.jsx)(o.X6q, {
        ...
        children: [(0, r.jsxs)("p", {
          children: [(0, r.jsxs)("label", {
            htmlFor: "emoji_name",
            children: [O.intl.string(O.t.m0YV7O), " ", (0, r.jsx)("span", {
          ...
          children: [(0, r.jsx)("label", {
            children: O.intl.string(O.t["9uKafX"])
          }), (0, r.jsx)(x.q, {
            onChange: C,
            selected: I,
