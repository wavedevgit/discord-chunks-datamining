...
let S = new h.Z("EmojiStudio"),
  w = e => {
    ...
    }), [M, R] = l.useState(null != a ? a : k), [P, L] = l.useState(null), [Z, z] = l.useState(null), [G, U] = l.useState(""), [W, B] = l.useState(null), [F, H] = l.useState(() => Date.now()), V = l.useRef(0), J = l.useRef(0), Y = l.useRef(!1), K = l.useCallback(e => {
      let {
        reason: t
      } = e, n = null != P ? P : Z;
    ...
    let X = l.useCallback(async () => {
        ...
        K({
          reason: "uploaded"
        }), Y.current = !0, (0, c.Mr3)(b.Hj), (0, _.y)({
          emoji: e,
          guildId: M
        })
      }, [M, h, W, K, G]),
