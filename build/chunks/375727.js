...
let E = new u.Z("EmojiStudio"),
  I = e => {
    let {
      userImage: t,
      guildId: n
    } = e, [a, u] = l.useState(t), I = (0, s.e7)([d.Z, p.Z, h.Z], () => {
      let e = p.Z.getGuildId(),
        t = d.Z.getGuild(e);
      return h.Z.can(j.Plq.CREATE_GUILD_EXPRESSIONS, t) && null != t ? t.id : null
    }), [y, S] = l.useState(null != n ? n : I), [w, T] = l.useState(null), [A, M] = l.useState(""), [k, P] = l.useState(null), [R, L] = l.useState(!1), z = l.useCallback(async () => {
      ...
      children: [(0, r.jsx)(o.X6q, {
        ...
        children: [(0, r.jsx)(o.xJW, {
          ...
          children: (0, r.jsxs)("div", {
            ...
            }), w === m.ze.NO_PERMISSIONS && (0, r.jsx)(x.H, {
              error: w,
              color: "text-tertiary"
            })]
          })
          ...
          className: N.foot,
          children: [null != w && w !== m.ze.NO_PERMISSIONS && (0, r.jsx)(x.H, {
            error: w
          }), (0, r.jsx)(o.zxk, {
            className: N.submit,
            onClick: z,
