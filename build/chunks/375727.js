...
let I = new d.Z("EmojiStudio"),
  D = e => {
    let {
      userImage: t,
      guildId: n
    } = e, [a, d] = l.useState(t), D = (0, s.e7)([h.Z, g.Z, m.Z], () => {
      let e = g.Z.getGuildId(),
        t = h.Z.getGuild(e);
      return m.Z.can(O.Plq.CREATE_GUILD_EXPRESSIONS, t) && null != t ? t.id : null
    }), [S, w] = l.useState(null != n ? n : D), [T, A] = l.useState(null), [M, k] = l.useState(null), [P, R] = l.useState(""), [L, Z] = l.useState(null), [z, G] = l.useState(!1), U = l.useCallback(async () => {
      ...
      children: [(0, r.jsx)(c.X6q, {
        ...
        children: [(0, r.jsx)(c.xJW, {
          ...
          children: [(0, r.jsx)("label", {
            children: N.intl.string(N.t.JmuIb2)
          }), (0, r.jsxs)("ul", {
            children: [(0, r.jsx)("li", {
              children: (0, r.jsxs)("div", {
  ...
  y = e => {
    ...
    return null == t || "" === t ? (0, r.jsx)("div", {
      className: E.previewPlaceholder
    }) : (0, r.jsx)("img", {
      src: t,
      alt: n
    })
