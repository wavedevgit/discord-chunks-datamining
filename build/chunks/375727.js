...
let E = new u.Z("EmojiStudio"),
  I = e => {
    let {
      userImage: t,
      guildId: n
    } = e, [a, u] = l.useState(t), I = (0, s.e7)([d.Z, m.Z, h.Z], () => {
      let e = m.Z.getGuildId(),
        t = d.Z.getGuild(e);
      return h.Z.can(j.Plq.CREATE_GUILD_EXPRESSIONS, t) && null != t ? t.id : null
    }), [y, S] = l.useState(null != n ? n : I), [w, T] = l.useState(null), [A, k] = l.useState(null), [M, P] = l.useState(""), [R, L] = l.useState(null), [Z, z] = l.useState(!1), G = l.useCallback(async () => {
      if (T(null), null == y) return void T(p.ze.MISSING_GUILD);
      if (null == a || (null == a ? void 0 : a.file) == null || null == R) return void T(p.ze.MISSING_IMAGE_DATA);
      let e = null;
      try {
        e = await (0, c.rS)({
          image: R,
      ...
      children: [(0, r.jsx)(o.X6q, {
        ...
        children: [(0, r.jsx)(o.xJW, {
          ...
          children: [(0, r.jsx)("label", {
            children: O.intl.string(O.t.JmuIb2)
          }), (0, r.jsxs)("ul", {
            children: [(0, r.jsx)("li", {
              children: (0, r.jsxs)("div", {
          ...
          children: [null != w && (0, r.jsx)(x.H, {
            ...
            onClick: G,
            fullWidth: !0,
            disabled: null == a || null == y || M.length < 2 || null != A,
  ...
  C = e => {
    ...
    return null == t || "" === t ? (0, r.jsx)("div", {
      className: N.previewPlaceholder
    }) : (0, r.jsx)("img", {
      src: t,
      alt: n
    })
