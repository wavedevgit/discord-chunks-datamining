...
function el(e) {
  ...
  let eS = !eu && null == em && null == ep,
    ...
    ej = H.ZP.hasBoostDiscount(G, el.fractionalState) && null != x && H.ZP.getPremiumType(x.planId) === Q.p9.TIER_2 ? ee.intl.format(ee.t.hf6YOT, {
