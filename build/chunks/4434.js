...
function er(e) {
  ...
  let {
    ...
    priceOptions: g
  } = e, Z = (0, b.Z)(), E = l.interval, _ = l.intervalCount, C = (0, u.e7)([k.Z], () => k.Z.getForSkuAndInterval((0, F.Wz)(J.Si.GUILD), E, _)), R = (0, u.e7)([A.default], () => A.default.getCurrentUser()), L = (0, u.e7)([U.Z], () => U.Z.getGuild(r), [r]), M = (0, y.Z)({
    forceFetch: !1
  });
  ...
  let el = null == x ? void 0 : x.items.find(e => e.planId === J.Xh.PREMIUM_MONTH_GUILD || e.planId === J.Xh.PREMIUM_YEAR_GUILD),
    ...
    ef = F.ZP.hasBoostDiscount(R, M.fractionalState) && null != x && F.ZP.getPremiumType(x.planId) === J.p9.TIER_2 ? z.NW.format(z.t.hf6YOT, {
      planName: F.ZP.getDisplayPremiumType(x.planId)
    ...
    children: [eg && (0, i.jsx)(W.n, {
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: ed ? (0, i.jsx)(m.$jN, {}) : eI ? (0, H.T4)(ex.amount, ex.currency) : function(e) {
          ...
          return i === J.rV.YEAR ? z.NW.formatToPlainString(z.t["8M04YG"], {
            price: l
          }) : i === J.rV.MONTH && 1 === r ? z.NW.formatToPlainString(z.t.VStWCQ, {
            price: l
          }) : i === J.rV.MONTH && r > 1 ? z.NW.formatToPlainString(z.t.xJvAFR, {
            price: l
          }) : null
        }({
          intervalType: E,
      ...
      message: z.NW.format(z.t.Om31w8, {
        documentationLink: K.Z.getArticleURL($.BhN.LOCALIZED_PRICING)
      })
...
function el(e) {
  let {
    ...
    priceOptions: a
  } = e, s = t.interval, o = t.intervalCount, d = (0, u.e7)([k.Z], () => k.Z.getForSkuAndInterval((0, F.Wz)(J.Si.GUILD), s, o));
      ...
      children: [(0, i.jsx)(Z.q9, {
        ...
        label: (0, i.jsx)(R.As, {
          label: z.NW.formatToPlainString(z.t.ZSVgeX, {
            planName: (0, F.aq)(P[0].subscriptionPlanId)
          }),
