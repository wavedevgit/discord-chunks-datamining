...
function E(e) {
  ...
  let [u, E] = n.useState(null), [b, y] = n.useState(false), A = (0, a.bG)([f.A], () => f.A.getSecureFramesRosterMapEntry(t)), p = (0, a.bG)([f.A], () => f.A.getSecureFramesRosterMapEntry(r)), g = n.useCallback(e => {
    E(l.fromByteArray(e)), y(false)
