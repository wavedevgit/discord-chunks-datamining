...
function b(e) {
  let {
    userId: t
  } = e, r = (0, i.bG)([s.default], () => s.default.getId());
  a()(r !== t, "[useSecureFramesPairwiseFingerprint] Should not pass current user id.");
  let [u, b] = n.useState(null), [E, y] = n.useState(false), A = (0, i.bG)([f.A], () => f.A.getSecureFramesRosterMapEntry(t)), p = (0, i.bG)([f.A], () => f.A.getSecureFramesRosterMapEntry(r)), g = n.useCallback(e => {
  ...
  return n.useEffect(() => {
    null != A && null != p && null == m.current && (y(true), m.current = setTimeout(() => O(r, p, t, A), 0));
    let e = m.current;
    return () => {
