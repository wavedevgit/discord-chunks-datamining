...
function T(e) {
  let {
    ...
    let e = (0, j.vd)(null == t ? true : t.features.has(E.GuildFeatures.COMMUNITY)).map(e => C(I({}, e), {
...
function P(e) {
  let {
    ...
    let e = (0, j.QL)(null == t ? true : t.features.has(E.GuildFeatures.COMMUNITY)).map(e => C(I({}, e), {
      tooltipPosition: "left"
    }));
    return (0, j.w3)(e)
