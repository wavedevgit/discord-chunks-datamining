...
function N(e) {
  let n = (0, r.ZA)(e),
    t = (0, r.yN)(e),
    c = n.preset === d.s8.CUSTOM && !t.inherited,
    [g, u] = a.useState(c),
    [S, p] = a.useState(false),
    N = S ? d.s8.CUSTOM : n.preset,
    E = L(e, () => p(false)),
  ...
  return e.type === h.d4z.GUILD_STAGE_VOICE ? (0, i.jsxs)(_.kSQ, {
    ...
    children: [e.isForumLikeChannel() ? (0, i.jsxs)(i.Fragment, {
      children: [(0, i.jsx)(_.S89, {
        ...
        checked: m,
        action: () => s.Z.setForumThreadsCreated(e, !m)
      }), (0, i.jsx)(_.Clw, {})]
    }) : null, (0, i.jsxs)(_.kSQ, {
      children: [(0, i.jsx)(_.k5B, {
        id: "cns_default",
        ...
        action: () => ((0, r.JK)(e.guild_id, e.id), p(false))
      }), (0, i.jsx)(_.k5B, {
        id: "cns_everything",
        group: "channel_notification_settings",
        label: b.intl.string(b.t.hZrr6u),
        checked: !t.inherited && N === d.s8.ALL_MESSAGES,
        action: () => ((0, r._m)(e.guild_id, e.id, d.s8.ALL_MESSAGES), p(false))
      }), (0, i.jsx)(_.k5B, {
        id: "cns_essentials",
        group: "channel_notification_settings",
        label: b.intl.string(b.t.y59NJi),
        checked: !t.inherited && N === d.s8.MENTIONS,
        action: () => ((0, r._m)(e.guild_id, e.id, d.s8.MENTIONS), p(false))
      }), (0, i.jsx)(_.k5B, {
        id: "cns_nothing",
        group: "channel_notification_settings",
        label: b.intl.string(b.t["pGn/bG"]),
        checked: !t.inherited && N === d.s8.NOTHING,
        action: () => ((0, r._m)(e.guild_id, e.id, d.s8.NOTHING), p(false))
      }), (0, i.jsx)(_.k5B, {
        id: "cns_custom",
        group: "channel_notification_settings",
        label: b.intl.string(b.t["32yow8"]),
        checked: S || !t.inherited && N === d.s8.CUSTOM,
        action: () => (u(true), p(true))
      })]
    }), (g || c) && E]
  })
}
...
function L(e, n) {
  let {
    ...
    n === h.bL.ALL_MESSAGES && a !== u.i.ALL_MESSAGES && (t.flags = (0, c.pq)(l.ZP.getChannelIdFlags(e.guild_id, e.id), S.ic.UNREADS_ALL_MESSAGES)), s.Z.updateChannelOverrideSettings(e.guild_id, e.id, t, g.UE.notifications(n))
  };
  return (0, i.jsxs)(_.kSQ, {
    children: [(0, i.jsxs)(_.sNh, {
      ...
      children: [(0, i.jsx)(_.k5B, {
        ...
        action: () => o(() => (0, r.IG)(e.guild_id, e.id, u.i.ALL_MESSAGES))
      }), (0, i.jsx)(_.k5B, {
        ...
        action: () => o(() => (0, r.IG)(e.guild_id, e.id, u.i.ONLY_MENTIONS))
      })]
