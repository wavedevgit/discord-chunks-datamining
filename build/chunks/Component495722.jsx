...
function G(e) {
  ...
  let {
    ...
    onGameSheetOpened: x,
    onGameSheetClosed: b
  } = e, C = (null == (t = n.userStatus) ? true : t.completedAt) != null, y = o.percentComplete > 0, E = (0, S.z)(n), [O, T, w] = (0, S.me)(n, o), P = s.useRef(null), M = s.useRef(null), H = (0, S._s)({
    quest: n
  }), U = (0, v.q8)(n), F = (0, S.Jf)(n), z = s.useCallback(() => {
