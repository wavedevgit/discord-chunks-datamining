...
let g = (e, t, n, r) => {
  ...
  E = function(e) {
    ...
    if (O) {
      ...
      if (null != s && (null == S ? void 0 : S.subscriptionPeriodEnd) != null) U = h.intl.format(h.t["2VPTa2"], {
        subtotalRate: E
      });
      else switch (t) {
        case p.rV.MONTH:
        ...
        v || (e = g(R, t, n, b.id)), U = (null == w ? void 0 : w.isPausedAllowsResumeButNotUpdates) ? h.intl.format(h.t.B6oNwM, {
          primaryText: r,
          rate: e,
          paidURL: f.EYA.PAID_TERMS,
