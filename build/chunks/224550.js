...
let m = function(e) {
  ...
  if (y) M = p.NW.format(p.t.rr811N, {
    ...
    if (null != m && (null == I ? void 0 : I.subscriptionPeriodEnd) != null) M = p.NW.format(p.t["2VPTa2"], {
      subtotalRate: g
    });
    else switch (t) {
      case _.rV.MONTH:
    ...
    M = (null == R ? void 0 : R.isPausedAllowsResumeButNotUpdates) ? p.NW.format(p.t.B6oNwM, {
      primaryText: r,
      rate: e,
      paidURL: f.EYA.PAID_TERMS,
