...
let g = (e, t, n, r) => {
  ...
  E = function(e) {
    ...
    if (v) {
      ...
      if (null != s && (null == T ? void 0 : T.subscriptionPeriodEnd) != null) U = h.intl.format(h.t["2VPTa2"], {
        subtotalRate: E
      });
      else switch (t) {
        case p.rV.MONTH:
        ...
        O || (e = g(R, t, n, b.id)), U = (null == P ? void 0 : P.isPausedAllowsResumeButNotUpdates) ? h.intl.format(h.t.B6oNwM, {
          primaryText: r,
          rate: e,
          paidURL: f.EYA.PAID_TERMS,
          contactLink: f.EYA.CONTACT,
          helpdeskArticle: l.Z.getArticleURL(f.BhN.BILLING)
        }) : null != P && (0, d.GY)(P, b.id, x) ? h.intl.format(h.t.LyBQUV, {
          primaryText: r,
          rate: e,
          paidURL: f.EYA.PAID_TERMS,
          contactLink: f.EYA.CONTACT,
