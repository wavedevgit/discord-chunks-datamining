    ...
    if (O) {
      ...
      if (null != s && (null == S ? void 0 : S.subscriptionPeriodEnd) != null) j = h.NW.format(h.t["2VPTa2"], {
        ...
        case f.POd.COLLECTIBLES:
          U = M, j = y ? h.NW.format(h.t.ofqyUl, {
            paidURL: f.EYA.PAID_TERMS
        ...
        case p.rV.MONTH:
          j = y ? h.NW.string(h.t.IjNapq) : h.NW.string(h.t["/sGXPj"]), j = y ? h.NW.string(h.t.IjNapq) : 1 === n ? h.NW.string(h.t["/sGXPj"]) : h.NW.formatToPlainString(h.t.Fqjiho, {
            intervalCount: n
          });
          break;
        case p.rV.YEAR:
