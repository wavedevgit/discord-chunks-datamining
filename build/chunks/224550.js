...
let g = (e, t, n, r) => {
  ...
  E = function(e) {
    ...
    if (O) {
      ...
      if (null != s && (null == S ? void 0 : S.subscriptionPeriodEnd) != null) j = h.NW.format(h.t["2VPTa2"], {
        subtotalRate: E
      });
      else switch (t) {
        case p.rV.MONTH:
          j = 1 === n ? h.NW.format(h.t["+ywPmZ"], {}) : h.NW.format(h.t.oBwZfn, {
            intervalCount: n
          });
          break;
        case p.rV.YEAR:
      ...
      case f.POd.COLLECTIBLES:
        U = M, j = v ? h.NW.format(h.t.ofqyUl, {
          paidURL: f.EYA.PAID_TERMS
        }) : h.NW.format(h.t.G3l0s7, {
          paidURL: f.EYA.PAID_TERMS
        });
        break;
      case f.POd.GUILD_PRODUCT:
        U = M, j = h.NW.format(h.t["GEAQ+v"], {
          paidURL: f.EYA.PAID_TERMS
        });
        break;
      default:
        U = k, j = h.NW.string(h.t["9/siSU"])
    } else if (null == b || v) switch (v && (U = M), t) {
      case p.rV.MONTH:
        j = v ? h.NW.string(h.t.IjNapq) : h.NW.string(h.t["/sGXPj"]), j = v ? h.NW.string(h.t.IjNapq) : 1 === n ? h.NW.string(h.t["/sGXPj"]) : h.NW.formatToPlainString(h.t.Fqjiho, {
          intervalCount: n
        });
        break;
      case p.rV.YEAR:
      ...
      y || (e = g(R, t, n, b.id)), j = (null == P ? void 0 : P.isPausedAllowsResumeButNotUpdates) ? h.NW.format(h.t.B6oNwM, {
        primaryText: r,
        rate: e,
        paidURL: f.EYA.PAID_TERMS,
