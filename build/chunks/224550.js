...
let g = (e, t, n, r) => {
  ...
  E = function(e) {
    ...
    if (O) {
      ...
      if (null != s && (null == S ? void 0 : S.subscriptionPeriodEnd) != null) j = h.intl.format(h.t["2VPTa2"], {
        subtotalRate: E
      });
      else switch (t) {
        case p.rV.MONTH:
          j = 1 === n ? h.intl.format(h.t["+ywPmZ"], {}) : h.intl.format(h.t.oBwZfn, {
            intervalCount: n
          });
          break;
        case p.rV.YEAR:
        ...
        case f.POd.COLLECTIBLES:
          U = M, j = y ? h.intl.format(h.t.ofqyUl, {
            paidURL: f.EYA.PAID_TERMS
        ...
        case f.POd.GUILD_PRODUCT:
          U = M, j = h.intl.format(h.t["GEAQ+v"], {
            paidURL: f.EYA.PAID_TERMS
          });
          break;
        default:
          U = k, j = h.intl.string(h.t["9/siSU"])
      } else if (null == b || y) switch (y && (U = M), t) {
        case p.rV.MONTH:
          j = y ? h.intl.string(h.t.IjNapq) : h.intl.string(h.t["/sGXPj"]), j = y ? h.intl.string(h.t.IjNapq) : 1 === n ? h.intl.string(h.t["/sGXPj"]) : h.intl.formatToPlainString(h.t.Fqjiho, {
            intervalCount: n
          });
          break;
        case p.rV.YEAR:
        ...
        v || (e = g(R, t, n, b.id)), j = (null == P ? void 0 : P.isPausedAllowsResumeButNotUpdates) ? h.intl.format(h.t.B6oNwM, {
          primaryText: r,
          rate: e,
          paidURL: f.EYA.PAID_TERMS,
          contactLink: f.EYA.CONTACT,
          helpdeskArticle: l.Z.getArticleURL(f.BhN.BILLING)
        }) : null != P && (0, d.GY)(P, b.id, L) ? h.intl.format(h.t.LyBQUV, {
          primaryText: r,
          rate: e,
          paidURL: f.EYA.PAID_TERMS,
          contactLink: f.EYA.CONTACT,
          helpdeskArticle: l.Z.getArticleURL(f.BhN.BILLING)
        }) : D && C === f.POd.BOOST && null != R ? h.intl.format(h.t["2nKy//"], {
