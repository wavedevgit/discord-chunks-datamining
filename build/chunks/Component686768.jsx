...
let _ = function(t) {
  let {
    ...
    isRetry: true
  }), h = r.useMemo(() => (0, o.Z)(), []), y = (0, p.W)("age_verification_retry_modal"), v = (0, f.d)("age_verification_retry_modal");
  r.useEffect(() => {
    ...
    children: (0, i.jsxs)(s.Kqy, {
      ...
      children: [(0, i.jsx)(s.Wn, {
        ...
        children: b.intl.format(b.t["L+FgkZ"], {
          handleOnHelpUrlHook: () => {
            c.Z.openUrl(d.Z.getArticleURL(x.BhN.TIGGER_PAWTECT_LEARN_MORE)), (0, u.x3)(h, u.d_.RETRY, u.sU.LEARN_MORE)
          }
        })
      })]
    })
