...
function x(e) {
  ...
  for (let t of new Set([...i, ...a])) r = T(e.guildId).updateVoiceState(t) || r;
...
class V extends(r = o.ZP.Store) {
  initialize() {
    B(), this.waitFor(u.default, f.default, _.ZP, p.Z), this.syncWith([f.default], k)
  }
  getVoiceStates(e) {
