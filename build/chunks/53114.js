...
class y extends o.Z {
  ...
  getStats(e) {
    ...
    return e instanceof _.nt ? (b.sender_freeze_count = P, b.sender_total_freezes_duration = L, b.sender_total_frames_duration = x) : (b.receiver_freeze_count = P, b.receiver_total_freezes_duration = L, b.receiver_total_frames_duration = x, b.receiver_pause_count = R, b.receiver_total_pauses_duration = D), g(h({}, b), {
  ...
  receivedStats(e, t, n) {
    ...
    t.rtp.outbound.filter(e => "video" === e.type).forEach(t => {
      ...
      if (null != r) {
        ...
        var i, a, o, c, u, f, p, m, E, b, y, O, v = !0;
