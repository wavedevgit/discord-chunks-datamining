...
class y extends a.Z {
  ...
  getStats(e) {
    ...
    return e instanceof _.nt ? (E.sender_freeze_count = P, E.sender_total_freezes_duration = D, E.sender_total_frames_duration = L) : (E.receiver_freeze_count = P, E.receiver_total_freezes_duration = D, E.receiver_total_frames_duration = L, E.receiver_pause_count = R, E.receiver_total_pauses_duration = w), m(p({}, E), {
  ...
  receivedStats(e, t, n) {
    ...
    t.rtp.outbound.filter(e => "video" === e.type).forEach(t => {
      ...
      if (null != r) {
        ...
        var i, a, l, c, d, f, h, g, E, b, y, O, v = !0;
  ...
  constructor(e, t = s.Z_) {
    super(), f(this, "connection", void 0), f(this, "timestampProducer", void 0), f(this, "networkQuality", void 0), f(this, "paused", void 0), f(this, "pausedCount", void 0), f(this, "zeroReceivers", void 0), f(this, "videoStopped", void 0), f(this, "videoEffectDuration", void 0), f(this, "hqSimulcastStreamEncoded", void 0), f(this, "lqSimulcastStreamEncoded", void 0), f(this, "bothSimulcastStreamsEncoded", void 0), f(this, "hqSimulcastStreamWatched", void 0), f(this, "lqSimulcastStreamWatched", void 0), f(this, "hqSimulcastStreamEligible", void 0), f(this, "lqSimulcastStreamEligible", void 0), f(this, "simulcastQualityChanges", void 0), f(this, "cameraToggles", void 0), f(this, "callUserIdsCount", void 0), f(this, "cameraDuration", void 0), f(this, "cameraOpportunityDuration", void 0), f(this, "cameraSendDuration", void 0), f(this, "windowOccluded", void 0), f(this, "videoStoppedForOcclusion", void 0), f(this, "numWindowOcclusionChanges", void 0), f(this, "outboundStats", void 0), f(this, "inboundStats", void 0), f(this, "streamStart", void 0), f(this, "streamEnd", void 0), f(this, "symmetricCodecUpdates", void 0), f(this, "asymmetricCodecUpdates", void 0), f(this, "bandwidthLimitedFramerate", void 0), f(this, "bandwidthLimitedResolution", void 0), f(this, "videoEntropy", void 0), f(this, "statCollectionPausedUsers", void 0), f(this, "sampleStats", void 0), this.connection = e, this.timestampProducer = t, this.networkQuality = new d.Z, this.pausedCount = 0, this.simulcastQualityChanges = 0, this.cameraToggles = 0, this.callUserIdsCount = 0, this.numWindowOcclusionChanges = 0, this.outboundStats = {}, this.inboundStats = {}, this.symmetricCodecUpdates = 0, this.asymmetricCodecUpdates = 0, this.statCollectionPausedUsers = new Set, this.sampleStats = e => {
      if (null == e) return;
    ...
    }, this.paused = new s.sX(!1, t), this.zeroReceivers = new s.sX(!1, t), this.videoStopped = new s.sX(!1, t), this.videoEffectDuration = new s.sX(!1, t), this.hqSimulcastStreamEncoded = new s.sX(!1, t), this.lqSimulcastStreamEncoded = new s.sX(!1, t), this.bothSimulcastStreamsEncoded = new s.sX(!1, t), this.hqSimulcastStreamWatched = new s.sX(!1, t), this.lqSimulcastStreamWatched = new s.sX(!1, t), this.hqSimulcastStreamEligible = new s.sX(!1, t), this.lqSimulcastStreamEligible = new s.sX(!1, t), this.windowOccluded = new s.sX(!1, t), this.videoStoppedForOcclusion = new s.sX(!1, t), this.bandwidthLimitedFramerate = new s.sX(!1, t), this.bandwidthLimitedResolution = new s.sX(!1, t), this.cameraDuration = new s.sX(!1, t), this.cameraOpportunityDuration = new s.sX(!1, t), this.cameraSendDuration = new s.sX(!1, t), this.videoEntropy = new u.b
  }
}