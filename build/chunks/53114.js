...
class y extends o.Z {
  ...
  getStats(e) {
    ...
    return e instanceof f.nt ? (E.sender_freeze_count = P, E.sender_total_freezes_duration = w, E.sender_total_frames_duration = L) : (E.receiver_freeze_count = P, E.receiver_total_freezes_duration = w, E.receiver_total_frames_duration = L, E.receiver_pause_count = R, E.receiver_total_pauses_duration = D), m(_({}, E), {
