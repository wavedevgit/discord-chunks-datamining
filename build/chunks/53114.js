...
class y extends o.Z {
  ...
  getStats(e) {
    ...
    return e instanceof f.nt ? (b.sender_freeze_count = w, b.sender_total_freezes_duration = L, b.sender_total_frames_duration = x) : (b.receiver_freeze_count = w, b.receiver_total_freezes_duration = L, b.receiver_total_frames_duration = x, b.receiver_pause_count = P, b.receiver_total_pauses_duration = D), g(h({}, b), {
  ...
  receivedStats(e, t, n) {
    ...
    t.rtp.outbound.filter(e => "video" === e.type).forEach(t => {
      ...
      if (null != r) {
        ...
        var i, a, o, c, u, _, p, m, E, b, y, O, v = !0;
