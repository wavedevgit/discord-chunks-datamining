...
let ec = new ea(a.Z, {
  ...
  MESSAGE_CREATE: function(e) {
    ...
    let {
      channelId: r,
      message: s
    } = e, l = N.Z.getChannel(r), a = A.default.getUser(null == (t = s.author) ? void 0 : t.id);
  ...
  ACTIVITY_USER_ACTION: function(e) {
    let t, {
      ...
      o = G.Z.getGame();
    return null != o && o.id === r && (n === F.mFx.JOIN && (t = (0, u.Z)(i, o)), null != t && void es(t, {
      priority: 2,
      type: 0
    }))
  },
  ...
  OVERLAY_CONTENT_INVENTORY_READY: function(e) {
    ...
    if (!r) return;
    let s = n;
    null != o && (s = s.filter(e => B.default.age(e.id) < o)), 0 !== s.length && es((0, g.Z)(i, s), {
      priority: 2,
