...
let el = new eo(a.Z, {
  ...
  MESSAGE_CREATE: function(e) {
    ...
    let {
      channelId: r,
      message: l
    } = e, s = I.Z.getChannel(r), a = k.default.getUser(null == (t = l.author) ? void 0 : t.id);
    ...
    if ((!L.default.isInstanceLocked() || L.default.isPinned(U.Odu.TEXT)) && r === N.Z.getChannelId() || x.Z.isNotificationDisabled(b.OverlayNotificationDisabledSetting.TEXT_CHAT) || D.Z.disableNotifications || !(0, _.eF)(l, r)) return !1;
  ...
  ACTIVITY_USER_ACTION: function(e) {
    let t, {
      ...
      o = W.Z.getGame();
    return null != o && o.id === r && (n === U.mFx.JOIN && (t = (0, u.Z)(i, o)), null != t && void ei(t, {
      priority: 2,
      type: 0
    }))
  },
  ...
  CLIPS_SAVE_CLIP: function() {
    ei((0, v.f)(G.intl.formatToPlainString(G.t.KLhk6u, {
      duration: (0, z.A)(O.Z.getSettings().clipsLength / 1e3, !0)
    })))
  },
