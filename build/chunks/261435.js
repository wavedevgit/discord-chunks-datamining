...
function el(e) {
  ...
  if (null == r || !r.isRingable() || "GUILD_RING_START" === e.type && !I.Z.getCurrentConfig({
    ...
    }).enabled || k.Z.getStatus() === G.Skl.DND || C.QZ.getSetting()) return !1;
...
let ec = new ea(a.Z, {
  ...
  ACTIVITY_USER_ACTION: function(e) {
    let t, {
      ...
      s = F.Z.getGame();
    return null != s && s.id === r && (n === G.mFx.JOIN && (t = (0, d.Z)(i, s)), null != t && void eo(t, {
      priority: 2,
      type: 0
    }))
  },
  ...
  CLIPS_SAVE_CLIP: function() {
    eo((0, x.f)(Y.NW.formatToPlainString(Y.t.KLhk6u, {
      duration: (0, V.A)(v.Z.getSettings().clipsLength / 1e3, !0)
    })))
  },
