...
function V(e) {
  ...
  (null == e ? void 0 : e.refreshThreadIds) && (P = Object.values(d.Z.getThreadsForParent(t.guild_id, t.id)).map(e => {
    ...
    return t
  }), A = 0, R = !0), 0 !== L.size && (P = P.filter(e => !L.has(e)), L.clear()), 0 !== x.size && (P = Array.from(new Set([...P, ...x])), x.clear()), ((null == e ? void 0 : e.refreshThreadIds) || (null == e ? void 0 : e.sortThreadIds)) && (D = a().chain(P).sort(j(l.z.LATEST_ACTIVITY)), w = a().chain(P).sort(j(l.z.CREATION_DATE)));
