...
function B(e) {
  ...
  (null == e ? void 0 : e.refreshThreadIds) && (C = Object.values(u.Z.getThreadsForParent(t.guild_id, t.id)).map(e => {
    ...
    return t
  }), T = 0, A = !0), 0 !== w.size && (C = C.filter(e => !w.has(e)), w.clear()), 0 !== D.size && (C = Array.from(new Set([...C, ...D])), D.clear()), ((null == e ? void 0 : e.refreshThreadIds) || (null == e ? void 0 : e.sortThreadIds)) && (R = a().chain(C).sort(M(s.z.LATEST_ACTIVITY)), P = a().chain(C).sort(M(s.z.CREATION_DATE)));
