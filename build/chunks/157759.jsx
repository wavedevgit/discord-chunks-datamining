...
let h = e => {
  ...
  return null != t && null != y && h && C ? <u.ZP title={b.intl.string(b.t["WV/CsL"])} description={b.intl.string(b.t["FlcC+/"])} buttonText={v ? b.intl.string(b.t.aCJlq6) : b.intl.string(b.t["6I1F3t"])} buttonDisabled={!v} buttonColor={v ? a.zx.Colors.RED : a.zx.Colors.WHITE} buttonLook={v ? a.zx.Looks.FILLED : a.zx.Looks.LINK} onButtonPress={I} /> : null
}