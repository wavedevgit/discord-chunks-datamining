...
function Z(n) {
  ...
  let {
    ...
    transitionState: Z,
    guildId: E
  } = n, m = (0, r.e7)([c.default], () => c.default.getId()), R = (0, r.e7)([_.ZP], () => _.ZP.getMember(E, m), [E, m]), O = (0, r.e7)([g.Z], () => g.Z.getGuild(E), [E]), p = null != (t = null == O ? void 0 : O.name) ? t : "", M = (0, N.no)(R), {
    analyticsLocations: P
  } = (0, d.ZP)(a.Z.AUTOMOD_PROFILE_QUARANTINE_ALERT), [U, j] = (0, I.ww)({
    guildId: E,
    analyticsLocations: P,
  ...
  }, [O, e]), null == O) ? null : (0, i.jsxs)(s.Y0X, {
    transitionState: Z,
    size: s.CgR.SMALL,
