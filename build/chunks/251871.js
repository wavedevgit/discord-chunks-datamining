...
function Z(n) {
  ...
  let {
    ...
    transitionState: Z,
    guildId: E
  } = n, m = (0, l.e7)([c.default], () => c.default.getId()), R = (0, l.e7)([_.ZP], () => _.ZP.getMember(E, m), [E, m]), p = (0, l.e7)([g.Z], () => g.Z.getGuild(E), [E]), O = null != (t = null == p ? void 0 : p.name) ? t : "", P = (0, N.no)(R), {
    analyticsLocations: U
  } = (0, d.ZP)(a.Z.AUTOMOD_PROFILE_QUARANTINE_ALERT), [M, j] = (0, I.ww)({
    guildId: E,
    analyticsLocations: U,
  ...
  }, [p, e]), null == p) ? null : (0, i.jsxs)(o.Y0X, {
    transitionState: Z,
    size: o.CgR.SMALL,
