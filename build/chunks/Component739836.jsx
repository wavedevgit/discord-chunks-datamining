...
function f(e) {
  ...
  let {
    ...
    guildId: g,
    location: v
  } = e, y = (0, o.Ay)(), j = null != (t = null != f.provider_id ? null == (n = c.A.get(f.provider_id)) ? true : n.name : null) ? t : h.intl.string(h.t.NzCoRx), {
    hasConnection: x,
    canConnect: A,
    startConnection: b,
    loading: C
    ...
    if (null != f.provider_id) {
      let e = c.A.get(f.provider_id),
        t = (null == e ? true : e.icon) != null ? (0, i.Mw)(y) ? e.icon.darkPNG : e.icon.lightPNG : null;
