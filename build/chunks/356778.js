...
function M(A, e, t) {
  return function(A, e, t, n) {
    let {
      addtionalQuery: l,
      shouldDispatch: i = !1
    } = n, s = r.useMemo(() => E(A, e, t, l), [A, e, t, l]), c = w(s), u = (0, o.Z)(s), [C, M] = r.useState({});
    return r.useEffect(() => {
      if (u !== s) {
        let n = D(A, t, l),
...
function p(A, e, t) {
  ...
  let {
    ...
    key: c,
    state: u
  } = I(A, e, "media", t), E = r.useMemo(() => D(A, "all_counts", t), [A, t]), d = r.useMemo(() => ({
    tabs: {
