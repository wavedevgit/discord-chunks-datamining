...
function O(e, t, n) {
  return function(e, t, n, r) {
    ...
    } = r, s = l.useMemo(() => T(e, t, n, i), [e, t, n, i]), _ = h(s), m = (0, u.Z)(s), [g, O] = l.useState({});
    return l.useEffect(() => {
      if (m !== s) {
        let r = N(e, n, i),
...
function R(e, t, n) {
  ...
  let {
    ...
    key: _,
    state: m
  } = p(e, t, "media", n), T = l.useMemo(() => N(e, "all_counts", n), [e, n]), I = l.useMemo(() => ({
    tabs: {
    ...
    include_nsfw: true
  }), [e, T]), g = l.useCallback(e => {
    let t = e.messages,
      n = e.links,
      r = e.media;
    f(s, t), f(u, n), f(_, r)
  }, [u, _, s]), h = l.useCallback(e => {
    g({
      messages: e,
      links: e,
      media: e
  ...
  l.useEffect(() => {
    let e = new c.tJ(t, E.aib.GUILD, T, I);
    h({
      searchTabFetcher: e,
      messageCount: A,
      lastMessage: null
    ...
    let n = setTimeout(async () => {
      ...
      if (null == t) h({
        ...
        g({
          ...
          media: {
            messageCount: null != (a = null == u ? true : u.total_results) ? a : 0,
  ...
  return {
    ...
    mediaCount: null != (a = null == m ? true : m.messageCount) ? a : A
  }
}