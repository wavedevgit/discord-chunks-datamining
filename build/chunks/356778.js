...
function M(A, e, t) {
  return function(A, e, t, n) {
    let {
      addtionalQuery: l,
      shouldDispatch: i = !1
    } = n, s = r.useMemo(() => u(A, e, t, l), [A, e, t, l]), c = w(s), E = (0, o.Z)(s), [C, M] = r.useState({});
    return r.useEffect(() => {
      if (E !== s) {
        let n = D(A, t, l),
...
function p(A, e, t) {
  ...
  let {
    ...
    key: c,
    state: E
  } = I(A, e, "media", t), u = r.useMemo(() => D(A, "all_counts", t), [A, t]), d = r.useMemo(() => ({
    tabs: {
    ...
    include_nsfw: !0
  }), [A, u]), C = r.useCallback(A => {
    let e = A.messages,
      t = A.links,
      n = A.media;
    B(s, e), B(o, t), B(c, n)
  }, [o, c, s]), w = r.useCallback(A => {
    C({
      messages: A,
      links: A,
      media: A
