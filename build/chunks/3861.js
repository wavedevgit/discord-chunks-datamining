...
let E = (0, a.Z)(e => {
  ...
  return (null == L ? void 0 : L.channelId) === I.id ? (0, r.jsx)(d.Z, {
    height: w
  }) : (null == I ? void 0 : I.isGuildVocal()) && !A ? (0, r.jsx)(u.Z, {
    channel: I,
    participants: t,
    hasConnectPermission: T
  }) : P === h.WtW.VOICE ? (0, r.jsx)(s.Z, {
    guildId: I.guild_id,
    width: C,
    className: g.voiceCallWrapper,
    participants: t,
    onContextMenu: O
  }) : (n = A ? n : t, null == a) ? 0 === n.length ? (0, r.jsx)(p.Z, {
    channelId: I.id
  }) : (0, r.jsx)(l.Z, {
