...
function p(e) {
  ...
  return null != i && delete i.keywordLists, {
    id: e.id,
    name: e.name,
    guild_id: e.guildId,
...
async function v(e) {
  let t = p(e);
  return delete t.id, I((await i.tn.post({
...
async function E(e, t, n) {
  a.Z.can(g.Plq.MANAGE_MESSAGES, t) && await i.tn.post({
...
function b(e, t, n) {
  ...
  null != s && a.Z.can(g.Plq.MANAGE_GUILD, s) && (0, c.UV)(() => {
