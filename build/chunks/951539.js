...
function b(e) {
  ...
  let {
    guild_id: f,
    channel_id: g
  } = e, h = e.entity_type === u.WX.EXTERNAL ? n.getDefaultChannel(e.guild_id) : t.getChannel(g), m = a.getGuild(f), x = b.getStageInstanceByChannel(g);
  return !!(0, r.b)(d.Z, m, h, x) && null != h && function(e) {
