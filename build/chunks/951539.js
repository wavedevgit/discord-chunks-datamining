...
function f(e) {
  ...
  let {
    guild_id: p,
    channel_id: f
  } = e, h = e.entity_type === _.WX.EXTERNAL ? n.getDefaultChannel(e.guild_id) : t.getChannel(f), m = r.getGuild(p), g = d.getStageInstanceByChannel(f);
  return !!(0, a.b)(s.Z, m, h, g) && null != h && b(e, [t])
}
