...
function f(e) {
  ...
  let {
    guild_id: h,
    channel_id: g
  } = e, m = e.entity_type === _.WX.EXTERNAL ? n.getDefaultChannel(e.guild_id) : t.getChannel(g), v = i.getGuild(h), b = f.getStageInstanceByChannel(g);
  return !!(0, r.b)(s.Z, v, m, b) && null != m && function(e) {
