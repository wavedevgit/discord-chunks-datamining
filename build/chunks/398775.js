...
function j(e) {
  ...
  } = (0, g.ZP)(), [j, C] = i.useState(!1), O = (0, m.ZP)(), S = null, v = null, T = [N.O0b.PAST_DUE, N.O0b.PAUSED].includes(t.status) ? t.currentPeriodStart : t.currentPeriodEnd, I = a()(T).add(l, "days").toDate();
  switch (t.status) {
    case N.O0b.PAST_DUE:
