...
function C(e) {
  ...
  } = (0, g.ZP)(), [O, C] = r.useState(!1), S = (0, m.ZP)(), v = null, T = null, N = [_.O0b.PAST_DUE, _.O0b.PAUSED].includes(t.status) ? t.currentPeriodStart : t.currentPeriodEnd, I = l()(N).add(a, "days").toDate();
  switch (t.status) {
    case _.O0b.PAST_DUE:
