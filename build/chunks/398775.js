...
function C(e) {
  let {
    ...
    l(t)
  }, [l]), p = d.status === _.O0b.PAUSED ? x.intl.string(x.t.Lp9WoK) : x.intl.string(x.t.eSR83d), h = function(e) {
...
function O(e) {
  ...
  } = (0, p.ZP)(), [C, O] = r.useState(!1), S = (0, m.ZP)(), v = null, T = null, N = [_.O0b.PAST_DUE, _.O0b.PAUSED].includes(t.status) ? t.currentPeriodStart : t.currentPeriodEnd, I = l()(N).add(a, "days").toDate();
  switch (t.status) {
    case _.O0b.PAST_DUE:
