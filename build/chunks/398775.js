...
function I(e) {
  ...
  } = (0, _.ZP)(), [j, I] = i.useState(!1), T = (0, p.ZP)(), E = null, P = null, O = [y.O0b.PAST_DUE, y.O0b.PAUSED].includes(t.status) ? t.currentPeriodStart : t.currentPeriodEnd, S = a()(O).add(s, "days").toDate();
  switch (t.status) {
    case y.O0b.PAST_DUE:
