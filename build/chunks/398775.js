...
function E(e) {
  let {
    ...
    a(t)
  }, [a]), p = d.status === b.O0b.PAUSED ? N.NW.string(N.t.Lp9WoK) : N.NW.string(N.t.eSR83d), _ = function(e) {
...
function j(e) {
  ...
  } = (0, p.ZP)(), [j, C] = i.useState(!1), O = (0, m.ZP)(), v = null, S = null, T = [b.O0b.PAST_DUE, b.O0b.PAUSED].includes(t.status) ? t.currentPeriodStart : t.currentPeriodEnd, I = a()(T).add(l, "days").toDate();
  switch (t.status) {
    case b.O0b.PAST_DUE:
