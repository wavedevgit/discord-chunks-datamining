...
async function E(e) {
  ...
  try {
    a(!0), i(!1), await (0, d.Mg)(t, {
      pauseDuration: n
    }, {
      amount: 0,
      currency: t.currency
    }, (0, b.UX)(t.items, t.currency, t.paymentSourceId), s, o), r()
  } catch (e) {
    i(!0), a(!1)
  }
}
...
function P(e) {
  ...
  } = (0, _.ZP)(), [O, P] = i.useState(!1), g = (0, p.ZP)(), v = null, N = null, I = [h.O0b.PAST_DUE, h.O0b.PAUSED].includes(t.status) ? t.currentPeriodStart : t.currentPeriodEnd, T = s()(I).add(o, "days").toDate();
  switch (t.status) {
    case h.O0b.PAST_DUE:
