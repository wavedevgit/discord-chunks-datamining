...
function j(e) {
  let {
    ...
    l(t)
  }, [l]), m = d.status === _.O0b.PAUSED ? x.intl.string(x.t.Lp9WoK) : x.intl.string(x.t.eSR83d), h = function(e) {
...
function O(e) {
  ...
  } = (0, m.ZP)(), [j, O] = r.useState(!1), S = (0, g.ZP)(), v = null, T = null, I = [_.O0b.PAST_DUE, _.O0b.PAUSED].includes(t.status) ? t.currentPeriodStart : t.currentPeriodEnd, N = l()(I).add(a, "days").toDate();
  switch (t.status) {
    case _.O0b.PAST_DUE:
