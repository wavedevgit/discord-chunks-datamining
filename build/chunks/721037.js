...
class k extends i.PureComponent {
  render() {
    ...
    return (0, r.jsx)(g.Z, {
      ...
      resizeConfig: x,
      className: o()({
        [w.pictureInPictureVideo]: (null == e ? void 0 : e.component) === N.NYg.VIDEO
      })
    })
  }
  constructor(...e) {
    super(...e), D(this, "handleWindowMove", (e, t) => {
      l.Ao(e, t)
...
let j = s.ZP.connectStores([E.Z, c.ZP, S.Z, b.Z, v.Z, T.Z, I.Z, p.Z, y.ZP, h.Z], e => {
  ...
  let l, {
    ...
    x = D && L === C.Ez.PANEL,
    k = null != O && null != w && (null == (t = p.Z.getSelectedParticipant(w)) ? void 0 : t.type) === R.fO.ACTIVITY,
