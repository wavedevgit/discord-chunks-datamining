...
let w = o.ZP.connectStores([p.Z, s.ZP, y.Z, h.Z, E.Z, v.Z, b.Z, f.Z, m.ZP], e => {
  var t, n, r, i;
  let o, {
      inPopoutWindow: a = !1
    } = e,
    ...
    A = null != _ && !(0, u.Z)(g, E.Z, v.Z),
    N = s.ZP.getActivityPanelMode(),
    C = A && N === S.Ez.PANEL,
  ...
  o = a && A ? null : a || !d || A ? null != _ && C ? null !== (n = b.Z.pipActivityWindow) && void 0 !== n ? n : b.Z.pipVideoWindow : null !== (r = b.Z.pipVideoWindow) && void 0 !== r ? r : b.Z.pipActivityWindow : null;
  let L = Array.from(b.Z.pipWindows.values()),
    ...
    j = v.Z.getVoiceChannelId(),
    U = v.Z.getChannelId() === j,
  ...
  return {
    ...
    maxY: w.height,
    theme: h.Z.theme,
    dockedRect: b.Z.getDockedRect(null !== (i = null == o ? void 0 : o.id) && void 0 !== i ? i : ""),
    appContext: D,
    roundCorners: !F
  }
})(P)