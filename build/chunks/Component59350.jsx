...
function en(e) {
  ...
  }), f = (0, o.e7)([N.ZP], () => N.ZP.getSelfMember(i.id)), x = (0, o.Wu)([N.ZP], () => N.ZP.getMemberRoleWithPendingUpdates(i.id, s.id)), j = (0, o.e7)([w.Z], () => w.Z.getSortedRoles(i.id)), Z = (0, b.ZP)(i.id, s.id), I = j.filter(e => x.includes(e.id)), P = (0, v.ZP)(s.id, i.id);
  (0, h.ZP)(() => {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(d.Heading, {
      ...
      children: [(0, r.jsx)("div", (t = J({}, u), l = l = {
        children: (0, r.jsx)(B, {
          src: c,
          avatarDecoration: m,
          size: $,
        ...
        children: null != (n = null == f ? true : f.nick) ? n : E.ZP.getName(s)
      }), (0, r.jsx)(d.Text, {
...
function et(e) {
  ...
  let {
    prompt: t,
    guild: i
  } = e, [c, u] = l.useState(null), [p, h] = l.useState(new Set), m = null == t || null == (n = t.options) ? true : n.filter(e => p.has(e.id)), f = (0, R.L6)(m), g = (0, R.dX)(m), _ = (0, o.Wu)([D.Z], () => D.Z.getOnboardingResponsesForPrompt(i.id, t.id)), {
    helpText: x,
  ...
  } = (0, k.Z)(i.id), j = t.options.map(e => J({
    value: e.id
...
function er(e) {
  ...
  return 0 === t.length ? null : (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(d.Heading, {
      ...
      children: t.map((e, t) => (0, r.jsx)(M.Z, {
        connection: e,
        guildId: n.id,
...
function el(e) {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [t.isNew && (0, r.jsx)(d.IGR, {
      ...
      children: t.options.map(e => (0, r.jsx)(G.Z, {
...
function ei(e) {
  let {
    guildId: n,
    onBrowseChannels: t
  } = e, i = (0, c.wj)((0, m.ZP)()), h = (0, o.e7)([Z.Z], () => Z.Z.getGuild(n)), f = (0, o.e7)([P.default], () => P.default.getCurrentUser()), g = (0, p.Z)("(min-width: 1344px)") && null != f, _ = l.useCallback(() => {
    (0, j.uL)(q.Z5c.CHANNEL(n, z.oC.CHANNEL_BROWSER)), null == t || t()
  }, [n, t]), C = (0, o.e7)([I.ZP], () => I.ZP.hasUnread(n, V.W.GUILD_ONBOARDING_QUESTION)), {
