...
let eJ = () => [s.z.CLIENT_THEMES_SETTINGS_BADGE, s.z.DEKSTOP_CUSTOM_APP_ICON_BADGE],
  e$ = () => {
    let e = [];
    return F.c.getCurrentConfig({
      location: "SettingsRendererConfig"
    }).enabled && e.push(s.z.RECENT_AVATARS_SETTINGS_MENU_NEW_BADGE), P.e.getCurrentConfig({
      location: "SettingsRendererConfig"
  ...
  e3 = e => {
    ...
    return Object.freeze({
      ...
      [eF.s6.APPEARANCE_TIMESTAMP_HOUR_CYCLE]: {
        ...
        parent: eF.s6.APPEARANCE,
        predicate: () => H.Z.getCurrentConfig({
          location: "SettingsRendererConfig"
        }, {
          autoTrackExposure: !1
        }).enable24HourPref
      ...
      [eF.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eF.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === $.ZP.releaseChannel || "development" === $.ZP.releaseChannel) && e2 && W.Z.supports(eW.AN.CONNECTION_REPLAY)
      },
      [eF.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: ez.oAB.VOICE,
        searchableTitles: [eK.intl.string(eK.t["726JHB"])],
        parent: eF.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => J.isPlatformEmbedded && W.Z.supports(eW.AN.DEBUG_LOGGING) && null != p.Z.fileManager.readLogFiles
      },
      ...
      [eF.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          q.default.track(ez.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, Q.q)({
            href: e,
            shouldConfirm: !0,
            onConfirm: () => {
      ...
      [eF.s6.DEVELOPER_OPTIONS_LAYOUT_DEBUGGING_OPTIONS]: {
        ...
        searchableTitles: ["Layout Debugging"],
        parent: eF.s6.DEVELOPER_OPTIONS_FLAGS,
        predicate: () => e2 && z.Z.isDeveloper && Y.default.layoutDebuggingEnabled
      },
      ...
      [eF.s6.QUEST_PREVIEW_TOOL]: {
        ...
        element: G.Z,
        predicate: () => (0, U.X7)({
          location: eY.dr.QUEST_PREVIEW_TOOL
        })
      },
      ...
      [eF.s6.LOGOUT]: {
        ...
        onClick: () => {
          (0, a.h7j)(e => {
            var t, n;
            return (0, i.jsx)(a.ConfirmModal, (t = function(e) {
