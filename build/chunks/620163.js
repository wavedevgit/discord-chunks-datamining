...
let eU = () => [s.z.CLIENT_THEMES_SETTINGS_BADGE, s.z.DEKSTOP_CUSTOM_APP_ICON_BADGE],
  ...
  eG = e => {
    let {
      unseenGiftCount: t,
      showPrepaidPaymentPastDueWarning: eG,
      impressionSource: eF,
      ...
      showGiftNitro: e1,
      isStricterMessageRequestsEnabled: e2,
      ...
      hypeSquadRemoved: e9,
      stealthRemediationEnabled: e5,
      hasIgnoredUsers: te,
      hasBlockedUsers: tt,
      isAllowGameFriendDMsVisible: tn,
      useRefreshedVoiceAndVideo: tr
    } = e;
    return Object.freeze({
      ...
      [ew.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        ...
        parent: ew.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => G.isPlatformEmbedded && L.Z.supports(eL.AN.DEBUG_LOGGING) && null != g.Z.fileManager.readLogFiles
      },
      ...
      [ew.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          M.default.track(ek.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, V.q)({
            href: e,
            shouldConfirm: !0,
            onConfirm: () => {
