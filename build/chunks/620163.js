...
let e0 = () => {
  ...
  e1 = () => {
    let e = e0(),
      [t] = (0, N.US)(e);
    return t === s.z.CLIENT_THEMES_SETTINGS_BADGE || t === s.z.DEKSTOP_CUSTOM_APP_ICON_BADGE ? (0, i.jsx)(l.lBU, {
      text: eX.intl.string(eX.t.y2b7CA)
    }) : t === s.z.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE ? (0, i.jsx)(l.IGR, {
      text: eX.intl.string(eX.t.y2b7CA)
    }) : null
  },
  e3 = () => {
    ...
    }).enabled && e.push(s.z.RECENT_AVATARS_SETTINGS_MENU_NEW_BADGE), I.J.getCurrentConfig({
      location: "SettingsRendererConfig"
  ...
  e8 = e => {
    ...
    return Object.freeze({
      ...
      [eW.s6.APPEARANCE_TIMESTAMP_HOUR_CYCLE]: {
        ...
        parent: eW.s6.APPEARANCE,
        predicate: () => F.Z.getCurrentConfig({
          location: "SettingsRendererConfig"
        }, {
          autoTrackExposure: !1
        }).enable24HourPref
      ...
      [eW.s6.CLICKER_GAME]: {
        ...
        element: j.Z,
        predicate: () => _.C.getCurrentConfig({
          location: "SettingsRendererConfig"
        }, {
          autoTrackExposure: !1
        }).enableGame,
      ...
      [eW.s6.ACTIVITY_PRIVACY_STATUS]: {
        ...
        parent: e8 ? eW.s6.GAMES_ACTIVITY_PRIVACY : eW.s6.ACTIVITY_PRIVACY
      },
      ...
      [eW.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          q.default.track(eY.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, J.q)({
            href: e,
            shouldConfirm: !0,
            onConfirm: () => {
      ...
      [eW.s6.QUEST_PREVIEW_TOOL]: {
        ...
        element: V.Z,
        predicate: () => (0, M.X7)({
          location: eK.dr.QUEST_PREVIEW_TOOL
        })
      },
      ...
      [eW.s6.LOGOUT]: {
        ...
        onClick: () => {
          (0, l.h7j)(e => {
            var t, n;
            return (0, i.jsx)(l.ConfirmModal, (t = function(e) {
