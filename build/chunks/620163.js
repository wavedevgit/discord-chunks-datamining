...
let e0 = () => {
  ...
  e3 = () => {
    ...
    }).enabled && e.push(s.z.RECENT_AVATARS_SETTINGS_MENU_NEW_BADGE), D.e.getCurrentConfig({
      location: "SettingsRendererConfig"
  ...
  e8 = () => {
    let e = e3(),
      [t] = (0, N.US)(e);
    return t === s.z.NAMEPLATE_USER_SETTINGS_MENU_NEW_BADGE ? (0, i.jsx)(Z.Z, {}) : t === s.z.RECENT_AVATARS_SETTINGS_MENU_NEW_BADGE ? (0, i.jsx)(a.IGR, {
      text: eX.intl.string(eX.t.y2b7CA)
    }) : null
  },
  e6 = ew.Z,
    ...
    return Object.freeze({
      ...
      [ez.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          q.default.track(eW.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, Q.q)({
            href: e,
            shouldConfirm: !0,
            onConfirm: () => {
