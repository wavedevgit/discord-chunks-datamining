/** Chunk was on web.js **/
/** chunk id: 298362, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  CV: () => i,
  E9: () => h,
...
let i = {
  ...
  l = `(?:${(0,Chunk476858.uJ)(s)}|[0-9]+|[0-9]+\\.[0-9]+|un?|uno?|una?|algunos?|unos?|demi-?)`;
...
let f = `(${l})\\s{0,5}(${(0,Chunk476858.uJ)(o)})\\s{0,5}`,
  p = RegExp(f, "i"),
  _ = (0, Chunk476858.mb)("", f);
