...
function N(e) {
  ...
  return <a.xJW>{<a.R94 type={a.R94.Types.DESCRIPTION}>{v.intl.string(v.t["2Y9ZfH"])}</a.R94>}{<div className={j.input}><a.VcW value={p.lds} onChange={n} options={N} renderOptionLabel={e => {
        ...
        }} placeholder={v.intl.string(v.t["Z+oF8v"])} /></div>}</a.xJW>
}