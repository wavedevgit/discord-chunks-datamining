...
function w(e) {
  ...
  }, [h, a, t, n]), [g, m] = i.useMemo(() => [h ? C.intl.string(C.t["8lklch"]) : C.intl.string(C.t.ji3jTF), h ? C.intl.string(C.t.RMQZCa) : C.intl.string(C.t["v/PagC"])], [h]), y = i.useMemo(() => ({
    align: "end"
  }), []);
