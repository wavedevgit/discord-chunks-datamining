...
function S(e) {
  let {
    ...
    totalFilters: E
  } = (0, y.p4)(C, t), S = i.useMemo(() => {
    if (t.type === v.aib.DMS) {
      var e, n;
      let t = null != (n = null == (e = (0, h.$G)(C).channel_id) ? true : e.length) ? n : 0;
      return t > 0 ? j.intl.format(j.t.A2dqWG, {
        filterCount: t
      }) : j.intl.string(j.t.tc619d)
    }
    return null
  }, [t.type, C]), [I, P] = i.useState(null), Z = i.useMemo(() => p ? [] : [o.z.CROSS_DM_SEARCH_SETTING_EDUCATION_POPOVER], [p]), [N, w] = (0, d.US)(Z), R = N === o.z.CROSS_DM_SEARCH_SETTING_EDUCATION_POPOVER, D = i.useCallback(e => {
    null != e && R && w(O.L.USER_DISMISS), P(e)
  }, [R, w, P]), M = i.useCallback(e => {
    w("user:explicit" === e ? O.L.USER_DISMISS : O.L.AUTO_DISMISS)
  }, [w]), k = i.useCallback(() => {
    D(null), g.Z.openSearchFiltersModal(t)
  }, [D, t]), L = i.useMemo(() => E > 0 ? j.intl.format(j.t.uaR4sI, {
    filterCount: E
  }) : j.intl.string(j.t.UdhTtk), [E]), U = t.type === v.aib.DMS || t.type === v.aib.CHANNEL;
  return (0, r.jsxs)("header", {
    className: a()(x.searchHeader, {
      [x.searchHeaderWithSubtitle]: null != S
    }),
...
function T(e) {
  ...
  }, [f, a, t, n]), [m, y] = i.useMemo(() => [f ? j.intl.string(j.t["8lklch"]) : j.intl.string(j.t.ji3jTF), f ? j.intl.string(j.t.RMQZCa) : j.intl.string(j.t["v/PagC"])], [f]), O = i.useMemo(() => ({
    align: "end"
  }), []);
  return (0, r.jsxs)(r.Fragment, {
...
function A(e) {
  ...
  return (0, r.jsx)(u.yRy, {
    ...
    children: e => (0, r.jsx)(u.Button, E(C({}, e), {
      buttonRef: o,
      variant: "secondary",
      icon: u.uVW,
      onClick: () => {
