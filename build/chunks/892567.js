...
let O = i.memo(function(e) {
  ...
  }), w = (0, d.dQu)(d.TVs.colors.BACKGROUND_BASE_LOW).hex(), D = i.useMemo(() => null != n && P ? n.colors.map(e => {
    let t = a()(e);
    return C && (t = t.desaturate(1 - N)), (0, _.aP)(t.hex(), n.effectId === c.m.TOON ? "#333" : w, b.sS[n.effectId].minContrastRatio)
  }) : [], [n, P, C, N, w]);
  if (!P || !s && !R || null == n) return t;
  let L = (0, g.K)(n.effectId, D, {
      shouldWrap: T
    }),
    x = v(n.effectId, o);
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)("span", {
      ...
      children: t
    }), (null == x ? void 0 : x.glowClassName) != null && (0, r.jsx)("span", {
...
function v(e, t) {
  switch (e) {
    case c.m.GRADIENT:
      return {
        effectClassName: y.gradient
      };
    case c.m.NEON:
      return {
        effectClassName: y.neon, glowClassName: t !== m.F.PLAIN ? y.neonGlow : void 0
      };
    case c.m.TOON:
      return {
        effectClassName: y.toon
      };
    case c.m.POP:
      return {
        effectClassName: y.pop
      };
    case c.m.SOLID:
      return {
        effectClassName: y.solid
      };
    default:
      return
  }
