...
class k extends s.Z {
  ...
  _initializeEvents() {
    ...
    this.on(l.z.State, (e, t, n) => {
      if (a.Z.wait(() => a.Z.dispatch(w(P({
        ...
        var r;
        null == (r = this._connection) || r.on(o.Sh.ScreenshareFinish, (e, t, n, r, i, o, a, s, l, c, u, d, p, h, m, g) => {
          ...
          (0, y.q)().then(y => {
            ...
            v.default.track(N.rMx.SCREENSHARE_FINISHED, P({
      ...
      var s;
      n === (null == (s = this._goLiveQualityManager) ? void 0 : s.getUserID()) && (this._goliveCurrentMaxResolution = r), a.Z.wait(() => a.Z.dispatch({
  ...
  _trackVideoStartStats() {
    ...
    v.default.track(N.rMx.VIDEO_STREAM_STARTED, w(P({}, this._getStreamAnalyticsProperties(), e), {
  ...
  _trackVideoEndStats(e) {
    ...
    a.getOutboundStats().forEach(t => {
      var r;
      (null != (r = t.num_frames) ? r : 0) > 0 && v.default.track(N.rMx.VIDEO_STREAM_ENDED, w(P({}, o, i, s, this._videoStreamStats.getStats(), t, this._soundshareStats.getStats(), this._getStreamAnalyticsProperties(), _, p), {
      ...
      (null != (r = null == l ? void 0 : l.num_frames) ? r : 0) > 0 && v.default.track(N.rMx.VIDEO_STREAM_ENDED, w(P({}, o, i, s, this._videoStreamStats.getStats(), l, this._soundshareStats.getStats(), this._getStreamAnalyticsProperties(), _, p), {
        app_hardware_acceleration_enabled: O.Z.getAppHardwareAccelerationEnabled(),
        channel_type: n,
        reason: e,
        max_viewers: this.analyticsContext.maxViewers,
