...
class F extends Chunk861687.Z {
  ...
  updateStats(e) {
    ...
    if (null != E && h) {
      ...
      null != e && e < 1e8 && (this.bandwidthSamples.push(e), this.bandwidthSamples.length > j && this.bandwidthSamples.shift(), this.bandwidthSamples.length === j && ((p = i().mean(this.bandwidthSamples)) > G ? g = "HQ" : p < U && (g = "LQ")))
    }
  ...
  trackVideoStartStats() {
    ...
    Chunk626135.default.track(Chunk981631.rMx.VIDEO_STREAM_STARTED, k(x({}, this.getStreamAnalyticsProperties(), module), {
  ...
  trackVideoEndStats(e) {
    ...
    o.getOutboundStats().forEach(t => {
      var r;
      (null != (r = t.num_frames) ? r : 0) > 0 && T.default.track(w.rMx.VIDEO_STREAM_ENDED, k(x({}, a, i, s, this.videoStreamStats.getStats(), t, this._soundshareStats.getStats(), this.getStreamAnalyticsProperties(), u, p), {
      ...
      (null != (r = null == l ? true : l.num_frames) ? r : 0) > 0 && T.default.track(w.rMx.VIDEO_STREAM_ENDED, k(x({}, a, i, s, this.videoStreamStats.getStats(), l, this._soundshareStats.getStats(), this.getStreamAnalyticsProperties(), u, p), {
        app_hardware_acceleration_enabled: S.Z.getAppHardwareAccelerationEnabled(),
        channel_type: n,
        reason: e,
        max_viewers: this.analyticsContext.maxViewers,
