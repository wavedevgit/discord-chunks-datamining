...
class M extends s.Z {
  ...
  _initializeEvents() {
    ...
    this.on(l.z.State, (e, t, n) => {
      if (o.Z.wait(() => o.Z.dispatch(w(P({
        ...
        var r;
        null == (r = this._connection) || r.on(a.Sh.ScreenshareFinish, (e, t, n, r, i, a, o, s, l, c, u, d, p, h, m, g) => {
          ...
          (0, y.q)().then(y => {
            ...
            O.default.track(A.rMx.SCREENSHARE_FINISHED, P({
      ...
      var s;
      n === (null == (s = this._goLiveQualityManager) ? void 0 : s.getUserID()) && (this._goliveCurrentMaxResolution = r), o.Z.wait(() => o.Z.dispatch({
  ...
  _getStreamAnalyticsProperties() {
    let {
      ...
      ownerId: i,
      guildId: a
    } = this._streamContext, o = b.Z.getRegion(E.Z.getHostname()), {
      gameName: s,
      gameId: l,
      exe: c,
      distributor: u
  ...
  _trackVideoStartStats() {
    ...
    O.default.track(A.rMx.VIDEO_STREAM_STARTED, w(P({}, this._getStreamAnalyticsProperties(), e), {
  ...
  _trackVideoEndStats(e) {
    ...
    o.getOutboundStats().forEach(t => {
      var r;
      (null != (r = t.num_frames) ? r : 0) > 0 && O.default.track(A.rMx.VIDEO_STREAM_ENDED, w(P({}, a, i, s, this._videoStreamStats.getStats(), t, this._soundshareStats.getStats(), this._getStreamAnalyticsProperties(), _, p), {
      ...
      (null != (r = null == l ? void 0 : l.num_frames) ? r : 0) > 0 && O.default.track(A.rMx.VIDEO_STREAM_ENDED, w(P({}, a, i, s, this._videoStreamStats.getStats(), l, this._soundshareStats.getStats(), this._getStreamAnalyticsProperties(), _, p), {
        app_hardware_acceleration_enabled: v.Z.getAppHardwareAccelerationEnabled(),
        channel_type: n,
        reason: e,
        max_viewers: this.analyticsContext.maxViewers,
