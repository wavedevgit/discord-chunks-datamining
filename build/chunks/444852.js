...
class k extends s.Z {
      ...
      if (a.Z.wait(() => a.Z.dispatch(w(R({
        ...
        null === (r = this._connection) || void 0 === r || r.on(o.Sh.ScreenshareFinish, (e, t, n, r, i, o, a, s, l, c, u, d, p, h, m, g) => {
          ...
          (0, v.q)().then(v => {
            ...
            y.default.track(N.rMx.SCREENSHARE_FINISHED, R({
  ...
  _trackVideoStartStats() {
    ...
    y.default.track(N.rMx.VIDEO_STREAM_STARTED, w(R({}, this._getStreamAnalyticsProperties(), e), {
  ...
  _trackVideoEndStats(e) {
    ...
    a.getOutboundStats().forEach(t => {
      var r;
      (null !== (r = t.num_frames) && void 0 !== r ? r : 0) > 0 && y.default.track(N.rMx.VIDEO_STREAM_ENDED, w(R({}, o, i, s, this._videoStreamStats.getStats(), t, this._soundshareStats.getStats(), this._getStreamAnalyticsProperties(), _, p), {
      ...
      (null !== (r = null == l ? void 0 : l.num_frames) && void 0 !== r ? r : 0) > 0 && y.default.track(N.rMx.VIDEO_STREAM_ENDED, w(R({}, o, i, s, this._videoStreamStats.getStats(), l, this._soundshareStats.getStats(), this._getStreamAnalyticsProperties(), _, p), {
        app_hardware_acceleration_enabled: O.Z.getAppHardwareAccelerationEnabled(),
        channel_type: n,
        reason: e,
        max_viewers: this.analyticsContext.maxViewers,
