...
let O = o.ZP.connectStores([g.Z, c.Z, f.Z, m.default], e => {
  ...
  let {
    ...
    application: c,
    subscriptionPlan: m
  } = e, f = null == l ? E.intl.string(E.t.lTGZAg) : E.intl.formatToPlainString(E.t.TjWdPT, {
    username: l.username
  }), g = o.name;
  return null != m && (g = E.intl.formatToPlainString(m.interval === b.rV.MONTH ? E.t.CTpcCQ : E.t.rgPWGx, {
    skuName: o.name,
