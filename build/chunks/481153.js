...
let I = o.ZP.connectStores([m.Z, c.Z, f.Z, g.default], e => {
  ...
  let {
    ...
    application: c,
    subscriptionPlan: g
  } = e, f = null == s ? b.NW.string(b.t.lTGZAg) : b.NW.formatToPlainString(b.t.TjWdPT, {
    username: s.username
  }), m = o.name;
  return null != g && (m = b.NW.formatToPlainString(g.interval === x.rV.MONTH ? b.t.CTpcCQ : b.t.rgPWGx, {
    skuName: o.name,
    ...
    children: [null != n.giftStyle ? (0, r.jsx)(p.Z, {
      ...
      children: [(0, r.jsx)(u.DK, {
        ...
        children: [o.productLine !== N.POd.COLLECTIBLES && (0, r.jsx)(d.Z, {
