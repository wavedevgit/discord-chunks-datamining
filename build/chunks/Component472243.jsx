...
function I(e) {
  ...
  let {
    ...
    className: A
  } = e, C = (0, a.e7)([f.default], () => _.ZP.canUseIncreasedMessageLength(f.default.getCurrentUser())), N = (0, u.Z)(), R = null != T ? T : N, P = null != (b = null != S ? S : T) ? b : N / 10, w = I.length, D = null != O.upsellLongMessages && (null != w ? w : 0) > h.J6R && C, x = null != O.upsellLongMessages && !C, L = (null == (n = (0, d.N)()) || null == (t = n.subscription_trial) ? true : t.sku_id) === m.Si.TIER_2, j = R - w, k = j > P, M = j < 0 && L, U = 0 === j ? g.intl.string(g.t.tU6YQ0) : j > 0 ? g.intl.formatToPlainString(g.t.qH8uFR, {
    count: j
  }) : g.intl.string(g.t.YSRIqa), {
    analyticsLocations: G
  } = (0, c.ZP)(l.Z.CHARACTER_COUNT);
  if (!(D && j >= 0 || !k || x && !k)) return null;
  let B = j >= 0;
  return (0, r.jsx)(c.Gt, {
    value: G,
