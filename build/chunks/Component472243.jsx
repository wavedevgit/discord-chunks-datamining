...
function y(e) {
  ...
  let {
    ...
    className: T
  } = e, C = (0, o.e7)([p.default], () => _.ZP.canUseIncreasedMessageLength(p.default.getCurrentUser())), A = (0, d.Z)(), N = null != S ? S : A, P = null != (y = null != I ? I : S) ? y : A / 10, w = v.length, R = null != O.upsellLongMessages && (null != w ? w : 0) > m.J6R && C, D = null != O.upsellLongMessages && !C, x = (null == (n = (0, f.N)()) || null == (t = n.subscription_trial) ? true : t.sku_id) === g.Si.TIER_2, L = N - w, j = L > P, M = L < 0 && x, k = 0 === L ? E.intl.string(E.t.tU6YQ7) : L > 0 ? E.intl.formatToPlainString(E.t.qH8uFW, {
    count: L
  }) : E.intl.string(E.t.YSRIqa), {
    analyticsLocations: U
  } = (0, u.ZP)(c.Z.CHARACTER_COUNT);
  if (!(R && L >= 0 || !j || D && !j)) return null;
  let G = L >= 0;
  return (0, r.jsx)(u.Gt, {
    value: U,
