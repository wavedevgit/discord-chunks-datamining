  ...
  return {
    ...
    HUB_SCHOOL_CLUB: {
      ...
      roles: [{
        ...
        mentionable: !0,
        hoist: !0,
        permissions: r.$e(i.TP, o.Plq.MANAGE_ROLES, o.Plq.MANAGE_CHANNELS, o.Plq.KICK_MEMBERS, o.Plq.BAN_MEMBERS, o.Plq.MANAGE_NICKNAMES, o.Plq.MANAGE_GUILD_EXPRESSIONS, o.Plq.MANAGE_MESSAGES, o.Plq.SEND_TTS_MESSAGES),
        color: 3066993
      }],
    ...
    HUB_STUDY: {
      ...
      channels: [{
        ...
        id: "22",
        parent_id: "20",
        name: a.intl.formatToPlainString(a.t.LuNsNT, {
          number: 1
        }),
        type: o.d4z.GUILD_VOICE
      }, {
