...
let y = function(e, t) {
  ...
  return (0, r.useLayoutEffect)(() => (n ? (e.addEventListener("mousedown", b), e.addEventListener("keydown", m)) : e.addEventListener("keydown", i), () => {
    n ? (e.removeEventListener("mousedown", b), e.removeEventListener("keydown", m)) : e.removeEventListener("keydown", i)
  }), [e, i, n]), n
}