...
function g(e, t) {
  let g = (0, r.e7)([u.Z], () => u.Z.can(Z.Plq.MANAGE_CHANNELS, t)),
    ...
    v = null != j && j.length > 0;
  return e.isGuildVoice() && (g || h) ? !b && g && v ? <l.sNh id={"clear-status"} label={f.intl.string(f.t["22CYiY"])} action={() => {
      a.ZP.updateVoiceChannelStatus(e.id, "")
    }} /> : b && h ? <l.sNh id={"set-status"} label={f.intl.string(f.t.Mgpxi4)} action={() => {
      (0, l.ZDy)(async () => {
        let {
          default: t
