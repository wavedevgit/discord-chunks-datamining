...
function m() {
  ...
  }, Chunk524825.X), n = (0, Chunk442837.e7)([Chunk430824.Z], () => Chunk430824.Z.getGuild(module)), m = (0, Chunk442837.e7)([Chunk592125.Z], () => null == require ? Chunk592125.Z.getChannel(exports) : null), g = (0, Chunk442837.e7)([Chunk594174.default], () => Chunk594174.default.getCurrentUser()), b = null != m ? (0, Chunk43267.x)(m) : null, _ = null != g ? g.getAvatarURL(module, 80) : Chunk768581.pK["0"], y = (0, Chunk951288.jsx)(Chunk481060.qEK, {
    src: _,
    "aria-hidden": true,
