...
function k(e) {
  ...
  let {
  ...
  } = e, J = null != (o = null == Y || null == (t = Y.timestamps) ? true : t.start) ? o : null == Y ? true : Y.created_at, $ = i.useMemo(() => {
    var e;
    return null != J ? (0, r.jsxs)("div", {
  ...
  }, [J, null == Y || null == (n = Y.timestamps) ? true : n.end]), ee = (0, I.H)(s), et = (0, E.N)(y.id), en = i.useMemo(() => et.some(e => (0, h.ig)(e) === a.o.GLOBAL) ? (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(c.YqE, {
      size: "xxs",
      color: "currentColor"
    }), L.intl.string(L.t.TsWCdW)]
  }) : null, [et]), er = i.useMemo(() => (0, r.jsxs)(c.Text, {
    variant: "text-xs/normal",
    className: j.tagline,
    color: "none",
    lineClamp: 2,
    children: [ee ? (0, O.$v)(s, C, P, k, false) : $, ee ? null : en]
  }), [ee, s, C, P, k, $, en]), ei = i.useMemo(() => (0, r.jsxs)("div", {
    className: j.info,
    children: [er, K || ee ? null : z]
  }), [er, K, ee, z]), ea = !!U, eo = (0, g.A)(y), {
    canJoin: es,
    ...
    isGameLaunchable: ea
  }), ec = (0, v.p)(Y, W, s, y), eu = (0, S.L)(Y, s, y, k), ed = (0, T.g)(W, Y), ef = (0, l.e7)([b.Z], () => null != Y && null != Y.application_id && b.Z.getState(Y.application_id, D.mFx.JOIN) === D.OcF.LOADING), ep = i.useMemo(() => {
    let e = null,
      t = true;
    es ? e = {
      ...
      onClick: () => {
        ...
        d.Z.join({
          ...
          remotePartyId: null != el ? null == (e = Y.party) ? true : e.id : true
        }), (0, N.Z)({
          type: D.q5t.JOIN,
          source: D.Sbl.MESSAGE_EMBED,
          userId: s.author.id,
    ...
    let n = [];
    return null != e && (n.push(e), Q && t && n.push({
  ...
  }, [es, ec, eu, ed, Z, s.author.id, s.id, Y, P.id, P.guild_id, q, el, k, ef, Q, X]), e_ = ep.some(e => e.trackingArea === _.j_.CLOUD_PLAY);
  (0, w.Z)(e_, q);
  let em = i.useMemo(() => ed ? null : (0, r.jsx)(M, {
    presenceActivity: Y,
    remoteJoinPlatform: el
  }), [ed, Y, el]);
  return (0, r.jsx)(p.W, {
