...
function T(e, t) {
  let n = arguments.length > 2 && true !== arguments[2] ? arguments[2] : p,
    l = arguments.length > 3 && true !== arguments[3] ? arguments[3] : 2,
    r = arguments.length > 4 && true !== arguments[4] ? arguments[4] : 16;
  for (let i = 0; i < 5; i++) {
    let a = n[i],
      o = D(-t, t);
...
let w = {
  ...
  [Chunk25639.s.GENTLE_AMBIENT_WITH_INTRO]: {
...
function C(e) {
  let {
    ...
    iconSize: i = 20,
    locked: a = false
  } = e, o = r.useId(), s = (i - 18) / 2, u = a ? "url(#".concat(o, ")") : true;
  return (0, l.jsx)("span", {
    className: n,
    style: {
      display: "inline-flex",
