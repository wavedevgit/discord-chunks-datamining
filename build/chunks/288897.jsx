...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk704875 = require("./704875.js"),
  Chunk653309 = require("./653309.js"),
...
class P extends Chunk73800.PureComponent {
  ...
  decorate(e) {
    ...
    return [...(0, E.Z)(n, e, r), ...(0, g.Z)(n, e), ...null != (t = null == i ? true : i(n, e)) ? t : []]
  }
  renderElement(e) {
    var t;
    let {
    ...
    "rtl" === a.dir && (a.style = N(S({}, a.style), {
      textAlign: "right"
    }));
    let l = null != (t = null == o ? true : o(e)) ? t : (0, b.Z)(e, n, i);
    return null != l ? l : <div{...N(S({}, a), {
      children: s
    })} />
  }
  renderLeaf(e) {
  ...
  handleCompositionStart() {
    ...
    let o = Chunk650557.F3.findDocumentOrShadowRoot(this.props.editor).getSelection(),
    ...
    if (null != e && null != t)
      for (let n = e.rangeCount - 1; n >= 0; n--) {
        let r = e.getRangeAt(n),
          ...
          a = r.startOffset,
          s = r.endOffset;
        if ((0, p.hasDomParent)(i, t) || !(0, p.isDOMRangeCollapsed)(i, a, o, s) && (0, p.hasDomParent)(o, t)) returntrue
      }
    returnfalse
  }
  ...
  render() {
    ...
    return <div ref={this.containerRef} className={Chunk73800}>{this.state.showPlaceholder ? <div className={a()(Chunk508928.placeholder, require)} aria-hidden={true}>{Chunk40851}</div> : null}{<Chunk650557.mH editor={exports} value={[...this.state.initialValue]}><Chunk650557.CX{...N(S({}, Chunk653309), {
