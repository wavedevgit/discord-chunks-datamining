...
let eN = {
  ...
  eD = e => {
    let {
      product: t,
      user: n
    } = e, i = M.ZP.canUsePremiumProfileCustomization(n), a = (0, p.cj)([Z.Z], () => Z.Z.getAllPending()), {
      pendingAvatar: l
    } = a, s = function(e, t) {
      if (null == e) return {};
  ...
  ez = e => {
    let {
      ...
      tab: v
    } = e, b = (0, p.e7)([A.default], () => A.default.getCurrentUser()), P = (0, ex.f)(a), {
