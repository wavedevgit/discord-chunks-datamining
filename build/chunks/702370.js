...
let eS = {
  ...
  eL = e => {
    ...
    } = (0, P.ZP)(), _ = B.ZP.canUseCollectibles(o), {
    ...
    let A = (0, X.L)(a),
      ...
      J = (0, m.e7)([M.Z], () => M.Z.isClaiming === (null == E ? void 0 : E.skuId)),
      $ = (0, b.ZP)(),
      ee = (0, p.wj)($),
      el = (0, z.G1)(E),
    ...
    let eB = e => (0, r.jsx)(N.Z, {
      ...
      }),
      {
        ...
        firstProfileEffect: eF
      } = (0, G.k)(E),
      eM = E.type === d.Z.BUNDLE ? eI.NW.formatToPlainString(eI.t["jM8/7+"], {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)("div", {
        ...
        children: [null == eA ? null : (0, r.jsxs)("div", {
          ...
          children: (0, r.jsxs)("div", {
            ...
            children: [(() => {
              ...
              return (0, r.jsx)(f.zxk, {
                ...
                }) : (0, z.x6)(E) ? eI.NW.string(eI.t.V1AWw8) : E.type === d.Z.PROFILE_EFFECT ? eI.NW.string(eI.t.kAeDcH) : eI.NW.string(eI.t.AQ0Ven)
              })
            })(), eH && (0, r.jsx)(er.Z, {
              product: E,
              onSuccess: x,
          ...
          variant: "text-xxs/normal",
          children: R ? null : el ? eI.NW.string(eI.t.O2K0xM) : (0, z.x6)(E) ? eI.NW.string(eI.t.Ifvd7O) : E.type === d.Z.PROFILE_EFFECT ? eI.NW.string(eI.t.pxunjo) : eI.NW.string(eI.t.IA8coq)
        })]
      })]
    })
  },
  ...
  eD = e => {
    ...
    } = b, C = (0, m.e7)([M.Z], () => M.Z.purchases), j = (0, H.o)(a, C), w = (0, ev.N)(a, g), O = (0, eh.W)(a, j);
    s()(null != O, "Selected product should not be null");
    let {
      analyticsLocations: I
    } = (0, P.ZP)([...u, x.Z.COLLECTIBLES_SHOP_DETAILS_MODAL]);
    (0, ee.u9)(O.skuId);
    let [N] = O.items, _ = (0, U.s)("CollectiblesShopProductDetailsModal"), {
      pdpBackground: k,
      logo: S
    } = (0, eb.OR)(l, a);
    i.useEffect(() => {
