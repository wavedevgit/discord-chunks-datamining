...
let eT = {
  ...
  eR = e => {
    ...
    return (0, V.x6)(t) ? (0, r.jsx)(eL, {
      product: t,
      user: n
    }) : (0, e_.o0)(t.skuId) ? (0, r.jsx)(em.b, {
  ...
  eA = e => {
    ...
    return t === m.a.PREMIUM_TIER_2_3_DAY ? (0, r.jsx)(h.Text, {
      ...
      children: eO.intl.format(eO.t.Q1scdH, {
        helpdeskArticle: M.Z.getArticleURL(ew.BhN.FRACTIONAL_PREMIUM_ABOUT)
      })
    }) : null
  },
  eZ = e => {
    ...
    let T = (0, J.L)(n),
      ...
      G = (0, p.e7)([F.Z], () => F.Z.isClaiming === (null == S ? void 0 : S.skuId)),
      W = (0, P.ZP)(),
      et = (0, f.wj)(W),
      en = (0, V.G1)(S),
      er = (0, V.ql)(S, ew.tuJ.DEFAULT),
      ec = (null == er ? void 0 : er.amount) === 0,
      {
        firstAvatarDecoration: eu
      } = (0, $.Rj)(null != N ? N : S),
      ed = i.useMemo(() => (0, V.BH)(S, w), [S, w]),
      {
        handleUseNow: em,
        isApplying: eh
      } = (0, q.W)({
    ...
    let eD = (e, t) => {
        let n = () => {
          ...
          i = B ? eO.intl.string(eO.t.cTdr39) : eO.intl.string(eO.t.zqh7ZG),
          a = !eZ || B;
        return (0, r.jsx)(h.ua7, {
          ...
          shouldShow: a,
          "aria-label": !1,
          children: i => (0, r.jsx)(h.zxk, eS(eN({}, i), {
      ...
      eM = (e, t) => {
        let n = !en && !ec && !u.tq && !eL && M && (ex || S.type !== d.Z.NAMEPLATE),
          i = t ? h.zxk.Colors.BRAND : h.zxk.Colors.PRIMARY,
          a = (0, V.x6)(S) ? eO.intl.string(eO.t.V1AWw8) : S.type === d.Z.PROFILE_EFFECT ? eO.intl.string(eO.t.kAeDcH) : S.type === d.Z.NAMEPLATE ? eO.intl.string(eO.t.H3vhqa) : eO.intl.string(eO.t.AQ0Ven),
          l = eT ? eO.intl.formatToPlainString(eO.t["cNSL/v"], {
      ...
      children: [(0, r.jsx)("div", {
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(ei.Z, {
            ...
            skuId: S.skuId
          }), T.isPurchased || T.isPartiallyOwnedBundle ? (0, r.jsx)(ee.U, {
          ...
          children: !en || w || ec ? M ? y ? (0, r.jsx)(h.zxk, {
            className: eE.button,
            look: h.zxk.Looks.FILLED,
            onClick: em,
            submitting: eh,
            ...
            children: ey.map((e, t) => {
              let n = 0 === t;
              return e.currency === ek.pK.DISCORD_ORB ? eD(e, n) : eM(e, n)
            })
          }) : null : (t = eO.intl.string(eO.t.sEAnVF), (0, r.jsx)(E.Z, {
          ...
          className: l()(eE.disclaimer, !et && eE.disclaimerLight),
          variant: "text-xxs/normal",
          children: en && !y ? eO.intl.string(eO.t.nKdAlJ) : null
        })]
      })]
    })
  },
  ...
  eM = e => {
    let {
      product: t,
      user: n
    } = e, i = U.ZP.canUsePremiumProfileCustomization(n), a = (0, p.cj)([Z.Z], () => Z.Z.getAllPending()), {
      pendingAvatar: l
    } = a, s = function(e, t) {
      if (null == e) return {};
    ...
    return (0, r.jsx)("div", {
      ...
      children: (null == u ? void 0 : u.type) === d.Z.NAMEPLATE ? (0, r.jsx)(eD, {
        user: n,
        nameplate: u
      }) : (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(N.Z, eS(eN({}, s), {
          pendingAvatar: o,
          user: n,
  ...
  eH = e => {
    let {
      ...
      tab: v
    } = e, b = (0, p.e7)([B.default], () => B.default.getCurrentUser()), P = (0, eg.f)(a), {
      previewingVariantIndex: C
    } = P, j = (0, p.e7)([F.Z], () => F.Z.purchases), _ = (0, G.o)(a, j), w = (0, eb.N)(a, C), I = (0, eP.W)(a, _);
    ...
    }, [c, k, I.skuId, I.items, S]);
    let T = (0, A.r)(),
      L = t === h.Dvm.EXITING;
    if (null == b) return null;
    let R = (0, e_.ZS)(l.skuId);
    return (0, r.jsx)(g.Gt, {
      value: k,
      children: (0, r.jsx)(h.Y0X, {
        ...
        children: (0, r.jsxs)(h.hzk, {
          ...
          children: [(0, r.jsx)(eZ, {
            ...
            }), (0, e_.o0)(a.skuId) ? a.skuId === e_.Vt.ORB_PROFILE_BADGE ? T || L ? null : (0, r.jsx)(ed.M, {
              user: b
