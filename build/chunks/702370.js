...
let eL = e => {
  ...
  eA = e => {
    ...
    return t === m.a.PREMIUM_TIER_2_3_DAY ? (0, r.jsx)(v.Text, {
      ...
      children: eS.intl.format(eS.t.Q1scdH, {
        helpdeskArticle: z.Z.getArticleURL(eI.BhN.FRACTIONAL_PREMIUM_ABOUT)
      })
    }) : null
  },
  eB = e => {
    ...
    let N = (0, $.L)(n),
      ...
      z = (0, f.e7)([G.Z], () => G.Z.isClaiming === (null == k ? void 0 : k.skuId)),
      V = (0, x.ZP)(),
      q = (0, p.wj)(V),
      en = (0, W.G1)(k),
      er = (0, W.ql)(k, eI.tuJ.DEFAULT),
      ei = (null == er ? void 0 : er.amount) === 0,
      {
        firstAvatarDecoration: ed
      } = (0, ee.Rj)(null != y ? y : k),
      em = i.useMemo(() => (0, W.BH)(k, O), [k, O]),
      {
        handleUseNow: ef,
        isApplying: ep
      } = (0, Y.W)({
    ...
    let eD = (e, t) => {
        ...
        return (0, r.jsx)(v.ua7, {
          ...
          shouldShow: a,
          "aria-label": !1,
          children: i => (0, r.jsx)(h.zx, eT(eN({}, i), {
      ...
      eM = (e, t) => {
        let n = !en && !ei && !u.tq && !eL && M,
          ...
          a = (0, W.x6)(k) ? eS.intl.string(eS.t.V1AWw8) : k.type === d.Z.PROFILE_EFFECT ? eS.intl.string(eS.t.kAeDcH) : k.type === d.Z.NAMEPLATE ? eS.intl.string(eS.t.H3vhqa) : eS.intl.string(eS.t.AQ0Ven),
          l = eC ? eS.intl.formatToPlainString(eS.t["cNSL/v"], {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)("div", {
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: en && !T ? eS.intl.string(eS.t.nKdAlJ) : null
        })]
      })]
    })
  },
  ...
  ez = e => {
    let {
      product: t,
      user: n
    } = e, i = F.ZP.canUsePremiumProfileCustomization(n), a = (0, f.cj)([B.Z], () => B.Z.getAllPending()), {
      pendingAvatar: l
    } = a, o = function(e, t) {
      if (null == e) return {};
  ...
  eH = e => {
    let {
      ...
      tab: h
    } = e, b = (0, f.e7)([D.default], () => D.default.getCurrentUser()), P = (0, ej.f)(a), {
      previewingVariantIndex: x
    } = P, j = (0, f.e7)([G.Z], () => G.Z.purchases), _ = (0, V.o)(a, j), w = (0, ex.N)(a, x), O = (0, eg.W)(a, _);
    s()(null != O, "Selected product should not be null");
    let {
      analyticsLocations: I
    } = (0, C.ZP)([...u, g.Z.COLLECTIBLES_SHOP_DETAILS_MODAL]);
    (0, ei.u9)(O.skuId);
    ...
    let k = i.useMemo(() => (0, W.jm)(a.type, a.skuId), [a.type, a.skuId]);
    i.useEffect(() => {
      ...
      children: (0, r.jsx)(v.Y0X, {
        ...
        children: (0, r.jsxs)(v.hzk, {
          ...
          children: [(0, r.jsx)(eB, {
            ...
            className: O.skuId === m.a.PREMIUM_TIER_2_3_DAY ? ek.fractionalNitroPreviewContainer : O.type === d.Z.AVATAR_DECORATION ? ek.collectiblePreviewsContainerWithChat : ek.collectiblePreviewsContainerNoChat,
            children: [(0, r.jsx)(en.Z, {
              asset: E,
              size: (0, ed.ML)(540),
              className: ek.categoryBanner,
              categoryBannerOverride: R
            }), (0, eO.o0)(a.skuId) ? a.skuId === eO.Vt.ORB_PROFILE_BADGE ? N || T ? null : (0, r.jsx)(ef.M, {
              user: b
            }) : a.skuId === m.a.PREMIUM_TIER_2_3_DAY ? (0, r.jsx)(em.q, {}) : (0, r.jsx)(ep.b, {
              product: a,
