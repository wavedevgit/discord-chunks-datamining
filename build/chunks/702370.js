...
let eS = e => {
  ...
  eL = e => {
    ...
    return (0, V.x6)(t) ? (0, r.jsx)(ey, {
      product: t,
      user: n
    }) : (0, ej.o0)(t.skuId) ? (0, r.jsx)(em.b, {
  ...
  eR = e => {
    ...
    return t === m.a.PREMIUM_TIER_2_3_DAY ? (0, r.jsx)(f.Text, {
      variant: "text-sm/normal",
  ...
  eZ = e => {
    ...
    let eA = (e, t) => {
        ...
        return (0, r.jsx)(f.ua7, {
          ...
          shouldShow: l,
          "aria-label": !1,
          children: i => (0, r.jsx)(f.zxk, eT(eN({}, i), {
      ...
      eB = (e, t) => {
        let n = !et && !er && !u.tq && !eS && D,
          ...
          a = eb ? eO.intl.formatToPlainString(eO.t["cNSL/v"], {
  ...
  eD = e => {
    let {
      product: t,
      user: n
    } = e, i = U.ZP.canUsePremiumProfileCustomization(n), l = (0, p.cj)([A.Z], () => A.Z.getAllPending()), {
      pendingAvatar: a
    } = l, s = function(e, t) {
      if (null == e) return {};
  ...
  ez = e => {
    let {
      ...
      tab: v
    } = e, P = (0, p.e7)([B.default], () => B.default.getCurrentUser()), x = (0, eg.f)(l), {
      previewingVariantIndex: C
    } = x, _ = (0, p.e7)([H.Z], () => H.Z.purchases), j = (0, G.o)(l, _), w = (0, eP.N)(l, C), I = (0, ex.W)(l, j);
    o()(null != I, "Selected product should not be null");
    let {
      analyticsLocations: k
    } = (0, g.ZP)([...u, b.Z.COLLECTIBLES_SHOP_DETAILS_MODAL]);
    (0, er.u9)(I.skuId);
      ...
      children: (0, r.jsx)(f.Y0X, {
        ...
        children: (0, r.jsxs)(f.hzk, {
          ...
          children: [(0, r.jsx)(eZ, {
            ...
            }), (0, ej.o0)(l.skuId) ? l.skuId === ej.Vt.ORB_PROFILE_BADGE ? S || L ? null : (0, r.jsx)(ed.M, {
              user: P
