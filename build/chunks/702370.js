...
let eN = {
  ...
  eL = e => {
    ...
    return (0, G.x6)(t) ? (0, r.jsx)(ey, {
      product: t,
      user: n
    }) : (0, ej.o0)(t.skuId) ? (0, r.jsx)(ed.b, {
  ...
  eR = e => {
    ...
    return t === m.a.PREMIUM_TIER_2_3_DAY ? (0, r.jsx)(h.Text, {
      ...
      children: ek.intl.format(ek.t.Q1scdH, {
        helpdeskArticle: D.Z.getArticleURL(e_.BhN.FRACTIONAL_PREMIUM_ABOUT)
      })
    }) : null
  },
  eA = e => {
    ...
    let eZ = (e, t) => {
        let n = () => {
          ...
          i = Z ? ek.intl.string(ek.t.cTdr39) : ek.intl.string(ek.t.zqh7ZG),
          a = !ey || Z;
        return (0, r.jsx)(h.ua7, {
          ...
          shouldShow: a,
          "aria-label": !1,
          children: i => (0, r.jsx)(h.zxk, eS(eE({}, i), {
      ...
      eB = (e, t) => {
        let n = !et && !eo && !u.tq && !eT && D && S.type !== d.Z.NAMEPLATE,
          ...
          l = ex ? ek.intl.formatToPlainString(ek.t["cNSL/v"], {
      ...
      children: [(0, r.jsx)("div", {
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(er.Z, {
            ...
            skuId: S.skuId
          }), N.isPurchased || N.isPartiallyOwnedBundle ? (0, r.jsx)($.U, {
          ...
          children: !et || w || eo ? D ? T ? (0, r.jsx)(h.zxk, {
            className: eO.button,
            look: h.zxk.Looks.FILLED,
            onClick: ed,
            submitting: ef,
            ...
            children: eN.map((e, t) => {
              let n = 0 === t;
              return e.currency === eI.pK.DISCORD_ORB ? eZ(e, n) : eB(e, n)
            })
          }) : null : (t = ek.intl.string(ek.t.sEAnVF), (0, r.jsx)(O.Z, {
  ...
  eD = e => {
    let {
      product: t,
      user: n
    } = e, i = M.ZP.canUsePremiumProfileCustomization(n), a = (0, p.cj)([A.Z], () => A.Z.getAllPending()), {
      pendingAvatar: l
    } = a, s = function(e, t) {
      if (null == e) return {};
  ...
  ez = e => {
    let {
      ...
      tab: v
    } = e, b = (0, p.e7)([Z.default], () => Z.default.getCurrentUser()), P = (0, ex.f)(a), {
      previewingVariantIndex: C
    } = P, j = (0, p.e7)([H.Z], () => H.Z.purchases), _ = (0, F.o)(a, j), w = (0, ev.N)(a, C), I = (0, eb.W)(a, _);
      ...
      children: (0, r.jsx)(h.Y0X, {
        ...
        children: (0, r.jsxs)(h.hzk, {
          ...
          children: [(0, r.jsx)(eA, {
            ...
            }), (0, ej.o0)(a.skuId) ? a.skuId === ej.Vt.ORB_PROFILE_BADGE ? y || L ? null : (0, r.jsx)(eu.M, {
              user: b
