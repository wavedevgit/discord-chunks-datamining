...
let P = 490,
  ...
  M = Chunk73800.forwardRef(function(e, t) {
    ...
    let eo = <_.ZP id={V} className={a()(I.autocomplete, et)} innerClassName={I.autocompleteInner} onMouseDown={e => e.preventDefault()}><s.bG navigator={z}><s.SJ>{e => {
            var {
              ref: t
            } = e, n = C(e, ["ref"]);
    ...
    return null != Q ? <q><c.jRF targetRef={e.targetRef} overrideTargetRect={Q} positionKey={$} position={null != (k = e.position) ? k : "top"} align={"left"} spacing={8} autoInvert={true} nudgeAlignIntoViewport={true}>{() => eo}</c.jRF></q> : eo
  })