...
function s(e) {
  ...
  (0, l.useEffect)(() => {
    ...
    r.backgroundColor = c, r.textColor = d, r.gridColor = f, r.timeOptions = {
      timeStyle: "short"
    }, r.fontFamily = "gg sans", r.fontSize = 11, u.setColor(h), r.addDataSeries(u), r.updateEndDate(), s(r)
  }, [t, c, h, f, d, u]), u.setPoints(e.dataPoints), null == n || n.updateEndDate();
  let p = {
    width: e.width,
    height: e.height
  };
