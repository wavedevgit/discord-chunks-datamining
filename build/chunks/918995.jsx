...
class l extends Chunk73800.Component {
  render() {
    ...
    return <Chunk233787.C transitionState={module} onClose={async () => await this.cancel()} aria-label={Chunk388032.intl.string(Chunk388032.t.Nn0Px8)} title={Chunk388032.intl.string(Chunk388032.t.Nn0Px8)} premiumModalType={Chunk233787.C.Types.UNCLAIMED} primary={{
      ...
      }}>{Chunk388032.intl.string(Chunk388032.t["7btfmJ"])}</Chunk233787.C>
  }
  constructor(...e) {
