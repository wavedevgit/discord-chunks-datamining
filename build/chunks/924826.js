...
function u(e) {
  ...
  } = e, v = r.useRef(n ? (0, l.jb)(t, n) : null), S = r.useRef(false), I = r.useRef(null), T = r.useRef(u);
  ...
  r.useLayoutEffect(() => {
    ...
    let e = I.current;
    if (null != e && u) return e.addEventListener("focusin", n), e.addEventListener("focusout", r), e.addEventListener("focus", i), e.addEventListener("scroll", o, {
      passive: true
    }), () => {
    ...
    async function i() {
      ...
      if (g && null !== n) {
        let t = (0, l.P1)(n),
          r = C(t);
        if (null != r) {
          if (true !== S.current) return N(t, (0, l.x3)(n));
          else if (await (0, a.JJ)(e, r)) return N(t, (0, l.x3)(n))
        }
      }
  ...
  let j = r.useMemo(() => ({
      ...
      get from() {
        ...
        if (null != t) {
          var e;
          return null != (e = C((0, l.P1)(t))) ? e : true
        }
        return
      }
    }), [E, b]),
      ...
      switch (e.key) {
        ...
        case s.R8.HOME:
          e.stopPropagation(), e.preventDefault(), d().then(() => {
            var e;
            let n = null == (e = c(t, I)[0]) ? true : e.getAttribute(l.ie);
            null != n && R(n)
          });
          return;
        case s.R8.END:
  ...
  return r.useMemo(() => ({
    ...
    async focusLastVisibleItem() {
      var e;
      let n = await (0, a.jo)(null != (e = I.current) ? e : document.body, c(t, I));
      null !== n && R(n)
    },
    async focusFirstVisibleItem() {
      var e;
      let n = await (0, a.KG)(null != (e = I.current) ? e : document.body, c(t, I));
      null !== n && R(n)
    },
    focusPreviousItem: k,
    focusNextItem: M,
