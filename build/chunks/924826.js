...
function u(e) {
  ...
  let M = r.useMemo(() => ({
    ...
    U = r.useCallback(e => {
      ...
      let n = v === s.hy.HORIZONTAL ? s.R8.RIGHT : s.R8.DOWN,
        r = v === s.hy.HORIZONTAL ? s.R8.LEFT : s.R8.UP;
      switch (e.key) {
        case n:
        ...
        case s.R8.HOME:
          e.stopPropagation(), e.preventDefault(), d().then(() => {
            var e;
            let n = null === (e = c(t, S)[0]) || void 0 === e ? void 0 : e.getAttribute(l.ie);
            null != n && P(n)
          });
          return;
        case s.R8.END:
  ...
  return r.useMemo(() => ({
    ...
    async focusLastVisibleItem() {
      var e;
      let n = await (0, a.jo)(null !== (e = S.current) && void 0 !== e ? e : document.body, c(t, S));
      null !== n && P(n)
    },
    async focusFirstVisibleItem() {
      var e;
      let n = await (0, a.KG)(null !== (e = S.current) && void 0 !== e ? e : document.body, c(t, S));
      null !== n && P(n)
    },
    focusPreviousItem: j,
    focusNextItem: k,
