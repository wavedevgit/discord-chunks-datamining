...
function K(e) {
  ...
  let O = null != n && (0, v.Z)(n, G.xjy.JOIN),
    E = async e => {
      if (null != a && "unsent" === s) {
        ...
        try {
          if (c("sending"), O) await f.Z.sendActivityInviteUser({
            ...
            l()(null != n, "Send channel must be defined"), (0, C.uL)(G.Z5c.CHANNEL(n.guild_id, n.id)), (0, b.i)(G.IlC.OVERLAY, !0), "fake_inventory_item" in t.extra && !0 === t.extra.fake_inventory_item ? await (0, S.k)({
              channel: n,
      ...
      l()(null != n, "Send channel must be defined"), (0, C.uL)(G.Z5c.CHANNEL(n.guild_id, n.id)), (0, b.i)(G.IlC.OVERLAY, !0), (0, W.Ws)(G.Odu.ACTIVITY, {
        type: W.Qu.REDIRECT,
        value: W.bk.CHAT,
        userId: a.id
      })
    }, x = O ? B.intl.string(B.t["3fRyS0"]) : B.intl.string(B.t.XHxDIS), I = O ? (0, i.jsx)(p.ejJ, {
      color: "currentColor",
      size: "sm"
    }) : (0, i.jsx)(p.Uuj, {
      color: "currentColor",
...
function X(e) {
  ...
  } = e, l = (0, u.e7)([R.default], () => R.default.getUser(n.author_id)), a = null != (t = null == o ? void 0 : o.application_id) ? t : n.extra.application_id, s = (0, u.e7)([k.Z], () => null != l ? k.Z.getApplicationActivity(l.id, a) : null, [a, l]), [c, h] = r.useState("unsent");
...
function en(e) {
  ...
  } = e, o = null != t && (0, v.Z)(t, G.xjy.JOIN), l = (0, E.q)(null == t ? void 0 : t.application_id), a = null != l && (0, z.yE)(l.flags, G.udG.EMBEDDED);
  return null == t || null == n ? null : (0, i.jsxs)(i.Fragment, {
    children: [(0, i.jsx)(Z.Z, {
      ...
      onClick: () => {
        (0, h.h7)(t, !1, G.IlC.POPOUT), (0, W.Ws)(G.Odu.ACTIVITY, {
          type: W.Qu.INVITE,
...
function ei(e) {
  let {
    locked: t
  } = e, n = (0, F.II)(), r = null == n ? void 0 : n.id, o = null == n ? void 0 : n.altId, l = (0, I.Z)(r, "ActivityWidget"), a = (0, u.e7)([R.default], () => R.default.getCurrentUser()), s = null != o ? o : r, c = (0, u.e7)([A.Z], () => null == s ? null : A.Z.getApplicationActivity(s), [s]);
  (0, O.ZP)(() => (j.L(), () => j.v()));
  let d = ee({
    gamingId: s,
