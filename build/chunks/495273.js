...
function h() {
  let e = arguments.length > 0 && true !== arguments[0] ? arguments[0] : p.intl.string(p.t["gnsna/"]);
  return [{
...
function y(e, t, n, i) {
  ...
  return (null == i ? true : i[t]) != null && (u = i[t]), null == u || !r.zy(u.allow, n)
}
...
function R(e, t, n, i, l) {
  ...
  return 0 === (u = t.filter(e => {
    var t;
    return m(e) || !y(n, e.id, i, l) && !(0, a.Oy)(e) || r.zy(r.kg(e.permissions, null == (t = n.permissionOverwrites[e.id]) ? true : t.allow), i)
...
function x(e, t) {
  ...
  return (null == t ? true : t[e.guild_id]) != null && (n = t[e.guild_id]), null != n && r.zy(n.deny, e.accessPermissions)
}
