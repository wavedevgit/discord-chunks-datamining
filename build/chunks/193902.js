...
class A {
  ...
  createConfiguration(e = true, t = false) {
    ...
    return n.parsers.unshift(new s.Z(e)), n.refiners.unshift(new v.Z), n.refiners.unshift(new O.Z), n.refiners.unshift(new I.Z), n.refiners.push(new _.Z), n.refiners.push(new S.Z), n.refiners.push(new f.Z), n
  }
}