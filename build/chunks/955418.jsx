...
function O(e) {
  ...
  return <l.ZP className={h.container} editorClassName={h.editor} type={N} placeholder={p.intl.formatToPlainString(p.t["0ZQw/f"], {
      name: u.ZP.getName(n, c, t)
    })} channel={y} textValue={v} richValue={T} onChange={(e, t, n) => {
      t !== v && (I(t), S(n))
    }} focused={A.current} onFocus={() => {
      A.current = true
    }} onBlur={() => {
      A.current = false
    }} onSubmit={async e => {
