...
class V extends i.Component {
  ...
  renderButton(e) {
    ...
    return (e.redeemed || a || e.isClaimed || !n.verified) && (l.color = u.zxk.Colors.BRAND, l.disabled = !0), (0, r.jsx)(u.zxk, B(F({}, l), {
  ...
  renderBody(e) {
    ...
    let o = r.isPreorder() ? M.NW.formatToPlainString(M.t.evinTU, {
      name: r.name
    }) : r.name;
...
let z = (0, f.Z)((0, m.Z)(V)),
  K = c.ZP.connectStores([O.Z, I.Z, C.default, j.Z, S.Z, N.default, h.Z], e => {
    let {
      ...
      author: n,
      currentUser: r
    } = e, i = O.Z.get(t), l = null != i ? I.Z.get(i.skuId) : null, a = null != i && null != i.userId ? C.default.getUser(i.userId) : null, o = h.Z.useReducedMotion;
    return {
      sku: l,
      giftCode: i,
      gifter: a,
