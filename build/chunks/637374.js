...
class W extends i.Component {
  ...
  constructor(...e) {
    super(...e), B(this, "handleViewLibrary", e => {
      ...
      e.preventDefault(), null != t && t.isHidden() ? (0, y.uL)(k.Z5c.APPLICATION_LIBRARY_SETTINGS) : (0, y.uL)(k.Z5c.APPLICATION_LIBRARY, {
        state: {
...
let K = (0, g.Z)((0, f.Z)(W)),
  Y = c.ZP.connectStores([j.Z, N.Z, S.default, I.Z, T.Z, O.default, _.Z], e => {
    let {
      ...
      author: n,
      currentUser: r
    } = e, i = j.Z.get(t), l = null != i ? N.Z.get(i.skuId) : null, a = null != i && null != i.userId ? S.default.getUser(i.userId) : null, o = _.Z.useReducedMotion;
    return {
      sku: l,
      giftCode: i,
      gifter: a,
