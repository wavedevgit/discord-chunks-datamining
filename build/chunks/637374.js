...
function H(e) {
  ...
  return (0, r.jsxs)(u.P3F, {
    ...
    children: [(0, r.jsx)(u.vqy, {
      ...
      children: n.isHidden() ? L.intl.string(L.t.Wi99Rk) : L.intl.string(L.t["+tXad3"])
    })]
  })
}
class V extends i.PureComponent {
  ...
  constructor(...e) {
    ...
    })), F(this, "renderTitle", () => this.props.isSelfGift ? L.intl.string(L.t["mT9B4+"]) : L.intl.string(L.t.Vo5yHx)), F(this, "renderActions", () => this.props.isSelfGift ? (0, r.jsx)(u.zxk, {
...
class z extends i.Component {
    ...
    return (0, r.jsxs)(_.Z, {
      ...
      children: [(0, r.jsxs)(_.Z, {
        ...
        children: [e.hasMultipleCopies ? (0, r.jsx)("div", {
          ...
          children: L.intl.format(L.t.nZBvUV, {
  ...
  renderTitle(e) {
    ...
    return this.isCustomGiftMessage() && !n ? L.intl.formatToPlainString(L.t.t1SOIS, {
      recipientDisplayName: R.ZP.getName(t)
    }) : null == r ? null : e.isSubscription ? n ? L.intl.string(L.t["2PJ1ND"]) : L.intl.string(L.t.hrnGnp) : n ? L.intl.string(L.t.QLEMlZ) : L.intl.string(L.t.W4DBc3)
  }
  renderBody(e) {
    let {
      libraryApplication: t,
    ...
    let o = r.isPreorder() ? L.intl.formatToPlainString(L.t.evinTU, {
      name: r.name
    }) : r.name;
    if (e.redeemed) return e.isSubscription || (0, g.mO)(e) ? L.intl.string(L.t.mVC3Cg) : L.intl.format(L.t["ss/L+/"], {
      skuName: o,
      onViewInLibrary: this.handleViewLibrary
    });
    if (!e.isSubscription && null != t) return L.intl.format(L.t.UdXO8P, {
      skuName: o,
      onViewInLibrary: this.handleViewLibrary
    });
    if (e.isClaimed) return L.intl.string(L.t.ARWFQU);
    if (!a.verified) return L.intl.format(L.t.GQxl7u, {
      onClick: this.handleVerificationClick
    });
    if (n) return e.isSelfRedeemable ? L.intl.string(L.t["lQI+cH"]) : L.intl.formatToPlainString(L.t["A+etHx"], {
      skuName: o
    });
    if (e.isExistingPremiumSubscriptionDisallowed) return L.intl.string(L.t["UCIU9/"]);
    if (e.hasMultipleCopies) return null != i ? e.isSubscription ? L.intl.format(L.t.l3VxgI, {
      ...
      skuName: o
    }) : e.isSubscription ? L.intl.formatToPlainString(L.t.svrO3d, {
      maxUses: e.maxUses,
      skuName: o
    ...
    return null != i ? L.intl.format(L.t["3HsdQ0"], {
      username: R.ZP.getUserTag(i)
    }) : L.intl.string(L.t.Jdnjjo)
  }
  ...
  constructor(...e) {
    super(...e), F(this, "handleViewLibrary", e => {
      ...
      return (0, r.jsxs)("div", {
        className: l,
        children: [!t && M.eZ.includes(e.giftStyle) && (0, r.jsx)(x.Z, {
          className: U.snow,
          wind: 5
        }), i && (0, r.jsx)(T.Z, {
...
let W = (0, f.Z)((0, m.Z)(z)),
  K = c.ZP.connectStores([C.Z, N.Z, S.default, j.Z, I.Z, O.default, h.Z], e => {
    let {
      ...
      author: n,
      currentUser: r
    } = e, i = C.Z.get(t), l = null != i ? N.Z.get(i.skuId) : null, a = null != i && null != i.userId ? S.default.getUser(i.userId) : null, o = h.Z.useReducedMotion;
    return {
      sku: l,
      giftCode: i,
      gifter: a,
