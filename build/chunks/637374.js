...
function H(e) {
  ...
  return (0, r.jsxs)(u.P3F, {
    ...
    children: [(0, r.jsx)(u.vqy, {
      ...
      children: n.isHidden() ? M.intl.string(M.t.Wi99Rk) : M.intl.string(M.t["+tXad3"])
    })]
  })
}
class V extends i.PureComponent {
  ...
  constructor(...e) {
    ...
    })), F(this, "renderTitle", () => this.props.isSelfGift ? M.intl.string(M.t["mT9B4+"]) : M.intl.string(M.t.Vo5yHx)), F(this, "renderActions", () => this.props.isSelfGift ? (0, r.jsx)(u.zxk, {
...
class z extends i.Component {
    ...
    return (0, r.jsxs)(h.Z, {
      ...
      children: [(0, r.jsxs)(h.Z, {
        ...
        children: [e.hasMultipleCopies ? (0, r.jsx)("div", {
          ...
          children: M.intl.format(M.t.nZBvUV, {
  ...
  renderButton(e) {
    ...
    return (e.redeemed || a || e.isClaimed || !n.verified) && (l.color = u.zxk.Colors.BRAND, l.disabled = !0), (0, r.jsx)(u.zxk, G(B({}, l), {
  ...
  renderTitle(e) {
    ...
    return this.isCustomGiftMessage() && !n ? M.intl.formatToPlainString(M.t.t1SOIS, {
      recipientDisplayName: R.ZP.getName(t)
    }) : null == r ? null : e.isSubscription ? n ? M.intl.string(M.t["2PJ1ND"]) : M.intl.string(M.t.hrnGnp) : n ? M.intl.string(M.t.QLEMlZ) : M.intl.string(M.t.W4DBc3)
  }
  renderBody(e) {
    let {
      libraryApplication: t,
    ...
    let o = r.isPreorder() ? M.intl.formatToPlainString(M.t.evinTU, {
      name: r.name
    }) : r.name;
    if (e.redeemed) return e.isSubscription || (0, _.mO)(e) ? M.intl.string(M.t.mVC3Cg) : M.intl.format(M.t["ss/L+/"], {
      skuName: o,
      onViewInLibrary: this.handleViewLibrary
    });
    if (!e.isSubscription && null != t) return M.intl.format(M.t.UdXO8P, {
      skuName: o,
      onViewInLibrary: this.handleViewLibrary
    });
    if (e.isClaimed) return M.intl.string(M.t.ARWFQU);
    if (!a.verified) return M.intl.format(M.t.GQxl7u, {
      onClick: this.handleVerificationClick
    });
    if (n) return e.isSelfRedeemable ? M.intl.string(M.t["lQI+cH"]) : M.intl.formatToPlainString(M.t["A+etHx"], {
      skuName: o
    });
    if (e.isExistingPremiumSubscriptionDisallowed) return M.intl.string(M.t["UCIU9/"]);
    if (e.hasMultipleCopies) return null != i ? e.isSubscription ? M.intl.format(M.t.l3VxgI, {
      ...
      skuName: o
    }) : e.isSubscription ? M.intl.formatToPlainString(M.t.svrO3d, {
      maxUses: e.maxUses,
      skuName: o
    ...
    return null != i ? M.intl.format(M.t["3HsdQ0"], {
      username: R.ZP.getUserTag(i)
    }) : M.intl.string(M.t.Jdnjjo)
  }
  ...
  render() {
    ...
    if (null == e || e.revoked)
      if (t) return (0, r.jsx)(V, {
        isSelfGift: i,
        width: n
      });
      else return (0, r.jsx)(p.OR, {
        isHorizontal: n >= p.aL
      });
    return (0, _.mO)(e) ? (0, r.jsx)("div", {
  ...
  constructor(...e) {
    super(...e), F(this, "handleViewLibrary", e => {
      ...
      e.preventDefault(), null != t && t.isHidden() ? (0, C.uL)(L.Z5c.APPLICATION_LIBRARY_SETTINGS) : (0, C.uL)(L.Z5c.APPLICATION_LIBRARY, {
        state: {
...
let W = (0, f.Z)((0, m.Z)(z)),
  K = c.ZP.connectStores([O.Z, T.Z, I.default, j.Z, S.Z, v.default, g.Z], e => {
    let {
      ...
      author: n,
      currentUser: r
    } = e, i = O.Z.get(t), l = null != i ? T.Z.get(i.skuId) : null, a = null != i && null != i.userId ? I.default.getUser(i.userId) : null, o = g.Z.useReducedMotion;
    return {
      sku: l,
      giftCode: i,
      gifter: a,
