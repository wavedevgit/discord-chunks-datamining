...
let E = {
  ...
  renderResults(e) {
    ...
    return m.mentions.user === u.h3.DENY ? (t = f.t.MLiD1d, n = f.NW.string(f.t.LPJmLy)) : (t = f.t.rPNimp, n = f.NW.string(f.t["9Oq93t"])), (0, r.jsxs)(i.Fragment, {
      ...
      }), b, o.length > 0 && s.length > 0 ? (0, r.jsx)(a.ZP.Divider, {}) : null, y, o.length > 0 && l.length > 0 || s.length > 0 && l.length > 0 ? (0, r.jsx)(a.ZP.Divider, {}) : null, v]
    }, "mentions")
  },
  onSelect(e) {
    let {
    ...
    return null != s ? a.insertText(_(s.user, o, a.hidePersonalInformation), p(s.user)) : null != l ? a.insertText(h(l)) : null != c && a.insertText(m(c), g(c)), {
      type: u.z2.MENTION
    }
  }
}