...
function P(e) {
  ...
  return null == l || y(n) || (null == n || null == (t = n.guild) ? void 0 : t.id) === f.fQ ? null : (0, r.jsx)(a.EJ, {
...
function A(e) {
  let {
    invite: t,
    showBigUserIcon: n
  } = e, s = i.useMemo(() => n ? null : E(t) && null != t.target_user ? h.ZP.getUserAvatarURL(t.target_user) : y(t) && null != t.inviter ? h.ZP.getUserAvatarURL(t.inviter) : null, [t, n]), o = _.NW.string(_.t["3rE1Pz"]);
  if (v(t)) {
    var c, u;
    o = (null == (c = t.channel) ? void 0 : c.name) != null && (null == (u = t.inviter) ? void 0 : u.username) != null ? _.NW.format(_.t.Lu4h19, {
      username: t.inviter.username
    }) : _.NW.string(_.t.OsdY8P)
  } else E(t) && null != t.target_user ? o = _.NW.formatToPlainString(_.t.x2L32d, {
    username: t.target_user.username
  }) : O(t) ? o = _.NW.string(_.t["FDsl+P"]) : y(t) && null != t.inviter && (o = _.NW.format(_.t.spU2mJ, {
...
function T(e) {
  ...
  if (null != o) p && null == h && (t = (0, r.jsx)(a.Vj, {
    guild: o,
