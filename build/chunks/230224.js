...
function T(e) {
  ...
  return null == o || j(n) || (null == n || null == (t = n.guild) ? void 0 : t.id) === f.fQ ? null : (0, r.jsx)(s.EJ, {
...
function A(e) {
  let {
    invite: t,
    showBigUserIcon: n
  } = e, l = i.useMemo(() => n ? null : v(t) && null != t.target_user ? h.ZP.getUserAvatarURL(t.target_user) : j(t) && null != t.inviter ? h.ZP.getUserAvatarURL(t.inviter) : null, [t, n]), a = _.intl.string(_.t["3rE1Pz"]);
  if (I(t)) {
    var c, u;
  ...
  }) : N(t) ? a = _.intl.string(_.t["FDsl+P"]) : j(t) && null != t.inviter && (a = _.intl.format(_.t.spU2mJ, {
