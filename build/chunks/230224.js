...
function P(e) {
  let {
    invite: t,
    showBigUserIcon: n
  } = e, o = i.useMemo(() => n ? null : v(t) && null != t.target_user ? h.ZP.getUserAvatarURL(t.target_user) : O(t) && null != t.inviter ? h.ZP.getUserAvatarURL(t.inviter) : null, [t, n]), a = f.NW.string(f.t["3rE1Pz"]);
  if (E(t)) {
    var c, u;
...
function A(e) {
  ...
  if (null != a) g && null == h && (t = (0, r.jsx)(l.Vj, {
    guild: a,
