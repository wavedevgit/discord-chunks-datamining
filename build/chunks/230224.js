...
function P(e) {
  ...
  return null == o || y(n) || (null == n || null == (t = n.guild) ? void 0 : t.id) === m.fQ ? null : (0, r.jsx)(a.EJ, {
...
function A(e) {
  let {
    invite: t,
    showBigUserIcon: n
  } = e, s = i.useMemo(() => n ? null : E(t) && null != t.target_user ? h.ZP.getUserAvatarURL(t.target_user) : y(t) && null != t.inviter ? h.ZP.getUserAvatarURL(t.inviter) : null, [t, n]), l = _.NW.string(_.t["3rE1Pz"]);
  if (v(t)) {
    var c, u;
    l = (null == (c = t.channel) ? void 0 : c.name) != null && (null == (u = t.inviter) ? void 0 : u.username) != null ? _.NW.format(_.t.Lu4h19, {
      username: t.inviter.username
    }) : _.NW.string(_.t.OsdY8P)
  } else E(t) && null != t.target_user ? l = _.NW.formatToPlainString(_.t.x2L32d, {
    username: t.target_user.username
  }) : O(t) ? l = _.NW.string(_.t["FDsl+P"]) : y(t) && null != t.inviter && (l = _.NW.format(_.t.spU2mJ, {
...
function T(e) {
  ...
  if (null != l) g && null == h && (t = (0, r.jsx)(a.Vj, {
    guild: l,
    size: a.Vj.Sizes.SMALL
  })), n = l.name, null != h && (n = h.name, i = (0, r.jsxs)("div", {
    className: N.inviteJoinContainer,
