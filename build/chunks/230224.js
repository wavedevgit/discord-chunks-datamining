...
function T(e) {
  ...
  return null == o || y(n) || (null == n || null == (t = n.guild) ? void 0 : t.id) === f.fQ ? null : (0, r.jsx)(a.EJ, {
...
function P(e) {
  let {
    invite: t,
    showBigUserIcon: n
  } = e, l = i.useMemo(() => n ? null : v(t) && null != t.target_user ? h.ZP.getUserAvatarURL(t.target_user) : y(t) && null != t.inviter ? h.ZP.getUserAvatarURL(t.inviter) : null, [t, n]), s = _.intl.string(_.t["3rE1Pz"]);
  if (O(t)) {
    var c, u;
