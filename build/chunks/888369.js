...
function k(e, t, n) {
  return !((0, d.bw)(e.type) && 0 === t || !g.Z.canBasicChannel((0, d.Gz)(e.type), e) || x(e, t, n) || j(e) && e.hasFlag(S.zZ.IS_GUILD_RESOURCE_CHANNEL)) && (t > 0 || b.ZP.resolveUnreadSetting(e) === I.i.ALL_MESSAGES)
}
...
function Y(e, t) {
  ...
  if (null == n) {
    ...
    for (let t in f) {
      ...
      if (!h && a) continue;
      let g = !l && (!a || h) && _;
      if ((g || h) && k(n, c, u) && (g && (r.unreadByType[I.W.CHANNEL] = !0, r.unreadChannelId = t), h)) {
