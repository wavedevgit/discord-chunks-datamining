...
function H(e, t) {
  ...
  if (t.forEach(e => {
      ...
      null !== n && !u && E.ZP.hasUnread(t.id) && M(t, a, !0) && (u = !0, i.unreadChannelId = t.id), a > 0 && M(t, a) ? i.mentionCounts[t.id] = {
        count: a,
  ...
  if (null == n) {
    ...
    for (let t in _) {
      let n = _[t],
        ...
        } = E.ZP.getGuildChannelUnreadState(n, u, a, o, l),
        h = c > 0;
      if (!h && o) continue;
      let m = !l && (!o || h) && f;
  ...
  getGuildHasUnreadIgnoreMuted(e) {
    ...
    for (let e in n)
      if (null != p.Z.getChannel(e)) {
        for (let t in n[e])
          if (E.ZP.hasUnreadOrMentions(t)) return !0
