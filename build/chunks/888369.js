...
function Z(e, t, n) {
  ...
  }), (t.unread !== n.unread || t.lowImportanceMentionCount !== n.lowImportanceMentionCount || t.highImportanceMentionCount !== n.highImportanceMentionCount) && (C[null != e ? e : N] = t, null != e && (t.unread ? P.add(e) : P.delete(e)), R++, L(null != e ? e : N), F(t, n), !0)
}
...
function W(e, t) {
  ...
  V(r);
  let f = D(n);
  return (r.unread !== f.unread || r.highImportanceMentionCount !== f.highImportanceMentionCount || r.lowImportanceMentionCount !== f.lowImportanceMentionCount) && (C[null != n ? n : N] = r, null != n && (r.unread ? P.add(n) : P.delete(n)), R++, L(null != n ? n : N), F(r, f), !0)
}
