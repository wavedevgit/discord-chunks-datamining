...
function u(e, t, n) {
  if (t === o.rV.YEAR) return s.intl.formatToPlainString(s.t["rS8FA+"], {
    price: e
  });
  if (t === o.rV.MONTH && 1 === n) return s.intl.formatToPlainString(s.t.AbOLNu, {
    price: e
  });
  if (t === o.rV.MONTH && n > 1) return s.intl.formatToPlainString(s.t["Qc+9ww"], {
    price: e,
    intervalCount: n
  });
