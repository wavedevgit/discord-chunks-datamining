...
let q = d().throttle(Chunk80932.OQ, 1e3),
  ...
  J = e => {
    ...
    return (0, r.jsx)(h.C3N, {
      label: t,
      description: V.intl.format(V.t.sgL8sL, {
        count: a
      }),
      children: l
    })
  ...
  $ = e => {
    ...
    return 0 === t.length ? (0, r.jsx)(h.ubH, {
      ...
      children: (0, r.jsx)(h.OZU, {
        children: V.intl.string(V.t.SpxYoa)
      })
    }) : (0, r.jsxs)("div", {
      role: "table",
  ...
  ee = e => {
    let t, n, i, {
      ...
      d = s.premiumTier,
      u = (0, k.FZ)(d);
    return null == u || d === H.Eu4.TIER_3 || c > 0 ? null : (c > o ? (t = V.intl.formatToPlainString(V.t.j0UH0t, {
      level: u
    }), n = V.intl.formatToPlainString(V.t.VQeyKy, {
      level: u
    }), i = H.qAy.BOOST_UPSELL_BANNER_LOST_LEVEL) : (t = V.intl.string(V.t.zT9Sxc), n = V.intl.formatToPlainString(V.t.dBZ1RU, {
      level: u
  ...
  en = () => {
    ...
    Chunk647438.useEffect(() => {
      ...
      null != Chunk80932 && Chunk80932 < Chunk599273 && q(exports.id)
    }, [Chunk599273, Chunk80932, exports.id]), Chunk647438.useEffect(() => {
      if (null != Chunk28664 && null == $) return void en(Chunk28664)
    }, [Chunk28664, $]);
    let ei = Chunk647438.useMemo(() => J.isEmojiEditingExperimentEnabled && null != $ ? new Set(d().differenceBy(Chunk28664, $, "id").map(e => e.id)) : new Set, [J.isEmojiEditingExperimentEnabled, Chunk28664, $]),
