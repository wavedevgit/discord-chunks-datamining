...
function y(e) {
  ...
  }), E = (0, i.e7)([c.Z], () => null != O ? c.Z.getMemberCount(O) : 0), S = null != j && (null != E ? E : 0) >= j, {
    approveRequest: I,
    rejectRequest: P,
    submitting: Z
  } = (0, m.s)(null == x ? void 0 : x.guildId, null == x ? void 0 : x.userId, null == x ? void 0 : x.joinRequestId);
  return null != x && x.applicationStatus === f.wB.SUBMITTED && v ? (0, r.jsxs)("div", {
    className: _.buttons,
