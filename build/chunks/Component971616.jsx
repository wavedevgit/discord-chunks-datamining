...
function S(e) {
  ...
  let j = null != t && t.planId === n,
    k = j || n === v.Xh.PREMIUM_MONTH_TIER_2 && null != t && [v.Xh.PREMIUM_YEAR_TIER_0, v.Xh.PREMIUM_YEAR_TIER_1].includes(t.planId),
    M = v.nH[n],
    {
      enabled: U
  ...
  let G = (0, g.aS)(n, false, D, S),
    ...
    W = () => null != M && !V && (0, r.jsx)(d.Text, {
      tag: "span",
      variant: "eyebrow",
      color: "always-white",
      className: T.planOptionDiscount,
      children: I.intl.format(I.t.IAybsL, {
        discount: (0, m.T3)(P, M / 100)
      })
    }),
