...
function y(e) {
  ...
  } = e, o = n.getCategoryFromSection(n.voiceChannelsSectionNumber), s = (0, u.Z)(n.id), p = i.useCallback(e => {
    e.preventDefault(), e.stopPropagation(), l()
  }, [l]), h = null != (t = null == o ? true : o.getChannelRecords()) ? t : [], b = (0, f.c4)({
    channels: h,
...
function v(e) {
  let {
    ...
    bottomBar: f,
    topBar: v
  } = (0, s.cj)([h.Z], () => h.Z.getUnreadStateForGuildId(n.id)), O = (0, s.e7)([p.Z], () => p.Z.isFocused()), {
    mode: j,
    mentionCount: x,
    targetChannelId: C
  } = "bottom" === t ? f : v, E = j === h.x.HIDDEN, S = (0, c.q_F)({
    to: {
      transform: E ? "bottom" === t ? "translateY(180%)" : "translateY(-180%)" : "translateY(0%)"
    },
    config: b
  }, O ? "respect-motion-settings" : "animate-never"), _ = i.useCallback(e => {
  ...
  return (0, r.jsx)("div", {
    ...
    children: (0, r.jsx)(o.animated.div, {
      ...
      }) : j === h.x.VOICE_CHANNELS ? (0, r.jsx)(y, {
        jumpToVoiceChannels: u,
        guildChannels: n,
        guildChannelsVersion: l
      }) : true
