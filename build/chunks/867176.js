...
function C(e) {
  ...
  let {
    ...
    size: C,
    canAnimate: D || !j ? x : M
  }), B = (0, u.dQu)(c.Z.unsafe_rawColors.PRIMARY_800).hex(), F = n.getAvatarURL(b, (0, u.pxk)(S)), V = (0, s._i)((0, d.ZP)(F, B, !1)), Z = (0, f.Z)(null != (t = null != w ? w : null == a ? void 0 : a.primaryColor) ? t : V).hex, H = N(S), Y = H + T - R, W = P - A - R;
  return (0, r.jsxs)("svg", {
    className: y.mask,
