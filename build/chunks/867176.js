...
function C(e) {
  ...
  let {
    ...
    size: C,
    canAnimate: D || !j ? x : k
  }), B = (0, u.dQu)(c.Z.unsafe_rawColors.PRIMARY_800).hex(), Z = n.getAvatarURL(b, (0, u.pxk)(T)), F = (0, s._i)((0, d.ZP)(Z, B, !1)), V = (0, f.Z)(null != (t = null != w ? w : null == o ? void 0 : o.primaryColor) ? t : F).hex, H = N(T), Y = H + S - P, W = R - A - P;
  return (0, r.jsxs)("svg", {
    className: y.mask,
