...
let w = 512,
  ...
  F = i.forwardRef(function(e, t) {
    ...
    } = e, s = i.useRef(!1), l = i.useRef(0), [F, Z] = i.useState(0), H = i.useRef(null), [W, Y] = i.useState(!1), K = g.Xn.useStore(e => e.activeCategoryIndex);
    i.useEffect(() => {
    ...
    let ec = i.useCallback(e => {
      ...
      ef = (0, h.Dt)();
    return (0, _.KR)(ef, !0, (0, f.DJ)(F)), i.useEffect(() => () => {
      (0, _.sJ)()
    }, []), (0, r.jsxs)(f.ZP, {
      id: ef,
