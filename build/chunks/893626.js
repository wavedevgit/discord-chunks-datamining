...
function j(e) {
  ...
  let {
    ...
    welcomeMessage: _,
    onSave: y
  } = e, O = (0, u.Dt)(), [C, P] = l.useState(b({}, _)), w = (0, s.e7)([m.Z], () => m.Z.getGuild(I)), z = l.useCallback(e => {
    let t = {};
    return Promise.resolve(d.ZP.getMembers(I).filter(n => {
      var r;
    ...
    y(null), k()
  }, [y, k]), B = null != (t = C.authorIds[0]) ? t : "", Z = (0, s.e7)([d.ZP], () => null != I ? d.ZP.getMember(I, B) : null), T = (0, s.e7)([g.default], () => null != Z ? g.default.getUser(Z.userId) : null), R = null != (o = null != (n = null == Z ? void 0 : Z.nick) ? n : null == T ? void 0 : T.username) ? o : "", E = function(e) {
    ...
    return e.message.length < c.ZR ? x.intl.formatToPlainString(x.t.TJGHXl, {
      minLength: c.ZR
    }) : null
  }(C);
