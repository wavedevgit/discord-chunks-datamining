...
function j(e) {
  ...
  let {
    ...
    welcomeMessage: _,
    onSave: y
  } = e, O = (0, u.Dt)(), [P, C] = l.useState(b({}, _)), w = (0, s.e7)([m.Z], () => m.Z.getGuild(I)), z = l.useCallback(e => {
    let t = {};
    ...
    y(null), k()
  }, [y, k]), Z = null != (t = P.authorIds[0]) ? t : "", M = (0, s.e7)([d.ZP], () => null != I ? d.ZP.getMember(I, Z) : null), T = (0, s.e7)([g.default], () => null != M ? g.default.getUser(M.userId) : null), R = null != (a = null != (n = null == M ? void 0 : M.nick) ? n : null == T ? void 0 : T.username) ? a : "", E = function(e) {
