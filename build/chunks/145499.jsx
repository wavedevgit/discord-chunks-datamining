...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk399829 = require("./399829.js"),
  Chunk428862 = require("./428862.js"),
...
let w = (e, t) => e < (0, v.A3)(I.Eu4.NONE) ? I.Eu4.NONE : e < (0, v.A3)(I.Eu4.TIER_1) ? I.Eu4.TIER_1 : e < (0, v.A3)(I.Eu4.TIER_2) ? I.Eu4.TIER_2 : e < (0, v.A3)(I.Eu4.TIER_3) || null != t && t.features.has(I.oNc.MORE_STICKERS) && e < d.D.MAX_STICKER_SLOTS ? I.Eu4.TIER_3 : I.Eu4.NONE,
  R = e => {
    ...
    return <r.Fragment>{<c.X6q color={"header-primary"} variant={"heading-md/semibold"}>{t}</c.X6q>}{!a && <c.Text variant={"text-xs/normal"}>{S.intl.format(S.t.ZLoNtr, {
          numTotal: s,
  ...
  D = () => <div className={Chunk145635.placeholderCard}><img className={Chunk145635.placeholderImg} alt={Chunk388032.intl.string(Chunk388032.t.wl4ntL)} src={require("./872732.js")} /></div>,
  A = e => {
    let {
      guild: t
    } = e, {
    ...
    return <c.zxk variant={"primary"} size={"sm"} text={S.intl.string(S.t.O1REe3)} onClick={() => {
  ...
  k = e => {
    ...
    let M = (e, n) => {
      ...
      G = [{
        tier: I.Eu4.NONE,
        title: <R guildStickers={d} currentGuildTier={Z} tier={I.Eu4.NONE}>{S.intl.string(S.t.tfVXhI)}</R>
      }, {
        tier: I.Eu4.TIER_1,
        title: <R guildStickers={d} currentGuildTier={Z} tier={I.Eu4.TIER_1}>{S.intl.string(S.t.nzXtaW)}</R>
      }, {
        tier: I.Eu4.TIER_2,
        title: <R guildStickers={d} currentGuildTier={Z} tier={I.Eu4.TIER_2}>{S.intl.string(S.t["h33/ub"])}</R>
      }, {
        tier: I.Eu4.TIER_3,
        title: <R guildStickers={d} currentGuildTier={Z} tier={I.Eu4.TIER_3}>{S.intl.string(S.t.BfF6EB)}</R>
      }];
    return <C.Z tiers={G} renderTier={e => {
        let i, l, {
            isAnimatedTo: s,
            onSetRef: u,
            tier: m,
