    ...
    children: t.map(e => {
      ...
      let r = null == i ? void 0 : i[e.id],
        ...
        a = (0, n.jsxs)(o.Text, {
          ...
          children: [e.name, l && (0, n.jsx)(o.Text, {
            tag: "div",
...
function x(e) {
  ...
  let h = (null == r ? void 0 : null === (t = r[i.id]) || void 0 === t ? void 0 : t.level) === s.m.HIGH,
    x = (0, n.jsxs)(o.Text, {
      ...
      children: [i.name, h && (0, n.jsx)(o.Text, {
        tag: "div",
...
let v = e => (t, i) => {
  ...
  E = r.memo(function(e) {
    ...
    }, [l, t, i]), c = s.slice(0, 3), d = r.useMemo(() => {
      var e;
      let t = s[3];
      if (null == t) return null;
      let i = t.getIconURL(24);
      if (null == i) return null;
      if (s.length <= 4) return (0, n.jsx)(x, {
        game: t,
        gameActivity: l
      });
      let r = s.slice(3);
