    ...
    children: t.map(e => {
      ...
      let r = null == n ? void 0 : n[e.id],
        ...
        a = (0, i.jsxs)(o.Text, {
          ...
          children: [e.name, l && (0, i.jsx)(o.Text, {
            tag: "div",
...
function x(e) {
  ...
  let h = (null == r || null == (t = r[n.id]) ? void 0 : t.level) === s.m.HIGH,
    x = (0, i.jsxs)(o.Text, {
      ...
      children: [n.name, h && (0, i.jsx)(o.Text, {
        tag: "div",
...
let E = e => (t, n) => {
  ...
  I = r.memo(function(e) {
    ...
    }, [l, t, n]), c = s.slice(0, 3), d = r.useMemo(() => {
      var e;
      let t = s[3];
      if (null == t) return null;
      let n = t.getIconURL(24);
      if (null == n) return null;
      if (s.length <= 4) return (0, i.jsx)(x, {
        game: t,
        gameActivity: l
      });
      let r = s.slice(3);
