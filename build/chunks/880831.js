...
function D(e) {
  ...
  let {
    ...
    count: a,
    lingerMs: o
  } = e, [s, l] = i.useState([]), [u, f] = i.useState(!1), _ = i.useRef(null), p = i.useRef(void 0), h = i.useCallback(() => {
    l([]), f(!0)
  }, []);
  i.useEffect(() => {
    function e(e) {
...
function L(e) {
  ...
  let {
  ...
  }), [n]), l = (0, g.Uj)(n), d = i.useContext(p.Z), [O, T] = i.useState(!1), S = (0, h.p)(), A = i.useCallback(e => {
    "A" !== e.target.nodeName && (f.Z.updateChatOpen(n.channel_id, !0), _.Z.jumpToMessage({
      channelId: n.channel_id,
      messageId: n.id,
      flash: !0
    }))
  }, [n.channel_id, n.id]), w = null != n.content && "" !== n.content ? (0, m.ZP)(n, {
    isInteracting: O,
    ...
    iconSize: N.WW
  }), x = (0, b.cv)(n), k = x.length > 0 ? x.map(e => (0, r.jsx)(y.Z, {
    className: C.sticker,
    size: 128,
    sticker: e,
    isInteracting: O
  ...
  return (0, r.jsxs)(u.P3F, {
    ...
    children: [(0, r.jsxs)("div", {
      className: o()(C.messageContentWrapper, {
        [C.mentioned]: n.mentioned
      }),
      children: [null != k ? null : L, null != (t = null != P ? P : k) ? t : (0, r.jsx)("span", {
        children: R
      }), null != k ? null : D]
    }), (0, r.jsx)("img", {
      alt: "",
      src: (null == l ? void 0 : l.guildMemberAvatar) != null && null != d ? (0, I.JM)({
        guildId: d,
        userId: n.author.id,
