...
let D = function(e) {
  let {
  ...
  } = (0, m.Ay)(u.A.WISHLIST_BANNER), o = (0, f.Ay)(null == t ? true : t.id), {
    displayItems: d,
    hasMoreItems: _,
    ...
    canAnimate: false,
    size: 713
  }), z = n.useMemo(() => _ ? d.slice(0, T.pl - 1) : d, [d, _]), X = (0, N.b)(z, t), Q = _ ? d[T.pl - 1] : null, J = I - T.pl + 1, [K, Z] = n.useState(false), $ = n.useCallback(e => {
    if (e && !b && d.length > 0) {
      let e = d.map(e => {
        let {
          item: t
