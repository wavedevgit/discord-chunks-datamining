...
let P = (0, s.Mg)(d.Z.LIVE_INDICATOR_BORDER_RADIUS),
  ...
  M = e => {
    ...
    return (0, r.jsx)(f.IGR, {
      text: F,
      className: a()(R, _.qualityIndicatorBadge, {
        [_.qualityIndicatorBadgePremium]: D && A
      }),
