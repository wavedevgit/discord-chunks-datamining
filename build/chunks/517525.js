...
let R = (0, o.Mg)(d.Z.LIVE_INDICATOR_BORDER_RADIUS),
    ...
    let D = t || i,
      ...
      U = l.useCallback(() => {
        k && D && (0, f.ZDy)(async () => {
          ...
          return t => (0, r.jsx)(e, N(A({}, t), {
            analyticsSource: M
          }))
        })
      }, [k, D, M]);
    if (l.useEffect(() => {
        !R && D && (S.default.track(I.rMx.PREMIUM_UPSELL_VIEWED, {
          type: _.cd.STREAM_QUALITY_INDICATOR,
          has_premium_stream_fps: t,
          has_premium_stream_resolution: i,
          location_stack: w
        }), P(!0))
      }, [t, i, D, R, P, w]), null == C) return null;
    let V = (0, r.jsx)(f.ua7, {
      text: x ? y.intl.string(y.t.q8TiVl) : D ? y.intl.string(y.t.IHgpEh) : y.intl.string(y.t.vLb0VV),
      position: "bottom",
      color: f.ua7.Colors.GREY,
      children: e => (0, r.jsxs)(f.P3F, N(A({}, e), {
        onClick: U,
        className: a()(Z.qualityIndicator, g, E.eE[d], x ? Z.qualityIndicatorLowQuality : Z.qualityIndicatorFullQuality, {
          [Z.clickable]: k && D
        }),
        children: [D ? (0, r.jsx)(f.SrA, {
          ...
          children: (0, v.bp)(C.maxFrameRate)
        })]
      }))
    });
    return (0, r.jsx)(f.IGR, {
      text: V,
      className: a()(T, Z.qualityIndicatorBadge, {
        [Z.qualityIndicatorBadgePremium]: D && j
      }),
  ...
  L = e => {
    let {
      ...
      className: s,
      premiumIndicator: c
    } = e, [d, m] = l.useState(!1), p = (0, v.W3)(t), {
      reducedMotion: h
    } = l.useContext(f.Sfi), S = n && null != p;
    l.useEffect(() => {
    ...
    return (e => {
      ...
      return (0, r.jsxs)("div", N(A({
        ...
        children: [O((e, n) => n ? (0, r.jsx)(u.animated.div, {
          style: e,
          children: (0, r.jsx)(M, {
