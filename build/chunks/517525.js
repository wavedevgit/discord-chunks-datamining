...
let w = (0, s.Mg)(d.Z.LIVE_INDICATOR_BORDER_RADIUS),
  ...
  M = e => {
    ...
    let D = t || i,
      ...
      U = l.useCallback(() => {
        k && D && (0, f.ZDy)(async () => {
          ...
          return t => (0, r.jsx)(e, x(Z({}, t), {
            analyticsSource: M
          }))
        })
      }, [k, D, M]);
    if (l.useEffect(() => {
        !w && D && (v.default.track(O.rMx.PREMIUM_UPSELL_VIEWED, {
          type: I.cd.STREAM_QUALITY_INDICATOR,
          has_premium_stream_fps: t,
          has_premium_stream_resolution: i,
          location_stack: T
        }), P(!0))
      }, [t, i, D, w, P, T]), null == C) return null;
    let F = (0, r.jsx)(f.ua7, {
      ...
      children: e => (0, r.jsxs)(f.P3F, x(Z({}, e), {
        onClick: U,
        className: a()(j.qualityIndicator, g, E.eE[d], N ? j.qualityIndicatorLowQuality : j.qualityIndicatorFullQuality, {
          [j.clickable]: k && D
        }),
    ...
    return (0, r.jsx)(f.IGR, {
      text: F,
      className: a()(R, j.qualityIndicatorBadge, {
        [j.qualityIndicatorBadgePremium]: D && A
      }),
