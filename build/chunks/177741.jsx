...
function H() {
  ...
  }, [Chunk153911]), Chunk73800.useEffect(() => {
    let e = false;
  ...
  return <div className={d()({
      [Chunk859581.wrapper]: !R,
      [Chunk859581.activeWrapper]: R
    })}>{v && <Chunk70097.Z autoPlay={true} className={Chunk859581.videoWrapper} onPlay={() => {
      ...
      }}><source src={exports} type={Chunk601046} /></Chunk70097.Z>}{<Chunk126663.animated.div className={Chunk859581.gadientHighlight} style={O} />}{<Chunk126663.animated.div className={Chunk859581.swipeWrapper} style={x}><svg className={Chunk859581.swipe} viewBox={"0 0 848 1024"} fill={"none"}>{<path d={"M257.206 1024L0 0H341.333L598.539 1024H257.206Z"} fill={"white"} />}{<path d={"M847.975 1024H690.436L433.231 0H590.769L847.975 1024Z"} fill={"white"} />}</svg></Chunk126663.animated.div>}</div>
}
let O = function() {
  return (0, Chunk442837.e7)([Chunk438820.Z], () => Chunk438820.Z.canPlayWowMoment) ? <H /> : null
}