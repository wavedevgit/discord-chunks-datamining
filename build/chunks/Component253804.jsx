...
function m() {
  let [e, t] = l.useState(null), [n, i] = l.useState(null), [s, o] = l.useState(null), [c, u] = l.useState([]), m = l.useRef(null), [f, x] = l.useState(400), [b, g] = l.useState(400), v = l.useCallback(() => {
    setTimeout(() => {
      var e, t, n, a;
      o(null != (e = null == (n = m.current) ? true : n.getProperties()) ? e : {}), u(null != (t = null == (a = m.current) ? true : a.getArtboards()) ? t : []), i({})
    }, 1e3)
  }, []), j = l.useCallback((e, t) => {
    null != n && i(n => {
      var a, l, i;
  ...
  return (0, a.jsxs)(r.BJc, {
    ...
    }), null != e && null == n ? (0, a.jsx)(r.y$y, {}) : null, null != n && (0, a.jsxs)(r.BJc, {
      children: [(0, a.jsxs)(r.BJc, {
        gap: 8,
        children: [(0, a.jsx)(r.DZT, {
          variant: "heading-lg/medium",
        ...
        children: [(0, a.jsx)(r.DZT, {
          ...
          return (0, a.jsx)(p, {
            ...
            value: null != (t = null == n || null == (i = n[e]) ? true : i.value) ? t : null == s || null == (r = s[e]) ? true : r.value,
            onChange: t => j(e, t),
            artboards: c
          }, e)
        })]
...
function p(e) {
  ...
  }) : "boolean" === n ? (0, a.jsx)(r.dOG, {
    label: t,
    checked: l,
    onChange: e => i(e)
  }) : "trigger" === n ? (0, a.jsx)(r.$nd, {
...
function h(e) {
  ...
  let {
    riveName: n,
    onRiveLoad: s
  } = e, o = null == (t = i[n]) ? true : t.riveSrc, u = null == o, m = l.useRef(null), p = (0, d.GyQ)(o);
  return (0, a.jsxs)(r.BJc, {
    gap: 8,
