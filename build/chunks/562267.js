...
function f(e) {
  ...
  let {
    channelId: n,
    chatInputType: f
  } = e, [p, h] = i.useState(null), m = (0, a.e7)([l.Z], () => l.Z.getStickerPreview(n, f.drafts.type));
  return (null == (t = f.stickers) ? void 0 : t.allowSending) && null != m && 0 !== m.length ? (0, r.jsxs)(r.Fragment, {
