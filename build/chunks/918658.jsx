...
function w(e) {
  ...
  return <c.zx buttonRef={o} className={a()(P.button, t)} innerClassName={P.buttonInner} look={c.zx.Looks.OUTLINED} color={c.zx.Colors.WHITE} size={c.zx.Sizes.NONE} onClick={n}>{i}</c.zx>
}
...
function D(e) {
  ...
  return <w onClick={t}>{R.intl.string(R.t.R9GHyc)}</w>
}
...
function M() {
  ...
  return <Chunk481060.qXd color={Chunk481060.DM8.BRAND} className={Chunk800515.notice}>{<w onClick={() => U({
        backToSettings: true
      })} className={Chunk800515.backButton}>{<Chunk671533.Z width={16} height={16} direction={Chunk671533.Z.Directions.LEFT} className={Chunk800515.backArrow} />}{M}</w>}{j && Chunk755721 ? <div className={Chunk800515.noticeContents}><div className={Chunk800515.noticeText}>{Chunk388032.intl.string(Chunk388032.t.PxbiAQ)}</div></div> : <div className={Chunk800515.noticeContents}>{<div className={Chunk800515.noticeText}>{Chunk755721 ? Chunk388032.intl.formatToPlainString(Chunk388032.t["0PHahI"], {
          numRoles: Object.keys(Chunk120356).length
        }) : Chunk388032.intl.formatToPlainString(Chunk388032.t.vMlK8v, {
          numRoles: Object.keys(Chunk120356).length
        })}</div>}{<Chunk481060.yRy targetElementRef={module} position={"bottom"} renderPopout={() => (0, Chunk255367.jsx)(Chunk889695.Z, {
          guildId: exports
        })}>{t => {
          let {
            onClick: n
        ...
        }}</Chunk481060.yRy>}{Chunk755721 && <Chunk481060.DY3 className={Chunk800515.previewWarning} text={Chunk388032.intl.string(Chunk388032.t.mW4DUF)}><Chunk481060.Mgn size={"xs"} color={Chunk692547.Z.unsafe_rawColors.YELLOW_300.css} /></Chunk481060.DY3>}{Chunk358085 && <Chunk481060.DY3 className={Chunk800515.previewWarning} text={Chunk388032.intl.formatToPlainString(Chunk388032.t.eummvb, {
          maxTiers: Chunk293810.fF,
          maxProducts: Chunk302463.dD
        })}><Chunk481060.Mgn size={"xs"} color={Chunk692547.Z.unsafe_rawColors.YELLOW_300.css} /></Chunk481060.DY3>}</div>}{Chunk755721 || a === Chunk981631.pNK.ROLE_SUBSCRIPTIONS ? null : <D onClick={() => U({
...
function k(e) {
  ...
  return (0, s.e7)([I.Z], () => I.Z.isViewingRoles(t)) ? <div className={a()(P.settingsWrapper, {
