...
let C = e => {
  ...
  let P = b("email"),
    j = b("password");
  return <h.Z transitionState={t} email={null == x ? true : x.email} emailError={P} passwordError={j} submitting={I} canResend={_ && !I && (null == x ? true : x.email) != null && 0 === P.length && 0 === j.length} canChange={R} onChangeEmailClick={function() {
      E(false)
