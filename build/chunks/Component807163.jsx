...
function eC(e) {
  ...
  } = (0, h.ZP)(N.Z.PREMIUM_UNCANCEL_MODAL), d = (0, D.GG)();
...
function eN(e) {
  ...
  return (0, r.jsx)(ex, {
    ...
    onLearnMore: () => {
      window.open(k.Z.getArticleURL(q.BhN.PREMIUM_DETAILS)), Z.default.track(q.rMx.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
