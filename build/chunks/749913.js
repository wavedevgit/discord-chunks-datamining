...
function es(e) {
  let {
  ...
  }, [j]), _ = (0, h.e7)([k.Z], () => k.Z.can(ee.Plq.ATTACH_FILES, t)), w = (0, h.Wu)([L.Z], () => L.Z.getUploads(t.id, Z.d.FirstThreadMessage)), N = g && _ && u, I = (null == t ? void 0 : t.isMediaChannel()) === !0, M = function(e, t) {
    let n = (0, K.AF)(),
      r = (0, V.ql)(e);
    ...
    return i.useCallback(async (t, i, l) => {
      ...
      if (s(v ? (0, H.V_)() : null), o(_ ? (0, H.T4)() : null), v || _) return {
        shouldClear: !1,
        shouldRefocus: !0
      };
      try {
        ...
        var C, y;
        return (null == (C = t.body) ? void 0 : C.code) === ee.evJ.AUTOMOD_TITLE_BLOCKED ? s((0, H.Gx)(t.body, e)) : (null == (y = t.body) ? void 0 : y.code) === ee.evJ.AUTOMOD_MESSAGE_BLOCKED && o((0, H.Gx)(t.body, e)), {
          shouldClear: !1,
          shouldRefocus: !0
        }
      } finally {
...
let eo = i.memo(function(e) {
  ...
  ec = i.memo(function(e) {
    ...
    }, c.X), b = (0, K.AF)(), j = null != t.topic && 0 !== t.topic.length, v = G.Z.hasSeen(t.id), _ = (0, V.ql)(t), C = (0, h.e7)([F.default], () => F.default.getCurrentUser());
    o()(null != C, "current user cannot be null"), (0, D.yp)({
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [u && p ? (0, r.jsx)(f.X6q, {
        ...
        onKeyDown: e => {
          var r, i;
          "Enter" === e.key && (e.preventDefault(), e.stopPropagation(), u && g.length > 0 ? null == l || l.focus() : a && e.shiftKey ? ((0, q.nH)({
            guildId: t.guild_id,
            channelId: t.id
          }), j && !v && b.getState().setGuidelinesOpen(!0), b.getState().setFormOpenFromUserAction(), g.trim().length > 0 && (b.getState().setBodyFocused(!0), null == l || l.focus())) : u || !(g.length > 0) || null != d || s || U.Z.updateForumSearchQuery(t.id, g));
...
function ev(e) {
  let {
    ...
    containerRef: x,
    containerWidth: p
  } = (0, Q.Z)(), b = i.useRef(null), j = i.useRef(null), [v, _] = i.useState(!0), C = (0, V.Vm)(t), [y, O] = i.useState(0);
  return (i.useLayoutEffect(() => {
  ...
  }, [C, v, x, p]), 0 === C.length) ? null : (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(f.lO_, {
      ...
      position: "bottom",
      align: "center",
      children: e => (0, r.jsxs)(g.zx, ea(ei({}, e), {
        buttonRef: j,
