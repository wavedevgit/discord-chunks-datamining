...
function es(e) {
  ...
  }, [j]), _ = (0, h.e7)([k.Z], () => k.Z.can(ee.Plq.ATTACH_FILES, t)), T = (0, h.Wu)([L.Z], () => L.Z.getUploads(t.id, Z.d.FirstThreadMessage)), O = g && _ && u, I = (null == t ? void 0 : t.isMediaChannel()) === !0, M = function(e, t) {
    let n = (0, K.AF)(),
      r = (0, G.ql)(e);
...
let eo = i.memo(function(e) {
  ...
  ec = i.memo(function(e) {
    ...
    }, c.X), b = (0, K.AF)(), j = null != t.topic && 0 !== t.topic.length, v = V.Z.hasSeen(t.id), _ = (0, G.ql)(t), C = (0, h.e7)([F.default], () => F.default.getCurrentUser());
...
function ev(e) {
  let {
    ...
    containerRef: x,
    containerWidth: p
  } = (0, Q.Z)(), b = i.useRef(null), j = i.useRef(null), [v, _] = i.useState(!0), C = (0, G.Vm)(t), [y, w] = i.useState(0);
