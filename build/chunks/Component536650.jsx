...
function O(e) {
  let {
    ...
    scrollerRef: v,
    sectionName: S
  } = e, I = (0, l.ap)((0, u.ZP)()), T = i.useRef(null), C = i.useRef(null), A = i.useRef(null), N = i.useRef(null), P = (0, c.dQu)(c.TVs.colors.BACKGROUND_BASE_LOW).hex(), w = (0, d.ZP)("number" == typeof O ? "" : O, null != P ? P : ""), R = i.useMemo(() => {
    var e, t;
  ...
  }, [w, I]), D = y(T), x = y(C), L = i.useCallback(() => {
    var e, t, n;
    let r = v.current,
      i = T.current,
      a = A.current,
    ...
    if (null != r && null != i && null != a && !isNaN(l) && !isNaN(c)) {
      let e = null != (n = r.scrollTop) ? n : 0,
        ...
        p = E(e, d, f);
      i.style.filter = "brightness(".concat(b(1, I ? 1.4 : .6, p), ")"), i.style.backgroundColor = "color-mix(in oklab,".concat(w, " ").concat((1 - p) * 100, "%, ").concat(R, ")"), a.style.opacity = "".concat(b(0, 1, p)), a.style.transform = "translateY(".concat(b(l / 4, 0, p), "px)"), null != o && (o.style.opacity = "".concat(b(1, 0, p)))
    }
  }, [R, w, null == x ? true : x.height, I, v, null == D ? true : D.height]);
  return i.useEffect(() => {
    L()
  }, [L, I]), i.useEffect(() => {
    let e = v.current,
