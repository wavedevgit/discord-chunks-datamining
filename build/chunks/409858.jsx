...
class J extends Chunk73800.Component {
  ...
  render() {
    ...
    return <div ref={this.modalRef}>{<Chunk481060.Y0X transitionState={Chunk979554} size={Chunk481060.CgR.SMALL} className={Chunk230277.modal} aria-labelledby={Chunk120356} parentComponent={"GiftCodeModal"}>{null != Chunk73800.giftStyle && !Chunk728345 && !Chunk812206 && <Chunk981632.Z defaultAnimationState={this.getDefaultAnimationStatus()} idleAnimationState={this.getIdleAnimationStatus()} giftStyle={Chunk73800.giftStyle} className={Chunk230277.seasonalGiftIcon} />}{!Chunk728345 && <div className={Chunk230277.backSplash} />}{!Chunk812206 && <Chunk481060.olH onClick={require} className={Chunk230277.closeButton} />}{<Chunk481060.hzk className={l()({
            [Chunk230277.content]: !Chunk728345,
            [Chunk230277.contentCustomGift]: Chunk728345
          })}>{!Chunk812206 && (null == Chunk73800.giftStyle || Chunk728345 && Chunk884697) && <Chunk925329.Z size={Chunk925329.Z.Sizes.LARGE} game={module} skuId={Chunk73800.skuId} />}{Chunk313201 && <img alt={""} src={Chunk100527 ? Chunk167969 : Chunk557256} />}{<Chunk481060.X6q id={Chunk120356} className={l()({
              [Chunk230277.customGiftHeader]: Chunk728345 && !Chunk884697,
              [Chunk230277.header]: !Chunk728345 || Chunk884697
            })} variant={"heading-sm/semibold"}>{<div className={l()({
                [Chunk230277.customGiftHeaderText]: Chunk728345
              })}>{this.firstHeaderText}</div>}{<div>{this.secondHeaderText}</div>}</Chunk481060.X6q>}{!(Chunk728345 && !Chunk884697) && <Chunk481060.Text className={Chunk230277.body} variant={"text-sm/normal"}>{this.bodyText}</Chunk481060.Text>}{Chunk728345 && !Chunk812206 && null != Chunk73800.giftStyle && !Chunk884697 && <Chunk981632.Z defaultAnimationState={this.getDefaultAnimationStatus()} idleAnimationState={this.getIdleAnimationStatus()} className={Chunk230277.giftAnimation} giftStyle={Chunk73800.giftStyle} />}{this.state.opened && !Chunk313201 && Chunk812206 && <Chunk551425.Z giftCode={Chunk73800} />}{Chunk313201 && <Chunk481060.Text className={Chunk230277.body} variant={"text-md/normal"}>{this.errorMessage}</Chunk481060.Text>}{Chunk728345 && this.state.opened && !this.state.accepted && !Chunk313201 && null != Chunk533307 && "" !== Chunk533307 && !Chunk703656 && <Chunk255367.Fragment>{<Chunk481060.vwX>{Chunk388032.intl.format(Chunk388032.t.DDO4W1, {
                sender: Chunk51144.ZP.getName(Chunk906732)
              })}</Chunk481060.vwX>}{<Chunk481060.X6q id={Chunk120356} className={Chunk230277.customMessage} variant={"heading-sm/bold"}>{Chunk533307}</Chunk481060.X6q>}</Chunk255367.Fragment>}{<Chunk481060.zxk variant={"primary"} text={this.buttonText} loading={exports} onClick={() => {
              this.trackStepAnalytics(), this.handleClick()
            }} />}</Chunk481060.hzk>}</Chunk481060.Y0X>}{null != Chunk73800.giftStyle && !Chunk442837 && this.step !== Chunk981631.wZ8.ERROR && !Chunk884697 && !exports && Chunk583434 && (null == Chunk410030 || null == Chunk832149 ? <X openedGift={Chunk583434 && !Chunk884697 && !exports} /> : <Chunk715627.Z confettiTarget={this.modalRef.current} emojiURL={Chunk832149} />)}{!Chunk884697 && !exports && Chunk583434 && null != Chunk607070 && <Y soundId={Chunk607070} step={this.step} />}</div>
  }
  constructor(...t) {
...
let Q = Chunk442837.ZP.connectStores([Chunk283595.Z, Chunk55563.Z, Chunk812206.Z, Chunk82142.Z, Chunk509545.Z, Chunk607070.Z], t => {
  ...
  $ = t => {
    ...
    return null == O ? null : <Q{...e = function(t) {
