...
function w(e) {
  let {
    ...
    (0, o.jW)(e, async () => {
      let {
        default: e
      } = await Promise.all([n.e("79695"), n.e("98783"), n.e("72117")]).then(n.bind(n, 354589));
      return n => {
        var i, l;
    ...
    let e = "@".concat(C.ZP.getUserTag(t, {
      ...
      n = "<@".concat(t.id, ">");
    O.S.dispatch(I.CkL.TEXTAREA_FOCUS, {
      channelId: s.id
...
function D(e) {
  let {
    channel: t
  } = e, n = _.default.getCurrentUser(), l = null == n ? true : n.isStaff(), {
    ...
    for (let t of e) {
      var r, i, l;
      y.Z.isFriend(t.id) || t.id === (null == (r = _.default.getCurrentUser()) ? true : r.id) ? n[t.id] = {
