...
let O = Chunk73800.memo(function(e) {
  ...
  switch (t) {
    ...
    case u.p2:
      return <d.P name={y ? f.intl.string(f.t.mlPMCw) : f.intl.string(f.t.k8fFjo)} />;
    case m.recentsSectionNumber:
      return <d.P name={f.intl.string(f.t.gKcrqK)} onDismiss={C} />;
    case m.voiceChannelsSectionNumber: {
      ...
      return <i.Fragment>{<div className={g.sectionDivider} />}{<d.rj category={e} channel={n} />}</i.Fragment>
    }
    case u.wF: {
      let e = m.getNamedCategoryFromSection(t);
      if (null == e) return null;
      return <d.ZP channel={e.record} position={e.position} disableManageChannels={_}><c.Z inlineSpecs={h.MF} arrowAlignment={o.cy.TOP} tutorialId={"organize-by-topic"} position={"right"} /></d.ZP>
    }
    default: {
      let e = m.getNamedCategoryFromSection(t);
      if (null == e) return null;
      return <d.ZP channel={e.record} position={e.position} disableManageChannels={_} />
    }
  }
})