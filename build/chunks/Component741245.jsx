...
let v = Object.freeze({
  DURATION: {
    [Chunk474936.PremiumTypes.TIER_0]: 1e3,
    [Chunk474936.PremiumTypes.TIER_1]: 1e3,
    [Chunk474936.PremiumTypes.TIER_2]: 1500
  },
  DELAY: {
    [Chunk474936.PremiumTypes.TIER_0]: 400,
    [Chunk474936.PremiumTypes.TIER_1]: 400,
    [Chunk474936.PremiumTypes.TIER_2]: 2200
  },
  ...
  getSvgBorderGradientId() {
    ...
    switch (exports) {
      ...
      case "PREMIUM_UPDATED":
        if (module === Chunk474936.PremiumTypes.TIER_0) return Chunk436774.Rj.PREMIUM_TIER_0;
        if (module === Chunk474936.PremiumTypes.TIER_1) return Chunk436774.Rj.PREMIUM_TIER_1;
    ...
    switch (module) {
      case "GUILD_BOOST_APPLIED":
        return (0, Chunk54381.jsx)("svg", {
          className: Chunk60564.svgBorder,
          width: "304",
          height: "48",
          viewBox: "0 0 304 48",
