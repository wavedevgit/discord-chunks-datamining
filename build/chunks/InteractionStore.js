...
function R(e) {
  ...
  null == (t = s.onFailure) || t.call(s, r, i, o, a), s.data.interactionType === c.B8.APPLICATION_COMMAND ? j(n) : y[n] = g(h({}, s), {
    state: _.F.FAILED,
    errorCode: r,
    errorMessage: i
  })
...
function M(e) {
  ...
  let s = I[a.nonce];
  null == s ? (t = v[a.nonce], n = y[a.nonce]) : (t = s.messageId, n = s.interaction), null != n && null != t && (j(a.nonce), null != t && "channelId" in n.data && l.Z.deleteMessage(n.data.channelId, t, true))
}
