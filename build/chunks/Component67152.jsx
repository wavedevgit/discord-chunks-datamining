  ...
  Z = [{
    ...
    render(e, t) {
      ...
      return (0, r.jsx)(d.P3F, {
        className: s()(C.cell, C.toggleExpandCell),
        onClick: () => i(e.key),
        children: (0, r.jsx)(d.Fbu, {
          size: "md",
          color: "currentColor",
          className: s()(C.caretIcon, {
            [C.caretDownIcon]: l
          })
        })
      })
          ...
          switch (e) {
            case v.x_.OPEN:
              return (0, r.jsxs)(r.Fragment, {
                children: [null != s ? O.intl.formatToPlainString(O.t.I6YOjS, {
                  payoutDate: s
                }) : O.intl.string(O.t.G5ATX6), (0, r.jsx)(b.Z, {
          ...
          switch (t) {
            ...
            case v.jw.ERROR:
              return (0, r.jsxs)(r.Fragment, {
                children: [null != s ? O.intl.formatToPlainString(O.t.I6YOjS, {
                  payoutDate: s
                }) : O.intl.string(O.t.ubdQTt), (0, r.jsx)(b.Z, {
                  className: C.statusScheduledIcon
                })]
              });
            case v.jw.PAID:
            ...
            case v.jw.RISK_REVIEW:
              return (0, r.jsxs)(r.Fragment, {
                children: [x.Z.getStatusErrorText(t), (0, r.jsx)(d.k$p, {
                  size: "md",
                  color: "currentColor",
                  className: C.statusErrorIcon
                })]
