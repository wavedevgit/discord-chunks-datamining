...
async function ee(e) {
  ...
  let {
    ...
    location: r,
    instanceId: i
  } = e, o = D.ZP.getEmbeddedActivityDurationMs(r.id, n), s = y.default.getSessionId();
...
function et(e) {
  ...
  W[r] = H;
  let Y = K[r];
  (0, C.Ew)(m.nonce) || m.nonce === (null == Y ? void 0 : Y.nonce) || (Y = void 0), S.default.track(V.rMx.ACTIVITY_SESSION_JOINED, {
    channel_id: g,
    guild_id: E,
  ...
  constructor(...e) {
    super(...e), H(this, "handleSelectedChannelUpdate", () => {
      ...
      if (null != r && null != t) {
        ...
        t.code !== V.$VG.CLOSE_NORMAL && (S.default.track(V.rMx.ACTIVITY_CLOSED_RPC_ERROR, {
