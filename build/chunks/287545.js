...
async function X(e) {
  ...
  let {
    ...
    location: r,
    instanceId: i
  } = e, a = C.ZP.getEmbeddedActivityDurationMs(r.id, n), s = m.default.getSessionId();
...
function Q(e) {
  ...
  if (a && null != A && A.isPrivate() && o && null == b && s.Z.selectParticipant(A.id, null), null == b) return;
  ...
  let k = C.ZP.getShelfActivities(I),
    M = S.Z.getState().shelfOrder,
    G = (0, N.Z)({
      applicationId: r,
      activityConfigs: k
    }),
    B = 1 + M.findIndex(e => e === r),
    {
      releasePhase: Z
    } = Y(G),
  ...
  constructor(...e) {
    super(...e), B(this, "handleSelectedChannelUpdate", () => {
      ...
      for (let {
        ...
        let r = (0, L.p)(t);
        null != r && (0, M.Z)(r) && r !== e && this.leaveActivity({
          location: t,
          applicationId: n
        })
      }
      ...
      if (!(0, k.Z)(null == d || null == (t = d.embedded_activity_config) ? true : t.supported_platforms)) return void this.showLaunchErrorModal(G.intl.string(G.t.uGDCc3));
      ...
      let E = C.ZP.getEmbeddedActivitiesForChannel(i).find(e => e.applicationId === o);
