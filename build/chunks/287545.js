...
async function ee(e) {
  ...
  let {
    ...
    location: i,
    instanceId: o
  } = e, s = D.ZP.getEmbeddedActivityDurationMs(i.id, r), l = y.default.getSessionId();
  null != o && null != l && await a.tn.post({
...
function et(e) {
  ...
  let {
    ...
    location: f,
    inviterUserId: h
  } = e, m = y.default.getId(), g = c.find(e => e.userId === m), E = null != (r = (0, U.pY)(f)) ? r : (0, U.wq)(f), b = v.Z.getChannel(E);
