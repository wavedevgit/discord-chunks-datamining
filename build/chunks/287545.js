...
async function ee(e) {
  ...
  let {
    ...
    location: r,
    instanceId: i
  } = e, a = D.ZP.getEmbeddedActivityDurationMs(r.id, n), s = b.default.getSessionId();
...
function et(e) {
  ...
  let {
    ...
    location: u,
    inviterUserId: f
  } = e, h = b.default.getId(), m = l.find(e => e.userId === h), g = (0, U.pY)(u), E = y.Z.getChannel(g);
  ...
  Y[r] = H;
  let W = K[r];
  (0, C.Ew)(m.nonce) || m.nonce === (null == W ? void 0 : W.nonce) || (W = void 0), T.default.track(F.rMx.ACTIVITY_SESSION_JOINED, {
    channel_id: E.id,
