...
async function ee(e) {
  ...
  let {
    ...
    location: o,
    instanceId: s
  } = e, l = D.ZP.getEmbeddedActivityDurationMs(o.id, i), c = y.default.getSessionId();
  null != s && null != c && await a.tn.post({
...
function et(e) {
  ...
  let {
    ...
    location: h,
    inviterUserId: m
  } = e, g = y.default.getId(), E = u.find(e => e.userId === g), b = null != (r = (0, U.pY)(h)) ? r : (0, U.wq)(h), I = null != (a = (0, U.jS)(h)) ? a : (0, U.hu)(h), A = O.Z.getChannel(b);
