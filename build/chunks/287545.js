...
function q(e) {
  var t;
  return {
    releasePhase: null == e ? void 0 : null === (t = e.activity) || void 0 === t ? void 0 : t.client_platform_config[(0, G.Z)((0, N.getOS)())].release_phase
  }
}
...
function et(e) {
  ...
  Y[r] = H;
  let W = K[r];
  (0, C.Ew)(m.nonce) || m.nonce === (null == W ? void 0 : W.nonce) || (W = void 0), T.default.track(V.rMx.ACTIVITY_SESSION_JOINED, {
