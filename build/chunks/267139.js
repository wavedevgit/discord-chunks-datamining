...
function A(e, t, r) {
  var i, o = {},
    ...
    s = null;
  if (null != t)
    for (i in void 0 !== t.ref && (s = t.ref), void 0 !== t.key && (a = "" + t.key), t) I.call(t, i) && !T.hasOwnProperty(i) && (o[i] = t[i]);
...
function D(e, t, i, o, a) {
  ...
  if (l) return a = a(l = e), e = "" === o ? "." + w(l, 0) : o, v(a) ? (i = "", null != e && (i = e.replace(P, "$&/") + "/"), D(a, t, i, "", function(e) {
    return e
  })) : null != a && (C(a) && (a = N(a, i + (!a.key || l && l.key === a.key ? "" : ("" + a.key).replace(P, "$&/") + "/") + e)), t.push(a)), 1;
  if (l = 0, o = "" === o ? "." : o + ":", v(e))
...
}, t.Component = E, t.Fragment = i, t.Profiler = a, t.PureComponent = y, t.StrictMode = o, t.Suspense = u, t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = j, t.act = U, t.cloneElement = function(e, t, r) {
