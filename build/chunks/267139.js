...
function A(e, t, r) {
  var i, a = {},
    ...
    s = null;
  if (null != t)
    for (i in void 0 !== t.ref && (s = t.ref), void 0 !== t.key && (o = "" + t.key), t) I.call(t, i) && !T.hasOwnProperty(i) && (a[i] = t[i]);
...
function D(e, t, i, a, o) {
  ...
  if (l) return o = o(l = e), e = "" === a ? "." + w(l, 0) : a, O(o) ? (i = "", null != e && (i = e.replace(R, "$&/") + "/"), D(o, t, i, "", function(e) {
    return e
  })) : null != o && (C(o) && (o = N(o, i + (!o.key || l && l.key === o.key ? "" : ("" + o.key).replace(R, "$&/") + "/") + e)), t.push(o)), 1;
  if (l = 0, a = "" === a ? "." : a + ":", O(e))
    for (var c = 0; c < e.length; c++) {
      var u = a + w(s = e[c], c);
      l += D(s, t, i, u, o)
    } else if ("function" == typeof(u = p(e)))
      for (e = u.call(e), c = 0; !(s = e.next()).done;) u = a + w(s = s.value, c++), l += D(s, t, i, u, o);
...
}, t.Component = E, t.Fragment = i, t.Profiler = o, t.PureComponent = y, t.StrictMode = a, t.Suspense = u, t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = j, t.act = U, t.cloneElement = function(e, t, r) {
