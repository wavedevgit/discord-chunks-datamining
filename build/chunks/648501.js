...
function I(e) {
  ...
  } = e, k = (0, i.e7)([f.ZP], () => f.ZP.getMentionCount(n.id)), M = (0, i.e7)([f.ZP], () => f.ZP.getIsMentionLowImportance(n.id)), U = (0, s.ZP)(n), G = (0, i.e7)([p.Z], () => !p.Z.can(j.Plq.CONNECT, n)), B = (0, i.e7)([g.Z], () => g.Z.hasVideo(n.id)), W = (0, u.PK)(n.id) && n.isGuildStageVoice(), V = (0, _.ZP)({
    channel: n,
    locked: G,
    video: B || W,
    selected: I
  }), F = (0, i.e7)([d.Z], () => d.Z.getNewThreadCount(n.guild_id, n.id)), H = (0, a.n2)(n.guild_id, n.id), z = (0, i.e7)([h.Z], () => {
    var e, t;
  ...
  if (!D && L === S.i.ALL_MESSAGES && n.isForumLikeChannel() && null != F && F > 0) return (0, r.jsx)(o.Text, {
    ...
    color: "text-brand",
    children: x.NW.format(x.t.GkAbqa, {
      count: (0, o.NGo)(F)
    })
  });
  if (!D && n.isForumLikeChannel() && null != H && H > 0) return (0, r.jsx)(o.Text, {
    variant: "text-xs/semibold",
    color: "text-muted",
    children: (0, o.NGo)(H)
  });
