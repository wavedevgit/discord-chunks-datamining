...
let S = (e, t, n) => {
  ...
  T = e => {
    let {
      ...
      primaryColor: N,
      secondaryColor: P
    } = (0, h.Z)(null == C ? true : C.src), R = (0, a.e7)([s.default], () => s.default.locale), w = (0, m.Z)(O.ABu.CRUNCHYROLL), D = (0, p.ap)(n.extra.media_assets_large_text), x = i.useCallback(e => {
    ...
    }, [t, n, D, R, null == C ? true : C.src, N, P, A]), L = () => {
