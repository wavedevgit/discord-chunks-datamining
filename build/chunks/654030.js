...
let G = l.ZP.connectStores([y.Z, j.Z, S.Z, T.Z, N.Z, A.Z, I.Z, b.Z, w.Z, P.default, C.ZP], e => {
  ...
  let {
    ...
    id: s
  } = null != i ? i : {}, c = null != n && null != n.party && n.party.id === a ? j.Z.getParty(n.party.id) : null, u = null != s ? null != (t = S.Z.getApplicationActivity(s)) ? t : T.Z.getApplicationActivity(s, !0) : S.Z.findActivity(e => e.type === L.IIU.LISTENING), d = !1;
