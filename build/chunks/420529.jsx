...
function v(e) {
  ...
  return E ? <o.sNh label={h.intl.string(h.t.PlwgdX)} id={"handoff"} action={() => {
      (0, u.F)(m)
    }} icon={(0, _.Z)(true)} disabled={T} /> : S.map(e => <o.sNh id={"transfer-".concat(e.type, "-").concat(e.id)} label={O(e.type, t)} action={() => A(e)} icon={(0, _.Z)(e.type)} disabled={T} />)
}