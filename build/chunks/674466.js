...
class y {
  ...
  static parseOutboundStats(e, t) {
    var n, r, i, o, a, s, l, c, u, d, f, _, p, h, m, E, v, O, I, S, T, N, A, C, P;
    let R = new y;
    return null == e ? R : {
      bytes: e.bytesSent,
...
class v {
  ...
  appendAndIncrementStats(e) {
    ...
    }), this.resolutionHistogram.addSample(a), this.bitrateHistogram.addSample(O), this.fpsHistogram.addSample(I), this.localWantHistogram.addSample(h), this.statsWindow.shift()
  }
  addSystemResources() {
