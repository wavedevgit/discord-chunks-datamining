...
class y {
  ...
  static parseOutboundStats(e, t) {
    var n, r, i, a, o, s, l, c, u, d, f, _, p, h, m, E, v, O, I, S, T, A, N, C, R;
    let P = new y;
    return null == e ? P : {
      bytes: e.bytesSent,
...
class v {
  ...
  appendAndIncrementStats(e) {
    ...
    }), this.resolutionHistogram.addSample(o), this.bitrateHistogram.addSample(O), this.fpsHistogram.addSample(I), this.localWantHistogram.addSample(h), this.statsWindow.shift()
  }
  addSystemResources() {
