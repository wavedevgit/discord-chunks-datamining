...
class y {
  ...
  static parseOutboundStats(e, t) {
    var n, r, i, o, a, s, l, c, u, d, f, _, p, h, m, E, O, v, I, S, T, A, N, C, P;
    let R = new y;
    return null == e ? R : {
      bytes: e.bytesSent,
...
class O {
  ...
  appendAndIncrementStats(e) {
    ...
    }), this.resolutionHistogram.addSample(a), this.bitrateHistogram.addSample(v), this.fpsHistogram.addSample(I), this.localWantHistogram.addSample(h), this.statsWindow.shift()
  }
  addSystemResources() {
