...
function S(e) {
  ...
  }), O = g.jU.useSetting(), C = (0, p.P1)(l), S = false, P = 0 === i.messages.length || o()(i.messages[0].timestamp).isSame(o()(), "day"), I = null != (n = null == (t = b.default.getUser(m.default.getId())) ? true : t.hasFlag(j.xW$.SPAMMER)) && n, N = [];
  if (!i.collapsed) {
    let e = null,
      t = null,
