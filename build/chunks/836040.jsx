...
function u(e) {
  ...
  return null == t ? null : <a.Z guildNode={u} guild={t} animatable={d} draggable={false} contextMenu={() => {}} selected={true} route={c.Z5c.GUILD_MEMBER_VERIFICATION_FOR_HUB(t.id, n.code)} />
}