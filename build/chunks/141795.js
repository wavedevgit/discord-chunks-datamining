...
class R extends E.ZP {
  ...
  async uploadFileToCloudAsChunks(e) {
    ...
    for (let a = 0; a < i; a++) {
      T.info("Uploading chunk ".concat(a + 1, " of ").concat(i, " for file id ").concat(this.id));
      let o = a * e,
        s = Math.min(o + e, n),
      ...
      try {
        ...
        throw T.error("Error uploading chunk ".concat(a + 1, " for file id ").concat(this.id, ": ").concat(e)), e
      }
    }
  ...
  async uploadChunk(e) {
    ...
    for (let a = 1; a <= n; a++) {
      var r;
      this.uploadAnalytics.totalRequestCount = (null != (r = this.uploadAnalytics.totalRequestCount) ? r : 0) + 1, T.log("Attempt ".concat(a, " for file id ").concat(this.id, " : Uploading chunk ").concat(e.start, "-").concat(e.end - 1, " of ").concat(e.totalSize, " bytes"));
      let n = i().throttle(t => {
        let n = e.start + t.loaded;
        this.emit("progress", n, e.totalSize, n - this.loaded), this.loaded = n
      }, 50);
      try {
        if ((await o.tn.put(S(v({
            url: e.sessionUrl,
            body: e.chunk,
            headers: t,
  ...
  uploadFileToCloud(e) {
    ...
    T.log("Uploading ".concat(this.id)), this.item.platform === E.ow.REACT_NATIVE ? n = null != (t = {
    ...
    return void 0 !== e.md5Hash && (a[N] = e.md5Hash), o.tn.put(S(v({
  ...
  async upload() {
    ...
    try {
      ...
      let e = await this.trackTime("getUploadUrlTimeMs", async () => await o.tn.post(S(v({
