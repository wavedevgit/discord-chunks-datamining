...
class C extends Error {
  ...
  static rejectionHandler(e) {
    return t => {
      if (t instanceof o.Pd) throw new C(e, {
        response: t
      });
      if (t instanceof Error) throw new C(e, {
        cause: t
      });
      throw new C(e, {
  ...
  constructor(e, t = {}) {
    ...
    let {
      cause: i,
      response: a
    } = t, o = C.getErrorKind(null != i ? i : Error("".concat(null != (n = null == a ? void 0 : a.text) ? n : "Unknown error")), a), s = "server_error" === o ? "".concat(e, ":").concat(o, ":status_").concat(null != (r = null == a ? void 0 : a.status) ? r : 0) : "".concat(e, ":").concat(o);
    super(s, {
      cause: i
    }), v(this, "kind", void 0), v(this, "phase", void 0), v(this, "messageShort", void 0), this.name = "ResumableUploadError", this.phase = e, this.kind = o, this.messageShort = s
  }
}
let R = "Content-MD5";
var P = function(e) {
...
class D extends b.ZP {
  ...
  createAttachmentUrlRetryOpts() {
    return this.item.platform === b.ow.REACT_NATIVE ? {
      ...
      backoff: new a.Z(.5 * h.Z.Millis.SECOND, 60 * h.Z.Millis.SECOND),
      retries: 8
    } : this.retryOpts()
  }
  supportsResume() {
  ...
  async uploadFileToCloud() {
    ...
    if (A.log("Uploading ".concat(this.id)), this.item.platform === b.ow.REACT_NATIVE ? t = null != (e = {
        type: this.item.mimeType,
        uri: this.item.uri,
        name: this.item.filename
      }).type && "application/json" !== e.type ? e.type : "application/octet-stream" : (e = this.item.file, t = "application/octet-stream"), (0, u.G)({
  ...
  async getResumePosition(e) {
    let t = {
      ...
      retries: 0,
      timeout: {
        deadline: 30 * h.Z.Millis.SECOND
      },
      signal: this._abortController.signal
    };
    return await o.tn.put(t).then(e => 200 === e.status || 201 === e.status ? this.currentSize : C.rejectionHandler("status_check")(e)).catch(e => {
  ...
  async startOrResumeUpload(e) {
    ...
    if (200 !== r.status && 201 !== r.status) throw new C("upload", {
      response: r
    });
    return r
  }
  ...
  async upload() {
    ...
    try {
      ...
      let e = await this.trackTime("getUploadUrlTimeMs", async () => await o.tn.post(S(I({
  ...
  constructor(e, t, n, r) {
    var i, a, o, s;
    super(e, n), v(this, "status", "NOT_STARTED"), v(this, "channelId", void 0), v(this, "responseUrl", void 0), v(this, "currentSize", void 0), v(this, "preCompressionSize", void 0), v(this, "postCompressionSize", void 0), v(this, "loaded", 0), v(this, "reactNativeFileIndex", void 0), v(this, "error", void 0), v(this, "reactNativeFilePrepped", !1), v(this, "startTime", void 0), v(this, "uploadAnalytics", new w), v(this, "contentHash", void 0), v(this, "etag", void 0), v(this, "uploadAttempts", 0), v(this, "_abortController", void 0), v(this, "_xhr", void 0), v(this, "_aborted", !1), v(this, "createResumeAwareProgressFn", e => t => {
      let n = t.loaded + e,
        r = t.total + e,
        i = n - this.loaded;
