...
n.d(t, {
  m: () => C,
  n: () => P
}), n(47120), n(411104), n(301563), n(757143), n(26686);
var r = n(392711),
  i = n.n(r),
  o = n(261470),
  a = n(544891),
...
class P extends E.ZP {
  ...
  async uploadChunk(e) {
    ...
    for (let o = 1; o <= n; o++) {
      var r;
      this.uploadAnalytics.totalRequestCount = (null != (r = this.uploadAnalytics.totalRequestCount) ? r : 0) + 1, T.log("Attempt ".concat(o, " for file id ").concat(this.id, " : Uploading chunk ").concat(e.start, "-").concat(e.end - 1, " of ").concat(e.totalSize, " bytes"));
      let n = i().throttle(t => {
        let n = e.start + t.loaded;
        this.emit("progress", n, e.totalSize, n - this.loaded), this.loaded = n
      }, 50);
      try {
        if ((await a.tn.put(S(O({
            url: e.sessionUrl,
            body: e.chunk,
            headers: t,
  ...
  uploadFileToCloud(e) {
    ...
    return void 0 !== e.md5Hash && (o[A] = e.md5Hash), a.tn.put(S(O({
  ...
  async upload() {
    ...
    try {
      ...
      let e = await this.trackTime("getUploadUrlTimeMs", async () => await a.tn.post(S(O({
