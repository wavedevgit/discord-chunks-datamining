...
function eo(e) {
  ...
  return i ? null : <A.d isTrayButton={true} isActive={l} label={l ? ea.intl.string(ea.t.GCimTk) : o ? ea.intl.string(ea.t.hLbG5O) : ea.intl.string(ea.t.e4WMv7)} iconComponent={c.V9} onClick={() => {
      (0, y.v)(n, y.d.REQUEST_TO_SPEAK, !l), a()
    }} color={l ? "green" : true} disabled={!o && !l} />
}
let ec = Chunk73800.memo(function(e) {
  let {
    channel: t
  } = e, n = (0, s.e7)([H.Z], () => H.Z.getVoiceChannelId() === t.id, [t.id]);
  return <div className={es.container}>{<div className={es.buttonSection}>{<ep channelId={t.id} />}{n ? <eo channel={t} /> : null}{<N.Z channel={t} />}</div>}{<ed channel={t} />}</div>
});
...
function eu(e) {
  ...
  return <A.d isTrayButton={true} onClick={() => {
      (0, W.RK)(t, false), (0, y.v)(n, y.d.SPEAK_ON_STAGE)
    }} iconComponent={c.Lrb} label={ea.intl.string(ea.t["8Joh+v"])} />
}
...
function ed(e) {
  ...
  if (!b) return <o.zx size={o.zx.Sizes.MEDIUM} color={o.zx.Colors.GREEN} className={a()(es.buttonSpacing, es.buttonWithTextButton)} onClick={() => {
      (0, y.v)(Z, y.d.JOIN_STAGE), (0, V.TM)(t)
    }}><div className={es.buttonWithTextInnerContainer}>{<c.Csw size={"md"} color={"currentColor"} className={es.buttonWithTextIcon} />}{<c.Text color={"none"} variant={"text-sm/medium"}>{ea.intl.string(ea.t["7vb2cX"])}</c.Text>}</div></o.zx>;
  let N = () => (function(e) {
    let {
      channel: t,
      appContext: n
  ...
  return (C || I) && null != g ? <c.yRy targetElementRef={T} renderPopout={e => {
      let {
        closePopout: i
      } = e;
      return (0, r.jsx)(w.Z, {
    ...
    }} align={"center"} position={"top"} spacing={16} animation={c.yRy.Animation.FADE}>{(e, t) => {
      let {
        onClick: n
      } = e, {
        isShown: i
    ...
    }}</c.yRy> : _ && !S || v ? <D.Z label={ea.intl.string(ea.t.SMKyio)} onClick={N} /> : <D.Z label={ea.intl.string(ea.t.c6qKws)} onClick={N} />
}
...
function eh(e) {
  ...
  return <A.d isTrayButton={true} iconComponent={c.zRq} label={ea.intl.string(ea.t.ezLpY2)} onClick={() => {
...
function ep(e) {
  ...
  return l ? <A.d isTrayButton={true} isActive={!i} label={i ? ea.intl.string(ea.t.ScHlfn) : ea.intl.string(ea.t.zqxfra)} iconComponent={i ? c.xjP : c.RZG} color={i ? true : "green"} onClick={() => {
      (0, y.v)(n, y.d.STAGE_MUSIC, i), (0, X.v)(!i)
    }} /> : <A.d isTrayButton={true} isActive={a} label={a ? ea.intl.string(ea.t.zqxfra) : ea.intl.string(ea.t.ScHlfn)} iconComponent={a ? c.RZG : c.xjP} color={a ? "green" : true} onClick={() => {
...
let ef = Chunk73800.memo(function(e) {
  ...
  let K = <c.yRy targetElementRef={Y} renderPopout={e => {
      let {
        closePopout: t
      } = e;
      return (0, r.jsx)(w.Z, {
    ...
    }} position={"top"} align={"right"} spacing={16} animation={c.yRy.Animation.FADE}>{(e, t) => {
      let {
        onClick: n
      } = e, {
        isShown: i
  ...
  return <div className={es.wrapper}>{D && !l ? <div className={es.buttonSection}>{<c.yRy targetElementRef={q} renderPopout={e => {
          let {
            closePopout: t
          } = e;
          return (0, r.jsx)(w.Z, {
        ...
        }} align={"right"} position={"top"} spacing={16} animation={c.yRy.Animation.FADE}>{(e, t) => {
          let {
            onClick: n
          } = e, {
            isShown: i
        ...
        }}</c.yRy>}{B && K}</div> : null}{<div className={es.buttonSection}>{D && !l && B ? <T.NZ channel={t} currentUser={E} exitFullScreen={() => null} canGoLive={A} hasPermission={O} disabled={W} /> : null}{<ep channelId={t.id} />}{D && <eo channel={t} />}{D && u && l && <eu channel={t} />}{D && !l && <eh channel={t} />}{<N.Z channel={t} />}</div>}{<ed channel={t} />}</div>
});
...
function eg(e) {
  ...
  return <div className={es.wrapper}>{<div className={es.buttonSection}><ep channelId={t.id} /></div>}{<ed channel={t} />}</div>
}
let em = Chunk73800.memo(function(e) {
  ...
  return n ? <eg channel={t} /> : i || l ? <div className={es.containerColumn}>{<div className={es.eventPrompts}>{u ? <v.Z channelId={null == t ? true : t.id} /> : null}{<div className={es.separator} />}{u && a ? <C.Z highlight={true} channel={t} /> : null}{<div className={es.separator} />}</div>}{<ef channel={t} />}</div> : <ec channel={t} />
})