...
let x = new s.Z("EmojiStudioModal"),
  w = e => {
    let {
      ...
      guildId: r,
      back: s
    } = e, h = (0, i.e7)([c.Z, d.Z, u.Z], () => {
      let e = d.Z.getGuildId(),
        t = c.Z.getGuild(e);
      return u.Z.can(O.Plq.CREATE_GUILD_EXPRESSIONS, t) && null != t ? t.id : null
    }), [f, w] = l.useState(null != r ? r : h), [_, E] = l.useState(null), [v, C] = l.useState(""), [A, S] = l.useState(null), [P, R] = l.useState(!1), M = async () => {
  ...
  I = e => {
    let {
      onChange: t,
      selected: r
    } = e, o = (0, i.e7)([c.Z], () => c.Z.getGuilds()), s = l.useMemo(() => Object.values(o).filter(v).map(E), [o]), u = l.useCallback(e => {
      let [t] = e;
