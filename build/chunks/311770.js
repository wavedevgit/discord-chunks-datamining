...
let O = new o.Z("EmojiStudioModal"),
  j = e => {
    ...
    }), [j, E] = a.useState(null != r ? r : h), [N, I] = a.useState(null), [y, C] = a.useState(""), [S, w] = a.useState(null), [A, k] = a.useState(!1), M = async () => {
    ...
    }, L = a.useRef(0), T = a.useCallback(e => {
      let {
        imageData: t,
  ...
  E = e => {
    let {
      ...
      userImage: r,
      guildId: i
    } = e, [s, o] = a.useState(r), c = a.useCallback(() => o(null), [o]), u = null == s ? l.CgR.MEDIUM : l.CgR.LARGE;
