...
let j = new s.Z("EmojiStudioModal"),
  w = e => {
    let {
      ...
      guilds: s,
      currentGuildId: c
    } = _(), [u, d] = i.useState(null != r ? r : c), [h, p] = i.useState(null), [O, w] = i.useState(""), [x, E] = i.useState(null), [v, N] = i.useState(!1), C = async () => {
    ...
    }, S = i.useRef(0), A = i.useCallback(e => {
      let {
        imageData: t,
  ...
  x = e => {
    let {
      ...
      userImage: r,
      guildId: l
    } = e, [o, s] = i.useState(r), c = i.useCallback(() => s(null), [s]);
    ...
    return (0, n.jsxs)("div", {
      ...
      children: [(0, n.jsxs)("header", {
        ...
        children: [(0, n.jsx)(a.dZu, {
          ...
          children: ["Drag & drop or ", (0, n.jsx)(v, {
            setUserImage: t
          })]
        })]
      })]
