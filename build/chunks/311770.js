...
let v = e => {
    let {
      ...
      guilds: n,
      currentGuildId: o
    } = f(), [d, u] = r.useState(o), [c, m] = r.useState(null), [x, j] = r.useState(null), v = async () => {
  ...
  b = e => {
    let {
      transitionState: l,
      userImage: n
    } = e, [a, o] = r.useState(n), s = null == a ? i.CgR.MEDIUM : i.CgR.LARGE;
  ...
  _ = e => {
    ...
    return (0, t.jsxs)("div", {
      ...
      children: [(0, t.jsxs)("header", {
        ...
        children: [(0, t.jsx)(i.dZu, {
          size: "lg",
          color: i.TVs.colors.HEADER_MUTED
        }), (0, t.jsxs)(i.Text, {
          variant: "text-md/medium",
          children: ["Drag & drop or ", (0, t.jsx)(I, {
            setUserImage: l
          })]
        })]
      }), (0, t.jsx)(i.olH, {
  ...
  I = e => {
    ...
    return (0, t.jsxs)(i.P3F, {
      ...
      tag: "a",
      children: ["Select an image", (0, t.jsx)(d.Z, {
        tabIndex: 0,
        onChange: (e, n, t) => (l({
          data: e,
          file: n,
