...
let O = new o.Z("EmojiStudioModal"),
  E = e => {
    let {
      ...
      guildId: r,
      back: o
    } = e, g = (0, l.e7)([c.Z, d.Z, u.Z], () => {
      let e = d.Z.getGuildId(),
        t = c.Z.getGuild(e);
      return u.Z.can(x.Plq.CREATE_GUILD_EXPRESSIONS, t) && null != t ? t.id : null
    }), [E, N] = a.useState(null != r ? r : g), [I, y] = a.useState(null), [C, S] = a.useState(""), [w, A] = a.useState(null), [k, T] = a.useState(!1), M = async () => {
    ...
    }, R = a.useRef(0), L = a.useCallback(e => {
      let {
        imageData: t,
      ...
      null != t && p.ZP.isDataTooBig(t) && (l = h.ze.TOO_BIG), y(null != n ? n : l), T(a), r < R.current || null != t && (A(t), R.current = r)
    }, []);
        ...
        children: [null != I && (0, n.jsx)(m.H, {
          ...
          children: [(0, n.jsxs)("div", {
            ...
            children: [(0, n.jsx)("img", {
              src: null != w ? w : "",
              alt: "Edited",
              className: k ? j.loading : ""
            }), (0, n.jsx)(v.R, {
              onChange: e => {
                S(e.length < 2 ? e : p.ZP.sanitizeEmojiName(e))
              },
              value: C
            })]
          }), (0, n.jsx)(f.q, {
  ...
  N = e => {
    let {
      ...
      userImage: r,
      guildId: l
    } = e, [i, o] = a.useState(r), c = a.useCallback(() => o(null), [o]), u = null == i ? s.CgR.MEDIUM : s.CgR.LARGE;
