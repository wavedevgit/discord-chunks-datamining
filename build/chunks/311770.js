...
let _ = new i.Yd("EmojiStudioModal"),
  O = e => {
    let {
      ...
      guilds: i,
      currentGuildId: o
    } = x(), [c, u] = l.useState(o), [d, b] = l.useState(null), [p, j] = l.useState(""), O = async () => {
  ...
  I = e => {
    let {
      transitionState: t,
      userImage: r
    } = e, [i, o] = l.useState(r), s = l.useCallback(() => o(null), [o]);
    ...
    return (0, n.jsxs)("div", {
      ...
      children: [(0, n.jsxs)("header", {
        ...
        children: [(0, n.jsx)(a.dZu, {
          ...
          children: ["Drag & drop or ", (0, n.jsx)(E, {
            setUserImage: t
          })]
        })]
      })]
