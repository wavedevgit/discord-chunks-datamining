...
let j = new s.Z("EmojiStudioModal"),
  w = e => {
    let {
      ...
      guilds: l,
      currentGuildId: s
    } = _(), [c, u] = i.useState(s), [d, h] = i.useState(null), [p, O] = i.useState(""), [w, x] = i.useState(null), [E, v] = i.useState(!1), N = async () => {
    ...
    }, C = i.useRef(0), S = i.useCallback(e => {
      let {
        imageData: t,
  ...
  x = e => {
    let {
      transitionState: t,
      userImage: r
    } = e, [l, o] = i.useState(r), s = i.useCallback(() => o(null), [o]);
