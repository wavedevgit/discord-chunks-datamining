...
let b = e => {
    let {
      guilds: l,
      currentGuildId: n
    } = _(), [r, d] = a.useState(n), [u, c] = a.useState(null), [m, f] = a.useState(null), [b, j] = a.useState(e.userImage), I = async () => {
  ...
  v = e => {
    ...
    return (0, t.jsxs)(o.zxk, {
      ...
      children: ["Select an image", (0, t.jsx)(u.Z, {
        disabled: n,
        tabIndex: 0,
        onChange: (e, n, t) => (l({
          data: e,
