...
let x = new s.Z("EmojiStudioModal"),
  w = e => {
    let {
      ...
      guildId: r,
      back: s
    } = e, c = (0, i.e7)([u.Z, h.Z, d.Z], () => {
      let e = h.Z.getGuildId(),
        t = u.Z.getGuild(e);
      return d.Z.can(O.Plq.CREATE_GUILD_EXPRESSIONS, t) && null != t ? t.id : null
    }), [g, w] = l.useState(null != r ? r : c), [_, E] = l.useState(null), [v, N] = l.useState(""), [C, S] = l.useState(null), [P, R] = l.useState(!1), M = async () => {
    ...
    }, k = l.useRef(0), T = l.useCallback(e => {
      let {
        imageData: t,
  ...
  _ = e => {
    let {
      ...
      userImage: r,
      guildId: i
    } = e, [o, s] = l.useState(r), c = l.useCallback(() => s(null), [s]), u = null == o ? a.CgR.MEDIUM : a.CgR.LARGE;
  ...
  I = e => {
    let {
      onChange: t,
      selected: r
    } = e, o = (0, i.e7)([u.Z], () => u.Z.getGuilds()), s = l.useMemo(() => Object.values(o).filter(v).map(E), [o]), c = l.useCallback(e => {
      let [t] = e;
  ...
  N = e => {
    ...
    return (0, n.jsxs)("div", {
      ...
      children: [(0, n.jsxs)("header", {
        ...
        children: [(0, n.jsx)(a.dZu, {
          size: "lg",
          color: a.TVs.colors.HEADER_MUTED
        }), (0, n.jsxs)(a.Text, {
          variant: "text-md/medium",
          children: ["Drag & drop or ", (0, n.jsx)(C, {
            setUserImage: t
          })]
        })]
      })]
  ...
  C = e => {
    ...
    return (0, n.jsxs)(a.P3F, {
      ...
      tag: "a",
      children: ["Select an image", (0, n.jsx)(c.Z, {
        tabIndex: 0,
        onChange: (e, r, n) => (t({
          data: e,
          file: r,
