...
let v = e => {
    let {
      ...
      guilds: s,
      currentGuildId: d
    } = k(), [u, c] = t.useState(d), [m, j] = t.useState(null), [g, v] = t.useState(null), [_, I] = t.useState(""), f = async () => {
  ...
  _ = e => {
    let {
      transitionState: l,
      userImage: n
    } = e, [a, s] = t.useState(n), o = t.useCallback(() => s(null), [s]);
  ...
  I = e => {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)("header", {
        ...
        children: [(0, r.jsx)(i.dZu, {
          size: "lg",
          color: i.TVs.colors.HEADER_MUTED
        }), (0, r.jsxs)(i.Text, {
          variant: "text-md/medium",
          children: ["Drag & drop or ", (0, r.jsx)(f, {
            setUserImage: l
          })]
        })]
      })]
  ...
  f = e => {
    ...
    return (0, r.jsxs)(i.P3F, {
      ...
      tag: "a",
      children: ["Select an image", (0, r.jsx)(d.Z, {
        tabIndex: 0,
        onChange: (e, n, r) => (l({
          data: e,
          file: n,
