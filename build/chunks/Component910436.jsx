...
function E(e) {
  ...
  for (let {
    ...
    if (I.length > 1 && x.type === O.IIU.PLAYING && !(0, a.Z)(x) && null != Z) P((0, r.jsx)(m.Z.GameSection, {
    ...
    null != E && null != Z && (0, d._D)(x, E) && (null == E.userStatus || !(0, d.zE)(E.userStatus, p.jn.ACTIVITY_PANEL)) && P((0, r.jsx)(f.Z, {
      quest: E
