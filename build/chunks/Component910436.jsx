...
function y(e) {
  ...
  for (let {
    ...
    if (Z.type === v.IIU.PLAYING)
    ...
    } else Z.type === v.IIU.LISTENING && ((0, o.Z)(Z) ? A((0, r.jsx)(E.Z.SpotifySection, {
      activity: Z,
      isSolo: 1 === T.length,
      partySize: {
        knownSize: L.length,
      ...
      getAssetImage: m.xF,
      members: L
    }, "spotify-".concat(null != (I = Z.session_id) ? I : t, "-").concat(R.id))) : (null != Z.assets || (0, a.Z)(Z)) && A((0, r.jsx)(E.Z.RichPresenceSection, {
      activity: Z,
      getAssetImage: m.xF,
      user: R
