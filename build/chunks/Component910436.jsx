...
function I(e) {
  ...
  for (let {
    ...
    P && null != I && null != Z && (0, d._D)(A, I) && (null == I.userStatus || !(0, d.zE)(I.userStatus, f.jn.ACTIVITY_PANEL)) && x((0, r.jsx)(m.Z, {
      quest: I
    }, "quest-".concat(I.id, "-").concat(null != (j = A.session_id) ? j : t)))
  }), j.length > 0 ? (0, r.jsx)(_.Z.Body, {
    children: j
  }) : null
}