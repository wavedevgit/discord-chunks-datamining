...
function x(t, n, e, i) {
  ...
  return <u.sNh id={m.intl.string(m.t.k5pvjo)} label={m.intl.string(m.t.k5pvjo)} action={q}>{<u.sNh id={m.intl.string(m.t.JKSLRE)} label={m.intl.string(m.t.JKSLRE)} action={() => {
        var t;
      ...
      }} />}{<u.sNh id={m.intl.string(m.t.nrBYSU)} label={m.intl.string(m.t.nrBYSU)} action={q} />}{<u.sNh id={m.intl.string(m.t.odzaCQ)} label={m.intl.string(m.t.odzaCQ)} action={() => {
        let t = {
            v: 60,
            title: T.name,
            st: X.format(O),
      ...
      }} />}{<u.sNh id={m.intl.string(m.t.rQe8EB)} label={m.intl.string(m.t.rQe8EB)} action={() => {
        let t = {
