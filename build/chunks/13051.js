...
function Z(e) {
  let t, {
    ...
    K = (0, d.e7)([j.Z], () => null != l.role_id ? j.Z.getRole(n.id, l.role_id) : void 0),
    {
      ...
      return {
        roleLink: e,
        syncDescriptionText: l.revoked && null != n ? E.intl.formatToPlainString(E.t.G16Wjo, {
          user: l.user,
          platformName: n.name
  ...
  if (i.useEffect(() => {
    ...
    icon: p.T39,
    text: L ? E.intl.formatToPlainString(E.t.gcdJ8P, {
  ...
  let $ = (0, r.jsxs)(g.Z, {
    ...
    Q = null;
  return Z && !D && null != a && (Q = (0, r.jsxs)(g.Z, {
    className: I.body,
