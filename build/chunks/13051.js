...
function P(e) {
  let t, {
    ...
    B = r.useCallback(() => {
      l.syncing || (0, p.h7j)(e => {
        ...
        return (0, i.jsx)(p.ConfirmModal, (t = E({}, e), n = n = {
    ...
    K = (0, d.e7)([j.Z], () => null != l.role_id ? j.Z.getRole(n.id, l.role_id) : void 0),
    {
      ...
      return {
        roleLink: e,
        syncDescriptionText: l.revoked && null != n ? I.intl.formatToPlainString(I.t.G16Wjo, {
          user: l.user,
          platformName: n.name
  ...
  let J = (0, i.jsxs)(g.Z, {
    ...
    Q = null;
  return P && !R && null != a && (Q = (0, i.jsxs)(g.Z, {
    className: w.body,
