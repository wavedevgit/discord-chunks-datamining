  ...
  let t, {
    ...
    B = i.useCallback(() => {
      l.syncing || (0, u.h7j)(e => {
        ...
        return (0, r.jsx)(u.ConfirmModal, (t = T({}, e), n = n = {
    ...
    }, [l.role_id]),
    {
      ...
      var e, t, n, r, i;
      let o = null != (n = null == (t = m.Z.get(l.type)) || null == (e = t.getPlatformUserUrl) ? void 0 : e.call(t, {
        id: l.account.id,
        name: l.account.name
      })) ? n : "";
      switch (l.type) {
    ...
    }, [l.account, l.subscriber_count, l.type]),
    {
      ...
      let e, t, n = null != l.role_id ? A[l.role_id] : null;
    ...
    Y = i.useMemo(() => {
      let e = g.ZP.getGuildEmoji(n.id),
        t = Object.values(A).filter(e => null != e.tags && e.tags.integration_id === l.id).map(e => e.id);
          ...
          children: [(0, r.jsx)(u.vwX, {
            ...
            children: [(0, r.jsxs)(b.Z, {
              ...
              children: t.syncing ? (0, r.jsx)(v.Z, {
                ...
                children: I.intl.string(I.t.BkuOOz)
              })
            })]
          })]
        })]
