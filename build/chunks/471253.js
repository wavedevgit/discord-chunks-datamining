...
function A(t, n) {
  let e = t.getGuildId();
  return r()(null != e, "This channel cannot be guildless."), n && (0, o.yw)(p.rMx.REQUEST_TO_SPEAK_INITIATED, g({}, (0, h.s$)(t))), a.tn.patch({
...
function O(t, n) {
  ...
  return (0, f.gf)(l) !== f.xO.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK || n || (0, o.yw)(p.rMx.PROMOTED_TO_SPEAKER, g({}, (0, h.s$)(t))), a.tn.patch({
...
function N(t, n, e) {
  ...
  e ? (o.allow = l.IH(o.allow, n), o.deny = l.Od(o.deny, n)) : (o.allow = l.Od(o.allow, n), o.deny = l.IH(o.deny, n)), u.Z.updatePermissionOverwrite(t.id, o)
}
