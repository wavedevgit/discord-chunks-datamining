...
function T(e, t) {
  let n = e.getGuildId();
  return r()(null != n, "This channel cannot be guildless."), t && (0, c.yw)(C.rMx.REQUEST_TO_SPEAK_INITIATED, g({}, (0, E.s$)(e))), o.tn.patch({
...
function O(e, t) {
  let n = e.getGuildId();
  return r()(null != n, "This channel cannot be guildless."), o.tn.patch({
...
function S(e, t) {
  ...
  return (0, p.gf)(l) !== p.xO.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK || t || (0, c.yw)(C.rMx.PROMOTED_TO_SPEAKER, g({}, (0, E.s$)(e))), o.tn.patch({
...
function N(e) {
  ...
  return r()(null != t, "This channel cannot be guildless."), o.tn.patch({
...
function f(e, t, n) {
  let i = e.getGuildId();
  return r()(null != i, "This channel cannot be guildless."), o.tn.patch({
...
function R(e, t) {
  ...
  let n = t.getGuildId();
  return r()(null != n, "This channel cannot be guildless."), f(t, e.id, !0), o.tn.patch({
