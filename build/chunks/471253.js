...
function p(e, t) {
  let n = e.getGuildId();
  return i()(null != n, "This channel cannot be guildless."), t && (0, s.yw)(f.rMx.REQUEST_TO_SPEAK_INITIATED, x({}, (0, _.s$)(e))), a.tn.patch({
...
function j(e, t) {
  ...
  return (0, b.gf)(l) !== b.xO.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK || t || (0, s.yw)(f.rMx.PROMOTED_TO_SPEAKER, x({}, (0, _.s$)(e))), a.tn.patch({
...
function O(e, t) {
  ...
  let n = t.getGuildId();
  return i()(null != n, "This channel cannot be guildless."), I(t, e.id, !0), a.tn.patch({
