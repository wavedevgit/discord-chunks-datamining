...
let y = Chunk473749.forwardRef(function() {
    ...
    let {
      hasSearchResults: C,
      searchResults: v
    } = (0, Chunk839469.F)(), G = (0, Chunk991346.VO)(), R = (0, Chunk991346.q8)(v), U = Chunk473749.useMemo(() => C ? R : G, [C, R, G]), B = (0, Chunk332473.b)(), F = (0, Chunk113434.iO)(), I = Chunk473749.useCallback(e => {
      l.Z.setSection(e)
    }, []);
