...
let F = i.memo(e => {
  let {
    start: t
  } = e, [n, r] = i.useState(0), a = (0, R.n)(), s = (0, l.e7)([u.Z], () => u.Z.useReducedMotion), c = !1 === a || s;
  return i.useEffect(() => {
    let e = new o.Xp;
...
let B = i.memo(function(e) {
  ...
  let {
  ...
  } = (0, _.ZP)(g.Z.ACTIVITY_INSTANCE_EMBED), G = (0, c.O)(), H = (0, l.e7)([S.Z], () => S.Z.getChannel(Z), [Z]), V = (null == H || null == (t = H.isThread) ? void 0 : t.call(H)) ? null == H ? void 0 : H.parent_id : Z, z = (0, l.e7)([I.default], () => I.default.getId()), {
    embeddedActivity: K,
  ...
  }), [V, j.id]), q = null == K ? void 0 : K.userIds, Q = (0, l.Wu)([P.default], () => Array.from(null != q ? q : []).map(e => P.default.getUser(e)).filter(k.lm), [q]), J = (0, l.e7)([T.Z], () => {
    ...
    return null
  }, [j.id, q]), $ = null == J ? void 0 : J.details, ee = i.useMemo(() => {
    let e = new C.ZP(j);
    ...
    currentEmbeddedActivity: Y,
    channel: H
  }), ei = i.useId(), ea = null != X && X.isLaunching && X.componentId === ei, el = async () => {
  ...
  if (es) {
    let e, t = w.ZP.getApplicationIconURL({
      id: j.id,
      icon: j.icon,
      bot: j.bot
    });
    ...
    return null != ec && p.push(ec), (0, r.jsx)(v.W, {
      header: j.name,
      title: c,
      iconSrc: t,
      embedUrl: (0, x.H)({
