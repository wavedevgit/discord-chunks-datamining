...
let F = i.memo(e => {
  let {
    start: t
  } = e, [n, r] = i.useState(0), l = (0, R.n)(), a = (0, o.e7)([d.Z], () => d.Z.useReducedMotion), c = !1 === l || a;
  return i.useEffect(() => {
    let e = new s.Xp;
...
let B = i.memo(function(e) {
  ...
  let d, {
    ...
    q = (0, o.Wu)([N.default], () => Array.from(null != X ? X : []).map(e => N.default.getUser(e)).filter(Z.lm), [X]),
    Q = (0, o.e7)([T.Z], () => {
    ...
    }, ea = en.disabled ? M.intl.string(M.t.JBnc7O) : M.intl.string(M.t.cX9uLS), eo = (0, v.G)($, () => {
      P.default.track(L.rMx.ACTIVITY_INSTANCE_EMBED_CLICKED, {
        application_id: O.id,
        channel_id: w,
        channel_type: null == H ? void 0 : H.type,
