...
let U = i.memo(e => {
  let {
    start: t
  } = e, [n, r] = i.useState(0), l = (0, Z.n)(), s = (0, a.e7)([u.Z], () => u.Z.useReducedMotion), c = !1 === l || s;
  return i.useEffect(() => {
    let e = new o.Xp;
...
let F = i.memo(function(e) {
  ...
  let O, {
    ...
    q = (0, a.Wu)([N.default], () => Array.from(null != X ? X : []).map(e => N.default.getUser(e)).filter(w.lm), [X]),
    Q = (0, a.e7)([I.Z], () => {
    ...
    }, ea = en.disabled ? L.intl.string(L.t.JBnc7O) : L.intl.string(L.t.cX9uLS), eo = (0, v.z)($, () => {
      T.default.track(k.rMx.ACTIVITY_INSTANCE_EMBED_CLICKED, {
        application_id: A.id,
        channel_id: Z,
        channel_type: null == H ? void 0 : H.type,
  ...
  return null != eo && ef.push(eo), (0, r.jsx)(y.W, {
    header: A.name,
    title: ep,
    iconSrc: es,
    embedUrl: (0, b.H)({
