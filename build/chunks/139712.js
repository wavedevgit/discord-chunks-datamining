...
function m(e) {
  ...
  let [g, h] = r.useState(i.KX.SERIES), j = (0, i.X2)(t.id, null), b = (null == j ? void 0 : j.response) === o.gv.INTERESTED ? o.gv.UNINTERESTED : o.gv.INTERESTED, y = b === o.gv.INTERESTED ? c.NW.string(c.t.WtOReX) : c.NW.string(c.t["8MPCVl"]);
