...
function m(e) {
  ...
  let [g, b] = l.useState(s.KX.SERIES), h = (0, s.X2)(t.id, null), j = (null == h ? void 0 : h.response) === c.gv.INTERESTED ? c.gv.UNINTERESTED : c.gv.INTERESTED, O = j === c.gv.INTERESTED ? o.intl.string(o.t.WtOReX) : o.intl.string(o.t["8MPCVl"]);
  return (0, r.jsx)(i.ConfirmModal, p(d({}, v), {
    header: O,
...
function f(e, t, n, l) {
  (0, s.cg)({
    ...
    openRsvpPicker: (e, t) => {
      (0, i.ZDy)(() => Promise.resolve(i => (0, r.jsx)(m, p(d({}, i), {
        event: e,
        recurrenceId: t,
        guildId: n,
        onRsvp: l
