...
function m(e) {
  ...
  let [g, h] = r.useState(i.KX.SERIES), j = (0, i.X2)(t.id, null), b = (null == j ? void 0 : j.response) === o.gv.INTERESTED ? o.gv.UNINTERESTED : o.gv.INTERESTED, y = b === o.gv.INTERESTED ? c.intl.string(c.t.WtOReX) : c.intl.string(c.t["8MPCVl"]);
  return (0, l.jsx)(s.ConfirmModal, p(d({}, f), {
    header: y,
...
function v(e, t, n, r) {
  (0, i.cg)({
    ...
    openRsvpPicker: (e, t) => {
      (0, s.ZDy)(() => Promise.resolve(s => (0, l.jsx)(m, p(d({}, s), {
        event: e,
        recurrenceId: t,
        guildId: n,
        onRsvp: r
