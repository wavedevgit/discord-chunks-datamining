...
function S(e, t) {
  ...
  } = (0, d.V)(), [N, C] = i.useState(!1), [w, R] = (0, l.I2)(t), {
    rulesByTriggerType: P,
    updateRule: D
  } = (0, l.pH)(t), L = i.useMemo(() => {
    var e;
    return null != (e = P[I]) ? e : []
  }, [P]), x = 0 === L.length, k = n > L.length && !x;
  ...
  let U = () => {
    ...
    G = () => {
      null != t && ((0, o.Zy)(), p.Z.open(t, h.pNK.GUILD_AUTOMOD), setTimeout(() => {
        A(t, I, {
          triggerMetadata: {
            keywordFilter: [e],
            regexPatterns: [],
  ...
  return w || (Z = (0, r.jsxs)(r.Fragment, {
    children: [x && (0, r.jsx)(a.sNh, {
      id: "add-first-rule",
