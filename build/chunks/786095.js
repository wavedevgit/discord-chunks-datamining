...
function j(e, t) {
  ...
  } = (0, d.V)(), [N, I] = r.useState(!1), [Z, x] = (0, s.I2)(t), {
    rulesByTriggerType: D,
    updateRule: T
  } = (0, s.pH)(t), M = r.useMemo(() => {
    var e;
    return null != (e = D[v]) ? e : []
  }, [D]), A = 0 === M.length, w = n > M.length && !A;
  ...
  return Z || (k = (0, i.jsxs)(i.Fragment, {
    ...
    label: b.intl.formatToPlainString(b.t.Kkjv1t, {
      keywordCount: R
    }),
    onFocus: () => {
      N || (I(!0), x())
