...
function v(e, t) {
  ...
  } = (0, d.V)(), [_, Z] = i.useState(!1), [I, x] = (0, s.I2)(t), {
    rulesByTriggerType: T,
    updateRule: A
  } = (0, s.pH)(t), M = i.useMemo(() => {
    var e;
    return null != (e = T[N]) ? e : []
  }, [T]), D = 0 === M.length, w = n > M.length && !D;
  ...
  let L = () => {
      null != t && ((0, l.Zy)(), m.Z.open(t, b.pNK.GUILD_AUTOMOD), setTimeout(() => {
        P(t, N, {
          triggerMetadata: {
            keywordFilter: [e],
            regexPatterns: [],
  ...
  return I || (k = (0, r.jsxs)(r.Fragment, {
    ...
    label: p.NW.formatToPlainString(p.t.Kkjv1t, {
      keywordCount: W
    }),
    onFocus: () => {
      _ || (Z(!0), x())
