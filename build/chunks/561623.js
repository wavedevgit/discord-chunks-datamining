      ...
      footer: (0, t.jsxs)("div", {
        children: [null !== et ? (0, t.jsx)(c.Text, {
          ...
          children: function(e) {
            switch (ee) {
              case j.rV.YEAR:
                return er ? x.intl.format(x.t.O7JRzc, {
                  price: e
                }) : x.intl.format(x.t["0y5kAA"], {
                  price: e
                });
              case j.rV.MONTH:
                if (null != Q) return x.intl.format(x.t["1/ucvr"], {
                  discountPrice: Q,
                  defaultPrice: e
                });
                if (er) return x.intl.format(x.t.rbwRlZ, {
                  price: e
                });
                if (1 === eo) return x.intl.format(x.t.C9oRCw, {
                  price: e
                });
          ...
          children: [(0, t.jsx)(c.zxk, {
            ...
            onClick: () => {
              if (null != Z) {
                ...
                null != G && G.id === Z.paymentSourceId && e ? (u.O5(Z, Y, v.Sbl.UNCANCEL_WINBACK_MODAL), D(!0)) : (B.onClose(), (0, m.Z)({
                  initialPlanId: W,
                  analyticsLocations: Y,
