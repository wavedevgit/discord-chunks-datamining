...
let R = e => {
  ...
  return o.useEffect(() => {
    ...
    children: X ? (0, r.jsxs)(r.Fragment, {
      ...
      premiumType: A,
      titleText: et ? M.intl.formatToPlainString(M.t.Sngnzs, {
        daysLeft: U
      }) : M.intl.formatToPlainString(M.t.tdvIlZ, {
        daysLeft: U
      }),
      ...
      footer: (0, r.jsxs)("div", {
        children: [null !== en ? (0, r.jsx)(a.Text, {
          ...
          children: function(e) {
            switch ($) {
              case P.rV.YEAR:
                return et ? M.intl.format(M.t.O7JRzc, {
                  price: e
                }) : M.intl.format(M.t["0y5kAA"], {
                  price: e
                });
              case P.rV.MONTH:
                if (null != J) return M.intl.format(M.t["1/ucvr"], {
                  discountPrice: J,
                  defaultPrice: e
                });
                if (et) return M.intl.format(M.t.rbwRlZ, {
                  price: e
                });
                if (1 === ee) return M.intl.format(M.t.C9oRCw, {
                  price: e
                });
          ...
          children: [(0, r.jsx)(a.zxk, {
            ...
            onClick: () => {
              if (null != v) {
                ...
                null != D && D.id === v.paymentSourceId && e ? (s.O5(v, B, O.Sbl.UNCANCEL_WINBACK_MODAL), Y(!0)) : (w.onClose(), (0, f.Z)({
                  initialPlanId: H,
                  analyticsLocations: B,
