...
let x = e => {
  ...
  let B = (0, s.ZP)(),
    ...
    } = (0, d.ZP)(_.Z.PREMIUM_UNCANCEL_MODAL),
  ...
  return n.useEffect(() => {
    ...
    children: z ? (0, t.jsxs)(t.Fragment, {
      ...
      premiumType: k,
      titleText: eo ? v.intl.formatToPlainString(v.t.Sngnzs, {
        daysLeft: E
      }) : v.intl.formatToPlainString(v.t.tdvIlZ, {
        daysLeft: E
      }),
      subtitleText: eo ? v.intl.format(v.t["6Su2XV"], {}) : v.intl.format(v.t["lE+P8f"], {}),
      footer: (0, t.jsxs)("div", {
        children: [null !== er ? (0, t.jsx)(a.Text, {
          variant: "text-sm/normal",
          children: function(e) {
            switch (Q) {
              case T.rV.YEAR:
                return eo ? v.intl.format(v.t.O7JRzc, {
                  price: e
                }) : v.intl.format(v.t["0y5kAA"], {
                  price: e
                });
              case T.rV.MONTH:
                if (null != $) return v.intl.format(v.t["1/ucvr"], {
                  discountPrice: $,
                  defaultPrice: e
                });
                if (eo) return v.intl.format(v.t.rbwRlZ, {
                  price: e
                });
                if (1 === ee) return v.intl.format(v.t.C9oRCw, {
                  price: e
                });
          ...
          children: [(0, t.jsx)(a.zxk, {
            ...
            onClick: () => {
              if (null != U) {
                ...
                null != Y && Y.id === U.paymentSourceId && e ? (c.O5(U, D, j.Sbl.UNCANCEL_WINBACK_MODAL), R(!0)) : (M.onClose(), (0, f.Z)({
                  initialPlanId: G,
                  analyticsLocations: D,
