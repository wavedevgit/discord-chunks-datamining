...
function P(e) {
  let {
    ...
    onEnable: P,
    onClose: _
  } = e, k = w.Z.getCameraComponent(), S = p.qF.useSetting(), [j, y] = n.useState((0, g.P)(b.default.getCurrentUser())), x = (0, s.O)(), {
    ...
    children: (0, r.jsx)(o.Z, {
      ...
      children: (0, r.jsx)(i.Modal, {
        ...
        actionBarInput: (0, r.jsx)(c.XZJ, {
          ...
          checked: S,
          onChange: () => {
            p.qF.updateSetting(!S), f.default.track(C.rMx.UPDATE_USER_SETTINGS_LOCAL, {
