...
function k(e) {
  let {
    ...
    onEnable: k,
    onClose: y
  } = e, O = f.Z.getCameraComponent(), _ = p.qF.useSetting(), [j, x] = n.useState((0, h.P)(m.default.getCurrentUser())), S = (0, s.O)(), {
    analyticsLocations: A
  } = (0, u.ZP)(d.Z.CAMERA_PREVIEW);
  n.useEffect(() => {
    w.default.track(C.rMx.OPEN_MODAL, {
  ...
  let M = n.useCallback(async () => {
    ...
    D = n.useCallback(async () => {
      await M(), l.Z.setVideoEnabled(true), null == k || k()
    }, [M, k]),
    I = n.useMemo(() => [{
      variant: "primary",
    ...
    children: (0, r.jsx)(o.Z, {
      ...
      children: (0, r.jsx)(i.Modal, {
        ...
        actionBarInput: (0, r.jsx)(c.Checkbox, {
          ...
          checked: _,
          onChange: () => {
            p.qF.updateSetting(!_), w.default.track(C.rMx.UPDATE_USER_SETTINGS_LOCAL, {
