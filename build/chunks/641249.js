...
function j() {
  let {
    editStateId: e,
    guildId: t
  } = (0, o.N)(), [j, v] = c.XZ(e, t), _ = (0, u.Z)(t, e), {
    setCurrentTab: O
  } = (0, p.dw)(), y = () => O(p.ue.EMOJIS), C = (0, i.e7)([s.Z], () => s.Z.getGuild(t)), N = null != C ? (0, d.Z)(C) : void 0;
  ...
  return (0, r.jsxs)(l.hjN, {
    ...
    children: [(0, r.jsxs)(l.R94, {
      ...
      onRemoveEmoji: function(e) {
        e.roles.filter(e => e !== (null == _ ? void 0 : _.id)).length > 0 ? E(e.id) : (0, l.ZDy)(async () => {
          let {
            default: t
