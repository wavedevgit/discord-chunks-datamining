...
class d {
  markChanged() {
    ...
    }), this.ids = e, this.channelIds = t, this.version++
  }
  mergeTag(e, t) {
    let n = {
      type: i.sz.COMPLETE,
  ...
  constructor(e) {
    s(this, "tags", void 0), s(this, "defaultTags", void 0), s(this, "ids", new Set), s(this, "channelIds", new Set), s(this, "version", 0), this.defaultTags = function(e) {
    ...
    }(e), this.tags = this.defaultTags, this.markChanged()
  }
}