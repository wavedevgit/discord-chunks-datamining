...
function _(e) {
  let {
    ...
    className: _,
    "data-jump-section": O
  } = e, E = i.useRef(null), y = (0, l.e7)([p.default], () => p.default.getCurrentUser()), v = i.useRef(null), I = (0, l.e7)([d.ZP], () => (null == y ? void 0 : y.id) != null && d.ZP.getMentionCount(y.id, g.W.NOTIFICATION_CENTER) > 0), {
    enabled: C
  } = s.Z.useExperiment({
