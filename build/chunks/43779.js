...
function w(e) {
  ...
  let {
  ...
  } = e, D = o.useMemo(() => g.r.build(P.config), [P.config]), Q = D.defaultRewardName, V = D.defaultRewardNameWithArticle, L = (null == (t = P.userStatus) ? void 0 : t.enrolledAt) != null, {
    ref: M,
    scrollHeight: W
  } = (0, u.kE)(), Z = 104 !== W, {
    ...
    config: (w = function(e) {
      ...
      clamp: !0
    }, Object.getOwnPropertyDescriptors ? Object.defineProperties(w, Object.getOwnPropertyDescriptors(T)) : (function(e, t) {
      var n = Object.keys(e);
  ...
  }), z = (null == (n = P.userStatus) ? void 0 : n.completedAt) != null, F = (null == (s = P.userStatus) ? void 0 : s.claimedAt) != null, X = (0, f.xN)(P.config), K = (0, f.LM)(P.config), {
    completedRatio: Y,
    completedRatioDisplay: G
  } = (0, m.I)(P), J = (0, m.Bd)(P, q), $ = o.useMemo(() => F && X ? C.intl.format(C.t["8Op4c3"], {
