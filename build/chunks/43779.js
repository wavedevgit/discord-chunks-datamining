...
function E(e) {
  ...
  }), L = o.useMemo(() => x.r.build(A.config), [A.config]), Z = L.defaultReward.messages.name, W = L.defaultReward.messages.nameWithArticle, V = M ? Z : W, Q = (null == (t = A.userStatus) ? void 0 : t.enrolledAt) != null, {
    ref: U,
    scrollHeight: H
  } = (0, d.kE)(), z = 104 !== H, {
  ...
  }), K = (null == (n = A.userStatus) ? void 0 : n.completedAt) != null, Y = (null == (s = A.userStatus) ? void 0 : s.claimedAt) != null, G = (0, f.xN)(A.config), J = (0, f.LM)(A.config), {
    completedRatio: $,
    completedRatioDisplay: ee
  } = (0, m.I)(A), et = (0, m.Bd)(A), en = o.useMemo(() => Y && G ? w.intl.format(w.t["8Op4c3"], {
  ...
  }, [et]), eo = (0, l.e7)([u.Z], () => u.Z.useReducedMotion);
  return (0, r.jsxs)("div", {
