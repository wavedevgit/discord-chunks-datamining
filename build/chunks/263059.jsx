...
function k(e) {
  ...
  let J = () => {
      ...
      return 0 === o.length ? null : null == x.sync_id ? <C.Z variant={"text-xs/normal"} text={o.join(", ")} /> : <C.Z variant={"text-xs/normal"} text={o.map((e, t) => (0, r.jsxs)(i.Fragment, {
    ...
    $ = () => {
      ...
      return null == t || null == n ? null : <R.Z start={t} end={n} />
    },
    ee = () => n.id === o.id ? null : <div className={L.actions}><P.Z user={n} activity={x} onAction={X} /></div>;
  if (null === F) return null;
  let et = null != (t = x.application_id) ? t : x.name,
    en = V === D.n_.ACTIVITY && H === et;
  return <u.Gt value={q}><T.Z targetElementRef={Z} sourceType={D.n_.ACTIVITY} user={n}><O.Z user={n} guildId={k} themeType={F} sourceId={et} sourceDetails={null == Y ? (0, b.Z)(x) : null} entry={Y} sourceType={D.n_.ACTIVITY} onAction={X}>{() => (0, r.jsx)(v.Z, {
          ref: Z,
          user: n,
