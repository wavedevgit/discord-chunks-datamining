...
function P(e) {
  ...
  let {
    ...
    searchId: i,
    query: o
  } = e, s = y(i), c = i, _ = (0, u.g)(i), h = d.Z.create({
    id: i,
    searchType: _,
    searchQuery: o
  });
  s.isSearching = !0, s.rawResults = null, s.analyticsId = null, s.query = a().omit(o, "type"), s.offset = null != (n = o.offset) ? n : 0, s.showBlockedResults = !1, s.searchResultsQueryString = r, w({
    type: "SEARCH_ADD_HISTORY",
    searchId: i,
    query: r
  });
  let g = i === m.I_8 ? null == (t = p.Z.getChannel(c)) ? void 0 : t.guild_id : _ === m.aib.GUILD ? i : null;
  h.fetch(e => {
    var t, n;
    l.Z.dispatch({
      type: "SEARCH_FINISH",
...
function w(e) {
  ...
  let i = A[n] = null != (t = A[n]) ? t : [],
    a = i.indexOf(r); - 1 !== a ? (i.splice(a, 1), i.unshift(r)) : null != i[0] && "" !== i[0] && r.startsWith(i[0]) ? i[0] = r : a < 0 && i.unshift(r), i.length > 5 && i.splice(5, i.length), s.K.set(v, {
    history: A
  })
}
...
function k() {
  S = !0, null != N && (0, u.g)(N) === m.aib.CHANNEL && (0, _.a)({
...
function G(e) {
  ...
  null == t ? (s.K.remove(v), A = {}) : (delete A[t], s.K.set(v, {
    history: A
  }))
}
...
function B(e) {
  ...
  null != A[t] && (A[t] = A[t].filter(e => e !== n), s.K.set(v, {
    history: A
  }))
}
