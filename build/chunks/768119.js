...
function A(e) {
  ...
  let i = v[n] = null != (t = v[n]) ? t : [],
    o = i.indexOf(r); - 1 !== o ? (i.splice(o, 1), i.unshift(r)) : null != i[0] && "" !== i[0] && r.startsWith(i[0]) ? i[0] = r : o < 0 && i.unshift(r), i.length > 5 && i.splice(5, i.length), a.K.set(E, {
    history: v
  })
}
...
function D(e) {
  ...
  null == t ? (a.K.remove(E), v = {}) : (delete v[t], a.K.set(E, {
    history: v
  }))
}
...
function L(e) {
  ...
  null != v[t] && (v[t] = v[t].filter(e => e !== n), a.K.set(E, {
    history: v
  }))
}
