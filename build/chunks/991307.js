...
function v(e) {
  let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : m.Yn.DEFAULT,
    ...
    h = u.Z.supports(m.AN.DISABLE_VIDEO) && !n ? (0, l.jsx)(i.S89, {
      id: "disable-video",
      label: O.NW.string(O.t["4MMsWF"]),
      action: () => {
        if (P) return void a.Z.show({
