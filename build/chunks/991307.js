...
function N(e) {
  let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Z.Yn.DEFAULT,
    ...
    N = (0, l.e7)([s.Z], () => s.Z.isLocalSoundboardMuted(e)),
    {
      muted: p,
      deafened: O = !1,
    ...
    x = u.Z.supports(Z.AN.DISABLE_VIDEO) && !n ? (0, i.jsx)(r.S89, {
      id: "disable-video",
      label: m.NW.string(m.t["4MMsWF"]),
      action: () => {
        if (j) {
          a.Z.show({
            title: m.NW.string(m.t.m2Hyj4),
            body: m.NW.string(m.t.EhaK6O),
            confirmText: m.NW.string(m.t.ND1my8),
            cancelText: m.NW.string(m.t.jEqEh4),
      ...
      subtext: j ? (0, i.jsxs)("div", {
        ...
        }), m.NW.string(m.t.m2Hyj4)]
      }) : null
    }, "disable-video") : null,
    y = n ? null : (0, i.jsx)(r.S89, {
      id: "soundboard-sound-mute",
      label: m.NW.string(m.t.LxhEuL),
      action: () => {
