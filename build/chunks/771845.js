...
function N(e, t) {
  ...
  S(e => null == T.nodes[e], e => T.addNode((0, c.Mg)(e), T.root, !1)), T.version = n.version;
  let r = a()(n, T);
...
function L(e) {
  ...
  n.children.map(e => e.id).filter(f.lm).forEach(e => {
    let t = T.getNode(e);
...
class Z extends E.Z {
  ...
  constructor() {
    super({
      ...
      if (null != t)
        for (let e of ((T = new c.g8).loadSnapshot(t), T.allNodes())) e.type === c.eD.FOLDER && (e.expanded = p.Z.isFolderExpanded(e.id))
    })
  }
}
