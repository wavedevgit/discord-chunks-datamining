...
function _(e) {
  ...
  return a.useEffect(() => {
    ...
    onSubmit: function(e) {
      ...
      f && (0, i.Kw)(u.v.VIDEO_BACKGROUND_FEEDBACK), null != x && (o = null != (a = null == p ? void 0 : p.value) ? a : null, s.default.track(c.rMx.VIDEO_BACKGROUND_FEEDBACK, (b = m({}, t), _ = _ = {
        reason: o,
        rating: x,
        feedback: h
      ...
      }), b)), null != p && (0, r.ZDy)(async () => {
        let {
          default: e
        } = await n.e("14466").then(n.bind(n, 729328));
        return t => (0, l.jsx)(e, m({
          body: d.intl.string(d.t.aHB11d)
        }, t))
      }))
    },
    onClose: x,
