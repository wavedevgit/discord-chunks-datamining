...
function g(e) {
  let {
    ...
    isPopoutWindow: P,
    children: w
  } = e, D = window.CSS.supports("selector(::-webkit-scrollbar)"), L = (0, l.e7)([u.Z], () => u.Z.zoom), x = P ? "" : "--custom-zoom: ".concat(L, ";"), j = "font-size: ".concat(E, "%; --saturation-factor: ").concat(v, "; ").concat(x), M = (0, p.Z)("highlight_mana_buttons"), k = (0, p.Z)("highlight_mana_components"), U = (0, p.Z)("highlight_void_toggleables"), G = (0, p.Z)("highlight_void_buttons"), B = o()((0, d.Z)(), (0, c.QeD)(a), "density-".concat(m), b, {
