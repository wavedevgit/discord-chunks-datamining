...
class D extends i.PureComponent {
  ...
  renderVideoCallButton() {
    ...
    let u = o.isManaged(),
      h = null,
      p = !1;
    return d ? (p = !0, h = w.intl.string(w.t.izMR7u), e = s.ua7.Colors.RED) : x.Z.supports(N.AN.VIDEO) ? a ? (h = w.intl.string(w.t.PHzjvb), e = s.ua7.Colors.RED, p = !0) : i && c === P.WtW.VIDEO ? (t = this.handleJoinVideoCall, h = u ? w.intl.string(w.t.S0W8Z2) : w.intl.string(w.t.W68MhI)) : (t = this.handleStartVideoCall, h = u ? w.intl.string(w.t.S0W8Z2) : w.intl.string(w.t.oCqlGB)) : (p = !0, t = this.handleBrowserNotSupported, h = w.intl.string(w.t.UVpg3d)), (0, r.jsx)(S.ZP.Icon, {
      icon: s.Odl,
      onClick: t,
      disabled: p || l,
      tooltip: h,
...
function L(e) {
  ...
  let {
    channel: n
  } = e, s = (0, m.Z)(), o = (0, l.e7)([p.Z], () => p.Z.getMode(n.id)), c = (0, l.e7)([E.Z], () => E.Z.isInChannel(n.id)), f = (0, l.e7)([u.Z], () => u.Z.useReducedMotion), {
    callActive: g,
    callUnavailable: b
  } = (0, l.cj)([j.Z], () => ({
  ...
  })), Z = (0, l.e7)([C.default], () => C.default.getUser(_)), I = (0, d.bp)(), S = [], T = (0, h.Z)(n.id), N = (0, l.e7)([O.Z], () => O.Z.hasLayers());
  ...
  }, []), s || (null == Z ? void 0 : Z.bot)) ? null : (0, r.jsx)(D, {
    channel: n,
    mode: o,
    inCall: c,
    callActive: g,
