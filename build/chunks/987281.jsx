...
function D(e) {
  let {
    ...
    onInteraction: F,
    minimal: G = false
  } = e, J = (0, l.cj)([M.default], () => {
    var e;
    return (null == t ? true : t.ownerId) === (null == (e = M.default.getCurrentUser()) ? true : e.id)
  }), Q = function(e) {
    let t = _(e),
      n = (0, S.Z)(k.Z),
    ...
    return n && c && t ? <i.sNh id={"clip-stream"} disabled={!o || !(a || d) || u} label={U.intl.string(U.t.U4URzM)} action={() => a ? (0, Z.C1)() : (0, Z.C1)((0, V.V9)(e))} /> : null
    ...
    return (n = f ? U.intl.string(U.t.S5anIS) : u ? U.intl.string(U.t.q3O3Jy) : U.intl.string(U.t["7Xq/nZ"]), o || !f && u && (null == a ? true : a.isGuildStageVoice())) ? null : <i.sNh id={"watch"} label={n} action={u ? function() {
        (0, s.g)((0, V.V9)(e))
      } : function() {
    ...
    return !t || c ? null : <i.S89 id={"mute"} label={U.intl.string(U.t.sWmtIy)} action={function() {
    ...
    return n || !t || !a || (0, A.isWeb)() ? null : <i.kSQ>{<i.S89 id={"sidechain-compression"} label={U.intl.string(U.t["/jwMtr"])} subtext={U.intl.string(U.t.zlA23N)} action={() => o.Z.setSidechainCompression(!c, {
          analyticsLocations: u
        })} checked={c} />}{<i.II_ id={"sidechain-parameters"} label={U.intl.string(U.t.fhEzfn)} control={(e, t) => {
          var n, l;
  ...
  } = (0, f.ZP)(d.Z.STREAM_CONTEXT_MENU);
  return G ? <f.Gt value={en}><i.v2r navId={"stream-context"} onClose={a.Zy} aria-label={U.intl.string(U.t.Gl3Q39)} variant={"fixed"} onSelect={R} onInteraction={F}>{<i.kSQ>{J ? et : z}</i.kSQ>}{<i.kSQ>{B}{Y}</i.kSQ>}{q}{L ? <r.Fragment>{<i.Clw />}{<i.sNh id={"more-options"} label={U.intl.string(U.t.PdRCRk)}>{X}{ee}{$}{W}</i.sNh>}</r.Fragment> : null}</i.v2r></f.Gt> : <u.Z context={n} object={N.qAy.CONTEXT_MENU}><i.v2r navId={"stream-context"} onClose={a.Zy} aria-label={U.intl.string(U.t.Gl3Q39)} variant={"flexible"} onSelect={R} onInteraction={F}>{<i.kSQ><r.Fragment>{z}{Q}{B}{$}{ee}</r.Fragment></i.kSQ>}{<i.kSQ>{Y}</i.kSQ>}{q}{<i.kSQ>{(null == K ? true : K.isGuildStageVoice()) ? null : H}{X}{L && W}</i.kSQ>}</i.v2r></u.Z>
}