...
function k(e) {
  ...
  let r, {
    ...
    ei = {
      ...
      style: (() => {
        if (K) return er && null != V ? R({}, eo.gradientStyle) : null != X ? {
          color: X
        } : void 0
      })(),
      onClick: L,
  ...
  function ea(e) {
    ...
    return (0, x.Z)(t.id, null != n.guildMemberAvatar && null != H ? (0, S.JM)({
      guildId: H,
      userId: t.id,
  ...
  let ec = l.useMemo(() => k ? (0, o.jsx)(b.ZP, {
      primaryGuild: n.primaryGuild,
      userId: i.author.id,
      contextGuildId: H,
      className: w.clanTagChiplet
    }) : null, [k, n.primaryGuild, H, i.author.id]),
    es = (0, h.nT)({
  ...
  if (null != F && null != A) {
    ...
    children: [(0, o.jsx)(u.P3F, C(R({}, ei), {
      className: a()(ei.className, _)
    })), ec]
  });
  ...
  return (0, o.jsxs)(d.Gt, {
    value: W,
    children: [null != ef && k ? (0, o.jsxs)(o.Fragment, {
      children: [" ", ef, " "]
    }) : null, "dot" === Q ? (0, o.jsx)(u.FhE, {
      color: X,
      name: Y,
      className: w.roleDot
    }) : null, r, !k && (0, o.jsx)(b.ZP, {
      primaryGuild: n.primaryGuild,
      userId: i.author.id,
      contextGuildId: H,
      className: w.clanTagChiplet
    }), null != eb ? eb : null, null == ef || k ? null : ef, null != i && (0, N.f)(i) && ee && G ? (0, o.jsx)(Z, {}) : null]
  })
}