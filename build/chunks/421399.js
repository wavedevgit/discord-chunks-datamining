...
function T(e) {
  ...
  let r, {
    ...
    V = a.useMemo(() => T ? (0, i.jsx)(b.ZP, {
      primaryGuild: n.primaryGuild,
      userId: l.author.id,
      contextGuildId: L,
      className: v.clanTagChiplet
    }) : null, [T, n.primaryGuild, L, l.author.id]);
  r = null != Z && null != I ? (0, i.jsx)(u.yRy, {
    preload: U ? void 0 : function() {
      let e = null != w ? w : l.author;
      return (0, g.Z)(e.id, null != n.guildMemberAvatar && null != L ? (0, j.JM)({
        guildId: L,
        userId: e.id,
    ...
    children: e => {
      ...
      return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(u.P3F, S(P({
          ...
          className: o()(J.className, v.clickable, E)
        })), V]
      })
    }
  }) : (0, i.jsxs)(i.Fragment, {
    children: [(0, i.jsx)(u.P3F, S(P({}, J), {
      className: o()(J.className, E)
    })), V]
  });
  ...
  return (0, i.jsxs)(d.Gt, {
    value: M,
    children: [null != X && T ? (0, i.jsxs)(i.Fragment, {
      children: [" ", X, " "]
    }) : null, "dot" === W ? (0, i.jsx)(u.FhE, {
      color: B,
      name: z,
      className: v.roleDot
      ...
      contextGuildId: L,
      className: v.clanTagChiplet
    }), null != Y ? Y : null, null == X || T ? null : X, null != l && (0, h.f)(l) && H && D ? (0, i.jsx)(N, {}) : null]
  })
}