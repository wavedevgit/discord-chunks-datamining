...
function Z(e) {
  ...
  let n, {
    ...
    el = {
      ...
      style: (() => {
        if (Q) return et && null != X ? T({}, er.gradientStyle) : null != J ? {
          color: J
        } : void 0
      })(),
      onClick: _,
  ...
  function ei(e) {
    ...
    return (0, x.Z)(t.id, null != r.guildMemberAvatar && null != U ? (0, P.JM)({
      guildId: U,
      userId: t.id,
  ...
  let ea = l.useMemo(() => Z ? (0, o.jsx)(b.ZP, {
      primaryGuild: r.primaryGuild,
      userId: i.author.id,
      contextGuildId: U,
      className: R.clanTagChiplet
    }) : null, [Z, r.primaryGuild, U, i.author.id]),
    ec = (0, j.nT)({
  ...
  if (null != D && null != I) {
    ...
    children: [(0, o.jsx)(u.P3F, w(T({}, el), {
      className: a()(el.className, A)
    })), ea]
  });
  ...
  return (0, o.jsxs)(d.Gt, {
    value: H,
    children: [null != ed && Z ? (0, o.jsxs)(o.Fragment, {
      children: [" ", ed, " "]
    }) : null, "dot" === $ ? (0, o.jsx)(u.FhE, {
      color: J,
      name: V,
      className: R.roleDot
    }) : null, n, !Z && (0, o.jsx)(b.ZP, {
      primaryGuild: r.primaryGuild,
      userId: i.author.id,
      contextGuildId: U,
      className: R.clanTagChiplet
    }), null != ef ? ef : null, null == ed || Z ? null : ed, null != i && (0, S.f)(i) && K && F ? (0, o.jsx)(E, {}) : null]
  })
}