...
function Z(e) {
  ...
  } = e, U = o.useRef(null), H = o.useContext(O.Z), V = null != (t = null == i ? void 0 : i.guild_id) ? t : H, {
    analyticsLocations: J
  } = (0, b.ZP)(f.Z.USERNAME), X = Z ? "@" : "", {
    nick: Y,
    colorString: W,
    colorStrings: $,
    colorRoleName: q
  } = r, K = (0, s.e7)([d.Z], () => d.Z.roleStyle), Q = "username" === K, ee = (0, v.X$)(), et = (0, j.Z)(null != B ? B : V, "BaseUsername"), er = (0, N.Z)(n), en = o.useContext(u.d), el = et && null != $ && null != $.primaryColor && null != $.secondaryColor, eo = Q && el;
  o.useEffect(() => {
  ...
  let {
    ...
    children: ec,
    "data-text": X + Y
  }, eu = o.useMemo(() => A ? (0, l.jsx)(g.ZP, {
    primaryGuild: r.primaryGuild,
    userId: n.author.id,
    contextGuildId: V,
    className: w.clanTagChiplet
  }) : null, [A, r.primaryGuild, V, n.author.id]), em = null != y ? y : n.author, ep = null != L && null != I ? (0, l.jsx)(h.Z, {
    targetElementRef: U,
    user: em,
    renderPopout: L,
    shouldShow: I,
    ...
    avatarUrl: null != r.guildMemberAvatar && null != V ? (0, x.JM)({
      guildId: V,
      userId: em.id,
    ...
    children: [(0, l.jsx)(p.P3F, R(C({}, es), {
      className: a()(es.className, k)
    })), eu]
  }), ed = null != G ? G[0] : null, ef = null != G ? G[1] : null;
  return (0, l.jsxs)(b.Gt, {
    value: J,
    children: [null != ed && A ? (0, l.jsxs)(l.Fragment, {
      children: [" ", ed, " "]
    }) : null, "dot" === K ? (0, l.jsx)(p.FhE, {
      color: W,
      colors: el ? $ : null,
      name: q,
      className: w.roleDot
    }) : null, ep, !A && (0, l.jsx)(g.ZP, {
      primaryGuild: r.primaryGuild,
      userId: n.author.id,
      contextGuildId: V,
      className: w.clanTagChiplet
    }), null != ef ? ef : null, null == ed || A ? null : ed, null != n && (0, S.f)(n) && ee && F ? (0, l.jsx)(E, {}) : null]
  })
}