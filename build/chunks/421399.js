...
function E(e) {
  ...
  } = e, z = o.useRef(null), [U, H] = o.useState(!1), V = o.useContext(y.Z), J = null != (t = null == i ? void 0 : i.guild_id) ? t : V, {
    analyticsLocations: X
  } = (0, f.ZP)(d.Z.USERNAME), Y = E ? "@" : "", {
    nick: W,
    colorString: $,
    colorStrings: q,
    colorRoleName: K
  } = r, Q = (0, s.e7)([p.Z], () => p.Z.roleStyle), ee = "username" === Q, et = (0, j.X$)(), er = (0, g.Z)(null != G ? G : J, "BaseUsername"), en = (0, S.Z)(n), el = er && null != q && null != q.primaryColor && null != q.secondaryColor, eo = ee && el;
  o.useEffect(() => {
  ...
  let {
    ...
    children: ec,
    "data-text": Y + W
  }, eu = o.useMemo(() => C ? (0, l.jsx)(O.ZP, {
    primaryGuild: r.primaryGuild,
    userId: n.author.id,
    contextGuildId: J,
    className: T.clanTagChiplet
  }) : null, [C, r.primaryGuild, J, n.author.id]), em = null != b ? b : n.author, ep = null != D && null != Z ? (0, l.jsx)(v.Z, {
    targetElementRef: z,
    user: em,
    renderPopout: D,
    shouldShow: Z,
    ...
    avatarUrl: null != r.guildMemberAvatar && null != J ? (0, h.JM)({
      guildId: J,
      userId: em.id,
    ...
    children: [(0, l.jsx)(m.P3F, R(w({}, es), {
      className: a()(es.className, I)
    })), eu]
  }), ed = null != F ? F[0] : null, ef = null != F ? F[1] : null;
  return (0, l.jsxs)(f.Gt, {
    value: X,
    children: [null != ed && C ? (0, l.jsxs)(l.Fragment, {
      children: [" ", ed, " "]
    }) : null, "dot" === Q ? (0, l.jsx)(m.FhE, {
      color: $,
      colors: el ? q : null,
      name: K,
      className: T.roleDot
    }) : null, ep, !C && (0, l.jsx)(O.ZP, {
      primaryGuild: r.primaryGuild,
      userId: n.author.id,
      contextGuildId: J,
      className: T.clanTagChiplet
    }), null != ef ? ef : null, null == ed || C ? null : ed, null != n && (0, P.f)(n) && et && L ? (0, l.jsx)(A, {}) : null]
  })
}