...
var b = function(e) {
    ...
    for (var u of i) {
      ...
      if (!d) break;
      var f = U(u, d);
      if ([a, o] = n ? [o, f] : [f, a], G(a, r.ZWJ) && G(o, r.ExtPict) && !(l = n ? V(e.substring(0, s)) : V(e.substring(0, e.length - s))) || G(a, r.RI) && G(o, r.RI) && !(c = null !== c ? !c : !!n || Y(e.substring(0, e.length - s))) || a !== r.None && o !== r.None && F(a, o)) break;
      s += u.length
    }
    return s || 1
  },
        ...
        if (ei.parent(e, j).children.splice(M, 1), t)
          for (var [k, U] of eg.points(t)) {
            ...
            if (null != t && null != G) t[U] = G;
              ...
              var Z = true,
                F = true;
              for (var [B, V] of ei.texts(e))
                if (false === el.compare(V, j)) Z = [B, V];
                else {
                  F = [B, V];
                  break
                } var H = false;
              Z && F && (H = el.equals(F[1], j) ? !el.hasPrevious(F[1]) : el.common(Z[1], j).length < el.common(F[1], j).length), Z && !H ? (k.path = Z[1], k.offset = Z[0].text.length) : F ? (k.path = F[1], k.offset = 0) : t = null
            }
          }
        break;
      case "remove_text":
...
var eY = eH(eH(eH(eH({}, eR), ej), eF), eB)