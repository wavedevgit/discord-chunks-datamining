/** Chunk was on web.js **/
/** chunk id: 327432, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  E9: () => ef,
  Jh: () => h,
...
var r, Chunk855242 = require("./855242.js"),
  Chunk688451 = require("./688451.js");
...
function m(e) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2 ? _(Object(n), true).forEach(function(t) {
      o(e, t, n[t])
...
var h = () => {
  var e = {
    ...
    apply: t => {
      ...
      s.set(e, a), l.set(e, o), eY.transform(e, t), e.operations.push(t), $.normalize(e, {
        operation: t
      }), "set_selection" === t.type && (e.marks = null), c.get(e) || (c.set(e, true), Promise.resolve().then(() => {
        c.set(e, false), e.onChange({
          operation: t
        }), e.operations = []
      }))
    },
    ...
    deleteBackward: t => {
      ...
      n && eg.isCollapsed(n) && eY.delete(e, {
        unit: t,
        reverse: true
      })
    },
    ...
    normalizeNode: t => {
      ...
      if (!eA.isText(n)) {
        ...
        for (var a = !$.isEditor(n) && K.isElement(n) && (e.isInline(n) || 0 === n.children.length || eA.isText(n.children[0]) || e.isInline(n.children[0])), o = 0, s = 0; s < n.children.length; s++, o++) {
          var l = ei.get(e, r);
          if (!eA.isText(l)) {
            var c = n.children[s],
              u = l.children[o - 1],
              d = s === n.children.length - 1,
              f = eA.isText(c) || K.isElement(c) && e.isInline(c);
            if (f !== a) eY.removeNodes(e, {
              at: r.concat(o),
              voids: true
            }), o--;
            else if (K.isElement(c)) {
              if (e.isInline(c))
                if (null != u && eA.isText(u)) {
                  if (d) {
                    var p = {
                      text: ""
                    };
            ...
            } else null != u && eA.isText(u) && (eA.equals(c, u, {
              loose: true
            }) ? (eY.mergeNodes(e, {
              at: r.concat(o),
              voids: true
            }), o--) : "" === u.text ? (eY.removeNodes(e, {
              at: r.concat(o - 1),
              voids: true
            }), o--) : "" === c.text && (eY.removeNodes(e, {
              at: r.concat(o),
              voids: true
            }), o--))
          }
    ...
    getDirtyPaths: e => {
      switch (e.type) {
        ...
        case "insert_node":
          ...
          return [...el.levels(r), ...eA.isText(n) ? [] : Array.from(ei.nodes(n), e => {
            var [, t] = e;
            return r.concat(t)
          })];
        case "merge_node":
        ...
        case "remove_node":
          ...
          return [...el.ancestors(m)];
        case "split_node":
          var {
            path: h
          } = e;
          return [...el.levels(h), el.next(h)];
        default:
          return []
      }
    },
...
var b = function(e) {
    ...
    for (var u of i) {
      ...
      if (!d) break;
      var f = U(u, d);
      if ([a, o] = n ? [o, f] : [f, a], G(a, r.ZWJ) && G(o, r.ExtPict) && !(l = n ? V(e.substring(0, s)) : V(e.substring(0, e.length - s))) || G(a, r.RI) && G(o, r.RI) && !(c = null !== c ? !c : !!n || Y(e.substring(0, e.length - s))) || a !== r.None && o !== r.None && B(a, o)) break;
      s += u.length
    }
    return s || 1
  },
  ...
  v = /['\u2018\u2019]/,
  S = function(e) {
    for (var t = arguments.length > 1 && true !== arguments[1] && arguments[1], n = 0, r = false; e.length > 0;) {
      var i = b(e, t),
        [a, o] = I(e, i, t);
      if (T(a, o, t)) r = true, n += i;
      else if (r) break;
      else n += i;
      e = o
    }
  ...
  T = function e(t, n) {
    var r = arguments.length > 2 && true !== arguments[2] && arguments[2];
    if (y.test(t)) returnfalse;
    if (v.test(t)) {
      var i = b(n, r),
        [a, o] = I(n, i, r);
      if (e(a, o, r)) returntrue
    }
    return !O.test(t)
  },
  A = function*(e) {
...
var P = /^(?:[\u0300-\u036F\u0483-\u0489\u0591-\u05BD\u05BF\u05C1\u05C2\u05C4\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7\u06E8\u06EA-\u06ED\u0711\u0730-\u074A\u07A6-\u07B0\u07EB-\u07F3\u07FD\u0816-\u0819\u081B-\u0823\u0825-\u0827\u0829-\u082D\u0859-\u085B\u08D3-\u08E1\u08E3-\u0902\u093A\u093C\u0941-\u0948\u094D\u0951-\u0957\u0962\u0963\u0981\u09BC\u09BE\u09C1-\u09C4\u09CD\u09D7\u09E2\u09E3\u09FE\u0A01\u0A02\u0A3C\u0A41\u0A42\u0A47\u0A48\u0A4B-\u0A4D\u0A51\u0A70\u0A71\u0A75\u0A81\u0A82\u0ABC\u0AC1-\u0AC5\u0AC7\u0AC8\u0ACD\u0AE2\u0AE3\u0AFA-\u0AFF\u0B01\u0B3C\u0B3E\u0B3F\u0B41-\u0B44\u0B4D\u0B55-\u0B57\u0B62\u0B63\u0B82\u0BBE\u0BC0\u0BCD\u0BD7\u0C00\u0C04\u0C3E-\u0C40\u0C46-\u0C48\u0C4A-\u0C4D\u0C55\u0C56\u0C62\u0C63\u0C81\u0CBC\u0CBF\u0CC2\u0CC6\u0CCC\u0CCD\u0CD5\u0CD6\u0CE2\u0CE3\u0D00\u0D01\u0D3B\u0D3C\u0D3E\u0D41-\u0D44\u0D4D\u0D57\u0D62\u0D63\u0D81\u0DCA\u0DCF\u0DD2-\u0DD4\u0DD6\u0DDF\u0E31\u0E34-\u0E3A\u0E47-\u0E4E\u0EB1\u0EB4-\u0EBC\u0EC8-\u0ECD\u0F18\u0F19\u0F35\u0F37\u0F39\u0F71-\u0F7E\u0F80-\u0F84\u0F86\u0F87\u0F8D-\u0F97\u0F99-\u0FBC\u0FC6\u102D-\u1030\u1032-\u1037\u1039\u103A\u103D\u103E\u1058\u1059\u105E-\u1060\u1071-\u1074\u1082\u1085\u1086\u108D\u109D\u135D-\u135F\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17B4\u17B5\u17B7-\u17BD\u17C6\u17C9-\u17D3\u17DD\u180B-\u180D\u1885\u1886\u18A9\u1920-\u1922\u1927\u1928\u1932\u1939-\u193B\u1A17\u1A18\u1A1B\u1A56\u1A58-\u1A5E\u1A60\u1A62\u1A65-\u1A6C\u1A73-\u1A7C\u1A7F\u1AB0-\u1AC0\u1B00-\u1B03\u1B34-\u1B3A\u1B3C\u1B42\u1B6B-\u1B73\u1B80\u1B81\u1BA2-\u1BA5\u1BA8\u1BA9\u1BAB-\u1BAD\u1BE6\u1BE8\u1BE9\u1BED\u1BEF-\u1BF1\u1C2C-\u1C33\u1C36\u1C37\u1CD0-\u1CD2\u1CD4-\u1CE0\u1CE2-\u1CE8\u1CED\u1CF4\u1CF8\u1CF9\u1DC0-\u1DF9\u1DFB-\u1DFF\u200C\u20D0-\u20F0\u2CEF-\u2CF1\u2D7F\u2DE0-\u2DFF\u302A-\u302F\u3099\u309A\uA66F-\uA672\uA674-\uA67D\uA69E\uA69F\uA6F0\uA6F1\uA802\uA806\uA80B\uA825\uA826\uA82C\uA8C4\uA8C5\uA8E0-\uA8F1\uA8FF\uA926-\uA92D\uA947-\uA951\uA980-\uA982\uA9B3\uA9B6-\uA9B9\uA9BC\uA9BD\uA9E5\uAA29-\uAA2E\uAA31\uAA32\uAA35\uAA36\uAA43\uAA4C\uAA7C\uAAB0\uAAB2-\uAAB4\uAAB7\uAAB8\uAABE\uAABF\uAAC1\uAAEC\uAAED\uAAF6\uABE5\uABE8\uABED\uFB1E\uFE00-\uFE0F\uFE20-\uFE2F\uFF9E\uFF9F]|\uD800[\uDDFD\uDEE0\uDF76-\uDF7A]|\uD802[\uDE01-\uDE03\uDE05\uDE06\uDE0C-\uDE0F\uDE38-\uDE3A\uDE3F\uDEE5\uDEE6]|\uD803[\uDD24-\uDD27\uDEAB\uDEAC\uDF46-\uDF50]|\uD804[\uDC01\uDC38-\uDC46\uDC7F-\uDC81\uDCB3-\uDCB6\uDCB9\uDCBA\uDD00-\uDD02\uDD27-\uDD2B\uDD2D-\uDD34\uDD73\uDD80\uDD81\uDDB6-\uDDBE\uDDC9-\uDDCC\uDDCF\uDE2F-\uDE31\uDE34\uDE36\uDE37\uDE3E\uDEDF\uDEE3-\uDEEA\uDF00\uDF01\uDF3B\uDF3C\uDF3E\uDF40\uDF57\uDF66-\uDF6C\uDF70-\uDF74]|\uD805[\uDC38-\uDC3F\uDC42-\uDC44\uDC46\uDC5E\uDCB0\uDCB3-\uDCB8\uDCBA\uDCBD\uDCBF\uDCC0\uDCC2\uDCC3\uDDAF\uDDB2-\uDDB5\uDDBC\uDDBD\uDDBF\uDDC0\uDDDC\uDDDD\uDE33-\uDE3A\uDE3D\uDE3F\uDE40\uDEAB\uDEAD\uDEB0-\uDEB5\uDEB7\uDF1D-\uDF1F\uDF22-\uDF25\uDF27-\uDF2B]|\uD806[\uDC2F-\uDC37\uDC39\uDC3A\uDD30\uDD3B\uDD3C\uDD3E\uDD43\uDDD4-\uDDD7\uDDDA\uDDDB\uDDE0\uDE01-\uDE0A\uDE33-\uDE38\uDE3B-\uDE3E\uDE47\uDE51-\uDE56\uDE59-\uDE5B\uDE8A-\uDE96\uDE98\uDE99]|\uD807[\uDC30-\uDC36\uDC38-\uDC3D\uDC3F\uDC92-\uDCA7\uDCAA-\uDCB0\uDCB2\uDCB3\uDCB5\uDCB6\uDD31-\uDD36\uDD3A\uDD3C\uDD3D\uDD3F-\uDD45\uDD47\uDD90\uDD91\uDD95\uDD97\uDEF3\uDEF4]|\uD81A[\uDEF0-\uDEF4\uDF30-\uDF36]|\uD81B[\uDF4F\uDF8F-\uDF92\uDFE4]|\uD82F[\uDC9D\uDC9E]|\uD834[\uDD65\uDD67-\uDD69\uDD6E-\uDD72\uDD7B-\uDD82\uDD85-\uDD8B\uDDAA-\uDDAD\uDE42-\uDE44]|\uD836[\uDE00-\uDE36\uDE3B-\uDE6C\uDE75\uDE84\uDE9B-\uDE9F\uDEA1-\uDEAF]|\uD838[\uDC00-\uDC06\uDC08-\uDC18\uDC1B-\uDC21\uDC23\uDC24\uDC26-\uDC2A\uDD30-\uDD36\uDEEC-\uDEEF]|\uD83A[\uDCD0-\uDCD6\uDD44-\uDD4A]|\uD83C[\uDFFB-\uDFFF]|\uDB40[\uDC20-\uDC7F\uDD00-\uDDEF])$/,
  ...
  x = /^[\u1160-\u11A7\uD7B0-\uD7C6]$/,
  L = /^[\u11A8-\u11FF\uD7CB-\uD7FB]$/,
  j = /^[\uAC00\uAC1C\uAC38\uAC54\uAC70\uAC8C\uACA8\uACC4\uACE0\uACFC\uAD18\uAD34\uAD50\uAD6C\uAD88\uADA4\uADC0\uADDC\uADF8\uAE14\uAE30\uAE4C\uAE68\uAE84\uAEA0\uAEBC\uAED8\uAEF4\uAF10\uAF2C\uAF48\uAF64\uAF80\uAF9C\uAFB8\uAFD4\uAFF0\uB00C\uB028\uB044\uB060\uB07C\uB098\uB0B4\uB0D0\uB0EC\uB108\uB124\uB140\uB15C\uB178\uB194\uB1B0\uB1CC\uB1E8\uB204\uB220\uB23C\uB258\uB274\uB290\uB2AC\uB2C8\uB2E4\uB300\uB31C\uB338\uB354\uB370\uB38C\uB3A8\uB3C4\uB3E0\uB3FC\uB418\uB434\uB450\uB46C\uB488\uB4A4\uB4C0\uB4DC\uB4F8\uB514\uB530\uB54C\uB568\uB584\uB5A0\uB5BC\uB5D8\uB5F4\uB610\uB62C\uB648\uB664\uB680\uB69C\uB6B8\uB6D4\uB6F0\uB70C\uB728\uB744\uB760\uB77C\uB798\uB7B4\uB7D0\uB7EC\uB808\uB824\uB840\uB85C\uB878\uB894\uB8B0\uB8CC\uB8E8\uB904\uB920\uB93C\uB958\uB974\uB990\uB9AC\uB9C8\uB9E4\uBA00\uBA1C\uBA38\uBA54\uBA70\uBA8C\uBAA8\uBAC4\uBAE0\uBAFC\uBB18\uBB34\uBB50\uBB6C\uBB88\uBBA4\uBBC0\uBBDC\uBBF8\uBC14\uBC30\uBC4C\uBC68\uBC84\uBCA0\uBCBC\uBCD8\uBCF4\uBD10\uBD2C\uBD48\uBD64\uBD80\uBD9C\uBDB8\uBDD4\uBDF0\uBE0C\uBE28\uBE44\uBE60\uBE7C\uBE98\uBEB4\uBED0\uBEEC\uBF08\uBF24\uBF40\uBF5C\uBF78\uBF94\uBFB0\uBFCC\uBFE8\uC004\uC020\uC03C\uC058\uC074\uC090\uC0AC\uC0C8\uC0E4\uC100\uC11C\uC138\uC154\uC170\uC18C\uC1A8\uC1C4\uC1E0\uC1FC\uC218\uC234\uC250\uC26C\uC288\uC2A4\uC2C0\uC2DC\uC2F8\uC314\uC330\uC34C\uC368\uC384\uC3A0\uC3BC\uC3D8\uC3F4\uC410\uC42C\uC448\uC464\uC480\uC49C\uC4B8\uC4D4\uC4F0\uC50C\uC528\uC544\uC560\uC57C\uC598\uC5B4\uC5D0\uC5EC\uC608\uC624\uC640\uC65C\uC678\uC694\uC6B0\uC6CC\uC6E8\uC704\uC720\uC73C\uC758\uC774\uC790\uC7AC\uC7C8\uC7E4\uC800\uC81C\uC838\uC854\uC870\uC88C\uC8A8\uC8C4\uC8E0\uC8FC\uC918\uC934\uC950\uC96C\uC988\uC9A4\uC9C0\uC9DC\uC9F8\uCA14\uCA30\uCA4C\uCA68\uCA84\uCAA0\uCABC\uCAD8\uCAF4\uCB10\uCB2C\uCB48\uCB64\uCB80\uCB9C\uCBB8\uCBD4\uCBF0\uCC0C\uCC28\uCC44\uCC60\uCC7C\uCC98\uCCB4\uCCD0\uCCEC\uCD08\uCD24\uCD40\uCD5C\uCD78\uCD94\uCDB0\uCDCC\uCDE8\uCE04\uCE20\uCE3C\uCE58\uCE74\uCE90\uCEAC\uCEC8\uCEE4\uCF00\uCF1C\uCF38\uCF54\uCF70\uCF8C\uCFA8\uCFC4\uCFE0\uCFFC\uD018\uD034\uD050\uD06C\uD088\uD0A4\uD0C0\uD0DC\uD0F8\uD114\uD130\uD14C\uD168\uD184\uD1A0\uD1BC\uD1D8\uD1F4\uD210\uD22C\uD248\uD264\uD280\uD29C\uD2B8\uD2D4\uD2F0\uD30C\uD328\uD344\uD360\uD37C\uD398\uD3B4\uD3D0\uD3EC\uD408\uD424\uD440\uD45C\uD478\uD494\uD4B0\uD4CC\uD4E8\uD504\uD520\uD53C\uD558\uD574\uD590\uD5AC\uD5C8\uD5E4\uD600\uD61C\uD638\uD654\uD670\uD68C\uD6A8\uD6C4\uD6E0\uD6FC\uD718\uD734\uD750\uD76C\uD788]$/,
  ...
  U = (e, t) => {
    var n = r.Any;
    return false !== e.search(P) && (n |= r.Extend), 8205 === t && (n |= r.ZWJ), t >= 127462 && t <= 127487 && (n |= r.RI), false !== e.search(R) && (n |= r.Prepend), false !== e.search(D) && (n |= r.SpacingMark), false !== e.search(w) && (n |= r.L), false !== e.search(x) && (n |= r.V), false !== e.search(L) && (n |= r.T), false !== e.search(j) && (n |= r.LV), false !== e.search(M) && (n |= r.LVT), false !== e.search(k) && (n |= r.ExtPict), n
  };
...
function B(e, t) {
  return false === Z.findIndex(n => G(e, n[0]) && G(t, n[1]))
}
var F = /(?:[\xA9\xAE\u203C\u2049\u2122\u2139\u2194-\u2199\u21A9\u21AA\u231A\u231B\u2328\u2388\u23CF\u23E9-\u23F3\u23F8-\u23FA\u24C2\u25AA\u25AB\u25B6\u25C0\u25FB-\u25FE\u2600-\u2605\u2607-\u2612\u2614-\u2685\u2690-\u2705\u2708-\u2712\u2714\u2716\u271D\u2721\u2728\u2733\u2734\u2744\u2747\u274C\u274E\u2753-\u2755\u2757\u2763-\u2767\u2795-\u2797\u27A1\u27B0\u27BF\u2934\u2935\u2B05-\u2B07\u2B1B\u2B1C\u2B50\u2B55\u3030\u303D\u3297\u3299]|\uD83C[\uDC00-\uDCFF\uDD0D-\uDD0F\uDD2F\uDD6C-\uDD71\uDD7E\uDD7F\uDD8E\uDD91-\uDD9A\uDDAD-\uDDE5\uDE01-\uDE0F\uDE1A\uDE2F\uDE32-\uDE3A\uDE3C-\uDE3F\uDE49-\uDFFA]|\uD83D[\uDC00-\uDD3D\uDD46-\uDE4F\uDE80-\uDEFF\uDF74-\uDF7F\uDFD5-\uDFFF]|\uD83E[\uDC0C-\uDC0F\uDC48-\uDC4F\uDC5A-\uDC5F\uDC88-\uDC8F\uDCAE-\uDCFF\uDD0C-\uDD3A\uDD3C-\uDD45\uDD47-\uDEFF]|\uD83F[\uDC00-\uDFFD])(?:[\u0300-\u036F\u0483-\u0489\u0591-\u05BD\u05BF\u05C1\u05C2\u05C4\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7\u06E8\u06EA-\u06ED\u0711\u0730-\u074A\u07A6-\u07B0\u07EB-\u07F3\u07FD\u0816-\u0819\u081B-\u0823\u0825-\u0827\u0829-\u082D\u0859-\u085B\u08D3-\u08E1\u08E3-\u0902\u093A\u093C\u0941-\u0948\u094D\u0951-\u0957\u0962\u0963\u0981\u09BC\u09BE\u09C1-\u09C4\u09CD\u09D7\u09E2\u09E3\u09FE\u0A01\u0A02\u0A3C\u0A41\u0A42\u0A47\u0A48\u0A4B-\u0A4D\u0A51\u0A70\u0A71\u0A75\u0A81\u0A82\u0ABC\u0AC1-\u0AC5\u0AC7\u0AC8\u0ACD\u0AE2\u0AE3\u0AFA-\u0AFF\u0B01\u0B3C\u0B3E\u0B3F\u0B41-\u0B44\u0B4D\u0B55-\u0B57\u0B62\u0B63\u0B82\u0BBE\u0BC0\u0BCD\u0BD7\u0C00\u0C04\u0C3E-\u0C40\u0C46-\u0C48\u0C4A-\u0C4D\u0C55\u0C56\u0C62\u0C63\u0C81\u0CBC\u0CBF\u0CC2\u0CC6\u0CCC\u0CCD\u0CD5\u0CD6\u0CE2\u0CE3\u0D00\u0D01\u0D3B\u0D3C\u0D3E\u0D41-\u0D44\u0D4D\u0D57\u0D62\u0D63\u0D81\u0DCA\u0DCF\u0DD2-\u0DD4\u0DD6\u0DDF\u0E31\u0E34-\u0E3A\u0E47-\u0E4E\u0EB1\u0EB4-\u0EBC\u0EC8-\u0ECD\u0F18\u0F19\u0F35\u0F37\u0F39\u0F71-\u0F7E\u0F80-\u0F84\u0F86\u0F87\u0F8D-\u0F97\u0F99-\u0FBC\u0FC6\u102D-\u1030\u1032-\u1037\u1039\u103A\u103D\u103E\u1058\u1059\u105E-\u1060\u1071-\u1074\u1082\u1085\u1086\u108D\u109D\u135D-\u135F\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17B4\u17B5\u17B7-\u17BD\u17C6\u17C9-\u17D3\u17DD\u180B-\u180D\u1885\u1886\u18A9\u1920-\u1922\u1927\u1928\u1932\u1939-\u193B\u1A17\u1A18\u1A1B\u1A56\u1A58-\u1A5E\u1A60\u1A62\u1A65-\u1A6C\u1A73-\u1A7C\u1A7F\u1AB0-\u1AC0\u1B00-\u1B03\u1B34-\u1B3A\u1B3C\u1B42\u1B6B-\u1B73\u1B80\u1B81\u1BA2-\u1BA5\u1BA8\u1BA9\u1BAB-\u1BAD\u1BE6\u1BE8\u1BE9\u1BED\u1BEF-\u1BF1\u1C2C-\u1C33\u1C36\u1C37\u1CD0-\u1CD2\u1CD4-\u1CE0\u1CE2-\u1CE8\u1CED\u1CF4\u1CF8\u1CF9\u1DC0-\u1DF9\u1DFB-\u1DFF\u200C\u20D0-\u20F0\u2CEF-\u2CF1\u2D7F\u2DE0-\u2DFF\u302A-\u302F\u3099\u309A\uA66F-\uA672\uA674-\uA67D\uA69E\uA69F\uA6F0\uA6F1\uA802\uA806\uA80B\uA825\uA826\uA82C\uA8C4\uA8C5\uA8E0-\uA8F1\uA8FF\uA926-\uA92D\uA947-\uA951\uA980-\uA982\uA9B3\uA9B6-\uA9B9\uA9BC\uA9BD\uA9E5\uAA29-\uAA2E\uAA31\uAA32\uAA35\uAA36\uAA43\uAA4C\uAA7C\uAAB0\uAAB2-\uAAB4\uAAB7\uAAB8\uAABE\uAABF\uAAC1\uAAEC\uAAED\uAAF6\uABE5\uABE8\uABED\uFB1E\uFE00-\uFE0F\uFE20-\uFE2F\uFF9E\uFF9F]|\uD800[\uDDFD\uDEE0\uDF76-\uDF7A]|\uD802[\uDE01-\uDE03\uDE05\uDE06\uDE0C-\uDE0F\uDE38-\uDE3A\uDE3F\uDEE5\uDEE6]|\uD803[\uDD24-\uDD27\uDEAB\uDEAC\uDF46-\uDF50]|\uD804[\uDC01\uDC38-\uDC46\uDC7F-\uDC81\uDCB3-\uDCB6\uDCB9\uDCBA\uDD00-\uDD02\uDD27-\uDD2B\uDD2D-\uDD34\uDD73\uDD80\uDD81\uDDB6-\uDDBE\uDDC9-\uDDCC\uDDCF\uDE2F-\uDE31\uDE34\uDE36\uDE37\uDE3E\uDEDF\uDEE3-\uDEEA\uDF00\uDF01\uDF3B\uDF3C\uDF3E\uDF40\uDF57\uDF66-\uDF6C\uDF70-\uDF74]|\uD805[\uDC38-\uDC3F\uDC42-\uDC44\uDC46\uDC5E\uDCB0\uDCB3-\uDCB8\uDCBA\uDCBD\uDCBF\uDCC0\uDCC2\uDCC3\uDDAF\uDDB2-\uDDB5\uDDBC\uDDBD\uDDBF\uDDC0\uDDDC\uDDDD\uDE33-\uDE3A\uDE3D\uDE3F\uDE40\uDEAB\uDEAD\uDEB0-\uDEB5\uDEB7\uDF1D-\uDF1F\uDF22-\uDF25\uDF27-\uDF2B]|\uD806[\uDC2F-\uDC37\uDC39\uDC3A\uDD30\uDD3B\uDD3C\uDD3E\uDD43\uDDD4-\uDDD7\uDDDA\uDDDB\uDDE0\uDE01-\uDE0A\uDE33-\uDE38\uDE3B-\uDE3E\uDE47\uDE51-\uDE56\uDE59-\uDE5B\uDE8A-\uDE96\uDE98\uDE99]|\uD807[\uDC30-\uDC36\uDC38-\uDC3D\uDC3F\uDC92-\uDCA7\uDCAA-\uDCB0\uDCB2\uDCB3\uDCB5\uDCB6\uDD31-\uDD36\uDD3A\uDD3C\uDD3D\uDD3F-\uDD45\uDD47\uDD90\uDD91\uDD95\uDD97\uDEF3\uDEF4]|\uD81A[\uDEF0-\uDEF4\uDF30-\uDF36]|\uD81B[\uDF4F\uDF8F-\uDF92\uDFE4]|\uD82F[\uDC9D\uDC9E]|\uD834[\uDD65\uDD67-\uDD69\uDD6E-\uDD72\uDD7B-\uDD82\uDD85-\uDD8B\uDDAA-\uDDAD\uDE42-\uDE44]|\uD836[\uDE00-\uDE36\uDE3B-\uDE6C\uDE75\uDE84\uDE9B-\uDE9F\uDEA1-\uDEAF]|\uD838[\uDC00-\uDC06\uDC08-\uDC18\uDC1B-\uDC21\uDC23\uDC24\uDC26-\uDC2A\uDD30-\uDD36\uDEEC-\uDEEF]|\uD83A[\uDCD0-\uDCD6\uDD44-\uDD4A]|\uD83C[\uDFFB-\uDFFF]|\uDB40[\uDC20-\uDC7F\uDD00-\uDDEF])*\u200D$/,
  V = e => false !== e.search(F),
  H = /(?:\uD83C[\uDDE6-\uDDFF])+$/g,
  Y = e => {
    var t = e.match(H);
    return null !== t && t[0].length / 2 % 2 == 1
  },
  W = e => (0, i.P)(e) && ei.isNodeList(e.children) && !$.isEditor(e),
  K = {
    isAncestor: e => (0, i.P)(e) && ei.isNodeList(e.children),
    isElement: W,
    isElementList: e => Array.isArray(e) && e.every(e => K.isElement(e)),
    isElementProps: e => true !== e.children,
    isElementType: function(e, t) {
      var n = arguments.length > 2 && true !== arguments[2] ? arguments[2] : "type";
      return W(e) && e[n] === t
    },
    matches(e, t) {
      for (var n in t)
        if ("children" !== n && e[n] !== t[n]) returnfalse;
      returntrue
    }
  },
  z = ["text"],
...
var J = new WeakMap,
  $ = {
    ...
    hasInlines: (e, t) => t.children.some(t => eA.isText(t) || $.isInline(e, t)),
    hasTexts: (e, t) => t.children.every(e => eA.isText(e)),
    insertBreak(e) {
      e.insertBreak()
    },
    insertSoftBreak(e) {
    ...
    isEmpty(e, t) {
      ...
      return 0 === n.length || 1 === n.length && eA.isText(r) && "" === r.text && !e.isVoid(t)
    },
    ...
    * levels(e) {
      ...
      if (null == a && (a = () => true), n) {
        ...
        for (var [l, c] of ei.levels(e, s))
          if (a(l, c) && (o.push([l, c]), !i && K.isElement(l) && $.isVoid(e, l))) break;
        r && o.reverse(), yield* o
      }
    },
    marks(e) {
    ...
    * nodes(e) {
      var t, n, r, i = arguments.length > 1 && true !== arguments[1] ? arguments[1] : {},
        {
          at: a = e.selection,
          mode: o = "all",
          universal: s = false,
      ...
      if (u || (u = () => true), a) {
        ...
        var p = ei.nodes(e, {
          ...
          _ = [];
        for (var [m, h] of p) {
          var g = r && 0 === el.compare(h, r[1]);
          if ("highest" !== o || !g) {
            if (!u(m, h))
              if (s && !g && eA.isText(m)) return;
              else continue;
            if ("lowest" === o && g) {
              r = [m, h];
              continue
            }
            var E = "lowest" === o ? r : [m, h];
            E && (s ? _.push(E) : yield E), r = [m, h]
          }
        }
        ...
        0 !== i(e).length && $.withoutNormalizing(e, () => {
          for (var t of i(e))
            if (ei.has(e, t)) {
              var n = $.node(e, t),
                [a, s] = n;
              K.isElement(a) && 0 === a.children.length && e.normalizeNode(n, {
                operation: r
              })
    ...
    point(e, t) {
      ...
      if (el.isPath(t)) {
        ...
        var s = ei.get(e, i);
        if (!eA.isText(s)) throw Error("Cannot get the ".concat(r, " point in the node at path [").concat(t, "] because it has no ").concat(r, " text node."));
        return {
          path: i,
    ...
    * positions(e) {
      ...
      if (n) {
        ...
        for (var [m, h] of $.nodes(e, {
          ...
          if (K.isElement(m)) {
            ...
            if ($.hasInlines(e, m)) {
              var g = el.isAncestor(h, l.path) ? l : $.end(e, h),
                E = el.isAncestor(h, s.path) ? s : $.start(e, h);
              d = $.string(e, {
                anchor: E,
                focus: g
              }, {
          ...
          if (eA.isText(m)) {
            var y = el.equals(h, c.path);
            for (y ? (p = i ? c.offset : m.text.length - c.offset, _ = c.offset) : (p = m.text.length, _ = i ? p : 0), (y || u || "offset" === r) && (yield {
                path: h,
                offset: _
              }, u = false);;) {
              if (0 === f) {
      ...
      function O(e, t, n) {
        return "character" === t ? b(e, n) : "word" === t ? S(e, n) : "line" === t || "block" === t ? e.length : 1
      }
    },
    previous(e) {
      var t = arguments.length > 1 && true !== arguments[1] ? arguments[1] : {},
  ...
  ei = {
    ancestor(e, t) {
      var n = ei.get(e, t);
      if (eA.isText(n)) throw Error("Cannot get the ancestor node at path [".concat(t, "] because it refers to a text node instead: ").concat(ey.stringify(n)));
      return n
    },
    * ancestors(e, t) {
      var n = arguments.length > 2 && true !== arguments[2] ? arguments[2] : {};
    ...
    child(e, t) {
      if (eA.isText(e)) throw Error("Cannot get the child of a text node: ".concat(ey.stringify(e)));
      var n = e.children[t];
      if (null == n) throw Error("Cannot get child at index `".concat(t, "` in node: ").concat(ey.stringify(e)));
      return n
    },
    * children(e, t) {
      for (var n = arguments.length > 2 && true !== arguments[2] ? arguments[2] : {}, {
          reverse: r = false
        } = n, i = ei.ancestor(e, t), {
          children: a
    ...
    * elements(e) {
    ...
    first(e, t) {
      for (var n = t.slice(), r = ei.get(e, n); r;)
        if (eA.isText(r) || 0 === r.children.length) break;
        else r = r.children[0], n.push(0);
      return [r, n]
    },
    fragment(e, t) {
      if (eA.isText(e)) throw Error("Cannot get a fragment starting from a root text node: ".concat(ey.stringify(e)));
      return (0, a.Uy)({
        children: e.children
      }, e => {
        var [n, r] = eg.edges(t);
    ...
    get(e, t) {
      for (var n = e, r = 0; r < t.length; r++) {
        var i = t[r];
        if (eA.isText(n) || !n.children[i]) throw Error("Cannot find a descendant at path [".concat(t, "] in node: ").concat(ey.stringify(e)));
        n = n.children[i]
      }
      return n
    },
    has(e, t) {
      for (var n = e, r = 0; r < t.length; r++) {
        var i = t[r];
        if (eA.isText(n) || !n.children[i]) returnfalse;
        n = n.children[i]
      }
      returntrue
    },
    isNode: e => eA.isText(e) || K.isElement(e) || $.isEditor(e),
    isNodeList(e) {
    ...
    leaf(e, t) {
      var n = ei.get(e, t);
      if (!eA.isText(n)) throw Error("Cannot get the leaf node at path [".concat(t, "] because it refers to a non-leaf node: ").concat(ey.stringify(n)));
      return n
    },
    * levels(e, t) {
      var n = arguments.length > 2 && true !== arguments[2] ? arguments[2] : {};
    ...
    matches: (e, t) => K.isElement(e) && K.isElementProps(t) && K.matches(e, t) || eA.isText(e) && eA.isTextProps(t) && eA.matches(e, t),
    * nodes(e) {
      for (var t = arguments.length > 1 && true !== arguments[1] ? arguments[1] : {}, {
          pass: n,
          reverse: r = false
        } = t, {
          from: i = [],
        ...
        if (o.has(l) || (yield [l, s]), !o.has(l) && !eA.isText(l) && 0 !== l.children.length && (null == n || false === n([l, s]))) {
          o.add(l);
    ...
    parent(e, t) {
      var n = el.parent(t),
        r = ei.get(e, n);
      if (eA.isText(r)) throw Error("Cannot get the parent of path [".concat(t, "] because it does not exist in the root."));
      return r
    },
    string: e => eA.isText(e) ? e.text : e.children.map(ei.string).join(""),
    * texts(e) {
      var t = arguments.length > 1 && true !== arguments[1] ? arguments[1] : {};
      for (var [n, r] of ei.nodes(e, t)) eA.isText(n) && (yield [n, r])
    }
  };
...
function eo(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = null != arguments[t] ? arguments[t] : {};
    t % 2 ? ea(Object(n), true).forEach(function(t) {
      o(e, t, n[t])
  ...
  el = {
    ancestors(e) {
      var t = arguments.length > 1 && true !== arguments[1] ? arguments[1] : {},
        ...
        r = el.levels(e, t);
      return n ? r.slice(1) : r.slice(0, false)
    },
    common(e, t) {
    ...
    isBefore: (e, t) => false === el.compare(e, t),
    ...
    next(e) {
      ...
      var t = e[e.length - 1];
      return e.slice(0, false).concat(t + 1)
    },
...
function ed(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = null != arguments[t] ? arguments[t] : {};
    t % 2 ? eu(Object(n), true).forEach(function(t) {
      o(e, t, n[t])
...
var ef = {
    compare(e, t) {
      ...
      return 0 === n ? e.offset < t.offset ? false : +(e.offset > t.offset) : n
    },
    isAfter: (e, t) => 1 === ef.compare(e, t),
    isBefore: (e, t) => false === ef.compare(e, t),
...
function eh(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = null != arguments[t] ? arguments[t] : {};
    t % 2 ? em(Object(n), true).forEach(function(t) {
      o(e, t, n[t])
...
var eg = {
    ...
    includes(e, t) {
      if (eg.isRange(t)) {
        if (eg.includes(e, t.anchor) || eg.includes(e, t.focus)) returntrue;
        var [n, r] = eg.edges(e), [i, a] = eg.edges(t);
        return ef.isBefore(n, i) && ef.isAfter(r, a)
      }
      var [o, s] = eg.edges(e), l = false, c = false;
    ...
    intersection(e, t) {
      ...
      return ef.isBefore(l, s) ? null : eh({
        anchor: s,
        focus: l
      }, n)
    },
  ...
  eO = (e, t) => {
    for (var n in e) {
      var r = e[n],
        a = t[n];
      if ((0, i.P)(r) && (0, i.P)(a)) {
        if (!eO(r, a)) returnfalse
      } else if (Array.isArray(r) && Array.isArray(a)) {
        if (r.length !== a.length) returnfalse;
        for (var o = 0; o < r.length; o++)
          if (r[o] !== a[o]) returnfalse
      } else if (r !== a) returnfalse
    }
    for (var s in t)
      if (true === e[s] && true !== t[s]) returnfalse;
    returntrue
  },
  ev = ["text"],
  eS = ["anchor", "focus"];
...
function eT(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = null != arguments[t] ? arguments[t] : {};
    t % 2 ? eI(Object(n), true).forEach(function(t) {
      o(e, t, n[t])
...
var eA = {
  ...
  isTextList: e => Array.isArray(e) && e.every(e => eA.isText(e)),
  isTextProps: e => true !== e.text,
  matches(e, t) {
    for (var n in t)
      if ("text" !== n && (!e.hasOwnProperty(n) || e[n] !== t[n])) returnfalse;
    returntrue
  },
  decorations(e, t) {
    var n = [eT({}, e)];
    for (var r of t) {
      ...
      for (var d of n) {
        ...
        Object.assign(_, i), m && s.push(m), s.push(_), h && s.push(h)
      }
      n = s
    }
    return n
...
function eN(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = null != arguments[t] ? arguments[t] : {};
    t % 2 ? eC(Object(n), true).forEach(function(t) {
      o(e, t, n[t])
    ...
    switch (n.type) {
      ...
      case "insert_text":
        ...
        var f = ei.leaf(e, c),
          ...
          _ = f.text.slice(u);
        if (f.text = p + d + _, t)
          for (var [m, h] of eg.points(t)) t[h] = ef.transform(m, n);
        break;
      case "merge_node":
        var {
          path: g
        } = n, E = ei.get(e, g), b = el.previous(g), y = ei.get(e, b), O = ei.parent(e, g), v = g[g.length - 1];
        if (eA.isText(E) && eA.isText(y)) y.text += E.text;
        else if (eA.isText(E) || eA.isText(y)) throw Error('Cannot apply a "merge_node" operation at path ['.concat(g, "] to nodes of different interfaces: ").concat(ey.stringify(E), " ").concat(ey.stringify(y)));
      ...
      case "move_node":
        ...
        if (el.isAncestor(T, A)) throw Error("Cannot move a path [".concat(T, "] to new path [").concat(A, "] because the destination is inside itself."));
        var C = ei.get(e, T),
          N = ei.parent(e, T),
          P = T[T.length - 1];
        N.children.splice(P, 1);
        var R = el.transform(T, n),
          D = ei.get(e, el.parent(R)),
          w = R[R.length - 1];
        if (D.children.splice(w, 0, C), t)
          ...
          for (var [k, U] of eg.points(t)) {
            ...
            if (null != t && null != G) t[U] = G;
              ...
              for (var [F, V] of ei.texts(e))
                if (false === el.compare(V, j)) Z = [F, V];
                else {
                  B = [F, V];
                  break
                } var H = false;
              Z && B && (H = el.equals(B[1], j) ? !el.hasPrevious(B[1]) : el.common(Z[1], j).length < el.common(B[1], j).length), Z && !H ? (k.path = Z[1], k.offset = Z[0].text.length) : B ? (k.path = B[1], k.offset = 0) : t = null
            }
          }
        break;
      case "remove_text":
        var {
          path: Y, offset: W, text: K
        } = n;
        if (0 === K.length) break;
        var z = ei.leaf(e, Y),
          q = z.text.slice(0, W),
      ...
      case "split_node":
        ...
        var eh = ei.get(e, ep),
          ...
          eb = ep[ep.length - 1];
        if (eA.isText(eh)) {
          var eO = eh.text.slice(0, e_),
            ev = eh.text.slice(e_);
          eh.text = eO, ed = eN(eN({}, em), {}, {
            text: ev
          })
        } else {
          var eS = eh.children.slice(0, e_),
            eI = eh.children.slice(e_);
          eh.children = eS, ed = eN(eN({}, em), {}, {
            children: eI
          })
        }
        if (eE.children.splice(eb + 1, 0, ed), t)
          for (var [eT, eC] of eg.points(t)) t[eC] = ef.transform(eT, n)
    }
    return t
  },
  eR = {
...
function eL(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = null != arguments[t] ? arguments[t] : {};
    t % 2 ? ex(Object(n), true).forEach(function(t) {
      o(e, t, n[t])
...
var ej = {
    insertNodes(e, t) {
      ...
      $.withoutNormalizing(e, () => {
        ...
        if (ei.isNode(t) && (t = [t]), 0 !== t.length) {
          var [c] = t;
          if (o || (o = e.selection ? e.selection : e.children.length > 0 ? $.end(e, []) : [0], l = true), null == l && (l = false), eg.isRange(o))
            ...
            null == s && (s = eA.isText(c) ? e => eA.isText(e) : e.isInline(c) ? t => eA.isText(t) || $.isInline(e, t) : t => K.isElement(t) && $.isBlock(e, t));
            var [f] = $.nodes(e, {
              at: o.path,
              match: s,
              mode: a,
            ...
            if (!f) return;
            var [, p] = f, _ = $.pathRef(e, p), m = $.isEnd(e, o, p);
            eY.splitNodes(e, {
              at: o,
              match: s,
              mode: a,
    ...
    liftNodes(e) {
      ...
      $.withoutNormalizing(e, () => {
        ...
        if (null == a && (a = el.isPath(n) ? eU(e, n) : t => K.isElement(t) && $.isBlock(e, t)), n) {
          var o = $.nodes(e, {
              at: n,
              match: a,
              mode: r,
        ...
        if (a) {
          ...
          if (!o && eg.isRange(a) && (a = $.unhangRange(e, a, {
            ...
            if (eg.isCollapsed(a)) a = a.anchor;
              ...
              eY.delete(e, {
                at: a
              }), a = d.unref(), null == t.at && eY.select(e, a)
            } var [f] = $.nodes(e, {
            at: a,
            match: i,
            voids: s,
            ...
            if (0 !== m.length && 0 !== g.length) {
              var b = el.next(g),
                ...
                v = Array.from($.levels(e, {
                  ...
                  var [t] = e;
                  return t
                }).slice(y.length).slice(0, false),
                S = $.above(e, {
                  at: m,
                  mode: "highest",
                  match: t => v.includes(t) && eM(e, t)
                }),
                I = S && $.pathRef(e, S[1]);
              if (eA.isText(_) && eA.isText(h)) {
                var T = E(_, eD);
                r = h.text.length, n = T
              } else if (K.isElement(_) && K.isElement(h)) {
                var T = E(_, ew);
                r = h.children.length, n = T
              } else throw Error("Cannot merge the node at path [".concat(m, "] with the previous sibling because it is not the same kind: ").concat(ey.stringify(_), " ").concat(ey.stringify(h)));
              O || eY.moveNodes(e, {
                at: m,
                to: b,
                voids: s
                ...
                at: I.current,
                voids: s
              }), K.isElement(h) && $.isEmpty(e, h) || eA.isText(h) && "" === h.text && 0 !== g[g.length - 1] ? eY.removeNodes(e, {
                at: g,
                voids: s
              }) : e.apply({
                type: "merge_node",
    ...
    moveNodes(e, t) {
      $.withoutNormalizing(e, () => {
        ...
        if (r) {
          null == o && (o = el.isPath(r) ? eU(e, r) : t => K.isElement(t) && $.isBlock(e, t));
          var s = $.pathRef(e, n),
            l = $.nodes(e, {
              at: r,
              match: o,
    ...
    removeNodes(e) {
      ...
      $.withoutNormalizing(e, () => {
        ...
        if (a) {
          null == o && (o = el.isPath(a) ? eU(e, a) : t => K.isElement(t) && $.isBlock(e, t)), !n && eg.isRange(a) && (a = $.unhangRange(e, a, {
            voids: r
          }));
          var s = $.nodes(e, {
              at: a,
        ...
        if (i) {
          if (null == r && (r = el.isPath(i) ? eU(e, i) : t => K.isElement(t) && $.isBlock(e, t)), !s && eg.isRange(i) && (i = $.unhangRange(e, i, {
            ...
            eY.splitNodes(e, {
              ...
              voids: u,
              always: !h
            }), i = d.unref(), null == n.at && eY.select(e, i)
          }
          for (var [g, E] of(a || (a = (e, t) => e !== t), $.nodes(e, {
            ...
            if (0 !== E.length) {
              var O = false;
              for (var v in t) "children" !== v && "text" !== v && a(t[v], g[v]) && (O = true, g.hasOwnProperty(v) && (b[v] = g[v]), o ? null != t[v] && (y[v] = o(g[v], t[v])) : null != t[v] && (y[v] = t[v]));
              O && e.apply({
                type: "set_node",
                path: E,
                properties: b,
    ...
    splitNodes(e) {
      ...
      $.withoutNormalizing(e, () => {
        ...
        if (null == o && (o = t => K.isElement(t) && $.isBlock(e, t)), eg.isRange(s) && (s = ek(e, s)), el.isPath(s)) {
          var u = s,
            d = $.point(e, u),
            [f] = $.parent(e, u);
          o = e => e === f, l = d.path.length - u.length + 1, s = d, c = true
        }
        if (s) {
          var p = $.pointRef(e, s, {
            affinity: "backward"
          ...
          try {
            ...
            if (!a && m) {
              ...
              l = s.path.length - E.length + 1, c = true
            }
            n = $.pointRef(e, s);
            var v = s.path.length - l,
              [, S] = _,
              I = s.path.slice(0, v),
              T = 0 === l ? s.offset : s.path[v] + h;
            for (var [A, C] of $.levels(e, {
                at: I,
                reverse: true,
                voids: a
              })) {
              var N = false;
              if (C.length < S.length || 0 === C.length || !a && K.isElement(A) && $.isVoid(e, A)) break;
              var P = p.current,
                R = $.isEnd(e, P, C);
              if (c || !p || !$.isEdge(e, P, C)) {
                N = true;
                var D = ei.extractProps(A);
                e.apply({
                  type: "split_node",
                  path: C,
                  position: T,
              ...
              T = C[C.length - 1] + (N || R ? 1 : 0)
            }
            if (null == t.at) {
              var w = n.current || $.end(e, []);
              eY.select(e, w)
            }
          } finally {
    ...
    unwrapNodes(e) {
      ...
      $.withoutNormalizing(e, () => {
        ...
        if (a) {
          null == o && (o = el.isPath(a) ? eU(e, a) : t => K.isElement(t) && $.isBlock(e, t)), el.isPath(a) && (a = $.range(e, a));
          var s = eg.isRange(a) ? $.rangeRef(e, a) : null,
            ...
            u = function(t) {
              var n = t.unref(),
                [a] = $.node(e, n),
                o = $.range(e, n);
              r && s && (o = eg.intersection(s.current, o)), eY.liftNodes(e, {
                at: o,
    ...
    wrapNodes(e, t) {
      ...
      $.withoutNormalizing(e, () => {
        ...
        if (s) {
          if (null == o && (o = el.isPath(s) ? eU(e, s) : e.isInline(t) ? t => K.isElement(t) && $.isInline(e, t) || eA.isText(t) : t => K.isElement(t) && $.isBlock(e, t)), i && eg.isRange(s)) {
            ...
            eY.splitNodes(e, {
              ...
              match: o,
              voids: a
            }), s = u.unref(), null == n.at && eY.select(e, s)
          }
  ...
  eM = (e, t) => {
    if (K.isElement(t)) {
      var n = t;
      return !!$.isVoid(e, t) || 1 === n.children.length && eM(e, n.children[0])
    }
    return !$.isEditor(t) && true
  },
  ek = (e, t) => {
...
function eZ(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = null != arguments[t] ? arguments[t] : {};
    t % 2 ? eG(Object(n), true).forEach(function(t) {
      o(e, t, n[t])
...
var eB = {
    collapse(e) {
      ...
      if (r) {
        if ("anchor" === n) eY.select(e, r.anchor);
        else if ("focus" === n) eY.select(e, r.focus);
        else if ("start" === n) {
          var [i] = eg.edges(r);
          eY.select(e, i)
        } else if ("end" === n) {
    ...
    select(e, t) {
      ...
      if (t = $.range(e, t), n) return void eY.setSelection(e, t);
    ...
    setPoint(e, t) {
      ...
      if (r) {
        ...
        eY.setSelection(e, {
          ["anchor" === i ? "anchor" : "focus"]: eZ(eZ({}, s), t)
        })
      }
    },
    setSelection(e, t) {
  ...
  eF = {
    delete(e) {
      ...
      $.withoutNormalizing(e, () => {
        ...
        if (s) {
          var c = false;
          if (eg.isRange(s) && eg.isCollapsed(s) && (c = true, s = s.anchor), ef.isPoint(s)) {
            var u = $.void(e, {
              at: s,
              mode: "highest"
            });
          ...
          if (el.isPath(s)) return void eY.removeNodes(e, {
            at: s,
            voids: o
          });
          if (!eg.isCollapsed(s)) {
            if (!l) {
              var [, _] = eg.edges(s), m = $.end(e, []);
              ef.equals(_, m) || (s = $.unhangRange(e, s, {
                voids: o
              }))
            }
            var [h, g] = eg.edges(s), E = $.above(e, {
              match: t => K.isElement(t) && $.isBlock(e, t),
              at: h,
              voids: o
            }), b = $.above(e, {
              ...
              at: g,
              voids: o
            }), y = E && b && !el.equals(E[1], b[1]), O = el.equals(h.path, g.path), v = o ? null : $.void(e, {
              at: h,
              mode: "highest"
            }), S = o ? null : $.void(e, {
              at: g,
            ...
            if (v) {
              var I = $.before(e, h);
              I && E && el.isAncestor(E[1], I.path) && (h = I)
            }
            if (S) {
              var T = $.after(e, g);
            ...
            for (var C of $.nodes(e, {
              ...
              var [N, P] = C;
              (!n || 0 !== el.compare(P, n)) && (!o && K.isElement(N) && $.isVoid(e, N) || !el.isCommon(P, h.path) && !el.isCommon(P, g.path)) && (A.push(C), n = P)
            }
            var R = Array.from(A, t => {
                var [, n] = t;
                return $.pathRef(e, n)
              }),
              D = $.pointRef(e, h),
            ...
            if (R.reverse().map(e => e.unref()).filter(e => null !== e).forEach(t => eY.removeNodes(e, {
                at: t,
                voids: o
              })), !S) {
              var G = w.current,
            ...
            }!O && y && w.current && D.current && eY.mergeNodes(e, {
              at: w.current,
              hanging: true,
              voids: o
            }), c && r && "character" === i && x.length > 1 && x.match(/[\u0E00-\u0E7F]+/) && eY.insertText(e, x.slice(0, x.length - a));
            var H = D.unref(),
              Y = w.unref(),
              W = r ? H || Y : Y || H;
          ...
          if (o) {
            ...
            if (!(!a && $.void(e, {
              ...
              var d = $.above(e, {
                ...
                O = t => {
                  var [n, r] = t;
                  return 0 !== r.length && (!!m || !(h && el.isAncestor(r, E) && K.isElement(n) && !e.isVoid(n) && !e.isInline(n) || g && el.isAncestor(r, b) && K.isElement(n) && !e.isVoid(n) && !e.isInline(n)))
                };
              ...
              var S = [],
                ...
                A = true,
                C = false;
              for (var [N] of y) K.isElement(N) && !e.isInline(N) ? (A = false, C = true, I.push(N)) : A ? S.push(N) : T.push(N);
              var [P] = $.nodes(e, {
                at: o,
                match: t => eA.isText(t) || $.isInline(e, t),
                mode: "highest",
                voids: a
              }), [, R] = P, D = $.isStart(e, o, R), w = $.isEnd(e, o, R), x = $.pathRef(e, _ && !T.length ? el.next(f) : f), L = $.pathRef(e, w ? el.next(R) : R);
              eY.splitNodes(e, {
                at: o,
                match: t => C ? K.isElement(t) && $.isBlock(e, t) : eA.isText(t) || $.isInline(e, t),
                mode: C ? "lowest" : "highest",
                always: C && (!p || S.length > 0) && (!_ || T.length > 0),
                voids: a
              });
              var j = $.pathRef(e, !D || D && w ? el.next(R) : R);
              if (eY.insertNodes(e, S, {
                  at: j.current,
                  match: t => eA.isText(t) || $.isInline(e, t),
                  mode: "highest",
                  voids: a
                }), m && !S.length && I.length && !T.length && eY.delete(e, {
                  at: f,
                  voids: a
                }), eY.insertNodes(e, I, {
                  at: x.current,
                  ...
                  mode: "highest",
                  voids: a
                }), !n.at && (T.length > 0 && L.current ? r = el.previous(L.current) : I.length > 0 && x.current ? r = el.previous(x.current) : j.current && (r = el.previous(j.current)), r)) {
                var M = $.end(e, r);
                eY.select(e, M)
              }
...
function eH(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = null != arguments[t] ? arguments[t] : {};
    t % 2 ? eV(Object(n), true).forEach(function(t) {
      o(e, t, n[t])
...
var eY = eH(eH(eH(eH({}, eR), ej), eB), eF)