        ...
        if (s) {
          ...
          if (!eg.isCollapsed(s)) {
            ...
            var [m, g] = eg.edges(s), E = $.above(e, {
              ...
              at: g,
              voids: a
            }), y = E && b && !el.equals(E[1], b[1]), v = el.equals(m.path, g.path), O = a ? null : $.void(e, {
              at: m,
              mode: "highest"
            }), I = a ? null : $.void(e, {
              at: g,
            ...
            for (var A of $.nodes(e, {
              ...
              var [C, P] = A;
              (!n || 0 !== el.compare(P, n)) && (!a && K.isElement(C) && $.isVoid(e, C) || !el.isCommon(P, m.path) && !el.isCommon(P, g.path)) && (N.push(A), n = P)
            }
            var R = Array.from(N, t => {
                var [, n] = t;
                return $.pathRef(e, n)
              }),
              w = $.pointRef(e, m),
...
var eW = eH(eH(eH(eH({}, eR), eM), eV), eF)