...
var m = () => {
  var e = {
    ...
    apply: t => {
      ...
      for (var r of J.pointRefs(e)) e_.transform(r, t);
      ...
      s.set(e, a), l.set(e, o), eY.transform(e, t), e.operations.push(t), J.normalize(e, {
        operation: t
    ...
    normalizeNode: t => {
      ...
      if (!eA.isText(n)) {
        ...
        for (var a = !J.isEditor(n) && K.isElement(n) && (e.isInline(n) || 0 === n.children.length || eA.isText(n.children[0]) || e.isInline(n.children[0])), o = 0, s = 0; s < n.children.length; s++, o++) {
          var l = ei.get(e, r);
          if (!eA.isText(l)) {
            var c = n.children[s],
              u = l.children[o - 1],
...
var w = /^(?:[\u0300-\u036F\u0483-\u0489\u0591-\u05BD\u05BF\u05C1\u05C2\u05C4\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7\u06E8\u06EA-\u06ED\u0711\u0730-\u074A\u07A6-\u07B0\u07EB-\u07F3\u07FD\u0816-\u0819\u081B-\u0823\u0825-\u0827\u0829-\u082D\u0859-\u085B\u08D3-\u08E1\u08E3-\u0902\u093A\u093C\u0941-\u0948\u094D\u0951-\u0957\u0962\u0963\u0981\u09BC\u09BE\u09C1-\u09C4\u09CD\u09D7\u09E2\u09E3\u09FE\u0A01\u0A02\u0A3C\u0A41\u0A42\u0A47\u0A48\u0A4B-\u0A4D\u0A51\u0A70\u0A71\u0A75\u0A81\u0A82\u0ABC\u0AC1-\u0AC5\u0AC7\u0AC8\u0ACD\u0AE2\u0AE3\u0AFA-\u0AFF\u0B01\u0B3C\u0B3E\u0B3F\u0B41-\u0B44\u0B4D\u0B55-\u0B57\u0B62\u0B63\u0B82\u0BBE\u0BC0\u0BCD\u0BD7\u0C00\u0C04\u0C3E-\u0C40\u0C46-\u0C48\u0C4A-\u0C4D\u0C55\u0C56\u0C62\u0C63\u0C81\u0CBC\u0CBF\u0CC2\u0CC6\u0CCC\u0CCD\u0CD5\u0CD6\u0CE2\u0CE3\u0D00\u0D01\u0D3B\u0D3C\u0D3E\u0D41-\u0D44\u0D4D\u0D57\u0D62\u0D63\u0D81\u0DCA\u0DCF\u0DD2-\u0DD4\u0DD6\u0DDF\u0E31\u0E34-\u0E3A\u0E47-\u0E4E\u0EB1\u0EB4-\u0EBC\u0EC8-\u0ECD\u0F18\u0F19\u0F35\u0F37\u0F39\u0F71-\u0F7E\u0F80-\u0F84\u0F86\u0F87\u0F8D-\u0F97\u0F99-\u0FBC\u0FC6\u102D-\u1030\u1032-\u1037\u1039\u103A\u103D\u103E\u1058\u1059\u105E-\u1060\u1071-\u1074\u1082\u1085\u1086\u108D\u109D\u135D-\u135F\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17B4\u17B5\u17B7-\u17BD\u17C6\u17C9-\u17D3\u17DD\u180B-\u180D\u1885\u1886\u18A9\u1920-\u1922\u1927\u1928\u1932\u1939-\u193B\u1A17\u1A18\u1A1B\u1A56\u1A58-\u1A5E\u1A60\u1A62\u1A65-\u1A6C\u1A73-\u1A7C\u1A7F\u1AB0-\u1AC0\u1B00-\u1B03\u1B34-\u1B3A\u1B3C\u1B42\u1B6B-\u1B73\u1B80\u1B81\u1BA2-\u1BA5\u1BA8\u1BA9\u1BAB-\u1BAD\u1BE6\u1BE8\u1BE9\u1BED\u1BEF-\u1BF1\u1C2C-\u1C33\u1C36\u1C37\u1CD0-\u1CD2\u1CD4-\u1CE0\u1CE2-\u1CE8\u1CED\u1CF4\u1CF8\u1CF9\u1DC0-\u1DF9\u1DFB-\u1DFF\u200C\u20D0-\u20F0\u2CEF-\u2CF1\u2D7F\u2DE0-\u2DFF\u302A-\u302F\u3099\u309A\uA66F-\uA672\uA674-\uA67D\uA69E\uA69F\uA6F0\uA6F1\uA802\uA806\uA80B\uA825\uA826\uA82C\uA8C4\uA8C5\uA8E0-\uA8F1\uA8FF\uA926-\uA92D\uA947-\uA951\uA980-\uA982\uA9B3\uA9B6-\uA9B9\uA9BC\uA9BD\uA9E5\uAA29-\uAA2E\uAA31\uAA32\uAA35\uAA36\uAA43\uAA4C\uAA7C\uAAB0\uAAB2-\uAAB4\uAAB7\uAAB8\uAABE\uAABF\uAAC1\uAAEC\uAAED\uAAF6\uABE5\uABE8\uABED\uFB1E\uFE00-\uFE0F\uFE20-\uFE2F\uFF9E\uFF9F]|\uD800[\uDDFD\uDEE0\uDF76-\uDF7A]|\uD802[\uDE01-\uDE03\uDE05\uDE06\uDE0C-\uDE0F\uDE38-\uDE3A\uDE3F\uDEE5\uDEE6]|\uD803[\uDD24-\uDD27\uDEAB\uDEAC\uDF46-\uDF50]|\uD804[\uDC01\uDC38-\uDC46\uDC7F-\uDC81\uDCB3-\uDCB6\uDCB9\uDCBA\uDD00-\uDD02\uDD27-\uDD2B\uDD2D-\uDD34\uDD73\uDD80\uDD81\uDDB6-\uDDBE\uDDC9-\uDDCC\uDDCF\uDE2F-\uDE31\uDE34\uDE36\uDE37\uDE3E\uDEDF\uDEE3-\uDEEA\uDF00\uDF01\uDF3B\uDF3C\uDF3E\uDF40\uDF57\uDF66-\uDF6C\uDF70-\uDF74]|\uD805[\uDC38-\uDC3F\uDC42-\uDC44\uDC46\uDC5E\uDCB0\uDCB3-\uDCB8\uDCBA\uDCBD\uDCBF\uDCC0\uDCC2\uDCC3\uDDAF\uDDB2-\uDDB5\uDDBC\uDDBD\uDDBF\uDDC0\uDDDC\uDDDD\uDE33-\uDE3A\uDE3D\uDE3F\uDE40\uDEAB\uDEAD\uDEB0-\uDEB5\uDEB7\uDF1D-\uDF1F\uDF22-\uDF25\uDF27-\uDF2B]|\uD806[\uDC2F-\uDC37\uDC39\uDC3A\uDD30\uDD3B\uDD3C\uDD3E\uDD43\uDDD4-\uDDD7\uDDDA\uDDDB\uDDE0\uDE01-\uDE0A\uDE33-\uDE38\uDE3B-\uDE3E\uDE47\uDE51-\uDE56\uDE59-\uDE5B\uDE8A-\uDE96\uDE98\uDE99]|\uD807[\uDC30-\uDC36\uDC38-\uDC3D\uDC3F\uDC92-\uDCA7\uDCAA-\uDCB0\uDCB2\uDCB3\uDCB5\uDCB6\uDD31-\uDD36\uDD3A\uDD3C\uDD3D\uDD3F-\uDD45\uDD47\uDD90\uDD91\uDD95\uDD97\uDEF3\uDEF4]|\uD81A[\uDEF0-\uDEF4\uDF30-\uDF36]|\uD81B[\uDF4F\uDF8F-\uDF92\uDFE4]|\uD82F[\uDC9D\uDC9E]|\uD834[\uDD65\uDD67-\uDD69\uDD6E-\uDD72\uDD7B-\uDD82\uDD85-\uDD8B\uDDAA-\uDDAD\uDE42-\uDE44]|\uD836[\uDE00-\uDE36\uDE3B-\uDE6C\uDE75\uDE84\uDE9B-\uDE9F\uDEA1-\uDEAF]|\uD838[\uDC00-\uDC06\uDC08-\uDC18\uDC1B-\uDC21\uDC23\uDC24\uDC26-\uDC2A\uDD30-\uDD36\uDEEC-\uDEEF]|\uD83A[\uDCD0-\uDCD6\uDD44-\uDD4A]|\uD83C[\uDFFB-\uDFFF]|\uDB40[\uDC20-\uDC7F\uDD00-\uDDEF])$/,
  ...
  U = (e, t) => {
    var n = r.Any;
    return -1 !== e.search(w) && (n |= r.Extend), 8205 === t && (n |= r.ZWJ), t >= 127462 && t <= 127487 && (n |= r.RI), -1 !== e.search(R) && (n |= r.Prepend), -1 !== e.search(P) && (n |= r.SpacingMark), -1 !== e.search(D) && (n |= r.L), -1 !== e.search(L) && (n |= r.V), -1 !== e.search(x) && (n |= r.T), -1 !== e.search(k) && (n |= r.LV), -1 !== e.search(j) && (n |= r.LVT), -1 !== e.search(M) && (n |= r.ExtPict), n
  };
...
var Q = new WeakMap,
  J = {
    ...
    after(e, t) {
      var n, r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
        ...
        o = 0;
      for (var s of J.positions(e, X(X({}, r), {}, {
          at: i
        }))) {
        if (o > a) break;
        0 !== o && (n = s), o++
    ...
    hasInlines: (e, t) => t.children.some(t => eA.isText(t) || J.isInline(e, t)),
    ...
    * levels(e) {
      ...
      if (null == a && (a = () => !0), n) {
        ...
        for (var [l, c] of ei.levels(e, s))
          if (a(l, c) && (o.push([l, c]), !i && K.isElement(l) && J.isVoid(e, l))) break;
        r && o.reverse(), yield* o
      }
    },
    marks(e) {
      ...
      if (0 === a.offset) {
        ...
        if (!J.above(e, {
            match: t => K.isElement(t) && J.isVoid(e, t) && e.markableVoid(t)
          })) {
          var c = J.above(e, {
    ...
    * nodes(e) {
      ...
      if (u || (u = () => !0), a) {
        ...
        var _ = ei.nodes(e, {
            ...
            pass: t => {
              var [n] = t;
              return !c && K.isElement(n) && J.isVoid(e, n)
            }
          }),
          p = [];
        for (var [h, m] of _) {
    ...
    normalize(e) {
      ...
      if (J.isNormalizing(e)) {
        ...
        0 !== i(e).length && J.withoutNormalizing(e, () => {
          for (var t of i(e))
            if (ei.has(e, t)) {
              var n = J.node(e, t),
                [a, s] = n;
    ...
    * positions(e) {
          ...
          if (K.isElement(h)) {
            ...
            if (J.hasInlines(e, h)) {
              var g = el.isAncestor(m, l.path) ? l : J.end(e, m),
                E = el.isAncestor(m, s.path) ? s : J.start(e, m);
              d = J.string(e, {
                anchor: E,
                focus: g
              }, {
    ...
    void(e) {
      var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      return J.above(e, X(X({}, t), {}, {
        match: t => K.isElement(t) && J.isVoid(e, t)
      }))
    },
  ...
  ei = {
    ...
    * children(e, t) {
    ...
    descendant(e, t) {
      var n = ei.get(e, t);
      if (J.isEditor(n)) throw Error("Cannot get the descendant node at path [".concat(t, "] because it refers to the root editor node instead: ").concat(ey.stringify(n)));
      return n
    },
    * descendants(e) {
      var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
    ...
    * elements(e) {
    ...
    has(e, t) {
      for (var n = e, r = 0; r < t.length; r++) {
        var i = t[r];
        if (eA.isText(n) || !n.children[i]) return !1;
        n = n.children[i]
      }
      return !0
    },
    isNode: e => eA.isText(e) || K.isElement(e) || J.isEditor(e),
    isNodeList(e) {
    ...
    * nodes(e) {
      for (var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, {
        ...
        if (o.has(l) || (yield [l, s]), !o.has(l) && !eA.isText(l) && 0 !== l.children.length && (null == n || !1 === n([l, s]))) {
          o.add(l);
    ...
    switch (n.type) {
      ...
      case "move_node":
        ...
        var N = ei.get(e, S),
          C = ei.parent(e, S),
          w = S[S.length - 1];
        C.children.splice(w, 1);
        var R = el.transform(S, n),
          P = ei.get(e, el.parent(R)),
          D = R[R.length - 1];
        if (P.children.splice(D, 0, N), t)
      ...
      case "remove_node":
        ...
        if (ei.parent(e, k).children.splice(j, 1), t)
          for (var [M, U] of eg.points(t)) {
            ...
            if (null != t && null != G) t[U] = G;
              ...
              for (var [F, V] of ei.texts(e))
                if (-1 === el.compare(V, k)) B = [F, V];
                else {
                  Z = [F, V];
                  break
                } var H = !1;
              B && Z && (H = el.equals(Z[1], k) ? !el.hasPrevious(Z[1]) : el.common(B[1], k).length < el.common(Z[1], k).length), B && !H ? (M.path = B[1], M.offset = B[0].text.length) : Z ? (M.path = Z[1], M.offset = 0) : t = null
            }
          }
        break;
      case "remove_text":
        ...
        var z = ei.leaf(e, Y),
          q = z.text.slice(0, W),
          $ = z.text.slice(W + K.length);
        if (z.text = q + $, t)
          for (var [X, Q] of eg.points(t)) t[Q] = ef.transform(X, n);
        break;
      case "set_node":
        var {
...
var ek = {
    insertNodes(e, t) {
      ...
      J.withoutNormalizing(e, () => {
        ...
        if (ei.isNode(t) && (t = [t]), 0 !== t.length) {
          var [c] = t;
          if (o || (o = e.selection ? e.selection : e.children.length > 0 ? J.end(e, []) : [0], l = !0), null == l && (l = !1), eg.isRange(o))
            if (r || (o = J.unhangRange(e, o, {
                voids: i
              })), eg.isCollapsed(o)) o = o.anchor;
            else {
              var [, u] = eg.edges(o), d = J.pointRef(e, u);
              eY.delete(e, {
                at: o
              }), o = d.unref()
            } if (ef.isPoint(o)) {
            null == s && (s = eA.isText(c) ? e => eA.isText(e) : e.isInline(c) ? t => eA.isText(t) || J.isInline(e, t) : t => K.isElement(t) && J.isBlock(e, t));
            var [f] = J.nodes(e, {
              at: o.path,
              match: s,
              mode: a,
            ...
            if (!f) return;
            var [, _] = f, p = J.pathRef(e, _), h = J.isEnd(e, o, _);
            eY.splitNodes(e, {
              at: o,
              match: s,
              mode: a,
    ...
    liftNodes(e) {
      ...
      J.withoutNormalizing(e, () => {
        ...
        if (null == a && (a = el.isPath(n) ? eU(e, n) : t => K.isElement(t) && J.isBlock(e, t)), n) {
          var o = J.nodes(e, {
              at: n,
              match: a,
              mode: r,
          ...
          for (var l of s) {
            ...
            var [u, d] = J.node(e, el.parent(c)), f = c[c.length - 1], {
              length: _
            } = u.children;
            if (1 === _) {
              var p = el.next(d);
    ...
    mergeNodes(e) {
      ...
      J.withoutNormalizing(e, () => {
        ...
        if (a) {
          ...
          if (!o && eg.isRange(a) && (a = J.unhangRange(e, a, {
              voids: s
            })), eg.isRange(a))
            if (eg.isCollapsed(a)) a = a.anchor;
            else {
              var [, u] = eg.edges(a), d = J.pointRef(e, u);
              eY.delete(e, {
                at: a
          ...
          if (f && _) {
            ...
            if (0 !== h.length && 0 !== g.length) {
              ...
              O || eY.moveNodes(e, {
                ...
                at: T.current,
                voids: s
              }), K.isElement(m) && J.isEmpty(e, m) || eA.isText(m) && "" === m.text && 0 !== g[g.length - 1] ? eY.removeNodes(e, {
                at: g,
                voids: s
              }) : e.apply({
                type: "merge_node",
    ...
    moveNodes(e, t) {
      J.withoutNormalizing(e, () => {
        ...
        if (r) {
          null == o && (o = el.isPath(r) ? eU(e, r) : t => K.isElement(t) && J.isBlock(e, t));
          var s = J.pathRef(e, n),
            l = J.nodes(e, {
              at: r,
              match: o,
    ...
    removeNodes(e) {
      ...
      J.withoutNormalizing(e, () => {
        ...
        if (a) {
          null == o && (o = el.isPath(a) ? eU(e, a) : t => K.isElement(t) && J.isBlock(e, t)), !n && eg.isRange(a) && (a = J.unhangRange(e, a, {
            voids: r
          }));
          var s = J.nodes(e, {
              at: a,
    ...
    setNodes(e, t) {
      ...
      J.withoutNormalizing(e, () => {
        ...
        if (i) {
          if (null == r && (r = el.isPath(i) ? eU(e, i) : t => K.isElement(t) && J.isBlock(e, t)), !s && eg.isRange(i) && (i = J.unhangRange(e, i, {
              voids: u
            })), c && eg.isRange(i)) {
          ...
          for (var [g, E] of(a || (a = (e, t) => e !== t), J.nodes(e, {
              at: i,
              match: r,
              mode: l,
              voids: u
            ...
            if (0 !== E.length) {
              var O = !1;
              for (var v in t) "children" !== v && "text" !== v && a(t[v], g[v]) && (O = !0, g.hasOwnProperty(v) && (b[v] = g[v]), o ? null != t[v] && (y[v] = o(g[v], t[v])) : null != t[v] && (y[v] = t[v]));
              O && e.apply({
                type: "set_node",
                path: E,
                properties: b,
    ...
    splitNodes(e) {
      ...
      J.withoutNormalizing(e, () => {
        ...
        if (null == o && (o = t => K.isElement(t) && J.isBlock(e, t)), eg.isRange(s) && (s = eM(e, s)), el.isPath(s)) {
          var u = s,
            d = J.point(e, u),
            [f] = J.parent(e, u);
        ...
        if (s) {
          ...
          try {
            ...
            for (var [A, N] of J.levels(e, {
                at: T,
                reverse: !0,
                voids: a
              })) {
              var C = !1;
              if (N.length < I.length || 0 === N.length || !a && K.isElement(A) && J.isVoid(e, A)) break;
              var w = _.current,
                R = J.isEnd(e, w, N);
              if (c || !_ || !J.isEdge(e, w, N)) {
                C = !0;
                var P = ei.extractProps(A);
                e.apply({
                  type: "split_node",
                  path: N,
                  position: S,
    ...
    unwrapNodes(e) {
      ...
      J.withoutNormalizing(e, () => {
        ...
        if (a) {
          null == o && (o = el.isPath(a) ? eU(e, a) : t => K.isElement(t) && J.isBlock(e, t)), el.isPath(a) && (a = J.range(e, a));
          var s = eg.isRange(a) ? J.rangeRef(e, a) : null,
            l = J.nodes(e, {
              at: a,
              match: o,
              mode: n,
    ...
    wrapNodes(e, t) {
      ...
      J.withoutNormalizing(e, () => {
        ...
        if (s) {
          if (null == o && (o = el.isPath(s) ? eU(e, s) : e.isInline(t) ? t => K.isElement(t) && J.isInline(e, t) || eA.isText(t) : t => K.isElement(t) && J.isBlock(e, t)), i && eg.isRange(s)) {
            var [l, c] = eg.edges(s), u = J.rangeRef(e, s, {
              affinity: "inward"
            });
            eY.splitNodes(e, {
              at: c,
          ...
          for (var [, f] of d) {
            var _ = eg.isRange(s) ? eg.intersection(s, J.range(e, f)) : s;
            if (_) {
              var p = Array.from(J.nodes(e, {
                at: _,
                match: o,
                mode: r,
                voids: a
  ...
  ej = (e, t) => {
    if (K.isElement(t)) {
      var n = t;
      return !!J.isVoid(e, t) || 1 === n.children.length && ej(e, n.children[0])
    }
    return !J.isEditor(t) && !0
  },
  eM = (e, t) => {
    if (eg.isCollapsed(t)) return t.anchor;
    var [, n] = eg.edges(t), r = J.pointRef(e, n);
    return eY.delete(e, {
      at: t
    }), r.unref()
  },
...
var eZ = {
    ...
    move(e) {
      ...
      if (n) {
        ...
        if (null == o || "anchor" === o) {
          var d = a ? J.before(e, s, c) : J.after(e, s, c);
          d && (u.anchor = d)
        }
        if (null == o || "focus" === o) {
    ...
    select(e, t) {
      ...
      if (t = J.range(e, t), n) return void eY.setSelection(e, t);
    ...
    delete(e) {
      ...
      J.withoutNormalizing(e, () => {
        ...
        if (s) {
          ...
          if (eg.isRange(s) && eg.isCollapsed(s) && (c = !0, s = s.anchor), ef.isPoint(s)) {
            ...
            if (!o && u) {
              ...
              var f = {
                ...
                _ = r ? J.before(e, s, f) || J.start(e, []) : J.after(e, s, f) || J.end(e, []);
              s = {
                anchor: s,
                focus: _
              }, l = !0
          ...
          if (!eg.isCollapsed(s)) {
            if (!l) {
              var [, p] = eg.edges(s), h = J.end(e, []);
              ef.equals(p, h) || (s = J.unhangRange(e, s, {
                voids: o
              }))
            }
            var [m, g] = eg.edges(s), E = J.above(e, {
              match: t => K.isElement(t) && J.isBlock(e, t),
              at: m,
              voids: o
            }), b = J.above(e, {
              ...
              at: g,
              voids: o
            }), y = E && b && !el.equals(E[1], b[1]), O = el.equals(m.path, g.path), v = o ? null : J.void(e, {
              at: m,
              mode: "highest"
            }), I = o ? null : J.void(e, {
              at: g,
            ...
            var A = [];
            for (var N of J.nodes(e, {
                at: s,
                voids: o
              })) {
              var [C, w] = N;
              (!n || 0 !== el.compare(w, n)) && (!o && K.isElement(C) && J.isVoid(e, C) || !el.isCommon(w, m.path) && !el.isCommon(w, g.path)) && (A.push(N), n = w)
            }
            ...
            }!O && y && D.current && P.current && eY.mergeNodes(e, {
              at: D.current,
              hanging: !0,
              voids: o
        ...
        if (t.length) {
          if (o) {
            ...
            if (!(!a && J.void(e, {
              ...
              if (c) {
                var [, u] = c;
                J.isEnd(e, o, u) ? o = J.after(e, u) : J.isStart(e, o, u) && (o = J.before(e, u))
              }
              var d = J.above(e, {
                  match: t => K.isElement(t) && J.isBlock(e, t),
                  at: o,
              ...
              var I = [],
                ...
                A = !0,
                N = !1;
              for (var [C] of y) K.isElement(C) && !e.isInline(C) ? (A = !1, N = !0, T.push(C)) : A ? I.push(C) : S.push(C);
              var [w] = J.nodes(e, {
                at: o,
                match: t => eA.isText(t) || J.isInline(e, t),
                mode: "highest",
                voids: a
              }), [, R] = w, P = J.isStart(e, o, R), D = J.isEnd(e, o, R), L = J.pathRef(e, p && !S.length ? el.next(f) : f), x = J.pathRef(e, D ? el.next(R) : R);
              eY.splitNodes(e, {
                at: o,
                match: t => N ? K.isElement(t) && J.isBlock(e, t) : eA.isText(t) || J.isInline(e, t),
                mode: N ? "lowest" : "highest",
                always: N && (!_ || I.length > 0) && (!p || S.length > 0),
                voids: a
              });
              var k = J.pathRef(e, !P || P && D ? el.next(R) : R);
              if (eY.insertNodes(e, I, {
                  ...
                  mode: "highest",
                  voids: a
                }), !n.at && (S.length > 0 && x.current ? r = el.previous(x.current) : T.length > 0 && L.current ? r = el.previous(L.current) : k.current && (r = el.previous(k.current)), r)) {
                var j = J.end(e, r);
                eY.select(e, j)
              }
              k.unref(), L.unref(), x.unref()
            }
          }
        }
      })
...
var eY = eH(eH(eH(eH({}, eR), ek), eZ), eF)