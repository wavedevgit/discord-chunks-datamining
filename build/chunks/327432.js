  ...
  var e = {
    ...
    apply: t => {
      ...
      if (el.operationCanTransformPath(t))
        for (var _ of (a = [], o = new Set, u)) f(el.transform(_, t));
      else a = u, o = d;
...
var b = function(e) {
    ...
    for (var u of i) {
      ...
      if (!d) break;
      var f = U(u, d);
      if ([a, o] = n ? [o, f] : [f, a], G(a, r.ZWJ) && G(o, r.ExtPict) && !(l = n ? F(e.substring(0, s)) : F(e.substring(0, e.length - s))) || G(a, r.RI) && G(o, r.RI) && !(c = null !== c ? !c : !!n || Y(e.substring(0, e.length - s))) || a !== r.None && o !== r.None && Z(a, o)) break;
      s += u.length
    }
    return s || 1
  },
...
var R = /^(?:[\u0300-\u036F\u0483-\u0489\u0591-\u05BD\u05BF\u05C1\u05C2\u05C4\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7\u06E8\u06EA-\u06ED\u0711\u0730-\u074A\u07A6-\u07B0\u07EB-\u07F3\u07FD\u0816-\u0819\u081B-\u0823\u0825-\u0827\u0829-\u082D\u0859-\u085B\u08D3-\u08E1\u08E3-\u0902\u093A\u093C\u0941-\u0948\u094D\u0951-\u0957\u0962\u0963\u0981\u09BC\u09BE\u09C1-\u09C4\u09CD\u09D7\u09E2\u09E3\u09FE\u0A01\u0A02\u0A3C\u0A41\u0A42\u0A47\u0A48\u0A4B-\u0A4D\u0A51\u0A70\u0A71\u0A75\u0A81\u0A82\u0ABC\u0AC1-\u0AC5\u0AC7\u0AC8\u0ACD\u0AE2\u0AE3\u0AFA-\u0AFF\u0B01\u0B3C\u0B3E\u0B3F\u0B41-\u0B44\u0B4D\u0B55-\u0B57\u0B62\u0B63\u0B82\u0BBE\u0BC0\u0BCD\u0BD7\u0C00\u0C04\u0C3E-\u0C40\u0C46-\u0C48\u0C4A-\u0C4D\u0C55\u0C56\u0C62\u0C63\u0C81\u0CBC\u0CBF\u0CC2\u0CC6\u0CCC\u0CCD\u0CD5\u0CD6\u0CE2\u0CE3\u0D00\u0D01\u0D3B\u0D3C\u0D3E\u0D41-\u0D44\u0D4D\u0D57\u0D62\u0D63\u0D81\u0DCA\u0DCF\u0DD2-\u0DD4\u0DD6\u0DDF\u0E31\u0E34-\u0E3A\u0E47-\u0E4E\u0EB1\u0EB4-\u0EBC\u0EC8-\u0ECD\u0F18\u0F19\u0F35\u0F37\u0F39\u0F71-\u0F7E\u0F80-\u0F84\u0F86\u0F87\u0F8D-\u0F97\u0F99-\u0FBC\u0FC6\u102D-\u1030\u1032-\u1037\u1039\u103A\u103D\u103E\u1058\u1059\u105E-\u1060\u1071-\u1074\u1082\u1085\u1086\u108D\u109D\u135D-\u135F\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17B4\u17B5\u17B7-\u17BD\u17C6\u17C9-\u17D3\u17DD\u180B-\u180D\u1885\u1886\u18A9\u1920-\u1922\u1927\u1928\u1932\u1939-\u193B\u1A17\u1A18\u1A1B\u1A56\u1A58-\u1A5E\u1A60\u1A62\u1A65-\u1A6C\u1A73-\u1A7C\u1A7F\u1AB0-\u1AC0\u1B00-\u1B03\u1B34-\u1B3A\u1B3C\u1B42\u1B6B-\u1B73\u1B80\u1B81\u1BA2-\u1BA5\u1BA8\u1BA9\u1BAB-\u1BAD\u1BE6\u1BE8\u1BE9\u1BED\u1BEF-\u1BF1\u1C2C-\u1C33\u1C36\u1C37\u1CD0-\u1CD2\u1CD4-\u1CE0\u1CE2-\u1CE8\u1CED\u1CF4\u1CF8\u1CF9\u1DC0-\u1DF9\u1DFB-\u1DFF\u200C\u20D0-\u20F0\u2CEF-\u2CF1\u2D7F\u2DE0-\u2DFF\u302A-\u302F\u3099\u309A\uA66F-\uA672\uA674-\uA67D\uA69E\uA69F\uA6F0\uA6F1\uA802\uA806\uA80B\uA825\uA826\uA82C\uA8C4\uA8C5\uA8E0-\uA8F1\uA8FF\uA926-\uA92D\uA947-\uA951\uA980-\uA982\uA9B3\uA9B6-\uA9B9\uA9BC\uA9BD\uA9E5\uAA29-\uAA2E\uAA31\uAA32\uAA35\uAA36\uAA43\uAA4C\uAA7C\uAAB0\uAAB2-\uAAB4\uAAB7\uAAB8\uAABE\uAABF\uAAC1\uAAEC\uAAED\uAAF6\uABE5\uABE8\uABED\uFB1E\uFE00-\uFE0F\uFE20-\uFE2F\uFF9E\uFF9F]|\uD800[\uDDFD\uDEE0\uDF76-\uDF7A]|\uD802[\uDE01-\uDE03\uDE05\uDE06\uDE0C-\uDE0F\uDE38-\uDE3A\uDE3F\uDEE5\uDEE6]|\uD803[\uDD24-\uDD27\uDEAB\uDEAC\uDF46-\uDF50]|\uD804[\uDC01\uDC38-\uDC46\uDC7F-\uDC81\uDCB3-\uDCB6\uDCB9\uDCBA\uDD00-\uDD02\uDD27-\uDD2B\uDD2D-\uDD34\uDD73\uDD80\uDD81\uDDB6-\uDDBE\uDDC9-\uDDCC\uDDCF\uDE2F-\uDE31\uDE34\uDE36\uDE37\uDE3E\uDEDF\uDEE3-\uDEEA\uDF00\uDF01\uDF3B\uDF3C\uDF3E\uDF40\uDF57\uDF66-\uDF6C\uDF70-\uDF74]|\uD805[\uDC38-\uDC3F\uDC42-\uDC44\uDC46\uDC5E\uDCB0\uDCB3-\uDCB8\uDCBA\uDCBD\uDCBF\uDCC0\uDCC2\uDCC3\uDDAF\uDDB2-\uDDB5\uDDBC\uDDBD\uDDBF\uDDC0\uDDDC\uDDDD\uDE33-\uDE3A\uDE3D\uDE3F\uDE40\uDEAB\uDEAD\uDEB0-\uDEB5\uDEB7\uDF1D-\uDF1F\uDF22-\uDF25\uDF27-\uDF2B]|\uD806[\uDC2F-\uDC37\uDC39\uDC3A\uDD30\uDD3B\uDD3C\uDD3E\uDD43\uDDD4-\uDDD7\uDDDA\uDDDB\uDDE0\uDE01-\uDE0A\uDE33-\uDE38\uDE3B-\uDE3E\uDE47\uDE51-\uDE56\uDE59-\uDE5B\uDE8A-\uDE96\uDE98\uDE99]|\uD807[\uDC30-\uDC36\uDC38-\uDC3D\uDC3F\uDC92-\uDCA7\uDCAA-\uDCB0\uDCB2\uDCB3\uDCB5\uDCB6\uDD31-\uDD36\uDD3A\uDD3C\uDD3D\uDD3F-\uDD45\uDD47\uDD90\uDD91\uDD95\uDD97\uDEF3\uDEF4]|\uD81A[\uDEF0-\uDEF4\uDF30-\uDF36]|\uD81B[\uDF4F\uDF8F-\uDF92\uDFE4]|\uD82F[\uDC9D\uDC9E]|\uD834[\uDD65\uDD67-\uDD69\uDD6E-\uDD72\uDD7B-\uDD82\uDD85-\uDD8B\uDDAA-\uDDAD\uDE42-\uDE44]|\uD836[\uDE00-\uDE36\uDE3B-\uDE6C\uDE75\uDE84\uDE9B-\uDE9F\uDEA1-\uDEAF]|\uD838[\uDC00-\uDC06\uDC08-\uDC18\uDC1B-\uDC21\uDC23\uDC24\uDC26-\uDC2A\uDD30-\uDD36\uDEEC-\uDEEF]|\uD83A[\uDCD0-\uDCD6\uDD44-\uDD4A]|\uD83C[\uDFFB-\uDFFF]|\uDB40[\uDC20-\uDC7F\uDD00-\uDDEF])$/,
  ...
  U = (e, t) => {
    var n = r.Any;
    return false !== e.search(R) && (n |= r.Extend), 8205 === t && (n |= r.ZWJ), t >= 127462 && t <= 127487 && (n |= r.RI), false !== e.search(P) && (n |= r.Prepend), false !== e.search(w) && (n |= r.SpacingMark), false !== e.search(D) && (n |= r.L), false !== e.search(x) && (n |= r.V), false !== e.search(L) && (n |= r.T), false !== e.search(j) && (n |= r.LV), false !== e.search(k) && (n |= r.LVT), false !== e.search(M) && (n |= r.ExtPict), n
  };
...
function Z(e, t) {
  return false === B.findIndex(n => G(e, n[0]) && G(t, n[1]))
}
var V = /(?:[\xA9\xAE\u203C\u2049\u2122\u2139\u2194-\u2199\u21A9\u21AA\u231A\u231B\u2328\u2388\u23CF\u23E9-\u23F3\u23F8-\u23FA\u24C2\u25AA\u25AB\u25B6\u25C0\u25FB-\u25FE\u2600-\u2605\u2607-\u2612\u2614-\u2685\u2690-\u2705\u2708-\u2712\u2714\u2716\u271D\u2721\u2728\u2733\u2734\u2744\u2747\u274C\u274E\u2753-\u2755\u2757\u2763-\u2767\u2795-\u2797\u27A1\u27B0\u27BF\u2934\u2935\u2B05-\u2B07\u2B1B\u2B1C\u2B50\u2B55\u3030\u303D\u3297\u3299]|\uD83C[\uDC00-\uDCFF\uDD0D-\uDD0F\uDD2F\uDD6C-\uDD71\uDD7E\uDD7F\uDD8E\uDD91-\uDD9A\uDDAD-\uDDE5\uDE01-\uDE0F\uDE1A\uDE2F\uDE32-\uDE3A\uDE3C-\uDE3F\uDE49-\uDFFA]|\uD83D[\uDC00-\uDD3D\uDD46-\uDE4F\uDE80-\uDEFF\uDF74-\uDF7F\uDFD5-\uDFFF]|\uD83E[\uDC0C-\uDC0F\uDC48-\uDC4F\uDC5A-\uDC5F\uDC88-\uDC8F\uDCAE-\uDCFF\uDD0C-\uDD3A\uDD3C-\uDD45\uDD47-\uDEFF]|\uD83F[\uDC00-\uDFFD])(?:[\u0300-\u036F\u0483-\u0489\u0591-\u05BD\u05BF\u05C1\u05C2\u05C4\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7\u06E8\u06EA-\u06ED\u0711\u0730-\u074A\u07A6-\u07B0\u07EB-\u07F3\u07FD\u0816-\u0819\u081B-\u0823\u0825-\u0827\u0829-\u082D\u0859-\u085B\u08D3-\u08E1\u08E3-\u0902\u093A\u093C\u0941-\u0948\u094D\u0951-\u0957\u0962\u0963\u0981\u09BC\u09BE\u09C1-\u09C4\u09CD\u09D7\u09E2\u09E3\u09FE\u0A01\u0A02\u0A3C\u0A41\u0A42\u0A47\u0A48\u0A4B-\u0A4D\u0A51\u0A70\u0A71\u0A75\u0A81\u0A82\u0ABC\u0AC1-\u0AC5\u0AC7\u0AC8\u0ACD\u0AE2\u0AE3\u0AFA-\u0AFF\u0B01\u0B3C\u0B3E\u0B3F\u0B41-\u0B44\u0B4D\u0B55-\u0B57\u0B62\u0B63\u0B82\u0BBE\u0BC0\u0BCD\u0BD7\u0C00\u0C04\u0C3E-\u0C40\u0C46-\u0C48\u0C4A-\u0C4D\u0C55\u0C56\u0C62\u0C63\u0C81\u0CBC\u0CBF\u0CC2\u0CC6\u0CCC\u0CCD\u0CD5\u0CD6\u0CE2\u0CE3\u0D00\u0D01\u0D3B\u0D3C\u0D3E\u0D41-\u0D44\u0D4D\u0D57\u0D62\u0D63\u0D81\u0DCA\u0DCF\u0DD2-\u0DD4\u0DD6\u0DDF\u0E31\u0E34-\u0E3A\u0E47-\u0E4E\u0EB1\u0EB4-\u0EBC\u0EC8-\u0ECD\u0F18\u0F19\u0F35\u0F37\u0F39\u0F71-\u0F7E\u0F80-\u0F84\u0F86\u0F87\u0F8D-\u0F97\u0F99-\u0FBC\u0FC6\u102D-\u1030\u1032-\u1037\u1039\u103A\u103D\u103E\u1058\u1059\u105E-\u1060\u1071-\u1074\u1082\u1085\u1086\u108D\u109D\u135D-\u135F\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17B4\u17B5\u17B7-\u17BD\u17C6\u17C9-\u17D3\u17DD\u180B-\u180D\u1885\u1886\u18A9\u1920-\u1922\u1927\u1928\u1932\u1939-\u193B\u1A17\u1A18\u1A1B\u1A56\u1A58-\u1A5E\u1A60\u1A62\u1A65-\u1A6C\u1A73-\u1A7C\u1A7F\u1AB0-\u1AC0\u1B00-\u1B03\u1B34-\u1B3A\u1B3C\u1B42\u1B6B-\u1B73\u1B80\u1B81\u1BA2-\u1BA5\u1BA8\u1BA9\u1BAB-\u1BAD\u1BE6\u1BE8\u1BE9\u1BED\u1BEF-\u1BF1\u1C2C-\u1C33\u1C36\u1C37\u1CD0-\u1CD2\u1CD4-\u1CE0\u1CE2-\u1CE8\u1CED\u1CF4\u1CF8\u1CF9\u1DC0-\u1DF9\u1DFB-\u1DFF\u200C\u20D0-\u20F0\u2CEF-\u2CF1\u2D7F\u2DE0-\u2DFF\u302A-\u302F\u3099\u309A\uA66F-\uA672\uA674-\uA67D\uA69E\uA69F\uA6F0\uA6F1\uA802\uA806\uA80B\uA825\uA826\uA82C\uA8C4\uA8C5\uA8E0-\uA8F1\uA8FF\uA926-\uA92D\uA947-\uA951\uA980-\uA982\uA9B3\uA9B6-\uA9B9\uA9BC\uA9BD\uA9E5\uAA29-\uAA2E\uAA31\uAA32\uAA35\uAA36\uAA43\uAA4C\uAA7C\uAAB0\uAAB2-\uAAB4\uAAB7\uAAB8\uAABE\uAABF\uAAC1\uAAEC\uAAED\uAAF6\uABE5\uABE8\uABED\uFB1E\uFE00-\uFE0F\uFE20-\uFE2F\uFF9E\uFF9F]|\uD800[\uDDFD\uDEE0\uDF76-\uDF7A]|\uD802[\uDE01-\uDE03\uDE05\uDE06\uDE0C-\uDE0F\uDE38-\uDE3A\uDE3F\uDEE5\uDEE6]|\uD803[\uDD24-\uDD27\uDEAB\uDEAC\uDF46-\uDF50]|\uD804[\uDC01\uDC38-\uDC46\uDC7F-\uDC81\uDCB3-\uDCB6\uDCB9\uDCBA\uDD00-\uDD02\uDD27-\uDD2B\uDD2D-\uDD34\uDD73\uDD80\uDD81\uDDB6-\uDDBE\uDDC9-\uDDCC\uDDCF\uDE2F-\uDE31\uDE34\uDE36\uDE37\uDE3E\uDEDF\uDEE3-\uDEEA\uDF00\uDF01\uDF3B\uDF3C\uDF3E\uDF40\uDF57\uDF66-\uDF6C\uDF70-\uDF74]|\uD805[\uDC38-\uDC3F\uDC42-\uDC44\uDC46\uDC5E\uDCB0\uDCB3-\uDCB8\uDCBA\uDCBD\uDCBF\uDCC0\uDCC2\uDCC3\uDDAF\uDDB2-\uDDB5\uDDBC\uDDBD\uDDBF\uDDC0\uDDDC\uDDDD\uDE33-\uDE3A\uDE3D\uDE3F\uDE40\uDEAB\uDEAD\uDEB0-\uDEB5\uDEB7\uDF1D-\uDF1F\uDF22-\uDF25\uDF27-\uDF2B]|\uD806[\uDC2F-\uDC37\uDC39\uDC3A\uDD30\uDD3B\uDD3C\uDD3E\uDD43\uDDD4-\uDDD7\uDDDA\uDDDB\uDDE0\uDE01-\uDE0A\uDE33-\uDE38\uDE3B-\uDE3E\uDE47\uDE51-\uDE56\uDE59-\uDE5B\uDE8A-\uDE96\uDE98\uDE99]|\uD807[\uDC30-\uDC36\uDC38-\uDC3D\uDC3F\uDC92-\uDCA7\uDCAA-\uDCB0\uDCB2\uDCB3\uDCB5\uDCB6\uDD31-\uDD36\uDD3A\uDD3C\uDD3D\uDD3F-\uDD45\uDD47\uDD90\uDD91\uDD95\uDD97\uDEF3\uDEF4]|\uD81A[\uDEF0-\uDEF4\uDF30-\uDF36]|\uD81B[\uDF4F\uDF8F-\uDF92\uDFE4]|\uD82F[\uDC9D\uDC9E]|\uD834[\uDD65\uDD67-\uDD69\uDD6E-\uDD72\uDD7B-\uDD82\uDD85-\uDD8B\uDDAA-\uDDAD\uDE42-\uDE44]|\uD836[\uDE00-\uDE36\uDE3B-\uDE6C\uDE75\uDE84\uDE9B-\uDE9F\uDEA1-\uDEAF]|\uD838[\uDC00-\uDC06\uDC08-\uDC18\uDC1B-\uDC21\uDC23\uDC24\uDC26-\uDC2A\uDD30-\uDD36\uDEEC-\uDEEF]|\uD83A[\uDCD0-\uDCD6\uDD44-\uDD4A]|\uD83C[\uDFFB-\uDFFF]|\uDB40[\uDC20-\uDC7F\uDD00-\uDDEF])*\u200D$/,
  F = e => false !== e.search(V),
  H = /(?:\uD83C[\uDDE6-\uDDFF])+$/g,
  Y = e => {
    var t = e.match(H);
  ...
  $ = {
    ...
    * nodes(e) {
      ...
      if (u || (u = () => true), a) {
        ...
        "lowest" === o && r && (s ? p.push(r) : yield r), s && (yield* p)
      }
    },
    normalize(e) {
      var t = arguments.length > 1 && true !== arguments[1] ? arguments[1] : {},
      ...
      if (n) {
        ...
        for (var [h, m] of $.nodes(e, {
          ...
          if (eA.isText(h)) {
            ...
            for (y ? (_ = i ? c.offset : h.text.length - c.offset, p = c.offset) : (_ = h.text.length, p = i ? _ : 0), (y || u || "offset" === r) && (yield {
                path: m,
                offset: p
              }, u = false);;) {
              if (0 === f) {
                if ("" === d) break;
                f = O(d, r, i), d = T(d, f, i)[1]
              }
...
function em(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = null != arguments[t] ? arguments[t] : {};
    t % 2 ? eh(Object(n), true).forEach(function(t) {
      o(e, t, n[t])
    ...
    switch (n.type) {
      ...
      case "merge_node":
        ...
        if (O.children.splice(v, 1), t)
          for (var [I, T] of eg.points(t)) t[T] = ef.transform(I, n);
        break;
      case "move_node":
        var {
          path: S, newPath: A
        } = n;
        if (el.isAncestor(S, A)) throw Error("Cannot move a path [".concat(S, "] to new path [").concat(A, "] because the destination is inside itself."));
        var C = ei.get(e, S),
          N = ei.parent(e, S),
          R = S[S.length - 1];
        N.children.splice(R, 1);
        var P = el.transform(S, n),
      ...
      case "remove_node":
        ...
        if (ei.parent(e, j).children.splice(k, 1), t)
          for (var [M, U] of eg.points(t)) {
            var G = ef.transform(M, n);
            if (null != t && null != G) t[U] = G;
            else {
              var B = true,
                Z = true;
              for (var [V, F] of ei.texts(e))
                if (false === el.compare(F, j)) B = [V, F];
                else {
                  Z = [V, F];
                  break
                } var H = false;
              B && Z && (H = el.equals(Z[1], j) ? !el.hasPrevious(Z[1]) : el.common(B[1], j).length < el.common(Z[1], j).length), B && !H ? (M.path = B[1], M.offset = B[0].text.length) : Z ? (M.path = Z[1], M.offset = 0) : t = null
            }
          }
        break;
      case "remove_text":
      ...
      case "split_node":
        ...
        if (eA.isText(em)) {
          ...
          var eI = em.children.slice(0, ep),
            eT = em.children.slice(ep);
          em.children = eI, ed = eN(eN({}, eh), {}, {
            children: eT
          })
        }
...
var ej = {
      ...
      $.withoutNormalizing(e, () => {
        ...
        if (ei.isNode(t) && (t = [t]), 0 !== t.length) {
          ...
          if (o || (o = e.selection ? e.selection : e.children.length > 0 ? $.end(e, []) : [0], l = true), null == l && (l = false), eg.isRange(o))
            ...
            if (!f) return;
            var [, _] = f, p = $.pathRef(e, _), h = $.isEnd(e, o, _);
            eY.splitNodes(e, {
              at: o,
              match: s,
              mode: a,
            ...
            if (0 !== h.length && 0 !== g.length) {
              var b = el.next(g),
                ...
                I = $.above(e, {
                  at: h,
                  mode: "highest",
                  match: t => v.includes(t) && ek(e, t)
                }),
                T = I && $.pathRef(e, I[1]);
              if (eA.isText(p) && eA.isText(m)) {
                var S = E(p, ew);
                r = m.text.length, n = S
              ...
              O || eY.moveNodes(e, {
                ...
                at: T.current,
                voids: s
              }), K.isElement(m) && $.isEmpty(e, m) || eA.isText(m) && "" === m.text && 0 !== g[g.length - 1] ? eY.removeNodes(e, {
                at: g,
                voids: s
              }) : e.apply({
                type: "merge_node",
    ...
    splitNodes(e) {
      ...
      $.withoutNormalizing(e, () => {
        ...
        if (null == o && (o = t => K.isElement(t) && $.isBlock(e, t)), eg.isRange(s) && (s = eM(e, s)), el.isPath(s)) {
          var u = s,
            d = $.point(e, u),
            [f] = $.parent(e, u);
        ...
        if (s) {
          ...
          try {
            ...
            for (var [A, C] of $.levels(e, {
              ...
              var N = false;
              if (C.length < I.length || 0 === C.length || !a && K.isElement(A) && $.isVoid(e, A)) break;
              var R = _.current,
                P = $.isEnd(e, R, C);
              if (c || !_ || !$.isEdge(e, R, C)) {
                N = true;
    ...
    delete(e) {
      ...
      $.withoutNormalizing(e, () => {
        ...
        if (s) {
          ...
          if (!eg.isCollapsed(s)) {
            if (!l) {
              var [, p] = eg.edges(s), h = $.end(e, []);
              ef.equals(p, h) || (s = $.unhangRange(e, s, {
                voids: o
              }))
            }
            var [m, g] = eg.edges(s), E = $.above(e, {
              ...
              at: g,
              voids: o
            }), y = E && b && !el.equals(E[1], b[1]), O = el.equals(m.path, g.path), v = o ? null : $.void(e, {
              at: m,
              mode: "highest"
            }), I = o ? null : $.void(e, {
              at: g,
            ...
            if (v) {
              var T = $.before(e, m);
              T && E && el.isAncestor(E[1], T.path) && (m = T)
            }
            if (I) {
              var S = $.after(e, g);
              S && b && el.isAncestor(b[1], S.path) && (g = S)
            }
            var A = [];
            for (var C of $.nodes(e, {
              ...
              var [N, R] = C;
              (!n || 0 !== el.compare(R, n)) && (!o && K.isElement(N) && $.isVoid(e, N) || !el.isCommon(R, m.path) && !el.isCommon(R, g.path)) && (A.push(C), n = R)
            }
            var P = Array.from(A, t => {
                var [, n] = t;
                return $.pathRef(e, n)
              }),
              w = $.pointRef(e, m),
            ...
            if (P.reverse().map(e => e.unref()).filter(e => null !== e).forEach(t => eY.removeNodes(e, {
                at: t,
                voids: o
              })), !I) {
              var G = D.current,
          ...
          if (o) {
            ...
            if (!(!a && $.void(e, {
              ...
              var I = [],
                ...
                A = true,
                C = false;
              for (var [N] of y) K.isElement(N) && !e.isInline(N) ? (A = false, C = true, T.push(N)) : A ? I.push(N) : S.push(N);
              var [R] = $.nodes(e, {
                at: o,
                match: t => eA.isText(t) || $.isInline(e, t),
                mode: "highest",
                voids: a
              }), [, P] = R, w = $.isStart(e, o, P), D = $.isEnd(e, o, P), x = $.pathRef(e, p && !S.length ? el.next(f) : f), L = $.pathRef(e, D ? el.next(P) : P);
              eY.splitNodes(e, {
                at: o,
                match: t => C ? K.isElement(t) && $.isBlock(e, t) : eA.isText(t) || $.isInline(e, t),
                mode: C ? "lowest" : "highest",
                always: C && (!_ || I.length > 0) && (!p || S.length > 0),
                voids: a
              });
              var j = $.pathRef(e, !w || w && D ? el.next(P) : P);
              if (eY.insertNodes(e, I, {
                  at: j.current,
                  match: t => eA.isText(t) || $.isInline(e, t),
                  mode: "highest",
                  voids: a
                }), h && !I.length && T.length && !S.length && eY.delete(e, {
                  at: f,
                  voids: a
                }), eY.insertNodes(e, T, {
                  at: x.current,
                  ...
                  mode: "highest",
                  voids: a
                }), !n.at && (S.length > 0 && L.current ? r = el.previous(L.current) : T.length > 0 && x.current ? r = el.previous(x.current) : j.current && (r = el.previous(j.current)), r)) {
                var k = $.end(e, r);
                eY.select(e, k)
              }
...
function eH(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = null != arguments[t] ? arguments[t] : {};
    t % 2 ? eF(Object(n), true).forEach(function(t) {
      o(e, t, n[t])
...
var eY = eH(eH(eH(eH({}, eP), ej), eZ), eV)