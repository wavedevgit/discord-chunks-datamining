...
function f(e) {
  ...
  return n && 0 === t.length ? <o.$jN className={p.spinner} /> : 0 === t.length ? <div className={p.emptyStateContainer}>{<o.X6q variant={"heading-xl/semibold"}>{d.intl.string(d.t["NqFP6+"])}</o.X6q>}{<o.Text variant={"text-md/normal"} color={"text-secondary"}>{d.intl.string(d.t.LhD4yM)}</o.Text>}</div> : <div className={p.container}>{b.map((e, t) => {
