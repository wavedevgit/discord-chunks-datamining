...
function b(e) {
  ...
  return t === g.oh.ACTIVITY ? (0, l.jsx)(f.Z, {
    user: r,
    currentUser: i,
    displayProfile: s,
    guildId: o,
    onClose: a
  }) : t === g.oh.MUTUAL_FRIENDS ? (0, l.jsx)(h.Z, {
    user: r,
    guildId: o,
    channelId: c,
    onClose: a
  }) : t === g.oh.MUTUAL_GUILDS ? (0, l.jsx)(j.Z, {
    user: r,
    onClose: a
  }) : t === g.oh.BOT_DATA_ACCESS ? (0, l.jsx)(d.Z, {
    user: r
  }) : t === g.oh.BOT_INFO ? (0, l.jsx)(u.Z, {
    user: r,
    currentUser: i,
    displayProfile: s,
    guildId: o,
