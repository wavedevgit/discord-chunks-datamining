...
function J(e) {
  ...
  let o = new Map;
  for (let e of t) a.set(e.id, e), o.set(e.id, (0, P.zi)(e)), e.targetedContent.includes(w.jn.QUEST_BAR) && (0, L.T)({
...
function eP() {
  ...
  }), module && (v = exports, eM.emitChange())
}
...
F();
class ex extends(T = Chunk442837.ZP.Store) {
  get quests() {
    return a
  }
  get excludedQuests() {
