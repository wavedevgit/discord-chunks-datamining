...
let T = i.memo(function(e) {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsxs)("div", {
      className: o()(O.blockedNoticeContainer, {
        [O.compact]: i
      }),
      ...
      className: o()(O.ephemeralAccessories, {
        [O.compact]: i
      }),
...
function S(e) {
  ...
  let {
    ...
    content: h,
    onUpdate: b
  } = e, S = null == (t = u.editedTimestamp) ? void 0 : t.toString(), A = i.useRef(!1), N = (0, c.e7)([_.Z], () => _.Z.getMessage(u.id), [u.id]), C = i.useCallback(() => {
  ...
  return i.useLayoutEffect(() => {
    ...
    children: [null != p ? p : (0, g.L5)(u, h), (null == N ? void 0 : N.isBlockedEdit) && null != u.timestamp && (0, r.jsxs)(r.Fragment, {
