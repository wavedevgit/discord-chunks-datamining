...
function T(e) {
  let {
    ...
    discountInfo: n,
    invoicePreview: r
  } = e, a = m.ZP.getPlanIdFromInvoice(t, r), l = d.Z.get(a);
  ...
  let c = (0, p.T4)(o.amount, r.currency),
    u = (0, m.aS)(x.Xh.PREMIUM_MONTH_TIER_2, false, false, {
      currency: t.currency,
...
function I(e) {
  ...
  } = e, r = (0, g._)(n, x.Xh.PREMIUM_MONTH_TIER_2, t);
  return (0, i.jsxs)(i.Fragment, {
    children: [(0, i.jsx)(s.X6q, {
      variant: "heading-xl/semibold",
      color: "always-white",
...
let N = function(e) {
  ...
  let D = () => {
    ...
    k = (0, h.eQ)(null == A ? true : A.expires_at);
          ...
          children: [(0, i.jsxs)("div", {
            ...
            children: [null != A ? (0, i.jsx)(I, {
              ...
              children: (() => {
                ...
                return m.ZP.isBaseSubscriptionCanceled(t) ? (0, i.jsx)(s.zxk, {
                  variant: "expressive",
                  icon: s.SrA,
                  size: "md",
