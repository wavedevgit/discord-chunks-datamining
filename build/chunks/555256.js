/** Chunk was on web.js **/
/** chunk id: 555256, original params: e,t,n (module,exports,re quire) **/
"use strict";
let r, i, a;
require.d(exports, {
  D: () => c,
...
var o = Object.defineProperty,
  ...
  c = ((i = c || {}).Closed = "close.click", i.Complete = "survey.completed", i.FeedbackClosed = "feedback.closed", i.PageChange = "page.change", i.API = "api", i.Override = "override", i),
  u = ((a = u || {}).ReplayCapture = "replay.capture", a.ReplayPaused = "replay.paused", a.ReplayResumed = "replay.resumed", a.FeedbackButtonLoaded = "feedback.button.loaded", a.SDKReady = "sdk.ready", a.SurveyAppeared = "survey.appeared", a.SurveyCloseRequested = "survey.closeRequested", a.SurveyClosed = "survey.closed", a.SurveyDimensions = "survey.dimensions", a.SurveyFadingOut = "survey.fadingOut", a.SurveyHeight = "survey.height", a.SurveyPresented = "survey.presented", a.SurveyLifeCycle = "survey.lifeCycle", a.SurveyWidth = "survey.width", a.SurveyWillClose = "survey.willClose", a.SurveyWillPresent = "survey.will.present", a.CloseSurveyOnOverlayClick = "close.survey.overlayClick", a.VisitorIDUpdated = "visitor.id.updated", a.QuestionAnswered = "question.answered", a);
let d = {
...
var E = class extends Error {
  ...
  b = class {
    ...
    constructor() {
      this.events = new Map, this.maxListeners = b.defaultMaxListeners, this.hasWarnedAboutPotentialMemoryLeak = false
    }
    ...
    addListener(e, t) {
      ...
      return this.events.set(e, n), this.maxListeners > 0 && this.listenerCount(e) > this.maxListeners && !this.hasWarnedAboutPotentialMemoryLeak && (this.hasWarnedAboutPotentialMemoryLeak = true, console.warn(new E(this, e, this.listenerCount(e)))), this
    }
    on(e, t) {
...
class T {
  constructor(e) {
    ...
    try {
      ...
      this.storage.setItem(t, t), this.storage.removeItem(t), this.isStorageAvailable = true
    } catch {
  ...
  setItemObject(e, t) {
    try {
      ...
      n instanceof Error && (n.stack = e + ": " + t, window.UserLeap.reportError("Failed to save to local storage", n))
    }
  }
  getItem(e) {
  ...
  getItemObject(e) {
    ...
    if (t) try {
      ...
      n instanceof Error && (n.stack = e + ": " + t, window.UserLeap.reportError("Failed to parse local storage", n))
    }
    return {}
  }
  removeItem(e) {
...
let N = {
  ...
  j = false,
  k = [],
  M = e => e._config && e._config.installationMethod ? e._config.installationMethod : e._gtm ? "web-gtm" : e._segment ? "web-segment" : "web-snippet",
  U = e => {
    var t;
...
let Z = async ({
  ...
  let {
    retries: n = 0,
    shouldDropOnRateLimit: r = false,
    shouldRetryRequest: i = false,
    ...a
  } = t, o = {
    url: e,
    options: a,
  ...
  er = ({
    ...
    e ? setInterval(() => {
      (async e => {
        ...
        if (t.some(e => e.values.length)) try {
          await e(JSON.stringify(t))
        } catch (e) {
          e instanceof Error && g.error("MetricsErr", {
            error: {
              message: e.message,
              name: e.name
            }
