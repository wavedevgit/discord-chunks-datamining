...
function f(e) {
  ...
  let {
    transitionState: n,
    onClose: f
  } = e, g = (0, s.e7)([d.ZP], () => d.ZP.getKeybindForAction(p.kg4.SOUNDBOARD_HOLD)), [_, y] = r.useState(null != (t = null == g ? void 0 : g.shortcut) ? t : []);
  return r.useEffect(() => (c.Z.disable(), () => {
    c.Z.enable()
  }), []), (0, i.jsxs)(o.Y0X, {
    transitionState: n,
