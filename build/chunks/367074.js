...
function C(e) {
  ...
  if (null != r && r.status === T.O0b.ENDED) {
    let e = r.endedAt,
      t = r.hasPremiumAtLeast(S.p9.TIER_2);
    if (null != e && t && i()().subtract(A, "days").isBefore(e)) returnfalse
  }
  if (null != o && o.status === T.O0b.ENDED) {
    let e = o.endedAt,
      t = o.hasPremiumAtLeast(S.p9.TIER_2);
    if (null != e && t && i()().subtract(A, "days").isBefore(e)) returnfalse
  }
  if (null != n) {
    let e = n.hasPremiumAtLeast(S.p9.TIER_2),
      t = c.default.getCurrentUser(),
      r = !!(null == n ? true : n.hasActiveTrial) && p.ZP.isPremiumExactly(t, S.p9.TIER_0),
