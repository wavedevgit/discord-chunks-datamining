...
function h(e) {
  return {
    ...
    icon: e.icon,
    openLink: t => {
      null == t || t.stopPropagation(), l.default.track(d.rMx.GAME_STORE_BUTTON_CLICKED, {
...
function m(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), l = (0, o.q)(e), m = (0, i.e7)([s.Z], () => null != l ? s.Z.getGameByName(l.name) : null), g = null != (t = (0, o.q)(null == m ? void 0 : m.id)) ? t : l, E = (0, i.e7)([c.Z], () => null != g ? c.Z.getGame(g.id) : null), b = (0, r.useMemo)(() => {
    var e, t, n;
