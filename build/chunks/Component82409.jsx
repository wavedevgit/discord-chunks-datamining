...
let k = [],
  U = {
    controller: new Chunk137317.Controller({
      value: 1,
      immediate: true
    }),
    renderBanner: false,
...
function G(e) {
  ...
  let {
    ...
    selectedFilter: h
  } = (0, E.Z)(), I = (0, s.e7)([S.Z], () => S.Z.oldestDisplayedMessageId), N = (0, s.Wu)([S.Z], () => S.Z.getInboxMessages()), w = (0, s.Wu)([y.ZP, _.Z, S.Z], () => N.filter(e => !(0, P.YH)({
    messageId: e.id,
    channelId: e.channelId,
    guildId: e.guildId,
    ReadStateStore_: y.ZP,
    GuildStore_: _.Z
  }) && !(0, P.Tj)(e, S.Z.selectedItemInfo))), D = (0, s.Wu)([y.ZP, _.Z, S.Z], () => N.filter(e => (0, P.YH)({
    messageId: e.id,
    channelId: e.channelId,
    guildId: e.guildId,
    ReadStateStore_: y.ZP,
  ...
  let {
    ...
    location: "NotificationsInboxSidebar"
  }), $ = Q === v.v8.DROPDOWN && h !== A.V5.ALL, ee = (0, A.H_)(h);
  return (0, r.jsx)("nav", {
