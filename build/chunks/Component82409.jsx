...
let k = [],
  U = {
    controller: new Chunk938288.Controller({
      value: 1,
      immediate: true
    }),
    renderBanner: false,
...
function G(e) {
  ...
  (0, p.ZP)(() => {
    ...
    let {
      ...
      let c = s[0],
        u = _.ZP.getTrackedAckMessageId(c);
      return null == u ? {
        message: null,
        isUnread: false
      } : {
        ...
        isUnread: null != (i = _.ZP.hasUnread(c)) && i
      }
    }(q, X);
    ...
    children: (0, r.jsxs)(c.y5t, {
      ...
      component: (0, r.jsx)(h.ZP, (t = L({
        ...
        children: (0, r.jsx)(c.Kqy, {
          ...
          children: Q === v.v8.DROPDOWN && !J.isGuildEntrypointEnabled && (0, r.jsx)(w.p, {})
        })
