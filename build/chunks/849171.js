...
function L(e) {
  ...
  let {
    ...
    channel: g,
    width: v
  } = e, h = v > 400 ? 2 : +(v > 300), [S] = v > 400 ? [s.EFr.SIZE_56, 56] : v > 300 ? [s.EFr.SIZE_32, 32] : [s.EFr.SIZE_24, 24], b = (0, o.Wu)([C.default, P.default], () => Array.from(i).map(e => (0, p.J)(e, P.default) ? null : C.default.getUser(e.userId)).filter(x.lm)), O = (0, o.e7)([d.ZP], () => {
    var e;
  ...
  } = (0, Z.ZP)(), _ = (0, c.O)(), I = R.ZP.getName(g.getGuildId(), g.id, null == b ? void 0 : b[0]), w = (0, E.s5)({
    userId: null == (t = C.default.getCurrentUser()) ? void 0 : t.id,
    channelId: g.id,
    application: m
  }) === E.Fw.CAN_JOIN, A = null != (n = g.getGuildId()) ? n : void 0, D = l.useId(), L = m.id, F = l.useMemo(() => ({
    channel: g,
    type: "channel"
  }), [g]), {
    submitting: k
