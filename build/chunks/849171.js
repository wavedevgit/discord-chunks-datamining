...
function L(e) {
  ...
  let {
    ...
    channel: g,
    width: v
  } = e, h = v > 400 ? 2 : +(v > 300), [S] = v > 400 ? [s.EFr.SIZE_56, 56] : v > 300 ? [s.EFr.SIZE_32, 32] : [s.EFr.SIZE_24, 24], b = (0, o.Wu)([x.default, P.default], () => Array.from(i).map(e => (0, p.J)(e, P.default) ? null : x.default.getUser(e.userId)).filter(R.lm)), O = (0, o.e7)([d.ZP], () => {
    var e;
  ...
  } = (0, j.ZP)(), Z = (0, c.O)(), I = C.ZP.getName(g.getGuildId(), g.id, null == b ? void 0 : b[0]), w = (0, E.s5)({
