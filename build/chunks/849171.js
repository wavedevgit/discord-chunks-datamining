...
function M(e) {
  ...
  let {
    ...
    channel: g,
    width: E
  } = e, h = E > 400 ? 2 : +(E > 300), [v] = E > 400 ? [u.EFr.SIZE_56, 56] : E > 300 ? [u.EFr.SIZE_32, 32] : [u.EFr.SIZE_24, 24], S = (0, o.Wu)([A.default, w.default], () => Array.from(i).map(e => (0, f.J)(e, w.default) ? null : A.default.getUser(e.userId)).filter(x.lm)), b = (0, o.e7)([c.ZP], () => {
    var e;
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(D, {
      ...
      children: S.length > 1 ? N.intl.formatToPlainString(N.t.cpe6CA, {
        username: _,
        count: S.length - 1
...
function k(e) {
  let {
    ...
    applicationId: c
  } = t, d = (0, g.Z)(), f = null != d && (0, p.p)(d.location) === u.id && d.applicationId === c, [m] = (0, _.Z)([c]), {
    url: S
  } = (0, E.Z)({
    applicationId: c,
    names: T,
  ...
  return l.useEffect(() => {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [j && null != d && (0, r.jsx)(h.Z, {
        className: C.iframe,
        embedId: (0, b.Z)(d.location.id, c)
      }), w && null != m && null != S && "" !== S ? (0, r.jsx)("img", {
        className: C.splashImage,
        alt: m.name,
        src: S
      }) : null, A && null != m && (0, r.jsx)(M, {
        width: n,
        channel: u,
        participants: t.participants,
        application: m
      }), a || w ? null : (0, r.jsx)("div", {
        className: C.clickShield
      })]
    })
  })
}