...
function D(e) {
  let {
    ...
    channelId: l,
    users: i
  } = e, a = null != t ? t : o.EFr.SIZE_32, u = (0, o.pxk)(a);
  return (0, r.jsx)(O.Z, {
    size: u,
    guildId: n,
    users: i,
...
function M(e) {
  ...
  let {
    ...
    channel: E,
    width: g
  } = e, h = g > 400 ? 2 : +(g > 300), [S] = g > 400 ? [o.EFr.SIZE_56, 56] : g > 300 ? [o.EFr.SIZE_32, 32] : [o.EFr.SIZE_24, 24], O = (0, u.Wu)([P.default, N.default], () => Array.from(i).map(e => (0, f.J)(e, N.default) ? null : P.default.getUser(e.userId)).filter(T.lm)), v = (0, u.e7)([c.ZP], () => {
    var e;
  ...
  } = (0, _.ZP)(), I = (0, s.O)(), Z = j.ZP.getName(E.getGuildId(), E.id, null == O ? void 0 : O[0]), A = (0, p.s5)({
    userId: null == (t = P.default.getCurrentUser()) ? void 0 : t.id,
    channelId: E.id,
    application: m
  }) === p.Fw.CAN_JOIN, R = null != (n = E.getGuildId()) ? n : void 0, x = l.useId(), M = m.id, L = l.useMemo(() => ({
    channel: E,
    type: "channel"
  }), [E]), {
    submitting: k
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(D, {
      ...
      children: O.length > 1 ? C.intl.formatToPlainString(C.t.cpe6CA, {
        username: Z,
        count: O.length - 1
      ...
      children: A ? (0, r.jsx)(o.zxk, {
        onClick: function(e) {
          e.stopPropagation(), null != v && (0, d.Z)({
...
function L(e) {
  ...
  } = (0, _.ZP)(I.Z.ACTIVITY_TILE), {
    applicationId: c
  } = t, d = (0, E.Z)(), f = null != d && (0, m.p)(d.location) === o.id && d.applicationId === c, [p] = (0, Z.Z)([c]), {
    url: O
  } = (0, g.Z)({
    applicationId: c,
    names: x,
    size: 1024
  }), y = !i && f, N = !f, P = !f && !i, T = (0, u.e7)([R.Z, A.Z], () => (0, b.Z)({
    LayerStore: R.Z,
  ...
  return l.useEffect(() => {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [y && null != d && (0, r.jsx)(h.Z, {
        className: w.iframe,
        embedId: (0, v.Z)(d.location.id, c)
      }), N && null != p && null != O && "" !== O ? (0, r.jsx)("img", {
        className: w.splashImage,
        alt: p.name,
        src: O
      }) : null, P && null != p && (0, r.jsx)(M, {
        width: n,
        channel: o,
        participants: t.participants,
        application: p
      }), a || N ? null : (0, r.jsx)("div", {
