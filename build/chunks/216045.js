...
function G() {
  ...
  let [et, en] = (0, x.US)([o.z.NAMEPLATE_USER_SETTINGS_MENU_NEW_BADGE]), ei = et === o.z.NAMEPLATE_USER_SETTINGS_MENU_NEW_BADGE;
  r.useEffect(() => {
    ei && en(M.L.TAKE_ACTION)
  }, [ei, en]), r.useEffect(() => () => u.Z.wait(m.W3), []);
  ...
  return s ? (0, i.jsx)(g.Z, {}) : (0, i.jsxs)(f.Gt, {
    ...
    children: [(0, i.jsx)(b.Z, {}), (0, i.jsx)(O.Z, {
      ...
      button: (0, i.jsxs)(d.gtL, {
        ...
        onClick: () => {
          var e;
          R.default.track(B.rMx.TRY_IT_OUT_PRESET_CLICKED, {
            cta_variant: "floating_action_button"
          }), null == ec || null == (e = ec.current) || e.scrollIntoView({
            behavior: "smooth"
          })
        },
