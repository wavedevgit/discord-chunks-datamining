...
function H() {
  ...
  let n = (0, l.e7)([D.default], () => {
    ...
    ei = et && !en;
  r.useEffect(() => {
    ei && (0, _.Q3)(o.z.RECENT_AVATARS_SETTINGS_MENU_NEW_BADGE, {
      forceTrack: !0
    })
  }, [ei]);
  let [er, es] = (0, j.US)([o.z.NAMEPLATE_USER_SETTINGS_MENU_NEW_BADGE]), ea = er === o.z.NAMEPLATE_USER_SETTINGS_MENU_NEW_BADGE;
  r.useEffect(() => {
    ea && es(V.L.TAKE_ACTION)
  }, [ea, es]), r.useEffect(() => () => m.Z.wait(p.W3), []);
  ...
  return s ? (0, i.jsx)(g.Z, {}) : (0, i.jsxs)(f.Gt, {
    value: $,
    children: [(0, i.jsx)(b.Z, {}), (0, i.jsx)(v.Z, {
