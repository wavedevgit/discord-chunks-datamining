...
class ec extends Chunk73800.PureComponent {
  renderSparkles() {
    ...
    return <div className={Chunk864989.sparkleContainer}><Chunk481060.Fmz importData={exports} shouldAnimate={!module} className={Chunk864989.sparkles} /></div>
  }
  renderActions() {
    return <Chunk339144.J{...es({}, this.props)} />
  }
  renderGame() {
    let {
      isStreaming: e,
    ...
    return <Chunk441248.k isStreaming={module} application={exports} game={require} onClickNotSharing={() => Chunk120356(true)} isForceShowSharingPopout={Chunk73800} setIsForceShowSharingPopout={Chunk120356} />
  }
  renderScreenshare() {
    let {
      isStreaming: e,
    ...
    return <div className={Chunk864989.gameWrapper}>{module ? <Chunk165393.Z title={Chunk120356} icon={null == exports ? true : exports.sourceIcon} /> : <Chunk194082.ZP look={Chunk194082.ZP.Looks.GRAY} size={Chunk194082.ZP.Sizes.SMALL} className={Chunk864989.liveIndicator} />}{<div className={Chunk864989.info}>{<Chunk115530.Z>{Chunk73800}</Chunk115530.Z>}{null != require && <div className={Chunk864989.perksDemoContainer}>{<Chunk481060.SrA size={"xxs"} color={Chunk436774.JX.PREMIUM_TIER_2} />}{<Chunk759198.Z className={Chunk864989.perksDemoText} variant={"text-xxs/semibold"}>{require}</Chunk759198.Z>}</div>}</div>}</div>
  }
  renderEmbeddedActivity() {
    ...
    let d = <Chunk690221.Z href={module} onClick={this.handleChannelLinkClick}><Chunk345243.Z className={Chunk864989.channel}>{Chunk481060}</Chunk345243.Z></Chunk690221.Z>,
      h = <Chunk690221.Z href={module} onClick={this.handleApplicationLinkClick}><Chunk115530.Z className={Chunk864989.underlineOnHover}>{exports.name}</Chunk115530.Z></Chunk690221.Z>,
      p = <Chunk255367.Fragment>{<Chunk925329.Z className={Chunk864989.gameIcon} game={exports} size={Chunk925329.Z.Sizes.SMALL} />}{<Chunk736409.j isForceShowSharingPopout={Chunk512722} setIsForceShowSharingPopout={a}><div className={Chunk864989.info}>{Chunk475179}{null != Chunk73800 && (0, Chunk131704.Qm)(Chunk73800.type) ? Chunk570140 : <ea timestamps={Chunk442837} />}</div></Chunk736409.j>}</Chunk255367.Fragment>;
    return <div className={Chunk864989.gameWrapper}>{Chunk925549}</div>
  }
  render() {
    let {
      canGoLive: e,
    ...
    return Chunk73800 || ((0, Chunk339144.y)(Chunk512722, a, exports) || module) && (null != require || null != exports) ? <div className={o()(Chunk864989.panel, Chunk442837)}><div className={Chunk864989.body}>{null == require || Chunk73800 && (null == Chunk120356 ? true : Chunk120356.pid) == null ? null != exports ? this.renderEmbeddedActivity() : this.renderScreenshare() : this.renderGame()}{this.renderActions()}</div></div> : null
  }
  constructor(...e) {
