...
class v extends Chunk47770.Z {
  ...
  connect(e, t, n) {
    (0, d.eJ)(h.eR.EXPERIMENT_CONFIG) || (n.experiments = true);
  ...
  constructor() {
    ...
    let b = (0, Chunk992774.zS)();
    null == (t = b.updateFieldTrial) || exports.call(b, "WebRTC-CheckReceiveTime", "Enabled"), b.setDeviceChangeCallback(this.handleDeviceChange), b.setVolumeChangeCallback(this.handleVolumeChange), b.setOnVoiceCallback(this.handleVoiceActivity), null == (n = b.setVideoInputInitializationCallback) || require.call(b, this.handleVideoInputInitialization), null == (r = b.setAudioInputInitializationCallback) || Chunk264344.call(b, this.handleAudioInputInitialization), null == (i = b.setAudioDeviceModuleErrorCallback) || i.call(b, this.handleAudioDeviceModuleErrorCallback), b.setTransportOptions({
      idleJitterBufferFlush: true,
      ducking: false
    }), null == (a = b.setNativeScreenSharePickerCallbacks) || Chunk47770.call(b, this.handleNativeScreenSharePickerUpdate, this.handleNativeScreenSharePickerCancel, this.handleNativeScreenSharePickerError), null == (c = b.setVideoCodecErrorCallback) || Chunk997545.call(b, this.handleVideoCodecErrorCallback), null == (p = b.setSystemMicrophoneModeChangeCallback) || Chunk65154.call(b, this.handleSystemMicrophoneModeChangeCallback), this.on("removeListener", this.handleRemoveListener), this.on("newListener", this.handleNewListener), null != (0, Chunk992774.zS)().getAudioSubsystem ? (0, Chunk992774.zS)().getAudioSubsystem((e, t) => {
      this.audioSubsystem = e, this.audioLayer = t
    }) : null != (0, Chunk992774.zS)().getUseLegacyAudioDevice && (this.audioSubsystem = (0, Chunk992774.zS)().getUseLegacyAudioDevice() ? Chunk149396.iA.LEGACY : Chunk149396.iA.STANDARD), null != b.pingVoiceThread && "undefined" != typeof window && "canary" === window.GLOBAL_ENV.RELEASE_CHANNEL && this.watchdogTick(), null != b.setActiveSinksChangeCallback && b.setActiveSinksChangeCallback(this.handleActiveSinksChange), null == (g = b.setLoopbackPlaybackGainMultiplier) || g.call(b, Chunk149396.Jk), null == (E = b.setVoiceFiltersFailedCallback) || E.call(b, e => this.emit(s.aB.VoiceFiltersFailed, e)), (0, Chunk734298.Z)(this), I(this)
  }
}
