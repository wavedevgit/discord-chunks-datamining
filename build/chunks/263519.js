...
function h(e) {
  ...
  } = e, I = (0, o.e7)([b.Z], () => null != j ? b.Z.get(j) : void 0, [j]), E = (0, o.e7)([O.Z], () => null != j ? O.Z.getForSKU(j) : void 0, [j]), x = null == (t = (0, o.Wu)([f.Z], () => null != j ? f.Z.getForSKU(j) : [], [j])[0]) ? void 0 : t.id, Z = (0, o.e7)([b.Z], () => null != j ? b.Z.getParentSKU(j) : void 0, [j]), w = null == Z ? void 0 : Z.bundledSkuIds, A = (0, o.Wu)([f.Z], () => {
    var e;
    return null != (e = null == w ? void 0 : w.flatMap(f.Z.getForSKU)) ? e : []
  }, [w]), k = r.useMemo(() => A.map(e => e.id), [A]), N = (0, v.KK)(null != (n = null == I ? void 0 : I.flags) ? n : 0), _ = (0, o.e7)([y.Z], () => null != l && !1 !== N && y.Z.getEntitlementsForGuild(l, !0).some(e => e.skuId === j), [N, j, l]), C = null == I ? void 0 : I.applicationId, D = (null == E ? void 0 : E.published) === !0 && (null == I ? void 0 : I.isAvailable()) === !0, {
    app: L
  } = (0, d.Rt)(C), {
