...
function y(e) {
  ...
  }, [N]), P = r.useMemo(() => R.map(e => e.id), [R]), w = (0, E.KK)(null != (n = null == S ? true : S.flags) ? n : 0), D = (0, o.e7)([g.Z], () => null != i && false !== w && g.Z.getEntitlementsForGuild(i, true).some(e => e.skuId === O), [w, O, i]), L = null == S ? true : S.applicationId, x = (null == T ? true : T.published) === true && (null == S ? true : S.isAvailable()) === true, {
    app: M
  } = (0, d.Rt)(L), {
