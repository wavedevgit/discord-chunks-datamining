...
function o() {
  ...
  return (0, Chunk54381.jsxs)(Chunk198358.Z, {
    children: [module >= 1e3 ? (0, Chunk54381.jsx)(Chunk793030.xvT, {
      variant: "display-sm",
      color: "text-primary",
      children: Chunk388032.intl.format(Chunk79046.default.Xu0QsX, {
        numHours: Math.floor(module / 60)
      })
    }) : (0, Chunk54381.jsx)(Chunk793030.xvT, {
      variant: "display-sm",
      color: "text-primary",
      children: Chunk388032.intl.format(Chunk79046.default.UZbUtl, {
        numMinutes: Math.floor(module)
      })
    }), (0, Chunk54381.jsx)(Chunk793030.xvT, {
      variant: "display-sm",
      color: "text-primary",
      children: Chunk388032.intl.format(Chunk79046.default["36PZwu"], {
        percent: 100 - exports,
