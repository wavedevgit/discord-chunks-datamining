...
function o() {
  ...
  return (0, Chunk951288.jsxs)(Chunk198358.Z, {
    children: [module >= 1e3 ? (0, Chunk951288.jsx)(Chunk793030.xvT, {
      variant: "display-sm",
      color: "text-primary",
      children: Chunk388032.intl.format(Chunk748246.default.Xu0QsX, {
      ...
      variant: "display-sm",
      color: "text-primary",
      children: Chunk388032.intl.format(Chunk748246.default.UZbUtl, {
      ...
      variant: "display-sm",
      color: "text-primary",
      children: Chunk388032.intl.format(Chunk748246.default["36PZwu"], {
        percent: exports
      })
    })]
  })
