...
function _() {
  return v([{
    ...
    label: Chunk388032.intl.string(Chunk259276.default.gMHKDJ)
  }, {
    value: Chunk531578.T_.HIGH_TTC,
    variant: Chunk531578.$7.SELF,
    label: Chunk388032.intl.string(Chunk259276.default.y06Ayn)
  }, {
    value: Chunk531578.T_.HIGH_LATENCY,
    variant: Chunk531578.$7.SELF,
    label: Chunk388032.intl.string(Chunk259276.default.y5k8Jq)
  }, {
    value: Chunk531578.T_.ROBOT_VOICE,
    variant: Chunk531578.$7.SOMEONE,
    label: Chunk388032.intl.string(Chunk259276.default.f2914v)
  }, {
    value: Chunk531578.T_.DESYNC,
    variant: Chunk531578.$7.UNSPECIFIED,
    label: Chunk388032.intl.string(Chunk259276.default["zk+QL1"])
  }, {
    value: Chunk531578.T_.CUTTING,
    variant: Chunk531578.$7.SOMEONE,
    label: Chunk388032.intl.string(Chunk259276.default.K5vYQA)
  }])
}
...
function E() {
  return v([{
    ...
    variant: Chunk531578.$7.SELF,
    label: Chunk388032.intl.string(Chunk259276.default["Bh+02d"])
  }, {
    value: Chunk531578.ct.NO_VIDEO,
    variant: Chunk531578.$7.SOMEONE,
    label: Chunk388032.intl.string(Chunk259276.default["R+wqwU"])
  }, {
    value: Chunk531578.ct.FREEZING_OR_HITCHING,
    variant: Chunk531578.$7.SOMEONE,
    label: Chunk388032.intl.string(Chunk259276.default["8I/GUL"])
  }, {
    value: Chunk531578.ct.BLURRY_OR_PIXELATED,
    variant: Chunk531578.$7.SOMEONE,
    label: Chunk388032.intl.string(Chunk259276.default.k7Idoz)
  }, {
    value: Chunk531578.ct.UNABLE_TO_ENABLE_DEVICE,
    variant: Chunk531578.$7.SELF,
    label: Chunk388032.intl.string(Chunk259276.default.QbC6La)
  }, {
    value: Chunk531578.ct.DESYNC,
    variant: Chunk531578.$7.UNSPECIFIED,
    label: Chunk388032.intl.string(Chunk259276.default.vRDE5O)
  }])
}
...
function g() {
  return v([{
    ...
    label: Chunk388032.intl.string(Chunk259276.default.PLBRzF)
  }])
}