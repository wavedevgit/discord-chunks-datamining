  ...
  try {
    ...
    function o({
      ...
      switch (e.type) {
        ...
        case "quote":
          let u = n.paragraph;
          return c(u, "paragraph"), i.createElement(t, null, e.value.lines.map((e, t) => i.createElement(u, {
            key: t,
            value: e,
            renderers: n
          }, i.createElement(s, {
        ...
        case "list":
          let o = n.listItem ?? "li";
          return i.createElement(t, e.value, e.value.items.map((e, t) => i.createElement(o, {
            key: t
          }, i.createElement(s, {
            nodes: e.content,
            renderers: n
        ...
        case "small":
          return i.createElement(t, null, i.createElement(s, {
            nodes: e.value.content,
            renderers: n
          }));
        default:
    ...
    let s = (0, i.memo)(function({
      ...
      return i.createElement(i.Fragment, null, e.map((e, t) => i.createElement(o, {
        key: t,
        node: e,
        renderers: n
      })))
