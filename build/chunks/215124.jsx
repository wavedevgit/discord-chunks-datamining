...
function m(e) {
  ...
  return null == g ? null : <div>{<l.R94 type={l.R94.Types.DESCRIPTION}>{u.intl.format(u.t.fvOn6O, {
        guildName: g.name
      })}</l.R94>}{<l.LZC size={16} />}{<l.zxk variant={"critical-primary"} text={u.intl.string(u.t.FrOFSk)} disabled={!f || x || j || v} onClick={() => {
        (0, l.ZDy)(async () => {
          let {
            default: e
