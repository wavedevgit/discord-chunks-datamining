...
function C(e) {
  ...
  return null != P && null != w ? <b.Z ref={true} channel={t} message={n} textValue={P} richValue={w} onCancel={a.Z.endEditMessage} onChange={a.Z.updateEditMessage} onConfirmDelete={s.Z.confirmDelete} saveMessage={L} validateEdit={N}>{x}</b.Z> : null
}
...
function R(e) {
  ...
  }), [m, g]), <u.ZP className={v.channelTextArea} textValue={t} richValue={n} channel={a} type={c.Ie.EDIT} onChange={s} onSubmit={e => {
      let {
        value: t
      } = e;
      return l(t)
    }} onKeyDown={d} focused={_} onFocus={m} onBlur={g} renderLeftAccessories={f} />
}
...
function P(e, t, n) {
  ...
  return n ? <C channel={o} message={i} /> : <E.ZP message={i} content={t} compact={null != a && a} />
}