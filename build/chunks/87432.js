/** Chunk was on 9452 **/
/** chunk id: 87432, original params: e,t,n (module,exports,require) **/
require.d(exports, {
  Z: () => function e(t, n, u) {
    ...
    let a = s;
    t.type === i.Jq.PANEL && (a = l(r({}, s), {
      panel: t
    })), t.type === i.Jq.CATEGORY && (a = l(r({}, s), {
      category: t
    })), t.type === i.Jq.ACCORDION && (a = l(r({}, s), {
      accordion: t
    }));
    let o = t.layout.map(t => e(t, n, u, a)).filter(e => null != e);
    return 0 !== o.length || "render" in t ? (u.register(t, a.panel, a.category, a.accordion), l(r({}, t), {
      layout: o
    })) : null
  }
});
