...
require.d(exports, {
  Z: () => function t(e, n, r) {
    ...
    let a = s;
    e.type === i.Jq.SIDEBAR_ITEM && (a = u(l({}, s), {
      panel: e.layout[0]
    })), e.type === i.Jq.PANEL && (a = u(l({}, s), {
      panel: e
    })), e.type === i.Jq.CATEGORY && (a = u(l({}, s), {
      category: e
    })), e.type === i.Jq.ACCORDION && (a = u(l({}, s), {
      accordion: e
    }));
    let o = e.layout.map(e => t(e, n, r, a)).filter(t => null != t);
    return 0 !== o.length || "render" in e || e.type === i.Jq.SIDEBAR_ITEM && "onClick" in e ? (r.register(e, a.panel, a.category, a.accordion), u(l({}, e), {
      layout: o
    })) : null
  }
});
