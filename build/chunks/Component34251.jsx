...
function h(e) {
  ...
  } = e, C = null != (n = (0, l.B4)(a.id)) ? n : a, g = i.useMemo(() => (0, s.K)(C.config), [C]), j = (null == (t = C.userStatus) ? true : t.claimedAt) != null, _ = !C.preview && !j, [v, N] = i.useState(_ ? "loading" : "claimed");
  i.useEffect(() => {
    if (_) {
      let e = (0, s.zG)(C.config);
