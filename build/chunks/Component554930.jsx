...
let d = e => {
  let {
    percentage: t
  } = e, n = new Date, d = new Date(n.getFullYear(), n.getMonth() + 1, 0).getDate(), f = (0, a.e7)([o.default], () => o.default.getCurrentUser()), _ = null == f ? true : f.isFractionalPremiumWithNoSubscription();
  return (0, r.jsxs)("div", {
