...
n.d(t, {
  ...
  mD: () => W,
  tS: () => H
}), n(388685), n(35282), n(704826), n(415506), n(49124), n(539854);
...
let I = window.DiscordNative,
  ...
  P = null,
  w = {};
null != I && (C = I.remoteApp.getVersion().split(".").map(e => parseInt(e)), P = null == (r = (i = I.remoteApp).getModuleVersions) ? void 0 : r.call(i), R = null == (a = (o = I.remoteApp).getBuildNumber) ? void 0 : a.call(o));
...
let z = {
    ...
    setBadge(e) {
      if ("darwin" === (0, h.getPlatformName)()) {
        let t = ""; - 1 === e ? t = "•" : e > 0 && (t = "".concat(e)), I.remoteApp.dock.setBadge(t)
    ...
    makeChunkedRequest(e, t, n) {
      ...
      for (let e = 0; e < _; e++) {
        let t = e * d;
        f[e] = c.substring(t, t + d)
      }
      return new Promise((e, t) => {
        null != I.http && I.http.makeChunkedRequest(r, f, {
          method: i,
          chunkInterval: s,
          contentType: l,
          token: o
