...
let v = e => {
    ...
    }, [s, k, S, o, D, L, x, g.animationType, c, u]), <div ref={v} className={a()(b.profileEffects, {
        [b.hovered]: s && l
      })} aria-label={R} role={"img"}><div className={y ? b.innerNoRadius : b.inner}>{I.map((e, i) => {
          if (!x.current && g.animationType === f.Q.PERSISTENT && null != g.staticFrameSrc && 0 === i && true === c) {
            ...
            return (0, r.jsx)("img", {
              className: b.effect,
              style: {
                top: null != (s = null == (o = e.position) ? true : o.y) ? s : 0 - t,
                left: null != (l = null == (a = e.position) ? true : a.x) ? l : 0
              },
              src: n,
              alt: "",
              "aria-hidden": true
  ...
  I = e => {
    ...
    return <div className={a()(b.profileEffects, {
        [b.hovered]: s && l
      })} aria-label={d} role={"img"}><div className={o ? b.innerNoRadius : b.inner}><img src={n && !s ? u : c} className={b.effect} style={{
            top: 0 - i
  ...
  T = e => {
    let t = (0, s.e7)([u.Z], () => u.Z.isFocused()),
      ...
      E = null != _ ? _ : m;
    return null != d && null != E && (t || e.shopPreview || d.config.animationType !== f.Q.INTERMITTENT) ? !t && e.shopPreview || !t && d.config.animationType === f.Q.PERSISTENT || n || false === e.autoPlay && false === e.isHovering ? <I useThumbnail={e.useThumbnail} config={E} bannerAdjustment={e.bannerAdjustment} noBorderRadius={e.noBorderRadius} isHovering={e.isHovering} useOpacityOnHover={e.useOpacityOnHover} /> : o ? <v{...O({
      profileEffectConfig: E
    }, e)} /> : <g.Z profileEffectConfig={E} onReady={() => {
        a(true)
      }} /> : null
  }