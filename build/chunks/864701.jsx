/** Chunk was on 67544 **/
/** chunk id: 864701, original params: e,t,n (module,exports,require) **/
require.d(exports, {
  Z: () => P
}), require("./539854.js");
var Chunk255367 = require("./255367.js"),
  ...
  Chunk658865 = require("./658865.js"),
  Chunk420893 = require("./420893.js"),
  Chunk682980 = require("./682980.js"),
  Chunk161829 = require("./161829.js");
let Chunk742914 = require("./742914.js"),
  y = [0, 1, 2, 3],
  h = {
    0: 0,
    3: 16,
...
function P(e) {
  let {
    ...
    for (let n = m.current.length - 1; n >= 0; n--)
      if (0 === n) {
        var e, t;
        let r = null != (e = 0 === (t = m.current[n]).x && t.y <= 0 ? 3 : 23 === t.x && t.y >= 14 ? 2 : t.x <= 0 && 14 === t.y ? 0 : t.x >= 23 && 0 === t.y ? 1 : true) ? e : m.current[n].direction,
          s = function(e, t) {
            switch (t) {
              case 0:
                return {
    ...
    var e;
    let t = null == (e = n.current) ? true : e.getContext("2d");
  ...
  return (0, l.Z)({
    ...
    onInterval: S,
    interval: 1e3
  }), <canvas ref={n} className={f.canvas} width={422.4} height={278.4} />
}
N.src = Chunk682980.Z