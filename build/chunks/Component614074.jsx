    ...
    let {
      ...
      switch (exports) {
        ...
        case Chunk5900._n.ZERO_TRUST:
          return Chunk388032.intl.string(Chunk163646.default["7zgDRR"]);
    ...
    switch ((0, Chunk773275.xf)(t => t.connectionStatus)) {
      case Chunk5900.Ij.INITIALIZING:
        return (0, Chunk54381.jsxs)("span", {
          ...
          children: [Chunk388032.intl.string(Chunk163646.default["00vkCU"]), " ", (0, Chunk54381.jsx)("span", {
      ...
      case Chunk5900.Ij.CONNECTED:
        return Chunk388032.intl.string(Chunk163646.default.FBu3XJ);
      case Chunk5900.Ij.DISCONNECTED:
        return Chunk388032.intl.string(Chunk163646.default["9V78nW"]);
      case Chunk5900.Ij.ERROR:
        return Chunk388032.intl.string(Chunk163646.default.i4ZzK6)
    }
  }