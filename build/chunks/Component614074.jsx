...
let S = () => {
    let {
      ...
      if (module) return Chunk388032.intl.string(Chunk665525.default.KN6HOb);
      switch (exports) {
        case Chunk5900._n.ERROR:
          return Chunk388032.intl.string(Chunk665525.default.cjqyz7);
        case Chunk5900._n.INSTALLING_TIMEOUT:
          return Chunk388032.intl.string(Chunk665525.default.an5PuY);
        case Chunk5900._n.NOT_INSTALLED:
        case Chunk5900._n.UNKNOWN:
          return Chunk388032.intl.string(Chunk665525.default.KN6HOb);
        case Chunk5900._n.INSTALLING:
          return Chunk388032.intl.string(Chunk665525.default.lYWqUK);
        case Chunk5900._n.WAITING_FOR_TERMS:
        case Chunk5900._n.READY_FOR_LICENSE:
          return Chunk388032.intl.string(Chunk665525.default.NSVz3Y);
        case Chunk5900._n.EXISTING_INSTALLATION:
          return Chunk388032.intl.string(Chunk665525.default.FgL0HB);
        case Chunk5900._n.ZERO_TRUST:
          return Chunk388032.intl.string(Chunk665525.default["7zgDRR"]);
    ...
    switch ((0, Chunk773275.xf)(t => t.connectionStatus)) {
      case Chunk5900.Ij.INITIALIZING:
        return (0, Chunk54381.jsxs)("span", {
          ...
          children: [Chunk388032.intl.string(Chunk665525.default["00vkCU"]), " ", (0, Chunk54381.jsx)("span", {
      ...
      case Chunk5900.Ij.CONNECTED:
        return Chunk388032.intl.string(Chunk665525.default.FBu3XJ);
      case Chunk5900.Ij.DISCONNECTED:
        return Chunk388032.intl.string(Chunk665525.default["9V78nW"]);
      case Chunk5900.Ij.ERROR:
        return Chunk388032.intl.string(Chunk665525.default.i4ZzK6)
    }
  }