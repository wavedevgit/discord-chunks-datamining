...
function g(e) {
  ...
  let A = i.useMemo(() => y || v ? <div className={a()(m.container, m.spinnerContainer)}><l.$jN /></div> : O || I || null == E || null == b ? <div className={m.container}><p.Z name={n} onRetry={S} /></div> : <div className={m.container}><h.ZP application={E} detectedGame={b} onClose={g} /></div>, [y, v, O, I, E, b, n, S, g]);
  return <l.VqE ref={T} aria-label={null == E ? true : E.name}>{A}</l.VqE>
}