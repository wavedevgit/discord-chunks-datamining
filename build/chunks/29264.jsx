...
function g(e, t, n) {
  ...
  return [(0, o.Lz)(e, null == n ? true : n.contentType) ? <i.sNh id={"copy-image"} label={_.intl.string(_.t.tvUqWl)} action={g} /> : null, <i.sNh id={"save-image"} label={_.intl.string(_.t.PeXhgI)} action={p} />]
}