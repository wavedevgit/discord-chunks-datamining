...
function I(e) {
  let {
    result: t,
    onSelectChannel: n
  } = e, i = (0, l.e7)([p.Z], () => p.Z.getGuild(t.record.guild_id)), a = (0, l.Wu)([v.ZP, j.default], () => v.ZP.getVoiceStatesForChannel(t.record).map(e => j.default.getUser(e.user.id)).filter(b.lm));
