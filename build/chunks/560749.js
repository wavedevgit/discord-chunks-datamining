...
function N(e) {
  let {
    result: t,
    onSelectChannel: n
  } = e, l = (0, o.e7)([_.Z], () => _.Z.getGuild(t.record.guild_id)), i = (0, o.Wu)([b.ZP, S.default], () => b.ZP.getVoiceStatesForChannel(t.record).map(e => S.default.getUser(e.user.id)).filter(C.lm));
...
function E(e) {
  let {
    ...
    return [...b.toSorted((t, n) => e.has(t.id) && !e.has(n.id) ? -1 : e.has(n.id) && !e.has(t.id) ? 1 : 0).map(e => (0, d.Z)(e.id)).filter(C.lm), ...E.filter(e => !t.has(e.id)).map(e => (0, d.Z)(e.id)).filter(C.lm)]
  }, [E, b]), R = "" !== u ? S : P;
  return (0, r.jsxs)("div", {
