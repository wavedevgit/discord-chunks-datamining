...
function E(e) {
  ...
  switch (E) {
    case C.ZI.DISPLAY:
      t = <v.ZP guild={T} role={P} locked={Z} highestRole={R} setSelectedSection={S} />;
      break;
    case C.ZI.PERMISSIONS:
      t = <O.ZP guild={T} role={P} locked={Z} setSelectedSection={S} initialSearchQuery={w} />;
      break;
    case C.ZI.VERIFICATIONS:
      t = <j.Z guild={T} role={P} locked={Z} setSelectedSection={S} integrations={null != A ? A : true} />;
      break;
    case C.ZI.MEMBERS:
      t = <_.ZP guild={T} role={P} locked={Z} setSelectedSection={S} />;
      break;
    default:
      (0, p.vE)(E)
  }
  return <o.hjN className={I.page}>{<y.Z guild={T} currentRoleId={n} setCurrentRoleId={l} setSelectedSection={S} />}{<div className={I.contentContainer} ref={D}><o.JcV containerRef={D}>{t}</o.JcV></div>}</o.hjN>
}