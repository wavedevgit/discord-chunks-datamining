...
function u(e) {
  ...
  return <d.Provider value={a}>{t(n)}</d.Provider>
}
u.Toggle = function(e) {
  let {
    className: t,
  ...
  return <l.P3F className={a()(c.toggle, t)} onClick={u}>{<l.Text variant={"heading-sm/semibold"} tag={"div"} color={"currentColor"}>{p}</l.Text>}{<m size={"sm"} color={"currentColor"} />}</l.P3F>
}