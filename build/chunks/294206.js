...
function Z(e) {
  let {
    sound: t,
    disabled: n = !1
  } = e, a = (0, l.e7)([O.Z], () => O.Z.isFavoriteSound(t.soundId), [t.soundId]), s = i.useCallback(e => {
...
let Y = i.forwardRef(function(e, t) {
  ...
  let {
    ...
    emojiId: ef,
    emojiName: e_
  } = D, ep = (0, l.e7)([b.default], () => b.default.getCurrentUser()), eh = (0, T.z)(D, null == k ? void 0 : k.guild_id), {
    playSoundboardSound: em,
    previewSound: eg,
    isPlayingSound: eE
  } = (0, S.Z)(D, null != (u = null == k ? void 0 : k.id) ? u : null, null != (y = ea ? E.AY.getSetting() : null == (n = E.kU.getSetting()) ? void 0 : n.volume) ? y : 100, !ea && (null == k ? void 0 : k.isVocal()) ? N.w.VOICE : N.w.DEFAULT), {
    createMultipleConfettiAt: eb
  } = i.useContext(p.h), ey = i.useRef(null), eO = H(D.soundId, ey.current), ev = (0, l.e7)([_.Z], () => _.Z.useReducedMotion), eI = i.useRef(j), eS = i.useRef(new c.Xp), eT = D.soundId === M, eA = "sound-".concat(D.soundId), eN = (0, s.JA)(eA), eC = null != ef || null != e_, eP = !(0, I.Nq)(ep, D, k) && !ea, eR = K || q && !eP, ew = null != (O = h.Wq.useStore().bottomPosition) ? O : 0, eD = (null != (R = null == (a = ey.current) ? void 0 : a.getBoundingClientRect().bottom) ? R : 0) + 50 > ew ? "top" : "bottom", [eL, ex] = i.useState(!1), ek = eP && et;
  ...
  function ej(e) {
    if (eT && !ev && (eI.current = Math.min(eI.current + G, U), Math.random() < eI.current && eb(eO.x, eO.y, void 0, void 0, {
        sprite: A.vv
  ...
  let eU = V({
    ...
    eG = e => Q || eP ? ek ? (0, r.jsx)(d.mBM, {
      size: "xs",
      color: "currentColor",
      className: o()(P.primaryIcon, P.lockIcon, e, {
        [P.hasEmoji]: eC
      })
    }) : null : (0, r.jsx)(d.o1U, {
      size: "xs",
    ...
    eF = () => ek && !en ? (0, r.jsxs)(r.Fragment, {
      ...
      }), eG(P.primaryIconTopLevel), (0, r.jsx)("div", {
  ...
  return (0, r.jsxs)("li", {
    ...
    children: [(0, r.jsx)(d.ua7, {
      ...
      shouldShow: !eL,
      delay: 500,
      children: e => (0, r.jsxs)(d.kL8, L(w(L(w({}, eu), {
        buttonProps: L(w({}, eN), {
          id: eA,
          role: "button"
        }),
