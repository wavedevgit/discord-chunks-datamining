...
function C(e) {
  let {
  ...
  } = e, B = t === E.ME ? void 0 : t, G = (0, g.ZP)(n.id, B), k = f.ZP.getName(B, C, n), {
    analyticsLocations: V
  } = (0, c.ZP)([...D, a.Z.USER_PROFILE_MODAL]), Y = (0, p.ZB)({
    layout: "MODAL",
    userId: n.id,
    sourceSessionId: M,
    guildId: B,
    ...
    messageId: _,
    roleId: w
  }), F = r.useRef(null), z = (0, s.Z)(F), W = (0, i.e7)([d.default], () => ["en-US", "en-GB"].includes(d.default.locale)) ? S.intl.formatToPlainString(S.t.KRe1Fh, {
    name: k
  }) : S.intl.string(S.t["3N/J2t"]);
  return (0, l.jsx)(c.Gt, {
    value: V,
    children: (0, l.jsx)(p.Mt, {
      ...
      children: (0, l.jsxs)(o.Y0X, {
        ...
        }), (null == G ? void 0 : G.profileEffectId) != null && (0, l.jsx)(u.Z, {
