...
let h = o.memo(function(e) {
  ...
  let {
    ...
    contentRef: b,
    compact: h
  } = e, T = i.state === m.yb.SEND_FAILED, y = i.state === m.yb.SENDING, C = i.isCommandType(), v = null == (t = i.editedTimestamp) ? void 0 : t.toString(), x = o.useRef(!1);
  return o.useLayoutEffect(() => {
    x.current ? null != p && p() : x.current = !0
  }, [p, i.content, s, v, c]), (0, a.jsxs)("div", {
    id: (0, u.ut)(i),
    ref: b,
