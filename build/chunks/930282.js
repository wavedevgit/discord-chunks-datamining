...
let h = o.memo(function(e) {
  ...
  let {
    ...
    onUpdate: b,
    contentRef: h
  } = e, y = a.isEdited(), v = a.state === p.yb.SEND_FAILED, O = a.state === p.yb.SENDING, x = a.isCommandType(), j = null == (t = a.editedTimestamp) ? void 0 : t.toString(), C = o.useRef(!1);
  return o.useLayoutEffect(() => {
    C.current ? null != b && b() : C.current = !0
  }, [b, a.content, l, j, s]), (0, r.jsxs)("div", {
    id: (0, u.ut)(a),
    ref: h,
