...
let _ = o.memo(function(e) {
  ...
  let {
    ...
    contentRef: h,
    compact: _
  } = e, y = a.state === p.yb.SEND_FAILED, v = a.state === p.yb.SENDING, O = a.isCommandType(), j = null == (t = a.editedTimestamp) ? void 0 : t.toString(), x = o.useRef(!1);
  return o.useLayoutEffect(() => {
    x.current ? null != g && g() : x.current = !0
  }, [g, a.content, c, j, l]), (0, r.jsxs)("div", {
    id: (0, u.ut)(a),
    ref: h,
    ...
    children: [null != l ? l : b(a, c), (0, r.jsx)(d.Z, {
      message: a,
      compact: _,
