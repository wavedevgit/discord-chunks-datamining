...
function o(e) {
  ...
  return e.size < a ? (r.verbose("[WebP] File too small: ".concat(e.size, " < ").concat(a)), {
    should: !1,
    reason: "file_too_small"
  }) : "image/webp" === e.type ? (r.verbose("[WebP] File already WebP format"), {
    should: !1,
    reason: "already_webp"
...
async function s(e) {
  ...
  try {
    ...
    try {
      ...
      }), c.width = d.width, c.height = d.height, u.drawImage(d, 0, 0)
    } finally {
