...
function x(e) {
  ...
  }) : null != M && null != x && f.Z.can(g.Plq.CREATE_INSTANT_INVITE, x) ? (0, r.jsx)(m.Z, _({
    onClick: () => {
      l()(null != M, "guild cannot be null"), l()(null != x, "channel cannot be null"), null != w && (0, d.v)(w, d.d.INVITE),
        function(e) {
          let {
            guild: t,
            channel: i,
