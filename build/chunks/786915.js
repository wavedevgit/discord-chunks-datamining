...
function y(e) {
  ...
  if (null != k && E) {
    ...
    return T === g.IlC.APP ? (0, r.jsx)(m.d, {
      onClick: e,
      iconComponent: M,
      label: L,
      themeable: !0
  ...
  return null != R && null != y && f.Z.can(g.Plq.CREATE_INSTANT_INVITE, y) ? (0, r.jsx)(m.Z, _({
    onClick: () => {
      l()(null != R, "guild cannot be null"), l()(null != y, "channel cannot be null"), null != A && (0, d.v)(A, d.d.INVITE),
        function(e) {
          let {
            guild: t,
            channel: i,
