...
let S = [I.O0b.PAST_DUE, I.O0b.PAUSED, I.O0b.BILLING_RETRY],
  R = e => {
    ...
    let {
      ...
      initialStep: M
    } = e, U = i.useRef(new a.qA), [B, Z] = i.useState(null), z = null == (t = (0, _.Af)(A)) ? void 0 : t.planId, F = null != z ? _.ZP.getPremiumType(z) : null;
    ...
    let [H, W, X, q] = (0, v.q)(M, A, w), V = (0, m.Q)(), G = (0, x.UV)(), {
    ...
    } = (0, x.WR)(!G || H !== E.R.WHAT_YOU_LOSE), Q = (0, y._)(A, N.Xh.PREMIUM_MONTH_TIER_2, K), [$] = (0, b.ED)({
      subscriptionId: A.id,
      items: (0, _.Ue)(null != (s = null == (n = A.renewalMutations) ? void 0 : n.items) ? s : A.items),
      renewal: !0,
      analyticsLocations: w,
      analyticsLocation: u.Z.CANCEL_INVOICE_PREVIEW
    }), ee = null !== $ ? _.ZP.getIntervalForInvoice($) : null, et = (0, _.aS)(N.Xh.PREMIUM_MONTH_TIER_2, !1, !1, {
      currency: A.currency,
      paymentSourceId: A.paymentSourceId
    }), en = (0, f.T4)(et.amount, et.currency), er = e => {
      ...
      if (S.includes(A.status)) await (0, c.EO)(A.id, w, R);
        ...
        await (0, c.Mg)(A, {
          ...
          amount: 0,
          currency: A.currency
        }, (0, _.UX)(r, A.currency, A.paymentSourceId), w, R)
      }
    }, [A, w, R]), es = i.useCallback(async () => {
