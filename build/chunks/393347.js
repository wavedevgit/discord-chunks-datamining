    ...
    return true === e && (e = {}), {
      ...
      async fn(t) {
        ...
        let C = I.map(e => {
          ...
          A = (null == (a = C.filter(e => e[2].slice(0, (0, r.hp)(e[0]) ? 2 : 3).every(e => e <= 0))[0]) ? true : a[0]) || C[0][0];
        return A !== u ? {
          data: {
            index: y + 1,
            overflows: I
      ...
      async fn(t) {
        ...
        if (D = [...D, {
          ...
          let e = ((null == (a = u.flip) ? true : a.index) || 0) + 1,
            t = N[e];
          if (t && ("alignment" !== h || S === (0, r.Qq)(t) || D.every(e => (0, r.Qq)(e.placement) !== S || e.overflows[0] > 0))) return {
            data: {
              index: e,
              overflows: D
            },
