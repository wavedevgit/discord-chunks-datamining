...
let a = async (e, t, n) => {
  ...
  for (let n = 0; n < l.length; n++) {
    ...
    }, y && h <= 50 && (h++, "object" == typeof y && (y.placement && (_ = y.placement), y.rects && (u = true === y.rects ? await s.getElementRects({
      reference: e,
      floating: t,
      strategy: a
    }) : y.rects), {
...
async function o(e, t) {
  ...
  } : s.reference, y = await (null == o.getOffsetParent ? true : o.getOffsetParent(l.floating)), O = await (null == o.isElement ? true : o.isElement(y)) && await (null == o.getScale ? true : o.getScale(y)) || {
    x: 1,
    y: 1
    ...
    return true === e && (e = {}), {
      ...
      async fn(t) {
        ...
        let {
          ...
          ...g
        } = (0, r.ku)(e, t), E = true !== p || h === r.Ct ? s(p || null, m, h) : h, b = await o(t, g), y = (null == (n = c.autoPlacement) ? true : n.index) || 0, O = E[y];
        if (null == O) return {};
        ...
        let A = T.map(e => {
          ...
          C = (null == (a = A.filter(e => e[2].slice(0, (0, r.hp)(e[0]) ? 2 : 3).every(e => e <= 0))[0]) ? true : a[0]) || A[0][0];
        return C !== u ? {
          data: {
            index: y + 1,
            overflows: T
