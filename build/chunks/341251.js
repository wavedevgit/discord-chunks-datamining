...
let s = RegExp(`(?:on\\s{0,3})?(${Chunk360345.lT})(?:\\s{0,3}(?:to|\\-|\\–|until|through|till)?\\s{0,3}(${Chunk360345.lT}))?(?:-|/|\\s{0,3}(?:of)?\\s{0,3})(${(0,Chunk476858.uJ)(Chunk360345.eB)})(?:(?:-|/|,?\\s{0,3})(${Chunk360345.fp}(?!\\w)))?(?=\\W|$)`, "i"),
  l = 1,
  c = 2,
  u = 3,
  d = 4;
