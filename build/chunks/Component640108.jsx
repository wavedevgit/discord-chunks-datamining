...
class X extends(r = Chunk73800.Component) {
  ...
  render() {
    ...
    return (0, Chunk255367.jsxs)(Chunk748780.Z.div, {
      className: Chunk70097 === Y.VIDEO ? Chunk55343.videoControls : Chunk55343.audioControls,
...
class et extends(i = Chunk73800.PureComponent) {
  ...
  updateControlsVisibility() {
    let {
      dragging: e,
      fullscreen: t
    } = this.state, n = exports ? F : V, r = Math.max(0, Date.now() - this._lastMove) > require;
  ...
  render() {
    ...
    if (exports === Y.AUDIO ? h = Chunk55343.wrapperAudio : Chunk374470 ? h = Chunk55343.wrapperControlsHidden : Chunk283693 && (h = Chunk55343.wrapperPlaying), r && exports === Y.VIDEO) {
      let t = this.getWidth();
  ...
  constructor(e) {
    var t, n;
    super(e), t = this, j(this, "_unmounted", false), j(this, "_lastMove", 0), j(this, "_analytics", true), j(this, "mediaRef", o.createRef()), j(this, "controlsRef", o.createRef()), j(this, "playPausePopRef", o.createRef()), j(this, "handleFullScreenExit", () => {
      let {
        current: e
      } = this.mediaRef;
      if (null == e) return;
