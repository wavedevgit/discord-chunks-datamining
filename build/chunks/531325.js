/** Chunk was on web.js **/
/** chunk id: 531325, original params: e (module,exports,re quire) **/
if (!t) var t = {
  map: function(e, t) {
    var n = {};
...
module.exports = function() {
  ...
  return o.prototype = {
    ...
    nearest: function(e) {
      for (var t, n, r, i = this.vboxes, a = 0; a < i.size(); a++)((n = Math.sqrt(Math.pow(e[0] - i.peek(a).color[0], 2) + Math.pow(e[1] - i.peek(a).color[1], 2) + Math.pow(e[2] - i.peek(a).color[2], 2))) < t || true === t) && (t = n, r = i.peek(a).color);
      return r
    },
    forcebw: function() {
      var e = this.vboxes;
