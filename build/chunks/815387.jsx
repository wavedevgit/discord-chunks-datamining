...
function ek(e) {
  let {
    ...
    id: s,
    author: l
  } = t, u = j.default.getId(), d = t.getChannelId(), f = (0, o.e7)([U.Z], () => U.Z.isCallActive(d, s), [d, s]), _ = (0, o.e7)([Y.Z], () => Y.Z.getVoiceState(eC.ME, u)), p = !f && null != t.call && !t.call.participants.includes(u), h = f && (null == _ || _.channelId !== d), m = i.useCallback(() => c.default.selectVoiceChannel(d), [d]), g = (0, et.l)({
    user: l,
    channelId: d,
    guildId: a.guild_id,
    messageId: t.id
  });
  return <er.Z compact={n} message={t} missed={p} joinable={h} usernameHook={g} onClickJoinCall={m} />
}
...
function ej(e) {
  let {
    ...
    author: o
  } = t, a = t.getChannelId(), s = (0, et.l)({
    user: o,
    channelId: a,
    guildId: i.guild_id,
    messageId: t.id
  });
  return <es.Z compact={n} message={t} usernameHook={s} isForumPost={i.isForumPost()} />
}
...
function eU(e) {
  ...
  return <eo.Z compact={n} message={t} usernameHook={s} />
}
...
function eG(e) {
  ...
  return <el.Z message={t} compact={n} usernameHook={c} onClickPins={__OVERLAY__ ? null : l} />
}
...
function eB(e) {
  let {
    ...
    author: a
  } = t, s = t.getChannelId(), l = (0, o.e7)([H.default], () => H.default.getUser(t.mentions[0]), [t]), c = K.ZP.getName(null, s, l), u = (0, et.l)({
    user: a,
    channelId: s,
    guildId: n.guild_id,
    messageId: t.id
  ...
  return n.isThread() ? <eI.Z message={t} channel={n} compact={i} targetUser={l} actorUsernameHook={u} targetUsernameHook={d} /> : <eh.Z message={t} compact={i} otherUsername={c} usernameHook={u} otherUsernameHook={d} />
}
...
function eZ(e) {
  let {
    ...
    var i;
    let o = G.Z.getChannel(null == (i = t.messageReference) ? true : i.channel_id);
    null != o && (0, s.jW)(e, async () => {
      let {
        default: e
  ...
  return <ev.Z message={t} compact={l} usernameHook={c} onClickThread={u} onClickViewThreads={d} onContextMenuThread={f} />
}
...
function eF(e) {
  let {
    ...
    author: a
  } = t, s = t.getChannelId(), l = (0, o.e7)([H.default], () => H.default.getUser(t.mentions[0]), [t]), c = (0, et.l)({
    user: a,
    channelId: s,
    guildId: n.guild_id,
    messageId: t.id
  ...
  return n.isThread() ? <eT.Z message={t} channel={n} compact={i} targetUser={l} actorUsernameHook={c} targetUsernameHook={u} /> : null != l && l.id !== a.id ? <em.Z message={t} channel={n} compact={i} usernameHook={c} otherUser={l} otherUsernameHook={u} /> : <em.Z message={t} channel={n} usernameHook={c} />
}
...
function eV(e) {
  ...
  return <r.Fragment>{<eA.Z message={t} compact={n} usernameHook={s} />}{<k.f channel={i} message={t} />}</r.Fragment>
}
...
function eH(e) {
  let {
    ...
    guild_id: l
  } = n, c = t.getChannelId(), u = (0, o.e7)([B.Z], () => B.Z.getGuild(l), [l]), d = i.useCallback(() => {
    null != u && (0, b.f)({
      guildId: u.id,
      location: {
  ...
  return <eN.ZP message={t} compact={a} guild={u} usernameHook={f} onClickMessage={d} />
}
...
function eY(e) {
  ...
  return <ei.Z message={t} compact={n} usernameHook={s} />
}
...
function eW(e) {
  let {
    ...
    messageReference: c
  } = t, d = t.getChannelId(), f = (0, o.e7)([F.Z], () => F.Z.findActivity(l, e => e.type === eC.IIU.PLAYING), [l]), _ = (0, o.e7)([G.Z], () => null != c ? G.Z.getChannel(c.channel_id) : null, [c]), p = null == c ? true : c.guild_id, h = (0, et.l)({
    user: s,
    channelId: d,
    guildId: a.guild_id,
    messageId: t.id
  ...
  return null != c && null != _ && null != c.guild_id ? <e_.Z message={t} compact={n} channel={_} playingActivity={f} onJoinStream={m} usernameHook={h} /> : null
}
...
function eK(e) {
  let {
    message: t,
    compact: n
  } = e, i = t.getChannelId(), a = (0, o.e7)([G.Z], () => G.Z.getChannel(i), [i]), s = null != a ? a.getGuildId() : null, l = () => {
    null != s && S.Z.open(s, eC.pNK.ACCESS, eC.KsC.ACCESS_DISCOVERABLE)
  };
  return <eu.FJ message={t} compact={n} onClick={l} />
}
...
function ez(e) {
  ...
  return (0, E.nY)(t) ? <en.Z message={t} compact={n} channel={i} /> : null
}
...
function eq(e) {
  ...
  return <ec.Z message={t} compact={n} usernameHook={o} />
}
...
function eX(e) {
  ...
  return <ef.Z message={t} compact={n} channel={i} usernameHook={o} />
}
...
function eQ(e) {
  ...
  return <ed.Z message={t} compact={n} channel={i} usernameHook={o} />
}
...
function eJ(e) {
  ...
  return <r.Fragment>{<ey.Z message={t} compact={i} usernameHook={a} />}{null != s && s.name === t.content ? <T.Z code={"".concat(n.guild_id, "-").concat(s.id)} /> : null}</r.Fragment>
}
...
function e$(e) {
  ...
  return <eg.Z message={t} compact={i} usernameHook={o} />
}
...
function e0(e) {
  ...
  return <eO.Z message={t} compact={i} usernameHook={o} />
}
...
function e1(e) {
  ...
  return <eb.Z message={t} compact={i} usernameHook={o} />
}
...
function e2(e) {
  ...
  let {
    ...
    guildId: s.guild_id,
    messageId: i.id
  }), d = (0, o.e7)([Z.Z], () => Z.Z.can(eC.Plq.MUTE_MEMBERS, s)), f = () => {
    (0, w.DT)(s, i.author.id, false), l.Z.deleteMessage(s.id, i.id, true)
  }, _ = (0, o.e7)([D.Z], () => D.Z.getParticipant(s.id, i.author.id)), p = new Date(q.default.extractTimestamp(i.id)).toISOString() === new Date(null != (n = null == _ || null == (t = _.voiceState) ? true : t.requestToSpeakTimestamp) ? n : 0).toISOString(), h = d && (null == _ ? true : _.rtsState) === L.xO.REQUESTED_TO_SPEAK && p;
  return <r.Fragment>{<eE.Z message={i} compact={c} usernameHook={u} />}{h ? <a.zxk variant={"secondary"} onClick={f} text={eP.intl.string(eP.t.f0T7hI)} icon={a.Lrb} /> : null}</r.Fragment>
}
...
function e3(e) {
  ...
  return <_.Z message={t} channel={n} compact={i} />
}
...
function e5(e) {
  ...
  return <f.Z message={t} channel={n} compact={i} />
}
...
function e4(e) {
  ...
  return (null == (t = n.purchaseNotification) ? true : t.type) === d.Eh.GUILD_PRODUCT ? <O.Z message={n} channel={i} compact={o} /> : null
}
...
function e6(e) {
  ...
  return <J.Z message={t} channel={n} compact={i} />
}
...
function e8(e) {
  ...
  return <ee.Z message={t} channel={n} />
}
...
function e7(e) {
  let {
    message: t,
    channel: n
  } = e, i = t.giftingPrompt, a = (0, o.e7)([H.default], () => H.default.getUser(null == i ? true : i.recipientUserId));
  return null == i || null == a ? null : <Q.Z giftIntentType={i.giftIntentType} recipientUser={a} channel={n} giftIntentSecondaryAction={i.giftIntentSecondaryAction} />
}
...
function e9(e) {
  ...
  return <ea.Z message={t} channel={n} compact={i} />
}
...
function te(e) {
  ...
  return <ep.Z message={t} channel={n} author={t.author} compact={i} />
}
...
function tt(e) {
  ...
  return <h.Z message={t} channel={n} compact={i} />
}
...
function tn(e) {
  ...
  return <p.Z message={t} channel={n} compact={i} />
}
...
function tr(e) {
  ...
  return <g.iq message={t} channel={n} compact={i} usernameHook={o} />
}
let ti = Object.freeze({
  ...
  [Chunk981631.uaV.PURCHASE_NOTIFICATION]: e4,
  ...
  [Chunk981631.uaV.NITRO_NOTIFICATION]: e8,
  ...
  [Chunk981631.uaV.CHAT_WALLPAPER_SET]: tt,
  [Chunk981631.uaV.CHAT_WALLPAPER_REMOVED]: tn,
...
function to(e) {
  ...
  return null == s ? (eM(Error("unknown message type ".concat(t.type))), null) : <$.ZP message={t} content={(0, X.ZP)(t).content} compact={null != i && i}><s message={t} channel={n} compact={i} disableInteraction={o} /></$.ZP>
}
let ta = Chunk73800.memo(to)