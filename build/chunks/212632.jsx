...
function f(e) {
  ...
  return <div>{<l.tEY within={true} offset={false}><div className={a()(d.wrapper, {
          [d.disabledSelected]: t === o._vf.DISABLED
        })}>{h.map(e => (0, i.jsxs)("label", {
          className: a()({
            [d.selected]: e === t,
        ...
        }, e))}</div></l.tEY>}{<l.R94 type={l.geA.DESCRIPTION} className={u.marginTop8}>{m}</l.R94>}</div>
}
