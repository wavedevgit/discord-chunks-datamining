...
function m(e) {
  ...
  if (t.isGroupDM()) return (0, n.jsx)(c.Z, {
    "aria-hidden": !0,
...
function S(e) {
  ...
  return t.isDM() || t.isGroupDM() ? (0, n.jsx)("span", {
...
function _(e) {
  ...
  if (t.isDM()) {
    let e = t.getRecipientId(),
      r = p.default.getUser(e);
    return null == r ? null : (0, n.jsx)("span", {
      className: g.searchResultDMUserName,
      children: f.ZP.getUserTag(r, {
        identifiable: d.Z.enabled && d.Z.hidePersonalInformation ? "never" : "always"
      })
    })
  }
  if (null != r) return (0, n.jsx)("span", {
