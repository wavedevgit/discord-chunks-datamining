...
function A(e) {
  ...
  let s = (0, o.e7)([y.Z], () => y.Z.getGuild(null == t ? true : t.guild_id)),
    i = (0, h.ZP)(t),
...
function D(e) {
  let {
    ...
    return f === b.h8.USER ? (0, r.jsx)(F, _({
      user: h
    }, y)) : f === b.h8.GROUP_DM ? (0, r.jsx)(I, _({
      channel: h
    }, y)) : f === b.h8.TEXT_CHANNEL || f === b.h8.VOICE_CHANNEL ? (0, r.jsx)(A, _({
      channel: h
    }, y)) : void(0, S.vE)(f)
  }, [u, a, n, s, t, d, c, o]);
  return {
