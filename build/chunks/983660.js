...
function u(e) {
  let {
    locked: t
  } = e, [n, u] = (0, s.US)(t ? [] : [a.z.OVERLAY_OOP_WELCOME_BACKGROUND_SWITCH_FROM_IP_NUX], void 0, !0);
  return (r.useEffect(() => {
    if (!t && n === a.z.OVERLAY_OOP_WELCOME_BACKGROUND_SWITCH_FROM_IP_NUX) return () => {
      n === a.z.OVERLAY_OOP_WELCOME_BACKGROUND_SWITCH_FROM_IP_NUX && u(l.L.AUTO_DISMISS)
    }
  }, [t, u, n]), t || n !== a.z.OVERLAY_OOP_WELCOME_BACKGROUND_SWITCH_FROM_IP_NUX) ? null : (0, i.jsx)("div", {
