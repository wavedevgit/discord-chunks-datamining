...
let p = {
  createChannel(e) {
    ...
    return _.Z.post({
      ...
      rejectWithError: !1
    }).then(e => (o.ZP.isOptInEnabled(n) && d.Z.updateChannelOverrideSettings(n, e.body.id, {
      flags: s.ic.OPT_IN_ENABLED
    }, c.ZB.OptedIn), a.Z.checkGuildTemplateDirty(n), e), e => {
      throw l.Z.dispatch({
  ...
  createRoleSubscriptionTemplateChannel: (e, n, t, l) => _.Z.post({
