...
function A(e) {
  ...
  } = (0, v.d)(), M = (0, s.e7)([_.Z], () => _.Z.getUserParticipantCount(C.id), [C]), j = (0, g.bt)(C.id, t), k = i.useCallback(() => {
    (0, a.j)(() => {
      v.d.setState({
  ...
  let W = i.useCallback(e => {
    var t, n;
    return null != (n = null == (t = j[e]) ? true : t.id) ? n : "empty-tile"
  }, [j]);
  return (0, r.jsx)(m.Z, {
    className: R,
    keyExtractor: W,
