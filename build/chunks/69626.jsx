...
function C(e, t, n, i, o) {
  ...
  "" !== h.Z.getDraft(e, h.d.ChannelMessage) ? (0, s.h7j)(t => <s.ConfirmModal{...N(S({
...
function R(e) {
  ...
  return S ? <d.Z role={"link"} onClick={A}>{O.GI}{s}</d.Z> : <span>{O.GI}{s}</span>
}
...
function P(e) {
  ...
  return <s.ua7 text={i} position={"top"} tooltipContentClassName={I.tooltip}>{e => {
      let {
        onMouseEnter: t,
        onMouseLeave: i
      } = e;
...
function w(e) {
  return {
    react: (e, t, n) => <R node={e} stateKey={n.key}>{t(e.content, n)}</R>
  }
}