...
class g extends Chunk73800.PureComponent {
  ...
  render() {
    ...
    return p ? (t = Chunk998502.ZP.getDiscordUtils().inputCaptureRegisterElement, e = this.handleNativeChange) : Chunk358085.isPlatformEmbedded || (e = this.handleComboKeys), <Chunk455279.Z disabled={Chunk921738} value={require} mode={Chunk73800} onClick={this.toggleRecordMode} onChange={module} registerNativeRecorder={exports} disableOnClickWhileRecording={p} />
  }
  constructor(e) {
