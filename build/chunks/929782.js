...
function S() {
  return !c.Z.isSupported() && ((0, a.h7j)(e => (0, r.jsx)(a.ConfirmModal, v(y({
...
function N() {
  ...
  return S() ? Promise.resolve(!1) : (_.default.track(m.rMx.PERMISSIONS_REQUESTED, {
    type: "audio"
...
function C(e) {
  let {
    usedKeybind: t = !1,
    location: n
  } = e, r = d.ZP.getKeybindForAction(m.kg4.TOGGLE_MUTE, !1, !0), i = u.Z.getVoiceChannelId(), a = null != i ? l.Z.getChannel(i) : null;
...
function R(e) {
  let {
    usedKeybind: t = !1,
    location: n
  } = e, r = d.ZP.getKeybindForAction(m.kg4.TOGGLE_DEAFEN, !1, !0), i = u.Z.getVoiceChannelId(), a = null != i ? l.Z.getChannel(i) : null;
