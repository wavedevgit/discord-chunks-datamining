...
function S() {
  return !c.Z.isSupported() && ((0, o.h7j)(e => (0, r.jsx)(o.ConfirmModal, v(y({
...
function C(e) {
  let {
    usedKeybind: t = !1,
    location: n
  } = e, r = d.ZP.getKeybindForAction(m.kg4.TOGGLE_MUTE, !1, !0), i = u.Z.getVoiceChannelId(), o = null != i ? l.Z.getChannel(i) : null;
...
function R(e) {
  let {
    usedKeybind: t = !1,
    location: n
  } = e, r = d.ZP.getKeybindForAction(m.kg4.TOGGLE_DEAFEN, !1, !0), i = u.Z.getVoiceChannelId(), o = null != i ? l.Z.getChannel(i) : null;
