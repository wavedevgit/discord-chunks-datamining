...
function u(e, t, n, r) {
  return <d keybind={e} message={t} messageWithoutKeybind={n} highlightAdminWarningIfElevated={r} />
}
...
function d(e) {
  ...
  }) ? <o.Text variant={"text-xxs/semibold"} color={d ? "text-feedback-warning" : "text-muted"}>{c.intl.string(c.t.PIeSHB)}</o.Text> : p ? <i.Fragment>{c.intl.format(n, {
      keybind: t,
