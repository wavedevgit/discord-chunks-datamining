...
function b(e) {
  ...
  return <div><l.i bannerIcon={(0, r.jsx)(o.ics, {
        size: "lg",
        color: "currentColor",
        className: E.bannerIcon
      })} bannerHeader={g.intl.format(g.t.GgMwjo, {
        guildName: null != (t = null == n ? true : n.name) ? t : ""
      })} bannerSubtext={g.intl.string(g.t.ONjwDw)} textStyles={E.bannerContainer} headerStyles={E.bannerHeader}><o.zxk variant={"primary"} size={"sm"} text={g.intl.string(g.t.Viksoq)} onClick={() => i()} /></l.i></div>
}
...
function y(e) {
  ...
  return <div><l.i bannerIcon={(0, r.jsx)(o.ics, {
      ...
      })} bannerSubtext={f} textStyles={E.bannerContainer} headerStyles={E.bannerHeader}><o.zxk variant={"primary"} size={"sm"} text={h} onClick={m} /></l.i></div>
}
...
function O(e) {
  ...
  return n.has(h.q.AUTOMOD_QUARANTINED_USERNAME_OR_GUILD_NICKNAME) || n.has(h.q.AUTOMOD_QUARANTINED_BIO) ? <y guild={t} /> : n.has(h.q.AUTOMOD_QUARANTINED_SERVER_TAG) ? <b guild={t} /> : <y guild={t} />
}