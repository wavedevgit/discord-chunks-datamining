...
function p(e) {
  ...
  let {
    ...
    width: b,
    height: y
  } = m, C = null != (t = null == l ? true : l.length) ? t : 0, v = b - 16, x = y - (f + h), {
    tileStyle: O,
    tileWidth: E,
    rows: j,
    columns: S
  ...
  })(C, v, x), [C, v, x]), _ = S + 1, P = _ * E + (_ - 1) * 8 <= b, I = Math.floor(E / c) + 8, Z = Math.max(0, x - I * j) / 2;
  return (0, i.jsx)(o.Z, {
    fade: true,
    className: n,
        ...
        children: null == l || null == (t = l.slice(n, n + S)) ? true : t.map((e, t) => {
          ...
          return (0, i.jsx)("div", {
            ...
            className: a()(s.tile, {
              ...
              [s.noHorizontalMargin]: (l + 1) % S == 0 || l === C - 1
            }),
