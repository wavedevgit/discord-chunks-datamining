...
function v(e) {
  let {
    ...
    onScrubBack: S,
    onScrubForward: O
  } = e, [b, h] = o.useState(null), [y, j] = o.useState(null), [T, x] = o.useState(null), [P, D] = o.useState(false), R = o.useRef(null), I = e => {
    R.current = e, h(e)
  };
  o.useEffect(() => {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)(i.P3F, {
      ...
      onMouseEnter: e => {
        a && (null != k.current && I(k.current.getBoundingClientRect()), D(true), A(e))
      },
      onMouseLeave: e => {
        a && (D(false), j(null))
      },
