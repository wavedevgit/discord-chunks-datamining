...
function v(e) {
  let {
    ...
    onScrubBack: C,
    onScrubForward: S
  } = e, [h, _] = l.useState(null), [j, y] = l.useState(null), [x, T] = l.useState(null), [D, R] = l.useState(false), P = l.useRef(null), N = e => {
    P.current = e, _(e)
  };
  l.useEffect(() => {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)(a.P3F, {
      ...
      onMouseEnter: e => {
        o && (null != k.current && N(k.current.getBoundingClientRect()), R(true), A(e))
      },
      onMouseLeave: e => {
        o && (R(false), y(null))
      },
