...
let K = new Set([Chunk275726.u.REPLY, Chunk275726.u.THREAD_STARTER_MESSAGE, Chunk275726.u.CONTEXT_MENU_COMMAND]);
var z = function(e) {
...
let em = "@me",
  ...
  eS = Object.freeze({
    ...
    THREAD_MEMBER: function(e) {
      let t = arguments.length > 1 && true !== arguments[1] ? arguments[1] : em;
  ...
  eA = Object.freeze({
    ...
    GLOBAL_DISCOVERY_APPS_PROFILE_STORE_SKU: (e, t) => "/discovery/applications/".concat(e, "/").concat(h.GlobalDiscoveryAppsSections.STORE, "/").concat(t),
    ...
    APPLICATION_DIRECTORY_PROFILE_STORE_SKU: (e, t) => "/application-directory/".concat(e, "/").concat(m.c.STORE, "/").concat(t),
...
let eD = 100,
  ...
  ez = 32,
  eq = 6e5,
  eX = 6 * Chunk70956.Z.Seconds.HOUR,
  eQ = [0, 5, 10, 15, 30, Chunk70956.Z.Seconds.MINUTE, 2 * Chunk70956.Z.Seconds.MINUTE, 5 * Chunk70956.Z.Seconds.MINUTE, 10 * Chunk70956.Z.Seconds.MINUTE, 15 * Chunk70956.Z.Seconds.MINUTE, 30 * Chunk70956.Z.Seconds.MINUTE, +Chunk70956.Z.Seconds.HOUR, 2 * Chunk70956.Z.Seconds.HOUR, eX],
  eJ = 10,
  e$ = 0xa00000,
  e0 = 524288e3,
  e1 = e => "||".concat(e, "||"),
...
let nz = e => "https://www.youtube.com/embed/".concat(e),
  nq = e => "https://img.youtube.com/vi/".concat(e, "/maxresdefault.jpg"),
  nX = "https://discordapp.com/mweb-handoff";
var nQ = function(e) {
