...
let eE = "@me",
  ...
  eN = Object.freeze({
    ...
    BILLING_STANDALONE_CHECKOUT_PAGE: (e, t, n, r) => "/billing/premium/subscribe?plan_id=".concat(e, "&gift=").concat(t, "&load_id=").concat(n).concat(r ? "&payment_method_type=".concat(r) : ""),
