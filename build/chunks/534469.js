...
function el(e) {
  ...
  let {
    ...
    selected: H,
    setPopout: W
  } = (0, D.Z)(a.id, K.d$), $ = j.RS.useSetting(), er = j.NA.useSetting(), ei = (0, u.e7)([x.Z], () => x.Z.getMessageByReference(E)), el = (0, m.A)((null != (n = a.editedTimestamp) ? n : a.timestamp).valueOf()), {
    handleMouseEnter: eo,
    handleMouseLeave: ea,
    isHovered: es
  } = (0, M.tn)({
    ...
    previewLinkTarget: !0,
    viewingChannelId: O
  }), ef = (0, L.Z)(s, h, ec), em = (0, A.ZP)(a), eg = (0, k.iG)(a, C), eb = (0, k.Gx)(a), e_ = (0, z.Z)(e, ep, !1), ey = i.useCallback(() => (0, v.XU)(g, h, s), [g, h, s]), eC = (0, f.p9)({
    guildId: g,
