...
function ei(e) {
  ...
  let p = $({}, function(e) {
    ...
    x = (0, C.Z)(g),
    v = (0, Z.k)(i);
  return i.type === X.uaV.THREAD_STARTER_MESSAGE && null != h && h.state === y.Y.LOADED ? (0, r.jsx)(el, et(ee({}, e), {
...
function el(e) {
  ...
  let {
    ...
    selected: H,
    setPopout: W
  } = (0, D.Z)(o.id, K.d$), $ = j.RS.useSetting(), er = j.NA.useSetting(), ei = (0, u.e7)([y.Z], () => y.Z.getMessageByReference(E)), el = (0, m.A)((null != (n = o.editedTimestamp) ? n : o.timestamp).valueOf()), {
    handleMouseEnter: ea,
    handleMouseLeave: eo,
    isHovered: es
  } = (0, k.tn)({
    ...
    previewLinkTarget: !0,
    viewingChannelId: O
  }), ef = (0, L.Z)(s, h, ec), em = (0, A.ZP)(o), eg = (0, M.iG)(o, x), eb = (0, M.Gx)(o), e_ = (0, z.Z)(e, ep, !1), eC = i.useCallback(() => (0, v.XU)(g, h, s), [g, h, s]), ex = (0, f.p9)({
    guildId: g,
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(d.P3F, {
      ...
      onFocus: w,
      onBlur: B,
      childrenRepliedMessage: o.type === X.uaV.REPLY && (0, Y.Z)(et(ee({}, e), {
        setPopout: W,
    ...
    e0 = (0, r.jsx)(d.tEY, {
      ...
      children: (0, r.jsxs)("li", {
        ...
        children: [(0, _.Uw)(v) && (0, r.jsx)(g.Z, {
          ...
          zalgo: !eT,
          childrenRepliedMessage: eo || v.type !== X.uaV.REPLY ? void 0 : (0, Y.Z)(et(ee({}, e), {
            setPopout: e_,
          ...
          childrenHeader: eo ? void 0 : (0, V.Z)({
            messageProps: e,
            setPopout: e_,
            messagePopouts: eg,
            replyReference: es,
