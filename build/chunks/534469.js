...
function er(e) {
  ...
  let {
    ...
    selected: G,
    setPopout: Q
  } = (0, M.Z)(a.id, q.d$), et = x.RS.useSetting(), en = x.NA.useSetting(), er = (0, u.e7)([v.Z], () => v.Z.getMessageByReference(O)), ei = (0, m.A)((null !== (n = a.editedTimestamp) && void 0 !== n ? n : a.timestamp).valueOf()), {
    handleMouseEnter: el,
    handleMouseLeave: eo,
    isHovered: ea
  } = (0, R.tn)({
