...
function ei(e) {
  ...
  let p = $({}, function(e) {
    ...
    x = (0, y.Z)(g),
    v = (0, Z.k)(i);
  return i.type === X.uaV.THREAD_STARTER_MESSAGE && null != h && h.state === C.Y.LOADED ? (0, r.jsx)(el, et(ee({}, e), {
...
function el(e) {
  ...
  let {
    ...
    groupId: x,
    viewingChannelId: O
  } = e, E = a.type === X.uaV.REPLY ? a.messageReference : void 0, I = (0, c.JA)(null != (t = e.id) ? t : ""), {
    onFocus: S
  } = I, Z = en(I, ["onFocus"]), {
    isFocused: N,
    handleFocus: w,
    ...
    selected: H,
    setPopout: W
  } = (0, D.Z)(a.id, K.d$), $ = j.RS.useSetting(), er = j.NA.useSetting(), ei = (0, u.e7)([C.Z], () => C.Z.getMessageByReference(E)), el = (0, m.A)((null != (n = a.editedTimestamp) ? n : a.timestamp).valueOf()), {
    handleMouseEnter: eo,
    handleMouseLeave: ea,
    isHovered: es
  } = (0, M.tn)({
    ...
    defaultValue: H,
    popouts: F
  }), ec = (0, u.e7)([p.Z], () => p.Z.keyboardModeEnabled), eu = H || ec && N, ed = eu || es, {
    content: ep,
    hasSpoilerEmbeds: eh
  } = (0, U.Z)(a, {
    ...
    previewLinkTarget: !0,
    viewingChannelId: O
  }), ef = (0, L.Z)(s, h, ec), em = (0, A.ZP)(a), eg = (0, k.iG)(a, x), eb = (0, k.Gx)(a), e_ = (0, z.Z)(e, ep, !1), ey = i.useCallback(() => (0, v.XU)(g, h, s), [g, h, s]), ex = (0, f.p9)({
    guildId: g,
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(d.P3F, {
      ...
      onFocus: w,
      onBlur: B,
      childrenRepliedMessage: a.type === X.uaV.REPLY && (0, Y.Z)(et(ee({}, e), {
        setPopout: W,
    ...
    e0 = (0, r.jsx)(d.tEY, {
      ...
      children: (0, r.jsxs)("li", {
        ...
        children: [(0, _.Uw)(v) && (0, r.jsx)(g.Z, {
          ...
          zalgo: !eT,
          childrenRepliedMessage: ea || v.type !== X.uaV.REPLY ? void 0 : (0, Y.Z)(et(ee({}, e), {
            setPopout: e_,
          ...
          childrenHeader: ea ? void 0 : (0, V.Z)({
            messageProps: e,
            setPopout: e_,
            messagePopouts: eg,
            replyReference: es,
