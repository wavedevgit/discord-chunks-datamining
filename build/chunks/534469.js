    ...
    e2 = (0, r.jsx)(d.tEY, {
      ...
      children: (0, r.jsxs)("li", {
        ...
        children: [(0, E.Uw)(O) && (0, r.jsx)(m.Z, {
          ...
          zalgo: !eL,
          childrenRepliedMessage: el || O.type !== z.uaV.REPLY ? void 0 : (0, Y.Z)(er(et({}, e), {
            setPopout: ey,
          ...
          childrenHeader: el ? void 0 : (0, F.Z)({
            messageProps: e,
            setPopout: ey,
            messagePopouts: eE,
            replyReference: ec,
...
function eu(e) {
  ...
  let {
    ...
    groupId: b,
    viewingChannelId: I
  } = e, T = s.type === z.uaV.REPLY ? s.messageReference : void 0, S = (0, c.JA)(null != (t = e.id) ? t : ""), {
    onFocus: A
  } = S, C = ei(S, ["onFocus"]), {
    isFocused: P,
    handleFocus: U,
    ...
    selected: H,
    setPopout: X
  } = (0, j.Z)(s.id, K.d$), Q = v.RS.useSetting(), J = v.NA.useSetting(), ee = Q && J, en = (0, u.e7)([y.Z], () => y.Z.getMessageByReference(T)), ea = (0, h.A)((null != (n = s.editedTimestamp) ? n : s.timestamp).valueOf()), {
    handleMouseEnter: eo,
    handleMouseLeave: es,
    isHovered: el
  } = (0, x.tn)({
    ...
    defaultValue: H,
    popouts: Z
  }), ec = (0, u.e7)([f.Z], () => f.Z.keyboardModeEnabled), eu = H || ec && P, ed = eu || el, {
    content: ef,
    hasSpoilerEmbeds: e_
  } = (0, M.Z)(s, {
    ...
    previewLinkTarget: !0,
    viewingChannelId: I
  }), ep = (0, k.Z)(l, _, ec), eh = (0, R.ZP)(s), em = (0, L.iG)(s, b), eg = (0, L.Gx)(s), eE = (0, V.Z)(e, ef, !1), eb = i.useCallback(() => (0, O.XU)(m, _, l), [m, _, l]), ey = (0, p.p9)({
    guildId: m,
    roleId: eh.iconRoleId
  });
  return (0, r.jsxs)("div", {
