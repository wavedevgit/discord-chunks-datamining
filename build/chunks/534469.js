...
function ei(e) {
  ...
  let {
    ...
    previewLinkTarget: !0,
    viewingChannelId: O
  }), ef = (0, M.Z)(s, h, ec), em = (0, T.ZP)(a), eg = (0, R.iG)(a, y), eb = (0, R.Gx)(a), e_ = (0, G.Z)(e, ep, !1), eC = i.useCallback(() => (0, v.XU)(g, h, s), [g, h, s]), ey = (0, f.p9)({
    guildId: g,
...
let el = i.memo(function(e) {
  ...
  let es = K.OBS.has(v.type) ? v.messageReference : void 0,
    ...
    eB = (0, M.Z)(S, en, eA),
    eF = (0, T.ZP)(v),
    eH = (0, u.e7)([y.Z], () => y.Z.getPendingReply(en)),
    eG = function(e) {
      let t = i.useRef(e);
      return i.useEffect(() => {
