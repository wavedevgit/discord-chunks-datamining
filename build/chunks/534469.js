...
function er(e) {
  ...
  return l.type === K.uaV.THREAD_STARTER_MESSAGE && null != f && f.state === C.Y.LOADED ? (0, r.jsx)(ei, ee($({}, e), {
...
function ei(e) {
  ...
  let {
    ...
    groupId: x,
    viewingChannelId: O
  } = e, E = a.type === K.uaV.REPLY ? a.messageReference : void 0, I = (0, c.JA)(null != (t = e.id) ? t : ""), {
    onFocus: P
  } = I, Z = et(I, ["onFocus"]), {
    isFocused: A,
    handleFocus: U,
    ...
    selected: z,
    setPopout: J
  } = (0, L.Z)(a.id, q.d$), en = j.RS.useSetting(), er = j.NA.useSetting(), ei = (0, u.e7)([C.Z], () => C.Z.getMessageByReference(E)), el = (0, m.A)((null != (n = a.editedTimestamp) ? n : a.timestamp).valueOf()), {
    handleMouseEnter: eo,
    handleMouseLeave: ea,
    isHovered: es
  } = (0, k.tn)({
    ...
    defaultValue: z,
    popouts: F
  }), ec = (0, u.e7)([p.Z], () => p.Z.keyboardModeEnabled), eu = z || ec && A, ed = eu || es, {
    content: ep,
    hasSpoilerEmbeds: eh
  } = (0, D.Z)(a, {
    ...
    previewLinkTarget: !0,
    viewingChannelId: O
  }), ef = (0, M.Z)(s, h, ec), em = (0, T.ZP)(a), eg = (0, R.iG)(a, x), eb = (0, R.Gx)(a), e_ = (0, V.Z)(e, ep, !1), ey = i.useCallback(() => (0, v.XU)(g, h, s), [g, h, s]), ex = (0, f.p9)({
    guildId: g,
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(d.P3F, {
      ...
      onFocus: U,
      onBlur: G,
      childrenRepliedMessage: a.type === K.uaV.REPLY && (0, W.Z)(ee($({}, e), {
        setPopout: J,
    ...
    e0 = (0, r.jsx)(d.tEY, {
      ...
      children: (0, r.jsxs)("li", {
        ...
        children: [(0, _.Uw)(v) && (0, r.jsx)(g.Z, {
          ...
          zalgo: !eT,
          childrenRepliedMessage: ea || v.type !== K.uaV.REPLY ? void 0 : (0, W.Z)(ee($({}, e), {
            setPopout: e_,
          ...
          childrenHeader: ea ? void 0 : (0, H.Z)({
            messageProps: e,
            setPopout: e_,
            messagePopouts: eg,
            replyReference: es,
