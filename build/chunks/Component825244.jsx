...
function D(e) {
  let t, i, p, O, D, M, {
    ...
    U = null != k && E.default.extractTimestamp(k.id) < Date.now() - S.NOr,
    G = (0, o.bG)([A.default], () => (null == k ? true : k.ownerId) === A.default.getId(), [k]),
    {
      canInvite: B,
      canManageGuild: V,
      canMessage: F
  ...
  let ei = G ? N.intl.string(N.t["1ach9C"]) : N.intl.string(N.t["ezm+/j"]);
  U && (ei = N.intl.string(N.t["gwyU/J"]));
