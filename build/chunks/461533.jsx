...
function d(t) {
  ...
  return <l.Modal transitionState={n} title={s.intl.string(s.t.uYPGsb)} subtitle={s.intl.format(s.t.Hg8Ee3, {
      onClick: f
    })} actions={[{
      ...
      onClick: S
    }]} onClose={d}><c.Kqy gap={8} className={u.mainCheckboxContainer}>{a.Ud.map(t => (0, r.jsxs)(c.P3F, {
