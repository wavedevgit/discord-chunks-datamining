...
function s() {
  let {
    search: e
  } = (0, Chunk114858.TH)(), t = (0, Chunk114858.UO)(), n = Chunk73800.useMemo(() => new URLSearchParams(module), [module]).get("source"), s = null != require ? parseInt(require, 10) : null;
  return function(e) {
    ...
    onClose: Chunk73800.useCallback(() => {
      if (0 === s) {
