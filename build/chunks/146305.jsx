...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk853714 = require("./853714.js"),
  Chunk359191 = require("./359191.js"),
  Chunk84658 = require("./84658.js"),
  Chunk142961 = require("./142961.js"),
  Chunk730910 = require("./730910.js"),
  Chunk475013 = require("./475013.js"),
  Chunk213956 = require("./213956.js"),
  Chunk702478 = require("./702478.js"),
  Chunk60986 = require("./60986.jsx"),
  Chunk247031 = require("./247031.js"),
  Chunk787561 = require("./787561.js"),
  Chunk579648 = require("./579648.js"),
  Chunk460461 = require("./460461.js"),
  Chunk29605 = require("./29605.jsx"),
  Chunk365307 = require("./365307.js"),
  Chunk324330 = require("./324330.js"),
  Chunk495300 = require("./495300.js"),
  Chunk651780 = require("./651780.js"),
  Chunk279542 = require("./279542.js"),
  Chunk665324 = require("./665324.js"),
  Chunk208150 = require("./208150.js"),
  Chunk353398 = require("./353398.js"),
  Chunk365774 = require("./365774.js"),
  Chunk178387 = require("./178387.js"),
  Chunk993097 = require("./993097.js"),
  Chunk486358 = require("./486358.js"),
  Chunk942478 = require("./942478.js"),
  Chunk845995 = require("./845995.js"),
  Chunk708510 = require("./708510.js"),
  Chunk237245 = require("./237245.js"),
  Chunk658666 = require("./658666.js"),
  Chunk224726 = require("./224726.js"),
  Chunk308619 = require("./308619.js"),
  Chunk254925 = require("./254925.js"),
  Chunk209402 = require("./209402.js"),
  Chunk981631 = require("./981631.js"),
  Chunk135899 = require("./135899.js"),
  Chunk388032 = require("./388032.js"),
  Chunk474913 = require("./474913.js");
...
let ex = {
  getSectionDefinition: function(e, t) {
    let ex = (0, p.p)(t.guild.id, "guild_settings"),
      ...
      ev = ex && ej ? {
        label: <div className={eh.roleSubLabel}>{ep.intl.string(ep.t.Tn7Koq)}</div>,
        ariaLabel: ep.intl.string(ep.t.Tn7Koq)
      } : {
        label: <div className={eh.roleSubLabel}>{ep.intl.string(ep.t["KzCF//"])}</div>,
    ...
    switch (e) {
      ...
      case em.pNK.ROLES:
        return {
          section: em.pNK.ROLES, impressionName: i.ImpressionNames.GUILD_SETTINGS_ROLES, label: ep.intl.string(ep.t.LPJmLy), element: k.Z, type: o.bT.MINIMAL, ariaLabel: ep.intl.string(ep.t.KXcECw), notice: {
            stores: [S.Z],
            element: k._
          }, predicate: () => t.canManageRoles, icon: t.pinPermissionMigrationAvailable ? <div className={eh.redDot} /> : true
        };
      case em.pNK.EMOJI:
        return {
      ...
      case em.pNK.GUILD_TEMPLATES:
        return {
          section: em.pNK.GUILD_TEMPLATES, impressionName: i.ImpressionNames.GUILD_SETTINGS_TEMPLATE, label: <$.Z showDirtyIndicator={t.showDirtyGuildTemplateIndicator} />, ariaLabel: ep.intl.string(ep.t.KUw7Sk), element: J.ZP, notice: {
            stores: [J.Sf],
            element: J.Q5
      ...
      case em.pNK.APP_DIRECTORY:
        return {
          section: em.pNK.APP_DIRECTORY, label: <G.K section={e} guildId={t.guild.id} />, ariaLabel: ep.intl.string(ep.t.AKcFUl)
        };
      case em.pNK.SAFETY:
        return {
      ...
      case em.pNK.GUILD_AUTOMOD:
        return {
          section: em.pNK.GUILD_AUTOMOD, label: <div className={eh.landingPageTabLink}>{ep.intl.string(ep.t.uRelg4)}</div>, ariaLabel: ep.intl.string(ep.t.uRelg4), element: u.Z, newIndicatorDismissibleContentTypes: null, predicate: () => !t.guild.features.has(em.oNc.COMMUNITY) && ((0, d.Nb)(t.guild.id) || (0, d.ze)(t.guild.id))
        };
      ...
      case em.pNK.DISCOVERY_LANDING_PAGE:
        return {
          section: em.pNK.DISCOVERY_LANDING_PAGE, impressionName: i.ImpressionNames.GUILD_SETTINGS_DISCOVERY_LANDING_PAGE, label: <div className={eh.landingPageTabLink}>{ep.intl.string(ep.t.kGlQGB)}{" "}{<c.Z />}</div>, ariaLabel: ep.intl.string(ep.t.kGlQGB), element: H.Z, notice: {
            stores: [T.Z],
            element: H.J
      ...
      case em.pNK.GUILD_PREMIUM:
        return {
          section: em.pNK.GUILD_PREMIUM, impressionName: i.ImpressionNames.GUILD_SETTINGS_BOOST_STATUS, label: ep.intl.string(ep.t["8+VX4+"]), ariaLabel: ep.intl.string(ep.t["8+VX4+"]), element: K.Z, className: eh.serverBoostTabItem, icon: <a.$Eu color={a.TVs.unsafe_rawColors.GUILD_BOOSTING_PINK} size={"sm"} className={eh.icon} />
        };
      case em.pNK.MEMBERS:
        return {
          section: em.pNK.MEMBERS, impressionName: i.ImpressionNames.GUILD_SETTINGS_MEMBERS, label: <V.$ />, ariaLabel: ep.intl.string(ep.t["9Oq93t"]), element: V.Z, type: o.bT.CUSTOM, predicate: () => t.canAccessMembersPage
        };
      case em.pNK.DELETE:
        return {
          section: em.pNK.DELETE, onClick() {
            ...
            e.mfaEnabled ? (0, a.h7j)(e => <a.ConfirmModal{...eb(ef({}, e, l), {
          ...
          }, label: ep.intl.string(ep.t.l3hWPz), ariaLabel: ep.intl.string(ep.t.l3hWPz), icon: <a.XHJ size={"xs"} color={"currentColor"} />, variant: "destructive", predicate: () => t.isOwnerWithRequiredMfaLevel
        };
      case em.pNK.LANDING:
