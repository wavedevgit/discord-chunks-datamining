          ...
          let t = v[e],
            {
              ...
              let [t, n, a] = "transparent" === e ? [0, 0, 0] : i()(e).hsl(), l = isNaN(t) ? 0 : o().round(t, 1), r = o().round(100 * a, 1);
              return {
                h: l,
                s: o().round(100 * n, 1),
                l: r
    ...
    children: [(0, Chunk54381.jsxs)("div", {
      ...
      children: [(0, Chunk54381.jsxs)(Chunk481060.njP, {
        ...
        children: [(0, Chunk54381.jsx)(Chunk481060.hU, {
          ...
          onClick: () => {
            N("color-overrides", JSON.stringify(y({}, exports), null, 2))
          },
          "aria-label": "Export"
        })]
      })]
