...
function p(e) {
  ...
  return <u.Z artURL={_} header={f.intl.string(f.t["z+mxvr"])} size={(0, u.L)(p)} noArt={g} selected={m} description={f.intl.format(f.t.d486Wl, {
      helpUrl: c.Z.getArticleURL(d.BhN.VOICE_VIDEO_TROUBLESHOOTING)
    })} errorCodeMessage={E ? f.intl.formatToPlainString(f.t["ejOT9/"], {
      errorCode: b
    }) : true} onCTAClick={y} callToAction={f.intl.string(f.t["hxmQ/f"])} />
}