...
function b() {
  let e = (0, s.Wu)([d.ZP, m.Z, p.Z], () => d.ZP.getGamesSeen(!1).filter(e => !!(0, d.FZ)(e, [d.ZP, m.Z, p.Z]).detectable && null != e.lastLaunched && 30 >= r()().diff(e.lastLaunched, "days")).map(e => {
      var t, n;
  ...
  return {
    assets: (0, c.Z)(n).filter(g.lm).map(e => {
      var t;
      return {
