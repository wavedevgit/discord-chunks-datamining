...
function D(e) {
  var t, {
    ...
    N = C(e, ["transitionState", "children", "size", "role", "className", "fullscreenOnMobile", "hideShadow", "onAnimationEnd", "returnRef", "animation", "parentComponent"]);
...
function x(e) {
  ...
  return (0, r.jsx)(E.Z, {
    ...
    className: o()(v.header, e.className, {
      [v.separator]: null == (l = e.separator) || l
    }),
    id: u ? true : c,
    children: e.children
  })
...
function j(e) {
  let {
    ...
    scrollerRef: i,
    scrollbarType: a
  } = e, s = C(e, ["className", "children", "scrollerRef", "scrollbarType"]), l = L(a);
...
function M(e) {
  ...
  return (0, r.jsx)(E.Z, {
    ...
    className: o()(v.footer, e.className, {
      [v.footerSeparator]: null == (s = e.separator) || s
    }),
    children: (0, r.jsx)(m.y5t, {
      children: e.children
    })
