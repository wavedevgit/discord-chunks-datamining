...
function eD() {
  ...
  })), c = (0, g.e7)([X.default], () => X.default.getCurrentUser()), [d] = r.useState(() => [eR(ec.intl.string(ec.t.C0ZDvr), !0, !1), eR(ec.intl.string(ec.t.iOtj8P), !1, !1, !0), eR(ec.intl.string(ec.t["0oqNgI"]), !1, !0)]), u = (0, g.e7)([B.ZP, K.Z], () => {
    let e = B.ZP.getWidgetByType(es.Odu.VOICE_V3);
    if (null == e) return null;
    let t = K.Z.getWidget(e.id);
    return null != t && (0, U.Aw)(t) ? t : null
  }), m = null != (t = null == u || null == (e = u.meta) ? void 0 : e.voiceStatesMaxShown) ? t : eo.At, p = [null != c ? function(e) {
    let t = eR(e.username);
    return t.user = e, t
  }(c) : null, ...d].filter(et.lm), f = [new Map(p.map(e => [e.user.id, e])), p.map(e => e.user.id)];
  return (0, i.jsxs)("div", {
