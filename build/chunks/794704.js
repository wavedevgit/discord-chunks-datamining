...
function ev(e) {
  ...
  } = e, c = null == a ? void 0 : a.pid, d = (0, p.e7)([w.default], () => null == a || null == c ? null : w.default.getTrackedGameByPid(c), [a, c], o()), {
    enabledLegacy: u,
    enabledOOP: m
  } = (0, p.cj)([Y.Z, q.Z], () => {
  ...
  }, [a, d]), g = (0, p.e7)([T.ZP, Y.Z, q.Z], () => null == a ? null : (0, T.FZ)(a, T.ZP, Y.Z, q.Z), [a], o()), [b, x] = r.useState(m), [j, E] = r.useState(u), [v, S] = r.useState(!1);
  r.useEffect(() => {
    x(m), E(u)
  }, [m, u]);
  ...
  return null == a ? null : (0, i.jsxs)(eO, {
    onExpand: S,
    className: v ? ed.expandedContainer : void 0,
    title: (0, i.jsxs)(i.Fragment, {
      children: [null != (s = null != (n = null != (t = null == l ? void 0 : l.name) ? t : null == g ? void 0 : g.name) ? n : null == a ? void 0 : a.gameName) ? s : "", null != g && g.verified ? (0, i.jsx)(h.ua7, {
...
function eS(e) {
  let {
    game: t,
    gameApplication: n
  } = e, s = r.useMemo(() => null == t ? null : "pid" in t ? t.pid : null, [t]), a = (0, p.e7)([E.Z], () => null != n ? n : E.Z.getApplication(null == t ? void 0 : t.id), [n, t]);
  return (0, i.jsx)(I.Z, {
    game: a,
    pid: s,
...
function eT(e) {
  let {
    ...
    clientSettingType: o,
    ariaLabel: c
  } = e, d = (0, p.cj)([T.ZP, Y.Z, q.Z], () => (0, T.FZ)(t, T.ZP, Y.Z, q.Z)), u = (0, p.cj)([Y.Z, q.Z], () => (0, T.b6)(t, !1, [Y.Z, q.Z]), [t]), m = a(u), [g, f] = r.useState(m);
  r.useEffect(() => {
    f(m)
  }, [m]);
  let b = (e, n) => {
...
function eN() {
  let [e, t] = r.useState(!1), {
    legacyEnabled: n,
    oopEnabled: s
  } = (0, p.cj)([w.default], () => w.default.getGlobalEnabledStatus()), a = (0, p.Wu)([T.ZP], () => T.ZP.getGamesSeen(!0)), l = (0, v.Z)(a.map(e => e.id)), o = !(0, er.supportsLegacy)(), c = (e, t) => {
    var i, r;
...
function eI() {
  let [e, t] = r.useState(!1), {
    oopEnabled: n,
    legacyEnabled: s
  } = (0, p.cj)([w.default], () => w.default.getGlobalEnabledStatus()), a = !(0, er.supportsOutOfProcess)(), l = (0, p.Wu)([T.ZP], () => T.ZP.getGamesSeen(!0)), o = (0, v.Z)(l.map(e => e.id)), c = (e, t) => {
    var i, r;
    eE(t);
    let a = !e && n;
    _.Z.setEnabled(s, e);
...
function ew(e) {
  ...
  } = e, s = null == n ? void 0 : n.id, a = (0, p.e7)([L.Z], () => L.Z.isLimitedInteractionOverrideEnabled(s), [s]), l = r.useMemo(() => null != t && (0, k.H8)(t.pid), [t]), o = (0, Z.Z)({
