...
function eS(e) {
  ...
  }, [l, d]), p = (0, g.e7)([I.ZP, W.Z, q.Z], () => null == l ? null : (0, I.FZ)(l, [I.ZP, W.Z, q.Z]), [l], o()), [b, _] = r.useState(m), [E, S] = r.useState(u), [v, T] = r.useState(!1);
  r.useEffect(() => {
    _(m), S(u)
  }, [m, u]);
...
function eT(e) {
  let {
    ...
    clientSettingType: o,
    ariaLabel: c
  } = e, d = (0, g.cj)([I.ZP, W.Z, q.Z], () => (0, I.FZ)(t, [I.ZP, W.Z, q.Z])), u = (0, g.cj)([W.Z, q.Z], () => (0, I.b6)(t, !1, [W.Z, q.Z]), [t]), m = l(u), [p, f] = r.useState(m);
  r.useEffect(() => {
    f(m)
  }, [m]);
  let b = (e, n) => {
...
function eI() {
  let [e, t] = r.useState(!1), {
    legacyEnabled: n,
    oopEnabled: s
  } = (0, g.cj)([w.default], () => w.default.getGlobalEnabledStatus()), l = (0, g.Wu)([I.ZP], () => I.ZP.getGamesSeen(!0)), a = (0, v.Z)(l.map(e => e.id)), o = !(0, er.supportsLegacy)(), c = (e, t) => {
    var i, r;
...
function eN() {
  let [e, t] = r.useState(!1), {
    oopEnabled: n,
    legacyEnabled: s
  } = (0, g.cj)([w.default], () => w.default.getGlobalEnabledStatus()), l = !(0, er.supportsOutOfProcess)(), a = (0, g.Wu)([I.ZP], () => I.ZP.getGamesSeen(!0)), o = (0, v.Z)(a.map(e => e.id)), c = (e, t) => {
    var i, r;
    eO(t);
    let l = !e && n;
    x.Z.setEnabled(s, e);
