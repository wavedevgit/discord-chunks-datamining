...
function ev(e) {
  ...
  }, [l, d]), p = (0, g.e7)([I.ZP, K.Z, X.Z], () => null == l ? null : (0, I.FZ)(l, [I.ZP, K.Z, X.Z]), [l], o()), [b, _] = r.useState(m), [E, v] = r.useState(u), [T, N] = r.useState(!1);
  r.useEffect(() => {
    _(m), v(u)
  }, [m, u]);
  let y = (0, S.$1)(),
...
function eN(e) {
  let {
    ...
    clientSettingType: o,
    ariaLabel: c
  } = e, d = (0, g.cj)([I.ZP, K.Z, X.Z], () => (0, I.FZ)(t, [I.ZP, K.Z, X.Z])), u = (0, g.cj)([K.Z, X.Z], () => (0, I.b6)(t, !1, [K.Z, X.Z]), [t]), m = l(u), [p, f] = r.useState(m);
  r.useEffect(() => {
    f(m)
  }, [m]);
  let b = (e, n) => {
...
function eI() {
  let [e, t] = r.useState(!1), {
    legacyEnabled: n,
    oopEnabled: s
  } = (0, g.cj)([k.default], () => k.default.getGlobalEnabledStatus()), l = (0, g.Wu)([I.ZP], () => I.ZP.getGamesSeen(!0)), a = (0, T.Z)(l.map(e => e.id)), o = (0, S.$1)(), c = (e, t) => {
    var i, r;
...
function ey() {
  let [e, t] = r.useState(!1), {
    oopEnabled: n,
    legacyEnabled: s
  } = (0, g.cj)([k.default], () => k.default.getGlobalEnabledStatus()), l = !(0, es.supportsOutOfProcess)(), a = (0, g.Wu)([I.ZP], () => I.ZP.getGamesSeen(!0)), o = (0, T.Z)(a.map(e => e.id)), c = (e, t) => {
    var i, r;
    eS(t);
    let l = !e && n;
    x.Z.setEnabled(s, e);
