...
function ev(e) {
  ...
  } = e, c = null == l ? void 0 : l.pid, d = (0, p.e7)([k.default], () => null == l || null == c ? null : k.default.getTrackedGameByPid(c), [l, c], o()), {
    enabledLegacy: u,
    enabledOOP: m
  } = (0, p.cj)([K.Z, X.Z], () => {
  ...
  }, [l, d]), g = (0, p.e7)([N.ZP, K.Z, X.Z], () => null == l ? null : (0, N.FZ)(l, [N.ZP, K.Z, X.Z]), [l], o()), [b, _] = r.useState(m), [E, v] = r.useState(u), [T, I] = r.useState(!1);
  r.useEffect(() => {
    _(m), v(u)
  }, [m, u]);
  let y = (0, S.$1)(),
...
function eT(e) {
  let {
    game: t,
    gameApplication: n
  } = e, s = r.useMemo(() => null == t ? null : "pid" in t ? t.pid : null, [t]), l = (0, p.e7)([v.Z], () => null != n ? n : v.Z.getApplication(null == t ? void 0 : t.id), [n, t]);
  return (0, i.jsx)(A.Z, {
    game: l,
    pid: s,
...
function eI(e) {
  let {
    ...
    clientSettingType: o,
    ariaLabel: c
  } = e, d = (0, p.cj)([N.ZP, K.Z, X.Z], () => (0, N.FZ)(t, [N.ZP, K.Z, X.Z])), u = (0, p.cj)([K.Z, X.Z], () => (0, N.b6)(t, !1, [K.Z, X.Z]), [t]), m = l(u), [g, f] = r.useState(m);
  r.useEffect(() => {
    f(m)
  }, [m]);
  let b = (e, n) => {
...
function eN() {
  let [e, t] = r.useState(!1), {
    legacyEnabled: n,
    oopEnabled: s
  } = (0, p.cj)([k.default], () => k.default.getGlobalEnabledStatus()), l = (0, p.Wu)([N.ZP], () => N.ZP.getGamesSeen(!0)), a = (0, T.Z)(l.map(e => e.id)), o = (0, S.$1)(), c = (e, t) => {
    var i, r;
...
function ey() {
  let [e, t] = r.useState(!1), {
    oopEnabled: n,
    legacyEnabled: s
  } = (0, p.cj)([k.default], () => k.default.getGlobalEnabledStatus()), l = !(0, es.supportsOutOfProcess)(), a = (0, p.Wu)([N.ZP], () => N.ZP.getGamesSeen(!0)), o = (0, T.Z)(a.map(e => e.id)), c = (e, t) => {
    var i, r;
    eS(t);
    let l = !e && n;
    x.Z.setEnabled(s, e);
      ...
      children: (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsxs)("div", {
          ...
          children: (0, i.jsx)(E.Z, {
            ...
            onChange: function(t) {
              d()(null != e, "Keybind should never be undefined"), b.Z.setKeybind(eh(eg({}, e), {
                shortcut: t
              }))
            }
          })
...
function eZ() {
  ...
  })), c = (0, p.e7)([Q.default], () => Q.default.getCurrentUser()), [d] = r.useState(() => [eD(ed.intl.string(ed.t.C0ZDvr), !0, !1), eD(ed.intl.string(ed.t.iOtj8P), !1, !1, !0), eD(ed.intl.string(ed.t["0oqNgI"]), !1, !0)]), u = (0, p.e7)([M.default, q.Z], () => {
    let e = M.default.getWidgetByType(el.Odu.VOICE_V3);
    if (null == e) return null;
    let t = q.Z.getWidget(e.id);
    return null != t && (0, V.Aw)(t) ? t : null
  }), m = null != (t = null == u || null == (e = u.meta) ? void 0 : e.voiceStatesMaxShown) ? t : ec.At, g = [null != c ? function(e) {
    let t = eD(e.username);
    return t.user = e, t
  }(c) : null, ...d].filter(en.lm), f = [new Map(g.map(e => [e.user.id, e])), g.map(e => e.user.id)];
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)(eE, {
      ...
      children: [(0, i.jsx)("div", {
        ...
        children: [(0, i.jsx)(F.PI, {
          children: ed.intl.string(ed.t.KNJ6Vl)
        }), (0, i.jsx)(F.ls, {}), (0, i.jsx)(F.RT, {
...
function ew() {
  let [e, t] = (0, I.US)([g.z.OVERLAY_OOP_SETTINGS_NUX], void 0, !0), n = () => {
    t(ea.L.DISMISS)
  };
  return ((0, O.ZP)(() => () => {
    t(ea.L.AUTO_DISMISS)
...
function ek(e) {
  ...
  } = e, s = null == n ? void 0 : n.id, l = (0, p.e7)([B.Z], () => B.Z.isLimitedInteractionOverrideEnabled(s), [s]), a = r.useMemo(() => null != t && (0, L.H8)(t.pid), [t]), o = (0, w.Z)({
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)(eA, {}), o && (0, i.jsx)(eE, {
...
function eL(e) {
  ...
  }(), l = (0, Z.o4)("user_settings").overlayV3UI, a = (0, p.e7)([Q.default], () => Q.default.getCurrentUser());
  (0, O.ZP)(() => {
    if (ei.isPlatformEmbedded) return (0, y.Ky)(), y.P7
  });
  let c = ex(ef);
  return (m().isEqual(c, ef) || (et.default.track(el.rMx.OVERLAY_SETTINGS_UPDATED, c), ef = c), null == a) ? null : (0, i.jsxs)(i.Fragment, {
    children: [(0, i.jsxs)(h.hjN, {
      tag: h.RB0.H1,
      title: ed.intl.string(ed.t["9cb1U1"]),
      children: [l ? (0, i.jsx)(ew, {}) : null, (0, i.jsxs)("div", {
        className: eu.overlayEnabledSettingsContainer,
        children: [(0, i.jsx)(ev, {
          runningGame: r,
          runningGameApplication: s
      ...
      children: [(0, i.jsx)(eZ, {}), (0, i.jsx)("div", {
        className: eu.settingsDivider
      })]
    }), (0, i.jsx)(h.hjN, {
      children: (0, i.jsx)(eR, {})
