...
function ev(e) {
  ...
  } = e, c = null == l ? void 0 : l.pid, d = (0, g.e7)([k.default], () => null == l || null == c ? null : k.default.getTrackedGameByPid(c), [l, c], o()), {
    enabledLegacy: u,
    enabledOOP: m
  } = (0, g.cj)([K.Z, X.Z], () => {
  ...
  }, [l, d]), p = (0, g.e7)([N.ZP, K.Z, X.Z], () => null == l ? null : (0, N.FZ)(l, [N.ZP, K.Z, X.Z]), [l], o()), [b, _] = r.useState(m), [E, v] = r.useState(u), [T, I] = r.useState(!1);
  r.useEffect(() => {
    _(m), v(u)
  }, [m, u]);
  let y = (0, S.$1)(),
...
function eT(e) {
  let {
    game: t,
    gameApplication: n
  } = e, s = r.useMemo(() => null == t ? null : "pid" in t ? t.pid : null, [t]), l = (0, g.e7)([v.Z], () => null != n ? n : v.Z.getApplication(null == t ? void 0 : t.id), [n, t]);
  return (0, i.jsx)(A.Z, {
    game: l,
    pid: s,
...
function eI(e) {
  let {
    ...
    clientSettingType: o,
    ariaLabel: c
  } = e, d = (0, g.cj)([N.ZP, K.Z, X.Z], () => (0, N.FZ)(t, [N.ZP, K.Z, X.Z])), u = (0, g.cj)([K.Z, X.Z], () => (0, N.b6)(t, !1, [K.Z, X.Z]), [t]), m = l(u), [p, f] = r.useState(m);
  r.useEffect(() => {
    f(m)
  }, [m]);
  let b = (e, n) => {
...
function eN() {
  let [e, t] = r.useState(!1), {
    legacyEnabled: n,
    oopEnabled: s
  } = (0, g.cj)([k.default], () => k.default.getGlobalEnabledStatus()), l = (0, g.Wu)([N.ZP], () => N.ZP.getGamesSeen(!0)), a = (0, T.Z)(l.map(e => e.id)), o = (0, S.$1)(), c = (e, t) => {
    var i, r;
...
function ey() {
  let [e, t] = r.useState(!1), {
    oopEnabled: n,
    legacyEnabled: s
  } = (0, g.cj)([k.default], () => k.default.getGlobalEnabledStatus()), l = !(0, es.supportsOutOfProcess)(), a = (0, g.Wu)([N.ZP], () => N.ZP.getGamesSeen(!0)), o = (0, T.Z)(a.map(e => e.id)), c = (e, t) => {
    var i, r;
    eS(t);
    let l = !e && n;
    x.Z.setEnabled(s, e);
