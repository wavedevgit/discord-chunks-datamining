...
function ev(e) {
  ...
  }, [a, d]), g = (0, p.e7)([T.ZP, Y.Z, q.Z], () => null == a ? null : (0, T.FZ)(a, T.ZP, Y.Z, q.Z), [a], o()), [b, x] = r.useState(m), [j, C] = r.useState(u), [v, S] = r.useState(!1);
  r.useEffect(() => {
    x(m), C(u)
  }, [m, u]);
...
function eS(e) {
  let {
    game: t,
    gameApplication: n
  } = e, s = r.useMemo(() => null == t ? null : "pid" in t ? t.pid : null, [t]), a = (0, p.e7)([C.Z], () => null != n ? n : C.Z.getApplication(null == t ? void 0 : t.id), [n, t]);
  return (0, i.jsx)(I.Z, {
    game: a,
    pid: s,
