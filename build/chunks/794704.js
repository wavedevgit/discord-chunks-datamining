...
function ev(e) {
  ...
  } = e, c = null == l ? void 0 : l.pid, d = (0, m.e7)([k.default], () => null == l || null == c ? null : k.default.getTrackedGameByPid(c), [l, c], o()), {
    enabledLegacy: u,
    enabledOOP: g
  } = (0, m.cj)([K.Z, X.Z], () => {
  ...
  let y = (0, S.$1)(),
    D = !(0, es.supportsOutOfProcess)(),
    {
      legacyEnabled: Z,
      oopEnabled: w
    } = (0, m.cj)([k.default], () => k.default.getGlobalEnabledStatus()),
    L = (e, t, n) => {
      var i, r, s;
...
function eT(e) {
  let {
    game: t,
    gameApplication: n
  } = e, s = r.useMemo(() => null == t ? null : "pid" in t ? t.pid : null, [t]), l = (0, m.e7)([v.Z], () => null != n ? n : v.Z.getApplication(null == t ? void 0 : t.id), [n, t]);
  return (0, i.jsx)(A.Z, {
    game: l,
    pid: s,
...
function eZ() {
  ...
  })), c = (0, m.e7)([Q.default], () => Q.default.getCurrentUser()), [d] = r.useState(() => [eD(ed.intl.string(ed.t.C0ZDvr), !0, !1), eD(ed.intl.string(ed.t.iOtj8P), !1, !1, !0), eD(ed.intl.string(ed.t["0oqNgI"]), !1, !0)]), u = (0, m.e7)([M.ZP, q.Z], () => {
    let e = M.ZP.getWidgetByType(el.Odu.VOICE_V3);
    if (null == e) return null;
    let t = q.Z.getWidget(e.id);
    return null != t && (0, V.Aw)(t) ? t : null
  }), g = null != (t = null == u || null == (e = u.meta) ? void 0 : e.voiceStatesMaxShown) ? t : ec.At, p = [null != c ? function(e) {
    let t = eD(e.username);
    return t.user = e, t
...
function ek(e) {
  ...
  } = e, s = null == n ? void 0 : n.id, l = (0, m.e7)([B.Z], () => B.Z.isLimitedInteractionOverrideEnabled(s), [s]), a = r.useMemo(() => null != t && (0, L.H8)(t.pid), [t]), o = (0, w.Z)({
...
function eL(e) {
  ...
  }(), l = (0, Z.o4)("user_settings").overlayV3UI, a = (0, m.e7)([Q.default], () => Q.default.getCurrentUser());
  (0, O.ZP)(() => {
    if (ei.isPlatformEmbedded) return (0, y.Ky)(), y.P7
  });
  let c = ex(ef);
  return (g().isEqual(c, ef) || (et.default.track(el.rMx.OVERLAY_SETTINGS_UPDATED, c), ef = c), null == a) ? null : (0, i.jsxs)(i.Fragment, {
