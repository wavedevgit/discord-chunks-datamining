...
function q(e) {
  let {
    ...
    theme: a,
    locale: l
  } = e, [c, p] = i.useState(n.friendSync), [m, g] = i.useState(n.visibility), [E, S] = i.useState(n.metadataVisibility), [T, C] = i.useState(n.showActivity), [N, R] = i.useState(null), [P, D] = i.useState(null), [j, Z] = i.useState(false), [H, W] = i.useState([]), q = (0, y.rR)(n.type), X = b.Z.get(q);
  i.useEffect(() => {
