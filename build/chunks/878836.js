...
let _ = e => {
  ...
  } = e, [n, d] = r.useState(void 0), [_, p] = r.useState(!0), [h, m] = r.useState([]), g = r.useCallback(async () => {
    var e;
    let n = (0, c.vP)(),
      r = n ? (0, o.Q8)(null != (e = l.Z.ipCountryCode) ? e : "ALL").countryPaymentMethods : [];
    if (m((0, u.lS)(r, n)), t) try {
      let e = await (0, a.R5)(r.length > 0 ? {
        regionalPaymentMethods: r
      } : void 0);
      d(e)
    } catch (e) {
      (0, a.SQ)(e)
