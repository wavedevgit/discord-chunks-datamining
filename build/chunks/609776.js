...
function P(e) {
  ...
  let {
    ...
    defaultOptions: F,
    isSlideReady: z = !0
  } = e, V = i.useMemo(() => j.Z.getStageInstanceByChannel(k.id), [k.id]), [W, H] = i.useState(null != (n = null != (t = null == F ? void 0 : F.topic) ? t : null == V ? void 0 : V.topic) ? n : ""), [q, J] = i.useState(null != (l = null == F ? void 0 : F.description) ? l : ""), [K] = i.useState(U), [Y, X] = i.useState(null != (f = null == F ? void 0 : F.schedule) ? f : {
    startDate: (0, g.ib)()
  }), [Q, $] = i.useState(K && (null == F ? void 0 : F.schedule) != null), ee = (0, v.J)(k), et = (0, v.U)(k), en = null == V && ee && !K, [er, ei] = i.useState(en && et), el = (0, o.e7)([b.Z], () => b.Z.hasHotspot(E.v.LIVE_STAGE_NOTIFICATION_BADGE)), ea = C.j8.GUILD_ONLY, [eo] = i.useState(null != (P = null != (p = null == F ? void 0 : F.privacyLevel) ? p : null == V ? void 0 : V.privacy_level) ? P : ea), [es, ec] = i.useState(null == F ? void 0 : F.recurrenceRule), ed = (0, N._d)(k.id), eu = (0, N.K3)(k.id), [eh, eg] = i.useState(!1), e_ = (0, u.ZP)(k), em = (0, h.q)(A), eb = null != M, ef = em.length > 1;
  (0, d.ZP)(() => {
