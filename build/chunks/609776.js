...
function k(e) {
  ...
  let {
    ...
    defaultOptions: z,
    isSlideReady: M = !0
  } = e, J = i.useMemo(() => j.Z.getStageInstanceByChannel(P.id), [P.id]), [V, H] = i.useState(null != (n = null != (t = null == z ? void 0 : z.topic) ? t : null == J ? void 0 : J.topic) ? n : ""), [W, q] = i.useState(null != (l = null == z ? void 0 : z.description) ? l : ""), [K] = i.useState(U), [X, Y] = i.useState(null != (p = null == z ? void 0 : z.schedule) ? p : {
    startDate: (0, m.ib)()
  }), [Q, $] = i.useState(K && (null == z ? void 0 : z.schedule) != null), ee = (0, _.J)(P), et = (0, _.U)(P), en = null == J && ee && !K, [er, ei] = i.useState(en && et), el = (0, o.e7)([b.Z], () => b.Z.hasHotspot(S.v.LIVE_STAGE_NOTIFICATION_BADGE)), ea = O.j8.GUILD_ONLY, [eo] = i.useState(null != (k = null != (f = null == z ? void 0 : z.privacyLevel) ? f : null == J ? void 0 : J.privacy_level) ? k : ea), [es, ec] = i.useState(null == z ? void 0 : z.recurrenceRule), ed = (0, N._d)(P.id), eu = (0, N.K3)(P.id), [ex, em] = i.useState(!1), eh = (0, u.ZP)(P), eg = (0, x.q)(D), eb = null != F, ep = eg.length > 1;
  (0, d.ZP)(() => {
