...
function w(e) {
  ...
  let {
    ...
    defaultOptions: U,
    isSlideReady: z = !0
  } = e, F = i.useMemo(() => v.Z.getStageInstanceByChannel(P.id), [P.id]), [V, W] = i.useState(null != (n = null != (t = null == U ? void 0 : U.topic) ? t : null == F ? void 0 : F.topic) ? n : ""), [H, q] = i.useState(null != (l = null == U ? void 0 : U.description) ? l : ""), [J] = i.useState(M), [K, Y] = i.useState(null != (b = null == U ? void 0 : U.schedule) ? b : {
    startDate: (0, h.ib)()
  }), [X, Q] = i.useState(J && (null == U ? void 0 : U.schedule) != null), $ = (0, p.J)(P), ee = (0, p.U)(P), et = null == F && $ && !J, [en, er] = i.useState(et && ee), ei = (0, o.e7)([m.Z], () => m.Z.hasHotspot(C.v.LIVE_STAGE_NOTIFICATION_BADGE)), el = y.j8.GUILD_ONLY, [ea] = i.useState(null != (w = null != (f = null == U ? void 0 : U.privacyLevel) ? f : null == F ? void 0 : F.privacy_level) ? w : el), [eo, ec] = i.useState(null == U ? void 0 : U.recurrenceRule), es = (0, j._d)(P.id), ed = (0, j.K3)(P.id), [eu, eh] = i.useState(!1), eg = (0, d.ZP)(P), e_ = (0, u.q)(k), em = null != B, eb = e_.length > 1;
  (0, s.ZP)(() => {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsxs)(c.hzk, {
      ...
      children: [A, (0, r.jsx)("div", {
        ...
        children: null == F && (es > 0 || ed > 0) && (0, r.jsx)(N.mv, {
          channelId: P.id
        })
      }), (0, r.jsxs)("form", {
        onSubmit: ef,
        ...
        children: [(0, r.jsxs)(c.xJW, {
          ...
          children: [(0, r.jsx)(_.Z, {
            ...
            timeSelected: X,
            onTimeChange: Q
          }), null != K.startDate && K.startDate < a()() ? (0, r.jsx)(c.Text, {
            color: "text-danger",
            variant: "text-xs/normal",
            className: S.warning,
