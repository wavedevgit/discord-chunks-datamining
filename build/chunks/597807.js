...
function l(e) {
  ...
  return function e(l, o = false) {
    if ("BODY" === l.tagName) returntrue;
    if ("OPTION" === l.tagName || "OPTGROUP" === l.tagName) {
      let r = l.closest("select");
      return !!r && e(r, true)
    }
    if ("INPUT" === l.tagName && "hidden" == l.type.toLowerCase() || "NOSCRIPT" === l.tagName) returnfalse;
    ...
    return (!!t || !!n(l)) && !(!t && function e(t) {
      return "hidden" == function e(t) {
        ...
        function u(e) {
          ...
          if ("fixed" == t) return a = true, e == s ? null : s;
          {
            var l;
