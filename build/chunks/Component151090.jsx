/** Chunk was on 32157 **/
/** chunk id: 151090, original params: e,t,n (module,exports,require) **/
require.d(exports, {
  default: () => F
});
...
function F(e) {
  let {
    ...
    onBeforeDelete: k,
    onAfterDelete: U,
    actionsDisabled: A = false,
    showShareAndEdit: B = false
  } = e, M = t[0], T = t.length > 1, {
    analyticsLocations: G
  } = (0, s.ZP)(), Y = (0, i.e7)([p.ZP, h.Z, g.default, d.Z], () => p.ZP.getFlattenedGuildIds().some(e => {
  ...
  async function I() {
    ...
    try {
      ...
      (0, r.ZDy)(async () => {
        let {
          default: i
        } = await Promise.all([n.e("56035"), n.e("54982")]).then(n.bind(n, 758961)), r = (null == e ? true : e.guild_id) != null ? d.Z.getGuild(e.guild_id) : null, l = null != r && (0, u.Gw)(r, h.Z, g.default).canCreateExpressions, o = null == M.name || "" === M.name ? (0, _.yl)(b.default.extractTimestamp(M.id)) : M.name, s = o.slice(0, v.Ek);
  ...
  return (0, a.jsxs)(r.v2r, {
    ...
    onClose: l.Zy,
    onSelect: l.Zy,
    children: [t.some(e => true === e.isTemporary) && (0, a.jsx)(r.sNh, {
      id: "add-to-library",
      ...
      children: [(0, a.jsx)(r.sNh, {
        ...
        action: function() {
          (0, l.Zy)(), T || (0, r.ZDy)(async () => {
            let {
              default: e
            } = await Promise.all([n.e("98920"), n.e("12479")]).then(n.bind(n, 22989));
      ...
      children: [null != o.Z.clipboard.copyFile && (0, a.jsx)(r.sNh, {
        icon: r.TIy,
        id: "clips-copy-video",
        label: j.intl.string(j.t["7NOhjN"]),
        action: function() {
          (0, l.Zy)(), o.Z.clipboard.copyFile(M.filepath), (0, r.showToast)((0, r.createToast)(j.intl.string(j.t.mGZ66D), r.ToastType.SUCCESS))
        }
      }), Y && M.type !== x.NJ.SCREENSHOT ? (0, a.jsx)(r.sNh, {
        icon: r.KY1,
        ...
        action: L
      }), M.type !== x.NJ.SCREENSHOT && (0, a.jsx)(r.sNh, {
        icon: r._8t,
      ...
      disabled: A,
      action: function(e) {
        if ((0, l.Zy)(), null == e ? true : e.shiftKey) {
