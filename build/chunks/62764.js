...
function F(e) {
  let {
    ...
    ref: v,
    width: j
  } = (0, p.ZP)(), [O, k] = i.useState(3), [F, H] = i.useState(!n), [V, z] = (0, h.Z)(!1, 2e3), W = (0, o.e7)([S.Z], () => S.Z.getChannel(t), [t]), {
    firstMessage: Y
  } = (0, A.cl)(W), q = (0, o.e7)([I.Z], () => I.Z.hasJoined(t)), {
    disableReactionUpdates: K,
    disableReactionCreates: X,
    isLurking: Q,
    isGuest: J,
    isPendingMember: $
  } = (0, b.Z)(W), ee = (0, E.nw)(W), et = (0, o.e7)([S.Z], () => S.Z.getChannel(s)), en = (0, T.Bs)(et), er = (0, o.e7)([f.Z], () => f.Z.shouldDisplayPrompt(t) && !0 === n, [t, n]), ei = i.useCallback(e => {
    let t = e[0];
    if (null != t && n) {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        className: L.buttons,
        children: [ee ? (0, r.jsx)(G, {
          channel: W
        }) : (0, r.jsx)(c.ua7, {
          text: M.intl.string(M.t.F7oeDg),
          children: e => (0, r.jsxs)(c.zxk, B(U({}, e), {
            look: c.zxk.Looks.BLANK,
            size: c.zxk.Sizes.SMALL,
            onClick: es,
            className: L.button,
            innerClassName: a()(L.buttonInner, {
              [L.active]: q
            }),
            children: [(0, r.jsx)(ed, {
              size: "xs",
