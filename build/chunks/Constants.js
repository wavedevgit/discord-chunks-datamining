...
let B = new Set([Chunk275726.u.REPLY, Chunk275726.u.THREAD_STARTER_MESSAGE, Chunk275726.u.CONTEXT_MENU_COMMAND]);
var V = function(e) {
...
let ey = 100,
  ...
  ek = 32,
  eU = 6e5,
  eG = 6 * Chunk70956.Z.Seconds.HOUR,
  eZ = [0, 5, 10, 15, 30, Chunk70956.Z.Seconds.MINUTE, 2 * Chunk70956.Z.Seconds.MINUTE, 5 * Chunk70956.Z.Seconds.MINUTE, 10 * Chunk70956.Z.Seconds.MINUTE, 15 * Chunk70956.Z.Seconds.MINUTE, 30 * Chunk70956.Z.Seconds.MINUTE, +Chunk70956.Z.Seconds.HOUR, 2 * Chunk70956.Z.Seconds.HOUR, eG],
  eF = 10,
  eB = 0xa00000,
  eV = 524288e3,
  eH = e => "||".concat(e, "||"),
  eY = /^\|\|([\s\S]+?)\|\|/,
  eW = /^<id:(home|browse|customize|guide|linked-roles)(?::(\d+))?>/,
  eK = /^\d{17,19}$/;
var ez = function(e) {
...
let tY = Object.freeze({
  ...
  tW = new Set(["facebook", "contacts"]),
  tK = new Set(["spotify", "xbox", "playstation", "playstation-stg", "crunchyroll"]),
  tz = Object.freeze({
...
let rC = 100,
  rA = /(mfa\.[a-z0-9_-]{20,})|([a-z0-9_-]{23,28}\.[a-z0-9_-]{6,7}\.[a-z0-9_-]{27})/i;
var rN = function(e) {
