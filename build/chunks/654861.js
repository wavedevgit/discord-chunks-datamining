...
var r = function(e) {
  ...
  c.prototype = Object.create(l.prototype), u.prototype = Object.create(l.prototype), d.prototype = Object.create(l.prototype), c.prototype.add = function(e) {
    ...
    var n = this.value,
      r = t.value;
    return t.isSmall ? I(n, Math.abs(r), this.sign) : O(n, r, this.sign)
    ...
    var e = this.value;
    return this.sign ? I(e, 1, this.sign) : new c(b(e, 1), this.sign)
    ...
    var e = this.value;
    return this.sign ? new c(b(e, 1), !0) : I(e, 1, this.sign)
