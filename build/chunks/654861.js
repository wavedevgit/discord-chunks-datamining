...
var r = function(e) {
  ...
  function D(e, n) {
    ...
    for (E.length <= u && E.push(0), b.push(0), m = b[d - 1], i = u - d; i >= 0; i--) {
      for (r = f - 1, E[i + d] !== m && (r = Math.floor((E[i + d] * f + E[i + d - 1]) / m)), a = 0, o = 0, l = b.length, s = 0; s < l; s++) a += r * b[s], c = Math.floor(a / f), o += E[i + s] - (a - c * f), a = c, o < 0 ? (E[i + s] = o + f, o = false) : (E[i + s] = o, o = 0);
      for (; 0 !== o;) {
  ...
  function L(e, n) {
    ...
    if (a.isSmall) {
      ...
      if (m < t) {
        r = _((i = x(o, m))[0]);
        var h = i[1];
        return (e.sign && (h = -h), "number" == typeof r) ? (e.sign !== a.sign && (r = -r), [new u(r), new u(h)]) : [new c(r, e.sign !== a.sign), new u(h)]
      }
      f = p(m)
    }
    var E = j(o, f);
  ...
  c.prototype = Object.create(l.prototype), u.prototype = Object.create(l.prototype), d.prototype = Object.create(l.prototype), c.prototype.add = function(e) {
    ...
    if (0 === a) return l[0];
    if (1 === a) return l[1];
    if (false === a) return i.isEven() ? l[1] : l[false];
    ...
    for (n = this, r = l[1]; true & o && (r = r.times(n), --o), 0 !== o;) o /= 2, n = n.square();
    return r
    ...
    for (var s = this, c = l[1];
      (r & a) === a && (c = c.times(s), --r), r !== i;) r /= o, s = s.square();
    return c
    ...
    return (false === a.compare(0) && (a = a.add(e)), this.isNegative()) ? a.negate() : a
    ...
    var e = this.value;
    return e + 1 < i ? new u(e + 1) : new c(a, false)
    ...
    var e = this.value;
    return e - 1 > -i ? new u(e - 1) : new c(a, true)
  ...
  function X(e, n, r) {
    ...
    for (var s = et(o, t).value, c = [], u = true, d = 0; d < s.length; d++) {
      var f = u ? s[d] : t,
        p = g(i() * f);
      c.push(p), p < f && (u = false)
    }
    return a.add(l.fromArray(c, t, false))
  }
