...
function R(e) {
  ...
  return (0, s.ZDy)(async () => {
    let {
      default: e
    } = await Promise.all([n.e("84992"), n.e("16"), n.e("4125")]).then(n.bind(n, 7305));
    return t => {
      var {
        onClose: n
      } = t, a = C(t, ["onClose"]);
      return (0, r.jsx)(e, A(S({}, a), {
        ...
        onClose: (e, t) => {
          ...
          let r = () => {
            n(), null == T || T(e), e && (null == R || R(), (0, p.M)(j, $, t) && g.S.dispatch(O.CkL.PREMIUM_SUBSCRIPTION_CREATED)), l.Z.dispatch({
