/** Chunk was on web (https://canary.discord.comweb.6d4953f88f353958.js.js) **/ ! function(e, n) {
  n(t)
}(0, function(e) {
  "use strict";
  ...
  function X(e, t) {
    ...
    for (var n = 0; n < e.length; n++)
      for (var r = e[n], i = n === e.length - 1 ? e[0] : e[n + 1]; L(r, i) > t;) i = M(r, i, .5), e.splice(n + 1, 0, i)
  }
  ...
  function eF(e, t, n) {
    ...
    return o ? (e.every(function(e) {
      ...
      return "string" == typeof e
    }) && (s = t.slice(0))) : (a = e.slice(0), s = t.slice(0)), eV(c, u, {
      string: i,
      single: o,
      t0: a,
      t1: s,
  ...
  e.interpolate = tO, e.separate = eB, e.combine = eZ, e.interpolateAll = eF, e.splitPathString = W, e.toPathString = H, e.fromCircle = eH, e.toCircle = eW, e.fromRect = eY, e.toRect = eK, Object.defineProperty(e, "__esModule", {
    value: !0
  })
})