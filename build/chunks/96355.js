/** Chunk was on web.js **/ ! function(e, n) {
  ...
  function l(e) {
    var t, n = (t = e.path[e.segmentStart]).toLowerCase(),
      r = e.data;
  ...
  function E(e, t, n, r, i, a, o, s) {
    this.a = {
      ...
      x: o,
      y: s
    }, null != o && null != s ? (this.getArcLength = C, this.getPoint = I, this.getDerivative = y) : (this.getArcLength = S, this.getPoint = O, this.getDerivative = b), this.init()
  }
  ...
  function en(e, t, n, r, i) {
    var a, o;
    if (i === eP(e, t, n, r) > 0)
      for (a = t; a < n; a += r) o = eA(a, e[a], e[a + 1], o);
    else
      for (a = n - r; a >= t; a -= r) o = eA(a, e[a], e[a + 1], o);
  ...
  function eF(e, t, n) {
    ...
    return a ? (e.every(function(e) {
      ...
      return "string" == typeof e
    }) && (s = t.slice(0))) : (o = e.slice(0), s = t.slice(0)), eZ(c, u, {
      string: i,
      single: a,
      t0: o,
      t1: s,
  ...
  function eZ(e, t, n) {
    ...
    if (s && Array.isArray(a) && (a = l.map(function(e) {
      ...
      return r && (a || o) ? function(e) {
        return e < 1e-4 && a || 1 - e < 1e-4 && o || u(e)
      } : u
    }
  ...
  function ez(e, t, n, r, i) {
    ...
    void 0 === o && (o = !0);
    var s, l = J(t, a);
    return G(r) && l.length < r / a && Q(l, Math.ceil(r / a - l.length)), s = j(e(l), l, o), o ? function(e) {
      return e < 1e-4 ? n : s(e)
    } : s
  }
  ...
  var e6 = d,
    ...
    te = function(e) {
      var t, n, r = new e6;
      return e.split(e7).forEach(function(e) {
        if (e.length) {
  ...
  m.prototype.__matrix = function(e) {
    ...
    return this.iterate(function(e, t, n, r) {
      var i, a, o, s = [],
        l = e[0];
      return "A" !== l && "a" !== l ? null : ("a" === l ? (a = n + e[6], o = r + e[7]) : (a = e[6], o = e[7]), 0 === (i = tn(n, r, a, o, e[4], e[5], e[1], e[2], e[3])).length ? [
        ["a" === e[0] ? "l" : "L", e[6], e[7]]
    ...
    return this.iterate(function(o, s, l, c) {
      var u, d = o[0],
        f = d.toUpperCase();
  ...
  E.prototype = {
    ...
    getPropertiesAtLength: function(e) {
      var t, n = v(e, this.length, this.getArcLength, [this.a.x, this.b.x, this.c.x, this.d.x], [this.a.y, this.b.y, this.c.y, this.d.y]),
  ...
  et.deviation = function(e, t, n, r) {
    var i = t && t.length,
      a = i ? t[0] * n : e.length,
      o = Math.abs(eP(e, 0, a, n));
    if (i)
      for (var s = 0, l = t.length; s < l; s++) {
        var c = t[s] * n,
          u = s < l - 1 ? t[s + 1] * n : e.length;
        o -= Math.abs(eP(e, c, u, n))
      }
    var d = 0;
      ...
      for (var s in e.forEach(r), i)
        for (var l = i[s], c = l.length, u = 0; u < c; ++u)
          for (var d = u + 1; d < c; ++d) {
            var f, _ = l[u],
              p = l[d];
            (f = a[_])[s = tP(f, p)] !== p && f.splice(s, 0, p), (f = a[p])[s = tP(f, _)] !== _ && f.splice(s, 0, _)
          }
      return a
    },
    tw = function(e, t) {
  ...
  e.interpolate = tO, e.separate = eB, e.combine = eV, e.interpolateAll = eF, e.splitPathString = Y, e.toPathString = H, e.fromCircle = eH, e.toCircle = eY, e.fromRect = eW, e.toRect = eK, Object.defineProperty(e, "__esModule", {
    value: !0
  })
})