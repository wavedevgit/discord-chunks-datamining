...
function S(e) {
  ...
  let {
    ...
    guildId: C
  }), P = (0, r.e7)([h.Z], () => h.Z.get(k), [k]);
  (0, I.p2)();
  let L = (0, c.Z)((0, s.Z)()),
    T = (0, r.e7)([_.ZP, x.default], () => _.ZP.isMember(C, x.default.getId())),
    A = i.useMemo(() => {
      if (null == j) return 0;
      let e = parseInt(j, 10);
      return isNaN(e) || null != S && null != S.storefront && e >= S.storefront.pages.length ? 0 : e
    }, [j, S]),
    M = null != (a = null == S || null == (t = S.storefront) || null == (n = t.pages[A]) ? true : n.title) ? a : null,
    y = i.useMemo(() => ({
      sessionId: L,
      guildId: C,
      pageIndex: A,
  ...
  return (i.useEffect(() => {
    null != C && (0, m.m0)(C, A, null != k ? k : null)
