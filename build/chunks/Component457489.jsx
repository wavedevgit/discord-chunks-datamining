...
function L(e) {
  ...
  return i.useEffect(() => {
    if (null != d) return (0, j.g)({
      ...
      onClose: () => {
        (0, g.s1)().location.pathname.indexOf(N.Z5c.CHANNELS_GAME_SHOP(t, a)) >= 0 && (0, C.Z)({
          guildId: t,
          pageIndex: a
        })
      }
...
function R(e) {
  ...
  }), A = (0, r.e7)([I.default], () => I.default.getSessionId(), []), M = (0, r.e7)([_.Z], () => _.Z.get(N), [N]);
  (0, p.p2)();
  let O = (0, c.Z)((0, s.Z)()),
  ...
  return (i.useEffect(() => {
    null != S && (0, b.m0)(S, y, null != N ? N : null)
  }, [S, y, N]), i.useEffect(() => {
