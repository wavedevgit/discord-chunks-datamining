...
function L(e) {
  ...
  return i.useEffect(() => {
    if (null != d) return (0, b.g)({
      ...
      onClose: () => {
        (0, p.s1)().location.pathname.indexOf(N.Z5c.CHANNELS_GAME_SHOP(t, a)) >= 0 && (0, k.Z)({
          guildId: t,
          pageIndex: a
        })
      }
...
function R(e) {
  ...
  }), A = (0, r.e7)([I.default], () => I.default.getSessionId(), []), M = (0, r.e7)([x.Z], () => x.Z.get(N), [N]);
  (0, _.p2)();
  let O = (0, c.Z)((0, s.Z)()),
  ...
  return (i.useEffect(() => {
    null != S && (0, v.m0)(S, y, null != N ? N : null)
  }, [S, y, N]), i.useEffect(() => {
