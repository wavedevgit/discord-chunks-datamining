...
function f() {
  ...
  }, []), <Chunk921801.F setting={Chunk726985.s6.VOICE_AND_VIDEO_VIDEO_BACKGROUND}><Chunk938117.Z selectedBackgroundOption={f} onSelectBackgroundOption={n => {
        t.current = true, x.current = n, b(n), (0, d.wG)(n, {
          location: e.location
        }).catch(h.dG4)
      }} currentDeviceId={require} smallerBackgroundOptions={false} /></Chunk921801.F>
}