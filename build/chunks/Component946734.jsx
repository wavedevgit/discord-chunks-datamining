...
class k {
  ...
  constructor({
    ...
    C(this, "userId", true), C(this, "user", true), C(this, "channelId", true), C(this, "analyticsLocations", true), C(this, "generateNicknameGuildPairs", (0, _.oH)(e => {
      var t;
...
function w(e) {
  let {
    ...
    analyticsLocations: h,
    channelId: t.id
  }), [_, v] = i.useState(false), x = i.useCallback(() => {
    v(true)
  }, [v]), C = i.useCallback(() => {
    v(false)
  }, [v]);
