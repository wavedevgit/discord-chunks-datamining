...
function O(e) {
  let {
    ...
    maxValues: v,
    disabled: I
  } = t, [T, S] = i.useState(!1), [A, N] = i.useState(!1), [C, R] = i.useState(new Map(null == g ? void 0 : g.map(e => [e.value, e]))), [P, w] = i.useState(new Set(C.keys())), [D, L] = i.useState(() => (null != g ? g : []).map(e => e.value)), [x, M] = i.useState(0);
  i.useEffect(() => {
