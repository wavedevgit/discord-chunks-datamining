...
function S(e) {
  ...
  return (0, n.jsxs)("div", {
    ...
    children: [(0, n.jsx)(o.q4e, {
      ...
      "aria-label": x.intl.formatToPlainString(x.t["2LwBlJ"], {
        filterNumber: t + 1
      }),
...
function O(e) {
  let {
    ...
    onClose: l,
    searchContext: a
  } = e, i = (0, d.Dt)(), S = r.useMemo(() => (0, p.s5)(a), [a]), O = (0, u.e7)([h.Z, f.Z], () => {
  ...
  } = (0, b.HJ)(a, m.dCx.FILTER_MENTIONS), L = (0, b.Zc)(S), M = (0, p.R6)(a), {
    options: Q,
    query: q,
    setQuery: A,
    handleClearFilter: B,
  ...
  } = (0, b.fI)(), ei = r.useMemo(() => F.length + N.length + q.length + z.length + $.length, [F, N, q, z, $]), eu = r.useCallback(() => {
  ...
  }, [ea, R, H, Y, w, ei, l]), es = r.useCallback(() => {
    _(), D(), B(), W(), er(), g.S.dispatch(m.CkL.SET_SEARCH_QUERY, {
      query: "",
      anchor: 0,
      focus: 0,
      performSearch: !1
  ...
  return (0, n.jsxs)(s.Modal, {
    ...
    children: [(0, n.jsx)(j, C({
      ...
      textPlaceholder: x.intl.formatToPlainString(x.t.K4l509, {
        channelName: O
      }),
      value: z,
      onChange: J,
