...
function v(e) {
  let {
    ...
    onClose: l,
    searchContext: a
  } = e, i = (0, d.Dt)(), y = r.useMemo(() => (0, m.s5)(a), [a]), v = (0, s.e7)([h.Z, x.Z], () => {
    let e = h.Z.getChannel(x.Z.getChannelId());
    return null != e ? (0, m.nl)(e) : "general"
  }), j = (0, p.gI)(a), {
    searchFilters: E
  } = (0, p.hE)(j), T = r.useMemo(() => (0, m.nI)(j), [j]), R = r.useMemo(() => [...E[C.dCx.FILTER_BEFORE], ...E[C.dCx.FILTER_AFTER], ...E[C.dCx.FILTER_ON]], [E]), {
    options: I,
    query: O,
    setQuery: N,
    setQueryString: k,
  ...
  } = (0, p.HJ)(a, C.dCx.FILTER_MENTIONS, E[C.dCx.FILTER_MENTIONS]), B = (0, p.Zc)(y), H = (0, m.R6)(a), {
    options: Z,
    query: z,
    setQuery: J,
    handleClearFilter: W,
    ...
    handleClearFilter: G,
    getApplyQueryString: $
  } = (0, p.ur)(a, E[C.dCx.FILTER_IN]), ee = r.useCallback(e => {
    if (null == e) return;
  ...
  } = (0, p.fI)(R), eu = r.useMemo(() => O.length + D.length + z.length + U.length + en.length, [O, D, z, U, en]), ed = r.useCallback(() => {
  ...
  }, [ec, P, Y, $, w, T, eu, l]), eh = r.useCallback(() => {
    L(), A(), W(), G(), eo(), g.S.dispatch(C.CkL.SET_SEARCH_QUERY, {
      query: T,
      anchor: 0,
      focus: 0,
      performSearch: !1,
