...
function b(e) {
  let {
    ...
    onClose: r,
    searchContext: b
  } = e, m = (0, u.Dt)(), x = l.useMemo(() => (0, c.s5)(b), [b]), {
    options: S,
    query: y,
    setQuery: C,
    setQueryString: v,
  ...
  } = (0, o.H)(b, d.dCx.FILTER_MENTIONS), P = (0, o.Z)(x), M = l.useMemo(() => y.length + O.length, [y, O]), N = l.useCallback(() => {
  ...
  }, [j, R, r]), Q = l.useCallback(() => {
    E(), T(), s.S.dispatch(d.CkL.SET_SEARCH_QUERY, {
      query: "",
      anchor: 0,
      focus: 0,
      performSearch: !1
