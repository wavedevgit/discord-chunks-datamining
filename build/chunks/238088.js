...
function b(e) {
  let {
    ...
    onClose: l,
    searchContext: b
  } = e, m = (0, u.Dt)(), x = r.useMemo(() => (0, c.s5)(b), [b]), {
    options: C,
    query: S,
    setQuery: y,
    setQueryString: v,
  ...
  } = (0, o.HJ)(b, d.dCx.FILTER_FROM), {
    options: O,
    query: j,
    setQuery: _,
    setQueryString: F,
    handleClearFilter: R,
    getApplyQueryString: T
  } = (0, o.HJ)(b, d.dCx.FILTER_MENTIONS), P = (0, o.Zc)(x), {
    options: M,
    query: I,
    setQuery: N,
    handleClearFilter: Q,
    getApplyQueryString: q
  } = (0, o.Z2)(b), H = r.useMemo(() => S.length + j.length + I.length, [S, j, I]), Z = r.useCallback(() => {
  ...
  }, [E, q, T, l]), A = r.useCallback(() => {
    k(), R(), Q(), s.S.dispatch(d.CkL.SET_SEARCH_QUERY, {
      query: "",
      anchor: 0,
      focus: 0,
      performSearch: !1
