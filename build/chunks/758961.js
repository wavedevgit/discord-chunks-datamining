...
function O(e) {
  ...
  let {
    ...
    transitionState: M,
    showGuildPicker: k = !1
  } = e, [I, T] = a.useState(null != (n = null != (t = null == E ? void 0 : E.name) ? t : null == P ? void 0 : P.name) ? n : ""), [D, R] = a.useState(null != (i = null == P ? void 0 : P.volume) ? i : 1), [_, F] = a.useState(null == P ? void 0 : P.emojiId), [A, B] = a.useState(null == P ? void 0 : P.emojiName), {
    file: U,
    loadAudioFromFile: z,
    maxVolume: L,
    setMaxVolume: G
  } = (0, b.p)(), [H, W] = a.useState(!1), [q, V] = a.useState(null), [J, Y] = a.useState(null), [K, X] = a.useState("ready"), [Q, $] = a.useState(O);
  async function ee(e) {
    try {
  ...
  return (0, l.jsxs)(u.Modal, {
    ...
    actions: ec,
    children: [null != q && !q.hasFieldErrors() && (0, l.jsx)(c.kzN, {
      className: C.section,
      children: q.message
    }), k ? (0, l.jsx)(c.xJW, {
      required: !0,
    ...
    }) : null, (ea || null != U) && (0, l.jsx)(y.Z, {
      sound: P,
      volume: D,
      disabled: el,
      onChange: Y
    }), ea || null != E ? null : (0, l.jsx)(c.xJW, {
      required: !0,
