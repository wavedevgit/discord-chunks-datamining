...
function S(e) {
  ...
  let {
    ...
    transitionState: k,
    showGuildPicker: Z = !1
  } = e, [M, I] = a.useState(null != (n = null != (t = null == O ? void 0 : O.name) ? t : null == P ? void 0 : P.name) ? n : ""), [T, _] = a.useState(null != (r = null == P ? void 0 : P.volume) ? r : 1), [D, R] = a.useState(null == P ? void 0 : P.emojiId), [F, W] = a.useState(null == P ? void 0 : P.emojiName), {
    file: z,
    loadAudioFromFile: A,
    maxVolume: B,
    setMaxVolume: L
  } = (0, y.p)(), [U, G] = a.useState(!1), [H, q] = a.useState(null), [V, Y] = a.useState(null), [J, X] = a.useState("ready"), [K, Q] = a.useState(S);
  async function $(e) {
    try {
  ...
  let et = function(e) {
    ...
    el = null != P,
    ea = M.length >= 2 && (el || null != z) && null != K && function(e) {
      if (null == e) return !0;
    ...
    es = a.useCallback(async () => {
      ...
      try {
        el ? await (0, g.$d)({
          ...
          emojiId: D,
          emojiName: F
        }) : (await ei(), (0, u.showToast)((0, u.createToast)(N.NW.string(N.t.T7dhBA), u.ToastType.SUCCESS))), E()
      } catch (e) {
        ee(e)
      } finally {
        X("ready"), G(!1), _(1), L(1)
