...
function S(e) {
  ...
  let {
    ...
    transitionState: k,
    showGuildPicker: Z = !1
  } = e, [M, I] = a.useState(null != (n = null != (t = null == O ? void 0 : O.name) ? t : null == P ? void 0 : P.name) ? n : ""), [T, _] = a.useState(null != (i = null == P ? void 0 : P.volume) ? i : 1), [D, R] = a.useState(null == P ? void 0 : P.emojiId), [F, z] = a.useState(null == P ? void 0 : P.emojiName), {
    file: A,
    loadAudioFromFile: B,
    maxVolume: L,
    setMaxVolume: U
