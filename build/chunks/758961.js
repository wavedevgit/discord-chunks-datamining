...
function S(e) {
  ...
  let {
    ...
    transitionState: Z,
    showGuildPicker: M = !1
  } = e, [k, I] = a.useState(null != (n = null != (t = null == O ? void 0 : O.name) ? t : null == E ? void 0 : E.name) ? n : ""), [T, D] = a.useState(null != (i = null == E ? void 0 : E.volume) ? i : 1), [R, _] = a.useState(null == E ? void 0 : E.emojiId), [F, z] = a.useState(null == E ? void 0 : E.emojiName), {
    file: A,
    loadAudioFromFile: B,
    maxVolume: U,
    setMaxVolume: L
  ...
  let et = function(e) {
    ...
    el = null != E,
    ea = k.length >= 2 && (el || null != A) && null != K && function(e) {
      if (null == e) return !0;
    ...
    es = a.useCallback(async () => {
      ...
      try {
        el ? await (0, g.$d)({
          ...
          emojiId: R,
          emojiName: F
        }) : (await er(), (0, u.showToast)((0, u.createToast)(w.intl.string(w.t.T7dhBA), u.ToastType.SUCCESS))), P()
      } catch (e) {
        ee(e)
      } finally {
        X("ready"), H(!1), D(1), L(1)
