...
let j = s.Z.Types,
  x = function(e) {
    ...
    return (i.useEffect(() => {
      (null == t ? void 0 : t.type) === _.IIU.HANG_STATUS && E && b.default.track(_.rMx.VIEW_HANG_STATUS, {
        source: "UserProfilePopout",
        guild_id: null == C ? void 0 : C.guild_id,
        channel_id: null == C ? void 0 : C.id
      })
    }, [null == t ? void 0 : t.type, E, C]), (null == t ? void 0 : t.type) !== _.IIU.HANG_STATUS || E) ? (0, r.jsx)(s.Z, S(O({}, j), {
      activity: t,
      user: n,
      application: A,
      hideHeader: v,
