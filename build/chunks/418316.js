...
function g(e) {
  var t, n, r, g, m, b, _, O, y, v, C, j, S, E, x;
  let {
    item: I,
    renderApplication: P
  } = e, N = null != (r = null == (t = I.other_user) ? void 0 : t.id) ? r : h.lds, w = u.ZP.getName(s.default.getUser(null == (n = I.other_user) ? void 0 : n.id)), Z = I.applicationId;
  switch (I.type) {
    ...
    case d.DY.GUILD_SCHEDULED_EVENT_STARTED:
      let L = I.guild_scheduled_event_id,
        ...
        U = null == (S = o.Z.getGuild(null == M ? void 0 : M.guild_id)) ? void 0 : S.name,
        G = (0, l.Z2)(null != M ? M : void 0);
      return (0, c.Ew)(U) || (0, c.Ew)(k) || !G ? null != (E = I.body) ? E : "" : p.intl.format(p.t.AyvfXV, {
        event_name: k,
        guild_name: U
      });
