  ...
  switch (I.type) {
    case d.O7.FRIEND_REQUESTS_GROUPED:
      let w = u.ZP.getName(s.default.getUser(null == (g = I.other_users) || null == (h = g[0]) ? void 0 : h.id)),
        ...
        R = Math.max((null != (y = null == (E = I.other_users) ? void 0 : E.length) ? y : 0) - 2, 0);
    ...
    case d.O7.MOBILE_NATIVE_UPDATE_AVAILABLE:
      let k = null != (v = null == (x = I.local_id) ? void 0 : x.split("_").pop()) ? v : "unknown";
    ...
    case d.DY.GUILD_SCHEDULED_EVENT_STARTED:
      let D = I.guild_scheduled_event_id,
        ...
        U = null == (C = a.Z.getGuild(null == L ? void 0 : L.guild_id)) ? void 0 : C.name,
        F = (0, l.Z2)(null != L ? L : void 0);
      return (0, c.Ew)(U) || (0, c.Ew)(M) || !F ? null != (j = I.body) ? j : "" : m.intl.format(m.t.AyvfXV, {
        event_name: M,
        guild_name: U
      });
    ...
    case d.O7.INCOMING_GAME_FRIEND_REQUESTS_ACCEPTED:
      return i()(null != A, "Expected application id for ".concat(I.type)), m.intl.format(m.t["BB/0vr"], {
        username: P,
        applicationName: () => N(A)
      });
    case d.O7.INCOMING_GAME_FRIEND_REQUESTS:
      return i()(null != A, "Expected application id for ".concat(I.type)), m.intl.format(m.t["7cqOLC"], {
        username: P,
        applicationName: () => N(A)
      });
    case d.DY.GAME_FRIEND_REQUEST_ACCEPTED:
      if (null == A) return I.body;
      return m.intl.format(m.t.Wi64vL, {
        username: P,
        applicationName: () => N(A)
      })
  }
