...
function h(e) {
  var t, n, r, h, g, _, b, x, y, v, E, N, O, j, C;
  let {
    item: S,
    renderApplication: I
  } = e, T = null != (r = null == (t = S.other_user) ? void 0 : t.id) ? r : p.lds, P = u.ZP.getName(s.default.getUser(null == (n = S.other_user) ? void 0 : n.id)), A = S.applicationId;
  switch (S.type) {
    ...
    case d.O7.INCOMING_GAME_FRIEND_REQUESTS_ACCEPTED:
      return i()(null != A, "Expected application id for ".concat(S.type)), m.NW.format(m.t["BB/0vr"], {
        username: P,
        applicationName: () => I(A)
      });
    case d.O7.INCOMING_GAME_FRIEND_REQUESTS:
      return i()(null != A, "Expected application id for ".concat(S.type)), m.NW.format(m.t["7cqOLC"], {
        username: P,
        applicationName: () => I(A)
      });
