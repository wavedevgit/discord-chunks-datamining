...
class k extends Chunk73800.PureComponent {
  ...
  render() {
    ...
    return null == Chunk73800 ? null : <Chunk503089.ZP theme={module} sidebarTheme={exports} section={null != require ? require : Chunk981631.CoT.OVERVIEW} onSetSection={Chunk787014.zc} onClose={Chunk37234.xf} sections={function(e) {
        let {
          channel: t,
          category: n,
          canManageRoles: l,
...
function B() {
  ...
  return <k channel={module} category={Chunk471445} canManageChannels={(null == module ? true : module.isThread()) ? Chunk787014 : Chunk503089} canDeleteChannels={(null == module ? true : module.isThread()) ? Chunk37234 : Chunk503089} canManageRoles={Chunk493544} canManageWebhooks={Chunk367907} canUnlinkChannel={Chunk933557} formState={require} theme={Chunk481060} sidebarTheme={Chunk570140} section={Chunk73800} analyticsLocation={exports} />
}