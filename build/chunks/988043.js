...
function C(e) {
  let {
    ingress: t,
    guildId: n
  } = e, b = (0, m.c_)(), C = d.h2.useSetting().includes(n), O = (0, c.q)(), S = (0, u.r)(), v = r.useCallback(e => {
    let i = (0, o.YK)();
    e ? i.delete(n) : i.add(n), d.h2.updateSetting(Array.from(i)), a.default.track(E.rMx.USER_SERVER_PRIVACY_SETTINGS_ACTION, {
