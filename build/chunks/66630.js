...
function M(t) {
  ...
  }), q = (0, N.a)(), [X, Q] = a.useState(null != (e = null == q ? void 0 : q.state) ? e : ""), [$, J] = a.useState(null != (n = null == q ? void 0 : q.emoji) ? n : null), [tt, te] = a.useState((0, _.Z)()), tn = a.useRef(null), tl = a.useRef(null), ta = a.useRef(null), [tr, ti] = a.useState(null != q && V ? (0, P.Z)(q) : null), [to, ts] = a.useState(H), [tu, tc] = a.useState(() => W && null != Y ? Y.label() : L.intl.string(L.t["xod36+"])), [td, tm] = a.useState(tu), {
    ref: tf,
    width: tp
  } = (0, m.ZP)(tu);
  a.useEffect(() => {
