...
function L(t) {
  ...
  }), W = (0, T.a)(), [H, K] = r.useState(null != (e = null == W ? void 0 : W.state) ? e : ""), [V, G] = r.useState(null != (n = null == W ? void 0 : W.emoji) ? n : null), [q, X] = r.useState((0, O.Z)()), $ = r.useRef(null), J = r.useRef(null), Q = r.useRef(null), [tt, te] = r.useState(null != W && Y ? (0, _.Z)(W) : null), [tn, tl] = r.useState(U), [tr, ta] = r.useState(() => M && null != B ? B.label() : D.intl.string(D.t["xod36+"])), [ti, to] = r.useState(tr), {
    ref: ts,
    width: tu
  } = (0, c.ZP)(tr);
  r.useEffect(() => {
