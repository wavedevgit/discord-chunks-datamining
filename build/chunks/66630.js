...
function L(t) {
  ...
  }), H = (0, T.a)(), [K, V] = r.useState(null != (e = null == H ? void 0 : H.state) ? e : ""), [G, q] = r.useState(null != (n = null == H ? void 0 : H.emoji) ? n : null), [X, $] = r.useState((0, O.Z)()), J = r.useRef(null), Q = r.useRef(null), tt = r.useRef(null), [te, tn] = r.useState(null != H && F && null == U ? (0, _.Z)(H) : U), [tl, tr] = r.useState(M), [ta, ti] = r.useState(() => null != U ? (0, P.Z)(U) : z && null != B ? B.label() : D.intl.string(D.t["xod36+"])), [to, ts] = r.useState(ta), {
    ref: tu,
    width: tc
  } = (0, c.ZP)(ta);
  r.useEffect(() => {
