    ...
    T = i.useCallback(() => {
      (0, s.ZDy)(async () => {
        ...
        return n => {
          ...
          return <e otherUserId={E} channelId={t} warningId={m} warningType={d.pj.INAPPROPRIATE_CONVERSATION_TIER_2} transitionState={i} onClose={o} />
        }
      }, {
        modalKey: p.X_
    ...
    N = i.useCallback(() => {
      (0, s.ZDy)(async () => {
        ...
        return n => {
          ...
          return <e transitionState={i} onBlock={S} onBlockAndReport={A} onCancel={() => {
              null == o || o(), I(f.NM.USER_BANNER_BLOCK_CANCEL)
            }} onClose={o} userId={E} channelId={t} />
        }
      })
    }, [S, A, E, t, I]);
  return <_.Q channelId={t} warningId={m} senderId={E} warningType={d.pj.INAPPROPRIATE_CONVERSATION_TIER_2} header={h.intl.string(h.t.ZzlB5u)} description={h.intl.string(h.t["D1aU+v"])} onDismiss={y} buttons={[{
