...
function m(e) {
  ...
  let {
    ...
    group: g,
    powerups: x
  } = e, [b, h] = i.useState(false), j = (0, o.e7)([s.Z], () => s.Z.useReducedMotion), Z = (0, f.Z)(g, v), C = !j && b ? null == Z || null == (t = Z.image) ? true : t.animatedUrl : null == Z || null == (n = Z.image) ? true : n.staticUrl, _ = (0, u.Z)({
    guildId: v,
    powerups: x
  }), {
    textColor: w
