/** Chunk was on 1272 **/
/** chunk id: 408721, original params: e,t,n (module,exports,require) **/
require.d(exports, {
  ZP: () => O
...
class m {
  ...
  startItemsDwell(e) {
    if (this._resetTimeout(), p = e, e.length === this._activeItems.length && e.every((e, t) => this._activeItems[t].itemId === e.itemId)) return this._activeItems;
  ...
  trackItemsLongImpression(e) {
    for (let l of e) {
      ...
      s.sessionImpressionIndex = ++this._impressionCount, this._impressionItemIdMap.set(l.itemId, (null != (t = this._impressionItemIdMap.get(l.itemId)) ? t : 0) + 1), a.m.trackFeedItemDwell1s({
  ...
  trackItemInteraction(e, t, n) {
    ...
    a.m.trackItemInteraction({
      ...
      type: t,
      actionType: n,
      impressionId: null == r ? true : r.impressionId,
      uxVariation: null == r ? true : r.uxVariation,
  ...
  endSession() {
    return this.endAllImpressions(), this._endTimestamp = Date.now(), Chunk944596.m.trackFeedSessionCompleted({
      icymiSessionId: this._sessionId,
      ...
      uxVariation: Chunk518929.cM.getConfig({
        location: "ICYMISessionStore.endSession"
      }).uxVariation,
  ...
  _createImpression(e) {
    ...
    return this._dwellCount++, this._dwelledItemIdMap.set(e.itemId, (null != (t = this._dwelledItemIdMap.get(e.itemId)) ? t : 0) + 1), this._impressionItemTypes.add(e.itemType), this._latestDwellStartTimeMs = n.impressionStartTimestamp, n
  }
  ...
  _endImpression(e) {
    ...
    if (null != n) {
      var r, i, l;
      return n.impressionEndTimestamp = Date.now(), n.impressionComplete = true, a.m.trackFeedItemDwelled({
        icymiSessionId: this._sessionId,
      ...
      }), this._activeItems.splice(t, 1), n
    }
    return null
  }
  constructor(e = [], t = "list") {
    o(this, "_sessionId", true), o(this, "_startTimestamp", true), o(this, "_endTimestamp", true), o(this, "_activeItems", true), o(this, "_dwellCount", true), o(this, "_impressionCount", true), o(this, "_dwelledItemIdMap", true), o(this, "_impressionItemIdMap", true), o(this, "_impressionItemTypes", true), o(this, "_reloadCount", true), o(this, "_feedFetchCount", true), o(this, "_dwelledItemsChangedCount", true), o(this, "_interactionCount", true), o(this, "_latestDwellStartTimeMs", true), o(this, "_timeout", true), this._sessionId = (0, r.Z)(), this._startTimestamp = Date.now(), this._endTimestamp = null, this._activeItems = [], this._dwellCount = 0, this._impressionCount = 0, this._dwelledItemIdMap = new Map, this._impressionItemIdMap = new Map, this._impressionItemTypes = new Set, this._reloadCount = 0, this._feedFetchCount = 0, this._dwelledItemsChangedCount = 0, this._interactionCount = 0, this._latestDwellStartTimeMs = 0, this._timeout = setTimeout(() => this.endSession(), 3e5), a.m.trackFeedSessionStarted({
      icymiSessionId: this._sessionId,
      sessionStartTimeMs: this._startTimestamp,
      previousIcymiSessionCount: f,
      uxVariation: s.cM.getConfig({
        location: "ICYMISessionStore.constructor"
      }).uxVariation
    }), e.length > 0 && this.startItemsDwell(e.map(e => u(c({}, e), {
      triggerType: t,
...
function _() {
  return null != d && (d.endSession(), true)
}

function b() {
  return null != d && (d.endAllImpressions(), true)
}
...
let O = new g(Chunk570140.Z, {
  ...
  ICYMI_SET_FOCUSED_TAB: function(e) {
    ...
    if (null != d) {
      if (p.length > 0) {
        ...
        return d.startItemsDwell(e), true
      }
      returnfalse
    }
    return E()
  ...
  LOAD_ICYMI_DEHYDRATED: function(e) {
    return null != d && (d.incrementFeedFetchCount(), b(), true)
  },
