...
function Z(e) {
  ...
  n.useEffect(() => {
    !async function() {
      ...
      null != e && a(E.NW.formatToPlainString(u.defaultName, {
        username: e.username
      }))
    }()
  }, [u.defaultName]), (0, v.Z)(e);
  let h = (0, s.jsxs)(s.Fragment, {
      children: [t ? (0, s.jsx)(j.Z, {
        guildTemplate: e
      }) : null, (0, s.jsx)("div", {
        className: W.icon,
  ...
  return {
    ...
    handleSubmit: () => {
      g.Z.acceptGuildTemplate(e.code, r, i).then(() => {
        (0, o.pTH)(), (0, m.Ou)()
      }).catch(e => d(e))
    }
  }
  ...
  let {
    ...
    return (0, s.jsxs)("div", {
      className: i()(W.channel, {
        [W.category]: e.type === H.d4z.GUILD_CATEGORY
      }),
      children: [(0, s.jsx)(t, {
...
function M(e) {
  let {
    guildId: t,
    roles: r
  } = e, n = r.slice().reverse().map(e => (0, s.jsx)(_, {
    guildId: t,
    role: e
  }, e.id));
  return (0, s.jsx)("ul", {
...
function _(e) {
  ...
  let {
    guildId: n,
    role: a
  } = e, i = (0, o.dQu)(u.Z.colors.BORDER_SUBTLE).hex(), l = null == a.color ? i : (0, d.Rf)(a.color), c = (0, h.X)(n, a.colorStrings);
  return (0, s.jsxs)("li", {
    className: W.role,
    style: {
      borderColor: null != (t = (0, d.wK)(l, .6)) ? t : void 0,
      backgroundColor: null != (r = (0, d.wK)(l, .075)) ? r : void 0
    },
