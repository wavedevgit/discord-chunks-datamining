...
function T(e) {
  ...
  r.useEffect(() => {
    !async function() {
      ...
      null != e && s(E.intl.formatToPlainString(u.defaultName, {
        username: e.username
      }))
    }()
  }, [u.defaultName]), (0, j.Z)(e);
  let x = (0, i.jsxs)(i.Fragment, {
      children: [t ? (0, i.jsx)(N.Z, {
        guildTemplate: e
      }) : null, (0, i.jsx)("div", {
        className: Z.icon,
        ...
        children: E.intl.format(u.terms, {
  ...
  return {
    ...
    handleSubmit: () => {
      p.Z.acceptGuildTemplate(e.code, n, l).then(() => {
        (0, o.pTH)(), (0, m.Ou)()
      }).catch(e => d(e))
    }
  }
  ...
  let {
    ...
    return (0, i.jsxs)("div", {
      className: l()(Z.channel, {
        [Z.category]: e.type === H.d4z.GUILD_CATEGORY
      }),
      children: [(0, i.jsx)(t, {
...
function _(e) {
  let {
    guildId: t,
    roles: n
  } = e, r = n.slice().reverse().map(e => (0, i.jsx)(b, {
    guildId: t,
    role: e
  }, e.id));
  return (0, i.jsx)("ul", {
...
function b(e) {
  ...
  let {
    guildId: r,
    role: s
  } = e, l = (0, o.dQu)(u.Z.colors.BORDER_SUBTLE).hex(), a = null == s.color ? l : (0, d.Rf)(s.color), c = (0, x.X)(r, s.colorStrings, "AcceptGuildTemplate");
  return (0, i.jsxs)("li", {
    className: Z.role,
    style: {
