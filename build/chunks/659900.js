...
function M(e) {
  ...
  r.useEffect(() => {
    !async function() {
      ...
      null != e && s(T.intl.formatToPlainString(u.defaultName, {
        username: e.username
      }))
    }()
  }, [u.defaultName]), (0, H.Z)(e);
  let x = (0, i.jsxs)(i.Fragment, {
      children: [t ? (0, i.jsx)(E.Z, {
        guildTemplate: e
      }) : null, (0, i.jsx)("div", {
        className: _.icon,
        ...
        children: T.intl.format(u.terms, {
          guidelinesURL: Z.EYA.GUIDELINES
        })
      })]
    }),
  ...
  return {
    ...
    handleSubmit: () => {
      j.Z.acceptGuildTemplate(e.code, n, l).then(() => {
        (0, o.pTH)(), (0, m.Ou)()
      }).catch(e => d(e))
    }
  }
...
function b(e) {
  let {
    ...
    return (0, i.jsxs)("div", {
      className: l()(_.channel, {
        [_.category]: e.type === Z.d4z.GUILD_CATEGORY
      }),
      children: [(0, i.jsx)(t, {
...
function S(e) {
  let {
    guildId: t,
    roles: n
  } = e, r = n.slice().reverse().map(e => (0, i.jsx)(G, {
    guildId: t,
    role: e
  }, e.id));
  return (0, i.jsx)("ul", {
...
function G(e) {
  ...
  let {
    guildId: r,
    role: s
  } = e, l = (0, o.dQu)(u.Z.colors.BORDER_SUBTLE).hex(), a = null == s.color ? l : (0, d.Rf)(s.color), c = (0, x._f)(r, s, s.colorStrings);
  return (0, i.jsxs)("li", {
    className: _.role,
    style: {
      borderColor: null != (t = (0, d.wK)(a, .6)) ? t : void 0,
      backgroundColor: null != (n = (0, d.wK)(a, .075)) ? n : void 0
    },
