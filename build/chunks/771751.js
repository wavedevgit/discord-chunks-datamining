...
function T(e) {
  ...
  let {
    ...
    offerOptions: u,
    forceRefetch: m
  } = e, [f, p] = a.useState(!1), [_, v] = a.useState(!1), [j, O] = a.useState(!1), [N, T] = a.useState(!1);
  a.useEffect(() => {
    j && T(!0);
    let e = setTimeout(() => {
      T(!1)
...
function S() {
  let [e, t] = a.useState([]), [n, i] = a.useState([]), [o, h] = a.useState(), [x, p] = a.useState(), [b, C] = a.useState([]), [y, S] = a.useState([]), [k, I] = a.useState(!0);
  a.useEffect(() => {
