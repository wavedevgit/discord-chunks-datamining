...
function S(e) {
  ...
  let {
    ...
    offerOptions: m,
    forceRefetch: p
  } = e, [b, f] = r.useState(!1), [g, y] = r.useState(!1), [O, E] = r.useState(!1), [N, T] = r.useState(!1);
  r.useEffect(() => {
    O && T(!0);
    let e = setTimeout(() => {
      T(!1)
...
function P(e) {
  ...
  let {
    ...
    offerOptions: o,
    forceRefetch: u
  } = e, [m, h] = r.useState(!1), [p, b] = r.useState(!1), [f, j] = r.useState(!1), [g, y] = r.useState(!1);
  r.useEffect(() => {
    f && y(!0);
    let e = setTimeout(() => {
      y(!1)
...
function w() {
  let [e, t] = r.useState([]), [n, l] = r.useState([]), [i, s] = r.useState(), [x, h] = r.useState(), [j, C] = r.useState([]), [w, k] = r.useState([]), [I, R] = r.useState(!0), [Z, L] = r.useState(10080), [A, D] = r.useState([]), {
    entitlements: M,
  ...
  r.useEffect(() => {
    ...
    I && (R(!1), m.Z.forceReset(), (0, d.T)(), E().then(e => {
