...
function m(e) {
  let {
    ...
    onToggleActivityRestrictedGuild: o
  } = e, c = (0, r.e7)([l.Z], () => l.Z.getMemberCount(t.id));
...
let g = function() {
  let {
    ...
    onToggleShowAllGuilds: p,
    isShowingAllGuilds: h,
    numTotalGuilds: f,
    onToggleActivityRestrictedGuild: b,
    isActivityRestricted: _,
    numGuildsShownLimit: x,
    isSearching: E
  } = (0, o.F)();
  return (0, i.jsxs)("div", {
    className: u.wrapper,
    children: [(0, i.jsx)(s.E1j, {
      ...
      onToggleActivityRestrictedGuild: b
    }, e.id)), f > x && !E && (0, i.jsxs)(s.P3F, {
      className: u.showAllButton,
      onClick: p,
      children: [h ? (0, i.jsx)(s.u04, {
        ...
        color: "text-primary",
        children: h ? d.intl.string(d.t["8fJE7+"]) : d.intl.format(d.t["4AUz5O"], {
          count: f
        })
      })]
    })]
