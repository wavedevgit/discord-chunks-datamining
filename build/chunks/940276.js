...
function h(e) {
  ...
  } = e, o = (0, s.e7)([a.Z], () => a.Z.getMemberCount(t.id));
  return (0, i.jsx)("li", {
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsxs)("div", {
      ...
      children: [(0, i.jsx)(l.E1j, {
        ...
        onFocus: () => o.default.track(u.rMx.ACTIVITY_SHARING_SETTINGS_INTERACTED, {
          interaction: "search_focused",
          sort_order: s,
          activity_restricted_guild_count: x,
          total_guild_count: E
        }),
        onBlur: () => o.default.track(u.rMx.ACTIVITY_SHARING_SETTINGS_INTERACTED, {
      ...
      "aria-live": "polite",
      role: "region",
      children: g.intl.format(m.default.EvzDfX, {
        count: e.length
      })
    }), (0, i.jsxs)("ul", {
