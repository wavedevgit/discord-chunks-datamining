...
function u(e) {
  ...
  } = e, o = (0, r.e7)([l.Z], () => l.Z.getMemberCount(t.id)), u = t.toString();
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)(s.E1j, {
      ...
      children: [h ? (0, i.jsx)(s.u04, {
        ...
        color: "text-primary",
        children: h ? c.intl.string(c.t["8fJE7+"]) : c.intl.format(c.t.jcANeH, {
          count: f
        })
      })]
    })]
