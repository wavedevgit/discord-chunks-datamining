...
let e_ = () => {
  let {
  ...
  } = (0, u.ZP)(d.Z.PREMIUM_MARKETING_PERK_CARD), t = (0, o.ZP)(), r = (0, s.e7)([c.Z], () => c.Z.useReducedMotion), eN = (0, E.BU)(k.Uq / 1024, {
    useKibibytes: !0
  }), {
    premiumSubscription: e_,
    isEligibleForReward: eE
  } = (0, s.cj)([_.ZP], () => ({
    premiumSubscription: _.ZP.getPremiumTypeSubscription(),
    isEligibleForReward: _.ZP.getIsSubscriptionEligibleForReward()
  })), ej = null != e_ ? C.ZP.getPremiumPlanItem(e_) : null, eC = (null != ej ? C.ZP.getSkuIdForPlan(ej.planId) : null) === k.Si.TIER_2, eO = N.default.getCurrentUser(), ev = (0, C.I5)(eO, k.p9.TIER_2), eS = (0, C.I5)(eO, k.p9.TIER_0), eT = (0, S.bq)({
    showAnimations: !0
  }), eI = null != eT ? eT.initialPercentage : void 0, ey = null != eT ? eT.percentage : void 0, eA = (0, g.Z)(x.Z), eP = (0, T.a)(), eR = (0, S.Kb)(W.qY), {
    fractionalState: eD
  } = (0, m.Z)(), eZ = eD === k.a$.FP_ONLY, {
    enabled: ew
  } = O.Z.useExperiment({
    ...
    serverBoosts: {
      ...
      description: eZ ? U.NW.format(U.t.uPiIBQ, {
        link: "https://discord.com"
      }) : U.NW.string(U.t.jsyNHh),
      descriptionCta: U.NW.string(U.t.jVcuVV),
      onCtaClick: eZ ? void 0 : () => {
    ...
    largeUploads: {
      name: "largeUploads",
      title: U.NW.formatToPlainString(U.t.jqhAdH, {
        premiumMaxSize: eN
      }),
      subtitle: U.NW.formatToPlainString(U.t["HI+cfn"], {
        premiumMaxSize: eN
      }),
      perkImage: ep,
    ...
    referralProgram: {
      ...
      description: U.NW.format(U.t["2JqTFx"], {
        helpdeskArticle: j.Z.getArticleURL(L.BhN.REFERRAL_PROGRAM)
      }),
  ...
  return (!eG && eV && null != eU && eU.status !== y.Vq.UPCOMING || eG && eV) && ev && !eZ && (eM.tenureBadge = {
    name: "tenureBadge",
