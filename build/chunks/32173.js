...
let eT = () => {
  let {
    ...
    showAnimations: !0
  }), eZ = null != eD ? eD.initialPercentage : void 0, ew = null != eD ? eD.percentage : void 0, ek = (0, g.Z)(j.Z), eL = (0, b.H)("usePerksDiscoverabilityCards"), eB = (0, A.a)(), eM = (0, y.Kb)(M.qY), {
    isFractionalPremiumActive: eU
  } = (0, p.Z)(), eV = null != eT && eT.hasPremiumAtLeast(B.p9.TIER_2), eG = (0, f.wE)(l.z.PERMADECOS_NITRO_HOME_CARD_NEW_BADGE), {
    enabled: eF
  } = I.Z.useExperiment({
