...
let ex = () => {
  let {
    ...
    showAnimations: !0
  }), eS = null != eO ? eO.initialPercentage : void 0, ev = null != eO ? eO.percentage : void 0, eT = (0, m.Z)(x.Z), eN = (0, h.H)("usePerksDiscoverabilityCards"), eI = (0, T.a)(), ey = (0, v.Kb)(Z.qY), {
    ...
    serverBoosts: {
      ...
      description: eA ? U.intl.format(U.t.uPiIBQ, {
        link: "https://discord.com"
      }) : U.intl.string(U.t.jsyNHh),
      descriptionCta: U.intl.string(U.t.jVcuVV),
      onCtaClick: eA ? void 0 : () => {
    ...
    permadecos: {
      ...
      isPremiumGetCta: !ej,
      onCtaClick: ej ? () => {
        eR || (0, g.EW)(l.z.PERMADECOS_NITRO_HOME_CARD_NEW_BADGE, {
