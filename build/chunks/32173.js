...
let eT = () => {
  let {
  ...
  } = (0, m.ZP)(u.Z.PREMIUM_MARKETING_PERK_CARD), t = (0, c.ZP)(), i = (0, s.e7)([d.Z], () => d.Z.useReducedMotion), ev = (0, S.BU)(B.Uq / 1024, {
    useKibibytes: !0
  }), {
    premiumSubscription: eT,
    isEligibleForReward: eI
  } = (0, s.cj)([O.ZP], () => ({
    premiumSubscription: O.ZP.getPremiumTypeSubscription(),
    isEligibleForReward: O.ZP.getIsSubscriptionEligibleForReward()
  })), eN = null != eT ? T.ZP.getPremiumPlanItem(eT) : null, ey = (null != eN ? T.ZP.getSkuIdForPlan(eN.planId) : null) === B.Si.TIER_2, eA = C.default.getCurrentUser(), eP = (0, T.I5)(eA, B.p9.TIER_2), eR = (0, T.I5)(eA, B.p9.TIER_0), eD = (0, y.bq)({
    showAnimations: !0
  }), eZ = null != eD ? eD.initialPercentage : void 0, ew = null != eD ? eD.percentage : void 0, ek = (0, p.Z)(j.Z), eL = (0, b.H)("usePerksDiscoverabilityCards"), eB = (0, A.a)(), eM = (0, y.Kb)(M.qY), {
    isFractionalPremiumActive: eU
  } = (0, g.Z)(), eV = null != eT && eT.hasPremiumAtLeast(B.p9.TIER_2), eG = (0, f.wE)(l.z.PERMADECOS_NITRO_HOME_CARD_NEW_BADGE), {
    enabled: eF
  } = I.Z.useExperiment({
    ...
    serverBoosts: {
      ...
      description: eU ? z.intl.format(z.t.uPiIBQ, {
        link: "https://discord.com"
      }) : z.intl.string(z.t.jsyNHh),
      descriptionCta: z.intl.string(z.t.jVcuVV),
    ...
    largeUploads: {
      name: "largeUploads",
      title: z.intl.formatToPlainString(z.t.jqhAdH, {
        premiumMaxSize: ev
      }),
      subtitle: z.intl.formatToPlainString(z.t["HI+cfn"], {
        premiumMaxSize: ev
      }),
      perkImage: ex,
    ...
    referralProgram: {
      ...
      description: z.intl.format(z.t["2JqTFx"], {
        helpdeskArticle: v.Z.getArticleURL(U.BhN.REFERRAL_PROGRAM)
      }),
    ...
    permadecos: {
      ...
      description: z.intl.format(z.t.Pd7olp, {
        learnMoreLink: v.Z.getArticleURL(U.BhN.PERMADECOS)
      }),
      descriptionCta: eP ? z.intl.string(z.t.jVcuVV) : z.intl.string(z.t.JST6jo),
      isPremiumGetCta: !eP,
      onCtaClick: eP ? () => {
        eG || (0, f.EW)(l.z.PERMADECOS_NITRO_HOME_CARD_NEW_BADGE, {
  ...
  return eq && eP && eV && (eK.tenureBadge = {
    name: "tenureBadge",
