...
let eE = () => {
  let {
  ...
  } = (0, u.ZP)(d.Z.PREMIUM_MARKETING_PERK_CARD), t = (0, o.ZP)(), r = (0, s.e7)([c.Z], () => c.Z.useReducedMotion), e_ = (0, j.BU)(W.Uq / 1024, {
    useKibibytes: !0
  }), {
    premiumSubscription: eE,
    isEligibleForReward: ej
  } = (0, s.cj)([E.ZP], () => ({
    premiumSubscription: E.ZP.getPremiumTypeSubscription(),
    isEligibleForReward: E.ZP.getIsSubscriptionEligibleForReward()
  })), eC = null != eE ? O.ZP.getPremiumPlanItem(eE) : null, eO = (null != eC ? O.ZP.getSkuIdForPlan(eC.planId) : null) === W.Si.TIER_2, ev = _.default.getCurrentUser(), eS = (0, O.I5)(ev, W.p9.TIER_2), eT = (0, O.I5)(ev, W.p9.TIER_0), eI = (0, T.bq)({
    showAnimations: !0
  }), ey = null != eI ? eI.initialPercentage : void 0, eA = null != eI ? eI.percentage : void 0, eP = (0, g.Z)(N.Z), eR = (0, I.a)(), eD = (0, T.Kb)(L.qY), {
    fractionalState: eZ
  } = (0, m.Z)(), ew = eZ === W.a$.FP_ONLY, {
    enabled: ek
  } = v.Z.useExperiment({
    ...
    serverBoosts: {
      ...
      description: ew ? V.NW.format(V.t.uPiIBQ, {
        link: "https://discord.com"
      }) : V.NW.string(V.t.jsyNHh),
      descriptionCta: V.NW.string(V.t.jVcuVV),
    ...
    largeUploads: {
      name: "largeUploads",
      title: V.NW.formatToPlainString(V.t.jqhAdH, {
        premiumMaxSize: e_
      }),
      subtitle: V.NW.formatToPlainString(V.t["HI+cfn"], {
        premiumMaxSize: e_
      }),
      perkImage: eh,
    ...
    referralProgram: {
      ...
      description: V.NW.format(V.t["2JqTFx"], {
    ...
    permadecos: {
      ...
      description: V.NW.format(V.t.Pd7olp, {
        learnMoreLink: C.Z.getArticleURL(B.BhN.PERMADECOS)
      }),
      descriptionCta: eS ? V.NW.string(V.t.jVcuVV) : V.NW.string(V.t.JST6jo),
      isPremiumGetCta: !eS,
  ...
  return (!eF && eG && null != eV && eV.status !== A.Vq.UPCOMING || eF && eG) && eS && !ew && (eU.tenureBadge = {
    name: "tenureBadge",
