...
class d extends(s = Chunk73800.PureComponent) {
  render() {
    ...
    return <input ref={this.setCodeBlockRef} className={a()(Chunk713569.input, module)} maxLength={1} value={null != this.props.code ? this.props.code : true} autoFocus={this.props.autoFocus} onKeyDown={this.handleKeyDown} onChange={this.handleChange} />
  }
  focus() {
    var e;
...
class E extends(i = Chunk73800.PureComponent) {
  render() {
    ...
    for (let e = 0; module < require.length; module++) module === require.length / 2 && s.push(<div className={Chunk713569.spacer} />), s.push(<d ref={t => this.setCodeBlockRef(e, t)} code={require[module]} autoFocus={0 === module} onChange={t => this.handleChange(e, t)} onKeyDown={t => this.handleKeyDown(e, t)} className={exports} />);
    return <Chunk600164.Z align={Chunk600164.Z.Align.CENTER} justify={Chunk600164.Z.Justify.CENTER} className={module}>{s}</Chunk600164.Z>
  }
  setCodeBlockRef(e, t) {
