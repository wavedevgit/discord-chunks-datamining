...
let p = new f(Chunk83790.w.ANIMATED_EMOJIS),
  ...
  b = new f(Chunk83790.w.ANIMATED_AVATAR),
  y = new f(Chunk83790.w.CUSTOM_DISCRIMINATOR),
  O = new f(Chunk83790.w.PREMIUM_GUILD_MEMBER_PROFILE),
  A = new f("profileBadges"),
  v = new f(Chunk83790.w.PROFILE_PREMIUM_FEATURES, "custom banner and avatar decoration"),
...
let M = new f(Chunk83790.w.INCREASED_GUILD_LIMIT),
  ...
  F = Object.freeze({
    [Chunk788868.pe.TIER_0]: new Chunk594579.A(Chunk788868.pe.TIER_0, [p, _, h, A, j, U, G, I]),
    [Chunk788868.pe.TIER_1]: new Chunk594579.A(Chunk788868.pe.TIER_1, [p, _, b, y, A, C, R, D, U, G, I]),
    [Chunk788868.pe.TIER_2]: new Chunk594579.A(Chunk788868.pe.TIER_2, [p, _, h, m, g, b, y, O, A, v, T, C, N, R, w, D, x, L, j, M, k, U, G, I, S, P, E, V])
  }),
  B = [C, N, V],
  H = [V];
