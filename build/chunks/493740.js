...
let p = new f(Chunk83790.w.ANIMATED_EMOJIS),
  ...
  N = new f("freeBoosts"),
  w = new f(Chunk83790.w.STREAM_MID_QUALITY),
...
let j = new f(Chunk83790.w.INCREASED_GUILD_LIMIT),
  ...
  F = Object.freeze({
    ...
    [Chunk788868.pe.TIER_2]: new Chunk594579.A(Chunk788868.pe.TIER_2, [p, _, h, m, g, y, b, O, v, A, T, C, N, w, R, D, L, x, M, j, k, U, G, S, I, P, E, V])
  }),
  B = [C, N, V],
  H = [V];
