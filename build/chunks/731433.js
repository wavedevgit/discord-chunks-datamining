...
function y(t) {
  let {
    user: a,
    deco: e
  } = t, s = (0, i.e7)([x.Z], () => x.Z.getStatus(a.id));
  return (0, r.jsxs)("div", {
...
function h(t) {
  ...
  let {
    ...
    theme: h
  } = (0, n.TCT)(), k = (0, i.e7)([f.default], () => f.default.getCurrentUser()), {
    purchases: A
  } = (0, _.c7)(), C = null == (a = A.get("1225876188074082374")) ? void 0 : a.items, N = void 0 !== C ? C[0] : void 0, {
    analyticsLocations: b
  } = (0, d.ZP)(c.Z.PREMIUM_SUBSCRIPTION_APRIL_CAMPAIGN_MODAL), P = (0, v.Z)({
    analyticsLocations: b
  });
  return (0, l.Z)({
