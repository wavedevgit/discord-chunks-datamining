...
function j(e) {
  ...
  return 0 === R.length && null == D ? null : <a.Fragment>{P}{<div className={s()(j, f.wrapper)}>{<div className={s()(f.icons, S)}>{R.length > 0 ? (0, a.jsxs)(a.Fragment, {
          children: [R.map((e, t) => {
        ...
        })}</div>}{null != D ? <d.Text variant={y} color={"header-secondary"}>{D}</d.Text> : null}</div>}</a.Fragment>
}