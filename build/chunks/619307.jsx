...
function L(e) {
  ...
  return i.useLayoutEffect(() => {
    if (u) {
  ...
  }, [u, W]), <d.y targetElementRef={W} spacing={0} animation={d.y.Animation.NONE} shouldShow={H} onRequestOpen={() => {
      q(true)
    }} onRequestClose={() => {
      q(false)
    }} renderPopout={e => {
      ...
      return (0, r.jsxs)(c.P, I(O({
        ...
        onKeyDown: e => {
          "ArrowDown" === e.key ? q(true) : "Escape" === e.key && d && (e.stopPropagation(), q(false)), l(e)
        }
      }, u), {
...
function x(e) {
  ...
  let L = i.useCallback((e, t) => {
    ...
    x = i.useMemo(() => _.map((e, t) => {
      var n;
      return <M isSelected={d(e.value)} value={e.value} label={g(e)} onSelect={L} className={y} isDisabled={e.disabled} preventCloseOnSelect={e.preventCloseOnSelect} serialize={E} />
    }), [L, d, y, _, g, E]),
    k = _.length <= h ? f.xV : f.h2;
  return <l.bG navigator={w}><l.SJ>{e => {
        var {
          ref: n
        } = e, i = T(e, ["ref"]);
