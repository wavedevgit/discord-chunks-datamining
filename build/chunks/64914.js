...
function j() {
  let [e] = r.useState(() => g.ZP.getEnableHardwareAcceleration()), t = h.bm.useSetting(), n = h.Sb.useSetting(), j = (0, s.e7)([m.Z], () => m.Z.testModeApplicationId), O = (0, s.e7)([p.ZP], () => p.ZP.showPlayAgain), C = r.useCallback(e => {
    ...
    (0, l.h7j)(t => {
      var n, r;
      return (0, i.jsx)(l.ConfirmModal, (n = E({
