  ...
  O = () => (0, r.jsxs)(s.hjN, {
    ...
    children: [(0, r.jsx)(s.R94, {
      ...
      children: N.NW.format(N.t.UBj0aW, {
        articleUrl: f.Z.getArticleURL(x.BhN.STICKERS_UPLOAD)
      })
    })]
  }),
  C = e => {
    let t, n, i, {
      ...
      u = (0, h.A3)(l),
      m = a.length;
    return null == d || l === x.Eu4.TIER_3 || o > 0 ? null : (m > u ? (t = N.NW.formatToPlainString(N.t.ZtAY1d, {
      level: d
    }), n = N.NW.formatToPlainString(N.t["13hOWl"], {
      level: d
    }), i = x.qAy.BOOST_UPSELL_BANNER_LOST_LEVEL) : (t = N.NW.string(N.t.zT9Sxc), n = N.NW.formatToPlainString(N.t.YaW9wM, {
      level: d,
