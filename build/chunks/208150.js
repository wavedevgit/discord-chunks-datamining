...
let v = {
  ...
  O = e => {
    ...
    } = (0, a.ZP)(), i = (0, u.Z)(t.id).available, l = b.oCV[b.Eu4.TIER_1] - i;
    return (0, r.jsxs)("div", {
  ...
  C = () => (0, r.jsxs)(s.hjN, {
    ...
    children: [(0, r.jsx)(s.R94, {
      ...
      children: N.NW.format(N.t.hxLvi4, {
        fileSize: (0, p.IC)(j.Ht, {
          useKibibytes: !0
        })
      })
    }), (0, r.jsx)(s.R94, {
      type: s.geA.DESCRIPTION,
      children: N.NW.format(N.t.UBj0aW, {
        articleUrl: f.Z.getArticleURL(b.BhN.STICKERS_UPLOAD)
      })
    })]
  }),
  y = e => {
    let t, n, i, {
      ...
      u = (0, h.A3)(a),
      m = l.length;
    return null == d || a === b.Eu4.TIER_3 || o > 0 ? null : (m > u ? (t = N.NW.formatToPlainString(N.t.ZtAY1d, {
      level: d
    }), n = N.NW.formatToPlainString(N.t["13hOWl"], {
      level: d
    }), i = b.qAy.BOOST_UPSELL_BANNER_LOST_LEVEL) : (t = N.NW.string(N.t.zT9Sxc), n = N.NW.formatToPlainString(N.t.YaW9wM, {
      level: d,
