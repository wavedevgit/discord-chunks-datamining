...
let Z = e => {
    ...
    return null === n ? <d.$jN /> : Z ? <C.P onClose={t} /> : <c.Modal size={"sm"} transitionState={o.D.ENTERED} title={y.intl.string(y.t.Lm2nFR)} subtitle={y.intl.string(y.t.SRIMcn)} onClose={t} input={(0, r.jsx)(m.Z, {
  ...
  M = e => {
    ...
    return i.useEffect(() => {
    ...
    }, [n]), <c.Modal size={"md"} transitionState={o.D.ENTERED} title={y.intl.string(y.t.SY9tyM)} subtitle={y.intl.string(y.t.mPmPrq)} onClose={t} actions={[]} actionBarInput={(0, r.jsx)("div", {
        className: s()(w.footer, w.footerSeparator),
        children: (0, r.jsx)(d.zxk, {
          variant: "primary",
          disabled: 0 === f.size || b,
      ...
      })}><d.w0Z className={w.list}>{Array.from(m.values()).map(e => (0, r.jsx)(E.Z, {
          checked: f.has(e.id),
  ...
  A = e => {
    ...
    return null === a ? <d.$jN /> : 2 === n ? <N.m results={o} onClose={t} /> : 1 === n ? <Z onClose={t} onShare={m} /> : 3 === n ? <M onClose={t} onShare={m} /> : true
  }