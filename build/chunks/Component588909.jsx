...
function A(e, t) {
  ...
  for (let a of t) switch (a.type) {
    case S.nc.WELCOME: {
      ...
      null != t && (0, d.Z)(t, x.xjy.JOIN) && (j.cancelText = C.intl.string(C.t["6F9ivu"]), j.onCancelClick = (e, n) => {
    ...
    case S.nc.GO_LIVE_NON_VOICE: {
      let {
        ...
        useStreamCtaCopy: t
      } = (0, g.tU)("welcomeNotification"), l = C.intl.string(t ? C.t.pEuzii : C.t.U76Ft2), c = e ? e => {
        let t = () => {
  ...
  let D = (0, f.zu)(a.z.OVERLAY_OOP_WELCOME_NUX),
    R = r ? true : () => (0, b.QR)((0, _.Pb)(), C.t["z8/sgJ"], C.intl.string(C.t.jZkzVJ), {
  ...
  return T(w({
    ...
    onNotificationClick: (e, t) => {
      var n;
      p("unlock"), u.Z.setInputLocked(false, E.Z.getTargetPID()), D || (0, f.Q3)(a.z.OVERLAY_OOP_WELCOME_NUX), null == (n = j.onNotificationClick) || n.call(j, e, t)
    },
    onDismissClick: (e, t) => {
      var n;
      p("dismiss"), D || (0, f.Q3)(a.z.OVERLAY_OOP_WELCOME_NUX), null == (n = j.onDismissClick) || n.call(j, e, t)
    }
  })
}