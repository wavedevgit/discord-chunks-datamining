...
function k(e, t) {
  ...
  if (o <= 0) n.set(t, v(E({}, r), {
    ...
    let n = i.get(t);
    if (null == n) return;
    n.start(Math.min(A, o), () => k(e, t))
  }
}

function j() {
  O.clear(), I.clear(), N.clear(), C.clear(), w.clear(), D.clear(), L.clear(), x = !1
}
...
function V(e) {
  var t, n, r, i, s, l, c, d, f, h, g, b, A, x, j, U, G, F, V, Z, H, W, Y, K, z, q, Q;
  let {
    userProfile: X
  } = e, J = null !== (j = null === (t = X.guild_member_profile) || void 0 === t ? void 0 : t.guild_id) && void 0 !== j ? j : y;
  if (null === (n = O.get(X.user.id)) || void 0 === n || n.delete(J), I.delete(X.user.id), null != X.mutual_guilds) {
    ...
    }), L.set(X.user.id, _.ZP.getFlattenedGuildIds().filter(t => null != e[t]).map(t => ({
      guild: e[t].guild,
      nick: e[t].nick
    })))
  }
  ...
  if (N.set(X.user.id, {
      ...
      badges: null != X.badges ? X.badges.map(e => {
        let t = (0, p.fv)(e.id);
        ...
        return e.id.startsWith(T) && null != ee ? v(E({}, e), {
          description: m.NW.formatToPlainString(m.t.IWkAq6, {
            date: ee
          })
        }) : e
      }) : X.badges
    }), (null === (x = X.user_profile) || void 0 === x ? void 0 : null === (A = x.profile_effect) || void 0 === A ? void 0 : A.expires_at) != null) {
    let e = new o.V7;
...
function H(e) {
  ...
  a.lastFetched = Date.now(), a.fetchError = o, N.set(r, a), (null == o ? void 0 : o.status) === 404 && (D.set(r, 0), w.set(r, []), L.set(r, []))
}
...
function X(e) {
  return [...N.keys()].reduce((e, t) => et(t) || e, !1)
}
