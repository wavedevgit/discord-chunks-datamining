...
function q(e) {
  ...
  let {
    userProfile: en,
    fetchStartedAt: er
  } = e, ei = null != (R = null == (t = en.guild_member_profile) ? void 0 : t.guild_id) ? R : T;
  ...
  if (null != Z && Z.userId === en.user.id && (Date.now() > Z.expiresAtMs ? Z = null : X(el, Z)), P.set(en.user.id, {
      ...
      profileEffectExpiresAt: null == (p = en.user_profile) || null == (f = p.profile_effect) ? void 0 : f.expires_at,
  ...
  if (null != en.guild_member_profile) {
    let e = {
        ...
        popoutAnimationParticleType: null == (z = en.guild_member_profile) ? void 0 : z.popout_animation_particle_type,
        profileEffectId: null == (Q = en.guild_member_profile) || null == (q = Q.profile_effect) ? void 0 : q.id,
        profileEffectExpiresAt: null == ($ = en.guild_member_profile) || null == (J = $.profile_effect) ? void 0 : J.expires_at,
    ...
    if ((null == (et = en.guild_member_profile) || null == (ee = et.profile_effect) ? void 0 : ee.expires_at) != null) {
      let e = new l.V7,
        t = L.get(en.user.id);
      if (null != t) t.set(en.guild_member_profile.guild_id, e);
      else {
...
function J(e) {
  ...
  s.fetchStartedAt = a, s.fetchEndedAt = Date.now(), s.fetchError = o, P.set(r, s), (null == o ? void 0 : o.status) === 404 && (M.set(r, 0), x.set(r, j), k.set(r, U))
}
