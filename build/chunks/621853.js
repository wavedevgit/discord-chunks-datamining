...
function Y(e) {
  ...
  let {
    userProfile: ee,
    fetchStartedAt: et
  } = e, en = null != (j = null == (t = ee.guild_member_profile) ? void 0 : t.guild_id) ? j : O;
  ...
  let er = null != ee.premium_since ? new Date(ee.premium_since) : null,
    ...
    eo = null != ee.badges ? ee.badges.map(e => {
      ...
      return e.id.startsWith(S) && null != ei ? y(E({}, e), {
        description: m.intl.formatToPlainString(m.t.IWkAq6, {
          date: ei
        })
      }) : e
    }) : [];
  if (null != M && M.userId === ee.user.id && (Date.now() > M.expiresAtMs ? M = null : W(eo, M)), N.set(ee.user.id, {
      userId: ee.user.id,
