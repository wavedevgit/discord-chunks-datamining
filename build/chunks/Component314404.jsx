  ...
  switch (t) {
    ...
    case F.Si.TIER_2:
      switch (a) {
        ...
        case F.Si.TIER_2:
          return e.interval === F.rV.MONTH ? H.intl.formatToPlainString(H.t.RqUv86, {
...
let $ = e => {
    ...
    } = (0, _.wD)(), K = (0, P.cF)(D, k && (0, O.pO)(U), Y), z = (0, E.ao)({
      location: "PremiumPlanSelectStep",
      giftRecipient: U,
      isGift: k
    }), q = null != c ? c : T;
    o()(true !== q, "should not be undefined");
    let [X, J] = (0, s.Wu)([b.Z], () => [null != q ? b.Z.get(q.planId) : null, null != f ? b.Z.get(f) : null]), $ = null == L ? true : L.subscription_trial, ee = (0, A.Vi)(), et = null != J ? J : D, en = i.useCallback(e => {
      null != p ? p(e) : N(e)
    }, [p, N]), er = null != m ? m : x;
    o()(null != er, "Price option has to be set");
    let ei = null == M || null == (t = M.discount) ? true : t.plan_ids,
      ea = null != M && g.some(e => null == ei ? true : ei.includes(e)) && null != M.discount,
      eo = (0, S.aS)(F.Xh.PREMIUM_MONTH_TIER_2, false, k, er);
    i.useEffect(() => {
      y && C.ZP.trackExposure({
        location: "5f89bb_1"
      })
    }, [y]);
    let es = (null == et ? true : et.id) != null && g.includes(et.id);
    i.useEffect(() => {
      if (!es) {
        if (null == X || k) en(g[0]);
        else if (null != X) {
    ...
    let el = (0, l.Jb)(),
      ...
      eu = Q(el, ["ref"]),
      ed = (null == et ? true : et.id) != null ? (0, S.aS)(et.id, false, k, er) : true,
      {
        ipCountryCode: ef
      } = (0, w.Z)(),
      ep = "HR" === ef && null != ed && ed.currency === V.pK.EUR,
      e_ = (0, S.Ap)(er.paymentSourceId),
      eh = i.useMemo(() => (null == $ ? true : $.interval) === F.rV.DAY ? (null == $ ? true : $.interval_count) > 7 ? H.intl.string(H.t.Z1V2cs) : H.intl.string(H.t.MI1rHs) : H.intl.string(H.t["+S5lrV"]), [$]),
    ...
    return {
      ...
      discountAmountOff: null == I || null == (a = I.find(e => e.subscriptionPlanId === F.Xh.PREMIUM_MONTH_TIER_2)) || null == (r = a.discounts) || null == (n = r.find(e => e.type === d.eW.SUBSCRIPTION_PLAN)) ? true : n.amount
    }
  },
  ee = e => {
    let {
    ...
    return {
      showFractionalPremiumBanner: a.isFractionalPremiumActive && (null == t || o) && !i && null != n && F.dJ.has(n),
  ...
  en = e => {
    let {
      ...
      if ((0, O.MY)(t) === O.xr.CUSTOM_MESSAGE_EMOJI_SOUNDBOARD && null != i) return (0, r.jsx)(j.Z, {
    ...
    if ((0, O.pO)(t)) return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)("div", {
        ...
        children: [(0, r.jsx)(Z.s, {
          className: f ? Y.compactSendGiftToUser : true,
          giftRecipient: t
        }), E(), b(m), g, !o && (0, r.jsx)(p.Z, {
          onClose: _
        })]
      })]
    });
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(Z.s, {
        className: f ? Y.compactSendGiftToUser : true,
        giftRecipient: t
      }), b(m), y && null != u && null != d && (0, r.jsx)(et, {
        selectedPlan: u,
        selectedPlanPrice: d,
        intervalType: null,
        isPrepaid: s
  ...
  er = e => {
    let {
      ...
      discountAmountOff: c
    } = e, u = (0, s.e7)([g.default], () => g.default.locale), {
      isGift: d,
      giftRecipient: f
    } = (0, _.wD)(), p = d && (0, O.pO)(f), {
      enabled: h
  ...
  ei = e => {
    ...
    return (0, r.jsx)("div", q(K({
      ref: n
    }, a), {
      children: t.map(e => (0, r.jsx)(G.Z, K({
        planId: e,
        selected: (null == i ? true : i.id) === e
      }, o), e))
    }))
  };
...
function ea(e) {
  let {
    ...
    if (t) {
      let t = (null == e ? true : e.trial_id) === F.a7;
      return (0, r.jsxs)("div", {
        children: [(0, r.jsx)(c.Text, {
          variant: "text-sm/normal",
          className: Y.trialPlanSelectHeader,
          children: t ? H.intl.format(H.t.nG95hA, {
            endDate: f
      ...
      return (0, r.jsxs)("div", {
        children: [(0, r.jsx)(c.Text, {
          ...
          children: H.intl.format(H.t["nG7g/E"], {
            numMonths: null != (a = null == R ? true : R.discount.user_usage_limit) ? a : "",
...
function eo(e) {
  ...
  return i = null != i ? i : f, n = null != n ? n : null == p ? true : p.id, (0, r.jsxs)(r.Fragment, {
    children: [null != n && s.includes(n) ? (0, r.jsx)(es, {
      paymentSources: i,
      onStepChange: t,
      selectedPlanId: n,
      isGift: m,
      ...
      className: m && b ? Y.equalDistantBackButton : true,
      onClick: a
    }) : null]
  })
}
...
function es(e) {
  let {
    ...
    isTrial: u,
    isNextDisabled: d = false
  } = e, f = (0, s.e7)([y.Z], () => y.Z.getPremiumTypeSubscription()), {
    step: p,
    selectedPlan: _
  } = (0, h.JL)(), {
    hasEntitlements: g
  } = (0, U.H)(n, i), E = null != f && null != f.paymentSourceId || Object.keys(o).length > 0 || g && !u;
  var b = l ? H.intl.string(H.t.PDTjLN) : H.intl.string(H.t.XqMe3N),
    O = m.h8.ADD_PAYMENT_STEPS;
  return E && (O = m.h8.REVIEW), (0, P.id)(_, i, a) && p !== m.h8.SELECT_FREE_SKU && (O = m.h8.SELECT_FREE_SKU), (0, r.jsx)(c.Button, {
    variant: "primary",
    text: b,
    onClick: () => t(O),
    disabled: d
