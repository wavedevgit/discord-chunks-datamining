...
let b = function(e) {
  ...
  let {
    ...
    quest: O,
    refreshQuest: v
  } = e, [I, y] = i.useState(false), [C, S] = i.useState(false), T = i.useRef(null), N = (0, d.MP)(), j = (0, l.e7)([u.Z], () => null != E ? u.Z.getFetchQuestPreviewError(E) : null, [E]), x = (0, l.e7)([u.Z], () => null != E && u.Z.isFetchingQuestPreview(E), [E]), P = i.useMemo(() => {
    let e = N.map(e => {
      var t, n, r;
      return {
        id: e.id,
