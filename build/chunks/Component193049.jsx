...
function A(e) {
  ...
  }, [eo, es, el, A, ee, w, D, X, F]), eu = i.useMemo(() => (0, S.zV)(K), [K]);
  ...
  }, [G]), !F && null == Z && (G === x.Wq.EDIT_USERNAME ? t = I.intl.formatToPlainString(I.t.AJh8BQ, {
    source: K.username
  }) : G === x.Wq.SUGGESTION && (X || null != Y) && (t = I.intl.string(I.t["i/2SgI"]))), (0, r.jsxs)(u.Y0X, {
