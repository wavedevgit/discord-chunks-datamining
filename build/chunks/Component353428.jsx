...
let G = e => {
  ...
  let {
    channel: s
  } = e, o = (0, a.bG)([j.default], () => j.default.getCurrentUser()), c = (0, a.bG)([j.default], () => j.default.getUser(s.getRecipientId())), u = (0, C.x)(), d = (0, a.bG)([y.A], () => null != c ? y.A.getUserProfile(c.id) : null), p = null != d && (null != (t = null == d ? true : d.fetchEndedAt) ? t : 0) > 0;
  return (l.useEffect(() => {
