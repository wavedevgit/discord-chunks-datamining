...
function p(e) {
  ...
  return t = null != A ? (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(i.nn4, {
      children: u.intl.format(u.t["94dBOT"], {
        color: (0, l.Rf)(A.color)
      })
    }), (0, r.jsx)("div", {
      className: g.attachedRoleColor,
      style: {
        backgroundColor: (0, l.Rf)(A.color)
      }
    }), (0, r.jsx)(i.LZC, {
      size: 8,
      horizontal: !0
...
function b(e) {
  let {
    ...
    listingRoleId: f,
    error: b
  } = e, v = (0, o.e7)([s.Z], () => null != f ? s.Z.getRole(l, f) : void 0);
  return null === t ? (0, r.jsxs)(i.xJW, {
    title: (0, r.jsxs)("div", {
      className: g.warningTitle,
      children: [(0, r.jsx)(m, {}), (0, r.jsx)(i.LZC, {
        horizontal: !0,
        size: 4
  ...
  }) : (a()(null != t, "newRoleParams cannot be null at this point"), (0, r.jsxs)(i.xJW, {
    required: !0,
