...
class Y extends D.ZP {
  ...
  constructor(...e) {
    super(...e), F(this, "channelItemRef", i.createRef()), F(this, "state", {
      ...
      }), t || n || e.isRoleSubscriptionTemplatePreviewChannel() || (0, _.Cq)(e), __OVERLAY__ || (0, O.Kh)(e.id)
...
function q(e) {
  ...
  }), h = (0, s.e7)([x.Z], () => x.Z.isCollapsed(n.parent_id)), p = (0, E.ZP)(n.id), f = (0, s.e7)([j.Z], () => j.Z.getStageInstanceByChannel(n.id), [n.id]), g = (0, v.Rk)(n.id, C.pV.AUDIENCE), {
    isSubscriptionGated: m,
    needSubscriptionToAccess: y
  } = (0, b.Z)(n.id), O = (0, s.e7)([T.ZP], () => T.ZP.isFavorite(t.id, n.id)), _ = (0, S.xJ)(n.id), I = (0, L.Z)({
    channel: n,
    isChannelSelected: !1,
