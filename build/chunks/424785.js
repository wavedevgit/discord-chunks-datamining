...
function q(e) {
  ...
  }), h = (0, s.e7)([x.Z], () => x.Z.isCollapsed(n.parent_id)), p = (0, S.ZP)(n.id), f = (0, s.e7)([j.Z], () => j.Z.getStageInstanceByChannel(n.id), [n.id]), g = (0, C.Rk)(n.id, v.pV.AUDIENCE), {
    isSubscriptionGated: m,
    needSubscriptionToAccess: O
  } = (0, b.Z)(n.id), _ = (0, s.e7)([T.ZP], () => T.ZP.isFavorite(t.id, n.id)), y = (0, E.xJ)(n.id), P = (0, L.Z)({
    channel: n,
    isChannelSelected: !1,
