...
n.d(t, {
  ZP: () => et
}), n(35282), n(388685), n(539854), n(361932), n(187205);
var r = n(392711),
  i = n.n(r),
  a = n(159635),
  o = n.n(a),
...
let G = u.Z.RULES,
  ...
  W = {
    ...
    text: x(D({}, B), {
      match: (e, t) => "string" == typeof t.textExclusions && "" !== t.textExclusions ? (0, d.T9)(t.textExclusions).exec(e) : null != B.match ? B.match(e, t, "") : null
    })
  },
  K = {
    inlineCode: j(G.inlineCode),
    ...
    mention: {
      ...
      parse(e, t, n) {
        let {
          isNotification: r,
          guild: a
        } = n, o = T.default.getUser(e[1]);
        if (null == o) return {
          content: e[0]
        };
        let s = N.ZP.getUserTag(o, {
          identifiable: r && I.Z.enabled ? "never" : "always"
        });
        if (r) {
    ...
    channel: {
      ...
      parse(e) {
        ...
        return {
          content: null == t ? e[0] : (0, s.F6)(t, T.default, v.Z, !0, !0)
        }
      }
    },
    emoji: {
...
function Q(e, t, n, r) {
  let i = "";
  return e.forEach(e => {
    if (X(t, e, r), "string" == typeof e.content) switch (e.type) {
      case "codeBlock":
      case "inlineCode":
      case "mention":
      case "roleMention":
...
function $(e) {
  ...
  let o = i()(t.reduce((e, t) => {
      let {
        userId: n
      } = t, r = T.default.getUser(n);
      return null == r || e.push({
        id: n,
        text: r.tag
      }), e
    }, [])),
    s = i()(null != r ? b.Z.getSortedRoles(r.id) : []).filter(e => {
      let {
        mentionable: t
      } = e;
      return a || t
...
let et = {
  parse(e, t) {
    ...
    return i.content = J(i.content, r, (t, n) => {
