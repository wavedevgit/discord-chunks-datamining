...
function J(e) {
  ...
  let tQ = l.useCallback(e => {
      var t;
      tn.info("[QV] | logVideoError: errorType: ".concat(e, ", videoProgress: ").concat(null == (t = e$.current) ? void 0 : t.currentTime, ", videoAssetId: ").concat(tc, ", connectionSpeed: ").concat(eA)), tC(e, eA)
    }, [eA, tC, e$, tc, tn]),
    tG = e => {
