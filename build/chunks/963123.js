...
function X(e) {
  ...
  let {
    ...
    visibleChanged: eE,
    targetRef: eO
  } = (0, B.Yy)(), [eh, eS] = l.useState(!0 === ei ? R.rq.PLAYING : R.rq.PAUSED), [eC, ej] = l.useState(!1), ey = (0, y.il)(er), [e_, ex] = l.useState(ey.percentComplete), [eD, eP] = l.useState(!1), [eT, eN] = l.useState(!0), [ek, ew] = l.useState(!1), [eA, eI] = l.useState([]), [eL, eR] = l.useState(E.Z.getEffectiveConnectionSpeed()), [eM, eV] = l.useState(0), [eB, eF] = l.useState(0), [eZ, eU] = l.useState(!1), [eq, eY] = l.useState(!1), eQ = l.useRef(!0), eG = l.useRef(null), ez = l.useRef(null), eH = (0, _.km)(e => {
    var t;
    return null != (t = e.videoProgress[er.id]) ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), eK = (0, _.km)(e => e.setVideoProgress), eW = (0, _.km)(e => e.muted), eX = (0, _.km)(e => e.volume), e$ = (0, d.e7)([v.Z], () => v.Z.useReducedMotion), eJ = (0, l.useRef)(null), e0 = (0, l.useRef)(null), e1 = l.useRef(!0), e2 = (null == (t = er.userStatus) ? void 0 : t.completedAt) != null, e6 = (0, _.km)(e => e.transcript), [e8, e4] = l.useState(null), [e3, e9] = l.useState(!1), [e7, e5] = l.useState(!1), [te, tt] = l.useState(null), tn = e2 ? null != (b = null == (n = eJ.current) ? void 0 : n.duration) ? b : 0 : Math.max(eH.maxTimestampSec, ey.progressSeconds), tr = l.useMemo(() => (0, D.T)({
    quest: er,
  ...
  }(er), ti = e2 ? eH.timestampSec >= eH.duration ? 0 : eH.timestampSec : Math.max(eH.timestampSec, ey.progressSeconds);
  (0, f.Ng)(() => {
  ...
  } = (0, F.Z)(er, eJ, tc, el, ta), ty = l.useCallback(() => {
    var e, t;
  ...
  let tB = l.useCallback(e => {
      var t;
      tr.info("[QV] | logVideoError: errorType: ".concat(e, ", videoProgress: ").concat(null == (t = eJ.current) ? void 0 : t.currentTime, ", videoAssetId: ").concat(ta, ", connectionSpeed: ").concat(eL)), tC(e, eL)
    }, [eL, tC, eJ, ta, tr]),
    tF = e => {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tG && ((0, P.e)({
        ...
        children: [null != tK && (0, r.jsx)("track", {
          ...
          srcLang: "en",
          default: !0
        }), null != ts && ta !== N.i.VIDEO_PLAYER_VIDEO_HLS && (0, r.jsx)("source", {
          onError: () => tB(R.CY.SOURCE_ERROR),
          src: ts.url,
          type: ts.mimetype
        })]
      }), (eT || ek) && eh === R.rq.PLAYING && (0, r.jsx)(p.$jN, {
        type: p.$jN.Type.WANDERING_CUBES,
        className: Q.loadingSpinner
      }), eh === R.rq.PAUSED && e8 === j.yE.LOST_FOCUS && (0, r.jsx)(H, {}), ec && eh !== R.rq.ENDED && (0, r.jsxs)(r.Fragment, {
