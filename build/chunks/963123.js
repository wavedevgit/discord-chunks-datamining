...
function ee(e) {
  ...
  let {
    ...
    visibleChanged: eO,
    targetRef: eb
  } = (0, U.Yy)(), [eC, eS] = l.useState(!0 === er ? B.rq.PLAYING : B.rq.PAUSED), [eh, e_] = l.useState(!1), [ej, ey] = l.useState(!1), ex = (0, _.il)(ee), [eD, eT] = l.useState(ex.percentComplete), [eP, eR] = l.useState(!1), [eN, eI] = l.useState(!0), [ek, eA] = l.useState(!1), [ew, eL] = l.useState([]), [eM, eV] = l.useState(b.Z.getEffectiveConnectionSpeed()), [eB, eF] = l.useState(0), [eZ, eU] = l.useState(0), [eq, eY] = l.useState(!1), [eH, eQ] = l.useState(!1), ez = l.useRef(!0), eG = l.useRef(null), eK = l.useRef(null), eX = (0, x.km)(e => {
    var t;
  ...
  }), [e5, te] = l.useState(!1), [tt, tn] = l.useState(!1), [tr, tl] = l.useState(null), to = e6 ? null != (O = null == (n = e1.current) ? void 0 : n.duration) ? O : 0 : Math.max(eX.maxTimestampSec, ex.progressSeconds), ti = l.useMemo(() => (0, T.T)({
    quest: ee,
    location: Y.dr.VIDEO_MODAL
  }), [ee]), {
    title: ta,
  ...
  let [tI, tk] = l.useState(!1), tA = l.useRef(null), tw = l.useRef(performance.now()), tL = l.useCallback(() => {
  ...
  return (0, r.jsx)(p.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [t2 && (() => {
        ...
        onLoadedData: e => {
          ti.info("[QV] | handleLoadedData: loadingFirstChunk: ".concat(eN)), eN && (tv(null != eG.current ? performance.now() - eG.current : null), eI(!1), null != tm.current && (tm.current.config.minAutoBitrate = 8e5))
        },
        onLoadedMetadata: e => {
        ...
        crossOrigin: tz,
        children: [null != t4 && tG && (0, r.jsx)("track", {
          ref: e2,
          src: t4.url,
          label: "English",
          kind: "captions",
      ...
      }), eC === B.rq.PAUSED && e7 === y.yE.LOST_FOCUS && (0, r.jsx)(W, {}), ec && eC !== B.rq.ENDED && (0, r.jsxs)(r.Fragment, {
