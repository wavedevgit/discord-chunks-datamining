...
function X(e) {
  ...
  }(), tf = tn ? e4.timestampSec >= e4.duration ? 0 : e4.timestampSec : Math.max(e4.timestampSec, ew.progressSeconds), {
    videoAssetId: tE,
    videoAsset: tg
  } = function(e, t, n, r, l) {
    var i;
  ...
  (0, p.Ng)(() => {
    tt.current && (tt.current = !1, eW(g.Z.getEffectiveConnectionSpeed()), tn && e4.timestampSec >= e4.duration && e9(ec.id, 0, e4.duration))
  }), o.useEffect(() => {
  ...
  o.useEffect(() => {
    ep !== m.Dvm.HIDDEN && ep !== m.Dvm.EXITING && ep !== m.Dvm.EXITED && (null == ep || !eD || ex || tn) && (!e_ || ey || tn) || null == e5.current || eP !== k.rq.PLAYING || (tS(k.rq.PAUSED), tn || tl(k.yE.LOST_FOCUS))
  ...
  let tN = o.useCallback(e => {
      null != e5.current && (tb(), eM(!0), tc(!1), e5.current.currentTime = e, e9(ec.id, e, e5.current.duration))
    }, [e5, e9, ec.id, tb]),
    tP = () => {
  ...
  return (0, r.jsx)(m.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tF && ((0, D.e)({
        ...
        onTimeUpdate: e => {
          null != e5.current && (e5.current.currentTime >= ez && (eG(e5.current.currentTime + 6 + 2 * Math.random()), tC(e5.current.currentTime)), e5.current.currentTime >= eH && (eK(e5.current.currentTime + 1), (0, C.qm)(ec.id, ew.taskType, e5.current.currentTime), ed(e5.current.currentTime)), e9(ec.id, e5.current.currentTime, e5.current.duration), ek(e5.current.currentTime / e5.current.duration * 100))
        },
        onEnded: e => {
          null != e5.current && (tC(e5.current.duration + 1), e9(ec.id, e5.current.duration, e5.current.duration)), tS(k.rq.ENDED), eU(!1)
        },
        onLoadedData: e => {
          if (eq) {
        ...
        onLoadedMetadata: e => {
          null != e5.current && (ts(!0), tE !== N.i.VIDEO_PLAYER_VIDEO_HLS && tN(tf), e7 ? e5.current.volume = 0 : e5.current.volume = e8)
        },
        onLoadStart: () => {
      ...
      }), eP === k.rq.PAUSED && to === k.yE.LOST_FOCUS && (0, r.jsx)(H, {}), eO && eP !== k.rq.ENDED && (0, r.jsxs)(r.Fragment, {
