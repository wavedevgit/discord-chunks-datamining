...
function J(e) {
  ...
  let {
    ...
    visibleChanged: ej,
    targetRef: ey
  } = (0, B.Yy)(), [e_, ex] = o.useState(!0 === ea ? M.rq.PLAYING : M.rq.PAUSED), [eD, eN] = o.useState(!1), eP = (0, _.il)(ei), [eT, eI] = o.useState(eP.percentComplete), [ew, ek] = o.useState(!1), [eA, eL] = o.useState(!0), [eR, eM] = o.useState(!1), [eV, eq] = o.useState([]), [eB, eF] = o.useState(b.Z.getEffectiveConnectionSpeed()), [eU, eZ] = o.useState(0), [eY, eW] = o.useState(0), [eQ, ez] = o.useState(!1), [eG, eH] = o.useState(!1), eK = o.useRef(!0), eX = o.useRef(null), e$ = o.useRef(null), eJ = (0, o.useRef)(-1), e0 = (0, x.km)(e => {
    var t;
  ...
  return (0, r.jsx)(p.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      }), (eA || eR) && e_ === M.rq.PLAYING && (0, r.jsx)(p.$jN, {
