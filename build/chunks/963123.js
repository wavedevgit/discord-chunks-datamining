...
function W() {
  ...
  return (0, r.jsx)("div", {
    ...
    style: {
      background: (0, f.wj)(e) ? "rgba(0, 0, 0, 0.65)" : "rgba(255, 255, 255, 0.65)"
    },
...
function $(e) {
  ...
  return null == a ? null : (0, r.jsx)(A.A, {
    ...
    children: e => (0, r.jsx)("img", {
      ...
      src: a.url,
      alt: "Video thumbnail",
      className: i()(H.stillFrameImageCard, {
        [H.stillFrameImageCardHidden]: !n
      })
    })
  })
}
...
function ee(e) {
  ...
  let {
  ...
  } = e, es = (0, x.km)(e => e.transcriptEnabled), ec = (0, x.km)(e => e.setTranscriptEnabled), eu = (0, x.km)(e => e.captionEnabled), ed = (0, x.km)(e => e.setCaptionEnabled), em = (0, x.km)(e => e.fullScreenEnabled), ef = (0, x.km)(e => e.setFullScreenEnabled), {
    focused: ep,
    focusedChanged: ev
  } = (0, q.xU)(), {
    visible: eg,
    visibleChanged: eb,
    targetRef: eE
  } = (0, q.Yy)(), [eO, eC] = l.useState(!0 === er ? B.rq.PLAYING : B.rq.PAUSED), [eh, eS] = l.useState(!1), [ej, ey] = l.useState(!1), e_ = (0, _.il)(ee), [ex, eD] = l.useState(e_.percentComplete), [eT, eP] = l.useState(!1), [eN, ek] = l.useState(!0), [eI, ew] = l.useState(!1), [eA, eL] = l.useState([]), [eR, eM] = l.useState(O.Z.getEffectiveConnectionSpeed()), [eV, eB] = l.useState(0), [eF, eZ] = l.useState(0), [eq, eU] = l.useState(!1), [eQ, eG] = l.useState(!1), eY = l.useRef(!0), ez = l.useRef(null), eH = l.useRef(null), eK = (0, x.km)(e => {
    var t;
    return null != (t = e.videoProgress[ee.id]) ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), eX = (0, x.km)(e => e.setVideoProgress), eW = (0, x.km)(e => e.muted), e$ = (0, x.km)(e => e.volume), eJ = (0, m.e7)([g.Z], () => g.Z.useReducedMotion), e0 = (0, l.useRef)(null), e1 = (0, l.useRef)(null), e2 = l.useRef(!0), e8 = (null == (t = ee.userStatus) ? void 0 : t.completedAt) != null, e6 = (0, x.km)(e => e.transcript), [e4, e7] = l.useState(null), e3 = (0, P._)({
    location: Q.dr.VIDEO_MODAL
  }), [e9, e5] = l.useState(!1), [te, tt] = l.useState(!1), [tn, tr] = l.useState(null), tl = e8 ? null != (E = null == (n = e0.current) ? void 0 : n.duration) ? E : 0 : Math.max(eK.maxTimestampSec, e_.progressSeconds), to = l.useMemo(() => (0, T.T)({
    quest: ee,
    location: Q.dr.VIDEO_MODAL
  }), [ee]), {
    title: ti,
  ...
  }(ee), ts = e8 ? eK.timestampSec >= eK.duration ? 0 : eK.timestampSec : Math.max(eK.timestampSec, e_.progressSeconds);
  (0, v.Ng)(() => {
  ...
  let {
    ...
    return l.useEffect(() => {
      ...
      s.current = new a.ZP({
        ...
        startFragPrefetch: !0,
        startLevel: -1
      }), s.current.on(a.ZP.Events.FRAG_LOADING, p), s.current.loadSource(f.url), s.current.attachMedia(t.current), i.current = !0;
      let e = s.current;
      return () => {
    ...
    if (to.info("[QV] | updatePlayerState | playerState: ".concat(e)), eC(e), null != e0.current) switch (e) {
      case B.rq.PLAYING:
  ...
  let [tk, tI] = l.useState(!1), tw = l.useRef(null), tA = l.useRef(performance.now()), tL = l.useCallback(() => {
    null != tw.current && clearTimeout(tw.current), eO === B.rq.PLAYING && (tw.current = setTimeout(() => {
  ...
  let tZ = l.useCallback(e => {
    ...
    tq = () => {
      if (null != e0.current) switch (to.info("[QV] | handlePlaybackBtnClick | playerState: ".concat(eO)), eO) {
        case B.rq.ENDED:
  ...
  let tH = l.useCallback(e => {
      var t;
      to.info("[QV] | logVideoError: errorType: ".concat(e, ", videoProgress: ").concat(null == (t = e0.current) ? void 0 : t.currentTime, ", videoAssetId: ").concat(tm, ", connectionSpeed: ").concat(eR)), t_(e, eR)
    }, [eR, t_, e0, tm, to]),
    tK = e => {
  ...
  return (0, r.jsx)(p.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [t1 && (() => {
        ...
        onLoadedData: e => {
          to.info("[QV] | handleLoadedData: loadingFirstChunk: ".concat(eN)), eN && (tp(eR, null != ez.current ? performance.now() - ez.current : null), ek(!1), null != td.current && (td.current.config.minAutoBitrate = 8e5))
        },
        onLoadedMetadata: e => {
        ...
        crossOrigin: tY,
        children: [null != t6 && tz && (0, r.jsx)("track", {
          ref: e1,
          src: t6.url,
          label: "English",
          kind: "captions",
      ...
      }), (eN || eI) && eO === B.rq.PLAYING && (0, r.jsx)(p.$jN, {
        type: p.$jN.Type.WANDERING_CUBES,
        className: H.loadingSpinner
      }), eO === B.rq.PAUSED && e4 === y.yE.LOST_FOCUS && (0, r.jsx)(W, {}), es && eO !== B.rq.ENDED && (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(p.P3F, {
          onClick: () => ec(!1),
          tabIndex: -1,
          children: (0, r.jsx)("div", {
            className: H.transcriptOverlay
          })
        ...
        children: eO === B.rq.PLAYING ? (0, r.jsx)(p.o1U, {
          className: H.playPausePopIcon
        }) : (0, r.jsx)(p.fpf, {
          className: H.playPausePopIcon
        })
      }, eO), eu && null != tn && (0, r.jsx)(s.animated.div, {
        className: H.captionContainer,
        ref: t$,
        style: {
          translateY: (0, s.to)([tX.to({
            range: [0, 1],
            output: [0, -50]
          })], e => "".concat(e, "px"))
        },
        ...
        style: {
          paddingLeft: (0, s.to)([tX.to({
            range: [0, 1],
            output: [0, 25]
          })], e => "".concat(e, "px")),
          paddingRight: (0, s.to)([tX.to({
            range: [0, 1],
            output: [0, 25]
          })], e => "".concat(e, "px")),
          height: (0, s.to)([tX.to({
        ...
        children: [(0, r.jsx)(M.Z, {
          ...
          style: {
            paddingTop: (0, s.to)([tX.to({
              range: [0, 1],
              output: [0, 1]
            })], e => "".concat(e * e * 12, "px")),
            paddingBottom: (0, s.to)([tX.to({
              range: [0, 1],
              output: [0, 1]
            })], e => "".concat(e * e * 12, "px")),
            pointerEvents: (0, s.to)([tX.to({
              range: [0, 1],
              output: [0, 1]
            })], e => e < .3 ? "none" : "auto")
          },
