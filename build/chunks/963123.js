...
function X(e) {
  let {
    quest: t,
    shouldShow: n
  } = e, o = l.useMemo(() => (0, k.z)(k.i.VIDEO_PLAYER_THUMBNAIL, t), [t]);
  return null == o ? null : (0, r.jsx)(w.A, {
    questOrQuests: t,
...
function J(e) {
  ...
  let {
    ...
    onClose: eo
  } = e, ei = (0, x.km)(e => e.transcriptEnabled), ea = (0, x.km)(e => e.setTranscriptEnabled), es = (0, x.km)(e => e.captionEnabled), ec = (0, x.km)(e => e.setCaptionEnabled), eu = (0, x.km)(e => e.fullScreenEnabled), ed = (0, x.km)(e => e.setFullScreenEnabled), {
    focused: em,
    focusedChanged: ep
  } = (0, Z.xU)(), {
    visible: ef,
    visibleChanged: ev,
    targetRef: eg
  } = (0, Z.Yy)(), [eb, eE] = l.useState(!0 === en ? V.rq.PLAYING : V.rq.PAUSED), [eO, eh] = l.useState(!1), eS = (0, _.il)(J), [eC, ej] = l.useState(eS.percentComplete), [ey, e_] = l.useState(!1), [ex, eD] = l.useState(!0), [eP, eT] = l.useState(!1), [eN, ek] = l.useState([]), [eI, ew] = l.useState(O.Z.getEffectiveConnectionSpeed()), [eA, eL] = l.useState(0), [eR, eM] = l.useState(0), [eV, eB] = l.useState(!1), [eF, eZ] = l.useState(!1), eU = l.useRef(!0), eq = l.useRef(null), eY = l.useRef(null), eQ = (0, x.km)(e => {
    var t;
    return null != (t = e.videoProgress[J.id]) ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), eG = (0, x.km)(e => e.setVideoProgress), ez = (0, x.km)(e => e.muted), eH = (0, x.km)(e => e.volume), eK = (0, m.e7)([g.Z], () => g.Z.useReducedMotion), eW = (0, l.useRef)(null), eX = (0, l.useRef)(null), e$ = l.useRef(!0), eJ = (null == (t = J.userStatus) ? void 0 : t.completedAt) != null, e0 = (0, x.km)(e => e.transcript), [e1, e2] = l.useState(null), [e6, e8] = l.useState(!1), [e4, e7] = l.useState(!1), [e3, e9] = l.useState(null), e5 = eJ ? null != (E = null == (n = eW.current) ? void 0 : n.duration) ? E : 0 : Math.max(eQ.maxTimestampSec, eS.progressSeconds), te = l.useMemo(() => (0, P.T)({
    quest: J,
  ...
  }(J), tr = eJ ? eQ.timestampSec >= eQ.duration ? 0 : eQ.timestampSec : Math.max(eQ.timestampSec, eS.progressSeconds);
  (0, v.Ng)(() => {
  ...
  let {
    ...
    return l.useEffect(() => {
      ...
      s.current = new a.ZP({
        ...
        startFragPrefetch: !0,
        startLevel: -1
      }), s.current.on(a.ZP.Events.FRAG_LOADING, p), s.current.loadSource(m.url), s.current.attachMedia(t.current), i.current = !0;
      let e = s.current;
      return () => {
    ...
    if (te.info("[QV] | updatePlayerState | playerState: ".concat(e)), eE(e), null != eW.current) switch (e) {
      case V.rq.PLAYING:
  ...
  let tk = l.useCallback(e => {
    ...
    tI = () => {
      if (null != eW.current) switch (te.info("[QV] | handlePlaybackBtnClick | playerState: ".concat(eb)), eb) {
        case V.rq.ENDED:
  ...
  let tR = l.useCallback(e => {
      var t;
      te.info("[QV] | logVideoError: errorType: ".concat(e, ", videoProgress: ").concat(null == (t = eW.current) ? void 0 : t.currentTime, ", videoAssetId: ").concat(tl, ", connectionSpeed: ").concat(eI)), tO(e, eI)
    }, [eI, tO, eW, tl, te]),
    tM = e => {
  ...
  return (0, r.jsx)(f.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tq && (() => {
        ...
        onLoadedData: e => {
          te.info("[QV] | handleLoadedData: loadingFirstChunk: ".concat(ex)), ex && (ts(eI, null != eq.current ? Date.now() - eq.current : null), eD(!1), null != ti.current && (ti.current.config.minAutoBitrate = 8e5))
        },
        onLoadedMetadata: e => {
        ...
        children: [null != tG && (0, r.jsx)("track", {
          ref: eX,
          src: tG.url,
          label: "English",
          kind: "captions",
          srcLang: "en",
          default: !0
        }), null != to && tl !== k.i.VIDEO_PLAYER_VIDEO_HLS && (0, r.jsx)("source", {
          onError: () => tR(V.CY.SOURCE_ERROR),
          src: to.url,
          type: to.mimetype
        })]
      }), (ex || eP) && eb === V.rq.PLAYING && (0, r.jsx)(f.$jN, {
        type: f.$jN.Type.WANDERING_CUBES,
        className: z.loadingSpinner
      }), eb === V.rq.PAUSED && e1 === y.yE.LOST_FOCUS && (0, r.jsx)(W, {}), ei && eb !== V.rq.ENDED && (0, r.jsxs)(r.Fragment, {
        ...
        children: eb === V.rq.PLAYING ? (0, r.jsx)(f.o1U, {
          className: z.playPausePopIcon
        }) : (0, r.jsx)(f.fpf, {
          className: z.playPausePopIcon
        })
      }, eb), es && null != e3 && (0, r.jsx)(s.animated.div, {
        className: z.captionContainer,
        ref: tF,
        style: {
          translateY: (0, s.to)([tV.to({
            range: [0, 1],
            output: [0, -50]
          })], e => "".concat(e, "px"))
        },
        ...
        style: {
          paddingLeft: (0, s.to)([tV.to({
            range: [0, 1],
            output: [0, 25]
          })], e => "".concat(e, "px")),
          paddingRight: (0, s.to)([tV.to({
            range: [0, 1],
            output: [0, 25]
          })], e => "".concat(e, "px")),
          height: (0, s.to)([tV.to({
        ...
        children: [(0, r.jsx)(R.Z, {
          ...
          style: {
            paddingTop: (0, s.to)([tV.to({
              range: [0, 1],
              output: [0, 1]
            })], e => "".concat(e * e * 12, "px")),
            paddingBottom: (0, s.to)([tV.to({
              range: [0, 1],
              output: [0, 1]
            })], e => "".concat(e * e * 12, "px")),
            pointerEvents: (0, s.to)([tV.to({
              range: [0, 1],
              output: [0, 1]
            })], e => e < .3 ? "none" : "auto")
          },
