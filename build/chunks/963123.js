...
function $(e) {
  ...
  }, c.X), eX = (0, _.km)(e => e.setVideoProgress), e$ = (0, _.km)(e => e.muted), eJ = (0, _.km)(e => e.volume), e0 = (0, d.e7)([v.Z], () => v.Z.useReducedMotion), e1 = (0, l.useRef)(null), e2 = (0, l.useRef)(null), e8 = l.useRef(!0), e6 = (null == (t = el.userStatus) ? void 0 : t.completedAt) != null, e3 = (0, _.km)(e => e.transcript), [e7, e4] = l.useState(null), [e9, e5] = l.useState(!1), [te, tt] = l.useState(!1), [tn, tr] = l.useState(null), tl = e6 ? null != (b = null == (n = e1.current) ? void 0 : n.duration) ? b : 0 : Math.max(eW.maxTimestampSec, ex.progressSeconds), to = l.useMemo(() => (0, D.T)({
    quest: el,
  ...
  return (0, r.jsx)(p.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      }), eC === M.rq.PAUSED && e7 === j.yE.LOST_FOCUS && (0, r.jsx)(K, {}), ed && eC !== M.rq.ENDED && (0, r.jsxs)(r.Fragment, {
