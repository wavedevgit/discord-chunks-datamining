...
function ee(e) {
  ...
  let {
    ...
    visibleChanged: eO,
    targetRef: eb
  } = (0, U.Yy)(), [eC, eS] = l.useState(!0 === er ? B.rq.PLAYING : B.rq.PAUSED), [eh, e_] = l.useState(!1), [ey, ej] = l.useState(!1), ex = (0, _.il)(ee), [eT, eD] = l.useState(ex.percentComplete), [eP, eR] = l.useState(!1), [eN, eI] = l.useState(!0), [ek, ew] = l.useState(!1), [eA, eL] = l.useState([]), [eM, eV] = l.useState(b.Z.getEffectiveConnectionSpeed()), [eB, eZ] = l.useState(0), [eF, eU] = l.useState(0), [eq, eH] = l.useState(!1), [eY, eQ] = l.useState(!1), eG = l.useRef(!0), ez = l.useRef(null), eK = l.useRef(null), eX = (0, x.km)(e => {
    var t;
  ...
  let [tI, tk] = l.useState(!1), tw = l.useRef(null), tA = l.useRef(performance.now()), tL = l.useCallback(() => {
  ...
  return (0, r.jsx)(p.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [t2 && (() => {
        ...
        onLoadedData: e => {
          ti.info("[QV] | handleLoadedData: loadingFirstChunk: ".concat(eN)), eN && (tv(null != ez.current ? performance.now() - ez.current : null), eI(!1), null != tm.current && (tm.current.config.minAutoBitrate = 8e5))
        },
        onLoadedMetadata: e => {
      ...
      }), (eN || ek) && eC === B.rq.PLAYING && (0, r.jsx)(p.$jN, {
