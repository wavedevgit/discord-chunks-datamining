...
function K(e) {
  let {
    quest: t,
    shouldShow: n
  } = e, l = o.useMemo(() => (0, T.z)(T.i.VIDEO_PLAYER_THUMBNAIL, t), [t]);
  return null == l ? null : (0, r.jsx)(I.A, {
    questOrQuests: t,
...
function J(e) {
  ...
  let {
    quest: ed,
    videoSessionId: em,
    onOptimisticProgressUpdate: ep,
    autoplay: ef,
    parentTransitionState: ev,
    performanceClockStartTime: eg
  } = e, eE = (0, S.aM)(), eb = (0, h._F)(), eO = (0, h.O5)(), eh = (0, x.km)(e => e.transcriptEnabled), eS = (0, x.km)(e => e.setTranscriptEnabled), eC = (0, x.km)(e => e.captionEnabled), ej = (0, x.km)(e => e.setCaptionEnabled), ey = (0, x.km)(e => e.fullScreenEnabled), ex = (0, x.km)(e => e.setFullScreenEnabled), {
    focused: e_,
    focusedChanged: eN
  } = (0, q.xU)(), {
    visible: eD,
    visibleChanged: eP,
    targetRef: eT
  } = (0, q.Yy)(), [eI, ew] = o.useState(!0 === ef ? R.rq.PLAYING : R.rq.PAUSED), [ek, eA] = o.useState(!1), eL = (0, y.il)(ed), [eR, eM] = o.useState(eL.percentComplete), [eV, eq] = o.useState(!1), [eB, eF] = o.useState(!0), [eU, eZ] = o.useState(!1), [eY, eQ] = o.useState([]), [eW, ez] = o.useState(E.Z.getEffectiveConnectionSpeed()), [eG, eH] = o.useState(0), [eK, eX] = o.useState(0), [e$, eJ] = o.useState(!1), [e0, e1] = o.useState(!1), e2 = o.useRef(!0), e6 = o.useRef(null), e4 = o.useRef(null), e8 = (0, o.useRef)(-1), e7 = (0, x.km)(e => {
    var t;
    return null !== (t = e.videoProgress[ed.id]) && void 0 !== t ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), e9 = (0, x.km)(e => e.setVideoProgress), e3 = (0, x.km)(e => e.muted), e5 = (0, x.km)(e => e.volume), te = (0, u.e7)([f.Z], () => f.Z.useReducedMotion), tt = (0, o.useRef)(null), tn = (0, o.useRef)(null), tr = o.useRef(!0), to = (null === (t = ed.userStatus) || void 0 === t ? void 0 : t.completedAt) != null, tl = (0, x.km)(e => e.transcript), [ti, ts] = o.useState(null), [ta, tc] = o.useState(!1), [tu, td] = o.useState(!1), [tm, tp] = o.useState(null), tf = to ? null !== (g = null === (n = tt.current) || void 0 === n ? void 0 : n.duration) && void 0 !== g ? g : 0 : Math.max(e7.maxTimestampSec, eL.progressSeconds), tv = to ? e7.timestampSec >= e7.duration ? 0 : e7.timestampSec : Math.max(e7.timestampSec, eL.progressSeconds), tg = o.useMemo(() => (0, N.T)({
    quest: ed,
    ...
    return o.useEffect(() => {
      d === T.i.VIDEO_PLAYER_VIDEO_HLS && null != m && null != t.current && !i.current && (a.current = new s.ZP({
        maxBufferLength: 15,
        startPosition: r,
        startFragPrefetch: !0
      }), a.current.loadSource(m.url), a.current.attachMedia(t.current), i.current = !0)
    }, [m, d, t, r]), {
      videoAssetId: d,
      videoAsset: m,
      hlsRef: a
    }
  }(ed, tt, eW, tv), th = o.useCallback(e => {
    if (null != tt.current) {
      var t, n;
      eb({
        questId: ed.id,
  ...
  }, [eb, ed.id, tE, to, em, tO]), tS = o.useCallback(() => {
    var e, t;
    ...
    if (tg.info("[QV] | updatePlayerState | playerState: ".concat(e)), ew(e), null != tt.current) switch (e) {
      case R.rq.PLAYING:
        tt.current.play(), eb({
          questId: ed.id,
  ...
  }, [ti, ed.id, eb, em, tO]), o.useEffect(() => {
    eN && null != tt.current && eb({
      questId: ed.id,
  ...
  let ty = o.useCallback(e => {
    var t;
    tg.info("[QV] | sendProgressUpdate: Checking conditions..."), to || (null === (t = ed.userStatus) || void 0 === t ? void 0 : t.enrolledAt) == null || (tg.info("[QV] | sendProgressUpdate: quest enrolled and not completed, sending video progress: ".concat(e)), (0, y.FI)(ed, e)), null != tt.current && eb({
      questId: ed.id,
  ...
  let tx = () => {
    ...
    tD = o.useCallback(() => {
      ...
      null == t || (0, O.rB)(t) || (t.removeEventListener(O.NO, tD), ex(!1), eb({
        questId: ed.id,
    ...
    tP = () => {
      ...
      tg.info("[QV] | handleSeekBackIncrement | newTime: ".concat(e)), tI(e), eI === R.rq.ENDED && tj(R.rq.PAUSED), eO({
        questId: ed.id,
    ...
    tT = () => {
      ...
      tg.info("[QV] | handleSeekForwardIncrement | newTime: ".concat(e)), tI(e), eI !== R.rq.ENDED && e >= tt.current.duration && tj(R.rq.ENDED), eO({
        questId: ed.id,
        questContent: j.jn.VIDEO_MODAL,
  ...
  let tI = o.useCallback(e => {
    ...
    tw = () => {
      if (null != tt.current) switch (tg.info("[QV] | handlePlaybackBtnClick | playerState: ".concat(eI)), eI) {
        case R.rq.ENDED:
  ...
  let tR = o.useCallback(e => {
      try {
        ...
        tg.info("[QV] | logVideoError: errorType: ".concat(e, ", videoProgress: ").concat(l, ", videoAssetId: ").concat(tE, ", connectionSpeed: ").concat(eW, ", error: ").concat(r, ", networkState: ").concat(o)), eb({
          questId: ed.id,
  ...
  return (0, r.jsx)(m.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tZ && ((0, D.e)({
        ...
        onLoadStart: () => {
          e6.current = Date.now(), tg.info("[QV] | handleLoadStart | loadingStartTime: ".concat(e6.current)), eb({
            questId: ed.id,
        ...
        onPlaying: () => {
          ...
          tg.info("[QV] | ⏰ Video FCP: ".concat(e, "ms")), eb({
            questId: ed.id,
        ...
        onWaiting: e => {
          e4.current = Date.now(), tg.info("[QV] | handleWaitingForData: bufferingStartTime: ".concat(e4.current)), e8.current += 1, eb({
            questId: ed.id,
        ...
        children: [null != tW && (0, r.jsx)("track", {
          ...
          srcLang: "en",
          default: !0
        }), null != tb && tE !== T.i.VIDEO_PLAYER_VIDEO_HLS && (0, r.jsx)("source", {
          onError: () => tR(R.CY.SOURCE_ERROR),
          src: tb.url,
          type: tb.mimetype
        })]
      }), (eB || eU) && eI === R.rq.PLAYING && (0, r.jsx)(m.$jN, {
        type: m.$jN.Type.WANDERING_CUBES,
        className: Q.loadingSpinner
      }), eI === R.rq.PAUSED && ti === j.yE.LOST_FOCUS && (0, r.jsx)(H, {}), eh && eI !== R.rq.ENDED && (0, r.jsxs)(r.Fragment, {
        ...
        children: eI === R.rq.PLAYING ? (0, r.jsx)(m.o1U, {
          className: Q.playPausePopIcon
        }) : (0, r.jsx)(m.fpf, {
          className: Q.playPausePopIcon
        })
      }, eI), eC && null != tm && (0, r.jsx)(a.animated.div, {
        ...
        children: [(0, r.jsx)(A.Z, {
          ...
          children: (0, r.jsx)(w.Z, {
            ...
            handleTranscriptBtnClick: () => {
              eh || null != tl && tl.questId === ed.id && tl.fetchStatus !== x.iF.NONE && tl.fetchStatus !== x.iF.FAILURE || (0, C.lL)(ed), eS(!eh), eO({
                questId: ed.id,
                questContent: j.jn.VIDEO_MODAL,
            ...
            handleFullScreenBtnClick: () => {
              ...
              t && null != n ? ((0, O.Dj)(n), n.addEventListener(O.NO, tD), eb({
                questId: ed.id,
                event: U.rMx.QUEST_VIDEO_FULLSCREEN_ENTERED,
                properties: {
                  video_session_id: em
                }
              })) : t || null == n || (n.removeEventListener(O.NO, tD), eb({
                questId: ed.id,
                event: U.rMx.QUEST_VIDEO_FULLSCREEN_EXITED,
                properties: {
                  video_session_id: em
