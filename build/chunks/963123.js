...
function X(e) {
  let {
    quest: t,
    shouldShow: n
  } = e, l = o.useMemo(() => (0, P.z)(P.i.VIDEO_PLAYER_THUMBNAIL, t), [t]);
  return null == l ? null : (0, r.jsx)(T.A, {
    questOrQuests: t,
...
function ee(e) {
  ...
  let {
    quest: em,
    videoSessionId: ep,
    onOptimisticProgressUpdate: ev,
    autoplay: ef,
    parentTransitionState: eE,
    performanceClockStartTime: eg
  } = e, eb = (0, C.aM)(), eO = (0, S._F)(), eS = (0, S.O5)(), eC = (0, _.km)(e => e.transcriptEnabled), eh = (0, _.km)(e => e.setTranscriptEnabled), ej = (0, _.km)(e => e.captionEnabled), ey = (0, _.km)(e => e.setCaptionEnabled), e_ = (0, _.km)(e => e.fullScreenEnabled), ex = (0, _.km)(e => e.setFullScreenEnabled), {
    focused: eN,
    focusedChanged: eD
  } = (0, B.xU)(), {
    visible: eP,
    visibleChanged: eT,
    targetRef: eI
  } = (0, B.Yy)(), [ew, eA] = o.useState(!0 === ef ? R.rq.PLAYING : R.rq.PAUSED), [eL, ek] = o.useState(!1), eR = (0, y.il)(em), [eM, eq] = o.useState(eR.percentComplete), [eB, eF] = o.useState(!1), [eU, eV] = o.useState(!0), [eZ, eY] = o.useState(!1), [eW, ez] = o.useState([]), [eG, eH] = o.useState(g.Z.getEffectiveConnectionSpeed()), [eK, eQ] = o.useState(0), [eX, e$] = o.useState(0), [eJ, e0] = o.useState(!1), [e1, e2] = o.useState(!1), e6 = o.useRef(!0), e4 = o.useRef(null), e8 = o.useRef(null), e9 = (0, o.useRef)(-1), e7 = (0, _.km)(e => {
    var t;
    return null !== (t = e.videoProgress[em.id]) && void 0 !== t ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), e3 = (0, _.km)(e => e.setVideoProgress), e5 = (0, _.km)(e => e.muted), te = (0, _.km)(e => e.volume), tt = (0, u.e7)([v.Z], () => v.Z.useReducedMotion), tn = (0, o.useRef)(null), tr = (0, o.useRef)(null), to = o.useRef(!0), tl = (null === (t = em.userStatus) || void 0 === t ? void 0 : t.completedAt) != null, ti = (0, _.km)(e => e.transcript), [ts, ta] = o.useState(null), [tc, tu] = o.useState(!1), [td, tm] = o.useState(!1), [tp, tv] = o.useState(null), tf = tl ? null !== (E = null === (n = tn.current) || void 0 === n ? void 0 : n.duration) && void 0 !== E ? E : 0 : Math.max(e7.maxTimestampSec, eR.progressSeconds), tE = tl ? e7.timestampSec >= e7.duration ? 0 : e7.timestampSec : Math.max(e7.timestampSec, eR.progressSeconds), {
    videoAssetId: tg,
    videoAsset: tb,
    hlsRef: tO
  } = function(e, t, n, r) {
    ...
    return o.useEffect(() => {
      d === P.i.VIDEO_PLAYER_VIDEO_HLS && null != m && null != t.current && !i.current && (a.current = new s.ZP({
        maxBufferLength: 15,
        startPosition: r,
        startFragPrefetch: !0
  ...
  }(em, tn, eG, tE), tS = o.useCallback(e => {
    if (null != tn.current) {
      var t, n;
      eO({
        questId: em.id,
        event: Z.rMx.QUEST_VIDEO_SEGMENT_WATCHED,
        properties: G((t = G({}, e), n = n = {
          video_asset_id: tg,
          quest_completed: tl,
    ...
    if (eA(e), null != tn.current) switch (e) {
      case R.rq.PLAYING:
        tn.current.play(), eO({
          questId: em.id,
  ...
  }, [ts, em.id, eO, ep, tO]), o.useEffect(() => {
    eD && null != tn.current && eO({
      questId: em.id,
  ...
  let tj = o.useCallback(e => {
    var t;
    tl || (null === (t = em.userStatus) || void 0 === t ? void 0 : t.enrolledAt) == null || (0, y.FI)(em, e), null != tn.current && eO({
      questId: em.id,
  ...
  let ty = () => {
    ...
    tD = () => {
      null != tn.current && (tT(Math.max(tn.current.currentTime - 10, 0)), ew === R.rq.ENDED && th(R.rq.PAUSED), eS({
        questId: em.id,
    ...
    tP = () => {
      ...
      tT(e), ew !== R.rq.ENDED && e >= tn.current.duration && th(R.rq.ENDED), eS({
        questId: em.id,
        questContent: j.jn.VIDEO_MODAL,
  ...
  return (0, r.jsx)(m.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tV && ((0, D.e)({
        ...
        onWaiting: e => {
          e8.current = Date.now(), e9.current += 1, eO({
            questId: em.id,
        ...
        children: [null != tW && (0, r.jsx)("track", {
          ...
          srcLang: "en",
          default: !0
        }), null != tb && tg !== P.i.VIDEO_PLAYER_VIDEO_HLS && (0, r.jsx)("source", {
          onError: () => tk(R.CY.SOURCE_ERROR),
          src: tb.url,
          type: tb.mimetype
        })]
      }), (eU || eZ) && ew === R.rq.PLAYING && (0, r.jsx)(m.$jN, {
        type: m.$jN.Type.WANDERING_CUBES,
        className: z.loadingSpinner
      }), ew === R.rq.PAUSED && ts === R.yE.LOST_FOCUS && (0, r.jsx)(Q, {}), eC && ew !== R.rq.ENDED && (0, r.jsxs)(r.Fragment, {
        ...
        style: {
          paddingLeft: (0, a.to)([tM.to({
            range: [0, 1],
            output: [0, 25]
          })], e => "".concat(e, "px")),
          paddingRight: (0, a.to)([tM.to({
            range: [0, 1],
            output: [0, 25]
          })], e => "".concat(e, "px")),
          height: (0, a.to)([tM.to({
        ...
        children: [(0, r.jsx)(L.Z, {
          ...
          children: (0, r.jsx)(w.Z, {
            ...
            handleTranscriptBtnClick: () => {
              eC || null != ti && ti.questId === em.id && ti.fetchStatus !== _.iF.NONE && ti.fetchStatus !== _.iF.FAILURE || (0, h.lL)(em), eh(!eC), eS({
                questId: em.id,
                questContent: j.jn.VIDEO_MODAL,
