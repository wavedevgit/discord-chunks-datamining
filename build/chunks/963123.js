...
function X(e) {
  ...
  }, c.X), eH = (0, _.km)(e => e.setVideoProgress), eK = (0, _.km)(e => e.muted), eX = (0, _.km)(e => e.volume), e$ = (0, d.e7)([v.Z], () => v.Z.useReducedMotion), eJ = (0, l.useRef)(null), e0 = (0, l.useRef)(null), e1 = l.useRef(!0), e2 = (null == (t = er.userStatus) ? void 0 : t.completedAt) != null, e6 = (0, _.km)(e => e.transcript), [e8, e4] = l.useState(null), [e3, e9] = l.useState(!1), [e7, e5] = l.useState(!1), [te, tt] = l.useState(null), tn = e2 ? null != (b = null == (n = eJ.current) ? void 0 : n.duration) ? b : 0 : Math.max(ez.maxTimestampSec, ey.progressSeconds), tr = l.useMemo(() => (0, N.T)({
    quest: er,
  ...
  return (0, r.jsx)(p.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      }), eh === R.rq.PAUSED && e8 === j.yE.LOST_FOCUS && (0, r.jsx)(z, {}), ec && eh !== R.rq.ENDED && (0, r.jsxs)(r.Fragment, {
