...
function $(e) {
  let {
    quest: t,
    shouldShow: n
  } = e, o = l.useMemo(() => (0, I.z0)(t, u.X.WATCH_VIDEO, I.n1.VIDEO, I.O.THUMBNAIL), [t]);
  return null == o ? null : (0, r.jsx)(A.A, {
    questOrQuests: t,
...
function ee(e) {
  ...
  let {
    ...
    visibleChanged: eg,
    targetRef: eb
  } = (0, q.Yy)(), [eE, eO] = l.useState(!0 === er ? B.rq.PLAYING : B.rq.PAUSED), [eh, eC] = l.useState(!1), [eS, ej] = l.useState(!1), ey = (0, _.il)(ee), [e_, ex] = l.useState(ey.percentComplete), [eD, eT] = l.useState(!1), [eP, eN] = l.useState(!0), [ek, eI] = l.useState(!1), [ew, eA] = l.useState([]), [eL, eR] = l.useState(O.Z.getEffectiveConnectionSpeed()), [eM, eV] = l.useState(0), [eB, eF] = l.useState(0), [eZ, eq] = l.useState(!1), [eU, eQ] = l.useState(!1), eG = l.useRef(!0), eY = l.useRef(null), eH = l.useRef(null), ez = (0, x.km)(e => {
    var t;
    return null != (t = e.videoProgress[ee.id]) ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), eK = (0, x.km)(e => e.setVideoProgress), eW = (0, x.km)(e => e.muted), eX = (0, x.km)(e => e.volume), e$ = (0, m.e7)([g.Z], () => g.Z.useReducedMotion), eJ = (0, l.useRef)(null), e0 = (0, l.useRef)(null), e1 = l.useRef(!0), e2 = (null == (t = ee.userStatus) ? void 0 : t.completedAt) != null, e8 = (0, x.km)(e => e.transcript), e6 = (0, D.Ec)(ee), e4 = (0, D.H)() && e6, [e7, e3] = l.useState(null), [e9, e5] = l.useState(!1), [te, tt] = l.useState(!1), [tn, tr] = l.useState(null), tl = e2 ? null != (E = null == (n = eJ.current) ? void 0 : n.duration) ? E : 0 : Math.max(ez.maxTimestampSec, ey.progressSeconds), to = l.useMemo(() => (0, P.T)({
    quest: ee,
  ...
  }(ee), ts = e2 ? ez.timestampSec >= ez.duration ? 0 : ez.timestampSec : Math.max(ez.timestampSec, ey.progressSeconds);
  (0, v.Ng)(() => {
  ...
  let {
  ...
  } = (0, U.Z)(ee, eJ, td, et, tm), tD = l.useCallback(() => {
    var e, t;
    ...
    if (to.info("[QV] | updatePlayerState | playerState: ".concat(e)), eO(e), null != eJ.current) switch (e) {
      case B.rq.PLAYING:
  ...
  let [tk, tI] = l.useState(!1), tw = l.useRef(null), tA = l.useRef(performance.now()), tL = l.useCallback(() => {
    null != tw.current && clearTimeout(tw.current), eE === B.rq.PLAYING && (tw.current = setTimeout(() => {
  ...
  let tq = l.useCallback(e => {
    ...
    tU = () => {
      if (null != eJ.current) switch (to.info("[QV] | handlePlaybackBtnClick | playerState: ".concat(eE)), eE) {
        case B.rq.ENDED:
  ...
  let tH = l.useCallback(e => {
      var t;
      to.info("[QV] | logVideoError: errorType: ".concat(e, ", videoProgress: ").concat(null == (t = eJ.current) ? void 0 : t.currentTime, ", videoAssetId: ").concat(tm, ", connectionSpeed: ").concat(eL)), t_(e, eL)
    }, [eL, t_, eJ, tm, to]),
    tz = e => {
  ...
  return (0, r.jsx)(p.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [t0 && (() => {
        ...
        onLoadedData: e => {
          to.info("[QV] | handleLoadedData: loadingFirstChunk: ".concat(eP)), eP && (tp(eL, null != eY.current ? performance.now() - eY.current : null), eN(!1), null != td.current && (td.current.config.minAutoBitrate = 8e5))
        },
        onLoadedMetadata: e => {
      ...
      }), (eP || ek) && eE === B.rq.PLAYING && (0, r.jsx)(p.$jN, {
        type: p.$jN.Type.WANDERING_CUBES,
        className: z.loadingSpinner
      }), eE === B.rq.PAUSED && e7 === y.yE.LOST_FOCUS && (0, r.jsx)(X, {}), ea && eE !== B.rq.ENDED && (0, r.jsxs)(r.Fragment, {
        ...
        children: eE === B.rq.PLAYING ? (0, r.jsx)(p.o1U, {
          className: z.playPausePopIcon
        }) : (0, r.jsx)(p.fpf, {
          className: z.playPausePopIcon
        })
      }, eE), ec && null != tn && (0, r.jsx)(s.animated.div, {
