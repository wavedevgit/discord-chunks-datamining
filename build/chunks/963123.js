...
function ee(e) {
  ...
  let {
    ...
    performanceClockStartTime: ed
  } = e, em = (0, C.aM)(), ep = (0, h._F)(), ef = (0, h.O5)(), ev = (0, x.km)(e => e.transcriptEnabled), eg = (0, x.km)(e => e.setTranscriptEnabled), eE = (0, x.km)(e => e.captionEnabled), eb = (0, x.km)(e => e.setCaptionEnabled), eO = (0, x.km)(e => e.fullScreenEnabled), eS = (0, x.km)(e => e.setFullScreenEnabled), {
    focused: eh,
    focusedChanged: eC
  } = (0, B.xU)(), {
    visible: ej,
    visibleChanged: ey,
    targetRef: e_
  } = (0, B.Yy)(), [ex, eN] = o.useState(!0 === ec ? M.rq.PLAYING : M.rq.PAUSED), [eD, eP] = o.useState(!1), eT = (0, _.il)(el), [eI, ew] = o.useState(eT.percentComplete), [eA, ek] = o.useState(!1), [eL, eR] = o.useState(!0), [eM, eV] = o.useState(!1), [eq, eB] = o.useState([]), [eF, eU] = o.useState(b.Z.getEffectiveConnectionSpeed()), [eZ, eY] = o.useState(0), [eQ, eW] = o.useState(0), [ez, eG] = o.useState(!1), [eH, eK] = o.useState(!1), eX = o.useRef(!0), e$ = o.useRef(null), eJ = o.useRef(null), e0 = (0, o.useRef)(-1), e1 = (0, x.km)(e => {
    var t;
    return null !== (t = e.videoProgress[el.id]) && void 0 !== t ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), e2 = (0, x.km)(e => e.setVideoProgress), e6 = (0, x.km)(e => e.muted), e4 = (0, x.km)(e => e.volume), e8 = (0, d.e7)([v.Z], () => v.Z.useReducedMotion), e7 = (0, o.useRef)(null), e9 = (0, o.useRef)(null), e3 = o.useRef(!0), e5 = (null === (t = el.userStatus) || void 0 === t ? void 0 : t.completedAt) != null, te = (0, x.km)(e => e.transcript), [tt, tn] = o.useState(null), [tr, to] = o.useState(!1), [ti, tl] = o.useState(!1), [ts, ta] = o.useState(null), tc = e5 ? null !== (E = null === (n = e7.current) || void 0 === n ? void 0 : n.duration) && void 0 !== E ? E : 0 : Math.max(e1.maxTimestampSec, eT.progressSeconds), tu = o.useMemo(() => (0, D.T)({
    quest: el,
  ...
  }(el), tp = e5 ? e1.timestampSec >= e1.duration ? 0 : e1.timestampSec : Math.max(e1.timestampSec, eT.progressSeconds), {
    videoAssetId: tf,
    videoAsset: tv,
    hlsRef: tg
  } = function(e, t, n, r) {
    ...
    return o.useEffect(() => {
      d === I.i.VIDEO_PLAYER_VIDEO_HLS && null != m && null != t.current && !l.current && (a.current = new s.ZP({
        maxBufferLength: 15,
        startPosition: r,
        startFragPrefetch: !0
  ...
  }(el, e7, eF, tp), tE = o.useCallback(e => {
    if (null != e7.current) {
      var t, n;
      ep({
        questId: el.id,
  ...
  }, [ep, el.id, tf, e5, es, tg]), tb = o.useCallback(() => {
    var e, t;
    ...
    if (tu.info("[QV] | updatePlayerState | playerState: ".concat(e)), eN(e), null != e7.current) switch (e) {
      case M.rq.PLAYING:
        e7.current.play(), ep({
          questId: el.id,
  ...
  }, [tt, el.id, ep, es, tg]), o.useEffect(() => {
    eC && null != e7.current && ep({
      questId: el.id,
  ...
  let th = o.useCallback(e => {
    var t;
    tu.info("[QV] | sendProgressUpdate: Checking conditions..."), e5 || (null === (t = el.userStatus) || void 0 === t ? void 0 : t.enrolledAt) == null || (tu.info("[QV] | sendProgressUpdate: quest enrolled and not completed, sending video progress: ".concat(e)), (0, _.FI)(el, e)), null != e7.current && ep({
      questId: el.id,
  ...
  let tC = () => {
    ...
    t_ = o.useCallback(() => {
      ...
      null == t || (0, S.rB)(t) || (t.removeEventListener(S.NO, t_), eS(!1), ep({
        questId: el.id,
    ...
    tx = () => {
      ...
      tu.info("[QV] | handleSeekBackIncrement | newTime: ".concat(e)), tD(e), ex === M.rq.ENDED && tS(M.rq.PAUSED), ef({
        questId: el.id,
    ...
    tN = () => {
      ...
      tu.info("[QV] | handleSeekForwardIncrement | newTime: ".concat(e)), tD(e), ex !== M.rq.ENDED && e >= e7.current.duration && tS(M.rq.ENDED), ef({
        questId: el.id,
        questContent: y.jn.VIDEO_MODAL,
  ...
  let tD = o.useCallback(e => {
    ...
    tP = () => {
      if (null != e7.current) switch (tu.info("[QV] | handlePlaybackBtnClick | playerState: ".concat(ex)), ex) {
        case M.rq.ENDED:
  ...
  o.useEffect(() => {
    ...
    let e = e9.current;
    return e.addEventListener("load", tw), () => {
  ...
  let tA = o.useCallback(e => {
      try {
        ...
        tu.info("[QV] | logVideoError: errorType: ".concat(e, ", videoProgress: ").concat(i, ", videoAssetId: ").concat(tf, ", connectionSpeed: ").concat(eF, ", error: ").concat(r, ", networkState: ").concat(o)), ep({
          questId: el.id,
  ...
  return (0, r.jsx)(p.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tB && ((0, P.e)({
        ...
        onLoadStart: () => {
          e$.current = Date.now(), tu.info("[QV] | handleLoadStart | loadingStartTime: ".concat(e$.current)), ep({
            questId: el.id,
        ...
        onPlaying: () => {
          ...
          tu.info("[QV] | ⏰ Video FCP: ".concat(e, "ms")), ep({
            questId: el.id,
        ...
        onWaiting: e => {
          eJ.current = Date.now(), tu.info("[QV] | handleWaitingForData: bufferingStartTime: ".concat(eJ.current)), e0.current += 1, ep({
            questId: el.id,
        ...
        children: [null != tZ && (0, r.jsx)("track", {
          ...
          srcLang: "en",
          default: !0
        }), null != tv && tf !== I.i.VIDEO_PLAYER_VIDEO_HLS && (0, r.jsx)("source", {
          onError: () => tA(M.CY.SOURCE_ERROR),
          src: tv.url,
          type: tv.mimetype
        })]
      }), (eL || eM) && ex === M.rq.PLAYING && (0, r.jsx)(p.$jN, {
        type: p.$jN.Type.WANDERING_CUBES,
        className: W.loadingSpinner
      }), ex === M.rq.PAUSED && tt === y.yE.LOST_FOCUS && (0, r.jsx)(K, {}), ev && ex !== M.rq.ENDED && (0, r.jsxs)(r.Fragment, {
      ...
      }, ex), eE && null != ts && (0, r.jsx)(a.animated.div, {
        className: W.captionContainer,
        ref: tM,
        style: {
          translateY: (0, a.to)([tL.to({
            range: [0, 1],
            output: [0, -50]
          })], e => "".concat(e, "px"))
        },
        ...
        style: {
          paddingLeft: (0, a.to)([tL.to({
            range: [0, 1],
            output: [0, 25]
          })], e => "".concat(e, "px")),
          paddingRight: (0, a.to)([tL.to({
            range: [0, 1],
            output: [0, 25]
          })], e => "".concat(e, "px")),
          height: (0, a.to)([tL.to({
        ...
        children: [(0, r.jsx)(L.Z, {
          ...
          style: {
            paddingTop: (0, a.to)([tL.to({
              range: [0, 1],
              output: [0, 1]
            })], e => "".concat(e * e * 12, "px")),
            paddingBottom: (0, a.to)([tL.to({
              range: [0, 1],
              output: [0, 1]
            })], e => "".concat(e * e * 12, "px")),
            pointerEvents: (0, a.to)([tL.to({
              range: [0, 1],
              output: [0, 1]
            })], e => e < .3 ? "none" : "auto")
          },
          children: (0, r.jsx)(A.Z, {
            ...
            handleTranscriptBtnClick: () => {
              ev || null != te && te.questId === el.id && te.fetchStatus !== x.iF.NONE && te.fetchStatus !== x.iF.FAILURE || (0, j.lL)(el), eg(!ev), ef({
                questId: el.id,
                questContent: y.jn.VIDEO_MODAL,
            ...
            handleFullScreenBtnClick: () => {
              ...
              t && null != n ? ((0, S.Dj)(n), n.addEventListener(S.NO, t_), ep({
                questId: el.id,
                event: Z.rMx.QUEST_VIDEO_FULLSCREEN_ENTERED,
                properties: {
                  video_session_id: es
                }
              })) : t || null == n || (n.removeEventListener(S.NO, t_), ep({
                questId: el.id,
                event: Z.rMx.QUEST_VIDEO_FULLSCREEN_EXITED,
                properties: {
                  video_session_id: es
