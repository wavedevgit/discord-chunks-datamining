...
function $(e) {
  let {
    quest: t,
    shouldShow: n
  } = e, o = l.useMemo(() => (0, I.z)(I.i.VIDEO_PLAYER_THUMBNAIL, t), [t]);
...
function ee(e) {
  ...
  let {
    ...
    visibleChanged: eg,
    targetRef: eE
  } = (0, U.Yy)(), [eb, eO] = l.useState(!0 === er ? B.rq.PLAYING : B.rq.PAUSED), [eh, eS] = l.useState(!1), eC = (0, y.il)(ee), [ej, e_] = l.useState(eC.percentComplete), [ey, ex] = l.useState(!1), [eD, eP] = l.useState(!0), [eT, eN] = l.useState(!1), [ek, eI] = l.useState([]), [eA, ew] = l.useState(O.Z.getEffectiveConnectionSpeed()), [eL, eR] = l.useState(0), [eM, eV] = l.useState(0), [eB, eF] = l.useState(!1), [eZ, eU] = l.useState(!1), eq = l.useRef(!0), eY = l.useRef(null), eQ = l.useRef(null), eG = (0, x.km)(e => {
    var t;
    return null != (t = e.videoProgress[ee.id]) ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), ez = (0, x.km)(e => e.setVideoProgress), eH = (0, x.km)(e => e.muted), eK = (0, x.km)(e => e.volume), eW = (0, m.e7)([g.Z], () => g.Z.useReducedMotion), eX = (0, l.useRef)(null), e$ = (0, l.useRef)(null), eJ = l.useRef(!0), e0 = (null == (t = ee.userStatus) ? void 0 : t.completedAt) != null, e1 = (0, x.km)(e => e.transcript), e2 = (0, D.Ec)(ee), e8 = (0, D.H)() && e2, [e6, e4] = l.useState(null), [e7, e3] = l.useState(!1), [e9, e5] = l.useState(!1), [te, tt] = l.useState(null), tn = e0 ? null != (b = null == (n = eX.current) ? void 0 : n.duration) ? b : 0 : Math.max(eG.maxTimestampSec, eC.progressSeconds), tr = l.useMemo(() => (0, T.T)({
    quest: ee,
  ...
  }(ee), ti = e0 ? eG.timestampSec >= eG.duration ? 0 : eG.timestampSec : Math.max(eG.timestampSec, eC.progressSeconds);
  (0, v.Ng)(() => {
  ...
  let {
    ...
    trackQuestVideoBufferingEnded: tb,
  ...
  } = (0, q.Z)(ee, eX, tc, et, ta), t_ = l.useCallback(() => {
    var e, t;
    ...
    if (tr.info("[QV] | updatePlayerState | playerState: ".concat(e)), eO(e), null != eX.current) switch (e) {
      case B.rq.PLAYING:
  ...
  let tw = l.useCallback(e => {
    ...
    tL = () => {
      if (null != eX.current) switch (tr.info("[QV] | handlePlaybackBtnClick | playerState: ".concat(eb)), eb) {
        case B.rq.ENDED:
  ...
  let tB = l.useCallback(e => {
      var t;
      tr.info("[QV] | logVideoError: errorType: ".concat(e, ", videoProgress: ").concat(null == (t = eX.current) ? void 0 : t.currentTime, ", videoAssetId: ").concat(ta, ", connectionSpeed: ").concat(eA)), tC(e, eA)
    }, [eA, tC, eX, ta, tr]),
    tF = e => {
  ...
  return (0, r.jsx)(f.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tG && (() => {
        ...
        onLoadedData: e => {
          tr.info("[QV] | handleLoadedData: loadingFirstChunk: ".concat(eD)), eD && (td(eA, null != eY.current ? Date.now() - eY.current : null), eP(!1), null != tc.current && (tc.current.config.minAutoBitrate = 8e5))
        },
        onLoadedMetadata: e => {
        ...
        children: [null != tK && (0, r.jsx)("track", {
          ref: e$,
          src: tK.url,
          label: "English",
          kind: "captions",
          srcLang: "en",
          default: !0
        }), null != ts && ta !== I.i.VIDEO_PLAYER_VIDEO_HLS && (0, r.jsx)("source", {
          onError: () => tB(B.CY.SOURCE_ERROR),
          src: ts.url,
          type: ts.mimetype
        })]
      }), (eD || eT) && eb === B.rq.PLAYING && (0, r.jsx)(f.$jN, {
        type: f.$jN.Type.WANDERING_CUBES,
        className: H.loadingSpinner
      }), eb === B.rq.PAUSED && e6 === _.yE.LOST_FOCUS && (0, r.jsx)(X, {}), ea && eb !== B.rq.ENDED && (0, r.jsxs)(r.Fragment, {
        ...
        children: eb === B.rq.PLAYING ? (0, r.jsx)(f.o1U, {
          className: H.playPausePopIcon
        }) : (0, r.jsx)(f.fpf, {
          className: H.playPausePopIcon
        })
      }, eb), ec && null != te && (0, r.jsx)(s.animated.div, {
