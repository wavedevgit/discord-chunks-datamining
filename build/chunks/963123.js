...
function ee(e) {
  ...
  let {
    ...
    visibleChanged: eg,
    targetRef: eb
  } = (0, q.Yy)(), [eE, eO] = l.useState(!0 === er ? B.rq.PLAYING : B.rq.PAUSED), [eh, eC] = l.useState(!1), [eS, ej] = l.useState(!1), ey = (0, _.il)(ee), [e_, ex] = l.useState(ey.percentComplete), [eD, eT] = l.useState(!1), [eP, eN] = l.useState(!0), [ek, eI] = l.useState(!1), [ew, eA] = l.useState([]), [eL, eR] = l.useState(O.Z.getEffectiveConnectionSpeed()), [eM, eV] = l.useState(0), [eB, eF] = l.useState(0), [eZ, eq] = l.useState(!1), [eU, eQ] = l.useState(!1), eG = l.useRef(!0), eH = l.useRef(null), eY = l.useRef(null), ez = (0, x.km)(e => {
    var t;
  ...
  return (0, r.jsx)(f.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tK && (() => {
        ...
        onLoadedData: e => {
          to.info("[QV] | handleLoadedData: loadingFirstChunk: ".concat(eP)), eP && (tf(eL, null != eH.current ? Date.now() - eH.current : null), eN(!1), null != td.current && (td.current.config.minAutoBitrate = 8e5))
        },
        onLoadedMetadata: e => {
      ...
      }), (eP || ek) && eE === B.rq.PLAYING && (0, r.jsx)(f.$jN, {
        ...
        children: eE === B.rq.PLAYING ? (0, r.jsx)(f.o1U, {
