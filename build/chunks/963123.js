...
function W(e) {
  let {
    quest: t,
    shouldShow: n
  } = e, o = l.useMemo(() => (0, N.z)(N.i.VIDEO_PLAYER_THUMBNAIL, t), [t]);
  return null == o ? null : (0, r.jsx)(I.A, {
    questOrQuests: t,
...
function $(e) {
  ...
  let {
    ...
    autoplay: ea,
    parentTransitionState: es,
    performanceClockStartTime: ec,
    onClose: eu
  } = e, ed = (0, _.km)(e => e.transcriptEnabled), em = (0, _.km)(e => e.setTranscriptEnabled), ep = (0, _.km)(e => e.captionEnabled), ef = (0, _.km)(e => e.setCaptionEnabled), ev = (0, _.km)(e => e.fullScreenEnabled), eg = (0, _.km)(e => e.setFullScreenEnabled), {
    focused: eb,
    focusedChanged: eE
  } = (0, F.xU)(), {
    visible: eO,
    visibleChanged: eh,
    targetRef: eS
  } = (0, F.Yy)(), [eC, ej] = l.useState(!0 === ea ? M.rq.PLAYING : M.rq.PAUSED), [ey, e_] = l.useState(!1), ex = (0, y.il)(el), [eD, eP] = l.useState(ex.percentComplete), [eT, eN] = l.useState(!1), [ek, eI] = l.useState(!0), [ew, eA] = l.useState(!1), [eL, eR] = l.useState([]), [eM, eV] = l.useState(E.Z.getEffectiveConnectionSpeed()), [eB, eF] = l.useState(0), [eZ, eU] = l.useState(0), [eq, eY] = l.useState(!1), [eQ, eG] = l.useState(!1), ez = l.useRef(!0), eH = l.useRef(null), eK = l.useRef(null), eW = (0, _.km)(e => {
    var t;
    return null != (t = e.videoProgress[el.id]) ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), eX = (0, _.km)(e => e.setVideoProgress), e$ = (0, _.km)(e => e.muted), eJ = (0, _.km)(e => e.volume), e0 = (0, d.e7)([v.Z], () => v.Z.useReducedMotion), e1 = (0, l.useRef)(null), e2 = (0, l.useRef)(null), e8 = l.useRef(!0), e6 = (null == (t = el.userStatus) ? void 0 : t.completedAt) != null, e4 = (0, _.km)(e => e.transcript), [e3, e7] = l.useState(null), [e9, e5] = l.useState(!1), [te, tt] = l.useState(!1), [tn, tr] = l.useState(null), tl = e6 ? null != (b = null == (n = e1.current) ? void 0 : n.duration) ? b : 0 : Math.max(eW.maxTimestampSec, ex.progressSeconds), to = l.useMemo(() => (0, D.T)({
    quest: el,
  ...
  let {
  ...
  } = (0, Z.Z)(el, e1, td, eo, tc), tx = l.useCallback(() => {
    var e, t;
    ...
    if (to.info("[QV] | updatePlayerState | playerState: ".concat(e)), ej(e), null != e1.current) switch (e) {
      case M.rq.PLAYING:
  ...
  let tZ = l.useCallback(e => {
      var t;
      to.info("[QV] | logVideoError: errorType: ".concat(e, ", videoProgress: ").concat(null == (t = e1.current) ? void 0 : t.currentTime, ", videoAssetId: ").concat(tc, ", connectionSpeed: ").concat(eM)), ty(e, eM)
    }, [eM, ty, e1, tc, to]),
    tU = e => {
  ...
  return (0, r.jsx)(p.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tH && ((0, P.e)({
        ...
        onLoadedData: e => {
          to.info("[QV] | handleLoadedData: loadingFirstChunk: ".concat(ek)), ek && (tp(eM, null != eH.current ? Date.now() - eH.current : null), eI(!1), null != td.current && (td.current.config.minAutoBitrate = 8e5))
        },
        onLoadedMetadata: e => {
        ...
        children: [null != tX && (0, r.jsx)("track", {
          ref: e2,
          src: tX.url,
          label: "English",
          kind: "captions",
          srcLang: "en",
          default: !0
        }), null != tu && tc !== N.i.VIDEO_PLAYER_VIDEO_HLS && (0, r.jsx)("source", {
          onError: () => tZ(M.CY.SOURCE_ERROR),
          src: tu.url,
          type: tu.mimetype
        })]
      }), (ek || ew) && eC === M.rq.PLAYING && (0, r.jsx)(p.$jN, {
        type: p.$jN.Type.WANDERING_CUBES,
        className: G.loadingSpinner
      }), eC === M.rq.PAUSED && e3 === j.yE.LOST_FOCUS && (0, r.jsx)(K, {}), ed && eC !== M.rq.ENDED && (0, r.jsxs)(r.Fragment, {
        ...
        children: eC === M.rq.PLAYING ? (0, r.jsx)(p.o1U, {
          className: G.playPausePopIcon
        }) : (0, r.jsx)(p.fpf, {
          className: G.playPausePopIcon
        })
      }, eC), ep && null != tn && (0, r.jsx)(s.animated.div, {
