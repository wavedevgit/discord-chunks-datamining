...
function ee(e) {
  ...
  }, c.X), eY = (0, x.km)(e => e.setVideoProgress), ez = (0, x.km)(e => e.muted), eK = (0, x.km)(e => e.volume), eW = (0, m.e7)([g.Z], () => g.Z.useReducedMotion), eX = (0, l.useRef)(null), e$ = (0, l.useRef)(null), eJ = l.useRef(!0), e0 = (null == (t = ee.userStatus) ? void 0 : t.completedAt) != null, e1 = (0, x.km)(e => e.transcript), e2 = (0, D.Ec)(ee), e8 = (0, D.H)() && e2, [e6, e7] = l.useState(null), [e3, e4] = l.useState(!1), [e9, e5] = l.useState(!1), [te, tt] = l.useState(null), tn = e0 ? null != (E = null == (n = eX.current) ? void 0 : n.duration) ? E : 0 : Math.max(eH.maxTimestampSec, eS.progressSeconds), tr = l.useMemo(() => (0, P.T)({
    quest: ee,
  ...
  }(ee), ti = e0 ? eH.timestampSec >= eH.duration ? 0 : eH.timestampSec : Math.max(eH.timestampSec, eS.progressSeconds);
  (0, v.Ng)(() => {
  ...
  let {
    ...
    let s = l.useRef(!1),
      ...
      v = () => {
        null != c.current && 8e5 !== c.current.config.minAutoBitrate && (c.current.config.minAutoBitrate = 8e5)
      };
    return l.useEffect(() => {
      ...
      c.current = new a.ZP({
        ...
        startFragPrefetch: !0,
        startLevel: -1
      }), c.current.on(a.ZP.Events.FRAG_LOADING, v), c.current.loadSource(f.url), c.current.attachMedia(t.current), s.current = !0;
      let e = c.current;
      return () => {
  ...
  let tL = l.useCallback(e => {
    ...
    tR = () => {
      if (null != eX.current) switch (tr.info("[QV] | handlePlaybackBtnClick | playerState: ".concat(eE)), eE) {
        case B.rq.ENDED:
  ...
  let tF = l.useCallback(e => {
      var t;
      tr.info("[QV] | logVideoError: errorType: ".concat(e, ", videoProgress: ").concat(null == (t = eX.current) ? void 0 : t.currentTime, ", videoAssetId: ").concat(tu, ", connectionSpeed: ").concat(ew)), tj(e, ew)
    }, [ew, tj, eX, tu, tr]),
    tZ = e => {
  ...
  return (0, r.jsx)(f.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tY && (() => {
        ...
        onLoadedData: e => {
          tr.info("[QV] | handleLoadedData: loadingFirstChunk: ".concat(eD)), eD && (tm(ew, null != eQ.current ? Date.now() - eQ.current : null), eT(!1), null != tc.current && (tc.current.config.minAutoBitrate = 8e5))
        },
        onLoadedMetadata: e => {
        ...
        children: [null != tW && (0, r.jsx)("track", {
          ...
          srcLang: "en",
          default: !0
        }), null != ts && ta !== I.n1.VIDEO_HLS && (0, r.jsx)("source", {
          onError: () => tF(B.CY.SOURCE_ERROR),
          src: ts.url,
          type: ts.mimetype
        })]
      }), (eD || eP) && eE === B.rq.PLAYING && (0, r.jsx)(f.$jN, {
        type: f.$jN.Type.WANDERING_CUBES,
        className: z.loadingSpinner
      }), eE === B.rq.PAUSED && e6 === y.yE.LOST_FOCUS && (0, r.jsx)(X, {}), ea && eE !== B.rq.ENDED && (0, r.jsxs)(r.Fragment, {
