...
function $(e) {
  ...
  let {
    ...
    visibleChanged: eh,
    targetRef: eS
  } = (0, F.Yy)(), [eC, ej] = l.useState(!0 === ea ? M.rq.PLAYING : M.rq.PAUSED), [ey, e_] = l.useState(!1), ex = (0, y.il)(el), [eD, eP] = l.useState(ex.percentComplete), [eT, eN] = l.useState(!1), [ek, ew] = l.useState(!0), [eI, eA] = l.useState(!1), [eL, eR] = l.useState([]), [eM, eV] = l.useState(E.Z.getEffectiveConnectionSpeed()), [eB, eF] = l.useState(0), [eZ, eU] = l.useState(0), [eq, eY] = l.useState(!1), [eQ, eG] = l.useState(!1), ez = l.useRef(!0), eH = l.useRef(null), eK = l.useRef(null), eW = (0, _.km)(e => {
    var t;
  ...
  return (0, r.jsx)(p.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tH && ((0, P.e)({
        ...
        onLoadedData: e => {
          to.info("[QV] | handleLoadedData: loadingFirstChunk: ".concat(ek)), ek && (tp(eM, null != eH.current ? Date.now() - eH.current : null), ew(!1), null != td.current && (td.current.config.minAutoBitrate = 8e5))
        },
        onLoadedMetadata: e => {
      ...
      }), (ek || eI) && eC === M.rq.PLAYING && (0, r.jsx)(p.$jN, {
