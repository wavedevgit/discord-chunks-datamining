...
function J(e) {
  ...
  let {
    ...
    visibleChanged: eg,
    targetRef: eb
  } = (0, Z.Yy)(), [eE, eO] = l.useState(!0 === en ? V.rq.PLAYING : V.rq.PAUSED), [eC, eh] = l.useState(!1), [eS, ej] = l.useState(!1), ey = (0, _.il)(J), [e_, ex] = l.useState(ey.percentComplete), [eD, eT] = l.useState(!1), [eP, eN] = l.useState(!0), [ek, eI] = l.useState(!1), [ew, eA] = l.useState([]), [eL, eR] = l.useState(O.Z.getEffectiveConnectionSpeed()), [eM, eV] = l.useState(0), [eB, eF] = l.useState(0), [eZ, eq] = l.useState(!1), [eU, eQ] = l.useState(!1), eG = l.useRef(!0), eY = l.useRef(null), ez = l.useRef(null), eH = (0, x.km)(e => {
    var t;
    return null != (t = e.videoProgress[J.id]) ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), eK = (0, x.km)(e => e.setVideoProgress), eX = (0, x.km)(e => e.muted), eW = (0, x.km)(e => e.volume), e$ = (0, m.e7)([g.Z], () => g.Z.useReducedMotion), eJ = (0, l.useRef)(null), e0 = (0, l.useRef)(null), e1 = l.useRef(!0), e2 = (null == (t = J.userStatus) ? void 0 : t.completedAt) != null, e8 = (0, x.km)(e => e.transcript), [e6, e4] = l.useState(null), [e7, e3] = l.useState(!1), [e9, e5] = l.useState(!1), [te, tt] = l.useState(null), tn = e2 ? null != (E = null == (n = eJ.current) ? void 0 : n.duration) ? E : 0 : Math.max(eH.maxTimestampSec, ey.progressSeconds), tr = l.useMemo(() => (0, T.T)({
    quest: J,
  ...
  }(J), ti = e2 ? eH.timestampSec >= eH.duration ? 0 : eH.timestampSec : Math.max(eH.timestampSec, ey.progressSeconds);
  (0, v.Ng)(() => {
  ...
  let {
    ...
    if (tr.info("[QV] | updatePlayerState | playerState: ".concat(e)), eO(e), null != eJ.current) switch (e) {
      case V.rq.PLAYING:
  ...
  let [tP, tN] = l.useState(!1), tk = l.useRef(null), tI = l.useRef(performance.now()), tw = l.useCallback(() => {
    null != tk.current && clearTimeout(tk.current), eE === V.rq.PLAYING && (tk.current = setTimeout(() => {
      eE === V.rq.PLAYING && tN(!0)
    }, Math.max(0, 3e3 - (performance.now() - tI.current))))
  }, [eE]), tA = () => {
  ...
  let tB = l.useCallback(e => {
    ...
    tF = () => {
      if (null != eJ.current) switch (tr.info("[QV] | handlePlaybackBtnClick | playerState: ".concat(eE)), eE) {
        case V.rq.ENDED:
  ...
  let tQ = l.useCallback(e => {
      var t;
      tr.info("[QV] | logVideoError: errorType: ".concat(e, ", videoProgress: ").concat(null == (t = eJ.current) ? void 0 : t.currentTime, ", videoAssetId: ").concat(tu, ", connectionSpeed: ").concat(eL)), tj(e, eL)
    }, [eL, tj, eJ, tu, tr]),
    tG = e => {
  ...
  return (0, r.jsx)(p.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tW && (() => {
        ...
        onLoadedData: e => {
          tr.info("[QV] | handleLoadedData: loadingFirstChunk: ".concat(eP)), eP && (tm(eL, null != eY.current ? performance.now() - eY.current : null), eN(!1), null != tc.current && (tc.current.config.minAutoBitrate = 8e5))
        },
        onLoadedMetadata: e => {
        ...
        children: [null != t0 && (0, r.jsx)("track", {
          ...
          srcLang: "en",
          default: !0
        }), null != ts && ta !== k.n1.VIDEO_HLS && (0, r.jsx)("source", {
          onError: () => tQ(V.CY.SOURCE_ERROR),
          src: ts.url,
          type: ts.mimetype
        })]
      }), (eP || ek) && eE === V.rq.PLAYING && (0, r.jsx)(p.$jN, {
        type: p.$jN.Type.WANDERING_CUBES,
        className: z.loadingSpinner
      }), eE === V.rq.PAUSED && e6 === y.yE.LOST_FOCUS && (0, r.jsx)(X, {}), ea && eE !== V.rq.ENDED && (0, r.jsxs)(r.Fragment, {
        ...
        children: eE === V.rq.PLAYING ? (0, r.jsx)(p.o1U, {
          className: z.playPausePopIcon
        }) : (0, r.jsx)(p.fpf, {
          className: z.playPausePopIcon
        })
      }, eE), ec && null != te && (0, r.jsx)(s.animated.div, {
