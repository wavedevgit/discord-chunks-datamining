...
function X(e) {
  let {
    quest: t,
    shouldShow: n
  } = e, i = o.useMemo(() => (0, P.z)(P.i.VIDEO_PLAYER_THUMBNAIL, t), [t]);
  return null == i ? null : (0, r.jsx)(T.A, {
    questOrQuests: t,
...
function ee(e) {
  ...
  let {
    quest: em,
    videoSessionId: ep,
    onOptimisticProgressUpdate: ef,
    autoplay: ev,
    parentTransitionState: eg,
    performanceClockStartTime: eE
  } = e, eb = (0, h.aM)(), eO = (0, S._F)(), eS = (0, S.O5)(), eh = (0, _.km)(e => e.transcriptEnabled), eC = (0, _.km)(e => e.setTranscriptEnabled), ej = (0, _.km)(e => e.captionEnabled), ey = (0, _.km)(e => e.setCaptionEnabled), e_ = (0, _.km)(e => e.fullScreenEnabled), ex = (0, _.km)(e => e.setFullScreenEnabled), {
    focused: eD,
    focusedChanged: eN
  } = (0, q.xU)(), {
    visible: eP,
    visibleChanged: eT,
    targetRef: eI
  } = (0, q.Yy)(), [ew, ek] = o.useState(!0 === ev ? R.rq.PLAYING : R.rq.PAUSED), [eA, eL] = o.useState(!1), eR = (0, y.il)(em), [eM, eV] = o.useState(eR.percentComplete), [eq, eB] = o.useState(!1), [eF, eU] = o.useState(!0), [eZ, eY] = o.useState(!1), [eQ, eW] = o.useState([]), [ez, eG] = o.useState(E.Z.getEffectiveConnectionSpeed()), [eH, eK] = o.useState(0), [eX, e$] = o.useState(0), [eJ, e0] = o.useState(!1), [e1, e2] = o.useState(!1), e6 = o.useRef(!0), e4 = o.useRef(null), e8 = o.useRef(null), e9 = (0, o.useRef)(-1), e7 = (0, _.km)(e => {
    var t;
    return null !== (t = e.videoProgress[em.id]) && void 0 !== t ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), e3 = (0, _.km)(e => e.setVideoProgress), e5 = (0, _.km)(e => e.muted), te = (0, _.km)(e => e.volume), tt = (0, u.e7)([f.Z], () => f.Z.useReducedMotion), tn = (0, o.useRef)(null), tr = (0, o.useRef)(null), to = o.useRef(!0), ti = (null === (t = em.userStatus) || void 0 === t ? void 0 : t.completedAt) != null, tl = (0, _.km)(e => e.transcript), [ts, ta] = o.useState(null), [tc, tu] = o.useState(!1), [td, tm] = o.useState(!1), [tp, tf] = o.useState(null), tv = ti ? null !== (g = null === (n = tn.current) || void 0 === n ? void 0 : n.duration) && void 0 !== g ? g : 0 : Math.max(e7.maxTimestampSec, eR.progressSeconds), tg = ti ? e7.timestampSec >= e7.duration ? 0 : e7.timestampSec : Math.max(e7.timestampSec, eR.progressSeconds), tE = o.useMemo(() => (0, D.T)({
    quest: em,
    ...
    return o.useEffect(() => {
      d === P.i.VIDEO_PLAYER_VIDEO_HLS && null != m && null != t.current && !l.current && (a.current = new s.ZP({
        maxBufferLength: 15,
        startPosition: r,
        startFragPrefetch: !0
      }), a.current.loadSource(m.url), a.current.attachMedia(t.current), l.current = !0)
    }, [m, d, t, r]), {
      videoAssetId: d,
      videoAsset: m,
      hlsRef: a
    }
  }(em, tn, ez, tg), th = o.useCallback(e => {
    if (null != tn.current) {
      var t, n;
      eO({
        questId: em.id,
        event: Z.rMx.QUEST_VIDEO_SEGMENT_WATCHED,
        properties: z((t = z({}, e), n = n = {
          video_asset_id: tb,
          quest_completed: ti,
    ...
    if (tE.info("[QV] | updatePlayerState | playerState: ".concat(e)), ek(e), null != tn.current) switch (e) {
      case R.rq.PLAYING:
        tn.current.play(), eO({
          questId: em.id,
  ...
  }, [ts, em.id, eO, ep, tS]), o.useEffect(() => {
    eN && null != tn.current && eO({
      questId: em.id,
  ...
  let ty = o.useCallback(e => {
    var t;
    tE.info("[QV] | sendProgressUpdate: Checking conditions..."), ti || (null === (t = em.userStatus) || void 0 === t ? void 0 : t.enrolledAt) == null || (tE.info("[QV] | sendProgressUpdate: quest enrolled and not completed, sending video progress: ".concat(e)), (0, y.FI)(em, e)), null != tn.current && eO({
      questId: em.id,
  ...
  let t_ = () => {
    ...
    tN = o.useCallback(() => {
      ...
      null == t || (0, O.rB)(t) || (t.removeEventListener(O.NO, tN), ex(!1), eO({
        questId: em.id,
    ...
    tP = () => {
      ...
      tE.info("[QV] | handleSeekBackIncrement | newTime: ".concat(e)), tI(e), ew === R.rq.ENDED && tj(R.rq.PAUSED), eS({
        questId: em.id,
    ...
    tT = () => {
      ...
      tE.info("[QV] | handleSeekForwardIncrement | newTime: ".concat(e)), tI(e), ew !== R.rq.ENDED && e >= tn.current.duration && tj(R.rq.ENDED), eS({
        questId: em.id,
        questContent: j.jn.VIDEO_MODAL,
  ...
  let tI = o.useCallback(e => {
    ...
    tw = () => {
      if (null != tn.current) switch (tE.info("[QV] | handlePlaybackBtnClick | playerState: ".concat(ew)), ew) {
        case R.rq.ENDED:
  ...
  o.useEffect(() => {
    ...
    let e = tr.current;
    return e.addEventListener("load", tL), () => {
  ...
  let tR = o.useCallback(e => {
      try {
        ...
        tE.info("[QV] | logVideoError: errorType: ".concat(e, ", videoProgress: ").concat(i, ", videoAssetId: ").concat(tb, ", connectionSpeed: ").concat(ez, ", error: ").concat(r, ", networkState: ").concat(o)), eO({
          questId: em.id,
  ...
  return (0, r.jsx)(m.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tZ && ((0, N.e)({
        ...
        onLoadStart: () => {
          e4.current = Date.now(), tE.info("[QV] | handleLoadStart | loadingStartTime: ".concat(e4.current)), eO({
            questId: em.id,
        ...
        onPlaying: () => {
          ...
          tE.info("[QV] | ⏰ Video FCP: ".concat(e, "ms")), eO({
            questId: em.id,
        ...
        onWaiting: e => {
          e8.current = Date.now(), tE.info("[QV] | handleWaitingForData: bufferingStartTime: ".concat(e8.current)), e9.current += 1, eO({
            questId: em.id,
        ...
        children: [null != tW && (0, r.jsx)("track", {
          ref: tr,
          src: tW.url,
          label: "English",
          kind: "captions",
          srcLang: "en",
          default: !0
        }), null != tO && tb !== P.i.VIDEO_PLAYER_VIDEO_HLS && (0, r.jsx)("source", {
          onError: () => tR(R.CY.SOURCE_ERROR),
          src: tO.url,
          type: tO.mimetype
        })]
      }), (eF || eZ) && ew === R.rq.PLAYING && (0, r.jsx)(m.$jN, {
        type: m.$jN.Type.WANDERING_CUBES,
        className: W.loadingSpinner
      }), ew === R.rq.PAUSED && ts === R.yE.LOST_FOCUS && (0, r.jsx)(K, {}), eh && ew !== R.rq.ENDED && (0, r.jsxs)(r.Fragment, {
        ...
        children: ew === R.rq.PLAYING ? (0, r.jsx)(m.o1U, {
          className: W.playPausePopIcon
        }) : (0, r.jsx)(m.fpf, {
          className: W.playPausePopIcon
        })
      }, ew), ej && null != tp && (0, r.jsx)(a.animated.div, {
        className: W.captionContainer,
        ref: tB,
        style: {
          translateY: (0, a.to)([tV.to({
            range: [0, 1],
            output: [0, -50]
          })], e => "".concat(e, "px"))
        },
        ...
        style: {
          paddingLeft: (0, a.to)([tV.to({
            range: [0, 1],
            output: [0, 25]
          })], e => "".concat(e, "px")),
          paddingRight: (0, a.to)([tV.to({
            range: [0, 1],
            output: [0, 25]
          })], e => "".concat(e, "px")),
          height: (0, a.to)([tV.to({
        ...
        children: [(0, r.jsx)(A.Z, {
          ...
          style: {
            paddingTop: (0, a.to)([tV.to({
              range: [0, 1],
              output: [0, 1]
            })], e => "".concat(e * e * 12, "px")),
            paddingBottom: (0, a.to)([tV.to({
              range: [0, 1],
              output: [0, 1]
            })], e => "".concat(e * e * 12, "px")),
            pointerEvents: (0, a.to)([tV.to({
              range: [0, 1],
              output: [0, 1]
            })], e => e < .3 ? "none" : "auto")
          },
          children: (0, r.jsx)(w.Z, {
            ...
            handleTranscriptBtnClick: () => {
              eh || null != tl && tl.questId === em.id && tl.fetchStatus !== _.iF.NONE && tl.fetchStatus !== _.iF.FAILURE || (0, C.lL)(em), eC(!eh), eS({
                questId: em.id,
                questContent: j.jn.VIDEO_MODAL,
            ...
            handleFullScreenBtnClick: () => {
              ...
              t && null != n ? ((0, O.Dj)(n), n.addEventListener(O.NO, tN), eO({
                questId: em.id,
                event: Z.rMx.QUEST_VIDEO_FULLSCREEN_ENTERED,
                properties: {
                  video_session_id: ep
                }
              })) : t || null == n || (n.removeEventListener(O.NO, tN), eO({
                questId: em.id,
                event: Z.rMx.QUEST_VIDEO_FULLSCREEN_EXITED,
                properties: {
                  video_session_id: ep
