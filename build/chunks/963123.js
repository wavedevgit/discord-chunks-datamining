...
function J(e) {
  ...
  let {
    ...
    autoplay: ev,
    parentTransitionState: ef,
    performanceClockStartTime: eE
  } = e, eg = (0, C.aM)(), eb = (0, S._F)(), eO = (0, S.O5)(), eS = (0, x.km)(e => e.transcriptEnabled), eC = (0, x.km)(e => e.setTranscriptEnabled), eh = (0, x.km)(e => e.captionEnabled), ej = (0, x.km)(e => e.setCaptionEnabled), ey = (0, x.km)(e => e.fullScreenEnabled), ex = (0, x.km)(e => e.setFullScreenEnabled), {
    focused: e_,
    focusedChanged: eD
  } = (0, B.xU)(), {
    visible: eN,
    visibleChanged: eP,
    targetRef: eT
  } = (0, B.Yy)(), [eI, ew] = o.useState(!0 === ev ? R.rq.PLAYING : R.rq.PAUSED), [eA, eL] = o.useState(!1), ek = (0, y.il)(ed), [eR, eM] = o.useState(ek.percentComplete), [eq, eB] = o.useState(!1), [eU, eF] = o.useState(!0), [eV, eZ] = o.useState(!1), [eY, eW] = o.useState([]), [ez, eG] = o.useState(g.Z.getEffectiveConnectionSpeed()), [eH, eK] = o.useState(0), [eQ, eX] = o.useState(0), [e$, eJ] = o.useState(!1), [e0, e1] = o.useState(!1), e2 = o.useRef(!0), e6 = o.useRef(null), e4 = o.useRef(null), e8 = (0, o.useRef)(-1), e9 = (0, x.km)(e => {
    var t;
    return null !== (t = e.videoProgress[ed.id]) && void 0 !== t ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), e7 = (0, x.km)(e => e.setVideoProgress), e3 = (0, x.km)(e => e.muted), e5 = (0, x.km)(e => e.volume), te = (0, u.e7)([v.Z], () => v.Z.useReducedMotion), tt = (0, o.useRef)(null), tn = (0, o.useRef)(null), tr = o.useRef(!0), to = (null === (t = ed.userStatus) || void 0 === t ? void 0 : t.completedAt) != null, tl = (0, x.km)(e => e.transcript), [ti, ts] = o.useState(null), [ta, tc] = o.useState(!1), [tu, td] = o.useState(!1), [tm, tp] = o.useState(null), tv = to ? null !== (E = null === (n = tt.current) || void 0 === n ? void 0 : n.duration) && void 0 !== E ? E : 0 : Math.max(e9.maxTimestampSec, ek.progressSeconds), {
    hlsAnalytics: tf,
    handleHlsSegmentUpdate: tE
  } = function() {
    let [e, t] = o.useState({
      levelIndex: -100,
      resWidth: -100,
  ...
  }(ed, tt, ez, tE, tg), tS = o.useCallback(e => {
    if (null != tt.current) {
      var t, n;
      eb({
        questId: ed.id,
    ...
    if (ew(e), null != tt.current) switch (e) {
      case R.rq.PLAYING:
        tt.current.play(), eb({
          questId: ed.id,
  ...
  }, [ti, ed.id, eb, em, tf]), o.useEffect(() => {
    eD && null != tt.current && eb({
      questId: ed.id,
  ...
  let tj = o.useCallback(e => {
    var t;
    to || (null === (t = ed.userStatus) || void 0 === t ? void 0 : t.enrolledAt) == null || (0, y.FI)(ed, e), null != tt.current && eb({
      questId: ed.id,
  ...
  let ty = () => {
    ...
    tN = () => {
      null != tt.current && (tT(Math.max(tt.current.currentTime - 10, 0)), eI === R.rq.ENDED && th(R.rq.PAUSED), eO({
        questId: ed.id,
    ...
    tP = () => {
      ...
      tT(e), eI !== R.rq.ENDED && e >= tt.current.duration && th(R.rq.ENDED), eO({
        questId: ed.id,
        questContent: j.jn.VIDEO_MODAL,
  ...
  return (0, r.jsx)(m.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tV && ((0, N.e)({
        ...
        onWaiting: e => {
          e4.current = Date.now(), e8.current += 1, eb({
            questId: ed.id,
      ...
      }), (eU || eV) && eI === R.rq.PLAYING && (0, r.jsx)(m.$jN, {
        type: m.$jN.Type.WANDERING_CUBES,
        className: z.loadingSpinner
      }), eI === R.rq.PAUSED && ti === R.yE.LOST_FOCUS && (0, r.jsx)(Q, {}), eS && eI !== R.rq.ENDED && (0, r.jsxs)(r.Fragment, {
      ...
      }, eI), eh && null != tm && (0, r.jsx)(a.animated.div, {
        ...
        children: [(0, r.jsx)(L.Z, {
          ...
          children: (0, r.jsx)(w.Z, {
            ...
            handleTranscriptBtnClick: () => {
              eS || null != tl && tl.questId === ed.id && tl.fetchStatus !== x.iF.NONE && tl.fetchStatus !== x.iF.FAILURE || (0, h.lL)(ed), eC(!eS), eO({
                questId: ed.id,
                questContent: j.jn.VIDEO_MODAL,
