...
function X(e) {
  let {
    quest: t,
    shouldShow: n
  } = e, o = l.useMemo(() => (0, k.z0)(t, u.X.WATCH_VIDEO, k.n1.VIDEO, k.O.THUMBNAIL), [t]);
...
function J(e) {
  ...
  let {
    ...
    visibleChanged: ev,
    targetRef: eg
  } = (0, Z.Yy)(), [eb, eE] = l.useState(!0 === en ? V.rq.PLAYING : V.rq.PAUSED), [eO, eh] = l.useState(!1), [eC, eS] = l.useState(!1), ej = (0, _.il)(J), [ey, e_] = l.useState(ej.percentComplete), [ex, eD] = l.useState(!1), [eT, eP] = l.useState(!0), [eN, ek] = l.useState(!1), [eI, ew] = l.useState([]), [eA, eL] = l.useState(O.Z.getEffectiveConnectionSpeed()), [eR, eM] = l.useState(0), [eV, eB] = l.useState(0), [eF, eZ] = l.useState(!1), [eq, eU] = l.useState(!1), eQ = l.useRef(!0), eG = l.useRef(null), eY = l.useRef(null), ez = (0, x.km)(e => {
    var t;
    return null != (t = e.videoProgress[J.id]) ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), eH = (0, x.km)(e => e.setVideoProgress), eW = (0, x.km)(e => e.muted), eK = (0, x.km)(e => e.volume), eX = (0, m.e7)([g.Z], () => g.Z.useReducedMotion), e$ = (0, l.useRef)(null), eJ = (0, l.useRef)(null), e0 = l.useRef(!0), e1 = (null == (t = J.userStatus) ? void 0 : t.completedAt) != null, e2 = (0, x.km)(e => e.transcript), [e8, e6] = l.useState(null), [e4, e7] = l.useState(!1), [e3, e9] = l.useState(!1), [e5, te] = l.useState(null), tt = e1 ? null != (E = null == (n = e$.current) ? void 0 : n.duration) ? E : 0 : Math.max(ez.maxTimestampSec, ej.progressSeconds), tn = l.useMemo(() => (0, T.T)({
    quest: J,
  ...
  }(J), to = e1 ? ez.timestampSec >= ez.duration ? 0 : ez.timestampSec : Math.max(ez.timestampSec, ej.progressSeconds);
  (0, v.Ng)(() => {
  ...
  let {
  ...
  } = (0, q.Z)(J, e$, ts, ee, tc), ty = l.useCallback(() => {
    var e, t;
    ...
    if (tn.info("[QV] | updatePlayerState | playerState: ".concat(e)), eE(e), null != e$.current) switch (e) {
      case V.rq.PLAYING:
  ...
  let [tT, tP] = l.useState(!1), tN = l.useRef(null), tk = l.useRef(performance.now()), tI = l.useCallback(() => {
    null != tN.current && clearTimeout(tN.current), eb === V.rq.PLAYING && (tN.current = setTimeout(() => {
  ...
  let tV = l.useCallback(e => {
    ...
    tB = () => {
      if (null != e$.current) switch (tn.info("[QV] | handlePlaybackBtnClick | playerState: ".concat(eb)), eb) {
        case V.rq.ENDED:
  ...
  let tU = l.useCallback(e => {
      var t;
      tn.info("[QV] | logVideoError: errorType: ".concat(e, ", videoProgress: ").concat(null == (t = e$.current) ? void 0 : t.currentTime, ", videoAssetId: ").concat(tc, ", connectionSpeed: ").concat(eA)), tS(e, eA)
    }, [eA, tS, e$, tc, tn]),
    tQ = e => {
  ...
  return (0, r.jsx)(f.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tK && (() => {
        ...
        onLoadedData: e => {
          tn.info("[QV] | handleLoadedData: loadingFirstChunk: ".concat(eT)), eT && (td(eA, null != eG.current ? performance.now() - eG.current : null), eP(!1), null != ts.current && (ts.current.config.minAutoBitrate = 8e5))
        },
        onLoadedMetadata: e => {
        ...
        children: [null != tJ && (0, r.jsx)("track", {
          ...
          srcLang: "en",
          default: !0
        }), null != ta && ti !== k.n1.VIDEO_HLS && (0, r.jsx)("source", {
          onError: () => tU(V.CY.SOURCE_ERROR),
          src: ta.url,
          type: ta.mimetype
        })]
      }), (eT || eN) && eb === V.rq.PLAYING && (0, r.jsx)(f.$jN, {
        type: f.$jN.Type.WANDERING_CUBES,
        className: z.loadingSpinner
      }), eb === V.rq.PAUSED && e8 === y.yE.LOST_FOCUS && (0, r.jsx)(K, {}), ei && eb !== V.rq.ENDED && (0, r.jsxs)(r.Fragment, {
      ...
      }, eb), es && null != e5 && (0, r.jsx)(s.animated.div, {
