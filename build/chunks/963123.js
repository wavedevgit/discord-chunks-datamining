...
function ee(e) {
  ...
  let {
    ...
    visibleChanged: eb,
    targetRef: eC
  } = (0, U.Yy)(), [eS, eh] = l.useState(!0 === el ? B.rq.PLAYING : B.rq.PAUSED), [e_, ej] = l.useState(!1), [ey, ex] = l.useState(!1), eT = (0, _.il)(ee), [eD, eP] = l.useState(eT.percentComplete), [eR, eN] = l.useState(!1), [eI, ek] = l.useState(!0), [eA, ew] = l.useState(!1), [eL, eM] = l.useState([]), [eV, eB] = l.useState(b.Z.getEffectiveConnectionSpeed()), [eF, eZ] = l.useState(0), [eU, eq] = l.useState(0), [eY, eH] = l.useState(!1), [eQ, ez] = l.useState(!1), eG = l.useRef(!0), eK = l.useRef(null), eX = l.useRef(null), eW = (0, x.km)(e => {
    var t;
    return null != (t = e.videoProgress[ee.id]) ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), e$ = (0, x.km)(e => e.setVideoProgress), eJ = (0, x.km)(e => e.muted), e0 = (0, x.km)(e => e.volume), e1 = (0, m.e7)([E.Z], () => E.Z.useReducedMotion), e2 = (0, l.useRef)(null), e8 = (0, l.useRef)(null), e6 = l.useRef(!0), e4 = (null == (t = ee.userStatus) ? void 0 : t.completedAt) != null, e7 = (0, x.km)(e => e.transcript), [e3, e9] = l.useState(null), e5 = (0, P._)({
    location: Y.dr.VIDEO_MODAL
  }), [te, tt] = l.useState(!1), [tn, tr] = l.useState(!1), [tl, to] = l.useState(null), ti = e4 ? null != (O = null == (n = e2.current) ? void 0 : n.duration) ? O : 0 : Math.max(eW.maxTimestampSec, eT.progressSeconds), ta = l.useMemo(() => (0, D.T)({
    quest: ee,
    location: Y.dr.VIDEO_MODAL
  }), [ee]), {
    title: ts,
  ...
  }(ee), tu = e4 ? eW.timestampSec >= eW.duration ? 0 : eW.timestampSec : Math.max(eW.timestampSec, eT.progressSeconds);
  (0, v.Ng)(() => {
  ...
  let {
    ...
    if (ta.info("[QV] | updatePlayerState | playerState: ".concat(e)), eh(e), null != e2.current) switch (e) {
      case B.rq.PLAYING:
  ...
  let [tk, tA] = l.useState(!1), tw = l.useRef(null), tL = l.useRef(performance.now()), tM = l.useCallback(() => {
    null != tw.current && clearTimeout(tw.current), eS === B.rq.PLAYING && (tw.current = setTimeout(() => {
  ...
  let tq = l.useCallback(e => {
    ...
    tY = () => {
      if (null != e2.current) switch (ta.info("[QV] | handlePlaybackBtnClick | playerState: ".concat(eS)), eS) {
        case B.rq.ENDED:
  ...
  let tX = l.useCallback(e => {
      var t;
      ta.info("[QV] | logVideoError: errorType: ".concat(e, ", videoProgress: ").concat(null == (t = e2.current) ? void 0 : t.currentTime, ", videoAssetId: ").concat(tp, ", connectionSpeed: ").concat(eV)), tT(e)
    }, [eV, tT, e2, tp, ta]),
    tW = e => {
  ...
  return (0, r.jsx)(p.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [t8 && (() => {
        ...
        onLoadedData: e => {
          ta.info("[QV] | handleLoadedData: loadingFirstChunk: ".concat(eI)), eI && (tE(null != eK.current ? performance.now() - eK.current : null), ek(!1), null != tf.current && (tf.current.config.minAutoBitrate = 8e5))
        },
        onLoadedMetadata: e => {
        ...
        crossOrigin: tG,
        children: [null != t7 && tK && (0, r.jsx)("track", {
          ref: e8,
          src: t7.url,
          label: "English",
          kind: "captions",
          srcLang: "en",
          default: !0
        }), null != tm && td !== I.n1.VIDEO_HLS && (0, r.jsx)("source", {
          onError: () => tX(B.CY.SOURCE_ERROR),
          src: tm.url,
          type: tm.mimetype
        })]
      }), (eI || eA) && eS === B.rq.PLAYING && (0, r.jsx)(p.$jN, {
        type: p.$jN.Type.WANDERING_CUBES,
        className: G.loadingSpinner
      }), eS === B.rq.PAUSED && e3 === y.yE.LOST_FOCUS && (0, r.jsx)(W, {}), eu && eS !== B.rq.ENDED && (0, r.jsxs)(r.Fragment, {
      ...
      }, eS), em && null != tl && (0, r.jsx)(s.animated.div, {
        ...
        style: {
          paddingLeft: (0, s.to)([t$.to({
            range: [0, 1],
            output: [0, 25]
          })], e => "".concat(e, "px")),
          paddingRight: (0, s.to)([t$.to({
            range: [0, 1],
            output: [0, 25]
          })], e => "".concat(e, "px")),
          height: (0, s.to)([t$.to({
