...
function H() {
  ...
  return (0, r.jsx)("div", {
    ...
    style: {
      background: (0, m.wj)(e) ? "rgba(0, 0, 0, 0.65)" : "rgba(255, 255, 255, 0.65)"
    },
...
function K(e) {
  let {
    quest: t,
    shouldShow: n
  } = e, i = o.useMemo(() => (0, I.z)(I.i.VIDEO_PLAYER_THUMBNAIL, t), [t]);
  return null == i ? null : (0, r.jsx)(A.A, {
    ...
    children: e => (0, r.jsx)("img", {
      ...
      src: i.url,
      alt: "Video thumbnail",
      className: l()(Q.stillFrameImageCard, {
...
function X(e) {
  ...
  return (0, r.jsx)(p.P3F, {
    className: l()(Q.endScreenPanel, Q.accentOnHover, s),
    onMouseEnter: d,
    onMouseLeave: m,
    onFocus: d,
    onBlur: m,
...
function J(e) {
  ...
  let {
    ...
    autoplay: es,
    parentTransitionState: ec,
    performanceClockStartTime: eu
  } = e, ed = (0, C.aM)(), em = (0, h._F)(), ep = (0, h.O5)(), ef = (0, x.km)(e => e.transcriptEnabled), ev = (0, x.km)(e => e.setTranscriptEnabled), eg = (0, x.km)(e => e.captionEnabled), eE = (0, x.km)(e => e.setCaptionEnabled), eb = (0, x.km)(e => e.fullScreenEnabled), eO = (0, x.km)(e => e.setFullScreenEnabled), {
    focused: eS,
    focusedChanged: eh
  } = (0, B.xU)(), {
    visible: eC,
    visibleChanged: ej,
    targetRef: ey
  } = (0, B.Yy)(), [e_, ex] = o.useState(!0 === es ? M.rq.PLAYING : M.rq.PAUSED), [eD, eN] = o.useState(!1), eP = (0, _.il)(ei), [eT, eI] = o.useState(eP.percentComplete), [eA, ew] = o.useState(!1), [ek, eL] = o.useState(!0), [eR, eM] = o.useState(!1), [eV, eq] = o.useState([]), [eB, eF] = o.useState(b.Z.getEffectiveConnectionSpeed()), [eU, eZ] = o.useState(0), [eY, eQ] = o.useState(0), [eW, ez] = o.useState(!1), [eG, eH] = o.useState(!1), eK = o.useRef(!0), eX = o.useRef(null), e$ = o.useRef(null), eJ = (0, o.useRef)(-1), e0 = (0, x.km)(e => {
    var t;
    return null !== (t = e.videoProgress[ei.id]) && void 0 !== t ? t : {
      timestampSec: 0,
      duration: 10
    }
  }, c.X), e1 = (0, x.km)(e => e.setVideoProgress), e2 = (0, x.km)(e => e.muted), e6 = (0, x.km)(e => e.volume), e4 = (0, d.e7)([v.Z], () => v.Z.useReducedMotion), e8 = (0, o.useRef)(null), e7 = (0, o.useRef)(null), e9 = o.useRef(!0), e3 = (null === (t = ei.userStatus) || void 0 === t ? void 0 : t.completedAt) != null, e5 = (0, x.km)(e => e.transcript), [te, tt] = o.useState(null), [tn, tr] = o.useState(!1), [to, ti] = o.useState(!1), [tl, ta] = o.useState(null), ts = e3 ? null !== (E = null === (n = e8.current) || void 0 === n ? void 0 : n.duration) && void 0 !== E ? E : 0 : Math.max(e0.maxTimestampSec, eP.progressSeconds), tc = o.useMemo(() => (0, N.T)({
    quest: ei,
    ...
    var t, n, r, o, i, l, a, s;
    let c = null !== (i = null === (t = e.config.videoMetadata) || void 0 === t ? void 0 : t.messages.videoEndCtaTitle) && void 0 !== i ? i : Y.NW.string(Y.t.iiTtpK),
      d = null !== (a = null !== (l = null === (n = e.config.videoMetadata) || void 0 === n ? void 0 : n.messages.videoEndCtaButtonLabel) && void 0 !== l ? l : null === (r = e.config.videoMetadata) || void 0 === r ? void 0 : r.messages.videoEndCtaSubtitle) && void 0 !== a ? a : Y.NW.string(Y.t.mxaHf3),
      m = (0, _.B2)(e.config),
      p = null !== (s = null === (o = e.config.videoMetadata) || void 0 === o ? void 0 : o.messages.videoEndCtaSubtitle) && void 0 !== s ? s : Y.NW.string(Y.t.mxaHf3),
      f = e.config.features.includes(u.S.VIDEO_QUEST_FORCE_END_CARD_CTA_SWAP);
    return {
      title: f ? m : c,
      subtitle: f ? p : d
    }
  }(ei), tm = e3 ? e0.timestampSec >= e0.duration ? 0 : e0.timestampSec : Math.max(e0.timestampSec, eP.progressSeconds), {
    videoAssetId: tp,
    videoAsset: tf,
    hlsRef: tv
  } = function(e, t, n, r) {
    ...
    let l = o.useRef(!1),
      ...
      d = o.useMemo(() => null != u ? c && a.ZP.isSupported() && null != u.videoPlayerVideoHls ? I.i.VIDEO_PLAYER_VIDEO_HLS : z.has(n) || null == u.videoPlayerVideoLowRes ? I.i.VIDEO_PLAYER_VIDEO : I.i.VIDEO_PLAYER_VIDEO_LOW_RES : null, [u, n, c]),
      m = o.useMemo(() => null != d ? (0, I.z)(d, e) : null, [e, d]),
      p = () => {
        null != s.current && (s.current.config.minAutoBitrate = 8e5)
      };
    return o.useEffect(() => {
      ...
      s.current = new a.ZP({
        ...
        startFragPrefetch: !0,
        startLevel: -1
      }), s.current.on(a.ZP.Events.FRAG_LOADED, p), s.current.loadSource(m.url), s.current.attachMedia(t.current), l.current = !0;
      let e = s.current;
      return () => {
  ...
  }(ei, e8, eB, tm), tg = o.useCallback(e => {
    if (null != e8.current) {
      var t, n;
      em({
        questId: ei.id,
  ...
  }, [em, ei.id, tp, e3, el, tv]), tE = o.useCallback(() => {
    var e, t;
    ...
    if (tc.info("[QV] | updatePlayerState | playerState: ".concat(e)), ex(e), null != e8.current) switch (e) {
      case M.rq.PLAYING:
        e8.current.play(), em({
          questId: ei.id,
  ...
  }, [te, ei.id, em, el, tv]), o.useEffect(() => {
    eh && null != e8.current && em({
      questId: ei.id,
  ...
  let tS = o.useCallback(e => {
    var t;
    tc.info("[QV] | sendProgressUpdate: Checking conditions..."), e3 || (null === (t = ei.userStatus) || void 0 === t ? void 0 : t.enrolledAt) == null || (tc.info("[QV] | sendProgressUpdate: quest enrolled and not completed, sending video progress: ".concat(e)), (0, _.FI)(ei, e)), null != e8.current && em({
      questId: ei.id,
  ...
  let th = () => {
    ...
    ty = o.useCallback(() => {
      ...
      null == t || (0, S.rB)(t) || (t.removeEventListener(S.NO, ty), eO(!1), em({
        questId: ei.id,
    ...
    t_ = () => {
      ...
      tc.info("[QV] | handleSeekBackIncrement | newTime: ".concat(e)), tD(e), e_ === M.rq.ENDED && tO(M.rq.PAUSED), ep({
        questId: ei.id,
    ...
    tx = () => {
      ...
      let e = Math.min(e8.current.currentTime + 10, ts);
      tc.info("[QV] | handleSeekForwardIncrement | newTime: ".concat(e)), tD(e), e_ !== M.rq.ENDED && e >= e8.current.duration && tO(M.rq.ENDED), ep({
        questId: ei.id,
        questContent: y.jn.VIDEO_MODAL,
  ...
  let tD = o.useCallback(e => {
    ...
    tN = () => {
      if (null != e8.current) switch (tc.info("[QV] | handlePlaybackBtnClick | playerState: ".concat(e_)), e_) {
        case M.rq.ENDED:
  ...
  let tA = o.useCallback(e => {
      try {
        ...
        tc.info("[QV] | logVideoError: errorType: ".concat(e, ", videoProgress: ").concat(i, ", videoAssetId: ").concat(tp, ", connectionSpeed: ").concat(eB, ", error: ").concat(r, ", networkState: ").concat(o)), em({
          questId: ei.id,
  ...
  }, [eg, tV, e4, tl, tM]), o.useEffect(() => (tL({
    controlBarAnimSpring: tj || eW ? 1 : 0,
    immediate: e4
  }), () => {
    tk.stop()
  }), [tj, tL, e4, eW, tk]);
  ...
  return (0, r.jsx)(p.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [tq && ((0, P.e)({
        ...
        onTimeUpdate: e => {
          null != e8.current && (e8.current.currentTime >= eU && (tc.info("[QV] | handleTimeUpdate: capturing server time update: currentTime: ".concat(e8.current.currentTime)), eZ(e8.current.currentTime + 6 + 2 * Math.random()), tS(e8.current.currentTime)), e8.current.currentTime >= eY && (eQ(e8.current.currentTime + 1), (0, j.qm)(ei.id, eP.taskType, e8.current.currentTime), ea(e8.current.currentTime)), e1(ei.id, e8.current.currentTime, e8.current.duration), eI(e8.current.currentTime / e8.current.duration * 100))
        },
        onEnded: e => {
        ...
        onLoadedData: e => {
          if (tc.info("[QV] | handleLoadedData: loadingFirstChunk: ".concat(ek)), ek) {
            ...
            }), eL(!1), null != tv.current && (tv.current.config.minAutoBitrate = 8e5)
          }
        },
        onLoadedMetadata: e => {
        ...
        onLoadStart: () => {
          eX.current = Date.now(), tc.info("[QV] | handleLoadStart | loadingStartTime: ".concat(eX.current)), em({
            questId: ei.id,
            ...
            properties: W({
              ...
              network_connection_speed: eB,
              video_session_id: el,
              is_hls_supported: a.ZP.isSupported()
            }, $(tv))
          })
        },
        onPlaying: () => {
          ...
          tc.info("[QV] | ⏰ Video FCP: ".concat(e, "ms")), em({
            questId: ei.id,
        ...
        onWaiting: e => {
          e$.current = Date.now(), tc.info("[QV] | handleWaitingForData: bufferingStartTime: ".concat(e$.current)), eJ.current += 1, em({
            questId: ei.id,
        ...
        children: [null != tU && (0, r.jsx)("track", {
          ref: e7,
          src: tU.url,
          label: "English",
          kind: "captions",
          srcLang: "en",
          default: !0
        }), null != tf && tp !== I.i.VIDEO_PLAYER_VIDEO_HLS && (0, r.jsx)("source", {
          onError: () => tA(M.CY.SOURCE_ERROR),
          src: tf.url,
          type: tf.mimetype
        })]
      }), (ek || eR) && e_ === M.rq.PLAYING && (0, r.jsx)(p.$jN, {
        type: p.$jN.Type.WANDERING_CUBES,
        className: Q.loadingSpinner
      }), e_ === M.rq.PAUSED && te === y.yE.LOST_FOCUS && (0, r.jsx)(H, {}), ef && e_ !== M.rq.ENDED && (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(p.P3F, {
          ...
          style: {
            marginBottom: (0, s.to)([tk, tM], (e, t) => "".concat(50 * e + t, "px"))
          },
        ...
        className: l()(Q.playPausePopCont, {
          [Q.play]: e_ === M.rq.PLAYING,
          [Q.pause]: e_ === M.rq.PAUSED
        }),
        children: e_ === M.rq.PLAYING ? (0, r.jsx)(p.o1U, {
          className: Q.playPausePopIcon
        }) : (0, r.jsx)(p.fpf, {
          className: Q.playPausePopIcon
        })
      }, e_), eg && null != tl && (0, r.jsx)(s.animated.div, {
        ...
        style: {
          paddingLeft: (0, s.to)([tk.to({
            range: [0, 1],
            output: [0, 25]
          })], e => "".concat(e, "px")),
          paddingRight: (0, s.to)([tk.to({
            range: [0, 1],
            output: [0, 25]
          })], e => "".concat(e, "px")),
          height: (0, s.to)([tk.to({
        ...
        children: [(0, r.jsx)(L.Z, {
          ...
          maxSeekableTime: tj && eG ? ts : void 0,
          onClick: e => {
          ...
          children: (0, r.jsx)(w.Z, {
            ...
            handleTranscriptBtnClick: () => {
              ef || null != e5 && e5.questId === ei.id && e5.fetchStatus !== x.iF.NONE && e5.fetchStatus !== x.iF.FAILURE || (0, j.lL)(ei), ev(!ef), ep({
                questId: ei.id,
                questContent: y.jn.VIDEO_MODAL,
            ...
            handleFullScreenBtnClick: () => {
              ...
              t && null != n ? ((0, S.Dj)(n), n.addEventListener(S.NO, ty), em({
                questId: ei.id,
                event: U.rMx.QUEST_VIDEO_FULLSCREEN_ENTERED,
                properties: {
                  video_session_id: el
                }
              })) : t || null == n || (n.removeEventListener(S.NO, ty), em({
                questId: ei.id,
                event: U.rMx.QUEST_VIDEO_FULLSCREEN_EXITED,
                properties: {
                  video_session_id: el
