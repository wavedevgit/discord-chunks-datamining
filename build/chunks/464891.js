...
function X(e) {
  let {
    ...
    messageClassname: _,
    badges: b
  } = e, h = (0, E.yE)(t.flags, U.iLy.SENT_BY_SOCIAL_LAYER_INTEGRATION) ? t.applicationId : null, y = (0, p.q)(h);
  return (0, r.jsxs)(r.Fragment, {
...
function $(e) {
  let {
    ...
    className: F,
    channel: Q
  } = e, $ = o.useMemo(() => null != p ? e => p(e, t) : void 0, [p, t]), [, ee] = (0, f.ZP)(t.author.id, e.guildId), et = (0, c.e7)([S.Z], () => S.Z.getGuild(e.guildId), [e.guildId]), en = null != t.author && null != et && w.Z.canManageUser(U.Plq.MODERATE_MEMBERS, t.author, et), er = ee && en, eo = function(e) {
    var t, n;
    let {
      props: a,
      guildId: i,
    ...
    }), Z = null != f.messageReference && null != f.webhookId && f.hasFlag(U.iLy.IS_CROSSPOST), A = f.author, {
      id: D
    } = A, B = b ? 32 : 80, {
      avatarSrc: L,
      ...
      showPending: !0
    }), z = f.isInteractionPlaceholder(), H = o.useMemo(() => {
      var e, t;
      return z && null == A.avatar && (null === (e = f.application) || void 0 === e ? void 0 : e.icon) != null && null !== (t = M.ZP.getApplicationIconURL({
        id: f.application.id,
    ...
    guildId: e.guildId,
    handleRenderPopout: $,
    showCommunicationDisabledStyles: er
  }), ea = (0, c.e7)([I.ZP], () => {
    var t;
