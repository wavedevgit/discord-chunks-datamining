...
function Q(e) {
  let {
    ...
    messageClassname: _,
    badges: b
  } = e, h = (0, E.yE)(t.flags, U.iLy.SENT_BY_SOCIAL_LAYER_INTEGRATION) ? t.applicationId : null, y = (0, g.q)(h);
  return (0, r.jsxs)(r.Fragment, {
...
function $(e) {
  ...
  return (0, r.jsx)(l.ua7, {
    ...
    shouldShow: null != o,
    text: H.NW.formatToPlainString(H.t["8zbGNT"], {
      date: o
    }),
...
function ee(e) {
  let {
    ...
    className: V,
    channel: J
  } = e, ee = o.useMemo(() => null != g ? e => g(e, t) : void 0, [g, t]), [, et] = (0, _.ZP)(t.author.id, e.guildId), en = (0, c.e7)([S.Z], () => S.Z.getGuild(e.guildId), [e.guildId]), er = null != t.author && null != en && w.Z.canManageUser(U.Plq.MODERATE_MEMBERS, t.author, en), eo = et && er, ea = function(e) {
    var t, n;
    let {
      props: a,
      guildId: i,
    ...
    } = (0, p.ZP)(d.Z.AVATAR), E = (0, c.e7)([I.ZP], () => {
      var e;
      return null !== (e = a.displayCompactAvatars) && void 0 !== e ? e : I.ZP.displayCompactAvatars
    }), Z = null != _.messageReference && null != _.webhookId && _.hasFlag(U.iLy.IS_CROSSPOST), A = _.author, {
      id: D
    } = A, B = h ? 32 : 80, {
      avatarSrc: L,
      ...
      showPending: !0
    }), H = _.isInteractionPlaceholder(), F = o.useMemo(() => {
      var e, t;
      return H && null == A.avatar && (null === (e = _.application) || void 0 === e ? void 0 : e.icon) != null && null !== (t = M.ZP.getApplicationIconURL({
        id: _.application.id,
        icon: _.application.icon,
        size: B,
        fallbackAvatar: !1
      })) && void 0 !== t ? t : L
    }, [H, null === (t = _.application) || void 0 === t ? void 0 : t.icon, null === (n = _.application) || void 0 === n ? void 0 : n.id, A.avatar, B, L]), V = (0, j.nT)({
      location: "MessageHeader"
    }), [Y, Q] = o.useState(!1), J = o.useRef(!1), $ = o.useRef(void 0), ee = o.useRef(void 0), et = o.useRef(void 0);
    if ((0, u.ZP)(() => () => {
      ...
      if (null != g && null != T) {
        ...
        return V ? (0, r.jsx)("div", {
          onMouseEnter: () => {
            V && (J.current = !0, $.current = setTimeout(() => {
              J.current && en()
            }, z.a6), ee.current = setTimeout(() => {
              J.current && Q(!0)
            }, z.JX))
          },
          onMouseLeave: () => {
            V && (J.current = !1, et.current = setTimeout(() => {
              J.current || Q(!1)
            }, z.Ig))
          },
          children: e
    ...
    function en() {
      return (0, N.Z)(_.author.id, null != b.guildMemberAvatar && null != i ? M.ZP.getGuildMemberAvatarURLSimple({
        guildId: i,
        userId: _.author.id,
  ...
  }), es = (!a || ei) && null != C && null != en ? (0, r.jsx)(l.yRy, {
    ...
    children: e => {
      ...
      return (0, r.jsx)(f.Z, q(K({}, C), {
        className: F.roleIcon,
        onClick: t
      }))
    }
  }, "role-icon-children") : (!a || ei) && null != C ? (0, r.jsx)(f.Z, q(K({}, C), {
    className: F.roleIcon
    ...
    compact: a,
    isRepliedMessage: !1
  }), el = [], eu = k.default.getCurrentUser(), ed = Z.ZP.isPremium(t.author), ep = Z.ZP.isPremium(eu), eg = null == J ? void 0 : J.isPrivate();
  (0, A.R)(null != C, "Message Username") && ed && !a && !eg && el.push((0, r.jsx)($, {
    currentUserIsPremium: ep,
    author: t.author
  }, "nitro-author")), null != es && el.push(es), null != en && (el.push((0, r.jsx)(b.Z, {
    guild: en,
    message: t
  }, "new-member")), el.push((0, r.jsx)(h.Z, {
    guild: en,
    message: t
  }, "leaderboard-champion"))), null != J && null != en && el.push((0, r.jsx)(m.Z, {
    guild: en,
    channel: J,
    userId: t.author.id,
    messageId: t.id
  ...
  let em = [];
  (0, E.yE)(t.flags, U.iLy.SUPPRESS_NOTIFICATIONS) && em.push((0, r.jsx)(x.Z, {}, "suppress-notifications")), t.hasPotions() && em.push((0, r.jsx)(y.Z, {
    message: t
  }));
  let ef = {};
