...
let X = l.memo(function(e) {
  let {
    ...
    compact: a,
    isRepliedMessage: !1
  }), [t, o, a]), S = l.useRef(null), N = (0, s.e7)([E.Z], () => E.Z.getGuild(i)), Z = l.useMemo(() => $(a, y, u, N), [a, y, u, N]), R = l.useMemo(() => null == u ? null : 1 === Z && null != N ? (0, r.jsx)(c.yRy, {
    targetElementRef: S,
  ...
  }, "role-icon-children") : 2 === Z ? (0, r.jsx)(g.Z, W(K({}, u), {
    className: z.roleIcon
  }), "role-icon-children") : null, [Z, u, N]), I = (0, s.e7)([T.default], () => T.default.getCurrentUser()), A = l.useMemo(() => {
    let e = [],
    ...
    return (0, k.R)(null != u, "Message Username") && n && !a && !i && e.push((0, r.jsx)(ee, {
      ...
      author: t.author
    }, "nitro-author")), null != R && e.push(R), null != N && (e.push((0, r.jsx)(b.Z, {
      guild: N,
      message: t
...
let ee = l.memo(function(e) {
  ...
  et = l.memo(function(e) {
    let {
      ...
      channel: w,
      preview: T
    } = e, _ = l.useMemo(() => null != p ? e => p(e, t) : void 0, [p, t]), [, k] = (0, f.ZP)(t.author.id, e.guildId), M = (0, s.e7)([N.Z, E.Z], () => {
      ...
      compact: o,
      isRepliedMessage: !1
    }), [t, w, o]), Y = (0, s.e7)([E.Z], () => $(o, G, g, E.Z.getGuild(e.guildId)), [o, G, g, e.guildId]), J = l.useMemo(() => {
      let e = [];
    ...
    }, [t]), ee = (0, A.XX)(t, b), et = (0, A.Dv)(t), en = h ? "".concat(ee) : "".concat(ee, " ").concat(et), er = (null == n ? void 0 : n.state) === v.Y.LOADED ? (0, A.Gq)(t) : void 0;
    return (0, r.jsx)(Q, {
      message: t,
      avatar: L,
