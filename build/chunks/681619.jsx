...
function c(e) {
  let {
    ...
    renderHeader: () => <s.Text variant={"text-sm/semibold"}>{e.key}</s.Text>
  }, e)), [t]), h = [a.length];
  return <div className={o.tableContainer}><s.Tvr className={l} innerClassName={o.table} sections={h} sectionHeight={40} renderSection={e => {
        let {
          section: t
        } = e, r = o.tableHeader;
        return (0, n.jsx)("div", {
