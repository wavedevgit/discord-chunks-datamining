...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk189648 = require("./189648.js"),
  Chunk775194 = require("./775194.js"),
  Chunk499848 = require("./499848.js"),
  Chunk724392 = require("./724392.js"),
  Chunk442580 = require("./442580.js"),
  Chunk770800 = require("./770800.js"),
  Chunk981631 = require("./981631.js"),
  Chunk65154 = require("./65154.js"),
  Chunk388032 = require("./388032.js"),
  Chunk442122 = require("./442122.js");
let I = (e, t, r) => <m.Z align={m.Z.Align.CENTER}><m.Z.Child><m.Z align={m.Z.Align.CENTER}>{<s.qEK size={s.EFr.SIZE_24} src={e.getAvatarURL(r, 24)} aria-label={e.username} className={S.avatar} />}{<span className={S.username}>{null != t ? t : b.ZP.getName(e)}</span>}</m.Z></m.Z.Child></m.Z>,
  k = e => <m.Z align={m.Z.Align.CENTER}><m.Z.Child><m.Z align={m.Z.Align.CENTER}><span className={S.username}>{e}</span></m.Z></m.Z.Child></m.Z>;
...
function A() {
  ...
  let {
    ...
    return null != i && (p.push(f), p.push({
      ...
      section: u.ID.CUSTOM,
      label: "Channel Name",
      element: () => <s.X6q className={S.channelName} variant={"heading-lg/semibold"}>{o.name}</s.X6q>
    }] : [], {
      section: u.ID.CUSTOM,
      label: "Connection State",
      element: () => <s.X6q className={S.channelName} variant={"heading-md/normal"}>{c === N.hes.RTC_CONNECTED ? "Connected" : "Disconnected"}</s.X6q>
    }, ...d, ...m, ...p, ...h]
  }({
  ...
  return Chunk73800.useEffect(() => () => {
    Chunk304680.xv()
  }, []), <Chunk503089.ZP theme={Chunk594174} sidebarTheme={Chunk51144} section={Chunk189648} onSetSection={Chunk304680.zc} sections={Chunk499848} />
}