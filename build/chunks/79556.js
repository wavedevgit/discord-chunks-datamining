...
class R extends S.ZP {
  ...
  render() {
    let {
      ...
      withGuildIcon: x,
      enableActivities: C
    } = this.props, S = C && null != O && O.length > 0, P = (0, f.D)(y), N = (0, r.jsx)("li", {
...
function L(e) {
  ...
  }), C = (0, l.e7)([m.Z], () => m.Z.shouldIndicateNewChannel(n.id, t.id)), {
    needSubscriptionToAccess: S,
    isSubscriptionGated: I
  } = (0, g.Z)(t.id), N = (0, l.e7)([j.ZP], () => j.ZP.isFavorite(n.id, t.id)), E = (0, l.e7)([x.default], () => {
