...
function x(e) {
  ...
  return [<r.kSQ>{s}{d}</r.kSQ>, <r.kSQ>{f}{g}{j}{m}{t && y}</r.kSQ>]
}
...
let D = (0, Chunk108843.Z)((0, Chunk883385.Z)(function(e) {
  ...
  return <r.v2r navId={"user-context"} onClose={l.Zy} aria-label={h.intl.string(h.t.liqwPD)} onSelect={o} onInteraction={c} variant={"fixed"}>{!u && (0, i.jsxs)(i.Fragment, {
