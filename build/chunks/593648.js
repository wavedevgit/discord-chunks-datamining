...
function X() {
  ...
  return 0 === Object.keys(e).length ? null : (0, i.jsxs)(y.F, {
...
class Q extends r.PureComponent {
  handleDesktopChange(e) {
    ...
    if (t !== U.qrD.NEVER) D.Z.requestPermission(e => {
  ...
  render() {
    let {
      ...
      focusMode: d
    } = this.props, m = Z.isPlatformEmbedded && (0, Z.isWindows)(), g = o().range(1, 11).map(e => ({
      value: 60 * e,
      label: G.intl.formatToPlainString(G.t.iXLF9f, {
        minutes: e
      })
    }));
    return (0, i.jsxs)(u.hjN, {
      ...
      }), (0, i.jsx)(ee, {}), (0, i.jsx)(es, {}), (0, i.jsx)(er, {}), (0, i.jsx)(y.F, {
      ...
      }), this.renderTTS(), (0, i.jsx)(X, {}), (0, i.jsx)(u.xJW, {
        children: (0, i.jsx)(q, {
          disabledSounds: s,
          disableAllSounds: a,
          notifyMessagesInSelectedChannel: c
...
async function et(e) {
  e(!0);
  let t = await (0, O.Tn)();
  0 === t.length ? await (0, v.oL)() : m.Z.show({
    title: G.intl.string(G.t["cY+Ooa"]),
    body: G.intl.format(G.t["7zTJJS"], {
...
function es() {
  ...
  }).enableInAppNotifications ? (0, i.jsxs)(y.F, {
