...
let E = 57.75,
  b = Chunk73800.memo(function(e) {
    ...
    return p || null == o || "" === o ? null : <div>{<div ref={A} className={a()(_.descriptionClamp, I && _.maxBioHeight)} onBlur={C}><d.Z userBio={o} setLineClamp={false} textColor={"header-primary"} /></div>}{(O || I) && <div className={_.viewFullBio}><s.Avr textVariant={"text-xs/normal"} size={"sm"} variant={"secondary"} text={f.intl.string(f.t.YDiPq6)} onClick={N} disabled={m} /></div>}</div>
  })