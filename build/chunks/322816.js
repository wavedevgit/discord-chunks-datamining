...
n.d(t, {
  ZP: () => R
}), n(415506), n(388685), n(539338), n(953529);
var r = n(255367),
  i = n(73800),
  l = n(120356),
  s = n.n(l),
...
function P(e) {
  let {
    ...
    role: n,
    locked: l
  } = e, s = (0, o.e7)([p.default], () => p.default.getCurrentUser()), u = i.useMemo(() => x.uB({
    user: s,
    context: t
  }), [s, t]), m = i.useMemo(() => ({
    [n.id]: T(S({}, n), {
...
function w(e) {
  ...
  function o(e) {
    ...
    }) && N.intl.string(N.t["K+D+GB"]) : N.intl.string(N.t.nOtPMD)
  }
  return (0, r.jsxs)("div", {
...
function R(e) {
  ...
  } = e, [c, u] = i.useState(null != o ? o : ""), m = i.useMemo(() => h.Z.generateGuildPermissionSpec(t), [t]).map(e => T(S({}, e), {
  ...
  return i.useEffect(() => {
    j.current || "" === c.trimStart() || (f.default.track(C.rMx.SEARCH_STARTED, {
