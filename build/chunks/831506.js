...
function P(e, t, n, l) {
  let r = n.find(e => null != e.party && e.party.id),
    ...
    a = S(t, e);
  if (null == i || l === f.Skl.OFFLINE) return null != a && void E(t, e);
  if (null != a) {
    if (a === i) return !1;
    E(t, e)
  }! function(e, t, n) {
...
d(A, "displayName", "GamePartyStore");
let O = new A(u.Z, {
  CONNECTION_OPEN_SUPPLEMENTAL: function(e) {
    ...
    for (let {
      ...
      of n) null != e && !1 !== P(f.ME, e.id, r, t) && (l = !0);
    for (let e of t) !1 !== m({
      guild: e
    }) && (l = !0);
    return l
  ...
  PRESENCES_REPLACE: function(e) {
    ...
    for (let {
      ...
      of t) null != e && !1 !== P(f.ME, e.id, l) && (n = !0);
    return n
  },
  PRESENCE_UPDATES: function(e) {
    ...
    return t.map(e => {
      ...
      return P(null != t ? t : f.ME, n.id, r, l)
    }).some(e => e)
  },
