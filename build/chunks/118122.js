...
function C(e) {
  let {
    disableTooltip: t,
    lastTargetNode: n
  } = e, a = (0, l.e7)([f.Z], () => f.Z.getGuilds()), C = i.useMemo(() => Object.values(a), [a]), S = (0, l.e7)([g.default], () => g.default.getCurrentUser()), P = i.useMemo(() => C.some(e => e.isOwner(S)), [C, S]), N = (0, o.s9z)(e => (0, o.DEQ)(e, y.PU)), {
