...
class eW extends Chunk473749.PureComponent {
  ...
  componentDidMount() {
    ...
    this.currentDocument.addEventListener(ex.NO, this.handleFullScreenChange), eb.default.track(eL.rMx.VIDEO_LAYOUT_TOGGLED, eF({
      video_layout: this.inPopout ? "popout" : t
    }, (0, N.AB)(e.id)))
  }
  componentWillUnmount() {
    this._videoBackgroundTooltipTimeout.stop(), this.currentDocument.removeEventListener(ex.NO, this.handleFullScreenChange), this.inPopout && (0, eO.isMac)() || this.maybeLeaveFullScreen()
  }
  ...
  get viewProperties() {
    let {
      ...
      inCall: r,
      canPopout: i
    } = this.props, l = t === eL.WtW.VIDEO && r && !(this.popoutOpen && !this.inPopout), a = t === eL.WtW.VIDEO && r && this.popoutSupported && i, o = t !== eL.WtW.VOICE && n.isPrivate() && !this.inPopout && r, s = n.type === eL.d4z.GUILD_VOICE, c = {
      renderHeader: true,
      useTheme: false,
  ...
  renderContent(e) {
    ...
    } = this.props, v = h === eL.AEg.MINIMUM, O = v || h === eL.AEg.NORMAL, j = l && o === eL.WtW.VIDEO, x = (null != (t = null == b ? true : b.length) ? t : 0) > 0 && p.isPrivate();
    return this._lastIdleProps = e, (0, r.jsx)($.Z, eH(eF({
      ...
      idle: !g && l && !v && e.idle,
      children: l && this.popoutOpen && !this.inPopout ? null : (0, r.jsx)(Y.Z, {
  ...
  render() {
    let {
      ...
      resizedHeight: p
    } = this.state, h = i === eL.WtW.VIDEO, g = e !== eL.AEg.HAVEN && e !== eL.AEg.NO_CHAT && e !== eL.AEg.FULL_SCREEN && null != c, m = eL.BRd.MIDNIGHT;
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(f.f6W, {
        ...
        children: t => (0, r.jsx)("div", {
          className: a()(eG.callContainer, l || e !== eL.AEg.FULL_SCREEN ? true : eG.fullScreen, t),
          ref: e => {
  ...
  constructor(...e) {
    super(...e), eB(this, "_prevLayout", eL.AEg.MINIMUM), eB(this, "_wrapperRef", i.createRef()), eB(this, "_callContainerRef", i.createRef()), eB(this, "_channelChatRef", i.createRef()), eB(this, "_contentRef", i.createRef()), eB(this, "_videoBackgroundTooltipTimeout", new p.V7), eB(this, "_lastIdleProps", null), eB(this, "state", {
      ...
      this.props.layout === eL.AEg.HAVEN ? (this.handleChangeLayout(eL.AEg.NO_CHAT), U.ZP.disconnect(this.props.channel.id)) : this.handleChangeLayout(eL.AEg.HAVEN)
      ...
      r !== e && (g.Z.updateLayout(t.id, e, n), e === eL.AEg.FULL_SCREEN && t.isPrivate() && ev.S.dispatch(eL.CkL.TEXTAREA_BLUR))
      ...
      let r = arguments.length > 3 && true !== arguments[3] ? arguments[3] : ek.A5.CONTEXT_MENU;
      ...
      switch (null == (a = this._lastIdleProps) || a.onPreventIdle("menu"), null == (o = this._lastIdleProps) || o.onActive(), e.type) {
        ...
        case ek.fO.USER:
          ...
          if (null != f) {
            if (i) return (0, z.D)(t, f, c, p, (e, t) => (0, eD.o)({
              menuItemProps: t,
              menuName: e,
            ...
            switch (c.type) {
              case eL.d4z.DM:
                return (0, m.jW)(t, async () => {
                  let {
                    default: t
                  } = await Promise.all([n.e("79695"), n.e("4040"), n.e("56826"), n.e("87120")]).then(n.bind(n, 131404));
                  return n => (0, r.jsx)(t, eH(eF({}, n), {
              ...
              case eL.d4z.PRIVATE_THREAD:
                let l = c.getGuildId();
                return s()(null != l, "GuildID null for guild voice channel"), (0, m.jW)(t, async () => {
                  let {
                    default: t
      ...
      (0, ek._5)(e) && (0, L.p9)(n, em.Z, ed.Z, ep.Z, D.default)[0] && (b.default.selectVoiceChannel(n.id), 0 === i.filter(t => (0, k.V9)(t) === e.id && t.state !== eL.jm8.ENDED).length && (0, y.rn)((0, k.my)(e.id), {
        forceMultiple: t.shiftKey
      })), l && a === eL.WtW.VIDEO && ((null == r ? true : r.id) === e.id ? g.Z.selectParticipant(n.id, null) : g.Z.selectParticipant(n.id, e.id))
      ...
      let {
        ...
        let n = e.getGuildId();
        null == n || eu.ZP.isCurrentUserGuest(n) || (0, V.uL)((0, ey.LY)(n)), F.openChannelCallPopout(e)
      };
      null == t || (0, C.R)() ? n() : (0, P.Z)({
        onConfirm: n
      })
      ...
      return t || n === eL.AEg.MINIMUM || n === eL.AEg.NORMAL ? (0, r.jsx)(K.ZP, {
        exitFullScreen: this.maybeLeaveFullScreen,
        channel: e,
      ...
      let d = e === eL.AEg.NO_CHAT ? ee.Z.Directions.UP : ee.Z.Directions.DOWN,
        ...
        y = l ? (0, r.jsx)(q.Z, {
          channel: n,
          stream: (null == o ? true : o.type) === ek.fO.STREAM ? (0, k.my)(o.id) : true,
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [b && !s ? y : null, m ? (0, r.jsxs)(w.Z, {
        ...
        }) : null, (null == o ? true : o.type) !== ek.fO.STREAM && (null == o ? true : o.type) !== ek.fO.ACTIVITY || s ? null : (0, r.jsx)(Q.Z, {
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [null != i && i.type !== ek.fO.ACTIVITY && i.user.id !== n ? (0, r.jsx)(el.Z, {
          ...
          className: eG.rightTrayIcon,
          onOpenPopout: () => {
            (0, eR.v)(Z.Z.VOICE_CONTROL_TRAY, eR.d.POPOUT, true), this.handleOpenPopout()
          },
          onClosePopout: () => {
            (0, eR.v)(Z.Z.VOICE_CONTROL_TRAY, eR.d.POPOUT, false), this.handleClosePopout()
          }
        }) : null, o ? (0, r.jsx)(et.Z, {
          themeable: u,
          ...
          className: eG.rightTrayIcon,
          onClick: () => {
            (0, eR.v)(Z.Z.VOICE_CONTROL_TRAY, eR.d.FULL_SCREEN, this.props.layout !== eL.AEg.FULL_SCREEN), this.handleFullScreen()
          }
        }) : null]
      })
      ...
      return !e || t || this.popoutOpen && !this.inPopout && i ? null : (0, r.jsx)(e_.ZP, {
      ...
      return s ? (0, r.jsx)(Q.Z, {
        children: (0, r.jsx)("div", {
          className: eG.headerWrapper,
          children: o ? null == e ? true : e() : (0, r.jsx)(eP.Z, {
            channel: t,
            guild: n,
            appContext: i,
            inCall: a,
...
let eK = function(e) {
  ...
  let {
    ...
    ref: b
  } = (0, j.ZP)(), y = (0, B.bp)(), C = (0, M.Z)(), S = (0, u.e7)([eh.Z], () => {
    var e;
    return (null != (e = null == C ? true : C.channelId) ? e : eh.Z.getVoiceChannelId()) === n.id
  }), {
    participants: P,
    ...
    return e && i !== eL.AEg.FULL_SCREEN && (i = eL.AEg.NO_CHAT), r === eL.AEg.HAVEN && (i = r), {
      mode: t,
      layout: i,
  ...
  }, [y, n.id]), z = (0, u.Wu)([eo.Z], () => eo.Z.getAllActiveStreams()), {
    selectedStream: K
  } = (0, u.cj)([eo.Z], () => ({
    selectedStream: null != V ? eo.Z.getActiveStreamForStreamKey(V.id) : null
  }), [V]), Y = (0, u.e7)([ed.Z], () => ed.Z.getGuild(n.getGuildId())), q = (0, u.e7)([ef.ZP], () => ef.ZP.getMentionCount(n.id), [n.id]), X = (0, u.e7)([es.default], () => es.default.getId()), {
    popoutWindow: Q,
  ...
  })), $ = (0, u.e7)([ep.Z], () => ep.Z.can(eL.Plq.CONNECT, n)), ee = (0, u.e7)([ec.Z], () => ec.Z.getToastsEnabled(n.id)), et = (0, u.e7)([D.default], () => D.default.getAwaitingRemoteSessionInfo()), en = (0, u.e7)([W.ZP], () => W.ZP.callHeaderHeight), er = i.useCallback(e => {
    v.ZP.updatedUnsyncedSettings({
      callHeaderHeight: e
    })
  }, []), ei = null != (t = null == Y ? true : Y.id) ? t : null, el = (0, I.Z)(ei, n.id), ea = (0, u.e7)([E.Z], () => E.Z.getFetchState(), []), eu = (0, x.Z)(ea);
  i.useEffect(() => {
    ea === E.O.ERROR && eu !== E.O.ERROR && (0, f.showToast)((0, f.createToast)(eU.intl.string(eU.t["AlJyI+"]), f.ToastType.FAILURE))
  }, [ea, eu]);
  ...
  i.useEffect(() => {
    let e = false,
      t = null;
    return (async () => {
      S && w === eL.WtW.VIDEO && (t = await ej.ZP.blockDisplaySleep(), e && null != t && ej.ZP.unblockDisplaySleep(t))
    })(), () => {
      null != t ? ej.ZP.unblockDisplaySleep(t) : e = true
    }
  }, [S, w]);
  let em = (0, eS.Z)(n, true),
    {
      ...
      children: (0, r.jsx)(e_.B2, {
        children: (0, r.jsxs)(ew._A, {
          children: [(0, r.jsx)(eW, {
            ...
            popoutType: s,
            canUseHaven: eE
          }), !n.isPrivate() && (0, r.jsx)(ew.YR, {}), (0, r.jsx)(e_.H_, {})]
        })
      })
    })
  })
