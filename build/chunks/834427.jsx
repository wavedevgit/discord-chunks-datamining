...
class c extends(r = Chunk73800.Component) {
  render() {
    ...
    return this.props.filters && (u = this.props.filters.map(e => e.extensions.map(e => ".".concat(e)).join(",")).join(",")), <input id={c} style={l(module)} className={require || s} disabled={module} type={"file"} tabIndex={exports} onMouseDown={this.handleBrowserInputMouseDown} onChange={this.props.onChange} onClick={this.props.onClick} multiple={this.props.multiple} accept={u} name={r} aria-label={Chunk73800} aria-hidden={a || true} ref={e => {
        this._input = e
