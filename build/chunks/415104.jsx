...
function _(e) {
  ...
  return <div id={"quest-tile-".concat(o.id)} ref={e => {
      v.current = e, B.current = e
    }} className={a()(j.container, u)} onMouseEnter={N} onMouseLeave={A} onFocus={N} onBlur={A}>{<f.Z quest={o} isHovering={y} errorHints={E} warningHints={T} isVisibleInViewport={k} sourceQuestContent={C} />}{<x.Z quest={o} questContent={d} isHovering={y} contentPosition={_} rowIndex={b} onReceiveErrorHints={S} isVisibleInViewport={k} sourceQuestContent={C} />}</div>
}

function b(e) {
  return <d.A questOrQuests={e.quest} questContent={e.questContent} questContentPosition={e.contentPosition} questContentRowIndex={e.rowIndex} trackGuildAndChannelMetadata={e.questContent === u.jn.QUESTS_EMBED} sourceQuestContent={e.sourceQuestContent}>{t => {
      var n, s;
