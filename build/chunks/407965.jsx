...
let _ = e => {
    ...
    return null == t ? null : <div className={x.previewContainer}><g.o userDiscountOffer={t} /></div>
  },
  j = () => {
    let {
      transitionState: e,
    ...
    if (j) return <Chunk82659.Modal transitionState={module} title={""} actions={[]} onClose={async () => {
        exports()
      }} />;
    let v = [];
    ...
    }), Chunk10508 && null !== Chunk515622 && v.reverse(), <Chunk82659.Modal transitionState={module} title={Chunk388032.intl.string(Chunk388032.t.PWq8TE)} subtitle={Chunk388032.intl.formatToPlainString(Chunk388032.t.nsGVzs, {})} actions={v} preview={null !== Chunk515622 && (0, Chunk255367.jsx)(_, {
        churnUserDiscountOffer: Chunk515622
      })} onClose={async () => exports()}><Chunk807163.g currentUser={E} premiumType={require} onClose={exports} isDowngrade={false} isPremiumRebrand={true} /></Chunk82659.Modal>
  }