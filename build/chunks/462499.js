...
function I(e) {
  ...
  let {
    ...
    onDelete: W,
    onIconUpload: z
  } = e, B = (0, d.Dt)(), [L, Z] = r.useState(null != (l = null == _ ? void 0 : _.title) ? l : ""), [S, y] = r.useState(null != (n = null == _ ? void 0 : _.description) ? n : ""), [G, R] = r.useState(function(e) {
  ...
  }, [G, L, z, S]), E = r.useCallback(() => null == X || null == G ? null : g.ZP.getResourceChannelIconURL({
    channelId: G.value,
    icon: X
  }), [G, X]);
