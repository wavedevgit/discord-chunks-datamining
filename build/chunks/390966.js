...
function N(e) {
  ...
  let A = Z;
  null != I && "" !== I && (A = v.NW.formatToPlainString(v.t.tXbu7O, {
    start: Z,
    end: I
  }));
  let R = l.useMemo(() => n === p.p1.CANCELED || (null == W ? void 0 : W.is_canceled) ? 5 : n === p.p1.ACTIVE ? 3 : p.$I.has(n) ? 4 : _ ? 2 : +!!C, [n, null == W ? void 0 : W.is_canceled, _, C]),
    z = function(e, t, n, l, a) {
      switch (e) {
        case 1:
          return a > 0 ? v.NW.formatToPlainString(v.t.PQlCWl, {
            minutes: a
          }) : v.NW.string(v.t.WINqKS);
        case 2:
          return v.NW.string(v.t.WINqKS);
        case 3:
          return null != l && "" !== l ? v.NW.format(v.t.vHYgJS, {
            start: n,
  ...
  if (null != P) {
    let e = (0, b.Ho)(P);
    M = v.NW.formatToPlainString(v.t.HmKEqa, {
      recurrenceRule: e.toText()
    });
    let n = s()(t);
    M = function(e, t) {
      let n = t.toDate(),
        r = n.toLocaleString(v.NW.currentLocale, {
          weekday: "long"
        });
      switch (e) {
        case m.z.WEEKLY:
          return v.NW.formatToPlainString(v.t.xQM9X1, {
            weekday: r
          });
        case m.z.BIWEEKLY:
          return v.NW.formatToPlainString(v.t.RYscaW, {
            weekday: r
          });
        case m.z.MONTHLY:
