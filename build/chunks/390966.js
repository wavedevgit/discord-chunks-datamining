...
function y(e) {
  ...
  let Z = (0, f.Z)(N, E),
    [{
      ...
      upcomingEvent: L,
      diffMinutes: k
    }, A] = l.useState((0, b.ub)(t, o));
  l.useEffect(() => {
    A((0, b.ub)(t, o));
    let e = setInterval(() => A((0, b.ub)(t, o)), 1e3);
    return () => {
      clearInterval(e)
    }
  }, [t, o]);
  let R = I;
  null != _ && "" !== _ && (R = v.intl.formatToPlainString(v.t.tXbu7O, {
    start: I,
    end: _
  }));
  ...
  return (0, r.jsxs)(h, {
    className: a()(c, {
      [O.isRecurring]: null != W
    }),
    tooltipText: M,
    children: [P && n === p.p1.SCHEDULED ? (0, r.jsx)(j, {}) : (0, r.jsx)(K, {
      color: X,
      size: "custom",
      width: 20,
      height: 20
