...
let h = a.memo(function(e) {
  let {
    ...
    audio: b
  } = (0, u.p)(), y = null != b, v = a.useRef(null), x = a.useRef(null), j = a.useRef(null), [N, w] = a.useState(0), [C, S] = a.useState(0), [O, P] = a.useState(0), [E, k] = a.useState(!1), [Z, M] = a.useState(!1), [I, _] = a.useState(!1), [D, R] = a.useState(0), [T, F] = a.useState(-1), W = a.useMemo(() => D / p.fineTuningScale, [p.fineTuningScale, D]);
  a.useEffect(() => {
    if (null == b) return;
  ...
  }, [p.fineTuningDelay, I, O, T, Z, C, E, N]), (0, l.jsxs)("div", {
