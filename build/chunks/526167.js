...
var r, i, o, a, s, l, Chunk525654 = require("./525654.js"),
...
let _ = "electron" === d.toLowerCase() ? parseInt(null != (o = u().version) ? o : "", 10) : false;

function m() {
  return _
}
let h = "firefox" === d.toLowerCase() ? parseInt(null != (a = u().version) ? a : "", 10) : false;
