...
let ea = [14, 14, 12, 12, 10, 8, 6],
  ...
  eg = e => {
    let {
      ...
      application: a,
      analyticsLocations: n
    }), o = (0, D.Nj)(u.z.CLOUD_PLAY_NEW_BADGE), c = (0, H.F)(r);
...
eE.Header = eb, eE.Body = e => {
...
}, eE.Separator = ed, eE.VoiceSection = e => {
  var t;
  let {
    guild: n,
    channel: r,
  ...
  return (0, i.jsxs)(eu, {
    children: [(0, i.jsxs)("div", {
      ...
      children: [null != t ? (0, i.jsx)("img", {
        ...
        children: [es(n), eo(ei.intl.formatToPlainString(ei.t.C4WXvc, {
  ...
  return null != c.assets || (0, O.Z)(c) || null != I ? (0, i.jsxs)(eu, {
    children: [(0, i.jsxs)("div", {
      className: s()(el.activitySection, {
        [el.activitySectionWithButtons]: b
      }),
      children: [null != h && 0 !== Object.keys(h).length ? (0, i.jsxs)("div", {
        ...
        }), null != h.small_image ? (0, i.jsx)("img", {
        ...
        children: [es(null != g && "" !== g ? g : c.name), null != m ? eo(m) : null, (() => {
          let {
            timestamps: e
          } = c;
          return null == e || !(0, v.Z)(c) || (0, y.Z)(c) ? null : eo((0, O.Z)(c) ? (0, i.jsx)(ec, {
            timestamps: e
          }) : (0, i.jsx)(G.ZP, {
            start: e.start,
            end: e.end,
  ...
  let {
    ...
    onPreviewClick: s,
    guildId: o
  } = e, u = (0, c.e7)([K.Z], () => K.Z.getChannel(a.channelId)), [d, p] = (0, k.wq)(u), h = (0, i.jsxs)(f.P3F, {
    onClick: d ? s : true,
