...
function d(e) {
  let {
    ...
    focused: p,
    canvas: m
  } = e, E = r.useRef(!1), g = (0, l.e7)([i.Z], () => i.Z.getDrawMode()), v = (0, u.Z)((0, s.Z)(t.id, n, d), f), h = (0, u.Z)((0, c.Z)(t.id, n, d), f), S = r.useCallback((e, t, n) => {
    if (null == m) return;
    let {
      x: r,
      y: l
