...
function d(e) {
  let {
    ...
    focused: m,
    canvas: p
  } = e, E = r.useRef(!1), g = (0, l.e7)([i.Z], () => i.Z.getDrawMode()), h = (0, o.Z)((0, s.Z)(t.id, n, d), f), S = (0, o.Z)((0, c.Z)(t.id, n, d), f), O = r.useCallback((e, t, n) => {
    if (null == p) return;
    let {
      x: r,
      y: l
