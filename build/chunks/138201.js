...
function d(e) {
  let {
    ...
    color: u,
    buttonText: m,
    buttonColor: p = l.zxk.Colors.PRIMARY,
    buttonSize: _ = l.zxk.Sizes.SMALL,
    buttonLook: g = l.zxk.Looks.FILLED,
    buttonDisabled: b,
    buttonIcon: x,
    buttonIconColor: h,
    buttonLoading: f,
  ...
  return (0, r.jsxs)("div", {
    className: o.row,
    children: ["numbered" === j && null != C ? (0, r.jsx)(l.X6q, {
