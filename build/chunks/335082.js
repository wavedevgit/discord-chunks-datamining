...
function T(e) {
  let {
    guildId: t
  } = e, n = (0, c.Q3)("GuildItem"), a = (0, l.e7)([g.Z], () => g.Z.getGuild(t)), m = (0, l.e7)([u.Z], () => u.Z.getMemberCount(t)), h = !d.SE.useSetting().includes(t), b = (0, o.dQu)(o.TVs.modules.guildbar.AVATAR_SIZE), T = (0, s.Ie)(null != t ? t : _.lds), N = r.useCallback(e => {
    let n = (0, f._o)();
...
function A(e) {
  ...
  } = e, r = d.G6.useSetting(), s = () => {
    (0, o.ZDy)(async () => {
      let {
        default: e
      } = await n.e("30649").then(n.bind(n, 95654));
      return n => (0, i.jsx)(e, v(S({}, n), {
        onScrollToGuildsSection: t
      }))
    })
