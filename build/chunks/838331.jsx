...
function P(e) {
  ...
  let U = n(w),
    ...
    Y = P ? d.Tv : d.lW;
  return <l.bG navigator={H}><l.SJ>{e => {
        var {
          ref: n,
          onKeyDown: i
...
D.Colors = S, D.Label = function(e) {
  ...
  return <span className={m.itemLabel}>{t}</span>
}, D.Icon = function(e) {
  let {
    children: t
  } = e;
  return <span className={m.itemCheckbox}>{t}</span>
  ...
  return <span className={m.itemCheckbox}><c.X displayOnly={true} value={null != t ? t : null != o && n.has(o)} type={c.X.Types.INVERTED} size={20} /></span>
}, D.Checkmark = function() {
  let {
    selected: e
  } = Chunk73800.useContext(R), t = Chunk73800.useContext(w);
  return module.has(exports) ? <span className={Chunk953408.itemCheckbox}><Chunk481060.owK size={"custom"} color={"currentColor"} width={20} height={20} /></span> : null
}