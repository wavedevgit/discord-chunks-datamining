...
let D = e => {
  ...
  M = e => {
    var {
      ...
      onMouseLeave: p,
      children: g
    } = e, m = R(e, ["selected", "locationState", "icon", "onClick", "collectibleShopTab", "onMouseEnter", "onMouseLeave", "children"]);
    let b = (0, l.JA)("shop"),
    ...
    return (0, r.jsxs)(r.Fragment, {
      children: [I && (0, r.jsx)(k, {}), (0, r.jsx)(u.Qj, L(w({
        selected: t,
        route: C,
        icon: null != a ? a : s.EOn,
  ...
  V = e => {
    ...
    return (0, r.jsx)(s.ua7, {
      ...
      children: e => (0, r.jsxs)(M, L(w(L(w({
        className: null != v.entryPointClassName ? (0, E.l)(Z, v.entryPointClassName) : void 0
      }, C), {
  ...
  H = e => {
    ...
    return (0, r.jsx)(_.Rg, L(w({
      targetElementRef: l,
      positionControlRef: o
    }, c), {
      children: (0, r.jsx)(M, L(w({}, n), {
        listItemRef: l,
  ...
  F = e => {
    var {
      displayOptions: t,
      dismissContent: n
    } = e, l = R(e, ["displayOptions", "dismissContent"]);
    let a = i.useRef(null),
      o = i.useRef(0);
    i.useLayoutEffect(() => {
      o.current += 1
  ...
  W = e => {
    ...
    } = (0, S.Z)(), u = (0, I.b)("Collectibles Shop Button"), d = {
      selected: t,
      locationState: i,
      onClick: () => {
        o || c(), null == n || n()
    ...
    if (o) return (0, r.jsx)(H, L(w({}, d), {
      listScrollerRef: a
    }));
    if (null != s) switch (s.type) {
      case T.k2.TOOLTIP:
        return (0, r.jsx)(B, L(w({}, d), {
          displayOptions: s
        }));
      case T.k2.COACHTIP:
        return (0, r.jsx)(V, L(w({}, d), {
          displayOptions: s
        }));
      case T.k2.BADGE:
        return (0, r.jsx)(U, w({}, d));
      case T.k2.COACHMARK:
        return (0, r.jsx)(F, L(w({
          dismissContent: c
        }, d), {
          displayOptions: s
        }))
    ...
    return (0, r.jsxs)(r.Fragment, {
      children: [u && (0, r.jsx)(z, {}), (0, r.jsx)(M, w({}, d))]
    })
  }