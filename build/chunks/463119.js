...
let L = e => {
  ...
  R = e => {
    var {
      ...
      onMouseLeave: d,
      children: p
    } = e, g = x(e, ["selected", "locationState", "icon", "onClick", "onMouseEnter", "onMouseLeave", "children"]);
    let m = (0, l.JA)("shop"),
    ...
    return (0, r.jsxs)(r.Fragment, {
      children: [O && (0, r.jsx)(w, {}), (0, r.jsx)(u.Qj, Z(A({
        selected: t,
  ...
  M = e => {
    ...
    return (0, r.jsx)(s.ua7, {
      ...
      children: e => (0, r.jsxs)(R, Z(A(Z(A({
        className: null != y.entryPointClassName ? (0, _.l)(j, y.entryPointClassName) : void 0
      }, I), {
  ...
  W = e => {
    ...
    } = (0, y.Z)(), a = (0, O.b)("Collectibles Shop Button"), s = {
      selected: t,
      locationState: i,
      onClick: n,
      listItemRef: l
    ...
    if (null != o) switch (o.type) {
      case C.k2.TOOLTIP:
        return (0, r.jsx)(U, Z(A({}, s), {
          displayOptions: o
        }));
      case C.k2.COACHTIP:
        return (0, r.jsx)(M, Z(A({}, s), {
          displayOptions: o
        }));
      case C.k2.BADGE:
