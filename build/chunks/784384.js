...
function I(e, t, n) {
  ...
  if (l && (0, d.Km)(n.type)) {
    if ((e.attachments.length > 0 || e.messageSnapshots.some(e => e.message.attachments.length > 0)) && !h.Z.can(b.Plq.ATTACH_FILES, n)) return {
    ...
    if (t.length > 0 && !h.Z.can(b.Plq.USE_EXTERNAL_STICKERS, n) && t.some(e => (function(e, t) {
        let n = c.Z.getStickerById(e.id);
        return null != n && !!(0, u.J8)(n) && (n.guild_id !== t.guild_id || void 0)
      })(e, n))) return {
      label: E.intl.string(E.t["0Yyrub"])
    };
    if ((e.hasFlag(b.iLy.IS_VOICE_MESSAGE) || e.messageSnapshots.some(e => e.message.hasFlag(b.iLy.IS_VOICE_MESSAGE))) && !h.Z.can(b.Plq.SEND_VOICE_MESSAGES, n)) return {
