...
function j() {
  ...
  return <Chunk481060.hjN title={Chunk388032.intl.string(Chunk388032.t.D0qeOz)} disabled={S}>{<Chunk481060.R94 type={Chunk481060.R94.Types.DESCRIPTION} className={Chunk301849.formDescription} disabled={S}>{Chunk388032.intl.format(Chunk388032.t.zuwel5, {
        premiumEmojiMaximum: N
      })}{<br />}{Chunk388032.intl.format(Chunk388032.t.sEkgBg, {
        handleTransitionToManageEmoji: y
      })}</Chunk481060.R94>}{<Chunk331146.E tierEmojiIds={j} guildId={exports} onRemoveEmoji={function(e) {
      ...
      }} />}{null != j && j.size > 0 ? <Chunk481060.LZC size={8} /> : null}{<Chunk861345.s onClick={function() {
      ...
      }} disabled={S}>{Chunk388032.intl.string(Chunk388032.t.ouOOV1)}</Chunk861345.s>}</Chunk481060.hjN>
}