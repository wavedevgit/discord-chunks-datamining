...
function V(e) {
  ...
  let {
    channel: _,
    isLoading: p
  } = e, [N, G] = i.useState(!1), B = (0, s.e7)([S.ZP], () => S.ZP.getCurrentEmbeddedActivity()), Z = (0, s.e7)([S.ZP], () => S.ZP.getActivityPanelMode()), F = (0, h.q)(null == B ? void 0 : B.applicationId), V = null == B ? void 0 : B.launchId, H = (0, s.e7)([v.Z], () => v.Z.getChannelId() === (null == _ ? void 0 : _.id)), {
    dockedRect: Y,
    isHidden: W
  } = (0, s.cj)([O.Z], () => {
    let e = O.Z.pipWindow;
  ...
  })), X = H || null != K, Q = (0, w.Z)(null == _ ? void 0 : _.id), J = Q && (null == q ? void 0 : q.type) !== k.fO.ACTIVITY, ee = !Q && Z === L.Ez.PIP, et = X && (J || ee) && null == Y, en = (!X || et) && !W, er = en && null != O.Z.pipVideoWindow && null != O.Z.pipActivityWindow;
  ...
  function eo(e) {
    ...
    return en && null != B && ((null == z ? void 0 : z.type) === k.fO.ACTIVITY || o) ? (null == (t = B.config) ? void 0 : t.useInteractivePIP) ? (0, r.jsx)(P.of, {
      onJumpToChannel: ei,
      applicationId: B.applicationId,
      channel: _,
      showControls: !a,
  ...
  if (i.useEffect(() => {
    ...
    }, [null == B ? void 0 : B.applicationId, en]), null == B || null == V || (0, w.Z)(null == _ ? void 0 : _.id) && null == z || null == F) return null;
  ...
  return (null == _ ? void 0 : _.guild_id) != null && (null == _ ? void 0 : _.guild_id) !== "" && (el.guild_id = _.guild_id), (null == _ ? void 0 : _.id) != null && (null == _ ? void 0 : _.id) !== "" && (el.channel_id = _.id), (0, r.jsx)(y.ZP, {
    timeout: 2e3,
    children: e => {
      var t, n;
      let {
