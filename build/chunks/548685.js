...
let j = e => {
  ...
  let {
    ...
    hasSorting: P,
    tab: L
  } = e, I = (0, o.e7)([d.default], () => d.default.getCurrentUser()), k = b.ZP.canUseCollectibles(I), {
    sortType: N,
    setSortType: A,
    sortedItems: w,
    sortOptions: B,
    ...
    animationPhase: W,
    startAnimation: V
  } = (0, O.y)(), U = (0, h.sp)(), z = null != (t = null == U ? void 0 : U.sessionId) ? t : "", G = l.useRef(null), q = l.useCallback(e => {
    V({
      isShuffling: !1,
      onOutroComplete: () => A(e)
  ...
  return null == I ? null : (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: n ? (0, r.jsx)(r.Fragment, {
        ...
        if (H)
          if (W === O.g.SHUFFLE_OUT) return (0, r.jsx)("div", {
            className: x.shuffleOutro
          }, "".concat(e.skuId, "-").concat(t));
          else W === O.g.SORT_OUT ? n = x.sortChangedOutro : W === O.g.SHUFFLE_IN ? n = x.shuffleIntro : W === O.g.SORT_IN && (n = x.sortChangedIntro);
        return (0, r.jsx)(h.k0, {
          newValue: {
            tilePosition: t,
