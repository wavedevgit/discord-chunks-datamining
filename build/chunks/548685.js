...
let j = e => {
  let {
    ...
    numVisibleItems: j,
    tab: y
  } = e, S = (0, i.e7)([c.default], () => c.default.getCurrentUser()), k = d.ZP.canUseCollectibles(S), P = (0, f.s)("useShopHomeSorting") && y === C.AW.HOME, {
    sortType: E,
    setSortType: w,
    sortedItems: B,
    sortOptions: T,
    shuffleProducts: I,
    showRecommendationOption: L
  } = (0, g.N)(n, k), N = (0, _.St)(B);
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(o.X6q, {
          ...
          text: O.intl.format(O.t.cl8gS0, {
            helpdeskArticle: u.Z.getArticleURL(v.BhN.DATA_USED_FOR_RECOMMENDED)
          }),
          position: "top",
          "aria-label": O.intl.formatToPlainString(O.t.cl8gS0, {
            helpdeskArticle: u.Z.getArticleURL(v.BhN.DATA_USED_FOR_RECOMMENDED)
          }),
          children: e => {
            var t, n;
