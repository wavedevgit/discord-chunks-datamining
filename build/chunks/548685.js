...
let P = e => {
  ...
  let {
    ...
    numVisibleItems: T,
    tab: I
  } = e, L = (0, o.e7)([d.default], () => d.default.getCurrentUser()), B = g.ZP.canUseCollectibles(L), N = (0, _.s)("useShopHomeSorting") && I === S.AW.HOME, {
    sortType: A,
    setSortType: w,
    sortedItems: Z,
    sortOptions: R,
  ...
  } = (0, C.N)(a, B), H = (0, x.St)(Z), M = (0, o.e7)([u.Z], () => u.Z.useReducedMotion), W = (0, o.e7)([p.Z], () => p.Z.isFocused()), V = !M && W, {
    animationPhase: U,
    startAnimation: G
  } = (0, E.y)(), z = (0, h.sp)(), q = null != (t = null == z ? void 0 : z.sessionId) ? t : "", Y = l.useRef(null), K = l.useCallback(e => {
    G({
      isShuffling: !1,
      onOutroComplete: () => w(e)
  ...
  return null == L ? null : (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: n ? (0, r.jsx)(r.Fragment, {
        ...
        if (V)
          if (U === E.g.SHUFFLE_OUT) return (0, r.jsx)("div", {
