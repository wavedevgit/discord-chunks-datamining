...
let j = e => {
  ...
  let {
    ...
    hasSorting: P,
    tab: L
  } = e, k = (0, o.e7)([d.default], () => d.default.getCurrentUser()), I = h.ZP.canUseCollectibles(k), {
    sortType: N,
    setSortType: A,
    sortedItems: B,
    sortOptions: w,
  ...
  } = (0, _.N)(j, I), D = (0, E.St)(B), F = (0, o.e7)([u.Z], () => u.Z.useReducedMotion), M = (0, o.e7)([p.Z], () => p.Z.isFocused()), H = !F && M, {
    animationPhase: W,
    startAnimation: V
  } = (0, v.y)(), U = (0, b.sp)(), z = null != (t = null == U ? void 0 : U.sessionId) ? t : "", G = l.useRef(null), q = l.useCallback(e => {
    V({
      isShuffling: !1,
      onOutroComplete: () => A(e)
  ...
  return null == k ? null : (0, n.jsxs)("div", {
    ...
    children: [(0, n.jsxs)("div", {
      ...
      children: r ? (0, n.jsx)(n.Fragment, {
        ...
        if (H)
          if (W === v.g.SHUFFLE_OUT) return (0, n.jsx)("div", {
