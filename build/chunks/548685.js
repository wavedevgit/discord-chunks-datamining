...
let P = e => {
  ...
  let {
    ...
    numVisibleItems: L,
    tab: k
  } = e, I = (0, o.e7)([d.default], () => d.default.getCurrentUser()), N = h.ZP.canUseCollectibles(I), B = (0, _.s)("useShopHomeSorting") && k === x.AW.HOME, {
    sortType: A,
    setSortType: w,
    sortedItems: R,
    sortOptions: Z,
  ...
  } = (0, C.N)(i, N), M = (0, S.St)(R), H = (0, o.e7)([u.Z], () => u.Z.useReducedMotion), W = (0, o.e7)([p.Z], () => p.Z.isFocused()), V = !H && W, {
    animationPhase: U,
    startAnimation: G
