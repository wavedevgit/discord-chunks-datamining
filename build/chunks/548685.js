...
let P = e => {
  ...
  let {
    ...
    numVisibleItems: L,
    tab: I
  } = e, k = (0, a.e7)([d.default], () => d.default.getCurrentUser()), N = h.ZP.canUseCollectibles(k), B = (0, _.s)("useShopHomeSorting") && I === x.AW.HOME, {
    sortType: A,
    setSortType: R,
    sortedItems: w,
    sortOptions: Z,
  ...
  } = (0, C.N)(o, N), M = (0, S.St)(w), H = (0, a.e7)([u.Z], () => u.Z.useReducedMotion), W = (0, a.e7)([p.Z], () => p.Z.isFocused()), V = !H && W, {
    animationPhase: U,
    startAnimation: G
  ...
  return null == k ? null : (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: n ? (0, r.jsx)(r.Fragment, {
        ...
        if (V)
          if (U === v.g.SHUFFLE_OUT) return (0, r.jsx)("div", {
            className: j.shuffleOutro
