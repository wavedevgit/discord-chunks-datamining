...
let j = e => {
  ...
  let {
    ...
    hasSorting: P,
    tab: L
  } = e, k = (0, o.e7)([d.default], () => d.default.getCurrentUser()), I = b.ZP.canUseCollectibles(k), {
    sortType: N,
    setSortType: A,
    sortedItems: w,
    sortOptions: B,
  ...
  } = (0, _.N)(j, I), D = (0, E.St)(w), F = (0, o.e7)([u.Z], () => u.Z.useReducedMotion), M = (0, o.e7)([p.Z], () => p.Z.isFocused()), H = !F && M, {
    animationPhase: W,
    startAnimation: V
