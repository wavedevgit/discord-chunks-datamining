...
let k = e => {
  ...
  let {
    ...
    numVisibleItems: T,
    tab: I
  } = e, L = (0, o.e7)([d.default], () => d.default.getCurrentUser()), B = g.ZP.canUseCollectibles(L), w = (0, _.s)("useShopHomeSorting") && I === E.AW.HOME, {
    sortType: N,
    setSortType: A,
    sortedItems: R,
    sortOptions: Z,
        ...
        children: [w && (0, r.jsxs)(r.Fragment, {
          ...
          onClick: () => {
            G({
              ...
              onOutroComplete: F,
              returnRef: Y
            }), b.default.track(j.rMx.COLLECTIBLES_SHOP_FEED_SHUFFLE_CLICKED, {
              page_session_id: q
            })
          },
