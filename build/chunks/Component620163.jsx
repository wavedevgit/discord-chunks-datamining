...
let eU = () => [Chunk704215.z.CLIENT_THEMES_SETTINGS_BADGE, Chunk704215.z.DEKSTOP_CUSTOM_APP_ICON_BADGE, Chunk704215.z.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE],
  ...
  eY = e => {
    let {
      ...
      isClipsBetaTagShowing: eW = false,
    ...
    return Object.freeze({
      ...
      [eN.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eN.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === Y.ZP.releaseChannel || "development" === Y.ZP.releaseChannel) && ez && G.Z.supports(ew.AN.CONNECTION_REPLAY)
      },
