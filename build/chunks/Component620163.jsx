...
let eU = () => [Chunk704215.z.CLIENT_THEMES_SETTINGS_BADGE, Chunk704215.z.DEKSTOP_CUSTOM_APP_ICON_BADGE, Chunk704215.z.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE],
  ...
  eY = e => {
    let {
      ...
      isClipsBetaTagShowing: eM = false,
    ...
    return Object.freeze({
      ...
      [eT.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE]: {
        ...
        parent: eT.s6.VOICE_AND_VIDEO_VIDEO_STREAMING,
        predicate: () => M.Z.supportsVideoHook() || M.Z.supportsExperimentalSoundshare() || M.Z.supportsSystemScreensharePicker() && (0, B.isMac)()
      },
      ...
      [eT.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eT.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === F.ZP.releaseChannel || "development" === F.ZP.releaseChannel) && eW && M.Z.supports(eN.AN.CONNECTION_REPLAY)
      },
      [eT.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eC.oAB.VOICE,
        searchableTitles: [eP.intl.string(eP.t["726JHL"])],
        parent: eT.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => B.isPlatformEmbedded && M.Z.supports(eN.AN.DEBUG_LOGGING) && null != p.Z.fileManager.readLogFiles
      },
      ...
      [eT.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          U.default.track(eC.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, Z.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
      ...
      [eT.s6.LOGOUT]: {
        section: "logout",
        onClick: () => {
          (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, ek(ej({
