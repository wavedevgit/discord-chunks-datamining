...
let eZ = () => {
    let e = [Chunk704215.z.CLIENT_THEMES_SETTINGS_BADGE, Chunk704215.z.DEKSTOP_CUSTOM_APP_ICON_BADGE, Chunk704215.z.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE];
    return Chunk368763.n.getConfig({
  ...
  eW = e => {
    let {
      ...
      isClipsBetaTagShowing: ek = false,
    ...
    return Object.freeze({
      ...
      [eR.s6.ACCOUNT_AGE_GROUP]: {
        searchableTitles: [eL.intl.string(eL.t["/52UYy"]), eL.intl.string(eL.t.sK0dmH), eL.intl.string(eL.t.XxRj7f), eL.intl.string(eL.t.yNGjyK), eL.intl.string(eL.t.KPGVWl)],
        section: eD.oAB.ACCOUNT,
        parent: eR.s6.ACCOUNT_PROFILE,
        predicate: () => e8
      },
      ...
      [eR.s6.PRIVACY_SENSITIVE_MEDIA_V2]: {
        section: eD.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eL.intl.string(eL.t.uEz8JF), eL.intl.string(eL.t["N/oRI+"]), eL.intl.string(eL.t.QVdYsK), eL.intl.string(eL.t["aWD+tu"]), eL.intl.string(eL.t["5mnTa7"])],
        parent: eR.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eR.s6.SENSITIVE_CONTENT_FILTERS]: {
        section: eD.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eL.intl.string(eL.t["Hj/But"]), eL.intl.string(eL.t["N/oRI+"]), eL.intl.string(eL.t.QVdYsK), eL.intl.string(eL.t["aWD+tu"]), eL.intl.string(eL.t["5mnTa7"]), eL.intl.string(eL.t["K0OWP+"])],
        parent: eR.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eR.s6.SEXUALLY_EXPLICIT_MEDIA_REDACTION]: {
        section: eD.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eL.intl.string(eL.t["Hj/But"]), eL.intl.string(eL.t["N/oRI+"]), eL.intl.string(eL.t.QVdYsK), eL.intl.string(eL.t["aWD+tu"]), eL.intl.string(eL.t["5mnTa7"])],
        parent: eR.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eR.s6.GORE_MEDIA_REDACTION]: {
        section: eD.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eL.intl.string(eL.t["Hj/But"]), eL.intl.string(eL.t["N/oRI+"]), eL.intl.string(eL.t.QVdYsK), eL.intl.string(eL.t["aWD+tu"]), eL.intl.string(eL.t["K0OWP+"])],
        parent: eR.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      ...
      [eR.s6.PRIVACY_DIRECT_MESSAGE_SPAM_FILTER_V2]: {
        section: eD.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eL.intl.string(eL.t.JzaP4h), eL.intl.string(eL.t.H9XOl3), eL.intl.string(eL.t.k4W40P)],
        parent: eR.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      ...
      [eR.s6.THIRD_PARTY_ACCESS]: {
        section: eD.oAB.CONNECTIONS,
        searchableTitles: [eL.intl.string(eL.t["Ig/XFa"]), eL.intl.string(eL.t["3fe7U5"]), eL.intl.string(eL.t["f6kk+r"])],
      ...
      [eR.s6.APPEARANCE_TIMESTAMP_HOUR_CYCLE]: {
        section: eD.oAB.APPEARANCE,
        searchableTitles: [eL.intl.string(eL.t.dyamEI), eL.intl.string(eL.t.p8NOwi), eL.intl.string(eL.t["+o/sOo"])],
        parent: eR.s6.APPEARANCE,
      ...
      [eR.s6.VOICE_AND_VIDEO_DEVICES]: {
        section: eD.oAB.VOICE,
        searchableTitles: [eL.intl.string(eL.t.hHMYbb), eL.intl.string(eL.t.dl18zb), eL.intl.string(eL.t.nuFtHH), eL.intl.string(eL.t["3182VD"]), eL.intl.string(eL.t["DGq/PR"])],
        parent: eR.s6.VOICE_AND_VIDEO_VOICE
      },
      [eR.s6.VOICE_AND_VIDEO_VOLUME_CONTROLS]: {
        section: eD.oAB.VOICE,
        searchableTitles: [eL.intl.string(eL.t.OX2Bnr), eL.intl.string(eL.t.eATD2B), eL.intl.string(eL.t.nuFtHH), eL.intl.string(eL.t["3182VD"]), eL.intl.string(eL.t["DGq/PR"])],
        parent: eR.s6.VOICE_AND_VIDEO_VOICE
      },
      ...
      [eR.s6.VOICE_AND_VIDEO_INPUT_PROFILE]: {
        section: eD.oAB.VOICE,
        searchableTitles: [eL.intl.string(eL.t.LM3U3k), eL.intl.string(eL.t.nuFtHH), eL.intl.string(eL.t.VZPR0R), eL.intl.string(eL.t.cjPbpT)],
        parent: eR.s6.VOICE_AND_VIDEO_VOICE,
        predicate: () => {
          let {
      ...
      [eR.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE]: {
        section: eD.oAB.VOICE,
        searchableTitles: [eL.intl.string(eL.t.KDdjou), eL.intl.string(eL.t.NMCIf9), eL.intl.string(eL.t.FeUKeA)],
        parent: eR.s6.VOICE_AND_VIDEO_VIDEO_STREAMING,
        predicate: () => G.Z.supportsVideoHook() || G.Z.supportsExperimentalSoundshare() || G.Z.supportsSystemScreensharePicker() && (0, H.isMac)()
      },
      ...
      [eR.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eR.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === Y.ZP.releaseChannel || "development" === Y.ZP.releaseChannel) && eK && G.Z.supports(ew.AN.CONNECTION_REPLAY)
      },
      [eR.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eD.oAB.VOICE,
        searchableTitles: [eL.intl.string(eL.t["726JHL"])],
        parent: eR.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => H.isPlatformEmbedded && G.Z.supports(ew.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eR.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          Z.default.track(eD.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, V.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
      ...
      [eR.s6.LOGOUT]: {
        section: "logout",
        onClick: () => {
          (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, eB(eU({
