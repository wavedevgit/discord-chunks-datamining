...
var Chunk54381 = require("./54381.js"),
  ...
  Chunk725095 = require("./725095.js"),
  Chunk18438 = require("./18438.js"),
  Chunk778825 = require("./778825.js"),
  Chunk40620 = require("./40620.js"),
  Chunk288047 = require("./288047.js"),
  Chunk925734 = require("./925734.js"),
  Chunk125675 = require("./125675.js"),
...
let eZ = () => [Chunk704215.z.CLIENT_THEMES_SETTINGS_BADGE, Chunk704215.z.DEKSTOP_CUSTOM_APP_ICON_BADGE, Chunk704215.z.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE],
  ...
  eK = e => {
    let {
      ...
      isClipsBetaTagShowing: ez = false,
    ...
    return Object.freeze({
      ...
      [eR.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE]: {
        ...
        parent: eR.s6.VOICE_AND_VIDEO_VIDEO_STREAMING,
        predicate: () => F.Z.supportsVideoHook() || F.Z.supportsExperimentalSoundshare() || F.Z.supportsSystemScreensharePicker() && (0, W.isMac)()
      },
      ...
      [eR.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eR.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === K.ZP.releaseChannel || "development" === K.ZP.releaseChannel) && eQ && F.Z.supports(ex.AN.CONNECTION_REPLAY)
      },
      [eR.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eD.oAB.VOICE,
        searchableTitles: [eL.intl.string(eL.t["726JHL"])],
        parent: eR.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => W.isPlatformEmbedded && F.Z.supports(ex.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eR.s6.LANGUAGE]: {
        ...
        searchableTitles: [eL.intl.string(eL.t.IHMsPn), eL.intl.string(eL.t.dyamEI), eL.intl.string(eL.t.p8NOwi), eL.intl.string(eL.t["+o/sOo"])],
      ...
      [eR.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          V.default.track(eD.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, Y.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
