...
let eG = () => [a.z.CLIENT_THEMES_SETTINGS_BADGE, a.z.DEKSTOP_CUSTOM_APP_ICON_BADGE, a.z.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE],
  eZ = () => {
    let e = eG(),
      [t] = (0, O.US)(e);
  ...
  eW = e => {
    ...
    return Object.freeze({
      ...
      [eP.s6.ACCOUNT_AGE_GROUP]: {
        searchableTitles: [ex.intl.string(ex.t["/52UYy"]), ex.intl.string(ex.t.sK0dmH), ex.intl.string(ex.t.XxRj7f), ex.intl.string(ex.t.yNGjyK), ex.intl.string(ex.t.KPGVWl)],
        section: eR.oAB.ACCOUNT,
        parent: eP.s6.ACCOUNT_PROFILE,
        predicate: () => e9
      },
      ...
      [eP.s6.PRIVACY_SENSITIVE_MEDIA_V2]: {
        section: eR.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [ex.intl.string(ex.t.uEz8JF), ex.intl.string(ex.t["N/oRI+"]), ex.intl.string(ex.t.QVdYsK), ex.intl.string(ex.t["aWD+tu"]), ex.intl.string(ex.t["5mnTa7"])],
        parent: eP.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eP.s6.SENSITIVE_CONTENT_FILTERS]: {
        section: eR.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [ex.intl.string(ex.t["Hj/But"]), ex.intl.string(ex.t["N/oRI+"]), ex.intl.string(ex.t.QVdYsK), ex.intl.string(ex.t["aWD+tu"]), ex.intl.string(ex.t["5mnTa7"]), ex.intl.string(ex.t["K0OWP+"])],
        parent: eP.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eP.s6.SEXUALLY_EXPLICIT_MEDIA_REDACTION]: {
        section: eR.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [ex.intl.string(ex.t["Hj/But"]), ex.intl.string(ex.t["N/oRI+"]), ex.intl.string(ex.t.QVdYsK), ex.intl.string(ex.t["aWD+tu"]), ex.intl.string(ex.t["5mnTa7"])],
        parent: eP.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      ...
      [eP.s6.THIRD_PARTY_ACCESS]: {
        section: eR.oAB.CONNECTIONS,
        searchableTitles: [ex.intl.string(ex.t["Ig/XFa"]), ex.intl.string(ex.t["3fe7U5"]), ex.intl.string(ex.t["f6kk+r"])],
      ...
      [eP.s6.VOICE_AND_VIDEO_DEVICES]: {
        section: eR.oAB.VOICE,
        searchableTitles: [ex.intl.string(ex.t.hHMYbb), ex.intl.string(ex.t.dl18zb), ex.intl.string(ex.t.nuFtHH), ex.intl.string(ex.t["3182VD"]), ex.intl.string(ex.t["DGq/PR"])],
        parent: eP.s6.VOICE_AND_VIDEO_VOICE
      },
      [eP.s6.VOICE_AND_VIDEO_VOLUME_CONTROLS]: {
        section: eR.oAB.VOICE,
        searchableTitles: [ex.intl.string(ex.t.OX2Bnr), ex.intl.string(ex.t.eATD2B), ex.intl.string(ex.t.nuFtHH), ex.intl.string(ex.t["3182VD"]), ex.intl.string(ex.t["DGq/PR"])],
        parent: eP.s6.VOICE_AND_VIDEO_VOICE
      },
      ...
      [eP.s6.VOICE_AND_VIDEO_INPUT_PROFILE]: {
        section: eR.oAB.VOICE,
        searchableTitles: [ex.intl.string(ex.t.LM3U3k), ex.intl.string(ex.t.nuFtHH), ex.intl.string(ex.t.VZPR0R), ex.intl.string(ex.t.cjPbpT)],
        parent: eP.s6.VOICE_AND_VIDEO_VOICE,
        predicate: () => {
          let {
      ...
      [eP.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE]: {
        section: eR.oAB.VOICE,
        searchableTitles: [ex.intl.string(ex.t.KDdjou), ex.intl.string(ex.t.NMCIf9), ex.intl.string(ex.t.FeUKeA)],
        parent: eP.s6.VOICE_AND_VIDEO_VIDEO_STREAMING,
        predicate: () => Z.Z.supportsVideoHook() || Z.Z.supportsExperimentalSoundshare() || Z.Z.supportsSystemScreensharePicker() && (0, Y.isMac)()
      },
      ...
      [eP.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eP.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === W.ZP.releaseChannel || "development" === W.ZP.releaseChannel) && eQ && Z.Z.supports(eD.AN.CONNECTION_REPLAY)
      },
      [eP.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eR.oAB.VOICE,
        searchableTitles: [ex.intl.string(ex.t["726JHL"])],
        parent: eP.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => Y.isPlatformEmbedded && Z.Z.supports(eD.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eP.s6.LANGUAGE]: {
        ...
        searchableTitles: [ex.intl.string(ex.t.IHMsPn), ex.intl.string(ex.t.dyamEI), ex.intl.string(ex.t.p8NOwi), ex.intl.string(ex.t["+o/sOo"])],
      ...
      [eP.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          B.default.track(eR.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, H.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
