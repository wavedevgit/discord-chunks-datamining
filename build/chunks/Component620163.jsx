  ...
  eW = e => {
    ...
    return Object.freeze({
      ...
      [eR.s6.ACCOUNT_AGE_GROUP]: {
        searchableTitles: [eL.intl.string(eL.t["/52UY2"]), eL.intl.string(eL.t.sK0dmJ), eL.intl.string(eL.t.XxRj7e), eL.intl.string(eL.t.yNGjyM), eL.intl.string(eL.t.KPGVWl)],
        section: ew.oAB.ACCOUNT,
        parent: eR.s6.ACCOUNT_PROFILE,
        predicate: () => e8
      },
      ...
      [eR.s6.SENSITIVE_CONTENT_FILTERS]: {
        section: ew.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eL.intl.string(eL.t["Hj/Bur"]), eL.intl.string(eL.t["N/oRIy"]), eL.intl.string(eL.t.QVdYsL), eL.intl.string(eL.t["aWD+tr"]), eL.intl.string(eL.t["5mnTa2"]), eL.intl.string(eL.t.K0OWPz)],
        parent: eR.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eR.s6.SEXUALLY_EXPLICIT_MEDIA_REDACTION]: {
        section: ew.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eL.intl.string(eL.t["Hj/Bur"]), eL.intl.string(eL.t["N/oRIy"]), eL.intl.string(eL.t.QVdYsL), eL.intl.string(eL.t["aWD+tr"]), eL.intl.string(eL.t["5mnTa2"])],
        parent: eR.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eR.s6.GORE_MEDIA_REDACTION]: {
        section: ew.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eL.intl.string(eL.t["Hj/Bur"]), eL.intl.string(eL.t["N/oRIy"]), eL.intl.string(eL.t.QVdYsL), eL.intl.string(eL.t["aWD+tr"]), eL.intl.string(eL.t.K0OWPz)],
        parent: eR.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      ...
      [eR.s6.THIRD_PARTY_ACCESS]: {
        section: ew.oAB.CONNECTIONS,
        searchableTitles: [eL.intl.string(eL.t["Ig/XFR"]), eL.intl.string(eL.t["3fe7U1"]), eL.intl.string(eL.t["f6kk+v"])],
      ...
      [eR.s6.VOICE_AND_VIDEO_INPUT_PROFILE]: {
        section: ew.oAB.VOICE,
        searchableTitles: [eL.intl.string(eL.t.LM3U3t), eL.intl.string(eL.t.nuFtHB), eL.intl.string(eL.t.VZPR0d), eL.intl.string(eL.t.cjPbpa)],
        parent: eR.s6.VOICE_AND_VIDEO_VOICE,
        predicate: () => {
          let {
      ...
      [eR.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE]: {
        section: ew.oAB.VOICE,
        searchableTitles: [eL.intl.string(eL.t.KDdjoq), eL.intl.string(eL.t.NMCIf3), eL.intl.string(eL.t.FeUKeH)],
        parent: eR.s6.VOICE_AND_VIDEO_VIDEO_STREAMING,
      ...
      [eR.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eR.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === Y.ZP.releaseChannel || "development" === Y.ZP.releaseChannel) && eW && G.Z.supports(eD.AN.CONNECTION_REPLAY)
      },
      [eR.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: ew.oAB.VOICE,
        searchableTitles: [eL.intl.string(eL.t["726JHB"])],
        parent: eR.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => H.isPlatformEmbedded && G.Z.supports(eD.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eR.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          Z.default.track(ew.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, V.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
