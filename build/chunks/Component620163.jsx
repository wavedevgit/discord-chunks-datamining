  ...
  e5 = e => {
    ...
    return Object.freeze({
      ...
      [eF.s6.APPEARANCE_TIMESTAMP_HOUR_CYCLE]: {
        ...
        parent: eF.s6.APPEARANCE,
        predicate: () => U.Z.getCurrentConfig({
          location: "SettingsRendererConfig"
        }, {
      ...
      [eF.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE]: {
        ...
        parent: eF.s6.VOICE_AND_VIDEO_VIDEO_STREAMING,
        predicate: () => V.Z.supportsVideoHook() || V.Z.supportsExperimentalSoundshare() || V.Z.supportsSystemScreensharePicker() && (0, z.isMac)()
      },
      ...
      [eF.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eF.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === q.ZP.releaseChannel || "development" === q.ZP.releaseChannel) && e5 && V.Z.supports(eW.AN.CONNECTION_REPLAY)
      },
      [eF.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eH.oAB.VOICE,
        searchableTitles: [eK.intl.string(eK.t["726JHB"])],
        parent: eF.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => z.isPlatformEmbedded && V.Z.supports(eW.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eF.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          Y.default.track(eH.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, K.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
      ...
      [eF.s6.QUEST_PREVIEW_TOOL_2]: {
        ...
        predicate: () => (0, L.T)({
          location: eY.dr.QUEST_PREVIEW_TOOL_2
        })
      },
      ...
      [eF.s6.LOGOUT]: {
        section: "logout",
        onClick: () => {
          (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, e0(eJ({
