  ...
  e7 = e => {
    ...
    return Object.freeze({
      ...
      [eH.s6.APPEARANCE_TIMESTAMP_HOUR_CYCLE]: {
        ...
        parent: eH.s6.APPEARANCE,
        predicate: () => Z.Z.getCurrentConfig({
          location: "SettingsRendererConfig"
        }, {
      ...
      [eH.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eH.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === J.ZP.releaseChannel || "development" === J.ZP.releaseChannel) && e9 && W.Z.supports(ez.AN.CONNECTION_REPLAY)
      },
      ...
      [eH.s6.QUEST_PREVIEW_TOOL_2]: {
        ...
        element: B.Z,
        predicate: () => (0, k.T)({
          location: eK.dr.QUEST_PREVIEW_TOOL_2
        })
      },
