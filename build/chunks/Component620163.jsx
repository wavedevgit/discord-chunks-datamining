/** Chunk was on web.js **/
/** chunk id: 620163, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  $Z: () => eJ,
  OF: () => e0,
...
var Chunk990547 = require("./990547.js"),
  ...
  Chunk994714 = require("./994714.jsx"),
  ...
  Chunk277329 = require("./277329.jsx"),
  Chunk273927 = require("./273927.jsx"),
  Chunk604224 = require("./604224.jsx"),
  Chunk43434 = require("./43434.jsx"),
  Chunk333576 = require("./333576.jsx"),
...
let eJ = () => {
    ...
    }).enabled && module.push(Chunk704215.z.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE), Chunk368763.n.getConfig({
      location: "getAppearanceDCs"
    }).enabled && module.push(Chunk704215.z.HALLOWEEN_APP_ICONS_APPEARANCE_SETTINGS_WEB_BADGE), module
  },
  e$ = () => {
    let e = eJ(),
  ...
  e3 = e => {
    ...
    return Object.freeze({
      ...
      [eG.s6.ACCOUNT_AGE_GROUP]: {
        searchableTitles: [eH.intl.string(eH.t["/52UY2"]), eH.intl.string(eH.t.sK0dmJ), eH.intl.string(eH.t.XxRj7e), eH.intl.string(eH.t.yNGjyM), eH.intl.string(eH.t.KPGVWl)],
        section: eZ.oAB.ACCOUNT,
        parent: eG.s6.ACCOUNT_PROFILE,
        predicate: () => ts
      },
      ...
      [eG.s6.PRIVACY_SENSITIVE_MEDIA_V2]: {
        section: eZ.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eH.intl.string(eH.t.uEz8JC), eH.intl.string(eH.t["N/oRIy"]), eH.intl.string(eH.t.QVdYsL), eH.intl.string(eH.t["aWD+tr"]), eH.intl.string(eH.t["5mnTa2"])],
        parent: eG.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eG.s6.SENSITIVE_CONTENT_FILTERS]: {
        section: eZ.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eH.intl.string(eH.t["Hj/Bur"]), eH.intl.string(eH.t["N/oRIy"]), eH.intl.string(eH.t.QVdYsL), eH.intl.string(eH.t["aWD+tr"]), eH.intl.string(eH.t["5mnTa2"]), eH.intl.string(eH.t.K0OWPz)],
        parent: eG.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eG.s6.SEXUALLY_EXPLICIT_MEDIA_REDACTION]: {
        section: eZ.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eH.intl.string(eH.t["Hj/Bur"]), eH.intl.string(eH.t["N/oRIy"]), eH.intl.string(eH.t.QVdYsL), eH.intl.string(eH.t["aWD+tr"]), eH.intl.string(eH.t["5mnTa2"])],
        parent: eG.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eG.s6.GORE_MEDIA_REDACTION]: {
        section: eZ.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eH.intl.string(eH.t["Hj/Bur"]), eH.intl.string(eH.t["N/oRIy"]), eH.intl.string(eH.t.QVdYsL), eH.intl.string(eH.t["aWD+tr"]), eH.intl.string(eH.t.K0OWPz)],
        parent: eG.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eG.s6.PRIVACY_DIRECT_MESSAGE_SPAM_FILTER_V2]: {
        section: eZ.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eH.intl.string(eH.t.JzaP4u), eH.intl.string(eH.t.H9XOl5), eH.intl.string(eH.t.k4W40N)],
        parent: eG.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      ...
      [eG.s6.THIRD_PARTY_ACCESS]: {
        section: eZ.oAB.CONNECTIONS,
        searchableTitles: [eH.intl.string(eH.t["Ig/XFR"]), eH.intl.string(eH.t["3fe7U1"]), eH.intl.string(eH.t["f6kk+v"])],
      ...
      [eG.s6.APPEARANCE_TIMESTAMP_HOUR_CYCLE]: {
        section: eZ.oAB.APPEARANCE,
        searchableTitles: [eH.intl.string(eH.t.dyamEB), eH.intl.string(eH.t.p8NOws), eH.intl.string(eH.t["+o/sOj"])],
        parent: eG.s6.APPEARANCE,
      ...
      [eG.s6.VOICE_AND_VIDEO_DEVICES]: {
        section: eZ.oAB.VOICE,
        searchableTitles: [eH.intl.string(eH.t.hHMYbW), eH.intl.string(eH.t.dl18zc), eH.intl.string(eH.t.nuFtHB), eH.intl.string(eH.t["3182VF"]), eH.intl.string(eH.t["DGq/PT"])],
        parent: eG.s6.VOICE_AND_VIDEO_VOICE
      },
      [eG.s6.VOICE_AND_VIDEO_VOLUME_CONTROLS]: {
        section: eZ.oAB.VOICE,
        searchableTitles: [eH.intl.string(eH.t.OX2Bnp), eH.intl.string(eH.t.eATD2N), eH.intl.string(eH.t.nuFtHB), eH.intl.string(eH.t["3182VF"]), eH.intl.string(eH.t["DGq/PT"])],
        parent: eG.s6.VOICE_AND_VIDEO_VOICE
      },
      ...
      [eG.s6.VOICE_AND_VIDEO_INPUT_PROFILE]: {
        section: eZ.oAB.VOICE,
        searchableTitles: [eH.intl.string(eH.t.LM3U3t), eH.intl.string(eH.t.nuFtHB), eH.intl.string(eH.t.VZPR0d), eH.intl.string(eH.t.cjPbpa)],
        parent: eG.s6.VOICE_AND_VIDEO_VOICE,
        predicate: () => {
          let {
      ...
      [eG.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE]: {
        section: eZ.oAB.VOICE,
        searchableTitles: [eH.intl.string(eH.t.KDdjoq), eH.intl.string(eH.t.NMCIf3), eH.intl.string(eH.t.FeUKeH)],
        parent: eG.s6.VOICE_AND_VIDEO_VIDEO_STREAMING,
        predicate: () => F.Z.supportsVideoHook() || F.Z.supportsExperimentalSoundshare() || F.Z.supportsSystemScreensharePicker() && (0, K.isMac)()
      },
      ...
      [eG.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eG.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === z.ZP.releaseChannel || "development" === z.ZP.releaseChannel) && e3 && F.Z.supports(eV.AN.CONNECTION_REPLAY)
      },
      [eG.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eZ.oAB.VOICE,
        searchableTitles: [eH.intl.string(eH.t["726JHB"])],
        parent: eG.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => K.isPlatformEmbedded && F.Z.supports(eV.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eG.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          H.default.track(eZ.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, W.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
      ...
      [eG.s6.QUEST_PREVIEW_TOOL_2]: {
        ...
        element: () => (0, r.jsx)(M.Z, {
          questId: null == b ? true : b.quest_id
        }),
        predicate: () => (0, L.T)({
          location: eF.dr.QUEST_PREVIEW_TOOL_2
        })
      },
      ...
      [eG.s6.LOGOUT]: {
        section: "logout",
        onClick: () => {
          (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, eQ(eq({
