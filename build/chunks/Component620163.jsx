  ...
  eX = e => {
    ...
    return Object.freeze({
      ...
      [eD.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eD.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === W.ZP.releaseChannel || "development" === W.ZP.releaseChannel) && eX && B.Z.supports(eM.AN.CONNECTION_REPLAY)
      },
      [eD.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eL.oAB.VOICE,
        searchableTitles: [ek.intl.string(ek.t["726JHB"])],
        parent: eD.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => Y.isPlatformEmbedded && B.Z.supports(eM.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eD.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          F.default.track(eL.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, H.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
      ...
      [eD.s6.QUEST_PREVIEW_TOOL_2]: {
        ...
        predicate: () => (0, x.T)({
          location: ej.dr.QUEST_PREVIEW_TOOL_2
        })
      },
      ...
      [eD.s6.LOGOUT]: {
        section: "logout",
        onClick: () => {
          (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, eH(eF({
