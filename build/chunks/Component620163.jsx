...
let eU = () => [a.z.CLIENT_THEMES_SETTINGS_BADGE, a.z.DEKSTOP_CUSTOM_APP_ICON_BADGE, a.z.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE],
  eG = () => {
    let e = eU(),
      [t] = (0, O.US)(e);
  ...
  eY = e => {
    ...
    return Object.freeze({
      ...
      [eN.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eN.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === Y.ZP.releaseChannel || "development" === Y.ZP.releaseChannel) && eQ && G.Z.supports(eR.AN.CONNECTION_REPLAY)
      },
      [eN.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: ew.oAB.VOICE,
        searchableTitles: [eD.intl.string(eD.t["726JHL"])],
        parent: eN.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => H.isPlatformEmbedded && G.Z.supports(eR.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eN.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          F.default.track(ew.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, V.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
