  ...
  ez = e => {
    ...
    return Object.freeze({
      ...
      [eP.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eP.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === W.ZP.releaseChannel || "development" === W.ZP.releaseChannel) && ez && B.Z.supports(eL.AN.CONNECTION_REPLAY)
      },
      [eP.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eD.oAB.VOICE,
        searchableTitles: [ej.intl.string(ej.t["726JHB"])],
        parent: eP.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => Y.isPlatformEmbedded && B.Z.supports(eL.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eP.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          F.default.track(eD.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, H.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
      ...
      [eP.s6.QUEST_PREVIEW_TOOL_2]: {
        ...
        predicate: () => (0, x.T)({
          location: ex.dr.QUEST_PREVIEW_TOOL_2
        })
      },
      ...
      [eP.s6.LOGOUT]: {
        section: "logout",
        onClick: () => {
          (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, eF(eB({
