...
let eB = () => [Chunk704215.z.CLIENT_THEMES_SETTINGS_BADGE, Chunk704215.z.DEKSTOP_CUSTOM_APP_ICON_BADGE, Chunk704215.z.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE],
  eZ = () => {
    let e = eB(),
  ...
  eK = e => {
    ...
    return Object.freeze({
      ...
      [eC.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eC.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === H.ZP.releaseChannel || "development" === H.ZP.releaseChannel) && ez && U.Z.supports(eP.AN.CONNECTION_REPLAY)
      },
      [eC.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eR.oAB.VOICE,
        searchableTitles: [eD.intl.string(eD.t["726JHL"])],
        parent: eC.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => V.isPlatformEmbedded && U.Z.supports(eP.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eC.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          B.default.track(eR.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, F.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
