  ...
  e1 = e => {
    ...
    return Object.freeze({
      ...
      [ek.s6.ACCOUNT_AGE_GROUP]: {
        searchableTitles: [eF.intl.string(eF.t["/52UY2"]), eF.intl.string(eF.t.sK0dmJ), eF.intl.string(eF.t.XxRj7e), eF.intl.string(eF.t.yNGjyM), eF.intl.string(eF.t.KPGVWl)],
        section: eG.oAB.ACCOUNT,
        parent: ek.s6.ACCOUNT_PROFILE,
        predicate: () => ta
      },
      ...
      [ek.s6.SENSITIVE_CONTENT_FILTERS]: {
        section: eG.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eF.intl.string(eF.t["Hj/Bur"]), eF.intl.string(eF.t["N/oRIy"]), eF.intl.string(eF.t.QVdYsL), eF.intl.string(eF.t["aWD+tr"]), eF.intl.string(eF.t["5mnTa2"]), eF.intl.string(eF.t.K0OWPz)],
        parent: ek.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [ek.s6.SEXUALLY_EXPLICIT_MEDIA_REDACTION]: {
        section: eG.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eF.intl.string(eF.t["Hj/Bur"]), eF.intl.string(eF.t["N/oRIy"]), eF.intl.string(eF.t.QVdYsL), eF.intl.string(eF.t["aWD+tr"]), eF.intl.string(eF.t["5mnTa2"])],
        parent: ek.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [ek.s6.GORE_MEDIA_REDACTION]: {
        section: eG.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eF.intl.string(eF.t["Hj/Bur"]), eF.intl.string(eF.t["N/oRIy"]), eF.intl.string(eF.t.QVdYsL), eF.intl.string(eF.t["aWD+tr"]), eF.intl.string(eF.t.K0OWPz)],
        parent: ek.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      ...
      [ek.s6.VOICE_AND_VIDEO_INPUT_PROFILE]: {
        section: eG.oAB.VOICE,
        searchableTitles: [eF.intl.string(eF.t.LM3U3t), eF.intl.string(eF.t.nuFtHB), eF.intl.string(eF.t.VZPR0d), eF.intl.string(eF.t.cjPbpa)],
        parent: ek.s6.VOICE_AND_VIDEO_VOICE,
        predicate: () => {
          let {
      ...
      [ek.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE]: {
        section: eG.oAB.VOICE,
        searchableTitles: [eF.intl.string(eF.t.KDdjoq), eF.intl.string(eF.t.NMCIf3), eF.intl.string(eF.t.FeUKeH)],
        parent: ek.s6.VOICE_AND_VIDEO_VIDEO_STREAMING,
        predicate: () => Z.Z.supportsVideoHook() || Z.Z.supportsExperimentalSoundshare() || Z.Z.supportsSystemScreensharePicker() && (0, W.isMac)()
      },
      ...
      [ek.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: ek.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === K.ZP.releaseChannel || "development" === K.ZP.releaseChannel) && e1 && Z.Z.supports(eZ.AN.CONNECTION_REPLAY)
      },
      [ek.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eG.oAB.VOICE,
        searchableTitles: [eF.intl.string(eF.t["726JHB"])],
        parent: ek.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => W.isPlatformEmbedded && Z.Z.supports(eZ.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [ek.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          V.default.track(eG.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, Y.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
      ...
      [ek.s6.QUEST_PREVIEW_TOOL_2]: {
        ...
        predicate: () => (0, L.T)({
          location: eB.dr.QUEST_PREVIEW_TOOL_2
        })
      },
      ...
      [ek.s6.LOGOUT]: {
        section: "logout",
        onClick: () => {
          (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, eq(eK({
