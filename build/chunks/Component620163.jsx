  ...
  e0 = e => {
    ...
    return Object.freeze({
      ...
      [eM.s6.ACCOUNT_AGE_GROUP]: {
        searchableTitles: [eZ.intl.string(eZ.t["/52UY2"]), eZ.intl.string(eZ.t.sK0dmJ), eZ.intl.string(eZ.t.XxRj7e), eZ.intl.string(eZ.t.yNGjyM), eZ.intl.string(eZ.t.KPGVWl)],
        section: eU.oAB.ACCOUNT,
        parent: eM.s6.ACCOUNT_PROFILE,
        predicate: () => ti
      },
      ...
      [eM.s6.SENSITIVE_CONTENT_FILTERS]: {
        section: eU.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eZ.intl.string(eZ.t["Hj/Bur"]), eZ.intl.string(eZ.t["N/oRIy"]), eZ.intl.string(eZ.t.QVdYsL), eZ.intl.string(eZ.t["aWD+tr"]), eZ.intl.string(eZ.t["5mnTa2"]), eZ.intl.string(eZ.t.K0OWPz)],
        parent: eM.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eM.s6.SEXUALLY_EXPLICIT_MEDIA_REDACTION]: {
        section: eU.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eZ.intl.string(eZ.t["Hj/Bur"]), eZ.intl.string(eZ.t["N/oRIy"]), eZ.intl.string(eZ.t.QVdYsL), eZ.intl.string(eZ.t["aWD+tr"]), eZ.intl.string(eZ.t["5mnTa2"])],
        parent: eM.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eM.s6.GORE_MEDIA_REDACTION]: {
        section: eU.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eZ.intl.string(eZ.t["Hj/Bur"]), eZ.intl.string(eZ.t["N/oRIy"]), eZ.intl.string(eZ.t.QVdYsL), eZ.intl.string(eZ.t["aWD+tr"]), eZ.intl.string(eZ.t.K0OWPz)],
        parent: eM.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      ...
      [eM.s6.VOICE_AND_VIDEO_INPUT_PROFILE]: {
        section: eU.oAB.VOICE,
        searchableTitles: [eZ.intl.string(eZ.t.LM3U3t), eZ.intl.string(eZ.t.nuFtHB), eZ.intl.string(eZ.t.VZPR0d), eZ.intl.string(eZ.t.cjPbpa)],
        parent: eM.s6.VOICE_AND_VIDEO_VOICE,
        predicate: () => {
          let {
      ...
      [eM.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eM.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === K.ZP.releaseChannel || "development" === K.ZP.releaseChannel) && e0 && Z.Z.supports(eB.AN.CONNECTION_REPLAY)
      },
      [eM.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eU.oAB.VOICE,
        searchableTitles: [eZ.intl.string(eZ.t["726JHB"])],
        parent: eM.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => W.isPlatformEmbedded && Z.Z.supports(eB.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eM.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          V.default.track(eU.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, Y.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
      ...
      [eM.s6.QUEST_PREVIEW_TOOL_2]: {
        ...
        predicate: () => (0, L.T)({
          location: eG.dr.QUEST_PREVIEW_TOOL_2
        })
      },
      ...
      [eM.s6.LOGOUT]: {
        section: "logout",
        onClick: () => {
          (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, ez(eW({
