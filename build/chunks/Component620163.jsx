...
function eJ(e, t) {
  return t = null != t ? t : {}, Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : eQ(Object(t)).forEach(function(n) {
  ...
  e4 = e => {
    ...
    return Object.freeze({
      ...
      [eB.s6.ACCOUNT_AGE_GROUP]: {
        searchableTitles: [eY.intl.string(eY.t["/52UY2"]), eY.intl.string(eY.t.sK0dmJ), eY.intl.string(eY.t.XxRj7e), eY.intl.string(eY.t.yNGjyM), eY.intl.string(eY.t.KPGVWl)],
        section: eF.oAB.ACCOUNT,
        parent: eB.s6.ACCOUNT_PROFILE,
        predicate: () => tl
      },
      ...
      [eB.s6.SENSITIVE_CONTENT_FILTERS]: {
        section: eF.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eY.intl.string(eY.t["Hj/Bur"]), eY.intl.string(eY.t["N/oRIy"]), eY.intl.string(eY.t.QVdYsL), eY.intl.string(eY.t["aWD+tr"]), eY.intl.string(eY.t["5mnTa2"]), eY.intl.string(eY.t.K0OWPz)],
        parent: eB.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eB.s6.SEXUALLY_EXPLICIT_MEDIA_REDACTION]: {
        section: eF.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eY.intl.string(eY.t["Hj/Bur"]), eY.intl.string(eY.t["N/oRIy"]), eY.intl.string(eY.t.QVdYsL), eY.intl.string(eY.t["aWD+tr"]), eY.intl.string(eY.t["5mnTa2"])],
        parent: eB.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eB.s6.GORE_MEDIA_REDACTION]: {
        section: eF.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eY.intl.string(eY.t["Hj/Bur"]), eY.intl.string(eY.t["N/oRIy"]), eY.intl.string(eY.t.QVdYsL), eY.intl.string(eY.t["aWD+tr"]), eY.intl.string(eY.t.K0OWPz)],
        parent: eB.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      ...
      [eB.s6.VOICE_AND_VIDEO_INPUT_PROFILE]: {
        section: eF.oAB.VOICE,
        searchableTitles: [eY.intl.string(eY.t.LM3U3t), eY.intl.string(eY.t.nuFtHB), eY.intl.string(eY.t.VZPR0d), eY.intl.string(eY.t.cjPbpa)],
        parent: eB.s6.VOICE_AND_VIDEO_VOICE,
        predicate: () => {
          let {
      ...
      [eB.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eB.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === z.ZP.releaseChannel || "development" === z.ZP.releaseChannel) && e4 && F.Z.supports(eH.AN.CONNECTION_REPLAY)
      },
      [eB.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eF.oAB.VOICE,
        searchableTitles: [eY.intl.string(eY.t["726JHB"])],
        parent: eB.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => K.isPlatformEmbedded && F.Z.supports(eH.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eB.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          H.default.track(eF.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, W.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
      ...
      [eB.s6.QUEST_PREVIEW_TOOL_2]: {
        ...
        predicate: () => (0, L.T)({
          location: eV.dr.QUEST_PREVIEW_TOOL_2
        })
      },
      ...
      [eB.s6.LOGOUT]: {
        section: "logout",
        onClick: () => {
          (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, eJ(eX({
