...
let e0 = () => {
  ...
  e1 = () => {
    ...
    }) : exports === Chunk704215.z.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE ? (0, Chunk951288.jsx)(Chunk481060.IGR, {
      text: Chunk388032.intl.string(Chunk388032.t.y2b7CA)
    }) : null
  },
  e2 = () => {
  ...
  e8 = e => {
    let {
      ...
      isClipsBetaTagShowing: eX = false,
    ...
    return Object.freeze({
      ...
      [eZ.s6.ACCOUNT_AGE_GROUP]: {
        searchableTitles: [eW.intl.string(eW.t["/52UY2"]), eW.intl.string(eW.t.sK0dmJ), eW.intl.string(eW.t.XxRj7e), eW.intl.string(eW.t.yNGjyM), eW.intl.string(eW.t.KPGVWl)],
        section: eV.oAB.ACCOUNT,
        parent: eZ.s6.ACCOUNT_PROFILE,
        predicate: () => tu
      },
      ...
      [eZ.s6.SENSITIVE_CONTENT_FILTERS]: {
        section: eV.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eW.intl.string(eW.t["Hj/Bur"]), eW.intl.string(eW.t["N/oRIy"]), eW.intl.string(eW.t.QVdYsL), eW.intl.string(eW.t["aWD+tr"]), eW.intl.string(eW.t["5mnTa2"]), eW.intl.string(eW.t.K0OWPz)],
        parent: eZ.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eZ.s6.SEXUALLY_EXPLICIT_MEDIA_REDACTION]: {
        section: eV.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eW.intl.string(eW.t["Hj/Bur"]), eW.intl.string(eW.t["N/oRIy"]), eW.intl.string(eW.t.QVdYsL), eW.intl.string(eW.t["aWD+tr"]), eW.intl.string(eW.t["5mnTa2"])],
        parent: eZ.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eZ.s6.GORE_MEDIA_REDACTION]: {
        section: eV.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eW.intl.string(eW.t["Hj/Bur"]), eW.intl.string(eW.t["N/oRIy"]), eW.intl.string(eW.t.QVdYsL), eW.intl.string(eW.t["aWD+tr"]), eW.intl.string(eW.t.K0OWPz)],
        parent: eZ.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      ...
      [eZ.s6.VOICE_AND_VIDEO_INPUT_PROFILE]: {
        section: eV.oAB.VOICE,
        searchableTitles: [eW.intl.string(eW.t.LM3U3t), eW.intl.string(eW.t.nuFtHB), eW.intl.string(eW.t.VZPR0d), eW.intl.string(eW.t.cjPbpa)],
        parent: eZ.s6.VOICE_AND_VIDEO_VOICE,
        predicate: () => {
          let {
      ...
      [eZ.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eZ.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === z.ZP.releaseChannel || "development" === z.ZP.releaseChannel) && e5 && F.Z.supports(eY.AN.CONNECTION_REPLAY)
      },
      [eZ.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eV.oAB.VOICE,
        searchableTitles: [eW.intl.string(eW.t["726JHB"])],
        parent: eZ.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => K.isPlatformEmbedded && F.Z.supports(eY.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eZ.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          H.default.track(eV.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, W.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
      ...
      [eZ.s6.QUEST_PREVIEW_TOOL_2]: {
        ...
        element: () => (0, r.jsx)(M.Z, {
          questId: null == T ? true : T.quest_id
        }),
        predicate: () => (0, x.T)({
          location: eH.dr.QUEST_PREVIEW_TOOL_2
        })
      },
      ...
      [eZ.s6.LOGOUT]: {
        section: "logout",
        onClick: () => {
          (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, e$(eQ({
