...
var Chunk990547 = require("./990547.js"),
  ...
  Chunk489968 = require("./489968.jsx"),
  ...
  Chunk665166 = require("./665166.jsx"),
  ...
  Chunk38915 = require("./38915.jsx"),
  Chunk321614 = require("./321614.js"),
  Chunk498639 = require("./498639.jsx"),
...
let e1 = () => {
  ...
  e8 = () => {
    ...
    }) : exports === Chunk704215.z.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE ? (0, Chunk255367.jsx)(Chunk481060.IGR, {
      text: Chunk388032.intl.string(Chunk388032.t.y2b7CA)
    }) : null
  },
  e6 = () => {
    ...
    }).enabled && module.push(Chunk704215.z.RECENT_AVATARS_SETTINGS_MENU_NEW_BADGE), Chunk594928.J.getCurrentConfig({
      location: "SettingsRendererConfig"
  ...
  e7 = e => {
    ...
    return Object.freeze({
      ...
      [eW.s6.PRIVACY_SENSITIVE_MEDIA_V2]: {
        section: eK.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eJ.intl.string(eJ.t.uEz8JC), eJ.intl.string(eJ.t["N/oRIy"]), eJ.intl.string(eJ.t.QVdYsL), eJ.intl.string(eJ.t["aWD+tr"]), eJ.intl.string(eJ.t["5mnTa2"])],
        parent: eW.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eW.s6.SENSITIVE_CONTENT_FILTERS]: {
        section: eK.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eJ.intl.string(eJ.t["Hj/Bur"]), eJ.intl.string(eJ.t["N/oRIy"]), eJ.intl.string(eJ.t.QVdYsL), eJ.intl.string(eJ.t["aWD+tr"]), eJ.intl.string(eJ.t["5mnTa2"]), eJ.intl.string(eJ.t.K0OWPz)],
        parent: eW.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eW.s6.SEXUALLY_EXPLICIT_MEDIA_REDACTION]: {
        section: eK.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eJ.intl.string(eJ.t["Hj/Bur"]), eJ.intl.string(eJ.t["N/oRIy"]), eJ.intl.string(eJ.t.QVdYsL), eJ.intl.string(eJ.t["aWD+tr"]), eJ.intl.string(eJ.t["5mnTa2"])],
        parent: eW.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eW.s6.GORE_MEDIA_REDACTION]: {
        section: eK.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eJ.intl.string(eJ.t["Hj/Bur"]), eJ.intl.string(eJ.t["N/oRIy"]), eJ.intl.string(eJ.t.QVdYsL), eJ.intl.string(eJ.t["aWD+tr"]), eJ.intl.string(eJ.t.K0OWPz)],
        parent: eW.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eW.s6.PRIVACY_DIRECT_MESSAGE_SPAM_FILTER_V2]: {
        section: eK.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eJ.intl.string(eJ.t.JzaP4u), eJ.intl.string(eJ.t.H9XOl5), eJ.intl.string(eJ.t.k4W40N)],
        parent: eW.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      ...
      [eW.s6.THIRD_PARTY_ACCESS]: {
        section: eK.oAB.CONNECTIONS,
        searchableTitles: [eJ.intl.string(eJ.t["Ig/XFR"]), eJ.intl.string(eJ.t["3fe7U1"]), eJ.intl.string(eJ.t["f6kk+v"])],
      ...
      [eW.s6.APPEARANCE_TIMESTAMP_HOUR_CYCLE]: {
        section: eK.oAB.APPEARANCE,
        searchableTitles: [eJ.intl.string(eJ.t.dyamEB), eJ.intl.string(eJ.t.p8NOws), eJ.intl.string(eJ.t["+o/sOj"])],
        parent: eW.s6.APPEARANCE,
      ...
      [eW.s6.VOICE_AND_VIDEO_DEVICES]: {
        section: eK.oAB.VOICE,
        searchableTitles: [eJ.intl.string(eJ.t.hHMYbW), eJ.intl.string(eJ.t.dl18zc), eJ.intl.string(eJ.t.nuFtHB), eJ.intl.string(eJ.t["3182VF"]), eJ.intl.string(eJ.t["DGq/PT"])],
        parent: eW.s6.VOICE_AND_VIDEO_VOICE
      },
      [eW.s6.VOICE_AND_VIDEO_VOLUME_CONTROLS]: {
        section: eK.oAB.VOICE,
        searchableTitles: [eJ.intl.string(eJ.t.OX2Bnp), eJ.intl.string(eJ.t.eATD2N), eJ.intl.string(eJ.t.nuFtHB), eJ.intl.string(eJ.t["3182VF"]), eJ.intl.string(eJ.t["DGq/PT"])],
        parent: eW.s6.VOICE_AND_VIDEO_VOICE
      },
      ...
      [eW.s6.VOICE_AND_VIDEO_INPUT_PROFILE]: {
        section: eK.oAB.VOICE,
        searchableTitles: [eJ.intl.string(eJ.t.LM3U3t), eJ.intl.string(eJ.t.nuFtHB), eJ.intl.string(eJ.t.VZPR0d), eJ.intl.string(eJ.t.cjPbpa)],
        parent: eW.s6.VOICE_AND_VIDEO_VOICE,
        predicate: () => {
          let {
      ...
      [eW.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE]: {
        section: eK.oAB.VOICE,
        searchableTitles: [eJ.intl.string(eJ.t.KDdjoq), eJ.intl.string(eJ.t.NMCIf3), eJ.intl.string(eJ.t.FeUKeH)],
        parent: tp ? eW.s6.VOICE_AND_VIDEO_VIDEO_STREAMING : eW.s6.VOICE_AND_VIDEO_ADVANCED,
        predicate: () => K.Z.supportsVideoHook() || K.Z.supportsExperimentalSoundshare() || K.Z.supportsSystemScreensharePicker() && (0, $.isMac)()
      },
      ...
      [eW.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eW.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === ee.ZP.releaseChannel || "development" === ee.ZP.releaseChannel) && e9 && K.Z.supports(eX.AN.CONNECTION_REPLAY)
      },
      [eW.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eK.oAB.VOICE,
        searchableTitles: [eJ.intl.string(eJ.t["726JHB"])],
        parent: eW.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => $.isPlatformEmbedded && K.Z.supports(eX.AN.DEBUG_LOGGING) && null != g.Z.fileManager.readLogFiles
      },
      ...
      [eW.s6.STREAMER_MODE_HIDE_DISCORD_WINDOW_FROM_SCREEN_CAPTURE]: {
        ...
        predicate: () => {
          var e, t, n;
          return null != (n = null === g.Z || true === g.Z || null == (t = g.Z.window) || null == (e = t.supportsContentProtection) ? true : e.call(t)) && n
        }
      },
      ...
      [eW.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          X.default.track(eK.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, Q.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
      ...
      [eW.s6.QUEST_PREVIEW_TOOL]: {
        ...
        element: G.Z,
        predicate: () => (0, U.X7)({
          location: eq.dr.QUEST_PREVIEW_TOOL
        })
      },
