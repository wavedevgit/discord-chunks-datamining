  ...
  e2 = e => {
    ...
    return Object.freeze({
      ...
      [eU.s6.ACCOUNT_AGE_GROUP]: {
        searchableTitles: [eV.intl.string(eV.t["/52UY2"]), eV.intl.string(eV.t.sK0dmJ), eV.intl.string(eV.t.XxRj7e), eV.intl.string(eV.t.yNGjyM), eV.intl.string(eV.t.KPGVWl)],
        section: eB.oAB.ACCOUNT,
        parent: eU.s6.ACCOUNT_PROFILE,
        predicate: () => to
      },
      ...
      [eU.s6.SENSITIVE_CONTENT_FILTERS]: {
        section: eB.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eV.intl.string(eV.t["Hj/Bur"]), eV.intl.string(eV.t["N/oRIy"]), eV.intl.string(eV.t.QVdYsL), eV.intl.string(eV.t["aWD+tr"]), eV.intl.string(eV.t["5mnTa2"]), eV.intl.string(eV.t.K0OWPz)],
        parent: eU.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eU.s6.SEXUALLY_EXPLICIT_MEDIA_REDACTION]: {
        section: eB.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eV.intl.string(eV.t["Hj/Bur"]), eV.intl.string(eV.t["N/oRIy"]), eV.intl.string(eV.t.QVdYsL), eV.intl.string(eV.t["aWD+tr"]), eV.intl.string(eV.t["5mnTa2"])],
        parent: eU.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eU.s6.GORE_MEDIA_REDACTION]: {
        section: eB.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eV.intl.string(eV.t["Hj/Bur"]), eV.intl.string(eV.t["N/oRIy"]), eV.intl.string(eV.t.QVdYsL), eV.intl.string(eV.t["aWD+tr"]), eV.intl.string(eV.t.K0OWPz)],
        parent: eU.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      ...
      [eU.s6.VOICE_AND_VIDEO_INPUT_PROFILE]: {
        section: eB.oAB.VOICE,
        searchableTitles: [eV.intl.string(eV.t.LM3U3t), eV.intl.string(eV.t.nuFtHB), eV.intl.string(eV.t.VZPR0d), eV.intl.string(eV.t.cjPbpa)],
        parent: eU.s6.VOICE_AND_VIDEO_VOICE,
        predicate: () => {
          let {
      ...
      [eU.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eU.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === z.ZP.releaseChannel || "development" === z.ZP.releaseChannel) && e2 && F.Z.supports(eF.AN.CONNECTION_REPLAY)
      },
      [eU.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eB.oAB.VOICE,
        searchableTitles: [eV.intl.string(eV.t["726JHB"])],
        parent: eU.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => K.isPlatformEmbedded && F.Z.supports(eF.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eU.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          H.default.track(eB.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, W.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
      ...
      [eU.s6.QUEST_PREVIEW_TOOL_2]: {
        ...
        predicate: () => (0, L.T)({
          location: eZ.dr.QUEST_PREVIEW_TOOL_2
        })
      },
      ...
      [eU.s6.LOGOUT]: {
        section: "logout",
        onClick: () => {
          (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, eX(ez({
