  ...
  ez = e => {
    ...
    return Object.freeze({
      ...
      [eN.s6.APPEARANCE_TIMESTAMP_HOUR_CYCLE]: {
        section: eP.oAB.APPEARANCE,
        searchableTitles: [ew.intl.string(ew.t.dyamEI), ew.intl.string(ew.t.p8NOwi), ew.intl.string(ew.t["+o/sOo"])],
        parent: eN.s6.APPEARANCE,
      ...
      [eN.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eN.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === H.ZP.releaseChannel || "development" === H.ZP.releaseChannel) && ez && U.Z.supports(eD.AN.CONNECTION_REPLAY)
      },
      [eN.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eP.oAB.VOICE,
        searchableTitles: [ew.intl.string(ew.t["726JHL"])],
        parent: eN.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => V.isPlatformEmbedded && U.Z.supports(eD.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
