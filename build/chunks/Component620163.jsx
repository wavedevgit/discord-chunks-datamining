  ...
  eY = e => {
    ...
    return Object.freeze({
      ...
      [eN.s6.ACCOUNT_AGE_GROUP]: {
        searchableTitles: [eD.intl.string(eD.t["/52UY2"]), eD.intl.string(eD.t.sK0dmJ), eD.intl.string(eD.t.XxRj7e), eD.intl.string(eD.t.yNGjyM), eD.intl.string(eD.t.KPGVWl)],
        section: eP.oAB.ACCOUNT,
        parent: eN.s6.ACCOUNT_PROFILE,
        predicate: () => e8
      },
      ...
      [eN.s6.PRIVACY_SENSITIVE_MEDIA_V2]: {
        section: eP.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eD.intl.string(eD.t.uEz8JC), eD.intl.string(eD.t["N/oRIy"]), eD.intl.string(eD.t.QVdYsL), eD.intl.string(eD.t["aWD+tr"]), eD.intl.string(eD.t["5mnTa2"])],
        parent: eN.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eN.s6.SENSITIVE_CONTENT_FILTERS]: {
        section: eP.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eD.intl.string(eD.t["Hj/Bur"]), eD.intl.string(eD.t["N/oRIy"]), eD.intl.string(eD.t.QVdYsL), eD.intl.string(eD.t["aWD+tr"]), eD.intl.string(eD.t["5mnTa2"]), eD.intl.string(eD.t.K0OWPz)],
        parent: eN.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [eN.s6.SEXUALLY_EXPLICIT_MEDIA_REDACTION]: {
        section: eP.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eD.intl.string(eD.t["Hj/Bur"]), eD.intl.string(eD.t["N/oRIy"]), eD.intl.string(eD.t.QVdYsL), eD.intl.string(eD.t["aWD+tr"]), eD.intl.string(eD.t["5mnTa2"])],
        parent: eN.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      ...
      [eN.s6.THIRD_PARTY_ACCESS]: {
        section: eP.oAB.CONNECTIONS,
        searchableTitles: [eD.intl.string(eD.t["Ig/XFR"]), eD.intl.string(eD.t["3fe7U1"]), eD.intl.string(eD.t["f6kk+v"])],
      ...
      [eN.s6.VOICE_AND_VIDEO_DEVICES]: {
        section: eP.oAB.VOICE,
        searchableTitles: [eD.intl.string(eD.t.hHMYbW), eD.intl.string(eD.t.dl18zc), eD.intl.string(eD.t.nuFtHB), eD.intl.string(eD.t["3182VF"]), eD.intl.string(eD.t["DGq/PT"])],
        parent: eN.s6.VOICE_AND_VIDEO_VOICE
      },
      [eN.s6.VOICE_AND_VIDEO_VOLUME_CONTROLS]: {
        section: eP.oAB.VOICE,
        searchableTitles: [eD.intl.string(eD.t.OX2Bnp), eD.intl.string(eD.t.eATD2N), eD.intl.string(eD.t.nuFtHB), eD.intl.string(eD.t["3182VF"]), eD.intl.string(eD.t["DGq/PT"])],
        parent: eN.s6.VOICE_AND_VIDEO_VOICE
      },
      ...
      [eN.s6.VOICE_AND_VIDEO_INPUT_PROFILE]: {
        section: eP.oAB.VOICE,
        searchableTitles: [eD.intl.string(eD.t.LM3U3t), eD.intl.string(eD.t.nuFtHB), eD.intl.string(eD.t.VZPR0d), eD.intl.string(eD.t.cjPbpa)],
        parent: eN.s6.VOICE_AND_VIDEO_VOICE,
        predicate: () => {
          let {
      ...
      [eN.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE]: {
        section: eP.oAB.VOICE,
        searchableTitles: [eD.intl.string(eD.t.KDdjoq), eD.intl.string(eD.t.NMCIf3), eD.intl.string(eD.t.FeUKeH)],
        parent: eN.s6.VOICE_AND_VIDEO_VIDEO_STREAMING,
        predicate: () => U.Z.supportsVideoHook() || U.Z.supportsExperimentalSoundshare() || U.Z.supportsSystemScreensharePicker() && (0, V.isMac)()
      },
      ...
      [eN.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eN.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === H.ZP.releaseChannel || "development" === H.ZP.releaseChannel) && eW && U.Z.supports(ew.AN.CONNECTION_REPLAY)
      },
      [eN.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eP.oAB.VOICE,
        searchableTitles: [eD.intl.string(eD.t["726JHB"])],
        parent: eN.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => V.isPlatformEmbedded && U.Z.supports(ew.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
