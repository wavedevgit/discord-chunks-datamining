  ...
  eY = e => {
    ...
    return Object.freeze({
      ...
      [eA.s6.APPEARANCE_TIMESTAMP_HOUR_CYCLE]: {
        section: eN.oAB.APPEARANCE,
        searchableTitles: [eP.intl.string(eP.t.dyamEI), eP.intl.string(eP.t.p8NOwi), eP.intl.string(eP.t["+o/sOo"])],
        parent: eA.s6.APPEARANCE,
      ...
      [eA.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eA.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === V.ZP.releaseChannel || "development" === V.ZP.releaseChannel) && eK && j.Z.supports(eR.AN.CONNECTION_REPLAY)
      },
      [eA.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eN.oAB.VOICE,
        searchableTitles: [eP.intl.string(eP.t["726JHL"])],
        parent: eA.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => F.isPlatformEmbedded && j.Z.supports(eR.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eA.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          G.default.track(eN.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, Z.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
      ...
      [eA.s6.LOGOUT]: {
        section: "logout",
        onClick: () => {
          (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, eU(ek({
