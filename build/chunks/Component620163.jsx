...
let ek = () => [Chunk704215.z.CLIENT_THEMES_SETTINGS_BADGE, Chunk704215.z.DEKSTOP_CUSTOM_APP_ICON_BADGE, Chunk704215.z.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE],
  eU = () => {
    let e = ek(),
  ...
  eH = e => {
    let {
      ...
      isClipsBetaTagShowing: eH = false,
    ...
    return Object.freeze({
      ...
      [eC.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eC.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === H.ZP.releaseChannel || "development" === H.ZP.releaseChannel) && eW && U.Z.supports(eR.AN.CONNECTION_REPLAY)
      },
      [eC.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eP.oAB.VOICE,
        searchableTitles: [ew.intl.string(ew.t["726JHL"])],
        parent: eC.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => V.isPlatformEmbedded && U.Z.supports(eR.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [eC.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          Z.default.track(eP.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, F.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
