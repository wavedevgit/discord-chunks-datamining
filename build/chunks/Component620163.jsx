  ...
  e$ = e => {
    ...
    return Object.freeze({
      ...
      [ej.s6.ACCOUNT_AGE_GROUP]: {
        searchableTitles: [eB.intl.string(eB.t["/52UY2"]), eB.intl.string(eB.t.sK0dmJ), eB.intl.string(eB.t.XxRj7e), eB.intl.string(eB.t.yNGjyM), eB.intl.string(eB.t.KPGVWl)],
        section: ek.oAB.ACCOUNT,
        parent: ej.s6.ACCOUNT_PROFILE,
        predicate: () => tr
      },
      ...
      [ej.s6.PRIVACY_SENSITIVE_MEDIA_V2]: {
        section: ek.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eB.intl.string(eB.t.uEz8JC), eB.intl.string(eB.t["N/oRIy"]), eB.intl.string(eB.t.QVdYsL), eB.intl.string(eB.t["aWD+tr"]), eB.intl.string(eB.t["5mnTa2"])],
        parent: ej.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [ej.s6.SENSITIVE_CONTENT_FILTERS]: {
        section: ek.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eB.intl.string(eB.t["Hj/Bur"]), eB.intl.string(eB.t["N/oRIy"]), eB.intl.string(eB.t.QVdYsL), eB.intl.string(eB.t["aWD+tr"]), eB.intl.string(eB.t["5mnTa2"]), eB.intl.string(eB.t.K0OWPz)],
        parent: ej.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [ej.s6.SEXUALLY_EXPLICIT_MEDIA_REDACTION]: {
        section: ek.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eB.intl.string(eB.t["Hj/Bur"]), eB.intl.string(eB.t["N/oRIy"]), eB.intl.string(eB.t.QVdYsL), eB.intl.string(eB.t["aWD+tr"]), eB.intl.string(eB.t["5mnTa2"])],
        parent: ej.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [ej.s6.GORE_MEDIA_REDACTION]: {
        section: ek.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eB.intl.string(eB.t["Hj/Bur"]), eB.intl.string(eB.t["N/oRIy"]), eB.intl.string(eB.t.QVdYsL), eB.intl.string(eB.t["aWD+tr"]), eB.intl.string(eB.t.K0OWPz)],
        parent: ej.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      [ej.s6.PRIVACY_DIRECT_MESSAGE_SPAM_FILTER_V2]: {
        section: ek.oAB.CONTENT_AND_SOCIAL,
        searchableTitles: [eB.intl.string(eB.t.JzaP4u), eB.intl.string(eB.t.H9XOl5), eB.intl.string(eB.t.k4W40N)],
        parent: ej.s6.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
      },
      ...
      [ej.s6.THIRD_PARTY_ACCESS]: {
        section: ek.oAB.CONNECTIONS,
        searchableTitles: [eB.intl.string(eB.t["Ig/XFR"]), eB.intl.string(eB.t["3fe7U1"]), eB.intl.string(eB.t["f6kk+v"])],
      ...
      [ej.s6.APPEARANCE_TIMESTAMP_HOUR_CYCLE]: {
        section: ek.oAB.APPEARANCE,
        searchableTitles: [eB.intl.string(eB.t.dyamEB), eB.intl.string(eB.t.p8NOws), eB.intl.string(eB.t["+o/sOj"])],
        parent: ej.s6.APPEARANCE,
        predicate: () => j.Z.getCurrentConfig({
          location: "SettingsRendererConfig"
        }, {
      ...
      [ej.s6.VOICE_AND_VIDEO_DEVICES]: {
        section: ek.oAB.VOICE,
        searchableTitles: [eB.intl.string(eB.t.hHMYbW), eB.intl.string(eB.t.dl18zc), eB.intl.string(eB.t.nuFtHB), eB.intl.string(eB.t["3182VF"]), eB.intl.string(eB.t["DGq/PT"])],
        parent: ej.s6.VOICE_AND_VIDEO_VOICE
      },
      [ej.s6.VOICE_AND_VIDEO_VOLUME_CONTROLS]: {
        section: ek.oAB.VOICE,
        searchableTitles: [eB.intl.string(eB.t.OX2Bnp), eB.intl.string(eB.t.eATD2N), eB.intl.string(eB.t.nuFtHB), eB.intl.string(eB.t["3182VF"]), eB.intl.string(eB.t["DGq/PT"])],
        parent: ej.s6.VOICE_AND_VIDEO_VOICE
      },
      ...
      [ej.s6.VOICE_AND_VIDEO_INPUT_PROFILE]: {
        section: ek.oAB.VOICE,
        searchableTitles: [eB.intl.string(eB.t.LM3U3t), eB.intl.string(eB.t.nuFtHB), eB.intl.string(eB.t.VZPR0d), eB.intl.string(eB.t.cjPbpa)],
        parent: ej.s6.VOICE_AND_VIDEO_VOICE,
        predicate: () => {
          let {
      ...
      [ej.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE]: {
        section: ek.oAB.VOICE,
        searchableTitles: [eB.intl.string(eB.t.KDdjoq), eB.intl.string(eB.t.NMCIf3), eB.intl.string(eB.t.FeUKeH)],
        parent: ej.s6.VOICE_AND_VIDEO_VIDEO_STREAMING,
        predicate: () => B.Z.supportsVideoHook() || B.Z.supportsExperimentalSoundshare() || B.Z.supportsSystemScreensharePicker() && (0, Y.isMac)()
      },
      ...
      [ej.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: ej.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === W.ZP.releaseChannel || "development" === W.ZP.releaseChannel) && e$ && B.Z.supports(eG.AN.CONNECTION_REPLAY)
      },
      [ej.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: ek.oAB.VOICE,
        searchableTitles: [eB.intl.string(eB.t["726JHB"])],
        parent: ej.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => Y.isPlatformEmbedded && B.Z.supports(eG.AN.DEBUG_LOGGING) && null != _.Z.fileManager.readLogFiles
      },
      ...
      [ej.s6.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          F.default.track(ek.rMx.USER_SETTINGS_MERCH_LINK_CLICKED), (0, H.q)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
      ...
      [ej.s6.QUEST_PREVIEW_TOOL_2]: {
        ...
        predicate: () => (0, x.T)({
          location: eU.dr.QUEST_PREVIEW_TOOL_2
        })
      },
      ...
      [ej.s6.LOGOUT]: {
        section: "logout",
        onClick: () => {
          (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, eK(eY({
