...
function y(e) {
  let t, {
    ...
    q = (0, j.$)(E, w),
    J = N && null != D && W;
  a()(null != I, "Expected plan to selected"), a()(null != M, "Expected selectedSkuId"), a()(null != k, "Step should be set");
  let Q = i.useCallback(() => {
    n(), null == y || y()
  }, [n, y]);
  i.useEffect(() => {
    !N || null == R || null == B || U || H || (0, u.pO)(R) || F({
      onSubscriptionConfirmation: y
    })
  }, [F, N, R, B, U, H, y]), i.useEffect(() => {
