...
class b extends n.EventEmitter {
  ...
  async compressAndCheckFileSize() {
    ...
    return this.files.length > r.getMaxAttachmentsCount() ? (m.log("Too many attachments for ".concat(this.id)), this._handleError({
      code: d.evJ.TOO_MANY_ATTACHMENTS
    }), !1) : !(this._fileSize() > r.getMaxTotalAttachmentSize()) || (this._handleError({
  ...
  setUploadingTextForUI() {
    let e = 1 === this.files.length && null != this.files[0].filename ? this.files[0].filename : f.intl.formatToPlainString(f.t.D0noUl, {
      ...
      n = this._fileSize();
    m.log("setUploadingTextForUI - total content: ".concat(n, " bytes and ").concat(this.files.length, " attachments for ").concat(this.id)), this._file = p(h({}, this._file), {
  ...
  _recomputeProgress() {
    let {
      loaded: e,
      total: t
    } = this._recomputeProgressTotal(), r = this._recomputeProgressByFile();
  ...
  async cancelItem(e) {
    ...
    this.files = [...this.files.slice(0, r), ...this.files.slice(r + 1)], this._file = p(h({}, this._file), {
      items: this.files
    }), await (0, o.V)(t), t.cancel(), this.emit("cancel-upload-item", this._file), 0 === this.files.length && this.cancel()
  }
  upload(e, t) {
  ...
  constructor(e, t = "POST", r) {
    ...
    super(), g(this, "id", void 0), g(this, "_file", void 0), g(this, "_aborted", !1), g(this, "_errored", !1), g(this, "_url", void 0), g(this, "_method", void 0), g(this, "_raiseEndpointErrors", !1), g(this, "processingMessageChangeInterval", void 0), g(this, "files", []), g(this, "_lastUpdate", 0), g(this, "_loaded", 0), g(this, "alreadyStarted", !1), g(this, "_cancel", void 0), g(this, "_handleStart", e => {
      ...
      let n = Date.now(),
        i = (0, c.S)(e, t),
        a = Math.floor((e - this._loaded) / ((n - this._lastUpdate) / 1e3));
      if (null != r) {
        var l;
        null == (l = this._file.items) || l.forEach(e => {
          e.item.progress = r[e.id]
        })
      }
      this._lastUpdate = n, this._loaded = e, this._file = p(h({}, this._file), {
        currentSize: t,
        progress: i,
        rate: a
    ...
    }), this.id = a().uniqueId("Uploader"), this._url = e, this._method = t, this._raiseEndpointErrors = null != (n = null == r ? void 0 : r.raiseEndpointErrors) && n, this._file = {
      id: this.id,
      name: "",
      currentSize: 0,
      totalPreCompressionSize: 0,
