...
function i(e) {
  ...
  let g = [];
  return (0, l.e7)([a.Z], () => null != o && !(0, r.eC)(o, a.Z) && (0, r.En)(s)) || (g = h.embeds, null != d ? g = h.embeds.filter((e, t) => d.includes(t)) : null != u && (g = [])), (null != d || "" === h.content && g.length > 0) && (h = h.set("content", g.map(e => e.url).join("\n"))), "" === h.content && (null == (n = h.embeds[0]) ? true : n.rawDescription) != null && (h = h.set("content", h.embeds[0].rawDescription)), {
    attachments: m,
    embeds: g,
