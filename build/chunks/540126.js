...
class ed extends ei {
  ...
  constructor(e, t, n, r) {
    ...
    this.isCollapsed = k.Z.isVoiceCategoryCollapsed(e.id), this.isMuted = false, this.categoriesById = n, this.channels = a()(t).map(e => new eb(this, e, r)).keyBy(e => e.id).value()
  }
}
class ef {
  isEmpty() {
