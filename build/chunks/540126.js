...
class er extends ee {
  ...
  constructor(e, t) {
    ...
    this.channels = o()(null != (n = P.ZP.getGuildFavorites(e.id)) ? n : []).map(e => j.Z.getChannel(e)).filter(T.lm).map(e => new ed(this, e, t)).keyBy(e => e.id).value();
    let r = g.Z.getSuggestedChannelId(e.id),
      i = j.Z.getChannel(r);
    null != i && null != r && (this.channels[r] = new ed(this, i, W(B({}, t), {
      activeJoinedRelevantThreads: {},
      activeJoinedUnreadThreads: {}
    })))
  }
