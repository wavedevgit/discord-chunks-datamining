...
class $ {
  ...
  getSectionRowsFromChannel(e) {
    ...
    if (s >= 0 && n.push({
        ...
        row: s
      }), r.type === M.d4z.GUILD_CATEGORY) return [{
      section: o().findIndex(this.getSortedNamedCategories(), e => e.id === (null == r ? void 0 : r.id)) + X
    }];
...
class er extends ee {
  ...
  constructor(e, t) {
    ...
    this.channels = o()(null != (n = N.ZP.getGuildFavorites(e.id)) ? n : []).map(e => j.Z.getChannel(e)).filter(T.lm).map(e => new ed(this, e, t)).keyBy(e => e.id).value();
    let r = g.Z.getSuggestedChannelId(e.id),
      i = j.Z.getChannel(r);
    null != i && null != r && (this.channels[r] = new ed(this, i, F(B({}, t), {
      activeJoinedRelevantThreads: {},
      activeJoinedUnreadThreads: {}
    })))
  }
...
class ei extends ee {
  ...
  constructor(e, t, n) {
    if (super(e), G(this, "enabled", !1), this.isCollapsed = m.Z.isCollapsed(e.id), this.enabled = !1, this.enabled)
      for (let e of Object.values(t))(0, v.vc)(e.type) && !(0, v.Q5)(e.type) && (this.channels[e.id] = new ep(this, e, n))
  }
}
G(ei, "MIN_READABLE_CHANNELS", 7), G(ei, "MAX_RECENT_CHANNELS", 10), G(ei, "MAX_TIMESTAMP_DELTA", 6048e5);
class el extends ee {
  updateAllChannels(e) {
    let t = !1;
...
class eo extends ee {
  ...
  constructor(e, t, n, r) {
    ...
    this.isCollapsed = D.Z.isVoiceCategoryCollapsed(e.id), this.isMuted = !1, this.categoriesById = n, this.channels = o()(t).map(e => new ef(this, e, r)).keyBy(e => e.id).value()
  }
}
class es {
  isEmpty() {
...
class eu extends ec {
  computeState(e) {
    ...
    return this.id !== a.moderatorReportChannelId || a.moderatorReportChannelEnabled ? a.optInEnabled && a.hideResourceChannels && this.record.hasFlag(k.zZ.IS_GUILD_RESOURCE_CHANNEL) ? {
      renderLevel: c ? 4 : 1,
      threadIds: p
