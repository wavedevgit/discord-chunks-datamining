...
class en {
  ...
  getSectionRowsFromChannel(e) {
    ...
    if (a >= 0 && n.push({
      ...
      section: o().findIndex(this.getSortedNamedCategories(), e => e.id === (null == r ? void 0 : r.id)) + $
    }];
...
class eo extends er {
  ...
  constructor(e, t) {
    ...
    this.channels = o()(null != (n = Z.ZP.getGuildFavorites(e.id)) ? n : []).map(e => x.Z.getChannel(e)).filter(R.lm).map(e => new ef(this, e, t)).keyBy(e => e.id).value();
    let r = g.Z.getSuggestedChannelId(e.id),
      i = x.Z.getChannel(r);
    null != i && null != r && (this.channels[r] = new ef(this, i, z(H({}, t), {
      activeJoinedRelevantThreads: {},
      activeJoinedUnreadThreads: {}
    })))
  }
...
class ea extends er {
  ...
  constructor(e, t, n) {
    if (super(e), F(this, "enabled", !1), this.isCollapsed = m.Z.isCollapsed(e.id), this.enabled = !1, this.enabled)
      for (let e of Object.values(t))(0, j.vc)(e.type) && !(0, j.Q5)(e.type) && (this.channels[e.id] = new em(this, e, n))
  }
}
F(ea, "MIN_READABLE_CHANNELS", 7), F(ea, "MAX_RECENT_CHANNELS", 10), F(ea, "MAX_TIMESTAMP_DELTA", 6048e5);
class es extends er {
  updateAllChannels(e) {
    let t = !1;
  ...
  constructor(e, t, n) {
    ...
    this.isCollapsed = !1, this.isMuted = !1, this.channels = o()(t).map(e => new eg(this, e, n)).keyBy(e => e.id).value()
  }
}
class ec extends er {
  invalidate() {
  ...
  constructor(e, t, n, r) {
    ...
    this.isCollapsed = M.Z.isVoiceCategoryCollapsed(e.id), this.isMuted = !1, this.categoriesById = n, this.channels = o()(t).map(e => new eb(this, e, r)).keyBy(e => e.id).value()
  }
}
class eu {
  isEmpty() {
...
class ep extends eh {
  computeState(e) {
    ...
    return this.id !== s.moderatorReportChannelId || s.moderatorReportChannelEnabled ? s.optInEnabled && s.hideResourceChannels && this.record.hasFlag(B.zZ.IS_GUILD_RESOURCE_CHANNEL) ? {
      renderLevel: c ? 4 : 1,
      threadIds: p
    } : !s.optInEnabled || s.optedInChannels.has(this.id) || null != a && s.optedInChannels.has(a) ? c || d || !o().isEmpty(p) || N.ZP.getMentionCount(this.id) > 0 ? {
      renderLevel: 4,
      threadIds: p
...
class eg extends eh {
  computeState(e) {
    ...
    return P.Z.can(V.Pl.VIEW_CHANNEL, this.record) ? eC(this.category.guild, this.record, e) ? {
...
class eb extends ep {
  ...
  computeState(e) {
    ...
    return 4 === n && (this.subtitle = e_(this.record, this.isCollapsed || this.category.isCollapsed, this.category.guild.optInEnabled)), {
      threadIds: [],
      renderLevel: n
    }
  }
...
function e_(e, t, n) {
  switch (e.type) {
    case G.d4z.GUILD_VOICE: {
      ...
      let o = a.ZP.getEmbeddedActivitiesForChannel(e.id).map(e => {
        var t;
