...
class et {
  ...
  _areGuildVocalChannelsInRecentsInNeedOfAppearingInActiveNow(e) {
    ...
    for (let e in r.channels) {
      let t = r.channels[e];
      if (2 === t.renderLevel && t.record.isGuildVocal() && null == n.channels[t.id] && o().some(D.Z.getVoiceStatesForChannel(t.id)) && P.ZP.getMentionCount(t.id) > 0) returntrue
    }
    returnfalse
  }
  getGuild(e, t, n) {
...
class en {
  get initializationData() {
    return {
      selectedChannel: T.Z.getChannel(w.Z.getChannelId()),
  ...
  constructor(e, t, n) {
    ...
    for (let e in s) {
      ...
      if (t.type !== G.d4z.GUILD_CATEGORY) {
        ...
        eI(this, t, O) ? p.push(t) : (t.type === G.d4z.GUILD_VOICE || t.type === G.d4z.GUILD_STAGE_VOICE) && (null != t.parent_id && null != c[t.parent_id] && m.push(c[t.parent_id]), m.push(t)), null != t.parent_id && t.parent_id in f ? f[t.parent_id].push(t) : u.push(t)
      }
    }
    for (let e in this.categories = {}, f) this.categories[e] = new ea(this, c[e], f[e], O);
    this.recentsSectionNumber = X, this.favoritesSectionNumber = Q, this.noParentCategory = new ei(this, u, O), this.favoritesCategory = new eo(this, O), this.recentsCategory = (0, _.Q)() ? new es(this, s, O) : new el(this, p, O), this.voiceChannelsCategory = new eu(this, m, c, O), this.guildActionSection = new ef(t, E.length > 0), this.channelNoticeSection = new ed(n), i()(!("null" in this.categories), "somehow a null got into categories"), this.voiceChannelsSectionNumber = $ + o().size(this.categories)
  }
}
class er {
  updateChannel(e, t) {
...
class ea extends er {
  shouldShowEmptyCategory() {
    return !!(super.shouldShowEmptyCategory() || N.Z.can(F.Pl.MANAGE_CHANNELS, this.record) && N.Z.can(F.Pl.VIEW_CHANNEL, this.record) && o().isEmpty(this.channels) && (!this.guild.optInEnabled || this.guild.optedInChannels.has(this.id)))
  }
  constructor(e, t, n, r) {
...
class eo extends er {
  updateChannel(e, t) {
    let n = e.id in this.channels && R.ZP.isFavorite(e.guild_id, e.id),
  ...
  constructor(e, t) {
    ...
    this.channels = o()(null != (n = R.ZP.getGuildFavorites(e.id)) ? n : []).map(e => T.Z.getChannel(e)).filter(L.lm).map(e => new eh(this, e, t)).keyBy(e => e.id).value();
    let r = h.Z.getSuggestedChannelId(e.id),
      i = T.Z.getChannel(r);
    null != i && null != r && (this.channels[r] = new eh(this, i, Y(V({}, t), {
      activeJoinedRelevantThreads: {},
      activeJoinedUnreadThreads: {}
    })))
  }
...
class es extends er {
  ...
  constructor(e, t, n) {
    if (super(e), B(this, "enabled", false), this.isCollapsed = m.Z.isCollapsed(e.id), this.enabled = eO() && Object.keys(t).length >= es.MIN_READABLE_CHANNELS, this.enabled)
...
class eu extends er {
  ...
  getShownChannelIds() {
    ...
    if (null == this.shownChannelIds) {
      ...
      for (let n = 0; n < t.length; n++) {
        var e;
        let r = t[n];
        n < t.length - 1 && r.record.type === G.d4z.GUILD_CATEGORY && (null == (e = t[n + 1]) ? true : e.record.type) === G.d4z.GUILD_CATEGORY || (n !== t.length - 1 || r.record.type !== G.d4z.GUILD_CATEGORY) && this.shownChannelIds.push(r.id)
      }
    }
    return this.shownChannelIds
  }
  ...
  constructor(e, t, n, r) {
    ...
    this.isCollapsed = k.Z.isVoiceCategoryCollapsed(e.id), this.isMuted = false, this.categoriesById = n, this.channels = o()(t).map(e => new eE(this, e, r)).keyBy(e => e.id).value()
  }
}
class ed {
  isEmpty() {
...
class ep {
  ...
  updateSubtitle() {
    ...
    return !o().isEqual(this.subtitle, e) && (this.subtitle = e, true)
  }
  computeSubtitle() {
...
class e_ extends ep {
  computeState(e) {
    ...
    return this.id !== l.moderatorReportChannelId || l.moderatorReportChannelEnabled ? l.optInEnabled && l.hideResourceChannels && this.record.hasFlag(Z.zZ.IS_GUILD_RESOURCE_CHANNEL) ? {
      renderLevel: c ? 4 : 1,
      threadIds: p
    } : !l.optInEnabled || l.optedInChannels.has(this.id) || null != s && l.optedInChannels.has(s) ? c || d || !o().isEmpty(p) || P.ZP.getMentionCount(this.id) > 0 ? {
      renderLevel: 4,
      threadIds: p
...
class eg extends e_ {
  computeState(e) {
    ...
    if (t > 1) {
      ...
      i.mutedChannelIds.has(this.id) || null != r && i.mutedChannelIds.has(r) ? t = 2 : 4 === t ? t = 3 : 2 === t && eI(this.category.guild, this.record, e) && (t = 3), 3 === t && eS(this, e) && (t = 4), n = o().sortBy(n, e => -P.ZP.lastMessageTimestamp(e))
    }
    return {
      renderLevel: t,
      threadIds: n
...
class eE extends e_ {
  getRenderLevel(e) {
    ...
    return !N.Z.can(F.Pl.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || ev(t, this.record) ? 1 : this.category.isCollapsed ? o().some(D.Z.getVoiceStatesForChannel(this.record.id)) ? 4 : 3 : 4
  }
  computeState(e) {
...
function ey(e, t, n, r, i) {
  ...
  if (S.uC.has(e.type)) {
    ...
    return a ? e : s ? (n.id in t || e.unshift(n.id), e) : i ? e.filter(e => !v.Z.isMuted(e) || P.ZP.getMentionCount(e) > 0) : e
  }
  return []
}
