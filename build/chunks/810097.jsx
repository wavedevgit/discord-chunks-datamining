...
function N(e) {
  ...
  return <u.ZP className={a()(E.popover, {
      [E.visible]: o,
      [E.expandable]: b,
      [E.statusPopover]: n === m.n_.STATUS,
      [E.avatarPopover]: n === m.n_.AVATAR,
      [E.activityPopover]: n === m.n_.ACTIVITY
    })}>{<c.DY3 text={g.intl.string(g.t.nhaI4e)} shouldShow={o} className={E.tooltipContainer} delay={0} aria-label={false}><u.zx onClick={x} className={E.button} aria-label={S[n]()} aria-haspopup={"dialog"}><c.EO4 size={"xs"} className={E.icon} /></u.zx></c.DY3>}{<c.DY3 text={g.intl.string(g.t.RmDYKC)} shouldShow={o} className={E.tooltipContainer} delay={0} aria-label={false}><u.zx onClick={M} className={E.button} aria-label={A[n]()} aria-haspopup={"dialog"}><c.n$P size={"xs"} className={E.icon} /></u.zx></c.DY3>}{null == N ? true : N(e => {
      let t = () => {
        var t;
        L(C), null == (t = e.onClick) || t.call(e)
      };
      return <c.DY3 text={g.intl.string(g.t.UKOtz8)} shouldShow={o} className={E.tooltipContainer} delay={0} aria-label={false}><u.zx{...v(y({
          ref: C
        }, e), {
          onClick: t,
          className: E.button,
