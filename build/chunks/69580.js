...
function ed(e) {
  ...
  let [eP, ew] = i.useState(null), [eD, eL] = i.useState(null), [ex, eM] = i.useState(null), [ek, ej] = i.useState(!1), [eU, eG] = i.useState(!1), eB = null == eP ? void 0 : eP.guilds, [eV, eF] = i.useState(null != e_ ? e_ : null), [eZ, eH] = i.useState(null != ep ? ep : null), [eY, eW] = i.useState(k.Hn), [eK, ez] = i.useState(!1), eq = i.useMemo(() => (null == eP ? void 0 : eP.user) != null ? new L.Z(eP.user) : null, [null == eP ? void 0 : eP.user]), eX = (0, A.Z)(null != (t = null == eP ? void 0 : eP.application) ? t : null), eQ = i.useMemo(() => null == eB ? void 0 : eB.find(e => e.id === eV), [eB, eV]), [eJ, e$] = i.useState(null), e0 = i.useMemo(() => {
    var e;
  ...
  switch (eD) {
    ...
    case "AUTHORIZE_SCOPES":
      ...
      }), e5.includes(u.x.BOT) && !d.fS(e8, k.Hn) && (v = "AUTHORIZE_BOT_PERMISSIONS"), to.length > 1 && (m = "SELECT_INSTALL_TYPE"), t_ = tO && null == eQ || ty && null == eZ, tf = !0;
      break;
