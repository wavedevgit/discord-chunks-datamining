...
function el() {
  ...
  if (i.useEffect(() => {
      ...
      } else l.tq || !o && x.default.isAuthenticated() || u.current || (u.current = !0, Promise.resolve().then(n.bind(n, 536285)).then(t => {
        let {
          default: n
        } = t;
...
function ed(e) {
  ...
  let [eP, ew] = i.useState(null), [eD, eL] = i.useState(null), [ex, eM] = i.useState(null), [ek, ej] = i.useState(!1), [eU, eG] = i.useState(!1), eB = null == eP ? void 0 : eP.guilds, [eZ, eF] = i.useState(null != e_ ? e_ : null), [eV, eH] = i.useState(null != ep ? ep : null), [eY, eW] = i.useState(k.Hn), [eK, ez] = i.useState(!1), eq = i.useMemo(() => (null == eP ? void 0 : eP.user) != null ? new L.Z(eP.user) : null, [null == eP ? void 0 : eP.user]), eX = (0, A.Z)(null != (t = null == eP ? void 0 : eP.application) ? t : null), eQ = i.useMemo(() => null == eB ? void 0 : eB.find(e => e.id === eZ), [eB, eZ]), [eJ, e$] = i.useState(null), e0 = i.useMemo(() => {
    var e;
    ...
    to = i.useCallback(async () => {
      ...
      if (!e7.current && !ti.current) {
        ...
        try {
          ...
          ew((0, B.d)(e)), el === V.s.NONE && e.authorized && !tt && tr(!0), (0, O.yw)(ee.rMx.OAUTH2_AUTHORIZE_VIEWED, {
...
function ef(e, t) {
  ...
  }, e))) : l && (null == a ? void 0 : a.startsWith(ee.Z5c.OAUTH2_ERROR)) ? (0, _.h7)(e => {
    var t, n;
