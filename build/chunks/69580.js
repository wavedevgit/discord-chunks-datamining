...
function eb(e) {
  ...
  switch (eG) {
    ...
    case "AUTHORIZE_SCOPES":
      ...
      }), tt.includes(u.x.BOT) && !f.fS(tr, F.Hn) && (N = "AUTHORIZE_BOT_PERMISSIONS"), tf.length > 1 && (T = "SELECT_INSTALL_TYPE"), tb = tN && null == e3 || tA && null == eQ, tE = !0;
      break;
