...
function ed(e) {
  ...
  let [eP, ew] = i.useState(null), [eD, eL] = i.useState(null), [ex, ek] = i.useState(null), [eM, ej] = i.useState(!1), [eU, eG] = i.useState(!1), eB = null == eP ? void 0 : eP.guilds, [eV, eF] = i.useState(null != ef ? ef : null), [eZ, eH] = i.useState(null != ep ? ep : null), [eY, eW] = i.useState(M.Hn), [eK, ez] = i.useState(!1), eq = i.useMemo(() => (null == eP ? void 0 : eP.user) != null ? new L.Z(eP.user) : null, [null == eP ? void 0 : eP.user]), eX = (0, A.Z)(null != (t = null == eP ? void 0 : eP.application) ? t : null), eQ = i.useMemo(() => null == eB ? void 0 : eB.find(e => e.id === eV), [eB, eV]), [eJ, e$] = i.useState(null), e0 = i.useMemo(() => {
    var e;
    ...
    ta = i.useCallback(async () => {
      ...
      if (!e7.current && !ti.current) {
        ...
        try {
          ...
          ew((0, B.d)(e)), el === Z.s.NONE && e.authorized && !tt && tr(!0), (0, O.yw)(ee.rMx.OAUTH2_AUTHORIZE_VIEWED, {
  ...
  switch (eD) {
    ...
    case "AUTHORIZE_SCOPES":
      ...
      }), e5.includes(u.x.BOT) && !d.fS(e8, M.Hn) && (v = "AUTHORIZE_BOT_PERMISSIONS"), to.length > 1 && (m = "SELECT_INSTALL_TYPE"), tf = tO && null == eQ || ty && null == eZ, t_ = !0;
      break;
...
function e_(e, t) {
  ...
  l && o === ee.Z5c.OAUTH2_AUTHORIZED ? (0, f.h7)(e => (0, r.jsx)(J.jO, ea({
    guild: t.guild,
    application: t.application
  }, e))) : l && (null == o ? void 0 : o.startsWith(ee.Z5c.OAUTH2_ERROR)) ? (0, f.h7)(e => {
    var t, n;
