...
function el() {
  ...
  if (i.useEffect(() => {
      ...
      } else l.tq || !a && x.default.isAuthenticated() || u.current || (u.current = !0, Promise.resolve().then(n.bind(n, 536285)).then(t => {
        let {
          default: n
        } = t;
    ...
    return e = !0 === d ? (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsx)(N.Dx, {
        children: en.intl.string(en.t.csrAMD)
      }), (0, r.jsx)(N.DK, {
      ...
      children: [(0, r.jsx)(N.Dx, {
        children: en.intl.string(en.t["Z+hCVV"])
      }), (0, r.jsx)(p.$, {})]
    }), (0, r.jsx)(X.G, {
...
function ed(e) {
  ...
  let [eR, eP] = i.useState(null), [eD, eL] = i.useState(null), [ex, ek] = i.useState(null), [ej, eM] = i.useState(!1), [eU, eG] = i.useState(!1), eB = null == eR ? void 0 : eR.guilds, [eZ, eF] = i.useState(null != e_ ? e_ : null), [eV, eH] = i.useState(null != ep ? ep : null), [eY, eW] = i.useState(j.Hn), [eK, ez] = i.useState(!1), eq = i.useMemo(() => (null == eR ? void 0 : eR.user) != null ? new L.Z(eR.user) : null, [null == eR ? void 0 : eR.user]), e$ = (0, A.Z)(null != (t = null == eR ? void 0 : eR.application) ? t : null), eX = i.useMemo(() => null == eB ? void 0 : eB.find(e => e.id === eZ), [eB, eZ]), [eQ, eJ] = i.useState(null), e0 = i.useMemo(() => {
    var e;
    return null == eN && null == eh && (null != (e = null == ed ? void 0 : ed.length) ? e : 0) === 0 && null == et
  }, [eN, null == ed ? void 0 : ed.length, et, eh]), [e1, e2] = i.useState(null);
  i.useEffect(() => {
  ...
  let tr = i.useCallback(async e => {
      ...
      try {
        ...
        if (e && (await (0, S.x9)(R, e9), setTimeout(() => {
            b.Z.fetch()
          }, 100)), null != eO) eO({
          application: null == eR ? void 0 : eR.application,
          location: n.location,
          ...
          M.Z.isDiscordUrl(n.location) && e === ee.Z5c.OAUTH2_AUTHORIZED ? (0, P.uL)(ee.Z5c.OAUTH2_AUTHORIZED, {
            state: {
              application: null == eR ? void 0 : eR.application,
              guild: eX
            }
    ...
    ta = i.useCallback(async () => {
      ...
      if (!e7.current && !ti.current) {
        ...
        try {
          ...
          eP((0, B.d)(e)), el === V.s.NONE && e.authorized && !tt && tr(!0), (0, O.yw)(ee.rMx.OAUTH2_AUTHORIZE_VIEWED, {
  ...
  }, [eN, to, e1, e0, eh, eD, ew]), i.useEffect(() => {
  ...
  switch (eD) {
    ...
    case "AUTHORIZE_SCOPES":
      if (null == eR || null == eq || null == eQ) return {
        label: en.intl.string(en.t.ZTNur6),
        body: (0, r.jsx)(eu, {})
      };
      ...
      }), e4.includes(u.x.BOT) && !d.fS(e8, j.Hn) && (v = "AUTHORIZE_BOT_PERMISSIONS"), to.length > 1 && (m = "SELECT_INSTALL_TYPE"), t_ = tO && null == eX || ty && null == eV, tf = !0;
      break;
  ...
  return th && null != eR && null != eq && (C = (0, r.jsx)(q.Z, {
    user: eq,
    application: eR.application,
    bot: eR.bot,
    accountScopes: e6,
...
function ef(e, t) {
  ...
  l && o === ee.Z5c.OAUTH2_AUTHORIZED ? (0, _.h7)(e => (0, r.jsx)(Q.jO, ea({
    guild: t.guild,
    application: t.application
  }, e))) : l && (null == o ? void 0 : o.startsWith(ee.Z5c.OAUTH2_ERROR)) ? (0, _.h7)(e => {
    var t, n;
    let i = null != (n = null != (t = null == s ? void 0 : s.get("error_description")) ? t : null == s ? void 0 : s.get("error")) ? n : en.intl.string(en.t["mqn87+"]);
    return Array.isArray(i) && (i = i[0]), (0, r.jsx)(X.j, es(ea({}, e), {
