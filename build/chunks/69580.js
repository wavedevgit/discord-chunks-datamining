...
function eg(e) {
    ...
    ta = i.useCallback(async () => {
      ...
      if (!e9.current && !to.current) {
        ...
        try {
          ...
          ek((0, V.d)(e)), eh === Y.s.NONE && e.authorized && !tn && ti(!0), (0, I.yw)(ei.rMx.OAUTH2_AUTHORIZE_VIEWED, {
  ...
  let tc = i.useCallback(e => {
    ...
    tu = (0, S.O)(tc);
  if (eG instanceof Error) return ew ? {
    body: (0, r.jsx)(et.Lk, {
      message: eG.message
    })
  } : {
  ...
  return tm && null != eM && null != eJ && (P = (0, r.jsx)(J.Z, {
    ...
    }), "SELECT_INSTALL_TYPE" !== ej ? eV ? (0, r.jsx)("div", {
      className: es.action,
      children: (0, r.jsx)(h.zx, {
