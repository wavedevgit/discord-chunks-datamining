...
function eh() {
  ...
  if (i.useEffect(() => {
    ...
    return e = !0 === d ? (0, r.jsxs)(r.Fragment, {
      ...
      children: [(0, r.jsx)(R.Dx, {
        children: eo.intl.string(eo.t["Z+hCVV"])
      }), (0, r.jsx)(E.$, {})]
    }), (0, r.jsx)(ee.G, {
...
function eg(e) {
  ...
  let [ej, eU] = i.useState(null), [eG, eB] = i.useState(null), [eV, eF] = i.useState(null), [eZ, eH] = i.useState(!1), [eY, eW] = i.useState(!1), eK = null == ej ? void 0 : ej.guilds, [ez, eq] = i.useState(null != ev ? ev : null), [eQ, eX] = i.useState(null != eO ? eO : null), [eJ, e$] = i.useState(G.Hn), [e0, e1] = i.useState(!1), e2 = i.useMemo(() => (null == ej ? void 0 : ej.user) != null ? new M.Z(ej.user) : null, [null == ej ? void 0 : ej.user]), e3 = i.useMemo(() => null == eK ? void 0 : eK.find(e => e.id === ez), [eK, ez]), [e4, e5] = i.useState(null), e6 = i.useMemo(() => {
    var e;
  ...
  let tc = i.useCallback(async e => {
      ...
      try {
        ...
        if (e && (await (0, C.x9)(ea, ta), setTimeout(() => {
            v.Z.fetch()
          }, 100)), null != eR) eR({
          application: null == ej ? void 0 : ej.application,
          location: n.location,
  ...
  return tv && null != ej && null != e2 && (D = (0, r.jsx)(J.Z, {
    id: ep,
    user: e2,
    application: ej.application,
    bot: ej.bot,
      ...
      children: (0, r.jsx)(b.ua7, {
        ...
        children: e => (0, r.jsx)("div", ed(ec({}, e), {
          ...
          children: (0, r.jsxs)(h.zx, {
            ...
            children: [eo.intl.string(eo.t.N22i9P), " ", (0, r.jsx)(O.Z, {
              className: es.emoji,
...
function eE(e, t) {
  ...
  let {
    ...
    pathname: o,
    searchParams: s
  } = null != (n = B.Z.toURLSafe(t.location)) ? n : {}, l = B.Z.isDiscordHostname(null != a ? a : null) || window.location.host === a;
  l && o === ei.Z5c.OAUTH2_AUTHORIZED ? (0, m.h7)(e => {
    let n = (0, r.jsx)(et._Z, {
      guild: t.guild,
  ...
  }) : l && (null == o ? void 0 : o.startsWith(ei.Z5c.OAUTH2_ERROR)) ? (0, m.h7)(e => {
    var t, n;
