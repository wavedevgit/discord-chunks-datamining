...
function eu(e) {
  ...
  let [eC, eR] = i.useState(null), [eP, ew] = i.useState(null), [eD, eL] = i.useState(null), [ex, eM] = i.useState(!1), [ek, ej] = i.useState(!1), eU = null == eC ? void 0 : eC.guilds, [eG, eB] = i.useState(null != ed ? ed : null), [eV, eF] = i.useState(null != ef ? ef : null), [eZ, eH] = i.useState(M.Hn), [eY, eW] = i.useState(!1), eK = i.useMemo(() => (null == eC ? void 0 : eC.user) != null ? new D.Z(eC.user) : null, [null == eC ? void 0 : eC.user]), ez = i.useMemo(() => null == eU ? void 0 : eU.find(e => e.id === eG), [eU, eG]), [eq, eX] = i.useState(null), eQ = i.useMemo(() => {
    var e;
    return null == eS && null == e_ && (null != (e = null == el ? void 0 : el.length) ? e : 0) === 0 && null == X
  }, [eS, null == el ? void 0 : el.length, X, e_]), [eJ, e$] = i.useState(null);
  i.useEffect(() => {
  ...
  }, [eS, tr, eJ, eQ, e_, eP, eN]), i.useEffect(() => {
  ...
  return tf && null != eC && null != eK && (A = (0, r.jsx)(z.Z, {
    user: eK,
    application: eC.application,
    bot: eC.bot,
    accountScopes: e3,
...
function ed(e, t) {
  ...
  }, e))) : l && (null == o ? void 0 : o.startsWith($.Z5c.OAUTH2_ERROR)) ? (0, _.h7)(e => {
    var t, n;
