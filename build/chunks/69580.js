...
function eu(e) {
  ...
  let [eC, eR] = i.useState(null), [eP, ew] = i.useState(null), [eD, eL] = i.useState(null), [ex, ek] = i.useState(!1), [eM, ej] = i.useState(!1), eU = null == eC ? void 0 : eC.guilds, [eG, eB] = i.useState(null != ed ? ed : null), [eV, eF] = i.useState(null != e_ ? e_ : null), [eZ, eH] = i.useState(k.Hn), [eY, eW] = i.useState(!1), eK = i.useMemo(() => (null == eC ? void 0 : eC.user) != null ? new D.Z(eC.user) : null, [null == eC ? void 0 : eC.user]), ez = i.useMemo(() => null == eU ? void 0 : eU.find(e => e.id === eG), [eU, eG]), [eq, eX] = i.useState(null), eQ = i.useMemo(() => {
    var e;
  ...
  switch (eP) {
    ...
    case "AUTHORIZE_SCOPES":
      ...
      }), e2.includes(u.x.BOT) && !d.fS(e4, k.Hn) && (m = "AUTHORIZE_BOT_PERMISSIONS"), tr.length > 1 && (h = "SELECT_INSTALL_TYPE"), tu = tE && null == ez || tg && null == eV, tc = !0;
      break;
  ...
  }), "SELECT_INSTALL_TYPE" !== eP && ty.push(eM ? {
