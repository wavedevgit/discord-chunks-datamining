...
let b = ["#51BC9D"],
  j = e => {
    ...
    } = (0, f.G)(), O = (null == (t = j.userStatus) ? void 0 : t.completedAt) != null, E = o.useRef(!1), S = (0, u.e7)([p.Z], () => p.Z.useReducedMotion), w = o.useRef(null), P = (0, u.e7)([m.Z], () => m.Z.hasLayers()), T = (0, d.Z)(P), [N, A] = o.useState(null), [R, k] = o.useState(null), B = o.useRef(new i.qA({
      gravity: 0,
      wind: 0
    })), I = (0, i.uR)(N, R), q = o.useCallback(() => {
      if (S) return;
      let e = _.current,
        t = w.current;
