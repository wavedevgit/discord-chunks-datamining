...
function x(e) {
  let {
    ...
    let e;
    return null != E ? w.intl.string(w.t.qB8ayc) : null == s ? null : (e = s.interval === P.rV.MONTH ? M ? F ? B.monthGiftText : w.t["4ZJ+7e"] : w.t["P+z55e"] : M ? F ? B.yearGiftText : w.t.p0pZXF : w.t.bXqk3t, w.intl.format(e, {
      skuName: (0, A.aq)(s.id),
