...
function k(e) {
  let {
    ...
    giftMessageError: b,
    isSendingMessage: y
  } = e, [v, S] = i.useState(u.kO8.Modes.DEFAULT), k = (0, c.e7)([I.Z], () => I.Z.enabled), j = f || null != l && null != h, U = (null == a ? void 0 : a.productLine) === R.POd.COLLECTIBLES, G = (0, E.Z)(), {
    selectedGiftingPromotionReward: B
  } = (0, P.wD)(), F = null == G ? void 0 : G.giftPurchaseConfirmation, V = (0, g.tK)(null == B ? void 0 : B.skuId), Z = (0, g.a5)(s) && null != V && null != F, H = () => null != s ? s.skuId : null != a ? a.id : null, Y = () => {
    let e;
    return null != b ? D.intl.string(D.t.qB8ayc) : null == s ? null : (e = s.interval === w.rV.MONTH ? j ? Z ? F.monthGiftText : D.t["4ZJ+7e"] : D.t["P+z55e"] : j ? Z ? F.yearGiftText : D.t.p0pZXF : D.t.bXqk3t, D.intl.format(e, {
      skuName: (0, N.aq)(s.id),
      intervalCount: s.intervalCount
    }))
  }, W = () => null != h || f && null == b ? D.intl.string(D.t.zOmK9P) : null != b ? D.intl.string(D.t.d1lrmZ) : D.intl.string(D.t["/s1xR0"]), K = (e, t) => {
    null != a && (0, A.dM)(new O.Z({
      code: t,
      maxUses: 1
    }), a), (0, T.JG)(e, () => S(u.kO8.Modes.SUCCESS), () => S(u.kO8.Modes.ERROR)), setTimeout(() => {
...
let M = e => {
  ...
  })), I = Array.from(E.values()), T = (0, c.e7)([v.Z], () => v.Z.getFriendIDs()), A = l().difference(T, I), N = [...I, ...A], P = (0, c.e7)([S.default], () => S.default.filter(e => N.includes(e.id) && !e.bot), [N]);
  if (null == P || 0 === P.length) return null;
  let R = l().sortBy(P, e => N.indexOf(e.id));
  return (0, r.jsxs)("div", {
    className: L.giftRecipientSection,
    children: [(0, r.jsx)(u.vwX, {
      children: D.intl.string(D.t.MJw05e)
    }), (0, r.jsxs)("div", {
      className: L.giftRecipient,
