...
function k(e) {
  let {
    ...
    giftMessageError: b,
    isSendingMessage: y
  } = e, [v, S] = i.useState(u.kO8.Modes.DEFAULT), k = (0, c.e7)([I.Z], () => I.Z.enabled), j = f || null != l && null != h, U = (null == o ? void 0 : o.productLine) === R.POd.COLLECTIBLES, G = (0, E.Z)(), {
    selectedGiftingPromotionReward: B
  } = (0, P.wD)(), F = null == G ? void 0 : G.giftPurchaseConfirmation, V = (0, g.tK)(null == B ? void 0 : B.skuId), Z = (0, g.a5)(s) && null != V && null != F, H = () => null != s ? s.skuId : null != o ? o.id : null, Y = () => {
    let e;
