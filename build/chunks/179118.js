...
function M(e) {
  let {
    ...
    null != a && (0, A.dM)(new O.Z({
      code: t,
      maxUses: 1
    }), a), (0, S.JG)(e, () => T(d.kO8.Modes.SUCCESS), () => T(d.kO8.Modes.ERROR)), setTimeout(() => {
...
let k = e => {
  ...
  })), S = Array.from(O.keys()).sort((e, t) => y.Z.compare(e, t)), A = (0, c.e7)([v.Z], () => v.Z.getFriendIDs()), N = l().difference(A, S), R = [...S, ...N], P = (0, c.e7)([T.default], () => T.default.filter(e => R.includes(e.id) && !e.bot), [R]);
