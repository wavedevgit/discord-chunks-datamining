...
function v(e) {
  ...
  let {
    ...
    allowFetch: s = true
  } = e, o = (0, f.SD)(i, true, s), l = (0, f.A4)(true, s);
  return r.useMemo(() => {
    var e, t, n, r, s;
    let c = null != (e = null == (n = o.result) ? true : n.sections) ? e : {},
    ...
    return {
      commands: p,
      commandSectionMap: _,
      loading: true === o.fetchState.fetching || true === l.fetchState.fetching
    }
...
function S(e) {
  ...
  return n => {
    let {
      ...
      isGuildInstalled: c,
      isUserInstalled: u
    } = (0, f.Sx)(e, n.id), d = (null == r ? true : r.guild_id) != null ? _.we(null == o ? true : o.permissions, r.guild_id, i, a, s) : null, p = (null == r ? true : r.guild_id) != null ? _._W(null == o ? true : o.permissions, r, r.guild_id) : null;
  ...
  return r => {
    ...
    if (!(r.applicationId in n)) {
      let {
        ...
        isGuildInstalled: l,
        isUserInstalled: c
      } = (0, f.Sx)(e, r.applicationId), u = (null == i ? true : i.guild_id) != null ? _.we(null == t ? true : t.permissions, i.guild_id, a, s, o) : null, d = (null == i ? true : i.guild_id) != null ? _._W(null == t ? true : t.permissions, i, i.guild_id) : null;
      n[r.applicationId] = {
        descriptor: t,
