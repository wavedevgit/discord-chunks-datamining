...
function v(e) {
  ...
  if (w) {
    ...
    return <d.Z onMount={() => {
      ...
      }} onSubmit={C} onClose={t} ratingHeader={E} ratingEmojiKind={x} ratingBody={P} categoriesHeader={O.intl.string(g.default["tq859/"])} optionsTree={[e, n, r, i]} impression={k} transitionState={v} />
  }
  return <u.Z modalType={"voice"} header={E} ratingEmojiKind={x} body={P} impression={k} problemTitle={O.intl.string(O.t.FJmoxM)} problems={(0, b.Z)({
      isMobile: false,
      showVibesHoneypot: j
    })} freeformNeededProblems={h} onSubmit={C} onClose={t} transitionState={v} otherKey={b.b.OTHER} />
}