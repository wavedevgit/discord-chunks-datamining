...
function D(e) {
  let {
    ...
    analyticsOverride: I,
    ref: T
  } = e, D = (0, f.GV)(), [L, x] = i.useState(false), M = (0, _.Fj)(t.guild_id), j = (0, s.uniqBy)([...M, ...w], "name").filter(e => !y.Ay.isEmojiFilteredOrLocked({
    emoji: e,
    channel: t,
    intention: N
  })).slice(0, 8);
  ...
  let k = e => {
    ...
    G = e => {
      null != e && e.key !== v.dh.TAB && (e.key !== v.dh.ENTER || e.shiftKey ? k(true) : k(!L))
    };
