...
function W(e) {
  let {
    ...
    "aria-setsize": m,
    "aria-posinset": p
  } = e, b = (0, u.JA)(n.id), [E, y] = a.useState(!1), I = a.useRef(!1), S = a.useCallback(() => {
    if ("send" === l) {
      y(!0), I.current = !0;
      return
    }
    null == g || g(n)
  }, [l, g, n]), A = a.useCallback(() => {
  ...
  }, [t.channel_id, t.id, g, n]), O = a.useCallback(() => {
    y(!1), I.current = !1, C.default.track(Z.rMx.FORWARD_ONE_TAP_UNDO, {
      channel_id: t.channel_id,
      message_id: t.id
    })
  }, [t]);
  return (0, _.ZP)(() => () => {
    ...
    }), "toggle" === l && !h && (0, r.jsx)(f.XZJ, {
      type: f.XZJ.Types.INVERTED,
      displayOnly: !0,
      size: 24,
      value: d,
      className: R.checkbox
    }), "send" === l && !h && (0, r.jsxs)("div", {
      className: R.actions,
      children: [E ? (0, r.jsx)(f.zxk, {
...
function z(e) {
  ...
  let h = a.useMemo(() => [t.length], [t.length]),
    ...
    b = a.useCallback(e => {
      ...
      return u === m.h8.USER ? (0, r.jsx)(U, k({
        user: d
      }, b)) : u === m.h8.GROUP_DM ? (0, r.jsx)(H, k({
        channel: d
      }, b)) : u === m.h8.TEXT_CHANNEL || u === m.h8.VOICE_CHANNEL ? (0, r.jsx)(Q, k({
        channel: d
      }, b)) : void(0, L.vE)(u)
    }, [c, o, l, i, t, n, p]),
    E = a.useRef(null),
