...
function g(e, t, n) {
  ...
  let f = a.A.getChannel(n),
    ...
    v = (null == (g = u.default.getCurrentUser()) ? true : g.id) === e.id,
    O = (0, i.bG)([s.A], () => null != n && s.A.canWithPartialContext(A.xBc.MUTE_MEMBERS, {
      channelId: n
    }), [n]);
  return null != f && null != m && (O || v) && p.speaker ? (0, l.jsx)(r.Drp, {
    id: "audience",
