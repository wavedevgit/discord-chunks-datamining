...
let j = e => {
  ...
  return <l.Modal title={u.intl.string(u.t.XlDE3t)} subtitle={u.intl.string(u.t.lVqhdX)} transitionState={y} onClose={f} actions={[{
      variant: "secondary",
      ...
      onClick: S,
      autoFocus: true
    }]}>{<s.Z reactionEmoji={g} />}{<r.hE2 size={"sm"} className={m.buttonRow}>{<r.yRy targetElementRef={k} renderPopout={e => {
          let {
            closePopout: t
          } = e;
          return (0, i.jsx)(c.Z, {
        ...
        }} position={"right"} animation={r.yRy.Animation.NONE} align={"center"}>{e => {
          var t, n;
        ...
        }}</r.yRy>}{null != g && <r.zxk text={u.intl.string(u.t.N86XcH)} variant={"critical-secondary"} onClick={() => I(null)} />}</r.hE2>}{E ? <r.Text variant={"text-sm/normal"} color={"text-danger"}>{u.intl.string(u.t.F75nNj)}</r.Text> : null}</l.Modal>
}