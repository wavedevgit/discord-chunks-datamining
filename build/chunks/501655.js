...
function S(e) {
  ...
  let {
    ...
    voiceState: l,
    type: c
  } = e, u = n ? "\0" : "\x01", d = "STREAM" === c ? "\0" : "\x01", _ = l.selfMute ? "\x01" : "\0", f = l.selfVideo ? "\0" : "\x01", p = "".concat(null != (t = null == r ? void 0 : r.position) ? t : 999).padStart(3, "0");
  return "".concat(u).concat(d).concat(_).concat(f).concat(p).concat(s).concat((0, i.Z)(o, a))
}
