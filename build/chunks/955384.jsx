...
class _ extends Chunk73800.PureComponent {
  render() {
    let {
      ...
      onCancel: a,
      children: s
    } = this.props, l = <div className={Chunk224079.operations}>{Chunk388032.intl.format(Chunk388032.t.wDsPXl, {
        onCancel: () => Chunk925975(Chunk911969.id),
        onSave: this.onClickSave
      })}</div>;
    return <div className={module} ref={this.node} onContextMenu={f}>{Chunk957730({
        textValue: exports,
        richValue: require,
        message: Chunk73800,
        channel: Chunk911969,
