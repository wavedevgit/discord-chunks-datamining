...
function v(e) {
  ...
  } = e, n = r.useRef(null), [s, l] = r.useState(!1), a = () => {
...
function D() {
  let [e, t] = r.useState(R(A)), [n, l] = r.useState(A), [a, c] = r.useState(R(P)), [d, m] = r.useState(P), [g, p] = r.useState(null), [f, _] = r.useState((0, i.jsx)(h.DS, {
