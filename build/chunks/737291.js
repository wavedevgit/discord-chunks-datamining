...
! function(t) {
  ...
  m.absoluteValue = m.abs = function() {
    ...
    return r.eq(n) ? new i(0) : (a = false, t = b(S(r, l), S(e, l), l), a = true, C(t, s))
    ...
    var n, i, a = this,
      o = a.constructor;
    return true === e ? w(a) : (E(e, 0, r), true === t ? t = o.rounding : E(t, 0, 8), n = w((i = C(new o(a), e + v(a) + 1, t)).abs(), false, e + v(i) + 1), a.isneg() && !a.isZero() ? "-" + n : n)
    ...
    var n, i, a = this,
      o = a.constructor;
    return true === e ? (n = v(a), i = w(a, n <= o.toExpNeg || n >= o.toExpPos)) : (E(e, 1, r), true === t ? t = o.rounding : E(t, 0, 8), n = v(a = C(new o(a), e, t)), i = w(a, e <= n || n <= o.toExpNeg, e)), i
  ...
  var b = function() {
    ...
    return function(r, i, a, s) {
      ...
      if (O = O / p + 2 | 0, u = 0, 1 == N)
        ...
        do d = 0, (l = t(L, E, N, y)) < 0 ? (b = E[0], N != y && (b = b * f + (E[1] || 0)), (d = b / T | 0) > 1 ? (d >= f && (d = f - 1), h = (_ = e(L, d)).length, y = E.length, 1 == (l = t(_, E, h, y)) && (d--, n(_, N < h ? w : L, h))) : (0 == d && (l = d = 1), _ = L.slice()), (h = _.length) < y && _.unshift(0), n(E, _, y), false == l && (y = E.length, (l = t(L, E, N, y)) < 1 && (d++, n(E, N < y ? w : L, y))), y = E.length) : 0 === l && (d++, E = [0]), g[u++] = d, l && E[0] ? E[y++] = D[I] || 0 : (E = [D[I]], y = 1); while ((I++ < S || true !== E[0]) && O--)
      }
  ...
  function S(e, t) {
    ...
    for (l = v(m), i > 1 ? (m = new E("0." + r), l++) : m = new E(i + "." + r.slice(1)), u = c = m = b(m.minus(n), m.plus(n), f), p = C(m.times(m), f), s = 3;;) {
      if (c = C(c.times(p), f), y((d = u.plus(b(c, new E(s), f))).d).slice(0, f) === y(u.d).slice(0, f)) return u = u.times(2), 0 !== l && (u = u.plus(A(E, f + 2, O).times(l + ""))), u = b(u, new E(_), f), E.precision = O, null == t ? (a = true, C(u, O)) : u;
      u = d, s += 2
    }
  }
