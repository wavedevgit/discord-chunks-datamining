...
function E(e) {
  let t = (0, r.e7)([u.default], () => u.default.getCurrentUser()),
    ...
    v = C.map(r => {
      ...
      return <a.sNh id={s.id} focusedClassName={j.focused} label={e => {
          let {
            isFocused: t
          } = e;
          return (0, i.jsxs)("div", {
  ...
  return v.push(<i.Fragment>{<a.Clw />}{<a.sNh id={"manage-accounts"} label={_.intl.string(_.t.WbFpq6)} action={() => {
        null == e || e(), (0, b.Z)()
      }} />}</i.Fragment>), v
}