...
function en(e) {
  let {
    header: t
  } = e, n = w.Z.getCameraComponent(), o = (0, l.e7)([w.Z], () => w.Z.getVideoDeviceId()), a = (0, O.Z)();
  return i.useEffect(() => {
...
function er(e) {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(N.Z, {
      ...
      fullRegionButton: p,
      onClick: () => {
        (0, G.v)(s, G.d.DISCONNECT), x.default.track(V.rMx.RING_CALL_DECLINED, z({
          location: s,
          guild_id: n.guild_id
      ...
      children: (e, t) => {
        ...
        return (0, r.jsx)(R.C, {
          ...
          onChange: () => {
            var e;
            (0, G.v)(s, G.d.JOIN_VIDEO_CALL), x.default.track(V.rMx.RING_CALL_ACCEPTED, z({
              location: s,
              guild_id: n.guild_id
            }, (0, h.v_)(n))), f.default.selectVoiceChannel(n.id, !0), (0, b.XU)(null !== (e = n.guild_id) && void 0 !== e ? e : V.ME, n.id)
          }
        })
      }
    }), (0, r.jsx)(C.Z, {
      ...
      color: "join",
      centerButton: !0,
      onCallJoined: () => x.default.track(V.rMx.RING_CALL_ACCEPTED, z({
        location: s,
        guild_id: n.guild_id
      }, (0, h.v_)(n))),
      className: W.actionButton
...
function ei(e) {
  ...
  } = (0, m.ZP)(p.Z.INCOMING_CALL_MODAL), [v, y] = i.useState(!1), O = (0, l.e7)([P.Z], () => P.Z.getGuild(h.guild_id)), I = null != O ? M.ZP.getGuildIconURL({
    id: O.id,
    icon: O.icon,
    size: et
  }) : null, S = null !== (t = (0, g.x)(h, et, !0)) && void 0 !== t ? t : I, T = (0, E.ZP)(h), [A, N] = (0, l.Wu)([w.Z], () => [w.Z.supports(Z.AN.VIDEO), Object.keys(w.Z.getVideoDevices()).length]), C = null != O ? "".concat(T, ", ").concat(O.name) : T, R = (0, l.e7)([L.Z], () => L.Z.isFocused()), D = (0, l.e7)([k.Z], () => k.Z.getMode(h.id)), x = i.useCallback(e => {
    null != e.top && null != e.left && d.Z.move(e.left, e.top)
  }, []), U = (0, c.q_F)({
    value: +!!v,
    config: Q(z({}, s.config.stiff), {
      clamp: !0
    })
  }, "animate-always");
  i.useEffect(() => {
    ...
    children: (0, r.jsx)(_.Z, {
      ...
      children: (0, r.jsx)(c.f6W, {
        ...
        children: e => (0, r.jsxs)(s.animated.div, {
          className: a()(W.root, Y.elevationHigh, {
            [W.previewCamera]: v
          }, e),
          style: Q(z({}, n), {
