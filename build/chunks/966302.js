...
function eo(e) {
  let {
    ...
    cameraUnavailable: l,
    enabled: d
  } = (0, S.Z)(), _ = (0, T.Z)(n), p = i.useRef(null), g = o > 1;
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(N.Z, {
      ...
      onClick: () => {
        (0, B.v)(s, B.d.DISCONNECT), k.default.track(Z.rMx.RING_CALL_DECLINED, Q({
          location: s,
          guild_id: n.guild_id
      ...
      children: (e, t) => {
        ...
        return (0, r.jsx)(P.C, {
          ...
          className: a()(K.actionButton, {
            [K.fullRegionDropdownButtonOverride]: g
          }),
          color: "green",
          centerButton: !0,
          hasPermission: _,
          ...
          onChange: () => {
            var e;
            (0, B.v)(s, B.d.JOIN_VIDEO_CALL), k.default.track(Z.rMx.RING_CALL_ACCEPTED, Q({
              location: s,
              guild_id: n.guild_id
      ...
      color: "join",
      centerButton: !0,
      onCallJoined: () => k.default.track(Z.rMx.RING_CALL_ACCEPTED, Q({
        location: s,
        guild_id: n.guild_id
      }, (0, h.v_)(n))),
      className: K.actionButton
...
function ea(e) {
  ...
  let {
    ...
    icon: I.icon,
    size: er
  }) : null, T = null != (t = (0, g.x)(h, er, !0)) ? t : S, A = (0, E.ZP)(h), [N, C] = (0, l.Wu)([D.Z], () => [D.Z.supports(H.AN.VIDEO), Object.keys(D.Z.getVideoDevices()).length]), P = null != I ? "".concat(A, ", ").concat(I.name) : A, L = (0, l.e7)([x.Z], () => x.Z.isFocused()), k = (0, l.e7)([j.Z], () => j.Z.getMode(h.id)), G = i.useCallback(e => {
    null != e.top && null != e.left && d.Z.move(e.left, e.top)
  }, []), B = (0, c.q_F)({
    value: +!!O,
    config: J(Q({}, s.config.stiff), {
      clamp: !0
    })
  }, "animate-always");
  i.useEffect(() => {
