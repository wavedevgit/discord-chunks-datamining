...
function eo(e) {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(C.Z, {
      ...
      fullRegionButton: p,
      onClick: () => {
        (0, B.v)(s, B.d.DISCONNECT), M.default.track(Z.rMx.RING_CALL_DECLINED, Q({
          location: s,
          guild_id: n.guild_id
        ...
        return (0, r.jsx)(P.C, {
          ...
          onChange: () => {
            ...
            (0, B.v)(s, B.d.JOIN_VIDEO_CALL), M.default.track(Z.rMx.RING_CALL_ACCEPTED, Q({
              location: s,
              guild_id: n.guild_id
            }, (0, h.v_)(n))), f.default.selectVoiceChannel(n.id, !0), (0, v.XU)(null !== (e = n.guild_id) && void 0 !== e ? e : Z.ME, n.id)
          }
        })
      }
    }), (0, r.jsx)(R.Z, {
      ...
      color: "join",
      centerButton: !0,
      onCallJoined: () => M.default.track(Z.rMx.RING_CALL_ACCEPTED, Q({
        location: s,
        guild_id: n.guild_id
      }, (0, h.v_)(n))),
      className: K.actionButton
...
function ea(e) {
  ...
  } = (0, m.ZP)(p.Z.INCOMING_CALL_MODAL), [y, O] = i.useState(!1), I = (0, l.e7)([w.Z], () => w.Z.getGuild(h.guild_id)), S = null != I ? k.ZP.getGuildIconURL({
    id: I.id,
    icon: I.icon,
    size: er
