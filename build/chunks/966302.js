...
function en(e) {
  ...
  let {
    ...
    icon: O.icon,
    size: $
  }) : null, I = null !== (t = (0, m.x)(E, $, !0)) && void 0 !== t ? t : S, T = (0, g.ZP)(E), [N, A] = (0, l.Wu)([P.Z], () => [P.Z.supports(V.AN.VIDEO), Object.keys(P.Z.getVideoDevices()).length]), C = null != O ? "".concat(T, ", ").concat(O.name) : T, w = (0, l.e7)([D.Z], () => D.Z.isFocused()), k = (0, l.e7)([x.Z], () => x.Z.getMode(E.id)), j = i.useCallback(e => {
