...
function W() {
  ...
  }, []), [F, X] = s.useState(A.a.UNENROLLED), [K, Y] = s.useState(!1), [G, J] = s.useState(!1), [$, ee] = s.useState(null), et = (W = U.config, (0, i.EQ)(W).with({
    configVersion: 2
  ...
  function ec() {
    (0, m.Xv)(U.config) ? (0, y.m)(U, g.jn.GIFT_INVENTORY_FOR_YOU, !0) : (0, j.openQuestsRewardCodeModal)({
      questId: U.id,
