...
let p = function(e) {
  ...
  return 0 === h.length ? null : <div className={m.wrapper}>{t && <a.X6q variant={"heading-lg/semibold"} className={m.header}>{u.intl.string(u.t.r90Wgo)}</a.X6q>}{h.map(e => <d.Z className={m.recommendedServerCard} guildId={e} boostingVariant={true} />)}{g.length > 3 && n && <c.Z />}</div>
}