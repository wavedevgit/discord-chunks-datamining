...
function h(e) {
  ...
  return <o.Z className={c.root}><a.Z artURL={u} size={(0, a.L)(_)} header={l.intl.string(l.t.O4FiWl)} onCTAClick={() => (0, i.ZDy)(async () => {
        let {
          default: e
      ...
      })} callToAction={l.intl.string(l.t.VINpSE)} /></o.Z>
}