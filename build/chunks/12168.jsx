...
function P(e) {
  ...
  return <span ref={f}><c.P3F onClick={o} focusProps={{
        enabled: !n
      }}><c.AMe config={p.u} from={{
          value: 0
        }} to={{
          value: +!!_
        }}>{e => {
...
function w(e) {
  ...
  return <r.Fragment>{t}{<c.P3F className={I.dropDownContainer} onClick={() => {
        i(!n), o()
      }}><c.CJ0 size={"md"} color={"currentColor"} className={a()(I.dropDown, {
          [I.dropDownOpen]: n
        })} /></c.P3F>}</r.Fragment>
}
...
function D(e) {
  let {
    ...
    analyticsOverride: T,
    ref: A
  } = e, D = (0, f.Dt)(), [L, x] = i.useState(false), M = (0, _.wC)(t.guild_id), k = (0, s.uniqBy)([...M, ...R], "name").filter(e => !E.ZP.isEmojiFilteredOrLocked({
    emoji: e,
    channel: t,
    intention: C
  })).slice(0, y.e5);
  ...
  return <c.VqE aria-labelledby={D} ref={A}>{<c.y5t forceLevel={2}><c.nn4><c.H id={D}>{n}</c.H></c.nn4></c.y5t>}{<div className={I.container}>{<h.Z analyticsOverride={T} channel={t} className={a()(I.animatedPicker, {
          [I.animatedPickerTall]: L
        })} headerClassName={a()(I.emojiPickerHeader, {
          [I.emojiPickerHeaderExpanded]: L
        })} closePopout={o} onSelectEmoji={L ? U : () => {}} shouldHidePickerActions={!L} wrapper={"div"} pickerIntention={C} searchProps={N(S({}, m), {
          accessory: (0, r.jsx)(w, {
          ...
          onKeyDown: G
        })} />}{<div className={I.slotsContainer}><div className={a()(I.slots, I.slotsWide)}>{k.map(e => {
