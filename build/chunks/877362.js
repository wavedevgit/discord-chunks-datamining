...
function S(e) {
  ...
  let {
    guildId: u
  } = e, N = (0, s.e7)([h.Z], () => h.Z.getGuild(u)), S = (0, s.e7)([g.Z], () => Object.values(g.Z.getRoles(u)).find(e => {
    var t;
    return (null == e || null == (t = e.tags) ? void 0 : t.premium_subscriber) !== void 0
  })), T = (0, s.e7)([j.default], () => j.default.getCurrentUser()), A = null == T ? void 0 : T.id, R = (0, s.e7)([v.ZP], () => null != A ? v.ZP.getMember(u, A) : void 0, [A, u]), L = (null == R ? void 0 : R.premiumSince) != null, D = (0, s.e7)([p.Z], () => p.Z.useReducedMotion), {
  ...
  return null == N || null == R || null == T ? null : (0, r.jsxs)(l.$, {
    ...
    }), null != S && !L && (0, r.jsx)(x.l, {
      avatar: (0, r.jsx)(y, (n = function(e) {
