...
function S(e) {
  ...
  let {
    guildId: u
  } = e, C = (0, s.e7)([h.Z], () => h.Z.getGuild(u)), S = (0, s.e7)([g.Z], () => Object.values(g.Z.getRoles(u)).find(e => {
    var t;
    return (null == e || null == (t = e.tags) ? void 0 : t.premium_subscriber) !== void 0
  })), y = (0, s.e7)([j.default], () => j.default.getCurrentUser()), T = null == y ? void 0 : y.id, A = (0, s.e7)([v.ZP], () => null != T ? v.ZP.getMember(u, T) : void 0, [T, u]), R = (null == A ? void 0 : A.premiumSince) != null, L = (0, s.e7)([p.Z], () => p.Z.useReducedMotion), {
  ...
  return null == C || null == A || null == y ? null : (0, r.jsxs)(l.$, {
