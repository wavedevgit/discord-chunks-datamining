...
function y(e) {
  ...
  let {
    guildId: u
  } = e, N = (0, s.e7)([h.Z], () => h.Z.getGuild(u)), y = (0, s.e7)([g.Z], () => Object.values(g.Z.getRoles(u)).find(e => {
    var n;
    return (null == e || null == (n = e.tags) ? void 0 : n.premium_subscriber) !== void 0
  })), R = (0, s.e7)([j.default], () => j.default.getCurrentUser()), T = null == R ? void 0 : R.id, L = (0, s.e7)([v.ZP], () => null != T ? v.ZP.getMember(u, T) : void 0, [T, u]), A = (null == L ? void 0 : L.premiumSince) != null, k = (0, s.e7)([m.Z], () => m.Z.useReducedMotion), {
  ...
  return null == N || null == L || null == R ? null : (0, r.jsxs)(l.$, {
