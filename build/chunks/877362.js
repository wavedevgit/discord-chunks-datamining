...
function R(e) {
  ...
  let {
    guildId: d
  } = e, Z = (0, s.e7)([h.Z], () => h.Z.getGuild(d)), R = (0, s.e7)([g.Z], () => Object.values(g.Z.getRoles(d)).find(e => {
    var n;
    return (null == e || null == (n = e.tags) ? void 0 : n.premium_subscriber) !== void 0
  })), y = (0, s.e7)([j.default], () => j.default.getCurrentUser()), T = null == y ? void 0 : y.id, L = (0, s.e7)([b.ZP], () => null != T ? b.ZP.getMember(d, T) : void 0, [T, d]), k = (null == L ? void 0 : L.premiumSince) != null, A = (0, s.e7)([m.Z], () => m.Z.useReducedMotion), {
  ...
  return null == Z || null == L || null == y ? null : (0, r.jsxs)(l.$, {
