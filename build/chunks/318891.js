...
class A extends Chunk317770.Z {
  _initialize() {
    f.Z.addChangeListener(T), p.Z.addChangeListener(T), d.Z.addChangeListener(T), _.Z.addChangeListener(T), s.Z.addChangeListener(T), m.ZP.addChangeListener(T), c.Z.addChangeListener(C)
  }
  _terminate() {
    f.Z.removeChangeListener(T), p.Z.removeChangeListener(T), d.Z.removeChangeListener(T), _.Z.removeChangeListener(T), s.Z.removeChangeListener(T), m.ZP.removeChangeListener(T), c.Z.removeChangeListener(C)
  }
}
let N = new A