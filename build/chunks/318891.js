...
class N extends a.Z {
  _initialize() {
    f.Z.addChangeListener(I), _.Z.addChangeListener(I), d.Z.addChangeListener(I), p.Z.addChangeListener(I), s.Z.addChangeListener(I), m.ZP.addChangeListener(I), c.Z.addChangeListener(T)
  }
  _terminate() {
    f.Z.removeChangeListener(I), _.Z.removeChangeListener(I), d.Z.removeChangeListener(I), p.Z.removeChangeListener(I), s.Z.removeChangeListener(I), m.ZP.removeChangeListener(I), c.Z.removeChangeListener(T)
  }
}
let A = new N