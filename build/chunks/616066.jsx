...
let v = Chunk998502.ZP.getEnableHardwareAcceleration() ? Chunk481060.Xo$ : Chunk481060.qEK,
  p = e => {
    ...
    let {
      ...
      user: d,
      avatarDecorationOverride: (null == n ? true : n.type) === s.Z.AVATAR_DECORATION ? n : true,
      size: y,
    ...
    return <v{...t = function(e) {
      ...
      avatarDecoration: P,
      src: p ? null == d ? true : d.getAvatarURL(true, 152, true) : null != g ? g : w,
