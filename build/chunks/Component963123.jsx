...
function $(e) {
  ...
  }, c.X), e1 = (0, x.km)(e => e.setVideoProgress), e2 = (0, x.km)(e => e.muted), e8 = (0, x.km)(e => e.volume), e4 = (0, d.e7)([v.Z], () => v.Z.useReducedMotion), e6 = (0, l.useRef)(null), e7 = (0, l.useRef)(null), e9 = l.useRef(true), e3 = (null == (t = ee.userStatus) ? true : t.completedAt) != null, [e5, te] = l.useState(null), [tt, tn] = l.useState(false), [tr, tl] = l.useState(false), [to, ti] = l.useState(null), ta = e3 ? null != (k = null == (n = e6.current) ? true : n.duration) ? k : 0 : Math.max(e0.maxTimestampSec, eT.progressSeconds), ts = l.useMemo(() => (0, D.T)({
    quest: ee,
  ...
  let tL = l.useCallback(() => {
      var e, t;
      return null != (t = null == (e = e6.current) ? true : e.currentTime) ? t : null
    }, []),
    {
    ...
    tV = l.useCallback(e => {
      if (ts.info("[QV] | updatePlayerState | playerState: ".concat(e)), eS(e), null != e6.current) switch (e) {
        case V.rq.PLAYING:
          e6.current.paused && tO(e5), te(null), e6.current.play();
          break;
        case V.rq.PAUSED:
          e6.current.paused || tM(), e6.current.pause(), eX.current = false;
          break;
        case V.rq.ENDED:
          tM(), ed(false)
      }
  ...
  l.useEffect(() => {
    eo !== f.Dvm.HIDDEN && eo !== f.Dvm.EXITING && eo !== f.Dvm.EXITED && (null == eo || !eO || eb || e3) && (!eE || eg || e3) || null == e6.current || eC !== V.rq.PLAYING || (ts.info("[QV] | Pausing video | playerState: ".concat(eC, ", parentTransitionState: ").concat(eo, ", visible: ").concat(eb, ", focused: ").concat(eg, ", isQuestCompleted: ").concat(e3)), tV(V.rq.PAUSED), e3 || te(j.yE.LOST_FOCUS))
  ...
  let tQ = !tB && (ej || e_ || eC === V.rq.ENDED),
    tG = l.useCallback(() => {
      ...
      let t = (0, C.fn)(null == (e = e6.current) ? true : e.parentNode, e6.current);
    ...
    tz = () => {
      ...
      ts.info("[QV] | handleSeekForwardIncrement | newTime: ".concat(e)), tK(e), eC !== V.rq.ENDED && e >= e6.current.duration && tV(V.rq.ENDED), tS(j.jn.VIDEO_MODAL, S.jZ.SEEK_FORWARD)
    };
  l.useEffect(() => {
    let e = e6.current;
    return () => {
  ...
  let tK = l.useCallback(e => {
      var t;
      null != e6.current && (ts.info("[QV] | seekTimeline | timeSec: ".concat(e)), eK(e / (null != (t = e6.current.duration) ? t : 1) * 100), tM(), eN(true), tl(false), e6.current.currentTime = e, e1(ee.id, e, e6.current.duration))
    }, [e6, e1, ee.id, tM, ts]),
    tX = () => {
      if (null != e6.current) switch (ts.info("[QV] | handlePlaybackBtnClick | playerState: ".concat(eC)), eC) {
        case V.rq.ENDED:
    ...
    t0 = l.useCallback(() => {
      if (null == e6.current || (ts.info("[QV] | handleTracksLoaded: textTracks.length: ".concat(e6.current.textTracks.length)), 0 === e6.current.textTracks.length)) return;
  ...
  l.useEffect(() => {
    var e, t;
    return t9({
      captionHeightSpring: em && null != to && null != (t = null == (e = t6.current) ? true : e.clientHeight) ? t : 0,
      immediate: e4
    }), () => {
      t7.stop()
    }
  }, [em, t9, e4, to, t7]), l.useEffect(() => (t4({
  ...
  let t3 = eC === V.rq.ENDED,
    t5 = l.useCallback(async e => {
      if (ep) {
        var t;
        let e = (0, C.fn)(null == (t = e6.current) ? true : t.parentNode, e6.current);
    ...
    nn = e3 || e0.maxTimestampSec >= (null != (B = null == (m = e6.current) ? true : m.currentTime) ? B : 0) + 1,
  ...
  return (0, r.jsx)(f.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [t3 && (() => {
        ...
        onTimeUpdate: e => {
          null != e6.current && (e6.current.currentTime >= eF && (ts.info("[QV] | handleTimeUpdate: capturing server time update: currentTime: ".concat(e6.current.currentTime)), eU(e6.current.currentTime + 6 + 2 * Math.random()), tZ(e6.current.currentTime)), e6.current.currentTime >= eq && (eH(e6.current.currentTime + 1), (0, y.qm)(ee.id, eT.taskType, e6.current.currentTime), er(e6.current.currentTime)), e1(ee.id, e6.current.currentTime, e6.current.duration), eR(e6.current.currentTime / e6.current.duration * 100))
        },
        onEnded: e => {
          null != e6.current && (tZ(e6.current.duration + 1), ts.info("[QV] | handleEnded: sending progress update: ".concat(e6.current.duration + 1)), e1(ee.id, e6.current.duration, e6.current.duration)), tV(V.rq.ENDED), eL(false)
        },
        onLoadedData: e => {
        ...
        onLoadedMetadata: e => {
          null != e6.current && (ts.info("[QV] | handleLoadedMetadata | videoAssetId: ".concat(tv)), tn(true), tm !== I.n1.VIDEO_HLS && tK(td), e2 ? e6.current.volume = 0 : e6.current.volume = e8)
        },
        onLoadStart: () => {
        ...
        onProgress: e => {
          if (null == e6.current) return;
          ts.info("[QV] | handleLoadingHasProgressed: buffered.length: ".concat(e6.current.buffered.length));
          let t = [];
        ...
        children: [(0, r.jsx)(L.Z, {
          ...
          duration: null != ($ = null == (E = e6.current) ? true : E.duration) ? $ : 1,
          ...
          children: (0, r.jsx)(w.Z, {
            ...
            handleFullScreenBtnClick: () => {
              ...
              let n = (0, C.fn)(null == (e = e6.current) ? true : e.parentNode, e6.current);
