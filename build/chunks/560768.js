...
function l(e, t, n, l, s) {
  ...
  if (null == e || null == t || !(0, i.Z)(t, o.xjy.JOIN) || null == a) returnfalse;
  let c = l.getApplication(a);
  return !(null == c || (0, r.yE)(c.flags, o.udG.EMBEDDED) || e.isPrivate() && s.isBlockedOrIgnored(e.getRecipientId())) && n.shouldShowEducation(a)
}