...
function O(e) {
  let {
    ...
    channelRecord: n,
    deleteChannel: i
  } = e, O = (0, s.yK)([f.A, h.A], () => a()(f.A.getThreadsForParent(n.guild_id, n.id)).values().filter(e => {
    let {
      id: n
    } = e;
  ...
  }).filter(b.Vq).sort((e, t) => g.default.compare(e.id, t.id)).value(), [t.oldestReadMessageId, n.guild_id, n.id]), j = l.useCallback((e, t) => {
