...
let y = Chunk647438.memo(function(e) {
  let {
    channel: t
  } = e, n = (0, d.Z)(), l = (0, s.e7)([f.Z], () => f.Z.isInChannel(t.id)), y = (0, s.e7)([f.Z], () => !a().isEmpty(f.Z.getVoiceStatesForChannel(t.id))), v = (0, s.e7)([h.Z], () => h.Z.can(b.Plq.CONNECT, t)), {
    needSubscriptionToAccess: j
  } = (0, u.Z)(t.id), x = (0, p.$R)(t), O = i.useCallback(() => {
  ...
  }).enabled && !n && !l && v && x && t.isVocalThread()) ? (0, r.jsx)(m.ZP.Icon, {
    icon: o.Csw,
    onClick: O,
