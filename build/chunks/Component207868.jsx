...
let _ = Chunk647438.memo(function(e) {
  ...
  } = (0, u.Z)(t.id), v = (0, p.$R)(t), x = i.useCallback(() => {
  ...
  return (i.useEffect(() => (g.S.subscribe(b.CkL.CALL_START, x), () => {
    g.S.unsubscribe(b.CkL.CALL_START, x)
  }), [x]), p.tM.useExperiment({
    guildId: t.guild_id,
    location: "63250c_1"
  }, {
    autoTrackExposure: false
  }).enabled && !n && !l && O && v && t.isVocalThread()) ? (0, r.jsx)(m.ZP.Icon, {
    icon: o.Csw,
    onClick: x,
