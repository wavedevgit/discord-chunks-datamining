...
class es extends i.PureComponent {
  ...
  constructor(...e) {
    super(...e), el(this, "handleApplicationOrChannelLinkClick", () => {
      ...
      s()(null != t, "Channel is null during navigation click"), s()(null != n, "Activity null during navigation click"), h.Z.channelListScrollTo(null !== (e = t.guild_id) && void 0 !== e ? e : en.ME, t.id), !(0, b.R)() && ((0, M.vd)(t.type) && p.Z.selectParticipant(t.id, (0, C.oW)(n.applicationId)), (0, M.Qm)(t.type) && (0, y.tg)(er.Ez.PANEL))
    })
  }
}
