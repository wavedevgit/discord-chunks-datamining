...
class e_ extends i.PureComponent {
  ...
  renderEmbeddedActivity() {
    let e, t, {
      ...
      showsActivityPopoutQuickRefocusNUX: u,
      markActivityPopoutQuickRefocusNUXAsDismissed: d
    } = this.props;
    ...
    let y = (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsx)(R.Z, {
        ...
        className: ef.info,
        children: [t, null != l && (0, F.Qm)(l.type) ? b : (0, r.jsx)(ey, {
          timestamps: f
        })]
      })]
    });
    return g ? (0, r.jsx)(h.yRy, {
      position: "top",
      align: "center",
      spacing: 16,
      shouldShow: u,
      ...
      children: e => (0, r.jsx)(h.P3F, eb(em({}, e), {
        className: o()(ef.gameWrapper, ef.clickableGameWrapper, {
          [ef.clickableGameWrapperForceHover]: u
        }),
        onClick: () => {
          p.Z.dispatch({
            type: "ACTIVITY_POPOUT_WINDOW_OPEN"
          }), u && d(eh.L.TAKE_ACTION), (0, j.yw)(eu.rMx.ACTIVITY_PANEL_GAME_CARD_ACTIVITY_POPOUT_REFOCUS_CLICKED)
        },
        children: y
      }))
    }) : (0, r.jsx)("div", {
  ...
  render() {
    ...
    return i || ((0, ea.y)(s, a, t) || e) && (null != n || null != t) ? (0, r.jsx)(S.j, {
      isForceShowSharingPopout: u,
      setIsForceShowSharingPopout: d,
  ...
  constructor(...e) {
    super(...e), eg(this, "handleApplicationOrChannelLinkClick", () => {
      var e;
      let {
        channel: t,
        embeddedActivity: n
      } = this.props;
      a()(null != t, "Channel is null during navigation click"), a()(null != n, "Activity null during navigation click"), g.Z.channelListScrollTo(null != (e = t.guild_id) ? e : eu.ME, t.id), !(0, _.R)({
        isContextless: n.location.kind === c.E.CONTEXTLESS
      }) && ((0, F.vd)(t.type) && f.Z.selectParticipant(t.id, (0, x.gN)({
...
let ev = (0, b.Z)(function(e) {
  ...
  let o = (0, u.e7)([Y.default], () => Y.default.getId()),
    ...
    [F, eo] = i.useState(!1),
    {
      ...
      let {
        embeddedActivity: t
      } = e, n = [], r = (0, Z.wE)(d.z.ACTIVITY_POPOUT_NUX_MODAL), i = (0, u.e7)([ei.Z], () => ei.Z.isFocused());
      (0, _.R)({
