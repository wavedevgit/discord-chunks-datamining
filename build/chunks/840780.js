...
class eb extends i.PureComponent {
  ...
  renderEmbeddedActivity() {
    ...
    let b = (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsx)(A.Z, {
        ...
        className: eh.info,
        children: [t, null != l && (0, F.Qm)(l.type) ? m : (0, r.jsx)(em, {
          timestamps: p
        })]
      })]
    });
    return f ? (0, r.jsx)(d.yRy, {
      position: "top",
      align: "center",
      spacing: 16,
      shouldShow: c,
  ...
  render() {
    ...
    return i || ((0, eo.y)(s, a, t) || e) && (null != n || null != t) ? (0, r.jsx)(C.j, {
      isForceShowSharingPopout: u,
      setIsForceShowSharingPopout: d,
  ...
  constructor(...e) {
    super(...e), ep(this, "handleApplicationOrChannelLinkClick", () => {
      var e;
      let {
        channel: t,
        embeddedActivity: n
      } = this.props;
      a()(null != t, "Channel is null during navigation click"), a()(null != n, "Activity null during navigation click"), f.Z.channelListScrollTo(null != (e = t.guild_id) ? e : ea.ME, t.id), !(0, y.R)() && ((0, F.vd)(t.type) && p.Z.selectParticipant(t.id, (0, S.gN)({
