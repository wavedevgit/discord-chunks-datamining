...
class ey extends i.PureComponent {
    ...
    return g ? (0, r.jsx)(h.yRy, {
      ...
      children: e => (0, r.jsx)(h.P3F, em(eg({}, e), {
        ...
        onClick: () => {
          ...
          }), u && d(ed.L.TAKE_ACTION), (0, S.yw)(ec.rMx.ACTIVITY_PANEL_GAME_CARD_ACTIVITY_POPOUT_REFOCUS_CLICKED)
        },
        children: y
      }))
    }) : (0, r.jsx)("div", {
  ...
  render() {
    ...
    return i || ((0, es.y)(s, a, t) || e) && (null != n || null != t) ? (0, r.jsx)(j.j, {
      isForceShowSharingPopout: u,
      setIsForceShowSharingPopout: d,
...
let e_ = (0, b.Z)(function(e) {
  ...
  let o = (0, u.e7)([W.default], () => W.default.getId()),
    ...
    N = (0, O.Z0)() && null != P && (0, _.R)({
      isContextless: P.location.kind === c.E.CONTEXTLESS
    }),
