...
class ey extends i.PureComponent {
  ...
  constructor(...e) {
    super(...e), ef(this, "activityPopoutTargetRef", i.createRef()), ef(this, "handleApplicationOrChannelLinkClick", () => {
      ...
      a()(null != t, "Channel cannot be null during navigation click"), g.Z.channelListScrollTo(null != (e = t.guild_id) ? e : ec.ME, t.id), !(0, O.R)() && ((0, F.vd)(t.type) && f.Z.selectParticipant(t.id, (0, E.gN)({
