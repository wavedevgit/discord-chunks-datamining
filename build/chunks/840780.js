...
class ey extends i.PureComponent {
    ...
    return g ? (0, r.jsx)(h.yRy, {
      ...
      children: e => (0, r.jsx)(h.P3F, em(eg({}, e), {
        className: o()(ep.gameWrapper, ep.clickableGameWrapper, {
          [ep.clickableGameWrapperForceHover]: u
        }),
        onClick: () => {
          p.Z.dispatch({
            type: "ACTIVITY_POPOUT_WINDOW_OPEN"
          }), u && d(ed.L.TAKE_ACTION), (0, j.yw)(ec.rMx.ACTIVITY_PANEL_GAME_CARD_ACTIVITY_POPOUT_REFOCUS_CLICKED)
        },
        children: y
      }))
    }) : (0, r.jsx)("div", {
  ...
  render() {
    ...
    return i || ((0, es.y)(s, a, t) || e) && (null != n || null != t) ? (0, r.jsx)(S.j, {
      isForceShowSharingPopout: u,
      setIsForceShowSharingPopout: d,
  ...
  constructor(...e) {
    super(...e), ef(this, "handleApplicationOrChannelLinkClick", () => {
      ...
      }) && ((0, H.vd)(t.type) && f.Z.selectParticipant(t.id, (0, x.gN)({
...
let e_ = (0, b.Z)(function(e) {
  ...
  let o = (0, u.e7)([z.default], () => z.default.getId()),
    ...
    [V, H] = i.useState(!1),
    {
      ...
      let {
        embeddedActivity: t
      } = e, n = [], r = (0, Z.wE)(d.z.ACTIVITY_POPOUT_NUX_MODAL), i = (0, u.e7)([er.Z], () => er.Z.isFocused());
      (0, _.R)({
