...
class eb extends i.PureComponent {
    ...
    let _ = (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsx)(A.Z, {
        ...
        children: (0, r.jsxs)("div", {
          className: eh.info,
          children: [t, null != l && (0, H.Qm)(l.type) ? O : (0, r.jsx)(em, {
            timestamps: g
          })]
        })
      })]
    });
    return m ? (0, r.jsx)(d.yRy, {
      ...
      children: e => (0, r.jsx)(d.P3F, eg(ef({}, e), {
        ...
        onClick: () => {
          ...
          }), c && u(eu.L.TAKE_ACTION), (0, j.yw)(ea.rMx.ACTIVITY_PANEL_GAME_CARD_ACTIVITY_POPOUT_REFOCUS_CLICKED)
        },
        children: _
      }))
    }) : (0, r.jsx)("div", {
  ...
  render() {
    ...
    return i || ((0, eo.y)(s, a, t) || e) && (null != n || null != t) ? (0, r.jsx)("div", {
  ...
  constructor(...e) {
    super(...e), ep(this, "activityPopoutTargetRef", i.createRef()), ep(this, "handleApplicationOrChannelLinkClick", () => {
      var e;
      let {
        channel: t,
        embeddedActivity: n
      } = this.props;
      a()(null != n, "Activity cannot be null during navigation click"), a()(null != t, "Channel cannot be null during navigation click"), f.Z.channelListScrollTo(null != (e = t.guild_id) ? e : ea.ME, t.id), !(0, y.R)() && ((0, H.vd)(t.type) && p.Z.selectParticipant(t.id, (0, x.gN)({
