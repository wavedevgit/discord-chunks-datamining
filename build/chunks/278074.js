...
let T = f(b(function(e) {
  ...
  A = e => Object.assign(f(e), {
    ...
    endsWith: t => {
      var n;
      return A(g(e, (n = t, b(e => v(e) && e.endsWith(n)))))
    },
    minLength: t => {
      let n;
      return A(g(e, (n = t, b(e => v(e) && e.length >= n))))
    },
    maxLength: t => {
      let n;
      return A(g(e, (n = t, b(e => v(e) && e.length <= n))))
    ...
    includes: t => {
      var n;
      return A(g(e, (n = t, b(e => v(e) && e.includes(n)))))
    },
    regex: t => {
      var n;
      return A(g(e, (n = t, b(e => v(e) && !!e.match(n)))))
    }
  }),
  C = A(b(v)),
