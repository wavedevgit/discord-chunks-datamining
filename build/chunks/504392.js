...
function N(e) {
  ...
  }, [t, n, null == i ? void 0 : i.allPowerups]), (null == i ? void 0 : i.powerupCatalog) == null) ? null : (0, r.jsxs)("div", {
        ...
        children: I.map(e => {
          ...
          let {
            ...
            switch (e) {
              case j.Us.LEVEL:
                return {
                  title: h.intl.string(E.default["TXY/b2"]), description: h.intl.string(E.default.aJv4PD)
                };
              case j.Us.PERK:
                return {
