...
n.d(t, {
  Z: () => T
}), n(539854), n(388685), n(361932), n(187205), n(953529);
var r = n(255367),
  o = n(73800),
  i = n(120356),
  l = n.n(i),
...
function T(e) {
  ...
  }, []), [null == T ? void 0 : T.powerupCatalog]), G = B.flatMap(e => e.listings).filter(e => "multiPerk" === e.type).map(e => e.group), W = (0, O.f)(G, t);
  return (o.useEffect(() => {
    if (null != i && !R.current)
      for (let e of B)
  ...
  }, [t, V, M, L]), (null == T ? void 0 : T.powerupCatalog) == null) ? null : (0, r.jsxs)("div", {
