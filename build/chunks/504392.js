...
function y(e) {
  ...
  let [D, U] = (0, u.US)(k), V = o.useMemo(() => Z.reduce((e, t) => {
  ...
  return (o.useEffect(() => {
  ...
  }, [t, i, null == y ? void 0 : y.allPowerups]), o.useEffect(() => {
    null != D && null != R && (0, c.ZDy)(async () => {
      let {
        default: e
  ...
  }, [t, D, U, R]), (null == y ? void 0 : y.powerupCatalog) == null) ? null : (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)(d.Z, {
      ...
      children: [(0, r.jsx)(d.Z.Icon, {
        ...
        children: w.intl.string(O.default.yv3DJC)
      })]
    }), (0, r.jsxs)("div", {
        ...
        children: V.map(e => {
          let {
            ...
            switch (e) {
              case I.Us.LEVEL:
                return {
                  title: w.intl.string(O.default["TXY/b2"]), description: w.intl.string(O.default.aJv4PD)
                };
              case I.Us.PERK:
                return {
                  title: w.intl.string(O.default.TV3Vm5), description: w.intl.string(O.default.STx9ho)
                }
            }
