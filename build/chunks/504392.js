...
function S(e) {
  ...
  let [U, D] = (0, u.US)(k), V = o.useMemo(() => P.reduce((e, t) => {
  ...
  return (o.useEffect(() => {
  ...
  }, [t, U, D, R]), (null == S ? void 0 : S.powerupCatalog) == null) ? null : (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)(d.Z, {
      ...
      children: [(0, r.jsx)(d.Z.Icon, {
        ...
        children: Z.intl.string(O.default.yv3DJC)
      })]
    }), (0, r.jsxs)("div", {
        ...
        children: V.map(e => {
          let {
            ...
            switch (e) {
              case I.Us.LEVEL:
                return {
                  title: Z.intl.string(O.default["TXY/b2"]), description: Z.intl.string(O.default.aJv4PD)
                };
              case I.Us.PERK:
                return {
                  title: Z.intl.string(O.default.TV3Vm5), description: Z.intl.string(O.default.STx9ho)
                }
            }
          ...
          return (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsxs)("div", {
              ...
              className: l()(w.powerupContainer, w.powerupHorizontalPadding, {
                [w.powerupsLevelContainer]: n === I.Us.LEVEL
              }),
              fade: !0,
              children: o.map((e, n) => {
                switch (e.type) {
