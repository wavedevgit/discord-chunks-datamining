  ...
  return (i.useEffect(() => {
    ...
    children: [(0, r.jsxs)(c.Z, {
      ...
      children: [(0, r.jsx)(c.Z.Icon, {
        ...
        children: C.intl.string(h.default.yv3DJC)
      })]
    }), (0, r.jsxs)("div", {
        ...
        children: N.map(e => {
          ...
          let {
            ...
            switch (e) {
              case b.Us.LEVEL:
                return {
                  title: C.intl.string(h.default["TXY/b2"]), description: C.intl.string(h.default.aJv4PD)
                };
              case b.Us.PERK:
                return {
                  title: C.intl.string(h.default.TV3Vm5), description: C.intl.string(h.default.STx9ho)
                }
            }
          }(e), c = e === b.Us.LEVEL ? l.zJl : "div";
          return (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsxs)("div", {
              ...
              className: s()(E.powerupContainer, E.powerupHorizontalPadding, {
                [E.powerupsLevelContainer]: e === b.Us.LEVEL
              }),
              fade: !0,
              children: t.map((e, i) => {
                switch (e.type) {
