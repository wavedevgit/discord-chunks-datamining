...
function S(e) {
  ...
  }, [t, k, D, A]), (null == S ? void 0 : S.powerupCatalog) == null) ? null : (0, r.jsxs)("div", {
        ...
        children: P.map(e => {
          ...
          let {
            ...
            switch (e) {
              case C.Us.LEVEL:
                return {
                  title: O.intl.string(N.default["TXY/b2"]), description: O.intl.string(N.default.aJv4PD)
                };
              case C.Us.PERK:
                return {
                  title: O.intl.string(N.default.TV3Vm5), description: O.intl.string(N.default.STx9ho)
                }
            }
