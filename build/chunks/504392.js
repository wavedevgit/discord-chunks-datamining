  ...
  return (i.useEffect(() => {
    ...
    children: [(0, r.jsxs)(c.Z, {
      ...
      children: [(0, r.jsx)(c.Z.Icon, {
        ...
        children: C.intl.string(j.default.yv3DJC)
      })]
    }), (0, r.jsxs)("div", {
        ...
        children: Z.map(e => {
          ...
          let {
            ...
            switch (e) {
              case h.Us.LEVEL:
                return {
                  title: C.intl.string(j.default["TXY/b2"]), description: C.intl.string(j.default.aJv4PD)
                };
              case h.Us.PERK:
                return {
                  title: C.intl.string(j.default.TV3Vm5), description: C.intl.string(j.default.STx9ho)
                }
            }
          ...
          return (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsxs)("div", {
              ...
              className: a()(E.powerupContainer, E.powerupHorizontalPadding, {
                [E.powerupsLevelContainer]: e === h.Us.LEVEL
              }),
              fade: !0,
              children: t.map((e, i) => {
                switch (e.type) {
