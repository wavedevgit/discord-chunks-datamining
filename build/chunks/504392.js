  ...
  return (o.useEffect(() => {
    ...
    children: [(0, r.jsxs)(u.Z, {
      ...
      children: [(0, r.jsx)(u.Z.Icon, {
        ...
        children: Z.NW.string(h.Z.yv3DJC)
      })]
    }), (0, r.jsxs)("div", {
        ...
        children: C.map(e => {
          ...
          let {
            ...
            switch (e) {
              case b.Us.LEVEL:
                return {
                  title: Z.NW.string(h.Z["TXY/b2"]), description: Z.NW.string(h.Z.aJv4PD)
                };
              case b.Us.PERK:
                return {
                  title: Z.NW.string(h.Z.TV3Vm5), description: Z.NW.string(h.Z.NHjM1t)
                }
            }
          }(e);
          return (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsxs)("div", {
              ...
              className: i()(N.powerupContainer, {
                [N.powerupsLevelContainer]: e === b.Us.LEVEL
              }),
              children: t.map((e, o) => {
                switch (e.type) {
                  case b.Us.LEVEL:
