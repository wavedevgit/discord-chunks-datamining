  ...
  return (i.useEffect(() => {
    ...
    children: [(0, r.jsxs)(c.Z, {
      ...
      children: [(0, r.jsx)(c.Z.Icon, {
        ...
        children: b.intl.string(j.default.yv3DJC)
      })]
    }), (0, r.jsxs)("div", {
        ...
        children: C.map(e => {
          ...
          let {
            ...
            switch (e) {
              case g.Us.LEVEL:
                return {
                  title: b.intl.string(j.default["TXY/b2"]), description: b.intl.string(j.default.aJv4PD)
                };
              case g.Us.PERK:
                return {
                  title: b.intl.string(j.default.TV3Vm5), description: b.intl.string(j.default.STx9ho)
                }
            }
          }(e), c = e === g.Us.LEVEL ? l.zJl : "div";
          return (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsxs)("div", {
              ...
              className: s()(h.powerupContainer, h.powerupHorizontalPadding, {
                [h.powerupsLevelContainer]: e === g.Us.LEVEL
              }),
              fade: !0,
              children: t.map((e, i) => {
                switch (e.type) {
