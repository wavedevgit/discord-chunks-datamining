...
function k() {
  let [e, t] = Chunk473749.useState([]), [n, i] = Chunk473749.useState([]), [r, s] = Chunk473749.useState(), [d, h] = Chunk473749.useState(), [x, g] = Chunk473749.useState([]), [_, N] = Chunk473749.useState([]), [k, R] = Chunk473749.useState(true), [A, Z] = Chunk473749.useState(10080), [D, L] = Chunk473749.useState([]), {
    entitlements: M,
