...
function R() {
  let [e, t] = r.useState([]), [n, i] = r.useState([]), [l, s] = r.useState(), [u, f] = r.useState(), [x, b] = r.useState([]), [C, O] = r.useState([]), [R, A] = r.useState(true), [D, Z] = r.useState(10080), [L, M] = r.useState([]), {
    entitlements: U,
  ...
  r.useEffect(() => {
    ...
    R && (A(false), h.Z.forceReset(), (0, m.Tf)(), N().then(e => {
