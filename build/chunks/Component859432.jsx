...
let J = Chunk73800.memo(function(e) {
  ...
  return ei || er ? (0, i.jsx)(s.v2r, {
    ...
    children: [(0, i.jsxs)(s.kSQ, {
      ...
      children: [en && z.isStaff() && eO ? (0, i.jsx)(s.sNh, {
        id: "create-deadchat",
        label: "Deadchat Ping",
        icon: s.eQA,
        action: () => {
      ...
      }) : null, en && z.isStaff() && ex ? (0, i.jsx)(s.sNh, {
      ...
      children: [ep, et && t.features.has(R.oNc.COMMUNITY) ? (0, i.jsx)(s.sNh, {
        id: "report-raid",
