...
function O(e, t) {
  let [n, a] = (0, l.Wu)([s.ZP], () => [s.ZP.isChannelMuted(e.guild_id, e.id), s.ZP.getChannelMuteConfig(e.guild_id, e.id)]), r = (0, c.U)(a), b = (0, v.ZP)(e, !0);
  ...
  switch (e.type) {
    ...
    case p.d4z.GROUP_DM:
      ...
      break;
    case p.d4z.DM:
      m = h.intl.format(h.t.byjuJi, {
        name: b
      }), E = h.intl.format(h.t["eC+9rq"], {
        name: b
      });
      break;
    default:
