...
function v(e, t) {
  let [n, a] = (0, l.Wu)([f.ZP], () => [f.ZP.isChannelMuted(e.guild_id, e.id), f.ZP.getChannelMuteConfig(e.guild_id, e.id)]), r = (0, d.U)(a), E = (0, O.ZP)(e, !0);
  ...
  switch (e.type) {
    ...
    case p.d4z.GROUP_DM:
      ...
      break;
    case p.d4z.DM:
      h = b.NW.format(b.t.byjuJi, {
        name: E
      }), y = b.NW.format(b.t["eC+9rq"], {
        name: E
      });
      break;
    default:
