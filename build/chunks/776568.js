...
function O(e, t) {
  let [n, r] = (0, a.Wu)([f.ZP], () => [f.ZP.isChannelMuted(e.guild_id, e.id), f.ZP.getChannelMuteConfig(e.guild_id, e.id)]), l = (0, c.U)(r), v = (0, g.ZP)(e, !0);

  function O(t) {
    t && e.type === b.d4z.GUILD_CATEGORY && (0, s.c4)(e.id), d.Z.updateChannelOverrideSettings(e.guild_id, e.id, {
      muted: t
    }, h.UE.muted(t))
  }
  ...
  switch (e.type) {
    ...
    case b.d4z.GROUP_DM:
      ...
      break;
    case b.d4z.DM:
      _ = Z.intl.format(Z.t.byjuJi, {
        name: v
      }), j = Z.intl.format(Z.t["eC+9rq"], {
        name: v
      });
      break;
    default:
