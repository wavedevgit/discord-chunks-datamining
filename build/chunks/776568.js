...
function O(t, n) {
  let [e, r] = (0, a.Wu)([f.ZP], () => [f.ZP.isChannelMuted(t.guild_id, t.id), f.ZP.getChannelMuteConfig(t.guild_id, t.id)]), l = (0, c.U)(r), Z = (0, v.ZP)(t, !0);

  function O(n) {
    n && t.type === g.d4z.GUILD_CATEGORY && (0, s.c4)(t.id), d.Z.updateChannelOverrideSettings(t.guild_id, t.id, {
      muted: n
    }, h.UE.muted(n))
  }
  ...
  switch (t.type) {
    ...
    case g.d4z.GROUP_DM:
      ...
      break;
    case g.d4z.DM:
      _ = b.intl.format(b.t.byjuJi, {
        name: Z
      }), j = b.intl.format(b.t["eC+9rq"], {
        name: Z
      });
      break;
    default:
