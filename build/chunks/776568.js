...
function T(e, t) {
  let [n, i] = (0, r.Wu)([p.ZP], () => [p.ZP.isChannelMuted(e.guild_id, e.id), p.ZP.getChannelMuteConfig(e.guild_id, e.id)]), o = (0, u.U)(i), f = (0, m.ZP)(e, !0);

  function T(t) {
    t && e.type === g.d4z.GUILD_CATEGORY && (0, c.c4)(e.id), s.Z.updateChannelOverrideSettings(e.guild_id, e.id, {
      muted: t
    }, _.UE.muted(t))
  }
  ...
  switch (e.type) {
    ...
    case g.d4z.GROUP_DM:
      ...
      break;
    case g.d4z.DM:
      A = b.intl.format(b.t.byjuJi, {
        name: f
      }), y = b.intl.format(b.t["eC+9rq"], {
        name: f
      });
      break;
    default:
