...
function U(e, t, n, r) {
  return null == e || null == t || null == n ? k(e, t, r) : "".concat(location.protocol, "//").concat(location.host).concat(m.Z5c.CHANNEL_THREAD_VIEW(e, t, n, r))
}
...
function G(e, t, n, r) {
  ...
  let o = e.getGuildId(),
    a = (0, s.BC)(o, t);
  return null != t && a ? U(o, t.id, e.id, g.default.castChannelIdAsMessageId(e.id)) : null != r ? r : k(o, e.id, n)
}
