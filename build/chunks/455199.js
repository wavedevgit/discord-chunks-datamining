...
function B(e) {
  ...
  j({
    addedMessages: i
  }), r ? A = A.concat(i) : (A = i, R = {}), a().forEach(i, e => {
    R[e.id] = !0
...
function J() {
  j({
    deletedMessages: a().filter(A, e => b.Z.isBlockedOrIgnoredForMessage(e))
...
function $(e) {
  ...
  A = a().filter(A, e => e.channel_id !== t.id || (delete R[e.id], n.push(e), !1)), j({
    deletedMessages: n
  })
}
