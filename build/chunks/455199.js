...
function U(e) {
  ...
  R = !0, null == t && D.guildFilter === I.NgX.THIS_SERVER && q({
    guildFilter: I.NgX.ALL_SERVERS
  })
}
...
function H(e) {
  ...
  let i = V(n, t);
  if (null == i) return !1;
  (N = N.slice()).unshift(i), w[i.id] = !0, M({
    addedMessages: [i]
  })
}
...
function ee(e) {
  ...
  N = a().filter(N, e => e.channel_id !== t.id || (delete w[e.id], n.push(e), !1)), M({
    deletedMessages: n
  })
}
