...
function _(e, t, n) {
  if (null != t && null != n) {
    ...
    let i = a().reduce(n, (e, t) => (0, c.stringSimilarity)(r.name, t.name) > (0, c.stringSimilarity)(r.name, e.name) ? t : e);
    return null == i ? null : i.id
  }
  return null
}
...
function v(e) {
  ...
  let o = (0, m.Z)(),
    c = (0, u.Z)(),
    [v, j] = i.useState(_(t.id, o, c));
  return null != v && l(v), (0, r.jsxs)(d.xJW, {
