...
function R(e) {
  let {
    ...
    live: j,
    stream: U
  } = (0, m.Z)(t.id), G = !a && x !== b.lY.MODAL && x !== b.lY.MODAL_V2 && (0, l.EQ)(n).with(b.n_.STATUS, () => 0 === j.length && null == U).with(b.n_.ACTIVITY, () => !0).with(b.n_.AVATAR, () => !1).exhaustive(), [B, F] = i.useState(G);
  if (i.useEffect(() => {
      B && !G && F(!1)
