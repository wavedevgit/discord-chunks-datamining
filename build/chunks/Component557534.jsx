...
function P(e) {
  ...
  } = e, j = (0, o.bG)([y.A], () => y.A.getGuild(t.getGuildId())), x = (0, o.bG)([f.A], () => f.A.getStageInstanceByChannel(t.id), [t.id]), C = (0, o.bG)([p.Ay], () => p.Ay.getActiveEventByChannel(t.id), [t.id]), I = (0, o.bG)([O.A], () => (0, h.K)(O.A, j, t, x)), N = (0, o.bG)([], () => (null == t ? true : t.type) === _.rbe.GUILD_VOICE ? v.intl.string(v.t["EE+P0H"]) : v.intl.string(v.t["0jeAXt"])), T = i.useRef(null);
