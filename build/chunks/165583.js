...
function x(e) {
  ...
  if (n > 24) {
    let e = t.diff(u()(), "d");
    return w.intl.formatToPlainString(w.t.xs9VPj, {
      numDays: e
    })
  }
  if (n > 1) return w.intl.formatToPlainString(w.t["p7KX5+"], {
    numHours: n
  });
  let r = t.diff(u()(), "minutes");
  return w.intl.formatToPlainString(w.t["XtQ+Ag"], {
    numMinutes: r
  })
}
...
function k(e) {
  ...
  return (0, r.jsxs)("div", {
    className: a()(o, D.gradientUpsellWrapper, {
      [D.gradientUpsellWrapperTier0]: _ === P.Si.TIER_0,
      [D.gradientUpsellWrapperTier2]: _ === P.Si.TIER_2,
    ...
    children: [(0, r.jsxs)("div", {
      ...
      }), _ === P.Si.TIER_0 && (0, r.jsx)(y.Z, {
        className: D.logoWordmark
      }), _ === P.Si.TIER_2 && (0, r.jsx)(b.Z, {
        className: D.logoWordmark
      })]
    }), (0, r.jsx)(p.Text, {
      ...
      text: null != c ? w.intl.formatToPlainString(w.t.iiLbvr, {
        percent: c.discount.amount
      }) : w.intl.string(w.t.IBYG5e),
      colorOptions: _ === P.Si.TIER_0 ? C.VE.PREMIUM_TIER_0_WHITE_FILL : C.VE.PREMIUM_TIER_2_WHITE_FILL
    }), (0, r.jsx)(p.Text, {
      variant: "eyebrow",
...
function M(e) {
  ...
  let {
    ...
    trialOffer: c,
    discountOffer: u
  } = e, [d, f] = i.useState(!1), _ = null != u ? w.intl.formatToPlainString(w.t.bkQ4bG, {
...
function j(e) {
  var t, n;
  let i = null == (t = (0, A.N)()) ? void 0 : t.subscription_trial,
    o = null != (n = null == i ? void 0 : i.sku_id) ? n : P.Si.TIER_2;
  return (0, r.jsx)(p.Text, {
    variant: "text-xs/bold",
    className: a()(D.trialBadge, e.className, {
      [D.trialBadgeGradientTier0]: o === P.Si.TIER_0,
      [D.trialBadgeGradientTier2]: o === P.Si.TIER_2
    }),
    color: "none",
    children: (0, v.a5)({
...
function F(e) {
  let {
    ...
    trialOffer: y,
    discountOffer: T
  } = e, A = (0, d.e7)([m.Z], () => m.Z.useReducedMotion), N = (0, h.ZP)(), C = (0, O.BU)(S.zz / O.XD, {
    useKibibytes: !0
  });
  switch (c) {
        ...
        children: [(0, r.jsx)(p.P3F, {
          ...
          children: [(0, r.jsx)("img", {
            ...
            children: w.intl.format(w.t["2HoFKC"], {
              planName: (0, v.jP)(u),
              onClick: () => (0, E.uL)(R.Z5c.APPLICATION_STORE)
            })
          })]
        }), (0, r.jsx)(U, {
          subscriptionTier: u,
    ...
    case P.cd.MESSAGE_LENGTH_UPSELL:
      ...
      switch (c) {
        case P.cd.UPLOAD_ERROR_UPSELL:
          j = w.intl.format(w.t.F4qoDw, {
            planName: (0, v.jP)(u),
            premiumMaxSize: u === P.Si.TIER_0 ? w.intl.string(w.t["C/Rhb2"]) : C,
            onClick: () => {
              (0, E.uL)(R.Z5c.APPLICATION_STORE), null == s || s()
            }
          });
          break;
        case P.cd.BURST_REACTION_UPSELL:
        ...
        case P.cd.STREAM_QUALITY_UPSELL:
          j = w.intl.format(w.t.WspKp6, {
            onClick: () => {
              (0, E.uL)(R.Z5c.APPLICATION_STORE), null == s || s(), (0, f.pT)()
            }
          });
          break;
        case P.cd.MESSAGE_LENGTH_UPSELL:
    ...
    case P.cd.PREMIUM_CLIENT_THEME_TRY_IT_OUT:
      return l()(null != o, "You must specify children for this upsell type"), (0, r.jsx)(k, {
        trialOffer: y,
        discountOffer: T,
