...
function z(e) {
  ...
  let {
    ...
    onSave: L,
    onDelete: D
  } = e, A = (0, d.Dt)(), [G] = i.useState(function(e) {
  ...
  }(Z)), [U, B] = i.useState(G), H = (0, o.e7)([v.Z], () => v.Z.getChannel(null == U ? void 0 : U.value)), R = (null == H ? void 0 : H.isMediaChannel()) === !0, F = i.useMemo(() => [{
    value: h.oi.VIEW,
  ...
  }], [null == H ? void 0 : H.type, R]), [X, q] = i.useState(P()), [W, Y] = i.useState(null != (n = null == Z ? void 0 : Z.title) ? n : ""), V = (0, o.e7)([y.Z], () => {
  ...
  }), [K, Q] = i.useState(null == Z ? null : null != (f = F.find(e => e.value === Z.actionType)) ? f : null), [J, $] = i.useState(null != (l = null == Z ? void 0 : Z.emoji) ? l : null), ee = (0, o.e7)([y.Z], () => {
    var e;
    return null == (e = y.Z.getNewMemberAction(null == Z ? void 0 : Z.channelId)) ? void 0 : e.icon
  }), [en, el] = i.useState(null), et = null == W || 0 === W.length || null == K || null == U, ei = Object.values(X).flat().length > 0, ea = i.useCallback(() => {
    ...
    let e = {
      ...
      n = null != en || null != J;
    L(e, en, n), w()
  }, [L, w, W, K, U, J, ee, en]), er = i.useCallback(() => {
    null == D || D(), w()
  }, [D, w]), eo = i.useCallback(e => {
    Y(e), q(E({
  ...
  }, [Q, q, U, W, J]), ec = i.useCallback(e => Promise.resolve(x.ZP.getSelectableChannels(M).filter(n => !V.has(n.channel.id) && (0, h.kb)(n.channel) && r()(e, n.channel.name)).map(e => ({
    value: e.channel.id,
    label: e.channel.name
  }))), [M, V]), ed = i.useCallback(e => {
  ...
  }, [M]), em = i.useCallback(function(e) {
    let n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
    $(n), el(e)
  }, []), eh = i.useCallback(() => null != en ? en : null != J ? null : null != ee && null != U ? g.ZP.getNewMemberActionIconURL({
    channelId: U.value,
    icon: ee
  }) : null, [U, ee, en, J])(), ep = i.useCallback(e => {
    null != e && em(e, null)
  }, [em]), ev = e => (n, l) => {
    var t, i;
    if (null == n) return;
    ...
    children: [(0, t.jsxs)("div", {
      ...
      children: [(0, t.jsx)(s.olH, {
        ...
        children: [(0, t.jsxs)(s.X6q, {
          ...
          onChange: eu,
          options: null == H ? F : F.map(e => _(O({}, e), {
            disabled: !T(e.value, H)
          }))
        }), null != K && X.actionType.length > 0 ? X.actionType.map(e => (0, t.jsx)(s.Text, {
