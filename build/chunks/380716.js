...
l.d(n, {
  default: () => Z
}), l(539854), l(388685), l(472816), l(794429);
var t = l(255367),
  i = l(73800),
  a = l(658722),
  r = l.n(a),
...
function w(e) {
  ...
  return (null == e.title || e.title.length < p.Wz) && n.title.push(S.intl.formatToPlainString(S.t.iu6AGh, {
    minLength: p.Wz
...
function Z(e) {
  ...
  let {
    ...
    onSave: G,
    onDelete: U
  } = e, A = (0, m.Dt)(), B = i.useRef(null), H = i.useRef(null), [R] = i.useState(function(e) {
  ...
  }(D)), [F, L] = i.useState(R), X = (0, o.e7)([x.Z], () => x.Z.getChannel(null == F ? void 0 : F.value)), q = (null == X ? void 0 : X.isMediaChannel()) === !0, W = i.useMemo(() => [{
    value: p.oi.VIEW,
  ...
  }], [null == X ? void 0 : X.type, q]), [V, Y] = i.useState(P()), [K, Q] = i.useState(null != (n = null == D ? void 0 : D.title) ? n : ""), J = (0, o.e7)([C.Z], () => {
  ...
  }), [$, ee] = i.useState(null == D ? null : null != (y = W.find(e => e.value === D.actionType)) ? y : null), [en, el] = i.useState(null != (l = null == D ? void 0 : D.emoji) ? l : null), et = (0, o.e7)([C.Z], () => {
    var e;
    return null == (e = C.Z.getNewMemberAction(null == D ? void 0 : D.channelId)) ? void 0 : e.icon
  }), [ei, ea] = i.useState(null != et && null != F ? f.ZP.getNewMemberActionIconURL({
    channelId: F.value,
    icon: et
  }) : null), er = (0, c.Z)(ei), eo = (0, c.Z)(en), es = null == K || 0 === K.length || null == $ || null == F, eu = Object.values(V).flat().length > 0, ec = i.useCallback(() => {
  ...
  }, [G, M, K, $, F, en, et, ei, er, eo]), ed = i.useCallback(() => {
    null == U || U(), M()
  }, [U, M]), em = i.useCallback(e => {
    Q(e), Y(w({
  ...
  }, [ee, Y, F, K, en]), ev = i.useCallback(e => Promise.resolve(j.ZP.getSelectableChannels(z).filter(n => !J.has(n.channel.id) && (0, p.kb)(n.channel) && r()(e, n.channel.name)).map(e => ({
    value: e.channel.id,
    label: e.channel.name
  }))), [z, J]), ex = i.useCallback(e => {
  ...
  }, [z]), ej = i.useCallback(function(e) {
    let n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
    el(n), ea(e)
  }, []), eg = i.useCallback(() => null != ei ? ei : null, [ei, en])(), ef = i.useCallback(e => {
    null != e && ej(e, null)
  }, [ej]), eb = e => n => {
    var l, t;
    let {
  ...
  return ey = null != eg ? (0, t.jsxs)(t.Fragment, {
    ...
    children: [(0, t.jsxs)("div", {
      ...
      children: [(0, t.jsx)(s.olH, {
            ...
            renderPopout: e => {
              let n = e.closePopout,
                ...
                i = (0, t.jsx)(s.yRy, {
                  ...
                  children: e => (0, t.jsx)(s.Text, k(T({}, e), {
                    variant: "text-sm/medium",
                    color: "none",
                    ref: B,
        ...
        children: [(0, t.jsxs)(s.X6q, {
          ...
          onChange: ep,
          options: null == X ? W : W.map(e => k(T({}, e), {
            disabled: !E(e.value, X)
          }))
        }), null != $ && V.actionType.length > 0 ? V.actionType.map(e => (0, t.jsx)(s.Text, {
