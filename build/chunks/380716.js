...
function P(e) {
  ...
  return (null == e.title || e.title.length < h.Wz) && n.title.push(I.intl.formatToPlainString(I.t.iu6AGh, {
    minLength: h.Wz
...
function z(e) {
  ...
  let {
    ...
    onSave: L,
    onDelete: D
  } = e, A = (0, d.Dt)(), G = i.useRef(null), R = i.useRef(null), [U] = i.useState(function(e) {
  ...
  }(Z)), [B, H] = i.useState(U), F = (0, o.e7)([v.Z], () => v.Z.getChannel(null == B ? void 0 : B.value)), X = (null == F ? void 0 : F.isMediaChannel()) === !0, q = i.useMemo(() => [{
    value: h.oi.VIEW,
  ...
  }], [null == F ? void 0 : F.type, X]), [W, Y] = i.useState(E()), [V, K] = i.useState(null != (n = null == Z ? void 0 : Z.title) ? n : ""), Q = (0, o.e7)([y.Z], () => {
  ...
  }), [J, $] = i.useState(null == Z ? null : null != (b = q.find(e => e.value === Z.actionType)) ? b : null), [ee, en] = i.useState(null != (l = null == Z ? void 0 : Z.emoji) ? l : null), el = (0, o.e7)([y.Z], () => {
    var e;
    return null == (e = y.Z.getNewMemberAction(null == Z ? void 0 : Z.channelId)) ? void 0 : e.icon
  }), [et, ei] = i.useState(null), ea = null == V || 0 === V.length || null == J || null == B, er = Object.values(W).flat().length > 0, eo = i.useCallback(() => {
    ...
    let e = {
      ...
      n = null != et || null != ee;
    L(e, et, n), w()
  }, [L, w, V, J, B, ee, el, et]), es = i.useCallback(() => {
    null == D || D(), w()
  }, [D, w]), eu = i.useCallback(e => {
    K(e), Y(P({
  ...
  }, [$, Y, B, V, ee]), em = i.useCallback(e => Promise.resolve(x.ZP.getSelectableChannels(M).filter(n => !Q.has(n.channel.id) && (0, h.kb)(n.channel) && r()(e, n.channel.name)).map(e => ({
    value: e.channel.id,
    label: e.channel.name
  }))), [M, Q]), eh = i.useCallback(e => {
    ...
    en(n), ei(e)
  }, []), ev = i.useCallback(() => null != et ? et : null != ee ? null : null != el && null != B ? j.ZP.getNewMemberActionIconURL({
    channelId: B.value,
    icon: el
  }) : null, [B, el, et, ee])(), ex = i.useCallback(e => {
    null != e && ep(e, null)
  }, [ep]), eg = e => (n, l) => {
    var t, i;
    if (null == n) return;
  ...
  return ej = null != ev ? (0, t.jsxs)(t.Fragment, {
    ...
    children: [(0, t.jsxs)("div", {
      ...
      children: [(0, t.jsx)(s.olH, {
        ...
        children: [(0, t.jsxs)(s.X6q, {
          ...
          onChange: ed,
          options: null == F ? q : q.map(e => _(O({}, e), {
            disabled: !T(e.value, F)
          }))
        }), null != J && W.actionType.length > 0 ? W.actionType.map(e => (0, t.jsx)(s.Text, {
