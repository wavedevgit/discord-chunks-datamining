...
function w(e) {
  ...
  let {
    ...
    onSave: D,
    onDelete: A
  } = e, G = (0, m.Dt)(), R = i.useRef(null), U = i.useRef(null), [B] = i.useState(function(e) {
  ...
  }(L)), [H, F] = i.useState(B), X = (0, o.e7)([x.Z], () => x.Z.getChannel(null == H ? void 0 : H.value)), q = (null == X ? void 0 : X.isMediaChannel()) === !0, W = i.useMemo(() => [{
    value: p.oi.VIEW,
  ...
  }], [null == X ? void 0 : X.type, q]), [Y, V] = i.useState(P()), [K, Q] = i.useState(null != (n = null == L ? void 0 : L.title) ? n : ""), J = (0, o.e7)([C.Z], () => {
  ...
  }), [$, ee] = i.useState(null == L ? null : null != (y = W.find(e => e.value === L.actionType)) ? y : null), [en, el] = i.useState(null != (l = null == L ? void 0 : L.emoji) ? l : null), et = (0, o.e7)([C.Z], () => {
    var e;
    return null == (e = C.Z.getNewMemberAction(null == L ? void 0 : L.channelId)) ? void 0 : e.icon
  }), [ei, ea] = i.useState(null != et && null != H ? f.ZP.getNewMemberActionIconURL({
    channelId: H.value,
    icon: et
  }) : null), er = (0, c.Z)(ei), eo = (0, c.Z)(en), es = null == K || 0 === K.length || null == $ || null == H, eu = Object.values(Y).flat().length > 0, ec = i.useCallback(() => {
  ...
  }, [D, Z, K, $, H, en, et, ei, er, eo]), ed = i.useCallback(() => {
    null == A || A(), Z()
  }, [A, Z]), em = i.useCallback(e => {
    Q(e), V(z({
  ...
  }, [ee, V, H, K, en]), ev = i.useCallback(e => Promise.resolve(g.ZP.getSelectableChannels(M).filter(n => !J.has(n.channel.id) && (0, p.kb)(n.channel) && r()(e, n.channel.name)).map(e => ({
    value: e.channel.id,
    label: e.channel.name
  }))), [M, J]), ex = i.useCallback(e => {
    ...
    children: [(0, t.jsxs)("div", {
      ...
      children: [(0, t.jsx)(s.olH, {
            ...
            renderPopout: e => {
              let n = e.closePopout,
                ...
                i = (0, t.jsx)(s.yRy, {
                  ...
                  children: e => (0, t.jsx)(s.Text, T(_({}, e), {
                    variant: "text-sm/medium",
                    color: "none",
                    ref: R,
        ...
        children: [(0, t.jsxs)(s.X6q, {
          ...
          onChange: ep,
          options: null == X ? W : W.map(e => T(_({}, e), {
            disabled: !E(e.value, X)
          }))
        }), null != $ && Y.actionType.length > 0 ? Y.actionType.map(e => (0, t.jsx)(s.Text, {
