...
function a() {
  ...
  return d !== Chunk5888.p.SUCCESS || null == u.messages || (f.push(Chunk612776.ij.MESSAGES), f.push(Chunk612776.ij.EMOJIS), f.push(Chunk612776.ij.VOICE), (null != (s = null == (e = u.guilds) ? true : module.guilds.length) ? s : 0) > 0 && f.push(Chunk612776.ij.GUILDS), (null != (l = null == (t = u.users) ? true : exports.length) ? l : 0) > 0 && null != u.sidekick && null != u.sidekick.user && (null == (n = u.users) ? true : require[0].id) !== u.sidekick.user.id && (f.push(Chunk612776.ij.FRIENDS_INTRO), f.push(Chunk612776.ij.FRIENDS_TRANSITION)), null != u.sidekick && null != u.sidekick.user && (f.push(Chunk612776.ij.FRIENDS_BEST), f.push(Chunk612776.ij.FRIENDS_LEAVE)), (null != (c = null == (a = u.applications) ? true : a.applications.length) ? c : 0) > 0 && f.push(Chunk612776.ij.GAMING), f.push(Chunk612776.ij.QUESTS), f.push(Chunk612776.ij.END_REWARD), f.push(Chunk612776.ij.END_CLAIM), f.push(Chunk612776.ij.END_SUMMARY)), f
}