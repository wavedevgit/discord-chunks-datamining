...
function N(e) {
  ...
  } = e, w = (0, s.e7)([j.Z], () => j.Z.getChannel(t)), R = (0, s.e7)([x.Z], () => x.Z.getGuild(null == w ? void 0 : w.getGuildId())), A = (0, f.ZP)(w);
  var D = w;
  ...
  if (i.useEffect(() => {
      ...
      (0, u.yw)(Z.rMx.CHANNEL_OPENED, T(P({}, e, (0, u.$H)(w.id)), {
        channel_view: N
      })), (0, p.a)(Z.rMx.CHANNEL_OPENED_CLICKSTREAM, {
        channelId: w.id
      })
    }, [w, N]), null == w || null == R) return null;
  let k = (0, r.jsx)(C.Z, {
    channel: w,
    baseChannelId: l
  });
