...
class b extends Chunk73800.Component {
  ...
  render() {
    ...
    return <Chunk748780.Z.div className={s()(Chunk161421.bar, module, {
        [Chunk161421.hidden]: require
      })} onClick={r} style={this.getAnimatedStyle()} aria-hidden={require}><span className={Chunk161421.text}>{exports}</span></Chunk748780.Z.div>
  }
  getAnimatedStyle() {
    let {
      translateY: e
...
class O extends(r = Chunk73800.PureComponent) {
  ...
  render() {
    ...
    return <div className={null != Chunk120356 ? Chunk120356 : true}><b hide={true === c || null == module && null == exports} className={s()(Chunk954955, null != exports ? Chunk161421.mention : Chunk161421.unread)} text={null != exports ? require : r} reverse={Chunk73800} animate={Chunk748780 && !Chunk902704.enabled} onClick={this.handleClick} /></div>
  }
  constructor(...e) {
