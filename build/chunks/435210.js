...
t.format = function(e) {
  ...
  for (var n = 1, r = arguments, i = r.length, a = String(e).replace(o, function(e) {
    ...
    }), s = r[n]; n < i; s = r[++n]) v(s) || !N(s) ? a += " " + s : a += " " + c(s);
  return a
...
function _(e, n, r) {
  ...
  var u = "",
    d = !1,
    y = ["{", "}"];
  if (b(n) && (d = !0, y = ["[", "]"]), P(n) && (u = " [Function" + (n.name ? ": " + n.name : "") + "]"), T(n) && (u = " " + RegExp.prototype.toString.call(n)), A(n) && (u = " " + Date.prototype.toUTCString.call(n)), C(n) && (u = " " + h(n)), 0 === s.length && (!d || 0 == n.length)) return y[0] + u + y[1];
  if (r < 0)
    if (T(n)) return e.stylize(RegExp.prototype.toString.call(n), "regexp");
...
function g(e, t, n, r, i, o) {
  ...
  if ((l = Object.getOwnPropertyDescriptor(t, i) || {
      value: t[i]
    }).get ? s = l.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : l.set && (s = e.stylize("[Setter]", "special")), x(r, i) || (a = "[" + i + "]"), !s && (0 > e.seen.indexOf(l.value) ? (s = v(n) ? _(e, l.value, null) : _(e, l.value, n - 1)).indexOf("\n") > -1 && (s = o ? s.split("\n").map(function(e) {
      return "  " + e
    }).join("\n").slice(2) : "\n" + s.split("\n").map(function(e) {
      return "   " + e
...
function A(e) {
  return N(e) && "[object Date]" === R(e)
}

function C(e) {
  return N(e) && ("[object Error]" === R(e) || e instanceof Error)
}
...
t.debuglog = function(e) {
  ...
  date: "magenta",
  regexp: "red"
}, t.types = n(842406), t.isArray = b, t.isBoolean = y, t.isNull = v, t.isNullOrUndefined = function(e) {
  return null == e
}, t.isNumber = O, t.isString = I, t.isSymbol = function(e) {
  return "symbol" == typeof e
}, t.isUndefined = S, t.isRegExp = T, t.types.isRegExp = T, t.isObject = N, t.isDate = A, t.types.isDate = A, t.isError = C, t.types.isNativeError = C, t.isFunction = P, t.isPrimitive = function(e) {
