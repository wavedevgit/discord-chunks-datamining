...
function I(e) {
  ...
  function S(e) {
    if (e.pipWindow.component === h.NYg.EMBED_IFRAME && null != b) {
      ...
      return null == e ? g.intl.string(g.t["8raC1N"]) : g.intl.formatToPlainString(g.t["a9+V+f"], {
        activityName: e
      })
    }
    return null == e.participant || e.participant.type !== m.fO.STREAM ? g.intl.string(g.t["ng/Kws"]) : g.intl.formatToPlainString(g.t.sqmFRk, {
