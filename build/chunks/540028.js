...
let T = function(e) {
  let {
    voiceChannelId: t,
    idle: n
  } = e, l = i.useRef(null), c = Array.from((0, o.e7)([p.Z], () => p.Z.pipWindows).values()).filter(e => e.component !== m.NYg.EMBED_IFRAME), u = (0, o.Wu)([_.Z], () => _.Z.getAllActiveStreamsForChannel(t)).filter(e => {
    var n;
