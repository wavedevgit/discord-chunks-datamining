...
function U(e, t) {
  let n = (0, y.Z)(t, e);
  return D(e, "channelAccessFormat", r.useMemo(() => null == n ? C.I.SOME_CHANNELS_ACCESS : (0, _.MT)(n) ? C.I.ALL_CHANNELS_ACCESS : C.I.SOME_CHANNELS_ACCESS, [n]))
}
let W = [];
...
function Y(e, t) {
  ...
  return D(e, "tierEmojiIds", r.useMemo(() => null == n ? z : V(s, n.id), [s, n]))
}
...
async function ee(e) {
  ...
  if ((null != p || null != b || null != h && null == b) && await v.I1(t, l, {
    ...
    let e = V(g.ZP.getGuildEmoji(t), s),
      ...
      i = n.map(e => g.ZP.getCustomEmojiById(e)).map(e => {
      ...
      l = r.map(e => g.ZP.getCustomEmojiById(e)).map(e => {
        if (null == e) return;
...
function en() {
  let [e, t] = r.useState(!1), [n, s] = r.useState();
  return {
    loading: e,
    error: n,
    handleCreateOrUpdateFromEditState: r.useCallback(async e => {
      ...
      try {
        if (t(!0), s(void 0), null != f) i()(null != l, "groupListingId is null"), await
        function(e) {
          var t;
          let {
            guildId: n,
            editStateId: r,
            groupListingId: s
          } = e, l = O.Z.getSubscriptionListing(r);
