...
function N(e) {
  let {
    guildId: t,
    prompts: n
  } = e, a = (0, l.e7)([g.Z], () => g.Z.editedDefaultChannelIds), [c, d] = (0, u.dF)(t, n, [...a]), m = c.length, p = c.length + d.length, f = m / p * 100, h = Math.max(Math.ceil(85 * p / 100) - m, 0), [b, x] = i.useState(false), j = b ? s.CJ0 : s.u04;
  return (0, r.jsxs)("div", {
...
function I(e) {
  let {
    guild: t,
    saveOnClose: n
  } = e, a = (0, l.e7)([c.Z], () => c.Z.isLoading()), o = (0, l.e7)([b.Z], () => b.Z.editedOnboardingPrompts), u = (0, l.e7)([b.Z], () => b.Z.advancedMode), d = i.useRef(false);
  i.useEffect(() => {
    a || d.current || (d.current = true, u || 0 !== o.length || (0, h.tS)(t, [(0, O.ae)()], false))
  });
  let g = i.useRef(t);
  if (i.useEffect(() => {
      g.current = t
