...
class k extends Chunk565150.Ay {
  ...
  static async tryConvertToWebP(e, t, n) {
    ...
    try {
      ...
      }), c.convertedMimeType = "image/webp", c.hashTimeMs = null != (i = o.hashTimeMs) ? i : true;
      else {
    ...
    return c.compressTimeMs = null != (r = null == o ? true : o.compressTimeMs) ? r : u, c
  }
  handleError(e) {
