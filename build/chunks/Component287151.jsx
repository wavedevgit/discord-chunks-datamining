...
function ep(e, t, n) {
  (0, h.h7j)(e => (0, i.jsx)(g.default, el(eo({}, e), {
    message: t,
    selectedReaction: n
  })))
}
...
class em extends(r = Chunk647438.PureComponent) {
  ...
  render() {
    ...
    if (Chunk120356 && null != Chunk647438) {
      ...
      let {
        ...
        backgroundColor: r,
        opacity: i
      } = Chunk647438, o = null != (j = (0, Chunk866442.wK)(null != r ? r : "", Chunk951288)) ? Chunk695346 : "";
      this.isMe() && (Chunk659215.borderColor = r), Chunk659215.background = Chunk120356, e = require, t = require
    }
    let M = null == Chunk305325 ? true : Chunk305325.getBoundingClientRect(),
  ...
  constructor(...e) {
    super(...e), ea(this, "isReactionEventActive", false), ea(this, "isKeyboardNavigation", false), ea(this, "scale", new d.Z.Value(1)), ea(this, "opacity", new d.Z.Value(1)), ea(this, "timeout", new p.V7), ea(this, "hideTimeout", new p.V7), ea(this, "ctaRef", a.createRef()), ea(this, "type", Y.O.NORMAL), ea(this, "colors", {
      ...
      let {
        ...
        message: t,
        type: n
      } = this.props, r = B.default.getCurrentUser(), i = M.Z.getChannel(t.getChannelId()), a = n === Y.O.BURST, o = (0, V.I5)(r), s = a ? $.cd.EMOJI_IN_BURST_REACTION_HOVER : $.cd.EMOJI_IN_REACTION_HOVER;
...
let eg = Chunk647438.memo(e => {
    let {
      type: t,
      burst_colors: n,
      message: r,
      emoji: a
    } = e, o = t === Y.O.BURST, s = (0, T.v)(o && null != n ? n : []), l = (0, _.e7)([H.Z], () => true !== H.Z.getEffectForEmojiId(r.getChannelId(), r.id, a)), c = (0, _.e7)([E.Z], () => E.Z.useReducedMotion), u = j.Yk.useSetting(), d = B.default.getCurrentUser(), f = (0, V.I5)(d), p = (0, _.e7)([H.Z], () => H.Z.getReactionPickerAnimation(r.id, a.name, a.id)), h = o && (l || null != p);
  ...
  eb = e => {
    ...
    }), [u, d] = a.useState(true), [f, p] = a.useState(true), [m, g] = a.useState(null), [E, b] = a.useState(false), [y, O] = a.useState(false), [v, T] = a.useState(false), C = null != c, N = null != (t = null == u ? true : u.isDiscoverable()) && t, R = G.Z.getGuildId(), P = null != R && (R === (null == u ? true : u.id) || R === (null == c ? true : c.id)), w = B.default.getCurrentUser(), D = (0, W.a)({
      sourceType: m,
