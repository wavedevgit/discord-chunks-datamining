...
class em extends(r = Chunk647438.PureComponent) {
  ...
  render() {
    ...
    let k = null == Chunk305325 ? true : Chunk305325.getBoundingClientRect(),
      M = null != Chunk906411 && null != Chunk592125,
      U = null == Chunk906411;
  ...
  constructor(...e) {
    super(...e), ea(this, "isReactionEventActive", false), ea(this, "isKeyboardNavigation", false), ea(this, "scale", new d.Z.Value(1)), ea(this, "opacity", new d.Z.Value(1)), ea(this, "timeout", new p.V7), ea(this, "hideTimeout", new p.V7), ea(this, "ctaRef", a.createRef()), ea(this, "type", Y.O.NORMAL), ea(this, "colors", {
      ...
      let {
        ...
        message: n,
        isLurking: r
      } = this.props, a = k.Z.getChannel(n.getChannelId()), o = M.Z.getGuild(null == a ? true : a.getGuildId());
...
let eg = Chunk647438.memo(e => {
  ...
  eb = e => {
    ...
    let {
      ...
      return {
        joinedEmojiSourceGuild: (null == e ? true : e.type) === T.B.GUILD ? M.Z.getGuild(null == e ? true : e.guildId) : true
      }
