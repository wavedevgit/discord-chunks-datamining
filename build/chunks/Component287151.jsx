...
class em extends(r = Chunk647438.PureComponent) {
  ...
  render() {
    ...
    if (Chunk120356 && null != Chunk647438) {
      ...
      let {
        ...
        backgroundColor: r,
        opacity: i
      } = Chunk647438, a = null != (j = (0, Chunk866442.wK)(null != r ? r : "", Chunk951288)) ? Chunk695346 : "";
        ...
        children: (0, Chunk951288.jsx)(Chunk748780.Z.div, {
          ...
          children: (0, Chunk951288.jsx)(Chunk481060.yRy, {
            ...
            children: n => (0, i.jsxs)(h.P3F, el(ea({}, n), {
              ...
              "aria-disabled": u,
              "aria-label": (0, L.iD)(this.isMe(), x, c, a),
  ...
  constructor(...e) {
    super(...e), eo(this, "isReactionEventActive", false), eo(this, "isKeyboardNavigation", false), eo(this, "scale", new d.Z.Value(1)), eo(this, "opacity", new d.Z.Value(1)), eo(this, "timeout", new p.V7), eo(this, "hideTimeout", new p.V7), eo(this, "ctaRef", o.createRef()), eo(this, "type", Y.O.NORMAL), eo(this, "colors", {
      ...
      o ? this.handleShowVerificationGate() : r || (this.isMe() ? (0, x.WO)({
        channelId: f,
        messageId: t.id,
        emoji: n,
        location: _,
      ...
      s && !this.isReactionEventActive && !i && o && (0, x.T6)({
      ...
      let {
        ...
        message: n,
        isLurking: r
      } = this.props, o = k.Z.getChannel(n.getChannelId()), a = M.Z.getGuild(null == o ? true : o.getGuildId());
...
let eg = Chunk647438.memo(e => {
    let {
      ...
      message: r,
      emoji: o
    } = e, a = t === Y.O.BURST, s = (0, S.v)(a && null != n ? n : []), l = (0, _.e7)([H.Z], () => true !== H.Z.getEffectForEmojiId(r.getChannelId(), r.id, o)), c = (0, _.e7)([E.Z], () => E.Z.useReducedMotion), u = j.Yk.useSetting(), d = B.default.getCurrentUser(), f = (0, V.I5)(d), p = (0, _.e7)([H.Z], () => H.Z.getReactionPickerAnimation(r.id, o.name, o.id)), h = a && (l || null != p);
  ...
  eb = e => {
    ...
    }), [u, d] = o.useState(true), [f, p] = o.useState(true), [m, g] = o.useState(null), [E, b] = o.useState(false), [y, O] = o.useState(false), [v, S] = o.useState(false), C = null != c, N = null != (t = null == u ? true : u.isDiscoverable()) && t, R = G.Z.getGuildId(), P = null != R && (R === (null == u ? true : u.id) || R === (null == c ? true : c.id)), w = B.default.getCurrentUser(), D = (0, W.a)({
      sourceType: m,
