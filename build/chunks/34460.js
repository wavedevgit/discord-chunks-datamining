...
function S(e) {
  ...
  } = e, x = (0, N.g4)(l, c, null != i ? null == (n = i[s]) || null == (t = n.listings[0]) ? void 0 : t.price_tier : void 0), u = null != x && x.length > 0, p = r.useCallback(e => {
    u ? d(!0) : m(e)
  }, [m, u, d]);
...
function w(e) {
  ...
  let [R, w] = r.useState(0), [B, k] = r.useState(!1), L = r.useCallback(e => {
