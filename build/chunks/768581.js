...
function A(e) {
  ...
  let m = {};
  return null != s && (m.size = (0, l.oO)(s * (0, l.x_)())), null != d && (m.keep_aspect_ratio = d), c && (m.quality = "lossless"), "webp" === p && u && $(a) && (m.animated = !0), t + "?".concat(o.stringify(m))
}
...
function w(e) {
  let {
    ...
    discriminator: i,
    bot: a
  } = e, o = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : f.IXf, l = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null, c = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : O;
  if (a) {
...
function R(e) {
  ...
  return null != (t = w(e, n, r, i, a)) ? t : C(e.id, e.discriminator, e.isProvisional)
}
...
function P(e) {
  ...
  return "webp" === u && a && $(i) && (_.animated = !0), t += "?".concat(o.stringify(_))
}
...
function x(e) {
  ...
  return "webp" === c && i && $(r) && (u.animated = !0), t += "?".concat(o.stringify(u))
}
...
function M(e) {
  ...
  return (null != a ? "https://".concat(a, "/splashes/").concat(n, "/").concat(r, ".jpg") : location.protocol + window.GLOBAL_ENV.API_ENDPOINT + f.ANM.GUILD_SPLASH(n, r)) + "?size=".concat(i)
}
...
function G(e) {
  ...
  return "jpg" === c && (d.quality = "lossless"), "webp" === c && i && $(r) && (d.animated = !0), t += "?".concat(o.stringify(d))
}
