...
function R(e) {
  let {
    ...
    discriminator: i,
    bot: a
  } = e, o = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : _.IXf, l = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null, c = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : O;
  if (a) {
...
function w(e) {
  ...
  return "webp" === u && a && X(i) && (f.animated = !0), t += "?".concat(o.stringify(f))
}
...
function M(e) {
  ...
  let {
    CDN_HOST: a,
    API_ENDPOINT: o
  } = window.GLOBAL_ENV, c = _.ANM.AVATAR_DECORATION_PRESETS(i);
