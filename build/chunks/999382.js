...
function em(e) {
  ...
  o = s = f, l = c = p, J = Q, ee = $, K = M.QZA.OPEN, z = {}, q = null, u = P.default.castGuildIdAsEveryoneGuildRoleId(n), er = s.mfaLevel, el = es, _ = null, ei = d, eb({
...
function eb(e) {
  ...
  } else r === M.pNK.MEMBERS ? u = s.getEveryoneRoleId() : r === M.pNK.VANITY_URL ? (0, L.U5)(s.id) : r === M.pNK.SAFETY && O.Z.dispatch({
