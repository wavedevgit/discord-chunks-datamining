...
function eE(e) {
  ...
  o = s = f, l = c = p, ee = $, en = et, q = j.QZA.OPEN, X = {}, Q = null, u = D.default.castGuildIdAsEveryoneGuildRoleId(n), ea = s.mfaLevel, eu = ec, _ = null, eo = d, eO({
...
function e2(e) {
  ...
  let i = eu.secondaryCategoryIds.indexOf(r); - 1 !== i && ((t = [...eu.secondaryCategoryIds]).splice(i, 1), eu = Z(V({}, eu), {
    secondaryCategoryIds: t
  })), -1 !== (i = ec.secondaryCategoryIds.indexOf(r)) && ((t = [...ec.secondaryCategoryIds]).splice(i, 1), ec = Z(V({}, ec), {
    secondaryCategoryIds: t
  }))
}
