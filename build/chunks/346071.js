...
function u(e) {
  let {
    ...
    style: d
  } = e, _ = t.fractionalState === o.a$.FP_SUB_PAUSED, f = (0, a.Z)(t.endsAt, _), p = "", h = {
    trial: {
  ...
  return (f.days > 0 && f.hours > 0 ? p = s.intl.format(h[n].days_and_hours, {
    days: f.days,
    hours: f.hours
  }) : f.days > 0 ? p = s.intl.format(h[n].days, {
    days: f.days
  }) : f.hours > 0 && (p = s.intl.format(h[n].hours, {
    hours: f.hours
