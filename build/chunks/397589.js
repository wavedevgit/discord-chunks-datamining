...
let I = e => {
  ...
  let {
    message: n
  } = e, b = i.useRef(null), O = (0, f.p7)("Message Header") && n.hasPotions(), I = s.Z.getChannel(n.getChannelId()), T = null == (t = n.potions) ? void 0 : t[0], S = i.useMemo(() => {
    var e;
  ...
  return O && null != S && (null == T ? void 0 : T.type) === p.B.CONFETTI ? (0, r.jsx)(a.P3F, {
    onFocus: A,
    onClick: N,
