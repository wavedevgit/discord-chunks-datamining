...
let y = e => {
  ...
  let {
    message: n
  } = e, y = o.useRef(null), v = (0, p.p7)("Message Header") && n.hasPotions(), O = s.Z.getChannel(n.getChannelId()), j = null == (t = n.potions) ? void 0 : t[0], x = o.useMemo(() => {
    var e;
  ...
  return v && null != x && (null == j ? void 0 : j.type) === m.B.CONFETTI ? (0, r.jsx)(a.P3F, {
    onFocus: C,
    onClick: P,
