...
let y = e => {
  ...
  let {
    message: n
  } = e, y = o.useRef(null), j = (0, p.p7)("Message Header") && n.hasPotions(), v = s.Z.getChannel(n.getChannelId()), P = null == (t = n.potions) ? void 0 : t[0], x = o.useMemo(() => {
    var e;
  ...
  return j && null != x && (null == P ? void 0 : P.type) === g.B.CONFETTI ? (0, r.jsx)(l.P3F, {
    onFocus: C,
    onClick: w,
