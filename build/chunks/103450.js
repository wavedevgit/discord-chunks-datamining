...
function U(e) {
  ...
  let U, {
    ...
    $ = (0, i.e7)([T.Z, y.Z, D.Z, v.Z], () => q || null != z && (0, x.t)({
    ...
    ee = (0, i.e7)([c.ZP], () => Array.from(c.ZP.getSelfEmbeddedActivities().values()).some(e => {
      let {
        applicationId: t,
        location: n
      } = e;
    ...
    ei = (0, i.e7)([O.Z, S.Z, I.Z, N.Z, C.Z, P.Z, A.Z], () => null != B ? er === p.Fw.CAN_JOIN : (0, d.Z)({
      user: F,
      activity: G,
      application: en,
      channelId: J,
