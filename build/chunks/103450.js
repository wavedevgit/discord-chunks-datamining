...
function G(e) {
  ...
  let G, {
    ...
    er = (0, i.e7)([w.Z], () => null != B && null != B.application_id && w.Z.getState(B.application_id, k.mFx.JOIN) === k.OcF.LOADING),
    ei = (0, b.q)(X),
    ea = (0, y.A)(ei),
    eo = (0, p.s5)({
      userId: F.id,
    ...
    es = (0, i.e7)([v.Z, S.Z, T.Z, N.Z, R.Z, D.Z, C.Z], () => null != Z ? eo === p.Fw.CAN_JOIN : (0, d.Z)({
      user: F,
      activity: B,
      application: ei,
      channelId: ee,
