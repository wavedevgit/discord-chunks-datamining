...
function G(e) {
  ...
  let G, {
    ...
    ee = (0, a.e7)([N.Z, v.Z, L.Z, I.Z], () => Q || null != q && (0, M.t)({
    ...
    et = (0, a.e7)([u.ZP], () => Array.from(u.ZP.getSelfEmbeddedActivities().values()).some(e => {
      let {
        applicationId: t,
        location: n
      } = e;
    ...
    eo = (0, a.e7)([O.Z, T.Z, S.Z, C.Z, R.Z, w.Z, A.Z], () => null == F || ei ? (0, f.Z)({
      user: V,
      activity: B,
      application: er,
      channelId: ei ? void 0 : $,
