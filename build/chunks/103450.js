...
function G(e) {
  ...
  let G, {
    ...
    ee = (0, o.e7)([N.Z, v.Z, L.Z, I.Z], () => Q || null != q && (0, M.t)({
    ...
    et = (0, o.e7)([u.ZP], () => Array.from(u.ZP.getSelfEmbeddedActivities().values()).some(e => {
      let {
        applicationId: t,
        location: n
      } = e;
    ...
    ea = (0, o.e7)([O.Z, T.Z, S.Z, C.Z, R.Z, w.Z, A.Z], () => null == F || ei ? (0, f.Z)({
      user: V,
      activity: B,
      application: er,
      channelId: ei ? void 0 : $,
  ...
  let eu = !J || Q && !es,
    ed = eu && (ec || ee) && !K && !et;
  eu ? ec || ee || null == B || (G = U.NW.formatToPlainString(U.t.SqJBnJ, {
    name: B.name
  })) : G = U.NW.string(U.t["0OiwfH"]);
  let ef = null != (n = null == F ? void 0 : F.launchId) ? n : null == B ? void 0 : B.session_id,
    e_ = async (e, t) => {
      ...
      async function t() {
        let e;
        z(!0), null != B && (e = await a.Z.sendActivityInviteUser({
  ...
  return es && (eh = U.NW.string(U.t.DPfdsr)), {
    buttonCTA: eh,
    tooltip: G,
