...
let I = (e, t, n) => {
  ...
  T = e => {
    let {
      ...
      primaryColor: C,
      secondaryColor: R
    } = (0, m.Z)(null == N ? void 0 : N.src), P = (0, a.e7)([s.default], () => s.default.locale), w = (0, h.Z)(v.ABu.CRUNCHYROLL), D = (0, _.ap)(n.extra.media_assets_large_text), L = i.useCallback(e => {
    ...
    }, [t, n, D, P, null == N ? void 0 : N.src, C, R, A]), x = () => {
