...
let I = (e, t, n) => {
  ...
  S = (e, t) => O.NW.formatToPlainString(O.t.kCbfbG, {
    username: t.username,
  ...
  T = e => {
    let {
    ...
    } = e, N = (0, a.e7)([l.default], () => l.default.getUser(n.author_id)), {
      largeImage: A
    } = (0, f.rv)({
      entry: n
    }), {
      primaryColor: C,
      secondaryColor: R
    } = (0, m.Z)(null == A ? void 0 : A.src), P = (0, a.e7)([s.default], () => s.default.locale), w = (0, h.Z)(v.ABu.CRUNCHYROLL), D = (0, _.ap)(n.extra.media_assets_large_text), L = i.useCallback(e => {
    ...
    return null == N ? null : (0, r.jsxs)(b.yR, {
