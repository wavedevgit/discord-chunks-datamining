...
let I = (e, t, n) => {
  ...
  S = e => {
    let {
      ...
      primaryColor: C,
      secondaryColor: w
    } = (0, m.Z)(null == N ? void 0 : N.src), R = (0, a.e7)([s.default], () => s.default.locale), P = (0, h.Z)(O.ABu.CRUNCHYROLL), D = (0, _.ap)(n.extra.media_assets_large_text), L = i.useCallback(e => {
    ...
    }, [t, n, D, R, null == N ? void 0 : N.src, C, w, A]), x = () => {
