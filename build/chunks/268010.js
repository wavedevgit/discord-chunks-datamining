...
let I = (e, t, n) => {
    ...
    return O.intl.formatToMarkdownString(r, {
      mediaTitle: a,
      userName: i,
      episodeDescription: e.extra.media_subtitle
    }).replaceAll("*", "")
  },
  S = (e, t) => O.intl.formatToPlainString(O.t.kCbfbG, {
    username: t.username,
  ...
  T = e => {
    let {
      ...
      primaryColor: C,
      secondaryColor: P
    } = (0, m.Z)(null == N ? void 0 : N.src), R = (0, a.e7)([s.default], () => s.default.locale), w = (0, h.Z)(v.ABu.CRUNCHYROLL), D = (0, _.ap)(n.extra.media_assets_large_text), L = i.useCallback(e => {
    ...
    }, [t, n, D, R, null == N ? void 0 : N.src, C, P, A]), x = () => {
