...
let W = Object.freeze({
  ...
  X = e => {
    ...
    if ((null == (n = (0, b.N)()) || null == (t = n.subscription_trial) ? true : t.sku_id) === x.Si.TIER_2 && o) return null;
    let l = (0, s.EQ)({
      type: i,
      isPreview: o,
      isCoachmark: a
  ...
  J = e => {
    ...
    i.useEffect(() => {
      (v === w.XV.length - 2 && "EDITOR" === a || b === c.Us.EASTER_EGG) && O(true)
    }, [v, a, b]);
    let D = (e, t) => {
        if ((0, A.zO)(e.id), z({
            isPersisted: !E,
            analyticsLocations: g,
            themeName: c.Us[e.id]
          }), E && o.v2EditorEnabled && "SETTINGS" === a ? x(e) : (0, f.ZI)({
