...
let d = [],
  _ = function(e) {
    ...
    } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, E = (0, i.e7)([a.Z], () => a.Z.isConnected()), d = (0, i.e7)([u.Z], () => null != e ? u.Z.getSubscriptionGroupListingsForGuildFetchState(e) : u.M.FETCHED), _ = r.useRef(t);
    r.useEffect(() => {
    ...
    let I = (0, l.Z)(_);
    return {
      listingsLoaded: d === u.M.FETCHED && !0 !== I
    }
  },
  I = function(e) {
    let {
  ...
  S = e => {
    let [t, n] = r.useState(!1), l = r.useMemo(() => e.map(E.W), [e]), o = (0, i.Wu)([u.Z], () => l.filter(e => !u.Z.getDidFetchListingForSubscriptionPlanId(e)), [l]);
    return r.useEffect(() => {
