...
let c = [],
  g = function(e) {
    ...
    } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, u = (0, s.e7)([a.Z], () => a.Z.isConnected()), c = (0, s.e7)([h.Z], () => null != e ? h.Z.getSubscriptionGroupListingsForGuildFetchState(e) : h.M.FETCHED), g = i.useRef(t);
    i.useEffect(() => {
      if (null == e || !u || !0 === o) return;
      let i = h.Z.getSubscriptionGroupListingsForGuildFetchState(e);
      (t || i === h.M.NOT_FETCHED) && (g.current = !1, d.FP(e, {
    ...
    let C = (0, r.Z)(g);
    return {
      listingsLoaded: c === h.M.FETCHED && !0 !== C
    }
  },
  C = function(e) {
    let {
  ...
  y = e => {
    let [t, n] = i.useState(!1), r = i.useMemo(() => e.map(u.W), [e]), l = (0, s.Wu)([h.Z], () => r.filter(e => !h.Z.getDidFetchListingForSubscriptionPlanId(e)), [r]);
    return i.useEffect(() => {
      !t && l.length > 0 && (n(!0), Promise.all(l.map(e => d.vY(e))).catch(() => {}).then(() => {
        n(!1)
      }))
    }, [t, l]), {
      loading: t
