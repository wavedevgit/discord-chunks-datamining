...
let h = [],
  _ = function(e) {
    ...
    } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, u = (0, r.e7)([s.Z], () => s.Z.isConnected()), h = (0, r.e7)([d.Z], () => null != e ? d.Z.getSubscriptionGroupListingsForGuildFetchState(e) : d.M.FETCHED), _ = i.useRef(t);
    i.useEffect(() => {
      if (null == e || !u || !0 === a) return;
      let i = d.Z.getSubscriptionGroupListingsForGuildFetchState(e);
      (t || i === d.M.NOT_FETCHED) && (_.current = !1, c.FP(e, {
    ...
    let E = (0, l.Z)(_);
    return {
      listingsLoaded: h === d.M.FETCHED && !0 !== E
    }
  },
  E = function(e) {
    let {
