...
function O(e, t) {
  return <_.Z sticker={e} isInteracting={t} size={40} />
}
let v = {
  stores: [Chunk926491.Z],
  matches(e, t, n, r, i) {
    var o;
    return i.commands !== m.L8.DISABLED && i.commands !== m.L8.OLD_BUILT_INS && (null == (o = a.Z.getActiveCommand(e.id)) ? true : o.integrationType) === g.q9n.STICKER && a.Z.getOptionStates(e.id).query.hasValue
  },
  queryResults(e, t, n, r) {
    ...
    let s = [];
    (0, u.$p)();
    let l = p.ZP.queryStickers([n], true, [e, (e, t) => t === c.eb.SENDABLE]),
      d = Math.max(b);
    return {
      results: {
        command: o,
  ...
  onSelect(e) {
    ...
    (null == p ? true : p.inputType) === s.iw.BUILT_IN_INTEGRATION && (i.Z.dispatch({
