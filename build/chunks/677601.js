...
class eK extends i.PureComponent {
  ...
  componentDidMount() {
    ...
    this.currentDocument.addEventListener(eE.NO, this.handleFullScreenChange), ex.default.track(eG.rMx.VIDEO_LAYOUT_TOGGLED, ez({
  ...
  renderContent(e) {
    ...
    } = this.state, x = f === eG.AEg.MINIMUM, C = x || f === eG.AEg.NORMAL, v = i && o === eG.WtW.VIDEO, j = (null != (t = null == b ? void 0 : b.length) ? t : 0) > 0 && p.isPrivate();
  ...
  constructor(...e) {
    super(...e), eV(this, "_prevLayout", eG.AEg.MINIMUM), eV(this, "_wrapperRef", i.createRef()), eV(this, "_callContainerRef", i.createRef()), eV(this, "_channelChatRef", i.createRef()), eV(this, "_contentRef", i.createRef()), eV(this, "_videoBackgroundTooltipTimeout", new p.V7), eV(this, "_lastIdleProps", null), eV(this, "state", {
      ...
      return this.inPopout || i === eG.AEg.FULL_SCREEN || null == t || n.isManaged() || (e = (0, r.jsx)(C.Z, {
        call: t
      })), (0, r.jsx)(k.Z, {
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [y && !s ? x : null, _ ? (0, r.jsxs)(k.Z, {
...
let eX = function(e) {
  ...
  let e_ = (0, B.S)(),
    ey = (0, eS.Z)(n, !0),
    {
      hasParticipantsPanel: ex
    } = (0, eR.Z)({
      location: "ChannelCall"
    }),
    {
      simplifiedSettingsEnabled: eC
    } = (0, K.Z)({
      location: "ChannelCall"
    }),
