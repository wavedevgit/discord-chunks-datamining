...
class eX extends i.PureComponent {
  ...
  componentDidMount() {
    ...
    this.currentDocument.addEventListener(eN.NO, this.handleFullScreenChange), ey.default.track(eH.rMx.VIDEO_LAYOUT_TOGGLED, ez({
  ...
  get screenMessage() {
    return this.popoutOpen && !this.inPopout && this.props.inCall ? {
      mainText: eF.NW.string(eF.t.J5bXZW)
    } : null
  }
  get paused() {
  ...
  get viewProperties() {
    let {
      ...
      channel: n,
      inCall: r
    } = this.props, i = t === eH.WtW.VIDEO && r && !(this.popoutOpen && !this.inPopout), l = t === eH.WtW.VIDEO && r && this.popoutSupported, o = t !== eH.WtW.VOICE && n.isPrivate() && !this.inPopout && r, a = n.type === eH.d4z.GUILD_VOICE, s = e === eH.AEg.MINIMUM || e === eH.AEg.NORMAL, c = this.inPopout && this.nativePopoutSupported, u = {
      renderHeader: !0,
      useTheme: !1,
      useExternalHeader: s,
      canInvite: a,
  ...
  renderContent(e) {
    ...
    let {
      ...
      isStaff: v
    } = this.state, y = f === eH.AEg.MINIMUM, x = y || f === eH.AEg.NORMAL, j = i && o === eH.WtW.VIDEO, O = (null !== (t = null == b ? void 0 : b.length) && void 0 !== t ? t : 0) > 0 && p.isPrivate();
  ...
  render() {
    let {
      ...
      resizedHeight: h
    } = this.state, g = i === eH.WtW.VIDEO, b = e !== eH.AEg.NO_CHAT && e !== eH.AEg.FULL_SCREEN && null != c, _ = g ? (0, f.ap)(p) ? eH.BRd.DARK : p : void 0;
    return (0, r.jsxs)("div", {
  ...
  constructor(...e) {
    var t, l;
    super(...e), eV(this, "_prevLayout", eH.AEg.MINIMUM), eV(this, "_wrapperRef", i.createRef()), eV(this, "_callContainerRef", i.createRef()), eV(this, "_channelChatRef", i.createRef()), eV(this, "_contentRef", i.createRef()), eV(this, "_videoBackgroundTooltipTimeout", new h.V7), eV(this, "_lastIdleProps", null), eV(this, "state", {
      ...
      switch (null === (o = this._lastIdleProps) || void 0 === o || o.onPreventIdle("menu"), null === (a = this._lastIdleProps) || void 0 === a || a.onActive(), e.type) {
        ...
        case eB.fO.STREAM:
          this.trackCallTileContextMenuImpression(e, eB.TH.STREAM), (0, _.jW)(t, async () => {
            let {
              default: t
        ...
        case eB.fO.USER:
          ...
          if (null != h) {
            if (this.props.enableSimplifiedCallSettings && i) return (0, q.D)(t, h, c, p, (e, t) => (0, eW.o)({
              menuItemProps: t,
              menuName: e,
            ...
            switch (c.type) {
              case eH.d4z.DM:
                return (0, _.jW)(t, async () => {
                  let {
                    default: t
                  } = await Promise.all([n.e("79695"), n.e("70205"), n.e("98783"), n.e("53912"), n.e("56826"), n.e("87405")]).then(n.bind(n, 131404));
                  return n => (0, r.jsx)(t, eY(ez({}, n), {
              ...
              case eH.d4z.GROUP_DM:
                return (0, _.jW)(t, async () => {
                  let {
                    default: t
                  } = await Promise.all([n.e("79695"), n.e("98783"), n.e("99476")]).then(n.bind(n, 354589));
                  return n => (0, r.jsx)(t, eY(ez({}, n), {
                    showChannelCallItems: !0,
                    showMediaItems: !0,
      ...
      (0, eB._5)(e) && (0, F.p9)(n, ev.Z, em.Z, eg.Z, W.Z)[0] && (C.default.selectVoiceChannel(n.id), 0 === i.filter(t => (0, H.V9)(t) === e.id && t.state !== eH.jm8.ENDED).length && (0, v.rn)((0, H.my)(e.id), {
        forceMultiple: t.shiftKey
      })), l && o === eH.WtW.VIDEO && ((null == r ? void 0 : r.id) === e.id ? b.Z.selectParticipant(n.id, null) : b.Z.selectParticipant(n.id, e.id))
      ...
      let {
        layout: n,
        selectedParticipant: r
      } = this.props, i = n === eH.AEg.FULL_SCREEN;
      ...
      return this.inPopout || i === eH.AEg.FULL_SCREEN || null == t || n.isManaged() || (e = (0, r.jsx)(x.Z, {
        call: t
      })), (0, r.jsx)(k.Z, {
      ...
      return t || n === eH.AEg.MINIMUM || n === eH.AEg.NORMAL ? (0, r.jsx)(Q.ZP, {
        exitFullScreen: this.maybeLeaveFullScreen,
        channel: e,
      ...
      return (0, r.jsxs)(r.Fragment, {
        ...
        }) : null, (null == a ? void 0 : a.type) !== eB.fO.STREAM && (null == a ? void 0 : a.type) !== eB.fO.ACTIVITY || s ? null : (0, r.jsx)(et.Z, {
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [null != i && i.type !== eB.fO.ACTIVITY && i.user.id !== n ? (0, r.jsx)(ec.Z, {
      ...
      return !e || t || this.popoutOpen && !this.inPopout && i ? null : (0, r.jsx)(eZ.ZP, {
      ...
      return c ? (0, r.jsxs)(et.Z, {
        children: [(0, r.jsx)("div", {
          className: eG.headerWrapper,
          children: a ? null == e ? void 0 : e() : (0, r.jsx)(eA.Z, {
            channel: t,
            guild: n,
            appContext: i,
            inCall: o,
...
let eQ = function(e) {
  ...
  let {
    ...
    ref: f
  } = (0, O.Z)(), g = (0, N.bp)(), b = (0, U.Z)(), _ = (0, d.e7)([e_.Z], () => {
    var e;
    ...
    return e && r !== eH.AEg.FULL_SCREEN && (r = eH.AEg.NO_CHAT), {
      mode: t,
      layout: r,
  ...
  }, [g, n.id]), H = (0, d.Wu)([ed.Z], () => ed.Z.getAllActiveStreams()), {
    selectedStream: F
  } = (0, d.cj)([ed.Z], () => ({
    selectedStream: null != L ? ed.Z.getActiveStreamForStreamKey(L.id) : null
  }), [L]), G = (0, d.e7)([em.Z], () => em.Z.getGuild(n.getGuildId())), z = (0, d.e7)([ef.Z], () => ef.Z.getCall(n.id), [n.id]), Y = (0, d.e7)([eb.ZP], () => eb.ZP.getMentionCount(n.id), [n.id]), q = (0, d.e7)([ep.default], () => ep.default.getId()), {
    popoutWindow: Q,
  ...
  })), $ = (0, d.e7)([eg.Z], () => eg.Z.can(eH.Plq.CONNECT, n)), ee = (0, d.e7)([eh.Z], () => eh.Z.getToastsEnabled(n.id)), et = (0, d.e7)([W.Z], () => W.Z.getAwaitingRemoteSessionInfo()), en = (0, d.e7)([K.ZP], () => K.ZP.callHeaderHeight), er = i.useCallback(e => {
    y.ZP.updatedUnsyncedSettings({
      callHeaderHeight: e
    })
  }, []), ei = null !== (t = null == G ? void 0 : G.id) && void 0 !== t ? t : null, el = (0, Z.Z)(ei, n.id), eo = (0, d.e7)([P.Z], () => P.Z.getFetchState(), []), ea = (0, E.Z)(eo);
  i.useEffect(() => {
      ...
      children: (0, r.jsx)(eZ.B2, {
        children: (0, r.jsxs)(eL._A, {
          children: [(0, r.jsx)(eX, {
            ...
            theme: eO
          }), !n.isPrivate() && (0, r.jsx)(eL.YR, {}), (0, r.jsx)(eZ.H_, {})]
        })
      })
    })
  })
