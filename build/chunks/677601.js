...
class eq extends i.PureComponent {
  ...
  renderContent(e) {
    ...
    } = this.state, C = f === eB.AEg.MINIMUM, x = C || f === eB.AEg.NORMAL, v = i && a === eB.WtW.VIDEO, j = (null != (t = null == b ? void 0 : b.length) ? t : 0) > 0 && p.isPrivate();
  ...
  constructor(...e) {
    super(...e), eH(this, "_prevLayout", eB.AEg.MINIMUM), eH(this, "_wrapperRef", i.createRef()), eH(this, "_callContainerRef", i.createRef()), eH(this, "_channelChatRef", i.createRef()), eH(this, "_contentRef", i.createRef()), eH(this, "_videoBackgroundTooltipTimeout", new p.V7), eH(this, "_lastIdleProps", null), eH(this, "state", {
      ...
      return this.inPopout || i === eB.AEg.FULL_SCREEN || null == t || n.isManaged() || (e = (0, r.jsx)(x.Z, {
        call: t
      })), (0, r.jsx)(M.Z, {
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [_ && !s ? y : null, b ? (0, r.jsxs)(M.Z, {
...
let eK = function(e) {
  ...
  let {
    ...
    selectedStream: null != G ? ec.Z.getActiveStreamForStreamKey(G.id) : null
  }), [G]), W = (0, u.e7)([eh.Z], () => eh.Z.getGuild(n.getGuildId())), Y = (0, u.e7)([ep.Z], () => ep.Z.getCall(n.id), [n.id]), K = (0, u.e7)([em.ZP], () => em.ZP.getMentionCount(n.id), [n.id]), X = (0, u.e7)([eu.default], () => eu.default.getId()), {
    popoutWindow: Q,
