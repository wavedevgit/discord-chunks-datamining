...
class eV extends i.PureComponent {
  ...
  componentDidMount() {
    ...
    this.currentDocument.addEventListener(eC.NO, this.handleFullScreenChange), em.default.track(eD.rMx.VIDEO_LAYOUT_TOGGLED, eB({
  ...
  constructor(...e) {
    super(...e), eU(this, "_prevLayout", eD.AEg.MINIMUM), eU(this, "_wrapperRef", i.createRef()), eU(this, "_callContainerRef", i.createRef()), eU(this, "_channelChatRef", i.createRef()), eU(this, "_contentRef", i.createRef()), eU(this, "_videoBackgroundTooltipTimeout", new p.V7), eU(this, "_lastIdleProps", null), eU(this, "state", {
      resizedHeight: V.ZP.callHeaderHeight
      ...
      switch (null == (a = this._lastIdleProps) || a.onPreventIdle("menu"), null == (o = this._lastIdleProps) || o.onActive(), e.type) {
        ...
        case eM.fO.STREAM:
          this.trackCallTileContextMenuImpression(e, eM.TH.STREAM), (0, g.jW)(t, async () => {
            let {
              default: t
        ...
        case eM.fO.USER:
          ...
          if (null != h) {
            if (i) return (0, G.D)(t, h, c, p, (e, t) => (0, ew.o)({
              menuItemProps: t,
              menuName: e,
      ...
      (0, eM._5)(e) && (0, U.p9)(n, ef.Z, ec.Z, eu.Z, D.Z)[0] && (b.default.selectVoiceChannel(n.id), 0 === i.filter(t => (0, L.V9)(t) === e.id && t.state !== eD.jm8.ENDED).length && (0, _.rn)((0, L.my)(e.id), {
      ...
      return t || n === eD.AEg.MINIMUM || n === eD.AEg.NORMAL ? (0, r.jsx)(z.ZP, {
        exitFullScreen: this.maybeLeaveFullScreen,
        channel: e,
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [b && !s ? _ : null, g ? (0, r.jsxs)(R.Z, {
        ...
        }) : null, (null == o ? void 0 : o.type) !== eM.fO.STREAM && (null == o ? void 0 : o.type) !== eM.fO.ACTIVITY || s ? null : (0, r.jsx)(K.Z, {
      ...
      return (0, r.jsxs)(K.Z, {
        children: [(0, r.jsx)("div", {
          ...
          children: c ? null == n ? void 0 : n(p) : (0, r.jsx)(eS.Z, {
            channel: i,
            guild: l,
            appContext: a,
            inCall: s,
...
let ez = function(e) {
  ...
  let {
    ...
    ref: m
  } = (0, v.ZP)(), g = (0, O.bp)(), b = (0, k.Z)(), _ = (0, u.e7)([ep.Z], () => {
    var e;
  ...
  }, [g, n.id]), H = (0, u.Wu)([el.Z], () => el.Z.getAllActiveStreams()), {
    selectedStream: G
  } = (0, u.cj)([el.Z], () => ({
  ...
  })), Q = (0, u.e7)([eu.Z], () => eu.Z.can(eD.Plq.CONNECT, n)), J = (0, u.e7)([eo.Z], () => eo.Z.getToastsEnabled(n.id)), $ = (0, u.e7)([D.Z], () => D.Z.getAwaitingRemoteSessionInfo()), ee = (0, u.e7)([V.ZP], () => V.ZP.callHeaderHeight), et = i.useCallback(e => {
    y.ZP.updatedUnsyncedSettings({
      callHeaderHeight: e
    })
  }, []), en = null != (t = null == z ? void 0 : z.id) ? t : null, er = (0, I.Z)(en, n.id), ei = (0, u.e7)([S.Z], () => S.Z.getFetchState(), []), eh = (0, j.Z)(ei);
  i.useEffect(() => {
