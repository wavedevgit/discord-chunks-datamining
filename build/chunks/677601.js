...
class eq extends i.PureComponent {
  ...
  componentDidMount() {
    ...
    this.currentDocument.addEventListener(eO.NO, this.handleFullScreenChange), ex.default.track(eB.rMx.VIDEO_LAYOUT_TOGGLED, eV({
  ...
  get screenMessage() {
    return this.popoutOpen && !this.inPopout && this.props.inCall ? {
      mainText: eG.intl.string(eG.t.J5bXZW)
    } : null
  }
  get inPopout() {
  ...
  get viewProperties() {
    let {
      ...
      channel: n,
      inCall: r
    } = this.props, i = t === eB.WtW.VIDEO && r && !(this.popoutOpen && !this.inPopout), l = t === eB.WtW.VIDEO && r && this.popoutSupported, a = t !== eB.WtW.VOICE && n.isPrivate() && !this.inPopout && r, o = n.type === eB.d4z.GUILD_VOICE, s = e === eB.AEg.MINIMUM || e === eB.AEg.NORMAL, c = this.inPopout && this.nativePopoutSupported, u = {
      renderHeader: !0,
      useTheme: !1,
      useExternalHeader: s,
      canInvite: o,
  ...
  renderContent(e) {
    ...
    } = this.state, y = f === eB.AEg.MINIMUM, C = y || f === eB.AEg.NORMAL, v = i && a === eB.WtW.VIDEO, j = (null != (t = null == b ? void 0 : b.length) ? t : 0) > 0 && p.isPrivate();
    return this._lastIdleProps = e, (0, r.jsx)(et.Z, ez(eV({
  ...
  render() {
    ...
    return e = g ? eB.BRd.MIDNIGHT : _ ? (0, h.ap)(m) ? eB.BRd.DARK : m : void 0, (0, r.jsxs)("div", {
  ...
  constructor(...e) {
    super(...e), eH(this, "_prevLayout", eB.AEg.MINIMUM), eH(this, "_wrapperRef", i.createRef()), eH(this, "_callContainerRef", i.createRef()), eH(this, "_channelChatRef", i.createRef()), eH(this, "_contentRef", i.createRef()), eH(this, "_videoBackgroundTooltipTimeout", new p.V7), eH(this, "_lastIdleProps", null), eH(this, "state", {
      ...
      (0, eU._5)(e) && (0, F.p9)(n, e_.Z, eh.Z, ef.Z, D.Z)[0] && (_.default.selectVoiceChannel(n.id), 0 === i.filter(t => (0, G.V9)(t) === e.id && t.state !== eB.jm8.ENDED).length && (0, x.rn)((0, G.my)(e.id), {
      ...
      return this.inPopout || i === eB.AEg.FULL_SCREEN || null == t || n.isManaged() || (e = (0, r.jsx)(C.Z, {
        call: t
      })), (0, r.jsx)(k.Z, {
      ...
      return t || n === eB.AEg.MINIMUM || n === eB.AEg.NORMAL ? (0, r.jsx)(K.ZP, {
        exitFullScreen: this.maybeLeaveFullScreen,
        channel: e,
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [_ && !s ? x : null, b ? (0, r.jsxs)(k.Z, {
        ...
        }) : null, (null == o ? void 0 : o.type) !== eU.fO.STREAM && (null == o ? void 0 : o.type) !== eU.fO.ACTIVITY || s ? null : (0, r.jsx)($.Z, {
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [null != i && i.type !== eU.fO.ACTIVITY && i.user.id !== n ? (0, r.jsx)(eo.Z, {
      ...
      return c ? (0, r.jsxs)($.Z, {
        children: [(0, r.jsx)("div", {
          ...
          children: o ? null == e ? void 0 : e() : (0, r.jsx)(eN.Z, {
            channel: t,
            guild: n,
            appContext: i,
            inCall: a,
...
let eK = function(e) {
  ...
  let {
    ...
    ref: m
  } = (0, j.ZP)(), g = (0, E.bp)(), b = (0, U.Z)(), _ = (0, u.e7)([eg.Z], () => {
    var e;
  ...
  }, [g, n.id]), H = (0, u.Wu)([ec.Z], () => ec.Z.getAllActiveStreams()), {
    selectedStream: z
  } = (0, u.cj)([ec.Z], () => ({
    selectedStream: null != F ? ec.Z.getActiveStreamForStreamKey(F.id) : null
  }), [F]), W = (0, u.e7)([eh.Z], () => eh.Z.getGuild(n.getGuildId())), Y = (0, u.e7)([ep.Z], () => ep.Z.getCall(n.id), [n.id]), K = (0, u.e7)([em.ZP], () => em.ZP.getMentionCount(n.id), [n.id]), X = (0, u.e7)([eu.default], () => eu.default.getId()), {
    popoutWindow: Q,
