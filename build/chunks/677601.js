...
class eW extends i.PureComponent {
  ...
  componentDidMount() {
    ...
    this.currentDocument.addEventListener(ev.NO, this.handleFullScreenChange), eb.default.track(eL.rMx.VIDEO_LAYOUT_TOGGLED, eG({
  ...
  get viewProperties() {
    let {
      ...
      channel: n,
      inCall: r
    } = this.props, i = t === eL.WtW.VIDEO && r && !(this.popoutOpen && !this.inPopout), l = t === eL.WtW.VIDEO && r && this.popoutSupported, a = t !== eL.WtW.VOICE && n.isPrivate() && !this.inPopout && r, o = n.type === eL.d4z.GUILD_VOICE, s = e === eL.AEg.MINIMUM || e === eL.AEg.NORMAL, c = this.inPopout && this.nativePopoutSupported, u = {
      renderHeader: !0,
      useTheme: !1,
      useExternalHeader: s,
      canInvite: o,
  ...
  renderContent(e) {
    ...
    } = this.props, y = f === eL.AEg.MINIMUM, x = y || f === eL.AEg.NORMAL, C = i && a === eL.WtW.VIDEO, v = (null != (t = null == b ? void 0 : b.length) ? t : 0) > 0 && p.isPrivate();
    return this._lastIdleProps = e, (0, r.jsx)($.Z, eH(eG({
  ...
  render() {
    let {
      ...
      resizedHeight: p
    } = this.state, f = i === eL.WtW.VIDEO, m = e !== eL.AEg.NO_CHAT && e !== eL.AEg.FULL_SCREEN && null != c, g = eL.BRd.MIDNIGHT;
    return (0, r.jsxs)("div", {
  ...
  constructor(...e) {
    super(...e), eF(this, "_prevLayout", eL.AEg.MINIMUM), eF(this, "_wrapperRef", i.createRef()), eF(this, "_callContainerRef", i.createRef()), eF(this, "_channelChatRef", i.createRef()), eF(this, "_contentRef", i.createRef()), eF(this, "_videoBackgroundTooltipTimeout", new p.V7), eF(this, "_lastIdleProps", null), eF(this, "state", {
      ...
      (0, eD._5)(e) && (0, B.p9)(n, eg.Z, ed.Z, ep.Z, k.Z)[0] && (b.default.selectVoiceChannel(n.id), 0 === i.filter(t => (0, U.V9)(t) === e.id && t.state !== eL.jm8.ENDED).length && (0, _.rn)((0, U.my)(e.id), {
        forceMultiple: t.shiftKey
      })), l && a === eL.WtW.VIDEO && ((null == r ? void 0 : r.id) === e.id ? m.Z.selectParticipant(n.id, null) : m.Z.selectParticipant(n.id, e.id))
      ...
      let {
        layout: n,
        selectedParticipant: r
      } = this.props, i = n === eL.AEg.FULL_SCREEN;
      ...
      return this.inPopout || i === eL.AEg.FULL_SCREEN || null == t || n.isManaged() || (e = (0, r.jsx)(x.Z, {
        call: t
      })), (0, r.jsx)(R.Z, {
      ...
      return t || n === eL.AEg.MINIMUM || n === eL.AEg.NORMAL ? (0, r.jsx)(Y.ZP, {
        exitFullScreen: this.maybeLeaveFullScreen,
        channel: e,
      ...
      return (0, r.jsxs)(r.Fragment, {
        ...
        }) : null, (null == o ? void 0 : o.type) !== eD.fO.STREAM && (null == o ? void 0 : o.type) !== eD.fO.ACTIVITY || s ? null : (0, r.jsx)(J.Z, {
      ...
      return !e || t || this.popoutOpen && !this.inPopout && i ? null : (0, r.jsx)(eI.ZP, {
...
let eY = function(e) {
  ...
  }, [g, n.id]), H = (0, u.Wu)([eo.Z], () => eo.Z.getAllActiveStreams()), {
    selectedStream: V
  } = (0, u.cj)([eo.Z], () => ({
  ...
  })), Q = (0, u.e7)([ep.Z], () => ep.Z.can(eL.Plq.CONNECT, n)), $ = (0, u.e7)([ec.Z], () => ec.Z.getToastsEnabled(n.id)), ee = (0, u.e7)([k.Z], () => k.Z.getAwaitingRemoteSessionInfo()), et = (0, u.e7)([W.ZP], () => W.ZP.callHeaderHeight), en = i.useCallback(e => {
    y.ZP.updatedUnsyncedSettings({
      callHeaderHeight: e
    })
  }, []), er = null != (t = null == z ? void 0 : z.id) ? t : null, ei = (0, P.Z)(er, n.id), el = (0, u.e7)([I.Z], () => I.Z.getFetchState(), []), ea = (0, j.Z)(el);
  i.useEffect(() => {
      ...
      children: (0, r.jsx)(eI.B2, {
        children: (0, r.jsxs)(ew._A, {
          children: [(0, r.jsx)(eW, {
            ...
            theme: eO
          }), !n.isPrivate() && (0, r.jsx)(ew.YR, {}), (0, r.jsx)(eI.H_, {})]
        })
      })
    })
  })
