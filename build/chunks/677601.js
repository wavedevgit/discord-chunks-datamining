...
class eX extends i.PureComponent {
  ...
  componentDidMount() {
    ...
    this.currentDocument.addEventListener(eN.NO, this.handleFullScreenChange), ey.default.track(eF.rMx.VIDEO_LAYOUT_TOGGLED, ez({
  ...
  render() {
    ...
    let {
      ...
      resizedHeight: b
    } = this.state, _ = l === eF.WtW.VIDEO, C = t !== eF.AEg.NO_CHAT && t !== eF.AEg.FULL_SCREEN && null != u;
  ...
  constructor(...e) {
    super(...e), eV(this, "_prevLayout", eF.AEg.MINIMUM), eV(this, "_wrapperRef", i.createRef()), eV(this, "_callContainerRef", i.createRef()), eV(this, "_channelChatRef", i.createRef()), eV(this, "_contentRef", i.createRef()), eV(this, "_videoBackgroundTooltipTimeout", new h.V7), eV(this, "_lastIdleProps", null), eV(this, "state", {
      ...
      (0, eB._5)(e) && (0, H.p9)(n, ev.Z, em.Z, eg.Z, W.Z)[0] && (C.default.selectVoiceChannel(n.id), 0 === i.filter(t => (0, F.V9)(t) === e.id && t.state !== eF.jm8.ENDED).length && (0, v.rn)((0, F.my)(e.id), {
