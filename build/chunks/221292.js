...
let v = e => {
  ...
  T = e => {
    ...
    } = e, p = c.default.getUser(a);
    if (null == p) return {};
    let m = (0, _.Of)(null == p ? true : p.id, f ? l : true),
      h = f && null != l ? o.ZP.getMember(l, null == p ? true : p.id) : null;
    return {
      profile_layout: i,
      ...
      profile_properties: v({
        user: p,
        userProfile: null == m ? true : m._userProfile
      }),
      guild_profile_properties: v({
        guildMember: h,
        guildMemberProfile: null == m ? true : m._guildMemberProfile
      }),
      profile_activity_types: s.Z.getActivities(p.id).map(e => {
        let {
          type: t
        } = e;
        return t
      }).filter(e => true !== e),
      profile_badges: null == m || null == (t = m.getBadges()) ? true : t.map(e => {
        let {
          id: t
        } = e;
        return t
      ...
      profile_effect_sku_id: null == m || null == (r = m.profileEffect) ? true : r.skuId,
      user_status: S(p.id),
      is_guild_profile: (null == m ? true : m.guildId) != null,
  ...
  C = e => {
    ...
    u.default.track(h.rMx.USER_PROFILE_ACTION, O(b({}, (0, r.hH)(t), (0, r.JS)(n), T(e), A(e)), {
      location_stack: s,
      profile_action: l,
      profile_section: c,
      source_message_id: i,
  ...
  N = e => {
    ...
    (null != l ? l : 0) <= 0 || (null != c ? c : 0) <= 0 || (null != d ? d : 0) <= 0 || u.default.track(h.rMx.USER_PROFILE_UI_VIEWED, O(b({}, (0, r.hH)(t), (0, r.JS)(n), T(e), A(e)), {
      location_stack: i,
      profile_ui: a,
      view_started_at: o,
      fetch_started_at: s,
  ...
  P = e => {
    ...
    u.default.track(h.rMx.USER_PROFILE_ACTIVITY_ACTION, O(b({}, (0, r.hH)(t), (0, r.JS)(n), T(e), A(e)), {
      location_stack: i,
      activity_action: a,
      activity_display: o,
      activity_type: I(null != l ? h.IIU.STREAMING : null == s ? true : s.type),
  ...
  R = e => {
    ...
    u.default.track(h.rMx.USER_PROFILE_BADGE_PRESSED, O(b({}, (0, r.hH)(t), (0, r.JS)(n), T(e), A(e)), {
      location_stack: i,
      badge: a
    }))
  },
  w = e => {
    ...
    u.default.track(h.rMx.USER_PROFILE_BADGE_HOVERED, O(b({}, (0, r.hH)(t), (0, r.JS)(n), T(e), A(e)), {
      location_stack: i,
      badge: a
    }))
  },
  ...
  x = e => {
    ...
    C(O(b({}, e), {
      action: a
    })), u.default.track(h.rMx.USER_PROFILE_EDIT_ACTION, O(b({}, (0, r.hH)(t), (0, r.JS)(n), T(e)), {
      location_stack: i,
      edit_action: a,
      widget_edited: o,
      game_id: s,
  ...
  L = e => {
    ...
    C(O(b({}, e), {
      action: "EDIT_SAVED"
    })), u.default.track(h.rMx.USER_PROFILE_EDIT_SAVED, O(b({}, (0, r.hH)(t), (0, r.JS)(n), T(e)), {
      location_stack: i,
      widget_edited: a,
      game_ids: o,
      tags: s,
  ...
  j = e => {
    ...
    C(O(b({}, e), {
      action: a
    })), u.default.track(h.rMx.USER_PROFILE_WISHLIST_ACTION, O(b({}, (0, r.hH)(t), (0, r.JS)(n), T(e)), {
      location_stack: i,
      action_type: a,
      wishlist_id: o,
      sku_id: s,
