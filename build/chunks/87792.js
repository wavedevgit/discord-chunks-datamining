...
function D(e) {
  let {
    ...
    onError: n
  }), b = T.tx.get(t), [_, E] = r.useState(T.iB), C = (0, p.Xi)({
  ...
  let v = b.sectionHeader(c),
    ...
    P = r.useCallback(() => (0, i.jsxs)(i.Fragment, {
      children: [(0, i.jsx)(o.Text, {
        ...
        children: v
      }), void 0 !== b.sectionDescription ? (0, i.jsx)(o.Text, {
...
let Z = () => {
  ...
  L = e => {
    let {
      userId: t
    } = e, n = (0, x.Z)(), r = (0, _.mq)(T.ne.ACTIVE), s = (0, m.Qr)(!!n), l = (0, _.Rd)(s);
  ...
  B = e => {
    let {
      user: t
    } = e, n = Array.from(T.tx.entries()), r = (0, f.kE)(), s = (0, m.t3)(), l = (0, _.Rd)(s);
    return (0, i.jsxs)("div", {
