...
function D(e) {
  let {
    ...
    onError: n
  }), _ = v.tx.get(t), [N, x] = i.useState(v.iB), C = (0, g.Xi)({
  ...
  let S = _.sectionHeader(c),
    ...
    P = i.useCallback(() => (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsx)(o.Text, {
        ...
        children: S
      }), void 0 !== _.sectionDescription ? (0, r.jsx)(o.Text, {
...
let Z = () => {
  ...
  W = e => {
    let {
      userId: t
    } = e, n = (0, b.Z)(), i = (0, N.mq)(v.ne.ACTIVE), s = (0, m.Qr)(!!n), a = (0, N.Rd)(s);
  ...
  L = e => {
    let {
      user: t
    } = e, n = Array.from(v.tx.entries()), i = (0, f.kE)(), s = (0, m.t3)(), a = (0, N.Rd)(s);
    return (0, r.jsxs)("div", {
