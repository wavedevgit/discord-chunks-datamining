...
let I = () => {
  ...
  P = e => {
    ...
    }), [d, h] = i.useState(!1), g = I(), m = (0, o.e7)([f.Z], () => f.Z.hasLayers()), O = (0, s.s9z)(s.JQI), y = n && g && !r && !(O || m), [C, x] = (0, c.US)(y ? [a.z.VIRTUAL_CURRENCY_DISCOVERY_REHEAT_COACHMARK] : []), P = C === a.z.VIRTUAL_CURRENCY_DISCOVERY_REHEAT_COACHMARK, N = i.useCallback(() => {
      x(j.L.TAKE_ACTION), (0, u.k5)({
  ...
  N = e => {
    let {
      ...
      descriptionText: x.intl.format(x.t.xk12LC, {
        quantity: 200
      }),
