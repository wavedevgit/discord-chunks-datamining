...
let P = e => {
  ...
  w = e => {
    let {
      ...
      location: N
    }), [d, h] = i.useState(!1), g = P({
      location: N
    }), m = (0, o.e7)([f.Z], () => f.Z.hasLayers()), _ = (0, s.s9z)(s.JQI), y = n && g && !r && !(_ || m), [C, v] = (0, c.US)(y ? [a.z.VIRTUAL_CURRENCY_DISCOVERY_REHEAT_COACHMARK] : []), I = C === a.z.VIRTUAL_CURRENCY_DISCOVERY_REHEAT_COACHMARK, w = i.useCallback(() => {
