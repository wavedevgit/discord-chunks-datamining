...
function S() {
  ...
  }, [k, require, Chunk997928, w, Chunk755721, Chunk388032, S]), Chunk73800.useEffect(() => {
    let e;
    if (!A) return;
    let t = 0;
    async function r() {
  ...
  return null != R && Chunk726542.Z.isSupported(R) ? x ? (0, Chunk255367.jsx)(E, {
    platformType: R,
    deeplink: I,
    onClick: () => {
      D(false), T(true)
