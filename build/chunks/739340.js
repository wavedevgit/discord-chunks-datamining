...
function O() {
  let [e, t] = i.useState(!1), [n, r] = i.useState("loading"), y = function() {
    ...
    return (0, l.Wu)([u.Z, g.ZP, p.ZP], () => {
      ...
      return r.map(e => e.id).sort((e, t) => m.default.compare(p.ZP.lastMessageId(t), p.ZP.lastMessageId(e))).filter(e => {
        let t = p.ZP.lastMessageId(e);
        return null == t || m.default.age(t) < b.ib
      })
    }, [t, n])
  }(), O = (0, l.Wu)([h.Z], () => (0, a.K)(y.map(e => h.Z.getMessages(e))), [y]), v = i.useCallback(async e => {
    r("loading");
    let n = async () => {
      let t = !1,
        n = !1,
      ...
      for (let i of y) {
        ...
        let a = h.Z.getMessages(i),
          c = a.length;
        null == i || a.loadingMore || a.hasPresent() && (a.hasFetched || a.ready) && (!(c < 50) || !a.hasMoreBefore) || (r.push(o.Z.fetchMessages({
          channelId: i,
          limit: 50
        })), t = !0)
      }
