...
function j() {
  ...
  return (0, o.Wu)([p.Z, _.ZP, m.ZP, d.Z], () => {
    ...
    return r.map(e => e.id).sort((e, t) => O.default.compare(m.ZP.lastMessageId(t), m.ZP.lastMessageId(e))).filter(e => {
...
function E() {
  let [e, t] = i.useState(!1), [n, r] = i.useState("loading"), l = j(), u = (0, o.e7)([c.Z], () => c.Z.isConnected()), d = (0, o.Wu)([g.Z], () => (0, s.K)(l.map(e => g.Z.getMessages(e))), [l]), h = i.useCallback(async n => {
    r("loading");
    let i = async () => {
      let e = !1,
        t = !1,
