...
class f extends Chunk73800.Component {
  ...
  getImageStyle() {
    ...
    switch (module) {
      case 0:
        return Chunk107778.authenticationRequiredImage;
      case 2:
        return Chunk107778.authenticationSuccessImage;
      default:
        return Chunk107778.authenticationFailImage
    }
  }
  getMessage() {
    let {
