...
let F = e => {
    ...
    } = e, [c, u, p] = (0, o.Wu)([j.Z], () => [j.Z.getStickerPack(n.pack_id), !j.Z.hasLoadedStickerPacks, j.Z.isPremiumPack(n.pack_id)], [n]), m = D({
      sticker: n,
      stickerPack: c
    });
    (0, O.Pq)(n.pack_id);
    ...
    }, [n.pack_id]), u || null == c) ? (0, r.jsx)(h.SE, {
  ...
  B = e => {
    ...
    i.useEffect(() => {
      ...
      (async () => {
        (null == e || e.hasFeature(N.oNc.DISCOVERABLE)) && j(await (0, _.Z)(n.id)), T(!0)
      })()
    }, [n.id, B]);
...
let H = e => {
  ...
  return null != a && (0, I.jl)(a) ? (0, r.jsx)(F, {
    sticker: a,
    closePopout: i,
    channel: n,
    refreshPositionKey: l
  }) : null != a && (0, I.J8)(a) ? (0, r.jsx)(B, {
    sticker: a,
    channel: n,
    closePopout: i,
    refreshPositionKey: l
