...
function S(e) {
  let {
    ...
    setQuery: o,
    setHeaderHeight: c
  } = e, d = i.useRef(null), m = f.D.useExperiment({
    guildId: t.id,
...
function T(e) {
  ...
  let n = (0, b.vc)(o()(y.LCk), "LL"),
    l = t.features.has(y.oNc.PIN_PERMISSION_MIGRATION_COMPLETE) ? (0, r.jsx)(u.Text, {
    ...
    }) : x.Z.can(N.Pl.ADMINISTRATOR, t) ? (0, r.jsx)(u.Text, {
      variant: "text-sm/normal",
      children: I.intl.format(I.t.HYM8OD, {
        onClickMigrate: () => {
          m.Z.show({
            title: I.intl.string(I.t.nFE8dH),
            body: I.intl.format(I.t["1PAzQ0"], {
              guildName: t.name
            }),
      ...
      variant: "text-sm/normal",
      children: I.intl.format(I.t.cAuU1d, {
        breakingChangeDate: n
      })
    });
  return (0, r.jsx)(h.Z, {
    ...
    children: [(0, r.jsx)(_.Z, {
      ...
      children: (0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)("div", {
          ...
          variant: "text-sm/normal",
          children: I.intl.format(I.t["38N3V1"], {
