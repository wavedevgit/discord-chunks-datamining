...
function N(e) {
  let {
    ...
    setQuery: o,
    setHeaderHeight: c
  } = e, u = i.useRef(null), m = g.D.useExperiment({
    guildId: t.id,
...
function I(e) {
  let {
    guild: t
  } = e, n = (0, h.vc)(o()(v.LCk), "LL"), i = t.features.has(v.oNc.PIN_PERMISSION_MIGRATION_COMPLETE) ? (0, r.jsx)(d.Text, {
    variant: "text-sm/normal",
