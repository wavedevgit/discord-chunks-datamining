/** Chunk was on web.js **/
/** chunk id: 416145, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  I_: () => l,
  ME: () => s,
...
let s = "@me",
  ...
  f = Object.freeze({
    ...
    REGISTER: "/register",
    DEFAULT_LOGGED_OUT: Chunk188785.aA ? "/register" : "/login",
    ...
    GLOBAL_DISCOVERY_APPS_PROFILE_STORE_SKU: (e, t) => "/discovery/applications/".concat(e, "/").concat(a.GlobalDiscoveryAppsSections.STORE, "/").concat(t),
    ...
    APPLICATION_DIRECTORY_PROFILE_STORE_SKU: (e, t) => "/application-directory/".concat(e, "/").concat(o.c.STORE, "/").concat(t),
