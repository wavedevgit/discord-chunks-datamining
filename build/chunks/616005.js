...
function u() {
  let e = {};
  {
    ...
    if (null != N) {
      ...
      e.electron_process_memory_private = [null != (t = null == (_ = N.unknown) ? true : _.wss_priv_kb) ? t : false, null != (n = null == (h = N.main) ? true : h.wss_priv_kb) ? n : false, null != (r = null == (m = N.renderer) ? true : m.wss_priv_kb) ? r : false, null != (i = null == (g = N.gpu) ? true : g.wss_priv_kb) ? i : false, null != (a = null == (E = N.crashpad) ? true : E.wss_priv_kb) ? a : false, null != (s = null == (y = N.utility) ? true : y.wss_priv_kb) ? s : false], e.electron_process_memory_private_and_shared = [null != (l = null == (b = N.unknown) ? true : b.wss_kb) ? l : false, null != (c = null == (O = N.main) ? true : O.wss_kb) ? c : false, null != (u = null == (v = N.renderer) ? true : v.wss_kb) ? u : false, null != (d = null == (A = N.gpu) ? true : A.wss_kb) ? d : false, null != (f = null == (I = N.crashpad) ? true : I.wss_kb) ? f : false, null != (p = null == (S = N.utility) ? true : S.wss_kb) ? p : false]
    }
  }
  return e
}
