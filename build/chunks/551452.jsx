...
function I(e) {
  return {
    react(t, a, s) {
      ...
      return <u.Z role={"link"} onClick={c} onContextMenu={f} className={"channelMention"}>{null != t.inContent ? a(t.inContent, s) : null}{null != t.inContent ? <d.Z /> : null}{(0, m.S)(t, a, s)}</u.Z>
    }
  }
}