...
let w = r.forwardRef(function(e, t) {
  ...
  return (0, a.jsx)(l.ua7, {
    ...
    position: "bottom",
    children: e => {
      var i, o, c = x({}, function(e) {
        if (null == e) throw TypeError("Cannot destructure " + e);
        return e
      }(e));
      return (0, a.jsx)(l.hU, P((i = P({}, c), o = o = {
        buttonRef: t,
        variant: "icon-only",
        "aria-label": n,
        size: "sm"
...
function I(e) {
  ...
  return null != o && null != c && (0, d.h)(o) ? (0, a.jsx)(w, {
    onClick: s,
...
function N(e) {
  ...
  let {
    ...
    let {
      ...
      width: i,
      height: o
    } = e, c = R(T.intl.string(T.t.ILJuBg), "name", {
      subtextLineClamp: 1
    }), s = R(T.intl.string(T.t["3Nf9u7"]), "size"), u = R(T.intl.string(T.t.eOB2eX), "alt", {
      subtextLineClamp: 2
    });
    ...
    return (0, a.jsxs)(l.sNh, {
      ...
      children: [c(d), s(T.intl.formatToPlainString(T.t.DTdonJ, {
        width: i,
        height: o,
        fileSize: p
      })), u(n)]
...
function k(e) {
  ...
  let {
    item: i
  } = e, o = r.useRef(null), [c, s] = r.useState(!1), u = y.Sb.useSetting(), d = "IMAGE" === i.type && null == i.children && !i.animated && (0, m.Lz)(i.url, i.contentType), p = (0, m.Jj)(i.url);
