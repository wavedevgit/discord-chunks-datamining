...
let N = r.forwardRef(function(e, t) {
  ...
  return (0, a.jsx)(s.ua7, {
    ...
    children: e => {
      ...
      return (0, a.jsx)(s.zxk, I(M(I(M({}, r), {
        buttonRef: t,
        onClick: n,
        look: s.iLD.BLANK,
        size: s.PhG.ICON,
...
function w(e) {
  ...
  let {
    ...
    if (null != i && null != c) {
      if ((0, E.yg)(E.uG.FORWARD_PRESSED), "embed" === c.type) return void(0, m.l8)({
        message: i,
        source: "media-viewer",
        forwardOptions: {
...
function L(e) {
  ...
  let i = (0, _.s$)(t.url);
  async function c() {
    if ((0, E.yg)(E.uG.SAVE_MEDIA_PRESSED), "VIDEO" === t.type && (0, O.q)({
        href: i
      }), "IMAGE" === t.type) {
      o(!0);
      try {
...
function R(e) {
  ...
  return (0, a.jsx)(N, {
    onClick: () => {
      (0, E.yg)(E.uG.OPEN_LINK_PRESSED), (0, O.q)({
        href: r
      })
    },
