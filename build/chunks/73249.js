...
function R(e) {
  ...
  return (0, a.jsx)(D, {
    onClick: () => {
      (0, S.yg)(S.uG.OPEN_LINK_PRESSED), (0, b.q)({
        href: r
      })
    },
...
function Z(e) {
  ...
  let {
    item: o
  } = e, i = r.useRef(null), [c, s] = r.useState(!1), u = g.Sb.useSetting(), d = "IMAGE" === o.type && O.isPlatformEmbedded && null == o.children && h.ZP.canCopyImage() && (0, m.Lz)(o.url), p = (0, m.Jj)(o.url);
