...
function L(e) {
  ...
  let {
    ...
    if (null != i && null != c) {
      if ((0, v.yg)(v.uG.FORWARD_PRESSED), "embed" === c.type) return void(0, m.l8)({
        message: i,
        source: "media-viewer",
        forwardOptions: {
...
function N(e) {
  ...
  async function c() {
    if ((0, v.yg)(v.uG.SAVE_MEDIA_PRESSED), "VIDEO" === t.type && (0, _.q)({
        href: i
      }), "IMAGE" === t.type) {
      o(!0);
      try {
...
function R(e) {
  ...
  return (0, a.jsx)(D, {
    onClick: () => {
      (0, v.yg)(v.uG.OPEN_LINK_PRESSED), (0, _.q)({
        href: r
      })
    },
...
function k(e) {
  ...
  let {
    ...
    let {
      ...
      width: o,
      height: i
    } = e, c = Z(E.intl.string(E.t.ILJuBg), "name", {
      subtextLineClamp: 1
    }), l = Z(E.intl.string(E.t["3Nf9u7"]), "size"), u = Z(E.intl.string(E.t.eOB2eX), "alt", {
      subtextLineClamp: 2
    });
...
let G = r.memo(function(e) {
  let {
    item: t,
    hideMediaOptions: n
  } = e, o = (0, c.e7)([u.Z], () => u.Z.keyboardModeEnabled), l = r.useRef(null), s = r.useCallback(() => {
    var e;
