...
function D(e) {
  ...
  let {
    item: o
  } = e, l = null == (t = o.sourceMetadata) ? void 0 : t.message, a = null == (n = o.sourceMetadata) ? void 0 : n.identifier, c = i.useCallback(() => {
    if (null != l && null != a) {
...
function Z(e) {
  ...
  let {
    ...
    onClose: a,
    onSelect: c
  } = e, d = (null == (n = i.sourceMetadata) || null == (t = n.identifier) ? void 0 : t.type) === "attachment" ? i.sourceMetadata.identifier.attachmentId : null, p = (0, u.Z)({
    id: d,
...
function R(e) {
  ...
  let {
    item: o
  } = e, l = i.useRef(null), [a, c] = i.useState(!1), u = y.Sb.useSetting(), d = "IMAGE" === o.type && null == o.children && !o.animated && (0, m.Lz)(o.url, o.contentType), p = (0, m.Jj)(o.url);
  return u || d || p || (null == (n = o.sourceMetadata) || null == (t = n.identifier) ? void 0 : t.type) === "attachment" ? (0, r.jsx)(s.yRy, {
    targetElementRef: l,
    shouldShow: a,
    align: "left",
    position: "top",
