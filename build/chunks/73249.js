...
let I = r.forwardRef(function(e, t) {
  ...
  return (0, a.jsx)(l.ua7, {
    ...
    children: e => {
      ...
      return (0, a.jsx)(l.zxk, M(x(M(x({}, r), {
        buttonRef: t,
        onClick: n,
        look: l.iLD.BLANK,
        size: l.PhG.ICON,
        color: l.Ttl.TRANSPARENT,
        className: i()(E.actionButton, {
          [E.selected]: o
        }),
...
function A(e) {
  ...
  let {
    item: o
  } = e, i = null == (t = o.sourceMetadata) ? void 0 : t.message, c = null == (n = o.sourceMetadata) ? void 0 : n.identifier, s = r.useCallback(() => {
    if (null != i && null != c) {
      if ((0, S.yg)(S.uG.FORWARD_PRESSED), "embed" === c.type) return void(0, d.l8)({
        message: i,
        source: "media-viewer",
        forwardOptions: {
  ...
  return null != i && null != c && (0, p.h)(i) ? (0, a.jsx)(I, {
    onClick: s,
...
function R(e) {
  ...
  let {
    ...
    onClose: c,
    onSelect: s
  } = e, p = (null == (n = r.sourceMetadata) || null == (t = n.identifier) ? void 0 : t.type) === "attachment" ? r.sourceMetadata.identifier.attachmentId : null, d = (0, u.Z)({
    id: p,
    ...
    let {
      ...
      width: o,
      height: i
    } = e, c = k(T.intl.string(T.t.ILJuBg), "name", {
      subtextLineClamp: 1
    }), s = k(T.intl.string(T.t["3Nf9u7"]), "size"), u = k(T.intl.string(T.t.eOB2eX), "alt", {
      subtextLineClamp: 2
    });
    if ((null == r || null == (t = r.identifier) ? void 0 : t.type) !== "attachment") return null;
    let p = (0, g.Z)(r.identifier),
      d = (0, b.BU)(r.identifier.size / 1e3);
    return (0, a.jsxs)(l.sNh, {
      id: "media-viewer-details",
      label: T.intl.string(T.t.sqBLa2),
      children: [c(p), s(T.intl.formatToPlainString(T.t.DTdonJ, {
        width: o,
        height: i,
        fileSize: d
      })), u(n)]
  ...
  return (0, a.jsxs)(l.v2r, {
    ...
    children: [(0, a.jsxs)(l.kSQ, {
      children: [o && (0, a.jsx)(l.sNh, {
        label: T.intl.string(T.t.tvUqWl),
        id: "media-viewer-copy-image",
        icon: l.TIy,
        action: O
      }, "media-viewer-copy-image"), i && (0, a.jsx)(l.sNh, {
...
function Z(e) {
  ...
  let {
    item: o
  } = e, i = r.useRef(null), [c, s] = r.useState(!1), u = y.Sb.useSetting(), p = "IMAGE" === o.type && null == o.children && !o.animated && (0, m.Lz)(o.url, o.contentType), d = (0, m.Jj)(o.url);
  return u || p || d || (null == (n = o.sourceMetadata) || null == (t = n.identifier) ? void 0 : t.type) === "attachment" ? (0, a.jsx)(l.yRy, {
    targetElementRef: i,
    shouldShow: c,
    align: "left",
    position: "top",
...
let B = r.memo(function(e) {
  let {
    item: t,
    hideMediaOptions: n
  } = e, o = (0, c.e7)([s.Z], () => s.Z.keyboardModeEnabled), l = r.useRef(null), u = r.useCallback(() => {
    var e;
    !o && (null == (e = l.current) ? void 0 : e.contains(document.activeElement)) && document.activeElement.blur()
  }, [o]);
  return ("IMAGE" === t.type || !n) && (0, a.jsx)(j.ZP, {
