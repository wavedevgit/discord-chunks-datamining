...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk125529 = require("./125529.js"),
  Chunk879892 = require("./879892.js"),
  Chunk267642 = require("./267642.js"),
  Chunk981631 = require("./981631.js"),
  Chunk388032 = require("./388032.js"),
  Chunk122039 = require("./122039.js");
...
let b = function() {
  ...
  return <div className={Chunk122039.wrapper}>{<Chunk481060.$Eu color={Chunk481060.TVs.unsafe_rawColors.GUILD_BOOSTING_PINK} className={Chunk122039.boostIcon} />}{<Chunk481060.Text className={Chunk122039.copy} color={"header-secondary"} variant={"text-sm/medium"}>{Chunk388032.intl.format(Chunk388032.t.kqC5vr, {
