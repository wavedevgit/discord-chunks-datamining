...
function o(e) {
  ...
  return <t.v2r onSelect={d} navId={"channel-summaries-context-menu"} aria-label={u.intl.string(u.t.ogxXGh)} onClose={a.Zy}><t.kSQ><t.sNh id={"delete-summary"} color={"danger"} label={u.intl.string(u.t["5AwUIi"])} action={() => {
          (0, r.$l)(n);
