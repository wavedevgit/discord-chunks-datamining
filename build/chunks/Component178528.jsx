  ...
  render() {
    ...
    return (0, Chunk951288.jsxs)(Chunk711553.Z, {
      ...
      children: [(0, Chunk951288.jsx)("div", {
        ...
        children: null != Chunk442837 ? (0, Chunk951288.jsx)(Chunk680089, (e = L({}, Chunk258536), t = t = {
          guild: Chunk442837,
...
function z(e) {
  ...
  let {
    ...
    return t
  }), w = (0, o.e7)([Z.Z], () => Z.Z.getVoiceChannelId()), N = (0, o.e7)([x.Z], () => x.Z.getGuildVersion(n)), D = (0, o.e7)([m.Z], () => m.Z.version), k = (0, o.e7)([v.default], () => v.default.getGuildChangeSentinel(n)), R = (0, a.QN)(null == r ? true : r.id), A = (0, c.gM)(null == r ? true : r.id), L = null != (t = null == r ? true : r.features.has(T.oNc.COMMUNITY)) && t, z = (0, o.e7)([C.Z], () => C.Z.getChannelId()), V = (0, o.e7)([S.Z], () => S.Z.desyncedVoiceStatesCount);
  return (0, i.jsx)(M, {
    guildId: n,
    guild: r,
    channels: s,
