...
function A(e) {
  let {
    ...
    onClose: A
  } = e, N = (0, s.e7)([f.Z], () => f.Z.getChannelStatus(t)), C = (0, s.e7)([E.Z], () => E.Z.getMediaSessionId()), [R, P] = i.useState(null != N ? N : ""), [w, D] = i.useState(!1), [L, x] = i.useState(null), k = (0, s.e7)([b.default], () => b.default.getCurrentUser()), M = R.length > S;
  i.useEffect(() => {
  ...
  let j = e => {
    ...
    G = async e => {
      ...
      if (!o) {
        try {
          ...
          204 === e.status ? (y.default.track(O.rMx.VOICE_CHANNEL_TOPIC_SET, {
            guild_id: t.guild_id,
            channel_id: t.id,
            media_session_id: C,
            raw_length: n,
    ...
    }, [B, V] = i.useState((0, p.JM)(R)), F = (e, t, n) => {
      P(t), V(n)
    }, Z = async () => (M || w || await G(), Promise.resolve({
      shouldClear: !1,
      shouldRefocus: !0
    }));
  return (0, r.jsx)("form", {
      ...
      children: [(0, r.jsxs)(c.hzk, {
        ...
        children: [(0, r.jsxs)(c.xBx, {
          ...
          children: [(0, r.jsx)(h.Z, {
            ...
            textValue: R,
            richValue: B,
            placeholder: v.intl.formatToPlainString(v.t.DUXxBg, {
              channelName: t.name
            }),
            focused: !0,
            channel: t,
