...
function A(e) {
  let {
    ...
    onClose: A
  } = e, C = (0, s.e7)([f.Z], () => f.Z.getChannelStatus(t)), P = (0, s.e7)([b.ZP], () => b.ZP.getMediaSessionId()), [R, w] = i.useState(null != C ? C : ""), [D, L] = i.useState(!1), [x, M] = i.useState(null), k = (0, s.e7)([y.default], () => y.default.getCurrentUser()), j = R.length > N, U = (0, g.Q3)("VoiceChannelStatusModal");
  i.useEffect(() => {
