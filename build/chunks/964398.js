...
let g = (e, t) => {
  ...
  y = l.memo(function(e) {
    let {
      ...
      onClose: E,
      children: C
    } = e, I = l.useRef(null), T = l.useRef([]), j = l.useRef(!1), S = l.useRef(null), [P, _] = l.useState(0), [Z, A] = l.useState({
      x: 0,
      y: 0
    ...
    }, [N, P]), G = l.useMemo(() => (0, i.throttle)(e => {
      ...
      k()
    }, 16), [v, L, k, U, P, n, t]), V = l.useCallback(e => {
      if (!x) return;
