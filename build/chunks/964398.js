...
let p = (e, t) => {
  ...
  y = r.memo(function(e) {
    let {
      ...
      onClose: C,
      children: x
    } = e, I = r.useRef(null), S = r.useRef([]), T = r.useRef(!1), P = r.useRef(null), [_, Z] = r.useState(0), [j, A] = r.useState({
      x: 0,
      y: 0
    }), w = Math.abs(j.x) + Math.abs(j.y) > 0, R = r.useMemo(() => a().chunk(x, h), [x]), D = r.useCallback((e, t) => {
      null == S.current[_] ? S.current[_] = [] : S.current[_][t] = e
    }, [_]), M = r.useCallback((e, t) => {
      P.current = t, E(h * e + t)
    }, [E]), k = r.useCallback(() => {
      P.current = null, E(null)
    }, [E]), U = r.useCallback(e => {
      k(), T.current = e
    }, [k]), L = r.useCallback((e, t, n) => {
      if (T.current) return void A({
        x: 0,
        y: 0
      });
      let l = {
    ...
    }, [b, _]), V = r.useMemo(() => (0, i.throttle)(e => {
    ...
    return (0, l.jsx)(o.P3F, {
      ...
      children: (0, l.jsxs)("div", {
        ...
        children: [(0, l.jsxs)("svg", {
          ...
          children: [m && (0, l.jsx)(o.P3F, {
            className: c.chatWheelDeadZoneIcon,
            onClick: C,
            children: (0, l.jsx)(d, {
              className: c.chatWheelDeadZoneIcon
            })
          }), N && R.length > 1 ? (0, l.jsx)("div", {
