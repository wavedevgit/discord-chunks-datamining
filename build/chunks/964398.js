...
let p = (e, t) => {
  ...
  N = l.memo(function(e) {
    let {
      ...
      onClose: C,
      children: T
    } = e, I = l.useRef(null), v = l.useRef([]), j = l.useRef(!1), _ = l.useRef(null), [S, P] = l.useState(0), [A, R] = l.useState({
      x: 0,
      y: 0
    }), w = Math.abs(A.x) + Math.abs(A.y) > 0, D = l.useMemo(() => s().chunk(T, f), [T]), Z = l.useCallback((e, t) => {
      ...
      M()
    }, 16), [y, B, M, k, S, n, t]), F = l.useCallback(e => {
      if (!m) return;
