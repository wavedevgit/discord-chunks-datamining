...
var y = new WeakMap,
  ...
  eC = e => {
    ...
    }) : "" !== n.text || r.children[r.children.length - 1] !== i || a.isInline(r) || "" !== d.ML.string(a, s) ? "" === n.text ? c.createElement(eP, {
      isMarkPlaceholder: l
...
function th(e) {
  var {
    ...
    for (var a = y(); l = null == (_ = M.get(t)) ? void 0 : _[0];) {
      ...
      var m = tr(l);
      t.selection && d.e6.equals(t.selection, m) || d.YR.select(t, m), l.diff.text ? d.ML.insertText(t, l.diff.text) : d.ML.deleteFragment(t), M.set(t, null == (p = M.get(t)) ? void 0 : p.filter(e => {
        var {
          id: t
        } = e;
        return t !== l.id
      ...
      switch (n) {
        ...
        case "deleteContentForward":
          ...
          if (l && d.e6.isCollapsed(r)) {
            ...
            if (C.offset < w.text.length) return m(C.path, {
              text: "",
              start: C.offset,
              end: C.offset + 1
            })
...
var tZ = ["editor", "children", "onChange", "value"],
  tF = e => {
    var {
      ...
      onChange: r,
      value: i
    } = e, a = g(e, tZ), o = (0, c.useRef)(!1), [s, l] = c.useState(() => {
