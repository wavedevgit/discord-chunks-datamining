...
function k(e) {
  ...
  return i.useCallback(() => {
    null != t && (d({
      ...
      questContentRowIndex: a,
      sourceQuestContent: s
    }), (0, g.xN)(t.config) && !u ? (0, N.B)() : c ? (0, g.Bg)(t.config) ? (0, A.openQuestsNitroRewardModal)(t, n) : (0, g.Xv)(t.config) ? (0, C.m)(t, n) : (0, g.vQ)(t.config) ? (0, A.openQuestInGameRewardModal)(t, n, s) : (0, g.xN)(t.config) ? (0, A.openQuestOrbsRewardModal)(t, n) : (0, A.openQuestsRewardCodeModal)({
      questId: t.id,
      questContent: n,
      questContentPosition: r,
      sourceQuestContent: s
...
function V(e) {
  ...
  }, [r, p, T, _, I, a, n, o, s, u, j, C, N, x, y, U, O, G])
}
