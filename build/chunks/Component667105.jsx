...
function U(e) {
  ...
  return i.useCallback(() => {
    null != t && (d({
      ...
      questContentRowIndex: a,
      sourceQuestContent: s
    }), (0, E.xN)(t.config) && !u ? (0, R.B)() : c ? (0, E.Bg)(t.config) ? (0, N.openQuestsNitroRewardModal)(t, n) : (0, E.Xv)(t.config) ? (0, N.openQuestCollectibleRewardModal)(t, n, s) : (0, E.vQ)(t.config) ? (0, N.openQuestInGameRewardModal)(t, n, s) : (0, E.xN)(t.config) ? (0, N.openQuestOrbsRewardModal)(t, n, s) : (0, N.openQuestsRewardCodeModal)({
      quest: t,
      questContent: n,
      questContentPosition: r,
      sourceQuestContent: s
        ...
        return p && (e = x.intl.string(x.t.umdNin), t = m.jZ.START_QUEST), (y || (0, E.pO)(n)) && ({
          ...
          onClick: async () => {
            ...
            p || G || (0, h.AH)(n.id, {
              ...
              questContentRowIndex: l,
              sourceQuestContent: O
            }), p ? (0, A.R)(P.dr.QUEST_HOME_DESKTOP) ? await (0, N.enrollAndStartVideoQuestWithErrorHandling)(n, {
              questContent: o,
              questContentCTA: t,
              sourceQuestContent: O,
