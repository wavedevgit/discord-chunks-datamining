...
let v = e => {
    ...
    }, [s, M, S, a, D, L, x, g.animationType, c, u]), (0, r.jsx)("div", {
      ref: v,
  ...
  T = e => {
    let t = (0, s.e7)([u.Z], () => u.Z.isFocused()),
      ...
      E = null != _ ? _ : m;
    return null != d && null != E && (t || e.shopPreview || d.config.animationType !== f.Q.INTERMITTENT) ? !t && e.shopPreview || !t && d.config.animationType === f.Q.PERSISTENT || n || !1 === e.autoPlay && !1 === e.isHovering ? (0, r.jsx)(I, {
