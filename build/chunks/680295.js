...
let v = e => {
  ...
  T = e => {
    let t = (0, s.e7)([u.Z], () => u.Z.isFocused()),
      ...
      E = null != f ? f : m;
    return null != d && null != E && (t || e.shopPreview || d.config.animationType !== _.Q.INTERMITTENT) ? !t && e.shopPreview || !t && d.config.animationType === _.Q.PERSISTENT || n || !1 === e.autoPlay && !1 === e.isHovering ? (0, r.jsx)(I, {
