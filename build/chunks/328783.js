...
let j = (0, o.hQ)(),
  C = r.memo(function(e) {
    let {
      availableClans: t
    } = e, [n, o] = (0, c.US)([l.z.GUILD_TAG_USER_PROFILE_NEW_BADGE]), C = r.useMemo(() => new Map(t.map(e => [e.id, e])), [t]), O = (0, s.e7)([m.default], () => {
      var e;
    ...
    }, [o]), N = r.useCallback(e => e === O, [O]), y = r.useCallback(e => e, []), A = r.useCallback(() => {
      o(b.L.TAKE_ACTION), (0, g.nE)(null, !1)
    }, [o]), P = r.useRef(null);
    return (0, u.Z)(P, _.Y_.GUILD_TAG), (0, i.jsxs)(d.Z, {
