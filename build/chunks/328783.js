...
let E = (0, o.hQ)(),
  j = i.memo(function(e) {
    let {
      availableClans: t
    } = e, [n, o] = (0, c.US)([a.z.GUILD_TAG_USER_PROFILE_NEW_BADGE]), j = i.useMemo(() => new Map(t.map(e => [e.id, e])), [t]), C = (0, s.e7)([m.default], () => {
      var e;
      return (0, p.Pb)(null == (e = m.default.getCurrentUser()) ? void 0 : e.primaryGuild).guildId
    }), O = i.useMemo(() => t.reduce((e, t) => {
      var n;
      ...
      return null == s ? null : (0, r.jsx)(h.Z, {
        clanTag: s,
    ...
    return (0, u.Z)(P, b.Y_.GUILD_TAG), (0, r.jsxs)(d.Z, {
      ...
      titleId: E,
      ref: P,
      titleIcon: n === a.z.GUILD_TAG_USER_PROFILE_NEW_BADGE && (0, r.jsx)(l.IGR, {
