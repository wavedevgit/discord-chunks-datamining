...
class h extends Chunk73800.PureComponent {
  ...
  render() {
    return <Chunk748780.Z.div style={this.getStyle()} className={Chunk666532.item}>{this.props.children}</Chunk748780.Z.div>
  }
  constructor(e) {
...
let f = e => {
  ...
  return <c.W component={"div"} className={l()(d.animator, s)}><h direction={i} springSettings={a} fadeInOut={o}>{t}</h></c.W>
}