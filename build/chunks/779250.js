...
function V(e) {
  let {
    ...
    onClose: E,
    createdEvent: O
  } = e, N = (0, g.Dt)(), C = i.useRef(n), T = !(0, a.isEqual)(C.current, n), D = i.useMemo(() => [{
    slideId: 0,
    ...
    valid: !0
  }], [v, x, T]), _ = Object.keys(z).length, R = (0, y.xt)(n), L = e => Math.max(0, Math.min(e, _ - 1)), [G, M] = i.useState(+!!R), [V, W] = i.useState(!1), U = i.useMemo(() => D.slice(0, G + 1).map(e => e.valid).every(Boolean), [D, G]), B = G >= D.length ? 3 : D[L(G)].slideId, F = 3 === B;
  ...
  return 2 === B && ($ = x ? A.intl.string(A.t.e5VEcH) : A.intl.string(A.t["60lJ0N"])), (0, r.jsxs)(c.Y0X, {
    transitionState: h,
    "aria-labelledby": N,
    size: c.CgR.DYNAMIC,
    parentComponent: "ScheduleEventModal",
    children: [!q && F ? (0, r.jsx)(X, {
      modal: H.current
    }) : null, (0, r.jsxs)(c.hzk, {
      className: k.content,
      scrollerRef: H,
      children: [!F && (0, r.jsx)(m.Z, {
...
function W(e) {
  let {
    ...
    transitionState: a,
    onClose: o
  } = e, d = (0, s.e7)([f.Z], () => f.Z.getGuild(t)), x = (0, s.e7)([y.ZP], () => y.ZP.getGuildScheduledEvent(l), [l]), m = (0, s.e7)([h.ZP], () => h.ZP.getDefaultChannel(t), [t]), g = (0, N.j$)(x, m), [p, S] = i.useState(g), [I] = i.useState((0, N.Ql)(x)), [Z, P] = i.useState(null), w = e => {
    var t;
    let n = (0, E.so)(e),
      l = null != (t = e.channel_id) ? t : null == m ? void 0 : m.id;
    null != l && u.ZP.createInvite(l, {
      max_age: G.value,
      max_uses: M.value
    }, R.t4x.GUILD_EVENTS), n ? P(e) : o()
  }, k = (0, v.Z)(d, null == x ? void 0 : x.id, p), [z, {
    loading: X,
    error: W
  }] = (0, j.Z)(async () => {
    if (null != Z) return;
    let e = {
      broadcastToDirectoryChannels: k.broadcastToDirectoryChannels
    };
  ...
  return (0, r.jsx)(V, {
    ...
    onSave: () => {
      null != p.recurrenceRule && I && (0, T.BP)(x, p) ? (0, c.ZDy)(async () => {
        let {
          ConfirmModal: e
