...
function V(e) {
  let {
    ...
    valid: !0
  }], [g, d, C]), D = Object.keys(L).length, _ = (0, j.xt)(n), G = e => Math.max(0, Math.min(e, D - 1)), [k, M] = i.useState(+!!_), [V, W] = i.useState(!1), z = i.useMemo(() => w.slice(0, k + 1).map(e => e.valid).every(Boolean), [w, k]), U = k >= w.length ? 3 : w[G(k)].slideId, B = 3 === U;
...
function W(e) {
  let {
    ...
    transitionState: a,
    onClose: u
  } = e, d = (0, s.e7)([h.Z], () => h.Z.getGuild(t)), x = (0, s.e7)([j.ZP], () => j.ZP.getGuildScheduledEvent(r), [r]), m = (0, s.e7)([v.ZP], () => v.ZP.getDefaultChannel(t), [t]), f = (0, O.j$)(x, m), [T, S] = i.useState(f), [I] = i.useState((0, O.Ql)(x)), [Z, P] = i.useState(null), A = e => {
    var t;
    let n = (0, b.so)(e),
  ...
  }, L = (0, g.Z)(d, null == x ? void 0 : x.id, T), [X, {
    loading: W,
    error: z
  }] = (0, p.Z)(async () => {
    if (null != Z) return;
