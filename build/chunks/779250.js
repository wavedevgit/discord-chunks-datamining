...
function V(e) {
  let {
    ...
    onClose: E,
    createdEvent: O
  } = e, N = (0, g.Dt)(), C = i.useRef(n), S = !(0, a.isEqual)(C.current, n), D = i.useMemo(() => [{
    slideId: 0,
    ...
    valid: !0
  }], [v, x, S]), _ = Object.keys(G).length, R = (0, y.xt)(n), z = e => Math.max(0, Math.min(e, _ - 1)), [M, k] = i.useState(+!!R), [V, W] = i.useState(!1), U = i.useMemo(() => D.slice(0, M + 1).map(e => e.valid).every(Boolean), [D, M]), F = M >= D.length ? 3 : D[z(M)].slideId, q = 3 === F;
  ...
  return 2 === F && ($ = x ? L.intl.string(L.t.e5VEcH) : L.intl.string(L.t["60lJ0N"])), (0, r.jsxs)(c.Y0X, {
    transitionState: h,
    "aria-labelledby": N,
    size: c.CgR.DYNAMIC,
    parentComponent: "ScheduleEventModal",
    children: [!B && q ? (0, r.jsx)(X, {
      modal: H.current
    }) : null, (0, r.jsxs)(c.hzk, {
      className: A.content,
      scrollerRef: H,
      children: [!q && (0, r.jsx)(m.Z, {
...
function W(e) {
  let {
    ...
    transitionState: a,
    onClose: o
  } = e, d = (0, s.e7)([f.Z], () => f.Z.getGuild(t)), x = (0, s.e7)([y.ZP], () => y.ZP.getGuildScheduledEvent(l), [l]), m = (0, s.e7)([h.ZP], () => h.ZP.getDefaultChannel(t), [t]), g = (0, N.j$)(x, m), [p, T] = i.useState(g), [I] = i.useState((0, N.Ql)(x)), [P, Z] = i.useState(null), w = e => {
    var t;
    let n = (0, E.so)(e),
    ...
    null != l && u.ZP.createInvite(l, {
      max_age: M.value,
      max_uses: k.value
    }, R.t4x.GUILD_EVENTS), n ? Z(e) : o()
  }, A = (0, v.Z)(d, null == x ? void 0 : x.id, p), [G, {
    loading: X,
    error: W
  }] = (0, j.Z)(async () => {
    if (null != P) return;
  ...
  return (0, r.jsx)(V, {
    ...
    onSave: () => {
      null != p.recurrenceRule && I && (0, S.BP)(x, p) ? (0, c.ZDy)(async () => {
        let {
          ConfirmModal: e
        } = await Promise.resolve().then(n.bind(n, 481060));
        return t => {
          var n, l;
          return (0, r.jsxs)(e, (n = z({}, t), l = l = {
