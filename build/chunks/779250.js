...
function z(e) {
  let {
    ...
    valid: !0
  }], [g, d, C]), D = Object.keys(L).length, _ = (0, j.xt)(n), A = e => Math.max(0, Math.min(e, D - 1)), [U, M] = i.useState(+!!_), [z, V] = i.useState(!1), W = i.useMemo(() => Z.slice(0, U + 1).map(e => e.valid).every(Boolean), [Z, U]), X = U >= Z.length ? 3 : Z[A(U)].slideId, F = 3 === X;
  ...
  return 2 === X && (Q = d ? R.intl.string(R.t.e5VEcH) : R.intl.string(R.t["60lJ0N"])), (0, l.jsxs)(o.Y0X, {
    transitionState: h,
    "aria-labelledby": E,
    size: o.CgR.DYNAMIC,
    parentComponent: "ScheduleEventModal",
    "data-migration-pending": !0,
    children: [!B && F ? (0, l.jsx)(G, {
      modal: Y.current
    }) : null, (0, l.jsxs)(o.hzk, {
      className: k.content,
      scrollerRef: Y,
...
function V(e) {
  ...
  }, L = (0, g.Z)(d, null == m ? void 0 : m.id, I), [G, {
    loading: V,
    error: W
  }] = (0, f.Z)(async () => {
    if (null != P) return;
