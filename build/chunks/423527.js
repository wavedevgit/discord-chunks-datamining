...
class ed extends(r = l.PureComponent) {
  ...
  async handleRegister() {
    ...
    } = this.props, h = null != s ? s.code : null, g = null != a ? a.skuId : null, p = b.MD.getState(), m = (0, q.Ew)(u) ? null : t === u, _ = ee.a ? await (0, C.K)(t) : t, x = ee.a ? await (0, C.K)(n) : n;
    H.S.dispatch(Q.CkL.WAVE_EMPHASIZE), this.setState({
      registering: !0,
      apiErrors: {}
    });
    try {
      d || null == s ? await (0, j.R$)({
        email: e,
        username: _,
        globalName: x,
        consent: i,
  ...
  renderFull(e, t) {
    let {
      ...
      this.setState({
        usernameFocused: !0
      }), C && s.length > 0 && !L.Z.wasRegistrationSuggestionFetched(s) && await w.Z.fetchSuggestionsRegistration(s)
      ...
      children: [(0, i.jsx)(I.II, {
        ...
        value: u,
        required: !0
      }), (0, i.jsx)(N.Z, {}), D, R, T, A, ee.a ? null : (0, i.jsx)(I.zx, {
  ...
  render() {
    ...
    return null == n || s || t ? null != l ? this.renderFull(() => (0, i.jsx)(Z.Z, {
      guildTemplate: l
