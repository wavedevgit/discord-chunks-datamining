...
d.ZP.initialize();
let el = /\.$/,
  ec = e => Array.isArray(e) ? e.map(e => e.replace(el, "")).join(". ").trim() : e;
class eu extends(r = o.PureComponent) {
  ...
  componentDidMount() {
    ...
    z.default.track(X.rMx.REGISTER_VIEWED, ea({
  ...
  componentDidUpdate(e, t) {
    ...
    let l = Q.EW.FULL;
    r || this.hasError("date_of_birth") ? l = Q.EW.AGE_GATE : null != i && (null != i.guild || null != i.channel) && (l = Q.EW.INVITE), o(l)
  }
  ...
  async handleRegister() {
    ...
    } = this.props, p = null != a ? a.code : null, h = null != l ? l.skuId : null, g = N.MD.getState(), _ = (0, K.Ew)(u) ? null : t === u, f = $.a ? await (0, y.K)(t) : t, b = $.a ? await (0, y.K)(n) : n;
    V.S.dispatch(X.CkL.WAVE_EMPHASIZE), this.setState({
      registering: !0,
      apiErrors: {}
    });
    try {
      d || null == a ? await (0, E.R$)({
        email: e,
        username: f,
        globalName: b,
        consent: i,
  ...
  renderInviteResolving() {
    ...
    return (0, i.jsxs)(I.ZP, {
      className: e,
      children: [(0, i.jsx)(Y.R, {}), (0, i.jsxs)(I.gO, {
  ...
  renderInviteButton() {
    let {
      ...
      consent: n,
      registering: r
    } = this.state, o = I.zx.Colors.BRAND, a = en.NW.string(en.t["3PatS0"]);
    return (null == e ? void 0 : e.stage_instance) != null && (o = I.zx.Colors.GREEN, a = en.NW.string(en.t["5UKyUl"])), (0, i.jsx)(h.ua7, {
  ...
  renderInvite() {
    let {
      ...
      subText: a,
      consentText: s
    } = this.renderConsentComponents(), l = (null == e ? void 0 : e.stage_instance) != null || (null == e ? void 0 : e.guild_scheduled_event) != null, c = e => {
      this.setState({
        globalName: e
      })
    };
    return (0, i.jsxs)("div", {
      children: [(0, i.jsxs)(I.ZP, {
        ...
        tag: "form",
        className: t,
        children: [this.renderInviteHeader(), l ? (0, i.jsx)("div", {
          ...
          }), this.renderInviteButton(), a, s, $.a ? null : (0, i.jsx)(I.zx, {
            look: I.zx.Looks.LINK,
            color: I.zx.Colors.LINK,
  ...
  renderFull(e, t) {
    ...
    return t ? (0, i.jsx)(J.Z, {
      onSubmit: this.handleSubmit,
      tag: "form",
      className: s()(T, er.horizontalAuthBox),
  ...
  render() {
    ...
    if (e || this.hasError("date_of_birth")) return (0, i.jsx)(f.Z, {});
    let {
      invite: n,
      giftCode: r,
      guildTemplate: o
    ...
    return null == n || a || t ? null != o ? this.renderFull(() => (0, i.jsx)(P.Z, {
      ...
      giftCode: r
    })) : null != n && a && n.state === X.r2o.RESOLVED && !t ? this.renderFull(() => (0, i.jsx)(Y.Z, {
      invite: n,
      isRegister: !0
    })) : this.renderFull() : n.state === X.r2o.RESOLVING ? this.renderInviteResolving() : this.renderInvite()
  }
  constructor(e) {
    var t;
    super(e), eo(this, "emailRef", void 0), eo(this, "usernameRef", void 0), eo(this, "globalNameRef", void 0), eo(this, "passwordRef", void 0), eo(this, "dateOfBirthRef", o.createRef()), eo(this, "_retryTimer", new p.V7), eo(this, "handleGotoLogin", e => {
      let t;
      let {
        email: n
      } = this.state, {
      ...
      let p = null != a ? (0, l.parse)(a.search) : {};
      null != o ? t = X.Z5c.INVITE_LOGIN(o.code) : null != r ? t = X.Z5c.GIFT_CODE_LOGIN(r.code) : null != i ? t = X.Z5c.GUILD_TEMPLATE_LOGIN(i.code) : null != c ? (t = X.Z5c.LOGIN, p.redirect_to = c) : (t = X.Z5c.LOGIN, "" !== n && (p = {
        email: n
      })), g.Z.loginReset(), u(t, {
        search: (0, l.stringify)(p)
      }), null == s || s(e), V.S.dispatch(X.CkL.WAVE_EMPHASIZE)
...
function ed(e) {
  let t = (0, d.cj)([U.Z, G.default, _.Z, R.Z, A.Z], () => ({
...
function ep(e) {
  ...
  return t = d ? (0, c.EQ)(u).with({
  ...
  })) : null != r && r.length > 0 && o.length > 0 ? (0, i.jsx)(h.Text, {
    variant: "text-sm/normal",
    color: "text-normal",
    ...
    show: d && (null == u ? void 0 : u.type) === D.K.ERROR || s,
    top: -12,
    bottom: 20,
    children: t
  })
