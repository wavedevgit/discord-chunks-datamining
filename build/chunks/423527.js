...
class eg extends(r = l.PureComponent) {
  ...
  renderInviteButton() {
    let {
      ...
      consent: n,
      registering: r
    } = this.state, l = j.zx.Colors.BRAND, s = el.intl.string(el.t["3PatS0"]);
    return (null == e ? void 0 : e.stage_instance) != null && (l = j.zx.Colors.GREEN, s = el.intl.string(el.t["5UKyUl"])), (0, i.jsx)(g.ua7, {
  ...
  renderInvite() {
    let {
      ...
      subText: d,
      consentText: h
    } = this.renderConsentComponents(), p = (null == e ? void 0 : e.stage_instance) != null || (null == e ? void 0 : e.guild_scheduled_event) != null, m = e => {
      this.setState({
        globalName: e
      })
    };
    return (0, i.jsxs)("div", {
      children: [(0, i.jsxs)(j.ZP, {
        ...
        tag: "form",
        className: t,
        children: [this.renderInviteHeader(), p ? (0, i.jsx)("div", {
          ...
          }) : null, this.renderInviteButton(), d, h, en.a ? null : (0, i.jsx)(j.zx, {
            look: j.zx.Looks.LINK,
            color: j.zx.Colors.LINK,
