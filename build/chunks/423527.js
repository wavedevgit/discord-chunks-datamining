...
class eh extends(r = l.PureComponent) {
  ...
  async handleRegister() {
    ...
    } = this.props, h = null != o ? o.code : null, g = null != s ? s.skuId : null, p = b.MD.getState(), f = (0, Y.Ew)(u) ? null : t === u, _ = et.a ? await (0, T.K)(t) : t, x = et.a ? await (0, T.K)(n) : n;
    K.S.dispatch($.CkL.WAVE_EMPHASIZE), this.setState({
      registering: !0,
      apiErrors: {}
    });
    try {
      this.inGuildOrChannelInviteFlow() ? await (0, O.ZP)({
        consent: i,
        invite: h,
        giftCodeSKUId: g,
  ...
  renderInvite() {
    let {
      ...
      parsedDateOfBirth: u,
      globalNameFocused: d
    } = this.state, h = (null == e ? void 0 : e.stage_instance) != null || (null == e ? void 0 : e.guild_scheduled_event) != null, p = e => {
      this.setState({
        globalName: e
      })
    };
    return (0, i.jsxs)("div", {
      children: [(0, i.jsxs)(S.ZP, {
        ...
        children: [this.renderInviteHeader(), h ? (0, i.jsx)("div", {
          ...
          }) : null, n ? this.renderConsentComponent() : null, this.renderInviteButton(), n ? null : this.renderConsentComponent(), et.a ? null : (0, i.jsx)("div", {
            children: (0, i.jsx)(S.zx, {
              look: S.zx.Looks.LINK,
              color: S.zx.Colors.LINK,
  ...
  renderFull(e, t) {
    let {
      ...
      inUnclaimedFlowExperiment: T
    } = this.props, A = this.renderErrorMessage(), P = (0, i.jsx)(g.ua7, {
      text: !c && y ? ei.intl.string(ei.t.AY4IVF) : null,
      children: e => (0, i.jsx)("div", ec(es({
        className: T ? eo.marginTop8 : eo.marginTop20
      }, e), {
        children: (0, i.jsx)(S.zx, {
          type: "submit",
          submitting: _,
      ...
      }), (0, i.jsx)(N.Z, {}), T ? this.renderConsentComponent() : null, P, A, T ? null : this.renderConsentComponent(), et.a ? null : (0, i.jsx)(S.zx, {
        look: S.zx.Looks.LINK,
        color: S.zx.Colors.LINK,
        onClick: this.handleGotoLogin,
        className: eo.marginTop20,
  ...
  render() {
    ...
    return null != l && n ? l.state === $.r2o.RESOLVING ? this.renderInviteResolving() : this.renderInvite() : null != o ? this.renderFull(() => (0, i.jsx)(P.Z, {
      guildTemplate: o
    }), !0) : null != r ? this.renderFull(() => (0, i.jsx)(J.Z, {
      giftCode: r
    })) : null != l && a && l.state === $.r2o.RESOLVED ? this.renderFull(() => (0, i.jsx)(X.Z, {
      invite: l,
      isRegister: !0
    })) : this.renderFull()
  }
  constructor(e) {
    ...
    super(e), ea(this, "emailRef", void 0), ea(this, "usernameRef", void 0), ea(this, "globalNameRef", void 0), ea(this, "passwordRef", void 0), ea(this, "dateOfBirthRef", l.createRef()), ea(this, "_retryTimer", new h.V7), ea(this, "handleGotoLogin", e => {
      ...
      null != l ? t = $.Z5c.INVITE_LOGIN(l.code) : null != r ? t = $.Z5c.GIFT_CODE_LOGIN(r.code) : null != i ? t = $.Z5c.GUILD_TEMPLATE_LOGIN(i.code) : null != c ? (t = $.Z5c.LOGIN, d.redirect_to = c) : (t = $.Z5c.LOGIN, "" !== n && (d = {
        email: n
      })), p.Z.loginReset(), u(t, {
      ...
      }), c = !0)), s && a && (0 === l.length && (this.setState({
