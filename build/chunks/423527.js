...
class eu extends(r = l.PureComponent) {
  ...
  componentDidMount() {
    ...
    V.default.track(X.rMx.REGISTER_VIEWED, eo({
      location: null != t ? "Invite Register Page" : "Non-Invite Register Page",
      registration_source: this.registrationSource
    }, null != e ? (0, A.Z)(e, !1, !1) : {}), {
      flush: !0
    }), null == this.props.consentRequired && f.Z.getLocationMetadata(), (0, U.e)("register")
  }
  ...
  async handleRegister() {
    ...
    } = this.props, d = null != o ? o.code : null, h = null != a ? a.skuId : null, p = E.MD.getState(), f = (0, W.Ew)(u) ? null : t === u, g = $.a ? await (0, C.K)(t) : t, _ = $.a ? await (0, C.K)(n) : n;
  ...
  renderInviteButton() {
    let {
      ...
      consent: n,
      registering: r
    } = this.state, l = I.zx.Colors.BRAND, o = en.intl.string(en.t["825cFx"]);
    return (null == e ? void 0 : e.stage_instance) != null && (l = I.zx.Colors.GREEN, o = en.intl.string(en.t["5UKyUl"])), (0, i.jsx)(p.ua7, {
  ...
  renderInvite() {
    let {
      ...
      parsedDateOfBirth: c,
      globalNameFocused: u
    } = this.state, d = (null == e ? void 0 : e.stage_instance) != null || (null == e ? void 0 : e.guild_scheduled_event) != null, h = e => {
      this.setState({
        globalName: e
      })
    };
  ...
  render() {
    ...
    return null != r && t ? r.state === X.r2o.RESOLVING ? this.renderInviteResolving() : this.renderInvite() : null != l ? this.renderFull(() => (0, i.jsx)(T.Z, {
      ...
      giftCode: n
    })) : null != r && o && r.state === X.r2o.RESOLVED ? this.renderFull(() => (0, i.jsx)(Y.Z, {
      invite: r,
      isRegister: !0
    })) : this.renderFull()
  }
  constructor(e) {
    var t;
    super(e), el(this, "emailRef", void 0), el(this, "usernameRef", void 0), el(this, "globalNameRef", void 0), el(this, "passwordRef", void 0), el(this, "dateOfBirthRef", l.createRef()), el(this, "_retryTimer", new h.V7), el(this, "handleGotoLogin", e => {
      let t, {
          email: n
        } = this.state,
        {
