...
d.ZP.initialize();
let eu = /\.$/,
  ed = e => Array.isArray(e) ? e.map(e => e.replace(eu, "")).join(". ").trim() : e;
class eh extends(r = l.PureComponent) {
  ...
  componentDidMount() {
    ...
    H.default.track($.rMx.REGISTER_VIEWED, es({
      location: null != t ? "Invite Register Page" : "Non-Invite Register Page",
      registration_source: this.registrationSource
    }, null != e ? (0, A.Z)(e, !1, !1) : {}), {
      flush: !0
    }), null == this.props.consentRequired && p.Z.getLocationMetadata(), (0, G.e)("register")
  }
  ...
  componentDidUpdate(e, t) {
    ...
    (t.apiErrors !== o || t.parsedDateOfBirth !== a) && (this.hasError("email") || this.hasError("phone") ? null != this.emailRef && this.emailRef.focus() : this.hasError("username") ? null != this.usernameRef && this.usernameRef.focus() : this.hasError("global_name") ? null != this.globalNameRef && this.globalNameRef.focus() : this.hasError("password") ? null != this.passwordRef && this.passwordRef.focus() : null == this.state.parsedDateOfBirth ? null != this.dateOfBirthRef.current && this.dateOfBirthRef.current.focus() : this.hasError("retry_after") && "number" == typeof o.retry_after && (this.setState({
      isRateLimited: !0
  ...
  async handleRegister() {
    ...
    } = this.props, g = null != o ? o.code : null, p = null != s ? s.skuId : null, f = b.MD.getState(), _ = (0, Y.Ew)(u) ? null : t === u, x = et.a ? await (0, T.K)(t) : t, E = et.a ? await (0, T.K)(n) : n;
    K.S.dispatch($.CkL.WAVE_EMPHASIZE), this.setState({
      registering: !0,
      apiErrors: {}
    });
    try {
      d || null == o ? await (0, O.R$)({
        email: e,
        username: x,
        globalName: E,
        consent: i,
  ...
  renderInviteResolving() {
    ...
    return (0, i.jsxs)(S.ZP, {
      className: e,
      children: [(0, i.jsx)(X.R, {}), (0, i.jsxs)(S.gO, {
  ...
  renderInviteButton() {
    let {
      ...
      consent: r,
      registering: l
    } = this.state, o = S.zx.Colors.BRAND, a = n ? ei.intl.string(ei.t["825cFx"]) : ei.intl.string(ei.t["3PatS0"]);
    return (null == e ? void 0 : e.stage_instance) != null && (o = S.zx.Colors.GREEN, a = ei.intl.string(ei.t["5UKyUl"])), (0, i.jsx)(g.ua7, {
      text: !r && t ? ei.intl.string(ei.t.AY4IVF) : null,
      children: e => (0, i.jsx)("div", ec(es({
        ...
        children: [this.renderInviteHeader(), m ? (0, i.jsx)("div", {
          ...
          children: [(0, i.jsx)(g.vwX, {
            ...
            children: [(0, i.jsx)(x.Z, {
              ...
              children: ei.intl.format(ei.t["6ENSU1"], {
                helpURL: q.Z.getArticleURL($.BhN.AGE_GATE)
              })
            })]
  ...
  renderErrorMessage() {
    ...
    return "string" != typeof e ? null : (0, i.jsx)(S.i_, {
  ...
  renderFull(e, t) {
    let {
      ...
      subText: A,
      consentText: P
    } = this.renderConsentComponents(), Z = this.renderErrorMessage(), R = (0, i.jsx)(g.ua7, {
      ...
      this.setState({
        usernameFocused: !0
      }), o.length > 0 && !D.Z.wasRegistrationSuggestionFetched(o) && await L.Z.fetchSuggestionsRegistration(o)
    }, k = null != e ? (0, i.jsx)(l.Fragment, {
      children: e()
    }, "custom-header") : (0, i.jsx)(S.Dx, {
      children: ei.intl.string(ei.t.wC4TlZ)
    }, "title"), M = (0, i.jsxs)(S.gO, {
      className: eo.marginTop20,
      ...
      }), (0, i.jsx)(N.Z, {}), R, Z, P, A, et.a ? null : (0, i.jsx)(S.zx, {
  ...
  render() {
    ...
    return null == l || a || t ? null != o ? this.renderFull(() => (0, i.jsx)(P.Z, {
      guildTemplate: o
    }), !0) : null != r ? this.renderFull(() => (0, i.jsx)(J.Z, {
      giftCode: r
    })) : null != l && a && l.state === $.r2o.RESOLVED && !t ? this.renderFull(() => (0, i.jsx)(X.Z, {
      invite: l,
      isRegister: !0
    })) : this.renderFull() : l.state === $.r2o.RESOLVING ? this.renderInviteResolving() : this.renderInvite()
  }
  constructor(e) {
    var t;
    super(e), ea(this, "emailRef", void 0), ea(this, "usernameRef", void 0), ea(this, "globalNameRef", void 0), ea(this, "passwordRef", void 0), ea(this, "dateOfBirthRef", l.createRef()), ea(this, "_retryTimer", new h.V7), ea(this, "handleGotoLogin", e => {
      ...
      null != l ? t = $.Z5c.INVITE_LOGIN(l.code) : null != r ? t = $.Z5c.GIFT_CODE_LOGIN(r.code) : null != i ? t = $.Z5c.GUILD_TEMPLATE_LOGIN(i.code) : null != c ? (t = $.Z5c.LOGIN, h.redirect_to = c) : (t = $.Z5c.LOGIN, "" !== n && (h = {
        email: n
      })), p.Z.loginReset(), u(t, {
        search: (0, s.stringify)(h),
        source: "register"
      }), null == a || a(e), K.S.dispatch($.CkL.WAVE_EMPHASIZE)
      ...
      if (null === a) return;
      let c = !1;
      null == o && (0 === t.length && (this.setState({
      ...
      }), c = !0)), s && (0 === l.length && (this.setState({
        globalNameClientError: ei.intl.string(ei.t.EkokLy)
      }), c = !0), null == i && (this.setState({
        dateOfBirthClientError: ei.intl.string(ei.t.EkokLy)
      }), c = !0)), c || this.handleRegister()
    }), ea(this, "trackInputFocus", e => {
      H.default.track($.rMx.REGISTER_INPUT_FOCUS, {
        field: e
      })
    }), ea(this, "trackInputBlur", e => {
      H.default.track($.rMx.REGISTER_INPUT_BLUR, {
        field: e
      })
...
function eg(e) {
  ...
  let {
    ...
    autoTrackExposure: r === ee.EW.INVITE
  });
  return (0, i.jsx)(eh, es({
    onChangeStep: e => o(e),
