...
function C(e) {
  let {
    guild: t
  } = e, n = (0, s.e7)([m.Z], () => m.Z.getEveryoneRole(t));
...
function j(e) {
  ...
  return 0 === t.length && 2 !== n ? null : (2 === n && (t = O.$X), (0, i.jsxs)("div", {
    className: x.tableContainer,
    children: [(0, i.jsx)(c.Text, {
      className: x.tableHeader,
      variant: "text-xs/semibold",
...
function G(e) {
  let {
    ...
    transitionState: l,
    onClose: d
  } = e, [p, f] = a.useState(0), E = a.useMemo(() => {
    let e = [],
      n = [];
    return O.$X.map(i => {
  ...
  return (0, i.jsxs)(c.Y0X, {
    ...
    children: [(0, i.jsx)(b, {
      ...
      onConfirm: () => {
        var e, i;
        n || (R(), d(), (0, S.Qd)(r.C.DISABLE_UNSAFE_COMMUNITY_PERMISSIONS_NOTICE, null != (e = null == t ? void 0 : t.id) ? e : "", !0, h.L.PRIMARY)), 0 === p ? (f(1), setTimeout(() => f(2), 3e3)) : 2 === p && (R(), d(), (0, S.Qd)(r.C.DISABLE_UNSAFE_COMMUNITY_PERMISSIONS_NOTICE, null != (i = null == t ? void 0 : t.id) ? i : "", !0, h.L.PRIMARY))
      },
      onDismiss: () => {
