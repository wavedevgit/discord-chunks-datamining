...
function d(e, t) {
  ...
  let n = (0, l.e7)([c.Z], () => c.Z.getApplicationFrecencyWithoutLoadingLatest()),
    ...
    s = r.useMemo(() => null == t ? void 0 : t.filter(t => !e.some(e => e.id === t.application.id)), [e, t]),
    f = r.useMemo(() => {
      var e;
      null == s || s.forEach(e => {
      ...
      let t = null != (e = null == s ? void 0 : s.map(e => (0, u.X0)(e.application, !0))) ? e : [],
        r = [...d];
  ...
  return r.useMemo(() => {
    ...
    return [...f.filter(e => e.id === i), ...f.filter(e => e.id !== i)]
  }, [f, d, n, t])
}