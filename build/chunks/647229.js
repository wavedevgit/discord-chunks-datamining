...
l.cipher.aes = function(e) {
  ...
  O: function() {
    ...
    for (t = n = 0; !c[t]; t ^= r || 1, n = f[n] || 1)
      for (a = (a = n ^ n << 1 ^ n << 2 ^ n << 3 ^ n << 4) >> 8 ^ 255 & a ^ 99, c[t] = a, u[a] = t, o = 0x1010101 * (i = d[e = d[r = d[t]]]) ^ 65537 * e ^ 257 * r ^ 0x1010100 * t, i = 257 * d[a] ^ 0x1010100 * a, e = 0; 4 > e; e++) s[e][t] = i = i << 24 ^ i >>> 8, l[e][a] = o = o << 24 ^ o >>> 8;
  ...
  na: function(e, t, n, r, i, a) {
    var o = [],
      s = l.bitArray,
      c = s.i;
    if (r = [s.partial(8, 64 * !!t.length | r - 2 << 2 | a - 1)], r = s.concat(r, n), r[3] |= i, r = e.encrypt(r), t.length)
      for (65279 >= (n = s.bitLength(t) / 8) ? o = [s.partial(16, n)] : 0xffffffff >= n && (o = s.concat([s.partial(16, 65534)], [n])), o = s.concat(o, t), t = 0; t < o.length; t += 4) r = e.encrypt(c(r, o.slice(t, t + 4).concat([0, 0, 0])));
    return r
  },
  ...
  pmac: function(e, t) {
    ...
    return n = t.slice(n), 128 > i.bitLength(n) && (s = a(s, r(s)), n = i.concat(n, [-0x80000000, 0, 0, 0])), o = a(o, n), e.encrypt(a(r(a(s, r(s))), o))
  },
  S: function(e) {
  ...
  C: function(e, t, n, r, i, a) {
    var o, s, c, u, d, f, _, p, h = l.bitArray;
    for (f = n.length, _ = h.bitLength(n), p = h.bitLength(r), s = h.bitLength(i), o = t.encrypt([0, 0, 0, 0]), 96 === s ? (i = i.slice(0), i = h.concat(i, [1])) : (i = l.mode.gcm.j(o, [0, 0, 0, 0], i), i = l.mode.gcm.j(o, i, [0, 0, Math.floor(s / 0x100000000), 0xffffffff & s])), s = l.mode.gcm.j(o, [0, 0, 0, 0], r), d = i.slice(0), r = s.slice(0), e || (r = l.mode.gcm.j(o, s, n)), u = 0; u < f; u += 4) d[3]++, c = t.encrypt(d), n[u] ^= c[0], n[u + 1] ^= c[1], n[u + 2] ^= c[2], n[u + 3] ^= c[3];
    return n = h.clamp(n, _), e && (r = l.mode.gcm.j(o, s, n)), e = [Math.floor(p / 0x100000000), 0xffffffff & p, Math.floor(_ / 0x100000000), 0xffffffff & _], r = l.mode.gcm.j(o, r, e), c = t.encrypt(i), r[0] ^= c[0], r[1] ^= c[1], r[2] ^= c[2], r[3] ^= c[3], {
  ...
  randomWords: function(e, t) {
    ...
    if (n & this.J) {
      ...
      var i, a = [],
        o = 0;
      for (i = 0, this.Z = a[0] = (new Date).valueOf() + this.da; 16 > i; i++) a.push(0x100000000 * Math.random() | 0);
