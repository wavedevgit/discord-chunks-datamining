...
function c(e, t, n) {
  ...
  var h = s[1],
    ...
    m = s[3],
    E = s[4];
  for (d = 0; d < f; d++) s = e[i >>> 24] ^ h[o >> 16 & 255] ^ g[a >> 8 & 255] ^ m[255 & t] ^ r[_], c = e[o >>> 24] ^ h[a >> 16 & 255] ^ g[t >> 8 & 255] ^ m[255 & i] ^ r[_ + 1], u = e[a >>> 24] ^ h[t >> 16 & 255] ^ g[i >> 8 & 255] ^ m[255 & o] ^ r[_ + 2], t = e[t >>> 24] ^ h[i >> 16 & 255] ^ g[o >> 8 & 255] ^ m[255 & a] ^ r[_ + 3], _ += 4, i = s, o = c, a = u;
...
l.cipher.aes = function(e) {
  ...
  C: function(e, t, n, r, i, o) {
    var a, s, c, u, d, f, _, p, h = l.bitArray;
    for (f = n.length, _ = h.bitLength(n), p = h.bitLength(r), s = h.bitLength(i), a = t.encrypt([0, 0, 0, 0]), 96 === s ? (i = i.slice(0), i = h.concat(i, [1])) : (i = l.mode.gcm.j(a, [0, 0, 0, 0], i), i = l.mode.gcm.j(a, i, [0, 0, Math.floor(s / 0x100000000), 0xffffffff & s])), s = l.mode.gcm.j(a, [0, 0, 0, 0], r), d = i.slice(0), r = s.slice(0), e || (r = l.mode.gcm.j(a, s, n)), u = 0; u < f; u += 4) d[3]++, c = t.encrypt(d), n[u] ^= c[0], n[u + 1] ^= c[1], n[u + 2] ^= c[2], n[u + 3] ^= c[3];
    return n = h.clamp(n, _), e && (r = l.mode.gcm.j(a, s, n)), e = [Math.floor(p / 0x100000000), 0xffffffff & p, Math.floor(_ / 0x100000000), 0xffffffff & _], r = l.mode.gcm.j(a, r, e), c = t.encrypt(i), r[0] ^= c[0], r[1] ^= c[1], r[2] ^= c[2], r[3] ^= c[3], {
