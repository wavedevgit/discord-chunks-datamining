...
function s(e) {
  switch (e) {
    case 60:
      return o.intl.formatToPlainString(o.t["4zv/jo"], {
        secs: 60
      });
    case 300:
      return o.intl.formatToPlainString(o.t.opVZ9v, {
        mins: 5
      });
    case 600:
      return o.intl.formatToPlainString(o.t.opVZ9v, {
    ...
    case 3600:
      return o.intl.formatToPlainString(o.t.xCjYxM, {
        hours: 1
      });
    case 86400:
      return o.intl.formatToPlainString(o.t.k2UNz8, {
        days: 1
      });
    case 604800:
      return o.intl.formatToPlainString(o.t.EmoBDw, {
        weeks: 1
      });
    default:
      return
