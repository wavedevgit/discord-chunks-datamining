...
let eA = e => {
    let {
      selected: t
    } = e, n = eh(e, ["selected"]), i = (0, P.c)("PrivateChannels.ICYMIButton"), l = (0, c.rm)("icymi");
  ...
  eg = e => {
    let {
      selected: t
    } = e, n = eh(e, ["selected"]), l = (0, c.rm)("friends"), a = (0, k.kX)(), s = (0, d.bG)([G.Ay], () => G.Ay.canShowFriendsTabBadge()), u = (0, d.bG)([v.A], () => v.A.useReducedMotion), {
      enabled: f
    } = U.u.useConfig({
    ...
    let y = () => {
        let e;
        _ ? (er.default.track(el.HAw.GIFT_INTENT_BADGE_CLICKED, {
          gift_intent_type: eo.np.FRIEND_ANNIVERSARY
        }), e = el.m3P.ALL, E.A.setSection(el.m3P.ALL), g(es.i.TAKE_ACTION)) : e = en.Ay.getState().section, (0, S.A)({
          tab_opened: e
        })
      },
      ...
      P = () => (0, r.jsx)(O.z9, ef(ep({
        onClick: y,
        interactiveClassName: _ ? ed.hc : true,
        selected: t,
  ...
  em = e => {
    ...
    } = e, i = eh(e, ["selected", "hideGameUpdateProgressIndicator"]), l = (0, c.rm)("library");
    return (0, r.jsx)(O.z9, ef(ep({
      selected: t,
  ...
  e_ = e => {
    ...
    let l = null == i ? true : () => _.A.preload(el.ME, i);
    return (0, r.jsx)(O.z9, ef(ep({
      selected: t,
  ...
  eE = e => {
    let {
      selected: t
    } = e, n = ec.intl.string(eu.default.Rkdixs), l = (0, c.rm)("family-center"), [a, s] = i.useState(true);
    return (0, r.jsx)(O.z9, ef(ep({
      selected: t,
    ...
    return t ? (0, r.jsx)("div", {
      ...
      children: (0, r.jsx)(j.Ay, {
        ...
        children: e => {
          ...
          return t === p.M.FAMILY_CENTER_NEW_BADGE ? (0, r.jsx)(b.LpS, {
...
let ev = Chunk64700.memo(function(e) {
  let {
    showLibrary: t,
    ...
    selectedChannelId: h,
    path: A
  } = e, m = i.useRef(null), _ = i.useRef(null), E = i.useRef(null), O = i.useRef(null), I = (0, P.c)("PrivateChannels"), v = null;
  return c ? v = (0, r.jsx)(F.V, {
    ...
    children: [(0, r.jsx)(Q.A, {
      ...
      children: (0, r.jsx)("div", {
        ...
        children: (0, r.jsx)(b.Button, {
          ...
          text: ec.intl.format(ec.t.fH9FBy, {
            tooltipHook: (e, t) => (0, r.jsx)(g.A, {
              children: e
            }, t)
          })
        })
      })
    }), (0, r.jsxs)(y.A, ef(ep({}, e), {
      version: A,
      selectedChannelId: h,
      listScrollerRef: E,
      children: [(0, r.jsx)(eg, {
        selected: null != A ? A === el.BVt.FRIENDS : l === el.BVt.FRIENDS
      }, "friends"), I ? (0, r.jsx)(eA, {
        selected: null != A ? A === el.BVt.ICYMI : l === el.BVt.ICYMI
      }, "icymi") : null, n && t ? (0, r.jsx)(em, {
        selected: null == A ? null != l && l.startsWith(el.BVt.APPLICATION_LIBRARY) : A.startsWith(el.BVt.APPLICATION_LIBRARY),
        hideGameUpdateProgressIndicator: l === el.BVt.APPLICATION_LIBRARY
      }, "library") : null, p ? (0, r.jsx)(e_, {
        selected: null == A ? null != l && l.startsWith(el.BVt.MESSAGE_REQUESTS) : A === el.BVt.MESSAGE_REQUESTS
        ...
        selected: A === el.BVt.COLLECTIBLES_SHOP || (null == l ? true : l.startsWith(el.BVt.COLLECTIBLES_SHOP)),
        listItemRef: _,
        locationState: {
          analyticsSource: {
            page: eI(l),
      ...
      }, "discord-shop"), f ? (0, r.jsx)(eE, {
        selected: null != l && l.startsWith(el.BVt.FAMILY_CENTER) || null != A && A.startsWith(el.BVt.FAMILY_CENTER)
      }, "family-center") : null, (0, r.jsx)(z.A, {
        selected: null == A ? null != l && l.startsWith(el.BVt.QUEST_HOME_V2) : A === el.BVt.QUEST_HOME_V2
...
function eC() {
  let e, t, n = (0, d.bG)([et.A], () => et.A.getHomeLink()),
    i = (0, d.bG)([ee.A], () => {
      if (n === el.BVt.APPLICATION_STORE) returntrue;
      let e = (0, ei.qt)(n);
      if (null != e) {
        var t, r;
        return null != (t = null == (r = ee.A.get(e)) ? true : r.premium) && t
      }
      returnfalse
    }, [n]),
    l = !Z.l_.useSetting(),
  ...
  let [b, _] = (0, j.kn)(m, true, true), E = (0, R.H)(), O = (e = Z.dm.useSetting(), t = (0, D.A)(), true === e && true === t);
  return (0, r.jsx)(ev, {
    theme: a,
    showLibrary: l,
