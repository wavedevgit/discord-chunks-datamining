...
function eI(e) {
  ...
  E || (es[t] = g);
  let O = r;
  if (r = l().values(es).find(e => null != e), ew(b.default.getId()), null == o || E ? er.stop() : er.start(o.duration - s + V, () => ef(_.id)), null != i && (!n && s > 0 || null == c || null != g && i.trackId !== g.track.id) ? ($.info("Listen along active but playback stopped or track changed. Stopping listen along in ".concat(V, "ms")), ei.start(V, () => {
...
function ew(e) {
  if (e === b.default.getId()) {
    ...
    t && n && null != r ? (ee.start(Z, eD, false), et.stop()) : et.start(B, () => ee.stop(), false)
  }
  returnfalse
}
...
function eM(e) {
  ...
  if ((null == t ? true : t.desktopSettings) != null) {
    ...
    null != e && E.ZP.getObservedAppNameForWindow(e) === M.name && n ? (ec = new f.Xp).start(Z, eD) : (null == ec || ec.stop(), ec = null)
