...
function O(e) {
  let {
    ...
    setStatusDefaultState: i
  } = e, o = (0, l.e7)([f.Z], () => f.Z.getStatus());
  return (0, r.jsxs)("div", {
...
function C(e) {
  ...
  } = (0, d.ZP)(u.Z.SHARING_CONTROLS_COACHMARK), o = p.G6.useSetting();
  return (0, r.jsxs)(j, {
    closePopout: t,
    children: [(0, r.jsx)(s.Text, {
      variant: "text-xs/normal",
      ...
      children: b.NW.format(b.t.nEgjjo, {
        onClickSettings: () => {
          t(), c.Z.open(g.oAB.ACTIVITY_PRIVACY, null, {
            analyticsLocations: i
          })
        }
      })
...
function x(e) {
  let {
    ...
    analyticsLocations: i
  } = (0, d.ZP)(u.Z.SHARING_CONTROLS_COACHMARK), l = p.G6.useSetting();
  return (0, r.jsxs)(j, {
