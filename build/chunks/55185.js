...
function j(e) {
  ...
  return (0, i.jsxs)(C, {
    ...
    children: [(0, i.jsx)(c.Text, {
      ...
      children: m.intl.format(m.t.fF2TbW, {
        helpDeskUrl: p.Z.getArticleURL(f.BhN.ACTIVITY_STATUS_SETTINGS)
      })
    }), (0, i.jsx)("div", {
...
function S(e) {
  ...
  return (0, i.jsxs)(C, {
    ...
    children: [(0, i.jsx)(c.Text, {
      ...
      color: "text-secondary",
      className: b.nuxContent,
      children: m.intl.format(g.default.ZMYkIS, {
        learnMoreLink: p.Z.getArticleURL(f.BhN.ACTIVITY_STATUS_SETTINGS)
      })
    }), (0, i.jsx)(v, {
      closePopout: t
    })]
