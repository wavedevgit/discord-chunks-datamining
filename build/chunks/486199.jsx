...
function d(e) {
  ...
  return <a.Z justify={a.Z.Justify.CENTER} className={c.wrapper}>{null != r || null != d ? <a.Z.Child shrink={0} grow={0}>{function(e, t, n, r, o) {
      ...
      }(r, d, u, p, m)}</a.Z.Child> : null}{function(e) {
      let {
        name: t,
        description: n,
        details: r,
      ...
      return (0, i.jsxs)(a.Z, {
        ...
        children: [(0, i.jsxs)(o.X6q, {
          ...
          children: [t, p && (0, i.jsx)(o.ua7, {
            text: s.intl.string(s.t.VFuFur),
            children: e => {
              var t, n;
              return (0, i.jsx)(o.Prq, (t = function(e) {
