...
function m(e) {
  let {
    ...
    messageReference: _
  } = t, y = (0, i.e7)([u.Z], () => null != _ ? u.Z.getMessage(_.channel_id, _.message_id) : null), C = (0, i.e7)([c.Z], () => null != y ? c.Z.getChannel(y.channel_id) : null), x = (0, i.e7)([c.Z], () => {
    var e, t;
  ...
  return (0, r.jsx)(p.Z, {
    ...
    icon: a.XHJ,
    onClick: () => {
      null != C && null != y && o.Z.confirmDelete(C, y, false, {
        isFlagResolved: x,
