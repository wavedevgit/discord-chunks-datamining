...
function v(e) {
  return Object.entries(e).sort((e, t) => b(e[1]) - b(t[1])).map(e => {
    let [t] = e;
    return t
  })
}
...
function R(e) {
  ...
  (null == (t = g.modelState[n]) ? void 0 : t.status) !== c.L.DOWNLOADED && (g.modelState[n] = p(f({}, g.modelState[n]), {
    status: c.L.MISSING
  }), "USER_CANCELED_DOWNLOAD" in (null != r ? r : {}) || (g.error = "ERROR_DOWNLOADING_DEPENDENCY"))
}
