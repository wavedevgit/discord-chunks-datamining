/** Chunk was on web.js **/
/** chunk id: 147426, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  CV: () => o,
  E9: () => v,
...
let a = {
  ...
  f = `(?:${(0,Chunk476858.uJ)(c)}|[0-9]+|[0-9]+\\.[0-9]+|пів|декілька|пар(?:у)|\\s{0,3})`;

function p(e) {
  let t = e.toLowerCase();
  return true !== c[t] ? c[t] : t.match(/декілька/) ? 2 : t.match(/пів/) ? .5 : t.match(/пар/) ? 2 : "" === t ? 1 : parseFloat(t)
}
let _ = `(?:${(0,Chunk476858.uJ)(u)}|[0-9]{1,2}(?:го|ого|е)?)`;
...
let y = `(${f})\\s{0,3}(${(0,Chunk476858.uJ)(d)})`,
  b = RegExp(y, "i"),
  O = (0, Chunk476858.mb)("(?:(?:близько|приблизно)\\s{0,3})?", y);
