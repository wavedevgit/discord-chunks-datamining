...
e = function() {
  ...
  j.prototype.toString = function() {
  ...
  }, f($, J), $.prototype.toKeyedSeq = function() {
    return this
  }, f(X, J), X.of = function() {
    return X(arguments)
    ...
    return this
  }, J.isSeq = tn, J.Keyed = $, J.Set = Z, J.Indexed = X;
  ...
  function tl(t, e) {
    return e ? function t(e, r, n, i) {
      return Array.isArray(r) ? e.call(i, n, X(r).map(function(n, i) {
        return t(e, n, i, r)
      })) : tf(r) ? e.call(i, n, $(r).map(function(n, i) {
        return t(e, n, i, r)
      })) : r
    }(e, t, "", {
      "": t
  ...
  function tb() {}
  J.prototype[Y] = !0, f(Q, X), Q.prototype.get = function(t, e) {
  ...
  }, f(tt, $), tt.prototype.get = function(t, e) {
  ...
  }, tt.prototype[k] = !0, f(te, X), te.prototype.__iterateUncached = function(t, e) {
  ...
  }, f(tr, X), tr.prototype.__iterateUncached = function(t, e) {
    if (e) return this.cacheResult().__iterate(t, e);
  ...
  }, f(td, X), td.prototype.toString = function() {
  ...
  }, f(ty, X), ty.prototype.toString = function() {
  ...
  function tx(t) {
    ...
    if ("number" === i) {
      var o = 0 | t;
      for (o !== t && (o ^= 0xffffffff * t); t > 0xffffffff;) t /= 0xffffffff, o ^= t;
      return tw(o)
    }
    if ("string" === i) {
    ...
    if ("object" === i) return function(t) {
      var e;
      if (tD && void 0 !== (e = n.get(t)) || void 0 !== (e = t[tK]) || !tC && (void 0 !== (e = t.propertyIsEnumerable && t.propertyIsEnumerable[tK]) || void 0 !== (e = function(t) {
  ...
  tN[tF] = !0, tN[E] = tN.remove, tN.removeIn = tN.deleteIn, tP.prototype.get = function(t, e, r, n) {
    ...
    if (T(a), (u || !f) && T(o), !u || 1 !== s.length) {
      if (!f && !u && s.length >= t5) return function(t, e, r, n) {
        t || (t = new M);
    ...
    if (d === h) return this;
    if (!l && d && p.length >= t8) return function(t, e, r, n, i) {
    ...
    var g = t && t === this.ownerID,
      y = l ? d ? c : c ^ s : c | s,
      v = l ? d ? t2(p, f, d, g) : function(t, e, r) {
        var n = t.length - 1;
  ...
  function ew(t) {
    ...
    return e._iter = t, e.size = t.size, e.flip = function() {
      ...
      return t.has(e)
    }, e.cacheResult = eN, e.__iterateUncached = function(e, r) {
      var n = this;
  ...
  function ek(t, e) {
    ...
    return r._iter = t, r.size = t.size, r.reverse = function() {
      ...
      return t.includes(e)
    }, r.cacheResult = eN, r.__iterate = function(e, r) {
      var n = this;
      return t.__iterate(function(t, r) {
        return e(t, r, n)
      }, !r)
  ...
  }, eh.isOrderedMap = ed, eh.prototype[k] = !0, eh.prototype[E] = eh.prototype.remove, f(em, $), em.prototype.get = function(t, e) {
  ...
  }, em.prototype[k] = !0, f(e_, X), e_.prototype.includes = function(t) {
  ...
  }, f(eb, Z), eb.prototype.has = function(t) {
    return this._iter.includes(t)
  ...
  }, f(eS, $), eS.prototype.entrySeq = function() {
  ...
  }, e_.prototype.cacheResult = em.prototype.cacheResult = eb.prototype.cacheResult = eS.prototype.cacheResult = eN, f(ej, tm), ej.prototype.toString = function() {
  ...
  function eV(t) {
    return null == t ? eY() : eG(t) && !b(t) ? t : eY().withMutations(function(e) {
      var r = g(t);
  ...
  eU[E] = eU.remove, eU.deleteIn = eU.removeIn = tN.removeIn, eU.merge = tN.merge, eU.mergeWith = tN.mergeWith, eU.mergeIn = tN.mergeIn, eU.mergeDeep = tN.mergeDeep, eU.mergeDeepWith = tN.mergeDeepWith, eU.mergeDeepIn = tN.mergeDeepIn, eU.setIn = tN.setIn, eU.update = tN.update, eU.updateIn = tN.updateIn, eU.withMutations = tN.withMutations, eU.asMutable = tN.asMutable, eU.asImmutable = tN.asImmutable, f(eV, tb), eV.of = function() {
    return this(arguments)
  ...
  e$[eJ] = !0, e$[E] = e$.remove, e$.mergeDeep = e$.merge, e$.mergeDeepWith = e$.mergeWith, e$.withMutations = tN.withMutations, e$.asMutable = tN.asMutable, e$.asImmutable = tN.asImmutable, e$.__empty = eY, e$.__make = eZ, f(eQ, eV), eQ.of = function() {
    return this(arguments)
  ...
  e1[k] = !0, e1.__empty = e3, e1.__make = e6, f(e2, t_), e2.of = function() {
    return this(arguments)
    ...
    }), this.__ownerID) ? (this.size = e, this._head = r, this.__hash = void 0, this.__altered = !0, this) : e7(e, r)
  ...
  e9[e8] = !0, e9.withMutations = tN.withMutations, e9.asMutable = tN.asMutable, e9.asImmutable = tN.asImmutable, e9.wasAltered = tN.wasAltered, p.Iterator = j, rt(p, {
    toArray: function() {
      tB(this.size);
    ...
    hashCode: function() {
      return this.__hash || (this.__hash = function(t) {
        ...
        return e = t.__iterate(i ? n ? function(t, e) {
          ...
          o = o + tx(t) | 0
        }), r = tS(r = o, 0xcc9e2d51), r = tS(r << 15 | r >>> -15, 0x1b873593), r = ((r = tS(r << 13 | r >>> -13, 5)) + 0xe6546b64 | 0) ^ e, r = tS(r ^ r >>> 16, 0x85ebca6b), r = tw((r = tS(r ^ r >>> 13, 0xc2b2ae35)) ^ r >>> 16)
      }(this))
    }
  });
  var re = p.prototype;
  re[S] = !0, re[z] = re.values, re.__toJS = re.toArray, re.__toStringMapper = ru, re.inspect = re.toSource = function() {
      return this.toString()
  ...
  return rr[w] = !0, rr[z] = re.entries, rr.__toJS = re.toObject, rr.__toStringMapper = function(t, e) {
  ...
  }), g.prototype.has = re.includes, rt($, h.prototype), rt(X, d.prototype), rt(Z, g.prototype), rt(tm, h.prototype), rt(t_, d.prototype), rt(tb, g.prototype), {
    Iterable: p,
    Seq: J,
    Collection: tv,
    Map: tL,
