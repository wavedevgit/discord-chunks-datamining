...
t.exports = function() {
  ...
  j.prototype.toString = function() {
    ...
    return this
  }, J.isSeq = tn, J.Keyed = $, J.Set = Y, J.Indexed = X;
  ...
  function tb() {}
  J.prototype[Z] = !0, f(Q, X), Q.prototype.get = function(t, e) {
  ...
  function tx(t) {
    ...
    if ("object" === e) {
      var i, o, a, u = t;
      if (tD && void 0 !== (a = n.get(u)) || void 0 !== (a = u[tK]) || !tE && (void 0 !== (a = u.propertyIsEnumerable && u.propertyIsEnumerable[tK]) || void 0 !== (a = function(t) {
  ...
  tN[tF] = !0, tN[C] = tN.remove, tN.removeIn = tN.deleteIn, tP.prototype.get = function(t, e, r, n) {
    ...
    var x = t && t === this.ownerID,
      k = l ? d ? c : c ^ s : c | s,
      C = l ? d ? t6(p, f, d, x) : function(t, e, r) {
        var n = t.length - 1;
  ...
  }, eh.isOrderedMap = ed, eh.prototype[k] = !0, eh.prototype[C] = eh.prototype.remove, f(em, $), em.prototype.get = function(t, e) {
  ...
  }, f(eb, Y), eb.prototype.has = function(t) {
    return this._iter.includes(t)
  ...
  function eQ(t) {
    return null == t ? e2() : e0(t) ? t : e2().withMutations(function(e) {
      var r = g(t);
      tB(r.size), r.forEach(function(t) {
        return e.add(t)
      })
  ...
  e$[eJ] = !0, e$[C] = e$.remove, e$.mergeDeep = e$.merge, e$.mergeDeepWith = e$.mergeWith, e$.withMutations = tN.withMutations, e$.asMutable = tN.asMutable, e$.asImmutable = tN.asImmutable, e$.__empty = eZ, e$.__make = eY, f(eQ, eV), eQ.of = function() {
    return this(arguments)
  ...
  e1[k] = !0, e1.__empty = e2, e1.__make = e5, f(e6, t_), e6.of = function() {
    return this(arguments)
    ...
    }), this.__ownerID) ? (this.size = e, this._head = r, this.__hash = void 0, this.__altered = !0, this) : e9(e, r)
  ...
  e8[e7] = !0, e8.withMutations = tN.withMutations, e8.asMutable = tN.asMutable, e8.asImmutable = tN.asImmutable, e8.wasAltered = tN.wasAltered, p.Iterator = j, rt(p, {
    toArray: function() {
      tB(this.size);
  ...
  }), g.prototype.has = re.includes, rt($, h.prototype), rt(X, d.prototype), rt(Y, g.prototype), rt(tm, h.prototype), rt(t_, d.prototype), rt(tb, g.prototype), {
    Iterable: p,
    Seq: J,
    Collection: tv,
    Map: tL,
