...
function j(e) {
  let {
    match: t,
    location: l
  } = e, o = (0, s.parse)(l.search).token, [d, j] = i.useState("loading"), y = i.useRef(false), b = i.useCallback(async e => {
    try {
  ...
  if (i.useEffect(() => {
      ...
      if (a.Fr || a.v1) {
        ...
        return
      }(0, m.isDesktop)() ? b(o): y.current || (y.current = true, j("rpc_attempting"), I(o))
    }, [o, l, b, I]), a.Fr || a.v1) {
