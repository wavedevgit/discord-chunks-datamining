...
function b(e) {
  let {
    match: t,
    location: l
  } = e, o = (0, s.parse)(l.search).token, [u, b] = i.useState("loading"), y = i.useRef(false), j = i.useCallback(async e => {
    try {
  ...
  if (i.useEffect(() => {
      ...
      if (a.Fr || a.v1) {
        ...
        return
      }(0, _.isDesktop)() ? j(o): y.current || (y.current = true, b("rpc_attempting"), O(o))
    }, [o, l, j, O]), a.Fr || a.v1) {
