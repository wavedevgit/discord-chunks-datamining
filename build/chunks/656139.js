...
let Z = e => {
    ...
    return null === n ? (0, r.jsx)(d.$jN, {}) : Z ? (0, r.jsx)(C.P, {
      ...
      children: (e => {
        ...
        return !0 == (R.length > 0 && 0 === t.size) ? (0, r.jsxs)(r.Fragment, {
  ...
  M = e => {
    let {
      onClose: t,
      onShare: a
    } = e, n = (0, l.e7)([j.Z], () => j.Z.getRecipientStatus()), [m, p] = i.useState(new Map), [f, x] = i.useState(new Map), [b, h] = i.useState(!1);
    return i.useEffect(() => {
      (async () => {
        let e = new Map;
        for (let [t, a] of n) {
