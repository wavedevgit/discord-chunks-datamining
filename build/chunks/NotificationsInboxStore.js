...
function z() {
  w = {}, D = null, x = [], L = new Chunk810457.Z, M = false, j = false, k = false, G = Chunk709054.default.fromTimestamp(Date.now()), B = true, U = false, F = null, Z = null
}
...
function eo(e) {
  ...
  })) ? true : t.notificationCenterVariant) && null != D && !M && !j && (!n || !U) && B
}
