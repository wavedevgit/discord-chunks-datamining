...
function z() {
  ...
  for (let e of n)
    if (P[e] = {
      ...
      if (null != t) {
        var i, o;
        P[e].loadState = C.Ve.LOADED, P[e].mostRecentMessageId = null != (i = null == (o = t.last()) ? true : o.id) ? i : P[e].mostRecentMessageId
      }
