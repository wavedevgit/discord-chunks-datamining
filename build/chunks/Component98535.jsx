...
function b(e) {
  ...
  E(p);
  let b = (0, o.e7)([i.Z], () => i.Z.useReducedMotion),
    [S, O] = l.useState(true),
    [x, y] = l.useState(true),
    ...
    k = l.useCallback(e => {
      ...
      c(t, n);
      let i = r && !b,
        a = o ? h.AW.ORBS : h.AW.CATALOG;
      O(n), y(!l), s(a, i)
    }, [b, s, c]),
    {
      searchError: T
    } = (0, d.a)();
  return null != T ? (0, r.jsx)(C.Z, {}) : null != p ? (0, r.jsx)(f.Z, {
    onRetry: u,
    errorMessage: p,
  ...
  E = e => {
    ...
    l.useEffect(() => {
      ...
      null != e && a.Z.captureMessage(e, {
        tags: {
          isStaff: null != (o = null == t || null == (l = t.isStaff()) ? true : l.toString()) ? o : "unknown",
