...
function M(e) {
  ...
  }), Z = F && null == j && null == G && null != U, H = (0, b.yi)(), Y = (null == H ? void 0 : H.interactionSource) === I.n_.ACTIVITY, W = i.useRef(null), K = i.useRef(null), z = i.useRef(null), q = i.useRef(null), [X, Q] = i.useReducer(L, x), {
    height: J,
    animationPhase: $
  ...
  }), Z && en.push((0, r.jsx)(v.Z, C({
    voiceChannel: U
  }, er), "voice"));
  let [ei, ...ea] = en, eo = ea.length > 0, es = null != N && eo ? (0, r.jsx)(l.zx, {
