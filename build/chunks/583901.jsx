...
function y() {
  return <div className={Chunk239926.selectionCircle}><Chunk481060.owK size={"md"} color={"currentColor"} className={Chunk239926.checkmarkCircle} colorClass={Chunk239926.checkmark} secondaryColor={Chunk692547.Z.unsafe_rawColors.WHITE_500.css} /></div>
}
...
function O(e) {
  ...
  return <u.ua7 text={t}>{e => (0, r.jsxs)("div", {
...
function v(e) {
  ...
  return <O onSelect={i} isSelected={n} name={m} className={o()(h.defaultThemeSelection, f)}>{"system" === t && (0, r.jsx)("div", {
...
function I(e) {
  ...
  return <O onSelect={i ? true : s} isSelected={n} name={t.getName()} className={o()([i ? h.disabled : null, (0, c.wj)(p) ? h.darkOverlay : h.lightOverlay])} style={{
      background: "var(--background-gradient), ".concat(m)
    }} tabIndex={a} showBadge={l} showLockedBadge={u} />
}