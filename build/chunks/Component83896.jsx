...
function E(e) {
  ...
  let T = i.useCallback(() => {
      !I && P && (c.default.selectVoiceChannel(n.id), p.default.track(_.rMx.HANG_STATUS_CTA_CLICKED, O(j({
        source: "HangStatusPopout"
      }, (0, g.Z)(n.id)), {
        other_user_id: l,
        cta_type: "join"
    ...
    N = i.useCallback(() => {
      ...
      if (null != e) {
        ...
        p.default.track(_.rMx.HANG_STATUS_CTA_CLICKED, O(j({
          source: "HangStatusPopout"
        }, (0, g.Z)(n.id)), {
          other_user_id: l,
          cta_type: "swipe"
