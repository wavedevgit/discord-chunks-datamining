...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk939872 = require("./939872.js"),
  Chunk265985 = require("./265985.js"),
...
let w = (e, t, n, l) => {
  ...
  let et = r.useCallback(async () => {
      ...
      if (a()(null != e, "No subscription listing"), a()(null != A, "No subscription plan"), a()(R, "Cannot purchase this unpublished plan"), (null == q ? true : q.active_trial) != null) {
        ...
        analyticsLocations: J,
        analyticsLocation: l,
        renderHeader: (n, r, l) => <T.h onClose={r} listing={e} step={l} guildId={t} />,
        initialPlanId: A.id,
        skuId: A.sku_id,
        planGroup: H,
        renderPurchaseConfirmation: (n, r) => ee ? <C.m listing={e} onClose={r} guildId={t} /> : <T.x listing={e} onClose={r} guildId={t} />,
