...
let P = e => {
  ...
  } = (0, h.o)(), E = (0, b.z)(t.id), w = t.id === P, T = !t.available && !t.temporarilyAvailable, N = t.temporarilyAvailable && !n && !w, Z = !w && t.id === C, [A, D] = i.useState(!1);
  i.useEffect(() => {
  ...
  let k = (0, _.J_)({
    ...
    B = x[t.styleKey],
    z = i.useCallback(() => {
      n || !T ? ((0, m.v6)(P === t.id ? null : t.id, l), N && p.default.track(y.rMx.VOICE_FILTER_LIMITED_TIME_VOICE_SELECTED, S({
        voice_filter_id: t.id
      }, (0, g.w)(l)))) : (0, u.i)()
    }, [n, T, P, t.id, l, N]),
    G = i.useCallback(() => {
      p.default.track(y.rMx.VOICE_FILTER_PREVIEW_PLAYED, S({
        voice_filter_id: t.id
      }, (0, g.w)(l))), V({
        volume: .5,
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(c.ua7, {
      ...
      children: e => (0, r.jsx)(c.P3F, I(S({}, e), {
