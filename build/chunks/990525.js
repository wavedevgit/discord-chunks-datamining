...
let y = e => {
  ...
  } = (0, p.o)(), C = (0, f.z)(t.id), x = t.id === y, I = !t.available && !t.temporarilyAvailable, O = t.temporarilyAvailable && !n && !x, E = !x && t.id === j, [N, S] = i.useState(!1);
  i.useEffect(() => {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)(s.P3F, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsxs)("div", {
          className: o()(v.profile, {
            [v.underDevelopment]: t.underDevelopment
          }),
      ...
      children: e => {
        ...
        return (0, r.jsx)(s.P3F, (t = b({}, e), n = n = {
          className: o()([v.hoverButtonCircle, v.previewButton], {
            [v.visible]: L
          }),
          onClick: L ? Z : M,
          "aria-label": h.intl.formatToPlainString(h.t.gDzvjY, {
            voiceFilterName: R
          }),
