...
let I = e => {
  let {
    ...
    activeVoice: I,
    mostRecentlyRequestedVoiceId: O
  } = (0, v.o)(), E = (0, h.z)(t.id), N = t.id === I, S = !t.available && !t.temporarilyAvailable, P = t.temporarilyAvailable && !n && !N, w = !N && t.id === O, [T, L] = i.useState(!1);
  i.useEffect(() => {
  ...
  let k = (0, p.J_)({
    ...
    [A, M] = i.useState(0),
    {
      ...
      stopSound: B,
      preloadSound: z
    } = (0, u.Z)(null != D ? D[A] : null, {
      soundId: t.id
    }),
    U = j[t.styleKey],
    V = i.useCallback(() => {
      n || !S ? ((0, m.v6)(I === t.id ? null : t.id, a), P && _.default.track(b.rMx.VOICE_FILTER_LIMITED_TIME_VOICE_SELECTED, x({
        voice_filter_id: t.id
      }, (0, f.w)(a)))) : (0, d.i)()
    }, [n, S, I, t.id, a, P]),
    W = i.useCallback(() => {
      _.default.track(b.rMx.VOICE_FILTER_PREVIEW_PLAYED, x({
        voice_filter_id: t.id
      }, (0, f.w)(a))), R({
        volume: .5
      }), (.25 > Math.random() || A > 0) && null != D && M(e => (e + 1) % D.length)
    }, [a, R, A, D, t.id]),
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(c.ua7, {
      ...
      children: e => (0, r.jsxs)(c.P3F, C(x({
        className: j.selector
      }, e), {
        onClick: () => {
          var t;
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [(0, r.jsxs)("div", {
            className: o()(j.profile, {
              [j.underDevelopment]: t.underDevelopment
            }),
    ...
    }), null != D && (0, r.jsx)(c.ua7, {
      text: y.intl.string(F ? y.t.ItuPbm : y.t["0gtbEx"]),
      children: e => (0, r.jsx)(c.P3F, C(x({}, e), {
        className: o()([j.hoverButtonCircle, j.previewButton], {
          [j.visible]: F
        }),
        onClick: F ? B : W,
        "aria-label": y.intl.formatToPlainString(y.t.gDzvjY, {
          voiceFilterName: H
        }),
        children: F ? (0, r.jsx)(c.wNq, {
          size: "custom",
          height: 16,
          width: 16,
          color: "white"
