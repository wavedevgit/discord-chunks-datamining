...
let O = e => {
  ...
  } = (0, v.o)(), N = (0, h.z)(t.id), S = t.id === O, P = !t.available && !t.temporarilyAvailable, w = t.temporarilyAvailable && !n && !S, T = !S && t.id === E, [L, k] = i.useState(!1);
  i.useEffect(() => {
  ...
  let Z = (0, p.J_)({
    ...
    [M, F] = i.useState(0),
    {
      ...
      stopSound: z,
      preloadSound: U
    } = (0, u.Z)(null != A ? A[M] : null, {
      soundId: t.id
    }),
    V = x[t.styleKey],
    W = i.useCallback(() => {
      n || !P ? ((0, m.v6)(O === t.id ? null : t.id, a), w && _.default.track(b.rMx.VOICE_FILTER_LIMITED_TIME_VOICE_SELECTED, C({
        voice_filter_id: t.id
      }, (0, f.w)(a)))) : (0, d.i)()
    }, [n, P, O, t.id, a, w]),
    H = i.useCallback(() => {
      _.default.track(b.rMx.VOICE_FILTER_PREVIEW_PLAYED, C({
        voice_filter_id: t.id
      }, (0, f.w)(a))), B({
        volume: .5,
        outputChannel: y.w.VOICE
      }), (.25 > Math.random() || M > 0) && null != A && F(e => (e + 1) % A.length)
    }, [a, B, M, A, t.id]),
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(c.ua7, {
      ...
      children: e => (0, r.jsx)(c.P3F, I(C({}, e), {
        className: o()([x.hoverButtonCircle, x.previewButton], {
          [x.visible]: R
        }),
        onClick: R ? z : H,
