...
function _(e) {
  ...
  let o = null != (t = null == (n = a.default.getCurrentUser()) ? true : n.isStaff()) && t;
  return (0, s.aP)({
...
function m(e, t) {
  return r.Bo.get({
    ...
    if (null != n.body) {
      var r, a, o, s;
      let l = null != (r = null == (s = n.body.tenant_metadata) || null == (o = s.guild_monetization) || null == (a = o.game_server) ? true : a.instructions.pc) ? r : [];
      i.h.dispatch({
