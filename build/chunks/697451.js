...
function W(e, t, n) {
  ...
  return (0, r.jsx)(f.yRy, {
    ...
    children: e => {
      ...
      if (a.type === L.uaV.CHAT_INPUT_COMMAND || a.type === L.uaV.INTERACTION_PREMIUM_UPSELL) return (0, r.jsx)(f.P3F, G(M({}, i), {
        tag: "span",
        onClick: s,
        innerRef: n,
        children: (0, r.jsxs)("div", {
          className: o()(k.appLauncherOnboardingCommandName, k.clickable),
...
function q(e) {
  ...
  let n, {
    ...
    A = i.useRef(null),
    N = i.useRef(null),
    R = i.useMemo(() => (e, t, n) => (l()(null != t, "ExecutedCommand: user cannot be undefined"), l()(null != b, "ExecutedCommand: currentUser cannot be undefined"), l()(null != s, "ExecutedCommand: channel cannot be undefined"), (0, r.jsx)(I.Z, G(M({}, e), {
      user: t,
      currentUser: b,
      guildId: s.guild_id,
      channelId: s.id,
    ...
    L = i.useMemo(() => e => (l()(null != s, "ExecutedCommand: channel cannot be null"), (0, r.jsx)(P.Z, G(M({}, e), {
      channel: s,
      messageId: a.id,
      interactionData: a.interactionData
    }))), [s, a.id, a.interactionData]),
    j = (0, O.t0)(a),
    U = (null == j ? void 0 : j.type) === _.B8.APPLICATION_COMMAND && null != j.target_user ? new T.Z(j.target_user) : null,
    B = (null == j ? void 0 : j.type) === _.B8.APPLICATION_COMMAND && null != a.messageReference && null != e.renderTargetMessage,
    Z = (0, w.Sw)(null == (t = a.interaction) ? void 0 : t.user, s),
    F = (0, w.Sw)(U, s),
  ...
  let $ = () => {
      let t = H(e, q.user, 0, Z, e => R(e, q.user, [g.Z.AVATAR]), A),
        n = Y(e, q.user, 0, Z, e => R(e, q.user));
    ...
    X = () => {
      ...
      let t = H(e, U, 1, F, e => R(e, U, [g.Z.AVATAR]), A),
        n = Y(e, U, 1, F, e => R(e, U));
      return (0, r.jsxs)(i.Fragment, {
        children: [t, n]
      }, "target")
  ...
  if ((null == a ? void 0 : a.activityInstance) === null || (0, v.g)(a)) {
    ...
    n = x.intl.format(x.t["rg7U+P"], {
      ...
      children: [n, (0, r.jsx)(K, {}), (0, r.jsx)(X, {})]
    }))
  } else {
    let e = () => {
        (0, y.Z)({
      ...
      t = () => (0, r.jsx)(f.P3F, {
        ...
        children: (0, r.jsx)("div", {
          className: o()(k.commandName, k.clickable),
  ...
  return (0, r.jsx)(E.Gt, {
    value: c,
    children: (0, r.jsx)("div", {
      className: o()(k.repliedMessage, k.messageSpine, k.executedCommand, V),
