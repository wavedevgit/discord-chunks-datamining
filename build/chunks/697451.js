...
function U(e, t, n, i, l, o) {
  ...
  if (m && null == d.activityInstance || g || _) return (0, r.jsx)("div", {
    ...
    children: (0, r.jsx)(k, {
      className: D.commandIcon
    })
  });
  let y = null != (u = j.ZP.getGuildMemberAvatarURL({
...
function V(e) {
  ...
  let n, {
    ...
    j = (0, d.e7)([I.default], () => I.default.getCurrentUser()),
    P = i.useRef(null),
    k = i.useRef(null),
    V = i.useMemo(() => (e, t, n) => (s()(null != t, "ExecutedCommand: user cannot be undefined"), s()(null != j, "ExecutedCommand: currentUser cannot be undefined"), s()(null != o, "ExecutedCommand: channel cannot be undefined"), (0, r.jsx)(x.Z, M(L({}, e), {
      user: t,
      currentUser: j,
      guildId: o.guild_id,
      channelId: o.id,
    ...
    H = i.useMemo(() => e => (s()(null != o, "ExecutedCommand: channel cannot be null"), (0, r.jsx)(A.Z, M(L({}, e), {
      channel: o,
      messageId: l.id,
      interactionData: l.interactionData
    }))), [o, l.id, l.interactionData]),
    z = (0, v.t0)(l),
    W = (null == z ? void 0 : z.type) === m.B8.APPLICATION_COMMAND && null != z.target_user ? new y.Z(z.target_user) : null,
    K = (null == z ? void 0 : z.type) === m.B8.APPLICATION_COMMAND && null != l.messageReference && null != e.renderTargetMessage,
    Y = (0, N.Sw)(null == (t = l.interaction) ? void 0 : t.user, o),
    X = (0, N.Sw)(W, o),
  ...
  let $ = () => {
    let t = U(e, J.user, 0, Y, e => V(e, J.user, [h.Z.AVATAR]), P),
      n = F(e, J.user, 0, Y, e => V(e, J.user));
    return (0, r.jsxs)(i.Fragment, {
      children: [t, n]
    }, "user")
  };
  if ((null == l ? void 0 : l.activityInstance) === null || (0, O.g)(l)) n = R.intl.format(R.t["rg7U+P"], {
    userHook: $,
    commandHook: () => {
      let t = function(e, t, n) {
        ...
        return (0, r.jsx)(p.yRy, {
          ...
          children: e => {
            ...
            if (l.type === Z.uaV.CHAT_INPUT_COMMAND || l.type === Z.uaV.INTERACTION_PREMIUM_UPSELL) return (0, r.jsx)(p.P3F, M(L({}, i), {
              tag: "span",
              onClick: o,
              innerRef: n,
              children: (0, r.jsxs)("div", {
                className: a()(D.appLauncherOnboardingCommandName, D.clickable),
    ...
    children: [n, (0, r.jsx)(B, {}), (0, r.jsx)(() => {
      ...
      let t = U(e, W, 1, X, e => V(e, W, [h.Z.AVATAR]), P),
        n = F(e, W, 1, X, e => V(e, W));
      return (0, r.jsxs)(i.Fragment, {
        children: [t, n]
      }, "target")
    ...
    n = Q ? R.intl.format(R.t.kfV8WF, {
      ...
      activityHook: () => (0, r.jsx)(p.P3F, {
        ...
        children: (0, r.jsx)("div", {
          className: a()(D.commandName, D.clickable),
  ...
  return (0, r.jsx)(b.Gt, {
    value: c,
    children: (0, r.jsx)("div", {
      className: a()(D.repliedMessage, D.messageSpine, D.executedCommand, q),
