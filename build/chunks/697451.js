...
function H(e) {
  ...
  let n, {
    ...
    j = i.useRef(null),
    P = i.useRef(null),
    k = i.useMemo(() => (e, t, n) => (s()(null != t, "ExecutedCommand: user cannot be undefined"), s()(null != f, "ExecutedCommand: currentUser cannot be undefined"), s()(null != o, "ExecutedCommand: channel cannot be undefined"), (0, r.jsx)(y.Z, M(L({}, e), {
      user: t,
      currentUser: f,
      guildId: o.guild_id,
      channelId: o.id,
