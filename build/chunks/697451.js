...
function U(e, t, n, i, l, o) {
  ...
  let x = null != (u = j.ZP.getGuildMemberAvatarURL({
...
function H(e) {
  ...
  let n, {
    ...
    f = (0, d.e7)([I.default], () => I.default.getCurrentUser()),
    j = i.useRef(null),
    P = i.useRef(null),
    k = i.useMemo(() => (e, t, n) => (s()(null != t, "ExecutedCommand: user cannot be undefined"), s()(null != f, "ExecutedCommand: currentUser cannot be undefined"), s()(null != o, "ExecutedCommand: channel cannot be undefined"), (0, r.jsx)(v.Z, M(L({}, e), {
      user: t,
      currentUser: f,
      guildId: o.guild_id,
      channelId: o.id,
    ...
    V = (0, O.t0)(l),
    z = (null == V ? void 0 : V.type) === m.B8.APPLICATION_COMMAND && null != V.target_user ? new x.Z(V.target_user) : null,
  ...
  let J = () => {
    let t = U(e, Q.user, 0, K, e => k(e, Q.user, [b.Z.AVATAR]), j),
      n = F(e, Q.user, 0, K, e => k(e, Q.user));
    return (0, r.jsxs)(i.Fragment, {
      children: [t, n]
    }, "user")
  };
  if ((null == l ? void 0 : l.activityInstance) === null || (0, y.g)(l)) n = R.intl.format(R.t["rg7U+P"], {
    userHook: J,
    commandHook: () => {
    ...
    children: [n, (0, r.jsx)(B, {}), (0, r.jsx)(() => {
      ...
      let t = U(e, z, 1, Y, e => k(e, z, [b.Z.AVATAR]), j),
        n = F(e, z, 1, Y, e => k(e, z));
      return (0, r.jsxs)(i.Fragment, {
        children: [t, n]
      }, "target")
  ...
  return (0, r.jsx)(E.Gt, {
    value: c,
    children: (0, r.jsx)("div", {
      className: a()(D.repliedMessage, D.messageSpine, D.executedCommand, X),
