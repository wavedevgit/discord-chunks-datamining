...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk618896 = require("./618896.js"),
  Chunk231338 = require("./231338.js"),
  Chunk388032 = require("./388032.js"),
  Chunk916396 = require("./916396.js");
...
let R = Chunk73800.memo(function(e) {
    let {
      ...
      chatOpen: n
    } = e, i = <g.ZP.Icon icon={u.Dio} tooltip={Z.intl.string(Z.t.cpT0Cg)} onClick={t} />;
    return <g.ZP toolbar={i} className={a()(P.headerContainer, {
        [P.chatOpen]: n
      })}>{<g.ZP.Icon icon={u.V9} disabled={true} aria-label={Z.intl.string(Z.t.TYZgzc)} />}{<g.ZP.Title>{Z.intl.string(Z.t.TYZgzc)}</g.ZP.Title>}</g.ZP>
  }),
  w = Chunk73800.memo(function(e) {
    ...
    return <div className={P.participantRowContainer}>{<b.Z targetElementRef={g} user={a.user} guildId={l.guild_id} channelId={l.id} position={"left"} spacing={16} clickTrap={true}>{e => {
          var t;
        ...
        }}</b.Z>}{<div className={P.buttonContainer}>{<u.ua7 text={D ? Z.intl.string(Z.t.h9rsTU) : Z.intl.string(Z.t.f0T7hI)}>{e => (0, r.jsx)("div", N(T({}, e), {
          ...
          }))}</u.ua7>}{<u.ua7 text={Z.intl.string(Z.t.moABMz)}>{e => (0, r.jsx)("div", N(T({}, e), {
            children: (0, r.jsx)(u.hU, {
  ...
  A = Chunk73800.memo(function(e) {
    ...
    return <u.j7V className={P.toggle} onChange={i} value={n}>{Z.intl.string(Z.t.GYCh0d)}</u.j7V>
  }),
  D = Chunk73800.memo(function() {
    return <div className={Chunk916396.emptyStateContainer}>{<Chunk618896.Z />}{<Chunk481060.Text className={Chunk916396.emptyStateTitle} variant={"text-lg/semibold"} color={"header-primary"}>{Chunk388032.intl.string(Chunk388032.t["7R24mZ"])}</Chunk481060.Text>}{<Chunk481060.Text className={Chunk916396.emptyStateBody} variant={"text-sm/normal"} color={"header-secondary"}>{Chunk388032.intl.string(Chunk388032.t.Rpr2s7)}</Chunk481060.Text>}</div>
  });
...
function k(e) {
  ...
  return <div className={a()(P.container, {
      [P.chatOpen]: i
    })}>{<R toggleRequestToSpeakSidebar={n} chatOpen={i} />}{<u.aVo className={P.contentContainer} sections={s} sectionHeight={function(e) {
        return 40 * (1 === e)
