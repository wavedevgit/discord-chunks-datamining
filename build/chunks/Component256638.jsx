...
let eA = e => {
    ...
    let {
      error: n,
      allowClick: i = false
    } = e, a = null == (t = (0, x.hp)(n)) ? true : t.errorCode, o = ey.intl.formatToPlainString(ey.t["ejOT9/"], {
      errorCode: a
    }), s = (0, r.jsx)(c.Text, {
...
let ex = Chunk647438.memo(function() {
  var e, t;
  ...
  if (null != ex) return (0, Chunk951288.jsx)(Chunk749277.A, {
    dismissibleContent: ex,
    noticeType: Chunk100527.type
  });
  let eL = null == (e = Chunk100527.metadata) ? true : module.premiumType;
  switch (Chunk100527.type) {
    ...
    case Chunk981631.kVF.PREMIUM_UNCANCEL:
      return (0, Chunk951288.jsxs)(Chunk481060.qXd, {
        color: eL === Chunk474936.p9.TIER_1 ? Chunk481060.DM8.PREMIUM_TIER_1 : eL === Chunk474936.p9.TIER_0 ? Chunk481060.DM8.PREMIUM_TIER_0 : Chunk481060.DM8.PREMIUM_TIER_2,
        children: [(0, Chunk951288.jsx)(Chunk481060.RyX, {
          ...
          color: "currentColor",
          className: Chunk522488.premiumIcon
        }), eL === Chunk474936.p9.TIER_1 ? Chunk388032.intl.formatToPlainString(Chunk388032.t.fXv4ws, {
          daysLeft: Chunk100527.metadata.daysLeft
        }) : eL === Chunk474936.p9.TIER_0 ? Chunk388032.intl.formatToPlainString(Chunk388032.t.ZOHZMj, {
          daysLeft: Chunk100527.metadata.daysLeft
          ...
          children: eL === Chunk474936.p9.TIER_1 ? Chunk388032.intl.string(Chunk388032.t.BkbUPD) : eL === Chunk474936.p9.TIER_0 ? Chunk388032.intl.string(Chunk388032.t.Px978f) : Chunk388032.intl.string(Chunk388032.t.LW5tCA)
        })]
      });
    ...
    case Chunk981631.kVF.PREMIUM_MISSING_PAYMENT:
      return (0, Chunk951288.jsxs)(Chunk481060.qXd, {
        ...
        children: [(0, Chunk951288.jsx)(Chunk481060.RyX, {
        ...
        }), eL === Chunk474936.p9.TIER_1 ? Chunk388032.intl.formatToPlainString(Chunk388032.t.b6QUvb, {
          daysLeft: Chunk100527.metadata.daysLeft
        }) : eL === Chunk474936.p9.TIER_0 ? Chunk388032.intl.formatToPlainString(Chunk388032.t["tURZ/P"], {
          daysLeft: Chunk100527.metadata.daysLeft
          ...
          children: eL === Chunk474936.p9.TIER_1 ? Chunk388032.intl.string(Chunk388032.t.lboF5O) : eL === Chunk474936.p9.TIER_0 ? Chunk388032.intl.string(Chunk388032.t["4UPwOj"]) : Chunk388032.intl.string(Chunk388032.t["P/VvGR"])
        })]
      });
