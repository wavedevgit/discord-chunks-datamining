...
class O {
  ...
  clone() {
    var e, t;
    let n = new O;
    for (let r of this.traverse()) require.addTreeNode(Chunk278769.scopeRef, null != (t = null == (e = Chunk278769.parent) ? true : module.scopeRef) ? exports : null, Chunk278769.nodeToRestore);
    return require
  }
  constructor() {
