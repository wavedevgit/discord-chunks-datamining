...
let y = new Set(["978380692553465866", "1024422698568122368", "511651871736201216", "511651876987469824", "511651880837840896", "642251038925127690", "944037208325619722", "511651885459963904", "1432523012455792640", "511651856145973248", "511651860671627264"]),
  O = new Set(["511651880837840896", "642251038925127690", "944037208325619722", "511651885459963904"]),
  A = new Set(["590665532894740483", "944037355453415424", "944037391444738048", "590665538238152709"]),
...
let w = Object.freeze({
    3: Chunk985018.t["t9uG/o"],
    1: Chunk985018.t.FSOz78,
    2: Chunk985018.t.lG6a5x
  }),
  P = Object.freeze({
    "628379151761408000": {
  ...
  ec = [Z, Q, $, J, ee, et, en, er, ei, ea, es, eo, el],
  eu = [ei, ea, eo],
  ed = [ei, eo],
...
let eR = Object.freeze({
  ...
  ek = {
    [Chunk652215.TVA.NONE]: eM[Chunk652215.TVA.NONE],
    [Chunk652215.TVA.TIER_1]: eM[Chunk652215.TVA.NONE] + eM[Chunk652215.TVA.TIER_1],
    [Chunk652215.TVA.TIER_2]: eM[Chunk652215.TVA.NONE] + eM[Chunk652215.TVA.TIER_1] + eM[Chunk652215.TVA.TIER_2],
    [Chunk652215.TVA.TIER_3]: eM[Chunk652215.TVA.NONE] + eM[Chunk652215.TVA.TIER_1] + eM[Chunk652215.TVA.TIER_2] + eM[Chunk652215.TVA.TIER_3]
  },
  eU = {
    [Chunk652215.TVA.NONE]: eS,
    [Chunk652215.TVA.TIER_1]: 24,
  ...
  eG = Object.freeze({
    [Chunk652215.TVA.NONE]: {
      features: [],
      limits: {
        emoji: Chunk307731.Xn,
        bitrate: Chunk652215.DqD,
        fileSize: Chunk652215.TbF,
        screenShareQualityFramerate: 30,
        screenShareQualityResolution: "720p",
        soundboardSounds: eU[Chunk652215.TVA.NONE],
        stickers: ek[Chunk652215.TVA.NONE],
        stageVideoUsers: Chunk652215._i_
      }
    },
    [Chunk652215.TVA.TIER_1]: {
      features: [Chunk652215.GuildFeatures.INVITE_SPLASH, Chunk652215.GuildFeatures.ANIMATED_ICON],
      limits: {
        emoji: 100,
        bitrate: 128e3,
        fileSize: Chunk652215.TbF,
        ...
        screenShareQualityResolution: "720p",
        soundboardSounds: eU[Chunk652215.TVA.TIER_1],
        stickers: ek[Chunk652215.TVA.TIER_1],
        stageVideoUsers: Chunk652215._i_
      }
    },
    [Chunk652215.TVA.TIER_2]: {
      features: [Chunk652215.GuildFeatures.INVITE_SPLASH, Chunk652215.GuildFeatures.ANIMATED_ICON, Chunk652215.GuildFeatures.BANNER, Chunk652215.GuildFeatures.ROLE_ICONS],
      limits: {
        emoji: 150,
        bitrate: 256e3,
        fileSize: ex,
        ...
        soundboardSounds: eU[Chunk652215.TVA.TIER_2],
        stickers: ek[Chunk652215.TVA.TIER_2],
        stageVideoUsers: Chunk652215.nyz
      }
    },
    [Chunk652215.TVA.TIER_3]: {
      features: [Chunk652215.GuildFeatures.INVITE_SPLASH, Chunk652215.GuildFeatures.ANIMATED_ICON, Chunk652215.GuildFeatures.BANNER, Chunk652215.GuildFeatures.ANIMATED_BANNER, Chunk652215.GuildFeatures.VANITY_URL, Chunk652215.GuildFeatures.ROLE_ICONS],
      limits: {
        emoji: 250,
        bitrate: 384e3,
        fileSize: eL,
        screenShareQualityFramerate: 60,
        screenShareQualityResolution: "1080p",
        soundboardSounds: eU[Chunk652215.TVA.TIER_3],
        stickers: ek[Chunk652215.TVA.TIER_3],
        stageVideoUsers: Chunk652215.uaN
      }
    }
  }),
...
let e9 = ["premium_tenure_1_month_v2", "premium_tenure_3_month_v2", "premium_tenure_6_month_v2", "premium_tenure_12_month_v2", "premium_tenure_24_month_v2", "premium_tenure_36_month_v2", "premium_tenure_60_month_v2", "premium_tenure_72_month_v2"],
  te = {
    premium_tenure_1_month_v2: {
      ...
      nameUnformatted: Chunk985018.t.LR1C0a,
      nameUnformattedNitro: Chunk985018.t.tx9Fvw,
    ...
    premium_tenure_3_month_v2: {
      ...
      nameUnformatted: Chunk985018.t["rI1/3H"],
      nameUnformattedNitro: Chunk985018.t.xJNb5C,
    ...
    premium_tenure_6_month_v2: {
      ...
      nameUnformatted: Chunk985018.t.VkhVKS,
      nameUnformattedNitro: Chunk985018.t["4scBFY"],
    ...
    premium_tenure_12_month_v2: {
      ...
      nameUnformatted: Chunk985018.t.gzUfNS,
      nameUnformattedNitro: Chunk985018.t["83Jw2B"],
    ...
    premium_tenure_24_month_v2: {
      ...
      nameUnformatted: Chunk985018.t.fuwTPm,
      nameUnformattedNitro: Chunk985018.t.vRSCKv,
    ...
    premium_tenure_36_month_v2: {
      ...
      nameUnformatted: Chunk985018.t.qNhNk4,
      nameUnformattedNitro: Chunk985018.t.mV86tk,
    ...
    premium_tenure_60_month_v2: {
      ...
      nameUnformatted: Chunk985018.t["wvX+eD"],
      nameUnformattedNitro: Chunk985018.t.WcsLxW,
    ...
    premium_tenure_72_month_v2: {
      ...
      nameUnformatted: Chunk985018.t["/menIw"],
      nameUnformattedNitro: Chunk985018.t["Z/qgMK"],
...
let tr = {
  [Chunk334279.j.PREMIUM_TIER_2_1_HOUR]: [1, 1],
  [Chunk334279.j.PREMIUM_TIER_2_1_DAY]: [2, 1],
  [Chunk334279.j.PREMIUM_TIER_2_3_DAY]: [2, 3]
}