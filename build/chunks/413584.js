...
let G = "WELCOME_CHANNEL",
  ...
  B = e => {
    ...
    } = (0, u.e7)([N.Z], () => N.Z.getSettingsProps()), c = (0, u.e7)([x.Z], () => x.Z.useReducedMotion), [d, p] = i.useState(null), [h, b] = i.useState(!1), [j, v] = i.useState(!1), {
      description: I,
      channels: E,
      enabled: P
    } = a, G = () => {
    ...
    return null == t ? null : (0, r.jsxs)(g.hjN, {
      ...
      children: [(0, r.jsx)("div", {
        ...
        onToggle: P || (null == E ? void 0 : E.length) !== 0 ? () => {
          F(!P)
        } : void 0,
        animateStatus: j,
        ...
        children: [(0, r.jsxs)("div", {
          ...
          }), null == E ? void 0 : E.map((e, n) => (0, r.jsx)(U, {
            guildId: t.id,
            welcomeChannel: e,
            onEdit: z(n),
            onChannelReorder: W,
