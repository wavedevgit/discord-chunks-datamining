...
class I extends(r = a.PureComponent) {
  ...
  getPosition(e) {
    ...
    } = this.props, u = Math.round(n), f = Math.round(s - i - this._boundHeight), _ = Math.round(r), p = Math.round(o - a - this._boundWidth);
    if (null != l) {
      var h, m, g;
      return {
...
let T = e => {
    ...
    } = e, [v, T] = a.useState(!1), S = a.useMemo(() => null == t ? null : n.map(e => {
    ...
    }), [n, t, r, p]), A = a.useCallback(() => {
      T(!0)
    }, []), N = a.useCallback(() => {
      T(!1)
    }, []), C = a.useMemo(() => n.some(e => e.component === d.NYg.ACTIVITY), [n]), R = a.useMemo(() => n.some(e => e.component === d.NYg.FRAME), [n]);
