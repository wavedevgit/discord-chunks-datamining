...
class T extends(r = o.PureComponent) {
  ...
  getPosition(e) {
    ...
    } = this.props, u = Math.round(n), d = Math.round(s - i - this._boundHeight), _ = Math.round(r), p = Math.round(a - o - this._boundWidth);
    if (null != l) {
      var h, m, g;
      return {
...
let S = e => {
    ...
    } = e, [I, S] = o.useState(!1), A = o.useMemo(() => null == t ? null : n.map(e => {
