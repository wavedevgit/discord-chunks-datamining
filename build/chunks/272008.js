...
async function N(e) {
  ...
  try {
    ...
    if (null != n.quest_user_status) a.Z.dispatch({
      ...
      errorHints: n.error_hints_v2.slice(0, A)
    }
  } catch (r) {
    var n;
    let e = new o.Z(r);
...
async function P() {
  if (!p.Z.isFetchingCurrentQuests) {
    ...
    }), _.Z.recordQuestRequestAttempt(y.ANM.QUESTS_CURRENT_QUESTS);
    try {
      ...
      }), _.Z.recordQuestRequestApiResponse(y.ANM.QUESTS_CURRENT_QUESTS, {
        wasSuccessful: !0
      })
    } catch (e) {
      a.Z.dispatch({
...
async function H(e) {
  ...
  try {
    ...
    a.Z.dispatch({
      ...
      placement: e
    }), _.Z.recordQuestRequestApiResponse("/quests/decision", {
      wasSuccessful: !0
    }), u.default.track(y.rMx.QUEST_DECISION_RECEIVED, S(I({}, (0, c.Z)()), {
      quest_id: g.quest.id
    }))
  } catch (t) {
    _.Z.recordQuestRequestApiResponse("/quests/decision", {
      wasSuccessful: !1
    }), u.default.track(y.rMx.QUEST_DECISION_ROUNDTRIP_ERROR, S(I({}, (0, c.Z)()), {
...
async function W(e, t) {
  ...
  if (null == n) return void g.ZP.getState().setTranscriptAsset({
    questId: e.id,
