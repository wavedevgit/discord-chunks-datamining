...
async function S(e) {
  ...
  try {
    ...
    if (null != n.quest_user_status) a.Z.dispatch({
      ...
      errorHints: n.error_hints_v2.slice(0, I)
    }
  } catch (r) {
    var n;
    let e = new s.Z(r);
...
async function N() {
  if (!_.Z.isFetchingCurrentQuests) {
    ...
    }), f.Z.recordQuestRequestAttempt(b.ANM.QUESTS_CURRENT_QUESTS);
    try {
      ...
      }), f.Z.recordQuestRequestApiResponse(b.ANM.QUESTS_CURRENT_QUESTS, {
        wasSuccessful: !0
      })
    } catch (e) {
      a.Z.dispatch({
...
async function P(e, t) {
  if (null != t.questContentCTA && (0, d._3)({
      questId: e,
  ...
  if (!_.Z.isClaimingReward(e)) {
    ...
    try {
      let r = await o.tn.post({
        ...
        i = (0, h.Xh)(r.body);
      return 0 === i.errors.length ? a.Z.dispatch({
...
async function Z(e) {
  ...
  if (null == t) return void m.ZP.getState().setTranscriptAsset({
    questId: e.id,
