...
async function P() {
  if (!p.Z.isFetchingCurrentQuests) {
    ...
    }), f.Z.recordQuestRequestAttempt(y.ANM.QUESTS_CURRENT_QUESTS);
    try {
      ...
      }), f.Z.recordQuestRequestApiResponse(y.ANM.QUESTS_CURRENT_QUESTS, {
        wasSuccessful: !0
      })
    } catch (e) {
      a.Z.dispatch({
...
async function H(e) {
  ...
  try {
    ...
    a.Z.dispatch({
      ...
      placement: e
    }), f.Z.recordQuestRequestApiResponse("/quests/decision", {
      wasSuccessful: !0
