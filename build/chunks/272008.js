...
async function A() {
  if (!f.Z.isFetchingCurrentQuests) {
    ...
    }), d.Z.recordQuestRequestAttempt(E.ANM.QUESTS_CURRENT_QUESTS);
    try {
      ...
      }), d.Z.recordQuestRequestApiResponse(E.ANM.QUESTS_CURRENT_QUESTS, {
        wasSuccessful: !0
      })
    } catch (e) {
      a.Z.dispatch({
...
async function B(e) {
  ...
  try {
    ...
    let o = await (0, l.Gg)(),
      f = await (0, s.Gy)(),
      _ = (await i.tn.get({
        url: E.ANM.QUEST_FETCH_QUEST_TO_DELIVER(e, null == o ? void 0 : o.uuid, f.uuid),
        rejectWithError: !1
      })).body;
    a.Z.dispatch({
...
async function V(e, t) {
  ...
  if (null == n) return void h.ZP.getState().setTranscriptAsset({
    questId: e.id,
