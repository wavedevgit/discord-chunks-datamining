...
function T(e) {
  ...
  let {
    ...
    selectedGiftStyle: x,
    giftRecipient: M
  } = (0, m.wD)(), k = L && (0, h.pO)(M) && A === E.h8.CONFIRM && null != x && (null == P ? void 0 : P.productLine) !== b.POd.COLLECTIBLES, j = null != n && null != A, U = [E.h8.SKU_SELECT, E.h8.SELECT_FREE_SKU], G = null != A && !U.includes(A) && null != S, B = (0, d.N)(o), Z = !L && null != B && null != S && y.nG[B.trial_id].skus.includes(S), F = (0, u.Ng)(), V = null == F || null == (t = F.discount) ? void 0 : t.plan_ids.some(e => y.GP[e].skuId === S), H = !L && null != F && null != S && V, {
    enabled: Y
  } = c.ZP.useExperiment({
