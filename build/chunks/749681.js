    ...
    switch (d.Z.setState({
      ...
      case u.GlobalDiscoveryTab.APPS:
        ...
        if (null != t.query) {
          ...
          return "" !== t.query && e.set("q", t.query), null != t.categoryId && e.set("category_id", t.categoryId.toString()), null != t.page && e.set("page", t.page.toString()), (0, s.uL)(m.Z5c.GLOBAL_DISCOVERY_APPS_SEARCH, {
            search: e.toString()
          })
        }
...
}), a(65234), a(111804), a(490233), a(97749), a(388685), a(415506);
var n = a(258971),
  r = a(726115),
  l = a(859921),
  i = a(341907),
