...
function y(e) {
  let {
    ...
    (0, s.h7j)(e => {
      ...
      return <m.SubscriptionDetailsModal appId={o.applicationId} subscriptionType={(0, c.KW)(o.flags) ? "user" : "guild"} onClose={t} skuId={o.id} transitionState={n} guildId={null} />
    })
    ...
    (0, s.h7j)(e => {
      ...
      return <h.ItemDetailsModal appId={o.applicationId} skuId={o.id} onClose={t} transitionState={n} />
    })
  }, [o]);
