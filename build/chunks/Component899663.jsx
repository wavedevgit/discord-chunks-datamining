...
function m(e) {
  ...
  let {
    target: n
  } = e, r = null == (t = (0, a.uB)(e)) ? true : t.activeElement;
  (0, a.kK)(n) && c.default.track(f.rMx.KEYBOARD_SHORTCUT_USED, {
...
function h(e) {
  ...
  return i.useEffect(() => ((0, o.waitForAllDefaultIntlMessagesLoaded)().then(() => (0, d.d1)()), _.intl.onLocaleChange(() => (0, d.d1)()), window.addEventListener("keydown", m), () => window.removeEventListener("keydown", m)), []), (0, r.jsx)(l.Sfi.Provider, {
    value: g,
    children: t
  })
}