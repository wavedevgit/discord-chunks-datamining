...
let N = () => {
  ...
  return <Chunk852860.Z errorMessage={require} onSave={() => {
    ...
    }} submitting={exports === Chunk981631.QZA.SUBMITTING} onReset={Chunk764260.S1} />
};
...
function I(e) {
  ...
  }, [p]), null != p) ? <j.Z editRoleId={p} setEditRoleId={C} selectedSection={N} setSelectedSection={I} /> : h ? <_.Z setEditRoleId={C} guild={n} everyoneRole={c} otherRoles={g} setSelectedSection={I} refToScroller={t} /> : <v.Z guild={n} everyoneRole={c} setEditRoleId={C} />
}