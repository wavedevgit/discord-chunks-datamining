...
function g(e) {
  ...
  return <a.yRy targetElementRef={m} animation={a.yRy.Animation.NONE} position={"bottom"} align={"right"} autoInvert={false} shouldShow={n} onRequestClose={y} renderPopout={function() {
