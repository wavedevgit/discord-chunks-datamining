/** Chunk was on web.js **/
/** chunk id: 708816, original params: e,t,n (module,exports,re quire) **/
"use strict";
let r;
require.d(exports, {
  Jc: () => j,
...
class A {
  ...
  getBorderRadius(e) {
    ...
    let c = null != (n = S(null == (t = e.styles[0]) ? true : t.borderTopLeftRadius)) ? n : "0",
      ...
      d = null != (a = S(null == (o = e.styles[0]) ? true : o.borderBottomRightRadius)) ? a : "0",
...
let C = Chunk73800.createContext(N);
...
function k() {
  ...
  return Chunk73800.useEffect(() => (module.invalidate = () => exports({}), () => {
    module.invalidate = () => null
  }), [module]), M.ringsEnabled && module.visible ? (0, Chunk255367.jsx)("div", {
    className: d("focus-rings-ring", module.className),
    style: module.getStyle()
  }) : null
}
let U = "u" > typeof window && (null == (i = window.document) ? true : i.createElement) != null ? Chunk73800.useLayoutEffect : Chunk73800.useEffect;
