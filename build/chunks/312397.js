...
let Q = () => {
  ...
  }, [e, s, a, t.features]), m = i.useCallback(() => {
...
class $ extends i.PureComponent {
      ...
      children: [(0, r.jsxs)(_.Z, {
        ...
        children: [(0, r.jsxs)(_.Z.Child, {
          ...
          children: [(0, r.jsx)(I.Z, {
            ...
            makeURL: t => T.ZP.getGuildIconURL({
              id: e.id,
              icon: t,
              canAnimate: !0,
              size: 100
            ...
            imageClassName: s()(Y.avatarUploaderInner, {
  ...
  renderJoinNotificationSection() {
    ...
    return (0, r.jsxs)(g.hjN, {
      ...
      children: [(0, r.jsx)(g.vwX, {
        children: W.intl.string(W.t.NASFnp)
      }), (0, r.jsx)(U.u, {
        canManageGuild: t,
        guildId: e.id,
        systemChannelId: e.systemChannelId
  ...
  renderNotificationSection() {
    ...
    return (0, r.jsx)("div", {
      ...
      children: (0, r.jsxs)(g.hjN, {
        className: Y.divider,
        children: [(0, r.jsx)(g.vwX, {
          children: W.intl.string(W.t["23TVho"])
        }), (0, r.jsx)(g.R94, {
          type: g.geA.DESCRIPTION,
          className: Y.marginBottom20,
  ...
  renderActivityFeedSection() {
    ...
    return void 0 === t ? null : (0, r.jsx)("div", {
      ...
      children: (0, r.jsxs)(g.hjN, {
        className: Y.divider,
        children: [(0, r.jsx)(g.vwX, {
          children: W.intl.string(W.t["oQ/7BQ"])
        }), (0, r.jsx)(g.j7V, {
    ...
    return (0, h.Jc)(e, !1) ? (0, r.jsx)("div", {
      children: (0, r.jsx)(g.hjN, {
        ...
        children: (0, r.jsx)(g.j7V, {
          ...
          hideBorder: !0,
          note: W.intl.format(W.t["c6Cy/v"], {
            helpdeskArticle: w.Z.getArticleURL(H.BhN.CONVERSATION_SUMMARIES)
          }),
          disabled: !t,
          children: (0, r.jsxs)("div", {
            className: Y.badgedItem,
            children: [W.intl.string(W.t.vmEDQk), (0, r.jsx)(g.IGR, {
          ...
          children: [(0, r.jsxs)(_.Z.Child, {
            ...
            children: [(0, r.jsxs)(g.vwX, {
              ...
              children: [(0, r.jsx)("div", {
                children: W.intl.string(W.t.tzGY0t)
              }), (0, r.jsx)(k.hH, {
                guild: e
              })]
            }), (0, r.jsx)(g.R94, {
              ...
              type: g.geA.DESCRIPTION,
              children: W.intl.format(W.t.ZYA9PT, {
                articleURL: w.Z.getArticleURL(H.BhN.GUILD_INVITE_SPLASH)
              })
            }), (0, r.jsx)(L.c, {
              guild: e,
              canManageGuild: t,
      ...
      children: (0, r.jsxs)(_.Z, {
        ...
        children: [(0, r.jsxs)(_.Z.Child, {
          ...
          children: [(0, r.jsxs)(g.vwX, {
            className: Y.flexFormTitle,
            children: [(0, r.jsx)("div", {
              children: W.intl.string(W.t["0r0AzM"])
            }), (0, r.jsx)(k.zA, {
              guild: e
            })]
          }), (0, r.jsx)(g.R94, {
            ...
            type: g.geA.DESCRIPTION,
            children: W.intl.format(W.t.vBcWUl, {
              articleURL: w.Z.getArticleURL(H.BhN.GUILD_BANNER_SPLASH)
            })
          }), (0, r.jsx)(D.F, {
            guild: e,
            canManageGuild: t,
  ...
  renderProfileVisibilitySection() {
    ...
    return (0, r.jsxs)(g.hjN, {
      className: Y.divider,
      children: [(0, r.jsx)(g.vwX, {
        children: W.intl.string(W.t.txdaxc)
      }), (0, r.jsx)(g.j7V, {
        className: Y.marginBottom0,
  ...
  constructor(...e) {
    super(...e), q(this, "_displaySectionRef", i.createRef()), q(this, "_inviteSectionRef", i.createRef()), q(this, "_notificationSectionRef", i.createRef()), q(this, "handleIconChange", e => {
      ...
      e ? n.add(H.oNc.SUMMARIES_ENABLED_BY_USER) : n.delete(H.oNc.SUMMARIES_ENABLED_BY_USER), R.Z.updateGuild({
        features: n
      })
      ...
      e ? (n.add(H.oNc.ACTIVITY_FEED_ENABLED_BY_USER), n.delete(H.oNc.ACTIVITY_FEED_DISABLED_BY_USER)) : (n.add(H.oNc.ACTIVITY_FEED_DISABLED_BY_USER), n.delete(H.oNc.ACTIVITY_FEED_ENABLED_BY_USER)), R.Z.updateGuild({
        features: n
      })
...
function ee() {
  ...
  let {
    ...
    fetchGuildProfile: _
  } = (0, O.u)(null == e ? void 0 : e.id);
  return (i.useEffect(() => {
    null != h && _()
  }, [h, _]), o()(null != p, "GuildSettingsOverview: currentUser cannot be undefined"), null == e) ? null : (0, r.jsx)(b.Gt, {
    value: c,
    children: (0, r.jsx)($, {
      canManageGuild: u,
      isGuildAdmin: m,
