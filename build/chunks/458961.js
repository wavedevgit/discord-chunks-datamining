...
function _(e) {
  ...
  let {
    ...
    application: ei
  } = (0, h.Z)(_, R.wW.GUILD_ROLE_SUBSCRIPTIONS), eo = I.M["0"], es = (0, c.e7)([p.Z], () => p.Z.useReducedMotion), ec = x.QK.useSetting(), ed = (0, V.n)(), eu = r.useCallback(() => {
    var e;
  ...
  } = (0, P.P)(), eX = (null == ea ? void 0 : ea.attachments) != null && (null == ea ? void 0 : ea.attachments.length) > 0, ez = null != eT ? eT : eV, eS = null != eF && "published" in eF, eQ = null != eF && !eS, ew = null != (q = null == ea ? void 0 : ea.role_id) ? q : null, [eR, eL] = r.useState(), ek = null != eR || null != ew, eB = (0, c.e7)([j.Z], () => null != ew && null !== eR ? j.Z.getRole(_, ew) : null != eR ? eR : void 0, [eR, ew, _]), eD = "";
