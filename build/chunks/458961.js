...
function J(e) {
  let {
    ...
    priceTiers: l
  } = (0, b.R)(t, w.RG5.GUILD_PRODUCTS), i = r.useMemo(() => (null != l ? l : null != A ? [A] : []).map(e => ({
    value: e,
...
function _(e) {
  ...
  let {
    ...
    transitionState: et,
    onClose: eA
  } = e, [en, er] = r.useState(ee), ea = (0, c.e7)([y.Z], () => null == en ? null : y.Z.getGuildProduct(en), [en]), el = (null == ea ? void 0 : ea.published) === !0, {
    application: ei
  } = (0, h.Z)(_, k.wW.GUILD_ROLE_SUBSCRIPTIONS), eo = I.M["0"], es = (0, c.e7)([p.Z], () => p.Z.useReducedMotion), ec = x.QK.useSetting(), ed = (0, V.n)(), eu = r.useCallback(() => {
    var e;
  ...
  let [eg, ep] = r.useState(null != (l = null == ea ? void 0 : ea.name) ? l : ""), [eh, em] = r.useState(null != (i = null == ea ? void 0 : ea.description) ? i : ""), [eb, ev] = r.useState(null != (m = null == ea ? void 0 : ea.price_tier) ? m : void 0), [eC, eq] = r.useState(eu), [ex, ej] = r.useState(null != (b = null == ea || null == (t = ea.image_asset) ? void 0 : t.filename) ? b : eo.name), [eU, eO] = r.useState(!1), [eV, eP] = r.useState(), ey = r.useMemo(() => null != eb ? (0, U.T4)(eb, w.pKx.USD) : void 0, [eb]), [eN, eI] = r.useState(!0), {
    changesSaving: eF,
    saveError: eT,
    saveProductWithAttachments: eK,
    hasUnsavedAttachmentChanges: eZ,
    cancelUnusedUploads: eW
  } = (0, P.P)(), eX = (null == ea ? void 0 : ea.attachments) != null && (null == ea ? void 0 : ea.attachments.length) > 0, ez = null != eT ? eT : eV, eS = null != eF && "published" in eF, eQ = null != eF && !eS, ew = null != (q = null == ea ? void 0 : ea.role_id) ? q : null, [ek, eR] = r.useState(), eL = null != ek || null != ew, eB = (0, c.e7)([j.Z], () => null != ew && null !== ek ? j.Z.getRole(_, ew) : null != ek ? ek : void 0, [ek, ew, _]), eD = "";
  ...
  let eE = () => {
    ...
    e0 = r.useMemo(() => eM || null == eG || "publish" === eG || null != ez ? null : (0, n.jsx)(u.oXn, {
      ...
      children: [(0, n.jsx)(u.zJl, {
        ...
        children: (0, n.jsxs)("div", {
          ...
          children: [(0, n.jsx)(z.Z, {
            ...
            published: el,
            onClick: () => {
              o()(e$, "Attempting to publish/unpublish when not allowed"), eY(el ? "unpublish" : "publish"), e3(D(B({}, eH), {
                published: !el
              }))
            },
            submitting: eS
