...
function $(e) {
  ...
  let {
    ...
    transitionState: eA,
    onClose: en
  } = e, [er, el] = r.useState(et), ea = (0, d.e7)([N.Z], () => null == er ? null : N.Z.getGuildProduct(er), [er]), eo = (null == ea ? void 0 : ea.published) === !0, {
    application: ei
  ...
  let [ep, em] = r.useState(null != (a = null == ea ? void 0 : ea.name) ? a : ""), [eh, eC] = r.useState(null != (o = null == ea ? void 0 : ea.description) ? o : ""), [eq, eb] = r.useState(null != (C = null == ea ? void 0 : ea.price_tier) ? C : void 0), [ev, ex] = r.useState(ef), [ej, eU] = r.useState(null != (q = null == ea || null == (t = ea.image_asset) ? void 0 : t.filename) ? q : es.name), [eV, eP] = r.useState(!1), [eO, eI] = r.useState(), eN = r.useMemo(() => null != eq ? (0, V.T4)(eq, w.pKx.USD) : void 0, [eq]), [eF, ey] = r.useState(!0), {
    changesSaving: eK,
    saveError: eT,
    saveProductWithAttachments: eZ,
    hasUnsavedAttachmentChanges: eX,
    cancelUnusedUploads: eW
  } = (0, I.P)(), ez = (null == ea ? void 0 : ea.attachments) != null && (null == ea ? void 0 : ea.attachments.length) > 0, eQ = null != eT ? eT : eO, eS = null != eK && "published" in eK, eR = null != eK && !eS, ew = null != (x = null == ea ? void 0 : ea.role_id) ? x : null, [eB, eL] = r.useState(), ek = null != eB || null != ew, eG = (0, d.e7)([U.Z], () => null != ew && null !== eB ? U.Z.getRole($, ew) : null != eB ? eB : void 0, [eB, ew, $]), eE = "";
