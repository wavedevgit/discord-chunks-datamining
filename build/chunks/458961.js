...
function H(e) {
  let {
    ...
    disabled: a,
    warning: o
  } = e, A = (0, m.Dt)(), s = a ? "text-muted" : "text-normal";
...
function J(e) {
  let {
    ...
    priceTiers: l
  } = (0, b.R)(t, k.RG5.GUILD_PRODUCTS), o = i.useMemo(() => (null != l ? l : null != r ? [r] : []).map(e => ({
    value: e,
...
function _(e) {
  ...
  let {
    ...
    transitionState: et,
    onClose: er
  } = e, [en, ei] = i.useState(ee), ea = (0, c.e7)([V.Z], () => null == en ? null : V.Z.getGuildProduct(en), [en]), el = (null == ea ? void 0 : ea.published) === !0, {
    application: eo
  } = (0, p.Z)(_, R.wW.GUILD_ROLE_SUBSCRIPTIONS), eA = I.M["0"], es = (0, c.e7)([h.Z], () => h.Z.useReducedMotion), ec = q.QK.useSetting(), ed = (0, y.n)(), eu = i.useCallback(() => {
    var e;
  ...
  let [eg, eh] = i.useState(null != (l = null == ea ? void 0 : ea.name) ? l : ""), [ep, em] = i.useState(null != (o = null == ea ? void 0 : ea.description) ? o : ""), [eb, ev] = i.useState(null != (m = null == ea ? void 0 : ea.price_tier) ? m : void 0), [eC, ex] = i.useState(eu), [eq, ej] = i.useState(null != (b = null == ea || null == (t = ea.image_asset) ? void 0 : t.filename) ? b : eA.name), [eO, eP] = i.useState(!1), [ey, eU] = i.useState(), eV = i.useMemo(() => null != eb ? (0, O.T4)(eb, k.pKx.USD) : void 0, [eb]), [eN, eI] = i.useState(!0), {
    changesSaving: eT,
    saveError: eF,
    saveProductWithAttachments: eZ,
    hasUnsavedAttachmentChanges: eS,
    cancelUnusedUploads: eK
  } = (0, U.P)(), ew = (null == ea ? void 0 : ea.attachments) != null && (null == ea ? void 0 : ea.attachments.length) > 0, ez = null != eF ? eF : ey, eW = null != eT && "published" in eT, eX = null != eT && !eW, ek = null != (x = null == ea ? void 0 : ea.role_id) ? x : null, [eR, eQ] = i.useState(), eB = null != eR || null != ek, eE = (0, c.e7)([j.Z], () => null != ek && null !== eR ? j.Z.getRole(_, ek) : null != eR ? eR : void 0, [eR, ek, _]), eL = "";
  ...
  let eD = () => {
    ...
    e0 = i.useMemo(() => eM || null == eG || "publish" === eG || null != ez ? null : (0, n.jsx)(u.oXn, {
      ...
      children: [(0, n.jsx)(u.zJl, {
        ...
        children: (0, n.jsxs)("div", {
          ...
          children: [(0, n.jsx)(z.Z, {
            ...
            published: el,
            onClick: () => {
              A()(e$, "Attempting to publish/unpublish when not allowed"), eY(el ? "unpublish" : "publish"), e3(L(E({}, eH), {
                published: !el
              }))
            },
            submitting: eW
      ...
      children: (0, n.jsxs)("div", {
        ...
        children: [(0, n.jsxs)("div", {
          ...
          children: [(0, n.jsx)(H, {
            ...
            value: eN,
            onChange: e => {
              e ? eI(!0) : eS ? (0, u.ZDy)(async () => {
                let {
                  ConfirmModal: e
                } = await Promise.resolve().then(r.bind(r, 481060));
                return t => (0, n.jsx)(e, L(E({}, t), {
