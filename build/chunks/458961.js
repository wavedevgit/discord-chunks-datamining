...
function J(e) {
  let {
    ...
    priceTiers: l
  } = (0, b.R)(t, k.RG5.GUILD_PRODUCTS), o = A.useMemo(() => (null != l ? l : null != n ? [n] : []).map(e => ({
    value: e,
...
function _(e) {
  ...
  let {
    ...
    transitionState: et,
    onClose: en
  } = e, [er, eA] = A.useState(ee), ea = (0, c.e7)([y.Z], () => null == er ? null : y.Z.getGuildProduct(er), [er]), el = (null == ea ? void 0 : ea.published) === !0, {
    application: eo
  } = (0, m.Z)(_, Q.wW.GUILD_ROLE_SUBSCRIPTIONS), ei = I.M["0"], es = (0, c.e7)([p.Z], () => p.Z.useReducedMotion), ec = x.QK.useSetting(), ed = (0, P.n)(), eu = A.useCallback(() => {
    var e;
  ...
  let [ef, ep] = A.useState(null != (l = null == ea ? void 0 : ea.name) ? l : ""), [em, eh] = A.useState(null != (o = null == ea ? void 0 : ea.description) ? o : ""), [eb, ev] = A.useState(null != (h = null == ea ? void 0 : ea.price_tier) ? h : void 0), [eC, eq] = A.useState(eu), [ex, ej] = A.useState(null != (b = null == ea || null == (t = ea.image_asset) ? void 0 : t.filename) ? b : ei.name), [eO, eU] = A.useState(!1), [eP, eV] = A.useState(), ey = A.useMemo(() => null != eb ? (0, O.T4)(eb, k.pKx.USD) : void 0, [eb]), [eN, eI] = A.useState(!0), {
    changesSaving: eT,
    saveError: eF,
    saveProductWithAttachments: eZ,
    hasUnsavedAttachmentChanges: eK,
    cancelUnusedUploads: eW
  } = (0, V.P)(), ez = (null == ea ? void 0 : ea.attachments) != null && (null == ea ? void 0 : ea.attachments.length) > 0, eX = null != eF ? eF : eP, eS = null != eT && "published" in eT, ew = null != eT && !eS, ek = null != (q = null == ea ? void 0 : ea.role_id) ? q : null, [eQ, eR] = A.useState(), eB = null != eQ || null != ek, eL = (0, c.e7)([j.Z], () => null != ek && null !== eQ ? j.Z.getRole(_, ek) : null != eQ ? eQ : void 0, [eQ, ek, _]), eD = "";
  ...
  let eE = () => {
    ...
    e0 = A.useMemo(() => eM || null == eG || "publish" === eG || null != eX ? null : (0, r.jsx)(u.oXn, {
      ...
      children: [(0, r.jsx)(u.zJl, {
        ...
        children: (0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(X.Z, {
            ...
            published: el,
            onClick: () => {
              i()(e$, "Attempting to publish/unpublish when not allowed"), eY(el ? "unpublish" : "publish"), e3(D(L({}, eH), {
                published: !el
              }))
            },
            submitting: eS
