...
function x(e) {
  let {
    onComplete: t,
    onClose: n
  } = e, [o, x] = a.useState(null), [N, C] = a.useState(null), [E, j] = a.useState(!1), T = (0, i.e7)([_.default], () => _.default.getCurrentUser()), I = a.useRef(null);
  async function g(e) {
  ...
  return null == T ? null : (0, s.jsxs)("form", {
    className: h.content,
    onSubmit: g,
    children: [(0, s.jsx)(c.gw7, {
      size: "custom",
      width: 56,
      height: 40,
      className: h.logo,
