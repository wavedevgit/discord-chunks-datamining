...
function N(e) {
  let {
    onComplete: t,
    onClose: n
  } = e, [o, N] = a.useState(null), [C, E] = a.useState(null), [j, T] = a.useState(!1), v = (0, i.e7)([p.default], () => p.default.getCurrentUser()), I = a.useRef(null);
  async function g(e) {
  ...
  return null == v ? null : (0, s.jsxs)("form", {
    className: x.content,
    onSubmit: g,
    children: [(0, s.jsx)(d.gw7, {
      size: "custom",
      width: 56,
      height: 40,
      className: x.logo,
