...
function N(e) {
  let {
    onComplete: t,
    onClose: n
  } = e, [a, N] = o.useState(null), [y, v] = o.useState(null), [j, E] = o.useState(!1), C = (0, i.e7)([_.default], () => _.default.getCurrentUser()), T = o.useRef(null);
  async function g(e) {
    ...
    try {
      ...
      if (null != e.body && null != e.body.date_of_birth) d.wE(m.L0.NEW_USER_FLOW), d.hp(m.L0.NEW_USER_FLOW), n();
        ...
        var r;
        (null == e || null == (r = e.body) ? void 0 : r.username) != null ? v(h.intl.string(h.t["TGg/2t"])) : v(null == e ? void 0 : e.body.message)
      }
    }
    E(!1)
  }
