...
let R = Chunk647438.memo(e => {
  let {
    ...
    forceShadow: h,
    cardType: b
  } = e, y = null == e ? true : e.onCtaClick, T = (0, c.e7)([d.Z], () => d.Z.useReducedMotion), [C, w] = i.useState(false), [D, L] = i.useState(false), x = b === E.gM.CARD_CAROUSEL_FIRST_ROW || b === E.gM.CARD_CAROUSEL_SECOND_ROW || b === E.gM.CARD_CAROUSEL_THIRD_ROW, M = (0, g.Z)(), [k, j] = (0, _.cv)(null != a && n ? [a] : []), {
    easterEggLevel: U,
  ...
  let Y = k !== a || null == a || D,
    W = e => {
      C && "transform" === e.propertyName && e.target.classList.contains(S.flipCard) && (L(true), p.default.track(O.rMx.PREMIUM_MARKETING_PERK_CARD_FLIPPED, {
        card_type: t
      }), null != a && j(v.L.TAKE_ACTION))
    };
  return (i.useEffect(() => {
    T && C && (L(true), p.default.track(O.rMx.PREMIUM_MARKETING_PERK_CARD_FLIPPED, {
      card_type: t
    }), null != a && j(v.L.TAKE_ACTION))
  }, [T, C, a, t, j]), (0, f.Z)({
    ...
    children: (0, r.jsx)("div", {
      className: o()({
        [S.noFlipCardContainer]: !x,
        [S.noFlipCardContainerCarousel]: x,
        [S.forceShadow]: h,
        [S.reducedMotion]: T
      }),
