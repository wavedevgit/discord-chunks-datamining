...
function k(e) {
  ...
  let [U, z] = o.useState(null), [H, W] = o.useState(null), [J, Y] = o.useState(!1), V = (0, l.e7)([N.Z], () => N.Z.getType() === I.M5.INVITE_UNCLAIMED), K = o.useCallback(e => {
    W(e), M(g.F.CREATION_INTENT), x.default.track(v.rMx.GUILD_TEMPLATE_SELECTED, {
