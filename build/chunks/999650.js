...
function q(e, t) {
  ...
  switch (a) {
    case y.aib.GUILD:
      n = m.ZP.queryGuildUsers(S(I({}, o), {
        guildId: t
      }));
      break;
    case y.aib.CHANNEL:
      n = m.ZP.queryChannelUsers(S(I({}, o), {
        channelId: t
      }));
      break;
    case y.aib.DMS:
...
function er(e) {
  ...
  return o()(et).keys().filter(e => y.TNx.test(e)).filter(e => null != et[e].key).map(e => ({
    token: e,
    text: et[e].key
  })).filter(t => {
    let {
