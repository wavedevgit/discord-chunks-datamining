...
function ee(e, t) {
  ...
  switch (a) {
    case S.aib.GUILD:
      n = y.ZP.queryGuildUsers(P(C({}, o), {
        guildId: t
      }));
      break;
    case S.aib.CHANNEL:
      n = y.ZP.queryChannelUsers(P(C({}, o), {
        channelId: t
      }));
      break;
    case S.aib.DMS:
...
function en(e, t, n) {
  ...
  return o()(r.concat(i)).sort(c.qU).map(e => {
    let {
      record: t,
      comparator: n
    } = e;
...
function eu(e) {
  ...
  return o()(el).keys().filter(e => S.TNx.test(e)).filter(e => null != el[e].key).map(e => ({
    token: e,
    text: el[e].key
  })).filter(t => {
    let {
