...
n.d(t, {
  ...
  ZP: () => er,
  nB: () => en
}), n(388685), n(413496), n(433524), n(35282), n(781311), n(704826), n(290780);
var r = n(658722),
  i = n.n(r),
  a = n(392711),
  o = n.n(a),
...
function z(e, t) {
  ...
  switch (a) {
    case b.aib.GUILD:
      n = m.ZP.queryGuildUsers(S(O({}, o), {
        guildId: t
      }));
      break;
    case b.aib.CHANNEL:
      n = m.ZP.queryChannelUsers(S(O({}, o), {
        channelId: t
      }));
      break;
    case b.aib.DMS:
...
function en(e) {
  ...
  return o()(ee).keys().filter(e => b.TNx.test(e)).filter(e => null != ee[e].key).map(e => ({
    token: e,
    text: ee[e].key
  })).filter(t => {
    let {
