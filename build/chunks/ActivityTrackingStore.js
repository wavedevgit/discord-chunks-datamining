...
function j(e) {
  ...
  null == d && (d = T[e.applicationId] = new s.Xp).start(I, () => j(e)), t || (C[e.applicationId] = e, o.K.set(v, C))
}
...
function x() {
  ...
  for (let {
    ...
    null != exports && (require.add(exports.id), exports.id in C || j({
  ...
  for (let t of Object.keys(C)) require.has(exports) || P(C[exports], module)
}
