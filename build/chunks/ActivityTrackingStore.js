...
let y = "ActivityTrackingStore",
  ...
  C = null != (r = Chunk433517.K.get(y)) ? r : {},
  T = {},
  N = false;
...
function j(e) {
  ...
  null != n && (n.stop(), delete T[e.applicationId]), delete C[e.applicationId], o.K.set(y, C)
}
...
function P(e) {
  ...
  null == d && (d = T[e.applicationId] = new s.Xp).start(I, () => P(e)), t || (C[e.applicationId] = e, o.K.set(y, C))
}
...
class Z extends(i = Chunk442837.ZP.Store) {
  ...
  ACTIVITY_UPDATE_FAIL: function(e) {
    ...
    n.token = null, n.updatedAt = null, o.K.set(y, C)
  }
})