...
let b = function(e) {
  let {
    channel: t
  } = e, n = (0, o.$5)(t), [b, _] = i.useState(false), y = (0, l.e7)([d.ZP], () => d.ZP.hasUnreadPins(t.id), [t]), v = (0, c.Aq)(), j = i.useRef(null), x = i.useCallback(() => {
    n || _(e => !e)
  }, [n]);

  function O(e) {
    (null == e ? true : e.shiftKey) || v.dispatch(h.CkL.POPOUT_CLOSE)
  }
