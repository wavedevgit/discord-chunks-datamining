...
let b = {
  ...
  m = Chunk64700.createContext(null);
class S extends(s = Chunk64700.PureComponent) {
  renderContent() {
    var e, t;
    let n = this.props,
      {
...
function I(e) {
  ...
  return null == i ? null : (0, r.jsx)("div", {
    className: a()(y.toolsContainer, {
      ...
      [y.closeIconOnly]: !n,
      [y.isMobileAndroid]: !n && true === (0, f.isAndroidWeb)()
    }),
    ref: s,
