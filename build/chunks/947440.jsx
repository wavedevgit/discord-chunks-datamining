...
function M(t, e) {
  ...
  return null == X || X.forEach(i => {
    ...
    null != i.launchId && !l && o && null != d && td.push(<a.sNh id={"invite-to-join-embedded"} label={J.intl.string(J.t["3fRyS0"])} subtext={d.name} action={() => {
        tl((0, w.p)(i.location), i.applicationId)
      }} />)
  }), q.forEach((t, i) => {
    (null == e ? true : e.id) !== v.default.getId() && (t.type === F.IIU.PLAYING && (0, D.Z)(t, F.xjy.JOIN) ? td.push(<a.sNh id={"invite-to-join"} label={J.intl.string(J.t["3fRyS0"])} subtext={t.name} action={() => tn(F.mFx.JOIN, t)} />) : t.type === F.IIU.LISTENING && (0, D.Z)(t, F.xjy.SYNC) && td.push(<a.sNh id={"invite-to-listen"} label={J.intl.string(J.t["5vvGpa"])} subtext={t.name} action={() => tn(F.mFx.LISTEN, t)} />))
  }), td.length > 0 && td.push(<a.Clw />), $.forEach((i, l) => {
    ...
    if (i.type === F.IIU.PLAYING && (0, D.Z)(i, F.xjy.JOIN) && (!o || d) && null != i.session_id && null != i.application_id)
      if (tt[l]) {
        let t = B[l];
        td.push(<a.sNh id={"join"} label={t ? J.intl.string(J.t.bf6Ci4) : J.intl.string(J.t.VJlc0d)} disabled={t} hint={t ? (0, n.jsx)(a.$jN, {
            type: a.$jN.Type.PULSING_ELLIPSIS
          }) : null} subtext={i.name} action={() => ta(i)} />)
      } else td.push(<a.sNh id={"ask-to-join"} label={J.intl.string(J.t.OKsSCQ)} subtext={i.name} action={() => tn(F.mFx.JOIN_REQUEST, i)} />);
      ...
      td.push(<a.sNh id={"spotify-play-".concat(i.session_id)} action={() => (0, y.Z)(o, R.kG.USER_ACTIVITY_PLAY)} label={(0, p.Z)(o, R.kG.USER_ACTIVITY_PLAY)} subtext={d ? (0, I.Z)(o, R.kG.USER_ACTIVITY_PLAY, null != t ? C.ZP.getNickname(t.guild_id, t.id, e) : true) : true} disabled={d} />, <a.sNh id={"spotify-sync-".concat(i.session_id)} action={() => (0, f.Z)(o, R.kG.USER_ACTIVITY_SYNC)} label={J.intl.string(J.t.gXYoq6)} subtext={r ? (0, I.Z)(o, R.kG.USER_ACTIVITY_SYNC, null != t ? C.ZP.getNickname(t.guild_id, t.id, e) : true) : true} disabled={r} />)
    }
  }), z.forEach((t, e) => {
    var i;
    ...
    tt[o] && null != c && td.push(<a.sNh id={"embedded-activity-join-".concat(t.applicationId)} label={r} disabled={d} hint={B[o] ? (0, n.jsx)(a.$jN, {
        type: a.$jN.Type.PULSING_ELLIPSIS
      }) : null} subtext={c.name} action={() => to(t)} />)
  }), td
}