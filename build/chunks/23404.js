...
function A(e) {
  ...
  let {
    quest: n
  } = e, i = (0, p.B6)(n.config.expiresAt), l = (0, p.B6)(_.r.build(n.config).rewardsExpireAt), a = (0, o.e7)([c.Z], () => c.Z.getState().theme), u = (0, s.wjy)(a) ? N.BRd.DARK : N.BRd.LIGHT, d = (null == (t = n.userStatus) ? void 0 : t.completedAt) != null;
  return (0, r.jsxs)("div", {
    className: P.heading,
...
function Z(e) {
  ...
  let {
    ...
    questContent: f.jn.ACTIVITY_PANEL,
    sourceQuestContent: f.jn.ACTIVITY_PANEL
  }), V = (0, p.tP)(_), H = (null == (t = _.userStatus) ? void 0 : t.enrolledAt) != null, F = (null == (n = _.userStatus) ? void 0 : n.completedAt) != null, z = (null == (l = _.userStatus) ? void 0 : l.claimedAt) != null, W = (null == _ ? void 0 : _.userStatus) != null && (0, g.zE)(_.userStatus, f.jn.ACTIVITY_PANEL), Y = (0, p.Rf)(_), K = (0, m.DD)({
    quest: _,
    taskDetails: Y,
