...
function A(e) {
  ...
  let {
    quest: n
  } = e, i = (0, h.B6)(n.config.expiresAt), l = (0, h.B6)(O.r.build(n.config).rewardsExpireAt), a = (0, o.e7)([u.Z], () => u.Z.getState().theme), s = (0, c.wjy)(a) ? T.BRd.DARK : T.BRd.LIGHT, d = (null == (t = n.userStatus) ? void 0 : t.completedAt) != null;
  return (0, r.jsxs)("div", {
    className: j.heading,
...
function Z(e) {
  ...
  let {
    nodeRef: _,
    quest: O
  } = e, E = (0, d.O5)(), T = (0, o.e7)([f.Z], () => f.Z.isEnrolling(O.id), [O]), Z = (0, o.e7)([f.Z], () => null != f.Z.questEnrollmentBlockedUntil, []), [w, L] = i.useState(!1), R = i.useCallback(() => L(!0), []), D = i.useCallback(() => L(!1), []), k = i.useCallback(e => {
    e.stopPropagation()
  }, []), M = i.useCallback(() => {
    (0, p.AH)(O.id, {
    ...
    questContent: g.jn.ACTIVITY_PANEL,
    sourceQuestContent: g.jn.ACTIVITY_PANEL
  }), V = (0, h.tP)(O), H = (null == (t = O.userStatus) ? void 0 : t.enrolledAt) != null, F = (null == (n = O.userStatus) ? void 0 : n.completedAt) != null, z = (null == (l = O.userStatus) ? void 0 : l.claimedAt) != null, W = (null == O ? void 0 : O.userStatus) != null && (0, m.zE)(O.userStatus, g.jn.ACTIVITY_PANEL), Y = (0, h.Rf)(O), K = (0, b.DD)({
    quest: O,
    taskDetails: Y,
