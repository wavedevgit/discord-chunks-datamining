...
function _(e) {
  ...
  return (0, r.jsxs)("div", {
    className: a()(x.verifiedRow, (null == s ? void 0 : s.hasMetadata) === !0 || (null == d ? void 0 : d.role_connections_metadata) != null && (null == d ? void 0 : d.role_connections_metadata.length) > 0 ? x.verifiedRowWithMetadata : null),
    children: [i, (0, r.jsx)(u.Text, {
      variant: "text-md/medium",
      className: x.verifiedText,
      children: b.intl.format(b.t.Nj0a3t, {
        platformName: null != (n = null == s ? void 0 : s.name) ? n : null == d || null == (t = d.application) ? void 0 : t.name
      })
    }), (0, r.jsx)(u.ua7, {
...
function y(e) {
  ...
  let {
    ...
    locked: h,
    operator: j
  } = e, v = (null == c ? void 0 : c.configuration) != null, _ = null != (n = null == c ? void 0 : c.index) ? n : -1, [O, y] = function(e, t) {
  ...
  }(null == c || null == (t = c.configuration) ? void 0 : t.value, j), [C, N] = i.useState(O), I = null != s ? b.intl.format(s, {
    count: C,
    metadataHook: () => C
  }) : (0, r.jsx)("span", {
