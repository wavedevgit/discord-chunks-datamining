...
function j(e) {
  ...
  if ((null == m ? void 0 : m.application) != null) o()(null != m.application.bot, "bot is null"), i = (0, r.jsx)(u.Z, {
    ...
    i = (0, r.jsx)("img", {
      className: b.verifiedIcon,
      src: e,
      alt: h.NW.formatToPlainString(h.t.rtm15O, {
        name: l.name
      })
    })
  }
  return (0, r.jsxs)("div", {
    ...
    children: [i, (0, r.jsx)(d.Text, {
      ...
      children: h.NW.format(h.t.Nj0a3t, {
        platformName: null != (n = null == l ? void 0 : l.name) ? n : null == m || null == (t = m.application) ? void 0 : t.name
      })
    }), (0, r.jsx)(d.zxk, {
...
function N(e) {
  ...
  let {
    ...
    metadataField: g,
    operator: p
  } = e, x = null != (n = null == l ? void 0 : l.index) ? n : -1, j = null != p ? p : f.iO.GREATER_THAN, N = Math.round(Number(null != (s = null == l || null == (t = l.configuration) ? void 0 : t.value) ? s : 0));
    ...
    onChange: e => {
      if (null != l) {
        if ("" !== e) {
          ...
          j === f.iO.GREATER_THAN ? n = Math.max(0, n - 1) : j === f.iO.LESS_THAN && (n = Math.max(1, n + 1)), c({
    ...
    children: [(0, r.jsxs)("div", {
      ...
      onChange: e => {
        ...
        if (e) {
          ...
          e === f.iO.GREATER_THAN ? r = Math.max(0, r - 1) : e === f.iO.LESS_THAN && (r = Math.max(1, r + 1)), i = {
...
function y(e) {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(_, {
      ...
      titleText: h.NW.formatToPlainString(h.t.j1Gf2t, {
        gameName: h.NW.string(h.t.HKUEZm)
      }),
      ...
      titleText: h.NW.formatToPlainString(h.t.j1Gf2t, {
        gameName: h.NW.string(h.t.C8p1Sk)
      }),
