...
function p(e, t) {
  switch (t.type) {
    ...
    case "set_source_type":
      if (t.sourceType === i.vA.CAMERA && e.preset === d.tI.PRESET_DOCUMENTS) return m(f({}, e), {
...
function v(e) {
  ...
  let {
    ...
    fps: d,
    soundshareEnabled: x
  } = (0, s.cj)([c.Z], () => c.Z.getState()), g = null !== (t = a.I0.useSetting()) && void 0 !== t && t, _ = null !== (n = a.eo.useSetting()) && void 0 !== n && n, [v, j] = l.useReducer(p, m(f({}, h), {
    muteStreamAudio: !x,
    preset: r,
    resolution: i,
    fps: d,
