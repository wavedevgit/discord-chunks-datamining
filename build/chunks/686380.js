...
class Z extends i.Component {
  getTitleText() {
    ...
    if (this.recipientHasNitro && void 0 === this.trialOffer.redeemed_at) return L.intl.formatToPlainString(L.t.Mptau7, {
      username: t
    });
    if (this.offerExpired) return this.isSender ? L.intl.string(L.t["9SNdf3"]) : L.intl.formatToPlainString(L.t["H0+MxM"], {
      userName: r
    });
    switch (N.Z.getCurrentConfig({
        location: "renderTitle"
      }, {
        autoTrackExposure: !1
      }).treatmentGroup) {
      case 1:
        return L.intl.formatToPlainString(L.t["L/leCw"], {
          receiver: t
        });
      case 2:
        return L.intl.formatToPlainString(L.t.febG6u, {
          receiver: t
        });
      case 3:
      ...
      case 4:
        return L.intl.formatToPlainString(L.t.PVQOi4, {
          receiver: t
        });
      default:
  ...
  getBodyText() {
    if (this.recipientHasNitro && !this.isSender && void 0 === this.trialOffer.redeemed_at) return L.intl.format(L.t.LwCwT0, {
    ...
    switch (N.Z.getCurrentConfig({
      ...
      case 1:
        return L.intl.format(L.t.Ylrdnp, {
          sender: t
        });
      case 2:
        return L.intl.format(L.t["8XzXzc"], {
          sender: t
        });
      case 3:
  ...
  renderActions() {
    let e = N.Z.getCurrentConfig({
        location: "renderActions"
      }, {
        autoTrackExposure: !1
      }),
      t = this.currentUser.id !== this.trialOffer.user_id || (0, T.I5)(this.currentUser) || !this.currentUser.verified || (0, P.B)(this.trialOffer),
    ...
    return (0, r.jsxs)("div", {
      ...
      }), 4 !== e.treatmentGroup && (0, r.jsx)("div", {
  ...
  renderExpirationDate() {
    ...
    if (void 0 !== e.redeemed_at && !this.isSender && null !== t) return L.intl.formatToPlainString(L.t.nP0ivb, {
      date: (0, O.vc)(l()(t), "LL")
    });
    if (this.recipientHasNitro || void 0 === e.expires_at) return null;
    let n = l()(e.expires_at);
    return this.offerExpired ? L.intl.formatToPlainString(L.t.PuSHfX, {
      date: (0, O.vc)(l()(n), "LL")
    }) : (0, C.F6)(n.valueOf())
  }
  renderMedia() {
    return (0, r.jsx)("div", {
      className: x.referral
    })
  }
  ...
  constructor(e) {
    super(e), j(this, "trialOffer", void 0), j(this, "currentUser", void 0), j(this, "recipientHasNitro", void 0), j(this, "trialEndsAt", void 0), j(this, "analyticsLocations", void 0), j(this, "offerExpired", void 0), j(this, "isSender", void 0), j(this, "dmRefreshXPCohort", void 0), this.trialOffer = e.trialOffer, this.currentUser = e.currentUser, this.recipientHasNitro = e.recipientHasNitro, this.trialEndsAt = e.trialEndsAt, this.analyticsLocations = e.analyticsLocations, this.dmRefreshXPCohort = e.dmRefreshXPCohort, this.offerExpired = (0, P.B)(this.trialOffer), this.isSender = this.currentUser.id === this.trialOffer.referrer_id
  }
}
...
function F(e) {
  ...
  }), [n, t]), a = E.default.getCurrentUser(), s = (0, u.e7)([E.default], () => null != i && (0, T.I5)(void 0 !== a && i.user_id === a.id ? a : E.default.getUser(i.user_id))), l = (0, u.e7)([b.Z], () => {
    var e;
