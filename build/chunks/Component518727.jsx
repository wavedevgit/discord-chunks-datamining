...
let I = 1e3,
  T = e => {
    ...
    if ((0, i.useEffect)(() => {
        let e;
        j && n && !Y && "none" === V && (o || !M ? (H("static"), o || (W(true), _.default.track(b.rMx.PREMIUM_BRAND_REFRESH_WOW_MOMENT_ASSETS_NOT_LOADED_ON_CONFIRMATION)), e = false) : (H("animated"), F(true), e = true), c.Z.dispatch({
