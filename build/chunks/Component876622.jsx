...
function h(e) {
  let {
    ...
    return t === r
  }), [r, n]), [o, h] = a.useState(false), m = function(e) {
    let {
      selected: t,
      isHovered: n
    } = e;
    ...
    selected: s,
    isHovered: o
  }), f = a.useCallback(() => h(true), []), g = a.useCallback(() => h(false), []), x = a.useRef(null);
  return (0, l.jsx)(c.YNO, {
    ...
    children: (e, t) => {
      ...
      return (0, l.jsx)(c.VQ0.Item, (n = function(e) {
...
function m(e) {
  let {
  ...
  } = e, [m, b] = a.useState(0), f = a.useRef(m), {
    lastVisibleIndex: g,
    onItemLayout: x,
    overflowItemsRef: v,
    itemWidthsRef: j
    ...
    maxLines: 1,
    containerWidth: m
  }), A = a.useMemo(() => r.slice(0, g + 1), [g, r]), _ = a.useMemo(() => r.slice(g + 1), [g, r]), y = a.useRef(null), O = a.useCallback(e => {
  ...
  return (0, l.jsxs)("div", {
    ...
    children: [(0, l.jsxs)("div", {
      ...
      onItemSelect: d,
      className: p.vR,
      children: [A.map(e => (0, l.jsx)(c.VQ0.Item, {
        id: e.id,
        look: "brand",
        "aria-label": e.label,
        className: p.Mf,
        children: e.label
      }, e.id)), 0 !== _.length ? (0, l.jsx)(h, {
        tabs: _,
        onTabSelect: d,
        selectedTab: n
      }) : null]
