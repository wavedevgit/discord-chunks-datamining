...
let R = e => {
  ...
  V = (0, u.Z)(e => {
    let {
      ...
      look: W = c.zx.Looks.OUTLINED,
      type: Y,
      onAction: B
    } = e, G = (0, s.e7)([v.default], () => {
      let e = v.default.getCurrentUser();
      return o()(null != e, "UserActivityActions: currentUser cannot be undefined"), e
    }), H = Y === S.Y.STREAM_PREVIEW || null != a, z = (0, O.Z)(t), J = z || H ? p.Z.Direction.HORIZONTAL : p.Z.Direction.VERTICAL, X = (null == t ? void 0 : t.type) === D.IIU.HANG_STATUS, q = (0, s.e7)([h.Z, _.Z], () => {
      var e;
    ...
    return (0, r.jsx)(p.Z, {
      ...
      children: (() => {
        ...
        if ((null == t ? void 0 : t.platform) === D.M7m.PS4 || (null == t ? void 0 : t.platform) === D.M7m.PS5) return (0, r.jsx)(x.Z, {
          look: W,
          color: F,
        ...
        return H ? (0, r.jsx)(A.Z, {
          isCurrentUser: G.id === i.id,
          color: F,
          look: W,
          applicationStream: a,
          onAction: B
        }, "watch-button") : X && null != q ? (0, r.jsx)(C.Z, {
          color: F,
          look: W,
          hangStatusChannel: q,
          onAction: B
