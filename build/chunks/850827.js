...
let k = e => {
  ...
  M = (0, u.Z)(e => {
    ...
    }), F = R === j.Y.STREAM_PREVIEW || null != o, B = (0, v.Z)(t), G = B || F ? f.Z.Direction.HORIZONTAL : f.Z.Direction.VERTICAL;
    if ((null == t ? void 0 : t.application_id) === A.bO) {
      ...
      }, Object.getOwnPropertyDescriptors ? Object.defineProperties(z, Object.getOwnPropertyDescriptors(J)) : (function(e, t) {
        var n = Object.keys(e);
    ...
    return (0, r.jsx)(f.Z, {
      ...
      children: (() => {
        ...
        if ((null == t ? void 0 : t.platform) === C.M7m.PS4 || (null == t ? void 0 : t.platform) === C.M7m.PS5) return (0, r.jsx)(S.Z, {
          look: U,
          color: L,
