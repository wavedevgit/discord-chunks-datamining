...
function O(e) {
  let {
    onActivate: t
  } = e, [n, O] = i.useState(false), v = (0, l.e7)([d.Z], () => d.Z.getGuildId()), j = (0, l.e7)([u.Z], () => u.Z.hasFetchedRequestToJoinGuilds), C = (0, f.Z)(), E = (0, a.Z)(v), x = i.useMemo(() => {
    let e = (0, h.qQ)({
  ...
  return (i.useEffect(() => {
    !n && S && E !== v && O(true)
  }, [n, S, E, v]), 0 === C.length) ? null : (0, r.jsx)(y, {
    onActivate: t,
