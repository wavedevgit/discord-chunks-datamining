...
function _(e) {
  let {
    onActivate: t
  } = e, [n, _] = i.useState(false), v = (0, l.e7)([d.Z], () => d.Z.getGuildId()), j = (0, l.e7)([u.Z], () => u.Z.hasFetchedRequestToJoinGuilds), x = (0, f.Z)(), C = (0, a.Z)(v), S = i.useMemo(() => {
    let e = (0, h.qQ)({
  ...
  let E = null != v && x.includes(v);
  return (i.useEffect(() => {
    !n && E && C !== v && _(true)
  }, [n, E, C, v]), 0 === x.length) ? null : (0, r.jsx)(y, {
    onActivate: t,
