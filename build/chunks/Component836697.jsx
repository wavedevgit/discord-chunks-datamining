...
function y(e) {
  let {
    onActivate: t
  } = e, [n, y] = i.useState(false), j = (0, l.e7)([d.Z], () => d.Z.getGuildId()), v = (0, l.e7)([u.Z], () => u.Z.hasFetchedRequestToJoinGuilds), C = (0, h.Z)(), x = (0, a.Z)(j), E = i.useMemo(() => {
    let e = (0, f.qQ)({
  ...
  return (i.useEffect(() => {
    !n && S && x !== j && y(true)
  }, [n, S, x, j]), 0 === C.length) ? null : (0, r.jsx)(O, {
    onActivate: t,
