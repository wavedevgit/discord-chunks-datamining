...
function y(e) {
  let {
    onActivate: t
  } = e, [n, y] = i.useState(false), v = (0, l.e7)([d.Z], () => d.Z.getGuildId()), j = (0, l.e7)([u.Z], () => u.Z.hasFetchedRequestToJoinGuilds), C = (0, h.Z)(), x = (0, a.Z)(v), E = i.useMemo(() => {
    let e = (0, f.qQ)({
  ...
  return (i.useEffect(() => {
    !n && S && x !== v && y(true)
  }, [n, S, x, v]), 0 === C.length) ? null : (0, r.jsx)(_, {
    onActivate: t,
