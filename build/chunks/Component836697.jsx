...
function y(e) {
  let {
    onActivate: t
  } = e, [n, y] = i.useState(false), j = (0, l.e7)([d.Z], () => d.Z.getGuildId()), v = (0, l.e7)([u.Z], () => u.Z.hasFetchedRequestToJoinGuilds), x = (0, h.Z)(), C = (0, a.Z)(j), E = i.useMemo(() => {
    let e = (0, f.qQ)({
  ...
  return (i.useEffect(() => {
    !n && S && C !== j && y(true)
  }, [n, S, C, j]), 0 === x.length) ? null : (0, r.jsx)(O, {
    onActivate: t,
