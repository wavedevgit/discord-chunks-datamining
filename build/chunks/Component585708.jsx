...
function _(e, t, n, _) {
  ...
  return {
    ...
    onNotificationClick: () => {
      ...
      }, true, true, t.id), m.Z.isInputLocked(n) ? (N("unlock"), r.Z.setInputLocked(false, n)) : (N("jump"), (0, s.uL)(E.Z5c.CHANNEL(e.guild_id, e.id, t.id)), d.isPlatformEmbedded && h.ZP.focus())
    },
    onDismissClick: () => {
      N("dismiss")
    }
