...
function P(e) {
  ...
  return (0, i.jsxs)(o.P3F, {
    className: l()(a, I.backgroundOption, {
...
function D(e) {
  ...
  function Z() {
    null != j && P && (h.Kw(j), b.default.track(C.rMx.PREMIUM_UPSELL_VIEWED, {
      type: T.cd.ANIMATED_VIDEO_BACKGROUND_NEW_PRESET,
      location: S.location,
      location_stack: v
    }))
  }
  return (0, i.jsxs)(o.P3F, A(y({}, O), {
    className: l()(I.backgroundOption, {
...
function L(e) {
  let {
    ...
    disabled: r
  } = e, s = (0, o.vRw)(), l = r ? N.intl.formatToPlainString(N.t.ykGFeH, {
    maxCustomBackgrounds: 25
  }) : N.intl.string(N.t.Qx0tFR), a = [{
...
function B(e) {
  ...
  } = (0, g.ZP)(m.Z.VIDEO_BACKGROUND_OPTIONS), f = Object.values((0, j.Z)()).sort((e, t) => O.E1[e.id] - O.E1[t.id]);
  return (0, i.jsx)(g.Gt, {
    value: h,
