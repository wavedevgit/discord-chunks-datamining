...
function k(e) {
  ...
  }), <div className={R.wrapper}>{s ? <u.$ /> : null}{<div className={a()(R.header, i)} />}{<_.X6q variant={"heading-lg/bold"} className={R.text}>{t}</_.X6q>}{null != n ? n : null}{o ? <d.x variant={"text-sm/normal"} color={"text-muted"} className={R.cta}>{C.intl.string(C.t["k7J/w8"])}</d.x> : null}</div>
}
...
function G(e) {
  ...
  let s = i.useMemo(() => null != n ? null != t ? C.intl.format(C.t.IlF6IS, {
    ...
    l = <d.x variant={"text-md/normal"} className={R.authorizedSuccessSubtext}>{s}</d.x>;
  return <j{...w({
    message: a,
    footer: l
  }, o)} />
...
function V() {
  ...
  return <Chunk787025.G removeChildWrapper={true}><Chunk787025.j transitionState={Chunk257465.D.ENTERED} hideHeader={true}><G guild={null == (e = require.state) ? true : module.guild} application={null == (t = require.state) ? true : exports.application} showsCloseWindowText={true} /></Chunk787025.j></Chunk787025.G>
}
...
function H(e) {
  ...
  return <A.G removeChildWrapper={true}><A.j transitionState={f.D.ENTERED} hideHeader={true} title={C.intl.string(C.t.j2d6Ki)} subtitle={l} /></A.G>
}