...
function z(e) {
  ...
  let {
    className: l,
    user: o
  } = e, c = i.useRef(null), m = (0, j.o9)(), g = (0, C.b)(), p = (0, _.gS)(), h = null !== (s = null == p ? void 0 : null === (t = p.nick) || void 0 === t ? void 0 : t[0]) && void 0 !== s ? s : null, [f, x] = i.useState(!1);
  i.useEffect(() => {
    x(null != c.current && c.current.scrollWidth > c.current.clientWidth)
  }, [o.username]);
  let N = !o.isClaimed(),
    b = m && !o.isPomelo() && !o.hasVerifiedEmailOrPhone() || N,
    E = b ? U.NW.string(U.t["7Ngnys"]) : void 0;
  return (0, r.jsxs)("div", {
...
function X(e) {
  ...
  }) : U.NW.string(U.t.I5kDqq), (0, r.jsxs)("div", {
    className: a()(V.field, i),
    children: [(0, r.jsx)("div", {
      className: V.constrainedRow,
      children: (0, r.jsxs)("div", {
      ...
      children: [c && null != o ? (0, r.jsx)(u.zxk, {
        ...
        onClick: function() {
          (0, u.h7j)(e => (0, r.jsx)(p.default, F(G({}, e), {
...
function J(e) {
  ...
  return w.Sb.useSetting() && R.wS ? (0, r.jsx)(u.yRy, {
    renderPopout: e => {
      let {
        closePopout: t
      } = e;
    ...
    children: e => (0, r.jsx)(u.P3F, F(G({}, e), {
...
function $(e) {
  let {
    className: t
  } = e, n = (0, x.l6)(), s = (0, x.Jm)(), l = !n || s, o = i.useMemo(() => n ? s ? U.NW.string(U.t.dJOmCw) : U.NW.string(U.t["Y0A/1N"]) : U.NW.string(U.t.Qdv3DA), [n, s]);
  return (0, r.jsxs)("div", {
