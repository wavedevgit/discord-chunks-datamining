...
function Y(e) {
  ...
  let {
    className: l,
    user: o
  } = e, c = r.useRef(null), u = (0, E.o9)(), p = (0, v.b)(), g = (0, O.gS)(), h = null != (s = null == g || null == (t = g.nick) ? void 0 : t[0]) ? s : null, [f, b] = r.useState(!1);
  r.useEffect(() => {
...
function K(e) {
  ...
  let {
    user: s,
    className: l
  } = e, o = (0, O.gS)(), c = null != (n = null == o || null == (t = o.nick) ? void 0 : t[0]) ? n : null, u = Z.ZP.getGlobalName(s), p = r.useRef(null), [g, h] = r.useState(!1);
  return r.useEffect(() => {
...
function J(e) {
  ...
  }) : G.intl.string(G.t.I5kDqq), (0, i.jsxs)("div", {
    className: a()(F.field, r),
    children: [(0, i.jsx)("div", {
      className: F.constrainedRow,
      children: (0, i.jsxs)("div", {
...
function Q(e) {
  ...
  }), s = k.Sb.useSetting(), a = r.useRef(null);
  return s && D.wS ? (0, i.jsx)(m.yRy, {
    targetElementRef: a,
    renderPopout: e => {
      let {
        closePopout: t
...
function ee(e) {
  let {
    className: t
  } = e, n = (0, x.l6)(), s = (0, x.Jm)(), l = !n || s, o = r.useMemo(() => n ? s ? G.intl.string(G.t.sK0dmJ) : G.intl.string(G.t.XxRj7e) : G.intl.string(G.t.UX0OdX), [n, s]);
  return (0, i.jsxs)("div", {
