...
function K(e) {
  ...
  let {
    className: l,
    user: o
  } = e, c = r.useRef(null), u = (0, v.o9)(), p = (0, S.b)(), g = (0, C.gS)(), h = null != (s = null == g || null == (t = g.nick) ? void 0 : t[0]) ? s : null, [f, b] = r.useState(!1);
  r.useEffect(() => {
...
function q(e) {
  ...
  let {
    user: s,
    className: l
  } = e, o = (0, C.gS)(), c = null != (n = null == o || null == (t = o.nick) ? void 0 : t[0]) ? n : null, u = w.ZP.getGlobalName(s), p = r.useRef(null), [g, h] = r.useState(!1);
  return r.useEffect(() => {
      ...
      children: [c && null != o ? (0, i.jsx)(u.zx, {
        ...
        onClick: function() {
          (0, m.h7j)(e => (0, i.jsx)(h.Z, W(z({}, e), {
            ...
            children: s.hasFlag(U.xW$.MFA_SMS) ? F.intl.string(F.t.jrhJys) : void 0,
