...
function k(e) {
  ...
  } = (0, p.KZ)(), [y, v] = i.useState("idle"), [j, O] = i.useState(null != t ? t : ""), x = i.useRef(null), _ = i.useRef(null), I = P.intl.string(P.t.xKSfBT), S = null != t && "" !== t.trim(), E = i.useCallback(() => {
    h({
...
function Z(e) {
  let {
    ...
    gameName: N = P.intl.string(P.t.GIWFlF),
    imageSrc: Z,
    applicationId: R,
    comment: L,
    tags: G
