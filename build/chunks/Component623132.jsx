...
function E(e) {
  ...
  return null == l ? (0, n.jsx)(s.X6q, S(I({}, i), {
    children: a
  })) : (0, n.jsx)(s.X6q, S(I({}, i), {
...
function C(e) {
  ...
  } = (0, p.KZ)(), [j, y] = a.useState("idle"), [v, x] = a.useState(null != t ? t : ""), h = a.useRef(null), P = a.useRef(null), I = _.intl.string(_.t.xKSfBQ), S = null != t && "" !== t.trim(), E = a.useCallback(() => {
    y("editing")
  }, []), k = a.useCallback(() => {
    let e = v.trim();
