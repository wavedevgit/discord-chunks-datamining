...
function f(e) {
  let {
    ...
    highContrastMode: S,
    children: A
  } = e, N = window.CSS.supports("selector(::-webkit-scrollbar)"), C = "font-size: ".concat(p, "%; --saturation-factor: ").concat(E, ";"), R = (0, u.Z)("highlight_mana_buttons"), P = (0, u.Z)("highlight_void_buttons"), w = o()((0, c.Z)(), (0, l.QeD)(a), "density-".concat(_), h, {
