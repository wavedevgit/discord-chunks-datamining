...
let k = e => {
    let {
      ...
      delay: o,
      index: a
    } = e, s = (0, u.JA)("item-".concat(a)), l = b.ZP.getURL(x + n), d = (0, p.q_F)({
      opacity: 1,
      from: {
        opacity: +!t
      },
  ...
  G = e => {
    let {
      ...
      var n;
      (0, _.t0)(e), c(false), null == (n = t.current) || n.focus()
    };
    return (0, r.jsxs)("div", {
      ref: u,
      className: a()(S.diversitySelector, o),
