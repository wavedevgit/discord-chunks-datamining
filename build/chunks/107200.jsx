...
function p() {
  ...
  return module && null != p ? <div className={Chunk143719.widget}><Chunk487029.Z width={Chunk710111.FW.width} height={Chunk710111.FW.height} guildId={f} channel={p} keepOpen={exports} onClose={function() {
        let e = (0, Chunk554174.Z)();
        null != module && (0, Chunk183584.oZ)(module)
      }} analyticsSource={"overlay"} /></div> : null
}