...
function L(e, t) {
  (0, c.h7j)(n => {
    ...
    return i = e.isPrivate() ? T.intl.string(T.t.hMRngI) : T.intl.formatToPlainString(T.t["3IRluL"], {
      channelName: o
    }), <h.Z.Provider value={e.guild_id}><c.ConfirmModal{...P(C({
...
function x(e, t) {
  (0, c.h7j)(n => <h.Z.Provider value={e.guild_id}><c.ConfirmModal{...P(C({
...
class M extends Chunk73800.PureComponent {
  render() {
    ...
    Chunk904245 && (e = <Chunk576855.Z className={Chunk739788.spacingTop}>{Chunk388032.intl.format(Chunk388032.t.IxY7Ex, {})}</Chunk576855.Z>), (0, Chunk970257.vc)(Chunk332148) && (t = <Chunk481060.j7V value={Chunk73800} onChange={this.handleToggleReport} hideBorder={true} className={Chunk739788.spacingTop}>{Chunk388032.intl.string(Chunk388032.t.x0jzo6)}</Chunk481060.j7V>);
    let b = Chunk501517 ? Chunk388032.intl.string(Chunk388032.t["2kHABQ"]) : Chunk388032.intl.string(Chunk388032.t.AMvpS0),
      y = <Chunk255367.Fragment>{<div className={Chunk739788.message}><Chunk294218.Z channel={Chunk755721} message={Chunk332148} disableInteraction={true} /></div>}{exports}{module}</Chunk255367.Fragment>,
      N = <Chunk255367.Fragment>{<Chunk481060.X6q variant={"heading-md/medium"} className={Chunk739788.spacing}>{Chunk699516}</Chunk481060.X6q>}{Chunk594174}</Chunk255367.Fragment>;
    if ((null == Chunk933557 ? true : Chunk933557.moderatorReportChannelId) != null) {
      let {
        isFlagResolved: e
      } = Chunk933557;
      return <Chunk372900.Z.Provider value={Chunk755721.guild_id}><Chunk481060.Y0X{...P(C({
        ...
        })} /></Chunk372900.Z.Provider>
    }
    return <Chunk372900.Z.Provider value={Chunk755721.guild_id}>{require ? (0, Chunk255367.jsx)(Chunk82659.Modal, {
