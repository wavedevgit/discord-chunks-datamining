...
function P(A, e) {
  ...
  let {
    editSkuId: l,
    onFileSizeError: a
  } = e, i = (0, r.e7)([g.Z], () => g.Z.getGuild(A)), [s, d] = n.useState({
    editSkuId: l,
    onFileSizeError: a
  }), u = n.useMemo(() => new V(U({
    guildId: A
  }, s)), [A, s]), [c, f] = n.useState(u.generateInitialProgresses), [, p] = n.useState(null);
  n.useLayoutEffect(() => {
  ...
  let {
    uploads: O
  } = u, F = !O.every(A => u.existingAttachmentIds.has(A.id)) || O.length !== u.existingAttachmentIds.size;
  return {
    addAttachment: j,
