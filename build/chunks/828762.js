...
class U {
  ...
  async saveProductWithAttachments(e) {
    ...
    return O.log("Created/updated product:", h), null != h && (null != this.editSkuId ? await o.Z.dispatch({
  ...
  constructor({
    ...
    var r;
    q(this, "guildId", void 0), q(this, "editSkuId", void 0), q(this, "target", new m.Z), q(this, "onFileSizeError", void 0), q(this, "existingAttachmentIds", new Set), q(this, "uploads", []), q(this, "generateInitialProgresses", () => {
      let e = {};
      for (let t of this.uploads) e[t.id] = 1;
      return e
    }), this.editSkuId = t, this.guildId = e, this.onFileSizeError = n;
...
function P(e, t) {
  ...
  let {
    editSkuId: a,
    onFileSizeError: l
  } = t, o = (0, A.e7)([f.Z], () => f.Z.getGuild(e)), [s, c] = r.useState({
    editSkuId: a,
    onFileSizeError: l
  }), d = r.useMemo(() => new U(x({
    guildId: e
  }, s)), [e, s]), [u, g] = r.useState(d.generateInitialProgresses), [, p] = r.useState(null);
  r.useLayoutEffect(() => {
    g(d.generateInitialProgresses())
  }, [d]);
  let [m, h] = r.useState(), [b, C] = r.useState(), q = r.useCallback(e => {
    d.deleteAttachment(e) && p({})
  }, [d]), j = r.useCallback(e => {
    d.addAttachment(e, g), p({})
  }, [d]), O = r.useCallback(async e => {
    try {
      h(e), C(void 0);
  ...
  let {
    uploads: V
  } = d, y = !V.every(e => d.existingAttachmentIds.has(e.id)) || V.length !== d.existingAttachmentIds.size;
  return {
    addAttachment: j,
