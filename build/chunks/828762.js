...
class P {
  addAttachment(e, t) {
    ...
    if (this.uploads.length >= r) throw l.uv.announce(C.intl.formatToPlainString(C.t["0QDZ4O"], {
    ...
    n.upload(), n.on("error", r => {
      ...
      null != A ? l.uv.announce(C.intl.formatToPlainString(C.t["+YVkfX"], {
        filename: A,
        reason: o
  ...
  async saveProductWithAttachments(e) {
    ...
    return O.log("Created/updated product:", m), null != m && (null != this.editSkuId ? await o.Z.dispatch({
  ...
  constructor({
    ...
    var n;
    x(this, "guildId", void 0), x(this, "editSkuId", void 0), x(this, "target", new p.Z), x(this, "onFileSizeError", void 0), x(this, "existingAttachmentIds", new Set), x(this, "uploads", []), x(this, "generateInitialProgresses", () => {
      let e = {};
      for (let t of this.uploads) e[t.id] = 1;
      return e
    }), this.editSkuId = t, this.guildId = e, this.onFileSizeError = r;
    let i = null == (n = m.Z.getGuildProduct(null != t ? t : "")) ? void 0 : n.attachments;
    null != i && (this.uploads = i.map(t => {
      var r;
...
function y(e, t) {
  ...
  let {
    editSkuId: a,
    onFileSizeError: l
  } = t, o = (0, i.e7)([g.Z], () => g.Z.getGuild(e)), [s, c] = n.useState({
    editSkuId: a,
    onFileSizeError: l
  }), d = n.useMemo(() => new P(q({
    guildId: e
  }, s)), [e, s]), [u, f] = n.useState(d.generateInitialProgresses), [, h] = n.useState(null);
  n.useLayoutEffect(() => {
    f(d.generateInitialProgresses())
  }, [d]);
  let [p, m] = n.useState(), [b, C] = n.useState(), x = n.useCallback(e => {
    ...
    try {
      ...
      C(e instanceof A.Hx ? e : new A.Hx({
        status: 400,
        body: {
  ...
  let {
    uploads: U
  } = d, V = !U.every(e => d.existingAttachmentIds.has(e.id)) || U.length !== d.existingAttachmentIds.size;
  return {
    addAttachment: j,
