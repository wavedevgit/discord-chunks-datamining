...
class V {
  addAttachment(e, t) {
    ...
    if (this.uploads.length >= A) throw a.uv.announce(b.intl.formatToPlainString(b.t["0QDZ4O"], {
...
function P(e, t) {
  ...
  let [m, h] = n.useState(), [C, b] = n.useState(), v = n.useCallback(e => {
    ...
    try {
      ...
      b(e instanceof i.Hx ? e : new i.Hx({
        status: 400,
        body: {
