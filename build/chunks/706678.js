...
function b() {
  for (let [e, t] of(E() || "" !== d ? y() : i.log("No violators found"), h)) t.warned = false, t.execTime = 0, t.execCount = 0
}
let y = function() {
