  ...
  stories: [{
    ...
    component: function(e) {
      ...
      return <div>{<a.J2{..._(d({}, m), {
        ...
        })} />}{<o.zxk variant={"primary"} text={"Toggle Popover"} buttonRef={b} onClick={() => E(!g)} />}</div>
    },
    controls: {
      title: {
        label: "Title",
    ...
    component: function(e) {
      ...
      return <div>{<a.Mb{..._(d({}, e), {
        ...
        })} />}{<o.zxk variant={"primary"} text={"Show Video Popover"} buttonRef={s} onClick={() => n(!t)} />}</div>
    },
    controls: {
      gradientColor: {
        label: "Gradient Color",
    ...
    component: function(e) {
      ...
      return <div>{<a.e4 targetElementRef={u} shouldShow={n} onRequestClose={() => l(false)} steps={d} caretConfig={{
            position: "top",
            align: "center"
          }} onStepChange={() => {}} />}{<o.zxk variant={"primary"} text={"Show Multi-Step"} buttonRef={u} onClick={() => l(!n)} />}</div>
    },
    controls: {
      showExpressive: {
