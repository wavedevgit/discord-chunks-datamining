...
function h(e) {
  let {
    user: t
  } = e, n = _.ZP.useName(t), r = (0, a.e7)([E.Z], () => E.Z.getNickname(t.id)), l = (0, a.e7)([b.Z], () => b.Z.getStatus(t.id));
  return (0, i.jsx)(S, {
    icon: (0, i.jsx)(c.Z, {
      "aria-hidden": !0,
      size: s.EFr.SIZE_32,
...
function m(e) {
  let {
    channel: t
  } = e, n = (0, a.e7)([p.Z], () => p.Z.getGuild(null == t ? void 0 : t.guild_id)), r = (0, o.ZP)(t);
  return (0, i.jsx)(S, {
    icon: (0, i.jsx)(d.Z, {
      size: d.E.SMALL_32,
      guild: n,
