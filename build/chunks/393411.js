...
function G(e) {
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("div", {
      className: k.bannerBackgroundImage
    }), (0, i.jsxs)("div", {
...
let Y = function(e) {
    ...
    ea = () => {
      if (null != r && null != r.premiumPlanIdFromItems) {
        ...
        let t = (0, C.DE)(e, null == p ? void 0 : p.id, !1),
          ...
          i = !1;
        1 === t.length && (null == p ? void 0 : p.id) === r.paymentSourceId && (0, C.tD)(e.id, n, null == p ? void 0 : p.id) && (i = !0), i ? d.O5(r, W) : (0, h.Z)({
  ...
  return (0, i.jsx)(ef, {
    wordMark: eh,
    subscriptionInfo: (a()(null != l, "Expected renewalInvoicePreview"), (0, i.jsx)("div", {
      className: k.planInfo,
    ...
    buttons: (() => {
      ...
      switch (e) {
        ...
        case Z.O0b.PAUSED:
          ...
          return (0, i.jsxs)("div", {
            className: k.toolsButtons,
            children: [n.length > 0 ? (0, i.jsx)(c.zxk, {
