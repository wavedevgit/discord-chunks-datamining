...
let z = function(e) {
  ...
  } = (0, m.ZP)(u.Z.SUBSCRIPTION_HEADER), K = (0, o.e7)([x.default], () => x.default.getCurrentUser()), {
    fractionalState: q
  } = (0, g.Z)({
    forceFetch: !1
  ...
  return (0, r.jsx)(ef, {
    ...
    buttons: (() => {
      ...
      if (j.ZP.isBaseSubscriptionCanceled(i)) return (0, r.jsx)(c.zxk, {
        className: k.toolsButton,
        size: c.zxk.Sizes.SMALL,
