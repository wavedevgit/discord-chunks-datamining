...
function g(e) {
  ...
  return <l.yRy targetElementRef={b} shouldShow={g} animation={l.yRy.Animation.NONE} position={"bottom"} align={"right"} autoInvert={false} onRequestClose={() => m(false)} renderPopout={e => (0, r.jsx)(c.Z, f(p({}, e), {
      channel: t,
