...
let V = l.memo(function(e) {
  ...
  let {
    ...
    roleId: i,
    size: 16
  }), C = (0, c.e7)([x.Z], () => x.Z.getRole(l, i)), m = s.includes(j.CR) ? "" : "@", p = (0, u.dQu)(u.TVs.unsafe_rawColors.PRIMARY_300).hsl(), g = null != (t = null == C ? void 0 : C.colorString) ? t : p, v = (0, h.X)(l, null == C ? void 0 : C.colorStrings);
  return (0, r.jsxs)("div", {
...
function E(e) {
  ...
  return (0, r.jsxs)("div", {
    className: a()(N.rowLabel, N.channelLabel, {
      [N.hasParent]: o
    }, l),
...
function k(e) {
  ...
  })(i, C, h), [i, C, h]), v = l.useMemo(() => Object.keys(j), [j]), [O, S] = l.useState(""), [L, V] = l.useState(!1), [E, k] = l.useState(!1), [A, W] = l.useState(!1), B = l.useRef(null), {
    sections: U,
    sectionCounts: F
  } = l.useMemo(() => {
