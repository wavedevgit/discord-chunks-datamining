...
let M = l.memo(function(e) {
  ...
  let {
    ...
    roleId: i,
    size: 16
  }), C = (0, c.e7)([j.Z], () => j.Z.getRole(l, i)), m = s.includes(h.CR) ? "" : "@", p = (0, u.dQu)(u.TVs.unsafe_rawColors.PRIMARY_300).hsl(), g = null != (t = null == C ? void 0 : C.colorString) ? t : p;
  return (0, r.jsxs)("div", {
...
function V(e) {
  ...
  return (0, r.jsxs)("div", {
    className: a()(v.rowLabel, v.channelLabel, {
      [v.hasParent]: o
    }, l),
...
function k(e) {
  let {
    ...
    helperText: p,
    className: f
  } = e, h = (0, c.e7)([j.Z], () => j.Z.getRoles(t)), x = l.useMemo(() => (function(e, t, n) {
    if (null == e) return {};
    let r = {};
    return e.forEach(e => {
  ...
  })(i, C, h), [i, C, h]), O = l.useMemo(() => Object.keys(x), [x]), [w, Z] = l.useState(""), [M, V] = l.useState(!1), [k, T] = l.useState(!1), [A, B] = l.useState(!1), W = l.useRef(null), {
    sections: U,
    sectionCounts: F
  } = l.useMemo(() => {
  ...
  let G = (e, t, n) => {
    ...
    Y = l.useCallback(e => {
      let t = _({}, x);
      R(e) ? t[e.id] = I(e.record) : L(e) && (t[e.id] = P(e.record)), z(t), Z(""), q(), setTimeout(() => {
        var e;
    ...
    J = l.useMemo(() => O.map(e => {
      var n;
      return n = x[e], N(_({}, n.tag), {
        label: E(n.row, t, v.noIndent)
      })
    }), [x, O, t]);
  return (0, r.jsxs)("div", {
