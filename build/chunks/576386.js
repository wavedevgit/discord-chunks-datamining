...
let f = e => {
    let {
      ...
      isSelected: l = !1,
      onClick: p
    } = e, f = (0, o.e7)([d.default], () => d.default.getCurrentUser()), [m, b] = (0, i.useState)(!1);
    return null == f ? null : (0, r.jsxs)(s.P3F, {
  ...
  m = e => {
    ...
    return null == (0, o.e7)([d.default], () => d.default.getCurrentUser()) ? null : (0, r.jsxs)(s.u2D, {
      ...
      }), 0 !== l.length ? (0, r.jsxs)("div", {
        children: [(0, r.jsx)(s.vwX, {
          children: p.intl.string(p.t["1vbbeX"])
        }), (0, r.jsx)("div", {
          className: v.list,
          children: l.map(e => (0, r.jsx)(f, {
            nameplate: e,
            isSelected: (null == t ? void 0 : t.id) === e.id,
            onClick: () => n(e, !1)
          }, e.id))
