...
class S extends(i = Chunk73800.Component) {
  ...
  handleDragMove(e, t) {
    ...
    let {
      ...
      bottom: true,
      right: true
    }, r, o, g, m)), _ = u ? (0, d.R)(v) : E("RESIZE_SOUTH_EAST", v);
  ...
  render() {
    ...
    return (0, Chunk255367.jsxs)("div", {
      ref: this.ref,
      style: f({}, Chunk120356, Chunk73800, r, null != Chunk902704 ? {
        zIndex: 1e3
      } : true, exports ? {
        visibility: "hidden"
      } : true),
  ...
  constructor(e) {
    super(e), p(this, "anchor", true), p(this, "size", true), p(this, "ref", l.createRef()), p(this, "dragState", {
      ...
      let {
        width: a,
        height: c
      } = b(i, this.size), u = (0, d.PY)(this.anchor, l, s, a, c);
      if ("MOVE" === e) {
        let {
          x: e,
          y: i
