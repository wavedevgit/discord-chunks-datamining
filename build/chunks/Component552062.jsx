...
class x extends(i = Chunk473749.Component) {
  ...
  componentDidUpdate(e, t) {
    null == t.operation && ((0, c.Z)(this.props.anchor, e.anchor) || this.setDOMPositions(v(this.props.anchor)), (0, c.Z)(this.props.size, e.size) || this.setDOMSize(b(this.props.size, this.props.minSize.width, this.props.minSize.height)))
  }
  ...
  handleDragMove(e, t) {
    ...
    let {
      width: g,
      height: m
    } = O(n, this.size), y = t - p, b = e - h, v = (0, d.ou)((0, d.PY)({
      top: y,
      left: b,
      bottom: true,
      right: true
    }, r, s, g, m)), _ = u ? (0, d.R)(v) : E("RESIZE_SOUTH_EAST", v);
    ...
    return (0, Chunk54381.jsxs)(Chunk473749.Fragment, {
      children: [module ? (0, Chunk54381.jsxs)(Chunk473749.Fragment, {
        children: [(0, Chunk54381.jsx)("div", {
          className: a()(Chunk719614.resizeNorth, {
            [Chunk719614.resizeNSCursor]: require
          }),
          onMouseDown: e => this.handleResizeMouseDown(e, "RESIZE_NORTH")
        }), (0, Chunk54381.jsx)("div", {
          className: a()(Chunk719614.resizeSouth, {
            [Chunk719614.resizeNSCursor]: require
          }),
        ...
        children: [(0, Chunk54381.jsx)("div", {
          className: a()(Chunk719614.resizeEast, {
            [Chunk719614.resizeEWCursor]: require
          }),
          onMouseDown: e => this.handleResizeMouseDown(e, "RESIZE_EAST")
        }), (0, Chunk54381.jsx)("div", {
          className: a()(Chunk719614.resizeWest, {
            [Chunk719614.resizeEWCursor]: require
          }),
        ...
        children: [(0, Chunk54381.jsx)("div", {
          className: a()(Chunk719614.resizeNorthWest, {
            [Chunk719614.resizeNWSECursor]: require
          }),
          onMouseDown: e => this.handleResizeMouseDown(e, "RESIZE_NORTH_WEST")
        }), (0, Chunk54381.jsx)("div", {
          className: a()(Chunk719614.resizeNorthEast, {
            [Chunk719614.resizeNESWCursor]: require
          }),
          onMouseDown: e => this.handleResizeMouseDown(e, "RESIZE_NORTH_EAST")
        }), (0, Chunk54381.jsx)("div", {
          className: a()(Chunk719614.resizeSouthWest, {
            [Chunk719614.resizeNESWCursor]: require
          }),
          onMouseDown: e => this.handleResizeMouseDown(e, "RESIZE_SOUTH_WEST")
        }), (0, Chunk54381.jsx)("div", {
          className: a()(Chunk719614.resizeSouthEast, {
            [Chunk719614.resizeNWSECursor]: require
          }),
  ...
  render() {
    ...
    return (0, Chunk54381.jsxs)("div", {
      ...
      className: a()({
        [Chunk719614.wrapper]: true,
        [Chunk719614.operation]: Chunk434529
      }),
  ...
  constructor(e) {
    super(e), p(this, "anchor", true), p(this, "size", true), p(this, "ref", o.createRef()), p(this, "dragState", {
      startX: 0,
      startY: 0,
      offsetX: 0,
      offsetY: 0,
      ...
      let {
        width: a,
        height: c
      } = O(i, this.size), u = (0, d.PY)(this.anchor, o, l, a, c);
      if ("MOVE" === e) {
        let {
          x: e,
          y: i
      ...
      if (t) {
        let {
          ...
          width: n,
          height: r
        } = O(this.ref.current, this.size), s = (0, d.PY)(this.anchor, e, t, n, r), o = (0, d.R)(s);
    ...
    }), this.anchor = v(e.anchor), this.size = b(e.size, e.minSize.width, e.minSize.height)
  }
}
