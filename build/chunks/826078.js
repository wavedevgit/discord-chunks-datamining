...
let _ = function(e) {
  ...
  let {
    ...
    cropData: N,
    setCropData: E
  } = (0, h.S)(), [R, L] = a.useState(((P = !(null == (n = S.current) || null == (t = n.videoElement) ? void 0 : t.paused), true), P)), T = a.useRef(null), [F, D] = a.useState(null), [I, A] = a.useState(), Z = a.useRef(null), B = a.useRef(null), [M, z] = a.useState(0), [H, W] = a.useState(!1), [U, V] = a.useState(null);
  (0, m.Z)(() => {
    var e;
