...
let P = e => {
    let {
      userId: t,
      channelId: n
    } = e, l = (0, o.e7)([b.Z], () => b.Z.getMutualGuilds(t), [t]), s = i.useMemo(() => null != l ? l.slice(0, 3).map((e, t) => {
      let {
        guild: n
  ...
  N = e => {
    let {
      ...
      (0, a.showToast)((0, a.createToast)(I.intl.string(I.t.a2j0ho), a.ToastType.FAILURE))
    }, []), o = i.useCallback(() => {
  ...
  T = e => {
    let {
      ...
      channelId: a
    } = (0, f._)(), s = (0, o.e7)([p.Z], () => null != a && p.Z.isSpam(a), [a]), c = (0, o.e7)([C.Z], () => C.Z.getRelationshipType(t), [t]), u = n.id === a, d = !l.tq && !u, h = !!l.tq || u || s, g = s || u ? (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsx)(N, {
        channelId: n.id,
        otherUserId: t
      }), (0, r.jsx)(m.Z, {
