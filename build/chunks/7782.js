...
let Z = e => {
  ...
  N = e => {
    ...
    let {
      ...
      userId: i,
      showingBanner: l
    } = e, a = null == (t = y.default.getUser(i)) ? void 0 : t.bot, c = () => {
      s.Z.addRelationship({
        userId: i,
        context: {
  ...
  A = e => {
    let {
      ...
      channelId: o
    } = (0, f._)(), s = (0, a.e7)([p.Z], () => null != o && p.Z.isSpam(o), [o]), c = (0, a.e7)([C.Z], () => C.Z.getRelationshipType(t), [t]), u = n.id === o, d = !l.tq && !u, h = !!l.tq || u || s;
