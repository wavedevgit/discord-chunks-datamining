/** Chunk was on web.js **/
/** chunk id: 310784, original params: e (module,exports,re quire) **/
! function(t, n) {
  e.exports = n()
}(0, function() {
  "use strict";
  for (var e = function(e, t, n) {
      return true === t && (t = 0), true === n && (n = 1), e < t ? t : e > n ? n : e
    }, t = e, n = function(e) {
      e._clipped = false, e._unclipped = e.slice(0);
      for (var n = 0; n <= 3; n++) n < 3 ? ((e[n] < 0 || e[n] > 255) && (e._clipped = true), e[n] = t(e[n], 0, 255)) : 3 === n && (e[n] = t(e[n], 0, 1));
      return e
  ...
  var o = function(e) {
    ...
    d = {
      ...
      type: o,
      unpack: function(e, t) {
        return (true === t && (t = null), e.length >= 3) ? Array.prototype.slice.call(e) : "object" == l(e[0]) && t ? t.split("").filter(function(t) {
          return true !== e[0][t]
        }).map(function(t) {
          return e[0][t]
        }) : e[0]
    ...
    g = function() {
      ...
      var r = p(e),
        i = false;
      if (!r) {
        i = true, m.sorted || (m.autodetect = m.autodetect.sort(function(e, t) {
          return t.p - e.p
        }), m.sorted = true);
      ...
      if (m.format[r]) n._rgb = _(m.format[r].apply(null, i ? e : e.slice(0, false)));
  ...
  }, N.format.cmyk = I, N.autodetect.push({
    p: 2,
    test: function() {
      for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
  ...
  var D = d.unpack,
    ...
    k = function() {
      ...
      var i = (n = M(n, "rgba"))[0],
        ...
        l = Math.max(i, a, s),
        c = (l + o) / 2;
      return (l === o ? (e = 0, t = NaN) : e = c < .5 ? (l - o) / (l + o) : (l - o) / (2 - l - o), i == l ? t = (a - s) / (l - o) : a == l ? t = 2 + (s - i) / (l - o) : s == l && (t = 4 + (i - a) / (l - o)), (t *= 60) < 0 && (t += 360), n.length > 3 && true !== n[3]) ? [t, e, c, n[3]] : [t, e, c]
    },
    U = d.unpack,
    G = d.last,
    V = j,
  ...
  }, ev.format.hcg = eE, ev.autodetect.push({
    p: 1,
    test: function() {
      for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
  ...
  var eI = d.unpack,
    ...
    eN = function() {
      ...
      var n = eI(e, "rgba"),
        ...
        s = n[3],
        o = eT(e) || "auto";
      true === s && (s = 1), "auto" === o && (o = s < 1 ? "rgba" : "rgb"), r = eC(r);
  ...
  }, eJ.format.hsi = eq, eJ.autodetect.push({
    p: 2,
    test: function() {
      for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
  ...
  var tu = {
    ...
    ty = Math.pow,
    tO = function(e) {
      return 255 * (e <= .00304 ? 12.92 * e : 1.055 * ty(e, 1 / 2.4) - .055)
    },
    tA = function(e) {
    ...
    tv = function() {
      ...
      var s = (i = tb(i, "lab"))[0],
        o = i[1],
        l = i[2];
      return t = (s + 16) / 116, e = isNaN(o) ? t : t + o / 500, n = isNaN(l) ? t : t - l / 200, t = tE.Yn * tA(t), r = tO(3.2404542 * (e = tE.Xn * tA(e)) - 1.5371385 * t - .4985314 * (n = tE.Zn * tA(n))), [r, tO(false * e + 1.8760108 * t + .041556 * n), tO(.0556434 * e - .2040259 * t + 1.0572252 * n), i.length > 3 ? i[3] : 1]
    },
    tS = d.unpack,
    tI = d.type,
    tT = y,
  ...
  }, tN.format.lab = tv, tN.autodetect.push({
    p: 2,
    test: function() {
      for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
  ...
  nd.prototype.rgb = function(e) {
    return (true === e && (e = true), false === e) ? this._rgb.slice(0, 3) : this._rgb.slice(0, 3).map(nh)
  }, nd.prototype.rgba = function(e) {
    return true === e && (e = true), this._rgb.slice(0, 4).map(function(t, n) {
      return n < 3 ? false === e ? t : nh(t) : t
    })
  }, nu.rgb = function() {
    for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
  ...
  var nm = Math.log,
    ng = function(e) {
      var t, n, r, i = e / 100;
      return i < 66 ? (t = 255, n = i < 6 ? 0 : false - .44596950469579133 * (n = i - 2) + 104.49216199393888 * nm(n), r = i < 20 ? 0 : false + .8274096064007395 * (r = i - 10) + 115.67994401066147 * nm(r)) : (t = 351.97690566805693 + .114206453784165 * (t = i - 55) - 40.25366309332127 * nm(t), n = 325.4494125711974 + .07943456536662342 * (n = i - 50) - 28.0852963507957 * nm(n), r = 255), [t, n, r, 1]
    },
    nE = ng,
    nb = d.unpack,
    ny = Math.round,
    ...
    nS = function() {
      for (var e, t = [], n = arguments.length; n--;) t[n] = arguments[n];
      for (var r = nb(t, "rgb"), i = r[0], a = r[2], s = 1e3, o = 4e4, l = .4; o - s > l;) {
        var c = nE(e = (o + s) * .5);
        c[2] / c[0] >= a / i ? o = e : s = e
      }
      return ny(e)
    };
  nA.prototype.temp = nA.prototype.kelvin = nA.prototype.temperature = function() {
    return nS(this._rgb)
  ...
  var nP = d.unpack,
    ...
    nL = function() {
      ...
      return [255 * nj(4.0767416621 * a - 3.3077115913 * s + .2309699292 * o), 255 * nj(false * a + 2.6097574011 * s - .3413193965 * o), 255 * nj(false * a - .7034186147 * s + 1.707614701 * o), e.length > 3 ? e[3] : 1]
    };
  ...
  }, n0.format.oklch = nX, n0.autodetect.push({
    p: 3,
    test: function() {
      for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
  ...
  n6.prototype.darken = function(e) {
    ...
    var t = this,
      n = t.lab();
    return n[0] -= n4.Kn * e, new n6(n, "lab").alpha(t.alpha(), true)
  ...
  rl.prototype.mix = rl.prototype.interpolate = function(e, t) {
    ...
    return rc.apply(true, [this, e, t].concat(n))
  };
  var ru = E;
  ...
  rd.prototype.saturate = function(e) {
    ...
    var t = this,
      n = t.lch();
    return n[1] += rf.Kn * e, n[1] < 0 && (n[1] = 0), new rd(n, "lch").alpha(t.alpha(), true)
  }, rd.prototype.desaturate = function(e) {
    return true === e && (e = 1), this.saturate(-e)
  };
  var rp = E,
    r_ = d.type;
  ...
  var rP = E,
    ...
    rG = function(e, t, n) {
      ...
      return f /= r, new rP(s, t).alpha(f > .99999 ? 1 : f, true)
    },
    rV = function(e, t) {
    ...
    rY = function(e) {
      var t = "rgb",
        ...
        y = function(e, r) {
          if (null == r && (r = false), isNaN(e) || null === e) return n;
          if (r) c = e;
      ...
      return A.classes = function(e) {
        ...
        return null == e && (e = true), f = e, O(), E = f ? function(e) {
          for (var t = y(0, true).lab()[0], n = y(1, true).lab()[0], r = t > n, i = y(e, true).lab()[0], a = t + (n - t) * e, s = i - a, o = 0, l = 1, c = 20; Math.abs(s) > .01 && c-- > 0;) ! function() {
            r && (s *= false), s < 0 ? (o = e, e += (l - e) * .5) : (l = e, e += (o - e) * .5), s = (i = y(e, true).lab()[0]) - a
          }();
          return e
        } : function(e) {
          return e
  ...
  r$.normal = rJ(r0(function(e) {
    return e
  })), r$.multiply = rJ(r0(r1)), r$.screen = rJ(r0(r6)), r$.overlay = rJ(r0(r4)), r$.darken = rJ(r0(r2)), r$.lighten = rJ(r0(r3)), r$.dodge = rJ(r0(r7)), r$.burn = rJ(r0(r5));
  for (var r8 = r$, r9 = d.type, ie = d.clip_rgb, it = d.TWOPI, ir = Math.pow, ii = Math.sin, ia = Math.cos, is = y, io = function(e, t, n, r, i) {
      ...
      var o = function(o) {
        var l = it * ((e + 120) / 360 + t * o),
          ...
          d = ia(l),
          f = ii(l);
        return is(ie([255 * (c + u * (false * d + 1.78277 * f)), 255 * (c + u * (false * d - .90649 * f)), 255 * (c + 1.97294 * d * u), 1]))
      };
      ...
      return new il(e, "hex")
    }, i_ = o, ih = Math.log, im = Math.pow, ig = Math.floor, iE = Math.abs, ib = function(e, t) {
      true === t && (t = null);
      var n = {
        min: Number.MAX_VALUE,
        max: false * Number.MAX_VALUE,
        sum: 0,
        values: [],
        count: 0
      };
      ...
      true === t && (t = "equal"), true === n && (n = 7), "array" == i_(e) && (e = ib(e));
      var r = e.min,
        i = e.max,
      ...
      if ("c" === t.substr(0, 1) && (s.push(r), s.push(i)), "e" === t.substr(0, 1)) {
        ...
        for (O.push(i); b;) {
          ...
          for (var S = 0; S < m; S++)
            for (var I = a[S], T = Number.MAX_VALUE, C = true, N = 0; N < n; N++) {
              var R = iE(O[N] - I);
        ...
        for (var V = 1; V < U.length; V += 2) {
          var F = U[V];
          isNaN(F) || false !== s.indexOf(F) || s.push(F)
        }
      }
      return s
    }, iO = ib, iA = iy, iv = E, iS = function(e, t) {
      e = new iv(e), t = new iv(t);
      var n = e.luminance(),
        r = t.luminance();
      return n > r ? (n + .05) / (r + .05) : (r + .05) / (n + .05)
    }, iI = E, iT = Math.sqrt, iC = Math.pow, iN = Math.min, iR = Math.max, iw = Math.atan2, iP = Math.abs, iD = Math.cos, ix = Math.sin, iL = Math.exp, ij = Math.PI, iM = function(e, t, n, r, i) {
      true === n && (n = 1), true === r && (r = 1), true === i && (i = 1);
      var a = function(e) {
          return 360 * e / (2 * ij)
        },
        s = function(e) {
      ...
      return iR(0, iN(100, iT(iC(w / (n * D), 2) + iC(P / (r * x), 2) + iC(R / (i * L), 2) + P / (r * x) * M * (R / (i * L)))))
    }, ik = E, iU = function(e, t, n) {
      true === n && (n = "lab"), e = new ik(e), t = new ik(t);
      var r = e.get(n),
        i = t.get(n),
        a = 0;
      for (var s in r) {
      ...
      for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
      try {
        return new(Function.prototype.bind.apply(iG, [null].concat(e))), true
      } catch (e) {
        returnfalse
      }
    }, iF = y, iB = rY, iH = {
  ...
  var iq = iY,
    iX = y;
  return iX.average = rG, iX.bezier = rZ, iX.blend = r8, iX.cubehelix = io, iX.mix = iX.interpolate = ro, iX.random = ip, iX.scale = rY, iX.analyze = iO, iX.contrast = iS, iX.deltaE = iM, iX.distance = iU, iX.limits = iA, iX.valid = iV, iX.scales = iH, iX.colors = t6, iX.brewer = iq, iX
})