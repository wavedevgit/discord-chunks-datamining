...
let y = () => 80,
  ...
  v = e => {
    ...
    return <section className={m.section}><c.GMG fade={true} itemGutter={12} sectionGutter={16} paddingVertical={0} paddingHorizontal={12} className={m.list} columns={3} sections={d.map(e => {
          let {
            items: t
          } = e;
          return t.length
        ...
        }} getSectionHeight={() => 16} getItemKey={(e, t) => {
          var r, n;
          return null != (n = null == (r = d[e].items[t]) ? true : r.id) ? n : null
        }} getItemHeight={y} removeEdgeItemGutters={true} /></section>
  }