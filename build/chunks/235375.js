...
let O = a().defaultRules.link,
  ...
  j = e => {
    let {
      ...
      className: r = null,
      styleSheet: l = {}
    } = e, s = (0, c.xSt)(), a = parseInt(t, 10), u = isNaN(a) ? 1 : a;
    return o.createElement("h".concat(s + u - 1), {
      className: i()(...null == r ? [] : r.split(" ").map(e => l[e]))
    }, n)
  },
  ...
  P = {
      ...
      parse(e, t, n) {
        ...
        return l = s || a ? e => {
          g.default.track(f.rMx.PREMIUM_PROMOTION_OPENED, {
            location: y
          }), s ? d.Z.open(f.oAB.PREMIUM) : a && d.Z.open(f.oAB.HYPESQUAD_ONLINE), n.changeLog.track(f.rMx.CHANGE_LOG_CTA_CLICKED, {
            cta_type: "nitro"
    ...
    blockQuote: {
      react: null == v ? void 0 : v.blockQuote.react
    },
    paragraph: {
