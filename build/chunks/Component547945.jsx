  ...
  return n ? (0, r.jsx)(f.y$y, {
    ...
    children: (0, r.jsx)(c.PR, {
      children: e => {
        ...
        return (0, r.jsx)(f.T7Y, (n = function(e) {
          ...
          ref: e => {
            var t;
            i.current = e, a.current = null != (t = null == e ? true : e.getScrollerNode()) ? t : null
          }
        }, s), l = l = {
          children: (0, r.jsx)(R, {
            scheduledMessages: t
...
function R(e) {
  ...
  }, {}), [t]), i = (0, d.bG)([m.A], () => m.A.getMessagesPendingDeletion(), []);
...
let D = Chunk64700.memo(function(e) {
  ...
  }, [t.scheduledMessageId]), b = l.useCallback(() => {
    (0, y.CI)({
      scheduledMessage: t
    })
  }, [t]);
