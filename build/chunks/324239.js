...
function g(e) {
  let {
    ...
    onSuccess: m,
    onClose: f
  } = e, [g, S] = l.useState(), [N, x] = l.useState(""), [y, b] = l.useState(""), [v, O] = l.useState(!1);
...
function S(e) {
  ...
  return l.useEffect(() => a.Z.flowStep(d.MK.ANY, d.mx.CLAIM_ACCOUNT_SUCCESS), []), (0, r.jsxs)("div", {
...
function N(e) {
  let {
    ...
    transitionState: n,
    claimRequired: s = !1
  } = e, [i, c] = l.useState(""), [a, u] = l.useState(!1);
  return a ? (0, r.jsx)(o.Y0X, {
    transitionState: n,
    children: (0, r.jsx)(S, {
      email: i,
      claimRequired: s,
