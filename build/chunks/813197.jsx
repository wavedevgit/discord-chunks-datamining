...
class _ extends(r = Chunk73800.PureComponent) {
  ...
  render() {
    ...
    return <Chunk53281.Z ref={this._ref} onClick={this.props.onClick} onChange={this.handleFileChange} filters={null != Chunk869783 ? Chunk869783 : u()} multiple={module} disabled={exports} className={require} tabIndex={r} aria-label={Chunk73800} />
  }
  constructor(...e) {
