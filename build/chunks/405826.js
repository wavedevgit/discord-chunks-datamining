...
let p = 250,
  ...
  g = null === s.Z || void 0 === s.Z ? void 0 : s.Z.spellCheck;
...
class E {
  ...
  setLocale(e) {
    var t;
    null === (t = g.setLocale(e)) || void 0 === t || t.then(t => {
...
async function O() {
  var e;
  let t = new E((null !== (e = await g.getAvailableDictionaries()) && void 0 !== e ? e : []).map(m).filter(u.lm));
  return b(t), t
}