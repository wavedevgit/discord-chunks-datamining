...
let y = e => {
  ...
  return (0 === t && (O ? (S = m.intl.string(m.t.IRxUlG), I = m.intl.string(m.t.fiNVin)) : j ? (S = m.intl.string(m.t.vW8iUF), I = m.intl.string(m.t["50gfOv"])) : v ? (S = m.intl.string(m.t.vdSOpz), I = m.intl.string(m.t.lm1UKt)) : x ? (S = m.intl.formatToPlainString(m.t.v1ktYb, {
    min: p.YeM.MEMBER_AGE
  }), I = m.intl.string(m.t.BddRzS)) : C && (S = m.intl.formatToPlainString(m.t.sncw41, {
