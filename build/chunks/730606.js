...
function P(e) {
  ...
  return n ? (0, r.jsx)(c.aQ.Provider, {
    value: s,
...
function D(e) {
  let {
    ...
    onIndexChange: n,
    startIndex: o = 0,
    shouldRedactExplicitContent: c = !1,
    shouldHideMediaOptions: d = !1
  } = e, [f, _] = i.useState(o), p = i.useRef(o), {
    zoomed: h,
    setZoomed: g
  } = (0, b.Y)(), C = i.useCallback(e => {
    _(e = R(e, t.length)), p.current = e, null == n || n(e), g(!1)
  }, [n, t, g]);
  i.useEffect(() => {
    let e = () => C(p.current + 1),
      t = () => C(p.current - 1);
    return m.S.subscribe(T.CkL.MODAL_CAROUSEL_NEXT, e), m.S.subscribe(T.CkL.MODAL_CAROUSEL_PREV, t), () => {
