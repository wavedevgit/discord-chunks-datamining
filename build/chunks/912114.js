...
function E(e) {
  ...
  } = e, m = void 0 !== n ? n : (null == t ? void 0 : t.icon) != null ? (0, f.x)(t, 120) : null, {
...
let S = function(e) {
  let {
    ...
    location: S
  } = e, P = (0, g.Dt)(), I = (0, o.e7)([b.Z], () => b.Z.getChannel(t)), Z = null == I ? void 0 : I.name, T = (0, m.cO)(I), [N, A] = i.useState(null != Z ? Z : ""), [w, R] = i.useState(void 0), M = void 0 !== w, {
    analyticsLocations: D
  } = (0, h.ZP)(S, p.Z.GROUP_DM_EDIT_MODAL), L = {
    channel_id: t,
  ...
  return (i.useEffect(() => {
    a(N !== Z || M)
  }, [N, Z, M, a]), (0, d.ZP)(() => (_.default.track(C.rMx.GDM_EDIT_INTERACTED, O(j({}, L), {
    action: "opened"
  })), () => {
    _.default.track(C.rMx.GDM_EDIT_INTERACTED, O(j({}, L), {
      action: "dismissed"
    }))
    ...
    children: (0, r.jsx)("form", {
      onSubmit: e => {
        ...
        let r = N !== Z,
          i = void 0 !== w;
        if (_.default.track(C.rMx.GDM_EDIT_INTERACTED, O(j({}, L), {
            action: "saved",
            new_name_set: "" !== N,
