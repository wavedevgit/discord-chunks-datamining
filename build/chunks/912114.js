...
function A(e) {
  ...
  } = e, h = void 0 !== n ? n : (null == t ? void 0 : t.icon) != null ? (0, p.x)(t, 120) : null, {
...
let N = function(e) {
  let {
    ...
    location: v
  } = e, T = (0, s.e7)([m.Z], () => m.Z.getChannel(t)), N = null == T ? void 0 : T.name, C = (0, h.cO)(T), [w, R] = i.useState(null != N ? N : ""), [P, D] = i.useState(void 0), L = void 0 !== P, {
    analyticsLocations: x
  } = (0, _.ZP)(v, f.Z.GROUP_DM_EDIT_MODAL), k = {
    channel_id: t,
  ...
  i.useEffect(() => {
    o(w !== N || L)
  }, [w, N, L, o]), (0, d.ZP)(() => (g.default.track(b.rMx.GDM_EDIT_INTERACTED, S(I({}, k), {
    action: "opened"
  })), () => {
    g.default.track(b.rMx.GDM_EDIT_INTERACTED, S(I({}, k), {
      action: "dismissed"
    }))
  }));
  let j = e => {
    ...
    let r = w !== N,
      i = void 0 !== P;
    if (g.default.track(b.rMx.GDM_EDIT_INTERACTED, S(I({}, k), {
        action: "saved",
        new_name_set: "" !== w,
