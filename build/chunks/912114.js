...
let E = function(e) {
  let {
    ...
    location: E
  } = e, S = (0, o.e7)([g.Z], () => g.Z.getChannel(t)), P = null == S ? void 0 : S.name, I = (0, m.cO)(S), [Z, T] = i.useState(null != P ? P : ""), [N, A] = i.useState(void 0), w = void 0 !== N, {
  ...
  return (i.useEffect(() => {
    a(Z !== P || w)
  }, [Z, P, w, a]), (0, d.ZP)(() => (b.default.track(y.rMx.GDM_EDIT_INTERACTED, j(v({}, M), {
    action: "opened"
  })), () => {
