/** Chunk was on 8381 **/
/** chunk id: 402350, original params: t,e,r (module,exports,require) **/
"use strict";
...
var Chunk551558 = require("./551558.js"),
  ...
  a = function(t, e) {
    for (var r = [].concat(t).reverse(); r.length;) {
      ...
      e(n);
      var i = n.children;
      Array.isArray(i) || o(false), r = r.concat([].concat(i.reverse()))
    }
  },
  u = function(t) {
    if (!(t && t.type)) returnfalse;
    var e = t.type;
...
module.exports = {
  fromRawTreeStateToRawState: function(t) {
    var e = t.blocks,
      r = [];
    return (Array.isArray(e) || o(false), Array.isArray(e) && e.length) ? (a(e, function(t) {
      var e = n({}, t);
