...
function Q(e, t) {
  if (null != e)
    for (let n of t) {
      ...
      if (null != t && "applications" in t && Array.isArray(t.applications) && t.applications.length > 0) return t.applications[0].id
    }
}
...
function ee(e, t) {
  return null != e && (q(e) || X(e) ? $(e.name.toLowerCase(), t) : null != t && t.id === U.Jk && e.application_id === U.$z || null != e.application_id && en(e.application_id, t))
}

function et(e, t) {
  for (let [n, r] of e)
    if (ee(t, r) && !ea(r)) return r
}
...
let e0 = (e, t) => e > 0 ? (0, i.floor)(Math.min(t / e, 1), 4) : 0,
  ...
  e7 = e => {
    ...
    for (let e of Object.values(null != (n = null == (t = r.userStatus) ? true : t.progress) ? n : {}).sort((e, t) => {
      ...
      if (null != t && (null == i ? true : i.has(t))) return e5({
        quest: r,
        taskType: t,
        includeTaskTypes: i
      })
...
let tl = tt([Chunk754700.X.PLAY_ON_XBOX, Chunk754700.X.PLAY_ON_PLAYSTATION]),
  tc = tt([Chunk754700.X.WATCH_VIDEO, Chunk754700.X.WATCH_VIDEO_ON_MOBILE]),
  tu = tt([Chunk754700.X.WATCH_VIDEO]),
  td = tt([Chunk754700.X.WATCH_VIDEO_ON_MOBILE]),
  tf = e => td(e) && !tu(e);
...
function tN(e) {
  var t;
  let n = null == (t = eC(e)) ? true : t.expirationMode;
  return null != n && K.has(n)
}

function tR(e) {
  var t;
  return tN(e) && (null == (t = eC(e)) ? true : t.expirationMode) === l.n.PREMIUM_PERMANENT
}
...
function tx(e, t) {
  var n, r;
  ea(e) || (null == (n = e.userStatus) ? true : n.enrolledAt) == null || (null == (r = e.userStatus) ? true : r.completedAt) != null || (0, P.cT)(e.id, t)
}
