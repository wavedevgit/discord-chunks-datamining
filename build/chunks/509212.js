...
let W = 2592e6,
  K = new Set([Chunk34738.n.PREMIUM_EXTENSION, Chunk34738.n.PREMIUM_PERMANENT]);
...
function en(e, t) {
  return null != e && (q(e) || X(e) ? et(e.name.toLowerCase(), t) : null != t && t.id === U.Jk && e.application_id === U.$z || null != e.application_id && ei(e.application_id, t))
}

function er(e, t) {
  for (let [n, r] of e)
    if (en(t, r) && !es(r)) return r
}
...
function eA(e) {
  ...
  if ((null == (t = r.userStatus) ? true : t.completedAt) != null) return Z.intl.string(Z.t.BzFeTF);
  if ((null == (n = r.userStatus) ? true : n.enrolledAt) != null) {
    let {
      percentComplete: e
    } = i, t = null != a ? a.percentComplete : e;
    return t >= .75 ? Z.intl.string(Z.t.gvCR4H) : t >= .45 && t <= .55 ? Z.intl.string(Z.t.JNx8sG) : t > 0 ? Z.intl.string(Z.t.JMbfnc) : Z.intl.string(Z.t["7e5k7L"])
  }
  return Z.intl.formatToPlainString(Z.t.EQa7os, {
...
function eD(e) {
  ...
  if (o >= 12) {
    ...
    return Z.intl.formatToPlainString(Z.t.PClsrw, {
      years: e
    })
  } {
    if (o > 0) return Z.intl.formatToPlainString(Z.t.kridzK, {
      months: o
    });
    let e = (0, r.Z)(i, n);
    if (!(e >= 7)) return Z.intl.formatToPlainString(Z.t["k2UNz+"], {
      days: e
    });
    {
      let t = Math.ceil(e / 7);
      return Z.intl.formatToPlainString(Z.t.EmoBD2, {
        weeks: t
      })
    }
  }
...
function eB(e, t) {
  R.Z.captureException(e, Y(V({}, t), {
    tags: Y(V({}, null == t ? true : t.tags), {
      app_context: "quests"
    })
  }))
}
...
function eJ(e) {
  ...
  return null == r ? null : ((0, N.isIOS)() || "ios" === (0, N.getOS)()) && (null == (t = r.ios) ? true : t.iosAppId) != null ? "https://apps.apple.com/app/id".concat(r.ios.iosAppId) : ((0, N.isAndroid)() || "android" === (0, N.getOS)()) && (null == (n = r.android) ? true : n.androidAppId) != null ? "https://play.google.com/store/apps/details?id=".concat(r.android.androidAppId) : null
}
...
let e2 = (e, t) => e > 0 ? (0, i.floor)(Math.min(t / e, 1), 4) : 0,
  ...
  te = e => {
    ...
    for (let e of Object.values(null != (n = null == (t = r.userStatus) ? true : t.progress) ? n : {}).sort((e, t) => {
      ...
      if (null != t && (null == i ? true : i.has(t))) return e7({
        quest: r,
        taskType: t,
        includeTaskTypes: i
      })
...
let tu = tr([Chunk754700.X.PLAY_ON_XBOX, Chunk754700.X.PLAY_ON_PLAYSTATION]),
  td = tr([Chunk754700.X.WATCH_VIDEO, Chunk754700.X.WATCH_VIDEO_ON_MOBILE]),
  tf = tr([Chunk754700.X.WATCH_VIDEO]),
  t_ = tr([Chunk754700.X.WATCH_VIDEO_ON_MOBILE]),
  tp = e => t_(e) && !tf(e);
...
function tC(e) {
  ...
  let {
    ...
    quest: a
  }), u = null != s ? s : null == o ? true : o.platform, d = c ? eQ({
    quest: a,
...
function tN(e) {
  ...
  return t ? null == i ? Z.intl.formatToPlainString(Z.t.Piihy1, {
    gamePublisher: n
...
function tP(e) {
  var t;
  let n = null == (t = eR(e)) ? true : t.expirationMode;
  return null != n && K.has(n)
}

function tD(e) {
  var t;
  return tP(e) && (null == (t = eR(e)) ? true : t.expirationMode) === l.n.PREMIUM_PERMANENT
}
...
function tM(e, t) {
  var n, r;
  es(e) || (null == (n = e.userStatus) ? true : n.enrolledAt) == null || (null == (r = e.userStatus) ? true : r.completedAt) != null || (0, P.cT)(e.id, t)
}
...
let tB = e => e.percentComplete > 0 ? Z.intl.formatToPlainString(Z.t["c59/Tp"], {
  remainTime: tl(e)
}) : Z.intl.formatToPlainString(Z.t.GNsKiW, {
  remainTime: tl(e)
});
...
function tV(e, t) {
  ...
  let {
    quest: r,
    adDecisionData: i
  } = null != (n = w.Z.questToDeliverForPlacement.get(tk(t))) ? n : {};
...
function tH(e) {
  ...
  let {
    metadataRaw: n
  } = null != (t = w.Z.questToDeliverForPlacement.get(tk(e))) ? t : {};
  return n
}
...
function tq(e) {
  ...
  null != s && (null == (t = s.userStatus) ? true : t.enrolledAt) != null && (null == (n = s.userStatus) ? true : n.completedAt) == null && tM(s, o.maxTimestampSec);
