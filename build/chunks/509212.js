...
function ei(e, t) {
  return null != e && (q(e) || X(e) ? er(e.name.toLowerCase(), t) : null != t && t.id === U.Jk && e.application_id === U.$z || null != e.application_id && eo(e.application_id, t))
}

function ea(e, t) {
  for (let [n, r] of e)
    if (ei(t, r) && !ec(r)) return r
}
...
let e4 = (e, t) => e > 0 ? (0, i.floor)(Math.min(t / e, 1), 4) : 0,
  ...
  tn = e => {
    ...
    for (let e of Object.values(null != (n = null == (t = r.userStatus) ? true : t.progress) ? n : {}).sort((e, t) => {
      ...
      if (null != t && (null == i ? true : i.has(t))) return te({
        quest: r,
        taskType: t,
        includeTaskTypes: i
      })
...
let tf = ta([Chunk754700.X.PLAY_ON_XBOX, Chunk754700.X.PLAY_ON_PLAYSTATION]),
  t_ = ta([Chunk754700.X.WATCH_VIDEO, Chunk754700.X.WATCH_VIDEO_ON_MOBILE]),
  tp = ta([Chunk754700.X.WATCH_VIDEO]),
  th = ta([Chunk754700.X.WATCH_VIDEO_ON_MOBILE]),
  tm = e => th(e) && !tp(e);
...
function tR(e) {
  ...
  let {
    ...
    quest: a
  }), u = null != s ? s : null == o ? true : o.platform, d = c ? e$({
    quest: a,
...
function tw(e) {
  var t;
  let n = null == (t = eD(e)) ? true : t.expirationMode;
  return null != n && K.has(n)
}

function tx(e) {
  var t;
  return tw(e) && (null == (t = eD(e)) ? true : t.expirationMode) === l.n.PREMIUM_PERMANENT
}
...
function tj(e, t) {
  var n, r;
  ec(e) || (null == (n = e.userStatus) ? true : n.enrolledAt) == null || (null == (r = e.userStatus) ? true : r.completedAt) != null || (0, P.cT)(e.id, t)
}
...
let tF = e => e.percentComplete > 0 ? Z.intl.formatToPlainString(Z.t["c59/Tp"], {
  remainTime: tu(e)
...
function tY(e, t) {
  ...
  let {
    quest: r,
    adDecisionData: i
  } = null != (n = w.Z.questToDeliverForPlacement.get(tU(t))) ? n : {};
...
function tW(e) {
  ...
  let {
    metadataRaw: n
  } = null != (t = w.Z.questToDeliverForPlacement.get(tU(e))) ? t : {};
  return n
}
...
function tQ(e) {
  ...
  null != s && (null == (t = s.userStatus) ? true : t.enrolledAt) != null && (null == (n = s.userStatus) ? true : n.completedAt) == null && tj(s, o.maxTimestampSec);
