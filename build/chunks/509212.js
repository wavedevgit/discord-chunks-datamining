...
function eT(e, t) {
  v.Z.captureException(e, j(M({}, t), {
    tags: j(M({}, null == t ? true : t.tags), {
      app_context: "quests"
    })
  }))
}
...
let eU = (e, t) => e > 0 ? (0, i.floor)(Math.min(t / e, 1), 4) : 0,
  ...
  eW = e => {
    ...
    for (let e of Object.values(null != (n = null == (t = r.userStatus) ? true : t.progress) ? n : {}).sort((e, t) => {
      ...
      if (null != t && (null == i ? true : i.has(t))) return eH({
        quest: r,
        taskType: t,
        includeTaskTypes: i
      })
...
let e1 = eq([Chunk754700.X.PLAY_ON_XBOX, Chunk754700.X.PLAY_ON_PLAYSTATION]),
...
function tl(e) {
  ...
  let {
    ...
    quest: a
  }), u = null != s ? s : null == o ? true : o.platform, d = c ? ex({
    quest: a,
...
let tO = e => e.percentComplete > 0 ? L.intl.formatToPlainString(L.t["c59/Tk"], {
  remainTime: e$(e)
...
function tT(e, t) {
  ...
  let {
    quest: r,
    adDecisionData: i
  } = null != (n = S.Z.questToDeliverForPlacement.get(tg(t))) ? n : {};
...
function tS(e) {
  ...
  let {
    metadataRaw: n
  } = null != (t = S.Z.questToDeliverForPlacement.get(tg(e))) ? t : {};
  return n
}
...
function tP(e) {
  ...
  let {
    ...
    videoSessionId: a
  } = e, o = N.ZP.getState().getVideoProgress(r);
  if (null == o) return;
