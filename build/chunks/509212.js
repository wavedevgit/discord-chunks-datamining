...
function eo(e, t) {
  return null != e && (X(e) || Q(e) ? ea(e.name.toLowerCase(), t) : null != t && t.id === G.Jk && e.application_id === G.$z || null != e.application_id && el(e.application_id, t))
}

function es(e, t) {
  for (let [n, r] of e)
    if (eo(t, r) && !ed(r)) return r
}
...
let e7 = (e, t) => e > 0 ? (0, i.floor)(Math.min(t / e, 1), 4) : 0,
  ...
  to = e => {
    ...
    for (let e of Object.values(null != (n = null == (t = r.userStatus) ? true : t.progress) ? n : {}).sort((e, t) => {
      ...
      if (null != t && (null == i ? true : i.has(t))) return ti({
        quest: r,
        taskType: t,
        includeTaskTypes: i
      })
...
let tg = tu([Chunk754700.X.PLAY_ON_XBOX, Chunk754700.X.PLAY_ON_PLAYSTATION]),
  tE = tu([Chunk754700.X.WATCH_VIDEO, Chunk754700.X.WATCH_VIDEO_ON_MOBILE]),
  tb = tu([Chunk754700.X.WATCH_VIDEO]),
  ty = tu([Chunk754700.X.WATCH_VIDEO_ON_MOBILE]),
  tO = e => ty(e) && !tb(e);
...
function tx(e) {
  ...
  let {
    ...
    quest: a
  }), c = null != s ? s : null == o ? true : o.platform, u = l ? e3({
    quest: a,
    idx: null != (r = null == o ? true : o.tier) ? r : null == (t = a.userStatus) ? true : t.claimedTier
  }) : null, d = nn(a.config), f = null != (i = null == u || null == (n = u.messages) ? true : n.redemptionInstructionsByPlatform) ? i : d.messages.redemptionInstructionsByPlatform;
...
function tF(e, t) {
  var n, r;
  ed(e) || (null == (n = e.userStatus) ? true : n.enrolledAt) == null || (null == (r = e.userStatus) ? true : r.completedAt) != null || (0, D.cT)(e.id, t)
}
...
function tQ(e, t) {
  ...
  let {
    quest: r,
    adDecisionData: i
  } = null != (n = L.Z.questToDeliverForPlacement.get(tV(t))) ? n : {};
...
function tJ(e) {
  ...
  let {
    metadataRaw: n
  } = null != (t = L.Z.questToDeliverForPlacement.get(tV(e))) ? t : {};
  return n
}
...
function t2(e) {
  ...
  null != s && (null == (t = s.userStatus) ? true : t.enrolledAt) != null && (null == (n = s.userStatus) ? true : n.completedAt) == null && tF(s, o.maxTimestampSec);
