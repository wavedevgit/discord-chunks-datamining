...
function er(e, t) {
  return null != e && (q(e) || X(e) ? en(e.name.toLowerCase(), t) : null != t && t.id === U.Jk && e.application_id === U.$z || null != e.application_id && ea(e.application_id, t))
}

function ei(e, t) {
  for (let [n, r] of e)
    if (er(t, r) && !el(r)) return r
}
...
let e3 = (e, t) => e > 0 ? (0, i.floor)(Math.min(t / e, 1), 4) : 0,
  ...
  tt = e => {
    ...
    for (let e of Object.values(null != (n = null == (t = r.userStatus) ? true : t.progress) ? n : {}).sort((e, t) => {
      ...
      if (null != t && (null == i ? true : i.has(t))) return e9({
        quest: r,
        taskType: t,
        includeTaskTypes: i
      })
...
let td = ti([Chunk754700.X.PLAY_ON_XBOX, Chunk754700.X.PLAY_ON_PLAYSTATION]),
  tf = ti([Chunk754700.X.WATCH_VIDEO, Chunk754700.X.WATCH_VIDEO_ON_MOBILE]),
  t_ = ti([Chunk754700.X.WATCH_VIDEO]),
  tp = ti([Chunk754700.X.WATCH_VIDEO_ON_MOBILE]),
  th = e => tp(e) && !t_(e);
...
function tN(e) {
  ...
  let {
    ...
    quest: a
  }), u = null != s ? s : null == o ? true : o.platform, d = c ? eJ({
    quest: a,
...
function tw(e) {
  var t;
  return tD(e) && (null == (t = eP(e)) ? true : t.expirationMode) === l.n.PREMIUM_PERMANENT
}
...
function tk(e, t) {
  var n, r;
  el(e) || (null == (n = e.userStatus) ? true : n.enrolledAt) == null || (null == (r = e.userStatus) ? true : r.completedAt) != null || (0, P.cT)(e.id, t)
}
...
let tZ = e => e.percentComplete > 0 ? Z.intl.formatToPlainString(Z.t["c59/Tp"], {
  remainTime: tc(e)
...
function tH(e, t) {
  ...
  let {
    quest: r,
    adDecisionData: i
  } = null != (n = w.Z.questToDeliverForPlacement.get(tj(t))) ? n : {};
...
function tY(e) {
  ...
  let {
    metadataRaw: n
  } = null != (t = w.Z.questToDeliverForPlacement.get(tj(e))) ? t : {};
  return n
}
...
function tX(e) {
  ...
  null != s && (null == (t = s.userStatus) ? true : t.enrolledAt) != null && (null == (n = s.userStatus) ? true : n.completedAt) == null && tk(s, o.maxTimestampSec);
