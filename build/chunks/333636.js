...
let o = function(e) {
  let {
    onClose: t,
    transitionState: n
  } = e, [o, A] = l.useState(null), [d, u] = l.useState(null), [T, C] = l.useState(null), [h, f] = l.useState(""), p = async () => {
    if (o) {
      f("");
      try {
        await (0, i.qy)(o, {
  ...
  return (0, a.jsxs)(s.Y0X, {
    ...
    children: [(0, a.jsxs)(s.xBx, {
      ...
      }), o === i.fw.HCAPTCHA_RQDATA && (0, a.jsx)(s.q4e, {
        value: d,
        options: r.Z,
        onChange: e => {
          o === i.fw.HCAPTCHA_RQDATA && u(e)
        }
      }), (o === i.fw.HCAPTCHA_RQDATA || o === i.fw.SMITE_RQDATA) && (0, a.jsx)(s.XZJ, {
        value: null != T && T,
        onChange: (e, t) => C(t),
