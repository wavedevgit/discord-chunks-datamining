...
let c = function(e) {
  let {
    onClose: t,
    transitionState: a
  } = e, [c, A] = l.useState(null), [d, u] = l.useState(null), [T, C] = l.useState(null), [h, p] = l.useState(""), f = async () => {
    if (c) {
      p("");
      try {
        await (0, r.qy)(c, {
  ...
  return (0, n.jsxs)(s.Y0X, {
    ...
    children: [(0, n.jsxs)(s.xBx, {
      ...
      }), c === r.fw.HCAPTCHA_RQDATA && (0, n.jsx)(s.q4e, {
        value: d,
        options: i.Z,
        onChange: e => {
          c === r.fw.HCAPTCHA_RQDATA && u(e)
        }
      }), (c === r.fw.HCAPTCHA_RQDATA || c === r.fw.SMITE_RQDATA) && (0, n.jsx)(s.XZJ, {
        value: null != T && T,
        onChange: (e, t) => C(t),
