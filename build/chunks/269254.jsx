...
function b(t) {
  ...
  }), A = null != h ? <a.sN id={"copy"} label={p.intl.string(p.t.ad58UF)} action={() => (0, d.JG)(h)} /> : null, I = (0, r.Z)({
    id: g,
  ...
  return <s.v2r navId={"expression-picker"} onClose={l.Zy} aria-label={p.intl.string(p.t.XoasSE)} onSelect={i} className={"context-menu"}><s.kSQ>{x}{d.wS && v ? null != A ? A : I : null}</s.kSQ></s.v2r>
}