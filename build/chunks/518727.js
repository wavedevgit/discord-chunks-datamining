...
let L = e => {
  let {
  ...
  } = e, o = (0, l.e7)([C.Z], () => C.Z.useReducedMotion), [L, b] = (0, i.useState)("entry"), g = (0, i.useRef)(null), y = (0, i.useRef)(null), S = () => {
    ...
    wasTier2PremiumBeforePurchase: v,
    selectedSkuId: I,
    purchaseState: w
  } = (0, f.JL)(), [O, P] = (0, i.useState)(!1);
  (0, i.useEffect)(() => {
  ...
  (0, i.useEffect)(() => {
    ...
    return p.S.subscribe(h.CkL.PREMIUM_PAYMENT_MODAL_CLOSED, e), () => {
