...
let x = e => {
  let {
  ...
  } = e, [o, x] = (0, i.useState)("entry"), h = (0, i.useRef)(null), j = (0, i.useRef)(null), L = () => {
    ...
    wasTier2PremiumBeforePurchase: g,
    selectedSkuId: y
  } = (0, p.JL)(), S = (0, C.P)(b, !!g, y), {
    mediaUrls: E,
    isSuccess: v
  } = (0, _.Z)(S), I = (0, i.useRef)(null), [w, O] = (0, i.useState)(!1);
  (0, i.useEffect)(() => {
    function e() {
      O(!0), L()
    }
    return c.S.subscribe(f.CkL.PREMIUM_PAYMENT_MODAL_CLOSED, e), () => {
