...
let h = e => {
  let {
  ...
  } = e, [o, h] = (0, i.useState)("entry"), j = (0, i.useRef)(null), L = (0, i.useRef)(null), b = () => {
    ...
    wasTier2PremiumBeforePurchase: y,
    selectedSkuId: S,
    purchaseState: E
  } = (0, p.JL)(), [v, I] = (0, i.useState)(!1);
  (0, i.useEffect)(() => {
  ...
  (0, i.useEffect)(() => {
    ...
    return c.S.subscribe(m.CkL.PREMIUM_PAYMENT_MODAL_CLOSED, e), () => {
