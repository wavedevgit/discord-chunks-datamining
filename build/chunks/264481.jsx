...
function y(e) {
  ...
  return <div className={g.empty}>{<div className={g.textContainer}>{<o.X6q variant={"heading-md/medium"} color={"header-primary"}>{t}</o.X6q>}{<o.Text variant={"text-sm/normal"} color={"header-secondary"}>{n}</o.Text>}</div>}{l}</div>
}
...
function v() {
  ...
  return <y heading={module} bodyText={exports} />
}
...
function _(e) {
  ...
  return <y heading={m} bodyText={b}><div className={g.buttonRow}><f.tG icon={o.kBi} text={p.intl.string(p.t["g33r/P"])} onClick={j} themeColor={"secondary"} /></div></y>
}

function I() {
  let e = (0, Chunk410030.ZP)();
  return <div className={Chunk771627.connectionPlatforms}>{x.map((t, n) => {
      let l = d.Z.get(t);
...
function P(e) {
  ...
  return <y heading={p.intl.string(p.t.VB6LWV)} bodyText={p.intl.string(p.t.KpjsU1)}>{<I />}{<div className={g.buttonRow}>{<f.tG text={p.intl.string(p.t["/Hl24e"])} onClick={n} themeColor={"secondary"} />}{<f.tG text={p.intl.string(p.t.GTCx0t)} onClick={i} themeColor={"secondary"} />}</div>}</y>
}