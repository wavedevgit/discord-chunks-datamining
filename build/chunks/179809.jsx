...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk199540 = require("./199540.js"),
  Chunk40153 = require("./40153.jsx"),
  Chunk252686 = require("./252686.js"),
...
let P = (0, Chunk624138.Mg)(Chunk477690.Z.FOLDER_ITEM_ANIMATION_DURATION),
  ...
  w = Chunk73800.memo(function(e) {
    ...
    let [{
      ...
      config: {
        duration: P
    ...
    }), ea = i.useCallback(e => null == n ? true : n(H, e), [n, H]), ec = <v.H>{<O.Z disabled={$ || a} hovered={K} selected={l} unread={Z} className={I.pill} />}{<j.Z text={er} disabled={R} selected={l} disableWrapper={true}><div ref={A ? e => {
            ee(e)
          } : true} className={o()(x.folderHeader, {
            [x.folderHeaderSmall]: "icon" === G || J,
            [I.wobble]: !$ && q && !a
          })} data-dnd-name={er}>{$ ? (0, r.jsx)(C.Z, {
            isFolder: true
          }) : (0, r.jsx)(_.Z, {
            folderNode: t,
            expanded: a,
            ...
            "aria-setsize": V,
            "aria-posinset": F
          })}</div></j.Z>}{A ? <y.ZP name={er} targetNode={t} onDragOverChanged={et} /> : null}</v.H>, eu = null != t.color ? t.color : E.Wyy, ed = eu === E.Wyy ? true : (0, u.Rf)(eu);
    return <div ref={ea} className={o()(x.folderGroup, {
        [x.isExpanded]: a,
        [x.isHovering]: Q
      })} style={{
        "--custom-folder-color": null != ed ? ed : ""
      }} data-drop-hovering={q}>{!$ && a && <span className={x.folderGroupBackground} />}{ec}{es((e, n, i) => {
        let {
          key: l
        } = i;
        return n && <N id={el} role={"group"} as={"ul"} gap={"xs"} className={x.folderGuildsList} style={{
            height: e.height.to(e => e * eo)
          }} aria-label={t.name}>{W.map((t, n) => U(t, n, W.length, e.height))}</N>
      })}{A && a ? <y.Zu name={er} targetNode={t} /> : null}</div>
  })