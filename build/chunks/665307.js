  ...
  k = [{
    ...
    render(e, t, n) {
      ...
      return (0, i.jsxs)(l.Fragment, {
        ...
        }), (0, C.Je)(e.libraryApplication) ? (0, i.jsx)(m.Z, {
...
class U extends(r = l.PureComponent) {
  ...
  handleHighlightedApplicationKey() {
    ...
    null != e && null != this._rowRefs[e] && (this.props.scrollToRow(this._rowRefs[e], w), new u.V7().start(L, () => {
  ...
  trackViewed() {
    ...
    v.default.track(T.rMx.LIBRARY_VIEWED, Z(x({}, e), {
      load_id: t.loadId
    }))
  }
  handleSort(e, t) {
  ...
  renderImportHelp() {
    let e, {
      ...
      r = t.length > 0;
    return r ? null : (e = "" !== n ? P.intl.format(P.t["4Q1TAg"], {
      query: n
    }) : P.intl.string(P.t["0Y+0PT"]), (0, i.jsxs)("div", {
