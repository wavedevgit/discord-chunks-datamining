...
function C(e) {
  let {
    guild: t,
    selected: C
  } = e, S = (0, p.Z)(t), E = (0, u.Nj)(o.z.CHANNEL_BROWSER_NEW_BADGE_NUX), P = (0, l.Wu)([h.Z], () => Array.from(h.Z.getNewChannelIds(t.id)).filter(e => h.Z.shouldIndicateNewChannel(t.id, e))), I = (0, l.e7)([g.ZP], () => g.ZP.hasUnread(t.id, v.W.GUILD_ONBOARDING_QUESTION)), N = P.length > b.Cb, w = (0, l.e7)([d.Z, g.ZP], () => {
  ...
  return E && !I && !N || C || w || (A = (0, r.jsx)(s.IGR, {
    ...
    text: S ? j.intl.string(j.t.h9mGOD) : j.intl.string(j.t.et6wam),
    selected: C,
    onClick: Z,
    onContextMenu: T,
    trailing: A
