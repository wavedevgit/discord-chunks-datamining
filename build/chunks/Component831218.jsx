...
let F = e => {
  ...
  } = e, f = l.Children.count(o), g = T.Z.getMutablePrivateChannels(), O = (0, N.k1)(g), y = (0, p.Wu)([R.Z, I.Z, w.Z], () => {
  ...
  })), A = l.useRef(null), D = null != s ? s : A, L = l.useCallback(e => {
    let t = D.current,
