/** Chunk was on 12858 **/
/** chunk id: 404339, original params: e,n,t (module,exports,require) **/
require.d(exports, {
  default: () => x
...
function x(e) {
  let {
    ...
    onClose: E,
    onJoin: p
  } = e, A = Array.from(t).map(e => l.default.getUser(e)).filter(e => null !== e), C = Array.from(x).map(e => l.default.getUser(e)).filter(e => null !== e);
  return 0 === A.length && 0 === C.length ? null : (0, i.jsx)(u.Z, {
    headerText: g.intl.string(g.t.zPUmzZ),
    descriptionText: ((e, n) => {
      let t = e > 0,
        i = n > 0;
      return t && i ? g.intl.string(g.t["X/iIjg"]) : t ? g.intl.formatToPlainString(g.t.WgQ12s, {
        n: e
    ...
    infoRows: (e => {
      let {
        ...
        blockedUsers: t,
        ignoredUsers: r
      } = e, l = o.Z.getChannel(n), d = t.length > 0, c = r.length > 0, u = [{
        icon: (0, i.jsx)("div", {
          className: N.icon,
      ...
      if (d && c) {
        ...
        u.unshift({
          ...
          text: (0, m.a)(o, e.length, null == l ? true : l.guild_id, n),
          className: N.row
        })
      } else {
        ...
        u.unshift({
          ...
          text: (0, m.a)(e, s, null == l ? true : l.guild_id, n),
          className: N.row
        })
      }
      return u
    ...
    onDismissAndStay: () => {
      p(), E(), (0, c.dI)(new Set([...t, ...x])), d.default.track(f.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
    ...
    onDismissAndLeave: () => {
      E(), d.default.track(f.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
