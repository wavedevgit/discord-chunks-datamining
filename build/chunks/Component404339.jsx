...
function N(e) {
  let {
    ...
    onClose: j,
    onJoin: E
  } = e, v = Array.from(r).map(e => o.default.getUser(e)).filter(e => null !== e), k = Array.from(N).map(e => o.default.getUser(e)).filter(e => null !== e);
  return 0 === v.length && 0 === k.length ? null : (0, t.jsx)(m.Z, {
    ...
    onDismissAndStay: () => {
      E(), j(), (0, c.dI)(new Set([...r, ...N])), d.default.track(f.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
    ...
    onDismissAndLeave: () => {
      j(), d.default.track(f.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
