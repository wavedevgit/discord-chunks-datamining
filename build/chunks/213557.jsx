...
function R(e) {
  ...
  let J = [];
  return (q || J.push(<_.Z channel={M} />), J.push(<x.ZP.Icon icon={a.Dio} tooltip={T.intl.string(T.t.cpT0Cg)} onClick={() => v.Z.closeChannelSidebar(R)} />), !(0, d.aC)(M) || W && G) ? <l.Fragment>{<s.Z channel={M} draftType={O.d.ChannelMessage} />}{<x.ZP toolbar={J} aria-label={T.intl.string(T.t.BIYAqa)}>{(0, C.ud)({
        channel: M,
        channelName: z ? X : F,
        guild: H,
        inSidebar: true,
      ...
      })}</x.ZP>}{<div className={A.chat}><E.Z channel={M} guild={H} chatInputType={h.Ie.SIDEBAR} /></div>}</l.Fragment> : <c.Z guild={H} channelId={M.id} />
}