...
function c(e) {
  return {
    ...
    [i.jj.FLAG_TO_CHANNEL]: (t, a) => new Promise(c => {
      (0, l.ZDy)(async () => {
        let {
          default: l
        } = await n.e("74543").then(n.bind(n, 643611)), s = t.actions.find(e => e.type === i.jj.FLAG_TO_CHANNEL);
        return n => (0, r.jsx)(l, u(o({
          action: a,
          isEdit: null != s,
    ...
    [i.jj.USER_COMMUNICATION_DISABLED]: (e, t) => new Promise(a => {
      (0, l.ZDy)(async () => {
        let {
          default: l
        } = await n.e("78273").then(n.bind(n, 41767)), c = e.actions.find(e => e.type === i.jj.USER_COMMUNICATION_DISABLED);
        return n => (0, r.jsx)(l, u(o({
          action: t,
          isEdit: null != c,
...
function f(e) {
  (0, l.h7j)(t => (0, r.jsx)(l.ConfirmModal, u(o({
