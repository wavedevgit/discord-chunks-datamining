...
function w(e) {
  let {
    ...
    status: u,
    activities: p
  } = e, h = (0, a.e7)([x.Z], () => null != x.Z.getTypingUsers(s.id)[t.id]), g = (0, a.e7)([O.default], () => O.default.getCurrentUser()), v = (0, a.e7)([_.Z], () => _.Z.isMobileOnline(t.id)), C = (0, a.e7)([y.Z], () => y.Z.getNickname(t.id)), S = (0, f.Z)(t.id), P = i.useRef(null), N = e => {
    (0, o.jW)(e, async () => {
      let {
        default: e
