/** Chunk was on web.js **/
/** chunk id: 828363, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  r: () => s
});
...
let o = 1948320,
  a = [0, 31, 62, 93, 124, 155, 186, 216, 246, 276, 306, 336];
class s {
  fromJulianDay(e) {
    let t = e - o,
  ...
  toJulianDay(e) {
    let t = o - 1 + 365 * (e.year - 1) + Math.floor((8 * e.year + 21) / 33);
    return t += a[e.month - 1], t += e.day
  }
  getMonthsInYear() {
    return 12
  }
