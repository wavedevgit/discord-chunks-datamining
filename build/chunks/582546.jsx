...
function h(e) {
  ...
  if (!y) return <o.sNh id={"connect-spotify"} label={p.intl.formatToPlainString(p.t.XWSHTU, {
      platform: _.ai
    })} action={() => {
      null == g || g({
  ...
  return null == O ? null : <o.sNh id={"play-on-spotify"} label={p.intl.string(p.t.rRffNz)} action={() => {
      null == g || g({
