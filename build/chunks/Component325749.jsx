...
function Y(e) {
  let {
    applicationId: n,
    channelId: t
  } = e, a = (0, c.e7)([m.Z], () => m.Z.getApplication(n)), Y = (0, c.e7)([E.ZP], () => E.ZP.getSelfEmbeddedActivities().get(n)), J = (0, c.e7)([N.Z], () => N.Z.getChannel(t)), V = g.Sb.useSetting(), q = (0, c.Wu)([j.ZP], () => {
    var e;
    ...
    let {
      ...
      null != t && o && (a(false), (0, A.Pr)(t, n))
    }, [t, n, o]), c = r.useCallback(() => {
      null != t && (o ? i() : (a(true), (0, A.Dj)(t)))
    }, [t, o, i]), l = r.useCallback(() => {
      null != t && !(0, A.rB)(t, n) && o && c()
    }, [t, n, o, c]);
    return r.useEffect(() => (null == n || n.addEventListener(A.NO, l), () => {
      ...
      children: [(0, o.jsxs)("div", {
        ...
        children: [(0, o.jsx)("div", {
          ...
          children: [(0, o.jsx)(P.Z, {
            ...
            onOpenPopout: () => {},
            onClosePopout: () => {
              (0, p.yw)(F.rMx.ACTIVITY_POPOUT_POP_IN_BUTTON_CLICKED), (0, R.Z)({
                onConfirm: () => {
                  z.Z.popInActivity()
                }
              })
