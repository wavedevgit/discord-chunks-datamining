...
function B(e) {
  ...
  if (r.useEffect(() => {
      ...
      (null == v ? true : v.bot) && H === C.FetchState.NOT_FETCHED && s.Z.fetch()
  ...
  if (y === R.d4z.DM) {
    let e;
    return null != v && null != M ? null != B && (e = (0, i.jsxs)("div", {
  ...
  if (n.isMultiUserDM())
    if (n.isManaged()) return (0, i.jsxs)(E.ZP, {
      channelId: n.id,
      children: [(0, i.jsx)(E.Ot, {
