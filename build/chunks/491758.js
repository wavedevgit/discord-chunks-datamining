...
function A() {
  ...
  let L = (0, a.e7)([m.default], () => m.default.locale),
    ...
    M = r.useMemo(() => [{
      ...
      label: T.intl.formatToPlainString(T.t.TEOC0N, {
        resolution: S.LY.RESOLUTION_720
      })
    }, {
      value: S.LY.RESOLUTION_1080,
      label: T.intl.formatToPlainString(T.t.TEOC0N, {
        resolution: S.LY.RESOLUTION_1080
      })
    }, {
      value: S.LY.RESOLUTION_1440,
      label: T.intl.formatToPlainString(T.t.TEOC0N, {
        resolution: S.LY.RESOLUTION_1440
      })
    }, {
    ...
    U = r.useMemo(() => [{
      value: S.ws.FPS_15,
      label: T.intl.formatToPlainString(T.t.Qb44XF, {
        fps: S.ws.FPS_15
      })
    }, {
      value: S.ws.FPS_30,
    ...
    children: [(0, i.jsxs)(o.hjN, {
      ...
      children: [!e && (0, i.jsx)(p.Z, {
        ...
        children: T.intl.format(T.t.kiaF4e, {
          onClick: () => d.Z.open(C.oAB.VOICE, v.gP, {
      ...
      children: [(0, i.jsx)(o.$i$, {}), (0, i.jsx)(o.hjN, {
