...
function C(e) {
  let {
    channel: t,
    baseChannelId: n
  } = e, C = (0, O.ZP)(t), S = (0, f.K)(), N = (0, f.V)(), T = (0, l.e7)([d.Z], () => d.Z.isMessageRequest(t.id)), j = (0, l.e7)([p.Z], () => p.Z.isSpam(t.id)), P = (0, g.V)(t.id, t.getRecipientId()), x = i.useCallback(() => {
    b.Z.closeChannelSidebar(_.uZ), T && S && (0, m.Kh)(t.id), j && N && (0, m.Kh)(t.id)
  }, [t.id, j, N, T, S]), A = i.useCallback(() => {
