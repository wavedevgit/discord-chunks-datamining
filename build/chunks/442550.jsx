...
function m(e) {
  ...
  if (null == t || O && S) return <l.IMN size={"custom"} width={"100%"} height={"100%"} color={(0, s.wj)(b) ? l.TVs.colors.WHITE : l.TVs.colors.BLACK} style={{
      maxWidth: y
  ...
  return <l.ua7 aria-label={p} text={p} shouldShow={E}>{e => (0, r.jsx)("img", h(_({}, e), {
      style: A,
      className: a()(d.contentImage, f),
      src: O && null != m ? m : t,
      "aria-hidden": g,
