...
let O = e => {
    ...
    return (0, r.jsx)(o.ua7, {
      ...
      children: e => {
        ...
        return (0, r.jsx)(o.P3F, j(v({}, p), {
          className: s,
          onClick: a,
          onContextMenu: e => (0, c.jW)(e, () => Promise.all([n.e("79695"), n.e("70205"), n.e("53912"), n.e("32325")]).then(n.bind(n, 354741)).then(e => {
            let {
              default: n
            } = e;
  ...
  I = e => {
    let {
      ...
      children: n,
      inlineEditor: l
    } = e, c = t.id, u = t.name, h = (0, p.ZP)(t), f = (0, p.cO)(t), [m, b] = i.useState(!1), _ = i.useCallback(() => l ? b(u) : (0, g.B)(c, d.Z.HEADER_BAR), [l, u, c]), v = l ? y.t.pYO54e : y.t["5Q9+/P"];
    return l ? (0, r.jsxs)("div", {
      className: C.newWrapper,
      children: [(0, r.jsxs)("div", {
        className: a()(C.hoverableContainer, {
          [C.editing]: !1 !== m
        }),
        onDoubleClick: e => e.stopPropagation(),
        ...
        children: [(0, r.jsx)(o.Text, {
          ...
          children: y.intl.format(y.t.HVqAgI, {
            onCancel: () => b(!1)
          })
        })]
      })]
