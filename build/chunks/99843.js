...
let C = e => {
  ...
  x = e => {
    let {
      channel: t,
      children: n
    } = e, l = t.id, c = t.name, d = (0, u.ZP)(t), p = (0, u.cO)(t), [h, f] = i.useState(!1);
    return (0, r.jsxs)("div", {
      className: b.newWrapper,
      children: [(0, r.jsxs)("div", {
        className: o()(b.hoverableContainer, {
          [b.editing]: !1 !== h
        }),
        onDoubleClick: e => e.stopPropagation(),
        children: [n, !1 === h ? (0, r.jsxs)(r.Fragment, {
        ...
        children: [(0, r.jsx)(a.Text, {
          ...
          children: g.NW.format(g.t.HVqAgI, {
            onCancel: () => f(!1)
          })
        })]
      })]
