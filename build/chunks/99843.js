...
let E = e => {
    ...
    return (0, _.m$)({
      ...
      children: e => (0, r.jsx)(s.tQf, O(j({}, e), {
        size: "xs",
  ...
  S = e => {
    ...
    return (0, r.jsx)(s.ua7, {
      ...
      children: e => {
        ...
        return (0, r.jsx)(s.P3F, O(j({}, d), {
          className: o,
          onClick: a,
          onContextMenu: e => (0, u.jW)(e, () => Promise.all([n.e("79695"), n.e("70205"), n.e("53912"), n.e("52495")]).then(n.bind(n, 354741)).then(e => {
            let {
              default: n
            } = e;
            return e => (0, r.jsx)(n, O(j({}, e), {
              channel: t,
              selected: !0
            }))
          }), {
          ...
          onMouseEnter: () => {
            null == c || c(), y.default.track(C.rMx.GDM_EDIT_INTERACTED, {
              channel_id: t.id,
  ...
  P = e => {
    let {
      ...
      children: n,
      inlineEditor: l
    } = e, u = t.id, d = t.name, f = (0, h.ZP)(t), m = (0, h.cO)(t), [g, _] = i.useState(!1), y = i.useCallback(() => l ? _(d) : (0, b.B)(u, p.Z.HEADER_BAR), [l, d, u]), j = l ? x.t.pYO54e : x.t["5Q9+/P"];
    return l ? (0, r.jsxs)("div", {
      className: v.newWrapper,
      children: [(0, r.jsxs)("div", {
        className: a()(v.hoverableContainer, {
          [v.editing]: !1 !== g
        }),
        onDoubleClick: e => e.stopPropagation(),
        children: [n, !1 === g ? (0, r.jsxs)(r.Fragment, {
          children: [(0, r.jsxs)(S, {
            channel: t,
  ...
  I = e => {
    let {
      channel: t,
      children: n
    } = e, l = (0, h.ZP)(t), a = i.useCallback(e => {
