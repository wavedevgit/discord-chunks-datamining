...
function _() {
  ...
  let m = (0, s.e7)([p.Z], () => p.Z.theme),
    ...
    C = (0, c.p)(h.h7.AUDIO_INPUT),
    E = (0, c.p)(h.h7.AUDIO_OUTPUT),
    [O, v] = (0, c.L)(h.h7.AUDIO_INPUT, {
      location: "UserSettingsDevices"
    }),
    [S, T] = (0, c.L)(h.h7.AUDIO_OUTPUT, {
      location: "UserSettingsDevices"
    }),
    I = O.concat(v),
    N = S.concat(T),
    y = r.useMemo(() => {
      ...
      return e && t && (null == C ? void 0 : C.containerId) != null && C.containerId === (null == E ? void 0 : E.containerId)
    }, [C, E]),
    A = I[0],
    P = N[0],
