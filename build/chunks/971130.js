...
let g = (e, t) => null != e && l.ZP.isMember(e, t),
  m = e => {
    ...
    if (null != I)
      for (let e of I) {
        ...
        !(null == I || g(r, I.id)) && (i.add(I.id), O.push({
          type: "FRIEND",
          item: I,
          isSuggested: !0
        }), l.numFriends++)
  ...
  D = e => {
    ...
    r === S.Iq.EMBEDDED_APPLICATION && a.ZP.queryChannels({
      query: t,
      limit: 3,
      guildId: void 0
    }).forEach(e => {
  ...
  V = e => {
    ...
    a.ZP.queryDMUsers({
      ...
      null != l && null != u.ZP.lastMessageId(l) && (n.add(t.id), r.push({
        type: "DM",
        item: t,
        isSuggested: !1
      }), i.numDms++)
  ...
  h = e => {
    ...
    a.ZP.queryFriends({
      ...
      !(r.has(t.id) || i.has(t.id)) && (i.add(t.id), I.push({
        type: "FRIEND",
        item: t,
        isSuggested: !1
      }), n.numFriends++)
...
function U(e) {
  ...
  if ("" === t) {
    ...
    I === S.Iq.EMBEDDED_APPLICATION && (c(P(o({}, e), {
      includeGroupDms: !1,
      limit: 1
    })), d(P(o({}, e), {
      suggestedChannelIds: i
    ...
    I === S.Iq.EMBEDDED_APPLICATION && D(P(o({}, e), {
      inviteTargetType: I
    })), V(P(o({}, e), {
      omitUserIds: n,
      shownUserIds: u
...
function v(e, t) {
  ...
  switch (A[e].type) {
    ...
    case b.HOURS:
      if (n) return E.NW.formatToPlainString(E.t.ZVdJMz, {
        numHours: r
      });
    ...
    case b.DAYS:
      if (n) return E.NW.formatToPlainString(E.t.T96qsr, {
        numDays: r
      });
