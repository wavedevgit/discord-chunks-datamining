...
function x(e) {
  ...
  return <u.Gt value={v}><div className={a()(b.container, h[j])}>{<div className={b.background}><div className={b.backgroundGradient} /></div>}{N((t, n) => <i.animated.div style={t} className={b.animationContainer}>{n ? (0, r.jsx)(m.Z, y({}, e)) : (0, r.jsx)(p.Z, y({}, e))}</i.animated.div>)}</div></u.Gt>
}