/** Chunk was on 75387 **/
/** chunk id: 397326, original params: e,t,r (module,exports,require) **/
"use strict";
require.d(exports, {
  a: () => u
});
...
var a = ["canDrag", "beginDrag", "isDragging", "endDrag"],
  ...
  c = function() {
    ...
    return e = [{
        ...
        key: "endDrag",
        value: function() {
          this.props && this.spec.endDrag && this.spec.endDrag(this.props, this.monitor, (0, Chunk498890.Al)(this.ref))
        }
      }],
      function(e, t) {
