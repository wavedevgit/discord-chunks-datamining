...
function h(e) {
  let {
    ...
    className: l,
    iconClassName: h
  } = e, [g, E] = (0, s.Wu)([u.Z], () => [u.Z.desaturateUserColors, u.Z.saturation]), b = (0, c.dQu)(p).hex(), y = null != t ? t : b, O = (0, a.ho)((0, a._i)(y), false, g ? E : null), v = (0, c.dQu)(_).hex(), S = (0, c.dQu)(m).hex(), I = null != i ? i : (0, d.B)({
    backgroundColor: y,
    colors: [v, S]
  }), T = n / 8;
  return (0, r.jsx)("div", {
