...
function m(e) {
  let {
    ...
    className: l,
    iconClassName: m
  } = e, [g, E] = (0, s.Wu)([u.Z], () => [u.Z.desaturateUserColors, u.Z.saturation]), b = (0, c.dQu)(_).hex(), y = null != t ? t : b, O = (0, o.ho)((0, o._i)(y), false, g ? E : null), v = (0, c.dQu)(p).hex(), I = (0, c.dQu)(h).hex(), S = null != i ? i : (0, d.B)({
    backgroundColor: y,
    colors: [v, I]
  }), T = n / 8;
  return (0, r.jsx)("div", {
