...
let D = i.forwardRef(function(e, t) {
  ...
  let {
    type: x,
    animateRef: v
  } = e, j = (0, a.e7)([y.Z], () => y.Z.shouldShowPopup() && y.Z.activeViewType() === x), {
    badgeTreatment: E
  } = h.Y.useExperiment({
    ...
    events: S,
    play: Z
  } = (0, O.Z)("ChannelAppLauncherButton"), {
    Component: T,
    play: L
  } = (0, c.B)(), {
    Component: D,
    play: W
  } = (0, u.P)(), U = (0, N.Q3)("ChannelAppLauncherButton");
  ...
  let B = i.useCallback(() => {
    (0, b.yw)(A.rMx.APP_LAUNCHER_ENTRYPOINT_BUTTON_CLICKED), j ? _.yT(C.ti.DISMISSED) : ((0, I.EW)(s.z.DESKTOP_APP_LAUNCHER_ONBOARDING, {
      dismissAction: R.L.TAKE_ACTION
    }), _.__(C._b.TEXT, x), f.ux()), Z()
  }, [j, x, Z]);
  i.useEffect(() => {
    let e = setTimeout(() => {
      L(), W()
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [H && E === h.O.GLOWING_ANIMATION && (0, r.jsx)("div", {
      ...
      className: o()(M.buttonContainer, w.t4, {
        [M.appLauncherCircleMask]: E === h.O.GLOWING_ANIMATION
      }),
      ref: t,
      ...
      }), n)), H && E === h.O.SIMPLE_BADGE && (0, r.jsx)(g.r, {
        top: -1,
        right: -1,
        size: 7,
...
let U = i.memo(function(e) {
  ...
  } = e, s = i.useRef(null), c = (0, j.R)({
    channel: t,
    chatInputType: n
  }), u = (0, T.Z)({
    type: n
  }), d = (0, E.h9)(t.id), p = (0, a.e7)([y.Z], () => y.Z.appDMChannelsWithFailedLoads().has(t.id)), {
    visible: h
  } = (0, Z.xL)();
