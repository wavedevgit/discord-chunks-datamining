...
let T = i.forwardRef(function(e, t) {
  ...
  let {
    type: f,
    animateRef: m
  } = e, g = (0, a.e7)([p.Z], () => p.Z.shouldShowPopup() && p.Z.activeViewType() === f), {
    Component: _,
    events: x,
    play: v
  } = (0, b.Z)("ChannelAppLauncherButton"), j = (0, C.Q3)("ChannelAppLauncherButton");
  ...
  let O = i.useCallback(() => {
    (0, u.yw)(E.rMx.APP_LAUNCHER_ENTRYPOINT_BUTTON_CLICKED), g ? d.yT(h.ti.DISMISSED) : ((0, y.EW)(s.z.DESKTOP_APP_LAUNCHER_ONBOARDING, {
...
function A(e) {
  ...
  if (!l) return n;
  let p = s && (null == u ? void 0 : u.iconURL) != null ? (0, r.jsxs)("div", {
...
let w = i.memo(function(e) {
  let {
    ...
    type: n
  }), d = (0, _.h9)(t.id), h = (0, a.e7)([p.Z], () => p.Z.appDMChannelsWithFailedLoads().has(t.id)), {
    visible: f
  } = (0, j.xL)();
