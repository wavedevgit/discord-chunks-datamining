...
let P = i.forwardRef(function(e, t) {
    ...
    let {
      ...
      events: x,
      play: v
    } = (0, g.Z)("ChannelAppLauncherButton"), P = (0, _.Q3)("ChannelAppLauncherButton");
    ...
    let S = i.useCallback(() => {
        b ? d.yT(h.ti.DISMISSED) : ((0, y.EW)(s.z.DESKTOP_APP_LAUNCHER_ONBOARDING, {
          dismissAction: O.L.TAKE_ACTION
        }), d.__(h._b.TEXT, f), u.ux()), v()
      }, [b, f, v]),
      Z = (0, r.jsx)(C, {
  ...
  S = i.memo(function(e) {
    let {
      ...
      type: n
    }), d = (0, b.h9)(t.id), h = (0, o.e7)([p.Z], () => p.Z.appDMChannelsWithFailedLoads().has(t.id)), {
      visible: g
    } = (0, x.xL)();
