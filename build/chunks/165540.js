...
let B = i.forwardRef(function(e, t) {
  ...
  let {
    type: v,
    animateRef: j
  } = e, O = (0, s.e7)([C.Z], () => C.Z.shouldShowPopup() && C.Z.activeViewType() === v), {
    badgeTreatment: I
  } = h.Y.useExperiment({
    ...
    events: N,
    play: T
  } = (0, E.Z)("ChannelAppLauncherButton"), {
    Component: w,
    play: U
  } = (0, u.B)(), B = (0, P.Q3)("ChannelAppLauncherButton");
  ...
  let G = (0, m.a)({
    ...
    F = i.useCallback(() => {
      ...
      }), O ? y.yT(x.ti.DISMISSED) : ((0, S.EW)(c.z.DESKTOP_APP_LAUNCHER_ONBOARDING, {
        dismissAction: M.L.TAKE_ACTION
      }), y.__(x._b.TEXT, v), f.ux()), T()
    }, [O, v, T, G, I]);
  i.useEffect(() => {
    let e = setTimeout(() => {
      I !== h.O.NONE && G && (U(), (0, _.h)({
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [G && I === h.O.GLOWING_ANIMATION && (0, r.jsx)("div", {
      ...
      className: o()(D.buttonContainer, k.t4, {
        [D.appLauncherCircleMask]: I === h.O.GLOWING_ANIMATION
      }),
      ref: t,
      ...
      }), n)), G && I === h.O.SIMPLE_BADGE && (0, r.jsx)(g.r, {
        top: -1,
        right: -1,
        size: 7,
...
function G(e) {
  ...
  if (!l) return n;
  let p = a && (null == c ? void 0 : c.iconURL) != null ? (0, r.jsxs)("div", {
...
let F = i.memo(function(e) {
  ...
  } = e, a = i.useRef(null), c = (0, O.R)({
    channel: t,
    chatInputType: n
  }), u = (0, w.Z)({
    type: n
  }), d = (0, I.h9)(t.id), p = (0, s.e7)([C.Z], () => C.Z.appDMChannelsWithFailedLoads().has(t.id)), {
    visible: h
  } = (0, T.xL)();
