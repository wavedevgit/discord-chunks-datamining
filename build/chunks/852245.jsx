...
function b(n) {
  ...
  return !__OVERLAY__ && d && (e || t || b || f) ? <i.sNh id={"edit-channel"} label={n.type === u.d4z.GUILD_CATEGORY ? s.intl.string(s.t.zdPFs7) : s.intl.string(s.t["3gUsJS"])} action={() => c.ZP.open(n.id)} /> : null
}