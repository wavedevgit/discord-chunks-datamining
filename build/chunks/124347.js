...
class w extends(r = a.Component) {
  ...
  getSrc(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
      ...
      } = this.props,
      {
        format: l,
        quality: c
      } = w.getFormatQuality(S(O({}, this.props), {
        freeze: t
      }));
    return (0, f.Q4)({
      src: n,
  ...
  render() {
    let {
      ...
      hasMouseOver: x,
      hasFocus: M
    } = this.state, k = null != n, j = this.getRatio(), U = (0, o.clamp)(Math.round(h * j), null != g ? g : 0, null != y ? y : 1 / 0), G = (0, o.clamp)(Math.round(m * j), null != E ? E : 0, null != v ? v : 1 / 0), B = {
      alt: e,
      readyState: L,
    ...
    switch ((k || null != I) && (B.onClick = this.onClick), r && (B.original = null != l && "" !== l ? l : B.src), L) {
      ...
      case b.zo9.READY:
        if (w.isAnimated(this.props)) {
          ...
          e ? (B.src = this.getSrc(j), B.renderAccessory = S) : (B.src = this.getSrc(j, !_ || !s), B.renderAccessory = this.renderAccessory), null != f && (B.children = t => {
            let {
              src: n,
              size: r,
              alt: i,
  ...
  constructor(e) {
    super(e), v(this, "state", {
      ...
      hasMouseOver: !1,
      hasFocus: !1
    }), v(this, "startLoadingTime", Date.now()), v(this, "_cancellers", new Set), v(this, "_imageRef", a.createRef()), v(this, "observeVisibility", () => {
