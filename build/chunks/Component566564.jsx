...
let P = e => {
        ...
        switch (e.type) {
          ...
          case o.z.FEED:
            ...
            l = (0, r.jsx)(x.Z, {
              ...
              numVisibleItems: u,
              sortedSkuIds: f,
              buttonContainerClassName: (null == t ? true : t.type) === o.z.IMMERSIVE_BANNER ? A.feedblockInteractiveBackground : true,
  ...
  R = e => {
    let {
      ...
      handleScroll: o
    } = (0, u.z)(s, n), a = (0, b.R)(), d = (0, f.sp)(), [p, m] = l.useState(L.IV), [C, h] = l.useState(false);
    return l.useEffect(() => {
      if (null != s.current) {
        let e = () => {
