...
function j(e) {
  ...
  i.useEffect(() => {
    ...
    ei && j && f.default.track(D.rMx.OPEN_MODAL, {
  ...
  let eo = i.useCallback((e, t, r, n) => {
    ...
    ea = i.useCallback(() => {
      ...
      let {
        ...
        width: r,
        height: n
      } = (0, A.Es)(k, e, t, en), i = (0, A.AK)(k, r, n, t, en), o = (0, A.kH)(r, n, i);
      V({
        type: "SET_DIMENSIONS",
        imageDimensions: {
          width: r,
    ...
    eu = i.useCallback(e => {
      ...
      (0, s.inRange)(i, n.right, n.left) && (0, s.inRange)(o, n.top, n.bottom) || eo(i, o, n, F), V({
    ...
    ed = i.useCallback((e, t) => {
      let {
        ...
        width: i,
        height: o
      } = (0, A.Es)(k, n, r, en), a = (0, A.AK)(k, i, o, r, en), s = (0, A.kH)(i * t, o * t, a);
      return {
        newImageDimensions: {
          width: i,
          height: o
  ...
  i.useEffect(() => (window.addEventListener("mouseup", ec), window.addEventListener("resize", ea), () => {
