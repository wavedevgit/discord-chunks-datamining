...
function j(e) {
  let {
    ...
    analyticsPage: S
  } = e, B = i.useRef(x), P = i.useRef(null), z = i.useRef(null), [L, V] = i.useReducer(M, k), {
    cropDimensions: H,
    dragBoundaries: U,
    imageDimensions: W,
    imageRotation: F,
  ...
  let ea = i.useCallback((e, t, r, n) => {
    ...
    eo = i.useCallback(() => {
      ...
      let {
        ...
        width: r,
        height: n
      } = (0, R.Es)(j, e, t, en), i = (0, R.AK)(j, r, n, t, en), a = (0, R.kH)(r, n, i);
      V({
        type: "SET_DIMENSIONS",
        imageDimensions: {
          width: r,
    ...
    ed = i.useCallback((e, t) => {
      let {
        ...
        width: i,
        height: a
      } = (0, R.Es)(j, n, r, en), o = (0, R.AK)(j, i, a, r, en), s = (0, R.kH)(i * t, a * t, o);
      return {
        newImageDimensions: {
          width: i,
          height: a
