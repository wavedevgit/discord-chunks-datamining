...
function C(e) {
  ...
  let {
    ...
    guild: p,
    specMap: h
  } = e, f = b.Plq[i], g = null != (n = null == (t = h[f.toString()]) ? void 0 : t.title) ? n : (0, u.wt)(f), C = m._o.has(f), x = (0, a.e7)([d.Z], () => d.Z.getRoles(p.id));
  return (0, r.jsx)(s.ua7, {
    ...
    children: e => {
      ...
      return (0, r.jsxs)(s.P3F, {
        className: o()(y.permissionChiplet, {
          [y.elevatedPermission]: C
        }),
        onMouseEnter: t,
        onMouseLeave: n,
...
let x = i.memo(function(e) {
  let {
    member: t,
    onNavigate: n
  } = e, l = (0, a.e7)([p.Z], () => p.Z.getGuild(t.guildId), [t.guildId]), c = (0, m.B2)(t.userId, t.guildId, m.Qn), u = (0, m.B2)(t.userId, t.guildId, m.pd), d = Object.keys(c).length, x = Object.keys(u).length, v = i.useMemo(() => null != l ? h.Z.getGuildPermissionSpecMap(l) : null, [l]), j = i.useMemo(() => null != l ? h.Z.generateGuildPermissionSpec(l) : null, [l]), O = i.useMemo(() => {
    ...
    title: (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(s.Text, {
        ...
        children: [(0, r.jsx)(s.Text, {
          variant: "eyebrow",
          color: "interactive-normal",
          children: _.intl.format(_.t["0x6aTk"], {
            count: x
          })
        }), (0, r.jsx)(s.Fbu, {
          size: "custom",
