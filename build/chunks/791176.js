...
function N(e) {
  ...
  let {
    ...
    guild: E,
    specMap: _
  } = e, A = I.Plq[l], m = null != (n = null == (t = _[A.toString()]) ? void 0 : t.title) ? n : (0, c.wt)(A), N = T._o.has(A), h = (0, a.Wu)([d.Z], () => d.Z.getManyRoles(E.id, s), [E.id, s]);
...
let h = l.memo(function(e) {
  let {
    member: t,
    onNavigate: n
  } = e, s = (0, a.e7)([E.Z], () => E.Z.getGuild(t.guildId), [t.guildId]), u = (0, T.B2)(t.userId, t.guildId, T.Qn), c = (0, T.B2)(t.userId, t.guildId, T.pd), d = Object.keys(u).length, h = Object.keys(c).length, O = l.useMemo(() => null != s ? _.Z.getGuildPermissionSpecMap(s) : null, [s]), p = l.useMemo(() => null != s ? _.Z.generateGuildPermissionSpec(s) : null, [s]), R = l.useMemo(() => {
  ...
  return null == s ? null : (0, r.jsx)(o.xJW, {
    title: (0, r.jsxs)("div", {
