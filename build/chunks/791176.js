...
function h(e) {
  ...
  let {
    ...
    guild: E,
    specMap: _
  } = e, A = T.Plq[l], f = null != (n = null == (t = _[A.toString()]) ? void 0 : t.title) ? n : (0, c.wt)(A), h = m._o.has(A), O = (0, a.e7)([d.Z], () => d.Z.getRoles(E.id));
...
let O = l.memo(function(e) {
  let {
    member: t,
    onNavigate: n
  } = e, i = (0, a.e7)([E.Z], () => E.Z.getGuild(t.guildId), [t.guildId]), u = (0, m.B2)(t.userId, t.guildId, m.Qn), c = (0, m.B2)(t.userId, t.guildId, m.pd), d = Object.keys(u).length, O = Object.keys(c).length, N = l.useMemo(() => null != i ? _.Z.getGuildPermissionSpecMap(i) : null, [i]), p = l.useMemo(() => null != i ? _.Z.generateGuildPermissionSpec(i) : null, [i]), R = l.useMemo(() => {
