/** Chunk was on 34261 **/
/** chunk id: 304414, original params: t,e,a (module,exports,require) **/
var i, r, n, s, o, d;
...
class u {
  ...
  toString() {
    ...
    return t += ";ROLE=" + this.data.role, this.data.type && (t += ";CUTYPE=" + this.data.type), this.data.status && (t += ";PARTSTAT=" + this.data.status), this.data.rsvp && (t += ";RSVP=" + this.data.rsvp.toString().toUpperCase()), this.data.delegatedTo && (t += ';DELEGATED-TO="' + this.data.delegatedTo.email() + '"'), this.data.delegatedFrom && (t += ';DELEGATED-FROM="' + this.data.delegatedFrom.email() + '"'), this.data.name && (t += ';CN="' + (0, Chunk141716.escape)(this.data.name) + '"'), this.data.email && this.data.mailto && (t += ";EMAIL=" + (0, Chunk141716.escape)(this.data.email)), this.data.x.length && (t += ";" + this.data.x.map(([t, e]) => t.toUpperCase() + "=" + (0, l.escape)(e)).join(";")), t += ":MAILTO:" + (0, Chunk141716.escape)(this.data.mailto || this.data.email) + "\r\n"
  }
}
exports.default = u