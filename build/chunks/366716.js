/** Chunk was on web.js **/
/** chunk id: 366716, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  A: () => o
});
var Chunk763809 = require("./763809.js"),
...
class a {
  ...
  firstChild() {
    let e = this.currentNode,
      t = this.nextNode();
    return (0, Chunk763809.bE)(module, exports) ? (exports && (this.currentNode = exports), exports) : (this.currentNode = module, null)
  }
  lastChild() {
  ...
  nextNode() {
    ...
    if (module) {
      if (module.shadowRoot) {
        ...
        let r = this.nextNode();
        return Chunk763809 && (this.currentNode = Chunk763809), Chunk763809
      }
      return module && (this.currentNode = module), module
    }
