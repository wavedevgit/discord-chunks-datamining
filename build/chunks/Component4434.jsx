...
function eu(e) {
  ...
  let {
    ...
    setInvoicePreview: R
  } = (0, O.JL)(), w = (0, C.Z)(), x = s.interval, L = s.intervalCount, U = (0, u.e7)([V.Z], () => V.Z.getForSkuAndInterval((0, K.Wz)(Q.Si.GUILD), x, L)), B = (0, u.e7)([G.default], () => G.default.getCurrentUser()), Z = (0, u.e7)([k.Z], () => k.Z.getGuild(a), [a]), et = (0, b.Z)({
    forceFetch: false
  });
