...
function j() {
  ...
  return module && require && Chunk120356 && !j ? <div className={Chunk117527.container}>{<div className={Chunk117527.background} />}{<div className={Chunk117527.content}><Chunk783739.Z premiumSubscription={exports} /></div>}</div> : <div className={a()(Chunk117527.container, Chunk117527.loading)}><Chunk481060.$jN /></div>
}