...
function D(e) {
  let {
    ...
    hideDiscriminator: a,
    onClose: o
  } = e, [u, m] = i.useState(!1), [h, f] = i.useState(null);
  async function x() {
    if (null != n) {
      f(null), m(!0);
      try {
  ...
  return (0, r.jsxs)(c.Y0X, {
    ...
    children: [(0, r.jsxs)(c.xBx, {
      ...
      }), a || l.isPomelo() ? null : (0, r.jsxs)(p.Z, {
        size: p.Z.Sizes.SIZE_24,
  ...
  constructor(...e) {
    super(...e), w(this, "getSortedBans", (0, b.oH)((e, t) => {
      ...
      return (0, r.jsxs)(c.hjN, {
        tag: c.RB0.H1,
        title: S.intl.formatToPlainString(S.t["bW+JJy"], {
          bans: a
        }),
...
function M() {
  ...
  let {
    guild: t
  } = (0, o.e7)([C.Z], () => C.Z.getProps(), [], a.isEqual), {
    enabled: n
  } = O.T.useExperiment({
