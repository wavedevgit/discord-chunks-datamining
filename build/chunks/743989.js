  ...
  var e = [, (e, t, n) => {
      ...
      let r = (() => {
        ...
        return function(t = {}) {
          ...
          a.onRuntimeInitialized = function() {
            ...
            }, a.requestAnimationFrame = (r = new o).requestAnimationFrame.bind(r), a.cancelAnimationFrame = r.cancelAnimationFrame.bind(r), a.enableFPSCounter = r.Rb.bind(r), a.disableFPSCounter = r.Ob, r.ob = n, a.resolveAnimationFrame = n, a.cleanup = function() {
              I && I.delete()
            }
          };
          var _, f, p = Object.assign({}, a),
            h = "./this.program",
            m = "object" == typeof window,
            g = "function" == typeof importScripts,
            E = "";
          (m || g) && (g ? E = self.location.href : "undefined" != typeof document && document.currentScript && (E = document.currentScript.src), e && (E = e), E = 0 !== E.indexOf("blob:") ? E.substr(0, E.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "", g && (f = e => {
          ...
          function z(e, t) {
            var n = q;
            return O || "function" != typeof WebAssembly.instantiateStreaming || Z(n) || n.startsWith("file://") || "function" != typeof fetch ? K(n, e, t) : fetch(n, {
              credentials: "same-origin"
              ...
              452908: (e, t, n, r, i) => {
                ...
                if (void 0 === window.h) {
                  ...
                  a.D = [], a.yc = function(e) {
                    ...
                    return a.D[e]
                  }, a.Bb = ["touchend", "click"], a.unlock = function() {
                    for (var e = 0; e < a.D.length; ++e) {
                      var t = a.D[e];
                      null != t && null != t.J && t.state === a.ga.xb && t.J.resume().then(() => {
                        nO(t.pb)
                      }, e => {
              ...
              455525: (e, t, n, r, i, a) => {
                ...
                return e == window.h.I.ya && 0 != n && (s.sampleRate = n), o.J = new(window.AudioContext || window.webkitAudioContext)(s), o.J.suspend(), o.state = window.h.ga.stopped, n = 0, e != window.h.I.ya && (n = t), o.Z = o.J.createScriptProcessor(r, n, t), o.Z.onaudioprocess = function(n) {
                  ...
                  if (e == window.h.I.ya || e == window.h.I.La)
                    for (nI(a, r, i), s = 0; s < n.outputBuffer.numberOfChannels; ++s)
                ...
                }), e == window.h.I.ya && o.Z.connect(o.J.destination), o.pb = a, window.h.yc(o)
              },
          ...
          var eb = {
            ...
            createNode(e, t, n, r) {
              ...
              }), 16384 == (61440 & (n = ej(e, t, n, r)).mode) ? (n.l = eb.O.dir.node, n.m = eb.O.dir.stream, n.j = {}) : 32768 == (61440 & n.mode) ? (n.l = eb.O.file.node, n.m = eb.O.file.stream, n.v = 0, n.j = null) : 40960 == (61440 & n.mode) ? (n.l = eb.O.link.node, n.m = eb.O.link.stream) : 8192 == (61440 & n.mode) && (n.l = eb.O.$a.node, n.m = eb.O.$a.stream), n.timestamp = Date.now(), e && (e.j[t] = n, e.timestamp = n.timestamp), n
            },
          ...
          var eO, ev, eI, eT, eS = null,
            ...
            })), e = Object.assign(new eI, e), -1 == t && (t = eV()), e.X = t, eN[t] = e),
            eH = {
              open: e => {
          ...
          var nE = {
            ...
            _embind_register_class_class_function: function(e, t, n, r, i, a, o) {
              ...
              t = ta(t), a = tK(i, a), tR([], [e], function(e) {
                ...
                return void 0 === l[t] ? (r.ea = n - 1, l[t] = r) : (tM(l, t, i), l[t].B[n - 1] = r), tR([], s, function(r) {
                  if (r = tX(i, [r[0], null].concat(r.slice(1)), null, a, o), void 0 === l[t].B ? (r.ea = n - 1, l[t] = r) : l[t].B[n - 1] = r, e.i.oa)
            ...
            _embind_register_integer: function(e, t, n, r, i) {
              t = ta(t), -1 === i && (i = 0xffffffff), i = tP(n);
              var a = e => e;
              if (0 === r) {
                var o = 32 - 8 * n;
                a = e => e << o >>> o
            ...
            fd_seek: function(e, t, n, r, i) {
              ...
              try {
                ...
                var a = eF(e);
                return eJ(a, t, r), Q = [a.position >>> 0, (X = a.position, 1 <= +Math.abs(X) ? 0 < X ? +Math.floor(X / 0x100000000) >>> 0 : ~~+Math.ceil((X - +(~~X >>> 0)) / 0x100000000) >>> 0 : 0)], C[i >> 2] = Q[0], C[i + 4 >> 2] = Q[1], a.Ma && 0 === t && 0 === r && (a.Ma = null), 0
              } catch (e) {
                if (void 0 === e1 || "ErrnoError" !== e.name) throw e;
                return e.aa
              }
      ...
      var r = void 0,
        ...
        a = function(e) {
          ...
          return t.addEventListener("mouseover", g, !0), t.addEventListener("mouseenter", g, !0), t.addEventListener("mouseout", g, !0), t.addEventListener("mouseleave", g, !0), t.addEventListener("mousemove", g, !0), t.addEventListener("mousedown", g, !0), t.addEventListener("mouseup", g, !0), t.addEventListener("touchmove", g, {
              passive: _
  ...
  return (() => {
    ...
    var C = new(function(e) {
      ...
      L = function() {
        function t(e) {
          var t, n = this;
          this.loaded = !1, this.destroyed = !1, this._observed = null, this.readyForPlaying = !1, this.artboard = null, this.eventCleanup = null, this.shouldDisableRiveListeners = !1, this.automaticallyHandleEvents = !1, this.enableRiveAssetCDN = !0, this._volume = 1, this._artboardWidth = void 0, this._artboardHeight = void 0, this._devicePixelRatioUsed = 1, this._hasZeroSize = !1, this._audioEventListener = null, this._boundDraw = null, this.eventTarget = e.eventTarget, this._viewModelInstance = null, this._dataEnums = null, this.durations = [], this.frameTimes = [], this.frameCount = 0, this.isTouchScrollEnabled = !1, this.onCanvasResize = function(e) {
        ...
        return Object.defineProperty(t.prototype, "viewModelCount", {
          ...
          if (!this.destroyed) {
            ...
            this.loaded = !1, this.readyForPlaying = !1, v.awaitInstance().then(function(e) {
              n.destroyed || (n.runtime = e, n.removeRiveListeners(), n.deleteRiveRenderer(), n.renderer = n.runtime.makeRenderer(n.canvas, _), n.canvas.width || n.canvas.height || n.resizeDrawingSurfaceToCanvas(), n.initData(l, h, m, u, p).then(function() {
          ...
          var e, t = this;
          C.status == l.UNAVAILABLE && (null == (e = this.artboard) ? void 0 : e.hasAudio) && null === this._audioEventListener && (this._audioEventListener = {
            type: o.AudioStatusChange,
            callback: function() {
              return t.onSystemAudioChanged()
            }
          }, C.add(this._audioEventListener), C.establishAudio())
            ...
            return g(this, function(c) {
              switch (c.label) {
                ...
                case 2:
                  ...
                  return this.file = this.riveFile.getInstance(), this.initArtboard(e, n, r, i, a), this.initArtboardSize(), this.initializeAudio(), this.loaded = !0, this.eventManager.fire({
                    type: o.Load,
                    data: null != (l = this.src) ? l : "buffer"
                  }), this.readyForPlaying = !0, this.taskQueue.process(), this.drawFrame(), [2, Promise.resolve()];
                case 3:
                  return console.warn(s = y(c.sent())), this.eventManager.fire({
                    type: o.LoadError,
                    data: s
                  }), [2, Promise.reject(s)];
                case 4:
          ...
          if (this.file) {
            ...
            if (this.animator = new S(this.runtime, this.artboard, this.eventManager), t.length > 0 || n.length > 0 ? (a = t.concat(n), this.animator.initLinearAnimations(t, r), this.animator.initStateMachines(n, r)) : a = [this.animator.atLeastOne(r, !1)], this.taskQueue.add({
                event: {
    ...
    var k = function() {
        ...
        return Object.defineProperty(e.prototype, "runtimeInstance", {
          ...
          if (t < e.length - 1) {
            var r, i, a, o, s, l, u, d, _, f, p, h, m, g, E = this.internalViewModelInstance(e[t]);
