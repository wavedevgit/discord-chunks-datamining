...
function h() {
  let [e, t] = Chunk647438.useState(null), [n, h] = Chunk647438.useState(0), [x, g] = Chunk647438.useState(1e3), [f, b] = Chunk647438.useState(0), v = (0, Chunk442837.e7)([Chunk115470.Z], () => {
    var t;
  ...
  }), y = Chunk647438.useMemo(() => null != module && f >= 0 && f <= 100 && require >= 0, [module, f, require]);
  return (0, Chunk951288.jsx)("div", {
    ...
    children: (0, Chunk951288.jsxs)(Chunk481060.Kqy, {
      ...
      }), !(f >= 0 && f <= 100) && (0, Chunk951288.jsx)(Chunk481060.Text, {
        variant: "text-sm/normal",
        color: "text-danger",
