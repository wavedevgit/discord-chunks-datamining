...
let T = Chunk73800.memo(function(e) {
  ...
  return <li role={z} className={o()(x.containerDefault, {
      [x.selected]: l
    })}>{<Z withGuildIcon={A} />}{T ? null : <Z withGuildIcon={A} inverted={true} style={{
        transform: "rotateX(180deg) translateY(-9px)"
      }} />}{<c.tEY focusTarget={K} ringTarget={K} offset={{
        top: 2,
        bottom: 2,
        right: 4
      }}><div className={o()(x.iconVisibility, I.wrapper, I.typeThread, {
          [I.modeSelected]: l,
          [I.modeMuted]: !l && U,
          [I.modeUnreadImportant]: !U && !l && L,
          [I.withGuildIcon]: A
        })} onMouseDown={B} onContextMenu={V}>{!L || U || l ? null : <div className={o()(I.unread, I.unreadImportant)} />}{<c.P3F{...w(N({}, W), {
          innerRef: K,
          className: I.link,
          onClick: G,
          "aria-label": Y,
        ...
        })} />}</div></c.tEY>}{<v.Z channel={t} collapsed={!P} collapsedMax={6} voiceStates={R} location={j.Sbl.GUILD_CHANNEL_LIST} />}</li>
})