...
function b(e) {
  ...
  return <a.yRy targetElementRef={n} shouldShow={x} animation={a.yRy.Animation.NONE} position={"bottom"} align={"right"} autoInvert={false} onRequestClose={() => _(false)} renderPopout={e => (0, r.jsx)(h.Z, m(g({}, e), {
      channel: t,
