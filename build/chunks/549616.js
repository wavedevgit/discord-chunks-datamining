...
class p extends a.Z {
  static fromServer(e) {
    ...
    } = e, O = d(e, ["products", "logo", "hero_ranking", "pdp_bg", "mobile_bg", "success_modal_bg", "mobile_banner", "hero_banner", "hero_banner_asset", "featured_block", "hero_logo", "banner_text_color", "hero_banner_config"]);
    return new p(u(l({}, super.fromServer(O)), {
