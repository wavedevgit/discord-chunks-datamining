...
function u(e) {
  ...
  return <a.m platformType={l.ABu.XBOX} headerConnect={c.intl.string(c.t.m8aaho)} headerReconnect={c.intl.string(c.t.z3rAho)} body={p} onClose={n} onContinue={t} img={(0, o.jsx)("img", {
      src: d.Z,
      width: 230,
      height: 160,
      alt: ""
