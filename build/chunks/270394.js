  ...
  return (0, r.jsxs)(S.Z, {
    ...
    children: [(0, r.jsxs)(S.Z, {
      ...
      children: [null != n && (0, r.jsx)(O.Z, {
        ...
        children: [null != n && (0, r.jsx)(j.Z, {
          discriminatorClass: U.discriminator,
          user: n
        }), i && null != l && (0, r.jsx)(g.Text, {
...
function q(e) {
  ...
  return n.maxUses > 0 && (a = "".concat(n.uses, "/").concat(n.maxUses)), (0, r.jsx)(K, {
    isDisabled: l,
    inviter: n.inviter,
    showChannel: i,
    channel: n.channel,
    ...
    inviteSourceTrailingContent: !o && (0, D.yE)(null != (t = n.flags) ? t : 0, u.$.IS_APPLICATION_BYPASS) ? (0, r.jsxs)("div", {
      className: U.bypass,
      children: [(0, r.jsx)(g.Text, {
        className: U.text,
        variant: "text-xs/normal",
...
function X(e) {
  ...
  return (0, r.jsx)(v.Xi, {
    ...
    renderSection: e => {
      ...
      if (t === V.TABLE)
        if (0 === N.length && !h) return (0, r.jsx)("div", {
    ...
    renderRow: e => {
      ...
      if (t === V.HEADER) return (0, r.jsx)(g.X6q, {
        variant: "heading-lg/semibold",
        color: "header-primary",
        className: U.header,
        children: B.intl.string(B.t["9F90iY"])
      });
      if (t === V.ACTIONS_V1) return (0, r.jsxs)(g.hjN, {
        className: U.actions,
      ...
      if (t === V.ACTIONS_V2) return (0, r.jsx)(L.Y, {
      ...
      if (t === V.TABLE) {
        if (0 === N.length && 0 === n && h) return (0, r.jsx)(g.$jN, {
