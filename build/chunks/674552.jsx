...
function f(e, t, n) {
  return <o.mAB count={e} color={t} aria-hidden={n} />
}

function g() {
  return <Chunk481060.G2e icon={(0, Chunk481060.GSL)(Chunk460562.Z)} disableColor={true} className={Chunk176330.unavailableBadge} />
}
