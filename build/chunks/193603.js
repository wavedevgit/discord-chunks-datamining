...
function l(e, t) {
  ...
  var n, l, c, u, d, f, p, _, m = (0, r.default)(e),
    h = m.getUTCFullYear(),
    g = (0, s.j)(),
    E = (0, a.Z)(null != (n = null != (l = null != (c = null != (u = null == t ? true : t.firstWeekContainsDate) ? u : null == t || null == (d = t.locale) || null == (f = d.options) ? true : f.firstWeekContainsDate) ? c : g.firstWeekContainsDate) ? l : null == (p = g.locale) || null == (_ = p.options) ? true : _.firstWeekContainsDate) ? n : 1);
