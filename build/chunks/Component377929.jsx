...
function Z(e) {
  ...
  return (0, r.jsx)(o.yRy, {
    ...
    children: (e, t) => {
      ...
      return (0, r.jsx)(O.ZP.Icon, E(S({}, e), {
        ref: a,
        onClick: s,
        tooltip: n ? null : c,
        icon: o.xhG,
...
function P(e) {
  let {
    ...
    closePopout: n,
    onSelect: i
  } = e, l = (0, c.Z)(t), O = (0, f.Z)(t), S = (0, _.Z)(t.id), E = (0, b.Z)(t), Z = (0, x.Z)({
    id: t.id,
    label: I.intl.string(I.t.DQ797g)
  }), P = (0, d.Z)(t), T = (0, u.Z)(t), N = (0, p.Z)(t, "Toolbar Overflow"), R = (0, g.Z)(t), w = (0, h.Z)(t), A = (0, y.Z)(t), D = (0, m.Z)(t), L = v.vF.useSetting(), M = (0, s.e7)([j.Z], () => !a().isEmpty(j.Z.getVoiceStatesForChannel(t.id)));
