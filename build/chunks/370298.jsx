...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk809090 = require("./809090.js"),
  Chunk104919 = require("./104919.js"),
  Chunk583027 = require("./583027.js"),
  Chunk978983 = require("./978983.js"),
...
function j(e) {
  ...
  return null == f ? null : (m || h(), <s.yRy targetElementRef={E} renderPopout={e => {
      let {
        closePopout: t
      } = e;
      return (0, r.jsx)(U, {
    ...
    }} position={"right"} align={"top"} animation={s.yRy.Animation.NONE} onRequestClose={t} shouldShow={n}>{e => {
      let {
        onClick: n
      } = e;
      return (0, r.jsx)(s.ua7, {
        text: w.intl.string(w.t.emnnEB),
        children: e => (0, r.jsx)(s.P3F, k(x({}, e), {
          className: l,
          focusProps: {
            offset: 2
          },
...
function U(e) {
  let {
    ...
    imageUrl: I,
    mimeType: L
  } = e, M = (0, o.e7)([S.Z], () => S.Z.getGuild(a.guild_id)), {
    fetchState: k,
  ...
  let F = i.useCallback(async e => {
      let t = await fetch(I),
        ...
        r = L.join("/"),
        i = new File([n], "image".concat((0, C.Q)({
          contentType: r
        })), {
          type: r
        });
    ...
    V = i.useCallback(async (e, t, n, r) => {
      ...
      await F(r), null != p.Z.getActiveCommand(a.id) && f.Po({
        ...
        location: n,
        sectionName: t.name
      }), N.S.dispatch(P.CkL.FOCUS_CHANNEL_TEXT_AREA, {
        channelId: a.id
      })
    }, [a.id, F, G, B, Z]),
  ...
  return <s.v2r onSelect={t} navId={"image-context-commands-popout"} onClose={n} aria-label={w.intl.string(w.t.P3ShV1)}>{<s.sNh id={"menu-image-rec-header"} render={() => (0, r.jsx)(s.Text, {
        className: D.title,
        variant: "text-md/bold",
        color: "header-primary",
        children: w.intl.string(w.t.emnnEB)
      })} navigable={false} disabled={true} />}{<s.Clw />}{U ? <s.sNh id={"menu-image-recs-placeholder"} render={() => (0, r.jsx)(v.Z, {})} navigable={false} disabled={true} /> : <r.Fragment>{j.filter(e => null != e.imageOption).map(e => {
