...
let g = function(e) {
  let {
    ...
    onClose: x,
    transitionState: b
  } = e, g = (0, c.Dt)(), z = m.ZP.getDefaultChannel(a), [_, k] = t.useState("tab-id-role-icon-file-upload"), [S, B] = t.useState(!1), E = (0, s.Z)(C);
  return t.useEffect(() => {
    B(!1)
  }, [_]), (0, o.jsx)(r.Y0X, {
    transitionState: b,
    ...
    children: (0, o.jsxs)("div", {
      ...
      children: [(0, o.jsx)("nav", {
        className: i()(j.nav, {
          [j.navUploadSelected]: "tab-id-role-icon-file-upload" === _
        }),
        children: (0, o.jsxs)("div", {
          className: j.navList,
          role: "tablist",
          ...
          children: [(0, o.jsx)("div", {
            ...
            children: (0, o.jsx)(d.zx, {
              ...
              "aria-current": "page",
              className: i()(j.navButton, {
                [j.navButtonActive]: "tab-id-role-icon-file-upload" === _
              }),
            ...
            children: (0, o.jsx)(d.zx, {
              ...
              "aria-current": "page",
              className: i()(j.navButton, {
                [j.navButtonActive]: "tab-id-role-icon-emoji" === _
              }),
              look: d.zx.Looks.BLANK,
              size: d.zx.Sizes.NONE,
      ...
      }), "tab-id-role-icon-file-upload" === _ ? (0, o.jsx)(r.hzk, {
        children: (0, o.jsxs)("div", {
      ...
      }) : null, "tab-id-role-icon-emoji" === _ ? (0, o.jsx)(u.Z, {
        hasTabWrapper: !0,
        closePopout: () => x(),
