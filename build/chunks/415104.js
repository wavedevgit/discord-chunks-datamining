...
function j(e) {
  ...
  let {
    ...
    rowIndex: v,
    impressionRef: _
  } = e, [y, C] = o.useState(!1), [O, w] = o.useState([]), S = (0, c.qb)(s), P = o.useMemo(() => (0, u.q8)(s), [s]), E = (0, l._F)(), T = o.useCallback(() => {
    C(!0), E({
      questId: s.id,
      event: h.rMx.QUEST_HOVER,
      properties: (0, l.mH)(p)
    }), P && (0, m.loadVideoQuestModal)()
  }, [E, s.id, p, P]), N = o.useCallback(() => {
    C(!1), E({
      questId: s.id,
      event: h.rMx.QUEST_HOVER_OFF,
      properties: (0, l.mH)(p)
    })
  }, [E, s.id, p]), A = o.useContext(f.t), {
