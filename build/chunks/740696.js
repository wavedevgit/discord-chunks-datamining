...
function j(t) {
  let {
    ...
    transitionState: v,
    onClose: b
  } = t, y = (0, i.e7)([l.Z], () => l.Z.getGuild(e), [e]), N = (0, i.e7)([c.Z], () => c.Z.can(u.Plq.MANAGE_CHANNELS, y)), P = f(), [S, O] = r.useState(0), C = (0, o.Dt)();
      ...
      children: (0, a.jsxs)("div", {
        ...
        children: [(0, a.jsx)(s.Text, {
          ...
          children: (0, a.jsx)(s.njP, {
            ...
            className: h.tags,
            children: P.map((t, e) => (0, a.jsx)(s.njP.Item, {
              id: e,
              children: t.name
            }, e))
          })
        ...
        children: [(0, a.jsx)(s.zxk, {
          ...
          onClick: () => {
            (0, s.ZDy)(async () => {
              let {
                default: t
              } = await Promise.all([n.e("45094"), n.e("37670")]).then(n.bind(n, 218613));
              return n => {
                var r, i;
