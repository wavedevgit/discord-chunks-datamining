...
r.d(t, {
  Z: () => w
}), r(388685), r(539854), r(781311), r(290780);
var n, s, l, a = r(442837),
  i = r(570140),
  o = r(279779),
  c = r(592125),
  u = r(271383),
...
function R(e, t) {
  ...
  let i = 3;
  s.mode.type === E.Sap.FILTER && (i = 10), n.results = function(e) {
...
function T(e, t, n) {
  let s = [];
  return t.type === E.Sap.FILTER ? s.push(I({
    filter: t.filter,
    token: t.token,
    searchId: e,
    maxResults: 10,
    tokens: n
  })) : t.type === E.Sap.FILTER_ALL ? s = function(e, t, r) {
    ...
    return null != n && "" !== n && ((function(e) {
      ...
      if (null != r && "" !== r) {
        ...
        let e = null == (l = b.ZP[E.dCx.FILTER_BEFORE]) || null == (s = l.getAutocompletions) || null == (n = s.call(l, {
            query: r,
            searchId: t,
            maxResults: 1
          })) ? void 0 : n[0],
          d = null == (o = b.ZP[E.dCx.FILTER_ON]) || null == (i = o.getAutocompletions) || null == (a = i.call(o, {
            query: r,
            searchId: t,
            maxResults: 1
          })) ? void 0 : a[0],
          p = null == (h = b.ZP[E.dCx.FILTER_AFTER]) || null == (u = h.getAutocompletions) || null == (c = u.call(h, {
            query: r,
            searchId: t,
            maxResults: 1
          })) ? void 0 : c[0];
        ...
        let f = [e];
        return null != d && f.push(d), null != p && f.push(p), {
          group: E.rtL.DATES,
          results: f
        }
      }
    }(e, t))), 5 > (0, y.BU)(s) && s.push(j(e, t)), s
  }(t.token, e, n) : t.type === E.Sap.EMPTY && (s.push(j(t.token, e)), s.push(function(e) {
...
class M extends(n = a.ZP.Store) {
  ...
  getState(e) {
    var t;
    return null != (t = C[e]) ? t : O({
      searchId: e
    })
  }
}
l = "SearchAutocompleteStore", (s = "displayName") in M ? Object.defineProperty(M, s, {
  value: l,
  enumerable: !0,
  configurable: !0,
  writable: !0
...
let k = new M(i.Z, {
    SEARCH_AUTOCOMPLETE_QUERY_UPDATE: function(e) {
      ...
      if (a === o.query && (null == o.mode || o.mode.filter === i.filter)) r = o.autocompletes, u = !1;
        ...
        null != e && e.getFullMatch().trim().length > 0 ? (m.Z.requestMembers(n, e.getFullMatch().trim(), 10), c.context.setQuery({
          query: e.getFullMatch().trim(),
          filters: {
            guild: n
          }
        }), r = o.autocompletes, u = !1) : (c.context.clearQuery(), r = T(n, i, s))
      }
      return C[n] = O({
        searchId: n,
        query: a,
