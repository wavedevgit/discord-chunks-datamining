...
function T(e, t, n) {
  let s = [];
  return t.type === E.Sap.FILTER ? s.push(R({
    filter: t.filter,
    token: t.token,
    searchId: e,
    maxResults: 10,
    ...
    return null != n && "" !== n && ((function(e) {
      ...
      if (null != r && "" !== r) {
        ...
        let e = null == (l = x.ZP[E.dCx.FILTER_BEFORE]) || null == (s = l.getAutocompletions) || null == (n = s.call(l, {
            query: r,
            searchId: t,
            maxResults: 1
          })) ? void 0 : n[0],
          d = null == (o = x.ZP[E.dCx.FILTER_ON]) || null == (i = o.getAutocompletions) || null == (a = i.call(o, {
            query: r,
            searchId: t,
            maxResults: 1
          })) ? void 0 : a[0],
          p = null == (h = x.ZP[E.dCx.FILTER_AFTER]) || null == (u = h.getAutocompletions) || null == (c = u.call(h, {
            query: r,
            searchId: t,
            maxResults: 1
          })) ? void 0 : c[0];
    ...
    }(e, t))), 5 > (0, y.BU)(s) && s.push(I(e, t)), s
  }(t.token, e, n) : t.type === E.Sap.EMPTY && (s.push(I(t.token, e)), s.push(function(e) {
...
class k extends(n = a.ZP.Store) {
  ...
  getState(e) {
    var t;
    return null != (t = v[e]) ? t : O({
      searchId: e
    })
  }
}
l = "SearchAutocompleteStore", (s = "displayName") in k ? Object.defineProperty(k, s, {
  value: l,
  enumerable: !0,
  configurable: !0,
  writable: !0
