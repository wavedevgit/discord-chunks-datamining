...
function A(e) {
  ...
  i.useEffect(() => {
    G === N.Wq.EDIT_USERNAME && H(!0), E.default.track(P.rMx.POMELO_EDIT_STEP_VIEWED, {
      source: n,
      step: G
    })
  }, [G, n]), i.useEffect(() => {
    F || q || null == K || !(K.length > 0) || $(e => {
      var t, n;
      return t = C({}, e), n = n = {
        username: K
  ...
  let [J, $] = i.useState({
    ...
    slideId: T.A.FINISH_LATER
  }], [G]), en = et.length, er = i.useCallback(async () => {
    if (J.globalName.length <= 0) {
      let e = _.intl.formatToPlainString(_.t.IpijXF, {
        minNum: 1,
        maxNum: 32
      });
      Z(e), E.default.track(P.rMx.POMELO_ERRORS, {
        reason: e,
  ...
  }, [et, M, G, es]), ea = i.useCallback(() => {
    L(T.A.FINISH_LATER)
  }, []), ec = i.useCallback(() => {
    k ? (L(T.A.SUGGESTIONS), W(N.Wq.SUGGESTION)) : (L(T.A.INFO), W(N.Wq.NONE))
  }, [k]), eu = i.useMemo(() => M === T.A.EDIT_SCREEN && G === N.Wq.EDIT_DISPLAY_NAME ? er : M === T.A.EDIT_SCREEN && G === N.Wq.EDIT_USERNAME ? ei : M === T.A.SUGGESTIONS && G === N.Wq.SUGGESTION ? ei : eo, [M, G, er, ei, eo]), ed = i.useMemo(() => {
    var e, t;
    return w(null != (t = null == (e = et.find(e => e.slideId === M)) ? void 0 : e.footerButtons) ? t : [], {
      handleNext: eu,
      handleBack: el,
      handleRemindMeLater: ea,
      onClose: A
    }, R, Q, q)
  }, [el, ea, eu, A, et, M, R, Q, q]), eg = i.useMemo(() => (0, y.zV)(X), [X]);
  ...
  }, [G]), !q && null == U && (G === N.Wq.EDIT_USERNAME ? t = _.intl.formatToPlainString(_.t.AJh8BQ, {
    source: X.username
  }) : G === N.Wq.SUGGESTION && (Q || null != K) && (t = _.intl.string(_.t["i/2SgI"]))), (0, r.jsxs)(c.Y0X, {
...
let w = (e, t, n, i, s) => 0 === e.length ? null : (0, r.jsxs)(c.mzw, {
  className: I.footer,
  children: [(0, r.jsxs)("div", {
    className: I.inline,
    children: [e.includes("REMIND_ME_LATER") && (0, r.jsx)(c.zxk, {
    ...
    }), e.includes("NEXT") && (0, r.jsx)(c.zxk, {
      type: "button",
      size: c.zxk.Sizes.SMALL,
      submitting: n,
      onClick: t.handleNext,
      children: _.intl.string(_.t.PDTjLC)
    }), e.includes("SUBMIT") && (0, r.jsx)(c.zxk, {
      type: "button",
      size: c.zxk.Sizes.SMALL,
      submitting: n,
      onClick: t.handleNext,
      children: _.intl.string(_.t.geKm7u)
    }), e.includes("GET_STARTED") && (0, r.jsx)(c.zxk, {
      type: "button",
      size: c.zxk.Sizes.SMALL,
      onClick: t.handleNext,
      children: _.intl.string(_.t.LhlgY2)
    }), e.includes("GOT_IT") && (0, r.jsx)(c.zxk, {
      type: "button",
      size: c.zxk.Sizes.SMALL,
      onClick: t.onClose,
      children: _.intl.string(_.t["NX+WJC"])
    }), e.includes("UPDATE") && (0, r.jsx)(c.zxk, {
      type: "button",
      size: c.zxk.Sizes.SMALL,
      disabled: i && !s,
      submitting: n,
