...
function A(e) {
  ...
  i.useEffect(() => {
    G === N.Wq.EDIT_USERNAME && B(!0), E.default.track(T.rMx.POMELO_EDIT_STEP_VIEWED, {
      source: r,
      step: G
    })
  }, [G, r]), i.useEffect(() => {
  ...
  let [Q, $] = i.useState({
    ...
    try {
      Z(null), D(!0), await y.Z.createPomelo({
    ...
    var e, t;
    return R(null != (t = null == (e = ee.find(e => e.slideId === M)) ? void 0 : e.footerButtons) ? t : [], {
      handleNext: el,
      handleBack: eo,
