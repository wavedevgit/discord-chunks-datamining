...
function A(e) {
  ...
  let [J, $] = i.useState({
    ...
    slideId: T.A.FINISH_LATER
  }], [G]), er = et.length, en = i.useCallback(async () => {
    ...
    try {
      U(null), D(!0), await h.Z.createPomelo({
  ...
  }, [et, L, G, eo]), ea = i.useCallback(() => {
    k(T.A.FINISH_LATER)
  }, []), ec = i.useCallback(() => {
    M ? (k(T.A.SUGGESTIONS), W(v.Wq.SUGGESTION)) : (k(T.A.INFO), W(v.Wq.NONE))
  }, [M]), eu = i.useMemo(() => L === T.A.EDIT_SCREEN && G === v.Wq.EDIT_DISPLAY_NAME ? en : L === T.A.EDIT_SCREEN && G === v.Wq.EDIT_USERNAME ? ei : L === T.A.SUGGESTIONS && G === v.Wq.SUGGESTION ? ei : es, [L, G, en, ei, es]), ed = i.useMemo(() => {
    var e, t;
    return w(null != (t = null == (e = et.find(e => e.slideId === L)) ? void 0 : e.footerButtons) ? t : [], {
      handleNext: eu,
      handleBack: el,
