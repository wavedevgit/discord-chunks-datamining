...
function P(e) {
  ...
  i.useEffect(() => {
    Z === N.Wq.EDIT_USERNAME && q(!0), h.default.track(v.rMx.POMELO_EDIT_STEP_VIEWED, {
      source: r,
      step: Z
    })
  }, [Z, r]), i.useEffect(() => {
    F || W || null == K || !(K.length > 0) || Q(e => {
      var t, r;
      return t = C({}, e), r = r = {
        username: K
  ...
  let [Y, Q] = i.useState({
    ...
    slideId: j.A.FINISH_LATER
  }], [Z]), ee = J.length, et = i.useCallback(async () => {
    if (Y.globalName.length <= 0) {
      let e = T.intl.formatToPlainString(T.t.IpijXF, {
        minNum: 1,
        maxNum: 32
      });
      U(e), h.default.track(v.rMx.POMELO_ERRORS, {
        reason: e,
    ...
    try {
      U(null), k(!0), await (0, d.S2)({
        global_name: Y.globalName
  ...
  }, [V, Y]), er = i.useCallback(async () => {
    try {
      U(null), k(!0), await p.Z.createPomelo({
        username: (0, y.R_)(Y.username)
      }, R), await (0, u.In)(V.id), G(N.Wq.PREVIEW)
    } catch (r) {
      let e = new m.Z(r),
        t = (null == e ? void 0 : e.status) != null && e.status >= 400 && e.status < 500 ? e.getAnyErrorMessage() : T.intl.string(T.t.R0RpRU);
      U(t), h.default.track(v.rMx.POMELO_ERRORS, {
        reason: t,
        username_error: !0,
        location: "modal",
        one_click_flow: R
  ...
  }, [J, w, Z, en]), es = i.useCallback(() => {
    L(j.A.FINISH_LATER)
  }, []), ea = i.useMemo(() => w === j.A.EDIT_SCREEN && Z === N.Wq.EDIT_DISPLAY_NAME ? et : w === j.A.EDIT_SCREEN && Z === N.Wq.EDIT_USERNAME ? er : w === j.A.SUGGESTIONS && Z === N.Wq.SUGGESTION ? er : ei, [w, Z, et, er, ei]), el = i.useMemo(() => {
    var e, t;
    return A(null != (t = null == (e = J.find(e => e.slideId === w)) ? void 0 : e.footerButtons) ? t : [], {
      handleNext: ea,
      handleBack: eo,
      handleRemindMeLater: es,
      onClose: P
    }, M, X, W)
  }, [eo, es, ea, P, J, w, M, X, W]), ec = i.useMemo(() => (0, y.zV)(V), [V]);
  ...
  }, [Z]), !W && null == D && (Z === N.Wq.EDIT_USERNAME ? t = T.intl.formatToPlainString(T.t.AJh8BQ, {
    source: V.username
  }) : Z === N.Wq.SUGGESTION && (X || null != K) && (t = T.intl.string(T.t["i/2SgI"]))), (0, n.jsxs)(c.Y0X, {
...
let A = (e, t, r, i, o) => 0 === e.length ? null : (0, n.jsxs)(c.mzw, {
  className: I.footer,
