...
let u = function(e) {
  ...
  return r.componentDidMount = function() {
    var e = this,
      ...
      r = (0, c.$h)(t);
    if (this._hcaptcha = r.window.hcaptcha || void 0, void 0 !== this._hcaptcha) return void this.setState({
      isApiReady: !0
    }, function() {
      e.renderCaptcha()
    });
    ...
    this.setState({
      ...
      e._hcaptcha = (0, c.$h)(t).window.hcaptcha, e.renderCaptcha(function() {
