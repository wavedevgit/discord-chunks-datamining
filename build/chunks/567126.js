...
function W(e) {
  ...
  }), a = S.Z.supports(D.AN.GO_LIVE_HARDWARE), [o, m] = l.useState(null), [C, y] = l.useState(null), [w, O] = l.useState(null), T = null != w && w.length > 0, [E, R] = l.useState(c.vA.WINDOW), [A, U] = l.useState(!1), W = l.useRef(null), F = l.useRef(new u.Xp), H = (0, d.e7)([p.ZP], () => p.ZP.getRunningGames()), V = function(e, t, n) {
    let r = (0, v.Zy)({
  ...
  }((0, d.e7)([_.Z], () => _.Z.quests), H, C), Y = l.useMemo(() => null == C ? null : [...C].sort((e, t) => (null == V ? void 0 : V.source.id) === e.id ? -1 : (null == V ? void 0 : V.source.id) === t.id ? 1 : z(t) - z(e)), [V, C]);
  l.useEffect(() => {
    let e = F.current;
    return (0, N.t)({
      width: 176,
  ...
  return (0, r.jsx)(f.P3F, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(R.Z, {
        className: B.nativeSourceSingleTypeImage
      }), (0, r.jsx)(f.Text, {
