...
function y(e) {
  let {
    ...
    claimableRewards: P
  } = (0, h.wD)(), Z = (0, a.e7)([p.default], () => p.default.getCurrentUser());
  i.useEffect(() => {
    ...
    w = (0, l.jsx)(_.O3, {
      children: (0, l.jsx)(o.mzw, {
        ...
        children: (0, l.jsx)(u.y, {
          onStepChange: e => {
            null != Z && null != v && x.default.track(m.rMx.GIFT_PROMOTION_REWARD_SELECTED, {
              user_id: Z.id,
