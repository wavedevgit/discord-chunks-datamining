...
function E(e) {
  let {
    ...
    claimableRewards: M
  } = (0, h.wD)(), v = (0, a.e7)([p.default], () => p.default.getCurrentUser());
  l.useEffect(() => {
    ...
    N = (0, i.jsx)(m.O3, {
      children: (0, i.jsx)(o.mzw, {
        ...
        children: (0, i.jsx)(u.y, {
          onStepChange: e => {
            null != v && null != Z && x.default.track(_.rMx.GIFT_PROMOTION_REWARD_SELECTED, {
              user_id: v.id,
