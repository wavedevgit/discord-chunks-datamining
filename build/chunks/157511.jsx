...
function h(e) {
  ...
  }, [O, h, P, N]), <r.Fragment>{<img className={m.sun} style={{
        bottom: "calc(".concat(_, "% - ").concat(C / 2, "px)"),
        right: Z,
        width: C,
        height: C
      }} src={g} alt={p.intl.string(f.default.JTkCcX)} />}{<u.Z itemId={d.yN.SUN} pointsPerInterval={v} interval={1e3} isPaused={n} />}</r.Fragment>
}