...
function G(e) {
  ...
  n.status !== E.Skl.OFFLINE || null != n.hiddenActivities && n.hiddenActivities.length > 0 ? (v[e] = n.status, j(e, n.activities), T[e] = B(Object.values(t).flatMap(e => {
    var t;
...
function Z(e) {
  ...
  if (n.status !== E.Skl.OFFLINE || null != n.hiddenActivities && n.hiddenActivities.length > 0) {
    var r;
    v[e] = n.status, j(e, n.activities), T[e] = null != (r = n.hiddenActivities) ? r : [], null != n.clientStatus && (A[e] = n.clientStatus)
  }
}
...
function en(e) {
  ...
  v[t] = e.status, j(t, [...e.activities].sort(L)), T[t] = [...e.hiddenActivities].sort(L), delete C[t]
}
