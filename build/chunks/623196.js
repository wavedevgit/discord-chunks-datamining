    ...
    S = () => {
      x({
        ...
        body: b.NW.format(b.t.fSv59f, {
          helpdeskArticle: u.Z.getArticleURL(_.BhN.GDPR_PACKAGE_CONTENTS)
        }),
  ...
  return (0, r.jsxs)(h.U, {
    ...
    children: [(0, r.jsx)(h.H, {
      ...
      description: b.NW.format(b.t.P3kNfn, {
        helpdeskArticle: u.Z.getArticleURL(_.BhN.GDPR_REQUEST_DATA)
      })
    }), O ? (0, r.jsx)(o.Zbd, {
      className: N.card,
      children: (0, r.jsx)(o.Text, {
        ...
        children: b.NW.format(b.t.RNDlV1, {
          date: a()(t.created_at).add(_.eBq, "days").format("MMMM Do YYYY")
        })
      })
    }) : (0, r.jsx)("div", {
      className: N.button,
