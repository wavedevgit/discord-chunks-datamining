...
function em(e) {
  ...
  if (null == r || !r.isRingable() || "GUILD_RING_START" === e.type && !h.Z.getCurrentConfig({
    ...
    }).enabled || I.Z.getStatus() === H.Skl.DND || f.QZ.getSetting()) return !1;
  let o = en.find(e => e.type === L.kL.TEXT && e.channelId === t && e.messageType === H.uaV.CALL);
  null != o && ed(o.id), ef((0, z.Z)(r), {
    priority: L.Tu.HIGH,
...
let ey = new eg(s.Z, {
  ...
  ACTIVITY_USER_ACTION: function(e) {
    let t, {
      ...
      o = (0, R.pL)();
    return null != o && (null == o ? void 0 : o.id) != null && (o.id === r || o.altId === r) && (n === H.mFx.JOIN && (t = (0, V.Z)(i, o)), null != t && void ef(t, {
      priority: L.Tu.URGENT,
      type: L.kL.GENERIC
    }))
  },
