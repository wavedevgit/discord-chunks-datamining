...
function eu() {
  if (er && null == ei.find(e => e.status === Y._1z.FOCUSED))
    for (let e of (er = !1, ei = [...ei, ...eo], eo = [], ei.length > 40 && (ei.length = 40), ei)) e.timer.start()
}
        ...
        return {
          start() {
            let r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : t,
              o = r ? Y._1z.TIMED_OUT : Y._1z.DISMISSED; - 1 === i && (i = setTimeout(() => c.Z.updateNotificationStatus(e, o), null != n ? n : q))
          },
          stop() {
            clearTimeout(i), i = -1
          }
...
function eg(e) {
  ...
  if (null == r || !r.isRingable() || "GUILD_RING_START" === e.type && !h.Z.getCurrentConfig({
    ...
    }).enabled || x.Z.getStatus() === Y.Skl.DND || f.QZ.getSetting()) return !1;
...
let eO = new ey(s.Z, {
  ...
  MESSAGE_CREATE: function(e) {
    ...
    let {
      channelId: r,
      message: l
    } = e, a = g.Z.getChannel(r), s = I.default.getUser(null == (t = l.author) ? void 0 : t.id);
  ...
  ACTIVITY_USER_ACTION: function(e) {
    let t, {
      ...
      o = (0, L.pL)();
    return null != o && (null == o ? void 0 : o.id) != null && (o.id === r || o.altId === r) && (n === Y.mFx.JOIN && (t = (0, z.Z)(i, o)), null != t && void eh(t, {
      priority: R.Tu.URGENT,
      type: R.kL.GENERIC
    }))
  },
  ...
  CLIPS_SAVE_CLIP: function() {
    eh((0, U.f)(Q.intl.format(Q.t.KLhk6u, {
