...
function ec() {
  if (ei && null == en.find(e => e.status === F._1z.FOCUSED))
    for (let e of (ei = !1, en = [...en, ...er], er = [], en.length > 40 && (en.length = 40), en)) e.timer.start()
}

function eu() {
  let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 3;
  en.filter(e => e.type === D.kL.TEXT && e.status === F._1z.TIMED_OUT).sort((e, t) => t.timestamp - e.timestamp).forEach((t, n) => {
...
function ed(e) {
  ...
  t === F._1z.DISMISSED ? en.splice(n, 1) : en[n] = X(K({}, i), {
    status: t
  }), ec()
}
        ...
        return {
          start() {
            let r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : t,
              o = r ? F._1z.TIMED_OUT : F._1z.DISMISSED; - 1 === i && (i = setTimeout(() => c.Z.updateNotificationStatus(e, o), null != n ? n : J))
          },
          stop() {
            clearTimeout(i), i = -1
          }
...
function ef() {
  ...
  for (let [n, r] of Object.entries(e)) i = i || function(e, t) {
    ...
    if (null == o || o.type !== F.IIU.PLAYING || ! function(e) {
        var t;
...
function em(e) {
  ...
  if (null == r || !r.isRingable() || "GUILD_RING_START" === e.type && !f.Z.getCurrentConfig({
    ...
    }).enabled || x.Z.getStatus() === F.Skl.DND || h.QZ.getSetting()) return !1;
...
let ey = new eg(s.Z, {
  ...
  ACTIVITY_USER_ACTION: function(e) {
    let t, {
      ...
      o = (0, L.pL)();
    return null != o && (null == o ? void 0 : o.id) != null && (o.id === r || o.altId === r) && (n === F.mFx.JOIN && (t = (0, M.Z)(i, o)), null != t && void eh(t, {
      priority: D.Tu.URGENT,
      type: D.kL.GENERIC
    }))
  },
  ...
  CLIPS_SAVE_CLIP: function() {
    eh((0, V.f)(Y.intl.format(Y.t.KLhk6u, {
