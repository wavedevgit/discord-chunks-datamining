...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk932711 = require("./932711.js"),
  Chunk871301 = require("./871301.js"),
  Chunk981631 = require("./981631.js"),
  Chunk490897 = require("./490897.js"),
  Chunk522458 = require("./522458.js");
...
function S(e) {
  ...
  return <u.H ref={O}>{<c.Z selected={P && N === g.jP.SIDEBAR} hovered={S && N === g.jP.SIDEBAR} unread={T > 0} className={j.pill} disabled={N === g.jP.LEGACY} />}{<_.Z><s.aRk selected={P || S} lowerBadge={w} lowerBadgeSize={Z}><s.LYs{...t = function(e) {
...
function x() {
  let e = Chunk73800.useRef(null),
    ...
    n = E(),
    l = (0, Chunk128008.mv)();
  return exports === Chunk821020.jP.SIDEBAR ? <S onClick={Chunk91192} /> : exports === Chunk821020.jP.POPOUT ? <Chunk961040.Z targetElementRef={module} popoutPosition={"right"} popoutAlign={"bottom"}>{(t, n, i) => (0, r.jsx)(S, {
      ref: e,
      selectedOverride: n,
      onClick: () => {
        l(), t()
      ...
      popoutProps: i
    })}</Chunk961040.Z> : exports === Chunk821020.jP.LEGACY ? <Chunk178088.k spacing={0} badgeState={{
      badgeForYou: require
    }} targetElementRef={module} popoutPosition={"right"} popoutAlign={"top"} dialogClassName={Chunk522458.positionLayer}>{(t, n, i) => (0, r.jsx)(S, {
      ref: e,
      selectedOverride: n,
      onClick: () => {
        l(), t()
