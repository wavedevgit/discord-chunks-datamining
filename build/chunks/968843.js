...
function er(e, t) {
  ...
  if (u !== (c && (null == (r = t.userStatus) ? true : r.completedAt) == null)) return u ? ee : et;
  let d = !(0, F.zi)(e),
    ...
    m = (null == (s = t.userStatus) ? true : s.enrolledAt) != null,
    {
      enabled: h,
      minutes: g
    } = (0, M.eC)(q.dr.QUEST_HOME_DESKTOP),
    E = T.Z.Millis.MINUTE * g,
    b = e7(e, E),
    y = e7(t, E);
  return d ? h && b !== y && (b || y) ? b ? et : ee : f !== p ? f ? et : ee : _ !== m ? _ ? ee : et : eh(e.config.expiresAt, t.config.expiresAt, 1) : f !== p ? f ? ee : et : _ !== m ? _ ? ee : et : eh(e.config.expiresAt, t.config.expiresAt, 0)
}
...
function ea(e, t) {
  ...
  return null == i && null == a ? eh(e.config.expiresAt, t.config.expiresAt, 0) : null != i && null == a ? ee : null == i && null != a ? et : eh(i, a, 0)
}
...
function eE(e) {
  ...
  return r.useMemo(() => {
    ...
    let e = t.sort((e, t) => {
      ...
      return i !== ((null == (r = t.userStatus) ? true : r.claimedAt) == null) ? i ? ee : et : eh(e.config.rewardsConfig.rewardsExpireAt, t.config.rewardsConfig.rewardsExpireAt, 0)
    }).map(e => e.id);
...
function eG() {
  let {
    ...
    let e = exports.filter(e => false === e.revoked),
      n = module.filter(e => e.type === Q.ABu.XBOX),
      r = module.filter(e => e.type === Q.ABu.PLAYSTATION),
...
let eZ = e => {
  ...
  eF = () => {
    ...
    } = eG(), n = module.length > 0, r = exports.length > 0, i = require && !Chunk473749 || !require && Chunk473749, a = Chunk63063.Z.getArticleURL(Chunk981631.BhN.QUEST_HOW_TO_PLAYSTATION), o = Chunk63063.Z.getArticleURL(Chunk981631.BhN.QUEST_HOW_TO_XBOX), s = Chunk388032.intl.format(Chunk388032.t.beN4DG, {
...
function eK(e, t) {
  let [n, i] = eW(e.id), s = r.useMemo(() => (0, H.yH)(e), [e]), l = s.includes(q.cd.DESKTOP), c = s.includes(q.cd.CONSOLE), u = eC(e), d = eN(e), f = r.useMemo(() => (0, a.EQ)(t).with({
    percentComplete: 0
  }, () => null).with({
  ...
  }, () => q.cd.DESKTOP).exhaustive(), [t]), p = u ? q.cd.DESKTOP : d ? q.cd.CONSOLE : null;
  return [r.useMemo(() => (0, a.EQ)({
    lastPlatformProgress: f,
    currentProgressingPlatform: p,
    selectedPlatform: n
  }).with({
    currentProgressingPlatform: q.cd.CONSOLE
  }, () => j.LI.CONSOLE).with({
    currentProgressingPlatform: q.cd.DESKTOP
  }, () => j.LI.DESKTOP).with({
...
function eJ(e) {
  ...
  if (null == n) return $.intl.formatToPlainString($.t.l9uXL8, {
    decorationName: t
  });
  let l = $.intl.formatToPlainString($.t.o97tNn, {
      rewardName: t
    }),
    ...
    _ = s ? u : f,
    m = i ? p : _;
  return a ? m : $.intl.formatToPlainString($.t.tTlItm, {
    duration: n,
    decorationName: t
  })
}
...
let e0 = () => (0, Chunk442837.Wu)([Chunk616022.Z], () => [...Chunk616022.Z.quests.values()]).some(e => e.preview),
  e1 = () => {
  ...
  e3 = e => {
    var t;
    let n = (null == e ? true : e.userStatus) != null && (0, F.zE)(e.userStatus, j.jn.ACTIVITY_PANEL),
      r = eI(null != e ? e : null),
