...
function V(e) {
  ...
  return {
    react(e, i, o) {
      ...
      return e.src ? <y.c node={e} tooltipPosition={t} enableClick={n} channelId={s} messageId={l} /> : <span>{e.surrogate}</span>
    }
  }
}
...
function H(e) {
  ...
  return {
    react(e, i, o) {
      ...
      return <y.Y isInteracting={u} node={e} tooltipPosition={t} enableClick={n} channelId={l} messageId={c} />
    }
  }
}
...
function W(e) {
  ...
  return <l.P3F onClick={a}>{n ? (0, r.jsx)(l.dz2, {
      size: "xs",
      color: "currentColor"
    }) : (0, r.jsx)(l.TIy, {
      size: "xs",
...
let K = {
  blockQuote: {
    react: (e, t, n) => <div className={j.blockquoteContainer}>{<div className={j.blockquoteDivider} />}{<blockquote>{t(e.content, n)}</blockquote>}</div>
  },
  s: {
    react: (e, t, n) => <s>{t(e.content, n)}</s>
  },
  highlight: {
    react: (e, t, n) => <span className={"highlight"}>{e.content}</span>
  },
  paragraph: {
    react: (e, t, n) => <p>{t(e.content, n)}</p>
  },
  inlineCode: {
    react: (e, t, n) => <code className={"inline"}>{(0, A.S)(e, t, n)}</code>
  },
  codeBlock: {
    react(e, t, i) {
      let o = () => <code className={a()(U.scrollbarGhostHairline, "hljs")}>{(0, A.S)(e, t, i)}</code>;
      return <pre><div className={j.codeContainer}>{S.wS ? <div className={j.codeActions}><W text={e.content} /></div> : null}{<d.GI createPromise={() => Promise.resolve().then(n.bind(n, 364964))} webpackId={364964} renderFallback={o} render={t => {
  ...
  text: {
    react: (e, t, n) => "string" == typeof e.content ? <span>{e.content}</span> : <span>{t(e.content, n)}</span>
  },
  spoiler: {
    react: (e, t, n) => <f.ZP type={f.ZP.Types.TEXT} inline={n.formatInline} renderTextElement={(e, t) => null == e || e.type !== u.Z || t ? e : i.cloneElement(e, {
        tabIndex: false
      })}>{() => t(e.content, n)}</f.ZP>
  },
  soundboard: {
    react: (e, t, n) => <b.ZP channelId={e.channelId} messageId={e.messageId} soundId={e.soundId} jumbo={e.jumboable} messageSounds={n.soundboardSounds} />
  },
  staticRouteLink: {
    react(e, t, n) {
      let i = () => {
      ...
      return (0, A.k)(e.id) ? <m.Z role={"link"} onClick={i} className={"channelMention"} iconType={e.id}>{t(e.mainContent, n)}{null != e.itemContent ? <g.Z /> : null}{null != e.itemContent ? t(e.itemContent, n) : null}</m.Z> : null
    }
  },
  timestamp: {
    react: (e, t, n) => <N.Z node={e} />
  },
  list: {
    react: (e, t, n) => {
  ...
  guild: {
    react: (e, t, n) => {
      ...
      return <h.Z guild={i}>{(0, A.S)(e, t, n)}</h.Z>
    }
  },
  channel: {
    react: (e, t, n) => <p.Z iconType={e.iconType}>{(0, A.S)(e, t, n)}</p.Z>
  },
  message: {
    react: (e, t, n) => <E.Z />
  },
