/** Chunk was on web.js **/
/** chunk id: 20816, original params: e (module,exports,re quire) **/
"use strict";
...
Object.create && (r.prototype = Object.create(null), new r().__proto__ || (n = false)), o.prototype.eventNames = function() {
  var e, r, i = [];
  ...
  if (u.fn) {
    switch (u.once && this.removeListener(e, u.fn, true, true), d) {
      ...
      case 5:
        return u.fn.call(u.context, t, r, i, a), true;
      case 6:
        return u.fn.call(u.context, t, r, i, a, s), true
    }
...
}, o.prototype.off = o.prototype.removeListener, o.prototype.addListener = o.prototype.on, o.prefixed = n, o.EventEmitter = o, module.exports = o