...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk659947 = require("./659947.js"),
  Chunk981631 = require("./981631.js"),
  Chunk420212 = require("./420212.js"),
  Chunk388032 = require("./388032.jsx"),
  Chunk628000 = require("./628000.js"),
...
class G extends Chunk73800.PureComponent {
  renderMessage() {
    ...
    return Chunk714338.Z.hasBind(exports) ? <Chunk481060.R94 className={Chunk628000.keybindMessage} type={Chunk481060.geA.DESCRIPTION} style={{
        color: Chunk692547.Z.unsafe_rawColors.RED_400.css
      }}>{Chunk388032.intl.string(Chunk388032.t["7lQlw8"])}</Chunk481060.R94> : Chunk420212.Sp.has(exports) ? <Chunk481060.R94 className={Chunk628000.keybindMessage} type={Chunk481060.geA.DESCRIPTION} style={{
        color: Chunk692547.Z.unsafe_rawColors.RED_400.css
      }}>{Chunk388032.intl.format(Chunk388032.t.MOIaNT, {
        keyboardNavArticle: Chunk63063.Z.getArticleURL(Chunk981631.BhN.KEYBOARD_NAVIGATION)
      })}</Chunk481060.R94> : <Chunk481060.R94 className={Chunk628000.keybindMessage} type={Chunk481060.geA.DESCRIPTION}>{this.props.keybindDescriptions[module.action]}</Chunk481060.R94>
  }
  render() {
    let {
      managed: e,
    ...
    return <Chunk600164.Z direction={Chunk600164.Z.Direction.VERTICAL} className={a()(Chunk628000.keybindGroup, Chunk588866.card)}>{!module && <Chunk225433.Z aria-label={Chunk388032.intl.string(Chunk388032.t.qEHmmJ)} className={Chunk628000.removeKeybind} onClick={this.handleDeleteKeybind} look={Chunk225433.Z.Looks.FILLED} />}{<Chunk600164.Z className={Chunk20493.marginBottom8}>{<Chunk600164.Z.Child basis={"45%"}><Chunk481060.xJW title={Chunk388032.intl.string(Chunk388032.t.UUpADw)} className={Chunk628000.item}><Chunk481060.q4e value={this.props.keybind.action} options={this.props.keybindActionTypes} onChange={this.handleActionChanged} isDisabled={module} /></Chunk481060.xJW></Chunk600164.Z.Child>}{<Chunk600164.Z.Child basis={"45%"}><Chunk481060.xJW title={Chunk388032.intl.string(Chunk388032.t["1La4tL"])} className={Chunk628000.item}><Chunk825209.Z defaultValue={this.props.keybind.shortcut} onChange={this.handleShortcutChange} /></Chunk481060.xJW></Chunk600164.Z.Child>}{<Chunk600164.Z.Child grow={0} shrink={0}><Chunk481060.xJW className={Chunk628000.switch}><Chunk481060.ua7 text={Chunk388032.intl.string(Chunk388032.t.uCD7qK)}>{e => (0, i.jsx)("div", B(M({}, e), {
                children: (0, i.jsx)(m.rsf, {
                  checked: t,
                  onChange: this.handleEnableDisable
                })
              }))}</Chunk481060.ua7></Chunk481060.xJW></Chunk600164.Z.Child>}</Chunk600164.Z>}{<Chunk600164.Z.Child>{this.renderMessage()}</Chunk600164.Z.Child>}{this.renderExtraSettings()}</Chunk600164.Z>
  }
  renderExtraSettings() {
    let {
      action: e
    } = this.props.keybind;
    return module === Chunk981631.kg4.SWITCH_TO_VOICE_CHANNEL ? <Chunk659947.Z keybind={this.props.keybind} /> : true
  }
  constructor(...e) {
...
class F extends Chunk73800.PureComponent {
  ...
  renderKeybinds(e) {
    return e.map(e => <div className={Z.row}><G keybind={e} keybindDescriptions={this.keybindDescriptions} keybindActionTypes={this.keybindActionTypes} /></div>)
  }
  renderEmpty(e) {
  ...
  render() {
    ...
    return <Chunk255367.Fragment>{<Chunk481060.hjN tag={Chunk481060.RB0.H1} title={Chunk388032.intl.string(Chunk388032.t.T9DA2N)}>{Chunk358085.isPlatformEmbedded ? (0, Chunk255367.jsxs)(Chunk255367.Fragment, {
          ...
          className: Chunk628000.browserNotice,
          children: Chunk388032.intl.format(Chunk388032.t.mPi3Fx, {
            downloadLink: Chunk981631.EYA.DOWNLOAD
          })
        })}</Chunk481060.hjN>}{<Chunk481060.$i$ />}{<Chunk481060.hjN tag={Chunk481060.RB0.H1} title={Chunk388032.intl.string(Chunk388032.t.Lz5KHB)} className={Chunk20493.marginTop60}>{<div className={Chunk628000.defaultKeybind}>{<Chunk481060.Text variant={"text-md/normal"}>{Chunk388032.intl.string(Chunk388032.t.sMWLBg)}</Chunk481060.Text>}{<div className={Chunk628000.defaultKeybindShortcutGroup}><Chunk481060.M2$ shortcut={Chunk721383._.binds["0"]} className={Chunk628000.__invalid_defaultKeybindShortcut} /></div>}</div>}{<Chunk481060.$i$ />}{<U>{e => (0, i.jsx)(i.Fragment, {
            children: e.map((e, t) => {
              let n = (0, b.UD)(e),
                s = (0, b.U6)(e),
                l = V[e];
          ...
          })}</U>}</Chunk481060.hjN>}</Chunk255367.Fragment>
  }
  constructor(...e) {
...
function H() {
  let e = (0, Chunk442837.e7)([Chunk556296.ZP], () => Chunk556296.ZP.getState()),
    ...
    r = (0, Chunk924557.Go)();
  return <F keybinds={module} canGoLive={exports} overlaySupported={require} allowSoundboard={(0, Chunk358085.isWindows)()} enableClips={Chunk73800} />
}