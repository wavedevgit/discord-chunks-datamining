...
let _ = (e, t, n, r) => {
    ...
    return {
      priceOptions: E,
      discountAmountOff: null == b || null == (_ = b.invoiceItems) || null == (p = _.find(t => t.subscriptionPlanId === e)) || null == (d = p.discounts) || null == (c = d.find(e => e.type === i.iS.SUBSCRIPTION_PLAN)) ? true : c.amount
    }
  },
  h = e => {
    let {
