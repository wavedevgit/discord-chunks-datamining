...
function l(e) {
  let {
    ...
    top: 0,
    bottom: 0
  }), d = (0, r.useRef)(null), f = (0, r.useCallback)(e => ({
  ...
  (0, r.useEffect)(() => {
    ...
    if (!(true === g && (null == m ? true : m.itemType) === "WIDGET" && !b)) {
      null !== c.current && cancelAnimationFrame(c.current), c.current = null, t.style.overflowAnchor = "auto", t.style.overscrollBehavior = "auto", s.current = 0;
      return
    }
    ...
    return u.current = {
      top: e.top,
      bottom: e.bottom
    }, t.style.overflowAnchor = "none", t.style.overscrollBehavior = "contain", c.current = requestAnimationFrame(function e(r) {
