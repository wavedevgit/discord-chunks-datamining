...
function M(e) {
  let {
    ...
    giftMessageError: g,
    isSendingMessage: y
  } = e, [O, I] = i.useState(f.kO8.Modes.DEFAULT), S = (0, c.e7)([T.Z], () => T.Z.enabled), M = _ || null != l && null != p, U = (null == o ? true : o.productLine) === w.POd.COLLECTIBLES, G = (0, E.Z)(), {
