...
function M(e) {
  let {
    ...
    let e;
    return null != g ? x.intl.string(x.t.qB8ayc) : null == s ? null : (e = s.interval === D.rV.MONTH ? M ? F ? Z.monthGiftText : x.t["4ZJ+7e"] : x.t["P+z55e"] : M ? F ? Z.yearGiftText : x.t.p0pZXF : x.t.bXqk3t, x.intl.format(e, {
      skuName: (0, N.aq)(s.id),
