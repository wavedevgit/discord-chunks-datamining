...
function M(e) {
  let {
    ...
    giftMessageError: g,
    isSendingMessage: y
  } = e, [O, I] = i.useState(f.kO8.Modes.DEFAULT), T = (0, c.e7)([S.Z], () => S.Z.enabled), M = _ || null != l && null != p, U = (null == a ? true : a.productLine) === w.POd.COLLECTIBLES, G = (0, E.Z)(), {
    ...
    let e;
    return null != g ? x.intl.string(x.t.qB8ayc) : null == s ? null : (e = s.interval === D.rV.MONTH ? M ? V ? Z.monthGiftText : x.t["4ZJ+7e"] : x.t["P+z55e"] : M ? V ? Z.yearGiftText : x.t.p0pZXF : x.t.bXqk3t, x.intl.format(e, {
      skuName: (0, N.aq)(s.id),
      intervalCount: s.intervalCount
    }))
  }, W = () => null != p || _ && null == g ? x.intl.string(x.t.zOmK9P) : null != g ? x.intl.string(x.t.d1lrmZ) : x.intl.string(x.t["/s1xR0"]), K = (e, t) => {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(f.vwX, {
        children: x.intl.string(x.t["/dG4ND"])
      }), null != t && (0, r.jsx)(f.kO8, {
        hideMessage: T ? x.intl.string(x.t["0RLn4+"]) : null,
        value: (0, C.Nz)(t),
        mode: O,
        text: e,
        onCopy: e => K(e, t),
...
let k = e => {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(f.vwX, {
      children: x.intl.string(x.t.MJw05e)
    }), (0, r.jsxs)("div", {
      className: L.giftRecipient,
