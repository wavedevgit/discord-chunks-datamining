...
function m(e) {
  ...
  let {
    ...
    context: v,
    onItemClick: b
  } = e, y = null !== (t = null == g ? void 0 : g.id) && void 0 !== t ? t : null == m ? void 0 : m.id, O = f.Z.getGuild(E), S = (0, o.e7)([_.Z], () => null != O ? _.Z.can(p.Plq.MANAGE_GUILD, O) : null), I = !0, T = !0, N = (0, c.LD)(E, T), A = (0, c.PL)(I, T), {
    isUserApp: C,
    isGuildApp: R
  } = i.useMemo(() => {
    var e, t, n, r;
