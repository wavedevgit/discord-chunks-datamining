...
function g(e) {
  ...
  let {
    ...
    context: y,
    onItemClick: O
  } = e, v = null != (t = null == E ? void 0 : E.id) ? t : null == g ? void 0 : g.id, I = f.Z.getGuild(b), T = (0, a.e7)([p.Z], () => null != I ? p.Z.can(h.Plq.MANAGE_GUILD, I) : null), S = !0, A = !0, N = (0, c.LD)(b, A), C = (0, c.PL)(S, A), R = (0, a.e7)([_.Z], () => null != _.Z.getNewestTokenForApplication(v)), {
    isUserApp: P,
    isGuildApp: w
  } = i.useMemo(() => {
    var e, t, n, r;
  ...
  let x = [];
  return w && T && x.push((0, r.jsx)(o.sNh, {
