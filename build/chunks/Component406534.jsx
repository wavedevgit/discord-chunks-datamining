...
function et(e) {
  ...
  let eP = null,
    ...
    eZ = el.map((e, t) => {
      ...
      if (e.type === K.ys_.MESSAGE_GROUP_BLOCKED || e.type === K.ys_.MESSAGE_GROUP_IGNORED || e.type === K.ys_.MESSAGE_GROUP_SPAMMER) {
        let t;
        return t = e.type === K.ys_.MESSAGE_GROUP_BLOCKED ? J.t["+FcYM/"] : e.type === K.ys_.MESSAGE_GROUP_IGNORED ? J.t["VFWjc+"] : J.t.xfkfTK, (0, i.jsx)(H.Z, {
          unreadId: Y.j1,
          messages: e,
          channel: U,
          compact: er,
  ...
  if (et.hasMoreBefore && null == ec || eI.unshift((0, i.jsx)(f.Z, {
    ...
    } else ex.includes(q.E.NEW_MESSAGES) && (r = (0, i.jsx)(V.LE, {
  ...
  if (null == r && (0, s.Lp)(U) && eC && ex.includes(q.E.SUMMARIES) && (r = (0, i.jsx)(V.BO, {
      channel: U,
      scrollManager: eo
    })), et.error) h = (0, i.jsx)(V.Rp, {
    ...
    h = et.loadingMore && et.jumpedToPresent ? (0, i.jsx)(V.DR, {
      className: ep
    }) : null != e ? (0, i.jsx)(V.DR, {
      type: V.A7.REPLY,
      onClick: () => {
