...
function T() {
  N.clear(), Object.values(g.Z.getMutablePrivateChannels()).forEach(e => {
    N.set(e.id, v(e))
  })
}
...
a = "PrivateChannelSortStore", (s = "displayName") in P ? Object.defineProperty(P, s, {
  value: a,
  enumerable: !0,
  configurable: !0,
  writable: !0
