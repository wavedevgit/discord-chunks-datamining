...
function P() {
  C.clear(), Object.values(v.Z.getMutablePrivateChannels()).forEach(e => {
    C.set(e.id, S(e))
  })
}
...
l = "PrivateChannelSortStore", (a = "displayName") in T ? Object.defineProperty(T, a, {
  value: l,
  enumerable: !0,
  configurable: !0,
  writable: !0
