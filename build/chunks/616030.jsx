...
function a(e) {
  ...
  return <o.NQ className={a} nextScene={l} onScenePlay={e => c(o.NQ.getNextScene(e))} pauseWhileUnfocused={false} pause={s} />
}
...
function s(e) {
  ...
  return <o.HC className={a} nextScene={l} onScenePlay={e => c(o.HC.getNextScene(e))} pauseWhileUnfocused={false} pause={s} />
}
...
function l(e) {
  ...
  return <o.Db className={a} nextScene={l} onScenePlay={e => c(o.Db.getNextScene(e))} pauseWhileUnfocused={false} pause={s} />
}