  ...
  setGoLiveSource(e) {
    ...
    if (this.goLiveSourceIdentifier = a, null != this.conn.setDesktopSource) {
      if (null != e.desktopDescription) {
        ...
        null != t ? this.logger.info("capturing desktop (type: ".concat(h, ", handle: ").concat(m, ", use-video-hook: ").concat(i.toString(), ", use-graphics-capture: ").concat(null == s ? true : s.toString(), ", use-graphics-capture-api-level: ").concat(null == a ? true : a.toString(), ", use-capture-device-for-encode: ").concat(null == o ? true : o.toString(), ").")) : this.logger.info("capturing desktop (type: <stop>)."), null != this.conn.setDesktopSourceWithOptions ? null != t ? this.conn.setDesktopSourceWithOptions({
          type: h,
          sourceId: m,
          useVideoHook: i,
          useGraphicsCapture: s,
