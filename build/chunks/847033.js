...
function A(e) {
  ...
  let {
    ...
    initialTab: l,
    guildId: o
  } = e, R = (0, s.e7)([p.Z], () => p.Z.getGuild(o)), A = (0, s.e7)([h.Z], () => h.Z.isViewingServerShop(o)), y = (0, g.g)(R, "guild_shop_page"), b = (0, O.RF)(o, "guild_shop_page"), P = (null == R ? void 0 : R.features.has(N.oNc.PRODUCTS_AVAILABLE_FOR_PURCHASE)) === !0, D = (0, _.mY)(null == R ? void 0 : R.id), v = null == (t = (0, u.YB)(o)) ? void 0 : t.server_shop_tab_order, U = [], M = T.y.GUILD_SHOP_FULL_PREVIEW;
  ...
  let [L, Z] = r.useState(l), k = y && !(D && b) || L === T.y.GUILD_PRODUCTS_PREVIEW;
  return r.useEffect(() => {
    Z(l)
  }, [l]), (0, i.jsx)(m.Provider, {
    value: {
      selectedTab: L,
      setSelectedTab: Z,
      categoryTabs: U,
