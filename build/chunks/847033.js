...
function A(e) {
  ...
  let {
    ...
    initialTab: l,
    guildId: o
  } = e, m = (0, s.e7)([p.Z], () => p.Z.getGuild(o)), A = (0, s.e7)([h.Z], () => h.Z.isViewingServerShop(o)), P = (0, T.g)(m, "guild_shop_page"), y = (0, g.RF)(o, "guild_shop_page"), b = (null == m ? void 0 : m.features.has(f.oNc.PRODUCTS_AVAILABLE_FOR_PURCHASE)) === !0, D = (0, _.mY)(null == m ? void 0 : m.id), v = null == (t = (0, u.YB)(o)) ? void 0 : t.server_shop_tab_order, U = [], M = O.y.GUILD_SHOP_FULL_PREVIEW;
  ...
  let [L, Z] = r.useState(l), k = P && !(D && y) || L === O.y.GUILD_PRODUCTS_PREVIEW;
  return r.useEffect(() => {
    Z(l)
  }, [l]), (0, i.jsx)(R.Provider, {
    value: {
      selectedTab: L,
      setSelectedTab: Z,
      categoryTabs: U,
