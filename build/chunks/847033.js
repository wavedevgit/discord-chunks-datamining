...
function g(e) {
  ...
  let {
    ...
    initialTab: l,
    guildId: o
  } = e, D = (0, a.e7)([N.Z], () => N.Z.getGuild(o)), g = (0, a.e7)([_.Z], () => _.Z.isViewingServerShop(o)), y = (0, p.g)(D, "guild_shop_page"), m = (0, S.RF)(o, "guild_shop_page"), h = (null == D ? void 0 : D.hasFeature(f.oNc.PRODUCTS_AVAILABLE_FOR_PURCHASE)) === !0, b = (0, E.mY)(null == D ? void 0 : D.id), U = null == (t = (0, d.YB)(o)) ? void 0 : t.server_shop_tab_order, M = [], L = A.y.GUILD_SHOP_FULL_PREVIEW;
  ...
  let [Z, k] = i.useState(l), v = y && !(b && m) || Z === A.y.GUILD_PRODUCTS_PREVIEW;
  return i.useEffect(() => {
    k(l)
