...
function D(e) {
  ...
  let {
    ...
    initialTab: l,
    guildId: o
  } = e, m = (0, a.e7)([O.Z], () => O.Z.getGuild(o)), D = (0, a.e7)([_.Z], () => _.Z.isViewingServerShop(o)), g = (0, p.g)(m, "guild_shop_page"), h = (0, S.RF)(o, "guild_shop_page"), y = (null == m ? void 0 : m.hasFeature(C.oNc.PRODUCTS_AVAILABLE_FOR_PURCHASE)) === !0, b = (0, d.mY)(null == m ? void 0 : m.id), U = null === (t = (0, E.YB)(o)) || void 0 === t ? void 0 : t.server_shop_tab_order, k = [], M = P.y.GUILD_SHOP_FULL_PREVIEW;
  D || y && b ? (k.push(U === A.a3.PRODUCTS_FIRST ? P.y.GUILD_PRODUCTS : P.y.GUILD_ROLE_SUBSCRIPTIONS), k.push(U === A.a3.PRODUCTS_FIRST ? P.y.GUILD_ROLE_SUBSCRIPTIONS : P.y.GUILD_PRODUCTS), M = k[0]) : y && !b ? (k.push(P.y.GUILD_PRODUCTS), M = P.y.GUILD_PRODUCTS) : !y && b && (k.push(P.y.GUILD_ROLE_SUBSCRIPTIONS), M = P.y.GUILD_ROLE_SUBSCRIPTIONS, g && k.push(P.y.GUILD_PRODUCTS_PREVIEW)), l = null != l ? l : M;
  let [v, Z] = i.useState(l), j = g && !(b && h) || v === P.y.GUILD_PRODUCTS_PREVIEW;
  return i.useEffect(() => {
    Z(l)
