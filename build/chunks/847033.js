...
function C(e) {
  ...
  let {
    ...
    initialTab: o,
    guildId: a
  } = e, T = (0, s.e7)([m.Z], () => m.Z.getGuild(a)), N = (0, s.e7)([_.Z], () => _.Z.isViewingServerShop(a)), C = (0, b.g)(T, "guild_shop_page"), R = (0, E.RF)(a, "guild_shop_page"), P = (null == T ? void 0 : T.features.has(I.oNc.PRODUCTS_AVAILABLE_FOR_PURCHASE)) === !0, w = (0, f.mY)(null == T ? void 0 : T.id), D = w && R, L = null == (t = (0, d.YB)(a)) ? void 0 : t.server_shop_tab_order, x = [], M = y.y.GUILD_SHOP_FULL_PREVIEW;
