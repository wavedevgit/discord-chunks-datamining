...
function y(e) {
  ...
  let {
    ...
    initialTab: l,
    guildId: a
  } = e, b = (0, o.e7)([f.Z], () => f.Z.getGuild(a)), y = (0, o.e7)([E.Z], () => E.Z.isViewingServerShop(a)), A = (0, T.g)(b, "guild_shop_page"), C = (0, h.RF)(a, "guild_shop_page"), P = (null == b ? void 0 : b.features.has(N.oNc.PRODUCTS_AVAILABLE_FOR_PURCHASE)) === !0, D = (0, _.mY)(null == b ? void 0 : b.id), M = null == (t = (0, d.YB)(a)) ? void 0 : t.server_shop_tab_order, j = [], x = S.y.GUILD_SHOP_FULL_PREVIEW;
  ...
  let [k, v] = i.useState(l), L = A && !(D && C) || k === S.y.GUILD_PRODUCTS_PREVIEW;
  return i.useEffect(() => {
    v(l)
