...
function m(e) {
  ...
  let {
    ...
    initialTab: l,
    guildId: o
  } = e, A = (0, s.e7)([p.Z], () => p.Z.getGuild(o)), m = (0, s.e7)([h.Z], () => h.Z.isViewingServerShop(o)), y = (0, T.g)(A, "guild_shop_page"), P = (0, O.RF)(o, "guild_shop_page"), b = (null == A ? void 0 : A.features.has(N.oNc.PRODUCTS_AVAILABLE_FOR_PURCHASE)) === !0, D = (0, _.mY)(null == A ? void 0 : A.id), v = null == (t = (0, d.YB)(o)) ? void 0 : t.server_shop_tab_order, U = [], M = g.y.GUILD_SHOP_FULL_PREVIEW;
