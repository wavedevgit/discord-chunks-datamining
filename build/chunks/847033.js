...
function P(e) {
  ...
  let {
    ...
    initialTab: l,
    guildId: o
  } = e, g = (0, a.e7)([T.Z], () => T.Z.getGuild(o)), P = (0, a.e7)([E.Z], () => E.Z.isViewingServerShop(o)), y = (0, S.g)(g, "guild_shop_page"), D = (0, N.RF)(o, "guild_shop_page"), b = (null == g ? void 0 : g.hasFeature(m.oNc.PRODUCTS_AVAILABLE_FOR_PURCHASE)) === !0, h = (0, _.mY)(null == g ? void 0 : g.id), U = null == (t = (0, d.YB)(o)) ? void 0 : t.server_shop_tab_order, M = [], v = A.y.GUILD_SHOP_FULL_PREVIEW;
  ...
  let [k, L] = i.useState(l), Z = y && !(h && D) || k === A.y.GUILD_PRODUCTS_PREVIEW;
  return i.useEffect(() => {
    L(l)
