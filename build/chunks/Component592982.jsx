...
function _(e) {
  let {
    ...
    id: N,
    type: T
  } = _, P = (0, l.bG)([u.A], () => u.A.getGuild(_.guild_id), [_.guild_id]), w = (0, l.bG)([d.A], () => d.A.getSelectedParticipant(N)), R = (null == w ? true : w.type) === j.lp.STREAM ? w.stream : null, D = (0, l.bG)([a.A], () => (null == w ? true : w.type) === j.lp.ACTIVITY ? a.A.getApplication(w.applicationId) : true), M = (0, h.A)(N), L = (0, y.A)(N), G = (0, g.A)(_, P, null == R ? true : R.ownerId, null == D ? true : D.id), k = (0, p.A)(N), U = (0, O.A)(), V = (0, c.RQ)(N), F = (0, c.dA)(N), H = (0, A.A)(R, I), B = (0, m.A)(D, N), K = (0, b.A)(), W = (0, s.A)(_), z = (0, f.f)(N);
  return (0, r.jsxs)(i.W1t, {
    ...
    children: [(0, r.jsx)(i.rXV, {
      ...
      children: [T === v.rbe.GUILD_STAGE_VOICE ? V : null, T === v.rbe.GUILD_STAGE_VOICE ? F : null, C || T === v.rbe.GUILD_STAGE_VOICE ? null : k, K, T !== v.rbe.GUILD_STAGE_VOICE ? M : null, T === v.rbe.GUILD_STAGE_VOICE || T === v.rbe.GUILD_VOICE ? L : null]
    }), (0, r.jsx)(i.rXV, {
      children: W
    }), (0, r.jsxs)(i.rXV, {
