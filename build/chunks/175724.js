...
let A = {
  ...
  action(e) {
    ...
    let f = N(i),
      _ = N(c);
    return null == i || f || _ || null == l ? null != i && !f && s.Z.getChatOpen(i) ? r.Z.updateChatOpen(i, false) : S.S.dispatch(T.CkL.SCROLLTO_PRESENT) : u.Z.closeChannelSidebar(i), false
  }
};
...
function N(e) {
  ...
  let t = false;
  return E.Z.getMessages(e).hasMoreAfter && (i.Z.jumpToPresent(e, T.AQB), t = true), b.ZP.hasUnread(e) && ((0, a.In)(e, {
    object: T.qAy.MARK_CHANNEL_AS_READ_KEYBIND,
    objectType: T.Qqv.ACK_MANUAL
  }), t = true), (0, a.iV)(e), t
}