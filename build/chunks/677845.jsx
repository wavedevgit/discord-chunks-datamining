...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk695492 = require("./695492.js"),
  Chunk981631 = require("./981631.js"),
  Chunk600295 = require("./600295.js");
...
function A(e) {
  ...
  let U = (0, s.e7)([b.Z], () => C.isPrivate() || (0, h.b)(b.Z, L, C), [L, C]),
    ...
    H = null != x && x === C.id,
    Y = k.map(e => t => <O.ZP participant={e} channel={C} className={S.tile} onClick={n} onDoubleClick={A} onContextMenu={N} inCall={P} width={t} inPopout={D} />);
  (0, f.Z)({
  ...
  }, []), null != L && !G && (!(M >= 2) || !Z || V || F || H ? B && 1 === M && U && (Z && !V ? Y.push(e => <y.h channel={C} guild={L} width={e} inPopout={D} handleClose={j} userParticipantCount={M} />) : Y.push(e => <I.Z width={e} channel={C} guild={L} inPopout={D} />)) : Y.push(e => <y.h channel={C} guild={L} width={e} inPopout={D} handleClose={j} userParticipantCount={M} />));
  let W = i.useCallback(e => {
    var t, n;
    return null != (n = null == (t = k[e]) ? true : t.id) ? n : "empty-tile"
  }, [k]);
  return <m.Z className={R} keyExtractor={W} paddingTop={64} paddingBottom={64}>{Y}</m.Z>
}