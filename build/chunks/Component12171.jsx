...
function v() {
  let [e, t] = l.useState("US"), [n, c] = l.useState(null), [v, _] = l.useState(null), [y, A] = l.useState("pm_card_us"), [C, S] = l.useState(false), O = Object.values((0, r.bG)([u.A], () => u.A.paymentSources)), T = g[e], E = async () => {
    let t = y;
