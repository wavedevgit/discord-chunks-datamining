...
function A(e) {
  ...
  return 2 === _ ? null : <r.Fragment>{<o.Ji ref={F} sprites={I} colors={k} spriteWidth={8} spriteHeight={8} />}{<y.Z interval={1e3} pointsPerInterval={W.points} isPaused={j || 0 !== _} itemId={x.yN.LAWNMOWER} onPointsInterval={J} />}{<g.Z className={v.lawnmowerClickable} onClick={Q}><p.Z className={v.lawnmower} width={N} minSpeed={50} maxSpeed={75} imageSize={80} isPaused={j || 0 !== _}>{e => (T.current = e, (0, r.jsxs)(r.Fragment, {
        ...
        }))}</p.Z></g.Z>}{<o.O_ className={v.confettiCanvas} environment={M} ref={B} requestAnimationFrame={null != (n = null == H ? true : H.requestAnimationFrame) ? n : requestAnimationFrame} cancelAnimationFrame={null != (O = null == H ? true : H.cancelAnimationFrame) ? O : cancelAnimationFrame} />}</r.Fragment>
}