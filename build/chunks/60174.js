...
class D extends i.Component {
  render() {
    ...
    } = this.state, c = t.state === v.yb.SENDING, p = e === O.O.BURST;
    ...
    !m && p && (g = (0, r.jsx)(_.X, {
      tooltipText: S.intl.string(S.t.Kfcszs)
    }));
    let T = a ? N : A,
      C = {
        size: "sm",
    ...
    return t.type === v.uaV.EMOJI_ADDED && 0 === t.reactions.length ? (0, r.jsx)(f.e, {
      message: t,
  ...
  constructor(...e) {
    ...
    }), C(this, "ref", i.createRef()), C(this, "onAddReaction", (e, t) => {
      if (null == e) return;
      let {
        channel: n,
        message: r,
