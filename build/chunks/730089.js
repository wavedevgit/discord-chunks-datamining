...
let b = (e, t, n, r) => (o.default.track(g.rMx.EMOJI_UPLOAD_FILE_SIZE_LIMIT_EXCEEDED, {
  ...
  p = async e => {
    let {
      ...
      hideErrorModal: v,
      analyticsLocation: O
    } = e, y = c.ZP.sanitizeEmojiName(n.name.split(".")[0]);
    if (c.ZP.isFileTooBig(n)) {
      if ("image/gif" === n.type || "image/webp" === n.type || "image/avif" === n.type) return b(n.name, n.size, p, h);
      else if (null != j) {
        var C, N;
        let e;
        t = (0, r.Ae)(j, 128, 128);
