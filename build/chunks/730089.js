...
let f = (e, t, n, r) => (o.default.track(g.rMx.EMOJI_UPLOAD_FILE_SIZE_LIMIT_EXCEEDED, {
  ...
  h = async e => {
    ...
    try {
      ...
      return null != r && (r.code === g.evJ.TOO_MANY_EMOJI ? (e = m.intl.string(m.t["jP/Rqm"]), n = a.d.TOO_MANY_EMOJI) : r.code === g.evJ.TOO_MANY_ANIMATED_EMOJI ? (e = m.intl.string(m.t["6v5dP/"]), n = a.d.TOO_MANY_ANIMATED_EMOJI) : null != r.image || r.code === g.evJ.INVALID_FILE_ASSET_SIZE ? (o.default.track(g.rMx.EMOJI_UPLOAD_FILE_SIZE_LIMIT_EXCEEDED, {
        guild_id: h,
        file_size: p.byteLength(t),
        upload_id: x
      }), e = m.intl.formatToPlainString(m.t.kIO9jy, {
        maxSize: d.xG
      }), n = a.d.TOO_BIG) : (null != r.image || r.code === g.evJ.INVALID_FILE_ASSET_SIZE_RESIZE_GIF) && (n = a.d.RESIZE_GIF)), 429 === i && (e = m.intl.string(m.t.Whhv4w), n = a.d.RATE_LIMIT), null == e || _ || l.Z.show({
