...
function p(e) {
  let {
    ...
    o.default.track(u.rMx.COLLECTIBLES_SHARE_LINK_BUTTON_CLICKED, {
      sku_id: t
    });
    let e = "".concat(location.protocol, "//").concat(location.host).concat(u.Z5c.COLLECTIBLES_SHOP).concat((0, c.aK)(n) ? "?tab=".concat(n) : "", "#itemSkuId=").concat(t);
