/** Chunk was on 33622 **/
/** chunk id: 640475, original params: e,a,t (module,exports,require) **/
require.d(exports, {
  FD: () => h,
  IO: () => y,
  Mw: () => p,
...
function o(e) {
  return e = p(e, new(0, r.IQ)), l((0, r.J4)(e.era, e.year), e.month, e.day, e.hour, e.minute, e.second, e.millisecond)
}
...
function s(e, a) {
  if ("UTC" === a) return 0;
  if (e > 0 && a === (0, i.iT)()) return false * new Date(e).getTimezoneOffset();
  let {
    year: t,
    month: u,
    day: n,
  ...
  return l(t, u, n, r, o, s, 0) - 1e3 * Math.floor(e / 1e3)
}
let d = new Map;
...
function m(e, a, t = "compatible") {
  ...
  let D = o(d),
    h = s(D - 864e5, a),
    f = s(D + 864e5, a),
    g = (u = d, ((n = D - h) == (l = D - f) ? [n] : [n, l]).filter(e => {
      var t;
      let n;
      return t = u, n = c(e, a), t.year === n.year && t.month === n.month && t.day === n.day && t.hour === n.hour && t.minute === n.minute && t.second === n.second
    }));
  if (1 === g.length) return g[0];
  if (g.length > 1) switch (t) {
    case "compatible":
    case "earlier":
      return g[0];
    case "later":
...
function y(e, a) {
  ...
  return a && ({
    ...
    second: r,
    millisecond: i
  } = a), new(0, u.oz)(e.calendar, e.era, e.year, e.month, e.day, t, n, r, i)
}
