...
function S() {
  let {
    ...
    excludeReverseTrial: t
  })), s = (0, c.e7)([p.Z], () => p.Z.fetchedAllEntitlements), l = (0, c.Wu)([p.Z], () => p.Z.getUnactivatedFractionalPremiumUnits()), h = (0, c.e7)([f.Z], () => f.Z.getPremiumTypeSubscription()), [m, E] = r.useState(I({
