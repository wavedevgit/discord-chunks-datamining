...
function B(e) {
  ...
  } = (0, p.Ay)(), [b, E] = l.useState(false), O = (0, g.C)(t.id), C = (0, o.bG)([I.A], () => I.A.getParentSKU(r.skuId), [r.skuId]), T = l.useMemo(() => null == C ? [] : (0, y.l)(r.id, C, O.subscriptions), [r.id, O, C]), S = 0 !== T.length, v = async () => {
    try {
      E(true);
      let {
        subscription: e
