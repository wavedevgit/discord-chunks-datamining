...
function eo(e, t) {
  ...
  let f = null;
  return null != o.holdoutName && null != o.holdoutControlBucket && o.holdoutName !== t && (null == (f = eo(e, o.holdoutName)) ? true : f.bucket) != null && (true !== f.override && Q({
...
function es(e) {
  ...
  if (!U && H(n) && (U = true), N = t.hasLoadedExperiments, C = t.trackedExposureExperiments, D = t.loadedUserExperiments, M = t.userExperimentOverrides, j = t.guildExperimentOverrides, w = y(E({}, w), {
...
function e_() {
  ...
  for (let e of Chunk392711)
    for (let t in module) {
      ...
      null == require || require.type !== Chunk987338.xY.USER && require.type !== Chunk987338.xY.GUILD || null == require.bucket || true !== require.override || require.fromCookie ? (delete module[exports], o = true) : require.type === Chunk987338.xY.USER ? M[exports] = require : j[exports] = require
    }(o = ef() || Chunk108131) && ep()
}
...
function eg(e) {
  ...
  let {
    ...
    experimentType: i,
    skipCleanup: o
  } = e, a = null != i ? i : null == (t = P[n]) ? true : t.type;
  if (null == a) returnfalse;
  if (null == r ? (M = E({}, M), delete M[n], j = E({}, j), delete j[n]) : "user" === a ? M = y(E({}, M), {
      [n]: {
        type: a,
        revision: 1,
        population: 0,
...
class eb extends Chunk750041.Z {
  ...
  loadCache() {
    ...
    null != module && ("loadedUserExperiments" in module ? (D = module.loadedUserExperiments, L = ea(module.loadedGuildExperiments), Object.values(D).forEach(e => e.loadedFromCache = true), Object.values(L).forEach(e => e.loadedFromCache = true)) : en(module, true))
  }
  takeSnapshot() {
    return {
