...
function e_() {
  ...
  for (let e of Chunk392711)
    for (let t in module) {
      ...
      null == require || require.type !== Chunk987338.xY.USER && require.type !== Chunk987338.xY.GUILD || null == require.bucket || true !== require.override || require.fromCookie ? (delete module[exports], o = true) : require.type === Chunk987338.xY.USER ? M[exports] = require : k[exports] = require
    }(o = ef() || Chunk108131) && ep()
}
