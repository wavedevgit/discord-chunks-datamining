...
function es(e) {
  ...
  if (!U && H(n) && (U = true), C = t.hasLoadedExperiments, N = t.trackedExposureExperiments, D = t.loadedUserExperiments, j = t.userExperimentOverrides, k = t.guildExperimentOverrides, w = y(E({}, w), {
...
function ec(e) {
  ...
  s.K.remove(O), t || (s.K.remove(v), s.K.remove(I), s.K.remove(T), j = {}, k = {}), D = {}, w = y(E({}, w), {
    rawUserExperiments: []
  }), N = {}, C = false
}
...
function ef() {
  let e = false,
    t = __OVERLAY__ ? M : (0, Chunk865427._S)();
...
function e_() {
  ...
  for (let e of Chunk392711)
    for (let t in module) {
      ...
      null == require || require.type !== Chunk987338.xY.USER && require.type !== Chunk987338.xY.GUILD || null == require.bucket || true !== require.override || require.fromCookie ? (delete module[exports], o = true) : require.type === Chunk987338.xY.USER ? j[exports] = require : k[exports] = require
    }(o = ef() || Chunk108131) && ep()
}
...
function eg(e) {
  ...
  if (null == r ? (j = E({}, j), delete j[n], k = E({}, k), delete k[n]) : "user" === a ? j = y(E({}, j), {
      [n]: {
        type: a,
        revision: 1,
        population: 0,
...
class eb extends Chunk750041.Z {
  ...
  getExperimentOverrideDescriptor(e) {
    var t;
    return U ? null != (t = j[e]) ? t : k[e] : null
  }
