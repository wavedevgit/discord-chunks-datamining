...
function R(e) {
  let {
    ...
    showGradient: H,
    textOptions: {
      textOverride: O.ZP.isPremium(t) ? N.intl.string(N.t.KXLX7u) : H ? N.intl.string(N.t.pj0XBA) : N.intl.string(N.t.mr4K7O)
    }
  });
...
function P(e) {
  let {
    ...
    isTryItOutFlow: p,
    guild: h
  } = e, m = (0, a.e7)([b.default], () => b.default.getCurrentUser()), {
