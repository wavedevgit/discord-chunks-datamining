...
function C(e) {
  let {
    ...
    product: x,
    purchase: k
  } = (0, d.Z)(null == D ? void 0 : D.skuId), M = y.ZP.canUseCollectibles(t), j = i.useRef(null), U = (0, f.Z)(l), G = (0, O.sr)(D, void 0 === R ? w : R), B = e => {
    L(e), null != e && U(e)
  }, V = () => {
    P(D), _()
  }, F = i.useCallback(e => {
  ...
  }, [l, _]), Z = (0, p.M)(), H = () => null != k && (!(0, u.qS)(k) || M) || null === D ? (0, r.jsx)(o.zxk, {
    variant: "primary",
