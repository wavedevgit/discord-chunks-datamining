...
let I = e => {
    ...
    let [M, U] = i.useState(false);
    return i.useEffect(() => {
      true === u || l || (x(), D(0)), !l && M && j.current && (x(), D(0)), a && l && !j.current && (L(), E.animationType === s.y.ANIMATION_TYPE_PERSISTENT ? D(d === _.Q.FromStart ? 0 : A) : D(0))
    }, [l, M, A, a, x, L, j, E.animationType, u, d]), (0, r.jsx)("div", {
      ref: I,
