...
let I = e => {
    ...
    return i.useEffect(() => {
      true === u || l || (x(), D(0)), !l && k && M.current && (x(), D(0)), a && l && !M.current && (L(), E.animationType === s.y.ANIMATION_TYPE_PERSISTENT ? D(d === _.Q.FromStart ? 0 : A) : D(0))
    }, [l, k, A, a, x, L, M, E.animationType, u, d]), (0, r.jsx)("div", {
      ref: I,
