...
function j(e) {
  ...
  let O = (0, a.e7)([f.Z, h.default], () => !!o()(f.Z.getMessages(n.id).toArray()).reverse().find(e => e.author.id !== h.default.getId() && e.state === _.yb.SENT && !(0, y.Z)(e))),
    ...
    S = C.NW.formatToPlainString(C.t.m0zYbW, {
      username: N
    }),
