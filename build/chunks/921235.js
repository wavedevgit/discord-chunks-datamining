...
function T(e) {
  ...
  let S = (0, s.e7)([p.Z, _.default], () => !!o()(p.Z.getMessages(n.id).toArray()).reverse().find(e => e.author.id !== _.default.getId() && e.state === b.yb.SENT && !(0, E.Z)(e))),
    ...
    R = y.intl.formatToPlainString(y.t.m0zYbW, {
      username: N
    }),
    P = null != a && "" !== a ? (0, r.jsx)(l.Text, {
      className: O.error,
      color: "text-danger",
