...
function b(e) {
  ...
  return <l.Z borderColor={"green"} text={(0, r.jsx)(d.Z, {
      name: h,
      description: n,
...
function y(e) {
  ...
  return <u.Z className={o()(t, m.shop)} purchasePriority={f.ne} PurchasableComponent={b} itemsShown={4} />
}