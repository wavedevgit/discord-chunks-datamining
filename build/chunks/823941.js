...
let N = 90,
  ...
  P = e => {
    ...
    return g.ZP.canUseCollectibles(o) ? t.summary : S.intl.format(S.t["9hafRk"], {
...
function D(e) {
  let {
    ...
    backgroundColors: a
  } = (0, b.Z)(t.styles), d = (0, l.e7)([u.Z], () => u.Z.useReducedMotion), _ = (0, l.e7)([h.Z], () => h.Z.isFocused()), {
    bannerOverrides: f,
    shopAllBannerStatic: p,
    shopAllBannerAnimated: g
  } = (0, I.t0)(t), T = !!(null == f ? void 0 : f.showDarkBannerText);
  return (0, r.jsxs)(y.Z, {
    asset: p,
    ...
    children: [!d && null != g && _ && (0, r.jsx)(w, {
      src: g
    }), (null == f ? void 0 : f.addAttributionLogo) ? (0, r.jsxs)("div", {
      ...
      size: C
    }), (null == f ? void 0 : f.addLogo) ? (0, r.jsx)("img", {
      ...
      alt: t.name,
      style: {
        maxWidth: null == f ? void 0 : f.logoMaxWidth
      }
    }) : (0, r.jsx)(c.LZC, {
      size: N
    }), (0, r.jsx)(c.Text, {
