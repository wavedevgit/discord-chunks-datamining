...
let _ = e => {
  ...
  let {
    ...
    canAnimate: y
  } = (0, a.j)(E, p), O = (0, i.e7)([s.ZP], () => null != _ && null != n ? s.ZP.getMember(_, n.id) : null), v = (0, i.e7)([l.default], () => {
    var e;
    ...
    isTryItOut: m,
    guildId: _
  }), S = h && void 0 !== T && void 0 !== v && v === (null == n ? void 0 : n.id), A = null != _ && null === T, N = (0, u.Z)(S ? A ? null == n ? void 0 : n.avatarDecoration : null != T ? T : I : null != I ? I : null == n ? void 0 : n.avatarDecoration), C = r.useMemo(() => (0, c.NZ)({
