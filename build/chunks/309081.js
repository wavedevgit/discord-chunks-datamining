...
function D(e) {
  let {
    ...
    toggleEmojiPicker: h
  } = e, j = (0, s.e7)([g.Z], () => g.Z.getChannel(t)), {
    emoji: O,
    isLoadingMedia: x,
    hasUpload: w,
    mediaUrl: k,
    ...
    localCreationAnswerId: n,
    image: o
  }), R = u === i.C.DEFAULT, W = w || null != O, T = a.useCallback(() => {
    f(m)
  }, [f, m]), L = a.useMemo(() => w ? C.NW.formatToPlainString(C.t.vcC7Qk, {
    imageName: (0, y.fw)(D),
    answerNumber: m + 1
  }) : null != O ? C.NW.formatToPlainString(C.t.ncOAhY, {
    emojiName: O.name,
    answerNumber: m + 1
  }) : C.NW.formatToPlainString(C.t.emdpNj, {
    answerNumber: m + 1
  }), [w, O, m, D]), B = a.useCallback(e => {
    let {
      closePopout: t
    } = e;
    return (0, r.jsx)("div", {
...
let W = a.forwardRef(function(e, t) {
  let {
    ...
    inputRef: B,
    deleteButtonRef: Z
  } = e, U = (0, m.Dt)(), M = (0, m.Dt)(), z = null != L && L.length > 0, H = (0, s.e7)([j.Z], () => j.Z.getUpload(o, d.localCreationAnswerId, h.d.Poll)), [F, Y] = a.useState(!1), K = () => {
    function e(e) {
  ...
  return (0, r.jsx)(r.Fragment, {
    children: b === i.C.DEFAULT ? (0, r.jsxs)("div", {
