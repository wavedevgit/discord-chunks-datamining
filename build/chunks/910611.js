...
function w(e) {
  ...
  let d = x.ZP.getApplicationIconURL({
    ...
    [p, h] = o !== s.z.CHANNEL_LINKED_LOBBY_EDUCATION_TOOLTIP ? [T.intl.string(T.t.XJVlf3), void 0] : [(0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(c.Text, {
        ...
        children: T.intl.format(T.t["16agur"], {
          helpdeskArticle: v.Z.getArticleURL(Z.BhN.LINKED_LOBBIES)
        })
      }), (0, r.jsx)(c.P3F, {
  ...
  return (0, r.jsx)(c.ua7, {
    ...
    children: e => {
      ...
      return (0, r.jsxs)("div", (t = function(e) {
        ...
        className: A.linkedLobbyTooltip
      }, e), n = n = {
...
function R(e) {
  let {
    ...
    switch (e) {
      case Z.d4z.DM:
        return {
          prefix: T.intl.string(T.t.EJRzg4), level: 1
        };
      case Z.d4z.GROUP_DM:
        return {
          prefix: T.intl.string(T.t["e5y+go"]), level: 1
        };
      ...
      case Z.d4z.PRIVATE_THREAD:
        return {
          prefix: T.intl.string(T.t["7Xm5QE"]), level: 2
        };
      default:
        return {
          prefix: null, level: 1
  ...
  switch (t.type) {
    ...
    case Z.d4z.GROUP_DM:
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(c.nn4, {
          children: T.intl.string(T.t["e5y+go"])
        }), (0, r.jsx)(E.Z, {
          channel: t,
    ...
    case Z.d4z.GUILD_FORUM:
    case Z.d4z.GUILD_MEDIA:
      return null != t.linkedLobby ? (0, r.jsxs)(w, {
        channel: t,
        children: [D(b, t.type === Z.d4z.GUILD_ANNOUNCEMENT ? T.intl.string(T.t.l1dkSE) : T.intl.string(T.t.Pnajj4)), (0, r.jsx)(S.Z.Title, {
          level: x,
          onContextMenu: d,
          onClick: u,
          children: v
    ...
    case Z.d4z.GUILD_VOICE:
      return (0, r.jsxs)(i.Fragment, {
        children: [D(b, T.intl.string(T.t.BVZqJi)), (0, r.jsx)(S.Z.Title, {
          level: x,
          onContextMenu: d,
          onClick: u,
          children: v
    ...
    case Z.d4z.GUILD_STAGE_VOICE:
      return (0, r.jsxs)(i.Fragment, {
        children: [D(b, T.intl.string(T.t.EErMzM)), (0, r.jsx)(S.Z.Title, {
          level: x,
          onContextMenu: d,
          onClick: u,
          children: v
    ...
    case Z.d4z.PRIVATE_THREAD:
      ...
      if (!s && null != l) {
        ...
        j = (0, r.jsxs)(i.Fragment, {
          children: [D(e, T.intl.string(T.t.Pnajj4)), (0, r.jsx)(S.Z.Title, {
            level: x,
            onContextMenu: m,
            onClick: f,
      ...
      return (0, r.jsxs)(i.Fragment, {
        children: [j, D(O ? null : b, T.intl.string(T.t["7Xm5QE"])), (0, r.jsx)(S.Z.Title, {
          level: x,
          onContextMenu: d,
          onClick: u,
          className: o()({
    ...
    case Z.d4z.GUILD_DIRECTORY:
      let I = (null == a ? void 0 : a.hasFeature(Z.oNc.HUB)) ? T.intl.formatToPlainString(T.t.Dy2aho, {
        guildName: n
      }) : n;
      return (0, r.jsxs)(i.Fragment, {
        children: [null !== b ? (0, r.jsx)(S.Z.Icon, {
          iconClassName: A.__invalid_icon,
          icon: b,
          "aria-hidden": !0
        }) : null, (0, r.jsxs)(S.Z.Title, {
          level: x,
          onContextMenu: d,
          onClick: u,
          children: [null != y ? (0, r.jsxs)(c.nn4, {
...
let k = e => {
  let {
    channel: t
  } = e, n = (0, a.e7)([C.default], () => C.default.getCurrentUser()), i = (0, a.e7)([C.default], () => C.default.getUser(t.getRecipientId())), l = (0, j.G)();
  return t.isDM() && (null == n ? void 0 : n.isStaff()) && null != i ? i.isStaff() ? (0, r.jsx)(d.Z, {
...
function D(e, t) {
  return (0, r.jsxs)(r.Fragment, {
    children: [null !== e && (0, r.jsx)(S.Z.Icon, {
      iconClassName: A.__invalid_icon,
      icon: e,
      "aria-hidden": !0
    }), (0, r.jsx)(c.nn4, {
...
function L(e) {
  ...
  } = e, l = (0, a.e7)([y.Z], () => y.Z.getGuildId()), s = (0, g.D)();
  return (l === Z.I_8 || s) && null != t ? (0, r.jsxs)("div", {
    className: A.guildBreadcrumbContainer,
    children: ["left" === i && (0, r.jsx)(S.Z.Caret, {
      direction: "left"
    }), (0, r.jsx)(m.Z, {
      guild: t,
