...
function B(e) {
  ...
  let {
    channel: n,
    children: i
  } = e, o = (0, u.q)(null == (t = n.linkedLobby) ? void 0 : t.application_id), [a, s] = (0, p.US)([l.z.CHANNEL_LINKED_LOBBY_EDUCATION_TOOLTIP], void 0, !0);
  ...
  let d = I.ZP.getApplicationIconURL({
    ...
    [f, _] = function() {
      return a !== l.z.CHANNEL_LINKED_LOBBY_EDUCATION_TOOLTIP ? [L.intl.string(L.t.XJVlf3), void 0] : [(0, r.jsxs)("div", {
...
function Z(e) {
  ...
  switch (t.type) {
    ...
    case w.d4z.GUILD_DIRECTORY:
      let S = (null == s ? void 0 : s.features.has(w.oNc.HUB)) ? L.intl.formatToPlainString(L.t.Dy2aho, {
        guildName: n
      }) : n;
      return (0, r.jsxs)(i.Fragment, {
...
let V = e => {
  ...
  let {
    channel: n
  } = e, o = (0, s.e7)([v.default], () => v.default.getCurrentUser()), a = (0, s.e7)([v.default], () => v.default.getUser(n.getRecipientId())), l = (0, S.G)(), c = (0, s.e7)([E.Z], () => null != a ? E.Z.getUserProfile(a.id) : null), u = null != c && (null != (t = null == c ? void 0 : c.fetchEndedAt) ? t : 0) > 0;
  return (i.useEffect(() => {
    (null == o ? void 0 : o.isStaff()) && null != a && !a.isStaff() && (0, b.Z)(a.id, a.getAvatarURL(void 0, 80), {
      dispatchWait: !0,
      withMutualGuilds: !0,
      withMutualFriendsCount: !0
    })
  }, [o, a]), n.isDM() && (null == o ? void 0 : o.isStaff()) && null != a) ? a.isStaff() ? (0, r.jsx)(d.Z, {
