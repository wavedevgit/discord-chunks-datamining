...
class O extends Chunk73800.Component {
  render() {
    ...
    return null != module.linkedLobby || exports ? <Chunk73800.Fragment>{<Chunk984370.Z.Divider />}{<div className={a()(Chunk916560.topic, Chunk916560.expandable, Chunk73433.markup)} onMouseDown={this.onMouseDown} onMouseMove={this.onMouseMove} onMouseUp={this.onMouseUp} onContextMenu={this.handleContextMenu} onClick={this.handleClick}>{<Chunk481060.P3F onClick={this.handleClick} aria-label={Chunk388032.intl.string(Chunk388032.t.mKwsSk)} className={Chunk916560.topicClickTarget} />}{null == module.linkedLobby || exports ? Chunk454585.Z.parseTopic(module.topic, true, {
          channelId: module.id
        }) : Chunk388032.intl.string(Chunk388032.t.XJVlf3)}</div>}</Chunk73800.Fragment> : null
  }
  constructor(...e) {
