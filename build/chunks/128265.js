...
class b {
  ...
  loadComplete(e) {
    ...
    return R.mutate({
      ...
      jumpSequenceId: null == A || T ? R.jumpSequenceId : R.jumpSequenceId + 1,
      jumpReturnTargetId: null != (y = null == A ? true : A.returnMessageId) ? y : null,
      hasMoreBefore: null == A && v ? R.hasMoreBefore : I,
      hasMoreAfter: null == A && O ? R.hasMoreAfter : S,
      cached: C,
