...
function _(e) {
  let {
    ...
    invite: n,
    isHoveringInvite: l
  } = e, o = (0, a.e7)([d.Z], () => d.Z.isInviteGameInstalled(n)), c = (0, a.e7)([d.Z], () => d.Z.isInviteJoinable(n)), [p, f] = i.useState(!1), b = i.useCallback(async () => {
    f(!0);
    try {
      await (0, h.MH)(n)
    } catch (e) {}
