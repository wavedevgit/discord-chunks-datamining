...
function _(e) {
  ...
  }), s = (0, g.vc)(o()(t.created_at), "LT"), d = i.useRef(null), h = (0, u.Z)(d);
  return i.useEffect(() => {
    n || (0, p.Br)(t)
  }, [t, n]), (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)("img", {
        ...
        children: m.intl.format(m.t.vtUO3d, {
          username: l
        })
      }), (0, r.jsxs)("div", {
...
function O(e) {
  let {
    ...
    invite: n,
    isHoveringInvite: l
  } = e, o = (0, a.e7)([h.Z], () => h.Z.isInviteGameInstalled(n)), u = (0, a.e7)([h.Z], () => h.Z.isInviteJoinable(n)), [f, g] = i.useState(!1), _ = i.useCallback(async () => {
    g(!0);
    try {
      await (0, p.MH)(n)
    } catch (e) {}
  ...
  return o && u ? (0, r.jsx)(s.zx, {
    ...
    text: m.intl.formatToPlainString(m.t.issFLC, {
