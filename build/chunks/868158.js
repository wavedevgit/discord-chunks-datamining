...
function R(e, t) {
  ...
  return null != c && l.push(c), P = {}, I(O({}, a), {
    presences: s,
    guilds: l
  })
}
...
function D(e, t, n) {
  ...
  let _ = null != (r = null == u ? void 0 : u.map((e, t) => !0 === e.unavailable ? e : (e.members = k(P, null == c ? void 0 : c[t]), U(e)))) ? r : [],
    p = L(t, u, e => U(e));
  return null != p && _.push(p), I(O({}, d), {
    users: o,
    presences: [],
    relationships: f,
    guilds: _,
