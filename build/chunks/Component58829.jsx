/** Chunk was on 95198 **/
/** chunk id: 58829, original params: l,e,n (module,exports,require) **/
require.d(exports, {
  default: () => x
}), require("./228524.js");
...
function f(l) {
  let {
    onComplete: e,
    excludedPlatformTypes: n,
    includedPlatformTypes: i
  } = l, a = (0, o.gn)();
  return (0, t.jsx)("div", {
    className: p.lA,
    children: a.filter(l => !(null == n ? true : n.has(l.type)) && (null == i || i.has(l.type))).map(l => (0, t.jsx)(d.A, {
      type: l.type,
      className: p.W2,
      innerClassName: p.Uz,
      onConnect: () => e(l.type)
...
function m(l) {
  let {
    integrations: e,
    onCompleteApplication: n
  } = l;
  if (null == e || null == n) return null;
  let i = e.filter(l => {
    var e;
    return (null == (e = l.application) ? true : e.roleConnectionsVerificationUrl) != null
  });
  return 0 === i.length ? null : (0, t.jsxs)(t.Fragment, {
    children: [(0, t.jsx)(c.Text, {
      ...
      children: i.map(l => {
        ...
        return a()(null != i, "bot is null"), (0, t.jsxs)(c.DUT, {
          onClick: () => n(e.id),
          className: p.pW,
...
function x(l) {
  ...
  return (0, t.jsxs)(s.Modal, {
    ...
    children: [(0, t.jsx)(f, {
      ...
      integrations: r,
      onCompleteApplication: null != d ? function(l) {
        null == d || d(l), i()
      } : true
    })]
  })
