...
function _(e) {
  ...
  let {
    ...
    defaultOpen: h
  } = e, [x, _] = r.useState(h), [j, E] = r.useState(!1), O = r.useCallback(() => {
    _(e => !e)
  }, []), C = (0, l.e7)([m.Z], () => m.Z.getUserExperimentDescriptor(s)), v = (0, l.e7)([m.Z], () => m.Z.getLoadedUserExperiment(s)), S = (0, l.Wu)([m.Z], () => a().sortBy(m.Z.getRecentExposures(f.xY.USER, s), e => {
    let [t, n] = e;
    return -n
  }).map(e => {
    let [t, n] = e;
    ...
    children: (0, i.jsxs)(c.vwX, {
      ...
      children: [(0, i.jsxs)("div", {
        children: [(0, i.jsxs)(c.Kqy, {
          ...
          align: "center",
          gap: 4,
          children: [n.title, " ", g.wS && (0, i.jsx)(c.P3F, {
            onClick: T,
...
function j(e) {
  ...
  } = e, [d, g] = r.useState(null != s), [h, x] = r.useState(!1), _ = r.useCallback(() => {
    g(e => !e)
  }, []), j = (0, l.e7)([m.Z], () => m.Z.getLoadedGuildExperiment(n)), E = (0, l.Wu)([m.Z], () => a().sortBy(m.Z.getRecentExposures(f.xY.GUILD, n), e => {
    let [t, n] = e;
    return -n
  }).map(e => {
    let [t, n] = e;
  ...
  return d ? (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsxs)(c.hjN, {
      children: [v, (0, i.jsxs)("div", {
        ...
        }), "string" == typeof t.description ? (0, i.jsx)("div", {
          className: b.description,
          children: (0, i.jsx)(c.R94, {
            type: c.geA.DESCRIPTION,
