...
function E(e, t) {
  ...
  if (e !== _.YYv) return g.A.getChannel(t);
  let l = m.Ay.getChannels(e),
    i = null != (n = null != (r = l[m.I6].find(e => e.channel.id === t)) ? r : l[m.vM].find(e => e.channel.id === t)) ? n : l[_.rbe.GUILD_CATEGORY].find(e => e.channel.id === t);
...
function C(e) {
  return (0, l.T)(v, {
    drop(e, t) {
      ...
      if (0 !== m.length) {
        if (l === _.YYv) return void(0, u.S_)(m);
        if (m = m.filter(e => {
            let {
              id: t
            ...
            return n.type === _.rbe.GUILD_CATEGORY || null == r ? A.A.can(_.xBc.MANAGE_CHANNELS, h) : A.A.can(_.xBc.MANAGE_CHANNELS, r)
          }), d.parent_id !== o.parentId && m.find(e => {
            if (e.id !== d.id) returnfalse;
            let t = g.A.getChannel(e.parent_id);
            if (!(null != t && A.A.can(_.xBc.MANAGE_ROLES, d) && A.A.can(_.xBc.MANAGE_ROLES, t))) returntrue;
            let r = j.r(d, t),
    ...
    canDrop(e, t) {
      ...
      if (y.A.getGuildId() === _.YYv) returntrue;
      let i = b.A.getGuild(n.guildId);
      if (null == i) returnfalse;
      let s = g.A.getChannel(l.parentId),
        a = g.A.getChannel(r.parent_id),
        o = A.A.can(_.xBc.MANAGE_CHANNELS, i),
        c = null != a ? A.A.can(_.xBc.MANAGE_CHANNELS, a) : o,
        u = null != s ? A.A.can(_.xBc.MANAGE_CHANNELS, s) : o;
      return c && u
    }
  }, (e, t) => {
    let n = t.getItem();
    ...
    canDrag(e) {
      ...
      if (null == l) returnfalse;
      if ((0, p.WW)(l.id) && A.A.can(_.xBc.MANAGE_CHANNELS, l)) return (0, d.A)() && (0, s.mMO)(async () => {
        let {
          default: e
        } = await n.e("2467").then(n.bind(n, 354643));
        return t => (0, r.jsx)(e, x({}, t))
      }), false;
      if (t.type === _.rbe.GUILD_CATEGORY) return A.A.can(_.xBc.MANAGE_CHANNELS, l) && !(0, p.WW)(l.id);
      let i = g.A.getChannel(t.parent_id);
      return null != i && A.A.can(_.xBc.MANAGE_CHANNELS, i) || null == i && A.A.can(_.xBc.MANAGE_CHANNELS, l)
    },
    beginDrag(e) {
      let {
        channel: {
      ...
      return {
        ...
        channelList: (0, o.A)(a._categories, a, e => {
          ...
          return t.type === _.rbe.GUILD_CATEGORY && null != a[t.id] && 0 === a[t.id].length ? s === _.YYv || A.A.can(_.xBc.MANAGE_CHANNELS, t) && A.A.can(_.xBc.VIEW_CHANNEL, t) : !h.A.isCollapsed(t.parent_id)
        }),
        guildId: r
      }
    }
