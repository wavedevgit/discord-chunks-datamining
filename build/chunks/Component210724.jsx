...
function B(e) {
  ...
  let {
    ...
    quest: i,
    location: D.dr.QUESTS_BAR
  }), H = (0, c.e7)([m.Z], () => m.Z.useReducedMotion), W = (0, c.e7)([x.Z], () => x.Z.hasLayers()), z = r.useRef(null), q = r.useMemo(() => (0, C.q8)(i), [i]), K = (null == (t = i.userStatus) ? true : t.enrolledAt) != null, Y = (0, u.Z)(K), Q = (null == (n = i.userStatus) ? true : n.completedAt) != null, {
    hasError: X,
    isLoading: J
    ...
    er(false), en.current || Q || eg(false)
  }, [Q, eg]), e_ = r.useCallback(() => {
    er(false), Q || eg(false), en.current = false
  }, [Q, eg]), ey = r.useCallback(() => {
    el(true)
  }, []), eC = r.useCallback(() => {
    el(false), eg(false)
  }, [eg]), eS = r.useCallback(function() {
  ...
  }, [eb, es]), eE = r.useCallback(() => {
    eS()
  }, [eS]), eO = r.useCallback(() => {
    window.clearTimeout(et.current), ea || ei || en.current || eg(false)
  }, [ea, ei, eg]), eT = r.useCallback(() => {
    var e;
    (0, f.dA)({
      questId: i.id,
  ...
  r.useEffect(() => {
    ...
    K && !Y && en.current && eb()
  }, [eb, K, Y]), r.useLayoutEffect(() => {
    Q || !K || Y || en.current || eg(false)
  }, [K, Q, Y, eg]), r.useLayoutEffect(() => {
