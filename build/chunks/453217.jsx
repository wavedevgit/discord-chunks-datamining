...
let h = function(e) {
  ...
  return <a.animated.div aria-hidden={h && j} className={o()(n, x.contentCollapsed, {
    ...
    }}>{<m.Z quest={_} useReducedMotion={b} />}{<div className={x.contentCollapsedWrapper}>{v ? (0, r.jsxs)("div", {
