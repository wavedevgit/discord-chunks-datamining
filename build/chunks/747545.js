        ...
        children: [(0, r.jsx)(u.q4e, {
          ...
          children: O.NW.format(O.t.aJYgRk, {
            onCameraSettingsClick: () => {
              null == A || A(), window.open((0, E.getPlatform)() === E.PlatformTypes.WINDOWS ? "ms-settings:camera" + (null != R ? "?cameraId=".concat(encodeURIComponent(R.replace(v, "{E5323777-F976-4f5b-9B55-B94699C46E44}"))) : "") : ""), x.default.track(j.rMx.SYSTEM_CAMERA_SETTINGS_OPENED, {
                location_stack: P
              })
            }
          })
