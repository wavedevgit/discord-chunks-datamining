...
let R = e => {
  ...
  D = e => {
    ...
    return <d.Gt value={S}><div ref={W}>{<n.O_ ref={G} className={y.confettiCanvas} environment={V} />}{<a.I graphic={{
            type: "dynamic",
          ...
          }} title={z} subtitle={null != J ? J : true} onClose={r} transitionState={t} actions={Q} />}{null != X ? <O.i options={X} /> : <x.Z confettiTarget={W.current} confettiCanvas={$} sprites={(0, I.vK)(m.categorySkuId)} />}</div></d.Gt>
  }