...
let W = 16 / 9,
  ...
  B = e => {
    let {
      ...
      if (e.type === k.fO.STREAM && 0 === j.filter(t => (0, C.V9)(t) === e.id && t.state !== R.jm8.ENDED).length) {
        if (!(0, x.p9)(l, Z.Z, P.Z, S.Z, _.Z)[0]) return;
        (0, p.rn)((0, C.my)(e.id), {
  ...
  G = i.memo(function(e) {
    ...
    } = (0, m.ZP)(f.Z.STAGE_TILE), p = (0, h.bp)(), _ = l.getGuildId(), C = I.default.getId(), {
    ...
    return O.type !== k.fO.USER || (null == (t = O.voiceState) ? void 0 : t.selfVideo) ? (0, r.jsx)(B, {
      stageParticipant: i,
      rtcParticipant: O,
      channel: l,
      guildId: _,
