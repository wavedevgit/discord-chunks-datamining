...
let U = 16 / 9,
  ...
  G = e => {
    let {
      ...
      if (e.type === k.fO.STREAM && 0 === j.filter(t => (0, x.V9)(t) === e.id && t.state !== R.jm8.ENDED).length) {
        if (!(0, C.p9)(l, N.Z, P.Z, Z.Z, y.Z)[0]) return;
        (0, p.rn)((0, x.my)(e.id), {
  ...
  F = i.memo(function(e) {
    ...
    } = (0, m.ZP)(f.Z.STAGE_TILE), p = (0, h.bp)(), y = l.getGuildId(), x = S.default.getId(), {
    ...
    let P = e => {
      ...
      Z = (e, t, i, o) => {
        switch (e.type) {
          ...
          case k.fO.USER:
          default:
            if (P(k.TH.USER), C && i) return (0, j.D)(t, v, l, {
              context: p
            }, (e, t) => (0, _.o)({
              menuName: e,
              menuItemProps: t,
    ...
    return O.type !== k.fO.USER || (null == (t = O.voiceState) ? void 0 : t.selfVideo) ? (0, r.jsx)(G, {
      stageParticipant: i,
      rtcParticipant: O,
      channel: l,
      guildId: y,
