...
let D = 16 / 9,
  ...
  B = e => {
    let {
      ...
      if (e.type === R.fO.STREAM && 0 === j.filter(t => (0, x.V9)(t) === e.id && t.state !== w.jm8.ENDED).length) {
        if (!(0, y.p9)(l, Z.Z, P.Z, S.Z, C.Z)[0]) return;
        (0, p.rn)((0, x.my)(e.id), {
  ...
  G = i.memo(function(e) {
    ...
    } = (0, m.ZP)(f.Z.STAGE_TILE), p = (0, h.bp)(), C = l.getGuildId(), x = I.default.getId();
    a()(null != C, "Channel cannot be guildless");
    let {
      user: y
    } = i, v = (0, s.e7)([b.Z], () => b.Z.getParticipant(l.id, i.id), [l.id, i.id]), O = (0, s.e7)([N.ZP], () => N.ZP.isModerator(y.id, l.id), [l.id, y.id]);
    ...
    let E = e => {
      ...
      P = (e, t, i, a) => {
        switch (e.type) {
          ...
          case R.fO.USER:
          default:
            if (E(R.TH.USER), i) return (0, j.D)(t, y, l, {
              context: p
            }, (e, t) => (0, _.o)({
              menuName: e,
              menuItemProps: t,
    ...
    return v.type !== R.fO.USER || (null == (t = v.voiceState) ? void 0 : t.selfVideo) ? (0, r.jsx)(B, {
      stageParticipant: i,
      rtcParticipant: v,
      channel: l,
      guildId: C,
