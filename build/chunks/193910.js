...
function k() {
  ...
  let [n] = (0, p.cv)(t);
  return i.useEffect(() => () => {
    n === s.z.ACTIVITIES_CHAT_MENU_NEW_BADGE && (0, _.Q3)(s.z.ACTIVITIES_CHAT_MENU_NEW_BADGE, {
...
function j(e) {
  ...
  function q() {
    ...
    null != i && (r = i[1], n = i[2], e = i[3], r += i[4]), (0, v.d)([(0, O.dp)(new Blob([e], {
      type: "text/plain"
    }), "message.".concat(n), "text/plain")], t, R), y.S.dispatchToLastSubscribed(S.CkL.CLEAR_TEXT), "" !== r && y.S.dispatchToLastSubscribed(S.CkL.INSERT_TEXT, {
      plainText: r
    })
  }
  ...
  function $(e) {
    ...
    let i = (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(e.icon, {
        ...
        children: e.display
      }), null != e.badgeVal && e.badgeVal > 0 && (0, r.jsx)(l.mAB, {
        className: w.badge,
