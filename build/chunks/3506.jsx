...
function R(e) {
  ...
  return <c.xJW title={n} className={y.userSettingsOverlayField}>{t}</c.xJW>
}
...
function D(e) {
  ...
  return l().isEqual(U, A) || (S.default.track(I.rMx.OVERLAY_SETTINGS_UPDATED, U), A = U), <i.Fragment>{<c.hjN className={t} tag={c.RB0.H1} title={n ? N.intl.string(N.t["9cb1U1"]) : null}>{false}{<div className={y.enableOverlaySection}>{<c.xJW title={N.intl.string(N.t.XkaTrq)} className={y.enableOverlayItem}><c.j7V className={y.enableSwitch} value={a} disabled={B} note={B ? N.intl.string(N.t.Eb0lnJ) : null} hideBorder={true} onChange={function(e) {
              var t, n;
              u.Z.setEnabled(e, r);
              let i = null != (n = null == (t = g.ZP.getCurrentGameForAnalytics()) ? true : t.id) ? n : null;
              (0, f.ou)(e, f.AE.LEGACY, i), !e && a && (0, E.l)(f.AE.LEGACY, i)
            }}>{N.intl.string(N.t.vSP6c3)}</c.j7V></c.xJW>}{<c.xJW title={N.intl.string(N.t.VsAZcH)} className={y.enableOverlayItem}><m.Z disabled={!a} defaultValue={null != L ? L.shortcut : []} onChange={function(e) {
              var t, n;
            ...
            }} /></c.xJW>}</div>}{<R title={N.intl.string(N.t.dnvZSk)}><c.FXm options={[{
          ...
          }} value={O} /></R>}{<R title={N.intl.string(N.t.J0dpcH)}><c.FXm options={[{
          ...
          }} value={T} /></R>}{<R title={N.intl.string(N.t.swsWWF)}><c.FXm options={[{
            name: N.intl.string(N.t.nBmDra),
            value: I.OYC.ALWAYS
          }, {
            name: N.intl.string(N.t["2OvIZW"]),
          ...
          }} value={D} /></R>}{M && <R><c.j7V value={k} onChange={e => u.Z.setShowKeybindIndicators(e)} hideBorder={true}>{N.intl.string(N.t.XZTl9v)}</c.j7V></R>}</c.hjN>}{<c.hjN tag={c.RB0.H1} title={N.intl.string(N.t["3GMnLi"])} className={y.notificationSection}>{<R title={N.intl.string(N.t.IQv8Eh)}><div className={y.notificationSettings}><h.Z position={w} onChange={(e, t) => u.Z.setNotificationPositionMode(t)} /></div></R>}{<R><c.j7V value={w !== I._vf.DISABLED && !Z} disabled={w === I._vf.DISABLED} onChange={function() {
          ...
          }} hideBorder={true}>{N.intl.string(N.t.Fy5kPj)}</c.j7V></R>}</c.hjN>}</i.Fragment>
}