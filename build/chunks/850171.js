/** Chunk was on web.js **/
/** chunk id: 850171, original params: e,t,n (module,exports,re quire) **/
"use strict";
let r, i, a, o;
require.d(exports, {
  A: () => f,
...
let d = 360,
  ...
  g = [Object.freeze(Object.defineProperty({
    ...
    disable: () => {
      let e = h();
      module && (module.ul_wasVisible = !!document.querySelector("iframe.intercom-launcher-frame"), module.ul_wasVisible && module("update", {
        hide_default_launcher: true
      }))
    },
    enable: () => {
      let e = h();
      module && (module.ul_wasVisible && module("update", {
        hide_default_launcher: false
      }), delete module.ul_wasVisible)
    }
  }, Symbol.toStringTag, {
    value: "Module"
  }))];
...
async function S(e, t) {
  ...
  if (l.ok) {
    let e = null == (n = l.headers) ? true : n.get("Authorization"),
      t = e ? e.split(" ") : true,
      i = t && 2 === t.length ? t[1] : true,
      a = null == (r = l.headers) ? true : r.get("x-ul-visitor-id");
    ...
    i && a && (a !== window.UserLeap.visitorId || window.UserLeap.token !== i) && (I("token", i), I("vid", a), s.e.emit(s.S.VisitorIDUpdated, {
      visitorId: a
...
let C = async (e, t, r) => {
  ...
  let {
    ...
    sessionReplay: I,
    studyType: T
  } = e, A = (0, s.g)(window.UserLeap), C = P(A), R = N(A);
  if (I)
    if (C) s.e.emit(s.S.ReplayCapture, {
      ...
      if (!s.m.replay) return window.UserLeap.reportError("displayQuestions", Error("Replay module not registered")), {
        success: false,
    ...
    await s.m.replay.initializeReplay({
      ...
      var r;
      return null == (r = s.m.replay) ? true : r.scheduleCapture({
        apiUrl: window.UserLeap._API_URL,
        completeUploadHeaders: A,
        eventId: e,
        isHeatmap: true,
  ...
  if (null == S || !(null != g && g.length)) return s.b.info("CannotDisplaySurvey", {
    vid: S
  }), {
    success: false,
  ...
  if (S !== window.UserLeap.visitorId && v !== window.UserLeap.visitorId && !window.previewMode) {
    ...
    return window.UserLeap.reportError("DisplaySurvey", Error(e)), {
      success: false,
      message: e,
      surveyState: "no survey"
    }
  }
  s.b.info("ShowingSurvey", {
    surveyId: O
  }), null == (i = s.m.replay) || i.RecordSurveyShown({
    id: O,
    userAgent: window.navigator.userAgent
  }), E.disable(), s.e.emit(s.S.SurveyWillPresent, {
  ...
  s.e.on("verify.view.version", Z), window.UserLeap.useMobileStyling = R, (0, s.h)(A) ? (w = "ul-direct-embeded-frame", j = document.head, k = window, U = false, (() => {
    let e = (0, s.g)(window.UserLeap),
      t = P(e),
      n = window.UserLeap.forceDirectEmbed,
      r = "web" === e["userleap-platform"];
    return t || n && r
  })() && (D(O, f), G.id = w, window.UserLeap.container.appendChild(G), L(), s.e.emit(s.S.SurveyLifeCycle, {
    state: "presented"
  ...
  let B = {
    ...
    previewMode: m,
    productConfig: {
      framePosition: null == h ? true : h.framePosition,
      desktopDisplay: null == h ? true : h.desktopDisplay,
      placement: null == h ? true : h.placement
    },
    responseGroupUid: y,
  ...
  }), B.customStyles = (f ? window.UserLeap.feedbackCustomStyles : window.UserLeap.customStyles) ?? h.customStyles, k && (k.__cfg = B);
...
function N(e) {
  var t;
  if (true !== window.UserLeap.useMobileStyling) return window.UserLeap.useMobileStyling;
  let n = (null == (t = window.UserLeap.windowDimensions) ? true : t.width) ?? document.body.clientWidth;
...
let w = "0px",
  ...
  x = (e, t) => {
    ...
    if (r) try {
      null == (n = r.parentNode) || n.removeChild(r), window.UserLeap.container = null, I("trackStartUrl", null), s.e.emit(s.S.SurveyLifeCycle, {
        state: "dismissed"
  ...
  j = (e, t, n, r) => {
    ...
    let d = false;
    if (n) null != (i = window.UserLeap.windowDimensions) && i.width ? s.width = `${window.UserLeap.windowDimensions.width}px` : s.width = "100%", null != (a = window.UserLeap.windowDimensions) && a.height ? s.maxHeight = window.UserLeap.windowDimensions.height - 20 + "px" : window.UserLeap.maxHeight ? s.maxHeight = window.UserLeap.maxHeight : s.maxHeight = document.body.clientHeight - 20 + "px", ["light", "dark"].includes(l.overlayStyleMobile) && (d = true);
    else {
  ...
  M = ({
    ...
    let f = false;
    c.setWidth = e => {
      parseInt(c.style.width) == e && f || (f = true, c.style.width = `${e}px`, s.e.emit(s.S.SurveyWidth, {
        name: s.S.SurveyWidth,
        contentFrameWidth: e,
        "survey.id": n
      }))
    }, null == (i = window.UserLeap.container) || i.appendChild(c), e && (t ? e.exitOnOverlayClickMobile : e.exitOnOverlayClick) && window.UserLeap.container && (window.UserLeap.container.onclick = () => {
      s.e.emit(s.S.CloseSurveyOnOverlayClick)
    }), s.e.emit(s.S.SurveyLifeCycle, {
      state: "presented"
    }), s.e.emit(s.S.SurveyPresented, {
      name: s.S.SurveyPresented,
      "survey.id": n
    });
    let p = null == (a = c.contentWindow) ? true : a.document;
    if (p && (p.open("text/html", "replace"), p.write("<!doctype html><head></head><body></body></html>"), p.close(), !t)) {
      let e = p.body;
      e.style.display = "flex", e.style.alignItems = "center"
    }
    return {
      frameId: o,
      contentWinDocHead: null == p ? true : p.head,
  ...
  Y = (e, t, n) => {
    ...
    if (Z(r) && Z(i)) {
      let l = r.querySelector(".ul-card--matrix_grid"),
        c = !l && t && n;
      try {
        c && (i.style.width = "360px"), a = r.clientHeight + (e => {
          let t = e.querySelector(".sprig-question-body"),
            ...
            o = 0;
          return Z(n) && (o += n.scrollHeight - n.clientHeight), Z(r) && (o += r.scrollHeight - r.clientHeight), Z(t) && (o += t.scrollHeight - t.clientHeight), Z(i) && Z(a) && 0 === a.clientHeight && (o += i.clientHeight), o
        })(e);
        let t = getComputedStyle(r);
        s = a;
        let n = parseFloat(t.marginTop) + parseFloat(t.marginBottom);
        a += n + (parseFloat(t.borderTopWidth) + parseFloat(t.borderBottomWidth)), l && (o = l.scrollWidth + H(".ul-card__container", e) + H(".sprig-question-body", e))
      } finally {
  ...
  ei = () => {
    ...
    return (null == (e = null == exports ? true : exports.parentElement) ? true : module.id) === "sprig-feedback-loading-container"
  },
  ea = () => document.getElementById("sprig-feedback-error-container"),
  eo = () => {
    if (!J) return 0;
    let e = null == J ? true : J.clientWidth,
      t = window.getComputedStyle(J);
    return module + parseInt(exports.borderRightWidth || "0") + parseInt(exports.borderLeftWidth || "0")
  },
  es = e => {
    let t = z();
    t && (null != en && en.endsWith("right") ? t.style.right = `${e}px` : null != en && en.endsWith("left") && (t.style.left = `${e}px`))
  },
  el = () => !!(J && (ei() || ea())) && (Chunk555256.e.off(Chunk555256.S.SurveyAppeared, ec), eu(), es(-eo()), true),
  ec = () => {
    if (!J || !$) return;
    let e = q();
    module && module.remove(), J.style.height = "auto", J.style.width = "auto", $.disabled = false, ee = false
  },
  eu = () => {
    if (J && !q()) {
      let e = (() => {
        ...
        return module.className = "ul-loading-spinner-container", module.id = "sprig-feedback-loading-animation", module.role = "progressbar", module.setAttribute("aria-live", "polite"), module.setAttribute("aria-busy", "true"), module.setAttribute("aria-label", "Processing..."), module.innerHTML = `
  ...
  `, module
      ...
      module && (J.style.height = "300px", J.style.width = "360px", J.appendChild(module))
    }
  },
  ed = () => {
    J && $ && (es(0), $.disabled = true, ee = true)
  },
  ef = async (e, t, n) => {
    let {
      buttonTheme: r,
    ...
    window.UserLeap.feedbackCustomStyles = true;
    let f = z();
    if (f) {
      if (!t && a === et) return;
    ...
    et = a, F({
      ...
      styleString: i ?? "",
      nonce: window.UserLeap.styleNonce
    }), X = "center-modal" === l, en = o;
    let [p, _] = o.split("-");
    (e => {
      if (z() || !er.includes(e)) return;
      let [t, n] = e.split("-"), r = document.createElement("div");
      r.id = "sprig-feedback-container", r.classList.add(`sprig-feedback-container-${n}`, `sprig-feedback-container-${t}`), document.body.appendChild(r)
    })(o), f = z(), $ = document.createElement("button");
    let m = document.createElement("div");
    m.className = "sprig-feedback-button-label", m.innerText = c, $.appendChild(m), $.id = "sprig-feedback-button", $.classList.add(`sprig-feedback-button-${_}`, `sprig-feedback-button-${p}`, `sprig-feedback-button-${r}`, "fade-in-transition"), s.e.on(s.E.SURVEY_FADING_OUT, el), $.addEventListener("click", async () => {
      ...
      if (N((0, s.g)(window.UserLeap)) || ee || ed(), t) return J && J.classList.add("sprig-feedback-loading-container-previews"), await C(t), void ec();
      let r = await (async e => {
      ...
      if (r) s.e.once(s.S.SurveyAppeared, ec), C({
        ...r,
        studyType: "feedbackButton"
      }, n);
      else if (J) {
    ...
    }), null == f || f.appendChild($), s.e.emit(s.S.FeedbackButtonLoaded, {
    ...
    if (X || h) es(0);
      ...
      let e = document.createElement("div");
      e.id = "sprig-feedback-loading-container", e.className = `sprig-feedback-loading-container sprig-feedback-loading-container-${_}`, e.style.setProperty("--feedback-border", g), J = e, eu(), null == f || f.appendChild(e), es(-eo())
    }
    window.UserLeap._config.isOnQuestionsTab && t && !ei() && J && (ed(), eu(), J && J.classList.add("sprig-feedback-loading-container-previews"), C(t), ec())
  }, ep = () => {
    let e = document.createElement("div");
    module.id = "sprig-feedback-error-container", module.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
  <circle cx="20" cy="20" r="14.5" stroke="#B0B5B7" stroke-width="3"/>
  <path d="M20 12L20 21.6" stroke="#B0B5B7" stroke-width="3" stroke-linecap="round"/>
  <circle cx="19.9984" cy="27.6" r="1.6" fill="#B0B5B7"/>
  </svg>`;
    let t = document.createElement("h3");
    return exports.className = "sprig-feedback-error-text", exports.innerText = "There was an error while loading the survey", module.appendChild(exports), module
  }, e_ = new class {
    constructor() {
      u(this, "_ldData", {})
    }
    ...
    setLDFlagsVariations(e) {
      try {
        ...
        }), Object.keys(e).forEach(t => this._ldData[`!launch_darkly_${t}`] = (e[t] ?? 0) + 1), true)
      } catch (e) {
        return e instanceof Error && window.UserLeap.reportError("setAllLDFlagsVariations", e), console.warn("[Sprig] An issue had occured when setting LaunchDarkly flags and variations."), false
      }
    }
  };
Object.freeze(e_);
let em = new class {
  ...
  setOptimizelyExperiment(e, t = true) {
    ...
    try {
      return t && Object.keys(this._optimizelyData).map(e => {
        ...
        let {
          id: t,
          variation: n
        } = e, r = this.transformExperimentId(t);
        n && "string" == typeof n && (this._optimizelyData[r] = n)
      }), true
    } catch (e) {
      return e instanceof Error && window.UserLeap.reportError("setOptimizelyExperiment", e), false
    }
  }
  ...
  getAndSetWebOptimizelyExperiments() {
    ...
    try {
      if (window && window.optimizely && "function" == typeof window.optimizely.get) {
        let t = null == (e = window.optimizely.get("state")) ? true : module.getExperimentStates({
          isActive: true
        });
        if (exports) {
          let e = Object.keys(exports).map(e => {
            var n, r;
            return null != (n = t[e].variation) && n.name ? {
              id: e,
              variation: null == (r = t[e].variation) ? true : r.name
            } : {
              id: e,
              variation: "Original"
            }
      ...
      return module instanceof Error && window.UserLeap.reportError("getAndSetWebOptimizely", module), false
    }
  }
};
Object.freeze(em);
class eh {
  constructor(e, t) {
    u(this, "paused"), u(this, "queue"), u(this, "ul"), this.ul = e, this.paused = false, this.queue = [], this.flush(t)
  }
  flush(e) {
    let t = e.length;
    if (t)
      for (let n = 0; n < t; n++) this.push(e[n])
  }
  isPaused() {
    return this.paused
  }
...
let eg = e => {
  ...
  eb = (e, t) => {
    ...
    document.hidden ? setTimeout(() => eb(e, t), e) : setTimeout(() => {
  ...
  eP = e => e.forEach(eN),
  eR = () => {
    ey.report(eI[ey.name] || 0), eO.report(eI[eO.name] || 0), ev.report(eI[ev.name] || 0), eS.report(eI[eS.name] || 0), eI = {}
  },
  ew = (e = 1e3) => {
    ey = (0, s.r)("sdk_mutations_nodes_added"), eO = (0, s.r)("sdk_mutations_nodes_removed"), ev = (0, s.r)("sdk_mutations_attributes_changed"), eS = (0, s.r)("sdk_mutations_character_data"), new MutationObserver(eP).observe(document, {
      attributes: true,
  ...
  eD = ({
    ...
    (0, s.i)(n, (e, t) => {
      ...
      if (null != (n = s.m.replay) && n.isReplayRecording()) {
        ...
        null == (r = s.m.replay) || r.disableRecording("Threshold violated", Error(n), {
          reportError: false
        }), window.UserLeap.reportError("Sdk Performance Metric threshold violated", Error("Sdk Performance Metric threshold violated"), {
          metricName: t.metric,
          type: t.type,
          value: t.value
        }, {
...
function eG(e) {
  ...
  let {
    pageUrlEvents: r,
    interactiveEvents: i,
    dismissOnPageChange: a,
    platform: o
  } = window.UserLeap._config;
  if (o && "web" !== o) return;
  eU !== window.location.href && s.b.navigation("LocationChange", {
    from: eU,
    to: window.location.href
  }), eU = window.location.href;
  let l = eV().trackStartUrl,
    c = l ? String(l) : null;
  r && eY(window.location.href), i && (eF(), eB()), K() && (() => {
    if (ei()) return;
    let e = z();
...
let eZ = {
  ...
  eB = () => {
    let e = window.UserLeap._config.interactiveEvents.filter(e => (0, s.p)(e, window.location.href)).map(e => {
        let {
          name: t,
          properties: n
        } = e, {
        ...
        return r ? e => {
          ...
          returnfalse
        } : e => (B(e.target) && e.target.innerText === i && window.UserLeap("track", t), false)
      }),
      t = t => e.forEach(e => e(t));
    window.UserLeap._config.interactiveEventsHandler = exports, window.addEventListener("click", exports, eZ)
  },
  eF = () => {
    window.UserLeap._config.interactiveEventsHandler && window.removeEventListener("click", window.UserLeap._config.interactiveEventsHandler, eZ), delete window.UserLeap._config.interactiveEventsHandler
  };

function eV() {
  let e = Chunk555256.l.getItemObject("userleap.ids");
  return module && module[window.UserLeap.envId] || {}
}

function eH() {
  if (window.previewMode) return;
  let e = Chunk555256.l.getItemObject("sprig.anon.env.vid.map") || {},
  ...
  }), I("vid", window.UserLeap.visitorId), exports || (module[window.UserLeap.envId] = window.UserLeap.visitorId, Chunk555256.l.setItemObject("sprig.anon.env.vid.map", module)), Chunk555256.e.emit(Chunk555256.S.VisitorIDUpdated, {
    visitorId: window.UserLeap.visitorId
  })
}
...
function eY(e, t, n, r) {
  ...
  try {
    ...
    let o = null == (i = null == document ? true : document.querySelector('meta[name="description"]')) ? true : i.getAttribute("content");
    null == (a = s.m.replay) || a.RecordPageView({
      ...o && {
        description: o
      },
      url: e,
    ...
    let l = window.UserLeap._config.pageUrlEvents,
      c = false;
    if (l && l.length)
      for (let t = 0; t < l.length && !(c = (0, s.p)(l[t], e)); t++);
    if (!c) return;
...
function eW() {
  ...
  }), "replaceState" in require && (t = require.replaceState, require.replaceState = function(...e) {
...
async function eK(e, t) {
  ...
  let r = N((0, s.g)(window.UserLeap)),
    i = await S(function(e) {
      ...
      surveyid: null == e ? true : e.surveyId,
      surveytemplateid: null == e ? true : e.surveyTemplateId,
      vid: n
    }), {
      shouldDropOnRateLimit: true
    });
  if (!i.ok) return i.reportError && i.error && (console.warn("[Sprig] (ERR-414) Failed to request questions from the server", i.error), window.UserLeap.reportError("getQuestions", i.error)), {
    success: false,
    surveyState: "no survey"
  };
...
let eq = function(e) {
  ...
  let t = async (t = {}) => {
    ...
    let {
      ...
      metadata: f = {},
      properties: p,
      showSurveyCallback: _
    } = t, {
      eventName: m
    } = t;
    if (window.UserLeap.debugMode && m !== ek && console.info("[DEBUG] Sprig track", t), "test" === e.mode) return;
    let h = s.l.getItem("sprig.previewKey") ?? true;
    ...
    f.url || (f.url = g), I("trackStartUrl", g), null != (r = null == (n = window.UserLeap) ? true : n._config) && r.optimizelyEnabled && (P((0, s.g)(window.UserLeap)) || em.getAndSetWebOptimizelyExperiments(), f.optimizelyExperiments = Object.assign({}, em.getAllOptimizelyExperiments())), null != (l = null == (i = window.UserLeap) ? true : i._config) && l.launchDarklyEnabled && (f.launchDarklyFlags = e_.getAllLaunchDarklyVariations()), u && (window.UserLeap.userId = u), d && (window.UserLeap.partnerAnonymousId = d), p && (f.eventProperties = p), null == (c = s.m.replay) || c.RecordEvent({
      name: m,
      url: f.url
    }), s.b.info("TrackEvent", {
      eventName: m
    });
    let E = window.UserLeap.delayingSurvey || Q() ? await S(A("1", [O], "events/batch"), {
      body: JSON.stringify({
        events: [{
          event: m,
          metadata: f
    ...
    if (!E.ok) {
      ...
      return E.reportError && (console.warn(e, E.error), E.error && window.UserLeap.reportError("track", E.error)), {
        success: false,
        message: e,
        error: E.error,
        surveyState: "no survey"
    ...
    return null != b && b.feedbackButton && ef(b.feedbackButton, true, y), await async function(e, t) {
      var n, r;
      let i = true;
      return !(t && null != (n = null == e ? true : e.json) && n.surveyId && (window.UserLeap.delayingSurvey = true, i = await t(e.json.surveyId), window.UserLeap.delayingSurvey = false, !i)) && (null != (r = null == e ? true : e.json) && r.delay && !window.UserLeap.isMobileSDK && (window.UserLeap.delayingSurvey = true, await (0, s.q)(e.json.delay), window.UserLeap.delayingSurvey = false), i)
    }(E, _) ? ! function(e) {
      if (!window.UserLeap._config.dismissOnPageChange) returntrue;
      let t = new URL(e),
    ...
    var n;
    let r = null == (n = null == e ? true : e.querySelector(`[id="${R}"]`)) ? true : n.contentDocument;
    r && F({
      document: r,
      elementId: "ul-custom-style",
      styleString: t
    ...
    displaySurvey: async e => (console.warn("[Sprig] displaySurvey should only be used to debug your studies; not intended for production usage."), window.UserLeap("dismissActiveSurvey", s.D.Override), eK({
      surveyId: e
    }, true)),
    _previewSurvey(e) {
      window.UserLeap("dismissActiveSurvey", s.D.Override), eK({
        surveyTemplateId: e
      }, false)
    },
    _reviewSurvey(e) {
    ...
    dismissActiveSurvey(e = s.D.API) {
      window.UserLeap.container && (e === s.D.Closed && window.Sprig.trackHistory && window.Sprig.trackHistory({
        event: "closed"
      }), s.e.emit(s.S.SurveyCloseRequested, {
        name: s.S.SurveyCloseRequested,
        initiator: e,
    ...
    async identifyAndSetAttributes(t) {
      let n;
      if (window.UserLeap.debugMode && console.info("[DEBUG] Sprig identifyAndSetAttributes", t), "test" === e.mode) return;
      ...
      let o = {};
      return r && (o.userId = window.UserLeap.userId = r), i && (o.partnerAnonymousId = window.UserLeap.partnerAnonymousId = i), a && Object.keys(a).length > 0 ? (n = await S(A("1", [v, O], "attributes"), {
        body: JSON.stringify(a),
        method: "PUT"
      })).ok ? Object.assign(ej, a) : n.reportError && (console.warn("[Sprig] (ERR-432) identifyAndSetAttributes failed", n.error), n.error && window.UserLeap.reportError("identifyAndSetAttributes", n.error)) : n = await S(A("1", [v, O]), {
        body: JSON.stringify(o),
        method: "PUT"
      }), a && a[eM] && (window.UserLeap.email = a[eM]), n.ok && (r && I("uid", r), i && I("aid", i)), {
        success: !!n.ok
      }
    },
    async removeAttributes(t) {
      if (window.UserLeap.debugMode && console.info("[DEBUG] Sprig removeAttributes", t), "test" === e.mode) return;
      ...
      return !n.ok && n.reportError && (console.warn("[Sprig] (ERR-433) Remove attributes failed", n.error), n.error && window.UserLeap.reportError("removeAttributes", n.error)), {
        success: !!n.ok
      }
    },
    ...
    async setUserId(t) {
      ...
      i.ok ? (r !== window.UserLeap.visitorId && (null == (n = s.m.replay) || n.clearUserReplayData()), I("uid", t)) : i.reportError && (console.warn("[Sprig] (ERR-420) Failed to set user id", i.error), i.error && window.UserLeap.reportError("setUserId", i.error))
    },
    async setPartnerAnonymousId(e) {
      ...
      return window.UserLeap.partnerAnonymousId = e, I("aid", e), {
        success: true
      }
    },
    track: async (e, n, r = {}, i) => t({
      eventName: e,
      properties: n,
      metadata: r,
    ...
    applyFeedbackStyles({
      ...
      window.UserLeap.feedbackCustomStyles = t, document.getElementById("sprig-feedback-style") && F({
        document,
        elementId: "ul-custom-style",
        styleString: e,
        nonce: window.UserLeap.styleNonce
    ...
    setWindowDimensions(e, t) {
      ...
      isNaN(i) || isNaN(a) || (window.UserLeap.windowDimensions = {
        width: i,
        height: a
      });
    ...
    logoutUser() {
      var e;
      window.UserLeap.debugMode && console.info("[DEBUG] Sprig logout"), s.b.info("LogOut", {
        vid: window.UserLeap.visitorId,
        userId: window.UserLeap.userId
      }), window.UserLeap.visitorId = null, window.UserLeap.userId = null, window.UserLeap.partnerAnonymousId = null, window.UserLeap.token = null, window.UserLeap.email = null, s.l.removeItem("userleap.ids"), window.UserLeap._queue.isPaused() && window.UserLeap._queue.empty(), eH(), null == (e = s.m.replay) || e.clearUserReplayData(), window.UserLeap._queue.unpause()
    },
    teardown() {
      ["hashchange", "popstate"].forEach(e => window.removeEventListener(e, eG, true)), window.UserLeap._config.interactiveEvents && eF(), window.UserLeap("dismissActiveSurvey", s.D.API), delete window.UserLeap, delete window.Sprig, delete window._Sprig
    },
    integrateOptimizely(e, t = true) {
      var n, r;
      if (null != (r = null == (n = window.UserLeap) ? true : n._config) && r.optimizelyEnabled) try {
        let n = "string" == typeof e ? JSON.parse(e) : e;
        em.setOptimizelyExperiment(n, t)
      } catch (e) {
        console.warn("[Sprig] Error with integrating Optimizely data"), e instanceof Error && window.UserLeap.reportError("integrateOptimizely", e)
      } else console.warn("[SPRIG] Optimizely integration is currently not enabled for your product.")
    },
    integrateOptimizelyClient(e) {
      var t, n;
      if (!(null != (n = null == (t = window.UserLeap) ? true : t._config) && n.optimizelyEnabled)) return void console.warn("[SPRIG] Optimizely integration is currently not enabled for your product.");
      e.notificationCenter.addNotificationListener("ACTIVATE:experiment, user_id,attributes, variation, event", ({
        experiment: e,
        variation: t
      }) => {
        let n = {
        ...
        window.UserLeap("integrateOptimizely", n, false)
      })
    },
    importLaunchDarklyData(e) {
      var t, n;
      null != (n = null == (t = window.UserLeap) ? true : t._config) && n.launchDarklyEnabled ? e_.setLDFlagsVariations(e) : console.warn("[SPRIG] LaunchDarkly integration is currently not enabled for your product.")
    },
    ...
    _generateVideoUploadUrl: async e => (async function(e) {
      ...
      try {
        ...
        if (r.ok) {
          let e = await r.json();
          return null == (t = null == e ? true : e.upload) ? true : t.url
        }
        return null
      } catch (e) {
        console.warn("[Sprig] Error with generating video upload url"), e instanceof Error && window.UserLeap.reportError("generateVideoUploadUrl", e)
      }
    })(e),
    _reportMetric(e, t) {
      (0, s.d)(e, t)
    ...
    _completeSessionReplay: async ({
      ...
      var r;
      return s.m.replay ? null == (r = s.m.replay) ? true : r._completeSessionReplay({
        surveyId: e,
        responseGroupUuid: t,
        eventDigest: n,
        headers: (0, s.g)(window.UserLeap)
      }) : (window.UserLeap.reportError("_completeSessionReplay", Error("Replay module not registered")), false)
    },
    pauseReplayRecording() {
      var e, t, n, r;
      null != (t = null == (e = s.m.replay) ? true : e.isReplayPaused) && t.call(e) || null == (r = null == (n = s.m.replay) ? true : n.recordReplayPaused) || r.call(n)
    },
    resumeReplayRecording() {
      var e, t, n, r, i, a;
      null != (t = null == (e = s.m.replay) ? true : e.isReplayPaused) && t.call(e) && (null == (r = null == (n = s.m.replay) ? true : n.recordReplayResumed) || r.call(n), null == (a = null == (i = s.m.replay) ? true : i.recordFullSnapshot) || a.call(i))
    }
  };
...
async function eQ(e, t, n = {}, r = {}) {
  let i = window.__cfg && window.__cfg.mode,
    ...
    d = {
      ...
      err: {
        message: `${null==t?true:t.name} - ${null==t?true:t.message}`,
        stack: null == t ? true : t.stack
      },
      meta: u,
      vid: a,
      envId: l,
...
function eX(e = {}) {
  ...
  async function r() {
    ...
    if (null == (t = window.SprigLoggerCallback) || t.call(window, "Loading Sprig"), window.UserLeap.reportError = eQ, window.UserLeap.loaded = true, window.UserLeap._config = Object.assign({}, e, window.UserLeap.config), window.UserLeap.delayingSurvey = false, window.UserLeap._config && "object" == typeof window.UserLeap._config)
    ...
    let f = l.token;
    f ? (window.UserLeap.token = f, window.UserLeap.visitorId = l.vid ?? null, window.UserLeap.userId = l.uid ?? null, window.UserLeap.partnerAnonymousId = l.aid ?? null) : eH();
    ...
    let _ = await async function(e) {
      ...
      let i = await (0, s.s)(A("1", [v], "config"), {
        headers: r
      });
      if (document.removeEventListener("securitypolicyviolation", s.n), !i.ok) return null == (t = window.SprigLoggerCallback) || t.call(window, "Sprig config fetch failed"), i.reportError && (console.warn("[Sprig] (ERR-422) Failed to load configuration", i.error), i.error && window.UserLeap.reportError("applyRemoteConfig", i.error)), (0, s.o)("Disabled: failed to fetch configuration"), e;
      let a = i.json;
      return null != a && a.disabled ? (null == (n = window.SprigLoggerCallback) || n.call(window, "Sprig config fetch disabled"), (0, s.o)(`Disabled: ${a.disabled}`), {
        disabled: a.disabled
      }) : Object.assign({}, a, e)
    }(e);
    null == (r = window.SprigLoggerCallback) || r.call(window, "Sprig fetched config"), eD({
      isWeb: !p,
      reportingIntervalSeconds: _.metricsReportingEnabled || _.mobileMetricsReportingEnabled ? _.metricsReportingIntervalSeconds : 0,
      ...
      postMetrics: async e => {
        ...
        await S(A("1", [v], "metrics"), {
          ...
          method: "POST",
          headers: {
            "x-ul-replay-enabled": `${!!(null!=(t=s.m.replay)&&t.isReplayRecording())}`
          },
          shouldDropOnRateLimit: true
        })
      }
    ...
    await (null == (i = s.m.replay) ? true : i.initializeReplay({
      ...
      apiUrl: window.UserLeap._API_URL,
      alwaysOnConfig: m
    })), a = _.replaySettings, eq(_), await ez(_), window.UserLeap._queue.unpause(), null == (o = window.SprigLoggerCallback) || o.call(window, "SdkReady"), s.e.emit(s.S.SDKReady, {
...
let e$ = {
  configure: e => {
    if (!e.envId && !e.environmentId) throw Error("Initialization Error: Sprig configure requires an environmentId");
    if (e.envId || (e.envId = e.environmentId ?? ""), e.installationMethod = "web-npm", window.Sprig) return window.Sprig;
