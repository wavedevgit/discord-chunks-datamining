...
let C = async (e, t, r) => {
  ...
  let D, M, k, U, G = document.createElement("div"),
    B = e => {
      let {
        "view.version": t
      } = e;
  ...
  s.e.on("verify.view.version", B), window.UserLeap.useMobileStyling = P, (0, s.h)(A) ? (D = "ul-direct-embeded-frame", M = document.head, k = window, U = false, (() => {
...
function eQ(e = {}) {
  ...
  async function r() {
    ...
    null == (r = window.SprigLoggerCallback) || r.call(window, "Sprig fetched config"), ew({
      isWeb: !_,
