...
function c(e) {
  let {
    searchQuery: t = ""
  } = e, n = (0, r.Ay)(e => e.recentlyShown), [c, d] = (0, s.A)(), u = c.filter(e => e.toLowerCase().includes(t.toLowerCase())).filter(e => !n.includes(l.M[e])).slice(0, 3);
  return 0 === u.length ? null : (0, a.jsx)(i.nVY, {
