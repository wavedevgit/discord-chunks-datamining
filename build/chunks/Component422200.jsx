...
let A = (0, Chunk108843.Z)(function(e) {
  let {
    channel: n,
    onSelect: t
  } = e, a = (0, d.Z)(n), o = (0, h.Z)(n), A = (0, _.Z)(n), N = (0, s.Z)(n), C = (0, Z.Z)(n), x = (0, f.Z)(n), S = (0, c.Z)({
    id: n.id,
    label: E.intl.string(E.t.DQ797g)
  }), w = (0, b.Z)(n, "Context Menu"), M = (0, g.Z)(n), T = (0, O.Z)(n), k = (0, y.Z)(n), R = (0, v.Z)(n), I = (0, m.Z)(n.id), D = (0, p.Z)(n), U = (0, P.Z)(n), F = (0, u.l)(n), G = (0, u.P)(n), L = (0, j.Z)(n);
