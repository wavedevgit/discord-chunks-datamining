...
function h(e) {
  ...
  } = e, f = i.useMemo(() => n.map(d.Wo), [n]), O = i.useCallback(e => {
    let t = (0, d.xx)(e, n);
    null != t && b(t)
  }, [b, n]), _ = i.useCallback(() => {
    let e = n.find(d.A6);
  ...
  return (0, l.jsxs)("div", {
    ...
    children: [(0, l.jsx)(u.X6q, {
      ...
      className: a()(E.freeformTextArea, {
        [E.freeformTextAreaDisabled]: !o
      }),
      value: s,
      maxLength: v.iF,
      onChange: c,
...
let g = function(e) {
  let {
    ...
    let e = [],
      t = [];
    return m && (e.push(S), t.push(_.intl.string(_.t.UyBQFx))), e.push(T), t.push(_.intl.string(_.t.LhMLCg)), {
      questionItems: e,
      questionTitles: t
    }
  }, [m, T, S]);
  ...
  let [I, N] = i.useState(0), y = i.useMemo(() => I === x.length - 1, [I, x.length]), C = i.useMemo(() => {
    let e = x[I],
      t = D[I];
    return (0, l.jsx)(h, function(e) {
  ...
  }, [x, D, I]), k = i.useMemo(() => x.every(d.cp), [x]), j = i.useMemo(() => {
    let e = x[I];
    return (0, d.cp)(e)
  }, [x, I]), R = i.useCallback(() => {
    k && (s.ZP.trackWithMetadata(O.rMx.SEARCH_RESULTS_FEEDBACK_SUBMITTED, {
      rating: r,
