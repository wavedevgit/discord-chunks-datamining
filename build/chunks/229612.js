...
function g(e) {
  let {
    ...
    isFreeformEnabled: o,
    selectOption: b,
    onFreeformTextChange: d
  } = e, g = i.useMemo(() => n.map(c.Wo), [n]), E = i.useCallback(e => {
    let t = (0, c.xx)(e, n);
    null != t && b(t)
  }, [b, n]);
  return (0, l.jsxs)("div", {
    ...
    children: [(0, l.jsx)(u.X6q, {
      ...
      className: a()(O.freeformTextArea, {
        [O.freeformTextAreaDisabled]: !o
      }),
      value: s,
      maxLength: f.iF,
      onChange: d,
...
let E = function(e) {
  let {
    ...
    let e = [],
      t = [];
    return m && (e.push(h), t.push(v.intl.string(v.t.UyBQFx))), e.push(p), t.push(v.intl.string(v.t.LhMLCg)), {
      questionItems: e,
      questionTitles: t
    }
  }, [m, p, h]);
  ...
  let [S, y] = i.useState(0), N = 0 === S, C = S === T.length - 1, D = i.useMemo(() => {
    let e = T[S],
      t = x[S];
  ...
  }, [T, x, S]), I = i.useMemo(() => T.every(c.cp), [T]), j = i.useMemo(() => {
    let e = T[S];
    return (0, c.cp)(e)
  }, [T, S]), k = i.useCallback(() => {
    I && ((0, b.z4)({
  ...
  }, [h, m, I, E, r, p, t, n]), P = i.useCallback(() => {
    if (N) return void E();
    y(S - 1)
  }, [N, S, E]), R = i.useCallback(() => {
    y(S + 1)
  }, [S]);
