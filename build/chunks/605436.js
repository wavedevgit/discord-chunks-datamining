...
function R(e, t, n, i) {
  ...
  return Object.values(t).filter(t => !y(t) && T(n, t.id, i) && C(e, t) && o(t.name)).sort(I).map(e => v(e, r.e$(e.permissions, i)))
}
...
function L(e, t, n, r, i) {
  let o = [];
  return 0 === (o = w(e, t, n, r, i).sort(I).map(e => v(e))).length ? S(g.intl.string(g.t.nZfHsb)) : o
}

function x(e, t, n, i, o) {
  let a = [];
  return 0 === (a = D(e, t, n, i, o).sort(I).map(e => v(e, r.e$(e.permissions, i)))).length ? S(g.intl.string(g.t.nZfHsb)) : a
}
