...
function D(e, t, n, i, a) {
  return t.filter(e => {
    var t;
    return v(e) || !N(n, e.id, i, a) && !(0, l.fI)(e) || r.e$(r.$e(e.permissions, null == (t = n.permissionOverwrites[e.id]) ? void 0 : t.allow), i)
  })
}

function L(e, t, n, r, i) {
  let a = [];
  return 0 === (a = P(e, t, n, r, i).sort(S).map(e => T(e))).length ? A(b.intl.string(b.t.nZfHsb)) : a
}

function x(e, t, n, r, i) {
  let a = [];
  return 0 === (a = D(e, t, n, r, i).sort(S).map(e => T(e, (0, l.Fs)(e, r)))).length ? A(b.intl.string(b.t.nZfHsb)) : a
}
...
function B(e, t, n, r) {
  let i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : () => !0;
  return e.map(u.default.getUser).filter(f.lm).filter(e => !(0, s.eM)(n, e) && N(t, e.id, r) && (i(k(e, n)) || i(e.username) || i(e.discriminator))).map(e => U(e, n)).sort(G)
}

function Z(e, t, n, r, i) {
  return e.map(u.default.getUser).filter(f.lm).filter(e => !N(t, e.id, r, i) || j(e, n))
}
...
function K(e, t) {
  ...
  if (null == n) return;
  let o = e.permissionOverwrites[n.id];
  if (null == o) {
    let o = {
      id: n.id,
      type: a.BN.MEMBER,
    ...
    return (0, i.hw)(e.id, [o], !0)
  } {
    let {
      allow: n,
      deny: a
    } = o;
    return n = r.IH(n, t), (0, i.kY)(e, o.id, n, a)
  }
}
...
function q(e, t, n) {
  return e === E.d4z.GUILD_TEXT || e === E.d4z.GUILD_ANNOUNCEMENT ? t : !(0, o.bw)(e) && e !== E.d4z.GUILD_CATEGORY || t && n
}
