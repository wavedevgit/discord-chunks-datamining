...
function P(e, t, n, r) {
  ...
  return Object.values(t).filter(t => !O(t) && A(n, t.id, r) && R(e, t) && i(t.name)).sort(T).map(e => I(e))
}

function w(e, t, n, i) {
  let a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : () => !0;
  return Object.values(t).filter(t => !O(t) && A(n, t.id, i) && R(e, t) && a(t.name)).sort(T).map(e => I(e, r.e$(e.permissions, i)))
}
...
function V(e, t, n, r) {
  let i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : () => !0;
  return e.map(u.default.getUser).filter(_.lm).filter(e => !(0, l.eM)(n, e) && A(t, e.id, r) && (i(k(e, n)) || i(e.username) || i(e.discriminator))).map(e => G(e, n)).sort(B)
}

function F(e, t, n, r, i) {
  return e.map(u.default.getUser).filter(_.lm).filter(e => !A(t, e.id, r, i) || j(e, n))
}

function Z(e, t, n, r, i) {
  return F(e, t, n, r, i).map(e => G(e, n)).sort(B)
}
