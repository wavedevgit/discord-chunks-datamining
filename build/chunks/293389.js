...
function L(e) {
  ...
  })), P = (0, l.e7)([g.ZP], () => g.ZP.getVisibleGame()), [Z, k] = r.useState(!1), M = r.useMemo(() => (0, x.le)(O) ? b ? O.gameName : T.intl.formatToPlainString(T.t.G6BGd3, {
    subgameName: O.gameName
  }) : O.name, [O, b]), [B, U] = r.useState(null != M ? M : "???"), V = a()(y.flexCenter, {
    [I.game]: !s,
    [I.activeGame]: s,
    [A.card]: !s,
  ...
  function F() {
    ...
    }), d.ToastType.SUCCESS)), k(!0)
  }
  let H = null != C && C.id === (null == P ? void 0 : P.id) || O.id === (null == P ? void 0 : P.id) || null != h && h.some(e => e.id === (null == P ? void 0 : P.id));
    ...
    children: [(0, i.jsxs)("div", {
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: [O.verified && !c ? (0, i.jsxs)("div", {
          ...
          return s || O.id === (null == P ? void 0 : P.id) ? e = T.intl.string(T.t.VbV5dn) : null != t && "" !== t && (e = T.intl.format(T.t.gGeOEx, {
            when: t
          })), (0, i.jsx)("div", {
