...
function L(e) {
  let {
    ...
    isSubgame: h = !1,
    parentGame: b
  } = e, C = (0, l.cj)([g.ZP, _.Z, j.Z], () => (0, g.FZ)(t, g.ZP, _.Z, j.Z)), O = (0, l.e7)([g.ZP], () => null == b || g.ZP.isDetectionEnabled(b)), v = (0, l.e7)([g.ZP], () => g.ZP.getVisibleGame()), [N, P] = r.useState(!1), Z = r.useMemo(() => (0, x.le)(C) ? h ? C.gameName : T.intl.formatToPlainString(T.t.G6BGd3, {
    subgameName: C.gameName
  }) : C.name, [C, h]), [k, M] = r.useState(null != Z ? Z : "???"), B = a()(y.flexCenter, {
    [I.game]: !n,
    [I.activeGame]: n,
    [A.card]: !n,
  ...
  function V() {
    ...
    E.default.track(S.rMx.USER_SETTINGS_REPORT_INCORRECT_GAME_DETECTION, {
      ...
      gameName: (0, x.le)(C) ? C.gameName : C.name
    }), d.ToastType.SUCCESS)), P(!0)
  }
  let G = null != b && b.id === (null == v ? void 0 : v.id) || C.id === (null == v ? void 0 : v.id) || null != c && c.some(e => e.id === (null == v ? void 0 : v.id));
  return (0, i.jsxs)(i.Fragment, {
    children: [(0, i.jsxs)("div", {
      className: B,
      children: [(0, i.jsxs)("div", {
        className: a()(I.gameNameLastPlayed, y.vertical),
        children: [C.verified && !s ? (0, i.jsxs)("div", {
          ...
          return n || C.id === (null == v ? void 0 : v.id) ? e = T.intl.string(T.t.VbV5dn) : null != t && "" !== t && (e = T.intl.format(T.t.gGeOEx, {
            when: t
          })), (0, i.jsx)("div", {
      ...
      }(), n && !s || G ? null : (0, i.jsx)(m.Z, {
        className: I.removeGame,
        onClick: function() {
          u.Z.deleteEntry(C), null == c || c.forEach(e => {
            u.Z.deleteEntry(e)
          })
        }
      })]
      ...
      children: c.map((e, t) => (0, i.jsxs)(r.Fragment, {
        children: [(0, i.jsx)(L, {
          rawGame: e,
          isOverride: !1,
          isSubgame: !0,
          parentGame: C
        }), t !== c.length - 1 && (0, i.jsx)("div", {
          className: I.border
        })]
      }, (0, g.rH)(e)))
    })]
...
let U = (0, C.oH)(function() {
  ...
  V = function(e) {
    let {
      className: t,
      showHeader: n = !0
    } = e, s = (0, l.Wu)([g.ZP], () => g.ZP.getGamesSeen(!1)), {
      runningGame: o,
      overrideExePaths: u
    } = (0, l.cj)([g.ZP], () => ({
    ...
    return r.useEffect(() => ((0, h.Ky)(), h.P7), []), (0, i.jsxs)(d.hjN, {
      ...
      className: t,
      children: [null != o ? (0, i.jsx)(L, {
        rawGame: o,
        isOverride: u.has(o.exePath),
        nowPlaying: !0
      }, (0, g.rH)(o)) : (0, i.jsx)(M, {}), (0, i.jsxs)("div", {
