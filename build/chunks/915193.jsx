...
function h(e) {
  ...
  return <svg className={r} height={"16"} width={"80"} viewBox={"0 0 80 16"} xmlns={"http://www.w3.org/2000/svg"}><g fill={"none"} fillRule={"evenodd"} opacity={".6"}>{<path d={"m0 0h80v16h-80z"} />}{<g stroke={n} strokeLinecap={"round"} strokeLinejoin={"round"} strokeWidth={"2"}>{<path d={"m71 1h4v4.16"} />}{<path d={"m2 1h4v4.16"} transform={"matrix(-1 0 0 1 8 0)"} />}{<path d={"m51 1h4m6 0h4m-24 0h4m-14 0h4m-14 0h4m-23 11v-2m9-9h4"} />}{<path d={"m72.13 10.474 2.869 3.12 2.631-3.12"} />}</g>}</g></svg>
}

function b(e, n) {
  let r = (0, i.e7)([c.default], () => c.default.getCurrentUser());
  return null == r || n.ownerId !== r.id || e.id === r.id ? null : <o.sNh id={"make-dm-owner"} color={"danger"} label={u.intl.string(u.t["6t3CyM"])} action={() => {
      (0, o.h7j)(i => {
        var c, b;
