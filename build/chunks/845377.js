...
let y = e => {
  ...
  return s ? (d = (0, r.jsx)(g.P4T, {
    size: "custom",
    color: m.Z.unsafe_rawColors.YELLOW_300.css,
    width: 20,
    height: 20
  }), u = null != a ? a : i) : l ? (d = (0, r.jsx)(g.XZJ, {
    readOnly: !0,
...
let I = e => {
  let {
    ...
    headerContent: o,
    failedItemsOnly: c = !1
  } = e, [m, I] = (0, u.Wu)([b.ZP], () => [b.ZP.getDiscoveryChecklist(l), b.ZP.isLoading()], [l]), {
    nsfwProperties: E
  } = null != m ? m : {}, S = null == t ? void 0 : t.features.has(j.oNc.PARTNERED), T = null == E ? void 0 : E.channels_banned_keywords, P = (0, u.e7)([p.ZP], () => {
    var e, n, r;
    if (null == T) return [];
    let i = null != (n = (null != (e = p.ZP.getChannels(t.id)) ? e : {})[p.sH]) ? n : [],
      l = null != (r = null == i ? void 0 : i.map(e => e.channel).reduce((e, t) => C(O({}, e), {
        [t.id]: t
      }), {})) ? r : {};
  ...
  let w = S ? _.t["WH+1Y2"] : _.t.a4MYDA,
    R = [{
      ...
      description: null,
      failingDescription: _.intl.format(w, {
        minMembers: m.minimumGuildSize.toLocaleString()
      }),
      ...
      pendingDescription: (null == m ? void 0 : m.size) ? _.intl.format(_.t.ALtXIC, {
      ...
      failingDescription: _.intl.format(_.t.kBXInZ, {
        onClick: () => x.Z.setSection(j.pNK.SAFETY, j.KsC.SAFETY_PERMISSIONS)
      }),
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(() => {
      ...
      children: [(0, r.jsx)(y, O({}, e)), t < R.length - 1 ? (0, r.jsx)("hr", {
