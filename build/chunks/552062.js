...
class j extends(i = o.Component) {
  ...
  handleDragMove(e, t) {
    ...
    let {
      width: f,
      height: m
    } = x(n, this.size), y = t - p, O = e - h, v = (0, d.ou)((0, d.PY)({
      top: y,
      left: O,
      bottom: void 0,
      right: void 0
    }, r, s, f, m)), S = u ? (0, d.R)(v) : Z("RESIZE_SOUTH_EAST", v);
    this.setDOMPositions(S), g || (null != a && a(), this.setState({
      operationStarted: !0
  ...
  handleResizeMove(e, t) {
    ...
    if (null != d) {
      ...
      g = Math.max(g + m, i.width), f = Math.max(f + y, i.height), this.setDOMSize({
        width: g,
        height: f
  ...
  constructor(e) {
    super(e), p(this, "anchor", void 0), p(this, "size", void 0), p(this, "ref", o.createRef()), p(this, "dragState", {
      ...
      let {
        width: a,
        height: c
      } = x(i, this.size), u = (0, d.PY)(this.anchor, o, l, a, c);
      if ("MOVE" === e) {
        let {
          x: e,
          y: i
        ...
        let i = Z(e, u);
        this.setDOMPositions(i), this.dragState = f(g({}, this.dragState), {
          startX: t,
          startY: n,
          offsetWidth: a,
          offsetHeight: c
