...
function C(e) {
  ...
  let {
    ...
    refreshed: l,
    handleRefresh: o
  } = e, [c, d] = r.useState(!1), m = null != (t = n.metadata) ? t : {}, h = (0, s.e7)([p.default], () => p.default.locale), C = r.useCallback(async () => {
    d(!0);
    try {
      await o(n)
    } finally {
  ...
  return (null == O || 0 === O.length) && null == j && (S = (0, i.jsx)(a.Text, {
    ...
    })), null != O && O.length > 0 && null != j ? (0, i.jsx)("div", {
      className: E.dot
    }) : null, null != j ? (0, i.jsx)(a.Text, {
      variant: "text-xs/normal",
      color: "header-secondary",
...
function O(e) {
  ...
  } = e, [u, g] = r.useState(t.visibility), [p, h] = r.useState(t.metadataVisibility), f = (0, c.ZP)();
  r.useEffect(() => {
...
function j() {
  let e = (0, s.e7)([h.Z], () => h.Z.getAccounts()),
    ...
    [n, l] = r.useState([]),
    c = r.useCallback(e => o.Z.refresh(e.type, e.id).finally(() => {
      l(t => [...t, e.id])
    }), []);
  return 0 === t.length ? null : (0, i.jsxs)(a.hjN, {
