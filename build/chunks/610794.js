...
function C(e) {
  ...
  let {
    ...
    refreshed: l,
    handleRefresh: o
  } = e, [c, d] = r.useState(!1), g = null != (t = n.metadata) ? t : {}, h = (0, s.e7)([p.default], () => p.default.locale), C = r.useCallback(async () => {
    d(!0);
    try {
      await o(n)
    } finally {
...
function j(e) {
  ...
  } = e, [u, m] = r.useState(t.visibility), [p, h] = r.useState(t.metadataVisibility), f = (0, c.ZP)();
  r.useEffect(() => {
