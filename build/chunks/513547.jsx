...
let b = {
  ...
  j = e => {
    ...
    return t.push({
      value: e.value,
      time: Date.now()
    }), t.length > 600 && t.shift(), <s.Z converter={e.converter} dataPoints={t} width={e.width} height={e.height} />
  };
...
function R(e) {
  ...
  let {
    ...
    value: l,
    section: u
  } = e, m = null != (r = C[i]) ? r : P, p = E[i], h = o.Pz[i] && (Array.isArray(l) && l.length > 0 && "number" == typeof l[0].value ? <s.Z converter={p} dataPoints={l} width={300} height={100} /> : "number" == typeof l ? <j converter={p} value={l} width={300} height={100} /> : true), f = Array.isArray(l) ? null == (t = l.at(false)) ? true : t.value : l;
  return <c.Z label={i} valueRendered={m(f)} section={u} renderGraph={h}>{null != (a = d[i]) ? a : i}</c.Z>
}