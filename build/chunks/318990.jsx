...
function d() {
  ...
  return 0 === module.length ? null : <div className={Chunk356883.container}>{<Chunk481060.qEK{...function(e) {
      ...
      size: Chunk481060.EFr.SIZE_24
    }, d)} />}{<Chunk481060.Text className={Chunk356883.text} variant={"text-sm/normal"} color={"always-white"}>{C}</Chunk481060.Text>}</div>
}