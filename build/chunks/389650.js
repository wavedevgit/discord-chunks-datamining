...
let G = o()((0, b.Rv)()).filter(e => e.description !== Z.intl.string(Z.t.HnNtEB)).groupBy(e => e.group).value(),
  F = c.ZP.connectStores([A.Z], () => ({
    theme: A.Z.theme
  }))(m.ubH);
class H extends r.PureComponent {
  renderMessage() {
    let {
      keybind: e
    } = this.props, t = y.BB(e.shortcut);
    return _.Z.hasBind(t) ? (0, i.jsx)(m.R94, {
    ...
    }) : D.Sp.has(t) ? (0, i.jsx)(m.R94, {
      className: w.keybindMessage,
      type: m.geA.DESCRIPTION,
      style: {
        color: d.Z.unsafe_rawColors.RED_400.css
      },
      children: Z.intl.format(Z.t.MOIaNT, {
        keyboardNavArticle: I.Z.getArticleURL(R.BhN.KEYBOARD_NAVIGATION)
      })
    }) : (0, i.jsx)(m.R94, {
      className: w.keybindMessage,
      type: m.geA.DESCRIPTION,
  ...
  renderExtraSettings() {
    ...
    return e === R.kg4.SWITCH_TO_VOICE_CHANNEL ? (0, i.jsx)(P.Z, {
      keybind: this.props.keybind
    }) : void 0
  }
  constructor(...e) {
    super(...e), B(this, "handleActionChanged", e => {
      g.Z.setKeybind(U(M({}, this.props.keybind), {
        action: e
      }))
...
class z extends r.PureComponent {
  ...
  get keybindActionTypes() {
    ...
    })), t && ((0, N.isWindows)() || v.Z.getUseSystemScreensharePicker()) && s.push({
  ...
  renderEmpty(e) {
    if (0 === e.length) return this.props.isCoreProductIllustrationEnabled ? null : (0, i.jsx)(F, {
  ...
  render() {
    let e = this.props.enableClips,
      t = o()(this.props.keybinds).reject(e => e.managed && ![R.kg4.OVERLAY_ACTIVATE_REGION_TEXT_WIDGET, R.kg4.SAVE_CLIP].includes(e.action)).reject(t => !e && t.action === R.kg4.SAVE_CLIP).reject(e => !this.props.allowSoundboard && (e.action === R.kg4.SOUNDBOARD || e.action === R.kg4.SOUNDBOARD_HOLD)).sortBy(e => e.id).sortBy(e => !0 === e.managed ? -1 : 0).value();
    return (0, i.jsxs)(i.Fragment, {
      children: [(0, i.jsx)(m.hjN, {
        ...
        children: N.isPlatformEmbedded ? (0, i.jsxs)(i.Fragment, {
          ...
          children: Z.intl.format(Z.t.mPi3Fx, {
            ...
            children: e.map((e, t) => {
              ...
              return (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)(m.X6q, {
                  ...
                  className: l()(w.defaultKeybindGroupHeader, {
                    [w.defaultKeybindGroupWithDescription]: null != s
                  }),
                  children: n
                  ...
                  children: s
                }), (0, i.jsx)(m.$i$, {}), a.map(e => (0, i.jsxs)(r.Fragment, {
                  children: [(0, i.jsxs)("div", {
                    className: w.defaultKeybind,
                    children: [(0, i.jsx)(m.Text, {
                      variant: "text-md/normal",
