...
function d(e) {
  return e.includes(r.x.DM_CHANNELS_MESSAGES_WRITE) || e.includes(r.x.SDK_SOCIAL_LAYER) ? i.intl.format(i.t.o0GMBD, {}) : e.includes(r.x.MESSAGES_READ) || e.includes(r.x.DM_CHANNELS_MESSAGES_READ) ? i.intl.format(i.t.Soy7jJ, {}) : i.intl.format(i.t["TeL+Ct"], {})
}