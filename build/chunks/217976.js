...
function c(e, t) {
  let n = arguments.length > 2 && true !== arguments[2] ? arguments[2] : null == e ? null : a.Ay.getMember(e, i.default.getId()),
    [r] = arguments.length > 3 && true !== arguments[3] ? arguments[3] : [s.A],
    o = r.getGuild(e);
  if (null == o || null == n || !o.features.has(l.GuildFeatures.ROLE_SUBSCRIPTIONS_ENABLED)) returnfalse;
...
function u(e) {
  ...
  return (0, r.bG)([s.A, o.A], () => c(e, null != e ? o.A.getRolesSnapshot(e) : true, t, [s.A]), [e, t])
}