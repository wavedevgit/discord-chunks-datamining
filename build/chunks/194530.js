...
function g(e) {
  ...
  let {
    ...
    noSkip: x = !1
  } = e, [E, j] = r.useState(""), [C, O] = r.useState(""), [S, v] = r.useState(""), [T, I] = r.useState(null), [N, y] = r.useState(null), A = (0, s.e7)([o.Z], () => o.Z.getErrors()), P = (0, s.e7)([o.Z], () => o.Z.getFormState()), R = r.useRef(null);
  async function D(e) {
