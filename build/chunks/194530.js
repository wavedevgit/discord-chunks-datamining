...
function p(e) {
  ...
  let {
    ...
    noSkip: _ = !1
  } = e, [E, j] = i.useState(""), [O, C] = i.useState(""), [S, v] = i.useState(""), [T, I] = i.useState(null), [y, A] = i.useState(null), P = (0, s.e7)([c.Z], () => c.Z.getErrors()), R = (0, s.e7)([c.Z], () => c.Z.getFormState()), D = i.useRef(null);
  async function Z(e) {
