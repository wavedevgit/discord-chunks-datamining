...
function S(e) {
  ...
  return null != C && t === f.S.STICKER ? (0, g.J8)(C) && !(0, g.V9)(C) ? null : R ? <a.sNh id={"unfavorite"} action={() => (0, _.hW)(C.id)} label={b.intl.string(b.t.XhzKyM)} /> : <a.sNh id={"favorite"} action={() => {
      (0, p.cQ)({
        sticker: C,
        location: I(O({}, A), {
    ...
    }} label={b.intl.string(b.t.kWmiPT)} /> : null != P && t === f.S.EMOJI ? w ? <a.sNh id={"unfavorite"} action={() => (0, s.Xe)(P)} label={b.intl.string(b.t.Ay49KC)} /> : <a.sNh id={"favorite"} action={() => {
      (0, c.J1)({
        emoji: P,
        location: I(O({}, A), {
          object: E.qAy.EMOJI
    ...
    }} label={b.intl.string(b.t["nNsr6+"])} /> : true
}