        ...
        switch (I) {
          ...
          default:
            if ((0, r.R3)(R = s(D, n, a, b, y, c, f, E, k = [], V = [], O), d), 123 === I)
              ...
              else switch (99 === x && 110 === (0, r.uO)(D, 3) ? 100 : x) {
                case 100:
                case 108:
                case 109:
                case 115:
      ...
      default:
        ...
        switch (D += (0, r.Dp)(I), I * M) {
          ...
          case 44:
            ...
            break;
          case 64:
            45 === (0, i.fj)() && (D += (0, i.iF)((0, i.lp)())), x = (0, i.fj)(), y = O = (0, r.to)(E = D += (0, i.QU)((0, i.Ud)())), I++;
            break;
          case 45:
            45 === C && 2 == (0, r.to)(D) && (M = 0)
        }
...
function s(e, t, n, a, s, u, l, c, d, p, f) {
  for (var h = s - 1, v = 0 === s ? u : [""], m = (0, r.Ei)(v), g = 0, b = 0, y = 0; g < a; ++g)
    for (var O = 0, x = (0, r.tb)(e, h + 1, h = (0, r.Wn)(b = l[g])), w = e; O < m; ++O)(w = (0, r.fy)(b > 0 ? v[O] + " " + x : (0, r.gx)(x, /&\f/g, v[O]))) && (d[y++] = w);
