...
function a(e) {
  return (0, i.cE)(function e(t, n, a, l, c, d, p, f, h) {
    for (var v, m, g, b = 0, y = 0, O = p, w = 0, x = 0, Z = 0, C = 1, S = 1, M = 1, I = 0, E = "", k = c, V = d, R = l, P = E; S;) switch (Z = I, I = (0, i.lp)()) {
      case 40:
        ...
        switch (I) {
          ...
          default:
            if ((0, r.R3)(R = s(P, n, a, b, y, c, f, E, k = [], V = [], O), d), 123 === I)
              ...
              else switch (99 === w && 110 === (0, r.uO)(P, 3) ? 100 : w) {
                case 100:
                case 108:
                case 109:
                case 115:
...
function s(e, t, n, a, s, u, l, c, d, p, f) {
  for (var h = s - 1, v = 0 === s ? u : [""], m = (0, r.Ei)(v), g = 0, b = 0, y = 0; g < a; ++g)
    for (var O = 0, w = (0, r.tb)(e, h + 1, h = (0, r.Wn)(b = l[g])), x = e; O < m; ++O)(x = (0, r.fy)(b > 0 ? v[O] + " " + w : (0, r.gx)(w, /&\f/g, v[O]))) && (d[y++] = x);
