...
function Y(e) {
  return null == e.version && 1 === b.OVERLAY_VERSION || e.version === b.OVERLAY_VERSION || (s.Z.dispatch({
...
function ev() {
  ey(), (0, c.Ty)(eO, (0, b.getRPCAuthToken)()), (0, c.$j)(), (0, c.lW)({
    type: v.BmY.CONNECT,
    pid: (0, b.getPID)(),
    token: (0, b.getRPCAuthToken)()
  })
...
class eS extends(i = a.ZP.PersistedStore) {
  initialize(e) {
    ...
    if (null != e) {
      ...
      null != t && (null == (V = F(t)).textChatNotifications && (V.textChatNotifications = R.textChatNotifications), null == V.textWidgetOpacity && (V.textWidgetOpacity = R.textWidgetOpacity), null == V.disableClickableRegions && (V.disableClickableRegions = R.disableClickableRegions))
    }
  }
  getState() {
    return D
...
S(eS, "displayName", "OverlayStore"), S(eS, "persistKey", "OverlayStoreV2"), S(eS, "migrations", [() => {
