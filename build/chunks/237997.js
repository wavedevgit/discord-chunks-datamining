...
function W(e) {
  return null == e.version && 1 === y.OVERLAY_VERSION || e.version === y.OVERLAY_VERSION || (s.Z.dispatch({
  ...
  if ("OVERLAY_INITIALIZE" === e.type && W(e) && (U = !0), U) {
    ...
    switch (e.type) {
      ...
      case "GUILD_CREATE":
        let i = e => (0, _.kt)(e),
          o = e.guild;
        switch (o.threads = null == (n = o.threads) ? void 0 : n.map(i), o.channels.op) {
          case "full_sync":
            o.channels.items = o.channels.items.map(i);
            break;
          case "update":
            o.channels.writes = o.channels.writes.map(i);
            break;
          default:
            o.channels
        }
...
function eE(e) {
  let {
    shouldShow: t
  } = e, n = V.showGameInviteNotification !== t;
...
function eI() {
  eO(), (0, c.Ty)(ev, (0, y.getRPCAuthToken)()), (0, c.$j)(), (0, c.lW)({
    type: I.BmY.CONNECT,
    pid: (0, y.getPID)(),
    token: (0, y.getRPCAuthToken)()
  })
...
class eC extends(i = o.ZP.PersistedStore) {
  initialize(e) {
    if (this.waitFor(p.default), this.syncWith([p.default], () => {
      ...
      if (b.isPlatformEmbedded) {
        let e = (0, O.M)();
        null == e && Z.error("Overlay module failed loaded"), r = e
      }
      M.delete((0, y.getPID)())
    }
    if (null != e) {
      ...
      null != t && (null == (V = F(t)).textChatNotifications && (V.textChatNotifications = w.textChatNotifications), null == V.textWidgetOpacity && (V.textWidgetOpacity = w.textWidgetOpacity), null == V.disableClickableRegions && (V.disableClickableRegions = w.disableClickableRegions))
    }
  }
  getState() {
    return L
...
S(eC, "displayName", "OverlayStore"), S(eC, "persistKey", "OverlayStoreV2"), S(eC, "migrations", [() => {
