...
class eT extends(i = a.ZP.PersistedStore) {
  initialize(e) {
    if (this.waitFor(f.default), this.syncWith([f.default], () => {
...
T(eT, "displayName", "OverlayStore"), T(eT, "persistKey", "OverlayStoreV2"), T(eT, "migrations", [() => {
  let e = S({}, o.K.get("OverlayStore")),
    {
      pinnedWidgets: t,
      positions: n,
      sizes: r,
