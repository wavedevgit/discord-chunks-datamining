...
function W(e) {
  return null == e.version && 1 === v.OVERLAY_VERSION || e.version === v.OVERLAY_VERSION || (s.Z.dispatch({
...
function eI() {
  ey(), (0, c.Ty)(eO, (0, v.getRPCAuthToken)()), (0, c.$j)(), (0, c.lW)({
    type: O.BmY.CONNECT,
    pid: (0, v.getPID)(),
    token: (0, v.getRPCAuthToken)()
  })
