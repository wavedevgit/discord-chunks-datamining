...
function U(t) {
  let {
    ...
    state: "LINK"
  }), [S, k] = a.useState(false), I = (0, l.e7)([h.Z], () => h.Z.getApplication(n.applicationId)), {
    analyticsLocations: E
  } = (0, g.ZP)(null != m ? m : [], p.Z.SOCIAL_LAYER_GIFT_CODE_CLAIM_MODAL);
  a.useEffect(() => {
    o.redeemed && "LINK" === C.state && j({
      state: "ERROR",
  ...
  let v = a.useCallback(async () => {
    ...
    T.default.track(P.rMx.SLAYER_STOREFRONT_GIFT_CODE_CLAIM_CLICKED, {
      ...
      application_id: null == I ? true : I.id,
      gift_code: o.code,
      gift_style: null != (e = null == (t = o.giftStyle) ? true : t.toString()) ? e : null,
    ...
    try {
      k(true), await _.Z.redeemGiftCode({
        code: o.code,
        options: {
          channelId: c
        }
...
let F = t => {
  let {
    ...
    onClose: n,
    error: a
  } = t, s = I.default.getCurrentUser(), o = (0, v.QW)(a, s), l = (0, x.ZP)(), r = (0, u.wj)(l);
...
function w(t) {
  ...
  return (0, i.jsx)(b.M, {
    ...
    bodyText: Z.intl.formatToPlainString(Z.t.PaYE38, {
...
function W(t) {
  let {
    ...
    emojiName: x,
    soundId: m
  } = t, p = (0, A.a)(r), g = (0, R.I)(r), [C, h] = a.useState(null), j = (0, l.e7)([I.default], () => I.default.getUser(u.userId)), S = N.ZP.getName(j), k = a.useRef({
    analyticsLocations: f,
    skuId: s.id,
    applicationId: r.id,
    isLaunchable: p,
  ...
  if (a.useEffect(() => {
    ...
    }, [p, g]), null == p) return (0, i.jsx)(c.IX, {
    transitionState: e,
    onClose: n,
    children: (0, i.jsx)(c.fef, {
      children: (0, i.jsx)(d.$jN, {})
  ...
  return (0, i.jsxs)(c.IX, {
    ...
    children: [(0, i.jsx)("div", {
      ...
      sku: s,
      title: Z.intl.formatToPlainString(Z.t["6yrIzU"], {
        sender: S
      })
    }), (0, i.jsxs)(c.fef, {
      children: [v && (0, i.jsx)(c.xvT, {
        ...
        className: o()({
          [D.giftSentToGameNoticeContainerPadding]: v
        }),
...
let z = t => {
  ...
  X = t => {
    let {
      confettiTarget: e,
      emojiName: n
    } = t, s = (0, l.e7)([m.Z], () => m.Z.useReducedMotion), o = a.useRef(e), [c, r] = a.useState(true), u = a.useCallback(() => {
      r(false)
    }, []);
    if (s || !c) return null;
    let d = null != n ? E.ZP.getURL(n) : true;
    return (0, i.jsx)(j.Z, {
