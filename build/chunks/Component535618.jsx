/** Chunk was on 88742 **/
/** chunk id: 535618, original params: t,n,i (module,exports,require) **/
require.d(exports, {
  default: () => D
}), require("./388685.js");
...
function D(t) {
  let {
    ...
    state: "LINK"
  }), [h, T] = e.useState(false), j = (0, l.e7)([p.Z], () => p.Z.getApplication(i.applicationId)), {
    analyticsLocations: I
  } = (0, g.ZP)(null != u ? u : [], m.Z.SOCIAL_LAYER_GIFT_CODE_CLAIM_MODAL), E = null != d && "" !== d;
  (0, x.ZP)(() => {
    S.default.track(R.rMx.OPEN_MODAL, {
      location_stack: I,
      type: y.tb,
      sku_id: i.id,
      application_id: null == j ? true : j.id
    })
  }), e.useEffect(() => {
  ...
  }, [f.state, o, I, E, d, i.productLine]), e.useEffect(() => {
    o.redeemed && "LINK" === f.state && C({
      state: "ERROR",
  ...
  let L = e.useCallback(async () => {
    ...
    S.default.track(R.rMx.SLAYER_STOREFRONT_GIFT_CODE_CLAIM_CLICKED, {
      ...
      application_id: null == j ? true : j.id,
      gift_code: o.code,
      gift_style: null != (n = null == (t = o.giftStyle) ? true : t.toString()) ? n : null,
      has_custom_message: E,
      is_custom_message_edited: E && d !== A.intl.string(A.t.ZkOo1U),
      emoji_name: null,
      sound_id: null
    ...
    try {
      T(true), await _.Z.redeemGiftCode({
        code: o.code,
        options: {
          channelId: c
        }
  ...
  }, [o, C, c, I, i.id, null == j ? true : j.id, E, d]);
...
let P = t => {
  let {
    ...
    onClose: i,
    error: e
  } = t, s = h.default.getCurrentUser(), o = (0, j.QW)(e, s), l = (0, f.ZP)(), r = (0, d.wj)(l);
...
function G(t) {
  ...
  if (e.useEffect(() => {
      g && S.default.track(R.rMx.SLAYER_STOREFRONT_LINK_ACCOUNT_STEP_VIEWED, {
        location_stack: _,
        sku_id: n.id,
        application_id: i.id,
        is_gift: true,
    ...
    }, [g, n.id, i.id, _, x, f]), !g) return (0, a.jsx)(c.IX, {
    transitionState: s,
    onClose: o,
  ...
  return (0, a.jsx)(N.M, {
    ...
    bodyText: A.intl.formatToPlainString(A.t.PaYE38, {
...
function Z(t) {
  let {
    ...
    customGiftMessage: d,
    analyticsLocations: _
  } = t, x = (0, L.a)(s), f = (0, E.I)(s), m = (0, l.e7)([h.default], () => h.default.getUser(r.userId)), g = I.ZP.getName(m);
  if (null == x) return (0, a.jsx)(c.IX, {
    transitionState: n,
    onClose: i,
    children: (0, a.jsx)(c.fef, {
      children: (0, a.jsx)(u.$jN, {})
  ...
  return (0, a.jsxs)(c.IX, {
    ...
    children: [(0, a.jsx)(v.y, {
      sku: e,
      title: A.intl.formatToPlainString(A.t["6yrIzU"], {
        sender: g
      })
    }), (0, a.jsxs)(c.fef, {
      children: [p && (0, a.jsx)(c.xvT, {
        ...
        className: o()({
          [O.giftSentToGameNoticeContainerPadding]: p
        }),
