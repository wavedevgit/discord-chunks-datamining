...
function m(e) {
  ...
  } = e, y = (0, a.bG)([s.A], () => s.A.useReducedMotion), [h, b] = i.useState([]), A = h.length < 50;
  i.useEffect(() => {
    function e(e) {
      let {
        channelId: r,
      ...
      if (r === t && !y && A && d) {
        ...
        b(e => [...e, d]), c.Ay.trackWithMetadata(f.HAw.VOICE_CHANNEL_EFFECT_VIEWED, {
          channel_id: t,
          guild_id: n
        })
      }
