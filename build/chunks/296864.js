...
function f(e) {
  ...
  let {
    ...
    guild_id: k,
    privacy_level: w
  } = a, I = (0, s.e7)([m.Z], () => m.Z.getChannel(a.channel_id), [a]), Z = (0, s.e7)([x.Z], () => x.Z.getGuild(k), [k]), {
    canManageGuildEvent: S
  } = (0, h.XJ)(null != I ? I : Z), T = S(a), O = (0, s.e7)([d.Z], () => d.Z.isLurking(k), [k]), _ = a.entity_type === C.WX.STAGE_INSTANCE, [P, A] = l.useState(_), [G, {
    loading: L,
    error: X
  }] = (0, g.Z)();
  if (!T) return null;
    ...
    children: (0, i.jsxs)(o.hzk, {
      ...
      children: [(0, i.jsx)("div", {
        ...
        children: N.intl.format(N.t.UMajoq, {
          privacyLevel: R,
          privacyLevelHook: (e, n) => w !== C.j8.PUBLIC ? null : (0, i.jsxs)("div", {
            className: y.privacyLevel,
            children: [(0, i.jsx)(o.enf, {
              size: "xs",
              color: "currentColor",
      ...
      }), null != X && null != X.getAnyErrorMessage() ? (0, i.jsx)(o.Text, {
        color: "text-danger",
        variant: "text-sm/normal",
