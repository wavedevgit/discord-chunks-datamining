...
function y(e) {
  ...
  } = (0, d.XJ)(null != w ? w : I), S = Z(a), T = (0, s.e7)([u.Z], () => u.Z.isLurking(b), [b]), O = a.entity_type === p.WX.STAGE_INSTANCE, [_, P] = l.useState(O), [A, {
    loading: G,
    error: L
  }] = (0, x.Z)();
  if (!S) return null;
    ...
    children: (0, t.jsxs)(c.hzk, {
      ...
      children: [(0, t.jsx)("div", {
        ...
        children: C.intl.format(C.t.UMajoq, {
          privacyLevel: X,
          privacyLevelHook: (e, n) => E !== p.j8.PUBLIC ? null : (0, t.jsxs)("div", {
            className: N.privacyLevel,
