...
function p(e) {
  ...
  if (E ? (F.onPressStart = e => {
      ...
      L || x && "mouse" !== e.pointerType ? ("keyboard" !== e.pointerType || h()) && Z(e) : "keyboard" !== e.pointerType && D && A(e)
    }) : (F.onPressStart = e => {
      j.current = e.pointerType, U.current = k, G.current = L, D && ("mouse" === e.pointerType && !L || "keyboard" === e.pointerType && (!w || m())) && A(e)
    }, F.onPress = e => {
  ...
  return {
    itemProps: (0, s.d)(C, D || L || b && !O ? V : {}, k ? W : {}, {
      onDoubleClick: Y,
