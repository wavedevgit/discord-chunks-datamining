...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk225104 = require("./225104.js"),
  Chunk458034 = require("./458034.js"),
  Chunk856651 = require("./856651.js"),
  Chunk981631 = require("./981631.js"),
  Chunk388032 = require("./388032.js"),
  Chunk268300 = require("./268300.js");
...
function W(e) {
  ...
  return <img src={(0, m.ap)(o) ? a.icon.lightSVG : a.icon.darkSVG} alt={""} className={i()(Y.platformIcon, t)} />
}
...
function X(e) {
  ...
  return <div className={i()(Y.channelName, t)}>{null != o ? <o className={Y.channelNameIcon} /> : null}{<p.X6q variant={"heading-lg/semibold"} color={"text-default"} className={Y.channelNameText}>{n.name}</p.X6q>}</div>
}
...
function Q(e) {
  ...
  return n = l ? "header-secondary" : "text-danger", <p.Text variant={"text-xs/normal"} color={n} className={Y.connectionsCheck}>{s}</p.Text>
}
...
function J(e) {
  ...
  return <c.Fragment>{Object.keys(y).sort((e, n) => {
...
function $(e) {
  ...
  return U.BFP.has(i.type) && (n = <p.j7V className={Y.accountConnectedPrivacyOptionsSwitchItem} hideBorder={true} value={s} onChange={e => {
      d(e), x.Z.setFriendSync(i.type, i.id, e)
    }}><p.Text variant={"text-sm/semibold"}>{D.intl.string(D.t["+KCMSk"])}</p.Text></p.j7V>), U.vbS.has(i.type) && (t = <p.j7V className={Y.accountConnectedPrivacyOptionsSwitchItem} hideBorder={true} value={u} onChange={e => {
      h(e), x.Z.setShowActivity(i.type, i.id, e)
    }}><p.Text variant={"text-sm/semibold"}>{D.intl.format(D.t["6u6J0t"], {
        platform: N.name
      })}</p.Text></p.j7V>), true === N.hasMetadata && (a = <p.j7V className={Y.accountConnectedPrivacyOptionsSwitchItem} hideBorder={true} value={m} disabled={!f} onChange={e => {
      r(e), C(e), x.Z.setMetadataVisibility(i.type, i.id, +!!e)
    }}><p.Text variant={"text-sm/semibold"}>{D.intl.string(D.t.FYKGsL)}</p.Text></p.j7V>), <div className={Y.accountConnectedPrivacyOptionsContainer}>{<p.j7V className={Y.accountConnectedPrivacyOptionsSwitchItem} hideBorder={true} value={f} onChange={e => {
        l(!e), b(e), x.Z.setVisibility(i.type, i.id, +!!e)
      }}><p.Text variant={"text-sm/semibold"}>{D.intl.string(D.t.f7yOAQ)}</p.Text></p.j7V>}{a}{t}{n}</div>
}
...
function ee(e) {
  ...
  return o.useEffect(() => {
  ...
  }, [_, ea.length, eo, a, i.id, t]), <p.Y0X size={p.CgR.MEDIUM} transitionState={n} aria-label={D.intl.string(D.t.zOZh3d)} className={Y.modalRoot} parentComponent={"GuildRoleConnectionsConnectAccountsModal"}>{function() {
      switch (l) {
        case 0:
    ...
    }()}{<p.qBt step={l} steps={[0, 1, 2]}>{function() {
        switch (l) {
          case 0: {
