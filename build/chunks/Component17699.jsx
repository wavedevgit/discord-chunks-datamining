...
function R(e) {
  ...
  async function C() {
    if (null != l) {
      x(null), h(true);
      try {
        await u.Z.unbanUser(l.id, a.id), g(), _.default.track(I.rMx.GUILD_BAN_REMOVED, Z(w({}, (0, p.hH)(l.id)), {
          target_user_id: a.id,
          reason: s.reason,
          location: v
        }))
...
function L(e) {
  let {
    guildId: t,
    storedSearchQuery: n
  } = e, [l, a] = i.useState(null != n ? n : ""), [s, c] = i.useState(false), d = i.useCallback(() => {
    ...
    if (!s) try {
      ...
      C.Z.setSearchQuery(l), await u.Z.searchGuildBans(t, r, n), c(false)
    } catch (e) {
      c(false)
    }
...
function k() {
  ...
  let {
  ...
  }, []), P = Chunk473749.useCallback((e, t, n) => {
    ...
    return r
  }, [Chunk740903]), R = Chunk473749.useMemo(() => P(Chunk246946, Chunk479531, Chunk626135), [Chunk246946, P, Chunk479531, Chunk626135]), D = null != Chunk246946, k = R.length % 1e3 == 0 && R.length > 0 && D, G = 0 === R.length, [M, U] = Chunk473749.useState({
    currentPage: 1,
    pageSize: 100
  });
