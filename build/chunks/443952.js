...
let G = {
  ...
  [k.Etm.ACCEPT_ACTIVITY_INVITE]: {
    ...
    handler(e) {
      ...
      return n === k.mFx.JOIN && (s = c.Z.join({
        userId: r,
        sessionId: i,
        applicationId: a,
        channelId: l,
  ...
  [k.Etm.OPEN_SHARE_MOMENT_DIALOG]: (0, l.S)(k.Etm.OPEN_SHARE_MOMENT_DIALOG, {
    ...
    handler(e) {
      ...
      if (!(0, C.yE)(null !== (t = n.application.flags) && void 0 !== t ? t : 0, k.udG.EMBEDDED)) throw new A.Z({
        errorCode: k.lTL.INVALID_COMMAND
  ...
  [k.Etm.SHARE_INTERACTION]: (0, l.S)(k.Etm.SHARE_INTERACTION, {
    ...
    handler(e) {
      ...
      if (null == c) throw new A.Z({
        errorCode: k.lTL.INVALID_COMMAND
      }, "No application.");
      if (!M.Cr.includes(c)) throw new A.Z({
        errorCode: k.lTL.INVALID_COMMAND
      }, "Unsupported application.");
      if (!(0, C.yE)(null !== (t = r.application.flags) && void 0 !== t ? t : 0, k.udG.EMBEDDED)) throw new A.Z({
        errorCode: k.lTL.INVALID_COMMAND
      }, "This application cannot access this API");
      let u = (0, L.Z)();
