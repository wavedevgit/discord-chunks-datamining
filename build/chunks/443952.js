...
let H = {
  ...
  [G.Etm.INITIATE_IMAGE_UPLOAD]: (0, a.S)(G.Etm.INITIATE_IMAGE_UPLOAD, {
    ...
    handler(e) {
      ...
      if (null == r) throw new L.Z({
        errorCode: G.lTL.INVALID_COMMAND
      }, "No application.");
      let l = null == (t = (0, D.Z)()) ? void 0 : t.id;
      if (null == l) throw new L.Z({
      ...
      return new Promise((e, t) => {
        ! function(e, t) {
          ...
          if ((0, f.R)({
            ...
            })) n = y.Z.getWindow(G.KJ3.ACTIVITY_POPOUT);
          else {
            var l;
  ...
  [G.Etm.OPEN_SHARE_MOMENT_DIALOG]: (0, a.S)(G.Etm.OPEN_SHARE_MOMENT_DIALOG, {
    ...
    handler(e) {
      ...
      if (!(0, P.yE)(null != (t = n.application.flags) ? t : 0, G.udG.EMBEDDED)) throw new L.Z({
        errorCode: G.lTL.INVALID_COMMAND
      ...
      if (!Z.Z.isDiscordCdnUrl(r)) throw new L.Z({
  ...
  [G.Etm.SHARE_INTERACTION]: (0, a.S)(G.Etm.SHARE_INTERACTION, {
    ...
    handler(e) {
      ...
      if (!V.Cr.includes(d)) throw new L.Z({
        errorCode: G.lTL.INVALID_COMMAND
      }, "Unsupported application.");
      if (!(0, P.yE)(null != (t = r.application.flags) ? t : 0, G.udG.EMBEDDED)) throw new L.Z({
        errorCode: G.lTL.INVALID_COMMAND
      }, "This application cannot access this API");
      let p = (0, D.Z)();
      if (null == p && s) throw new L.Z({
        errorCode: G.lTL.INVALID_COMMAND
      }, "No channel found");
      ...
      return new Promise(e => {
        let t = !1,
          r = (0, M.jU)(u),
          l = o.z1l;
        (y.Z.getWindowOpen(G.KJ3.ACTIVITY_POPOUT) || r.context === G.IlC.POPOUT) && (l = o.u1M), (0, O.M)({
          applicationId: d,
          channel: p,
          command: i,
