...
function s(e) {
  ...
  let {
    quest: n,
    onClose: s
  } = e, c = (0, l.km)(e => e.transcript), u = (null == c ? true : c.questId) === n.id && (null == c ? true : c.fetchStatus) === l.iF.SUCCESS && null != (t = c.text) ? t : "", d = o.useMemo(() => u.split("\n").map(e => e.trim()).filter(e => e.length > 0), [u]);
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: (0, r.jsx)(a.w0Z, {
        ...
        children: (0, r.jsx)("div", {
          ...
          children: (null == c ? true : c.fetchStatus) === l.iF.FETCHING ? (0, r.jsx)("div", {
