/** Chunk was on web.js **/
/** chunk id: 685578, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  BU: () => tz,
  CX: () => tP,
...
var Chunk653603 = require("./653603.js"),
  ...
  Chunk889678 = require("./889678.js"),
  a = require.n(Chunk889678),
  Chunk123763 = require("./123763.js"),
  l = require.n(Chunk123763),
  Chunk473749 = require("./473749.js"),
  Chunk367989 = require("./367989.js"),
  Chunk327432 = require("./327432.js"),
  Chunk690096 = require("./690096.js"),
  Chunk247187 = require("./247187.js"),
...
var y = new WeakMap,
  ...
  J = e => {
    for (var t = e && e.parentNode; t;) {
      if ("[object ShadowRoot]" === t.toString()) returntrue;
      t = t.parentNode
    }
    returnfalse
  },
  $ = (e, t, n) => {
    for (var {
      ...
      (Y(i) || W(i) && 0 === i.childNodes.length || W(i) && "false" === i.getAttribute("contenteditable")) && (!a || !s);) {
      if (o >= r.length) {
  ...
  ei = (e, t, n) => {
    ...
    if (i.contains(r)) return ey.hasDOMNode(e, r, {
      editable: true
    });
    var o = n.find(e => {
      var {
      ...
      for (var i of t)
        if (i === r || i.contains(r)) returntrue;
      for (var o of n)
        if (o === r || o.contains(r)) returntrue
    });
    return !!o && o !== t && ei(e, o, n)
  },
  eo = parseInt(Chunk473749.version.split(".")[0], 10) >= 17,
  ...
  eE = "undefined" != typeof window && true !== window.document && true !== window.document.createElement,
  eb = (!ep || !e_) && !ed && "undefined" != typeof globalThis && globalThis.InputEvent && "function" == typeof globalThis.InputEvent.prototype.getTargetRanges,
  ey = {
    ...
    blur(e) {
      ...
      R.set(e, false), n.activeElement === t && t.blur()
    },
    focus(e) {
      var t = ey.toDOMNode(e, e),
        n = ey.findDocumentOrShadowRoot(e);
      R.set(e, true), n.activeElement !== t && t.focus({
        preventScroll: true
      })
    },
    deselect(e) {
      var {
        selection: t
      } = e, n = ey.findDocumentOrShadowRoot(e).getSelection();
      n && n.rangeCount > 0 && n.removeAllRanges(), t && d.YR.deselect(e)
    },
    hasDOMNode(e, t) {
      var n, r = arguments.length > 2 && true !== arguments[2] ? arguments[2] : {},
        {
          editable: i = false
        } = r,
        o = ey.toDOMNode(e, e);
    ...
    toDOMNode(e, t) {
      var n = N.get(e),
        r = d.ML.isEditor(t) ? S.get(e) : null == n ? true : n.get(ey.findKey(e, t));
      if (!r) throw Error("Cannot resolve a DOM node from Slate node: ".concat(d.o4.stringify(t)));
      return r
    },
    toDOMPoint(e, t) {
      var [n] = d.ML.node(e, t.path), r = ey.toDOMNode(e, n);
      d.ML.void(e, {
        at: t
      }) && (t = {
        path: t.path,
      ...
      for (var i = "[data-slate-string], [data-slate-zero-width]", o = Array.from(r.querySelectorAll(i)), a = 0, s = 0; s < o.length; s++) {
        ...
        if (null != c && null != c.textContent) {
          var {
            length: u
          } = c.textContent, f = l.getAttribute("data-slate-length"), p = null == f ? u : parseInt(f, 10), _ = a + p, m = o[s + 1];
          if (t.offset === _ && null != m && m.hasAttribute("data-slate-mark-placeholder")) {
            var h, g, E = m.childNodes[0];
    ...
    toDOMRange(e, t) {
      var {
        anchor: n,
        focus: r
      } = t, i = d.e6.isBackward(t), o = ey.toDOMPoint(e, n), a = d.e6.isCollapsed(t) ? o : ey.toDOMPoint(e, r), s = ey.getWindow(e).document.createRange(), [l, c] = i ? a : o, [u, f] = i ? o : a, p = !!(W(l) ? l : l.parentElement).getAttribute("data-slate-zero-width"), _ = !!(W(u) ? u : u.parentElement).getAttribute("data-slate-zero-width");
    ...
    toSlatePoint(e, t, n) {
      ...
      if (s) {
        ...
        if (h) {
          ...
          h ? (l = h.closest('[data-slate-node="text"]'), c = (g = h).textContent.length, g.querySelectorAll("[data-slate-zero-width]").forEach(e => {
          ...
          var I = ey.toSlateNode(e, S),
            {
              path: T,
              offset: C
            } = d.ML.start(e, ey.findPath(e, I));
          return S.querySelector("[data-slate-leaf]") || (C = a), {
            path: T,
            offset: C
          }
        }
    ...
    toSlateRange(e, t, n) {
      ...
      "getAttribute" in o && "false" === o.getAttribute("contenteditable") && (o = r, a = (null == (l = r.textContent) ? true : l.length) || 0);
      var f = ey.toSlatePoint(e, [r, i], {
        exactMatch: c,
        suppressThrow: u
      });
      if (!f) return null;
      var p = s ? f : ey.toSlatePoint(e, [o, a], {
        exactMatch: c,
        suppressThrow: u
      });
      if (!p) return null;
      ...
      return d.e6.isExpanded(h) && d.e6.isForward(h) && W(o) && d.ML.void(e, {
        at: h.focus,
        mode: "highest"
      }) && (h = d.ML.unhangRange(e, h, {
        voids: true
      })), h
    },
    hasRange(e, t) {
  ...
  eT = (e, t) => {
    ...
    for (var n = 0; n < e.length; n++) {
      var r = e[n],
        i = t[n];
      if (!d.e6.equals(r, i) || !eI(r, i)) returnfalse
    }
    returntrue
  },
  eC = (e, t) => {
    ...
    for (var n = 0; n < e.length; n++) {
      var r = e[n],
        i = t[n];
      if (r.anchor.offset !== i.anchor.offset || r.focus.offset !== i.focus.offset || !eI(r, i)) returnfalse
    }
    returntrue
  },
  eA = eE ? Chunk473749.useLayoutEffect : Chunk473749.useEffect,
  eN = e => {
    var {
      isLast: t,
      leaf: n,
      parent: r,
      text: i
    } = e, o = ex(), a = ey.findPath(o, i), s = d.y$.parent(a), l = true === n[B];
    return o.isVoid(r) ? c.createElement(ew, {
      ...
      isMarkPlaceholder: l
    }) : t && "\n" === n.text.slice(false) ? c.createElement(eP, {
      isTrailing: true,
      text: n.text
    }) : c.createElement(eP, {
      text: n.text
  ...
  eR = (0, Chunk473749.memo)((0, Chunk473749.forwardRef)((e, t) => c.createElement("span", {
  ...
  ew = e => {
    var {
      length: t = 0,
      isLineBreak: n = false,
      isMarkPlaceholder: r = false
    } = e, i = {
      "data-slate-zero-width": n ? "n" : "z",
      "data-slate-length": t
    };
    return r && (i["data-slate-mark-placeholder"] = true), c.createElement("span", Object.assign({}, i), el && n ? null : "\uFEFF", n ? c.createElement("br", null) : null)
  },
  ...
  eL = e => {
    ...
    } = e, s = (0, c.useRef)(null), l = (0, c.useRef)(null), u = ex(), d = (0, c.useRef)(null);
    (0, c.useEffect)(() => () => {
      d.current && d.current.disconnect()
    }, []), (0, c.useEffect)(() => {
      var e = null == l ? true : l.current;
      if (e ? I.set(u, e) : I.delete(u), d.current ? (d.current.disconnect(), e && d.current.observe(e)) : e && (d.current = new(window.ResizeObserver || f.do)(() => {
          var e = Z.get(u);
          null == e || e()
    ...
    if (t[F]) {
      ...
      p = c.createElement(c.Fragment, null, o(_), p)
    }
    return a({
      attributes: {
  ...
  ej = Chunk473749.memo(eL, (e, t) => t.parent === e.parent && t.isLast === e.isLast && t.renderLeaf === e.renderLeaf && t.renderPlaceholder === e.renderPlaceholder && t.text === e.text && d.xv.equals(t.leaf, e.leaf) && t.leaf[F] === e.leaf[F]),
  eM = e => {
    var {
      attributes: t,
      children: n
  ...
  ek = e => {
    for (var {
        ...
        renderLeaf: o,
        text: a
      } = e, s = ex(), l = (0, c.useRef)(null), u = d.xv.decorations(a, t), f = ey.findKey(s, a), p = [], _ = 0; _ < u.length; _++) {
      var m = u[_];
    ...
    var h = (0, c.useCallback)(e => {
      var t = N.get(s);
      e ? (null == t || t.set(f, e), C.set(a, e), T.set(e, a)) : (null == t || t.delete(f), C.delete(a), l.current && T.delete(l.current)), l.current = e
    }, [l, s, f, a]);
  ...
  eU = Chunk473749.memo(ek, (e, t) => t.parent === e.parent && t.isLast === e.isLast && t.renderLeaf === e.renderLeaf && t.renderPlaceholder === e.renderPlaceholder && t.text === e.text && eC(t.decorations, e.decorations)),
  eG = e => {
    var {
      decorations: t,
      element: n,
      ...
      renderLeaf: a,
      selection: s
    } = e, l = ex(), u = ez(), f = l.isInline(n), p = ey.findKey(l, n), _ = (0, c.useCallback)(e => {
      var t = N.get(l);
    ...
    if (f && (h["data-slate-inline"] = true), !f && d.ML.hasInlines(l, n)) {
      var g = d.NB.string(n),
        E = i()(g);
      "rtl" === E && (h.dir = E)
    }
    if (d.ML.isVoid(l, n)) {
      h["data-slate-void"] = true, !u && f && (h.contentEditable = false);
      var b = f ? "span" : "div",
        [
          [v]
        ] = d.NB.texts(n);
  ...
  eZ = Chunk473749.memo(eG, (e, t) => e.element === t.element && e.renderElement === t.renderElement && e.renderLeaf === t.renderLeaf && e.renderPlaceholder === t.renderPlaceholder && eT(e.decorations, t.decorations) && (e.selection === t.selection || !!e.selection && !!t.selection && d.e6.equals(e.selection, t.selection))),
  eF = e => {
    var {
      attributes: t,
      children: n,
  ...
  eW = e => {
    for (var {
        ...
        renderLeaf: o,
        selection: a
      } = e, s = eV(), l = ex(), u = ey.findPath(l, n), f = [], p = d.W_.isElement(n) && !l.isInline(n) && d.ML.hasInlines(l, n), _ = 0; _ < n.children.length; _++) {
      var m = u.concat(_),
        h = n.children[_],
        g = ey.findKey(l, h),
        E = d.ML.range(l, m),
      ...
      d.W_.isElement(h) ? f.push(c.createElement(eH.Provider, {
...
class e5 extends Chunk473749.Component {
  constructor() {
...
function tu(e) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2 ? tc(Object(n), true).forEach(function(t) {
      m(e, t, n[t])
...
var td = 25,
  tf = 200,
  tp = function() {},
  t_ = e => (null == e ? true : e.constructor.name) === "DataTransfer";
...
function tm(e) {
  var {
  ...
  } = e, i = false, o = null, a = null, s = null, l = 0, c = false, u = () => {
    var e = G.get(t);
    if (G.delete(t), e) {
      var {
        selection: n
    ...
    i || (i = true, setTimeout(() => i = false)), b() && (i = "action");
    var e = t.selection && d.ML.rangeRef(t, t.selection, {
      affinity: "forward"
    });
    M.set(t, t.marks), tp("flush", U.get(t), k.get(t));
    for (var o = y(); l = null == (p = k.get(t)) ? true : p[0];) {
      var l, p, _, m = j.get(t);
      true !== m && (j.delete(t), t.marks = m), m && false === c && (c = null);
      var h = tr(l);
      t.selection && d.e6.equals(t.selection, h) || d.YR.select(t, h), l.diff.text ? d.ML.insertText(t, l.diff.text) : d.ML.deleteFragment(t), k.set(t, null == (_ = k.get(t)) ? true : _.filter(e => {
        var {
          id: t
        } = e;
        return t !== l.id
      })), e6(t, l) || (o = false, U.delete(t), M.delete(t), i = "action", G.delete(t), n.cancel(), r.cancel(), null == e || e.unref())
    }
    ...
    var E = M.get(t);
    M.delete(t), true !== E && (t.marks = E, t.onChange())
  }, _ = e => {
    ...
    c = false, G.delete(t), n.cancel(), r.cancel(), b() && p(), U.set(t, {
      at: i,
      run: e
    }), s = setTimeout(p)
  }, E = e => {
    ...
    var {
      inputType: n
    } = e, r = null, i = e.dataTransfer || e.data || true;
    false !== c && "insertText" !== n && "insertCompositionText" !== n && (c = false);
    var [o] = e.getTargetRanges();
    o && (r = ey.toSlateRange(t, o, {
      exactMatch: false,
      suppressThrow: true
    }));
    var s = ey.getWindow(t).getSelection();
    if (!r && s && (o = s, r = ey.toSlateRange(t, s, {
        exactMatch: false,
        suppressThrow: true
      ...
      if (n.startsWith("delete")) {
        ...
        var _ = n.endsWith("Backward") ? "backward" : "forward",
          ...
          S = k.get(t),
          I = null == S ? true : S.find(e => d.y$.equals(e.path, y)),
          T = I ? [I.diff, O] : [O];
        if (0 === e7(b.text, ...T).length && (l = false), d.e6.isExpanded(r)) {
          if (l && d.y$.equals(r.anchor.path, r.focus.path)) {
            ...
            return v(d.ML.range(t, A, A)), h(r.anchor.path, {
              text: "",
              end: E.offset,
              start: m.offset
            })
      ...
      switch (n) {
        ...
        case "deleteContentForward":
          ...
          if (l && d.e6.isCollapsed(r)) {
            ...
            if (N.offset < P.text.length) return h(N.path, {
              text: "",
              start: N.offset,
              end: N.offset + 1
            })
        ...
        case "deleteContentBackward":
          var R, w, {
            ...
            x = z(o) ? o.isCollapsed : !!(null != (w = o) && w.collapsed);
          if (l && x && d.e6.isCollapsed(r) && D.offset > 0) return h(D.path, {
            text: "",
            start: D.offset - 1,
            end: D.offset
          });
        ...
        case "insertText":
          if (t_(i)) return g(() => ey.insertData(t, i), {
            at: r
          });
          var L = null != i ? i : "";
          if (j.get(t) && (L = L.replace("\uFEFF", "")), "insertText" === n && /.*\n.*\n$/.test(L) && (L = L.slice(0, false)), L.includes("\n")) return g(() => {
            var e = L.split("\n");
            e.forEach((n, r) => {
          ...
          if (d.y$.equals(r.anchor.path, r.focus.path)) {
            ...
            if (L && c && "insertCompositionText" === n) {
              ...
              G.start + G.text.search(/\S|$/) === Z + 1 && G.end === c.start + c.text.length ? (G.start -= 1, c = null, C()) : c = false
            } else c = "insertText" === n && (null === c ? G : !!(c && d.e6.isCollapsed(r)) && c.end + c.text.length === M.offset && tu(tu({}, c), {}, {
              text: c.text + L
            }));
    ...
    if (e) {
      var r = !n || !d.y$.equals(n.anchor.path, e.anchor.path),
        i = !n || !d.y$.equals(n.anchor.path.slice(0, false), e.anchor.path.slice(0, false));
      (r && c || i) && (c = false), (r || y()) && (a = setTimeout(p, tf))
    }
  }, S = () => {
    (b() || !y()) && p()
  }, T = e => {
    y() || (m(true), setTimeout(m))
  }, C = () => {
    b() || (s = setTimeout(p))
  }, A = e => {
  ...
  return {
    ...
    handleCompositionStart: e => {
      w.set(t, true), o && (clearTimeout(o), o = null)
    },
...
function ty(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = null != arguments[t] ? arguments[t] : {};
    t % 2 ? tb(Object(n), true).forEach(function(t) {
      m(e, t, n[t])
...
function tv(e) {
  ...
  var r = ex(),
    i = th(),
    [o] = (0, c.useState)(() => tm(ty({
      editor: r
    }, n)));
  return tg(t, o.handleDomMutations, tO), L.set(r, o.scheduleFlush), i && o.flush(), o
}
...
var tN = e => c.createElement(c.Fragment, null, eW(e)),
  tP = e => {
    ...
    var q = (0, c.useCallback)(l()(() => {
        if ((el || !ey.isComposing(N)) && (!z.isUpdatingSelection || null != J && J.isFlushing()) && !z.isDraggingInternally) {
          var e = ey.findDocumentOrShadowRoot(N),
            ...
            n = ey.toDOMNode(N, N),
            r = e.getSelection();
          if (t === n ? (z.latestElement = t, R.set(N, true)) : R.delete(N), !r) return d.YR.deselect(N);
          var {
            anchorNode: i,
            focusNode: o
          } = r, a = ey.hasEditableTarget(N, i) || ey.isTargetInsideNonReadonlyVoid(N, i), s = ey.hasEditableTarget(N, o) || ey.isTargetInsideNonReadonlyVoid(N, o);
          if (a && s) {
            var l = ey.toSlateRange(N, r, {
              exactMatch: false,
              suppressThrow: true
            });
            l && (ey.isComposing(N) || null != J && J.hasPendingChanges() || null != J && J.isFlushing() ? null == J || J.handleUserSelect(l) : d.YR.select(N, l))
          }!p || a && s || d.YR.deselect(N)
        }
      }, 100), [p]),
    ...
    eA(() => {
      k.current && (e = H(k.current)) ? (v.set(N, e), S.set(N, k.current), C.set(N, k.current), T.set(k.current, N)) : C.delete(N);
      var e, {
          selection: t
        } = N,
      ...
      if (!(!n || !ey.isFocused(N) || null != J && J.hasPendingAction())) {
        var r = e => {
            ...
            if (t || r) {
              var i = S.get(N),
                o = false;
              if (i.contains(n.anchorNode) && i.contains(n.focusNode) && (o = true), r && o && t && !e) {
                var a = ey.toSlateRange(N, n, {
                  exactMatch: true,
                  suppressThrow: true
                });
              ...
              z.isUpdatingSelection = true;
              var c = t && ey.toDOMRange(N, t);
              return c ? (d.e6.isBackward(t) ? n.setBaseAndExtent(c.endContainer, c.endOffset, c.startContainer, c.startOffset) : n.setBaseAndExtent(c.startContainer, c.startOffset, c.endContainer, c.endOffset), E(N, c)) : n.removeAllRanges(), c
            }
          },
          i = r(),
          o = (null == J ? true : J.isFlushing()) === "action";
        if (!el || !o) return void setTimeout(() => {
          i && ec && ey.toDOMNode(N, N).focus(), z.isUpdatingSelection = false
        });
        var a = null,
          s = requestAnimationFrame(() => {
            if (o) {
              ...
              e(), a = setTimeout(() => {
                e(true), z.isUpdatingSelection = false
              })
            }
          });
        return () => {
    ...
    var $ = (0, c.useCallback)(e => {
        if (G(), !p && ey.hasEditableTarget(N, e.target) && !tL(e, u)) {
          ...
          var {
            ...
            inputType: n
          } = e, r = e.dataTransfer || e.data || true, i = "insertCompositionText" === n || "deleteCompositionText" === n;
          if (!(i && ey.isComposing(N))) {
            var o = false;
            if ("insertText" === n && t && d.e6.isCollapsed(t) && e.data && 1 === e.data.length && /[a-z ]/i.test(e.data) && 0 !== t.anchor.offset) {
              o = true, N.marks && (o = false);
              var {
                anchor: a
              } = t, [s, l] = ey.toDOMPoint(N, a), c = null == (m = s.parentElement) ? true : m.closest("a"), f = ey.getWindow(N);
              if (o && c && ey.hasDOMNode(N, c)) {
                var _, m, h, g, E = null == f ? true : f.document.createTreeWalker(c, NodeFilter.SHOW_TEXT).lastChild();
                E === s && (null == (g = E.textContent) ? true : g.length) === l && (o = false)
              }
              if (o && s.parentElement && (null == f || null == (h = f.getComputedStyle(s.parentElement)) ? true : h.whiteSpace) === "pre") {
                var b = d.ML.above(N, {
                  at: a.path,
                  match: e => d.W_.isElement(e) && d.ML.isBlock(N, e)
                });
                b && d.NB.string(b[0]).includes("	") && (o = false)
              }
            }
            ...
            if (!i) {
              ...
              switch (n) {
                ...
                case "insertReplacementText":
                case "insertText":
                  "insertFromComposition" === n && ey.isComposing(N) && (L(false), w.set(N, false)), (null == r ? true : r.constructor.name) === "DataTransfer" ? ey.insertData(N, r) : "string" == typeof r && (o ? U.current.push(() => d.ML.insertText(N, r)) : d.ML.insertText(N, r))
              }
              var I = null == (_ = D.get(N)) ? true : _.unref();
      ...
      ee = (0, c.useCallback)(e => {
        null == e ? (q.cancel(), X.cancel(), S.delete(N), C.delete(N), k.current && eb && k.current.removeEventListener("beforeinput", $)) : eb && e.addEventListener("beforeinput", $), k.current = e
      }, [k, $, q, X]);
    eA(() => {
    ...
    if (z.hasMarkPlaceholder = false, N.selection && d.e6.isCollapsed(N.selection) && er) {
      var {
        anchor: ei
      } = N.selection, eo = d.NB.leaf(N, ei.path), es = g(eo, tT);
    ...
    var ep = null == (t = I.get(N)) || null == (n = t.getBoundingClientRect()) ? true : n.height;
    return c.createElement(eK.Provider, {
      ...
      onBeforeInput: (0, c.useCallback)(e => {
        if (!eb && !p && !tx(e, A.onBeforeInput) && ey.hasSelectableTarget(N, e.target) && (e.preventDefault(), !ey.isComposing(N))) {
          var t = e.data;
          d.ML.insertText(N, t)
        }
      }, [p]),
      ...
      onBlur: (0, c.useCallback)(e => {
        if (p || z.isUpdatingSelection || !ey.hasSelectableTarget(N, e.target) || tx(e, A.onBlur)) return;
          ...
          if (d.ML.hasPath(N, n) && d.NB.get(N, n) === t) {
            if (e.detail === eX && n.length >= 1) {
              ...
              if (!(d.W_.isElement(t) && d.ML.isBlock(N, t))) {
                var i, o = d.ML.above(N, {
                  match: e => d.W_.isElement(e) && d.ML.isBlock(N, e),
                  at: n
                });
                r = null != (i = null == o ? true : o[1]) ? i : n.slice(0, 1)
              }
              var a = d.ML.range(N, r);
              d.YR.select(N, a);
              return
            }
            if (!p) {
      ...
      onCompositionEnd: (0, c.useCallback)(e => {
        if (ey.hasSelectableTarget(N, e.target) && (ey.isComposing(N) && (L(false), w.set(N, false)), null == J || J.handleCompositionEnd(e), !tx(e, A.onCompositionEnd) && !el && !eu && !em && !ea && !eg && !eh) && e.data) {
          var t = j.get(N);
          j.delete(N), true !== t && (M.set(N, N.marks), N.marks = t), d.ML.insertText(N, e.data);
          var n = M.get(N);
          M.delete(N), true !== n && (N.marks = n)
        }
      }, [A.onCompositionEnd]),
      onCompositionUpdate: (0, c.useCallback)(e => {
        !ey.hasSelectableTarget(N, e.target) || tx(e, A.onCompositionUpdate) || ey.isComposing(N) || (L(true), w.set(N, true))
      }, [A.onCompositionUpdate]),
      onCompositionStart: (0, c.useCallback)(e => {
        if (ey.hasSelectableTarget(N, e.target) && (null == J || J.handleCompositionStart(e), !tx(e, A.onCompositionStart) && !el)) {
          L(true);
          var {
            selection: t
          } = N;
      ...
      onCopy: (0, c.useCallback)(e => {
        ey.hasSelectableTarget(N, e.target) && !tx(e, A.onCopy) && (e.preventDefault(), ey.setFragmentData(N, e.clipboardData, "copy"))
      }, [A.onCopy]),
      ...
      onDragStart: (0, c.useCallback)(e => {
        if (!p && ey.hasTarget(N, e.target) && !tx(e, A.onDragStart)) {
          var t = ey.toSlateNode(N, e.target),
            n = ey.findPath(N, t);
          if (d.W_.isElement(t) && d.ML.isVoid(N, t) || d.ML.void(N, {
              at: n,
              voids: true
            })) {
          ...
          z.isDraggingInternally = true, ey.setFragmentData(N, e.dataTransfer, "drag")
        }
      }, [p, A.onDragStart]),
      onDrop: (0, c.useCallback)(e => {
        if (!p && ey.hasTarget(N, e.target) && !tx(e, A.onDrop)) {
          ...
          var t = N.selection,
            ...
            r = e.dataTransfer;
          d.YR.select(N, n), z.isDraggingInternally && t && !d.e6.equals(t, n) && !d.ML.void(N, {
            at: n,
            voids: true
          }) && d.YR.delete(N, {
            at: t
          }), ey.insertData(N, r), ey.isFocused(N) || ey.focus(N)
        }
        z.isDraggingInternally = false
      }, [p, A.onDrop]),
      onDragEnd: (0, c.useCallback)(e => {
        !p && z.isDraggingInternally && A.onDragEnd && ey.hasTarget(N, e.target) && A.onDragEnd(e), z.isDraggingInternally = false
      }, [p, A.onDragEnd]),
      onFocus: (0, c.useCallback)(e => {
        if (!p && !z.isUpdatingSelection && ey.hasEditableTarget(N, e.target) && !tx(e, A.onFocus)) {
          var t = ey.toDOMNode(N, N);
          if (z.latestElement = ey.findDocumentOrShadowRoot(N).activeElement, ec && e.target !== t) return void t.focus();
          R.set(N, true)
        }
      }, [p, A.onFocus]),
      onKeyDown: (0, c.useCallback)(e => {
        if (!p && ey.hasEditableTarget(N, e.target)) {
          ...
          if (ey.isComposing(N) && false === t.isComposing && (w.set(N, false), L(false)), !(tx(e, A.onKeyDown) || ey.isComposing(N))) {
            var {
              selection: n
            } = N, r = N.children[null !== n ? n.focus.path[0] : 0], o = "rtl" === i()(d.NB.string(r));
            if (e3.isRedo(t)) {
              e.preventDefault();
              var a = N;
      ...
      onPaste: (0, c.useCallback)(e => {
        !p && ey.hasEditableTarget(N, e.target) && !tx(e, A.onPaste) && (!eb || Q(e.nativeEvent) || eu) && (e.preventDefault(), ey.insertData(N, e.clipboardData))
      }, [p, A.onPaste])
    }), c.createElement(tN, {
      decorations: et,
      node: N,
...
var tU = (0, Chunk473749.createContext)({}),
  tG = (e, t) => e === t;
...
var tF = ["editor", "children", "onChange", "value"],
  tB = e => {
    var {
      ...
      onChange: r,
      value: i
    } = e, o = g(e, tF), a = (0, c.useRef)(false), [s, l] = c.useState(() => {
    ...
    return (0, c.useEffect)(() => {
      ...
      }) : (document.addEventListener("focus", e, true), document.addEventListener("blur", e, true), () => {
        document.removeEventListener("focus", e, true), document.removeEventListener("blur", e, true)
      })
...
var tz = function(e) {
    var t = arguments.length > 1 && true !== arguments[1] ? arguments[1] : "x-slate-fragment",
      n = e,
      {
        apply: r,
        onChange: i,
    ...
    return N.set(n, new WeakMap), n.addMark = (e, t) => {
      var r, i;
      null == (r = L.get(n)) || r(), !j.get(n) && null != (i = k.get(n)) && i.length && j.set(n, null), M.delete(n), a(e, t)
    }, n.removeMark = e => {
      var t;
      ...
      if (n.selection && d.e6.isCollapsed(n.selection)) {
        ...
        if (t) {
          var [, r] = t, i = d.ML.range(n, r, n.selection.anchor), a = tY(n, i);
      ...
      var l = U.get(n);
      if (null != l && l.at) {
        var c = d.E9.isPoint(null == l ? true : l.at) ? ta(n, l.at, e) : ts(n, l.at, e);
        U.set(n, c ? tK(tK({}, l), {}, {
          at: c
        }) : null)
      }
      ...
      if (r) {
        ...
        if (!d.e6.isCollapsed(r) || a) {
          ...
          if (c.childNodes.forEach(e => {
            ...
            var [f] = s, p = l.cloneRange(), _ = ey.toDOMNode(n, f);
      ...
      if (r) {
        ...
        return n.insertFragment(i), true
      }
      returnfalse
    }, n.insertTextData = e => {
