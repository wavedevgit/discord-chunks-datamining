...
function D(e) {
  ...
  let {
    ...
    selectedFilter: s
  } = (0, C.Z)(), h = (0, a.e7)([j.Z], () => j.Z.oldestDisplayedMessageId), x = (0, a.Wu)([j.Z], () => j.Z.getInboxMessages()), S = (0, a.Wu)([_.ZP, b.Z, j.Z], () => x.filter(e => !(0, E.YH)({
    messageId: e.id,
    channelId: e.channelId,
    guildId: e.guildId,
    ReadStateStore_: _.ZP,
    GuildStore_: b.Z
  }) && O.default.compare(e.id, h) > 0 && e.id !== j.Z.lastClickedUnreadMessageId)), I = (0, a.Wu)([_.ZP, b.Z, j.Z], () => x.filter(e => (0, E.YH)({
    messageId: e.id,
    channelId: e.channelId,
    guildId: e.guildId,
    ReadStateStore_: _.ZP,
    GuildStore_: b.Z
  }) || e.id === j.Z.lastClickedUnreadMessageId)), Z = i.useCallback(e => {
    s !== w.V5.BOOKMARKS && v.Z.loadMoreInbox(e)
  }, [s]), {
    hasLoadedEver: T,
    hasNotifyingChannels: D
  } = (0, a.cj)([j.Z], () => ({
  ...
  return (0, r.jsxs)("nav", {
    ...
    children: [(0, r.jsx)(p.ZP, (t = function(e) {
    ...
    }), t)), z === y.v8.TABS && (0, r.jsx)(P.Z, {}), s === w.V5.ALL && (0, r.jsx)(U, {
      hideBanner: !T || s !== w.V5.ALL
    }), K && (0, r.jsx)(G, {
      filter: s
    }), (0, r.jsx)(N.Z, {
