...
function N(e) {
  ...
  let V = (0, c.e7)([O.default], () => O.default.getCurrentUser()),
    ...
    F = i.useMemo(() => {
      if (!B) return null;
      let e = (0, s.uniqBy)([...null != a ? a : [], ...M.filter(e => e.author.id !== (null == V ? void 0 : V.id))].sort((e, t) => v.default.compare(t.id, e.id)), "id").filter(e => e.author.id !== (null == V ? void 0 : V.id) && v.default.age(e.id) < E.ib);
  ...
  return (0, r.jsxs)("nav", {
    ...
    children: [(0, r.jsx)(f.ZP, (t = function(e) {
