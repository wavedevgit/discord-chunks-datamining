...
function w(e) {
  ...
  })), [w, A] = i.useState(S.V5.ALL), [D, L] = i.useState(S.xM.UNREAD);
  (0, i.useEffect)(() => {
  ...
  let k = (0, c.e7)([O.default], () => O.default.getCurrentUser()),
    ...
    U = i.useMemo(() => {
      let e = (0, s.uniqBy)([...null != a ? a : []].sort((e, t) => v.default.compare(t.id, e.id)), "id");
      if (w === S.V5.ALL) return e;
      if (w === S.V5.ANNOUNCEMENTS) return null == e ? void 0 : e.filter(e => {
