...
function Z(e) {
  ...
  let B = (0, c.e7)([y.default], () => y.default.getCurrentUser()),
    ...
    H = i.useMemo(() => {
      if (!G) return null;
      let e = (0, s.uniqBy)([...null != a ? a : [], ...k.filter(e => e.author.id !== (null == B ? void 0 : B.id))].sort((e, t) => O.default.compare(t.id, e.id)), "id").filter(e => e.author.id !== (null == B ? void 0 : B.id) && O.default.age(e.id) < x.ib);
      if (_ === x.V5.ALL) return e;
      if (_ === x.V5.ANNOUNCEMENTS) return null == e ? void 0 : e.filter(e => {
