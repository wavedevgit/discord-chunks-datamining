...
function Z(e) {
  ...
  let G = (0, c.e7)([b.default], () => b.default.getCurrentUser()),
    ...
    F = i.useMemo(() => {
      var e;
      return k ? v === x.V5.BOOKMARKS ? B.flatMap(e => {
        let {
          message: t
        } = e;
        return null != t ? [{
        ...
        kind: x.fL.MENTION,
        message: e
      }))) ? e : [], ...P.filter(e => e.author.id !== (null == G ? void 0 : G.id)).map(e => ({
        message: e,
  ...
  return (0, r.jsxs)("nav", {
    ...
    children: [(0, r.jsx)(p.ZP, (t = function(e) {
      ...
      children: (0, r.jsx)(u.Kqy, {
        ...
        children: V === O.v8.DROPDOWN && (0, r.jsx)(E.p, {
          selectedFilter: v,
          setSelectedFilter: j,
    ...
    }), t)), V === O.v8.TABS && (0, r.jsx)(E.Z, {
      selectedFilter: v,
      setSelectedFilter: j
    }), v === x.V5.ALL && (0, r.jsx)(D, {
      hideBanner: U || v !== x.V5.ALL
    }), H && (0, r.jsx)(L, {
      filter: v
    }), (0, r.jsx)(S.Z, {
...
function D(e) {
  let {
    hideBanner: t
  } = e, n = (0, c.e7)([y.Z], () => y.Z.shouldHide), [l, a] = (0, i.useState)(!1);
  return (0, r.jsx)("div", {
