...
function D(e) {
  ...
  })), [g, E] = i.useState(w.V5.ALL), [S, I] = i.useState(w.xM.UNREAD), {
    messages: T,
    loadState: D,
    loadMore: F,
    hasLoadedEver: V
  } = (0, x.ZP)(), H = function(e) {
    let [t, n] = (0, i.useState)(!0), [r, l] = (0, i.useState)(!1);
    return (0, h.ZP)(() => {
      let e = setTimeout(() => {
        l(!0)
      }, .25 * v.Z.Millis.SECOND);
      return () => {
        clearTimeout(e)
      }
    }), (0, i.useEffect)(() => {
  ...
  }(V && f && !p && D !== x.jd.Loading);
  (0, i.useEffect)(() => {
    if (!f) return void L(null)
  }, [f]);
  let z = (0, c.e7)([y.default], () => y.default.getCurrentUser()),
    W = (0, c.e7)([_.Z], () => _.Z.getSavedMessages()),
    K = i.useMemo(() => {
      var e;
      if (!V) return null;
      if (g === w.V5.BOOKMARKS) return W.flatMap(e => {
        let {
          message: t
        } = e;
        return null != t ? [{
      ...
      let t = (0, s.uniqBy)([...null != (e = null == a ? void 0 : a.map(e => ({
        kind: w.fL.MENTION,
        message: e
      }))) ? e : [], ...T.filter(e => e.author.id !== (null == z ? void 0 : z.id)).map(e => ({
        message: e,
    ...
    X = q === j.v8.DROPDOWN && g !== w.V5.ALL;
  return (0, r.jsxs)("nav", {
    className: o()(A.container, {
      [A.panelSpacing]: l
    }),
    children: [(0, r.jsx)(m.ZP, (t = function(e) {
      ...
      children: (0, r.jsxs)(u.Kqy, {
        ...
        children: [q === j.v8.DROPDOWN && (0, r.jsx)(P.p, {
          selectedFilter: g,
          setSelectedFilter: E,
    ...
    }), t)), q === j.v8.TABS && (0, r.jsx)(P.Z, {
      selectedFilter: g,
      setSelectedFilter: E
    }), g === w.V5.ALL && (0, r.jsx)(U, {
      canShow: Y
    }), X && (0, r.jsx)(G, {
      filter: g
    }), (0, r.jsx)(N.Z, {
      ...
      messages: K,
      loadingInitial: H,
      loadingMore: D === x.jd.Loading || p,
      listName: "notifications-inbox",
      loadMore: function(e) {
        let t = null != a && a.length > 0 ? a[a.length - 1].id : null;
        [w.V5.ALL, w.V5.MENTIONS, w.V5.ANNOUNCEMENTS].includes(g) && d && !p && L(null, t), [w.V5.ALL, w.V5.ANNOUNCEMENTS].includes(g) && D !== x.jd.Done && D !== x.jd.Loading && F(e)
      },
...
function U(e) {
  ...
  return (0, r.jsx)(u.P3F, {
    ...
    onMouseEnter: () => a(!0),
    onMouseLeave: () => a(!1),
    className: o()(A.caughtUpContainer, {
      [A.hide]: !(!n && t)
    }),
...
function B() {
  ...
  } = (0, f.ZP)(p.Z.NOTIFICATIONS_INBOX);
