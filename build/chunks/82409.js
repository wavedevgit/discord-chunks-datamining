...
function N(e) {
  ...
  })), [N, D] = i.useState(E.V5.ALL), [L, k] = i.useState(E.xM.UNREAD), {
    messages: M,
    loadState: U,
    loadMore: G,
    hasLoadedEver: B
  ...
  let V = (0, c.e7)([y.default], () => y.default.getCurrentUser()),
    ...
    F = i.useMemo(() => {
      if (!B) return null;
      let e = (0, s.uniqBy)([...null != a ? a : [], ...M.filter(e => e.author.id !== (null == V ? void 0 : V.id))].sort((e, t) => O.default.compare(t.id, e.id)), "id").filter(e => e.author.id !== (null == V ? void 0 : V.id) && O.default.age(e.id) < E.ib);
      if (N === E.V5.ALL) return e;
      if (N === E.V5.ANNOUNCEMENTS) return null == e ? void 0 : e.filter(e => {
