...
function R(e) {
  ...
  let B = (0, c.e7)([O.default], () => O.default.getCurrentUser()),
    ...
    V = i.useMemo(() => {
      var e;
      return Z ? f === N.V5.BOOKMARKS ? F.flatMap(e => {
        let {
          message: t
        } = e;
        return null != t ? [{
  ...
  return (0, r.jsxs)("nav", {
    ...
    children: [(0, r.jsx)(g.ZP, (t = function(e) {
      ...
      children: (0, r.jsxs)(u.Kqy, {
        ...
        children: [H === v.v8.DROPDOWN && (0, r.jsx)(I.p, {
          selectedFilter: f,
          setSelectedFilter: C,
    ...
    }), t)), H === v.v8.TABS && (0, r.jsx)(I.Z, {
      selectedFilter: f,
      setSelectedFilter: C
    }), f === N.V5.ALL && (0, r.jsx)(k, {
      hideBanner: R || f !== N.V5.ALL
    }), z && (0, r.jsx)(U, {
      filter: f
    }), (0, r.jsx)(P.Z, {
