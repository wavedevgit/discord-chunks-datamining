...
function U(e) {
  ...
  let {
    ...
    selectedFilter: p
  } = (0, S.Z)(), P = (0, s.e7)([x.Z], () => x.Z.oldestDisplayedMessageId), N = (0, s.Wu)([x.Z], () => x.Z.getInboxMessages()), w = (0, s.Wu)([y.ZP, _.Z, x.Z], () => N.filter(e => !(0, I.YH)({
    messageId: e.id,
    channelId: e.channelId,
    guildId: e.guildId,
    ReadStateStore_: y.ZP,
    GuildStore_: _.Z
  }) && v.default.compare(e.id, P) > 0 && e.id !== x.Z.lastClickedUnreadMessageId)), D = (0, s.Wu)([y.ZP, _.Z, x.Z], () => N.filter(e => (0, I.YH)({
    messageId: e.id,
    channelId: e.channelId,
    guildId: e.guildId,
    ReadStateStore_: y.ZP,
    ...
    function(e) {
      ...
      i.useEffect(() => {
        null != e && t.forEach(e => {
          ...
          null != r && null != i && n.hasPresent() && v.default.compare(i, r) > 0 && d.In(e, {
  ...
  (0, h.ZP)(() => {
    ...
    if (C.Lk.getCurrentConfig({
      ...
      }).notificationCenterVariant !== C.jP.SIDEBAR) return;
  ...
  return (0, r.jsxs)("nav", {
    ...
    children: [(0, r.jsx)(f.ZP, (t = M({
      ...
      children: (0, r.jsx)(c.Kqy, {
        ...
        children: Q === C.v8.DROPDOWN && !J && (0, r.jsx)(Z.p, {})
      })
    ...
    }), t)), Q === C.v8.TABS && (0, r.jsx)(Z.Z, {}), p === A.V5.ALL && (0, r.jsx)(H, {
...
function B(e, t) {
  return i.useMemo(() => 0 === e.length ? [] : e.filter(e => {
    ...
    if (v.default.age(n) > A.ib) return !1;
