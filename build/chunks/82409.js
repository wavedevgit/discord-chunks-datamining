...
function H(e) {
  ...
  let p = (0, u.e7)([N.default], () => N.default.getCurrentUser()),
    f = i.useMemo(() => {
      let e = (0, s.uniqBy)([...null != n ? n : []].sort((e, t) => Z.default.compare(t.id, e.id)), "id");
      if (0 === d.size) return e;
      let t = e;
      return d.has(D.x.ANNOUNCEMENTS) && (t = null == t ? void 0 : t.filter(e => {
        let t = P.Z.getChannel(e.channel_id);
        return (null == t ? void 0 : t.type) === M.d4z.GUILD_ANNOUNCEMENT
      })), d.has(D.x.MENTIONS) && (t = null == t ? void 0 : t.filter(e => (null == p ? void 0 : p.id) != null && e.mentioned && e.mentions.includes(null == p ? void 0 : p.id))), t
    }, [d, n, p]);
  return (0, r.jsxs)("nav", {
    className: o()(G.container, {
      [G.panelSpacing]: t
    }),
    children: [(0, r.jsx)(b.ZP, B({
      hasSubheader: !0,
      guild: k.F7
    }, V)), (0, r.jsx)(D.Z, {
      selectedFilters: d,
...
function Y(e) {
  let {
    ...
    params: i
  } = (0, a.$B)(), l = (0, u.e7)([P.Z], () => P.Z.getChannel(t.channel_id));
  return null == t || null == l ? null : (0, r.jsx)(d.P3F, {
    className: o()(G.messageClickableContainer, {
      [G.selected]: t.id === i.messageId
    }),
    onClick: () => {
...
function K(e) {
  ...
  let {
  ...
  }), p = "" === l.content && l.attachments.length > 0, f = 1 === l.attachments.length ? d.XBm : d.Ka2, b = (0, m.KS)(s, null), v = (0, g.ZP)(s, !1), j = (0, u.e7)([w.Z], () => w.Z.getGuild(s.getGuildId())), S = (0, u.e7)([T.Z], () => T.Z.unreadMessageIds), {
    nick: E,
    colorString: P
  } = (0, y.ZP)(l), {
    ...
    animateOnHover: !0
  }), L = S.has(l.id), k = s.type !== M.d4z.GUILD_ANNOUNCEMENT || null == j;
  return (0, i.useEffect)(() => {
    null != j && I.Z.requestMember(j.id, l.author.id)
  }, [j, l.author.id]), (0, r.jsx)(d.tEY, (t = B({}, a), n = n = {
        ...
        children: [(0, r.jsxs)(d.Kqy, {
          ...
          children: [p && (0, r.jsx)(f, {
            ...
            children: p ? (0, r.jsx)("div", {
              ...
              children: l.attachments.length > 1 ? U.intl.formatToPlainString(U.t.rtfTKi, {
                count: l.attachments.length
...
function q(e) {
  let {
    message: t
  } = e, n = (0, j.a3)(t.timestamp.getTime());
  return (0, r.jsx)(v.Z, {
