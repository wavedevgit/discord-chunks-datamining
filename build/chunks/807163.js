...
function ec(e) {
  var s, r, n = et({}, function(e) {
    if (null == e) throw TypeError("Cannot destructure " + e);
    return e
  }(e));
  let {
    theme: i
  } = (0, A.z)(), a = (0, p.dQu)(p.TVs.colors.INTERACTIVE_ACTIVE, i).hex();
  return (0, t.jsx)(p.SrA, (s = function(e) {
    for (var s = 1; s < arguments.length; s++) {
...
function eu(e) {
  let s, {
    ...
    l = n === D.p9.TIER_1;
  return s = (null == a ? void 0 : a.premiumType) === D.p9.TIER_2 ? (0, t.jsxs)(y.Z, {
    user: r,
    displayProfile: a,
    forceShowPremium: !0,
    themeType: null,
    className: W.profileCard,
    children: [(0, t.jsx)(L.b, {
      user: r,
      displayProfile: a,
    ...
    onLearnMore: () => {
      i(), j.Z.open(K.oAB.PROFILE_CUSTOMIZATION), U.default.track(K.rMx.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
...
function em(e) {
  let {
    premiumType: s
  } = e, r = (0, m.e7)([C.Z], () => C.Z.useReducedMotion), n = (0, g.wC)(null).filter(e => e.type === I.B.GUILD && (e.animated || null != e.guildId)).slice(0, 3), i = (0, m.Wu)([T.Z], () => T.Z.stickerFrecencyWithoutFetchingLatest.frequently.slice(0, 3 - n.length)), a = eo().emojiStickersVisual, o = s === D.p9.TIER_1;
  return (0, t.jsx)(el, {
    description: o ? B.intl.format(B.t.couiKC, {}) : B.intl.format(B.t["0hUHi4"], {}),
    onLearnMore: () => {
      window.open(S.Z.getArticleURL(K.BhN.PREMIUM_DETAILS)), U.default.track(K.rMx.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
        action: "emojis_stickers"
      })
    },
    renderVisual: () => null != n && n.length > 0 || !o && null != i && i.length > 0 ? (0, t.jsxs)("div", {
      ...
      children: [n.map(e => null == e.id ? e.url : w.ZP.getEmojiURL({
        ...
        alt: "",
        src: e
      }) : null), o ? null : i.map(e => (0, t.jsx)(v.Z, {
        disableAnimation: r,
        sticker: e,
        size: 58,
...
function ed(e) {
  ...
  return (0, t.jsx)(el, {
    ...
    onLearnMore: () => {
      r(), j.Z.open(K.oAB.GUILD_BOOSTING), U.default.track(K.rMx.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
        action: "boosts"
      })
    },
...
let ep = () => {
  ...
  return (0, t.jsx)(el, {
    ...
    onLearnMore: () => {
      window.open(S.Z.getArticleURL(K.BhN.STREAM_QUALITY_SETTINGS)), U.default.track(K.rMx.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
        action: "screen_share"
      })
    },
...
function ex(e) {
  let {
    premiumType: s
  } = e, r = eo().uploadsMessagesItemVisual;
  return (0, t.jsx)(el, {
...
let ef = e => {
  let {
    country: s
  } = e, r = eo(), n = "PL" === s ? r.PL : r.TR;
  return (0, t.jsx)(el, {
    description: B.intl.format("PL" === s ? B.t["0MAev7"] : B.t.p2CqUl, {}),
    onLearnMore: () => {
      window.open(S.Z.getArticleURL(K.BhN.LOCALIZED_PRICING)), U.default.track(K.rMx.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
...
let eh = function(e) {
  ...
  let I = null != f && !x;
  return (n.useEffect(() => {
    I && U.default.track(K.rMx.CANCELLATION_FLOW_DISCOUNT_OFFER_PROMPT_VIEWED, {
      location_stack: d,
      discount_id: null == f ? void 0 : f.discount_id
    })
  }, [I, d, f]), x) ? (0, t.jsxs)(t.Fragment, {
    children: [(0, t.jsx)(V.Z, {
      premiumType: s,
      onClose: o
    }), (0, t.jsx)(p.hzk, {
      className: W.body,
      children: (0, t.jsx)(p.$jN, {
        className: W.spinner
      })
    })]
  }) : (0, t.jsxs)(t.Fragment, {
