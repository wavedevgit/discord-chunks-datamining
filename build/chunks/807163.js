...
function eu(e) {
  ...
  let {
    theme: i
  } = (0, M.z)(), a = (0, p.dQu)(p.TVs.colors.INTERACTIVE_ACTIVE, i).hex();
...
function em(e) {
  ...
  return s = (null == a ? void 0 : a.premiumType) === K.p9.TIER_2 ? (0, r.jsxs)(A.Z, {
    ...
    onLearnMore: () => {
      i(), j.Z.open(B.oAB.PROFILE_CUSTOMIZATION), S.default.track(B.rMx.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
...
function ed(e) {
  let {
    premiumType: s
  } = e, t = (0, m.e7)([h.Z], () => h.Z.useReducedMotion), n = (0, g.wC)(null).filter(e => e.type === N.B.GUILD && (e.animated || null != e.guildId)).slice(0, 3), i = (0, m.Wu)([v.Z], () => v.Z.stickerFrecencyWithoutFetchingLatest.frequently.slice(0, 3 - n.length)), a = el().emojiStickersVisual, o = s === K.p9.TIER_1;
  return (0, r.jsx)(ec, {
    description: o ? W.intl.format(W.t.couiKC, {}) : W.intl.format(W.t["0hUHi4"], {}),
    onLearnMore: () => {
      window.open(k.Z.getArticleURL(B.BhN.PREMIUM_DETAILS)), S.default.track(B.rMx.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
    ...
    renderVisual: () => null != n && n.length > 0 || !o && null != i && i.length > 0 ? (0, r.jsxs)("div", {
      ...
      children: [n.map(e => null == e.id ? e.url : w.ZP.getEmojiURL({
        ...
        alt: "",
        src: e
      }) : null), o ? null : i.map(e => (0, r.jsx)(E.Z, {
        disableAnimation: t,
        sticker: e,
        size: 58,
...
function ep(e) {
  ...
  return (0, r.jsx)(ec, {
    ...
    onLearnMore: () => {
      t(), j.Z.open(B.oAB.GUILD_BOOSTING), S.default.track(B.rMx.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
        action: "boosts"
      })
    },
...
let ex = () => {
  ...
  return (0, r.jsx)(ec, {
    ...
    onLearnMore: () => {
      window.open(k.Z.getArticleURL(B.BhN.STREAM_QUALITY_SETTINGS)), S.default.track(B.rMx.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
        action: "screen_share"
      })
    },
...
let ej = e => {
  ...
  return (0, r.jsx)(ec, {
    ...
    onLearnMore: () => {
      window.open(k.Z.getArticleURL(B.BhN.LOCALIZED_PRICING)), S.default.track(B.rMx.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
...
let eh = function(e) {
  ...
  let N = null != f && !x;
  return (n.useEffect(() => {
    N && S.default.track(B.rMx.CANCELLATION_FLOW_DISCOUNT_OFFER_PROMPT_VIEWED, {
      location_stack: d,
