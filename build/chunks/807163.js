...
function ei(e) {
  ...
  return (0, t.jsxs)("div", {
    className: i()(K.whatYouLoseItem, {
      [K.premiumRebrand]: a
    }),
    children: [(0, t.jsxs)("div", {
      className: i()(K.whatYouLoseItemLeftColumn, {
        [K.premiumRebrand]: a
      }),
      ...
      className: i()(K.whatYouLoseItemRightColumn, {
        [K.premiumRebrand]: a
      }),
      children: n()
    })]
...
function el(e) {
  let s, {
    ...
    l = n === z.p9.TIER_1;
  return s = (null == i ? void 0 : i.premiumType) === z.p9.TIER_2 ? (0, t.jsxs)(O.Z, {
    user: r,
    displayProfile: i,
    forceShowPremium: !0,
    themeType: null,
...
let em = () => {
  ...
  return (0, t.jsx)(ei, {
    ...
    onLearnMore: () => {
      window.open(S.Z.getArticleURL(V.BhN.STREAM_QUALITY_SETTINGS)), w.default.track(V.rMx.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
        action: "screen_share"
      })
    },
