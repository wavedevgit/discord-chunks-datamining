...
var w = r.forwardRef(function(e, t) {
    var a = e.className,
      ...
      y = P(),
      O = y.isReady,
      I = y.addReadyListener,
      S = y.removeReadyListener,
      T = y.setIsReady,
      N = r.useRef(new Map),
      A = r.useRef(null),
      C = r.useRef(0),
      ...
      D = r.useCallback(function() {
        ...
        if (null != e) {
          ...
          if (null != t) {
            t.clearRect(0, 0, e.width, e.height), null == _ || _(t), N.current.forEach(function(n, r) {
              var i = n.confetti,
                o = n.spriteCanvas;
              i.update(s), i.draw(o, t), i.shouldDestroy(e, s) && N.current.delete(r)
            }), null == p || p(t), N.current.size > 0 ? A.current = m(D) : (t.clearRect(0, 0, e.width, e.height), A.current = null);
            var n = Date.now();
...
function x(e, t) {
  var n, i, o = r.useState(null !== (n = null == t ? void 0 : t.isReady) && void 0 !== n && n),
    a = o[0],
    s = o[1],
    l = r.useState(null !== (i = null == e ? void 0 : e.isReady) && void 0 !== i && i),
    c = l[0],
    u = l[1];
  r.useEffect(function() {
