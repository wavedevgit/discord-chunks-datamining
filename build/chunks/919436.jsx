...
class R extends(r = Chunk73800.PureComponent) {
  ...
  getAnimatedStyle() {
    ...
    return {
      ...
      transform: Chunk255367.to([0, 1], [.5, 1]).to(e => "scale(".concat(e, ")"))
    }
  }
  getChannelIcon() {
    let {
  ...
  render() {
    let {
      ...
      hovered: f,
      animating: m
    } = this.state, b = module.isMultiUserDM() && null == module.icon && Chunk43267;
    return <Chunk126663.animated.div style={this.getAnimatedStyle()}><Chunk682662.H>{<Chunk276952.Z hovered={!Chunk199902 && Chunk93687} selected={!Chunk199902 && require} unread={!Chunk199902 && Chunk358221} className={Chunk223203.pill} />}{<Chunk662146.Z text={null != exports ? exports : ""} selected={require}><Chunk481060.aRk rounded={true} selected={false} lowerBadge={r > 0 ? (0, Chunk674552.Ne)(r, true, true) : null} upperBadge={(0, Chunk674552.Or)({
              audio: Chunk73800,
              video: Chunk91192,
              ...
              children: Chunk19780 ? (0, Chunk255367.jsx)(Chunk266076.Z, {
                channel: module,
            ...
            }, Chunk933557)} /></Chunk481060.aRk></Chunk662146.Z>}</Chunk682662.H></Chunk126663.animated.div>
  }
  constructor(...e) {
    super(...e), N(this, "state", {
      ...
      let {
        channel: t
      } = this.props, r = t.type === x.d4z.DM ? y.default.getUser(t.getRecipientId()) : null;
