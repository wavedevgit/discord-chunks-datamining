...
function K(e) {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [T ? (0, r.jsxs)("div", {
      ...
      className: a()(H.appDetailsContainer, {
...
function ea(e) {
  ...
  return x === y.JS.START || x === y.JS.JOIN ? a ? (0, r.jsx)(Y, X(G({}, d), {
    sectionName: o,
    application: n,
    onClick: _,
    onClickAppCardFriends: _,
