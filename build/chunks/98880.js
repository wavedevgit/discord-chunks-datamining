...
function Q(e) {
  let {
    ...
    fakeAppIconURL: V
  }), [t]), b = r.useMemo(() => null == x ? null : (0, R.ae)(x), [x]), g = (0, C.ZP)(v, ""), [N, E] = r.useState(!1), P = r.useCallback(() => {
    !0 === a && E(!0)
  }, [a]), O = h || (0, T.lf)(t), I = "large_banner" === n || "medium_banner" === n, _ = r.useCallback(() => E(!1), []), S = (0, s.e7)([f.Z, A.Z], () => f.Z.inDevModeForApplication(t.id) || A.Z.inTestModeForApplication(t.id), [t.id]), L = (0, T.WA)(t);
  return (0, i.jsxs)(i.Fragment, {
    children: [I ? (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsx)("span", {
        ...
        }), S && (0, i.jsx)(J, {}), L !== d.ww.NONE && (0, i.jsx)(j.Z, {
          labelType: L
        })]
      }) : null, (0, i.jsx)("div", {
...
function $(e) {
  ...
  if ((0, T.BQ)(t)) {
    if ((0, T.ye)(t)) return (0, i.jsx)(ee, {
      application: t,
      showVideo: l,
      disableFadeIn: r
    });
    if (null != t.bot) return (0, i.jsx)(et, {
      bot: t.bot,
      fallbackColor: n,
      disableFadeIn: r
    })
...
function et(e) {
  let {
    ...
    fallbackColor: n,
    disableFadeIn: l
  } = e, r = (0, s.e7)([m.Z], () => m.Z.useReducedMotion), a = (0, _.aN)({
    id: t.id,
    banner: t.banner,
    canAnimate: !r,
    size: 600
  });
  return null == a ? (0, i.jsx)(en, {
    fallbackColor: n,
    disableFadeIn: l
  }) : (0, i.jsx)("img", {
    src: a,
...
function el(e) {
  ...
  return {
    onClickAppCard: r.useCallback(e => {
      e.stopPropagation(), (0, N.yw)(M.rMx.APPLICATION_COMMAND_SECTION_SELECTED, {
        application_id: t.id,
        section_name: n,
...
function er(e) {
  ...
  return b === x.JS.START || b === x.JS.JOIN ? o ? (0, i.jsx)(q, G(F({}, d), {
    sectionName: a,
    application: n,
    onClick: y,
    disabled: m,
    enableVideoBanner: !v,
    children: v ? (0, i.jsx)(c.$jN, {
