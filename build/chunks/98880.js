...
function Q(e) {
  let {
    ...
    fakeAppIconURL: H
  }), [t]), v = l.useMemo(() => null == C ? null : (0, R.ae)(C), [C]), x = (0, N.ZP)(b, ""), [g, j] = l.useState(!1), P = l.useCallback(() => {
    !0 === o && j(!0)
  }, [o]), E = h || (0, T.lf)(t), I = "large_banner" === n || "medium_banner" === n, O = l.useCallback(() => j(!1), []), S = (0, c.e7)([f.Z, A.Z], () => f.Z.inDevModeForApplication(t.id) || A.Z.inTestModeForApplication(t.id), [t.id]), L = (0, T.WA)(t);
  return (0, r.jsxs)(r.Fragment, {
    children: [I ? (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)("span", {
        ...
        }), S && (0, r.jsx)(J, {}), L !== d.ww.NONE && (0, r.jsx)(y.Z, {
          labelType: L
        })]
      }) : null, (0, r.jsx)("div", {
...
function $(e) {
  ...
  if ((0, T.BQ)(t)) {
    if ((0, T.ye)(t)) return (0, r.jsx)(ee, {
      application: t,
      showVideo: i,
      disableFadeIn: l
    });
    if (null != t.bot) return (0, r.jsx)(et, {
      bot: t.bot,
      fallbackColor: n,
      disableFadeIn: l
    })
...
function ei(e) {
  ...
  return {
    onClickAppCard: l.useCallback(e => {
...
function el(e) {
  ...
  return v === C.JS.START || v === C.JS.JOIN ? a ? (0, r.jsx)(q, z(F({}, d), {
    sectionName: o,
    application: n,
    onClick: _,
    disabled: m,
