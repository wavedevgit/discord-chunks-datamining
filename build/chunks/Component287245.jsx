...
let C = e => {
    ...
    }), c = n.author, u = _.Ay.getName(c), d = (0, h.A)({
      userId: c.id,
      guildId: t.guild_id
    }), {
      avatarSrc: p,
  ...
  S = e => {
    let {
      ...
      idle: n,
      showChat: i
    } = e, h = l.useRef(new Set), [g, f] = l.useState([]), [b, A] = l.useState(0), _ = l.useRef(null), v = l.useRef(false), [S, I] = l.useState(true), [N, T] = l.useState(""), [P, w] = l.useState((0, d.x7)(N));
    l.useEffect(() => {
      let e = h.current;
      return () => {
    ...
    return l.useEffect(() => {
      ...
      onMouseEnter: () => v.current = true,
      onMouseLeave: () => v.current = false,
      onWheel: e => {
