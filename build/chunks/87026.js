...
let B = e => {
    let {
      ...
      headerId: r,
      theme: c
    } = e, m = (0, o.e7)([S.Z], () => S.Z.getGuild(t.id), [t.id]), x = null != m && m.verificationLevel > L.sFg.NONE, f = (null == m ? void 0 : m.explicitContentFilter) === L.lxg.ALL_MEMBERS, p = (0, d.wj)(c) ? k : G;
    return (0, s.jsxs)("div", {
...
let V = e => {
  ...
  K = e => {
    ...
    let {
      guild: a
    } = (0, o.cj)([b.Z], () => b.Z.getProps()), c = (0, o.e7)([N.Z], () => N.Z.theme), [d, u] = n.useState(!1), [g, S] = n.useState(!y.$X.some(e => T.oz(e, a))), [O, w] = n.useState(y.b4), [P, Z] = n.useState(y.b4), [A] = n.useState(null == a ? void 0 : a.defaultMessageNotifications), [D] = n.useState(null == a ? void 0 : a.verificationLevel), [k] = n.useState(null == a ? void 0 : a.explicitContentFilter), [G] = n.useState(g), Y = (0, o.e7)([C.Z], () => null != a ? C.Z.getEveryoneRole(a) : void 0), H = (0, o.e7)([j.ZP], () => null != a ? j.ZP.getChannels(a.id) : null), z = (0, f.Dt)(), {
      enabled: J
    } = (0, m.D2)(null != (t = null == a ? void 0 : a.id) ? t : L.lds);
