...
function b(a) {
  let {
    match: t
  } = a, l = (0, i.e7)([n.Z], () => n.Z.getState("quests")), c = t.params.questId, b = function(a) {
      ...
      children: (0, s.jsx)(d.ZP, {
        children: W ? (0, s.jsxs)(s.Fragment, {
          children: [(0, s.jsx)(d.Dx, {
            children: u.intl.string(u.t["Z+hCVV"])
          }), (0, s.jsx)(d.Hh, {})]
        }) : (0, s.jsxs)(s.Fragment, {
          children: [(0, s.jsx)(d.Dx, {
            ...
            children: u.intl.string(u.t.ghBJz8)
          })]
        })
      })
    })]
