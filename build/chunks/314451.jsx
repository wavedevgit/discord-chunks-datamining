...
function g(e) {
  ...
  return <div onMouseEnter={() => y(true)} onMouseLeave={() => y(false)}><a.yRy targetElementRef={E} shouldShow={m} animation={a.yRy.Animation.NONE} position={"bottom"} align={"right"} autoInvert={false} onRequestOpen={() => b(true)} onRequestClose={() => b(false)} renderPopout={() => (function(e) {
        let {
          onClose: t,
