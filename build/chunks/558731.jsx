...
function s(e) {
  ...
  return <o.x title={m} className={a.settingButtonContainer}><div className={a.settingButtonContent}>{null != x && <l.R type={l.g.DESCRIPTION}>{x}</l.R>}{<r.zxk onClick={f} text={g} variant={v} disabled={b} />}</div></o.x>
}