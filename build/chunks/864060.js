...
function w(e, t) {
  ...
  if (null == u || null == d || null == c || u.type === G.d4z.GROUP_DM && e.type === G.uaV.RECIPIENT_REMOVE || b.Z.areSlayerNotificationsSuppressed() && ((a = u).type === G.d4z.DM || null != a.linkedLobby) || !M(d, c, u, {
      ignoreStatus: r,
  ...
  if (S.Ec.has(u.type)) {
    ...
    let t = (0, _.J)(u);
    return t !== k.iN.NO_MESSAGES && (t === k.iN.ALL_MESSAGES || (0, f.Hl)({
      rawMessage: e,
      userId: d.id,
      suppressEveryone: !1,
      suppressRoles: !1
...
function F(e, t) {
  ...
  }) || y.ZP.isGuildOrCategoryOrChannelMuted(t.guild_id, t.id)) && (!!n || h.Z.getChannelId(Z.Z.getGuildId()) !== t.id) && y.ZP.getNewForumThreadsCreated(t)
}
let V = (e, t, n) => "".concat(e, " (").concat((0, a.F6)(t, A.default, v.Z, !0)).concat(null != n ? ", ".concat((0, a.F6)(n, A.default, v.Z)) : "", ")");
...
function x(e, t, n) {
  ...
  if ("message_reference" in t ? (0, r.s)(t) : (0, r.Z)(t)) i = L.NW.string(L.t["9ddYKi"]);
  else if (null != t.activity && null != t.application) i = t.activity.type === G.mFx.JOIN ? L.NW.formatToPlainString(H(e, L.t.E8CgCg, L.t.c6KHWF, L.t.Fy7rJC), {
    user: l,
    game: t.application.name
  }) : t.activity.type === G.mFx.JOIN_REQUEST ? L.NW.formatToPlainString(H(e, L.t["/TD0lZ"], L.t["/TD0lZ"], L.t["/TD0lZ"]), {
    user: l,
    game: t.application.name
  }) : "";
  else if (null != t.activity && t.activity.type === G.mFx.LISTEN) {
    let t = H(e, L.t.SaDdmJ, L.t.qsODho, L.t.WeiMTU);
    i = L.NW.formatToPlainString(t, {
      user: l
    })
  } else if (null != E && E.length > 0) i = L.NW.formatToPlainString(L.t.zY4v1N, {
    stickerName: E[0].name
  });
  else if (t.type === G.uaV.PREMIUM_REFERRAL) i = L.NW.formatToPlainString(L.t.lieTqa, {
    username: O.ZP.getName(n)
  });
  else if (null != t.poll) i = L.NW.formatToPlainString(L.t.ImizdH, {
    ...
    i = L.NW.formatToPlainString(L.t["9WrecH"], {
      question: n
    })
  ...
  return 0 === i.length && (i = function(e) {
    ...
    if (void 0 !== e.attachments && e.attachments.length > 0) {
      ...
      return L.NW.formatToPlainString(L.t["51OkwM"], {
        filename: t
      })
    }
    return ""
