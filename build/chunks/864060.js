...
function F(e, t) {
  ...
  }) || v.ZP.isGuildOrCategoryOrChannelMuted(t.guild_id, t.id)) && (!!n || Z.Z.getChannelId(m.Z.getGuildId()) !== t.id) && v.ZP.getNewForumThreadsCreated(t)
}
let H = (e, t, n) => "".concat(e, " (").concat((0, a.F6)(t, y.default, I.Z, !0)).concat(null != n ? ", ".concat((0, a.F6)(n, y.default, I.Z)) : "", ")");
...
function z(e, t, n) {
  ...
  else if (null != t.activity && null != t.application) i = t.activity.type === b.mFx.JOIN ? M.intl.formatToPlainString(W(e, M.t.E8CgCg, M.t.c6KHWF, M.t.Fy7rJC), {
    user: l,
    game: t.application.name
  }) : t.activity.type === b.mFx.JOIN_REQUEST ? M.intl.formatToPlainString(W(e, M.t["/TD0lZ"], M.t["/TD0lZ"], M.t["/TD0lZ"]), {
    user: l,
    game: t.application.name
  }) : "";
  ...
  else if (t.type === b.uaV.PREMIUM_REFERRAL) i = M.intl.formatToPlainString(M.t.lieTqa, {
