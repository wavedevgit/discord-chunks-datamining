...
function k(e, t) {
  ...
  if (null == u || null == s || null == d || u.type === O.d4z.GROUP_DM && e.type === O.uaV.RECIPIENT_REMOVE || R.Z.areSlayerNotificationsSuppressed() && ((l = u).type === O.d4z.DM || null != l.linkedLobby) || !M(s, d, u, {
      ignoreStatus: r,
  ...
  if (S.Ec.has(u.type)) {
    ...
    let t = (0, _.J)(u);
    return t !== L.iN.NO_MESSAGES && (t === L.iN.ALL_MESSAGES || (0, c.Hl)({
      rawMessage: e,
      userId: s.id,
      suppressEveryone: !1,
      suppressRoles: !1
...
function w(e, t) {
  ...
  }) || v.ZP.isGuildOrCategoryOrChannelMuted(t.guild_id, t.id)) && (!!n || C.Z.getChannelId(Z.Z.getGuildId()) !== t.id) && v.ZP.getNewForumThreadsCreated(t)
}
let V = (e, t, n) => "".concat(e, " (").concat((0, l.F6)(t, m.default, h.Z, !0)).concat(null != n ? ", ".concat((0, l.F6)(n, m.default, h.Z)) : "", ")");
...
function H(e, t, n) {
  let i, u = P.ZP.getName(e.getGuildId(), e.id, n),
    o = u;
  switch (e.type) {
    case O.d4z.GUILD_ANNOUNCEMENT:
    case O.d4z.GUILD_TEXT:
  ...
  let g = t.content;
  if ((0, f.Z)(t) && null == (g = U.Z.stringify(t, e))) throw new a.Z("NotificationTextUtils").warn("SystemMessageUtils.stringify(...) could not convert", {
    message: t
  ...
  if ("message_reference" in t ? (0, r.s)(t) : (0, r.Z)(t)) i = b.intl.string(b.t["9ddYKi"]);
  else if (null != t.activity && null != t.application) i = t.activity.type === O.mFx.JOIN ? b.intl.formatToPlainString(F(e, b.t.E8CgCg, b.t.c6KHWF, b.t.Fy7rJC), {
    user: u,
    game: t.application.name
  }) : t.activity.type === O.mFx.JOIN_REQUEST ? b.intl.formatToPlainString(F(e, b.t["/TD0lZ"], b.t["/TD0lZ"], b.t["/TD0lZ"]), {
    user: u,
    game: t.application.name
  }) : "";
  else if (null != t.activity && t.activity.type === O.mFx.LISTEN) {
    let t = F(e, b.t.SaDdmJ, b.t.qsODho, b.t.WeiMTU);
    i = b.intl.formatToPlainString(t, {
      user: u
    })
  } else if (null != _ && _.length > 0) i = b.intl.formatToPlainString(b.t.zY4v1N, {
    stickerName: _[0].name
  });
  else if (t.type === O.uaV.PREMIUM_REFERRAL) i = b.intl.formatToPlainString(b.t.lieTqa, {
    username: D.ZP.getName(n)
  });
  else if (null != t.poll) i = b.intl.formatToPlainString(b.t.ImizdH, {
    ...
    i = b.intl.formatToPlainString(b.t["9WrecH"], {
      question: n
    })
  ...
  return 0 === i.length && (i = function(e) {
    ...
    if (void 0 !== e.attachments && e.attachments.length > 0) {
      ...
      return b.intl.formatToPlainString(b.t["51OkwM"], {
        filename: t
      })
    }
    return ""
