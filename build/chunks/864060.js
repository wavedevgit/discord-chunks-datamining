...
function M(e, t) {
  ...
  if (null == u || null == d || null == c || u.type === L.d4z.GROUP_DM && e.type === L.uaV.RECIPIENT_REMOVE || b.Z.areSlayerNotificationsSuppressed() && ((a = u).type === L.d4z.DM || null != a.linkedLobby) || !w(d, c, u, {
      ignoreStatus: o,
...
function F(e, t) {
  ...
  return !(null == t || null == l || null == a || !w(l, a, t, {
    ignoreStatus: i,
...
function z(e, t, n) {
  ...
  else if (null != t.activity && null != t.application) i = t.activity.type === L.mFx.JOIN ? k.intl.formatToPlainString(W(e, k.t.E8CgCg, k.t.c6KHWF, k.t.Fy7rJC), {
    user: l,
    game: t.application.name
  }) : t.activity.type === L.mFx.JOIN_REQUEST ? k.intl.formatToPlainString(W(e, k.t["/TD0lZ"], k.t["/TD0lZ"], k.t["/TD0lZ"]), {
    user: l,
    game: t.application.name
  }) : "";
  else if (null != t.activity && t.activity.type === L.mFx.LISTEN) {
    let t = W(e, k.t.SaDdmJ, k.t.qsODho, k.t.WeiMTU);
    i = k.intl.formatToPlainString(t, {
      user: l
    })
  } else if (null != E && E.length > 0) i = k.intl.formatToPlainString(k.t.zY4v1N, {
    stickerName: E[0].name
  });
  else if (t.type === L.uaV.PREMIUM_REFERRAL) i = k.intl.formatToPlainString(k.t.lieTqa, {
    username: R.ZP.getName(n)
  });
  else if (null != t.poll) i = k.intl.formatToPlainString(k.t.ImizdH, {
