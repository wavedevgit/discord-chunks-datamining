...
function U(e, t) {
  ...
  if (null == s || null == c || null == d || s.type === R.d4z.GROUP_DM && e.type === R.uaV.RECIPIENT_REMOVE || w.Z.areSlayerNotificationsSuppressed() && ((i = s).type === R.d4z.DM || null != i.linkedLobby) || !k(c, d, s, {
      ignoreStatus: o,
      ignoreSameUser: R.V$x.SELF_MENTIONABLE_SYSTEM.has(e.type)
    }) || u.Z.isMessageRequest(t)) return !1;
  if (!a) {
...
function G(e, t) {
  ...
  return !(null == t || null == r || null == i || !k(r, i, t, {
    ignoreStatus: l,
    ignoreNoMessagesSetting: !0
  }) || S.ZP.isGuildOrCategoryOrChannelMuted(t.guild_id, t.id)) && (!!n || C.Z.getChannelId(x.Z.getGuildId()) !== t.id) && S.ZP.getNewForumThreadsCreated(t)
}
let V = (e, t, n) => "".concat(e, " (").concat((0, i.F6)(t, T.default, N.Z, !0)).concat(null != n ? ", ".concat((0, i.F6)(n, T.default, N.Z)) : "", ")");
...
function F(e, t, n) {
  let l, r = _.ZP.getName(e.getGuildId(), e.id, n),
    s = r;
  switch (e.type) {
    case R.d4z.GUILD_ANNOUNCEMENT:
    case R.d4z.GUILD_TEXT:
  ...
  let f = t.content;
  if ((0, h.Z)(t) && null == (f = Z.Z.stringify(t, e))) throw new a.Z("NotificationTextUtils").warn("SystemMessageUtils.stringify(...) could not convert", {
    message: t
  ...
  if ("message_reference" in t ? (0, o.s)(t) : (0, o.Z)(t)) l = M.intl.string(M.t["9ddYKi"]);
  else if (null != t.activity && null != t.application) l = t.activity.type === R.mFx.JOIN ? M.intl.formatToPlainString(B(e, M.t.E8CgCg, M.t.c6KHWF, M.t.Fy7rJC), {
    user: r,
    game: t.application.name
  }) : t.activity.type === R.mFx.JOIN_REQUEST ? M.intl.formatToPlainString(B(e, M.t["/TD0lZ"], M.t["/TD0lZ"], M.t["/TD0lZ"]), {
    user: r,
    game: t.application.name
  }) : "";
  ...
  } else if (null != g && g.length > 0) l = M.intl.formatToPlainString(M.t.zY4v1N, {
    stickerName: g[0].name
  });
  else if (t.type === R.uaV.PREMIUM_REFERRAL) l = M.intl.formatToPlainString(M.t.lieTqa, {
    username: j.ZP.getName(n)
  });
  else if (null != t.poll) l = M.intl.formatToPlainString(M.t.ImizdH, {
    ...
    l = M.intl.formatToPlainString(M.t["9WrecH"], {
      question: n
    })
  ...
  return 0 === l.length && (l = function(e) {
    ...
    if (void 0 !== e.attachments && e.attachments.length > 0) {
      ...
      return M.intl.formatToPlainString(M.t["51OkwM"], {
        filename: t
      })
    }
    return ""
