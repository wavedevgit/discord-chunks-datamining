...
function w(t, e) {
  ...
  if (null == u || null == d || null == c || u.type === b.d4z.GROUP_DM && t.type === b.uaV.RECIPIENT_REMOVE || L.Z.areSlayerNotificationsSuppressed() && ((a = u).type === b.d4z.DM || null != a.linkedLobby) || !k(d, c, u, {
      ignoreStatus: o,
      ignoreSameUser: b.V$x.SELF_MENTIONABLE_SYSTEM.has(t.type)
    }) || s.Z.isMessageRequest(e)) return !1;
  if (!r) {
  ...
  if (O.Z.getCurrentConfig({
      ...
      autoTrackExposure: !0
    }).disableCurrentActivityNotifications && null != t.application_id) {
  ...
  if (N.Ec.has(u.type)) {
    ...
    let e = (0, _.J)(u);
    return e !== M.iN.NO_MESSAGES && (e === M.iN.ALL_MESSAGES || (0, f.Hl)({
      rawMessage: t,
      userId: d.id,
      suppressEveryone: !1,
      suppressRoles: !1
...
function F(t, e) {
  ...
  return !(null == e || null == l || null == a || !k(l, a, e, {
    ignoreStatus: i,
    ignoreNoMessagesSetting: !0
  }) || v.ZP.isGuildOrCategoryOrChannelMuted(e.guild_id, e.id)) && (!!n || Z.Z.getChannelId(A.Z.getGuildId()) !== e.id) && v.ZP.getNewForumThreadsCreated(e)
}
let H = (t, e, n) => "".concat(t, " (").concat((0, a.F6)(e, y.default, h.Z, !0)).concat(null != n ? ", ".concat((0, a.F6)(n, y.default, h.Z)) : "", ")");
...
function Y(t, e, n) {
  ...
  let f = e.content;
  if ((0, g.Z)(e) && null == (f = U.Z.stringify(e, t))) throw new r.Z("NotificationTextUtils").warn("SystemMessageUtils.stringify(...) could not convert", {
    message: e
  ...
  if ("message_reference" in e ? (0, o.s)(e) : (0, o.Z)(e)) i = G.intl.string(G.t["9ddYKi"]);
  else if (null != e.activity && null != e.application) i = e.activity.type === b.mFx.JOIN ? G.intl.formatToPlainString(W(t, G.t.E8CgCg, G.t.c6KHWF, G.t.Fy7rJC), {
    user: l,
    game: e.application.name
  }) : e.activity.type === b.mFx.JOIN_REQUEST ? G.intl.formatToPlainString(W(t, G.t["/TD0lZ"], G.t["/TD0lZ"], G.t["/TD0lZ"]), {
    user: l,
    game: e.application.name
  }) : "";
  else if (null != e.activity && e.activity.type === b.mFx.LISTEN) {
    let e = W(t, G.t.SaDdmJ, G.t.qsODho, G.t.WeiMTU);
    i = G.intl.formatToPlainString(e, {
      user: l
    })
  } else if (null != E && E.length > 0) i = G.intl.formatToPlainString(G.t.zY4v1N, {
    stickerName: E[0].name
  });
  else if (e.type === b.uaV.PREMIUM_REFERRAL) i = G.intl.formatToPlainString(G.t.lieTqa, {
    username: R.ZP.getName(n)
  });
  else if (null != e.poll) i = G.intl.formatToPlainString(G.t.ImizdH, {
    ...
    i = G.intl.formatToPlainString(G.t["9WrecH"], {
      question: n
    })
  ...
  return 0 === i.length && (i = function(t) {
    ...
    if (void 0 !== t.attachments && t.attachments.length > 0) {
      ...
      return G.intl.formatToPlainString(G.t["51OkwM"], {
        filename: e
      })
    }
    return ""
