...
function w(e, t) {
  ...
  if (null == u || null == d || null == c || u.type === b.d4z.GROUP_DM && e.type === b.uaV.RECIPIENT_REMOVE || L.Z.areSlayerNotificationsSuppressed() && ((a = u).type === b.d4z.DM || null != a.linkedLobby) || !k(d, c, u, {
      ignoreStatus: o,
  ...
  if (N.Ec.has(u.type)) {
    ...
    let t = (0, _.J)(u);
    return t !== M.iN.NO_MESSAGES && (t === M.iN.ALL_MESSAGES || (0, f.Hl)({
      rawMessage: e,
      userId: d.id,
      suppressEveryone: !1,
      suppressRoles: !1
...
function F(e, t) {
  ...
  return !(null == t || null == l || null == a || !k(l, a, t, {
    ignoreStatus: i,
    ignoreNoMessagesSetting: !0
  }) || v.ZP.isGuildOrCategoryOrChannelMuted(t.guild_id, t.id)) && (!!n || Z.Z.getChannelId(A.Z.getGuildId()) !== t.id) && v.ZP.getNewForumThreadsCreated(t)
}
let H = (e, t, n) => "".concat(e, " (").concat((0, a.F6)(t, y.default, h.Z, !0)).concat(null != n ? ", ".concat((0, a.F6)(n, y.default, h.Z)) : "", ")");
...
function z(e, t, n) {
  let i, l = D.ZP.getName(e.getGuildId(), e.id, n),
    u = l;
  switch (e.type) {
    case b.d4z.GUILD_ANNOUNCEMENT:
    case b.d4z.GUILD_TEXT:
  ...
  let f = t.content;
  if ((0, g.Z)(t) && null == (f = U.Z.stringify(t, e))) throw new r.Z("NotificationTextUtils").warn("SystemMessageUtils.stringify(...) could not convert", {
    message: t
  ...
  else if (null != t.activity && null != t.application) i = t.activity.type === b.mFx.JOIN ? G.intl.formatToPlainString(W(e, G.t.E8CgCg, G.t.c6KHWF, G.t.Fy7rJC), {
    user: l,
    game: t.application.name
  }) : t.activity.type === b.mFx.JOIN_REQUEST ? G.intl.formatToPlainString(W(e, G.t["/TD0lZ"], G.t["/TD0lZ"], G.t["/TD0lZ"]), {
    user: l,
    game: t.application.name
  }) : "";
  else if (null != t.activity && t.activity.type === b.mFx.LISTEN) {
    let t = W(e, G.t.SaDdmJ, G.t.qsODho, G.t.WeiMTU);
    i = G.intl.formatToPlainString(t, {
      user: l
    })
  } else if (null != E && E.length > 0) i = G.intl.formatToPlainString(G.t.zY4v1N, {
    stickerName: E[0].name
  });
  else if (t.type === b.uaV.PREMIUM_REFERRAL) i = G.intl.formatToPlainString(G.t.lieTqa, {
    username: R.ZP.getName(n)
  });
  else if (null != t.poll) i = G.intl.formatToPlainString(G.t.ImizdH, {
