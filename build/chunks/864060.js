...
function M(e, t) {
  ...
  if (null == u || null == d || null == c || u.type === L.d4z.GROUP_DM && e.type === L.uaV.RECIPIENT_REMOVE || b.Z.areSlayerNotificationsSuppressed() && ((a = u).type === L.d4z.DM || null != a.linkedLobby) || !k(d, c, u, {
      ignoreStatus: o,
  ...
  if (N.Ec.has(u.type)) {
    ...
    let t = (0, _.J)(u);
    return t !== w.iN.NO_MESSAGES && (t === w.iN.ALL_MESSAGES || (0, f.Hl)({
      rawMessage: e,
      userId: d.id,
      suppressEveryone: !1,
      suppressRoles: !1
...
function F(e, t) {
  ...
  }) || y.ZP.isGuildOrCategoryOrChannelMuted(t.guild_id, t.id)) && (!!n || m.Z.getChannelId(Z.Z.getGuildId()) !== t.id) && y.ZP.getNewForumThreadsCreated(t)
}
let H = (e, t, n) => "".concat(e, " (").concat((0, a.F6)(t, v.default, I.Z, !0)).concat(null != n ? ", ".concat((0, a.F6)(n, v.default, I.Z)) : "", ")");
...
function z(e, t, n) {
  let i, l = U.ZP.getName(e.getGuildId(), e.id, n),
    u = l;
  switch (e.type) {
    case L.d4z.GUILD_ANNOUNCEMENT:
    case L.d4z.GUILD_TEXT:
  ...
  let f = t.content;
  if ((0, g.Z)(t) && null == (f = D.Z.stringify(t, e))) throw new r.Z("NotificationTextUtils").warn("SystemMessageUtils.stringify(...) could not convert", {
    message: t
  ...
  else if (null != t.activity && null != t.application) i = t.activity.type === L.mFx.JOIN ? G.intl.formatToPlainString(W(e, G.t.E8CgCg, G.t.c6KHWF, G.t.Fy7rJC), {
    user: l,
    game: t.application.name
  }) : t.activity.type === L.mFx.JOIN_REQUEST ? G.intl.formatToPlainString(W(e, G.t["/TD0lZ"], G.t["/TD0lZ"], G.t["/TD0lZ"]), {
    user: l,
    game: t.application.name
  }) : "";
  ...
  else if (t.type === L.uaV.PREMIUM_REFERRAL) i = G.intl.formatToPlainString(G.t.lieTqa, {
