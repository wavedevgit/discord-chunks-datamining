...
function w(t, e) {
  ...
  if (null == u || null == d || null == c || u.type === L.d4z.GROUP_DM && t.type === L.uaV.RECIPIENT_REMOVE || b.Z.areSlayerNotificationsSuppressed() && ((a = u).type === L.d4z.DM || null != a.linkedLobby) || !M(d, c, u, {
      ignoreStatus: o,
  ...
  if (T.Ec.has(u.type)) {
    ...
    let e = (0, _.J)(u);
    return e !== G.iN.NO_MESSAGES && (e === G.iN.ALL_MESSAGES || (0, f.Hl)({
      rawMessage: t,
      userId: d.id,
      suppressEveryone: !1,
      suppressRoles: !1
...
function F(t, e) {
  ...
  return !(null == e || null == l || null == a || !M(l, a, e, {
    ignoreStatus: i,
    ignoreNoMessagesSetting: !0
  }) || v.ZP.isGuildOrCategoryOrChannelMuted(e.guild_id, e.id)) && (!!n || Z.Z.getChannelId(m.Z.getGuildId()) !== e.id) && v.ZP.getNewForumThreadsCreated(e)
}
...
function x(t, e, n) {
  ...
  else if (null != e.activity && null != e.application) i = e.activity.type === L.mFx.JOIN ? k.intl.formatToPlainString(W(t, k.t.E8CgCg, k.t.c6KHWF, k.t.Fy7rJC), {
    user: l,
    game: e.application.name
  }) : e.activity.type === L.mFx.JOIN_REQUEST ? k.intl.formatToPlainString(W(t, k.t["/TD0lZ"], k.t["/TD0lZ"], k.t["/TD0lZ"]), {
    user: l,
    game: e.application.name
  }) : "";
  ...
  else if (e.type === L.uaV.PREMIUM_REFERRAL) i = k.intl.formatToPlainString(k.t.lieTqa, {
