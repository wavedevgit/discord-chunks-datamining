...
let F = (e, t, n) => "".concat(e, " (").concat((0, a.F6)(t, y.default, h.Z, !0)).concat(null != n ? ", ".concat((0, a.F6)(n, y.default, h.Z)) : "", ")");
...
function x(e, t, n) {
  ...
  if ("message_reference" in t ? (0, o.s)(t) : (0, o.Z)(t)) i = k.NW.string(k.t["9ddYKi"]);
  else if (null != t.activity && null != t.application) i = t.activity.type === L.mFx.JOIN ? k.NW.formatToPlainString(H(e, k.t.E8CgCg, k.t.c6KHWF, k.t.Fy7rJC), {
    user: l,
    ...
    i = k.NW.formatToPlainString(t, {
      user: l
    })
  } else if (null != E && E.length > 0) i = k.NW.formatToPlainString(k.t.zY4v1N, {
    stickerName: E[0].name
  });
  else if (t.type === L.uaV.PREMIUM_REFERRAL) i = k.NW.formatToPlainString(k.t.lieTqa, {
    username: R.ZP.getName(n)
  });
  else if (null != t.poll) i = k.NW.formatToPlainString(k.t.ImizdH, {
    ...
    i = k.NW.formatToPlainString(k.t["9WrecH"], {
      question: n
    })
