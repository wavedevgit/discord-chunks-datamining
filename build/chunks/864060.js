...
function M(t, e) {
  ...
  if (null == o || null == s || null == d || o.type === R.d4z.GROUP_DM && t.type === R.uaV.RECIPIENT_REMOVE || D.Z.areSlayerNotificationsSuppressed() && ((l = o).type === R.d4z.DM || null != l.linkedLobby) || !k(s, d, o, {
      ignoreStatus: r,
...
function H(t, e, n) {
  ...
  if ("message_reference" in e ? (0, r.s)(e) : (0, r.Z)(e)) i = L.intl.string(L.t["9ddYKi"]);
  else if (null != e.activity && null != e.application) i = e.activity.type === R.mFx.JOIN ? L.intl.formatToPlainString(F(t, L.t.E8CgCg, L.t.c6KHWF, L.t.Fy7rJC), {
    user: o,
    game: e.application.name
  }) : e.activity.type === R.mFx.JOIN_REQUEST ? L.intl.formatToPlainString(F(t, L.t["/TD0lZ"], L.t["/TD0lZ"], L.t["/TD0lZ"]), {
    user: o,
    game: e.application.name
  }) : "";
  else if (null != e.activity && e.activity.type === R.mFx.LISTEN) {
    let e = F(t, L.t.SaDdmJ, L.t.qsODho, L.t.WeiMTU);
    i = L.intl.formatToPlainString(e, {
      user: o
    })
  } else if (null != E && E.length > 0) i = L.intl.formatToPlainString(L.t.zY4v1N, {
    stickerName: E[0].name
  });
  else if (e.type === R.uaV.PREMIUM_REFERRAL) i = L.intl.formatToPlainString(L.t.lieTqa, {
    username: U.ZP.getName(n)
  });
  else if (null != e.poll) i = L.intl.formatToPlainString(L.t.ImizdH, {
    ...
    i = L.intl.formatToPlainString(L.t["9WrecH"], {
      question: n
    })
  ...
  return 0 === i.length && (i = function(t) {
    ...
    if (void 0 !== t.attachments && t.attachments.length > 0) {
      ...
      return L.intl.formatToPlainString(L.t["51OkwM"], {
        filename: e
      })
    }
    return ""
