...
function k(e, t) {
  ...
  if (null == o || null == d || null == c || o.type === L.d4z.GROUP_DM && e.type === L.uaV.RECIPIENT_REMOVE || O.Z.areSlayerNotificationsSuppressed() && ((a = o).type === L.d4z.DM || null != a.linkedLobby) || !G(d, c, o, {
      ignoreStatus: u,
  ...
  if (S.Ec.has(o.type)) {
    ...
    let t = (0, _.J)(o);
    return t !== b.iN.NO_MESSAGES && (t === b.iN.ALL_MESSAGES || (0, f.Hl)({
      rawMessage: e,
      userId: d.id,
      suppressEveryone: !1,
      suppressRoles: !1
...
let F = (e, t, n) => "".concat(e, " (").concat((0, a.F6)(t, y.default, C.Z, !0)).concat(null != n ? ", ".concat((0, a.F6)(n, y.default, C.Z)) : "", ")");
...
function W(e, t, n) {
  ...
  if ("message_reference" in t ? (0, u.s)(t) : (0, u.Z)(t)) i = M.intl.string(M.t["9ddYKi"]);
  else if (null != t.activity && null != t.application) i = t.activity.type === L.mFx.JOIN ? M.intl.formatToPlainString(H(e, M.t.E8CgCg, M.t.c6KHWF, M.t.Fy7rJC), {
    user: l,
    game: t.application.name
  }) : t.activity.type === L.mFx.JOIN_REQUEST ? M.intl.formatToPlainString(H(e, M.t["/TD0lZ"], M.t["/TD0lZ"], M.t["/TD0lZ"]), {
    user: l,
    game: t.application.name
  }) : "";
  ...
  } else if (null != E && E.length > 0) i = M.intl.formatToPlainString(M.t.zY4v1N, {
    stickerName: E[0].name
  });
  else if (t.type === L.uaV.PREMIUM_REFERRAL) i = M.intl.formatToPlainString(M.t.lieTqa, {
    username: R.ZP.getName(n)
  });
  else if (null != t.poll) i = M.intl.formatToPlainString(M.t.ImizdH, {
    ...
    i = M.intl.formatToPlainString(M.t["9WrecH"], {
      question: n
    })
