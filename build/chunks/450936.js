...
function b(e) {
  ...
  }), x = (0, a.Z)(C), v = (0, i.e7)([c.Z], () => c.Z.getAppIdForBotUserId(null == y ? void 0 : y.id)), j = (0, i.e7)([d.Z], () => {
    var e;
  ...
  r.useEffect(() => {
    if (null == O) {
      var e;
      (0, p.Z)(null != (e = null == y ? void 0 : y.id) ? e : m.lds, void 0, {
        withMutualGuilds: !0
      })
    }
  }, [y, O]), r.useEffect(() => {
    (null == y ? void 0 : y.id) != null && l.Z.dispatch({
      type: "APP_DM_OPEN",
      botUserId: y.id
    })
  }, [null == y ? void 0 : y.id]);
