...
function b(e) {
  ...
  }), x = (0, a.Z)(y), v = (0, i.e7)([c.Z], () => c.Z.getAppIdForBotUserId(null == C ? void 0 : C.id)), j = (0, i.e7)([d.Z], () => {
    var e;
  ...
  r.useEffect(() => {
    if (null == O) {
      var e;
      (0, p.Z)(null != (e = null == C ? void 0 : C.id) ? e : m.lds, void 0, {
        withMutualGuilds: !0
      })
    }
  }, [C, O]), r.useEffect(() => {
