...
function b(e) {
  ...
  }), x = (0, a.Z)(C), v = (0, i.e7)([c.Z], () => c.Z.getAppIdForBotUserId(null == _ ? void 0 : _.id)), j = (0, i.e7)([d.Z], () => {
    var e;
  ...
  r.useEffect(() => {
    if (null == O) {
      var e;
      (0, p.Z)(null != (e = null == _ ? void 0 : _.id) ? e : m.lds, void 0, {
        withMutualGuilds: !0
      })
    }
  }, [_, O]), r.useEffect(() => {
    (null == _ ? void 0 : _.id) != null && l.Z.dispatch({
      type: "APP_DM_OPEN",
      botUserId: _.id
    })
  }, [null == _ ? void 0 : _.id]);
