...
function d(e) {
  return {
    [r.jj.BLOCK_MESSAGE]: (e, t) => new Promise(e => {
      (0, s.ZDy)(async () => {
        let {
          default: s
    ...
    [r.jj.FLAG_TO_CHANNEL]: (t, l) => new Promise(d => {
      (0, s.ZDy)(async () => {
        let {
          default: s
        } = await n.e("74543").then(n.bind(n, 643611)), h = t.actions.find(e => e.type === r.jj.FLAG_TO_CHANNEL);
        return n => (0, i.jsx)(s, o(a({
          action: l,
          isEdit: null != h,
    ...
    [r.jj.USER_COMMUNICATION_DISABLED]: (e, t) => new Promise(l => {
      (0, s.ZDy)(async () => {
        let {
          default: s
        } = await n.e("78273").then(n.bind(n, 41767)), d = e.actions.find(e => e.type === r.jj.USER_COMMUNICATION_DISABLED);
        return n => (0, i.jsx)(s, o(a({
          action: t,
          isEdit: null != d,
...
function c(e) {
  (0, s.h7j)(t => (0, i.jsx)(s.ConfirmModal, o(a({
