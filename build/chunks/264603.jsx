...
function h() {
  ...
  return <div ref={module} className={i()(Chunk616257.panel, Chunk386.panel)}>{<Chunk481060.Text variant={"text-md/normal"}>{"Receive DMs In Game"}</Chunk481060.Text>}{<Chunk481060.PhF options={x} isSelected={e => e === t} select={Chunk695346.JG.updateSetting} popoutLayerContext={Chunk246992.O$} serialize={e => e.toString()} />}</div>
}