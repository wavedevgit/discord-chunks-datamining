...
function p(e) {
  ...
  return __OVERLAY__ ? null : e.id === a._ ? <i.sNh id={"create-category"} label={u.intl.string(u.t["ISN+ND"])} action={() => (0, i.ZDy)(async () => {
      let {
        default: e
      } = await n.e("1812").then(n.bind(n, 477782));
      return t => (0, r.jsx)(e, s({}, t))
    })} /> : t ? [<i.sNh id={"create-channel"} label={u.intl.string(u.t["fUYU+v"])} action={() => (0, i.ZDy)(async () => {
      let {
        default: t
    ...
    })} />, <i.sNh id={"create-category"} label={u.intl.string(u.t["ISN+ND"])} action={() => (0, i.ZDy)(async () => {
      let {
        default: t
      } = await Promise.all([n.e("45094"), n.e("45822")]).then(n.bind(n, 218613));
      return n => (0, r.jsx)(t, d(s({}, n), {
