...
function f(e) {
  ...
  return <c.Z modalType={"activity"} header={m.intl.formatToPlainString(m.t.QXYwoK, {
      applicationName: v.name
    })} body={m.intl.string(m.t["9hk2KC"])} problemTitle={m.intl.string(m.t.g1q5fn)} problems={(0, _.Z)(true, T)} freeformNeededProblems={p} onSubmit={function(e) {
      var t;
      let {
        rating: a,
        problem: c,
    ...
    }} onClose={y} transitionState={h} otherKey={s.K8.OTHER} />
}