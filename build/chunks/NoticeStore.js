  ...
  e$ = {
    ...
    [Chunk981631.kVF.PENDING_MEMBER]: {
      predicate: e => {
        ...
        return null != (r = null != i && null != o && !(null == (t = et.Z.getGuild(i)) ? true : t.features.has(eS.oNc.GUILD_ONBOARDING)) && (null == (n = ee.ZP.getMember(i, o.id)) ? true : n.isPending)) && r
      }
    },
    ...
    [Chunk981631.kVF.PREMIUM_TIER_2_DISCOUNT_ENDING]: {
      predicate: () => {
        ...
        return !!module && Chunk431.Z.getAlmostExpiringDiscountOffers([Chunk474936.Si.TIER_2]).length > 0 && !eX(Chunk981631.kVF.PREMIUM_TIER_2_DISCOUNT_ENDING)
      }
    },
    [Chunk981631.kVF.PREMIUM_UNCANCEL]: {
      predicate: e => {
        let {
          ...
          currentUser: n
        } = e, r = null != t ? o()(t.currentPeriodEnd).diff(o()().startOf("day"), "days") : 0, i = (null == t ? true : t.canceledAt) != null && (null == t ? true : t.status) === eS.O0b.CANCELED && 1 >= o()().diff(o()(t.canceledAt), "days"), a = null != t && o()(t.currentPeriodEnd).isBefore(o()()), s = null != t && t.status === eS.O0b.CANCELED && !a && r <= 7 && r >= 0 && (0, eO.M5)(n, eN.p9.TIER_2) && !i && !n.hasFreePremium() && !t.isPurchasedExternally;
      ...
      metadata: e => {
        ...
        } = e, r = null != n ? o()(n.currentPeriodEnd).diff(o()().startOf("day"), "days") : 0, i = null != n ? null == (t = (0, eO.Af)(n)) ? true : t.planId : null;
        return {
          daysLeft: r,
    ...
    [Chunk981631.kVF.PREMIUM_MISSING_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t ? o()(t.currentPeriodEnd).diff(o()().startOf("day"), "days") : 0, i = (null != t ? o()(t.currentPeriodEnd).diff(o()(t.currentPeriodStart).startOf("day"), "days") : 0) > 14 ? 7 : 2, a = null != t && o()(t.currentPeriodEnd).isBefore(o()()), s = eE.Z.applicationIdsFetched.has(eN.CL), l = eE.Z.getForApplication(eN.CL), c = null != t ? (0, eO.Af)(t) : null, u = null != c ? eO.ZP.getSkuIdForPlan(c.planId) : null, d = null != l && null != c && Array.from(l).filter(e => {
          let {
            skuId: t,
            consumed: n
          } = e;
          return !n && t === u
        }).length > 0, f = null != t && r <= i && r >= 0 && t.status !== eS.O0b.PAST_DUE && !a && s && !d && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [Chunk981631.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && null != t.paymentSourceId ? eh.Z.getPaymentSource(t.paymentSourceId) : null, i = null != t && o()(t.currentPeriodEnd).isBefore(o()()), a = null != t && t.status === eS.O0b.PAST_DUE && !i && null != r && r.invalid && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [Chunk981631.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && o()(t.currentPeriodEnd).isBefore(o()()), i = null != t && null != t.paymentSourceId ? eh.Z.getPaymentSource(t.paymentSourceId) : null, a = null != i && eR.Uk.has(i.type), s = null != t && t.status === eS.O0b.PAST_DUE && !r && a && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [Chunk981631.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
      predicate: e => {
        ...
        return null != t && null != N.Z.getMentionRaidDetected(t) && (null == n ? true : n.features.has(eS.oNc.COMMUNITY)) && !eX(eS.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION) || false
      },
      metadata: e => {
        let {
          selectedGuildId: t
...
function e0() {
  ...
  for (let n of Chunk188785.a ? eJ : eQ)
    if (null != e$[require] && e$[require].predicate({
      ...
      let a = null == (e = (t = e$[require]).metadata) ? true : module.call(exports, {
        currentUser: r,
        premiumSubscription: Chunk913527,
        selectedGuildId: o
      });
