  ...
  e$ = {
    ...
    [Chunk981631.kVF.PENDING_MEMBER]: {
      predicate: e => {
        ...
        return null != (r = null != i && null != a && !(null == (t = et.Z.getGuild(i)) ? true : t.features.has(eT.oNc.GUILD_ONBOARDING)) && (null == (n = ee.ZP.getMember(i, a.id)) ? true : n.isPending)) && r
      }
    },
    ...
    [Chunk981631.kVF.PREMIUM_UNCANCEL]: {
      predicate: e => {
        let {
          ...
          currentUser: n
        } = e, r = null != t ? a()(t.currentPeriodEnd).diff(a()().startOf("day"), "days") : 0, i = (null == t ? true : t.canceledAt) != null && (null == t ? true : t.status) === eT.O0b.CANCELED && 1 >= a()().diff(a()(t.canceledAt), "days"), o = null != t && a()(t.currentPeriodEnd).isBefore(a()()), s = null != t && t.status === eT.O0b.CANCELED && !o && r <= 7 && r >= 0 && (0, eO.M5)(n, eC.p9.TIER_2) && !i && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [Chunk981631.kVF.MFA_SMS_BACKUP]: {
      predicate: e => {
        ...
        return null != t && t.mfaEnabled && !t.hasFlag(eT.xW$.MFA_SMS) && !t.hasFlag(eT.xW$.STAFF) && !t.hasFlag(eT.xW$.PARTNER) && !eX(eT.kVF.MFA_SMS_BACKUP)
      }
    },
    ...
    [Chunk981631.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
      predicate: e => {
        ...
        return null != t && null != C.Z.getMentionRaidDetected(t) && (null == n ? true : n.features.has(eT.oNc.COMMUNITY)) && !eX(eT.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION) || false
      },
      metadata: e => {
        let {
          selectedGuildId: t
    ...
    [Chunk981631.kVF.SYSTEM_SERVICE_WARNING]: {
      predicate: e => {
        ...
        if (eX(eT.kVF.SYSTEM_SERVICE_WARNING) || !(0, Y.s2)(O.ZP) || null == t || en.Z.getMode() !== eT.pM4.PUSH_TO_TALK) returnfalse;
