  ...
  e0 = {
    ...
    [Chunk981631.kVF.PASSKEY_BACKUP]: {
      predicate: e => {
        ...
        return (null == t ? true : t.mfaEnabled) && K.Z.hasFetchedCredentials() && !K.Z.hasCredentials
      }
    },
    [Chunk981631.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: {
      predicate: () => {
        let e = Chunk431.Z.getAlmostExpiringTrialOffers([Chunk474936.Si.TIER_2]),
          {
            showNagbar: t
          } = (0, Chunk931118.xZ)("PremiumDiscountEndingNotice");
        return module.length > 0 && !eQ(Chunk981631.kVF.PREMIUM_TIER_2_TRIAL_ENDING) && exports
      }
    },
    ...
    [Chunk981631.kVF.PREMIUM_TIER_2_DISCOUNT_ENDING]: {
      predicate: () => {
        let e = Chunk431.Z.getAlmostExpiringDiscountOffers([Chunk474936.Si.TIER_2]),
          {
            showNagbar: t
          } = (0, Chunk931118.xZ)("PremiumDiscountEndingNotice");
        return module.length > 0 && !eQ(Chunk981631.kVF.PREMIUM_TIER_2_DISCOUNT_ENDING) && exports
      }
    },
    [Chunk981631.kVF.PREMIUM_UNCANCEL]: {
      predicate: e => {
        let {
          ...
          currentUser: n
        } = e, r = null != t ? a()(t.currentPeriodEnd).diff(a()().startOf("day"), "days") : 0, i = (null == t ? true : t.canceledAt) != null && (null == t ? true : t.status) === eA.O0b.CANCELED && 1 >= a()().diff(a()(t.canceledAt), "days"), o = null != t && a()(t.currentPeriodEnd).isBefore(a()()), s = null != t && t.status === eA.O0b.CANCELED && !o && r <= 7 && r >= 0 && (0, ev.M5)(n, eN.PremiumTypes.TIER_2) && !i && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [Chunk981631.kVF.SYSTEM_SERVICE_WARNING]: {
      predicate: e => {
        ...
        if (eQ(eA.kVF.SYSTEM_SERVICE_WARNING) || !(0, Y.s2)(O.ZP) || null == t || er.Z.getMode() !== eA.pM4.PUSH_TO_TALK) returnfalse;
