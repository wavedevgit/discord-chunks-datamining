...
function b(e) {
  ...
  }), S = (0, o.e7)([u.Z], () => u.Z.getState().soundshareEnabled), T = d.Z.supports(g.AN.DESKTOP_CAPTURE_APPLICATIONS), A = (0, o.e7)([d.Z], () => d.Z.supports(g.AN.SOUNDSHARE)), N = (0, o.e7)([d.Z], () => d.Z.supportsScreenSoundshare()), C = (0, p.Z)(t, v), P = (0, _.Z)(t, v, m.Vq), R = null != I && A && (!I.startsWith("screen") || N), w = i.useCallback(() => {
