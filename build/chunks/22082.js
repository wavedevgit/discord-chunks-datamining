...
function P(e, n) {
  ...
  if (null != t && null != n && t.has(n)) {
    var l;
    !_.ZP.isOptInEnabled(e) || (null == (l = g.Z.getChannel(n)) ? void 0 : l.isThread()) || null != E.ZP.ackMessageId(n) || u.Z.wait(() => (0, s.In)(n, {
      object: b.qAy.ACK_RECENT_CHANNEL_NEW_CHANNEL_VIEWED,
      objectType: b.Qqv.ACK_AUTOMATIC
    }, !0, !0, S.default.atPreviousMillisecond(n)))
  }
}
