...
function P(e, t) {
  ...
  if (null != n && null != t && n.has(t)) {
    var l;
    !E.ZP.isOptInEnabled(e) || (null == (l = f.Z.getChannel(t)) ? void 0 : l.isThread()) || null != C.ZP.ackMessageId(t) || u.Z.wait(() => (0, s.In)(t, {
      object: b.qAy.ACK_RECENT_CHANNEL_NEW_CHANNEL_VIEWED,
      objectType: b.Qqv.ACK_AUTOMATIC
    }, !0, !0, S.default.atPreviousMillisecond(t)))
  }
}
...
function y(e) {
  ...
  0 !== n.length && (Z[e] = new Set(n.filter(t => {
...
r = "NewChannelsStore", (i = "displayName") in O ? Object.defineProperty(O, i, {
  value: r,
  enumerable: !0,
  configurable: !0,
  writable: !0
