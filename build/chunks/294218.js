...
let M = i.memo(function(e) {
  ...
  let {
    ...
    allowLinks: !0,
    previewLinkTarget: !0
  }), K = i.type === b.uaV.REPLY ? i.messageReference : void 0, q = (0, c.e7)([d.Z], () => d.Z.getMessageByReference(K)), X = (0, a.JA)(i.id), J = (0, p.ZP)(i), Q = (0, c.e7)([_.Z], () => i.hasFlag(b.iLy.HAS_THREAD) && _.Z.getChannel(I.default.castMessageIdAsChannelId(i.id))), $ = (0, s.p9)({
    guildId: Z.guild_id,
    roleId: J.iconRoleId
  }), ee = (0, c.e7)([E.Z], () => E.Z.can(b.Plq.CREATE_INSTANT_INVITE, Z)), et = (0, m.Z)({
    message: i,
    channel: Z,
    enabled: G
  });
  ...
  return (0, r.jsx)(N.Z, h({
    ...
    childrenExecutedCommand: (0, P.Z)(i, Z, l),
    ...
    childrenSystemMessage: (0, C.Z)(U(h({}, e), {
      disableInteraction: B
    })),
    onContextMenu: v,
    onClick: k,
