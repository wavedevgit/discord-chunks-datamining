...
let Z = i.memo(function(e) {
  ...
  let {
    ...
    return i
  }(e, ["message", "compact", "className", "onContextMenu", "onClick", "hideSimpleEmbedContent", "channel", "isGroupStart", "animateAvatar", "subscribeToComponentDispatch", "renderThreadAccessory", "trackAnnouncementViews"]), V = l.type === T.uaV.POLL_RESULT || null != (t = e.disableInteraction) && t, z = l.isFirstMessageInForumPost(M), K = (0, u.A)((null != (n = l.editedTimestamp) ? n : l.timestamp).valueOf()), {
    content: Y,
    hasSpoilerEmbeds: X
  } = (0, E.Z)(l, {
