...
let R = i.memo(function(e) {
  ...
  let {
    ...
    return i
  }(e, ["message", "compact", "className", "onContextMenu", "onClick", "hideSimpleEmbedContent", "channel", "isGroupStart", "animateAvatar", "subscribeToComponentDispatch", "renderThreadAccessory", "trackAnnouncementViews"]), z = i.type === P.uaV.POLL_RESULT || null != (t = e.disableInteraction) && t, W = i.isFirstMessageInForumPost(M), K = (0, u.A)((null != (n = i.editedTimestamp) ? n : i.timestamp).valueOf()), {
    content: Y,
    hasSpoilerEmbeds: X
  } = (0, v.Z)(i, {
  ...
  return (0, r.jsx)(E.Z, w({
    ...
    childrenSystemMessage: (0, I.Z)(Z(w({}, e), {
      disableInteraction: z
    })),
    onContextMenu: k,
    onClick: D,
