...
let D = r.memo(function(e) {
  ...
  let {
    ...
    allowLinks: !0,
    previewLinkTarget: !0
  }), z = r.type === A.uaV.REPLY ? r.messageReference : void 0, Y = (0, a.e7)([u.Z], () => u.Z.getMessageByReference(z)), K = (0, s.JA)(r.id), q = (0, I.ZP)(r), X = (0, a.e7)([_.Z], () => r.hasFlag(A.iLy.HAS_THREAD) && _.Z.getChannel(h.default.castMessageIdAsChannelId(r.id))), J = (0, c.p9)({
    guildId: L.guild_id,
    roleId: q.iconRoleId
  }), Q = (0, T.Z)({
    message: r,
    channel: L,
    enabled: x
  }), $ = (0, C.iG)(r), ee = (0, C.Gx)(r);
  return (0, i.jsx)(p.Z, y({
    compact: l,
    className: o()(D, {
    ...
    childrenSystemMessage: (0, f.Z)(b(y({}, e), {
      disableInteraction: G
    })),
    onContextMenu: v,
    onClick: U,
