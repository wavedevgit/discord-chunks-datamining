...
function f(e) {
  ...
  let {
    ...
    width: m,
    height: A
  } = b, y = null != (t = null == i ? true : i.length) ? t : 0, O = m - 16, j = A - (p + h), {
    tileStyle: v,
    tileWidth: x,
    rows: E,
    columns: _
  ...
  })(y, O, j), [y, O, j]), C = _ + 1, S = C * x + (C - 1) * 8 <= m, I = Math.floor(x / c) + 8, N = Math.max(0, j - I * E) / 2;
  return (0, r.jsx)(s.A, {
    fade: true,
    className: n,
    ...
    renderRow: function(e) {
      ...
      return (0, r.jsx)("div", {
        className: o.nM,
        children: null == i || null == (t = i.slice(n, n + _)) ? true : t.map((e, t) => {
          var l;
          let i = n + t;
          return (0, r.jsx)("div", {
            style: v,
