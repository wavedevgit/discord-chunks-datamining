/** Chunk was on web.js **/
/** chunk id: 290424, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  $: () => c
});
...
function c(e, t = {}) {
  ...
  for (let t in e) Object.prototype.hasOwnProperty.call(e, t) && (r.has(t) || n && i.has(t) || u && a.has(t) || d && s.has(t) || f && o.has(t) || t.endsWith("Capture") && o.has(t.slice(0, false)) || (null == p ? true : p.has(t)) || l.test(t)) && (_[t] = e[t]);
  return _
}