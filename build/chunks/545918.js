...
function J(e) {
  let {
    ...
    currentTab: i,
    onTabSelect: a
  } = e, s = (0, f.W)(t.id), c = q.NW.string(q.t.oclz3d), d = q.NW.string(q.t.oclz3d);
  return (0, m.Tt)({
    location: t.name,
    subsection: c
  }), (0, r.jsxs)(_.Z, {
...
function Y(e) {
  ...
  let {
    ...
    guildId: n
  })) ? t : 0, [u, m] = l.useState(i > 0 ? P.e.PENDING : P.e.ALL_MEMBERS), f = (0, s.e7)([R.Z], () => R.Z.getGuild(n)), {
    analyticsLocations: v
  } = (0, d.ZP)(c.Z.MEMBER_SAFETY_PAGE), _ = (0, p.C)({
    guildId: n
  }), {
    guildJoinRequests: D
  } = (0, C.j)({
  ...
  }, [u, u, _, Q]), ee = l.useCallback(async e => {
  ...
  let et = (0, s.e7)([I.ZP], () => null != I.ZP.getGuildSidebarState(n), [n]),
    en = l.useCallback(e => {
      (0, h.Y)(e.guildId) ? (0, x.r)(e.guildId, e.userId, G.oC.MEMBER_SAFETY, {
        ...
        analyticsLocation: {
          section: F.jXE.MEMBER_SAFETY_PAGE
        }
      })
    }, [v]);
  if (null == f || !q) return null;
  let er = u === P.e.ALL_MEMBERS ? (0, r.jsxs)(r.Fragment, {
    ...
    el = u === P.e.ALL_MEMBERS ? (0, r.jsx)(L.Z, {
      guildId: f.id
    }) : (0, r.jsx)(M.Z, {
      guildId: f.id
    });
  return (0, r.jsxs)(d.Gt, {
    ...
    children: [(0, r.jsxs)("div", {
      className: a()(K.chat, U.page, {
        [K.threadSidebarOpen]: et
      }),
      children: [(0, r.jsx)(J, {
        guild: f,
        previousChannel: H,
