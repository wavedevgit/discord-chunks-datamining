...
function Y(e) {
  let {
    ...
    currentTab: i,
    onTabSelect: a
  } = e, o = (0, f.W)(t.id), c = U.NW.string(U.t.oclz3d), d = U.NW.string(U.t.oclz3d);
  return (0, m.Tt)({
    location: t.name,
    subsection: c
  }), (0, r.jsxs)(v.Z, {
...
function K(e) {
  ...
  let {
    ...
    guildId: n
  })) ? t : 0, [u, m] = l.useState(i > 0 ? P.e.PENDING : P.e.ALL_MEMBERS), f = (0, o.e7)([R.Z], () => R.Z.getGuild(n)), {
    analyticsLocations: _
  } = (0, d.ZP)(c.Z.MEMBER_SAFETY_PAGE), v = (0, N.C)({
    guildId: n
  }), {
    guildJoinRequests: D
  } = (0, g.j)({
  ...
  }, [u, u, v, Q]), ee = l.useCallback(async e => {
