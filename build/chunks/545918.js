...
function J(e) {
  let {
    ...
    currentTab: a,
    onTabSelect: i
  } = e, s = (0, f.W)(t.id), c = z.NW.string(z.t.oclz3d), d = z.NW.string(z.t.oclz3d);
  return (0, m.Tt)({
    location: t.name,
    subsection: c
  }), (0, r.jsxs)(_.Z, {
...
function Q(e) {
  ...
  let {
    ...
    guildId: n
  })) ? t : 0, [u, m] = l.useState(a > 0 ? O.e.PENDING : O.e.ALL_MEMBERS), f = (0, s.e7)([R.Z], () => R.Z.getGuild(n)), {
    analyticsLocations: g
  } = (0, d.ZP)(c.Z.MEMBER_SAFETY_PAGE), _ = (0, C.C)({
    guildId: n
  }), {
    guildJoinRequests: B
  } = (0, p.j)({
  ...
  }, [u, u, _, X]), ee = l.useCallback(async e => {
  ...
  let et = (0, s.e7)([E.ZP], () => null != E.ZP.getGuildSidebarState(n), [n]),
    en = l.useCallback(e => {
      (0, h.Y)(e.guildId) ? (0, x.r)(e.guildId, e.userId, q.oC.MEMBER_SAFETY, {
        ...
        analyticsLocation: {
          section: W.jXE.MEMBER_SAFETY_PAGE
        }
      })
    }, [g]);
  if (null == f || !z) return null;
  let er = u === O.e.ALL_MEMBERS ? (0, r.jsxs)(r.Fragment, {
    ...
    el = u === O.e.ALL_MEMBERS ? (0, r.jsx)(D.Z, {
      guildId: f.id
    }) : (0, r.jsx)(M.Z, {
      guildId: f.id
    });
