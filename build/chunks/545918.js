...
function G(e) {
  let {
    ...
    currentTab: n,
    onTabSelect: l
  } = e, i = (0, j.W)(t.id), a = k.intl.string(k.t.oclz3d), s = k.intl.string(k.t.oclz3d);
  return (0, u.Tt)({
    location: t.name,
    subsection: a
  }), (0, r.jsxs)(v.Z, {
...
function F(e) {
  ...
  let {
    ...
    guildId: n
  })) ? t : 0, [u, j] = l.useState(i > 0 ? E.e.PENDING : E.e.ALL_MEMBERS), v = (0, s.e7)([N.Z], () => N.Z.getGuild(n)), {
  ...
  }, [u, u, D, q]), J = l.useCallback(async e => {
  ...
  return null != v && F ? (0, r.jsxs)(d.Gt, {
    value: y,
    children: [(0, r.jsxs)("div", {
      className: a()(B.chat, L.page, {
        [B.threadSidebarOpen]: K
      }),
      children: [(0, r.jsx)(G, {
        guild: v,
        currentTab: u,
        ...
        children: (0, r.jsx)("div", {
          ...
          children: u === E.e.ALL_MEMBERS ? (0, r.jsxs)(r.Fragment, {
    ...
    }), U && (u === E.e.ALL_MEMBERS ? (0, r.jsx)(w.Z, {
      guildId: v.id
    }) : (0, r.jsx)(O.Z, {
      guildId: v.id
    }))]
