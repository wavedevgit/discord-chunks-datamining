...
function q(e) {
  let {
    ...
    currentTab: i,
    onTabSelect: a
  } = e, s = (0, b.W)(t.id), c = z.intl.string(z.t.oclz3d), d = z.intl.string(z.t.oclz3d);
  return (0, m.Tt)({
    location: t.name,
    subsection: c
  }), (0, r.jsxs)(C.Z, {
...
function V(e) {
  ...
  let {
    ...
    guildId: n
  })) ? t : 0, [u, m] = l.useState(i > 0 ? O.e.PENDING : O.e.ALL_MEMBERS), b = (0, s.e7)([I.Z], () => I.Z.getGuild(n)), {
  ...
  }, [u, u, C, Y]), W = l.useCallback(async e => {
  ...
  return null != b && G ? (0, r.jsxs)(d.Gt, {
    value: _,
    children: [(0, r.jsxs)("div", {
      className: a()(U.chat, F.page, {
        [U.threadSidebarOpen]: X
      }),
      children: [(0, r.jsx)(q, {
        guild: b,
        previousChannel: J,
    ...
    }), z && (u === O.e.ALL_MEMBERS ? (0, r.jsx)(k.Z, {
      guildId: b.id
    }) : (0, r.jsx)(w.Z, {
      guildId: b.id
    }))]
