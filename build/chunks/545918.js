...
function Y(e) {
  let {
    ...
    currentTab: i,
    onTabSelect: a
  } = e, s = (0, f.W)(t.id), c = U.NW.string(U.t.oclz3d), d = U.NW.string(U.t.oclz3d);
  return (0, m.Tt)({
    location: t.name,
    subsection: c
  }), (0, r.jsxs)(v.Z, {
...
function J(e) {
  ...
  let er = u === y.e.ALL_MEMBERS ? (0, r.jsxs)(r.Fragment, {
    ...
    el = u === y.e.ALL_MEMBERS ? (0, r.jsx)(L.Z, {
      guildId: f.id
    }) : (0, r.jsx)(M.Z, {
      guildId: f.id
    });
  return (0, r.jsxs)(d.Gt, {
    ...
    children: [(0, r.jsxs)("div", {
      className: a()(V.chat, q.page, {
        [V.threadSidebarOpen]: et
      }),
      children: [(0, r.jsx)(Y, {
        guild: f,
        previousChannel: H,
