...
function V(e) {
  let {
    ...
    currentTab: i,
    onTabSelect: a
  } = e, s = (0, f.W)(t.id), d = F.intl.string(F.t.oclz3d), u = F.intl.string(F.t.oclz3d);
  return (0, x.Tt)({
    location: t.name,
    subsection: d
  }), (0, r.jsxs)(T.Z, {
...
function J(e) {
  ...
  let {
    ...
    guildId: n
  })) ? t : 0, [o, m] = l.useState(i > 0 ? R.e.PENDING : R.e.ALL_MEMBERS), x = (0, s.e7)([O.Z], () => O.Z.getGuild(n)), {
    analyticsLocations: f
  } = (0, u.ZP)(d.Z.MEMBER_SAFETY_PAGE), C = (0, g.C)({
    guildId: n
  }), {
    guildJoinRequests: T
  } = (0, v.j)({
  ...
  }, [o, o, C, Y]), W = l.useCallback(async e => {
  ...
  return null != x && D ? (0, r.jsxs)(u.Gt, {
    value: f,
    children: [(0, r.jsxs)("div", {
      className: a()(q.chat, U.page, {
        [q.threadSidebarOpen]: X
      }),
      children: [(0, r.jsx)(V, {
        guild: x,
        previousChannel: J,
        ...
        children: (0, r.jsx)("div", {
          ...
          children: o === R.e.ALL_MEMBERS ? (0, r.jsxs)(r.Fragment, {
    ...
    }), z && (o === R.e.ALL_MEMBERS ? (0, r.jsx)(k.Z, {
      guildId: x.id
    }) : (0, r.jsx)(A.Z, {
      guildId: x.id
    }))]
