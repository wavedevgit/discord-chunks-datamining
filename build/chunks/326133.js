...
let P = 490,
  ...
  k = i.forwardRef(function(e, t) {
    ...
    }, [k.guild_id]), V = i.useRef(null), [F, Z, H] = (0, O.Z)(N(S({}, e), {
      guild: B
    }), t, V), Y = (null == (n = M.autocomplete) ? void 0 : n.forceChatLayer) ? g.ZP : m.ZP, W = (0, f.DJ)(F.selectedIndex);
    ...
    if (i.useEffect(() => {
        U(F.isVisible)
      }, [U, F.isVisible]), !F.isVisible || null == F.query || void 0 === K) return null;
    let X = null != (a = F.query.typeInfo.renderResults({
