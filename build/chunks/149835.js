...
function f(t, e) {
  ...
  function O() {
    ...
    a.h(t.id, t.branchId, e), u.default.track(d.rMx.APPLICATION_SETTINGS_UPDATED, p({
      hidden_enabled: (0, s.yE)(e, d.eHb.HIDDEN)
    }, t.getAnalyticsData()))
  }
  return (0, r.jsx)(l.sNh, {
    ...
    action: function() {
      null != t && null != e && (t.isHidden() || !f ? O() : (0, l.h7j)(t => {
        var n, i;
        return (0, r.jsx)(l.ConfirmModal, (n = p({
          ...
          children: (0, r.jsx)(l.Text, {
            ...
            children: b.intl.format(b.t.HXfjKi, {
              name: e.name
            })
          })
