...
let u = Chunk73800.forwardRef(function(e, t) {
  let {
    ...
    plated: N
  } = e, y = "function" == typeof p ? <p width={20} height={20} size={"custom"} colorClass={null != g ? g : ""} color={"currentColor"} /> : p;
  return <o.ua7 tooltipClassName={_} text={n} aria-label={C} color={S} tooltipContentClassName={I} forceOpen={T}>{e => {
      var n, o, {
          onClick: p,
          onMouseEnter: g,
          onMouseLeave: _
