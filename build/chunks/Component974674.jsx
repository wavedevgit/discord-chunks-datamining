...
function Z(e) {
  let {
    ...
    isTyping: r,
    size: i
  } = e, a = n && !r && t === m.Skl.ONLINE, o = (0, g.UC)(i);
...
function F(e) {
  let {
    ...
    width: (0, g.px)(n),
    height: (0, g.px)(n)
  }, C = null == _ || m ? true : P(_, E, y), A = I.size * h.hs, N = R(E, n, y, O), w = null != v && (0, r.jsx)("svg", {
    width: A + S,
    height: A,
...
function V(e) {
  ...
  } = e, H = n !== m.Skl.UNKNOWN ? n : null, Y = (0, g.UC)(a), W = null != H ? Math.ceil((Y.status * g.D6 - Y.status) / 2) : 0, K = Y.size + W, z = (0, u.vj)(H, s), q = i.useId();
...
function W(e) {
  let {
  ...
  } = e, J = (0, u.vj)(R, w), $ = i.useId(), ee = i.useId(), [et] = i.useState(() => O({
    fill: a
  }, Z({
    size: T,
    status: n,
    ...
    fill: ec
  } = er, eu = I(er, ["avatarCutoutX", "avatarCutoutY", "avatarCutoutWidth", "avatarCutoutHeight", "avatarCutoutRadius", "fill"]), ed = (0, g.px)(T), ef = (0, g.UC)(T), ep = ef.status * g.D6, e_ = ef.status * g.EW, em = null != R ? (ef.status * g.D6 - ef.status) / 2 : 0, eh = ef.size + Math.ceil(em), [eg, eE, eb] = (0, l.q_F)({
    config: {
      tension: 450,
      friction: 20,
      clamp: true
  ...
  }, A() ? "animate-always" : "animate-never", [K, R]);
  return (0, r.jsx)(F, S(O({}, e), {
    ariaLabel: V,
    ariaHidden: k,
    typingOffset: em,
