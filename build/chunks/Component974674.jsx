...
function F(e) {
  let {
    ...
    width: (0, g.px)(n),
    height: (0, g.px)(n)
  }, C = null == _ || h ? true : P(_, E, y), A = I.size * m.hs, N = w(E, n, y, O), R = null != v && (0, r.jsx)("svg", {
    width: A + S,
    height: A,
...
let B = Chunk473749.forwardRef((e, t) => {
  let {
    src: n,
    isSpeaking: i,
    isLatched: a,
...
function V(e) {
  ...
  } = e, H = n !== h.Skl.UNKNOWN ? n : null, Y = (0, g.UC)(a), W = null != H ? Math.ceil((Y.status * g.D6 - Y.status) / 2) : 0, K = Y.size + W, z = (0, u.vj)(H, s), q = i.useId();
  return (0, r.jsx)(F, S(O({}, e), {
    ariaLabel: P,
    ariaHidden: N,
    status: H,
    specs: Y,
    ...
    children: (0, r.jsxs)("svg", {
      ...
      children: [null != M && k(q, Y, {
        ...
        width: Y.size,
        height: Y.size,
        mask: null != M ? "url(#".concat(q, ")") : "url(#".concat(R(H, a, l, f), ")"),
        children: (0, r.jsx)(B, {
          ref: m,
          src: t,
          isSpeaking: E,
      ...
      }), null != H && null != A ? L(A, l, Y, H) : null, null != H ? (0, r.jsx)(d.u, {
        ...
        delay: C,
        children: (0, r.jsxs)("g", {
          children: [(0, r.jsx)("rect", S(O({}, D(Y, H, l, f)), {
            fill: z,
      ...
      }) : null, null != j && U(Y, j), null != V && G(Y, l, f, {
        avatarTooltipTitle: V,
        avatarTooltipText: Z
      }, M)]
    })
...
function W(e) {
  let {
  ...
  } = e, J = (0, u.vj)(w, R), $ = i.useId(), ee = i.useId(), [et] = i.useState(() => O({
    fill: a
  }, Z({
    size: T,
    status: n,
    ...
    fill: ec
  } = er, eu = I(er, ["avatarCutoutX", "avatarCutoutY", "avatarCutoutWidth", "avatarCutoutHeight", "avatarCutoutRadius", "fill"]), ed = (0, g.px)(T), ef = (0, g.UC)(T), ep = ef.status * g.D6, e_ = ef.status * g.EW, eh = null != w ? (ef.status * g.D6 - ef.status) / 2 : 0, em = ef.size + Math.ceil(eh), [eg, eE, eb] = (0, l.q_F)({
    config: {
      tension: 450,
      friction: 20,
      clamp: true
  ...
  }, A() ? "animate-always" : "animate-never", [K, w]);
  return (0, r.jsx)(F, S(O({}, e), {
    ariaLabel: V,
    ariaHidden: k,
    typingOffset: eh,
    ...
    children: (0, r.jsxs)("svg", {
      ...
      }), null != j && L(j, f, ef, w), (0, r.jsx)(d.u, {
        text: D ? (0, _.u5)(w) : null,
        ariaHidden: true,
        position: "top",
        spacing: H(ef.status, ef.stroke, f, p),
        delay: x,
        children: (0, r.jsxs)(s.animated.g, {
          transform: eg.scale.to(e => "scale(".concat(e, ") ").concat(Y(ef, e, w))),
          children: [(0, r.jsxs)("svg", {
            width: ep,
            height: e_,
            viewBox: "0 0 ".concat(ep, " ").concat(e_),
            className: D ? b.cursorDefault : true,
...
let z = Chunk473749.memo(function(e) {
  ...
  let {
    isMobile: o = false,
    isTyping: s = false
  } = a, l = i.useRef(n), c = i.useRef(o), d = (0, u.vj)(n, t), f = i.useRef(d), p = i.useRef(false), _ = p.current || K(s, n, l.current, o, c.current);
  return i.useLayoutEffect(() => {
    p.current = _, l.current = n, c.current = o, f.current = d
  }, [n, o, d, _]), null != n && null != l.current && _ ? (0, r.jsx)(W, S(O({}, a), {
    status: n,
    statusColor: d,
