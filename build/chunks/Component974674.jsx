...
function V(e) {
  ...
  return (0, r.jsx)(B, S(O({}, e), {
    ...
    children: (0, r.jsxs)("svg", {
      ...
      }), null != Z && null != T ? L(T, l, V, Z) : null, null != Z ? (0, r.jsx)(d.aM, {
      ...
      }) : null, null != R && U(V, R), null != M && G(V, l, f, {
        avatarTooltipTitle: M,
        avatarTooltipText: j
      }, x)]
    })
...
function W(e) {
  let {
    ...
    fill: es
  } = et, el = I(et, ["avatarCutoutX", "avatarCutoutY", "avatarCutoutWidth", "avatarCutoutHeight", "avatarCutoutRadius", "fill"]), ec = (0, g.px)(y), eu = (0, g.UC)(y), ed = eu.status * g.D6, ef = eu.status * g.EW, ep = null != T ? (eu.status * g.D6 - eu.status) / 2 : 0, e_ = eu.size + Math.ceil(ep), [em, eh, eg] = (0, l.q_F)({
    config: {
      tension: 450,
      friction: 20,
      clamp: true
