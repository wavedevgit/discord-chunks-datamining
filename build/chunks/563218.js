...
function b(e) {
  ...
  return i.useEffect(() => (t.addEventListener("resize", x), c.S.subscribe(h.CkL.REMEASURE_TARGET, x), () => {
    t.removeEventListener("resize", x), c.S.unsubscribe(h.CkL.REMEASURE_TARGET, x)
