/** Chunk was on web.js **/
/** chunk id: 755416, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  Z: () => s
});
var Chunk463424 = require("./463424.js"),
  Chunk897000 = require("./897000.js"),
  Chunk886138 = require("./886138.js"),
  Chunk347418 = require("./347418.js");
let s = {
  read: c
};
...
function f(e, t, n) {
  try {
    ...
    e._raw = (e._raw || "") + o;
    let a = m(i);
    return (0, r.wB)(e, S(g(a, true))), true
  } catch (e) {
    returnfalse
  }
}
...
function h(e, t, n = false) {
  try {
    ...
    if ("ParseError" === r.name && (0, a.U)(r) && !n) return h(e, (0, a.v)(t), true);
    throw r
  }
}
...
function B(e, t) {
  let n = Z(e);
  true !== e.value["rdf:Description"] && (e = e.value["rdf:Description"]), (0, r.wB)(n, Z(e), F(e));
  let i = V(e);
  return {
    value: i,
    attributes: n,
