...
class ef extends Chunk73800.PureComponent {
  ...
  renderStreamState() {
    ...
    if (null != Chunk512722 && null == o) {
      if ((null == exports ? true : exports.type) === Chunk354459.fO.STREAM) return (0, Chunk255367.jsx)(Chunk916771.Z, {
        stream: exports.stream,
        width: require,
        avError: Chunk512722
      });
      else if ((null == exports ? true : exports.type) === Chunk354459.fO.USER) return (0, Chunk255367.jsx)(Chunk249212.Z, {
    ...
    switch (true) {
      ...
      case (null == module ? true : module.state) === Chunk981631.jm8.FAILED:
        return (0, Chunk255367.jsx)(Chunk916771.Z, {
          stream: module,
          width: require
        });
      case (null == exports ? true : exports.type) === Chunk354459.fO.HIDDEN_STREAM:
        return (0, Chunk255367.jsx)(Chunk792517.Z, {
          participant: exports,
          width: require
        });
      case Chunk73800:
        return (0, Chunk255367.jsx)(Chunk351483.Z, {
          width: require
        })
    }
    return null
  ...
  render() {
    let {
      ...
      isVideoEnabled: i,
      width: a
    } = this.props, o = (0, Chunk933557.F6)(module, Chunk594174.default, Chunk699516.Z), s = (null == require ? true : require.id) === Chunk314897.default.getId() && Chunk73800, l = this.renderStreamState(), c = this.activeStreamForSelectedParticipant, u = null;
    return (null == require ? true : require.type) !== Chunk354459.fO.ACTIVITY && (null != l ? u = l : ((null == require ? true : require.type) === Chunk354459.fO.USER || (null == require ? true : require.type) === Chunk354459.fO.STREAM) && (u = (0, Chunk255367.jsx)(Chunk484286.Z, {
      paused: this.streamerPaused,
      streamId: exports,
      component: Chunk131951.Z.getVideoComponent(),
      mirror: Chunk392711,
      children: (0, Chunk255367.jsx)(Chunk266910.Z, {
    ...
    }))), (0, Chunk255367.jsx)(Chunk937995.ZP, {
      timeout: 1800,
      children: e => {
        var t;
