...
function N(e) {
  ...
  return <c.Z className={(0, E.l)(y, "actions", t)} type={t} source={n} activity={i} applicationStream={o} user={s} guildId={l} look={a.zx.Looks.FILLED} color={null != f ? f : a.zx.Colors.PRIMARY} channelId={u} onAction={d} />
}
...
function C(e) {
  ...
  }, [null == t ? true : t.type, A, R]), (null == t ? true : t.type) !== b.IIU.HANG_STATUS || A) ? <l.Z{...T(v({}, O), {
    activity: t,
    user: n,
    application: D,
    hideHeader: E,
