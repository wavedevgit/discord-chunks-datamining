...
function q(e) {
  var {
    ...
    disableSelection: i
  } = e, a = I(e, ["rowData", "selectedDestinations", "handleToggleDestination", "disableSelection"]);
  let o = l.useMemo(() => [t.length], [t.length]),
    ...
    h = l.useCallback(e => {
      ...
      return a === p.h8.USER ? (0, r.jsx)(U, R({
        user: o
      }, h)) : a === p.h8.GROUP_DM ? (0, r.jsx)(z, R({
        channel: o
      }, h)) : a === p.h8.TEXT_CHANNEL || a === p.h8.VOICE_CHANNEL ? (0, r.jsx)(H, R({
        channel: o
      }, h)) : void(0, C.vE)(a)
    }, [i, s, t, f]),
    m = l.useRef(null),
