...
function z(e) {
  var {
    ...
    disableSelection: s
  } = e, i = U(e, ["rowData", "selectedDestinations", "handleToggleDestination", "disableSelection"]);
  let u = l.useMemo(() => [t.length], [t.length]),
    ...
    b = l.useCallback(e => {
      ...
      return i === h.h8.USER ? (0, r.jsx)(H, k({
        user: u
      }, p)) : i === h.h8.GROUP_DM ? (0, r.jsx)(F, k({
        channel: u
      }, p)) : i === h.h8.TEXT_CHANNEL || i === h.h8.VOICE_CHANNEL ? (0, r.jsx)(q, k({
        channel: u
      }, p)) : void(0, T.vE)(i)
    }, [s, a, t, f]),
    m = l.useRef(null),
