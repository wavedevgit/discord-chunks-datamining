...
function g(e) {
  ...
  return <div className={d.container} style={{
      width: E,
      height: E,
      padding: O.stroke
    }} aria-label={"".concat(null != (t = _()) ? t : "")}>{<div className={d.trophyIconContainer}><l.rm8 size={"custom"} color={u ? C : (0, s.Lq)(v.trophy)} width={j} height={j} /></div>}{!u && <div className={d.lockContainer} style={x}><l.mBM{...h({
        size: "custom",
        color: (0, s.Lq)(v.locked)
      }, S)} /></div>}{u && y === c.EP.LEGENDARY && <div className={d.lockContainer} style={x}><a.Z{...h({
