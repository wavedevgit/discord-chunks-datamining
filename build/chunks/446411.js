...
n.d(t, {
  BC: () => er,
  ZP: () => ea
}), n(388685), n(539854), n(953529), n(35282);
var r, i = n(255367),
  a = n(73800),
  o = n(120356),
  s = n.n(o),
...
function er(e) {
  ...
  let {
    ...
    sourceMetadata: M
  } = e, [U, B] = a.useState(b), Z = null != d && null == d.proxyURL, V = a.useCallback(() => B(!1), [B]), H = e => {
    e.preventDefault(), e.stopPropagation(), null == I || I(!1), B(!0), Z && (P.S.dispatch(G.CkL.VIDEO_EMBED_PLAYBACK_STARTED), P.S.subscribeOnce(G.CkL.VIDEO_EMBED_PLAYBACK_STARTED, V))
  };
  a.useEffect(() => () => {
    Z && P.S.unsubscribe(G.CkL.VIDEO_EMBED_PLAYBACK_STARTED, V)
  }, [Z, V]);
  let {
    width: Y,
    height: W
  ...
  Y = Math.max(K.width, X), W = Math.max(K.height, Q);
  let z = (0, w.q)(u);
  ...
  if (U && null != d) {
    let e, t = !0 === y || "function" == typeof y && y(),
      n = {
        width: Y,
        height: W
      },
...
class ea extends(r = a.PureComponent) {
  ...
  renderThumbnail() {
    ...
    return null == t ? null : (0, i.jsx)(U.G.Consumer, {
      children: i => {
        let {
          disableAnimations: l
        } = i;
  ...
  renderImages() {
    ...
    return null == c && null == u && null == d && null == f ? null : (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(g.h.Provider, {
          value: (0, T.P)(s.images[0].url, s.images[0]),
          children: c
        }, 0), null != f && (0, i.jsx)(g.h.Provider, {
        ...
        children: [(0, i.jsx)(g.h.Provider, {
          ...
          children: u
        }, 1), null == f && null != d && (0, i.jsx)(g.h.Provider, {
          value: (0, T.P)(null == (n = s.images[2]) ? void 0 : n.url, s.images[2]),
          children: d
        }, 2), null != f && (0, i.jsx)(g.h.Provider, {
    ...
    if (n)
      if (e && !this.state.isImageHovered) {
        ...
        this.props.showImageRecs && (0, d.a)({
          ...
          withCommands: !0
        }), R.default.track(G.rMx.IMAGE_HOVERED, {
  ...
  renderImage() {
    ...
    let y = (0, w.q)(l),
      ...
      } : (0, S.G)(d.map(e => z(W({}, (0, E.Hv)(e, b, "IMAGE")), {
        original: e.url,
    ...
    "jpg" === N && (N = "jpeg");
    let C = null != l && !O.uo.test(null == l ? void 0 : l.url) && !(l.srcIsAnimated && O.YG.test(null == l ? void 0 : l.url)) && !(l.srcIsAnimated && O.FH.test(null == l ? void 0 : l.url)),
      R = !0 !== this.props.isSearchResult && o && (null == (t = this.props.message) ? void 0 : t.channel_id) != null && (null == (n = this.props.message) ? void 0 : n.channel_id) !== void 0 && C && !eo(l) && null != N;
      ...
      children: e => (0, i.jsx)(U.G.Consumer, {
        children: t => {
          ...
          return f(z(W({}, A), {
            ...
            onClick: v[y],
            onMouseEnter: () => this.handleImageHover(!0, l, R),
            onMouseLeave: () => this.handleImageHover(!1, l, R),
            renderAdjacentContent: () => {
              var e, t;
              return !0 === this.props.showImageRecs && R ? this.renderImageHoverButtons({
                mimeType: ["image", N],
  ...
  renderVideo() {
    ...
    if (e) return null == o ? null : (0, i.jsx)(U.G.Consumer, {
      children: e => {
        let {
          disableAnimations: s
        } = e;
  ...
  renderAll() {
    ...
    let c = this.renderFooter(),
      u = null == t;
    return n.type === G.hBH.RICH && (u = null == n.video), {
      provider: a,
      author: o,
      title: s,
      description: e,
  ...
  getMaxWidth(e) {
    ...
    if (i === G.hBH.RICH && void 0 !== n) return J;
    if (i === G.hBH.GIFV) {
      var u, d, f, _;
      let {
        width: e
      } = (0, x.Tj)({
        width: null != (d = null != (u = null == r ? void 0 : r.width) ? u : null == a ? void 0 : a.width) ? d : 0,
        height: null != (_ = null != (f = null == r ? void 0 : r.height) ? f : null == a ? void 0 : a.height) ? _ : 0,
        maxWidth: o,
        maxHeight: s
      });
      return e
  ...
  usesJustifiedAutoStyle() {
    ...
    return e.type === G.hBH.IMAGE || e.type === G.hBH.VIDEO || e.type === G.hBH.GIFV || (e.type === G.hBH.RICH || e.type === G.hBH.ARTICLE) && (null != e.video || null != e.image)
  }
  getEmbedColor(e) {
    let {
      color: t
  ...
  getSpoilerStyles(e) {
    ...
    if (void 0 === d && void 0 === i && o !== G.hBH.RICH) {
      let e = null != r ? r : a;
      if (void 0 !== e) {
        let {
          minWidth: n,
  ...
  render() {
    ...
    return null != t.provider && M.j.includes(t.provider.name) ? (0, i.jsx)(M.Z, {
      embed: t,
      className: r
    }) : (0, A.Z)(t) ? (0, i.jsx)(N.Z, {
      embed: t,
      className: r
    }) : (null == (e = t.provider) ? void 0 : e.name) === "Amazon Music" && t.type === G.hBH.RICH ? (0, i.jsx)(b.Z, {
      embed: t,
      className: r
    }) : (0, _.Z)(t) ? (0, i.jsx)(p.Z, {
      embed: t,
      className: r
    }) : this.isInline() ? null != n ? (0, i.jsx)(h.ZP, {
    ...
    }) : this.renderInlineMediaEmbed() : null != n ? (0, i.jsx)(h.ZP, {
