...
function q(e) {
  ...
  let {
    ...
    sourceMetadata: B
  } = e, [V, W] = i.useState(y), F = null != c && null == c.proxyURL, Z = i.useCallback(() => W(!1), [W]), G = e => {
...
class X extends(r = i.PureComponent) {
  ...
  renderThumbnail() {
    ...
    return null == l ? null : (0, n.jsx)(V.G.Consumer, {
      children: n => {
        let {
          disableAnimations: o
        } = n;
  ...
  renderImages() {
    ...
    let [d, u, c, h] = a.images.map(e => this.renderImage({
      hiddenSpoiler: i,
      isVisible: s,
      image: e,
      isGalleryImage: !0,
    ...
    return null == d && null == u && null == c && null == h ? null : (0, n.jsxs)("div", {
      ...
      children: [(0, n.jsxs)("div", {
        ...
        children: [(0, n.jsx)(f.h.Provider, {
          value: (0, O.P)(a.images[0].url, a.images[0]),
          children: d
        }, 0), null != h && (0, n.jsx)(f.h.Provider, {
        ...
        children: [(0, n.jsx)(f.h.Provider, {
          ...
          children: u
        }, 1), null == h && null != c && (0, n.jsx)(f.h.Provider, {
          value: (0, O.P)(null == (t = a.images[2]) ? void 0 : t.url, a.images[2]),
          children: c
        }, 2), null != h && (0, n.jsx)(f.h.Provider, {
  ...
  renderImage() {
    ...
    let {
      ...
      image: d,
      isGalleryImage: u = !1,
      alt: c = F.intl.string(F.t.X4IxWF),
      allImages: h = null
    } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, {
    ...
    let j = (0, E.q)(d),
      ...
      } : (0, P.G)(h.map(e => Y(z({}, (0, v.Hv)(e, x, "IMAGE")), {
        original: e.url,
  ...
  renderVideo() {
    ...
    return null == r || null == i ? null : e ? null == s ? null : (0, n.jsx)(V.G.Consumer, {
      children: e => {
        let {
          disableAnimations: a
        } = e;
  ...
  renderFooter() {
    ...
    if (null != e) {
      ...
      return (0, n.jsxs)("div", {
        ...
        children: [null != t ? (0, n.jsx)("img", {
          alt: "",
          className: _.embedFooterIcon,
          src: t
        }) : null, (0, n.jsxs)("span", {
          className: _.embedFooterText,
          children: [e.text, null != e.text && null != l ? (0, n.jsx)("span", {
            className: _.embedFooterSeparator,
            children: "•"
          }) : null, null != l ? (0, T.Y4)(l) : null]
        })]
      })
    }
    if (null != l) return (0, n.jsx)("div", {
      className: a()(_.embedFooter, _.embedMargin),
  ...
  renderAll() {
    ...
    let d = this.renderFooter(),
      u = null == l;
    return t.type === D.hBH.RICH && (u = null == t.video), {
      provider: i,
      author: s,
      title: a,
      description: e,
  ...
  render() {
    ...
    return null != l.provider && B.j.includes(l.provider.name) ? (0, n.jsx)(B.Z, {
      embed: l,
      className: r
    }) : (0, S.Z)(l) ? (0, n.jsx)(N.Z, {
      embed: l,
      className: r
    }) : (null == (e = l.provider) ? void 0 : e.name) === "Amazon Music" && l.type === D.hBH.RICH ? (0, n.jsx)(y.Z, {
      embed: l,
      className: r
    }) : (0, m.Z)(l) ? (0, n.jsx)(p.Z, {
      embed: l,
      className: r
    }) : this.isInline() ? null != t ? (0, n.jsx)(g.ZP, {
    ...
    }) : this.renderInlineMediaEmbed() : null != t ? (0, n.jsx)(g.ZP, {
