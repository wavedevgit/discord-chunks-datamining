...
function W(t, e) {
  ...
  }, [e, t]), B = (0, a.e7)([N.Z], () => null == t || t.isPrivate() || N.Z.can(R.Plq.SEND_MESSAGES, t), [t]), K = (0, a.Wu)([C.Z], () => [...z.map(t => null != t.application_id && C.Z.getState(t.application_id, R.mFx.JOIN) === R.OcF.LOADING), ...H.map(t => C.Z.getState(t.applicationId, R.mFx.JOIN) === R.OcF.LOADING)], [z, H]), Q = (0, s.Z)([...z.filter(t => (null == t ? void 0 : t.application_id) != null).map(t => t.application_id), ...H.map(t => t.applicationId)]), tt = null == t ? void 0 : t.id, te = (0, a.Wu)([j.Z, h.Z, O.Z, g.Z, E.Z, P.Z, N.Z], () => [...z.map(t => (0, w.Z)({
    user: null != e ? e : X,
    activity: t,
  ...
  })], [z, Q, tt, X, H, e]), ti = (0, a.Wu)([p.Z, Z.default], () => z.map(t => t.type === R.IIU.LISTENING && null != e ? (0, y.Z)(p.Z, Z.default, e, t) : void 0), [e, z]), tn = (0, c.O)();
  ...
  let tl = (i, n) => {
    ...
    ta = (l, a) => {
      ...
      if (null != d && null != r) {
        ...
        if (null != t && t.type === R.d4z.GUILD_VOICE) return (0, o.ZDy)(async () => {
          let {
            default: e
  ...
  return null == q || q.forEach(i => {
    ...
    (null == e ? void 0 : e.id) !== Z.default.getId() && (t.type === R.IIU.PLAYING && (0, Y.Z)(t, R.xjy.JOIN) ? tr.push((0, n.jsx)(o.sNh, {
      id: "invite-to-join",
      label: M.intl.string(M.t["3fRyS0"]),
      subtext: t.name,
      action: () => tl(R.mFx.JOIN, t)
    }, "self".concat(i))) : t.type === R.IIU.LISTENING && (0, Y.Z)(t, R.xjy.SYNC) && tr.push((0, n.jsx)(o.sNh, {
      id: "invite-to-listen",
