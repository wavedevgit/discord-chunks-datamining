...
function M(t, e) {
  ...
  } = (0, s.ZP)(), X = (0, o.e7)([_.default], () => _.default.getCurrentUser()), q = (0, o.e7)([A.ZP], () => A.ZP.getSelfEmbeddedActivities()), $ = (0, o.Wu)([m.Z], () => m.Z.getActivities().filter(t => null == t.application_id || !(null == q ? void 0 : q.has(t.application_id)))), z = (0, o.Wu)([S.Z], () => null != e ? S.Z.getActivities(e.id, null == t ? void 0 : t.getGuildId()) : [], [e, t]), H = (0, o.Wu)([A.ZP], () => {
  ...
  }, [e, t]), B = (0, o.e7)([h.Z], () => null == t || t.isPrivate() || h.Z.can(F.Plq.SEND_MESSAGES, t), [t]), K = (0, o.Wu)([C.Z], () => [...z.map(t => null != t.application_id && C.Z.getState(t.application_id, F.mFx.JOIN) === F.OcF.LOADING), ...H.map(t => C.Z.getState(t.applicationId, F.mFx.JOIN) === F.OcF.LOADING)], [z, H]), Q = (0, u.Z)([...z.filter(t => (null == t ? void 0 : t.application_id) != null).map(t => t.application_id), ...H.map(t => t.applicationId)]), tt = null == t ? void 0 : t.id, te = (0, o.Wu)([N.Z, O.Z, j.Z, g.Z, E.Z, P.Z, h.Z], () => [...z.map(t => (0, w.Z)({
    user: null != e ? e : X,
    activity: t,
  ...
  })], [z, Q, tt, X, H, e]), ti = (0, o.Wu)([p.Z, Z.default], () => z.map(t => t.type === F.IIU.LISTENING && null != e ? (0, y.Z)(p.Z, Z.default, e, t) : void 0), [e, z]), tn = (0, r.O)();
  ...
  let tl = (i, n) => {
    ...
    to = (l, o) => {
      ...
      return null == d || null == c ? void 0 : null != e ? T.pu({
        ...
        let {
          default: e
        } = await Promise.all([i.e("7654"), i.e("49049"), i.e("50875")]).then(i.bind(i, 560114));
        return i => {
          var l, a;
