...
function M(t, e) {
  ...
  } = (0, u.ZP)(), X = (0, a.e7)([_.default], () => _.default.getCurrentUser()), q = (0, a.e7)([A.ZP], () => A.ZP.getSelfEmbeddedActivities()), $ = (0, a.Wu)([m.Z], () => m.Z.getActivities().filter(t => null == t.application_id || !(null == q ? void 0 : q.has(t.application_id)))), z = (0, a.Wu)([S.Z], () => null != e ? S.Z.getActivities(e.id, null == t ? void 0 : t.getGuildId()) : [], [e, t]), H = (0, a.Wu)([A.ZP], () => {
  ...
  }, [e, t]), B = (0, a.e7)([h.Z], () => null == t || t.isPrivate() || h.Z.can(F.Plq.SEND_MESSAGES, t), [t]), K = (0, a.Wu)([C.Z], () => [...z.map(t => null != t.application_id && C.Z.getState(t.application_id, F.mFx.JOIN) === F.OcF.LOADING), ...H.map(t => C.Z.getState(t.applicationId, F.mFx.JOIN) === F.OcF.LOADING)], [z, H]), Q = (0, s.Z)([...z.filter(t => (null == t ? void 0 : t.application_id) != null).map(t => t.application_id), ...H.map(t => t.applicationId)]), tt = null == t ? void 0 : t.id, te = (0, a.Wu)([N.Z, O.Z, j.Z, g.Z, E.Z, P.Z, h.Z], () => [...z.map(t => (0, w.Z)({
    user: null != e ? e : X,
    activity: t,
  ...
  })], [z, Q, tt, X, H, e]), ti = (0, a.Wu)([p.Z, Z.default], () => z.map(t => t.type === F.IIU.LISTENING && null != e ? (0, y.Z)(p.Z, Z.default, e, t) : void 0), [e, z]), tn = (0, c.O)();
  ...
  let tl = (i, n) => {
    ...
    ta = (l, a) => {
      ...
      if (null != d && null != r) {
        ...
        if (null != t && t.type === F.d4z.GUILD_VOICE) return (0, o.ZDy)(async () => {
          let {
            default: e
          } = await Promise.all([i.e("7654"), i.e("49049"), i.e("47966")]).then(i.bind(i, 560114));
          return i => {
            var l, o;
        ...
        if ((null == t ? void 0 : t.id) != null) return T.sN({
  ...
  return null == q || q.forEach(i => {
    ...
    null != i.launchId && !l && a && null != d && tr.push((0, n.jsx)(o.sNh, {
    ...
    (null == e ? void 0 : e.id) !== Z.default.getId() && (t.type === F.IIU.PLAYING && (0, Y.Z)(t, F.xjy.JOIN) ? tr.push((0, n.jsx)(o.sNh, {
      id: "invite-to-join",
      label: J.NW.string(J.t["3fRyS0"]),
      subtext: t.name,
      action: () => tl(F.mFx.JOIN, t)
    }, "self".concat(i))) : t.type === F.IIU.LISTENING && (0, Y.Z)(t, F.xjy.SYNC) && tr.push((0, n.jsx)(o.sNh, {
      id: "invite-to-listen",
      label: J.NW.string(J.t["5vvGpa"]),
      subtext: t.name,
      action: () => tl(F.mFx.LISTEN, t)
    }, "self".concat(i))))
  }), tr.length > 0 && tr.push((0, n.jsx)(o.Clw, {})), z.forEach((i, l) => {
    ...
    if (i.type === F.IIU.PLAYING && (0, Y.Z)(i, F.xjy.JOIN) && (!a || d) && null != i.session_id && null != i.application_id)
      ...
      tr.push((0, n.jsx)(o.sNh, {
        ...
        disabled: d
      }, "spotify-play-".concat(i.session_id)), (0, n.jsx)(o.sNh, {
    ...
    te[a] && null != c && tr.push((0, n.jsx)(o.sNh, {
      id: "embedded-activity-join-".concat(t.applicationId),
      label: r,
      disabled: d,
      hint: K[a] ? (0, n.jsx)(o.$jN, {
        type: o.$jN.Type.PULSING_ELLIPSIS
      }) : null,
      subtext: c.name,
      action: () => td(t)
