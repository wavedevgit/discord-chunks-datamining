...
function M(t, e) {
  ...
  })], [$, K, Q, W, z, e]), te = (0, l.Wu)([s.Z, v.default], () => $.map(t => t.type === F.IIU.LISTENING && null != e ? (0, b.Z)(s.Z, v.default, e, t) : void 0), [e, $]), ti = (0, r.O)();
    ...
    tl = (l, o) => {
      ...
      if (null != d && null != r) {
        ...
        if (null != t && t.type === F.d4z.GUILD_VOICE) return (0, a.ZDy)(async () => {
          let {
            default: e
          } = await Promise.all([i.e("7654"), i.e("49049"), i.e("17029")]).then(i.bind(i, 560114));
          return i => {
            var l, a;
        ...
        if ((null == t ? void 0 : t.id) != null) return x.sN({
  ...
  return null == X || X.forEach(i => {
    ...
    (null == e ? void 0 : e.id) !== v.default.getId() && (t.type === F.IIU.PLAYING && (0, D.Z)(t, F.xjy.JOIN) ? td.push((0, n.jsx)(a.sNh, {
      id: "invite-to-join",
      label: J.intl.string(J.t["3fRyS0"]),
      subtext: t.name,
