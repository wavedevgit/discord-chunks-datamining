...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk680474 = require("./680474.js"),
  Chunk571737 = require("./571737.jsx"),
  Chunk796150 = require("./796150.js"),
  Chunk946542 = require("./946542.js"),
  Chunk213746 = require("./213746.jsx"),
  Chunk979007 = require("./979007.js"),
  Chunk981631 = require("./981631.js"),
  Chunk388032 = require("./388032.jsx"),
  Chunk714002 = require("./714002.js");
let P = function(e) {
  let {
    applicationId: t,
    ...
    V = a.useMemo(() => {
      ...
      switch (Z) {
        case y.GlobalDiscoveryAppsSections.ABOUT:
          return <b.Z application={A} />;
        case y.GlobalDiscoveryAppsSections.STORE:
          return <j.Z application={A} />
      }
    }, [Z, A]),
    H = a.useCallback(e => {
  ...
  return <c.Z onScroll={P} ref={T}><s.Z>{null == A ? null == L || L === u.M.FETCHING ? (0, r.jsx)("div", {
