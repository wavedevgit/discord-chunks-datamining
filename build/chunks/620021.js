...
function j(l) {
  ...
  return (0, t.jsxs)(t.Fragment, {
    children: [e || null == n || n.id === h.default.getId() ? null : (0, t.jsx)(o.Zbd, {
...
let b = function(l) {
  ...
  }), [f, y] = r.useState(!1), [I, M] = r.useState(null != (e = null == b ? void 0 : b.nick) ? e : ""), [Z, G] = r.useState({});
  (0, c.ZP)(() => {
  ...
  let z = (0, x.sE)(a, {
    ...
    P = r.useCallback(async l => {
      ...
      try {
        ...
        (null == e ? void 0 : e.nick) != null ? l = (null == (o = e.nick) || null == (s = o._errors) || null == (r = s[0]) ? void 0 : r.message) || E.intl.string(E.t.xex86u) : (null == e ? void 0 : e.username) != null && (l = (null == (m = e.username) || null == (h = m._errors) || null == (c = h[0]) ? void 0 : c.message) || E.intl.string(E.t.xex86u)), G({
          nick: l
        })
      }
    }, [a, I, d, i, b, z]);
