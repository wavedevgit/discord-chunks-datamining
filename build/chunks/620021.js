...
function p(l) {
  ...
  return (0, t.jsxs)(t.Fragment, {
    children: [n || null == e || e.id === x.default.getId() ? null : (0, t.jsx)(o.Zbd, {
...
let b = function(l) {
  ...
  } = l, j = (0, s.e7)([k.ZP], () => null != a ? k.ZP.getMember(a, i.id) : null), A = (0, s.e7)([m.Z, g.default, N.Z], () => {
    var l;
  ...
  }), [f, I] = r.useState(!1), [M, Z] = r.useState(null != (n = null == j ? void 0 : j.nick) ? n : ""), [z, P] = r.useState({});
  (0, d.ZP)(() => {
  ...
  let G = (0, c.sE)(a, {
    ...
    L = r.useCallback(async l => {
      ...
      try {
        ...
        (null == n ? void 0 : n.nick) != null ? l = (null == (o = n.nick) || null == (s = o._errors) || null == (r = s[0]) ? void 0 : r.message) || C.intl.string(C.t.xex86u) : (null == n ? void 0 : n.username) != null && (l = (null == (N = n.username) || null == (k = N._errors) || null == (d = k[0]) ? void 0 : d.message) || C.intl.string(C.t.xex86u)), P({
          nick: l
        })
      }
    }, [a, M, x, i, j, G]);
