...
let b = function(l) {
  ...
  }), [f, I] = r.useState(!1), [M, Z] = r.useState(null != (e = null == j ? void 0 : j.nick) ? e : ""), [z, P] = r.useState({});
  (0, d.ZP)(() => {
    ...
    L = r.useCallback(async l => {
      ...
      try {
        I(!0), await u.tn.patch({
          ...
          body: h,
          rejectWithError: !1
        }), G(c.jQ.CHANGE_NICKNAME), x()
      } catch (i) {
        let l;
        I(!1);
        let e = null != (t = null == (n = i.body) ? void 0 : n.errors) ? t : null;
        (null == e ? void 0 : e.nick) != null ? l = (null == (o = e.nick) || null == (s = o._errors) || null == (r = s[0]) ? void 0 : r.message) || C.intl.string(C.t.xex86u) : (null == e ? void 0 : e.username) != null && (l = (null == (N = e.username) || null == (k = N._errors) || null == (d = k[0]) ? void 0 : d.message) || C.intl.string(C.t.xex86u)), P({
          nick: l
        })
      }
    }, [a, M, x, i, j, G]);
