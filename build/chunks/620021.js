...
function E(l) {
  let {
    ...
    error: u,
    hasNick: d
  } = l, c = r.useRef(null), k = r.useCallback(() => {
    var l;
    i(""), null == (l = c.current) || l.focus()
  }, [i]);
  return (0, t.jsxs)(t.Fragment, {
    children: [e || null == n || n.id === x.default.getId() ? null : (0, t.jsx)(o.Zbd, {
      ...
      onChange: i,
      autoFocus: !0
    }), null != u ? (0, t.jsx)(o.Text, {
      variant: "text-xs/normal",
      color: "text-danger",
      className: p.nickError,
      children: u
    }) : null, d && !e ? (0, t.jsx)(o.zxk, {
...
let b = function(l) {
  ...
  } = l, j = (0, s.e7)([k.ZP], () => null != a ? k.ZP.getMember(a, i.id) : null), A = (0, s.e7)([h.Z, m.default, N.Z], () => {
    var l;
  ...
  }), [f, I] = r.useState(!1), [M, Z] = r.useState(null != (e = null == j ? void 0 : j.nick) ? e : ""), [z, G] = r.useState({});
  (0, d.ZP)(() => {
    ...
    y = r.useCallback(async l => {
      ...
      try {
        I(!0), await u.tn.patch({
          ...
          body: h,
          rejectWithError: !1
        }), P(c.jQ.CHANGE_NICKNAME), x()
      } catch (i) {
        let l;
        I(!1);
        let e = null != (t = null == (n = i.body) ? void 0 : n.errors) ? t : null;
        (null == e ? void 0 : e.nick) != null ? l = (null == (o = e.nick) || null == (s = o._errors) || null == (r = s[0]) ? void 0 : r.message) || _.intl.string(_.t.xex86u) : (null == e ? void 0 : e.username) != null && (l = (null == (N = e.username) || null == (k = N._errors) || null == (d = k[0]) ? void 0 : d.message) || _.intl.string(_.t.xex86u)), G({
          nick: l
        })
      }
    }, [a, M, x, i, j, P]);
