...
class F extends(n = Chunk73800.PureComponent) {
  ...
  renderDefaultForm() {
    ...
    return <div className={Chunk472645.mainLoginContainer}><Chunk388905.gO>{<Chunk952802.Z alpha2={exports.alpha2} countryCode={exports.code.split(" ")[0]} className={Chunk20493.marginBottom20} label={Chunk388032.intl.string(Chunk388032.t.tUjnxs)} error={null != (e = this.renderError("login")) ? module : this.renderError("email")} onChange={(e, t) => this.setState({
            login: e,
            loginPrefix: t
          })} setRef={this.setLoginRef} autoCapitalize={"none"} autoComplete={"off"} autoCorrect={"off"} spellCheck={"false"} value={this.state.login} autoFocus={!require} required={true} />}{<Chunk388905.II label={Chunk388032.intl.string(Chunk388032.t["CIGa+/"])} error={this.renderError("password")} onChange={e => this.setState({
            password: e
          })} name={"password"} type={"password"} setRef={this.setPasswordRef} autoComplete={"off"} spellCheck={"false"} autoFocus={require} value={this.state.password} required={true} />}{<Chunk388905.zx onClick={this.handleForgotPassword} look={Chunk755721.zx.Looks.LINK} color={Chunk755721.zx.Colors.LINK} className={Chunk20493.marginTop4}>{Chunk388032.intl.string(Chunk388032.t.wWIufn)}</Chunk388905.zx>}</Chunk388905.gO></div>
  }
  renderDefault() {
    let {
      loginStatus: e,
    ...
    return <Chunk255367.Fragment>{<Chunk37148.x title={Chunk388032.intl.string(Chunk388032.t.bPP34e)} subtitle={Chunk388032.intl.string(Chunk388032.t.rvx0T0)} />}{<Chunk103866.f>{this.renderDefaultForm()}</Chunk103866.f>}{<Chunk369585.G leading={(0, Chunk255367.jsx)(Chunk481060.Avr, {
          variant: "secondary",
          size: "md",
          onClick: exports,
  ...
  renderMFA() {
    ...
    return <Chunk124860.Cd mfaFinish={this.handleTokenSubmitMFA} mfaChallenge={module} onEarlyClose={() => {
        this.handleReset()
      }} width={"100%"} headerAlignStart={true} />
  }
  renderDisabledAccount() {
    ...
    return <Chunk255367.Fragment>{<Chunk37148.x title={exports} subtitle={require} />}{<Chunk369585.G leading={(0, Chunk255367.jsx)(Chunk481060.Text, {
  ...
  renderPhonePasswordRecovery() {
    ...
    return <Chunk103866.f><Chunk379760.Z title={Chunk388032.intl.string(Chunk388032.t["+xqy3d"])} subtitle={Chunk388032.intl.format(Chunk388032.t.ef4uZ2, {
          onResendClick: this.handleResendCode
        })} error={module} onSubmit={this.handlePasswordReset} onCancel={true} /></Chunk103866.f>
  }
  render() {
    let {
      loginStatus: e
...
let N = function(e) {
  ...
  return <l.I size={"md"} onClose={t} transitionState={r}><F{...D(L({}, u, h), {
      transitionTo: O.uL,
      replaceWith: O.dL,
      onBackPressed: d,
