...
function j() {
  ...
  Object.values(module).forEach(e => {
    ...
    g.info("id: ".concat(e.id)), g.info("name: ".concat(t)), g.info("default name: ".concat(n)), g.info("recipients ids: ".concat(e.recipients)), e.recipients.forEach(e => {
      ...
      g.info("username: ".concat(n)), g.info("global name: ".concat(a)), g.info("nickname: ".concat(l)), g.info("guild nicknames: ".concat(r)), v()
    })
    ...
    g.info("username: ".concat(r)), g.info("global name: ".concat(i)), g.info("nickname: ".concat(s)), v()
...
function C() {
  ...
  module.forEach(e => {
    ...
    let t = o.Z.getScoreWithoutFetchingLatest(e.id);
    g.info("id: ".concat(e.id, " - Frecency Score: ").concat(t)), g.info("default name: ".concat((0, l.on)(e, p.default, m.Z))), g.info("name: ".concat((0, l.F6)(e, p.default, m.Z)))
  ...
  g.info("START Quick Switcher State"), g.info("Query: ".concat(module.query)), module.results.forEach(e => {
    switch (g.info("Result Type: ".concat(e.type)), e.type) {
      ...
      case b.h8.DM:
        ...
        break;
      case b.h8.GROUP_DM:
        g.info("channel type: ".concat(e.record.type)), g.info("channel id: ".concat(e.record.id)), g.info("name: ".concat((0, l.F6)(e.record, p.default, m.Z))), e.record.isGroupDM() && (g.info("default name: ".concat((0, l.on)(e.record, p.default, m.Z))), g.info("recipient id: ".concat(e.record.recipients)), e.record.recipients.forEach(e => {
          let t = p.default.getUser(e);
          null != t && (g.info("recipient username: ".concat(t.username)), g.info("recipient global name: ".concat(f.ZP.getGlobalName(t))), g.info("recipient nickname: ".concat(m.Z.getNickname(t.id))))
        }));
        break;
