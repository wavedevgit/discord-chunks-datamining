...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk915614 = require("./915614.js"),
  Chunk268861 = require("./268861.jsx"),
  Chunk690336 = require("./690336.js"),
...
let Y = !Chunk358085.isPlatformEmbedded && false,
  Q = Y ? <Chunk70097.Z src={"https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExNzdpcnRrYXdrNzVuNjZ3NXpmeTJvNGl4Z2N4OXBsamx5aXphdHhxaCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9dg/OPg2B0FPBL94H12uM0/giphy480p.mp4"} className={Chunk960972.videoDev} autoPlay={true} loop={true} muted={true} /> : null,
  K = null;
...
let q = Chunk73800.memo(function(e) {
    ...
    return <c.P3F className={l()(H.overlayBackground, {
        [H.overlayActive]: !r,
        [H.overlayLocked]: r
      })} onMouseDown={e => {
        let {
      ...
      }} onContextMenu={J}>{r ? null : (0, i.jsx)(R.Z, {
  ...
  $ = Chunk73800.memo(function(e) {
    ...
    return t && n ? <R.Z className={H.closeContainer}><A.Z onClick={() => d.Z.setInputLocked(false, (0, N.getPID)())} IconComponent={c.d$P} /></R.Z> : null
  });
...
function er(e) {
  ...
  }, [o, n]), <f.Gt value={R}>{j || h ? null : (0, i.jsx)(c.f6W, {
