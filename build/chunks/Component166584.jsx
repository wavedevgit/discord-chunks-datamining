...
function j(e) {
  ...
  }, [P, j] = i.useState(f), [k, M] = i.useState(D), [U, G] = i.useState(false), B = i.useRef(null), Z = i.useRef(null), F = i.useRef(0);
  i.useLayoutEffect(() => {
    F.current = 0
  }, [f]), i.useLayoutEffect(() => {
    if (U) return;
    ...
    j(n.length === P.length ? P : n), M(r), F.current++
  }, [f, P, U]);
