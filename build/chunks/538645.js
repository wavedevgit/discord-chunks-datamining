...
function x() {
  let {
    profileEffects: e,
    upsertConfig: t
  } = (0, g.n6)(), [n, s] = r.useState(), x = r.useRef(null), E = (0, o.Wu)([m.Z], () => m.Z.profileEffects), [C, O] = r.useState(""), j = r.useMemo(() => "" === C ? E : E.filter(e => {
    let t = C.toLowerCase();
    ...
    children: [null == n && (0, i.jsxs)(i.Fragment, {
      children: [(0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)("div", {
          ...
          className: h.grid,
          children: Object.values(e).map(e => (0, i.jsx)(b, {
            effect: e,
            onClick: e => {
              s(e)
            }
        ...
        children: [(0, i.jsx)(c.X6q, {
          ...
          className: h.pfxGrid,
          children: j.map(e => (0, i.jsx)(c.P3F, {
