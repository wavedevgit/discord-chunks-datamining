...
let O = 1e3,
  v = e => {
    ...
    }, [L, n, M]), G) ? <div>{<div className={y.videoContainer}>{<div className={y.entryAnimationContainer}><d.Z playsInline={true} muted={true} autoPlay={true} onEnded={S} className={a()(y.video, "entry" === O ? y.visible : y.hidden)}><source src={x.modalGlowEntry} /></d.Z></div>}{<d.Z ref={I} playsInline={true} muted={true} loop={true} className={a()(y.video, "idle" === O ? y.visible : y.hidden)}><source src={x.modalGlowIdle} /></d.Z>}{<d.Z ref={T} playsInline={true} muted={true} className={a()(y.video, "exit" === O ? y.visible : y.hidden)}><source src={x.modalGlowExit} /></d.Z>}</div>}{<div className={y.wowAnimation}><l._dj fit={"layout"} ref={k} dataBinding={{
            ExitTrigger: j
          }} /></div>}{<div className={"exit" === O ? y.exitAnimationContainer : y.entryAnimationContainer}>{t}</div>}</div> : t
  }