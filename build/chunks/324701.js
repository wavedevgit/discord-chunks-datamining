...
async function E(e) {
  ...
  if (null != await (0, l.XA)(p).catch(e => {
      var t, n, r;
      return (null == e || null == (t = e.body) ? void 0 : t.code) === d.evJ.TOO_MANY_SAVED_MESSAGES ? o.Z.show({
      ...
      }) : (0, i.showToast)((0, i.createToast)(null != (r = null == e || null == (n = e.body) ? void 0 : n.message) ? r : _.intl.string(_.t.R0RpRU), i.ToastType.FAILURE)), null
    }) && t) {
