...
async function h(e) {
  ...
  if (null == c.Z.getSavedMessage(h.channelId, h.messageId) && !(0, u.Z)()) return void(0, i.ZDy)(async () => {
    let {
      default: e
  ...
  if (null != await (0, s.XA)(h).catch(e => {
      ...
      return (null == e || null == (t = e.body) ? void 0 : t.code) === d.evJ.TOO_MANY_SAVED_MESSAGES ? l.Z.show({
        ...
        body: m.intl.formatToPlainString(m.t["1zVbEB"], {
          max: p.D
        }),
        cancelText: m.intl.string(m.t.BddRzc),
        confirmText: m.intl.string(m.t.ZGbTc3),
        onConfirm: () => o.S.dispatch(d.CkL.TOGGLE_FOR_LATER)
      }) : (0, i.showToast)((0, i.createToast)(null != (r = null == e || null == (n = e.body) ? void 0 : n.message) ? r : m.intl.string(m.t.R0RpRU), i.ToastType.FAILURE)), null
    }) && t) {
