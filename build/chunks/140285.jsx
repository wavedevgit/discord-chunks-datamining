...
function m(e) {
  ...
  return <i.FXm className={u.__invalid_channelAccessSelect} radioItemClassName={u.__invalid_channelAccessSelectRadioButton} withTransparentBackground={true} size={i.FXm.Sizes.NOT_SET} onChange={e => {
      let {
        value: t
      } = e;
      return h(t)
      ...
      icon: (0, i.GSL)(o.Z),
      radioBarClassName: u.__invalid_channelAccessSelectRadioBar
    }]} value={p} aria-labelledby={t} disabled={n} />
}