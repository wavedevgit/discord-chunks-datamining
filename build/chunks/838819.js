...
let Y = e => {
  ...
  X = function(e) {
    ...
    }), (0, I.q3)(u, Q, ea, ee, eo), (0, I.EB)(Q, q), (0, H.Z)(), l.useEffect(() => {
    ...
    let [eL, eB] = l.useState(1), {
      isPaginationEnabled: ew,
      categoriesPerPage: eN
    } = (0, k.a)("CollectiblesShop"), eA = l.useCallback(e => {
      if (!ew || eN <= 0) return 1;
      let t = eO.findIndex(t => t.skuId === e);
      return -1 === t ? 1 : Math.floor(t / eN) + 1
    }, [eO, ew, eN]), eR = l.useCallback(async (e, t, r) => {
    ...
    }, [eP, n, ek.enabled, et, ew, eN, eA, eL, eB]), eZ = (0, P.b)("Collectibles Shop Button"), eF = l.useMemo(() => {
      if (!ew) return eO;
      let e = (eL - 1) * eN;
      return eO.slice(e, e + eN)
    }, [eO, ew, eN, eL]), eD = l.useRef(null), eH = l.useCallback(e => {
      eB(e), null != J.current && null != eD.current ? J.current.scrollTo({
        to: eD.current.getBoundingClientRect().top
      }) : null != J.current && J.current.scrollTo({
        to: 0
      })
    }, [J, eB]), eM = (0, c.e7)([j.Z], () => {
      var e;
              ...
              children: (0, r.jsxs)("div", {
                ...
                children: [(0, r.jsx)(Z.I, {
                  ...
                  if (null != ev) {
                    var t, l;
                    let e = [];
                    return null != eh ? e.push("shop load fetch categories error: ".concat(ev.message)) : null != em ? e.push("shop load fetch purchase error: ".concat(ev.message)) : e.push("shop load claim error: ".concat(ev.message)), E.Z.captureMessage(e.join("\n"), {
                      tags: {
                    ...
                    case G.AW.BUNDLES:
                      return (0, r.jsx)("div", {
                        ...
                        children: (0, r.jsx)("main", {
                          className: i()(K.page, K.pageWithPagination, {
                            [K.pageFullscreen]: n
                          }),
