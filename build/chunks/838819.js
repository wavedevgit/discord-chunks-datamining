...
let J = e => {
  ...
  ee = function(e) {
    ...
    let {
    ...
    } = (0, g.ZP)([...$, b.Z.COLLECTIBLES_SHOP, ee]), {
      sessionId: er,
      scrollerRef: el,
      scrollHandler: ei
      ...
      transitionState: eo,
      transitionToTab: es
    } = (0, R.B)(el, i, n), [ec, eu] = l.useState(!1), ed = (0, B.R)("CollectiblesShop"), [ef, ep] = l.useState(z.IV), [eb, eg] = l.useState(), [eh, em] = l.useState(), {
      noCache: e_,
    ...
    }, [et, u, er, eb, eg, eh, eo, ea, ee, en]), l.useEffect(() => {
    ...
    } = (0, w.a)("CollectiblesShop"), eq = l.useCallback(e => {
      if (!eG || ez <= 0) return 1;
