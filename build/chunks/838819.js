...
let K = e => {
  ...
  $ = function(e) {
    ...
    let eE = l.useCallback(() => {
      ...
      ek = l.useRef(null),
      eT = l.useRef(null);
    (0, p.Tbt)(ek), l.useEffect(() => {
      if (!n) {
        var e;
        null == (e = eT.current) || e.focus()
      }
    }, [n]);
    let [eI, eL] = l.useState(1), eB = l.useCallback(e => {
      let t = ev.findIndex(t => t.skuId === e);
      return -1 === t ? 1 : Math.floor(t / U.kN) + 1
    }, [ev]), ew = l.useCallback(async (e, t, r) => {
    ...
    }, [ej, n, eP.enabled, ee, eB, eI, eL]), eN = (0, P.b)("Collectibles Shop Button"), eA = l.useMemo(() => {
      let e = (eI - 1) * U.kN;
              ...
              children: (0, r.jsxs)("div", {
                ...
                children: [(0, r.jsx)(R.I, {
                  ...
                  if (null != eC) {
                    var t, l;
                    let e = [];
                    return null != eg ? e.push("shop load fetch categories error: ".concat(eC.message)) : null != eh ? e.push("shop load fetch purchase error: ".concat(eC.message)) : e.push("shop load claim error: ".concat(eC.message)), E.Z.captureMessage(e.join("\n"), {
                      tags: {
                    ...
                    case U.AW.BUNDLES:
                      return (0, r.jsx)("div", {
                        ...
                        children: (0, r.jsx)("main", {
                          className: i()(q.page, q.pageWithPagination, {
                            [q.pageFullscreen]: n
                          }),
