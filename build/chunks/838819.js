...
let Q = e => {
  ...
  et = function(e) {
    ...
    } = (0, g.ZP)([...$, b.Z.COLLECTIBLES_SHOP, et]), {
      sessionId: el,
      scrollerRef: ea,
      scrollHandler: ei
    } = (0, h._)(K.rMx.COLLECTIBLES_SHOP_SCROLLED, u), {
      selectedTab: eo,
      transitionState: es,
      transitionToTab: ec
    } = (0, A.B)(ea, a, n), [eu, ed] = l.useState(!1), ep = (0, B.R)("CollectiblesShop"), [ef, eb] = l.useState(q.IV), [eg, eh] = l.useState(), [em, e_] = l.useState(), {
      noCache: eC,
    ...
    } = (0, L.a)("CollectiblesShop"), eK = l.useCallback(e => {
      if (!ez || eq <= 0) return 1;
      let t = ew.findIndex(t => t.skuId === e);
      return -1 === t ? 1 : Math.floor(t / eq) + 1
    }, [ew, ez, eq]), eY = l.useCallback(async (e, t, r) => {
    ...
    }, [eH, n, eM.enabled, ec, ez, eq, eK, eU, eG]), e$ = (0, I.b)("Collectibles Shop Button"), eX = l.useMemo(() => {
      if (!ez) return ew;
      let e = (eU - 1) * eq;
