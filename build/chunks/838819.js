...
function ea(e) {
  let {
    ...
    isFullScreen: u
  } = e, b = l.useRef(10 + 70 * Math.random()), [f, g] = l.useState(!1), h = (0, $.M7)(t.skuId), m = (0, p.O)(e => {
    g(e && null != h)
  }, u ? .13 : .15);
  return (0, r.jsxs)("div", {
    ...
    children: [c && (0, r.jsx)(d.P3F, {
      ...
      isPremiumUser: n,
      isGiftEasterEggEnabled: i
    }), null != h && null != t.unpublishedAt && (0, r.jsx)(R.$, {
...
let eo = function(e) {
  ...
  let {
    ...
    scrollerRef: Z,
    scrollHandler: R
  } = (0, h._)(K.rMx.COLLECTIBLES_SHOP_SCROLLED, p), {
    selectedTab: W,
    transitionState: U,
    transitionToTab: $
  } = (0, A.B)(Z, a, n), [en, er] = l.useState(!1), eo = (0, B.R)("CollectiblesShop"), [ei, es] = l.useState(J.IV), [ec, eu] = l.useState(), [ed, eb] = l.useState(), {
  ...
  (0, F.Kp)({
    ...
    if (U === J.f7.VISIBLE) {
      var e;
      let t;
      t = W === J.AW.CATALOG ? ed : p, S.default.track(K.rMx.COLLECTIBLES_SHOP_VIEWED, {
        location_stack: x,
        source: t,
        page_session_id: N,
    ...
    e_ || S.default.track(K.rMx.PREMIUM_UPSELL_VIEWED, {
  ...
  let eR = l.useCallback(async (e, t, r) => {
