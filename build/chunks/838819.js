...
let K = e => {
  ...
  X = function(e) {
    ...
    let {
    ...
    } = (0, s.cj)([P.Z], () => P.Z.getAnalytics()), Q = l.useMemo(() => {
      switch (a) {
        case U.AW.ORBS:
      ...
      newestAnalyticsLocation: et
    } = (0, f.ZP)([...J, p.Z.COLLECTIBLES_SHOP, Q]), {
      sessionId: en,
      scrollerRef: er,
      scrollHandler: el
    } = (0, g._)(G.rMx.COLLECTIBLES_SHOP_SCROLLED, X), {
      selectedTab: ea,
      transitionState: eo,
      transitionToTab: ei
    } = (0, N.B)(er, a, n), [es, ec] = l.useState(!1), eu = (0, B.R)("CollectiblesShop"), [ed, eb] = l.useState(U.IV), [ep, ef] = l.useState(), [eg, eh] = l.useState(), {
      noCache: em,
      includeUnpublished: e_
    } = (0, D.Z)(), {
      closeIntroToOrbsClaimedCoachmark: eC
    } = (0, v.Z)({
    ...
    (0, A.Kp)({
      ...
      if (eo === U.f7.VISIBLE && et === Q) {
        var e;
        let t;
        t = ea === U.AW.CATALOG ? eg : X, j.default.track(G.rMx.COLLECTIBLES_SHOP_VIEWED, {
          location_stack: ee,
          source: t,
          page_session_id: en,
    ...
    }, [ee, X, en, ep, ef, eg, eo, ea, Q, et]), l.useEffect(() => {
      null == ej || ey || j.default.track(G.rMx.PREMIUM_UPSELL_VIEWED, {
    ...
    let eR = l.useCallback(() => {
      ...
      eD = l.useRef(null),
      eM = l.useRef(null);
    (0, d.Tbt)(eD), l.useEffect(() => {
      if (!n) {
        var e;
        null == (e = eM.current) || e.focus()
      }
    }, [n]);
    let eV = l.useCallback(async (e, t, r) => {
            ...
            children: (0, r.jsxs)("div", {
              ...
              children: [(0, r.jsx)(R.I, {
                ...
                if (null != eI) {
                  var t, l;
                  let e = [];
                  return null != eE ? e.push("shop load fetch categories error: ".concat(eI.message)) : null != eP ? e.push("shop load fetch purchase error: ".concat(eI.message)) : e.push("shop load claim error: ".concat(eI.message)), S.Z.captureMessage(e.join("\n"), {
                    tags: {
