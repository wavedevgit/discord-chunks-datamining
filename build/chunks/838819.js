...
let K = e => {
  ...
  J = function(e) {
    ...
    } = (0, f.ZP)([...q, p.Z.COLLECTIBLES_SHOP, J]), {
      sessionId: et,
      scrollerRef: en,
      scrollHandler: er
    } = (0, g._)(G.rMx.COLLECTIBLES_SHOP_SCROLLED, u), {
      selectedTab: el,
      transitionState: ea,
      transitionToTab: eo
    } = (0, N.B)(en, a, n), [ei, es] = l.useState(!1), ec = (0, B.R)("CollectiblesShop"), [eu, ed] = l.useState(U.IV), [eb, ep] = l.useState(), [ef, eg] = l.useState(), {
      noCache: eh,
      includeUnpublished: em
    } = (0, D.Z)(), {
    ...
    (0, A.Kp)({
      ...
      if (ea === U.f7.VISIBLE && ee === J) {
        var e;
        let t;
        t = el === U.AW.CATALOG ? ef : u, j.default.track(G.rMx.COLLECTIBLES_SHOP_VIEWED, {
          location_stack: Q,
          source: t,
          page_session_id: et,
      ...
      null == ex || eO || j.default.track(G.rMx.PREMIUM_UPSELL_VIEWED, {
    ...
    l.useEffect(() => {
      eL(), (0, h.un)(c.z.COLLECTIBLES_GIFTING_COACHMARK) || (0, h.EW)(c.z.COLLECTIBLES_GIFTING_COACHMARK, {
    ...
    let eA = l.useCallback(() => {
      ...
      eW = l.useRef(null),
      eH = l.useRef(null);
    (0, d.Tbt)(eW), l.useEffect(() => {
      if (!n) {
        var e;
        null == (e = eH.current) || e.focus()
      }
    }, [n]);
    let eD = l.useCallback(async (e, t, r) => {
              ...
              children: (0, r.jsxs)("div", {
                ...
                children: [(0, r.jsx)(R.I, {
                  ...
                  if (null != ew) {
                    var t, l;
                    let e = [];
                    return null != eS ? e.push("shop load fetch categories error: ".concat(ew.message)) : null != ek ? e.push("shop load fetch purchase error: ".concat(ew.message)) : e.push("shop load claim error: ".concat(ew.message)), S.Z.captureMessage(e.join("\n"), {
                      tags: {
