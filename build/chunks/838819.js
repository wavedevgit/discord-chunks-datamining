...
function ea(e) {
  let {
    ...
    isFullScreen: u
  } = e, b = l.useRef(10 + 70 * Math.random()), [f, g] = l.useState(!1), m = (0, $.M7)(t.skuId), h = (0, p.O)(e => {
    g(e && null != m)
  }, u ? .13 : .15);
  return (0, r.jsxs)("div", {
    ...
    children: [c && (0, r.jsx)(d.P3F, {
      ...
      isPremiumUser: n,
      isGiftEasterEggEnabled: i
    }), null != m && null != t.unpublishedAt && (0, r.jsx)(R.$, {
...
let eo = function(e) {
  ...
  let {
    ...
    scrollerRef: Z,
    scrollHandler: R
  } = (0, m._)(K.rMx.COLLECTIBLES_SHOP_SCROLLED, p), {
    selectedTab: W,
    transitionState: U,
    transitionToTab: $
  ...
  l.useEffect(() => {
    eI(), (0, h.un)(c.z.COLLECTIBLES_GIFTING_COACHMARK) || (0, h.EW)(c.z.COLLECTIBLES_GIFTING_COACHMARK, {
