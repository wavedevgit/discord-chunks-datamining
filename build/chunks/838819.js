...
let J = e => {
  ...
  ee = function(e) {
    ...
    let {
      ...
      transitionState: eo,
      transitionToTab: es
    } = (0, R.B)(el, a, n), [ec, eu] = l.useState(!1), ed = (0, B.R)("CollectiblesShop"), [eb, ef] = l.useState(z.IV), [ep, eg] = l.useState(), [eh, em] = l.useState(), {
      noCache: e_,
    ...
    (0, Z.Kp)({
      ...
      if (eo === z.f7.VISIBLE && en === ee) {
        var e;
        let t;
        t = ei === z.AW.CATALOG ? eh : u, j.default.track(q.rMx.COLLECTIBLES_SHOP_VIEWED, {
          location_stack: et,
          source: t,
          page_session_id: er,
    ...
    l.useEffect(() => {
      eA(), (0, m.un)(c.z.COLLECTIBLES_GIFTING_COACHMARK) || (0, m.EW)(c.z.COLLECTIBLES_GIFTING_COACHMARK, {
    ...
    }, [eB, eG, ez]), eY = l.useCallback(async (e, t, r) => {
    ...
    }, [eB, eG, ez, eV]), eX = l.useRef(null), eJ = l.useCallback(e => {
              ...
              children: (0, r.jsxs)("div", {
                ...
                children: [(0, r.jsx)(H.I, {
                  ...
                  if (null != eI) {
                    var t, l;
                    let e = [];
                    return null != eE ? e.push("shop load fetch categories error: ".concat(eI.message)) : null != ek ? e.push("shop load fetch purchase error: ".concat(eI.message)) : e.push("shop load claim error: ".concat(eI.message)), P.Z.captureMessage(e.join("\n"), {
                      tags: {
