...
function eo(e) {
  ...
  } = e, c = (0, s.e7)([S.default], () => S.default.getCurrentUser()), u = (0, X.St)(t);
  return null == c || 0 === t.length ? null : (0, r.jsxs)("div", {
    children: [null != l ? (0, r.jsx)(d.Text, {
      ...
      children: u.map((e, t) => (0, r.jsx)(w.k0, {
        newValue: {
          tilePosition: t
        },
...
function ec(e) {
  let {
    ...
    isFullScreen: u
  } = e, b = l.useRef(10 + 70 * Math.random()), [f, g] = l.useState(!1), m = (0, Q.M7)(t.skuId), h = (0, p.O)(e => {
    g(e && null != m)
  }, u ? .13 : .15);
  return (0, r.jsxs)("div", {
    className: ea.categoryWrapper,
    ref: h,
    children: [c && (0, r.jsx)(d.P3F, {
      className: o()(ea.hiddenWumpus, {
      ...
      isPremiumUser: n,
      isGiftEasterEggEnabled: i
    }), null != m && null != t.unpublishedAt && (0, r.jsx)(W.$, {
...
let eu = function(e) {
  ...
  let {
  ...
  } = (0, s.cj)([I.Z], () => I.Z.getAnalytics()), x = l.useMemo(() => {
    switch (a) {
      case ee.AW.ORBS:
    ...
    scrollerRef: D,
    scrollHandler: z
  } = (0, m._)(et.rMx.COLLECTIBLES_SHOP_SCROLLED, p), {
    selectedTab: X,
    transitionState: Q,
    transitionToTab: eo
  } = (0, F.B)(D, a, n), [ei, eu] = l.useState(!1), ed = (0, N.R)("CollectiblesShop"), [eb, ep] = l.useState(ee.IV), [ef, eg] = l.useState(), [em, eh] = l.useState(), {
    closeIntroToOrbsClaimedCoachmark: e_
  } = (0, j.Z)({
  ...
  (0, H.Kp)({
    ...
    if (Q === ee.f7.VISIBLE && R === x) {
      var e;
      let t;
      t = X === ee.AW.CATALOG ? em : p, k.default.track(et.rMx.COLLECTIBLES_SHOP_VIEWED, {
        location_stack: L,
        source: t,
        page_session_id: W,
  ...
  }, [L, p, W, ef, eg, em, Q, X, x, R]), l.useEffect(() => {
    null == eO || ej || k.default.track(et.rMx.PREMIUM_UPSELL_VIEWED, {
  ...
  l.useEffect(() => {
    eZ(), (0, h.un)(c.z.COLLECTIBLES_GIFTING_COACHMARK) || (0, h.EW)(c.z.COLLECTIBLES_GIFTING_COACHMARK, {
          ...
          children: (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)(V.I, {
              ...
              if (null != eB) {
                var t, l;
                let e = [];
                return null != ek ? e.push("shop load fetch categories error: ".concat(eB.message)) : null != eP ? e.push("shop load fetch purchase error: ".concat(eB.message)) : e.push("shop load claim error: ".concat(eB.message)), E.Z.captureMessage(e.join("\n"), {
                  tags: {
                ...
                case ee.AW.CATALOG:
                  return (0, r.jsx)("div", {
                    ...
                    children: (0, r.jsx)("main", {
                      ...
                      children: eS ? (0, r.jsx)(G.Z, {}) : (0, r.jsx)("div", {
                        className: ea.categories,
                        children: eI.filter(e => null == e.unpublishedAt || e.unpublishedAt > new Date).filter(e => {
                          let {
                            products: t
                          } = e;
                          return t.length > 0
