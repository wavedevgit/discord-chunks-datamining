...
function ea(e) {
  let {
    ...
    isFullScreen: d
  } = e, u = l.useRef(10 + 70 * Math.random()), [h, m] = l.useState(!1), p = (0, Y.M7)(t.skuId), b = (0, f.O)(e => {
    m(e && null != p)
  }, d ? .13 : .15);
  return (0, r.jsxs)("div", {
...
let eo = function(e) {
  ...
  let {
    ...
    transitionState: Y,
    transitionToTab: er
  } = (0, W.B)(H, a, n), [el, eo] = l.useState(!1), es = (0, P.R)("CollectiblesShop"), [ei, ec] = l.useState(X.IV), [ed, eu] = l.useState(), [eg, eh] = l.useState(), {
  ...
  (0, R.Kp)({
    ...
    if (Y === X.f7.VISIBLE) {
      var e;
      let t;
      t = U === X.AW.CATALOG ? eg : f, E.default.track(Q.rMx.COLLECTIBLES_SHOP_VIEWED, {
        location_stack: x,
        source: t,
        page_session_id: A,
  ...
  return (0, r.jsx)(p.Gt, {
    ...
    children: (0, r.jsxs)(T.k0, {
                ...
                case X.AW.CATALOG:
                  return (0, r.jsx)("div", {
                    ...
                    children: (0, r.jsx)("main", {
                      ...
                      children: ek ? (0, r.jsx)(z.Z, {}) : null != eO ? (0, r.jsx)(M.Z, {
                        onRetry: ew,
      ...
      }), eB && (0, r.jsx)(G.Z, {}), !n && U === X.AW.HOME && (0, r.jsxs)(r.Fragment, {
