...
let eo = function(e) {
  ...
  let {
    ...
    transitionState: U,
    transitionToTab: K
  } = (0, R.B)(Z, a, n), [en, er] = l.useState(!1), eo = (0, B.R)("CollectiblesShop"), [ei, es] = l.useState($.IV), [ec, eu] = l.useState(), [ed, eb] = l.useState(), {
  ...
  (0, F.Kp)({
    ...
    e_ || S.default.track(J.rMx.PREMIUM_UPSELL_VIEWED, {
