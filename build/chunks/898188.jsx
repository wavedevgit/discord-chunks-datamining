...
function S(e) {
  ...
  return null == n ? <c.Text variant={"text-xxs/normal"} color={"header-secondary"}>{v.intl.format(v.t.MkzlDA, {
      channelName: v.intl.string(v.t.J90oLS)
    })}</c.Text> : <c.Text variant={"text-xxs/normal"} color={"header-secondary"}>{v.intl.format(v.t.MkzlDA, {
      channelName: i
    })}</c.Text>
}
...
function A(e) {
  ...
  return <y.Z emojiId={i} emojiName={o} size={y.R.MEDIUM} defaultComponent={(0, r.jsx)(s, {
...
function N(e) {
  ...
  return null == h || N && !R ? null : <div className={a()(I.container, p)}>{R && null != y ? (0, r.jsx)(s.Z.div, {
      style: {
...
function C(e) {
  ...
  return s || a || !o || !c ? null : <N guildId={t} channel={n} className={i} />
}