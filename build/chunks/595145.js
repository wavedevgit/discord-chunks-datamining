...
function K(e) {
  let {
  ...
  } = (0, f.ZP)([...ec, u.Z.USER_PROFILE_MODAL_V2]), ea = (0, I.ZB)({
    layout: "MODAL_V2",
    userId: n.id,
    sourceSessionId: J,
    showGuildProfile: !0,
    ...
    messageId: W,
    roleId: X
  }), el = r.useRef(null), es = (0, s.Z)(el), ed = (0, P.$m)(), eu = (0, a.q_F)({
    opacity: +(null != ed.interactionType),
    config: {
      duration: 150
    }
  }), ef = (0, i.e7)([h.Z], () => null != K ? h.Z.getGuild(K) : null), ep = r.useMemo(() => null != K ? {
    [K]: [n.id]
  } : {}, [K, n.id]);
  (0, d.$)(ep);
  let em = (0, O.ZP)(n.id, K),
    eb = (0, i.e7)([x.Z], () => x.Z.getRelationshipType(n.id)),
    e_ = (0, i.e7)([g.Z], () => g.Z.hidePersonalInformation),
    ey = (0, p.p)({
    ...
    eg = (0, i.e7)([y.default], () => y.default.locale),
    ej = (0, C.Z)(n.id),
    eI = (0, Z.Z)(n.id);
  return (0, o.jsx)(f.Gt, {
    value: ei,
        ...
        children: (0, o.jsx)(a.Y0X, {
          ...
          children: (0, o.jsxs)(k.Z, {
            ...
            children: [(0, o.jsxs)("div", {
              className: z.profile,
              children: [null != ed.interactionType && (0, o.jsx)(c.animated.div, {
                style: eu,
                ...
                children: [(0, o.jsx)(D.Z, {
                  ...
                  nickname: j.ZP.useName(null == ef ? void 0 : ef.id, q, n),
                  ...
                  children: [(null == em ? void 0 : em.bio) != null && (null == em ? void 0 : em.bio) !== "" && !e_ && (0, o.jsx)(A.Z, {
                    userBio: em.bio,
                    setLineClamp: !1
                  ...
                  }), eI.length > 0 && (0, o.jsx)(R.Z, {
                    heading: Y.intl.string(Y.t.PHjkRE),
                    children: eI.map(e => (0, o.jsx)(S.tH, {
              ...
              }), (null == em ? void 0 : em.profileEffectId) != null && (0, o.jsx)(b.Z, {
