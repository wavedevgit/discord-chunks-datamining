...
function X(e) {
  let {
  ...
  } = (0, f.ZP)([...ei, u.Z.USER_PROFILE_MODAL_V2]), ea = (0, v.ZB)({
    layout: "MODAL_V2",
    userId: t.id,
    sourceSessionId: J,
    showGuildProfile: !0,
    ...
    messageId: q,
    roleId: z
  }), el = r.createRef(), es = (0, s.Z)(el), ed = (0, P.$m)(), eu = (0, a.q_F)({
    opacity: +(null != ed.interactionType),
    config: {
      duration: 150
    }
  }), ef = (0, c.e7)([y.Z], () => null != X ? y.Z.getGuild(X) : null), ep = r.useMemo(() => null != X ? {
    [X]: [t.id]
  } : {}, [X, t.id]);
  (0, d.$)(ep);
        ...
        children: (0, o.jsx)(a.Y0X, {
          ...
          children: (0, o.jsxs)(V.Z, {
            ...
            children: [(0, o.jsxs)("div", {
              className: W.profile,
              children: [null != ed.interactionType && (0, o.jsx)(i.animated.div, {
                style: eu,
                ...
                children: [(0, o.jsx)(D.Z, {
                  ...
                  }), ex.length > 0 && (0, o.jsx)(E.Z, {
                    heading: Y.intl.string(Y.t.PHjkRE),
                    headingClassName: W.profileHeading,
                    headingVariant: "text-xs/semibold",
                    headingColor: "none",
                    children: ex.map(e => (0, o.jsx)(Z.tH, {
