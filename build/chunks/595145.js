...
function en(e) {
  ...
  let {
  ...
  } = (0, m.ZP)([...em, p.Z.USER_PROFILE_MODAL_V2]), e_ = (0, A.ZB)({
    layout: "MODAL_V2",
    userId: n.id,
    sourceSessionId: ec,
    guildId: en,
    ...
    roleId: ei,
    showGuildProfile: ep
  }), ey = r.useRef(null), ex = (0, u.Z)(ey), eh = (0, w.$m)(), eg = (0, s.q_F)({
    opacity: +(null != eh.interactionType),
    config: {
      duration: 150
    }
  }), ej = (0, a.e7)([v.Z], () => null != en ? v.Z.getGuild(en) : null), ev = r.useMemo(() => null != en ? {
    [en]: [n.id]
  } : {}, [en, n.id]);
  (0, f.$)(ev);
