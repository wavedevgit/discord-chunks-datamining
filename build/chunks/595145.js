...
function en(e) {
  ...
  let {
    ...
    roleId: ei,
    showGuildProfile: ep
  }), e_ = r.useRef(null), ex = (0, u.Z)(e_), eh = (0, w.$m)(), eg = (0, s.q_F)({
    opacity: +(null != eh.interactionType),
    config: {
      duration: 150
    }
  }), ej = (0, a.e7)([I.Z], () => null != en ? I.Z.getGuild(en) : null), eI = r.useMemo(() => null != en ? {
    [en]: [n.id]
  } : {}, [en, n.id]);
  (0, f.$)(eI);
  let ev = (0, T.ZP)(n.id, ep ? en : void 0),
    ...
    eE = (0, _.vh)(n.id),
    eB = (0, C.Z)(n.id),
    eD = (0, a.e7)([j.default], () => ["en-US", "en-GB"].includes(j.default.locale)) ? ee.intl.formatToPlainString(ee.t.KRe1Fh, {
      name: eO
