...
function q(e) {
  let {
  ...
  } = (0, f.ZP)([...ec, u.Z.USER_PROFILE_MODAL_V2]), el = (0, I.ZB)({
    layout: "MODAL_V2",
    userId: n.id,
    sourceSessionId: Q,
    showGuildProfile: !0,
    ...
    messageId: K,
    roleId: J
  }), ea = i.createRef(), es = (0, s.Z)(ea), ed = (0, N.$m)(), eu = (0, l.q_F)({
    opacity: +(null != ed.interactionType),
    config: {
      duration: 150
    }
  }), ef = (0, r.e7)([x.Z], () => null != q ? x.Z.getGuild(q) : null), ep = i.useMemo(() => null != q ? {
    [q]: [n.id]
  } : {}, [q, n.id]);
  (0, d.$)(ep);
            ...
            children: [(0, o.jsxs)("div", {
              ...
              children: [null != ed.interactionType && (0, o.jsx)(c.animated.div, {
                ...
                children: [(0, o.jsx)(k.Z, {
                  ...
                  }), ey.length > 0 && (0, o.jsx)(M.Z, {
                    heading: F.intl.string(F.t.PHjkRE),
                    headingClassName: W.profileHeading,
                    headingVariant: "text-xs/semibold",
                    headingColor: "none",
                    children: ey.map(e => (0, o.jsx)(S.tH, {
              ...
              }), (null == eb ? void 0 : eb.profileEffectId) != null && (0, o.jsx)(m.Z, {
