...
function W(e) {
  let {
    ...
    messageId: K,
    roleId: q
  }), ea = r.createRef(), el = (0, s.Z)(ea), es = (0, N.$m)(), ed = (0, a.q_F)({
    opacity: +(null != es.interactionType),
    config: {
      duration: 150
    }
  }), eu = (0, c.e7)([y.Z], () => null != W ? y.Z.getGuild(W) : null), ef = r.useMemo(() => null != W ? {
    [W]: [n.id]
  } : {}, [W, n.id]);
  (0, d.$)(ef);
            ...
            children: [(0, o.jsxs)("div", {
              ...
              children: [null != es.interactionType && (0, o.jsx)(i.animated.div, {
                ...
                children: [(0, o.jsx)(V.Z, {
                  ...
                  }), ex.length > 0 && (0, o.jsx)(U.Z, {
                    heading: H.intl.string(H.t.PHjkRE),
                    headingClassName: Y.profileHeading,
                    headingVariant: "text-xs/semibold",
                    headingColor: "none",
                    children: ex.map(e => (0, o.jsx)(w.tH, {
