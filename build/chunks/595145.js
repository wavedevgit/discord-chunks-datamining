...
function q(e) {
  ...
  let {
  ...
  } = (0, f.ZP)([...el, u.Z.USER_PROFILE_MODAL_V2]), ed = (0, A.ZB)({
    layout: "MODAL_V2",
    userId: q.id,
    sourceSessionId: ee,
    showGuildProfile: !0,
    ...
    messageId: K,
    roleId: $
  }), eu = c.createRef(), ef = (0, s.Z)(eu), ep = (0, C.$m)(), eb = (0, r.q_F)({
    opacity: +(null != ep.interactionType),
    config: {
      duration: 150
    }
  }), em = (0, a.e7)([x.Z], () => null != X ? x.Z.getGuild(X) : null), eh = c.useMemo(() => null != X ? {
    [X]: [q.id]
  } : {}, [X, q.id]);
  (0, d.$)(eh);
  let eg = (0, O.ZP)(q.id, X),
    ...
    [{
      ...
      section: null != (t = null == (n = Q.find(e => {
        let {
          section: n
        } = e;
        return n === et
      })) ? void 0 : n.section) ? t : F.oh.FEATURED,
      subsection: eo
    });
  return c.useEffect(() => {
    null == Q.find(e => e.section === eI) && eC({
      section: Q[0].section,
      subsection: void 0
    })
  }, [eI]), (0, o.jsx)(f.Gt, {
        ...
        children: (0, o.jsx)(r.Y0X, {
          ...
          children: (0, o.jsxs)(B.Z, {
            ...
            children: [(0, o.jsxs)("div", {
              className: G.profile,
              children: [null != ep.interactionType && (0, o.jsx)(i.animated.div, {
                style: eb,
                ...
                children: [(0, o.jsx)(D.Z, {
                  ...
                  }), eO.length > 0 && (0, o.jsx)(M.Z, {
                    heading: Y.intl.string(Y.t.PHjkRE),
                    headingClassName: G.profileHeading,
                    headingVariant: "text-xs/semibold",
                    headingColor: "none",
                    children: eO.map(e => (0, o.jsx)(w.tH, {
              ...
              }), (null == eg ? void 0 : eg.profileEffectId) != null && (0, o.jsx)(m.Z, {
