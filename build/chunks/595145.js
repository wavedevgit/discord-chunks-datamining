...
function en(e) {
  ...
  let {
    ...
    openedAt: eu,
    onClose: ef,
    showGuildProfile: ep = !0,
    sourceAnalyticsLocations: em = []
  } = e, {
    analyticsLocations: eb
  } = (0, m.ZP)([...em, p.Z.USER_PROFILE_MODAL_V2]), ey = (0, A.ZB)({
    layout: "MODAL_V2",
    userId: n.id,
    sourceSessionId: ec,
    guildId: en,
    ...
    roleId: ei,
    showGuildProfile: ep
  }), e_ = r.useRef(null), ex = (0, u.Z)(e_), eh = (0, w.$m)(), ej = (0, s.q_F)({
  ...
  let eI = (0, T.ZP)(n.id, ep ? en : void 0),
    ...
    eE = (0, _.vh)(n.id),
    eB = (0, C.Z)(n.id),
    eD = (0, a.e7)([g.default], () => ["en-US", "en-GB"].includes(g.default.locale)) ? ee.intl.formatToPlainString(ee.t.KRe1Fh, {
      name: eO
    }) : ee.intl.string(ee.t["3N/J2t"]);
  return (0, o.jsx)(m.Gt, {
    value: eb,
        ...
        children: (0, o.jsx)(s.Y0X, {
          ...
          children: (0, o.jsxs)(F.Z, {
            ...
            children: [null != eZ && (0, o.jsx)("div", {
              ...
              style: {
                backgroundImage: "url(".concat(eZ, ")")
              }
            }), null != eh.interactionType && (0, o.jsx)(l.animated.div, {
              style: ej,
              ...
              children: [(0, o.jsxs)("div", {
                ...
                children: [(0, o.jsx)(Y.Z, {
                  ...
                  children: [eP === $.OGo.PENDING_INCOMING && (0, o.jsx)(F.Z.Overlay, {
