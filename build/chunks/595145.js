...
function K(e) {
  let {
    ...
    messageId: q,
    roleId: z
  }), ea = r.useRef(null), el = (0, s.Z)(ea), es = (0, A.$m)(), ed = (0, a.q_F)({
    opacity: +(null != es.interactionType),
    config: {
      duration: 150
    }
  }), eu = (0, i.e7)([g.Z], () => null != K ? g.Z.getGuild(K) : null), ef = r.useMemo(() => null != K ? {
    [K]: [n.id]
  } : {}, [K, n.id]);
  (0, d.$)(ef);
  let ep = (0, v.ZP)(n.id, K),
    ...
    e_ = null == ep ? void 0 : ep.getBannerURL({
      canAnimate: !1,
      size: 1024
    }),
    ey = (0, p.p)({
      ...
      children: (0, o.jsx)(A.NJ, {
        ...
        children: (0, o.jsx)(a.Y0X, {
          ...
          children: (0, o.jsxs)(k.Z, {
            ...
            children: [null != e_ && (0, o.jsx)("div", {
              className: W.backgroundImage,
              style: {
                backgroundImage: "url(".concat(e_, ")")
              }
            }), null != es.interactionType && (0, o.jsx)(c.animated.div, {
              style: ed,
