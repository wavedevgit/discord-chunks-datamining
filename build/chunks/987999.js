...
function j(t) {
  ...
  return (0, n.jsxs)(o.v2r, {
    ...
    children: [(null == h ? void 0 : h.applicationStatus) === p.wB.REJECTED && (0, n.jsx)(o.sNh, {
      ...
      action: () => {
        e.hasFeature(g.oNc.CLAN) && (0, a.Vr)({
          guildId: j,
      ...
      action: () => {
        (0, o.h7j)(t => {
          var r, i;
          return (0, n.jsx)(o.ConfirmModal, (r = function(t) {
            ...
            children: (0, n.jsx)(o.Text, {
              ...
              children: (null == h ? void 0 : h.applicationStatus) === p.wB.STARTED ? O.intl.string(O.t.fJwWVl) : O.intl.format(O.t["9ZezpK"], {
                name: e.name
              })
            })
