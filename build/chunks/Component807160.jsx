  ...
  return (0, i.jsx)(m.aML, {
    ...
    children: e => {
      var {
        onMouseEnter: n,
        onMouseLeave: r
      } = e, o = ec(e, ["onMouseEnter", "onMouseLeave"]);
      return (0, i.jsx)(m.P3F, el(ea({}, o), {
        onMouseEnter: () => {
...
function ev(e) {
  ...
  }), a = (0, C.C)(r), s = (0, p.e7)([F.Z], () => F.Z.getGuild(t)), l = (null == r ? true : r.role_id) != null && (null == r ? true : r.attachments_count) === 0 ? er.intl.string(er.t.H11qcT) : a, c = o.useCallback(async () => {
...
function eS(e) {
  ...
  let {
    ...
    requireCurrentGuild: false
  }), s = (0, p.e7)([T.Z], () => T.Z.getGuildProductFetchState(o) === T.M.FETCHING), l = null == a ? true : a.role_id, c = (0, p.e7)([Z.Z], () => null != l ? Z.Z.getRole(r, l) : true, [r, l]), u = (0, N.Z)({
    guildId: r,
    productId: o
  }), d = (null != (n = null == a || null == (t = a.attachments) ? true : t.length) ? n : 0) > 0, f = null != c;
  return s ? (0, i.jsx)("div", {
    className: ei.guildProductBenefits,
    children: (0, i.jsx)(m.$jN, {})
  }) : null != a && (d || f) ? (0, i.jsxs)("div", {
    className: ei.guildProductBenefits,
...
class eI extends(r = Chunk473749.PureComponent) {
  ...
  renderDescription() {
    ...
    if (null != Chunk442837 && 0 !== Chunk442837.items.length) {
      ...
      if (Chunk442837.type === Chunk981631.NYc.PREMIUM) Chunk442837.items.forEach(e => {
        ...
        (0, Q.uZ)(t) ? (n.push(Q.ZP.getDisplayName(t, false, _)), o = (0, Q.Wz)(et.GP[t].skuId)) : (n.push("".concat(r > 1 ? "".concat(r, "x ") : "").concat(Q.ZP.getDisplayName(t, false, _))), null == o && (o = (0, Q.Wz)(et.GP[t].skuId)))
      });
      ...
      } else Chunk442837.type === Chunk981631.NYc.APPLICATION && (null != Chunk91192 && (o = Chunk91192.skuId), null != Chunk120356 ? require.push(Chunk388032.intl.formatToPlainString(Chunk388032.t["0wL/VI"], {
  ...
  render() {
    ...
    return (0, Chunk54381.jsx)(Chunk91192.mh, {
      id: module.id,
      children: e => (0, i.jsxs)(m.P3F, el(ea({
...
function eT(e) {
  ...
  let I = (0, p.e7)([F.Z], () => F.Z.getGuild(null == m ? true : m.guildId)),
    ...
    N = (0, p.e7)([B.default], () => {
      var e, t, n, i;
      let o = r.isGift ? null == (e = r.entitlements) ? true : e.find(e => {
        var t;
        return (null == (t = e.user) ? true : t.id) != null && null != e.gifterId
      }) : null;
      return null == o ? null : null != (i = B.default.getUser(null != (n = null == (t = o.user) ? true : t.id) ? n : null)) ? i : null == o ? true : o.user
    }, [r]),
    {
