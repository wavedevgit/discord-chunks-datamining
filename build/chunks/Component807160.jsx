...
function ev(e) {
  let {
    ...
    (null == s ? true : s.features.has(ee.GuildFeatures.PRODUCTS_AVAILABLE_FOR_PURCHASE)) ? await (0, R.Z)(ee.Z5c.GUILD_PRODUCT(t, n)) : await (0, R.Z)(ee.Z5c.CHANNEL(t)), (0, k.default)()
  }, [s, t, n]);
