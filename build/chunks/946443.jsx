...
function P(e) {
  ...
  let z = (0, u.e7)([f.Z], () => f.Z.messageGroupSpacing),
    ...
    K = (0, g.Z)("unreads", k);
  if (0 === V.length) {
    return <div className={o()(I.container, {
        [I.widerInbox]: W
      })}><h.y5t component={(0, r.jsx)(v.Z, {
          tab: d.X.UNREADS,
          setTab: T,
          badgeState: M,
          closePopout: L
        })}><C.Z Icon={h.xx7} header={x.intl.string(x.t["6XMM+P"])} tip={(null == (Z = a().os) ? true : Z.family) === "OS X" ? x.intl.string(x.t.w9uDOT) : x.intl.string(x.t.BiUJCw)} /></h.y5t></div>
  }
  return <div className={o()(I.container, "group-spacing-".concat(z), {
      [I.widerInbox]: W
    })} aria-label={x.intl.string(x.t.sRUdBw)}><h.y5t component={(0, r.jsx)(v.Z, {
        tab: d.X.UNREADS,
        setTab: T,
        badgeState: M,
        closePopout: L,
...
function N(e) {
  ...
  return <div className={I.tutorial}>{<div className={I.tutorialIcon}><h.xx7 size={"md"} color={"currentColor"} /></div>}{<div>{<h.X6q className={I.__invalid_tutorialHeader} variant={"heading-md/semibold"}>{x.intl.string(x.t.vZPktL)}</h.X6q>}{<h.Text color={"header-secondary"} variant={"text-sm/normal"}>{x.intl.string(x.t.vWkIIC)}</h.Text>}{<div data-button-hoisted-classname-wrapper={true} className={I.tutorialButton}><h.zxk variant={"primary"} size={"sm"} text={x.intl.string(x.t["+IrDzM"])} onClick={t} /></div>}</div>}</div>
}
...
function w(e) {
  ...
  return <div className={I.container}><h.y5t component={(0, r.jsx)(v.Z, {
        tab: d.X.UNREADS,
        setTab: t,
        badgeState: n,
        closePopout: i
      })}><C.Z Icon={h.xx7} disableStars={true} header={x.intl.string(x.t["KG/ynZ"])} tip={x.intl.string(x.t.cvcKzc)} /></h.y5t></div>
}