...
let eB = e => {
    let {
      ...
      product: n,
      user: a
    } = e, l = i.useRef(null), o = (0, j.X)(l), s = (0, K.x6)(n), {
  ...
  eU = e => {
    ...
    } = (0, _.ZP)(), I = G.ZP.canUseCollectibles(n), {
      previewingVariantIndex: w
    } = x, y = (0, eb.N)(t, w), T = (0, ex.W)(t, P);
    ...
    let E = (0, X.L)(t),
      ...
      U = (0, m.e7)([z.Z], () => z.Z.isClaiming === (null == T ? true : T.skuId)),
      M = (0, g.ZP)(),
      F = (0, f.wj)(M),
      W = (0, K.G1)(T),
      $ = (0, K.ql)(T, eT.tuJ.DEFAULT),
      ee = (null == $ ? true : $.amount) === 0,
      {
        firstAvatarDecoration: en
      } = (0, Q.Rj)(null != y ? y : T),
      er = i.useMemo(() => (0, K.BH)(T, I), [T, I]),
      {
        handleUseNow: ei,
        isApplying: ed
      } = (0, q.W)({
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(ea.Z, {
            ...
            children: [(0, r.jsx)(es.Z, {
              ...
              discount: er,
              isPremiumUser: I,
              hideStrikethroughPrice: !I || eP,
              nitroIconType: "tooltip",
              nitroIconSize: "xs",
              discountOfferAmount: eg
            }), I || eP ? null : (0, r.jsx)(ec.Z, {
              product: T
            })]
          })]
        }), (0, r.jsx)(v.Rny, {
          ...
          children: (() => {
            if (W && !I && !ee) {
              let e;
              return e = eE.intl.string(eE.t.sEAnVH), (0, r.jsx)(A.Z, {
            ...
            return D ? N ? (0, r.jsx)(v.Button, {
              ...
              children: eO.map((e, t) => {
                ...
                if (e.currency === eA.pK.DISCORD_ORB) {
                  let t = k ? eE.intl.string(eE.t.cTdr3x) : eE.intl.string(eE.t.zqh7ZM),
                    n = !ek || k,
                ...
                return n = (0, K.x6)(T) ? eE.intl.string(eE.t.V1AWw0) : T.type === c.Z.PROFILE_EFFECT ? eE.intl.string(eE.t.kAeDcK) : T.type === c.Z.NAMEPLATE ? eE.intl.string(eE.t.H3vhqU) : eE.intl.string(eE.t.AQ0Veg), eP ? n = eE.intl.formatToPlainString(eE.t["5U5RB5"], {
                  discountOfferAmount: eg
                }) : eh && (n = eE.intl.formatToPlainString(eE.t["cNSL/j"], {
          ...
          className: l()(eN.disclaimer, !F && eN.disclaimerLight),
          variant: "text-xxs/normal",
          children: W && !N ? eE.intl.string(eE.t.nKdAlO) : null
        })]
      })]
    })
  },
  ...
  eG = e => {
    let {
      ...
      activeBundleSlide: i,
      isTransitioning: a
    } = e, o = (0, m.e7)([b.Z], () => b.Z.useReducedMotion), s = G.ZP.canUsePremiumProfileCustomization(n), u = (0, m.cj)([D.Z], () => D.Z.getAllPending()), {
      pendingAvatar: d
    } = u, p = function(e, t) {
      if (null == e) return {};
      ...
      firstNameplate: _
    } = (0, Q.Rj)(t), P = null != x, j = () => (0, r.jsxs)(r.Fragment, {
  ...
  eV = e => {
    let {
      ...
      tab: g
    } = e, b = (0, m.e7)([U.default], () => U.default.getCurrentUser()), P = (0, eO.f)(a), {
      previewingVariantIndex: j
    } = P, O = (0, W.o)(a), C = (0, eb.N)(a, j), I = (0, ex.W)(a, O);
    s()(null != I, "Selected product should not be null");
    let {
      analyticsLocations: w
    } = (0, _.ZP)([...f, x.Z.COLLECTIBLES_SHOP_DETAILS_MODAL]);
    (0, ei.u9)(I.skuId);
    let y = (0, eP.kc)(o),
      T = (0, k.Y)({
    ...
    }, [p, w, I.skuId, I.items, S]);
    let A = (0, Z.r9)(),
      E = t === v.Dvm.EXITING,
      N = (0, e_.t0)(a),
      R = null == N ? true : N.amount,
      L = i.useMemo(() => (0, K.x6)(I) ? I.items.length : 0, [I]),
      {
        activeSlide: D,
        isTransitioning: F
      } = (0, ee.b)({
    ...
    return null == b ? null : (0, r.jsx)(_.Gt, {
      value: w,
      children: (0, r.jsxs)(v.Y0X, {
        ...
        children: [(0, r.jsxs)(v.hzk, {
          ...
          children: [(0, r.jsx)(eU, {
            ...
            className: l()(eN.previewContainer, I.skuId === u.a.PREMIUM_TIER_2_3_DAY ? eN.fractionalNitroPreviewContainer : I.type === c.Z.AVATAR_DECORATION ? eN.collectiblePreviewsContainerWithChat : eN.collectiblePreviewsContainerNoChat),
            style: {
              backgroundImage: "url(".concat(y, ")")
            },
            children: [(0, ey.o0)(a.skuId) ? a.skuId === ey.Vt.ORB_PROFILE_BADGE ? A || E ? null : (0, r.jsx)(em.M, {
              user: b
          ...
          children: (0, r.jsxs)(v.mzw, {
            ...
            children: [(0, r.jsx)("img", {
              ...
              }), (null == N ? true : N.expiresAt) != null && (0, r.jsx)(er.R, {
                endDate: N.expiresAt
              })]
            })]
          })
