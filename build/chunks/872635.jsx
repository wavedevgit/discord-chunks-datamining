...
function E(e) {
  ...
  return null == c ? null : <div className={g.buttons}>{<y slateEditor={c} markdownSyntax={"bold"}><l.mY4 size={"md"} color={"currentColor"} className={a()(g.icon, o)} /></y>}{<y slateEditor={c} markdownSyntax={"italics"}><l.h32 size={"md"} color={"currentColor"} className={a()(g.icon, o)} /></y>}{<y slateEditor={c} markdownSyntax={"strikethrough"}><l.dwl size={"md"} color={"currentColor"} className={a()(g.icon, o)} /></y>}{<div className={a()(g.divider, s)} />}{!(null == i ? true : i.disableBlockQuotes) && <O slateEditor={c} blockType={"blockQuote"}><l.PEf size={"md"} color={"currentColor"} className={a()(g.icon, o)} /></O>}{!(null == i ? true : i.disableInlineCode) && <y slateEditor={c} markdownSyntax={"inlineCode"}><l.nF$ size={"custom"} width={20} height={20} color={"currentColor"} className={a()(g.icon, o)} /></y>}{<y slateEditor={c} markdownSyntax={"spoiler"}><l.tEF size={"md"} color={"currentColor"} className={a()(g.icon, o)} /></y>}</div>
}
let b = Chunk73800.forwardRef(function(e, t) {
  ...
  return null == P ? null : <u.ZP><div id={"slate-toolbar"} ref={f} className={g.toolbar} style={{
        top: S - A,
        left: T - C
      }} onMouseDown={e => {
        e.stopPropagation()
        ...
        e.stopPropagation()
      }}>{<v slateEditor={P} />}{<E editorRef={o} options={l} />}</div></u.ZP>
});
...
function y(e) {
  ...
  return <button aria-pressed={a} className={g.button} onClick={o}>{i}</button>
}
...
function O(e) {
  ...
  return <button aria-pressed={s} className={g.button} onClick={o}>{i}</button>
}
