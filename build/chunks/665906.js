...
function b(e) {
  let t = (0, a.e7)([_.Z], () => _.Z.can(o.$e(g.Plq.CREATE_PRIVATE_THREADS), e), [e]);
  return e.type === g.d4z.GUILD_TEXT && O(t, e)
}
...
function O(e, t, n) {
  return !(__OVERLAY__ || !e || !u.uC.has(t.type) || null != n && (n.hasFlag(g.iLy.HAS_THREAD) || (0, c.Z)(n)))
}

function S(e) {
  let t = (0, a.e7)([f.Z], () => f.Z.getChannel(p.default.castMessageIdAsChannelId(e.id)), [e]);
  return I((0, a.e7)([_.Z], () => _.Z.can(g.Plq.VIEW_CHANNEL, t), [t]), e, t)
}
...
function T(e) {
  return (0, a.cj)([h.Z, _.Z], () => {
    let t = h.Z.getActiveJoinedThreadsForParent(e.guild_id, e.id),
      ...
      o = i()(n).some(e => _.Z.can(g.Plq.VIEW_CHANNEL, e.channel)),
      a = i()(t).some(e => !(e.channel.id in n) && _.Z.can(g.Plq.VIEW_CHANNEL, e.channel)),
...
function N(e) {
  let t = (0, a.e7)([f.Z], () => f.Z.getChannel(null == e ? void 0 : e.parent_id)),
    n = (0, a.e7)([_.Z], () => null != t && _.Z.can(g.Plq.MANAGE_THREADS, t), [t]),
...
function D(e) {
  var t;
  let n = (0, a.e7)([_.Z], () => null != e && _.Z.can(g.Plq.SEND_MESSAGES_IN_THREADS, e));
  return null != e && (!e.isThread() || e.isActiveThread() || e.isArchivedThread() && (null === (t = e.threadMetadata) || void 0 === t ? void 0 : t.locked) !== !0 && n)
}

function w(e) {
  var t;
  return null != e && (!e.isThread() || e.isActiveThread() || e.isArchivedThread() && (null === (t = e.threadMetadata) || void 0 === t ? void 0 : t.locked) !== !0 && _.Z.can(g.Plq.SEND_MESSAGES_IN_THREADS, e))
}
...
function k(e) {
  let t = (0, l.Z)(),
    n = (0, a.e7)([_.Z], () => _.Z.can(g.Plq.CONNECT, e)),
    r = D(e),
    i = m.useExperiment({
      guildId: e.guild_id,
      location: "e791ea_1"
