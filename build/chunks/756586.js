      ...
      switch (e.key) {
        ...
        case "ArrowLeft":
          if (v.getKeyLeftOf) {
            ...
            null == t && T && (t = "rtl" === M ? null == (_ = v.getFirstKey) ? true : _.call(v, n.focusedKey) : null == (p = v.getLastKey) ? true : p.call(v, n.focusedKey)), null != t && (e.preventDefault(), y(t, "rtl" === M ? "first" : "last"))
          }
          break;
        case "ArrowRight":
          if (v.getKeyRightOf) {
