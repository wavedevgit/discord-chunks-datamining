...
function I(e) {
  ...
  let {
    transitionState: n,
    onClose: i
  } = e, r = (0, m.e7)([j.default], () => {
    let e = j.default.getCurrentUser();
    return o()(null != e, "ChangeUsernameModal: currentUser cannot be undefined"), e
  }), u = a.useMemo(() => _.ZP.canEditDiscriminator(r) && !r.isPomelo(), [r]), [d, I] = a.useState(!1), [y, L] = a.useState(r.username), [R, S] = a.useState(r.discriminator), [T, F] = a.useState(""), [B, P] = a.useState(!1), W = (0, m.e7)([v.Z], () => v.Z.getErrors()), z = (0, p.n)(), U = r.isPomelo() && z, M = (0, b.a)(y, U, !1, r.username), q = a.useRef(null), D = a.useMemo(() => {
    var e, t, n;
  ...
  return (0, l.jsxs)(x.Y0X, {
    ...
    children: [(0, l.jsxs)(x.xBx, {
      ...
      onSubmit: K,
      children: [(0, l.jsxs)(x.hzk, {
        className: k.content,
        children: [(0, l.jsx)(x.xJW, {
          ...
          children: (0, l.jsxs)("div", {
            ...
            children: [(0, l.jsx)(x.oil, {
              ...
              inputClassName: s()(k.multiInputField, {
                [k.lowercase]: r.isPomelo()
              })
            }), !r.isPomelo() && (0, l.jsx)(x.oil, {
              name: "discriminator",
