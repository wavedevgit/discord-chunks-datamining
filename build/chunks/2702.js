...
function E(e) {
  ...
  }), o = s.useMemo(() => C.ZP.canEditDiscriminator(r) && !r.hasUniqueUsername(), [r]), [d, E] = s.useState(!1), [y, L] = s.useState(r.username), [R, S] = s.useState(r.discriminator), [T, q] = s.useState(""), [F, B] = s.useState(!1), W = (0, m.e7)([j.Z], () => j.Z.getErrors()), z = (0, b.n)(), M = r.hasUniqueUsername() && z, D = (0, g.a)(y, M, !1, r.username), J = s.useRef(null), K = s.useMemo(() => {
    var e, t, n;
