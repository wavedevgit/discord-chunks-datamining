...
function I(e) {
  ...
  }), u = l.useMemo(() => _.ZP.canEditDiscriminator(r) && !r.isPomelo(), [r]), [d, I] = l.useState(!1), [y, L] = l.useState(r.username), [R, S] = l.useState(r.discriminator), [T, F] = l.useState(""), [P, B] = l.useState(!1), W = (0, m.e7)([v.Z], () => v.Z.getErrors()), z = (0, p.n)(), U = r.isPomelo() && z, M = (0, b.a)(y, U, !1, r.username), q = l.useRef(null), D = l.useMemo(() => {
    var e, t, n;
