...
function L(e) {
  ...
  let {
    transitionState: n,
    onClose: a
  } = e, o = (0, g.e7)([b.default], () => {
    let e = b.default.getCurrentUser();
    return l()(null != e, "ChangeUsernameModal: currentUser cannot be undefined"), e
  }), u = s.useMemo(() => x.ZP.canEditDiscriminator(o) && !o.isPomelo(), [o]), [c, L] = s.useState(!1), [P, R] = s.useState(o.username), [C, U] = s.useState(o.discriminator), [N, A] = s.useState(""), [I, w] = s.useState(!1), Z = (0, g.e7)([S.Z], () => S.Z.getErrors()), j = (0, _.n)(), G = o.isPomelo() && j, F = (0, p.a)(P, G, !1, o.username), D = s.useRef(null), z = s.useMemo(() => {
    var e, t, n;
        ...
        children: [(0, i.jsx)(m.xJW, {
          ...
          children: (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)(m.oil, {
              ...
              inputClassName: r()(y.multiInputField, {
                [y.lowercase]: o.isPomelo()
              })
            }), !o.isPomelo() && (0, i.jsx)(m.oil, {
              name: "discriminator",
