...
function R(e) {
  ...
  let {
    transitionState: n,
    onClose: i
  } = e, r = (0, d.e7)([_.default], () => {
    let e = _.default.getCurrentUser();
    return o()(null != e, "ChangeUsernameModal: currentUser cannot be undefined"), e
  }), u = s.useMemo(() => j.ZP.canEditDiscriminator(r) && !r.isPomelo(), [r]), [m, R] = s.useState(!1), [z, S] = s.useState(r.username), [L, P] = s.useState(r.discriminator), [y, M] = s.useState(""), [T, B] = s.useState(!1), F = (0, d.e7)([C.Z], () => C.Z.getErrors()), U = (0, b.n)(), W = r.isPomelo() && U, Z = (0, g.a)(z, W, !1, r.username), A = s.useRef(null), D = s.useMemo(() => {
    var e, t, n;
        ...
        children: [(0, l.jsx)(x.xJW, {
          ...
          children: (0, l.jsxs)("div", {
            ...
            children: [(0, l.jsx)(x.oil, {
              ...
              inputClassName: a()(E.multiInputField, {
                [E.lowercase]: r.isPomelo()
              })
