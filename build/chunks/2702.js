...
function y(e) {
  ...
  }), u = a.useMemo(() => C.ZP.canEditDiscriminator(r) && !r.isPomelo(), [r]), [d, y] = a.useState(!1), [L, R] = a.useState(r.username), [S, T] = a.useState(r.discriminator), [F, B] = a.useState(""), [P, W] = a.useState(!1), z = (0, m.e7)([j.Z], () => j.Z.getErrors()), U = (0, b.n)(), M = r.isPomelo() && U, q = (0, g.a)(L, M, !1, r.username), D = a.useRef(null), J = a.useMemo(() => {
    var e, t, n;
  ...
  return (0, s.jsxs)(f.Y0X, {
    ...
    children: [(0, s.jsxs)(f.xBx, {
      ...
      onSubmit: Z,
      children: [(0, s.jsxs)(f.hzk, {
        className: I.content,
        children: [(0, s.jsx)(f.xJW, {
          ...
          children: (0, s.jsxs)("div", {
            ...
            children: [(0, s.jsx)(x.Is, {
              ...
              inputClassName: i()(I.multiInputField, {
                [I.lowercase]: r.isPomelo()
              })
            }), !r.isPomelo() && (0, s.jsx)(x.Is, {
              name: "discriminator",
