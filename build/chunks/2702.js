...
function R(e) {
  ...
  let {
    transitionState: n,
    onClose: i
  } = e, a = (0, d.e7)([j.default], () => {
    let e = j.default.getCurrentUser();
    return o()(null != e, "ChangeUsernameModal: currentUser cannot be undefined"), e
  }), u = s.useMemo(() => C.ZP.canEditDiscriminator(a) && !a.isPomelo(), [a]), [m, R] = s.useState(!1), [z, S] = s.useState(a.username), [L, P] = s.useState(a.discriminator), [y, T] = s.useState(""), [B, F] = s.useState(!1), M = (0, d.e7)([_.Z], () => _.Z.getErrors()), W = (0, b.n)(), Z = a.isPomelo() && W, A = (0, g.a)(z, Z, !1, a.username), D = s.useRef(null), U = s.useMemo(() => {
    var e, t, n;
        ...
        children: [(0, l.jsx)(x.xJW, {
          ...
          children: (0, l.jsxs)("div", {
            ...
            children: [(0, l.jsx)(x.oil, {
              ...
              inputClassName: r()(E.multiInputField, {
                [E.lowercase]: a.isPomelo()
              })
            }), !a.isPomelo() && (0, l.jsx)(x.oil, {
              name: "discriminator",
