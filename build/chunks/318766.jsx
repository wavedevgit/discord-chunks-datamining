...
let T = 20,
  ...
  C = () => {
    ...
    return <div className={Chunk3974.premiumTooltipContainer}>{<Chunk481060.Fmz className={a()(Chunk3974.premiumUnlockAnimation, {
          [Chunk3974.reducedMotion]: module
        })} loop={false} shouldAnimate={!module} pauseAtFrame={module ? 149 : true} importData={() => require.e("21812").then(require.t.bind(require, 741855, 19))} />}{<Chunk481060.Text variant={"text-sm/medium"} className={Chunk3974.premiumTooltipText}>{Chunk388032.intl.format(Chunk388032.t["/7R4q6"], {})}</Chunk481060.Text>}</div>
  };
...
let P = function(e) {
  ...
  return <u.ua7 targetElementRef={z} text={() => (0, r.jsx)(C, {})} aria-label={E.intl.formatToMarkdownString(E.t["/7R4q6"], {})} position={"top"} shouldShow={Y} tooltipClassName={b.premiumTooltip} tooltipContentClassName={b.premiumTooltipContainer}>{e => (0, r.jsx)(u.P3F, {
      innerRef: z,
      tabIndex: t,
      className: a()(k, n),
      onMouseEnter: () => {
