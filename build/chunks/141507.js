...
let R = e => {
  ...
  P = i.memo(function(e) {
    ...
    if (i.useEffect(() => {
        let e = Date.now();
        return () => {
          Date.now() - e >= C && w(t) && z !== S.t0.NONE && (z === S.t0.NEWLY_ADDED_EMOJI && null !== t && t.type === u.B.GUILD && (0, f.Zg)(t.guildId, K[0].id), null != G.source && (0, O.Gn)({
            emoji: t,
            subCategory: z,
    ...
    if (w(t)) {
      ...
      P = "" === e ? (0, r.jsx)(s.Text, {
        ...
        alt: null != ($ = t.allNamesString) ? $ : "",
        src: e,
        className: N.emoji
      })
    } else if ("CREATE_EMOJI" === t.type) P = (0, r.jsx)(s.oFk, {
      size: "md",
      color: "currentColor",
      className: N.icon,
      colorClass: N.icon
    ...
    let Q = U && "CREATE_EMOJI" === t.type ? A.intl.string(A.t["Z/r7IS"]) : R({
      inspectedEmoji: t,
      channel: M,
      guildId: k,
      intention: j,
