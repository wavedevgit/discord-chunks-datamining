  ...
  let {
    ...
    switch (n) {
      ...
      case a.Us.NAVIGATE_OUT:
        e.preventDefault(), e.stopPropagation(), A(!0), v({
          type: n
        });
        return;
    ...
    onBlur: w,
    onMouseLeave: D,
    "aria-activedescendant": O.length > 0 ? (0, o.qR)(t, O.join(d)) : void 0
  }), [t, P, R, w, D, O]), M = r.useCallback(e => {
    let {
      path: n
    } = e;
    return {
      role: "menu",
      tabIndex: -1,
      "aria-activedescendant": L(n) ? (0, o.qR)(t, O.join(d)) : void 0,
