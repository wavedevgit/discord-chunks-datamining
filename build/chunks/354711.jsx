...
function d(e) {
  ...
  return <l.z theme={o} gradient={d} disableAdaptiveTheme={f} reduceAdaptiveTheme={_}>{p(a()((0, c.Q)(null != (n = null != (t = null == d ? true : d.theme) ? t : o) ? n : h), {
      [u.e3]: null != d,
