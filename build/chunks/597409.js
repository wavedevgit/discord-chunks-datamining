...
let b = function(e) {
  ...
  let {
    ...
    user: p,
    onSelect: d
  } = e, y = null != (r = null == b ? void 0 : b.id) ? r : s.lds, O = (0, c.e7)([a.Z], () => null != b && a.Z.canManageUser(s.Plq.BAN_MEMBERS, p, b), [b, p]);
        ...
        action: () => (0, o.ZDy)(async () => {
          ...
          return r => {
            ...
            return (0, n.jsx)(e, (t = function(e) {
              ...
              guildId: y,
              user: p
            }, Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(c)) : (function(e, r) {
              var t = Object.keys(e);
