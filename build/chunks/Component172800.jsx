...
let w = e => {
      ...
      switch (e.type) {
        case b.ld.EXPAND_OR_COLLAPSE_EMOJIS: {
          let {
            ...
            t.stopPropagation(), L.current || j.current || (T(e, {
              isFinalSelection: true,
              toggleFavorite: false
            }), (0, d.D)(e.guildId), e.sectionCollapsedToThreeRows || W(), E.default.track(v.rMx.EMOJI_PICKER_THREE_ROW_COLLAPSE_TOGGLED, {
              collapsed: e.sectionCollapsedToThreeRows,
              guild_id: e.guildId
            }))
          }, l = e.sectionCollapsedToThreeRows ? a ? (0, s.wj)(et) ? J : ee : (0, s.wj)(et) ? K : z : a ? (0, s.wj)(et) ? X : $ : (0, s.wj)(et) ? q : Q, c = S.intl.string(e.sectionCollapsedToThreeRows ? S.t.NZI2Zk : S.t["/K2RDH"]);
          return n({
            handleSelect: o,
            icon: (0, r.jsx)("img", {
              className: I.icon,
  ...
  let ef = t.filter(e => {
      let t = e;
      return t.subCategory === O.t0.TOP_GUILD_EMOJI || t.subCategory === O.t0.NEWLY_ADDED_EMOJI && t.emoji.type === f.B.GUILD && !p.Z.isNewerThanLastSeen(t.emoji.guildId, t.emoji.id)
    }),
    ep = t.filter(e => {
      let t = e;
      return t.subCategory === O.t0.NEWLY_ADDED_EMOJI && t.emoji.type === f.B.GUILD && p.Z.isNewerThanLastSeen(t.emoji.guildId, t.emoji.id)
    });
  return 0 === ep.length ? ed(t) : (0, r.jsxs)("div", {
    className: I.topEmojiSectionContainer,
    children: [(0, r.jsx)("div", {
      className: o()(I.topEmojiContainer, {
        [I.noEmojis]: 0 === ef.length
      }),
      children: ed(ef)
    }), (0, r.jsxs)("div", {
