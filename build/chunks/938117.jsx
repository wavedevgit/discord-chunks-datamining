...
function O(e) {
  ...
  return P ? <a.xJW title={_.intl.string(_.t.lZTUPj)} className={I}>{null != y ? <a.kzN className={j.videoBackgroundError}>{y}</a.kzN> : null}{<h.Z canUseCustomBackgrounds={R} customBackgroundOptions={Z} selectedOption={O} onSelectOption={M} onUpsellClick={() => {
        (0, a.ZDy)(async () => {
          let {
            default: e
