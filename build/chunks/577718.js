...
function L(e) {
  null != e && h.Z.open(e.id, y.pNK.BOOST_PERKS, {
    section: y.jXE.PREMIUM_GUILD_PROGRESS_BAR
  })
}

function w(e, t) {
  null != t && ((0, O.f2)(t, y.Eu4.TIER_1) ? h.Z.open(t.id, y.pNK.BOOST_PERKS, {
    section: y.jXE.PREMIUM_GUILD_INVITE_SPLASH
  }) : (0, u.Z)({
...
let D = i.memo(function(e) {
  ...
  }, k = (0, a.wj)(n) ? A : x, [M, U] = (0, c.US)(t, v.R.GUILD_HEADER_TOOLTIPS);
    ...
    children: (() => {
      switch (M) {
        ...
        case l.z.GUILD_HEADER_INVITE_SPLASH:
          let e = (0, O.f2)(i, y.Eu4.TIER_1) ? N.intl.format(N.t.DDzEVl, {}) : N.intl.formatToPlainString(N.t.pMftkJ, {
              boostCount: (0, O.KK)(i, y.Eu4.TIER_1)
            }),
