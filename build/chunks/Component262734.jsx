...
function j(e) {
  ...
  })), x = (0, s.e7)([h.Z], () => null != P && j === P && h.Z.getChatOpen(P), [j, P]), A = (0, s.e7)([m.ZP], () => m.ZP.callChatSidebarWidth), Z = (0, u.dQu)(o.Z.modules.chat.RESIZE_HANDLE_WIDTH), w = i.useRef(null), L = i.useRef(null), [D, R] = i.useState({
    width: 0,
    height: 0
  }), M = i.useCallback(() => {
