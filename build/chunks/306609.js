...
function B(e) {
  ...
  } = (0, m.ZP)(p.Z.VOICE_FILTER_POPOUT), X = i.useRef(null), q = (0, d.Z)({
    minDimension: 400,
    maxDimension: 600,
  ...
  let K = (0, s.e7)([O.default], () => (0, S.I5)(O.default.getCurrentUser())),
    ...
    es = i.useRef(null);
  (0, u.ZP)(() => {
    (0, E.r5)(), ei && (0, I.jG)(), j.default.track(k.rMx.VOICE_FILTER_PICKER_OPENED, {
        ...
        children: [(0, r.jsx)(v.j, {
          ...
          onOpen: () => {
            ...
            j.default.track(k.rMx.VOICE_FILTER_MIC_SELECTOR_OPENED, {
              active_voice_filter_id: null != (e = h.Z.getActiveVoiceFilter()) ? e : null
            })
          },
          popoutPosition: "top"
        }), l && (0, r.jsx)(v.j, {
          ...
          renderPopout: () => (0, r.jsx)(g.default, {
            ...
            onClose: t,
            onInteraction: (0, _.u)("AudioDeviceMenu", J, {
              entrypoint: L.A5.THREE_DOT
            }),
            minimal: !0
          }),
          children: e => (0, r.jsx)(c.hU, Y(W({
            variant: "secondary"
          }, e), {
            buttonRef: eu,
            icon: c.Huf,
