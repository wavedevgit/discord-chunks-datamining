...
function V(e) {
  ...
  let H = (0, s.e7)([h.default], () => (0, y.I5)(h.default.getCurrentUser())),
    ...
    et = (0, c.q_F)({
      transform: X ? "translateY(-8px) scale(".concat(.96, ")") : "translateY(0px) scale(1)",
      config: {
        duration: 150,
        mass: 1,
        stiffness: 711.1,
    ...
    ei = i.useRef(null);
  (0, u.ZP)(() => {
    (0, C.r5)(), ee && (0, j.jG)(), v.default.track(A.rMx.VOICE_FILTER_PICKER_OPENED, {
  ...
  return (0, r.jsx)(p.Gt, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      }), (0, r.jsx)(w.l, {}), (0, r.jsx)(E.R, {}), (0, r.jsx)(T.y, {}), (0, r.jsxs)("div", {
        className: a()(R.voiceFiltersFooter, {
          [R.hasActiveVoice]: null != $
        }),
        children: [(0, r.jsx)(P.Y, {}), l && (0, r.jsx)(P.a, {}), (0, r.jsx)(c.yRy, {
          targetElementRef: ea,
          position: "top",
          align: "right",
          ...
          children: e => (0, r.jsx)(c.zxk, U(F({}, e), {
            buttonRef: ea,
            ...
            onClick: t => {
              var n;
              v.default.track(A.rMx.VOICE_FILTER_VOICE_SETTINGS_CLICKED, {
                active_voice_filter_id: null != $ ? $ : null
