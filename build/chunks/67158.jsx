...
let m = Chunk73800.memo(Chunk73800.forwardRef(function(e, t) {
  ...
  return n ? null : <div className={l()(d.CT, u.buttonContainer)} ref={t}><o.Z className={l()(u.emojiButton, m)} onClick={x} active={(g === d.X1.GIF || g === d.X1.EMOJI || g === d.X1.STICKER) && f === a} tabIndex={0} focusProps={{
        offset: {
          top: 4,
          bottom: 4,
          left: false,
