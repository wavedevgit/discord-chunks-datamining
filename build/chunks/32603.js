/** Chunk was on web.js **/
/** chunk id: 32603, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  Ay: () => et,
  HP: () => Z,
  ...
  xu: () => es,
  yO: () => Q
}), require("./896048.js"), require("./65821.js"), require("./321073.js"), require("./114821.js"), require("./339614.js"), require("./667532.js"), require("./638769.js");
var Chunk284009 = require("./284009.js"),
  ...
  Chunk99712 = require("./99712.js"),
  Chunk240935 = require("./240935.js"),
  Chunk50827 = require("./50827.js"),
...
let K = "placeholder-channel-id",
  ...
  $ = 4,
  J = 5,
  ee = new Set([String(Chunk281405.n.GUILD_DIRECTORY)]);
class et {
  _areGuildActionRowsUpdated(e, t) {
    var n;
    return !s().isEqual(null == (n = this.guilds[e]) ? true : n.getGuildActionSection().getRows().filter(e => !ee.has(e)), t)
  }
  _areChannelNoticeRowsUpdated(e, t) {
    var n;
    return !s().isEqual(null == (n = this.guilds[e]) ? true : n.getChannelNoticeSection().getRows(), t)
  }
  _areGuildVocalChannelsInRecentsInNeedOfAppearingInActiveNow(e) {
    ...
    for (let e in r.channels) {
      let t = r.channels[e];
      if (2 === t.renderLevel && t.record.isGuildVocal() && null == n.channels[t.id] && s().some(D.A.getVoiceStatesForChannel(t.id)) && R.Ay.getMentionCount(t.id) > 0) returntrue
    }
    returnfalse
  }
  getGuild(e, t, n) {
  ...
  updateRecentsCategory(e) {
    var t, n;
    return null != e && e in this.guilds && null != (t = null == (n = this.guilds[e]) ? true : n.updateRecentsCategory()) && t
  }
  nonPositionalChannelIdUpdate(e) {
    let t = I.A.getBasicChannel(e);
    return null != t && null != t.guild_id && null != this.guilds[t.guild_id] && (t instanceof v.YB || null != (t = I.A.getChannel(e))) && this.nonPositionalChannelUpdate(t)
  }
...
class en {
  ...
  getNamedCategoryFromSection(e) {
    return e -= J, i()(e >= 0 && e < this.getSortedNamedCategories().length, "invalid section index ".concat(e)), this.getSortedNamedCategories()[e]
  }
  ...
  getSectionRowsFromChannel(e) {
    ...
    if (o >= 0 && n.push({
      ...
      section: s().findIndex(this.getSortedNamedCategories(), e => e.id === (null == r ? true : r.id)) + J
    }];
  ...
  getSlicedChannels(e, t) {
    ...
    for (let e of this.getSortedCategories()) {
      ...
      for (let t of e.getShownChannelIds()) {
        let c = e.channels[t];
        a && (c.id === n.id ? a = false : i || o.push(c)), s && !i && l.push(c), a || s || c.id !== r.id || (s = true)
      }
    }
    return [o, e, l]
  }
  ...
  constructor(e, t, n) {
    ...
    for (const e in o) {
      ...
      if (t.type !== G.rbe.GUILD_CATEGORY) {
        ...
        eS(this, t, O) ? p.push(t) : (t.type === G.rbe.GUILD_VOICE || t.type === G.rbe.GUILD_STAGE_VOICE) && (null != t.parent_id && null != c[t.parent_id] && m.push(c[t.parent_id]), m.push(t)), null != t.parent_id && t.parent_id in f ? f[t.parent_id].push(t) : u.push(t)
      }
    }
    for (const e in this.categories = {}, f) this.categories[e] = new ea(this, c[e], f[e], O);
    this.recentsSectionNumber = Q, this.favoritesSectionNumber = Z, this.noParentCategory = new ei(this, u, O), this.favoritesCategory = new es(this, O), this.recentsCategory = (0, _.i)() ? new eo(this, o, O) : new el(this, p, O), this.voiceChannelsCategory = new eu(this, m, c, O), this.guildActionSection = new ef(t, E.length > 0), this.channelNoticeSection = new ed(n), i()(!("null" in this.categories), "somehow a null got into categories"), this.voiceChannelsSectionNumber = J + s().size(this.categories)
  }
}
class er {
  updateChannel(e, t) {
...
class ea extends er {
  ...
  constructor(e, t, n, r) {
    for (const i of (super(e), B(this, "id", true), B(this, "record", true), this.record = t, this.id = t.id, this.isCollapsed = true === e.collapsedCategoryIds[t.id], this.isMuted = e.mutedChannelIds.has(t.id), this.channels = {}, n)) this.channels[i.id] = new e_(this, i, r)
  }
}
class es extends er {
  updateChannel(e, t) {
  ...
  constructor(e, t) {
    ...
    this.channels = s()(null != (n = P.Ay.getGuildFavorites(e.id)) ? n : []).map(e => I.A.getChannel(e)).filter(L.Vq).map(e => new eh(this, e, t)).keyBy(e => e.id).value();
...
class eo extends er {
  ...
  constructor(e, t, n) {
    if (super(e), B(this, "enabled", false), this.isCollapsed = m.A.isCollapsed(e.id), this.enabled = eO() && Object.keys(t).length >= eo.MIN_READABLE_CHANNELS, this.enabled)
      for (const e of Object.values(t))(0, v.ig)(e.type) && !(0, v.fT)(e.type) && (this.channels[e.id] = new eg(this, e, n))
  }
}
...
class el extends er {
  ...
  updateChannel(e, t) {
    ...
    if (this.guild.optInEnabled) {
      ...
      if (eS(this.guild, e, t) && null == n) return this.channels[e.id] = new em(this, e, t), this.invalidate(), true
    }
    return n
  }
  getFirstVoiceChannel(e) {
  ...
  constructor(e, t, n) {
    ...
    this.isCollapsed = false, this.isMuted = false, this.channels = s()(t).map(e => new em(this, e, n)).keyBy(e => e.id).value()
  }
}
...
function ec(e, t) {
  ...
  if (null != e.record.parent_id) {
    var n, r;
    return null != (n = null == (r = t[e.record.parent_id]) ? true : r.position) ? n : false
  }
  return false
}
class eu extends er {
  ...
  getShownChannelIds() {
    if (!this.guild.optInEnabled) return [];
    if (null == this.shownChannelIds) {
      let t = s()(this.channels).filter(e => 4 === e.renderLevel).orderBy([e => ec(e, this.categoriesById), e => e.record.type === G.rbe.GUILD_CATEGORY ? false : e.record.position], ["asc", "asc"]).value();
      this.shownChannelIds = [];
      for (let n = 0; n < t.length; n++) {
        var e;
        let r = t[n];
        n < t.length - 1 && r.record.type === G.rbe.GUILD_CATEGORY && (null == (e = t[n + 1]) ? true : e.record.type) === G.rbe.GUILD_CATEGORY || (n !== t.length - 1 || r.record.type !== G.rbe.GUILD_CATEGORY) && this.shownChannelIds.push(r.id)
      }
    }
    return this.shownChannelIds
  }
  ...
  constructor(e, t, n, r) {
    ...
    this.isCollapsed = k.A.isVoiceCategoryCollapsed(e.id), this.isMuted = false, this.categoriesById = n, this.channels = s()(t).map(e => new eE(this, e, r)).keyBy(e => e.id).value()
  }
}
class ed {
  isEmpty() {
...
class ef {
  ...
  constructor(e, t) {
    B(this, "guildActionRows", true), this.guildActionRows = e.map(String), t && this.guildActionRows.push(String(U.n.GUILD_DIRECTORY))
  }
}
class ep {
  get isMuted() {
  ...
  updateChannel(e, t) {
    ...
    return r.renderLevel === this.renderLevel && s().isEqual(r.threadIds, this.threadIds) || (this.renderLevel = r.renderLevel, this.threadIds = r.threadIds, this.threadCount = s().size(r.threadIds), n = true), 4 === this.renderLevel && this.updateSubtitle() && (n = true), n
  }
  updateSubtitle() {
    let e = this.computeSubtitle();
    return !s().isEqual(this.subtitle, e) && (this.subtitle = e, true)
  }
  computeSubtitle() {
...
class e_ extends ep {
  computeState(e) {
    ...
    return this.id !== l.moderatorReportChannelId || l.moderatorReportChannelEnabled ? l.optInEnabled && l.hideResourceChannels && this.record.hasFlag(V.lx.IS_GUILD_RESOURCE_CHANNEL) ? {
      renderLevel: c ? 4 : 1,
      threadIds: p
    } : !l.optInEnabled || l.optedInChannels.has(this.id) || null != o && l.optedInChannels.has(o) ? c || d || !s().isEmpty(p) || R.Ay.getMentionCount(this.id) > 0 ? {
      renderLevel: 4,
      threadIds: p
    } : l.hideMutedChannels && l.mutedChannelIds.has(this.id) ? {
      renderLevel: 2,
      threadIds: p
    } : this.category.isCollapsed && (l.mutedChannelIds.has(this.id) || null != o && l.mutedChannelIds.has(o) || this.record.isGuildVocal() || this.record.type === G.rbe.GUILD_STORE || (0, v.ig)(this.record.type) && !R.Ay.hasUnread(this.record.id)) ? {
      renderLevel: 3,
      threadIds: p
    } : {
      renderLevel: 4,
...
class em extends ep {
  computeState(e) {
    ...
    return N.A.can(F.xB.VIEW_CHANNEL, this.record) ? eS(this.category.guild, this.record, e) ? {
...
class eg extends e_ {
  computeState(e) {
    ...
    if (t > 1) {
      ...
      i.mutedChannelIds.has(this.id) || null != r && i.mutedChannelIds.has(r) ? t = 2 : 4 === t ? t = 3 : 2 === t && eS(this.category.guild, this.record, e) && (t = 3), 3 === t && ev(this, e) && (t = 4), n = s().sortBy(n, e => -R.Ay.lastMessageTimestamp(e))
    }
    return {
      renderLevel: t,
      threadIds: n
...
class eE extends e_ {
  getRenderLevel(e) {
    ...
    return !N.A.can(F.xB.VIEW_CHANNEL, this.record) || 4 === e || 3 === e || eA(t, this.record) ? 1 : this.category.isCollapsed ? s().some(D.A.getVoiceStatesForChannel(this.record.id)) ? 4 : 3 : 4
  }
  computeState(e) {
  ...
  switch (e.type) {
    case G.rbe.GUILD_VOICE: {
      ...
      let s = o.Ay.getEmbeddedActivitiesForChannel(e.id).map(e => {
        var t;
        return null == (t = l.A.getApplication(e.applicationId)) ? true : t.name
      }).filter(L.Vq);
...
function ey(e, t, n, r, i) {
  ...
  if (v.wE.has(e.type)) {
    ...
    return a ? e : o ? (n.id in t || e.unshift(n.id), e) : i ? e.filter(e => !A.A.isMuted(e) || R.Ay.getMentionCount(e) > 0) : e
  }
  return []
}
...
function ev(e, t) {
  ...
  if (R.Ay.getMentionCount(e.id) > 0) returntrue;
  for (let t in r[e.id])
    if (R.Ay.getMentionCount(t) > 0) returntrue;
...
function eS(e, t, n) {
  ...
  if (t.type === G.rbe.GUILD_DIRECTORY || !e.optInEnabled || e.optedInChannels.has(t.id) || t.isThread() || null != t.parent_id && e.optedInChannels.has(t.parent_id) || e.hideResourceChannels && t.hasFlag(V.lx.IS_GUILD_RESOURCE_CHANNEL)) returnfalse;
  if (t.isGuildVocal()) {
  ...
  if (null != r && (r.id === t.id || r.isThread() && r.parent_id === t.id) || R.Ay.getMentionCount(t.id) > 0) returntrue;
  for (let e in i[t.id])
    if (R.Ay.getMentionCount(e) > 0 || R.Ay.hasUnread(e) || R.Ay.hasRecentlyVisitedAndRead(e)) returntrue;
...
let eI = new Set(Object.values(Chunk281405.n));

function eT(e) {
  if (null == e) return null;
  if (eI.has(e)) return e;
  let t = I.A.getChannel(e);
  return (null == t ? true : t.isDirectory()) ? U.n.GUILD_DIRECTORY : null
}