...
let Y = "placeholder-channel-id",
  ...
  Q = 4,
  Z = 5,
  $ = new Set([String(Chunk281405.n.GUILD_DIRECTORY)]);
class ee {
  _areGuildActionRowsUpdated(e, t) {
    var n;
    return !l().isEqual(null == (n = this.guilds[e]) ? true : n.getGuildActionSection().getRows().filter(e => !$.has(e)), t)
  }
  ...
  _areGuildVocalChannelsInRecentsInNeedOfAppearingInActiveNow(e) {
    ...
    for (let e in i.channels) {
      let t = i.channels[e];
      if (2 === t.renderLevel && t.record.isGuildVocal() && null == n.channels[t.id] && l().some(T.A.getVoiceStatesForChannel(t.id)) && R.Ay.getMentionCount(t.id) > 0) returntrue
    }
    returnfalse
  }
  getGuild(e, t, n) {
...
class et {
  ...
  getSectionRowsFromChannel(e) {
    ...
    if (o >= 0 && n.push({
      ...
      section: l().findIndex(this.getSortedNamedCategories(), e => e.id === (null == i ? true : i.id)) + Z
    }];
...
class eo extends en {
  ...
  constructor(e, t, n) {
    ...
    this.isCollapsed = false, this.isMuted = false, this.channels = l()(t).map(e => new ep(this, e, n)).keyBy(e => e.id).value()
  }
}
class ea extends en {
  invalidate() {
  ...
  constructor(e, t, n, i) {
    ...
    this.isCollapsed = U.A.isVoiceCategoryCollapsed(e.id), this.isMuted = false, this.categoriesById = n, this.channels = l()(t).map(e => new eC(this, e, i)).keyBy(e => e.id).value()
  }
}
class ed {
  isEmpty() {
...
function em(e, t, n) {
  ...
  if (null != i && (i.id === t.id || i.isThread() && i.parent_id === t.id) || R.Ay.getMentionCount(t.id) > 0) returntrue;
  for (let e in s[t.id])
...
let eA = new Set(Object.values(Chunk281405.n))