...
let I = e => {
    ...
    let {
      ...
      channelId: u,
      messageId: d
    } = e, f = i.useRef(null), h = null == (t = n.originalMatch) ? true : t[0], m = null != h ? h : n.name, [g, b] = i.useState(false), O = e => <c.Z{...v(y({}, e), {
      emojiName: n.name,
    ...
    return <l.yRy animation={l.yRy.Animation.TRANSLATE} align={"center"} autoInvert={true} nudgeAlignIntoViewport={true} position={"right"} onRequestClose={() => {
        b(false)
      }} renderPopout={T} targetElementRef={f}>{I}</l.yRy>
  },
  T = e => {
    let {
      node: t,
    ...
    return <l.yRy animation={l.yRy.Animation.FADE} align={"center"} onRequestClose={() => {
        f.default.track(h.rMx.CLOSE_POPOUT, {
          nonce: w
        }), A(false), C(false)
      }} autoInvert={true} nudgeAlignIntoViewport={true} position={"right"} renderPopout={L} positionKey={O} targetElementRef={R}>{D}</l.yRy>
  },
  S = e => {
    let {
      emojiNode: t,
