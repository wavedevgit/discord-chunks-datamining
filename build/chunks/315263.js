...
function B(e) {
  ...
  if (null != C && C.type === g.g.ACTIVITY_BOOKMARK) return e => {
    ...
    let {
      code: t,
      url: n
    } = C, r = h.Z.getApplication(t), i = new URL(n), o = (0, f.Z)(), {
      currentChannelId: l,
      instanceId: _,
      isCurrentlyInInstance: p,
      canLaunchInChannel: g
    } = (0, m.v)(t);
    if (g) return !p && null != l && ((0, d.u)(t, i.searchParams.get("link_id"), i.searchParams.get("custom_id"), i.searchParams.get("referrer_id")).then(async e => {
      let {
        customId: n,
        referrerId: r
      } = e;
    ...
    }).catch(() => {}), !0);
    {
      ...
      return null != e && (a.Z.openPrivateChannel(e).then(async e => {
        let {
          customId: n,
          referrerId: r
        } = await (0, d.u)(t, i.searchParams.get("link_id"), i.searchParams.get("custom_id"), i.searchParams.get("referrer_id"));
        (0, u.Z)({
  ...
  if (null != C && C.type === g.g.QUESTS_EMBED && (0, S.cB)({
  ...
  return Z && (null == B ? void 0 : B.startsWith("/discovery/quests")) ? e => (null == e || e.preventDefault(), (0, T.navigateToQuestHome)({
    fromContent: i.j.QUEST_BADGE
  }), !0) : Z && (null == B ? void 0 : B.startsWith("/discovery/servers")) ? e => (null == e || e.preventDefault(), n.e("11866").then(n.bind(n, 749681)).then(e => {
    let {
      transitionToGlobalDiscovery: t
    } = e, {
      GlobalDiscoveryTab: r
  ...
  }), !0) : o || null == (0, A.v)(e) ? void 0 : t => (null == t || t.preventDefault(), N.Z.show(e), !0)
}