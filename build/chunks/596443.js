...
function I(e) {
  ...
  let {
    ...
    categoryTitle: x,
    userId: E
  } = e, I = (0, c.e7)([b.Z], () => b.Z.getRoles(C.id)), P = j.Plq[s], S = null != (l = null == (t = y[P.toString()]) ? void 0 : t.title) ? l : (0, m.wt)(P), Z = null != (a = null == (n = y[P.toString()]) ? void 0 : n.description) ? a : "", T = v._o.has(P), A = v.Qn.includes(s), w = g.length, R = (0, c.e7)([_.Z], () => _.Z.can(j.Plq.MANAGE_ROLES, C), [C]), M = i.useCallback(async e => {
