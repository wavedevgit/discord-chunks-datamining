...
function P(e) {
  ...
  let {
    ...
    categoryTitle: C,
    userId: E
  } = e, P = (0, c.e7)([b.Z], () => b.Z.getRoles(y.id)), S = j.Plq[s], Z = null != (l = null == (t = x[S.toString()]) ? void 0 : t.title) ? l : (0, m.wt)(S), N = null != (o = null == (n = x[S.toString()]) ? void 0 : n.description) ? o : "", T = v._o.has(S), A = v.Qn.includes(s), w = g.length, R = (0, c.e7)([_.Z], () => _.Z.can(j.Plq.MANAGE_ROLES, y), [y]), k = i.useCallback(async e => {
