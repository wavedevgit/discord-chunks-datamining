...
function D(e) {
  ...
  let {
    ...
    categoryTitle: h,
    userId: O
  } = e, C = (0, u.Wu)([I.Z], () => I.Z.getManyRoles(g.id, m)), D = R.Plq[o], b = null != (s = null == (t = N[D.toString()]) ? void 0 : t.title) ? s : (0, A.wt)(D), L = null != (a = null == (n = N[D.toString()]) ? void 0 : n.description) ? a : "", x = p._o.has(D), U = p.Qn.includes(o), M = m.length, P = (0, u.e7)([f.Z], () => f.Z.can(R.Plq.MANAGE_ROLES, g), [g]), j = l.useCallback(async e => {
