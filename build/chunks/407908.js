...
function b(e) {
  ...
  let {
    channel: b
  } = e, _ = i.useContext(p.AnalyticsContext), C = (0, a.Aq)(), x = m.intl.string(g.default["Beo/7u"]), {
    firstMessage: y
  } = (0, s.cl)(b), v = null == y || null == (t = y.messageSnapshots) ? void 0 : t[0], j = null == v || null == (n = v.moderatorReport) ? void 0 : n.reported_user_id;
