...
async function ea(e) {
  ...
  } = e, O = P.Z.getChannel(r), v = null != (t = null == O ? void 0 : O.getGuildId()) ? t : void 0;
  ...
  return await new Promise((e, c) => {
    (0, m.Z)({
      ...
      interactionLifecycleOptionsFactory: () => ({
        ...
        onFailure: (e, n, a, o) => {
          null == l || l(), k.default.track(Q.rMx.ACTIVITY_INTERACTION_CALLBACK_ERROR, {
            channel_id: r,
            guild_id: i,
            application_id: t,
...
async function el(e) {
  ...
  if (null == i) return M.S.dispatch(Q.CkL.SHOW_ACTIVITIES_CHANNEL_SELECTOR, {
    applicationId: d
  }), {
    result: "failure",
    reason: 3
  ...
  if (p !== Y.jy.CAN_LAUNCH) {
    let e = 4;
    return p === Y.jy.NO_USE_EMBEDDED_ACTIVITIES_PERMISSION ? (e = 5, (0, N.w)()) : p === Y.jy.ACTIVITIES_FEATURE_NOT_ENABLED_FOR_OS && (e = 6, l.Z.show({
  ...
  if ((null == h ? void 0 : h.applicationId) != null && (t = E.Z.getApplication(null == h ? void 0 : h.applicationId)), !(!o || await (0, F.p)({
      applicationId: n,
      application: f,
      channel: _,
  ...
  return null != i ? (await G.Z.post(er({
...
async function e_(e) {
  ...
  let {
    guildId: o,
    force: l = !1
  } = e, c = V.ZP.getShelfActivities(o), u = c.map(e => E.Z.getApplication(e.application_id)).filter(U.lm);
...
function em() {
  ...
  (0, v.wH)(o.z.ACTIVITIES_VOICE_LAUNCHER_BADGE, Math.floor(new Date().getTime() / 1e3), {
    dismissAction: e
  })
}
async function eg(e) {
...
function ey() {
  eE(X.Ez.ACTIVITY_POPOUT_WINDOW), s.Z.dispatch({
