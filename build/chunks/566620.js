  ...
  return await new Promise((e, c) => {
    (0, h.Z)({
      ...
      interactionLifecycleOptionsFactory: () => ({
        ...
        onFailure: (e, n, o, a) => {
          null == l || l(), L.default.track(z.rMx.ACTIVITY_INTERACTION_CALLBACK_ERROR, {
            channel_id: r,
            guild_id: i,
            application_id: t,
            ...
            error_reason_code: a,
            source: s
          }), null != e && null != n && null != o ? c(new f.Z({
            status: o,
            body: {
              message: n,
              code: e
            }
          })) : null != a && a in v.Z.ReasonCodes ? c(new v.Z(a)) : c(new v.Z(v.Z.ReasonCodes.UNKNOWN))
        }
      })
    })
  }), {
...
async function ei(e) {
  ...
  if (null == i) return x.S.dispatch(z.CkL.SHOW_ACTIVITIES_CHANNEL_SELECTOR, {
    applicationId: d
  }), {
    result: "failure",
    reason: 3
  ...
  if ((null == h ? void 0 : h.applicationId) != null && (t = g.Z.getApplication(null == h ? void 0 : h.applicationId)), !(!a || await (0, B.p)({
      applicationId: n,
      application: f,
      channel: _,
