      ...
      interactionLifecycleOptionsFactory: () => ({
        ...
        onFailure: (e, n, o, a) => {
          null == l || l(), L.default.track(q.rMx.ACTIVITY_INTERACTION_CALLBACK_ERROR, {
            ...
            error_reason_code: a,
            source: s
          }), null != e && null != n && null != o ? u(new f.Z({
            status: o,
            body: {
              message: n,
              code: e
            }
          })) : null != a && a in v.Z.ReasonCodes ? u(new v.Z(a)) : u(new v.Z(v.Z.ReasonCodes.UNKNOWN))
        }
      })
    })
  }), {
...
async function ea(e) {
  ...
  if (!E && null == i) return x.S.dispatch(q.CkL.SHOW_ACTIVITIES_CHANNEL_SELECTOR, {
    applicationId: m
  }), {
    result: "failure",
    reason: 3
  ...
  if (O !== H.jy.CAN_LAUNCH) {
    let e = 4;
    return O === H.jy.NO_USE_EMBEDDED_ACTIVITIES_PERMISSION ? (e = 5, (0, T.w)()) : O === H.jy.ACTIVITIES_FEATURE_NOT_ENABLED_FOR_OS && (e = 6, s.Z.show({
  ...
  if ((null == v ? void 0 : v.applicationId) != null && (t = g.Z.getApplication(null == v ? void 0 : v.applicationId)), !(!a || await (0, F.p)({
      applicationId: n,
      application: b,
      channel: y,
  ...
  if (null != i && !_) return await j.Z.post(ee({
...
async function ed(e) {
  ...
  let {
    guildId: s,
    force: l = !1
  } = e, c = B.ZP.getShelfActivities(s), u = c.map(e => g.Z.getApplication(e.application_id)).filter(M.lm);
