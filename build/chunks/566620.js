...
async function el(e) {
  ...
  } = e, O = M.Z.getChannel(r), v = null != (t = null == O ? true : O.getGuildId()) ? t : true;
  ...
  try {
    ...
    if (null != n && (0, Q.Z)({
      ...
      if (null == m || m(), "failure" === e.result) throw new T.Z(T.Z.Reasons.LEGACY_LAUNCH_CLIENT_VALIDATION_FAILED, e.reason)
    }
    l.Z.dispatch({
