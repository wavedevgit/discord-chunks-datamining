...
async function er(e) {
  ...
  }, !0), await (0, N.a)(e, t).then(n.resolve).catch(n.reject)
}
...
function ei(e) {
  ...
  for (let e of ("guild" === i.type && c.size > 0 && u.Z.requestMembersById(i.guildId, [...c]), (0, R.nG)(a.application_commands.map(e => eD(e, o)), !0))) {
...
function es(e, t) {
  ...
  return t.forEach(e => {
    ...
    let s = (0, R.X0)(j(M({}, r.descriptor.application), {
      bot: t
    }));
...
class ep extends(r = l.ZP.Store) {
  ...
  query(e, t, n) {
    ...
    let r = "channel" === e.type ? e.channel : void 0,
      ...
      d = !1;
    n.allowFetch && (u && c && null != r && eC(r) && (v.default.track(L.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
      miss: null == i.result,
      size: Object.keys(eh.indices).length
    }), eR(i) && null != r && (null != r.guild_id ? (0, N.j)({
      type: "guild",
      guildId: r.guild_id
    }) : (0, N.j)({
      type: "channel",
      ...
      type: "user"
    }), d = !0), eR(o) && null != n.applicationId && ((0, N.j)({
      type: "application",
...
function eg(e, t, n) {
  let [r, a] = i.useState(!0), o = (0, l.cj)([eh], () => "channel" === e.type ? eh.getContextState(e) : eh.getUserState());
  return i.useEffect(() => {
    if (r) {
      ...
      n && t && eC(e.channel) && (v.default.track(L.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
        miss: null == o.result,
        size: Object.keys(eh.indices).length
      }), eR(o) && (null != e.channel.guild_id ? (0, N.j)({
        type: "guild",
...
function eE(e, t) {
  let [n, r] = i.useState(!0), a = (0, l.cj)([eh], () => {
    var t;
    return null != (t = eh.indices[e]) ? t : H
  });
  return i.useEffect(() => {
    n && null != e && (t && (v.default.track(L.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
      miss: null == a.result,
      size: Object.keys(eh.indices).length
    }), eR(a) && (0, N.j)({
      type: "guild",
...
function eb(e, t) {
  let [n, r] = i.useState(!0), a = (0, l.cj)([eh], () => eh.getUserState());
  return i.useEffect(() => {
    n && (t && eR(a) && e && (0, N.j)({
      type: "user"
    }), r(!1))
...
function ey(e, t) {
  let [n, r] = i.useState(!0), a = (0, l.e7)([eh], () => eh.getApplicationState(e));
  i.useEffect(() => {
    n && (t && eR(a) && null != e && (0, N.j)({
      type: "application",
      applicationId: e
    }), r(!1))
  }, [t, e, a, n])
...
function eN(e) {
  ...
  let {
    ...
    scoreMethod: v = A.p.NONE,
    sortOptions: O = eS,
    installOnDemand: S = !1
  } = e, {
    commandTypes: N
  } = c, C = null == p ? void 0 : p.toLowerCase(), R = null == C ? void 0 : C.split(" "), P = h === A.D.ONLY_TEXT, w = h !== A.D.DENY ? (0, I.Kh)(N, !0, P) : [], L = [], x = {
    permissionContext: c,
    query: C,
    splitQuery: R,
    ...
    scoreMethod: v,
    installOnDemand: S
  }, k = null != (i = null == (t = u.result) ? void 0 : t.sections) ? i : {}, U = null != (a = null == (n = d.result) ? void 0 : n.sections) ? a : {}, G = new Set;
  if (g) {
...
function eA(e, t, n, r, i) {
  ...
  for (let i of t)
    if (w.Ft(i, u, {
      ...
      y.push(i)
    } return 0 !== (a = c !== A.p.NONE && null != o && null != s ? ek(o, s, y, e, c) : y).length || l ? ((c === A.p.NONE || c === A.p.APPLICATION_ONLY) && a.sort((e, t) => eU(e.displayName, t.displayName)), {
    section: e,
    data: a
  }) : null
}
...
function ek(e, t, n, r, i) {
  ...
  for (let t of n) {
    let n;
    (i === A.p.COMMAND_ONLY || i === A.p.COMMAND_OR_APPLICATION) && (n = ej(t, e, c, u)), (void 0 === n || void 0 !== a && a < n) && (n = a), void 0 !== n && o.push(j(M({}, t), {
      score: n
    }))
  }
  return o
