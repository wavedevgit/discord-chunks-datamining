...
function ei(e) {
  ...
  for (let e of ("guild" === i.type && c.size > 0 && u.Z.requestMembersById(i.guildId, [...c]), (0, C.nG)(o.application_commands.map(e => eD(e, a)), !0))) {
...
function e_() {
  ...
  return e !== eh.oldLocale && (X(), eh.collator = new Intl.Collator(e, {
    sensitivity: "accent",
    numeric: !0
  }), eh.oldLocale = e, !0)
}
class ep extends(r = l.ZP.Store) {
  ...
  getContextState(e) {
    var t, n;
    return "contextless" !== e.type && eC(e.channel) ? null !== (n = this.indices[null !== (t = e.channel.guild_id) && void 0 !== t ? t : e.channel.id]) && void 0 !== n ? n : Z : V
  }
  ...
  query(e, t, n) {
    ...
    let r = "channel" === e.type ? e.channel : void 0,
      ...
      d = !1;
    n.allowFetch && (u && c && null != r && eC(r) && (v.default.track(D.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
      miss: null == i.result,
      size: Object.keys(eh.indices).length
    }), eR(i) && null != r && (null != r.guild_id ? (0, T.j)({
      type: "guild",
      guildId: r.guild_id
    }) : (0, T.j)({
      type: "channel",
      ...
      type: "user"
    }), d = !0), eR(a) && null != n.applicationId && ((0, T.j)({
      type: "application",
...
function eg(e, t, n) {
  ...
  return i.useEffect(() => {
    if (r) {
      ...
      n && t && eC(e.channel) && (v.default.track(D.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
        miss: null == a.result,
        size: Object.keys(eh.indices).length
      }), eR(a) && (null != e.channel.guild_id ? (0, T.j)({
        type: "guild",
...
function eE(e, t) {
  ...
  return i.useEffect(() => {
    n && null != e && (t && (v.default.track(D.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
      miss: null == o.result,
      size: Object.keys(eh.indices).length
    }), eR(o) && (0, T.j)({
      type: "guild",
...
function eT(e, t, n) {
  let r = "channel" === e.type ? e.channel : void 0,
    ...
    c = ey(),
    u = eO();
  return ev(n.applicationId, n.allowFetch), i.useMemo(() => eN({
    permissionContext: o,
    text: t.text,
...
function eN(e) {
  ...
  let F = L.flatMap(e => e.data.map(t => k(x({}, t), {
    section: e.section
  })));
  ...
  return {
    ...
    sectionedCommands: L,
    loading: (null == u ? void 0 : u.fetchState.fetching) === !0 || (null == d ? void 0 : d.fetchState.fetching) === !0 || null != b && (null === (r = _.get(b)) || void 0 === r ? void 0 : r.fetchState.fetching) === !0
  }
}
...
function eA(e, t, n, r, i) {
  ...
  return 0 !== (o = c !== N.p.NONE && null != a && null != s ? ek(a, s, E, e, c) : E).length || l ? ((c === N.p.NONE || c === N.p.APPLICATION_ONLY) && o.sort((e, t) => eU(e.displayName, t.displayName)), {
    section: e,
    data: o
  }) : null
}
...
function eC(e) {
  var t;
  return (null == e ? void 0 : e.guild_id) != null || e.type === D.d4z.DM && (null === (t = b.default.getUser(e.getRecipientId())) || void 0 === t ? void 0 : t.bot) === !0
}
...
function ek(e, t, n, r, i) {
  ...
  for (let t of n) {
    let n;
    (i === N.p.COMMAND_ONLY || i === N.p.COMMAND_OR_APPLICATION) && (n = ej(t, e, c, u)), (void 0 === n || void 0 !== o && o < n) && (n = o), void 0 !== n && a.push(k(x({}, t), {
      score: n
    }))
  }
  return a
