...
n.d(t, {
  ...
  un: () => eU,
  v1: () => eT
}), n(953529), n(388685), n(539854), n(642613), n(35282), n(361932), n(187205), n(997841);
var r, i = n(73800),
  a = n(512722),
  o = n.n(a),
  s = n(442837),
...
function q(e, t) {
  ...
  }, t)), void 0 !== n && (ep.indices[i] = n, "application" === e.type && (ep.applicationIndices.set(i, n), ep.applicationIndicesVersion = ep.applicationIndicesVersion + 1)), a
}
...
async function en(e) {
  ...
  }, !0), await (0, S.a)(e, t).then(n.resolve).catch(n.reject)
}
...
function er(e) {
  ...
  for (let e of ("guild" === i.type && u.size > 0 && c.Z.requestMembersById(i.guildId, [...u]), (0, C.nG)(a.application_commands.map(e => eP(e, o)), !0))) {
...
class e_ extends(r = s.ZP.Store) {
  ...
  query(e, t, n) {
    ...
    n.allowFetch && (u && c && null != r && eN(r) && (y.default.track(D.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
      ...
      type: "user"
    }), d = !0), eC(o) && null != n.applicationId && ((0, S.j)({
      type: "application",
...
function em(e, t, n) {
  let [r, a] = i.useState(!0), o = (0, s.cj)([ep], () => "channel" === e.type ? ep.getContextState(e) : ep.getUserState());
  return i.useEffect(() => {
    if (r) {
      ...
      n && t && eN(e.channel) && (y.default.track(D.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
        miss: null == o.result,
        size: Object.keys(ep.indices).length
      }), eC(o) && (null != e.channel.guild_id ? (0, S.j)({
        type: "guild",
...
function eg(e, t) {
  let [n, r] = i.useState(!0), a = (0, s.cj)([ep], () => {
    var t;
...
function eE(e, t) {
  let [n, r] = i.useState(!0), a = (0, s.cj)([ep], () => ep.getUserState());
  return i.useEffect(() => {
    n && (t && eC(a) && e && (0, S.j)({
      type: "user"
    }), r(!1))
...
function eb(e, t) {
  let [n, r] = i.useState(!0), a = (0, s.e7)([ep], () => ep.getApplicationState(e));
  i.useEffect(() => {
    n && (t && eC(a) && null != e && (0, S.j)({
      type: "application",
      applicationId: e
    }), r(!1))
  }, [t, e, a, n])
...
function eS(e) {
  ...
  let {
    ...
    commandTypes: N
  } = c, C = null == p ? void 0 : p.toLowerCase(), w = null == C ? void 0 : C.split(" "), R = m === A.D.ONLY_TEXT, D = m !== A.D.DENY ? (0, v.Kh)(N, !0, R) : [], L = [], k = {
    permissionContext: c,
    query: C,
    splitQuery: w,
    ...
    scoreMethod: O,
    installOnDemand: S
  }, M = null != (i = null == (t = u.result) ? void 0 : t.sections) ? i : {}, U = null != (a = null == (n = f.result) ? void 0 : n.sections) ? a : {}, G = new Set;
  if (g) {
...
function eA(e, t, n, r, i) {
  ...
  return 0 !== (a = c !== A.p.NONE && null != o && null != s ? ek(o, s, E, e, c) : E).length || l ? ((c === A.p.NONE || c === A.p.APPLICATION_ONLY) && a.sort((e, t) => eM(e.displayName, t.displayName)), {
    section: e,
    data: a
  }) : null
}
...
function ek(e, t, n, r, i) {
  ...
  for (let t of n) {
    let n;
    (i === A.p.COMMAND_ONLY || i === A.p.COMMAND_OR_APPLICATION) && (n = ej(t, e, c, u)), (void 0 === n || void 0 !== a && a < n) && (n = a), void 0 !== n && o.push(j(x({}, t), {
      score: n
    }))
  }
  return o
