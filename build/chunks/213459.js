...
class ep extends(r = l.ZP.Store) {
  ...
  query(e, t, n) {
    ...
    let r = "channel" === e.type ? e.channel : void 0,
      ...
      d = !1;
    n.allowFetch && (u && c && null != r && eC(r) && (O.default.track(L.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
      miss: null == i.result,
...
function eg(e, t, n) {
  ...
  return i.useEffect(() => {
    if (r) {
      ...
      n && t && eC(e.channel) && (O.default.track(L.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
        miss: null == o.result,
        size: Object.keys(eh.indices).length
...
function eA(e) {
  ...
  if (v.applications.useFrecency && m.DZ.loadIfNecessary(), L.sort((e, t) => {
