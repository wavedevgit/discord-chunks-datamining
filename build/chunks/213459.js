...
function er(e) {
  ...
  for (let e of ("guild" === i.type && c.size > 0 && u.Z.requestMembersById(i.guildId, [...c]), (0, C.nG)(o.application_commands.map(e => ew(e, a)), !0))) {
...
function eT(e) {
  ...
  let {
    ...
    scoreMethod: O,
    installOnDemand: T
  }, j = null != (i = null == (t = u.result) ? void 0 : t.sections) ? i : {}, U = null != (o = null == (n = d.result) ? void 0 : n.sections) ? o : {}, G = new Set;
  if (g) {
...
function eA(e, t, n, r, i) {
  ...
  return 0 !== (o = c !== A.p.NONE && null != a && null != s ? ek(a, s, E, e, c) : E).length || l ? ((c === A.p.NONE || c === A.p.APPLICATION_ONLY) && o.sort((e, t) => ej(e.displayName, t.displayName)), {
    section: e,
    data: o
  }) : null
}
...
function ek(e, t, n, r, i) {
  ...
  for (let t of n) {
    let n;
    (i === A.p.COMMAND_ONLY || i === A.p.COMMAND_OR_APPLICATION) && (n = eM(t, e, c, u)), (void 0 === n || void 0 !== o && o < n) && (n = o), void 0 !== n && a.push(M(x({}, t), {
      score: n
    }))
  }
  return a
