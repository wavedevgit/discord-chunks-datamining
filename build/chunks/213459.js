...
function er(e) {
  ...
  for (let e of ("guild" === i.type && c.size > 0 && u.Z.requestMembersById(i.guildId, [...c]), (0, C.nG)(a.application_commands.map(e => ew(e, o)), !0))) {
...
class e_ extends(r = l.ZP.Store) {
  ...
  query(e, t, n) {
    ...
    n.allowFetch && (u && c && null != r && eN(r) && (y.default.track(D.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
      ...
      type: "user"
    }), d = !0), eC(o) && null != n.applicationId && ((0, T.j)({
      type: "application",
...
function em(e, t, n) {
  let [r, a] = i.useState(!0), o = (0, l.cj)([ep], () => "channel" === e.type ? ep.getContextState(e) : ep.getUserState());
  return i.useEffect(() => {
    if (r) {
      ...
      n && t && eN(e.channel) && (y.default.track(D.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
        miss: null == o.result,
        size: Object.keys(ep.indices).length
      }), eC(o) && (null != e.channel.guild_id ? (0, T.j)({
        type: "guild",
...
function eg(e, t) {
  let [n, r] = i.useState(!0), a = (0, l.cj)([ep], () => {
    var t;
...
function eE(e, t) {
  let [n, r] = i.useState(!0), a = (0, l.cj)([ep], () => ep.getUserState());
  return i.useEffect(() => {
    n && (t && eC(a) && e && (0, T.j)({
      type: "user"
    }), r(!1))
...
function eb(e, t) {
  let [n, r] = i.useState(!0), a = (0, l.e7)([ep], () => ep.getApplicationState(e));
  i.useEffect(() => {
    n && (t && eC(a) && null != e && (0, T.j)({
      type: "application",
      applicationId: e
    }), r(!1))
  }, [t, e, a, n])
...
function eT(e) {
  ...
  let {
    ...
    commandTypes: N
  } = c, C = null == p ? void 0 : p.toLowerCase(), P = null == C ? void 0 : C.split(" "), R = m === A.D.ONLY_TEXT, D = m !== A.D.DENY ? (0, v.Kh)(N, !0, R) : [], L = [], k = {
    permissionContext: c,
    query: C,
    splitQuery: P,
    ...
    scoreMethod: O,
    installOnDemand: T
  }, j = null != (i = null == (t = u.result) ? void 0 : t.sections) ? i : {}, U = null != (a = null == (n = d.result) ? void 0 : n.sections) ? a : {}, G = new Set;
  if (g) {
  ...
  let F = L.flatMap(e => e.data.map(t => M(x({}, t), {
    section: e.section
  })));
