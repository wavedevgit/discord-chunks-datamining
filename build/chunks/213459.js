...
function er(e) {
  ...
  for (let e of ("guild" === i.type && u.size > 0 && c.Z.requestMembersById(i.guildId, [...u]), (0, C.nG)(o.application_commands.map(e => ew(e, a)), !0))) {
...
class e_ extends(r = s.ZP.Store) {
  ...
  query(e, t, n) {
    ...
    n.allowFetch && (u && c && null != r && eN(r) && (y.default.track(D.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
      ...
      type: "user"
    }), d = !0), eC(a) && null != n.applicationId && ((0, S.j)({
      type: "application",
...
function em(e, t, n) {
  let [r, o] = i.useState(!0), a = (0, s.cj)([ep], () => "channel" === e.type ? ep.getContextState(e) : ep.getUserState());
  return i.useEffect(() => {
    if (r) {
...
function eg(e, t) {
  let [n, r] = i.useState(!0), o = (0, s.cj)([ep], () => {
    var t;
...
function eE(e, t) {
  let [n, r] = i.useState(!0), o = (0, s.cj)([ep], () => ep.getUserState());
  return i.useEffect(() => {
    n && (t && eC(o) && e && (0, S.j)({
      type: "user"
    }), r(!1))
...
function eb(e, t) {
  let [n, r] = i.useState(!0), o = (0, s.e7)([ep], () => ep.getApplicationState(e));
  i.useEffect(() => {
...
function eS(e) {
  ...
  let {
    ...
    scoreMethod: O,
    installOnDemand: S
  }, j = null != (i = null == (t = u.result) ? void 0 : t.sections) ? i : {}, U = null != (o = null == (n = f.result) ? void 0 : n.sections) ? o : {}, G = new Set;
  if (g) {
...
function eM(e, t, n, r, i) {
  ...
  for (let t of n) {
    let n;
    (i === A.p.COMMAND_ONLY || i === A.p.COMMAND_OR_APPLICATION) && (n = ek(t, e, c, u)), (void 0 === n || void 0 !== o && o < n) && (n = o), void 0 !== n && a.push(k(x({}, t), {
      score: n
    }))
  }
  return a
