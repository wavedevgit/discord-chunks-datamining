...
function Q(e, t) {
  let n, r = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
    i = q(e),
    o = eh.indices[i];
  return null != o ? ("fetchState" in t && o.fetchState.fetching && o.fetchState.abort.abort(), n = k({}, o, t)) : r && (n = k({
    serverVersion: B,
    fetchState: {
      fetching: !1
    }
...
function es(e, t) {
  ...
  return t.forEach(e => {
    ...
    let s = (0, P.X0)(j(k({}, r.descriptor.application), {
      bot: t
    }));
...
function eA(e) {
  ...
  let {
    ...
    scoreMethod: O,
    installOnDemand: S
  }, M = null != (i = null == (t = u.result) ? void 0 : t.sections) ? i : {}, U = null != (o = null == (n = d.result) ? void 0 : n.sections) ? o : {}, G = new Set;
  if (g) {
  ...
  let F = L.flatMap(e => e.data.map(t => j(k({}, t), {
    section: e.section
  })));
...
function eN(e, t, n, r, i) {
  ...
  for (let i of t)
    if (w.Ft(i, u, {
      ...
      y.push(i)
    } return 0 !== (o = c !== N.p.NONE && null != a && null != s ? eM(a, s, y, e, c) : y).length || l ? ((c === N.p.NONE || c === N.p.APPLICATION_ONLY) && o.sort((e, t) => eU(e.displayName, t.displayName)), {
    section: e,
    data: o
  }) : null
}
...
function eM(e, t, n, r, i) {
  ...
  for (let t of n) {
    let n;
    (i === N.p.COMMAND_ONLY || i === N.p.COMMAND_OR_APPLICATION) && (n = ej(t, e, c, u)), (void 0 === n || void 0 !== o && o < n) && (n = o), void 0 !== n && a.push(j(k({}, t), {
      score: n
    }))
  }
  return a
