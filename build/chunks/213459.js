...
function $(e) {
  ...
  eA(null !== (t = e_.indices[r]) && void 0 !== t ? t : F) && et(n)
}
async function ee(e) {
  var t, n;
  let r = K(e),
    i = null !== (t = e_.indices[r]) && void 0 !== t ? t : F;
  return eA(i) ? (await et(e), null !== (n = e_.indices[r]) && void 0 !== n ? n : F) : i
}
async function et(e) {
...
class ef extends(r = l.ZP.Store) {
  ...
  getContextState(e) {
    var t, n;
    return "contextless" !== e.type && eN(e.channel) ? null !== (n = this.indices[null !== (t = e.channel.guild_id) && void 0 !== t ? t : e.channel.id]) && void 0 !== n ? n : F : V
  }
...
function eg(e, t) {
  let [n, r] = i.useState(!0), o = (0, l.cj)([e_], () => {
    var t;
    return null !== (t = e_.indices[e]) && void 0 !== t ? t : F
  });
  return i.useEffect(() => {
...
function eI(e) {
  ...
  let {
    ...
    commandTypes: A
  } = c, C = null == p ? void 0 : p.toLowerCase(), R = null == C ? void 0 : C.split(" "), D = g === T.D.ONLY_TEXT, w = g !== T.D.DENY ? (0, y.Kh)(A, !0, D) : [], x = [], k = {
    permissionContext: c,
    query: C,
    splitQuery: R,
  ...
  if (I.applications.useFrecency && h.DZ.loadIfNecessary(), x.sort((e, t) => {
    ...
    let e = eT(y.Tm[P.bi.BUILT_IN], w, !0, !0, k);
    null != e && x.push(e)
  }
  let V = x.flatMap(e => e.data.map(t => M(L({}, t), {
    section: e.section
  })));
...
function eT(e, t, n, r, i) {
  ...
  return 0 !== (o = c !== T.p.NONE && null != a && null != s ? ex(a, s, E, e, c) : E).length || l ? ((c === T.p.NONE || c === T.p.APPLICATION_ONLY) && o.sort((e, t) => ek(e.displayName, t.displayName)), {
    section: e,
    data: o
  }) : null
}
