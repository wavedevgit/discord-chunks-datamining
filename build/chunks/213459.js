...
function ei(e) {
  ...
  for (let e of ("guild" === i.type && c.size > 0 && u.Z.requestMembersById(i.guildId, [...c]), (0, P.nG)(o.application_commands.map(e => eD(e, a)), !0))) {
...
class ep extends(r = l.ZP.Store) {
  ...
  hasUserStateApplication(e) {
    ...
    let {
      applicationId: r,
      authorizedOnly: i = !1
    } = e, o = this.indices[G], a = (null != (n = null == o || null == (t = o.result) ? void 0 : t.sections) ? n : {})[r];
  ...
  query(e, t, n) {
    ...
    n.allowFetch && (u && c && null != r && eC(r) && (v.default.track(L.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
    ...
    }), eP(i) && null != r && (null != r.guild_id ? (0, N.j)({
      type: "guild",
      guildId: r.guild_id
    }) : (0, N.j)({
      type: "channel",
      ...
      type: "user"
    }), d = !0), eP(a) && null != n.applicationId && ((0, N.j)({
      type: "application",
  ...
  return i.useEffect(() => {
    if (r) {
      ...
      n && t && eC(e.channel) && (v.default.track(L.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
        miss: null == a.result,
        size: Object.keys(eh.indices).length
      }), eP(a) && (null != e.channel.guild_id ? (0, N.j)({
        type: "guild",
...
function eN(e) {
  ...
  let {
    ...
    commandTypes: N
  } = c, C = null == p ? void 0 : p.toLowerCase(), P = null == C ? void 0 : C.split(" "), R = h === A.D.ONLY_TEXT, w = h !== A.D.DENY ? (0, I.Kh)(N, !0, R) : [], L = [], x = {
    permissionContext: c,
    query: C,
    splitQuery: P,
    ...
    scoreMethod: v,
    installOnDemand: S
  }, k = null != (i = null == (t = u.result) ? void 0 : t.sections) ? i : {}, U = null != (o = null == (n = d.result) ? void 0 : n.sections) ? o : {}, G = new Set;
  if (g) {
...
function eA(e, t, n, r, i) {
  ...
  for (let i of t)
    if (w.Ft(i, u, {
      ...
      y.push(i)
    } return 0 !== (o = c !== A.p.NONE && null != a && null != s ? ek(a, s, y, e, c) : y).length || l ? ((c === A.p.NONE || c === A.p.APPLICATION_ONLY) && o.sort((e, t) => eU(e.displayName, t.displayName)), {
    section: e,
    data: o
  }) : null
}
...
function ek(e, t, n, r, i) {
  ...
  for (let t of n) {
    let n;
    (i === A.p.COMMAND_ONLY || i === A.p.COMMAND_OR_APPLICATION) && (n = ej(t, e, c, u)), (void 0 === n || void 0 !== o && o < n) && (n = o), void 0 !== n && a.push(j(M({}, t), {
      score: n
    }))
  }
  return a
