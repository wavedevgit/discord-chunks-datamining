...
let x = 15 * Chunk70956.Z.Millis.MINUTE,
  A = (0, Chunk525296.Z)(function(e) {
    let {
      ...
      quest: a
    } = e, o = i.useRef(null), c = <v.Z party={t} onUserContextMenu={n} />, d = <y.Z party={t} onChannelContextMenu={l} quest={a} />, {
      partiedMembers: p,
    ...
    return null != c || null != d ? <u.yRy targetElementRef={o} position={"left"} renderPopout={e => {
        let {
          closePopout: n
        } = e;
        return (0, r.jsx)(C.Z, {
...
function w() {
  ...
  return exports ? h = module.length > 0 ? module.map(e => {
    ...
    return <A party={t} quest={s.get(t.id)} />
  }) : <div className={Chunk370168.emptyCard}>{<Chunk481060.X6q variant={"heading-md/semibold"} className={Chunk370168.emptyHeader}>{Chunk388032.intl.string(Chunk388032.t["ngJ/5u"])}</Chunk481060.X6q>}{<Chunk481060.Text color={"none"} className={Chunk370168.emptyText} variant={"text-sm/normal"}>{Chunk388032.intl.string(Chunk388032.t["99ZWxc"])}</Chunk481060.Text>}</div> : <div className={Chunk370168.emptyCard}><Chunk481060.$jN /></div>
}