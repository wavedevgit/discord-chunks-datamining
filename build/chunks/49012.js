...
function C(e, t) {
  ...
  return !!(null == r || r.type !== A.d4z.DM || I.Z.isFriend(null !== (n = r.getRecipientId()) && void 0 !== n ? n : "")) && e === t
}
...
function R(e, t) {
  ...
  if (null == x) {
    null != t && t.preventDefault(), o.Z.show({
      title: N.NW.string(N.t.x87gam),
      body: N.NW.format(N.t["9rqRws"], {
        url: e.href
      }),
      isDismissable: !0,
      contextKey: I
  ...
  if (null != D && null != L) {
    ...
    let n = b.Z.getGuild(k),
      r = (null == e ? void 0 : null === (F = e.messageReference) || void 0 === F ? void 0 : F.guild_id) != null && (null == e ? void 0 : e.webhookId) != null && (null == e ? void 0 : e.hasFlag(A.iLy.IS_CROSSPOST)) && null != k;
  ...
  if (null != L) {
    ...
    null != e && null != t && t.hasFeature(A.oNc.DISCOVERABLE) && T.default.track(A.rMx.URL_CLICKED, {
      url_domain: (0, y.F)(M),
      guild_id: t.id,
      channel_id: e.id
