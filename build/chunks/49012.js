...
function w(e, t) {
  ...
  let H = () => {
      if (M && _.Z.trackAnnouncementMessageLinkClicked({
          messageId: U,
          channelId: L,
          guildId: j,
          sourceChannelId: G,
          sourceGuildId: B
        }), null != w) return void w();
      (0, s.Z)(k)
    },
    Y = null != R ? R : () => {};
  ...
  let W = "function" == typeof T ? T() : T,
    K = (0, O.E)(k),
    z = "http:" !== K && "https:" !== K;
  if (!z && (W || y.Z.isTrustedDomain(k)) || z && y.Z.isTrustedProtocol(k)) return void(null == t || null != P && P ? H() : M && _.Z.trackAnnouncementMessageLinkClicked({
    messageId: U,
    channelId: L,
    guildId: j,
    sourceChannelId: G,
