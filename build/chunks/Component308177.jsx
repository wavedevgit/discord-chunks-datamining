...
let j = (0, Chunk112724.Z)(e => {
  ...
  })(j, R), G = v ? j - 32 : Math.min(j - 64, 3 * k + 8), H = e => e === D.length - 1 || 0 === S && 1 === e, [B, F] = i.useState(false), [V, z] = i.useState(false);
  return (0, r.jsx)(p.Z, {
    sections: M,
    renderSection: e => {
      let {
    ...
    rowHeight: e => null == L[e][0] ? 0 : 0 === e ? G / m.Q + 8 : 1 === e ? B ? 0 : U : 98 * !V,
    renderFooter: e => {
      let {
        section: t
      } = e;
