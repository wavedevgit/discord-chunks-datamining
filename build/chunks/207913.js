...
function B(e) {
  let {
    ...
    isUnread: s,
    groupedMessages: d
  } = e, h = (0, m.KS)(n, null), p = (0, g.ZP)(n, !1), f = (0, c.e7)([Z.Z], () => Z.Z.getGuild(n.getGuildId())), {
    nick: _,
    colorString: O
  } = (0, y.ZP)(t), {
    ...
    animateOnHover: !0
  }), x = n.type !== D.d4z.GUILD_ANNOUNCEMENT || null == f, I = (0, j.x)({
    channel: n,
    message: t,
    user: t.author,
    compact: !0,
...
function F(e) {
  ...
  return (0, r.jsxs)(u.Kqy, {
    ...
    children: [(0, r.jsx)(f.ZP, {
      ...
      children: M.intl.formatToPlainString(L.default.NzUuLC, {
        count: t.length
      })
    })]
  })
...
function H(e) {
  let {
    ...
    return (0, i.useMemo)(() => {
      ...
      } else y = p ? M.intl.string(M.t.sad2PD) : i ? M.intl.string(M.t.p0oZm5) : s > 1 ? M.intl.formatToPlainString(M.t.rtfTKi, {
        count: s
      }) : 1 === s ? M.intl.string(M.t.tCcq5u) : d ? M.intl.format(M.t.zY4v1N, {
...
let z = (0, i.memo)(function(e) {
  let {
    ...
    params: f
  } = (0, s.$B)(), g = (0, c.e7)([N.Z], () => N.Z.getChannel(t.channel_id));
  return null == t || null == g ? null : (0, r.jsx)(u.P3F, {
    className: o()(k.messageClickableContainer, {
      [k.selected]: t.id === f.messageId
    }),
    onClick: () => {
      (0, T.Qz)({
