...
function k(e) {
  let {
    ...
    params: l
  } = (0, s.$B)(), h = (0, a.e7)([P.Z], () => P.Z.getChannel(t.channel_id)), p = (0, a.e7)([N.ZP], () => {
    if (null == h) return !1;
    let e = N.ZP.getTrackedAckMessageId(null == h ? void 0 : h.id);
    return Z.default.compare(t.id, e) > 0
  }, [h, t.id]);
  return null == t || null == h ? null : (0, r.jsx)(c.P3F, {
    className: o()(L.messageClickableContainer, {
      [L.selected]: t.id === l.messageId
    }),
    onClick: () => {
...
function M(e) {
  ...
  let {
    ...
    isUnread: g,
    groupedMessages: m
  } = e, O = (0, p.KS)(s, null), v = (0, h.ZP)(s, !1), j = (0, a.e7)([w.Z], () => w.Z.getGuild(s.getGuildId())), {
    nick: S,
    colorString: E,
    primaryGuild: P
  } = (0, y.ZP)(l), {
    ...
    animateOnHover: !0
  }), k = s.type !== R.d4z.GUILD_ANNOUNCEMENT || null == j, M = (0, _.x)({
    channel: s,
    message: l,
    user: l.author,
    compact: !0,
  ...
  }, [j, l.author.id]), (0, r.jsx)(c.tEY, (t = function(e) {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [g && (0, r.jsx)("div", {
        ...
        children: [(0, r.jsxs)(c.Kqy, {
          ...
          isSelected: d,
          channel: s
        }), null != m && (0, r.jsxs)(c.Kqy, {
          gap: 4,
          style: {
            minWidth: 0,
            marginTop: 4
          },
          children: [null == m ? void 0 : m.slice(0, U(m.length)).map(e => (0, r.jsx)(B, {
            message: e,
            channel: s,
            isSelected: d
          }, e.id)), null != m && (null == m ? void 0 : m.length) > U(m.length) ? (0, r.jsx)(G, {
            overflowMessages: m.slice(U(m.length))
          }) : null]
        })]
      })]
    })
...
function G(e) {
  ...
  return (0, r.jsx)(c.Kqy, {
    ...
    children: (0, r.jsx)(c.Text, {
      ...
      children: D.intl.formatToPlainString(D.t.NzUuLC, {
        count: t.length
      })
    })
  })
...
function H(e) {
  let {
    ...
    return (0, i.useMemo)(() => {
      ...
      } else _ = f ? D.intl.string(D.t.sad2PD) : i ? D.intl.string(D.t.p0oZm5) : a > 1 ? D.intl.formatToPlainString(D.t.rtfTKi, {
        count: a
      }) : 1 === a ? D.intl.string(D.t.tCcq5u) : h ? D.intl.format(D.t.zY4v1N, {
        stickerName: t.stickerItems[0].name
      }) : b ? D.intl.string(D.t.slFYgo) : D.intl.string(D.t.sDqZHB);
      else v = !1, _ = (0, r.jsx)(O.ZP, {
        content: s,
        message: t,
        compact: !1,
