...
function V(e) {
  let {
    ...
    animateOnHover: !0
  }), x = n.type !== L.d4z.GUILD_ANNOUNCEMENT || null == f, I = (0, j.x)({
    channel: n,
    message: t,
    user: t.author,
    compact: !0,
...
function F(e) {
  ...
  return (0, r.jsxs)(u.Kqy, {
    ...
    children: [(0, r.jsx)(f.ZP, {
      ...
      children: k.intl.formatToPlainString(M.default.NzUuLC, {
        count: t.length
      })
    })]
  })
...
let W = (0, i.memo)(function(e) {
  ...
  let {
    ...
    params: m
  } = (0, s.$B)(), b = (0, c.e7)([w.Z], () => w.Z.getChannel(i.channelId)), _ = null != (t = null == a ? void 0 : a.map(e => e.message).filter(e => null != e)) ? t : [];
  return null == g || null == b ? null : (0, r.jsx)(u.P3F, {
    className: o()(U.messageClickableContainer, {
      [U.selected]: g.id === m.messageId
    }),
    onClick: () => {
      (0, A.Qz)({
        interactionType: A.s_.CLICK,
        message: g
      }), h.Z.trackJump(b.id, g.id, "Notifications Inbox"), f && p.In(g.channel_id, {
        section: L.jXE.INBOX,
