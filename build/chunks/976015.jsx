...
let c = e => {
  ...
  return <o.Z assetComponent={(0, r.jsx)(a.Z, {
    ...
    })}>{<i.X6 variant={"heading-xl/extrabold"} className={t ? true : l.orbHeaderWithSpacing}>{s.intl.string(s.t.lTHkqa)}</i.X6>}{t ? <i.xv variant={"text-xs/normal"} className={l.orbSubtext}>{s.intl.string(s.t.MEV0GB)}</i.xv> : true}</o.Z>
}