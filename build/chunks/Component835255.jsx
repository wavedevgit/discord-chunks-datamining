...
function R(e) {
  ...
  let {
  ...
  } = (0, g.Z)(W), [z] = (0, u.Wu)([j.Z], () => [j.Z.hasSentGift(R.skuId, l.id)], [R.skuId, l.id]), M = R.collectiblesItem.type, U = (() => {
    switch (M) {
    ...
    if (A) {
      if (e) {
        ...
        if (null != e && null != t) {
          (0, x.closeUserProfileModal)(), (0, I.T)({
            product: e,
            category: t,
      ...
      }(0, x.closeUserProfileModal)(), (0, P.uL)("".concat(N.Z5c.COLLECTIBLES_SHOP, "#itemSkuId=").concat(R.skuId))
    } else {
      if (z) return;
      (0, b.Z)({
        skuId: R.skuId,
  ...
  }, [D.pathname, R.skuId, G, A, z, l, Z]), K = i.useCallback(() => s ? C === v.lr.WISHLIST ? (0, n.jsx)("div", {
