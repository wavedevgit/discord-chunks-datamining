...
function h(e) {
  let {
    ...
    description: F,
    isGuildSupported: I
  } = (0, S.K)(r), [M, j] = l.useState(), [_, w] = l.useState(false), y = async () => {
    w(true);
      ...
      children: [(0, n.jsxs)(s.Kqy, {
        ...
        children: [(0, n.jsx)(s.Text, {
          ...
          children: [(0, n.jsx)("div", {
            ...
            text: E,
            onClick: () => {
              a()(null != M, "Guild ID must not be null on click"), p.Z.hasSeenCreatorOnboardingForGuild(M) || (0, c.k)(M), g.Z.open(M, b, true, C), null == i || i()
            },
            disabled: null == M
          })]
        })]
