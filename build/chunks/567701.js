/** Chunk was on 68856 **/ ! function(r, n) {
  "use strict";
  var i = "function",
    o = "undefined",
    a = "object",
  ...
  Y.VERSION = "0.7.40", Y.BROWSER = q([l, h, s]), Y.CPU = q([d]), Y.DEVICE = q([c, p, f, g, y, m, v, _, b]), Y.ENGINE = Y.OS = q([l, h]), typeof e !== o ? (t.exports && (e = t.exports = Y), e.UAParser = Y) : typeof define === i && define.amd ? define(function() {
    return Y
