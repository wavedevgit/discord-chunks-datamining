...
let O = e => {
  ...
  return <d.W5 onMount={S} onUnmount={A} targetRef={O} overrideTargetRect={f} position={null != _ ? _ : "right"} align={null != p ? p : "top"} autoInvert={true} ref={b} nudgeAlignIntoViewport={true} clickTrap={!E}>{t}</d.W5>
};
class v extends Chunk73800.PureComponent {
  ...
  render() {
    ...
    return Chunk990547 && null != Chunk239091 && null != Chunk481060 && null != Chunk73800 && null != Chunk40851 && Chunk481060.context === require ? <O target={Chunk73800} rect={Chunk239091} close={this.close} onUnmount={Chunk481060.onClose} align={Chunk481060.align} position={Chunk481060.position} impressionName={Chunk481060.impressionName} impressionProperties={Chunk481060.impressionProperties} disableClickTrap={null != (t = Chunk481060.disableClickTrap) && exports}>{(e, t) => {
        let {
          position: r
        } = e;
        return c({
