...
let u = e => "".concat(e.toFixed(0), "%"),
  d = Chunk73800.forwardRef(function(e, t) {
    ...
    return <div className={c.sliderContainer}><l.i ref={m} mini={true} handleSize={16} className={c.slider} initialValue={n} minValue={o} maxValue={d} onValueChange={E} asValueChanges={f} onValueRender={p} orientation={"horizontal"} aria-label={h} /></div>
  })