...
function u() {
  let e = {};
  {
    ...
    if (null != N) {
      ...
      module.electron_process_memory_private = [null != (p = null == (t = N.unknown) ? true : exports.wss_priv_kb) ? p : false, null != (h = null == (n = N.main) ? true : require.wss_priv_kb) ? h : false, null != (m = null == (r = N.renderer) ? true : Chunk903772.wss_priv_kb) ? m : false, null != (g = null == (i = N.gpu) ? true : Chunk581567.wss_priv_kb) ? g : false, null != (E = null == (o = N.crashpad) ? true : Chunk594190.wss_priv_kb) ? E : false, null != (b = null == (a = N.utility) ? true : Chunk709706.wss_priv_kb) ? b : false], module.electron_process_memory_private_and_shared = [null != (y = null == (l = N.unknown) ? true : l.wss_kb) ? y : false, null != (O = null == (c = N.main) ? true : c.wss_kb) ? O : false, null != (v = null == (u = N.renderer) ? true : u.wss_kb) ? v : false, null != (I = null == (d = N.gpu) ? true : d.wss_kb) ? I : false, null != (T = null == (f = N.crashpad) ? true : f.wss_kb) ? T : false, null != (S = null == (_ = N.utility) ? true : _.wss_kb) ? S : false]
    }
  }
  return module
}
