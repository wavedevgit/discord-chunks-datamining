...
function u() {
  let e = {};
  {
    ...
    if (null != N) {
      var t, n, r, i, o, a, l, c, u, d, f, p, _, m, h, g, E, b, y, O, v, S, I, T;
      module.electron_process_memory_private = [null != (_ = null == (t = N.unknown) ? true : exports.wss_priv_kb) ? _ : false, null != (m = null == (n = N.main) ? true : require.wss_priv_kb) ? m : false, null != (h = null == (r = N.renderer) ? true : Chunk903772.wss_priv_kb) ? h : false, null != (g = null == (i = N.gpu) ? true : Chunk581567.wss_priv_kb) ? g : false, null != (E = null == (o = N.crashpad) ? true : Chunk594190.wss_priv_kb) ? E : false, null != (b = null == (a = N.utility) ? true : Chunk709706.wss_priv_kb) ? b : false], module.electron_process_memory_private_and_shared = [null != (y = null == (l = N.unknown) ? true : l.wss_kb) ? y : false, null != (O = null == (c = N.main) ? true : c.wss_kb) ? O : false, null != (v = null == (u = N.renderer) ? true : u.wss_kb) ? v : false, null != (S = null == (d = N.gpu) ? true : d.wss_kb) ? S : false, null != (I = null == (f = N.crashpad) ? true : f.wss_kb) ? I : false, null != (T = null == (p = N.utility) ? true : p.wss_kb) ? T : false]
    }
  }
  return module
}
