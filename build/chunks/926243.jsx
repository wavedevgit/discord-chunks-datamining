...
function P(e) {
  let {
    ...
    return (0, i.createElement)("li", S(I({}, d), {
      key: o,
      ref: Y
    }), Z !== C(q, f) && <R ref={l} emoji={W} isFavorite={H.isFavoriteEmojiWithoutFetchingLatest(W)} isLargeSize={L} isMediumSize={D} isInspected={a} isDisabled={z} showPulse={x === o} allowAnimatedEmoji={M} onFocus={null != u ? u : Q} onMouseMove={Q} onMouseEnter={t} onMouseLeave={n} onClick={e => {
        ...
        X(e)
      }} onContextMenu={J} tabIndex={c} columnIndex={q} rowIndex={f} size={K} surrogateCodePoint={N} selectedItemClassName={P} inNitroLockedSection={B} />)
  };
  return T ? <l.ua7 text={y.intl.formatToPlainString(y.t.glqNsb, {
      key: (0, E.isMac)() ? "Opt" : "Alt"
    })} position={"top"} delay={200}>{e => $(e)}</l.ua7> : $()
}