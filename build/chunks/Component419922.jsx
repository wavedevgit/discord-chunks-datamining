...
let P = e => {
  ...
  w = e => {
    ...
    A.current = t && u;
    let C = null == s ? (0, b.Q6)(a) : s;
    return (l()(null != C, "Unable to determine sticker asset URL. Sticker ID: ".concat(a.id)), i.useEffect(() => {
    ...
    }, [C, o, a.id, c, m]), i.useEffect(() => {
      var e;
      let n;
      t || (n = 0), null == (e = E.current) || e.setState(t && u, n)
    }, [a, t, u]), null == C) ? null : (0, r.jsx)("div", {
      role: "img",
      className: d,
