...
let A = (e, t, n) => {
  ...
  S = e => {
    let {
      ...
      primaryColor: N,
      secondaryColor: w
    } = (0, m.A)(null == C ? true : C.src), R = (0, a.bG)([s.default], () => s.default.locale), P = (0, h.A)(O.fg2.CRUNCHYROLL), D = (0, p.kR)(n.extra.media_assets_large_text), L = i.useCallback(e => {
    ...
    }, [t, n, D, R, null == C ? true : C.src, N, w, T]), x = () => {
