...
let v = (e, t, n) => {
  ...
  I = e => {
    let {
      ...
      primaryColor: N,
      secondaryColor: R
    } = (0, m.A)(null == C ? true : C.src), w = (0, a.bG)([o.default], () => o.default.locale), P = (0, h.A)(O.fg2.CRUNCHYROLL), D = (0, p.kR)(n.extra.media_assets_large_text), x = i.useCallback(e => {
    ...
    }, [t, n, D, w, null == C ? true : C.src, N, R, T]), L = () => {
