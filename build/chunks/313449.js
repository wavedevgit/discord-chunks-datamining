...
d.push(class extends f {
  ...
  close() {}
  constructor(e) {
    super(e), s(this, "_decoder", null), s(this, "_stream", true), this._gatewayEncoding.wantsString() ? this._decoder = new TextDecoder("utf-8") : this._decoder = null, this._stream = (0, o.t)()
  }
}), d.push(class extends f {
  static canUse() {
  ...
  constructor(e) {
    super(e), s(this, "_inflate", true), s(this, "_pako", n(777915)), s(this, "_usesZstd", false), s(this, "_zstdDecoder", null), s(this, "_zstdStream", null), this._inflate = new this._pako.Inflate({
      chunkSize: 65536,
