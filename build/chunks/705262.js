...
let W = Object.freeze({
  ...
  q = e => {
    let {
      ...
      isPreview: n,
      isCoachmark: i
    } = e, o = (0, E.Q3)("GradientSelectorsTitle"), a = (0, s.EQ)({
  ...
  X = e => {
    ...
    let {
      ...
      type: s
    } = i.useContext(K), [c] = (0, l.Wu)([N.Z], () => [N.Z.isPreview]), u = (null == (n = (0, y.N)()) || null == (t = n.subscription_trial) ? void 0 : t.sku_id) === L.Si.TIER_2;
  ...
  J = e => {
    ...
    }), [b, y] = i.useState(!1), [O, v] = i.useState(-1), I = (0, l.e7)([_.Z], () => _.Z.useReducedMotion), S = C.M.useExperiment({
