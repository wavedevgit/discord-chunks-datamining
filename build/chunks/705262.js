...
let Y = Object.freeze({
  ...
  z = e => {
    let {
      ...
      isPreview: n,
      isCoachmark: i
    } = e, o = (0, g.Q3)("GradientSelectorsTitle"), a = (0, s.EQ)({
      ...
      type: "EDITOR",
      isCoachmark: !0
    }, () => M.intl.string(M.t["8+vbqa"])).with({
      isVisualRefreshEnabled: !0
    }, () => M.intl.string(M.t.hjV0fX)).otherwise(() => M.intl.string(M.t.OCOOiI));
    return (0, r.jsxs)("div", {
      className: j.title,
  ...
  Q = e => {
    ...
    let {
      ...
      type: s
    } = i.useContext(W), [c] = (0, l.Wu)([A.Z], () => [A.Z.isPreview]), u = (null == (n = (0, b.N)()) || null == (t = n.subscription_trial) ? void 0 : t.sku_id) === D.Si.TIER_2;
  ...
  X = e => {
    ...
    } = (0, h.ZP)(p.Z.CLIENT_THEMES_THEME_SELECTOR), [m, g] = (0, l.Wu)([A.Z], () => {
      var e;
      return [A.Z.isPreview, null == (e = A.Z.gradientPreset) ? void 0 : e.id]
    }), [E, b] = i.useState(!1), [y, O] = i.useState(-1), v = (0, l.e7)([_.Z], () => _.Z.useReducedMotion), I = N.M.useExperiment({
  ...
  $ = e => {
    ...
    } = (0, h.ZP)(p.Z.CLIENT_THEMES_THEME_SELECTOR), [s, c, u] = (0, l.Wu)([v.Z, I.ZP, A.Z], () => [v.Z.theme, null == A.Z.gradientPreset, I.ZP.useSystemTheme === L.KW.ON]), d = e => {
      (0, T.xs)(), K({
        isPersisted: !0,
        analyticsLocations: a,
