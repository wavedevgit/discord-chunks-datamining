...
let K = Object.freeze({
  ...
  X = e => {
    let {
      ...
      type: "EDITOR",
      isCoachmark: !0
    }, () => U.intl.string(U.t["8+vbqa"])).with({
      isVisualRefreshEnabled: !0
    }, () => U.intl.string(U.t.hjV0fX)).otherwise(() => U.intl.string(U.t.OCOOiI));
    return (0, r.jsxs)("div", {
      className: G.title,
  ...
  J = e => {
    ...
    let {
      ...
      type: s
    } = i.useContext(z), [c] = (0, l.Wu)([C.Z], () => [C.Z.isPreview]), u = (null == (n = (0, y.N)()) || null == (t = n.subscription_trial) ? void 0 : t.sku_id) === x.Si.TIER_2;
  ...
  et = e => {
    ...
    } = (0, h.ZP)(p.Z.CLIENT_THEMES_THEME_SELECTOR), [s, c, u] = (0, l.Wu)([I.Z, S.ZP, C.Z], () => [I.Z.theme, null == C.Z.gradientPreset && null == T.L1.getSetting().customUserThemeSettings, S.ZP.useSystemTheme === k.KW.ON]), d = e => {
      (0, N.xs)(), q({
        isPersisted: !0,
        analyticsLocations: o,
