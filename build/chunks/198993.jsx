...
class b extends(o = Chunk73800.PureComponent) {
  render() {
    ...
    return <div style={{
      ...
      }} className={c()(Chunk634715.qrCodeContainer, exports)}><Chunk353515.default{...C({
        value: require,
        level: "M"
      }, n)} /></div>
  }
...
class g extends(a = Chunk73800.PureComponent) {
  render() {
    ...
    return <div className={Chunk634715.qrCodeOverlayContainer}>{<b{...C({}, this.props)} />}{<div className={Chunk634715.qrCodeOverlay}><img className={Chunk634715[exports]} src={Chunk515695} alt={""} /></div>}</div>
  }
}
f(g, "defaultProps", {
  size: 144,
