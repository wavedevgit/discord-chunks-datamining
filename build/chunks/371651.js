...
function $(e, t) {
  ...
  switch (R) {
    ...
    case m.R5.IN_PROCESS_V2:
      return {
        source: m.d0.DEV_OVERRIDE, enabledOOP: !1, enabledLegacy: !0, overlayMethod: m.gl.Hook
      };
    case m.R5.OUT_OF_PROCESS_V3:
      return {
        source: m.d0.DEV_OVERRIDE, enabledOOP: !0, enabledLegacy: !1, overlayMethod: m.gl.OutOfProcess
      };
    case m.R5.OUT_OF_PROCESS_V3_LIMITED_INTERACTION:
      return {
        source: m.d0.DEV_OVERRIDE, enabledOOP: !0, enabledLegacy: !1, overlayMethod: m.gl.OutOfProcessLimitedInteraction
      }
  }
  if (!V()) return {
    source: m.d0.DEFAULT,
  ...
  if (!(0, g.NW)("determineOverlayMethod", !1)) {
    let e = (0, b.qT)(i),
      t = e.enabledLegacy && Z();
    return S(I({}, e), {
      overlayMethod: t ? e.overlayMethod : m.gl.Disabled
    })
  }
  if (!F() && Z()) {
    let e = (0, b.qT)(i);
    return S(I({}, e), {
      overlayMethod: e.enabledLegacy ? e.overlayMethod : m.gl.Disabled
    })
  }
  if (!(0, p.supportsOutOfProcess)()) return S(I({}, (0, b.qT)(i)), {
    source: m.d0.NO_OUT_OF_PROCESS_SUPPORT
  });
  if (!o.enabledOOP && o.enabledLegacy) return Z() ? S(I({}, (0, b.qT)(i)), {
  ...
  switch (t) {
    ...
    case l.Jx.BORDERLESS_FULLSCREEN: {
      ...
      return S(I({}, o), {
        overlayMethod: e ? n : t ? (0, b.qT)(i).overlayMethod : m.gl.Disabled
      })
    }
    ...
    case l.Jx.UNKNOWN:
      return {
        source: m.d0.FULL_SCREEN_TYPE, enabledOOP: !1, enabledLegacy: !1, overlayMethod: m.gl.Disabled
      };
    default:
      return {
        source: m.d0.DEFAULT, enabledOOP: !1, enabledLegacy: !1, overlayMethod: m.gl.Disabled
      }
  }
}
async function ee(e) {
...
async function er(e) {
  ...
  let n = H(e);
  return null == n ? (C.error("Tried to determine initial overlay method for untracked pid ".concat(e)), {
...
async function ei(e, t) {
  ...
  q(e, "state", r === m.gl.Disabled ? m.mM.OVERLAY_DISABLED : m.mM.WAITING_FOR_MODULE_TRACKING), q(e, "overlayMethod", r), q(e, "source", t.source), q(e, "oopEnabled", t.enabledOOP), q(e, "legacyEnabled", t.enabledLegacy), C.verbose("Updating overlay method for pid ".concat(e, ' "').concat(null == (n = H(e)) ? void 0 : n.gameName, '" to ').concat((0, b.P_)(r))), eD.emitChange();
  let i = H(e);
...
async function eo() {
  ...
  await ec(i), (n.size > 0 || r.size > 0) && C.verbose("Tracked games have changes", {
...
async function ea(e) {
  ...
  n.fullscreenType !== r && (C.verbose("Fullscreen type different in swap for pid ".concat(e), {
    oldFullscreenType: n.fullscreenType,
    newFullscreenType: r
  }), q(e, "previousFullscreenType", n.fullscreenType), q(e, "fullscreenType", r), eD.emitChange(), t = !0);
  let i = $(n, r);
  ...
  let o = R === m.R5.OUT_OF_PROCESS_V3 || R === m.R5.OUT_OF_PROCESS_V3_LIMITED_INTERACTION,
    ...
    s = (0, b.PD)(n, r, F()),
    l = (0, b.DH)(n, r, F());
  switch (C.verbose("Overlay method different for pid ".concat(e), {
...
function eu(e) {
  null == M && (__OVERLAY__ && C.error("Running Polling While in Overlay Context!"), M = setTimeout(async () => {
    M = null;
    let e = Y();
...
async function ed(e, t) {
  ...
  let n = e !== P,
    r = t !== w;
  if (P = e, w = t, h.v.update({
      legacyEnabled: P,
      oopEnabled: w
    }), C.info("setOverlayEnabled", {
      newOopEnabled: t,
      newLegacyEnabled: e
    }), w && r && (0, p.setOutOfProcessSupport)(!0), P || w) n && C.info("Legacy change"), r && C.info("OOP change"), eg();
  else
...
function e_(e) {
  ...
  return C.info("handleOverlaySetEnabled", {
    legacyEnabled: t,
    oopEnabled: n
  }), ed(t, n), !0
}
...
function em(e) {
  if (__OVERLAY__ && C.error("Running handleGameToggleOverlay While in Overlay Context!"), C.verbose("handleGameToggleOverlay", {
      action: e
    }), !V()) {
  ...
  let i = n && Z(),
    o = null != r && r && F();
  return i || o ? (C.verbose("handleGameToggleOverlay: game enabled changed", {
    pid: t,
    legacyEnabled: i,
    overlayV3Enabled: o
  }), z(t) ? eg() : ee(t)) : et(t), !0
...
function eb(e) {
  return C.error("Overlay reload for pid", {
    pid: e.pid
  }), eg(), !0
}
