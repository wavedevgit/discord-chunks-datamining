...
function et(e, t) {
  ...
  switch (P) {
    ...
    case g.R5.IN_PROCESS_V2:
      return {
        source: g.d0.DEV_OVERRIDE, enabledOOP: !1, enabledLegacy: !0, overlayMethod: g.gl.Hook
      };
    case g.R5.OUT_OF_PROCESS_V3:
      return {
        source: g.d0.DEV_OVERRIDE, enabledOOP: !0, enabledLegacy: !1, overlayMethod: g.gl.OutOfProcess
      };
    case g.R5.OUT_OF_PROCESS_V3_LIMITED_INTERACTION:
      return {
        source: g.d0.DEV_OVERRIDE, enabledOOP: !0, enabledLegacy: !1, overlayMethod: g.gl.OutOfProcessLimitedInteraction
      }
  }
  if (!Y()) return {
    source: g.d0.DEFAULT,
  ...
  switch (t) {
    ...
    case l.Jx.UNKNOWN:
      return {
        source: g.d0.FULL_SCREEN_TYPE, enabledOOP: !1, enabledLegacy: !1, overlayMethod: g.gl.Disabled
      };
    default:
      return {
        source: g.d0.DEFAULT, enabledOOP: !1, enabledLegacy: !1, overlayMethod: g.gl.Disabled
      }
  }
}
async function en(e) {
...
async function ea(e, t) {
  ...
  Q(e, "state", r === g.gl.Disabled ? g.mM.OVERLAY_DISABLED : g.mM.WAITING_FOR_MODULE_TRACKING), Q(e, "overlayMethod", r), Q(e, "source", t.source), Q(e, "oopEnabled", t.enabledOOP), Q(e, "legacyEnabled", t.enabledLegacy), R.verbose("Updating overlay method for pid ".concat(e, ' "').concat(null == (n = W(e)) ? void 0 : n.gameName, '" to ').concat((0, y.P_)(r))), ex.emitChange();
  let i = W(e);
...
async function es() {
  ...
  await ed(i), (n.size > 0 || r.size > 0) && R.verbose("Tracked games have changes", {
...
async function el(e) {
  ...
  if (b.l.has(n.state)) return R.verbose("Skipping overlay method swap for pid ".concat(e, " - state is ").concat(n.state)), !1;
  ...
  n.fullscreenType !== r && (R.verbose("Fullscreen type different in swap for pid ".concat(e), {
    ...
    newFullscreenType: r
  }), Q(e, "previousFullscreenType", n.fullscreenType), Q(e, "fullscreenType", r), ex.emitChange(), t = !0);
  let i = et(n, r);
...
function ec(e, t) {
  var n;
  return X(e) ? (null == (n = W(e)) ? void 0 : n.overlayMethod) === g.gl.Hook ? (R.verbose("Hook requested for pid ".concat(e, " but already enabled")), Promise.resolve()) : (R.verbose("Enabling hook for pid ".concat(e)), Q(e, "hasChangedRenderMode", !0), ea(e, t)) : (R.verbose("Hook requested for untracked pid ".concat(e)), Promise.resolve())
}

function eu(e, t) {
  var n;
  return X(e) ? (null == (n = W(e)) ? void 0 : n.overlayMethod) === t.overlayMethod ? (R.verbose("OOP requested for pid ".concat(e, " but already enabled")), Promise.resolve()) : (R.verbose("Enabling OOP for pid ".concat(e)), Q(e, "hasChangedRenderMode", !0), ea(e, t)) : (R.verbose("OOP requested for untracked pid ".concat(e)), Promise.resolve())
}
async function ed(e) {
  let t = !1;
...
async function e_(e, t) {
  ...
  if (w = e, D = t, m.v.update({
      ...
      newOopEnabled: t,
      newLegacyEnabled: e
    }), D && r && (0, p.setOutOfProcessSupport)(!0), w || D) n && R.info("Legacy change"), r && R.info("OOP change"), eb();
  else
...
async function eb() {
  await ey(), await (0, o._v)(2e3);
  let e = K(),
    t = new Set([...d.ZP.getRunningGames().filter(e => d.ZP.getOverlayEnabledForGame(e)).map(e => e.pid), ...e]);
  for (let n of (R.info("Retracking ".concat(t.size, " games (").concat(e.length, " already tracked)")), t)) await en(n), await (0, o._v)(16);
...
function ev(e) {
  return R.error("Overlay crashed for pid ".concat(e.pid)), !!X(e.pid) && (Q(e.pid, "state", g.mM.OVERLAY_CRASHED), !0)
}
...
function eT(e) {
  if (null != W(e.pid)) return Q(e.pid, "state", e.overlayState), R.verbose("Updating overlay state for pid ".concat(e.pid, " to ").concat(e.overlayState)), e.overlayState === g.mM.WAITING_FOR_OVERLAY_OPEN ? $(e.pid, g.zE.MODULE_TRACKING) : e.overlayState === g.mM.OVERLAY_RENDERING && $(e.pid, g.zE.OVERLAY_RENDERING), !0
}
