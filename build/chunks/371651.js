...
function J(e, t) {
  ...
  if (!(0, m.supportsOutOfProcess)()) return N(S({}, (0, y.qT)(i)), {
    source: _.d.NO_OUT_OF_PROCESS_SUPPORT
  });
  if (!o.enabledOOP && o.enabledLegacy) return B() ? N(S({}, (0, y.qT)(i)), {
...
function ec(e) {
  null == k && (__OVERLAY__ && P.error("Running Polling While in Overlay Context!"), k = setTimeout(async () => {
    k = null;
    let e = H();
