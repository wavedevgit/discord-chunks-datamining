/** Chunk was on web.js **/
/** chunk id: 840810, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  d: () => a
});
var Chunk670474 = require("./670474.js"),
  Chunk659155 = require("./659155.js");
class a {
  isDisabled(e) {
    var t;
  ...
  findNextNonDisabled(e, t) {
    ...
    for (; null != n;) {
      ...
      if ((null == e ? true : e.type) === "item" && !this.isDisabled(e)) return n;
      n = t(n)
    }
    return null
  }
  ...
  constructor(...e) {
    ...
    "stack" === this.layout && "vertical" === this.orientation && (this.getKeyLeftOf = true, this.getKeyRightOf = true)
  }
}