/** Chunk was on web.js **/
/** chunk id: 452282, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  Ay: () => O,
  U3: () => y
...
class b extends(r = Chunk64700.Component) {
  ...
  componentDidUpdate(e) {
    let {
      ...
      items: i,
      width: a
    } = this.props, o = y(r, i.length), s = y(e.currentIndex, i.length);
    (o !== s || i.length !== e.items.length) && this.updateAnimatedIndex(o, s), a !== e.width ? this.animatedAlignmentOffset.setValue(this.getAlignmentOffset(t)) : n && (t !== e.align || o !== s) && l.A.spring(this.animatedAlignmentOffset, _(f({}, h), {
  ...
  animateToIndex(e, t) {
    ...
    i > 0 && (0 === e && t === r.length - 1 ? n.setValue(false) : 0 === t && e === r.length - 1 && r.length > 2 && n.setValue(r.length)), l.A.spring(n, _(f({}, h), {
      toValue: e
    })).start()
  }
