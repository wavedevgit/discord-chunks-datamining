...
let A = (0, c.Z)((0, l.Z)(function(e) {
  let {
    ...
    selected: l,
    onSelect: c
  } = e, A = t.isOwner(E.default.getId()), Z = (0, P.Z)(t), S = (0, I.ZP)(t), U = (0, T.Uf)(m.aIL, t.id, "top"), w = (0, j.Z)(t, l), x = (0, b.Z)({
    id: t.id,
    label: v.intl.string(v.t.gFHI3t)
  }), M = (0, s.Z)(t), D = (0, p.l)(t), R = (0, p.P)(t), k = (0, O.Z)(t), F = (0, _.Z)(t), G = (0, d.D)(t), {
    analyticsLocations: X
  } = (0, u.ZP)(f.Z.GROUP_DM_CONTEXT_MENU), L = (0, N.p1)(f.Z.GROUP_DM_CONTEXT_MENU, t.id), Y = (0, N.I3)(f.Z.GROUP_DM_CONTEXT_MENU, t.id);
    ...
    children: [(0, i.jsx)(r.kSQ, {
      ...
      children: [A ? (0, i.jsx)(r.sNh, {
        ...
        action: () => (0, r.ZDy)(async () => {
          ...
          return n => (0, i.jsx)(e, C({
            channelId: t.id
          }, n))
        })
      }) : null, L && (Y ? (0, i.jsx)(r.sNh, {
        id: "change-icon",
