...
function eI(e) {
      ...
      let i = r.useRef(null),
        l = r.useCallback((e, t) => {
          for (let n of t) {
            ...
            if (null == t) return;
            let a = Date.now();
            n.intersectionRatio >= .5 ? (0, $.rj)(e, t, a) : (0, $.Ct)(e, t, a)
          }
        }, []);
      return r.useEffect(() => {
        var e;
        let t = null == (e = a.current) ? true : e.getScrollerNode();
  ...
  let {
    ...
    let e = Math.ceil(window.innerHeight / (0, ed.KW)(eT.getWidth(ek))) * eA;
    return S ? e : 0
  }, [ek, eA, S]), eB = r.useMemo(() => {
    let e = Math.ceil(window.innerHeight / (0, ed.KW)(eT.getWidth(ek))) * eA;
    return L && eS ? e : 0
  }, [ek, eA, L, eS]), eU = r.useMemo(() => {
    if (eu)
      if (!ea && eS) return [1, 0];
  ...
  }, [eu, eS, g.length, x.length, ea, el, eL, j, eH, ez, eB, eF, eD]), eG = r.useMemo(() => !ea && eS ? [
    [],
    []
  ] : el ? eS ? [
    [], j, [],
    ...
    [], g, []
  ], [eS, ea, el, j, g, x, eF, eD]), eV = r.useCallback((e, n) => {
    (0, ee.B5)({
      guildId: t.guild_id,
      channelId: t.id,
      postId: e.id,
    ...
    coords: n,
    onHeightChange: eq,
    children: !_ && (0, a.jsx)(et.Z, {
      channel: t,
      hasAnyThread: V,
      hasActiveThreads: G
    }, t.id)
  }, "forum-channel-header") : 2 !== e || el ? 1 === e && eS && !ea ? (0, a.jsx)(e_, {
    channel: t,
    coords: n
  ...
  let {
    ...
    } = e, g = (0, h.e7)([U.Z], () => U.Z.getChannelId()), x = r.useCallback(e => n => {
      var a;
      t.current = n, e.current = null != (a = null == n ? true : n.getScrollerNode()) ? a : null
    }, [t]), p = r.useCallback(e => eN({
      section: e.section,
      isShowingSearchResult: f,
      hasActiveThreads: n
    })(), [n, f]), j = r.useCallback(e => d(e.section, true, () => {
      if (3 === e.section) return __OVERLAY__ ? null : (0, a.jsx)("div", {
        "data-item-role": "item",
    ...
    let {
      ...
      focusedThreadId: f,
      headerHeight: h
    } = e, g = r.useRef(null), x = r.useCallback(e => {
      t.current = e, g.current = null == e ? true : e.getScrollerNode()
    }, [t]), b = r.useCallback((e, n) => {
      let {
        current: a
      } = t;
      if (null == a) return;
    ...
    }, [n]), v = r.useCallback((e, t, n) => s(e, t, eN({
      section: e,
      coords: t,
      key: n,
      isShowingSearchResult: c,
      hasActiveThreads: o
    })), [s, o, c]), C = r.useCallback(e => 0 === e ? {} : {
      role: "grid",
    ...
    return {
      ...
      renderGridItem: r.useCallback((e, t, r, s, o) => {
        ...
        }, s) : __OVERLAY__ ? null : (0, a.jsx)("div", {
          style: ej({}, r),
          "data-item-role": "item",
      ...
      getSectionProps: C,
      getGridSectionHeight: r.useCallback(e => 0 === e ? h - 8 - 24 : 2 === e ? o || !u ? 40 : 0 : 1 === e && c && !d ? 40 : 0, [h, c, d, o, u])
    }
  }({
  ...
  let tt = r.useCallback(() => {
      var e, n;
      if (eS) return;
      let a = eu ? null == (e = e1.current) ? true : e.getScrollerState() : null == (n = eo.current) ? true : n.getScrollerState();
      if (null == a) return;
      (0, ee.ab)({
        guildId: t.guild_id,
        channelId: t.id
    ...
    tl = r.useCallback((e, n, a) => 0 === e ? 0 : (0, ed.KW)(a, t.isMediaChannel() ? ed.Lv.SIXTEEN_BY_NINE : ed.Lv.THREE_BY_TWO), [t]),
...
function eZ(e) {
  ...
  r.useLayoutEffect(ex, [ex, p, ed, A]), (0, W.yp)({
  ...
  r.useLayoutEffect(() => {
    ...
    if (null != ew.current && null != n && null != n.children) {
      let {
        left: e,
        top: t
      } = ew.current.getBoundingClientRect(), a = 0;
  ...
  return (0, a.jsx)("div", ev(ej({
    ...
    children: (0, a.jsxs)(W.I3, {
      children: [null != s.guild_id ? (0, a.jsx)(S.Z, {
        className: l()(ep.newMemberBanner, {
          [ep.gridViewBanner]: H === f.X.GRID
        }),
        guildId: s.guild_id,
        channel: s
      }) : null, (0, a.jsx)("div", {
        ...
        children: [(0, a.jsx)(ek, {
          channel: s
        }), eG.length > 0 ? (0, a.jsxs)(a.Fragment, {
          children: [(0, a.jsx)("div", {
              ...
              children: (0, a.jsx)(d.SJ, {
                children: e => {
                  ...
                  return (0, a.jsx)("div", ev(ej({
                    ...
                    children: eG.map(e => (0, a.jsx)(ec.Z, {
                      tag: e,
                      onClick: () => {
                        var t;
            ...
            children: (e, t) => {
              ...
              return (0, a.jsxs)(x.zx, ev(ej({}, e), {
                ...
                }) : eb.intl.string(eb.t.fZ8hzm), n ? (0, a.jsx)(b.u04, {
                  size: "custom",
                  color: "currentColor",
                  width: 20
                }) : (0, a.jsx)(b.CJ0, {
        ...
        children: e => {
          ...
          return t === g.z.FORUM_CHANNEL_HELPER_CARD ? (0, a.jsx)(ea.Z, {
            onDismiss: n
          }) : null
        }
      })]
