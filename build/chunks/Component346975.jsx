...
function eN(e) {
  ...
  }(t), H = m.length > 0, U = H || f.length > 0, V = (0, P.Z)(t), {
    tagFilter: G,
    tagSetting: X
  } = (0, K.H)(t.id);
  (0, J.ku)(t, G, X, u);
      ...
      let a = i.useRef(null),
        l = i.useCallback((e, t) => {
          for (let n of t) {
            ...
            if (null == t) return;
            let r = Date.now();
            n.intersectionRatio >= .5 ? (0, Q.rj)(e, t, r) : (0, Q.Ct)(e, t, r)
          }
        }, []);
      return i.useEffect(() => {
        var e;
  ...
  let {
    columns: ek
  } = i.useMemo(() => eo ? e_.getRenderOptions(eM) : ec.eU, [eo, eM]), eA = i.useMemo(() => O ? Math.round((window.innerHeight - 200) / 118) : 0, [O]), {
    showResolvedFlags: eL
  } = (0, T.N)(t.id), eF = t.isModeratorReportChannel(), eD = i.useMemo(() => {
    let e = Math.ceil(window.innerHeight / (0, ec.KW)(e_.getWidth(eM))) * ek;
    return _ ? e : 0
  }, [eM, ek, _]), ez = i.useMemo(() => {
    let e = Math.ceil(window.innerHeight / (0, ec.KW)(e_.getWidth(eM))) * ek;
    return y ? e : 0
  }, [eM, ek, y]), eH = i.useMemo(() => {
    let e = Math.ceil(window.innerHeight / (0, ec.KW)(e_.getWidth(eM))) * ek;
    return I && eC ? e : 0
  }, [eM, ek, I, eC]), eB = i.useMemo(() => {
    if (eo)
      if (!et && eC) return [1, 0];
  ...
  }, [eo, eC, m.length, f.length, et, en, eA, x, eD, ez, eH, eL, eF]), eU = i.useMemo(() => !et && eC ? [
    [],
    []
  ] : en ? eC ? [
    [], x, [],
    ...
    [], m, []
  ], [eC, et, en, x, m, f, eL, eF]), eV = i.useCallback((e, n) => {
    (0, $.B5)({
      guildId: t.guild_id,
      channelId: t.id,
      postId: e.id,
    ...
    }) : (ew.current = e.id, (0, L.ok)(e))
  }, [t.guild_id, t.id, ew]), [eG, eq] = i.useState(a + s - 24), eW = i.useCallback((e, n, i) => 0 === e ? (0, r.jsx)(eZ, {
    channel: t,
    isEmpty: !H,
    isSearchLoading: I,
    ...
    coords: n,
    onHeightChange: eq,
    children: !O && (0, r.jsx)(ee.Z, {
      channel: t,
      hasAnyThread: U,
      hasActiveThreads: H
    }, t.id)
  }, "forum-channel-header") : 2 !== e || en ? 1 === e && eC && !et ? (0, r.jsx)(eE, {
    channel: t,
    coords: n
  }, "archive-or-search-result") : i() : (0, r.jsx)(eI, {
    channel: t,
    coords: n
  }, "archived-missing-reading-history-perm"), [eC, en, x, et, t, H, I, O, U]), eX = (0, g.e7)([q.Z], () => q.Z.hasHidden(t.id)), eK = {
    editorHeight: a,
    isGridLayout: eo
  }, eJ = i.useRef(eK);
  i.useEffect(() => {
  ...
  let {
    ...
    } = e, f = (0, g.e7)([B.Z], () => B.Z.getChannelId()), x = i.useCallback(e => n => {
      var r;
      t.current = n, e.current = null != (r = null == n ? true : n.getScrollerNode()) ? r : null
    }, [t]), b = i.useCallback(e => eP({
      section: e.section,
      isShowingSearchResult: h,
      hasActiveThreads: n
    ...
    }, [n]), v = i.useCallback((e, t, n) => s(e, t, eP({
      section: e,
      coords: t,
      key: n,
      isShowingSearchResult: c,
      hasActiveThreads: o
    })), [s, o, c]), C = i.useCallback(e => 0 === e ? {} : {
      role: "grid",
...
function eI(e) {
  ...
  return (0, r.jsx)("div", {
    ...
    children: (0, r.jsx)(p.Text, {
      ...
      children: ex.intl.format(ex.t.TycmzM, {
        channelName: i
      })
    })
  })
...
function eE(e) {
  ...
  return (0, r.jsx)("div", {
    ...
    children: (0, r.jsx)(p.Text, {
      color: "text-muted",
      variant: "text-md/normal",
      children: ex.intl.format(ex.t.OWZJdX, {
        channelName: i
      })
    })
  })
...
function eR(e) {
  ...
  return 0 === a ? null : (0, r.jsx)(p.P3F, {
    ...
    children: (0, r.jsx)(p.Text, {
      ...
      children: ex.intl.format(ex.t.ue1qfH, {
        count: a
      })
    })
  })
...
function eZ(e) {
  ...
  let {
    ...
    tagFilter: D,
    layoutType: B
  } = (0, K.H)(s.id), q = (0, ei.AF)(), X = (0, K.v)(), Y = (0, g.e7)([H.Z], () => H.Z.canChatInGuild(s.guild_id)), Q = (0, J.r_)(s), ee = (0, A.cD)(s), [er, el] = i.useState(ee), [, es] = (0, y.AB)(null != (a = s.getGuildId()) ? a : true), ec = (0, I.HL)(s), eu = Y && (ee || er && es) && !ec, em = s.isMediaChannel();
  i.useEffect(() => {
    ee && el(true)
  }, [ee]);
  let {
  ...
  i.useLayoutEffect(eC, [eC, b, eu, L]), (0, G.yp)({
  ...
  let e_ = (0, g.e7)([U.Z], () => U.Z.getUploads(s.id, z.d.FirstThreadMessage)),
    ...
    eN = null == (n = eO.current) || null == (t = n.getBoundingClientRect()) ? true : t.width,
    eI = i.useRef(null),
    eE = i.useRef(null);
  i.useLayoutEffect(() => {
    var e;
    ...
    if (null != eO.current && null != n && null != n.children) {
      let {
        left: e,
        top: t
      } = eO.current.getBoundingClientRect(), r = 0;
  ...
  return (0, r.jsx)("div", ej(eb({
    ...
    children: (0, r.jsxs)(G.I3, {
      children: [null != s.guild_id ? (0, r.jsx)(O.Z, {
        ...
        children: [eR && (0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(p.X6q, {
            ...
            color: "text-default",
            children: C ? ex.intl.string(ex.t["/9i3qq"]) : 0 === w ? ex.intl.string(ex.t.DbgHxs) : ex.intl.formatToPlainString(ex.t["tBz/8f"], {
              numPosts: w,
              query: E
            })
          }), !C && (0, r.jsx)(p.P3F, {
            onClick: () => {
              (0, $.zI)({
                guildId: s.guild_id,
                channelId: s.id
              }), W.Z.clearForumSearch(s.id), q.getState().setName("")
            },
            children: (0, r.jsx)(p.Text, {
          ...
          children: [(0, r.jsx)("div", {
            ...
            children: (e, t) => {
              ...
              return (0, r.jsxs)(x.zx, ej(eb({}, e), {
                ...
                }) : ex.intl.string(ex.t.fZ8hzs), n ? (0, r.jsx)(p.u04, {
                  size: "custom",
                  color: "currentColor",
                  width: 20
                }) : (0, r.jsx)(p.CJ0, {
        ...
        children: e => {
          ...
          return t === f.z.FORUM_CHANNEL_HELPER_CARD ? (0, r.jsx)(en.Z, {
            onDismiss: n
          }) : null
        }
      })]
