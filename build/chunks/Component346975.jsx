...
function eI(e) {
  ...
  let {
    columns: eA
  } = a.useMemo(() => eu ? eT.getRenderOptions(ek) : ed.eU, [eu, ek]), eL = a.useMemo(() => _ ? Math.round((window.innerHeight - 200) / 118) : 0, [_]), {
    showResolvedFlags: eF
  } = (0, I.N)(t.id), eD = t.isModeratorReportChannel(), eH = a.useMemo(() => {
    let e = Math.ceil(window.innerHeight / (0, ed.KW)(eT.getWidth(ek))) * eA;
    return S ? e : 0
  }, [ek, eA, S]), ez = a.useMemo(() => {
    let e = Math.ceil(window.innerHeight / (0, ed.KW)(eT.getWidth(ek))) * eA;
    return N ? e : 0
  }, [ek, eA, N]), eB = a.useMemo(() => {
    let e = Math.ceil(window.innerHeight / (0, ed.KW)(eT.getWidth(ek))) * eA;
    return L && eN ? e : 0
  }, [ek, eA, L, eN]), eU = a.useMemo(() => {
    if (eu)
      if (!er && eN) return [1, 0];
  ...
  }, [eu, eN, g.length, x.length, er, el, eL, j, eH, ez, eB, eF, eD]), eG = a.useMemo(() => !er && eN ? [
    [],
    []
  ] : el ? eN ? [
    [], j, [],
    ...
    [], g, []
  ], [eN, er, el, j, g, x, eF, eD]), eV = a.useCallback((e, n) => {
    (0, ee.B5)({
      guildId: t.guild_id,
      channelId: t.id,
      postId: e.id,
  ...
  }, [t.guild_id, t.id, eI]), [eW, eq] = a.useState(i + s - 24), eX = a.useCallback((e, n, a) => 0 === e ? (0, r.jsx)(eZ, {
    channel: t,
    isEmpty: !G,
    isSearchLoading: L,
    ...
    coords: n,
    onHeightChange: eq,
    children: !_ && (0, r.jsx)(et.Z, {
      channel: t,
      hasAnyThread: V,
      hasActiveThreads: G
    }, t.id)
  }, "forum-channel-header") : 2 !== e || el ? 1 === e && eN && !er ? (0, r.jsx)(e_, {
    channel: t,
    coords: n
  }, "archive-or-search-result") : a() : (0, r.jsx)(eE, {
    channel: t,
    coords: n
  }, "archived-missing-reading-history-perm"), [eN, el, j, er, t, G, L, _, V]), eK = (0, f.e7)([q.Z], () => q.Z.hasHidden(t.id)), eY = {
    editorHeight: i,
    isGridLayout: eu
  }, eJ = a.useRef(eY);
  a.useEffect(() => {
    ...
    let {
      editorHeight: n,
      isGridLayout: r
    } = eJ.current, a = r ? e1 : eo, i = null == (e = a.current) ? true : e.getScrollerState();
    null != i && !eK && i.scrollTop > n && (null == (t = a.current) || t.scrollTo({
      to: 0
    }))
  }, [eK]);
  let {
    ...
    } = e, g = (0, f.e7)([U.Z], () => U.Z.getChannelId()), x = a.useCallback(e => n => {
      var r;
      t.current = n, e.current = null != (r = null == n ? true : n.getScrollerNode()) ? r : null
    }, [t]), p = a.useCallback(e => ew({
      section: e.section,
      isShowingSearchResult: h,
      hasActiveThreads: n
    })(), [n, h]), j = a.useCallback(e => d(e.section, true, () => {
    ...
    let {
      ...
      focusedThreadId: h,
      headerHeight: f
    } = e, g = a.useRef(null), x = a.useCallback(e => {
      t.current = e, g.current = null == e ? true : e.getScrollerNode()
    }, [t]), b = a.useCallback((e, n) => {
      let {
        current: r
      } = t;
      if (null == r) return;
    ...
    }, [n]), v = a.useCallback((e, t, n) => s(e, t, ew({
      section: e,
      coords: t,
      key: n,
      isShowingSearchResult: c,
    ...
    return {
      ...
      getSectionProps: C,
      getGridSectionHeight: a.useCallback(e => 0 === e ? f - 8 - 24 : 2 === e ? o || !u ? 40 : 0 : 1 === e && c && !d ? 40 : 0, [f, c, d, o, u])
    }
  }({
  ...
  let tt = a.useCallback(() => {
      var e, n;
      if (eN) return;
      let r = eu ? null == (e = e1.current) ? true : e.getScrollerState() : null == (n = eo.current) ? true : n.getScrollerState();
      if (null == r) return;
      (0, ee.ab)({
        guildId: t.guild_id,
        channelId: t.id
    ...
    tl = a.useCallback((e, n, r) => 0 === e ? 0 : (0, ed.KW)(r, t.isMediaChannel() ? ed.Lv.SIXTEEN_BY_NINE : ed.Lv.THREE_BY_TWO), [t]),
    ...
    children: (0, r.jsx)(b.Wdt, {
      children: e => (0, r.jsxs)(r.Fragment, {
        children: [u && (0, r.jsx)(p.Z, {
          ...
          navigator: ta,
          children: (0, r.jsx)(b.GMG, ej({
            ref: e => {
              var t;
              to.current = null != (t = null == e ? true : e.getScrollerNode()) ? t : null, e8(e)
            },
            itemGutter: 16,
            padding: 24,
            className: ep.grid,
...
function eR(e) {
  let {
    ...
    X.Z.resort(t.id)
  }, [t]), i = (0, f.e7)([K.Z], () => K.Z.getNewThreadCount());
  return 0 === i ? null : (0, r.jsx)(b.P3F, {
...
function eZ(e) {
  ...
  let {
    ...
    tagFilter: D,
    layoutType: H
  } = (0, Y.H)(s.id), U = (0, ei.AF)(), q = (0, Y.v)(), K = (0, f.e7)([B.Z], () => B.Z.canChatInGuild(s.guild_id)), Q = (0, J.r_)(s), $ = (0, L.cD)(s), [et, ea] = a.useState($), [, es] = (0, S.AB)(null != (i = s.getGuildId()) ? i : true), eo = (0, _.HL)(s), ed = K && ($ || et && es) && !eo, em = s.isMediaChannel();
  a.useEffect(() => {
    $ && ea(true)
  }, [$]);
  let {
  ...
  a.useLayoutEffect(ex, [ex, p, ed, A]), (0, W.yp)({
  ...
  let ey = (0, f.e7)([G.Z], () => G.Z.getUploads(s.id, z.d.FirstThreadMessage)),
    ...
    {
      width: eP
    } = (0, f.e7)([V.Z], () => V.Z.windowSize()),
    eI = null == (n = eS.current) || null == (t = n.getBoundingClientRect()) ? true : t.width,
    eE = a.useRef(null),
    e_ = a.useRef(null);
  a.useLayoutEffect(() => {
    var e;
  ...
  return (0, r.jsx)("div", ev(ej({
    ...
    children: (0, r.jsxs)(W.I3, {
      children: [null != s.guild_id ? (0, r.jsx)(N.Z, {
        className: l()(ep.newMemberBanner, {
          [ep.gridViewBanner]: H === h.X.GRID
        }),
        guildId: s.guild_id,
        channel: s
      }) : null, (0, r.jsx)("div", {
        className: l()(ep.mainCard, ep.header, {
          [ep.headerWithMatchingPosts]: eR || eZ
        }),
          ...
          children: [(0, r.jsx)("div", {
            ...
            children: (e, t) => {
              ...
              return (0, r.jsxs)(x.zx, ev(ej({}, e), {
                ...
                "aria-label": D.size > 0 ? eb.intl.string(eb.t.IkpM1T) : eb.intl.string(eb.t["9vKK/N"]),
                ...
                }) : eb.intl.string(eb.t.fZ8hzm), n ? (0, r.jsx)(b.u04, {
                  size: "custom",
                  color: "currentColor",
                  width: 20
                }) : (0, r.jsx)(b.CJ0, {
        ...
        children: e => {
          ...
          return t === g.z.FORUM_CHANNEL_HELPER_CARD ? (0, r.jsx)(er.Z, {
            onDismiss: n
          }) : null
        }
      })]
...
function ek(e) {
  let {
    channel: t
  } = e, n = t.isMediaChannel(), i = a.useRef(null);
