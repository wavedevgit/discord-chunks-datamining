...
function N(e) {
  ...
  })), W = (null == (t = w.userStatus) ? true : t.enrolledAt) != null, z = (null == (n = w.userStatus) ? true : n.completedAt) != null, q = z && (null == (N = w.userStatus) ? true : N.claimedAt) == null, K = (0, g.iQ)(w), Y = !(0, g.zi)(w), Q = (0, f._Q)(w), X = (0, b.PB)(w), J = (0, b.HJ)(w), $ = (0, b.Vl)(w), ee = (0, f.Rf)(w), [et, en, ea] = (0, f.me)(w, ee), er = Y && Q === f.OH.ACCEPTED, ei = er && et === h.LI.SELECT, el = er && !ei && en.length > 1, es = r.useCallback(e => {
