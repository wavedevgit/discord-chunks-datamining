...
let p = e => i.useMemo(() => {
  ...
  h = e => {
    ...
    if (l === o.z.NAGBAR_NOTICE_OFFER_EXPIRING) {
      if (n === f.kVF.PREMIUM_TIER_2_TRIAL_ENDING) return <s.Z dismissCurrentNotice={() => c(d.L.USER_DISMISS)} subscriptionTier={_.Si.TIER_2} />;
      if (n === f.kVF.PREMIUM_TIER_2_DISCOUNT_ENDING) return <a.Z dismissCurrentNotice={() => c(d.L.USER_DISMISS)} subscriptionTier={_.Si.TIER_2} />
    }
  }