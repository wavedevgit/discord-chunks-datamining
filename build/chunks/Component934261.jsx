...
let I = e => {
    let {
      ...
      product: u,
      purchase: d
    } = e, p = (0, l.e7)([y.default], () => y.default.getCurrentUser()), m = (0, l.e7)([s.Z], () => s.Z.getProduct(null == n ? true : n.skuId)), g = (0, l.e7)([x.default], () => x.default.locale), h = _.ZP.canUseCollectibles(p), b = (0, c.qS)(d), j = (0, c.G1)(u), P = !h && b, C = (null == d ? true : d.expiresAt) != null ? (0, O.TD)(Date.now(), d.expiresAt) : null, I = (0, a.ag)(d), w = (0, a.kd)(m), A = (0, f.M)(!j || h), N = S(P, j, h, A);
  ...
  w = e => {
    ...
    }, null != f ? u.Z.getAllPending() : P.Z.getAllPending())), Z = _.ZP.isPremium(i), D = _.ZP.canUsePremiumProfileCustomization(i), T = (0, h.ZP)(i.id), U = !!(null == T ? true : T.getPreviewBio(v)), B = {
      user: i,
      guild: f,
      pendingGlobalName: x,
      pendingNickname: y,
