...
function h(e) {
  ...
  }, []), <d.Z tab={f.vf.FEATURED} guildIds={o} loading={u} onScroll={t} onGuildCardSeen={n} onGuildCardClick={a} />
}
...
function g(e) {
  ...
  }, [p]), <d.Z tab={t} guildIds={h} loading={g} onScroll={n} onGuildCardSeen={a} onGuildCardClick={o} />
}
...
function m(e) {
  ...
  switch (i.useEffect(() => {
    ...
    case f.vf.FEATURED:
      return <h tab={t} onScroll={n} onGuildCardClick={s} onGuildCardSeen={l} />;
    case f.vf.GAMING:
    case f.vf.MUSIC:
    case f.vf.ENTERTAINMENT:
    case f.vf.TECH:
    case f.vf.EDUCATION:
      return <g tab={t} onScroll={n} onGuildCardClick={s} onGuildCardSeen={l} />;
    case f.vf.HUBS:
      return <p.Z onScroll={n} />;
    default:
      (0, o.vE)(t)
  }
}