...
function m(e) {
  ...
  })), [I, h] = r.useState(l || m), g = s.Rt.useSetting(), y = null != t && !b.some(e => t.includes(e));
  return (r.useEffect(() => {
    h(l || m)
  }, [l, m]), I && y && !(m && g)) ? (0, o.jsx)(a.W, p({
    onViewBlockedProfileClick: () => h(!1)
  }, e)) : n.isNonUserBot() ? (0, o.jsx)(u.Z, p({}, e)) : n.bot ? (0, o.jsx)(d.Z, p({}, e)) : (0, o.jsx)(f.Z, p({}, e))
}