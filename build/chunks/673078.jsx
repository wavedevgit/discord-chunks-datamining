...
function m(t) {
  ...
  return null == o ? null : <n.Fragment>{<a.X6q className={b.warningSectionHeader} variant={"text-md/medium"} color={"text-default"}>{<a.Mgn size={"sm"} color={"currentColor"} />}{<a.LZC horizontal={true} size={8} />}{p.intl.string(p.t.bi7buL)}</a.X6q>}{<a.Text variant={"text-md/normal"}>{p.intl.format(p.t["4kglOT"], {
        roleName: o.name
      })}</a.Text>}</n.Fragment>
}
...
function O(t) {
  ...
  return <a.ConfirmModal{...e = function(t) {
