...
function I(e) {
  let {
    ...
    userId: n.id,
    guildId: P
  }), R = (0, r.e7)([s.Z], () => s.Z.isFetchingUserOutbox(n.id)), U = n.id === t.id, L = (0, r.e7)([u.Z, c.Z], () => {
    let e = U ? u.Z.getStatus() : c.Z.getStatus(n.id);
    return e === i.Skl.OFFLINE || e === i.Skl.INVISIBLE
  }), D = C.length > 0 || null != _, B = S && null == _ && null == M && null != w, G = !L && (D || B), k = A.length > 0;
  return G || k || !R ? (0, l.jsxs)(i.zJl, {
    className: O.scroller,
    fade: !0,
    children: [G ? (0, l.jsxs)(g.Z, {
      children: [!N && B && (0, l.jsx)(m.Z, {
        user: n,
        currentUser: t,
        voiceChannel: w,
        onClose: T
      ...
      }), C.map((e, r) => (0, l.jsx)(v.Z, {
        user: n,
        currentUser: t,
        activity: e,
        onClose: T,
        profileGuildId: null == I ? void 0 : I.guildId
      }, "live-".concat(r))), N && B && (0, l.jsx)(m.Z, {
        user: n,
        currentUser: t,
        voiceChannel: w,
        onClose: T
