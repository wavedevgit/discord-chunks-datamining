...
function I(e) {
  let {
    ...
    userId: n.id,
    guildId: P
  }), w = (0, r.e7)([s.Z], () => s.Z.isFetchingUserOutbox(n.id)), U = n.id === t.id, L = (0, r.e7)([a.Z, d.Z], () => {
    let e = U ? a.Z.getStatus() : d.Z.getStatus(n.id);
    return e === i.Skl.OFFLINE || e === i.Skl.INVISIBLE
  }), D = A.length > 0 || null != _, G = S && null == _ && null == R && null != M, B = !L && (D || G), k = C.length > 0;
  return B || k || !w ? (0, l.jsxs)(i.zJl, {
    className: y.scroller,
    fade: !0,
    children: [B ? (0, l.jsx)(h.Z, {
      "aria-label": Z.intl.string(Z.t.J6STd3),
      children: (0, l.jsxs)("ul", {
        className: y.activityList,
        children: [!N && G && (0, l.jsx)("li", {
      ...
      introText: U ? Z.intl.format(Z.t["4bk9Ag"], {
