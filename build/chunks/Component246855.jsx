...
function E(e) {
  let {
    onVideoLoaded: t,
    isLoading: n
  } = e, i = (0, o.e7)([d.Z], () => d.Z.useReducedMotion), [u, m] = r.useState(!i), p = (0, c.ZP)(), f = (0, l.apv)(p), x = f ? L.Z : w.Z, h = f ? A.Z : S.Z, C = r.useRef(null), _ = r.useRef(null), [j, g] = r.useState(false), [y, v] = r.useState(false), [N, O] = r.useState(false);
  r.useEffect(() => {
    j && y && N && t()
  }, [j, y, N, t]), r.useEffect(() => {
    n || i || setTimeout(() => {
