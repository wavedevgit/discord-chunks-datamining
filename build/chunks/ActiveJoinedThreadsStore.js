  ...
  for (let e in t)
    for (let n in t[e]) {
      ...
      if (null != t) {
        ...
        ee(S, e, n, false), ee(A, e, i ? n : null, false), ee(I, e, r ? n : null, false), a && X(e, true)
      } else {
        ee(T, e, e, false);
...
function k(e, t, n) {
  ...
  if (null != r && m.Z.isActive(e, t, n)) {
    if (null != i) {
      ...
      ee(S, r, e, true), ee(A, r, n ? e : null, true), ee(I, r, t ? e : null, true), ee(T, r, null, true), ee(C, r, null, true), X(r, a)
    } else {
