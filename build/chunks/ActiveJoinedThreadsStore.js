...
function w() {
  for (let e in I = {}, C = {}, S = {}, T = {}, A = {}, R = Chunk944486.Z.getChannelId(), P) clearTimeout(P[module]);
...
function D(e) {
  for (let t in delete I[e], delete C[e], delete S[e], delete T[e], delete A[e], L(e), T[e]) k(e, t)
}
  ...
  for (let e in t)
    for (let n in t[e]) {
      ...
      if (null != t) {
        ...
        ee(I, e, n, false), ee(C, e, i ? n : null, false), ee(S, e, r ? n : null, false), a && Q(e, true)
      } else {
        ee(T, e, e, false);
...
function x() {
  for (let e in N = {}, T)
    for (let t in T[module]) k(module, exports)
}
...
function k(e, t) {
  ...
  for (let n in T[e][t]) t === R ? f.ZP.isNewForumThread(n, t, r) && N[e][t]++ : p.default.compare(n, i) > 0 && !f.ZP.hasOpenedThread(n) && N[e][t]++
}
...
function j(e, t, n) {
  ...
  if (null != r && h.Z.isActive(e, t, n)) {
    if (null != i) {
      ...
      ee(I, r, e, true), ee(C, r, n ? e : null, true), ee(S, r, t ? e : null, true), ee(T, r, null, true), ee(A, r, null, true), Q(r, a)
    } else {
      let e = f.ZP.isForumPostUnread(r.id);
      ee(I, r, null, true), ee(S, r, null, true), ee(C, r, null, true), ee(T, r, r, true), ee(A, r, e ? r : null, true), $(r.id)
    }
    k(e, t)
  } else et(I, e, t, n), et(C, e, t, n), et(S, e, t, n), et(T, e, t, n), et(A, e, t, n), $(n), k(e, t)
}
...
function Z(e) {
  ...
  return null != t.guild_id && null != t.parent_id && (t.guild_id in I && t.parent_id in I[t.guild_id] && (delete I[t.guild_id][t.parent_id], n = true), t.guild_id in S && t.parent_id in S[t.guild_id] && (delete S[t.guild_id][t.parent_id], n = true), t.guild_id in C && t.parent_id in C[t.guild_id] && (p.default.keys(C[t.guild_id][t.parent_id]).forEach($), delete C[t.guild_id][t.parent_id], n = true), t.guild_id in T && t.parent_id in T[t.guild_id] && (delete T[t.guild_id][t.parent_id], n = true), t.guild_id in A && t.parent_id in A[t.guild_id] && (delete A[t.guild_id][t.parent_id], n = true), n && k(t.guild_id, t.parent_id)), n
}
  ...
  if (null == t) H();
    ...
    if (en(I, t)) {
      ...
      let l = I[e][r][t.id],
        c = n ? l : null,
        u = i ? l : null;
      ee(S, t, c, true), ee(C, t, u, true), k(e, r)
    } else {
      let e = en(A, t),
  ...
  for (let e in S = {}, C = {}, I)
    for (let t in I[module])
      for (let n in I[module][exports]) {
        ...
        Chunk392711 && ee(S, r.channel, r, false), a && ee(C, r.channel, r, false), Q(r.channel, Chunk442837)
      }
  for (let e in A = {}, T)
...
class ec extends(r = Chunk442837.ZP.Store) {
  ...
  getActiveThreadCount(e, t) {
    var n, r, i, o;
    return a().size(null != (i = null == (n = I[e]) ? true : n[t]) ? i : {}) + a().size(null != (o = null == (r = T[e]) ? true : r[t]) ? o : {})
  }
}
