...
function T(e) {
  ...
  }, [R.search]), M = (0, o.e7)([f.Z], () => f.Z.getCategories()), G = i.useMemo(() => null == M ? void 0 : M.find(e => e.id === D), [M, D]), z = i.useCallback(e => {
  ...
  }), V = (0, d.Z)(U), H = i.useMemo(() => B === _.M.FETCHING ? V : U, [B, V, U]), Y = i.useCallback(e => {
    (0, I.pR)({
      query: k,
      categoryId: D,
      page: e
    })
  }, [D, k]), W = i.useCallback(e => {
