...
function E(e) {
  ...
  return (i.useEffect(() => {
    ...
    return t && <o.animated.div className={f.voiceChannelEffectEmojiContainer} style={{
        transform: i.to(g)
      }}><l.Z className={f.voiceChannelEffectEmoji} emojiId={E.id} emojiName={E.name} animated={null != (n = E.animated) && n} /></o.animated.div>
  })
}