...
function W(e) {
  ...
  let {
    ...
    onSubmitted: p,
    viewId: I
  } = e, [k, W] = l.useState(""), b = (0, o.e7)([m.Z], () => m.Z.getApplication(x)), [w, S] = l.useState(""), z = (0, o.e7)([g.Z], () => g.Z.getGame(x)), G = null != (t = null != (a = null == z ? void 0 : z.name) ? a : null == b ? void 0 : b.name) ? t : "", L = null == b ? void 0 : b.getIconURL(j.Si.LARGE), {
    primaryColor: R,
    secondaryColor: Z
  } = (0, h.Z)(L);
  l.useEffect(() => {
  ...
  let B = (0, o.Wu)([N.Z], () => {
      ...
      return (0, r.chain)(N.Z.games).filter(a => i()(e, a.name.toLowerCase())).filter(e => e.id !== x).take(4).concat(null != a ? [a] : []).compact().uniqBy("id").value()
    }, [x, w, G, k]),
