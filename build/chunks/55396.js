...
function C(e) {
  ...
  let {
    ...
    onSubmitted: f,
    viewId: I
  } = e, [k, C] = i.useState(""), w = (0, o.e7)([d.Z], () => d.Z.getApplication(x)), [S, z] = i.useState(""), G = (0, o.e7)([h.Z], () => h.Z.getGame(x)), L = null != (a = null != (t = null == G ? void 0 : G.name) ? t : null == w ? void 0 : w.name) ? a : "", y = null == w ? void 0 : w.getIconURL(v.Si.LARGE), {
    primaryColor: Z,
    secondaryColor: F
  } = (0, g.Z)(y);
  i.useEffect(() => {
