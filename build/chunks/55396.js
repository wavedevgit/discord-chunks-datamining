...
function C(e) {
  ...
  let {
    ...
    onSubmitted: f,
    viewId: I
  } = e, [k, C] = l.useState(""), w = (0, o.e7)([m.Z], () => m.Z.getApplication(x)), [S, z] = l.useState(""), G = (0, o.e7)([g.Z], () => g.Z.getGame(x)), L = null != (a = null != (t = null == G ? void 0 : G.name) ? t : null == w ? void 0 : w.name) ? a : "", Z = null == w ? void 0 : w.getIconURL(v.Si.LARGE), {
    primaryColor: F,
    secondaryColor: X
  } = (0, h.Z)(Z);
  l.useEffect(() => {
