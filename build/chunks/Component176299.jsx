...
function tl(e) {
  ...
  let O = i.useRef(null),
    ...
    y = i.useCallback(e => {
      var t;
      document.body.classList.remove(eD.dragging), document.body.classList.remove(eD.draggingMin), document.body.classList.remove(eD.draggingMax), document.body.classList.remove(eD.collapsing), null == (t = O.current) || t.style.setProperty("--custom-overdrag", "0px"), f.K.set(ej.nT, e), eI.default.track(eA.rMx.CHANNEL_SIDEBAR_RESIZED, {
        width: e
      })
    }, []),
    S = (0, E.Z)({
