...
function j(e) {
  ...
  let {
    ...
    giftBoxAnimation: P,
    trinketsAnimation: w
  } = null != (t = null == n ? true : n.chatGiftIcon) ? t : {}, j = null != n.firstTimeNotice && !s && C && R >= L, [k, M] = (0, f.XR)(j ? a.z.GIFTING_PROMOTION_DESKTOP_FIRST_TIME_COACHMARK : null, (0, d.t)(a.z.GIFTING_PROMOTION_DESKTOP_FIRST_TIME_COACHMARK)), U = null != k, G = v || U, B = (0, y.Ft)(l), Z = (0, p.IH)();
  if (s) return null;
  let F = () => {
      (0, _.Z)({
        isGift: true,
