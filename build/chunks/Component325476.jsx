...
class f extends(i = Chunk73800.PureComponent) {
  render() {
    ...
    return exports ? (0, Chunk255367.jsx)("aside", {
      className: Chunk416746.sidebarScrollable,
      children: (0, Chunk255367.jsx)(Chunk481060.Ttm, {
        fade: true,
        className: Chunk416746.scroller,
        children: (0, Chunk255367.jsx)(Chunk600164.Z.Child, b(m({}, require), {
          wrap: true
        }))
      })
    }) : (0, Chunk255367.jsx)(Chunk600164.Z.Child, b(m({}, require), {
      wrap: true
    }))
  }
}
...
class x extends(r = Chunk73800.PureComponent) {
  render() {
    return (0, Chunk255367.jsx)(Chunk600164.Z, m({}, this.props))
  }
}
p(x, "defaultProps", {
