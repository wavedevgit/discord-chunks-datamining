...
function U(e) {
  let {
    ...
    "aria-setsize": b,
    "aria-posinset": h
  } = e, p = (0, o.JA)(t.id), m = r.useCallback(() => {
    c || null == f || f(t)
  }, [f, c, t]);
...
function q(e) {
  ...
  let u = r.useMemo(() => [t.length], [t.length]),
    ...
    p = r.useCallback(e => {
      ...
      return i === h.h8.USER ? (0, l.jsx)(I, M({
        user: u
      }, p)) : i === h.h8.GROUP_DM ? (0, l.jsx)(F, M({
        channel: u
      }, p)) : i === h.h8.TEXT_CHANNEL || i === h.h8.VOICE_CHANNEL ? (0, l.jsx)(H, M({
        channel: u
      }, p)) : void(0, L.vE)(i)
    }, [s, a, t, f]),
    m = r.useRef(null),
