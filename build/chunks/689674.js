...
function d(e) {
  ...
  }, [p.guild_id]), h = (null == (t = d.messageReference) ? void 0 : t.guild_id) != null && null != d.webhookId && d.hasFlag(u.iLy.IS_CROSSPOST) && null != p.guild_id, g = p.type === i.d.GUILD_ANNOUNCEMENT && f, _ = !d.hasFlag(u.iLy.EPHEMERAL) && (h || g), b = h && null != d.messageReference ? d.messageReference.message_id : d.id, y = h && null != d.messageReference ? d.messageReference.channel_id : p.id, x = h && (null == (n = d.messageReference) ? void 0 : n.guild_id) != null ? d.messageReference.guild_id : p.guild_id, E = r.useCallback(e => {
  ...
  }, [b, p.id, p.guild_id, y, x]), v = s.Z.useExperiment({
    location: "836a4b_1"
  }, {
    disable: !_ || !m,
    autoTrackExposure: !0
  }).enabled, O = (0, a.O)(E, 0, v);
  return r.useEffect(() => () => {
    c.Z.handleMessageLostVisibility(b)
  }, [b]), O
}