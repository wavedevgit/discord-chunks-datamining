...
function d(e) {
  ...
  }, [p.guild_id]), _ = (null == (t = d.messageReference) ? void 0 : t.guild_id) != null && null != d.webhookId && d.hasFlag(u.iLy.IS_CROSSPOST) && null != p.guild_id, g = p.type === i.d.GUILD_ANNOUNCEMENT && f, h = !d.hasFlag(u.iLy.EPHEMERAL) && (_ || g), b = _ && null != d.messageReference ? d.messageReference.message_id : d.id, E = _ && null != d.messageReference ? d.messageReference.channel_id : p.id, C = _ && (null == (n = d.messageReference) ? void 0 : n.guild_id) != null ? d.messageReference.guild_id : p.guild_id, O = r.useCallback(e => {
  ...
  }, [b, p.id, p.guild_id, E, C]), y = s.Z.useExperiment({
    location: "836a4b_1"
  }, {
    disable: !h || !m,
    autoTrackExposure: !0
  }).enabled, v = (0, a.O)(O, 0, y);
  return r.useEffect(() => () => {
    c.Z.handleMessageLostVisibility(b)
  }, [b]), v
}