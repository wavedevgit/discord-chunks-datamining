...
function d(e) {
  ...
  }, [p.guild_id]), _ = (null == (t = d.messageReference) ? void 0 : t.guild_id) != null && null != d.webhookId && d.hasFlag(u.iLy.IS_CROSSPOST) && null != p.guild_id, h = p.type === i.d.GUILD_ANNOUNCEMENT && f, g = !d.hasFlag(u.iLy.EPHEMERAL) && (_ || h), b = _ && null != d.messageReference ? d.messageReference.message_id : d.id, E = _ && null != d.messageReference ? d.messageReference.channel_id : p.id, y = _ && (null == (n = d.messageReference) ? void 0 : n.guild_id) != null ? d.messageReference.guild_id : p.guild_id, C = r.useCallback(e => {
