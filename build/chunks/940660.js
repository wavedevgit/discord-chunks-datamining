/** Chunk was on web.js **/
/** chunk id: 940660, original params: e,t,n (module,exports,re quire) **/
"use strict";
...
var a, Chunk76466 = require("./76466.js"),
  ...
  Y = function() {
    ...
    return exports.clear = function() {
      this.characterList = g(), this.blockConfigs = [], this.currentBlockType = "unstyled", this.currentDepth = 0, this.currentEntity = null, this.currentText = "", this.entityMap = Chunk928460, this.wrapper = null, this.contentBlocks = []
      ...
      var n = e.textContent;
      "" === n.trim() && "pre" !== this.wrapper && (n = " "), "pre" !== this.wrapper && (n = (n = n.replace(R, "")).replace(N, A)), this._appendText(n, t)
