...
class eq extends Chunk64700.PureComponent {
  ...
  renderContent(e) {
    ...
    } = this.props, y = f === eB.DUB.MINIMUM, _ = y || f === eB.DUB.NORMAL, O = i && a === eB._Of.VIDEO, j = (null != (t = null == b ? true : b.length) ? t : 0) > 0 && p.isPrivate();
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(h.NPJ, {
        ...
        children: t => (0, r.jsx)("div", {
          className: s()(eF.ik, i || e !== eB.DUB.FULL_SCREEN ? true : eF.iy, t),
          ref: e => {
  ...
  constructor(...e) {
    super(...e), eH(this, "_prevLayout", eB.DUB.MINIMUM), eH(this, "_wrapperRef", l.createRef()), eH(this, "_callContainerRef", l.createRef()), eH(this, "_channelChatRef", l.createRef()), eH(this, "_contentRef", l.createRef()), eH(this, "_videoBackgroundTooltipTimeout", new p.Ep), eH(this, "_lastIdleProps", null), eH(this, "state", {
      ...
      this.props.layout === eB.DUB.HAVEN ? (this.handleChangeLayout(eB.DUB.NO_CHAT), U.Ay.disconnect(this.props.channel.id)) : this.handleChangeLayout(eB.DUB.HAVEN)
      ...
      (0, eU.Ay)(e) && (0, G.eo)(n, em.A, ed.A, ep.A, M.default)[0] && (b.default.selectVoiceChannel(n.id), 0 === l.filter(t => (0, k._z)(t) === e.id && t.state !== eB.XYD.ENDED).length && (0, A.A9)((0, k.Iy)(e.id), {
        forceMultiple: t.shiftKey
      })), i && s === eB._Of.VIDEO && ((null == r ? true : r.id) === e.id ? g.A.selectParticipant(n.id, null) : g.A.selectParticipant(n.id, e.id))
      ...
      let d = e === eB.DUB.NO_CHAT ? ee.A.Directions.UP : ee.A.Directions.DOWN,
        ...
        A = i ? (0, r.jsx)(X.A, {
          channel: n,
          stream: (null == a ? true : a.type) === eU.lp.STREAM ? (0, k.Iy)(a.id) : true,
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [null != l && l.type !== eU.lp.ACTIVITY && l.user.id !== n ? (0, r.jsx)(ei.A, {
          ...
          className: eF.iq,
          onOpenPopout: () => {
            (0, eL.X)(N.A.VOICE_CONTROL_TRAY, eL.O.POPOUT, true), this.handleOpenPopout()
          },
          onClosePopout: () => {
            (0, eL.X)(N.A.VOICE_CONTROL_TRAY, eL.O.POPOUT, false), this.handleClosePopout()
          }
        }) : null, a ? (0, r.jsx)(et.A, {
          themeable: u,
...
let eX = function(e) {
  ...
  let {
    ...
    var e;
    return (null != (e = null == E ? true : E.channelId) ? e : ef.A.getVoiceChannelId()) === n.id
  }), {
    participants: T,
  ...
  }, []), ei = null != (t = null == X ? true : X.id) ? t : null, es = (0, S.A)(ei, n.id), eu = (0, u.bG)([x.A], () => x.A.getFetchState(), []), eg = (0, j.A)(eu);
  l.useEffect(() => {
