...
function x(e, t) {
  ...
  return {
    ...
    onSave: async r => {
      ...
      if (null != e && "" !== s && null != d) {
        h(true), m(null), null != n && (i.Z.selectGuild(n), l.default.selectVoiceChannel(e.id));
        try {
          let n;
          null != b ? n = await c.Ef(e, s, d) : (n = await c.HO(e, s, d, null != x && x), f && o.Kw(u.v.LIVE_STAGE_NOTIFICATION_BADGE)), t(n)
        } catch (e) {
          m(new a.Hx(e)), h(false)
        }
      }
    }
  }
