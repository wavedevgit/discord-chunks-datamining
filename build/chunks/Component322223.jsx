...
function I(e) {
  ...
  let {
    onDismiss: v
  } = e, I = (0, a.bG)([f.A], () => f.A.getGuildId()), T = (0, a.bG)([d.A], () => null != I ? d.A.getChannelId(I) : null, [I]), C = null != I ? I : null, N = (0, a.bG)([u.A], () => null != C ? u.A.getGuild(C) : null, [C]), {
  ...
  let k = (0, m.P$)(w) ? b.intl.formatToPlainString(b.t.tZTx2E, {
      guildName: N.name
    }) : (0, m.Qm)(w) ? b.intl.formatToPlainString(b.t["1bSmxr"], {
      guildName: N.name
