...
function G(e) {
  let {
    savedMessageKeys: t,
    closePopout: n
  } = e, a = i.useRef(null), l = (0, _.Z)("for-later", a), [o, s] = i.useState(new Date);
  return i.useEffect(() => {
...
function H(e) {
  let {
    ...
    var r;
    await (0, S.fC)(t, o), e.shiftKey || n(), N.default.track(k.rMx.FOR_LATER_SAVED_MESSAGE_JUMP, {
  ...
  }, [n, t, o]), c = (0, m.e7)([E.Z], () => !!((null == o ? void 0 : o.type) === k.d4z.UNKNOWN || (null == o ? void 0 : o.isPrivate())) || E.Z.can(k.Plq.VIEW_CHANNEL, o));
...
function V(e) {
  let {
    ...
    closePopout: n,
    throttledNow: i
  } = e, a = (0, m.e7)([I.Z], () => I.Z.getSavedMessage(t.channelId, t.messageId));
