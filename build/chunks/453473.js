...
function z(e) {
  let {
    ...
    closePopout: n,
    throttledNow: s
  } = e, i = (0, I.gr)(t), o = l.useCallback(async e => {
    var r;
    await (0, I.fC)(t, i), e.shiftKey || n(), O.default.track(A.rMx.FOR_LATER_SAVED_MESSAGE_JUMP, {
...
function q(e) {
  let {
    ...
    closePopout: n,
    throttledNow: l
  } = e, s = (0, p.e7)([P.Z], () => P.Z.getSavedMessage(t.channelId, t.messageId));
