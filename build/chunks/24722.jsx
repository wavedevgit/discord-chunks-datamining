...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk37148 = require("./37148.js"),
  Chunk794433 = require("./794433.js"),
  Chunk185413 = require("./185413.js"),
  Chunk971628 = require("./971628.js"),
...
function w(e) {
  ...
  return <l.I onClose={r} transitionState={t}>{<u.x title={k.intl.string(k.t["ZYOK4+"])} subtitle={null != S ? k.intl.format(k.t["qP+nub"], {
        numMembers: O.ey,
        roleName: S.name
      }) : k.intl.format(k.t["3OxP4u"], {
        numMembers: O.ey
      })} alignCenter={true} titleTextVariant={"heading-xl/semibold"} />}{<s.f><b.t listClassName={h.list} pendingAdditions={E} query={M} onQueryChange={P} onClickRow={U} onRemovePendingAddition={A} roles={[]} members={N} placeholderText={k.intl.string(k.t.vMiCaW)} renderEmptyText={e => k.intl.format(k.t.eq8a8f, {
          query: e
        })} /></s.f>}{<o.G actions={I} />}</l.I>
}