...
function c() {
  let e = (0, o.cj)([s.Z], () => {
    ...
    c = r.useMemo(() => e.filter(e => {
      var t;
      return (null == e.integration_types || e.integration_types.includes(i.Y.GUILD_INSTALL)) && (null == e.contexts || (null === (t = e.contexts) || void 0 === t ? void 0 : t.includes(l.D.GUILD)))
    }), [e]),
    ...
    p = r.useMemo(() => t.startsWith("/") ? u.filter(e => e.type === l.yU.CHAT) : u, [t, u]),
