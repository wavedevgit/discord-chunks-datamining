...
function x(e) {
  ...
  let n = e.item.originalItem,
    o = a.useCallback(() => {
      var e;
      return (0, m.yE)(null != (e = n.flags) ? e : 0, v.J0y.IS_CLIP) ? (0, i.jsxs)(s.DY, {
  ...
  return null == c ? null : (c.searchParams.append("format", "webp"), (0, g.lV)(b(I({}, e), {
    alt: n.description,
    poster: c.toString(),
    fileSize: n.size,
    fileName: (0, p.Z)(n),
...
function w(e) {
  let {
    message: t,
    item: n
  } = e, i = n.originalItem, o = a.useCallback((e, n, a) => {
    var o;
  ...
  }, [t, i.duration_secs]), s = a.useCallback(e => {
    var n;
