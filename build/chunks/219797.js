...
function O(e) {
  ...
  return null == c ? null : (c.searchParams.append("format", "webp"), (0, g.lV)(y(x({}, e), {
    alt: n.description,
    poster: c.toString(),
    fileSize: n.size,
    fileName: (0, h.Z)(n),
...
function j(e) {
  let {
    ...
    var a;
    (0, u.tb)(t.id, null !== (a = r.duration_secs) && void 0 !== a ? a : null, n, t.author.id)
  }, [t, r.duration_secs]), o = i.useCallback((e, n) => {
    var i;
    (0, u.EW)(t.id, null !== (i = r.duration_secs) && void 0 !== i ? i : null, e, t.author.id, n)
...
function T(e) {
  ...
  let {
    attachment: n,
    message: i
  } = e, o = i.channel_id, l = (0, a.e7)([d.Z], () => {
    var e;
    return null === (e = d.Z.getBasicChannel(o)) || void 0 === e ? void 0 : e.guild_id
  }), {
    clip_created_at: s,
    clip_participants: u,
    title: p,
