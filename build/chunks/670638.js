...
function q(e) {
  let {
    ...
    return s
  }(e, ["children", "onOpen", "onClose", "preventIdle", "quest", "questContent", "questContentPosition"]), x = (0, m.O5)(), g = s.useRef(null), h = s.useCallback(() => {
    x({
      questId: l.id,
      questContent: u,
