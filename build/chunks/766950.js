...
function L(e) {
  let {
    ...
    canApply: l,
    isApplying: a
  } = e, i = (0, h.m)(k.p9.TIER_2), s = (0, r.jsx)(d.zxk, {
    variant: "secondary",
    size: "md",
    onClick: n,
    icon: d.T$Z,
...
function I(e) {
  ...
  let {
    ...
    onError: e => {}
  }), Q = z !== (null == H || null == (k = H.displayNameStyles) ? void 0 : k.fontId) || X !== (null == H || null == (w = H.displayNameStyles) ? void 0 : w.effectId) || !(0, c.E)(V, null != (B = null == H || null == (I = H.displayNameStyles) ? void 0 : I.colors) ? B : []);
      ...
      children: (0, r.jsxs)(d.Y0X, {
        ...
        children: [(0, r.jsxs)(d.hzk, {
          ...
          children: [(0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)(d.xBx, {
              ...
              setSelectedEffectId: e => {
                e === a.m.GRADIENT && 1 === V.length ? q(V.concat(E.p6O)) : (0 === V.length || (0, c.E)(V, F[X].defaultColors)) && q(F[e].defaultColors), K(e)
              },
              className: D.selectionSubSection,
              configs: F
            }), (0, r.jsx)(O.Z, {
          ...
          onApply: () => {
            if (Q) {
              let e = V;
              X === a.m.SOLID && V.length > 0 && V[0] === F[X].defaultColors[0] && (e = []), J({
                fontId: z,
                effectId: X,
                colors: e
          ...
          onSurpriseMe: () => {
            let e = (0, S.aY)();
            U(e.fontId), K(e.effectId), q(e.colors), x.default.track(E.rMx.DISPLAY_NAME_STYLES_SURPRISE_ME)
          },
          onClose: G,
          canApply: Q,
          analyticsLocations: W
