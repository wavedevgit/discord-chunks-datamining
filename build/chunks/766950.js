...
function T(e) {
  let {
    ...
    canApply: l,
    isApplying: i
  } = e, s = (0, m.m)(v.p9.TIER_2), a = (0, o.jsx)(c.zxk, {
    variant: "secondary",
    size: "md",
    onClick: n,
    icon: c.T$Z,
    ...
    children: [a, (0, o.jsx)(c.ua7, {
      text: P.intl.string(_.default.cVTpnp),
      shouldShow: !l,
      children: e => {
        var n, r;
        return (0, o.jsx)(c.zxk, (n = k({}, e), r = r = {
          onClick: t,
          disabled: !l || i,
          loading: i,
...
function w(e) {
  ...
  let {
    ...
    guild: L,
    onClose: B
  } = e, Z = (0, s.e7)([g.default], () => g.default.getCurrentUser()), G = (0, C.J)(), [H, M] = r.useState(null != (E = null == Z || null == (t = Z.displayNameStyles) ? void 0 : t.fontId) ? E : i.C.DEFAULT), [F, z] = r.useState(null != (D = null == Z || null == (n = Z.displayNameStyles) ? void 0 : n.effectId) ? D : l.m.SOLID), [U, X] = r.useState((null == Z || null == (p = Z.displayNameStyles) ? void 0 : p.colors) != null && (null == Z || null == (f = Z.displayNameStyles) ? void 0 : f.colors.length) > 0 ? null == Z || null == (m = Z.displayNameStyles) ? void 0 : m.colors : G[F].defaultColors), {
    analyticsLocations: Y
  } = (0, u.ZP)(A, d.Z.EDIT_DISPLAY_NAME_STYLES_MODAL), {
  ...
  return (r.useEffect(() => {}, [Y]), null == Z) ? null : (0, o.jsx)(u.Gt, {
    value: Y,
    children: (0, o.jsxs)(c.Y0X, {
      ...
      children: [(0, o.jsxs)(c.hzk, {
        ...
        onApply: () => {
          if (V) {
            let e = U;
            F === l.m.SOLID && U.length > 0 && U[0] === G[F].defaultColors[0] && (e = []), q({
              fontId: H,
              effectId: F,
              colors: e
            })
