...
function A(e) {
  ...
  let {
    ...
    guild: Z,
    onClose: Y
  } = e, G = (0, s.e7)([b.default], () => b.default.getCurrentUser()), H = null != (w = null == G || null == (t = G.displayNameStyles) ? void 0 : t.colors) ? w : [], z = (0, v.J)(), [F, U] = o.useState(null != (A = null == G || null == (n = G.displayNameStyles) ? void 0 : n.fontId) ? A : i.C.DEFAULT), [X, K] = o.useState(null != (L = null == G || null == (m = G.displayNameStyles) ? void 0 : m.effectId) ? L : a.m.SOLID), [q, V] = o.useState(H.length > 0 && X !== a.m.GRADIENT ? H[0] : z[X].defaultColors[0]), [W, $] = o.useState(H.length > 0 && X === a.m.GRADIENT ? H : z[a.m.GRADIENT].defaultColors);
  (0, f.Z)({
  ...
  let {
    ...
    onError: e => {}
  }), et = X === a.m.GRADIENT ? W : [q], en = F !== (null == G || null == (g = G.displayNameStyles) ? void 0 : g.fontId) || X !== (null == G || null == (h = G.displayNameStyles) ? void 0 : h.effectId) || !(0, c.E)(et, null != (R = null == G || null == (E = G.displayNameStyles) ? void 0 : E.colors) ? R : []);
