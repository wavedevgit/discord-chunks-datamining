...
function T(e) {
  let {
    ...
    canApply: l,
    isApplying: i
  } = e, a = (0, m.m)(S.p9.TIER_2), s = (0, r.jsx)(c.zxk, {
    variant: "secondary",
    size: "md",
    onClick: n,
    icon: c.T$Z,
...
function w(e) {
  ...
  let {
    ...
    guild: A,
    onClose: L
  } = e, B = (0, a.e7)([g.default], () => g.default.getCurrentUser()), Z = (0, C.J)(), [G, H] = o.useState(null != (k = null == B || null == (t = B.displayNameStyles) ? void 0 : t.fontId) ? k : i.C.DEFAULT), [M, F] = o.useState(null != (w = null == B || null == (n = B.displayNameStyles) ? void 0 : n.effectId) ? w : l.m.SOLID), [z, U] = o.useState(null != (E = null == B || null == (p = B.displayNameStyles) ? void 0 : p.colors) ? E : Z[M].defaultColors), {
    analyticsLocations: X
  } = (0, u.ZP)(I, d.Z.EDIT_DISPLAY_NAME_STYLES_MODAL), {
    handleApplyDisplayNameStyles: Y,
    isApplying: q
  } = (0, b.Z)({
    onSuccess: () => {
      L()
    ...
    children: (0, r.jsxs)(c.Y0X, {
      ...
      children: [(0, r.jsxs)(c.hzk, {
        ...
        onApply: () => {
          if (K) {
            let e = z;
            M === l.m.SOLID && z.length > 0 && z[0] === Z[M].defaultColors[0] && (e = []), Y({
              fontId: G,
              effectId: M,
              colors: e
            })
