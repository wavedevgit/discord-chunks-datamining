...
function I(e) {
  let {
    ...
    selectedChannelId: s,
    className: a
  } = e, h = (0, g.BT)(t), x = t.canHaveRaidActivityAlerts(), [b, j] = i.useState(x), N = (0, o.e7)([f.Z], () => f.Z.getChannel(s), [s]), _ = (0, u.ZP)(N), I = async () => {
    j(!b);
    try {
      var e;
      await (0, m.f6)(t, !x);
...
function E(e) {
  ...
  let {
    ...
    className: m
  } = e, g = null != (t = n.safetyAlertsChannelId) ? t : null, h = (0, o.Wu)([x.ZP, N.default, j.Z, b.Z], () => {
...
function S(e) {
  ...
  let {
    guild: s
  } = e, [l, a] = i.useState(!1), o = null != (t = s.safetyAlertsChannelId) ? t : null, [c, d] = i.useState(null != o ? o : null != (n = null == s ? void 0 : s.publicUpdatesChannelId) ? n : null);
  return (0, r.jsx)(h.Z, {
...
function T(e) {
  ...
  let {
    guild: s
  } = e, l = null != (t = s.safetyAlertsChannelId) ? t : null, [a, o] = i.useState(null != l ? l : null != (n = null == s ? void 0 : s.publicUpdatesChannelId) ? n : null);
