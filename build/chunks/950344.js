...
function h(e) {
  ...
  } = (0, s.Ay)(null != (t = (0, a.UC)()) ? t : []), j = r.useRef(false);
  r.useEffect(() => {
    m && null != h && null != y && !j.current && (j.current = true, o.default.track(p.HAw.ROLE_SUBSCRIPTION_LISTING_UPSELL_PAGE_VIEWED, function(e) {
