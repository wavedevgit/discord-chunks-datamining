...
function p(e) {
  ...
  } = e, E = (0, r.e7)([a.default], () => a.default.getCurrentUser()), b = (0, r.e7)([s.ZP], () => s.ZP.getPremiumTypeSubscription()), {
    fractionalState: y
  } = (0, i.Z)({
    forceFetch: !1
  }), O = (0, r.e7)([c.Z], () => c.Z.getPremiumTypeOverride());
  if (n) return {
    buttonText: null != m ? m : _.intl.string(_.t["Gd/XHB"])
  };
  if (p) return {
    buttonText: null != m ? m : _.intl.string(_.t.PEjaCw)
  };
  ...
  if (!(null != b && b.status !== f.O0b.ACCOUNT_HOLD && !(0, o.Q0)(b.planId) && !T && void 0 === O || A)) return {
    buttonText: null != m ? m : v
  };
  {
    var N, C;
    let e = h({
