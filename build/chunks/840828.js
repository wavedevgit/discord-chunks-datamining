...
function p(e) {
  ...
  } = e, E = (0, r.e7)([o.default], () => o.default.getCurrentUser()), b = (0, r.e7)([s.ZP], () => s.ZP.getPremiumTypeSubscription()), {
    fractionalState: y
  } = (0, i.Z)({
    forceFetch: !1
  ...
  if (!(null != b && b.status !== f.O0b.ACCOUNT_HOLD && !(0, a.Q0)(b.planId) && !T && void 0 === v || A)) return {
    buttonText: null != m ? m : O
  };
  {
    var N, C;
    let e = h({
