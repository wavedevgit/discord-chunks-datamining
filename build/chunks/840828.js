...
function p(e) {
  ...
  if (n) return {
    buttonText: null != m ? m : _.NW.string(_.t["Gd/XHB"])
  };
  if (p) return {
    buttonText: null != m ? m : _.NW.string(_.t.PEjaCw)
  };
  ...
  if (!(null != b && b.status !== f.O0b.ACCOUNT_HOLD && !(0, o.Q0)(b.planId) && !T && void 0 === v || N)) return {
