/** Chunk was on web.js **/
/** chunk id: 61090, original params: e,t,n (module,exports,re quire) **/
"use strict";
var r;
...
require.d(exports, {
  A: () => l
}), require("./734808.js"), require("./667532.js"), require("./321073.js");
let a = null != (r = globalThis.__getTotalRequireTime) ? r : () => 0,
  s = "u" > typeof performance;
class o {
  get isTracing() {
    return !!s && !!this.isTracing_ && (!(Date.now() > this.endTime_) || (this.isTracing_ = false, false))
  }
  get endTime() {
  ...
  markAt(e, t, n) {
    ...
    this.logs.splice(a, 0, {
      ...
      log: t,
      timestamp: n,
      prefix: null != (r = null == (i = this.logs[a]) ? true : i.prefix) ? r : ""
    })
  }
  addDetail(e, t) {
    this.isTracing && this.logs.push({
