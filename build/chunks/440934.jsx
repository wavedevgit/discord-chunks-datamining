...
function f(n) {
  ...
  return <form onSubmit={n => {
      n.preventDefault(), O()
    }}><r.I transitionState={f} onClose={t}>{<o.x leading={(0, i.jsx)(l.qEK, {
          src: j,
          size: l.EFr.SIZE_24,
          "aria-label": x,
          className: b.applicationIcon
        })} title={e} titleTextVariant={"heading-xl/semibold"} />}{<s.f>{null != y && "" !== y ? <l.Wn messageType={l.QYI.ERROR} className={b.submissionWarning}>{y}</l.Wn> : null}{<l.Wn messageType={l.QYI.WARNING} className={b.submissionWarning}>{m.intl.format(m.t["dSTy//"], {
            applicationName: x
          })}</l.Wn>}{<l.hjN className={b.components}><c.Il modal={n} validators={I} validationErrors={v} setValidationErrors={E}>{(0, p.xX)(h)}</c.Il></l.hjN>}</s.f>}{<a.G actions={[{
          variant: "secondary",
          ...
          onClick: O
        }]} actionsFullWidth={true} />}</r.I></form>
}

function h(n) {
  (0, l.h7j)(e => <f{...function(n) {
