...
class _ extends i.Z {
  constructor(...e) {
    super(...e), u(this, "currentInterval_", null), u(this, "currentSubgameInfo_", null), u(this, "actions", {
      ...
      let t = (0, l.I8)(e);
      (0, l.yA)(this.currentSubgameInfo_, t) && (this.currentSubgameInfo_ = t, r.Z.dispatch({
      ...
      t && !e.added.some(e => e.distributor === c.GQo.ROBLOX) && r.Z.dispatch({
        type: "ROBLOX_SUBGAME_UPDATE",
        subgameInfo: this.currentSubgameInfo_
      }), t || null == this.currentInterval_ ? t && null == this.currentInterval_ && (o.ZP.checkForRobloxSubgameUpdate(), this.currentInterval_ = setInterval(() => {
