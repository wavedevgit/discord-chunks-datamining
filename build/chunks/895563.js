...
function h(e) {
  ...
  return 0 === b.length ? (0, r.jsx)(o.sNh, {
    id: "favorite-channel",
    label: p(e, !1),
    action: () => h(null)
  }) : (0, r.jsxs)(o.sNh, {
    ...
    children: [n && (0, r.jsx)(o.kSQ, {
      ...
      children: b.map(e => (0, r.jsx)(o.sNh, {
...
function g(e) {
  ...
  return __OVERLAY__ || !t ? null : (0, r.jsx)(o.sNh, {
    id: "favorite-channel",
    label: p(e, !0),
    color: "danger",
    action: () => e.type === O.d4z.GUILD_CATEGORY ? (0, o.ZDy)(async () => {
      let {
        default: t
