/** Chunk was on web.js **/
/** chunk id: 528352, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  CV: () => a,
  E9: () => y,
...
let a = {
  ...
  u = `(?:${(0,Chunk476858.uJ)(o)}|[0-9]+|[0-9]+[\\.,][0-9]+|halve?|half|paar)`;

function d(e) {
  let t = e.toLowerCase();
  return true !== o[t] ? o[t] : "paar" === t ? 2 : "half" === t || t.match(/halve?/) ? .5 : parseFloat(t.replace(",", "."))
}
let f = `(?:${(0,Chunk476858.uJ)(l)}|[0-9]{1,2}(?:ste|de)?)`;
...
let m = `(${u})\\s{0,5}(${(0,Chunk476858.uJ)(c)})\\s{0,5}`,
  g = RegExp(m, "i"),
