...
let c = null,
  ...
  h = /^:([^\s:]+?(?:::skin-tone-\d)?):/,
  m = n(523558),
  g = /^(>:\(|>:\-\(|>=\(|>=\-\(|:"\)|:\-"\)|="\)|=\-"\)|<\/3|<\\3|:\-\\|:\-\/|=\-\\|=\-\/|:'\(|:'\-\(|:,\(|:,\-\(|='\(|='\-\(|=,\(|=,\-\(|:\(|:\-\(|=\(|=\-\(|<3|♡|\]:\(|\]:\-\(|\]=\(|\]=\-\(|o:\)|O:\)|o:\-\)|O:\-\)|0:\)|0:\-\)|o=\)|O=\)|o=\-\)|O=\-\)|0=\)|0=\-\)|:'D|:'\-D|:,D|:,\-D|='D|='\-D|=,D|=,\-D|:\*|:\-\*|=\*|=\-\*|x\-\)|X\-\)|:\||:\-\||=\||=\-\||:o|:\-o|:O|:\-O|=o|=\-o|=O|=\-O|:@|:\-@|=@|=\-@|:D|:\-D|=D|=\-D|:'\)|:'\-\)|:,\)|:,\-\)|='\)|='\-\)|=,\)|=,\-\)|:\)|:\-\)|=\)|=\-\)|\]:\)|\]:\-\)|\]=\)|\]=\-\)|:,'\(|:,'\-\(|;\(|;\-\(|=,'\(|=,'\-\(|:P|:\-P|=P|=\-P|8\-\)|B\-\)|,:\(|,:\-\(|,=\(|,=\-\(|,:\)|,:\-\)|,=\)|,=\-\)|:s|:\-S|:z|:\-Z|:\$|:\-\$|=s|=\-S|=z|=\-Z|=\$|=\-\$|;\)|;\-\))/,
  E = /[\u200d\ud800-\udfff\u0300-\u036f\ufe20-\ufe2f\u20d0-\u20ff\ufe0e\ufe0f\u270b\u2b50\u2728\u26a1\u26c5\u26c4\u2614\u2615\u26bd\u26be\u26f3\u26f5\u2693\u26fd\u26f2\u26fa\u26ea\u231a\u23f0\u231b\u23f3\u26ce\u2648\u2649\u264a\u264b\u264c\u264d\u264e\u264f\u2650\u2651\u2652\u2653\u270a\u274c\u2b55\u26d4\u2757\u2755\u2753\u2754\u2705\u274e\u267f\u23e9\u23ea\u23eb\u23ec\u2795\u2796\u2797\u27b0\u27bf\u26aa\u26ab\u25fe\u25fd\u2b1b\u2b1c\u26a7]/,
...
function A(e) {
  ...
  if (null != t) return t;
  let n = new N(e);
  return n.setSpriteSheetIndex(n.hasDiversity ? d++ : f++), u.set(e, n), n
}
...
function x(e) {
  ...
  if (null == t) {
    let n = y[e];
    t = a.ZP.filterUnsupportedEmojis(b.slice(n[0], n[1])).map(A), L.set(e, t)
  }
  return t
}
...
function H(e) {
  ...
  return null !== (n = null === (t = I(e)) || void 0 === t ? void 0 : t.surrogates) && void 0 !== n ? n : r
}
...
function Y(e) {
  return D(W(_.reduce((e, t) => e.replace(t, ""), e), !1))
}
let K = {
  ...
  convertShortcutToName: function e(e) {
    let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1],
      ...
      r = n;
    return Object.prototype.hasOwnProperty.call(m, e) && (r = m[e]), t ? ":".concat(r, ":") : r
  },
  convertSurrogateToBase: Y,
  forEach: e => {
    for (let t of b) t.hasDiversityParent || t.hasMultiDiversityParent || e(A(t))
  },
  numDiversitySprites: d,
  numNonDiversitySprites: f,
  EMOJI_NAME_RE: p,
  EMOJI_NAME_AND_DIVERSITY_RE: h,
  EMOJI_SHORTCUT_RE: g,
  hasSurrogates: function e(e) {
    return i().toArray(e).some(e => null != S[e])
  }
}