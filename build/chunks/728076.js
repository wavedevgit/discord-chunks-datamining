...
function b(e, t, n, b) {
  ...
  let Q = r.useCallback(() => {
      let e = !0,
        t = {};
      return 0 === x.trim().length && (e = !1, t.question = f.intl.string(f.t.gPX3oK)), y.filter(e => (0, u.cS)(e, P)).length < d.gY && (e = !1, t["answer-".concat(y[0].localCreationAnswerId)] = f.intl.string(f.t.fYvzER)), y.forEach(n => {
