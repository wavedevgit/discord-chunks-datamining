...
function ea(e) {
  ...
  switch (o) {
    case N.aib.GUILD:
      t = E.ZP.queryGuildUsers(D(P({}, s), {
        guildId: r
      }));
      break;
    case N.aib.CHANNEL:
      t = E.ZP.queryChannelUsers(D(P({}, s), {
        channelId: r
      }));
      break;
    case N.aib.DMS:
      ...
      if (null != l && l.length > 0) {
        ...
        null != e && l.push(e), t = E.ZP.queryUsers(D(P({}, s), {
          users: l,
          boosters: (0, E.Cq)(c.h8.USER)
        }))
      } else t = E.ZP.queryAllUsers(D(P({}, s), {
        boosters: (0, E.Cq)(c.h8.USER)
      }));
      break;
    default:
