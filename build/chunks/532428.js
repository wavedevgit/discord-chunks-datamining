...
function ea(e) {
  ...
  switch (n.type) {
    ...
    case C.aib.THREAD:
      ...
      a = g.ZP.queryGuildUsers(D(P({}, o), {
        guildId: n.guildId
      }));
      break;
    case C.aib.CHANNEL:
      a = g.ZP.queryChannelUsers(D(P({}, o), {
    ...
    case C.aib.DMS:
      ...
      if (null != s && s.length > 0) {
        ...
        null != e && s.push(e), a = g.ZP.queryUsers(D(P({}, o), {
          users: s,
          boosters: (0, g.Cq)(c.h8.USER)
        }))
      } else a = g.ZP.queryAllUsers(D(P({}, o), {
        boosters: (0, g.Cq)(c.h8.USER)
      }));
      break;
    default:
