...
function er(e) {
  ...
  switch (r.type) {
    case S.aib.GUILD:
      t = g.ZP.queryGuildUsers(P(C({}, o), {
        guildId: r.guildId
      }));
      break;
    case S.aib.CHANNEL:
      t = g.ZP.queryChannelUsers(P(C({}, o), {
    ...
    case S.aib.DMS:
      ...
      if (null != s && s.length > 0) {
        ...
        null != e && s.push(e), t = g.ZP.queryUsers(P(C({}, o), {
          users: s,
          boosters: (0, g.Cq)(c.h8.USER)
        }))
      } else t = g.ZP.queryAllUsers(P(C({}, o), {
        boosters: (0, g.Cq)(c.h8.USER)
      }));
      break;
    default:
...
function ep(e) {
  ...
  for (let r of Object.keys(ed)) {
    if (n.length >= t) break;
    let a = ed[r].key;
    ef(r) && null != a && i()(e.toLowerCase(), a) && n.push({
      token: r,
      text: a
    })
  }
