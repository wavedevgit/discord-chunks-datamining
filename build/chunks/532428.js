...
function k() {
  return {
    ...
    [C.intl.string(C.t.cu86KC)]: () => j("day", false),
...
function W(e) {
  ...
  return null != (t = T.Xyh.test(n) ? n : r(n === T.ME ? m.default.getCurrentUser() : null != e.getMatch(4) ? m.default.findByTag(e.getMatch(4)) : m.default.findByTag(e.getMatch(2), e.getMatch(3)))) && (e.setData("userId", t), true)
}

function K(e, t) {
  let n, r, i = e.getFullMatch().trim().toLowerCase(),
    a = k()[i];
  return null != a ? [n, r] = a() : R().has(i) ? [n, r] = M(i, "MMMM", "month") : D().has(i) ? [n, r] = M(i, "dddd", "day") : x().has(i) ? [n, r] = M(i, "YYYY", "year") : [n, r] = M(i, T.b2L, "day"), !!(n.isValid() && r.isValid()) && ("before" === t ? (r = n, n = null) : "after" === t && (n = r, r = null), e.setData("start", n), e.setData("end", r), true)
}
...
function Q(e, t) {
  let n = e.getMatch(1);
  return T.Xyh.test(n) ? (e.setData("channelIds", [n]), true) : (n.startsWith('"') && n.endsWith('"') && (n = n.substring(1, n.length - 1).replaceAll(/\\(.)/g, (e, t) => t)), (0, v.b7)(t)) ? z(e, n, t.guildId) : t.type === T.aib.DMS && !h.Z.hidePersonalInformation && q(e, n)
}
...
function er(e) {
  ...
  switch (n.type) {
    ...
    case T.aib.THREAD:
      ...
      o = g.ZP.queryGuildUsers(w(N({}, a), {
        guildId: n.guildId
      }));
      break;
    case T.aib.CHANNEL:
      o = g.ZP.queryChannelUsers(w(N({}, a), {
    ...
    case T.aib.DMS:
      ...
      if (null != s && s.length > 0) {
        ...
        null != e && s.push(e), o = g.ZP.queryUsers(w(N({}, a), {
          users: s,
          boosters: (0, g.Cq)(c.h8.USER)
        }))
      } else o = g.ZP.queryAllUsers(w(N({}, a), {
        boosters: (0, g.Cq)(c.h8.USER)
      }));
      break;
    default:
...
function es(e) {
  ...
  return ((t = t.trim()).startsWith('"') && t.endsWith('"') ? t = t.substring(1, t.length - 1).replaceAll(/\\(.)/g, (e, t) => t) : t.startsWith('"') && (t = t.substring(1).replaceAll(/\\(.)/g, (e, t) => t)), "#" === t[0] && (t = t.substring(1)), (0, v.b7)(n)) ? eo(t, n.guildId, r) : n.type !== T.aib.DMS || h.Z.hidePersonalInformation ? [] : ea(t, r, true)
}
...
function eu(e) {
  let t = [C.intl.string(C.t.tPZo4p), C.intl.string(C.t.JL7sRS), C.intl.string(C.t.WjkIKU)],
    n = [C.intl.string(C.t.TNLcpx), C.intl.string(C.t.XM9XGP), C.intl.string(C.t.ZNR2fi), C.intl.string(C.t["AV/v6i"]), C.intl.string(C.t["20uQR3"]), C.intl.string(C.t.F8Wf0e), C.intl.string(C.t.L4lxyE), C.intl.string(C.t.PJgX2h), C.intl.string(C.t.nrpA5E)];
  return {
    [T.dCx.FILTER_FROM]: {
