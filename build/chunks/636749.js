...
function v(e) {
  let {
    ...
    senderId: s,
    safetyWarning: b
  } = e, v = o.useMemo(() => (null == b ? void 0 : b.feedback_type) === u.ny.UPVOTE, [b]), h = o.useMemo(() => (null == b ? void 0 : b.feedback_type) === u.ny.DOWNVOTE, [b]), k = o.useCallback((e, o) => {
    (null == b ? void 0 : b.feedback_type) !== e && ((0, d.Ms)(n, t, e), (0, i.showToast)((0, i.createToast)(m.intl.string(m.t["gd/Yqq"]), i.ToastType.CUSTOM, {
      component: (0, a.jsx)(g, {})
    })), (0, _.qc)({
      channelId: n,
      warningId: t,
  ...
  return (0, a.jsxs)("div", {
    ...
    children: [(0, a.jsx)(i.Text, {
      ...
      children: [(0, a.jsx)(i.P3F, {
        className: c()([x.buttonsBackground, v ? x.buttonsBackgroundActive : x.buttonsBackgroundInactive, {
          [x.disabled]: v
        }]),
        ...
        className: c()([x.buttonsBackground, h ? x.buttonsBackgroundActive : x.buttonsBackgroundInactive, {
          [x.disabled]: h
        }]),
