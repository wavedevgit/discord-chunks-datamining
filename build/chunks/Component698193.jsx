...
function H(n) {
  let {
    ...
    guild: e,
    onSelect: s
  } = n, c = t.isGuildStageVoice(), d = (0, l.bG)([y.A], () => c ? y.A.getStageInstanceByChannel(t.id) : true, [c, t.id]), A = (0, m.A)(t), v = (0, p.Qs)(t.id), C = (0, x.A)(null == v ? true : v.id, e, t), V = (0, T.A)(t, d), O = (0, b.m)(t), X = (0, b.y)(t), N = (0, g.A)(t), S = (0, h.A)(t), P = (0, j.A)(t), D = (0, G.A)(t), I = (0, _.A)(t), B = (0, E.A)(t), Z = (0, M.A)(t, e), H = (0, u.A)({
    id: t.id,
