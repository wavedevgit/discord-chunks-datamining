...
let Q = e => {
  let {
    ...
    reportId: et,
    textInput: en
  } = e, er = q(t, "checkbox"), ea = q(t, "text_line_resource"), ei = V(t, "external_link"), eo = V(t, "free_text"), el = V(t, "dropdown"), es = q(t, "text"), ec = i.s.REPORT_TO_MOD.has(n.name), [ed, eu] = a.useState(!1), [em, ep] = a.useState(!1), [e_, eg] = a.useState(""), [eb, ex] = a.useState(() => ({})), [eh, ef] = a.useState(() => ({})), ev = a.useMemo(() => "message" === n.name ? n.record.channel_id : void 0, [n]), ej = a.useCallback(e => ({
    nodeRef: t.id,
    destination: e,
  ...
  }), [t, eo, el, er, eb, eh]), eC = a.useMemo(() => (0, c.VP)(eo, el, er, eh, eb), [eo, el, er, eh, eb]), ey = function(e, t) {
  ...
  let eI = e => {
      e === z.evJ.INVALID_FORM_BODY ? eg(G.intl.string(G.t.VjAAuL)) : ec ? eg(G.intl.string(W.default.psKFdH)) : eg(G.intl.string(G.t.h6D8V1))
    },
    eT = () => {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)(o.xBx, {
      ...
      children: [null != ea && (0, r.jsx)(B.Z, {
        ...
        element: es
      }), null != q(t, "message_preview") && ("message" === n.name || "first_dm" === n.name || "report_to_mod_message" === n.name) && (0, r.jsx)(N.Z, {
        message: n.record
        ...
        children: [eS && (0, r.jsx)(T.Z, {
          ...
          reportId: et,
          reportType: n
        }), !eS && null != q(t, "mute_users") && ("message" === n.name || "first_dm" === n.name || "user" === n.name || "report_to_mod_message" === n.name) && (0, r.jsx)(k.Z, {
          user: "user" === n.name ? n.record : n.record.author,
          channelId: ev,
          reportId: et
          ...
          message: n.record,
          reportId: et
        }), null != q(t, "leave_guild") && "guild" === n.name && (0, r.jsx)(S.Z, {
          guildId: n.record.id,
          reportId: et
        ...
        reportType: n,
        reportSubType: Q
      }), null != q(t, "channel_preview") && "stage_channel" === n.name && (0, r.jsx)(R.Z, {
        stageInstance: n.record
      }), null != q(t, "guild_scheduled_event_preview") && "guild_scheduled_event" === n.name && (0, r.jsx)(O.Z, {
        event: n.record
        ...
        state: eb
      }), X.includes(n.name) && null != el && el.length > 0 && (0, r.jsx)(x.Z, {
        elements: el,
        onChange: ey,
        state: eh
