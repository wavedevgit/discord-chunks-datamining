...
let Q = e => {
  let {
    ...
    reportId: et,
    textInput: en
  } = e, er = H(t, "checkbox"), el = H(t, "text_line_resource"), ei = V(t, "external_link"), ea = V(t, "free_text"), es = V(t, "dropdown"), eo = H(t, "text"), ec = i.s.REPORT_TO_MOD.has(n.name), [ed, eu] = l.useState(!1), [em, ep] = l.useState(!1), [eg, ex] = l.useState(""), [e_, eb] = l.useState(() => ({})), [eh, ef] = l.useState(() => ({})), ev = l.useMemo(() => "message" === n.name ? n.record.channel_id : void 0, [n]), ej = l.useCallback(e => ({
    nodeRef: t.id,
    destination: e,
    textInput: null != ea || null != es ? eh : void 0,
    multiSelect: null != er ? {
      name: er.name,
      state: e_
    } : void 0
