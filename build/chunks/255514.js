...
let q = e => {
  let {
    ...
    reportId: J,
    textInput: $
  } = e, ee = F(t, "checkbox"), et = F(t, "text_line_resource"), en = X(t, "external_link"), er = X(t, "free_text"), el = X(t, "dropdown"), ei = F(t, "text"), [ea, eo] = l.useState(!1), [es, ec] = l.useState(!1), [ed, eu] = l.useState(""), [em, ex] = l.useState(() => ({})), [ep, ef] = l.useState(() => ({})), [eb, eh] = l.useState((0, s.VP)(er, el, ee, $, Q)), e_ = l.useMemo(() => "message" === n.name ? n.record.channel_id : void 0, [n]), eg = function(e, t) {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)(i.xBx, {
      ...
      children: [null != et && (0, r.jsx)(A.Z, {
        ...
        user: n.record
      }) : null, null != F(t, "guild_preview") && "guild" === n.name ? (0, r.jsx)(N.Z, {
        guild: n.record
      }) : null, function(e) {
        let {
          elements: t
        ...
        children: [eO && (0, r.jsx)(Z.Z, {
          ...
          channelId: e_,
          reportId: J
        }), null != F(t, "block_users") && ("message" === n.name || "first_dm" === n.name || "user" === n.name || "application" === n.name && null != n.record.bot) && (0, r.jsx)(u.Z, {
          ...
          channelId: e_,
          reportId: J
        }), null != F(t, "delete_message") && "message" === n.name && (0, r.jsx)(f.Z, {
          message: n.record,
          reportId: J
        }), null != F(t, "leave_guild") && "guild" === n.name && (0, r.jsx)(C.Z, {
          guildId: n.record.id,
          reportId: J
        }), null != F(t, "deauthorize_app") && "application" === n.name && (0, r.jsx)(p.Z, {
        ...
        event: n.record
      }), null != F(t, "guild_directory_entry_preview") && "guild_directory_entry" === n.name && (0, r.jsx)(v.Z, {
        entry: n.record
      }), null != F(t, "guild_discovery_preview") && "guild_discovery" === n.name && (0, r.jsx)(j.Z, {
        entry: n.record
      }), null != F(t, "app_preview") && "application" === n.name && (0, r.jsx)(d.Z, {
        entry: n.record
      }), null != ee && (0, r.jsx)(S.Z, {
        element: ee,
        onChange: (e, t) => {
        ...
        state: em
      }), ("user_urf" === n.name || "message_urf" === n.name) && null != el && el.length > 0 && (0, r.jsx)(b.Z, {
        elements: el,
        onChange: eg,
        state: ep
      }), ("user_urf" === n.name || "message_urf" === n.name) && null != er && er.length > 0 && (0, r.jsx)(g.Z, {
        elements: er,
        onChange: eg,
        state: ep
      }), (0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(x.Z, {
          node: t,
          onSelectChild: ev
        }), null != en && en.length > 0 ? (0, r.jsx)(_.Z, {
          elements: en
        }) : null]
      }), (0, r.jsx)(h.Z, {
        errorMessage: ed,
