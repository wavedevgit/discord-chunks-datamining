...
let K = e => {
  let {
    ...
    reportId: et,
    textInput: en
  } = e, er = q(t, "checkbox"), ea = q(t, "text_line_resource"), ei = X(t, "external_link"), eo = X(t, "free_text"), el = X(t, "dropdown"), es = q(t, "text"), ec = i.s.REPORT_TO_MOD.has(n.name), [ed, eu] = a.useState(!1), [em, ep] = a.useState(!1), [e_, eg] = a.useState(""), [eb, ex] = a.useState(() => ({})), [eh, ef] = a.useState(() => ({})), ev = a.useMemo(() => "message" === n.name ? n.record.channel_id : void 0, [n]), ej = a.useCallback(e => ({
    nodeRef: t.id,
    destination: e,
  ...
  let eO = e => {
      e === z.evJ.INVALID_FORM_BODY ? eg(G.intl.string(G.t.VjAAuL)) : ec ? eg(G.intl.string(F.default.psKFdH)) : eg(G.intl.string(G.t.h6D8V1))
    },
    eT = () => {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)(o.xBx, {
      ...
      children: [null != ea && (0, r.jsx)(B.Z, {
        ...
        user: n.record
      }) : null, null != q(t, "guild_preview") && "guild" === n.name ? (0, r.jsx)(C.Z, {
        guild: n.record
        ...
        state: eb
      }), V.includes(n.name) && null != el && el.length > 0 && (0, r.jsx)(x.Z, {
        elements: el,
        onChange: eC,
        state: eh
