...
let K = e => {
  let {
    ...
    reportId: et,
    textInput: en
  } = e, er = q(t, "checkbox"), ea = q(t, "text_line_resource"), ei = X(t, "external_link"), eo = X(t, "free_text"), el = X(t, "dropdown"), es = q(t, "text"), ec = i.s.REPORT_TO_MOD.has(n.name), [ed, eu] = a.useState(!1), [em, ep] = a.useState(!1), [e_, eb] = a.useState(""), [eg, ex] = a.useState(() => ({})), [eh, ef] = a.useState(() => ({})), ev = a.useMemo(() => "message" === n.name ? n.record.channel_id : void 0, [n]), ej = a.useCallback(e => ({
    nodeRef: t.id,
    destination: e,
  ...
  }), [t, eo, el, er, eg, eh]), eC = a.useMemo(() => (0, c.VP)(eo, el, er, eh, eg), [eo, el, er, eh, eg]), ey = function(e, t) {
    ...
    children: [(0, r.jsxs)(o.xBx, {
      ...
      children: [null != ea && (0, r.jsx)(B.Z, {
        ...
        children: [eN && (0, r.jsx)(T.Z, {
          ...
          channelId: ev,
          reportId: et
        }), null != q(t, "delete_message") && ("message" === n.name || "report_to_mod_message" === n.name) && (0, r.jsx)(g.Z, {
          message: n.record,
          reportId: et
