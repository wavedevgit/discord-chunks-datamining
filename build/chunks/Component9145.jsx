...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk757728 = require("./757728.js");
let H = Chunk884338.u8.SIZE_32,
  G = {
    [Chunk918559.MI.NO_CHAT]: Chunk757728.noChat,
    [Chunk918559.MI.RESIZABLE]: Chunk757728.resizable
  };
...
function B(e) {
  ...
  let eh = X.get(null != (l = null == z ? true : z.id) ? l : ""),
    ...
    ef = (0, s.Wu)([j.ZP], () => {
      var e;
      return null == K ? [] : Array.from(null != (e = null == eh ? true : eh.embeddedActivity.userIds) ? e : []).map(e => j.ZP.getMember(K.guild_id, e))
    }, [eh, K]),
    eg = i.useMemo(() => {
      let e = new Map;
      return ef.forEach(t => {
