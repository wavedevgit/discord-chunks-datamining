...
let v = "mweb_handoff_nonce",
  ...
  y = () => {
    ...
    let P = null == C ? <Chunk255367.Fragment>{Chunk388032.intl.string(Chunk388032.t.uJ1Jsb)}{<br />}{Chunk388032.intl.string(Chunk388032.t.GHVWAg)}</Chunk255367.Fragment> : S.has(C) ? Chunk388032.intl.string(Chunk388032.t.EPt55u) : O.has(C) ? Chunk388032.intl.string(Chunk388032.t.g87kTk) : true;
    return null != C && S.has(C) ? <div className={Chunk493148.errorContainer}><Chunk481060.Text color={"interactive-normal"} variant={"text-sm/semibold"}>{P}</Chunk481060.Text></div> : <div className={Chunk493148.container}>{<Chunk481060.Text variant={"text-sm/semibold"}>{P}</Chunk481060.Text>}{<Chunk755721.zx color={Chunk755721.zx.Colors.BRAND_INVERTED} onClick={() => {
        ...
        }}><Chunk481060.Text className={Chunk493148.buttonText} variant={"text-sm/semibold"}>{Chunk388032.intl.string(Chunk388032.t["NcC75+"])}</Chunk481060.Text></Chunk755721.zx>}</div>
  }