...
function c(e, t, n, a) {
  ...
  p && (y = new ResizeObserver(e => {
    let [o] = e;
    o && o.target === v && y && (y.unobserve(t), cancelAnimationFrame(b), b = requestAnimationFrame(() => {
      var e;
      null == (e = y) || e.observe(t)
    })), n()
  }), v && !h && y.observe(v), y.observe(t));
  let O = h ? u(e) : null;
  return h && function t() {
    let o = u(e);
    ...
    }), null == g || g(), null == (e = y) || e.disconnect(), y = null, h && cancelAnimationFrame(s)
  }
}