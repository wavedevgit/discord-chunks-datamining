...
async function F(e) {
        ...
        case c.jw.ROLE:
          if ("roleMention" === a.type) t = a.roleId;
            ...
            if ((0, x.BH)(a.text)) t = a.text.trim();
              ...
              let e = (0, f.K)(a.text, null == (m = M.guild) ? void 0 : m.id, M.channel.id, {
                allowUsers: !1
              });
        ...
        case c.jw.USER:
          if ("userMention" === a.type) t = a.userId;
            ...
            if ((0, x.BH)(a.text)) t = a.text.trim();
              ...
              let e = (0, f.K)(a.text, null == (E = M.guild) ? void 0 : E.id, M.channel.id, {
                allowRoles: !1
              });
  ...
  if (null != N.execute) return _.ZP.trackWithMetadata(k.rMx.APPLICATION_COMMAND_USED, {
    command_id: N.id,
  ...
  null != j && (J.target_id = j), null != M.autocomplete ? (0, C.GV)(N, M, J) : (s.Z.clearAll(M.channel.id, Q), Y({
