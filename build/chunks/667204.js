...
async function V(e) {
  ...
  null != j && ($.target_id = j), H && ($.client_supports_contextless_activity_launch = !0), null != M.autocomplete ? (0, C.GV)(N, M, $) : (s.Z.clearAll(M.channel.id, J), Y({
...
async function Q(e, t, n, r) {
  let i = e,
    a = (0, T.dg)(n),
    o = e => {
      null == r || r(a, e), m.yr(t, k.evJ.ENTITY_TOO_LARGE, j.intl.formatToPlainString(j.t.fxEKdX, {
        maxSize: (0, T.Ng)(a)
      }))
    },
    {
  ...
  return {
    totalSize: s,
    largestUploadedFileSize: l
  } = await q(i, !0), !i.some(e => e.error === k.evJ.ENTITY_TOO_LARGE) && !(s > N.zz) || (o(l), !1)
}