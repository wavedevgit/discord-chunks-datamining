...
function J(e) {
  ...
  let d = X(t),
    f = Q(n);
  return o = null == o ? M.FC : o, a = null == a ? M.rs : a, <i.Fragment>{<I.Z{...W(H({}, u), {
      alt: s,
      volume: o,
      autoMute: a,
      onVolumeChange: d,
...
function ee(e) {
  ...
  let a = X(t),
    s = Q(i);
  return n = null == n ? M.FC : n, <R.Z{...W(H({}, o), {
    onVolumeChange: a,
    onMute: s,
    volume: n
  })} />
...
function et(e) {
  let {
    ...
    return <d.VqE aria-label={Z.intl.string(Z.t.fSiQ3N)} className={F.mediaMosaicAltTextPopout} onKeyDown={e => {
        e.key === G.mR.Escape && setTimeout(() => {
          var e;
          return null == (e = b.current) ? true : e.focus()
        }, 0)
      }}>{<span className={F.mediaMosaicAltTextPopoutTitle}>{Z.intl.string(Z.t.fSiQ3N)}</span>}{<span className={F.mediaMosaicAltTextPopoutDescription}>{t}</span>}</d.VqE>
  }, b = i.createRef();
  return <div className={a()(F.imageContent, s)}>{<div className={a()(F.imageContainer, l)} style={_}>{<p.Z{...H({}, e)} />}{null != o && o()}</div>}{m && g && <div className={F.mediaMosaicAltTextContainer}><d.yRy targetElementRef={b} animation={d.yRy.Animation.FADE} renderPopout={() => (0, r.jsx)(E, {
          altText: t
        })}>{e => (0, r.jsx)(d.tEY, {
          offset: 4,
        ...
        })}</d.yRy></div>}{!m && g && <span className={F.altText}>{t}</span>}</div>
}
...
function er(e) {
  ...
  return <i.Fragment>{<T.Z{...H({}, n)} />}{null != t && t()}</i.Fragment>
}
...
let el = e => {
    ...
    return <b.G.Consumer>{e => e.disableInteractions ? null : (0, r.jsxs)("div", {
        onClick: n,
  ...
  ec = e => {
    ...
    return <b.G.Consumer>{e => e.disableInteractions ? null : (0, r.jsxs)(d.P3F, {
...
function eu(e) {
  ...
  return c ? null : <div className={a()(F.newMessagesBar, {
      [F.disableInteractions]: c
    })}>{<d.tEY offset={4}><button type={"button"} className={F.barButtonMain} onClick={s} aria-label={Z.intl.string(Z.t.z0Mkp6)} aria-describedby={o}><span id={o} className={F.span}>{t}</span></button></d.tEY>}{<d.tEY offset={4}><button type={"button"} onClick={l} className={F.barButtonAlt}>{Z.intl.string(Z.t.e6RscX)}{<d.eQA size={"md"} color={"currentColor"} className={F.barButtonIcon} />}</button></d.tEY>}</div>
}
...
function ed(e) {
  ...
  let ee = i.useMemo(() => <N.Z channel={s} summaries={M} summariesMembers={G} selectTopic={Q} setOpen={J} />, [M, G, Q, J, s]),
    et = i.useCallback(() => {
  ...
  return M.length > 0 && (er = "" === H || null == H ? Z.intl.string(Z.t.DwnFuL) : H), E ? null : <div ref={I} className={a()(F.newTopicsBarContainer, F.containerMarginTop)}>{<div className={F.newTopicsBarTopicSection}><d.P3F className={F.newTopicsBarTextClickable} aria-label={Z.intl.string(Z.t.RT3MPz)} onClick={X}><div className={a()({
            [F.newTopicsBarTextUnselected]: !z,
            [F.newTopicsBarTextSelected]: z
          })}>{<d.sVe size={"xs"} color={"currentColor"} className={F.newTopicsBarIcon} />}{<d.Text variant={"text-sm/medium"} className={a()(F.newTopicsBarCompact, F.newTopicsBarText)}>{er}</d.Text>}{<D.Z width={16} height={16} direction={D.Z.Directions.DOWN} className={F.newTopicsBarCaret} />}</div></d.P3F></div>}{<d.P3F onClick={et} className={F.newTopicsBarInitial}>{p}</d.P3F>}{<d.P3F onClick={en} className={a()(F.barButtonAlt, F.flexEnd)}>{<div className={F.newTopicsBarCompact}>{Z.intl.string(Z.t.e6RscX)}</div>}{<d.eQA size={"md"} color={"currentColor"} className={F.barButtonIcon} />}</d.P3F>}{z && <div className={F.topicsDropdown}>{<div className={F.topicsDropdownHeading}>{<div className={F.topicsDropdownHeadingText}>{<d.sVe size={"custom"} color={"currentColor"} className={F.topicsPillHeadingIcon} width={18} height={20} />}{<d.X6q variant={"heading-md/bold"} color={"header-primary"} lineClamp={1}>{Z.intl.string(Z.t.q21fUl)}</d.X6q>}{<O.Z className={F.summariesBetaTag} />}</div>}{<d.P3F aria-label={Z.intl.string(Z.t.cpT0Cg)} onClick={X} className={F.topicsDropdownClose}><d.Dio size={"md"} color={"currentColor"} /></d.P3F>}</div>}{<d.Ttm ref={R} className={F.topicsScroller} fade={true}>{ee}</d.Ttm>}</div>}</div>
}
...
function ep(e) {
  ...
  let ee = i.useMemo(() => <N.Z channel={s} summaries={C} summariesMembers={P} selectTopic={q} setOpen={J} />, [C, P, q, J, s]);
  if (!(0, u.e7)([A.Z], () => A.Z.shouldShowTopicsBar())) return null;
  let et = Z.intl.string(Z.t["38qwgI"]);
  return C.length > 0 && (et = "" === k || null == k ? Z.intl.string(Z.t.DwnFuL) : k), p ? null : <div ref={y} className={a()(F.topicsPillContainer, F.containerMarginTop)}>{<div className={F.topicsPill}>{<d.P3F className={F.topicsPillText} aria-label={Z.intl.string(Z.t.RT3MPz)} onClick={z}><div className={a()({
            [F.topicsPillTextUnselected]: !W,
            [F.topicsPillTextSelected]: W
          })}>{<d.sVe size={"xs"} color={"currentColor"} className={F.topicsPillSummaryIcon} />}{<d.Text className={F.topicsPillTextTitle} variant={"text-sm/medium"}>{et}</d.Text>}{<D.Z width={16} height={16} direction={D.Z.Directions.DOWN} className={F.topicsPillDropdownCaret} />}</div></d.P3F>}{<div className={F.topicsPillCarets}>{<d.P3F aria-label={Z.intl.string(Z.t["4huCnJ"])} onClick={Q} className={a()(F.topicsPillCaret, F.topicsCaretLeft, {
            [F.topicsPillCaretDisabled]: null == G
          })}><D.Z width={16} height={16} direction={D.Z.Directions.UP} /></d.P3F>}{<d.P3F aria-label={Z.intl.string(Z.t["58KOoK"])} onClick={X} className={a()(F.topicsPillCaret, F.topicsCaretRight, {
            [F.topicsPillCaretDisabled]: null == j
          })}><D.Z width={16} height={16} direction={D.Z.Directions.DOWN} /></d.P3F>}</div>}</div>}{W && <div className={F.topicsDropdown}>{<div className={F.topicsDropdownHeading}>{<div className={F.topicsDropdownHeadingText}>{<d.sVe size={"custom"} color={"currentColor"} className={F.topicsPillHeadingIcon} width={18} height={20} />}{<d.X6q variant={"heading-md/bold"} color={"header-primary"} lineClamp={1}>{Z.intl.string(Z.t.q21fUl)}</d.X6q>}{<O.Z className={F.summariesBetaTag} />}</div>}{<d.P3F aria-label={Z.intl.string(Z.t.cpT0Cg)} onClick={z} className={F.topicsDropdownClose}><d.Dio size={"md"} color={"currentColor"} /></d.P3F>}</div>}{<d.Ttm ref={T} className={F.topicsScroller} fade={true}>{ee}</d.Ttm>}</div>}</div>
}
let eh = function(e) {
    let t = !(arguments.length > 1) || true === arguments[1] || arguments[1];
    return <div className={F.tooltip}>{<d.Text color={"none"} variant={"text-sm/semibold"} lineClamp={1} className={F.tooltipEmojiName}>{e}</d.Text>}{t && <d.Text className={F.clickCTA} color={"text-muted"} variant={"text-sm/normal"}>{Z.intl.string(Z.t["515vjI"])}</d.Text>}</div>
  },
  em = e => {
    let {
      children: t,
    ...
    return <div className={a()(F.popoutContainer, n)}>{t}</div>
  },
  eg = e => {
    let {
      className: t
    } = e;
    return <em className={t}><div className={F.popoutLoadingBackground}><div className={F.popoutLoadingForeground} /></div></em>
  }