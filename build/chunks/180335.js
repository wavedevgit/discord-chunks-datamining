...
function h(e, t) {
  let n = e.filter(a.kr);
  return t.type === s.IIU.PLAYING ? n.filter(o.dX).find(e => f(e, t)) : t.type === s.IIU.LISTENING ? n.filter(o.dU).find(e => _(e, t)) : t.type === s.IIU.WATCHING ? e.filter(o.y0).find(e => p(e, t)) : true
}