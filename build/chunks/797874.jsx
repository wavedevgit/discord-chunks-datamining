...
let T = function(e) {
  ...
  } : true, N = null != v ? <img alt={""} className={a()(b.icon, b.imageIcon)} src={h.ZP.getApplicationIconURL({
      id: v.id,
      icon: v.icon,
      size: 32
    })} /> : null, C = (0, d.ZP)({
  ...
  return <f.Z applicationId={t} targetElementRef={y}>{e => {
      var n;
