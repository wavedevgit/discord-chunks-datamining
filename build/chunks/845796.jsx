...
let v = () => {
  ...
  return <div className={i()({
    ...
    })}><Chunk481060.PhF look={Chunk481060.qQH.CUSTOM} className={Chunk970387.custom} options={C.map(E)} select={y} isSelected={e => e === x.value} serialize={e => e} popoutWidth={224} popoutClassName={i()({
        [Chunk306414.shopTakeOver]: v
      })} /></div>
}