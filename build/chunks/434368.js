...
function j(e) {
  let {
    guildId: t,
    onClose: n
  } = e, o = (0, a.e7)([C.Z], () => C.Z.getSearchStateByGuildId(t), [t], i()), j = (0, u.dW)(t), g = l.useCallback(() => {
    o.requireUnusualDmActivity || j(u.aY.UNUSUAL_DM_ACTIVITY), (0, d.Dr)(t, h(f({}, o), {
      requireUnusualDmActivity: !o.requireUnusualDmActivity
    }))
  }, [t, o, j]), x = l.useCallback(() => {
    o.requireCommunicationDisabled || j(u.aY.COMMUNICATION_DISABLED), (0, d.Dr)(t, h(f({}, o), {
      requireCommunicationDisabled: !o.requireCommunicationDisabled
    }))
  }, [t, o, j]), O = l.useCallback(() => {
    o.requireUnusualAccountActivity || j(u.aY.UNUSUAL_ACCOUNT_ACTIVITY), (0, d.Dr)(t, h(f({}, o), {
      requireUnusualAccountActivity: !o.requireUnusualAccountActivity
    }))
  }, [t, o, j]), y = l.useCallback(() => {
    o.requireUsernameQuarantined || j(u.aY.USERNAME_QUARANTINED), (0, d.Dr)(t, h(f({}, o), {
