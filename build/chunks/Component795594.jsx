...
let ec = e => {
  ...
  ef = e => {
    let {
      ...
      locale: p,
      id: g
    } = e, b = o.id, I = i.useMemo(() => j.ZP.createFromServer(o), [o]), T = (0, F.yE)(I.flags, $.udG.EMBEDDED), S = (0, _.e7)([q.Z], () => {
      var e, t, n, r;
    ...
    }), P = o.bot, M = (0, _.e7)([k.Z], () => k.Z.getDMFromUserId(null == P ? true : P.id)), {
      ...
      if (null != o.description && "" !== o.description) return (0, r.jsx)(E.Text, {
        ...
        variant: "text-sm/normal",
        color: "text-default",
        children: (0, x.parseBioReact)(o.description)
      })
    }, [o.description]), ef = () => {
    ...
    }, [M, P, G, o.id]), em = () => A.enabled ? (0, r.jsxs)("div", {
