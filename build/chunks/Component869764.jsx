...
function b(e) {
  ...
  let {
    ...
    id: N,
    name: I
  } = null != g ? g : {}, O = (0, o.e7)([m.Z], () => m.Z.getChannel(s)), E = (0, d.ZP)(O, true), S = (0, o.e7)([h.Z], () => h.Z.can(x.Plq.VIEW_CHANNEL, O)), T = i.useMemo(() => {
...
function D(e) {
  ...
  i.useEffect(() => {
    var e;
    null == r && (null == d ? true : d.flags) != null && (0, a.yE)(null != (e = d.flags) ? e : 0, T.q.STARTED_HOME_ACTIONS) && (0, p.Fg)(t)
