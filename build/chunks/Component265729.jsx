...
let M = function(e) {
  let {
    ...
    return null == t
  }), p = (0, c.bG)([C.default], () => S.Ay.isPremiumExactly(C.default.getCurrentUser(), R.PremiumTypes.TIER_2)), m = o().groupBy(l, e => (0, T.Kx)(e.skuId, e.subscriptionPlanId, e.giftStyle)), [A, f] = i.useState(false);
  i.useEffect(() => {
    u.h.wait(() => {
      (0, _.XJ)().then(() => f(true))
    })
