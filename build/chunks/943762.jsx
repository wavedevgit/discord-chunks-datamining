...
function c(e) {
  ...
  return <div className={l.wrapper}>{<o.ZP guildId={n} users={t} max={6} size={o.u8.SIZE_16} />}{<i.Text variant={"text-xs/normal"} color={"none"}>{t.length}{" "}{a}</i.Text>}</div>
}
