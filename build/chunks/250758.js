...
function C(e, t) {
  ...
  let o = 3;
  s.mode.type === j.Sap.FILTER && (o = 10), n.results = function(e) {
...
function P(e, t) {
  let r = [];
  return t.type === j.Sap.FILTER ? r.push(I(t.filter, t.token, e, 10)) : t.type === j.Sap.FILTER_ALL ? r = function(e, t) {
    let r = (null != e ? e.getFullMatch() : "").trim(),
      n = [];
  ...
  }(t.token, e) : t.type === j.Sap.EMPTY && (r.push(R(t.token, e)), r.push(function(e) {
...
let A = new Z(o.Z, {
    SEARCH_AUTOCOMPLETE_QUERY_UPDATE: function(e) {
      ...
      if (a === i.query && (null == i.mode || i.mode.filter === o.filter)) r = i.autocompletes, u = !1;
        ...
        }), r = i.autocompletes, u = !1) : (c.context.clearQuery(), r = P(n, o))
      }
      return v[n] = E({
        searchId: n,
        query: a,
