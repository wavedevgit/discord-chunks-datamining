  ...
  return t.type === E.Sap.FILTER ? s.push(R({
    ...
    return null != n && "" !== n && ((function(e) {
      ...
      if (null != r && "" !== r) {
        ...
        let e = null == (l = o.ZP[E.dCx.FILTER_BEFORE]) || null == (s = l.getAutocompletions) || null == (n = s.call(l, {
            query: r,
            searchId: t,
            maxResults: 1
          })) ? void 0 : n[0],
          ...
          f = null == (d = o.ZP[E.dCx.FILTER_AFTER]) || null == (h = d.getAutocompletions) || null == (u = h.call(d, {
            query: r,
            searchId: t,
            maxResults: 1
          })) ? void 0 : u[0];
...
let Z = new k(i.Z, {
    SEARCH_AUTOCOMPLETE_QUERY_UPDATE: function(e) {
      ...
      if (a === o.query && (null == o.mode || o.mode.filter === i.filter)) r = o.autocompletes, u = !1;
        ...
        null != e && e.getFullMatch().trim().length > 0 ? (d.Z.requestMembers(n, e.getFullMatch().trim(), 10), c.context.setQuery({
