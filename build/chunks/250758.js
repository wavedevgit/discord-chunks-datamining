...
function j(e, t) {
  ...
  let i = 3;
  s.mode.type === _.Sap.FILTER && (i = 10), r.results = function(e) {
...
function R(e, t) {
  ...
  }(t.token, e) : t.type === _.Sap.EMPTY && (n.push(I(t.token, e)), n.push(function(e) {
...
l = "SearchAutocompleteStore", (s = "displayName") in A ? Object.defineProperty(A, s, {
  value: l,
  enumerable: !0,
  configurable: !0,
  writable: !0
