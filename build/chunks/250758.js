...
function j(e, t) {
  let n = [];
  return t.type === b.Sap.FILTER ? n.push(C(t.filter, t.token, e, 10)) : t.type === b.Sap.FILTER_ALL ? n = function(e, t) {
    ...
    }(e, t))), 5 > (0, p.BU)(r) && r.push(O(e)), r
  }(t.token, e) : t.type === b.Sap.EMPTY && (n.push(O(t.token)), n.push(function(e) {
...
l = "SearchAutocompleteStore", (i = "displayName") in N ? Object.defineProperty(N, i, {
  value: l,
  enumerable: !0,
  configurable: !0,
  writable: !0
