...
l = "SearchAutocompleteStore", (i = "displayName") in w ? Object.defineProperty(w, i, {
  value: l,
  enumerable: !0,
  configurable: !0,
  writable: !0
...
let Z = new w(o.Z, {
    SEARCH_AUTOCOMPLETE_QUERY_UPDATE: function(e) {
      ...
      if (a === s.query && (null == s.mode || s.mode.filter === o.filter)) n = s.autocompletes, u = !1;
        ...
        null != e && e.getFullMatch().trim().length > 0 ? (p.Z.requestMembers(r, e.getFullMatch().trim(), 10), c.context.setQuery(e.getFullMatch().trim(), {
          guild: r
        }), n = s.autocompletes, u = !1) : (c.context.clearQuery(), n = T(r, o))
      }
      return v[r] = O({
        searchId: r,
        query: a,
