...
class T extends(r = a.ZP.Store) {
  ...
  getState(e) {
    var t;
    return null != (t = E[e]) ? t : x({
      searchId: e
    })
  }
}
l = "SearchAutocompleteStore", (i = "displayName") in T ? Object.defineProperty(T, i, {
  value: l,
  enumerable: !0,
  configurable: !0,
  writable: !0
...
let P = new T(o.Z, {
    ...
    SEARCH_EDITOR_STATE_CLEAR: function(e) {
      ...
      null != n && (n.context.destroy(), n.results = [], delete y[t]), delete E[t]
    },
    CHANNEL_CREATE: S,
    CHANNEL_DELETE: S,
    ...
    SEARCH_CLEAR_HISTORY: function(e) {
      ...
      null != t ? I(t) : Object.keys(E).forEach(I)
    },
    LOGOUT: function() {
