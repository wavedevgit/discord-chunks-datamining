...
function j(e, t, r) {
  ...
  if (c === E.aib.GUILD && p) {
    let e = O[r];
    null == e ? a = null : ((null == t || 0 === h.length) && (e.results = d.ZP.getRecentlyTalked(r, 10).map(e => {
      let {
        record: t
      } = e;
      return {
...
function T(e, t) {
  let r = [];
  return t.type === E.Sap.FILTER ? r.push(j(t.filter, t.token, e, 10)) : t.type === E.Sap.FILTER_ALL ? r = function(e, t) {
    let r = (null != e ? e.getFullMatch() : "").trim(),
      n = [];
    return null != r && "" !== r && ((function(e) {
      let t = (0, u.g)(e),
        r = [E.dCx.FILTER_HAS];
    ...
    }(e, t))), 5 > (0, p.BU)(n) && n.push(R(e, t)), n
  }(t.token, e) : t.type === E.Sap.EMPTY && (r.push(R(t.token, e)), r.push(function(e) {
...
let M = new k(i.Z, {
    SEARCH_AUTOCOMPLETE_QUERY_UPDATE: function(e) {
      ...
      if (a === o.query && (null == o.mode || o.mode.filter === i.filter)) r = o.autocompletes, u = !1;
        ...
        null != e && e.getFullMatch().trim().length > 0 ? (h.Z.requestMembers(n, e.getFullMatch().trim(), 10), c.context.setQuery({
          query: e.getFullMatch().trim(),
          filters: {
            guild: n
          }
        }), r = o.autocompletes, u = !1) : (c.context.clearQuery(), r = T(n, i))
      }
      return C[n] = I({
        searchId: n,
        query: a,
