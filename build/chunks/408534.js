...
function O(e) {
  let {
    ...
    id: P,
    type: Z
  } = O, N = (0, i.e7)([u.Z], () => u.Z.getGuild(O.guild_id), [O.guild_id]), T = (0, i.e7)([d.Z], () => d.Z.getSelectedParticipant(P)), A = (null == T ? void 0 : T.type) === C.fO.STREAM ? T.stream : null, w = (0, i.e7)([a.Z], () => (null == T ? void 0 : T.type) === C.fO.ACTIVITY ? a.Z.getApplication(T.applicationId) : void 0), R = (0, h.Z)(P), k = (0, _.Z)(P), M = (0, m.Z)(O, N, null == A ? void 0 : A.ownerId, null == w ? void 0 : w.id), D = (0, p.Z)(P), L = (0, y.Z)(), U = (0, c.$A)(P), B = (0, c.j8)(P), F = (0, b.Z)(A, S), G = (0, g.Z)(w, P), H = (0, f.Z)(), V = (0, s.Z)(O);
