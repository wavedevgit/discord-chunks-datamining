...
function O(e) {
  let {
    ...
    id: S,
    type: Z
  } = O, N = (0, i.e7)([u.Z], () => u.Z.getGuild(O.guild_id), [O.guild_id]), T = (0, i.e7)([d.Z], () => d.Z.getSelectedParticipant(S)), A = (null == T ? void 0 : T.type) === C.fO.STREAM ? T.stream : null, w = (0, i.e7)([o.Z], () => (null == T ? void 0 : T.type) === C.fO.ACTIVITY ? o.Z.getApplication(T.applicationId) : void 0), R = (0, h.Z)(S), k = (0, _.Z)(S), M = (0, m.Z)(O, N, null == A ? void 0 : A.ownerId, null == w ? void 0 : w.id), L = (0, p.Z)(S), D = (0, y.Z)(), U = (0, c.$A)(S), B = (0, c.j8)(S), F = (0, b.Z)(A, P), G = (0, g.Z)(w, S), H = (0, f.Z)(), V = (0, s.Z)(O);
