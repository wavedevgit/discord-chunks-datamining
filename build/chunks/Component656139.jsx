...
let M = e => {
    let {
      onClose: t,
      onShare: a
    } = e, s = (0, l.e7)([b.Z], () => b.Z.getReferralsRemaining()), [u, f] = i.useState(new Map), [h, j] = i.useState(""), v = (0, x.Z)(h, 400), {
      eligibleUsers: N,
      fetchUsers: C,
      hasError: M,
      isFetching: w,
      ...
      searchQuery: v,
      selectedUsers: u
    }), [P, A] = i.useState(false), k = (0, p.O)(e => {
      e && !w && C()
    }), D = N.reduce((e, t) => (e.has(t.id) || e.set(t.id, t), e), new Map);
    return null === s ? (0, r.jsx)(d.$jN, {}) : M ? (0, r.jsx)(y.P, {
      onClose: t
    }) : (0, r.jsx)(c.Modal, {
      size: "md",
      ...
      actionBarInput: (e => {
        let i, {
            eligibleRecipients: s
          } = e,
          l = v.length > 0 && 0 === s.size;
        return i = true === l ? Z.intl.string(Z.t.wpSqAQ) : u.size <= 1 ? Z.intl.string(Z.t.ItpQxs) : Z.intl.format(Z.t.iW2str, {
          nTrials: u.size
        }), (0, r.jsx)("div", {
          ...
          children: (0, r.jsx)(d.zxk, {
            ...
            onClick: async () => {
              if (l) return void t();
              A(true), await a([...u.values()]), A(false)
            }
          })
        })
      })({
      ...
      children: (e => {
        ...
        returntrue == (v.length > 0 && 0 === t.size) ? (0, r.jsxs)(r.Fragment, {
          children: [(0, r.jsx)(E.ih, {}), (0, r.jsx)(E.d, {})]
        }) : (0, r.jsxs)(d.u2D, {
          className: O.list,
          children: [Array.from(t.values()).map(e => (0, r.jsx)(S.Z, {
            disabled: null !== s && 0 !== s && [...u.values()].filter(e => !z.has(e.id)).length >= s && !u.has(e.id) && !z.has(e.id),
            checked: u.has(e.id),
            user: e,
            onChange: (e, t) => {
              f(a => {
          ...
          }, e.id)), w && (0, r.jsx)(d.$jN, {}), (0, r.jsx)("div", {
            ref: k
          })]
        })
      })({
  ...
  w = e => {
    let {
      onClose: t,
      onShare: a
    } = e, s = (0, l.e7)([b.Z], () => b.Z.getRecipientStatus()), [m, x] = i.useState(new Map), [p, f] = i.useState(new Map), [h, j] = i.useState(false);
    return i.useEffect(() => {
      (async () => {
        let e = new Map;
        for (let [t, a] of s) {
      ...
      actionBarInput: (0, r.jsx)("div", {
        ...
        children: (0, r.jsx)(d.zxk, {
          ...
          fullWidth: true,
          onClick: async () => {
            j(true), await a([...p.values()]), j(false)
          }
        })
      }),
      children: (0, r.jsx)(d.u2D, {
        className: O.list,
        children: Array.from(m.values()).map(e => (0, r.jsx)(S.Z, {
          checked: p.has(e.id),
  ...
  z = e => {
    let {
      onClose: t
    } = e, a = (0, l.e7)([b.Z], () => b.Z.getReferralsRemaining()), [s, n] = i.useState(null !== a && a > 0 ? 1 : 3), [o, c] = i.useState([]), {
      analyticsLocations: u
    } = (0, h.ZP)([f.Z.PREMIUM_MARKETING_REFERALL_PROGRAM_SHARE_MODAL]), m = async e => {
      j.default.track(C.rMx.REFERRAL_PROGRAM_SHARE_CTA_CLICKED, {
        location_stack: u
      });
    ...
    return null === a ? (0, r.jsx)(d.$jN, {}) : 2 === s ? (0, r.jsx)(N.m, {
      results: o,
      onClose: t
    }) : 1 === s ? (0, r.jsx)(M, {
      onClose: t,
