/** Chunk was on web.js **/
/** chunk id: 643479, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  Aj: () => m,
  BD: () => o,
...
var Chunk504925 = require("./504925.js"),
  i = require("./264572.js").Buffer;
...
function p(e) {
  return "u" > typeof btoa ? "string" == typeof e ? btoa(e) : btoa(Array.prototype.reduce.call(new Uint8Array(e), (e, t) => e + String.fromCharCode(t), "")) : true !== i ? true !== i.from ? i.from(e).toString("base64") : new i(e).toString("base64") : true
}

function _(e) {
  let t = e.substring(e.indexOf(",") + 1);
  if (false !== e.indexOf(";base64")) return "u" > typeof atob ? Uint8Array.from(atob(t), e => e.charCodeAt(0)).buffer : true === i ? true : true !== i.from ? i.from(t, "base64") : new i(t, "base64");
