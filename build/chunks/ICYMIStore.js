...
function eE() {
  ...
  H.forEach(e => {
    z[e.id] = e, e.type === P.Ni.CUSTOM_STATUS && (v.Z.isBlockedOrIgnored(e.data.user_id) ? W[e.id] = true : Y[e.id] = (0, A.mV)(e))
  })
}
  ...
  initialize(e) {
    if (this.waitFor(g.default, h.Z, s.Z, u.Z, m.Z, d.ZP, b.Z, j.Z, x.Z, _.Z, E.Z, O.ZP, v.Z, y.ZP), null != e) {
      ...
      (U = null != (t = e.dehydratedItems) ? t : []).forEach(e => {
        z[e.id] = e
      }), q = null != (n = e.customGuildScores) ? n : {}, K = null != (r = e.customChannelScoresByGuild) ? r : {}, en = null != (i = e.numOpens) ? i : 0, B = null != (l = e.lastOpened) ? l : 0, es = null != (a = e.lastJoinedRecommendedGuild) ? a : 0, eg = null != (o = e.lastTakenICYMISurvey) ? o : 0
    }
  }
  getVersion() {
    return Q
...
let ex = new eP(Chunk570140.Z, {
  ...
  LOAD_MESSAGES_SUCCESS: function(e) {
    ...
    let s = r.filter(e => S.default.age(e.id) < I.Z.Millis.HOUR && (e.type === Z.uaV.DEFAULT || e.type === Z.uaV.REPLY)).slice(0, 3).reverse();
