...
function P() {
  return N([g.Z, E.Z, O.Z, s.Z], () => {
    ...
    return {
      channelType: t,
      guildId: n,
      connected: i === S.hes.RTC_CONNECTED,
...
function j() {
  return N([I.Z], () => I.Z.isCurrentUserSpeaking(), (e, t) => {
    if (e !== t) {
      let e = b.Z.isSelfMute();
      if (b.Z.getMode() === S.pM4.PUSH_TO_TALK && !e) return t ? "ptt_start" : "ptt_stop"
    }
  }), null
}

function A() {
  return N([b.Z], () => b.Z.getActiveVoiceFilter(), (e, t) => {
    if (e !== t)
...
function x() {
  return N([b.Z], () => b.Z.isSelfMutedTemporarily(), (e, t) => {
    if (e !== t) {
      let e = b.Z.isSelfMute();
      if (b.Z.getMode() === S.pM4.VOICE_ACTIVITY && !e) return t ? "ptt_stop" : "ptt_start"
    }
  }), null
}

function Z() {
  return N([I.Z], () => I.Z.isCurrentUserPrioritySpeaker(), (e, t) => {
    if (e !== t) {
      let e = b.Z.isSelfMute();
...
function L() {
  return N([y.Z], () => y.Z.userHasBeenMovedVersion, (e, t) => {
...
function R() {
  return N([O.Z, h.Z, f.default, y.Z, g.Z], () => {
    ...
    let s = null;
    return (null == (s = 1 === o.length ? o[0] : h.Z.getCurrentUserActiveStream()) ? void 0 : s.state) === S.jm8.CONNECTING && (s = null), null != s && (l = (0, c.V9)(s), a = h.Z.getViewerIds(l).filter(e => e !== r).length), {
      channelType: e,
      voiceChannelId: n,
...
function D() {
  return N([O.Z, a.ZP, f.default], () => {
    let e = O.Z.getVoiceChannelId(),
      ...
      c = (0, C.lm)(r) ? a.ZP.getEmbeddedActivitiesForChannel(r) : a.i6,
      u = (0, C.lm)(n) ? a.ZP.getSelfEmbeddedActivityForLocation(n) : null;
    return {
