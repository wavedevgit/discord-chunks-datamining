...
function K() {
  ...
  let l = v.ZP.getMentionChannelIds().filter(e => e !== r && !V.includes(e)).map(e => W(e)).filter(N.lm).reverse();
...
function z(e, t) {
  switch (U) {
    case u.h8.USER: {
      ...
      e.unshift((0, u.o6)(null != t ? w.intl.formatToPlainString(w.t.FREzQk, {
        name: t.name
      }) : w.intl.string(w.t.XFYW1t))), G = e;
      break
    }
    case u.h8.TEXT_CHANNEL:
...
function q(e) {
  ...
  let {
    query: n,
    queryMode: i
  } = e, a = null != (t = T.Z.getGuildId()) ? t : void 0, o = new Set(["user:".concat(h.default.getId())]);
  null != a && o.add("guild:".concat(a)), r = null != r ? r : new u.ZP(Q, x, null != i ? L : D, {
    frecencyBoosters: !0,
    blacklist: o
