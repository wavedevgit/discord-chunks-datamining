...
function X() {
  ...
  for (let e = 1; e < W.length; e += 1) {
    let t = q(W[e]);
    null != t && (t.type !== u.h8.TEXT_CHANNEL && t.type !== u.h8.VOICE_CHANNEL || I.Z.can(w.Plq.VIEW_CHANNEL, t.record)) && o.push(t)
  }
  ...
  let l = T.ZP.getMentionChannelIds().filter(e => e !== r && !W.includes(e)).map(e => q(e)).filter(R.lm).reverse();
  if (l.length > 0 && (i.push((0, u.o6)(D.intl.string(D.t["61Df19"]))), i = i.concat(l)), null != n) {
    let e = y.ZP.getSelectableChannelIds(n).filter(e => {
...
function J(e) {
  ...
  let {
    query: n,
    queryMode: i
  } = e, o = null != (t = A.Z.getGuildId()) ? t : void 0, a = new Set(["user:".concat(m.default.getId())]);
  null != o && a.add("guild:".concat(o)), r = null != r ? r : new u.ZP(et, j, null != i ? k : M, {
    frecencyBoosters: !0,
    blacklist: a
...
class ea extends(i = s.ZP.PersistedStore) {
  initialize(e) {
    var t;
    this.waitFor(O.ZP, v.Z, g.Z), this.syncWith([h.Z], () => !0), G = l.K.get(x) || !1, W = null != (t = null == e ? void 0 : e.channelHistory) ? t : []
  }
  getState() {
    return {
      channelHistory: W
