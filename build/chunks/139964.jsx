...
function O(e) {
  ...
  }, [l]), null == g || null == O) ? null : <j.Z{...t = function(e) {
...
function y() {
  return <div className={Chunk751848.row}>{<Chunk481060.Text variant={"text-md/medium"}>{Chunk388032.intl.string(Chunk388032.t.PL48CA)}</Chunk481060.Text>}{<v />}</div>
}

function v() {
  return null != (0, Chunk442837.e7)([Chunk553795.Z], () => Chunk553795.Z.getAccount(null, Chunk981631.ABu.RIOT_GAMES)) ? <Chunk755721.zx disabled={true} color={Chunk755721.zx.Colors.TRANSPARENT} look={Chunk755721.zx.Looks.OUTLINED} innerClassName={Chunk751848.doneButton}>{<Chunk481060.kmB />}{<Chunk481060.Text variant={"text-sm/medium"}>{Chunk388032.intl.string(Chunk388032.t.i4jeWV)}</Chunk481060.Text>}</Chunk755721.zx> : <Chunk481060.zxk variant={"secondary"} size={"sm"} text={Chunk388032.intl.string(Chunk388032.t.To26Nj)} onClick={() => (0, Chunk231757.Z)({
...
function C(e) {
  ...
  return <a.j7V hideBorder={true} onChange={o} value={!i} className={h.guildOptoutSwitch}>{_.intl.string(_.t.eZhXQU)}</a.j7V>
}