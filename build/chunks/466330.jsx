...
let E = (n, e, l) => {
    ...
    let c = p(l, n);
    return <i.sNh id={"invite-people"} label={c} color={"brand"} icon={n === s.t4x.GUILD_HEADER ? i.ejJ : true} action={() => (0, i.ZDy)(async () => {
        let {
          default: i
  ...
  O = (n, e) => {
    let l = p(e, n);
    return <i.sNh id={"invite-people"} label={l} color={"brand"} icon={n === s.t4x.GUILD_HEADER ? i.ejJ : true} action={() => (0, i.ZDy)(async () => {
        let {
          default: n
