...
function O(e, t) {
  if (e instanceof d.dm) return e.id === y ? {
    brand: null,
  ...
  if (e instanceof d.Vg) return {
    ...
    label: h.intl.format(h.t.hSPoZ2, {
      bank: (0, c.Ul)(e.bank)
    })
  };
  else if (e instanceof d.jc) return {
    brand: u.ZP.Types.IDEAL,
    label: null == e.bank ? h.intl.string(h.t.nSbwqK) : h.intl.format(h.t["9kUlRU"], {
      bank: (0, c.YE)(e.bank)
    })
  };
  ...
  let {
    ...
    if (e instanceof d.ZP) {
      let {
        brand: t,
        label: n
      } = O(e, c), i = e === v || null == T || (null == T ? void 0 : T.includes(e.paymentGateway));
      return {
        value: e.id,
        label: (0, r.jsxs)("div", {
