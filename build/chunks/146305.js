...
let eP = {
  getSectionDefinition: function(e, t) {
    ...
    let ew = (0, j.p)(t.guild.id, "guild_settings"),
      ...
      ek = (null === (eP = t.guild.profile) || void 0 === eP ? void 0 : eP.badge) != null ? (0, c.ky)(t.guild.id, t.guild.profile.badge, ey.NC.SIZE_16) : null;
    switch (e) {
      case e_.pNK.PROFILE:
        return {
      ...
      case e_.pNK.COMMUNITY:
        ...
        return t.guild.hasFeature(e_.oNc.COMMUNITY) && (eA = t.isGuildSettingsFoundationEnabled ? eI.NW.string(eI.t["8nY2LC"]) : eI.NW.string(eI.t["/dp6yc"])), {
      ...
      case e_.pNK.ROLE_SUBSCRIPTIONS_STORE_PAGE:
        return {
          section: e_.pNK.ROLE_SUBSCRIPTIONS_STORE_PAGE, impressionName: i.ImpressionNames.GUILD_ROLE_SUBSCRIPTION_STORE_PAGE_GUILD_SETTINGS, newIndicator: 2022 === new Date().getFullYear(), label: eI.NW.string(eI.t.ipTYsr), ariaLabel: eI.NW.string(eI.t.ipTYsr), element: O.Z, predicate: () => t.monetizationPredicate() && (0, v.sy)(t.guild)
        };
