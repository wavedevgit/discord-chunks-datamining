...
let eb = {
  getSectionDefinition: function(e, t) {
    ...
    switch (e) {
      ...
      case em.pNK.TAG:
        return {
          section: em.pNK.TAG, impressionName: i.ImpressionNames.GUILD_SETTINGS_TAG, label: ep.intl.string(ep.t["2QmKZ2"]), ariaLabel: ep.intl.string(ep.t["2QmKZ2"]), element: ed.ZP, predicate: () => t.canManageGuild, notice: {
            stores: [T.Z],
            element: eu.Z
      ...
      case em.pNK.ONBOARDING:
        return {
          section: em.pNK.ONBOARDING, label: ep.intl.string(ep.t.LdxCKy), element: Y.Z, ariaLabel: ep.intl.string(ep.t.LdxCKy), newIndicatorDismissibleContentTypes: t.onboardingEnabled ? null : [l.z.COMMUNITY_ONBOARDING_NEW_BADGE], notice: {
            ...
            let n = Z.ug,
              r = n.findIndex(e => e === t);
            if (-1 !== r) return ep.intl.formatToPlainString(ep.t["5r28iY"], {
              count: r + 1,
              total: n.length
            })
      ...
      case em.pNK.ANALYTICS:
        return {
          section: em.pNK.ANALYTICS, impressionName: i.ImpressionNames.GUILD_SETTINGS_ANALYTICS, label: ep.intl.string(ep.t["0wWfUF"]), ariaLabel: ep.intl.string(ep.t["0wWfUF"]), element: M.Z, predicate: () => ev
        };
      ...
      case em.pNK.GUILD_PRODUCTS:
        return {
          section: em.pNK.GUILD_PRODUCTS, label: ep.intl.string(ep.t.X6h2g4), ariaLabel: ep.intl.string(ep.t.X6h2g4), element: f.Z, predicate: () => t.monetizationPredicate() && (0, p.p)(t.guild.id, "guild_product_settings_predicate") && (0, h.sy)(t.guild)
        };
      case em.pNK.ROLE_SUBSCRIPTIONS_STORE_PAGE:
        return {
          section: em.pNK.ROLE_SUBSCRIPTIONS_STORE_PAGE, impressionName: i.ImpressionNames.GUILD_ROLE_SUBSCRIPTION_STORE_PAGE_GUILD_SETTINGS, newIndicator: 2022 === new Date().getFullYear(), label: ep.intl.string(ep.t.ipTYsr), ariaLabel: ep.intl.string(ep.t.ipTYsr), element: j.Z, predicate: () => t.monetizationPredicate() && (0, h.sy)(t.guild)
        };
      case em.pNK.GUILD_PREMIUM:
        return {
          section: em.pNK.GUILD_PREMIUM, impressionName: i.ImpressionNames.GUILD_SETTINGS_BOOST_STATUS, label: ep.intl.string(ep.t["8+VX4+"]), ariaLabel: ep.intl.string(ep.t["8+VX4+"]), element: K.Z, className: ef.serverBoostTabItem, icon: (0, r.jsx)(s.$Eu, {
      ...
      case em.pNK.DELETE:
        return {
          section: em.pNK.DELETE, onClick() {
            ...
            e.mfaEnabled ? (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, ex(eh({}, e, l), {
          ...
          }, label: ep.intl.string(ep.t.l3hWPz), ariaLabel: ep.intl.string(ep.t.l3hWPz), icon: (0, r.jsx)(s.XHJ, {
            size: "xs",
            color: "currentColor"
