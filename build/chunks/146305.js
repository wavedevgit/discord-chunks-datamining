...
let eO = {
  getSectionDefinition: function(e, t) {
    ...
    switch (e) {
      case eh.pNK.PROFILE:
        return {
          section: eh.pNK.PROFILE, impressionName: i.ImpressionNames.GUILD_SETTINGS_PROFILE, label: eb.intl.string(eb.t.txdaxc), ariaLabel: eb.intl.string(eb.t.txdaxc), element: ed.Z, type: o.bT.SCROLLABLE_CUSTOM, notice: {
            stores: [R.Z],
            element: em.Z
          }
        };
      case eh.pNK.TAG:
        return {
          section: eh.pNK.TAG, impressionName: i.ImpressionNames.GUILD_SETTINGS_TAG, label: eb.intl.string(eb.t["2QmKZ2"]), ariaLabel: eb.intl.string(eb.t["2QmKZ2"]), element: eg.ZP, predicate() {
      ...
      case eh.pNK.INVITES:
        return {
          section: eh.pNK.INVITES, impressionName: i.ImpressionNames.GUILD_SETTINGS_INVITES_V2, label: eb.intl.string(eb.t.YOt3Oj), ariaLabel: eb.intl.string(eb.t.YOt3Oj), element: ea.Z, type: o.bT.CUSTOM, predicate: () => t.canManageGuild
        };
      case eh.pNK.ROLES:
        return {
      ...
      case eh.pNK.EMOJI:
        return {
          section: eh.pNK.EMOJI, impressionName: i.ImpressionNames.GUILD_SETTINGS_EMOJI, label: eb.intl.string(eb.t.sMOuub), element: V.ZP, predicate: () => t.canManageGuildExpressions
        };
      ...
      case eh.pNK.APP_DIRECTORY:
        return {
          section: eh.pNK.APP_DIRECTORY, label: eb.intl.string(eb.t.AKcFUl), ariaLabel: eb.intl.string(eb.t.AKcFUl), onClick() {
      ...
      case eh.pNK.SAFETY:
        return {
          section: eh.pNK.SAFETY, impressionName: i.ImpressionNames.GUILD_SETTINGS_SAFETY, label: eb.intl.string(eb.t["suhY+f"]), ariaLabel: eb.intl.string(eb.t["suhY+f"]), element: U.Z, newIndicatorDismissibleContentTypes: [l.z.COMMUNITY_GUILD_SETTINGS_SAFETY], predicate: () => t.canManageGuild && t.guild.hasFeature(eh.oNc.COMMUNITY)
        };
      case eh.pNK.MODERATION:
        return {
          section: eh.pNK.MODERATION, impressionName: i.ImpressionNames.GUILD_SETTINGS_MODERATION, label: eb.intl.string(eb.t["suhY+f"]), element: Q.ZP, predicate: () => t.canManageGuild && !t.guild.hasFeature(eh.oNc.COMMUNITY)
        };
      case eh.pNK.GUILD_AUTOMOD:
        return {
          ...
          }), ariaLabel: eb.intl.string(eb.t.uRelg4), element: g.Z, newIndicatorDismissibleContentTypes: null, predicate: () => !t.guild.hasFeature(eh.oNc.COMMUNITY) && ((0, m.Nb)(t.guild.id) || (0, m.ze)(t.guild.id))
        };
      case eh.pNK.AUDIT_LOG:
        return {
          section: eh.pNK.AUDIT_LOG, impressionName: i.ImpressionNames.GUILD_SETTINGS_AUDIT_LOG, label: eb.intl.string(eb.t.SPWLyc), element: D.Z, type: o.bT.CUSTOM, predicate: () => t.canViewAuditLog
        };
      case eh.pNK.BANS:
        return {
          section: eh.pNK.BANS, impressionName: i.ImpressionNames.GUILD_SETTINGS_BANS, label: eb.intl.string(eb.t.ZbeITU), element: F.Z, predicate: () => t.canManageBans
        };
      case eh.pNK.COMMUNITY:
        let eI = eb.intl.string(eb.t.ElKTeX);
        return t.guild.hasFeature(eh.oNc.COMMUNITY) && (eI = eb.intl.string(eb.t["8nY2LC"])), {
      ...
      case eh.pNK.ONBOARDING:
        return {
          section: eh.pNK.ONBOARDING, label: eb.intl.string(eb.t.LdxCKy), element: X.Z, ariaLabel: eb.intl.string(eb.t.LdxCKy), newIndicatorDismissibleContentTypes: t.onboardingEnabled ? null : [l.z.COMMUNITY_ONBOARDING_NEW_BADGE], notice: {
            ...
            let n = A.ug,
              r = n.findIndex(e => e === t);
            if (-1 !== r) return eb.intl.formatToPlainString(eb.t["5r28iY"], {
              count: r + 1,
              total: n.length
            })
      ...
      case eh.pNK.DISCOVERY_LANDING_PAGE:
        return {
          ...
          }), ariaLabel: eb.intl.string(eb.t.kGlQGB), element: W.Z, notice: {
            stores: [R.Z],
            element: W.J
      ...
      case eh.pNK.COMMUNITY_WELCOME:
        return {
          section: eh.pNK.COMMUNITY_WELCOME, impressionName: i.ImpressionNames.GUILD_SETTINGS_COMMUNITY_WELCOME, label: eb.intl.string(eb.t["2rkmDg"]), ariaLabel: eb.intl.string(eb.t["2rkmDg"]), element: H.Z, notice: {
            stores: [y.Z],
            element: N.Z
      ...
      case eh.pNK.GUILD_PRODUCTS:
        return {
          section: eh.pNK.GUILD_PRODUCTS, label: eb.intl.string(eb.t.X6h2g4), ariaLabel: eb.intl.string(eb.t.X6h2g4), element: x.Z, predicate: () => t.monetizationPredicate() && (0, f.p)(t.guild.id, "guild_product_settings_predicate") && (0, b.sy)(t.guild)
        };
      case eh.pNK.ROLE_SUBSCRIPTIONS_STORE_PAGE:
        return {
          section: eh.pNK.ROLE_SUBSCRIPTIONS_STORE_PAGE, impressionName: i.ImpressionNames.GUILD_ROLE_SUBSCRIPTION_STORE_PAGE_GUILD_SETTINGS, newIndicator: 2022 === new Date().getFullYear(), label: eb.intl.string(eb.t.ipTYsr), ariaLabel: eb.intl.string(eb.t.ipTYsr), element: v.Z, predicate: () => t.monetizationPredicate() && (0, b.sy)(t.guild)
        };
      case eh.pNK.GUILD_PREMIUM:
        return {
          section: eh.pNK.GUILD_PREMIUM, impressionName: i.ImpressionNames.GUILD_SETTINGS_BOOST_STATUS, label: eb.intl.string(eb.t["8+VX4+"]), ariaLabel: eb.intl.string(eb.t["8+VX4+"]), element: q.Z, className: ej.serverBoostTabItem, icon: (0, r.jsx)(J.Z, {
            className: ej.icon
          })
        };
      case eh.pNK.MEMBERS:
        return {
          section: eh.pNK.MEMBERS, impressionName: i.ImpressionNames.GUILD_SETTINGS_MEMBERS, label: (0, r.jsx)(K.$, {}), ariaLabel: eb.intl.string(eb.t["9Oq93t"]), element: K.Z, type: o.bT.CUSTOM, predicate: () => t.canAccessMembersPage
        };
      case eh.pNK.DELETE:
        return {
          section: eh.pNK.DELETE, onClick() {
            ...
            e.mfaEnabled ? (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, ev(e_({}, e, l), {
