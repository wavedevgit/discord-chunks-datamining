...
function p(e, t) {
  ...
  return e === n.l.FAVORITE_GAMES ? u(d({}, a), {
...
function b(e) {
  ...
  a = null != o ? e === n.l.FAVORITE_GAMES ? x() : [...o.games || [], x()] : e === n.l.FAVORITE_GAMES ? x() : [x()];
  let c = h(t, p(e, a));
  l.Z.setPendingWidgets(c);
  let d = [];
  e === n.l.FAVORITE_GAMES ? d.push(a.applicationId) : a.forEach(e => {
