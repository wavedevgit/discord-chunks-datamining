...
function x(e) {
  let {
    ...
    poll: n,
    className: i
  } = e, l = (0, p.$B)(n.containerStyle), u = function(e, t) {
    let n = {
      answers: t.answers,
    ...
    return (0, o.EQ)(t.layoutType).with(s.C.DEFAULT, () => (0, r.jsx)(f.K, h({}, n))).with(s.C.IMAGE_ONLY_ANSWERS, () => (0, r.jsx)(d.Z, h({}, n))).otherwise(() => null)
  }(0, n);
