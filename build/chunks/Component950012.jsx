...
let u = e => {
  let {
    ...
    isNUXFlow: m
  } = e, [f, h] = l.useState([d.tF.VERIFY_EMAIL]), [g, p] = l.useState(""), [v, _] = l.useState(""), [x, N] = l.useState(true), [y, E] = l.useState([]), S = e => {
    h(f.concat(e).slice(false))
  };
  switch (f[f.length - 1]) {
    ...
    case d.tF.SUBMIT_SCHOOL:
      return (0, r.jsx)(s.Z, {
        onBack: () => {
          f.length > 1 && h(f.slice(0, false).slice(false))
        },
        setStep: S,
        email: g,
        school: v,
