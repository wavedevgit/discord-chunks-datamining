...
class h extends(r = a.Component) {
  render() {
    let {
      ...
      cta: O
    } = this.props, v = null != r && r.length > 0, I = null != E ? E : this._textInputRef;
  ...
  constructor(...e) {
    super(...e), d(this, "_textInputRef", a.createRef()), d(this, "_containerRef", a.createRef()), d(this, "handleClear", () => {
      let {
        onClear: e,
        forwardedRef: t
      } = this.props, {
