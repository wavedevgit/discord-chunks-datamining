...
function E(e) {
  let {
    ...
    emojiId: S,
    emojiName: M
  } = t, j = null != x, [w, N] = o.useState(!1), P = (0, s.e7)([_.ZP], () => null != S ? _.ZP.getUsableCustomEmojiById(S) : null), A = j || null != E, k = (!j || !w) && (null != S || null != M), L = 0 === a, D = o.useRef(null), R = (0, s.e7)([p.Z], () => p.Z.keyboardModeEnabled), Z = e => {
    ...
    onClick: e => {
      null == E || E(e), null == x || x(t), R || null == D.current || D.current.blur()
    },
    onContextMenu: e => Z(e),
    onMouseEnter: () => j && N(!0),
    onMouseLeave: () => j && N(!1)
