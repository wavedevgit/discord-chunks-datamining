...
function S(e) {
  let {
    ...
    I.wS && r && (0, u.jW)(e, async () => {
      ...
      return n => (0, l.jsx)(e, g(R({}, n), {
        tag: t
      }))
    })
  }, z = (0, l.jsxs)(l.Fragment, {
    children: [x ? (0, l.jsx)(_.Z, {
      className: a()(N.emoji, {
        [N.small]: j
      }),
      emojiId: D,
  ...
  return P ? (0, l.jsx)(c.P3F, g(R(g(R({}, w), {
    innerRef: y,
    focusProps: {
      ringTarget: y
    },
    "aria-label": null != U ? U : O.intl.formatToPlainString(O.t.iyRTLi, {
      tagName: L
    }),
    role: "button",
    "aria-pressed": p
