...
let y = r.memo(function(e) {
  ...
  O = e => {
    let {
      ...
      title: l,
      icon: o
    } = e, d = (0, a.e7)([g.Z], () => g.Z.getChannel(n)), u = (0, a.e7)([x.Z], () => x.Z.getMessages(n)), m = (0, a.e7)([p.Z], () => p.Z.can(_.Plq.VIEW_CHANNEL, d)), h = u.first(), C = (0, c.zy)(h, !1), v = (null == C ? void 0 : C.length) > 0 ? C[0] : null, Z = null != d && null == h && !u.loadingMore && !u.ready && !u.hasFetched && m;
    r.useEffect(() => {
      Z && s.Z.fetchMessages({
        channelId: n,
        after: n,
