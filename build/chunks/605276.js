...
function Z(e) {
  let {
    guild: n
  } = e, t = (0, a.e7)([d.Z], () => d.Z.getGuild(n.id), [n]);
  return l.useEffect(() => {
    null == t && (0, c.P)(n.id)
  }, [n.id, t]), (0, r.jsx)(i.Zbd, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(i.X6q, {
        ...
        children: (null == t ? void 0 : t.memberCount) != null && (null == t ? void 0 : t.presenceCount) != null && (0, r.jsxs)(r.Fragment, {
...
let y = l.memo(function(e) {
  ...
  O = e => {
    let {
      ...
      title: t,
      icon: c
    } = e, d = (0, a.e7)([g.Z], () => g.Z.getChannel(n)), u = (0, a.e7)([p.Z], () => p.Z.getMessages(n)), m = (0, a.e7)([x.Z], () => x.Z.can(v.Plq.VIEW_CHANNEL, d)), h = u.first(), C = (0, o.zy)(h, !1), _ = (null == C ? void 0 : C.length) > 0 ? C[0] : null, Z = null != d && null == h && !u.loadingMore && !u.ready && !u.hasFetched && m;
    l.useEffect(() => {
      Z && s.Z.fetchMessages({
        channelId: n,
        after: n,
    ...
    let N = e => {
      null != d && (e.shiftKey ? (0, j.C3)(d.guild_id, d.id) : f.Z.openResourceChannelAsSidebar({
        guildId: d.guild_id,
        channelId: d.id
      }))
    };
    return (0, r.jsx)(i.P3F, {
      ...
      children: (0, r.jsxs)(r.Fragment, {
        children: [(() => {
          ...
          return null != c && null != e ? (0, r.jsx)("img", {
            src: e,
  ...
  P = l.memo(function(e) {
    ...
    return 0 === t.length ? null : (0, r.jsx)(i.Zbd, {
      className: I.sidebarCardWrapper,
      children: (0, r.jsxs)("div", {
        className: I.sidebarCard,
        children: [(0, r.jsx)(i.X6q, {
