...
function H(e) {
  ...
  let {
    ...
    var e;
    return (0, d.Z)(F) && null != Y ? (0, r.jsxs)("div", {
    ...
    var e;
    return F.type === U.IIU.WATCHING ? null : (0, u.Z)(F) ? e_() : (0, r.jsx)(D.Z, {
      text: null == (e = F.assets) ? void 0 : e.large_text,
      variant: "text-xs/normal"
    })
  }, e_ = () => {
    var e, t, n, i;
    return (null == (e = F.party) ? void 0 : e.size) == null && F.application_id === G.Zc ? (0, r.jsxs)("div", {
    ...
    }) : (0, c.Z)(F) && (null == (t = F.party) ? void 0 : t.size) != null && (null == (n = F.party) ? void 0 : n.size.length) >= 2 ? (0, r.jsxs)("div", {
      className: V.gameState,
      children: [(0, r.jsx)(D.Z, {
        variant: "text-xs/normal",
        text: F.state
        ...
        variant: "text-xs/normal",
        text: 0 === F.party.size[1] ? B.NW.formatToPlainString(B.t.IM4J4e, {
