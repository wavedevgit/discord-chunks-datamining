...
function z(e) {
  ...
  let {
    ...
    className: J,
    onClose: $
  } = e, ee = (0, g.Dt)(), et = (0, g.Dt)(), en = i.useRef(null), {
    ...
    userId: n.id,
    onAction: el
  }), eu = (0, T.Z)(W), ed = null != eu.text && "" !== eu.text, {
    largeImage: e_,
    smallImage: ef
  } = (0, p.FO)(W, z), ep = (0, B.Z)({
    ...
    return W.type === F.IIU.HANG_STATUS ? (0, r.jsx)(b.Z, {
      hangStatusActivity: W,
      className: o()(Y.hangStatusIcon, Y.image, {
        [Y.small]: ei !== V.lY.MODAL_V2
      })
    }) : null == ep ? (0, r.jsx)(h.E, {
      image: e_,
      smallImage: ef,
    ...
    children: [em(), eg(), eE()]
  }), ev = () => null == q || null == X ? null : (0, r.jsx)(j.Z, {
    user: n,
    guild: q,
    channel: X,
    onAction: el,
    onClose: $
  }), eI = () => n.id === a.id ? null : (0, r.jsx)("div", {
    className: Y.actions,
    ...
    children: (0, r.jsx)(w.Z, {
      ...
      children: (0, r.jsx)(C.Z, {
        ...
        children: () => (0, r.jsx)(R.Z, {
          ...
          sourceType: V.n_.ACTIVITY,
          onAction: el,
          renderMoreButtonPopout: e => (0, r.jsx)(G.Z, {
            display: "live",
            user: n,
            activity: W,
            entry: es,
          ...
          children: (0, r.jsxs)(x.Z, {
            ...
            children: [(0, r.jsx)(M.Z, K({
              ...
              children: [(0, r.jsxs)("div", {
                className: Y.content,
                children: [!n.bot && eh(), (0, r.jsxs)("div", {
                  className: Y.details,
                  children: [eO(), !n.bot && (0, r.jsx)(L.Z, {
                    user: n,
                    activity: W,
                    className: Y.badges
                  }), ey(), ei === V.lY.MODAL_V2 && eI()]
                }), ei === V.lY.MODAL && eI()]
              }), ev()]
