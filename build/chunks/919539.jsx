...
function S(e) {
  let {
    ingress: t,
    guildId: n
  } = e, S = (0, h.c_)(), T = (0, p.q)(), I = g.h2.useSetting().includes(n), N = g.mX.useSetting(), y = g.zA.useSetting().includes(n), A = r.useCallback(e => {
    let i = (0, u.gl)();
  ...
  return <f.U setting={E.s6.PRIVACY_SERVER_SPECIFIC_PRIVACY_MESSAGE_REQUESTS_V2} scrollPosition={j.FY.MESSAGE_REQUESTS_V2}>{n === C.T ? (0, i.jsx)(b.Z, {
...
function T(e) {
  ...
  return <S ingress={t} guildId={null != n ? n : r} />
}