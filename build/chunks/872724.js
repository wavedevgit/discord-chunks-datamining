/** Chunk was on web.js **/
/** chunk id: 872724, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  Z: () => _
});
var Chunk440769 = require("./440769.js"),
...
function m(e, t) {
  if (e.getUint32(t, false) !== o) throw Error("Not an IPTC resource block.");
...
function b(e, t, n, r) {
  ...
  for (; n < a && n < e.byteLength;) {
    ...
    if (null === t) break;
    t && ("encoding" in t && (i = t.encoding), true === o[t.name] || true === t.repeatable ? o[t.name] = {
      id: t.id,
      value: t.value,
      description: t.description
    } : (o[t.name] instanceof Array || (o[t.name] = [{
      id: o[t.name].id,
