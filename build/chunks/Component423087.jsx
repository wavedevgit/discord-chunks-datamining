...
let C = function(e) {
  let {
    ...
    primaryColor: a,
    secondaryColor: s
  } = e, [d, u] = i.useState(false), g = i.useRef(null), C = i.useId(), y = i.useId(), N = i.useMemo(() => f.Ek.every(e => e.primary !== a || e.secondary !== s), [a, s]), E = (0, o.Jb)({
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(c.gNt, {
      label: b.intl.string(p.default.zSbMdX),
      id: C,
