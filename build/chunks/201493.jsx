...
let C = e => {
  ...
  return L ? <_.Z searchQuery={D} setSearchQuery={k} mostRecentQuery={R} handleSearchKeyPress={G} handleClearSearch={B} handleCreateOrAddGuild={H} searchResults={A} searchFetching={w} /> : null == N && null == S ? <div className={v.pageContainer}><a.$jN className={v.spinner} /></div> : (null == N ? true : N.length) === 0 && null == S ? <div className={v.pageContainer}><b.Z guild={E} onAddGuild={H} /></div> : <y.Z channel={C} searchQuery={D} setSearchQuery={k} handleSearchKeyPress={G} handleClearSearch={B} handleCreateOrAddGuild={H} currentCategoryId={S} handleSelectCategory={e => {
      p.Su(C.id, e)
    }} directoryEntries={N} categoryCounts={Z} allEntriesCount={P} isLoading={T} />
}