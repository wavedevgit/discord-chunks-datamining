...
function g(t) {
  ...
  let w = t => {
    (0, r.h7j)(i => {
      var o, a;
      return <r.ConfirmModal{...o = function(t) {
  ...
  return <r.sNh id={d.intl.string(d.t.B9sJLS)} label={d.intl.string(d.t.B9sJLS)} action={b ? true : () => w()} color={"danger"}>{b && (0, l.jsxs)(l.Fragment, {
