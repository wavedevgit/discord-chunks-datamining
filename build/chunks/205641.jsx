...
class b extends(r = Chunk73800.Component) {
  ...
  render() {
    ...
    return <Chunk82923.Z.div className={o()(Chunk834404.animation, module)} style={function(e) {
        ...
        return e
      }({}, exports, this.getWumpusStyle())}>{<div className={Chunk834404.fireTopWrapper}><Chunk82923.Z.div className={Chunk834404.fire} style={this.getFireStyle()} /></div>}{<div className={Chunk834404.fireBottomWrapper}><Chunk82923.Z.div className={Chunk834404.fire} style={this.getFireStyle()} /></div>}{<div className={Chunk834404.wumpus} />}</Chunk82923.Z.div>
  }
  constructor(...e) {
