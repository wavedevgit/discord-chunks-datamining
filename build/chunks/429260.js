...
function I() {
  return (0, r.jsx)(d.ZP, {
    ...
    children: e => {
      ...
      return t === a.z.REPORT_TO_MOD_NEW_TAG ? (0, r.jsx)(o.IGR, {
        color: l.Z.BG_BRAND,
...
function T(e) {
  let t = (0, i.e7)([_.Z], () => _.Z.hasReportedMessage(e.channel_id, e.id)),
    n = (0, p.sP)(e);
  return ((0, s.zq)(() => {
    n && (0, u.Q3)(a.z.REPORT_TO_MOD_NEW_TAG, {
    ...
    action: () => {
      (0, u.Q3)(a.z.REPORT_TO_MOD_NEW_TAG, {
...
function S(e) {
  ...
  return (0, E.a4)(e) && null != n && n.isStaff() && t ? (0, r.jsx)(o.sNh, {
