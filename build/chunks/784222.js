...
let G = [D.Z5.DISALLOW_EXTERNAL, D.Z5.DISALLOW_CUSTOM],
  B = e => {
    ...
    let {
      topEmojis: q,
      newlyAddedEmojis: Q
    } = (0, R.Z)(V, l), X = (0, s.Wu)([v.ZP], () => v.ZP.getFlattenedGuildIds(), []), J = (0, s.e7)([c.ZP], () => c.ZP.expandedSectionsByGuildIds), {
      ...
      if (null != Z && null != h) {
        ...
        if (null != p) 0 !== p.unlocked.length && g(p.unlocked, {
          ...
          for (let e of B)
            ...
            let n = (l === D.Hz.REACTION && (K || z) ? W : Y).filter(e => !S.ZP.isEmojiFiltered({
              emoji: e,
              channel: t,
              intention: l
            }));
