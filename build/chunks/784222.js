...
let M = [Chunk185923.Z5.DISALLOW_EXTERNAL, Chunk185923.Z5.DISALLOW_CUSTOM],
  k = e => {
    var t;
    let {
      channel: n,
      ...
      showOnlyUnicode: G
    } = e, Z = (0, s.e7)([c.ZP], () => c.ZP.categories), F = r.useMemo(() => G ? d.ZP.getCategories() : Z, [Z, G]), B = (0, s.e7)([E.Z], () => E.Z.getGuild(null == n ? true : n.getGuildId()), [n]), V = null != (t = null == n ? true : n.getGuildId()) ? t : i, H = (0, s.e7)([c.ZP], () => c.ZP.getDisambiguatedEmojiContext(V), [V]), Y = (0, T.NJ)(V), W = (0, T.wC)(V), K = (0, T.q5)(V), {
      topEmojis: z,
      newlyAddedEmojis: q
    } = (0, A.Z)(V, p), Q = (0, s.Wu)([y.ZP], () => y.ZP.getFlattenedGuildIds(), []), X = (0, s.e7)([c.ZP], () => c.ZP.expandedSectionsByGuildIds), {
      canCreateExpressions: J
    } = (0, _.XJ)(B), $ = (0, s.e7)([O.default], () => O.default.getCurrentUser()), ee = (0, I.I5)($), et = (0, m.B4)(), en = H.getCustomEmoji(), er = e => {
      if (e.type === u.B.GUILD) return e.guildId
    }, ei = r.useMemo(() => a().groupBy(en, er), [en]), ea = (0, h.g2)({
              ...
              let t = e * u,
                ...
                a = y.slice(t, n).map((e, t) => {
                  ...
                  return {
                    ...
                    visibleRowIndex: s,
                    category: d.type,
                    subCategory: d.sectionId === N.En.TOP_GUILD_EMOJI ? (0, T.IP)(z, q, null != (r = null != (n = e.id) ? n : e.uniqueName) ? r : e.name) : N.t0.NONE
                  }
                });
              if (U.push(a), !h) {
                if (w && e === M - 1) {
          ...
          for (let e of F)
            if (e === N.UX.CUSTOM) {
              let t = t => {
                let r = ei[t];
                if (null == r) return;
                let i = r.filter(e => !M.includes(v.ZP.getEmojiUnavailableReason({
                  emoji: e,
                ...
                let a = E.Z.getGuild(t),
                  s = et || !ee && v.ZP.isEmojiCategoryNitroLocked({
                    categoryEmojis: i,
                    channel: n,
                    intention: p
                  });
            ...
            let t = (p === P.Hz.REACTION ? K : W).filter(e => !v.ZP.isEmojiFiltered({
              emoji: e,
              channel: n,
              intention: p
            }));
            ...
            let t = Y.filter(e => !v.ZP.isEmojiFiltered({
              emoji: e,
              channel: n,
              intention: p
            }));
    ...
    return r.useCallback((e, r) => {
      switch (e.type) {
        ...
        case 0: {
          ...
          if (s === P.Z5.PREMIUM_LOCKED) return void o({
            type: 0,
            emojiDescriptor: e
          });
          if (s === P.Z5.ROLE_SUBSCRIPTION_LOCKED && i.type === u.B.GUILD) return void o({
            type: 1,
            guildId: i.guildId,
            emojiId: i.id
          });
