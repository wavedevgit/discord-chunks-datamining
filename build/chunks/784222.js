...
let G = [D.Z5.DISALLOW_EXTERNAL, D.Z5.DISALLOW_CUSTOM],
  B = e => {
    ...
    } = e, B = (0, s.e7)([c.ZP], () => c.ZP.categories), V = (0, s.e7)([y.Z], () => y.Z.getGuild(null == t ? void 0 : t.getGuildId()), [t]), F = null == t ? null : t.getGuildId(), Z = (0, s.e7)([c.ZP], () => c.ZP.getDisambiguatedEmojiContext(F), [F]), H = (0, C.NJ)(F), W = (0, C.wC)(F), Y = (0, C.q5)(F), {
    ...
    } = (0, m.XJ)(V), ee = (0, s.e7)([I.default], () => I.default.getCurrentUser()), et = (0, N.I5)(ee), en = (0, g.B4)(), er = Z.getCustomEmoji(), ei = e => {
