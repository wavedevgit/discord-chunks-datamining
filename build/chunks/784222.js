...
let U = [D.Z5.DISALLOW_EXTERNAL, D.Z5.DISALLOW_CUSTOM],
  G = e => {
    let {
      channel: t,
      collapsedSections: n,
    ...
    } = e, G = (0, s.e7)([c.ZP], () => c.ZP.categories), B = (0, s.e7)([b.Z], () => b.Z.getGuild(null == t ? void 0 : t.getGuildId()), [t]), F = null == t ? null : t.getGuildId(), V = (0, s.e7)([c.ZP], () => c.ZP.getDisambiguatedEmojiContext(F), [F]), Z = (0, A.NJ)(F), H = (0, A.wC)(F), W = (0, A.q5)(F), {
    ...
    let {
      topEmojis: z,
      newlyAddedEmojis: q
    } = (0, R.Z)(F, l), Q = (0, s.Wu)([O.ZP], () => O.ZP.getFlattenedGuildIds(), []), X = (0, s.e7)([c.ZP], () => c.ZP.expandedSectionsByGuildIds), {
      canCreateExpressions: J
    } = (0, g.XJ)(B), $ = (0, s.e7)([S.default], () => S.default.getCurrentUser()), ee = (0, T.I5)($), et = (0, m.B4)({
      location: "useEmojiGrid"
    }), en = V.getCustomEmoji(), er = e => {
      ...
      if (null != V && null != h) {
        let f = Math.floor(h / (M + 2 * L)),
          ...
          m = (a, _) => {
            let p = new Map,
              ...
              b = _.guild,
              O = y.Z.getGuildId(),
              S = _.sectionId === P.En.TOP_GUILD_EMOJI,
              T = !S && null != b && O === b.id && v.length < b.getMaxEmojiSlots(),
              C = S && v.length < f && !eo,
              R = null != b && S && eo && ea === N.B.WITH_TOP_LIST && ei[b.id].length < b.getMaxEmojiSlots(),
              D = i && J && null != b && (T || C || R);
            D && R && v.length === f && v.shift();
            let L = v.length > g && null != b && _.isNitroLocked,
              k = L && !X.has(b.id);
            k && v.splice(g - 1);
            let U = eo && D && !h,
              G = Math.ceil((D || L ? v.length + 1 : v.length) / f),
              B = [];
            for (let e = 0; e < G; e++) {
              let t = 0 === e,
                n = e * f - (U && e > 0 ? 1 : 0),
                ...
                i = v.slice(n, r).map((e, n) => {
                  ...
                  return {
                    ...
                    visibleRowIndex: u,
                    category: _.type,
                    subCategory: _.sectionId === P.En.TOP_GUILD_EMOJI ? (0, A.IP)(z, q, null !== (i = null !== (r = e.id) && void 0 !== r ? r : e.uniqueName) && void 0 !== i ? i : e.name) : P.t0.NONE
                  }
                });
              if (U && t && !h && (i = [{
                  type: 1,
                  guildId: b.id,
                  name: w.NW.string(w.t["Z/r7IS"]),
                  size: M,
                  rowIndex: d,
                  columnIndex: 0,
                  visibleRowIndex: u
        ...
        if (null != p) 0 !== p.unlocked.length && m(p.unlocked, {
          ...
          for (let e of G)
            ...
            let n = (l === D.Hz.REACTION && (Y || K) ? W : H).filter(e => !I.ZP.isEmojiFiltered({
              emoji: e,
              channel: t,
              intention: l
            }));
            ...
            let n = Z.filter(e => !I.ZP.isEmojiFiltered({
              emoji: e,
              channel: t,
              intention: l
            }));
    ...
    }, [V, h, M, L, p, n, eo, ea, ei, i, J, X, t, l, z, q, ee, G, B, Q, Y, K, W, H, Z, et, es, k])
  };
var B = function(e) {
