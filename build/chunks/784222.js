      ...
      if (null != V && null != p) {
              ...
              let t = 0 === e,
                ...
                i = y.slice(n, r).map((e, n) => {
                  ...
                  return {
                    ...
                    visibleRowIndex: u,
                    category: d.type,
                    subCategory: d.sectionId === P.En.TOP_GUILD_EMOJI ? (0, A.IP)(K, z, null != (i = null != (r = e.id) ? r : e.uniqueName) ? i : e.name) : P.t0.NONE
                  }
                });
              if (G && t && !p && (i = [{
                  type: 1,
        ...
        if (null != f) 0 !== f.unlocked.length && y(f.unlocked, {
          ...
          for (let e of Z)
            ...
            let n = (l === R.Hz.REACTION ? W : Y).filter(e => !v.ZP.isEmojiFiltered({
              emoji: e,
              channel: t,
              intention: l
            }));
    ...
    return r.useCallback((e, r) => {
      switch (e.type) {
        ...
        case 0: {
          ...
          if (c === R.Z5.PREMIUM_LOCKED) return void a({
            type: 0,
            emojiDescriptor: e
          });
          if (c === R.Z5.ROLE_SUBSCRIPTION_LOCKED && s.type === u.B.GUILD) return void a({
            type: 1,
            guildId: s.guildId,
            emojiId: s.id
          });
