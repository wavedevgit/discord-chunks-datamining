...
function I(e) {
  return null == e ? true : e.map(e => {
    ...
    return e.type === u.jw.CHANNEL && "channel_types" in e ? O(b({}, r), {
      channelTypes: e.channel_types
    }) : (e.type === u.jw.NUMBER || e.type === u.jw.INTEGER) && ("min_value" in e || "max_value" in e) ? O(b({}, r), {
      minValue: e.min_value,
      maxValue: e.max_value
    }) : e.type === u.jw.STRING && ("min_length" in e || "max_length" in e) ? O(b({}, r), {
...
function S(e) {
  ...
  } else if (i.type !== u.jw.SUB_COMMAND && i.type !== u.jw.SUB_COMMAND_GROUP && (null == i.options || 0 === i.options.length)) return [v({
    rootCommand: r,
    command: i,
    applicationId: o,
    subCommandPath: a,
...
function A(e, t) {
  return l().flatMap(e, e => (a()(null != e.id, "Missing command id"), S({
    rootCommand: e,
    command: e,
