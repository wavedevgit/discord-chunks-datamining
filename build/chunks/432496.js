...
let d = new u(i.Z, {
  ...
  GUILD_MEMBERS_CHUNK_BATCH: function(e) {
    ...
    1 === s(i) && (a[i].foundMembers += r.members.length, a[i].notFoundMembers += null !== (n = null === (t = r.notFound) || void 0 === t ? void 0 : t.length) && void 0 !== n ? n : 0, a[i].foundMembers + a[i].notFoundMembers >= o && (a[i].fetchState = 2))
  }
})