...
let m = function(e) {
  let {
    onClose: t,
    transitionState: l
  } = e, m = (0, a.e7)([d.default], () => d.default.getCurrentUser()), [p, g] = i.useState(!1), y = i.useCallback(() => (null == t || t(), Promise.resolve()), [t]), h = i.useCallback(() => {
    null == t || t(), (0, c.ZDy)(async () => {
      let {
        default: e
      } = await Promise.all([n.e("9343"), n.e("11564")]).then(n.bind(n, 642298));
  ...
  }, [m, t]), j = i.useMemo(() => (null == m ? void 0 : m.email) == null ? [{
