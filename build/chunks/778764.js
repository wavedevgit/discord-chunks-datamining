...
function v(e) {
  let {
    ...
    ticket: c,
    challenge: m
  } = e, b = (0, d.Dt)(), [C, E] = r.useState(""), [v, S] = r.useState(!0), [T, N] = r.useState(x.x.INIT), [I, y] = r.useState(""), [A, P] = r.useState(null), R = async () => {
    let e;
    N(x.x.REGISTER);
    ...
    children: [(0, i.jsxs)(o.xBx, {
      ...
      children: [(0, i.jsxs)(o.Mi4, {
        ...
        children: (0, i.jsxs)("form", {
          onSubmit: e => {
            e.preventDefault(), (0, f.Sr)(C, c, I).then(async () => {
              await (0, u.Yn)(!1)
            }).then(() => a()).catch(() => {
