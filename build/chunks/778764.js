...
function j(e) {
  let {
    ...
    ticket: o,
    challenge: u
  } = e, f = (0, c.Dt)(), [C, O] = r.useState(""), [j, S] = r.useState(!0), [v, T] = r.useState(b.x.INIT), [N, I] = r.useState(""), [y, A] = r.useState(null), P = async () => {
    let e;
    T(b.x.REGISTER);
      ...
      children: [(0, i.jsxs)(a.Mi4, {
        ...
        children: [(0, i.jsxs)(a.hzk, {
          ...
          children: [(0, i.jsx)("div", {
            ...
            children: null != y && (0, i.jsx)(a.Text, {
        ...
        children: (0, i.jsxs)("form", {
          onSubmit: e => {
            e.preventDefault(), (0, h.Sr)(C, o, N).then(async () => {
              await (0, d.Yn)(!1)
            }).then(() => l()).catch(() => {
