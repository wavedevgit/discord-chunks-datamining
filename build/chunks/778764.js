...
function O(e) {
  let {
    ...
    ticket: l,
    challenge: u
  } = e, f = (0, c.Dt)(), [E, j] = i.useState(""), [O, C] = i.useState(!0), [v, S] = i.useState(b.x.INIT), [T, I] = i.useState(""), [y, A] = i.useState(null), P = async () => {
    let e;
    S(b.x.REGISTER);
    ...
    try {
      ...
      g.Z.captureException(e), A(x.NW.string(x.t.xSCvBQ)), S(b.x.INIT);
      return
    }
    I(e), S(b.x.NAME)
  };
  return (0, r.jsxs)(o.Y0X, {
    ...
    children: [(0, r.jsxs)(o.xBx, {
      ...
      children: [(0, r.jsxs)(o.X6q, {
        ...
        children: [v === b.x.INIT && x.NW.string(x.t.vrOCCg), v === b.x.REGISTER && x.NW.string(x.t.wePEBA), v === b.x.NAME && x.NW.string(x.t["cY/IOj"])]
      }), (0, r.jsx)(o.olH, {
        onClick: a,
        ...
        children: (0, r.jsxs)("form", {
          onSubmit: e => {
            e.preventDefault(), (0, h.Sr)(E, l, T).then(async () => {
              ...
              A(x.NW.string(x.t.fEptJC)), S(b.x.INIT)
            })
          },
          children: [(0, r.jsxs)(o.hzk, {
            className: _.content,
