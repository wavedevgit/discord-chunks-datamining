...
function W(e) {
  ...
  let {
    ...
    entries: o,
    viewId: d
  } = e, m = a.useMemo(() => null == r ? void 0 : r.genres.map(_.P3).join(", "), [r]), g = a.useMemo(() => {
    if (null == r) return "";
    let {
      artwork: e,
      screenshots: t
    ...
    return ""
  }, [r]), p = null == i ? void 0 : i.getIconURL(160, y.$k ? "webp" : "png"), f = w.default.extractTimestamp(i.id), x = s()().diff(s()(f), "days") <= R.G, j = o.some(e => (0, v.ig)(e) === c.o.GLOBAL), h = null != (t = r.name) ? t : null == i ? void 0 : i.name;
...
let Y = e => e.filter(N.z6).slice(0, 5),
  X = e => {
    ...
    } = (0, x.ZP)(), y = (0, d.e7)([O.default], () => O.default.locale), _ = a.useMemo(() => (0, I.fP)(), []), w = (0, d.Wu)([E.Z], () => {
      var e;
      return (null != (e = E.Z.getSimilarGames(r)) ? e : []).slice(0, 25)
    }), [N, k] = a.useState(null), C = (0, S.N)(r), [A, G] = a.useState(null), T = (0, f.q)(r), D = (0, d.e7)([h.Z], () => h.Z.getGame(r)), M = null != (t = null == D ? void 0 : D.name) ? t : null == T ? void 0 : T.name, Z = (e, t) => {
      var n;
      (0, I.UE)({
        gameName: null != M ? M : "",
        applicationId: r,
    ...
    return ((0, g.ZP)(() => {
      ...
      y.startsWith("en") || (null == D ? void 0 : D.summaryLocalized) != null || m.Z.getDetectableGamesSupplemental([r], {
        forceFetch: !0
      })
    }, [r, null == D ? void 0 : D.summaryLocalized, y]), a.useEffect(() => {
      (async () => {
        if (0 === w.length) {
          k(null);
          try {
    ...
    }), null == D || null == T) ? null : (0, n.jsx)(u.Y0X, {
      transitionState: s,
      size: u.CgR.DYNAMIC,
