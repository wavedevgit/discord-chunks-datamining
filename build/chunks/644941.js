...
function F(e) {
  ...
  let {
    ...
    entries: s,
    viewId: u
  } = e, m = i.useMemo(() => null == r ? void 0 : r.genres.map(b.P3).join(", "), [r]), g = i.useMemo(() => {
    if (null == r) return "";
    let {
      artwork: e,
      screenshots: t
    ...
    return ""
  }, [r]), f = null == a ? void 0 : a.getIconURL(160, j.$k ? "webp" : "png"), p = I.default.extractTimestamp(a.id), O = o()().diff(o()(p), "days") <= k.G, x = s.some(e => (0, E.ig)(e) === c.o.GLOBAL), v = null != (t = r.name) ? t : null == a ? void 0 : a.name;
        ...
        children: (0, n.jsxs)("div", {
          children: [(0, n.jsx)(d.X6q, {
            ...
            children: [null != f && (0, n.jsx)("img", {
              ...
              src: f,
              height: 16,
              alt: K.intl.formatToPlainString(K.t["nh+jWl"], {
                game: v
              })
            }), (0, n.jsx)(d.Text, {
...
let B = e => e.filter(N.z6).slice(0, 5),
  z = e => {
    ...
    } = (0, p.ZP)(), b = (0, u.e7)([h.default], () => h.default.locale), I = i.useMemo(() => (0, y.fP)(), []), N = (0, u.Wu)([S.Z], () => {
      var e;
      return (null != (e = S.Z.getSimilarGames(r)) ? e : []).slice(0, 25)
    }), [w, A] = i.useState(null), C = (0, P.N)(r), [L, T] = i.useState(null), M = (0, f.q)(r), R = (0, u.e7)([x.Z], () => x.Z.getGame(r)), D = null != (t = null == R ? void 0 : R.name) ? t : null == M ? void 0 : M.name, G = (e, t) => {
      var n;
      (0, y.UE)({
        gameName: null != D ? D : "",
        applicationId: r,
    ...
    return ((0, g.ZP)(() => {
      ...
      b.startsWith("en") || (null == R ? void 0 : R.summaryLocalized) != null || m.Z.getDetectableGamesSupplemental([r], {
        forceFetch: !0
      })
    }, [r, null == R ? void 0 : R.summaryLocalized, b]), i.useEffect(() => {
      (async () => {
        if (0 === N.length) {
          A(null);
          try {
    ...
    }), null == R || null == M) ? null : (0, n.jsx)(d.Y0X, {
      transitionState: o,
      size: d.CgR.DYNAMIC,
