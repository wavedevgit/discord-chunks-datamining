...
function Y(e) {
  ...
  let {
    ...
    entries: s,
    viewId: u
  } = e, m = i.useMemo(() => null == r ? void 0 : r.genres.map(I.P3).join(", "), [r]), g = i.useMemo(() => {
    if (null == r) return "";
    let {
      artwork: e,
      screenshots: t
    ...
    return ""
  }, [r]), f = null == a ? void 0 : a.getIconURL(160, b.$k ? "webp" : "png"), p = y.default.extractTimestamp(a.id), O = o()().diff(o()(p), "days") <= K.G, E = s.some(e => (0, x.ig)(e) === c.o.GLOBAL), v = null != (t = r.name) ? t : null == a ? void 0 : a.name;
...
function B(e) {
  let {
    ...
    onClose: s,
    applicationId: o
  } = e, c = (0, h.u)(o, f.Z.GAME_PROFILE), u = i.useCallback(e => {
    r(e)
  }, [r]);
  return (0, n.jsxs)("div", {
...
let z = e => e.filter(w.z6).slice(0, 5),
  H = e => {
    ...
    } = (0, O.ZP)(), b = (0, u.e7)([j.default], () => j.default.locale), I = i.useMemo(() => (0, _.fP)(), []), y = (0, u.Wu)([P.Z], () => {
      var e;
      return (null != (e = P.Z.getSimilarGames(r)) ? e : []).slice(0, 25)
    }), [w, A] = i.useState(null), C = (0, N.N)(r), [L, M] = i.useState(null), T = (0, p.q)(r), R = (0, u.e7)([v.Z], () => v.Z.getGame(r)), G = null != (t = null == R ? void 0 : R.name) ? t : null == T ? void 0 : T.name, D = (e, t) => {
      var n;
      (0, _.UE)({
        gameName: null != G ? G : "",
        applicationId: r,
    ...
    }), null == R || null == T) ? null : (0, n.jsx)(d.Y0X, {
      transitionState: o,
      size: d.CgR.DYNAMIC,
