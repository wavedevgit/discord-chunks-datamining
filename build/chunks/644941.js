...
function W(e) {
  ...
  let {
    ...
    return ""
  }, [r]), p = null == i ? void 0 : i.getIconURL(160, y.$k ? "webp" : "png"), f = I.default.extractTimestamp(i.id), x = s()().diff(s()(f), "days") <= R.G, j = o.some(e => (0, v.ig)(e) === c.o.GLOBAL), h = null != (t = r.name) ? t : null == i ? void 0 : i.name;
...
let Y = e => e.filter(S.z6).slice(0, 5),
  X = e => {
    ...
    }), [S, C] = a.useState(null), k = (0, N.N)(r), [A, G] = a.useState(null), T = (0, f.q)(r), M = (0, d.e7)([h.Z], () => h.Z.getGame(r)), D = null != (t = null == M ? void 0 : M.name) ? t : null == T ? void 0 : T.name, L = (e, t) => {
      var n;
      (0, w.UE)({
        gameName: null != D ? D : "",
        applicationId: r,
    ...
    return ((0, g.ZP)(() => {
      ...
      y.startsWith("en") || (null == M ? void 0 : M.summaryLocalized) != null || m.Z.getDetectableGamesSupplemental([r], {
        forceFetch: !0
      })
    }, [r, null == M ? void 0 : M.summaryLocalized, y]), a.useEffect(() => {
      (async () => {
        if (0 === I.length) {
          C(null);
          try {
