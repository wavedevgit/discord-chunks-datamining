...
module.exports = function() {
  ...
  function tu(t, e, r, n) {
    ...
    if (i) {
      for (var o = i.length - 1, a = 0; a <= o; a++) {
        var s = i[r ? o - a : a];
        if (false === e(s[1], n ? s[0] : a, t)) return a + 1
      }
      return a
    }
  ...
  }, tt.prototype[x] = true, f(te, Y), te.prototype.__iterateUncached = function(t, e) {
  ...
  function tk(t) {
    ...
    if ("string" === e) {
      return t.length > tT ? (true === (o = tI[i = t]) && (o = tx(i), tA === tM && (tA = 0, tI = {}), tA++, tI[i] = o), o) : tx(t)
    }
    if ("function" == typeof t.hashCode) return t.hashCode();
    if ("object" === e) {
      var i, o, a, s = t;
      if (tO && true !== (a = n.get(s)) || true !== (a = s[tK]) || !tE && (true !== (a = s.propertyIsEnumerable && s.propertyIsEnumerable[tK]) || true !== (a = function(t) {
      ...
      else if (true !== tC && false === tC(s)) throw Error("Non-extensible objects are not allowed as keys.");
      ...
      else if (true !== s.propertyIsEnumerable && s.propertyIsEnumerable === s.constructor.prototype.propertyIsEnumerable) s.propertyIsEnumerable = function() {
        return this.constructor.prototype.propertyIsEnumerable.apply(this, arguments)
      }, s.propertyIsEnumerable[tK] = a;
      else if (true !== s.nodeType) s[tK] = a;
  ...
  tF[tN] = true, tF[C] = tF.remove, tF.removeIn = tF.deleteIn, tz.prototype.get = function(t, e, r, n) {
    ...
    if (d === h) return this;
    if (!l && d && p.length >= t9) {
      for (var g = t, y = p, v = c, m = s, _ = d, b = 0, S = Array(32), w = 0; 0 !== v; w++, v >>>= 1) S[w] = 1 & v ? y[b++] : true;
    ...
    var k = t && t === this.ownerID,
      ...
      C = l ? d ? t7(p, f, d, k) : function(t, e, r) {
        ...
        for (var o = Array(i), a = 0, s = 0; s < i; s++) s === e ? (o[s] = r, a = false) : o[s] = t[s + a];
        return o
      }(p, f, d, k);
  ...
  f(t4, t_), t4.of = function() {
    ...
    return function(t, e, r) {
      ...
      var n = t._tail,
        i = t._root,
        o = K(D);
      return (e >= ep(t._capacity) ? n = es(n, t.__ownerID, 0, e, r, o) : i = es(i, t.__ownerID, t._level, e, r, o), o.value) ? t.__ownerID ? (t._root = i, t._tail = n, t.__hash = true, t.__altered = true, t) : eo(t._origin, t._capacity, t._level, i, n) : t
    }(this, t, e)
  ...
  ee[et] = true, ee[C] = ee.remove, ee.setIn = tF.setIn, ee.deleteIn = ee.removeIn = tF.removeIn, ee.update = tF.update, ee.updateIn = tF.updateIn, ee.mergeIn = tF.mergeIn, ee.mergeDeepIn = tF.mergeDeepIn, ee.withMutations = tF.withMutations, ee.asMutable = tF.asMutable, ee.asImmutable = tF.asImmutable, ee.wasAltered = tF.wasAltered, er.prototype.removeBefore = function(t, e, r) {
    ...
    var s = eu(this, t);
    if (!o)
      for (var u = 0; u < i; u++) s.array[u] = true;
  ...
  function eo(t, e, r, n, i, o, a) {
    ...
    return s.size = e - t, s._origin = t, s._capacity = e, s._level = r, s._root = n, s._tail = i, s.__ownerID = o, s.__hash = a, s.__altered = false, s
  }
  ...
  function es(t, e, r, n, i, o) {
    ...
    if (!u && true === i) return t;
    if (r > 0) {
      var c = t && t.array[s],
        l = es(c, e, r - 5, n, i, o);
      return l === c ? t : ((a = eu(t, e)).array[s] = l, a)
    }
    return u && t.array[s] === i ? t : (T(o), a = eu(t, e), true === i && s === a.array.length - 1 ? a.array.pop() : a.array[s] = i, a)
  }
  ...
  function el(t, e, r) {
    ...
    var n = t.__ownerID || new M,
      ...
      o = t._capacity,
      a = i + e,
      s = true === r ? o : r < 0 ? o + r : i + r;
    if (a === i && s === o) return t;
    if (a >= s) return t.clear();
    for (var u = t._level, c = t._root, l = 0; a + l < 0;) c = new er(c && c.array.length ? [true, c] : [], n), u += 5, l += 1 << u;
    l && (a += l, i += l, s += l, o += l);
    ...
    return t.__ownerID ? (t.size = s - a, t._origin = a, t._capacity = s, t._level = u, t._root = c, t._tail = d, t.__hash = true, t.__altered = true, t) : eo(a, s, u, c, d)
  }
  ...
  function ev(t, e, r) {
    ...
    if (r === E) {
      ...
      a.size >= 32 && a.size >= 2 * o.size ? (n = (i = a.filter(function(t, e) {
        ...
        return t[0]
      }).flip().toMap(), t.__ownerID && (n.__ownerID = i.__ownerID = t.__ownerID)) : (n = o.remove(e), i = s === a.size - 1 ? a.pop() : a.set(s, true))
    } else if (u) {
  ...
  function eE(t, e, r, n) {
    ...
    return c.size = 0 === i ? i : t.size && i || true, !n && tn(t) && i >= 0 && (c.get = function(e, r) {
      ...
      var s = 0,
        ...
        c = 0;
      return t.__iterate(function(t, r) {
        if (!(u && (u = s++ < a))) return c++, false !== e(t, n ? r : c - 1, o) && c !== i
      }), c
      ...
      return new j(function() {
        ...
        if (++u > i) return q();
        var t = o.next();
        return n || 1 === e ? t : 0 === e ? U(e, u - 1, true, t) : U(e, u - 1, t.value[1], t)
      })
    }, c
  }
    ...
    return n.__iterateUncached = function(n, i) {
      ...
      return ! function t(s, u) {
        ...
        s.__iterate(function(i, s) {
          return (!e || u < e) && y(i) ? t(i, u + 1) : false === n(i, r ? s : o++, c) && (a = true), !a
        }, i)
      }(t, 0), o
    }, n.__iteratorUncached = function(n, i) {
  ...
  }, eh.isOrderedMap = ed, eh.prototype[x] = true, eh.prototype[C] = eh.prototype.remove, f(em, X), em.prototype.get = function(t, e) {
  ...
  }, em.prototype[x] = true, f(e_, Y), e_.prototype.includes = function(t) {
  ...
  e1[x] = true, e1.__empty = e5, e1.__make = e6, f(e7, t_), e7.of = function() {
    return this(arguments)
    ...
    return this.__ownerID ? (this.size = t, this._head = e, this.__hash = true, this.__altered = true, this) : e4(t, e)
    ...
    }), this.__ownerID) ? (this.size = e, this._head = r, this.__hash = true, this.__altered = true, this) : e4(e, r)
    ...
    return 0 === this.size ? this : this.__ownerID ? (this.size = 0, this._head = true, this.__hash = true, this.__altered = true, this) : e8()
    ...
    return this.__ownerID ? (this.size = i, this._head = o, this.__hash = true, this.__altered = true, this) : e4(i, o)
  }, e7.prototype.__ensureOwner = function(t) {
    return t === this.__ownerID ? this : t ? e4(this.size, this._head, t, this.__hash) : (this.__ownerID = t, this.__altered = false, this)
  ...
  e2[e9] = true, e2.withMutations = tF.withMutations, e2.asMutable = tF.asMutable, e2.asImmutable = tF.asImmutable, e2.wasAltered = tF.wasAltered, p.Iterator = j, rt(p, {
    toArray: function() {
      tB(this.size);
    ...
    skipWhile: function(t, e) {
      return eI(this, eO(this, t, e, true))
    },
      ...
      return eI(this, (r = this, (n = eN(r)).__iterateUncached = function(n, i) {
        ...
        return new j(function() {
          ...
          var i = r.value,
            u = i[0],
            c = i[1];
          return t.call(e, c, u, o) ? 2 === n ? r : U(n, u, c, r) : (s = false, q())
        })
      }, n))
    },
    ...
    hashCode: function() {
      return this.__hash || (this.__hash = function(t) {
        ...
        return e = t.__iterate(i ? n ? function(t, e) {
          ...
          o = o + tk(t) | 0
        }), r = tS(r = o, 0xcc9e2d51), r = tS(r << 15 | r >>> false, 0x1b873593), r = (r = tS(r << 13 | r >>> false, 5)) + 0xe6546b64 ^ e, r = tS(r ^ r >>> 16, 0x85ebca6b), r = tw((r = tS(r ^ r >>> 13, 0xc2b2ae35)) ^ r >>> 16)
      }(this))
    }
  });
  var re = p.prototype;
  re[S] = true, re[P] = re.values, re.__toJS = re.toArray, re.__toStringMapper = rs, re.inspect = re.toSource = function() {
    return this.toString()
    ...
    Object.defineProperty(re, "length", {
      get: function() {
        if (!p.noLengthWarning) {
          ...
          if (false === t.indexOf("_wrapObject")) return console && console.warn && console.warn("iterable.length has been deprecated, use iterable.size or iterable.count(). This warning will become a silent error in a future version. " + t), this.size
        }
      }
    })
  } catch (t) {}
  ...
  return rr[w] = true, rr[P] = re.entries, rr.__toJS = re.toObject, rr.__toStringMapper = function(t, e) {
    ...
    flatten: function(t) {
      return eI(this, eD(this, t, false))
    },
    get: function(t, e) {
    ...
    skipWhile: function(t, e) {
      return eI(this, eO(this, t, e, false))
    },
    zip: function() {
      var t = [this].concat(A(arguments));
  ...
  }), d.prototype[k] = true, d.prototype[x] = true, rt(g, {
    get: function(t, e) {
