/** Chunk was on web.js **/
/** chunk id: 614792, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  A: () => g
}), require("./896048.js"), require("./638769.js"), require("./264879.js");
var Chunk61090 = require("./61090.js"),
  Chunk100245 = require("./100245.js");
...
class m extends h {
  ...
  appStateChanged(e) {
    "active" === e && (null == this.firstAppActiveTime && (this.firstAppActiveTime = Date.now()), this.wasEverActive = true), null == this.readyProperties.num_guilds && (this.didBackgroundApp = this.didBackgroundApp || "active" !== e)
  }
  recordRender(e, t) {
  ...
  serializeTTITracker(e) {
    ...
    return l(s({}, this.extraProperties, p), {
      ...
      cache_num_basic_channels_stale: null == (o = this.cacheInfo) ? true : o.basicChannelsStale,
