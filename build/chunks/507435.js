...
function j(e) {
  ...
  } = e, d = n.embeds[0], p = i.useMemo(() => (0, h.Z)(d), [d]), _ = (0, o.aF)(null != (t = null == p ? void 0 : p.questionText) ? t : "", b.Dv), C = (0, m.ZP)(n), v = (0, f.l)({
    user: n.author,
    channelId: l.id,
    guildId: l.guild_id,
    messageId: n.id
  }), y = n.messageReference, j = i.useCallback(() => {
    null != y && u.Z.jumpToMessage({
