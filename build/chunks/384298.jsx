...
function g(e) {
  ...
  let y = () => E === p.lY.MODAL || E === p.lY.MODAL_V2 ? m.intl.string(m.t["3xjX0d"]) : t.isDM() || t.isGroupDM() ? m.intl.string(m.t["7hwn2N"]) : t.isGuildStageVoice() ? m.intl.string(m.t.Acqcoq) : m.intl.string(m.t.BXxdl5),
    ...
    v = e => {
      ...
      }), t.isGuildStageVoice() ? (0, c.Cq)(t) : (a.default.selectVoiceChannel(t.id), (0, l.Kh)(t.id)), null == g || g()
    };
  return E === p.lY.MODAL_V2 ? <_.tG text={b ? y() : O()} size={o.Ph.TINY} themeColor={"secondary"} onClick={v} /> : <_.tG text={b ? y() : O()} size={o.Ph.SMALL} themeColor={"secondary"} fullWidth={true} onClick={v} />
}