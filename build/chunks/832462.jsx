...
function d(e) {
  ...
  }, [n, t]), <s.VerifyAccountLoading platformType={t} />
}
let f = function(e) {
  let {
    match: t
  ...
  return [u.ABu.XBOX, u.ABu.PLAYSTATION_STAGING, u.ABu.PLAYSTATION, u.ABu.CRUNCHYROLL].includes(n) && c === a.g.DESKTOP ? <d platformType={n} /> : null
}