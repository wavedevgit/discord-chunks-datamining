...
function B(e) {
  let {
    ...
    availableSounds: n,
    guildId: i
  } = e, l = C.Z.getGuild(i), s = null != l ? (0, E.nL)(l) : 0;
  return 0 === t ? (0, r.jsx)(r.Fragment, {
    ...
    children: [(0, r.jsx)(u.ua7, {
      text: D.intl.formatToPlainString(D.t.tuuJJS, {
        currentBoostLevel: t
      }),
...
let F = e => {
    ...
    let [s, a] = i.useState(!1), o = i.useMemo(() => new d.V7, []), c = i.useCallback(() => {
      o.stop(), a(!0)
    }, [o]), m = i.useCallback(() => {
      o.start(200, () => a(!1))
    }, [o]);
    return (0, r.jsx)(u.yRy, L(k({
      shouldShow: s,
  ...
  z = () => (0, r.jsx)(F, {
    ...
    renderPopoutChildren: e => (0, r.jsx)(u.zxk, L(k({}, e), {
      disabled: !0,
...
function H(e) {
  ...
  } = (0, f.XJ)(t), o = i.useRef(null), d = (0, p.ZP)(), m = t.premiumTier, g = (0, E.yw)(t, l, m);
  i.useEffect(() => {
    (0, x.w)()
  }, []);
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(u.$i$, {
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(U, {
            children: D.intl.string(D.t.sMOuub)
          }), (0, r.jsx)(U, {
            children: D.intl.string(D.t.lLFvlZ)
          }), (0, r.jsx)(U, {
            children: D.intl.string(D.t["85qMS0"])
          })]
        }), l.map(e => (0, r.jsx)(V, {
          sound: e,
          isPlaying: !1,
...
function V(e) {
  let {
    ...
    emojiId: j,
    emojiName: _
  } = t, C = (0, c.e7)([y.default], () => null != h ? h : y.default.getUser(b), [b, h]), {
    canManageGuildExpression: N
  } = (0, f.XJ)(o), E = i.useMemo(() => N(t), [t, N]), S = null != j || null != _, [P, w] = i.useState(!1), Z = (0, v.z)(t, o.id);
  async function M() {
    if (!P) {
      w(!0);
      try {
  ...
  let G = i.useCallback(() => {
      null != C && (0, O.openUserProfileModal)({
        userId: C.id,
        guildId: o.id,
        analyticsLocation: {
          section: R.jXE.GUILD_SETTINGS_SOUNDBOARD
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [S ? (0, r.jsx)(g.Z, {
      ...
      children: [(0, r.jsx)(u.P3F, {
        ...
        onClick: function(e) {
          e.stopPropagation(), (0, u.h7j)(e => (0, r.jsx)(u.ConfirmModal, L(k({
            header: D.intl.formatToPlainString(D.t["PR/VbG"], {
              soundName: p
            }),
            ...
            children: (0, r.jsx)(u.Text, {
              ...
              children: D.intl.format(D.t["u6+CmJ"], {
                soundName: p
              })
            })
          })))
