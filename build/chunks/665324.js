...
function U(e) {
  let {
    ...
    availableSounds: n,
    guildId: i
  } = e, s = O.Z.getGuild(i), l = null != s ? (0, E.nL)(s) : 0;
...
let B = e => {
    ...
    let [l, a] = i.useState(!1), o = i.useMemo(() => new d.V7, []), c = i.useCallback(() => {
      o.stop(), a(!0)
    }, [o]), m = i.useCallback(() => {
      o.start(200, () => a(!1))
    }, [o]);
...
function H(e) {
  let {
    ...
    emojiId: j,
    emojiName: N
  } = t, O = (0, c.e7)([C.default], () => null != h ? h : C.default.getUser(b), [b, h]), {
  ...
  let M = i.useCallback(() => {
      null != O && (0, v.openUserProfileModal)({
        userId: O.id,
        guildId: o.id,
        analyticsLocation: {
          section: R.jXE.GUILD_SETTINGS_SOUNDBOARD
