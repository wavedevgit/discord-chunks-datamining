...
function $(e) {
  let {
    ...
    emojiConfetti: ez,
    soundEffect: eq
  } = (0, w.wD)(), eX = c.CgR.SMALL;
  e_ || (null == eH ? true : eH.isLargeModal) ? eX = c.CgR.LARGE : ep || (null == eH ? true : eH.isMediumModal) ? eX = c.CgR.MEDIUM : (eD === L.h8.ADD_PAYMENT_STEPS || eh || (null == eH ? true : eH.isDynamicModal)) && (eX = c.CgR.DYNAMIC);
  let eQ = (0, v.N)(),
