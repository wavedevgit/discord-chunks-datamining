...
function m(e) {
  ...
  return o()(null != S, "Expected premium type"), <C.Z premiumType={S} titleText={x.intl.string(x.t["7VcWW1"])} subtitleText={x.intl.format(x.t.Qk34Ii, {
      subscriptionName: y
    })} footer={(0, t.jsxs)("div", {
