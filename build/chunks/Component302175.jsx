...
function G(e) {
  ...
  } = (0, p.ZP)(), T = n !== C.A3.INACTIVE, P = (0, S.Z)(t), [L, j] = i.useState(false), [k, G] = i.useState(false), Z = k, B = i.useCallback(() => {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)("div", {
      ...
      children: [(0, r.jsx)(m.xm, {
        heading: a,
        description: c,
        label: w.intl.formatToPlainString(R.default.QOacIS, {
          quantity: u,
          decorator: null != g ? g : ""
        }),
        isEnabled: T
...
let B = 3,
  F = Chunk473749.forwardRef((e, t) => {
    ...
    let o = (0, E.BU)(n.id, "GuildPowerupsMarketingPowerupCards"),
      ...
      l = (0, I.Z)(n.id),
      d = (null != l ? l : []).slice(0, B);
    return 0 === d.length ? null : (0, r.jsxs)("div", {
      ref: t,
      className: D.container,
      children: [(0, r.jsx)(c.X6q, {
        variant: "heading-xxl/extrabold",
        children: w.intl.string(R.default.wjI18Q)
      }), (0, r.jsx)(c.xvT, {
        variant: "text-lg/medium",
        children: w.intl.format(R.default.S562fn, {
        ...
        children: [d.map(e => (0, r.jsx)(Z, {
          ...
          powerup: e,
          onClose: a
        }, "guild-powerup-marketing-".concat(e.skuId))), o && d.length < B && null != s && (0, r.jsx)(G, {
          guildId: n.id,
          activeStatus: C.A3.INACTIVE,
          title: w.intl.string(P.default["B3OfL/"]),
          description: w.intl.string(P.default.EGkJAG),
          cost: s,
          costDecorator: "+",
          imageUrl: L.Z,
          onClose: a,
