...
function M(e) {
  ...
  let {
  ...
  }, [ee]), el = (0, y.X)(null == ee ? void 0 : ee.guildId, er), {
    reducedMotion: ea
    ...
    null != H && ((0, m.yw)(A.rMx.MEDIA_POST_PREVIEW_EMBED_CLICKED, {
      ...
      is_member: $
    }), H.canAccess ? (0, _.Z)(A.Z5c.CHANNEL(H.guildId, H.threadId, H.messageId)) : $ ? (0, _.Z)(A.Z5c.CHANNEL(H.guildId, H.parentChannelId)) : await I.Ub(H.guildId, {}, {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [null != H.authorId && null != em && (0, r.jsx)(v.Z, {
          targetElementRef: G,
          userId: H.authorId,
          guildId: H.guildId,
          channelId: F.id,
