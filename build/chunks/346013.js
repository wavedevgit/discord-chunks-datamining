...
function F(e) {
  ...
  let {
    ...
    setPopout: H
  } = (0, E.Z)(F.id, R.d$), V = (0, v.qo)(F, B, H, !0), z = C.QK.useSetting(), K = (0, A.n)(), [Y, X] = i.useState(!1), [q, Q] = i.useState((null == G ? void 0 : G.coverImage) == null), J = (0, d.e7)([m.Z], () => m.Z.useReducedMotion), $ = (0, d.e7)([I.ZP, S.default], () => {
    var e;
    return I.ZP.isMember(null == G ? void 0 : G.guildId, null == (e = S.default.getCurrentUser()) ? void 0 : e.id)
  }, [G]), ee = (0, d.e7)([I.ZP], () => (null == G ? void 0 : G.authorId) != null ? I.ZP.getMember(G.guildId, G.authorId) : null), et = (0, g.Z)((null == ee ? void 0 : ee.avatarDecoration) != null ? null == ee ? void 0 : ee.avatarDecoration : null == G || null == (t = G.user) ? void 0 : t.avatarDecoration), [en, er, ei] = i.useMemo(() => {
    var e;
    return [null != (e = null == ee ? void 0 : ee.colorString) ? e : "inherit", null == ee ? void 0 : ee.colorStrings, null == ee ? void 0 : ee.colorRoleId]
  }, [ee]), ea = (0, O.E)(null == ee ? void 0 : ee.guildId, er), {
    reducedMotion: el
  } = i.useContext(p.Sfi), [eo, es] = i.useState(!1), ec = i.useCallback(() => {
    X(!0)
  }, [X]), eu = i.useCallback(() => {
    X(!1)
  }, [X]), ed = i.useCallback(async () => {
    null != G && ((0, h.yw)(k.rMx.MEDIA_POST_PREVIEW_EMBED_CLICKED, {
      media_post_id: G.threadId,
      channel_id: B.id,
      can_access: G.canAccess,
      is_member: $
    }), G.canAccess ? (0, x.Z)(k.Z5c.CHANNEL(G.guildId, G.threadId, G.messageId)) : $ ? (0, x.Z)(k.Z5c.CHANNEL(G.guildId, G.parentChannelId)) : await P.Ub(G.guildId, {}, {
      channelId: G.parentChannelId
    }))
  }, [G, B, $]), ep = i.useCallback(() => (s()((null == G ? void 0 : G.authorId) != null, "Author Id cannot be null when loading user profile"), (0, N.Z)(G.authorId, G.avatarUrl, {
    guildId: G.guildId,
    channelId: B.id
  })), [G, B]);
  if (null == G) return null;
  let em = (e, t) => (s()(null != G.authorId, "Author Id cannot be null when rendering user popout"), (0, r.jsx)(j.Z, U(W({}, e), {
      userId: G.authorId,
      guildId: G.guildId,
      channelId: B.id,
      messageId: F.id,
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      onMouseEnter: ec,
      onMouseLeave: eu,
      children: [!q && (!0 === G.shouldShowBlurredThumbnailImage ? (0, r.jsx)("img", {
        src: M,
        alt: D.NW.string(D.t.rIbh8P),
        className: l()(L.thumbnail, {
          [L.spoiler]: G.shouldSpoiler
        }),
        onContextMenu: V,
        onError: () => Q(!0)
      }) : (0, r.jsx)(b.Z, {
        ...
        onContextMenu: V,
        onError: () => Q(!0)
      })), null != G.coverImageOverlayText && (0, r.jsx)(p.P3F, {
        onClick: ed,
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [null != eh && (0, r.jsx)(p.yRy, {
          ...
          children: [(0, r.jsxs)("div", {
            ...
            children: [null != G.channelName && (0, r.jsx)(p.EAQ, {
              size: "md",
              color: "currentColor",
          ...
          }), null != G.authorName && (0, r.jsx)(p.Text, {
            ...
            children: D.NW.format(D.t.voIDKS, {
              ...
              authorNameHook: () => (0, r.jsx)(p.yRy, {
                ...
                position: "right",
                preload: null == G.authorId ? void 0 : ep,
                children: e => (0, r.jsx)(p.rz2, U(W({}, e), {
                  name: G.authorName,
                  color: en,
                  roleGradient: ea,
