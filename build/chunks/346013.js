...
function M(e) {
  ...
  let {
    ...
    null != H && ((0, p.yw)(P.rMx.MEDIA_POST_PREVIEW_EMBED_CLICKED, {
      media_post_id: H.threadId,
      channel_id: F.id,
      can_access: H.canAccess,
      is_member: J
    }), H.canAccess ? (0, g.Z)(P.Z5c.CHANNEL(H.guildId, H.threadId, H.messageId)) : J ? (0, g.Z)(P.Z5c.CHANNEL(H.guildId, H.parentChannelId)) : await j.Ub(H.guildId, {}, {
