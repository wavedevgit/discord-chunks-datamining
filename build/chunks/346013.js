...
function M(e) {
  ...
  let {
    ...
    message: U,
    channel: F
  } = e, B = i.useRef(null), G = i.useRef(null), V = (0, N.J)(k, U), {
    setPopout: H
  } = (0, E.Z)(U.id, A.d$), z = (0, b.qo)(U, F, H, !0), W = O.QK.useSetting(), K = (0, S.n)(), [Y, X] = i.useState(!1), [q, Q] = i.useState((null == V ? void 0 : V.coverImage) == null), J = (0, c.e7)([x.ZP, y.default], () => {
    var e;
    return x.ZP.isMember(null == V ? void 0 : V.guildId, null == (e = y.default.getCurrentUser()) ? void 0 : e.id)
  }, [V]), $ = (0, c.e7)([x.ZP], () => (null == V ? void 0 : V.authorId) != null ? x.ZP.getMember(V.guildId, V.authorId) : null), ee = (0, m.Z)((null == $ ? void 0 : $.avatarDecoration) != null ? null == $ ? void 0 : $.avatarDecoration : null == V || null == (t = V.user) ? void 0 : t.avatarDecoration), [et, en, er] = i.useMemo(() => {
    var e, t;
    ...
    reducedMotion: el
  } = i.useContext(u.Sfi), [ea, eo] = i.useState(!1), es = i.useCallback(() => {
    X(!0)
  }, [X]), ec = i.useCallback(() => {
    X(!1)
  }, [X]), eu = i.useCallback(async () => {
    null != V && ((0, p.yw)(P.rMx.MEDIA_POST_PREVIEW_EMBED_CLICKED, {
      media_post_id: V.threadId,
      channel_id: F.id,
      can_access: V.canAccess,
      is_member: J
    }), V.canAccess ? (0, _.Z)(P.Z5c.CHANNEL(V.guildId, V.threadId, V.messageId)) : J ? (0, _.Z)(P.Z5c.CHANNEL(V.guildId, V.parentChannelId)) : await j.Ub(V.guildId, {}, {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [null != V.authorId && null != ep && (0, r.jsx)(v.Z, {
          targetElementRef: G,
          userId: V.authorId,
          guildId: V.guildId,
          channelId: F.id,
          ...
          children: [(0, r.jsxs)("div", {
            ...
            children: w.intl.format(w.t.voIDKS, {
              ...
              authorNameHook: () => null == V.authorId ? (0, r.jsx)(u.rz2, {
                name: V.authorName,
                colorString: et,
                colorStrings: ei,
