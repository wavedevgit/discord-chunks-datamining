...
function M(e) {
  ...
  let {
    ...
    setPopout: G
  } = (0, E.Z)(U.id, w.d$), H = (0, y.qo)(U, F, G, !0), V = O.QK.useSetting(), z = (0, N.n)(), [W, K] = i.useState(!1), [Y, X] = i.useState((null == B ? void 0 : B.coverImage) == null), q = (0, c.e7)([d.Z], () => d.Z.useReducedMotion), Q = (0, c.e7)([j.ZP, C.default], () => {
    var e;
  ...
  }, [J]), er = (0, x.X)(null == J ? void 0 : J.guildId, et), {
    reducedMotion: ei
  } = i.useContext(u.Sfi), [el, ea] = i.useState(!1), eo = i.useCallback(() => {
    K(!0)
  }, [K]), es = i.useCallback(() => {
    K(!1)
  }, [K]), ec = i.useCallback(async () => {
    null != B && ((0, m.yw)(A.rMx.MEDIA_POST_PREVIEW_EMBED_CLICKED, {
      media_post_id: B.threadId,
      channel_id: F.id,
      can_access: B.canAccess,
      is_member: Q
    }), B.canAccess ? (0, _.Z)(A.Z5c.CHANNEL(B.guildId, B.threadId, B.messageId)) : Q ? (0, _.Z)(A.Z5c.CHANNEL(B.guildId, B.parentChannelId)) : await I.Ub(B.guildId, {}, {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      onMouseEnter: eo,
      onMouseLeave: es,
      children: [!Y && (!0 === B.shouldShowBlurredThumbnailImage ? (0, r.jsx)("img", {
        src: k,
        alt: Z.intl.string(Z.t.rIbh8P),
        className: a()(R.thumbnail, {
          [R.spoiler]: B.shouldSpoiler
        }),
        onContextMenu: H,
        onError: () => X(!0)
      }) : (0, r.jsx)(g.Z, {
        ...
        onContextMenu: H,
        onError: () => X(!0)
      })), null != B.coverImageOverlayText && (0, r.jsx)(u.P3F, {
        onClick: ec,
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [null != B.authorId && null != ed && (0, r.jsx)(v.Z, {
          ...
          children: [(0, r.jsxs)("div", {
            ...
            children: [null != B.channelName && (0, r.jsx)(u.EAQ, {
              size: "md",
              color: "currentColor",
