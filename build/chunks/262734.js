...
function O(e) {
  let {
    frame: t
  } = e, n = (0, c.q)(t.applicationId), l = i.useRef(null), O = i.useRef(null), [y, I] = i.useState({
    width: 0,
    height: 0
  }), v = i.useCallback(() => {
    (0, d.eU)({
  ...
  }, [t.applicationId]), C = i.useCallback(() => {
    (0, d.xT)({
      applicationId: t.applicationId
    })
  }, [t.applicationId]);
  i.useLayoutEffect(() => {
    ...
    let e = e => {
      null == l.current || l.current.contains(e.target) || (0, d.eU)({
        applicationId: t.applicationId,
        layoutMode: f.U.PIP
      })
    };
  ...
  return (0, r.jsx)(o.f6W, {
    ...
    children: e => (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)("div", {
        ...
        children: (0, r.jsx)("div", {
          className: a()(_.activityContainer, {
            [_.activityContainerNoMargin]: P
          }),
          style: {
            paddingLeft: N,
            paddingRight: N,
