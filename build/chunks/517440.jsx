...
function y(t) {
  let e = c.C.useExperiment({
    ...
    j = function(t, e) {
      ...
      return <o.sNh id={"fix-grammar"} label={n ? f.intl.string(f.t.p54KYW) : f.intl.string(f.t.fCpOHh)} icon={o.$2U} action={r} disabled={n} />
    }(m, S),
    T = function(t, e) {
      let [i, c] = a.useState(false), d = (0, r.e7)([u.default], () => u.default.locale), b = a.useCallback(async (n, l) => {
        ...
        return <o.sNh id={"translate-".concat(t.value)} label={t.name} icon={() => (0, l.jsx)("img", {
            alt: "",
            src: e,
            className: h.flagIcon
          })} action={() => b(t.value, t.name)} disabled={i} />
      });
      return <o.sNh id={"translate"} label={i ? f.intl.string(f.t.SVKIdX) : f.intl.string(f.t["6epDlZ"])} action={() => b()} disabled={i}>{p}</o.sNh>
    }(m, S);
  return "" !== m.trim() && (null == e ? true : e.enableAIFeatures) ? <l.Fragment>{j}{T}</l.Fragment> : null
}