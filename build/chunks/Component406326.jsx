...
function E(e) {
  ...
  }, [t, F]), z = i.useMemo(() => R > 0 ? v.intl.format(v.t.uaR4sL, {
    filterCount: R
  }) : v.intl.string(v.t.UdhTtr), [R]), W = (0, g.u5)({
    location: "SearchHeader"
...
function w(e) {
  ...
  let {
    ...
    isPopoverVisible: u
  } = e, h = i.useRef(null), g = null != (t = p.rR.useSetting()) ? t : j.K, m = i.useCallback(e => {
    if (g !== e) {
      if (e) {
        let e = {
          type: O.aib.DMS
