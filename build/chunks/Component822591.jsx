...
let Z = "dismissedCommunityFeaturesUpsell",
  ...
  D = e => {
    let {
      ...
      onboardingEnabled: n,
      guild: l
    } = e, [c, u] = i.useState(true === o.K.get(Z)), d = (0, s.e7)([j.Z], () => {
      var e;
    ...
    let b = (0, s.e7)([_.Z], () => _.Z.getGuild("942897714956472401")),
      v = l.features.has(S.GuildFeatures.COMMUNITY) && d >= 1e3 && g && null == b;
