...
class j extends(r = l.PureComponent) {
  get analyticsLocation() {
    return O(C({}, this.props.analyticsContext.location), {
...
function I(e) {
  ...
  } = e, r = (0, p.O)(), [l, a] = (0, s.Wu)([h.Z, f.Z, g.Z], () => [h.Z.isConnected(t) || f.Z.isLaunchable(t) || null != n && g.Z.isLaunchable(n.id, n.branchId), f.Z.launchingGames.has(t)], [t, n]), o = (0, s.e7)([m.ZP], () => new Set(m.ZP.getRunningVerifiedApplicationIds()).has(t), [t]), c = (0, s.e7)([g.Z], () => null != n ? g.Z.getState(n.id, n.branchId) : null, [n]);
  return (0, i.jsx)(j, O(C({}, e), {
    analyticsContext: r,
    isLaunchable: l,
    isLaunching: a,
    isRunning: o,
