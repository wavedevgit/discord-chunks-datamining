/** Chunk was on web.js **/
/** chunk id: 436773, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  z: () => c
});
...
function c(e, t = {}) {
  ...
  for (let t in e) Object.prototype.hasOwnProperty.call(e, t) && (r.has(t) || n && i.has(t) || u && o.has(t) || d && a.has(t) || f && s.has(t) || t.endsWith("Capture") && s.has(t.slice(0, false)) || (null == _ ? true : _.has(t)) || l.test(t)) && (p[t] = e[t]);
  return p
}