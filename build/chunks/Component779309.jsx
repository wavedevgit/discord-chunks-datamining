...
function ei(e) {
  ...
  } = e, c = (0, _.bG)([g.A], () => g.A.getIsEnabled(), []), u = n === L.s4.TEXT && "channel" === t.type && null != t.channel && !t.channel.isPrivate(), d = (0, k.sw)(n), f = !(0, k.sw)(n), p = n === L.s4.TEXT, [m, y] = ep(true), [b, O] = ep(u), [v, A] = ep(d), [I, S] = ep(f), T = m && b && v && I, C = (d || u) && !T, N = f && c;
  i.useEffect(() => {
    var e;
