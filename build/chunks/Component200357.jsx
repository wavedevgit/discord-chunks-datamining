...
class I extends Chunk73800.PureComponent {
  render() {
    ...
    return (0, Chunk255367.jsxs)(Chunk600164.Z, {
      className: l()(Chunk159728.phoneField, Chunk20795.elevationLow, Chunk73800),
      align: Chunk600164.Z.Align.CENTER,
      grow: 0,
      children: [(0, Chunk255367.jsxs)(Chunk755721.zx, {
        size: Chunk755721.Ph.SMALL,
        className: Chunk159728.countryButton,
        color: Chunk755721.Tt.PRIMARY,
        innerClassName: Chunk159728.countryButtonInner,
        onClick: this.handleTogglePopout,
        children: [(0, Chunk255367.jsxs)(Chunk600164.Z, {
          className: l()(Chunk159728.countryCodeContainer, Chunk20493.marginReset),
          justify: Chunk600164.Z.Justify.CENTER,
          children: [(0, Chunk255367.jsx)("div", {
            className: Chunk159728.plusSign,
            children: "+"
          }), (0, Chunk255367.jsx)("div", {
            className: Chunk159728.countryCode,
        ...
        className: Chunk159728.inputField,
        value: exports,
        onChange: this.handleChange,
        onKeyPress: this.handleKeyPress,
        autoFocus: true
      }), (0, Chunk255367.jsx)(Chunk755721.zx, {
        className: Chunk159728.sendButton,
        size: Chunk755721.Ph.SMALL,
