...
let b = {
  ...
  _ = Chunk473749.memo(function(e) {
    let {
      ...
      config: b,
      trail: 100 * !A
    }, A ? "animate-never" : "respect-motion-settings"), M = (0, h.ee)(() => new Set(I.map(e => e.user.id)), [I, j]), z = (0, h.ee)(() => new Set(I.filter(e => x.has((0, u.V9)(e.stream))).map(e => e.user.id)), [I, x, j]);
    return r.useEffect(() => {
