...
let E = {
  ...
  _ = Chunk647438.memo(function(e) {
    let {
      ...
      config: E,
      trail: 100 * !A
    }, A ? "animate-never" : "respect-motion-settings"), M = (0, p.ee)(() => new Set(I.map(e => e.user.id)), [I, C]), V = (0, p.ee)(() => new Set(I.filter(e => S.has((0, u.V9)(e.stream))).map(e => e.user.id)), [I, S, C]);
    return r.useEffect(() => {
