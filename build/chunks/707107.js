...
let _ = 0,
  ...
  h = "function" == typeof g.encodeInto ? function(e, n) {
...
function b(e, n, t) {
  if (void 0 === t) {
    let t = g.encode(e),
      r = n(t.length, 1) >>> 0;
    return u().subarray(r, r + t.length).set(t), _ = t.length, r
  }
  let r = e.length,
    l = n(r, 1) >>> 0,
    i = u(),
...
${n.stack}` : t
    }(a[n]), r.__wbindgen_export_0, r.__wbindgen_export_1),
    l = _;
  j()[e / 4 + 1] = l, j()[e / 4 + 0] = t
}
