...
function f(e) {
  ...
  } = e, p = (0, r.e7)([o.default], () => o.default.getCurrentUser()), h = (0, r.e7)([a.Z], () => a.Z.getPremiumTypeSubscription()), m = (0, r.e7)([l.Z], () => l.Z.getPremiumTypeOverride()), g = null != f ? f : d.intl.string(d.t["2pG5GR"]), E = null != h ? (0, s.Af)(h) : null, b = void 0 !== m ? m : null != E ? (0, s.Rd)(E.planId) : null == p ? void 0 : p.premiumType, y = t === c.Si.TIER_2 && null != b && [c.p9.TIER_0, c.p9.TIER_1].includes(b);
  y && (g = d.intl.string(d.t.IJI7ys));
  let O = null != h && (0, s.m3)(h);
  if (!(null != h && h.status !== u.O0b.ACCOUNT_HOLD && !(0, i.Q0)(h.planId) && !y && void 0 === m || O)) return {
