...
function p(e) {
  let {
    ...
    forceFetch: !1
  }), b = (0, r.e7)([c.Z], () => c.Z.getPremiumTypeOverride()), y = null != p ? p : f.intl.string(f.t["2pG5GR"]), O = null != g ? (0, l.Af)(g) : null, v = void 0 !== b ? b : null != O ? (0, l.Rd)(O.planId) : null == m ? void 0 : m.premiumType, I = t === d.Si.TIER_2 && null != v && [d.p9.TIER_0, d.p9.TIER_1].includes(v);
  I && (y = f.intl.string(f.t.IJI7ys));
  let T = null != g && (0, l.m3)(g) || null != g && (0, u.o)("PremiumSubscribeButton", m, E);
  if (!(null != g && g.status !== _.O0b.ACCOUNT_HOLD && !(0, a.Q0)(g.planId) && !I && void 0 === b || T)) return {
