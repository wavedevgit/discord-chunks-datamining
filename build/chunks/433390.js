...
function f(e) {
  ...
  } = e, p = (0, r.e7)([a.default], () => a.default.getCurrentUser()), h = (0, r.e7)([o.Z], () => o.Z.getPremiumTypeSubscription()), m = (0, r.e7)([l.Z], () => l.Z.getPremiumTypeOverride()), g = null != f ? f : d.intl.string(d.t["2pG5Ga"]), E = null != h ? (0, s.Af)(h) : null, b = true !== m ? m : null != E ? (0, s.Rd)(E.planId) : null == p ? true : p.premiumType, y = t === c.Si.TIER_2 && null != b && [c.PremiumTypes.TIER_0, c.PremiumTypes.TIER_1].includes(b);
