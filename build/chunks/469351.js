...
function T(e) {
  let {
    ...
    listingsLoaded: T
  } = (0, v.eD)(t), P = (0, s.e7)([b.Z], () => b.Z.getGuild(t)), w = (0, s.e7)([j.default], () => j.default.getCurrentUser()), R = (null == P ? void 0 : P.isOwner(w)) === !0, {
    loading: Z
  } = (0, o.H)(t), [D, k] = i.useState(n ? "manage_listings" : "payment");
  (0, u.P)(P);
  let A = i.useCallback(() => {
    if (null == P) return;
  ...
  let L = (0, r.jsxs)(r.Fragment, {
    ...
    G = (0, l.EQ)(D).with("basic_info", () => (0, r.jsx)(O.Z, {
      guildId: t
    })).with("manage_listings", () => (0, r.jsx)(C.Z, {
      guildId: t
    })).with("payment", () => (0, r.jsx)(y.Z, {
      guildId: t
    })).exhaustive(),
    U = T ? (0, r.jsx)(a.njP.Panel, {
      id: D,
      children: G
    }) : (0, r.jsx)(a.$jN, {});
