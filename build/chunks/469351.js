...
function P(e) {
  let {
    ...
    listingsLoaded: P
  } = (0, O.eD)(t), w = (0, s.e7)([j.Z], () => j.Z.getGuild(t)), R = (0, s.e7)([_.default], () => _.default.getCurrentUser()), Z = null != w && (0, x.eM)(w, R), {
    loading: D
  } = (0, o.H)(t), [k, A] = i.useState(n ? "manage_listings" : "payment");
  (0, u.P)(w);
  let L = i.useCallback(() => {
    if (null == w) return;
  ...
  let M = (0, r.jsxs)(r.Fragment, {
    ...
    U = (0, l.EQ)(k).with("basic_info", () => (0, r.jsx)(C.Z, {
      guildId: t
    })).with("manage_listings", () => (0, r.jsx)(y.Z, {
      guildId: t
    })).with("payment", () => (0, r.jsx)(N.Z, {
      guildId: t
    })).exhaustive(),
    B = P ? (0, r.jsx)(a.njP.Panel, {
      id: k,
      children: U
    }) : (0, r.jsx)(a.$jN, {});
