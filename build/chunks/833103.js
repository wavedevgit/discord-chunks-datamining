...
function S(e) {
  return {
    ...
    renderOptionSuffix: r.useCallback(e => {
      ...
      if (null != t) return (0, n.jsx)(s.Text, {
...
function j(e) {
  let [t, l] = r.useState([]), [n, a] = r.useState(""), i = r.useMemo(() => {
...
function F() {
  let [e, t] = r.useState([]), l = r.useCallback(() => (0, u.Z)(), []), n = r.useCallback(e => e.date.isValid(), []), a = r.useMemo(() => e.filter(n), [e, n]), {
    beforeFilter: s,
    afterFilter: o,
    duringFilter: c
  } = k(), d = r.useCallback(() => ({
    ...
    t([])
  }, []), v = r.useCallback(() => 0 === a.length ? null : a.map(e => {
    let {
      query: t,
      date: l
    } = e, n = l.format(b.b2L);
