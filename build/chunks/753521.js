  ...
  return r.useEffect(() => {
    ...
    children: [(0, i.jsx)(d.Z, {
      ...
      children: [(0, i.jsxs)("div", {
        ...
        }) : null, v !== d.O.Customize || p ? null : (0, i.jsxs)(s.zxk, {
          onClick: () => _(d.O.Intro),
          color: s.zxk.Colors.TRANSPARENT,
          children: [(0, i.jsx)(s.whL, {
            size: "xs",
            color: "currentColor"
          }), " ", h.intl.string(h.t["13/7kZ"])]
        }), v === d.O.Intro ? (0, i.jsxs)(s.zxk, {
          onClick: () => {
            var e;
            (null == (e = T.current) ? void 0 : e.maybeChangeToAfterTab()) && _(d.O.Customize)
          },
          children: [h.intl.string(h.t.uw9zIy), " ", (0, i.jsx)(s.ZSh, {
            size: "xs",
            color: "currentColor"
          })]
        }) : v === d.O.Customize ? (0, i.jsxs)(s.zxk, {
          onClick: () => {
            _(d.O.Tips), y(O)
          },
          children: [h.intl.string(h.t["1Qm829"]), " ", (0, i.jsx)(s.dz2, {
            size: "xs",
            color: "currentColor"
          })]
        }) : (0, i.jsx)(s.zxk, {
