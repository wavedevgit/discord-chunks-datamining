  ...
  return s.useEffect(() => {
    ...
    children: [(0, i.jsx)(d.Z, {
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: [c || v !== d.O.Tips && v !== d.O.Customize ? null : (0, i.jsx)(r.eee, {
          className: j.dismiss,
        ...
        }) : null, c && v === d.O.Customize ? (0, i.jsx)(r.P3F, {
          className: j.dismiss,
          onClick: t,
          children: (0, i.jsx)(r.Text, {
            variant: "text-sm/semibold",
        ...
        className: j.right,
        children: [v === d.O.Customize ? (0, i.jsx)(r.Text, {
          className: j.warning,
          variant: "text-xs/medium",
          color: "text-muted",
          children: u.intl.string(u.t.nlpqxM)
        }) : null, v !== d.O.Customize || N ? null : (0, i.jsxs)(r.zxk, {
          onClick: () => f(d.O.Intro),
        ...
        }), v === d.O.Intro ? (0, i.jsxs)(r.zxk, {
          onClick: () => {
            var e;
            (null == (e = O.current) ? void 0 : e.maybeChangeToAfterTab()) && f(d.O.Customize)
          },
          children: [u.intl.string(u.t.uw9zIy), " ", (0, i.jsx)(r.ZSh, {
            size: "xs",
            color: "currentColor"
          })]
        }) : v === d.O.Customize ? (0, i.jsxs)(r.zxk, {
          onClick: () => {
            f(d.O.Tips), C(y)
          },
          children: [u.intl.string(u.t["1Qm829"]), " ", (0, i.jsx)(r.dz2, {
            size: "xs",
            color: "currentColor"
          })]
        }) : (0, i.jsx)(r.zxk, {
