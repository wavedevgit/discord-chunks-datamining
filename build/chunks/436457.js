...
var a = n(255367),
  ...
  h = n(388032),
  x = n(145575);
let N = (r = window.GLOBAL_ENV.INVITE_HOST, o = "", null == r && (r = location.host, o = m.Z5c.INVITE("")), "".concat(location.protocol, "//").concat(r).concat(o, "/"));
...
function y(e) {
  let {
    ...
    onConnect: r,
    isSlideReady: o
  } = e, [i, y] = s.useState(""), [v, j] = s.useState(!1), [E, C] = s.useState(null), T = s.useRef(null);
  s.useEffect(() => {
    var e;
