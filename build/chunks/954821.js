...
let x = e => {
  ...
  _ = e => {
    ...
    let {
      ...
      subscription: _,
      onClose: E
    } = e, j = (0, u.Dt)(), C = (0, g.YB)(s), O = (null == C || null == (t = C.cover_image_asset) ? void 0 : t.application_id) != null ? (0, m._W)(C.cover_image_asset.application_id, C.cover_image_asset, 440) : void 0, {
      ...
      await v(_.id) && E()
    }, y = o.role_benefits.benefits.filter(e => e.ref_type === h.Qs.CHANNEL), A = o.role_benefits.benefits.filter(e => e.ref_type === h.Qs.INTANGIBLE), P = l()(_.currentPeriodEnd).format("MMMM Do, YYYY"), R = f.intl.formatToPlainString(f.t.KsMRPz, {
  ...
  E = e => {
    (0, a.h7j)(t => (0, i.jsx)(_, function(e) {
