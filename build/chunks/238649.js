...
let N = r.memo(r.forwardRef((e, t) => {
  ...
  } = (0, u.ZP)(d.Z.PREMIUM_MARKETING_HERO_CTA), I = (0, p.Nx)(), y = (0, _.$)(), {
    buttonText: A,
    marketingSubscriptionTierSkuId: P
  } = (0, b.G)({
    hasActivePromotion: !!s,
    subscriptionTier: r
  }), R = (0, g.Z)(), D = null != R, Z = (0, l.e7)([c.Z], () => c.Z.useReducedMotion), {
    visibilityPercentageRef: w,
    visibilityPercentage: k
  } = (0, E.E)(!Z), L = (0, l.e7)([m.Z], () => m.Z.affinities), B = !D && L.length > 0;
  return (0, i.jsx)(u.Gt, {
    value: N,
