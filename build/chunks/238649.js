...
let I = r.memo(r.forwardRef((e, t) => {
  ...
  } = (0, u.ZP)(d.Z.PREMIUM_MARKETING_HERO_CTA), y = (0, g.ZP)({
    location: "PremiumMarketingHeroHeading"
  }), A = (0, g.J1)(y), P = (0, p.Nx)(), R = (0, j.$)(), {
    buttonText: D,
    marketingSubscriptionTierSkuId: Z
  } = (0, x.G)({
    hasActivePromotion: !!s,
    subscriptionTier: r
  }), w = (0, h.Z)(), k = null != w, L = (0, l.e7)([c.Z], () => c.Z.useReducedMotion), {
    visibilityPercentageRef: B,
    visibilityPercentage: M
  } = (0, O.E)(!L), U = (0, l.e7)([m.Z], () => m.Z.affinities), V = !k && U.length > 0;
  return (0, i.jsx)(u.Gt, {
    value: I,
