...
let y = r.memo(r.forwardRef((e, t) => {
  ...
  } = (0, u.ZP)(d.Z.PREMIUM_MARKETING_HERO_CTA), A = (0, g.ZP)({
    location: "PremiumMarketingHeroHeading"
  }), P = (0, g.J1)(A), R = (0, p.Nx)(), D = (0, j.$)(), {
    buttonText: Z,
    marketingSubscriptionTierSkuId: w
  } = (0, x.G)({
    hasActivePromotion: !!s,
    subscriptionTier: r
  }), k = (0, h.Z)(), L = null != k, B = (0, l.e7)([c.Z], () => c.Z.useReducedMotion), {
    visibilityPercentageRef: M,
    visibilityPercentage: U
  } = (0, O.E)(!B), V = (0, l.e7)([m.Z], () => m.Z.affinities), G = !L && V.length > 0;
  return (0, i.jsx)(u.Gt, {
    value: y,
