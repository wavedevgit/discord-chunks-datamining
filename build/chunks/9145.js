...
function z(e) {
  ...
  let {
    maxHeight: z,
    connectedLocation: W,
    renderExternalHeader: Y
  } = e, q = (0, A.Z)(), K = (0, s.Wu)([S.ZP], () => S.ZP.getEmbeddedActivitiesForLocation(W), [W]), X = (0, T.pY)(W), Q = (0, s.e7)([x.Z], () => x.Z.getChannel(X)), J = (0, Z.gb)(K), $ = (0, Z.uF)(J), ee = i.useCallback(() => {
    (0, P.tg)(U.Ez.PIP)
  }, []), et = i.useRef(null), en = (0, s.e7)([S.ZP], () => S.ZP.getFocusedLayout()), er = en !== U.MI.NO_CHAT, [ei, el] = i.useState(null != (n = null != (t = g.ZP.activityPanelHeight) ? t : z) ? n : null), ea = i.useCallback(e => {
  ...
  let ex = [];
  null != ef && (ex = Array.from(ef.embeddedActivity.userIds).map(e => O.default.getUser(e)).filter(e => null != e && void 0 !== e));
  let ev = e => {
    var t;
  ...
  return (0, r.jsx)(u.f6W, {
    ...
    children: e => (0, r.jsxs)("div", {
      className: a()(G.wrapper, V[en], e, {
        [G.contextlessActivityWrapper]: em
      }),
      ref: et,
      style: ey,
      children: [!em && (null == Y ? void 0 : Y()), (0, r.jsxs)("div", {
        className: G.activityPanelContainer,
        children: [er || em ? null : (0, r.jsx)("div", {
          className: G.header,
          ...
          className: a()(G.activityContainer, {
            [G.activityContainerNoMargin]: eh
          }),
          style: {
            paddingLeft: ed,
            paddingRight: ed,
        ...
        resizableNode: et,
        onResize: e => {
          E.S.dispatch(B.CkL.MANUAL_IFRAME_RESIZING, {
            resizing: !0
          }), el(e)
        },
        onResizeEnd: e => {
