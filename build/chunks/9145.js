...
function G(e) {
  ...
  } = e, V = (0, N.Z)(), z = (0, s.Wu)([I.ZP], () => I.ZP.getEmbeddedActivitiesForLocation(F), [F]), W = (0, Z.pY)(F), Y = (0, s.e7)([y.Z], () => y.Z.getChannel(W)), q = (0, P.gb)(z), K = (0, P.uF)(q), X = i.useCallback(() => {
    (0, E.tg)(k.Ez.PIP)
  }, []), Q = i.useRef(null), J = (0, s.e7)([I.ZP], () => I.ZP.getFocusedLayout()), $ = J !== k.MI.NO_CHAT, [ee, et] = i.useState(null != (n = null != (t = m.ZP.activityPanelHeight) ? t : G) ? n : null), en = i.useCallback(e => {
    d.ZP.updatedUnsyncedSettings({
      activityPanelHeight: e
    })
  }, []), er = i.useRef(null), [ei, el] = i.useState({
    width: 0,
    height: 0
  });
  i.useLayoutEffect(() => {
  ...
  let eg = [];
  null != eu && (eg = Array.from(eu.embeddedActivity.userIds).map(e => v.default.getUser(e)).filter(e => null != e && void 0 !== e));
  let eb = e => {
    var t;
  ...
  return (0, r.jsx)(u.f6W, {
    ...
    children: e => (0, r.jsxs)("div", {
      className: a()(D.wrapper, B[J], e, {
        [D.contextlessActivityWrapper]: ed
      }),
      ref: Q,
      style: em,
      children: [!ed && (null == H ? void 0 : H()), (0, r.jsxs)("div", {
        className: D.activityPanelContainer,
        children: [$ || ed ? null : (0, r.jsx)("div", {
          className: D.header,
          ...
          className: a()(D.activityContainer, {
            [D.activityContainerNoMargin]: ec
          }),
          style: {
            paddingLeft: eo,
            paddingRight: eo,
        ...
        resizableNode: Q,
        onResize: e => {
          j.S.dispatch(M.CkL.MANUAL_IFRAME_RESIZING, {
            resizing: !0
          }), et(e)
        },
        onResizeEnd: e => {
