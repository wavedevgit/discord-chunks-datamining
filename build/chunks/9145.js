...
function H(e) {
  ...
  } = e, W = (0, T.Z)(), Y = (0, s.Wu)([Z.ZP], () => Z.ZP.getEmbeddedActivitiesForLocation(z), [z]), K = (0, P.p)(z), q = (0, s.e7)([y.Z], () => y.Z.getChannel(K)), Q = (0, I.gb)(Y), X = (0, I.uF)(Q), J = i.useCallback(() => {
    (0, E.tg)(M.Ez.PIP)
  }, []), $ = i.useRef(null), ee = (0, s.e7)([Z.ZP], () => Z.ZP.getFocusedLayout()), et = ee !== M.MI.NO_CHAT, [en, er] = i.useState(null != (n = null != (t = g.ZP.activityPanelHeight) ? t : H) ? n : null), ei = i.useCallback(e => {
  ...
  let e_ = [];
  null != eh && (e_ = Array.from(eh.embeddedActivity.userIds).map(e => x.default.getUser(e)).filter(e => null != e && void 0 !== e));
  let ey = e => {
    var t;
  ...
  return (0, r.jsx)(c.f6W, {
    ...
    children: e => (0, r.jsxs)("div", {
      ...
      ref: $,
      style: em,
      children: [null == V ? void 0 : V(), (0, r.jsxs)("div", {
        ...
        children: [et ? null : (0, r.jsx)("div", {
          ...
          className: a()(G.activityContainer, {
            [G.activityContainerNoMargin]: eu
          }),
          style: {
            paddingLeft: ec,
            paddingRight: ec,
          ...
          children: [(0, r.jsx)(w.ZP, {
            ...
            popoutOpen: !1,
            onOpenPopout: () => {
              (0, p.yw)(k.rMx.ACTIVITY_POPOUT_POP_OUT_BUTTON_CLICKED), (0, R.Z)({
                onConfirm: E.Gj
              })
            },
            onClosePopout: () => {}
