...
function H(e) {
  ...
  } = e, W = (0, N.Z)(), Y = (0, o.Wu)([I.ZP], () => I.ZP.getEmbeddedActivitiesForLocation(V), [V]), q = (0, Z.p)(V), K = (0, o.e7)([y.Z], () => y.Z.getChannel(q)), X = (0, P.gb)(Y), Q = (0, P.uF)(X), J = i.useCallback(() => {
    (0, E.tg)(L.Ez.PIP)
  }, []), $ = i.useRef(null), ee = (0, o.e7)([I.ZP], () => I.ZP.getFocusedLayout()), et = ee !== L.MI.NO_CHAT, [en, er] = i.useState(null != (n = null != (t = m.ZP.activityPanelHeight) ? t : H) ? n : null), ei = i.useCallback(e => {
  ...
  let e_ = [];
  null != ep && (e_ = Array.from(ep.embeddedActivity.userIds).map(e => v.default.getUser(e)).filter(e => null != e && void 0 !== e));
  let ey = e => {
    var t;
      ...
      children: [null == z ? void 0 : z(), (0, r.jsxs)("div", {
        ...
        children: [et ? null : (0, r.jsx)("div", {
          ...
          children: [(0, r.jsx)(A.Z, {
            ...
            popoutOpen: !1,
            onOpenPopout: () => {
              (0, h.yw)(D.rMx.ACTIVITY_POPOUT_POP_OUT_BUTTON_CLICKED), (0, w.Z)({
                onConfirm: E.Gj
              })
            },
            onClosePopout: () => {}
        ...
        resizableNode: $,
        onResize: e => {
          j.S.dispatch(D.CkL.MANUAL_IFRAME_RESIZING, {
            resizing: !0
          }), er(e)
        },
        onResizeEnd: e => {
