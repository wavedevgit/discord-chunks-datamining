...
function O(t) {
  let {
    transitionState: e,
    onClose: r
  } = t, [O, S] = o.useState(null), [A, w] = o.useState(null), [E, h] = o.useState(!1), N = o.useRef(null), T = (0, i.e7)([f.default], () => f.default.getCurrentUser()), j = o.useRef(null);
  o.useEffect(() => {
    ...
    if (t.preventDefault(), null != O) {
      ...
      try {
        ...
        if (null != t.body && null != t.body.date_of_birth) c.Z.flowStep(_.MK.ANY, _.FF.AGE_GATE_UNDERAGE), d.wE(y.L0.CLAIM_ACCOUNT), d.hp(y.L0.CLAIM_ACCOUNT), r();
          ...
          var e;
          (null == t || null == (e = t.body) ? void 0 : e.username) != null ? w(g.intl.string(g.t["TGg/2t"])) : w(null == t ? void 0 : t.body.message)
        }
      }
      h(!1)
    }
