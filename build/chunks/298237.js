...
function A(e) {
  let {
    transitionState: t,
    onClose: r
  } = e, [A, N] = l.useState(null), [E, O] = l.useState(null), [v, w] = l.useState(!1), T = l.useRef(null), C = (0, i.e7)([s.default], () => s.default.getCurrentUser()), h = l.useRef(null);
  l.useEffect(() => {
    u.Z.flowStep(g.MK.ANY, g.FF.AGE_GATE), f.default.track(b.rMx.OPEN_MODAL, {
      type: "Claim Age Gate"
    })
  }, []), l.useEffect(() => {
    ...
    children: (0, n.jsxs)(c.hzk, {
      ...
      children: [(0, n.jsx)("div", {
        ...
        children: [(0, n.jsx)(c.X6q, {
          ...
          children: y.intl.format(y.t.EcJBEB, {
