...
let N = e => {
  let {
    ...
    width: c,
    height: u
  } = (0, o.ZP)(), [f, h] = i.useState(v.hO.INITIAL), N = (0, l.e7)([b.Z], () => b.Z.getRequest(t)), j = (0, l.e7)([p.Z], () => p.Z.getGuild(t)), {
  ...
  let A = i.useCallback(() => {
      h(Math.max(f, v.hO.FILLING)), m.Z.removeGuildJoinRequest(t), (0, d.uL)(y.Z5c.ME)
    }, [t, f]),
    Z = (e, t) => () => {
      (0, s.h7j)(n => {
        var i, l;
