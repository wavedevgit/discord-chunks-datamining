...
function er(e) {
  ...
  let z = (0, R.q)(u);
  if (null != d && null != d.proxyURL) return <div className={s()(F.embedVideo, r)}>{m({
      poster: z,
      src: d.proxyURL,
      placeholder: L,
      placeholderVersion: M,
  ...
  if (U && null != d) {
    ...
    return <div className={r} style={n}><div className={s()(F.embedVideo, a)} style={o}><k.ZP provider={f} src={d.url} style={e} width={Y} height={W} allowFullScreen={_} autoMute={t} /></div></div>
  }
  return <div className={s()(F.embedVideo, r)} style={p ? {
      maxWidth: Y
    } : {
      width: Y,
      height: W
    ...
    })}{<div className={F.embedVideoActions}><div className={F.centerContent}>{E ? (0, i.jsx)(v.Z, {
...
function ei(e) {
  ...
  return <y.Z className={s()(F.embedVideo, t)} original={n} poster={(0, R.q)(l)} src={(0, R.q)(c)} alt={f} width={l.width} height={l.height} naturalHeight={c.height} naturalWidth={c.width} maxWidth={o} maxHeight={a} responsive={d} autoPlay={r} playable={p} renderImageComponent={u} hiddenSpoilers={h} disableAltTextDisplay={_} placeholder={m} placeholderVersion={g} sourceMetadata={E} />
}
class eo extends(r = Chunk73800.PureComponent) {
  renderProvider() {
    ...
    return null == exports ? null : this.shouldShowStaticPlaceholder ? <div className={s()(Chunk94488.embedProvider, Chunk94488.embedMargin)}>{this.renderContentPlaceholder({
        width: 80,
        height: 18
      })}</div> : <div className={s()(Chunk94488.embedProvider, Chunk94488.embedMargin)}>{null != exports.url ? require({
        className: Chunk94488.embedLink,
        href: exports.url,
  ...
  renderAuthor() {
    ...
    return null == exports ? null : this.shouldShowStaticPlaceholder ? <div className={s()(Chunk94488.embedAuthor, Chunk94488.embedMargin)}>{this.renderContentPlaceholder({
        width: 150,
        height: 18
      })}</div> : <div className={s()(Chunk94488.embedAuthor, Chunk94488.embedMargin)}>{null != exports.iconProxyURL ? <img alt={""} className={Chunk94488.embedAuthorIcon} src={exports.iconProxyURL} /> : null}{null != exports.url ? require({
        className: Chunk94488.embedAuthorNameLink,
        href: exports.url,
        tabIndex: module ? 0 : false,
        children: exports.name,
        target: "_blank",
        ...
        messageId: null == r ? true : r.id,
        channelId: null == r ? true : r.channel_id
      }) : <span className={Chunk94488.embedAuthorName}>{exports.name}</span>}</div>
  }
  renderContentPlaceholder(e) {
    ...
    return <I.ZT className={F.contentPlaceholder} width={t} height={n} opacity={.3} />
  }
  renderTitle() {
    let e = !(arguments.length > 0) || true === arguments[0] || arguments[0],
      {
    ...
    return null == Chunk120356 ? null : this.shouldShowStaticPlaceholder ? <div className={s()(Chunk94488.embedTitle, Chunk94488.embedMargin)}>{this.renderContentPlaceholder({
        width: 400,
        height: 30
      })}</div> : <div className={s()(Chunk94488.embedTitle, Chunk94488.embedMargin)}>{null != Chunk892814 ? require({
        className: Chunk94488.embedTitleLink,
        href: Chunk892814,
        tabIndex: module ? 0 : false,
  ...
  renderDescription() {
    ...
    return null == require ? null : <div className={s()(Chunk94488.embedDescription, Chunk94488.embedMargin)}>{this.shouldShowStaticPlaceholder ? this.renderContentPlaceholder({
        width: 400,
        height: 50
      }) : exports(module, require, false)}</div>
  }
  renderThumbnail() {
    let e = !(arguments.length > 0) || true === arguments[0] || arguments[0],
      {
    ...
    return null == exports ? null : <Chunk249458.G.Consumer>{i => {
        let {
          disableAnimations: l
        } = i;
        return o({
  ...
  renderFields() {
    ...
    }), null != r && require.push(r), <div className={Chunk94488.embedFields}>{require.map((e, t) => {
        let {
          length: n
        } = e;
        return e.map((e, r) => {
  ...
  renderImages() {
    ...
    return null == Chunk481060 && null == Chunk607070 && null == Chunk399654 && null == Chunk370298 ? null : <div className={Chunk94488.embedGalleryImagesWrapper} style={{
        height: Chunk892814
      }}>{<div className={Chunk94488.embedGallerySide}>{<Chunk947849.h.Provider value={(0, Chunk963206.P)(s.images[0].url, s.images[0])}>{Chunk481060}</Chunk947849.h.Provider>}{null != Chunk370298 && <Chunk947849.h.Provider value={(0, Chunk963206.P)(null == (e = s.images[2]) ? true : module.url, s.images[2])}>{Chunk399654}</Chunk947849.h.Provider>}</div>}{<div className={Chunk94488.embedGallerySide}>{<Chunk947849.h.Provider value={(0, Chunk963206.P)(null == (t = s.images[1]) ? true : exports.url, s.images[1])}>{Chunk607070}</Chunk947849.h.Provider>}{null == Chunk370298 && null != Chunk399654 && <Chunk947849.h.Provider value={(0, Chunk963206.P)(null == (n = s.images[2]) ? true : require.url, s.images[2])}>{Chunk399654}</Chunk947849.h.Provider>}{null != Chunk370298 && <Chunk947849.h.Provider value={(0, Chunk963206.P)(null == (r = s.images[3]) ? true : r.url, s.images[3])}>{Chunk370298}</Chunk947849.h.Provider>}</div>}</div>
  }
  renderImageHoverButtons(e) {
    ...
    return <div className={s()(V.hoverButtonGroup, {
        [V.nonMediaMosaicItem]: !r,
        [V.forceShowHover]: this.state.showImageAppMenu
      })}><f.Z toggleShowMenu={a} showMenu={this.state.showImageAppMenu} channelId={o} className={s()(V.hoverButton, {
          [V.selected]: this.state.showImageAppMenu
        })} imageUrl={n} mimeType={t} /></div>
  }
  ...
  renderImage() {
    ...
    let y = (0, Chunk52824.q)(Chunk892814),
      ...
      A = {
        containerClassName: s()(Chunk635477, {
          [Chunk94488.embedMedia]: !Chunk481060,
          [Chunk94488.embedImage]: !Chunk481060,
          [Chunk94488.galleryImage]: Chunk481060
        }),
        imageContainerClassName: Chunk481060 ? Chunk94488.galleryImageContainer : true,
        imageClassName: Chunk481060 ? Chunk94488.embedGalleryImageElement : true,
        src: (0, Chunk52824.q)(Chunk892814),
    ...
    return <Chunk947849.h.Consumer>{e => (0, i.jsx)(U.G.Consumer, {
        children: t => {
          let {
            disableAnimations: n
          } = t;
  ...
  renderVideo() {
    ...
    if (module) return null == Chunk120356 ? null : <Chunk249458.G.Consumer>{e => {
        let {
          disableAnimations: s
        } = e;
        return (0, i.jsx)(ei, {
    ...
    return <er className={Chunk94488.embedMedia} href={r} allowFullScreen={Chunk399654} thumbnail={Chunk73800} video={Chunk120356} provider={null == s ? true : s.name} maxWidth={Chunk715697} maxHeight={Chunk95398} responsive={true} renderImageComponent={Chunk481060} renderVideoComponent={Chunk892814} renderLinkComponent={Chunk607070} onControlsShow={Chunk947849} onControlsHide={Chunk768494} playable={exports && !require} placeholder={null == Chunk120356 ? true : Chunk120356.placeholder} placeholderVersion={null == Chunk120356 ? true : Chunk120356.placeholderVersion} sourceMetadata={Chunk936141} />
  }
  renderFooter() {
    let {
      footer: e,
    ...
    if (null != module) {
      ...
      return <div className={s()(Chunk94488.embedFooter, Chunk94488.embedMargin)}>{null != require ? <img alt={""} className={Chunk94488.embedFooterIcon} src={require} /> : null}{<span className={Chunk94488.embedFooterText}>{module.text}{null != module.text && null != exports ? <span className={Chunk94488.embedFooterSeparator}>{"•"}</span> : null}{null != exports ? (0, Chunk55935.Y4)(exports) : null}</span>}</div>
    }
    if (null != exports) return <div className={s()(Chunk94488.embedFooter, Chunk94488.embedMargin)}><span className={Chunk94488.embedFooterText}>{(0, Chunk55935.Y4)(exports)}</span></div>
  }
  renderStaticPlaceholderMedia() {
    ...
    return <Chunk481060.Eep className={exports} readyState={Chunk981631.zo9.READY} src={""} width={s} height={Chunk892814} maxWidth={r} maxHeight={Chunk73800} mediaLayoutType={Chunk217702.hV.STATIC} useFullWidth={false} zoomable={false} />
  }
  renderMedia() {
    let e = arguments.length > 0 && true !== arguments[0] && arguments[0],
      {
  ...
  renderSuppressButton(e) {
    return <c.P3F focusProps={{
        offset: {
          bottom: 4
        }
      }} className={F.embedSuppressButton} onClick={e} aria-label={Z.intl.string(Z.t.GT3fNz)}><c.Dio size={"xs"} color={"currentColor"} /></c.P3F>
  }
  ...
  render() {
    ...
    return null != exports.provider && Chunk401419.j.includes(exports.provider.name) ? <Chunk401419.Z embed={exports} className={r} /> : (0, Chunk785992.Z)(exports) ? <Chunk400266.Z embed={exports} className={r} /> : (null == (e = exports.provider) ? true : module.name) === "Amazon Music" && exports.type === Chunk981631.hBH.RICH ? <Chunk624195.Z embed={exports} className={r} /> : (0, Chunk635477.Z)(exports) ? <Chunk715697.Z embed={exports} className={r} /> : this.isInline() ? null != require ? <Chunk95398.ZP type={Chunk95398.ZP.Types.ATTACHMENT} reason={require} onReveal={this.onReveal} onToggleObscurity={this.onToggleObscurity} isSingleMosaicItem={true} containerStyles={this.getSpoilerStyles(true)} obscurityControlClassName={s()({
        [Chunk94488.obscureVideoSpacing]: this.state.isVisible && this.state.videoControlsShown
      })}>{this.renderInlineMediaEmbed}</Chunk95398.ZP> : this.renderInlineMediaEmbed() : null != require ? <Chunk95398.ZP type={Chunk95398.ZP.Types.EMBED} onReveal={this.onReveal} onToggleObscurity={this.onToggleObscurity} reason={require} isSingleMosaicItem={true} containerStyles={this.getSpoilerStyles(false)}>{this.renderEmbedContent}</Chunk95398.ZP> : this.renderEmbedContent()
  }
  constructor(...e) {
    var t;
    super(...e), t = this, Y(this, "state", W({
      ...
      return <div aria-hidden={e} className={s()(F.inlineMediaEmbed, r, {
      ...
      return <article className={s()(n, F.embedFull, H.markup, {
          [F.isHidden]: e,
        ...
        }}><div className={F.gridContainer}><div className={s()({
              [F.grid]: true,
              [F.hasThumbnail]: null != f
            })}>{null != r ? t.renderSuppressButton(r) : null}{a}{l}{c}{u}{d}{_}{f}{p}</div></div></article>
    })
  }
}
