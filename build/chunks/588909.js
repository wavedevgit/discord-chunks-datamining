  ...
  for (let r of t) switch (r.type) {
    case O.nc.WELCOME: {
      ...
      null != t && (0, s.Z)(t, b.xjy.JOIN) && (E.cancelText = _.intl.string(_.t["6F9ivr"]), E.onCancelClick = (e, n) => {
        u("unlock"), a.Z.updateNotificationStatus(n), a.Z.setInputLocked(!1, (0, h.getPID)()), (0, l.h7)(t, !1, b.IlC.POPOUT)
      });
      break
    }
    ...
    case O.nc.CONTENT_INVENTORY:
      (0, f.Rb)("welcomeNotification").allowActivityWidget && (E.renderFooter = () => (0, i.jsx)(m.lX, {
