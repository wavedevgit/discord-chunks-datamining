...
function g() {
  let e = (0, Chunk442837.Wu)([Chunk317632.Z], () => Chunk317632.Z.getInvites()),
    ...
    [n, l] = Chunk473749.useMemo(() => o().partition(module, e => {
      var n;
...
function _() {
  return 0 === (0, Chunk442837.Wu)([Chunk317632.Z], () => Chunk317632.Z.getInvites()).length ? null : (0, Chunk54381.jsx)(Chunk481060.M0o, {
    tooltip: Chunk388032.intl.string(Chunk388032.t["Zy3MR/"]),
    color: Chunk481060.YX$.SECONDARY,
    icon: (0, Chunk54381.jsx)(Chunk481060.XHJ, {
      size: "xs"
    }),
    onClick: b
  })
