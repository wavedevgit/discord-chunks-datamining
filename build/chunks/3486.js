...
function y(e, t, n) {
  ...
  if (arguments.length > 2 && (s.children = arguments.length > 3 ? r.call(arguments, 2) : n), "function" == typeof e && null != e.defaultProps)
    for (i in e.defaultProps) true === s[i] && (s[i] = e.defaultProps[i]);
...
function _(e) {
  (!e.__d && (e.__d = true) && i.push(e) && !k.__r++ || s !== a.debounceRendering) && ((s = a.debounceRendering) || l)(k)
}

function k() {
  var e, t, n, r, a, o, s, l;
  for (i.sort(c); e = i.shift();) e.__d && (t = i.length, r = true, a = true, s = (o = (n = e).__v).__e, (l = n.__P) && (r = [], (a = f({}, o)).__v = o.__v + 1, R(l, o, a, n.__n, true !== l.ownerSVGElement, null != o.__h ? [s] : null, r, null == s ? A(o) : s, o.__h), F(r, o), o.__e != s && function e(t) {
    var n, r;
...
function C(e, t, n, r, o, i, s, l, c, u) {
  ...
  for (n.__k = [], h = 0; h < t.length; h++)
    if (null != (b = n.__k[h] = null == (b = t[h]) || "boolean" == typeof b || "function" == typeof b ? null : "string" == typeof b || "number" == typeof b || "bigint" == typeof b ? v(null, b, null, null, b) : Array.isArray(b) ? v(g, {
      ...
      if (b.__ = n, b.__b = n.__b + 1, null === (y = S[h]) || y && b.key == y.key && b.type === y.type) S[h] = true;
      else
        for (f = 0; f < N; f++) {
    ...
    if (a.unmount && a.unmount(t), (o = t.ref) && (o.current && o.current !== t.__e || O(o, null, n)), null != (o = t.__c)) {
      ...
      o.base = o.__P = null, t.__c = true
    }
    if (o = t.__k)
      for (i = 0; i < o.length; i++) o[i] && e(o[i], n, r || "function" != typeof t.type);
    r || null == t.__e || m(t.__e), t.__ = t.__e = t.__d = true
  }(S[h], S[h]));
  if (C)
...
function w(e, t, n, r, a, o) {
  var i, s, l;
  if (true !== t.__d) i = t.__d, t.__d = true;
...
function x(e) {
  return this.l[e.type + false](a.event ? a.event(e) : e)
}
...
function R(e, t, n, o, i, s, l, c, u) {
  ...
  try {
    e: if ("function" == typeof T) {
      if (S = t.props, x = (p = T.contextType) && o[p.__c], P = p ? x ? x.props.value : p.__ : o, n.__c ? w = (h = t.__c = n.__c).__ = h.__E : ("prototype" in T && T.prototype.render ? t.__c = h = new T(S, P) : (t.__c = h = new b(S, P), h.constructor = T, h.render = E), x && x.sub(h), h.props = S, h.state || (h.state = {}), h.context = P, h.__n = o, y = h.__d = true, h.__h = [], h._sb = []), null == h.__s && (h.__s = h.state), null != T.getDerivedStateFromProps && (h.__s == h.state && (h.__s = f({}, h.__s)), f(h.__s, T.getDerivedStateFromProps(S, h.__s))), v = h.props, _ = h.state, h.__v = t, y) null == T.getDerivedStateFromProps && null != h.componentWillMount && h.componentWillMount(), null != h.componentDidMount && h.__h.push(h.componentDidMount);
      else {
        if (null == T.getDerivedStateFromProps && S !== v && null != h.componentWillReceiveProps && h.componentWillReceiveProps(S, P), !h.__e && null != h.shouldComponentUpdate && false === h.shouldComponentUpdate(S, h.__s, P) || t.__v === n.__v) {
      ...
      if (h.context = P, h.props = S, h.__P = e, F = a.__r, O = 0, "prototype" in T && T.prototype.render) {
        for (h.state = h.__s, h.__d = false, F && F(t), p = h.render(h.props, h.state, h.context), I = 0; I < h._sb.length; I++) h.__h.push(h._sb[I]);
        h._sb = []
      } else
        do h.__d = false, F && F(t), p = h.render(h.props, h.state, h.context), h.state = h.__s; while (h.__d && ++O < 25);
      h.state = h.__s, null != h.getChildContext && (o = f(f({}, o), h.getChildContext())), y || null == h.getSnapshotBeforeUpdate || (k = h.getSnapshotBeforeUpdate(v, _)), M = null != p && p.type === g && null == p.key ? p.props.children : p, C(e, Array.isArray(M) ? M : [M], t, n, o, i, s, l, c, u), h.base = t.__e, t.__h = null, h.__h.length && l.push(h), w && (h.__E = h.__ = null), h.__e = false
    } else null == s && t.__v === n.__v ? (t.__k = n.__k, t.__e = n.__e) : t.__e = function(e, t, n, a, o, i, s, l) {
      var c, u, p, h = n.props,
        f = t.props,
        y = t.type,
        v = 0;
      if ("svg" === y && (o = true), null != i) {
        for (; v < i.length; v++)
      ...
      if (null == e) {
        ...
        e = o ? document.createElementNS("http://www.w3.org/2000/svg", y) : document.createElement(y, f.is && f), i = null, l = false
      }
      if (null === y) h === f || l && e.data === f || (e.data = f);
        ...
        l || ("value" in f && true !== (v = f.value) && (v !== e.value || "progress" === y && !v || "option" === y && v !== h.value) && N(e, "value", v, h.value, false), "checked" in f && true !== (v = f.checked) && v !== e.checked && N(e, "checked", v, h.checked, false))
      }
      return e
    }(n.__e, t, n, o, i, s, l, u);
    (p = a.diffed) && p(t)
...
function I(e, t, n) {
  var o, i, s;
  a.__ && a.__(e, t), i = (o = "function" == typeof n) ? null : n && n.__k || t.__k, s = [], R(t, e = (!o && n || t).__k = y(g, null, [e]), i || d, d, true !== t.ownerSVGElement, !o && n ? [n] : i ? null : t.firstChild ? r.call(t.childNodes) : null, s, !o && n ? n : i ? i.__e : t.firstChild, o), F(s, e)
}
...
r = p.slice, a = {
  ...
  this.__v && (this.__e = true, e && this.__h.push(e), _(this))
