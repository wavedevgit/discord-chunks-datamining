...
function f(e, t) {
  (0, a.ZDy)(async () => {
    let {
      default: i
    } = await n.e("68784").then(n.bind(n, 611611)), l = null == t ? void 0 : t.answers.map(e => {
      var t, n;
      return {
        text: e.text,
        image: {
...
function m() {
  var e;
  let [t, n] = i.useState([]), [s, d] = i.useState(!1), [m, g] = i.useState(!1), b = o.C.useExperiment({
  ...
  return i.useCallback((e, n) => _ ? s ? {
    ...
    children: (0, r.jsxs)(a.kSQ, {
      ...
      children: [t.map((t, n) => (0, r.jsx)(a.sNh, {
        id: "poll-suggestions-".concat(n),
        label: t.title,
        subtext: t.question,
        "aria-label": t.question,
        action: () => f(e, t)
      }, "poll-suggestions-".concat(n))), (0, r.jsx)(a.Clw, {}), (0, r.jsx)(a.sNh, {
