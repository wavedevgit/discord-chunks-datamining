...
function k(e) {
  ...
  } = (0, i.ZP)(), v = null != (l = null != (t = null == p ? void 0 : p[0]) ? t : null == j ? void 0 : j[0]) ? l : null, D = (0, o.e7)([x.default], () => x.default.getUser(k), [k]), [b, O] = s.useState(h.UK.DURATION_60_SEC), E = (0, d.sE)(U, {
    location: v,
    targetUserId: k
  }), [A, R] = s.useState(""), [y, B] = s.useState(!1), W = s.useCallback(async () => {
    if (null != D) {
      B(!0);
      try {
        await r.Z.setCommunicationDisabledDuration(U, k, b, A, v), E(d.jQ.TIMEOUT), (0, a.showToast)((0, a.createToast)(T.NW.formatToPlainString(T.t.O9C3Nj, {
