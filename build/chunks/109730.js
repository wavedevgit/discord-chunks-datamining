...
function j(e) {
  ...
  let {
  ...
  } = (0, c.ZP)(), D = null != (l = null != (t = null == v ? void 0 : v[0]) ? t : null == b ? void 0 : b[0]) ? l : null, I = (0, s.e7)([h.default], () => h.default.getUser(j), [j]), [A, y] = r.useState(C.UK.DURATION_60_SEC), [K, B] = r.useState(""), [M, Z] = r.useState(!1), [P, w] = r.useState(!1), H = (0, s.e7)([x.Z], () => {
    var e;
    ...
    if (null != I) {
      Z(!0);
      try {
        await a.Z.setCommunicationDisabledDuration(E, j, A, K, D, k), P && null != k && _.Z.resolveFlag(k), L(d.jQ.TIMEOUT), (0, o.showToast)((0, o.createToast)(g.intl.formatToPlainString(g.t.O9C3Nj, {
          user: m.ZP.getName(E, null, I)
        }), o.ToastType.SUCCESS)), f()
      } catch (e) {
  ...
  return ((0, i.ZP)(() => {
    null != I && T.default.track(N.rMx.OPEN_MODAL, {
      type: C.Cl,
      guild_id: E,
      other_user_id: I.id
    })
    ...
    (null == I || null == E) && f()
  }, [E, I, f]), null == I || null == E) ? null : (0, n.jsxs)(o.Y0X, {
    transitionState: U,
    "aria-labelledby": S,
