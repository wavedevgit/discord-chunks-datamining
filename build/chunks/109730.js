...
function U(e) {
  ...
  let {
  ...
  } = (0, u.ZP)(), I = null != (l = null != (t = null == f ? void 0 : f[0]) ? t : null == D ? void 0 : D[0]) ? l : null, k = (0, a.e7)([m.default], () => m.default.getUser(U), [U]), [A, K] = r.useState(C.UK.DURATION_60_SEC), [M, Z] = r.useState(""), [B, w] = r.useState(!1), [P, H] = r.useState(!1), L = (0, a.e7)([h.Z], () => {
    var e;
    ...
    if (null != k) {
      w(!0);
      try {
        await i.Z.setCommunicationDisabledDuration(O, U, A, M, I, b), P && null != b && x.Z.resolveFlag(b), X(_.jQ.TIMEOUT), (0, o.showToast)((0, o.createToast)(v.intl.formatToPlainString(v.t.O9C3Nj, {
          user: p.ZP.getName(O, null, k)
        }), o.ToastType.SUCCESS)), R()
      } catch (e) {
  ...
  return ((0, c.ZP)(() => {
    null != k && T.default.track(g.rMx.OPEN_MODAL, {
      type: C.Cl,
      guild_id: O,
      other_user_id: k.id
    })
    ...
    (null == k || null == O) && R()
  }, [O, k, R]), null == k || null == O) ? null : (0, n.jsxs)(o.Y0X, {
    transitionState: S,
    "aria-labelledby": y,
    ...
    children: [(0, n.jsx)(o.xBx, {
      ...
      children: (0, n.jsxs)(o.Kqy, {
        ...
        children: [(0, n.jsx)(o.olH, {
          ...
          children: v.intl.format(v.t.OhsOy8, {
            user: p.ZP.getName(O, null, k)
          })
        })]
      })
      ...
      children: [(0, n.jsx)(o.Text, {
        ...
        children: v.intl.format(v.t.Ns83GR, {
        ...
        buttons: j.map(e => (function(e, t, l) {
          let {
            value: r,
            label: a
          } = e;
