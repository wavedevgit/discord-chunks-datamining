...
function j(e) {
  ...
  let {
  ...
  } = (0, c.ZP)(), D = null != (l = null != (t = null == v ? void 0 : v[0]) ? t : null == b ? void 0 : b[0]) ? l : null, I = (0, r.e7)([h.default], () => h.default.getUser(j), [j]), [A, y] = o.useState(C.UK.DURATION_60_SEC), [K, M] = o.useState(""), [B, Z] = o.useState(!1), [P, w] = o.useState(!1), H = (0, r.e7)([x.Z], () => {
    var e;
    ...
    if (null != I) {
      Z(!0);
      try {
        await a.Z.setCommunicationDisabledDuration(E, j, A, K, D, k), P && null != k && _.Z.resolveFlag(k), L(d.jQ.TIMEOUT), (0, s.showToast)((0, s.createToast)(g.intl.formatToPlainString(g.t.O9C3Nj, {
          user: T.ZP.getName(E, null, I)
        }), s.ToastType.SUCCESS)), f()
      } catch (e) {
  ...
  return ((0, i.ZP)(() => {
    null != I && m.default.track(N.rMx.OPEN_MODAL, {
      type: C.Cl,
      guild_id: E,
      other_user_id: I.id
    })
    ...
    (null == I || null == E) && f()
  }, [E, I, f]), null == I || null == E) ? null : (0, n.jsxs)(s.Y0X, {
    transitionState: U,
    "aria-labelledby": S,
    ...
    children: [(0, n.jsx)(s.xBx, {
      ...
      children: (0, n.jsxs)(s.Kqy, {
        ...
        children: [(0, n.jsx)(s.olH, {
          ...
          children: g.intl.format(g.t.OhsOy8, {
            user: T.ZP.getName(E, null, I)
          })
        })]
      })
      ...
      children: [(0, n.jsx)(s.Text, {
        ...
        children: g.intl.format(g.t.Ns83GR, {
        ...
        buttons: R.map(e => (function(e, t, l) {
          let {
            value: o,
            label: r
          } = e;
