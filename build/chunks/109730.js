...
function f(t) {
  ...
  } = (0, d.ZP)(), A = null != (l = null != (e = null == v ? void 0 : v[0]) ? e : null == D ? void 0 : D[0]) ? l : null, j = (0, a.e7)([g.default], () => g.default.getUser(f), [f]), [K, b] = s.useState(O.UK.DURATION_60_SEC), [M, Z] = s.useState(""), [k, P] = s.useState(!1), [w, B] = s.useState(!1), L = (0, a.e7)([h.Z], () => {
    var t;
  ...
  return ((0, u.ZP)(() => {
    ...
    actionBarInput: null == y || L ? void 0 : (0, n.jsx)(o.XZJ, {
      value: w,
      onChange: (t, e) => {
        B(e)
      },
