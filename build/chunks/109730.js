...
function g(e) {
  ...
  } = (0, s.ZP)(), U = null != (l = null != (t = null == I ? void 0 : I[0]) ? t : null == M ? void 0 : M[0]) ? l : null, b = (0, r.e7)([d.default], () => d.default.getUser(g), [g]), [p, v] = o.useState(T.UK.DURATION_60_SEC), k = (0, _.sE)(N, {
    location: U,
    targetUserId: g
  }), [R, y] = o.useState(""), [j, B] = o.useState(!1), L = o.useCallback(async () => {
    if (null != b) {
      B(!0);
      try {
        await c.Z.setCommunicationDisabledDuration(N, g, p, R, U, S), k(_.jQ.TIMEOUT), (0, a.showToast)((0, a.createToast)(A.intl.formatToPlainString(A.t.O9C3Nj, {
          user: x.ZP.getName(N, null, b)
        }), a.ToastType.SUCCESS)), h()
      } catch (e) {
  ...
  return ((0, i.ZP)(() => {
    null != b && E.default.track(m.rMx.OPEN_MODAL, {
      type: T.Cl,
      guild_id: N,
      other_user_id: b.id
    })
    ...
    (null == b || null == N) && h()
  }, [N, b, h]), null == b || null == N) ? null : (0, n.jsxs)(a.Y0X, {
    transitionState: f,
    "aria-labelledby": D,
    children: [(0, n.jsxs)(a.xBx, {
      ...
      children: [(0, n.jsx)(a.X6q, {
        ...
        children: A.intl.format(A.t.OhsOy8, {
          user: x.ZP.getName(N, null, b)
        })
      }), (0, n.jsx)(a.P3F, {
        onClick: h,
      ...
      children: [(0, n.jsx)(a.Text, {
        ...
        children: A.intl.format(A.t.Ns83GR, {
        ...
        buttons: O.map(e => (function(e, t, l) {
          let {
            value: o,
            label: r
          } = e;
