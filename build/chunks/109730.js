...
function k(e) {
  ...
  } = (0, i.ZP)(), v = null != (l = null != (t = null == p ? void 0 : p[0]) ? t : null == j ? void 0 : j[0]) ? l : null, D = (0, o.e7)([x.default], () => x.default.getUser(k), [k]), [b, O] = s.useState(m.UK.DURATION_60_SEC), E = (0, d.sE)(U, {
    location: v,
    targetUserId: k
  }), [A, R] = s.useState(""), [y, B] = s.useState(!1), K = s.useCallback(async () => {
    if (null != D) {
      B(!0);
      try {
        await r.Z.setCommunicationDisabledDuration(U, k, b, A, v), E(d.jQ.TIMEOUT), (0, a.showToast)((0, a.createToast)(C.intl.formatToPlainString(C.t.O9C3Nj, {
          user: h.ZP.getName(U, null, D)
  ...
  return ((0, c.ZP)(() => {
    null != D && _.default.track(T.rMx.OPEN_MODAL, {
      type: m.Cl,
      guild_id: U,
      other_user_id: D.id
    })
    ...
    (null == D || null == U) && S()
  }, [U, D, S]), null == D || null == U) ? null : (0, n.jsxs)(a.Y0X, {
    transitionState: I,
    "aria-labelledby": f,
