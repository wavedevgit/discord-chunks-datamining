...
function p(e) {
  ...
  let {
    guildId: U,
    userId: p,
    anaylticsLocations: k,
    transitionState: I,
    onClose: S,
    modReportId: f
  } = e, j = (0, u.Dt)(), {
    analyticsLocations: v
  } = (0, i.ZP)(), D = null != (l = null != (t = null == k ? void 0 : k[0]) ? t : null == v ? void 0 : v[0]) ? l : null, b = (0, s.e7)([x.default], () => x.default.getUser(p), [p]), [O, E] = o.useState(h.UK.DURATION_60_SEC), R = (0, d.sE)(U, {
    location: D,
    targetUserId: p
  }), [A, y] = o.useState(""), [B, K] = o.useState(!1), w = o.useCallback(async () => {
    if (null != b) {
      K(!0);
      try {
        await r.Z.setCommunicationDisabledDuration(U, p, O, A, D, f), R(d.jQ.TIMEOUT), (0, a.showToast)((0, a.createToast)(C.intl.formatToPlainString(C.t.O9C3Nj, {
          user: m.ZP.getName(U, null, b)
        }), a.ToastType.SUCCESS)), S()
      } catch (e) {
  ...
  return ((0, c.ZP)(() => {
    null != b && _.default.track(T.rMx.OPEN_MODAL, {
      type: h.Cl,
      guild_id: U,
      other_user_id: b.id
    })
    ...
    (null == b || null == U) && S()
  }, [U, b, S]), null == b || null == U) ? null : (0, n.jsxs)(a.Y0X, {
    transitionState: I,
    "aria-labelledby": j,
    children: [(0, n.jsxs)(a.xBx, {
      ...
      children: [(0, n.jsx)(a.X6q, {
        ...
        children: C.intl.format(C.t.OhsOy8, {
          user: m.ZP.getName(U, null, b)
        })
      }), (0, n.jsx)(a.P3F, {
        onClick: S,
      ...
      children: [(0, n.jsx)(a.Text, {
        ...
        children: C.intl.format(C.t.Ns83GR, {
