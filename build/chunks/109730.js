...
function U(t) {
  ...
  } = (0, _.ZP)(), p = null != (n = null != (e = null == D ? void 0 : D[0]) ? e : null == b ? void 0 : b[0]) ? n : null, y = (0, i.e7)([g.default], () => g.default.getUser(U), [U]), [R, k] = a.useState(S.UK.DURATION_60_SEC), [j, B] = a.useState(""), [K, P] = a.useState(!1), [L, Z] = a.useState(!1), w = (0, i.e7)([T.Z], () => {
    var t;
  ...
  return ((0, c.ZP)(() => {
    ...
    actionBarInput: null == v || w ? void 0 : (0, l.jsx)(u.XZJ, {
      value: L,
      onChange: (t, e) => {
        Z(e)
      },
