...
function C(e, t, n, i) {
  ...
  return l = r.Modifier.applyEntity(l, s, a), r.EditorState.set(i, {
    currentContent: l
  })
}

function j(e, t, n, i) {
  let l, a, s = t.getCurrentContent(),
    c = s.getFirstBlock(),
    u = c.getText();
  "number" == typeof n ? (n > u.length && (n = u.length), null != i && i > u.length && (i = u.length), l = new r.SelectionState({
    anchorKey: c.getKey(),
    anchorOffset: n,
    focusKey: c.getKey(),
...
function T(e, t) {
  ...
  return i.findEntityRanges(e => null !== e.getEntity(), (e, t) => {
    ...
    let i = n[e.type];
    t = C([e.type, null != i && i.mutable ? "MUTABLE" : "IMMUTABLE", {
      token: e
    }], e.start, e.end, t)
  }), a.forEach(e => {
