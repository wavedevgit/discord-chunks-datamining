...
function T(e) {
  ...
  function A(e) {
    ...
    return <s.sNh id={a} label={o} action={() => I(e)} />
  }
  return <s.v2r navId={"pip-menu"} aria-label={"switch PIP"} onClose={t} onSelect={h}>{S().map(A)}</s.v2r>
}
let S = function(e) {
  let {
    voiceChannelId: t,
  ...
  return d || f ? null : <s.yRy targetElementRef={l} position={"bottom"} renderPopout={e => (0, r.jsx)(T, O({
      voiceChannelId: t,
      pipWindows: c,
      idle: n
    }, e))}>{e => (0, r.jsx)(s.P3F, I(O({
