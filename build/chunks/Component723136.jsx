...
function f(e) {
  let {
    guild: t
  } = e, n = (0, l.e7)([o.Z], () => null != t && o.Z.can(u.Plq.MANAGE_GUILD, t), [t]), c = t.features.has(u.GuildFeatures.REPORT_TO_MOD_PILOT), [f, h] = i.useState((0, a.Z)(t) && c), x = i.useCallback(async e => {
    h(e), await p(t, e)
  }, [t]);
