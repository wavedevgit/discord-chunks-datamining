...
function g(e, t) {
  ...
  return n ? <r.Fragment>{<d.sNh id={"mute-folder"} label={p.intl.string(p.t.vBTk2N)} action={() => u()}>{(0, c.k)().map(e => {
        let {
          value: t,
          label: n
        } = e;
      ...
      })}</d.sNh>}{<d.sNh id={"unmute-folder"} label={p.intl.string(p.t.VFDdkZ)} action={g} />}</r.Fragment> : null
}