...
function u(e) {
  let {
    controls: t,
    children: n
  } = e, [s, u] = r.useState(!1), [m, g] = r.useState(!1), p = r.useRef(null), h = r.useRef(null), f = (0, a.throttle)(() => {
    var e;
  ...
  return r.useLayoutEffect(() => {
    ...
    children: [(0, i.jsx)("div", {
    ...
    }), null != t && (0, i.jsx)("header", {
      className: l()(d.contentControls, {
        [d.contentControlsWithFade]: s
      }),
      children: t
    }), (0, i.jsx)(c.yW, {
      ref: p,
      ...
      className: l()(d.contentSpacerBottom, {
        [d.contentSpacerBottomBorder]: m
      })
    })]
  })
}
