...
function u(e) {
  let {
    controls: t,
    children: n
  } = e, [i, u] = l.useState(!1), [h, x] = l.useState(!1), m = l.useRef(null), b = l.useRef(null), p = (0, o.throttle)(() => {
    var e;
  ...
  }, []), null == n && null == t) ? null : (0, r.jsxs)(c.y5, {
    children: [(0, r.jsx)("div", {
      className: a()(d.contentSpacerTop, {
        [d.contentSpacerTopBorder]: h && null == t
      })
    }), null != t && (0, r.jsx)("header", {
      className: a()(d.contentControls, {
        [d.contentControlsWithFade]: i
      }),
      children: t
    }), (0, r.jsx)(s.yW, {
      ref: m,
      ...
      children: (0, r.jsx)("main", {
        ref: b,
        className: a()(d.contentInner, {
          [d.contentInnerShouldScroll]: h
        }),
        children: n
      })
    }), (0, r.jsx)("div", {
      className: a()(d.contentSpacerBottom, {
        [d.contentSpacerBottomBorder]: h
      })
    })]
  })
}
