...
function y() {
  ...
  switch (y) {
    case Chunk740903.u.OVERVIEW:
      e = (0, Chunk255367.jsx)(Chunk464610.Z, {
        guild: require
      });
      break;
    case Chunk740903.u.CAPTCHA_AND_RAID_PROTECTION:
      e = (0, Chunk255367.jsx)(Chunk733629.Z, {
    ...
    case Chunk740903.u.AUTOMOD:
      e = (0, Chunk255367.jsx)(Chunk874993.Z, {
        guildId: require.id
      });
      break;
  ...
  return (0, Chunk255367.jsxs)(Chunk255367.Fragment, {
    children: [y !== Chunk740903.u.OVERVIEW && (0, Chunk255367.jsxs)(Chunk755721.zx, {
      className: Chunk889400.back,
      innerClassName: Chunk889400.backButton,
      ...
      children: [(0, Chunk255367.jsx)(Chunk768762.Z, {
        className: Chunk889400.__invalid_arrow,
