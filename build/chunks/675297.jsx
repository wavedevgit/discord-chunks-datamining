...
function O(e) {
  ...
  let j = () => (0, g.e)({
    ...
    Z = <m.m product={t} guildId={n} showEditProduct={x} showUnpublishProduct={false} showCopyLink={true} showTestDownload={false} showDeleteProduct={false} showReportProduct={true} onEditProduct={x ? U : () => {}} onUnpublishProduct={() => {}} onDeleteProduct={() => {}} onReportProduct={G} onCopyProductLink={B} onTestDownload={() => {}} />;
  return <p.Z imageUrl={D} name={t.name} description={t.description} formattedPrice={k} role={w} ctaComponent={(0, r.jsx)(E.Z, {
      guildId: n,
      guildProductListingId: t.id,
      sourceAnalyticsLocations: O
    })} productType={L} shouldShowFullDescriptionButton={v} onShowFullDescription={j} onTapCard={j} actionMenu={Z} showOpaqueBackground={R} hideRoleTag={I} lineClamp={T} cardWidth={S} cardHeight={A} thumbnailHeight={N} descriptionTextVariant={C} isDraft={!t.published} />
}