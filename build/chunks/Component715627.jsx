...
let o = {
  ...
  u = Chunk647438.memo(function(t) {
    let {
      ...
      confettiCanvas: x
    } = r.useContext(l.h), S = (0, s.uR)(null != b ? b : x, v), [w, _] = r.useState(false);
    r.useEffect(() => {
      w && (null == j || j())
    });
    let Z = r.useMemo(() => {
    ...
    return r.useEffect(() => {
      ...
      return t = t.map((n, i) => setTimeout(() => {
        S.createMultipleConfetti(function(t, e, n, i, r) {
          var s, l;
        ...
        }(e.getBoundingClientRect(), f, h, m, g, y, O), null != p ? p : 50), i === t.length - 1 && null != j && _(true)
      }, 60 * i)), () => {
        for (let e of t) clearTimeout(e)
      }
    }, [S, e, d, p, f, h, m, g, y, O, j]), (0, i.jsx)(s.Ji, {
      ref: P,
