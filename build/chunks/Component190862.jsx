...
let O = e => {
  ...
  j = e => {
    ...
    } = (0, s.h)(t), b = (0, l.e7)([o.default], () => o.default.getId() === n.id), j = b && !a && g, x = (0, c.mR)(t), P = (0, c.Hy)(t, {
      isCurrentUser: b
    }), I = (0, c.kQ)(t), w = 1 === (0, c.Gv)(t.type), [S, E] = i.useState(false);
    return (0, r.jsx)(d.N, {
      value: {
        expanded: S,
        setExpanded: E
      ...
      children: (0, r.jsx)(O, y({
        ...
        headerTitle: x,
        headerSubtitle: P,
        headerActionButtons: b && !w ? [(0, r.jsx)(u.yX, {
          disabled: I,
          widgetType: t.type,
          widget: t,
          onAddGame: () => E(true)
