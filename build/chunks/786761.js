...
function P(e) {
  ...
  let h, m, {
    ...
    Z = e.content;
  return new d.ZP((e.type === O.uaV.PREMIUM_REFERRAL ? (h = E.default.isProbablyAValidSnowflake(e.content) ? e.content : void 0, Z = "") : e.type === O.uaV.CHAT_WALLPAPER_SET && (m = (0, a.Z)(e.content), Z = ""), C(e)) ? S(I({}, U), {
    id: e.id,
