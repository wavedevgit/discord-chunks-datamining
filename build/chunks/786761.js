...
function A(e) {
  var t;
  return null == e.author ? S : null != e.webhook_id ? new d.default(e.author) : null != (t = p.default.getUser(e.author.id)) ? t : new d.default(e.author)
}
