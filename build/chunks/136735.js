...
function B(e) {
  ...
  let {
    ...
    guildId: K,
    sticker: M
  } = e, F = (0, u.e7)([j.Z], () => j.Z.theme), Y = (0, u.e7)([f.ZP], () => (null == M ? void 0 : M.tags) != null ? f.ZP.getCustomEmojiById(M.tags) : null), H = null != (l = null == (t = v.default.getCurrentUser()) ? void 0 : t.isStaff()) && l ? S.OC : S.Ht, [q, V] = i.useState(null), [X, J] = i.useState(null != (s = null == M ? void 0 : M.name) ? s : ""), [G, Q] = i.useState({
    file: null,
    filename: null != (o = (0, O._V)(M)) ? o : ""
  }), [$, ee] = i.useState(null == Y ? void 0 : Y.id), [et, el] = i.useState(null != (w = null == Y ? void 0 : Y.name) ? w : null == M ? void 0 : M.tags), [en, ei] = i.useState(null != (P = null == M ? void 0 : M.description) ? P : ""), [es, ea] = i.useState(!1), [er, eo] = i.useState(null), eu = (0, u.e7)([x.Z], () => x.Z.getGuild(K)), ec = (null == eu ? void 0 : eu.hasFeature(k.oNc.PARTNERED)) || (null == eu ? void 0 : eu.hasFeature(k.oNc.VERIFIED)), ed = null != M, em = ed || (null == G ? void 0 : G.file) != null, ef = 0 === en.length || en.length >= 2 && en.length <= 100, eg = !es && (null == er ? void 0 : er.isBlocking) !== !0 && X.length >= 2 && (null != $ || null != et || (null == M ? void 0 : M.tags) != null && (null == M ? void 0 : M.tags) !== "") && em && ef, ep = async e => {
    var t;
    if (null == e) return;
    ...
    if (i === E.u3.LOTTIE) {
      if (!ec) return void eo({
        message: C.NW.format(C.t.RNNjy8, {
          articleURL: b.Z.getArticleURL(k.BhN.STICKERS_UPLOAD)
        }),
        isBlocking: !0
      });
    ...
    try {
      if (ea(!0), ed) await (0, I.Jf)(K, null != (n = null == M ? void 0 : M.id) ? n : "", {
        name: X,
        tags: r,
        description: en
      });
        ...
        let e = new FormData;
        e.append("name", X), e.append("tags", r), e.append("description", en), (null == G ? void 0 : G.file) != null && e.append("file", G.file), a = null != (s = null == (i = G.file) ? void 0 : i.type) ? s : "", N.default.track(k.rMx.STICKER_UPLOAD_STARTED, {
          filetype: a
        }), await (0, I.lY)({
          guildId: K,
          body: e,
          platform: "web"
        }), R(!0), (0, d.showToast)((0, d.createToast)(C.NW.string(C.t.QR85gY), d.ToastType.SUCCESS))
      }
      U()
    } catch (e) {
      eo({
