...
function U(e) {
  ...
  let {
    ...
    guildId: F,
    sticker: Y
  } = e, H = (0, u.e7)([x.Z], () => x.Z.theme), q = (0, u.e7)([g.ZP], () => (null == Y ? void 0 : Y.tags) != null ? g.ZP.getCustomEmojiById(Y.tags) : null), V = null != (l = null == (t = h.default.getCurrentUser()) ? void 0 : t.isStaff()) && l ? C.OC : C.Ht, [W, X] = i.useState(null), [G, J] = i.useState(null != (s = null == Y ? void 0 : Y.name) ? s : ""), [Q, $] = i.useState({
    file: null,
    filename: null != (o = (0, S._V)(Y)) ? o : ""
  }), [ee, et] = i.useState(null == q ? void 0 : q.id), [el, en] = i.useState(null != (w = null == q ? void 0 : q.name) ? w : null == Y ? void 0 : Y.tags), [ei, es] = i.useState(null != (Z = null == Y ? void 0 : Y.description) ? Z : ""), [ea, er] = i.useState(!1), [eo, eu] = i.useState(null), ec = (0, u.e7)([v.Z], () => v.Z.getGuild(F)), ed = (null == ec ? void 0 : ec.features.has(k.oNc.PARTNERED)) || (null == ec ? void 0 : ec.features.has(k.oNc.VERIFIED)), em = null != Y, ef = em || (null == Q ? void 0 : Q.file) != null, eg = 0 === ei.length || ei.length >= 2 && ei.length <= 100, ep = !ea && (null == eo ? void 0 : eo.isBlocking) !== !0 && G.length >= 2 && (null != ee || null != el || (null == Y ? void 0 : Y.tags) != null && (null == Y ? void 0 : Y.tags) !== "") && ef && eg, ej = async e => {
    var t;
    if (null == e) return;
    let l = null == (t = e.type) ? void 0 : t.split(";")[0];
    if (!T.has(l)) return void eu({
    ...
    let i = (0, S.Zv)(n.type);
    if (i === O.u3.LOTTIE) {
      if (!ed) return void eu({
        message: D.intl.format(D.t.RNNjy8, {
          articleURL: N.Z.getArticleURL(k.BhN.STICKERS_UPLOAD)
        }),
        isBlocking: !0
      });
    ...
    try {
      if (er(!0), em) await (0, I.Jf)(F, null != (n = null == Y ? void 0 : Y.id) ? n : "", {
        name: G,
        tags: r,
        description: ei
      });
        ...
        let e = new FormData;
        e.append("name", G), e.append("tags", r), e.append("description", ei), (null == Q ? void 0 : Q.file) != null && e.append("file", Q.file), a = null != (s = null == (i = Q.file) ? void 0 : i.type) ? s : "", b.default.track(k.rMx.STICKER_UPLOAD_STARTED, {
          filetype: a
        }), await (0, I.lY)({
          guildId: F,
          body: e,
          platform: "web"
        }), _(!0), (0, m.showToast)((0, m.createToast)(D.intl.string(D.t.QR85gY), m.ToastType.SUCCESS))
      }
      M()
    } catch (e) {
      eu({
  ...
  return (0, n.jsxs)(m.Y0X, {
    ...
    children: [(0, n.jsx)(m.olH, {
      ...
      onSubmit: ex,
      className: P.form,
      children: [(0, n.jsxs)(m.hzk, {
        className: P.modalContent,
        children: [(0, n.jsxs)(m.xBx, {
          ...
          children: [(0, n.jsxs)(m.vwX, {
            children: [D.intl.string(D.t.uGccen), (0, n.jsx)(m.ua7, {
              text: D.intl.string(D.t.S6jlDg),
              children: e => (0, n.jsx)(m.d3s, function(e) {
