...
function B(e) {
  ...
  let {
    ...
    guildId: K,
    sticker: M
  } = e, F = (0, u.e7)([j.Z], () => j.Z.theme), H = (0, u.e7)([f.ZP], () => (null == M ? void 0 : M.tags) != null ? f.ZP.getCustomEmojiById(M.tags) : null), Y = null != (l = null == (t = v.default.getCurrentUser()) ? void 0 : t.isStaff()) && l ? w.OC : w.Ht, [q, V] = i.useState(null), [X, J] = i.useState(null != (s = null == M ? void 0 : M.name) ? s : ""), [G, Q] = i.useState({
    file: null,
    filename: null != (o = (0, O._V)(M)) ? o : ""
  }), [$, ee] = i.useState(null == H ? void 0 : H.id), [et, el] = i.useState(null != (k = null == H ? void 0 : H.name) ? k : null == M ? void 0 : M.tags), [en, ei] = i.useState(null != (P = null == M ? void 0 : M.description) ? P : ""), [es, ea] = i.useState(!1), [er, eo] = i.useState(null), eu = (0, u.e7)([x.Z], () => x.Z.getGuild(K)), ec = (null == eu ? void 0 : eu.hasFeature(S.oNc.PARTNERED)) || (null == eu ? void 0 : eu.hasFeature(S.oNc.VERIFIED)), ed = null != M, em = ed || (null == G ? void 0 : G.file) != null, ef = 0 === en.length || en.length >= 2 && en.length <= 100, eg = !es && (null == er ? void 0 : er.isBlocking) !== !0 && X.length >= 2 && (null != $ || null != et || (null == M ? void 0 : M.tags) != null && (null == M ? void 0 : M.tags) !== "") && em && ef, ep = async e => {
    var t;
    if (null == e) return;
    let l = null == (t = e.type) ? void 0 : t.split(";")[0];
    if (!z.has(l)) return void eo({
