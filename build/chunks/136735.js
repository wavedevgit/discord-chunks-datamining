...
function L(e) {
  ...
  }), [$, ee] = i.useState(null == H ? void 0 : H.id), [et, el] = i.useState(null != (S = null == H ? void 0 : H.name) ? S : null == F ? void 0 : F.tags), [en, ei] = i.useState(null != (P = null == F ? void 0 : F.description) ? P : ""), [es, ea] = i.useState(!1), [er, eo] = i.useState(null), eu = (0, u.e7)([x.Z], () => x.Z.getGuild(M)), ec = (null == eu ? void 0 : eu.features.has(w.oNc.PARTNERED)) || (null == eu ? void 0 : eu.features.has(w.oNc.VERIFIED)), ed = null != F, em = ed || (null == J ? void 0 : J.file) != null, ef = 0 === en.length || en.length >= 2 && en.length <= 100, eg = !es && (null == er ? void 0 : er.isBlocking) !== !0 && X.length >= 2 && (null != $ || null != et || (null == F ? void 0 : F.tags) != null && (null == F ? void 0 : F.tags) !== "") && em && ef, ep = async e => {
    var t;
    if (null == e) return;
