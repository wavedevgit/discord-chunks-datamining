...
let B = e => {
  let {
    ...
    isAnimating: L,
    contentPosition: U
  } = e, Q = (0, x._Q)(t), W = Q >= x.OH.ACCEPTED, z = Q >= x.OH.COMPLETED, F = Q >= x.OH.CLAIMED, G = (0, f.Xv)(t.config), H = (0, S.uq)(n), X = n === h.jn.QUESTS_EMBED, Y = B || L, V = W && !F && H, K = (0, x.t5)(t, w.dr.QUESTS_CARD, n), {
