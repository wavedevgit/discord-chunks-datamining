...
function U(e) {
  ...
  } = e, p = (null == (t = o.userStatus) ? void 0 : t.completedAt) != null, m = p && (null == (n = o.userStatus) ? void 0 : n.claimedAt) != null, g = (0, h.oo)({
    quest: o
  ...
  if (p) return g ? R.intl.formatToPlainString(R.t.l1jCMz, {
    date: d
  }) : R.intl.formatToPlainString(R.t.zNoqRU, {
    reward: E,
    date: d
...
let B = e => {
  ...
  } = e, B = (0, m._Q)(n), Z = (0, m.B6)(null == (t = n.userStatus) ? void 0 : t.completedAt, {
    year: "numeric",
    month: "long",
    day: "numeric"
  }), F = B >= m.OH.ACCEPTED, V = B >= m.OH.COMPLETED, H = B >= m.OH.CLAIMED, Y = (0, h.Xv)(n.config), W = (0, A.uq)(a), K = a === E.jn.QUESTS_EMBED, z = T || w, q = F && !H && W, $ = (0, m.t5)(n, C.dr.QUESTS_CARD, a, x), {
    xboxAndPlaystationAccounts: X
  } = (0, m.z6)(), Q = (0, p.O5)(), J = i.useMemo(() => y.r.build(n.config), [n.config]), ee = (0, m.Rf)(n), et = (0, b.DD)({
    quest: n,
    taskDetails: ee,
  ...
  }, ei = (0, s.e7)([d.default], () => d.default.locale), ea = (0, m.z)(n), eo = W && Y, es = _ && !V, el = X.length > 0 && W && (0, h.$J)(n) && F && !V && !ea, ec = (0, r.jsx)(v.Z, {
    autoplay: f,
