...
function Z(e) {
  let {
    ...
    inGiftInventory: u
  } = e, d = n >= p.OH.COMPLETED, m = (0, a.e7)([c.Z], () => c.Z.useReducedMotion), x = (0, a.e7)([h.Z], () => h.Z.isEnrolling(t.id)), g = (0, j.q8)(t), f = (0, j.Vl)(t), b = (0, T.Ks)({
    progressState: n,
    quest: t,
    location: s,
    isCollectibleQuest: i,
...
let L = e => {
  ...
  let {
    ...
    month: "long",
    day: "numeric"
  }), G = W >= p.OH.ACCEPTED, F = W >= p.OH.COMPLETED, H = W >= p.OH.CLAIMED, X = (0, j.Xv)(n.config), Y = (0, S.uq)(s), V = s === g.jn.QUESTS_EMBED, K = B || U, J = G && !H && Y, $ = (0, p.t5)(n, w.dr.QUESTS_CARD, s), {
    xboxAndPlaystationAccounts: ee
  } = (0, p.z6)(), et = (0, x.O5)(), en = (0, f.j)({
    location: w.dr.QUESTS_BAR_MOBILE
  }), er = i.useMemo(() => v.r.build(n.config), [n.config]), ei = (0, p.Rf)(n), es = (0, C.DD)({
    quest: n,
    taskDetails: ei,
    location: w.dr.QUESTS_CARD,
    questContent: g.jn.QUESTS_EMBED
  }), eo = (0, a.e7)([h.Z], () => null != h.Z.questEnrollmentBlockedUntil, []), ea = (0, a.e7)([u.default], () => u.default.locale), el = (0, p.z)(n), ec = Y && X, eu = L && !F, ed = ee.length > 0 && Y && (0, j.$J)(n) && G && !F && !el, em = (0, r.jsx)(O.Z, {
    autoplay: T,
        ...
        children: [(0, r.jsx)(l.Text, {
          ...
          children: function(e) {
            ...
            let {
              ...
              quest: o
            }), C = c.defaultRewardNameWithArticle, v = c.defaultRewardName, y = u ? v : C, N = (0, j.Kr)(o.config), O = (0, j.b7)(o), T = (0, b.U)();
            if (g) {
              let e = f ? (0, j.o9)({
                  quest: o,
            ...
            if (h) return f ? _.intl.formatToPlainString(_.t.l1jCMz, {
              date: p
            }) : _.intl.formatToPlainString(_.t.zNoqRU, {
              reward: y,
              date: p
            ...
            return l ? _.intl.formatToPlainString(_.t.DT3aub, {
              reward: null != (s = null == E ? void 0 : E.messages.nameWithArticle) ? s : y
            ...
            }) : T ? x : null != N ? _.intl.formatToPlainString(_.t.Pu5eyM, {
              reward: y,
              duration: N
