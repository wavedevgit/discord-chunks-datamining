...
function M(e) {
  ...
  } = e, m = n >= h.OH.COMPLETED, p = (0, l.e7)([c.Z], () => c.Z.useReducedMotion), g = (0, l.e7)([x.Z], () => x.Z.isEnrolling(t.id)), C = (0, j.q8)(t), f = (0, j.Vl)(t), b = (0, y.Ks)({
    progressState: n,
    quest: t,
    questContent: o,
    isCollectibleQuest: s,
...
let k = e => {
  ...
  } = e, B = (0, h._Q)(n), U = (0, h.B6)(null == (t = n.userStatus) ? void 0 : t.completedAt, {
    year: "numeric",
    month: "long",
    day: "numeric"
  }), G = B >= h.OH.ACCEPTED, W = B >= h.OH.COMPLETED, F = B >= h.OH.CLAIMED, z = (0, j.Xv)(n.config), X = (0, T.uq)(o), H = o === g.jn.QUESTS_EMBED, Y = A || Q, V = G && !F && X, J = (0, h.t5)(n, q.dr.QUESTS_CARD, o, L), {
    xboxAndPlaystationAccounts: K
  } = (0, h.z6)(), $ = (0, p.O5)(), ee = s.useMemo(() => f.r.build(n.config), [n.config]), et = (0, h.Rf)(n), en = (0, C.DD)({
    quest: n,
    taskDetails: et,
    location: q.dr.QUESTS_CARD,
    questContent: g.jn.QUESTS_EMBED,
    sourceQuestContent: L
  }), er = (0, l.e7)([x.Z], () => null != x.Z.questEnrollmentBlockedUntil, []), es = (0, l.e7)([u.default], () => u.default.locale), eo = (0, h.z)(n), ei = X && z, el = k && !W, ea = K.length > 0 && X && (0, j.$J)(n) && G && !W && !eo, ec = (0, r.jsx)(v.Z, {
    autoplay: y,
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(a.ua7, {
        ...
        children: [(0, r.jsx)(a.Text, {
          ...
          children: k ? P.intl.formatToPlainString(P.t["ge+AJi"], {
          ...
          children: function(e) {
            ...
            } = e, h = (null == (t = i.userStatus) ? void 0 : t.completedAt) != null, x = h && (null == (n = i.userStatus) ? void 0 : n.claimedAt) != null, g = (0, j.oo)({
              quest: i
            ...
            if (h) return g ? P.intl.formatToPlainString(P.t.l1jCMz, {
              date: p
            }) : P.intl.formatToPlainString(P.t.zNoqRU, {
              reward: C,
              date: p
            ...
            return a ? P.intl.formatToPlainString(P.t.DT3aub, {
              reward: null != (o = null == f ? void 0 : f.messages.nameWithArticle) ? o : C
            }) : null != f && null != f.approximateCount ? P.intl.format(P.t["4bMK19"], {
