...
function k(e) {
  let {
    ...
    inGiftInventory: u
  } = e, d = n >= x.OH.COMPLETED, m = (0, l.e7)([c.Z], () => c.Z.useReducedMotion), p = (0, l.e7)([g.Z], () => g.Z.isEnrolling(t.id)), h = (0, f.q8)(t), j = (0, S.Ks)({
    progressState: n,
    quest: t,
    location: i,
    isCollectibleQuest: s,
...
let W = e => {
  ...
  }), et = s.useMemo(() => b.r.build(t.config), [t.config]), en = (0, x.Rf)(t), er = (0, C.DD)({
    quest: t,
    taskDetails: en,
    location: A.dr.QUESTS_CARD,
    questContent: h.jn.QUESTS_EMBED
  }), es = (0, l.e7)([u.default], () => u.default.locale), ei = (0, x.z)(t), eo = H && G, el = g && !z, ea = J.length > 0 && H && (0, f.$J)(t) && B && !z && !ei, ec = (0, r.jsx)(E.Z, {
    quest: t,
      ...
      children: [(0, r.jsx)(a.ua7, {
        ...
        children: [(0, r.jsx)(a.Text, {
          ...
          children: function(e) {
            ...
            } = e, h = (null === (t = l.userStatus) || void 0 === t ? void 0 : t.completedAt) != null, j = h && (null === (n = l.userStatus) || void 0 === n ? void 0 : n.claimedAt) != null, C = (0, x.B6)(null === (r = l.userStatus) || void 0 === r ? void 0 : r.completedAt, {
              year: "numeric",
              month: "long",
              day: "numeric"
            }), b = (0, f.oo)({
              quest: l
            }), N = u.defaultReward.messages.nameWithArticle, E = u.defaultReward.messages.nameWithArticle, T = p ? E : N, y = (0, f.Kr)(l.config), S = (0, f.b7)(l), O = (0, v.U)();
            if (j) {
              let e = b ? (0, f.o9)({
                  quest: l,
