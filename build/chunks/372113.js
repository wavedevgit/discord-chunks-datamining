...
function Z(e) {
  let {
    ...
    inGiftInventory: u
  } = e, d = n >= g.OH.COMPLETED, m = (0, a.e7)([c.Z], () => c.Z.useReducedMotion), x = (0, a.e7)([p.Z], () => p.Z.isEnrolling(t.id)), h = (0, j.q8)(t), f = (0, j.Vl)(t), b = (0, N.Ks)({
    progressState: n,
    quest: t,
    location: i,
    isCollectibleQuest: s,
...
let L = e => {
  ...
  let {
    ...
    isAnimating: U,
    contentPosition: Q
  } = e, W = (0, g._Q)(n), z = (0, g.B6)(null == (t = n.userStatus) ? void 0 : t.completedAt, {
    year: "numeric",
    month: "long",
    day: "numeric"
  }), G = W >= g.OH.ACCEPTED, F = W >= g.OH.COMPLETED, H = W >= g.OH.CLAIMED, X = (0, j.Xv)(n.config), Y = (0, S.uq)(i), V = i === h.jn.QUESTS_EMBED, K = B || U, J = G && !H && Y, $ = (0, g.t5)(n, w.dr.QUESTS_CARD, i), {
    xboxAndPlaystationAccounts: ee
  } = (0, g.z6)(), et = (0, x.O5)(), en = (0, f.j)({
    location: w.dr.QUESTS_BAR_MOBILE
  }), er = s.useMemo(() => v.r.build(n.config), [n.config]), es = (0, g.Rf)(n), ei = (0, C.DD)({
    quest: n,
    taskDetails: es,
    location: w.dr.QUESTS_CARD,
    questContent: h.jn.QUESTS_EMBED
  }), eo = (0, a.e7)([p.Z], () => null != p.Z.questEnrollmentBlockedUntil, []), ea = (0, a.e7)([u.default], () => u.default.locale), el = (0, g.z)(n), ec = Y && X, eu = L && !F, ed = ee.length > 0 && Y && (0, j.$J)(n) && G && !F && !el, em = (0, r.jsx)(T.Z, {
    autoplay: N,
      ...
      children: [(0, r.jsx)(l.ua7, {
        ...
        children: [(0, r.jsx)(l.Text, {
          ...
          children: function(e) {
            ...
            } = e, p = (null == (t = o.userStatus) ? void 0 : t.completedAt) != null, h = p && (null == (n = o.userStatus) ? void 0 : n.claimedAt) != null, f = (0, j.oo)({
              quest: o
            }), C = c.defaultReward.messages.nameWithArticle, v = c.defaultReward.messages.nameWithArticle, y = u ? v : C, O = (0, j.Kr)(o.config), T = (0, j.b7)(o), N = (0, b.U)();
            if (h) {
              let e = f ? (0, j.o9)({
                  quest: o,
            ...
            if (p) return f ? _.intl.formatToPlainString(_.t.l1jCMz, {
              date: g
            }) : _.intl.formatToPlainString(_.t.zNoqRU, {
              reward: y,
              date: g
            ...
            }) : N ? x : null != O ? _.intl.formatToPlainString(_.t.Pu5eyM, {
              reward: y,
              duration: O
