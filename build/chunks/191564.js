...
function C(e) {
  ...
  return (0, n.jsxs)(s.mzw, {
    ...
    children: [(0, n.jsxs)("div", {
      ...
      children: [!b && (0, n.jsx)(s.zxk, {
        look: s.zxk.Looks.LINK,
        color: s.zxk.Colors.PRIMARY,
        onClick: l,
        children: N.NW.string(N.t["ETE/oK"])
      }), null != i && (!(0, d.qS)(i) || u) || null === f ? (0, n.jsx)(s.zxk, {
        onClick: o,
        disabled: a,
        children: N.NW.string(N.t.d6sv6u)
      }) : u || !(0, d.G1)(r) ? (0, n.jsx)(s.zxk, {
...
function I(e) {
  let {
  ...
  } = (0, b.bd)(r), [j, x] = i.useMemo(() => {
    let e = (0, d.bl)(o, l);
    return [e.purchased, e.shopPreviews]
  }, [o, l]), [P, _] = i.useState(() => null != p ? p : void 0 !== h ? h : null == m ? null : null != m ? m : null), [I, S] = i.useMemo(() => {
    var e;
    ...
    product: w,
    purchase: Z
  } = (0, f.Z)(null == I ? void 0 : I.skuId), k = i.useRef(null), D = v.ZP.canUseCollectibles(t), T = P === (void 0 === h ? null != m ? m : null : h), A = i.useCallback(e => {
    _(e)
  }, [_]), B = i.useCallback(e => {
    a(), (0, u.mK)({
      analyticsLocations: g,
...
function S(e) {
  let {
    ...
    categories: h,
    purchases: v
  } = (0, p.Z)("ProfileEffectModal"), y = (0, l.e7)([j.default], () => j.default.getCurrentUser()), {
    analyticsLocations: O
  } = (0, a.ZP)(r, c.Z.EDIT_PROFILE_EFFECT_MODAL), _ = (0, b.Kg)(y, f);
  return i.useEffect(() => {
