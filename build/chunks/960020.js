...
o = "BurstReactionEffectsStore", (l = "displayName") in g ? Object.defineProperty(g, l, {
  value: o,
  enumerable: !0,
  configurable: !0,
  writable: !0
...
let f = new g(a.Z, {
  ...
  BURST_REACTION_EFFECT_PLAY: e => {
    ...
    let c = null != (t = d[r]) ? t : {},
      u = (null != (n = h[r]) ? n : {})[a],
      g = c[a];
    ("HOVER" !== s || null == g) && ("HOVER" === g && "EXTERNAL" === s && null != u && ("function" == typeof u.destroy && u.destroy(), null == (i = h[r]) || delete i[a], g = void 0), null == g && (null != d[r] ? d[r][a] = s : d[r] = {
      [a]: s
    }))
  },
