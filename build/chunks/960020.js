...
l = "BurstReactionEffectsStore", (o = "displayName") in m ? Object.defineProperty(m, o, {
  value: l,
  enumerable: !0,
  configurable: !0,
  writable: !0
...
let g = new m(a.Z, {
  ...
  BURST_REACTION_EFFECT_PLAY: e => {
    ...
    let c = null != (t = d[r]) ? t : {},
      u = (null != (n = h[r]) ? n : {})[a],
      m = c[a];
    ("HOVER" !== s || null == m) && ("HOVER" === m && "EXTERNAL" === s && null != u && ("function" == typeof u.destroy && u.destroy(), null == (i = h[r]) || delete i[a], m = void 0), null == m && (null != d[r] ? d[r][a] = s : d[r] = {
      [a]: s
    }))
  },
