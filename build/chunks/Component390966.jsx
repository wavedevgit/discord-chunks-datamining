/** Chunk was on 34082 **/
/** chunk id: 390966, original params: e,t,n (module,exports,require) **/
require.d(exports, {
  z: () => x
}), require("./388685.js");
...
function x(e) {
  let {
    ...
    guildEventId: E,
    recurrenceId: P
  } = e, I = (0, u.dQu)(c.Z.colors.TEXT_BRAND).hex(), S = (0, u.dQu)(c.Z.colors.TEXT_FEEDBACK_POSITIVE).hex(), C = (0, u.dQu)(c.Z.colors.TEXT_DANGER).hex();
  ...
  let w = (0, d.Z)(P, E),
    [{
      ...
      upcomingEvent: D,
      diffMinutes: z
    }, L] = l.useState((0, m.ub)(t, x));
  l.useEffect(() => {
    L((0, m.ub)(t, x));
    let e = setInterval(() => L((0, m.ub)(t, x)), 1e3);
    return () => {
      clearInterval(e)
    }
  }, [t, x]);
  let R = T;
  null != Z && "" !== Z && (R = f.intl.formatToPlainString(f.t.tXbu7O, {
    start: T,
    end: Z
  }));
  let _ = l.useMemo(() => n === v.p1.CANCELED || (null == w ? true : w.is_canceled) ? 5 : n === v.p1.ACTIVE ? 3 : v.$I.has(n) ? 4 : k ? 2 : +!!D, [n, null == w ? true : w.is_canceled, k, D]),
    A = function(e, t, n, l, i) {
      switch (e) {
        case 1:
          return i > 0 ? f.intl.formatToPlainString(f.t.PQlCWl, {
            minutes: i
          }) : f.intl.string(f.t.WINqKS);
        case 2:
          return f.intl.string(f.t.WINqKS);
        case 3:
          return null != l && "" !== l ? f.intl.format(f.t.vHYgJS, {
            start: n,
    ...
    }(_, R, h, Z, z),
    {
      ...
      switch (n) {
        case 3:
          c = l, d = null != s ? true : "text-feedback-positive";
          break;
        case 4:
          o = u.T39;
          break;
  ...
  if (null != y) {
    let e = (0, m.Ho)(y);
    K = f.intl.formatToPlainString(f.t.HmKEqa, {
      recurrenceRule: e.toText()
    });
    let n = o()(t);
    K = function(e, t) {
      let n = t.toDate(),
        r = n.toLocaleString(f.intl.currentLocale, {
          weekday: "long"
        });
      switch (e) {
        case p.z.WEEKLY:
          return f.intl.formatToPlainString(f.t.xQM9X1, {
            weekday: r
          });
        case p.z.BIWEEKLY:
          return f.intl.formatToPlainString(f.t.RYscaW, {
            weekday: r
          });
        case p.z.MONTHLY:
  ...
  return (0, r.jsxs)(j, {
    className: s()(a, {
      [g.isRecurring]: null != K
    }),
    tooltipText: G,
    children: [O && n === v.p1.SCHEDULED ? (0, r.jsx)(b, {}) : (0, r.jsx)(B, {
      color: X,
      size: "custom",
      width: 20,
      height: 20
