...
function N(e) {
  ...
  let B = i.useMemo(() => n === p.p1.CANCELED || (null == D ? true : D.is_canceled) ? 5 : n === p.p1.ACTIVE ? 3 : p.$I.has(n) ? 4 : M ? 2 : +!!j, [n, null == D ? true : D.is_canceled, M, j]),
    Z = I(B, G, g, x, k),
    {
      Icon: F,
      iconColor: V,
