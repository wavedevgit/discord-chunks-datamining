...
function M(e) {
  let {
    ...
    onClose: B,
    onRoleClick: Z
  } = e, F = u.ZP.useName(null == j ? true : j.id, G, t), {
    relationshipType: V,
    ...
    location: "UserProfilePopoutBody"
  }), X = (null == M ? true : M.widgets) != null && M.widgets.length > 0, Q = q && X, J = (0, d.I5)(n);
  return (0, r.jsxs)(a.Ttm, {
    ...
    }), V === D.OGo.PENDING_INCOMING && (0, r.jsx)(v.Z.Overlay, {
