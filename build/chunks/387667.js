...
function c(e) {
  ...
  return a.Z.captureMessage("Unknown target type for: ".concat(e)), s.KFR.UNKNOWN
}
...
class u {
  constructor(e, t, r) {
    h(this, "key", void 0), h(this, "oldValue", void 0), h(this, "newValue", void 0), h(this, "subtarget", void 0), this.key = e, this.oldValue = t, this.newValue = r
  }
}
class d extends i.Z {
  constructor(e) {
    var t, r, n, i, a, s;
    super(), h(this, "id", void 0), h(this, "actionType", void 0), h(this, "action", void 0), h(this, "targetType", void 0), h(this, "targetId", void 0), h(this, "target", void 0), h(this, "userId", void 0), h(this, "changes", void 0), h(this, "timestampStart", void 0), h(this, "timestampEnd", void 0), h(this, "user", void 0), h(this, "options", void 0), this.id = e.id, this.action = e.action, this.actionType = v(this.action), this.targetId = e.targetId, this.timestampStart = null !== (t = e.timestampStart) && void 0 !== t ? t : l()(o.default.extractTimestamp(this.id)), this.timestampEnd = null !== (r = e.timestampEnd) && void 0 !== r ? r : this.timestampStart, this.userId = e.userId, this.changes = null !== (n = e.changes) && void 0 !== n ? n : [], this.targetType = c(this.action), this.options = null !== (i = e.options) && void 0 !== i ? i : {}, this.target = null !== (a = e.target) && void 0 !== a ? a : e.id, this.user = null !== (s = e.user) && void 0 !== s ? s : null
  }
}
let E = d