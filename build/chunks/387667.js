/** Chunk was on 12630 **/
/** chunk id: 387667, original params: A,e,t (module,exports,require) **/
require.d(exports, {
  Pw: () => c,
  ZP: () => u,
  ms: () => f,
...
function g(A) {
  ...
  if (A <= s.rsA.BOT_ADD || A === s.rsA.MESSAGE_DELETE || A === s.rsA.MESSAGE_PIN || A === s.rsA.MESSAGE_UNPIN) return s.KFR.USER;
...
class f {
  constructor(A, e, t) {
    o(this, "key", true), o(this, "oldValue", true), o(this, "newValue", true), o(this, "subtarget", true), this.key = A, this.oldValue = e, this.newValue = t
  }
}
class v extends Chunk81825.Z {
  constructor(A) {
    var e, t, n, l, i, s;
    super(), o(this, "id", true), o(this, "actionType", true), o(this, "action", true), o(this, "targetType", true), o(this, "targetId", true), o(this, "target", true), o(this, "userId", true), o(this, "changes", true), o(this, "timestampStart", true), o(this, "timestampEnd", true), o(this, "user", true), o(this, "options", true), this.id = A.id, this.action = A.action, this.actionType = c(this.action), this.targetId = A.targetId, this.timestampStart = null != (e = A.timestampStart) ? e : r()(a.default.extractTimestamp(this.id)), this.timestampEnd = null != (t = A.timestampEnd) ? t : this.timestampStart, this.userId = A.userId, this.changes = null != (n = A.changes) ? n : [], this.targetType = g(this.action), this.options = null != (l = A.options) ? l : {}, this.target = null != (i = A.target) ? i : A.id, this.user = null != (s = A.user) ? s : null
  }
}
let u = v