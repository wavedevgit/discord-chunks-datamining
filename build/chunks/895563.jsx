/** Chunk was on 86715 **/
/** chunk id: 895563, original params: n,e,t (module,exports,require) **/
require.d(exports, {
  P: () => j,
  l: () => p
}), require("./388685.js");
...
function p(n) {
  ...
  return 0 === h.length ? <o.sNh id={"favorite-channel"} label={O(n, false)} action={() => p(null)} /> : <o.sNh id={"favorite-channel"} label={O(n, false)} action={() => p(null)}>{t && <o.kSQ><o.sNh id={"favorite-".concat(s.channel.id)} label={s.channel.name} action={() => p("null" === s.channel.id ? null : s.channel.id)} /></o.kSQ>}{<o.kSQ>{h.map(n => (0, r.jsx)(o.sNh, {
        id: "favorite-".concat(n.channel.id),
        label: n.channel.name,
        action: () => p(n.channel.id)
      }, n.channel.id))}</o.kSQ>}</o.sNh>
}

function j(n) {
  let e = (0, c.e7)([s.Z], () => s.Z.isFavorite(n.id));
  return __OVERLAY__ || !e ? null : <o.sNh id={"favorite-channel"} label={O(n, true)} color={"danger"} action={() => n.type === b.d4z.GUILD_CATEGORY ? (0, o.ZDy)(async () => {
      let {
        default: e
      } = await t.e("37720").then(t.bind(t, 357632));
      return t => {
        var i, l;
        return (0, r.jsx)(e, (i = function(n) {
          ...
          channel: n
        }, Object.getOwnPropertyDescriptors ? Object.defineProperties(i, Object.getOwnPropertyDescriptors(l)) : (function(n, e) {
          var t = Object.keys(n);
