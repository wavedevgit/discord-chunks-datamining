...
class X extends(r = o.Component) {
  ...
  render() {
    let {
      ...
      volume: p,
      type: h
    } = this.props, m = "string" == typeof f || f > 250;
...
class et extends(i = o.PureComponent) {
  ...
  updateControlsVisibility() {
    let {
      dragging: e,
      fullscreen: t
    } = this.state, n = t ? F : V, r = Math.max(0, Date.now() - this._lastMove) > n;
  ...
  renderControls() {
    ...
    return _ || n || t === Y.AUDIO ? (0, a.jsx)(X, {
      buffers: c,
      currentTime: u,
      duration: d,
      volume: (0, T.P)(g, 1),
  ...
  render() {
    let {
      ...
      hideControls: _,
      playing: f
    } = this.state, h = k.wrapperPaused;
    if (t === Y.AUDIO ? h = k.wrapperAudio : _ ? h = k.wrapperControlsHidden : f && (h = k.wrapperPlaying), r && t === Y.VIDEO) {
      let t = this.getWidth();
      return (0, a.jsxs)("div", {
        className: l()(h, {
    ...
    return (0, a.jsxs)("div", {
      className: l()(h, k.newMosaicStyle, i, {
        [k.wrapperMediaMosaic]: c === L.hV.MOSAIC
      }),
      "data-fullscreen": d,
      ...
      children: [this.renderMetadata(), t === Y.AUDIO ? this.renderAudio() : this.renderVideo(), (0, a.jsx)(p.f6W, {
