...
function k(e) {
  ...
  return f = o.e$(f, I.Plq.ADMINISTRATOR) ? C : j(r.id, n, f, i), (u.Z.isLurking(r.id) || (null == n ? true : n.isPending)) && (f = o.hX(f, c)), g.ZP.isCurrentUserGuest(r.id) && (f = o.hX(f, P)), L(f, r, t, s)
}
