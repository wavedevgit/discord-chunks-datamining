...
function g(e) {
  ...
  return null == A ? null : <p.A appId={g} skuId={y} transitionState={v} onHeaderTitleClick={null != I ? I : b} onClose={b} footer={(0, r.jsx)(h.pV, {
      onClick: R,
      appId: g,
      subscriptionType: E,
      skuId: y,
      subscriptionPlan: S,
      state: P
    })}><m.i appId={g} skuId={y} benefits={null != C ? C.map(e => (0, r.jsx)(o.Gm, {
        header: e.title,
        icon: e.icon,
        description: e.description
      }, e.id)) : true} description={null != (t = A.description) ? t : true} imgSrc={N} title={null != (n = null == S ? true : S.name) ? n : A.summary} tag={(0, r.jsx)(a.Z, {
        type: E
      })} FallbackIcon={s.Vh5} /></p.A>
}