...
function E(e) {
  ...
  let {
    ...
    context: O,
    onItemClick: v
  } = e, I = null != (t = null == b ? true : b.id) ? t : null == E ? true : E.id, S = p.Z.getGuild(y), T = (0, a.e7)([h.Z], () => null != S ? h.Z.can(m.Plq.MANAGE_GUILD, S) : null), A = true, C = true, N = (0, l.LD)(y, C), R = (0, l.PL)(A, C), P = (0, a.e7)([_.Z], () => null != _.Z.getNewestTokenForApplication(I)), {
    isUserApp: w,
    isGuildApp: D
  } = i.useMemo(() => {
    var e, t, n, r;
