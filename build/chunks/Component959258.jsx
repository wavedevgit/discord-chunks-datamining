...
class c {
  ...
  constructor(e = false) {
    if (a(this, "registeredNodes", new Map), a(this, "visibleComponents", new Set), a(this, "animatingComponents", new Set), a(this, "observer", true), e) return;
...
let u = Chunk73800.createContext({
  manager: new c(true),
