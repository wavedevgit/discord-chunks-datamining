...
function T(e) {
  ...
  let {
    ...
    incidentData: R,
    isUnderLockdown: D
  } = (0, _.mI)(C), w = (0, l.n2)(null != (t = null == N ? true : N.id) ? t : g.lds), x = i.useCallback(() => null != N && (0, c._X)(N.id), [N]);
  if (null == N || null == R || !P) return null;
  let L = e => {
      if (e && w && A !== E.oC.MEMBER_SAFETY && x()) return void p.default.track(g.rMx.APP_NOTICE_PRIMARY_CTA_OPENED, {
