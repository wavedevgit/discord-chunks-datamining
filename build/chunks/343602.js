...
function j(t) {
  ...
  let {
    ...
    target: v,
    onHeightUpdate: L
  }), _ = (0, c.e7)([u.Z], () => u.Z.isSubmitButtonEnabled), A = b.Xk.useSetting();
  ...
  let G = null != (k = null == (n = P.chatInputType) || null == (e = n.commands) ? void 0 : e.enabled) && k,
    ...
    I = (0, l.jsx)(s.S89, {
      ...
      action: () => {
        let t = !A;
        b.Xk.updateSetting(t), p.default.track(y.rMx.SLASH_COMMAND_SUGGESTIONS_TOGGLED, {
          enabled: t,
          location: {
