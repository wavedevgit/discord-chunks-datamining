...
function j(t) {
  ...
  let {
    ...
    target: v,
    onHeightUpdate: L
  }), w = (0, c.e7)([u.Z], () => u.Z.isSubmitButtonEnabled), A = (0, d.Z)(), M = p.Xk.useSetting();
  ...
  let R = null != (x = null == (n = T.chatInputType) || null == (e = n.commands) ? void 0 : e.enabled) && x,
    ...
    U = (0, l.jsx)(s.S89, {
      ...
      action: () => {
        let t = !M;
        p.Xk.updateSetting(t), f.default.track(O.rMx.SLASH_COMMAND_SUGGESTIONS_TOGGLED, {
          enabled: t,
          location: {
