...
let V = i.memo(function(e) {
    ...
    let {
    ...
    }), Y = (0, s.e7)([C.Z], () => I.Z.can(D.Plq.READ_MESSAGE_HISTORY, f) ? null : C.Z.getViewingRolesTimestamp(f.getGuildId())), {
      ...
      jumpToPresent: () => {
        if (m.hasPresent()) {
          var e;
          null == (e = z.ref.current) || e.scrollToBottom({
