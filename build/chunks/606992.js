...
function o(e) {
  let {
    ...
    type: n,
    state: o
  } = e, [s, l] = r.useState(void 0), c = null == o ? void 0 : o.query, u = null == o ? void 0 : o.isVisible, {
    renderWindow: d
  ...
  return r.useEffect(() => (d.document.addEventListener("selectionchange", _), () => d.document.removeEventListener("selectionchange", _)), [d.document, _]), r.useEffect(() => {
    _()
  }, [_, t]), s
}