...
async function p(e) {
  ...
  await (0, i.ZDy)(async () => {
    ...
    return n => {
      ...
      return <e transitionState={i} onClose={e => {
          o(), null == E || E(e)
        }} analyticsLocations={t} analyticsLocation={p} analyticsSourceLocation={null != h ? h : p} guildId={m} totalNumberOfSlotsToAssign={b} closeGuildPerksModal={g} disablePremiumUpsell={y} onSubscriptionConfirmation={v} onSubscribeComplete={O} applicationId={T} intent={S} />
    }
  }, {
    modalKey: _,
    onCloseCallback: C,
