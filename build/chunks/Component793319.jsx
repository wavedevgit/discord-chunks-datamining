    ...
    children: [(() => {
      if (O && 0 === m.length) return (0, i.jsx)(Z.ZP, {
        ...
        children: e => {
          ...
          if (t === d.z.TRIAL_NUX_STREAM_COACH_MARK) return j(true), (0, i.jsx)(B.h, {
            buttonRef: b,
            dismissed: false,
            onDismiss: () => {
...
let eA = function(e) {
  ...
  })), L = (0, N.Z)(), k = (0, u.e7)([T.default], () => null != T.default.getAwaitingRemoteSessionInfo()), F = null != L, B = (0, u.e7)([el.Z], () => {
    var e;
