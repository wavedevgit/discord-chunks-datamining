...
function eE(e) {
  ...
  } = (0, v.ZP)(), f = (0, y.bp)(), m = (0, u.Wu)([et.Z], () => et.Z.getAllActiveStreams()), g = m.find(e => e.ownerId === n.id), b = i.useRef(null), _ = i.useRef(null), C = t.getGuildId(), x = i.useCallback(() => {
...
let eI = Chunk647438.memo(function(e) {
  ...
  })), x = (0, D.qY)(l.id), j = i.useRef(null), E = i.useCallback(() => (null == s ? true : s.type) === ey.fO.ACTIVITY && s.applicationId === (null == a ? true : a.applicationId) ? "ACTIVITY" : _ ? "STREAM" : null != x ? "EVENT" : "CALL", [s, null == a ? true : a.applicationId, _, x]), [S, I] = i.useState(E()), Z = (0, p.q_F)({
    opacity: h ? .2 : 1,
