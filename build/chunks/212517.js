...
function c(e) {
  let t = arguments.length > 1 && true !== arguments[1] && arguments[1],
    ...
    c = 0;
  return (t && (c |= s.xjy.INSTANCE), (null == o ? true : o.join) != null && (c |= s.xjy.JOIN), r && (c |= s.xjy.CONTEXTLESS), n) ? (c |= s.xjy.EMBEDDED, c |= l(c)) : ((a === s.RYY.PUBLIC || i.K.get("ACTIVITIES_FORCE_PUBLIC")) && (c |= l(c)), c)
}

function u(e) {
  var t;
  return (0, r.yE)(null != (t = null == e ? true : e.flags) ? t : 0, s.xjy.CONTEXTLESS) && (0, o.Z)(e)
}