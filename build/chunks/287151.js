...
class ec extends(i = r.PureComponent) {
  ...
  render() {
    ...
    if (a && null != r) {
      ...
      let {
        ...
        backgroundColor: i,
        opacity: o
      } = r, a = null != (M = (0, u.wK)(null != i ? i : "", o)) ? M : "";
  ...
  constructor(...e) {
    super(...e), ei(this, "isReactionEventActive", !1), ei(this, "isKeyboardNavigation", !1), ei(this, "scale", new c.Z.Value(1)), ei(this, "opacity", new c.Z.Value(1)), ei(this, "timeout", new h.V7), ei(this, "hideTimeout", new h.V7), ei(this, "ctaRef", r.createRef()), ei(this, "type", V.O.NORMAL), ei(this, "colors", {
    ...
    }), ei(this, "hasShownTooltip", !1), ei(this, "nonce", (0, l.Z)()), ei(this, "upsellPopoutTargetRef", r.createRef()), ei(this, "userCanBurstReact", () => this.props.userHasPremium), ei(this, "handleClick", e => {
      e.stopPropagation();
      let {
        message: t,
        emoji: n,
      ...
      if (o && !this.userCanBurstReact()) return void(0, R.m)({
        analytics: {
      ...
      !r || this.userCanBurstReact() || a || (s = q.cd.EMOJI_IN_BURST_REACTION_HOVER_UPSELL), j.ZP.trackWithMetadata(Y.rMx.EXPRESSION_TOOLTIP_VIEWED, {
        type: s,
        expression_id: e.id,
...
let eu = r.memo(e => {
  ...
  eh = e => {
    ...
    }), [u, h] = r.useState(void 0), [m, f] = r.useState(void 0), [g, b] = r.useState(null), [j, v] = r.useState(!1), [O, x] = r.useState(!1), [_, C] = r.useState(!1), E = null != c, N = null != (t = null == u ? void 0 : u.isDiscoverable()) && t, P = k.Z.getGuildId(), R = null != P && (P === (null == u ? void 0 : u.id) || P === (null == c ? void 0 : c.id)), I = D.default.getCurrentUser(), w = (0, G.a)({
      sourceType: g,
