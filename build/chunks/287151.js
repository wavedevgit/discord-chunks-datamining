...
function ec(e, t, n) {
  (0, g.h7j)(e => (0, r.jsx)(b.default, es(eo({}, e), {
    message: t,
    selectedReaction: n
  })))
}
...
class ed extends(i = l.PureComponent) {
      ...
      children: () => (0, r.jsx)("div", {
        ...
        children: (0, r.jsx)(d.Z.div, {
          ...
          children: (0, r.jsx)(g.yRy, {
            ...
            position: "top",
            children: n => (0, r.jsxs)(g.P3F, es(eo({}, n), {
  ...
  constructor(...e) {
    super(...e), el(this, "isReactionEventActive", !1), el(this, "isKeyboardNavigation", !1), el(this, "scale", new d.Z.Value(1)), el(this, "opacity", new d.Z.Value(1)), el(this, "timeout", new m.V7), el(this, "hideTimeout", new m.V7), el(this, "ctaRef", l.createRef()), el(this, "type", z.O.NORMAL), el(this, "colors", {
      ...
      s && !this.isReactionEventActive && !r && l && (0, A.T6)({
      ...
      }, u = "string" == typeof o ? "" === o.trim() : null == o, d = () => u || null == o || null == a ? null : (0, r.jsx)(g.Text, {
      ...
      return n === z.O.BURST ? (0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(g.P3F, {
          ...
          return i ? (0, r.jsxs)("div", {
            ...
            children: [(0, H.I5)(e) && (0, r.jsx)(g.SrA, {
              size: "md",
      ...
      let {
        ...
        message: t,
        type: n
      } = this.props, i = F.default.getCurrentUser(), r = k.Z.getChannel(t.getChannelId()), l = n === z.O.BURST, o = (0, H.I5)(i), s = l ? Q.cd.EMOJI_IN_BURST_REACTION_HOVER : Q.cd.EMOJI_IN_REACTION_HOVER;
      !l || this.userCanBurstReact() || o || (s = Q.cd.EMOJI_IN_BURST_REACTION_HOVER_UPSELL), O.ZP.trackWithMetadata($.rMx.EXPRESSION_TOOLTIP_VIEWED, {
        type: s,
        expression_id: e.id,
        ...
        is_custom: null != e.id,
        nonce: this.nonce
      }), !l || null == r || o || this.userCanBurstReact() || V.default.track($.rMx.PREMIUM_UPSELL_VIEWED, {
        type: Q.cd.BURST_REACTION_UPSELL,
        location: {
...
let eh = l.memo(e => {
    let {
      ...
      message: i,
      emoji: l
    } = e, o = t === z.O.BURST, s = (0, P.v)(o && null != n ? n : []), a = (0, p.e7)([G.Z], () => void 0 !== G.Z.getEffectForEmojiId(i.getChannelId(), i.id, l)), c = (0, p.e7)([j.Z], () => j.Z.useReducedMotion), u = _.Yk.useSetting(), d = F.default.getCurrentUser(), h = (0, H.I5)(d), m = (0, p.e7)([G.Z], () => G.Z.getReactionPickerAnimation(i.id, l.name, l.id)), g = o && (a || null != m);
    return (0, r.jsx)(ed, es(eo({}, e), {
      colors: s,
      isBurstReaction: o,
      hideEmoji: g,
      userHasPremium: h,
  ...
  em = e => {
    ...
    let {
      ...
      return {
        joinedEmojiSourceGuild: (null == e ? void 0 : e.type) === T.B.GUILD ? L.Z.getGuild(null == e ? void 0 : e.guildId) : void 0
      }
    }), [u, d] = l.useState(void 0), [h, m] = l.useState(void 0), [f, b] = l.useState(null), [j, v] = l.useState(!1), [O, y] = l.useState(!1), [x, P] = l.useState(!1), E = null != c, N = null != (t = null == u ? void 0 : u.isDiscoverable()) && t, R = U.Z.getGuildId(), I = null != R && (R === (null == u ? void 0 : u.id) || R === (null == c ? void 0 : c.id)), w = F.default.getCurrentUser(), Z = (0, W.a)({
      sourceType: f,
    ...
    return (0, r.jsxs)("div", {
      children: [M ? (0, r.jsxs)(r.Fragment, {
        ...
        }), null != Z.emojiDescription && Z.type !== W.$.UNAVAILABLE && (0, r.jsx)(g.Text, {
          variant: "text-sm/normal",
          "aria-label": Z.type,
