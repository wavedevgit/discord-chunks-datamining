/** Chunk was on web.js **/
/** chunk id: 232582, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  dz: () => o,
  ih: () => g
}), require("./734808.js"), require("./896048.js"), require("./65821.js"), require("./321073.js");
...
class _ extends Chunk324281.G {
  ...
  internalBinaryWrite(e, t, n) {
    "" !== e.link && t.tag(1, r.O0.LengthDelimited).string(e.link), "" !== e.locale && t.tag(2, r.O0.LengthDelimited).string(e.locale), false !== e.isDefault && t.tag(3, r.O0.Varint).bool(e.isDefault);
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.f$.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
