...
let y = (e, t, n, r) => {
  ...
  v = e => {
    let {
      ...
      primaryColor: A,
      secondaryColor: N
    } = (0, d.Z)(null == v ? void 0 : v.src), C = (0, c.yA)(n), w = (0, c.Nq)(n), R = i.useCallback(e => {
      if (null != t && null != I && null != C && null != w && (0, _.qy)(w)) return (0, u.SO)({
        entry: n,
    ...
    return (0, r.jsxs)(h.yR, {
      children: [(0, r.jsx)(h.wG, {
        channel: t,
        headerIcons: null == P ? null : (0, r.jsx)(m.Z, {
          Icon: P,
