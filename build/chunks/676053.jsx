...
function O(e) {
  ...
  let N = i.useRef(null),
    ...
    L = C ? <img src={h} alt={""} draggable={false} className={p.inlineAsset} /> : <r.Fragment>{<a.Z ref={N} src={h} width={240} height={135} autoPlay={true} muted={true} loop={true} playsInline={true} className={p.inlineAsset} controls={false} preload={"metadata"} />}{<div className={p.playButton}><o.J playing={false} size={"sm"} aria-label={"Play video: ".concat(t)} onClick={D} /></div>}</r.Fragment>;
  return <l.m{...E(m({}, A), {
    onRequestClose: P,
    hasVideo: true,
