...
function O(e) {
  let {
    url: t
  } = e, n = g(t), i = E(t), c = (0, a.e7)([_.Z], () => _.Z.getRegisteredExperiments()), h = (0, a.e7)([_.Z], () => null == n ? null : _.Z.getLoadedUserExperiment(n)), m = (0, a.cj)([_.Z], () => _.Z.getAllExperimentOverrideDescriptors()), b = (0, a.e7)([l.default], () => {
  ...
  let I = (0, f.a)(O.buckets, O.description).find(e => e.value === i),
    ...
    C = null;
  return (1 === T && null != I ? C = (0, r.jsx)(s.Text, {
    variant: "text-xs/normal",
    color: "text-muted",
    children: I.label
  }) : null != h && (C = (0, r.jsxs)(s.Text, {
    variant: "text-xs/normal",
    color: "text-muted",
