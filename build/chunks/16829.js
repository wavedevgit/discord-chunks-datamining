...
let S = l.memo(function() {
    return (0, r.jsx)(o.ua7, {
      ...
      children: e => (0, r.jsx)(o.Text, R(p({}, e), {
...
function v(e) {
  ...
  let {
    ...
    className: E,
    onClickInviter: A
  } = e, m = (0, a.e7)([_.ZP], () => null == i ? null : _.ZP.getMember(n, i.id), [i, n]), f = (0, d.X7)(null == m ? void 0 : m.guildId, null == m ? void 0 : m.userId, null == m ? void 0 : m.colorStrings), g = l.useCallback(e => {
...
function L(e) {
  ...
  switch (!0) {
    ...
    case null != i && A:
      return (0, r.jsxs)(o.P3F, R(p({
        className: N.inviteContainer
      }, E), {
        "aria-label": (0, h.MS)(i),
        role: "button",
        tabIndex: 0,
...
let M = l.memo(function(e) {
  ...
  let {
    ...
    onClickInviter: c
  } = e, d = (0, a.e7)([g.Z], () => g.Z.getEnhancedMember(s, i), [s, i]), _ = null != (t = null == d ? void 0 : d.inviterId) ? t : null, f = (0, a.e7)([m.default], () => m.default.getUser(_), [_]);
  l.useEffect(() => {
  ...
  return (O === h.gq.INVITE || O === h.gq.VANITY_URL || O === h.gq.MANUAL_MEMBER_VERIFICATION && null != I) && T ? (0, r.jsx)(C, {}) : (0, r.jsx)(D, {
    hasTooltip: v && !o,
