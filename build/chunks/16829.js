...
function v(e) {
  ...
  let {
    ...
    className: E,
    onClickInviter: A
  } = e, m = (0, a.e7)([_.ZP], () => null == i ? null : _.ZP.getMember(n, i.id), [i, n]), T = (0, d.X7)(null == m ? void 0 : m.guildId, null == m ? void 0 : m.userId, null == m ? void 0 : m.colorStrings), g = l.useCallback(e => {
...
let L = l.memo(function(e) {
  ...
  let {
    ...
    onClickInviter: c
  } = e, d = (0, a.e7)([g.Z], () => g.Z.getEnhancedMember(s, i), [s, i]), _ = null != (t = null == d ? void 0 : d.inviterId) ? t : null, T = (0, a.e7)([m.default], () => m.default.getUser(_), [_]);
  l.useEffect(() => {
