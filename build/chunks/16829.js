...
function m(A) {
  ...
  } = A, f = (0, s.e7)([u.Z], () => u.Z.getChannel(g)), c = (0, v.ZP)(f, !0), h = !!t && (o === p.gq.SOCIAL_LAYER_INTEGRATION_LINKED_CHANNEL || null != i), E = r.useMemo(() => o === p.gq.SOCIAL_LAYER_INTEGRATION_LINKED_CHANNEL ? (0, n.jsx)(y, {
    channel: f
  }) : (0, n.jsx)(T, {
    guildId: l,
    inviterUser: i,
...
function x(A) {
  var {
    ...
    integrationType: o,
    joinSourceChannelId: g,
    showJoinMethodContextAsFooter: v,
    guildId: h,
    inviterUser: E,
    onClickInviter: d
  } = A, C = function(A, e) {
...
let Z = r.memo(function(A) {
  ...
  let {
    ...
    onClickInviter: g
  } = A, f = (0, s.e7)([M.Z], () => M.Z.getEnhancedMember(i, l), [i, l]), v = null != (e = null == f ? void 0 : f.inviterId) ? e : null, c = (0, s.e7)([B.default], () => B.default.getUser(v), [v]);
  r.useEffect(() => {
    null != v && (o.Z.requestMembersById(i, [v]), (0, E.Z)(v, void 0, {
      guildId: i
    }))
  }, [i, v]);
  ...
  return (d === p.gq.INVITE || d === p.gq.VANITY_URL || d === p.gq.MANUAL_MEMBER_VERIFICATION && null != u) && h ? (0, n.jsx)(V, {}) : (0, n.jsx)(m, {
    hasTooltip: b && !a,
