...
function C(e) {
  ...
  let {
    ...
    className: _,
    onClickInviter: A
  } = e, T = (0, a.e7)([d.ZP], () => null == s ? null : d.ZP.getMember(n, s.id), [s, n]), I = (0, u.X7)(null == T ? void 0 : T.guildId, null == T ? void 0 : T.userId, null == T ? void 0 : T.colorStrings), N = l.useCallback(e => {
