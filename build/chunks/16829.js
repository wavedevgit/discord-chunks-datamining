...
let U = l.memo(function() {
    return (0, r.jsx)(o.ua7, {
      ...
      children: e => (0, r.jsx)(o.Text, h(S({}, e), {
...
function C(e) {
  ...
  let {
    ...
    className: _,
    onClickInviter: A
  } = e, T = (0, i.e7)([d.ZP], () => null == a ? null : d.ZP.getMember(n, a.id), [a, n]), N = (0, u.E)(null == T ? void 0 : T.guildId, null == T ? void 0 : T.colorStrings), O = l.useCallback(e => {
...
let v = l.memo(function(e) {
  ...
  let {
    ...
    onClickInviter: c
  } = e, u = (0, i.e7)([O.Z], () => O.Z.getEnhancedMember(s, a), [s, a]), d = null != (t = null == u ? void 0 : u.inviterId) ? t : null, N = (0, i.e7)([T.default], () => T.default.getUser(d), [d]);
  l.useEffect(() => {
    null != d && (E.Z.requestMembersById(s, [d]), (0, _.Z)(d, void 0, {
      guildId: s
    }))
  }, [s, d]);
  ...
  let {
    ...
    joinSourceType: R,
    integrationType: p
  } = u, h = null != R ? L[R] : null, C = null != (n = null == h ? void 0 : h.hasTooltip) && n;
  return (R === f.gq.INVITE || R === f.gq.VANITY_URL || R === f.gq.MANUAL_MEMBER_VERIFICATION && null != g) && I ? (0, r.jsx)(D, {}) : (0, r.jsx)(m, {
    hasTooltip: C && !o,
    inviterUser: null != N ? N : null,
    guildId: s,
    joinSourceType: R,
    children: e => (0, r.jsx)(b, S({
      sourceInviteCode: g,
      joinSourceType: R,
      integrationType: p,
      showInviterAsFooter: o,
