...
class D {
  ...
  stop() {
    this._started = !1, A = null, T = 0, null != this._nextCheck && clearTimeout(this._nextCheck), l.Z.dispatch({
  ...
  async _checkTwitch(e) {
    ...
    try {
      ...
      }, _ = await w(l, t), p = u.Z.get(h.ABu.TWITCH), m = null != (i = P(s)) ? i : e.name, g = null != c && "" !== c ? c.slice(0, I) : void 0, E = null != _ && "" !== _ ? _.slice(0, I) : void 0;
      return {
