...
function Z(e, t) {
  ...
  let n = Y(e, t.userId);
  x[n] !== t.communicationDisabledUntil && (0, _.b)(t) && (x[n] = t.communicationDisabledUntil, V(n))
}

function F(e, t) {
  if (null != t) {
    let n = Y(e, t);
    null != x[n] && V(n), H(Y(e, t))
  } else
    for (let t in x) {
      let n = t;
      K(n) === e && (V(t), H(n))
...
function q(e) {
  ...
  if ((0, m.yE)(null != (t = L.flags) ? t : 0, T.q.IS_GUEST) && (L.flags = (0, m.pj)(null != (n = L.flags) ? n : 0, T.q.BYPASSES_VERIFICATION)), null == P[o]) return L;
  if (r === y.default.getId())
    if (h.Z.isViewingRoles(o) || h.Z.isFullServerPreview(o)) {
      let e = h.Z.getViewingRoles(o);
      D[o] = C(A({}, L, h.Z.getMemberOptions(o)), {
...
function en(e) {
  for (let t of e)
    if (null != t.member && (null == L[t.id] ? L[t.id] = t.member : L[t.id] = C(A({}, t.member), {
        roles: t.member.roles
      }), null != P[t.id])) {
      let e = P[t.id];
      null != e[t.member.userId] && (e[t.member.userId] = C(A({}, e[t.member.userId]), {
        roles: t.member.roles
      }))
    }
}
...
function eC(e) {
  ...
  (null == (t = n.resolved) ? true : t.members) != null && null != r && ev({
    ...
    members: Object.entries(n.resolved.members).map(e => {
      var t, r;
      let [i, o] = e, a = null == (r = n.resolved) || null == (t = r.users) ? true : t[i];
      if (null != a) return C(A({}, o), {
        user: a
      })
    }).filter(e => null != e)
  })
...
function eR(e) {
  ...
  null == n || n.isPrivate() || ev({
    ...
    members: Object.entries(e.resolved.members).map(t => {
      var n, r;
      let [i, o] = t, a = null == (r = e.resolved) || null == (n = r.users) ? true : n[i];
      if (null != a) return C(A({}, o), {
        user: a
      })
    }).filter(e => null != e)
