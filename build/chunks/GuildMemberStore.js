...
function X(e) {
  ...
  if ((0, g.yE)(null != (t = x.flags) ? t : 0, T.q.IS_GUEST) && (x.flags = (0, g.pj)(null != (n = x.flags) ? n : 0, T.q.BYPASSES_VERIFICATION)), null == w[a]) return x;
...
function ei(e) {
  var t, n;
  if (null == e.guildId || null == S.Z.getGuild(e.guildId)) returnfalse;
