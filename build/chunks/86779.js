...
let b = "mweb_handoff_nonce",
  ...
  S = () => {
    ...
    if ("null" === n && null === y && P("deep_link_failed"), null != n && "null" !== n && null == A && null === y && P("nonce_missing"), i.useEffect(() => {
      ...
      }, [n, A, y, S, P]), null == S) return null;
    let T = null == y ? (0, r.jsxs)(r.Fragment, {
      children: [x.NW.string(x.t.uJ1Jsb), (0, r.jsx)("br", {}), x.NW.string(x.t.GHVWAg)]
    }) : I.has(y) ? x.NW.string(x.t.EPt55u) : j.has(y) ? x.NW.string(x.t.g87kTk) : void 0;
    return null != y && I.has(y) ? (0, r.jsx)("div", {
      ...
      children: [(0, r.jsx)(u.Text, {
        ...
        onClick: () => {
          ...
          r.set("redirect", encodeURIComponent(window.location.pathname + n.toString())), r.set("key", e), r.set("fingerprint", S), t.search = r.toString(), p.default.track(_.rMx.DEEP_LINK_CLICKED, {
            fingerprint: (0, o.K)(S),
