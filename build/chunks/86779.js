...
let b = "mweb_handoff_nonce",
  ...
  N = () => {
    ...
    if ("null" === n && null === y && P("deep_link_failed"), null != n && "null" !== n && null == Z && null === y && P("nonce_missing"), i.useEffect(() => {
        if (null != Z) {
          let e = c.K.get(v);
          (null == e || Date.now() >= e) && (P("nonce_expired"), S())
        }
      }, [Z, P]), i.useEffect(() => {
        null != n && "null" !== n && null != Z && null == y && a.tn.post({
      ...
      }, [n, Z, y, N, P]), null == N) return null;
    let A = null == y ? (0, r.jsxs)(r.Fragment, {
