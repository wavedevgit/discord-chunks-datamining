...
let b = "mweb_handoff_nonce",
  ...
  y = () => {
    ...
    let [j, C] = i.useState(null), T = i.useCallback(e => {
    ...
    if ("null" === n && null === j && T("deep_link_failed"), null != n && "null" !== n && null == A && null === j && T("nonce_missing"), i.useEffect(() => {
      ...
      }, [n, A, j, y, T]), null == y) return null;
    let P = null == j ? (0, r.jsxs)(r.Fragment, {
      children: [E.intl.string(E.t.uJ1Jsb), (0, r.jsx)("br", {}), E.intl.string(E.t.GHVWAg)]
    }) : S.has(j) ? E.intl.string(E.t.EPt55u) : O.has(j) ? E.intl.string(E.t.g87kTk) : void 0;
    return null != j && S.has(j) ? (0, r.jsx)("div", {
      ...
      children: [(0, r.jsx)(u.Text, {
        ...
        onClick: () => {
          ...
          r.set("redirect", encodeURIComponent(window.location.pathname + n.toString())), r.set("key", e), r.set("fingerprint", y), t.search = r.toString(), g.default.track(_.rMx.DEEP_LINK_CLICKED, {
            fingerprint: (0, a.K)(y),
