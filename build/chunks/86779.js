...
let b = "mweb_handoff_nonce",
  ...
  S = () => {
    ...
    i.useEffect(() => {
      null !== g && e !== g && d.Z.dispatch({
        type: "FINGERPRINT",
        fingerprint: g
      })
    }, [g, e]);
    let [y, C] = i.useState(null), T = i.useCallback(e => {
      C(e), m.default.track(_.rMx.MOBILE_WEB_HANDOFF_FAILURE, {
        reason: e,
        fingerprint: (0, a.K)(S)
      }, {
        fingerprint: S
    ...
    if ("null" === n && null === y && T("deep_link_failed"), null != n && "null" !== n && null == A && null === y && T("nonce_missing"), i.useEffect(() => {
        if (null != A) {
          let e = c.K.get(I);
          (null == e || Date.now() >= e) && (T("nonce_expired"), j())
        }
      }, [A, T]), i.useEffect(() => {
        null != n && "null" !== n && null != A && null == y && s.tn.post({
      ...
      }, [n, A, y, S, T]), null == S) return null;
    let P = null == y ? (0, r.jsxs)(r.Fragment, {
      children: [x.intl.string(x.t.uJ1Jsb), (0, r.jsx)("br", {}), x.intl.string(x.t.GHVWAg)]
    }) : N.has(y) ? x.intl.string(x.t.EPt55u) : O.has(y) ? x.intl.string(x.t.g87kTk) : void 0;
    return null != y && N.has(y) ? (0, r.jsx)("div", {
      ...
      children: [(0, r.jsx)(u.Text, {
        ...
        onClick: () => {
          ...
          r.set("redirect", encodeURIComponent(window.location.pathname + n.toString())), r.set("key", e), r.set("fingerprint", S), t.search = r.toString(), m.default.track(_.rMx.DEEP_LINK_CLICKED, {
            fingerprint: (0, a.K)(S),
