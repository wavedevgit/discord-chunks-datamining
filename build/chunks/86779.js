...
let b = "mweb_handoff_nonce",
  ...
  N = () => {
    ...
    let [y, C] = i.useState(null), P = i.useCallback(e => {
      C(e), g.default.track(_.rMx.MOBILE_WEB_HANDOFF_FAILURE, {
        reason: e,
        fingerprint: (0, s.K)(N)
      }, {
        fingerprint: N
    ...
    return null != y && O.has(y) ? (0, r.jsx)("div", {
      ...
      children: [(0, r.jsx)(u.Text, {
        ...
        onClick: () => {
          ...
          r.set("redirect", encodeURIComponent(window.location.pathname + n.toString())), r.set("key", e), r.set("fingerprint", N), t.search = r.toString(), g.default.track(_.rMx.DEEP_LINK_CLICKED, {
            fingerprint: (0, s.K)(N),
