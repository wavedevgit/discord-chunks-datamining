...
n.d(t, {
  Z: () => N
}), n(388685), n(35282), n(190126), n(368063), n(65234), n(111804), n(490233), n(97749), n(457542);
var r = n(200651),
  i = n(192379),
  l = n(593473),
  s = n(756647),
...
let E = "mweb_handoff_nonce",
  ...
  N = () => {
    ...
    let [y, C] = i.useState(null), P = i.useCallback(e => {
      C(e), p.default.track(_.rMx.MOBILE_WEB_HANDOFF_FAILURE, {
        reason: e,
        fingerprint: (0, s.K)(N)
      }, {
        fingerprint: N
    ...
    if ("null" === n && null === y && P("deep_link_failed"), null != n && "null" !== n && null == A && null === y && P("nonce_missing"), i.useEffect(() => {
        if (null != A) {
          let e = c.K.get(v);
          (null == e || Date.now() >= e) && (P("nonce_expired"), S())
        }
      }, [A, P]), i.useEffect(() => {
        null != n && "null" !== n && null != A && null == y && a.tn.post({
      ...
      }, [n, A, y, N, P]), null == N) return null;
    let T = null == y ? (0, r.jsxs)(r.Fragment, {
      children: [x.intl.string(x.t.uJ1Jsb), (0, r.jsx)("br", {}), x.intl.string(x.t.GHVWAg)]
    }) : O.has(y) ? x.intl.string(x.t.EPt55u) : I.has(y) ? x.intl.string(x.t.g87kTk) : void 0;
    return null != y && O.has(y) ? (0, r.jsx)("div", {
      ...
      children: [(0, r.jsx)(u.Text, {
        ...
        onClick: () => {
          ...
          r.set("redirect", encodeURIComponent(window.location.pathname + n.toString())), r.set("key", e), r.set("fingerprint", N), t.search = r.toString(), p.default.track(_.rMx.DEEP_LINK_CLICKED, {
            fingerprint: (0, s.K)(N),
