...
let v = "mweb_handoff_nonce",
  ...
  C = () => {
    ...
    let [y, A] = i.useState(null), T = i.useCallback(e => {
    ...
    return null != y && S.has(y) ? (0, r.jsx)("div", {
      ...
      children: [(0, r.jsx)(d.Text, {
        ...
        onClick: () => {
          ...
          r.set("redirect", encodeURIComponent(window.location.pathname + n.toString())), r.set("key", e), r.set("fingerprint", C), t.search = r.toString(), f.default.track(x.rMx.DEEP_LINK_CLICKED, {
            fingerprint: (0, s.K)(C),
