...
let v = "mweb_handoff_nonce",
  ...
  y = () => {
    ...
    i.useEffect(() => {
      null !== g && e !== g && h.Z.dispatch({
        type: "FINGERPRINT",
        fingerprint: g
      })
    }, [g, e]);
    let [C, A] = i.useState(null), T = i.useCallback(e => {
    ...
    if ("null" === n && null === C && T("deep_link_failed"), null != n && "null" !== n && null == Z && null === C && T("nonce_missing"), i.useEffect(() => {
        if (null != Z) {
          let e = c.K.get(j);
          (null == e || Date.now() >= e) && (T("nonce_expired"), N())
        }
      }, [Z, T]), i.useEffect(() => {
        null != n && "null" !== n && null != Z && null == C && a.tn.post({
    ...
    return null != C && S.has(C) ? (0, r.jsx)("div", {
      ...
      children: [(0, r.jsx)(d.Text, {
        ...
        onClick: () => {
          ...
          r.set("redirect", encodeURIComponent(window.location.pathname + n.toString())), r.set("key", e), r.set("fingerprint", y), t.search = r.toString(), m.default.track(x.rMx.DEEP_LINK_CLICKED, {
            fingerprint: (0, o.K)(y),
