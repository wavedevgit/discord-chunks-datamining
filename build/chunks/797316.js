...
function A(e, t) {
  ...
  T.forEach(i => {
    var a;
    i !== O.Z.getGuildId() && i !== b.Z.getGuildId() && i !== (null == (a = h.Z.getChannel(v.Z.getChannelId())) ? void 0 : a.getGuildId()) && (null == r || r.guildId !== i) && (T.clearWithoutFlushing(i, e), t && (n[i] = T.get(i)))
