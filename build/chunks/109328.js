...
e.exports = function(e, t, r, i, a, o) {
  var s, l, c, u, d = this,
    _ = [],
    f = r.type;
  if ("keypress" !== f || r.code && "Arrow" === r.code.slice(0, 5) || (d.callbacks["any-character"] || []).forEach(function(e) {
      _.push(e)
    }), !d.callbacks[e]) return _;
  for (c = n(64e3), "keyup" === f && c(e) && (t = [e]), s = 0; s < d.callbacks[e].length; ++s)
