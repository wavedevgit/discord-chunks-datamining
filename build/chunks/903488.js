...
class h {
  ...
  handleSearchSuccess(e, t) {
    ...
    this.analyticsId = r, this.isFetching = !1, this.isIndexing = !1, this.isInitialFetchComplete = !0, this.isHistoricalIndexing = a, this.error = null, this.documentsIndexed = i, this.showNoResultsAlt = .05 > Math.random(), this.cursor = s;
