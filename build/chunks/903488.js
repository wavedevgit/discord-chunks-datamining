...
class p {
  ...
  handleSearchFailure(e) {
    this.isFetching = !1, this.isIndexing = !1, this.isInitialFetchComplete = !0, this.isHistoricalIndexing = !1, this.error = new a.Hx(e), this.analyticsId = null, this.documentsIndexed = 0, this.showNoResultsAlt = .05 > Math.random()
  }
  handleSearchSuccess(e, t) {
    ...
    this.analyticsId = r, this.isFetching = !1, this.isIndexing = !1, this.isInitialFetchComplete = !0, this.isHistoricalIndexing = a, this.error = null, this.documentsIndexed = o, this.showNoResultsAlt = .05 > Math.random(), this.cursor = i;
