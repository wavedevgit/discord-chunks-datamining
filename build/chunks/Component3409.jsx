...
function eR(e) {
  ...
  null != t && (o = eC(t));
  let a = n;
  return null != n && (a = eC(n)), (0, r.jsx)(P.Z, er(et({}, i), {
    onPrimary: o,
    onBack: a
  }))
}
...
function eP(e) {
  ...
  let [eH, eY] = i.useState(m), [eW, eK] = i.useState(null), [ez, eq] = i.useState(eV(m)), eX = (0, l.e7)([j.Z], () => j.Z.redirectedPaymentSourceId), eQ = (0, l.e7)([z.Z], () => z.Z.cashAppPayComponent), eJ = {
    completeSteps: tm,
  ...
  switch (eH) {
      ...
      let tP = (e, t) => {
          ...
          switch (e) {
            ...
            case X.He.PAYMENT_REQUEST:
              en && "googlePay" === t ? n(C.h8.AWAITING_BROWSER_CHECKOUT_GOOGLE_PAY) : en && "applePay" === t ? n(C.h8.AWAITING_BROWSER_CHECKOUT_APPLE_PAY) : (eq(ek), n(C.h8.PAYMENT_REQUEST_INFORMATION));
              break;
    ...
    case C.h8.ADDRESS:
      ...
      eP && null != tT && (p = C.h8.PAYMENT_ELEMENT), n = eP ? null : (0, r.jsx)(eA, {
        billingAddressInfo: e7.info,
        onBillingAddressChange: (e, t) => {
          e9({
            info: et({}, e7.info, e),
...
function ew(e) {
  ...
  let [s, c] = i.useState(() => ({
    ...
    token: null
  })), [I, T, S, A, N] = (0, l.Wu)([j.Z], () => [j.Z.braintreeEmail, j.Z.braintreeNonce, j.Z.error, j.Z.venmoUsername, j.Z.adyenPaymentData]), [C, R] = (0, l.Wu)([k.Z], () => [k.Z.error, k.Z.isAwaitingAuthentication]);
  i.useEffect(() => {
    let e = e => {
      let {
        billingAddress: t
  ...
  let [P, w] = i.useState(false), [D, L] = i.useState(false), [x, M] = i.useState(null), B = i.useRef(null), Z = (0, l.e7)([k.Z], () => k.Z.isAwaitingAuthentication), [F, V] = (0, l.Wu)([G.Z], () => [G.Z.purchaseTokenAuthState, G.Z.purchaseTokenHash]);
  return i.useEffect(() => {
