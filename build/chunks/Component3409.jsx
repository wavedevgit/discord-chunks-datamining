...
function ey(e) {
  ...
  null != t && (a = eb(t));
  let o = n;
  return null != n && (o = eb(n)), (0, r.jsx)(R.Z, ea(er({}, i), {
    onPrimary: a,
    onBack: o
  }))
}
...
function eO(e) {
  ...
  let n, o, u, _, {
    ...
    eS = i.useMemo(() => {
      let e = m === P.h8.PAYMENT_TYPE || m === P.h8.PAYMENT_ELEMENT;
      return ev && e ? ei ? P.h8.AWAITING_BROWSER_CHECKOUT : P.h8.PAYMENT_ELEMENT : m
    }, [ev, m, ei]),
    eI = i.useMemo(() => (0, H.vP)(), []),
    {
  ...
  function ej(e) {
    switch (e) {
      ...
      default:
        return {
          steps: [P.h8.ADD_PAYMENT_STEPS]
        }
    }
  }
  let [eM, ek] = i.useState(eS), [eU, eG] = i.useState(null), [eZ, eF] = i.useState(ej(eS)), eB = (0, l.e7)([k.Z], () => k.Z.redirectedPaymentSourceId), eV = (0, l.e7)([Q.Z], () => Q.Z.cashAppPayComponent), eH = {
    completeSteps: tu,
  ...
  i.useEffect(() => {
    ...
    (async () => {
      if (null == eB) return;
      await (0, d.tZ)();
      let n = G.Z.getPaymentSource(eB);
      null != n && (e(n), t(false), k.Z.clearRedirectedPaymentSourceId())
    })()
  }, [eB]);
  let eW = i.useCallback(function(e) {
  ...
  let [ez, eq] = i.useState(null), {
    ...
    setP24BankState: ta,
    selectedSkuId: to
  } = h, ts = null != to ? to : "", tl = (0, l.e7)([F.Z], () => F.Z.get(ts), [ts]), tc = null == tl || null == (t = tl.eligiblePaymentGateways) ? true : t.map(e => e.valueOf());
  ...
  let td = !(0, B.isDesktop)() || ei ? ["googlePay", "applePay"] : [],
    ...
    tA = i.useCallback((e, t) => ev && null != t && (0, S.qH)(e) ? () => tb(e) : () => eW(P.h8.PAYMENT_TYPE), [ev, tb, eW]);
  switch (eM) {
    ...
    case P.h8.PAYMENT_TYPE:
      let tN = (e, t) => {
          switch (e) {
            case J.He.CARD:
              ei ? eW(P.h8.AWAITING_BROWSER_CHECKOUT) : (eF(eT), eW(P.h8.CREDIT_CARD_INFORMATION));
              break;
            case J.He.PAYPAL:
              eF(eC), eW(P.h8.PAYPAL_INFORMATION);
              break;
            case J.He.VENMO:
              eF(eP), eW(P.h8.VENMO_INFORMATION);
              break;
            case J.He.PAYMENT_REQUEST:
              ei && "googlePay" === t ? eW(P.h8.AWAITING_BROWSER_CHECKOUT_GOOGLE_PAY) : ei && "applePay" === t ? eW(P.h8.AWAITING_BROWSER_CHECKOUT_APPLE_PAY) : (eF(eN), eW(P.h8.PAYMENT_REQUEST_INFORMATION));
              break;
            case J.He.PRZELEWY24:
              eF(eR), eW(P.h8.PRZELEWY24_INFORMATION);
              break;
            case J.He.EPS:
              eF(eD), eW(P.h8.EPS_INFORMATION);
              break;
            case J.He.IDEAL:
              eF(eA), eW(P.h8.IDEAL_INFORMATION);
              break;
            case J.He.CASH_APP:
              eF(ex), eW(P.h8.CASH_APP_INFORMATION);
              break;
            case J.He.GIROPAY:
        ...
        tw = () => {
          eF(ew), eW(P.h8.PAYMENT_TYPE)
        },
        tR = async (e, t) => {
          if ((0, p.Xt)(e), null == e) return void tw();
          eq(e);
          let {
    ...
    case P.h8.PAYMENT_ELEMENT:
      ...
      let tD = async () => {
        e4(true);
        try {
          if (null == tE || !(0, S.qH)(tE)) throw (0, d.PP)("Valid Payment Element source type not found", true);
          let {
            steps: e,
            methodType: t
          } = eL[tE];
    ...
    case P.h8.AWAITING_BROWSER_CHECKOUT_APPLE_PAY:
      let tM = () => {
          eF(eT), eW(ev ? P.h8.PAYMENT_ELEMENT : P.h8.CREDIT_CARD_INFORMATION)
        },
        tk = () => {
          ev ? (ty(), null == b || b()) : (eF(ew), eW(P.h8.PAYMENT_TYPE))
        };
      n = (0, r.jsx)("div", {
        className: ee.body,
    ...
    case P.h8.VENMO_INFORMATION:
      ...
      o = (0, r.jsx)(ey, {
        ...
        onPrimary: () => tB ? eW(P.h8.ADDRESS) : (0, f.og)()
      });
      break;
    ...
    case P.h8.ADDRESS:
        ...
        tz = async () => {
          ...
          switch (e) {
            case J.He.PAYMENT_REQUEST:
              ...
              if (null == ez) throw tw(), (0, d.SQ)("Missing paymentRequestPaymentMethod");
            ...
            case J.He.CASH_APP:
              try {
                ...
                let {
                  paymentSource: t
                } = await (0, d.Dk)(e3.info, e, Y, te, ec);
      ...
      tK && (_ = P.h8.PAYMENT_ELEMENT), n = tK ? null : (0, r.jsx)(eg, {
        billingAddressInfo: e3.info,
        onBillingAddressChange: (e, t) => {
          e2({
            info: er({}, e3.info, e),
  ...
  let tq = ev && tm,
    tQ = tq ? "combined_stripe_elements" : true,
    tX = (0, r.jsxs)(c.qBt, {
...
function ev(e) {
  ...
  let [s, c] = i.useState(() => ({
    ...
    token: null
  })), [S, I, T, C, A] = (0, l.Wu)([k.Z], () => [k.Z.braintreeEmail, k.Z.braintreeNonce, k.Z.error, k.Z.venmoUsername, k.Z.adyenPaymentData]), [N, P] = (0, l.Wu)([U.Z], () => [U.Z.error, U.Z.isAwaitingAuthentication]);
  i.useEffect(() => {
    let e = e => {
      let {
        billingAddress: t
  ...
  let [w, R] = i.useState(false), [D, x] = i.useState(false), [L, j] = i.useState(null), M = i.useRef(null), F = (0, l.e7)([U.Z], () => U.Z.isAwaitingAuthentication), [B, V] = (0, l.Wu)([Z.Z], () => [Z.Z.purchaseTokenAuthState, Z.Z.purchaseTokenHash]);
  return i.useEffect(() => {
    null != L && null != M.current && M.current.scrollIntoView({
      behavior: "smooth"
    })
  }, [L]), {
    paymentSources: n,
