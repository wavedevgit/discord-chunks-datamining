...
function ev(e) {
  ...
  let [R, D] = i.useState(false), [w, x] = i.useState(false), [L, j] = i.useState(null), M = i.useRef(null), B = (0, l.e7)([U.Z], () => U.Z.isAwaitingAuthentication), [F, V] = (0, l.Wu)([Z.Z], () => [Z.Z.purchaseTokenAuthState, Z.Z.purchaseTokenHash]);
  return i.useEffect(() => {
