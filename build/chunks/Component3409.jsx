...
function eO(e) {
  ...
  let td = !(0, F.isDesktop)() || ei ? ["googlePay", "applePay"] : [],
    ...
    tC = i.useCallback((e, t) => ev && null != t && (0, I.qH)(e) ? () => tb(e) : () => eW(R.h8.PAYMENT_TYPE), [ev, tb, eW]);
  switch (ek) {
    ...
    case R.h8.PAYMENT_TYPE:
      let tN = (e, t) => {
          switch (e) {
            case J.He.CARD:
              ei ? eW(R.h8.AWAITING_BROWSER_CHECKOUT) : (eZ(eT), eW(R.h8.CREDIT_CARD_INFORMATION));
              break;
            case J.He.PAYPAL:
    ...
    case R.h8.PAYPAL_INFORMATION:
      let tk = 0 !== e6.length && null != e7;
      n = (0, r.jsx)(e_, {});
      let tj = tC(J.He.PAYPAL, tE);
      o = (0, r.jsx)(ey, {
        onBack: tj,
        primaryCTA: w.Z.CTAType.CONTINUE,
        primaryText: tk ? $.intl.string($.t.PDTjLN) : $.intl.string($.t.Djzd7L),
        onPrimary: () => tk ? eW(R.h8.ADDRESS) : (0, f.i0)()
      });
      break;
    case R.h8.VENMO_INFORMATION:
      let tU = 0 !== e9.length && null != e7;
      n = (0, r.jsx)(ep, {});
      let tG = tC(J.He.VENMO, tE);
      o = (0, r.jsx)(ey, {
        onBack: tG,
        primaryCTA: w.Z.CTAType.CONTINUE,
        primaryText: tU ? $.intl.string($.t.PDTjLN) : $.intl.string($.t["4KoTLM"]),
        onPrimary: () => tU ? eW(R.h8.ADDRESS) : (0, f.og)()
      });
      break;
    ...
    case R.h8.CASH_APP_INFORMATION:
      let tB = null != te,
        tZ = null != eV;
      n = (0, r.jsx)(eh, {});
      let tF = tC(J.He.CASH_APP, tE);
      o = (0, r.jsx)(ey, {
        onBack: tF,
        primaryCTA: w.Z.CTAType.CONTINUE,
        primaryText: tB ? $.intl.string($.t.PDTjLN) : $.intl.string($.t["9ALP8w"]),
        onPrimary: () => tB ? eW(R.h8.ADDRESS) : (0, q.cp)(),
        primaryDisabled: !tZ
      });
      break;
    case R.h8.ADDRESS:
      let tV = ev && null != tE,
        tH = async () => {
          ...
          switch (e) {
            ...
            case J.He.CARD:
              try {
                let e = tV ? await (0, d.Q5)(...t) : await (0, d.f0)(eu, e$.token, e3.info, Y);
                tu(e)
              } catch (e) {}
              break;
            case J.He.VENMO:
            ...
            case J.He.IDEAL:
              try {
                let e = tV ? await (0, d.Q5)(...t) : await (0, d.aN)(eu, e3.info, Y);
                tu(e)
              } catch (e) {
                el.warn(e)
              }
      ...
      tV && (p = R.h8.PAYMENT_ELEMENT), n = tV ? null : (0, r.jsx)(eg, {
        billingAddressInfo: e3.info,
        onBillingAddressChange: (e, t) => {
          e2({
            info: er({}, e3.info, e),
  ...
  let tY = ev && tm,
    tW = tY ? "combined_stripe_elements" : true,
    tK = (0, r.jsxs)(c.qBt, {
    ...
    tz = ek === R.h8.PAYMENT_TYPE && 0 === g.length ? null : o;
...
function ev(e) {
  ...
  let [s, c] = i.useState(() => ({
    ...
    token: null
  })), [I, S, T, A, C] = (0, l.Wu)([j.Z], () => [j.Z.braintreeEmail, j.Z.braintreeNonce, j.Z.error, j.Z.venmoUsername, j.Z.adyenPaymentData]), [N, R] = (0, l.Wu)([U.Z], () => [U.Z.error, U.Z.isAwaitingAuthentication]);
  i.useEffect(() => {
    let e = e => {
      let {
        billingAddress: t
