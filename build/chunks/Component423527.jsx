...
class eu extends(r = Chunk647438.PureComponent) {
    ...
    return (0, Chunk951288.jsxs)("div", {
      children: [(0, Chunk951288.jsxs)(Chunk388905.ZP, {
        ...
        children: [this.renderInviteHeader(), Chunk990547 ? (0, Chunk951288.jsx)("div", {
          ...
          className: Chunk990547 ? true : Chunk67894.authBlock,
  ...
  renderFull(e, t) {
    let {
      ...
      }), l.length > 0 && !D.Z.wasRegistrationSuggestionFetched(l) && await L.Z.fetchSuggestionsRegistration(l)
    }, R = e => {
      this.setState({
        username: e.toLocaleLowerCase(),
        usernameClientError: 0 === e.length ? er.intl.string(er.t.EkokLy) : null
      })
    }, w = null != e ? (0, i.jsx)(s.Fragment, {
      children: e()
