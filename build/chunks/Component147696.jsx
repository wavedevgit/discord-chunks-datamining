    ...
    children: (0, s.jsxs)("ul", {
      ...
      children: [(0, s.jsxs)("li", {
        ...
        children: [(0, s.jsx)("div", {
          className: g.P0,
          children: (0, s.jsx)(x.A, {
            emojiName: null == (n = j.Ay.getByName("books")) ? true : n.surrogates
          })
        }), (0, s.jsx)(o.Text, {
          variant: "text-md/normal",
          color: "text-muted",
...
function f(e) {
  ...
  let {
    ...
    selected: n,
    onChange: i
  } = e, r = null != (t = (0, u.gU)(a)) ? t : o.N$i, c = l.useCallback(() => {
    i(a)
  }, [a, i]);
...
function C(e) {
  let {
    ...
    return (null != (e = a[b.I6]) ? e : []).concat(null != (t = a[b.vM]) ? t : []).filter(e => (0, m.A)(e.channel)).map(e => e.channel)
  }), [j, C] = l.useState(0), k = u.find(e => e.id === x), [p, y] = l.useState(null != k ? [k] : []), T = p.length === u.length, P = l.useCallback(() => {
    C(1)
  }, [C]), A = l.useCallback(e => {
    y(t => t.includes(e) ? [...i().pull(t, e)] : [...t, e])
  }, [y]), _ = l.useCallback(() => {
    T ? y([]) : y(u)
  }, [T, u, y]), E = l.useCallback(() => {
    p.forEach(e => {
      let t = (0, h.es)(e, e.accessPermissions, true);
      (0, d.R$)(e.id, [t]), a()
    })
  }, [p, a]), K = l.useMemo(() => [{
    variant: "secondary",
    ...
    children: [(0, s.jsx)("div", {
      ...
      children: (0, s.jsx)(o.Text, {
        ...
        children: v.intl.format(v.t["OP/pKr"], {
          emphasisHook: e => (0, s.jsx)(o.Text, {
            tag: "span",
            variant: "text-xs/medium",
            color: "interactive-text-active",
            children: e
          }),
          brandHook: e => (0, s.jsx)(o.Text, {
            tag: "span",
            variant: "text-xs/normal",
            color: "text-brand",
            children: e
