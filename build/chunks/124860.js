...
function p(e) {
  ...
  let {
    ...
    onClose: b,
    width: j = 440
  } = e, [y, x] = l.useState(null != (r = null == (t = f.methods[0]) ? void 0 : t.type) ? r : "select"), [S, v] = l.useState(y), O = async e => {
    let {
      mfaType: t,
      data: r
    } = e;
