...
function j(e, t) {
  ...
  let m = p.Z.can(g.Plq.VIEW_CHANNEL, t),
    ...
    y = null != t && m ? n : g.VqG,
    v = k(e, b, n);
  return null != v ? v : null != h ? _ === o.y.MODAL && null != i ? f !== a.P.BLOCKED ? E.NW.format(E.t["4xL9Sk"], {
    applicationName: h,
    ...
    interactionUserHook: i,
    integrationOwnerHook: r
  }) : f !== a.P.BLOCKED ? E.NW.format(E.t.AXQufH, {
    applicationName: h,
    channelName: b,
    channelHook: y,
    integrationOwnerHook: r
    ...
    channelHook: y,
    integrationOwnerHook: r
  }) : f !== a.P.BLOCKED ? E.NW.format(E.t.IZg0VV, {
    channelName: b,
    channelHook: y
