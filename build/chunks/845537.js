...
function M(e) {
  let {
    id: t,
    guildId: n
  } = e, a = (0, i.e7)([g.Z], () => null != n ? g.Z.getRole(n, t) : void 0), s = (0, i.e7)([l.Z], () => l.Z.roleStyle), c = (0, p._f)(n, a, null == a ? void 0 : a.colorStrings);
...
function k(e) {
  let {
    id: t
  } = e, n = (0, i.e7)([h.Z], () => h.Z.getChannel(t)), o = T.intl.string(T.t.zLZPmp).toLowerCase(), a = "text", s = !0;
  if (null != n) {
    var l;
