...
function D(e) {
  ...
  if (null != l) {
    ...
    return (0, r.jsx)(a.ua7, {
      ...
      delay: 750,
      position: "top",
      "aria-label": O.ZP.getUserTag(l, {
        decoration: "never"
      }),
      children: e => (0, r.jsx)(a.P3F, C(A({
        tag: "span"
      }, e), {
        children: d
      }))
...
function L(e) {
  let {
    id: t,
    guildId: n
  } = e, o = (0, i.e7)([m.Z], () => null != n ? m.Z.getRole(n, t) : void 0), s = (0, i.e7)([l.Z], () => l.Z.roleStyle), c = (0, p.X)(n, null == o ? void 0 : o.colorStrings, "RoleMention");
...
function x(e) {
  let {
    id: t
  } = e, n = (0, i.e7)([h.Z], () => h.Z.getChannel(t)), a = v.intl.string(v.t.zLZPmp).toLowerCase(), o = "text", s = !0;
  if (null != n) {
    var l;
