...
function _(e) {
  let {
    channelId: t
  } = e, _ = (0, i.bG)([f.A], () => f.A.getChannel(t)), j = (0, i.bG)([f.A], () => f.A.getChannel(null == _ ? true : _.parent_id)), x = (0, i.bG)([b.A], () => b.A.getGuild(null == _ ? true : _.getGuildId())), v = (0, o.Ay)(_), E = l.useRef(false);
  if (l.useEffect(() => {
