...
function j(e) {
  let {
    channelId: t
  } = e, j = (0, i.bG)([f.A], () => f.A.getChannel(t)), _ = (0, i.bG)([f.A], () => f.A.getChannel(null == j ? true : j.parent_id)), x = (0, i.bG)([b.A], () => b.A.getGuild(null == j ? true : j.getGuildId())), v = (0, o.Ay)(j), E = l.useRef(false);
  if (l.useEffect(() => {
