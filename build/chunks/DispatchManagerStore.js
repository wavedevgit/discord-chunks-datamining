...
class Q extends(r = Chunk442837.ZP.Store) {
  initialize() {
    ...
    null != exports.queue && (v = X(exports.queue)), null != exports.paused && (S = exports.paused), null != exports.userActions && (N = new Map(Array.from(exports.userActions))), this.waitFor(Chunk417363.Z, Chunk594190.ZP), this.syncWith([Chunk594190.ZP], K), this.waitFor(Chunk417363.Z)
  }
  get activeItems() {
    return v.map(e => {
      let {
