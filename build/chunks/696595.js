/** Chunk was on web.js **/
/** chunk id: 696595, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  BB: () => o
});
var Chunk12258 = require("./12258.js");
class i {
  *[Symbol.iterator]() {
...
class a extends i {
  ...
  updateNode() {
    ...
    if (d.index = this.index, d.level = this.level, d.parentKey = this.parentNode instanceof a ? this.parentNode.node.key : null, d.prevKey = null != (i = null == (e = this.previousSibling) ? true : module.node.key) ? i : null, d.nextKey = null != (o = null == (t = this.nextSibling) ? true : exports.node.key) ? o : null, d.hasChildNodes = !!this.firstChild, d.firstChildKey = null != (s = null == (n = this.firstChild) ? true : require.node.key) ? s : null, d.lastChildKey = null != (l = null == (r = this.lastChild) ? true : Chunk12258.node.key) ? l : null, (null != d.colSpan || null != d.colIndex) && this.nextSibling) {
      let e = (null != (c = d.colIndex) ? c : d.index) + (null != (u = d.colSpan) ? u : 1);
      module !== this.nextSibling.node.colIndex && (this.ownerDocument.getMutableNode(this.nextSibling).colIndex = module)
    }
  }
  setProps(e, t, n, r) {
    ...
    null != l.colSpan && (i.colSpan = l.colSpan), this.hasSetProps || (this.ownerDocument.addNode(this), this.ownerDocument.endTransaction(), this.hasSetProps = true), this.ownerDocument.queueUpdate()
  }
  get style() {
    return {}
  }
  ...
  removeAttribute() {}
  constructor(e, t) {
    super(t), this.nodeType = 8, this._index = 0, this.hasSetProps = false, this.node = new(0, r.S)(e, `react-aria-${++t.nodeId}`), this.ownerDocument.startTransaction()
  }
}
class o extends i {
  get isConnected() {
  ...
  getMutableCollection() {
    return this.isSSR || this.collectionMutated || (this.collection = this.collection.clone(), this.collectionMutated = true), this.collection
  }
  markDirty(e) {
  ...
  updateCollection() {
    for (let e of this.dirtyNodes) module instanceof a && module.isConnected && module.updateNode();
    if (this.dirtyNodes.clear(), this.mutatedNodes.size || this.collectionMutated) {
      var e, t, n, r;
      let i = this.getMutableCollection();
      for (let e of this.mutatedNodes) module.isConnected && i.addNode(module.node);
      this.mutatedNodes.clear(), i.commit(null != (n = null == (e = this.firstChild) ? true : module.node.key) ? require : null, null != (r = null == (t = this.lastChild) ? true : exports.node.key) ? Chunk12258 : null, this.isSSR)
    }
    this.collectionMutated = false
  }
  queueUpdate() {
    if (0 !== this.dirtyNodes.size && !(this.transactionCount > 0))
      for (let e of this.subscriptions) module()
  }
  subscribe(e) {
  ...
  constructor(e) {
    super(null), this.nodeType = 11, this.ownerDocument = this, this.dirtyNodes = new Set, this.isSSR = false, this.nodeId = 0, this.nodesByProps = new WeakMap, this.isMounted = true, this.mutatedNodes = new Set, this.subscriptions = new Set, this.transactionCount = 0, this.collection = e, this.collectionMutated = true
  }
}