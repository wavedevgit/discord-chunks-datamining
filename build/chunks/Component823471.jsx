...
function P(e) {
  let {
    ...
    closePopout: n,
    onSelect: l
  } = e, y = (0, c.A)(t, "Sidebar Overflow"), O = (0, d.A)(t), x = (0, f.A)(t), v = (0, m.A)(t), E = (0, s.A)(t), I = (0, u.A)(t), N = (0, g.A)(t.id), T = (0, h.A)(t), P = (0, o.A)(t), w = (0, a.A)(t), R = (0, A.A)({
    id: t.id,
  ...
  return (0, r.jsxs)(i.W1t, {
    ...
    children: [(0, r.jsxs)(i.rXV, {
      ...
      children: [(0, r.jsx)(i.Drp, {
        ...
        action: function() {
          M(), setTimeout(() => {
            _._.dispatch(C.jej.FOCUS_SEARCH, {
        ...
        action: function() {
          M(), _._.dispatch(C.jej.TOGGLE_CHANNEL_PINS)
        }
      })]
    }), (0, r.jsxs)(i.rXV, {
      children: [D, E, I, P]
