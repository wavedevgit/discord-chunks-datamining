...
function x(e) {
  ...
  let {
  ...
  } = (0, c.j)(), K = e => <d.yRy targetElementRef={x} animation={d.yRy.Animation.FADE} shouldShow={R} position={"top"} onRequestClose={() => D(false)} renderPopout={e => {
      let {
        closePopout: n
      } = e;
      return (0, r.jsx)(I.Z, {
    ...
    })}</d.yRy>, q = i.useCallback(() => {
    L || D(!R)
  }, [L, R]);
  return (0, E.yp)({
    event: C.CkL.TOGGLE_SOUNDBOARD,
    handler: q
  }), <h.Gt value={V}><d.ua7 targetElementRef={x} text={A ? N.intl.string(N.t["Ox4/zc"]) : Z ? N.intl.string(N.t["+YBKYG"]) : w ? N.intl.string(N.t.X1lQlp) : N.intl.string(N.t["6EJvHh"])}>{e => K(e)}</d.ua7></h.Gt>
}