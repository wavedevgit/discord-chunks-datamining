...
function g() {
  var e, t;
  let [n, g] = Chunk647438.useState(false), j = (0, Chunk442837.e7)([Chunk594174.default], () => Chunk594174.default.getCurrentUser()), v = (0, Chunk848572.kG)(), _ = (0, Chunk442837.e7)([Chunk78839.Z], () => Chunk78839.Z.getPremiumTypeSubscription()), y = null != v && null != (t = null == (e = Chunk474936.vK[v]) ? true : module.tenureReqNumMonths) ? exports : 0, C = Chunk647438.useCallback(async e => {
    let t = new Date;
    e > 0 ? t.setMonth(t.getMonth() - e) : t.setDate(t.getDate() - 7), t.setDate(t.getDate() - 2);
    let n = {
      subscription_status: x.O0b.ACTIVE,
      endedAt: true,
      premium_streak_started_at: h.default.fromTimestamp(t.getTime())
    };
    g(true), await l.tn.patch({
      url: "/debug/subscriptions/".concat(_.id),
      body: n,
      rejectWithError: false
    }), await (0, c.In)(j.id), await (0, o.jg)(), g(false)
  }, [_, j]);
