...
let v = function(e) {
  ...
  return C || !L ? null : <E.Z className={t} style={n} title={j} description={P ? O.intl.string(O.t.lpgkzs) : O.intl.string(O.t.usQh4O)} icons={b.J6} onDrop={x} onDragClear={M} onDragOver={k} />
}