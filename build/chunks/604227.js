...
function g() {
  ...
  let p = window.GLOBAL_ENV.RELEASE_CHANNEL,
    h = "402653",
    f = "c7a98d4ccbbe0b2365ae3e9b4effb9711091b59e".substring(0, 7),
    ...
    O = [p, h, "(".concat(f, ")")];
  return null != b && (O.push("Host ".concat(b)), null != x && O.push(x.toLowerCase()), null != _ && O.push("(".concat(_, ")"))), O.push("Build Override: ".concat(null != E ? E.id : "N/A")), null != C && O.push(C), (0, i.jsx)(c.Z, {
    copyValue: O.join(" "),
