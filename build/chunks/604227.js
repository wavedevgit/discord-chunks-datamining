...
function h() {
  ...
  let h = window.GLOBAL_ENV.RELEASE_CHANNEL,
    f = "425519",
    b = "52f1561fdbf9099c45ec25f23dee3b1ed34e5c72".substring(0, 7),
    ...
    C = [h, f, "(".concat(b, ")")];
  return null != x && (C.push("Host ".concat(x)), null != j && C.push(j.toLowerCase()), null != _ && C.push("(".concat(_, ")"))), C.push("Build Override: ".concat(null != O ? O.id : "N/A")), null != E && C.push(E), (0, i.jsx)(u.Z, {
    copyValue: C.join(" "),
