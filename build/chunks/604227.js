...
function g() {
  ...
  let p = window.GLOBAL_ENV.RELEASE_CHANNEL,
    h = "413038",
    f = "12bcb77ae6847776d206b8b1474572b3d5084b9c".substring(0, 7),
    ...
    O = [p, h, "(".concat(f, ")")];
  return null != b && (O.push("Host ".concat(b)), null != x && O.push(x.toLowerCase()), null != _ && O.push("(".concat(_, ")"))), O.push("Build Override: ".concat(null != E ? E.id : "N/A")), null != j && O.push(j), (0, i.jsx)(c.Z, {
    copyValue: O.join(" "),
