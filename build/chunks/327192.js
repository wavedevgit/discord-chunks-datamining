...
let z = e => {
  ...
  return null != (0, a.e7)([N.Z], () => N.Z.getGuild(s.guild.id), [s.guild.id]) || (r = (0, i.jsx)(m.zxk, {
    size: m.PhG.SMALL,
    onClick: function() {
      p.Z.joinServer(s.id, () => {})
    },
    ...
    children: (0, i.jsx)("span", {
      children: l ? V.intl.string(V.t.RXvQQk) : V.intl.string(V.t.XpeFYm)
    })
  })), (0, i.jsxs)("div", {
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [function(e) {
      ...
      let n = x.Z.get(e.type),
        ...
        l = null;
      return n.type === B.ABu.TWITTER && s && (l = (0, i.jsx)(m.ua7, {
      ...
      if (null == r || 0 === r.length)
        ...
        }, "label")], a = V.intl.string(V.t["LVh3//"]);
      return l && (a = V.intl.string(V.t.i4jeWV)), r.push((0, i.jsx)(m.zxk, {
    ...
    })), (null == (t = x.Z.get(o.type)) ? void 0 : t.hasMetadata) === !0 && (l = (0, i.jsx)(m.j7V, {
      className: G.connectionOptionSwitch,
      hideBorder: !0,
      value: 1 === v,
      onChange: function(e) {
...
function W() {
  return r.useEffect(() => () => {
    (0, S.EW)(o.z.NEW_CRUNCHYROLL_CONNECTION, {
    ...
    children: [(0, i.jsx)(m.X6q, {
      ...
      variant: "text-xs/normal",
      color: "header-secondary",
      children: V.intl.format(V.t["oYc+Gx"], {
...
function X(e) {
  ...
  return t = r ? (0, i.jsx)(m.$jN, {
    className: F.marginTop20,
    type: m.$jN.Type.SPINNING_CIRCLE
  }) : 0 === s.length ? (0, i.jsxs)(m.ubH, {
    className: F.marginTop40,
    theme: l,
    children: [!o && (0, i.jsx)(m.oxh, {
      darkSrc: n(703152),
      lightSrc: n(548617),
      width: 230,
      height: 220
  ...
  }) : s.filter(e => x.Z.isSupported(e.type)).map((e, t) => (0, i.jsx)(Y, {
    theme: l,
    account: e,
    locale: a,
