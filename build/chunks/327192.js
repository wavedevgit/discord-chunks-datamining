...
function H(e) {
  ...
  let n, s, a, {
    ...
    [h, N] = i.useState(l.friendSync),
    [O, C] = i.useState(l.visibility),
    [v, T] = i.useState(l.metadataVisibility),
    ...
    X = b.Z.get(q);
  i.useEffect(() => {
    N(l.friendSync), C(l.visibility), T(l.metadataVisibility), y(l.showActivity)
  }, [l]);
  let J = {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [function(e) {
      ...
      value: h,
      onChange: function(e) {
        N(e), g.Z.setFriendSync(l.type, l.id, e)
      },
      children: (0, r.jsx)(u.Text, {
    ...
    })), (null === (t = b.Z.get(l.type)) || void 0 === t ? void 0 : t.hasMetadata) === !0 && (a = (0, r.jsx)(u.j7V, {
      className: U.connectionOptionSwitch,
      hideBorder: !0,
      value: 1 === v,
      onChange: function(e) {
...
let X = () => {
  let e = (0, o.e7)([y.Z], () => y.Z.hidePersonalInformation),
    t = (0, o.e7)([v.Z], () => v.Z.isFetching()),
    n = (0, o.e7)([v.Z], () => v.Z.getAccounts()),
    s = (0, N.ZP)();
