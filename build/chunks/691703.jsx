...
function g(e) {
  ...
  return null != t.guild && t.guild.features.includes(p.oNc.DISCOVERABLE) ? <div className={n}>{<l.X6q variant={"heading-sm/semibold"} color={"header-primary"}>{m.intl.string(m.t.KJEO29)}</l.X6q>}{<u.Z guild={t.guild} onClick={g} />}</div> : null
}