...
function _(e) {
  let {
    ...
    isGradient: j = !1
  } = e, v = a.useCallback(e => 0 !== e && e !== t && !n.some(t => t === e), [n, t]), C = a.useRef(null), y = a.useRef(null), k = a.useRef(null), [O, P] = a.useState(() => v(o) ? o : null), [w, S] = a.useState({
    start: o,
    end: null != h ? h : c.p6O
  }), [I, E] = a.useState({
    showStart: !1,
