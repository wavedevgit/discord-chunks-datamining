...
let g = e => {
    ...
    let u = (0, i.Bd)(null != n ? n : c.p6O) > .1;
    return (0, r.jsx)("div", m(f({}, a), {
      className: s()("left" === t ? p.colorPickerDropperLeft : p.colorPickerDropperRight, u ? p.lightRing : p.darkRing, {
        [p.disabled]: o
      }),
...
function _(e) {
  let {
    ...
    isGradient: x = !1
  } = e, v = o.useCallback(e => 0 !== e && e !== t && !n.some(t => t === e), [n, t]), y = o.useRef(null), C = o.useRef(null), k = o.useRef(null), [O, P] = o.useState(() => v(a) ? a : null), [S, I] = o.useState({
    start: a,
    end: null != h ? h : c.p6O
  }), [E, w] = o.useState({
    showStart: !1,
  ...
  let N = o.useCallback(e => {
    ...
    T = o.useCallback(() => {
      var e, t, n, o, a;
      let s = {
          background: "linear-gradient(90deg, ".concat((0, i.Rf)(null != (e = S.start) ? e : c.p6O), " 0%, ").concat((0, i.Rf)(S.end), " 100%)")
        },
        l = (0, r.jsxs)("div", {
    ...
    A = o.useCallback(() => (0, r.jsx)(l.Z$W, {
      onChange: R,
      value: O
    }), [R, O]),
    B = o.useCallback(e => {
      let t = (0, r.jsx)(l.jHW, m(f({}, e), {
        "aria-label": u.intl.string(u.t["FHBa//"])
      }));
      return d ? t : (0, r.jsx)(l.yRy, {
        targetElementRef: y,
        renderPopout: A,
        position: _,
