...
let f = e => {
    ...
    return (0, o.jsx)("div", h(b({}, l), {
      className: i()("left" === t ? p.colorPickerDropperLeft : p.colorPickerDropperRight, {
        [p.disabled]: n
      }),
...
function j(e) {
  let {
    ...
    isGradient: P = !1
  } = e, x = n.useCallback(e => 0 !== e && e !== t && !r.some(t => t === e), [r, t]), C = n.useRef(null), O = n.useRef(null), y = n.useRef(null), [k, w] = n.useState(() => x(l) ? l : null), [m, v] = n.useState({
    start: x(l) ? l : void 0,
    end: c.p6O
  }), [S, R] = n.useState({
    showStart: !1,
  ...
  let _ = n.useCallback(e => {
    ...
    B = n.useCallback(() => {
      var e, t, r, n, l;
      let i = {
          background: "linear-gradient(90deg, ".concat((0, s.Rf)(null != (e = m.start) ? e : 0), " 0%, ").concat((0, s.Rf)(m.end), " 100%)")
        },
        a = (0, o.jsxs)("div", {
    ...
    G = n.useCallback(() => (0, o.jsx)(a.Z$W, {
      onChange: D,
      value: k
    }), [D, k]),
    W = n.useCallback(e => {
      let t = (0, o.jsx)(a.jHW, h(b({}, e), {
        "aria-label": u.NW.string(u.t["FHBa//"])
      }));
      return d ? t : (0, o.jsx)(a.yRy, {
        targetElementRef: C,
        renderPopout: G,
        position: j,
        children: e => (0, o.jsx)(a.ua7, {
          targetElementRef: C,
          text: u.NW.string(u.t["FHBa//"]),
          position: "bottom",
          children: r => (0, o.jsx)("div", h(b({
            ref: C
          }, r, e), {
            children: t
          }))
    ...
    Z = n.useCallback(e => {
      ...
      return d ? t : (0, o.jsx)(a.ua7, {
        text: u.NW.string(u.t.bBvAEB),
        position: "bottom",
        children: e => (0, o.jsx)("div", h(b({}, e), {
          children: t
        }))
      })
    }, [d]);
  return (0, o.jsx)(a.zH8, h(b({}, e), {
