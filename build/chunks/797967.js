...
function m(e) {
  let {
    ...
    isGradient: O = !1
  } = e, y = o.useCallback(e => 0 !== e && e !== t && !r.some(t => t === e), [r, t]), h = o.useRef(null), x = o.useRef(null), C = o.useRef(null), [P, w] = o.useState(() => y(a) ? a : null), [k, S] = o.useState({
    start: a,
    end: null != j ? j : c.p6O
  }), [I, E] = o.useState({
    showStart: !1,
