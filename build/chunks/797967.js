...
let f = e => {
    ...
    return (0, o.jsx)("div", {
      className: s()("left" === t ? p.colorPickerDropperLeft : p.colorPickerDropperRight, {
        [p.disabled]: n
      }),
      ...
      children: (0, o.jsx)(a.yRy, {
        ...
        children: e => (0, o.jsx)(a.ua7, {
          ...
          children: l => (0, o.jsx)("div", {
            ref: r,
            children: (0, o.jsx)(a.P3F, h(b({}, l, e), {
...
function j(e) {
  let {
    ...
    isGradient: C = !1
  } = e, P = n.useCallback(e => 0 !== e && e !== t && !r.some(t => t === e), [r, t]), x = n.useRef(null), k = n.useRef(null), w = n.useRef(null), [m, y] = n.useState(() => P(l) ? l : null), [O, S] = n.useState({
    start: P(l) ? l : void 0,
    end: c.p6O
  }), [v, R] = n.useState({
    showStart: !1,
  ...
  let _ = n.useCallback(e => {
    ...
    B = n.useCallback(() => {
      var e, t, r, n, l;
      let s = {
          background: "linear-gradient(90deg, ".concat((0, i.Rf)(null != (e = O.start) ? e : 0), " 0%, ").concat((0, i.Rf)(O.end), " 100%)")
        },
        a = (0, o.jsxs)("div", {
