...
let f = function(e) {
  let {
    ...
    withGameTile: f = !0,
    onLoadComplete: b
  } = e, C = (0, c.wj)(h) ? g.BRd.DARK : g.BRd.LIGHT, v = (0, d.Gd)(s.id, C), y = j && null != s.config.cosponsorMetadata && null != v;
  return (0, i.jsxs)("div", {
    className: a()(p.partnerBranding, t),
    children: [f && (0, i.jsx)(x.Fl, {
      ...
      children: e => (0, i.jsx)("img", {
        ...
        className: a()(p.partnerBrandingLogotype, n, {
          [p.partnerBrandingLogotypeWithCosponsor]: y
        }),
