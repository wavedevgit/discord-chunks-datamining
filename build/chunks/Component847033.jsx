...
function N(e) {
  ...
  let {
    ...
    initialTab: a,
    guildId: o
  } = e, S = (0, s.e7)([m.Z], () => m.Z.getGuild(o)), C = (0, s.e7)([_.Z], () => _.Z.isViewingServerShop(o)), N = (0, b.g)(S, "guild_shop_page"), R = (0, E.RF)(o, "guild_shop_page"), P = (null == S ? true : S.features.has(I.oNc.PRODUCTS_AVAILABLE_FOR_PURCHASE)) === true, w = (0, f.mY)(null == S ? true : S.id), D = w && R, x = null == (t = (0, d.YB)(o)) ? true : t.server_shop_tab_order, L = [], j = y.y.GUILD_SHOP_FULL_PREVIEW;
