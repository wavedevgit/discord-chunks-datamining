...
function N(e) {
  ...
  let {
    ...
    initialTab: o,
    guildId: a
  } = e, I = (0, s.e7)([h.Z], () => h.Z.getGuild(a)), A = (0, s.e7)([p.Z], () => p.Z.isViewingServerShop(a)), N = (0, b.g)(I, "guild_shop_page"), P = (0, E.RF)(a, "guild_shop_page"), R = (null == I ? true : I.features.has(S.GuildFeatures.PRODUCTS_AVAILABLE_FOR_PURCHASE)) === true, w = (0, f.mY)(null == I ? true : I.id), D = w && P, x = null == (t = (0, d.YB)(a)) ? true : t.server_shop_tab_order, L = [], j = y.y.GUILD_SHOP_FULL_PREVIEW;
  A || R && w ? (L.push(x === O.a3.PRODUCTS_FIRST ? y.y.GUILD_PRODUCTS : y.y.GUILD_ROLE_SUBSCRIPTIONS), L.push(x === O.a3.PRODUCTS_FIRST ? y.y.GUILD_ROLE_SUBSCRIPTIONS : y.y.GUILD_PRODUCTS), j = L[0]) : R && !w ? (L.push(y.y.GUILD_PRODUCTS), j = y.y.GUILD_PRODUCTS) : !R && w && (L.push(y.y.GUILD_ROLE_SUBSCRIPTIONS), j = y.y.GUILD_ROLE_SUBSCRIPTIONS, N && L.push(y.y.GUILD_PRODUCTS_PREVIEW)), o = null != o ? o : j;
  let [M, k] = i.useState(o), U = N && !D || M === y.y.GUILD_PRODUCTS_PREVIEW;
  i.useEffect(() => {
    k(o)
  }, [o]);
  let G = e => {
    ...
    if (M === y.y.GUILD_PRODUCTS_PREVIEW) e.stopPropagation(), k(y.y.GUILD_ROLE_SUBSCRIPTIONS), t.action_taken = v.mz.DISMISS_TAB_PREVIEW;
      ...
      var n;
      (0, _.dL)(S.Z5c.CHANNEL(a, null == (n = m.ZP.getDefaultChannel(a)) ? true : n.id)), t.action_taken = v.mz.DISMISS_FULL_PREVIEW
    }
