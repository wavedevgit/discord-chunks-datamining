...
let ea = [z.fO.ACTIVITY],
  eo = i.memo(e => {
    ...
    } = e, eT = i.useContext(N.h9) || ev, [eS, eA] = i.useState(!1), eN = A.Sb.useSetting(), eC = (0, s.e7)([P.default], () => P.default.isStreamInfoOverlayEnabled), [ew, eR] = i.useState(!1), eP = (0, s.e7)([R.default], () => R.default.getId()), eD = g.type === z.fO.ACTIVITY ? null : g.user, eL = null != (a = null == eD ? void 0 : eD.id) ? a : null, [ex] = (0, p.Z)(g.type === z.fO.ACTIVITY ? [g.applicationId] : []), ek = (0, s.e7)([b.Z], () => b.Z.getEnabled()), ej = (0, s.e7)([L.Z], () => null != eL && L.Z.isLocalVideoDisabled(eL, (0, h.Z)(g.type)), [eL, g.type]), eM = (0, s.e7)([L.Z], () => null != eL ? L.Z.getVideoToggleState(eL, (0, h.Z)(g.type)) : K.ZUi.NONE, [eL, g.type]), eU = eM === K.ZUi.AUTO_PROBING, {
      speaking: eG,
      ringing: eB,
      hasVideo: eZ
    } = (0, W.Z)(g, eP), eF = (0, s.e7)([S.Z], () => null !== eL && S.Z.isUserPlayingSounds(eL), [eL]), eV = e_(eP, g, eo.getGuildId()), eH = g.type === z.fO.STREAM && eL === eP, eY = (0, s.e7)([C.Z], () => g.type === z.fO.USER && null != eL ? C.Z.getEffectForUserId(eL) : null), eW = (0, s.e7)([k.Z], () => k.Z.getVoicePlatformForChannel(eo.id, null != eL ? eL : K.lds)), {
      showGameIcon: eK
    } = E.ZP.useExperiment({
      location: "voice_users"
    }, {
      autoTrackExposure: !1
    }), ez = (0, s.e7)([x.Z], () => eK && null != eL ? x.Z.findActivity(eL, e => null != e.application_id && e.type === K.IIU.PLAYING) : null, [eK, eL]), eq = (0, s.e7)([D.Z], () => (null == ez ? void 0 : ez.application_id) != null ? D.Z.getDetectableGame(ez.application_id) : null), e$ = (0, s.e7)([_.Z], () => null != eq && (null == ez ? void 0 : ez.application_id) != null ? _.Z.getApplication(null == ez ? void 0 : ez.application_id) : void 0), eX = (0, T.wV)({
      userId: eL,
      channelId: eo.id
    }), eQ = (0, T.zU)({
    ...
    switch (g.type) {
      case z.fO.STREAM:
        e6 = (0, r.jsx)(V.Z, {
          ...
          idle: eT,
          premiumIndicator: !1
        }), e7 = X.intl.formatToPlainString(X.t.gHPz3d, {
      ...
      case z.fO.USER:
        e6 = (0, r.jsx)(H.Z, {
          ...
          participant: g,
          channelId: eo.id
        }), e7 = X.intl.formatToPlainString(X.t["iC/x/f"], {
      ...
      case z.fO.ACTIVITY:
        e6 = (0, r.jsx)(Z.ZP, {
          ...
          channel: eo,
          width: es
        }), e7 = X.intl.formatToPlainString(X.t.YCvOsL, {
          activityName: null == ex ? void 0 : ex.name
        });
        break;
        ...
        children: (0, r.jsxs)(I.Z, {
          ...
          children: [(0, r.jsx)(F.Z, {
            ...
            children: (0, r.jsxs)(u.kL8, {
              ...
              children: [null != eY && null != eL ? (0, r.jsx)(w.Z, {
                voiceChannelEffect: eY,
                onComplete: () => (0, C.H)(eL),
                userId: eL
              }) : null, g.type === z.fO.USER ? (0, r.jsx)("div", {
              ...
              }) : null, ea.includes(g.type) ? null : (0, r.jsx)(eu, en(ee({
                focused: em,
                width: es,
                inCall: ed,
                ...
                isHovered: ew
              })), g.type === z.fO.USER && ek ? (0, r.jsx)(y.Z, {
                userId: g.id,
                channelId: eo.id
...
function es(e) {
  ...
  if (t === z.fO.STREAM) return n === z.wR.XBOX ? (0, r.jsx)(U.Z, {
    className: i
  }) : (0, r.jsx)(u.pzj, {
    size: "md",
    color: "currentColor",
...
let eu = i.memo(e => {
  let {
    ...
    hideAudioIcon: C,
    onToggleMute: w
  } = e, R = (0, s.e7)([L.Z], () => null != m && L.Z.isLocalVideoAutoDisabled(m, (0, h.Z)(p)), [m, p]), P = (0, g.j)({
    displayNameStyles: E
  }), D = () => R || d === K.ZUi.AUTO_PROBING ? t ? (0, r.jsx)("div", {
    className: Q.status,
  ...
  }) : null, x = (0, Y.N)(a), k = (0, Y.K)(a), [M, U] = i.useState(!1);
  i.useEffect(() => {
    let e = !1,
      t = () => {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)("div", {
      ...
      children: [(0, r.jsxs)(u.Text, {
        ...
        children: [null != Z && p === z.fO.USER && (0, r.jsx)(Z, {
          ...
          children: e => (0, r.jsx)(u.tQf, en(ee({}, e), {
