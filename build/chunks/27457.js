...
let eo = [z.fO.ACTIVITY],
  ea = i.memo(e => {
    ...
    let {
    ...
    } = e, eT = i.useContext(N.h9) || ev, [eS, eA] = i.useState(!1), eN = A.Sb.useSetting(), eC = (0, s.e7)([w.default], () => w.default.isStreamInfoOverlayEnabled), [eR, eP] = i.useState(!1), ew = (0, s.e7)([P.default], () => P.default.getId()), eD = g.type === z.fO.ACTIVITY ? null : g.user, eL = null != (o = null == eD ? void 0 : eD.id) ? o : null, [ex] = (0, p.Z)(g.type === z.fO.ACTIVITY ? [g.applicationId] : []), eM = (0, s.e7)([b.Z], () => b.Z.getEnabled()), ek = (0, s.e7)([L.Z], () => null != eL && L.Z.isLocalVideoDisabled(eL, (0, h.Z)(g.type)), [eL, g.type]), ej = (0, s.e7)([L.Z], () => null != eL ? L.Z.getVideoToggleState(eL, (0, h.Z)(g.type)) : K.ZUi.NONE, [eL, g.type]), eU = ej === K.ZUi.AUTO_PROBING, {
      speaking: eG,
      ringing: eB,
      hasVideo: eZ
      ...
      autoTrackExposure: !1
    }), ez = (0, s.e7)([x.Z], () => eK && null != eL ? x.Z.findActivity(eL, e => null != e.application_id && e.type === K.IIU.PLAYING) : null, [eK, eL]), eq = (0, s.e7)([D.Z], () => (null == ez ? void 0 : ez.application_id) != null ? D.Z.getDetectableGame(ez.application_id) : null), eX = (0, s.e7)([_.Z], () => null != eq && (null == ez ? void 0 : ez.application_id) != null ? _.Z.getApplication(null == ez ? void 0 : ez.application_id) : void 0), eQ = (0, T.wV)({
      userId: eL,
      channelId: ea.id
    }), eJ = (0, T.zU)({
    ...
    switch (g.type) {
      case z.fO.STREAM:
        e6 = (0, r.jsx)(V.Z, {
          ...
          idle: eT,
          premiumIndicator: !1
        }), e7 = Q.intl.formatToPlainString(Q.t.gHPz3d, {
      ...
      case z.fO.USER:
        e6 = (0, r.jsx)(H.Z, {
          ...
          participant: g,
          channelId: ea.id
        }), e7 = Q.intl.formatToPlainString(Q.t["iC/x/f"], {
      ...
      case z.fO.ACTIVITY:
        e6 = (0, r.jsx)(Z.ZP, {
          ...
          channel: ea,
          width: es
        }), e7 = Q.intl.formatToPlainString(Q.t.YCvOsL, {
        ...
        children: (0, r.jsxs)(I.Z, {
          ...
          children: [(0, r.jsx)(F.Z, {
            ...
            children: (0, r.jsxs)(u.kL8, {
              ...
              children: [null != eY && null != eL ? (0, r.jsx)(R.Z, {
              ...
              }) : null, eo.includes(g.type) ? null : (0, r.jsx)(eu, en(ee({
                focused: em,
                width: es,
                inCall: ed,
                ...
                isHovered: eR
              })), g.type === z.fO.USER && eM ? (0, r.jsx)(y.Z, {
                userId: g.id,
                channelId: ea.id
...
let eu = i.memo(e => {
  let {
    ...
    displayNameStyles: E
  }), D = () => P || d === K.ZUi.AUTO_PROBING ? t ? (0, r.jsx)("div", {
    className: J.status,
  ...
  }) : null, x = (0, Y.N)(o), M = (0, Y.K)(o), [j, U] = i.useState(!1);
  i.useEffect(() => {
    let e = !1,
      t = () => {
  ...
  return (0, r.jsxs)("div", {
    className: a()(J.overlayContainer, {
      [J.compact]: M
    }),
    children: [(0, r.jsx)("div", {
      className: a()(J.overlayTop, {
        [J.small]: o < 195
      }),
      children: D()
    }), !x && (0, r.jsxs)("div", {
      className: a()(J.overlayBottom, {
        [J.small]: o < 195
      }),
      children: [(0, r.jsxs)(u.Text, {
        className: a()(J.experimentOverlayTitle, {
          [J.compact]: M
        }),
        color: "none",
        variant: M ? "text-sm/normal" : "text-md/normal",
        children: [null != Z && p === z.fO.USER && (0, r.jsx)(Z, {
          className: a()(J.experimentTitleIcon, {
            [J.compact]: M
          }),
          size: "xs",
          color: "currentColor"
...
function e_(e, t, n) {
  ...
  return {
    ...
    deafened: null != (a = t.type === z.fO.USER && (null == (i = t.voiceState) ? void 0 : i.isVoiceDeafened())) && a
  }
}