...
function A(e) {
  ...
  let {
    ...
    width: N,
    windowKey: _
  } = e, [P, A] = (0, s.useState)(0), T = (0, s.useRef)("right"), [L, B] = (0, s.useState)(null), [D, F] = (0, s.useState)(null), U = (0, s.useRef)(null), W = (0, o.uR)(L, D), G = l.Mq[x.yN.LAWNMOWER], [K, V] = (0, s.useState)({}), H = (0, i.e7)([c.Z], () => c.Z.getWindow(_)), [q, z] = (0, d.Z)(x.yN.LAWNMOWER), Y = null != (t = q.count) ? t : 0;
  (0, b.is)(Z, j);
  let X = (0, b.eR)(w);
  (0, f.Z)(R, Y);
