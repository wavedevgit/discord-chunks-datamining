...
let x = e => {
  let {
    ...
    interests: j
  } = s, [N, _] = i.useState(""), [v, y] = i.useState(0), O = (0, c.e7)([d.default], () => d.default.getId()), C = i.useMemo(() => (0, l.chunk)((0, u.XV)(p.i6, O), 9), [O]), I = [...C[v], ...C[(v + 1) % C.length]], E = i.useMemo(() => Array.from(j), [j]), S = i.useMemo(() => E.filter(e => !p.WZ.has(e) && !p.gh.has(e)), [E]), T = e => {
    let t = new Set(j);
    t.delete(e), n({
      interests: t
    })
