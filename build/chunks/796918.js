...
let x = e => {
  let {
    ...
    interests: j
  } = s, [N, _] = i.useState(""), [v, y] = i.useState(0), C = (0, c.e7)([d.default], () => d.default.getId()), O = i.useMemo(() => (0, l.chunk)((0, u.XV)(p.i6, C), 9), [C]), I = [...O[v], ...O[(v + 1) % O.length]], E = i.useMemo(() => Array.from(j), [j]), S = i.useMemo(() => E.filter(e => !p.WZ.has(e) && !p.gh.has(e)), [E]), T = e => {
    let t = new Set(j);
    t.delete(e), n({
      interests: t
    })
