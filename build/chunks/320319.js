...
let R = {
  ...
  D = r.memo(e => {
    let {
      ...
      cardType: O,
      confettiCanvas: S
    } = e, w = null == e ? void 0 : e.onCtaClick, k = (0, c.e7)([m.Z], () => m.Z.useReducedMotion), [L, B] = r.useState(!1), [M, U] = r.useState(!1), V = (0, b.Er)(), G = (0, b.IB)(), [F, H] = r.useState(!1), [z, Y] = r.useState(t === j.u.TENURE_REWARD_COLLECTIBLE && G && (null == V ? void 0 : V.nitroTenureStatus) === v.EB.REDEEMABLE);
    r.useEffect(() => {
    ...
    return (r.useEffect(() => {
    ...
    }), n) ? t === j.u.UPCOMING_DROP_UNTIMED ? (0, i.jsx)("div", {
      ...
      children: (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(Z, P(A({}, e), {
          ref: t === j.u.TENURE_REWARD_COLLECTIBLE ? er : void 0
        })), z && (0, i.jsx)(_.Z, {
          speedValues: R,
          numBursts: 3,
...
let Z = r.forwardRef((e, t) => {
  ...
  return (0, i.jsxs)(u.P3F, {
    ...
    onClick: _,
    children: [null != j && (0, i.jsx)(u.Text, {
