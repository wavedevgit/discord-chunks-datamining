...
let R = {
  ...
  D = r.memo(e => {
    ...
    return (r.useEffect(() => {
    ...
    }), n) ? t === C.u.UPCOMING_DROP_UNTIMED ? (0, i.jsx)("div", {
      ...
      children: (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(Z, P(A({}, e), {
          ref: t === C.u.TENURE_REWARD_COLLECTIBLE ? er : void 0
        })), z && (0, i.jsx)(_.Z, {
          speedValues: R,
          numBursts: 3,
...
let Z = r.forwardRef((e, t) => {
  ...
  let {
    ...
    perkImage: v,
    imageOverlayText: T
  } = e, I = b === j.R0.CARD_CAROUSEL_FIRST_ROW || b === j.R0.CARD_CAROUSEL_SECOND_ROW || b === j.R0.CARD_CAROUSEL_THIRD_ROW, N = "" !== o || "" !== c || "" !== a && f === j.zW.REWARD, A = (0, x._)(f);
