...
let h = e => {
  let {
    application: t,
    reportId: n
  } = e, [h, _] = l.useState(!1), f = (0, i.e7)([m.Z], () => {
    let e = m.Z.getApps();
  ...
  let v = (0, i.e7)([s.ZP], () => s.ZP.getSelfEmbeddedActivities()),
    j = l.useCallback(() => {
      if (_(!1), d.ZP.trackWithMetadata(p.rMx.IAR_DEAUTHORIZE_APP_BUTTON_CLICKED, {
          application_id: t.id,
          report_id: n
        }), null == f) return;
      o.Z.delete(f.id), x.S.safeDispatch(p.CkL.HIDE_APP_LAUNCHER_BUTTON_APP_INSTALLED_EDUCATION, {
        applicationId: t.id
      });
      let e = v.get(t.id);
