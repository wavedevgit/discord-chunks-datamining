...
let v = (e, l, r) => {
  ...
  g = e => {
    let {
      ...
      onClose: g,
      transitionState: k,
      currentSelectedRoles: y = []
    } = e, {
      shouldEveryonePost: N,
      setShouldEveryonePost: S
    } = v(l, r, a), C = n.useRef(null), O = function(e) {
      let l = (0, s.e7)([m.Z], () => m.Z.getRoles(e.id));
      return n.useMemo(() => (0, p.KV)(e, l).filter(l => j(e.id)(l.id)), [e, l])
    }(l), _ = O.reduce((e, l) => (e.set(l.id, l), e), new Map), R = O.map(e => ({
      key: e.key,
      label: e.name,
      value: e.id
    })), [z, H] = n.useState(y.map(e => e.id).filter(j(l.id))), [P, M] = n.useState(!1), [E, B] = n.useState(!1), L = z.length > 0 || N, V = function(e, l) {
          ...
          s = function(e) {
            for (var l = 1; l < arguments.length; l++) {
              ...
              "function" == typeof Object.getOwnPropertySymbols && (t = t.concat(Object.getOwnPropertySymbols(r).filter(function(e) {
                ...
                var t;
                t = r[l], l in e ? Object.defineProperty(e, l, {
                  value: t,
                  enumerable: !0,
                  configurable: !0,
                  writable: !0
            ...
            children: (0, t.jsx)("div", {
              ...
              children: (0, t.jsx)(c.JcV, {
                ...
                children: (0, t.jsx)(c.VcW, {
                  ...
                  renderOptionPrefix: e => null != e ? (0, t.jsx)(b, {
