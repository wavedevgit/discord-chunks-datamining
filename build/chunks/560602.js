...
let w = (e, l, t) => {
  ...
  v = e => {
    ...
    } = w(l, t, v), C = r.useRef(null), O = function(e) {
      let l = (0, o.e7)([d.Z], () => d.Z.getRoles(e.id));
      return r.useMemo(() => (0, p.KV)(e, l).filter(l => f(e.id)(l.id)), [e, l])
    }(l), N = O.reduce((e, l) => (e.set(l.id, l), e), new Map), R = O.map(e => ({
      key: e.key,
      label: e.name,
      value: e.id
    })), [z, P] = r.useState(k.map(e => e.id).filter(f(l.id))), [H, M] = r.useState(!1), [_, E] = r.useState(!1), B = z.length > 0 || y, L = function(e, l) {
    ...
    return H ? (0, n.jsx)(s.$jN, {}) : (0, n.jsxs)(s.Y0X, {
      transitionState: g,
          ...
          children: (0, n.jsx)("div", {
            ...
            children: (0, n.jsx)(s.JcV, {
              ...
              children: (0, n.jsx)(s.VcW, {
                ...
                renderOptionPrefix: e => null != e ? (0, n.jsx)(j, {
