...
let j = (e, l, t) => {
  ...
  v = e => {
    ...
    } = j(l, t, v), O = r.useRef(null), N = function(e) {
      let l = (0, o.e7)([h.Z], () => h.Z.getRoles(e.id));
      return r.useMemo(() => (0, x.KV)(e, l).filter(l => w(e.id)(l.id)), [e, l])
    }(l), z = N.reduce((e, l) => (e.set(l.id, l), e), new Map), R = N.map(e => ({
      key: e.key,
      label: e.name,
      value: e.id
    })), [P, H] = r.useState(y.map(e => e.id).filter(w(l.id))), [M, _] = r.useState(!1), [V, B] = r.useState(!1), E = P.length > 0 || S, L = function(e, l) {
    ...
    return M ? (0, n.jsx)(s.$jN, {}) : (0, n.jsxs)(s.Y0X, {
      transitionState: k,
