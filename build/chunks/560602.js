...
let v = (e, l, r) => {
  ...
  g = e => {
    ...
    }(l), _ = O.reduce((e, l) => (e.set(l.id, l), e), new Map), z = O.map(e => ({
      key: e.key,
      label: e.name,
      value: e.id
    })), [H, R] = n.useState(y.map(e => e.id).filter(j(l.id))), [P, E] = n.useState(!1), [M, B] = n.useState(!1), L = H.length > 0 || N, V = function(e, l) {
