...
let Y = {
  ...
  F = (0, p.Z)(class extends o.PureComponent {
    render() {
      return (0, i.jsx)("div", {
...
function z(e) {
  let {
    ...
    return (0, A.Z)(t) && (n = M.ABu.SPOTIFY), null != t.platform && [M.M7m.PS4, M.M7m.PS5].includes(t.platform) && (n = M.ABu.PLAYSTATION), n
  }({
    activity: t
  });
...
class H extends(r = o.PureComponent) {
  get activity() {
    ...
    return null != t && (null == e ? void 0 : e.type) !== M.IIU.PLAYING && (null == e ? void 0 : e.type) !== M.IIU.WATCHING && (null == e ? void 0 : e.type) !== M.IIU.LISTENING && (null == e ? void 0 : e.type) !== M.IIU.HANG_STATUS ? {
      type: M.IIU.PLAYING,
      name: L.NW.string(L.t.eXan7O)
    } : e
  }
  getTypeClass(e, t) {
    return (0, Z.l)(U, e, this.props.type, t)
  }
  ...
  renderHeader(e) {
    ...
    switch (a.type) {
      case M.IIU.STREAMING:
        t = L.NW.formatToPlainString(L.t.Dzgz4u, {
          platform: [M.ABu.TWITCH, M.ABu.YOUTUBE].includes(c.toLowerCase()) ? c : g.Z.get(M.ABu.TWITCH).name
        });
        break;
      case M.IIU.LISTENING:
        t = L.NW.formatToPlainString(L.t["5sYPnp"], {
          name: c
        });
        break;
      case M.IIU.WATCHING:
        t = L.NW.formatToPlainString(L.t.Ge29Z2, {
          name: c
        });
        break;
      case M.IIU.PLAYING:
      ...
      case M.IIU.COMPETING:
        t = L.NW.formatToPlainString(L.t.SQCo6O, {
          name: c
        })
    }
    if (null != r) {
      var u;
      t = (0, E.yE)(null !== (u = null == a ? void 0 : a.flags) && void 0 !== u ? u : 0, M.xjy.EMBEDDED) ? a.type === M.IIU.WATCHING ? L.NW.formatToPlainString(L.t["M/L8oq"], {
        guildName: r.name
      }) : L.NW.formatToPlainString(L.t["4chKQk"], {
        guildName: r.name
      }) : L.NW.formatToPlainString(L.t.sddlGB, {
        server: r.name
      })
    }
    return (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsx)(f.X6q, {
        className: s()((0, Z.l)(U, "headerText", e ? "EmptyBody" : "Normal")),
  ...
  renderImage(e) {
    ...
    let p = (0, A.Z)(e),
      m = null != u.large_image ? (0, i.jsx)("img", {
        ...
        src: G(d, u.large_image, null != l ? l : [W.Si.LARGE, W.Si.LARGE]),
    ...
    return (this.isStreamerOnTypeActivityFeed() && null != e.url && "" !== e.url && (m = (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(f.H, {
          ...
          children: L.NW.format(L.t.gmCZRU, {
            game: e.details
          })
        })]
      }), (0, i.jsx)(f.eee, {
    ...
    })), (0, x.dS)(e) || null == u.small_image || (a = (0, i.jsx)(f.ua7, {
      ...
      children: e => {
        ...
        return (0, i.jsx)("img", V({
          ...
          src: G(d, u.small_image, [W.Si.SMALL, W.Si.SMALL]),
  ...
  renderGameImage(e) {
    ...
    return null != e.assets || (0, T.Z)(e) || e.type !== M.IIU.PLAYING || "ActivityFeed" === n || t.bot ? null : null == r && null != l ? (0, i.jsx)("div", {
  ...
  renderName(e) {
    ...
    return (a && null != n ? u = (0, i.jsx)("span", {
      ...
      children: u
    }) : !a && (c = l, u = l, (0, A.Z)(e) && null != e.sync_id && null != l ? u = (0, i.jsx)(f.eee, {
      className: U.bodyLink,
      onClick: this.handleOpenSpotifyTrack,
      children: l
    }) : (0, x.dS)(e) && (u = e.name)), null == u) ? null : (0, i.jsx)(f.Text, {
      title: c,
      variant: "text-sm/semibold",
      className: s()((0, Z.l)(U, "name", t.bot ? "wrap" : "normal")),
      children: u
    })
  }
  renderDetails(e) {
    ...
    if (e.type === M.IIU.CUSTOM_STATUS) l = r;
      ...
      if (l = r, o = r, (0, A.Z)(e) && null != r) l = L.NW.format(L.t.uU9le3, {
        artists: o,
    ...
    return null == l || "" === l ? null : ((0, _.Z)(e) && (l = L.NW.formatToPlainString(L.t.gmCZRU, {
      game: l
      ...
      title: null != o ? o : void 0,
      className: (0, _.Z)(e) || (0, A.Z)(e) ? U.detailsWrap : U.details,
      children: l
    })
  }
  renderChannelDetails(e) {
    ...
    return n && null != t ? null == r ? (0, i.jsx)("div", {
      className: (0, _.Z)(e) || (0, A.Z)(e) ? U.detailsWrap : U.details,
      children: L.NW.format(L.t["hq/Qzc"], {
        guildName: t.name
      })
    }) : (0, i.jsxs)("div", {
      className: s()((0, _.Z)(e) || (0, A.Z)(e) ? U.detailsWrap : U.details, U.guildDetails),
  ...
  renderTimePlayed(e) {
    ...
    if (!(0, C.Z)(e) || (0, A.Z)(e)) return null;
    let {
      timestamps: n
    } = e;
    return null == n ? null : (0, T.Z)(e) ? (0, i.jsx)(F, {
      timestamps: n
    }) : (0, i.jsx)(P.ZP, {
      start: n.start,
  ...
  renderState(e, t) {
    ...
    return (!(0, C.Z)(e) && (c = null == s ? void 0 : s.large_text, u = null == s ? void 0 : s.large_text, (0, A.Z)(e) && null != c && (c = L.NW.format(L.t.vOLBEx, {
      album: u,
    ...
    }))), null != c && "" !== c && e.type !== M.IIU.CUSTOM_STATUS || (0, x.dS)(e)) ? ((null == a ? void 0 : a.size) == null && [W.Zc].includes(null !== (n = e.application_id) && void 0 !== n ? n : "") ? l = L.NW.formatToPlainString(L.t["u//9Bw"], {
      count: "0",
      max: null !== (r = null == t ? void 0 : t.getMaxParticipants()) && void 0 !== r ? r : 0
    }) : (0, x.dS)(e) && (null == a ? void 0 : a.size) != null ? l = L.NW.formatToPlainString(L.t["JC/3x8"], {
      numSpeakers: a.size[0],
      numListeners: a.size[1] - a.size[0]
    }) : (null == a ? void 0 : a.size) != null && a.size.length >= 2 && (l = 0 === a.size[1] ? L.NW.formatToPlainString(L.t.IM4J4e, {
      count: a.size[0]
    }) : L.NW.formatToPlainString(L.t["u//9Bw"], {
      count: a.size[0],
      max: a.size[1]
    })), (0, i.jsxs)("div", {
      className: U.state,
    ...
    return (0, i.jsxs)("div", {
      ...
      children: [this.renderHeader(S), (0, i.jsx)("div", {
        ...
        children: (0, i.jsxs)("div", {
          ...
          children: [e, this.isStreamerOnTypeActivityFeed() ? null : (0, i.jsxs)(b.Z.Child, {
            className: s()((0, Z.l)(U, "content", p ? "GameImage" : null != e ? "Images" : "NoImages", t)),
