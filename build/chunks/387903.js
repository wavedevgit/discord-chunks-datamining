...
class q extends(r = a.PureComponent) {
  ...
  renderHeader(e) {
    ...
    if (null != r) {
      var u;
      t = (0, A.yE)(null != (u = null == o ? void 0 : o.flags) ? u : 0, F.xjy.EMBEDDED) ? o.type === F.IIU.WATCHING ? G.intl.formatToPlainString(G.t["M/L8oq"], {
        guildName: r.name
    ...
    return (null == o ? void 0 : o.type) === F.IIU.HANG_STATUS && (t = G.intl.string(G.t["74vS//"])), (0, l.jsxs)("div", {
  ...
  renderName(e) {
    ...
    return (a === F.IIU.HANG_STATUS ? u = (0, I.O8)(e) : o && null != n ? u = (0, l.jsx)("span", {
      ...
      children: u
    }) : !o && (c = i, u = i, (0, k.Z)(e) && null != e.sync_id && null != i ? u = (0, l.jsx)(f.eee, {
  ...
  renderDetails(e) {
    ...
    if (e.type === F.IIU.CUSTOM_STATUS) a = r;
      ...
      if (a = r, o = r, (0, k.Z)(e) && null != r) a = G.intl.format(G.t.uU9le3, {
        artists: o,
        artistsHook: (t, n) => (0, l.jsx)(P.Z, {
          artists: r,
  ...
  renderState(e, t) {
    ...
    let i, {
      ...
      c = a,
      u = a;
    return (!(0, L.Z)(e) && (c = null == s ? void 0 : s.large_text, u = null == s ? void 0 : s.large_text, (0, k.Z)(e) && null != c && (c = G.intl.format(G.t.vOLBEx, {
      album: u,
    ...
    }))), null != c && "" !== c && e.type !== F.IIU.CUSTOM_STATUS || (0, C.dS)(e)) ? ((null == o ? void 0 : o.size) == null && [V.Zc].includes(null != (n = e.application_id) ? n : "") ? i = G.intl.formatToPlainString(G.t["u//9Bw"], {
      count: "0",
      max: null != (r = null == t ? void 0 : t.getMaxParticipants()) ? r : 0
    }) : (0, C.dS)(e) && (null == o ? void 0 : o.size) != null ? i = G.intl.formatToPlainString(G.t["JC/3x8"], {
      numSpeakers: o.size[0],
      numListeners: o.size[1] - o.size[0]
    }) : (null == o ? void 0 : o.size) != null && o.size.length >= 2 && (i = 0 === o.size[1] ? G.intl.formatToPlainString(G.t.IM4J4e, {
      count: o.size[0]
    ...
    return (0, l.jsxs)("div", {
      ...
      children: [this.renderHeader(S), (0, l.jsx)("div", {
        ...
        children: (0, l.jsxs)("div", {
          ...
          children: [e, this.isStreamerOnTypeActivityFeed() ? null : (0, l.jsxs)(h.Z.Child, {
