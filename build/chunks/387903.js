...
let z = {
  ...
  q = (0, f.Z)(class extends a.PureComponent {
    render() {
      return (0, i.jsx)("div", {
...
function $(e) {
  ...
  return (0, k.Z)(t) && (n = B.ABu.SPOTIFY), null != t.platform && [B.M7m.PS4, B.M7m.PS5].includes(t.platform) && (n = B.ABu.PLAYSTATION), n
}
...
class Q extends(r = a.PureComponent) {
  get activity() {
    ...
    return null != t && (null == e ? void 0 : e.type) !== B.IIU.PLAYING && (null == e ? void 0 : e.type) !== B.IIU.WATCHING && (null == e ? void 0 : e.type) !== B.IIU.LISTENING && (null == e ? void 0 : e.type) !== B.IIU.HANG_STATUS ? {
      type: B.IIU.PLAYING,
      name: Z.intl.string(Z.t.eXan7O)
    } : e
  }
  getTypeClass(e, t) {
    return (0, P.l)(F, e, this.props.type, t)
  }
  isStreamerOnTypeActivityFeed() {
    return (0, M.Z)(this.activity) && "ActivityFeed" === this.props.type
  }
  renderHeader(e) {
    let t, {
        hideHeader: n,
    ...
    if (null != r) {
      var u;
      t = (0, R.yE)(null != (u = null == l ? void 0 : l.flags) ? u : 0, B.xjy.EMBEDDED) ? l.type === B.IIU.WATCHING ? Z.intl.formatToPlainString(Z.t["M/L8oq"], {
        guildName: r.name
    ...
    return (null == l ? void 0 : l.type) === B.IIU.HANG_STATUS && (t = Z.intl.string(Z.t["74vS//"])), (0, i.jsxs)("div", {
      className: F.headerContainer,
      children: [(0, i.jsx)(d.X6q, {
        className: s()((0, P.l)(F, "headerText", e ? "EmptyBody" : "Normal")),
  ...
  renderImage(e) {
    ...
    let _ = (0, k.Z)(e),
      p = null != u.large_image ? (0, i.jsx)("img", {
        ...
        src: (0, C.xF)(f, u.large_image, null != o ? o : [G.Si.LARGE, G.Si.LARGE]),
  ...
  renderName(e) {
    ...
    return (o === B.IIU.HANG_STATUS ? u = (0, v.O8)(e) : l && null != n ? u = (0, i.jsx)("span", {
      ...
      children: u
    }) : !l && (c = a, u = a, (0, k.Z)(e) && null != e.sync_id && null != a ? u = (0, i.jsx)(d.eee, {
      ...
      className: s()((0, P.l)(F, "name", t.bot ? "wrap" : "normal")),
      children: u
    })
  }
  renderDetails(e) {
    ...
    return null == o || "" === o ? null : ((0, M.Z)(e) && (o = Z.intl.formatToPlainString(Z.t.gmCZRU, {
      ...
      title: null != s ? s : void 0,
      className: (0, M.Z)(e) || (0, k.Z)(e) ? F.detailsWrap : F.details,
      children: o
    })
  }
  renderChannelDetails(e) {
    ...
    return n && null != t ? null == r ? (0, i.jsx)("div", {
      ...
      className: s()((0, M.Z)(e) || (0, k.Z)(e) ? F.detailsWrap : F.details, F.guildDetails),
  ...
  renderTimePlayed(e) {
    ...
    if (!(0, x.Z)(e) || (0, k.Z)(e)) return null;
    let {
      timestamps: n
    } = e;
  ...
  renderState(e, t) {
    ...
    let a, {
      ...
      c = o,
      u = o;
    if (!(0, x.Z)(e) && (c = null == l ? void 0 : l.large_text, u = null == l ? void 0 : l.large_text, (0, k.Z)(e) && null != c)) {
    ...
    return null != c && "" !== c && e.type !== B.IIU.CUSTOM_STATUS || (0, N.dS)(e) ? ((null == s ? void 0 : s.size) == null && [G.Zc].includes(null != (n = e.application_id) ? n : "") ? a = Z.intl.formatToPlainString(Z.t["u//9Bw"], {
      count: "0",
      max: null != (r = null == t ? void 0 : t.getMaxParticipants()) ? r : 0
    }) : (0, N.dS)(e) && (null == s ? void 0 : s.size) != null ? a = Z.intl.formatToPlainString(Z.t["JC/3x8"], {
      numSpeakers: s.size[0],
      numListeners: s.size[1] - s.size[0]
    }) : (null == s ? void 0 : s.size) != null && s.size.length >= 2 && (a = 0 === s.size[1] ? Z.intl.formatToPlainString(Z.t.IM4J4e, {
      count: s.size[0]
  ...
  render() {
    ...
    let u = "ActivityFeed" === t,
      f = "StreamPreview" === t,
      _ = !1;
    (0, j.Z)(c) ? (e = this.renderXboxImage(), _ = !0) : null == (e = this.renderImage(c)) && (_ = null != (e = this.renderGameImage(c)));
    ...
    return (0, i.jsxs)("div", {
      ...
      children: [this.renderHeader(v), (0, i.jsx)("div", {
        ...
        children: (0, i.jsxs)("div", {
          ...
          children: [e, this.isStreamerOnTypeActivityFeed() ? null : (0, i.jsxs)(h.Z.Child, {
            className: s()((0, P.l)(F, "content", _ ? "GameImage" : null != e ? "Images" : "NoImages", t)),
