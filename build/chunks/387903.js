...
class G extends(r = o.PureComponent) {
  ...
  renderHeader(e) {
    ...
    if (null != r) {
      var u;
      t = (0, E.yE)(null != (u = null == a ? void 0 : a.flags) ? u : 0, R.xjy.EMBEDDED) ? a.type === R.IIU.WATCHING ? F.intl.formatToPlainString(F.t["M/L8oq"], {
        guildName: r.name
  ...
  renderImage(e) {
    ...
    })), (0, I.dS)(e) || null == u.small_image || (a = (0, l.jsx)(p.ua7, {
  ...
  renderName(e) {
    ...
    let a = (0, Z.Z)(e),
      c = e.name,
      u = c;
    return (a && null != n ? u = (0, l.jsx)("span", {
      className: U.activityName,
      children: u
    }) : !a && (c = i, u = i, (0, A.Z)(e) && null != e.sync_id && null != i ? u = (0, l.jsx)(p.eee, {
  ...
  renderDetails(e) {
    ...
    if (e.type === R.IIU.CUSTOM_STATUS) i = r;
      ...
      if (i = r, o = r, (0, A.Z)(e) && null != r) i = F.intl.format(F.t.uU9le3, {
        artists: o,
  ...
  renderState(e, t) {
    ...
    }))), null != c && "" !== c && e.type !== R.IIU.CUSTOM_STATUS || (0, I.dS)(e)) ? ((null == a ? void 0 : a.size) == null && [M.Zc].includes(null != (n = e.application_id) ? n : "") ? i = F.intl.formatToPlainString(F.t["u//9Bw"], {
      count: "0",
      max: null != (r = null == t ? void 0 : t.getMaxParticipants()) ? r : 0
    }) : (0, I.dS)(e) && (null == a ? void 0 : a.size) != null ? i = F.intl.formatToPlainString(F.t["JC/3x8"], {
      numSpeakers: a.size[0],
      numListeners: a.size[1] - a.size[0]
    }) : (null == a ? void 0 : a.size) != null && a.size.length >= 2 && (i = 0 === a.size[1] ? F.intl.formatToPlainString(F.t.IM4J4e, {
      count: a.size[0]
  ...
  render() {
    ...
    return (0, l.jsxs)("div", {
      ...
      children: [this.renderHeader(j), (0, l.jsx)("div", {
        className: s()(f ? U.bodyAlignCenter : U.bodyNormal),
        children: (0, l.jsxs)("div", {
          className: U.activityDetails,
          children: [e, this.isStreamerOnTypeActivityFeed() ? null : (0, l.jsxs)(b.Z.Child, {
            className: s()((0, w.l)(U, "content", f ? "GameImage" : null != e ? "Images" : "NoImages", t)),
