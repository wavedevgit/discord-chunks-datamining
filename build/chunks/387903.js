...
let z = {
  ...
  q = (0, f.Z)(class extends o.PureComponent {
    render() {
      return (0, i.jsx)("div", {
...
class J extends(r = o.PureComponent) {
  ...
  renderHeader(e) {
    ...
    if (null != r) {
      var u;
      t = (0, P.yE)(null != (u = null == l ? void 0 : l.flags) ? u : 0, B.xjy.EMBEDDED) ? l.type === B.IIU.WATCHING ? Z.intl.formatToPlainString(Z.t["M/L8oq"], {
        guildName: r.name
  ...
  renderState(e, t) {
    ...
    let o, {
      ...
      c = a,
      u = a;
    if (!(0, x.Z)(e) && (c = null == l ? void 0 : l.large_text, u = null == l ? void 0 : l.large_text, (0, M.Z)(e) && null != c)) {
    ...
    return null != c && "" !== c && e.type !== B.IIU.CUSTOM_STATUS || (0, N.dS)(e) ? ((null == s ? void 0 : s.size) == null && [G.Zc].includes(null != (n = e.application_id) ? n : "") ? o = Z.intl.formatToPlainString(Z.t["u//9Bw"], {
      count: "0",
      max: null != (r = null == t ? void 0 : t.getMaxParticipants()) ? r : 0
    }) : (0, N.dS)(e) && (null == s ? void 0 : s.size) != null ? o = Z.intl.formatToPlainString(Z.t["JC/3x8"], {
      numSpeakers: s.size[0],
      numListeners: s.size[1] - s.size[0]
    }) : (null == s ? void 0 : s.size) != null && s.size.length >= 2 && (o = 0 === s.size[1] ? Z.intl.formatToPlainString(Z.t.IM4J4e, {
      count: s.size[0]
  ...
  render() {
    ...
    let u = "ActivityFeed" === t,
      f = "StreamPreview" === t,
      _ = !1;
    (0, k.Z)(c) ? (e = this.renderXboxImage(), _ = !0) : null == (e = this.renderImage(c)) && (_ = null != (e = this.renderGameImage(c)));
    let p = this.renderName(c),
      m = this.renderDetails(c),
      g = this.renderState(c, o),
      ...
      children: [this.renderHeader(v), (0, i.jsx)("div", {
        ...
        children: (0, i.jsxs)("div", {
          ...
          children: [e, this.isStreamerOnTypeActivityFeed() ? null : (0, i.jsxs)(h.Z.Child, {
            className: s()((0, w.l)(F, "content", _ ? "GameImage" : null != e ? "Images" : "NoImages", t)),
