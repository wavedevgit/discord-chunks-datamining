...
let z = {
  ...
  J = (0, p.Z)(class extends a.PureComponent {
    render() {
      return (0, l.jsx)("div", {
...
class q extends(r = a.PureComponent) {
  ...
  renderHeader(e) {
    ...
    switch (o.type) {
      ...
      case F.IIU.LISTENING:
        t = W.intl.formatToPlainString(W.t["5sYPnp"], {
          name: c
        });
        break;
      case F.IIU.WATCHING:
        t = W.intl.formatToPlainString(W.t.Ge29Z2, {
          name: c
        });
        break;
      case F.IIU.PLAYING:
      ...
      case F.IIU.COMPETING:
        t = W.intl.formatToPlainString(W.t.SQCo6O, {
          name: c
        })
    }
    if (null != r) {
      var u;
      t = (0, N.yE)(null != (u = null == o ? void 0 : o.flags) ? u : 0, F.xjy.EMBEDDED) ? o.type === F.IIU.WATCHING ? W.intl.formatToPlainString(W.t["M/L8oq"], {
        guildName: r.name
      }) : W.intl.formatToPlainString(W.t["4chKQk"], {
        guildName: r.name
      }) : W.intl.formatToPlainString(W.t.sddlGB, {
        server: r.name
      })
    }
    return (null == o ? void 0 : o.type) === F.IIU.HANG_STATUS && (t = W.intl.string(W.t["74vS//"])), (0, l.jsxs)("div", {
  ...
  renderImage(e) {
    ...
    return (this.isStreamerOnTypeActivityFeed() && null != e.url && "" !== e.url && (m = (0, l.jsxs)("div", {
      ...
      children: [(0, l.jsxs)("div", {
        ...
        children: [(0, l.jsx)(f.H, {
          ...
          children: W.intl.format(W.t.gmCZRU, {
            game: e.details
          })
        })]
      }), (0, l.jsx)(f.eee, {
    ...
    })), (0, E.dS)(e) || null == u.small_image || (o = (0, l.jsx)(f.ua7, {
      text: "" !== u.small_text ? u.small_text : null,
      position: "top",
      children: e => {
        var t;
        return (0, l.jsx)("img", G({
  ...
  renderGameImage(e) {
    ...
    return null != e.assets || (0, D.Z)(e) || e.type !== F.IIU.PLAYING || "ActivityFeed" === n || t.bot ? null : null == r && null != i ? (0, l.jsx)("div", {
      className: s()(Y.gameIcon, Y.screenshareIcon)
    }) : (0, l.jsx)(b.Z, {
  ...
  renderName(e) {
    ...
    return (a === F.IIU.HANG_STATUS ? u = (0, S.O8)(e) : o && null != n ? u = (0, l.jsx)("span", {
      ...
      children: u
    }) : !o && (c = i, u = i, (0, L.Z)(e) && null != e.sync_id && null != i ? u = (0, l.jsx)(f.eee, {
      className: Y.bodyLink,
      onClick: this.handleOpenSpotifyTrack,
      children: i
    }) : (0, E.dS)(e) && (u = e.name)), null == u) ? null : (0, l.jsx)(f.Text, {
      title: c,
  ...
  renderDetails(e) {
    ...
    else if (e.type === F.IIU.HANG_STATUS && null != i) a = W.intl.formatToPlainString(W.t.IAZiW1, {
      guildName: i.name
    }), t = () => {
      (0, P.X)(i.id)
    };
    else if (!(0, k.Z)(e)) {
      if (a = r, o = r, (0, L.Z)(e) && null != r) a = W.intl.format(W.t.uU9le3, {
        artists: o,
        artistsHook: (t, n) => (0, l.jsx)(C.Z, {
          artists: r,
    ...
    return null == a || "" === a ? null : ((0, U.Z)(e) && (a = W.intl.formatToPlainString(W.t.gmCZRU, {
      game: a
  ...
  renderChannelDetails(e) {
    ...
    return n && null != t ? null == r ? (0, l.jsx)("div", {
      className: (0, U.Z)(e) || (0, L.Z)(e) ? Y.detailsWrap : Y.details,
      children: W.intl.format(W.t["hq/Qzc"], {
        guildName: t.name
      })
    }) : (0, l.jsxs)("div", {
  ...
  renderState(e, t) {
    ...
    let i, {
      ...
      c = a,
      u = a;
    return (!(0, k.Z)(e) && (c = null == s ? void 0 : s.large_text, u = null == s ? void 0 : s.large_text, (0, L.Z)(e) && null != c && (c = W.intl.format(W.t.vOLBEx, {
      album: u,
    ...
    }))), null != c && "" !== c && e.type !== F.IIU.CUSTOM_STATUS || (0, E.dS)(e)) ? ((null == o ? void 0 : o.size) == null && [V.Zc].includes(null != (n = e.application_id) ? n : "") ? i = W.intl.formatToPlainString(W.t["u//9Bw"], {
      count: "0",
      max: null != (r = null == t ? void 0 : t.getMaxParticipants()) ? r : 0
    }) : (0, E.dS)(e) && (null == o ? void 0 : o.size) != null ? i = W.intl.formatToPlainString(W.t["JC/3x8"], {
      numSpeakers: o.size[0],
      numListeners: o.size[1] - o.size[0]
    }) : (null == o ? void 0 : o.size) != null && o.size.length >= 2 && (i = 0 === o.size[1] ? W.intl.formatToPlainString(W.t.IM4J4e, {
      count: o.size[0]
