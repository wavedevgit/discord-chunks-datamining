...
function x(e) {
  ...
  return <div className={p.wrapper} ref={g}>{<div className={l()(p.container, c)} style={j}>{<div className={p.progress} style={_} />}{0 !== x && <u.Z width={x} className={l()(p.notches, f[t])} />}</div>}{m}</div>
}