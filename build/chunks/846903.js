/** Chunk was on web.js **/
/** chunk id: 846903, original params: e,t,n (module,exports,re quire) **/
"use strict";
var r;
r = {
  value: true
};
let Chunk438774 = require("./438774.js"),
  Chunk471356 = require("./471356.js"),
  Chunk466809 = require("./466809.js"),
  s = () => {},
  l = new Chunk471356.TimeoutError;
class c extends Chunk438774 {
  constructor(e) {
    var t, n, r, i;
  ...
  _tryToStartAnother() {
    if (0 === this._queue.size) return this._intervalId && clearInterval(this._intervalId), this._intervalId = true, this._resolvePromises(), false;
    if (!this._isPaused) {
  ...
  _initializeIntervalIfNeeded() {
    this._isIntervalIgnored || true !== this._intervalId || (this._intervalId = setInterval(() => {
      this._onInterval()
    }, this._interval), this._intervalEnd = Date.now() + this._interval)
  }
  _onInterval() {
    0 === this._intervalCount && 0 === this._pendingCount && this._intervalId && (clearInterval(this._intervalId), this._intervalId = true), this._intervalCount = this._carryoverConcurrencyCount ? this._pendingCount : 0, this._processQueue()
  }
  _processQueue() {
