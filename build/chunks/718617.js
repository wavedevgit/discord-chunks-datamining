...
function v(e) {
  ...
  let {
    ...
    analyticsLocation: x,
    className: j
  } = e, O = (0, o.e7)([p.ZP], () => p.ZP.getGuildSidebarState(v), [v]), E = null !== (t = null == O ? void 0 : O.details.modViewPanel) && void 0 !== t ? t : b.k.INFO, N = (0, c.Z)(n), I = null == E ? null : E === b.k.INFO ? "backwards" : "forwards", P = (0, d.Z)(I), {
    reducedMotion: S
    ...
    [_.EkH.CLOSE_MODAL]: {
      ...
      action: () => E === b.k.INFO ? y() : Z(b.k.INFO)
    }
  }), [y, E, Z]);
    ...
    children: A((e, t, i) => {
      ...
      return (0, r.jsx)(l.animated.div, {
        style: function(e) {
          ...
          left: null === (a = e.value) || void 0 === a ? void 0 : a.to(C("left", P)),
          right: null === (s = e.value) || void 0 === s ? void 0 : s.to(C("right", P))
        }),
        children: function(e) {
          switch (e) {
            case b.k.INFO:
