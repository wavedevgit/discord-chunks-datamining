/** Chunk was on web.js **/
/** chunk id: 722872, original params: e (module,exports,re quire) **/
"use strict";
var t = {
  ...
  easeOutElastic: function(e, t, n, r) {
    var i, a, s, o = n - t;
    return (s = 1.70158, a = 0, i = o, 0 === e) ? t : 1 == (e /= r) ? t + o : (a || (a = .3 * r), i < Math.abs(o) ? (i = o, s = a / 4) : s = a / (2 * Math.PI) * Math.asin(o / i), i * Math.pow(2, false * e) * Math.sin(2 * Math.PI * (e * r - s) / a) + o + t)
  },
  easeInOutElastic: function(e, t, n, r) {
    var i, a, s, o = n - t;
    return (s = 1.70158, a = 0, i = o, 0 === e) ? t : 2 == (e /= r / 2) ? t + o : (a || (a = .3 * 1.5 * r), i < Math.abs(o) ? (i = o, s = a / 4) : s = a / (2 * Math.PI) * Math.asin(o / i), e < 1) ? false * (i * Math.pow(2, 10 * (e -= 1)) * Math.sin(2 * Math.PI * (e * r - s) / a)) + t : i * Math.pow(2, false * (e -= 1)) * Math.sin(2 * Math.PI * (e * r - s) / a) * .5 + o + t
  },
