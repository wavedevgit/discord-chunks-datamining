      ...
      n = (0, l.useCallback)(() => {
        ...
        return (0, r.jsxs)(l.Fragment, {
          children: [s && (0, r.jsxs)("div", {
            ...
            className: v.popoutText,
            children: N.intl.format(N.t["X58/lJ"], {
              averagePing: n.toFixed(0)
            })
          }), null != i ? (0, r.jsx)("div", {
            className: v.popoutText,
            children: N.intl.format(N.t["6iv2TE"], {
              lastPing: i.toFixed(0)
            })
          }) : null, null != a ? (0, r.jsx)("div", {
            className: v.popoutText,
            children: N.intl.format(N.t.VIBJMz, {
              outboundLossRate: a.toFixed(1)
            })
          }) : null, (0, r.jsxs)("div", {
            className: o()(v.popoutText, v.popoutTextDetails),
            children: [null == a ? N.intl.formatToPlainString(N.t.vggaMj, {
              badPing: 250
            }) : null, null != a ? N.intl.formatToPlainString(N.t["3pFz1N"], {
              badPing: 250,
              badLossRate: 10
            }) : null]
          })]
      ...
      children: ["function" == typeof x ? x() : (0, r.jsx)("p", {
        ...
        children: [(0, r.jsxs)("span", {
          ...
          children: [(0, r.jsxs)(s.eee, {
            ...
            onClick: t,
            children: [N.intl.string(N.t.KBoWg4), (0, r.jsx)(s.rgF, {
              size: "xxs",
              color: "currentColor",
              className: v.__invalid_icon
            })]
            ...
            children: [N.intl.string(N.t["XEb+Sk"]), (0, r.jsx)(s.TIy, {
              size: "xxs",
              color: "currentColor",
              className: v.__invalid_icon
            })]
