...
let x = () => {
  ...
  m = function(e) {
    ...
    let t = (0, l.useCallback)(() => {
      ...
      p = d.Sb.getSetting(),
      m = {
        [y.hes.AWAITING_ENDPOINT]: b.NW.format(b.t.Eu2vUV, {
          url: y.yXt.STATUS
        }),
        ...
        [y.hes.ICE_CHECKING]: b.NW.format(b.t.SyoYUV, {
          url: g.Z.getArticleURL(y.BhN.VOICE_CONNECTION_ERRORS)
        }),
        [y.hes.DTLS_CONNECTING]: b.NW.format(b.t.SyoYUV, {
          url: g.Z.getArticleURL(y.BhN.VOICE_CONNECTION_ERRORS)
        }),
        [y.hes.RTC_CONNECTED]: n,
        [y.hes.NO_ROUTE]: b.NW.format(b.t["2tgQnp"], {
          url: g.Z.getArticleURL(y.BhN.VOICE_CONNECTION_ERRORS)
        }),
