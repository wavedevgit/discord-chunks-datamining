...
function C(e) {
  let {
    ...
    scrollerRef: _,
    sectionName: y
  } = e, v = (0, a.ap)((0, c.ZP)()), N = r.useRef(null), g = r.useRef(null), j = r.useRef(null), P = r.useRef(null), E = (0, o.dQu)(o.TVs.colors.BG_BASE_PRIMARY).hex(), A = (0, s.ZP)("number" == typeof x ? "" : x, null != E ? E : ""), I = r.useMemo(() => {
    var e, t;
    ...
    if (null != r && null != a && null != o && !isNaN(s) && !isNaN(u)) {
      ...
      a.style.filter = "brightness(".concat(1 + ((v ? 1.4 : .6) - 1) * f, ")"), a.style.backgroundColor = "color-mix(in oklab,".concat(A, " ").concat((1 - f) * 100, "%, ").concat(I, ")"), o.style.opacity = "".concat(0 + +f), o.style.transform = "translateY(".concat((i = s / 4) + (0 - i) * f, "px)"), null != c && (c.style.opacity = "".concat(1 + -1 * f))
    }
