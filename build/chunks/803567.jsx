...
function N(e) {
  ...
  return m && p.push({
    ...
    value: 0
  }), <o.hjN className={t ? true : C.marginBottom20}>{<o.vwX id={S} tag={o.RB0.H3} className={C.marginBottom8}>{E.intl.string(E.t.t8QhiY)}</o.vwX>}{<o.R94 type={o.R94.Types.DESCRIPTION} className={C.marginBottom8}>{E.intl.string(E.t.najZCQ)}</o.R94>}{<o.FXm options={p} onChange={e => {
        c.Z.setNoiseCancellation(2 === e.value, T), c.Z.setNoiseSuppression(1 === e.value, T)
      }} value={r ? 2 : +!!s} />}{m && <o.ToO className={C.marginBottom8} type={o.Dd5.PRIMARY} imageData={{
        src: (0, l.ap)(n) ? O : v,
        width: 70,
        height: 40
      }} align={d.Z.Align.CENTER} body={(0, i.jsx)(o.eee, {
...
function y(e) {
  ...
  }), [r]), S = n === j.pM4.VOICE_ACTIVITY && u, T = <x.Z>{(b || O || v) && <o.R94 className={t ? true : C.marginBottom20} type={o.R94.Types.DESCRIPTION}>{E.intl.string(E.t["/Whuzs"])}</o.R94>}{<m.F setting={_.s6.VOICE_AND_VIDEO_ADVANCED_PROCESSING_ECHO_CANCELLATION}><o.j7V className={t ? true : s()(C.marginTop8, C.marginBottom20)} value={l} onChange={e => c.Z.setEchoCancellation(e, {
          page: j.ZY5.USER_SETTINGS,
          section: j.jXE.SETTINGS_VOICE_AND_VIDEO
        })} disabled={b} hideBorder={t}>{E.intl.string(E.t.iWTwu7)}</o.j7V></m.F>}{<m.F setting={_.s6.VOICE_AND_VIDEO_ADVANCED_PROCESSING_NOISE_SUPPRESSION}><N refreshStyles={t} /></m.F>}{<m.F setting={_.s6.VOICE_AND_VIDEO_ADVANCED_PROCESSING_ADVANCED_VOICE_ACTIVITY}><o.j7V value={h} onChange={e => c.Z.setMode(n, {
          vadUseKrisp: e
        })} note={E.intl.string(E.t.LoOB1N)} disabled={!S} hideBorder={t}>{E.intl.string(E.t.BbESsr)}</o.j7V></m.F>}{<m.F setting={_.s6.VOICE_AND_VIDEO_ADVANCED_PROCESSING_AUTOMATIC_GAIN_CONTROL}><o.j7V value={d} onChange={e => c.Z.setAutomaticGainControl(e, {
          page: j.ZY5.USER_SETTINGS,
          section: j.jXE.SETTINGS_VOICE_AND_VIDEO
        })} note={E.intl.string(E.t["6EjbvL"])} disabled={v} hideBorder={t}>{E.intl.string(E.t.cUMdHx)}</o.j7V></m.F>}{<m.F setting={_.s6.VOICE_AND_VIDEO_ADVANCED_PROCESSING_BYPASS_SYSTEM_INPUT_PROCESSING}><o.j7V value={f} onChange={e => {
          c.Z.setBypassSystemInputProcessing(e)
        }} note={E.intl.string(E.t["UyRX+P"])} hideBorder={t}>{E.intl.string(E.t.DFPXIC)}</o.j7V></m.F>}</x.Z>;
  return t ? T : <o.hjN className={C.marginBottom20} title={E.intl.string(E.t["6I6GUl"])}>{T}</o.hjN>
}