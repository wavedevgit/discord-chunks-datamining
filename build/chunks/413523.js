...
class P {
  ...
  rebuild() {
    ...
    return t.add(c.default.getId()), this.guildRingingUsers.size > 0 && (t = new Set([...t, ...this.guildRingingUsers])), l.Z.getAllActiveStreamsForChannel(this.channelId).forEach(e => {
      let {
        ownerId: n
      } = e;
      return t.add(n)
  ...
  constructor(e) {
    v(this, "channelId", void 0), v(this, "call", void 0), v(this, "participants", {}), v(this, "lastSpoke", {}), v(this, "guildRingingUsers", new Set), v(this, "participantByIndex", new i.h(e => {
      var t;
      let n = [];
