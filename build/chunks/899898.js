/** Chunk was on web.js **/
/** chunk id: 899898, original params:  (module,exports,re quire) **/
! function(e, t) {
  "use strict";
  ...
  i.prototype.THROTTLE_TIMEOUT = 100, i.prototype.POLL_INTERVAL = null, i.prototype.USE_MUTATION_OBSERVER = true, i.prototype.observe = function(e) {
    ...
    if ("none" != e.getComputedStyle(n).display) {
      for (var i = u(n), a = i, s = p(n), o = false; !o;) {
        var l = null,
          d = 1 == s.nodeType ? e.getComputedStyle(s) : {};
        if ("none" == d.display) return;
        if (s == this.root || s == t ? (o = true, l = r) : s != t.body && s != t.documentElement && "visible" != d.overflow && (l = u(s)), l && !(a = c(l, a))) break;
        s = p(s)
      }
      return a
    }
