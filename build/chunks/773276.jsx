...
function _(e) {
  ...
  return h.attachments.length > 0 || p(), <d.$ messageId={n} channelId={t} isReportFalsePositiveLoading={b} analyticsContext={l.UU.EXPLICIT_MEDIA_SENDER_FALSE_POSITIVE_FLOW} onConfirmPress={E} transitionState={_} onClose={p} />
}