...
let T = e => {
  ...
  let {
    entry: l
  } = e, [o, p] = i.useState(!1), C = null != (0, a.e7)([_.Z], () => _.Z.getGuild(l.guildId)), x = async () => {
    p(!0);
    try {
      C ? (0, g.X)(l.guildId) : await u.Z.joinGuild(l.guildId, {
    ...
    icon: l.icon,
    size: 40
  })) ? t : void 0, S = j.NW.string(j.t.VJlc0d);
  return C && (S = j.NW.string(j.t.cqWE2d)), (0, r.jsxs)("div", {
    className: O.card,
    onContextMenu: e => {
      (0, c.jW)(e, async () => {
        let {
