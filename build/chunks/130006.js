...
module.exports = function(e, t, n, o, p, m, A) {
  ...
  if (M && (C = c(M.call(new e))) !== Object.prototype && C.next && (!a && c(C) !== b && (u ? u(C, b) : s(C[O]) || _(C, O, S)), d(C, w, true, true), a && (h[w] = S)), g && p === I && x && x.name !== I && (!a && E ? f(L, "name", I) : (D = true, j = function() {
      return i(x, this)
    })), p)
    if (N = {
        values: P(I),
