...
module.exports = function(e, t, n, a, _, h, C) {
  l(n, t, a);
  ...
  if (M && (A = c(M.call(new e))) !== Object.prototype && A.next && (!o && c(A) !== b && (u ? u(A, b) : s(A[O]) || p(A, O, T)), d(A, w, true, true), o && (m[w] = T)), g && _ === S && L && L.name !== S && (!o && E ? f(x, "name", S) : (D = true, j = function() {
      return i(L, this)
    })), _)
    if (N = {
        values: R(S),
