...
class h extends Chunk647438.Component {
  render() {
    ...
    if (module.type === Chunk981631.AzA.RECENT_RELEASE_DATE) return (0, Chunk951288.jsx)(f, {
      className: exports,
    ...
    if (module.type === Chunk981631.AzA.EARLY_ACCESS)
      if (null != module.releaseDate) return (0, Chunk951288.jsx)(f, {
        className: exports,
        circle: (0, Chunk951288.jsx)(p, {
    ...
    return module.type === Chunk981631.AzA.FLAVOR_TEXT ? (0, Chunk951288.jsx)(f, {
      ...
      className: exports
    }) : module.type === Chunk981631.AzA.HAS_FREE_PREMIUM_CONTENT ? (0, Chunk951288.jsx)(f, {
      className: exports,
      circle: (0, Chunk951288.jsx)(p, {
