...
class M extends i.Z {
  ...
  getActivelyProgressingPlayOnDesktopQuestIds() {
    ...
    for (let r of t)
      if (null != r.id)
        for (let t of n.values()) R(t) && (0, m.Nj)({
          quest: t
  ...
  constructor(...e) {
    super(...e), y(this, "legacyStreamKeyToHeartbeatState", new Map), y(this, "heartbeats", new Map([
      ...
      let i = () => {
        ...
        } else this.terminateLegacyHeartbeat({
          streamKey: n,
      ...
      let {
        progressSeconds: n,
        targetSeconds: i
      } = (0, m.il)(t, r.T.DESKTOP), o = Math.max(0, (i - n) * f.Z.Millis.SECOND);
      return o <= O ? o + S : O
    }), y(this, "terminateLegacyHeartbeat", e => {
      let {
        streamKey: t,
        sendTerminalHeartbeat: n
      } = e, r = this.legacyStreamKeyToHeartbeatState.get(t);
      if (null != r) {
        ...
        window.clearTimeout(i), this.legacyStreamKeyToHeartbeatState.delete(t), n && (0, p.m0)({
          questId: e,
          streamKey: t,
          terminal: !0
        })
      ...
      (null === n || null === r) && this.legacyStreamKeyToHeartbeatState.forEach((e, n) => {
        e.questId === t && (T.log("terminateHeartbeatForQuestId - terminating heartbeat for quest ID ".concat(t)), this.terminateLegacyHeartbeat({
          streamKey: n,
      ...
      if (T.log("~ handleSendHeartbeatSuccess -> Heartbeat succeeded:", t), null != r.completedAt)
        for (let e of (this.terminateLegacyHeartbeat({
          ...
          }), this.heartbeats.keys())) this.terminateHeartbeatV2(n, e)
      ...
      let {
        ...
        channelId: n,
        quest: r
      } = e, i = null == r || !C(n), o = C(n) && !this.legacyStreamKeyToHeartbeatState.has(t) && null != r && R(r) && !(0, m.$H)(r);
      i ? (T.log("handleVoiceStateChange - calling terminateHeartbeat for streamKey ".concat(t)), this.terminateLegacyHeartbeat({
        streamKey: t,
        sendTerminalHeartbeat: !0
      })) : o && (T.log("handleVoiceStateChange - initiating heartbeat for stream task"), this.initiateLegacyHeartbeat({
        streamKey: t,
      ...
      i ? (T.log("handleEmbeddedActivityUpdate - terminating heartbeat"), this.terminateLegacyHeartbeat({
        streamKey: r,
        sendTerminalHeartbeat: !0
      })) : o && (T.log("handleEmbeddedActivityUpdate - initiating heartbeat for activity task"), this.initiateLegacyHeartbeat({
        streamKey: r,
        applicationId: e,
        questId: t.id
      }))
      ...
      C(n) && R(i) && !(0, m.$H)(i) && !this.legacyStreamKeyToHeartbeatState.has(t) && (T.log("handleStreamCreate - initiating heartbeat for stream task"), this.initiateLegacyHeartbeat({
        streamKey: t,
        applicationId: E.r.build(i.config).application.id,
        questId: i.id
      }))
      ...
      null == i ? (T.log("handleStreamStart - calling terminateHeartbeat for streamKey ".concat(o)), this.terminateLegacyHeartbeat({
        streamKey: o,
        sendTerminalHeartbeat: !0
      })) : C(r) && R(i) && !(0, m.$H)(i) && !this.legacyStreamKeyToHeartbeatState.has(o) && (T.log("handleStreamStart - initiating heartbeat for stream task"), this.initiateLegacyHeartbeat({
        streamKey: o,
        applicationId: E.r.build(i.config).application.id,
        questId: i.id
      }))
      ...
      T.log("handleStreamClose - terminating heartbeat"), this.terminateLegacyHeartbeat({
        streamKey: t,
        sendTerminalHeartbeat: !0
      })
    }), y(this, "actions", {
