...
var er = function(e) {
  ...
  ef = function(e) {
    function t(t, n) {
      var r;
      if ((r = e.call(this) || this).key = void 0, r.animation = new P, r.queue = void 0, r._phase = es, r._state = {
          pauseQueue: new Set,
          resumeQueue: new Set
          ...
          if (!f) {
            ...
            if (o.is.und(a.duration))
              if (a.decay) {
                ...
                for (var b = null == c.lastVelocity ? m : c.lastVelocity, y = a.precision || (h == d ? .005 : Math.min(1, .001 * Math.abs(d - h))), O = a.restVelocity || y / 10, v = a.clamp ? 0 : a.bounce, I = !o.is.und(v), S = h == d ? c.v0 > 0 : h < d, T = !1, A = 1, N = Math.ceil(e / 1), C = 0; C < N && !(!(Math.abs(b) > O) && (f = Math.abs(d - _) <= y)); ++C) {
                  I && (T = _ == d || _ > d == S) && (b = -b * v, _ = d);
                  var P = (-(1e-6 * a.tension) * (_ - d) + -(.001 * a.friction) * b) / a.mass;
                  b += P * A, _ += b * A
                } else {
                  var R = a.progress || 0;
...
function eS(e, t, n) {
  ...
  s ? (t.to = void 0, t.onRest = void 0) : o.each(ey, function(n) {
    var r = t[n];
    if (o.is.fun(r)) {
      var i = e._events[n];
...
}), t.BailSignal = er, t.Controller = ev, t.FrameValue = ea, t.Interpolation = eW, t.Spring = eZ, t.SpringContext = ew, t.SpringHandle = eL, t.SpringValue = ef, t.Trail = eH, t.Transition = eY, t.config = v, t.inferTo = H, t.interpolate = ez, t.to = eK, t.update = eq, t.useChain = O, t.useSpring = ek, t.useSprings = ex, t.useTrail = eM, t.useTransition = eF