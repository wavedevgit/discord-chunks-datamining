...
function Y(e) {
  ...
  return t ? Y(t.get()) : a.is.arr(e) ? e.map(Y) : a.isAnimatedString(e) ? f.createStringInterpolator({
    range: [0, 1],
    output: [e, e]
  })(1) : e
}
          ...
          return e.abrupt("return", r.promise = c(l.mark(function e() {
            ...
            return l.wrap(function(e) {
              for (;;) switch (e.prev = e.next) {
                ...
                case 24:
                  return a.is.fun(d) && f.batchedUpdates(function() {
                    d(v)
                  }), e.abrupt("return", v);
                case 26:
                case "end":
...
var er = function(e) {
  ...
  eo = function(e) {
    ...
    return n.get = function() {
      ...
      this.idle || f.frameLoop.start(this), this._emit({
        type: "priority",
        parent: this,
        priority: e
      })
  ...
  e_ = function(e) {
    ...
    return n.advance = function(e) {
            ...
            if (a.is.und(o.duration))
              if (o.decay) {
                var g = !0 === o.decay ? .998 : o.decay,
                  E = Math.exp(-(1 - g) * p);
                f = h + m / (1 - g) * (1 - E), _ = .1 > Math.abs(c.lastPosition - f), b = m * E
              } else
                for (var b = null == c.lastVelocity ? m : c.lastVelocity, y = o.precision || (h == d ? .005 : Math.min(1, .001 * Math.abs(d - h))), O = o.restVelocity || y / 10, v = o.clamp ? 0 : o.bounce, I = !a.is.und(v), T = h == d ? c.v0 > 0 : h < d, S = !1, A = 1, N = Math.ceil(e / 1), C = 0; C < N && !(!(Math.abs(b) > O) && (_ = Math.abs(d - f) <= y)); ++C) {
                  I && (S = f == d || f > d == T) && (b = -b * v, f = d);
                  var R = (-(1e-6 * o.tension) * (f - d) + -(.001 * o.friction) * b) / o.mass;
                  b += R * A, f += b * A
                } else {
                  var P = o.progress || 0;
      ...
      var t = this;
      return f.batchedUpdates(function() {
        if (t._focus(e), t._set(e) && !t.is(ec)) return t._onChange(t.get(), !0);
        t._stop()
      }), this
    }, n.pause = function() {
      ef(this, "pause"), this.is(eu) || (this._phase = eu, a.flush(this._state.pauseQueue, function(e) {
        return e()
      }))
    }, n.resume = function() {
      ef(this, "resume"), this.is(eu) && (this._start(), a.flush(this._state.resumeQueue, function(e) {
        return e()
      }))
    }, n.finish = function(e) {
      var t = this;
      if (this.resume(), this.is(ec)) {
        ...
        !n.config.decay && a.is.und(e) && (e = n.to), a.is.und(e) || this._set(e), f.batchedUpdates(function() {
      ...
      var e = c(l.mark(function e(t, n) {
        ...
        return l.wrap(function(e) {
          for (;;) switch (e.prev = e.next) {
            case 0:
              return ef(this, "start"), a.is.und(t) ? (r = this.queue || [], this.queue = []) : r = [a.is.obj(t) ? t : o(o({}, n), {}, {
                to: t
      ...
      var t = this;
      return this.is(ed) || (en(this._state, this._lastCallId), this._focus(this.get()), f.batchedUpdates(function() {
        return t._stop(e)
      })), this
    }, n.reset = function() {
      this._update({
      ...
      if (V && this.is(ec) && (i.changed && !P ? G = !0 : G || this._stop()), !T) {
        ...
        if (G) {
          ...
          var W = +!P;
          W < Z.length && f.batchedUpdates(function() {
      ...
      var t = this.animation;
      _.getAnimated(this).reset(t.to), this.is(ec) || (t.changed = !1), t.immediate || (t.fromValues = t.values.map(function(e) {
...
function eT(e, t, n) {
  ...
  s ? (t.to = void 0, t.onRest = void 0) : a.each(ey, function(n) {
    var r = t[n];
    if (a.is.fun(r)) {
      var i = e._events[n];
...
function eV(e, t, n) {
  ...
  a.each(h, function(e, n) {
    ...
    if (r = x(r, e.item, n), !(r = a.is.obj(r) ? H(r) : {
        to: r
      }).config) {
...
}), t.BailSignal = er, t.Controller = ev, t.FrameValue = eo, t.Interpolation = eW, t.Spring = eZ, t.SpringContext = ew, t.SpringHandle = eL, t.SpringValue = e_, t.Trail = eH, t.Transition = eY, t.config = v, t.inferTo = H, t.interpolate = ez, t.to = eK, t.update = eq, t.useChain = O, t.useSpring = eM, t.useSprings = ex, t.useTrail = ek, t.useTransition = eV