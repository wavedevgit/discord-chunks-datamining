...
let b = new d.Z("ImageEditor"),
  ...
  j = e => {
    let {
      ...
      x: 0,
      y: 0
    }), D = l.useRef(null), [I, S] = l.useState(1), [w, T] = l.useState(null), [A, M] = l.useState({
      top: 0,
      bottom: 0,
      left: 0,
      right: 0
    }), [k, P] = l.useState(0), [R, L] = l.useState({
      x: 0,
      y: 0
    }), [Z, z] = l.useState(!1), G = "image/gif" === t.type, U = (0, o.v)(t.type), W = U && !G, [B, F] = l.useState(null);
    l.useEffect(() => {
      (0, p.Z)()
    }, []);
    let H = l.useCallback(e => {
        ...
        d.current = {
          x: t,
          y: n
        }, D.current.style.transform = "translate3d(".concat(t, "px, ").concat(n, "px, 0) rotate(").concat(k, "deg)"), y({
          x: t,
          y: n
        })
      }, [D, k, A]),
    ...
    let q = l.useRef(null),
      $ = l.useCallback(async () => {
        ...
        let r = Date.now(),
          ...
          o = null;
        if (null != q.current && (q.current(), q.current = null), G) try {
          let n = C({
              file: t,
              image: l,
              cropDimensions: _,
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(u.ua7, {
          ...
          children: [(0, r.jsx)(u.BlJ, {
            color: u.TVs.colors.ICON_SECONDARY,
            size: "sm"
          }), null != B && (0, r.jsx)(u.iRW, {
            className: f.slider,
            initialValue: B,
            minValue: 1,
            maxValue: 4,
...
function E(e, t, n) {
  let {
    width: r,
    height: l
  } = N(e, t), a = Math.abs(240 - r) / 2, i = Math.abs(240 - l) / 2;
...
let C = (e, t, n) => {
  let {
    height: r,
    width: l
  } = N(t, n), a = (r = Math.min(r, 240)) / (l = Math.min(l, 240)), i = {
    height: r,
    width: l
  }, s = Math.floor(a < 1 ? g.eT * a : g.eT / a), o = a < 1 ? s : g.eT, c = a > 1 ? s : g.eT;
  return v(x({}, e), {
    cropDimensions: i,
    resizeHeight: o,
    resizeWidth: c
