...
let f = new o.Z("ImageEditor"),
  ...
  x = e => {
    let {
      ...
      x: 0,
      y: 0
    }), E = l.useRef(null), [N, D] = l.useState(1), [I, C] = l.useState(null), [y, S] = l.useState({
      top: 0,
      bottom: 0,
      left: 0,
      right: 0
...
function O(e, t, n) {
  let {
    width: r,
    height: l
  } = _(e, t), a = Math.abs(256 - r) / 2, i = Math.abs(256 - l) / 2;
...
let j = (e, t, n) => {
  let {
    height: r,
    width: l
  } = _(t, n), a = (r = Math.min(r, 256)) / (l = Math.min(l, 256)), i = {
    height: r,
    width: l
