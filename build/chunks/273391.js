...
let v = new c.Z("ImageEditor"),
  ...
  b = e => {
    let {
      ...
      x: 0,
      y: 0
    }), E = l.useRef(null), [I, D] = l.useState(1), [C, y] = l.useState(null), [S, w] = l.useState({
      top: 0,
      bottom: 0,
      left: 0,
      right: 0
    }), [T, A] = l.useState(0), [M, k] = l.useState({
      x: 0,
      y: 0
    }), [P, R] = l.useState(!1), L = "image/gif" === t.type, Z = (0, i.v)(t.type), z = Z && !L, [G, U] = l.useState(null);
    l.useEffect(() => {
      (0, d.Z)()
    }, []);
    ...
    let J = l.useRef(null),
      K = l.useCallback(async () => {
        ...
        let r = Date.now(),
          ...
          s = null;
        if (null != J.current && (J.current(), J.current = null), L) try {
          let n = N({
              file: t,
              image: l,
              cropDimensions: x,
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(o.ua7, {
          ...
          children: [(0, r.jsx)(o.BlJ, {
            color: o.TVs.colors.ICON_SECONDARY,
            size: "sm"
          }), null != G && (0, r.jsx)(o.iRW, {
            className: g.slider,
            initialValue: G,
            minValue: 1,
            maxValue: 4,
...
function O(e, t, n) {
  let {
    width: r,
    height: l
  } = j(e, t), a = Math.abs(256 - r) / 2, i = Math.abs(256 - l) / 2;
...
let N = (e, t, n) => {
  let {
    height: r,
    width: l
  } = j(t, n), a = (r = Math.min(r, 256)) / (l = Math.min(l, 256)), i = {
    height: r,
    width: l
  }, s = Math.floor(a < 1 ? h.eT * a : h.eT / a), o = a < 1 ? s : h.eT, c = a > 1 ? s : h.eT;
  return f(p({}, e), {
    cropDimensions: i,
    resizeHeight: o,
    resizeWidth: c
