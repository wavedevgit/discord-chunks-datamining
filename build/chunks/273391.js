...
let g = new l.Z("ImageEditor"),
  m = e => {
    let {
      ...
      x: 0,
      y: 0
    }), b = a.useRef(null), [v, x] = a.useState(1), [_, O] = a.useState(null), [j, E] = a.useState({
      width: 0,
      height: 0
    }), [D, N] = a.useState({
      top: 0,
      ...
      left: 0,
      right: 0
    }), [y, I] = a.useState(0), [C, w] = a.useState({
      x: 0,
      y: 0
    }), [S, A] = a.useState(!1), [k, M] = a.useState(0), R = "image/gif" === t.type;
    a.useEffect(() => {
      (0, c.Z)()
    }, []);
    let T = a.useCallback(() => {
      ...
      L = a.useCallback(e => {
        ...
        m.current = {
          x: t,
          y: r
        }, b.current.style.transform = "translate3d(".concat(t, "px, ").concat(r, "px, 0) rotate(").concat(y, "deg)"), M(new Date().getTime())
      }, [b, y, D]),
      P = a.useCallback(e => {
        if (null == _) return;
        let {
    ...
    let U = a.useRef(null),
      W = a.useCallback(async () => {
        ...
        let r = Date.now(),
          ...
          s = null;
        if (null != U.current && (U.current(), U.current = null), R) try {
          let {
            result: r,
            cancelFn: i
          } = await (0, o.$p)({
    ...
    return a.useEffect(() => {
      ...
      let e = setTimeout(W, 1e3);
      return () => clearTimeout(e)
    }, [v, W, l, k]), (0, n.jsxs)("div", {
