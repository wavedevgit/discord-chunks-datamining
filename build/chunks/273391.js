...
let m = new o.Z("ImageEditor"),
  f = e => {
    let {
      ...
      x: 0,
      y: 0
    }), p = l.useRef(null), [O, y] = l.useState(1), [j, x] = l.useState(null), [w, _] = l.useState({
      width: 0,
      height: 0
    }), [E, v] = l.useState({
      top: 0,
      ...
      left: 0,
      right: 0
    }), [I, N] = l.useState(0), [C, A] = l.useState({
      x: 0,
      y: 0
    }), [S, P] = l.useState(!1), [R, M] = l.useState(0), k = "image/gif" === t.type;
    l.useEffect(() => {
      (0, c.Z)()
    }, []);
    let T = l.useCallback(() => {
        ...
        let {
          width: e,
          height: t
        } = p.current.getBoundingClientRect(), r = Math.min(e, t), n = {
          width: r,
          height: r
        };
        x({
      ...
      D = l.useCallback(e => {
        ...
        f.current = {
          x: t,
          y: r
        }, p.current.style.transform = "translate3d(".concat(t, "px, ").concat(r, "px, 0) rotate(").concat(I, "deg)"), M(new Date().getTime())
      }, [p, I, E]),
      L = l.useCallback(e => {
        if (null == j) return;
        let {
    ...
    let U = l.useRef(null),
      H = l.useCallback(async () => {
        ...
        let r = Date.now(),
          ...
          a = null;
        if (null != U.current && (U.current(), U.current = null), k) try {
          let {
            result: r,
            cancelFn: i
          } = await (0, s.$p)({
    ...
    return l.useEffect(() => {
      ...
      let e = setTimeout(H, 1e3);
      return () => clearTimeout(e)
    }, [O, H, o, R]), (0, n.jsxs)("div", {
