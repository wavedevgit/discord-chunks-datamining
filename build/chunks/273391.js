...
let g = new i.Z("ImageEditor"),
  ...
  f = e => {
    let {
      ...
      x: 0,
      y: 0
    }), _ = a.useRef(null), [j, O] = a.useState(1), [E, N] = a.useState(null), [I, D] = a.useState({
      top: 0,
      bottom: 0,
      left: 0,
      right: 0
      ...
      x: 0,
      y: 0
    }), [A, k] = a.useState(!1), T = "image/gif" === t.type;
    a.useEffect(() => {
      (0, c.Z)()
    }, []);
    let M = a.useCallback(() => {
...
function x(e, t) {
  let {
    width: r,
    height: n
  } = b(e, t), a = Math.abs(400 - r) / 2, s = Math.abs(400 - n) / 2;
  return {
    top: s,
    bottom: -s,
    left: -a,
