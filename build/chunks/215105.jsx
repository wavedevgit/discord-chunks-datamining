...
function N(e) {
  ...
  return <l.V ref={U} onKeyDown={G}><div className={a()(I.container, Z, {
        [I.customProfileTheme]: null != D
      })}><d.ZP parentModalKey={E} emojiPickerCloseOnModalOuterClick={true} className={I.input} innerClassName={I.inputInner} editorClassName={I.editor} type={c.Ie.USER_PROFILE_REPLY} placeholder={v.intl.formatToPlainString(A(s), {
          username: p.ZP.getName(n, o, t)
        })} channel={T} textValue={L} richValue={M} onChange={(e, t, n) => {
          t !== L && (x(t), k(n))
        }} focused={j.current} onFocus={() => {
          j.current = true
        }} onSubmit={async e => {
          let {
            value: t
