...
class g extends Chunk73800.PureComponent {
  render() {
    ...
    return <Chunk600164.Z align={Chunk600164.Z.Align.CENTER} className={a()({
        selected: exports
      })}>{<m region={module} className={Chunk190010.regionSelectName} />}{exports ? <i className={Chunk190010.check} /> : null}</Chunk600164.Z>
  }
}
class E extends Chunk73800.PureComponent {
  ...
  render() {
    ...
    return <Chunk481060.nsm className={Chunk190010.root} label={Chunk388032.intl.string(Chunk388032.t.w8gMqq)} options={Chunk73800} value={require} onChange={this.handleChangeVoiceRegion} renderOption={this.renderOption} popoutProps={h} popoutClassName={Chunk190010.regionSelectPopout} />
  }
  constructor(...e) {
    super(...e), p(this, "renderOption", (e, t) => <g region={e.value} selected={t} />), p(this, "getSelectedRegion", () => {
      var e;
      let {
        regions: t,
        call: n
