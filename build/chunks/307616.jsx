...
class A extends Chunk73800.PureComponent {
  render() {
    ...
    return <exports><div className={a()(Chunk776022.layer, !require && Chunk776022.inactive)}>{module({
...
function P() {
  let e = N(),
    ...
    o = (0, Chunk724723.q)("Modals"),
    a = Chunk73800.useRef(true);
  Chunk73800.useLayoutEffect(() => {
    a.current = exports[exports.length - 1]
  }, [exports]);
  ...
  return <Chunk215569.W component={Chunk73800.Fragment}>{S.map((e, n) => {
      var i;
      let a = l().findLast(t, t => t.Layer === e || null == t.Layer && e === p.ZP),
        s = null != (i = null == a ? true : a.backdropStyle) ? i : d.fCB.DARK;
      return o && (0, d.OLG)(s) ? <e><d.ZMr variant={s === d.fCB.LIGHTBOX || s === d.fCB.IMMERSIVE ? "lightbox" : "default"} animationVariant={(null == a ? true : a.instant) ? "instant" : "default"} isVisible={E[n]} onClick={f} /></e> : <u.Z isVisible={E[n]} backdropStyle={s} onClose={f} LayerComponent={e} backdropInstant={null == a ? true : a.instant} />
    })}{require.map((e, t) => {
      let {
        key: i,
        Layer: o,
      ...
      return <A modalKey={i} LayerComponent={null != o ? o : p.ZP} isVisible={l} isTopModal={t === n.length - 1} render={a} closeModal={h} instant={s} />
    })}</Chunk215569.W>
}