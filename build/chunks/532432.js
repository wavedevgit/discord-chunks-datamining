...
function j(e) {
  let {
    ...
    forcedDivider: I,
    withHighlight: N = !1
  } = e, y = N ? o.gtL : o.zxk, A = (0, u.T)({
    location: "AvatarSection"
  }), P = [];
  A && P.push(a.z.RECENT_AVATARS_SETTINGS_PROFILE_PAGE_NEW_BADGE);
  let [R, D] = (0, c.US)(P), Z = R === a.z.RECENT_AVATARS_SETTINGS_PROFILE_PAGE_NEW_BADGE, w = (0, m._)(), {
    recentAvatarsLimit: k
  } = (0, d.pC)(w), L = r.useCallback(() => {
    D(f.L.TAKE_ACTION), (0, p.$r)(b.pC.AVATAR, O, T, T ? E : void 0)
  }, [O, T, D]);
  return (0, i.jsx)(h.Z, {
    className: S,
    title: j,
    titleIcon: Z ? (0, i.jsx)(g.Z, {
      className: x.newBadge
    }) : void 0,
    description: A ? _.intl.format(_.t.U4tZfX, {
      recentAvatarsLimit: k,
      onClick: L
    }) : void 0,
    errors: n,
