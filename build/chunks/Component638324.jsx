...
function I(e) {
  let {
    ingress: t,
    guildId: n
  } = e, I = (0, A.q9)(), N = (0, m.K)(), y = g.$s.useSetting().includes(n), v = (0, o.uM)(), j = g.YX.useSetting(), P = g.Zr.useSetting().includes(n), R = i.useCallback(e => {
    let r = (0, _.xo)();
  ...
  return (0, r.jsx)(f.h, {
    ...
    children: "0" === n ? (0, r.jsx)(b.Ay, {
      ...
      disabled: N || v,
      tooltipText: v ? S.intl.string(T.default["6Af/cw"]) : true,
