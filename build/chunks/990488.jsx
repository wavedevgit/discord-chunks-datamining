...
function v(e) {
  let {
    ...
    switch (e.field_type) {
      case o.QJ.TERMS:
        return <h.dd channelId={a} formField={e} onChange={(e, n) => c(t, n)} />;
      case o.QJ.TEXT_INPUT:
        return <x.zY formField={e} autofocus={0 === t} onChange={e => u(t, e)} />;
      case o.QJ.PARAGRAPH:
        return <m.lX formField={e} autofocus={0 === t} onChange={e => u(t, e)} />;
      case o.QJ.MULTIPLE_CHOICE:
        return <d.sp formField={e} onChange={e => f(t, e)} />
    }
  };
  return <r.Fragment>{n.map((e, t) => p(e, t))}</r.Fragment>
}
...
function j(e) {
  ...
  return (t = m === p.sFg.NONE ? null : m === p.sFg.VERY_HIGH ? f.l : u.b, null == d) ? null : <r.Fragment>{!o && null != t && <t />}{<v guildId={n} formFields={i} updateFormFields={s} />}</r.Fragment>
}
...
function C(e) {
  ...
  let j = i.useRef(b);
  return null == m ? null : <r.Fragment>{!d && !j.current && null != t && <t isUserVerified={b} />}{<v guildId={n} formFields={s} updateFormFields={o} />}</r.Fragment>
}