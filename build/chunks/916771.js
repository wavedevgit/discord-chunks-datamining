...
function h(e) {
  ...
  }), v = null === (t = (0, a.hp)(null != m ? m : a.u.STREAM_FAILED_TO_START)) || void 0 === t ? void 0 : t.errorCode;
  return (0, r.jsx)(d.Z, {
    artURL: p,
    ...
    noArt: E,
    selected: g,
    description: _.NW.format(_.t.sXsgsL, {
      helpUrl: u.Z.getArticleURL(f.BhN.STREAM_FAILED)
    }),
    errorCodeMessage: b ? _.NW.formatToPlainString(_.t["ejOT9/"], {
      errorCode: v
    }) : void 0,
    onCTAClick: () => {
