...
let b = function(e) {
  ...
  return <o.v2r navId={"member-application-context-menu"} onClose={i.Zy} aria-label={u.intl.string(u.t.liqwPD)} onSelect={d}><o.kSQ>{O && <o.sNh id={"ban"} label={u.intl.string(u.t["I+Cbur"])} icon={o.pgN} color={"danger"} action={() => (0, o.ZDy)(async () => {
          let {
            default: e
        ...
        })} />}{<o.sNh id={"copyUserId"} label={"Copy User ID"} icon={o.VuL} action={() => (0, l.JG)(p.id)} />}</o.kSQ></o.v2r>
}