...
function C(e) {
  ...
  return <d.J validation={Z} disabled={k} helperText={j} successMessage={U} characterCount={B && D ? null != (t = null == n ? true : n.length) ? t : 0 : true} characterCountMaxLength={B && L ? b : true}>{<l.t><textarea{...y(E({
        ...
        onChange: W
      })} /></l.t>}{null != g && <u.n id={T}>{p.intl.format(p.t["bmQU//"], {
        minLength: g
      })}</u.n>}{null != b && <u.n id={S}>{p.intl.format(p.t["+DFxLS"], {
        maxLength: b
      })}</u.n>}{!B && D ? <R value={n} maxLength={b} hasError={Z.hasError} /> : null}{B || D || false === L ? null : <P value={n} maxLength={b} />}</d.J>
}
...
function R(e) {
  ...
  return <div className={a()(h.maxLength, {
      [h.errorOverflow]: o
    })} aria-hidden={"true"}>{null != (t = null == n ? true : n.length) ? t : 0}{" "}{null != i && "/ ".concat(i)}</div>
}
...
function P(e) {
  ...
  return null == o ? null : <div className={a()(h.maxLength, {
      [h.errorOverflow]: o < 0
