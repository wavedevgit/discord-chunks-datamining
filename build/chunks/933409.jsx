...
function N(e, t, N, _, A) {
  ...
  let D = (0, r.e7)([O.Z], () => O.Z.getGuild(t), [t]),
    ...
    K = (0, c.Z)(t, e.id),
    W = null != F && null != N && h.Z.canWithPartialContext(y.Plq.VIEW_CHANNEL, {
      channelId: F
    }) && !w ? [(!B || B && !G) && h.Z.canWithPartialContext(y.Plq.MUTE_MEMBERS, {
      channelId: N
    }) ? <o.S89 id={"voice-mute"} label={M.intl.string(M.t.e9e9UV)} checked={q} color={"danger"} action={() => {
        false === q && Q(f.jQ.MUTE), s.Z.setServerMute(t, e.id, !q)
      }} /> : null, (!B || B && !G) && h.Z.canWithPartialContext(y.Plq.DEAFEN_MEMBERS, {
      channelId: N
    }) ? <o.S89 id={"voice-deafen"} label={M.intl.string(M.t.hMA2GB)} checked={V} color={"danger"} action={() => s.Z.setServerDeaf(t, e.id, !V)} /> : null, !L && null != D && h.Z.canWithPartialContext(y.Plq.MOVE_MEMBERS, {
      channelId: N
    }) ? <o.sNh id={"voice-disconnect"} label={L ? M.intl.string(M.t["6vrfgo"]) : M.intl.string(M.t["/jERiI"])} color={"danger"} action={() => s.Z.setChannel(t, e.id, null)} /> : null] : [],
    J = async (t, n, l) => {
  ...
  if (!L && null != D && null != Y && null != Y.joinedAt && (z || $) && D.features.has(y.oNc.GUILD_ONBOARDING_EVER_ENABLED)) {
    var ee;
    X = (0, v.yE)(null != (ee = Y.flags) ? ee : 0, C.q.BYPASSES_VERIFICATION) ? <o.sNh id={"verify"} label={M.intl.string(M.t.NbhSIy)} action={() => {
        var t;
        return s.Z.setMemberFlags(D.id, e.id, (0, v.mB)(null != (t = Y.flags) ? t : 0, C.q.BYPASSES_VERIFICATION, false))
      }} /> : <o.sNh id={"verify"} label={M.intl.string(M.t["6QlTeH"])} action={() => {
        var t;
        return s.Z.setMemberFlags(D.id, e.id, (0, v.mB)(null != (t = Y.flags) ? t : 0, C.q.BYPASSES_VERIFICATION, true))
      }} />
  }
  return [H, ...W, ...L || null == D ? [] : [X, K && !w ? R ? <o.sNh id={"removetimeout"} label={M.intl.formatToPlainString(M.t.csKetb, {
      user: e.username
    })} color={"danger"} action={() => {
      (0, d.q)({
        guildId: t,
    ...
    }} /> : <o.sNh id={"timeout"} label={M.intl.formatToPlainString(M.t.OhsOy8, {
      user: e.username
    })} color={"danger"} action={n => {
    ...
    }} /> : null, (0, Z.BK)(e, D) ? <o.sNh id={"kick"} label={M.intl.formatToPlainString(M.t["9l/iTU"], {
      user: e.username
    })} color={"danger"} action={() => (0, o.ZDy)(async () => {
      let {
        default: i
    ...
    })} /> : null, (0, Z.mm)(e, D) ? <o.sNh id={"ban"} label={M.intl.formatToPlainString(M.t.WnpUBg, {
      user: e.username
    })} color={"danger"} action={() => (0, o.ZDy)(async () => {
      let {
        default: i
