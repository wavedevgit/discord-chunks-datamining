...
let A = new Chunk451988.Ep,
  g = new Chunk451988.Ep;
class m extends Chunk272355.A {
  ...
  handleIdleUpdate() {
    ...
    for (let e of (A.stop(), g.stop(), s.A.getAllActiveStreams()))
    ...
    null == r || r.isGuildStageVoice() || A.start(e + n.afkTimeout * p.A.Millis.SECOND - Date.now(), () => {
