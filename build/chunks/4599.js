...
function g(e) {
  ...
  } = e, M = t === b.ME ? void 0 : t, w = (0, c.e7)([s.Z], () => s.Z.isBlocked(n.id)), {
    analyticsLocations: L
  } = (0, d.ZP)([...S, w ? r.Z.BLOCKED_PROFILE_MODAL : r.Z.IGNORED_PROFILE_MODAL]), D = (0, p.ZB)({
    layout: "MODAL",
    userId: n.id,
    guildId: M,
    channelId: g,
  ...
  }], R = (0, _.ZP)(n.id, E ? M : void 0), k = u.ZP.getName(null == R ? void 0 : R.guildId, g, n), G = v.intl.formatToPlainString(v.t.KRe1Fh, {
    name: k
  });
  return (0, o.jsx)(d.Gt, {
    value: L,
