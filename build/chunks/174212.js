...
function g(e) {
  ...
  if (null != l && f.delete(l), f.set(n, {
      ...
      query: i,
      name: a
    }), p.set(n, new Date), o.optionNameToNonce.set(a, n), o.lastErrored) return o.lastErrored = !1, !0
}
let E = (0, l.isDesktop)();
...
function b(e) {
  ...
  }), p.delete(a), null == (n = d.optionNameToAutocompleteQueries.get(l.name)) || n.set(l.query, m), d.optionNameToLastQuery.get(l.name) === l.query && (d.lastErrored = !1, d.optionNameToLastResults.set(l.name, m)), d.lastResponseNonce = a, !0
}
