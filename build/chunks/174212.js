...
function g(e) {
  ...
  if (null != l && f.delete(l), f.set(n, {
      ...
      query: i,
      name: o
    }), p.set(n, new Date), a.optionNameToNonce.set(o, n), a.lastErrored) return a.lastErrored = !1, !0
}
let E = (0, l.isDesktop)();
...
function b(e) {
  ...
  }), p.delete(o), null == (n = d.optionNameToAutocompleteQueries.get(l.name)) || n.set(l.query, m), d.optionNameToLastQuery.get(l.name) === l.query && (d.lastErrored = !1, d.optionNameToLastResults.set(l.name, m)), d.lastResponseNonce = o, !0
}
...
function y(e) {
  ...
  return (0, s.yw)(u.rMx.APPLICATION_COMMAND_OPTION_STRING_AUTOCOMPLETE_PERFORMANCE, {
    duration_ms: i,
    error: !0
  }), p.delete(t), h(n.channelId).lastErrored = !0, !0
}
