...
function U(e) {
  ...
  return null != t ? M(t.id) : f.G6.getSetting()
}
...
function G(e) {
  ...
  switch (e.type) {
    case v.IIU.LISTENING:
      ...
      returnfalse;
    case v.IIU.PLAYING:
      return null != e.application_id ? M(e.application_id) : U(e.name);
...
function Z() {
  ...
  x !== Chunk348327 && (x = Chunk348327), exports && (j = k(L = s()([...N, ...D.filter(e => e.type !== v.IIU.CUSTOM_STATUS)].sort(Chunk158776.f)).uniqBy(e => "".concat(e.type, ":").concat(e.application_id, ":").concat(e.name)).value()))
}
