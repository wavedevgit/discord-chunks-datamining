...
function eM(e) {
  ...
  n.append("build_id", "d5a90118ea6dd9cedaa62acad0aa731c409e6060"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
