...
function eM(e) {
  ...
  n.append("build_id", "8ff7e40aee210cfe135104715d989cb2509dd03b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
