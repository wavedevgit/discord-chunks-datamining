...
function eM(e) {
  ...
  n.append("build_id", "1d6b7bfbeaf1cd680d23a7398f1861480cf9311f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
