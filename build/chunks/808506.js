...
function ek(e) {
  ...
  n.append("build_id", "c6526b28da1886cf913611728852c83a9333e373"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
