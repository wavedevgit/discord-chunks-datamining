...
function eM(e) {
  ...
  n.append("build_id", "f91641c264989826521a9464eead6b458a1eec53"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
