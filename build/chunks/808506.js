...
function eM(e) {
  ...
  n.append("build_id", "b3602af0447f18eb06c50143f45306714a48436c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
