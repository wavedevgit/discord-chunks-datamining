...
function ek(e) {
  ...
  n.append("build_id", "31588a250c67a962b6833f242bdfcc6f58c0f144"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
