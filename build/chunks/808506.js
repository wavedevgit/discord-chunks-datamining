...
function ek(e) {
  ...
  n.append("build_id", "51403e08412caa52f93bf4093220f6e0728e896a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
