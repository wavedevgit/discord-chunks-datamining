...
function ek(e) {
  ...
  n.append("build_id", "2de7c3e71e98680911d6e80612a3d95f6bfed79f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
