...
function ex(e) {
  ...
  n.append("build_id", "0ae6ce32202f0a237ce7839625e54811fd4fb73c"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
