...
function eM(e) {
  ...
  n.append("build_id", "27e730db5f5f71890895cea7a0f0f261a4b4ec3b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
