...
function eM(e) {
  ...
  n.append("build_id", "2149cf400895a05f7fba73428e2745459585b0d1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
