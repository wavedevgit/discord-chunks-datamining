...
function ek(e) {
  ...
  n.append("build_id", "a7c4cc2b7dee15c3fc96da619510394f896bd919"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
