...
function eM(e) {
  ...
  n.append("build_id", "8b21c4246953730675fb52a19d47f45661c442a1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
