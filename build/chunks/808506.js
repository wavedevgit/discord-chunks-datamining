...
function eM(e) {
  ...
  n.append("build_id", "9fbad4df8e36d968107dbc299d90aead7e79befe"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
