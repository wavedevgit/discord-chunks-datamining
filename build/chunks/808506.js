...
function ek(e) {
  ...
  n.append("build_id", "9a9b28e521366cb3beae08bbe0c85cdc3c259c3a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
