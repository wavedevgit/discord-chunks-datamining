...
function ex(e) {
  ...
  n.append("build_id", "c7e4f4351222071f21a7fd2e52b1a3b76a12a52c"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
