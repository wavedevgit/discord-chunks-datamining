...
function ek(e) {
  ...
  n.append("build_id", "44246edc6f7a07603e5736026d53072f3f4d1d5b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
