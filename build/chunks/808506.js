...
function ek(e) {
  ...
  n.append("build_id", "cbecfa298e1f662cb2200a141c87a982eb69cf0e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
