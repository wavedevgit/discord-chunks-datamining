...
function eM(e) {
  ...
  n.append("build_id", "594512045ea049bf60dbee5f0d9b35187fc1b412"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
