...
function ek(e) {
  ...
  n.append("build_id", "fd1547f89ab4d4dfe117fb0acb636478e53e8348"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
