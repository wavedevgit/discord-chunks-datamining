...
function eM(e) {
  ...
  n.append("build_id", "bcdcb489f223ef11bc26dc28fb34fbe77f2ceb77"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
