...
function ek(e) {
  ...
  n.append("build_id", "055b0de2d89d833a3b9706fc82dd975a4f9486ac"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
