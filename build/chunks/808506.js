...
function eM(e) {
  ...
  n.append("build_id", "2583fb381ae170fa9fc709f852018ca579f03b93"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
