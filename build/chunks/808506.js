...
function eM(e) {
  ...
  n.append("build_id", "f9da0b4705edfaae7744ed5406f44888b3208678"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
