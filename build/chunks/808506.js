...
function eM(e) {
  ...
  n.append("build_id", "9dfdb0f4f0da20024c3c91702b4435aca8239ad2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
