...
function ek(e) {
  ...
  n.append("build_id", "be031bde87baab988d256ebcf4fbf3ffc0eec6c3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
