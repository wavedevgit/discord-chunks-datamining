...
function eM(e) {
  ...
  n.append("build_id", "8cbce2b8ccfacb32a1e08b38836ac1e20c9b5689"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
