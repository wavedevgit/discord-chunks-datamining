...
function eM(e) {
  ...
  n.append("build_id", "f62b24a2f1156af5d88d52db89dac0be07c2e9f2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
