...
function eM(e) {
  ...
  n.append("build_id", "00eb1f7a038ff56135819007e1ded11e8c5457e3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
