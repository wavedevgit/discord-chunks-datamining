...
function ex(e) {
  ...
  n.append("build_id", "5703daea85d7d434487157e666c840e14b0a7a46"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
