...
function ek(e) {
  ...
  n.append("build_id", "a29a903cd316af47c583922bfa005be760a45b20"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
