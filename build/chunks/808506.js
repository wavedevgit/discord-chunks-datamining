...
function ek(e) {
  ...
  n.append("build_id", "daf2f39bcb3eaf670f248a2b45f7a407b86ef0ff"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
