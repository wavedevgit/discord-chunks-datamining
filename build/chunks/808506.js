...
function ek(e) {
  ...
  n.append("build_id", "0491910d0469a53710386e627543e81da2c8aded"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
