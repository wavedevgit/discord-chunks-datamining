...
function ek(e) {
  ...
  n.append("build_id", "9a8446f63e954828ba98c5a018d28b2c89c3b30f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
