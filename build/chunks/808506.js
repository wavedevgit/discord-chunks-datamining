...
function ek(e) {
  ...
  n.append("build_id", "49af62de23cb9542e0b526bd928e0486db669387"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
