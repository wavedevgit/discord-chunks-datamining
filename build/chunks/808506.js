...
function ek(e) {
  ...
  n.append("build_id", "90bfeb817d133ec1d68e273afbfa2174c06bf31c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
