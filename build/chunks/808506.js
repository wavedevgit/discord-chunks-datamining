...
function eM(e) {
  ...
  n.append("build_id", "392107d8a9508cd20597f15f9a65da4403cbe8b9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
