...
function eM(e) {
  ...
  n.append("build_id", "ad44b3cbe898eb25db2594de190fe9cfbbe691e3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
