...
function eM(e) {
  ...
  n.append("build_id", "e7fea2bbfdae9c3fa92316a03fc5b71a4d27d368"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
