...
function eM(e) {
  ...
  n.append("build_id", "a50de70fa444d55069f21d8f896dbebd85a1a295"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
