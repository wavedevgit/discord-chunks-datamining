...
function eM(e) {
  ...
  n.append("build_id", "f5eca42f42ffd520a424282848769c35ac637bfb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
