...
function ek(e) {
  ...
  n.append("build_id", "6ba77712597ef1911d86a9beabaf179f5ca7e500"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
