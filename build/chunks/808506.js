...
function ek(e) {
  ...
  n.append("build_id", "28bdf0de8db92200049d1bc144454efae797e4fd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
