...
function ex(e) {
  ...
  n.append("build_id", "d7e27417cd10f98b010ac8c5424f0dfbef382431"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
