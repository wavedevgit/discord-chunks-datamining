...
function eM(e) {
  ...
  n.append("build_id", "9c9469c7333a7ef336a3448541ce0175ebae340f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
