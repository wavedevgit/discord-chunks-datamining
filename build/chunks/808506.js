...
function ek(e) {
  ...
  n.append("build_id", "890f660076be2d276d1330333befb8b74d48714d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
