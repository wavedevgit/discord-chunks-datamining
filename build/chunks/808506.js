...
function ex(e) {
  ...
  n.append("build_id", "e6b5a222cd6db4bddb5b51872c51bf7f633c4595"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
