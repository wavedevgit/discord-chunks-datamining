...
function eM(e) {
  ...
  n.append("build_id", "f10fef9fa7db7722612dccb79397495ef6b39f2d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
