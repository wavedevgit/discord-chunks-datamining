...
function eM(e) {
  ...
  n.append("build_id", "92da37b3bfd4e1cfeb01893450de8b6d55d87d4a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
