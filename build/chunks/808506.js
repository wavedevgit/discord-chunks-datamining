...
function eM(e) {
  ...
  n.append("build_id", "db916530d85d67aad0221a51e397c62b0455fcf1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
