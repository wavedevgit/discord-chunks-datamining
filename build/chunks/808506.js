...
function ek(e) {
  ...
  n.append("build_id", "bc5f11f0b67801b0543ad5831eb4b2ee07d6aaf4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
