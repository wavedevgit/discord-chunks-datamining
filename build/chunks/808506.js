...
function ex(e) {
  ...
  n.append("build_id", "514e28d5f8179125ab36c45826bd26a5a5d8f125"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
