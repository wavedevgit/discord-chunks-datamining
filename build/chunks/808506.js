...
function ex(e) {
  ...
  n.append("build_id", "3311818e3e225fb21842199ec9d842df3bbfec20"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
