...
function ek(e) {
  ...
  n.append("build_id", "5d374ece8e503f4f65f600385b10a123acdd3dfb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
