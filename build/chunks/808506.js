...
function eM(e) {
  ...
  n.append("build_id", "e6966834f1340c461a6e8c9995c5c16ba0f64317"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
