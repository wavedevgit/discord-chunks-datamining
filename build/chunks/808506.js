...
function eM(e) {
  ...
  n.append("build_id", "6e9f603faa92a496023e2e272449605184626e9b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
