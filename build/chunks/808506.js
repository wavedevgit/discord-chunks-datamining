...
function ek(e) {
  ...
  n.append("build_id", "6683cdf5e7fb8fbcce4975017c490c9ce65b5741"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
