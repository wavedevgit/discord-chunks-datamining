...
function ek(e) {
  ...
  n.append("build_id", "a6234cd026fbad104b3cbdfeb657dc32760ab7a3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
