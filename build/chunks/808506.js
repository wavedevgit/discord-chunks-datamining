...
function eM(e) {
  ...
  n.append("build_id", "d18b515e44ad0aa18bd645aded01d518214450db"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
