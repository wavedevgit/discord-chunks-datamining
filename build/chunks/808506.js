...
function eM(e) {
  ...
  n.append("build_id", "889f3b2670feee77fa0e1326ad6c42b4385ae430"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
