...
function eM(e) {
  ...
  n.append("build_id", "01f0d1523eb2c3b13a5d28f9351dba9ad5941a1e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
