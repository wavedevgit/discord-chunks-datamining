...
function ex(e) {
  ...
  n.append("build_id", "2dc85cda33ee956077bdf82ef55126607e0bc873"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
