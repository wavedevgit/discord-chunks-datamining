...
function ex(e) {
  ...
  n.append("build_id", "d365bbfc85b85800c7a0be2bbac1ce2a83db660a"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
