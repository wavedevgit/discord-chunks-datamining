...
function eM(e) {
  ...
  n.append("build_id", "75504d725620279c0cc5a70a81fcbb334ceb62a6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
