...
function ex(e) {
  ...
  n.append("build_id", "1093775492d275105c06d28ac8ab6eeb127eb2db"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
