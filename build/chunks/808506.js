...
function ek(e) {
  ...
  n.append("build_id", "0bfcf71cfc2d7399eb827e9e76ea5417680f6248"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
