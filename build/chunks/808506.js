...
function ek(e) {
  ...
  n.append("build_id", "0f37a80064100263e1591cd6ea872d8e0ec75aff"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
