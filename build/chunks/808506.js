...
function eM(e) {
  ...
  n.append("build_id", "991a14b6662be0a68f657dba599935688505b8e5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
