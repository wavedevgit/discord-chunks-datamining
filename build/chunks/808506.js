...
function eM(e) {
  ...
  n.append("build_id", "f51ff503a2e8218f308198cc08eab218cb070d7d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
