...
function ex(e) {
  ...
  n.append("build_id", "614216a258884a06a65286f1b80e44a46bb1a383"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
