...
function ex(e) {
  ...
  n.append("build_id", "d9d7329530c55c8d0d9f8b4963d5f66505265c27"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
