...
function eM(e) {
  ...
  n.append("build_id", "d6669ba7268285e81de5bf8f2260aedbe522cf2a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
