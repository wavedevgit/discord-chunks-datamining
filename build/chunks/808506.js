...
function eM(e) {
  ...
  n.append("build_id", "d18a0744af0377557ca4783de3406079782768fb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
