...
function ek(e) {
  ...
  n.append("build_id", "e1700c7613b2e8be56fe57d44c13474ed25fd928"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
