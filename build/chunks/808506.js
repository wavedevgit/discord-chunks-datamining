...
function ek(e) {
  ...
  n.append("build_id", "28c2ad310f5466edf3000581c15729e4f67d381c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
