...
function ek(e) {
  ...
  n.append("build_id", "824a0b44e776de7e583087aa06755cf48ee84f6c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
