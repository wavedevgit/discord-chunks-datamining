...
function ek(e) {
  ...
  n.append("build_id", "6d3bcd439772a47d83eabeff9192e898fa4a43ca"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
