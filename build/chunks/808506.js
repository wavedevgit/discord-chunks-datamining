...
function ex(e) {
  ...
  n.append("build_id", "4d1fc247e87160e6c874c44f449336af408c69b5"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
