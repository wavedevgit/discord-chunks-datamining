...
function ek(e) {
  ...
  n.append("build_id", "08719087de35b6c53f3e74eb0439c9fa09cf3426"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
