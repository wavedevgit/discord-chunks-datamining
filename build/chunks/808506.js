...
function ex(e) {
  ...
  n.append("build_id", "a40853777381d71c07e05a5391af7d2ed8b6098d"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
