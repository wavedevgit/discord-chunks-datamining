...
function ek(e) {
  ...
  n.append("build_id", "2a8739104d7a014c771d37139b43970f64c9beb5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
