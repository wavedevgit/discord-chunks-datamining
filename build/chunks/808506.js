...
function eM(e) {
  ...
  n.append("build_id", "d3602f521277cd01d4d4ef3e859c43151b5ae44c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
