...
function ek(e) {
  ...
  n.append("build_id", "794f1a2f7a06dda91ef2ed10b5912262ce70dc7f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
