...
function ex(e) {
  ...
  n.append("build_id", "912b2f2e780b13850d5a69cd8d9998ba343b7de7"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
