...
function ex(e) {
  ...
  n.append("build_id", "59e91bd7004cdb716ae0054c15767f8dc0314f31"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
