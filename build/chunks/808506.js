...
function eM(e) {
  ...
  n.append("build_id", "a4a946477aa3b2e8c444894dba01d81733ba073c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
