...
function eM(e) {
  ...
  n.append("build_id", "be907c3d026e400a2ab3223e08e04c8edf86755c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
