...
function ex(e) {
  ...
  n.append("build_id", "f2d2c0aa728ce4e07159f0d1af72cc8ae01e5ee9"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
