...
function eM(e) {
  ...
  n.append("build_id", "f18c890e6fe4c97d348600a9f2831763ab4d21b8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
