...
function eM(e) {
  ...
  n.append("build_id", "2c5436893cbafc778b6677db1aead88b1bebc6e7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
