...
function eM(e) {
  ...
  n.append("build_id", "2639d9b86c349fa176f952176fd8dccb7b0ba835"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
