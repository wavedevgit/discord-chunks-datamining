...
function ek(e) {
  ...
  n.append("build_id", "2817634afe3bdb856facd46d997357994fb8d483"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
