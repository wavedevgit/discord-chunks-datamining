...
function ek(e) {
  ...
  n.append("build_id", "f925ebd9d5277654ded368879963c6351ccce1da"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
