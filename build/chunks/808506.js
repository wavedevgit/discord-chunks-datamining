...
function ek(e) {
  ...
  n.append("build_id", "268002174b6c37abc3bc7f4aca6cfbaf9f598d1e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
