...
function ek(e) {
  ...
  n.append("build_id", "eb3b9107277e1ddb0659b8c3cfe7d4c9a701c165"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
