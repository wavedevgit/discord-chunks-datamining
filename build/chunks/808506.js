...
function eM(e) {
  ...
  n.append("build_id", "8ac11d5fe015090b84c7aa020b434cd2e313e5f9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
