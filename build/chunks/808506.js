...
function ek(e) {
  ...
  n.append("build_id", "8975974f3184d3bcb4ac6e182b1cd2da3d1dd120"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
