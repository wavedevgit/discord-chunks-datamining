...
function ek(e) {
  ...
  n.append("build_id", "c1bff70781dbf016d292526eccaf1ed6291ca535"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
