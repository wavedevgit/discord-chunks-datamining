...
function ek(e) {
  ...
  n.append("build_id", "55c8eb77bd18d85989b946b80a0867bdb9082e85"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
