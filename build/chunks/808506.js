...
function ek(e) {
  ...
  n.append("build_id", "8b9a34268f4d4dfa865c7581ea023bb603e8ee98"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
