...
function ek(e) {
  ...
  n.append("build_id", "19a7e2354c70122dd1bba982ab563c9539afe600"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
