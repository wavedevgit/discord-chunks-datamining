...
function eM(e) {
  ...
  n.append("build_id", "655771ef4253dd65bfe6ce5a6f3422b969de8e7a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
