...
function ek(e) {
  ...
  n.append("build_id", "bb3173c24ce5a1f1c27c81ba2159db4daa3b7157"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
