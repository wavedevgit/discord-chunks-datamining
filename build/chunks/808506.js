...
function eM(e) {
  ...
  n.append("build_id", "ef856223c79df73b99e692f914406addd2e68e53"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
