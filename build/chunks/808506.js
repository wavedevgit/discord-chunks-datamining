...
function ek(e) {
  ...
  n.append("build_id", "5c674a5772c64662e5e1ad3fa797af55e07943e9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
