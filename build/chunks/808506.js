...
function ek(e) {
  ...
  n.append("build_id", "6321eb8d2ab9bf6e6d087d964d2de4fb2a6a3a8c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
