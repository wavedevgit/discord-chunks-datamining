...
function eM(e) {
  ...
  n.append("build_id", "ac1c8a39cf88eebc3581d7ec237fe90e719b1bc4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
