...
function eM(e) {
  ...
  n.append("build_id", "c9acedfe0a7317fc4839c9e57d7e4966ec81eafe"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
