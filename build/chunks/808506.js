...
function eM(e) {
  ...
  n.append("build_id", "601dbbbeaa0acb851b0271b14e41fdffdfa3980a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
