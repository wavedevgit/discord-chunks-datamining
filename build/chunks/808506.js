...
function ek(e) {
  ...
  n.append("build_id", "f3ace7bb170280add076248d7b980f66034cb287"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
