...
function eM(e) {
  ...
  n.append("build_id", "e4d58094bb945f068605f39af43f701105a062a0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
