...
function eM(e) {
  ...
  n.append("build_id", "27dccc214113ebd0ecc35da393fadea9c980ed85"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
