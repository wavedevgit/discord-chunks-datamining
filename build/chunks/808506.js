...
function ek(e) {
  ...
  n.append("build_id", "043bf33a41db2f9e9c2a1dcfffcbe52115061328"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
