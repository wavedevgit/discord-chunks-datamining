...
function ex(e) {
  ...
  n.append("build_id", "efb0aa8f6bc53484a1f6e7cc2f770199302efe60"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
