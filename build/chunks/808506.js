...
function eM(e) {
  ...
  n.append("build_id", "66ce51176b882d2a9258cbe300c127c0ef151e92"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
