...
function eM(e) {
  ...
  n.append("build_id", "8889e8df60edd81911d0152fe6be5de8b625ddf1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
