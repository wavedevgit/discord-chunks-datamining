...
function ek(e) {
  ...
  n.append("build_id", "313fbd5e358f371e65054591c006baf81efc5c20"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
