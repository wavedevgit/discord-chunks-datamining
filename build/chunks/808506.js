...
function eM(e) {
  ...
  n.append("build_id", "209bcad5e2552db7903388206754902f057e7f40"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
