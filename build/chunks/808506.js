...
function eM(e) {
  ...
  n.append("build_id", "a948e1fa3477510782b9c85c12abdd0ae2798f0d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
