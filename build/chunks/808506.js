...
function eM(e) {
  ...
  n.append("build_id", "a2fe21f2bac6bff5d288c2770953c5602be917d6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
