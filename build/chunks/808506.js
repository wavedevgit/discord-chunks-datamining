...
function ex(e) {
  ...
  n.append("build_id", "d94bc728b85b180a5cad020241f34393c6789075"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
