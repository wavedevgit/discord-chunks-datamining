...
function eC(e) {
  switch (ea && eo.info("[app data received]", e), e.type) {
    case j.BmY.CONNECT:
      ...
      if (null == t) break;
      (0, d.te)(M.OVERLAY_LAYOUT_ID, R.Z.getDefaultLayout(M.OVERLAY_LAYOUT_ID), 0), Promise.all([(0, v.Z)(t, e.pid), o.ZP.PersistedStore.getAllStates()]).then(t => {
        let [n, r] = t, {
          pid: i,
          token: a
        } = e;
...
function eM(e) {
  ...
  n.append("build_id", "d3d216288f7de4592f40253a834aeb312dd5cb53"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
