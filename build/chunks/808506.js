...
function ek(e) {
  ...
  n.append("build_id", "a8fbdf558dcb42690412d4df9840ef16a2ddf594"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
