...
function ek(e) {
  ...
  n.append("build_id", "71d875f6d39119aab1721ecb7494e986ac6180b0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
