...
function eM(e) {
  ...
  n.append("build_id", "2b802cb48e4d8489c69d3381f13c31150f732833"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
