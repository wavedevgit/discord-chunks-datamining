...
function eM(e) {
  ...
  n.append("build_id", "4ee74453d802d0d880033f1873b966536a20f497"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
