...
function ek(e) {
  ...
  n.append("build_id", "03117ffe7a641c128d4ec1f5bd5a990cf4b77cb4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
