...
function ex(e) {
  ...
  n.append("build_id", "fbc4341d958085f644a14f6fbead06b855b516d5"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
