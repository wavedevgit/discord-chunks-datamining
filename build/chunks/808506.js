...
function ek(e) {
  ...
  n.append("build_id", "4b7a13f73921295c3cd421dcf23ae50d33b74cd2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
