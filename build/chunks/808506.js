...
function ek(e) {
  ...
  n.append("build_id", "42f2c26481e17ec0e5ce252492fd4842b875ebed"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
