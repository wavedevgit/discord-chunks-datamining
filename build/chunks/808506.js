...
function eM(e) {
  ...
  n.append("build_id", "bdd6986fe2defcea034f29df5c60bf67751da02a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
