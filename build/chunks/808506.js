...
function eM(e) {
  ...
  n.append("build_id", "57678551448ceb50a36154a0472018f8df8611b4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
