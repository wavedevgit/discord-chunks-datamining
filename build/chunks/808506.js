...
function ek(e) {
  ...
  n.append("build_id", "1198fd97dc2858f5bc5a56506d5d350124d1b534"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
