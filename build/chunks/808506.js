...
function ek(e) {
  ...
  n.append("build_id", "ae92649bf8b57553002589add557ec2532cd4832"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
