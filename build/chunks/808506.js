...
function eM(e) {
  ...
  n.append("build_id", "ffebb23f0cd2cd5d08813f8730f948df0ab40d8f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
