...
function eM(e) {
  ...
  n.append("build_id", "d4931d5a4181b4ab650d7c3f425615904fb39755"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
