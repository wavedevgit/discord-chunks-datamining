...
function eM(e) {
  ...
  n.append("build_id", "bc49fccb0f8025518885e4a3c157affa5f35f5d2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
