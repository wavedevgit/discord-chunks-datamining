...
function ex(e) {
  ...
  n.append("build_id", "8d50553d5c78b8903272f251394b57261bc7ecff"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
