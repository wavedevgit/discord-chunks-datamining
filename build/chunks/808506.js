...
async function eb(e) {
  ...
  if (ea.verbose("updateIntendedOverlayPIDs", {
      ...
      action: e
    }), ef.isMutexHeld() || ea.error("updateIntendedOverlayPIDs: overlayMutex is not held.", e), !Q && null != e) return void ea.verbose("updateIntendedOverlayPIDs: Connection is not opened while updating applications.", e);
  async function r(e) {
    if (!(e in H)) return;
    let t = H[e];
    delete H[e];
...
function eT(e, t, n) {
  ...
  ec(e, B({}, a)), (0, d.te)(x.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(x.OVERLAY_LAYOUT_ID), U.bv, {
...
function eC(e) {
  switch (eo && ea.info("[app data received]", e), e.type) {
    case M.BmY.CONNECT:
      ...
      if (null == t) break;
      (0, d.te)(x.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(x.OVERLAY_LAYOUT_ID), U.bv), Promise.all([(0, v.Z)(t, e.pid), a.ZP.PersistedStore.getAllStates()]).then(t => {
        let [n, r] = t, {
          pid: i,
          token: o
        } = e;
        g.lW({
          ...
          token: o,
          payloads: [n]
        }), eh(i, "READY"), (0, x.setPID)(i), f.Z.overlayReady(i);
        let a = el(i);
        ec(i, V(B({}, a), {
...
function ek(e) {
  ...
  n.append("build_id", "baaeae8b59e57b694c035973f9e10900b2eb7e10"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
