...
function eM(e) {
  ...
  n.append("build_id", "cf12ceaaecdbdf6ba4962835e9b9ceac6e828a2b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
