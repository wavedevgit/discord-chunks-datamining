...
function ex(e) {
  ...
  n.append("build_id", "8ee634745b4e33736dbeead6a9517076b3b6e7ed"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
