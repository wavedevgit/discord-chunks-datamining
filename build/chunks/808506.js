...
function eM(e) {
  ...
  n.append("build_id", "960e970766bb1597e1bf491f842ce075592b35c1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
