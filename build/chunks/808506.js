...
function eM(e) {
  ...
  n.append("build_id", "3afeacd1287941095eac92abe00d6273ea01108c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
