...
function ek(e) {
  ...
  n.append("build_id", "84174894ad3073a17fd2190257659858bdbeb1d5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
