...
function ex(e) {
  ...
  n.append("build_id", "c213be5a992cf14517cdae61065145f284326377"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
