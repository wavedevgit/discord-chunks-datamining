...
function eM(e) {
  ...
  n.append("build_id", "ab91ede5b22f90a59b6686dc18692a877e648f35"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
