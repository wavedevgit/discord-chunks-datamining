...
function ek(e) {
  ...
  n.append("build_id", "1ca028303f8096cf92e4da80a29a4df74bdeddd7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
