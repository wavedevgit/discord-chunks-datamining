...
function eM(e) {
  ...
  n.append("build_id", "44c75406a222030a5f116b36c48868aded155d0b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
