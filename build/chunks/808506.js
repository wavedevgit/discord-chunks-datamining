...
function ek(e) {
  ...
  n.append("build_id", "483d62de548a029dd5113d5e9c90bd97eb56e629"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
