...
function eM(e) {
  ...
  n.append("build_id", "c819a988cfe79f7aacb1f335f263cdafb327a1b4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
