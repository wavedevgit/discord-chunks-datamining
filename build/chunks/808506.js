...
function eM(e) {
  ...
  n.append("build_id", "e6ddc6146432aa0dcfcac2f62257ed14c4ded6b4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
