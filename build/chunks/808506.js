...
function eM(e) {
  ...
  n.append("build_id", "5de825622989bb3dde1ff8418ead8fefb72d5ce5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
