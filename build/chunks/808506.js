...
function eM(e) {
  ...
  n.append("build_id", "a57ecc8e4662078ba9d00d30dd9c52a8be4bb44b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
