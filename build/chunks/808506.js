...
function eM(e) {
  ...
  n.append("build_id", "487822a87d120b97314e702625b508c4c4bd9cd9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
