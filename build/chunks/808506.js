...
function eM(e) {
  ...
  n.append("build_id", "3f335bb382ce6e25a53eb1db9d6ec5bcaa5598e2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
