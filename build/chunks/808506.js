...
function eM(e) {
  ...
  n.append("build_id", "fec90a0e005413089e67c8460494051f1449537c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
