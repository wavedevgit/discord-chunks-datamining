...
function ek(e) {
  ...
  n.append("build_id", "6c9cced4b1025ba67d8095054b8ddb6740912a56"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
