...
function eM(e) {
  ...
  n.append("build_id", "010062e874cd10144cb2ac9cc99622e0af1664e9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
