...
function ek(e) {
  ...
  n.append("build_id", "98100d0d8c29dfadf5024ad1541d4ba57632c561"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
