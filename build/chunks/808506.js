...
function eM(e) {
  ...
  n.append("build_id", "ab462817a321d5c6d914fa1c6779261a8a14d9e0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
