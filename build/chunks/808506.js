...
function eM(e) {
  ...
  n.append("build_id", "feb068fd0b83b2351dff36964df46889e89d738b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
