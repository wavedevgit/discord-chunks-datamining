...
function ek(e) {
  ...
  n.append("build_id", "1b79b55d1d78a5e5aa6352d1634007df35d10bdb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
