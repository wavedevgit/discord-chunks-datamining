...
function eM(e) {
  ...
  n.append("build_id", "ed8d33be7257d35bf1f7b7ccbe083199791565bd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
