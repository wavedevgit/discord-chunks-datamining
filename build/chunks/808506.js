...
function ek(e) {
  ...
  n.append("build_id", "784a5841a8562b95061dfcdbd86903830a3e81c0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
