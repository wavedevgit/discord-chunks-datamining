...
function ek(e) {
  ...
  n.append("build_id", "a838f8d7fe69c8566568179a12d49dffdd592faa"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
