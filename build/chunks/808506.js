...
function ex(e) {
  ...
  n.append("build_id", "20c8074ef285e4cd9bfd8f95ec6a1caddb5b4c15"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
