...
function ek(e) {
  ...
  n.append("build_id", "b4fb5446905643921d414b9cecd8683991a78006"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
