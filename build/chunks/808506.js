...
function eM(e) {
  ...
  n.append("build_id", "5537d868a1cad3a42587798c97f927ee5a5e5567"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
