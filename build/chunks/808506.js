...
function ek(e) {
  ...
  n.append("build_id", "f608dd572a5ba300b7f6b782a77c8930a1035c2e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
