...
function eM(e) {
  ...
  n.append("build_id", "4eb9a9b7d7e9a18c148e3731278293c0595089c1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
