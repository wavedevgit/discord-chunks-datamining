...
function eM(e) {
  ...
  n.append("build_id", "cd1789aa1a430aa1b4f9868e9e25737250f28559"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
