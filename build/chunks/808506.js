...
function eM(e) {
  ...
  n.append("build_id", "c4e8101a5ecad72143ccf5fc93eeecc86b907383"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
