...
function ex(e) {
  ...
  n.append("build_id", "9f506a4102861ad28acc7c99f433617683f48975"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
