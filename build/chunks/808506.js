...
function eM(e) {
  ...
  n.append("build_id", "a99c808398490d5335a14a61965ce2c547e996e9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
