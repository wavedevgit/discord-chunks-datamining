...
function ex(e) {
  ...
  n.append("build_id", "e472d2051713f173ab236895074e4f57064be678"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
