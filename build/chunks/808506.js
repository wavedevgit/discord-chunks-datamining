...
function eM(e) {
  ...
  n.append("build_id", "037787904d10b9840d7ecb636decacace1f0eb7c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
