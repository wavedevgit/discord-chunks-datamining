...
function eM(e) {
  ...
  n.append("build_id", "783e64cab64fdeb0e564cf0e5aef06aaa34dad30"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
