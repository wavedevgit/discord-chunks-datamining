...
function ex(e) {
  ...
  n.append("build_id", "2d6def4ecf9fe654fdad3417fe7f3cc0ef35545a"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
