...
function ek(e) {
  ...
  n.append("build_id", "c02969051be70af79de18a1d81cf465e586cb7d1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
