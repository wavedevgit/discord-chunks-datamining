...
function eM(e) {
  ...
  n.append("build_id", "f670df522ec66728caa3c3561422d665c0f7d664"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
