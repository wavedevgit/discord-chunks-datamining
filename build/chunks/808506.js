...
function eM(e) {
  ...
  n.append("build_id", "33b0d90824979fa9a7747ee44700627e1ccb7233"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
