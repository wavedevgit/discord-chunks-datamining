...
function eM(e) {
  ...
  n.append("build_id", "caf99982d310781a11cda2327926a7ca0489c157"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
