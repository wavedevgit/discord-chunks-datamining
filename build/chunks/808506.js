...
function eM(e) {
  ...
  n.append("build_id", "499631c605253eedd346d7b8e69f5fb4fc4e22b4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
