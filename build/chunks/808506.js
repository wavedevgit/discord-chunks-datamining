...
function eM(e) {
  ...
  n.append("build_id", "892efef3fc92b23dfe1b2701a1fbd92368b7b5cd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
