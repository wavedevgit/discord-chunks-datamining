...
function eM(e) {
  ...
  n.append("build_id", "491bf1a25585618934090f5c3a8862a9e53d7160"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
