...
function ex(e) {
  ...
  n.append("build_id", "2857dd4152789831d7f93017dc90cfc9d5f3a70c"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
