...
function ex(e) {
  ...
  n.append("build_id", "043d809725e76f420f306a52e9083275dcfde0f0"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
