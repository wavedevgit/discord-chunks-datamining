...
function eM(e) {
  ...
  n.append("build_id", "43ef5e6bffa270a4326c428fab2c258018eff436"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
