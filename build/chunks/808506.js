...
function ek(e) {
  ...
  n.append("build_id", "a67d1618dbe3c86e9d2ca6f298f383afab93d6ee"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
