...
function eM(e) {
  ...
  n.append("build_id", "a524b76f1b6289d58793b17c9947fc6a6c502f41"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
