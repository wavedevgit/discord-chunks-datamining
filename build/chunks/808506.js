...
function ek(e) {
  ...
  n.append("build_id", "a5bd64d47cd131b8eb6f85cb544a21a32c857cca"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
