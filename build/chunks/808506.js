...
function ek(e) {
  ...
  n.append("build_id", "6cc7f428930b21873a887a003eca4b1d135c0993"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
