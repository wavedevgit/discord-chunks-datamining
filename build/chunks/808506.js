...
function eM(e) {
  ...
  n.append("build_id", "37b4e2c26acb01a885fe29e9318e81851bbdba5f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
