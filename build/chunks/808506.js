...
function ex(e) {
  ...
  n.append("build_id", "cc9add53ca62e3d5f03fe4442ff1079466eff543"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
