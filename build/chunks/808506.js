...
function eM(e) {
  ...
  n.append("build_id", "f931f544abfdda86d5a19ed20a2deaf3373e5a05"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
