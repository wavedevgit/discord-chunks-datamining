...
function ex(e) {
  ...
  n.append("build_id", "007564c757fd838432013bed647ebe8a8fa22d4a"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
