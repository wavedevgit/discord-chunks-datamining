...
function eM(e) {
  ...
  n.append("build_id", "78bf0151f964487bed8eb94bd83ac95f2125ca9d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
