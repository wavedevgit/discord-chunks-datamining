...
function eM(e) {
  ...
  n.append("build_id", "51fe8403cbb599abe2373a1d391572555ebea236"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
