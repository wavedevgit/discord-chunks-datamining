...
function eM(e) {
  ...
  n.append("build_id", "c1c01362e5ea6064c13b2a23cb296ca5aa5a9668"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
