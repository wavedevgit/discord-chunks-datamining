...
function ek(e) {
  ...
  n.append("build_id", "6001a47e79dead07a97f85e99ea4c1f9a1ebd838"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
