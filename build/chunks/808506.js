...
function eM(e) {
  ...
  n.append("build_id", "69bdfb68499f5dec03b3641628d6dcfc895200e1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
