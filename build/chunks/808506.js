...
function eM(e) {
  ...
  n.append("build_id", "3bc1d74568a0869379dcaaf934a464419d02442c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
