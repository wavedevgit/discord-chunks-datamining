...
function ek(e) {
  ...
  n.append("build_id", "29ac7d3e3ceee582972d9f81e22aac46bb7c193c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
