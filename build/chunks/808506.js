...
function ek(e) {
  ...
  n.append("build_id", "b68feffb0c3f5f12f431a44af544fa818314b1f2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
