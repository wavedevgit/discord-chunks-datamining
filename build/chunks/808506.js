...
function eM(e) {
  ...
  n.append("build_id", "6bb5cd55844c5f79b001f27f24d21097401d9302"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
