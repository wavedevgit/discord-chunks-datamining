...
function ek(e) {
  ...
  n.append("build_id", "170e6c24dc6225222b9f60ed6522789ff73180e4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
