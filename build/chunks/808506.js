...
function ek(e) {
  ...
  n.append("build_id", "c0fbe4875878c7b5b75d096db42008fde25cc292"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
