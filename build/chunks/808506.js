...
function ek(e) {
  ...
  n.append("build_id", "19d7a51440362fa815d75ae8b42bf2ad9021dc1e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
