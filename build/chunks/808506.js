...
function ek(e) {
  ...
  n.append("build_id", "1494fd948ce72d6f5a7128f1da7667cee9e6d15d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
