...
function eM(e) {
  ...
  n.append("build_id", "35f1b6ab9d445012b9b03d62a2b13e02f1a385f1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
