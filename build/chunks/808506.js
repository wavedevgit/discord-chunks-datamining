...
function ex(e) {
  ...
  n.append("build_id", "9752f563d6b8fe717c94a205d905cb51e2358336"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
