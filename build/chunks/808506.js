...
function ek(e) {
  ...
  n.append("build_id", "6b2172ca0a939d6cd25df6186c802b535d340a4d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
