...
function eM(e) {
  ...
  n.append("build_id", "10ce9e5e87a1fd7aea7f390de4a3b2f7cb5e572d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
