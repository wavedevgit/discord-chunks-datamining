...
function ek(e) {
  ...
  n.append("build_id", "c998d7e9049d79ebf1016c72878a8d31e783a4ef"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
