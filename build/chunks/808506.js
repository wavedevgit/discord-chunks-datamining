...
function eM(e) {
  ...
  n.append("build_id", "fb3a34e531a322fa27a4bef1185a1d15722c07d6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
