...
function ek(e) {
  ...
  n.append("build_id", "1cde2ec6d36956d662986fdae7125f3c8cf4d6c0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
