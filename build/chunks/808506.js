...
function ek(e) {
  ...
  n.append("build_id", "0002f937811e00bea15ae21c92c104ae4a5984e9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
