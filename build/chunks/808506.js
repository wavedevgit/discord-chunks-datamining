...
function eM(e) {
  ...
  n.append("build_id", "bb1a1d7527d4d5ef2bdfd691dafe41a63c02b19f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
