...
function eM(e) {
  ...
  n.append("build_id", "99b17e2bef634596f53e6ff5d2601caa0b1ffa30"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
