...
function eM(e) {
  ...
  n.append("build_id", "7b9fd4c1086b73dcb915ab465fb42e618292edf2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
