...
function eM(e) {
  ...
  n.append("build_id", "fe23b8b5572b5f0f8eb743ea63a2b98e5868391d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
