...
function ek(e) {
  ...
  n.append("build_id", "6cd9cfb80c18f9d2e25eba1981f53d1954a45857"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
