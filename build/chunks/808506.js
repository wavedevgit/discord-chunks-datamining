...
function ex(e) {
  ...
  n.append("build_id", "87a0770f5506b81340015123debf49655490ede9"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
