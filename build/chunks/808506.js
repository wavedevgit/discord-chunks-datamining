...
function eM(e) {
  ...
  n.append("build_id", "15a6d097074bd975e317c26d25223684a8ca72e4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
