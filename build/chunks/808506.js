...
function ek(e) {
  ...
  n.append("build_id", "e9c724a3a9f032093a23f42071754ed85adcfb3d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
