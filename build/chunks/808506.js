...
function ex(e) {
  ...
  n.append("build_id", "c91fcf2be3f80db896d659a957a9e2a03211a5e8"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
