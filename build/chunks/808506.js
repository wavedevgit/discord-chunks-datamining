...
function ex(e) {
  ...
  n.append("build_id", "ebf05aab59a76e1cb983bccb505bc764bd01fe46"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
