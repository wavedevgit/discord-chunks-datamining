...
function ek(e) {
  ...
  n.append("build_id", "ce00ea8f4c1d6ed55be74c3214ee77f062c9a591"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
