...
function eM(e) {
  ...
  n.append("build_id", "4d619cfaf67b7e8a02647391efdc71cc3dca6501"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
