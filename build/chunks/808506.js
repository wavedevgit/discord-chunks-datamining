...
function ek(e) {
  ...
  n.append("build_id", "ad91ab2096b07aa15ada4e444678851cb88d4998"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
