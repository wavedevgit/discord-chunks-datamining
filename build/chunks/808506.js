...
function eM(e) {
  ...
  n.append("build_id", "4bf0cd3b37cbb3a97efa766649cbb2dac686051b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
