...
function ek(e) {
  ...
  n.append("build_id", "c61e8721a6c4701d5ce85dba0e45fdaf1412ff74"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
