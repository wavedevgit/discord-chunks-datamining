...
function ek(e) {
  ...
  n.append("build_id", "334cbb66208d8e659ff57203403cf5e380da9475"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
