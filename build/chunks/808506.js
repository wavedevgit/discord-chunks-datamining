...
function ek(e) {
  ...
  n.append("build_id", "daba8e218f06187f82181c0d48f9a7e05806d811"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
