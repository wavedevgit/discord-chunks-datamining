...
function eM(e) {
  ...
  n.append("build_id", "71487d945fec2113f1aa78bcb13d89618e60f44f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
