...
function ek(e) {
  ...
  n.append("build_id", "1fb8af87f07b5069187f59bd2d4d300fed092b0c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
