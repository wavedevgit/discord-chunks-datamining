...
function ek(e) {
  ...
  n.append("build_id", "56f431a6f35f4eecf7c7e8c9f10eabb5b10a1308"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
