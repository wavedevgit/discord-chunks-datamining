...
function eM(e) {
  ...
  n.append("build_id", "217cda59da60aaeea20b6a6c215bdd5cb3e62505"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
