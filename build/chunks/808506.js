...
function eM(e) {
  ...
  n.append("build_id", "417026bee1a146b0dbcccef28c02138bb8b86463"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
