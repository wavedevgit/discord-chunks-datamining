...
function ek(e) {
  ...
  n.append("build_id", "70b48337b9a2a64c7229a0db9bd219418021c7ac"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
