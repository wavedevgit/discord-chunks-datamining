...
function ek(e) {
  ...
  n.append("build_id", "6603f391201c13ac86e137784382d38281abdbef"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
