...
function eM(e) {
  ...
  n.append("build_id", "361c6173858ffd575b90b82d532cf14d4de888eb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
