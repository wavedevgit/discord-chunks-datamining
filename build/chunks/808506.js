...
function ek(e) {
  ...
  n.append("build_id", "e93b8ef9b11a7fa0815325de1aed99869aebc8dd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
