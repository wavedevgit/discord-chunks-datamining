...
function ek(e) {
  ...
  n.append("build_id", "f7d18c07f77a6bd15eeed68174fd9d5a6986000e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
