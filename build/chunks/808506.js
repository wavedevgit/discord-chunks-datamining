...
function eM(e) {
  ...
  n.append("build_id", "ef6c2aa6853d374d8346117ac8c61afbe393866b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
