...
function ek(e) {
  ...
  n.append("build_id", "511d7ef1e1cd898a914f86d6c0c817eb46a2f465"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
