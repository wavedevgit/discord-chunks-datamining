...
function eM(e) {
  ...
  n.append("build_id", "ca0668b11d03276e78578723127ac8c390be2ad9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
