...
function ek(e) {
  ...
  n.append("build_id", "645717dd2d30d632fb61eb9b527c0fb56ea3e642"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
