...
function eM(e) {
  ...
  n.append("build_id", "595fab6967c60cd6341886b1839de8f8e99a1796"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
