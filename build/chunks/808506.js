...
function ek(e) {
  ...
  n.append("build_id", "757a3d9dfea02664830bc639dfc37813480d730e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
