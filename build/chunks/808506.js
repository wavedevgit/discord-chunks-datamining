...
function ek(e) {
  ...
  n.append("build_id", "a5e509e2b7619eeb69000656e0a24139c9f91660"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
