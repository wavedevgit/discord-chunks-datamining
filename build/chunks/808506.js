...
function eM(e) {
  ...
  n.append("build_id", "ade0380491802865ae63538efea20bf71f21476b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
