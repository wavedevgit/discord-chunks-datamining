...
function ek(e) {
  ...
  n.append("build_id", "6a10d692ccd5499d40715fb37195b437ca8c70cb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
