...
function ek(e) {
  ...
  n.append("build_id", "e21911bcdb8adf8806bd2dcfb8b5906695cba2b7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
