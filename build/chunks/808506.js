...
function ek(e) {
  ...
  n.append("build_id", "e0be714e04cb0216bb5d9d50b150e228596062ca"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
