...
function ek(e) {
  ...
  n.append("build_id", "2f204d2cf7235906b4b0e00fc963b2f7fd94ad29"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
