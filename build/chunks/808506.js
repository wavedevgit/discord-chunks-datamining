...
function eM(e) {
  ...
  n.append("build_id", "72c563c9ee777f7dcf23fe85ddbe09f40072c300"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
