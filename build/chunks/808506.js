...
function ex(e) {
  ...
  n.append("build_id", "a03be0fdf8636bb5608fa9f76343c9f8af4ba5a5"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
