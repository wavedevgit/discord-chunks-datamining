...
function eM(e) {
  ...
  n.append("build_id", "14234226b144cd92d9d33c39a1408fa136436a82"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
