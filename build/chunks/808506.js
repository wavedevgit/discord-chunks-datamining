...
function ek(e) {
  ...
  n.append("build_id", "f87bdd855e121c4d3edcc4f76c37824908fcad60"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
