...
function ek(e) {
  ...
  n.append("build_id", "d98890dbb18d0f5dae04c97cec0a87f77d89912c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
