...
function ek(e) {
  ...
  n.append("build_id", "ed06ff4ba39dd8a52c74292f98dc46d70c6a3bc6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
