...
function ek(e) {
  ...
  n.append("build_id", "e6e1523eedf408c9e5cc2d201b9eef1488822704"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
