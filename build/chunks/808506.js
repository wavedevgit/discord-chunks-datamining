...
function eM(e) {
  ...
  n.append("build_id", "5596521fcb48f4c2597ca904591008d9b0e848e4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
