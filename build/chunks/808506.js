...
function eM(e) {
  ...
  n.append("build_id", "213fd56d351832e8705cdfd800541daea0cecffe"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
