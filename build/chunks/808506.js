...
function eM(e) {
  ...
  n.append("build_id", "8460315caf413e3f09da926c82151e45f22550c8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
