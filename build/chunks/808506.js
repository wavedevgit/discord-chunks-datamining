...
function eM(e) {
  ...
  n.append("build_id", "fa62d6fe5cb70d2a32b087ba3fa2577ab673862e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
