...
function ek(e) {
  ...
  n.append("build_id", "d9e25f8687ec3c318619a34188298baad1e168c7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
