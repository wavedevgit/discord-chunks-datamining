...
function ek(e) {
  ...
  n.append("build_id", "91c89e1996fbd0c2e34d427b2802c688e26986a8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
