...
function ek(e) {
  ...
  n.append("build_id", "6c0ac39fff761f5b8855c99525cb4eaddd5b6f3c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
