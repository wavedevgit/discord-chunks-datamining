...
function ek(e) {
  ...
  n.append("build_id", "867d61524fdf2c3c0f2b09d8557b98f2e3de7a9c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
