...
function ek(e) {
  ...
  n.append("build_id", "de3510fbc8c3f0b6a8c37b4f119b7fc6df1405e8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
