...
function eM(e) {
  ...
  n.append("build_id", "9fa051a171a64473f26ce07a5b3992eb390a32c4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
