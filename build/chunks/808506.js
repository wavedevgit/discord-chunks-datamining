...
function ek(e) {
  ...
  n.append("build_id", "357eabbf30722e6e60b95800711d83c00e8bf817"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
