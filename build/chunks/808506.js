...
function ek(e) {
  ...
  n.append("build_id", "9c6eedf2cf5f926c0eca88c8837e78e46ea591e1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
