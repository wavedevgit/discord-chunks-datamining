...
function eM(e) {
  ...
  n.append("build_id", "39caacdc0c98259f8d21bfa2668caa3784c35a2c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
