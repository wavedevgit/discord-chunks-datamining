...
function eM(e) {
  ...
  n.append("build_id", "d7f93d92f4a4e87958d4572a2cd3a6f7848c51d0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
