...
function eM(e) {
  ...
  n.append("build_id", "e4e7f35c7765fe43ffa1306a01dd078d9f2b060e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
