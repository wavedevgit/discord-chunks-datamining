...
function eM(e) {
  ...
  n.append("build_id", "cfd91e663da8312840dc50d356cd963f4bb3ce76"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
