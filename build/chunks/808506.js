...
function ex(e) {
  ...
  n.append("build_id", "7fc82278501698563276d137f01aea5d70f654d7"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
