...
function ek(e) {
  ...
  n.append("build_id", "4db99bc86922cd033eb69d5140b20342692ca3aa"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
