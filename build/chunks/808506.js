...
function ek(e) {
  ...
  n.append("build_id", "02023242b542a46db9d3850d454dd6d7f474a831"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
