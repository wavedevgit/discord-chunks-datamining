...
function eM(e) {
  ...
  n.append("build_id", "df2e1b6175d382d80d32315f44be6131fb941a03"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
