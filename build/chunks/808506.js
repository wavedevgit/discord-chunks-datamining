...
function eM(e) {
  ...
  n.append("build_id", "0c1030e5b25953867912544ce9580c9459fdeb97"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
