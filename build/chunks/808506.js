...
function ek(e) {
  ...
  n.append("build_id", "1541d31224db7a665005adad3a47c33fd34b80b6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
