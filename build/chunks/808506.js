...
function ex(e) {
  ...
  n.append("build_id", "9a837c2b2b1957ecab2254080ab145202adebeeb"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
