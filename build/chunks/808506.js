...
function eM(e) {
  ...
  n.append("build_id", "c418e5288e5930896bbe2dfe115899efe495bf33"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
