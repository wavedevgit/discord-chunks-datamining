...
function ek(e) {
  ...
  n.append("build_id", "4ae7df92885f7b49b14a71413e0723b174ef4764"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
