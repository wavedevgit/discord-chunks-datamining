...
function eM(e) {
  ...
  n.append("build_id", "ea0f5dbfc6a450c8fba8efb0ee3709fbcf6dd05f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
