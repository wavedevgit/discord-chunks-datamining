...
function eM(e) {
  ...
  n.append("build_id", "daafd325c58d250406f6ef262e5e49022f0ba18a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
