...
function ek(e) {
  ...
  n.append("build_id", "c14e64b18b18622d60ca82f038429ebb356cb503"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
