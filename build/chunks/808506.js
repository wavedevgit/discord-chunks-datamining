...
function eM(e) {
  ...
  n.append("build_id", "d9fd9deee6e86d2cb0d100b045a6d1d59d214a00"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
