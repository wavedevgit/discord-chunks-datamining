...
function ek(e) {
  ...
  n.append("build_id", "762cac977b2dbe304e000bcd1584259753fa9b6c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
