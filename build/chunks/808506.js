...
function eM(e) {
  ...
  n.append("build_id", "c84bfcaf05c1404d860cc0644dc2b1519cfe42f3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
