...
function eM(e) {
  ...
  n.append("build_id", "493cb6bfaf52eac6bd5089805f0896c3171ec978"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
