...
function ek(e) {
  ...
  n.append("build_id", "b5dce662ede534aa62d0bdfe35e82bf361595ec6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
