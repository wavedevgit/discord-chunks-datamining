...
function eM(e) {
  ...
  n.append("build_id", "513b16b032eb8ea70d26e015ac51524f5d013ad8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
