...
function eM(e) {
  ...
  n.append("build_id", "fbc346062aaf445e1defb491d0d42b75a075a239"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
