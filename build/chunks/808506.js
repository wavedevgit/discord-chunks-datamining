...
function eM(e) {
  ...
  n.append("build_id", "3142273e23a2a9173b3dfcef685f81f48a2a9ae2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
