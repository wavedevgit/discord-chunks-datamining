...
function ek(e) {
  ...
  n.append("build_id", "d637bed94bcbc44a2e087cdbda9a04eeaf079842"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
