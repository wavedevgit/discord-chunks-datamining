...
function ek(e) {
  ...
  n.append("build_id", "dd1c4fe2f3f51fdd4ed73a10e9f32046249623cd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
