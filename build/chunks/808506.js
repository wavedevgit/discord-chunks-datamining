...
function ex(e) {
  ...
  n.append("build_id", "b1903206073f466a5e2614bd4de01dde4cf15aab"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
