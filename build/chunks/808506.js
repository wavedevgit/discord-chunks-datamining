...
function ek(e) {
  ...
  n.append("build_id", "263e661e5ee49be80bb7aabd1aefd0f0cc78fbbb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
