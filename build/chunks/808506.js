...
function ex(e) {
  ...
  n.append("build_id", "e41a4215e0e90918587b6f8de0755f9e90336030"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
