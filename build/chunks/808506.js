...
function ex(e) {
  ...
  n.append("build_id", "acdd2a65232c1b381fd1bba8e85cee1dad9f53cf"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
