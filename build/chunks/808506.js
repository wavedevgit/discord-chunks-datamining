...
function eM(e) {
  ...
  n.append("build_id", "f5bd0aefa177d87004705c8310d06aeba5173cef"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
