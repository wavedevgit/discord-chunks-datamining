...
function ek(e) {
  ...
  n.append("build_id", "c4478237104c5223825de45dc037d462246484d9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
