...
function ek(e) {
  ...
  n.append("build_id", "0f213f644f624db5670b296ef07bc67100cf45f4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
