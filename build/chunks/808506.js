...
function ex(e) {
  ...
  n.append("build_id", "ba5c36ea9add1ba920e456b9c1decae7cbd1d47f"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
