...
function ek(e) {
  ...
  n.append("build_id", "80f93af50391909b38cef3b88c178f6b002ac29e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
