...
function eM(e) {
  ...
  n.append("build_id", "f967225dcc9fd53fd5c16a3ac705ae7d527c18cf"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
