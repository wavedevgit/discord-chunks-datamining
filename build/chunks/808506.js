...
function ek(e) {
  ...
  n.append("build_id", "fa2c5ab3ea4306f539dce2418fa26fec8015d84b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
