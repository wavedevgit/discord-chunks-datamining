...
function ek(e) {
  ...
  n.append("build_id", "91d7257f890146788d94ee06445d27072b3e2cf7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
