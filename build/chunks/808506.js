...
function eM(e) {
  ...
  n.append("build_id", "81db5c1768066f236de2df32bed5b6ae61eeb46f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
