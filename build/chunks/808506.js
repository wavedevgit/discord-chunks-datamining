...
function ek(e) {
  ...
  n.append("build_id", "8aa46b692efd6a05609a9709aa824297689c2244"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
