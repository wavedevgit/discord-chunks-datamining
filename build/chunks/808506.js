...
function eM(e) {
  ...
  n.append("build_id", "2477d9cfb2800e4d61253f72a6b623a20a9a81fa"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
