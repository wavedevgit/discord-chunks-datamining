...
function ek(e) {
  ...
  n.append("build_id", "68662375c1783f916fd55d0b8845158f29eef31b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
