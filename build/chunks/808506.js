...
function eM(e) {
  ...
  n.append("build_id", "b7f305db3746ff4cbe229733cea2d5021ac1d42e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
