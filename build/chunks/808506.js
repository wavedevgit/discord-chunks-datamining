...
function ek(e) {
  ...
  n.append("build_id", "b7ab3511c6c486cf1c51e8742487f074b0839753"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
