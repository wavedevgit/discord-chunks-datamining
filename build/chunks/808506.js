...
function ek(e) {
  ...
  n.append("build_id", "7d2d0361b182addb164f2d5f6079ed39c6d10e0c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
