...
function eM(e) {
  ...
  n.append("build_id", "7f7ab022a20dc3462b05bed8c36bc22df1c9b9a5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
