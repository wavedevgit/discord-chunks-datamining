...
function ex(e) {
  ...
  n.append("build_id", "b48f408cda80a406ad2835bb9dcb63e6e0a5069a"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
