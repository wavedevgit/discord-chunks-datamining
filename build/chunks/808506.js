...
function ek(e) {
  ...
  n.append("build_id", "f4098dd03fbea7b46726b93b92b3776f5276ad54"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
