...
function eM(e) {
  ...
  n.append("build_id", "b1d61282d0cc3ec99604fe47aaaae30fcecbc2f7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
