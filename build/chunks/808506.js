...
function eM(e) {
  ...
  n.append("build_id", "cede4cdb55cd200ef5a6d9e4489b830678c30430"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
