...
function eM(e) {
  ...
  n.append("build_id", "8c1210ca057e9823207d2f13de7fca94998acb55"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
