...
n.r(t), n.d(t, {
  ...
  default: () => e$,
  getOverlayURL: () => eO
}), n(388685), n(410992), n(227481), n(730884), n(20464), n(341884), n(364341), n(629680), n(505025), n(918970), n(121784), n(644351), n(146733), n(853839), n(570086), n(479048), n(65234), n(111804), n(490233), n(97749), n(358797), n(415506);
var i, o = n(807864),
  a = n(442837),
  s = n(379649),
  l = n(570140),
...
function eT(e, t, n) {
  ...
  ec(e, B({}, a)), (0, d.te)(M.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(M.OVERLAY_LAYOUT_ID), 0, {
...
function eC(e) {
  switch (eo && ea.info("[app data received]", e), e.type) {
    case j.BmY.CONNECT:
      ...
      if (null == t) break;
      (0, d.te)(M.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(M.OVERLAY_LAYOUT_ID), 0), Promise.all([(0, O.Z)(t, e.pid), a.ZP.PersistedStore.getAllStates()]).then(t => {
        let [n, r] = t, {
          pid: i,
          token: o
        } = e;
...
function eM(e) {
  ...
  n.append("build_id", "7f9652ea3a6ee3ed4f9fd5299500abc05411ce86"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
