...
function eM(e) {
  ...
  n.append("build_id", "1ddcb8e13d3b868de27517061359a38e737dc9e2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
