...
function eM(e) {
  ...
  n.append("build_id", "b02a6d32d4329fbfe94aa8893679ad1be6edad7e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
