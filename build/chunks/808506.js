...
function eM(e) {
  ...
  n.append("build_id", "ce9c1ab838054473d8e9162b525eba5c41739596"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
