...
function ek(e) {
  ...
  n.append("build_id", "32a8f17147f966d0bef145c5de5d0cbeeafc5de9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
