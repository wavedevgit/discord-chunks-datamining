...
function ek(e) {
  ...
  n.append("build_id", "7d5e1b7631daa6369dab4d8bbfcc4ef616962d59"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
