...
function ek(e) {
  ...
  n.append("build_id", "3135e932f0d9dc94ddd7e822d902135bb15ca156"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
