...
function ek(e) {
  ...
  n.append("build_id", "e016ff27a55b925b99df0c08c4cb423c97d9c049"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
