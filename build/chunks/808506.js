...
function ek(e) {
  ...
  n.append("build_id", "6dbbf444cedddcee657fe004a9f9c4a66ded56b3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
