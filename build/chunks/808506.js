...
function ek(e) {
  ...
  n.append("build_id", "7fb9101d4f4cc075e7a042ad8019ba98322b9751"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
