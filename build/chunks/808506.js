...
function eM(e) {
  ...
  n.append("build_id", "69b57ca9e643c8fac3e144114d7a6dd69754230d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
