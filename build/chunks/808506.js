...
function ex(e) {
  ...
  n.append("build_id", "46b77b3f23301d6185d256c679672f803bc537b2"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
