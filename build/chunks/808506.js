...
function eM(e) {
  ...
  n.append("build_id", "f224b406af9ea56ae105646b7a93e11ce2a72cf9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
