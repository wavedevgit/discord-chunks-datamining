...
function eM(e) {
  ...
  n.append("build_id", "f9247cf226240fe35107211642b307ac0348761c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
