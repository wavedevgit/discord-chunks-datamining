...
function ek(e) {
  ...
  n.append("build_id", "638fec2e6ce65937731d864fdd4adc8aa4e4e503"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
