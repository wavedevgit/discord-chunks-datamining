...
function eM(e) {
  ...
  n.append("build_id", "e230c9b870e7cacd3fbc88feb1beb5a608845c98"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
