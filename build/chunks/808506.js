...
function ek(e) {
  ...
  n.append("build_id", "907f6877cdb3903f28745e61f3983664a3dd6ad1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
