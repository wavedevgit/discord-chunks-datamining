...
function ek(e) {
  ...
  n.append("build_id", "a74a6ca6fcf6b8fdc8dc6f359c2fa2778eb4302a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
