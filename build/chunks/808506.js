...
function eM(e) {
  ...
  n.append("build_id", "86ee9fe4b0e23ae07e3e49907a832207f22a1932"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
