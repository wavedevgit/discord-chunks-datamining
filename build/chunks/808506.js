...
function ek(e) {
  ...
  n.append("build_id", "3a266d6b0fb45ed08e6673bc66d01fb30a4cced4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
