...
function ek(e) {
  ...
  n.append("build_id", "b718ee33fdb87222807b922a350029722282009f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
