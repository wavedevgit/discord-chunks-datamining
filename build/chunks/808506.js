...
function eM(e) {
  ...
  n.append("build_id", "b5bed9d08790e3ecfece19e7ac6c3a640fd2453c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
