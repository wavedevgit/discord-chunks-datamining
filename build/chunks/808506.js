...
function ex(e) {
  ...
  n.append("build_id", "deabf6a6963ece819afa4261302c1dcca6ab6b61"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
