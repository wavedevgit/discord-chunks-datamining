...
function ex(e) {
  ...
  n.append("build_id", "62c8dc2845ca458e146d3d817f64f39b97239526"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
