...
function ek(e) {
  ...
  n.append("build_id", "146baf12db714dea1be3f2003e1a6a747b9db624"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
