...
function eM(e) {
  ...
  n.append("build_id", "630b68a48815595081eb1da3ca92e092010bb526"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
