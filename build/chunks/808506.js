...
function ex(e) {
  ...
  n.append("build_id", "efbd7834e938e1d0f1b8d5bfca3029dde8e3f580"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
