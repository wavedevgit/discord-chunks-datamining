...
function eM(e) {
  ...
  n.append("build_id", "2132a67dcd4f7aee9aff5f330001109579732e06"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
