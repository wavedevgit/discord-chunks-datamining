...
function eM(e) {
  ...
  n.append("build_id", "71fedae08c4526e3bb0a60bd1b7cb5974d566811"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
