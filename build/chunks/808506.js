...
function ek(e) {
  ...
  n.append("build_id", "8522e7b5116eca0219436371ad88c3566017c136"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
