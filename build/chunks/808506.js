...
function ek(e) {
  ...
  n.append("build_id", "471ad0029d990c169658e1e51ad023af43b40afa"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
