...
function ek(e) {
  ...
  n.append("build_id", "6f58df720e5daac4694e14f0110627a9ef020196"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
