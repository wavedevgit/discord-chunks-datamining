...
function eM(e) {
  ...
  n.append("build_id", "bceb5609639f718e55f80209a044ab90c7ee8e1d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
