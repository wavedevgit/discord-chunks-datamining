...
function eM(e) {
  ...
  n.append("build_id", "72357dc0d2912c1df0a9c9fb59def9b5f4d26632"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
