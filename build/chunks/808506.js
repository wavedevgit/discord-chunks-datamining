...
function eM(e) {
  ...
  n.append("build_id", "2add38f3b47e37b7e6dfc11063b8bc6ab5a448b5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
