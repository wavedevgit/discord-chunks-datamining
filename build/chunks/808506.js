...
function eM(e) {
  ...
  n.append("build_id", "7311589e5b7246bcad776d74533406deb243cb99"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
