...
function ek(e) {
  ...
  n.append("build_id", "1543f5c64113ea4cf3fb902cbde512bd8609e1d4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
