...
function ek(e) {
  ...
  n.append("build_id", "235ee36337bc47af58188ab6e92e33e17a4e47a5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
