...
function eM(e) {
  ...
  n.append("build_id", "75a29067da24bb3c0633fe814a2cb9c06cf238c8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
