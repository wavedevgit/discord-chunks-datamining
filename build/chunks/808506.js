...
function ek(e) {
  ...
  n.append("build_id", "11144798659703fd9f232193e0e88ad0e5c33c34"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
