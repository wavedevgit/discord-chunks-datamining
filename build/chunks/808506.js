...
function ek(e) {
  ...
  n.append("build_id", "569c44d74750f6ffdfeeac43128679265156ce4a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
