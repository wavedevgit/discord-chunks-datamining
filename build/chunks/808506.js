...
function ek(e) {
  ...
  n.append("build_id", "0294224be43c7f7bcc849bd847027a09fc28da7b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
