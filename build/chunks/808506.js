...
function ek(e) {
  ...
  n.append("build_id", "e0977d600ceea0d815259f6230d6083917169460"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
