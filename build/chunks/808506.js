...
function eM(e) {
  ...
  n.append("build_id", "fb3c54f1fafd7b9a514b3ca38ef713a5b814035e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
