...
function eM(e) {
  ...
  n.append("build_id", "a9b6f2ccc9628cb8cbc1be71cf18f98f74562c48"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
