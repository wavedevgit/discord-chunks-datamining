...
function ek(e) {
  ...
  n.append("build_id", "bc3ff02ab77c950e583c19d20043368f111f5ef5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
