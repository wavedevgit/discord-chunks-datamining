...
function eM(e) {
  ...
  n.append("build_id", "fe7f6c8401683a62ec2277ce5d6497816963187c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
