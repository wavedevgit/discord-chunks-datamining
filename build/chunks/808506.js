...
function ek(e) {
  ...
  n.append("build_id", "b90de78672963ff3b1e38e33425c0069afcb83e7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
