...
function ek(e) {
  ...
  n.append("build_id", "44b425d2ad83a72bbdb90c22e593fe34454f9816"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
