...
function eM(e) {
  ...
  n.append("build_id", "3862c35cec2495c3f4dccadf94be537ea933cd14"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
