...
function ex(e) {
  ...
  n.append("build_id", "43ae64e06a19edb3773b4f0aa12a692503ff5da1"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
