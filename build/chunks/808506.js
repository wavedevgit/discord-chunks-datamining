...
function eM(e) {
  ...
  n.append("build_id", "61fe78879da6432408bf358d4d414e8028562966"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
