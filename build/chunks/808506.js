...
n.r(t), n.d(t, {
  ...
  default: () => eJ,
  getOverlayURL: () => eO
}), n(388685), n(410992), n(227481), n(730884), n(20464), n(341884), n(364341), n(629680), n(505025), n(918970), n(121784), n(644351), n(146733), n(853839), n(570086), n(479048), n(65234), n(111804), n(490233), n(97749), n(358797), n(415506), n(49124);
var i, a = n(807864),
  o = n(442837),
  s = n(379649),
  l = n(570140),
...
class ee {
  ...
  constructor() {
    ...
    }), U(this, "queueDispatch", e => !(!W() || en.has(e.type)) && (this.isDispatching ? this.waitingActionsToFlush.add(e) : ("USER_SETTINGS_PROTO_UPDATE" === e.type && (e = V(G({}, e), {
      settings: {
...
function ep(e, t) {
  let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
    r = Y.get(e);
  (null === n || r === n) && r !== t && (null == t ? Y.delete(e) : Y.set(e, t), (null == t || "CRASHED" === t) && (f.Z.setFocusedPID(null), e_()), $.delete(e), ea.info("pid=".concat(e, " status transition ").concat(null != r ? r : "DISCONNECTED", " -> ").concat(null != t ? t : "DISCONNECTED"), Y))
}
async function eh(e) {
  try {
...
async function eE(e) {
  ...
  if (ea.verbose("updateIntendedOverlayPIDs", {
      ...
      action: e
    }), ed.isMutexHeld() || ea.error("updateIntendedOverlayPIDs: overlayMutex is not held.", e), !q && null != e) return void ea.verbose("updateIntendedOverlayPIDs: Connection is not opened while updating applications.", e);
  async function r(e) {
    if (!(e in Z)) return;
    let t = Z[e];
    delete Z[e];
  ...
  for (let t of null != (n = e.added) ? n : []) {
    ...
    if (ea.verbose("updateIntendedOverlayPIDs: newGame", n), n.legacyEnabled) switch (n.pid in Z ? ea.error("Unexpected. ".concat(n.pid, " is being added twice?"), Z, e) : ec(n.pid), n.overlayMethod) {
      case p.gl.Hook:
        let r = new Date().getTime();
        el(n.pid, {
          mounting_started_at: r,
          fullscreen_type: await (0, T.hj)(n.pid, 0)
        }), Y.has(n.pid) || await em(n.pid), Z[n.pid] = {
...
let ev = ef("setOverlayEnabled", async e => {
  ...
  if (K === e) return void ea.verbose("setOverlayEnabled: no change", {
    newOverlayEnabled: e
  });
  K = e, eQ.emitChange();
  let t = await (0, k.K)();
...
function eT(e, t, n) {
  ...
  el(e, G({}, o)), (0, d.te)(x.OVERLAY_LAYOUT_ID, R.Z.getDefaultLayout(x.OVERLAY_LAYOUT_ID), j.bv, {
...
function eN(e) {
  switch (ei && ea.info("[app data received]", e), e.type) {
    case M.BmY.CONNECT:
      ...
      if (null == t) break;
      (0, d.te)(x.OVERLAY_LAYOUT_ID, R.Z.getDefaultLayout(x.OVERLAY_LAYOUT_ID), j.bv), Promise.all([(0, v.Z)(t, e.pid), o.ZP.PersistedStore.getAllStates()]).then(t => {
        let [n, r] = t, {
          pid: i,
          token: a
        } = e;
        g.lW({
          ...
          token: a,
          payloads: [n]
        }), ep(i, "READY"), (0, x.setPID)(i), f.Z.overlayReady(i);
        let o = es(i);
        el(i, V(G({}, o), {
...
async function eC(e, t) {
  ...
  try {
    null != r && r !== x.DEV_PID && n.sendCommand(r, {
...
function ex(e) {
  ...
  n.append("build_id", "973d00e1a3b74d4a21852936ea6d9a958ef70109"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
