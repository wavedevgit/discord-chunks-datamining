...
function eM(e) {
  ...
  n.append("build_id", "10f8377a79b0f1d0ee01f153b5d081f55b08200c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
