...
function ex(e) {
  ...
  n.append("build_id", "e9e07edc4d116c0a92879e459fc216ccacf4d92a"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
