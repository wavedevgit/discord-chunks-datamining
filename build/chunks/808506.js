...
function eM(e) {
  ...
  n.append("build_id", "f0cd6468656b1eb8f9b7c40eb9e4941fcae6f24c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
