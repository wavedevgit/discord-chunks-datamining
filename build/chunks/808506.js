...
function eM(e) {
  ...
  n.append("build_id", "7eca5b47d07022b42bda70c8c2c62b93471994a1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
