...
function eM(e) {
  ...
  n.append("build_id", "d5cb7f9aaa739589a6c8890fd93cead42ba31810"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
