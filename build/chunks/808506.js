...
function ek(e) {
  ...
  n.append("build_id", "781148e9d67b5e309fedd28ba0b80207894a93fd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
