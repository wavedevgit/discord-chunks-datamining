...
function eM(e) {
  ...
  n.append("build_id", "5a419c69e462931e785a09d0024f35fed8160dfd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
