...
function eM(e) {
  ...
  n.append("build_id", "f419812e6176991bdce2d0746ff2b007cc550f70"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
