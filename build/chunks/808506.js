...
function ek(e) {
  ...
  n.append("build_id", "d887b3f1278da0eb473a81bc811dc7ba91c85bb6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
