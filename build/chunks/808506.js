...
function eM(e) {
  ...
  n.append("build_id", "42aea65a537177a1c0e62af397fba76f0decd544"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
