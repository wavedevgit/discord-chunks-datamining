...
function ex(e) {
  ...
  n.append("build_id", "f3f979d826ea1212a85820972ce88ccbba670f75"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
