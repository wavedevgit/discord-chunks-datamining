...
function eM(e) {
  ...
  n.append("build_id", "712d3a9f06649ea95b31c42930209b96ea086a11"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
