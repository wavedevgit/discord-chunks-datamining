...
function ek(e) {
  ...
  n.append("build_id", "f075201080af5c6401269c2001444d532f663929"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
