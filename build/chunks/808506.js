...
function eM(e) {
  ...
  n.append("build_id", "c9d9b0fde5ea4b11a9594c4453a8c0e10eafb83a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
