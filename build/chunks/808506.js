...
function ex(e) {
  ...
  n.append("build_id", "b9ca817b4827651b3189f38171ec923c88244499"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
