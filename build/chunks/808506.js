...
function eM(e) {
  ...
  n.append("build_id", "75007aa8857a42547167b7191823e23cc40561da"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
