...
function ek(e) {
  ...
  n.append("build_id", "11b42fe490f2600c8d913c69af5024121857c982"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
