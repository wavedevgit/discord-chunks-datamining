...
function ex(e) {
  ...
  n.append("build_id", "d61681e557e9c421c703b8a02597a20d8e24389a"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
