...
function eM(e) {
  ...
  n.append("build_id", "6a315b68bc80d6769887c261b06795d92dac2545"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
