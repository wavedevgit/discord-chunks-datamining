...
function eM(e) {
  ...
  n.append("build_id", "2c502ad6e1395916e599febe888d7f8145babd09"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
