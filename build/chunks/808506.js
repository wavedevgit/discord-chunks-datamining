...
function ex(e) {
  ...
  n.append("build_id", "239675eab196f716dd3ff557fe717fa48d4f4816"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
