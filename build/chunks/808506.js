...
function ek(e) {
  ...
  n.append("build_id", "7234242a0f10ddb3b7811c948a94ca69b7ebad6c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
