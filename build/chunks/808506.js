...
function eM(e) {
  ...
  n.append("build_id", "2698b98ebf4b1ef4d868335d9ac545357ec062dc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
