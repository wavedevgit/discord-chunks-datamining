...
function ek(e) {
  ...
  n.append("build_id", "1e319f3e9f995b6ccc4fd54db01348be79b0b11a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
