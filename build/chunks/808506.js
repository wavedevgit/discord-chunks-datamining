...
function eM(e) {
  ...
  n.append("build_id", "96be7056b93cf2611283e50d29e534a8702489d5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
