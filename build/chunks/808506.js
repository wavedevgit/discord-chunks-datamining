...
function ek(e) {
  ...
  n.append("build_id", "17308384986e70b430fa62a6cbd34d979a9835ce"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
