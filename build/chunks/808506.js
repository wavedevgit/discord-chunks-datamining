...
function eM(e) {
  ...
  n.append("build_id", "505f747373cf55e5741589e393d461ac2506bf37"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
