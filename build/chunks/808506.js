...
function ek(e) {
  ...
  n.append("build_id", "92f3e2d87dbf7b6139786270ed2e4f9c23201c7f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
