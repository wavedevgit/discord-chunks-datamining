...
function ek(e) {
  ...
  n.append("build_id", "5539a2cb223a62940945ed4d165a14ed1c941c7b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
