...
function eM(e) {
  ...
  n.append("build_id", "705b986db2bd1f50424a421367af9567d00a85be"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
