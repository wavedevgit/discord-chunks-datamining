...
function ek(e) {
  ...
  n.append("build_id", "b7567bc77b2fb4740b96a9f8ca01601c6e00aabd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
