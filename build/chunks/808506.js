...
function eM(e) {
  ...
  n.append("build_id", "d93759c5b9d019ef66611250fb686bdab548493b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
