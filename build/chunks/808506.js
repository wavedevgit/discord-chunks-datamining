...
function eM(e) {
  ...
  n.append("build_id", "4ae03a4489090df6ce8da7f1fc06f71134def7a6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
