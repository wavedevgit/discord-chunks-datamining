...
function ex(e) {
  ...
  n.append("build_id", "ffc23f0521cb7f4bdb1d9fdf5a69693cd7046205"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
