...
function eM(e) {
  ...
  n.append("build_id", "24296720f6fb530651e78836c1338f1affadd9d1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
