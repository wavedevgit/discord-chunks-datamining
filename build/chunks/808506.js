...
function ek(e) {
  ...
  n.append("build_id", "ca737db022e20f4e263c9bd3d77e7e950837cbd4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
