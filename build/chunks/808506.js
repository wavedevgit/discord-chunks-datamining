...
function eM(e) {
  ...
  n.append("build_id", "9405494e94bfd827e38d7edbdda618faaed4c1de"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
