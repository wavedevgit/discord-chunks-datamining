...
function ex(e) {
  ...
  n.append("build_id", "196f76549eaf693f330724e7ee31caaabfd669e8"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
