...
function eM(e) {
  ...
  n.append("build_id", "bfb2370aad720608e419e21d6d58ae6a7d998fd9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
