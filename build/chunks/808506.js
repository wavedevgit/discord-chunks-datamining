...
function eM(e) {
  ...
  n.append("build_id", "41fa86123188fe81ef72c7d91ff99387f28f3267"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
