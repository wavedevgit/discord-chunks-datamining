...
function ek(e) {
  ...
  n.append("build_id", "b8fcfd4813c153bde10a6aa80b68d8f634c83f3f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
