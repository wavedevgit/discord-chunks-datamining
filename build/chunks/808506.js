...
function ek(e) {
  ...
  n.append("build_id", "be560c0ff04442dad85f5a94a849cfd06ed56939"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
