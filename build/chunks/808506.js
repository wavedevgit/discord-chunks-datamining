...
function ek(e) {
  ...
  n.append("build_id", "f0859c4902a402dd5d1a0ef4dd5b4b40dabe67e2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
