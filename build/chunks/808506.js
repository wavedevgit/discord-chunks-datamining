...
function ek(e) {
  ...
  n.append("build_id", "96d87323f2474eb0539af8e3d4fbac4a0f880017"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
