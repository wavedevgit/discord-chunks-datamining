...
function ek(e) {
  ...
  n.append("build_id", "f3d329e623533146bfb072ddb8a36a4361e21167"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
