...
function eM(e) {
  ...
  n.append("build_id", "4b8822826cc407eb10ee3d61d9d0c83620047895"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
