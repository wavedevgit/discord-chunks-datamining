...
function ek(e) {
  ...
  n.append("build_id", "b09445e37a3fe235e584f88b08cd497a3a25fc0b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
