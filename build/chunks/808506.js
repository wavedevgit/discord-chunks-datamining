...
function ek(e) {
  ...
  n.append("build_id", "05438e22fe751b8fac10d07bc962bbf0ef1ce1ef"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
