...
function ek(e) {
  ...
  n.append("build_id", "0a5260d827fd2f431c128a552e55c7f99fd1b7fe"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
