...
function ex(e) {
  ...
  n.append("build_id", "7b6926752c069e79449835cae2118c0b9c1c36ca"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
