...
function ex(e) {
  ...
  n.append("build_id", "b939eac44b85308f467e1913885629655e005375"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
