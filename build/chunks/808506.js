...
function ek(e) {
  ...
  n.append("build_id", "51a04426261d4122fc963ee1ed22b523bfe18247"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
