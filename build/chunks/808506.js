...
function eM(e) {
  ...
  n.append("build_id", "732686e12d4e60ed3b8ccec1d7f4465a4c4afddb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
