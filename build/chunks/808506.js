...
function ek(e) {
  ...
  n.append("build_id", "0cb0668ddfa30da79908928457edda933089f301"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
