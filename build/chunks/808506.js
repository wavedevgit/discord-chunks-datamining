...
function eM(e) {
  ...
  n.append("build_id", "c626d3594a5a3d37c1b01e98ed2f45b00c1a4863"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
