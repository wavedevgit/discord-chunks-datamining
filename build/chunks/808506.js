...
function ek(e) {
  ...
  n.append("build_id", "47f7ba11b4eeea1484104d46fc935ba764da23f8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
