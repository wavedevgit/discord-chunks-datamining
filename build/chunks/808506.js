...
function ex(e) {
  ...
  n.append("build_id", "a53fa6b4ab56838f1c3fd8ac8b98dca43ab89caf"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
