...
function eM(e) {
  ...
  n.append("build_id", "53765401432df7d1c9bede425f6756033d2b2c20"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
