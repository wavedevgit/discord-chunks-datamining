...
function eM(e) {
  ...
  n.append("build_id", "d5e0591d54dc2c2ca7e986afa1dec8b0cdc54d21"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
