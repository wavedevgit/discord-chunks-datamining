...
function ex(e) {
  ...
  n.append("build_id", "f375cecf09862a3e4a2a84ae502f06dd904ed67a"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
