...
function ek(e) {
  ...
  n.append("build_id", "f3ea7243efeda30f8f1d658e5e46cb31a6210ed5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
