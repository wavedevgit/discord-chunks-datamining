...
function ek(e) {
  ...
  n.append("build_id", "dec051a04c5dc5bf13abc0bdd57269994e158b6c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
