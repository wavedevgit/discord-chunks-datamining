...
function eM(e) {
  ...
  n.append("build_id", "f807921018e50fc4e4814e8e59f0778a28cac0e6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
