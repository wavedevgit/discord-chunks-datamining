...
function eM(e) {
  ...
  n.append("build_id", "810f9f1df68cc53d15cdfd779766a7d0dc66bca0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
