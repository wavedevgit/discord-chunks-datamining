...
function ex(e) {
  ...
  n.append("build_id", "9622ca882358ea34970f7db4809f6101754c5dd9"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
