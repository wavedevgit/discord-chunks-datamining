...
function eM(e) {
  ...
  n.append("build_id", "d04a206b0c952384ac6243ffa8e22278222bd5ee"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
