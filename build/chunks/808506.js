...
function eM(e) {
  ...
  n.append("build_id", "dbdd2c50f2da9cf8634bce809ccf01f4a4cde27e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
