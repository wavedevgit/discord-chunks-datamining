...
function eM(e) {
  ...
  n.append("build_id", "d81329f99fe2f0446daa283f96cfc32bdcd1f78e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
