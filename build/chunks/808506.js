...
function ex(e) {
  ...
  n.append("build_id", "96b20f50ab35c93a597d8c996a8e7197b633f620"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
