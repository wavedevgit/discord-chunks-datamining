...
function ek(e) {
  ...
  n.append("build_id", "bb65e071835748ba99394b2d25ce8156a49dbac9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
