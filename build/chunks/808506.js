...
function ek(e) {
  ...
  n.append("build_id", "c4d6768b69ecdd621e37052ecba9fb779fc4e25d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
