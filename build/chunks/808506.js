...
function ex(e) {
  ...
  n.append("build_id", "fb730234f1179fea4d72d57147f9edd5ff5ee890"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
