...
function ex(e) {
  ...
  n.append("build_id", "b72e46a7524f626d7a2bd5d44c77f9fe9f91c84f"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
