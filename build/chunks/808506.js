...
function ek(e) {
  ...
  n.append("build_id", "edab11557ee879d15ef9389d76596db5aa8d1b32"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
