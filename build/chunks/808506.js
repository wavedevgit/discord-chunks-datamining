...
function eM(e) {
  ...
  n.append("build_id", "4ed8b87eaa0b8e63637dbc392c8b2cc7049f26d2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
