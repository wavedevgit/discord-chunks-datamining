...
function eM(e) {
  ...
  n.append("build_id", "2610939d945d78f6d984741a8b3f71d5b622915a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
