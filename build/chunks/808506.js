...
function eM(e) {
  ...
  n.append("build_id", "58e322533d3cf20226645a12c3a7092729713c64"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
