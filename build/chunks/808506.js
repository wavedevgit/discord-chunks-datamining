...
function ek(e) {
  ...
  n.append("build_id", "773f5fa0452f4231276503a94b6b05488018561d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
