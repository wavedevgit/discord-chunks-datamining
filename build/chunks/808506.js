...
function eM(e) {
  ...
  n.append("build_id", "e05beb42ddb076f0a11828ce0028ba665650a6b8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
