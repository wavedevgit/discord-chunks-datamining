...
function eM(e) {
  ...
  n.append("build_id", "291bb221101ce10765a87fcb150a444b231cd812"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
