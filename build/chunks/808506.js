...
function ek(e) {
  ...
  n.append("build_id", "c3d9f69f5841977bcf91cc5ec702862db46122dc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
