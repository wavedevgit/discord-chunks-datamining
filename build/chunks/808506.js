...
function ek(e) {
  ...
  n.append("build_id", "3a54b10d2a440b36bd8841b889c2296294388ea8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
