...
function ek(e) {
  ...
  n.append("build_id", "cc7307222b92749ceb765406214686770e194bac"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
