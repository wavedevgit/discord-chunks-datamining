...
function eM(e) {
  ...
  n.append("build_id", "d76f360cb1b01d8d78263ade38b94bd4300829d1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
