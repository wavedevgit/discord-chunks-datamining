...
function ek(e) {
  ...
  n.append("build_id", "434ff3977eb05e78f2bd82eb1713fe6c63f3bdff"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
