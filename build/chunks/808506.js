...
function ek(e) {
  ...
  n.append("build_id", "0990e754c37d22f564369b7cfe58feb356c5635a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
