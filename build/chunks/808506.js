...
function ek(e) {
  ...
  n.append("build_id", "5e09fcd445616d505eedbe09f9fab672dd156e62"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
