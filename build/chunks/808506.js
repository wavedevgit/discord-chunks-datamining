...
function eM(e) {
  ...
  n.append("build_id", "357086973e4fb2655056729e4ad3802131f5e43c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
