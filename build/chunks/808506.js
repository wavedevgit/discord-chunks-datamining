...
function ek(e) {
  ...
  n.append("build_id", "3009b5a79ff61adf49b4f17dc30c28a31ed2d0fc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
