...
function ex(e) {
  ...
  n.append("build_id", "c3d0576dc1d445eb71614dc025b8e1b8515a0aa2"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
