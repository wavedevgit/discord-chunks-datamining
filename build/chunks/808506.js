...
function ek(e) {
  ...
  n.append("build_id", "9ff5b6d45a487bf79f7c2a06375ace2d4a6ec2bd"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
