...
function eM(e) {
  ...
  n.append("build_id", "119a54577fce9e6a3659bdf5e7cc538d55e4fb4a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
