...
function eM(e) {
  ...
  n.append("build_id", "e183509c9f2abdb1fab3986f24d8955d248068b3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
