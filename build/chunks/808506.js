...
function ek(e) {
  ...
  n.append("build_id", "2b266648a1917b73609ec68d10f7442920a03a0d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
