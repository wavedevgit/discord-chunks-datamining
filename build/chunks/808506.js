...
function eM(e) {
  ...
  n.append("build_id", "6c626f6d6caa500e45901c8a8d19c59c64073838"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
