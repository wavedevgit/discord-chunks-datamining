...
function ek(e) {
  ...
  n.append("build_id", "15cc4155d2c945f0131a57f62650cb6ed1dbe7ff"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
