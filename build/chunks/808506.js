...
function eM(e) {
  ...
  n.append("build_id", "3da62bf8feb0171203bb7b52c73f57b252dcaa4f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
