...
function eM(e) {
  ...
  n.append("build_id", "ec903141fa661adf61ef917cd364655b5cccfaa2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
