...
function ek(e) {
  ...
  n.append("build_id", "637be4005dee6b7ad4b4ddc498ffa64729ee4500"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
