...
function ek(e) {
  ...
  n.append("build_id", "4076bff8988c7be75254b3d283b525f538c74d78"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
