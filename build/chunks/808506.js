...
function eM(e) {
  ...
  n.append("build_id", "010a176bc3a5fbda8f158cb17082d3d899782995"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
