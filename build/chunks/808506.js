...
function ex(e) {
  ...
  n.append("build_id", "b4813ad5e07dc1511fc507fac88685046fffa881"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
