...
function ex(e) {
  ...
  n.append("build_id", "cbac500b05981a670685533fe3bdac7c7b3c1d90"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
