...
function ek(e) {
  ...
  n.append("build_id", "7729e3a53026fcbd00d93d31080504099e5f3215"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
