...
function eM(e) {
  ...
  n.append("build_id", "97925011bd9eaf9de1b28077b29ddf61ba91e5b0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
