...
function eM(e) {
  ...
  n.append("build_id", "152140c6e26571b972e161fdbcb157608c140bad"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
