...
function eM(e) {
  ...
  n.append("build_id", "f856579ca2d4f63ed5dc1699a2e020a65a1bd694"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
