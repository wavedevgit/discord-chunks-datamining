...
function ek(e) {
  ...
  n.append("build_id", "c9b17ef3217308c8c71537685f204bf54b62d609"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
