...
function ex(e) {
  ...
  n.append("build_id", "cb388b6044049b61399ac6b3a3dff2d3afcedfe6"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
