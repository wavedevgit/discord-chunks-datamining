...
function ex(e) {
  ...
  n.append("build_id", "26dadec97bb3443dc03c0d212c445990b36fda24"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
