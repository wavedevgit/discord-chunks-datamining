...
function eM(e) {
  ...
  n.append("build_id", "44088042e5c8f41f2fe8ad88aa48e9bbb6370c8f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
