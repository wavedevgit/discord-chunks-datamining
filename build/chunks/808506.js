...
function ek(e) {
  ...
  n.append("build_id", "bd7857cf44e67ef4d8bd03b7eb077687d35a026b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
