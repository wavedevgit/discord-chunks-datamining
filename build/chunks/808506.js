...
function ex(e) {
  ...
  n.append("build_id", "cc549f68f64b1f409f1b49414693dabf0e09246e"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
