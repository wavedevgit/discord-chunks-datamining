...
function eM(e) {
  ...
  n.append("build_id", "e8b249753702398103a748665e83993382f97da8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
