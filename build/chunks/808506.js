...
function eM(e) {
  ...
  n.append("build_id", "2f23ed866cf848f29ee7b952ee2d51a553a95f2e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
