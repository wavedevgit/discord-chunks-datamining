...
function ek(e) {
  ...
  n.append("build_id", "e7ac2d9b907061fb9f22fa965b69c5a1f5915970"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
