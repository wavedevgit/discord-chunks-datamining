...
function ek(e) {
  ...
  n.append("build_id", "42bf26903759180610a53d03a041fe688096948b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
