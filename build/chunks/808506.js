...
function ek(e) {
  ...
  n.append("build_id", "5f2cfd3d7dcb86f7a1ab5064d843827825afac6e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
