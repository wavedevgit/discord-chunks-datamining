...
function eM(e) {
  ...
  n.append("build_id", "2f03bb88c0b0346ba429c0794aea1965606b535a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
