...
function eM(e) {
  ...
  n.append("build_id", "38f57c86bbd9afd313f1d0607edef0901b8326ca"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
