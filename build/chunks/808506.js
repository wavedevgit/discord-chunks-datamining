...
function ek(e) {
  ...
  n.append("build_id", "6e953e5687e9c1c0e92776916243fca696bdd9b8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
