...
function ek(e) {
  ...
  n.append("build_id", "d39716eac2eac57d234841f1e7243d15ed5f2254"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
