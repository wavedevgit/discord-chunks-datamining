...
function eM(e) {
  ...
  n.append("build_id", "a63eb495419322374bf0bd16a0d426ed3e1ba8cc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
