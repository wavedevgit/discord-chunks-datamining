...
function ek(e) {
  ...
  n.append("build_id", "00b2877c5f081b4e2b008e3d5c3456a353604626"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
