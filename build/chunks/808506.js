...
function ek(e) {
  ...
  n.append("build_id", "d83464a440ee64279dc4494e65b737fb78dc8354"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
