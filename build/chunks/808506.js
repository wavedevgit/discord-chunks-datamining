...
function ex(e) {
  ...
  n.append("build_id", "44060f1dec2d5189cf15b4a42d072e77ee645183"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
