...
function eM(e) {
  ...
  n.append("build_id", "2235fa61cd74e16d4ef73147eb454c77a1468a7f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
