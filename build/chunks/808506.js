...
function eM(e) {
  ...
  n.append("build_id", "bb45293716240ae96396513a689948464e00923b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
