...
function ex(e) {
  ...
  n.append("build_id", "dad8d5d79503f9100df9b02f525eee64d946318c"), n.append("rpc", String(t)), n.append("rpc_auth_token", X), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
