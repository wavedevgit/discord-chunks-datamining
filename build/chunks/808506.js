...
function ek(e) {
  ...
  n.append("build_id", "c32c58a9696b0dbf54cabab138010f2d8be681ff"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
