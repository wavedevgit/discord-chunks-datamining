...
function ex(e) {
  ...
  n.append("build_id", "73bbe5fe4a3447d1072a88f0b618c081219bb11a"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
