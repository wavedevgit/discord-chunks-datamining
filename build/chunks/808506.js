...
function eM(e) {
  ...
  n.append("build_id", "fcbcb797b7fc11f12987f0db153fe8ac21488f90"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
