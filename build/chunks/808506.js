...
function eM(e) {
  ...
  n.append("build_id", "8c3b2c994d6a88cb573e8a1df327eaead4aeaed8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
