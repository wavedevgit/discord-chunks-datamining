...
function eM(e) {
  ...
  n.append("build_id", "c0deb31cedd5f4f0348720b9020c7b6fc06430d8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
