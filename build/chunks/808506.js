...
function eM(e) {
  ...
  n.append("build_id", "0432ce6aee5b190f20b4e6ce6c05f28cd220cdce"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
