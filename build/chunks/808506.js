...
function eM(e) {
  ...
  n.append("build_id", "eab0f093bf38405a15d8c81a1564e4077146e696"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
