...
function ek(e) {
  ...
  n.append("build_id", "523e50ccc6b731f9a067e54965e6b637a0bec26e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
