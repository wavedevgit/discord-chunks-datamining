...
function eM(e) {
  ...
  n.append("build_id", "5ed50159ce2464786be9158b4df503189cac662c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
