...
function ek(e) {
  ...
  n.append("build_id", "e5a07aa3a075135577fa7f91bb3ca8c6dc730c1f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
