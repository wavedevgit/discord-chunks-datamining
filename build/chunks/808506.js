...
function eM(e) {
  ...
  n.append("build_id", "2f5e6db0c5ff796b298a1f77cde866727c5c521e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
