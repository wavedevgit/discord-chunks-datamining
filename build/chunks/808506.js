...
function eM(e) {
  ...
  n.append("build_id", "405de189630a4c474bb24a23be9257b713ce12d9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
