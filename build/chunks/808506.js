...
function ek(e) {
  ...
  n.append("build_id", "428fc0726156c86907364b02ecec0992269ffcd7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
