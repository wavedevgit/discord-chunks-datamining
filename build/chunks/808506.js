...
function eM(e) {
  ...
  n.append("build_id", "f92f7419b880675ceb843261a052af51250ba2ba"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
