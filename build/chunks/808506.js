...
function ek(e) {
  ...
  n.append("build_id", "29e8c5d802fecfd268215a73777d35bc8089f5d7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
