...
function ex(e) {
  ...
  n.append("build_id", "cc8c30832072cf692592d2a7deb3c850d797c2a9"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
