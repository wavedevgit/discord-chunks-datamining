...
function eM(e) {
  ...
  n.append("build_id", "0808eb82e69df669b03df3e0ccaef5568a01e34a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
