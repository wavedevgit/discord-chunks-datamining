...
function eM(e) {
  ...
  n.append("build_id", "31fa0c517102541370ab70411138ff343c6f4f40"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
