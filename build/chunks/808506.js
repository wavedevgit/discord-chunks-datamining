...
function ek(e) {
  ...
  n.append("build_id", "edef814b9682ea9815ff1cbf1720e05522b6cd08"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
