...
function eM(e) {
  ...
  n.append("build_id", "03226a2e72d9de5721dea252e0b03fa44249de5a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
