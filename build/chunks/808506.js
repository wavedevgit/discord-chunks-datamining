...
function eM(e) {
  ...
  n.append("build_id", "ca1691d459b51368dca63c762717f2db2799a908"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
