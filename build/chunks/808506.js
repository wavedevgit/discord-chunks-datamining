...
function ek(e) {
  ...
  n.append("build_id", "7fe45466031dad9e87bd5993736e8a2925dcd5de"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
