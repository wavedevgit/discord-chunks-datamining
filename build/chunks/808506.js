...
function ek(e) {
  ...
  n.append("build_id", "9f829d9d10fd9c6ff715f1e8dd05f33c2a150324"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
