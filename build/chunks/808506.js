...
function eM(e) {
  ...
  n.append("build_id", "192086336321825e841af9b1d6dfbf951e5c14a0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
