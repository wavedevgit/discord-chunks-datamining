...
function ek(e) {
  ...
  n.append("build_id", "830c5a80ba0196d2740a06e381c3861906980a01"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
