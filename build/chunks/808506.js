...
function ek(e) {
  ...
  n.append("build_id", "6ac2d5eaf2916588e908cb6b35bd3f6328192d40"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
