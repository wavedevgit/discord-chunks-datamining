...
function ek(e) {
  ...
  n.append("build_id", "1fb137abcf312b8471f89396c8000c82201382b9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
