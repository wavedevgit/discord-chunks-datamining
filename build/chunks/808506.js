...
function eM(e) {
  ...
  n.append("build_id", "5fbbc14eac07ec922620de35dcde0565363cca17"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
