...
function ek(e) {
  ...
  n.append("build_id", "ca3130fb90f13a94668cdbc77beb5fd0915dd079"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
