...
function ex(e) {
  ...
  n.append("build_id", "7e19c2ba0e5d6ee7099758915f6061f877952233"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
