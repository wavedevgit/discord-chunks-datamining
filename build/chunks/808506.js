...
function eM(e) {
  ...
  n.append("build_id", "164c9000a661c7993e45aba30a8b7fbcd67d5f1e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
