...
function ek(e) {
  ...
  n.append("build_id", "7d0d2abed883b166d354954403965b9610c40576"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
