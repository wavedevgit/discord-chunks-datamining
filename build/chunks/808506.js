...
function ek(e) {
  ...
  n.append("build_id", "348a5fec0125f01f0d5a70f72e11c0fbc1b64a5f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
