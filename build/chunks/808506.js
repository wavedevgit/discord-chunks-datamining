...
function ex(e) {
  ...
  n.append("build_id", "bc3fa122498cdbb685001d65021869cee9b2ee8e"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
