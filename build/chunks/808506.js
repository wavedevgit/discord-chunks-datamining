...
function ek(e) {
  ...
  n.append("build_id", "cc962668d14301ec162e9f96070295e71c019ff6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
