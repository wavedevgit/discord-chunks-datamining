...
function ek(e) {
  ...
  n.append("build_id", "a8958e4d2345e616eb22c85bea9ecbb96eac2baf"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
