...
function eM(e) {
  ...
  n.append("build_id", "1319359bc781398a6db000fa6b4f726e0c8545bd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
