...
function eM(e) {
  ...
  n.append("build_id", "8b18ce7fb43018448c249e8b38390c4872710e3b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
