...
function eM(e) {
  ...
  n.append("build_id", "9ca8f5e1805c3724ca8bc08288f2a70c2708902a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
