...
function ek(e) {
  ...
  n.append("build_id", "13d7137af09d92c6d9f058379af443b54621f68c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
