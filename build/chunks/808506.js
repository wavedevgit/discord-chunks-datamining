...
function ek(e) {
  ...
  n.append("build_id", "2a90b738f92b0e82ec4f70e777366a05f7f5d5c9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
