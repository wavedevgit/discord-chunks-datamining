...
function eM(e) {
  ...
  n.append("build_id", "895c6402527d78adb67947563c99c199e94a7f33"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
