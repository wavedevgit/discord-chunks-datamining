...
function eM(e) {
  ...
  n.append("build_id", "d1bf009040301f3112ce662d3661790db501bda2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
