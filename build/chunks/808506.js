...
function eM(e) {
  ...
  n.append("build_id", "a7580482f4128734a2d8b14e923ed9c7f1369b4c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
