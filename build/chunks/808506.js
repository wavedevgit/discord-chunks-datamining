...
function ex(e) {
  ...
  n.append("build_id", "a0e5c876d034c5319ab757fcca83e774aaa0fcbb"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
