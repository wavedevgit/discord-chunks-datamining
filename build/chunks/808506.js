...
function eM(e) {
  ...
  n.append("build_id", "6aa730029f6d006b284e836cfbe129bfbc1cd601"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
