...
function ek(e) {
  ...
  n.append("build_id", "5e7438a724b5fac061f0aad4dfc6fff3a0373f6b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
