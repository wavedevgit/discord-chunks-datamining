...
function ek(e) {
  ...
  n.append("build_id", "45f5944788129870623db5bc8a8b2bf19f900904"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
