...
function ek(e) {
  ...
  n.append("build_id", "70d80bc87d54278a47376011b579651662c2f289"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
