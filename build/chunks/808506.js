...
function eM(e) {
  ...
  n.append("build_id", "c8deaf94097f0640cb7d63cd91e3c59e765de128"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
