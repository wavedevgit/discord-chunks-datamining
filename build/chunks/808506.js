...
function ek(e) {
  ...
  n.append("build_id", "d4b2a79c41a05fb12b276aabf7f33ee7b5776685"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
