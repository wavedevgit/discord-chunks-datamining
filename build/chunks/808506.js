...
function ek(e) {
  ...
  n.append("build_id", "97ecc264e3de93ecd1477fbaccb59541dc82a6fa"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
