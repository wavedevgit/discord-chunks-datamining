...
function ex(e) {
  ...
  n.append("build_id", "64a0d1c159dc58695a904f68f8fea4f82a54001d"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
