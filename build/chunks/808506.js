...
function eM(e) {
  ...
  n.append("build_id", "2f9aee70c55f081dbb50777cf7a3e7d6bd226105"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
