...
function eM(e) {
  ...
  n.append("build_id", "5e8def898d0e3d3904f54c2a29a4c7c777798fd8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
