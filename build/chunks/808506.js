...
function ex(e) {
  ...
  n.append("build_id", "3a6e7a498b8448929aed2982107fc337eca407a3"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
