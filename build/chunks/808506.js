...
function eM(e) {
  ...
  n.append("build_id", "9acbe57f588c009ca2de1aae04bea82bff5ad3e1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
