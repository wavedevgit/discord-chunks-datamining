...
function ek(e) {
  ...
  n.append("build_id", "12b3fc8dc3c41524fb9542b13459f073a3d9b93e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
