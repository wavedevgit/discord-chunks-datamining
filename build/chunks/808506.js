...
function eM(e) {
  ...
  n.append("build_id", "348422ce9505cee6451f3bc306a15e5f8885dc55"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
