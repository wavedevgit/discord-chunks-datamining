...
function eM(e) {
  ...
  n.append("build_id", "ba4c748a9e421007f2e1a5dae093604f9a63a87f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
