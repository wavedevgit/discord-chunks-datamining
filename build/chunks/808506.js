...
function ek(e) {
  ...
  n.append("build_id", "6f93d3940894784478a03f53d8a85c3ddd44019d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
