...
function eM(e) {
  ...
  n.append("build_id", "b8a9b9b89a4f4635351d2eae6c268dff2cd4302f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
