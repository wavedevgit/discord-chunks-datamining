...
function eM(e) {
  ...
  n.append("build_id", "986f4d1df49a39adc7fcb10f8d29bdbfa739616e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
