...
function eM(e) {
  ...
  n.append("build_id", "8805335e10784535dbc6f51a09773773dba14e3b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
