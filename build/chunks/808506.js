...
function eM(e) {
  ...
  n.append("build_id", "dfc9aa89fed9300226fb25743badf54a6edff5a5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
