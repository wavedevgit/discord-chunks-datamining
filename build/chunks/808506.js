...
function eM(e) {
  ...
  n.append("build_id", "63f34234d46b1d5ed31e2feb5db7a5f089831b7b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
