...
function eM(e) {
  ...
  n.append("build_id", "f5f1245401e5672ac8cc696e336d1d9e7d3ab88f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
