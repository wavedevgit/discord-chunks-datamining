...
function ek(e) {
  ...
  n.append("build_id", "501fd652b91449eb3a5f987d57ade81cdad3c3ae"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
