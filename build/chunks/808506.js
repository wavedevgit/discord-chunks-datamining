...
function eM(e) {
  ...
  n.append("build_id", "dbe97afb083bd6d130387d3df4b8522631ba3331"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
