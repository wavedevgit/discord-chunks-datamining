...
function ex(e) {
  ...
  n.append("build_id", "b0b0f9b7a611a995b6287cdbec9ba7d01c3984ef"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
