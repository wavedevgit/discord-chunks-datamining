...
function eM(e) {
  ...
  n.append("build_id", "f3e2da35cc5b55de2dd58ab4614382515f7d4961"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
