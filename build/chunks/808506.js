...
function ek(e) {
  ...
  n.append("build_id", "ac4bec21f3c27cf1fec178e76c7134e6bba366c9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
