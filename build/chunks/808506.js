...
function eM(e) {
  ...
  n.append("build_id", "062d947b24797a471fd6eb1f99ed168df8b11b30"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
