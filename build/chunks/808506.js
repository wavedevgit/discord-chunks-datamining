...
function ek(e) {
  ...
  n.append("build_id", "a6ea869247f536892a4ab022f6e1a7de90221ced"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
