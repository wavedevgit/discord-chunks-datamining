...
function eM(e) {
  ...
  n.append("build_id", "db79ab88f060ff9fbc67cd751da476d56468cb45"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
