...
function ex(e) {
  ...
  n.append("build_id", "b3ba3114457814278d4e0ed66f579f44e0c0e5ed"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
