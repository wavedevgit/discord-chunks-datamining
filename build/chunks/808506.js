...
function eM(e) {
  ...
  n.append("build_id", "643fb5c3c30c34494107e7a2a6cc8ab233bfeae8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
