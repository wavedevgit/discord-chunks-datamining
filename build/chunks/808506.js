...
function ek(e) {
  ...
  n.append("build_id", "f547ae7d7b339fe2c905e3413cb12fd77e829453"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
