...
function ek(e) {
  ...
  n.append("build_id", "b9ee8d48b90c82792668a4a09589e7dee811d13d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
