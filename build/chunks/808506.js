...
function eM(e) {
  ...
  n.append("build_id", "ed73e238a006596c4b0f3b318a585aa8957f3d81"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
