...
function eM(e) {
  ...
  n.append("build_id", "f729b7f57a1c719d774218d0763f6f1858dc35db"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
