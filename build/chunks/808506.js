...
function ek(e) {
  ...
  n.append("build_id", "f1de997e346957abf48981e8ff4ff5a5e30265f7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
