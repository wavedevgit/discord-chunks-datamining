...
function ek(e) {
  ...
  n.append("build_id", "19fd0b5a6bead88246109412df61833cdea739bd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
