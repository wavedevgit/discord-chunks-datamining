...
function eM(e) {
  ...
  n.append("build_id", "ac91bce7535dc0758a39803fd532cecc0d8ab702"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
