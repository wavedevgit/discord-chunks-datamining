...
function eM(e) {
  ...
  n.append("build_id", "5e421682ffcff92934b227ddf5cabde752874c3b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
