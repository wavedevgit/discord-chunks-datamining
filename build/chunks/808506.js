...
function ek(e) {
  ...
  n.append("build_id", "ab94fb0c5f5caa84c909426bfcee9abb0aa1b5be"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
