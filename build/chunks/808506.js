...
function eM(e) {
  ...
  n.append("build_id", "52b150b5e37865a1e7c92f0d47537f694b732f47"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
