...
function eM(e) {
  ...
  n.append("build_id", "09525448f774d9746ed053ca09fbdb4cf80d643f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
