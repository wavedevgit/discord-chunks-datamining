...
function ek(e) {
  ...
  n.append("build_id", "87ad4412ca2e01a0aa77a2b4fd9624f5b803906f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
