...
function ek(e) {
  ...
  n.append("build_id", "d39d574f48c9460b147ec23a4e05b65655f35f3c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
