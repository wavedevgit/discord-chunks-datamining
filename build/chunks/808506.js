...
function eM(e) {
  ...
  n.append("build_id", "1788448d930c496a06d3e10622ae14a8569d09f7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
