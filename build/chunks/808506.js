...
function ek(e) {
  ...
  n.append("build_id", "cc2332e3d955a279c103b39956aad100e3222c92"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
