...
function eM(e) {
  ...
  n.append("build_id", "a983dfec387cf2fdb1548cc4497705e2fab6922a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
