...
function eM(e) {
  ...
  n.append("build_id", "e718e1e51634df58e2902d1d9f04d855230da421"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
