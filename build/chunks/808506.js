...
function ek(e) {
  ...
  n.append("build_id", "4d57448e8add881a338966917796f8ac37a4ed61"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
