...
function ek(e) {
  ...
  n.append("build_id", "17c49b56e41536ed00e34482c9c6157611460ba6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
