...
function ek(e) {
  ...
  n.append("build_id", "e371a9c433118ab491cd8389d9f1c5db21d1e194"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
