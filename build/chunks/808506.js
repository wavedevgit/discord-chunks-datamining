...
function ek(e) {
  ...
  n.append("build_id", "f3ce9ca344dd525b00e42775f885b2dc2039e8b5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
