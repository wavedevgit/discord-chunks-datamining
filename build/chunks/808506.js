...
function ek(e) {
  ...
  n.append("build_id", "a99d9a6152cc1a34d6eb37d78fcdd65634f6633f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
