...
function eM(e) {
  ...
  n.append("build_id", "430b74d7e3904cdd6124586beec1b2c6d1340602"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
