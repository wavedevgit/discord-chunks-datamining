...
function eM(e) {
  ...
  n.append("build_id", "16cc72143f20df715a6e3798f8c20df846aa435f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
