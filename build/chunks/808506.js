...
function ex(e) {
  ...
  n.append("build_id", "db2437729db61ab19270c9aabc51f4624fc583fa"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
