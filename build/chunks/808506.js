...
function eM(e) {
  ...
  n.append("build_id", "f85354ad191dc37e25778654736bf59b2a277e6f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
