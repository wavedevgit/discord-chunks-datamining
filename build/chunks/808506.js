...
function eM(e) {
  ...
  n.append("build_id", "b1ea3a39f03407f58d2ddd2632967598a0954bff"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
