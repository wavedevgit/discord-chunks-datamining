...
function eM(e) {
  ...
  n.append("build_id", "ce3acd86f5ddece3852b8d745dd24d9b4ea4f47f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
