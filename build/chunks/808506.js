...
function eM(e) {
  ...
  n.append("build_id", "1535efb869f5cf1648b77e529fe9b9df488b0e5b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
