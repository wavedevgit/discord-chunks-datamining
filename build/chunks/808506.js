...
function eM(e) {
  ...
  n.append("build_id", "be7878e7b0fe145f7162ffcfae6bef22dd8d85d7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
