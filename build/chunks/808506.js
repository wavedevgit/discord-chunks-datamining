...
function eM(e) {
  ...
  n.append("build_id", "6a848d183381f689a93b73c4c1625a10c9b6e9da"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
