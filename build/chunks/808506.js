...
function ex(e) {
  ...
  n.append("build_id", "beb99723fc04d518f532700b901b6c7dfcd29c75"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
