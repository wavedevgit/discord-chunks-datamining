...
function ex(e) {
  ...
  n.append("build_id", "54945ca29a788bf898df1360e51f1010c70518b3"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
