...
function ex(e) {
  ...
  n.append("build_id", "ed7e84d255557184a440f6966984aa774647aa51"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
