...
function ek(e) {
  ...
  n.append("build_id", "a4978a5cefaf42104330ceaf470c2e13d00a619e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
