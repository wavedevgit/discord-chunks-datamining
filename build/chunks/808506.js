...
function eM(e) {
  ...
  n.append("build_id", "c68feac32ad0ffee6613815e39a35c92ea2a466f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
