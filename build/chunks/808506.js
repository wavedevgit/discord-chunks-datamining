...
function eM(e) {
  ...
  n.append("build_id", "41392e1e9e255b1dab98a0bedaefd959aa286f39"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
