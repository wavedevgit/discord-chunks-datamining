...
function eM(e) {
  ...
  n.append("build_id", "a68f235558e1dbd1ce281fa8d2e1d95d372fef87"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
