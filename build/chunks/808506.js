...
function eM(e) {
  ...
  n.append("build_id", "5820de495fdbbd64daf1978541d8c1c3bc1ea6e6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
