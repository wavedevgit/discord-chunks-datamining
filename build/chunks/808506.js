...
function ek(e) {
  ...
  n.append("build_id", "85b4e267fcd7b338a285c3d29caefaf3bf2d0c67"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
