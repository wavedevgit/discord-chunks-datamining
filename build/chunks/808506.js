...
function eM(e) {
  ...
  n.append("build_id", "4dd49c1395f9fad467b80bd522a2ec2ff7a195f8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
