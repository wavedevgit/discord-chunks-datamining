...
function eM(e) {
  ...
  n.append("build_id", "a26565a8d75384e138f2bf49b26c978b3d0b652f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
