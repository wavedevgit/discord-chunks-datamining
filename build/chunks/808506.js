...
function ek(e) {
  ...
  n.append("build_id", "0cf339fbe7c7defcfca9fc996240573acf8baae5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
