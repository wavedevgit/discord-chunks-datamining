...
function eM(e) {
  ...
  n.append("build_id", "933f9d05f90681138c3bf95fe310e46fca032af6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
