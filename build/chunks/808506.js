...
function ek(e) {
  ...
  n.append("build_id", "9daa3e017533769a0e8962a05a5a7f09a0abd4a4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
