...
function eM(e) {
  ...
  n.append("build_id", "869cfecf5d19f46f7fd589ddbbcce9f749b60db0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
