...
function eM(e) {
  ...
  n.append("build_id", "c05ccabbf7fdcc272501264b075ee904400f773b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
