...
function eM(e) {
  ...
  n.append("build_id", "b01a2bcb56b606664695711e28022f2f51739475"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
