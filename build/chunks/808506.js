...
function ek(e) {
  ...
  n.append("build_id", "1bc347ad70bcc11c31bbbdca25f1ced38ca65fcb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
