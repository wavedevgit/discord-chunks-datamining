...
function ex(e) {
  ...
  n.append("build_id", "0c46fcc773c1342079b6d85ccd5042f7e3e7e67c"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
