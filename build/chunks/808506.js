...
function eT(e, t, n) {
  ...
  ec(e, B({}, a)), (0, d.te)(k.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(k.OVERLAY_LAYOUT_ID), 0, {
...
function eC(e) {
  switch (eo && ea.info("[app data received]", e), e.type) {
    case j.BmY.CONNECT:
      ...
      if (null == t) break;
      (0, d.te)(k.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(k.OVERLAY_LAYOUT_ID), 0), Promise.all([(0, v.Z)(t, e.pid), a.ZP.PersistedStore.getAllStates()]).then(t => {
        let [n, r] = t, {
          pid: i,
          token: o
        } = e;
        g.lW({
          ...
          token: o,
          payloads: [n]
        }), eh(i, "READY"), (0, k.setPID)(i), f.Z.overlayReady(i);
        let a = el(i);
        ec(i, V(B({}, a), {
...
function ek(e) {
  ...
  n.append("build_id", "d4175f0c8dc0e53168964143377158951b68dbc1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
