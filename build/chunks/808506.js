...
function eM(e) {
  ...
  n.append("build_id", "6a6a804604af4e34c3ce58eed1afbeac3f31dfae"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
