...
function ek(e) {
  ...
  n.append("build_id", "ea499018d22be792ec71299c619db0ff5671a6a7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
