...
function ek(e) {
  ...
  n.append("build_id", "d3acc8dc0493b40ed08c36967b222686b4e4ceb1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
