...
function eM(e) {
  ...
  n.append("build_id", "bbf1aad6f49f6a112deb996727fa1e03bfcc2801"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
