...
function ek(e) {
  ...
  n.append("build_id", "667350695665017435477ade0c40c216c67a4564"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
