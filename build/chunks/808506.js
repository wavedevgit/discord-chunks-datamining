...
function eM(e) {
  ...
  n.append("build_id", "19cbaa82684fe3af1471704afa144638c13db1ac"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
