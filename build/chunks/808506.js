...
function ex(e) {
  ...
  n.append("build_id", "eed62d03bc684b38fe705db3b8cb3d148cdcf992"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
