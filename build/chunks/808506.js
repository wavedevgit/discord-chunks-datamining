...
function eM(e) {
  ...
  n.append("build_id", "02d5a36e5f01b4040ae09a7374bd05986b3ae5ef"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
