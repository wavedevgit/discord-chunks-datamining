...
function eM(e) {
  ...
  n.append("build_id", "ac8add8e3a5f0a809f31af464ae90a07c9deed29"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
