...
function ek(e) {
  ...
  n.append("build_id", "5d4c4c707b6f909c2d4520b749f4786cd60617ae"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
