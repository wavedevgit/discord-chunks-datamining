...
function ex(e) {
  ...
  n.append("build_id", "10bd4ce6ebecb50d0807df12f3799c947dcb6789"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
