...
function ek(e) {
  ...
  n.append("build_id", "7795bb7562895399edc176980718af096f24ef0d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
