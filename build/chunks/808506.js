...
function eM(e) {
  ...
  n.append("build_id", "e0a0928eabc215c60214a284c05d7e9eeca483c3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
