...
function ek(e) {
  ...
  n.append("build_id", "976e90f9afaf0ebc4a2f61ab41eb2f1a921e14f8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
