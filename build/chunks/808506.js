...
function eM(e) {
  ...
  n.append("build_id", "f927acace4118b46614a375022ee6261bf50d7b3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
