...
function eM(e) {
  ...
  n.append("build_id", "93c03199342258bafe74e2d112c44088c9ce42a1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
