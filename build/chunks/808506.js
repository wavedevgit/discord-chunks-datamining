...
function eM(e) {
  ...
  n.append("build_id", "759a05e70fee473a6818166a9ec734d43d0e9792"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
