...
function eM(e) {
  ...
  n.append("build_id", "3f16c0689caed25ccbd05088d25bb5606c97d361"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
