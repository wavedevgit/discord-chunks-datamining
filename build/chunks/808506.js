...
function eM(e) {
  ...
  n.append("build_id", "80e7447eab0fbbc16fcf9f127e01e79220de0cc4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
