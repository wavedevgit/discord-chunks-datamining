...
function eM(e) {
  ...
  n.append("build_id", "8b5171223051877c929c935b21f8f9e19ab0d414"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
