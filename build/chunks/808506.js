...
function eM(e) {
  ...
  n.append("build_id", "5cef987ff530087b773d7a6cbb08713ae10723e5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
