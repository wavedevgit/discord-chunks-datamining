...
function ex(e) {
  ...
  n.append("build_id", "bb739f45a0bfed066671793cdd6b94753a727c51"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
