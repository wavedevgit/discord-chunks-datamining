...
function ek(e) {
  ...
  n.append("build_id", "46a5e7205f6c3c15fca722e8dc7236284c902101"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
