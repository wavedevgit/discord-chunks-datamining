...
function eM(e) {
  ...
  n.append("build_id", "642588015b040ccc6bd8df6cb13cd8856967375b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
