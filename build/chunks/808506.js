...
function ek(e) {
  ...
  n.append("build_id", "36dff39cd38de77f373c964972291537f83d0661"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
