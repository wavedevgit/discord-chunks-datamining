...
function ek(e) {
  ...
  n.append("build_id", "eb09a01a5437c8f58f4646bdbf4763fd1ccee232"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
