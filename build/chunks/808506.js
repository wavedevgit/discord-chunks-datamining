...
function ek(e) {
  ...
  n.append("build_id", "534771155c259e8b03ba8341f053d415d15ef519"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
