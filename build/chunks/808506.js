...
function ek(e) {
  ...
  n.append("build_id", "0478aa282c914ca8262dace39c5a0892e62033ea"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
