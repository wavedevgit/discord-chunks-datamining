...
function eM(e) {
  ...
  n.append("build_id", "402e10644c250d1fca8695342db298ee2f85b0cd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
