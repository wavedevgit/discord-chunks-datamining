...
function ex(e) {
  ...
  n.append("build_id", "9d420b0398c54c8ef6e82eb1e6aac2c47422d887"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
