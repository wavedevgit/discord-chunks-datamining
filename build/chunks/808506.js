...
function eM(e) {
  ...
  n.append("build_id", "73decd25fe94fa0f34ca3f4244425e3f8eb63bee"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
