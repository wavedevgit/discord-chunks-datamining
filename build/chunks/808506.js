...
function ek(e) {
  ...
  n.append("build_id", "a76dce6e18b58410e4c06e9c7af6f48cf7fa72a8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
