...
function ek(e) {
  ...
  n.append("build_id", "b3edffe492ea69df409c1f4d9d658cb78f02741f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
