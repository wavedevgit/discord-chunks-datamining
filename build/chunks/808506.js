...
async function eb(e) {
  ...
  if (eo.verbose("updateIntendedOverlayPIDs", {
      isConnectionOpened: $,
      action: e
    }), ef.isMutexHeld() || eo.error("updateIntendedOverlayPIDs: overlayMutex is not held.", e), !$ && null != e) return void eo.verbose("updateIntendedOverlayPIDs: Connection is not opened while updating applications.", e);
  async function r(e) {
    if (!(e in H)) return;
    let t = H[e];
    delete H[e];
...
function eS(e, t, n) {
  ...
  ec(e, B({}, o)), (0, d.te)(k.OVERLAY_LAYOUT_ID, R.Z.getDefaultLayout(k.OVERLAY_LAYOUT_ID), U.bv, {
...
function eC(e) {
  switch (ea && eo.info("[app data received]", e), e.type) {
    case M.BmY.CONNECT:
      ...
      if (null == t) break;
      (0, d.te)(k.OVERLAY_LAYOUT_ID, R.Z.getDefaultLayout(k.OVERLAY_LAYOUT_ID), U.bv), Promise.all([(0, I.Z)(t, e.pid), o.ZP.PersistedStore.getAllStates()]).then(t => {
        let [n, r] = t, {
          pid: i,
          token: a
        } = e;
...
function ek(e) {
  ...
  n.append("build_id", "08508b88c5fb4920d290a69e280fad08d041fa58"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
