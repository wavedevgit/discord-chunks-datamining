...
function ex(e) {
  ...
  n.append("build_id", "8486eff4d91bce3a02e03cf95686e58396b3c66c"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
