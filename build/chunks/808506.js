...
function eM(e) {
  ...
  n.append("build_id", "4139eda40ee402932fe533d5a877271af87fb6d0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
