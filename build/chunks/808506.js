...
function ex(e) {
  ...
  n.append("build_id", "1918433e798f0256f7843b5bb7199be7f7b1230b"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
