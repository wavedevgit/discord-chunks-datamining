...
function eM(e) {
  ...
  n.append("build_id", "d30a98790df9f2ad34ab3707478c974add616a09"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
