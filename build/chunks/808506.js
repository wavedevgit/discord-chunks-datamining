...
function eM(e) {
  ...
  n.append("build_id", "d98269a454331e5e67d3f656f6b185497b312f92"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
