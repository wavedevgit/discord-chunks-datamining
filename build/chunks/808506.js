...
function ek(e) {
  ...
  n.append("build_id", "2fe0aff8a4a059dd014086a86dafe0985d5eb9a8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
