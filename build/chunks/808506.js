...
function eM(e) {
  ...
  n.append("build_id", "bda05edf091337533fb105b2f8fbb8a7b9a7e592"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
