...
function ek(e) {
  ...
  n.append("build_id", "09117711ef01602c22fd16acc0df3ada84497bbd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
