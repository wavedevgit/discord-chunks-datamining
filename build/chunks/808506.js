...
function ek(e) {
  ...
  n.append("build_id", "a8441ed4b680761f202c040afa38146d700ae5df"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
