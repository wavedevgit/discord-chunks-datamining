...
function eM(e) {
  ...
  n.append("build_id", "38030db6a3c7d05f8edc2ce63d3a486160ef215c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
