...
function eM(e) {
  ...
  n.append("build_id", "2cf630af1ea0a8a71bd659c7650f911b6af14f43"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
