...
function ek(e) {
  ...
  n.append("build_id", "a9470692ab54b87196bf63aa9d03340889e0a153"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
