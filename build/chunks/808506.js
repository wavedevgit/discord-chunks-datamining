...
function ek(e) {
  ...
  n.append("build_id", "3bca1f7b9f817a1026e61013d370b460afe1a3bb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
