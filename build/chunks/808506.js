...
function ex(e) {
  ...
  n.append("build_id", "fa233f1b34d3bb26598cf6405a9af28d843f130f"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
