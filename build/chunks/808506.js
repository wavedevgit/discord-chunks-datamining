...
function ek(e) {
  ...
  n.append("build_id", "8ec62e2a1ebe6b33b03a0013a035e462109956f3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
