...
function eM(e) {
  ...
  n.append("build_id", "eb93ed82f405c45490065a3d886eced6d0171f38"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
