...
function ek(e) {
  ...
  n.append("build_id", "b8987271df059c1dbabb4e5c452ab9512f3cedba"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
