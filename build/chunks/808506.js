...
function eM(e) {
  ...
  n.append("build_id", "8b0baf577403be267d11bb1c81aefda04186883b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
