...
function eM(e) {
  ...
  n.append("build_id", "2e63a45d3f9db6a7e1d040576745bfbc3e91bafe"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
