...
function ek(e) {
  ...
  n.append("build_id", "72c8de56afb72eb0c877045b9d34859da9887c09"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
