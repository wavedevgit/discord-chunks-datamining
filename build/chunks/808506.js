...
function eM(e) {
  ...
  n.append("build_id", "b50bd40256be57f76fee29d438351aaca4441ab2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
