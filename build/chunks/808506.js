...
function eM(e) {
  ...
  n.append("build_id", "672f64ed83783449867a85357b18c48b3b8ccfee"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
