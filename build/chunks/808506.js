...
function ex(e) {
  ...
  n.append("build_id", "eaf54e911cb4612aae7565b098759ecddcbd3471"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
