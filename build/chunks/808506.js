...
function eM(e) {
  ...
  n.append("build_id", "32c305871f3c1fe491527c137e6fea7751fd145e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
