...
function ek(e) {
  ...
  n.append("build_id", "fefbf4b4ce2858aff7d80fdfdf35a7e3362be05a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
