...
function eM(e) {
  ...
  n.append("build_id", "3667d133e771e04e48e3f67137b5f942610cf7eb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
