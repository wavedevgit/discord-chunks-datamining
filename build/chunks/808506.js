...
function eM(e) {
  ...
  n.append("build_id", "3c01408cba3889aef93335ef732cba2e474e293a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
