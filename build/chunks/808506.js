...
function eM(e) {
  ...
  n.append("build_id", "6235777f72e594b4b3b2535bfdbde0daa89d706b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
