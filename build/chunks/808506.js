...
function ex(e) {
  ...
  n.append("build_id", "7646977e832417fd7f897b29c7050d57bc58bb8d"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
