...
function ek(e) {
  ...
  n.append("build_id", "8ad5fd3a9a1a8b3a11083cca4dc5d8a17aa4cd18"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
