...
function ex(e) {
  ...
  n.append("build_id", "49c3867fb31e0d1e0824954aa475b3df3ceec71d"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
