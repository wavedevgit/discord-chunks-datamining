...
function ek(e) {
  ...
  n.append("build_id", "8439ed63a4676a6458999e926e8765628c68c525"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
