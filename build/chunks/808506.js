...
function ek(e) {
  ...
  n.append("build_id", "76e0688934671e1283b30ff9615165d0c1894122"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
