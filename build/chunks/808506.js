...
function ek(e) {
  ...
  n.append("build_id", "4665aa6fb0f542d30acc5285e87bf28d8e76fcb4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
