...
function ek(e) {
  ...
  n.append("build_id", "d1acb4ce9b3cd196775a333ccb190f39c8c6135c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
