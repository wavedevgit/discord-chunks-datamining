...
function eM(e) {
  ...
  n.append("build_id", "552ef17ff9ddd334636bc61389f09683141ef6b6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
