...
function eM(e) {
  ...
  n.append("build_id", "c3e0823c568395c9b698d9757ea744fa0dc54672"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
