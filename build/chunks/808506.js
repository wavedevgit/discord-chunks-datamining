...
function ex(e) {
  ...
  n.append("build_id", "23ec3ecb80322f2389973b9e5eaa4edf31bd0f20"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
