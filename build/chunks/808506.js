...
function ek(e) {
  ...
  n.append("build_id", "9dcfc2f44b2d833574ae16d5c749039aa047196f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
