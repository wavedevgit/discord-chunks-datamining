...
function eM(e) {
  ...
  n.append("build_id", "2b3a68c7ec2e45f2878ae12787a1afb4d29471af"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
