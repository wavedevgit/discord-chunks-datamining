...
function eM(e) {
  ...
  n.append("build_id", "bf83bfd6d77d1db157cb2bac040878a1690bf3fc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
