...
function ex(e) {
  ...
  n.append("build_id", "ef335c7062307bd2afda0f775b092d4da87e0bcf"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
