...
function ex(e) {
  ...
  n.append("build_id", "44aa2dfae11127c5871d613e3ea364e25c19534e"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
