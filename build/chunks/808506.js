...
function ek(e) {
  ...
  n.append("build_id", "21329ee01cbce77abdfe9b6f8cc931aa7079ef4a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
