...
function eM(e) {
  ...
  n.append("build_id", "217f2b4560159fb01114a5f8a0b6bff18ad8463c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
