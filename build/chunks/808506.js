...
function eM(e) {
  ...
  n.append("build_id", "e9927f721b59ed1957cb28f92b1505c334182d87"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
