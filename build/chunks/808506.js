...
function eM(e) {
  ...
  n.append("build_id", "b26083393fdbbf965e01b5d6290d2164f08bfdf5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
