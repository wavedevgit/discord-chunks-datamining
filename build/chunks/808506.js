...
function eM(e) {
  ...
  n.append("build_id", "a466bdab6f064afd70bc782a0de185f3ffee123b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
