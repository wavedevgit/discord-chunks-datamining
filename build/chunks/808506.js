...
function ek(e) {
  ...
  n.append("build_id", "13de088a921cdf82551222ed54dc693f26318804"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
