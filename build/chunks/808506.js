...
function eM(e) {
  ...
  n.append("build_id", "f54735cebedfbbbc535afb8668ccbbaaf1fcc42c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
