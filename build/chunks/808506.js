...
function eM(e) {
  ...
  n.append("build_id", "ecf3cf0ff446909e6c1c9d15dc36291fd67916ef"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
