...
function ek(e) {
  ...
  n.append("build_id", "00f95d1b0062826848244e2a6283e9b830bf1eba"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
