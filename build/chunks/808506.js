...
function ex(e) {
  ...
  n.append("build_id", "c3a816192a128367dfe475a67c881b73675c20e0"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
