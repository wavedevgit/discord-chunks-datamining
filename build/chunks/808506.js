...
function eM(e) {
  ...
  n.append("build_id", "27dac42ecf6bc7bca13daa531bec326dc6a17429"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
