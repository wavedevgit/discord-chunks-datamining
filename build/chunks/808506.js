...
function ek(e) {
  ...
  n.append("build_id", "32a5f3bce0bcea17c282d6895de61ed12e05294b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
