...
function eM(e) {
  ...
  n.append("build_id", "601ef5200c3d110363d31e1692365d2d790b99ba"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
