...
function eM(e) {
  ...
  n.append("build_id", "c2832c3d2c31d702649c72ba2625f14cc1ae8c69"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
