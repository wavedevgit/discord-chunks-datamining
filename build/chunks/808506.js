...
function eM(e) {
  ...
  n.append("build_id", "4adee68f70ea99f05c8a863956968cbc61d300a8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
