...
function ek(e) {
  ...
  n.append("build_id", "09cf632c9461df3460ce4fe7714218f1bc34e90f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
