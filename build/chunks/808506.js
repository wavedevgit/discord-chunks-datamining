...
function ek(e) {
  ...
  n.append("build_id", "5b5bcbb7dc0decd898b3bf0dfeb1862498538879"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
