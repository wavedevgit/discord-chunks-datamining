...
function eM(e) {
  ...
  n.append("build_id", "bf6d9614acf9f657481552efbd040c4756245b96"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
