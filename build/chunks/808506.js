...
function ek(e) {
  ...
  n.append("build_id", "503e30f3c352e90f70146fa7032a044e2e8fafe1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
