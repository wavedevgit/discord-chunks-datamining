...
function ex(e) {
  ...
  n.append("build_id", "b422e96c2dbcdc2fe3a1a78afd132382a93e18c9"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
