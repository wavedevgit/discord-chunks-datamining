...
function ek(e) {
  ...
  n.append("build_id", "80e343015c1397be5867e3f614b98ff2bdf4029a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
