...
function ek(e) {
  ...
  n.append("build_id", "d49a1d2f5f4d903527998e40041590850ddb1ee6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
