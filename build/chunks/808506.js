...
function eM(e) {
  ...
  n.append("build_id", "2a8040f4c57218ba630242a2d7bf3e9c8f99f472"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
