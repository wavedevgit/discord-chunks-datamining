...
function ek(e) {
  ...
  n.append("build_id", "fa847a529ccc5ba16fddadaa3cfbfd39869e11da"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
