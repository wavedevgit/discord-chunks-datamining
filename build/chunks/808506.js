...
function ex(e) {
  ...
  n.append("build_id", "db3b9d0113dff4a5a1bbb27eaa26e357ea9cf166"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
