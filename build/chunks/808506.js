...
function eM(e) {
  ...
  n.append("build_id", "796615c2f6af4fe1b6763f0dcd1870092b3ba3ee"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
