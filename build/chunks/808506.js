...
function eM(e) {
  ...
  n.append("build_id", "cc54fe30be09bfb9aa222b8402421b54ce8aba2f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
