...
function ex(e) {
  ...
  n.append("build_id", "0eafaa53fd8bbb9ae50afe8af7c73f648efd1cf1"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
