...
function ek(e) {
  ...
  n.append("build_id", "27b7f7e1a7b72df6cd51b2305613d6580b5899ac"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
