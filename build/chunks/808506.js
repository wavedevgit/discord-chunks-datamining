...
function ek(e) {
  ...
  n.append("build_id", "64285a30bca22de6dae139abea7b64612a4163b7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
