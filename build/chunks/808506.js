...
function ek(e) {
  ...
  n.append("build_id", "2ad1952a568b176b84d22afced8d17bde7ad379f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
