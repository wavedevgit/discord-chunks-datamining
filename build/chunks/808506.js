...
function ek(e) {
  ...
  n.append("build_id", "026a30f6148b11ba35b1ffa92b535c02fa72a1ae"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
