...
function ek(e) {
  ...
  n.append("build_id", "1d9f6177e800a63314b0ef88c50146db032b16a1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
