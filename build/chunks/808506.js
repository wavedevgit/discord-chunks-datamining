...
function ek(e) {
  ...
  n.append("build_id", "170abde4d4abebf2c1805f608a061074a53d820d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
