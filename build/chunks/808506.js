...
function ex(e) {
  ...
  n.append("build_id", "0acde342ad9b6e1a380eb344846dc27e5ce6e74e"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
