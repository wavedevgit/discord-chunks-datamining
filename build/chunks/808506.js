...
function eM(e) {
  ...
  n.append("build_id", "31d15caa0eecbdfe8a3fca00135cb6635339f76e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
