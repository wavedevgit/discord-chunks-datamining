...
function eM(e) {
  ...
  n.append("build_id", "c46c12adb30db3e32f7170556192ab2e0ca8ee2e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
