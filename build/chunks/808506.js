...
function eM(e) {
  ...
  n.append("build_id", "be5663272b51bcc49633f4c988dacfd295576479"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
