...
function eM(e) {
  ...
  n.append("build_id", "753a9438b34f77600ec5e4803083718f1ffb87f6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
