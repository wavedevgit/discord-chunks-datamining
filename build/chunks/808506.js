...
function ek(e) {
  ...
  n.append("build_id", "510f7159d1d36090c08af05ae8639d6db315c8cb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
