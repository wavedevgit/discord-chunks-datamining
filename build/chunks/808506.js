...
function eM(e) {
  ...
  n.append("build_id", "188a51edaa7bc538c040edf44346f2306c52bd82"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
