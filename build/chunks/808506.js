...
function ek(e) {
  ...
  n.append("build_id", "f1ad1201b8814186a40c3d7af29afa745514bef1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
