...
function eM(e) {
  ...
  n.append("build_id", "b06bf57d6045ffe7763ffcd61bff373933777954"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
