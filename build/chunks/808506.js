...
function ek(e) {
  ...
  n.append("build_id", "4dc7062acbff3a667624a5a7200d32f237493a3f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
