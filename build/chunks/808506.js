...
function eM(e) {
  ...
  n.append("build_id", "c4c761df3716197fd5480b9e544aa879945addf1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
