...
function ek(e) {
  ...
  n.append("build_id", "3562fcafab750e173d174e3876002f43d93a37ff"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
