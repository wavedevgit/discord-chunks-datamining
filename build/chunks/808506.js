...
function ek(e) {
  ...
  n.append("build_id", "18f1e0c3bfd3aebd6125b6ca3a59de9122523f17"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
