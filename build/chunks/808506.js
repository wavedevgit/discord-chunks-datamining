...
function ex(e) {
  ...
  n.append("build_id", "473460db0d8f6f0e56490d256c4572072689b7cc"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
