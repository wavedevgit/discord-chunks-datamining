...
function eM(e) {
  ...
  n.append("build_id", "a2b05576d3a5a2c1405184712a90a99e3f6f7186"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
