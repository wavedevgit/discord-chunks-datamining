...
function ek(e) {
  ...
  n.append("build_id", "111d5bfdb199cd6def1983a6f00627bdab52b458"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
