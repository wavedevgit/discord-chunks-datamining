...
function eM(e) {
  ...
  n.append("build_id", "0f53623afb33acd3ab27eaa152201b50e9ee66fd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
