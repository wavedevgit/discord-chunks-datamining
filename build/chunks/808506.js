...
function ek(e) {
  ...
  n.append("build_id", "504dd9a13653d27cc66c2a3bfe8b7abbd6d3b921"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
