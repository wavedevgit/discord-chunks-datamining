...
function eM(e) {
  ...
  n.append("build_id", "97348e8d416ad6850bb608ae0db782533e48c5e8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
