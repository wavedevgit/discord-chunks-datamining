...
function ek(e) {
  ...
  n.append("build_id", "888b5564f035fd988fe8ae939516a451c93509ec"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
