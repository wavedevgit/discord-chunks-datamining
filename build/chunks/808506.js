...
function eM(e) {
  ...
  n.append("build_id", "91777e4295803cff65e0210eef2fe4364859d1d5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
