...
function ex(e) {
  ...
  n.append("build_id", "1efd5b4ed98c654f20700e7a1335d8f358d6ccd7"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
