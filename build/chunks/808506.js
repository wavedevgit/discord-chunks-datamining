...
function ek(e) {
  ...
  n.append("build_id", "2e0ca35e01b0781c2e460c3f52b6268e0d535e2d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
