...
function eM(e) {
  ...
  n.append("build_id", "ac8aa904cbf9fd1b9610e63b90bb92b4a78ffdba"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
