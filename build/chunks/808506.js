...
function ek(e) {
  ...
  n.append("build_id", "b1e1720bdd835a90ecaa1252ec0964ae46ccb04f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
