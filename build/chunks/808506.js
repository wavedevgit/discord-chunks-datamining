...
function ek(e) {
  ...
  n.append("build_id", "18861c32004c10db65dda5998bb195bf018735ee"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
