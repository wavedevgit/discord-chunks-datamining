...
function eM(e) {
  ...
  n.append("build_id", "a2d7d04f8db6a6ead1d34bf6cdc60c5ef284d67d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
