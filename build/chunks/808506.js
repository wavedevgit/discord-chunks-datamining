...
function ek(e) {
  ...
  n.append("build_id", "a576acbaea45c3cd4d47525107e7e6580a8da9e9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
