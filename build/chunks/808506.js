...
function eM(e) {
  ...
  n.append("build_id", "f790d76eba39fa99bfa6c045a9735916f6a8ee31"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
