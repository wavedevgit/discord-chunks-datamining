...
function ek(e) {
  ...
  n.append("build_id", "0696cc900896192ed62a56ad20fb5e1981c0a17a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
