...
function ex(e) {
  ...
  n.append("build_id", "87509ca4462f920c7c60bc90713d42d3b7d28a5e"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
