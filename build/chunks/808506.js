...
function ek(e) {
  ...
  n.append("build_id", "fab52c589ab743cc3672e8a4551dda0eb71be3c6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
