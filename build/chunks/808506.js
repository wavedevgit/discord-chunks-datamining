...
function eM(e) {
  ...
  n.append("build_id", "40be1409857e3d053fdede74fe3298ee5210ba05"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
