...
function eM(e) {
  ...
  n.append("build_id", "da9b2991590a953a350a784651f4199b9fe35be8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
