...
function eM(e) {
  ...
  n.append("build_id", "ed29cd261f842f8d22aab6f388626cd1c5ca9981"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
