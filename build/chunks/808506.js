...
function ek(e) {
  ...
  n.append("build_id", "011450fc786c6c9412530e3eb36cea244760a241"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
