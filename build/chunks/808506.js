...
function eM(e) {
  ...
  n.append("build_id", "048b486fc5710e1a020b4a28e616dd2b5a7031a2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
