...
function eM(e) {
  ...
  n.append("build_id", "aa57f8d37b20a606c73243555cdff896cb3ddcfe"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
