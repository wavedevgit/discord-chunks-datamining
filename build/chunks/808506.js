...
function eM(e) {
  ...
  n.append("build_id", "d82238737d7bb066b3c0e3fa7e4a9bab6b2fff37"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
