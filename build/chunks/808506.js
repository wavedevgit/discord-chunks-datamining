...
function eM(e) {
  ...
  n.append("build_id", "872b2a845aa7a1f5050b6faa5ba7a2afb2fc7fc6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
