...
function ex(e) {
  ...
  n.append("build_id", "3277d8e037965afa3c762c2995858fa2eea745ee"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
