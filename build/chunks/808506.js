...
function ek(e) {
  ...
  n.append("build_id", "88ba6af94534ab1da205595e439fee36b061758c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
