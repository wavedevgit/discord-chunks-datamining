...
function eM(e) {
  ...
  n.append("build_id", "a69812d2742fb2bfc321b98546c219c958f264c1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
