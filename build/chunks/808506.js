...
function eM(e) {
  ...
  n.append("build_id", "e6e31b1cd0abf8569ff2bf05aa945652677bb07e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
