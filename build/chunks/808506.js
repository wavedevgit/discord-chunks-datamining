...
function ek(e) {
  ...
  n.append("build_id", "1b78dff09816f170ba1c83100492bfa3b85d71dd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
