...
function eM(e) {
  ...
  n.append("build_id", "f6d4a56eafbe0ef58ddce7e8a200e3b2f51a7301"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
