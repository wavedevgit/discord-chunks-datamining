...
function ek(e) {
  ...
  n.append("build_id", "43c097f0d1f0955f2ecb45c9bfcdb3d53160a66c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
