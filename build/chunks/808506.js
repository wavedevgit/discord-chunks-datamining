...
function eM(e) {
  ...
  n.append("build_id", "75a78281f92d08d4d505672aed7a46a61e2ef989"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
