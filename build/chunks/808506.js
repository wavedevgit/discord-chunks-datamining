...
function ex(e) {
  ...
  n.append("build_id", "f6c0baad01a2dc866ec35a2368b567fca0088c14"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
