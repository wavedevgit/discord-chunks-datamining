...
function ek(e) {
  ...
  n.append("build_id", "8a657f077af6cc75ddf5eea0b9490674c1a07d82"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
