...
function ek(e) {
  ...
  n.append("build_id", "8821896ba5b64e2f18c5e1e7b497621614f3711b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
