...
function ex(e) {
  ...
  n.append("build_id", "a762ece330c64ee5ffc0d6d487494239836d1b7b"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
