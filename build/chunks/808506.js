...
function eM(e) {
  ...
  n.append("build_id", "b5e76bb5a94679a69325e7fface5cbd876d56985"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
