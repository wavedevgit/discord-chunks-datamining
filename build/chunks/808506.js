...
function eM(e) {
  ...
  n.append("build_id", "713da1168983be45fe4fbcfad5c716412ddbdac2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
