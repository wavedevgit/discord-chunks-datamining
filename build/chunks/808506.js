...
function ek(e) {
  ...
  n.append("build_id", "d4772b9b61a670ea86087f95b081c53c7ed8c99d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
