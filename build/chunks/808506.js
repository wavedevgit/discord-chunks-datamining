...
function ex(e) {
  ...
  n.append("build_id", "88f354164b474f82441a2f1fbf5b63c4e887ec79"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
