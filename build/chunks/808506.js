...
function ek(e) {
  ...
  n.append("build_id", "813042b7922fb440bcd444c87f76a0f5d13abfcf"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
