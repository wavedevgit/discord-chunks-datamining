...
function eM(e) {
  ...
  n.append("build_id", "531f587309b7dbeb503d7bfca708c02c7ed64d80"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
