...
function ek(e) {
  ...
  n.append("build_id", "00dfa6d69e8210015d680cf42cbc7eec46913518"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
