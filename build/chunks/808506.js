...
function eM(e) {
  ...
  n.append("build_id", "8c6d618899e0815a306c1d8b7fd6f08502b66efe"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
