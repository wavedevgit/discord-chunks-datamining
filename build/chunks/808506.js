...
function eM(e) {
  ...
  n.append("build_id", "8d867ecd45e4c40937749b465515141bc8df43a6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
