...
function eM(e) {
  ...
  n.append("build_id", "ba0a785e4553bcb3554b4e3530c0fad73f3d375b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
