...
function eM(e) {
  ...
  n.append("build_id", "3aa68956f8f981414c055065a28554899a56b048"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
