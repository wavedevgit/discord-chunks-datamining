...
function ek(e) {
  ...
  n.append("build_id", "4f9c4873a25ed9373dbfdf4ffd981b88f259f2fd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
