    ...
    case j.BmY.CONNECT:
      ...
      (0, d.te)(M.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(M.OVERLAY_LAYOUT_ID), U.bv), Promise.all([(0, I.Z)(t, e.pid), o.ZP.PersistedStore.getAllStates()]).then(t => {
        ...
        g.lW({
          ...
          token: a,
          payloads: [n]
        }), eh(i, "READY"), (0, M.setPID)(i), _.Z.overlayReady(i);
        let o = el(i);
        ec(i, F(B({}, o), {
...
function eM(e) {
  ...
  n.append("build_id", "5c63e7ca0531a5770eb29f7c1309e7b0e3f31c63"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
