...
function ek(e) {
  ...
  n.append("build_id", "cdc7287d263f2652af6a9561bc3dac31c67f33d4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
