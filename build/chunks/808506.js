...
function ek(e) {
  ...
  n.append("build_id", "35cf4735964802357d9dcf8da164fe0e197c40ae"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
