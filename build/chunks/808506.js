...
function eM(e) {
  ...
  n.append("build_id", "f9023c9900b3ce807ab4a34e65eac22b6721bbf0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
