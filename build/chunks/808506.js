...
function ek(e) {
  ...
  n.append("build_id", "876b6854086ea16fdbe95cf8bcf3321fe8a0b88f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
