...
function ek(e) {
  ...
  n.append("build_id", "fda57162cd2d4f38b0858371971a4db0f9b6fdf4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
