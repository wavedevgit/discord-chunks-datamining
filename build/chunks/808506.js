...
function ek(e) {
  ...
  n.append("build_id", "9ea8db254e5f018efa1aff82b1ba0c4f4bb19b2b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
