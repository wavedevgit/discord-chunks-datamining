...
function ek(e) {
  ...
  n.append("build_id", "2defbc739ddf1ba315b3f5c75e5dca312e202e8d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
