...
function ek(e) {
  ...
  n.append("build_id", "2b67554430c14f89e6f3db7bc5602b958c8ae38c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
