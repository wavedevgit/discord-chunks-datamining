...
function eM(e) {
  ...
  n.append("build_id", "8a4ac4835e680adcf0d10210e8dfa2041755991b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
