...
function ex(e) {
  ...
  n.append("build_id", "d5c96b39d6f5e53bf0a2b948504fb267766a7e4e"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
