...
function ek(e) {
  ...
  n.append("build_id", "66a84767c279a384c243962c6365c8f3c2649fb3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
