...
function ex(e) {
  ...
  n.append("build_id", "cbb92a28c415631a7f5997158ec3dfd8ec1eabda"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
