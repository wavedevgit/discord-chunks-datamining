...
function ek(e) {
  ...
  n.append("build_id", "70fbbfc3aa3027d6df4503a6761d83dcaa51c84b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
