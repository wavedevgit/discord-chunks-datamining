...
function eM(e) {
  ...
  n.append("build_id", "2add09057d083675ccf3766579812729fdc3ee88"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
