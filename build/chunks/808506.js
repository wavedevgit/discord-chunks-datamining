...
function eM(e) {
  ...
  n.append("build_id", "05544358203718e11a3e66e72b95dad422e41550"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
