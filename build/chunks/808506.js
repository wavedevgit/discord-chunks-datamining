...
function ek(e) {
  ...
  n.append("build_id", "52bce92b3c8be846fd79d8ddfaf340340e1a4390"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
