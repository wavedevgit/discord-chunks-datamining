...
function eM(e) {
  ...
  n.append("build_id", "3f3111f4eb0aec5123928a9706075ad688fede16"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
