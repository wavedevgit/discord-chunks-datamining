...
function ex(e) {
  ...
  n.append("build_id", "8010601c891f07e74f5292ba339c2c958c659213"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
