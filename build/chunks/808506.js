...
function eM(e) {
  ...
  n.append("build_id", "cd7e03388013dffeca782c6b337fe7b44d95041c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
