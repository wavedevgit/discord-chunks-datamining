...
function ek(e) {
  ...
  n.append("build_id", "17912aa98d37fd387f90ee93ead1eb98ab189ff8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
