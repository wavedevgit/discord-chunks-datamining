...
function ek(e) {
  ...
  n.append("build_id", "d7ebf36720224fc62b6135340f7c60baba96d22c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
