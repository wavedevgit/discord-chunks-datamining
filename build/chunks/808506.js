...
function ek(e) {
  ...
  n.append("build_id", "13ca4305124953d7c6ddbbfff8c60059f13063e7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
