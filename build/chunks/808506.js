...
function ek(e) {
  ...
  n.append("build_id", "767ed47eb7ea8b43cc685113249a9fbc4966f853"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
