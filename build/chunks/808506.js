...
function eM(e) {
  ...
  n.append("build_id", "1db5fdcd93a1957ee3d0e3c7e3fb804ddced080f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
