...
function eM(e) {
  ...
  n.append("build_id", "b505c7a63c47be116019ab38aec880ca08e8e7aa"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
