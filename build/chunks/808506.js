...
function ek(e) {
  ...
  n.append("build_id", "07bd425c5a18fb04ae6d81aafaa730333db1ef61"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
