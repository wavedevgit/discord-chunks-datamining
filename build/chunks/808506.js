...
function eM(e) {
  ...
  n.append("build_id", "b516452a77c965fb11de661d481abd5392428642"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
