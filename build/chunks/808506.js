...
function ex(e) {
  ...
  n.append("build_id", "f0142675bdddecc56047a43706594a75b74545ac"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
