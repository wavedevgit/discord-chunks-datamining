...
function ex(e) {
  ...
  n.append("build_id", "e55ffa47f4a585c274945869c6b59d435eae8ce0"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
