...
function eM(e) {
  ...
  n.append("build_id", "8ff9459a0bab8dc86880076d2fcc5361eb28ae5c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
