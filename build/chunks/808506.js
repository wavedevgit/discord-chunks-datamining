...
function eM(e) {
  ...
  n.append("build_id", "9165666dacd3a7e3d38023e524ac9a81ee152c5d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
