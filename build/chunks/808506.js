...
function ex(e) {
  ...
  n.append("build_id", "f28dc930dc853797ad458f6df6dea84ca30354a2"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
