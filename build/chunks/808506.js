...
function eM(e) {
  ...
  n.append("build_id", "c53adf138de78a83e4352c739f82dedfb32257e2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
