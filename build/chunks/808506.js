...
function eM(e) {
  ...
  n.append("build_id", "11d0a65cb538253415901e461f5bcd336217131a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
