...
function ek(e) {
  ...
  n.append("build_id", "ed075dc4f5b0fd4e912ed330a32b9b6a2d4b90c5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
