...
function ek(e) {
  ...
  n.append("build_id", "83e9fe35a8f0b5c7c564df374ffa68296a3c98ef"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
