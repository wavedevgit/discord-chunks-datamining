...
function ex(e) {
  ...
  n.append("build_id", "9ece6b8de1dd40d536621cdeda7aae963fe0767b"), n.append("rpc", String(t)), n.append("rpc_auth_token", X), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
