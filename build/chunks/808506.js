...
function ex(e) {
  ...
  n.append("build_id", "8175bd32b6c8469d95c806744a2935c433ba60f3"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
