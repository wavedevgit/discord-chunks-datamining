...
function eM(e) {
  ...
  n.append("build_id", "768b6fcdb0d90f0333b3c9ac360ab18add3c5c36"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
