...
function ex(e) {
  ...
  n.append("build_id", "90c5a74bceffe37855f49d7c52146f428a43bb4e"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
