...
function ek(e) {
  ...
  n.append("build_id", "df91f60f28a0feabf9dfbe08162f220d980327d1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
