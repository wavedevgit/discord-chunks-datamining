...
function eM(e) {
  ...
  n.append("build_id", "6e7e964535ed0dc83cf7ebcc0fb0ec958745857d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
