...
function ex(e) {
  ...
  n.append("build_id", "ee609e14ce28e98412aa1264dcbb113d4da3e439"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
