...
function eM(e) {
  ...
  n.append("build_id", "174e51a086449381ceec6fc53408b92b4bada9c0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
