...
function ek(e) {
  ...
  n.append("build_id", "3905b4c37403e6a576881d8d0eeaa58382b029cf"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
