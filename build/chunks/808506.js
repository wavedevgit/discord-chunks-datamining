...
function eM(e) {
  ...
  n.append("build_id", "3af091a36de0b7be790546eb326755ff873e4e5d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
