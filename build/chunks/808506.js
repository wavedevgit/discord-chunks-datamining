...
function eM(e) {
  ...
  n.append("build_id", "b87467d2919b48c3d0d47ee805da507045a6a075"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
