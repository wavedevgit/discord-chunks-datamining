...
function ex(e) {
  ...
  n.append("build_id", "6d260a58f13887d63d32c36b88a76a759835877a"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
