...
function ek(e) {
  ...
  n.append("build_id", "80ca6d385ca1849d595c6a593202b3432d4793f6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
