...
function eM(e) {
  ...
  n.append("build_id", "f932769075d63a2a285c6954b00b5254ac52cda9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
