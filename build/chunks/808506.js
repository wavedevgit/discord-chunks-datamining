...
function eM(e) {
  ...
  n.append("build_id", "200551b578741bb2eb448daefd9b4954f4de6053"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
