...
function eC(e) {
  switch (eo && ea.info("[app data received]", e), e.type) {
    case j.BmY.CONNECT:
      ...
      if (null == t) break;
      (0, d.te)(M.OVERLAY_LAYOUT_ID, R.Z.getDefaultLayout(M.OVERLAY_LAYOUT_ID), 0), Promise.all([(0, v.Z)(t, e.pid), a.ZP.PersistedStore.getAllStates()]).then(t => {
        let [n, r] = t, {
          pid: i,
          token: o
        } = e;
...
function eM(e) {
  ...
  n.append("build_id", "d4968b9272f79aaed85685dc2a3d2f8ae0f7143b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
