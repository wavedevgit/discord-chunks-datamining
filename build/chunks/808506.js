...
function eM(e) {
  ...
  n.append("build_id", "9a1bd466982a0ead1c300780cbf6ebd27b1e118f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
