...
function eM(e) {
  ...
  n.append("build_id", "3fb98a24ffc186c93212965c48bc2e3e7542f0f0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
