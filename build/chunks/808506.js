...
function ek(e) {
  ...
  n.append("build_id", "e68234b8a549ddc2c2372995d6344a4b73ce2f9e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
