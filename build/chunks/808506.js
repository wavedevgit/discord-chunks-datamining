...
function eM(e) {
  ...
  n.append("build_id", "a50aafab8ad1a7bbca4bfdefb153219d3d7fcd9f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
