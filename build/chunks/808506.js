...
function ex(e) {
  ...
  n.append("build_id", "94e4f0822ef189103807737fda2525de97be3a0d"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
