...
function ek(e) {
  ...
  n.append("build_id", "cbfba2486f2aedf1f28ad45c8ddc534464e7111f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
