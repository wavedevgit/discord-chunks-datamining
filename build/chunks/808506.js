...
function ek(e) {
  ...
  n.append("build_id", "a47cd9ef307a04c6cb0ba03eafc647c177930ca6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
