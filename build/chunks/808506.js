...
function eM(e) {
  ...
  n.append("build_id", "24ca4255a6b685a5054af3480b85dc6731c9b55b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
