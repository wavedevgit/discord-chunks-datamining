...
function ek(e) {
  ...
  n.append("build_id", "19e0a4067c621e133e98605fd86dc1805a403cf9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
