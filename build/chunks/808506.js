...
function ek(e) {
  ...
  n.append("build_id", "2821c075a2cf40e092341d03d9086a7053df0c75"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
