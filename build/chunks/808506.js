...
function ek(e) {
  ...
  n.append("build_id", "a8a27a8d2ddf5ddac48504eed636f84f60af3b7f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
