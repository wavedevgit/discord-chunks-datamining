...
function ek(e) {
  ...
  n.append("build_id", "a74b7244b46917e1d78cb7e1a6a00b11a2a5635f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
