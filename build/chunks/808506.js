...
function eM(e) {
  ...
  n.append("build_id", "14fd633dc98e82c4ad6370a35380883e3457a21a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
