...
function ek(e) {
  ...
  n.append("build_id", "8bbde9194edcfe2097829ad96d2e9173c68de859"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
