...
function ek(e) {
  ...
  n.append("build_id", "588773ce337500f4b56b45cbc67f3bcb6b2a9241"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
