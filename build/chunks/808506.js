...
function eM(e) {
  ...
  n.append("build_id", "4900f66a3452decc7cc97d10ce05692357ea4ded"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
