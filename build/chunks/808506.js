...
function ek(e) {
  ...
  n.append("build_id", "9969305ad45b7c94739148bb247f53a1dfbbce12"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
