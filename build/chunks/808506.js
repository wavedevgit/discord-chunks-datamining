...
function ek(e) {
  ...
  n.append("build_id", "28f7b44937a31b2338403468de1a6d8644cd2b4e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
