...
function ek(e) {
  ...
  n.append("build_id", "96b14dd04cc3b505cfe43ed67b0e020b0a164742"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
