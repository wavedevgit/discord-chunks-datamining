...
function eM(e) {
  ...
  n.append("build_id", "942a14edd1dfd784e3262b56abd272d9f0d9a7d8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
