...
function ek(e) {
  ...
  n.append("build_id", "5aa20adf9baf5b5781b45a8175505acb2f626d0a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
