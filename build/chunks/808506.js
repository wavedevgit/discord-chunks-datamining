...
function eM(e) {
  ...
  n.append("build_id", "932f9c1ab2c4473db15e93d8de2638f461093757"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
