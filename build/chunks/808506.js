...
function ek(e) {
  ...
  n.append("build_id", "379394544b08c844d8b4a77a56dcd5b24173e0e5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
