...
function eM(e) {
  ...
  n.append("build_id", "26d77201640ade9dda39b96d7ed24df986192343"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
