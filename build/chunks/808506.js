...
function eM(e) {
  ...
  n.append("build_id", "2a356583d4e4e4886401088da2c203ae3d40a220"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
