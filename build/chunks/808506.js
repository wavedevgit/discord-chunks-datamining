...
function eM(e) {
  ...
  n.append("build_id", "7c79d92178725024d364960ee9ea3312d015a43b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
