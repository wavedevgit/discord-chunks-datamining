...
function ek(e) {
  ...
  n.append("build_id", "d9f6b12151b2e2d4c2b3ee1889acc653a9ab0a0a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
