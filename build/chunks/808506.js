...
function ek(e) {
  ...
  n.append("build_id", "6f2373b33cd9aa66b8cbf1e6d67baee700522af7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
