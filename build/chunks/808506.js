...
function eM(e) {
  ...
  n.append("build_id", "04cfa7209650a1380b732adc1c6a3df14d185d20"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
