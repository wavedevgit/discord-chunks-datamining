...
function eM(e) {
  ...
  n.append("build_id", "3547d6dcbf9cd8cad588fda2e59e7b65034c962a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
