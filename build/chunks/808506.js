...
function eM(e) {
  ...
  n.append("build_id", "c8cbe14ad759428b6c6d324fd53b572add3038d6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
