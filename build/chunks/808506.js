...
function eM(e) {
  ...
  n.append("build_id", "a67f10225645036d4c54fb2dab6eb6f1780ff72a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
