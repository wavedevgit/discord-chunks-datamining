...
function eM(e) {
  ...
  n.append("build_id", "368c1682e4d763ad682df4de20170d1652daa970"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
