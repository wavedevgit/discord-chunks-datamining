...
function ek(e) {
  ...
  n.append("build_id", "8a212317e6a0400f3ce00b2da6f5d7fc854a694b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
