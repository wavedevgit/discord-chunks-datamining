...
function ex(e) {
  ...
  n.append("build_id", "c4d6aae00308adb387108953412a020ab51a8d21"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
