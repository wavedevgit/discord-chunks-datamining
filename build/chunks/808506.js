...
function eM(e) {
  ...
  n.append("build_id", "29b5ca0e760d868e95ce9cb2b947e5f036191dff"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
