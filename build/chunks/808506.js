...
function eM(e) {
  ...
  n.append("build_id", "1e2e226946226bc4b96ffa19dad9f990a41b8f8f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
