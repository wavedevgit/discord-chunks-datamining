...
function ek(e) {
  ...
  n.append("build_id", "002c25ae27d2cc41fc0116bf8067f79a98959500"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
