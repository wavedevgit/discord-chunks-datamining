...
function eM(e) {
  ...
  n.append("build_id", "1be79bdcc31abab569fa504ffc2e698272c3c4df"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
