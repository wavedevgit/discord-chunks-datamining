...
function ek(e) {
  ...
  n.append("build_id", "0536ad2451f7ca66340297587465a7b8bf1e0555"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
