...
function eM(e) {
  ...
  n.append("build_id", "968219b8b84d2c06d88eb0ee9ed8d6ec85b573b4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
