...
function ex(e) {
  ...
  n.append("build_id", "14acfa7d2c77caf9574df439e30248074d671368"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
