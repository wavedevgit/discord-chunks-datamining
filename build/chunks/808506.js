...
function ex(e) {
  ...
  n.append("build_id", "c4d8857f4036fef173c40116897cc1896b0b59c6"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
