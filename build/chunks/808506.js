...
function eM(e) {
  ...
  n.append("build_id", "7aa8f717394541c04ff1d8b28f5e199b467278b4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
