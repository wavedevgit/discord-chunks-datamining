...
function ek(e) {
  ...
  n.append("build_id", "8e202f7fb568541c4d2f6f6cc8b63b11cdb25750"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
