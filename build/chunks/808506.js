...
function eM(e) {
  ...
  n.append("build_id", "8cea1b14277556b9aa2e8107ca07b5c6ab2b2804"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
