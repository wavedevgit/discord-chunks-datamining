...
function eM(e) {
  ...
  n.append("build_id", "e652000950f34f1e55724d05ff2fb9afeef0c96f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
