...
function eM(e) {
  ...
  n.append("build_id", "61fea1160f1e1615b558136ca9b0a8d59c9ab23d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
