...
function ek(e) {
  ...
  n.append("build_id", "848c152bec64eb5afdf9fd47637f045ea9145929"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
