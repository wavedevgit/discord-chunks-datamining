...
function ek(e) {
  ...
  n.append("build_id", "1e9efdebb7e100e79ecb81864a9c7c473e7bfcd7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
