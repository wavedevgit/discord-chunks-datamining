...
function eM(e) {
  ...
  n.append("build_id", "b66fecdf792676e13ba5de52f89ec9e16aa4cbd7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
