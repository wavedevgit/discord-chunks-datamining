...
function eM(e) {
  ...
  n.append("build_id", "6685183a417e985840921382db175763be514b83"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
