...
function ek(e) {
  ...
  n.append("build_id", "43f292db994cfaf43bf23453fe6894b20183a239"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
