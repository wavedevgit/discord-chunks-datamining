...
function ek(e) {
  ...
  n.append("build_id", "46b507f9d68af40486ec4476fd542945df480f71"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
