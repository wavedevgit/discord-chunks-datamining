...
function ek(e) {
  ...
  n.append("build_id", "62ca6dd10a4256bd3db29ac0ddd35a596382ffe5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
