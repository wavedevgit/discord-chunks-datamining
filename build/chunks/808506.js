...
function ek(e) {
  ...
  n.append("build_id", "f9449c511d365fe507882e59a876968b7bd77f58"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
