...
function ek(e) {
  ...
  n.append("build_id", "5919904ba4165642f01f71f0748fcab266c39d02"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
