...
function ek(e) {
  ...
  n.append("build_id", "b0b746ccd88494019ea4baa6485dbfb2a56a872b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
