...
function ek(e) {
  ...
  n.append("build_id", "c212b1b00601f36930769e5ef126a7a43688dd01"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
