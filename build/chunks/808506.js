...
function eM(e) {
  ...
  n.append("build_id", "1f5b2971c603d62a9c93919dbef92699924e00bd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
