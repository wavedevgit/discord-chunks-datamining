...
function ek(e) {
  ...
  n.append("build_id", "c7b9875779f74393e67951efbbfb57a83a42f6ff"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
