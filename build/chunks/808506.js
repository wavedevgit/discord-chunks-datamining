...
function ek(e) {
  ...
  n.append("build_id", "782666cb366eb81191aa0ca40f0e8894f0ab431b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
