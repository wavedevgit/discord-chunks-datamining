...
function ek(e) {
  ...
  n.append("build_id", "e655da683ddad857fe060061b0d4569b1833a0ae"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
