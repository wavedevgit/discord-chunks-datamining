...
function ek(e) {
  ...
  n.append("build_id", "dd41b9fa13b44771118c31294369254ec79d6a11"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
