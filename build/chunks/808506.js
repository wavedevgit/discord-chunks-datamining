...
function eM(e) {
  ...
  n.append("build_id", "1092e14d4b5f7cf9b34317897a1db6685129553e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
