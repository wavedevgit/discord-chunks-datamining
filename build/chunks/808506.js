...
function ek(e) {
  ...
  n.append("build_id", "aa4bc487a391ff5084ab76fbaadaaafbe312494f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
