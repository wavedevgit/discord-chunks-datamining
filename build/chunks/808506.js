...
function ex(e) {
  ...
  n.append("build_id", "8970fdad1ac2c55586ba7fe0ba867b90a399e07f"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
