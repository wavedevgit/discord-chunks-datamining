...
function ek(e) {
  ...
  n.append("build_id", "f1bc56eeee12fa6772abb2e4d430490213923194"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
