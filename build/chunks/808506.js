...
function eM(e) {
  ...
  n.append("build_id", "7b2ecc6fb347bc5804a461eb9f58c8e5d3ed989d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
