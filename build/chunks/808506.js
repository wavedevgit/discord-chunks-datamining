...
function ek(e) {
  ...
  n.append("build_id", "0bc9d389160a6fb9307461fd78bdba8fd0a98123"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
