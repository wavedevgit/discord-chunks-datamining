...
function ek(e) {
  ...
  n.append("build_id", "6aba6f852aeb8f7e6f9d0602823a3b580edb62b9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
