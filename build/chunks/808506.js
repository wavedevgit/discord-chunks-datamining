...
function ek(e) {
  ...
  n.append("build_id", "beb5705e39644a2e777e736e003a2d2b17f7ed5c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
