...
function ek(e) {
  ...
  n.append("build_id", "b5c4e90ec14f5f4cbeec7ac9c2ede4a00f5fabe8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
