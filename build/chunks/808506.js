...
function ex(e) {
  ...
  n.append("build_id", "e3258690411beab2e2b250def6c9d9d0acf64303"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
