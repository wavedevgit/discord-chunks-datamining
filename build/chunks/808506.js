...
function ek(e) {
  ...
  n.append("build_id", "ec5187c8077351060e7a41ce455b9e4c7b61053a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
