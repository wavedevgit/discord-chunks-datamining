...
function eM(e) {
  ...
  n.append("build_id", "1ab8cf864d264fdcd15cd9b1f8b6fe52743313b2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
