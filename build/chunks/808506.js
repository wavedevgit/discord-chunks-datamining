...
function ek(e) {
  ...
  n.append("build_id", "adbc152b160adf34310d4acb100390a92a9f4efe"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
