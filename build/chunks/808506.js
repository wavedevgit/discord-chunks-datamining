...
function eM(e) {
  ...
  n.append("build_id", "5cd6bef9a17475b16f00312185c2c8580246c8a0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
