...
function ek(e) {
  ...
  n.append("build_id", "2af9fdaa671f3afd89bbec30c41d4e96100969e5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
