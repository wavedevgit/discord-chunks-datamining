...
function ek(e) {
  ...
  n.append("build_id", "407872ba12290687bc95722fa3bd0cd6c237700d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
