...
function ex(e) {
  ...
  n.append("build_id", "0c5cd6e93d0ac6686f238599bfb5671c162377ca"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
