...
function eM(e) {
  ...
  n.append("build_id", "b31078563417798b2c1069e72ad75080669ab581"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
