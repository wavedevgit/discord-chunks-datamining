...
function eM(e) {
  ...
  n.append("build_id", "21069566cf88375a098156e0942c50c648035b3a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
