...
function ek(e) {
  ...
  n.append("build_id", "2769aaf7ff535a5c2375d01e466d38ddf151e4aa"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
