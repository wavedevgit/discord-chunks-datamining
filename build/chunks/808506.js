...
function eM(e) {
  ...
  n.append("build_id", "e8c1e719f0fefcb83a0ed873708ccaacad0c86bf"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
