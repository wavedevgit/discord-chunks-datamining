...
function ek(e) {
  ...
  n.append("build_id", "96f3ef087f932f73e35918a337c12427b7795bcb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
