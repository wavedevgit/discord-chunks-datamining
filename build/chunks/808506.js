...
function ek(e) {
  ...
  n.append("build_id", "30d9e4765d61736ebf8a789e916758e9e5cc2ab0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
