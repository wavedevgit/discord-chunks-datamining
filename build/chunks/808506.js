...
function ek(e) {
  ...
  n.append("build_id", "c913eb5c82bad8d33cf026e793de06b159b46261"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
