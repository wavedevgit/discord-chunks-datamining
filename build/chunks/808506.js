...
function ek(e) {
  ...
  n.append("build_id", "e6f143354bdb09473f892308639dd5b8fa52e775"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
