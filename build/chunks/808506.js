...
function ex(e) {
  ...
  n.append("build_id", "47a6e24f343a1960134fedb202a10b86f0279236"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
