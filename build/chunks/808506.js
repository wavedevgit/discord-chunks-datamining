...
function eM(e) {
  ...
  n.append("build_id", "427ee87af9307ff417feaad46bec2a2d025f1d2f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
