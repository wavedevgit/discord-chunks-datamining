...
function eM(e) {
  ...
  n.append("build_id", "8983beb1d565f53380dd8d958dd88e57fae45eae"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
