...
function eM(e) {
  ...
  n.append("build_id", "875be853451e5fdafcee016164bdab85069eae72"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
