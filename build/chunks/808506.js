...
function ex(e) {
  ...
  n.append("build_id", "f901c2eefec3c102eda3e8b251aa6f30017f58b5"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
