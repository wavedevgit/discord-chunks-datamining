...
function eM(e) {
  ...
  n.append("build_id", "e0956aff1795f3cafc0a33d16620108d0b6ee6ec"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
