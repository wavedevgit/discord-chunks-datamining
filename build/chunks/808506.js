...
function eM(e) {
  ...
  n.append("build_id", "db5c74d65afc982fde9bb1a0e06772364b099420"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
