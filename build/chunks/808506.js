...
function ex(e) {
  ...
  n.append("build_id", "fa87bb8cfb22a44800dc05dcb328d2e6639d852a"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
