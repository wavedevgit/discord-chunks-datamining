...
function ex(e) {
  ...
  n.append("build_id", "7586b7c97036535fad762ca264b6ca1d270c5a39"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
