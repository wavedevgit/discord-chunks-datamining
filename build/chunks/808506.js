...
function eM(e) {
  ...
  n.append("build_id", "84cbfea09edf2298790852edd8e0a608b9bdace3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
