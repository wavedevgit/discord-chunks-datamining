...
function eM(e) {
  ...
  n.append("build_id", "18882583acb9180adbf27a4a9314ceec06a0bfdc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
