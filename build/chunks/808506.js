...
function ek(e) {
  ...
  n.append("build_id", "ac51ac1b3e4e633f687bd00df3a0285304231e7a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
