...
function ek(e) {
  ...
  n.append("build_id", "01a231781ae2bf5fa2befb078a2db7020abd9ecd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
