...
function eM(e) {
  ...
  n.append("build_id", "e14dd9952fc6a5014a1e9feaf605be8268060e0b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
