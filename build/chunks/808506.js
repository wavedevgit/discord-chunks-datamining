...
function ek(e) {
  ...
  n.append("build_id", "ff3981838ff5129ef23ec891e37d867c484c277c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
