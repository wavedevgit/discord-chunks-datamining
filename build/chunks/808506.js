...
function ep(e, t) {
  let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
    r = Y.get(e);
  (null === n || r === n) && r !== t && (null == t ? Y.delete(e) : Y.set(e, t), (null == t || "CRASHED" === t) && (f.Z.setFocusedPID(null), e_()), $.delete(e), eo.info("pid=".concat(e, " status transition ").concat(null != r ? r : "DISCONNECTED", " -> ").concat(null != t ? t : "DISCONNECTED"), Y))
}
async function eh(e) {
  try {
...
async function eE(e) {
  ...
  if (eo.verbose("updateIntendedOverlayPIDs", {
      ...
      action: e
    }), ed.isMutexHeld() || eo.error("updateIntendedOverlayPIDs: overlayMutex is not held.", e), !q && null != e) return void eo.verbose("updateIntendedOverlayPIDs: Connection is not opened while updating applications.", e);
  async function r(e) {
    if (!(e in Z)) return;
    let t = Z[e];
    delete Z[e];
...
let ev = ef("setOverlayEnabled", async e => {
  if (!j.iP) return;
  if (K === e) return void eo.verbose("setOverlayEnabled: no change", {
    newOverlayEnabled: e
  });
  K = e, eX.emitChange();
  let t = await (0, k.K)();
...
function eS(e, t, n) {
  ...
  el(e, G({}, a)), (0, d.te)(x.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(x.OVERLAY_LAYOUT_ID), 0, {
...
function eN(e) {
  switch (ei && eo.info("[app data received]", e), e.type) {
    case M.BmY.CONNECT:
      ...
      if (null == t) break;
      (0, d.te)(x.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(x.OVERLAY_LAYOUT_ID), 0), Promise.all([(0, v.Z)(t, e.pid), a.ZP.PersistedStore.getAllStates()]).then(t => {
        let [n, r] = t, {
          pid: i,
          token: o
        } = e;
...
function ex(e) {
  ...
  n.append("build_id", "0b0f62129bd681e6d7753a6f523ea289fed0ae11"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
