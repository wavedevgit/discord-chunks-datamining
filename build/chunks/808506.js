...
function ek(e) {
  ...
  n.append("build_id", "caf4d1d407bc5c14f775837d7517a51c83b480c3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
