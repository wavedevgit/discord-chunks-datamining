...
function ek(e) {
  ...
  n.append("build_id", "3a301d5a41a3daf814c10eae4f0747af142bb5fb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
