...
function ek(e) {
  ...
  n.append("build_id", "e72821825df90279da37413877386cf564001066"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
