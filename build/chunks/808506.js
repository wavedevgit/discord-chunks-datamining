...
function ek(e) {
  ...
  n.append("build_id", "e7172ab4d7f2366f6e33cbc7f19010db7d41c953"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
