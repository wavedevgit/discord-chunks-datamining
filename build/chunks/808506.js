...
function eM(e) {
  ...
  n.append("build_id", "aeec32dc202be51db9075d9dcfa7c130e5734f67"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
