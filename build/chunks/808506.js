...
function eM(e) {
  ...
  n.append("build_id", "a5beddf9a3f40f2e818777ae930cc851634fc3d8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
