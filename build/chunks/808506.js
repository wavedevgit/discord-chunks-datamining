...
function ek(e) {
  ...
  n.append("build_id", "3bad5af7bd0bd899e2e1710edaca866dc09c9d27"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
