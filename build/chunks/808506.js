...
function ex(e) {
  ...
  n.append("build_id", "08e1d352e63b84da68536385b01102ce359d6b20"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
