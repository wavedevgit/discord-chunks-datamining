...
function eM(e) {
  ...
  n.append("build_id", "861b97af9e7b6feba5d200d16d897991f9e53abd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
