...
function ek(e) {
  ...
  n.append("build_id", "799d753630196a56d2c4ec64d85bb244e5e1c91f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
