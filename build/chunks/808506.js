...
function eM(e) {
  ...
  n.append("build_id", "cd704aaa361f9ae34b522c54c7a783e2cf510fce"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
