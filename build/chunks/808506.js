...
function ex(e) {
  ...
  n.append("build_id", "d3d229b5941d23da65ec79c39c796db630ea3a22"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
