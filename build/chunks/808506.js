...
function eM(e) {
  ...
  n.append("build_id", "3677722482aefedb4d542aad9ca23e4cb7ebba42"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
