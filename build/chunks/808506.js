...
function ek(e) {
  ...
  n.append("build_id", "4a0326097f8a11d14ef26f57f51674a767f11d49"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
