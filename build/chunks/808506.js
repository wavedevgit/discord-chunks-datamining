...
function eM(e) {
  ...
  n.append("build_id", "f0197593f546053fdfa64206f8d36791b92d7237"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
