...
function eM(e) {
  ...
  n.append("build_id", "8a88b7ac5cbd648025f5ccbab84b17a11ac00b93"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
