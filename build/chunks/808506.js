...
function ek(e) {
  ...
  n.append("build_id", "94b0af16d578816b5f228d8e88f8dc0f9afbeecd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
