...
function ek(e) {
  ...
  n.append("build_id", "251dde2d324e2e4a93a136bb25f5fcd47d69903d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
