...
function ek(e) {
  ...
  n.append("build_id", "12352aefef843fd11a0f2149a1834383c0915f2b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
