...
function eM(e) {
  ...
  n.append("build_id", "7872fee0f11628dc0d884e663f6ced7db74d2b54"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
