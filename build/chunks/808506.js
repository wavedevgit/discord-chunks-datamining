...
function eM(e) {
  ...
  n.append("build_id", "2dd3b248a9afd1667352aeca794c83605de46e12"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
