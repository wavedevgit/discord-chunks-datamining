...
function eM(e) {
  ...
  n.append("build_id", "0e7cfead9e53fb54be29bee1e96960c0d48226cf"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
