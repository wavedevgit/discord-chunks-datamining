...
function eM(e) {
  ...
  n.append("build_id", "3df38fd8ca7fe090b8b41fee334a8ac2670e263e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
