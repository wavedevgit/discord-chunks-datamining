...
function eM(e) {
  ...
  n.append("build_id", "ed49a943819579fa1e9ba07bbded0b71da69e4dd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
