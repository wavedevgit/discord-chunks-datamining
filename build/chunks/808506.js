...
function eM(e) {
  ...
  n.append("build_id", "2f5101100d73aea5b35a1c730b41727f4df3b1f5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
