...
function eM(e) {
  ...
  n.append("build_id", "bd1af3f4f4a93206156766e12cd26f9e3c549fb4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
