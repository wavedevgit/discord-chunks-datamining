...
function eM(e) {
  ...
  n.append("build_id", "8d2e3b5e9ef416733e67d9473fd58693cd581d2b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
