...
function ek(e) {
  ...
  n.append("build_id", "b7e79a05e93d0b26fb35bd325b2a56e50de84d87"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
