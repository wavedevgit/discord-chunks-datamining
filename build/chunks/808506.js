...
function eM(e) {
  ...
  n.append("build_id", "4f6b005df1f28afa79714827b6e8fdfd8d8e6c5c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
