...
function eM(e) {
  ...
  n.append("build_id", "caca167e88c6b6ba5389a44efdb65727b9f6001c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
