...
function eM(e) {
  ...
  n.append("build_id", "7e8c18a696343e3a554f91292867897c1b54245c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
