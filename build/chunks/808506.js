...
function ek(e) {
  ...
  n.append("build_id", "f6e9cb10101850991b265ed38a7d67add6470df1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
