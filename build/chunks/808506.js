...
function ek(e) {
  ...
  n.append("build_id", "9492db717350be87f5f97d9a4c6b399ca214dcc2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
