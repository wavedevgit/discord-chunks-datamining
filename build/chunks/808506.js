...
function eM(e) {
  ...
  n.append("build_id", "677a17bd781b6a1722a607d7ca1c08d8cb4ab6fc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
