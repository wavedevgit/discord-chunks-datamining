...
function ex(e) {
  ...
  n.append("build_id", "a8626f702e6dc78c6a17bc36cb201162c55bf4f4"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
