...
function ex(e) {
  ...
  n.append("build_id", "af89e1bf82e75eb369a5f7532a9fa6ebd877add2"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
