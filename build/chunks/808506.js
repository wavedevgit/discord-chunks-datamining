...
function eM(e) {
  ...
  n.append("build_id", "0a4134dee5bdd338e07412b23b8d646fda6cc6f7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
