...
function ex(e) {
  ...
  n.append("build_id", "d5fe8bfd430daf5fd417ae385a367ce04c1e6714"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
