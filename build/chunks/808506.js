...
function ek(e) {
  ...
  n.append("build_id", "8a7df980263d826dbe3efdc96631e0b7d9f00f83"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
