...
function eM(e) {
  ...
  n.append("build_id", "dca572732dd0407119335db2e450dd3449f05cb1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
