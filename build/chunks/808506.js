...
function eM(e) {
  ...
  n.append("build_id", "b9afcfc4992c07e7a7d15ecf5e3b5aa2f390555a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
