...
function ek(e) {
  ...
  n.append("build_id", "d7165bab926ce7c35bbbd012e65fcd6f11e741f3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
