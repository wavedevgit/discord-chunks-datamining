...
function eM(e) {
  ...
  n.append("build_id", "be131558c5400b6d64cd6e9deff0fca5daf02e30"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
