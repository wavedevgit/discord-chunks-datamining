...
function ex(e) {
  ...
  n.append("build_id", "5647e02392ed9dbc2483fde766503629b80868ed"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
