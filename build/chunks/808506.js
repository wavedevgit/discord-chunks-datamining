...
function eM(e) {
  ...
  n.append("build_id", "0864f74d0d16abac4d6644d628b6309cb3a14a49"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
