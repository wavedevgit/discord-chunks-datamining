...
function ek(e) {
  ...
  n.append("build_id", "96044b86526978e7f63002bbb584ad66d2379673"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
