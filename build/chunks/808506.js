...
function ex(e) {
  ...
  n.append("build_id", "bc5a2a40070d0df7b138a08f2b0300517fab1773"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
