...
function eM(e) {
  ...
  n.append("build_id", "e6cad5e3bec200bf9bf72a9b1385b1db3d3867a2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
