...
function ek(e) {
  ...
  n.append("build_id", "ebe62c6c368323a710d81b42002595a6144333f1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
