...
function eT(e, t, n) {
  ...
  ec(e, B({}, o)), (0, d.te)(x.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(x.OVERLAY_LAYOUT_ID), U.bv, {
...
function eC(e) {
  switch (ea && eo.info("[app data received]", e), e.type) {
    case M.BmY.CONNECT:
      ...
      if (null == t) break;
      (0, d.te)(x.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(x.OVERLAY_LAYOUT_ID), U.bv), Promise.all([(0, v.Z)(t, e.pid), o.ZP.PersistedStore.getAllStates()]).then(t => {
        let [n, r] = t, {
          pid: i,
          token: a
        } = e;
...
function ek(e) {
  ...
  n.append("build_id", "99698ceff3a648b0f4981ff7d2e173b8845509dd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
