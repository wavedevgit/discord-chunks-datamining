...
function ek(e) {
  ...
  n.append("build_id", "c29895acd7c6fc558a84ec9f95f9b21f13a263a3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
