...
function eM(e) {
  ...
  n.append("build_id", "6e138ed9b3aaf9f7b250c7e3848968bb6f7bc99b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
