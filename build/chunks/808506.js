...
function ek(e) {
  ...
  n.append("build_id", "8360a47d00dba43bfb6dd8f8a4567e524608a53a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
