...
function ek(e) {
  ...
  n.append("build_id", "2c37bc35d68febfb6cec4a1ca86db60d413bba05"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
