...
function ek(e) {
  ...
  n.append("build_id", "8a9321c3d185db36296dcd6f1d7e5f1edee6559d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
