...
function eM(e) {
  ...
  n.append("build_id", "0f7501d36598e3e0b960c963a0d19063af10f6cc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
