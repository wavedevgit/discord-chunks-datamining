...
function eM(e) {
  ...
  n.append("build_id", "cb3de0ccffa2213321e3db263ad3fbd0e58b2e98"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
