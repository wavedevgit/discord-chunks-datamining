...
function eM(e) {
  ...
  n.append("build_id", "20264dd638f6c3209eb7bdd232fe442f8a60389a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
