...
function eM(e) {
  ...
  n.append("build_id", "e7ed6049edf5f18494a6cb51ce16cf5f92065947"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
