...
function ek(e) {
  ...
  n.append("build_id", "5355ea8a09747e453eb732d06793f5414a2abef8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
