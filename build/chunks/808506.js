...
function eM(e) {
  ...
  n.append("build_id", "79d81e374f25419906ed9ea3fc9def135a2e6067"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
