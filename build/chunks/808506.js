...
function eM(e) {
  ...
  n.append("build_id", "ca35251d7321dcf289a5a9ca0f9e15fb70ca93db"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
