...
function ek(e) {
  ...
  n.append("build_id", "213f37d4c5a1d93d61d5b9632988ced227c76bcb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
