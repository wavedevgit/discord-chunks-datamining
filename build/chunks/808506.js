...
function ek(e) {
  ...
  n.append("build_id", "a02b0b5eeca3479088d13861fcaf48e70b83bd6a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
