...
function eM(e) {
  ...
  n.append("build_id", "717abcaeeda25b8efb23c841ce2ed3dbdba1bf93"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
