...
function eM(e) {
  ...
  n.append("build_id", "ad26d8ec625732d83c3503f1fe12515b8e24ed35"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
