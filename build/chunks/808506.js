...
function ek(e) {
  ...
  n.append("build_id", "e783b565ae4e4c674a62f50a5a99990871af1d8e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
