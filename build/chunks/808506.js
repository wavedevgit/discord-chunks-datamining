...
function ek(e) {
  ...
  n.append("build_id", "ab88707d9d4fb5edfaf2437922f3d80bb852673f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
