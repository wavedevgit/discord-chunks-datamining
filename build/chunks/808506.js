...
function ek(e) {
  ...
  n.append("build_id", "ecafbfae62e11dd2f17e0c02dd7f7fd0616570f8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
