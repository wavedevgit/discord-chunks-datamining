...
function eM(e) {
  ...
  n.append("build_id", "36c10475cd052a25954c25de20fa9081d653453e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
