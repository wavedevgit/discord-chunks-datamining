...
function eM(e) {
  ...
  n.append("build_id", "73476a338509a9d3061c653f801bf69ecb9eafa5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
