...
function ek(e) {
  ...
  n.append("build_id", "2ce3105bfab72af683d2cd587439578f88a7d9f9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
