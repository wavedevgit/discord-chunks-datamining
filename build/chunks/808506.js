...
function eM(e) {
  ...
  n.append("build_id", "794ed9fbf55dbac16ec44166269aa90398404f8d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
