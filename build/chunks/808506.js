...
function ek(e) {
  ...
  n.append("build_id", "20cfb54f0336529e39c335cbf596b8b5bf96ab26"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
