...
function ex(e) {
  ...
  n.append("build_id", "ceba982f213ecfd794c6c2357c66eae787b3f83b"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
