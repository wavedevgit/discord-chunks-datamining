...
function ek(e) {
  ...
  n.append("build_id", "33b52f35254140ec261cf725842e46648e628e16"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
