...
function ek(e) {
  ...
  n.append("build_id", "f1a444d464d0415a0e6e1c687e87740d0274dea0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
