...
function eM(e) {
  ...
  n.append("build_id", "2b4d36aee71bdf6af15232be594d43a0444175ba"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
