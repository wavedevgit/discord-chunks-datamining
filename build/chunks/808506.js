...
function ek(e) {
  ...
  n.append("build_id", "0a42b4cb8cb85ab714766b57db5f84e528dd9c3b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
