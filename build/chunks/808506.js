...
function ek(e) {
  ...
  n.append("build_id", "a18219e2f4a81140904ff11e2cefc374087e2b87"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
