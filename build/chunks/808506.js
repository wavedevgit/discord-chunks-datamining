...
function eM(e) {
  ...
  n.append("build_id", "015d1ea63d2faf61354bc85a2126989da006a0c8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
