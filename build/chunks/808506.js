...
function eM(e) {
  ...
  n.append("build_id", "d81903015e08f7951af47c7a1424628a5d5f4f5f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
