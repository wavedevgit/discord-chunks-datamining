...
function ek(e) {
  ...
  n.append("build_id", "f575dc6068ad91ca728a082066248267f7f64699"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
