...
function ek(e) {
  ...
  n.append("build_id", "7319a4830adefb10cfeb8329fc89f47e8643f3ae"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
