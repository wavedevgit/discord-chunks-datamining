...
function eM(e) {
  ...
  n.append("build_id", "47421104fb677be915edffaf2b94dfa4ddb3e646"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
