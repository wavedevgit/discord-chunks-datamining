...
function ex(e) {
  ...
  n.append("build_id", "d755969ef0507ea7f1cfb8e0fb9266c444e7a461"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
