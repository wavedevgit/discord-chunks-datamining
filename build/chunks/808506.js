...
function ex(e) {
  ...
  n.append("build_id", "9d40aa947bf6df166ef15a2b46f605181db4ee21"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
