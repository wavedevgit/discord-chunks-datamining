...
function eM(e) {
  ...
  n.append("build_id", "db3ea37d7d04c4ca5c5a29d7d53318648a08e03d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
