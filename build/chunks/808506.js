...
function eM(e) {
  ...
  n.append("build_id", "586e5e064dc9e2da6dcafee0e9b923ba12e33145"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
