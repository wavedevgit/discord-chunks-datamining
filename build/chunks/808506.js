...
function ek(e) {
  ...
  n.append("build_id", "ada3c7b0116e89460d4b4904165dd732e01d4c16"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
