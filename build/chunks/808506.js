...
function ek(e) {
  ...
  n.append("build_id", "c0e9f780bd9e534dd3a4267a9c5cc8551013e834"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
