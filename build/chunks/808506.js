...
function eM(e) {
  ...
  n.append("build_id", "f52d0e7f826e4ee4050df1dd5551a5bc0ce605e7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
