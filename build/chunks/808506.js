...
function ek(e) {
  ...
  n.append("build_id", "7001e3f2bcfd688dfa174991fafdf1635afa4432"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
