...
function eM(e) {
  ...
  n.append("build_id", "e2030fcf29653a35352186ad3a020db91d7ebdba"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
