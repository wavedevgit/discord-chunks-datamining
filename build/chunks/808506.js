...
function eM(e) {
  ...
  n.append("build_id", "b57f3e1a892f47cceca15019946cd53f27f7a580"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
