...
function eM(e) {
  ...
  n.append("build_id", "dab37b7b6443c7a39404e886cf3228f1539a0006"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
