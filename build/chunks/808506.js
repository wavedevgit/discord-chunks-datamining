...
function eM(e) {
  ...
  n.append("build_id", "716c231b74e909e7eb950544688ac6006d6222cf"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
