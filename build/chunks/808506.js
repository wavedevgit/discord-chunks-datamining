...
function ex(e) {
  ...
  n.append("build_id", "a41642133fce4699a67175b78c8ab872a405dc95"), n.append("rpc", String(t)), n.append("rpc_auth_token", J), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
