...
function ek(e) {
  ...
  n.append("build_id", "389291fa271c2287bef9b96174b746aca40c1ccb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
