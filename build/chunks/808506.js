...
function eM(e) {
  ...
  n.append("build_id", "ccccbae24da988430fccccd81a3dad8bdb26d3a7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
