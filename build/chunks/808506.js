...
function eM(e) {
  ...
  n.append("build_id", "2bb5a9a1a9df9849d66be4cf9b3e1109cb6fc47d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
