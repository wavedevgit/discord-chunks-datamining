...
function ek(e) {
  ...
  n.append("build_id", "d61c2fc29ac54e7a91cd8362c3472c68e514ef0d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
