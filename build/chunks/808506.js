...
function ek(e) {
  ...
  n.append("build_id", "bf1e49ca6344981a7ef84e9131c6081714a7b76f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
