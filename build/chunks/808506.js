...
function ek(e) {
  ...
  n.append("build_id", "a1f4a39ae51e528180631ca24ec5fda5c83c4c01"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
