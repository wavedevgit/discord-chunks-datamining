...
function ek(e) {
  ...
  n.append("build_id", "9b28fe1f82911c249093428745bbd949626b3b56"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
