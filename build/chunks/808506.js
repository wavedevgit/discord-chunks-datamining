...
function eM(e) {
  ...
  n.append("build_id", "05710e26f66e52b613ca9d239eb4fdef74ae0f6e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
