...
function eM(e) {
  ...
  n.append("build_id", "82971c935a8a797250073fd96c1f260a4a5300a6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
