...
function eM(e) {
  ...
  n.append("build_id", "d9c2ee985142f07860476f1cbb97f366688c565a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
