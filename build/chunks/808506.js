...
function eM(e) {
  ...
  n.append("build_id", "4ae8fc306fcc0e89de9c30a7650d261b7d0babfd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
