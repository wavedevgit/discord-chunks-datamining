...
function eM(e) {
  ...
  n.append("build_id", "02722f8084d6d0afe050a1326c081c1f94daa42f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
