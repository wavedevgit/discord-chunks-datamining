...
function eM(e) {
  ...
  n.append("build_id", "501594f9090774a1cfcbfd4663f57e1bca8a47df"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
