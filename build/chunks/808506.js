...
function eM(e) {
  ...
  n.append("build_id", "cf4eb3c5c25ba575995934aab1171cee630fa10b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
