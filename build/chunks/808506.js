...
function eM(e) {
  ...
  n.append("build_id", "bfc5107ce9b9161c161ffab27ce50bdb03340ac1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
