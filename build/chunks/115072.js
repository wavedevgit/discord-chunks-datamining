...
i.d(t, {
  default: () => _
}), i(266796), i(230036), i(47120), i(571269), i(298267);
var r = i(200651),
  n = i(192379),
  l = i(772848),
  a = i(442837),
...
function _(e) {
  ...
  let {
    transitionState: P,
    onClose: C
  } = e, E = n.useRef(null), k = n.useRef(null), [T, D] = n.useState(""), [A, I] = n.useState(""), [R, L] = n.useState(), [Z, z] = n.useState(""), [J, M] = n.useState([]), [V, q] = n.useState(), [B, G] = n.useState(), [H, X] = n.useState(!1), [U, Y] = n.useState(""), [K, F] = n.useState(function(e) {
    switch (e) {
      case "windows":
        return "Windows";
      case "macos":
    ...
    return ""
  }((0, j.getOS)())), [Q, $] = n.useState(""), [ee, et] = n.useState(""), [ei, er] = n.useState(""), [en, el] = n.useState(""), [ea, eo] = n.useState(!1), [es, ec] = n.useState(!1), [eu, ed] = n.useState(!1), [em, ev] = n.useState(!1);
  n.useEffect(() => {
    ...
    o.tn.get({
      ...
      if (null != e.body && "ab462817a321d5c6d914fa1c6779261a8a14d9e0" !== e.body.hash) {
        {
          let e = new Date("1743613240403"),
            t = new Date;
  ...
  async function eg() {
    ...
    ec(!1), null != a && a.ok ? (eh && window.open(a.body.permalink_url, "_blank"), ep(), (0, s.ZDy)(async () => {
      let {
        default: e
      } = await i.e("64648").then(i.bind(i, 81155));
      return t => {
        var i, n;
    ...
    children: [(0, r.jsx)(s.xBx, {
      children: (0, r.jsx)(s.X6q, {
        ...
        children: (0, r.jsx)(s.H, {
          children: W.NW.string(W.t["5Lqopa"])
        })
      })
    }), (0, r.jsx)(s.hzk, {
      onPaste: ej,
      children: (0, r.jsxs)("form", {
        onSubmit: eg,
        children: [null != ef && (0, r.jsx)(s.ToO, {
          ...
          children: [(0, r.jsx)(s.xJW, {
            ...
            children: (0, r.jsx)(s.VcW, {
              value: B,
              options: null !== (S = null == V ? void 0 : null === (w = V.features) || void 0 === w ? void 0 : null === (_ = w.filter(e => "" !== (0, y.pD)(e))) || void 0 === _ ? void 0 : null === (t = _.map(e => {
                var t;
                return {
                  label: null !== (t = e.name) && void 0 !== t ? t : "",
                  value: (0, y.pD)(e)
                }
              })) || void 0 === t ? void 0 : t.sort((e, t) => e.label.localeCompare(t.label))) && void 0 !== S ? S : [],
              isDisabled: null == V,
              onChange: e => G(e)
            })
          }), (0, r.jsx)(s.xJW, {
            ...
            children: [W.NW.string(W.t.HVxmOD), (0, r.jsx)(c.Z, {
              ref: E,
              onChange: e => {
                var t, i;
                (null === (i = e.currentTarget) || void 0 === i ? void 0 : null === (t = i.files) || void 0 === t ? void 0 : t[0]) != null && M([...J, ...Array.from(e.currentTarget.files).map(e => new u.ZP({
                  id: (0, l.Z)(),
                  file: e,
                  platform: u.ow.WEB
                }))])
          ...
          }), J.length > 0 ? (0, r.jsxs)(s.hjN, {
            children: [(0, r.jsx)(s.vwX, {
              children: "Preview"
            }), (0, r.jsx)("div", {
              ref: k,
              className: N.attachments,
              children: J.length > 0 && J.map(e => (0, r.jsxs)("div", {
