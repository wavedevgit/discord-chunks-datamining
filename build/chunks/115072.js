...
function S(e) {
  ...
  let {
    transitionState: E,
    onClose: k
  } = e, D = r.useRef(null), T = r.useRef(null), [W, N] = r.useState(""), [A, R] = r.useState(""), [I, L] = r.useState(), [Z, z] = r.useState(""), [J, M] = r.useState([]), [V, q] = r.useState(), [B, G] = r.useState(), [H, X] = r.useState(!1), [U, Y] = r.useState(""), [K, F] = r.useState(function(e) {
    switch (e) {
      case "windows":
        return "Windows";
      case "macos":
  ...
  r.useEffect(() => {
    ...
    o.tn.get({
      ...
      if (null != e.body && "7c86cd05e605f06f111f262d454e85083e1360f8" !== e.body.hash) {
        {
          let e = new Date("1746655479440"),
            t = new Date;
    ...
    children: [(0, i.jsx)(s.xBx, {
      children: (0, i.jsx)(s.X6q, {
        ...
        children: (0, i.jsx)(s.H, {
          children: O.intl.string(O.t["5Lqopa"])
        })
      })
    }), (0, i.jsx)(s.hzk, {
      onPaste: ej,
      children: (0, i.jsxs)("form", {
        onSubmit: eg,
        children: [null != ep && (0, i.jsx)(s.ToO, {
          type: s.ToO.Types.DANGER,
          body: O.intl.format(O.t["yY60+/"], {
