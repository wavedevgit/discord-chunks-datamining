...
function P(e) {
  ...
  let {
    ...
    return ""
  }((0, y.getOS)())), [$, ee] = r.useState(""), [et, en] = r.useState(""), [ei, er] = r.useState(""), [el, ea] = r.useState(""), [eo, es] = r.useState(!1), [ec, eu] = r.useState(!1), [ed, em] = r.useState(!1), [eh, ef] = r.useState(null);
  r.useEffect(() => {
    ...
    o.tn.get({
      ...
      if (null != e.body && "e016ff27a55b925b99df0c08c4cb423c97d9c049" !== e.body.hash) {
        let e = new Date("1752770734977"),
          t = new Date,
          n = (0, j.TD)(t, e);
  ...
  async function ej() {
    ...
    eu(!1), null != a && a.ok ? (ep && window.open(a.body.permalink_url, "_blank"), ev(), (0, c.ZDy)(async () => {
      let {
        default: e
        ...
        children: [null != ex && (0, i.jsx)(c.ToO, {
          ...
          children: [(0, i.jsx)(c.xJW, {
            ...
            children: (0, i.jsx)(c.VcW, {
              value: G,
              options: null != (E = null == B || null == (C = B.features) || null == (P = C.filter(e => "" !== (0, b.pD)(e))) || null == (t = P.map(e => {
                var t;
                return {
                  label: null != (t = e.name) ? t : "",
                  value: (0, b.pD)(e)
                }
              })) ? void 0 : t.sort((e, t) => e.label.localeCompare(t.label))) ? E : [],
              isDisabled: null == B,
              onChange: e => H(e)
            })
          }), (0, i.jsx)(c.xJW, {
            ...
            children: [S.intl.string(S.t.HVxmOD), (0, i.jsx)(u.Z, {
              ...
              onChange: e => {
                var t, n;
                (null == (n = e.currentTarget) || null == (t = n.files) ? void 0 : t[0]) != null && q([...M, ...Array.from(e.currentTarget.files).map(e => new d.ZP({
                  id: (0, l.Z)(),
                  file: e,
                  platform: d.ow.WEB
                }))])
