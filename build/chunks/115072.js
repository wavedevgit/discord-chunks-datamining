...
function P(e) {
  ...
  let {
    ...
    return ""
  }((0, y.getOS)())), [$, ee] = r.useState(""), [et, en] = r.useState(""), [ei, er] = r.useState(""), [el, ea] = r.useState(""), [eo, es] = r.useState(!1), [eu, ec] = r.useState(!1), [ed, em] = r.useState(!1), [eh, ep] = r.useState(null);
  r.useEffect(() => {
    ...
    o.tn.get({
      ...
      if (null != e.body && "830c5a80ba0196d2740a06e381c3861906980a01" !== e.body.hash) {
        let e = new Date("1753755777053"),
          t = new Date,
          n = (0, j.TD)(t, e);
  ...
  async function ej() {
    ...
    ec(!1), null != a && a.ok ? (ef && window.open(a.body.permalink_url, "_blank"), ev(), (0, u.ZDy)(async () => {
      let {
        default: e
      ...
      children: (0, i.jsxs)("form", {
        ...
        children: [null != ex && (0, i.jsx)(u.ToO, {
          ...
          children: [(0, i.jsx)(u.xJW, {
            ...
            children: [S.intl.string(S.t.HVxmOD), (0, i.jsx)(c.Z, {
              ref: T,
              onChange: e => {
                var t, n;
