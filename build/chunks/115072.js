...
function _(e) {
  ...
  n.useEffect(() => {
    ...
    o.tn.get({
      ...
      if (null != e.body && "33e1e4ab713039b7110023076fa22aceb9ba91a0" !== e.body.hash) {
        {
          let e = new Date("1741135799912"),
            t = new Date;
  ...
  async function eg() {
    ...
    ec(!1), null != a && a.ok ? (ev && window.open(a.body.permalink_url, "_blank"), ep(), (0, s.ZDy)(async () => {
      let {
        default: e
