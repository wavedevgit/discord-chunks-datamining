...
function P(e) {
  ...
  let {
    ...
    return ""
  }((0, y.getOS)())), [$, ee] = r.useState(""), [et, en] = r.useState(""), [ei, er] = r.useState(""), [el, ea] = r.useState(""), [eo, es] = r.useState(!1), [ec, eu] = r.useState(!1), [ed, em] = r.useState(!1), [eh, ep] = r.useState(null);
  r.useEffect(() => {
    ...
    o.tn.get({
      ...
      if (null != e.body && "174e51a086449381ceec6fc53408b92b4bada9c0" !== e.body.hash) {
        let e = new Date("1754509954496"),
          t = new Date,
          n = (0, j.TD)(t, e);
  ...
  async function ej() {
    ...
    eu(!1), null != a && a.ok ? (ef && window.open(a.body.permalink_url, "_blank"), ev(), (0, c.ZDy)(async () => {
      let {
        default: e
