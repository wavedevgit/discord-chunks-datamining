...
function _(e) {
  ...
  n.useEffect(() => {
    ...
    o.tn.get({
      ...
      if (null != e.body && "73f08a488af55abd45913ff49119ed789af4fdc9" !== e.body.hash) {
        {
          let e = new Date("1742964452991"),
            t = new Date;
  ...
  async function eg() {
    ...
    ec(!1), null != a && a.ok ? (ev && window.open(a.body.permalink_url, "_blank"), ex(), (0, s.ZDy)(async () => {
      let {
        default: e
