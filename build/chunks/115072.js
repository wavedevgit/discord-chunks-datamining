...
function w(e) {
  ...
  r.useEffect(() => {
    ...
    o.tn.get({
      ...
      if (null != e.body && "d365bbfc85b85800c7a0be2bbac1ce2a83db660a" !== e.body.hash) {
        let e = new Date("1751038169611"),
          t = new Date,
          n = (0, g.TD)(t, e);
        ...
        children: [null != ep && (0, i.jsx)(s.ToO, {
          ...
          children: [(0, i.jsx)(s.xJW, {
            ...
            children: [O.intl.string(O.t.HVxmOD), (0, i.jsx)(c.Z, {
              ...
              onChange: e => {
                var t, n;
                (null == (n = e.currentTarget) || null == (t = n.files) ? void 0 : t[0]) != null && J([...M, ...Array.from(e.currentTarget.files).map(e => new u.ZP({
                  id: (0, l.Z)(),
                  file: e,
                  platform: u.ow.WEB
                }))])
