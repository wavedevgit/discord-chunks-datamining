...
function B(e) {
  let {
    channel: t
  } = e, l = (0, s.e7)([x.Z], () => null != t ? x.Z.getGuild(t.getGuildId()) : null, [t]), p = null != l && I.default.extractTimestamp(l.id) < Date.now() - P._8R, v = (0, s.e7)([C.default], () => (null == l ? void 0 : l.ownerId) === C.default.getId(), [l]), {
    canInvite: B,
    canManageGuild: G,
    canMessage: F
