...
function B(e) {
  let {
    channel: t
  } = e, l = (0, s.e7)([x.Z], () => null != t ? x.Z.getGuild(t.getGuildId()) : null, [t]), p = null != l && I.default.extractTimestamp(l.id) < Date.now() - S._8R, v = (0, s.e7)([C.default], () => (null == l ? void 0 : l.ownerId) === C.default.getId(), [l]), {
    canInvite: B,
    canManageGuild: G,
    canMessage: F
  } = (0, m.TE)(t, l), H = (0, s.e7)([y.default], () => {
    var e, t;
    ...
    return {
      ...
      handleAddApplication: i.useCallback(() => {
        null != e && (h.ZP.trackWithMetadata(S.rMx.SERVER_SETUP_CTA_CLICKED, {
          setup_type: Z.Ft.CHANNEL_WELCOME,
          action: Z.j7.ADD_APP
        }), (0, u.ZDy)(async () => {
          let {
  ...
  }, "message")), (0, E.isWeb)() && el.push((0, r.jsx)(o.Z.div, {
    className: T.cardWrapper,
    style: J ? {
      opacity: ee[el.length]
    } : {},
  ...
  }, "download")), el.push((0, r.jsx)(o.Z.div, {
    className: T.cardWrapper,
    style: J ? {
      opacity: ee[el.length]
    } : {},
      ...
      children: (0, r.jsxs)("div", {
        ...
        children: [(0, r.jsxs)(o.Z.div, {
          ...
          children: [(0, r.jsx)(u.X6q, {
            ...
            children: N.intl.format(N.t.rkHVKS, {
              guildName: l.name
            })
          }), (0, r.jsxs)(u.Text, {
            ...
            variant: "text-sm/normal",
            children: [ea, " ", el.length > 0 ? N.intl.format(N.t.UOtD39, {
              guideURL: eo
            }) : null]
          })]
        }), el]
