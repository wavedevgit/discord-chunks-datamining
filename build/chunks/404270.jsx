...
let x = e => {
  ...
  return <div className={l()(b.wrapper, n)}>{<s.X6q className={b.heading} variant={"heading-xl/semibold"}>{f.intl.string(f.t["3x1PFB"])}</s.X6q>}{<s.Text variant={"text-md/normal"}>{function(e) {
        let {
          currentUser: t,
          locale: n,
