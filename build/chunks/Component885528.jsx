/** Chunk was on 18831 **/
/** chunk id: 885528, original params: e,t,n (module,exports,require) **/
require.d(exports, {
  Z: () => Z
}), require("./953529.js");
...
let w = e => {
  ...
  S = e => {
    ...
    } = e, a = (0, d.e7)([p.default], () => p.default.locale);
    ...
    return (0, i.jsxs)(r.Anchor, {
      ...
      children: [(0, i.jsx)("div", {
        ...
        children: (0, i.jsx)(r.Fbu, {
          size: "md",
          color: c.Z.colors.INTERACTIVE_TEXT_DEFAULT
        })
      })]
    })
  },
  ...
  k = e => (0, i.jsx)(r.Text, {
    ...
    children: A.intl.format(A.t.IFxUaT, {
      letUsKnowHook: (t, n) => (0, i.jsx)(r.Anchor, {
  ...
  Z = e => {
    ...
    let {
      ...
      isDsaEligible: T,
      violationType: L
    } = (0, E.YG)(n), N = (0, d.e7)([g.Z], () => g.Z.getAppealEligibility()), I = (0, b.P)(), k = null != p && null != p.flagged_content && p.flagged_content.length > 0, Z = (0, v.e)(), M = !!(null == p ? true : p.is_coppa) && N.includes(h.tG.AGE_VERIFY_ELIGIBLE), R = !!(null == p ? true : p.is_coppa) && N.includes(h.tG.AGE_VERIFY_GLOBAL_ELIGIBLE), F = {
      accountStanding: I,
      classificationId: n,
      hasFlaggedContent: k,
      isDsaEligible: T,
    ...
    }, [Z]), null == p && A === h.OY.FAILED) ? (c(), null) : null == p ? null : (0, i.jsxs)("div", {
          ...
          appealComponent: (0, i.jsx)(U, {
            ...
            onLetUsKnowClick: () => {
              m.default.track(O.rMx.SAFETY_HUB_ACTION, {
                ...
                is_dsa_eligible: T,
                violation_type: L
              }), R ? f.Z.openV2(n, r) : M ? f.Z.open(n, r) : C && (u.Z.increment({
