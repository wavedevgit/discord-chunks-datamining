...
function f(t) {
  let {
    ...
    minutes: a,
    seconds: u
  } = (0, s.Z)(o), f = String(i).padStart(2, "0"), b = String(a).padStart(2, "0"), O = String(u).padStart(2, "0"), m = "".concat(f, ":").concat(b, ":").concat(O);
  return (0, r.jsxs)(l.Y0X, {
    ...
    children: [(0, r.jsx)("div", {
      ...
      variant: "text-md/normal",
      className: d.subtext,
      children: p.intl.formatToPlainString(p.t["+5XVHx"], {
        countdownString: m
      })
    }), (0, r.jsx)(c.zx, {
      className: d.ctaBtn,
...
function b(t) {
  ...
  return null == s || null == n ? null : (0, r.jsx)(u.A, {
