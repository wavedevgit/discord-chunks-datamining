...
function u(t) {
  let {
    ...
    minutes: u,
    seconds: f
  } = (0, o.Z)(c), p = String(a).padStart(2, "0"), b = String(u).padStart(2, "0"), d = String(f).padStart(2, "0"), O = "".concat(p, ":").concat(b, ":").concat(d);
  return (0, r.jsxs)(l.Y0X, {
    ...
    children: [(0, r.jsx)("div", {
      ...
      variant: "text-md/normal",
      className: s.subtext,
      children: i.intl.formatToPlainString(i.t["+5XVHx"], {
        countdownString: O
      })
    }), (0, r.jsx)(l.zxk, {
      className: s.ctaBtn,
...
function f(t) {
  ...
  return null == i ? null : (0, r.jsx)(u, (e = function(t) {
