...
function j(e) {
  let {
    ...
    return t.users.map((t, r) => {
      ...
      return {
        userId: t.user_id,
        value: null != (a = null == (i = t.statistics[n]) ? true : i.value) ? a : 0,
        rank: r + 1,
...
function G(e) {
  ...
  } = e, b = (0, a.e7)([_.default], () => _.default.getUser(t)), y = h.ZP.getName(c, true, b), O = null != u && u > n, [v, P] = i.useState("default"), D = (0, a.e7)([f.Z], () => {
