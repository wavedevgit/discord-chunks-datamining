...
class H extends o.PureComponent {
  ...
  constructor(e) {
    super(e), M(this, "selectable", !0), M(this, "layoutClass", x.autocompleteRowVertical), M(this, "handleMouseEnter", () => {
      let {
        onHover: e,
        index: t,
        selected: n
...
class q extends H {
  renderContent() {
    ...
    let {
      ...
      guildId: a
    } = this.props, s = null == a ? A.Z.getNickname(t.id) : null;
    return (0, i.jsxs)(P.RX, {
      children: [(0, i.jsx)(P.Tw, {
        ...
        children: (0, i.jsx)(P.BR, {
          children: null != (e = null != n ? n : s) ? e : R.ZP.getName(t)
        })
      }), (0, i.jsxs)(P.dY, {
...
class X extends H {
  renderContent() {
    let {
      ...
      colorString: r,
      colorStrings: o
    } = e, a = "dot" === _.Z.roleStyle, l = "username" === _.Z.roleStyle && (null != r || null != o), c = (0, y.AQ)(n, e, o), u = null != c && l, {
      gradientStyle: d,
      gradientClassname: p
    } = (0, f.JUn)({
      colorStrings: o,
    ...
    return (0, i.jsxs)(P.RX, {
      children: [(0, i.jsx)(P.z5, {
        ...
        children: L.intl.string(L.t["/91tbm"])
      })]
    })
  }
}
class Q extends H {
  renderContent() {
    let {
      channel: e,
      category: t
    } = this.props, n = e.type === w.d4z.GUILD_CATEGORY ? f.ROc : (0, E.KS)(e);
    return (0, i.jsxs)(P.RX, {
      children: [null != n && (0, i.jsx)(P.Tw, {
        children: (0, i.jsx)(n, {
          className: x.icon
        })
      }), (0, i.jsx)(P.z5, {
...
class $ extends H {
  ...
  renderContent() {
    ...
    return e.inputType === p.iw.PLACEHOLDER ? (0, i.jsx)(m.Z, {}) : (0, i.jsx)(h.Z, {
      command: e,
      channel: t,
      showImage: n,
      showOptions: a || s && o,
...
class ee extends H {
  renderContent() {
    let {
      ...
      sentinel: t,
      guild: n
    } = this.props, r = T.Yk.getSetting(), o = null != e.id || "" !== e.url ? (0, i.jsx)("img", {
      alt: "",
...
class et extends H {
  renderContent() {
    ...
    return (0, I.jl)(s) ? n = null == (e = v.Z.getStickerPack(s.pack_id)) ? void 0 : e.name : (0, I.J8)(s) && (n = null == (t = S.Z.getGuild(s.guild_id)) ? void 0 : t.name), (0, i.jsxs)(P.RX, {
      children: [(0, i.jsx)(P.Tw, {
        children: o(s, l || !0 === a)
      }), (0, i.jsxs)(P.z5, {
        children: [(0, i.jsx)(P.BR, {
          ...
          children: L.intl.format(L.t.PAutaW, {
            queryMatch: r
          })
        })]
      }), null != n && (0, i.jsx)(P.dY, {
  ...
  render() {
    ...
    return o.Children.count(t) > 0 ? (0, i.jsx)(V.Provider, {
      ...
      children: (0, i.jsx)("div", {
        ...
        children: (0, i.jsx)("div", U(k({
          className: s()(x.autocompleteInner, r)
        }, l), {
          children: t
        }))
      })
