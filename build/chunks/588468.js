...
class ee extends V {
  renderContent() {
    ...
    return (0, v.jl)(s) ? n = null == (e = O.Z.getStickerPack(s.pack_id)) ? void 0 : e.name : (0, v.J8)(s) && (n = null == (t = T.Z.getGuild(s.guild_id)) ? void 0 : t.name), (0, i.jsxs)(w.RX, {
      children: [(0, i.jsx)(w.Tw, {
        children: a(s, l || !0 === o)
      }), (0, i.jsxs)(w.z5, {
        children: [(0, i.jsx)(w.BR, {
