...
class Z extends o.PureComponent {
  ...
  constructor(e) {
    super(e), x(this, "selectable", !0), x(this, "layoutClass", L.autocompleteRowVertical), x(this, "handleMouseEnter", () => {
      let {
        onHover: e,
        index: t,
        selected: n
...
class z extends Z {
  renderContent() {
    ...
    let {
      ...
      guildId: a
    } = this.props, s = null == a ? T.Z.getNickname(t.id) : null;
    return (0, i.jsxs)(P.RX, {
      children: [(0, i.jsx)(P.Tw, {
        ...
        children: (0, i.jsx)(P.BR, {
          children: null != (e = null != n ? n : s) ? e : C.ZP.getName(t)
        })
      }), (0, i.jsxs)(P.dY, {
...
class q extends Z {
  renderContent() {
    let {
      ...
      colorString: r,
      colorStrings: o
    } = e, a = "dot" === f.Z.roleStyle, l = "username" === f.Z.roleStyle && (null != r || null != o), c = (0, b.OC)(n, "AutocompleteRow") && null != o && null != o.primaryColor && null != o.secondaryColor, u = c && l, {
      text: _,
      gradient: p
    } = (0, d.JUn)(null == o ? void 0 : o.primaryColor, null == o ? void 0 : o.secondaryColor, null == o ? void 0 : o.tertiaryColor, f.Z.useReducedMotion, "username"), h = l ? M({}, u ? _.gradientStyle : {
      color: null != r ? r : void 0
    }) : void 0;
    return (0, i.jsxs)(P.RX, {
      children: [(0, i.jsx)(P.z5, {
        children: (0, i.jsxs)(P.BR, {
          children: [a && (0, i.jsx)(d.FhE, {
            className: L.roleDot,
            color: r,
            colors: c ? o : null,
            tooltip: !1
  ...
  renderContent() {
    ...
    return (0, i.jsxs)(P.RX, {
      children: [null != n && (0, i.jsx)(P.Tw, {
        ...
        children: (0, i.jsx)(P.BR, {
          children: (0, m.F6)(e, N.default, T.Z)
        })
      }), null != t ? (0, i.jsx)(P.dY, {
        children: t.name
      }) : null]
...
class $ extends Z {
  renderContent() {
    let {
      ...
      sentinel: t,
      guild: n
    } = this.props, r = I.Yk.getSetting(), o = null != e.id || "" !== e.url ? (0, i.jsx)("img", {
      alt: "",
...
class ee extends Z {
  renderContent() {
    ...
    return (0, O.jl)(s) ? n = null == (e = v.Z.getStickerPack(s.pack_id)) ? void 0 : e.name : (0, O.J8)(s) && (n = null == (t = S.Z.getGuild(s.guild_id)) ? void 0 : t.name), (0, i.jsxs)(P.RX, {
      children: [(0, i.jsx)(P.Tw, {
        children: o(s, l || !0 === a)
      }), (0, i.jsxs)(P.z5, {
        children: [(0, i.jsx)(P.BR, {
