...
class i {
  ...
  test(e) {
    ...
    for (let t = 0; t < this.set.length; t++)
      if (R(this.set[t], e, this.options)) returntrue;
    returnfalse
  }
}
module.exports = i;
let a = new(require("./147567.js")),
  ...
  y = (e, t) => (l("comp", e, t), l("caret", e = I(e, t)), l("tildes", e = v(e, t)), l("xrange", e = C(e, t)), l("stars", e = N(e, t)), e),
  ...
  C = (e, t) => (l("replaceXRanges", e, t), e.split(/\s+/).map(e => A(e, t)).join(" ")),
  A = (e, t) => {
    e = e.trim();
  ...
  w = e => (t, n, r, i, a, o, s, l, c, u, d, f) => (n = O(r) ? "" : O(i) ? `>=${r}.0.0${e?"-0":""}` : O(a) ? `>=${r}.${i}.0${e?"-0":""}` : o ? `>=${n}` : `>=${n}${e?"-0":""}`, l = O(c) ? "" : O(u) ? `<${+c+1}.0.0-0` : O(d) ? `<${c}.${+u+1}.0-0` : f ? `<=${c}.${u}.${d}-${f}` : e ? `<${c}.${u}.${+d+1}-0` : `<=${l}`, `${n} ${l}`.trim()),
  R = (e, t, n) => {
