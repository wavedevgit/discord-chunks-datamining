...
var R = r.forwardRef(function(e, t) {
    var a = e.className,
      ...
      T = r.useCallback(function() {
        ...
        if (null != e) {
          ...
          if (null != t) {
            t.clearRect(0, 0, e.width, e.height), null == _ || _(t), v.current.forEach(function(n, r) {
              var i = n.confetti,
                o = n.spriteCanvas;
              i.update(s), i.draw(o, t), i.shouldDestroy(e, s) && v.current.delete(r)
            }), null == p || p(t), v.current.size > 0 ? O.current = m(T) : (t.clearRect(0, 0, e.width, e.height), O.current = null);
            var n = Date.now();
            0 !== I.current && (S.current = 1e3 / (n - I.current)), I.current = n
          }
        }
      }, [s, p, _, m]);
    r.useEffect(function() {
      null != O.current && (E(O.current), O.current = m(T))
    }, [E, T, m]);
    ...
    return r.useEffect(function() {
      ...
      return e("click", L, l), e("mousedown", x, c), e("mousemove", M, u), e("mouseup", k, d),
        function() {
          window.removeEventListener("click", L), window.removeEventListener("mousedown", x), window.removeEventListener("mousemove", M), window.removeEventListener("mouseup", M)
        }
    }, [L, x, M, k, l, c, u, d]), r.useEffect(function() {
      var e = y.current,
...
function L(e, t) {
  var n, i = r.useState(null != (n = null == t ? void 0 : t.isReady) && n),
    o = i[0],
    a = i[1];
  r.useEffect(function() {
