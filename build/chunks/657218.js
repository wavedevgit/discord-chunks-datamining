    ...
    return {
      ...
      submit: i.useCallback(async (e, i, l) => {
        ...
        try {
          ...
          return (null == (u = e.body) ? void 0 : u.code) === G.evJ.AUTOMOD_TITLE_BLOCKED && c((0, k.Gx)(e.body, t)), h(!1), {
            shouldClear: !1,
            shouldRefocus: !0
          }
        }
...
function J(e) {
  let {
    parentChannel: t,
    parentMessageId: n
  } = e, i = (0, o.e7)([N.Z], () => null == n ? null : N.Z.getMessage(t.id, n)), l = S.jU.useSetting();
