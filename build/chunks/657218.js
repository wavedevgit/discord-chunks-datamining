...
function Q(e) {
  let {
    ...
    let {
      ...
      location: o,
      enableAIFeatures: s
    } = e, [c, u] = i.useState(null), [d, p] = i.useState(null), [h, f] = i.useState(!1), m = (0, H.Z)({
      parentChannel: t,
      parentMessageId: n,
      threadSettings: r,
      privateThreadMode: l,
...
function $(e) {
  ...
  let {
    ...
    isGeneratingAI: p,
    enableAIFeatures: h,
    renderAiGenerateButton: f
  } = e, m = null != (t = l.name) ? t : "", g = (0, L.Op)(s, {
    content: m
  }), b = (0, k.Od)(n, i), _ = null != i && !h, y = (0, v.Dt)(), C = h ? V.intl.string(V.t["Nb2/RE"]) : "" !== b ? b : V.intl.string(V.t["Nb2/RE"]);
