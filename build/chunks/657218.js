...
function K(e) {
  let {
    ...
    if ((null == e ? void 0 : e.name) != null && (null == e ? void 0 : e.name) !== "" || 0 !== n.length || 0 !== r.length) return void p.Z.show({
  ...
  return (0, r.jsxs)(j.ZP, {
    ...
    children: [(0, r.jsx)(j.ZP.Icon, {
      ...
      children: G.intl.string(G.t["4WNcpq"])
    })]
  })
}
...
function X(e) {
  let {
    ...
    let [n, r] = i.useState({}), l = i.useCallback(n => {
      var i, l;
      r(e => W({}, e, n)), u.Z.changeThreadSettings(e.id, (i = W({}, n), l = l = {
        parentMessageId: t
    ...
    return i.useEffect(() => {
      ...
      return n(!0), N.Z.addChangeListener(n), () => {
    ...
    let {
      ...
      textAreaState: a,
      location: o
    } = e, [s, c] = i.useState(null), [u, d] = i.useState(null), [p, h] = i.useState(!1), f = (0, F.Z)({
      parentChannel: t,
      parentMessageId: n,
      threadSettings: r,
      privateThreadMode: l,
    ...
    return {
      ...
      submit: i.useCallback(async (e, i, l) => {
        ...
        if (c(g ? (0, L.V_)() : null), d(b ? (0, L.T4)() : null), g || b) return h(!1), {
          shouldClear: !1,
          shouldRefocus: !0
        };
        if (null == n) {
        ...
        try {
          ...
          return (null == (u = e.body) ? void 0 : u.code) === H.evJ.AUTOMOD_TITLE_BLOCKED && c((0, L.Gx)(e.body, t)), h(!1), {
            shouldClear: !1,
            shouldRefocus: !0
          }
        }
        return (0, I.qB)(t.id, Y.drafts.type), h(!1), {
          shouldClear: !0,
          shouldRefocus: !1
        }
          ...
          children: (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsxs)(O.ZP, {
              ...
              children: [(0, r.jsx)("div", {
                ...
                error: x,
                disabled: E
              }), t.type === H.d4z.GUILD_TEXT ? (0, r.jsx)(Q, {
...
function J(e) {
  ...
  let {
    ...
    error: o,
    disabled: s
  } = e, u = null != (t = l.name) ? t : "", p = (0, L.Op)(o, {
    content: u
  }), h = (0, k.Od)(n, i), f = null != i, m = (0, v.Dt)();
...
function $(e) {
  let {
    ...
    u.Z.saveDraft(t.id, n, N.d.FirstThreadMessage), l(e => ("" !== n && e.textValue !== n ? d.Z.startTyping(t.id) : "" === n && d.Z.stopTyping(t.id), {
      textValue: n,
      richValue: r
    }))
