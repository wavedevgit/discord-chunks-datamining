...
function Y(e) {
  let {
    ...
    parentMessageId: n,
    location: i
  } = e, l = (0, o.e7)([S.Z], () => S.Z.getChannel(t)), {
      ...
      children: (0, r.jsxs)("section", {
        ...
        children: [(0, r.jsx)(p.Z, {
          ...
          children: [(0, r.jsx)(j.ZP.Icon, {
            ...
            children: F.intl.string(F.t["4WNcpq"])
          })]
        }), (0, r.jsx)(q, {
          parentChannel: l,
          parentMessageId: n,
...
function q(e) {
  let {
    ...
    parentMessageId: n,
    location: l
  } = e, u = (0, o.e7)([h.Z], () => h.Z.messageGroupSpacing), p = function() {
    ...
    let [n, r] = i.useState({}), l = i.useCallback(n => {
      var i, l;
      r(e => z({}, e, n)), c.Z.changeThreadSettings(e.id, (i = z({}, n), l = l = {
        parentMessageId: t
    ...
    return {
      ...
      submit: i.useCallback(async (e, i, l) => {
        ...
        try {
          ...
          return (null == (u = e.body) ? void 0 : u.code) === G.evJ.AUTOMOD_TITLE_BLOCKED && c((0, M.Gx)(e.body, t)), h(!1), {
            shouldClear: !1,
            shouldRefocus: !0
          }
        }
        return (0, I.qB)(t.id, W.drafts.type), h(!1), {
          shouldClear: !0,
          shouldRefocus: !1
        }
    ...
    textAreaState: _,
    location: l
  }), N = (0, L.oD)(f, y) ? s.qtY : s.or_, T = (0, C.R6)("CreateThreadSidebar");
  return (0, r.jsx)("div", {
    className: H.chat,
    onMouseDown: p,
    onFocus: p,
...
function Q(e) {
  ...
  } = e, [f, m] = i.useState(!0), g = i.useCallback(() => m(!0), []), b = i.useCallback(() => m(!1), []), y = i.useCallback((e, n, r) => {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(x.Z, {
      ...
      focused: f,
      className: a()(H.channelTextArea, {
        [H.channelTextAreaWithTypingIndicator]: !h
      }),
      innerClassName: a()(H.channelTextAreaInner, {
        [H.channelTextAreaInnerError]: null != j
      }),
      onFocus: g,
      onBlur: b,
      onChange: y,
