...
function I(e) {
  ...
  return l.useEffect(() => {
    ...
    children: [(0, a.jsx)("dt", {
      ...
      tag: "span",
      className: O.nH,
      onClick: () => (0, b.C)(JSON.stringify(i), () => s(true)),
      children: r ? (0, a.jsx)(u.Uzd, {
        color: "currentColor",
        size: "sm"
      }) : (0, a.jsx)(u.TdU, {
        color: "currentColor",
      ...
      return (0, a.jsxs)("div", {
        ...
        children: [(0, a.jsxs)(p.Ay, {
          ...
          children: [(0, a.jsx)(p.Ay.Icon, {
            ...
            onClick: () => {
              (0, b.C)(JSON.stringify(function(e) {
