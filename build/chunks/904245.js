  ...
  eD = {
    ...
    _sendMessage(e, t, n) {
      ...
      if (!1 !== n.eagerDispatch) {
        ...
        (0, j.EL)(e, t.id), null != g && (t.sticker_items = g.map(e => z.Z.getStickerById(e)).filter(e => null != e)), eD.receiveMessage(e, t, !0, n)
      }
      ...
      return null != b && (Y.message.poll = b), null != g && (Y.message.sticker_ids = g), k.Z.isEnabled() && (Y.message.has_poggermode_enabled = !0), null != y && (Y.message.content_inventory_entry = y), null != m && (Y.message.confetti_potion = (0, V.vY)(m), m.callback()), new Promise((t, r) => {
        let i = Date.now(),
          o = l.ZP.length,
