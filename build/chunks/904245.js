...
let eM = {
  ...
  ej = {
    ...
    async _sendMessage(e, t, n) {
      ...
      if (null != v && (ei.message.poll = v), null != g && (ei.message.sticker_ids = g), F.Z.isEnabled() && (ei.message.has_poggermode_enabled = !0), null != I && (ei.message.content_inventory_entry = I), null != E && (ei.message.confetti_potion = (0, W.vY)(E), E.callback()), null != N && N.length > 0 && (ei.message.attachments = N), null != C && C.length > 0) try {
        let t = await (0, w.c)({
          channelId: e,
          nonce: ee,
          items: C,
      ...
      return new Promise((t, r) => {
        ...
        eP.info("Queueing message to be sent LogId:".concat(c)), l.ZP.enqueue(ei, c => {
          let d = Date.now() - i;
          if (c.ok) {
            ...
            x.Z.recordMessageSendApiResponse(ee), o.Z.dispatch({
              ...
              suggested: m
            }), ex(u, e, c.body.id, null != h ? h : "chat_input", !!n.isGiftLinkSentOnBehalfOfUser), t(c)
          } else {
            var _;
            let t;
            ...
            if (c.hasErr) "ABORTED" === c.err.code && (i = !0);
              ...
              }) : c.body.code === ey.evJ.EXPLICIT_CONTENT ? (t = ev.xi.EXPLICIT_CONTENT, null != s && o.Z.dispatch({
                type: "UPLOAD_FAIL",
                channelId: e,
                file: s._file,
                messageRecord: (0, L.e5)(eN(eT({}, en), {
                  key: "pending-upload-".concat(s._file.id)
                })),
                reason: ev.xi.EXPLICIT_CONTENT,
                noSendFailed: !0
              }), ej.sendExplicitMediaClydeError(e, c.body.attachments, y.UU.EXPLICIT_MEDIA_MESSAGE_SEND_BLOCKED)) : null != v || Q || null != I || ej.sendClydeError(e, c.body.code);
            i ? ej.deleteMessage(e, et, !0) : (o.Z.dispatch({
              type: "MESSAGE_SEND_FAILED",
              messageId: et,
              channelId: e,
