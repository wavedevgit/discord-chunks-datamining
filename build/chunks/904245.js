...
function eD(e) {
  ...
  (0, E.ZP)(t).forEach(e => {
    ...
    else if (t === g.g.QUESTS_EMBED)(0, Q.dA)({
      questId: l,
      event: ey.rMx.QUEST_LINK_SHARED,
      trackGuildAndChannelMetadata: !0
    });
    else if (t === g.g.APP_OAUTH2_LINK) c.ZP.trackWithMetadata(ey.rMx.APP_OAUTH2_LINK_EMBED_URL_SENT, {
      application_id: l
    }), (0, h.z$)(l, h.Un.OAUTH, s);
...
function eL(e) {
  ...
  } = e, u = er.default.getId(), d = eo.Z.getInvite(r), f = (0, C.fU)(r), _ = null != d && (0, P.P1)(d), p = null == d || null == (t = d.target_application) ? void 0 : t.id;
  ...
  if (null != m) {
    ...
    null != s && (t.is_suggested = s.isAffinitySuggestion, t.row_num = s.rowNum, t.num_total = s.numTotal, t.num_affinity_connections = s.numAffinityConnections, t.is_filtered = s.isFiltered), t = eT(eN(eT({}, t), {
      location: a,
      invite_type: e,
    ...
    }), l), c.ZP.trackWithMetadata(ey.rMx.INVITE_SENT, t)
  } else {
    let e = {};
    null != d && d.state === ey.r2o.RESOLVED && null != d.inviter && (e.invite_inviter_id = d.inviter.id, null != d.target_application && (e.application_id = d.target_application.id), e = eT(eN(eT({}, e), {
      location: a,
      ...
      send_type: ey.a5g.DIRECT_MESSAGE,
      invite_guild_scheduled_event_id: f.guildScheduledEventId
    }), l), c.ZP.trackWithMetadata(ey.rMx.INVITE_SENT, e))
  }
}
...
function ex(e, t, n, r, i) {
  (0, ep.Q_)(e).forEach(e => {
    ...
    null != o && c.ZP.trackWithMetadata(ey.rMx.GIFT_CODE_SENT, {
      location: r,
      gift_code: e,
...
function ek(e, t) {
  ...
  if (r.state === X.Y.LOADED && !n.mentions.includes(r.message.author.id)) return {
...
let eM = {
    ...
    [ey.evJ.INVALID_MESSAGE_SEND_USER]: {
      ...
      messageGetter: () => eI.intl.formatToPlainString(eI.t.CTMXwM, {
  ...
  ej = {
    ...
    sendClydeError(e) {
      let t, n, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
        i = ei.Z.getChannel(e);
      null != i && (r === ey.evJ.SLOWMODE_RATE_LIMITED ? (t = eI.intl.formatToPlainString(eI.t.IWntYm, {
        seconds: i.rateLimitPerUser
      }), n = "SLOWMODE_RATE_LIMITED") : r === ey.evJ.INVALID_MESSAGE_SEND_USER ? (t = eI.intl.formatToPlainString(eI.t.CTMXwM, {
        helpUrl: eh.Z.getArticleURL(ey.BhN.DM_COULD_NOT_BE_DELIVERED)
    ...
    sendExplicitMediaClydeError(e, t, n) {
      ...
      ej.sendBotMessage(e, o, s, l), (0, y.aP)({
    ...
    jumpToPresent(e, t) {
      ...
      ea.Z.hasPresent(e) ? a.Z.dispatch({
    ...
    trackJump(e, t, n, r) {
      c.ZP.trackWithMetadata(ey.rMx.JUMP, eT({
        context: n,
        channel_id: e,
        message_id: t
      }, r))
    ...
    jumpToMessage(e) {
      ...
      return "string" == typeof o && ej.trackJump(t, n, o, a), ej.fetchMessages({
        channelId: t,
        limit: ey.Z8P,
        jump: {
          messageId: n,
    ...
    fetchMessages(e) {
      ...
      return d || this.fetchLocalMessages(t, n, r, o, v), i.tn.get({
        ...
        oldFormErrors: !0,
        rejectWithError: !1
      }).then(e => (et.Z.fetchMessages.recordEnd(), et.Z.dispatchMessages.measure(() => {
        let i = e.body,
          s = null != n,
          c = null != r,
          u = null == n && null == r,
        ...
        eC.log("Fetched ".concat(i.length, " messages for ").concat(t, " isBefore:").concat(s, " isAfter:").concat(c)), v.markComplete(), a.Z.dispatch({
      ...
      }), !0), () => (eC.log("Failed to fetch messages for ".concat(t)), a.Z.dispatch({
    ...
    async fetchNewLocalMessages(e, t) {
      ...
      eC.log("Fetched ".concat(l.messages.length, " messages from the cache after foregrounding. ").concat(_.length, " are new")), 0 !== _.length && a.Z.dispatch({
        type: "LOCAL_MESSAGES_LOADED",
        guildId: r.guild_id,
        channelId: e,
        users: l.users,
    ...
    _tryFetchMessagesCached(e) {
      ...
      if ((null == o ? void 0 : o.messageId) != null || (null == s ? void 0 : s.messageId) != null) {
        ...
        let e = (null == o ? void 0 : o.messageId) != null ? eg.default.extractTimestamp(null == o ? void 0 : o.messageId) : 0,
          n = c.first(),
          r = c.last();
        if (!c.hasMoreBefore && null != n && eg.default.extractTimestamp(n.id) >= e || !c.hasMoreAfter && null != r && eg.default.extractTimestamp(r.id) <= e || null != n && null != r && eg.default.extractTimestamp(n.id) < e && eg.default.extractTimestamp(r.id) > e) return a.Z.dispatch({
          type: "LOAD_MESSAGES_SUCCESS_CACHED",
          channelId: t,
          jump: o,
          limit: ey.Z8P
    ...
    async sendMessage(e, t) {
      ...
      return (x.Z.recordMessageSendAttempt(e, a), ea.Z.isReady(e)) ? l() : r && e !== m.V ? (eP.info("Waiting for channel ".concat(e, " to be ready before sending.")), new Promise((t, n) => {
        ea.Z.whenReady(e, () => {
    ...
    sendActivityBookmark: (e, t, n, r) => ej._sendMessage(e, {
      content: t,
      tts: !1,
      validNonShortcutEmojis: [],
      invalidEmojis: []
    ...
    sendGreetMessage(e, t) {
      ...
      return i.tn.post({
        ...
        oldFormErrors: !0,
        rejectWithError: !1
      }).then(n => (k.Z.donateSentMessage(n.body.content, e), ej.receiveMessage(e, n.body), a.Z.dispatch({
        type: "STICKER_TRACK_USAGE",
        stickerIds: [t]
      }), n), t => {
        throw eC.log("Failed to send greeting"), 429 !== t.status && ej.sendClydeError(e, t.body.code), a.Z.dispatch({
    ...
    validateMessage(e, t, n) {
      let r, i;
      return e.some(e => e.animated) && !em.ZP.canUseAnimatedEmojis(t) ? (r = eI.intl.string(eI.t.msFJy8), i = "INVALID_ANIMATED_EMOJI_BODY") : es.Z.canWithPartialContext(ey.Plq.USE_EXTERNAL_EMOJIS, {
        channelId: n
      }) ? (r = eI.intl.string(eI.t.FzugNj), i = "INVALID_EXTERNAL_EMOJI_BODY_UPGRADE") : (r = eI.intl.string(eI.t.Q87rIy), i = "INVALID_EXTERNAL_EMOJI_BODY"), {
        errorMessage: r,
        errorMessageName: i
      }
    },
    async _sendMessage(e, t, n) {
      var r, i, o;
      let s, c, u = (0, q.Z)(e);
      if (null != u) return eP.info("Converting channel to a private channel"), u.then(e => {
      ...
      if (!1 !== n.eagerDispatch && (s = (0, M.ZP)({
          ...
          nonce: et,
          poll: (0, V.x9)(I)
        }), (0, B.EL)(e, s.id), null != E && (s.sticker_items = E.map(e => J.Z.getStickerById(e)).filter(e => null != e)), ej.receiveMessage(e, s, !0, n)), !eR && null != f && f.length > 0) {
        eR = !0;
        let t = ed.default.getCurrentUser(),
          {
            errorMessage: n,
            errorMessageName: r
          } = ej.validateMessage(f, t, e);
      ...
      if (null != I && (ei.message.poll = I), null != E && (ei.message.sticker_ids = E), F.Z.isEnabled() && (ei.message.has_poggermode_enabled = !0), null != N && (ei.message.content_inventory_entry = N), null != b && (ei.message.confetti_potion = (0, W.vY)(b), b.callback()), null != C && C.length > 0 && (ei.message.attachments = C), null != P && P.length > 0) try {
        let t = await (0, w.c)({
          channelId: e,
          nonce: et,
          items: P,
      ...
      return new Promise((t, r) => {
        ...
        eP.info("Queueing message to be sent LogId:".concat(u)), l.ZP.enqueue(ei, u => {
          let f = Date.now() - i;
          if (u.ok) {
            k.Z.donateSentMessage(d, e), ej.receiveMessage(e, u.body, !0, {
              sendAnalytics: {
                duration: f,
                queueSize: o
              },
            ...
            x.Z.recordMessageSendApiResponse(et), a.Z.dispatch({
              ...
              suggested: g
            }), ex(d, e, u.body.id, null != m ? m : "chat_input", !!n.isGiftLinkSentOnBehalfOfUser), t(u)
          } else {
            var p;
            let t;
            ...
            if (u.hasErr) "ABORTED" === u.err.code && (i = !0);
              ...
              } else S.U8.has(u.body.code) ? a.Z.dispatch({
              ...
              }) : u.body.code === ey.evJ.POGGERMODE_TEMPORARILY_DISABLED ? a.Z.dispatch({
                type: "POGGERMODE_TEMPORARILY_DISABLED"
              }) : u.body.code === ey.evJ.EXPLICIT_CONTENT ? (t = ev.xi.EXPLICIT_CONTENT, null != c && a.Z.dispatch({
                type: "UPLOAD_FAIL",
                channelId: e,
                file: c._file,
                messageRecord: (0, L.e5)(eN(eT({}, s), {
                  key: "pending-upload-".concat(c._file.id)
                })),
                reason: ev.xi.EXPLICIT_CONTENT,
                noSendFailed: !0
              }), ej.sendExplicitMediaClydeError(e, u.body.attachments, y.UU.EXPLICIT_MEDIA_MESSAGE_SEND_BLOCKED)) : null != I || X || null != N || ej.sendClydeError(e, u.body.code);
            i ? ej.deleteMessage(e, en, !0) : (a.Z.dispatch({
              type: "MESSAGE_SEND_FAILED",
              messageId: en,
              channelId: e,
              ...
              eC.log("Cancelling pending message", e.nonce), a.Z.dispatch({
                type: "MESSAGE_SEND_FAILED",
                messageId: e.nonce,
    ...
    async editMessage(e, t, n) {
      ...
      l.ZP.enqueue({
        ...
        n.hasErr ? o.uv.announce(eI.intl.string(eI.t.Atp7FB)) : r ? o.uv.announce(eI.intl.string(eI.t.Hym4i4)) : o.uv.announce(eI.intl.string(eI.t["0x1HBA"])), ej.endEditMessage(e, n.hasErr ? void 0 : n), ej.focusMessage({
          channelId: e,
          messageId: t
        })
      })
    ...
    async suppressEmbeds(e, t) {
      await ee.Z.unarchiveThreadIfNecessary(e), i.tn.patch({
        url: ey.ANM.MESSAGE(e, t),
        body: {
          flags: ey.iLy.SUPPRESS_EMBEDS
        },
        oldFormErrors: !0,
        rejectWithError: !1
      })
    ...
    async deleteMessage(e, t) {
      ...
      n ? r() : (await ee.Z.unarchiveThreadIfNecessary(e), i.tn.del({
        url: ey.ANM.MESSAGE(e, t),
        oldFormErrors: !0,
        rejectWithError: !1
      }).then(() => {
    ...
    dismissAutomatedMessage(e) {
      null != e.loggingName && c.ZP.trackWithMetadata(ey.rMx.AUTOMATED_MESSAGE_DISMISSED, {
    ...
    crosspostMessage: (e, t) => i.tn.post({
      ...
      let t;
      t = 429 === e.status ? eI.intl.formatToPlainString(eI.t["77cuq6"], {
        retryAfter: Math.floor(e.body.retry_after / 60)
      }) : eI.intl.string(eI.t.z2gyND), eb.Z.show({
