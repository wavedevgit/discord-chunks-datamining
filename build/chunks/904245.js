...
function ew(e) {
  ...
  (0, g.ZP)(t).forEach(e => {
    ...
    else if (t === m.g.QUESTS_EMBED)(0, q.dA)({
      questId: l,
      event: eb.rMx.QUEST_LINK_SHARED,
      trackGuildAndChannelMetadata: !0
    });
    else if (t === m.g.APP_OAUTH2_LINK) c.ZP.trackWithMetadata(eb.rMx.APP_OAUTH2_LINK_EMBED_URL_SENT, {
      application_id: l
    }), (0, p.z$)(l, p.Un.OAUTH, s);
...
function eD(e) {
  ...
  } = e, u = en.default.getId(), d = ei.Z.getInvite(r), f = (0, N.fU)(r), _ = null != d && (0, C.P1)(d), h = null == d || null == (t = d.target_application) ? void 0 : t.id;
  ...
  if (null != m) {
    ...
    null != s && (t.is_suggested = s.isAffinitySuggestion, t.row_num = s.rowNum, t.num_total = s.numTotal, t.num_affinity_connections = s.numAffinityConnections, t.is_filtered = s.isFiltered), t = eS(eA(eS({}, t), {
      location: o,
      invite_type: e,
    ...
    }), l), c.ZP.trackWithMetadata(eb.rMx.INVITE_SENT, t)
  } else {
    let e = {};
    null != d && d.state === eb.r2o.RESOLVED && null != d.inviter && (e.invite_inviter_id = d.inviter.id, null != d.target_application && (e.application_id = d.target_application.id), e = eS(eA(eS({}, e), {
      location: o,
      ...
      send_type: eb.a5g.DIRECT_MESSAGE,
      invite_guild_scheduled_event_id: f.guildScheduledEventId
    }), l), c.ZP.trackWithMetadata(eb.rMx.INVITE_SENT, e))
  }
}
...
function eL(e, t, n, r, i) {
  (0, e_.Q_)(e).forEach(e => {
    ...
    null != a && c.ZP.trackWithMetadata(eb.rMx.GIFT_CODE_SENT, {
      location: r,
      gift_code: e,
...
function ex(e, t) {
  ...
  if (r.state === Q.Y.LOADED && !n.mentions.includes(r.message.author.id)) return {
...
let ek = {
    ...
    [eb.evJ.INVALID_MESSAGE_SEND_USER]: {
      ...
      messageGetter: () => ev.intl.formatToPlainString(ev.t.CTMXwM, {
        helpUrl: ep.Z.getArticleURL(eb.BhN.DM_COULD_NOT_BE_DELIVERED)
      })
    },
  ...
  eM = {
    ...
    sendBotMessage(e, t, n, r) {
      null != n && c.ZP.trackWithMetadata(eb.rMx.AUTOMATED_MESSAGE_RECEIVED, {
        message_author: "Clyde",
        message_name: n
      }), eM.receiveMessage(e, (0, k.cs)({
        messageId: r,
        channelId: e,
        content: t,
        loggingName: n
    ...
    sendClydeError(e) {
      let t, n, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
        i = er.Z.getChannel(e);
      null != i && (r === eb.evJ.SLOWMODE_RATE_LIMITED ? (t = ev.intl.formatToPlainString(ev.t.IWntYm, {
        seconds: i.rateLimitPerUser
      }), n = "SLOWMODE_RATE_LIMITED") : r === eb.evJ.INVALID_MESSAGE_SEND_USER ? (t = ev.intl.formatToPlainString(ev.t.CTMXwM, {
        helpUrl: ep.Z.getArticleURL(eb.BhN.DM_COULD_NOT_BE_DELIVERED)
      }), n = "INVALID_MESSAGE_SEND_USER") : r === eb.evJ.TOO_MANY_THREADS ? (t = i.isForumLikeChannel() || i.isForumPost() ? ev.intl.string(ev.t["/jUd29"]) : ev.intl.string(ev.t["5EMPAw"]), n = "TOO_MANY_THREADS") : r === eb.evJ.TOO_MANY_ANNOUNCEMENT_THREADS ? (t = ev.intl.string(ev.t["aY+lLC"]), n = "TOO_MANY_ANNOUNCEMENT_THREADS") : r === eb.evJ.HARMFUL_LINK_MESSAGE_BLOCKED ? (t = ev.intl.formatToPlainString(ev.t.zSG3Q0, {
        helpUrl: eb.EYA.HARMFUL_LINKS
      }), n = "HARMFUL_LINK_MESSAGE_BLOCKED") : r in ek ? (n = ek[r].messageName, t = ek[r].messageGetter()) : (t = ev.intl.formatToPlainString(ev.t.CTMXwM, {
        helpUrl: ep.Z.getArticleURL(eb.BhN.DM_COULD_NOT_BE_DELIVERED)
    ...
    sendExplicitMediaClydeError(e, t, n) {
      ...
      eM.sendBotMessage(e, a, s, l), (0, b.aP)({
    ...
    jumpToPresent(e, t) {
      ...
      ea.Z.hasPresent(e) ? o.Z.dispatch({
    ...
    trackJump(e, t, n, r) {
      c.ZP.trackWithMetadata(eb.rMx.JUMP, eS({
        context: n,
        channel_id: e,
        message_id: t
      }, r))
    ...
    jumpToMessage(e) {
      ...
      return "string" == typeof a && eM.trackJump(t, n, a, o), eM.fetchMessages({
        channelId: t,
        limit: eb.Z8P,
        jump: {
          messageId: n,
    ...
    fetchMessages(e) {
      let {
        ...
        truncate: f,
        forICYMI: _
      } = e, p = er.Z.getChannel(t), m = y.Z.isConnectedOrOverlay(), g = Date.now();
      if (null != p && p.type === eb.d4z.GUILD_STORE) return !1;
      if (t === h.V || (eN.log("Fetching messages for ".concat(t, " between ").concat(n, " and ").concat(r, ". jump=").concat(JSON.stringify(l))), eM._tryFetchMessagesCached({
          channelId: t,
          before: n,
          after: r,
          limit: a,
      ...
      return d || this.fetchLocalMessages(t, n, r, a, v), i.tn.get({
        ...
        oldFormErrors: !0,
        rejectWithError: !1
      }).then(e => (ee.Z.fetchMessages.recordEnd(), ee.Z.dispatchMessages.measure(() => {
        let i = e.body,
          s = null != n,
          c = null != r,
          u = null == n && null == r,
        ...
        if (null != O) {
          let e = Math.floor(a / 2),
            ...
            r = [O, ...i.map(e => {
              ...
              return t
            })].filter((e, t, n) => n.indexOf(e) === t).sort(em.default.compare).indexOf(O);
          if (r < n - 1 && (d = !1), i.length - r < e && (p = !1), p && i.length > 0) {
            let e = el.ZP.lastMessageId(t);
            i[0].id === e && (p = !1)
          }
        }
        eN.log("Fetched ".concat(i.length, " messages for ").concat(t, " isBefore:").concat(s, " isAfter:").concat(c)), v.markComplete(), o.Z.dispatch({
      ...
      }), !0), () => (eN.log("Failed to fetch messages for ".concat(t)), o.Z.dispatch({
    ...
    async fetchNewLocalMessages(e, t) {
      ...
      eN.log("Fetched ".concat(l.messages.length, " messages from the cache after foregrounding. ").concat(_.length, " are new")), 0 !== _.length && o.Z.dispatch({
        type: "LOCAL_MESSAGES_LOADED",
        guildId: r.guild_id,
        channelId: e,
        users: l.users,
    ...
    _tryFetchMessagesCached(e) {
      let {
        ...
        focus: s,
        truncate: l
      } = e, c = ea.Z.getMessages(t);
      if (c.cached || !c.ready) return !1;
      if ((null == a ? void 0 : a.messageId) != null || (null == s ? void 0 : s.messageId) != null) {
        if ((null == a ? void 0 : a.messageId) != null && c.has(a.messageId, !1)) return o.Z.dispatch({
          type: "LOAD_MESSAGES_SUCCESS_CACHED",
          channelId: t,
          jump: a,
          limit: i,
        ...
        if ((null == s ? void 0 : s.messageId) != null)
          if (c.has(s.messageId, !1)) return o.Z.dispatch({
            type: "LOAD_MESSAGES_SUCCESS_CACHED",
            channelId: t,
            focus: s,
            limit: i,
        ...
        let e = (null == a ? void 0 : a.messageId) != null ? em.default.extractTimestamp(null == a ? void 0 : a.messageId) : 0,
          n = c.first(),
          r = c.last();
        if (!c.hasMoreBefore && null != n && em.default.extractTimestamp(n.id) >= e || !c.hasMoreAfter && null != r && em.default.extractTimestamp(r.id) <= e || null != n && null != r && em.default.extractTimestamp(n.id) < e && em.default.extractTimestamp(r.id) > e) return o.Z.dispatch({
          type: "LOAD_MESSAGES_SUCCESS_CACHED",
          channelId: t,
          jump: a,
          limit: eb.Z8P
        }), !0
      } else if (null != n && c.hasBeforeCached(n)) return o.Z.dispatch({
        type: "LOAD_MESSAGES_SUCCESS_CACHED",
        channelId: t,
        before: n,
        limit: i,
      ...
      else if (null != r && c.hasAfterCached(r)) return o.Z.dispatch({
        type: "LOAD_MESSAGES_SUCCESS_CACHED",
        channelId: t,
        after: r,
        limit: i,
    ...
    async sendMessage(e, t) {
      ...
      return (i = eA(eS({}, i), {
        nonce: l
      }), L.Z.recordMessageSendAttempt(e, l), ea.Z.isReady(e)) ? s() : r && e !== h.V ? (eC.info("Waiting for channel ".concat(e, " to be ready before sending.")), new Promise((t, n) => {
        ea.Z.whenReady(e, () => {
    ...
    sendGreetMessage(e, t) {
      ...
      return i.tn.post({
        ...
        oldFormErrors: !0,
        rejectWithError: !1
      }).then(n => (x.Z.donateSentMessage(n.body.content, e), eM.receiveMessage(e, n.body), o.Z.dispatch({
        type: "STICKER_TRACK_USAGE",
        stickerIds: [t]
      }), n), t => {
        throw eN.log("Failed to send greeting"), 429 !== t.status && eM.sendClydeError(e, t.body.code), o.Z.dispatch({
    ...
    validateMessage(e, t, n) {
      let r, i;
      return e.some(e => e.animated) && !eh.ZP.canUseAnimatedEmojis(t) ? (r = ev.intl.string(ev.t.msFJy8), i = "INVALID_ANIMATED_EMOJI_BODY") : eo.Z.canWithPartialContext(eb.Plq.USE_EXTERNAL_EMOJIS, {
        channelId: n
      }) ? (r = ev.intl.string(ev.t.FzugNj), i = "INVALID_EXTERNAL_EMOJI_BODY_UPGRADE") : (r = ev.intl.string(ev.t.Q87rIy), i = "INVALID_EXTERNAL_EMOJI_BODY"), {
        errorMessage: r,
        errorMessageName: i
      }
    },
    async _sendMessage(e, t, n) {
      var r, i, a;
      let s, c, u = (0, z.Z)(e);
      if (null != u) return eC.info("Converting channel to a private channel"), u.then(e => {
      ...
      if (!1 !== n.eagerDispatch && (s = (0, k.ZP)({
          ...
          nonce: et,
          poll: (0, F.x9)(A)
        }), (0, G.EL)(e, s.id), null != E && (s.sticker_items = E.map(e => X.Z.getStickerById(e)).filter(e => null != e)), eM.receiveMessage(e, s, !0, n)), !eP && null != f && f.length > 0) {
        eP = !0;
        let t = eu.default.getCurrentUser(),
          {
            errorMessage: n,
            errorMessageName: r
          } = eM.validateMessage(f, t, e);
      ...
      if (null != A && (ei.message.poll = A), null != E && (ei.message.sticker_ids = E), B.Z.isEnabled() && (ei.message.has_poggermode_enabled = !0), null != N && (ei.message.content_inventory_entry = N), null != y && (ei.message.confetti_potion = (0, Y.vY)(y), y.callback()), null != C && C.length > 0 && (ei.message.attachments = C), null != P && P.length > 0) try {
        let t = await (0, R.c)({
          channelId: e,
          nonce: et,
          items: P,
      ...
      return new Promise((t, r) => {
        ...
        eC.info("Queueing message to be sent LogId:".concat(u)), l.ZP.enqueue(ei, u => {
          let f = Date.now() - i;
          if (u.ok) {
            x.Z.donateSentMessage(d, e), eM.receiveMessage(e, u.body, !0, {
              sendAnalytics: {
                duration: f,
                queueSize: a
              },
            ...
            let r = (0, Y.ZC)(u.body);
            null != r && ((0, V.gA)(W.D1), (0, K.I)({
              name: r.name,
              id: r.id
            }, void 0, !0, H.LL.MessageSent));
            ...
            L.Z.recordMessageSendApiResponse(et), o.Z.dispatch({
              ...
              suggested: g
            }), eL(d, e, u.body.id, null != m ? m : "chat_input", !!n.isGiftLinkSentOnBehalfOfUser), t(u)
          } else {
            var p;
            let t;
            ...
            if (u.hasErr) "ABORTED" === u.err.code && (i = !0);
              ...
              } else I.U8.has(u.body.code) ? o.Z.dispatch({
              ...
              }) : u.body.code === eb.evJ.POGGERMODE_TEMPORARILY_DISABLED ? o.Z.dispatch({
                type: "POGGERMODE_TEMPORARILY_DISABLED"
              }) : u.body.code === eb.evJ.EXPLICIT_CONTENT ? (t = eO.xi.EXPLICIT_CONTENT, null != c && o.Z.dispatch({
                type: "UPLOAD_FAIL",
                channelId: e,
                file: c._file,
                messageRecord: (0, D.e5)(eA(eS({}, s), {
                  key: "pending-upload-".concat(c._file.id)
                })),
                reason: eO.xi.EXPLICIT_CONTENT,
                noSendFailed: !0
              }), eM.sendExplicitMediaClydeError(e, u.body.attachments, b.UU.EXPLICIT_MEDIA_MESSAGE_SEND_BLOCKED)) : null != A || $ || null != N || eM.sendClydeError(e, u.body.code);
            i ? eM.deleteMessage(e, er, !0) : (o.Z.dispatch({
              type: "MESSAGE_SEND_FAILED",
              messageId: er,
              channelId: e,
              ...
              eN.log("Cancelling pending message", e.nonce), o.Z.dispatch({
                type: "MESSAGE_SEND_FAILED",
                messageId: e.nonce,
    ...
    async editMessage(e, t, n) {
      ...
      l.ZP.enqueue({
        ...
        n.hasErr ? a.uv.announce(ev.intl.string(ev.t.Atp7FB)) : r ? a.uv.announce(ev.intl.string(ev.t.Hym4i4)) : a.uv.announce(ev.intl.string(ev.t["0x1HBA"])), eM.endEditMessage(e, n.hasErr ? void 0 : n), eM.focusMessage({
          channelId: e,
          messageId: t
        })
      })
    ...
    async suppressEmbeds(e, t) {
      await $.Z.unarchiveThreadIfNecessary(e), i.tn.patch({
        url: eb.ANM.MESSAGE(e, t),
        body: {
          flags: eb.iLy.SUPPRESS_EMBEDS
        },
        oldFormErrors: !0,
        rejectWithError: !1
      })
    ...
    async deleteMessage(e, t) {
      ...
      n ? r() : (await $.Z.unarchiveThreadIfNecessary(e), i.tn.del({
        url: eb.ANM.MESSAGE(e, t),
        oldFormErrors: !0,
        rejectWithError: !1
      }).then(() => {
    ...
    dismissAutomatedMessage(e) {
      null != e.loggingName && c.ZP.trackWithMetadata(eb.rMx.AUTOMATED_MESSAGE_DISMISSED, {
    ...
    crosspostMessage: (e, t) => i.tn.post({
      ...
      let t;
      t = 429 === e.status ? ev.intl.formatToPlainString(ev.t["77cuq6"], {
        retryAfter: Math.floor(e.body.retry_after / 60)
      }) : ev.intl.string(ev.t.z2gyND), eE.Z.show({
