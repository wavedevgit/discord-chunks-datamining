...
function ex(e) {
  ...
  (0, b.ZP)(t).forEach(e => {
    ...
    else if (t === E.g.QUESTS_EMBED)(0, J.dA)({
      questId: c,
      event: ev.rMx.QUEST_LINK_SHARED,
      trackGuildAndChannelMetadata: !0,
      sourceQuestContent: i.j.QUESTS_EMBED
    });
    else if (t === E.g.APP_OAUTH2_LINK) u.ZP.trackWithMetadata(ev.rMx.APP_OAUTH2_LINK_EMBED_URL_SENT, {
      application_id: c
    }), (0, m.z$)(c, m.Un.OAUTH, l);
...
function ek(e) {
  ...
  } = e, c = ea.default.getId(), d = es.Z.getInvite(r), f = (0, P.fU)(r), _ = null != d && (0, w.P1)(d), p = null == d || null == (t = d.target_application) ? void 0 : t.id;
  ...
  if (null != h) {
    ...
    null != s && (t.is_suggested = s.isAffinitySuggestion, t.row_num = s.rowNum, t.num_total = s.numTotal, t.num_affinity_connections = s.numAffinityConnections, t.is_filtered = s.isFiltered), t = eN(eR(eN({}, t), {
      location: o,
      invite_type: e,
    ...
    }), l), u.ZP.trackWithMetadata(ev.rMx.INVITE_SENT, t)
  } else {
    let e = {};
    null != d && d.state === ev.r2o.RESOLVED && null != d.inviter && (e.invite_inviter_id = d.inviter.id, null != d.target_application && (e.application_id = d.target_application.id), e = eN(eR(eN({}, e), {
      location: o,
      ...
      send_type: ev.a5g.DIRECT_MESSAGE,
      invite_guild_scheduled_event_id: f.guildScheduledEventId
    }), l), u.ZP.trackWithMetadata(ev.rMx.INVITE_SENT, e))
  }
}
...
function eM(e, t, n, r, i) {
  (0, em.Q_)(e).forEach(e => {
    ...
    null != a && u.ZP.trackWithMetadata(ev.rMx.GIFT_CODE_SENT, {
      location: r,
      gift_code: e,
...
let eU = {
    ...
    [ev.evJ.INVALID_MESSAGE_SEND_USER]: {
      ...
      messageGetter: () => eS.intl.formatToPlainString(eS.t.CTMXwM, {
  ...
  eG = {
    ...
    sendBotMessage(e, t, n, r) {
      null != n && u.ZP.trackWithMetadata(ev.rMx.AUTOMATED_MESSAGE_RECEIVED, {
        message_author: "Clyde",
        message_name: n
      }), eG.receiveMessage(e, (0, U.cs)({
        messageId: r,
        channelId: e,
        content: t,
        loggingName: n
    ...
    sendClydeError(e) {
      let t, n, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
        i = eo.Z.getChannel(e);
      null != i && (r === ev.evJ.SLOWMODE_RATE_LIMITED ? (t = eS.intl.formatToPlainString(eS.t.IWntYm, {
        seconds: i.rateLimitPerUser
      }), n = "SLOWMODE_RATE_LIMITED") : r === ev.evJ.INVALID_MESSAGE_SEND_USER ? (t = eS.intl.formatToPlainString(eS.t.CTMXwM, {
        helpUrl: eg.Z.getArticleURL(ev.BhN.DM_COULD_NOT_BE_DELIVERED)
      }), n = "INVALID_MESSAGE_SEND_USER") : r === ev.evJ.TOO_MANY_THREADS ? (t = i.isForumLikeChannel() || i.isForumPost() ? eS.intl.string(eS.t["/jUd29"]) : eS.intl.string(eS.t["5EMPAw"]), n = "TOO_MANY_THREADS") : r === ev.evJ.TOO_MANY_ANNOUNCEMENT_THREADS ? (t = eS.intl.string(eS.t["aY+lLC"]), n = "TOO_MANY_ANNOUNCEMENT_THREADS") : r === ev.evJ.HARMFUL_LINK_MESSAGE_BLOCKED ? (t = eS.intl.formatToPlainString(eS.t.zSG3Q0, {
        helpUrl: ev.EYA.HARMFUL_LINKS
      }), n = "HARMFUL_LINK_MESSAGE_BLOCKED") : r in eU ? (n = eU[r].messageName, t = eU[r].messageGetter()) : (t = eS.intl.formatToPlainString(eS.t.CTMXwM, {
        helpUrl: eg.Z.getArticleURL(ev.BhN.DM_COULD_NOT_BE_DELIVERED)
      }), n = "SEND_FAILED (".concat(r, ")")), eG.sendBotMessage(e, t, n))
    },
    sendExplicitMediaClydeError(e, t, n) {
      ...
      eG.sendBotMessage(e, o, l, c), (0, O.aP)({
    ...
    trackJump(e, t, n, r) {
      u.ZP.trackWithMetadata(ev.rMx.JUMP, eN({
        context: n,
        channel_id: e,
        message_id: t
      }, r))
    ...
    jumpToMessage(e) {
      ...
      return "string" == typeof a && eG.trackJump(t, n, a, o), eG.fetchMessages({
        channelId: t,
        limit: ev.Z8P,
        jump: {
          messageId: n,
    ...
    fetchMessages(e) {
      ...
      } = e, h = eo.Z.getChannel(t), m = I.Z.isConnectedOrOverlay(), E = Date.now();
      if (null != h && h.type === ev.d4z.GUILD_STORE) return !1;
      if (t === g.V || (eP.log("Fetching messages for ".concat(t, " between ").concat(n, " and ").concat(r, ". jump=").concat(JSON.stringify(o))), eG._tryFetchMessagesCached({
          channelId: t,
          before: n,
          after: r,
          limit: i,
        ...
        if (null != O) {
          let e = Math.floor(i / 2),
            ...
            r = [O, ...a.map(e => {
              ...
              return t
            })].filter((e, t, n) => n.indexOf(e) === t).sort(eb.default.compare).indexOf(O);
      ...
      }), !0), () => (eP.log("Failed to fetch messages for ".concat(t)), s.Z.dispatch({
    ...
    _tryFetchMessagesCached(e) {
      ...
      if ((null == a ? void 0 : a.messageId) != null || (null == o ? void 0 : o.messageId) != null) {
        if ((null == a ? void 0 : a.messageId) != null && c.has(a.messageId, !1)) return s.Z.dispatch({
          type: "LOAD_MESSAGES_SUCCESS_CACHED",
          channelId: t,
          jump: a,
          limit: i,
        ...
        if ((null == o ? void 0 : o.messageId) != null)
          if (c.has(o.messageId, !1)) return s.Z.dispatch({
            type: "LOAD_MESSAGES_SUCCESS_CACHED",
            channelId: t,
            focus: o,
            limit: i,
    ...
    async sendMessage(e, t) {
      ...
      return (M.Z.recordMessageSendAttempt(e, o), el.Z.isReady(e)) ? l() : r && e !== g.V ? (ew.info("Waiting for channel ".concat(e, " to be ready before sending.")), new Promise((t, n) => {
        el.Z.whenReady(e, () => {
    ...
    sendActivityBookmark: (e, t, n, r) => eG._sendMessage(e, {
      content: t,
      tts: !1,
      validNonShortcutEmojis: [],
      invalidEmojis: []
    ...
    sendGreetMessage(e, t) {
      ...
      return a.tn.post({
        ...
        oldFormErrors: !0,
        rejectWithError: !1
      }).then(n => (j.Z.donateSentMessage(n.body.content, e), eG.receiveMessage(e, n.body), s.Z.dispatch({
        type: "STICKER_TRACK_USAGE",
        stickerIds: [t]
      }), n), t => {
        throw eP.log("Failed to send greeting"), 429 !== t.status && eG.sendClydeError(e, t.body.code), s.Z.dispatch({
    ...
    validateMessage(e, t, n) {
      let r, i;
      return e.some(e => e.animated) && !eE.ZP.canUseAnimatedEmojis(t) ? (r = eS.intl.string(eS.t.msFJy8), i = "INVALID_ANIMATED_EMOJI_BODY") : ec.Z.canWithPartialContext(ev.Plq.USE_EXTERNAL_EMOJIS, {
        channelId: n
      }) ? (r = eS.intl.string(eS.t.FzugNj), i = "INVALID_EXTERNAL_EMOJI_BODY_UPGRADE") : (r = eS.intl.string(eS.t.Q87rIy), i = "INVALID_EXTERNAL_EMOJI_BODY"), {
        errorMessage: r,
        errorMessageName: i
      }
    },
    async _sendMessage(e, t, n) {
      var r, i, a;
      let o, l = (0, Q.Z)(e);
      if (null != l) return ew.info("Converting channel to a private channel"), l.then(e => {
      ...
      if (null != v && (en.message.poll = v), null != g && (en.message.sticker_ids = g), Z.Z.isEnabled() && (en.message.has_poggermode_enabled = !0), null != I && (en.message.content_inventory_entry = I), null != E && (en.message.confetti_potion = (0, z.vY)(E), E.callback()), null != T && T.length > 0 && (en.message.attachments = T), null != S && S.length > 0) try {
        let t = await (0, L.c)({
          channelId: e,
          nonce: W,
          items: S,
      ...
      return new Promise((t, r) => {
        ...
        ew.info("Queueing message to be sent LogId:".concat(l)), c.ZP.enqueue(en, l => {
          let d = Date.now() - i;
          if (l.ok) {
            j.Z.donateSentMessage(u, e), eG.receiveMessage(e, l.body, !0, {
              sendAnalytics: {
                duration: d,
                queueSize: a
              },
            ...
            let r = (0, z.ZC)(l.body);
            null != r && ((0, Y.gA)(q.D1), (0, X.I)({
              name: r.name,
              id: r.id
            }, void 0, !0, K.LL.MessageSent));
            ...
            M.Z.recordMessageSendApiResponse(W), s.Z.dispatch({
            ...
            if (l.hasErr) "ABORTED" === l.err.code && (i = !0);
              ...
              } else A.U8.has(l.body.code) ? s.Z.dispatch({
              ...
              }) : l.body.code === ev.evJ.POGGERMODE_TEMPORARILY_DISABLED ? s.Z.dispatch({
                type: "POGGERMODE_TEMPORARILY_DISABLED"
              }) : l.body.code === ev.evJ.EXPLICIT_CONTENT ? t = eT.xi.EXPLICIT_CONTENT : null != v || k || null != I || eG.sendClydeError(e, l.body.code);
            i ? eG.deleteMessage(e, J, !0) : (null != o && s.Z.dispatch({
              type: "UPLOAD_FAIL",
              channelId: e,
              file: o._file,
              messageId: J,
              reason: t,
              noSendFailed: !0
            }), l.hasErr || t !== eT.xi.EXPLICIT_CONTENT || eG.sendExplicitMediaClydeError(e, null == (p = l.body) ? void 0 : p.attachments, O.UU.EXPLICIT_MEDIA_MESSAGE_SEND_BLOCKED), s.Z.dispatch({
              type: "MESSAGE_SEND_FAILED",
              messageId: J,
              channelId: e,
    ...
    async editMessage(e, t, n) {
      ...
      c.ZP.enqueue({
        ...
        n.hasErr ? o.uv.announce(eS.intl.string(eS.t.Atp7FB)) : r ? o.uv.announce(eS.intl.string(eS.t.Hym4i4)) : o.uv.announce(eS.intl.string(eS.t["0x1HBA"])), eG.endEditMessage(e, n.hasErr ? void 0 : n), eG.focusMessage({
          channelId: e,
          messageId: t
        })
      })
    ...
    dismissAutomatedMessage(e) {
      null != e.loggingName && u.ZP.trackWithMetadata(ev.rMx.AUTOMATED_MESSAGE_DISMISSED, {
    ...
    crosspostMessage: (e, t) => a.tn.post({
      ...
      let t;
      t = 429 === e.status ? eS.intl.formatToPlainString(eS.t["77cuq6"], {
        retryAfter: Math.floor(e.body.retry_after / 60)
      }) : eS.intl.string(eS.t.z2gyND), eO.Z.show({
