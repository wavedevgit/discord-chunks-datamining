...
let eM = {
  ...
  ej = {
    ...
    fetchMessages(e) {
      ...
      s.Z.commit(y), a.Z.dispatch({
        type: "LOAD_MESSAGES"
      });
      let v = null == b ? void 0 : b.messageId,
        I = new ew;
      return d || this.fetchLocalMessages(t, n, r, o, I), i.tn.get({
        url: ey.ANM.MESSAGES(t),
        query: {
          before: n,
          after: r,
        ...
        eC.log("Fetched ".concat(i.length, " messages for ").concat(t, " isBefore:").concat(s, " isAfter:").concat(c)), I.markComplete(), a.Z.dispatch({
    ...
    async _sendMessage(e, t, n) {
      var r, i, o;
      let s, c = (0, q.Z)(e);
      if (null != c) return eP.info("Converting channel to a private channel"), c.then(e => {
      ...
      let u = t.content,
        ...
        } = t,
        {
          ...
          suggestedInvite: m,
          stickerIds: g,
          confettiPotionData: E,
          messageReference: b,
          allowedMentions: O,
          poll: v,
          contentInventoryEntry: I,
          attachments: N,
      ...
      if (null != p) {
        let e, t = null == p ? void 0 : p.activity.session_id;
      ...
      if (null != v && (en.message.poll = v), null != g && (en.message.sticker_ids = g), F.Z.isEnabled() && (en.message.has_poggermode_enabled = !0), null != I && (en.message.content_inventory_entry = I), null != E && (en.message.confetti_potion = (0, W.vY)(E), E.callback()), null != N && N.length > 0 && (en.message.attachments = N), null != C && C.length > 0) try {
        let t = await (0, w.c)({
          channelId: e,
          nonce: X,
          items: C,
      ...
      return new Promise((t, r) => {
        ...
        eP.info("Queueing message to be sent LogId:".concat(c)), l.ZP.enqueue(en, c => {
          let d = Date.now() - i;
          if (c.ok) {
            ...
            x.Z.recordMessageSendApiResponse(X), a.Z.dispatch({
              ...
              suggested: m
            }), ex(u, e, c.body.id, null != h ? h : "chat_input", !!n.isGiftLinkSentOnBehalfOfUser), null != s && a.Z.dispatch({
            ...
            if (c.hasErr) "ABORTED" === c.err.code && (i = !0);
              ...
              } else S.U8.has(c.body.code) ? a.Z.dispatch({
              ...
              }) : c.body.code === ey.evJ.POGGERMODE_TEMPORARILY_DISABLED ? a.Z.dispatch({
                type: "POGGERMODE_TEMPORARILY_DISABLED"
              }) : c.body.code === ey.evJ.EXPLICIT_CONTENT ? t = ev.xi.EXPLICIT_CONTENT : null != v || H || null != I || ej.sendClydeError(e, c.body.code);
            i ? ej.deleteMessage(e, ee, !0) : (null != s && a.Z.dispatch({
              type: "UPLOAD_FAIL",
              channelId: e,
              file: s._file,
              messageId: ee,
              reason: t,
              noSendFailed: !0
            }), c.hasErr || t !== ev.xi.EXPLICIT_CONTENT || ej.sendExplicitMediaClydeError(e, null == (p = c.body) ? void 0 : p.attachments, y.UU.EXPLICIT_MEDIA_MESSAGE_SEND_BLOCKED), a.Z.dispatch({
              type: "MESSAGE_SEND_FAILED",
              messageId: ee,
              channelId: e,
