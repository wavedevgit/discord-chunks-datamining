...
function eM(e) {
  ...
  (0, y.ZP)(t).forEach(e => {
    ...
    else if (t === b.g.QUESTS_EMBED)(0, J.dA)({
      questId: c,
...
function ek(e) {
  ...
  } = e, c = ea.default.getId(), u = es.Z.getInvite(r), _ = (0, w.fU)(r), f = null != u && (0, D.P1)(u), p = null == u || null == (t = u.target_application) ? void 0 : t.id;
  ...
  if (null != h) {
    ...
    let e = {};
    null != u && u.state === ev.r2o.RESOLVED && null != u.inviter && (e.invite_inviter_id = u.inviter.id, null != u.target_application && (e.application_id = u.target_application.id), e = eN(eR(eN({}, e), {
      location: o,
...
let eB = {
  ...
  eV = {
    ...
    sendClydeError(e) {
      ...
      }), n = "HARMFUL_LINK_MESSAGE_BLOCKED") : r in eB ? (n = eB[r].messageName, t = eB[r].messageGetter()) : (t = eS.intl.formatToPlainString(eS.t.CTMXwM, {
        helpUrl: eg.Z.getArticleURL(ev.BhN.DM_COULD_NOT_BE_DELIVERED)
      }), n = "SEND_FAILED (".concat(r, ")")), eV.sendBotMessage(e, t, n))
    },
    sendExplicitMediaClydeError(e, t, n) {
      ...
      eV.sendBotMessage(e, o, l, c), (0, v.aP)({
    ...
    jumpToMessage(e) {
      ...
      return "string" == typeof o && eV.trackJump(n, r, o, s), null == eP || null == (t = eP.pauseAllMediaPlayers) || t.call(eP), eV.fetchMessages({
        channelId: n,
        limit: ev.Z8P,
        jump: {
          messageId: r,
    ...
    fetchMessages(e) {
      let {
        ...
        feature: h
      } = e, m = eo.Z.getChannel(t), g = T.Z.isConnectedOrOverlay(), b = Date.now();
      if (null != m && m.type === ev.d4z.GUILD_STORE) return !1;
      if (t === E.V || (ew.log("Fetching messages for ".concat(t, " between ").concat(r, " and ").concat(n, ". jump=").concat(JSON.stringify(o))), eV._tryFetchMessagesCached({
          channelId: t,
          before: n,
          after: r,
          limit: i,
      ...
      return d || this.fetchLocalMessages(t, n, r, i, I), a.tn.get({
        ...
        ew.log("Fetched ".concat(a.length, " messages for ").concat(t, " isBefore:").concat(l, " isAfter:").concat(c)), I.markComplete(), s.Z.dispatch({
      ...
      }), !0), () => (ew.log("Failed to fetch messages for ".concat(t)), s.Z.dispatch({
    ...
    async fetchNewLocalMessages(e, t) {
      ...
      ew.log("Fetched ".concat(o.messages.length, " messages from the cache after foregrounding. ").concat(u.length, " are new")), 0 !== u.length && s.Z.dispatch({
        type: "LOCAL_MESSAGES_LOADED",
        guildId: r.guild_id,
        channelId: e,
        users: o.users,
    ...
    sendActivityBookmark: (e, t, n, r) => eV._sendMessage(e, {
      content: t,
      tts: !1,
      validNonShortcutEmojis: [],
      invalidEmojis: []
    ...
    sendGreetMessage(e, t) {
      ...
      return a.tn.post({
        ...
        oldFormErrors: !0,
        rejectWithError: !1
      }).then(n => (U.Z.donateSentMessage(n.body.content, e), eV.receiveMessage(e, n.body), s.Z.dispatch({
        type: "STICKER_TRACK_USAGE",
        stickerIds: [t]
      }), n), t => {
        throw ew.log("Failed to send greeting"), 429 !== t.status && eV.sendClydeError(e, t.body.code), s.Z.dispatch({
    ...
    async _sendMessage(e, t, n) {
      var r, i, a, o;
      let l, c = (0, Q.Z)(e);
      if (null != c) return eD.info("Converting channel to a private channel"), c.then(e => {
      ...
      if (null != I && (ei.message.poll = I), null != E && (ei.message.sticker_ids = E), Z.Z.isEnabled() && (ei.message.has_poggermode_enabled = !0), null != T && (ei.message.content_inventory_entry = T), null != b && (ei.message.confetti_potion = (0, z.vY)(b), b.callback()), null != S && S.length > 0 && (ei.message.attachments = S), null != A && A.length > 0) try {
        let t = await (0, x.c)({
          channelId: e,
          nonce: $,
          items: A,
      ...
      return new Promise((t, r) => {
        ...
        eD.info("Queueing message to be sent LogId:".concat(o)), u.ZP.enqueue(ei, o => {
          let c = Date.now() - i;
          if (o.ok) {
            U.Z.donateSentMessage(d, e), eV.receiveMessage(e, o.body, !0, {
              sendAnalytics: {
                duration: c,
                queueSize: a
              },
            ...
            j.Z.recordMessageSendApiResponse($), s.Z.dispatch({
            ...
            if (o.hasErr) "ABORTED" === o.err.code && (i = !0);
              ...
              }) : o.body.code === ev.evJ.EXPLICIT_CONTENT ? t = eT.xi.EXPLICIT_CONTENT : null != I || W || null != T || eV.sendClydeError(e, o.body.code);
            i ? eV.deleteMessage(e, en, !0) : (null != l && s.Z.dispatch({
              type: "UPLOAD_FAIL",
              channelId: e,
              file: l._file,
              messageId: en,
              reason: t,
              noSendFailed: !0
            }), o.hasErr || t !== eT.xi.EXPLICIT_CONTENT || eV.sendExplicitMediaClydeError(e, null == (p = o.body) ? void 0 : p.attachments, v.UU.EXPLICIT_MEDIA_MESSAGE_SEND_BLOCKED), s.Z.dispatch({
              type: "MESSAGE_SEND_FAILED",
              messageId: en,
              channelId: e,
              ...
              ew.log("Cancelling pending message", e.nonce), s.Z.dispatch({
                type: "MESSAGE_SEND_FAILED",
                messageId: e.nonce,
    ...
    async editMessage(e, t, n) {
      ...
      u.ZP.enqueue({
        ...
        n.hasErr ? o.uv.announce(eS.intl.string(eS.t.Atp7FB)) : r ? o.uv.announce(eS.intl.string(eS.t.Hym4i4)) : o.uv.announce(eS.intl.string(eS.t["0x1HBA"])), eV.endEditMessage(e, n.hasErr ? void 0 : n), eV.focusMessage({
          channelId: e,
          messageId: t
        })
      })
