...
let ej = {
  ...
  eU = {
    ...
    fetchMessages(e) {
      ...
      if (t === g.V || (eR.log("Fetching messages for ".concat(t, " between ").concat(n, " and ").concat(r, ". jump=").concat(JSON.stringify(o))), eU._tryFetchMessagesCached({
          channelId: t,
          before: n,
          after: r,
          limit: i,
    ...
    async sendMessage(e, t) {
      ...
      return (k.Z.recordMessageSendAttempt(e, o), es.Z.isReady(e)) ? l() : r && e !== g.V ? (eP.info("Waiting for channel ".concat(e, " to be ready before sending.")), new Promise((t, n) => {
        es.Z.whenReady(e, () => {
        ...
        eP.info("Queueing message to be sent LogId:".concat(l)), c.ZP.enqueue(en, l => {
          ...
          if (l.ok) {
            ...
            if (l.hasErr) "ABORTED" === l.err.code && (i = !0);
              ...
              }) : l.body.code === eO.evJ.EXPLICIT_CONTENT ? t = eI.xi.EXPLICIT_CONTENT : null != v || M || null != I || eU.sendClydeError(e, l.body.code);
