  ...
  eL = {
    ...
    fetchMessages(e) {
      ...
      return d || this.fetchLocalMessages(t, n, r, o, O), i.tn.get({
        ...
        eS.log("Fetched ".concat(i.length, " messages for ").concat(t, " isBefore:").concat(s, " isAfter:").concat(c)), O.markComplete(), a.Z.dispatch({
    ...
    validateMessage(e, t, n) {
      let r, i;
      return e.some(e => e.animated) && !ep.ZP.canUseAnimatedEmojis(t) ? (r = eb.NW.string(eb.t.msFJy8), i = "INVALID_ANIMATED_EMOJI_BODY") : eo.Z.canWithPartialContext(eg.Plq.USE_EXTERNAL_EMOJIS, {
        channelId: n
      ...
      return null != y && (j.message.poll = y), null != m && (j.message.sticker_ids = m), G.Z.isEnabled() && (j.message.has_poggermode_enabled = !0), null != v && (j.message.content_inventory_entry = v), null != g && (j.message.confetti_potion = (0, H.vY)(g), g.callback()), new Promise((t, r) => {
        ...
        eT.info("Queueing message to be sent LogId:".concat(s)), l.ZP.enqueue(j, s => {
          ...
          if (s.ok) {
            ...
            t ? eL.deleteMessage(e, w, !0) : (a.Z.dispatch({
              type: "MESSAGE_SEND_FAILED",
              messageId: w,
              channelId: e,
    ...
    async editMessage(e, t, n) {
      ...
      l.ZP.enqueue({
        ...
        n.hasErr ? o.uv.announce(eb.NW.string(eb.t.Atp7FB)) : r ? o.uv.announce(eb.NW.string(eb.t.Hym4i4)) : o.uv.announce(eb.NW.string(eb.t["0x1HBA"])), eL.endEditMessage(e, n.hasErr ? void 0 : n), eL.focusMessage({
          channelId: e,
          messageId: t
        })
      })
