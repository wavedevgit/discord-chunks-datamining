...
function eC(e) {
  ...
  (0, g.ZP)(t).forEach(e => {
    ...
    else if (t === m.g.QUESTS_EMBED)(0, z.dA)({
      questId: l,
      event: eg.rMx.QUEST_LINK_SHARED,
      trackGuildAndChannelMetadata: !0
    });
    else if (t === m.g.APP_OAUTH2_LINK) c.ZP.trackWithMetadata(eg.rMx.APP_OAUTH2_LINK_EMBED_URL_SENT, {
      application_id: l
...
function eP(e) {
  ...
  } = e, u = et.default.getId(), d = er.Z.getInvite(r), f = (0, N.fU)(r), _ = null != d && (0, C.P1)(d), h = null == d || null == (t = d.target_application) ? void 0 : t.id;
  ...
  if (null != m) {
    ...
    null != s && (t.is_suggested = s.isAffinitySuggestion, t.row_num = s.rowNum, t.num_total = s.numTotal, t.num_affinity_connections = s.numAffinityConnections, t.is_filtered = s.isFiltered), t = eO(eI(eO({}, t), {
      location: a,
      invite_type: e,
    ...
    }), l), c.ZP.trackWithMetadata(eg.rMx.INVITE_SENT, t)
  } else {
    let e = {};
    null != d && d.state === eg.r2o.RESOLVED && null != d.inviter && (e.invite_inviter_id = d.inviter.id, null != d.target_application && (e.application_id = d.target_application.id), e = eO(eI(eO({}, e), {
      location: a,
      ...
      send_type: eg.a5g.DIRECT_MESSAGE,
      invite_guild_scheduled_event_id: f.guildScheduledEventId
    }), l), c.ZP.trackWithMetadata(eg.rMx.INVITE_SENT, e))
  }
}
...
let eD = {
    ...
    [eg.evJ.INVALID_MESSAGE_SEND_USER]: {
      ...
      messageGetter: () => eb.intl.formatToPlainString(eb.t.CTMXwM, {
        helpUrl: e_.Z.getArticleURL(eg.BhN.DM_COULD_NOT_BE_DELIVERED)
      })
    },
  ...
  eL = {
    ...
    sendBotMessage(e, t, n, r) {
      null != n && c.ZP.trackWithMetadata(eg.rMx.AUTOMATED_MESSAGE_RECEIVED, {
        message_author: "Clyde",
        message_name: n
      }), eL.receiveMessage(e, (0, x.cs)({
        messageId: r,
        channelId: e,
        content: t,
        loggingName: n
    ...
    sendClydeError(e) {
      let t, n, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
        i = en.Z.getChannel(e);
      null != i && (r === eg.evJ.SLOWMODE_RATE_LIMITED ? (t = eb.intl.formatToPlainString(eb.t.IWntYm, {
        seconds: i.rateLimitPerUser
      }), n = "SLOWMODE_RATE_LIMITED") : r === eg.evJ.INVALID_MESSAGE_SEND_USER ? (t = eb.intl.formatToPlainString(eb.t.CTMXwM, {
        helpUrl: e_.Z.getArticleURL(eg.BhN.DM_COULD_NOT_BE_DELIVERED)
      }), n = "INVALID_MESSAGE_SEND_USER") : r === eg.evJ.TOO_MANY_THREADS ? (t = i.isForumLikeChannel() || i.isForumPost() ? eb.intl.string(eb.t["/jUd29"]) : eb.intl.string(eb.t["5EMPAw"]), n = "TOO_MANY_THREADS") : r === eg.evJ.TOO_MANY_ANNOUNCEMENT_THREADS ? (t = eb.intl.string(eb.t["aY+lLC"]), n = "TOO_MANY_ANNOUNCEMENT_THREADS") : r === eg.evJ.HARMFUL_LINK_MESSAGE_BLOCKED ? (t = eb.intl.formatToPlainString(eb.t.zSG3Q0, {
        helpUrl: eg.EYA.HARMFUL_LINKS
      }), n = "HARMFUL_LINK_MESSAGE_BLOCKED") : r in eD ? (n = eD[r].messageName, t = eD[r].messageGetter()) : (t = eb.intl.formatToPlainString(eb.t.CTMXwM, {
        helpUrl: e_.Z.getArticleURL(eg.BhN.DM_COULD_NOT_BE_DELIVERED)
      }), n = "SEND_FAILED (".concat(r, ")")), eL.sendBotMessage(e, t, n))
    },
    sendExplicitMediaClydeError(e, t, n) {
      ...
      eL.sendBotMessage(e, o, s, l), (0, b.aP)({
    ...
    jumpToPresent(e, t) {
      ...
      ei.Z.hasPresent(e) ? a.Z.dispatch({
    ...
    trackJump(e, t, n, r) {
      c.ZP.trackWithMetadata(eg.rMx.JUMP, eO({
        context: n,
        channel_id: e,
        message_id: t
      }, r))
    ...
    jumpToMessage(e) {
      ...
      return "string" == typeof o && eL.trackJump(t, n, o, a), eL.fetchMessages({
        channelId: t,
        limit: eg.Z8P,
        jump: {
          messageId: n,
    ...
    fetchMessages(e) {
      let {
        ...
        truncate: f,
        forICYMI: _
      } = e, p = en.Z.getChannel(t), m = y.Z.isConnectedOrOverlay(), g = Date.now();
      if (null != p && p.type === eg.d4z.GUILD_STORE) return !1;
      if (t === h.V || (eS.log("Fetching messages for ".concat(t, " between ").concat(n, " and ").concat(r, ". jump=").concat(JSON.stringify(l))), eL._tryFetchMessagesCached({
          channelId: t,
          before: n,
          after: r,
          limit: o,
      ...
      return d || this.fetchLocalMessages(t, n, r, o, v), i.tn.get({
        ...
        oldFormErrors: !0,
        rejectWithError: !1
      }).then(e => ($.Z.fetchMessages.recordEnd(), $.Z.dispatchMessages.measure(() => {
        let i = e.body,
          s = null != n,
          c = null != r,
          u = null == n && null == r,
        ...
        if (null != O) {
          let e = Math.floor(o / 2),
            ...
            r = [O, ...i.map(e => {
              ...
              return t
            })].filter((e, t, n) => n.indexOf(e) === t).sort(eh.default.compare).indexOf(O);
          if (r < n - 1 && (d = !1), i.length - r < e && (p = !1), p && i.length > 0) {
            let e = es.ZP.lastMessageId(t);
            i[0].id === e && (p = !1)
          }
        }
        eS.log("Fetched ".concat(i.length, " messages for ").concat(t, " isBefore:").concat(s, " isAfter:").concat(c)), v.markComplete(), a.Z.dispatch({
      ...
      }), !0), () => (eS.log("Failed to fetch messages for ".concat(t)), a.Z.dispatch({
    ...
    async fetchNewLocalMessages(e, t) {
      ...
      eS.log("Fetched ".concat(l.messages.length, " messages from the cache after foregrounding. ").concat(_.length, " are new")), 0 !== _.length && a.Z.dispatch({
        type: "LOCAL_MESSAGES_LOADED",
        guildId: r.guild_id,
        channelId: e,
        users: l.users,
    ...
    _tryFetchMessagesCached(e) {
      ...
      if ((null == o ? void 0 : o.messageId) != null || (null == s ? void 0 : s.messageId) != null) {
        ...
        let e = (null == o ? void 0 : o.messageId) != null ? eh.default.extractTimestamp(null == o ? void 0 : o.messageId) : 0,
          n = c.first(),
          r = c.last();
        if (!c.hasMoreBefore && null != n && eh.default.extractTimestamp(n.id) >= e || !c.hasMoreAfter && null != r && eh.default.extractTimestamp(r.id) <= e || null != n && null != r && eh.default.extractTimestamp(n.id) < e && eh.default.extractTimestamp(r.id) > e) return a.Z.dispatch({
          type: "LOAD_MESSAGES_SUCCESS_CACHED",
          channelId: t,
          jump: o,
          limit: eg.Z8P
    ...
    async sendMessage(e, t) {
      ...
      return (i = eI(eO({}, i), {
        nonce: l
      }), D.Z.recordMessageSendAttempt(e, l), ei.Z.isReady(e)) ? s() : r && e !== h.V ? (eT.info("Waiting for channel ".concat(e, " to be ready before sending.")), new Promise((t, n) => {
        ei.Z.whenReady(e, () => {
    ...
    sendActivityBookmark: (e, t, n, r) => eL._sendMessage(e, {
      content: t,
      tts: !1,
      validNonShortcutEmojis: [],
      invalidEmojis: []
    ...
    sendGreetMessage(e, t) {
      ...
      return i.tn.post({
        ...
        oldFormErrors: !0,
        rejectWithError: !1
      }).then(n => (L.Z.donateSentMessage(n.body.content, e), eL.receiveMessage(e, n.body), a.Z.dispatch({
        type: "STICKER_TRACK_USAGE",
        stickerIds: [t]
      }), n), t => {
        throw eS.log("Failed to send greeting"), 429 !== t.status && eL.sendClydeError(e, t.body.code), a.Z.dispatch({
    ...
    validateMessage(e, t, n) {
      let r, i;
      return e.some(e => e.animated) && !ep.ZP.canUseAnimatedEmojis(t) ? (r = eb.intl.string(eb.t.msFJy8), i = "INVALID_ANIMATED_EMOJI_BODY") : eo.Z.canWithPartialContext(eg.Plq.USE_EXTERNAL_EMOJIS, {
        channelId: n
      }) ? (r = eb.intl.string(eb.t.FzugNj), i = "INVALID_EXTERNAL_EMOJI_BODY_UPGRADE") : (r = eb.intl.string(eb.t.Q87rIy), i = "INVALID_EXTERNAL_EMOJI_BODY"), {
        errorMessage: r,
        errorMessageName: i
      }
    },
    _sendMessage(e, t, n) {
      ...
      if (null != _) {
        let e, t = null == _ ? void 0 : _.activity.session_id;
      ...
      return null != y && (V.message.poll = y), null != m && (V.message.sticker_ids = m), G.Z.isEnabled() && (V.message.has_poggermode_enabled = !0), null != O && (V.message.content_inventory_entry = O), null != g && (V.message.confetti_potion = (0, H.vY)(g), g.callback()), null != v && v.length > 0 && (V.message.attachments = v), new Promise((t, r) => {
        let i = Date.now(),
          o = l.ZP.length,
          s = Math.floor(1e4 * Math.random());
        eT.info("Queueing message to be sent LogId:".concat(s)), l.ZP.enqueue(V, s => {
          let u = Date.now() - i;
          if (s.ok) {
            ...
            D.Z.recordMessageSendApiResponse(w), a.Z.dispatch({
            ...
            if (s.hasErr) "ABORTED" === s.err.code && (t = !0);
              ...
              }) : s.body.code === eg.evJ.POGGERMODE_TEMPORARILY_DISABLED ? a.Z.dispatch({
                type: "POGGERMODE_TEMPORARILY_DISABLED"
              }) : null != y || P || null != O || eL.sendClydeError(e, s.body.code);
            t ? eL.deleteMessage(e, j, !0) : (a.Z.dispatch({
              type: "MESSAGE_SEND_FAILED",
              messageId: j,
              channelId: e,
              ...
              eS.log("Cancelling pending message", e.nonce), a.Z.dispatch({
                type: "MESSAGE_SEND_FAILED",
                messageId: e.nonce,
    ...
    async editMessage(e, t, n) {
      ...
      l.ZP.enqueue({
        ...
        n.hasErr ? o.uv.announce(eb.intl.string(eb.t.Atp7FB)) : r ? o.uv.announce(eb.intl.string(eb.t.Hym4i4)) : o.uv.announce(eb.intl.string(eb.t["0x1HBA"])), eL.endEditMessage(e, n.hasErr ? void 0 : n), eL.focusMessage({
          channelId: e,
          messageId: t
        })
      })
    ...
    async suppressEmbeds(e, t) {
      await J.Z.unarchiveThreadIfNecessary(e), i.tn.patch({
        url: eg.ANM.MESSAGE(e, t),
        body: {
          flags: eg.iLy.SUPPRESS_EMBEDS
        },
        oldFormErrors: !0,
        rejectWithError: !1
      })
    ...
    async deleteMessage(e, t) {
      ...
      n ? r() : (await J.Z.unarchiveThreadIfNecessary(e), i.tn.del({
        url: eg.ANM.MESSAGE(e, t),
        oldFormErrors: !0,
        rejectWithError: !1
      }).then(() => {
    ...
    dismissAutomatedMessage(e) {
      null != e.loggingName && c.ZP.trackWithMetadata(eg.rMx.AUTOMATED_MESSAGE_DISMISSED, {
    ...
    crosspostMessage: (e, t) => i.tn.post({
      ...
      let t;
      t = 429 === e.status ? eb.intl.formatToPlainString(eb.t["77cuq6"], {
        retryAfter: Math.floor(e.body.retry_after / 60)
      }) : eb.intl.string(eb.t.z2gyND), em.Z.show({
