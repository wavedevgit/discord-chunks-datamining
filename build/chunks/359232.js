...
let s = (e, t) => {
    ...
    if (t.type === o.re.STRING_SELECT) {
      ...
      else if (t.values.length > r) return a.intl.formatToPlainString(a.t.LDvfRE, {
        count: r
      })
    } else if (t.selectedOptions.length < n) return a.intl.formatToPlainString(a.t.Jmwzd3, {
      count: n
    });
    else if (t.selectedOptions.length > r) return a.intl.formatToPlainString(a.t.LDvfRE, {
      count: r
    });
    return null
  },
  l = (e, t) => {
    ...
    return null == t || 0 === t.value.length ? i ? a.intl.formatToPlainString(a.t.ONSqYW, {
      min: n,
      max: r
    }) : null : t.value.length < n || t.value.length > r ? a.intl.formatToPlainString(a.t.ONSqYW, {
      min: n,
      max: r
    }) : null
  };
