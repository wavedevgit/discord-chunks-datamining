...
let g = {
  ...
  stories: [{
    ...
    component: function(e) {
      ...
      return <a.Kqy gap={16} align={"center"}>{<a.Text variant={"text-md/normal"}>{"Click the button below to open the modal"}</a.Text>}{<a.zxk variant={"primary"} text={"Open Modal"} onClick={() => (0, a.h7j)(e => (0, r.jsx)(l.Modal, p(f({}, i, e), {
    ...
    component: function(e) {
      ...
      return <a.Kqy gap={16} align={"center"}>{<a.Text variant={"text-md/normal"}>{"Click the button below to open the expressive modal"}</a.Text>}{<a.zxk variant={"primary"} text={"Open ExpressiveModal"} onClick={() => (0, a.h7j)(e => (0, r.jsx)(s.I, p(f({}, l, e), {
            graphic: d,
            actions: [{
              variant: "secondary",
              text: "Cancel",
