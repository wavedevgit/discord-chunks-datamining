...
function E(e) {
  ...
  let F = l.useCallback(e => {
    ...
    K = l.useCallback(e => {
      ...
      return <div className={P.clipsRow}>{n.map(e => {
          let t = 0 === e.length;
          return (0, r.jsx)(x.Z, {
    ...
    U = L || 0 !== B.length ? L ? <div className={P.spinnerContainer}><p.$jN /></div> : <p.aVo className={P.clipGrid} sections={[B.length]} sectionHeight={0} rowHeight={328.25} renderRow={K} /> : <v.Z isEmptyBecauseQuery={V.length > 0} closePopout={a} />;
  return <p.Y0X size={p.CgR.DYNAMIC} transitionState={o} className={P.root} parentComponent={"ClipsGalleryModal"}><f.Gt value={H}>{<O.Z onClose={a} filterQuery={E} setFilterQuery={S} sortOrder={k} setSortOrder={Z} />}{U}</f.Gt></p.Y0X>
}