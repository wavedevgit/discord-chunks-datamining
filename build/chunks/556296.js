  ...
  j = (e, t, n, r) => {
    ...
    (0, h.IK)(e.message, null, {
      tags: {
        ...
        backquoteCode: "".concat(null == (i = (0, y.T_)(null != a ? a : "`")) ? void 0 : i.keyCode),
        nativeBackquoteCode: "".concat(null == (o = (0, y.T_)(null != s ? s : "`")) ? void 0 : o.keyCode)
      },
      extra: C({
        stack: e.stack,
        keyCombo: t,
...
let G = () => {
    ...
    let n = (0, O.UR)("shift"),
      r = (0, y.T_)("`");
    return 0 === t.length ? j(Error("Default overlay keybind combo is empty"), e, t) : null == n ? j(Error("Unable to get shift code"), e, t, {
      shiftCode: n
    }) : null == r && j(Error("Unable to get backtick code"), e, t), M(t, !1)
  },
  B = {},
  Z = {},
  F = 0,
...
function ef(e) {
  let t = !1;
  return l().each(Z, n => {
    n.action === e && !0 === n.managed && (eo(n), t = !0)
  }), t
}
let e_ = [function() {
  let e = m.Z.getShortcuts();
  return l().each(Z, t => {
    t.action === I.kg4.PUSH_TO_TALK && !0 === t.managed && (null == t.context || null == e[t.context]) && eo(t)
