...
function ee(e) {
  X(e.id), k = N({}, k), delete k[e.id], e.action === v.kg4.TOGGLE_MUTE && K(), e.action === v.kg4.TOGGLE_OVERLAY_INPUT_LOCK && Y()
}
...
function ei(e) {
  ...
  U = t, t ? (d.Z.enable(), l().forEach(k, J), K(), Y()) : (d.Z.disable(), l().forEach(k, e => X(e.id)), z(), W())
}
