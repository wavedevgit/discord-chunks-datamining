...
let L = "1001",
  ...
  B = !1,
  F = !1,
  V = [v.kg4.PUSH_TO_TALK, v.kg4.TOGGLE_OVERLAY_INPUT_LOCK, v.kg4.OVERLAY_ACTIVATE_REGION_TEXT_WIDGET];
...
function Y() {
  let e = x();
  null == l().find(M, t => e.action === t.action && t.enabled && t.shortcut.length > 0) && U && !F && (J(e), F = !0)
}
...
function K() {
  ...
  null == l().find(M, e => w.action === e.action && e.enabled && e.shortcut.length > 0) && !__OVERLAY__ && !B && U && e && (J(w), B = !0)
}
...
function Q(e, t, n, r) {
  if (g.isPlatformEmbedded) E.ZP.inputEventRegister(parseInt(e), t, n, r);
    ...
    r.keyup && i.bindGlobal((0, y.BB)(t), () => n(!1), "keyup"), r.keydown && i.bindGlobal((0, y.BB)(t), () => n(!0), "keydown"), k[e] = i
  }
}
...
function J(e) {
  ...
  let i = e.id,
    o = G[n].keyEvents;
  e.action === v.kg4.TOGGLE_MUTE && z(), e.action === v.kg4.TOGGLE_OVERLAY_INPUT_LOCK && W(), Q(i, t, e => H(i, e), N({
    focused: !0,
    blurred: !0,
    keydown: !1,
    keyup: !1
...
function ee(e) {
  X(e.id), M = N({}, M), delete M[e.id], e.action === v.kg4.TOGGLE_MUTE && K(), e.action === v.kg4.TOGGLE_OVERLAY_INPUT_LOCK && Y()
}
...
function ei(e) {
  ...
  U = t, t ? (d.Z.enable(), l().forEach(M, J), K(), Y()) : (d.Z.disable(), l().forEach(M, e => X(e.id)), z(), W())
}
...
function eo(e) {
  ...
  G = t, k = {}, j = 0, Object.values(M).filter(e => V.includes(e.action) && e.managed).length !== V.length && ec(), l().forEach(M, e => {
...
function ea(e, t) {
  ...
  return null == l().find(M, t => t.action === e && (!n || t.managed === n)) && (J($({
    action: e,
    enabled: !0,
    shortcut: (0, y.Kd)(t),
    managed: !0,
...
let el = [function() {
  ...
  return l().each(M, t => {
    t.action === v.kg4.PUSH_TO_TALK && !0 === t.managed && (null == t.context || null == e[t.context]) && ee(t)
  }), l().reduce(h.Z.getShortcuts(), (e, t, n) => {
    let r = l().find(M, e => e.action === v.kg4.PUSH_TO_TALK && !0 === e.managed && e.context === n);
    if (null == r) J($({
  ...
  return !!O.default.getAnyGlobalEnabledOverlay() && ea(v.kg4.TOGGLE_OVERLAY_INPUT_LOCK, D())
}, function() {
  return !!O.default.getAnyGlobalEnabledOverlay() && ea(v.kg4.OVERLAY_ACTIVATE_REGION_TEXT_WIDGET, "]`")
}, function() {
  let e = es(v.kg4.SOUNDBOARD_HOLD);
  return ea(v.kg4.SOUNDBOARD_HOLD, S.D_, !1) || e
}, function() {
  return ea(v.kg4.SAVE_CLIP, I.D_)
}];

function ec() {
  return K(), Y(), el.reduce((e, t) => t() || e, !1)
}
...
d.Z.setGetKeybindList(() => {
  let e = [];
  for (let t in M) M.hasOwnProperty(t) && e.push((0, y.BB)(M[t].shortcut));
  let {
    showKeybindIndicators: t
  } = p.Z.getCurrentConfig({
    location: "KeybindsStore"
...
class ed extends(i = c.ZP.DeviceSettingsStore) {
  initialize(e) {
    __OVERLAY__ || this.waitFor(h.Z, O.default), M = null != e ? e : {}
  }
  ...
  getKeybindForAction(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
      ...
      i = l().find(M, r => r.action === e && (!t || r.managed) && (!n || r.shortcut.length > 0 && r.enabled));
...
A(ed, "displayName", "KeybindsStore"), A(ed, "persistKey", "keybinds"), A(ed, "migrations", [function() {
  let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
    {
      v: t,
      keybinds: n = e
