...
n.d(t, {
  ...
  I1: () => j,
  ZP: () => eE
}), n(415506), n(388685), n(539854), n(704826), n(35282);
var i, a = n(348327),
  o = n.n(a),
  s = n(392711),
  l = n.n(s),
...
function U(e) {
  ...
  return j(n) ? n : null == i ? (M(Error("Unable to get backtick code for overlay default keybind"), e, n, {
    rawBacktickShape: r
...
let G = () => {
    let e = L();
    "shift" === e && (M(Error("Default overlay keybind is only shift"), e, null), e = "shift+`");
    let t = U(e);
    if (null == t) return k([], !1);
    if (j(t)) return k(t, !0);
    let n = (0, O.UR)("shift"),
      r = (0, y.T_)("`");
    return 0 === t.length ? M(Error("Default overlay keybind combo is empty"), e, t) : null == n ? M(Error("Unable to get shift code"), e, t, {
      shiftCode: n
    }) : null == r && M(Error("Unable to get backtick code"), e, t), k(t, !1)
  },
  B = {},
  Z = {},
  F = 0,
...
function $() {
  let e = G();
  null == l().find(Z, t => e.action === t.action && t.enabled && t.shortcut.length > 0) && V && !W && (er(e), W = !0)
}
...
function Q() {
  ...
  null == l().find(Z, e => D.action === e.action && e.enabled && e.shortcut.length > 0) && !__OVERLAY__ && !Y && V && e && (er(D), Y = !0)
}
...
function er(e) {
  ...
  let i = e.id,
    a = H[n].keyEvents;
  e.action === I.kg4.TOGGLE_MUTE && J(), e.action === I.kg4.TOGGLE_OVERLAY_INPUT_LOCK && X(), et(i, t, e => q(i, e), C({
    focused: !0,
    blurred: !0,
    keydown: !1,
    keyup: !1
...
function ea(e) {
  en(e.id), Z = C({}, Z), delete Z[e.id], e.action === I.kg4.TOGGLE_MUTE && Q(), e.action === I.kg4.TOGGLE_OVERLAY_INPUT_LOCK && $()
}
...
function ec(e) {
  ...
  V = t, t ? (d.Z.enable(), l().forEach(Z, er), Q(), $()) : (d.Z.disable(), l().forEach(Z, e => en(e.id)), J(), X())
}
...
let e_ = [function() {
  ...
  return l().each(Z, t => {
    ...
    let r = l().find(Z, e => e.action === I.kg4.PUSH_TO_TALK && !0 === e.managed && e.context === n);
    if (null == r) er(ei({
...
d.Z.setGetKeybindList(() => {
  let e = [];
  for (let t in Z) Z.hasOwnProperty(t) && e.push((0, O.BB)(Z[t].shortcut));
  let {
    showKeybindIndicators: t
  } = p.Z.getCurrentConfig({
    location: "KeybindsStore"
...
N(em, "displayName", "KeybindsStore"), N(em, "persistKey", "keybinds"), N(em, "migrations", [function() {
  ...
  return t
}, e => l().reduce(e, (e, t, n) => t.action === I.kg4.TOGGLE_GO_LIVE_STREAMING && t.managed ? e : R(C({}, e), {
  [n]: t
}), {})]);
let eg = new em(u.Z, {
    CONNECTION_OPEN: ep,
