...
function X(e) {
  if (g.isPlatformEmbedded) E.ZP.inputEventUnregister(parseInt(e, 10));
    ...
    if (null != t) {
      let n = k[e],
        r = G[n.action];
      (null == r ? void 0 : r.isPressed) === !0 && T.nextTick(() => r.onTrigger(!1, n)), t.reset(), M[e] = null
    }
  }
}
...
N(ed, "displayName", "KeybindsStore"), N(ed, "persistKey", "keybinds"), N(ed, "migrations", [function() {
  let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
    {
      v: t,
      keybinds: n = e
  ...
  return t
}, e => l().reduce(e, (e, t, n) => t.action === O.kg4.TOGGLE_GO_LIVE_STREAMING && t.managed ? e : R(A({}, e), {
  [n]: t
}), {})]);
let ef = new ed(u.Z, {
    CONNECTION_OPEN: ec,
