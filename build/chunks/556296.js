...
n.d(t, {
  ...
  ZP: () => eg,
  s4: () => M
}), n(415506), n(539854), n(388685), n(704826), n(35282);
var i, a = n(348327),
  o = n.n(a),
  s = n(392711),
  l = n.n(s),
...
let x = "1001",
  ...
  U = () => {
    ...
    let t = (0, O.Kd)(e),
      n = (0, O.UR)("shift");
    if (null == n) return j(Error("Unable to get shift code"), e, t, {
      shiftCode: n
    }), k(t, !1);
    ...
    if (M(t)) {
      ...
      j(Error("Default overlay keybind combo is only shift"), e, t, {
        rawBacktickCode: n
      }), t.push([I.MoX.KEYBOARD_KEY, n, (0, O.dU)()])
    }
    return k(t)
  },
  G = {},
...
function en(e) {
  ...
  let i = e.id,
    a = Z[n].keyEvents;
  e.action === I.kg4.TOGGLE_MUTE && J(), e.action === I.kg4.TOGGLE_OVERLAY_INPUT_LOCK && X(), ee(i, t, e => z(i, e), C({
    focused: !0,
    blurred: !0,
    keydown: !1,
    keyup: !1
...
function ec(e) {
  ...
  Z = t, G = {}, V = 0, Object.values(B).filter(e => W.includes(e.action) && e.managed).length !== W.length && e_(), l().forEach(B, e => {
...
function eu(e, t) {
  ...
  return null == l().find(B, t => t.action === e && (!n || t.managed === n)) && (en(er({
    action: e,
    enabled: !0,
    shortcut: (0, O.Kd)(t),
    managed: !0,
...
N(eh, "displayName", "KeybindsStore"), N(eh, "persistKey", "keybinds"), N(eh, "migrations", [function() {
  let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
    {
      v: t,
      keybinds: n = e
