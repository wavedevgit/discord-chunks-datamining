...
function g(e) {
  ...
  return null == I ? null : <o.zxk variant={"active"} size={"sm"} text={I} fullWidth={true} loading={E || a} onClick={S} />
}
...
function E(e) {
  let {
    ...
    t.visibility !== f.k.PUBLIC_WITH_RECRUITMENT && null != l ? p() : s.Z.openMemberVerificationModal(o, true, l)
  }, [p, o, t.visibility, l]);
  return null == c ? null : <g guildId={o} ctaType={c} onGoToGuild={d} onAcceptInvite={p} onStartApplication={h} onComplete={n} />
}