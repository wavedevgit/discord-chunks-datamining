...
function N() {
  ...
  }), [t, n] = r.useState(150), [g, p] = r.useState(150), [x, E] = r.useState(500), [C, T] = r.useState(h.b.DEFAULT), N = () => {
    switch (C) {
      case h.b.DEFAULT:
        T(h.b.HIGHLIGHTED);
        break;
  ...
  return (0, i.jsxs)(O.$0, {
    children: [(0, i.jsx)(l.X6q, {
      ...
      children: [(0, i.jsxs)("div", {
        ...
        onClick: () => {
          (0, a.xf)(), (0, u.s1)().location.pathname.includes(j.Z5c.COLLECTIBLES_SHOP) || (0, d.mK)({
            openInLayer: !1,
            analyticsLocations: I,
