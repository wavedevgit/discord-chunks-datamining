...
function N() {
  ...
  }), [t, n] = r.useState(150), [p, h] = r.useState(150), [E, j] = r.useState(500), [C, I] = r.useState(f.b.DEFAULT), N = () => {
    switch (C) {
      case f.b.DEFAULT:
        I(f.b.HIGHLIGHTED);
        break;
  ...
  return (0, i.jsxs)(O.$0, {
    children: [(0, i.jsx)(l.X6q, {
      ...
      children: [(0, i.jsx)("div", {
        ...
        onClick: () => {
          (0, a.xf)(), (0, u.s1)().location.pathname.includes(S.Z5c.COLLECTIBLES_SHOP) || (0, d.mK)({
            openInLayer: !1,
            analyticsLocations: y,
