...
function I() {
  ...
  return (0, r.jsxs)("div", {
    children: [e && (0, r.jsx)(y, {}), (0, r.jsx)(A, {}), (0, r.jsx)(P, {})]
  })
}
...
function A() {
  ...
  }), [t, n] = i.useState(150), [p, h] = i.useState(150), [_, E] = i.useState(500), [j, T] = i.useState(f.b.DEFAULT), I = () => {
    switch (j) {
      case f.b.DEFAULT:
        T(f.b.HIGHLIGHTED);
        break;
