...
let T = e => [e.userId, ... function(e) {
  ...
  L = r.memo(function(e) {
    ...
    let {
      ...
      onMouseLeave: h,
      query: f
    } = e, m = (0, a.e7)([v.Z], () => v.Z.getChannel(n), [n]), g = null == m ? void 0 : m.getGuildId(), y = (0, a.e7)([_.Z], () => _.Z.getGuild(g), [g]), O = (0, u.KS)(m, y), b = (null == o ? void 0 : o.id) === n, E = b ? "text-positive" : r ? "interactive-active" : "text-muted", x = b ? s.TVs.colors.TEXT_POSITIVE : r ? s.TVs.colors.INTERACTIVE_ACTIVE : s.TVs.colors.ICON_MUTED;
