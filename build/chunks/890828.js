...
let k = e => [e.userId, ... function(e) {
  ...
  L = r.memo(function(e) {
    let {
      channel: t,
      query: n
    } = e, [o] = (0, a.e7)([S.Z], () => [S.Z.getVoiceStatesForChannel(t.id), S.Z.getVoiceStateVersion()], [t.id], N.Q), [l, c] = r.useState([]);
    (0, O.BO)(n, Object.values(o), c, D);
    let u = (0, a.Wu)([S.Z, C.default, b.Z, j.Z], () => Object.values(S.Z.getVoiceStatesForChannel(t.id)).map(e => C.default.getUser(e.userId)).filter(Z.lm).sort((e, t) => {
        var i, r, o, a;
  ...
  M = r.memo(function(e) {
    ...
    let {
      ...
      onMouseLeave: h,
      query: f
    } = e, m = (0, a.e7)([_.Z], () => _.Z.getChannel(n), [n]), g = null == m ? void 0 : m.getGuildId(), y = (0, a.e7)([x.Z], () => x.Z.getGuild(g), [g]), O = (0, u.KS)(m, y), v = (null == o ? void 0 : o.id) === n, b = v ? "text-positive" : r ? "interactive-active" : "text-muted", E = v ? s.TVs.colors.TEXT_POSITIVE : r ? s.TVs.colors.INTERACTIVE_ACTIVE : s.TVs.colors.ICON_MUTED;
...
function U(e) {
  let {
    ...
    let e = function() {
        let e = (0, a.Wu)([C.default, j.Z, v.Z], () => j.Z.getFriendIDs().sort((e, t) => {
          var n, i, r, o;
