...
function j(e) {
  let {
    ...
    location: "UserProfileAccountPopout"
  }).allowQuietMode || r, g = d.fv.useSetting(), m = e === p.Skl.DND, _ = i => {
    let r = C(n);
      ...
      children: [(0, i.jsx)(l.Clw, {}, "menu-separator-statuses"), (0, i.jsx)(l.sNh, {
        ...
        label: () => (0, i.jsxs)("div", {
          ...
          children: [(0, i.jsx)(l.owu, {
            ...
            className: f.description,
            children: r && null != g && "0" !== g ? h.intl.formatToPlainString(h.t.BWD8fn, {
