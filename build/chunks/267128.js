...
function k(e, t, n) {
  ...
  if (o.message.type === R.uaV.USER_JOIN || o.message.type === R.uaV.ROLE_SUBSCRIPTION_PURCHASE || o.message.type === R.uaV.GUILD_DEADCHAT_REVIVE_PROMPT || o.message.type === R.uaV.GUILD_GAMING_STATS_PROMPT) return (0, r.jsx)(x, {
...
function j(e, t) {
  ...
  } = e, u = (null == o ? void 0 : o.state) === E.Y.LOADED ? o.message : void 0;
...
function U(e, t, n) {
  let {
    ...
    onClickReply: u
  } = e, d = o.state !== E.Y.DELETED ? u : void 0;
  switch (o.state) {
    case E.Y.LOADED: {
      let {
...
function G(e, t, n, i, o, s) {
  ...
  if ((0, p.Z)(e) && (f = (0, r.jsx)(m.Z, {
    ...
    } else L ? l = (0, g.N4)(E) : T ? l = P.intl.string(P.t.kHdYCQ) : A ? l = P.intl.string(P.t["E+6SSU"]) : N ? l = P.intl.string(P.t["XC3A5+"]) : E.hasFlag(R.iLy.IS_COMPONENTS_V2) ? l = P.intl.string(P.t.Xxat6e) : (l = P.intl.string(P.t["6hGo0d"]), d = (0, r.jsx)(c.XBm, {
      size: "custom",
      color: "currentColor",
      className: b,
      width: v,
...
function B(e) {
  ...
  return (0, r.jsxs)("div", {
    id: (0, T.Gq)(s),
    className: a()(w.repliedMessage, A, C ? w.contextCommandMessage : {
