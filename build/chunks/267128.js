...
function R(e, t, s, l, a, i) {
  ...
  if ((0, p.Z)(e) && (m = (0, n.jsx)(h.Z, {
    ...
    } else b ? o = (0, C.N4)(x) : E ? o = _.intl.string(_.t.kHdYCQ) : y ? o = _.intl.string(_.t["E+6SSU"]) : S ? o = _.intl.string(_.t["XC3A5+"]) : x.hasFlag(M.iLy.IS_COMPONENTS_V2) ? o = _.intl.string(_.t.Xxat6e) : (o = _.intl.string(_.t["6hGo0d"]), d = (0, n.jsx)(c.XBm, {
      size: "custom",
      color: "currentColor",
      className: P,
      width: v,
...
function D(e) {
  let t, {
    ...
    w = function(e, t, s) {
      ...
      if (i || l.state !== x.Y.LOADED || o) return s === M.uaV.CONTEXT_MENU_COMMAND ? (0, n.jsx)("div", {
      ...
      if (l.message.type === M.uaV.USER_JOIN || l.message.type === M.uaV.ROLE_SUBSCRIPTION_PURCHASE || l.message.type === M.uaV.GUILD_DEADCHAT_REVIVE_PROMPT || l.message.type === M.uaV.GUILD_GAMING_STATS_PROMPT) return (0, n.jsx)(A, {
        className: I.userJoinSystemMessageIcon
      });
      if (l.message.type === M.uaV.GUILD_APPLICATION_PREMIUM_SUBSCRIPTION) return (0, n.jsx)(c.Prq, {
        size: "md",
        color: "currentColor",
        className: I.ticketIcon
      });
      if (l.message.type === M.uaV.POLL_RESULT) return (0, n.jsx)(c.QDj, {
      ...
      let O = () => {
        ...
        return e = l.message.author, t = a.guild_id, (0, n.jsx)("img", {
          alt: "",
          src: (null == m ? void 0 : m.guildMemberAvatar) != null && null != t ? (0, j.JM)({
            guildId: t,
            userId: e.id,
          ...
          return (0, n.jsxs)(n.Fragment, {
            children: [p, (0, n.jsx)(c.P3F, {
              className: r()(I.repliedTextPreview, I.clickable, {
                [I.repliedMessageClickableSpineHovered]: t
              }),
              onClick: d,
              onMouseEnter: s,
              onMouseLeave: s,
  ...
  null != s && null != a && (t = _.intl.formatToPlainString(_.t.RhbQ2N, {
  ...
  return (0, n.jsxs)("div", {
    id: (0, E.Gq)(i),
    className: r()(I.repliedMessage, Z, G ? I.contextCommandMessage : {
      [I.messageSpine]: !O || !h && C
    }),
    "aria-label": t,
    children: [O && h && C && (0, n.jsx)(c.P3F, {
      tag: "div",
      "aria-label": _.intl.string(_.t.dpjpOj),
      className: r()(I.repliedMessageClickableSpine, {
        [I.repliedMessageContentHovered]: f
      }),
