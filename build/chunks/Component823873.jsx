...
function b(e) {
  ...
  let {
    eventId: b
  } = e, E = (0, l.e7)([o.ZP], () => o.ZP.getGuildScheduledEvent(b), [b]), O = (0, l.e7)([m.Z], () => m.Z.getGuild(null == E ? true : E.guild_id), [E]), I = (0, l.e7)([h.Z], () => h.Z.getChannel(null == E ? true : E.channel_id), [E]), y = (0, u.zI)(b, null), v = null != E && (0, o.xt)(E), C = null != E ? (0, f.DK)(E) : null, S = (0, d.Z)(null == E ? true : E.guild_id, null == E ? true : E.id, C), T = null == y ? true : y.startTime.toISOString(), {
