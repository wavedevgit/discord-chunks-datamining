...
function x(e) {
  ...
  return n === h.T ? null : <d.U setting={g.s6.PRIVACY_SERVER_SPECIFIC_PRIVACY_ACTIVITY_JOINING_V2}><u.Z title={b.intl.string(b.t["T+nevL"])} value={!c} onChange={p} note={b.intl.format(b.t.jXKQCg, {
