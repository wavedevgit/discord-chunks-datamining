...
class m extends Chunk727916.Z {
  ...
  innerExtract(e, t) {
    ...
    if (a = 0, m = 0, g = false, E[p]) {
      let e = parseInt(E[p]);
      if (isNaN(e) && (e = (0, i.zU)(E[p])), e >= 60) return null;
      n.end.assign("second", e)
    }
    if (isNaN(a = parseInt(E[f])) && (a = (0, i.zU)(E[f])), E[_] ? "半" == E[_] ? m = 30 : "正" == E[_] || "整" == E[_] ? m = 0 : isNaN(m = parseInt(E[_])) && (m = (0, i.zU)(E[_])) : a > 100 && (m = a % 100, a = Math.floor(a / 100)), m >= 60 || a > 24) return null;
    if (a >= 12 && (g = 1), E[h]) {
      if (a > 12) return null;
