...
class m extends Chunk727916.Z {
  ...
  innerExtract(e, t) {
    ...
    if (isNaN(a = parseInt(t[f])) && (a = (0, i.zU)(t[f])), t[p] ? "半" == t[p] ? m = 30 : "正" == t[p] || "整" == t[p] ? m = 0 : isNaN(m = parseInt(t[p])) && (m = (0, i.zU)(t[p])) : a > 100 && (m = a % 100, a = Math.floor(a / 100)), m >= 60 || a > 24) return null;
    if (a >= 12 && (g = 1), t[h]) {
      if (a > 12) return null;
    ...
    if (a = 0, m = 0, g = false, E[_]) {
      let e = parseInt(E[_]);
      if (isNaN(e) && (e = (0, i.zU)(E[_])), e >= 60) return null;
      n.end.assign("second", e)
    }
    if (isNaN(a = parseInt(E[f])) && (a = (0, i.zU)(E[f])), E[p] ? "半" == E[p] ? m = 30 : "正" == E[p] || "整" == E[p] ? m = 0 : isNaN(m = parseInt(E[p])) && (m = (0, i.zU)(E[p])) : a > 100 && (m = a % 100, a = Math.floor(a / 100)), m >= 60 || a > 24) return null;
    if (a >= 12 && (g = 1), E[h]) {
      if (a > 12) return null;
