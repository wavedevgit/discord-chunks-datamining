...
class D extends Chunk73800.Component {
  render() {
    ...
    !Chunk995774 && Chunk659215 && (g = <Chunk466794.X tooltipText={Chunk388032.intl.string(Chunk388032.t.Kfcszs)} />);
    let T = Chunk120356 ? Chunk588429 : Chunk92254,
      C = {
        size: "sm",
        color: "currentColor",
        className: Chunk474936.icon
      };
    return exports.type === Chunk981631.uaV.EMOJI_ADDED && 0 === exports.reactions.length ? <Chunk387188.e message={exports} className={a()(Chunk474936.reactionBtn, require)} /> : <Chunk481060.yRy targetElementRef={this.ref} shouldShow={l} onRequestClose={this.handleReactionPickerToggle} renderPopout={this.renderReactionPopout} position={"right"}>{(e, t) => {
        let {
          isShown: o
        } = t;
  ...
  constructor(...e) {
    super(...e), C(this, "state", {
      ...
      let {
      ...
      }), s = <g.$ closePopout={t} channel={i} onSelectEmoji={e => {
          let {
            emoji: n,
            willClose: r,
            isBurst: i
        ...
        }} analyticsOverride={a} messageId={o.id} />;
      return <c.M.Consumer>{e => {
          let {
            inDialog: t
          } = e;
