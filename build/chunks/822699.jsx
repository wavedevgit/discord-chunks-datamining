...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk881317 = require("./881317.js"),
  Chunk886806 = require("./886806.js"),
...
let el = (0, Chunk320830.Z)(Chunk781428.Z),
  eo = (0, Chunk320830.Z)(Chunk209411.Z),
  es = (0, Chunk320830.Z)(Chunk344295.Z),
  ea = (0, Chunk320830.Z)(Chunk236446.Z),
  ...
  ef = (0, Chunk320830.Z)(Chunk886806.Z),
...
class eS extends Chunk73800.PureComponent {
  static getDerivedStateFromProps(e, t) {
    ...
    let {
      ...
      backgroundId: o
    } = t, s = null != (n = (0, l.parse)(i.search).redirect_to) ? n : null;
    (null == s || "" === s || !(0, w.B)(s) || s.startsWith($.Z5c.ME)) && (s = null);
    let a = null;
    if (null == r) a = (0, Z.gK)(s);
    else if ((null == r ? true : r.state) === $.r2o.RESOLVED) {
      let {
        guild: e,
        target_application: t
      } = r;
      null != t ? null != o && (a = (0, T.xF)(t.id, o, 1024)) : null != e && "string" == typeof e.splash && (a = P.ZP.getGuildSplashURL({
        id: e.id,
        splash: e.splash
      }))
    }
  ...
  render() {
    ...
    return <Chunk721751.Z splash={module}>{<Chunk765717.Z path={Chunk981631.Z5c.LOGIN_HANDOFF} render={e => (0, r.jsx)(eo, ei(er({}, e), {
          redirectTo: t
        }))} />}{<Chunk765717.Z impressionName={Chunk990547.ImpressionNames.USER_LOGIN} path={Chunk981631.Z5c.LOGIN} render={e => (0, r.jsx)(el, ei(er({}, e), {
          redirectTo: t
        }))} />}{<Chunk765717.Z impressionName={Chunk990547.ImpressionNames.USER_REGISTRATION} path={Chunk981631.Z5c.REGISTER} render={e => ee.a ? (0, r.jsx)(es, ei(er({}, e), {
          redirectTo: t,
          inviteKey: n
        })) : (0, r.jsx)(ed, ei(er({}, e), {
          redirectTo: t
        }))} />}{<Chunk765717.Z path={Chunk981631.Z5c.GIFT_CODE_LOGIN(":giftCode")} render={e => (0, r.jsx)(ec, er({
          login: true
        }, e))} />}{<Chunk765717.Z path={Chunk981631.Z5c.GIFT_CODE(":giftCode")} render={e => (0, r.jsx)(ec, er({}, e))} />}{<Chunk765717.Z path={[Chunk981631.Z5c.INVITE_LOGIN(":inviteCode"), Chunk981631.Z5c.INVITE(":inviteCode")]} render={e => {
          let {
            match: {
              params: {
                inviteCode: t
            ...
            location: i,
            transitionTo: l
          } = e, o = (0, I.mb)(t, i.search);
          return s.tq || s.Em ? (0, r.jsx)(eu, {
            inviteKey: o,
            transitionTo: l
          }, o) : (0, r.jsx)(es, {
            inviteKey: o,
        ...
        }} />}{<Chunk765717.Z path={[Chunk981631.Z5c.GUILD_TEMPLATE_LOGIN(":guildTemplateCode"), Chunk981631.Z5c.GUILD_TEMPLATE(":guildTemplateCode")]} render={e => {
          let {
            match: {
              params: {
                guildTemplateCode: t
        ...
        }} />}{<Chunk765717.Z path={Chunk981631.Z5c.VERIFY} render={e => (0, r.jsx)(ef, er({}, e))} />}{<Chunk765717.Z path={Chunk981631.Z5c.VERIFY_HUB_EMAIL} render={e => (0, r.jsx)(eb, er({}, e))} />}{<Chunk765717.Z path={Chunk981631.Z5c.VERIFY_REQUEST} render={e => (0, r.jsx)(em, er({}, e))} />}{<Chunk765717.Z path={Chunk981631.Z5c.DISABLE_EMAIL_NOTIFICATIONS} render={e => (0, r.jsx)(e_, er({}, e))} />}{<Chunk765717.Z path={Chunk981631.Z5c.DISABLE_SERVER_HIGHLIGHT_NOTIFICATIONS} render={e => (0, r.jsx)(ex, er({}, e))} />}{<Chunk765717.Z path={Chunk981631.Z5c.AUTHORIZE_IP} render={e => (0, r.jsx)(eh, er({}, e))} />}{<Chunk765717.Z path={Chunk981631.Z5c.REJECT_IP} render={e => (0, r.jsx)(eg, er({
          source: $.Z5c.REJECT_IP
        }, e))} />}{<Chunk765717.Z path={Chunk981631.Z5c.REJECT_MFA} render={e => (0, r.jsx)(eg, er({
          source: $.Z5c.REJECT_MFA
        }, e))} />}{<Chunk765717.Z path={Chunk981631.Z5c.AUTHORIZE_PAYMENT} render={e => (0, r.jsx)(ep, er({}, e))} />}{<Chunk765717.Z path={Chunk981631.Z5c.RESET} render={e => (0, r.jsx)(eg, er({
          source: $.Z5c.RESET
        }, e))} />}{<Chunk765717.Z path={Chunk981631.Z5c.PICK_GUILD_SETTINGS(":section?", ":subsection?")} render={e => (0, r.jsx)(ev, er({}, e))} />}{<Chunk765717.Z path={Chunk981631.Z5c.CHANNEL(Chunk893607.Hw.guildId(), Chunk893607.Hw.channelId({
          optional: true
        }), ":messageId?")} render={e => (0, r.jsx)(eE, er({}, e))} />}{<Chunk765717.Z path={Chunk981631.Z5c.REPORT} render={e => (0, r.jsx)(ej, er({}, e))} />}{<Chunk765717.Z path={Chunk981631.Z5c.REPORT_SECOND_LOOK} render={e => (0, r.jsx)(eI, er({}, e))} />}{<Chunk765717.Z path={Chunk981631.Z5c.ACCOUNT_REVERT(":token")} render={e => (0, r.jsx)(eO, er({}, e))} />}</Chunk721751.Z>
  }
  constructor(...e) {
...
let eN = Chunk442837.ZP.connectStores([Chunk314897.default, Chunk701190.Z, Chunk82142.Z, Chunk353926.Z, Chunk409059.Z], e => {
  var t, n, r;
  let {
    match: i,
    location: l
