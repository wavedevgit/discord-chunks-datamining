/** Chunk was on web.js **/
/** chunk id: 687972, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  A: () => f,
  g: () => p
...
function f(e) {
  let {
    ...
    getScrollerState: g,
    getAnchorId: E
  } = e, b = (0, a.A)(), y = (0, r.useRef)(d), [O] = (0, r.useState)(() => new i.A), {
    dirty: A,
    chunkStart: v,
    chunkEnd: S,
  ...
  let R = (0, r.useMemo)(() => {
    ...
    w = (0, r.useMemo)(() => A > 0 ? y.current : (O.mergeProps({
      sectionHeight: n,
      rowHeight: o,
      footerHeight: c,
      listHeaderHeight: p,
      ...
      sections: t,
      getAnchorId: E
    }), O.compute(Math.max(0, v * _), S * _)), [A, v, S, n, o, c, p, m, h, t, O, _, E]);
...
function p(e) {
  ...
  (0, r.useLayoutEffect)(() => {
    ...
    let o = t => {
      if (t < 0 || t >= a.sections[n.section] || s(n.section, n.row) !== n.id) returnfalse;
      let [i] = a.computeScrollPosition(n.section, t), o = i - n.scrollOffset;
      return r !== o && (e.scrollTop = o), true
    };
