...
let T = e => {
  ...
  Z = e => {
    ...
    } = (0, g.ZP)(), j = (0, x.Z)(t.id), Z = t.features.has(N.GuildFeatures.MORE_STICKERS) ? N.Eu4.TIER_3 : t.premiumTier, R = t.features.has(N.GuildFeatures.MORE_STICKERS) ? N.oCV[N.Eu4.TIER_3] : j, D = (0, b.Z)(t.id);
    if (i.useEffect(() => {
        ...
        return er ? g = (0, r.jsx)(m.Z, {
          ...
          children: [K && (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)("img", {
              ...
              variant: "text-md/normal",
              color: "text-default",
              children: v.tier === N.Eu4.TIER_1 ? I.intl.formatToPlainString(I.t.psMYux, {
                numAdditional: Y
