...
let T = e => {
  ...
  Z = e => {
    ...
    } = (0, g.ZP)(), j = (0, h.Z)(t.id), Z = t.features.has(E.GuildFeatures.MORE_STICKERS) ? E.Eu4.TIER_3 : t.premiumTier, R = t.features.has(E.GuildFeatures.MORE_STICKERS) ? E.oCV[E.Eu4.TIER_3] : j, D = (0, x.Z)(t.id);
    if (i.useEffect(() => {
        ...
        return er ? g = (0, r.jsx)(f.Z, {
          ...
          children: [K && (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)("img", {
              ...
              variant: "text-md/normal",
              color: "text-default",
              children: O.tier === E.Eu4.TIER_1 ? S.intl.formatToPlainString(S.t.psMYux, {
                numAdditional: Y
