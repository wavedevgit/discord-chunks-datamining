...
function b(e) {
  ...
  return <s.yRy targetElementRef={p} shouldShow={_} align={l} animation={j === d.u3.TITLE_BAR_LEFT ? s.yRy.Animation.TRANSLATE : s.yRy.Animation.FADE} animationPosition={j === d.u3.TITLE_BAR_LEFT ? "bottom" : "left"} position={n} onRequestClose={C} spacing={b} renderPopout={() => (0, r.jsx)(s.VqE, {
...
function O() {
  return <div className={Chunk614147.container}>{<div className={Chunk614147.backgroundContainer}><span className={Chunk614147.background} /></div>}{<Chunk82409.Z />}</div>
}