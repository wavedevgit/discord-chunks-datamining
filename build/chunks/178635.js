...
function A(e, t) {
  ...
  if (n) {
    var a, o, s;
    let n, l = null == (a = c.A2.getSetting()[t.feedbackType]) ? void 0 : a.lastImpressionTime;
    return (null == l || Number.isNaN(l)) && null != t.storageKey && (null == (n = null != (o = i.K.get(t.storageKey)) ? o : void 0) || Number.isNaN(n) || c.A2.updateSetting(e => b(g({}, e), {
