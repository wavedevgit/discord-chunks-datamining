...
function _(e) {
  ...
  } = e, C = t === g.ME ? true : t, S = (0, l.e7)([d.Z], () => d.Z.isBlocked(n.id)), {
    analyticsLocations: w
  } = (0, s.ZP)([...E, S ? c.Z.BLOCKED_PROFILE_MODAL : c.Z.IGNORED_PROFILE_MODAL]), D = (0, f.ZB)({
    layout: "MODAL_V2",
    userId: n.id,
  ...
  }], B = (0, p.ZP)(n.id, C), R = u.ZP.getName(null == B ? true : B.guildId, _, n), U = y.intl.formatToPlainString(y.t.KRe1Fh, {
    name: R
  });
  return (0, r.jsx)(s.Gt, {
    value: w,
