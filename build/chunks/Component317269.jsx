...
function E(t) {
  ...
  if (a()(null != C && null != c, "Missing startingPlan or newPlan"), f.Y1.indexOf(i) < f.Y1.indexOf(n)) switch (n) {
      case f.Xh.PREMIUM_MONTH_TIER_1:
        e = T.intl.string(T.t.knvOV1), N.X7u.has(null != s ? s : N.HeQ.UNKNOWN) && (e = T.intl.format(T.t.o6hBiY, {}));
        break;
      case f.Xh.PREMIUM_MONTH_TIER_2:
        e = T.intl.string(T.t.f8Dqur), N.X7u.has(null != s ? s : N.HeQ.UNKNOWN) && (e = T.intl.format(T.t.A4THYm, {}));
        break;
      case f.Xh.PREMIUM_YEAR_TIER_1:
        e = T.intl.string(T.t.YZd5r6), N.X7u.has(null != s ? s : N.HeQ.UNKNOWN) && (e = T.intl.format(T.t.MHAxpK, {}));
        break;
      case f.Xh.PREMIUM_YEAR_TIER_2:
        e = T.intl.formatToPlainString(T.t["M/Lknp"], {
          numFreeGuildSubscriptions: f.cb
        }), N.X7u.has(null != s ? s : N.HeQ.UNKNOWN) && (e = T.intl.format(T.t.mULxLS, {
          numFreeGuildSubscriptions: f.cb
        }));
        break;
...
function _(t) {
  ...
  let O = t => t.skuId === f.Si.TIER_0 ? N.X7u.has(null != b ? b : N.HeQ.UNKNOWN) ? T.intl.format(T.t.o6hBiY, {}) : T.intl.string(T.t["AGf/yc"]) : t.skuId === f.Si.TIER_1 ? N.X7u.has(null != b ? b : N.HeQ.UNKNOWN) ? T.intl.format(T.t.o6hBiY, {}) : T.intl.string(T.t.knvOV1) : N.X7u.has(null != b ? b : N.HeQ.UNKNOWN) ? T.intl.format(T.t.A4THYm, {}) : d ? T.intl.string(T.t["g52y/v"]) : T.intl.string(T.t.aTUr3d);
  if (null != S) e = (0, l.jsx)("div", {
    className: I.text,
    ...
    let t = H.Z.get(s);
    a()(null != t, "Missing plan"), t.skuId === f.Si.TIER_0 ? e = (0, l.jsxs)("div", {
      className: I.text,
      children: [(0, l.jsx)("p", {
    ...
    }) : (t.skuId === f.Si.TIER_1 || t.skuId === f.Si.TIER_2) && (e = (0, l.jsxs)("div", {
      className: I.text,
      children: [(0, l.jsx)("p", {
  ...
  } else if (null != o) e = (0, l.jsx)(E, {
    planId: s,
    startingPremiumSubscriptionPlanId: o
  });
  else if (null != R) {
    let t = H.Z.get(s);
    a()(null != t, "Missing plan"), e = (0, l.jsxs)(l.Fragment, {
    ...
    let t = H.Z.get(s);
    a()(null != t, "Missing plan"), e = (0, l.jsx)("div", {
      className: I.text,
      children: O(t)
    })
  }
  ...
  let [Y, D] = i.useState(false), B = i.useCallback(() => {
    null != L && (L(), "apple_payment_link" === U && D(true))
  }, [L, U]);
  n = "apple_payment_link" === U ? T.intl.string(T.t.qXV2XV) : null != S ? T.intl.formatToPlainString(T.t["1qGgm5"], {
    skuName: S.name
  }) : v ? T.intl.string(T.t.QJ9EyM) : null != R ? T.intl.string(T.t.ta3cXV) : T.intl.string(T.t.TkTvBw);
  let Q = () => N.X7u.has(null != b ? b : N.HeQ.UNKNOWN) ? p.ZP.Types.PREMIUM_PAYMENT_STARTED : null != o ? p.ZP.Types.PREMIUM_UPDATED : p.ZP.Types.PREMIUM_ACTIVATED;
  return w ? (0, l.jsx)(x.Z, {
    type: Q(),
    text: e,
    buttonText: n,
    hideClose: j,
