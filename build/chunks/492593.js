...
let O = function(e) {
  ...
  let j = (0, s.e7)([_.Z], () => (null == L ? void 0 : L.guildId) == null || (null == L ? void 0 : L.colorRoleId) == null ? null : _.Z.getRole(L.guildId, L.colorRoleId)),
    ...
    H = (0, r.jsx)(l.d.Provider, {
      ...
      children: (0, r.jsx)(c.tEY, E(m({}, R), {
        children: (0, r.jsxs)("div", E(m({
          className: a()(t, {
            [p.gradient]: U,
            [p.withDisplayNameStyles]: V && (null == L ? void 0 : L.displayNameStyles) != null,
            [p.wrapper]: !0,
            [p.contentOnly]: o,
            [p.compact]: n,
            [p.preview]: g,
