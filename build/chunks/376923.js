...
function g(e, t) {
  ...
  return (0, s.Dc)(a) ? null == i || null == l || null == a ? 1 : (0, p.yE)(null != (n = l.flags) ? n : 0, f.q.BYPASSES_VERIFICATION) || (0, p.yE)(null != (r = l.flags) ? r : 0, f.q.COMPLETED_ONBOARDING) || null != l.isPending && !l.isPending ? 2 : 1 : 0
}

function b(e, t) {
  var n;
  let r = (0, o.e7)([d.default], () => d.default.getUser(e), [e]),
