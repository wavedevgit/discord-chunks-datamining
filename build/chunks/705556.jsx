...
function g(e) {
  ...
  return b ? null == y ? <f.O1 action={"EDIT_PROFILE"} text={_.intl.string(_.t.s5vZlZ)} icon={a.vdY} autoFocus={true} fullWidth={h} variant={"primary"} onClick={() => {
      null == E || E(), v(), (0, s.i)(g)
    }} /> : <a.yRy targetElementRef={T} renderPopout={e => {
      let {
        closePopout: t
      } = e;
