  ...
  async function W() {
    ...
    try {
      ...
      (0, s.ZDy)(async () => {
        let {
          default: l
        } = await Promise.all([n.e("56035"), n.e("41488")]).then(n.bind(n, 758961)), i = (null == r ? void 0 : r.guild_id) != null ? p.Z.getGuild(r.guild_id) : null, o = null != i && (0, d.Gw)(i, f.Z, v.default).canCreateExpressions, s = null == S || "" === S ? (0, _.yl)(h.default.extractTimestamp(t.id)) : S, u = s.slice(0, w.Ek);
