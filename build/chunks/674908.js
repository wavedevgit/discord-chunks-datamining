  ...
  async function W() {
    ...
    try {
      ...
      (0, s.ZDy)(async () => {
        let {
          default: l
        } = await Promise.all([n.e("56035"), n.e("42564")]).then(n.bind(n, 758961)), i = (null == a ? void 0 : a.guild_id) != null ? p.Z.getGuild(a.guild_id) : null, o = null != i && (0, d.Gw)(i, f.Z, v.default).canCreateExpressions, s = null == S || "" === S ? (0, _.yl)(h.default.extractTimestamp(t.id)) : S, u = s.slice(0, w.Ek);
