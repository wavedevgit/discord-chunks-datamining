...
var Chunk481060 = require("./481060.js"),
  ...
  Chunk79541 = require("./79541.js"),
  Chunk388032 = require("./388032.jsx"),
  Chunk133023 = require("./133023.js");
let p = {
    [Chunk118589.UA.EMAIL_VERIFICATION]: Chunk388032.intl.string(Chunk79541.default.HC4IiR),
    [Chunk118589.UA.REFRESH_APP]: Chunk388032.intl.string(Chunk79541.default.SzfxQ3),
    [Chunk118589.UA.AGE_VERIFICATION]: Chunk388032.intl.string(Chunk79541.default["dSkE/A"])
  },
  h = function() {
    let {
      task: e
    ...
    return (0, Chunk951288.jsxs)(Chunk481060.Kqy, {
      ...
      children: [(0, Chunk951288.jsxs)(Chunk481060.Kqy, {
        ...
        children: [(0, Chunk951288.jsx)(Chunk481060.Heading, {
          ...
          children: Chunk388032.intl.string(Chunk79541.default["/OpRAP"])
        ...
        children: Chunk388032.intl.format(Chunk79541.default["0DHxym"], {
