...
let X = e => {
    let {
      selected: t
    } = e, n = (0, o.e7)([E.default], () => E.default.getCurrentUser()), r = (0, o.e7)([_.Z], () => _.Z.getPremiumTypeSubscription()), i = (0, A.N)(), l = (0, P.N)(), a = (0, C.Vi)(), s = (0, z.V)(), c = (0, I.Qo)(n, r), u = (0, o.e7)([y.Z], () => y.Z.getCreatedAtOverride()), d = t || null != i || null != l || a || null != s || c, p = null != u ? u : null == n ? true : n.createdAt;
  ...
  $ = e => {
    ...
    let eo = (0, o.e7)([E.default], () => E.default.getCurrentUser()),
      es = (0, o.e7)([_.Z], () => _.Z.getPremiumTypeSubscription()),
      {
        variant: ec,
      ...
      ey = (0, M._h)(),
      eC = (0, Y.Kn)(),
      eS = O.Z.getAlmostExpiringTrialOffers([K.Si.TIER_2]),
      eT = eu && eS.length > 0 && null != eg && null != eg.expires_at,
      eN = O.Z.getAlmostExpiringDiscountOffers([K.Si.TIER_2]),
      ...
      ek = [],
      eU = [];
    (0, g.Kl)() && ((ej || eT && !eD) && ek.push(s.z.NITRO_TAB_BADGE_OFFER_REMINDER), ey && ek.push(s.z.RECURRING_3P_PROMOTION_POPOVER), eE && ek.push(s.z.BOGO_2025_NITRO_TAB_BADGE), eR && ek.push(s.z.VOICE_FILTER_EARLY_ACCESS_PREMIUM_TAB_BADGE), eb && ek.push(s.z.Q2_2025_MARKETING_MOMENT_NITRO_TAB_BADGE_V2), eM && ek.push(s.z.GAME_WIDGETS_PREMIUM_TAB_BADGE));
    let [eG, eH] = (0, m.US)(ek, true, true);
    ex && eU.push(s.z.CHURN_DISCOUNT_PREMIUM_TAB_COACHMARK), eO && eU.push(s.z.PREMIUM_GROUP_POPOVER);
    let [eB, eV] = (0, m.US)(eU, true, true), eF = (0, Z.H)(a.I.PREMIUM_TAB), [ez, eY] = (0, m.TE)(null != eF && "premiumTab" === eF.properties.properties.oneofKind ? s.z.PREMIUM_TAB_MARKETING_MOMENT_OFFER_BADGE : null, null != (et = null == eF ? true : eF.promotionId) ? et : "", true, true);
    if (i.useEffect(() => {
    ...
    let eW = () => {
      ew === s.z.FRACTIONAL_NITRO_DURATION_LEFT_PILL && eL(Q.L.TAKE_ACTION), v.default.track(q.rMx.NITRO_TAB_VISITED, {
        badge_decorator: y,
        has_premium: ed
      }), null != eG && eH(Q.L.USER_DISMISS), null != ez && eY(Q.L.USER_DISMISS)
    };
    if (eP === K.a$.NONE || eb || (y = 7, n = (0, r.jsx)(j.Z, {
        className: "",
        startsAt: eA,
        endsAt: eZ,
    ...
    }) : eG === s.z.VOICE_FILTER_EARLY_ACCESS_PREMIUM_TAB_BADGE || eG === s.z.GAME_WIDGETS_PREMIUM_TAB_BADGE ? (n = (0, r.jsx)(H._y, {
      isTabSelected: en,
      badgeCopy: J.intl.string(J.t.y2b7CA),
      offerExpiresAt: null
    }), y = 2) : eb ? (n = (0, r.jsx)(F.S, {
      expiresAt: eZ
    }), y = 4) : null != ev ? (n = (0, r.jsx)(W.Z, {
      copy: ev,
      showStars: false
    }), y = 1) : null != eh ? (n = ec === T.tE.OFFER_COUNTDOWN && ej ? (0, r.jsx)(B.a, {
      discountOffer: eh
    }) : (0, r.jsx)(H.GN, {
      userDiscount: eh,
      isTabSelected: en,
    ...
    }), y = 3) : null == eg || eD ? eC ? (n = (0, r.jsx)(V.l, {
      isSelected: en,
      onSelect: () => (0, h.Q3)(s.z.REFERRAL_PROGRAM_PREMIUM_TAB_BADGE, {
        dismissAction: Q.L.TAKE_ACTION
      })
    }), y = 6) : ex && (n = (0, r.jsx)(G.Z, {
      isSelected: en,
      discountOffer: em
    }), y = 8) : (n = ec === T.tE.OFFER_COUNTDOWN && eT ? (0, r.jsx)(B.F, {
      trialOffer: eg
    }) : (0, r.jsx)(H.$H, {
      trialOffer: eg,
      isTabSelected: en,
    ...
    let eK = (0, r.jsx)(d.Qj, ($ = function(e) {
    ...
    return eC ? (0, r.jsx)(V.C, {
      children: eK
    }) : ex && eB === s.z.CHURN_DISCOUNT_PREMIUM_TAB_COACHMARK && 8 === y ? (0, r.jsx)(U.Z, {
      targetElementRef: er,
      discountOffer: em,
      premiumSubscription: es,
      dismissCoachmark: eV,
      children: eK
    }) : eO && eB === s.z.PREMIUM_GROUP_POPOVER ? (0, r.jsx)(L.x, {
      targetElementRef: er,
      dismissPopover: eV,
      children: eK
    }) : eK
