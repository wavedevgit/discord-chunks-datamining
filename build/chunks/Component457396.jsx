...
let K = e => {
    let {
      selected: t
    } = e, n = (0, a.e7)([m.default], () => m.default.getCurrentUser()), r = (0, a.e7)([b.Z], () => b.Z.getPremiumTypeSubscription()), i = (0, x.N)(), l = (0, P.Ng)(), o = (0, y.Vi)(), s = (0, B.V)(), c = (0, O.Qo)(n, r), u = (0, a.e7)([E.Z], () => E.Z.getCreatedAtOverride()), d = t || null != i || null != l || o || null != s || c, p = null != u ? u : null == n ? true : n.createdAt;
  ...
  q = e => {
    ...
    let eu = (0, l.JA)("nitro"),
      ...
      eP = (null == ed ? true : ed.trial_id) === F.a7,
      ex = (0, p.YZ)("NitroTabButton"),
      eA = [],
      eZ = [];
    (0, f.Kl)() && (em && eA.push(o.z.SEPTEMBER_2025_MARKETING_MOMENT_NITRO_TAB_BADGE), eg && eA.push(o.z.BOGO_2025_NITRO_TAB_BADGE), ej && eA.push(o.z.VOICE_FILTER_EARLY_ACCESS_PREMIUM_TAB_BADGE), eh && eA.push(o.z.Q2_2025_MARKETING_MOMENT_NITRO_TAB_BADGE_V2), ex && eA.push(o.z.CUSTOM_THEMES_PREMIUM_TAB_BADGE));
    let [ew, eL] = (0, g.US)(eA, true, true);
    ev && eZ.push(o.z.CHURN_DISCOUNT_PREMIUM_TAB_COACHMARK);
    let [eR, eD] = (0, g.US)(eZ, true, true);
    if (i.useEffect(() => {
        true === X && null != ew && eL(W.L.AUTO_DISMISS), true === X && null != eR && eD(W.L.AUTO_DISMISS)
      }, [eL, X, ew, eD, eR]), !K({
        selected: X
      })) return null;
    let ek = () => {
      eT === o.z.FRACTIONAL_NITRO_DURATION_LEFT_PILL && eN(W.L.TAKE_ACTION), _.default.track(z.rMx.NITRO_TAB_VISITED, {
        badge_decorator: E,
        has_premium: ei
      }), null != ew && eL(W.L.USER_DISMISS)
    };
    if (eI === F.a$.NONE || eh || (E = 7, n = (0, r.jsx)(N.Z, {
        className: "",
        startsAt: eC,
        endsAt: eS,
        messageStyle: u.aj.SHORT_TIME,
        upperCase: true
      })), em) n = (0, r.jsx)(G.Z, {}), E = 9;
      ...
      n = (0, r.jsx)(D._y, {
        ...
        offerExpiresAt: true === e ? null == ed ? true : ed.expires_at : null
      }), E = 4
    } else ew === o.z.VOICE_FILTER_EARLY_ACCESS_PREMIUM_TAB_BADGE || ew === o.z.CUSTOM_THEMES_PREMIUM_TAB_BADGE ? (n = (0, r.jsx)(D._y, {
      isTabSelected: X,
      badgeCopy: Y.intl.string(Y.t.y2b7CA),
      offerExpiresAt: null
    }), E = 2) : eh ? (n = (0, r.jsx)(M.S, {
      expiresAt: eS
    }), E = 4) : null != e_ ? (n = (0, r.jsx)(H.Z, {
      copy: e_,
      showStars: false
    }), E = 1) : null != ep ? (n = (0, r.jsx)(D.GN, {
      userDiscount: ep,
      isTabSelected: X,
      includesAmountOff: false
    }), E = 3) : null == ed || eP ? ey ? (n = (0, r.jsx)(k.l, {
      isSelected: X,
      onSelect: () => (0, h.Q3)(o.z.REFERRAL_PROGRAM_PREMIUM_TAB_BADGE, {
        dismissAction: W.L.TAKE_ACTION
      })
    }), E = 6) : ev && (n = (0, r.jsx)(R.Z, {
      isSelected: X,
      discountOffer: ef
    }), E = 8) : (n = (0, r.jsx)(D.$H, {
      trialOffer: ed,
    ...
    el && es && (eM = Y.intl.string(Y.t["4gwVVl"])), !ei && ea && (eo === C.Rx.TRY_NITRO && null != ed ? eM = Y.intl.string(Y.t["3O6A4e"]) : eo === C.Rx.JOIN_NITRO ? eM = Y.intl.string(Y.t.brBiOz) : eo === C.Rx.GET_NITRO && (eM = Y.intl.string(Y.t.GayC1t))), eO && eE.cohort !== S.xI.Control && (n = (0, r.jsx)(D._y, {
      isTabSelected: X,
    ...
    let eU = (0, r.jsx)(c.Qj, (q = function(e) {
    ...
    return eO && eE.cohort === S.xI.Static ? (0, r.jsx)(w.X, {
      children: eU
    }) : ey ? (0, r.jsx)(k.C, {
      children: eU
    }) : ev && eR === o.z.CHURN_DISCOUNT_PREMIUM_TAB_COACHMARK && 8 === E ? (0, r.jsx)(L.Z, {
      targetElementRef: J,
      discountOffer: ef,
