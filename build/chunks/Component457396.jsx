...
let Q = e => {
  ...
  J = e => {
    ...
    let [eU, eG] = (0, m.US)(eD, true, true), eH = (0, Z.H)(a.I.PREMIUM_TAB), [eB, eV] = (0, m.TE)(null != eH && "premiumTab" === eH.properties.properties.oneofKind ? o.z.PREMIUM_TAB_MARKETING_MOMENT_OFFER_BADGE : null, null != ($ = null == eH ? true : eH.id) ? $ : "", true, true);
    if (i.useEffect(() => {
    ...
    if (eN === Y.a$.NONE || eh || (I = 7, n = (0, r.jsx)(j.Z, {
      ...
      isDismissed: eB !== o.z.PREMIUM_TAB_MARKETING_MOMENT_OFFER_BADGE
    }), I = 9;
