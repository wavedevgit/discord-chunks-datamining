...
e.exports = function(e, t, n, p, h, m, g, E) {
  ...
  if (e === s ? (G = Z = g, S = 19) : e === l ? (G = u, B -= 257, Z = d, H -= 257, S = 256) : (G = f, Z = _, S = -1), U = 0, R = 0, P = w, I = m, x = L, M = 0, v = -1, O = (j = 1 << L) - 1, e === l && j > a || e === c && j > o) return 1;
  for (;;) {
    T = P - M, g[R] < S ? (A = 0, N = g[R]) : g[R] > S ? (A = Z[H + g[R]], N = G[B + g[R]]) : (A = 96, N = 0), b = 1 << P - M, w = y = 1 << x;
