...
e.exports = function(e, t, n, p, h, m, g, E) {
  ...
  if (e === s ? (G = Z = g, I = 19) : e === l ? (G = u, B -= 257, Z = d, H -= 257, I = 256) : (G = f, Z = _, I = -1), U = 0, P = 0, R = w, S = m, x = L, M = 0, y = -1, O = (j = 1 << L) - 1, e === l && j > o || e === c && j > a) return 1;
  for (;;) {
    T = R - M, g[P] < I ? (N = 0, A = g[P]) : g[P] > I ? (N = Z[H + g[P]], A = G[B + g[P]]) : (N = 96, A = 0), v = 1 << R - M, w = b = 1 << x;
    ...
    if (R > L && (U & O) !== y) {
      for (0 === M && (M = L), S += w, k = 1 << (x = R - M); x + M < D && !((k -= V[x + M]) <= 0);) x++, k <<= 1;
