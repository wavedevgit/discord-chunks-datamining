...
module.exports = function(e, t, n, p, h, m, g, E) {
  ...
  if (e === s ? (G = V = g, T = 19) : e === l ? (G = u, B -= 257, V = d, H -= 257, T = 256) : (G = f, V = _, T = false), U = 0, P = 0, R = w, I = m, L = x, j = 0, O = false, v = (M = 1 << x) - 1, e === l && M > o || e === c && M > a) return 1;
  for (;;) {
    ...
    if (R > x && (U & v) !== O) {
      for (0 === j && (j = x), I += w, k = 1 << (L = R - j); L + j < D && !((k -= Z[L + j]) <= 0);) L++, k <<= 1;
      if (M += 1 << L, e === l && M > o || e === c && M > a) return 1;
