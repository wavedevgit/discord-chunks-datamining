...
module.exports = function(e, t, n, p, h, m, g, E) {
  ...
  if (e === s ? (G = V = g, S = 19) : e === l ? (G = u, B -= 257, V = d, H -= 257, S = 256) : (G = f, V = _, S = false), U = 0, P = 0, R = w, I = m, x = L, M = 0, O = false, v = (j = 1 << L) - 1, e === l && j > a || e === c && j > o) return 1;
  for (;;) {
    T = R - M, g[P] < S ? (A = 0, C = g[P]) : g[P] > S ? (A = V[H + g[P]], C = G[B + g[P]]) : (A = 96, C = 0), b = 1 << R - M, w = y = 1 << x;
    ...
    if (R > L && (U & v) !== O) {
      for (0 === M && (M = L), I += w, k = 1 << (x = R - M); x + M < D && !((k -= Z[x + M]) <= 0);) x++, k <<= 1;
