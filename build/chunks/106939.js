...
function H(e) {
  ...
  return (0, r.jsxs)(u.njP, {
    ...
    children: [(0, r.jsx)(u.njP.Item, {
      ...
      children: [U.NW.string(M.Z["gVWG+/"]), i > 0 ? (0, r.jsx)(u.mAB, {
        className: V.badge,
        count: i
      }) : null]
...
function z(e) {
  ...
  return (0, r.jsx)(u.f6W, {
    ...
    children: e => (0, r.jsxs)(x.Z, {
      ...
      }), (0, r.jsx)(x.Z.Divider, {}), (0, r.jsxs)(u.njP, {
        "aria-label": U.NW.string(M.Z.RZqaJi),
        selectedItem: n,
        type: "top-pill",
        onItemSelect: i,
...
function K() {
  ...
  } = (0, f.ZP)(h.Z.FAMILY_CENTER), t = (0, P.Z)(), n = (0, R.M8)(), s = (0, N.wE)(d.z.FAMILY_CENTER_NEW_BADGE), l = (0, c.e7)([I.Z], () => I.Z.getIsInitialized()), x = (0, A.M)(), D = (0, c.e7)([C.Z], () => C.Z.theme), {
    selectedTab: Z,
    handleTabChange: w
  } = (0, y.Z)(), G = (0, _.Dt)(), H = S.default.getCurrentUser(), Y = null != t, K = l && null != H && !Y;
  (0, g.ZP)(() => {
