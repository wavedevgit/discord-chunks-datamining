      ...
      return (0, n.jsx)(a.A, j({
        ...
        onContextMenu: e => {
          (0, d.L3)(e, async () => {
            let {
              default: e
            } = await Promise.all([r.e("97262"), r.e("91042"), r.e("21601")]).then(r.bind(r, 365689));
            return r => {
              var i, s;
...
function I(e) {
  let {
    ...
    transitionState: r,
    onClose: s
  } = e, d = i.useMemo(() => b.A.getFriendIDs(), []);
  i.useEffect(() => {
    m.A.fetchFriendMembersIfNotFetched(t.id, d)
  }, [t.id, d]);
  let a = (0, o.bG)([p.Ay], () => p.Ay.getMembers(t.id)),
    f = i.useMemo(() => u()(a).filter(e => !!d.includes(e.userId) && null != g.default.getUser(e.userId)).sortBy(e => {
      var t;
