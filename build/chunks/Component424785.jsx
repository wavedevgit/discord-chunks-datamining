...
class Y extends Chunk98597.ZP {
  ...
  render() {
    ...
    } = this.state, C = this.getVoiceStatesCount(), E = (0, Chunk951288.jsxs)("li", {
...
function X(e) {
  ...
  }), p = (0, a.e7)([I.Z], () => I.Z.isCollapsed(n.parent_id)), f = (0, S.ZP)(n.id), h = (0, a.e7)([E.Z], () => E.Z.getStageInstanceByChannel(n.id), [n.id]), g = (0, j.Rk)(n.id, C.pV.AUDIENCE), {
    isSubscriptionGated: m,
    needSubscriptionToAccess: b
  } = (0, _.Z)(n.id), O = (0, a.e7)([A.ZP], () => A.ZP.isFavorite(t.id, n.id)), y = (0, x.xJ)(n.id), v = (0, M.Z)({
    channel: n,
