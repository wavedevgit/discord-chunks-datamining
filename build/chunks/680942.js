...
let x = {
  ...
  S = e => {
    ...
    } = (0, s.ZP)(), T = l.useRef(null), I = (0, i.Z)(T), L = (0, b.hv)("CollectiblesShopGiftButton"), B = (0, p.sp)(), w = (0, g.Z)();
    return (0, f.x6)(t) ? null : (0, r.jsx)(o.ua7, {
      text: v.intl.string(v.t["JCFN//"]),
      delay: y,
      children: e => {
        var l, i;
        return (0, r.jsx)(o.zxk, (l = function(e) {
