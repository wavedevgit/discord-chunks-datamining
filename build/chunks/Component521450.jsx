...
let E = () => {
  ...
  return Chunk647438.useEffect(() => {
    ...
    children: (0, Chunk951288.jsxs)(Chunk481060.C3N, {
      label: Chunk388032.intl.string(Chunk41418.default.USIXU7),
      children: [(0, Chunk951288.jsx)(Chunk481060.rsf, {
        checked: module,
        description: Chunk388032.intl.string(Chunk41418.default["5MdB3j"]),
        onChange: Chunk695346.Ex.updateSetting,
        label: Chunk388032.intl.string(Chunk41418.default.zkEceS)
        ...
        children: (0, Chunk951288.jsxs)(Chunk435935.k, {
          ...
          children: [(0, Chunk951288.jsx)(Chunk435935.k.Child, {
            children: (0, Chunk951288.jsx)(Chunk481060.Text, {
              ...
              color: "text-default",
              children: Chunk388032.intl.string(Chunk41418.default.xAVm7K)
            })
            ...
            children: (0, Chunk951288.jsx)(Chunk799899.rU, {
              ...
              children: Chunk388032.intl.string(Chunk41418.default.cUIXFY)
            })
        ...
        description: Chunk388032.intl.string(Chunk41418.default.y34S46),
        onChange: E,
        label: Chunk388032.intl.string(Chunk41418.default.irvJKR)
      })]
    })
  })
}