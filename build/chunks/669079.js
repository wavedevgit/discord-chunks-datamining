...
let V = e => (null == e ? void 0 : e.type) === m.uaV.CUSTOM_GIFT && (null == e ? void 0 : e.embeds.length) === 1 && (null == e ? void 0 : e.embeds[0].type) === m.hBH.GIFT,
  Z = e => {
    let t;
    if (null == e || l.l.getCurrentConfig({
        location: "findGiftCodes"
      }).enabled) return [];
    let n = new Set;
...
async function Y(e) {
  ...
  try {
    ...
    return d.default.track(m.rMx.GIFT_CODE_RESOLVED, {
      resolved: !0,
      gift_code: r.code,
    ...
    throw d.default.track(m.rMx.GIFT_CODE_RESOLVED, {
      resolved: !1,
      gift_code: e
    }), new a.Z(t)
  }
...
function K(e, t, n, r, i, o, a) {
  return null == n && (r || i || null == e) ? !a || o || r || i ? r && (t.isSubscription || null != e) ? m.wZ8.SUCCESS : m.wZ8.CONFIRM : m.wZ8.OPEN : m.wZ8.ERROR
}
...
function z(e, t, n) {
  switch (e) {
    ...
    case m.wZ8.SUCCESS:
      return t.isSubscription ? E.intl.formatToPlainString(E.t["1C2BGx"], {
        skuName: n.name
      }) : E.intl.string(E.t["+BNMcH"]);
    case m.wZ8.CONFIRM:
    default:
      return t.isSubscription ? E.intl.formatToPlainString(E.t["2VN4Nz"], {
        skuName: n.name
      }) : E.intl.string(E.t.RmamAA)
  }
}
...
function Q(e) {
  ...
  }, () => E.intl.formatToPlainString(E.t["vFfV+P"], {
    timeInterval: E.intl.string(E.t.FPybU1)
  })).with({
    interval: g.rV.YEAR,
    premiumSubscriptionType: g.p9.TIER_2
  }, () => E.intl.formatToPlainString(E.t["vFfV+P"], {
    timeInterval: E.intl.string(E.t.tfqrho)
  })).with({
    interval: g.rV.MONTH,
    premiumSubscriptionType: g.p9.TIER_1
  }, () => E.intl.formatToPlainString(E.t.gjKbFx, {
    intervalCount: e.intervalCount
  })).with({
    interval: g.rV.YEAR,
    premiumSubscriptionType: g.p9.TIER_1
  }, () => E.intl.formatToPlainString(E.t.GIe7Bw, {
    intervalCount: e.intervalCount
...
function X(e) {
  ...
  switch (t) {
    ...
    default:
      ...
      return E.intl.formatToPlainString(E.t.l6Ea4e, {
        skuName: n.name
      })
  }
}
...
function J(e, t, n, r, i) {
  let o = n || r ? void 0 : e,
    a = E.intl.format(E.t["5zyz9/"], {
      onGoToLibrary: i
    });
  return null != o ? a : null == t ? null : en(t, u.default.getCurrentUser())
}

function $(e, t, n) {
  let r = t.applicationId,
    i = e.length > 0 ? e : [r],
    o = i.map(e => n.getLibraryApplication(r, e, !0)).filter(f.lm);
...
function en(e, t) {
  switch (e.code) {
    ...
    case m.evJ.INVALID_GIFT_REDEMPTION_SUBSCRIPTION_INCOMPATIBLE:
      return E.intl.formatToPlainString(E.t["4YTHKy"], {
        planName: (0, _.M5)(t, g.p9.TIER_2) ? E.intl.string(E.t["lG6a5+"]) : E.intl.string(E.t["FSOz7+"])
      });
