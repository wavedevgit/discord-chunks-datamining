    ...
    return o.useMemo(() => {
      ...
      switch (t.skuId) {
        case g.If:
          ...
          break;
        case a.A$:
          e = b ? <s.Text color={"text-danger"} variant={"text-sm/semibold"}>{v.intl.string(k.default.hN75yc)}</s.Text> : <s.Text color={"text-danger"} variant={"text-sm/semibold"}>{v.intl.string(k.default.Du91RU)}</s.Text>;
          break;
        case a.MB:
        case a.Vk:
      ...
      return b && t.skuId === g.XW && (e = <r.Fragment>{e}{<s.Text color={"text-danger"} variant={"text-sm/semibold"}>{p ? v.intl.string(k.default.TkNA7e) : v.intl.string(k.default.M4XL5u)}</s.Text>}</r.Fragment>), e
    }, [t, x, n, b, p])
  }(j, _);
  return (0, m.$)(j, _, m.w.DEACTIVATE), <s.Y0X{...t = function(e) {
