...
e = require.nmd(module), (function() {
  ...
  function I(e) {
    ...
    }), (t = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(D)) && !/\bi686\b/i.test(D) ? (Z && (Z.architecture = 64, Z.family = Z.family.replace(RegExp(" *" + t), "")), U && (/\bWOW64\b/i.test(e) || M && /\w(?:86|32)$/.test(o.cpuClass || o.platform) && !/\bWin64; x64\b/i.test(e)) && L.unshift("32-bit")) : Z && /^OS X/.test(Z.family) && "Chrome" == U && parseFloat(j) >= 39 && (Z.architecture = 64), e || (e = null);
    var q = {};
