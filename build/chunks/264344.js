...
e = n.nmd(e), (function() {
  ...
  function S(e) {
    ...
    }), (t = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(w)) && !/\bi686\b/i.test(w) ? (V && (V.architecture = 64, V.family = V.family.replace(RegExp(" *" + t), "")), U && (/\bWOW64\b/i.test(e) || M && /\w(?:86|32)$/.test(a.cpuClass || a.platform) && !/\bWin64; x64\b/i.test(e)) && L.unshift("32-bit")) : V && /^OS X/.test(V.family) && "Chrome" == U && parseFloat(k) >= 39 && (V.architecture = 64), e || (e = null);
    var q = {};
    return q.description = e, q.layout = j && j[0], q.manufacturer = B, q.name = U, q.prerelease = x, q.product = G, q.ua = e, q.version = U && k, q.os = V || {
      architecture: null,
      family: null,
      version: null,
      toString: function() {
    ...
    }, q.parse = S, q.toString = z, q.version && L.unshift(k), q.name && L.unshift(U), V && U && !(V == String(V).split(" ")[0] && (V == U.split(" ")[0] || G)) && L.push(G ? "(" + V + ")" : "on " + V), L.length && (q.description = L.join(" ")), q
  }
  var I = S();
