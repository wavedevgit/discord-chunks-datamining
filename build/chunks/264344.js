...
e = require.nmd(module), (function() {
  ...
  function I(e) {
    ...
    if (k && (k = [k]), /\bAndroid\b/.test(Z) && !G && (t = /\bAndroid[^;]*;(.*?)(?:Build|\) AppleWebKit)\b/i.exec(e)) && (G = v(t[1]).replace(/^[a-z]{2}-[a-z]{2};\s*/i, "") || null), B && !G ? G = W([B]) : B && G && (G = G.replace(RegExp("^(" + y(B) + ")[-_.\\s]", "i"), B + " ").replace(RegExp("^(" + y(B) + ")[-_.]?(\\w)", "i"), B + " $2")), (t = /\bGoogle TV\b/.exec(G)) && (G = t[0]), /\bSimulator\b/i.test(e) && (G = (G ? G + " " : "") + "Simulator"), "Opera Mini" == U && /\bOPiOS\b/.test(e) && L.push("running in Turbo/Uncompressed mode"), "IE" == U && /\blike iPhone OS\b/.test(e) ? (B = (t = I(e.replace(/like iPhone OS/, ""))).manufacturer, G = t.product) : /^iP/.test(G) ? (U || (U = "Safari"), Z = "iOS" + ((t = / OS ([\d_]+)/i.exec(e)) ? " " + t[1].replace(/_/g, ".") : "")) : "Konqueror" == U && /^Linux\b/i.test(Z) ? Z = "Kubuntu" : B && "Google" != B && (/Chrome/.test(U) && !/\bMobile Safari\b/i.test(e) || /\bVita\b/.test(G)) || /\bAndroid\b/.test(Z) && /^Chrome/.test(U) && /\bVersion\//i.test(e) ? (U = "Android Browser", Z = /\bAndroid\b/.test(Z) ? Z : "Android") : "Silk" == U ? (/\bMobi/i.test(e) || (Z = "Android", L.unshift("desktop mode")), /Accelerated *= *true/i.test(e) && L.unshift("accelerated")) : "UC Browser" == U && /\bUCWEB\b/.test(e) ? L.push("speed mode") : "PaleMoon" == U && (t = /\bFirefox\/([\d.]+)\b/.exec(e)) ? L.push("identifying as Firefox " + t[1]) : "Firefox" == U && (t = /\b(Mobile|Tablet|TV)\b/i.exec(e)) ? (Z || (Z = "Firefox OS"), G || (G = t[1])) : !U || (t = !/\bMinefield\b/i.test(e) && /\b(?:Firefox|Safari)\b/.exec(U)) ? (U && !G && /[\/,]|^[^(]+?\)/.test(e.slice(e.indexOf(t + "/") + 8)) && (U = null), (t = G || B || Z) && (G || B || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(Z)) && (U = /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(Z) ? Z : t) + " Browser")) : "Electron" == U && (t = (/\bChrome\/([\d.]+)\b/.exec(e) || 0)[1]) && L.push("Chromium " + t), M || (M = K(["(?:Cloud9|CriOS|CrMo|Edge|Edg|EdgA|EdgiOS|FxiOS|HeadlessChrome|IEMobile|Iron|Opera ?Mini|OPiOS|OPR|Raven|SamsungBrowser|Silk(?!/[\\d.]+$)|UCBrowser|YaBrowser)", "Version", y(U), "(?:Firefox|Minefield|NetFront)"])), (t = "iCab" == k && parseFloat(M) > 3 && "WebKit" || /\bOpera\b/.test(U) && (/\bOPR\b/.test(e) ? "Blink" : "Presto") || /\b(?:Midori|Nook|Safari)\b/i.test(e) && !/^(?:Trident|EdgeHTML)$/.test(k) && "WebKit" || !k && /\bMSIE\b/i.test(e) && ("Mac OS" == Z ? "Tasman" : "Trident") || "WebKit" == k && /\bPlayStation\b(?! Vita\b)/i.test(U) && "NetFront") && (k = [t]), "IE" == U && (t = (/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(e) || 0)[1]) ? (U += " Mobile", Z = "Windows Phone " + (/\+$/.test(t) ? t : t + ".x"), L.unshift("desktop mode")) : /\bWPDesktop\b/i.test(e) ? (U = "IE Mobile", Z = "Windows Phone 8.x", L.unshift("desktop mode"), M || (M = (/\brv:([\d.]+)/.exec(e) || 0)[1])) : "IE" != U && "Trident" == k && (t = /\brv:([\d.]+)/.exec(e)) && (U && L.push("identifying as " + U + (M ? " " + M : "")), U = "IE", M = t[1]), j) {
      ...
      else E(t = r.runtime) == d ? (U = "Adobe AIR", Z = t.flash.system.Capabilities.os) : E(t = r.phantom) == T ? (U = "PhantomJS", M = (t = t.version || null) && t.major + "." + t.minor + "." + t.patch) : "number" == typeof R.documentMode && (t = /\bTrident\/(\d+)/i.exec(e)) ? (M = [M, R.documentMode], (t = +t[1] + 4) != M[1] && (L.push("IE " + M[1] + " mode"), k && (k[1] = ""), M[1] = t), M = "IE" == U ? String(M[1].toFixed(1)) : M[0]) : "number" == typeof R.documentMode && /^(?:Chrome|Firefox)\b/.test(U) && (L.push("masking as " + U + " " + M), U = "IE", M = "11.0", k = ["Trident"], Z = "Windows");
      Z = Z && m(Z)
    }
    if (M && (t = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(M) || /(?:alpha|beta)(?: ?\d)?/i.exec(e + ";" + (j && o.appMinorVersion)) || /\bMinefield\b/i.test(e) && "a") && (x = /b/i.test(t) ? "beta" : "alpha", M = M.replace(RegExp(t + "\\+?$"), "") + ("beta" == x ? N : C) + (/\d+\+?/.exec(t) || "")), "Fennec" == U || "Firefox" == U && /\b(?:Android|Firefox OS|KaiOS)\b/.test(Z)) U = "Firefox Mobile";
      ...
      L.unshift("embedded")
    } else(/\bBlackBerry\b/.test(G) || /\bBB10\b/.test(e)) && (t = (RegExp(G.replace(/ +/g, " *") + "/([.\\d]+)", "i").exec(e) || 0)[1] || M) ? (Z = ((t = [t, /BB10/.test(e)])[1] ? (G = null, B = "BlackBerry") : "Device Software") + " " + t[0], M = null) : this != g && "Wii" != G && (j && P || /Opera/.test(U) && /\b(?:MSIE|Firefox)\b/i.test(e) || "Firefox" == U && /\bOS X (?:\d+\.){2,}/.test(Z) || "IE" == U && (Z && !/^Win/.test(Z) && M > 5.5 || /\bWindows XP\b/.test(Z) && M > 8 || 8 == M && !/\bTrident\b/.test(e))) && !c.test(t = I.call(g, e.replace(c, "") + ";")) && t.name && (t = "ing as " + t.name + ((t = t.version) ? " " + t : ""), c.test(U) ? (/\bIE\b/.test(t) && "Mac OS" == Z && (Z = null), t = "identify" + t) : (t = "mask" + t, U = w ? m(w.replace(/([a-z])([A-Z])/g, "$1 $2")) : "Opera", /\bIE\b/.test(t) && (Z = null), j || (M = null)), k = ["Presto"], L.push(t));
    (t = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(e) || 0)[1]) && (t = [parseFloat(t.replace(/\.(\d)$/, ".0$1")), t], "Safari" == U && "+" == t[1].slice(false) ? (U = "WebKit Nightly", x = "alpha", M = t[1].slice(0, false)) : (M == t[1] || M == (t[2] = (/\bSafari\/([\d.]+\+?)/i.exec(e) || 0)[1])) && (M = null), t[1] = (/\b(?:Headless)?Chrome\/([\d.]+)/i.exec(e) || 0)[1], 537.36 == t[0] && 537.36 == t[2] && parseFloat(t[1]) >= 28 && "WebKit" == k && (k = ["Blink"]), j && (l || t[1]) ? (k && (k[1] = "like Chrome"), t = t[1] || ((t = t[0]) < 530 ? 1 : t < 532 ? 2 : t < 532.05 ? 3 : t < 533 ? 4 : t < 534.03 ? 5 : t < 534.07 ? 6 : t < 534.1 ? 7 : t < 534.13 ? 8 : t < 534.16 ? 9 : t < 534.24 ? 10 : t < 534.3 ? 11 : t < 535.01 ? 12 : t < 535.02 ? "13+" : t < 535.07 ? 15 : t < 535.11 ? 16 : t < 535.19 ? 17 : t < 536.05 ? 18 : t < 536.1 ? 19 : t < 537.01 ? 20 : t < 537.11 ? "21+" : t < 537.13 ? 23 : t < 537.18 ? 24 : t < 537.24 ? 25 : t < 537.36 ? 26 : "Blink" != k ? "27" : "28")) : (k && (k[1] = "like Safari"), t = (t = t[0]) < 400 ? 1 : t < 500 ? 2 : t < 526 ? 3 : t < 533 ? 4 : t < 534 ? "4+" : t < 535 ? 5 : t < 537 ? 6 : t < 538 ? 7 : t < 601 ? 8 : t < 602 ? 9 : t < 604 ? 10 : t < 606 ? 11 : t < 608 ? 12 : "12"), k && (k[1] += " " + (t += "number" == typeof t ? ".x" : /[.+]/.test(t) ? "" : "+")), "Safari" == U && (!M || parseInt(M) > 45) ? M = t : "Chrome" == U && /\bHeadlessChrome/i.test(e) && L.unshift("headless")), "Opera" == U && (t = /\bzbov|zvav$/.exec(Z)) ? (U += " ", L.unshift("desktop mode"), "zvav" == t ? (U += "Mini", M = null) : U += "Mobile", Z = Z.replace(RegExp(" *" + t + "$"), "")) : "Safari" == U && /\bChrome\b/.exec(k && k[1]) ? (L.unshift("desktop mode"), U = "Chrome Mobile", M = null, /\bOS X\b/.test(Z) ? (B = "Apple", Z = "iOS 4.3+") : Z = null) : /\bSRWare Iron\b/.test(U) && !M && (M = K("Chrome")), M && 0 == M.indexOf(t = /[\d.]+$/.exec(Z)) && e.indexOf("/" + t + "-") > false && (Z = v(Z.replace(t, ""))), Z && false != Z.indexOf(U) && !RegExp(U + " OS").test(Z) && (Z = Z.replace(RegExp(" *" + y(U) + " *"), "")), k && !/\b(?:Avant|Nook)\b/.test(U) && (/Browser|Lunascape|Maxthon/.test(U) || "Safari" != U && /^iOS/.test(Z) && /\bSafari\b/.test(k[1]) || /^(?:Adobe|Arora|Breach|Midori|Opera|Phantom|Rekonq|Rock|Samsung Internet|Sleipnir|SRWare Iron|Vivaldi|Web)/.test(U) && k[1]) && (t = k[k.length - 1]) && L.push(t), L.length && (L = ["(" + L.join("; ") + ")"]), B && G && 0 > G.indexOf(B) && L.push("on " + B), G && L.push((/^on /.test(L[L.length - 1]) ? "" : "on ") + G), Z && (n = (t = / ([\d.+]+)$/.exec(Z)) && "/" == Z.charAt(Z.length - t[0].length - 1), Z = {
      architecture: 32,
    ...
    }), (t = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(D)) && !/\bi686\b/i.test(D) ? (Z && (Z.architecture = 64, Z.family = Z.family.replace(RegExp(" *" + t), "")), U && (/\bWOW64\b/i.test(e) || j && /\w(?:86|32)$/.test(o.cpuClass || o.platform) && !/\bWin64; x64\b/i.test(e)) && L.unshift("32-bit")) : Z && /^OS X/.test(Z.family) && "Chrome" == U && parseFloat(M) >= 39 && (Z.architecture = 64), e || (e = null);
    var q = {};
    return q.description = e, q.layout = k && k[0], q.manufacturer = B, q.name = U, q.prerelease = x, q.product = G, q.ua = e, q.version = U && M, q.os = Z || {
      architecture: null,
      family: null,
      version: null,
      toString: function() {
    ...
    }, q.parse = I, q.toString = z, q.version && L.unshift(M), q.name && L.unshift(U), Z && U && !(Z == String(Z).split(" ")[0] && (Z == U.split(" ")[0] || G)) && L.push(G ? "(" + Z + ")" : "on " + Z), L.length && (q.description = L.join(" ")), q
  }
  var T = I();
