...
class p extends a.Component {
  ...
  renderBody() {
    ...
    switch (t.type) {
      case c.QyF.INPUT:
        e = null != n ? d.intl.format(d.t.NqNqy8, {
          vendorName: n.vendor.name,
          modelName: n.model.name
        }) : d.intl.format(d.t.stSaRk, {
          name: t.displayName
        });
        break;
      case c.QyF.OUTPUT:
        e = null != n ? d.intl.format(d.t.uPgqIC, {
          vendorName: n.vendor.name,
          modelName: n.model.name
        }) : d.intl.format(d.t.jyhYp6, {
          name: t.displayName
        });
        break;
      default:
        e = (0, i.jsxs)(a.Fragment, {
          children: [null != n ? d.intl.format(d.t["4Xyzx8"], {
            vendorName: n.vendor.name,
            modelName: n.model.name
          }) : d.intl.format(d.t.Z7XQcn, {
            name: t.displayName
          }), (0, i.jsx)(l.FXm, {
            value: s,
            className: m.options,
  ...
  render() {
    let {
      certifiedDeviceMetadata: e,
      transitionState: t
    } = this.props, n = null != e ? d.intl.string(d.t.kiqvHR) : d.intl.string(d.t.AbnGIy);
  ...
  constructor(e) {
    super(e), h(this, "confirm", () => {
      ...
      s.oI(), t(), o.default.track(c.rMx.MODAL_DISMISSED, {
        type: null != e ? "New Audio Device Detected - Certified" : "New Audio Device Detected - Not Certified",
