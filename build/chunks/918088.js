...
function N(e, t) {
  ...
  if (!T(e)) {
    ...
    y = !e.isSearchHit && null != t, v = null != (l = null == t ? void 0 : t.reactions) ? l : v
  }
  let j = _.size > 0,
...
function P(e, t) {
  ...
  let {
    ...
    canShowVoteCounts: D,
    canSubmitVote: L,
    expirationLabel: M = y.intl.string(y.t["e+J3JS"]),
    hasSelectedAnswer: k,
    hasVoted: U,
    isEditingVote: F,
    isExpired: B,
    ...
    showResults: K
  } = w, Y = (0, b.cZ)(V), X = y.intl.formatToPlainString(y.t.XRkuoa, {
    count: Y.toLocaleString()
  }), q = Math.max(...P.map(e => {
    var t, n;
    let r = j(V, "".concat(e.answer_id));
    ...
    enabled: !0,
    type: "showVotes"
  }, en = h.allow_multiselect, er = (0, r.EQ)({
    isInteractive: G,
    isExpired: B,
