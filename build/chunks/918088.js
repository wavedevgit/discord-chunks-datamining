...
function N(e) {
  ...
  return {
    ...
    src: null == e.id ? m.ZP.getURL(e.name) : _.ZP.getEmojiURL({
      id: e.id,
      animated: l,
      size: n
    }),
...
function R(e, t) {
  ...
  if (!P(e)) {
    ...
    I = !e.isSearchHit && null != t, O = null != (o = null == t ? true : t.reactions) ? o : O
  }
  let C = h.size > 0,
...
function w(e, t) {
  ...
  if (null == f) return;
  let _ = o.Z.useReducedMotion,
    m = null == (a = u.Z.getChannel(e.getChannelId())) || null == (n = a.getGuildId) ? true : n.call(a),
    g = (0, y.E)(f, m),
    v = d.answers,
    S = d.layout_type,
    T = R(e, t, {
  ...
  let {
    ...
    let a = "".concat(e.answer_id),
      ...
      d = F.has(a),
      f = c >= K && 0 !== c,
      p = M && null != (o = null == l ? true : l.me_vote) && o,
      m = A({
        didSelfVote: p,
        hasVoted: M,
        isExpired: U,
