...
function w(e, t) {
  ...
  let {
    ...
    canShowVoteCounts: D,
    canSubmitVote: x,
    expirationLabel: L = S.intl.string(S.t["e+J3JS"]),
    hasSelectedAnswer: j,
    hasVoted: M,
    isEditingVote: k,
    isExpired: U,
    ...
    showResults: H
  } = T, Y = (0, E.cZ)(B), W = S.intl.formatToPlainString(S.t.XRkuoa, {
    ...
    return {
      ...
      votes: (0, r.EQ)(I).with(i.C.IMAGE_ONLY_ANSWERS, () => "(".concat(c.toLocaleString(), ")")).otherwise(() => S.intl.formatToPlainString(S.t.XRkuoa, {
    ...
    enabled: x,
    type: "submit"
  })), X = (0, m.isIOS)() ? S.intl.string(S.t.PVATMz) : S.intl.string(S.t.cHfFqq), Q = (0, r.EQ)({
    isExpired: U,
    isInteractive: G,
    isEditingVote: k
  }).with({
  ...
  }, () => S.intl.string(S.t.yCXvxc)).otherwise(() => S.intl.string(S.t["9Y2wKC"]));
  return {
    question: d.question,
    promptLabel: ee,
    answers: z,
