...
function R(e) {
  ...
  }, {}), [t]), l = (0, u.e7)([_.Z], () => _.Z.getMessagesPendingDeletion(), []);
...
let k = i.memo(function(e) {
  let {
    ...
    switch (e) {
      case b._.SCHEDULED:
        return {
          isError: !1, stateMessage: T.intl.string(T.t.Fn6Odn)
        };
      case b._.ERROR_CHANNEL_NOT_FOUND:
        return {
          isError: !0, stateMessage: T.intl.string(T.t.v5O2dH)
        };
      ...
      case b._.ERROR_USER_CANNOT_USE_SCHEDULED_MESSAGES:
        return {
          isError: !0, stateMessage: T.intl.string(T.t.w6zHX1)
        };
      case b._.ERROR_SEND_FAILED:
        return {
          isError: !0, stateMessage: T.intl.string(T.t["pflV7+"])
        };
