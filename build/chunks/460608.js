...
function x(e) {
  ...
  }, [n]), x = i.useMemo(() => t.sort((e, n) => u.default.extractTimestamp(e.id) < u.default.extractTimestamp(n.id) ? 1 : -1), [t]), f = (0, a.e7)([d.Z], () => {
    var e;
    return null == (e = d.Z.getGuild(n)) ? void 0 : e.premiumSubscriberCount
  });
  return (i.useEffect(() => {
    f !== t.length && (0, l.C0)(n)
  }, [n, f, t.length]), 0 === x.length) ? null : (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(s.X6, {
      ...
      fade: !0,
      children: x.map((e, n) => (0, r.jsx)(p.Z, {
        boost: e
