...
function f(e) {
  ...
  }, [n]), f = i.useMemo(() => t.sort((e, n) => u.default.extractTimestamp(e.id) < u.default.extractTimestamp(n.id) ? 1 : -1), [t]), x = (0, s.e7)([d.Z], () => {
    var e;
    return null == (e = d.Z.getGuild(n)) ? void 0 : e.premiumSubscriberCount
  });
  return (i.useEffect(() => {
    x !== t.length && (0, l.C0)(n)
  }, [n, x, t.length]), 0 === f.length) ? null : (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(a.X6, {
      ...
      fade: !0,
      children: f.map((e, n) => (0, r.jsx)(p.Z, {
        boost: e
