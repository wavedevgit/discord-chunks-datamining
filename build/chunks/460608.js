...
function _(e) {
  ...
  }, [n]), _ = i.useMemo(() => t.sort((e, n) => d.default.extractTimestamp(e.id) < d.default.extractTimestamp(n.id) ? 1 : -1), [t]), f = (0, a.e7)([u.Z], () => {
    var e;
    return null == (e = u.Z.getGuild(n)) ? void 0 : e.premiumSubscriberCount
  });
  return (i.useEffect(() => {
    f !== t.length && (0, l.C0)(n)
  }, [n, f, t.length]), 0 === _.length) ? null : (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(s.X6, {
      ...
      fade: !0,
      children: _.map((e, n) => (0, r.jsx)(p.Z, {
        boost: e
