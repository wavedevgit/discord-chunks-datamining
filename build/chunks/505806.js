...
require.d(exports, {
  A: () => o
}), require("./321073.js"), require("./264879.js"), require("./896048.js");
...
class s extends(r = Chunk64700.Component) {
  ...
  calculateInitialDeltaBytes(e) {
    let {
      ...
      updateInterval: n,
      pointsToSmooth: r
    } = this.props, l = Date.now(), i = 0, a = 0, s = [], o = null != e[0] ? e[0].bytes : 0;
    for (; i < t + r; i++) {
      let t, r = l - (i + 1) * n;
      for (; a < e.length;)
  ...
  constructor(e) {
    super(e), a(this, "_interval", new i.IX), a(this, "update", () => {
      let {
        onUpdate: e,
        numUpdatesToShow: t,
        pointsToSmooth: n,
        updateInterval: r
      } = this.props, l = this.props.getHistoricalTotalBytes(), i = null != l[0] ? l[0].bytes : 0, a = [...this.state.deltaBytes.slice(1, t + n), i - this.state.lastTotalBytes];
      this.setState({
        deltaBytes: a,
