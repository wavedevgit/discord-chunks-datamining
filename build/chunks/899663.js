...
function h(e) {
  ...
  (0, o.k)(n) && c.default.track(f.rMx.KEYBOARD_SHORTCUT_USED, {
...
function m(e) {
  ...
  return i.useEffect(() => ((0, a.waitForAllDefaultIntlMessagesLoaded)().then(() => (0, _.d1)()), p.intl.onLocaleChange(() => (0, _.d1)()), window.addEventListener("keydown", h), () => window.removeEventListener("keydown", h)), []), (0, r.jsx)(l.Sfi.Provider, {
    value: u,
    children: t
  })
}