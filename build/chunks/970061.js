...
async function et(e, t, n, r, i) {
  ...
  if (null == i.sound || $ || (ee(i.sound, null != (o = i.volume) ? o : 1, i.soundpack), r.ping = true), i.isUserAvatar && null != e && (e = await (0, m.w)(e)), M && v.A.taskbarFlash && R.Ay.flashFrame(true), k) {
    let a = {
      title: t,
      body: n
    };
