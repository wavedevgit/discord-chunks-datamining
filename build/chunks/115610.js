...
async function g(e, t) {
  ...
  let y = Array.from(s.Z.getAllStickersIterator()),
    C = y.filter(e => e.type === c.n0.GUILD).filter(e => h(e.guild_id) && (0, a.kl)(e, E, t)).sort((e, t) => -m.default.compare(e.id, t.id));
  if (C.length > 5) {
  ...
  let x = u.Z.getGuildIds().filter(h).map(e => i.ZP.getUsableGuildEmoji(e)).flat().filter(e => null == p.ZP.getEmojiUnavailableReason({
    emoji: e,
    channel: t,
    guildId: b,
    intention: _.Hz.CHAT
