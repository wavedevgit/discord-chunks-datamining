...
async function h(e, t) {
  ...
  let y = Array.from(s.Z.getAllStickersIterator()),
    x = y.filter(e => e.type === c.n0.GUILD).filter(e => _(e.guild_id) && (0, a.kl)(e, E, t)).sort((e, t) => -m.default.compare(e.id, t.id));
  if (x.length > 5) {
  ...
  let C = u.Z.getGuildIds().filter(_).map(e => i.ZP.getUsableGuildEmoji(e)).flat().filter(e => null == p.ZP.getEmojiUnavailableReason({
    emoji: e,
    channel: t,
    guildId: b,
    intention: g.Hz.CHAT
