...
let y = t => {
  let {
    ...
    onConfirm: y,
    transitionState: S
  } = t, O = (0, s.ZP)(n, !0), A = n.id, z = n.isForumPost(), h = (0, r.e7)([C.Z], () => C.Z.getGuild(n.getGuildId())), f = (0, g.u1)(A), {
    isSubscriptionGated: v
  } = (0, u.Z)(n.id), N = (0, I.Z)(h, n), [R, H] = l.useState(), x = (0, r.e7)([T.default], () => n.isOwner(T.default.getId()), [n]), B = (0, _.q)("DeleteChannelConfirm"), M = (0, r.e7)([U.Z], () => U.Z.can(n.isThread() ? D.Plq.MANAGE_THREADS : D.Plq.MANAGE_CHANNELS, n), [n]), b = (0, r.e7)([c.Z], () => {
    var t;
