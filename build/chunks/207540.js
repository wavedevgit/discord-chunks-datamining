...
let w = t => {
  let {
    ...
    onConfirm: w,
    transitionState: y
  } = t, O = (0, o.ZP)(e, !0), Z = e.id, b = e.isForumPost(), N = (0, r.e7)([p.Z], () => p.Z.getGuild(e.getGuildId())), z = (0, h.u1)(Z), {
    isSubscriptionGated: D
  } = (0, m.Z)(e.id), P = (0, x.Z)(N, e), [S, I] = l.useState(), A = (0, r.e7)([T.default], () => e.isOwner(T.default.getId()), [e]), G = (0, d.q)("DeleteChannelConfirm"), B = (0, r.e7)([j.Z], () => j.Z.can(e.isThread() ? k.Plq.MANAGE_THREADS : k.Plq.MANAGE_CHANNELS, e), [e]), R = (0, r.e7)([g.Z], () => {
    var t;
    return null != (t = g.Z.getCount(e.id)) ? t : 0
  }, [e.id]), U = b && (B || A && R < 1), M = z.length > 0 && (e.type === k.d4z.GUILD_VOICE || e.type === k.d4z.GUILD_STAGE_VOICE);
  if (l.useEffect(() => {
      (async () => {
  ...
  if (null != S) {
    ...
    switch (S) {
      case u.j.DEFAULT:
        t = E.intl.format(E.t.iWlB6u, {
          onClick: e
        });
        break;
      case u.j.TODO:
        t = E.intl.format(E.t["/rjozM"], {
          onClick: e
        });
        break;
      case u.j.RESOURCE:
        t = E.intl.format(E.t.Nf5pt7, {
          onClick: e
        });
        break;
      case u.j.RULES:
  ...
  let {
    ...
    deleteBody: E.intl.format(E.t.a6Gz9P, {
      channelName: O
    })
  } : e.isForumPost() ? {
    deleteText: U ? E.intl.string(E.t.nEOg1N) : E.intl.string(E.t.xwMqDw),
    deleteBody: U && A && !B ? E.intl.format(E.t["6/pY29"], {
      postName: O
    }) : U ? E.intl.format(E.t.su3voK, {
      postName: O
  ...
  return G ? (0, i.jsx)(a.Modal, {
    ...
    children: M ? (0, i.jsx)(s.Text, {
      variant: "text-md/normal",
      color: "header-secondary",
      children: E.intl.format(E.t.Ze005O, {
        count: z.length
      })
    }) : null
  }) : (0, i.jsxs)(s.Y0X, {
