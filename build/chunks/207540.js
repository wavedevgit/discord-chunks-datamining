...
let b = t => {
  let {
    ...
    onConfirm: b,
    transitionState: U
  } = t, L = (0, s.ZP)(e, !0), D = e.id, v = e.isForumPost(), S = (0, l.e7)([I.Z], () => I.Z.getGuild(e.getGuildId())), G = (0, m.u1)(D), {
    isSubscriptionGated: j
  } = (0, _.Z)(e.id), x = (0, g.Z)(S, e), [z, A] = r.useState(), N = (0, l.e7)([T.default], () => e.isOwner(T.default.getId()), [e]), R = (0, o.q)("DeleteChannelConfirm"), B = (0, l.e7)([y.Z], () => y.Z.can(e.isThread() ? f.Plq.MANAGE_THREADS : f.Plq.MANAGE_CHANNELS, e), [e]), P = (0, l.e7)([E.Z], () => {
    var t;
    return null != (t = E.Z.getCount(e.id)) ? t : 0
  }, [e.id]), w = v && (B || N && P < 1), H = G.length > 0 && (e.type === f.d4z.GUILD_VOICE || e.type === f.d4z.GUILD_STAGE_VOICE);
  if (r.useEffect(() => {
      (async () => {
  ...
  if (null != z) {
    ...
    switch (z) {
      case u.j.DEFAULT:
        t = O.intl.format(O.t.iWlB6u, {
          onClick: e
        });
        break;
      case u.j.TODO:
        t = O.intl.format(O.t["/rjozM"], {
          onClick: e
        });
        break;
      case u.j.RESOURCE:
        t = O.intl.format(O.t.Nf5pt7, {
          onClick: e
        });
        break;
      case u.j.RULES:
  ...
  let {
    ...
    deleteBody: O.intl.format(O.t.a6Gz9P, {
      channelName: L
    })
  } : e.isForumPost() ? {
    deleteText: w ? O.intl.string(O.t.nEOg1N) : O.intl.string(O.t.xwMqDw),
    deleteBody: w && N && !B ? O.intl.format(O.t["6/pY29"], {
      postName: L
    }) : w ? O.intl.format(O.t.su3voK, {
      postName: L
    }) : O.intl.string(O.t.RUHcys)
  } : e.isThread() ? {
  ...
  return R ? (0, i.jsx)(a.u, {
    ...
    children: H ? (0, i.jsx)(d.Text, {
      variant: "text-md/normal",
      color: "header-secondary",
      children: O.intl.format(O.t.Ze005O, {
        count: G.length
      })
    }) : null
  }) : (0, i.jsxs)(d.Y0X, {
