...
function N(e, t) {
  ...
  return I({
    pathname: null != o && null != s ? v.Z5c.CHANNEL(s, o, e) : v.Z5c.APPLICATION_STORE_LISTING_SKU(e, a)
  }, l)
}
...
function A(e, t, n, r) {
  ...
  let s = "string" == typeof t ? t : t.id,
    l = i = "https:";
  return a = null != o ? "".concat(l, "//").concat(o, "/app-assets/").concat(e, "/store/").concat(s, ".").concat(r) : "".concat(l).concat(window.GLOBAL_ENV.API_ENDPOINT).concat(v.ANM.STORE_ASSET(e, s, r)), null != n && (a += "?size=".concat((0, f.oO)(n * (0, f.x_)()))), a
}
...
function k(e, t, n) {
  ...
  let a = [];
  (0, E.yE)(r.flags, v.l4R.HAS_FREE_PREMIUM_CONTENT) && a.push({
    type: v.AzA.HAS_FREE_PREMIUM_CONTENT
  });
  let s = r.releaseDate;
  return null != s && o()().diff(s, "months") < T && (r.accessType === v.kGb.EARLY_ACCESS ? a.push({
