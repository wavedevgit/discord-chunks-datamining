...
function Z(e) {
  ...
  return (0, g.Nj)(l.z.CUSTOM_THEME_COACHMARK) ? n ? (0, r.jsx)(H, {
    markAsDismissed: t
  }) : (0, r.jsx)(F, {}) : (0, r.jsx)(H, {
...
function K(e) {
  ...
  return (0, r.jsx)(u.ua7, {
    ...
    children: e => (0, r.jsxs)(c.zx, G(j({}, e), {
      ...
      onClick: n,
      children: [(0, r.jsx)(u.T$Z, {
        size: "sm"
      }), "with-text" === t && x.intl.string(L.default.c9MBEB)]
    }))
  })
}
...
function q(e) {
  ...
  return (0, N.hf)(i, p.Z.CUSTOM_THEMES_EDITOR_COACHMARK), (0, r.jsxs)("div", {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(K, {
      ...
      children: [(0, r.jsx)(c.zx, {
        ...
        textOptions: {
          textOverride: x.intl.string(x.t.pj0XBA)
        }
      })]
    })]
  })
...
function Q(e) {
  ...
  let {
    ...
    markAsDismissed: a,
    isCoachmark: o
  } = e, f = A.M.useExperiment({
    location: "ClientThemeColorPickerTools"
  }).enabled, E = (0, S.jJ)(), b = i.useRef(!1), {
    colors: y,
    chassisMixAmount: T,
    gradientAngle: P,
    setColors: D,
    ...
    setGradientAngle: M
  } = (0, I.Ig)(), [j, U] = i.useState(null != (t = y[0]) ? t : I.Dp), G = (0, s.e7)([v.Z], () => v.Z.theme), B = (0, g.Nj)(l.z.CUSTOM_THEME_ENTRYPOINT_GRADIENT), {
    analyticsLocations: V
  } = (0, h.ZP)(p.Z.CUSTOM_THEMES_EDITOR), F = async () => {
    b.current = !0, await (0, d.ZI)({
      theme: G,
    ...
    }), (0, N.u7)(y, T, P, G, V), null == a || a(w.L.TAKE_ACTION), B || (0, g.Q3)(l.z.CUSTOM_THEME_ENTRYPOINT_GRADIENT), (0, m.Ll)(), (0, O.UD)()
  }, H = () => {
      ...
      children: [(0, r.jsx)(u.Ttm, {
        children: (0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(Z, {
            ...
            size: c.zx.Sizes.MEDIUM,
            onClick: H,
            children: [(0, r.jsx)(u.Oe7, {
              size: "xs"
            }), x.intl.string(x.t.yBZMsb)]
          })]
        })
      }), o ? (0, r.jsx)(q, {
        onSaveTheme: F,
