...
function G(e) {
  ...
  return (0, p.wE)(l.z.CUSTOM_THEME_COACHMARK) ? n ? (0, r.jsx)(B, {
    markAsDismissed: t
  }) : (0, r.jsx)(U, {}) : (0, r.jsx)(B, {
    markAsDismissed: () => (0, p.EW)(l.z.CUSTOM_THEME_COACHMARK)
  })
}
...
function Z(e) {
  ...
  return (0, r.jsx)(c.ua7, {
    ...
    children: e => (0, r.jsxs)(c.zxk, M(L({}, e), {
      ...
      children: [(0, r.jsx)(c.T$Z, {
        size: "sm"
      }), "with-text" === t && P.intl.string(R.default.c9MBEB)]
    }))
  })
}
...
function W(e) {
  ...
  return (0, I.hf)(i, _.Z.CUSTOM_THEMES_EDITOR_COACHMARK), (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(Z, {
      ...
      premiumModalAnalyticsLocation: {
        page: A.ZY5.PREMIUM_UPSELL_CUSTOM_THEMES
      },
      textOptions: {
...
function z(e) {
  ...
  let {
    ...
    setGradientAngle: O
  } = (0, y.I)(), [A, C] = i.useState(null != (t = _[0]) ? t : "#4394D4"), R = (0, s.e7)([E.Z], () => E.Z.theme), D = (0, p.wE)(l.z.CUSTOM_THEME_ENTRYPOINT_GRADIENT), L = () => {
    (0, u.ZI)({
      theme: R,
    ...
    }), null == a || a(N.L.TAKE_ACTION), D || (0, p.EW)(l.z.CUSTOM_THEME_ENTRYPOINT_GRADIENT), (0, f.Ll)()
  }, x = () => {
    Y(), (0, I.uf)()
  }, M = _.length > 0;
  return (i.useEffect(() => Y, []), d) ? (0, r.jsx)("div", {
