...
function et(e) {
  ...
  let {
    ...
    setGradientAngle: C
  } = (0, N.Ig)(), [x, M] = i.useState(null != (t = f[0]) ? t : N.Dp), j = (0, s.e7)([A.Z], () => A.Z.theme), B = (0, O.Nj)(l.z.CUSTOM_THEME_ENTRYPOINT_GRADIENT), {
    ...
    }), (0, w.u7)(f, m, v, j, V), null == a || a(k.L.TAKE_ACTION), B || (0, O.Q3)(l.z.CUSTOM_THEME_ENTRYPOINT_GRADIENT), (0, y.Ll)(), (0, S.UD)()
  }, Z = () => {
