...
function B(e) {
  ...
  return (0, h.wE)(l.z.CUSTOM_THEME_COACHMARK) ? n ? (0, r.jsx)(V, {
    markAsDismissed: t
  }) : (0, r.jsx)(G, {}) : (0, r.jsx)(V, {
    markAsDismissed: () => (0, h.EW)(l.z.CUSTOM_THEME_COACHMARK)
  })
}
  ...
  return (0, r.jsx)(c.ua7, {
    ...
    children: e => (0, r.jsxs)(c.zxk, k(x({}, e), {
      ...
      children: [(0, r.jsx)(c.T$Z, {
        size: "sm"
      }), "with-text" === t && w.intl.string(P.default.c9MBEB)]
    }))
  })
}
...
function q(e) {
  ...
  let {
    ...
    gradientAngle: E,
    setColors: y,
    setChassisMixAmount: v,
    setGradientAngle: N
  } = (0, O.I)(), [R, P] = i.useState(null != (t = m[0]) ? t : "#4394D4"), L = (0, s.e7)([b.Z], () => b.Z.theme), x = (0, h.wE)(l.z.CUSTOM_THEME_ENTRYPOINT_GRADIENT), {
    analyticsLocations: M
  } = (0, f.ZP)(_.Z.CUSTOM_THEMES_EDITOR), k = () => {
    (0, u.ZI)({
      theme: L,
    ...
    }), (0, T.u7)(m, g, E, L, M), null == a || a(C.L.TAKE_ACTION), x || (0, h.EW)(l.z.CUSTOM_THEME_ENTRYPOINT_GRADIENT), (0, p.Ll)()
  }, j = () => {
    W(), (0, T.uf)()
  }, U = m.length > 0;
  return (i.useEffect(() => W, []), d) ? (0, r.jsx)("div", {
