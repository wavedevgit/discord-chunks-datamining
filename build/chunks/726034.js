...
function O(e) {
  ...
  return (0, r.jsxs)(o.zxk, {
    ...
    children: [(0, r.jsx)(o.T$Z, {
      size: "sm"
    }), "with-text" === t && m.intl.string(m.t["WZ+NyM"])]
  })
}
...
function I(e) {
  ...
  let {
    ...
    setGradientAngle: A
  } = (0, d.I)(), [N, C] = i.useState(null != (t = c[0]) ? t : "#4394D4"), [P] = (0, a.Wu)([u.Z], () => [u.Z.theme]), R = () => {
    (0, s.ZI)({
      theme: P,
  ...
  return l ? (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)(o.Ttm, {
      ...
      children: [(0, r.jsx)(E, {}), (0, r.jsx)(p.o, {}), (0, r.jsx)(_.U, {
        onChange: e => {
          C(e), 0 === c.length && S([e])
        },
        value: N,
