...
function F(e) {
  ...
  return (0, m.wE)(l.z.CUSTOM_THEME_COACHMARK) ? n ? (0, r.jsx)(Z, {
    markAsDismissed: t
  }) : (0, r.jsx)(V, {}) : (0, r.jsx)(Z, {
  ...
  return (0, r.jsx)(c.ua7, {
    ...
    children: e => (0, r.jsxs)(c.zxk, U(M({}, e), {
      ...
      children: [(0, r.jsx)(c.T$Z, {
        size: "sm"
      }), "with-text" === t && L.intl.string(D.default.c9MBEB)]
    }))
  })
}
...
function z(e) {
  let {
    onSaveTheme: t,
    canApply: n
  } = e, i = (0, b.m)(w.p9.TIER_2);
  return (0, A.hf)(i, _.Z.CUSTOM_THEMES_EDITOR_COACHMARK), (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(W, {
      ...
      textOptions: {
        subscribeText: L.intl.string(L.t.JST6jo)
      },
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(W, {
      ...
      children: [(0, r.jsx)(c.zxk, {
        ...
        textOptions: {
          textOverride: L.intl.string(L.t.pj0XBA)
        }
      })]
    })]
  })
...
function X(e) {
  ...
  let {
    ...
    markAsDismissed: a,
    isCoachmark: o
  } = e, d = S.M.useExperiment({
    location: "ClientThemeColorPickerTools"
  }).enabled, g = (0, T.jJ)(), E = i.useRef(!1), {
    colors: b,
    chassisMixAmount: I,
    gradientAngle: R,
    setColors: w,
    ...
    setGradientAngle: k
  } = (0, v.Ig)(), [M, j] = i.useState(null != (t = b[0]) ? t : v.Dp), U = (0, s.e7)([O.Z], () => O.Z.theme), G = (0, m.wE)(l.z.CUSTOM_THEME_ENTRYPOINT_GRADIENT), {
    ...
    }), (0, A.u7)(b, I, R, U, B), null == a || a(P.L.TAKE_ACTION), G || (0, m.EW)(l.z.CUSTOM_THEME_ENTRYPOINT_GRADIENT), (0, h.Ll)(), (0, y.UD)()
  }, Z = () => {
