...
let R = () => {
    ...
    return (0, r.jsx)(m.Z, {
      ...
      textOptions: {
        textOverride: i ? N.intl.string(N.t.IJI7ys) : o ? (0, y.Rt)({
  ...
  w = e => {
    let {
      isCoachmark: t,
      markAsDismissed: n
    } = e, i = (0, s.e7)([v.Z], () => v.Z.isUpsellPreview), a = () => {
...
function D(e) {
  ...
  } = (0, _.ZP)(f.Z.APP_ICON_EDITOR), c = (0, s.e7)([E.default], () => E.default.getCurrentUser()), {
    isUpsellPreview: h,
  ...
  i.useEffect(() => {
    h && b.default.track(S.rMx.PREMIUM_UPSELL_VIEWED, {
