...
let P = () => {
    ...
    return (0, r.jsx)(g.Z, {
      ...
      textOptions: {
        textOverride: i ? C.intl.string(C.t.IJI7ys) : o ? (0, O.Rt)({
  ...
  D = e => {
    let {
      isCoachmark: t,
      markAsDismissed: n
    } = e, i = (0, s.e7)([I.Z], () => I.Z.isUpsellPreview), a = () => {
      null == n || n(A.L.DISMISS), (0, h.Ll)(), (0, v.O)(), t || u.Z.open()
    };
    return (0, r.jsxs)("div", {
      className: R.editorFooter,
      children: [i && (0, r.jsx)(P, {}), (0, r.jsx)(l.zx, {
...
function L(e) {
  ...
  } = (0, p.ZP)(_.Z.APP_ICON_EDITOR), l = (0, s.e7)([b.default], () => b.default.getCurrentUser()), {
    isUpsellPreview: u,
  ...
  i.useEffect(() => {
    u && y.default.track(S.rMx.PREMIUM_UPSELL_VIEWED, {
