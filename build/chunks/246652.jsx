...
class l extends Chunk73800.PureComponent {
  ...
  render() {
    return null != this.state.error ? <div><Chunk481060.Text color={"text-danger"} variant={"text-md/normal"} className={Chunk517791.labelSpacing}>{"Error rendering component. Check console for more information on the error."}</Chunk481060.Text></div> : this.props.children
  }
  constructor(...e) {
    var t, n;
    super(...e), n = {
