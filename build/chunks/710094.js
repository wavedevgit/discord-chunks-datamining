...
function x(e) {
  ...
  let eA = null != (n = null != M ? M : F) ? n : null,
    ...
    eR = (0, u.Ng)(),
    eP = {
      user_trial_offer_id: null == eC ? void 0 : eC.id
    };
  i.useEffect(() => {
    null != $ && null != eI.current && eI.current.scrollIntoView({
      behavior: "smooth"
    })
  }, [$]);
  let ew = i.useCallback((e, t) => {
      K(e), null != t && ef(t), x(E.h8.CONFIRM, {
        fulfillment: {
          subscription: e,
          entitlements: t
        }
  ...
  return e_ === P.GZ.ONE_TIME ? (eK = null != ee, a = (0, r.jsx)(T.Z, {
  ...
  })) : (eK = eE ? null == eh : null != eD && e_ === P.GZ.SUBSCRIPTION && ej && !eD.canRedeemTrial(), null == W || em || eE ? (o()(null != en, "Expected plan to be selected"), a = (0, r.jsx)(_.Z, {
    ...
    isDiscount: eG,
    handleClose: Y
  })) : (o()(null != en, "Expected plan to be selected"), a = (0, r.jsx)(f.Z, {
    ...
    children: [(0, r.jsx)(y.P, {
      ...
      }), null != ev && ev, (0, r.jsx)(v.Z, {}), (0, r.jsx)(O.Z, {}), a]
    }), (0, r.jsx)(C.O3, {
