...
function N(e) {
  let {
    ...
    onMouseEnter: f,
    onMouseLeave: m
  } = p, g = "en-US" === h.NW.currentLocale || "en-GB" === h.NW.currentLocale, b = null != u ? u : s.substring(0, 6).toUpperCase(), x = h.NW.formatToPlainString(h.t["tmJ75+"], {
    orderNumber: n,
    description: b
  }), v = g ? h.NW.formatToPlainString(h.t.pBzwhY, {
    orderNumber: n,
    description: b
  ...
  return (0, r.jsxs)("div", {
    ...
    }), a && null != i && (0, r.jsx)(c.ua7, {
      text: h.NW.string(h.t.N86XcH),
      delay: 340,
      children: e => {
        var t, n;
        return (0, r.jsx)(c.P3F, (t = O({}, e), n = n = {
          onClick: e => i(e, o, s, b),
...
function C(e) {
  let {
    ...
    numberOfLockedAvatarSlots: P
  } = (0, p.pC)(t), [S, w] = a.useState(null), T = null != S ? S : null == C ? void 0 : C.message, F = j.length > E ? j.slice(0, E) : j, R = F.length, _ = Math.max(E - R, 0), Z = (0, c.vRw)(), L = a.useCallback(async e => {
    if (null == d) return;
    w(null);
    let {
      id: t,
  ...
  }, [Z, s, l, d]), D = a.useCallback((e, t, a, l) => {
...
function E(e) {
  let {
    ...
    onComplete: n,
    onClose: a
  } = e, l = (0, o.e7)([u.default], () => u.default.getCurrentUser()), s = d.ZP.canUseIncreasedRecentAvatarsLimit(l), {
    recentAvatarsLimit: f
  } = (0, p.pC)(s);
  return (0, r.jsxs)("div", {
