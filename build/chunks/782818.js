...
function C(e) {
  let {
    ...
    id: s,
    storageHash: o,
    description: u = h.intl.string(h.t.lqaIxM)
  } = t, {
    avatarSrc: f,
    eventHandlers: d
  } = (0, b.Z)({
    ...
    onMouseEnter: p,
    onMouseLeave: m
  } = d, g = null != u ? u : o.substring(0, 6).toUpperCase(), j = h.intl.formatToPlainString(h.t["tmJ75+"], {
    orderNumber: n + 1,
    description: g
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(c.zxk, O(x({
      ...
      delay: 340,
      children: e => (0, r.jsx)(c.zxk, O(x(O(x({}, e), {
        "aria-label": v,
...
function A(e) {
  ...
  return (0, r.jsxs)(c.P3F, {
    ...
    onClick: v,
    "aria-label": h.intl.formatToPlainString(h.t.D4829v, {
      numberOfLockedAvatarSlots: t
    }),
...
function E(e) {
  let {
    ...
    onComplete: a
  } = e, o = (0, s.e7)([u.default], () => u.default.getCurrentUser()), {
    avatars: b,
    loading: O,
    error: v
  } = (0, p.S)(), {
  ...
  } = (0, f.pC)(t), P = l.useRef([]), S = l.useRef(null), w = l.useRef(b.length), R = l.useRef(null), [T, k] = l.useState(!1), [_, I] = l.useState(!1), [L, F] = l.useState(null), Z = null != L ? L : null == v ? void 0 : v.message, D = b.length > E ? b.slice(0, E) : b, U = D.length, M = Math.max(E - U, 0), B = (0, c.vRw)(), z = l.useCallback(async e => {
    if (null == o || T) return;
    k(!0), F(null);
    let {
      id: t,
  ...
  }, [B, T, a, o]), H = l.useCallback((e, t, l, a, i) => {
    let s = t + 1 < b.length ? t + 1 : t - 1;
    R.current = s >= 0 ? P.current[s] : S.current, e.shiftKey ? (0, d.B)(l) : (I(!0), (0, c.ZDy)(async () => {
      let {
        default: e
  ...
  return (l.useEffect(() => {
    ...
    _ || (b.length < w.current && null != R.current && requestAnimationFrame(() => {
      var e;
      null == (e = R.current) || e.focus()
    }), w.current = b.length)
  }, [b.length, _]), O) ? (0, r.jsx)(c.$jN, {
    className: y.spinner
  }) : (0, r.jsxs)("div", {
    className: y.recentAvatarContainer,
    children: [null != Z && !O && (0, r.jsx)(c.Text, {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      children: [(0, r.jsx)(c.vwX, {
        ...
        children: [h.intl.format(h.t["+CyJu7"], {
          recentAvatarsLimit: a
        }), " ", !l && h.intl.format(h.t.Xs2Otb, {
          onClick: v
        })]
      })]
    }), (0, r.jsx)(E, {
