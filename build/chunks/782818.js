...
function v(e) {
  let {
    ...
    onMouseEnter: f,
    onMouseLeave: m
  } = p, j = "en-US" === x.NW.currentLocale || "en-GB" === x.NW.currentLocale, b = null != u ? u : s.substring(0, 6).toUpperCase(), O = x.NW.formatToPlainString(x.t["tmJ75+"], {
    orderNumber: n,
    description: b
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(c.P3F, {
      ...
      children: e => {
        var t, n;
        return (0, r.jsx)(c.P3F, (t = h({}, e), n = n = {
          onClick: e => i(e, o, s, b),
...
function C(e) {
  ...
  } = (0, d.pC)(t), [P, w] = l.useState(!1), [S, T] = l.useState(null), R = null != S ? S : null == C ? void 0 : C.message, _ = g.length > A ? g.slice(0, A) : g, F = _.length, L = Math.max(A - F, 0), Z = (0, c.vRw)(), D = l.useCallback(async e => {
    if (null == s || P) return;
    w(!0), T(null);
    let {
      id: t,
  ...
  }, [Z, P, a, s]), k = l.useCallback((e, t, l, a) => {
    e.shiftKey ? (0, p.B)(t) : (0, c.ZDy)(async () => {
      let {
        default: e
  ...
  return (l.useEffect(() => {
    ...
    children: [null != R && !O && (0, r.jsx)(c.Text, {
      ...
      children: [F > 0 && (0, r.jsx)("ul", {
        ...
        children: [(0, r.jsx)(c.nn4, {
          children: x.NW.format(x.t["8W2HOz"], {
            numberOfEmptyAvatarSlots: L
          })
        }), [...Array(L)].map((e, t) => (0, r.jsx)(m.Z, {
