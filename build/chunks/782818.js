...
function C(e) {
  let {
    ...
    loading: g,
    error: C
  } = (0, f.S)(), v = a.useRef([]), O = a.useRef(null), E = a.useRef(i.length), N = a.useRef(null), [S, w] = a.useState(!1), [P, T] = a.useState(!1), [R, _] = a.useState(null), F = null != R ? R : null == C ? void 0 : C.message, Z = i.length, D = Math.max(b.iZ - Z, 0), I = (0, o.vRw)(), k = a.useCallback(async e => {
    if (null == l || S) return;
    w(!0), _(null);
    let {
      id: a,
    ...
    N.current = c >= 0 ? v.current[c] : O.current, e.shiftKey ? (0, d.B)(a) : (T(!0), (0, o.ZDy)(async () => {
      let {
        default: e
