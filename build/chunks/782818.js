...
function O(e) {
  let {
    ...
    id: s,
    storageHash: u,
    description: d = y.intl.string(y.t.lqaIxM)
  } = t, {
    avatarSrc: f,
    eventHandlers: p
  } = (0, m.Z)({
    ...
    onMouseEnter: g,
    onMouseLeave: h
  } = p, b = null != d ? d : u.substring(0, 6).toUpperCase(), j = y.intl.formatToPlainString(y.t["tmJ75+"], {
    orderNumber: n + 1,
    description: b
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(o.zx, C(A({
      ...
      delay: 340,
      children: e => (0, r.jsx)(o.zx, C(A(C(A({}, e), {
        "aria-label": O,
...
function v(e) {
  let {
    ...
    loading: o,
    error: m
  } = (0, p.S)(), C = l.useRef([]), v = l.useRef(null), E = l.useRef(i.length), N = l.useRef(null), [S, T] = l.useState(!1), [w, P] = l.useState(!1), [R, _] = l.useState(null), F = null != R ? R : null == m ? void 0 : m.message, Z = i.length, D = Math.max(j.iZ - Z, 0), k = (0, c.vRw)(), I = l.useCallback(async e => {
    if (null == a || S) return;
    T(!0), _(null);
    let {
      id: l,
  ...
  }, [k, S, t, a]), L = l.useCallback((e, t, l, a, s) => {
    let o = t + 1 < i.length ? t + 1 : t - 1;
    N.current = o >= 0 ? C.current[o] : v.current, e.shiftKey ? (0, f.B)(l) : (P(!0), (0, c.ZDy)(async () => {
      let {
        default: e
  ...
  return (l.useEffect(() => {
    ...
    w || (i.length < E.current && null != N.current && requestAnimationFrame(() => {
      var e;
    ...
    children: [null != F && !o && (0, r.jsx)(c.Text, {
      ...
      children: [Z > 0 && (0, r.jsx)("ul", {
        ...
        children: [(0, r.jsxs)(c.nn4, {
          ...
          }), y.intl.format(y.t["8W2HOz"], {
            numberOfEmptyAvatarSlots: D
          })]
        }), [...Array(D)].map((e, t) => (0, r.jsx)(g.Z, {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      children: [(0, r.jsx)(c.vwX, {
        ...
        children: y.intl.format(y.t["+CyJu7"], {
