...
function v(e) {
  let {
    ...
    id: s,
    storageHash: o,
    description: u = h.NW.string(h.t.lqaIxM)
  } = t, {
    avatarSrc: f,
    eventHandlers: d
  } = (0, b.Z)({
    ...
    onMouseEnter: p,
    onMouseLeave: m
  } = d, g = null != u ? u : o.substring(0, 6).toUpperCase(), j = h.NW.formatToPlainString(h.t["tmJ75+"], {
    orderNumber: n + 1,
    description: g
...
function A(e) {
  let {
  ...
  } = (0, f.pC)(t), P = a.useRef([]), S = a.useRef(null), w = a.useRef(b.length), R = a.useRef(null), [T, k] = a.useState(!1), [_, I] = a.useState(!1), [L, F] = a.useState(null), Z = null != L ? L : null == N ? void 0 : N.message, D = b.length > A ? b.slice(0, A) : b, W = D.length, U = Math.max(A - W, 0), M = (0, c.vRw)(), B = a.useCallback(async e => {
    if (null == o || T) return;
    k(!0), F(null);
    let {
      id: t,
    ...
    try {
      ...
      (0, c.ZDy)(async () => {
        let {
          default: t
        } = await Promise.all([n.e("59732"), n.e("77068")]).then(n.bind(n, 712451));
  ...
  }, [M, T, l, o]), z = a.useCallback((e, t, a, l, i) => {
    let s = t + 1 < b.length ? t + 1 : t - 1;
    R.current = s >= 0 ? P.current[s] : S.current, e.shiftKey ? (0, d.B)(a) : (I(!0), (0, c.ZDy)(async () => {
      let {
        default: e
