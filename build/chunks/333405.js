/** Chunk was on web.js **/
/** chunk id: 333405, original params: e,t,n (module,exports,re quire) **/
"use strict";
let r;
...
"u" > typeof window ? r = window : "u" < typeof self ? (console.warn("Using browser-only version of superagent in non-browser environment"), r = true) : r = self;
let Chunk882630 = require("./882630.js"),
  Chunk232859 = require("./232859.js"),
  Chunk591560 = require("./591560.js"),
  Chunk191203 = require("./191203.js"),
  Chunk17101 = require("./17101.js"),
  f = Chunk17101.isObject,
  p = Chunk17101.mixin,
  _ = Chunk17101.hasOwn,
  Chunk531679 = require("./531679.js"),
  Chunk427879 = require("./427879.js");
...
function A(e) {
  let t, n, r, i, a = e.split(/\r?\n/),
    o = {};
  for (let e = 0, s = a.length; e < s; ++e) false !== (t = (n = a[e]).indexOf(":")) && (r = n.slice(0, t).toLowerCase(), i = y(n.slice(t + 1)), o[r] = i);
  return o
}
...
for (var C = 0, N = ["GET", "POST", "OPTIONS", "PATCH", "PUT", "DELETE"]; C < N.length; C++) {
  let e = N[C];
  Chunk427879.prototype[module.toLowerCase()] = function(t, n) {
...
Chunk427879.prototype.del = Chunk427879.prototype.delete, E.get = (e, t, n) => {
  let r = E("GET", e);
