...
function E(e) {
  ...
  if (null == y && null != n && (0, s.Z)(n)) return <u.tG icon={v} text={_.intl.string(_.t.RscU7O)} size={E === f.lY.MODAL_V2 ? i.Ph.TINY : i.Ph.SMALL} fullWidth={E !== f.lY.MODAL_V2} themeColor={"secondary"} onClick={e => {
  ...
  return C ? <o.ua7 text={A}>{e => (0, r.jsx)(u.tG, g(h({}, e), {
      icon: o.YVR,
      text: S,
      disabled: !N,
      submitting: I,
    ...
    }))}</o.ua7> : <o.ua7 text={A}>{e => (0, r.jsx)(u.tG, g(h({}, e), {
      icon: o.iWm,
      text: S,
      disabled: !N,
      submitting: I,
