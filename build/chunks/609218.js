...
function G(e) {
  let {
    ...
    description: U,
    enableSocialProof: G,
    analyticsLocationSection: B,
    upsellViewedTrackingData: V,
    onClose: F,
    onDisplay: Z,
    onLearnMore: H,
    isEmojiPickerOverlay: Y = !1
  } = e, W = (0, s.e7)([O.Z], () => O.Z.affinities), K = (0, s.e7)([O.Z], () => O.Z.hasFetched);
  i.useEffect(() => {
    !K && G && p.MH()
  }, [K, G]), i.useEffect(() => {
  ...
  let z = W.length > 1 && G,
    ...
    X = () => {
      ...
      }), null == H || H(), (0, m.Z)(), F(), (0, h.xf)(), (0, g.uL)(R.Z5c.APPLICATION_STORE)
    },
    Q = (0, I.N)(),
    J = i.useCallback(() => {
      var e;
