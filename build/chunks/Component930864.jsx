...
function A(e) {
  ...
  let eC = a.useMemo(() => (0, r.throttle)(() => {
    ...
    eO = a.useCallback(async function(e) {
      var a;
      let {
        withMessage: r,
      ...
      s && (0, T.mc)(), null == k || k(), i && (await d.Z.fetchMessages({
        channelId: c[0]
      }), (0, m.Kh)(c[0], {
        openTextInVoiceIfVoiceChannel: true
      }));
      let h = await x.Z.sendForwards(u, c, I(M({}, N), {
          withMessage: r
        })),
        f = c.some(e => {
