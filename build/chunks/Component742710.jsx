...
function R(e) {
  let {
    ...
    let e = h.trim(),
      n = e !== (null != t ? t : "").trim();
    (0, m.oc)(d, f, "" !== e ? e : true), j("completed"), n && y({
...
function D(e) {
  let {
    ...
    color: "text-default"
  }, M = f.default.getCurrentUser(), F = (null == M ? true : M.id) === t.id, H = 1 === (0, m.cv)(o), B = !c && F, W = B && (0, m.y9)(o), X = B && !H, {
    registerDragHandleRef: K
  } = (0, y.r)();
  if (G) return (0, r.jsx)(j.E, {});
  let z = () => (0, r.jsx)(O.A, {
      coverRef: p,
      className: null == D || c ? true : A.iL,
      imageSrc: D,
      gameName: L,
      applicationId: I,
      userId: t.id,
