...
let f = () => {
  ...
  let v = async () => {
    ...
    text: "".concat(g.intl.format(g.t.yxFzdH, {
      planPremiumType: c.ZP.getDisplayPremiumType("".concat(t))
    })),
    onClick: v,
    disabled: j,
  ...
  let {
    intervalType: T,
    intervalCount: I
  } = b, N = (0, d.og)("".concat(x), T, I);
  return (0, i.jsxs)(o.Modal, {
    size: "md",
    transitionState: e,
    title: "".concat(g.intl.format(g.t.LZunzc, {
      planPremiumType: c.ZP.getDisplayPremiumType("".concat(t))
    })),
    subtitle: 0 !== n.total ? g.intl.format(g.t.ycyeBw, {
      renewalDate: n.subscriptionPeriodStart,
      rate: (0, d.og)((0, d.T4)(n.total, n.currency), T, I)
    }) : g.intl.format(g.t["+y0Tj4"], {
      renewalDate: n.subscriptionPeriodStart
    }),
    actions: S,
    onClose: async () => s(),
    children: [(0, i.jsxs)(u.aO, {
      ...
      children: [(0, i.jsx)(u.Z9, {
        ...
        label: g.intl.formatToPlainString(g.t.r3jVZm, {
          planName: c.ZP.getDisplayName("".concat(t))
        }),
        value: "".concat(N),
        className: h.canceled
      }), (0, i.jsx)(u.UN, {}), (0, i.jsx)(m.nd, {
        premiumSubscription: _,
        renewalInvoice: n,
        isUpdate: !0
      })]
