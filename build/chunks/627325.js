...
function S(e) {
  let {
    ...
    query: a
  } = e, o = j(), S = (0, s.e7)([f.default], () => (0, p.I5)(f.default.getCurrentUser())), x = E(a, S), P = Math.ceil(x.length / t), {
  ...
  return a && 0 === x.length ? (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(u.aNP, {
      ...
      color: "header-muted",
      children: _.intl.format(_.t["5afO9f"], {
        onClick: C ? h.wV : h.r5
      })
    })]
...
let j = () => (0, s.e7)([g.Z], () => {
  ...
  x = (e, t) => {
    ...
    return "" === n ? e : e.filter(e => {
      let {
        name: t
      } = e, r = (0, o._I)(_.intl.string(t)).toLowerCase();
      return a()(n, r)
    })
  },
  E = (e, t) => (0, s.Wu)([g.Z], () => {
