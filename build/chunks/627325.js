...
function x(e) {
  let {
    ...
    query: o
  } = e, s = P(), c = (0, u.e7)([m.default], () => (0, g.I5)(m.default.getCurrentUser())), x = E(o, c), C = Math.ceil(x.length / t), {
  ...
  return o && 0 === x.length ? (0, r.jsxs)("div", {
    ...
    renderSectionHeader: !1 === l ? void 0 : e => (0, r.jsx)(f.Text, {
...
let P = () => (0, u.e7)([b.Z], () => {
  ...
  C = (e, t) => {
    ...
    return "" === n ? e : e.filter(e => {
      let {
        name: t
      } = e, r = (0, c._I)(y.intl.string(t)).toLowerCase();
      return s()(n, r)
    })
  },
  E = (e, t) => (0, u.Wu)([b.Z], () => {
