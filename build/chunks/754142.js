...
function w(e, t, n) {
  var r, i, o, a;
  return e ? null != (i = null == (r = I(t)) ? true : r.frameRateEncode) ? i : null : null != (a = null == (o = T(t, n)) ? true : o.frameRateDecode) ? a : null
}
...
function D(e, t) {
  ...
  x = null != k && null != X ? es ? null == $ || null == (c = $.getOutboundStats()) ? true : c.find(e => e.quality === S.y7) : null == $ ? true : $.getInboundStats(X.ownerId) : es ? null != (D = i().maxBy(null != (m = null == $ ? true : $.getOutboundStats()) ? m : [], e => e.num_frames)) ? D : null : null != ec ? null == $ ? true : $.getInboundStats(ec) : null, (0, g.q)().then(t => {
    ...
    let eH = {
      ...
      duration: null != (eh = null == $ ? true : $.getDurationSeconds()) ? eh : null,
      ...
      video_codec: null != (eO = null != V ? V : (0, o.bU)(null == (s = C(es, ed, ec)) ? true : s.codec.name)) ? eO : null,
      video_encoder: null != (ev = null != H ? H : (0, o.lG)(null == (l = I(ed)) ? true : l.encoderImplementationName)) ? ev : null,
      video_decoder: null != (eS = null != Y ? Y : (0, o.z_)(null == (c = T(ed, ec)) ? true : c.decoderImplementationName)) ? eS : null,
      ...
      video_device_name: null != q ? q : null == (R = f.Z.getVideoDevices()[f.Z.getVideoDeviceId()]) ? true : R.name,
