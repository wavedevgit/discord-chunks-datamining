...
var Chunk266454 = require("./266454.js"),
  ...
  Chunk708383 = require("./708383.js"),
  Chunk923532 = require("./923532.js"),
  Chunk107200 = require("./107200.jsx"),
  Chunk983660 = require("./983660.js"),
  Chunk987650 = require("./987650.js"),
  Chunk757744 = require("./757744.js"),
  Chunk981631 = require("./981631.js"),
  Chunk388032 = require("./388032.jsx"),
  Chunk411961 = require("./411961.js");
...
let eE = e => {
    ...
    return <l className={s()(ey.overlayBackground, {
        [ey.overlayActive]: !o,
        [ey.overlayLocked]: o,
        [ey.previewMode]: !o && i
      })} onMouseDown={e => {
      ...
      }} onContextMenu={eb}>{o ? null : (0, r.jsx)("div", {
...
class ex extends Chunk73800.Component {
  handleLock() {
  ...
  initialSetup() {
    ...
    let d = require && !i && null != Chunk120356,
      u = module && null != Chunk255367 && null != Chunk73800,
    ...
    if (c ? p = {
        ...
        game: Chunk120356,
        voiceChannelId: Chunk73800,
        voiceGuild: Chunk255367
      } : Chunk954955 && (p = {
  ...
  renderInvalidSizeMessage() {
    return <Chunk600164.Z justify={Chunk600164.Z.Justify.CENTER} align={Chunk600164.Z.Align.CENTER} className={Chunk411961.invalidContainer}><div className={Chunk411961.inactiveContainer}>{Chunk388032.intl.format(Chunk388032.t.ketnW1, Chunk145597.OVERLAY_MIN_RESOLUTION)}</div></Chunk600164.Z>
  }
  render() {
    let {
      locked: e,
    ...
    if (0 === p || 0 === Chunk442837 || require || !Chunk73800) return null;
    let g = module || Chunk120356,
      m = Chunk314897.default.getId();
    return <div className={Chunk411961.overlay}>{<Chunk708383.Z />}{Chunk120356 && <header className={Chunk411961.previewingInGameHeader}>{Chunk388032.intl.string(Chunk388032.t.iOq96u)}</header>}{i}{(!module || Chunk921738.has(Chunk981631.O0n.TEXT_WIDGET)) && <eE locked={module} keybind={exports} onClick={module ? this.handleDeactivate : this.handleLock} isPreviewingInGame={Chunk120356} />}{(0, Chunk145597.validResolution)(c) ? <Chunk312178.Z className={s()({
          [Chunk411961.layoutLocked]: module,
          [Chunk411961.layoutUnlocked]: !module
        })} /> : module ? null : this.renderInvalidSizeMessage()}{<Chunk107200.Z />}{null != Chunk954955 && null != u && <Chunk923532.Z streamerId={Chunk481060} guildId={Chunk954955.id} channelId={u} />}{Chunk498607 && <Chunk983660.Z locked={module} />}{<Chunk348733.Z locked={Chunk704215} keybind={exports} />}{<Chunk681603.Z />}</div>
  }
  constructor(e) {
...
function eC() {
  ...
  return <Chunk906732.Gt value={Chunk239091}><ex locked={require} initialized={i} incompatibleApp={Chunk73800} activeRegions={Chunk120356} isPreviewingInGame={s} windowSize={c} keybind={null != Chunk954955 ? (0, Chunk13140.BB)(Chunk954955.shortcut, true) : "???"} keybindKeyCodes={null != Chunk954955 ? Chunk954955.shortcut : []} connectedToVoice={null != u} voiceChannelId={null != Chunk498607 ? Chunk498607.id : null} voiceGuild={p} game={Chunk704215} canGoLive={Chunk481060} isStreaming={Chunk668781} showKeybindNotification={Chunk13245} dismissKeybindNotification={Chunk425493} isOOPOverlayAvailable={(!Chunk266454 || Chunk185666 && Chunk714338 && Chunk951483 && !Chunk600164) && !Chunk377400} /></Chunk906732.Gt>
}