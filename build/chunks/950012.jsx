...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk994640 = require("./994640.js"),
  Chunk247007 = require("./247007.jsx"),
  Chunk999464 = require("./999464.js"),
...
let u = e => {
  ...
  switch (h[h.length - 1]) {
    case d.tF.VERIFY_EMAIL:
      return <i.Z setGuildsInfo={S} setStep={y} email={x} setEmail={p} setGuildId={N} invite={n} onClose={t} isNUXFlow={m} />;
    case d.tF.SELECT_SCHOOL:
      return <a.Z guildsInfo={E} setStep={y} email={x} setGuildId={N} forceGuildScrollHeight={u} />;
    case d.tF.SUBMIT_SCHOOL:
      return <s.Z onBack={() => {
          h.length > 1 && f(h.slice(0, false).slice(false))
        }} setStep={y} email={x} school={g} setSchool={_} />;
    case d.tF.VERIFY_PIN:
      return <o.Z email={x} onClose={t} guildId={v} />;
    case d.tF.EMAIL_WAITLIST:
      return <c.Z setStep={y} school={g} />;
    default:
      return null
  }
}