...
function ex() {
  ...
  return (Chunk73800.useEffect(() => {
    ...
    ref: module,
    className: Chunk736967.container,
    style: {
    ...
    children: [(0, Chunk255367.jsx)(ed, {
      ...
      className: Chunk736967.sidebarContent,
...
function eh() {
  return (0, Chunk442837.e7)([Chunk19759.Z], () => Chunk19759.Z.displayTools) ? (0, Chunk255367.jsx)("div", {
    className: i()(Chunk736967.container, Chunk736967.mobileContainerExpanded),
    ...
    children: (0, Chunk255367.jsx)(Chunk481060.P3F, {
      ...
      children: (0, Chunk255367.jsxs)(Chunk665149.ZP, {
        className: i()(Chunk616257.headerBar, Chunk736967.mobileHeaderCollapsed),
