...
let j = {
  ...
  PlayStationModal: async () => {
    let {
      ...
      t.default.getDevicesForPlatform = e => e === p.ABu.PLAYSTATION ? i : r.call(t.default, e), t.default.getFetchingDevices = e => e !== p.ABu.PLAYSTATION && s.call(t.default, e), t.default.getLastSelectedDeviceByPlatform = e => e === p.ABu.PLAYSTATION ? "device-1" : o.call(t.default, e), t.default.getAwaitingRemoteSessionInfo = () => null;
      let d = n.onClose;
  ...
  FamilyCenterQRCodeModal: async () => {
    let {
      default: e
    } = await Promise.all([require.e("75942"), require.e("90688")]).then(require.bind(require, 978305));
    return t => (0, a.jsx)(e, b({}, t))
  },
