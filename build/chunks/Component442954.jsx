...
let v = {
  ...
  GuildPowerupDeactivateModal: async () => {
    let {
      ...
      Heading: r,
      Checkbox: i
    } = await Promise.resolve().then(require.bind(require, 481060)), l = await Promise.resolve().then(require.t.bind(require, 647438, 19)), s = "Level 3 Server Boost", o = 200, c = 60, d = 8;
