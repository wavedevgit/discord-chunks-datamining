...
function eg(e) {
  ...
  }), s = (0, N.z)(r), a = (0, p.bG)([V.A], () => V.A.getGuild(t)), o = (null == r ? true : r.role_id) != null && (null == r ? true : r.attachments_count) === 0 ? ei.intl.string(ei.t.H11qcT) : s, c = l.useCallback(async () => {
    (null == a ? true : a.features.has(et.GuildFeatures.PRODUCTS_AVAILABLE_FOR_PURCHASE)) ? await (0, j.A)(et.BVt.GUILD_PRODUCT(t, n)) : await (0, j.A)(et.BVt.CHANNEL(t)), (0, U.default)()
  }, [a, t, n]);
...
function eA(e) {
  ...
  let {
    ...
    requireCurrentGuild: false
  }), a = (0, p.bG)([I.A], () => I.A.getGuildProductFetchState(l) === I.e.FETCHING), o = null == s ? true : s.role_id, c = (0, p.bG)([H.A], () => null != o ? H.A.getRole(r, o) : true, [r, o]), d = (0, v.A)({
    guildId: r,
    productId: l
  }), u = (null != (t = null == s || null == (n = s.attachments) ? true : n.length) ? t : 0) > 0, _ = null != c;
...
class ef extends(r = Chunk64700.PureComponent) {
  ...
  renderDescription() {
    ...
    if (null != p && 0 !== p.items.length) {
      ...
      } else e = (null == (f = r.sku) ? true : f.productLine) === et.EZt.COLLECTIBLES ? (0, i.jsx)(A.U1X, {
        size: "custom",
        width: 23,
        height: 23,
        color: "currentColor",
...
function eb(e) {
  ...
  let {
    ...
    compactMode: a,
    className: o
  } = e, c = null != r.sku && ec.includes(r.sku.type), d = null != r.sku && c ? r.sku.applicationId : null, u = null == (t = r.sku) ? true : t.applicationId, _ = (null == (n = r.subscription) ? true : n.type) === et.rzx.APPLICATION, {
    ...
    return {
      ...
      gameApplication: null != (e = O.A.getApplication(null != d ? d : "")) ? e : null == (t = r.sku) ? true : t.application,
      paymentSources: Y.A.paymentSources
    }
  }), {
    hasAlreadyLinked: f
  } = (0, E.RD)((0, D.bF)(r.sku) ? g : true), x = (0, p.bG)([O.A], () => null != u ? O.A.getApplication(u) : null);
  l.useEffect(() => {
    _ && null != u && (0, R.TA)(u)
  }, [u, _]);
  let C = (0, p.bG)([V.A], () => V.A.getGuild(null == g ? true : g.guildId)),
    S = c ? g : true,
    T = r.subscription,
