...
function m() {
  let e = (0, Chunk101966.Z)({
    ...
    n = (0, Chunk40347.Z)();
  return module && exports && null != require ? <p levelUpData={require} /> : null
}
...
function p(e) {
  ...
  return r.useEffect(() => l, [l]), <s.EqS containerRef={n}><div className={d.wrapper}>{<s.M0o className={d.closeButton} tooltip={c.intl.string(c.t.cpT0Cg)} color={s.YX$.SECONDARY} size={s.tT7.SIZE_24} icon={(0, i.jsx)(s.Dio, {
          size: "xs",
          color: "currentColor"
        })} onClick={l} />}{<r.Suspense fallback={null}><u levelUpData={t} /></r.Suspense>}</div></s.EqS>
}