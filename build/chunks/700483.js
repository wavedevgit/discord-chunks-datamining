...
function ep(e) {
  ...
  } = (0, O.XJ)(t), f = (0, a.e7)([X.Z], () => X.Z.getStageInstanceByChannel(t.id), [t.id]), m = (0, a.e7)([C.ZP], () => C.ZP.getGuildScheduledEvent(null == f ? void 0 : f.guild_scheduled_event_id)), g = (0, a.e7)([F.Z], () => F.Z.getVoiceChannelId() === t.id, [t.id]), {
    suppress: x
  } = (0, N.Z)(t), y = U.default.getId(), [v] = (0, ei.Z)(t), j = K.ZP.isModerator(y, t.id), E = (0, Y.B)(t.id), I = h(m), S = (0, P.Z)({
  ...
  return (j || I) && null != f ? (0, r.jsx)(s.yRy, {
    targetElementRef: T,
    renderPopout: e => {
      let {
        closePopout: i
      ...
      return (0, r.jsx)(R.Z, {
        children: (0, r.jsx)(s.v2r, {
          ...
          onClose: i,
          onSelect: n,
          onInteraction: (0, _.u)("End Stage", Z, {
...
let em = i.memo(function(e) {
  let {
    ...
    selfMute: c,
    mute: u
  } = (0, N.Z)(t), d = (0, Y.B)(t.id), b = (0, a.e7)([x.Z], () => null != x.Z.getAwaitingRemoteSessionInfo()), {
    cameraUnavailable: C,
    enabled: v
  } = (0, I.Z)(), j = (0, Z.Z)(t), {
    limit: O,
    reachedLimit: k
  } = (0, S.Z)(t), M = (0, a.e7)([H.default], () => H.default.getCurrentUser()), U = (0, a.e7)([B.Z], () => (0, y.Z)(B.Z)), G = (0, a.e7)([F.Z], () => F.Z.getVoiceChannelId() === t.id, [t.id]), V = (0, a.e7)([h.Z], () => h.Z.getStreamParticipants(t.id)[0], [t.id]), z = (0, Q.PK)(t.id), W = O > 0, q = k && !z || null != V && V.user.id !== (null == M ? void 0 : M.id), K = (0, P.Z)({
    ...
    location: "SpeakerControlTray"
  }), $ = (0, _.u)("AudioDeviceMenu", n, {
    entrypoint: eo.A5.CARET
  }), ee = i.useRef(null), et = i.useRef(null);
  ...
  return K ? (0, r.jsxs)("div", {
    className: es.experimentWrapper,
    children: [G && !l ? (0, r.jsxs)("div", {
      className: o()(es.buttonSection, {
        [es.experimentButtonSection]: X
      }),
      children: [(0, r.jsx)(s.yRy, {
        targetElementRef: et,
        renderPopout: e => {
...
let eb = i.memo(function(e) {
  ...
  } = e, i = (0, en.Z)(t.id), l = (0, Y.B)(t.id), o = (0, a.e7)([G.Z], () => G.Z.can(q.yP, t), [t]), s = (0, er.Z)(t.id), c = (0, a.e7)([h.Z], () => null != t ? h.Z.getSelectedParticipant(t.id) : null), u = !s && null == c;
  return n ? (0, r.jsx)(eg, {
    channel: t
  }) : i || l ? (0, r.jsxs)("div", {
