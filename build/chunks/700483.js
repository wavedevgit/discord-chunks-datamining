...
let eh = i.memo(function(e) {
  let {
    ...
    limit: j,
    reachedLimit: O
  } = (0, I.Z)(t), w = (0, o.e7)([F.default], () => F.default.getCurrentUser()), R = (0, o.e7)([D.Z], () => (0, x.Z)(D.Z)), L = (0, o.e7)([B.Z], () => B.Z.getVoiceChannelId() === t.id, [t.id]), U = (0, o.e7)([h.Z], () => h.Z.getStreamParticipants(t.id)[0], [t.id]), G = (0, K.PK)(t.id), H = j > 0, V = O && !G || null != U && U.user.id !== (null == w ? void 0 : w.id), W = (0, _.u)("AudioDeviceMenu", n, {
    entrypoint: ei.A5.CARET
