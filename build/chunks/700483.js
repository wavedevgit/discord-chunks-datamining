...
let ef = i.memo(function(e) {
  let {
    ...
    limit: v,
    reachedLimit: C
  } = (0, I.Z)(t), E = (0, s.e7)([G.default], () => G.default.getCurrentUser()), A = (0, s.e7)([U.Z], () => (0, j.Z)(U.Z)), D = (0, s.e7)([H.Z], () => H.Z.getVoiceChannelId() === t.id, [t.id]), M = (0, s.e7)([f.Z], () => f.Z.getStreamParticipants(t.id)[0], [t.id]), F = (0, Q.PK)(t.id), B = v > 0, W = C && !F || null != M && M.user.id !== (null == E ? void 0 : E.id), V = (0, x.u)("AudioDeviceMenu", n, {
    entrypoint: el.A5.CARET
