...
function ep(e) {
  let {
    ...
    suppress: g
  } = (0, N.Z)(t), y = U.default.getId(), [x] = (0, ei.Z)(t), v = K.ZP.isModerator(y, t.id), j = (0, Y.B)(t.id), E = l(f), I = (0, S.Z)({
  ...
  return (v || E) && null != h ? (0, r.jsx)(s.yRy, {
    renderPopout: e => {
      let {
        closePopout: l
      } = e;
...
let em = i.memo(function(e) {
  let {
    ...
    limit: j,
    reachedLimit: O
  } = (0, P.Z)(t), k = (0, a.e7)([H.default], () => H.default.getCurrentUser()), M = (0, a.e7)([B.Z], () => (0, x.Z)(B.Z)), U = (0, a.e7)([F.Z], () => F.Z.getVoiceChannelId() === t.id, [t.id]), G = (0, a.e7)([h.Z], () => h.Z.getStreamParticipants(t.id)[0], [t.id]), V = (0, Q.PK)(t.id), z = j > 0, W = O && !V || null != G && G.user.id !== (null == k ? void 0 : k.id), q = (0, S.Z)({
