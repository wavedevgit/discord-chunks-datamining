...
function eu(e) {
  ...
  } = (0, j.XJ)(t), f = (0, a.e7)([q.Z], () => q.Z.getStageInstanceByChannel(t.id), [t.id]), m = (0, a.e7)([x.ZP], () => x.ZP.getGuildScheduledEvent(null == f ? void 0 : f.guild_scheduled_event_id)), g = (0, a.e7)([B.Z], () => B.Z.getVoiceChannelId() === t.id, [t.id]), {
    suppress: y
  } = (0, P.Z)(t), C = D.default.getId(), [v] = (0, en.Z)(t), O = Y.ZP.isModerator(C, t.id), E = (0, z.B)(t.id), S = h(m), {
  ...
  return (O || S) && null != f ? (0, r.jsx)(s.yRy, {
    targetElementRef: Z,
    renderPopout: e => {
      let {
        closePopout: i
...
let eh = i.memo(function(e) {
  let {
    ...
    limit: O,
    reachedLimit: j
  } = (0, S.Z)(t), w = (0, a.e7)([F.default], () => F.default.getCurrentUser()), R = (0, a.e7)([L.Z], () => (0, C.Z)(L.Z)), D = (0, a.e7)([B.Z], () => B.Z.getVoiceChannelId() === t.id, [t.id]), U = (0, a.e7)([h.Z], () => h.Z.getStreamParticipants(t.id)[0], [t.id]), H = (0, K.PK)(t.id), G = O > 0, V = j && !H || null != U && U.user.id !== (null == w ? void 0 : w.id), W = (0, _.u)("AudioDeviceMenu", n, {
    entrypoint: ei.A5.CARET
