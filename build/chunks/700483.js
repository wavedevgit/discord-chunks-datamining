...
function ed(e) {
  let {
    ...
    suppress: C
  } = (0, Z.Z)(t), x = k.default.getId(), [j] = (0, er.Z)(t), O = q.ZP.isModerator(x, t.id), S = (0, W.B)(t.id), I = f(g), {
...
let ef = i.memo(function(e) {
  let {
    ...
    limit: j,
    reachedLimit: O
  } = (0, I.Z)(t), E = (0, o.e7)([H.default], () => H.default.getCurrentUser()), R = (0, o.e7)([U.Z], () => (0, x.Z)(U.Z)), M = (0, o.e7)([F.Z], () => F.Z.getVoiceChannelId() === t.id, [t.id]), k = (0, o.e7)([f.Z], () => f.Z.getStreamParticipants(t.id)[0], [t.id]), B = (0, X.PK)(t.id), G = j > 0, V = O && !B || null != k && k.user.id !== (null == E ? void 0 : E.id), z = (0, y.u)("AudioDeviceMenu", n, {
    entrypoint: el.A5.CARET
