...
function eo(e) {
  ...
  } = (0, p.ZP)(), i = (0, et.Z)(t.id), [l, a] = (0, er.Z)(t), o = (0, s.e7)([G.Z], () => G.Z.can(ei.Plq.REQUEST_TO_SPEAK, t));
...
let ec = i.memo(function(e) {
  let {
    channel: t
  } = e, n = (0, s.e7)([F.Z], () => F.Z.getVoiceChannelId() === t.id, [t.id]);
  return (0, r.jsxs)("div", {
...
function eu(e) {
  ...
  } = (0, E.XJ)(t), g = (0, s.e7)([q.Z], () => q.Z.getStageInstanceByChannel(t.id), [t.id]), m = (0, s.e7)([x.ZP], () => x.ZP.getGuildScheduledEvent(null == g ? void 0 : g.guild_scheduled_event_id)), b = (0, s.e7)([F.Z], () => F.Z.getVoiceChannelId() === t.id, [t.id]), {
    suppress: j
  } = (0, P.Z)(t), O = k.default.getId(), [v] = (0, er.Z)(t), C = K.ZP.isModerator(O, t.id), Z = (0, W.B)(t.id), I = f(m), {
    ...
    renderPopout: e => {
      ...
      return (0, r.jsx)(R.Z, {
        children: (0, r.jsx)(c.v2r, {
          ...
          onClose: i,
          onSelect: n,
          onInteraction: (0, y.u)("End Stage", S, {
...
let ef = i.memo(function(e) {
  let {
    ...
    selfMute: a,
    mute: o
  } = (0, P.Z)(t), d = (0, W.B)(t.id), u = (0, s.e7)([j.Z], () => null != j.Z.getAwaitingRemoteSessionInfo()), {
    cameraUnavailable: h,
    enabled: _
  } = (0, Z.Z)(), x = (0, S.Z)(t), {
    limit: v,
    reachedLimit: C
  } = (0, I.Z)(t), E = (0, s.e7)([B.default], () => B.default.getCurrentUser()), A = (0, s.e7)([U.Z], () => (0, O.Z)(U.Z)), D = (0, s.e7)([F.Z], () => F.Z.getVoiceChannelId() === t.id, [t.id]), k = (0, s.e7)([f.Z], () => f.Z.getStreamParticipants(t.id)[0], [t.id]), G = (0, Q.PK)(t.id), H = v > 0, z = C && !G || null != k && k.user.id !== (null == E ? void 0 : E.id), V = (0, y.u)("AudioDeviceMenu", n, {
    entrypoint: el.A5.CARET
...
let em = i.memo(function(e) {
  ...
  } = e, i = (0, et.Z)(t.id), l = (0, W.B)(t.id), a = (0, s.e7)([G.Z], () => G.Z.can(Y.yP, t), [t]), o = (0, en.Z)(t.id), c = (0, s.e7)([f.Z], () => null != t ? f.Z.getSelectedParticipant(t.id) : null), d = !o && null == c;
  return n ? (0, r.jsx)(eg, {
    channel: t
  }) : i || l ? (0, r.jsxs)("div", {
