...
function eu(e) {
  let {
    ...
    suppress: y
  } = (0, P.Z)(t), C = L.default.getId(), [v] = (0, en.Z)(t), j = Y.ZP.isModerator(C, t.id), E = (0, z.B)(t.id), S = h(m), {
...
let eh = i.memo(function(e) {
  let {
    ...
    limit: j,
    reachedLimit: O
  } = (0, S.Z)(t), w = (0, a.e7)([F.default], () => F.default.getCurrentUser()), R = (0, a.e7)([D.Z], () => (0, C.Z)(D.Z)), L = (0, a.e7)([B.Z], () => B.Z.getVoiceChannelId() === t.id, [t.id]), U = (0, a.e7)([h.Z], () => h.Z.getStreamParticipants(t.id)[0], [t.id]), H = (0, K.PK)(t.id), G = j > 0, V = O && !H || null != U && U.user.id !== (null == w ? void 0 : w.id), W = (0, _.u)("AudioDeviceMenu", n, {
    entrypoint: ei.A5.CARET
