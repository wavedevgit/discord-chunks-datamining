...
function ea(e) {
  ...
  } = (0, p.ZP)(), i = (0, ee.Z)(t.id), [l, o] = (0, en.Z)(t), c = (0, a.e7)([U.Z], () => U.Z.can(er.Plq.REQUEST_TO_SPEAK, t));
...
let es = i.memo(function(e) {
  let {
    channel: t
  } = e, n = (0, a.e7)([B.Z], () => B.Z.getVoiceChannelId() === t.id, [t.id]);
  return (0, r.jsxs)("div", {
...
function eu(e) {
  ...
  } = (0, O.XJ)(t), f = (0, a.e7)([q.Z], () => q.Z.getStageInstanceByChannel(t.id), [t.id]), m = (0, a.e7)([x.ZP], () => x.ZP.getGuildScheduledEvent(null == f ? void 0 : f.guild_scheduled_event_id)), g = (0, a.e7)([B.Z], () => B.Z.getVoiceChannelId() === t.id, [t.id]), {
    suppress: y
  } = (0, P.Z)(t), C = D.default.getId(), [v] = (0, en.Z)(t), j = Y.ZP.isModerator(C, t.id), E = (0, z.B)(t.id), S = h(m), {
  ...
  return (j || S) && null != f ? (0, r.jsx)(s.yRy, {
    targetElementRef: Z,
    renderPopout: e => {
      let {
        closePopout: i
...
function ep(e) {
  let {
    ...
    parentAnalyticsLocation: n
  } = (0, p.ZP)(), i = (0, a.e7)([J.Z], () => J.Z.isMuted()), l = (0, Q.pp)(t), o = (0, a.e7)([J.Z], () => J.Z.shouldPlay());
...
let eh = i.memo(function(e) {
  let {
    ...
    selfMute: o,
    mute: c
  } = (0, P.Z)(t), u = (0, z.B)(t.id), d = (0, a.e7)([y.Z], () => null != y.Z.getAwaitingRemoteSessionInfo()), {
    cameraUnavailable: b,
    enabled: x
  } = (0, E.Z)(), v = (0, I.Z)(t), {
    limit: j,
    reachedLimit: O
  } = (0, S.Z)(t), w = (0, a.e7)([F.default], () => F.default.getCurrentUser()), R = (0, a.e7)([L.Z], () => (0, C.Z)(L.Z)), D = (0, a.e7)([B.Z], () => B.Z.getVoiceChannelId() === t.id, [t.id]), U = (0, a.e7)([h.Z], () => h.Z.getStreamParticipants(t.id)[0], [t.id]), H = (0, K.PK)(t.id), G = j > 0, V = O && !H || null != U && U.user.id !== (null == w ? void 0 : w.id), W = (0, _.u)("AudioDeviceMenu", n, {
    entrypoint: ei.A5.CARET
...
let em = i.memo(function(e) {
  ...
  } = e, i = (0, ee.Z)(t.id), l = (0, z.B)(t.id), o = (0, a.e7)([U.Z], () => U.Z.can(W.yP, t), [t]), s = (0, et.Z)(t.id), c = (0, a.e7)([h.Z], () => null != t ? h.Z.getSelectedParticipant(t.id) : null), u = !s && null == c;
  return n ? (0, r.jsx)(ef, {
    channel: t
  }) : i || l ? (0, r.jsxs)("div", {
