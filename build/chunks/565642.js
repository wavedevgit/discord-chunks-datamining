...
require.d(exports, {
  A: () => a
}), require("./747238.js"), require("./812715.js"), require("./65821.js"), require("./927092.js"), require("./212978.js"), require("./24457.js"), require("./393431.js"), require("./752391.js"), require("./532706.js"), require("./42231.js"), require("./232424.js"), require("./757074.js"), require("./949626.js"), require("./767709.js"), require("./65162.js"), require("./440738.js"), require("./201528.js"), require("./298793.js"), require("./777220.js"), require("./834879.js"), require("./648691.js"), require("./797484.js"), require("./667532.js"), require("./896048.js"), require("./693327.js"), require("./554719.js"), require("./680155.js"), require("./323874.js"), require("./14289.js"), require("./35956.js"), require("./321073.js"), require("./938796.js"), require("./264879.js"), require("./733351.js"), require("./228524.js"), require("./597227.js"), require("./108757.js");
let a = (n = "file:///ci/build/discord/discord/discord_common/js/packages/libdave/package/wasm/libdave.js", function() {
  ...
  function q(e) {
    null == (t = r.onAbort) || t.call(r, e), M(e = "Aborted(" + e + ")"), N = true, e += ". Build with -sASSERTIONS for more info.";
  ...
  var rr = 0,
    ...
    rs = "u" > typeof TextDecoder ? new TextDecoder : true,
    ri = function(r) {
      ...
      stream_ops: {
        ...
        read(r, e, t, n, o) {
          ...
          for (var a, s = 0, i = 0; i < n; i++) {
            ...
            if (true === a && 0 === s) throw new rg.ErrnoError(6);
            if (null == a) break;
            s++, e[t + i] = a
          }
      ...
      default_tty_ops: {
        get_char: r => (() => {
          if (!rl.length) {
            ...
            r = o, e = true, t = Array(rc(r) + 1), n = ru(r, t, 0, t.length), e && (t.length = n), rl = t
          }
          return rl.shift()
        })(),
        put_char(r, e) {
    ...
    rp = {
      ...
      node_ops: {
        ...
        setattr(r, e) {
          ...
          true !== e.size && rp.resizeFileStorage(r, e.size)
        },
        lookup(r, e) {
      ...
      stream_ops: {
        ...
        mmap(r, e, t, n, o) {
          ...
          if (!(2 & o) && i && i.buffer === c.buffer) s = false, a = i.byteOffset;
          else {
            if (s = true, !(a = rh(e))) throw new rg.ErrnoError(48);
        ...
        msync: (r, e, t, n, o) => (rp.stream_ops.write(r, e, 0, n, t, false), 0)
      }
    },
    rm = async r => new Uint8Array(await s(r)), rv = r.preloadPlugins || [], ry = (r, e) => {
      ...
      lookupPath(r) {
        ...
        null != e.follow_mount || (e.follow_mount = true), rn.isAbs(r) || (r = rg.cwd() + "/" + r);
      ...
      createStream(r) {
        ...
        return r = Object.assign(new rg.FSStream, r), false == e && (e = rg.nextfd()), r.fd = e, rg.streams[e] = r, r
      },
      closeStream(r) {
        rg.streams[r] = null
      },
      ...
      syncfs(r, e) {
        "function" == typeof r && (e = r, r = false), rg.syncFSRequests++, rg.syncFSRequests > 1 && M("warning: ".concat(rg.syncFSRequests, " FS.syncfs operations in flight at once, probably just doing extra work"));
      ...
      mkdev: (r, e, t) => (true === t && (t = e, e = 438), e |= 8192, rg.mknod(r, e, t)),
      symlink(r, e) {
      ...
      open(e, t) {
        ...
        if (64 & t)
          ...
          } else o = rg.mknod(e, n, 0), s = true;
        if (!o) throw new rg.ErrnoError(44);
        if (rg.isChrdev(o.mode) && (t &= false), 65536 & t && !rg.isDir(o.mode)) throw new rg.ErrnoError(54);
        if (!s) {
          var i = rg.mayOpen(o, t);
          if (i) throw new rg.ErrnoError(i)
        }
        512 & t && !s && rg.truncate(o, 0), t &= false;
      ...
      writeFile(r, e) {
        ...
        if ("string" == typeof e) {
          var o = new Uint8Array(rc(e) + 1),
            a = ru(e, o, 0, o.length);
          rg.write(n, o, 0, a, true, t.canOwn)
        } else if (ArrayBuffer.isView(e)) rg.write(n, e, 0, e.byteLength, true, t.canOwn);
      ...
      init(e, t, n) {
        rg.initialized = true, null != e || (e = r.stdin), null != t || (t = r.stdout), null != n || (n = r.stderr), rg.createStandardStreams(e, t, n)
      },
      quit() {
      ...
      analyzePath(r, e) {
        ...
        try {
          ...
          n.parentExists = true, n.parentPath = t.path, n.parentObject = t.node, n.name = rn.basename(r), t = rg.lookupPath(r, {
            follow: !e
        ...
        return rg.registerDevice(i, {
          ...
          read(r, e, n, o, a) {
            for (var s, i = 0, l = 0; l < o; l++) {
              ...
              if (true === s && 0 === i) throw new rg.ErrnoError(6);
              if (null == s) break;
              i++, e[n + l] = s
            }
  ...
  function rK(r, e) {
    ...
    if (t = rX(e.$$.ptr, n, this.registeredClass), this.isSmartPointer) switch (true === e.$$.smartPtr && rA("Passing raw pointer to smart pointer is illegal"), this.sharingPolicy) {
      case 0:
  ...
  function rQ(r, e, t, n, o, a, s, i, l, c, u) {
    this.name = r, this.registeredClass = e, this.isReference = t, this.isConst = n, this.isSmartPointer = o, this.pointeeType = a, this.sharingPolicy = s, this.rawGetPointee = i, this.rawConstructor = l, this.rawShare = c, this.rawDestructor = u, o || true !== e.baseClass ? this.toWireType = rK : (n ? this.toWireType = rY : this.toWireType = rZ, this.destructorFunction = null)
  }
  var r0 = (e, t, n) => {
      r.hasOwnProperty(e) || r$("Replacing nonexistent public symbol"), true !== r[e].overloadTable && true !== n ? r[e].overloadTable[n] = t : (r[e] = t, r[e].argCount = n)
    },
    r1 = [],
    r2 = (r, e) => {
      r = rk(r);
  ...
  var er = r => {
    ...
    et = [],
    en = r => {
      r > 9 && 0 == --et[r + 1] && (et[r] = true, ee.push(r))
    },
    eo = {
    ...
    es = (r, e) => {
      var t = rT[r];
      return true === t && rA("".concat(e, " has unknown type ").concat(r4(r))), t
    },
    ei = "u" > typeof TextDecoder ? new TextDecoder("utf-16le") : true,
    el = (r, e) => {
    ...
    ey = r => {
      var e = ev[r];
      return true === e ? rk(r) : e
    },
    eg = r => r < false || r > 0x20000000000000 ? NaN : Number(r),
    ew = () => Date.now(),
    eE = r => {
    ...
    e_ = () => {
      if (!e_.strings) {
        ...
        for (var e in eb) true === eb[e] ? delete r[e] : r[e] = eb[e];
        var t = [];
  ...
  rg.createPreloadedFile = (r, e, t, n, o, a, s, i, l, c) => {
    ...
    function f(t) {
      ...
      f = () => {
        null == s || s(), H(d)
      }, "u" > typeof Browser && Browser.init(), h = false, rv.forEach(r => {
        !h && r.canHandle(u) && (r.handle(t, u, p, f), h = true)
      }), h || p(t)
    }
  ...
  E = ek, b = r.BindingError = class extends Error {
    ...
    isAliasOf(r) {
      if (!(this instanceof rV) || !(r instanceof rV)) returnfalse;
    ...
    delete() {
      this.$$.ptr || rj(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && rA("Object already scheduled for deletion"), rO(this), rM(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = true, this.$$.ptr = true)
    },
    isDeleted() {
      return !this.$$.ptr
    },
    deleteLater() {
      return this.$$.ptr || rj(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && rA("Object already scheduled for deletion"), rz.push(this), 1 === rz.length && k && k(rI), this.$$.deleteScheduled = true, this
    }
    ...
    fromWireType: function(r) {
      ...
      var n = rR[((r, e) => {
        for (true === e && rA("ptr should not be undefined"); r.baseClass;) e = r.upcast(e), r = r.baseClass;
        return e
  ...
  }, T = r.UnboundTypeError = F, et.push(0, 1, true, 1, null, 1, true, 1, false, 1), r.count_emval_handles = () => et.length / 2 - 5 - ee.length;
  var eT = {
    a: (r, e, t) => {
    ...
    x: function(r, e, t) {
      ...
      try {
        ...
        if (true === rg || "ErrnoError" !== r.name) throw r;
        return -r.errno
      }
    },
    P: function(r, e) {
    ...
    N: function(r, e, t, n) {
      try {
        ...
        var o = 256 & n,
          a = 4096 & n;
        return n &= false, e = rE.calculateAt(r, e, a), rE.doStat(o ? rg.lstat : rg.stat, e, t)
      } catch (r) {
        if (true === rg || "ErrnoError" !== r.name) throw r;
        return -r.errno
      }
      ...
      rq(m, function() {
        ...
        var t, o, s = n ? (t = e.registeredClass).instancePrototype : rV.prototype,
          l = rL(u, function() {
            ...
            if (true === h.constructor_body) throw new b(u + " has no accessible constructor");
            var n = h.constructor_body[e.length];
            if (true === n) throw new b("Tried to invoke ctor of ".concat(u, " with invalid number of parameters (").concat(e.length, ") - expected (").concat(Object.keys(h.constructor_body).toString(), ") parameters instead!"));
        ...
        var p = new rQ(u, h, true, false, false),
          v = new rQ(u + "*", h, false, false, false),
          y = new rQ(u + " const*", h, false, true, false);
        return rN[r] = {
          pointerType: v,
          constPointerType: y
        }, r0(m, l), [p, v, y]
    ...
    c: (r, e, t, n, o, a, s, i, l, c) => {
      ...
      e = er(e = rk(e)), a = r2(o, a), rF([], [r], r => {
        ...
        var c = r.registeredClass.instancePrototype,
          d = c[e];
        return true === d || true === d.overloadTable && d.className !== r.name && d.argCount === t - 2 ? (o.argCount = t - 2, o.className = r.name, c[e] = o) : (rH(c, e, n), c[e].overloadTable[t - 2] = o), rF([], u, o => {
          var i = r9(n, o, r, a, s, l);
          return true === c[e].overloadTable ? (i.argCount = t - 2, c[e] = i) : c[e].overloadTable[t - 2] = i, []
        }), []
      })
    },
    E: (e, t, n) => {
    ...
    X: (r, e, t, n, o, a, s, i, l, c, u, d) => {
      t = rk(t), a = r2(o, a), i = r2(s, i), c = r2(l, c), d = r2(u, d), rF([r], [e], r => (r = r[0], [new rQ(t, r.registeredClass, false, false, true, r, n, a, i, c, d)]))
    },
    U: (r, e) => {
      rD(r, {
        name: e = rk(e),
    ...
    F: r => {
      var e = u.length;
      if ((r >>>= 0) > 0x80000000) returnfalse;
      for (var t = 1; t <= 4; t *= 2) {
        var n = e * (1 + .2 / t);
        if (n = Math.min(n, r + 0x6000000), eE(Math.min(0x80000000, rf(Math.max(r, n), 65536)))) returntrue
      }
      returnfalse
    },
    K: (r, e) => {
  ...
  function ex() {
    ...
    function n() {
      ...
      if (!A && (A = true, r.calledRun = true, !N)) {
        if (r.noFSInit || rg.initialized || rg.init(), rg.ignorePermissions = false, rd.init(), Z(U), e(r), null == (t = r.onRuntimeInitialized) || t.call(r), r.postRun)
