...
async function b(e) {
  ...
  try {
    ...
    if (U === _.GZQ.ONE_TIME) i()(null != j, "SKU must exist and be fetched."), i()(null != k, "SKUPricePreview must exist."), e = await (0, c.ZZ)(j.applicationId, j.id, {
    ...
    } else if (D && null != w && null != P && null != L) e = _.Uk1.has(P.type) ? await (0, a.G)(L, w, P, R.currency) : await (0, a.Mg)(L, {
      paymentSource: P,
      currency: R.currency
    }, I, S, B);
    else if (null != L) {
      ...
      L.status === _.O0b.PAUSED ? n.status = _.O0b.ACTIVE : n.items = t, e = await (0, a.Mg)(L, n, I, S, B)
    } else e = await (0, l.Ld)({
      planId: N.id,
      currency: R.currency,
      paymentSource: P,
    ...
    t(p.A.COMPLETED), "subscription" in e ? n = null != e.subscription ? u.Z.createFromServer(e.subscription) : null : "entitlements" in e && (r = null != e.entitlements ? e.entitlements : void 0), x(n, r)
  } catch (e) {
