...
let A = t => {
  let {
    ...
    transitionState: R,
    onClose: v
  } = t, L = (0, E.Z)(), x = (0, c.Jm)(), p = (0, u.m8)(), b = (0, I.pn)("SensitiveContentFilterSetting"), M = l.useMemo(() => x && p, [x, p]), T = l.useCallback(t => {
    (0, u.aP)({
      action: t,
      channelId: e,
      messageId: A
    ...
    children: [(0, r.jsx)(i.xBx, {
      ...
      children: [(0, r.jsx)(i.X6q, {
        ...
        children: [M ? (0, r.jsx)(i.zxk, {
          ...
          color: i.zxk.Colors.BRAND,
          onClick: function() {
            T(u.Yy.EXPLICIT_MEDIA_LEARN_MORE_CLICK_SETTINGS), o.Z.open(f.oAB.CONTENT_AND_SOCIAL, null, {
          ...
          color: "header-secondary",
          children: M ? C.intl.format(C.t["TGqx+v"], {
            handleOnHelpUrlHook: () => {
            ...
            handleFalsePositiveHook: () => {
              v(), T(u.Yy.EXPLICIT_MEDIA_LEARN_MORE_CLICK_FALSE_POSITIVE), (0, i.ZDy)(async () => {
                let {
                  default: t
                } = await n(788679);
