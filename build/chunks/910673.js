...
let v = t => {
  let {
    ...
    transitionState: A,
    onClose: R
  } = t, L = (0, u.Z)(), p = (0, c.Jm)(), x = (0, _.m8)(), b = (0, I.pn)("SensitiveContentFilterSetting"), y = l.useMemo(() => p && x, [p, x]), T = l.useCallback(t => {
    (0, _.aP)({
      action: t,
      channelId: e,
      messageId: v
    ...
    R(), T(_.Yy.EXPLICIT_MEDIA_LEARN_MORE_CLICK_FALSE_POSITIVE), (0, a.ZDy)(async () => {
      let {
        default: t
      } = await n(788679);
  ...
  let O = l.useCallback(() => y ? g.intl.format(g.t["TGqx+v"], {
    handleOnHelpUrlHook: () => {
  ...
  }) : x ? null : g.intl.format(g.t.Ge0HUl, {
    ...
    children: [(0, r.jsx)(a.xBx, {
      ...
      children: [(0, r.jsx)(a.X6q, {
        ...
        children: [y ? (0, r.jsx)(a.zxk, {
          ...
          onClick: function() {
            T(_.Yy.EXPLICIT_MEDIA_LEARN_MORE_CLICK_SETTINGS), i.Z.open(f.oAB.CONTENT_AND_SOCIAL, null, {
