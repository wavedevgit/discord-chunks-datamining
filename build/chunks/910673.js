...
let A = e => {
  let {
    ...
    transitionState: R,
    onClose: v
  } = e, L = (0, u.Z)(), x = (0, c.Jm)(), b = (0, _.m8)(), p = (0, I.pn)("SensitiveContentFilterSetting"), M = r.useMemo(() => x && b, [x, b]), T = r.useCallback(e => {
    (0, _.aP)({
      action: e,
      channelId: t,
      messageId: A
    ...
    v(), T(_.Yy.EXPLICIT_MEDIA_LEARN_MORE_CLICK_FALSE_POSITIVE), (0, i.ZDy)(async () => {
      let {
        default: e
      } = await n(788679);
  ...
  let P = r.useCallback(() => M ? m.intl.format(m.t["TGqx+v"], {
    handleOnHelpUrlHook: () => {
  ...
  }) : b ? null : m.intl.format(m.t.Ge0HUl, {
    ...
    children: [(0, l.jsx)(i.xBx, {
      ...
      children: [(0, l.jsx)(i.X6q, {
        ...
        children: [M ? (0, l.jsx)(i.zxk, {
          ...
          color: i.zxk.Colors.BRAND,
          onClick: function() {
            T(_.Yy.EXPLICIT_MEDIA_LEARN_MORE_CLICK_SETTINGS), o.Z.open(f.oAB.CONTENT_AND_SOCIAL, null, {
