...
let x = (e, t) => b.ZP.getName(e.getGuildId(), e.id, t.user),
  v = function(e) {
    ...
    }, [n.id, n.guild_id, b]), C = t.filter(e => e.type === _.Ui.VOICE), E = 4 === C.length ? 2 : 3, Z = (0, s.Wu)([u.Z], () => C.map(e => u.Z.getParticipant(n.id, e.id)).filter(m.lm), [n.id, C]);
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(g.Z, {}), (0, r.jsx)("div", {
        ...
        children: Z.slice(0, 5).map(e => (0, r.jsx)(f.ZP, {
          participant: e,
          channel: n,
          className: O.tile,
          inCall: !0,
