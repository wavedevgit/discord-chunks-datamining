...
let v = (e, t) => b.ZP.getName(e.getGuildId(), e.id, t.user),
  j = function(e) {
    ...
    }, [n.id, n.guild_id, j]), E = t.filter(e => e.type === _.Ui.VOICE), I = 4 === E.length ? 2 : 3, P = (0, o.Wu)([u.Z], () => E.map(e => u.Z.getParticipant(n.id, e.id)).filter(g.lm), [n.id, E]);
    return (0, r.jsxs)("div", {
      ...
      children: [b && (0, r.jsx)(m.Z, {}), (0, r.jsx)("div", {
        ...
        children: (0, r.jsx)(s.Text, {
          ...
          children: 0 === E.length ? C.intl.string(C.t.FUVhyM) : 1 === E.length ? C.intl.formatToPlainString(C.t.EQwZlJ, {
            a: v(n, E[0])
          }) : 2 === E.length ? C.intl.formatToPlainString(C.t.zBcKoK, {
            a: v(n, E[0]),
            b: v(n, E[1])
          }) : E.length > 2 ? C.intl.formatToPlainString(C.t["3AqFaG"], {
            a: v(n, E[0]),
            b: v(n, E[1]),
            n: E.length - 2
          }) : void 0
