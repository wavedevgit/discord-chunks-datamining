...
function g(e) {
  ...
  } = e, [f, g] = r.useState(!1), E = (0, i.e7)([a.ZP], () => a.ZP.getCurrentEmbeddedActivity()), b = l ? m.t.cpT0Cg : m.t["0hKkS0"], y = r.useMemo(() => null != n ? (0, d.XZ)(n.displayName) : m.intl.string(m.t["3xjX0d"]), [n]), O = void 0 !== o.flags && (0, p.yE)(o.flags, h.udG.EMBEDDED), v = null != E && E.applicationId === o.id && (0, s.p)(E.location) === t.channel.id, {
...
function E(e) {
  let {
    ...
    application: n,
    isEmbeddedApp: i,
    hasActiveMatchingEmbeddedActivity: a,
