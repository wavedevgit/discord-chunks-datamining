...
function _(e) {
  ...
  } = e, [h, _] = r.useState(!1), x = (0, l.e7)([a.ZP], () => a.ZP.getCurrentEmbeddedActivity()), y = c ? b.t.cpT0Cg : b.t["0hKkS0"], C = r.useMemo(() => null != n ? (0, p.XZ)(n.displayName) : b.intl.string(b.t["3xjX0d"]), [n]), v = void 0 !== o.flags && (0, m.yE)(o.flags, g.udG.EMBEDDED), j = null != x && x.applicationId === o.id && (x.location.kind === i.E.CONTEXTLESS || (0, s.pY)(x.location) === t.channel.id), {
  ...
  return {
    ...
    buttonText: (0, f.ms)({
      ...
      applicationId: o.id,
      botUserId: E
    }) && v ? j ? b.intl.string(b.t["Hi1/aW"]) : null != C ? C : b.intl.string(b.t.zKX8Nj) : b.intl.string(y),
