...
function N(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), T = (0, c.Z)(), [E, P] = null != (l = (0, x.Z)(N)) ? l : [C, b], R = (0, u.L)(N), W = (0, f.M)(E), k = I === s.vA.CAMERA, A = null != Z || !!w && (!m || k), M = null != Z ? null == Z || null == (t = Z.id) ? void 0 : t.startsWith(s.vA.CAMERA) : k, L = A ? void 0 : N === p.tI.PRESET_VIDEO ? _.NW.string(g.Z.MuHUFR) : N === p.tI.PRESET_DOCUMENTS ? _.NW.string(g.Z.y0JuYW) : void 0;
  return (0, r.jsxs)("div", {
    className: j.root,
    children: [A && (0, r.jsx)(S, {
      source: Z
    }), (0, r.jsxs)("div", {
      className: j.summary,
