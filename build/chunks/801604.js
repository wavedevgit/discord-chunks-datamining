...
function S(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), T = (0, c.Z)(), [E, P] = null != (l = (0, x.Z)(S)) ? l : [C, y], R = (0, u.L)(S), k = (0, f.M)(E), A = w === s.vA.CAMERA, M = null != I || !!N && (!m || A), L = null != I ? null == I || null == (t = I.id) ? void 0 : t.startsWith(s.vA.CAMERA) : A, D = M ? void 0 : S === p.tI.PRESET_VIDEO ? _.intl.string(g.default.MuHUFR) : S === p.tI.PRESET_DOCUMENTS ? _.intl.string(g.default.y0JuYW) : void 0;
  return (0, r.jsxs)("div", {
    className: j.root,
