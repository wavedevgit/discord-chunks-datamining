...
let S = () => [{
  ...
  R = e => {
    let {
      guild: t
    } = e, [n, s] = i.useState(0), [l, o] = i.useState(0), [N, _] = i.useState(), v = (0, a.e7)([m.Z], () => m.Z.can(p.Plq.ADMINISTRATOR, t)), O = null == N ? void 0 : N.offsetWidth, C = null == N ? void 0 : N.offsetHeight;
    i.useEffect(() => {
