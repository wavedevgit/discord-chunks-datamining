...
let E = () => [{
  ...
  w = e => {
    let {
      guild: t
    } = e, [n, l] = i.useState(0), [a, o] = i.useState(0), [v, _] = i.useState(), O = (0, s.e7)([m.Z], () => m.Z.can(p.Plq.ADMINISTRATOR, t)), y = null == v ? void 0 : v.offsetWidth, C = null == v ? void 0 : v.offsetHeight;
    i.useEffect(() => {
