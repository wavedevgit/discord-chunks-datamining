...
let v = e => {
  ...
  let [C] = I.items, P = () => C.type === a.Z.AVATAR_DECORATION ? m.intl.string(m.t["7v0T9P"]) : C.type === a.Z.PROFILE_EFFECT ? m.intl.string(m.t.wR5wOj) : null, R = null != S && S.id !== (null == A ? void 0 : A.id), w = () => {
    null != t && null != E && E(t)
  };
  return (0, r.jsxs)("div", {
    className: v,
