...
let O = e => {
  ...
  let [C] = I.items, P = () => C.type === a.Z.AVATAR_DECORATION ? m.NW.string(m.t["7v0T9P"]) : C.type === a.Z.PROFILE_EFFECT ? m.NW.string(m.t.wR5wOj) : null, R = null != S && S.id !== (null == N ? void 0 : N.id), w = () => {
    null != t && null != E && E(t)
  };
  return (0, r.jsxs)("div", {
    className: O,
