...
let _ = e => {
  let {
    ...
    isReducedMotion: v,
    onClick: T
  } = e, N = (0, m.rO)(), I = r.useRef(null), y = r.useRef(0), A = function(e) {
    let t;
    switch (e) {
      case p.NA.EMOJIS:
    ...
    return t
  }(t), P = (0, d.ZP)(), R = (0, o.wj)(P), D = R ? c.Ttl.WHITE : c.Ttl.BRAND, Z = (0, a.debounce)(() => {
    g.default.track(h.rMx.PREMIUM_WHATS_NEW_BOX_CTA_CLICKED, {
