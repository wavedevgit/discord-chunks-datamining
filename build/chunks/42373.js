...
let _ = e => {
  let {
    ...
    badgeText: N,
    size: I
  } = e, y = (0, g.rO)(), A = r.useRef(null), P = r.useRef(0), R = function(e) {
    let t;
    switch (e) {
      case h.NA.EMOJIS:
    ...
    return t
  }(t), D = (0, u.ZP)(), Z = (0, o.wj)(D), w = Z ? c.Tt.WHITE : c.Tt.BRAND, k = (0, l.debounce)(() => {
    p.default.track(f.rMx.PREMIUM_WHATS_NEW_BOX_CTA_CLICKED, {
