...
function es(e, t) {
  ...
  return (e.insert = e.strstart < M - 1 ? e.strstart : M - 1, t === f) ? (et(e, true), 0 === e.strm.avail_out) ? q : Z : e.last_lit && (et(e, false), 0 === e.strm.avail_out) ? K : z
}
...
function el(e, t) {
  for (var n, r, i;;) {
    ...
    if (n = 0, e.lookahead >= M && (e.ins_h = (e.ins_h << e.hash_shift ^ e.window[e.strstart + M - 1]) & e.hash_mask, n = e.prev[e.strstart & e.w_mask] = e.head[e.ins_h], e.head[e.ins_h] = e.strstart), e.prev_length = e.match_length, e.prev_match = e.match_start, e.match_length = M - 1, 0 !== n && e.prev_length < e.max_lazy_match && e.strstart - n <= e.w_size - k && (e.match_length = ea(e, n), e.match_length <= 5 && (e.strategy === b || e.match_length === M && e.strstart - e.match_start > 4096) && (e.match_length = M - 1)), e.prev_length >= M && e.match_length <= e.prev_length) {
      ...
      if (e.match_available = 0, e.match_length = M - 1, e.strstart++, r && (et(e, false), 0 === e.strm.avail_out)) return K
    } else if (e.match_available) {
      if ((r = a._tr_tally(e, 0, e.window[e.strstart - 1])) && et(e, false), e.strstart++, e.lookahead--, 0 === e.strm.avail_out) return K
    } else e.match_available = 1, e.strstart++, e.lookahead--
  }
  return (e.match_available && (r = a._tr_tally(e, 0, e.window[e.strstart - 1]), e.match_available = 0), e.insert = e.strstart < M - 1 ? e.strstart : M - 1, t === f) ? (et(e, true), 0 === e.strm.avail_out) ? q : Z : e.last_lit && (et(e, false), 0 === e.strm.avail_out) ? K : z
}
...
function ec(e, t) {
  for (var n, r, i, o, s = e.window;;) {
    ...
    if (e.match_length >= M ? (n = a._tr_tally(e, 1, e.match_length - M), e.lookahead -= e.match_length, e.strstart += e.match_length, e.match_length = 0) : (n = a._tr_tally(e, 0, e.window[e.strstart]), e.lookahead--, e.strstart++), n && (et(e, false), 0 === e.strm.avail_out)) return K
  }
