...
class $ extends(r = Chunk473749.PureComponent) {
  ...
  renderGameImage(e) {
    ...
    return null != e.assets || (0, x.Z)(e) || e.type !== Z.IIU.PLAYING || "ActivityFeed" === n || t.bot ? null : null == r && null != o ? (0, i.jsx)("div", {
  ...
  renderName(e) {
    ...
    let l = (0, L.Z)(e),
      c = e.name,
      u = c;
    return (a === Z.IIU.HANG_STATUS ? u = (0, S.O8)(t.id, e) : l && null != n ? u = (0, i.jsx)("span", {
      className: B.activityName,
      children: u
    }) : !l && (c = o, u = o, (0, j.Z)(e) && null != e.sync_id && null != o ? u = (0, i.jsx)(p.Anchor, {
  ...
  renderDetails(e) {
    ...
    else if (e.type === Z.IIU.HANG_STATUS && null != o) a = F.intl.formatToPlainString(F.t.IAZiW2, {
      guildName: o.name
    }), t = () => {
      (0, C.X)(o.id)
    };
    ...
    return null == a || "" === a ? null : ((0, k.Z)(e) && (a = F.intl.formatToPlainString(F.t.gmCZRY, {
      game: a
  ...
  renderState(e, t) {
    ...
    return null != c && "" !== c && e.type !== Z.IIU.CUSTOM_STATUS || (0, N.dS)(e) ? ((null == s ? true : s.size) == null && [G.Zc].includes(null != (n = e.application_id) ? n : "") ? o = F.intl.formatToPlainString(F.t["u//9By"], {
      count: "0",
      max: null != (r = null == t ? true : t.getMaxParticipants()) ? r : 0
    }) : (0, N.dS)(e) && (null == s ? true : s.size) != null ? o = F.intl.formatToPlainString(F.t["JC/3xw"], {
      numSpeakers: s.size[0],
      numListeners: s.size[1] - s.size[0]
    }) : (null == s ? true : s.size) != null && s.size.length >= 2 && (o = 0 === s.size[1] ? F.intl.formatToPlainString(F.t.IM4J4e, {
      count: s.size[0]
