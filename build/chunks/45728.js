/** Chunk was on 33622 **/
/** chunk id: 45728, original params: e,a,t (module,exports,require) **/
require.d(exports, {
  C: () => n
});
let u = new Map;
  ...
  resolvedOptions() {
    ...
    return null == l && (l = "h12" === new Intl.DateTimeFormat("fr", {
      ...
      let t = i(e += (e.includes("-u-") ? "" : "-u") + "-nu-latn", {
        ...
        u = parseInt(t.formatToParts(new Date(2020, 2, 3, 0)).find(e => "hour" === e.type).value, 10),
        n = parseInt(t.formatToParts(new Date(2020, 2, 3, 23)).find(e => "hour" === e.type).value, 10);
    ...
    }(module.locale, this.options)), module.hourCycle = this.resolvedHourCycle, module.hour12 = "h11" === this.resolvedHourCycle || "h12" === this.resolvedHourCycle), "ethiopic-amete-alem" === module.calendar && (module.calendar = "ethioaa"), module
  }
  constructor(e, a = {}) {
