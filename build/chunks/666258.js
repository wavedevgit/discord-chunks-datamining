...
function F(e) {
  let {
    ...
    setError: F,
    analyticsLocation: B
  } = e, [z, G] = i.useState(!1), [H, q] = i.useState(!1), W = i.useRef(null), [Y] = (0, d.Wu)([_.Z], () => [_.Z.hideInstantInvites]), K = (0, I.Dt)(), X = (0, I.Dt)(), J = (0, I.Dt)(), Q = i.useMemo(() => f && null != r.vanityURLCode ? (0, O.Z)(r.vanityURLCode, !1) : null, [r, f]), $ = i.useCallback(async () => {
    var e, t;
    if (j) return;
