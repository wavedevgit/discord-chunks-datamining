...
let j = new O(c.Z, {
  ...
  MESSAGE_UPDATE: function(e) {
    ...
    if (e.message.pinned) {
      ...
      let i = o().findIndex(r.messages, e => e.id === t); - 1 === i ? r.messages.unshift((0, d.e5)(e.message)) : r.messages[i] = (0, d.wi)(r.messages[i], e.message), x[n] = r
    } else {
      if (null == r) return;
  ...
  MESSAGE_EXPLICIT_CONTENT_SCAN_TIMEOUT: function(e) {
    ...
    if (null == r) return;
    let i = o().findIndex(r.messages, e => e.id === t); - 1 !== i && (r.messages = r.messages.slice(), r.messages[i] = (0, u.Cm)(r.messages[i]), x[n] = r)
  }
})