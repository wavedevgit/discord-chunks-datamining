...
function N(e) {
  ...
  } = e, R = (0, s.e7)([O.Z], () => O.Z.getChannel(t)), w = (0, s.e7)([v.Z], () => v.Z.getGuild(null == R ? true : R.getGuildId())), A = (0, f.ZP)(R);
  var D = R;
  let L = (0, s.e7)([x.Z], () => null != D && !a().isEmpty(x.Z.getVoiceStatesForChannel(D.id)));
  i.useEffect(() => {
