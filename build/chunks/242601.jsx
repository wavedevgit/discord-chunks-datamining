...
class eC extends Chunk73800.PureComponent {
  ...
  renderGuildHeaderNotices(e) {
    ...
    return n ? <div onClick={t => e ? null : t.stopPropagation()}><B.Z tutorialId={ev} position={"bottom"} inlineSpecs={eI}>{this.renderGuildHeaderDropdownButton(e)}</B.Z></div> : t ? <h.ua7 forceOpen={true} color={h.FGA.BRAND} position={"bottom"} shouldShow={!e && !i} text={em.intl.string(em.t.sFSrFB)} aria-label={em.intl.string(em.t.sFSrFB)}>{() => this.renderGuildHeaderDropdownButton(e)}</h.ua7> : i || e ? this.renderGuildHeaderDropdownButton(e) : l ? <h.yRy targetElementRef={this.guildHeaderDropdownButtonRef} renderPopout={() => (0, r.jsx)("div", {
      ...
      })} position={"bottom"} align={"center"} animation={h.yRy.Animation.TRANSLATE} shouldShow={true}>{() => this.renderGuildHeaderDropdownButton(e)}</h.yRy> : this.renderGuildHeaderUpsellPopout(e)
  }
  renderGuildHeader(e) {
    let {
      guild: t,
    ...
    }).entrypoints ? <y.Gt value={o}><es.ZP guild={t} controller={s} renderBanner={c} hasSubheader={e} bannerVisible={u} communityInfoVisible={p} guildBanner={this.getGuildBannerHash()} onContextMenu={this.handleHeaderContextMenu} disableBannerAnimation={f} animationOverlayHeight={d}>{this.renderGuildHeaderNotices(n)}</es.ZP></y.Gt> : <y.Gt value={o}><h.KeG targetElementRef={this.guildHeaderRef} renderPopout={this.renderMenuPopout} position={"bottom"} align={"center"} animation={h.yRy.Animation.SCALE} shouldShow={n} onRequestClose={() => {
          (0, T.l)(false)
        }} spacing={4}>{i => {
          var {
            onClick: l
  ...
  renderChannelList() {
    ...
    if (exports || null == require) return <Chunk591190.Z withBannerPadding={null != require && null != this.getGuildBannerHash()} />;
    {
      if (require.features.has(Chunk981631.oNc.HUB) && !Chunk120356) return <div className={Chunk540835.hubContainer}><Chunk258871.Z guild={require} channel={null != Chunk73800 ? Chunk73800 : Chunk984933.ZP.getDefaultChannel(require.id)} /></div>;
  ...
  render() {
    ...
    return <nav className={Chunk540835.container} onContextMenu={this.handleContextMenu} aria-label={Chunk388032.intl.formatToPlainString(Chunk388032.t.nj5gAQ, {
        guildName: null != (e = null == exports ? true : exports.name) ? module : ""
      })}>{null != exports && this.renderGuildHeader(this.state.hasGuildSubheader)}{null != exports && <Chunk156978.Z guild={exports} setHasSubheader={e => this.setState({
          hasGuildSubheader: e
        })} />}{this.renderChannelList()}</nav>
  }
  constructor(...e) {
    super(...e), e_(this, "historyUnlisten", () => {}), e_(this, "guildHeaderRef", i.createRef()), e_(this, "guildHeaderDropdownButtonRef", i.createRef()), e_(this, "showTimeout", new f.V7), e_(this, "state", {
      ...
      return t => {
        ...
        return null != i && <e onClose={n} guild={i} />
      }
      ...
      let b = [];
      return (o && b.push(p.z.STUDENT_HUB_PRIVACY_SETTINGS_TOOLTIP), s && b.push(p.z.GUILD_HEADER_ACTIVE_THREADS_NOTICE), t && b.push(p.z.GUILD_HEADER_PREMIUM_GUILD_PROGRESS), n && b.push(p.z.GUILD_HEADER_PROGRESS_BAR_SIZE_COACH_MARK), i && b.push(p.z.GUILD_HEADER_ROLE_SUBSCRIPTION_UPSELL), l && b.push(p.z.GUILD_HEADER_INVITE_SPLASH), a && b.push(p.z.GUILD_DISCOVERY_LANDING_PAGE_SETTINGS_UPSELL), f && b.push(p.z.GUILD_POWERUP_PERKS_COACHMARK), h && b.push(p.z.BOOSTER_ENHANCED_ROLE_COLORS_COACHMARK), 0 === b.length) ? this.renderGuildHeaderDropdownButton(e) : (c && b.push(p.z.MEDIA_CHANNEL_UPSELL), u && b.push(p.z.SERVER_SUBSCRIPTION_TIER_TEMPLATE_UPSELL), d && b.push(p.z.PREMIUM_CUSTOM_NOTIFICATION_SOUNDS_COACHMARK), <ec.Z contentTypes={b} theme={m} guild={g} renderGuildHeaderDropdownButton={() => this.renderGuildHeaderDropdownButton(e)} />)
    }), e_(this, "renderGuildHeaderDropdownButton", e => (0, R.jW)({
      location: "guild_sidebar"
    }).entrypoints ? <es.wD open={e} /> : <b.Z open={e} className={a()(eb.dropdownButton, {
        [eb.dropdownButtonBannerVisible]: this.state.bannerVisible
      })} ref={this.guildHeaderDropdownButtonRef} />), e_(this, "setAnimatedValueForBanner", e => {
      let {
        renderBanner: t,
...
function eS(e) {
  ...
  let [ec, eu] = (0, C.ZP)(e => [ef.XN.some(t => e.currentlyShown.has(t.dismissibleContentType)), e.currentlyShownGroup.has(eh.R.GUILD_HEADER_TOOLTIPS)], u.X), ed = (0, I.Z)(o), eg = (0, h.s9z)(h.JQI), em = (0, d.e7)([$.Z], () => $.Z.hasLayers()), eb = (0, d.e7)([F.Z], () => F.Z.shouldShow(ev)), e_ = m && (null == o ? true : o.premiumProgressBarEnabled) === false && !el.s.isDisallowPopupsSet(), eO = (0, d.e7)([Q.Z], () => Q.Z.getMemberCount(n)), eE = m && null != eO && eO >= 30 && (null == o ? true : o.premiumProgressBarEnabled) === false && !el.s.isDisallowPopupsSet(), ey = (0, x.Z)(n), eI = (null == o ? true : o.features.has(ep.oNc.HUB)) === true, eS = m && (null == o ? true : o.features.has(ep.oNc.DISCOVERABLE)) === true, eN = (0, v.Q)(), eT = (m || (null == o ? true : o.premiumTier) === ep.Eu4.NONE) && !el.s.isDisallowPopupsSet() && !eN, eP = (0, d.e7)([Z.Z, $.Z], () => null != o && null != L && m && !$.Z.hasLayers() && Z.Z.shouldShowGuildTemplateDirtyTooltip(n)), ej = (0, d.e7)([Y.Z], () => Y.Z.getChannel(a)), {
    isPopoutOpen: ex
  } = (0, T.y)(), eA = null != (t = null == o ? true : o.features.has(ep.oNc.COMMUNITY)) && t, eZ = (0, d.e7)([H.Z], () => !s().isEmpty(H.Z.getThreadsForGuild(n))), ew = ei.ZP.isNewUser(L), eL = X && !ew;
  (0, P.Z)(o);
  let eR = (0, S.Nj)(p.z.PREMIUM_TUTORIAL_SERVER_MENU_TOOLTIP),
    ...
    eV = (0, k.Z)(n),
    eH = (0, M.Z)(null == L ? true : L.id, n) && (null == o ? true : o.premiumProgressBarEnabled) === false;
  return <eC guildId={n} hideSelectedChannel={l} guild={o} scrollToChannel={f} selectedChannelId={l ? null : a} selectedChannel={ej} selectedVoiceChannelId={g} voiceStates={c} rtcConnectedChannelId={eM} rtcDesyncedVoiceStatesCount={eU} isUnavailable={A} theme={G} user={L} hasChannelNotice={null != ed || ec} anyLayerOpen={eg || em} showGuildBoostingProgressBarUpsell={e_} showGuildBoostingProgressBarSizeUpsell={eE} showInviteSplashUpsell={eT} showDiscoveryLandingPageSettingsUpsell={eS} showGuildHeaderTutorial={eb} showGuildTemplateDirtyTooltip={eP} showRoleSubscriptionUpsell={ey} showHubPrivacySettingsTooltip={eI} showNewUnreadsBar={eA} showActiveThreadsNotice={b && null != eO && eO >= 200 && eZ} showMediaChannelUpsell={eD} showTierTemplatesUpsell={ek} isHeaderPopoutOpen={ex} enableStudyGroup={B} isGuildHeaderDismissibleTooltipShown={eu} canShowCoachMarkAtBottom={X} headerAnalyticsLocations={es} isTutorialHighlightDismissed={eR} shouldRenderBurstCoachmark={eL} shouldRenderCustomNotificationSoundsCoachmark={eG} shouldRenderGuildPowerupPerkCoachmark={false === eV} shouldRenderBoosterEnhancedRoleColorsCoachmark={eH} />
}