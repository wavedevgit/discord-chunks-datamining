...
let h = e => e.toString() === m.Plq.MENTION_EVERYONE.toString() ? O.intl.string(O.t.yCpsQw) : (0, s.wt)(e);
...
function y(e) {
  ...
  let c = async () => {
    var e, n;
    let i = null != t ? d.Z.getEveryoneRole(t) : true;
    if (null == i) return;
