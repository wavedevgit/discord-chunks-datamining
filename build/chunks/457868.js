...
let K = H.ZP.getEnableHardwareAcceleration(),
  ...
  Q = i.memo(function(e) {
    let {
      ...
      userId: o,
      guildOwnerId: a
    } = e, s = (0, p.e7)([k.Z], () => k.Z.isTyping(t.id, o)), u = (0, p.e7)([T.ZP], () => T.ZP.getMember(t.guild_id, o)), h = (0, p.e7)([A.Z], () => {
      var e;
      return (null == u ? void 0 : u.colorRoleId) != null ? null == (e = A.Z.getRole(t.guild_id, u.colorRoleId)) ? void 0 : e.name : void 0
    }, [t.guild_id, u]), g = (0, p.e7)([M.default], () => M.default.getUser(o)), b = (0, p.e7)([M.default], () => M.default.getCurrentUser()), _ = (null == g ? void 0 : g.id) === (null == b ? void 0 : b.id), C = (0, p.e7)([w.Z, R.Z], () => _ ? R.Z.getStatus() : w.Z.getStatus(o, t.guild_id)), y = (0, p.e7)([w.Z], () => w.Z.isMobileOnline(o)), v = (0, p.e7)([w.Z, R.Z], () => _ ? R.Z.getActivities() : w.Z.getActivities(o, t.guild_id)), O = (0, p.e7)([Z.Z], () => Z.Z.getAnyStreamForUser(o)), L = (0, c.JA)(o), D = (0, p.e7)([E.Z], () => E.Z.canUserViewChannel(t.id, l, o)), U = (null == g ? void 0 : g.id) != null && g.id === a, H = i.useCallback(e => {
      ...
      if (null == g) return;
      let e = "@".concat(B.ZP.getUserTag(g, {
          decoration: "never"
        })),
        n = "<@".concat(g.id, ">");
...
function ee(e) {
  ...
  }(l, X), y = 0 === d.length || d.every(e => 0 === e.userIds.length);
  if (i.useEffect(() => {
    ...
    }, [t.guild_id, t.id, t.type]), y) return (0, r.jsx)(et, {
    channel: t
  });
      ...
      children: (0, r.jsx)(h.Wdt, {
        children: e => (0, r.jsx)("div", {
          ...
          children: (0, r.jsx)(h.aVo, q({
            ...
            renderFooter: e => d[e.section] === f ? (0, r.jsx)($, {
              channel: t
            }, "footer") : null,
