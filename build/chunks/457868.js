...
let X = H.ZP.getEnableHardwareAcceleration(),
  ...
  J = i.memo(function(e) {
    let {
      ...
      userId: o,
      guildOwnerId: a
    } = e, s = (0, p.e7)([k.Z], () => k.Z.isTyping(t.id, o)), u = (0, p.e7)([T.ZP], () => T.ZP.getMember(t.guild_id, o)), g = (0, p.e7)([A.Z], () => {
      var e;
      return (null == u ? void 0 : u.colorRoleId) != null ? null == (e = A.Z.getRole(t.guild_id, u.colorRoleId)) ? void 0 : e.name : void 0
    }, [t.guild_id, u]), b = (0, p.e7)([M.default], () => M.default.getUser(o)), _ = (0, p.e7)([M.default], () => M.default.getCurrentUser()), C = (null == b ? void 0 : b.id) === (null == _ ? void 0 : _.id), y = (0, p.e7)([w.Z, R.Z], () => C ? R.Z.getStatus() : w.Z.getStatus(o, t.guild_id)), v = (0, p.e7)([w.Z], () => w.Z.isMobileOnline(o)), O = (0, p.e7)([w.Z, R.Z], () => C ? R.Z.getActivities() : w.Z.getActivities(o, t.guild_id)), L = (0, p.e7)([Z.Z], () => Z.Z.getAnyStreamForUser(o)), D = (0, c.JA)(o), U = (0, p.e7)([E.Z], () => E.Z.canUserViewChannel(t.id, l, o)), H = (null == b ? void 0 : b.id) != null && b.id === a, z = i.useCallback(e => {
      null != b && (0, f.jW)(e, async () => {
        let {
          default: e
        } = await Promise.all([n.e("79695"), n.e("70675")]).then(n.bind(n, 654663));
        return n => (0, r.jsx)(e, K(q({}, n), {
          user: b,
          guildId: t.guild_id,
          channel: t
        }))
      ...
      if (null == b) return;
      let e = "@".concat(B.ZP.getUserTag(b, {
          decoration: "never"
        })),
        n = "<@".concat(b.id, ">");
    ...
    return en ? (0, r.jsx)("div", {
      ...
      children: (0, r.jsx)(h.yRy, {
        ...
        renderPopout: e => (0, r.jsx)(S.Z, K(q({}, e), {
          userId: b.id,
          guildId: t.guild_id,
          channelId: t.id
        })),
...
function et(e) {
  ...
  if (i.useEffect(() => {
    ...
    }, [t.guild_id, t.id, t.type]), y) return (0, r.jsx)(en, {
    channel: t
  });
      ...
      children: (0, r.jsx)(h.Wdt, {
        children: e => (0, r.jsx)("div", {
          ...
          children: (0, r.jsx)(h.aVo, q({
            ...
            renderFooter: e => d[e.section] === f ? (0, r.jsx)(ee, {
              channel: t
            }, "footer") : null,
