...
let W = U.ZP.getEnableHardwareAcceleration(),
  ...
  q = i.memo(function(e) {
    let {
    ...
    }, [t.guild_id, h]), b = (0, p.e7)([w.default], () => w.default.getUser(a)), _ = (0, p.e7)([w.default], () => w.default.getCurrentUser()), x = (null == b ? void 0 : b.id) === (null == _ ? void 0 : _.id), y = (0, p.e7)([N.Z, T.Z], () => x ? T.Z.getStatus() : N.Z.getStatus(a, t.guild_id)), v = (0, p.e7)([N.Z], () => N.Z.isMobileOnline(a)), O = (0, p.e7)([N.Z, T.Z], () => x ? T.Z.getActivities() : N.Z.getActivities(a, t.guild_id)), R = (0, p.e7)([P.Z], () => P.Z.getAnyStreamForUser(a)), k = (0, c.JA)(a), L = (0, p.e7)([E.Z], () => E.Z.canUserViewChannel(t.id, l, a)), U = (null == b ? void 0 : b.id) != null && b.id === o, H = i.useCallback(e => {
      ...
      let e = "@".concat(D.ZP.getUserTag(b, {
        ...
        n = "<@".concat(b.id, ">");
      M.S.dispatch(G.CkL.TEXTAREA_FOCUS, {
        channelId: t.id
...
function Q(e) {
  ...
  }(l, Y), y = 0 === d.length || d.every(e => 0 === e.userIds.length);
  if (i.useEffect(() => {
      k.default.track(G.rMx.MEMBER_LIST_VIEWED, {
        channel_id: t.id,
        channel_type: t.type,
        guild_id: t.guild_id
      })
    }, [t.guild_id, t.id, t.type]), y) return (0, r.jsx)(J, {
    channel: t
  });
