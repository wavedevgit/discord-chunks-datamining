...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk143046 = require("./143046.js"),
  Chunk538668 = require("./538668.js"),
...
function V(e) {
  ...
  function ea(e) {
    ...
    return en && null != B && ((null == z ? true : z.type) === M.fO.ACTIVITY || a) ? (null == (t = B.config) ? true : t.useInteractivePIP) ? (0, r.jsx)(w.of, {
      onJumpToChannel: ei,
      applicationId: B.applicationId,
      channel: _,
      showControls: !o,
      ...
      return (0, r.jsxs)(b.Z, {
        ...
        children: [(0, r.jsx)("div", {
          ...
          className: a()(j.iframe, {
            [j.pipModeShort]: en && !N,
            [j.pipModeTall]: en && N,
            [j.pipNonInteractive]: en && !(null == (n = B.config) ? true : n.useInteractivePIP)
          }),
          shouldRefocus: !en && H
