...
function B(e) {
  ...
  let {
    ...
    quest: o,
    location: T.dr.QUESTS_BAR
  }), Q = (0, l.e7)([d.Z], () => d.Z.useReducedMotion), L = (0, l.e7)([p.Z], () => p.Z.hasLayers()), V = s.useRef(null), M = s.useMemo(() => (0, h.q8)(o), [o]), W = (null == (t = o.userStatus) ? void 0 : t.enrolledAt) != null, Z = (0, u.Z)(W), U = (null == (n = o.userStatus) ? void 0 : n.completedAt) != null, H = (0, u.Z)(U), {
    hasError: z,
    isLoading: F
  } = (0, y.d7)(), X = s.useContext(w.T) || B && I && !F && !q, K = s.useRef(X), Y = (0, E.B)(o, X && !z), G = s.useRef(-1), J = s.useRef(!1), [$, ee] = s.useState(!1), [et, en] = s.useState(!1), [er, es] = s.useState(!0), [eo, ea] = s.useState(!0), [ei, el] = s.useState(Y.preEnrollmentExpandedHeight), ec = s.useRef(null), eu = s.useCallback(e => {
    es(!1), en(e)
  }, []), ed = s.useCallback(() => {
    var e, t;
