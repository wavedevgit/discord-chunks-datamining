...
function B(e) {
  ...
  let {
    ...
    location: E.dr.QUESTS_BAR
  }), q = (0, l.e7)([g.Z], () => null != g.Z.questEnrollmentBlockedUntil), I = (0, C.qN)({
    quest: s,
    location: E.dr.QUESTS_BAR
  }), D = (0, l.e7)([u.Z], () => u.Z.useReducedMotion), M = (0, l.e7)([p.Z], () => p.Z.hasLayers()), L = o.useRef(null), W = o.useMemo(() => (0, h.q8)(s), [s]), V = (null == (t = s.userStatus) ? void 0 : t.enrolledAt) != null, Z = (0, d.Z)(V), Q = (null == (n = s.userStatus) ? void 0 : n.completedAt) != null, H = (0, d.Z)(Q), {
    hasError: U,
    isLoading: z
  } = (0, _.d7)(), F = o.useContext(P.T) || B && I && !z && !q, K = o.useRef(F), X = (0, S.B)(s, F && !U), Y = o.useRef(-1), G = o.useRef(!1), [J, $] = o.useState(!1), [ee, et] = o.useState(!1), [en, er] = o.useState(!0), [eo, es] = o.useState(!0), [ea, ei] = o.useState(X.preEnrollmentExpandedHeight), el = o.useRef(null), ec = o.useCallback(e => {
    er(!1), et(e)
  }, []), ed = o.useCallback(() => {
    var e, t;
    ei((null != (t = null == (e = el.current) ? void 0 : e.offsetHeight) ? t : 84) + 2 * X.paddingVertical)
  }, [X.paddingVertical]), eu = o.useCallback(() => {
    ed(), ec(!0)
  }, [ed, ec]), ep = o.useCallback(() => {
    $(!0)
  }, []), em = o.useCallback(() => {
    $(!1), G.current || Q || ec(!1)
  }, [Q, ec]), ef = o.useCallback(() => {
    $(!1), Q || ec(!1), G.current = !1
  }, [Q, ec]), eg = o.useCallback(function() {
  ...
  }, [eu, Q, X.shouldExpandOnQuestComplete]), o.useLayoutEffect(() => {
    V && !Z && G.current && eu()
  }, [eu, V, Z]), o.useLayoutEffect(() => {
    Q || !V || Z || G.current || ec(!1)
  }, [V, Q, Z, ec]), o.useLayoutEffect(() => {
  ...
  }, [Q, eu, X.canCollapseOnBlur, ed, H]), o.useEffect(() => {
    var e, t;
    U && (0, m.dA)({
      questId: s.id,
  ...
  return B && (F || !eo || z) && !U ? (0, r.jsx)(y.A, {
    questOrQuests: s,
    questContent: X.trackingCtx.content,
    overrideVisibility: !M && F,
    children: (e, t) => {
      let n = X.component;
      return L.current = t.current, (0, r.jsxs)("div", {
        className: N.mask,
...
let q = 12633 == n.j ? function() {
  let e = (0, C.DH)();
  return null == e ? null : (0, r.jsx)(_.p, {
