...
function B(e) {
  ...
  let {
    ...
    hasError: z,
    isLoading: F
  } = (0, y.d7)(), X = s.useContext(w.T) || B && q && !F && !I, K = s.useRef(X), Y = (0, S.B)(o, X && !z), G = s.useRef(-1), J = s.useRef(!1), [$, ee] = s.useState(!1), [et, en] = s.useState(!1), [er, es] = s.useState(!0), [eo, ea] = s.useState(!0), [ei, el] = s.useState(Y.preEnrollmentExpandedHeight), ec = s.useRef(null), eu = s.useCallback(e => {
    es(!1), en(e)
  }, []), ed = s.useCallback(() => {
    var e, t;
  ...
  }, [z, B, o.id, Y.trackingCtx.content]), s.useEffect(() => {
    if (!X && eo && !F) {
      var e;
      (0, m.dA)({
        questId: o.id,
