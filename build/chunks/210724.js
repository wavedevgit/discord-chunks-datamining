...
function I(e) {
  ...
  let {
    ...
    quest: s,
    location: P.dr.QUESTS_BAR
  }), V = (0, l.e7)([d.Z], () => d.Z.useReducedMotion), L = (0, l.e7)([p.Z], () => p.Z.hasLayers()), M = o.useRef(null), W = o.useMemo(() => (0, g.q8)(s), [s]), Z = (null == (t = s.userStatus) ? void 0 : t.enrolledAt) != null, U = (0, u.Z)(Z), H = (null == (n = s.userStatus) ? void 0 : n.completedAt) != null, z = (0, u.Z)(H), {
    hasError: F,
    isLoading: X
  } = (0, O.d7)(), K = o.useContext(T.T) || I && D && !X && !q, Y = o.useRef(K), G = (0, S.B)(s, K && !F), J = o.useRef(-1), $ = o.useRef(!1), [ee, et] = o.useState(!1), [en, er] = o.useState(!1), [eo, es] = o.useState(!0), [ea, ei] = o.useState(!0), [el, ec] = o.useState(G.preEnrollmentExpandedHeight), eu = o.useRef(null), ed = o.useCallback(e => {
    es(!1), er(e)
  }, []), ep = o.useCallback(() => {
    var e, t;
    ec((null != (t = null == (e = eu.current) ? void 0 : e.offsetHeight) ? t : 84) + 2 * G.paddingVertical)
  }, [G.paddingVertical]), em = o.useCallback(() => {
    ep(), ed(!0)
  }, [ep, ed]), ef = o.useCallback(() => {
    et(!0)
  }, []), eg = o.useCallback(() => {
    et(!1), $.current || H || ed(!1)
  }, [H, ed]), ex = o.useCallback(() => {
    et(!1), H || ed(!1), $.current = !1
  }, [H, ed]), eh = o.useCallback(function() {
  ...
  }, [eh, s, G.trackingCtx.content]), ev = o.useCallback(() => {
    var e;
    (0, m.dA)({
      questId: s.id,
  ...
  }, [em, H, G.shouldExpandOnQuestComplete]), o.useLayoutEffect(() => {
    Z && !U && $.current && em()
  }, [em, Z, U]), o.useLayoutEffect(() => {
    H || !Z || U || $.current || ed(!1)
  }, [Z, H, U, ed]), o.useLayoutEffect(() => {
  ...
  }, [H, em, G.canCollapseOnBlur, ep, z]), o.useEffect(() => {
    var e, t;
    F && (0, m.dA)({
      questId: s.id,
  ...
  }, [F, I, s.id, G.trackingCtx.content]), o.useEffect(() => {
    if (!K && ea && !X) {
      var e;
      (0, m.dA)({
        questId: s.id,
  ...
  }, [K, ea, X, s.id, Q, G.trackingCtx.content]), o.useEffect(() => {
...
let q = 12633 == n.j ? function() {
  let e = (0, E.DH)();
  return null == e ? null : (0, r.jsx)(O.p, {
