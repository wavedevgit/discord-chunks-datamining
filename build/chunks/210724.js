...
function k(e) {
  ...
  let {
    ...
    quest: o,
    location: P.dr.QUESTS_BAR
  }), I = (0, l.e7)([d.Z], () => d.Z.useReducedMotion), D = (0, l.e7)([p.Z], () => p.Z.hasLayers()), M = s.useRef(null), L = s.useMemo(() => (0, h.q8)(o), [o]), Z = (null == (t = o.userStatus) ? void 0 : t.enrolledAt) != null, W = (0, u.Z)(Z), V = (null == (n = o.userStatus) ? void 0 : n.completedAt) != null, Q = (0, u.Z)(V), {
    hasError: H,
    isLoading: U
  ...
  }, [K.paddingVertical]), eu = s.useCallback(() => {
    ec(), el(!0)
  }, [ec, el]), ed = s.useCallback(() => {
    J(!0)
  }, []), ep = s.useCallback(() => {
    J(!1), Y.current || V || el(!1)
  }, [V, el]), em = s.useCallback(() => {
    J(!1), V || el(!1), Y.current = !1
  }, [V, el]), ef = s.useCallback(function() {
  ...
  }, [eu, V, K.shouldExpandOnQuestComplete]), s.useLayoutEffect(() => {
    Z && !W && Y.current && eu()
  }, [eu, Z, W]), s.useLayoutEffect(() => {
    V || !Z || W || Y.current || el(!1)
  }, [Z, V, W, el]), s.useLayoutEffect(() => {
  ...
  }, [V, eu, K.canCollapseOnBlur, ec, Q]), s.useEffect(() => {
    var e, t;
    H && (0, m.dA)({
      questId: o.id,
  ...
  }, [H, k, o.id]), k && (z || !er || U) && !H) ? (0, r.jsx)(v.A, {
    questOrQuests: o,
