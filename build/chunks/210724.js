...
function B(e) {
  ...
  }, [X.paddingVertical]), ed = o.useCallback(() => {
    ec(), el(!0)
  }, [ec, el]), eu = o.useCallback(() => {
    J(!0)
  }, []), ep = o.useCallback(() => {
    J(!1), Y.current || V || el(!1)
  }, [V, el]), em = o.useCallback(() => {
    J(!1), V || el(!1), Y.current = !1
  }, [V, el]), ef = o.useCallback(function() {
  ...
  }, [ed, V, X.shouldExpandOnQuestComplete]), o.useLayoutEffect(() => {
    Z && !W && Y.current && ed()
  ...
  }, [V, ed, X.canCollapseOnBlur, ec, Q]), o.useEffect(() => {
    var e, t;
    U && (0, m.dA)({
      questId: s.id,
