...
let O = function(e) {
  let {
    mobile: t
  } = e, n = (0, i.e7)([_.Z], () => _.Z.getLayers().includes(E.S9g.USER_SETTINGS)), O = (0, i.e7)([h.default], () => m.ZP.canUseClientThemes(h.default.getCurrentUser())), v = (0, i.e7)([l.Z], () => l.Z.isCoachmark), S = (0, c.g)(), {
    activePanel: I,
    metadata: T
  } = (0, g.oq)(), C = [];
  !n && null == I && (v && !O && C.push(a.z.CLIENT_THEMES_COACHMARK), S && O && C.push(a.z.CUSTOM_THEME_COACHMARK));
  let [A, N] = (0, p.US)(C, b.R.SIDEBAR, true), P = A === a.z.CLIENT_THEMES_COACHMARK, w = A === a.z.CUSTOM_THEME_COACHMARK;
  if (n) return null;
  let R = I === g.wh.CLIENT_THEMES || P,
    D = I === g.wh.APP_ICON,
    x = I === g.wh.CUSTOM_THEME || w,
    L = I === g.wh.APPLICATION_TEST_MODE_DEBUG;
  if (!(R || D || x || L)) return null;
