...
function E() {
  return (0, Chunk951288.jsx)("div", {
    className: Chunk286026.erroredContent,
  ...
  return (0, a.jsxs)("div", {
    children: [(0, a.jsxs)("div", {
      ...
      children: (0, a.jsx)(x.zx, {
        ...
        onClick: async () => {
          if (G) return void t();
          N(true), await r([..._.values()]), N(false)
        },
