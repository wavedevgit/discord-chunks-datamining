...
function N(e) {
  let {
    ...
    snapshot: n,
    index: d
  } = e, p = i.useMemo(() => new x.r(t, n, d), [t, n, d]), m = (0, a.e7)([h.Z, C.default, y.Z, E.Z, b.Z, u.Z], () => p.getForwardInfo(h.Z, C.default, y.Z, E.Z, b.Z, u.Z).footerInfo, [p], o.Z), f = i.useCallback(() => {
    (0, v.Z)(t)
  }, [t]);
...
function P(e) {
  ...
  let {
    ...
    allowDevLinks: b,
    previewLinkTarget: !0
  }), x = (0, a.e7)([h.Z], () => h.Z.getChannel(n.channel_id)), v = _.jU.useSetting();
