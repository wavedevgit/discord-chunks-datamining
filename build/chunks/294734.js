...
function T(e) {
  let {
    ...
    snapshot: n,
    index: d
  } = e, p = i.useMemo(() => new v.r(t, n, d), [t, n, d]), m = (0, a.e7)([g.Z, E.default, x.Z, y.Z, b.Z, u.Z], () => p.getForwardInfo(g.Z, E.default, x.Z, y.Z, b.Z, u.Z).footerInfo, [p], o.Z), f = i.useCallback(() => {
    (0, O.Z)(t)
  }, [t]);
