...
function d(e) {
  ...
  return <div className={c.picker}>{<r.Text variant={"text-sm/semibold"}>{"Preselected Gradient"}</r.Text>}{<div className={c.themes}>{l.vs.map(e => {
