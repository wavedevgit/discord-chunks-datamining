...
function k(e) {
  ...
  let {
    ...
    selectedSkuId: P
  } = (0, b.JL)(), I = (0, l.e7)([d.default], () => d.default.getCurrentUser()), T = (0, l.e7)([f.Z], () => null != P ? f.Z.get(P) : null, [P]), E = (0, s.Z)({}), M = (0, l.e7)([p.Z], () => null != P ? p.Z.getForSKU(P) : null, [P]), Z = (null == M ? true : M.headerBackground) != null && (null == T ? true : T.applicationId) != null ? (0, g._W)(T.applicationId, M.headerBackground, 256) : true, _ = async (e, n) => {};
  return (0, i.jsxs)(i.Fragment, {
