...
function x(e) {
  ...
  return <i.Fragment>{e.children}{<a.J2 targetElementRef={e.targetElementRef} shouldShow={true} position={"top"} asset={(0, i.jsx)(p.Z, {
        guildId: e.guild.id,
        guildProfile: e.guild.profile
      })} title={f.intl.formatToPlainString(f.t["m/Tc3t"], {
        guildName: e.guild.name
      })} body={f.intl.string(f.t.DrAXIi)} actions={o} size={"md"} onRequestClose={() => t(h.L.USER_DISMISS)} />}</i.Fragment>
}
...
function _(e) {
  ...
  return <i.Fragment>{e.children}{<a.J2 targetElementRef={e.targetElementRef} shouldShow={true} position={"top"} asset={(0, i.jsx)(p.Z, {
        ...
        guildName: e.guild.name
      })} body={f.intl.string(f.t.DrAXIi)} actions={d} size={"md"} onRequestClose={() => t(h.L.USER_DISMISS)} />}</i.Fragment>
}

function j(e) {
  let t = (0, r.e7)([d.Z], () => d.Z.getGuild(e.guildId)),
    n = (0, u.S3)(e.guildId);
  return null != t && (0, m.jq)(t) && null !== n ? "changed" === n ? <x guild={t} onDismiss={e.onDismiss} targetElementRef={e.targetElementRef}>{e.children}</x> : <_ guild={t} onDismiss={e.onDismiss} targetElementRef={e.targetElementRef}>{e.children}</_> : (b.error("GuildTagCoachmark rendered without guildId or coachmark type."), e.children)
}