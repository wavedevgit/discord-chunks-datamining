...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk804932 = require("./804932.js"),
  Chunk993609 = require("./993609.js"),
  Chunk987889 = require("./987889.js"),
  Chunk586694 = require("./586694.js"),
...
function F(e) {
  ...
  }), Z = <div className={G.usernameTagContainer} inert={true}><v.Z channel={n} message={t} hideGuildTag={true} hideSystemTag={true} className={G.username} /></div>;
  return (0, i.useEffect)(() => {
    null != b && N.Z.requestMember(b.id, t.author.id)
  }, [b, t.author.id]), <u.tEY{...V(B({}, l), {
...
function H(e) {
  ...
  return <u.Kqy direction={"horizontal"} gap={4} inert={true}>{<h.ZP users={n} useFallbackUserForPopout={true} size={h.u8.SIZE_16} />}{<u.Text variant={"text-sm/medium"} className={G.overflowText}>{U.intl.formatToPlainString(k.default.NzUuLC, {
        count: t.length
      })}</u.Text>}</u.Kqy>
}
...
function z(e) {
  ...
  return <y.Z timestamp={t.timestamp} className={G.timestamp} isEdited={t.isEdited()} isInline={true}>{n}</y.Z>
}
...
function W(e) {
  let {
    ...
    return (0, i.useMemo)(() => {
      ...
      else y = false, C = <_.ZP content={s} message={t} compact={false} className={o()(G.message, {
          [G.unread]: n,
          [G.selected]: l
        })} />;
      return e && (C = <div className={o()(G.message, {
          [G.unread]: n,
          [G.selected]: l,
  ...
  return <u.Kqy direction={"horizontal"} gap={4} align={"center"} inert={true}>{null != c && <c size={"xxs"} className={G.inlineIcon} />}{<u.Text variant={"text-sm/normal"} lineClamp={1} className={G.message}>{a}</u.Text>}</u.Kqy>
}
let K = (0, Chunk73800.memo)(function(e) {
  ...
  return null == p || null == m ? null : <u.kL8 aria-label={_} className={o()(G.messageClickableContainer, {
    ...
    }}><F message={p} channel={m} isSelected={p.id === g.messageId} groupedMessages={y} isUnread={h} /></u.kL8>
}, (e, t) => {
  var n, r;
