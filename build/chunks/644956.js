...
function U(e) {
  ...
  }, [i]), c = (0, l.e7)([C.default], () => C.default.getUser(t.userId), [t.userId]), u = (0, l.e7)([T.Z], () => T.Z.getChannel(o), [o]);
  return null == c || null == u ? null : (0, r.jsx)(S.Z, {
    userId: t.userId,
    guildId: i,
    channelId: o,
    roleId: a.id,
...
function G(e) {
  ...
  let f = (0, b.Z)(o),
    ...
    h = (0, l.Wu)([A.ZP, C.default], () => {
      let e = A.ZP.getMembers(o),
        t = null == n || n === p ? e : e.filter(e => e.roles.includes(n));
      return a()(t).filter(e => null != C.default.getUser(e.userId)).sortBy(e => {
        var t;
    ...
    y = i.useMemo(() => null != m ? h.map(e => (0, r.jsx)(U, {
      member: e,
      guildId: o,
      channelId: s,
      role: m
...
function B(e) {
  ...
  } = (0, m.ZP)(h.Z.ROLE_MENTION), g = (0, l.e7)([p.Z], () => p.Z.roleStyle), E = (0, v.$V)(c, "RoleMention"), b = (null != t && 0 !== t || null != n && null != n.primaryColor) && !f, S = b && "dot" === g, T = b && "username" === g, A = E && null != n && null != n.secondaryColor ? (0, I.f)(n) : null, N = e => (0, r.jsxs)(O.Z, M(x({
  ...
  return !C || f || null == o || null == c || null == i && "@everyone" !== a ? (0, r.jsx)(m.Gt, {
    value: _,
    children: N()
  }) : (0, r.jsx)(m.Gt, {
    value: _,
