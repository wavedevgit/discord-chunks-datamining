...
let T = {
  ...
  S = function(e) {
    let {
      ...
      to: {
        scaleFactor: N >= A || b && N + 1 === A || b && false === N && A === p.Eu4.NONE ? 1 : 0
      },
      config: {
        tension: 360,
        friction: 12
      }
    }), G = <r.Fragment>{<a.animated.div className={E.progressBarMarkerIndicator} style={{
          transform: U.to(e => "translate(-50%, -50%) scale(".concat(e, ")"))
        }} />}{A !== p.Eu4.NONE ? j ? <s.mTd className={o()(E.boostedTierIcon, E.disabledIndicator)} size={"xxs"} color={"currentColor"} /> : <u.Z tier={A} color={"currentColor"} className={E.boostedTierIcon} /> : true}</r.Fragment>;
    ...
    return <s.ua7 tooltipClassName={E.tooltip} text={x ? m.intl.formatToPlainString(m.t["1o48kp"], {
        tierName: (0, d.nW)(A, {
          useLevels: false
        })
      ...
      })} shouldShow={A !== p.Eu4.NONE}>{e => (0, r.jsxs)(F, v(y({
