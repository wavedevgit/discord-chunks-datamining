...
function m(e) {
  ...
  }), p = s ? u.intl.string(u.t.wu4gyc) : u.intl.string(u.t.eFNRzc), h = s || !c;
  return (0, r.jsxs)("div", {
...
function p(e) {
  ...
  if (n[0].currency === c.pK.DISCORD_ORB) return (0, r.jsx)(m, {
    orbPrice: n[0],
    isProductDisabled: p,
    hasSufficientOrbs: u
  });
  ...
  return (0, r.jsxs)("div", {
    ...
    }), n.length > 1 && n[1].currency === c.pK.DISCORD_ORB && (0, r.jsx)(o.Z, {
