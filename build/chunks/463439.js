...
function m(t) {
  ...
  } = t, A = (0, a.e7)([E.Z], () => E.Z.isBlocked(e)), [C, O] = i.useState(A), v = (0, d.o)(), I = (0, d.Q)(), [S, j] = i.useState(!1), y = (0, h.q)(n), M = i.useMemo(() => v ? 0 : I ? 2 : 1, [v, I]), R = () => {
    O(!0), b(_.NM.USER_TAKEOVER_MODAL_BLOCK), o.Z.blockUser(e, {
      location: f.DL
    }).then(() => {
      u.Z.showBlockSuccessToast(e, n)
    })
  }, w = () => {
    O(!1), o.Z.unblockUser(e, {
      location: f.DL
    }), b(_.NM.USER_TAKEOVER_MODAL_UNBLOCK), u.Z.showUnblockSuccessToast(e, n)
  }, P = async () => {
    null != y && (j(!0), await (0, l.J7)(y, () => {
      u.Z.showReportSuccessToast(e, n), T()
    }, () => {
      u.Z.showFailedToast()
    }), j(!1), b(_.NM.USER_TAKEOVER_MODAL_REPORT))
  }, D = t => {
