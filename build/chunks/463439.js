...
function g(t) {
  ...
  } = t, A = (0, c.e7)([h.Z], () => h.Z.isBlocked(e)), [T, S] = s.useState(A), O = (0, d.o)(), j = (0, d.Q)(), [R, M] = s.useState(!1), v = (0, N.q)(n), y = s.useMemo(() => O ? 0 : j ? 2 : 1, [O, j]), z = () => {
    S(!0), I(_.NM.USER_TAKEOVER_MODAL_BLOCK), a.Z.blockUser(e, {
      location: b.DL
    }).then(() => {
      E.Z.showBlockSuccessToast(e, n)
    })
  }, L = () => {
    S(!1), a.Z.unblockUser(e, {
      location: b.DL
    }), I(_.NM.USER_TAKEOVER_MODAL_UNBLOCK), E.Z.showUnblockSuccessToast(e, n)
  }, w = async () => {
    null != v && (M(!0), await (0, u.J7)(v, () => {
      E.Z.showReportSuccessToast(e, n), C()
    }, () => {
      E.Z.showFailedToast()
    }), M(!1), I(_.NM.USER_TAKEOVER_MODAL_REPORT))
  }, P = t => {
