...
function O(t) {
  ...
  } = t, T = (0, a.e7)([x.Z], () => x.Z.isBlocked(e)), [E, y] = i.useState(T), S = (0, d.o)(), A = (0, d.Q)(), [N, C] = i.useState(!1), k = (0, h.q)(n), I = i.useMemo(() => S ? 0 : A ? 2 : 1, [S, A]), M = () => {
    y(!0), j(p.NM.USER_TAKEOVER_MODAL_BLOCK), o.Z.blockUser(e, {
      location: m.DL
    }).then(() => {
      u.Z.showBlockSuccessToast(e, n)
    })
  }, R = () => {
    y(!1), o.Z.unblockUser(e, {
      location: m.DL
    }), j(p.NM.USER_TAKEOVER_MODAL_UNBLOCK), u.Z.showUnblockSuccessToast(e, n)
  }, Z = async () => {
    null != k && (C(!0), await (0, l.J7)(k, () => {
      u.Z.showReportSuccessToast(e, n), v()
    }, () => {
      u.Z.showFailedToast()
    }), C(!1), j(p.NM.USER_TAKEOVER_MODAL_REPORT))
  }, w = t => {
