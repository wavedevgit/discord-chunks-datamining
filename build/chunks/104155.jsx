...
function j(e) {
  ...
  return <o.Z sidebarType={o.y.ThreadSidebar} maxWidth={600}><s.Z channelId={t} baseChannelId={_.oC.CHANNEL_BROWSER} /></o.Z>
}
...
function v(e) {
  ...
  return null == j ? null : <div className={b.pageBody}>{<div className={b.header}>{<a.E1j className={b.search} query={o} onChange={e => {
          "" === o && "" !== e && p.default.track(x.rMx.SEARCH_STARTED, {
            search_type: "channel browser"
          }), s(e.toLowerCase())
        }} onClear={I} placeholder={C.intl.string(C.t.s5MnmJ)} />}{Z ? <a.zxk icon={a.qJs} onClick={w} text={C.intl.string(C.t.CumH4u)} /> : null}</div>}{<g.Z className={b.browser} channels={v} categories={O} guild={j} hasSidebar={N} />}</div>
}