...
function Z(e) {
  let {
    appId: t,
    message: l
  } = e, a = (0, C.R)(t), [u, d, f, h, _, E, x] = (0, o.Wu)([p.Z, b.Z, g.Z], () => {
    var e;
  ...
  return (0, r.jsx)(k, {
    appName: u.name,
    title: T.intl.formatToPlainString(T.t.XDRjs7, {
      appName: u.name
    }),
    description: A,
...
function R(e) {
  ...
  }, [u]), v = i.useMemo(() => null != E ? (0, O.y)(E, 45) : void 0, [E]), Z = (0, C.R)(null != (l = null == E ? void 0 : E.id) ? l : ""), {
    openModal: R,
