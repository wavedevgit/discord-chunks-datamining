...
function Z(e) {
  ...
  let v = g.subscriptions.length,
    I = g.otps.length,
    A = i.useMemo(() => v > 0 && I > 0 ? N.intl.formatToPlainString(N.t["jA648/"], {
      subCount: v,
      itemCount: I
...
function R(e) {
  ...
  }, [u]), v = i.useMemo(() => null != E ? (0, x.y)(E, 45) : void 0, [E]), Z = (0, j.R)(null != (l = null == E ? void 0 : E.id) ? l : ""), {
    openModal: R,
