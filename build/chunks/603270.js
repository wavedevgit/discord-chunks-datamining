...
function S(e) {
  ...
  i.useEffect(() => {
    v === h.N.NONE && (0, l.k)(t), null != p || f || g || (0, u.UM)(t)
  }, [p, t, g, f, v]);
...
function T(e) {
  ...
  }, [u, v.channel_id, h]), L = (0, E.R)(null !== (l = null == T ? void 0 : T.id) && void 0 !== l ? l : "");
  i.useEffect(() => {
    null != S || w || Z || (0, s.km)(h)
  }, [Z, w, S, h]), i.useEffect(() => {
  ...
  let F = S.type === N.epS.SUBSCRIPTION,
    B = !!F && (0, d.KW)(S.flags),
    G = () => {
      (0, o.ZDy)(async () => {
        let {
