...
function R(e) {
  ...
  return (0, r.jsx)(D, {
    ...
    iconSrc: C,
    onIconClick: () => {
      Z(), x.default.track(T.rMx.STOREFRONT_STORE_MESSAGE_EMBED_CLICKED, {
        application_id: t,
        area: "app_icon"
      })
    },
...
function L(e) {
  ...
  return (0, r.jsx)(D, {
    ...
    iconSrc: v,
    onIconClick: () => {
      F(), x.default.track(T.rMx.STOREFRONT_SKU_MESSAGE_EMBED_CLICKED, {
        application_id: y.id,
        sku_id: f.id,
        area: "app_icon"
      })
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(s.zx, {
        color: s.Tt.CUSTOM,
        onClick: () => {
          B(), x.default.track(T.rMx.STOREFRONT_SKU_MESSAGE_EMBED_CLICKED, {
            application_id: y.id,
            sku_id: f.id,
            area: "view_details"
          })
