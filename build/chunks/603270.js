...
function R(e) {
  ...
  return (0, r.jsx)(k, {
    ...
    title: m.name,
    description: B,
    link: "".concat(location.protocol, "//").concat(location.host).concat(I.Z5c.GLOBAL_DISCOVERY_APPS_PROFILE_SECTION(y.id, N.GlobalDiscoveryAppsSections.STORE)),
    onLinkCopy: () => {
      (0, j.X)(y.id, j.B.SKU_EMBED, c)
    },
    iconSrc: v,
    onIconClick: () => {
