...
function Z(e) {
  ...
  let E = h.subscriptions.length,
    C = h.otps.length,
    A = i.useMemo(() => E > 0 && C > 0 ? T.NW.formatToPlainString(T.t["jA648/"], {
      subCount: E,
      itemCount: C
    }) : E > 0 ? T.NW.formatToPlainString(T.t.GSfibG, {
      count: E
...
function k(e) {
  ...
  }, [u]), E = i.useMemo(() => null != x ? (0, N.y)(x, 45) : void 0, [x]), Z = (0, j.R)(null != (a = null == x ? void 0 : x.id) ? a : ""), {
    openModal: k,
  ...
  return (0, r.jsx)(R, {
    ...
    iconSrc: E,
    onIconClick: () => {
      W(), v.default.track(S.rMx.STOREFRONT_SKU_MESSAGE_EMBED_CLICKED, {
        application_id: x.id,
        sku_id: m.id,
        area: "app_icon"
      })
