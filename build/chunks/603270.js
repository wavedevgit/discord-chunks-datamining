...
function R(e) {
  let {
    appId: t,
    message: l
  } = e, a = (0, I.R)(t), [d, p, _, g, b, y, C] = (0, o.Wu)([m.Z, E.Z, h.Z], () => {
    var e;
  ...
  let x = g.subscriptions.length,
    S = g.otps.length,
    w = i.useMemo(() => x > 0 && S > 0 ? P.intl.formatToPlainString(P.t["jA648/"], {
      subCount: x,
      itemCount: S
    }) : x > 0 ? P.intl.formatToPlainString(P.t.GSfibG, {
      count: x
    }) : S > 0 ? P.intl.formatToPlainString(P.t.j7Go5O, {
      count: S
    }) : P.intl.string(P.t.rMA98v), [S, x]);
  ...
  return (0, r.jsx)(L, {
    ...
    iconSrc: C,
    onIconClick: () => {
      Z(), v.default.track(T.rMx.STOREFRONT_STORE_MESSAGE_EMBED_CLICKED, {
        application_id: t,
        area: "app_icon"
      })
    },
...
function D(e) {
  ...
  let {
    ...
    data: y
  } = (0, p.IX)(null == f ? void 0 : f.applicationId), C = (0, o.e7)([h.Z], () => {
    var e;
    return null == (e = h.Z.getBasicChannel(d.channel_id)) ? void 0 : e.guild_id
  }, [d]), x = i.useMemo(() => null != y ? (0, O.y)(y, 45) : void 0, [y]), R = (0, I.R)(null != (l = null == y ? void 0 : y.id) ? l : ""), {
    openModal: D,
  ...
  return (0, r.jsx)(L, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(s.zx, {
        color: s.Tt.CUSTOM,
        onClick: () => {
          B(), v.default.track(T.rMx.STOREFRONT_SKU_MESSAGE_EMBED_CLICKED, {
            application_id: y.id,
            sku_id: f.id,
            area: "view_details"
          })
