...
let M = e => {
  ...
  } = (0, c.ZP)(l.Z.TIERED_TENURE_BADGES_MODAL), I = (0, o.Dt)(), j = Object.values(b.vK), S = (0, E.SI)(null == U ? void 0 : U.userId), B = (0, E.Rw)(), P = m.default.getCurrentUser(), f = null != (t = (0, E.a1)(null != (a = null == U ? void 0 : U.userId) ? a : null == P ? void 0 : P.id)) ? t : new Date, p = (0, _.yd)(null == P ? void 0 : P.premiumType, b.p9.TIER_2), O = j.map(e => {
    let {
      id: a,
      nameUnformatted: t,
      tenureReqNumMonths: s
    } = e, r = v.intl.string(t), l = (0, N.J)(a), c = (0, x.q)(a, s), o = null == U, u = o && (null == B ? void 0 : B.id) === a, m = !o && (null == S ? void 0 : S.id) === a, _ = u && (null == B ? void 0 : B.status) === E.Vq.EARNED, g = u && (null == B ? void 0 : B.status) === E.Vq.UPCOMING, b = m || _;
    return (0, n.jsxs)("div", {
      className: d()(h.badge, {
        [h.earnedBadge]: b || g
      }),
    ...
    children: [(0, n.jsx)(r.olH, {
      ...
      children: p ? (0, n.jsxs)(n.Fragment, {
        children: [(0, n.jsx)(i.xv, {
          ...
          children: O
        }), null != U && U.userId !== (null == P ? void 0 : P.id) && (0, n.jsx)(r.gtL, {
