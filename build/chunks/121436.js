...
let j = e => {
  ...
  } = (0, o.ZP)(s.Z.TIERED_TENURE_BADGES_MODAL), M = (0, c.Dt)(), P = Object.values(x.vK), R = (0, p.SI)(null == h ? void 0 : h.userId), U = (0, p.Rw)(), I = g.default.getCurrentUser(), y = null != (t = (0, p.a1)(null != (n = null == h ? void 0 : h.userId) ? n : null == I ? void 0 : I.id)) ? t : new Date, Z = (0, v.yd)(null == I ? void 0 : I.premiumType, x.p9.TIER_2), B = P.map(e => {
    let {
      id: n,
      nameUnformatted: t,
      tenureReqNumMonths: r
    } = e, u = T.intl.string(t), d = (0, E.J)(n), s = (0, _.q)(n, r), o = null == h, c = o && (null == U ? void 0 : U.id) === n, m = !o && (null == R ? void 0 : R.id) === n, g = c && (null == U ? void 0 : U.status) === p.Vq.EARNED, v = c && (null == U ? void 0 : U.status) === p.Vq.UPCOMING, b = m || g;
    return (0, l.jsxs)("div", {
      className: a()(O.badge, {
        [O.earnedBadge]: b || v
      }),
    ...
    children: [(0, l.jsx)(d.olH, {
      ...
      children: [Z ? (0, l.jsxs)(l.Fragment, {
        children: [(0, l.jsx)(i.xv, {
          ...
          children: B
        }), null != h && h.userId !== (null == I ? void 0 : I.id) && (0, l.jsx)(d.gtL, {
