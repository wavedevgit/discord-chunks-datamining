...
let T = e => {
  ...
  } = (0, u.ZP)(d.Z.TIERED_TENURE_BADGES_MODAL), M = (0, o.Dt)(), U = Object.values(p.vK), R = (0, v.SI)(null == I ? void 0 : I.userId), O = (0, v.Rw)(), S = g.default.getCurrentUser(), j = null != (n = (0, v.a1)(null != (t = null == I ? void 0 : I.userId) ? t : null == S ? void 0 : S.id)) ? n : new Date, P = (0, E.yd)(null == S ? void 0 : S.premiumType, p.p9.TIER_2), k = U.map(e => {
    let {
      id: t,
      nameUnformatted: n,
      tenureReqNumMonths: i
    } = e, s = N.intl.string(n), d = (0, f.J)(t), u = (0, _.q)(t, i), o = null == I, c = o && (null == O ? void 0 : O.id) === t, g = !o && (null == R ? void 0 : R.id) === t, E = c && (null == O ? void 0 : O.status) === v.Vq.EARNED, m = c && (null == O ? void 0 : O.status) === v.Vq.UPCOMING, x = g || E;
    return (0, a.jsxs)("div", {
      className: r()(h.badge, {
        [h.earnedBadge]: x || m
      }),
    ...
    children: [(0, a.jsx)(s.olH, {
      ...
      children: [P ? (0, a.jsxs)(a.Fragment, {
        children: [(0, a.jsx)(l.xv, {
          ...
          children: k
        }), null != I && I.userId !== (null == S ? void 0 : S.id) && (0, a.jsx)(s.gtL, {
