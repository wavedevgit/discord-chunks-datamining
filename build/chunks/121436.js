...
let x = e => {
  ...
  } = (0, s.ZP)(d.Z.TIERED_TENURE_BADGES_MODAL), h = (0, c.Dt)(), j = Object.values(E.vK), S = (0, v.SI)(null == P ? void 0 : P.userId), U = (0, v.Rw)(), M = m.default.getCurrentUser(), R = null != (n = (0, v.a1)(null != (t = null == P ? void 0 : P.userId) ? t : null == M ? void 0 : M.id)) ? n : new Date, y = (0, g.yd)(null == M ? void 0 : M.premiumType, E.p9.TIER_2), I = j.map(e => {
    let {
      id: t,
      nameUnformatted: n,
      tenureReqNumMonths: l
    } = e, u = N.intl.string(n), d = (0, _.J)(t), s = (0, f.q)(t, l), c = null == P, o = c && (null == U ? void 0 : U.id) === t, m = !c && (null == S ? void 0 : S.id) === t, g = o && (null == U ? void 0 : U.status) === v.Vq.EARNED, b = o && (null == U ? void 0 : U.status) === v.Vq.UPCOMING, E = m || g;
    return (0, r.jsxs)("div", {
      className: a()(T.badge, {
        [T.earnedBadge]: E || b
      }),
    ...
    children: [(0, r.jsx)(u.olH, {
      ...
      children: y ? (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(i.xv, {
          ...
          children: I
        }), null != P && P.userId !== (null == M ? void 0 : M.id) && (0, r.jsx)(u.gtL, {
