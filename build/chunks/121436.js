...
let P = e => {
  ...
  } = (0, d.ZP)(s.Z.TIERED_TENURE_BADGES_MODAL), j = (0, c.Dt)(), h = Object.values(p.vK), S = (0, v.SI)(null == O ? void 0 : O.userId), U = (0, v.Rw)(), M = m.default.getCurrentUser(), R = null != (n = (0, v.a1)(null != (t = null == O ? void 0 : O.userId) ? t : null == M ? void 0 : M.id)) ? n : new Date, y = (0, g.yd)(null == M ? void 0 : M.premiumType, p.p9.TIER_2), I = h.map(e => {
    let {
      id: t,
      nameUnformatted: n,
      tenureReqNumMonths: r
    } = e, u = x.intl.string(n), s = (0, _.J)(t), d = (0, f.q)(t, r), c = null == O, o = c && (null == U ? void 0 : U.id) === t, m = !c && (null == S ? void 0 : S.id) === t, g = o && (null == U ? void 0 : U.status) === v.Vq.EARNED, b = o && (null == U ? void 0 : U.status) === v.Vq.UPCOMING, p = m || g;
    return (0, l.jsxs)("div", {
      className: a()(N.badge, {
        [N.earnedBadge]: p || b
      }),
    ...
    children: [(0, l.jsx)(u.olH, {
      ...
      children: y ? (0, l.jsxs)(l.Fragment, {
        children: [(0, l.jsx)(i.xv, {
          ...
          children: I
        }), null != O && O.userId !== (null == M ? void 0 : M.id) && (0, l.jsx)(u.gtL, {
        ...
        children: [(0, l.jsx)(i.xv, {
          ...
          premiumModalAnalyticsLocation: {
            page: E.ZY5.TIERED_TENURE_BADGES_MODAL
          },
          textOptions: {
