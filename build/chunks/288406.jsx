...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk334920 = require("./334920.js"),
  Chunk768581 = require("./768581.js"),
  Chunk185923 = require("./185923.js"),
  Chunk385491 = require("./385491.js");
  ...
  E = Chunk73800.memo(function(e) {
    let {
      ...
      if (!t.useSpriteSheet) {
        ...
        return null != i ? <d.Z className={p.lockedEmoji} aria-label={l} src={i} size={n} alt={null != (e = t.allNamesString) ? e : ""} /> : null
      }
      return <div className={a()(p.emojiSpriteImage, {
          [p.lockedEmoji]: u
        })} style={g(t, o, n)}><c.nn4>{l}</c.nn4></div>
    })();
    return <i.Fragment>{h}{u ? <div className={p.emojiLockIconContainer}><c.mBM size={"xs"} color={"currentColor"} className={p.emojiLockIcon} /></div> : null}</i.Fragment>
  })