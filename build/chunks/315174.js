...
function D(e) {
  ...
  }, [l, f]), O = (0, c.e7)([_.Z], () => (0, g.b)(_.Z, l)), P = i.useCallback(() => {
    O ? (0, u.ZDy)(async () => {
      let {
        default: e
  ...
  return (0, r.jsxs)(r.Fragment, {
    ...
    }), !R.includes(l.id) && (0, r.jsx)(u.ua7, {
      text: E.intl.string(E.t.Sd8Ix8),
      position: "bottom",
      children: e => (0, r.jsx)(u.P3F, I(x({
...
let L = i.memo(function(e) {
  let {
    ...
    hasSubheader: T
  } = e, R = y.hasFeature(v.oNc.ANIMATED_BANNER), L = (0, h.Z)(y), k = !L && y.hasCommunityInfoSubheader(), U = !L && Z, G = (0, O.xR)(C) && R && !g, [B, F] = i.useState(!1), V = i.useRef(!1), H = i.useRef(null), z = null != t ? t : H, W = i.useRef(void 0), K = b.QK.getSetting();
  i.useEffect(() => {
    if (G && n && !V.current && K) return F(!0), W.current = setTimeout(() => {
      F(!1)
    }, 5e3), () => {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(s.animated.div, {
      ...
      style: {
        ...
        filter: (0, u.apv)(n) ? i.to(e => "brightness(".concat(.75 + .25 * e, ")")) : void 0
      }
    })]
  })
}