...
function w(e) {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(y.Z, {
      ...
      "aria-label": j.NW.formatToPlainString(j.t.xMXpl5, {
...
function T(e) {
  let {
    ...
    onContextMenu: a,
    children: s
  } = e, d = (0, c.e7)([g.Z], () => g.Z.theme), p = i.useCallback(async () => {
    let {
      default: e
  ...
  }, [l, d]), h = (0, c.e7)([b.Z], () => (0, f.b)(b.Z, l)), m = i.useCallback(() => {
    h ? (0, u.ZDy)(async () => {
      let {
        default: e
...
let A = i.memo(function(e) {
  let {
    ...
    hasSubheader: R
  } = e, L = O.hasFeature(v.oNc.ANIMATED_BANNER), k = (0, p.Z)(O), M = !k && O.hasCommunityInfoSubheader(), G = !k && A, B = (0, _.xR)(j) && L && !g, [U, W] = i.useState(!1), V = i.useRef(!1), H = i.useRef(null), F = i.useRef(void 0), z = m.QK.getSetting();
  i.useEffect(() => {
