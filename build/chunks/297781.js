...
function U(e) {
  let {
    ...
    defaultIconColor: a,
    location: o
  } = x(), s = (0, b.Jg)(t) && (0, h.Hi)(o, [0, 4, 7, 9]), l = s ? _.TVs.colors.TEXT_POSITIVE : a, c = s ? "text-positive" : i, {
    streamPreviewUrl: u
  } = (0, E.Z)(t), {
    enabled: d
  } = f.c.useExperiment({
...
function B(e) {
  let {
    ...
    defaultIconColor: a,
    location: o
  } = x(), s = (0, b.Jg)(t) && (0, h.Hi)(o, [0, 4]), l = s ? _.TVs.colors.TEXT_POSITIVE : a, c = s ? "text-positive" : i;
  return (0, r.jsxs)("div", {
    className: T.badgeContainer,
...
function q(e) {
  let {
    ...
    defaultIconColor: a,
    location: o
  } = x(), s = (0, b.Jg)(t) && 4 === o, l = s ? _.TVs.colors.TEXT_POSITIVE : a, c = s ? "text-positive" : i;
  return (0, r.jsxs)("div", {
    className: T.badgeContainer,
