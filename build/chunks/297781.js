...
function U(e) {
  let {
    ...
    defaultIconColor: a,
    location: o
  } = x(), s = (0, b.Jg)(t) && (0, h.Hi)(o, [0, 4, 7, 9]), l = s ? f.TVs.colors.TEXT_FEEDBACK_POSITIVE : a, c = s ? "text-positive" : i, {
    streamPreviewUrl: u
  } = (0, E.Z)(t), {
    enabled: d
  } = _.c.useExperiment({
...
function B(e) {
  let {
    ...
    defaultIconColor: a,
    location: o
  } = x(), s = (0, b.Jg)(t) && (0, h.Hi)(o, [0, 4]), l = s ? f.TVs.colors.TEXT_FEEDBACK_POSITIVE : a, c = s ? "text-positive" : i;
  return (0, r.jsxs)("div", {
    className: T.badgeContainer,
...
function q(e) {
  let {
    ...
    defaultIconColor: a,
    location: o
  } = x(), s = (0, b.Jg)(t) && 4 === o, l = s ? f.TVs.colors.TEXT_FEEDBACK_POSITIVE : a, c = s ? "text-positive" : i;
  return (0, r.jsxs)("div", {
    className: T.badgeContainer,
