...
require("./73800.js");
var Chunk385499 = require("./385499.js"),
...
function c(e) {
  ...
  return null == f ? null : <i.Z className={a ? s.botTagCompact : s.botTagCozy} type={f} verified={null == o ? true : o.isVerifiedBot()} hideIcon={u} useRemSizes={true}>{d}</i.Z>
}