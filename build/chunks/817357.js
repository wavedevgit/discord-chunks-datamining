...
function j(e) {
  let {
    ...
    product: r
  } = (0, d.T)(t), o = [g.selectionItem];
  return s && o.push(g.selected), (0, l.jsx)(i.P3F, {
    onClick: () => {
      null != r && n(r)
    },
...
function I(e) {
  let {
    ...
    [k.xB.skuId]: k.xB,
    [k.We.skuId]: k.We
  }, I = (0, r.e7)([m.default], () => m.default.getCurrentUser()), [y, O] = s.useState(null), [N, v] = s.useState(null), [P, z] = s.useState(!1), C = (0, r.e7)([p.ZP], () => p.ZP.getPremiumTypeSubscription()), {
    analyticsLocations: _
  } = (0, a.ZP)([o.Z.PREMIUM_MARKETING_REWARD_SELECTION_MODAL]), S = s.useMemo(() => null != y ? {
    asset: y.assetHash
  } : null, [y]), T = () => {
    (0, i.ZDy)(async () => {
      let {
  ...
  let w = async () => {
    null != N && (z(!0), await (0, b.Ei)({
      rewardSkuIds: [N.skuId],
      subscriptionId: C.id
    }) ? ((0, i.pTH)(), (0, b.es)(!1), (0, h.Z)({
      product: N,
      analyticsLocations: _,
      overrideTitle: f.NW.formatToPlainString(f.t.dTWbOz, {
        itemName: N.name
      }),
