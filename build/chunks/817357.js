...
function y(e) {
  let {
    ...
    product: i
  } = (0, u.T)(t), s = (0, d.G)(i), a = [x.selectionItem];
  return l && a.push(x.selected), (0, r.jsx)(o.P3F, {
    onClick: () => {
      null != i && n(i)
    },
...
function E(e) {
  let {
    ...
    [g.xB.skuId]: g.xB,
    [g.We.skuId]: g.We
  }, h = (0, i.e7)([m.default], () => m.default.getCurrentUser()), [E, j] = l.useState(null), [_, P] = l.useState(null), [N, v] = l.useState(!1), T = (0, i.e7)([p.ZP], () => p.ZP.getPremiumTypeSubscription()), {
    analyticsLocations: O
  } = (0, a.ZP)([s.Z.PREMIUM_MARKETING_REWARD_SELECTION_MODAL]), S = l.useMemo(() => null != E ? {
    asset: E.assetHash
  } : null, [E]), C = () => {
    (0, o.ZDy)(async () => {
      let {
  ...
  let R = async () => {
    null != _ && (v(!0), await (0, b.Ei)({
      rewardSkuIds: [_.skuId],
      subscriptionId: T.id
    }) ? ((0, o.pTH)(), (0, b.es)(!1), (0, f.Z)({
      product: _,
      analyticsLocations: O,
      overrideTitle: k.intl.formatToPlainString(k.t.dTWbOz, {
        itemName: _.name
      }),
