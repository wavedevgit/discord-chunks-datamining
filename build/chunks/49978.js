...
function M(e) {
  ...
  } = e, C = (0, l.e7)([m.Z], () => m.Z.getChannel(u)), S = (0, l.e7)([r.Z], () => r.Z.useReducedMotion), M = (0, I.T)({
    channel: C,
    type: "channel"
  }, null != d ? d : null, null != o ? o : null), [P, w] = i.useState(_ && !g.ZP.disableInviteWithTextChannelActivityLaunch), L = (0, y.F)(d);
  i.useEffect(() => {
    var e;
    x.w1({
      guildId: d
  ...
  return (0, a.jsxs)(s.Ttm, {
    className: O.scroll,
    children: [null != D || null != R ? (0, a.jsx)(p.Z, {
      aspectRatio: 16 / 9,
...
function P(e) {
  ...
  } = (0, d.ZP)(o.Z.ACTIVITY_CHANNEL_SELECTOR), h = (0, l.e7)([m.Z], () => m.Z.getChannel(p)), y = (0, I.T)({
    channel: h,
    type: "channel"
  }, null != n ? n : null, null != t ? t : null), T = (0, l.e7)([m.Z, b.Z], () => m.Z.getChannel(b.Z.getChannelId())), j = (0, l.e7)([g.ZP], () => f && !g.ZP.disableInviteWithTextChannelActivityLaunch), Z = (0, l.e7)([_.ZP], () => null != p && "" !== p && _.ZP.getEmbeddedActivitiesForChannel(p).some(e => e.applicationId === t)), A = E(n), M = async () => {
    var e;
    null != p && "" !== p && null != y && null != n && "" !== n && await (0, C.Z)({
      targetApplicationId: null === (e = y.application) || void 0 === e ? void 0 : e.id,
      locationObject: i,
      channelId: p,
      analyticsLocations: v,
      commandOrigin: u.bB.APPLICATION_LAUNCHER
    }) && (r(), null != T && A && j && await x.sN({
      activityChannelId: p,
