...
let k = Chunk73800.forwardRef(function(e, t) {
  ...
  }), [u]), <o.Ji ref={s} colors={b} sprites={n} spriteWidth={C} spriteHeight={C} />
});
...
function j(e) {
  ...
  }, [o]), E !== f.IlC.APP) ? t : <d.Rm.Provider value={y}>{t}{Object.keys(w).map(e => {
      let t = w[e];
      return <k ref={t => {
          null != t ? n.current[e] = t : delete n.current[e]
        }} sprites={t.sprites} />
    })}{h ? <u.ZP><div className={p.animationWrapper}><a.kci animationRef={I} className={p.lottieAnimation} nextScene={c} sceneSegments={L} onScenePlay={O} onSceneComplete={v} importData={x} pauseWhileUnfocused={false} /></div></u.ZP> : null}</d.Rm.Provider>
}