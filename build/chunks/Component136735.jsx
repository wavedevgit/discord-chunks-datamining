...
function R(e) {
  ...
  let {
    ...
    guildId: U,
    sticker: L
  } = e, K = (0, o.e7)([d.ZP], () => (null == L ? true : L.tags) != null ? d.ZP.getCustomEmojiById(L.tags) : null), F = null != (l = null == (t = f.default.getCurrentUser()) ? true : t.isStaff()) && l ? S.OC : S.Ht, [M, G] = i.useState(null), [q, Y] = i.useState(null != (a = null == L ? true : L.name) ? a : ""), [X, J] = i.useState({
    file: null,
    filename: null != (C = (0, y._V)(L)) ? C : ""
  }), [V, H] = i.useState(null == K ? true : K.id), [Q, W] = i.useState(null != (O = null == K ? true : K.name) ? O : null == L ? true : L.tags), [$, ee] = i.useState(null != (R = null == L ? true : L.description) ? R : ""), [et, el] = i.useState(false), [en, ei] = i.useState(null), er = (0, o.e7)([g.Z], () => g.Z.getGuild(U)), ea = (null == er ? true : er.features.has(I.oNc.PARTNERED)) || (null == er ? true : er.features.has(I.oNc.VERIFIED)), es = null != L, eo = es || (null == X ? true : X.file) != null, eu = 0 === $.length || $.length >= 2 && $.length <= 100, ed = !et && (null == en ? true : en.isBlocking) !== true && q.length >= 2 && (null != V || null != Q || (null == L ? true : L.tags) != null && (null == L ? true : L.tags) !== "") && eo && eu, ec = async e => {
    var t;
    if (null == e) return;
