...
function o(e) {
  let {
    onError: t,
    onSuccess: n
  } = null != e ? e : {}, [o, c] = i.useState(!1), [d, u] = i.useState(!1), [m, g] = i.useState(!1), [p, h] = i.useState(!1), [f, b] = i.useState(!1), [_, x] = i.useState(!1), [E, j] = i.useState(!1), [O, C] = i.useState(!1), S = o || d || m || p || _ || O, v = i.useCallback(async e => {
    if (!S) {
      c(!0);
      try {
