            ...
            return l.wrap(function(e) {
              for (;;) switch (e.prev = e.next) {
                case 0:
                  ...
                  })()(t) : o.is.fun(t) && (I = Promise.resolve(t(v, i.stop.bind(i)))), e.next = 11, Promise.all([I.then(m), E]);
                case 11:
                  O = q(i, !0), e.next = 21;
                  break;
                case 14:
...
var er = function(e) {
  ...
  ef = function(e) {
    ...
    return n.advance = function(e) {
          ...
          if (!f) {
            ...
            if (o.is.und(a.duration))
              if (a.decay) {
                ...
                for (var b = null == c.lastVelocity ? m : c.lastVelocity, y = a.precision || (h == d ? .005 : Math.min(1, .001 * Math.abs(d - h))), v = a.restVelocity || y / 10, O = a.clamp ? 0 : a.bounce, I = !o.is.und(O), S = h == d ? c.v0 > 0 : h < d, T = !1, N = 1, A = Math.ceil(e / 1), C = 0; C < A && !(!(Math.abs(b) > v) && (f = Math.abs(d - _) <= y)); ++C) {
      ...
      var R = o.is.und(t.reset) ? l && !t.default : !o.is.und(E) && M(t.reset, r),
        w = R ? E : this.get(),
        D = W(m),
      ...
      if (V && this.is(ec) && (i.changed && !R ? G = !0 : G || this._stop()), !S) {
        (G || o.getFluidConfig(d)) && (i.values = P.getPayload(), i.toValues = O ? null : U == f.AnimatedString ? [1] : o.toArray(D)), i.immediate = k, i.onStart = ep(c("onStart"), r), i.onChange = ep(c("onChange"), r);
        var Z = i.onRest,
