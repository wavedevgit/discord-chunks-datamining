...
function b(e) {
  ...
  })), <a.Text color={"text-muted"} className={_} variant={"text-xs/normal"}>{t}</a.Text>
}
...
function x(e) {
  ...
  return t.status === g.O0b.CANCELED || t.isPurchasedExternally ? null : <b subscription={t} withOverheadSeparator={n} />
}