...
function i(e, t) {
  let {
    ...
    feedback: c,
    analyticsData: u
  } = t, d = n.Z.getSettings(), b = n.Z.getInputDeviceId(), m = n.Z.getInputDevices()[b], p = n.Z.getOutputDeviceId(), _ = n.Z.getOutputDevices()[p], f = n.Z.getVideoDeviceId(), h = n.Z.getVideoDevices()[f], g = n.Z.getNoiseCancellation(), O = n.Z.getMediaEngine().getAudioSubsystem(), v = n.Z.getMediaEngine().getAudioLayer();
