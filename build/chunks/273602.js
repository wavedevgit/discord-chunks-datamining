...
async function w(e) {
  ...
  x.on("progress", e => {
    let t = (0, h.dg)(p.id);
    e.currentSize > t && (x.cancel(), l(!1), _(), (0, C.G)(o, (0, E.KZ)(c)))
  });
  ...
  let S = [...v, ...null != (t = i.map((e, t) => (0, T.B)(e, t))) ? t : []];
  try {
    await r.tn.patch({
      ...
      rejectWithError: !1
    }), _(), u.Z.clearAll(o.id, f.d.ChannelMessage)
  } catch (e) {
...
function N(e) {
  ...
  let {
    ...
    transitionState: u,
    onClose: d
  } = e, m = (0, o.e7)([_.Z], () => _.Z.getChannel(n), [n]), f = (0, o.e7)([g.Z], () => g.Z.getGuild(null == m ? void 0 : m.getGuildId()), [m]), b = (0, o.e7)([_.Z], () => _.Z.getChannel(null == m ? void 0 : m.parent_id), [m]), h = null == (t = r[0]) ? void 0 : t.item, [y, T] = i.useState(null);
  i.useEffect(() => {
    null != h && (0, p.Fq)(h.file, (e, t) => T(e), S.dG)
  }, [h]);
  let C = null != h && null != y ? {
      src: y,
      width: O.TJ,
