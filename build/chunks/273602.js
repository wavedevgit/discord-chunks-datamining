...
function S(e) {
  ...
  let {
    ...
    transitionState: I,
    onClose: M
  } = e, A = (0, d.Dt)(), D = (0, r.e7)([p.Z], () => p.Z.getChannel(n), [n]), N = (0, r.e7)([f.Z], () => f.Z.getGuild(null == D ? void 0 : D.getGuildId()), [D]), L = (0, r.e7)([p.Z], () => p.Z.getChannel(null == D ? void 0 : D.parent_id), [D]), k = null == (t = S[0]) ? void 0 : t.item, [Z, z] = i.useState(null);
  i.useEffect(() => {
    ...
    G = i.useCallback(() => {
      null != D && null != N && ((0, j.xI)({
        ...
        let {
          ...
          guild: i,
          onClose: r
        } = e, o = new c.Z(C.ANM.MESSAGE(t.id, _.default.castChannelIdAsMessageId(t.id)), "PATCH");
        o.on("start", () => {
          a(!0)
        }), o.on("progress", e => {
          let l = (0, b.dg)(i.id);
  ...
  return null == L ? null : (0, a.jsxs)(o.Y0X, {
    transitionState: I,
    size: o.CgR.SMALL,
