...
function M(e) {
  ...
  let {
    ...
    transitionState: s,
    onClose: u
  } = e, m = (0, d.Dt)(), f = (0, r.e7)([g.Z], () => g.Z.getChannel(n), [n]), _ = (0, r.e7)([b.Z], () => b.Z.getGuild(null == f ? void 0 : f.getGuildId()), [f]), y = (0, r.e7)([g.Z], () => g.Z.getChannel(null == f ? void 0 : f.parent_id), [f]), O = null == (t = l[0]) ? void 0 : t.item, [h, v] = i.useState(null);
  i.useEffect(() => {
  ...
  return null == y ? null : (0, a.jsxs)(o.Y0X, {
    transitionState: s,
    size: o.CgR.SMALL,
