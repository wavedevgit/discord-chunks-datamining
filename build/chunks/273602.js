...
async function Z(t) {
  ...
  try {
    await o.tn.patch({
      ...
      rejectWithError: !1
    }), p(), h.Z.clearAll(n.id, b.d.ChannelMessage)
  } catch (t) {
...
function A(t) {
  ...
  let {
    ...
    transitionState: h,
    onClose: u
  } = t, g = (0, n.e7)([p.Z], () => p.Z.getChannel(i), [i]), b = (0, n.e7)([m.Z], () => m.Z.getGuild(null == g ? void 0 : g.getGuildId()), [g]), f = (0, n.e7)([p.Z], () => p.Z.getChannel(null == g ? void 0 : g.parent_id), [g]), v = null == (e = o[0]) ? void 0 : e.item, [C, S] = a.useState(null);
  a.useEffect(() => {
  ...
  return null == f ? null : (0, s.jsx)(l.Modal, {
