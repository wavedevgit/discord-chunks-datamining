...
function w(e) {
  ...
  let {
    ...
    transitionState: s,
    onClose: d
  } = e, m = (0, u.Dt)(), f = (0, r.e7)([g.Z], () => g.Z.getChannel(n), [n]), h = (0, r.e7)([b.Z], () => b.Z.getGuild(null == f ? void 0 : f.getGuildId()), [f]), _ = (0, r.e7)([g.Z], () => g.Z.getChannel(null == f ? void 0 : f.parent_id), [f]), y = null == (t = l[0]) ? void 0 : t.item, [O, x] = i.useState(null);
  i.useEffect(() => {
  ...
  return null == _ ? null : (0, a.jsxs)(o.Y0X, {
    transitionState: s,
    size: o.CgR.SMALL,
