...
async function M(e) {
  ...
  v.on("progress", e => {
    let t = (0, _.dg)(p.id);
    e.currentSize > t && (v.cancel(), u(!1), g(), (0, x.G)(r, (0, j.KZ)(l)))
  });
  ...
  try {
    await o.tn.patch({
      ...
      rejectWithError: !1
    }), g(), s.Z.clearAll(r.id, f.d.ChannelMessage)
  } catch (e) {
...
function w(e) {
  ...
  let {
    ...
    transitionState: s,
    onClose: d
  } = e, m = (0, u.Dt)(), f = (0, r.e7)([g.Z], () => g.Z.getChannel(n), [n]), h = (0, r.e7)([b.Z], () => b.Z.getGuild(null == f ? void 0 : f.getGuildId()), [f]), _ = (0, r.e7)([g.Z], () => g.Z.getChannel(null == f ? void 0 : f.parent_id), [f]), y = null == (t = o[0]) ? void 0 : t.item, [O, x] = i.useState(null);
  i.useEffect(() => {
  ...
  return null == _ ? null : (0, a.jsxs)(l.Y0X, {
    transitionState: s,
    size: l.CgR.SMALL,
