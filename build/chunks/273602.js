...
async function I(e) {
  ...
  try {
    await o.tn.patch({
      ...
      rejectWithError: !1
    }), g(), c.Z.clearAll(r.id, h.d.ChannelMessage)
  } catch (e) {
...
function M(e) {
  ...
  let {
    ...
    transitionState: c,
    onClose: d
  } = e, m = (0, u.Dt)(), h = (0, r.e7)([g.Z], () => g.Z.getChannel(n), [n]), b = (0, r.e7)([f.Z], () => f.Z.getGuild(null == h ? void 0 : h.getGuildId()), [h]), _ = (0, r.e7)([g.Z], () => g.Z.getChannel(null == h ? void 0 : h.parent_id), [h]), y = null == (t = o[0]) ? void 0 : t.item, [O, j] = i.useState(null);
  i.useEffect(() => {
