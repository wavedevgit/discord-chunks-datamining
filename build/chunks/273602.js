...
function P(e) {
  ...
  let {
    ...
    transitionState: u,
    onClose: d
  } = e, m = (0, i.e7)([_.Z], () => _.Z.getChannel(n), [n]), f = (0, i.e7)([g.Z], () => g.Z.getGuild(null == m ? void 0 : m.getGuildId()), [m]), b = (0, i.e7)([_.Z], () => _.Z.getChannel(null == m ? void 0 : m.parent_id), [m]), h = null == (t = c[0]) ? void 0 : t.item, [T, y] = o.useState(null);
  o.useEffect(() => {
