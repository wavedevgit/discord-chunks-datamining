...
async function P(e) {
  ...
  try {
    await r.tn.patch({
      ...
      rejectWithError: !1
    }), _(), u.Z.clearAll(i.id, g.d.ChannelMessage)
  } catch (e) {
...
function N(e) {
  ...
  let {
    ...
    transitionState: u,
    onClose: d
  } = e, p = (0, m.Dt)(), g = (0, i.e7)([f.Z], () => f.Z.getChannel(n), [n]), h = (0, i.e7)([b.Z], () => b.Z.getGuild(null == g ? void 0 : g.getGuildId()), [g]), T = (0, i.e7)([f.Z], () => f.Z.getChannel(null == g ? void 0 : g.parent_id), [g]), y = null == (t = r[0]) ? void 0 : t.item, [C, v] = o.useState(null);
  o.useEffect(() => {
  ...
  return null == T ? null : (0, a.jsxs)(l.Y0X, {
    transitionState: u,
    size: l.CgR.SMALL,
