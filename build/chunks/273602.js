...
async function M(e) {
  ...
  try {
    await r.tn.patch({
      ...
      rejectWithError: !1
    }), _(), s.Z.clearAll(i.id, f.d.ChannelMessage)
  } catch (e) {
...
function P(e) {
  ...
  let {
    ...
    transitionState: s,
    onClose: u
  } = e, m = (0, d.Dt)(), f = (0, i.e7)([_.Z], () => _.Z.getChannel(n), [n]), b = (0, i.e7)([g.Z], () => g.Z.getGuild(null == f ? void 0 : f.getGuildId()), [f]), h = (0, i.e7)([_.Z], () => _.Z.getChannel(null == f ? void 0 : f.parent_id), [f]), T = null == (t = r[0]) ? void 0 : t.item, [y, C] = o.useState(null);
  o.useEffect(() => {
