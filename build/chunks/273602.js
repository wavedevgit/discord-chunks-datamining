...
async function S(e) {
  ...
  try {
    await r.tn.patch({
      ...
      rejectWithError: !1
    }), f(), s.Z.clearAll(o.id, _.d.ChannelMessage)
  } catch (e) {
...
function M(e) {
  ...
  let {
    ...
    transitionState: s,
    onClose: d
  } = e, m = (0, u.Dt)(), _ = (0, o.e7)([f.Z], () => f.Z.getChannel(n), [n]), b = (0, o.e7)([g.Z], () => g.Z.getGuild(null == _ ? void 0 : _.getGuildId()), [_]), h = (0, o.e7)([f.Z], () => f.Z.getChannel(null == _ ? void 0 : _.parent_id), [_]), y = null == (t = r[0]) ? void 0 : t.item, [T, C] = i.useState(null);
  i.useEffect(() => {
  ...
  return null == h ? null : (0, a.jsxs)(c.Y0X, {
    transitionState: s,
    size: c.CgR.SMALL,
