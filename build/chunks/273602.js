...
function A(e) {
  ...
  let {
    ...
    transitionState: u,
    onClose: d
  } = e, p = (0, m.Dt)(), g = (0, i.e7)([f.Z], () => f.Z.getChannel(n), [n]), h = (0, i.e7)([b.Z], () => b.Z.getGuild(null == g ? void 0 : g.getGuildId()), [g]), T = (0, i.e7)([f.Z], () => f.Z.getChannel(null == g ? void 0 : g.parent_id), [g]), y = null == (t = c[0]) ? void 0 : t.item, [C, x] = o.useState(null);
  o.useEffect(() => {
