...
function A(t) {
  ...
  let {
    ...
    transitionState: d,
    onClose: u
  } = t, c = (0, a.e7)([p.Z], () => p.Z.getChannel(i), [i]), f = (0, a.e7)([m.Z], () => m.Z.getGuild(null == c ? void 0 : c.getGuildId()), [c]), b = (0, a.e7)([p.Z], () => p.Z.getChannel(null == c ? void 0 : c.parent_id), [c]), v = null == (e = o[0]) ? void 0 : e.item, [C, S] = n.useState(null);
  n.useEffect(() => {
  ...
  return null == b ? null : (0, s.jsx)(l.Modal, {
