...
function I(e) {
  ...
  let {
    channel: u
  } = e, h = (0, a.e7)([j.ZP], () => j.ZP.lastMessageId(u.id)), g = null == h ? new Date(null != (n = null == (t = u.threadMetadata) ? void 0 : t.archiveTimestamp) ? n : Date.now()).getTime() : p.default.extractTimestamp(h);
  (0, i.$)({
