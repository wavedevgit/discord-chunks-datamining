...
function w(e) {
  return e.isActiveThread() ? (0, r.jsx)(C, {
    channel: e
  }) : (0, r.jsx)(S, {
    channel: e
  })
...
function O(e) {
  ...
  return (0, r.jsxs)(s.Text, {
    ...
    }), ":\xa0", I, "\xa0 • \xa0", (0, N.Ye)(Z.default.extractTimestamp(n.id))]
  })
}
...
function S(e) {
  ...
  let {
    channel: d
  } = e, u = (0, l.e7)([x.ZP], () => x.ZP.lastMessageId(d.id)), h = null == u ? new Date(null != (n = null == (t = d.threadMetadata) ? void 0 : t.archiveTimestamp) ? n : Date.now()).getTime() : Z.default.extractTimestamp(u);
  (0, o.$)({
