...
function N(e) {
  ...
  let {
    ...
    onClick: i,
    submitting: r
  } = e, a = null != (t = _.ZP.getGuildIconURL({
    id: n.id,
    icon: n.icon,
    size: 40
  })) ? t : void 0;
...
let E = e => {
  ...
  } = e, [h, x] = i.useState(null), [_, v] = i.useState(void 0), [E, S] = i.useState(null), I = e => async () => {
    x(null), s(e), S(e);
    try {
  ...
  }, j = () => t(g.tF.SUBMIT_SCHOOL), y = r;
  return null != _ && "" !== _ && (y = r.filter(e => o()(_.toLowerCase(), e.name.toLowerCase()))), (0, l.jsxs)("div", {
    ...
    children: [(0, l.jsx)(c.X6q, {
      ...
      children: (0, l.jsx)(c.Text, {
        ...
        children: f.intl.format(f.t.dZeiTE, {
          onJoinWaitlist: j
        })
      })
    }), (0, l.jsxs)("div", {
      className: a()(p.guildList, {
        [p.forcedHeight]: m
      }),
      children: [(0, l.jsxs)("div", {
        ...
        children: y.map(e => void 0 === e ? null : (0, l.jsx)(N, {
          guildInfo: e,
          onClick: I(e.id),
          submitting: E === e.id
        }, e.id))
        ...
        children: (0, l.jsxs)("div", {
          ...
          children: [(0, l.jsx)("div", {
            ...
            children: f.intl.format(f.t.flgDKC, {
              onJoinWaitlist: j
            })
          })]
        })
