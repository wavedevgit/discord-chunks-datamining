...
function j(e) {
  let {
    ...
    value: i,
    onChange: a
  } = e, s = v(e, ["renderLeading", "renderTrailing", "value", "onChange"]), o = (0, m.w)("SingleSelect"), l = I({
    value: i,
    onChange: a
  }), {
    id: c,
...
function M(e) {
  let {
    renderLeading: t,
    renderTrailing: n
  } = e, i = v(e, ["renderLeading", "renderTrailing"]), a = (0, m.w)("Select"), {
    id: s,
    serialize: o,
    options: l,
    select: c,
