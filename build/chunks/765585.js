...
let h = r.forwardRef(function(e, t) {
  let {
    ...
    tryItButtonColor: B
  } = e, M = v ? a.zxk.Sizes.LARGE : a.zxk.Sizes.MAX, [U, V] = r.useState(!1), {
    ref: G,
    width: F
  } = (0, o.ZP)();
  ...
  return r.useEffect(() => {
    ...
    children: (0, i.jsxs)("div", {
      ...
      children: [null != k && (0, i.jsx)(a.P3F, {
        onClick: L,
        className: w,
        children: k
      }), (0, i.jsxs)("div", {
        className: l()(h, O ? p.artInline : p.artAbsolute),
        children: [T && (0, i.jsx)(u.Z, {
          className: p.gifTag
        }), A]
      }), (0, i.jsxs)("div", {
        className: p.body,
        children: [(0, i.jsxs)(a.X6q, {
          ...
          color: "always-white",
          children: [S && !P ? (0, i.jsx)(a.SrA, {
            size: "md",
            color: "currentColor",
            className: p.premiumIcon
          }) : null, P ? (0, i.jsxs)(a.Text, {
            color: "always-white",
            variant: "eyebrow",
        ...
        children: null != E ? (0, i.jsxs)(i.Fragment, {
