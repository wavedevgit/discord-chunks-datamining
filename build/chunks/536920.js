...
function v(e) {
  let {
    ...
    clientSettingType: v,
    gameId: j
  } = e, [C, k] = r.useState("unreported"), [b, y] = r.useState(""), [N, f] = r.useState(!1), [S, R] = r.useState(!1), [z, w] = r.useState(!1), [I, M] = r.useState(!1), A = (0, i.e7)([m.Z, u.ZP], () => {
    var e;
    ...
    f(!0), await _.default.track(h.rMx.OVERLAY_DISABLED_SURVEY, {
      reason: C,
      comment: b,
