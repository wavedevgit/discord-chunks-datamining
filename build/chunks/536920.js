...
function p(e) {
  let {
    ...
    clientSettingType: p,
    gameId: v
  } = e, [k, j] = a.useState("unreported"), [C, b] = a.useState(""), [N, f] = a.useState(!1), [y, R] = a.useState(!1), [S, z] = a.useState(!1), [I, w] = a.useState(!1), A = (0, i.e7)([u.Z, d.ZP], () => {
    var e;
    ...
    f(!0), await m.default.track(x.rMx.OVERLAY_DISABLED_SURVEY, {
      reason: k,
      comment: C,
