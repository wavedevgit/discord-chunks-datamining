...
let d = {
  ...
  fn: function(e) {
    ...
    if (!t.modifiersData[o]._skip) {
      for (var d = n.mainAxis, f = void 0 === d || d, _ = n.altAxis, p = void 0 === _ || _, h = n.fallbackPlacements, m = n.padding, g = n.boundary, E = n.rootBoundary, v = n.altBoundary, b = n.flipVariations, y = void 0 === b || b, O = n.allowedAutoPlacements, S = t.options.placement, I = (0, i.Z)(S) === S, T = h || (I || !y ? [(0, r.Z)(S)] : u(S)), N = [S].concat(T).reduce(function(e, n) {
