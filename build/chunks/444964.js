...
(i = s = exports.ICalEventStatus || (exports.ICalEventStatus = {})).CONFIRMED = "CONFIRMED", i.TENTATIVE = "TENTATIVE", i.CANCELLED = "CANCELLED", (r = o = exports.ICalEventBusyStatus || (exports.ICalEventBusyStatus = {})).FREE = "FREE", r.TENTATIVE = "TENTATIVE", r.BUSY = "BUSY", r.OOF = "OOF", (n = d = exports.ICalEventTransparency || (exports.ICalEventTransparency = {})).TRANSPARENT = "TRANSPARENT", n.OPAQUE = "OPAQUE", exports.default = class {
  ...
  toJSON() {
    var t;
    let e = null;
    return (0, Chunk139761.isRRule)(this.data.repeating) || "string" == typeof this.data.repeating ? e = this.data.repeating.toString() : this.data.repeating && (e = Object.assign({}, this.data.repeating, {
      until: (0, Chunk139761.toJSON)(this.data.repeating.until),
      exclude: null == (t = this.data.repeating.exclude) ? true : module.map(t => (0, h.toJSON)(t))
    })), Object.assign({}, this.data, {
      start: (0, Chunk139761.toJSON)(this.data.start) || null,
      end: (0, Chunk139761.toJSON)(this.data.end) || null,
      recurrenceId: (0, Chunk139761.toJSON)(this.data.recurrenceId) || null,
      stamp: (0, Chunk139761.toJSON)(this.data.stamp) || null,
      created: (0, Chunk139761.toJSON)(this.data.created) || null,
      lastModified: (0, Chunk139761.toJSON)(this.data.lastModified) || null,
      repeating: exports,
      x: this.x()
    })
  }
  toString() {
    ...
    return n += "BEGIN:VEVENT\r\n", n += "UID:" + this.data.id + "\r\n", n += "SEQUENCE:" + this.data.sequence + "\r\n", n += "DTSTAMP:" + (0, Chunk139761.formatDate)(this.calendar.timezone(), this.data.stamp) + "\r\n", this.data.allDay ? (n += "DTSTART;VALUE=DATE:" + (0, Chunk139761.formatDate)(this.calendar.timezone(), this.data.start, true) + "\r\n", this.data.end && (n += "DTEND;VALUE=DATE:" + (0, Chunk139761.formatDate)(this.calendar.timezone(), this.data.end, true) + "\r\n"), n += "X-MICROSOFT-CDO-ALLDAYEVENT:TRUE\r\n", n += "X-MICROSOFT-MSNCALENDAR-ALLDAYEVENT:TRUE\r\n") : (n += (0, Chunk139761.formatDateTZ)(this.timezone(), "DTSTART", this.data.start, this.data) + "\r\n", this.data.end && (n += (0, Chunk139761.formatDateTZ)(this.timezone(), "DTEND", this.data.end, this.data) + "\r\n")), (0, Chunk139761.isRRule)(this.data.repeating) || "string" == typeof this.data.repeating ? n += this.data.repeating.toString().replace(/\r\n/g, "\n").split("\n").filter(t => t && !t.startsWith("DTSTART:")).join("\r\n") + "\r\n" : this.data.repeating && (n += "RRULE:FREQ=" + this.data.repeating.freq, this.data.repeating.count && (n += ";COUNT=" + this.data.repeating.count), this.data.repeating.interval && (n += ";INTERVAL=" + this.data.repeating.interval), this.data.repeating.until && (n += ";UNTIL=" + (0, Chunk139761.formatDate)(this.calendar.timezone(), this.data.repeating.until)), this.data.repeating.byDay && (n += ";BYDAY=" + this.data.repeating.byDay.join(",")), this.data.repeating.byMonth && (n += ";BYMONTH=" + this.data.repeating.byMonth.join(",")), this.data.repeating.byMonthDay && (n += ";BYMONTHDAY=" + this.data.repeating.byMonthDay.join(",")), this.data.repeating.bySetPos && (n += ";BYSETPOS=" + this.data.repeating.bySetPos), this.data.repeating.startOfWeek && (n += ";WKST=" + this.data.repeating.startOfWeek), n += "\r\n", this.data.repeating.exclude && (this.data.allDay ? n += "EXDATE;VALUE=DATE:" + this.data.repeating.exclude.map(t => (0, h.formatDate)(this.calendar.timezone(), t, true)).join(",") + "\r\n" : (n += "EXDATE", this.timezone() ? n += ";TZID=" + this.timezone() + ":" + this.data.repeating.exclude.map(t => (0, h.formatDate)(this.timezone(), t, false, true)).join(",") + "\r\n" : n += ":" + this.data.repeating.exclude.map(t => (0, h.formatDate)(this.timezone(), t)).join(",") + "\r\n"))), this.data.recurrenceId && (n += (0, Chunk139761.formatDateTZ)(this.timezone(), "RECURRENCE-ID", this.data.recurrenceId, this.data) + "\r\n"), n += "SUMMARY:" + (0, Chunk139761.escape)(this.data.summary) + "\r\n", this.data.transparency && (n += "TRANSP:" + (0, Chunk139761.escape)(this.data.transparency) + "\r\n"), (null == (t = this.data.location) ? true : module.title) && (n += "LOCATION:" + (0, Chunk139761.escape)(this.data.location.title + (this.data.location.address ? "\n" + this.data.location.address : "")) + "\r\n", this.data.location.radius && this.data.location.geo && (n += "X-APPLE-STRUCTURED-LOCATION;VALUE=URI;" + (this.data.location.address ? "X-ADDRESS=" + (0, Chunk139761.escape)(this.data.location.address) + ";" : "") + "X-APPLE-RADIUS=" + (0, Chunk139761.escape)(this.data.location.radius) + ";X-TITLE=" + (0, Chunk139761.escape)(this.data.location.title) + ":geo:" + (0, Chunk139761.escape)(null == (e = this.data.location.geo) ? true : exports.lat) + "," + (0, Chunk139761.escape)(null == (a = this.data.location.geo) ? true : require.lon) + "\r\n"), this.data.location.geo && (n += "GEO:" + (0, Chunk139761.escape)(null == (i = this.data.location.geo) ? true : i.lat) + ";" + (0, Chunk139761.escape)(null == (r = this.data.location.geo) ? true : r.lon) + "\r\n")), this.data.description && (n += "DESCRIPTION:" + (0, Chunk139761.escape)(this.data.description.plain) + "\r\n", this.data.description.html && (n += "X-ALT-DESC;FMTTYPE=text/html:" + (0, Chunk139761.escape)(this.data.description.html) + "\r\n")), this.data.organizer && (n += 'ORGANIZER;CN="' + (0, Chunk139761.escape)(this.data.organizer.name) + '"', this.data.organizer.email && this.data.organizer.mailto && (n += ";EMAIL=" + (0, Chunk139761.escape)(this.data.organizer.email)), this.data.organizer.email && (n += ":mailto:" + (0, Chunk139761.escape)(this.data.organizer.mailto || this.data.organizer.email)), n += "\r\n"), this.data.attendees.forEach(function(t) {
      n += t.toString()
    }), this.data.alarms.forEach(function(t) {
      n += t.toString()
    }), this.data.categories.length > 0 && (n += "CATEGORIES:" + this.data.categories.map(function(t) {
      return t.toString()
    }).join() + "\r\n"), this.data.url && (n += "URL;VALUE=URI:" + (0, Chunk139761.escape)(this.data.url) + "\r\n"), this.data.status && (n += "STATUS:" + this.data.status.toUpperCase() + "\r\n"), this.data.busystatus && (n += "X-MICROSOFT-CDO-BUSYSTATUS:" + this.data.busystatus.toUpperCase() + "\r\n"), null !== this.data.priority && (n += "PRIORITY:" + this.data.priority + "\r\n"), n += (0, Chunk139761.generateCustomAttributes)(this.data), this.data.created && (n += "CREATED:" + (0, Chunk139761.formatDate)(this.calendar.timezone(), this.data.created) + "\r\n"), this.data.lastModified && (n += "LAST-MODIFIED:" + (0, Chunk139761.formatDate)(this.calendar.timezone(), this.data.lastModified) + "\r\n"), n += "END:VEVENT\r\n"
  }
}