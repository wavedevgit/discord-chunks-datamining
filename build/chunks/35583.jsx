...
class m extends Chunk73800.PureComponent {
  ...
  handleDownloadApps() {
    (0, Chunk481060.h7j)(e => <c.default{...function(e) {
  ...
  render() {
    switch (this.props.mode) {
      case "UPDATE_AVAILABLE":
        return <Chunk665149.JO hideOnClick={false} tooltip={Chunk388032.intl.string(Chunk388032.t["zp9d//"])} foreground={Chunk220705.downloadArrow} background={Chunk220705.cloud} icon={Chunk481060._8t} className={this.props.className} />;
      case "UPDATE_MANUALLY":
      case "UPDATE_DOWNLOADED":
        return <Chunk665149.JO tooltip={Chunk388032.intl.string(Chunk388032.t.u18OXF)} foreground={Chunk220705.updateIconForeground} onClick={this.handleInstallDownload} icon={Chunk481060._8t} className={this.props.className} />;
      default:
        return null
    }
  }
