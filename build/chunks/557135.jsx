...
let v = {
  async handleVoiceConnect(e) {
    ...
    }) : (v || s || o.default.selectVoiceChannel(t.id), !__OVERLAY__ && (s || R || b || I) && O(t, A), true) : new Promise(e => {
      (0, i.ZDy)(async () => {
        let {
          default: i
        ...
        return n => {
          ...
          return <i channelId={t.id} blockedUserIds={P} ignoredUserIds={w} transitionState={a} onClose={o} onJoin={() => e(this.handleVoiceConnect({
              channel: t,
              connected: s,
              needSubscriptionToAccess: b,
              routeDirectlyToChannel: I,
