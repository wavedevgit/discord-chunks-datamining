...
function I(e, n) {
  ...
  var a = p;
  try {
    for (O(n), _ = r(u); null !== _ && (!(_.expirationTime > n) || e && !R());) {
      var o = _.callback;
      if ("function" == typeof o) {
        _.callback = null, p = _.priorityLevel;
        var s = o(_.expirationTime <= n);
        n = t.unstable_now(), "function" == typeof s ? _.callback = s : _ === r(u) && i(u), O(n)
      } else i(u);
      _ = r(u)
    }
    if (null !== _) var l = !0;
...
t.unstable_IdlePriority = 5, t.unstable_ImmediatePriority = 1, t.unstable_LowPriority = 4, t.unstable_NormalPriority = 3, t.unstable_Profiling = null, t.unstable_UserBlockingPriority = 2, t.unstable_cancelCallback = function(e) {
  ...
  return s = a + s, e = {
    ...
    expirationTime: s,
    sortIndex: -1
  }, a > o ? (e.sortIndex = a, n(d, e), null === r(u) && e === r(d) && (g ? (b(A), A = -1) : g = !0, x(v, a - o))) : (e.sortIndex = s, n(u, e), m || h || (m = !0, L(I))), e
