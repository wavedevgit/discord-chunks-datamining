...
require("./424218.js"), require("./823379.js"), require("./63063.js");
...
let O = [Chunk981631.Eu4.NONE, Chunk981631.Eu4.TIER_1, Chunk981631.Eu4.TIER_2, Chunk981631.Eu4.TIER_3],
  v = O.slice().reverse(),
  S = e => {
    var t;
...
function L(e) {
  ...
  } = Object.values(d.Z.boostSlots).reduce((e, t) => (F(t) && e.numCanceledGuildBoostSlots++, t.isAvailable() && e.numAvailableGuildBoostSlots++, e), {
...
function F(e) {
  var t;
  return (null == (t = e.subscription) ? true : t.status) === _.O0b.CANCELED || e.canceled
}
