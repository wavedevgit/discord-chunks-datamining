...
let v = [Chunk981631.Eu4.NONE, Chunk981631.Eu4.TIER_1, Chunk981631.Eu4.TIER_2, Chunk981631.Eu4.TIER_3],
  ...
  R = e => [{
    ...
    perks: [{
      ...
      title: y.intl.formatToPlainString(y.t.T8P3TE, {
        limit: g.eez
      }),
      description: y.intl.formatToPlainString(y.t.T8P3TE, {
        limit: g.eez
      }),
      icon: 12
    } : null].filter(_.lm)
...
function U(e) {
  ...
  } = Object.values(u.Z.boostSlots).reduce((e, t) => (z(t) && e.numCanceledGuildBoostSlots++, t.isAvailable() && e.numAvailableGuildBoostSlots++, e), {
