...
let N = e => {
    let {
      ...
      size: c.EFr.SIZE_56
    }), o = m.ZP.getName(t), d = t.username !== o && r === _.Fz.SUCCESS, f = r === _.Fz.FAIL;
    return (0, i.jsxs)("div", {
      className: w.referredUserRowContainer,
      children: [(0, i.jsx)(c.qEK, function(e) {
  ...
  Z = e => {
    ...
    return n > 0 && (p = b.intl.formatToPlainString(b.t.iWtOfC, {
      numReferrals: h
    })), 0 === h && (p = b.intl.string(b.t["7VBEue"])), (0, i.jsxs)("div", {
