...
let g = function(e) {
  ...
  return <div className={o()(_.partnerBranding, t)}>{b && <d.Fl id={"QuestPartnerBranding_gameTile"}>{e => (0, r.jsx)("img", {
        ref: e,
        ...
        onLoad: y
      })}</d.Fl>}{<d.Fl id={"QuestPartnerBranding_gameLogotype"}>{e => (0, r.jsx)("img", {
        ref: e,
        ...
        onLoad: y
      })}</d.Fl>}{I && <r.Fragment>{<div className={_.cosponsorBrandSeparatorWrapper} style={{
          margin: "0 ".concat(h, "px")
        }}><l.P$X className={_.cosponsorBrandSeparator} color={a.Z.colors.WHITE} /></div>}{<d.Fl id={"QuestPartnerBranding_cosponsorLogotype"}>{e => {
          var t, i;
          return (0, r.jsx)("img", {
            ref: e,
