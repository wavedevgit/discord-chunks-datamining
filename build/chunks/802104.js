...
class y extends a.Z {
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, p(this, "_checkInterval", null), p(this, "_callbacks", []), p(this, "_bootstrapper", null), p(this, "updateAvailable", !1), p(this, "nativeUpdateAvailable", !1), p(this, "nativeUpdatesDownloaded", 0), p(this, "nativeUpdateCountThreshold", 1), p(this, "actions", {
      ...
      this._handleCheckingForUpdates(), r.tn.get({
        ...
        if (null == e.body || "11b42fe490f2600c8d913c69af5024121857c982" === e.body.hash) return this._handleUpdateNotAvailable();
      ...
      this.updateAvailable = !0, this.nativeUpdateAvailable = e, o.Z.dispatch({
        type: "UPDATE_AVAILABLE"
      })
    }), p(this, "_handleUpdateManually", () => {
      this.updateAvailable = !0, this.nativeUpdateAvailable = !0, o.Z.dispatch({
