...
class b extends o.Z {
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, _(this, "_checkInterval", null), _(this, "_callbacks", []), _(this, "_bootstrapper", null), _(this, "updateAvailable", !1), _(this, "nativeUpdateAvailable", !1), _(this, "nativeUpdatesDownloaded", 0), _(this, "nativeUpdateCountThreshold", 1), _(this, "actions", {
      ...
      this._handleCheckingForUpdates(), r.tn.get({
        ...
        if (null == e.body || "d988a2a4023f9ed55e196713c6444b2a861ffa46" === e.body.hash) return this._handleUpdateNotAvailable();
      ...
      this.updateAvailable = !0, this.nativeUpdateAvailable = e, a.Z.dispatch({
        type: "UPDATE_AVAILABLE"
      })
    }), _(this, "_handleUpdateManually", () => {
      this.updateAvailable = !0, this.nativeUpdateAvailable = !0, a.Z.dispatch({
