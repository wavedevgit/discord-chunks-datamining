...
let x = new Z(u.Z, {
  ...
  CHANNEL_SETTINGS_PERMISSIONS_UPDATE_PERMISSION: function(e) {
    ...
    l = _(b({}, l), {
      ...
      [t]: l
    }), E.add(t), O = f.QZA.OPEN, I = !o().isEqual(y, v), r = d.o4(C, S)
  },
  ...
  CHANNEL_UPDATES: function(e) {
    ...
    for (let e of t) !1 !== function(e) {
      ...
      return E.forEach(e => {
        null != y && (n[e] = y[e])
      }), null == n[t] && null == C.permissionOverwrites[t] && (n[t] = d.we(t)), null == (y = b({}, C.permissionOverwrites, n))[N] ? N = t : null != T && null != y[T] && (N = T, T = null), r = d.o4(C, S), !0
    }(e.id) && (n = !0);
    return n
  },
