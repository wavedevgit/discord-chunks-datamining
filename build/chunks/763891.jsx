...
function N(e) {
  ...
  return (l.useEffect(() => {
    ...
    n || (0, h.n)({
      ...
      cacheDisabled: Z
  ...
  }, [R, N, D, Z, n, A]), n || null == F) ? <m.Z /> : <r.Fragment>{<div style={{
        backgroundImage: "url(".concat(q, ")")
      }} className={S.bannerContainer}><s.X6q variant={"heading-xxl/extrabold"}>{G}</s.X6q></div>}{<div className={S.products}>{J.slice(40 * (H - 1), 40 * H).map((e, t) => {
        ...
        return null == n ? null : (0, r.jsx)(p.k0, {
      ...
      })}</div>}{J.length > 40 && <div className={S.paginationContainer}><div><s.DsT currentPage={H} totalCount={J.length} pageSize={40} onPageChange={e => {
          ...
          }} disablePaginationGap={true} /></div></div>}</r.Fragment>
}