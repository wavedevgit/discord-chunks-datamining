...
function N(e) {
  ...
  })), E = (0, a.ZP)(), D = (0, s.wjy)(E), [R, I] = (0, r.useState)(D), A = (0, g.ZP)(t.id, null), {
    bannerSrc: L
  } = (0, h.Z)({
    displayProfile: A,
    size: 413,
  ...
  return (D && R || !D && !R) && (B = E), (0, o.jsxs)("div", {
    ...
    children: [(0, o.jsx)(s.xBx, {
      ...
      children: [(0, o.jsx)(s.Text, {
        ...
        color: "text-muted",
        children: S.intl.format(C.default.prQba2, {
          helpArticleLink: x.Z.getArticleURL(y.BhN.DISPLAY_NAME_STYLES)
        })
      }), (0, o.jsx)(k, {
        darkPreview: R,
