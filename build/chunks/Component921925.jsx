...
function p(e) {
  ...
  let y = _.length > 1,
    O = null != b ? b.message : "";
  if (null != b && b instanceof s.Ey && (b.code === o.tG.CARD_DECLINED && y && (O += " ".concat(f.intl.string(f.t.iWvwQS))), b.code === o.tG.INVALID_GIFT_REDEMPTION_FRAUD_REJECTED && (O = f.intl.string(f.t.ypuSd8)), b.code === d.t02.BILLING_NON_REFUNDABLE_PAYMENT_SOURCE && (O = f.intl.string(f.t.mXMmWE)), b.code === o.tG.INVALID_CURRENCY_FOR_PAYMENT_SOURCE && (O = f.intl.string(f.t.mC1Fjz)), b.code === o.tG.INVALID_BILLING_ADDRESS)) {
