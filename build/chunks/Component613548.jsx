...
function R(e) {
  let {
    ...
    let e = Date.now();
    return s()(S.Z.getSpeakers()).map(e => P.Z.getParticipant(t, e)).filter(e => null != e && e.type === T.fO.USER && e.speaking && !(0, C.ZP)(e)).sortBy(t => -S.Z.getSpeakingDuration(t.user.id, e)).slice(0, 3).value()
  });
...
function k(e) {
  ...
  }), D = !N && L && (t.isGuildVoice() || t.isGroupDM()), {
    enabled: U,
    inInbox: B
  } = b.Z.useExperiment({
    location: "ChannelCallHeaderToolbar"
  }), V = [];
  return C && V.push((0, r.jsx)(R, {
    channelId: s,
    guildId: t.guild_id
  }, "current-speaker")), V.push((0, r.jsx)(m.Z, {
    className: A.button,
    channelId: s
  }, "clips-enabled-indicator")), (null == E ? true : E.type) === T.fO.STREAM && (V.push((0, r.jsx)(_.Z, {
    className: A.button,
    participant: E
  }, "warning")), V.push((0, r.jsx)(g.Z, {
    size: f.ZP.Sizes.LARGE,
    className: A.button,
    participant: E,
    showQuality: true,
    premiumIndicator: false
  }, "live-indicator"))), (null == E ? true : E.type) === T.fO.USER && V.push((0, r.jsx)(v.Z, {
    className: A.button,
    userId: E.id
  }, "video-warning")), C && !L && V.push((0, r.jsx)(u.yRy, {
    targetElementRef: l,
    position: "bottom",
  ...
  }, "call-members-popout")), U && !B && V.push((0, r.jsx)(y.Z, {
    className: A.button
  }, "for-later")), D && V.push((0, r.jsx)(j.Z, {
    className: a()(A.button, {
      [A.lastButton]: n
    }),
    onClick: () => d.Z.toggleParticipantsList(t.id, !N)
  }, "participants-list-button")), k && V.push((0, r.jsx)(O.T, {
    channelId: t.id,
    className: a()(A.button, {
      [A.lastButton]: N
    }),
