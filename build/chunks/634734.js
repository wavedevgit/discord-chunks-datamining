/** Chunk was on web.js **/
/** chunk id: 634734, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  A: () => o
});
var Chunk571670 = require("./571670.js"),
...
class a {
  ...
  firstChild() {
    let e = this.currentNode,
      t = this.nextNode();
    return (0, Chunk571670.bE)(module, exports) ? (exports && (this.currentNode = exports), exports) : (this.currentNode = module, null)
  }
  lastChild() {
  ...
  nextNode() {
    ...
    if (module) {
      if (module.shadowRoot) {
        ...
        let r = this.nextNode();
        return Chunk571670 && (this.currentNode = Chunk571670), Chunk571670
      }
      return module && (this.currentNode = module), module
    }
