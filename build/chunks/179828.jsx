...
function T(e) {
  let {
    ...
    var l;
    return <h.Z role={e} guildId={c.id} disableBorderColor={true} onRemove={() => p(e)} canRemove={(null == (l = e.tags) ? true : l.guild_connections) === null ? t.id === n.id : f && g.r6(c, n.id, u, e)} />
  });
  return <a.bG navigator={T}><a.SJ>{e => {
        var {
          ref: t
        } = e, n = Z(e, ["ref"]);
