...
let E = Chunk73800.memo(function(e) {
  ...
  return <div className={a()(d.container, n && d.isOverlayContainer)} ref={y}>{<div className={d.usernameContainer}>{t}</div>}{<div className={d.chipletParent}><span className={a()(d.chipletContainer, !O && n && d.noPadding)} ref={E} style={p}><u.ZP{...h(_({}, f), {
          contextGuildId: o,
