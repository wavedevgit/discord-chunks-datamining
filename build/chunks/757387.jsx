...
let V = (0, Chunk108843.Z)((0, Chunk883385.Z)(function(e) {
  ...
  return <i.v2r navId={"user-context"} onClose={d.Zy} aria-label={H.intl.string(H.t.liqwPD)} onSelect={Y} onInteraction={J}>{!e_ && <t.Fragment>{<i.kSQ>{eC}{o && !F && eI}{F && em}</i.kSQ>}{<i.kSQ>{B && ee}{u && el}{en}{er}{ev}{B && ei}{B && ed}{et}</i.kSQ>}{o && <i.kSQ>{es}</i.kSQ>}{<i.kSQ>{B && eZ}</i.kSQ>}{<i.kSQ>{o && eo}{o && ea}{o && eE}{B && ec}{ex}{B && eu}{eg}{B && ef}{B && eh}{V && eM}</i.kSQ>}{<i.kSQ>{eb}</i.kSQ>}{<i.kSQ>{ej}{eO}</i.kSQ>}{V && <i.kSQ>{eN}{eP}</i.kSQ>}</t.Fragment>}{<i.kSQ>{ep}</i.kSQ>}</i.v2r>
}, {
