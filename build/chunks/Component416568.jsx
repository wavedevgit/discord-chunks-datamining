...
function ec(e) {
  let {
    ...
    startSorting: C,
    stopSorting: E
  } = (0, M.Z)(), Z = i.useRef(false), [T] = i.useState(() => new f.V7), A = i.useRef(null), G = i.useRef(null), B = (0, u.OP)(), {
    ref: F
  } = B, V = function(e, t) {
    if (null == e) return {};
    ...
    location: "GuildsBar"
  }), ep = +!!en + +!!eu + +(ed === P.u3.SERVER_RAIL_TOP), eh = i.useMemo(() => {
  ...
  (0, _.Ng)(() => {
    ...
    if (eh.setGuildsTree(s), Z.current || 0 === s.size) return;
