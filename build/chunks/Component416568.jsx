...
function es(e) {
  let {
    ...
    scrollToTop: n,
    lurkingGuildIds: i
  } = e, l = (0, C.Z)(), o = (0, p.Wu)([R.Z, A.ZP], () => R.Z.getGuildIds().filter(e => A.ZP.isCurrentUserGuest(e))), a = i.concat(o), {
    entrypoint: s
  } = (0, I.pN)({
    location: "GuildsBar"
  }), c = N.o.useConfig({
...
function eu(e) {
  let {
    ...
    location: "GuildsBar"
  }), ed = +!!$ + +(eu === I.u3.SERVER_RAIL_TOP), ep = i.useMemo(() => {
  ...
  } = (0, v.ZP)(O.Z.GUILDS_LIST), ef = eo(er);
  (0, _.Ng)(() => {
