...
function es(e) {
  let {
    ...
    scrollToTop: n,
    lurkingGuildIds: i
  } = e, l = (0, C.Z)(), o = (0, f.Wu)([R.Z, A.ZP], () => R.Z.getGuildIds().filter(e => A.ZP.isCurrentUserGuest(e))), a = i.concat(o), {
    entrypoint: s
  } = (0, I.pN)({
    location: "GuildsBar"
  }), c = N.o.useConfig({
...
function eu(e) {
  let {
    ...
    let e = D.ZP.getGuildsTree();
    return [e, e.version]
  }), d = (0, f.e7)([S.Z], () => S.Z.lurkingGuildIds()), h = i.useMemo(() => n ? [] : d, [d, n]), b = (0, f.e7)([j.Z], () => j.Z.isFullscreenInContext()), {
    isSorting: y,
    startSorting: x,
    stopSorting: E
    ...
    return i
  }(B, ["ref"]), H = (0, m.mFp)(), [z, K] = i.useState(false), q = (0, m.dQu)(g.Z.modules.guildbar.AVATAR_SIZE), J = (0, m.dQu)(g.Z.space.SPACE_XS), $ = (0, C.Z)(), {
    pathname: er
  } = (0, c.TH)(), {
    entrypoint: eu
  } = (0, I.pN)({
  ...
  } = (0, v.ZP)(O.Z.GUILDS_LIST), ep = eo(er);
  (0, _.Ng)(() => {
