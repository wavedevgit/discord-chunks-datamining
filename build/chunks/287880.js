...
let c = null != (s = null == (n = window) ? void 0 : n.crypto) ? s : null == (i = window) ? void 0 : i.msCrypto,
  a = "Uint8Array" in window,
  l = null != c && "getRandomValues" in c && a,
  d = "PublicKeyCredential" in window && a;

function u() {
  var e;
  return e = c.getRandomValues(new Uint8Array(20)), o.encode(e).toString("utf8").replace(/=/g, "").toLowerCase().replace(/(\w{4})/g, "$1 ").trim()
}
