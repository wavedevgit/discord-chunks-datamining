...
function S(e) {
  ...
  } = (0, u.XJ)(null != S ? S : n), U = M(T), F = (0, x.ZP)(T), V = (0, b.T)(null == S ? void 0 : S.id, T.id), {
    withinStartWindow: A
  } = (0, Z.ub)(L), X = (0, i.e7)([g.Z], () => null == S || !S.isGuildVocal() || g.Z.can(I.Plq.CONNECT, S), [S]), z = (0, a.J)(G), H = (0, j.Z)(w, B);
  ...
  return {
    onDeleteClick: U ? function(e) {
      e.stopPropagation(), U && !k && (0, r.h7j)(e => (0, l.jsx)(r.ConfirmModal, O(E({}, e), {
    ...
    onRsvpClick: W,
    onStartClick: U && A && !(null == H ? void 0 : H.is_canceled) ? function(e) {
      e.stopPropagation(), (0, r.ZDy)(async () => {
        let {
          default: e
        } = await Promise.all([t.e("84722"), t.e("4598")]).then(t.bind(t, 296864));
        return n => (0, l.jsx)(e, O(E({}, n), {
          event: T,
          onSuccess: R
        }))
      })
    ...
    onInviteClick: function(e) {
      if (e.stopPropagation(), null != n) {
        if (!F || !V) {
          ...
          (0, v.JG)(e), m.default.track(I.rMx.GUILD_SCHEDULED_EVENT_LINK_COPIED, {
            guild_id: G,
          ...
          let {
            default: e
          } = await Promise.all([t.e("7654"), t.e("49049"), t.e("29328")]).then(t.bind(t, 560114));
    ...
    onEndClick: U && D === C.WX.EXTERNAL && k ? function(e) {
      if (e.stopPropagation(), !U) return;
      let n = () => {
        p.Z.endEvent(B, G), (0, r.pTH)()
      };
      (0, r.h7j)(e => (0, l.jsx)(r.ConfirmModal, O(E({}, e), {
