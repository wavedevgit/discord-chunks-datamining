...
function D(e) {
  ...
  } = (0, c.XJ)(null != D ? D : n), B = R(O), w = (0, h.ZP)(O), H = (0, E.T)(null == D ? void 0 : D.id, O.id), {
    withinStartWindow: M
  } = (0, b.ub)(P), X = (0, l.e7)([m.Z], () => null == D || !D.isGuildVocal() || m.Z.can(L.Plq.CONNECT, D), [D]), V = (0, s.J)(A), F = (0, C.Z)(Z, z);
  ...
  return {
    onDeleteClick: B ? function(e) {
      e.stopPropagation(), B && !U && (0, r.h7j)(e => (0, i.jsx)(r.ConfirmModal, S(N({}, e), {
    ...
    onEndClick: B && k === y.WX.EXTERNAL && U ? function(e) {
      ...
      (0, r.h7j)(e => (0, i.jsx)(r.ConfirmModal, S(N({}, e), {
