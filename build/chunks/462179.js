...
function I(e) {
  ...
  } = (0, u.XJ)(null != I ? I : n), U = M(S), z = (0, b.ZP)(S), A = (0, x.T)(null == I ? void 0 : I.id, S.id), {
    withinStartWindow: J
  ...
  async function q(e) {
    e.stopPropagation(), await c.Z.joinGuild(H), f.Z.addConditionalChangeListener(() => null == f.Z.getGuild(H) || (T || V(e), K(e), !1))
  }
  ...
  return {
    ...
    onRsvpClick: V,
    onStartClick: U && J && !(null == W ? void 0 : W.is_canceled) ? function(e) {
