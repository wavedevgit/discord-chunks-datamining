...
function D(e) {
  ...
  } = (0, c.XJ)(null != D ? D : n), B = R(O), w = (0, h.ZP)(O), H = (0, C.T)(null == D ? void 0 : D.id, O.id), {
    withinStartWindow: M
  } = (0, b.ub)(P), X = (0, l.e7)([m.Z], () => null == D || !D.isGuildVocal() || m.Z.can(L.Plq.CONNECT, D), [D]), V = (0, s.J)(A), F = (0, E.Z)(G, z);
  ...
  return {
    onDeleteClick: B ? function(e) {
      e.stopPropagation(), B && !U && (0, r.h7j)(e => (0, i.jsx)(r.ConfirmModal, S(j({}, e), {
    ...
    onInviteClick: function(e) {
      if (e.stopPropagation(), null != n) {
        if (!w || !H) {
          ...
          (0, f.JG)(e), I.default.track(L.rMx.GUILD_SCHEDULED_EVENT_LINK_COPIED, {
            guild_id: A,
    ...
    onEndClick: B && k === y.WX.EXTERNAL && U ? function(e) {
