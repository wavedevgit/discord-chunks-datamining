...
let eu = () => {
  let {
  ...
  } = (0, d.ZP)(c.Z.PREMIUM_MARKETING_PERK_CARD), t = (0, o.ZP)(), n = (0, C.BU)(N.Uq / 1024, {
    useKibibytes: !0
  }), i = (0, s.e7)([E.ZP], () => E.ZP.getPremiumTypeSubscription()), ed = null != i ? O.ZP.getPremiumPlanItem(i) : null, eu = (null != ed ? O.ZP.getSkuIdForPlan(ed.planId) : null) === N.Si.TIER_2, em = x.default.getCurrentUser(), eg = (0, O.I5)(em, N.p9.TIER_2), ep = (0, O.I5)(em, N.p9.TIER_0), eh = (0, m.Z)(_.Z), ef = (0, p.H)("usePremiumPerksCards"), {
    isFractionalPremiumActive: eb
  } = (0, u.Z)(), e_ = null != i && i.hasPremiumAtLeast(N.p9.TIER_2), ex = (0, g.wE)(l.z.PERMADECOS_NITRO_HOME_CARD_NEW_BADGE), eE = (0, h.Z)({
    ...
    serverBoosts: {
      ...
      description: eb ? D.intl.format(D.t.uPiIBQ, {
        link: "https://discord.com"
      }) : D.intl.string(D.t.jsyNHh),
      descriptionCta: D.intl.string(D.t.jVcuVV),
      onCtaClick: eb ? void 0 : () => {
    ...
    referralProgram: {
      ...
      description: D.intl.format(D.t["2JqTFx"], {
        helpdeskArticle: j.Z.getArticleURL(y.BhN.REFERRAL_PROGRAM)
      }),
    ...
    permadecos: {
      ...
      description: D.intl.format(D.t.Pd7olp, {
        learnMoreLink: j.Z.getArticleURL(y.BhN.PERMADECOS)
      }),
      descriptionCta: eg ? D.intl.string(D.t.jVcuVV) : D.intl.string(D.t.JST6jo),
      isPremiumGetCta: !eg,
      onCtaClick: eg ? () => {
        ex || (0, g.EW)(l.z.PERMADECOS_NITRO_HOME_CARD_NEW_BADGE, {
