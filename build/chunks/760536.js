...
var r = n(288660),
  ...
  d = function(e, t) {
    ...
    if (t.charsetSentinel)
      for (m = 0; m < f.length; ++m) 0 === f[m].indexOf("utf8=") && (f[m] === u ? h = "utf-8" : f[m] === c && (h = "iso-8859-1"), p = m, m = f.length);
    for (m = 0; m < f.length; ++m)
      if (m !== p) {
        var m, g, E, b = f[m],
          y = b.indexOf("]="),
          O = -1 === y ? b.indexOf("=") : y + 1; - 1 === O ? (g = t.decoder(b, o.decoder, h, "key"), E = t.strictNullHandling ? null : "") : (g = t.decoder(b.slice(0, O), o.decoder, h, "key"), E = r.maybeMap(l(b.slice(O + 1), t, a(n[g]) ? n[g].length : 0), function(e) {
          return t.decoder(e, o.decoder, h, "value")
        })), E && t.interpretNumericEntities && "iso-8859-1" === h && (E = s(String(E))), b.indexOf("[]=") > -1 && (E = a(E) ? [E] : E);
        var v = i.call(n, g);
    ...
    for (var s = i ? t : l(t, n, a), c = e.length - 1; c >= 0; --c) {
      ...
      if ("[]" === d && n.parseArrays) u = n.allowEmptyArrays && ("" === s || n.strictNullHandling && null === s) ? [] : r.combine([], s);
        ...
        var _ = "[" === d.charAt(0) && "]" === d.charAt(d.length - 1) ? d.slice(1, -1) : d,
          ...
          p = parseInt(f, 10);
        n.parseArrays || "" !== f ? !isNaN(p) && d !== f && String(p) === f && p >= 0 && n.parseArrays && p <= n.arrayLimit ? (u = [])[p] = s : "__proto__" !== f && (u[f] = s) : u = {
          0: s
        }
      }
      s = u
