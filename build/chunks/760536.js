  ...
  d = function(e, t) {
    ...
    for (m = 0; m < _.length; ++m)
      if (m !== p) {
        var m, g, E, b = _[m],
          y = b.indexOf("]="),
          v = -1 === y ? b.indexOf("=") : y + 1; - 1 === v ? (g = t.decoder(b, o.decoder, h, "key"), E = t.strictNullHandling ? null : "") : (g = t.decoder(b.slice(0, v), o.decoder, h, "key"), E = r.maybeMap(l(b.slice(v + 1), t, a(n[g]) ? n[g].length : 0), function(e) {
    ...
    for (var s = i ? t : l(t, n, a), c = e.length - 1; c >= 0; --c) {
      ...
      if ("[]" === d && n.parseArrays) u = n.allowEmptyArrays && ("" === s || n.strictNullHandling && null === s) ? [] : r.combine([], s);
        ...
        var f = "[" === d.charAt(0) && "]" === d.charAt(d.length - 1) ? d.slice(1, -1) : d,
          ...
          p = parseInt(_, 10);
        n.parseArrays || "" !== _ ? !isNaN(p) && d !== _ && String(p) === _ && p >= 0 && n.parseArrays && p <= n.arrayLimit ? (u = [])[p] = s : "__proto__" !== _ && (u[_] = s) : u = {
          0: s
        }
      }
      s = u
