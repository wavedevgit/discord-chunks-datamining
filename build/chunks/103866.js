...
function p(e) {
  let {
    controls: t,
    children: n
  } = e, [a, u] = i.useState(!1), [_, f] = i.useState(!1), p = i.useRef(null), h = i.useRef(null), m = (0, s.throttle)(() => {
    var e;
  ...
  return i.useLayoutEffect(() => {
    ...
    children: [(0, r.jsx)("div", {
      className: o()(d.bodySpacerTop, {
        [d.bodySpacerTopBorder]: _ && null == t
      })
      ...
      children: (0, r.jsx)("main", {
        ...
        className: o()(d.bodyInner, {
          [d.bodyInnerShouldScroll]: _
        }),
        children: n
      })
    }), (0, r.jsx)("div", {
      className: o()(d.bodySpacerBottom, {
        [d.bodySpacerBottomBorder]: _
      })
    })]
  })
}