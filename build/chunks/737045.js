/** Chunk was on web.js **/
/** chunk id: 737045, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  $N: () => d,
  T6: () => c,
...
var Chunk718574 = require("./718574.jsx"),
  Chunk926983 = require("./926983.jsx"),
...
function p(e, t, c) {
  ...
  return {
      ...
      description: (() => {
        switch (u) {
          ...
          case o.rbe.GUILD_FORUM:
            return (null == c ? true : c.createPostsDisabled) && !e.isMediaChannel() ? r.A.getForumChannelPermissionText() : l.t.LG9VAi;
          ...
          case o.rbe.GUILD_VOICE:
            return i.A.getTextInVoiceSendMessageChannelPermissionText(null == c ? true : c.sendMessagesDisabled);
          default:
            return l.t.WQ6zpT
        }
      })(),
    ...
    [o.xBc.MENTION_EVERYONE.toString()]: {
      title: u === o.rbe.GUILD_STAGE_VOICE ? l.intl.string(l.t.VDUAHO) : (null == c ? true : c.inGameMentionsExperiment) ? l.intl.string(l.t.lEO7Wr) : l.intl.string(l.t.Y78KGC),
      description: u === o.rbe.GUILD_CATEGORY ? l.t["HOhg/B"] : u === o.rbe.GUILD_STAGE_VOICE ? l.t.rZn1oO : (null == c ? true : c.inGameMentionsExperiment) ? l.t.wdHpIC : l.t["6IUSdt"],
      ...
      description: (() => {
        switch (u) {
          case o.rbe.GUILD_CATEGORY:
            return l.t["cJRv/g"];
          case o.rbe.GUILD_VOICE:
            return i.A.getTextInVoiceReadMessageHistoryChannelPermissionText(null == c ? true : c.readMessageHistoryDisabled);
          case o.rbe.GUILD_FORUM:
          case o.rbe.GUILD_MEDIA:
            return l.t.RqCc7i;
          default:
