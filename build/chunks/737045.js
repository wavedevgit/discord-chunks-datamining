...
var i, n, Chunk718574 = require("./718574.jsx"),
...
function D(t, e, i) {
  ...
  return {
      ...
      description: (() => {
        switch (n) {
          ...
          case S.rbe.GUILD_FORUM:
            return (null == i ? true : i.createPostsDisabled) && !t.isMediaChannel() ? E.A.getForumChannelPermissionText() : _.t.LG9VAi;
          ...
          case S.rbe.GUILD_VOICE:
            return c.A.getTextInVoiceSendMessageChannelPermissionText(null == i ? true : i.sendMessagesDisabled);
          default:
            return _.t.WQ6zpT
        }
      })(),
    ...
    [S.xBc.MENTION_EVERYONE.toString()]: {
      title: n === S.rbe.GUILD_STAGE_VOICE ? _.intl.string(_.t.VDUAHO) : (null == i ? true : i.inGameMentionsExperiment) ? _.intl.string(_.t.lEO7Wr) : _.intl.string(_.t.Y78KGC),
      description: n === S.rbe.GUILD_CATEGORY ? _.t["HOhg/B"] : n === S.rbe.GUILD_STAGE_VOICE ? _.t.rZn1oO : (null == i ? true : i.inGameMentionsExperiment) ? _.t.wdHpIC : _.t["6IUSdt"],
      ...
      description: (() => {
        switch (n) {
          case S.rbe.GUILD_CATEGORY:
            return _.t["cJRv/g"];
          case S.rbe.GUILD_VOICE:
            return c.A.getTextInVoiceReadMessageHistoryChannelPermissionText(null == i ? true : i.readMessageHistoryDisabled);
          case S.rbe.GUILD_FORUM:
          case S.rbe.GUILD_MEDIA:
            return _.t.RqCc7i;
          default:
