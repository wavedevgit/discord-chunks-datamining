...
function R(e) {
  let {
    guild: t
  } = e, o = (0, l.e7)([u.Z], () => u.Z.getEnabled(t.id)), h = (0, l.e7)([f.Z], () => f.Z.hasFetched(t.id)), x = (0, y.Z)(t), b = (0, l.e7)([v.Z], () => v.Z.editedDefaultChannelIds), j = x.filter(e => !b.has(e.id)), [O, C] = i.useState(!1);
  i.useEffect(() => {
    h || o || (0, p.S)(t.id)
  }, [t.id, h, o]);
  let N = e => {
  ...
  return O || 0 === j.length ? null : (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(a.Text, {
      ...
      children: j.map((e, n) => (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsxs)("div", {
          ...
          children: [(0, r.jsxs)("div", {
            ...
            }), null != e.topic && e.topic.length > 0 ? (0, r.jsx)(c.Z, {
              className: w.markup,
              children: (0, r.jsx)(a.Text, {
                className: P.topic,
                variant: "text-xs/normal",
...
function Z(e) {
  let {
    saveOnClose: t = !1
  } = e, n = (0, l.e7)([j.Z], () => j.Z.getGuild()), s = (0, l.e7)([u.Z], () => u.Z.isLoading()), o = (0, l.e7)([x.ZP], () => x.ZP.getChannels(null == n ? void 0 : n.id)), c = (0, l.e7)([h.Z], () => h.Z.getCategories(null == n ? void 0 : n.id)), d = (0, l.e7)([C.Z], () => C.Z.advancedMode), m = i.useRef(null), [g, p] = i.useState(!1), f = i.useRef(n);
  return (i.useEffect(() => {
    f.current = n
  }), i.useEffect(() => {
    if (t) {
  ...
  }, [t, d]), null == n) ? null : s ? (0, r.jsx)(a.$jN, {}) : (0, r.jsxs)("div", {
    className: P.columns,
    children: [(0, r.jsxs)("div", {
...
function D() {
  ...
  return null == e ? null : (0, r.jsx)(o.Z, {
    onSave: () => {
      (0, _.DO)(e).then(() => {
        n && (0, O.rS)(e, {
          ignoreDefaultPrompt: !0
