...
function P(e) {
  let {
    guild: t
  } = e, a = (0, l.e7)([d.Z], () => d.Z.getEnabled(t.id)), h = (0, l.e7)([p.Z], () => p.Z.hasFetched(t.id)), f = (0, C.Z)(t), x = (0, l.e7)([_.Z], () => _.Z.editedDefaultChannelIds), b = f.filter(e => !x.has(e.id)), [v, O] = i.useState(!1);
  i.useEffect(() => {
    h || a || (0, g.S)(t.id)
  }, [t.id, h, a]);
  let y = e => {
...
function w(e) {
  let {
    saveOnClose: t = !1
  } = e, n = (0, l.e7)([b.Z], () => b.Z.getGuild()), a = (0, l.e7)([d.Z], () => d.Z.isLoading()), o = (0, l.e7)([f.ZP], () => f.ZP.getChannels(null == n ? void 0 : n.id)), c = (0, l.e7)([h.Z], () => h.Z.getCategories(null == n ? void 0 : n.id)), u = (0, l.e7)([O.Z], () => O.Z.advancedMode), m = i.useRef(null), [g, p] = i.useState(!1), _ = i.useRef(n);
  return (i.useEffect(() => {
    _.current = n
  }), i.useEffect(() => {
    if (t) {
