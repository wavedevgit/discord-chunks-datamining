  ...
  p = e => {
    ...
    switch (n) {
      case o.cJ.PERKS_DISCOVERABILITY:
        p = false === i ? [t.profiles, t.moreEmojiPower, t.largeUploads, t.hdVideo, t.clientThemes, t.customAppIcons] : l === c.xc.FP_ONLY || u ? [t.profiles, t.clientThemes, t.hdVideo] : [t.profiles, t.clientThemes, t.serverBoosts];
        break;
      case o.cJ.WHATS_NEW:
        p = (e => {
          let {
