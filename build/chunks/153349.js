...
let R = i.memo(function(e) {
  ...
  w = i.memo(function(e) {
    ...
    })), R = (0, c.e7)([y.ZP], () => y.ZP.getMember(E, a.user.id)), w = (0, m.X7)(l.guild_id, null == R ? void 0 : R.userId, null != (t = null == R ? void 0 : R.colorStrings) ? t : null), A = i.useMemo(() => ({
      [E]: [a.user.id]
    }), [E, a.user.id]);
    (0, f.$)(A);
