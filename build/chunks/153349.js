...
let A = i.memo(function(e) {
    ...
    return (0, r.jsxs)(m.ZP, {
      ...
      children: [(0, r.jsx)(m.ZP.Icon, {
        ...
        children: S.intl.string(S.t.TYZgzc)
      })]
    })
  }),
  w = i.memo(function(e) {
    ...
    } = e, m = i.useRef(null), [x, v] = i.useState(o);
    (0, h.ZP)(() => {
      if (!x) return;
...
function k(e) {
  let {
    ...
    chatOpen: i
  } = e, l = (0, v.Fd)(t.id), o = [+!!(0, c.e7)([x.Z], () => x.Z.can(P.Pl.MANAGE_CHANNELS, t) || x.Z.can(P.Pl.MANAGE_ROLES, t)), Math.max(1, l.length)];
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(A, {
      ...
      renderSection: function(e) {
        ...
        return 1 === t ? (0, r.jsx)(u.Text, {
          ...
          color: "header-secondary",
          children: l.length > 0 ? S.intl.formatToPlainString(S.t["5z7q5e"], {
            numHands: l.length
          }) : S.intl.string(S.t.TYZgzc)
