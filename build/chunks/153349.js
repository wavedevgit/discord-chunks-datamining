...
let w = i.memo(function(e) {
  ...
  R = i.memo(function(e) {
    ...
    let {
      channel: l,
      participant: o,
      tempDisableOnInit: g = !1
    } = e, C = i.useRef(null), [j, S] = i.useState(g);
    (0, f.ZP)(() => {
      if (!j) return;
    ...
    let P = l.getGuildId();
    s()(null != P, "Channel cannot be guildless");
    let {
      isMobile: I,
      status: w
    } = (0, c.cj)([x.Z], () => ({
      isMobile: x.Z.isMobileOnline(o.user.id),
      status: x.Z.getStatus(o.user.id, P)
    })), R = (0, c.e7)([y.ZP], () => y.ZP.getMember(P, o.user.id)), M = (0, b.X7)(l.guild_id, null == R ? void 0 : R.userId, null != (t = null == R ? void 0 : R.colorStrings) ? t : null), D = i.useMemo(() => ({
      [P]: [o.user.id]
    }), [P, o.user.id]);
    (0, m.$)(D);
    let k = o.rtsState === E.xO.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK;

    function L() {
      (0, v.DT)(l, o.user.id, !1)
    }

    function U() {
      (0, v.DT)(l, o.user.id, !0)
    }
    let B = e => {
      (0, p.jW)(e, async () => {
        let {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(_.Z, {
        ...
        text: k ? Z.intl.string(Z.t.h9rsTU) : Z.intl.string(Z.t.f0T7hI),
        children: e => (0, r.jsx)(u.zx, A(N({}, e), {
