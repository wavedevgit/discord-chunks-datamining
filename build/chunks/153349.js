...
let w = i.memo(function(e) {
  ...
  A = i.memo(function(e) {
    ...
    })), A = (0, c.e7)([x.ZP], () => x.ZP.getMember(Z, s.user.id)), D = (0, b.X7)(l.guild_id, null == A ? void 0 : A.userId, null != (t = null == A ? void 0 : A.colorStrings) ? t : null), L = i.useMemo(() => ({
      [Z]: [s.user.id]
    }), [Z, s.user.id]);
    (0, g.$)(L);
