...
let R = i.memo(function(e) {
  ...
  A = i.memo(function(e) {
    ...
    } = e, j = i.useRef(null), [v, Z] = i.useState(m);
    (0, f.ZP)(() => {
      if (!v) return;
      let e = setTimeout(() => Z(!1), 1e3);
    ...
    })), A = (0, c.e7)([y.ZP], () => y.ZP.getMember(I, s.user.id)), D = (0, b.X7)(l.guild_id, null == A ? void 0 : A.userId, null != (t = null == A ? void 0 : A.colorStrings) ? t : null), L = i.useMemo(() => ({
      [I]: [s.user.id]
    }), [I, s.user.id]);
    (0, g.$)(L);
...
function M(e) {
  let {
    ...
    chatOpen: i
  } = e, l = (0, v.Fd)(t.id), s = [+!!(0, c.e7)([j.Z], () => j.Z.can(S.Pl.MANAGE_CHANNELS, t) || j.Z.can(S.Pl.MANAGE_ROLES, t)), Math.max(1, l.length)];
  return (0, r.jsxs)("div", {
