...
class O extends(n = Chunk73800.PureComponent) {
  isSortable(e) {
  ...
  renderHeader() {
    ...
    return (0, Chunk255367.jsx)(E, {
      className: l()(Chunk120356, Chunk483849.row, {
        [Chunk483849.stickyHeader]: _
      }),
      children: p
    })
  }
  renderBody() {
    ...
    if (require) {
      let r = null != n ? module.find(e => {
        ...
        l = null != require && null != n && this.isSortable(require) ? Chunk73800.sort("function" == typeof Chunk120356 ? (e, t) => o(e, t, i) : this.getDefaultSort(n)) : Chunk73800;
      A = null != require && Chunk255367 === Chunk981631.sHY.DESCENDING ? l.reverse() : l
    }
    return A.map((t, r) => {
