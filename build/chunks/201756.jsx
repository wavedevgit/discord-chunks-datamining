...
let Z = Chunk73800.forwardRef(function(e, t) {
  ...
  return a && (d = "text-brand"), <th className={i()(H.tableHeaderCellContainer, s)}><u.P3F{...N(w({}, c), {
      innerRef: t,
      onClick: l,
...
function D(e) {
  ...
  return <thead><tr className={H.tableHeaderRow}>{Y && <th className={i()(H.tableHeaderCellContainer, _.xsmallCol)}><u.ua7 shouldShow={!X} text={O.intl.string(O.t.tJEY0N)}>{e => (0, r.jsx)(u.P3F, N(w({}, e), {
            onClick: K,
          ...
          }))}</u.ua7></th>}{<Z label={O.intl.string(O.t.Es7n9f)} />}{P ? <r.Fragment>{<u.yRy targetElementRef={o} animation={u.yRy.Animation.FADE} position={"bottom"} spacing={4} align={"left"} renderPopout={() => (0, r.jsx)(g.Z, {
            guildId: t,
            onClose: y.dG4
          })}>{e => {
            var {
          ...
          }}</u.yRy>}{<u.yRy targetElementRef={a} animation={u.yRy.Animation.FADE} position={"bottom"} spacing={4} align={"left"} renderPopout={() => (0, r.jsx)(h.Z, {
            guildId: t,
            onClose: y.dG4
          })}>{e => {
            var {
          ...
          }}</u.yRy>}</r.Fragment> : <r.Fragment>{<Z label={O.intl.string(O.t.xcKP1N)} className={_.smallCol} />}{<Z label={O.intl.string(O.t.sPph4O)} className={_.smallCol} />}</r.Fragment>}{P ? <u.yRy targetElementRef={D} animation={u.yRy.Animation.FADE} position={"bottom"} spacing={4} align={"left"} renderPopout={() => (0, r.jsx)(x.Z, {
          guildId: t,
          onClose: y.dG4
        })}>{e => {
          var {
        ...
        }}</u.yRy> : P && <Z label={O.intl.string(O.t.yn0w19)} className={_.smallCol} />}{<u.yRy targetElementRef={L} animation={u.yRy.Animation.FADE} position={"bottom"} spacing={4} align={"left"} renderPopout={e => {
          let {
            closePopout: n
          } = e;
          return (0, r.jsx)(v.Z, {
        ...
        }}</u.yRy>}{<u.ua7 text={O.intl.string(O.t["2cRO3d"])} position={"top"} align={"left"} shouldShow={true} color={u.ua7.Colors.BRAND}>{e => (0, r.jsx)(u.yRy, {
          targetElementRef: R,
        ...
        })}</u.ua7>}{<Z label={O.intl.string(O.t["5Q9xGh"])} className={_.smallCol} />}</tr></thead>
}