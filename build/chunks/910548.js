...
function ee(e) {
  let {
    ...
    confettiCanvas: g
  } = i.useContext(_.h), [E, b] = i.useState(null), y = (0, s.uR)(g, E), O = X(f, h), I = R.includes(h), T = I && "exit" === f, S = i.useCallback(e => {
    p(e)
  }, []), A = i.useCallback(() => {
    "exit" === f && (null == t || t())
