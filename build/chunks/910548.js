...
function M(e) {
  let {
    ...
    confettiCanvas: g
  } = l.useContext(f.h), [b, E] = l.useState(null), y = (0, s.uR)(g, b), C = function(e, t) {
  ...
  }(d, _), x = T.includes(_), O = x && "exit" === d, j = l.useCallback(e => {
    m(e)
  }, []), P = l.useCallback(() => {
    "exit" === d && (null == t || t())
...
function U(e) {
  let t, {
    ...
    P = N.nick,
    A = o(N);
  t = null == c || null == a ? u > 1 ? x.intl.format(x.t.yfC9dn, {
    username: P,
    usernameHook: A,
    numSubscriptions: u
