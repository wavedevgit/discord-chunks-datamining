...
class E extends Chunk98597.ZP {
  render() {
    let {
      ...
      canReorderChannel: s
    } = this.props, a = <li className={o()(this.getClassName(), {
        [Chunk915887.disabled]: this.isDisabled()
      })} data-dnd-name={module.name}><Chunk473403.ZP className={Chunk915887.iconVisibility} channel={module} selected={exports} onClick={this.handleClick} onMouseDown={j} onContextMenu={this.handleContextMenu} connectDragPreview={Chunk442837 ? Chunk120356 : null} aria-label={(0, Chunk201895.ZP)({
          channel: module
        })} resolvedUnreadSetting={Chunk490897.i.ONLY_MENTIONS}>{this.renderInviteButton()}{this.renderEditButton()}</Chunk473403.ZP></li>;
