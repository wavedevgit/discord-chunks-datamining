...
function o(t) {
  ...
  return {
    ...
    [E.xB.USE_SOUNDBOARD.toString()]: {
      ...
      description: null != (i = null == t ? true : t.SOUNDBOARD_DESCRIPTION) ? i : s.t["+8p+fc"],
    ...
    [E.xB.PRIORITY_SPEAKER.toString()]: {
      ...
      description: null != (n = null == t ? true : t.PRIORITY_SPEAKER_DESCRIPTION) ? n : s.t.OJkrro,
...
function A(t, i) {
  ...
  return {
    title: i,
    permissions: S((null == n ? true : n.showManageWebhooks) ? [E.xB.VIEW_CHANNEL, E.xB.MANAGE_CHANNELS, E.xB.MANAGE_ROLES, E.xB.MANAGE_WEBHOOKS] : [E.xB.VIEW_CHANNEL, E.xB.MANAGE_CHANNELS, E.xB.MANAGE_ROLES], t)
  }
}
