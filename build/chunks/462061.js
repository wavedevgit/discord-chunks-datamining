...
function T(e) {
  let {
    ...
    streamId: Y,
    speaking: H
  } = t, z = V.id === F, G = (0, _.ZP)(t), K = (0, o.e7)([O.Z], () => O.Z.isFocused()), B = (0, o.e7)([g.Z], () => g.Z.getWindowFocused(j.KJ3.CHANNEL_CALL_POPOUT)), q = (0, o.e7)([y.Z], () => null != V.id && y.Z.isLocalVideoDisabled(V.id, (0, f.Z)(t.type)), [V.id, t.type]), J = (0, o.e7)([b.ZP], () => b.ZP.isGuestOrLurker(n.guild_id, V.id)), X = I.ZP.getName(n.getGuildId(), n.id, V) + (J ? " ".concat(x.NW.string(x.t["pFO/Pj"])) : ""), Q = H && (B || K), $ = s < 124 ? A : w, {
    avatarSrc: ee,
    ...
    size: $,
    animateOnHover: !Q
  }), en = (0, o.e7)([d.Z], () => d.Z.getSelectedParticipant(n.id)), er = (0, m.Z)(N.Yn.DEFAULT, t.user.id), el = {
    channel: n,
  ...
  }, [G]), i && !q && !L && G && !R && null != W && y.Z.supports(N.AN.VIDEO)) ? null != er ? (0, r.jsx)(Z.Z, {
    avError: er,
    userId: t.id,
    width: s,
    selected: R
