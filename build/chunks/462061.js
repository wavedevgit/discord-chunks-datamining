...
function D(e) {
  let {
    ...
    streamId: Y,
    speaking: z
  } = t, G = H.id === W, B = (0, _.ZP)(t), K = (0, o.e7)([Z.Z], () => Z.Z.isFocused()), q = (0, o.e7)([v.Z], () => v.Z.getWindowFocused(P.KJ3.CHANNEL_CALL_POPOUT)), J = (0, o.e7)([y.Z], () => null != H.id && y.Z.isLocalVideoDisabled(H.id, (0, f.Z)(t.type)), [H.id, t.type]), X = (0, o.e7)([O.ZP], () => O.ZP.isGuestOrLurker(n.guild_id, H.id)), Q = j.ZP.getName(n.getGuildId(), n.id, H) + (X ? " ".concat(x.intl.string(x.t["pFO/Pj"])) : ""), $ = z && (q || K), ee = u < 124 ? N : C, {
    avatarSrc: et,
  ...
  }, [B]), i && !J && !L && B && !S && null != V && y.Z.supports(A.AN.VIDEO)) ? null != el && null == ei ? (0, r.jsx)(I.Z, {
    avError: el,
    userId: t.id,
    width: u,
    selected: S
