...
function R(e, t) {
  ...
  switch (e.type) {
    ...
    case a.re.BUTTON: {
      let n = null != e.emoji ? h(e.emoji, y) : true;
      return {
        type: a.re.BUTTON,
        id: P(t),
    ...
    case a.re.STRING_SELECT:
      return {
        type: a.re.STRING_SELECT, id: P(t), customId: e.custom_id, disabled: e.disabled, required: null != (n = e.required) && n, options: e.options.map(e => ({
          type: d.tM.STRING,
          label: e.label,
          value: e.value,
          default: e.default,
          description: e.description,
          emoji: null != e.emoji ? h(e.emoji, y) : true
    ...
    case a.re.USER_SELECT:
      return {
        type: a.re.USER_SELECT, id: P(t), customId: e.custom_id, disabled: e.disabled, required: null != (o = e.required) && o, placeholder: e.placeholder, minValues: e.min_values, maxValues: e.max_values, defaultValues: e.default_values
      };
    case a.re.ROLE_SELECT:
      return {
        type: a.re.ROLE_SELECT, id: P(t), customId: e.custom_id, disabled: e.disabled, required: null != (s = e.required) && s, placeholder: e.placeholder, minValues: e.min_values, maxValues: e.max_values, defaultValues: e.default_values
      };
    case a.re.MENTIONABLE_SELECT:
      return {
        type: a.re.MENTIONABLE_SELECT, id: P(t), customId: e.custom_id, disabled: e.disabled, required: null != (c = e.required) && c, placeholder: e.placeholder, minValues: e.min_values, maxValues: e.max_values, defaultValues: e.default_values
      };
    case a.re.CHANNEL_SELECT:
      return {
        type: a.re.CHANNEL_SELECT, id: P(t), customId: e.custom_id, disabled: e.disabled, required: null != (f = e.required) && f, placeholder: e.placeholder, minValues: e.min_values, maxValues: e.max_values, channelTypes: e.channel_types, defaultValues: e.default_values
      };
    case a.re.SECTION: {
      let n = e.components.map((e, t) => E(e, t)).filter(u.lm),
    ...
    case a.re.TEXT_DISPLAY:
      return {
        type: a.re.TEXT_DISPLAY, id: P(t), content: e.content
      };
    case a.re.THUMBNAIL:
      return {
        type: a.re.THUMBNAIL, id: P(t), media: (0, l.ym)(e.media), description: e.description, spoiler: e.spoiler
      };
    case a.re.MEDIA_GALLERY:
      return {
        type: a.re.MEDIA_GALLERY, id: P(t), items: e.items.map(e => ({
    ...
    case a.re.FILE:
      return {
        type: a.re.FILE, id: P(t), file: (0, l.ym)(e.file), name: e.name, size: e.size, spoiler: e.spoiler
      };
    case a.re.SEPARATOR:
      return {
        type: a.re.SEPARATOR, id: P(t), divider: null == (_ = e.divider) || _, spacing: null != (m = e.spacing) ? m : a.US.SMALL
      };
    case a.re.CONTENT_INVENTORY_ENTRY:
      if (null == e.content_inventory_entry) return null;
      return {
        type: a.re.CONTENT_INVENTORY_ENTRY, id: P(t), contentInventoryEntry: e.content_inventory_entry
      };
    case a.re.CONTAINER: {
      let n = e.components.map((e, t) => E(e, t)).filter(u.lm);
      return {
    ...
    case a.re.FILE_UPLOAD:
      return {
        type: e.type, id: P(t), customId: e.custom_id, disabled: e.disabled, required: null != (g = e.required) && g, minValues: e.min_values, maxValues: e.max_values
      };
    case a.re.CHECKPOINT_CARD:
      return {
        type: e.type, id: P(t), checkpointData: {}
      };
    default:
