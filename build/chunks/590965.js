...
E(j, "displayName", "InviteModalStore");
let N = new j(a.Z, {
  ...
  INVITE_MODAL_OPEN: function(e) {
    ...
    let n = function(e) {
      ...
      return null != d && (p.channel = b({}, d)), null != h && (p.guild = new u.ZP(h)), null != e.inviter && (p.inviter = b({}, e.inviter)), p
    }(t);
    S.push([n, e.resolve])
  },
  INVITE_MODAL_CLOSE: function() {
    if (r = null, O = !1, S.length > 0) {
      let [, e] = S.shift();
      null != e && e()
    }
  },
