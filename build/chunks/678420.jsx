...
class x extends Chunk73800.PureComponent {
  ...
  render() {
    var e, t;
    return <Chunk388080.Z{...e = m({}, this.props), t = t = {
      onClose: this.close,
...
function f(e) {
  ...
  if (l.useEffect(() => {
    ...
    }, [n, t]), s) return <o.Y0X transitionState={e.transitionState} parentComponent={"ChangeLog"}><div className={g.empty}><o.X6q variant={"heading-lg/medium"}>{u.intl.string(u.t.V9ospq)}</o.X6q></div></o.Y0X>;
  if (null == t)
    if (n) return <o.Y0X transitionState={e.transitionState} parentComponent={"ChangeLog"}><div className={g.empty}><o.Text variant={"text-md/semibold"}>{u.intl.string(u.t.O1iRT0)}</o.Text></div></o.Y0X>;
    else return <o.Y0X transitionState={e.transitionState} parentComponent={"ChangeLog"}><div className={g.empty}><o.$jN type={o.$jN.Type.WANDERING_CUBES} /></div></o.Y0X>;
  return <o.Y0X transitionState={e.transitionState} parentComponent={"ChangeLog"}><x changeLog={t} /></o.Y0X>
}