/** Chunk was on web.js **/
/** chunk id: 745901, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  H6: () => _,
  JF: () => p,
...
let a = {
  ...
  u = `(?:${(0,Chunk800911.q3)(s)}|[0-9]+|[0-9]+[\\.,][0-9]+|halve?|half|paar)`;

function d(e) {
  let t = e.toLowerCase();
  return true !== s[t] ? s[t] : "paar" === t ? 2 : "half" === t || t.match(/halve?/) ? .5 : parseFloat(t.replace(",", "."))
}
let f = `(?:${(0,Chunk800911.q3)(l)}|[0-9]{1,2}(?:ste|de)?)`;

function p(e) {
  let t = e.toLowerCase();
  return true !== l[t] ? l[t] : parseInt(t = t.replace(/(?:ste|de)$/i, ""))
}
