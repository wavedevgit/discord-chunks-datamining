...
let _ = function(e) {
  ...
  let {
    ...
    onDragComplete: P,
    onDragReset: w
  } = e, R = (0, l.e7)([p.Z], () => p.Z.getChannel(O.channelId)), D = (0, l.e7)([h.Z], () => h.Z.getGuild(C)), {
    customEmoji: Z,
    unicodeEmoji: A
  } = (0, u.Z)(null == (t = O.emoji) ? void 0 : t.id, null == (s = O.emoji) ? void 0 : s.name), k = null == O.emoji || null != Z || null != A, W = f.ZP.getNewMemberActionIconURL({
