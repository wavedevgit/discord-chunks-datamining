...
function ei(e) {
  ...
  } = e, c = (0, f.e7)([_.Z], () => _.Z.getIsEnabled(), []), u = n === k._b.TEXT && "channel" === t.type && null != t.channel && !t.channel.isPrivate(), d = (0, W.Yn)(n), p = !(0, W.Yn)(n), m = n === k._b.TEXT, [b, x] = ed(!0), [C, v] = ed(u), [g, N] = ed(d), [j, P] = ed(p), E = b && C && g && j, O = (d || u) && !E, A = p && c;
  r.useEffect(() => {
    var e;
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [A ? (0, i.jsx)(er, {}) : null, (0, i.jsx)(el, {
      searchQuery: l,
      setSearchQuery: o,
...
function el(e) {
  let {
    ...
    c(!0), (0, g.yw)(Y.rMx.APP_LAUNCHER_SEARCH_FOCUSED, {
      source: R.Z.entrypoint(),
      location: j.Vh.APP_LAUNCHER_HOME
    })
  }, []), m = r.useCallback(() => {
...
function ec(e) {
  let {
    ...
    let {
      ...
      allowFetch: !0
    }), o = r.useCallback(e => null == l.find(t => t.id === e.id), [l]), c = (0, f.e7)([A.Z], () => A.Z.getFetchState({
      surface: en,
      activeState: i
    })), u = (0, f.e7)([A.Z], () => A.Z.getCollections({
      surface: en,
      activeState: i
    ...
    context: t,
    recommendationsSections: u
  }), h = o === A.M.FETCHING, _ = !h && 0 === u.length;
  return (r.useEffect(() => {
    l(_)
  }, [_, l]), _) ? null : h ? et.map((e, t) => {
    let {
      cards: n,
      look: r
    } = e;
...
function eu(e) {
  ...
  let h = "channel" in d && (0, w.aZ)(d.channel, "AppLauncherHome.RecommendationsSection()"),
    b = r.useMemo(() => {
      ...
      return (0, T.yE)(l.flags, c.b.APPENDS_REMAINING_ACTIVITIES) && e.push(...o.map(e => {
        let {
          application: t
        } = e;
        return {
