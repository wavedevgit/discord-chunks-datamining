...
function en(e) {
  ...
  } = e, c = (0, m.e7)([b.Z], () => b.Z.getIsEnabled(), []), u = n === R._b.TEXT && "channel" === t.type && null != t.channel && !t.channel.isPrivate(), d = (0, D.Yn)(n), p = !(0, D.Yn)(n), h = n === R._b.TEXT, [y, v] = eu(!0), [x, C] = eu(u), [g, j] = eu(d), [P, N] = eu(p), O = y && x && g && P, E = (d || u) && !O, A = p && c;
  r.useEffect(() => {
    var e;
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [A ? (0, i.jsx)(ei, {}) : null, (0, i.jsx)(er, {
      searchQuery: l,
      setSearchQuery: o,
...
function el(e) {
  let {
    ...
    return e
  }, [a]), u = Q.intl.string(Q.t["s+UQpa"]), d = u;
