...
function ei(e) {
  ...
  } = e, c = (0, f.e7)([x.Z], () => x.Z.getIsEnabled(), []), d = n === k._b.TEXT && "channel" === t.type && null != t.channel && !t.channel.isPrivate(), u = (0, D.Yn)(n), p = !(0, D.Yn)(n), m = n === k._b.TEXT, [b, _] = eu(!0), [v, y] = eu(d), [N, g] = eu(u), [j, P] = eu(p), E = b && v && N && j, A = (u || d) && !E, I = p && c;
  r.useEffect(() => {
    var e;
...
function el(e) {
  let {
    ...
    setSearchQuery: n,
    placeholder: l
  } = e, o = r.useRef(null), [s, c] = r.useState(!1), d = r.useMemo(() => a().debounce(e => {
    ...
    c(!0), (0, N.yw)(Y.rMx.APP_LAUNCHER_SEARCH_FOCUSED, {
      source: R.Z.entrypoint(),
      location: j.Vh.APP_LAUNCHER_HOME
    })
  }, []), m = r.useCallback(() => {
...
function ea(e) {
  let {
    ...
    return e
  }, [o]), d = J.NW.string(J.t["s+UQpa"]), u = d;
  ...
  r.useEffect(() => {
    s || 0 !== p.length && (0, N.yw)(Y.rMx.APP_LAUNCHER_FRECENTS_SEEN, {
      num: p.length,
...
function ec(e) {
  let {
    ...
    let {
      ...
      allowFetch: !0
    }), a = r.useCallback(e => null == l.find(t => t.id === e.id), [l]), c = (0, f.e7)([I.Z], () => I.Z.getFetchState({
      surface: en,
      activeState: i
    })), d = (0, f.e7)([I.Z], () => I.Z.getCollections({
      surface: en,
      activeState: i
    ...
    context: t,
    recommendationsSections: d
  }), h = a === I.M.FETCHING, x = !h && 0 === d.length;
  return (r.useEffect(() => {
    l(x)
  }, [x, l]), x) ? null : h ? et.map((e, t) => {
    let {
      cards: n,
      look: r
    } = e;
...
function ed(e) {
  ...
  let h = "channel" in u && (0, w.aZ)(u.channel, "AppLauncherHome.RecommendationsSection()"),
    b = r.useMemo(() => {
      ...
      return (0, T.yE)(l.flags, c.b.APPENDS_REMAINING_ACTIVITIES) && e.push(...a.map(e => {
        let {
          application: t
        } = e;
        return {
