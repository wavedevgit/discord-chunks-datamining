...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk270801 = require("./270801.js"),
  Chunk652730 = require("./652730.js"),
  Chunk41776 = require("./41776.js"),
  Chunk657352 = require("./657352.js"),
  Chunk33154 = require("./33154.js"),
...
class K extends Chunk73800.PureComponent {
  ...
  render() {
    ...
    if (module && !Chunk391650) {
      ...
      } return <Chunk481060.yRy targetElementRef={this.textAreaContainerRef} position={"top"} align={"left"} shouldShow={Chunk33154} onRequestClose={() => this.setState({
        shouldShowLurkerModeSuccessPopout: false
      })} renderPopout={this.renderSuccessPopout}>{e => (0, r.jsx)(j.Z, W(H({}, A), {
  ...
  constructor(...e) {
    super(...e), V(this, "state", {
      ...
      return a()(null != n, "This guildID cannot be null"), <T.Z onClose={t} guild={n} />
    }), V(this, "handleCancelApplication", () => {
      let {
        guild: e
      } = this.props;
      null != e && (0, c.h7j)(t => <c.ConfirmModal{...W(H({
      ...
      null != t && (0, c.h7j)(e => <c.ConfirmModal{...W(H({}, e), {
      ...
      return a()(null != e, "GuildVerification.renderLurkerModeUpsellPopout - guild cannot be undefined"), <S.Z type={S.s.CHAT} guild={e} closePopout={this.closeLurkerModeUpsellPopout} />
      ...
      return <c.u_l renderModal={t => (0, r.jsx)(O.Z, W(H({}, t), {
          onAccept: i,
          guildName: e.name
        }))} onCloseRequest={i} />
    })
