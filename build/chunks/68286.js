...
function C(e) {
  let {
    ...
    height: m = d,
    ref: g
  } = (0, o.ZP)(), v = (0, f.Z)(), _ = (0, u.ZY)(v), S = (0, r.e7)([c.Z], () => c.Z.windowSize(_), [_]), I = function(e) {
    let {
      tileCount: t,
      padding: n,
      borderWidth: i,
  ...
  i.useLayoutEffect(() => {
    ...
    let f = function(e) {
      let {
        ...
        widgetMinMaxSizes: o
      } = e, a = t === h.C5.VERTICAL, s = E(i, r, l, a), c = b(n, r, i, a, s);
      return (0, p.Se)(c, {
    ...
    let f = function(e) {
      let {
        ...
        widgetMinMaxSizes: a
      } = e, s = E(r, l, o, t === h.C5.VERTICAL), c = b(i, l, r, n === h.C5.VERTICAL, s);
      return (0, p.Se)(c, {
