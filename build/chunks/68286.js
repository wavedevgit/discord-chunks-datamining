...
function j(e) {
  let {
    ...
    widgetMinMaxSizes: o
  } = e, a = t === h.C5.VERTICAL, s = S(i, r, l, a), u = E(n, r, i, a, s);
  return (0, p.Se)(u, {
...
function Z(e) {
  let {
    ...
    return c = Math.max(a.height, c), c = Math.min(u.height, c), {
      minSize: a,
      defaultSize: E(t, n, i, o, (0, p.eJ)(c)),
      maxSize: u,
      containerSpecs: s
    }
  }({
  ...
  (0, a.Ng)(() => {
    ...
    let f = function(e) {
      let {
        ...
        widgetMinMaxSizes: a
      } = e, s = S(r, l, o, t === h.C5.VERTICAL), u = E(i, l, r, n === h.C5.VERTICAL, s);
      return (0, p.Se)(u, {
