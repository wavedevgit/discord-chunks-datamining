...
class C extends a.Z {
  ...
  constructor(e, t, n, r = new s.x) {
    var a;
    super(), a = this, E(this, "userId", void 0), E(this, "isStageChannel", void 0), E(this, "supportsSeamless", void 0), E(this, "ladder", void 0), E(this, "connection", void 0), E(this, "audioSsrcs", void 0), E(this, "videoSsrcs", void 0), E(this, "remoteVideoSsrcs", void 0), E(this, "framesReceived", void 0), E(this, "streamIds", void 0), E(this, "offscreenUsers", void 0), E(this, "offscreenDisabledUsers", void 0), E(this, "streamPixelCounts", void 0), E(this, "latestWants", void 0), E(this, "participants", void 0), E(this, "selectedParticipantId", void 0), E(this, "delayedCall", void 0), E(this, "offscreenTimeout", void 0), E(this, "pipOpen", void 0), E(this, "simulcastDebugOverrides", void 0), E(this, "videoHealthManager", void 0), E(this, "otherUsers", void 0), E(this, "delayedUpdate", void 0), E(this, "addLru", void 0), E(this, "updateOffscreenUsers", void 0), E(this, "handleLocalVideoDisabled", void 0), E(this, "handleLocalMute", void 0), E(this, "update", void 0), E(this, "incomingVideoEnabledChanged", void 0), this.userId = e, this.isStageChannel = t, this.supportsSeamless = n, this.ladder = r, this.connection = null, this.audioSsrcs = {}, this.videoSsrcs = {}, this.remoteVideoSsrcs = {}, this.framesReceived = {}, this.streamIds = {}, this.offscreenUsers = {}, this.offscreenDisabledUsers = {}, this.streamPixelCounts = {}, this.latestWants = v, this.participants = new Set, this.selectedParticipantId = null, this.pipOpen = !1, this.simulcastDebugOverrides = new Map, this.videoHealthManager = null, this.otherUsers = new Set, this.delayedUpdate = () => {
        ...
        if (a.shouldReceiveFromUser(t)) {
          ...
          if (i.length > 1) {
            ...
            if (a.supportsSeamless && !a.framesReceived[_])
              for (let e of (u = !0, s = [_], i)) e.ssrc !== _ && a.framesReceived[e.ssrc] && (e.quality === b ? o[e.ssrc] = b : o[e.ssrc] = c ? f : r, s.push(e.ssrc))
