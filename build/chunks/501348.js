...
class et extends i.Component {
  renderZoomSlider() {
    ...
    return R.isPlatformEmbedded ? (0, r.jsxs)(u.xJW, {
      ...
      children: [(0, r.jsx)(u.vwX, {
        ...
        type: u.R94.Types.DESCRIPTION,
        children: V.NW.format(V.t.OMkSUl, {
          modKey: h.Z.modKey
        })
      })]
    }) : null
  ...
  renderPreview() {
    ...
    return (0, r.jsx)(u.Rny, {
      children: (0, r.jsx)(u.Zbd, {
        ...
        outline: !0,
        "aria-hidden": !0,
        children: s.map((t, n) => (0, r.jsx)(I.Z, {
          author: (0, T.ZH)(t),
          message: t,
          compact: e,
          isGroupStart: n % 2 == 0,
  ...
  renderTheme() {
    ...
    return t ? (0, r.jsx)(u.xJW, {
      ...
      title: (0, r.jsx)(ee, {}),
      children: [(0, r.jsx)(k.i, {}), (0, r.jsx)(A.F, {
  ...
  handleSliderValueText(e) {
    return V.NW.formatToPlainString(V.t["0hpvOT"], {
      value: e
    })
  }
  ...
  constructor(...e) {
    super(...e), H(this, "darkMessages", $(B.BRd.DARK)), H(this, "lightMessages", $(B.BRd.LIGHT)), H(this, "handleDisplayCompactAvatarsChanged", e => {
