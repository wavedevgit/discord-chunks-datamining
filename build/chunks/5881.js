...
function l() {
  let {
    quest: e,
    location: t
  } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = s(), i = null == e ? void 0 : e.config.messages.questName, a = null != t ? "-".concat(t) : "", l = null != i ? "-".concat(i, ")") : "", c = "QuestLogger".concat(a).concat(l), u = new r.Z(c);
  return {
    log: n ? u.log : o.dG,
    warn: n ? u.warn : o.dG,
