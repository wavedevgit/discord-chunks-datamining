...
async function v(e, t) {
  ...
  let {
    ...
    fps: k,
    soundshareEnabled: M
  } = s.Z.getState(), U = null != (m = null == t ? void 0 : t.preset) ? m : D, [L, B] = null != (x = (0, y.Z)(U, T, A)) ? x : [], V = null != (E = null != L ? L : null == t ? void 0 : t.resolution) ? E : W, G = null != (C = null != B ? B : null == t ? void 0 : t.fps) ? C : k, F = null != (I = null == t ? void 0 : t.previewDisabled) ? I : a.I0.getSetting(), K = null != (j = null == t ? void 0 : t.soundshareEnabled) ? j : M;
  return (0, g.Z)(U, V, G, T, A, Z) || (U = N.tI.PRESET_VIDEO, V = N.LY.RESOLUTION_720, G = N.ws.FPS_30), (0, l.Rc)({
    preset: U,
    resolution: V,
    frameRate: G,
    soundshareEnabled: K
  }), (0, l.WH)(_, w, (P = function(e) {
