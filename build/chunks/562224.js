...
async function b(e, t) {
  ...
  if (!d.Z.getUseSystemScreensharePicker() && !await i.Z.hasPermission(N.Eu.SCREEN_RECORDING, {
  ...
  let {
    ...
    fps: k,
    soundshareEnabled: M
  } = a.Z.getState(), B = null !== (m = null == t ? void 0 : t.preset) && void 0 !== m ? m : D, [U, L] = null !== (x = (0, y.Z)(B, w, R)) && void 0 !== x ? x : [], G = null !== (C = null != U ? U : null == t ? void 0 : t.resolution) && void 0 !== C ? C : W, V = null !== (j = null != L ? L : null == t ? void 0 : t.fps) && void 0 !== j ? j : k, F = null !== (E = null == t ? void 0 : t.previewDisabled) && void 0 !== E ? E : s.I0.getSetting(), H = null !== (I = null == t ? void 0 : t.soundshareEnabled) && void 0 !== I ? I : M;
  return (0, g.Z)(B, G, V, w, R, Z) || (B = O.tI.PRESET_VIDEO, G = O.LY.RESOLUTION_720, V = O.ws.FPS_30), (0, l.Rc)({
    preset: B,
    resolution: G,
    frameRate: V,
    soundshareEnabled: H
  }), (0, l.WH)(_, T, (P = function(e) {
  ...
  }, Object.getOwnPropertyDescriptors ? Object.defineProperties(P, Object.getOwnPropertyDescriptors(S)) : (function(e, t) {
    var n = Object.keys(e);
