...
function M(e) {
  let t, {
    ...
    s = null != l && n.features.has(Z.oNc.ROLE_SUBSCRIPTIONS_ENABLED);
  return (0, o.P)(n), t = s ? a === Z.KsC.ROLE_SUBSCRIPTION_EMOJI ? P.ue.EMOJIS : P.ue.TIERS : P.ue.PAYMENT, (0, r.jsx)(j.l, {
    guildId: n.id,
    refetchOnMount: true,
