...
function j(e) {
  ...
  return <i.v2r navId={"overlay-voice-widget-context-menu"} onClose={o.Zy} aria-label={y.intl.string(y.t.tPfVWl)} onSelect={j}>{<i.kSQ label={y.intl.string(y.t.dnvZSk)}>{f().map(e => (0, n.jsx)(i.k5B, {
        label: e.name,
        checked: S === e.value,
        id: "avatar-size-mode-".concat(e.value),
        group: "avatar-size-mode",
        action: () => c.Z.setAvatarSizeMode(e.value)
      }, e.value))}</i.kSQ>}{<i.kSQ label={y.intl.string(y.t.J0dpcH)}>{b().map(e => (0, n.jsx)(i.k5B, {
        label: e.name,
        checked: h === e.value,
        id: "display-name-mode-".concat(e.value),
        group: "display-name-mode",
        action: () => c.Z.setDisplayNameMode(e.value)
      }, e.value))}</i.kSQ>}{<i.kSQ label={y.intl.string(y.t.swsWWF)}>{O().map(e => (0, n.jsx)(i.k5B, {
        label: e.name,
        checked: k === e.value,
        id: "display-user-mode-".concat(e.value),
        group: "display-user-mode",
        action: () => c.Z.setDisplayUserMode(e.value)
      }, e.value))}</i.kSQ>}{<i.kSQ><i.II_ id={"voice-widget-max-users-displayed"} label={y.intl.string(y.t["X/Uyzc"])} control={(e, t) => {
          var a, l;
