...
function b(e) {
  let {
    ...
    message: n,
    embedUrl: b
  } = e, [x, y, E] = (0, l.Wu)([f.Z], () => [f.Z.getApplication(t), f.Z.isInvalidApplication(t), f.Z.getApplicationFetchState(t)], [t]), v = (0, l.e7)([d.Z], () => {
    var e;
  ...
  }, [N, v, y, n.author.id, n.channel_id]), y) ? (0, r.jsxs)(c.Z, {
    containerRef: C,
