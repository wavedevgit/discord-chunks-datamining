...
function b(e) {
  let {
    ...
    message: n,
    embedUrl: b
  } = e, [E, y, x] = (0, a.Wu)([f.Z], () => [f.Z.getApplication(t), f.Z.isInvalidApplication(t), f.Z.getApplicationFetchState(t)], [t]), C = (0, a.e7)([d.Z], () => {
    var e;
  ...
  return (i.useEffect(() => {
    ...
    v && y && p.default.track(g.rMx.APP_DIRECTORY_PROFILE_INVALID_EMBED_VIEWED, {
      device_platform: l.tq ? "mobile_web" : "desktop_web",
      sender_user_id: n.author.id,
      guild_id: C,
      channel_id: n.channel_id
    })
  }, [v, C, y, n.author.id, n.channel_id]), y) ? (0, r.jsxs)(c.Z, {
    containerRef: I,
