...
class S extends a.Z {
  ...
  handleVoiceFilterFileReady(e) {
    let {
      ...
      analyticsContext: i
    } = e, a = l.Z.getMostRecentlyRequestedVoiceFilter(), o = l.Z.getActiveVoiceFilter(), s = a !== o;
    if (r) {
      var u;
    ...
    if (s && null != a) {
      ...
      let n = T(e),
        r = Object.values(null != n ? n : {}).filter(e => !_.Z.isModelDownloaded(e)).filter(e => e !== t);
  ...
  handleVoiceFilterDownloadFailed(e) {
    ...
    let {
      ...
      voiceFilterId: i,
      error: a
    } = e, o = "USER_CANCELED_DOWNLOAD", s = null != a && o in a, u = (null != (t = null == a ? void 0 : a.message) ? t : String(a)).substring(0, 200);
    s && (u = o), c.default.track(g.rMx.VOICE_FILTER_DOWNLOAD_ATTEMPTED, {
      canceled: s,
  ...
  handleVoiceFilterApplied(e) {
    ...
    } = e, a = l.Z.getPreviousVoiceFilter();
    if (null !== a && null === t) {
    ...
    null !== t && ((0, s.EW)(r.z.VOICE_FILTER_IN_CALL_COACHMARK, {
      dismissAction: E.L.INDIRECT_ACTION
    }), (0, s.EW)(r.z.VOICE_FILTER_FIRST_USE_COACHMARK, {
      dismissAction: E.L.INDIRECT_ACTION
    }), c.default.track(g.rMx.VOICE_FILTER_ENABLED, v(y({
  ...
  handleVoiceFilterApplyFailed(e) {
    ...
    c.default.track(g.rMx.VOICE_FILTER_ACTIVATE_FAILED, {
  ...
  async handleVoiceFilterCatalogFetch(e) {
    let {
      catalog: t
    } = e, n = Object.keys(t.models).map(e => ({
      id: e,
      fileName: (0, m.i)(e)
    }));
    if (u.ZP.canCheckVoiceFilterFilesExist()) {
      ...
      for (let {
        ...
        of e) t[n] = {
        status: r ? f.L.DOWNLOADED : f.L.MISSING
      };
      (0, p.gf)(t);
