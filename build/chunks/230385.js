...
class v extends i.Z {
  ...
  handleVoiceFilterPrefetch(e) {
    ...
    for (let e of Object.values(t)) {
      var i;
      for (let t of Object.values(null != (i = e.modelIds) ? i : {})) r.has(t) || (r.add(t), (0, _.fz)({
        voiceFilterId: e.id,
        modelId: t,
        url: n[t].url,
        fileName: (0, p.i)(t)
  ...
  handleVoiceFilterFileReady(e) {
    let {
      ...
      analyticsContext: i
    } = e, a = s.Z.getMostRecentlyRequestedVoiceFilter(), o = s.Z.getActiveVoiceFilter(), c = a !== o;
    if (r) {
      var u;
    ...
    if (c && null != a) {
      ...
      if (r.length > 0) return void O.info("waiting for more dependencies", {
  ...
  handleVoiceFilterDownloadFailed(e) {
    ...
    c && (u = o), l.default.track(h.rMx.VOICE_FILTER_DOWNLOAD_ATTEMPTED, {
      canceled: c,
  ...
  handleVoiceFilterApplyFailed(e) {
    ...
    l.default.track(h.rMx.VOICE_FILTER_ACTIVATE_FAILED, {
  ...
  async handleVoiceFilterCatalogFetch(e) {
    let {
      catalog: t
    } = e, n = {}, r = Object.keys(t.models).map(e => ({
      id: e,
      fileName: (0, p.i)(e)
    }));
    for (let {
      ...
      of(await c.ZP.checkVoiceFilterFilesExist(r))) n[e] = {
      status: t ? f.L.DOWNLOADED : f.L.MISSING
    };
    (0, _.gf)(n)
  }
  constructor(...e) {
