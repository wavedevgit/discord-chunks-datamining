...
class S {
  ...
  renderNicknamePairs() {
    return this.getNicknameGuildPairs().map((e, t) => {
      let [n, a] = e, o = (0, r.jsx)(l.P3F, {
        tag: "span",
        onClick: this.handleClick,
        children: n
      });
      return a.length > 0 && (o = (0, r.jsx)(l.DY3, {
        className: I.tooltip,
        text: a.join(", "),
        position: "bottom",
        children: o
  ...
  constructor({
    ...
    T(this, "userId", void 0), T(this, "user", void 0), T(this, "channelId", void 0), T(this, "analyticsLocations", void 0), T(this, "generateNicknameGuildPairs", (0, E.oH)(e => {
      var t;
      return o()(h.ZP.getNicknameGuildsMapping(null != (t = null == e ? void 0 : e.id) ? t : this.userId)).toPairs().map(e => {
        let [t, n] = e;
        return [t, n.map(e => {
          var t;
...
function A(e) {
  ...
  } = e, a = (0, s.e7)([g.default], () => g.default.getUser(t), [t]), [o] = i.useState(() => new S({
    user: a,
    userId: t,
    channelId: n,
    analyticsLocations: r
...
function N(e) {
  let {
    channel: t
  } = e, n = t.getRecipientId(), i = (0, _.gc)(n), a = Array(i.length).fill(null), {
    ...
    let o = s.user,
      c = i[n];
    return null == c || null == o ? null : (0, r.jsx)(l.DY3, {
