...
let F = d().throttle(h.OQ, 1e3),
  z = e => {
    let {
      ...
      onEdit: s,
      editingDisabled: a = !1
    } = e, [o, c] = i.useState(n.name), d = P.ZP.getEmojiURL({
      id: n.id,
      animated: n.animated,
      size: 32
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)("div", {
        ...
        children: (0, r.jsx)(g.ua7, {
          ...
          children: e => {
            var t, i;
            return (0, r.jsx)("div", (t = B({}, e), i = i = {
              className: l()(G.emojiImage, {
  ...
  V = e => {
    ...
    return (0, r.jsxs)(g.vwX, {
      ...
      children: [t, (0, r.jsxs)("span", {
        children: [" — ", M.NW.format(M.t.sgL8sL, {
          count: n - i
        })]
      })]
    })
  ...
  K = e => {
    let t, n, i, {
      ...
      d = a.premiumTier,
      u = (0, R.FZ)(d);
    return null == u || d === W.Eu4.TIER_3 || c > 0 ? null : (c > o ? (t = M.NW.formatToPlainString(M.t.j0UH0t, {
      level: u
    }), n = M.NW.formatToPlainString(M.t.VQeyKy, {
      level: u
    }), i = W.qAy.BOOST_UPSELL_BANNER_LOST_LEVEL) : (t = M.NW.string(M.t.zT9Sxc), n = M.NW.formatToPlainString(M.t.dBZ1RU, {
      level: u
    }), i = W.qAy.BOOST_UPSELL_BANNER_SLOTS_FULL), (0, r.jsx)(C.Z, {
      header: t,
      text: n,
      guild: a,
      analyticsLocation: {
  ...
  X = () => {
    ...
    let [Z, U] = i.useMemo(() => {
      ...
      return [n, r]
    }, [p, e.id]), z = (0, R.y4)(e), V = Math.max(z - Z.length, z - U.length), Y = (n, r, i) => (0, O.G)({
      data: n,
      file: r,
      image: i,
      guildId: e.id,
      ...
      s((0, u.Z)()), T.default.track(W.rMx.EMOJI_UPLOAD_STARTED, {
        guild_id: e.id,
        upload_id: t
      }), await (0, I._)(n, Y), x(!0)
    }, q = () => {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [0 === V ? null : (0, r.jsx)(b.Z, {
        ...
        children: [(0, r.jsx)(K, {
          ...
          children: [(0, r.jsx)(g.R94, {
            type: g.geA.DESCRIPTION,
            children: M.NW.format(M.t.TA1BR0, {
              count: z
            })
          }), Q && (0, r.jsx)(g.R94, {
            type: g.geA.DESCRIPTION,
            children: M.NW.format(M.t.uMkfTk, {
              onClick: () => D.Z.open(e.id, W.pNK.ROLE_SUBSCRIPTIONS, void 0, W.KsC.ROLE_SUBSCRIPTION_EMOJI)
            })
          }), (0, r.jsxs)("div", {
            children: [(0, r.jsx)(g.vwX, {
              ...
              children: [(0, r.jsx)("li", {
                ...
                children: (0, r.jsx)(g.R94, {
                  type: g.geA.DESCRIPTION,
                  children: M.NW.format(M.t.gfAXoa, {
                    maxSize: L.xG
                  })
                })
              }), (0, r.jsx)("li", {
          ...
          }), $ ? (0, r.jsx)(v.b, {}) : (0, r.jsxs)(g.zxk, {
            tabIndex: -1,
            size: g.zxk.Sizes.MEDIUM,
            onClick: () => {
              let t = (0, u.Z)();
              s(t), T.default.track(W.rMx.EMOJI_UPLOAD_STARTED, {
                guild_id: e.id,
                upload_id: t
              })
            },
            ...
            children: [M.NW.string(M.t.DU0dy8), V > 0 ? (0, r.jsx)(I.Z, {
              disabled: C || 0 === V || !a,
              tabIndex: 0,
              onChange: Y,
              setLoading: P,
