...
let z = u().throttle(h.OQ, 1e3),
  H = e => {
    let {
      ...
      onEdit: l,
      editingDisabled: a = !1
    } = e, [o, c] = i.useState(n.name), u = P.ZP.getEmojiURL({
      id: n.id,
      animated: n.animated,
      size: 32
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)("div", {
        ...
        children: (0, r.jsx)(g.ua7, {
          ...
          children: e => {
            var t, i;
            return (0, r.jsx)("div", (t = F({}, e), i = i = {
              className: s()(U.emojiImage, {
                [U.emojiDisabled]: !n.available
              }),
              style: {
  ...
  V = e => {
    ...
    return (0, r.jsxs)(g.vwX, {
      ...
      children: [t, (0, r.jsxs)("span", {
        children: [" — ", G.intl.format(G.t.sgL8sL, {
          count: n - i
        })]
      })]
    })
  ...
  K = e => {
    let t, n, i, {
      ...
      u = a.premiumTier,
      d = (0, R.FZ)(u);
    return null == d || u === L.Eu4.TIER_3 || c > 0 ? null : (c > o ? (t = G.intl.formatToPlainString(G.t.j0UH0t, {
      level: d
    }), n = G.intl.formatToPlainString(G.t.VQeyKy, {
      level: d
    }), i = L.qAy.BOOST_UPSELL_BANNER_LOST_LEVEL) : (t = G.intl.string(G.t.zT9Sxc), n = G.intl.formatToPlainString(G.t.dBZ1RU, {
      level: d
    }), i = L.qAy.BOOST_UPSELL_BANNER_SLOTS_FULL), (0, r.jsx)(y.Z, {
      header: t,
      text: n,
      guild: a,
      analyticsLocation: {
  ...
  X = () => {
    ...
    let [Z, B] = i.useMemo(() => {
      ...
      return [n, r]
    }, [p, e.id]), H = (0, R.y4)(e), V = Math.max(H - Z.length, H - B.length), Y = (n, r, i) => (0, C.G)({
      data: n,
      file: r,
      image: i,
      guildId: e.id,
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [0 === V ? null : (0, r.jsx)(b.Z, {
        ...
        children: [(0, r.jsx)(K, {
          ...
          children: [(0, r.jsx)(g.R94, {
            ...
            children: [(0, r.jsx)(g.vwX, {
              ...
              children: [(0, r.jsx)("li", {
                ...
                children: (0, r.jsx)(g.R94, {
                  type: g.geA.DESCRIPTION,
                  children: G.intl.format(G.t.gfAXoa, {
                    maxSize: M.xG
                  })
                })
              }), (0, r.jsx)("li", {
          ...
          }), $ ? (0, r.jsx)(O.b, {}) : (0, r.jsxs)(g.zxk, {
            tabIndex: -1,
            size: g.zxk.Sizes.MEDIUM,
            onClick: () => {
              let t = (0, d.Z)();
              l(t), T.default.track(L.rMx.EMOJI_UPLOAD_STARTED, {
                guild_id: e.id,
                upload_id: t
              })
            },
            ...
            children: [G.intl.string(G.t.DU0dy8), V > 0 ? (0, r.jsx)(I.Z, {
              disabled: y || 0 === V || !a,
              tabIndex: 0,
              onChange: Y,
              setLoading: P,
