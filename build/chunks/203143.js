...
function k(e) {
  ...
  if (null == i) return;
  if (h.Z.isLurking(i.guild_id)) return void L({
    guildId: i.guild_id,
...
async function F(e) {
  ...
  if (null == r) return;
  if (h.Z.isLurking(r.guild_id)) return void L({
    guildId: r.guild_id,
...
async function B(e) {
  ...
  if (null != r) return h.Z.isLurking(r.guild_id) ? void L({
    guildId: r.guild_id,
...
let H = {
  ...
  createPoll: async function(e) {
    let {
      ...
      layout: a,
      onClose: s
    } = e, c = j.Z.getUploads(t.id, x.d.Poll), u = r.map(e => {
      var t, n;
