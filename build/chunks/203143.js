...
async function B(e) {
  ...
  try {
    ...
    (0, T.eu)(t, n, e => (i()(null != e, "Must not be able to vote without existing state!"), R(Z({}, e), {
      ...
      messageId: n,
      answerIds: e
    }), (0, T.eu)(t, n, () => void 0), c.uv.announce(0 === e.length ? w.intl.string(w.t["xcvy+/"]) : w.intl.string(w.t.o20GSk))
  } catch (e) {
    var o, s, u;
    d.Z.show({
...
let V = {
  ...
  createPoll: async function(e) {
    ...
    try {
      null != c && c.length > 0 ? await I.sk({
        channel: t,
        items: c,
        poll: d,
        nonce: (0, b.r)()
      }) : await m.Z.sendPollMessage(t.id, d), null == s || s()
    } catch (e) {
