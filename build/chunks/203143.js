...
async function F(e) {
  ...
  try {
    ...
    (0, N.eu)(t, n, e => (i()(null != e, "Must not be able to vote without existing state!"), Z(w({}, e), {
      submitting: !0,
      editing: !1
    }))), await U({
      channelId: t,
      ...
      messageId: n,
      answerIds: e
    }), (0, N.eu)(t, n, () => void 0), c.uv.announce(0 === e.length ? A.intl.string(A.t["xcvy+/"]) : A.intl.string(A.t.o20GSk))
  } catch (e) {
    var o, s, u;
    d.Z.show({
