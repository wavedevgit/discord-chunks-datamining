...
function A(e) {
  ...
  if (null != t && null == d.Z.getChannel(t)) throw new _.Z({
    errorCode: N.lTL.INVALID_CHANNEL
...
let Z = {
  [N.zMe.GUILD_STATUS]: {
    ...
    handler(e) {
      ...
      if (null == h.Z.getGuild(t)) throw new _.Z({
  ...
  [N.zMe.VOICE_STATE_CREATE]: {
    ...
    handler(e) {
      ...
      if (null == d.Z.getChannel(t)) throw new _.Z({
        errorCode: N.lTL.INVALID_CHANNEL
      }, "Invalid channel id: ".concat(t));
      return e => {
        let {
    ...
    handler(e) {
      ...
      return e => {
        let {
          ...
          currentGuildMember: p.ZP.getSelfMember(t)
        };
  ...
  [N.zMe.SCREENSHARE_STATE_UPDATE]: {
    ...
    handler: () => e => {
      ...
      let {
        prevState: n,
        dispatch: r
      } = e, l = u.Z.getStreamerActiveStreamMetadata(), a = (null == l ? void 0 : l.pid) != null ? s.ZP.getGameForPID(l.pid) : null, c = (null == a ? void 0 : a.id) != null ? o.Z.getApplication(a.id) : null, d = null != c ? (0, I.Z)(c) : null, p = null == l ? void 0 : l.sourceName, h = {
        active: null != l,
