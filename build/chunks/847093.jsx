/** Chunk was on 67544 **/
/** chunk id: 847093, original params: e,t,n (module,exports,require) **/
require.d(exports, {
  Z: () => M
...
let Chunk874332 = require("./874332.js"),
  Chunk225334 = require("./225334.js"),
  E = function(e) {
    let t = arguments.length > 1 && true !== arguments[1] ? arguments[1] : 0,
      n = arguments.length > 2 && true !== arguments[2] ? arguments[2] : 0,
      r = arguments.length > 3 && true !== arguments[3] ? arguments[3] : 0,
      s = arguments.length > 4 && true !== arguments[4] ? arguments[4] : 0;
    return {
      0: {
        top: t + s + e,
        right: n - r / 6 - e
  ...
  S = () => [Chunk388032.intl.string(Chunk603571.default.TXLQ3d), Chunk388032.intl.string(Chunk603571.default.TC42mZ), Chunk388032.intl.string(Chunk603571.default.h3tura), Chunk388032.intl.string(Chunk603571.default["sAbI/v"]), Chunk388032.intl.string(Chunk603571.default.NJ4o2t), Chunk388032.intl.string(Chunk603571.default.sUsj8f), Chunk388032.intl.string(Chunk603571.default.jMKjJC), Chunk388032.intl.string(Chunk603571.default.J6uWam)];
...
function I(e) {
  ...
  return o((e, n) => n ? <c.animated.div className={_.affirmation} style={C({}, a.current, e)}>{t}</c.animated.div> : null)
}
...
function k(e) {
  let {
    ...
    className: i
  } = e, c = (0, p.Dt)(), l = (0, p.Dt)(), u = <path d={n} stroke={t ? "white" : "currentColor"} strokeWidth={"3"} strokeLinecap={"round"} />;
  return <svg className={i} viewBox={"0 0 ".concat(s, " ").concat(o)} fill={"none"} xmlns={"http://www.w3.org/2000/svg"}>{t ? (0, r.jsxs)(r.Fragment, {
