...
var h, t, Chunk255367 = require("./255367.js"),
...
let E = Object.freeze({
  DURATION: {
    ...
    [Chunk474936.p9.TIER_2]: 1500
  },
  DELAY: {
    [Chunk474936.p9.TIER_0]: 400,
    [Chunk474936.p9.TIER_1]: 400,
    [Chunk474936.p9.TIER_2]: 2200
  },
...
class g extends(h = Chunk73800.PureComponent) {
  componentDidMount() {
    this.animate()
  }
  animate() {
  ...
  getSvgBorderGradientId() {
    ...
    switch (exports) {
      case "GUILD_BOOST_APPLIED":
        return Chunk436774.Rj.PREMIUM_GUILD;
      case "PREMIUM_ACTIVATED":
      case "PREMIUM_PAYMENT_STARTED":
      case "PREMIUM_UPGRADED":
      case "PREMIUM_UPDATED":
        if (module === Chunk474936.p9.TIER_0) return Chunk436774.Rj.PREMIUM_TIER_0;
        if (module === Chunk474936.p9.TIER_1) return Chunk436774.Rj.PREMIUM_TIER_1;
        return Chunk436774.Rj.PREMIUM_TIER_2;
      default:
  ...
  renderSvgBorder() {
    ...
    switch (module) {
      case "GUILD_BOOST_APPLIED":
        return <svg className={Chunk970612.svgBorder} width={"304"} height={"48"} viewBox={"0 0 304 48"}><rect x={"1"} y={"1"} fill={"none"} width={"302"} height={"46"} rx={"8"} stroke={"url(#".concat(this.getSvgBorderGradientId(), ")")} strokeWidth={"2"} /></svg>;
      case "PREMIUM_PAYMENT_STARTED":
        return <svg className={Chunk970612.svgBorder} width={"156"} height={"48"} viewBox={"0 0 156 48"}><rect x={"1"} y={"1"} fill={"none"} width={"154"} height={"46"} rx={"8"} stroke={"url(#".concat(this.getSvgBorderGradientId(), ")")} strokeWidth={"2"} /></svg>;
      case "PREMIUM_ACTIVATED":
      case "PREMIUM_UPGRADED":
        return <svg className={Chunk970612.svgBorder} width={"298"} height={"48"} viewBox={"0 0 298 48"}><rect x={"1"} y={"1"} fill={"none"} width={"296"} height={"46"} rx={"8"} stroke={"url(#".concat(this.getSvgBorderGradientId(), ")")} strokeWidth={"2"} /></svg>;
      case "PREMIUM_UPDATED":
        return <svg className={Chunk970612.svgBorder} width={"276"} height={"48"} viewBox={"0 0 276 48"}><rect x={"1"} y={"1"} fill={"none"} width={"274"} height={"46"} rx={"8"} stroke={"url(#".concat(this.getSvgBorderGradientId(), ")")} strokeWidth={"2"} /></svg>;
      default:
        return null
    }
  }
  ...
  render() {
    ...
    return <div className={c()(Chunk970612.container, module)}>{this.renderSvgBorder()}{<Chunk748780.Z.div className={Chunk970612.animationContainer} style={this.getContainerStyle()}>{<Chunk481060.ZX5 className={Chunk970612.shine} style={this.getShineStyle()} />}{this.renderSvgCopy()}</Chunk748780.Z.div>}</div>
  }
  constructor(...a) {
