...
function p() {
  ...
  return <Chunk255367.Fragment>{<Chunk861345.p benefits={require} onEdit={function(e) {
        ...
        let r = [...n],
          [i] = r.splice(e, 1);
        r.splice(t, 0, i), p(r)
      }} guildId={exports} />}{require.length > 0 ? <Chunk481060.LZC size={8} /> : null}{<Chunk861345.s onClick={function() {
        (0, Chunk481060.h7j)(e => (0, r.jsx)(o.DI, g(m({}, e), {
          guildId: t,
          onSave: e => h(e)
        })))
      }} disabled={f}>{Chunk388032.intl.string(Chunk388032.t["6dwqo6"])}</Chunk861345.s>}</Chunk255367.Fragment>
}