...
function N(e) {
  ...
  } = (0, c.ZP)(l.Z.USER_MENTION), R = (0, a.e7)([E.default], () => E.default.getUser(i)), w = (0, a.e7)([p.Z], () => p.Z.getChannel(d)), D = null != w ? w.getGuildId() : null, L = N || null == R || null == D || null == d ? void 0 : e => {
  ...
  }, x = y.ZP.useName(R), k = (0, a.e7)([p.Z, h.ZP, g.Z], () => b.ZP.getNickname(D, d, R)), M = m.Z.getGuild(D), j = (0, u.Ib)(M, w) && i === O.fL ? O.jM : null;
