...
function y(e) {
  ...
  return I && (D = E.intl.string(E.t.qmtuXF)), <d.Z>{<d.Z.Header text={D} />}{<d.Z.Body>{<div className={b.headerLine}>{<d.Z.Icon channel={S} onClick={N ? C : true} />}{<d.Z.Info title={R} onClick={N ? C : true}><d.Z.Data members={t.length} /></d.Z.Info>}</div>}{<d.Z.Button onClick={C} submitting={T} isDisabled={N} color={w}>{P}</d.Z.Button>}</d.Z.Body>}</d.Z>
}