...
function h() {
  let {
    ...
    isPortrait: n,
    onClose: l
  } = Chunk473749.useContext(Chunk215113.VideoQuestModalContext), h = (0, Chunk915750.aM)(), b = (0, Chunk113434.tP)(module), S = Chunk473749.useRef(null), {
    isHoveringOrFocusing: y
  } = (0, Chunk104505.Z)(S), C = (0, Chunk684245.e)({
    quest: module,
    onClose: Chunk120356,
  ...
  return (0, Chunk54381.jsx)(Chunk681715.u, {
    ...
    children: (0, Chunk54381.jsx)(Chunk481060.P3F, {
      onClick: () => C(Chunk497505.jn.VIDEO_MODAL, Chunk617136.jZ.OPEN_GAME_LINK),
