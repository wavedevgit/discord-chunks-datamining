...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk527790 = require("./527790.js"),
  Chunk540440 = require("./540440.js"),
  Chunk365583 = require("./365583.js"),
...
function C(t) {
  ...
  return r.useEffect(() => c.Bt, []), <l.Modal title={(0, _.y)(i)} subtitle={h.intl.format(h.t.KV72oa, {
      settingsHook: (t, n) => {
        let r = (0, T.C)({
          entry: i,
          onOpenGameSettings: f
      ...
      size: "sm"
    }]} onClose={R} transitionState={C}>{null != O ? <div className={p.error}>{<a.k$p color={a.TVs.colors.STATUS_DANGER} />}{<a.Text variant={"text-sm/medium"}>{h.intl.string(h.t.FMbL3t)}</a.Text>}</div> : null}{<u.Z user={n} entry={i} className={p.card} hideContextMenu={true} />}</l.Modal>
}