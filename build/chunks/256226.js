...
let N = i.forwardRef(function(e, t) {
  ...
  let {
    ...
    tabIndex: x
  } = L, M = I(L, ["tabIndex"]), j = (0, m.p9)({
    roleId: C.id,
    size: 16,
    guildId: P
  }), k = (0, c.e7)([_.Z], () => _.Z.roleStyle), U = (null === (o = C.tags) || void 0 === o ? void 0 : o.guild_connections) === null, G = i.useCallback(e => {
    (0, f.jW)(e, async () => {
      let {
        default: e
  ...
  return (0, r.jsx)(d.tEY, {
    children: (0, r.jsxs)("div", S(y({
      ...
      children: [Y(), null != j ? (0, r.jsx)(g.Z, S(y({
