...
function u(e) {
  ...
  } = e, f = (0, o.h)(t), p = (0, i.bG)([s.Ay], () => s.Ay.getLaunchState(t, "channel" === n.type ? n.channel.id : true)), _ = (0, i.bG)([l.A], () => l.A.isLaunchingFrame(t)), h = null != f && (0, c.x)(f) ? _ : null != p && p.isLaunching && p.componentId === u, m = (0, a.A)(h);
  return r.useEffect(() => {
    !h && m && (null == d || d())
  }, [h, m, d]), {
    submitting: h,
