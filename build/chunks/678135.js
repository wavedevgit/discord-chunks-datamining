...
function A(e) {
  let {
    ...
    showViewFullProfileButton: Z = !1,
    pendingBadges: H,
    shouldOpenBadgeTooltip: Y,
    showNameplatePreview: W = !1,
    interactive: K = !0
  } = e, z = (0, u.ZP)(t.id, null == n ? void 0 : n.id), {
    avatarSrc: q,
...
function N(e) {
  let {
    pendingGlobalName: t
  } = e, n = (0, o.e7)([m.default], () => m.default.getCurrentUser()), i = (0, o.e7)([h.Z], () => h.Z.getPendingNameplate());
