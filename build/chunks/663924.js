...
function R(e) {
  let {
    ...
    renderWindow: O,
    windowDispatch: v
  } = i.useContext(l.ZP), I = null != u, T = (0, o.Jw)(null != u ? u : ""), S = i.useCallback(e => {
    var t;
  ...
  i.useLayoutEffect(() => (O.addEventListener("mousedown", S), O.addEventListener("contextmenu", S), v.subscribe(b.CkL.POPOUT_CLOSE, w), () => {
