/** Chunk was on web.js **/
/** chunk id: 368742, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  G: () => o,
  z: () => i
});
var Chunk128709 = require("./128709.js");
...
function i(e, t) {
  let n = a(e, t, "left"),
    ...
    O = parseInt(f, 10) || 0,
    v = parseInt(p, 10) || 0;
  n <= s + v ? s = n - parseInt(u, 10) - v : n + i > g - O && (s += n + i - g + O), r <= m + b ? l = r - parseInt(c, 10) - b : r + o > E - y && (l += r + o - E + y), e.scrollLeft = s, e.scrollTop = l
}
...
function o(e, t) {
  if (e && document.contains(e)) {
    ...
    if ("hidden" === window.getComputedStyle(l).overflow)
      ...
      (Math.abs(r - l) > 1 || Math.abs(i - c) > 1) && (null == t || null == (o = t.containingElement) || null == (a = o.scrollIntoView) || a.call(o, {
        block: "center",
        inline: "center"
