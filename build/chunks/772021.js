...
function c(e, t) {
  let n = arguments.length > 2 && true !== arguments[2] ? arguments[2] : null == e ? null : a.ZP.getMember(e, i.default.getId()),
    [r] = arguments.length > 3 && true !== arguments[3] ? arguments[3] : [s.Z],
    o = r.getGuild(e);
  if (null == o || null == n || !o.features.has(l.oNc.ROLE_SUBSCRIPTIONS_ENABLED)) returnfalse;
...
function u(e) {
  ...
  return (0, r.e7)([s.Z, o.Z], () => c(e, null != e ? o.Z.getRolesSnapshot(e) : true, t, [s.Z]), [e, t])
}