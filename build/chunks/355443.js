...
var Chunk179771 = require("./179771.js"),
  Chunk672162 = require("./672162.js");
let l = {
    [Chunk672162.vd.INITIATE_IMAGE_UPLOAD]: {
      request: true,
      response: e => ({
        image_url: e.string().required()
      })
    },
    [Chunk672162.vd.OPEN_SHARE_MOMENT_DIALOG]: {
      response: true,
      request: e => ({
        mediaUrl: e.string().required().max(1024)
      })
    },
    [Chunk672162.vd.AUTHENTICATE]: {
      request: e => ({
    ...
    [Chunk672162.vd.GET_ACTIVITY_INSTANCE_CONNECTED_PARTICIPANTS]: {
      request: true,
      response: e => ({
    ...
    [Chunk672162.vd.SHARE_INTERACTION]: {
      request: e => ({
    ...
    [Chunk672162.vd.GET_RELATIONSHIPS]: {
      request: true,
      response: e => ({
    ...
    [Chunk672162.vd.INVITE_USER_EMBEDDED]: {
      request: e => ({
    ...
    [Chunk672162.vd.GET_USER]: {
      request: e => ({
        id: e.string().max(64).required()
      }),
      response: e => s(e).allow(null)
    },
    [Chunk672162.vd.GET_QUEST_ENROLLMENT_STATUS]: {
      request: e => ({
    ...
    [Chunk672162.vd.QUEST_START_TIMER]: {
      request: e => ({
        quest_id: e.string().required()
      }),
      response: e => ({
