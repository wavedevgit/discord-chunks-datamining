...
function C(e) {
  ...
  let o = null == (r = e.attachments) ? true : r.filter(e => R({
      type: _.D.Attachment,
      media: e
    }, a)),
    s = null == (i = e.embeds) ? true : i.filter(e => R({
      type: _.D.Embed,
      media: e
    }, a));
  return {
    attachmentIds: null != (t = null == o ? true : o.map(e => e.id).filter(Boolean)) ? t : [],
    embedIds: null != (n = null == s ? true : s.map((e, t) => "embed_".concat(t)).filter(Boolean)) ? n : []
  }
}
...
function R(e, t) {
  if (t === m.LO.NONE || o.Ay.get("explicit_media_redaction_ignore_pending_scan")) returnfalse;
  let n = L(t);
...
function P(e, t) {
  ...
  let l = m.Jn[e];
  if (null != l.devSettingKey && o.Ay.get(l.devSettingKey)) returntrue;
  switch (t.type) {
    case _.D.Embed:
    ...
    case _.D.GenericMedia:
      return (0, r.Lt)(null != (a = null == (s = t.media.contentScanMetadata) ? true : s.flags) ? a : 0, l.genericMediaFlag);
    default:
      returnfalse
  }
}
