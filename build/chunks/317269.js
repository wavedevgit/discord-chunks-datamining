...
function E(t) {
  ...
  if (C()(null != a && null != L, "Missing startingPlan or newPlan"), x.Y1.indexOf(l) < x.Y1.indexOf(n)) switch (n) {
      ...
      case x.Xh.PREMIUM_YEAR_TIER_2:
        e = f.intl.formatToPlainString(f.t["M/Lknp"], {
          numFreeGuildSubscriptions: x.cb
        }), T.X7u.has(null != s ? s : T.HeQ.UNKNOWN) && (e = f.intl.format(f.t.mULxLS, {
          numFreeGuildSubscriptions: x.cb
        }));
        break;
...
function _(t) {
  ...
  if (null != w) e = (0, i.jsx)("div", {
    className: I.text,
    children: f.intl.format(f.t.tsQOs7, {
      skuName: w.name
    })
  });
  else if (b && !p) {
    let t = d.Z.get(s);
    C()(null != t, "Missing plan"), t.skuId === x.Si.TIER_0 ? e = (0, i.jsxs)("div", {
      className: I.text,
      children: [(0, i.jsx)("p", {
        children: f.intl.string(f.t.L9lcGx)
      }), (0, i.jsx)("p", {
        children: f.intl.format(f.t.EoDFuL, {
          helpCenterLink: h.Z.getArticleURL(T.BhN.FRACTIONAL_PREMIUM_ABOUT)
        })
      })]
    }) : (t.skuId === x.Si.TIER_1 || t.skuId === x.Si.TIER_2) && (e = (0, i.jsxs)("div", {
      className: I.text,
      children: [(0, i.jsx)("p", {
        children: f.intl.string(f.t.UPpbPz)
      }), (0, i.jsx)("p", {
        children: f.intl.format(f.t.EoDFuL, {
          helpCenterLink: h.Z.getArticleURL(T.BhN.FRACTIONAL_PREMIUM_ABOUT)
        })
  ...
  } else if (null != u) e = (0, i.jsx)(E, {
    planId: s,
    startingPremiumSubscriptionPlanId: u
  });
  else if (null != j) {
    let t = d.Z.get(s);
    C()(null != t, "Missing plan"), e = (0, i.jsxs)(i.Fragment, {
      children: [(0, i.jsx)("div", {
        className: I.text,
        children: A(t)
      }), (0, i.jsx)("div", {
        className: I.text,
        children: f.intl.format(f.t["6aZ0NT"], {
          guildName: j.name
        })
      })]
    })
    ...
    let t = d.Z.get(s);
    C()(null != t, "Missing plan"), e = (0, i.jsx)("div", {
      className: I.text,
      children: A(t)
    })
  }
  let O = Z.ZP.getPremiumType(s);
  C()(null != O, "premium type should not be null in purchase confirmation"), n = null != w ? f.intl.formatToPlainString(f.t["1qGgm5"], {
    skuName: w.name
  }) : p ? f.intl.string(f.t.QJ9EyM) : null != j ? f.intl.string(f.t.ta3cXV) : f.intl.string(f.t.TkTvBw);
