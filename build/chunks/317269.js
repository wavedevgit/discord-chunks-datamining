...
function E(e) {
  ...
  if (s()(null != a && null != C, "Missing startingPlan or newPlan"), m.Y1.indexOf(i) < m.Y1.indexOf(n)) switch (n) {
      ...
      case m.Xh.PREMIUM_YEAR_TIER_2:
        ...
        }), L.X7u.has(null != l ? l : L.HeQ.UNKNOWN) && (t = g.intl.format(g.t.mULxLS, {
          numFreeGuildSubscriptions: m.cb
        }));
        break;
...
function y(e) {
  ...
  if (null != Z) t = (0, r.jsx)("div", {
    ...
    let e = p.Z.get(l);
    s()(null != e, "Missing plan"), e.skuId === m.Si.TIER_0 ? t = (0, r.jsxs)("div", {
      className: S.text,
      children: [(0, r.jsx)("p", {
        children: g.intl.string(g.t.L9lcGx)
      }), (0, r.jsx)("p", {
        children: g.intl.format(g.t.EoDFuL, {
          helpCenterLink: x.Z.getArticleURL(L.BhN.FRACTIONAL_PREMIUM_ABOUT)
        })
      })]
    }) : (e.skuId === m.Si.TIER_1 || e.skuId === m.Si.TIER_2) && (t = (0, r.jsxs)("div", {
      className: S.text,
      children: [(0, r.jsx)("p", {
  ...
  return s()(null != k, "premium type should not be null in purchase confirmation"), n = null != Z ? g.intl.formatToPlainString(g.t["1qGgm5"], {
    skuName: Z.name
  }) : I ? g.intl.string(g.t.QJ9EyM) : null != T ? g.intl.string(g.t.ta3cXV) : g.intl.string(g.t.TkTvBw), (0, r.jsxs)("div", {
