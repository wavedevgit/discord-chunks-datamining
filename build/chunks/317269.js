...
function y(e) {
  ...
  if (s()(null != a && null != C, "Missing startingPlan or newPlan"), L.Y1.indexOf(i) < L.Y1.indexOf(n)) switch (n) {
      ...
      case L.Xh.PREMIUM_YEAR_TIER_2:
        t = S.NW.formatToPlainString(S.t["M/Lknp"], {
          numFreeGuildSubscriptions: L.cb
        }), g.X7u.has(null != l ? l : g.HeQ.UNKNOWN) && (t = S.NW.format(S.t.mULxLS, {
          numFreeGuildSubscriptions: L.cb
        }));
        break;
...
function I(e) {
  let t, n, {
      ...
      postSuccessGuild: T,
      paymentSourceType: P,
      startingFractionalPremiumEndsAt: M
    } = e,
    {
      theme: O
    } = (0, a.TCT)(),
  ...
  if (null != Z) t = (0, r.jsx)("div", {
    className: E.text,
    children: S.NW.format(S.t.tsQOs7, {
      skuName: Z.name
    })
  });
  else if (A) {
    let e = _.Z.get(l);
    s()(null != e, "Missing plan"), e.skuId === L.Si.TIER_0 ? t = (0, r.jsxs)("div", {
      className: E.text,
      children: [(0, r.jsx)("p", {
        children: S.NW.string(S.t.L9lcGx)
      }), (0, r.jsx)("p", {
        children: S.NW.format(S.t.EoDFuL, {
          helpCenterLink: h.Z.getArticleURL(g.BhN.FRACTIONAL_PREMIUM_ABOUT)
        })
      })]
    }) : (e.skuId === L.Si.TIER_1 || e.skuId === L.Si.TIER_2) && (t = (0, r.jsxs)("div", {
      className: E.text,
      children: [(0, r.jsx)("p", {
        children: S.NW.string(S.t.UPpbPz)
      }), (0, r.jsx)("p", {
        children: S.NW.format(S.t.EoDFuL, {
          helpCenterLink: h.Z.getArticleURL(g.BhN.FRACTIONAL_PREMIUM_ABOUT)
        })
    ...
    s()(null != e, "Missing plan"), t = (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsx)("div", {
        ...
        className: E.text,
        children: S.NW.format(S.t["6aZ0NT"], {
          guildName: T.name
        })
      })]
    })
    ...
    className: E.text,
    children: S.NW.format(S.t.PLXpCw, {
      helpCenterLink: h.Z.getArticleURL(g.BhN.FRACTIONAL_PREMIUM_ABOUT)
    })
  });
  let U = f.ZP.getPremiumType(l);
  return s()(null != U, "premium type should not be null in purchase confirmation"), n = null != Z ? S.NW.formatToPlainString(S.t["1qGgm5"], {
    skuName: Z.name
  }) : N ? S.NW.string(S.t.QJ9EyM) : null != T ? S.NW.string(S.t.ta3cXV) : S.NW.string(S.t.TkTvBw), (0, r.jsxs)("div", {
