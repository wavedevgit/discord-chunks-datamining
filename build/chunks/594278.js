...
let g = function(e) {
  let {
    ...
    renderItem: p
  } = e, h = i.useMemo(() => new a.Xp, []), [f, x] = i.useState(d.n.LEFT), [b, j] = i.useState(0), [N, _] = i.useState(!1), [v, O] = i.useState(!1), C = i.useCallback((e, t) => {
    j(n => {
      let r = n + t;
    ...
    v || C(t, 1)
  }, [C, t, v]), I = i.useCallback(() => {
    v || C(t, -1)
  }, [C, t, v]);
  return i.useEffect(() => {
    null != g && (N ? N && h.stop() : h.start(g, y))
  }, [N, h, g, y]), (0, r.jsxs)("div", {
    className: m.root,
    onMouseEnter: () => _(!0),
    onMouseLeave: () => _(!1),
