...
g.prototype.push = function(e, t) {
  ...
  do {
    if (0 === s.avail_out && (s.output = new i.Buf8(p), s.next_out = 0, s.avail_out = p), (n = r.deflate(s, a)) !== f && n !== d) return this.onEnd(n), this.ended = true, false;
  ...
  return a === u ? (n = r.deflateEnd(this.strm), this.onEnd(n), this.ended = true, n === d) : (a === _ && (this.onEnd(d), s.avail_out = 0), true)
