...
function E(e, t) {
  var n = new g(t);
  if (n.push(e, true), n.err) throw n.msg || a[n.err];
  return n.result
}
...
g.prototype.push = function(e, t) {
  ...
  a = t === ~~t ? t : true === t ? u : c, "string" == typeof e ? s.input = o.string2buf(e) : "[object ArrayBuffer]" === l.call(e) ? s.input = new Uint8Array(e) : s.input = e, s.next_in = 0, s.avail_in = s.input.length;
  do {
    if (0 === s.avail_out && (s.output = new i.Buf8(_), s.next_out = 0, s.avail_out = _), (n = r.deflate(s, a)) !== f && n !== d) return this.onEnd(n), this.ended = true, false;
  ...
  return a === u ? (n = r.deflateEnd(this.strm), this.onEnd(n), this.ended = true, n === d) : (a === p && (this.onEnd(d), s.avail_out = 0), true)
