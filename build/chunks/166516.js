...
! function() {
  var e = function(t) {
    "use strict";
    t = t || {};
    var e, o, n, r, i, a, s, l, h, c, f, u, d, y, p, g, w = {
      bgColor: "#d00",
      textColor: "#fff",
    ...
    m.ready = function() {
      ...
      l && (x = [], h = false, c = false, a.clearRect(0, 0, r, n), a.drawImage(s, 0, 0, r, n), E.setIcon(i), window.clearTimeout(y), window.clearTimeout(p))
    }, m.start = function() {
      if (l && !c) {
        var t = function() {
