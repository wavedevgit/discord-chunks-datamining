...
! function() {
  var e = function(t) {
    "use strict";
    t = t || {};
    var e, o, r, n, i, a, s, l, h, c, f, u, d, y, p, g, w = {
      bgColor: "#d00",
      textColor: "#fff",
    ...
    var x = [];
    f = function() {}, l = u = false;
    var m = {};
    m.ready = function() {
      l = true, m.reset(), f()
    }, m.reset = function() {
      l && (x = [], h = false, c = false, a.clearRect(0, 0, n, r), a.drawImage(s, 0, 0, n, r), E.setIcon(i), window.clearTimeout(y), window.clearTimeout(p))
    }, m.start = function() {
      if (l && !c) {
        var t = function() {
          h = x[0], c = false, x.length > 0 && (x.shift(), m.start())
        };
        if (x.length > 0) {
          c = true;
          var o = function() {
    ...
    E.getIcon = function() {
      ...
      if (e.dataUrl && e.dataUrl(r), e.element) e.element.setAttribute("href", r), e.element.setAttribute("src", r);
        ...
        var i = o;
        o = g.createElement("link"), d.opera && o.setAttribute("rel", "icon"), o.setAttribute("rel", "icon"), o.setAttribute("type", "image/png"), g.getElementsByTagName("head")[0].appendChild(o), o.setAttribute("href", r), i.parentNode && i.parentNode.removeChild(i)
    ...
    I.duration = 40, I.types = {}, I.types.fade = [{
      ...
      b[e.type](M(t, a[n])), y = setTimeout(function() {
        r ? n -= 1 : n += 1, I.run(t, o, r, n)
      }, I.duration), E.setIcon(i)
    }, (e = M(w, t)).bgColor = A(e.bgColor), e.textColor = A(e.textColor), e.position = e.position.toLowerCase(), e.animation = I.types["" + e.animation] ? e.animation : w.animation, g = e.win.document;
    ...
    if (T || U)
      for (var R = 0; R < I.types["" + e.animation].length; R++) {
        ...
        T && (S.y < .6 ? S.y = S.y - .4 : S.y = S.y - 2 * S.y + (1 - S.w)), U && (S.x < .6 ? S.x = S.x - .4 : S.x = S.x - 2 * S.x + (1 - S.h)), I.types["" + e.animation][R] = S
      }
    return e.type = b["" + e.type] ? e.type : w.type, o = E.getIcon(), i = document.createElement("canvas"), s = document.createElement("img"), o.hasAttribute("href") ? (s.setAttribute("crossOrigin", "anonymous"), s.onload = function() {
      r = s.height > 0 ? s.height : 32, n = s.width > 0 ? s.width : 32, i.height = r, i.width = n, a = i.getContext("2d"), m.ready()
    }, s.setAttribute("src", o.getAttribute("href"))) : (s.onload = function() {
      r = 32, n = 32, s.height = r, s.width = n, i.height = r, i.width = n, a = i.getContext("2d"), m.ready()
    }, s.setAttribute("src", "")), {
      badge: function(t, e) {
        e = ("string" == typeof e ? {
          animation: e
