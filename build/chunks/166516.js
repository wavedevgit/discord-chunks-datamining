/** Chunk was on 70401 **/ ! function() {
  var t = function(e) {
    "use strict";
    e = e || {};
    var t, n, r, o, i, a, c, s, d, l, p, u, h, f, y, g, w = {
      bgColor: "#d00",
      textColor: "#fff",
    ...
    return t.type = b["" + t.type] ? t.type : w.type, n = E.getIcon(), i = document.createElement("canvas"), c = document.createElement("img"), n.hasAttribute("href") ? (c.setAttribute("crossOrigin", "anonymous"), c.onload = function() {
        ...
        t = ("string" == typeof t ? {
          ...
          try {
            if ("number" == typeof e ? e > 0 : "" !== e) {
              ...
              if ("animation" in t && I.types["" + t.animation] && (n.options.animation = "" + t.animation), "type" in t && b["" + t.type] && (n.options.type = "" + t.type), ["bgColor", "textColor"].forEach(function(e) {
