...
let P = e => {
    let {
      ...
      hasActiveThreads: a,
      withGuildIcon: c
    } = e, u = (0, o.e7)([O.Z], () => O.Z.getGuild(l.guild_id), [l.guild_id]), d = l.type === S.d4z.DM || l.type === S.d4z.GROUP_DM, A = null;
  ...
  x = 12633 == n.j ? l.forwardRef(function(e, t) {
    ...
    let {
      ...
      withGuildIcon: q,
      hasActiveEvent: X = !1
    } = e, J = W === p.i.ALL_MESSAGES || null != Z && Z > 0, Q = (0, a.JA)(s.id), {
      role: $
    } = Q, ee = function(e, t) {
      if (null == e) return {};
      ...
      return l
    }(Q, ["role"]), et = l.useRef(null), en = l.useRef(null), er = (0, A.Z)(s), el = S.Z5c.CHANNEL(er, s.id), es = (0, u.ZP)(s), ei = s.isGuildVocal(), ea = (0, r.jsx)("div", {
      className: i()({
    ...
    return (0, r.jsx)(E.tEY, {
      ...
      children: (0, r.jsxs)("div", {
        ref: t,
        className: i()(x, null != g || null != m || null != f || K ? U.wrapper : U.notInteractive, (() => {
        ...
        onMouseEnter: z,
        onMouseLeave: B,
        children: [c || !O ? null : (0, r.jsx)("div", {
          className: i()(U.unread, J ? U.unreadImportant : void 0)
