...
let P = e => {
    let {
      ...
      hasActiveThreads: i,
      withGuildIcon: u
    } = e, c = (0, o.e7)([I.Z], () => I.Z.getGuild(l.guild_id), [l.guild_id]), d = l.type === S.d4z.DM || l.type === S.d4z.GROUP_DM, A = null;
  ...
  x = 12633 == n.j ? l.forwardRef(function(e, t) {
    ...
    let {
      ...
      withGuildIcon: q,
      hasActiveEvent: X = !1
    } = e, J = Z === U.i.ALL_MESSAGES || null != K && K > 0, Q = (0, i.JA)(s.id), {
      role: $
    } = Q, ee = function(e, t) {
      if (null == e) return {};
      ...
      return l
    }(Q, ["role"]), et = l.useRef(null), en = l.useRef(null), er = (0, A.Z)(s), el = S.Z5c.CHANNEL(er, s.id), es = (0, c.ZP)(s), ea = s.isGuildVocal(), ei = (0, r.jsx)("div", {
      className: a()({
        [L.favoritesSuggestion]: Y
      }),
      ref: en,
      children: (0, r.jsxs)(N.Z, D(p({
    ...
    return (0, r.jsx)(E.tEY, {
      ...
      children: (0, r.jsxs)("div", {
        ref: t,
        className: a()(x, null != g || null != m || null != f || k ? L.wrapper : L.notInteractive, (() => {
        ...
        onMouseEnter: W,
        onMouseLeave: z,
        children: [u || !I ? null : (0, r.jsx)("div", {
          className: a()(L.unread, J ? L.unreadImportant : void 0)
        }), null != (n = null == b ? void 0 : b(ei)) ? n : ei]
      })
    })
  }) : null