...
function b(e) {
  let {
    channel: t,
    size: n = E.EFr.SIZE_20
  } = e, l = (0, i.e7)([g.default], () => g.default.getUser(null == t ? void 0 : t.recipients[0])), s = (0, i.e7)([R.Z], () => !(null == l || null == t || t.isMultiUserDM()) && null != R.Z.getTypingUsers(null == t ? void 0 : t.id)[null == l ? void 0 : l.id]), {
    status: a,
    isMobile: o
...
let P = e => {
    let {
      ...
      hasActiveThreads: o,
      withGuildIcon: c
    } = e, u = (0, i.e7)([I.Z], () => I.Z.getGuild(l.guild_id), [l.guild_id]), d = l.type === S.d4z.DM || l.type === S.d4z.GROUP_DM, A = null;
  ...
  x = l.forwardRef(function(e, t) {
    ...
    let {
      ...
      withGuildIcon: q,
      hasActiveEvent: X = !1
    } = e, J = Z === p.i.ALL_MESSAGES || null != K && K > 0, Q = (0, o.JA)(s.id), {
      role: $
    } = Q, ee = function(e, t) {
      if (null == e) return {};
      ...
      return l
    }(Q, ["role"]), et = l.useRef(null), en = l.useRef(null), er = (0, A.Z)(s), el = S.Z5c.CHANNEL(er, s.id), es = (0, u.ZP)(s), ea = s.isGuildVocal(), eo = (0, r.jsx)("div", {
      className: a()({
        [U.favoritesSuggestion]: Y
      }),
      ref: en,
      children: (0, r.jsxs)(N.Z, D(L({
    ...
    return (0, r.jsx)(E.tEY, {
      ...
      children: (0, r.jsxs)("div", {
        ref: t,
        className: a()(x, null != g || null != m || null != f || V ? U.wrapper : U.notInteractive, (() => {
        ...
        children: [c || !I ? null : (0, r.jsx)("div", {
          className: a()(U.unread, J ? U.unreadImportant : void 0)
        }), null != (n = null == b ? void 0 : b(eo)) ? n : eo]
      })
    })
  })