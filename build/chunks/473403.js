...
function x(e) {
  let {
    channel: t,
    size: n = s.EFr.SIZE_20
  } = e, r = (0, c.e7)([b.default], () => b.default.getUser(null == t ? void 0 : t.recipients[0])), i = (0, c.e7)([v.Z], () => !(null == r || null == t || t.isMultiUserDM()) && null != v.Z.getTypingUsers(null == t ? void 0 : t.id)[null == r ? void 0 : r.id]), {
    status: o,
    isMobile: l
  } = (0, c.cj)([h.Z], () => null == r || null == t || t.isMultiUserDM() ? {
    status: null,
    isMobile: !1
  } : {
...
let Z = e => {
    let {
      ...
      hasActiveThreads: l,
      withGuildIcon: u
    } = e, _ = (0, c.e7)([I.Z], () => I.Z.getGuild(r.guild_id), [r.guild_id]), f = r.type === S.d4z.DM || r.type === S.d4z.GROUP_DM, p = null;
    if (u && null != _ && !f) p = (0, a.jsx)(m.Z, {
      size: m.E.SMALL_32,
  ...
  R = r.forwardRef(function(e, t) {
    ...
    let {
      ...
      return r
    }(J, ["role"]), et = r.useRef(null), en = r.useRef(null), ea = (0, p.Z)(i), er = S.Z5c.CHANNEL(ea, i.id), ei = (0, _.ZP)(i), eo = i.isGuildVocal(), el = (0, a.jsx)("div", {
      className: o()({
        [A.favoritesSuggestion]: q
      }),
      ref: en,
      children: (0, a.jsxs)(g.Z, P(N({
        ...
        children: [(0, a.jsxs)("div", {
          ...
          }), r.Children.count(W) > 0 ? (0, a.jsx)("div", {
            onClick: T,
            className: A.children,
            children: W
          }) : null]
        }), null != k ? (0, a.jsx)("div", {
          className: o()(A.linkBottom, {
            [A.withGuildIcon]: Y
          }),
    ...
    return (0, a.jsx)(s.tEY, {
      ...
      children: (0, a.jsxs)("div", {
        ref: t,
        className: o()(R, null != b || null != L || null != y || H ? A.wrapper : A.notInteractive, (() => {
        ...
        onMouseEnter: M,
        onMouseLeave: B,
        children: [u || !I ? null : (0, a.jsx)("div", {
          className: o()(A.unread, K ? A.unreadImportant : void 0)
        }), null != (n = null == x ? void 0 : x(el)) ? n : el]
      })
    })
  })