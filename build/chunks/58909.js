...
function j(e) {
  ...
  let {
    guildId: a
  } = e, j = (0, s.e7)([f.Z], () => f.Z.getGuild(a)), v = (0, s.e7)([m.default], () => m.default.getCurrentUser()), {
    onAdoptTag: b,
    isAdopting: C
  } = (0, u.Z)(a), N = (null == v || null == (r = v.primaryGuild) ? void 0 : r.identityGuildId) === a && (null == v || null == (t = v.primaryGuild) ? void 0 : t.identityEnabled) === !0;
  if (null != v && null != j && (0, d.jq)(j)) return (0, n.jsxs)("div", {
