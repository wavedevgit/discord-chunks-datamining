...
function j(e) {
  ...
  let {
    guildId: i
  } = e, j = (0, s.e7)([m.Z], () => m.Z.getGuild(i)), v = (0, s.e7)([p.default], () => p.default.getCurrentUser()), {
    onAdoptTag: C,
    isAdopting: b
  } = (0, u.Z)(i), N = (null == v || null == (r = v.primaryGuild) ? void 0 : r.identityGuildId) === i && (null == v || null == (t = v.primaryGuild) ? void 0 : t.identityEnabled) === !0;
  if (null != v && null != j && (0, c.jq)(j)) return (0, n.jsxs)("div", {
