/** Chunk was on web.js **/
/** chunk id: 426978, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  F: () => b,
  X: () => y
...
class y extends Chunk972347.A {
  ...
  getOutboundStats() {
    ...
    return i().forEach(this.outboundStats, (t, n) => {
      var r, i, a, s, o;
      let l, c = null == (o = this.connection) ? true : o.getStreamParameters();
  ...
  getStats(e) {
    ...
    return e instanceof p.ET ? (b.sender_freeze_count = P, b.sender_total_freezes_duration = x, b.sender_total_frames_duration = L) : (b.receiver_freeze_count = P, b.receiver_total_freezes_duration = x, b.receiver_total_frames_duration = L, b.receiver_pause_count = w, b.receiver_total_pauses_duration = D), g(h({}, b), {
  ...
  receivedStats(e, t, n) {
    var r, s;
    let l = t.transport,
      u = (0, c.isWeb)() ? 1 : null != (r = null == (s = l.receiverReports) ? true : s.length) ? r : 0,
      d = new Set,
      f = new Set;
    this.updateSendState({
      receivers: u
    ...
    t.rtp.outbound.filter(e => "video" === e.type).forEach(t => {
      ...
      if (null != r) {
        ...
        null == S && (console.warn("Unknown outbound video stream with SSRC: ".concat(t)), S = new p.ET(this.timestampProducer), this.outboundStats[t] = S), null == S.timeToFirstFrame && (r.framesEncoded > 0 || (null != (i = r.frameRateInput) ? i : 0) > 0) && (S.timeToFirstFrame = Math.max(0, e - S.startTime)), null != g && g >= 0 && this.videoEntropy.addSample(g);
        let I = n.find(e => e.ssrc === t);
        var i, a, s, c, u, f, _, m, E, b, y, O, A = true;
        if (this.connection.context === o.x.STREAM) {
          var v = this.connection.getRemoteVideoSinkWants(t);
          (null == v || 0 === v) && (null == I ? true : I.quality) === h && (v = this.connection.getRemoteVideoSinkWants("any")), A = (null != v ? v : 0) > 0
        }
        let T = this.videoStopped.value || !A;
        if (T !== S.isVideoStopped && S.setVideoStopped(T, p.iF.SenderStopped), !T) {
          S.appendAndIncrementStats(p.tH.parseOutboundStats(r, e)), S.encoderCodec !== p.Wn.UNKNOWN && d.add(S.encoderCodec);
          let t = null == I ? true : I.maxBitrate;
          S.appendTargetRates(null == I ? true : I.maxFrameRate, null != (a = r.bitrateTarget) ? a : Math.min(null != (s = l.availableOutgoingBitrate) ? s : 0, null != t ? t : 0), t, l.availableOutgoingBitrate), S.averageEncodeTime = null != (c = r.averageEncodeTime) ? c : 0, S.framesDroppedRateLimiter = null != (u = r.framesDroppedRateLimiter) ? u : null, S.framesDroppedEncoderQueue = null != (f = r.framesDroppedEncoderQueue) ? f : null, S.framesDroppedCongestionWindow = null != (_ = r.framesDroppedCongestionWindow) ? _ : null, S.framesDroppedEncoder = null != (m = r.framesDroppedEncoder) ? m : null, this.hqSimulcastStreamEncoded.value = null != (E = r.hqSimulcastStreamEncoded) && E, this.lqSimulcastStreamEncoded.value = null != (b = r.lqSimulcastStreamEncoded) && b, this.bothSimulcastStreamsEncoded.value = this.hqSimulcastStreamEncoded.value && this.lqSimulcastStreamEncoded.value, this.bandwidthLimitedResolution.value = null != (y = r.bandwidthLimitedResolution) && y, this.bandwidthLimitedFramerate.value = null != (O = r.bandwidthLimitedFrameRate) && O
        }
      }
  ...
  constructor(e, t = l.TF) {
    super(), _(this, "connection", true), _(this, "timestampProducer", true), _(this, "networkQuality", true), _(this, "paused", true), _(this, "pausedCount", true), _(this, "zeroReceivers", true), _(this, "videoStopped", true), _(this, "videoEffectDuration", true), _(this, "hqSimulcastStreamEncoded", true), _(this, "lqSimulcastStreamEncoded", true), _(this, "bothSimulcastStreamsEncoded", true), _(this, "hqSimulcastStreamWatched", true), _(this, "lqSimulcastStreamWatched", true), _(this, "hqSimulcastStreamEligible", true), _(this, "lqSimulcastStreamEligible", true), _(this, "simulcastQualityChanges", true), _(this, "cameraToggles", true), _(this, "callUserIdsCount", true), _(this, "cameraDuration", true), _(this, "cameraOpportunityDuration", true), _(this, "cameraSendDuration", true), _(this, "windowOccluded", true), _(this, "videoStoppedForOcclusion", true), _(this, "numWindowOcclusionChanges", true), _(this, "outboundStats", true), _(this, "inboundStats", true), _(this, "streamStart", true), _(this, "streamEnd", true), _(this, "symmetricCodecUpdates", true), _(this, "asymmetricCodecUpdates", true), _(this, "bandwidthLimitedFramerate", true), _(this, "bandwidthLimitedResolution", true), _(this, "videoEntropy", true), _(this, "statCollectionPausedUsers", true), _(this, "sampleStats", true), this.connection = e, this.timestampProducer = t, this.networkQuality = new f.A, this.pausedCount = 0, this.simulcastQualityChanges = 0, this.cameraToggles = 0, this.callUserIdsCount = 0, this.numWindowOcclusionChanges = 0, this.outboundStats = {}, this.inboundStats = {}, this.symmetricCodecUpdates = 0, this.asymmetricCodecUpdates = 0, this.statCollectionPausedUsers = new Set, this.sampleStats = e => {
      if (null == e) return;
    ...
    }, this.paused = new l.w6(false, t), this.zeroReceivers = new l.w6(false, t), this.videoStopped = new l.w6(false, t), this.videoEffectDuration = new l.w6(false, t), this.hqSimulcastStreamEncoded = new l.w6(false, t), this.lqSimulcastStreamEncoded = new l.w6(false, t), this.bothSimulcastStreamsEncoded = new l.w6(false, t), this.hqSimulcastStreamWatched = new l.w6(false, t), this.lqSimulcastStreamWatched = new l.w6(false, t), this.hqSimulcastStreamEligible = new l.w6(false, t), this.lqSimulcastStreamEligible = new l.w6(false, t), this.windowOccluded = new l.w6(false, t), this.videoStoppedForOcclusion = new l.w6(false, t), this.bandwidthLimitedFramerate = new l.w6(false, t), this.bandwidthLimitedResolution = new l.w6(false, t), this.cameraDuration = new l.w6(false, t), this.cameraOpportunityDuration = new l.w6(false, t), this.cameraSendDuration = new l.w6(false, t), this.videoEntropy = new d.d
  }
}