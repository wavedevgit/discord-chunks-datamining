...
let _ = (0, o.hQ)(),
  j = r.memo(function(e) {
    let {
      ...
      onChange: o
    } = e, [j, C] = (0, c.US)([a.z.GUILD_TAG_USER_PROFILE_NEW_BADGE]), O = r.useMemo(() => new Map(t.map(e => [e.id, e])), [t]), E = (0, s.e7)([p.default], () => {
      var e;
      return (0, d.Pb)(null == (e = p.default.getCurrentUser()) ? void 0 : e.primaryGuild).guildId
    }), v = void 0 !== n ? n : E, S = r.useMemo(() => t.reduce((e, t) => {
      var n;
    ...
    }, [C, o]), y = r.useCallback(e => e === v, [v]), A = r.useCallback(e => e, []), P = r.useCallback(() => {
