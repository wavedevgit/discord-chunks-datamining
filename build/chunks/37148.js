...
function m(e) {
  let {
    ...
    hasGradient: a,
    children: s
  } = e, [l, c] = i.useState(24), [u, d] = i.useState(24), _ = i.useRef(null), h = i.useRef(null);
...
function b(e) {
  ...
  return null == t ? null : g(t) ? (0, r.jsx)("img", {
    src: t.src,
    alt: "",
    draggable: !1
  }) : E(t) ? (0, r.jsx)(c.F, {
...
function y(e) {
  let {
    ...
    headingId: g
  } = (0, _.v)(), E = null != t, y = c ? m : h, O = (0, r.jsx)("div", {
    ...
    className: o()(f.section, f.header, {
      [f.headerCentered]: c
    }),
