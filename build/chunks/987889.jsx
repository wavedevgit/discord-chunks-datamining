...
function S(e) {
  ...
  return <o.ua7 text={t} position={"top"} spacing={4} onTooltipShow={() => u(true)} onTooltipHide={() => u(false)}>{e => (0, r.jsx)(o.P3F, v(C({}, e), {
      className: y.action,
      onClick: e => {
        (0, f.Qz)({
          message: l,
...
function x(e) {
  ...
  return <o.yRy shouldShow={g} animation={o.yRy.Animation.NONE} position={"right"} align={"top"} autoInvert={false} targetElementRef={O} onRequestClose={() => {
      b(false), j(n.id, u)
...
let I = {
    ...
    [Chunk982183.r0.BOOKMARK]: {
      ...
      Icon: e => null != h.Z.getSavedMessage(e.message.channel_id, e.message.id) ? <o.plf{...C({}, e)} /> : <o.gt9{...C({}, e)} />,
...
function N(e) {
  ...
  return <o.Kqy direction={"horizontal"} gap={4} align={"center"} justify={"center"} className={y.actions}>{l.map(e => {
      let i = I[e];
      switch (i.type) {
        case "standard":
