...
function v(t) {
  let {
    analyticsSection: e,
    type: i
  } = t, v = (0, r.e7)([u.default], () => u.default.getCurrentUser()), N = g.ZP.canUseAnimatedAvatar(v), b = g.ZP.canUsePremiumProfileCustomization(v), y = i === m.pC.BANNER && b || i === m.pC.AVATAR && N, {
    sourceAnalyticsLocations: A
  } = (0, s.ZP)(l.Z.PREMIUM_PREVIEW_UPSELL_HEADER);
  if (a.useEffect(() => {
      y || _.default.track(h.rMx.PREMIUM_UPSELL_VIEWED, {
        type: e,
        location_stack: A
      })
    }, [y, e, A]), y) return null;
