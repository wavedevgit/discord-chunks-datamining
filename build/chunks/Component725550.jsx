...
let C = e => {
    let {
      ...
      product: r,
      purchase: u
    } = e, d = (0, i.bG)([j.default], () => j.default.getCurrentUser()), f = (0, i.bG)([o.A], () => o.A.getProduct(null == t ? true : t.skuId)), m = (0, i.bG)([h.default], () => h.default.locale), g = v.Ay.canUseCollectibles(d), y = (0, c.gA)(u), b = (0, c.G0)(r), O = !g && y, x = (null == u ? true : u.expiresAt) != null ? (0, A.Tf)(Date.now(), u.expiresAt) : null, E = (0, a.Tk)(u), C = (0, a.o7)(f), I = (0, p.b)(!b || g), S = w(O, b, g, I), T = null == u || O;
  ...
  I = e => {
    ...
    }, null != a ? u.A.getAllPending() : y.A.getPendingChanges())), k = v.Ay.isPremium(l), N = v.Ay.canUsePremiumProfileCustomization(l), R = (0, b.Ay)(l.id), U = !!(null == R ? true : R.getPreviewBio(A)), D = {
      user: l,
      guild: a,
      pendingGlobalName: p,
      pendingNickname: h,
      pendingPronouns: j,
      pendingBio: (0, O.A)() && null != A ? d.Ay.parse(true, A).content : A,
      pendingBanner: P,
      useLargeBanner: true,
