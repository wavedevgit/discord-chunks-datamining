...
class eT extends i.PureComponent {
  ...
  setAnimatedValue(e) {
    let {
      guild: t
    } = this.props, n = null != this.getGuildBannerHash(), r = null != t && (0, ec.Z)(t);
  ...
  renderChannelList() {
    ...
    {
      if (n.features.has(eg.oNc.HUB) && !l) return (0, r.jsx)("div", {
  ...
  render() {
    ...
    return (0, r.jsxs)("nav", {
      ...
      children: [null != t && this.renderGuildHeader(this.state.hasGuildSubheader), null != t && (0, r.jsx)(eh.Z, {
        guild: t,
  ...
  constructor(...e) {
    super(...e), ey(this, "historyUnlisten", () => {}), ey(this, "guildHeaderRef", i.createRef()), ey(this, "guildHeaderDropdownButtonRef", i.createRef()), ey(this, "showTimeout", new h.V7), ey(this, "state", {
      ...
      null != t && (0, m.jW)(e, async () => {
        let {
          default: e
        } = await Promise.all([n.e("71418"), n.e("7654"), n.e("44156"), n.e("7104"), n.e("6850"), n.e("58227"), n.e("67649"), n.e("54408"), n.e("20087"), n.e("88388"), n.e("87154"), n.e("33213"), n.e("15875")]).then(n.bind(n, 545135));
        return n => (0, r.jsx)(e, ev(eI({}, n), {
          guild: t
        }))
      })
...
function eP(e) {
  ...
  let c = (0, j.Z)(n),
    ...
    k = (0, F.Ll)(),
    M = (0, d.e7)([q.Z], () => null != k ? k : q.Z.theme),
    {
      enableStudyGroup: H
    } = (0, D.s)(o),
    W = (0, N.ZP)(e => e.currentlyShown.has(p.z.NAGBAR_NOTICE_CONNECT_PLAYSTATION)),
    [K, $] = i.useState(!W),
    ec = (0, E.Z)(n),
    {
  ...
  let eG = (0, T.Nj)(p.z.PREMIUM_TUTORIAL_SERVER_MENU_TOOLTIP),
    eB = (0, U.Z)(n),
    eV = (0, x.Z)(n),
    eH = (0, d.e7)([el.Z], () => el.Z.getChannelId()),
    eF = (0, d.e7)([ei.Z], () => ei.Z.desyncedVoiceStatesCount),
    ez = V.Y.useExperiment({
      location: "GuildSidebar"
    }, {
      autoTrackExposure: !0
    }).enabled,
    eW = (0, G.Z)(n),
    eY = (0, B.Z)(null == L ? void 0 : L.id, n) && (null == o ? void 0 : o.premiumProgressBarEnabled) === !1;
  return (0, r.jsx)(eT, {
    guildId: n,
    hideSelectedChannel: l,
    guild: o,
    ...
    shouldRenderGuildPowerupPerkCoachmark: !1 === eW,
    shouldRenderBoosterEnhancedRoleColorsCoachmark: eY
  })
}