...
class eS extends i.PureComponent {
  ...
  componentDidMount() {
    var e;
    this.setAnimatedValue(0), g.Z.subscribe("LAYER_PUSH", this.closeAllHeaderNotices), this.historyUnlisten = H.Z.addRouteChangeListener(this.handleHistoryChange);
    let {
      location: t
    } = H.Z.getHistory();
  ...
  renderGuildHeaderNotices(e) {
    ...
    return n ? (0, r.jsx)("div", {
      ...
      position: "bottom",
      shouldShow: !e && !i,
      text: eb.intl.string(eb.t.sFSrFB),
      "aria-label": eb.intl.string(eb.t.sFSrFB),
      children: () => this.renderGuildHeaderDropdownButton(e)
      ...
      renderPopout: () => (0, r.jsx)("div", {
        ...
        children: (0, r.jsx)(Y.ZP, {
          header: eb.intl.string(eb.t["Q3qa4+"]),
          content: eb.intl.string(eb.t.UyHD4O),
          buttonCTA: eb.intl.string(eb.t.U9PrMz),
  ...
  renderGuildHeader(e) {
    ...
    return null == t ? null : (0, M.jW)({
      location: "guild_sidebar"
    }).entrypoints ? (0, r.jsx)(y.Gt, {
      value: o,
      children: (0, r.jsx)(ec.ZP, {
        guild: t,
        controller: s,
        renderBanner: c,
        hasSubheader: e,
  ...
  renderChannelList() {
    let e = this.props,
      ...
      a = eI(e, ["isUnavailable", "guild", "selectedChannel", "enableStudyGroup"]);
    if (t || null == n) return (0, r.jsx)(ep.Z, {
      withBannerPadding: null != n && null != this.getGuildBannerHash()
    });
    {
      if (n.hasFeature(eh.oNc.HUB) && !l) return (0, r.jsx)("div", {
        className: e_.hubContainer,
        children: (0, r.jsx)(k.Z, {
          guild: n,
          channel: null != i ? i : J.ZP.getDefaultChannel(n.id)
        })
      });
      let e = n.id === em._ ? es.j : es.E;
      return (0, r.jsx)(e, ey(eO({
        guild: n
      }, a), {
        guildBanner: this.getGuildBannerHash(),
  ...
  render() {
    ...
    return (0, r.jsxs)("nav", {
      ...
      "aria-label": eb.intl.formatToPlainString(eb.t.nj5gAQ, {
        guildName: null != e ? e.toString() : ""
      }),
      children: [null != e && this.renderGuildHeader(this.state.hasGuildSubheader), null != e && (0, r.jsx)(ed.Z, {
        guild: e,
  ...
  constructor(...e) {
    super(...e), eE(this, "historyUnlisten", () => {}), eE(this, "guildHeaderRef", i.createRef()), eE(this, "guildHeaderDropdownButtonRef", i.createRef()), eE(this, "showTimeout", new h.V7), eE(this, "state", {
      ...
      null != t && (0, m.jW)(e, async () => {
        let {
          default: e
        } = await Promise.all([n.e("7654"), n.e("55616"), n.e("44156"), n.e("49286"), n.e("6850"), n.e("58227"), n.e("32652"), n.e("54408"), n.e("20087"), n.e("92754"), n.e("87154"), n.e("33213"), n.e("15875")]).then(n.bind(n, 545135));
        return n => (0, r.jsx)(e, ey(eO({}, n), {
          guild: t
        }))
      })
      ...
      let t = (0, T.un)(p.z.STUDENT_HUB_PRIVACY_SETTINGS_TOOLTIP),
        n = null == (e = this.props.guild) ? void 0 : e.hasFeature(eh.oNc.HUB);
      !t && n && (0, T.EW)(p.z.STUDENT_HUB_PRIVACY_SETTINGS_TOOLTIP, {
        dismissAction: eg.L.AUTO
      })
      ...
      let {
        ...
        shouldRenderGuildPowerupPerkCoachmark: f,
        guild: g,
        theme: m
      } = this.props;
      if (null == g) return this.renderGuildHeaderDropdownButton(e);
      let b = [];
      return (o && b.push(p.z.STUDENT_HUB_PRIVACY_SETTINGS_TOOLTIP), s && b.push(p.z.GUILD_HEADER_ACTIVE_THREADS_NOTICE), t && b.push(p.z.GUILD_HEADER_PREMIUM_GUILD_PROGRESS), n && b.push(p.z.GUILD_HEADER_PROGRESS_BAR_SIZE_COACH_MARK), i && b.push(p.z.GUILD_HEADER_ROLE_SUBSCRIPTION_UPSELL), c && b.push(p.z.GUILD_HEADER_SOUNDBOARD_PERMISSION), l && b.push(p.z.GUILD_HEADER_INVITE_SPLASH), a && b.push(p.z.GUILD_DISCOVERY_LANDING_PAGE_SETTINGS_UPSELL), f && b.push(p.z.GUILD_POWERUP_PERKS_COACHMARK), 0 === b.length) ? this.renderGuildHeaderDropdownButton(e) : (u && b.push(p.z.MEDIA_CHANNEL_UPSELL), d && b.push(p.z.SERVER_SUBSCRIPTION_TIER_TEMPLATE_UPSELL), h && b.push(p.z.PREMIUM_CUSTOM_NOTIFICATION_SOUNDS_COACHMARK), (0, r.jsx)(eu.Z, {
        contentTypes: b,
        theme: m,
        guild: g,
        renderGuildHeaderDropdownButton: () => this.renderGuildHeaderDropdownButton(e)
      }))
    }), eE(this, "renderGuildHeaderDropdownButton", e => (0, M.jW)({
      location: "guild_sidebar"
    }).entrypoints ? (0, r.jsx)(ec.wD, {
      open: e
    }) : (0, r.jsx)(b.Z, {
      open: e,
      className: a()(e_.dropdownButton, {
        [e_.dropdownButtonBannerVisible]: this.state.bannerVisible
      }),
...
function eN(e) {
  ...
  let {
    ...
    selectedChannelId: a
  } = e, o = (0, d.e7)([ee.Z], () => ee.Z.getGuild(n));
  (0, _.J_)(n);
  let c = (0, j.Z)(n),
    h = (0, d.e7)([X.Z], () => X.Z.getGuildDimensions(n).scrollTo),
    g = (0, d.e7)([ei.Z], () => ei.Z.getChannelId()),
    [m, b, C] = (0, d.Wu)([en.Z], () => [en.Z.can(eh.Plq.MANAGE_GUILD, o), en.Z.can(eh.Plq.MANAGE_ROLES, o), en.Z.can(eh.Plq.MANAGE_THREADS, o)]),
    P = (0, d.e7)([Q.Z], () => Q.Z.isUnavailable(n)),
    L = (0, d.e7)([el.default], () => el.default.getCurrentUser()),
    k = (0, d.e7)([K.Z], () => K.Z.darkSidebar ? eh.BRd.DARK : K.Z.theme),
    {
      enableStudyGroup: M
    } = (0, D.s)(o),
    H = (0, N.ZP)(e => e.currentlyShown.has(p.z.NAGBAR_NOTICE_CONNECT_PLAYSTATION)),
    [z, Y] = i.useState(!H),
    J = (0, E.Z)(n),
    {
  ...
  let [eu, ed] = (0, N.ZP)(e => [ef.XN.some(t => e.currentlyShown.has(t.dismissibleContentType)), e.currentlyShownGroup.has(eg.R.GUILD_HEADER_TOOLTIPS)], u.X), ep = (0, v.Z)(o), em = (0, f.s9z)(f.JQI), eb = (0, d.e7)([et.Z], () => et.Z.hasLayers()), e_ = (0, d.e7)([W.Z], () => W.Z.shouldShow(ev)), eE = m && (null == o ? void 0 : o.premiumProgressBarEnabled) === !1 && !eo.s.isDisallowPopupsSet(), eO = (0, d.e7)([$.Z], () => $.Z.getMemberCount(n)), ey = m && null != eO && eO >= 30 && (null == o ? void 0 : o.premiumProgressBarEnabled) === !1 && !eo.s.isDisallowPopupsSet(), eI = b && null != o && (o.hasFeature(eh.oNc.COMMUNITY) || null != eO && eO > 50), eC = (0, w.Z)(n), eN = (null == o ? void 0 : o.hasFeature(eh.oNc.HUB)) === !0, eT = m && (null == o ? void 0 : o.hasFeature(eh.oNc.DISCOVERABLE)) === !0, eP = (0, I.Q)(), ej = (m || (null == o ? void 0 : o.premiumTier) === eh.Eu4.NONE) && !eo.s.isDisallowPopupsSet() && !eP, eA = (0, d.e7)([R.Z, et.Z], () => null != o && null != L && m && !et.Z.hasLayers() && R.Z.shouldShowGuildTemplateDirtyTooltip(n)), eZ = (0, d.e7)([q.Z], () => q.Z.getChannel(a)), {
    isPopoutOpen: ex
  } = (0, A.y)(), ew = null != (t = null == o ? void 0 : o.hasFeature(eh.oNc.COMMUNITY)) && t, eL = (0, d.e7)([F.Z], () => !s().isEmpty(F.Z.getThreadsForGuild(n))), eR = ea.ZP.isNewUser(L), eD = z && !eR, ek = (0, S.Z)(L);
  (0, Z.Z)(o);
  let eM = (0, T.wE)(p.z.PREMIUM_TUTORIAL_SERVER_MENU_TOOLTIP),
    eU = (0, U.Z)(n),
    eG = (0, x.Z)(n),
    eB = (0, d.e7)([ei.Z], () => ei.Z.getChannelId()),
    eV = (0, d.e7)([er.Z], () => er.Z.desyncedVoiceStatesCount),
    eH = V.Y.useExperiment({
      location: "GuildSidebar"
    }, {
      autoTrackExposure: !0
    }).enabled,
    eF = (0, G.Ek)(n, "ConnectedGuildSidebar"),
    ez = (0, B.Z)(n);
  return (0, r.jsx)(eS, {
    guildId: n,
    hideSelectedChannel: l,
    ...
    showActiveThreadsNotice: C && null != eO && eO >= 200 && eL,
    ...
    shouldRenderGuildPowerupPerkCoachmark: eF && !1 === ez
  })
}