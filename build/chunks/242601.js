...
class eC extends i.PureComponent {
  ...
  renderChannelList() {
    ...
    {
      if (n.features.has(ep.oNc.HUB) && !l) return (0, r.jsx)("div", {
  ...
  render() {
    ...
    return (0, r.jsxs)("nav", {
      ...
      "aria-label": em.intl.formatToPlainString(em.t.nj5gAQ, {
        guildName: null != (e = null == t ? void 0 : t.name) ? e : ""
      }),
      children: [null != t && this.renderGuildHeader(this.state.hasGuildSubheader), null != t && (0, r.jsx)(eu.Z, {
        guild: t,
...
function eS(e) {
  ...
  let [eu, ed] = (0, C.ZP)(e => [eh.XN.some(t => e.currentlyShown.has(t.dismissibleContentType)), e.currentlyShownGroup.has(ef.R.GUILD_HEADER_TOOLTIPS)], u.X), eg = (0, v.Z)(o), em = (0, f.s9z)(f.JQI), eb = (0, d.e7)([$.Z], () => $.Z.hasLayers()), e_ = (0, d.e7)([F.Z], () => F.Z.shouldShow(eI)), eE = m && (null == o ? void 0 : o.premiumProgressBarEnabled) === !1 && !el.s.isDisallowPopupsSet(), eO = (0, d.e7)([Q.Z], () => Q.Z.getMemberCount(n)), ey = m && null != eO && eO >= 30 && (null == o ? void 0 : o.premiumProgressBarEnabled) === !1 && !el.s.isDisallowPopupsSet(), ev = b && null != o && (o.features.has(ep.oNc.COMMUNITY) || null != eO && eO > 50), eS = (0, A.Z)(n), eN = (null == o ? void 0 : o.features.has(ep.oNc.HUB)) === !0, eT = m && (null == o ? void 0 : o.features.has(ep.oNc.DISCOVERABLE)) === !0, eP = (0, I.Q)(), ej = (m || (null == o ? void 0 : o.premiumTier) === ep.Eu4.NONE) && !el.s.isDisallowPopupsSet() && !eP, eA = (0, d.e7)([x.Z, $.Z], () => null != o && null != R && m && !$.Z.hasLayers() && x.Z.shouldShowGuildTemplateDirtyTooltip(n)), eZ = (0, d.e7)([Y.Z], () => Y.Z.getChannel(a)), {
    isPopoutOpen: ex
  } = (0, T.y)(), ew = null != (t = null == o ? void 0 : o.features.has(ep.oNc.COMMUNITY)) && t, eL = (0, d.e7)([V.Z], () => !s().isEmpty(V.Z.getThreadsForGuild(n))), eR = ei.ZP.isNewUser(R), eD = ea && !eR;
  (0, P.Z)(o);
  ...
  return (0, r.jsx)(eC, {
    ...
    showActiveThreadsNotice: Z && null != eO && eO >= 200 && eL,
