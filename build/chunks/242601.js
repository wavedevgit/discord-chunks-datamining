...
class eN extends i.PureComponent {
  ...
  renderChannelList() {
    ...
    {
      if (n.hasFeature(ef.oNc.HUB) && !l) return (0, r.jsx)("div", {
  ...
  render() {
    ...
    return (0, r.jsxs)("nav", {
      ...
      children: [null != e && this.renderGuildHeader(this.state.hasGuildSubheader), null != e && (0, r.jsx)(ep.Z, {
        guild: e,
