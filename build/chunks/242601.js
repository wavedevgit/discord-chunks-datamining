...
class eI extends i.PureComponent {
  ...
  constructor(...e) {
    super(...e), e_(this, "historyUnlisten", () => {}), e_(this, "showTimeout", new h.V7), e_(this, "state", {
      ...
      (e >= n && l || e < n && !l) && (l = !l), (e >= t && !r || e < t && r) && (r = !r), a = Math.max(t - e, 0), i = l, (r !== this.state.renderBanner || l !== this.state.bannerVisible || a !== this.state.bannerVisibleHeight || i !== this.state.communityInfoVisible) && this.setState({
        renderBanner: r,
        bannerVisible: l,
        bannerVisibleHeight: a,
        communityInfoVisible: i
...
function eC(e) {
  ...
  let {
    ...
    selectedChannelId: a
  } = e, o = (0, d.e7)([$.Z], () => $.Z.getGuild(n));
  (0, _.J_)(n);
  let c = (0, A.Z)(n),
    h = (0, d.e7)([q.Z], () => q.Z.getGuildDimensions(n).scrollTo),
    g = (0, d.e7)([er.Z], () => er.Z.getChannelId()),
    [m, b, I] = (0, d.Wu)([et.Z], () => [et.Z.can(ep.Plq.MANAGE_GUILD, o), et.Z.can(ep.Plq.MANAGE_ROLES, o), et.Z.can(ep.Plq.MANAGE_THREADS, o)]),
  ...
  let [ec, eu] = (0, T.ZP)(e => [eh.XN.some(t => e.currentlyShown.has(t.dismissibleContentType)), e.currentlyShownGroup.has(ef.R.GUILD_HEADER_TOOLTIPS)], u.X), ed = (0, y.Z)(o), eg = (0, f.s9z)(f.JQI), em = (0, d.e7)([ee.Z], () => ee.Z.hasLayers()), eb = (0, d.e7)([F.Z], () => F.Z.shouldShow(ev)), e_ = m && (null == o ? void 0 : o.premiumProgressBarEnabled) === !1 && !ea.s.isDisallowPopupsSet(), eE = (0, d.e7)([J.Z], () => J.Z.getMemberCount(n)), eO = m && null != eE && eE >= 30 && (null == o ? void 0 : o.premiumProgressBarEnabled) === !1 && !ea.s.isDisallowPopupsSet(), eN = b && null != o && (o.hasFeature(ep.oNc.COMMUNITY) || null != eE && eE > 50), ey = (0, L.Z)(n), eC = (null == o ? void 0 : o.hasFeature(ep.oNc.HUB)) === !0, eS = m && (null == o ? void 0 : o.hasFeature(ep.oNc.DISCOVERABLE)) === !0, eT = (0, v.Q)(), eP = (m || (null == o ? void 0 : o.premiumTier) === ep.Eu4.NONE) && !ea.s.isDisallowPopupsSet() && !eT, ej = (0, d.e7)([D.Z, ee.Z], () => null != o && null != R && m && !ee.Z.hasLayers() && D.Z.shouldShowGuildTemplateDirtyTooltip(n)), eA = (0, d.e7)([K.Z], () => K.Z.getChannel(a)), {
    isPopoutOpen: eZ
  } = (0, Z.y)(), ex = null !== (t = null == o ? void 0 : o.hasFeature(ep.oNc.COMMUNITY)) && void 0 !== t && t, ew = (0, d.e7)([B.Z], () => !s().isEmpty(B.Z.getThreadsForGuild(n))), eL = el.ZP.isNewUser(R), eR = H && !eL, eD = (0, C.Z)(R);
  (0, x.Z)(o);
