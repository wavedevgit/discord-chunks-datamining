...
class eT extends i.PureComponent {
  ...
  renderChannelList() {
    ...
    if (t || null == n) return (0, r.jsx)(ef.Z, {
      withBannerPadding: null != n && null != this.getGuildBannerHash()
    });
    {
      if (n.hasFeature(eg.oNc.HUB) && !l) return (0, r.jsx)("div", {
  ...
  render() {
    ...
    return (0, r.jsxs)("nav", {
      ...
      children: [null != e && this.renderGuildHeader(this.state.hasGuildSubheader), null != e && (0, r.jsx)(eh.Z, {
        guild: e,
  ...
  constructor(...e) {
    super(...e), ey(this, "historyUnlisten", () => {}), ey(this, "guildHeaderRef", i.createRef()), ey(this, "guildHeaderDropdownButtonRef", i.createRef()), ey(this, "showTimeout", new h.V7), ey(this, "state", {
...
function eP(e) {
  ...
  let c = (0, j.Z)(n),
    ...
    k = (0, d.e7)([X.Z], () => X.Z.darkSidebar ? eg.BRd.DARK : X.Z.theme),
    {
      enableStudyGroup: M
    } = (0, D.s)(o),
  ...
  let [ep, eh] = (0, N.ZP)(e => [em.XN.some(t => e.currentlyShown.has(t.dismissibleContentType)), e.currentlyShownGroup.has(eb.R.GUILD_HEADER_TOOLTIPS)], u.X), ef = (0, v.Z)(o), e_ = (0, f.s9z)(f.JQI), eO = (0, d.e7)([er.Z], () => er.Z.hasLayers()), eE = (0, d.e7)([K.Z], () => K.Z.shouldShow(eS)), ey = m && (null == o ? void 0 : o.premiumProgressBarEnabled) === !1 && !ec.s.isDisallowPopupsSet(), eI = (0, d.e7)([et.Z], () => et.Z.getMemberCount(n)), ev = m && null != eI && eI >= 30 && (null == o ? void 0 : o.premiumProgressBarEnabled) === !1 && !ec.s.isDisallowPopupsSet(), eC = b && null != o && (o.hasFeature(eg.oNc.COMMUNITY) || null != eI && eI > 50), eN = (0, L.Z)(n), eP = (null == o ? void 0 : o.hasFeature(eg.oNc.HUB)) === !0, ej = m && (null == o ? void 0 : o.hasFeature(eg.oNc.DISCOVERABLE)) === !0, eA = (0, I.Q)(), eZ = (m || (null == o ? void 0 : o.premiumTier) === eg.Eu4.NONE) && !ec.s.isDisallowPopupsSet() && !eA, ex = (0, d.e7)([R.Z, er.Z], () => null != o && null != w && m && !er.Z.hasLayers() && R.Z.shouldShowGuildTemplateDirtyTooltip(n)), eL = (0, d.e7)([Q.Z], () => Q.Z.getChannel(a)), {
    isPopoutOpen: ew
  } = (0, A.y)(), eR = null != (t = null == o ? void 0 : o.hasFeature(eg.oNc.COMMUNITY)) && t, eD = (0, d.e7)([W.Z], () => !s().isEmpty(W.Z.getThreadsForGuild(n))), ek = es.ZP.isNewUser(w), eM = Y && !ek, eU = (0, S.Z)(w);
  (0, Z.Z)(o);
