...
class eT extends i.PureComponent {
  ...
  constructor(...e) {
    super(...e), ey(this, "historyUnlisten", () => {}), ey(this, "showTimeout", new h.V7), ey(this, "state", {
      ...
      null != t && (0, m.jW)(e, async () => {
        let {
          default: e
        } = await Promise.all([n.e("7654"), n.e("44156"), n.e("49286"), n.e("32652"), n.e("6850"), n.e("58227"), n.e("54408"), n.e("80728"), n.e("50629"), n.e("87154"), n.e("33213"), n.e("15875")]).then(n.bind(n, 545135));
        return n => (0, r.jsx)(e, ev(eI({}, n), {
          guild: t
        }))
      })
      ...
      let b = [];
      return (o && b.push(p.z.STUDENT_HUB_PRIVACY_SETTINGS_TOOLTIP), s && b.push(p.z.GUILD_HEADER_ACTIVE_THREADS_NOTICE), t && b.push(p.z.GUILD_HEADER_PREMIUM_GUILD_PROGRESS), n && b.push(p.z.GUILD_HEADER_PROGRESS_BAR_SIZE_COACH_MARK), i && b.push(p.z.GUILD_HEADER_ROLE_SUBSCRIPTION_UPSELL), c && b.push(p.z.GUILD_HEADER_SOUNDBOARD_PERMISSION), l && b.push(p.z.GUILD_HEADER_INVITE_SPLASH), a && b.push(p.z.GUILD_DISCOVERY_LANDING_PAGE_SETTINGS_UPSELL), 0 === b.length) ? this.renderGuildHeaderDropdownButton(e) : (u && b.push(p.z.MEDIA_CHANNEL_UPSELL), d && b.push(p.z.SERVER_SUBSCRIPTION_TIER_TEMPLATE_UPSELL), h && b.push(p.z.PREMIUM_CUSTOM_NOTIFICATION_SOUNDS_COACHMARK), f && b.push(p.z.GUILD_POWERUP_PERKS_COACHMARK), (0, r.jsx)(ep.Z, {
        contentTypes: b,
        theme: m,
        guild: g,
        renderGuildHeaderDropdownButton: () => this.renderGuildHeaderDropdownButton(e)
      }))
    }), ey(this, "renderGuildHeaderDropdownButton", e => (0, U.jW)({
      location: "guild_sidebar"
    }).entrypoints ? (0, r.jsx)(ed.wD, {
      open: e
    }) : (0, r.jsx)(b.Z, {
      open: e,
      className: a()(eO.dropdownButton, {
        [eO.dropdownButtonBannerVisible]: this.state.bannerVisible
      })
