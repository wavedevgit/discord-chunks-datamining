...
function x(e) {
  ...
  }), N = null != x && (0, s.ye)(x), T = null != S && N && I, {
  ...
  }), R = (0, i.e7)([_.ZP], () => _.ZP.getCurrentEmbeddedActivity()), k = (0, b.Z)(), D = w === E.jy.CAN_LAUNCH, M = null != v ? v : O.customId, L = [];
  D && L.push({
  ...
  let U = (0, m.z)(x);
  return null != L && null != U && L.push(U), (0, r.jsx)(d.W, {
    actions: L,
    embedUrl: C,
    header: x.name,
