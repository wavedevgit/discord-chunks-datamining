...
function O(e) {
  ...
  let {
    ...
    embedUrl: x,
    referrerId: I
  } = e, j = null == O || null == (t = O.bot) ? void 0 : t.id, S = (0, c.ms)({
    context: {
      type: "contextless"
    },
    applicationId: O.id,
    botUserId: null == O || null == (n = O.bot) ? void 0 : n.id
  }), T = null != O && (0, s.ye)(O), N = null != j && T && S, {
  ...
  }), R = (0, i.e7)([h.ZP], () => h.ZP.getCurrentEmbeddedActivity()), D = (0, b.Z)(), L = w === E.jy.CAN_LAUNCH, M = null != y ? y : v.customId, k = [];
  L && k.push({
