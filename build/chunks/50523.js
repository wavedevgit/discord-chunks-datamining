...
function E(e) {
  ...
  let {
    ...
    embedUrl: j,
    referrerId: C
  } = e, I = null == E || null == (t = E.bot) ? void 0 : t.id, S = (0, c.ms)({
    context: {
      type: "contextless"
    },
    applicationId: E.id,
  ...
  } = (0, l.ZP)(a.Z.ACTIVITY_CUSTOM_LINK), w = (0, i.e7)([f.Z], () => f.Z.getChannelId()), Z = (0, y.KF)(w), k = (0, i.e7)([b.ZP], () => {
    if (null == w) return;
    let e = b.ZP.getEmbeddedActivitiesForChannel(w).filter(e => e.applicationId === E.id);
    return e.length > 0 ? e[0].compositeInstanceId : void 0
  }), R = (0, i.e7)([b.ZP], () => b.ZP.getCurrentEmbeddedActivity()), D = (0, x.Z)(), L = Z === y.jy.CAN_LAUNCH, M = null != O ? O : N.custom_id, W = null != C ? C : N.referrer_id, U = [];
  L && U.push({
  ...
  let F = (0, m.z)(E);
  return null != U && null != F && U.push(F), (0, r.jsx)(d.W, {
    actions: U,
    embedUrl: j,
    header: E.name,
