...
function v(e) {
  ...
  let {
    ...
    embedUrl: y,
    referrerId: I
  } = e, j = null == v || null == (t = v.bot) ? void 0 : t.id, S = (0, c.ms)({
    context: {
      type: "contextless"
    },
    applicationId: v.id,
    botUserId: null == v || null == (n = v.bot) ? void 0 : n.id
  }), T = null != v && (0, s.ye)(v), N = null != j && T && S, {
  ...
  }), R = (0, i.e7)([h.ZP], () => h.ZP.getCurrentEmbeddedActivity()), D = (0, b.Z)(), L = w === E.jy.CAN_LAUNCH, M = null != O ? O : x.customId, k = [];
  L && k.push({
