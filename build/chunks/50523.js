...
function y(e) {
  ...
  let {
    ...
    embedUrl: j,
    referrerId: C
  } = e, S = null == y || null == (t = y.bot) ? void 0 : t.id, I = (0, c.ms)({
    context: {
      type: "contextless"
    },
    applicationId: y.id,
    botUserId: null == y || null == (n = y.bot) ? void 0 : n.id
  }), N = null != y && (0, s.ye)(y), T = null != S && N && I, {
  ...
  }), R = (0, i.e7)([_.ZP], () => _.ZP.getCurrentEmbeddedActivity()), k = (0, b.Z)(), D = w === E.jy.CAN_LAUNCH, L = null != v ? v : O.customId, M = [];
  D && M.push({
