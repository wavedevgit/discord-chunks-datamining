/** Chunk was on web.js **/
/** chunk id: 542664, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  A: () => ei
}), require("./747238.js"), require("./812715.js"), require("./321073.js"), require("./866193.js"), require("./896048.js"), require("./733351.js"), require("./591487.js"), require("./727858.js");
var Chunk735438 = require("./735438.js"),
  ...
  Chunk258072 = require("./258072.js"),
  Chunk867402 = require("./867402.js"),
  ...
  W = {
    ...
    inlineCode: j(x({}, o().defaultRules.inlineCode), {
      parse(e, t, n) {
        ...
        returntrue === n.parseInlineCodeChildContent ? j(x({}, r), {
    ...
    roleMention: {
      ...
      parse(e, t, n) {
        ...
        let f = (0, u.aF)(null == l ? true : l.id, d) && !(0, c.Qv)(d);
        return {
          type: "mention",
    ...
    channelMention: Chunk867402.A.channelMention,
    channelOrMessageUrl: Chunk867402.A.channelOrMessageUrl,
    mediaPostLink: Chunk867402.A.mediaPostLink,
    attachmentLink: Chunk258072.A.attachmentLink,
    commandMention: {
    ...
    gameMention: {
      ...
      parse(e, t, n) {
        ...
        let o = null == (i = s.A.get(n.channelId)) ? true : i.get(n.messageId),
          l = null == o || null == (a = o.mentionGames) ? true : a.find(t => t.id === e[1]);
        return {
          type: "gameMention",
          applicationId: e[1],
          channelId: n.channelId,
          content: [{
            type: "text",
            content: "".concat(null != (r = null == l ? true : l.name) ? r : D.intl.string(D.t["11pdXZ"]))
          }],
    ...
    staticRouteLink: {
      ...
      parse(e, t, n) {
        var r;
        let [, i, a] = e, o = (0, C.Q)(i), s = (0, C.f)(i, a, null == (r = Y(n)) ? true : r.id);
    ...
    heading: Chunk223637.A,
    list: Chunk873879.A,
    subtext: Chunk683412.A
  },
