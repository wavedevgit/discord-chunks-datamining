...
var r = n(255367),
  ...
  _ = n(20493);
let x = () => {
  let [e, t] = i.useState(""), [l, x] = i.useState(""), [E, b] = i.useState(!1), [I, v] = i.useState(!1), [O, N] = i.useState(null), [j, S] = i.useState(null), y = (0, o.e7)([d.Z], () => d.Z.getCountryCode()), C = y.code.split(" ")[0], T = async () => {
    try {
    ...
    children: [(0, r.jsx)(p.Ee, {
      ...
      children: [g.intl.string(g.t.WWzQtb), (0, r.jsx)(s.owK, {
        size: "md",
        color: "currentColor",
  ...
  return I ? P : (0, r.jsxs)(p.ZP, {
    children: [(0, r.jsx)(p.Dx, {
      children: g.intl.string(g.t.o4JNrK)
    }), (0, r.jsx)(p.DK, {
