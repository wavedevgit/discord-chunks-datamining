...
var r = n(200651),
  ...
  _ = n(20493);
let x = () => {
  let [e, t] = i.useState(""), [s, x] = i.useState(""), [N, b] = i.useState(!1), [E, v] = i.useState(!1), [j, I] = i.useState(null), [O, S] = i.useState(null), y = (0, l.e7)([d.Z], () => d.Z.getCountryCode()), C = y.code.split(" ")[0], P = async () => {
    try {
    ...
    children: [(0, r.jsx)(g.Ee, {
      ...
      children: [m.NW.string(m.t.WWzQtb), (0, r.jsx)(a.owK, {
        size: "md",
        color: "currentColor",
