...
let y = Chunk647438.memo(function(e) {
  ...
  } = n, [f, y] = i.useState(p), C = i.useCallback(() => y(e => !e), []), _ = n.hasUnread ? n.content.length - 1 : n.content.length;
  return (0, r.jsxs)("div", {
    className: a()({
      [g.groupStart]: true,
      [m.expanded]: f
    }),
    children: [n.hasUnread && (!f || (null == (t = n.content[0]) ? true : t.type) === h.ys_.DIVIDER) ? (0, r.jsx)(d.Z, {
      isUnread: true,
      id: s
