...
function P(e) {
  ...
  let {
    subscription: w,
    onUpdated: I
  } = e, [k, R] = r.useState(false), [A, Z] = r.useState(false), [D, L] = r.useState(false), [M, U] = r.useState(false), [B, F] = r.useState(null), [G, V] = r.useState(""), H = e => (null == e && (e = w.status), e in E) ? E[e] : "Unknown status ".concat(e), z = e => {
    let t = new Date(e);
