...
function S(e) {
  ...
  let {
    subscription: T,
    onUpdated: N
  } = e, [O, P] = i.useState(false), [I, w] = i.useState(false), [k, R] = i.useState(false), [A, Z] = i.useState(false), [D, L] = i.useState(null), M = e => (null == e && (e = T.status), e in _) ? _[e] : "Unknown status ".concat(e), U = e => {
    let t = new Date(e);
