...
function y(e) {
  ...
  let {
    subscription: E,
    onUpdated: O
  } = e, [T, S] = r.useState(false), [P, w] = r.useState(false), [I, k] = r.useState(false), [R, Z] = r.useState(false), [A, D] = r.useState(null), L = e => (null == e && (e = E.status), e in j) ? j[e] : "Unknown status ".concat(e), M = e => {
    let t = new Date(e);
  ...
  return (0, a.jsxs)("div", {
    ...
    children: [V && (0, a.jsx)(o.P3F, {
      ...
      children: [(0, a.jsxs)(o.Text, {
        ...
        children: [(0, a.jsxs)(o.Text, {
          variant: "text-md/normal",
          children: ["Pause Reason: ", E.pauseReason in g ? g[E.pauseReason] : "Unknown pause reason ".concat(E.pauseReason)]
