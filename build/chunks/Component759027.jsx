...
function y(e) {
  ...
  let {
    subscription: S,
    onUpdated: N
  } = e, [T, O] = r.useState(false), [P, I] = r.useState(false), [k, w] = r.useState(false), [R, A] = r.useState(false), [Z, D] = r.useState(null), L = e => (null == e && (e = S.status), e in v) ? v[e] : "Unknown status ".concat(e), M = e => {
    let t = new Date(e);
