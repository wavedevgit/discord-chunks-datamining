...
function S(e) {
  ...
  let {
    subscription: O,
    onUpdated: T
  } = e, [N, P] = l.useState(false), [I, w] = l.useState(false), [k, R] = l.useState(false), [A, Z] = l.useState(false), [D, L] = l.useState(null), M = e => (null == e && (e = O.status), e in _) ? _[e] : "Unknown status ".concat(e), U = e => {
    let t = new Date(e);
