...
var i, l, s, Chunk311907 = require("./311907.js"),
...
function U() {
  ...
  r = null == e ? true : e.application_id
}
...
function P(e) {
  let t = function(e) {
    ...
    let l = g.A.getRelationshipType(e),
      ...
      o = g.A.getNickname(e),
      d = null != (t = null == (n = c.A.getUserAffinity(e)) ? true : n.communicationProbability) ? t : 0;
    return s ? function(e) {
      var t, n;
      let {
        userId: r,
      ...
      let l, s, a, u, o, d, c, g, S, {
        ...
        } = e,
        {
          category: w,
          displayActivities: U
        } = (l = A.A.getPrimaryActivity(), s = r, a = (null == l ? true : l.name) != null && null != s, u = f.A.getStatus(v), d = (null == (o = E.A.getVoiceStateForUser(v)) ? true : o.channelId) != null, g = (c = M.filter(b)).filter(G), S = c.filter(e => e.application_id === s), a && S.length > 0 ? {
        ...
        F = null != L ? null == (i = h.A.getChannel(L)) ? true : i.guild_id : null,
        V = f.A.getStatus(v),
        x = V === m.clD.ONLINE,
        j = U.some(b),
      ...
      let a = E.A.getVoiceStateForUser(n),
        u = null == a ? true : a.channelId,
        o = null != u ? null == (t = h.A.getChannel(u)) ? true : t.guild_id : null,
        d = i.length > 0 || null != u,
...
class L extends(i = Chunk311907.Ay.Store) {
  initialize() {
...
let F = e => (0, v.R)(e, "FriendsWidgetFriendsStore"),
  V = new L(Chunk73153.h, __OVERLAY__ || !Chunk672396.OX && !Chunk672396.ed ? {} : {
    ...
    RELATIONSHIP_PENDING_INCOMING_REMOVED: F(function(e) {
      let t = false;
      for (let e of T.values("FRIEND_REQUESTS", true)) e.relationshipType === m.eA$.PENDING_INCOMING && (t = P(e.userId) || t);
      return t
    }),
    ...
    LOGOUT: F(function() {
      let e = T.size() > 0;
      return T.clear(), r = true, D = new Map, e
    })
  })