...
function L(e) {
  ...
  return (0, r.jsxs)("div", {
    className: s()(D.onboardingContainer, {
      [D.upsellOnTop]: A
    }),
      ...
      children: (0, r.jsxs)(c.zx, {
        ...
        onClick: () => {
          if (C.Z.hasChanges() && !C.Z.canCloseEarly()) {
            ...
            return
          }(0, v.NB)(), (0, x.BG)(), (0, _.bj)(), (0, j.Pk)(), (0, b.$K)(y.PG.LANDING)
        },
...
function k(e) {
  let {
    ...
    if (!l) return () => n(e)
  }, c = (0, a.e7)([O.Z], () => O.Z.advancedMode);
  return (0, r.jsxs)("div", {
    className: D.progressContainer,
    children: [(0, r.jsxs)(u.P3F, {
      className: s()(D.progressBarContainer, D.clickableProgressBar),
