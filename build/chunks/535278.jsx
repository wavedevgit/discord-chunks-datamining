...
let m = function(e) {
  ...
  return null == g || (null == (t = g.discount) ? true : t.plan_ids.some(e => d.GP[e].skuId !== c)) || null == g.expires_at || Object.values(E).every(e => 0 === e) ? null : <i.qXd color={i.DM8.PREMIUM_TIER_2}>{<i.RyX onClick={n} />}{<i.SrA size={"md"} color={"currentColor"} className={p.premiumIcon} />}{h(E, Number(g.discount.amount))}{<i.EyT onClick={() => {
        (0, l.Z)({
          subscriptionTier: c,
          analyticsLocations: m,
          analyticsObject: {
      ...
      }}>{_.intl.string(_.t.zLXssL)}</i.EyT>}</i.qXd>
}