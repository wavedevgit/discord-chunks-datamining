...
let B = e => {
  ...
  (0, x.A)(l, z);
  let [K, Z] = i.useState(false), q = (0, T.p)(), X = i.useRef(null), [J, Q] = i.useState(false), [$, ee] = i.useState(false), et = null != q && null != F && F.status === G.Dmq.CANCELED, en = (0, v.iU)(M.gD.PREMIUM_MONTH_TIER_2, q, F), er = !$ && et, {
