...
function S(e) {
  ...
  })), R = C === y.z.SERVER_SHOP, P = (0, l.e7)([f.ZP], () => null != n ? f.ZP.getTrueMember(t, n.id) : null), [w, D] = (0, c.A7R)(null == N ? [] : g.default.keys(N)), x = i.useRef(o);
  i.useEffect(() => {
    let e = {},
      t = x.current;
    if (null != t && null != C) {
  ...
  let L = null != o && null != n && null != P ? A.find(e => P.roles.includes(e.id)) : true,
    j = i.useMemo(() => null != o && null != n ? A.filter(e => !(0, d.fI)(e)).filter(e => {
      var t;
  ...
  return (P.roles.forEach(e => {
    ...
    children: (0, r.jsx)(c.hQY, {
      ...
      autoFocus: true,
      children: e => {
        let t = j.reduce((t, n) => (a()(e.toLowerCase(), n.name.toLowerCase()) && t.push((0, r.jsxs)(c.lo1, {
            value: n.id,
