...
let q = l.memo(function(e) {
  ...
  G = l.memo(function(e) {
    let {
      member: t,
      highestRole: n
    } = e, o = (0, u.e7)([N.Z], () => N.Z.getGuild(t.guildId), [t.guildId]), i = t.roles.length - 1, s = l.useMemo(() => new Intl.NumberFormat(W.NW.currentLocale).format(i), [i]), c = (0, k.vN)(t), d = (0, k.vN)(t, !0), m = (0, u.e7)([_.Z], () => _.Z.can(B.Plq.MANAGE_ROLES, o), [o]);
...
let J = l.memo(function(e) {
  ...
  Q = l.memo(function(e) {
    let {
      ...
      onOpenProfileMenu: d,
      compact: m
    } = e, b = (0, u.e7)([_.Z, N.Z], () => _.Z.can(B.Plq.MANAGE_GUILD, N.Z.getGuild(t.guildId)), [t.guildId]), {
      selectedUserIds: p,
      addUsers: f,
      removeUser: h
    } = (0, T.Z)(t.guildId), j = (0, P.xC)(t.guildId), g = (0, P.hB)(t.guildId, j, t.userId), y = (0, x.m)(t.guildId), v = (0, u.e7)([M.Z], () => {
      var e;
    ...
    }, [f, g, t, h, p]), H = v === I.d$.ORDER_BY_GUILD_JOINED_AT_ASC, w = v === I.d$.ORDER_BY_USER_ID_ASC || v === I.d$.ORDER_BY_USER_ID_DESC;
  ...
  et = l.memo(function(e) {
    let {
      ...
      compact: b = !1
    } = e, p = (0, u.e7)([O.ZP], () => O.ZP.getGuildSidebarState(n), [n]), f = (null == p ? void 0 : p.details.userId) === t, h = (0, u.e7)([M.Z], () => M.Z.getEnhancedMember(n, t), [n, t]), j = (0, k.zq)(h), g = (0, u.e7)([H.default], () => H.default.getUser(t), [t]), x = (0, k.RN)(null != h ? h : void 0), y = l.useCallback(e => {
