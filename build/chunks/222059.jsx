...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk339149 = require("./339149.js"),
  Chunk864682 = require("./864682.js"),
...
function R(e) {
  ...
  let U = null;
  !o && b && (U = <c.Z className={T.downloadProgress} determineOwnVisibility={false} />);
  let G = o || O || L,
    B = <a.aRk selected={true} lowerBadge={p > 0 ? (0, I.Ne)(p) : null} upperBadge={U} lowerBadgeSize={{
        width: (0, a.OVM)(p)
      }}><a.LYs{...t = function(e) {
  ...
  return <div className={T.tutorialContainer}><g.Z inlineSpecs={A} tutorialId={"friends-list"} position={"right"}><S.H>{<E.Z selected={o} hovered={O} className={T.pill} />}{<x.Z color={a.ua7.Colors.PRIMARY} hideOnClick={true} text={k} selected={o}>{B}</x.Z>}</S.H></g.Z></div>
}
...
function D() {
  let e = (0, Chunk278464.n)(),
    t = (0, Chunk442837.e7)([Chunk941128.Z, Chunk417363.Z], () => {
      ...
      return Chunk255367 > 0 && Chunk255367 < 100
    }),
    n = (0, Chunk849862.If)(),
  ...
  return Chunk155409 && (E = Chunk981631.Z5c.APPLICATION_STORE), <R selected={module} user={Chunk864682} selectedChannelId={Chunk944486.Z.getChannelId(Chunk981631.ME)} badge={Chunk460181} link={Chunk276952} showProgressBadge={exports} />
}