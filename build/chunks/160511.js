...
function f(e) {
  let {
    ...
    onClose: m,
    isSlideReady: g
  } = e, [x, p] = r.useState(!1), [j, b] = r.useState(null), [y, S] = r.useState(!1), [v, C] = r.useState(null), [Z, w] = r.useState(""), k = r.useRef(null);
  r.useEffect(() => {
    p(!0), i.tn.post({
  ...
  let E = null == j ? u.intl.string(u.t.LQdCQE) : u.intl.formatToPlainString(u.t["8r6h7+"], {
    phoneNumber: j
  });
  return (0, l.jsxs)("form", {
    ...
    children: [(0, l.jsx)(d.Z.SlideHeader, {
      subtitle: E,
      onClose: m
