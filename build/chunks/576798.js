/** Chunk was on web.js **/
/** chunk id: 576798, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  A: () => o
...
function o(e) {
  ...
  return a.A.logGroups.map(r => {
    ...
    let {
      ...
      nativeLogs: p,
      serverTrace: _
    } = r, h = 0 === c ? null != (a = null == (o = i().find(f, e => e.log.indexOf("Logger loaded") >= 0)) ? true : o.timestamp) ? a : e : d, m = l(u(f, p, t, n), h), g = "Trace #".concat(c + 1, " started ").concat((0, s.aK)(d), "\n").concat(m);
...
function u(e, t, n, r) {
  ...
  let o = false;
  return e.filter(e => !(o && e.log.includes("↪")) && !(o = !r && "\uD83C\uDFA8" === e.emoji || false === e.shouldKeep))
}
