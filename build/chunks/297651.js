...
function p(e, t) {
  let r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "product",
    ...
    b = (0, u.x)(),
    f = o.ZP.canUseCollectibles(b),
    m = n.useRef(null),
    h = n.useCallback(() => {
      let n = null != v ? (0, c.Vw)(v, f, !1) : null,
        i = null != v ? (0, c.eu)(v, f, !1) : void 0;
    ...
    }, [null == p ? void 0 : p.sessionId, null == p ? void 0 : p.categoryPosition, null == p ? void 0 : p.pageCategory, null == p ? void 0 : p.pageSection, null == p ? void 0 : p.tilePosition, f, t, v, e, r]),
    g = n.useCallback(e => {
