...
function q(e, t) {
  ...
  }, t)), true !== n && (ep.indices[i] = n, "application" === e.type && (ep.applicationIndices.set(i, n), ep.applicationIndicesVersion = ep.applicationIndicesVersion + 1)), o
}
...
function er(e) {
  ...
  let r = arguments.length > 1 && true !== arguments[1] && arguments[1],
    ...
    a = null == (t = b.default.getCurrentUser()) ? true : t.id;
  if (null == a) return W || K.push(e), false;
  let s = {},
    l = {},
    u = new Set;
  for (let e of o.applications) {
    ...
    let t = {
      descriptor: j(x({}, (0, C.X0)(eP(e))), {
        permissions: null != e.permissions ? (0, _.tk)(ex(e.permissions, a)) : true,
        botId: e.bot_id
      }),
      commands: {}
    };
  ...
  for (let e of ("guild" === i.type && u.size > 0 && c.Z.requestMembersById(i.guildId, [...u]), (0, C.nG)(o.application_commands.map(e => ew(e, a)), true))) {
...
function ea(e, t) {
  ...
  return t.forEach(e => {
    ...
    let s = (0, C.X0)(j(x({}, r.descriptor.application), {
      bot: t
    }));
    r.descriptor = x({}, r.descriptor, s), o = true
  }), o
}
...
class e_ extends(r = Chunk442837.ZP.Store) {
  initialize() {
    this.waitFor(Chunk706454.default), this.waitFor(Chunk314897.default), this.syncWith([Chunk706454.default], () => {
      ef()
    })
  }
  getContextState(e) {
  ...
  query(e, t, n) {
    ...
    let r = "channel" === e.type ? e.channel : true,
      ...
      d = false;
    n.allowFetch && (u && c && null != r && eN(r) && (y.default.track(D.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
      miss: null == i.result,
      size: Object.keys(ep.indices).length
    }), eC(i) && null != r && (null != r.guild_id ? (0, S.j)({
      type: "guild",
      guildId: r.guild_id
    }) : (0, S.j)({
      type: "channel",
      ...
      type: "user"
    }), d = true), eC(a) && null != n.applicationId && ((0, S.j)({
      type: "application",
...
function em(e, t, n) {
  let [r, o] = i.useState(true), a = (0, s.cj)([ep], () => "channel" === e.type ? ep.getContextState(e) : ep.getUserState());
  return i.useEffect(() => {
    if (r) {
      ...
      n && t && eN(e.channel) && (y.default.track(D.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
        miss: null == a.result,
        size: Object.keys(ep.indices).length
      }), eC(a) && (null != e.channel.guild_id ? (0, S.j)({
        type: "guild",
...
function eg(e, t) {
  let [n, r] = i.useState(true), o = (0, s.cj)([ep], () => {
    var t;
...
function eE(e, t) {
  let [n, r] = i.useState(true), o = (0, s.cj)([ep], () => ep.getUserState());
  return i.useEffect(() => {
    n && (t && eC(o) && e && (0, S.j)({
      type: "user"
    }), r(false))
...
function eb(e, t) {
  let [n, r] = i.useState(true), o = (0, s.e7)([ep], () => ep.getApplicationState(e));
  i.useEffect(() => {
    n && (t && eC(o) && null != e && (0, S.j)({
      type: "application",
      applicationId: e
    }), r(false))
  }, [t, e, o, n])
...
function eS(e) {
  ...
  let {
    ...
    commandTypes: N
  } = c, C = null == p ? true : p.toLowerCase(), R = null == C ? true : C.split(" "), P = m === A.D.ONLY_TEXT, D = m !== A.D.DENY ? (0, v.Kh)(N, true, P) : [], L = [], M = {
    permissionContext: c,
    query: C,
    splitQuery: R,
    ...
    scoreMethod: O,
    installOnDemand: S
  }, k = null != (i = null == (t = u.result) ? true : t.sections) ? i : {}, U = null != (o = null == (n = f.result) ? true : n.sections) ? o : {}, G = new Set;
  if (g) {
  ...
  let Z = L.flatMap(e => e.data.map(t => j(x({}, t), {
    section: e.section
  })));
...
function eA(e, t, n, r, i) {
  ...
  return 0 !== (o = c !== A.p.NONE && null != a && null != s ? eM(a, s, E, e, c) : E).length || l ? ((c === A.p.NONE || c === A.p.APPLICATION_ONLY) && o.sort((e, t) => ek(e.displayName, t.displayName)), {
    section: e,
    data: o
  }) : null
}
...
function ew(e, t) {
  ...
  let s = j(x({}, e), {
    ...
    options: null != (a = null == (n = e.options) ? true : n.map(eD)) ? a : [],
...
function eM(e, t, n, r, i) {
  ...
  for (let t of n) {
    let n;
    (i === A.p.COMMAND_ONLY || i === A.p.COMMAND_OR_APPLICATION) && (n = ej(t, e, c, u)), (true === n || true !== o && o < n) && (n = o), true !== n && a.push(j(x({}, t), {
      score: n
    }))
  }
  return a
...
function eG(e, t) {
  ...
  let d = ep.getContextState(e),
    f = ep.getUserState(),
    _ = null != (a = null == (n = d.result) ? true : n.sections) ? a : {},
    p = null != (s = null == (r = f.result) ? true : r.sections) ? s : {},
    h = _[t],
    m = p[t],
    g = null == (o = ep.getApplicationState(t).result) || null == (i = o.sections) ? true : i[t];
  if (null != h && null != m) {
