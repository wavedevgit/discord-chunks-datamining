...
let _ = e => {
  ...
  let y = null != (n = null != v ? v : null == O ? true : O.skuId) ? n : "",
    ...
    I = (0, d.sp)();
  return <s.$ innerRef={T} onChange={x} threshold={0}><c.P3F className={m.featuredBlock} innerRef={T} style={{
      ...
      }}>{null != E && <c.IGR disableColor={true} text={E} className={m.featuredBlockBadge} />}{<div className={m.featuredBlockTextContainer}>{null != L && <c.X6q lineClamp={2} className={i()(m.featuredBlockTitleText, {
            [m.featuredBlockTitleTextNameplate]: P
          })} style={{
            color: null != (a = null == C ? true : C.bannerTextColor) ? a : "white"
          }} variant={"heading-xl/semibold"}>{L}</c.X6q>}{null != k && <c.X6q lineClamp={null != L ? 2 : 4} className={m.featuredBlockBodyText} style={{
            color: null != (_ = null == C ? true : C.bannerTextColor) ? _ : "white"
          }} variant={"heading-md/medium"}>{k}</c.X6q>}</div>}{<div className={m.featuredBlockButtonContainer}><c.zxk variant={"overlay-primary"} text={h.intl.string(h.t.jVcuVV)} onClick={e => {
