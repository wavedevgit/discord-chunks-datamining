  ...
  initialize(e) {
    null != e && E.default.keys(e.progressByGuild).forEach(t => {
      ...
      A.set(t, {
        ...
        tag: n.tag,
        verificationForm: null !== (l = n.verificationForm) && void 0 !== l ? l : d({}, s.t),
        ...
        banner: null !== (i = n.banner) && void 0 !== i ? i : u.qC.NIGHT_SKY,
...
_(R, "displayName", "ClanSetupStore"), _(R, "persistKey", "ClanSetupStore");
let f = new R(o.Z, {
  ...
  MEMBER_VERIFICATION_FORM_UPDATE: function(e) {
    ...
    l && (t = null == n ? s.t : d({}, O(r).verificationForm, n), g(r, {
      verificationForm: t
    }))
  }
})