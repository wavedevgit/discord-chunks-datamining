...
let eH = {
  ...
  eY = {
    ...
    async _sendMessage(e, t, n) {
      ...
      if (false !== n.eagerDispatch && ((0, z.iq)(e, ed.id), null != w && (ed.sticker_items = w.map(e => ee.A.getStickerById(e)).filter(e => null != e)), eY.receiveMessage(e, ed, true, n)), !ex && null != y && y.length > 0) {
        ex = true;
      ...
      return new Promise((t, r) => {
        ...
        eL.info("Queueing message to be sent LogId:".concat(o)), d.Ay.enqueue(e_, s => {
          let c = Date.now() - i;
          if (s.ok) {
            B.A.donateSentMessage(E, e), eY.receiveMessage(e, s.body, true, {
              sendAnalytics: {
                duration: c,
                queueSize: a
              },
            ...
            i ? eY.deleteMessage(e, eu, true) : (null != m && l.h.dispatch({
              type: "UPLOAD_FAIL",
              channelId: e,
              file: m._file,
              messageId: eu,
              reason: t,
              noSendFailed: true
            }), s.hasErr || t !== eS.ty.EXPLICIT_CONTENT || eY.sendExplicitMediaClydeError(e, null == (f = s.body) ? true : f.attachments, S.SW.EXPLICIT_MEDIA_MESSAGE_SEND_BLOCKED), l.h.dispatch({
              type: "MESSAGE_SEND_FAILED",
              messageId: eu,
              channelId: e,
    ...
    async editMessage(e, t, n) {
      ...
      d.Ay.enqueue({
        ...
        n.hasErr ? s.OR.announce(eT.intl.string(eT.t.Atp7FP)) : r ? s.OR.announce(eT.intl.string(eT.t.Hym4ix)) : s.OR.announce(eT.intl.string(eT.t["0x1HBD"])), eY.endEditMessage(e, n.hasErr ? true : n), eY.focusMessage({
          channelId: e,
          messageId: t
        })
      })
