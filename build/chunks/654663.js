...
let R = (0, u.Z)((0, o.Z)(function(e) {
  let {
    ...
    guildId: n,
    channelId: D
  }), V = (0, C.Z)(t, n, u), q = (0, _.Z)(t.id, u), G = (0, k.Z)(t.id), H = (0, x.Z)({
    user: t,
    context: u
  }), F = (0, r.e7)([O.Z, p.Z], () => {
  ...
  }), B = Q ? null == F ? void 0 : F.id : null, K = (0, T.Z)(t, B), Y = (0, j.Z)({
    user: t,
    guildId: n,
    channelId: D,
    context: u
    ...
    channelId: D,
    location: "ThreadUserContextMenu"
  }), ei = (0, W.Z)(t, n, D), ea = (0, U.Z)(t.id, n), eo = (0, S.Z)(t, n), eu = (0, g.Z)({
    id: t.id,
