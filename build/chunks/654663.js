...
let W = (0, u.Z)((0, a.Z)(function(e) {
  let {
    ...
    guildId: n,
    channelId: D
  }), L = (0, _.Z)(t, n, u), G = (0, C.Z)(t.id, u), Q = (0, A.Z)(t.id), V = (0, E.Z)({
    user: t,
    context: u
  }), H = (0, l.e7)([O.Z, p.Z], () => {
  ...
  }), F = B ? null == H ? void 0 : H.id : null, K = (0, T.Z)(t, F), X = (0, P.Z)({
    user: t,
    guildId: n,
    channelId: D,
    context: u
    ...
    channelId: D,
    location: "ThreadUserContextMenu"
  }), ei = (0, I.Z)(t, n, D), eo = (0, R.Z)(t.id, n), ea = (0, S.Z)(t, n), eu = (0, b.Z)({
    id: t.id,
  ...
  return (0, r.jsxs)(i.v2r, {
    ...
    onSelect: d,
    children: [!ed && (0, r.jsxs)(r.Fragment, {
