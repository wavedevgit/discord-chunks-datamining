...
function V(e, t) {
  let {
    forceBatchScan: n = !1,
    jitter: r = !1
  } = null != t ? t : {}, i = (null == t ? void 0 : t.isMessageUpdate) ? e.filter(A.MD).filter(F) : e.filter(F);
  i.forEach(e => {
    let t = k(e);
...
function Z(e) {
  ...
  return e.forEach(e => {
    ...
    let y = n[e.id];
    y.numOfAttachments += h, y.numOfEmbeds += m, y.numOfExplicitAttachments = null != (d = null == (a = e.attachments) ? void 0 : a.filter(e => (0, A.SI)(T._.EXPLICIT, {
      type: v.l.Attachment,
      media: e
    })).length) ? d : 0, y.numOfExplicitEmbeds = null != (f = null == (o = e.embeds) ? void 0 : o.filter(e => (0, A.SI)(T._.EXPLICIT, {
      type: v.l.Embed,
      media: e
    })).length) ? f : 0, y.numOfGoreAttachments = null != (_ = null == (s = e.attachments) ? void 0 : s.filter(e => (0, A.SI)(T._.GORE, {
      type: v.l.Attachment,
      media: e
    })).length) ? _ : 0, y.numOfGoreEmbeds = null != (p = null == (l = e.embeds) ? void 0 : l.filter(e => (0, A.SI)(T._.GORE, {
      type: v.l.Embed,
      media: e
    })).length) ? p : 0
  }), {
