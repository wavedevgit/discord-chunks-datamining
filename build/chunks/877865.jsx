...
function A() {
  return <div className={Chunk936631.loader}><Chunk481060.$jN /></div>
}
...
function D(e) {
  ...
  return <div className={l()(O.container, o)}>{<div className={O.headerContainer}>{<p.Text variant={"text-sm/medium"}>{y.intl.string(b.default["8ZcEfn"])}</p.Text>}{<p.ua7 text={y.intl.string(b.default["61KGaW"])} shouldShow={a.length === C}>{e => (0, r.jsx)(p.P3F, S(I({}, e), {
        ...
        }))}</p.ua7>}</div>}{B && <P colors={a} selectedIndex={v} onColorSelect={G} />}{<N onChange={x} onChangeComplete={M} color={A} />}{<div className={O.hexInputContainer}>{<input className={O.hexInput} value={A.toUpperCase()} onChange={e => L(e.target.value)} maxLength={7} placeholder={m.Dp} type={"text"} />}{<div className={O.trailingIcons}>{null != c && <p.ua7 text={y.intl.string(b.default["8QXO8v"])} tooltipClassName={O.eyeDropperTooltip}>{e => (0, r.jsx)(_.h, S(I({
            variant: "icon-only",
            size: "sm"
          }, e), {
            onClick: k,
          ...
          }))}</p.ua7>}{B && <p.ua7 text={y.intl.string(b.default["rTik5+"])}>{e => (0, r.jsx)(_.h, S(I({}, e), {
            variant: "icon-only",
            size: "sm",
            onClick: () => U(v),
            icon: f.X,
