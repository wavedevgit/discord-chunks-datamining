...
"use strict";
var Chunk991207 = require("./991207.js"),
  ...
  y = require("./740456.js").fastKey,
  Chunk605944 = require("./605944.js"),
  x = Chunk605944.set,
  d = Chunk605944.getterFor;
module.exports = {
    ...
    return s(l, {
      ...
      delete: function(t) {
        ...
        if (e) {
          var n = e.next,
            o = e.previous;
          delete r.index[e.index], e.removed = true, o && (o.next = n), n && (n.previous = o), r.first === e && (r.first = n), r.last === e && (r.last = o), v ? r.size-- : this.size--
        }
        return !!e
      },
      forEach: function(t) {
        for (var r, e = h(this), n = i(t, arguments.length > 1 ? arguments[1] : true); r = r ? r.next : e.first;)
  ...
  setStrong: function(t, r, e) {
    ...
    f(t, r, function(t, r) {
      ...
      return t.target && (t.last = e = e ? e.next : t.state.first) ? "keys" === r ? p(e.key, false) : "values" === r ? p(e.value, false) : p([e.key, e.value], false) : (t.target = null, p(true, true))
    }, e ? "entries" : "values", !e, true), l(r)
  }
}