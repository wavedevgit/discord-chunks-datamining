...
function I(e) {
  let {
    guildId: t
  } = e, n = (0, s.e7)([g.default], () => g.default.getCurrentUser()), l = (0, s.e7)([f.Z], () => f.Z.getGuild(t)), I = (0, s.e7)([m.Z], () => m.Z.getRolesSnapshot(t)), j = (0, s.e7)([m.Z], () => m.Z.getSortedRoles(t)), {
    impersonateType: S,
    viewingRoles: T
  } = (0, s.cj)([E.Z], () => ({
  ...
  let R = null != l && null != n && null != P ? j.find(e => P.roles.includes(e.id)) : void 0,
    ...
    }).filter(e => (null == R ? void 0 : R.id) === e.id || _.r6(l, n.id, R, e)) : [], [l, n, N, R, j]);
