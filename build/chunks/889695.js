...
function S(e) {
  ...
  })), w = N === y.z.SERVER_SHOP, R = (0, l.e7)([f.ZP], () => null != n ? f.ZP.getTrueMember(t, n.id) : null), [P, D] = (0, c.A7R)(null == C ? [] : g.default.keys(C)), L = i.useRef(a);
  i.useEffect(() => {
    let e = {},
      t = L.current;
    if (null != t && null != N) {
  ...
  let x = null != a && null != n && null != R ? A.find(e => R.roles.includes(e.id)) : void 0,
    k = i.useMemo(() => null != a && null != n ? A.filter(e => !(0, d.fI)(e)).filter(e => {
      var t;
      return !w || (null == (t = e.tags) ? void 0 : t.subscription_listing_id) != null
    }).filter(e => (null == x ? void 0 : x.id) === e.id || m.r6(a, n.id, x, e)) : [], [a, n, w, x, A]);
  ...
  return (R.roles.forEach(e => {
    ...
    children: (0, r.jsx)(c.hQY, {
      ...
      autoFocus: !0,
      children: e => {
        let t = k.reduce((t, n) => (o()(e.toLowerCase(), n.name.toLowerCase()) && t.push((0, r.jsxs)(c.lo1, {
            value: n.id,
