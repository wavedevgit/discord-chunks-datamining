...
let y = function(e) {
  let {
    ...
    primaryColor: y,
    secondaryColor: b
  } = e, [g, j] = a.useState(!1), C = a.useRef(null), v = a.useMemo(() => f.go.every(e => e.primary !== y || e.secondary !== b), [y, b]);
  ...
  return (0, t.jsxs)("div", {
    ...
    children: [(0, t.jsx)(o.vwX, {
      ...
      children: [f.go.map(e => (0, t.jsx)(o.P3F, {
        className: s()(x.pickerItem, {
          [x.pickerItemSelected]: e.primary === y && e.secondary === b
        }),
        onClick: () => N(e),
      ...
      }, "".concat(e.primary).concat(e.secondary))), (0, t.jsx)(d.Z, {
        popoutTargetRef: C,
        ...
        children: e => {
          var n, r;
          return (0, t.jsx)(o.P3F, (n = function(e) {
          ...
          }, Object.getOwnPropertyDescriptors ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(r)) : (function(e, n) {
            var r = Object.keys(e);
