...
let b = function(e) {
  ...
  let {
    ...
    guildId: b,
    guildProfile: x
  } = e, [j, N] = i.useState(!1), v = null !== (t = x.badgeColorPrimary) && void 0 !== t ? t : m.go["0"].primary, _ = null !== (n = x.badgeColorSecondary) && void 0 !== n ? n : m.go["0"].secondary, y = i.useMemo(() => m.go.every(e => e.primary !== v || e.secondary !== _), [v, _]);
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(o.vwX, {
      ...
      children: [m.go.map(e => (0, r.jsx)(o.P3F, {
        className: a()(f.pickerItem, {
          [f.pickerItemSelected]: e.primary === v && e.secondary === _
        }),
        onClick: () => O(e),
      ...
      }, "".concat(e.primary).concat(e.secondary))), (0, r.jsx)(d.Z, {
