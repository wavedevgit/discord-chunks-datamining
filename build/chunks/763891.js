...
function I(e) {
  ...
  let {
    ...
    scrollerRef: L,
    tab: B
  } = e, w = (0, d.sp)(), N = null != (t = null == w ? void 0 : w.sessionId) ? t : "", {
    noCache: A,
    includeUnpublished: R
  } = (0, _.Z)(), Z = (0, i.e7)([u.default], () => u.default.getCurrentUser()), F = (0, i.e7)([p.Z], () => p.Z.productsWithVariantsAsGroup), [D, H] = l.useState(1), M = () => {
    var e;
  ...
  }, [N, I, R, A, n, B]), n || null == Z) ? (0, r.jsx)(h.Z, {}) : (0, r.jsxs)(r.Fragment, {
