...
function N(e) {
  ...
  let {
    ...
    scrollerRef: A,
    tab: w
  } = e, B = (0, p.sp)(), R = null != (t = null == B ? void 0 : B.sessionId) ? t : "", {
    noCache: Z,
    includeUnpublished: D
  } = (0, v.Z)(), F = (0, i.e7)([u.default], () => u.default.getCurrentUser()), M = (0, i.e7)([f.Z], () => f.Z.productsWithVariantsAsGroup), [H, W] = l.useState(1), V = () => {
    var e;
  ...
  }, [w, z]), Y = (0, g.a)(), X = l.useMemo(() => Y(M.filter(e => {
    var t;
  ...
  }, [R, N, D, Z, r, w]), r || null == F) ? (0, n.jsx)(m.Z, {}) : (0, n.jsxs)(n.Fragment, {
