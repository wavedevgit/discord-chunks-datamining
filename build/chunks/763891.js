...
function E(e) {
  ...
  let {
    ...
    scrollerRef: j,
    tab: y
  } = e, P = (0, c.sp)(), k = null != (t = null == P ? void 0 : P.sessionId) ? t : "", {
    noCache: T,
    includeUnpublished: I
  } = (0, h.Z)(), L = (0, i.e7)([s.default], () => s.default.getCurrentUser()), B = (0, i.e7)([u.Z], () => u.Z.productsWithVariantsAsGroup), [w, N] = l.useState(1), A = () => {
    var e;
  ...
  }, [y]), D = (0, d.a)(), H = l.useMemo(() => D(B.filter(e => {
    var t;
  ...
  }, [k, E, I, T, n, y]), n || null == L) ? (0, r.jsx)(b.Z, {}) : (0, r.jsxs)(r.Fragment, {
