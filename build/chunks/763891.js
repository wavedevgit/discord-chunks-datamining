...
function k(e) {
  ...
  } = (0, _.Z)(), Z = (0, a.e7)([u.default], () => u.default.getCurrentUser()), M = (0, a.e7)([p.Z], () => p.Z.productsWithVariantsAsGroup), [H, D] = l.useState(1), F = () => {
    var e;
  ...
  }, [B, V]), Y = (0, g.a)(), K = l.useMemo(() => Y(M.filter(e => {
    var t;
  ...
  }, [A, k, R, w, n, B]), n || null == Z) ? (0, r.jsx)(b.Z, {}) : (0, r.jsxs)(r.Fragment, {
