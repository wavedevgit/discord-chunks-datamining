...
function L(e) {
  ...
  } = (0, _.Z)(), R = (0, i.e7)([u.default], () => u.default.getCurrentUser()), H = (0, i.e7)([p.Z], () => p.Z.productsWithVariantsAsGroup), [M, D] = l.useState(1), F = () => {
    var e;
  ...
  }, [B, V]), q = (0, f.a)(), Y = l.useMemo(() => q(H.filter(e => {
    var t;
  ...
  }, [A, L, Z, w, n, B]), n || null == R) ? (0, r.jsx)(b.Z, {}) : (0, r.jsxs)(r.Fragment, {
