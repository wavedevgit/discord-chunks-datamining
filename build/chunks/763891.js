...
function k(e) {
  ...
  } = (0, _.Z)(), Z = (0, o.e7)([u.default], () => u.default.getCurrentUser()), D = (0, o.e7)([p.Z], () => p.Z.productsWithVariantsAsGroup), [M, F] = l.useState(1), H = () => {
    var e;
  ...
  }, [B, V]), Y = (0, g.a)(), K = l.useMemo(() => Y(D.filter(e => {
    var t;
  ...
  return (l.useEffect(() => {
  ...
  }, [A, k, w, R, n, B]), n || null == Z) ? (0, r.jsx)(b.Z, {}) : (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)("div", {
      ...
      children: q.slice(40 * (M - 1), 40 * M).map((e, t) => {
