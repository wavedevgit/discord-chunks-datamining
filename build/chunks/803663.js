...
function g(e) {
  let {
    ...
    channelId: y,
    guildId: v
  } = null != b ? b : {}, O = (0, i.e7)([f.Z], () => null != y && f.Z.isInChannel(y), [y]), I = (0, i.e7)([u.Z], () => null != y ? u.Z.getChannel(y) : null, [y]), S = (0, i.e7)([d.Z], () => null != I && d.Z.can(l.gl, I), [I]);
  if (!(0, c.dS)(t) || !S || null == v || null == y) return null;
  let T = e => {
    e.stopPropagation(), null == n || n({
      action: "PRESS_STAGE_CHANNEL_LISTEN_BUTTON"
    }), s.AC(v, y), (0, o.Kh)(y), null == g || g()
  };
