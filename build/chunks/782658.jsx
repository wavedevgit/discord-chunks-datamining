...
function x(e) {
  ...
  let U = null != M ? M : {
    ...
    W = <A.Z onTransitionToInviteChannel={H} onAcceptInstantInvite={Y} currentUserId={F} guild={Z} invite={U} message={n} />;
  switch (U.state) {
    ...
    case D.r2o.EXPIRED:
    case D.r2o.BANNED:
      W = <C.Z banned={U.state === D.r2o.BANNED} author={n.author} channelId={n.channel_id} />;
      break;
    case D.r2o.ERROR:
      W = <I.Z author={n.author} inviteError={k} />;
      break;
    default:
      switch ((0, h.VR)(U)) {
        case h.wx.GROUP_DM:
          W = <S.Z onTransitionToInviteChannel={H} onAcceptInstantInvite={Y} currentUserId={F} invite={U} message={n} />;
          break;
        case h.wx.FRIEND:
          W = <T.Z invite={U} message={n} getAcceptInviteContext={x} />;
          break;
        default:
          if ((0, h.TY)(U)) {
            W = <w.Z onTransitionToInviteChannel={H} onAcceptInstantInvite={Y} currentUserId={F} message={n} guild={Z} invite={U} />;
            break
          }
          if ((0, h.Tx)(U)) {
            W = <p.ZP guildScheduledEvent={V} guild={U.guild} channel={U.channel} isMember={null != Z} onAcceptInstantInvite={Y} onTransitionToInviteChannel={H} />;
            break
          }
          if ((0, h.$P)(U)) {
            W = <P.Z invite={U} stageInstance={U.stage_instance} guild={U.guild} isMember={null != Z} message={n} onTransitionToInviteChannel={H} onAcceptInstantInvite={Y} />;
            break
          }
          if ((0, h.P1)(U)) {
            W = <v.Z invite={U} getAcceptInviteContext={x} message={n} />;
            break
          }!B && (0, f.l)(U) && (W = <N.Z onTransitionToInviteChannel={H} onAcceptInstantInvite={Y} isMemberOfGuild={null != Z} invite={U} message={n} />)
      }
  }
  return <s.Z section={D.jXE.INVITE_LINK}>{W}</s.Z>
}