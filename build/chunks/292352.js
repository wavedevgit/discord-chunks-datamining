...
let T = new Map([
    [3, {
      priority: 100,
      tooltipHeader: () => Chunk388032.intl.string(Chunk382402.default.kvTgWP),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk382402.default.fLBUx7),
        yesterday: Chunk388032.intl.string(Chunk382402.default.cHHgxI),
        days: Chunk382402.default.qvKjp8
      })
    }],
    [5, {
      priority: 200,
      tooltipHeader: () => Chunk388032.intl.string(Chunk382402.default.D7Sngz),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk382402.default.IHd5cZ),
        yesterday: Chunk388032.intl.string(Chunk382402.default.wOsfxv),
        days: Chunk382402.default.oCk8c4
      })
    }],
    [1, {
      priority: 300,
      tooltipHeader: () => Chunk388032.intl.string(Chunk382402.default.kIcKAj),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk382402.default.JUHIYZ),
        yesterday: Chunk388032.intl.string(Chunk382402.default.GiswUW),
        days: Chunk382402.default["fwQgE/"]
      })
    }],
    [2, {
      priority: 400,
      tooltipHeader: () => (0, Chunk546791.lW)(Chunk388032.intl.string(Chunk382402.default["NulX9+"]), Chunk388032.intl.string(Chunk382402.default.uav9Bh)),
    ...
    [4, {
      priority: 500,
      tooltipHeader: () => Chunk388032.intl.string(Chunk382402.default.CcrbCw),
  ...
  A = new Map([
    [6, {
      priority: 175,
      tooltipHeader: () => Chunk388032.intl.string(Chunk382402.default.eo4Fxh),
      tooltipDescription: () => Chunk388032.intl.string(Chunk382402.default["O/AElu"]),
      sectionHeader: e => s.intl.formatToPlainString(o.default.eGFWUd, {
        count: e
      }),
      sectionDescription: () => Chunk388032.intl.string(Chunk382402.default["O/AElu"])
    }],
    [7, {
      priority: 150,
      tooltipHeader: () => Chunk388032.intl.string(Chunk382402.default.NMYKsh),
  ...
  C = () => ({
    seconds: Chunk388032.intl.string(Chunk382402.default.CJdoee),
    minutes: Chunk382402.default.InzMn3,
    hours: Chunk382402.default.ErkYCI,
    yesterday: Chunk388032.intl.string(Chunk382402.default.GvfssA),
    days: Chunk382402.default.pWig18,
    date: Chunk382402.default.MP3khg
  }),
  N = () => ({
    seconds: Chunk388032.intl.string(Chunk382402.default.Bqsamd),
    minutes: Chunk382402.default.kX3wJg,
    hours: Chunk382402.default.J18GbG,
    yesterday: Chunk388032.intl.string(Chunk382402.default.Ln9zMn),
    days: Chunk382402.default.WRtySz,
    date: Chunk382402.default.Y3ZYtM
  })