...
let S = new Map([
    [3, {
      priority: 100,
      tooltipHeader: () => Chunk388032.intl.string(Chunk313570.default.kvTgWP),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk313570.default.fLBUx7),
        yesterday: Chunk388032.intl.string(Chunk313570.default.cHHgxI),
        days: Chunk313570.default.qvKjp8
      })
    }],
    [5, {
      priority: 200,
      tooltipHeader: () => Chunk388032.intl.string(Chunk313570.default.D7Sngz),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk313570.default.IHd5cZ),
        yesterday: Chunk388032.intl.string(Chunk313570.default.wOsfxv),
        days: Chunk313570.default.oCk8c4
      })
    }],
    [1, {
      priority: 300,
      tooltipHeader: () => Chunk388032.intl.string(Chunk313570.default.kIcKAj),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk313570.default.JUHIYZ),
        yesterday: Chunk388032.intl.string(Chunk313570.default.GiswUW),
        days: Chunk313570.default["fwQgE/"]
      })
    }],
    [2, {
      priority: 400,
      tooltipHeader: () => (0, Chunk546791.lW)(Chunk388032.intl.string(Chunk313570.default["NulX9+"]), Chunk388032.intl.string(Chunk313570.default.uav9Bh)),
    ...
    [4, {
      priority: 500,
      tooltipHeader: () => Chunk388032.intl.string(Chunk313570.default.CcrbCw),
  ...
  A = new Map([
    [6, {
      priority: 175,
      tooltipHeader: () => Chunk388032.intl.string(Chunk313570.default.eo4Fxh),
      tooltipDescription: () => Chunk388032.intl.string(Chunk313570.default["O/AElu"]),
      sectionHeader: e => s.intl.formatToPlainString(o.default.eGFWUd, {
        count: e
      }),
      sectionDescription: () => Chunk388032.intl.string(Chunk313570.default["O/AElu"])
    }],
    [7, {
      priority: 150,
      tooltipHeader: () => Chunk388032.intl.string(Chunk313570.default.NMYKsh),
  ...
  C = () => ({
    seconds: Chunk388032.intl.string(Chunk313570.default.CJdoee),
    minutes: Chunk313570.default.InzMn3,
    hours: Chunk313570.default.ErkYCI,
    yesterday: Chunk388032.intl.string(Chunk313570.default.GvfssA),
    days: Chunk313570.default.pWig18,
    date: Chunk313570.default.MP3khg
  }),
  N = () => ({
    seconds: Chunk388032.intl.string(Chunk313570.default.Bqsamd),
    minutes: Chunk313570.default.kX3wJg,
    hours: Chunk313570.default.J18GbG,
    yesterday: Chunk388032.intl.string(Chunk313570.default.Ln9zMn),
    days: Chunk313570.default.WRtySz,
    date: Chunk313570.default.Y3ZYtM
  })