...
let S = new Map([
    [3, {
      priority: 100,
      tooltipHeader: () => Chunk388032.intl.string(Chunk404517.default.kvTgWP),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk404517.default.fLBUx7),
        yesterday: Chunk388032.intl.string(Chunk404517.default.cHHgxI),
        days: Chunk404517.default.qvKjp8
      })
    }],
    [5, {
      priority: 200,
      tooltipHeader: () => Chunk388032.intl.string(Chunk404517.default.D7Sngz),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk404517.default.IHd5cZ),
        yesterday: Chunk388032.intl.string(Chunk404517.default.wOsfxv),
        days: Chunk404517.default.oCk8c4
      })
    }],
    [1, {
      priority: 300,
      tooltipHeader: () => Chunk388032.intl.string(Chunk404517.default.kIcKAj),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk404517.default.JUHIYZ),
        yesterday: Chunk388032.intl.string(Chunk404517.default.GiswUW),
        days: Chunk404517.default["fwQgE/"]
      })
    }],
    [2, {
      priority: 400,
      tooltipHeader: () => (0, Chunk546791.lW)(Chunk388032.intl.string(Chunk404517.default["NulX9+"]), Chunk388032.intl.string(Chunk404517.default.uav9Bh)),
    ...
    [4, {
      priority: 500,
      tooltipHeader: () => Chunk388032.intl.string(Chunk404517.default.CcrbCw),
  ...
  A = new Map([
    [6, {
      priority: 175,
      tooltipHeader: () => Chunk388032.intl.string(Chunk404517.default.eo4Fxh),
      tooltipDescription: () => Chunk388032.intl.string(Chunk404517.default["O/AElu"]),
      sectionHeader: e => s.intl.formatToPlainString(o.default.eGFWUd, {
        count: e
      }),
      sectionDescription: () => Chunk388032.intl.string(Chunk404517.default["O/AElu"])
    }],
    [7, {
      priority: 150,
      tooltipHeader: () => Chunk388032.intl.string(Chunk404517.default.NMYKsh),
  ...
  C = () => ({
    seconds: Chunk388032.intl.string(Chunk404517.default.CJdoee),
    minutes: Chunk404517.default.InzMn3,
    hours: Chunk404517.default.ErkYCI,
    yesterday: Chunk388032.intl.string(Chunk404517.default.GvfssA),
    days: Chunk404517.default.pWig18,
    date: Chunk404517.default.MP3khg
  }),
  N = () => ({
    seconds: Chunk388032.intl.string(Chunk404517.default.Bqsamd),
    minutes: Chunk404517.default.kX3wJg,
    hours: Chunk404517.default.J18GbG,
    yesterday: Chunk388032.intl.string(Chunk404517.default.Ln9zMn),
    days: Chunk404517.default.WRtySz,
    date: Chunk404517.default.Y3ZYtM
  })