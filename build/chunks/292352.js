...
let S = new Map([
    [3, {
      priority: 100,
      tooltipHeader: () => Chunk388032.intl.string(Chunk660886.default.kvTgWP),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk660886.default.fLBUx7),
        yesterday: Chunk388032.intl.string(Chunk660886.default.cHHgxI),
        days: Chunk660886.default.qvKjp8
      })
    }],
    [5, {
      priority: 200,
      tooltipHeader: () => Chunk388032.intl.string(Chunk660886.default.D7Sngz),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk660886.default.IHd5cZ),
        yesterday: Chunk388032.intl.string(Chunk660886.default.wOsfxv),
        days: Chunk660886.default.oCk8c4
      })
    }],
    [1, {
      priority: 300,
      tooltipHeader: () => Chunk388032.intl.string(Chunk660886.default.kIcKAj),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk660886.default.JUHIYZ),
        yesterday: Chunk388032.intl.string(Chunk660886.default.GiswUW),
        days: Chunk660886.default["fwQgE/"]
      })
    }],
    [2, {
      priority: 400,
      tooltipHeader: () => (0, Chunk546791.lW)(Chunk388032.intl.string(Chunk660886.default["NulX9+"]), Chunk388032.intl.string(Chunk660886.default.uav9Bh)),
    ...
    [4, {
      priority: 500,
      tooltipHeader: () => Chunk388032.intl.string(Chunk660886.default.CcrbCw),
  ...
  A = new Map([
    [6, {
      priority: 175,
      tooltipHeader: () => Chunk388032.intl.string(Chunk660886.default.eo4Fxh),
      tooltipDescription: () => Chunk388032.intl.string(Chunk660886.default["O/AElu"]),
      sectionHeader: e => s.intl.formatToPlainString(o.default.eGFWUd, {
        count: e
      }),
      sectionDescription: () => Chunk388032.intl.string(Chunk660886.default["O/AElu"])
    }],
    [7, {
      priority: 150,
      tooltipHeader: () => Chunk388032.intl.string(Chunk660886.default.NMYKsh),
  ...
  C = () => ({
    seconds: Chunk388032.intl.string(Chunk660886.default.CJdoee),
    minutes: Chunk660886.default.InzMn3,
    hours: Chunk660886.default.ErkYCI,
    yesterday: Chunk388032.intl.string(Chunk660886.default.GvfssA),
    days: Chunk660886.default.pWig18,
    date: Chunk660886.default.MP3khg
  }),
  N = () => ({
    seconds: Chunk388032.intl.string(Chunk660886.default.Bqsamd),
    minutes: Chunk660886.default.kX3wJg,
    hours: Chunk660886.default.J18GbG,
    yesterday: Chunk388032.intl.string(Chunk660886.default.Ln9zMn),
    days: Chunk660886.default.WRtySz,
    date: Chunk660886.default.Y3ZYtM
  })