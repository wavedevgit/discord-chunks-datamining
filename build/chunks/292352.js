...
let S = new Map([
    [3, {
      priority: 100,
      tooltipHeader: () => Chunk388032.intl.string(Chunk893102.default.kvTgWP),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk893102.default.fLBUx7),
        yesterday: Chunk388032.intl.string(Chunk893102.default.cHHgxI),
        days: Chunk893102.default.qvKjp8
      })
    }],
    [5, {
      priority: 200,
      tooltipHeader: () => Chunk388032.intl.string(Chunk893102.default.D7Sngz),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk893102.default.IHd5cZ),
        yesterday: Chunk388032.intl.string(Chunk893102.default.wOsfxv),
        days: Chunk893102.default.oCk8c4
      })
    }],
    [1, {
      priority: 300,
      tooltipHeader: () => Chunk388032.intl.string(Chunk893102.default.kIcKAj),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk893102.default.JUHIYZ),
        yesterday: Chunk388032.intl.string(Chunk893102.default.GiswUW),
        days: Chunk893102.default["fwQgE/"]
      })
    }],
    [2, {
      priority: 400,
      tooltipHeader: () => (0, Chunk546791.lW)(Chunk388032.intl.string(Chunk893102.default["NulX9+"]), Chunk388032.intl.string(Chunk893102.default.uav9Bh)),
    ...
    [4, {
      priority: 500,
      tooltipHeader: () => Chunk388032.intl.string(Chunk893102.default.CcrbCw),
  ...
  A = new Map([
    [6, {
      priority: 175,
      tooltipHeader: () => Chunk388032.intl.string(Chunk893102.default.eo4Fxh),
      tooltipDescription: () => Chunk388032.intl.string(Chunk893102.default["O/AElu"]),
      sectionHeader: e => s.intl.formatToPlainString(o.default.eGFWUd, {
        count: e
      }),
      sectionDescription: () => Chunk388032.intl.string(Chunk893102.default["O/AElu"])
    }],
    [7, {
      priority: 150,
      tooltipHeader: () => Chunk388032.intl.string(Chunk893102.default.NMYKsh),
  ...
  C = () => ({
    seconds: Chunk388032.intl.string(Chunk893102.default.CJdoee),
    minutes: Chunk893102.default.InzMn3,
    hours: Chunk893102.default.ErkYCI,
    yesterday: Chunk388032.intl.string(Chunk893102.default.GvfssA),
    days: Chunk893102.default.pWig18,
    date: Chunk893102.default.MP3khg
  }),
  N = () => ({
    seconds: Chunk388032.intl.string(Chunk893102.default.Bqsamd),
    minutes: Chunk893102.default.kX3wJg,
    hours: Chunk893102.default.J18GbG,
    yesterday: Chunk388032.intl.string(Chunk893102.default.Ln9zMn),
    days: Chunk893102.default.WRtySz,
    date: Chunk893102.default.Y3ZYtM
  })