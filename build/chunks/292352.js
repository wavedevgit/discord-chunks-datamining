...
let S = new Map([
    [3, {
      priority: 100,
      tooltipHeader: () => Chunk388032.intl.string(Chunk41418.default.kvTgWP),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk41418.default.fLBUx7),
        yesterday: Chunk388032.intl.string(Chunk41418.default.cHHgxI),
        days: Chunk41418.default.qvKjp8
      })
    }],
    [5, {
      priority: 200,
      tooltipHeader: () => Chunk388032.intl.string(Chunk41418.default.D7Sngz),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk41418.default.IHd5cZ),
        yesterday: Chunk388032.intl.string(Chunk41418.default.wOsfxv),
        days: Chunk41418.default.oCk8c4
      })
    }],
    [1, {
      priority: 300,
      tooltipHeader: () => Chunk388032.intl.string(Chunk41418.default.kIcKAj),
      ...
      timestampFormatter: () => ({
        today: Chunk388032.intl.string(Chunk41418.default.JUHIYZ),
        yesterday: Chunk388032.intl.string(Chunk41418.default.GiswUW),
        days: Chunk41418.default["fwQgE/"]
      })
    }],
    [2, {
      priority: 400,
      tooltipHeader: () => (0, Chunk546791.lW)(Chunk388032.intl.string(Chunk41418.default["NulX9+"]), Chunk388032.intl.string(Chunk41418.default.uav9Bh)),
    ...
    [4, {
      priority: 500,
      tooltipHeader: () => Chunk388032.intl.string(Chunk41418.default.CcrbCw),
  ...
  A = new Map([
    [6, {
      priority: 175,
      tooltipHeader: () => Chunk388032.intl.string(Chunk41418.default.eo4Fxh),
      tooltipDescription: () => Chunk388032.intl.string(Chunk41418.default["O/AElu"]),
      sectionHeader: e => s.intl.formatToPlainString(o.default.eGFWUd, {
        count: e
      }),
      sectionDescription: () => Chunk388032.intl.string(Chunk41418.default["O/AElu"])
    }],
    [7, {
      priority: 150,
      tooltipHeader: () => Chunk388032.intl.string(Chunk41418.default.NMYKsh),
  ...
  C = () => ({
    seconds: Chunk388032.intl.string(Chunk41418.default.CJdoee),
    minutes: Chunk41418.default.InzMn3,
    hours: Chunk41418.default.ErkYCI,
    yesterday: Chunk388032.intl.string(Chunk41418.default.GvfssA),
    days: Chunk41418.default.pWig18,
    date: Chunk41418.default.MP3khg
  }),
  N = () => ({
    seconds: Chunk388032.intl.string(Chunk41418.default.Bqsamd),
    minutes: Chunk41418.default.kX3wJg,
    hours: Chunk41418.default.J18GbG,
    yesterday: Chunk388032.intl.string(Chunk41418.default.Ln9zMn),
    days: Chunk41418.default.WRtySz,
    date: Chunk41418.default.Y3ZYtM
  })