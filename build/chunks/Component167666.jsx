...
class g extends(r = Chunk647438.PureComponent) {
  ...
  renderChildren() {
    ...
    return Chunk647438.Children.map(this.props.children, t => o.isValidElement(t) ? t.type === l.hzk || t.type === l.YAO ? o.cloneElement(t, {
  ...
  render() {
    ...
    return (0, Chunk951288.jsx)(r, _(d({
      className: s()(Chunk884281.modal, exports, Chunk647438, {
