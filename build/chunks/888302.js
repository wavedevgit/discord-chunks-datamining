...
function u(e) {
  let {
    ...
    count: d
  }) : 1 === n.size && n.has(o.G.NAMEPLATE) ? c.intl.format(c.t.ZWGN9f, {
    count: d
  }) : 1 === n.size && n.has(o.G.PROFILE_EFFECT) ? c.intl.format(c.t["v/7apq"], {
    count: d
  }) : 1 === n.size && n.has(o.G.BUNDLE) ? c.intl.format(c.t.fZ1rdn, {
    count: d
