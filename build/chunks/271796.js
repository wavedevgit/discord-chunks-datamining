...
var u = function() {
    function e() {
      ...
      for (var t = arguments.length, r = Array(exports), n = 0; Chunk675082 < exports; Chunk675082++) require[Chunk675082] = arguments[Chunk675082];
    ...
    return a(module, [{
      ...
      value: function() {
        if (!this.isDisposed) {
          ...
          this.disposables = [];
          for (var n = 0; Chunk675082 < module; Chunk675082++) exports[Chunk675082].dispose()
        }
      }
    }, {
      key: "dispose",
