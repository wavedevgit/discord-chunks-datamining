        ...
        return {
          toComponent: function() {
            ...
            return n = t.titleAttributes, (i = {
              key: e = t.title
            })["data-rh"] = true, o = M(n, i), [r.createElement(h.TITLE, o, e)]
          }, toString: function() {
    ...
    if (e.prioritizeSeoTags) {
      var _ = function(e) {
        ...
        return {
          priorityMethods: {
            toComponent: function() {
              return [].concat(k(h.META, i.priority), k(h.LINK, o.priority), k(h.SCRIPT, a.priority))
            },
            toString: function() {
              return U(h.META, i.priority, r) + " " + U(h.LINK, o.priority, r) + " " + U(h.SCRIPT, a.priority, r)
            }
          },
          metaTags: i.default,
          linkTags: o.default,
...
var W = function(e, t) {
    var n, r = document.head || document.querySelector(h.HEAD),
  ...
  z = function(e, t) {
    var n = e.baseTag,
      ...
      u = e.title,
      d = e.titleAttributes;
    K(h.BODY, e.bodyAttributes), K(h.HTML, r),
      function(e, t) {
        true !== e && document.title !== e && (document.title = R(e)), K(h.TITLE, t)
      }(u, d);
    var f = {
        baseTag: W(h.BASE, n),
        linkTags: W(h.LINK, i),
        metaTags: W(h.META, o),
        noscriptTags: W(h.NOSCRIPT, a),
