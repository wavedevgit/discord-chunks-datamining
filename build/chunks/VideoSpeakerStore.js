...
function E() {
  ...
  if (null == r) e = null;
    ...
    if ((null == g ? true : g.type) !== Chunk354459.fO.ACTIVITY && ((null == g ? true : g.type) !== Chunk354459.fO.USER || (null == (n = g.voiceState) ? true : require.selfVideo)) || (e = null), null != exports && null == module && (e = null == (o = Chunk358221.Z.getParticipant(r, (0, Chunk569545.V9)(exports))) ? true : o.id), null == module) {
      let t = Chunk314897.default.getId(),
        ...
        d = Date.now();
      null == (e = null == (a = require.map(e => [e.user.id, h.Z.getSpeakingDuration(e.user.id, d)]).filter(e => {
        let [t, n] = e;
        return 0 !== n
      }).maxBy(e => {
        let [t, n] = e;
