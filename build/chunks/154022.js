    ...
    children: (0, i.jsxs)(d.Zbd, {
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(d.zxk, {
          ...
          children: [R.Skl.ONLINE, R.Skl.DND, R.Skl.IDLE].map(e => (0, i.jsx)(d.Xo$, {
...
function J() {
  let e = (0, c.e7)([g.Z], () => g.Z.syncProfileThemeWithUserTheme),
    t = r.useRef(null);
  return (0, y.Z)(t, A.rP.SYNC_PROFILE_THEME_WITH_USER_THEME), (0, i.jsx)(d.xJW, {
    ref: t,
...
function Q() {
  ...
  let a = w.intl.format(w.t.GwEVEx, {
    learnMoreLink: T.Z.getArticleURL(R.BhN.FORCED_COLORS)
  });
  return (0, i.jsx)(d.xJW, {
...
function $() {
  ...
  return (0, i.jsxs)(d.xJW, {
    ...
    children: [(0, i.jsx)(d.R94, {
      type: d.R94.Types.DESCRIPTION,
      className: L.marginBottom8,
      children: w.intl.format(w.t["2l9U2t"], {
        helpdeskArticle: T.Z.getArticleURL(R.BhN.REDUCED_MOTION)
      })
    }), (0, i.jsx)(d.XZJ, {
      className: a()(L.marginTop20, L.marginBottom20),
      value: "auto" === s,
...
function et() {
  let e = (0, c.e7)([g.Z], () => g.Z.isSubmitButtonEnabled),
    t = N.dN.useSetting(),
    n = r.useRef(null);
  return (0, y.Z)(n, A.rP.LEGACY_CHAT_INPUT), (0, i.jsxs)(d.xJW, {
    ref: n,
    className: L.marginTop20,
    children: [(0, i.jsx)(d.vwX, {
      className: L.marginBottom8,
      ...
      children: (0, i.jsx)(d.j7V, {
        ...
        onChange: e => {
          S.default.track(R.rMx.LEGACY_CHAT_INPUT_TOGGLED, {
            enabled: e,
            location: {
              section: R.jXE.SETTINGS_ACCESSIBILITY
            }
          ...
          children: (0, i.jsx)(d.zxk, {
            ...
            onClick: () => {
              if (n) {
                (0, C.NB)(), s(!1);
                return
              }(0, C.cP)(w.intl.string(w.t.PKaNJC), !0, void 0, () => s(!0), () => s(!1)), s(!0)
            },
