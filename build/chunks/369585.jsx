...
function b(e) {
  ...
  return <footer className={o()(f.actionBar, f.section)}>{null != t && <div className={f.actionBarLeading}>{t}</div>}{<div className={o()(f.actionBarTrailing, {
        [f.actionBarTrailingFullWidth]: i
      })}><c.h fullWidth={i}>{null == n ? true : n.map((e, t) => {
          var n;
