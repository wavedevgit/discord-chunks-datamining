...
class R extends s.PureComponent {
  render() {
    let {
      ...
      hideDiscriminator: t,
      hideInviteCode: n
    } = this.props, s = new Z.Z(e.inviter);
    return (0, r.jsxs)(j.Z, {
...
class S extends s.PureComponent {
  componentDidMount() {
    ...
    }), y.default.track(I.rMx.OPEN_MODAL, D(P({}, (0, x.v_)(w.Z.getChannel(e))), {
  ...
  renderContent() {
    ...
    return e || null == t ? (0, r.jsx)(h.$jN, {
      className: O.marginTop20,
      type: h.$jN.Type.SPINNING_CIRCLE
    }) : l().isEmpty(t) ? this.renderEmpty() : (0, r.jsxs)("div", {
