...
class D extends n.PureComponent {
  render() {
    let {
      ...
      hideDiscriminator: t,
      hideInviteCode: r
    } = this.props, n = new w.Z(e.inviter);
    return (0, s.jsxs)(v.Z, {
...
class S extends n.PureComponent {
  componentDidMount() {
    ...
    }), C.default.track(I.rMx.OPEN_MODAL, R(P({}, (0, x.v_)(N.Z.getChannel(e))), {
  ...
  renderHeader() {
    return (0, s.jsxs)(v.Z, {
      children: [(0, s.jsx)(v.Z.Child, {
        wrap: !0,
        children: (0, s.jsx)(h.vwX, {
          children: f.NW.string(f.t.EgHyKy)
        })
      }), (0, s.jsx)(v.Z.Child, {
        wrap: !0,
        grow: 0,
        ...
        basis: 100,
        children: (0, s.jsx)(h.vwX, {
          children: f.NW.string(f.t.LBlFEB)
        })
      }), (0, s.jsx)(v.Z.Child, {
        wrap: !0,
        grow: 0,
