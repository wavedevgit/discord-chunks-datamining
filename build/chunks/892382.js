...
class S extends s.PureComponent {
  render() {
    let {
      ...
      hideDiscriminator: t,
      hideInviteCode: r
    } = this.props, s = new w.Z(e.inviter);
    return (0, n.jsxs)(j.Z, {
...
class D extends s.PureComponent {
  componentDidMount() {
    ...
    }), I.default.track(f.rMx.OPEN_MODAL, R(P({}, (0, x.v_)(y.Z.getChannel(e))), {
  ...
  renderContent() {
    ...
    return e || null == t ? (0, n.jsx)(h.$jN, {
      className: E.marginTop20,
      type: h.$jN.Type.SPINNING_CIRCLE
    }) : l().isEmpty(t) ? this.renderEmpty() : (0, n.jsxs)("div", {
