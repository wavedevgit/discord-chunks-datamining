...
let m = e => {
  ...
  let v = i.useCallback(e => {
    ...
    I = (0, d.gK)();
  return <div className={g.page}><o.Z embedded={true} splash={I} waveState={m} showLogo={false} updateWaveState={v}>{<div className={g.dragRegion} />}{<div className={g.contentWrapper}>{!_ && (0, r.jsx)(p.H, {
          invite: E
        })}</div>}</o.Z></div>
}