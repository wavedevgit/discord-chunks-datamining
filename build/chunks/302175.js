...
function x(e) {
  ...
  } = (0, _.ZP)(), c = null != (0, O.Z)(t, n), g = (0, v.Z)(t), [E, b] = i.useState(!1), [T, P] = i.useState(!1), D = T, x = i.useCallback(() => {
  ...
  return (0, r.jsxs)("div", {
    className: o()(R.topPerksCard, R.animatedTopPerksCard, C.powerupCard, {
      [R.animate]: E
    }),
    onMouseEnter: () => P(!0),
    onMouseLeave: () => P(!1),
  ...
  return 0 === d.length ? null : (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(l.X6, {
      ...
      children: N.intl.format(A.default.S562fn, {
        helpDeskArticle: g.Z.getArticleURL(S.BhN.GUILD_BOOSTING_FAQ)
      })
    }), (0, r.jsx)("div", {
