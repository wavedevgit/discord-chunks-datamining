...
function A(e) {
  let {
    guildId: t,
    powerup: n
  } = e, o = null != (0, m.Z)(t, n), [l, c] = i.useState(!1), [_, p] = i.useState(!1), h = _, g = i.useCallback(() => {}, []), I = i.useCallback(() => {}, []), T = {
    tension: 400,
    friction: 30
  }, A = (0, u.q_F)({
  ...
  return (0, r.jsxs)("div", {
    className: a()(y.topPerksCard, y.animatedTopPerksCard, v.powerupCard, {
      [y.animate]: l
    }),
    onMouseEnter: () => p(!0),
    onMouseLeave: () => p(!1),
    children: [(0, r.jsx)("div", {
      ...
      className: y.borderGlowOverlay
    }), (0, r.jsxs)(s.animated.div, {
      style: N(S({}, C), {
        transform: C.y.to(e => "translateY(".concat(e, "px)"))
      }),
      className: a()(y.contentContainer, v.contentContainer),
      children: [(0, r.jsx)(f.xm, {
        heading: n.title,
        description: n.description,
        label: b.NW.formatToPlainString(E.Z.QOacIS, {
          quantity: n.cost
        }),
        isEnabled: o
      }), (0, r.jsxs)(s.animated.div, {
...
let C = i.forwardRef((e, t) => {
  ...
  let {
    guild: o
  } = e, a = (0, h.Ek)(o, "GuildPowerupsMarketingPowerupCards");
  i.useEffect(() => {
  ...
  return a && 0 !== u.length ? (0, r.jsxs)("div", {
    ref: t,
