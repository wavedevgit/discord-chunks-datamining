...
class m {
  ...
  constructor() {
    h(this, "director", true), h(this, "applications", true), h(this, "streamKey", true), h(this, "mode", true), this.mode = null, this.applications = [], this.director = new s.d(e => this._onDirectorAction(e)), r.h.subscribe("STREAM_START", e => {
      let {
        streamType: t,
        guildId: n,
        channelId: r,
