/** Chunk was on 54157 **/
/** chunk id: 315322, original params: e,t,n (module,exports,require) **/
require.d(exports, {
  $z: () => T,
  I1: () => y,
  IZ: () => b,
...
function h(e) {
  var t, n, r;
  return null != (r = null == (n = (0, i.UP)(e)) || null == (t = n.trim()) ? true : t.length) ? r : 0
}
...
function x(e) {
  let {
    ...
    query: n,
    queryString: s
  } = e, l = Object.keys(n), a = l.reduce((e, t) => {
    let r = n[t];
    return e[t] = Array.isArray(r) ? r.length : 1, e
  }, {}), c = null != s ? (0, i.kG)(s) : [], f = 0, _ = 0, g = 0, S = 0, m = 0, y = 0, b = 0, E = 0, x = 0;
  c.forEach(e => {
    e.type === u.dCx.ANSWER_IN ? f++ : e.type === u.dCx.ANSWER_USERNAME_FROM ? _++ : e.type === u.dCx.ANSWER_USERNAME_MENTIONS ? g++ : e.type === u.dCx.ANSWER_HAS ? S++ : e.type === u.dCx.ANSWER_BEFORE ? m++ : e.type === u.dCx.ANSWER_ON ? y++ : e.type === u.dCx.ANSWER_AFTER ? b++ : e.type === u.dCx.ANSWER_PINNED ? E++ : e.type === u.dCx.ANSWER_AUTHOR_TYPE && x++
  });
