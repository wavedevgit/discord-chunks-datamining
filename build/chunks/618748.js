...
function L(e) {
  ...
  return (0, a.P)(n), t = o ? s === P.KsC.ROLE_SUBSCRIPTION_EMOJI ? S.ue.EMOJIS : S.ue.TIERS : S.ue.PAYMENT, (0, r.jsx)(x.l, {
    guildId: n.id,
    refetchOnMount: !0,
...
function M(e) {
  let t, {
    ...
    L = () => {
      ...
      }), (0, _.be)(n.id), (0, m.uL)(P.Z5c.CHANNEL(n.id, w.oC.ROLE_SUBSCRIPTIONS))
    };
