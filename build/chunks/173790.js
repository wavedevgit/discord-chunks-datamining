...
function N(e) {
  ...
  return r.useEffect(() => {
    ...
    ref: I,
    role: "region",
    "aria-label": x.intl.formatToPlainString(x.t["4OP4Ul"], {
      applicationName: L
    }),
...
function j(e) {
  ...
  }), a = (0, f.yJ)(n), u = null != a && null != a.activity_preview_video_asset_id ? (0, c.Z)(n.id, a.activity_preview_video_asset_id) : null;
  return (0, i.jsx)(C.Z, {
    context: t,
    application: n,
    imageCoverUrl: o.url,
