...
function E(e) {
  ...
  let {
    ...
    location: "AppLauncherApplicationViewScreen"
  }), Z = r.useRef(null), [k, M] = r.useState(!1), {
    iconURL: W,
    name: D
  } = r.useMemo(() => (0, _.sl)(S, {
    fakeAppIconURL: P,
    size: 84
  }), [S]), B = (0, d.PL)(!0, !0), U = (0, d.LD)(null == A ? void 0 : A.guild_id, !0), H = r.useMemo(() => (0, d.If)(n, S.id), [B, U, n, S.id]), V = !H.isGuildInstalled && !H.isUserInstalled;
  return r.useEffect(() => {
    V && d.ZP.queryInstallOnDemandApp(S.id, null == A ? void 0 : A.id)
  }, [S.id, null == A ? void 0 : A.id, V]), (0, i.jsxs)(a.u2D, {
