...
let I = {
  ...
  L = e => {
    ...
    } = (0, y.hr)(Z), V = null == F ? void 0 : F.heroBanner, U = l.useMemo(() => A(Z.rankedSkuIds), [t, A, Z.rankedSkuIds]), G = (0, C.a)()(U), z = (0, v.l)(G).slice(0, 4), q = (0, k.St)(z), Y = _ === P.AW.ORBS ? w.intl.string(w.t.hvVgAQ) : w.intl.formatToPlainString(w.t.wvKYCg, {
