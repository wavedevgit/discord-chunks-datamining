...
let T = {
  ...
  L = e => {
    ...
    return null == e ? T : {
      ...
      logoUrl: (0, C.uV)(null !== (r = null !== (n = e.heroLogo) && void 0 !== n ? n : e.logo) && void 0 !== r ? r : "", {
        size: x.n
      }),
  ...
  N = e => {
    let {
      ...
      heroBlock: s,
      tab: C
    } = e, x = (0, i.e7)([u.Z], () => u.Z.useReducedMotion), N = (0, i.e7)([f.Z], () => f.Z.isFocused()), P = (0, i.e7)([h.default], () => h.default.getCurrentUser()), w = (0, y.u)(), Z = l.useMemo(() => null != s ? s : L(a), [s, a]), {
    ...
    } = (0, S.hr)(Z), V = null == R ? void 0 : R.heroBanner, D = l.useMemo(() => w(Z.rankedSkuIds), [t, w, Z.rankedSkuIds]), U = (0, _.a)()(D), z = (0, v.l)(U).slice(0, 4), G = C === O.AW.ORBS ? I.NW.string(I.t.hvVgAQ) : I.NW.formatToPlainString(I.t.wvKYCg, {
      category_name: Z.name
    });
    return null != P && (t || Z !== T) ? (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [null == M || x || !N || A ? (0, r.jsx)("div", {
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: t ? (0, r.jsx)(r.Fragment, {
            ...
            children: z.map((e, t) => {
              ...
              return null == e || null == n ? null : (0, r.jsx)(p.k0, {
                newValue: {
                  tilePosition: t,
                  pageSection: "top 4",
                  categoryPosition: 0
