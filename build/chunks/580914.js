...
let N = {
  ...
  R = e => {
    let {
      ...
      heroBlock: s,
      tab: O
    } = e, j = (0, c.e7)([d.Z], () => d.Z.useReducedMotion), R = (0, c.e7)([m.Z], () => m.Z.isFocused()), Z = (0, c.e7)([h.default], () => h.default.getCurrentUser()), F = (0, S.u)(), D = (0, C.sp)(), H = l.useMemo(() => null != s ? s : A(a), [s, a]), {
    ...
    } = (0, k.hr)(H), q = null == W ? void 0 : W.heroBanner, K = l.useMemo(() => F(H.rankedSkuIds), [t, F, H.rankedSkuIds]), Y = (0, x.a)()(K), $ = (0, E.l)(Y).slice(0, 4), X = (0, T.St)($), J = O === I.AW.ORBS ? B.intl.string(B.t["1CdL8f"]) : B.intl.formatToPlainString(B.t.wvKYCg, {
    ...
    return null != Z && (t || H !== N) ? (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [null == z || j || !R || M ? (0, r.jsx)("div", {
