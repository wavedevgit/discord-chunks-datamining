...
let I = {
  ...
  N = e => {
    let {
      ...
      heroBlock: o,
      tab: _
    } = e, x = (0, s.e7)([d.Z], () => d.Z.useReducedMotion), N = (0, s.e7)([f.Z], () => f.Z.isFocused()), L = (0, s.e7)([p.default], () => p.default.getCurrentUser()), A = (0, k.u)(), R = l.useMemo(() => null != o ? o : T(a), [o, a]), {
    ...
    } = (0, y.hr)(R), V = null == F ? void 0 : F.heroBanner, U = l.useMemo(() => A(R.rankedSkuIds), [t, A, R.rankedSkuIds]), G = (0, C.a)()(U), z = (0, v.l)(G).slice(0, 4), q = (0, S.St)(z), Y = _ === P.AW.ORBS ? w.NW.string(w.t.hvVgAQ) : w.NW.formatToPlainString(w.t.wvKYCg, {
      category_name: R.name
    });
    return null != L && (t || R !== I) ? (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [null == M || x || !N || Z ? (0, r.jsx)("div", {
