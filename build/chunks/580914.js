...
let A = {
  ...
  R = e => {
    ...
    let {
      ...
      heroBlock: R,
      tab: F
    } = e, D = (0, c.e7)([d.Z], () => d.Z.useReducedMotion), H = (0, c.e7)([m.Z], () => m.Z.isFocused()), M = (0, c.e7)([h.default], () => h.default.getCurrentUser()), W = (0, E.u)(), V = (0, C.sp)(), U = l.useMemo(() => null != R ? R : w(j), [R, j]), {
