...
let B = {
  ...
  L = e => {
    let {
      ...
      heroBlock: s,
      tab: C
    } = e, v = (0, i.e7)([u.Z], () => u.Z.useReducedMotion), L = (0, i.e7)([f.Z], () => f.Z.isFocused()), N = (0, i.e7)([h.default], () => h.default.getCurrentUser()), w = (0, S.u)(), P = l.useMemo(() => null != s ? s : T(a), [s, a]), {
      isPreviewingStaticBanner: Z,
      bannerOverrides: A,
      bannerStyleOverrides: R,
      heroLogo: W,
      heroBannerStatic: H,
      heroBannerAnimated: F
    } = (0, j.hr)(P), M = null == A ? void 0 : A.heroBanner, V = l.useMemo(() => w(P.rankedSkuIds), [t, w, P.rankedSkuIds]), D = (0, _.l)(V).slice(0, 4), U = C === y.AW.ORBS ? E.NW.string(E.t.hvVgAQ) : E.NW.formatToPlainString(E.t.wvKYCg, {
      category_name: P.name
    });
    return null != N && (t || P !== B) ? (0, r.jsxs)("div", {
      className: o()(I.heroBlock, {
        [I.responsiveHero]: null == R ? void 0 : R.responsive
      }),
      children: [(0, r.jsxs)("div", {
        className: I.banner,
        style: (null == R ? void 0 : R.backgroundStyle) != null ? {
          background: R.backgroundStyle
        } : void 0,
        children: [null == F || v || !L || Z ? (0, r.jsx)("div", {
          ...
          className: o()(I.bannerShadow, I.left, {
          ...
          className: o()(I.bannerShadow, I.right, {
            [I.darker]: null == M ? void 0 : M.darker
          }),
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [t ? (0, r.jsx)("div", {
            ...
            className: I.heroHeaderBadgeLogoSummaryContainer,
            children: [null != P.unpublishedAt && (0, r.jsx)(d.IGR, {
              disableColor: !0,
