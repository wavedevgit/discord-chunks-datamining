...
let w = {
  ...
  D = e => {
    ...
    let {
      ...
      heroBlock: D,
      tab: M
    } = e, H = (0, c.e7)([p.Z], () => p.Z.useReducedMotion), W = (0, c.e7)([C.Z], () => C.Z.isFocused()), V = (0, c.e7)([_.default], () => _.default.getCurrentUser()), U = (0, x.u)(), G = (0, v.sp)(), {
      showBetaTag: z
    } = m.Z.useExperiment({
