...
function A(e) {
  let {
    ...
    currentUser: n,
    channel: A
  } = e, D = __OVERLAY__, L = (0, m.ZP)(t.id), M = (0, d.ZP)(), k = i.useRef(Date.now()), {
    analyticsLocations: U
  } = (0, h.ZP)(u.Z.USER_PROFILE_SIDEBAR), G = (0, f.ZB)({
    layout: "SIDEBAR",
    userId: t.id,
    channelId: A.id
  }), F = i.useRef(null), B = (0, c.Z)(F), H = (0, b.$m)(), z = (0, o.q_F)({
    opacity: +(null != H.interactionType),
    config: {
      duration: 150
    }
  }), V = e => {
    (0, _.openUserProfileModal)(R({
