...
let p = e => ({
  ...
  g = e => {
    let {
      ...
      selected: n,
      onError: c
    } = e, u = (0, l.e7)([o.Z], () => o.Z.getGuilds()), g = a.useMemo(() => Object.values(u).filter(h).map(p), [u]), m = a.useCallback(e => {
      let [t] = e;
      if (null == t || null == t.value) return null;
      let n = u[t.value];
      return null == n ? null : (0, r.jsx)(i.Z, {
        guild: n,
    ...
    return (a.useEffect(() => {
      ...
      null == n && t(g[0].value)
    }, [g, t, c, n]), g.length < 1) ? null : (0, r.jsx)(s.q4e, {
