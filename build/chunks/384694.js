...
let v = e => ({
  ...
  b = e => {
    let {
      ...
      onError: d,
      labelledBy: b
    } = e, _ = (0, a.e7)([u.Z], () => u.Z.getGuilds()), {
      selectedGuild: j,
      selectedGuildEmojis: O
    } = (0, a.cj)([u.Z, s.ZP], () => ({
      selectedGuild: null != n ? u.Z.getGuild(n) : void 0,
      selectedGuildEmojis: null != n ? s.ZP.getGuildEmojiOrUndefined(n) : void 0
    })), N = l.useMemo(() => Object.values(_).filter(x).map(v), [_]), E = l.useCallback(e => {
      let [t] = e;
    ...
    return l.useEffect(() => {
      N.length < 1 ? d(m.ze.NO_PERMISSIONS) : null != j && null != O && 1 > function(e, t) {
        let n = t.filter(t => !(0, c.Kt)(t, e.id)).length;
        return (0, h.y4)(e) - n
      }(j, O) ? d(g.evJ.TOO_MANY_EMOJI) : d(null)
    }, [N, d, j, O]), (0, r.jsx)(i.q4e, {
