...
function D(e) {
  let t = (0, a.e7)([_.Z], () => _.Z.getPremiumTypeSubscription()),
    n = (0, c.Vi)() ? N.Xh.PREMIUM_MONTH_TIER_2 : true,
    {
  ...
  if (null != L && !Object.values(N.Si).includes(L)) throw Error("subscriptionTier must be a premium subscription");
  let y = (0, u.ao)({
