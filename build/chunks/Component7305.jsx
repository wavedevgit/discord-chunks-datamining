...
function F(e) {
  ...
  let {
    ...
    giftMessage: G,
    giftRecipient: D
  } = (0, f.wD)(), z = H && (0, _.pO)(D) && U === m.h8.PLAN_SELECT;
  return (0, r.jsx)(v.Z, {
    ...
    children: (0, r.jsx)(g.PaymentModal, {
      ...
      analyticsObject: n,
      analyticsSourceLocation: a,
      analyticsSubscriptionType: k.NYc.PREMIUM,
      onComplete: s,
      transitionState: C,
      initialPlanId: c,
      giftMessage: G,
