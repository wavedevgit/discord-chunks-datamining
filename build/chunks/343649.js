...
async function eo(e, t) {
  ...
  return (0, P.W3)(e, n.map(e => e.id), t)
}
...
function ec(e) {
  let t, {
    ...
    eY = (0, I.V)(),
    eB = i.useMemo(() => null != eP && eI && eY ? (0, j.g)(eP, eU) : [{
  ...
  let [eq, e$] = i.useState(M.h8.PLAN_SELECT), eJ = i.useMemo(() => Date.now(), [eq]), eQ = i.useCallback((e, t) => {
    e$(e), ek(null);
    let n = Date.now();
    F.default.track(q.rMx.PAYMENT_FLOW_STEP, en(et({}, eK), {
  ...
  i.useEffect(() => {
    ...
    z.Z.hasFetchedSubscriptions() || (0, m.jg)(), (0, b.U)(en(et({}, eK), {
      guild_id: ec,
      application_id: eE
    })), null != eP && null != eP.renewalMutations && F.default.track(q.rMx.PREMIUM_GUILD_PENDING_MODAL, {
      location: P,
      guild_id: ec
    })
  });
  ...
  }, [eq, eQ, e9, eC, eP, ef, e3]), (0, C.bp)(eq, eC, eQ, e7), (0, M.dZ)(eq, e2, e7);
  ...
  if (eh) t = (0, r.jsx)(g.Vq, {
    ...
    if ((null == eP ? void 0 : eP.isPausedOrPausePending) && !eP.isPausedAllowsUpdatesButNotResume) t = (0, r.jsx)(E.hzk, {
      children: (0, r.jsx)("p", {
        className: ee.copy,
        children: Q.intl.string(Q.t.mOWsFx)
      })
    });
    else if (null != eP && null != eP.renewalMutations) t = (0, r.jsx)(E.hzk, {
    children: (0, r.jsx)("p", {
      className: ee.copy,
    ...
    switch (eq) {
      case M.h8.PLAN_SELECT:
        a()(null != ec, "Missing guildId"), a()(null != eg, "Missing nextPremiumSubscriptionPlan"), e = (0, r.jsx)(X.CP, {
          premiumSubscriptionPlan: eg,
          numGuildBoosts: eU,
          ...
          guildId: ec,
          priceOptions: o
        }), e9 && null != eP && null != eP.paymentGateway && (e = (0, r.jsxs)(r.Fragment, {
          children: [(0, r.jsx)(E.kzN, {
            className: ee.externalErrorBlock,
            children: Q.intl.format(Q.t["/m3Y3t"], {
              paymentGatewayName: J.Vz[eP.paymentGateway]
            })
          }), e]
        })), l = (0, r.jsx)(E.zxk, {
      ...
      case M.h8.AWAITING_AUTHENTICATION:
        ...
        break;
      case M.h8.REVIEW:
        a()(null != eg, "Missing nextPremiumSubscriptionPlan"), e = (0, r.jsx)(X.Gq, {
          paymentSources: eL,
          priceOptions: o,
          ...
          onClick: async () => {
            ...
            try {
              ...
              if (F.default.track(q.rMx.PAYMENT_FLOW_COMPLETED, en(et({}, eK), {
          ...
          children: e => (0, r.jsx)(E.zxk, en(et({}, e), {
            color: E.zxk.Colors.GREEN,
            onClick: () => {
              null != te.current && (te.current.scrollIntoView({
                behavior: "smooth"
              }), tn(!0))
            },
            type: "submit",
    ...
    t = eq === M.h8.ADD_PAYMENT_STEPS ? tu : (0, r.jsx)(R.Z, {
      ...
      body: e,
      footer: eq !== M.h8.CONFIRM ? (0, r.jsxs)(E.mzw, {
  ...
  let td = null;
  return eh || eq === M.h8.PREMIUM_UPSELL || (td = (0, r.jsx)(V.Z, {
    onClose: e5,
    currentStep: eq,
    purchaseState: e2
  })), (0, r.jsxs)(E.Y0X, {
