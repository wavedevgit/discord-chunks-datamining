...
function ec(e) {
  let t, {
    ...
    eG = (0, I.V)(),
    eF = i.useMemo(() => null != em && ey && eG ? (0, j.g)(em, ev) : [{
    ...
    } = (0, f.ZP)(c, y.Z.GUILD_BOOST_PURCHASE_MODAL),
    eV = i.useMemo(() => {
      var e, t;
      return {
        load_id: eY,
        ...
        subscription_plan_id: null != (t = null == (e = eF.find(e => {
          let {
            planId: t
          } = e;
          return $.Z1.has(t)
        })) ? void 0 : e.planId) ? t : $.Xh.PREMIUM_MONTH_GUILD,
        quantity: ev,
        location: m,
        source: er,
        location_stack: eH
  ...
  let [eX, eK] = i.useState(M.h8.PLAN_SELECT), eq = i.useMemo(() => Date.now(), [eX]), e$ = i.useCallback((e, t) => {
    eK(e), eM(null);
    let n = Date.now();
    G.default.track(q.rMx.PAYMENT_FLOW_STEP, en(et({}, eV), {
  ...
  i.useEffect(() => {
    ...
    (async () => {
      if (!0 === ez) try {
        ...
        e1(L.A.FAIL), o(n), G.default.track(q.rMx.PAYMENT_FLOW_FAILED, en(et({}, e), {
    ...
    z.ZP.hasFetchedSubscriptions() || (0, P.jg)(), (0, O.U)(en(et({}, eV), {
      guild_id: ec,
      application_id: eE
    })), null != em && null != em.renewalMutations && G.default.track(q.rMx.PREMIUM_GUILD_PENDING_MODAL, {
      location: m,
      guild_id: ec
    })
  });
  let [e0, e8] = i.useState(ei), [e3, e1] = i.useState(L.A.WAITING), [e2, e4] = i.useState(!0), e7 = () => {
    r(e3 === L.A.COMPLETED)
  ...
  }, [eX, e$, e6, eT, em, e_, e0]), (0, C.bp)(eX, eT, e$, e1), (0, M.dZ)(eX, e3, e1);
  ...
  if (eh) t = (0, l.jsx)(g.Vq, {
    onClose: e7
  });
  else if (eN && ey && eG && null != tt && "" !== tt)
    if ((null == em ? void 0 : em.isPausedOrPausePending) && !em.isPausedAllowsUpdatesButNotResume) t = (0, l.jsx)(E.hzk, {
      children: (0, l.jsx)("p", {
        className: ee.copy,
        children: Q.NW.string(Q.t.mOWsFx)
      })
    });
    else if (null != em && null != em.renewalMutations) t = (0, l.jsx)(E.hzk, {
    children: (0, l.jsx)("p", {
      className: ee.copy,
    ...
    switch (eX) {
      case M.h8.PLAN_SELECT:
        a()(null != ec, "Missing guildId"), a()(null != ef, "Missing nextPremiumSubscriptionPlan"), e = (0, l.jsx)(X.CP, {
          premiumSubscriptionPlan: ef,
          numGuildBoosts: ev,
          ...
          guildId: ec,
          priceOptions: o
        }), e6 && null != em && null != em.paymentGateway && (e = (0, l.jsxs)(l.Fragment, {
          children: [(0, l.jsx)(E.kzN, {
            className: ee.externalErrorBlock,
            children: Q.NW.format(Q.t["/m3Y3t"], {
              paymentGatewayName: J.Vz[em.paymentGateway]
            })
          }), e]
        })), r = (0, l.jsx)(E.zxk, {
      ...
      case M.h8.AWAITING_AUTHENTICATION:
        e = (0, l.jsx)(h.F, {
          className: ee.__invalid_body
        });
        break;
      case M.h8.REVIEW:
        a()(null != ef, "Missing nextPremiumSubscriptionPlan"), e = (0, l.jsx)(X.Gq, {
          paymentSources: ex,
          priceOptions: o,
        ...
        }), n = M.h8.PLAN_SELECT, i = eU ? (0, l.jsx)(E.zxk, {
          ...
          onClick: async () => {
            ...
            eM(null);
            try {
              if (e1(L.A.PURCHASING), ek(!0), a()(null != eL, "Missing paymentSourceId"), G.default.track(q.rMx.PAYMENT_FLOW_COMPLETED, en(et({}, eV), {
              ...
              e1(L.A.FAIL), eM(t), G.default.track(q.rMx.PAYMENT_FLOW_FAILED, en(et({}, eV), {
          ...
          children: e => (0, l.jsx)(E.zxk, en(et({}, e), {
            color: E.zxk.Colors.GREEN,
            onClick: () => {
    ...
    t = eX === M.h8.ADD_PAYMENT_STEPS ? tc : (0, l.jsx)(R.Z, {
      ...
      body: e,
      footer: eX !== M.h8.CONFIRM ? (0, l.jsxs)(E.mzw, {
  ...
  let ta = null;
  return eh || eX === M.h8.PREMIUM_UPSELL || (ta = (0, l.jsx)(V.Z, {
    onClose: e7,
    currentStep: eX,
    purchaseState: e3
  })), (0, l.jsxs)(E.Y0X, {
    transitionState: n,
    className: o()({
      [ee.planSelectStep]: eX === M.h8.PLAN_SELECT
    }),
    children: [ta, t]
  })
}
...
function ea(e) {
  let t = (0, p.e7)([z.ZP], () => z.ZP.getPremiumTypeSubscription()),
    ...
    } = (0, f.ZP)(y.Z.GUILD_BOOST_PURCHASE_MODAL);
  return (0, l.jsx)(f.Gt, {
    value: n,
