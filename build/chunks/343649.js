...
function ec(e) {
  let t, {
    ...
    eF = (0, I.V)(),
    eY = i.useMemo(() => null != em && ef && eF ? (0, j.g)(em, ew) : [{
    ...
    eX = i.useMemo(() => {
      ...
      return {
        ...
        subscription_plan_id: null != (t = null == (e = eY.find(e => {
          let {
            planId: t
          } = e;
          return $.Z1.has(t)
  ...
  let [eK, eq] = i.useState(M.h8.PLAN_SELECT), e$ = i.useMemo(() => Date.now(), [eK]), eJ = i.useCallback((e, t) => {
    eq(e), eL(null);
    let n = Date.now();
    G.default.track(q.rMx.PAYMENT_FLOW_STEP, en(et({}, eX), {
  ...
  i.useEffect(() => {
    ...
    (async () => {
      if (!0 === eG) try {
        ...
        e2(L.A.FAIL), o(n), G.default.track(q.rMx.PAYMENT_FLOW_FAILED, en(et({}, e), {
    ...
    z.ZP.hasFetchedSubscriptions() || (0, P.jg)(), (0, b.U)(en(et({}, eX), {
      guild_id: ec,
      application_id: eE
  ...
  }, [eK, eJ, e5, ej, em, eS, e8]), (0, C.bp)(eK, ej, eJ, e2), (0, M.dZ)(eK, e1, e2);
  ...
  if (eh) t = (0, l.jsx)(g.Vq, {
    ...
    switch (eK) {
      case M.h8.PLAN_SELECT:
        a()(null != ec, "Missing guildId"), a()(null != eI, "Missing nextPremiumSubscriptionPlan"), e = (0, l.jsx)(X.CP, {
          premiumSubscriptionPlan: eI,
          numGuildBoosts: ew,
          ...
          guildId: ec,
          priceOptions: o
        }), e5 && null != em && null != em.paymentGateway && (e = (0, l.jsxs)(l.Fragment, {
      ...
      case M.h8.AWAITING_AUTHENTICATION:
        ...
        break;
      case M.h8.REVIEW:
        a()(null != eI, "Missing nextPremiumSubscriptionPlan"), e = (0, l.jsx)(X.Gq, {
          paymentSources: eM,
          priceOptions: o,
        ...
        }), n = M.h8.PLAN_SELECT, i = eW ? (0, l.jsx)(E.zxk, {
          ...
          onClick: async () => {
            ...
            eL(null);
            try {
              if (e2(L.A.PURCHASING), eT(!0), a()(null != ek, "Missing paymentSourceId"), G.default.track(q.rMx.PAYMENT_FLOW_COMPLETED, en(et({}, eX), {
              ...
              e2(L.A.FAIL), eL(t), G.default.track(q.rMx.PAYMENT_FLOW_FAILED, en(et({}, eX), {
    ...
    t = eK === M.h8.ADD_PAYMENT_STEPS ? ta : (0, l.jsx)(R.Z, {
      ...
      body: e,
      footer: eK !== M.h8.CONFIRM ? (0, l.jsxs)(E.mzw, {
  ...
  let tu = null;
  return eh || eK === M.h8.PREMIUM_UPSELL || (tu = (0, l.jsx)(V.Z, {
    onClose: e6,
    currentStep: eK,
    purchaseState: e1
  })), (0, l.jsxs)(E.Y0X, {
    transitionState: n,
    className: o()({
      [ee.planSelectStep]: eK === M.h8.PLAN_SELECT
    }),
    children: [tu, t]
  })
}
