...
function eo(e) {
  let t, {
    ...
    ez = (0, I.V)(),
    eG = i.useMemo(() => null != eP && eS && ez ? (0, T.g)(eP, ev) : [{
    ...
    eH = i.useMemo(() => {
      ...
      return {
        ...
        subscription_plan_id: null !== (t = null === (e = eG.find(e => {
          ...
          return q.Z1.has(t)
        })) || void 0 === e ? void 0 : e.planId) && void 0 !== t ? t : q.Xh.PREMIUM_MONTH_GUILD,
        quantity: ev,
        location: m,
        source: en,
        location_stack: eB
  ...
  let [eV, eX] = i.useState(M.h8.PLAN_SELECT), eK = i.useMemo(() => Date.now(), [eV]), eq = i.useCallback((e, t) => {
    eX(e), ex(null);
    let n = Date.now();
    z.default.track(K.rMx.PAYMENT_FLOW_STEP, et(ee({}, eH), {
  ...
  i.useEffect(() => {
    ...
    (async () => {
      if (!0 === eW) try {
        ...
        e3(L.A.FAIL), o(n), z.default.track(K.rMx.PAYMENT_FLOW_FAILED, et(ee({}, e), {
    ...
    W.ZP.hasFetchedSubscriptions() || (0, P.jg)(), (0, O.U)(et(ee({}, eH), {
      guild_id: eo,
      application_id: ep
    })), null != eP && null != eP.renewalMutations && z.default.track(K.rMx.PREMIUM_GUILD_PENDING_MODAL, {
      location: m,
      guild_id: eo
    })
  });
  ...
  if (em) t = (0, r.jsx)(g.Vq, {
    onClose: e7
  });
  else if (eh && eS && ez && null != te && "" !== te) {
    if (null == eP ? void 0 : eP.isPausedOrPausePending) t = (0, r.jsx)(E.hzk, {
      children: (0, r.jsx)("p", {
        className: Q.copy,
      ...
      switch (eV) {
        case M.h8.PLAN_SELECT:
          a()(null != eo, "Missing guildId"), a()(null != ey, "Missing nextPremiumSubscriptionPlan"), e = (0, r.jsx)(V.CP, {
            premiumSubscriptionPlan: ey,
            numGuildBoosts: ev,
        ...
        case M.h8.AWAITING_AUTHENTICATION:
          ...
          break;
        case M.h8.REVIEW:
          a()(null != ey, "Missing nextPremiumSubscriptionPlan"), e = (0, r.jsx)(V.Gq, {
            paymentSources: eO,
            priceOptions: o,
            ...
            onClick: async () => {
              ...
              ex(null);
              try {
                if (e3(L.A.PURCHASING), eL(!0), a()(null != eM, "Missing paymentSourceId"), z.default.track(K.rMx.PAYMENT_FLOW_COMPLETED, et(ee({}, eH), {
                ...
                e3(L.A.FAIL), ex(t), z.default.track(K.rMx.PAYMENT_FLOW_FAILED, et(ee({}, eH), {
      ...
      t = eV === M.h8.ADD_PAYMENT_STEPS ? to : (0, r.jsx)(A.Z, {
        ...
        body: e,
        footer: eV !== M.h8.CONFIRM ? (0, r.jsxs)(E.mzw, {
  ...
  let ta = null;
  return em || eV === M.h8.PREMIUM_UPSELL || (ta = (0, r.jsx)(H.Z, {
    onClose: e7,
    currentStep: eV,
    purchaseState: e8
  })), (0, r.jsxs)(E.Y0X, {
    transitionState: n,
    className: o()({
      [Q.planSelectStep]: eV === M.h8.PLAN_SELECT
    }),
    children: [ta, t]
  })
}
