...
function u(e) {
  ...
  } = e, p = (0, a.e7)([s.Z], () => s.Z.useReducedMotion), [_, h] = i.useState(d), m = i.useRef((0, l._)(t, _)), [g, E] = i.useState(null == f), [b, y] = i.useState(false), [O, v] = i.useState(false), S = () => {
    m.current = (0, l._)(t, _), v(e => e + 1)
  }, I = () => {
