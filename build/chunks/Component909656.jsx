...
function T(e) {
  ...
  let {
    ...
    var e;
    return (null == m || null == (e = m.cover_image_asset) ? true : e.application_id) == null ? null : (0, b._W)(m.cover_image_asset.application_id, m.cover_image_asset, S)
  }, [m]), [T, P] = i.useState(a), [w, Z] = i.useState(null != (t = null == m ? true : m.description) ? t : ""), [R, D] = i.useState(j), [A, L] = i.useState(null == m ? true : m.store_page_guild_products_default_sort), [k, G] = i.useState(null == m ? true : m.server_shop_tab_order), {
    loading: M,
    error: U,
  ...
  function V(e, t) {
    s()(null != e, "Null value not allowed"), null != t && W(t.name), D(e)
  }
  let K = i.useMemo(() => {
      var e;
      return null != w && w !== (null != (e = null == m ? true : m.description) ? e : "") || (null == R ? true : R.startsWith("data:")) === true || T !== a || (null == m ? true : m.store_page_guild_products_default_sort) !== A || (null == m ? true : m.server_shop_tab_order) !== k
    }, [R, a, w, m, T, A, k]),
    Y = null != w && "" !== w && null != R;
  i.useEffect(() => {
    var e;
    (null == m || null == (e = m.cover_image_asset) ? true : e.application_id) != null && D((0, b._W)(m.cover_image_asset.application_id, m.cover_image_asset, S))
    ...
    children: [null != U && (0, r.jsxs)(r.Fragment, {
      ...
      children: K && (0, r.jsx)(p.oXn, {
        children: (0, r.jsx)(u.Z, {
          ...
          onReset: () => {
            var e;
            P(a), Z(null != (e = null == m ? true : m.description) ? e : ""), D(j), L(null == m ? true : m.store_page_guild_products_default_sort), G(null == m ? true : m.server_shop_tab_order)
          },
          onSave: () => {
            s()(null != m, "Settings must be defined");
            let e = {};
            w !== m.description && (e.description = w), null != R && R.startsWith("data:") && (e.cover_image = R), T !== a && (e.full_server_gate = T === y.e3.ALL_CHANNELS), A !== m.store_page_guild_products_default_sort && (e.store_page_guild_products_default_sort = A), k !== m.server_shop_tab_order && (e.server_shop_tab_order = k), o().isEmpty(e) || B(n.id, e)
          },
