...
function E(e) {
  let {
    ...
    title: r,
    description: s
  } = e, o = a.useMemo(() => 0 === n ? 16 : .5 === n ? 20 : 1 === n ? 24 : 16, [n]), m = a.useMemo(() => {
    switch (t) {
      case b.x0.KILL:
  ...
  return null != r || null != s ? null == r || null == s ? (0, l.jsx)(c.u, {
    text: null != r ? r : s,
    position: "top",
    children: h
  }) : (0, l.jsx)(u.i, {
...
function S(e) {
  let {
    ...
    }(0 === n.length || n[n.length - 1].time < t - 2) && n.push({
      time: t,
      position: 100
    });
    let a = [],
      i = e / 5;
    for (let e = i; e < t; e += i)
      if (!n.some(t => .01 > Math.abs(t.time - e))) {
        let n = e / t * 100;
        a.push({
          position: n
        })
  ...
  return (0, l.jsx)("div", {
    ...
    children: (0, l.jsxs)("div", {
      ...
      children: [s.map((e, t) => (0, l.jsx)("div", {
        className: k.timeSubNotch,
        style: {
          left: "".concat(e.position, "%")
        },
        children: (0, l.jsx)("div", {
          className: k.timeSubNotchTick
        })
      }, "sub-".concat(t))), r.map((e, t) => (0, l.jsxs)("div", {
        className: k.timeNotch,
        style: {
          left: "".concat(e.position, "%")
        },
        children: [(0, l.jsx)("div", {
          className: k.timeNotchTick
        }), (0, l.jsxs)(d.Text, {
...
function w(e) {
  ...
  let {
    ...
    var e;
    return null == i.timeline || (null == (e = i.decision) ? true : e.timestamp) == null ? [] : i.timeline.filter(e => e.signal.type === b.Bs.GAME_EVENT)
  }, [i.timeline, null == (t = i.decision) ? true : t.timestamp]), o = a.useCallback(e => {
    var t, n;
    if (null == r || r <= 0 || (null == (t = i.decision) ? true : t.timestamp) == null) return null;
    let l = (e - ((null == (n = i.decision) ? true : n.timestamp) - i.length)) / 1e3;
    return l < 0 || l > r ? null : l / r * 100
  }, [r, null == (n = i.decision) ? true : n.timestamp, i.length]);
...
function O(e) {
  ...
  let {
    ...
    var e;
    return null == i.timeline || (null == (e = i.decision) ? true : e.timestamp) == null ? [] : i.timeline.filter(e => e.signal.type === b.Bs.SOUNDBOARD && true === e.signal.playing)
  }, [i.timeline, null == (t = i.decision) ? true : t.timestamp]), o = a.useCallback(e => {
    var t, n;
    if (null == r || r <= 0 || (null == (t = i.decision) ? true : t.timestamp) == null) return null;
    let l = (e - ((null == (n = i.decision) ? true : n.timestamp) - i.length)) / 1e3;
...
function T(e) {
  ...
  let {
    ...
    var e;
    return null == i.timeline || (null == (e = i.decision) ? true : e.timestamp) == null ? [] : i.timeline.filter(e => e.signal.type === b.Bs.PHRASE)
  }, [i.timeline, null == (t = i.decision) ? true : t.timestamp]), o = a.useCallback(e => {
    var t, n;
    if (null == r || r <= 0 || (null == (t = i.decision) ? true : t.timestamp) == null) return null;
    let l = (e - ((null == (n = i.decision) ? true : n.timestamp) - i.length)) / 1e3;
  ...
  return (0, l.jsx)(l.Fragment, {
    children: s.map((e, t) => {
      let n = o(e.timestamp);
      return null == n ? null : (0, l.jsx)(u.i, {
...
let I = function(e) {
  let {
    ...
    subscribe: I,
    seek: P
  } = (0, y.D)(), A = u(), M = a.useRef(null), [D, U] = a.useState(false), [Z, z] = a.useState(null), B = a.useRef(null), V = a.useRef(null), [F, G] = a.useState(false), [_, K] = a.useState(null);
  a.useEffect(() => I({
    onPlay: () => {
      z(null), G(false)
    }
  ...
  let {
    ...
    width: H = 0,
    height: q = 0
  } = (0, h.ZP)(), Y = (0, o.e7)([v.Z], () => v.Z.windowSize());
  a.useMemo(() => {
    Y.width, Y.height;
    let e = W.current;
  ...
  let J = a.useRef(null),
    ...
    $ = a.useCallback((e, t) => {
      ...
      let n = ((0, s.clamp)(e, _.left, _.right) - _.left) / _.width * c,
        l = (0, s.clamp)(n, 0, c),
        a = Z;
      null == a && t && (a = l <= f ? "start" : l >= g ? "end" : "playhead", m && (T(), G(true)), z(a)), "start" === a ? E(l) : "end" === a ? w(l) : "playhead" === a && P((0, s.clamp)(l, f, g))
    }, [c, _, Z, f, g, m, T, E, w, P]),
    Q = a.useCallback(e => {
      if (null == c) return;
  ...
  a.useEffect(() => (document.addEventListener("mousemove", en), document.addEventListener("mouseup", el), () => {
    ...
    !async function() {
      ...
      let s = null == r ? true : r.getContext("2d", {
        willReadFrequently: true
      });
      if (null == s) return;
      let o = X.current;
      if ((null == (e = o[i]) ? true : e.length) === i) {
  ...
  return (0, l.jsx)("div", {
    ...
    children: (0, l.jsxs)("div", {
      ...
      children: [(0, l.jsxs)("div", {
        ...
        children: (0, l.jsxs)("div", {
          className: r()(k.timeline, {
            [k.timelineDragging]: null != Z
          }),
          onMouseDown: et,
          children: [(0, l.jsx)("canvas", {
            ...
            children: (0, l.jsx)("div", {
              ...
              style: {
                left: null != c && c > 0 ? "".concat(A / c * 100, "%") : 0
              }
            })
          }), (0, l.jsx)(p.Z, {
            preload: "auto",
            ...
            children: [(0, l.jsx)(d.tEY, {
              children: (0, l.jsx)("button", {
                ...
                children: (0, l.jsx)("div", {
                  className: k.cropLeftArrow
                })
              })
            }), (0, l.jsx)(d.tEY, {
              children: (0, l.jsx)("button", {
                className: r()(k.dragHandleRight, {
                  [k.dragging]: "end" === Z
                }),
                onMouseDown: et,
                onKeyDown: ee,
...
function R(e) {
  ...
  return t = t < 10 ? "0" + t : t, n = n < 10 ? "0" + n : n, l = l < 10 ? "0" + l : l, "".concat(t, ":").concat(n, ".").concat(l)
}

function L(e) {
  let t = Math.floor(e / 60),
    n = C.intl.formatToPlainString(C.t.iXLF9W, {
      minutes: t
    }),
    l = C.intl.formatToPlainString(C.t.geSp4K, {
      seconds: e % 60
    });
