...
function O(e) {
  ...
  })) ? void 0 : I.rawValue, z = null != V ? V.split(",") : [], W = (0, a.Wu)([_.default], () => z.map(e => _.default.getUser(e)).filter(Boolean)), K = L && null != U ? E.intl.formatToPlainString(E.t["er/cHx"], {
    username: B
  }) : E.intl.formatToPlainString(E.t.noNjkZ, {
    username: F.nick
  }), Y = null != R && null != k, X = null;
  X = Y ? L || H ? E.intl.format(E.t.CaLQqK, {
  ...
  }) : E.intl.string(E.t["tHT/Vl"]), 0 === G.length && (X = L ? E.intl.string(E.t.IE2uZW) : E.intl.string(E.t.QVhmGx));
  let q = L ? E.intl.string(E.t["00XIbm"]) : E.intl.string(E.t["7CrE9/"]);
  return (0, r.jsxs)("div", {
