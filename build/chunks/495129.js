...
function O(e) {
  ...
  })) ? void 0 : I.rawValue, z = null != V ? V.split(",") : [], W = (0, a.Wu)([_.default], () => z.map(e => _.default.getUser(e)).filter(Boolean)), K = L && null != U ? v.intl.formatToPlainString(v.t["er/cHx"], {
    username: B
  }) : v.intl.formatToPlainString(v.t.noNjkZ, {
    username: F.nick
  }), Y = null != R && null != k, X = null;
  X = Y ? L || H ? v.intl.format(v.t.CaLQqK, {
  ...
  }) : v.intl.string(v.t["tHT/Vl"]), 0 === G.length && (X = L ? v.intl.string(v.t.IE2uZW) : v.intl.string(v.t.QVhmGx));
