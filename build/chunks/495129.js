...
function O(e) {
  ...
  let {
    ...
    return "channel_id" === t
  })) ? void 0 : O.rawValue, R = (0, a.e7)([g.Z], () => g.Z.getGuild(w)), k = (0, a.e7)([h.Z], () => h.Z.getChannel(Z)), L = (0, a.e7)([_.default], () => _.default.getCurrentUser()), D = (0, a.e7)([], () => P.author.id === (null == L ? void 0 : L.id)), M = null == (S = A.recipients) ? void 0 : S.find(e => e !== P.author.id), U = (0, a.e7)([_.default], () => null != M ? _.default.getUser(M) : null), F = (0, d.ZP)(P), B = (0, y._T)(A.getGuildId(), A.id, U), G = (0, a.Wu)([b.ZP], () => null != k ? b.ZP.getVoiceStatesForChannel(k) : [], [k]), H = G.some(e => e.user.id === (null == L ? void 0 : L.id)), V = null == (T = P.embeds[0]) || null == (N = T.fields) || null == (I = N.find(e => {
    let {
      rawName: t
    } = e;
