  ...
  constructor(...e) {
    super(...e), R(this, "state", {
      ...
      if (t.isModeratorReportChannel()) return void(0, u.jW)(e, async () => {
        let {
          default: e
        } = await n.e("52202").then(n.bind(n, 466676));
        return n => (0, r.jsx)(e, L(D({}, n), {
          channel: t
        }))
      });
...
function G(e) {
  ...
  })), g = (0, a.e7)([E.ZP], () => E.ZP.resolveUnreadSetting(t)), m = (0, a.cj)([y.Z, j.Z], () => {
  ...
  } = (0, b.Z)(t.id), I = (0, a.e7)([E.ZP], () => E.ZP.isFavorite(n.id, t.id)), N = (0, h.$5)(t), Z = (0, p.NX)(t.id), A = (0, P.Z)({
    channel: t,
