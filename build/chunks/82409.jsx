...
require("./100527.js"), require("./906732.js");
var Chunk377171 = require("./377171.js"),
  Chunk315174 = require("./315174.js"),
  ...
  Chunk862149 = require("./862149.js"),
  Chunk207913 = require("./207913.js"),
  Chunk553984 = require("./553984.js"),
  Chunk333834 = require("./333834.js"),
...
function U(e) {
  ...
  return <nav className={o()(L.container, {
      [L.panelSpacing]: l
    })}><c.y5t forceLevel={1} component={(0, r.jsx)(f.ZP, (t = M({
        hasSubheader: true,
        guild: ee
      }, k), n = n = {
      ...
      }), t))}>{Q === v.v8.TABS && <Z.Z />}{p === A.V5.ALL && <H hideBanner={!G || p !== A.V5.ALL} />}{$ && <z filter={p} />}{<T.Z className={L.messageList} renderMessageGroup={F} messages={p === A.V5.BOOKMARKS ? Y : q} unreadMessages={p === A.V5.BOOKMARKS ? [] : X} listName={"notifications-inbox"} renderLoadingState={V} ignoreGrouping={p === A.V5.BOOKMARKS} loadMore={U} />}</c.y5t></nav>
}

function G(e) {
  return <E.HP><U{...M({}, e)} /></E.HP>
}
...
function V() {
  return <Chunk862149.Z />
}

function F(e, t) {
  return <w.Z message={e[0]} groupedMessages={e.slice(1)} isUnread={t} />
}
...
function H(e) {
  ...
  return <div className={o()(L.caughtUpContainer, {
      [L.hide]: n || t
    })}><div className={L.caughtUpContent}>{<c.Text variant={"text-sm/medium"} color={"text-feedback-positive"} className={L.caughtUpText}>{D.intl.string(D.t["6XMM+P"])}</c.Text>}{<c.W6s size={"sm"} color={p.Z.TEXT_FEEDBACK_POSITIVE} />}</div></div>
}
...
function z(e) {
  ...
  return <c.X6q color={"text-primary"} variant={"text-sm/semibold"} className={L.filterHeaderWrap}>{n[t]}</c.X6q>
}