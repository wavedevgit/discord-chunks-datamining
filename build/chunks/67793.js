/** Chunk was on 91584 **/
/** chunk id: 67793, original params: t,e,r (module,exports,require) **/
"use strict";
var Chunk381538 = require("./381538.js"),
  Chunk607488 = require("./607488.js"),
  Chunk647438 = require("./647438.js"),
  Chunk581079 = require("./581079.js"),
  Chunk205558 = require("./205558.js"),
  s = require("./174466.js").setDraftEditorSelection;
  ...
  return r._setSelection = function() {
    ...
    if (null != e && e.getHasFocus()) {
      ...
      if (e.hasEdgeWithin(c, i, l)) {
        ...
        f || a(false);
        var p = f.firstChild;
        p || a(false), p.nodeType === Node.TEXT_NODE ? t = p : u(p) ? t = f : (t = p.firstChild) || a(false), s(e, t, c, i, l)
      }
    }
