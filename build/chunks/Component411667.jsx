...
function c(e) {
  ...
  let h = null;
  return null != m ? h = m : g ? h = s.intl.string(s.t.MyJpJT) : null != f ? (h = f, t = s.intl.string(s.t["YKw/NQ"])) : p ? h = s.intl.string(s.t.e2g9sW) : b && (h = s.intl.string(s.t.rxI9sl)), null != h ? (0, r.jsx)("div", {
    className: o.noticeContainer,
