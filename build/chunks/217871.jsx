...
let I = 1e3,
  ...
  S = Chunk73800.memo(function(e) {
    ...
    return null != a && <s.animated.div className={v.messageComboScore} style={p}><c.Text className={v.comboScore} variant={"text-sm/bold"}>{(0, b.Eo)(a.combo)}</c.Text></s.animated.div>
  }),
  A = Chunk73800.memo(function(e) {
    ...
    return <r.Fragment>{<c.Text className={v.comboValue} variant={"text-sm/bold"}>{t}</c.Text>}{<div className={v.comboNameplate} style={{
          color: u
        }}>{<c.Text className={v.comboMultiplier} style={{
            color: u
          }} variant={"text-sm/bold"}>{O.intl.format(O.t["6bgVlp"], {
            multiplier: n
          })}</c.Text>}{s && <r.Fragment>{<div className={a()(v.comboSquare, v.left)} style={{
              backgroundColor: u
            }} />}{<div className={a()(v.comboSquare, v.right)} style={{
              backgroundColor: u
            }} />}</r.Fragment>}{l && <r.Fragment>{<div className={a()(v.confettiIcon, v.left)}><h.Z width={24} height={24} /></div>}{<div className={a()(v.confettiIcon, v.right)}><h.Z width={24} height={24} /></div>}</r.Fragment>}{1 === n && <c.Text className={v.tip} variant={"text-sm/bold"}>{O.intl.string(O.t.b5Cpoa)}</c.Text>}</div>}</r.Fragment>
  }),
  N = Chunk73800.memo(function(e) {
    ...
    return <r.Fragment>{<S channelId={t} width={h} />}{<s.animated.div ref={f} className={v.combo} style={N}><A value={w} multiplier={P} /></s.animated.div>}</r.Fragment>
  })