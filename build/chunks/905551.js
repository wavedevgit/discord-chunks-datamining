...
function h(e) {
  ...
  let r = null != (n = null == (t = i.default.getCurrentUser()) ? true : t.isStaff()) && n;
  return (0, s.Kb)({
...
function g(e, t) {
  return a.tn.get({
    ...
    if (null != n.body) {
      var a, i, r, s;
      let o = null != (s = null == (r = n.body.tenant_metadata) || null == (i = r.guild_monetization) || null == (a = i.game_server) ? true : a.instructions.pc) ? s : [];
      l.Z.dispatch({
