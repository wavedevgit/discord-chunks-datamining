...
function h(e) {
  ...
  let l = null != (n = null == (t = r.default.getCurrentUser()) ? true : t.isStaff()) && n;
  return (0, s.Kb)({
...
function g(e, t) {
  return a.tn.get({
    ...
    if (null != n.body) {
      var a, r, l, s;
      let o = null != (s = null == (l = n.body.tenant_metadata) || null == (r = l.guild_monetization) || null == (a = r.game_server) ? true : a.instructions.pc) ? s : [];
      i.Z.dispatch({
