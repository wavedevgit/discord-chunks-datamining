...
function C(e) {
  ...
  let {
    ...
    className: D,
    onNavigate: b
  } = e, L = l.useRef(null), x = (0, o.e7)([m.ZP], () => m.ZP.getGuildSidebarState(C), [C]), U = l.useRef(0), [M, P] = l.useState(null != (t = null == x ? void 0 : x.details.additionalSearchQuery) ? t : {}), j = (0, N.z0)(s, C, {
    addtionalQuery: M,
    shouldDispatch: !0
