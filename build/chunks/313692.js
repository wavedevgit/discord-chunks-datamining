...
function b(A) {
  ...
  let {
    ...
    className: O,
    onNavigate: P
  } = A, V = r.useRef(null), j = (0, a.e7)([u.ZP], () => u.ZP.getGuildSidebarState(b), [b]), T = r.useRef(0), [y, m] = r.useState(null != (e = null == j ? void 0 : j.details.additionalSearchQuery) ? e : {}), L = (0, w.z0)(l, b, {
    addtionalQuery: y,
    shouldDispatch: !0
  }), x = (0, a.e7)([C.default], () => C.default.getUser(l), [l]), Z = (0, a.e7)([d.ZP], () => d.ZP.getMember(b, l), [b, l]);
  (0, g.Ng)(() => {
  ...
  let N = r.useCallback(A => {
      null != j && (T.current = A.target.scrollTop, (0, B.r)(b, l, j.baseChannelId, {
  ...
  return null == x || null == Z || null == F ? null : (0, n.jsxs)("div", {
