...
function p(e) {
  ...
  let {
    ...
    className: U,
    onNavigate: L
  } = e, v = l.useRef(null), b = (0, o.e7)([I.ZP], () => I.ZP.getGuildSidebarState(p), [p]), M = l.useRef(0), [x, P] = l.useState(null != (t = null == b ? void 0 : b.details.additionalSearchQuery) ? t : {}), j = (0, O.z0)(i, p, {
    addtionalQuery: x,
    shouldDispatch: !0
  }), y = (0, o.e7)([m.default], () => m.default.getUser(i), [i]), G = (0, o.e7)([g.ZP], () => g.ZP.getMember(p, i), [p, i]);
  (0, c.Ng)(() => {
  ...
  let w = l.useCallback(e => {
      null != b && (M.current = e.target.scrollTop, (0, N.r)(p, i, b.baseChannelId, {
  ...
  return null == y || null == G || null == Z ? null : (0, r.jsxs)("div", {
