...
function x(e) {
  ...
  }), null != e.relationship.nickname && (E = m(p({}, E), {
    [e.relationship.id]: e.relationship.nickname
  })), null != e.relationship.since && (v = m(p({}, v), {
    [e.relationship.id]: e.relationship.since
  })), null != e.relationship.originApplicationId && (I = m(p({}, I), {
...
function j(e) {
  g = p({}, g), u.default.keys(g).forEach(e => {
