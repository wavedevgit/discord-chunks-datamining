...
function h(e) {
  ...
  return <f.C3>{<d.Z />}{<u.Z />}{<div className={p.confirmation}>{<s.X6q variant={"heading-xxl/bold"} className={p.confirmationHeader}>{"Success!"}</s.X6q>}{<s.Text variant={"text-md/normal"}>{y}</s.Text>}{<div className={p.divider} />}{<a.z onClick={n} text={_.intl.string(_.t.cpT0Cg)} fullWidth={true} />}</div>}</f.C3>
}