...
let x = e => {
  ...
  let {
    className: n
  } = e, i = (0, a.e7)([c.default], () => c.default.getCurrentUser()), x = (0, a.e7)([o.default], () => o.default.locale), j = (0, a.e7)([u.Z], () => u.Z.getPremiumTypeSubscription()), v = (0, a.e7)([d.Z], () => null != j ? d.Z.get(j.planId) : true), _ = null != (t = (0, a.e7)([d.Z], () => null != v ? d.Z.getForSkuAndInterval((0, g.Wz)(f.Si.GUILD), v.interval, v.intervalCount) : true)) ? t : f.GP[f.Xh.PREMIUM_MONTH_GUILD];
  return (0, r.jsxs)("div", {
