...
let v = Chunk73800.forwardRef(function(e, t) {
  ...
  return T === _.lY.MODAL || T === _.lY.MODAL_V2 || (null == A ? true : A.userId) == null ? <article aria-label={O} aria-labelledby={v}><d.Z.Overlay{...b(g({
      ref: t,
      className: a()(h.card, i)
    }, I), {
      children: n
    })} /></article> : <article aria-labelledby={v}><s.kL8 className={h.clickableContainer} aria-label={p.intl.string(p.t.pD1L1t)} focusProps={{
        ringTarget: t
      }} onClick={() => {
        null == m || m({
          action: "PRESS_CARD"
