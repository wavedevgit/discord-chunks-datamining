...
function v(e) {
  ...
  return (0, r.jsx)(o.ua7, {
    ...
    onTooltipShow: () => u(!0),
    onTooltipHide: () => u(!1),
    children: e => (0, r.jsx)(o.P3F, O(_({}, e), {
      className: b.action,
      onClick: e => {
        (0, p.Qz)({
          message: l,
...
function j(e) {
  let {
    ...
    Menu: s,
    interactionType: c
  } = e, u = (0, p.fJ)(), [d, h] = (0, i.useState)(!1), [f, g] = (0, i.useState)(!1), m = (0, i.useRef)(null);
  return (0, r.jsx)(o.yRy, {
    ...
    children: e => (0, r.jsx)(o.ua7, {
      ...
      onTooltipShow: () => h(!0),
      onTooltipHide: () => h(!1),
      children: t => (0, r.jsx)(o.P3F, O(_({}, t), {
        innerRef: m,
        className: b.action,
        onClick: e => {
          (0, p.Qz)({
...
function x(e) {
  ...
  return (0, r.jsx)(o.Kqy, {
    ...
    children: l.map(e => {
      ...
      switch (i.type) {
        case "standard":
          return (0, r.jsx)(v, O(_({}, i), {
            message: t
          }), e);
        case "menu":
          return (0, r.jsx)(j, O(_({}, i), {
            channel: n,
            message: t
          }), e)
      }
