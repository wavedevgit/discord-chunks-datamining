...
function E(e) {
  ...
  return (0, r.jsx)(o.ua7, {
    ...
    onTooltipShow: () => u(!0),
    onTooltipHide: () => u(!1),
    children: e => (0, r.jsx)(o.P3F, C(y({}, e), {
      className: O.action,
      onClick: e => {
        (0, p.Qz)({
          message: l,
...
function S(e) {
  let {
    ...
    interactionType: c,
    actionType: u
  } = e, d = (0, p.fJ)(), [h, f] = (0, i.useState)(!1), [m, b] = (0, i.useState)(!1), _ = (0, i.useRef)(null), {
    openMenu: v,
    closeMenu: j
  } = (0, g.z)(), E = () => {
    let e = !m;
  ...
  return (0, r.jsx)(o.yRy, {
    ...
    children: e => (0, r.jsx)(o.ua7, {
      ...
      onTooltipShow: () => f(!0),
      onTooltipHide: () => f(!1),
      children: t => (0, r.jsx)(o.P3F, C(y({}, t), {
        innerRef: _,
        className: O.action,
        onClick: e => {
          (0, p.Qz)({
...
function P(e) {
  ...
  return (0, r.jsx)(o.Kqy, {
    ...
    children: l.map(e => {
      ...
      switch (i.type) {
        case "standard":
          return (0, r.jsx)(E, C(y({}, i), {
            actionType: e,
            message: t
          }), e);
        case "menu":
          return (0, r.jsx)(S, C(y({}, i), {
            actionType: e,
            channel: n,
            message: t
          }), e)
