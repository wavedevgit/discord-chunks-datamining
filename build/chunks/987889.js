...
function O(e) {
  ...
  return (0, r.jsx)(o.ua7, {
    ...
    position: "top",
    spacing: 4,
    children: e => (0, r.jsx)(o.P3F, m(g({}, e), {
      className: f.action,
      onMouseEnter: () => u(!0),
      onMouseLeave: () => u(!1),
      onClick: e => {
...
function v(e) {
  let {
    ...
    Menu: a,
    interactionType: c
  } = e, [u, d] = (0, i.useState)(!1), [p, b] = (0, i.useState)(!1), y = (0, i.useRef)(null);
  return (0, r.jsx)(o.yRy, {
    ...
    children: e => (0, r.jsx)(o.ua7, {
      ...
      position: "top",
      spacing: 4,
      children: t => (0, r.jsx)(o.P3F, m(g({}, t), {
        innerRef: y,
        className: f.action,
        onMouseEnter: () => d(!0),
        onMouseLeave: () => d(!1),
        onClick: e => {
          (0, h.Qz)({
            message: n,
            interactionType: c
          }), e.stopPropagation(), b(!p)
        },
        children: (0, r.jsx)(s, m(g({}, e), {
          message: n,
          "aria-label": l,
          className: f.actionIcon,
          size: u ? "sm" : "xs"
...
function j(e) {
  ...
  return (0, r.jsx)(o.Kqy, {
    ...
    children: l.map(e => {
      ...
      switch (i.type) {
        case "standard":
          return (0, r.jsx)(O, m(g({}, i), {
            message: t
          }), e);
        case "menu":
          return (0, r.jsx)(v, m(g({}, i), {
            channel: n,
            message: t
          }), e)
      }
