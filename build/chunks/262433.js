...
function h(e) {
  ...
  let Z = s.Z.getEmojiImage(null != (n = null != (t = a.emojiId) ? t : a.emojiName) ? n : ""),
    ...
    {
      outlineColor: R
    } = (0, d.bg)(a.userId, b, I, v);
  g(a, e => {
      e.x += e.xSpeed * window.devicePixelRatio, e.y += e.ySpeed * window.devicePixelRatio, e.opacity -= e.opacitySpeed, e.opacity <= 0 && (0, u.j)(() => {
    ...
    function(e, t, n) {
      ...
      let a = null != (r = E.getState().lastSpawned[e.id]) ? r : 0,
        o = Date.now();
      !(a + 100 > o) && e.state !== c.f.STOP && (.8 >= Math.random() || a + 300 < o) && (0, u.j)(() => {
        E.setState(r => {
          var a;
    ...
    }(a, A, N), (0, f.I)(h, A, N, R, m.q2), (0, f.T)(h, A, N, a.userId), g(a, e => (function(e, t, n) {
      if (null == t) return;
    ...
    })(h, Z, e)), a.lastUpdatedAt + m.FO < Date.now() && (0, o.ZZ)(_, a), a.state !== c.f.STOP || Object.keys(null != (r = E.getState().particles[a.id]) ? r : {}).length > 0 || y.push(a), h.restore()
}