...
function p(t) {
  ...
  return n ? e ? null : <l.sNh id={"uninstall"} label={b.intl.string(b.t.DwgfOD)} action={() => (0, a.W)(t.id, t.branchId, d.Sbl.APPLICATION_CONTEXT_MENU_TOGGLE_INSTALL)} /> : null == p ? null : <l.sNh id={"install"} label={b.intl.string(b.t["N+XVnp"])} action={() => s.installApplication(t.id, t.branchId, d.Sbl.APPLICATION_CONTEXT_MENU_TOGGLE_INSTALL)} />
}