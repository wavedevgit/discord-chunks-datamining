...
function T(e) {
  ...
  } = e, L = (0, d.Z)(v), [R, D] = a.useState(!1), [P, B] = a.useState(null), [F, M] = a.useState(s().shuffle(v)), [U, w] = a.useState(""), [H, Z] = a.useState(!1), $ = (0, b.Dt)(), Y = (0, f.Z)(R), G = (0, f.Z)(P), z = (0, f.Z)(C), K = (0, f.Z)(U), W = (0, f.Z)(H), V = null != P ? y[P] : null, X = null != V;
  return a.useEffect(() => {
    ...
    transitionState: T,
    "aria-labelledby": $,
    children: [(0, l.jsx)(E.Z, {}), (0, l.jsxs)(u.xBx, {
      separator: !1,
