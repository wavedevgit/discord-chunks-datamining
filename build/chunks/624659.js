...
function N(e) {
  ...
  } = e, I = (0, d.Z)(x), [B, L] = l.useState(!1), [M, R] = l.useState(null), [F, D] = l.useState(s().shuffle(x)), [w, z] = l.useState(""), [H, P] = l.useState(!1), Y = (0, m.Dt)(), U = (0, h.Z)(B), W = (0, h.Z)(M), K = (0, h.Z)(j), X = (0, h.Z)(w), G = (0, h.Z)(H), J = null != M ? S[M] : null, V = null != J;
  return l.useEffect(() => {
    ...
    transitionState: N,
    "aria-labelledby": Y,
    children: [(0, a.jsx)(b.Z, {}), (0, a.jsxs)(c.xBx, {
      separator: !1,
