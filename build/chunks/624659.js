...
function N(e) {
  ...
  let {
    ...
    onSubmit: I,
    onClose: k,
    canDismissForever: D = !0,
    showHelpdeskLink: R = !0
  } = e, L = (0, b.Z)(v), [P, B] = a.useState(!1), [A, U] = a.useState(null), [F, w] = a.useState(s().shuffle(v)), [M, Z] = a.useState(""), [$, H] = a.useState(!1), z = (0, O.Dt)(), G = (0, h.Z)(P), K = (0, h.Z)(A), Y = (0, h.Z)(I), Q = (0, h.Z)(M), V = (0, h.Z)($), W = null != A ? T[A] : null, X = null != W;
  return a.useEffect(() => {
    ...
    children: [(0, l.jsx)(_.Z, {}), (0, l.jsxs)(d.xBx, {
      separator: !1,
