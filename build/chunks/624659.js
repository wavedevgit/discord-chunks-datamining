...
function T(e) {
  ...
  } = e, D = (0, b.Z)(v), [L, P] = a.useState(!1), [B, F] = a.useState(null), [M, U] = a.useState(s().shuffle(v)), [w, H] = a.useState(""), [Z, $] = a.useState(!1), Y = (0, f.Dt)(), G = (0, O.Z)(L), z = (0, O.Z)(B), K = (0, O.Z)(k), V = (0, O.Z)(w), W = (0, O.Z)(Z), Q = null != B ? x[B] : null, X = null != Q;
  return a.useEffect(() => {
    ...
    children: [(0, l.jsx)(E.Z, {}), (0, l.jsxs)(c.xBx, {
      separator: !1,
