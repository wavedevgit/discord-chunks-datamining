...
function E(e) {
  ...
  } = e, P = (0, d.Z)(p), [Z, w] = o.useState(!1), [B, D] = o.useState(null), [M, R] = o.useState(s().shuffle(p)), [L, F] = o.useState(""), [z, H] = o.useState(!1), U = (0, f.Dt)(), Y = (0, m.Z)(Z), K = (0, m.Z)(B), W = (0, m.Z)(N), G = (0, m.Z)(L), X = (0, m.Z)(z), J = null != B ? S[B] : null, V = null != J;
  return o.useEffect(() => {
    ...
    transitionState: E,
    "aria-labelledby": U,
    children: [(0, r.jsx)(h.Z, {}), (0, r.jsxs)(c.xBx, {
      separator: !1,
