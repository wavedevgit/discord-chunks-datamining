...
function k(e) {
  ...
  } = e, Z = (0, d.Z)(_), [A, B] = a.useState(!1), [L, W] = a.useState(null), [D, U] = a.useState(s().shuffle(_)), [P, F] = a.useState(""), [V, z] = a.useState(!1), M = (0, x.Dt)(), G = (0, N.Z)(A), w = (0, N.Z)(L), X = (0, N.Z)(O), K = (0, N.Z)(P), H = (0, N.Z)(V), q = null != L ? v[L] : null, J = null != q;
  return a.useEffect(() => {
