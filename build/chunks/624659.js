...
function y(e) {
  ...
  } = e, D = (0, b.Z)(v), [L, P] = a.useState(!1), [B, U] = a.useState(null), [F, M] = a.useState(s().shuffle(v)), [w, H] = a.useState(""), [Z, $] = a.useState(!1), G = (0, _.Dt)(), Y = (0, f.Z)(L), z = (0, f.Z)(B), K = (0, f.Z)(k), W = (0, f.Z)(w), V = (0, f.Z)(Z), Q = null != B ? C[B] : null, X = null != Q;
  return a.useEffect(() => {
    ...
    children: [(0, l.jsx)(E.Z, {}), (0, l.jsxs)(d.xBx, {
      separator: !1,
