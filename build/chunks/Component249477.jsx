...
class er extends Chunk64700.PureComponent {
  componentDidUpdate(e) {
    ...
    if (e.voiceChannelId !== g && null != e.voiceChannelId) {
      ...
      (null == a ? true : a.channelId) !== e.voiceChannelId && (a = null), X.default.track(J.HAw.LEAVE_VOICE_CHANNEL, et({
      ...
      }, (0, f.JK)(e.voiceChannelGuildId, e.voiceChannelId, e.videoEnabled), null == a || null == (l = a.voiceStateAnalytics) ? true : l.getStats(), b.A.getSelectedParticipantStats(e.voiceChannelId)))
    }
    if (e.voiceChannelId !== g && null != g) {
      ...
      (0, f.zV)(J.HAw.CHANNEL_OPENED, et({}, (0, f.qL)(g))), (0, A.k)(J.HAw.CHANNEL_OPENED_CLICKSTREAM, {
        channelId: g
      });
      let i = null,
        l = Q.default.getFocusedPID();
      null != l && x.default.getOverlayMethod(l) !== j.Ue.Disabled && (Q.default.isInstanceLocked() ? i = J.Xmn.OVERLAY_LOCKED_ACTIVATED : Q.default.isInstanceLocked() || (i = Q.default.isPinned(J.uss.TEXT) ? J.Xmn.OVERLAY_UNLOCKED_PINNED : J.Xmn.OVERLAY_UNLOCKED)), X.default.track(J.HAw.JOIN_VOICE_CHANNEL, et({
        location: i,
        channel_id: g,
        channel_type: v,
        channel_bitrate: C,
    ...
    if (e.runningGame !== P && null != P && !P.isLauncher && (!K || z)) {
      ...
      let f = x.default.getTrackedGameByPid(P.pid),
        h = (0, y.hw)(P),
        A = {
          enabledOOP: null != (a = null == f ? true : f.oopEnabled) ? a : h.enabledOOP,
          enabledLegacy: null != (o = null == f ? true : f.legacyEnabled) ? o : h.enabledLegacy,
          overlayMethod: null != (u = null == f ? true : f.overlayMethod) ? u : h.overlayMethod,
          source: null != (d = null == f ? true : f.source) ? d : h.source,
      ...
      if (setTimeout(() => {
        ...
        let e = P.name;
        c.A.identifyGame(w, e).then(e => c.A.reportUnverifiedGame(e)).catch(e => new _.A("AutoAnalytics").error("Cannot identify game", e))
      }
    }
    if (e.runningNonGame !== k && (null == k ? true : k.id) != null && (null == (i = e.runningNonGame) ? true : i.id) !== k.id) {
      let e = E.A.getById(k.id);
      null != e && X.default.track(J.HAw.LAUNCH_NON_GAME_APPLICATION, {
        name: e.name,
        application_id: e.id,
    ...
    if ((e.videoEnabled !== N || e.isScreenSharing !== T) && null != g) {
      let e = "none",
        ...
        n = null;
      T ? (e = "screen", n = (0, m.p)()) : N && (e = "camera"), X.default.track(J.HAw.VIDEO_INPUT_TOGGLED, et({
        video_input_type: e,
        video_toggle_source: __OVERLAY__ ? "overlay" : "app",
        enabled_inputs: t,
        preview_enabled: R.bm.getSetting()
      }, n, this.getGameMetadata(), (0, f.QS)(g)))
    }
    if (F && null != G && (!e.connected || G !== e.selectedChannelId || H !== e.selectedGuildId)) {
      ...
      if (null != t && null != n && null != r && r.publicUpdatesChannelId === t) {
        ...
        X.default.track(J.HAw.ACK_COMMUNITY_MESSAGES, et({
          last_message_id: null == i ? true : i.id,
          last_message_reference_message_id: null == i || null == (h = i.messageReference) ? true : h.message_id,
...
function ei() {
  let [e, t] = (0, o.yK)([H.A], () => [H.A.getVoiceChannelId(), H.A.getChannelId()], []), n = (0, o.bG)([D.A], () => D.A.getChannel(t), [t]), l = (0, o.bG)([b.A], () => (null == n ? true : n.id) != null && b.A.getChatOpen(n.id), [n]), a = null == n ? true : n.nsfw, s = (0, o.bG)([D.A], () => D.A.getChannel(e), [e]), c = (0, o.bG)([F.A], () => F.A.getGuildId(), []), u = (0, o.bG)([U.A], () => U.A.getGuild(c), [c]), d = (0, o.bG)([z.default], () => z.default.getCurrentUser(), []), m = (0, o.bG)([k.Ay], () => {
    var e, t;
    return null != d && null != c && null != (e = null == (t = k.Ay.getMember(c, d.id)) ? true : t.isPending) && e
  }, [d, c]), _ = (0, o.bG)([q.Ay], () => q.Ay.getState().section, []), E = (0, o.bG)([W.A], () => W.A.getHomeLink(), []), O = (0, o.bG)([I.A], () => I.A.isConnected(), []), [S, T] = (0, o.yK)([G.A], () => [G.A.isVideoEnabled(), G.A.isScreenSharing()], []), j = (0, o.bG)([Y.A], () => Y.A.getPrimaryActivity(), []), {
    currentGame: x,
    currentNonGame: P
  } = (0, o.cf)([y.Ay], () => ({
  ...
  return ! function(e) {
    ...
    i.useEffect(() => {
      if (n && null != s) {
        let e = (0, h.C)(D.A.getChannel(s), true);
        (0, f.zV)(J.HAw.CHANNEL_OPENED, et({}, e, (0, f.qL)(s))), (0, A.k)(J.HAw.CHANNEL_OPENED_CLICKSTREAM, {
          channelId: s
        }), t.current.isTextInVoice && (0, f.zV)(J.HAw.TEXT_IN_VOICE_OPENED, {
          channel_is_nsfw: t.current.isNSFWChannel
        })
      }
    }, [n, s]), i.useEffect(() => {
      n && null == o && l === J.BVt.FRIENDS && (0, g.A)({
        tab_opened: r
      })
    }, [n, r, l, o]), i.useEffect(() => {
      if (n && null != o) {
        ...
        (0, f.zV)(J.HAw.GUILD_VIEWED, n), (0, A.k)(J.HAw.GUILD_VIEWED_CLICKSTREAM, {
          guildId: o
        })
      }
    }, [n, o, a]);
    ...
    i.useEffect(() => {
      n && null == o && l === J.BVt.MESSAGE_REQUESTS && !c.current && (c.current = true, X.default.track(J.HAw.MESSAGE_REQUESTS_INITIALIZED, {
