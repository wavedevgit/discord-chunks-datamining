...
let h = function(e) {
  ...
  return <div className={p.container}>{<img alt={""} src={f} className={p.image} />}{<a.X6q variant={"heading-xl/semibold"} className={p.header}>{m}</a.X6q>}{<a.Text variant={"text-md/normal"} color={"header-secondary"}>{b}</a.Text>}</div>
}