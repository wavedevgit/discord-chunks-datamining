...
let A = (0, Chunk108843.Z)(function(e) {
  ...
  return <d.Gt value={k}><i.v2r navId={"user-settings-cog"} onClose={r.Zy} aria-label={w.intl.string(w.t.opYYHh)} onSelect={n} onInteraction={s}>{V.map(e => {
        var t, n;
        let {
          section: l,
          label: r,
        ...
        return <i.sNh{...t = function(e) {
      ...
      })}{e.user.isStaff() && C.length > 0 ? <i.sNh label={"Build Overrides"} id={"build_overrides"}><i.kSQ>{C.map(e => (0, a.jsx)(i.k5B, {
          ...
          }, "input-".concat(e.payload)))}</i.kSQ></i.sNh> : null}{null != t ? <i.kSQ><i.sNh id={"clear-build-override"} disabled={u} label={w.intl.string(w.t["/Nz9ra"])} action={R} color={"danger"} /></i.kSQ> : null}</i.v2r></d.Gt>
