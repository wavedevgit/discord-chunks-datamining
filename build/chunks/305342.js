...
let M = e => {
    let {
      ...
      header: n,
      guildId: l
    } = e, [a, s] = i.useState(!1), c = a ? t : t.slice(0, 5), u = t.length > 5, m = t.length - 5, p = S.intl.formatToPlainString(S.t["XSdy7+"], {
      numTruncated: m
    }), h = (0, d.Dt)();
  ...
  w = e => {
    ...
    return 0 === a.length ? null : (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(o.X6q, {
        ...
        color: "header-secondary",
        className: Z.sectionHeader,
        children: S.intl.format(S.t.NAnXEh, {
          count: a.length
        })
      }), (0, r.jsx)(o.LZC, {
        size: 12
  ...
  R = e => {
    let {
      ...
      guildId: n,
      className: i
    } = e, l = (0, v.Z)(n, t), [s] = g.UE(t), c = (0, j.Z)(s), [d] = g.R7(t), u = g.qs(t, n), [m] = g.XZ(t, n);
  ...
  k = e => {
    ...
    return t = i ? (0, r.jsxs)(r.Fragment, {
      children: [S.intl.string(S.t["r/xxPT"]), (0, r.jsx)(o.u04, {
        size: "md",
        color: "currentColor",
        className: Z.toggleTruncationButtonIcon
      })]
    }) : (0, r.jsxs)(r.Fragment, {
      children: [l, (0, r.jsx)(o.CJ0, {
        size: "md",
        color: "currentColor",
        className: Z.toggleTruncationButtonIcon
      })]
  ...
  D = e => {
    ...
    } = (0, P.Z)(b, l, d, p), M = (0, s.e7)([m.Z], () => m.Z.isSyncing), {
      activeSubscription: w,
      activeSubscriptionListing: D
    } = (0, C.Z)(d), F = (null == D ? void 0 : D.id) === n, U = (null == w ? void 0 : w.status) === T.O0b.CANCELED, [z, B] = i.useState(!1), [H, G] = i.useState(!1), W = i.useCallback(e => {
      let t = !1;
      null != e && (t = e.scrollHeight - e.clientHeight > 1), G(t)
    }, []), [Y] = g._T(n), [V] = g.PK(n), [X] = g.TT(n), [K] = g.F2(n), q = (0, _.Z)(l, n), Q = null != X && null == w && q, J = (0, c.Z)(I.iP), [$, ee] = i.useState(!1), et = $ || !J, en = (0, s.e7)([u.Z], () => u.Z.isViewingServerShop(l)), er = (null == b ? void 0 : b.published) === !0, ei = (null == b ? void 0 : b.soft_deleted) === !0, el = S.intl.string(S.t.KzmEAw);
    return (er || en) && !ei ? (0, r.jsxs)("article", {
      className: Z.container,
      "aria-label": Y,
      children: [Q && (0, r.jsxs)("div", {
        className: a()(Z.tierTrialIndicator, Z.tierTopIndicator),
        children: [S.intl.format(S.t.L2ouio, {
