...
let M = e => {
    let {
      ...
      header: n,
      guildId: l
    } = e, [a, o] = i.useState(!1), s = a ? t : t.slice(0, 5), u = t.length > 5, p = t.length - 5, m = Z.intl.formatToPlainString(Z.t["XSdy7+"], {
      numTruncated: p
    }), f = (0, d.Dt)();
  ...
  R = e => {
    let {
      guildId: t,
      listingId: n
    } = e, i = (0, j.Z)(t), [l] = b.XZ(n, t), a = i.filter(e => l.has(e.id));
  ...
  D = e => {
    let {
      ...
      guildId: n,
      className: i
    } = e, l = (0, C.Z)(n, t), [o] = b.UE(t), s = (0, _.Z)(o), [u] = b.R7(t), d = b.qs(t, n), [p] = b.XZ(t, n);
    return null == l && 0 === s.length && 0 === u.length && 0 === p.size ? null : (0, r.jsxs)("div", {
  ...
  F = e => {
    ...
    } = (0, I.Z)(j, l, d, f), M = (0, o.e7)([m.Z], () => m.Z.isSyncing), {
      activeSubscription: R,
      activeSubscriptionListing: F
    } = (0, v.Z)(d), U = (null == F ? void 0 : F.id) === n, z = (null == R ? void 0 : R.status) === T.O0b.CANCELED, [B, H] = i.useState(!1), [G, W] = i.useState(!1), Y = i.useCallback(e => {
      let t = !1;
      null != e && (t = e.scrollHeight - e.clientHeight > 1), W(t)
    }, []), [V] = b._T(n), [X] = b.PK(n), [K] = b.TT(n), [q] = b.F2(n), Q = (0, y.Z)(l, n), J = null != K && null == R && Q, $ = (0, u.Z)(S.iP), [ee, et] = i.useState(!1), en = ee || !$, er = (0, o.e7)([p.Z], () => p.Z.isViewingServerShop(l)), ei = (null == j ? void 0 : j.published) === !0, el = (null == j ? void 0 : j.soft_deleted) === !0, ea = Z.intl.string(Z.t.KzmEAw);
