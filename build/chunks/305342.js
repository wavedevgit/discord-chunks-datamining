...
let w = e => {
    let {
      ...
      header: n,
      guildId: l
    } = e, [a, o] = i.useState(!1), c = a ? t : t.slice(0, 5), d = t.length > 5, m = t.length - 5, p = T.intl.formatToPlainString(T.t["XSdy7+"], {
      numTruncated: m
    }), h = (0, u.Dt)();
  ...
  M = e => {
    let {
      guildId: t,
      listingId: n
    } = e, i = (0, _.Z)(t), [l] = g.XZ(n, t), a = i.filter(e => l.has(e.id));
    return 0 === a.length ? null : (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(s.X6q, {
        ...
        color: "header-secondary",
        className: Z.sectionHeader,
        children: T.intl.format(T.t.NAnXEh, {
          count: a.length
        })
      }), (0, r.jsx)(s.LZC, {
        size: 12
  ...
  k = e => {
    let {
      ...
      guildId: n,
      className: i
    } = e, l = (0, C.Z)(n, t), [o] = g.UE(t), c = (0, j.Z)(o), [u] = g.R7(t), d = g.qs(t, n), [m] = g.XZ(t, n);
    return null == l && 0 === c.length && 0 === u.length && 0 === m.size ? null : (0, r.jsxs)("div", {
      className: a()(Z.subscriptionPerks, i),
      children: [null != l && (0, r.jsxs)(s.y5t, {
  ...
  R = e => {
    ...
    return t = i ? (0, r.jsxs)(r.Fragment, {
      children: [T.intl.string(T.t["r/xxPT"]), (0, r.jsx)(s.u04, {
        size: "md",
        color: "currentColor",
        className: Z.toggleTruncationButtonIcon
      })]
    }) : (0, r.jsxs)(r.Fragment, {
      children: [l, (0, r.jsx)(s.CJ0, {
        size: "md",
        color: "currentColor",
        className: Z.toggleTruncationButtonIcon
      })]
  ...
  D = e => {
    ...
    } = (0, P.Z)(_, l, u, p), w = (0, o.e7)([m.Z], () => m.Z.isSyncing), {
      activeSubscription: M,
      activeSubscriptionListing: D
    } = (0, b.Z)(u), F = (null == D ? void 0 : D.id) === n, U = (null == M ? void 0 : M.status) === S.O0b.CANCELED, [z, B] = i.useState(!1), [H, G] = i.useState(!1), W = i.useCallback(e => {
      let t = !1;
      null != e && (t = e.scrollHeight - e.clientHeight > 1), G(t)
    }, []), [Y] = g._T(n), [V] = g.PK(n), [X] = g.TT(n), [K] = g.F2(n), q = (0, v.Z)(l, n), Q = null != X && null == M && q, J = (0, c.Z)(I.iP), [$, ee] = i.useState(!1), et = $ || !J, en = (0, o.e7)([d.Z], () => d.Z.isViewingServerShop(l)), er = (null == _ ? void 0 : _.published) === !0, ei = (null == _ ? void 0 : _.soft_deleted) === !0, el = T.intl.string(T.t.KzmEAw);
    return (er || en) && !ei ? (0, r.jsxs)("article", {
      className: Z.container,
      "aria-label": Y,
      children: [Q && (0, r.jsxs)("div", {
        className: a()(Z.tierTrialIndicator, Z.tierTopIndicator),
        children: [T.intl.format(T.t.L2ouio, {
          ...
          clickableOnMobile: !0,
          text: T.intl.formatToPlainString(T.t.FYyR4u, {
