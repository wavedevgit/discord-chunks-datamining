...
let z = e => {
    let {
      ...
      header: n,
      guildId: l
    } = e, [a, s] = r.useState(!1), o = a ? t : t.slice(0, 5), d = t.length > 5, m = t.length - 5, f = E.intl.formatToPlainString(E.t["XSdy7+"], {
      numTruncated: m
    }), h = (0, u.Dt)();
  ...
  D = e => {
    ...
    } = (0, j.Z)(u), B = (null == D ? void 0 : D.id) === n, F = (null == A ? void 0 : A.status) === S.O0b.CANCELED, [G, U] = r.useState(!1), [H, W] = r.useState(!1), Y = r.useCallback(e => {
      let t = !1;
      null != e && (t = e.scrollHeight - e.clientHeight > 1), W(t)
    }, []), [K] = p._T(n), [V] = p.PK(n), [X] = p.TT(n), [q] = p.F2(n), J = (0, b.Z)(l, n), Q = null != X && null == A && J, $ = (0, d.Z)(P.iP), [ee, et] = r.useState(!1), en = ee || !$, ei = (0, s.e7)([m.Z], () => m.Z.isViewingServerShop(l)), er = (null == x ? void 0 : x.published) === !0, el = (null == x ? void 0 : x.soft_deleted) === !0, ea = E.intl.string(E.t.KzmEAw);
