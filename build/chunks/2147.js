  ...
  eN = d.ZP.connectStores([k.Z], () => {
    ...
    return {
      ...
      onSave() {
        ...
        e.isThread() && (t = (0, W.Z)(t, !0)), (0, m.wk)(e.id, {
          name: t,
          type: n,
          topic: i,
          bitrate: r,
...
class ev extends r.PureComponent {
  ...
  componentDidUpdate(e) {
    ...
    (null != (r = null == (n = e.channel) ? void 0 : n.topic) ? r : "") !== l && l !== this.state.textTopicValue && this.setState({
      textTopicValue: l,
  ...
  renderChannelInfo(e, t) {
    ...
    let p, x, {
          ...
          children: [(0, i.jsxs)(g.xJW, {
            ...
            children: [(0, i.jsx)(g.vwX, {
              ...
              children: [(0, i.jsx)(g.yRy, {
                ...
                children: e => {
                  var t, n;
                  return (0, i.jsx)(g.zxk, (t = function(e) {
              ...
              }), null != e.defaultReactionEmoji ? (0, i.jsx)(g.zxk, {
      ...
      H = e.isForumChannel() ? (0, i.jsxs)("div", {
        children: [(0, i.jsxs)("div", {
          className: er.twoColumnSettings,
          children: [(0, i.jsxs)(g.xJW, {
          ...
          }), e.defaultForumLayout === a.X.GRID ? (0, i.jsx)($.Z, {
      ...
      J = P ? N : j,
      ee = A.X_.has(e.type) ? (0, i.jsxs)("div", {
        children: [(0, i.jsxs)(g.xJW, {
          children: [(0, i.jsx)(g.vwX, {
            id: ed,
      ...
      eh = P && null != e.threadMetadata ? (0, i.jsxs)("div", {
        children: [(0, i.jsx)(g.xJW, {
      ...
      eg = e.type === Y.d4z.PRIVATE_THREAD && null != e.threadMetadata ? (0, i.jsx)("div", {
      ...
      em = A.ov.has(e.type) ? (0, i.jsx)("div", {
        children: (0, i.jsx)(g.j7V, {
      ...
      ep = A.Y0.has(e.type) && null != S && S.hasFeature(Y.oNc.NEWS) && e.id !== (null == S ? void 0 : S.rulesChannelId) && e.id !== (null == S ? void 0 : S.publicUpdatesChannelId) ? (0, i.jsx)("div", {
        children: (0, i.jsx)(g.j7V, {
          note: (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsx)("div", {
              children: ei.NW.format(ei.t.tI7KNT, {
                documentationLink: X.Z.getArticleURL(Y.BhN.ANNOUNCEMENT_CHANNELS)
              })
            }), (0, i.jsx)("div", {
              className: el.marginTop8,
      ...
      ef = A.uC.has(e.type) ? (0, i.jsxs)("div", {
      ...
      ex = this.props.showChannelSummariesSettings ? (0, i.jsx)(g.j7V, {
        note: ei.NW.format(ei.t.feJW19, {
          helpdeskArticle: X.Z.getArticleURL(Y.BhN.CONVERSATION_SUMMARIES)
        }),
        ...
        children: (0, i.jsxs)("div", {
          ...
          children: [ei.NW.string(ei.t.id3ozs), (0, i.jsx)(g.IGR, {
            text: ei.NW.string(ei.t.oW0eUV),
            color: u.Z.colors.BG_BRAND.css
          })]
        })
      }) : null,
      eb = e.isMediaChannel() ? (0, i.jsxs)("div", {
        children: [(0, i.jsx)(g.$i$, {
          className: s()(el.marginTop40, el.marginBottom40)
        }), (0, i.jsx)(g.j7V, {
    ...
    return e.type === Y.d4z.GUILD_CATEGORY ? (x = ei.NW.string(ei.t.OCAkGB), p = "category-name") : e.isForumPost() ? (x = ei.NW.string(ei.t.uyVrTE), p = "post-title") : P ? (x = ei.NW.string(ei.t.j3XWjI), p = "thread-name") : (x = ei.NW.string(ei.t.PVbHDg), p = "channel-name"), (0, i.jsxs)("div", {
      children: [(0, i.jsx)(g.xJW, {
        title: x,
        ...
        className: s()(el.marginTop40, el.marginBottom40)
      }), k, B, V, G, ee, eh, H, z, F, eg, em, ep, ex, ef, eb]
    })
  }
  renderBitrate(e) {
  ...
  renderVoiceBitrate(e, t) {
    ...
    return (0, i.jsxs)(S.Z, {
      ...
      }), r > Y.epw ? (0, i.jsx)(g.R94, {
        id: em,
        type: g.geA.DESCRIPTION,
        children: ei.NW.format(ei.t.SbQJk5, {
          bitrate: Y.epw / 1e3
        })
      }) : null]
    })
  ...
  showVoiceSettings() {
    ...
    return null != e && null != e.guild_id && A.vg.has(e.type) && (e.isGuildVocal() || P.tM.getCurrentConfig({
      guildId: e.guild_id,
      location: "9b50bd_1"
    }).enabled)
  }
  ...
  onRenderUserLimit(e) {
    return 0 === (e = Math.round(e)) ? ei.NW.string(ei.t.XX5ciY) : ei.NW.formatToPlainString(ei.t["3uHFUV"], {
      num: e
    })
  }
  renderUserLimit(e) {
  ...
  renderRegionOverride(e) {
    ...
    return (0, i.jsxs)(S.Z, {
      direction: S.Z.Direction.VERTICAL,
      children: [(0, i.jsx)(g.vwX, {
        children: ei.NW.string(ei.t.Ms8bX1)
      }), (0, i.jsx)(g.q4e, {
        options: s,
        value: a,
  ...
  renderJuiceImage(e) {
    ...
    return t = e.type === Y.d4z.GUILD_CATEGORY ? (0, h.wj)(r) ? n(309095) : n(925442) : (0, h.wj)(r) ? n(316491) : n(301358), (0, i.jsx)(S.Z, {
  ...
  constructor(e) {
    var t, n;
    super(e), es(this, "defaultReactionButtonRef", r.createRef()), es(this, "renderEmojiPicker", e => {
      let {
        closePopout: t
      } = e, {
        channel: n
      ...
      null != t && (t.isThread() ? e = (0, W.Z)(e, !1) : Y.TPd.LIMITED_CHANNEL_NAME.has(t.type) && (e = (0, H.Nj)(e)), (0, m.pW)({
        name: e
      }))
...
function ey() {
  ...
  let {
    ...
    submitting: l,
    subsection: s
  } = (0, d.cj)([k.Z], () => k.Z.getProps()), a = (0, d.e7)([G.Z], () => {
    var e;
    return G.Z.getRegions(null != (e = null == n ? void 0 : n.getGuildId()) ? e : null)
  }), o = (0, d.e7)([L.Z], () => L.Z.theme), c = (0, d.e7)([B.Z], () => B.Z.getGuild(null == n ? void 0 : n.getGuildId())), u = (0, P.C7)(n), h = (0, P.Xb)(n), {
    canManageChannels: g,
    canSendMessages: m
  } = (0, d.cj)([V.Z], () => ({
    canManageChannels: V.Z.can(Y.Plq.MANAGE_CHANNELS, n),
    canSendMessages: V.Z.can(Y.Plq.SEND_MESSAGES, n)
  })), p = (0, N.ZP)(n), f = M.default.getId(), x = (0, T.v)(), v = null == n ? void 0 : n.id, y = (0, b.ts)(n, !1, !0), C = j.Z.useExperiment({
    guildId: null == n ? void 0 : n.guild_id,
