  ...
  eT = d.ZP.connectStores([W.Z], () => {
    ...
    return {
      ...
      onSave() {
        ...
        e.isThread() && (t = (0, M.Z)(t, !0)), (0, p.wk)(e.id, {
          name: t,
          type: n,
          topic: i,
          bitrate: l,
...
class eZ extends l.PureComponent {
  ...
  renderChannelInfo(e, t) {
    ...
    let f, j, {
      ...
      M = V.TK.has(e.type) ? (0, i.jsxs)("div", {
        children: [(0, i.jsx)(g.xJW, {
          ...
          className: s()(eo.marginTop40, eo.marginBottom40)
        })]
      }) : null,
      B = R && D ? (0, i.jsxs)("div", {
        children: [(0, i.jsx)(g.xJW, {
          ...
          children: [(0, i.jsxs)(g.xJW, {
            ...
            children: [(0, i.jsx)(g.vwX, {
              ...
              children: [(0, i.jsx)(g.yRy, {
                ...
                animation: g.yRy.Animation.NONE,
                align: "center",
                children: e => (0, i.jsx)(m.zx, eu(ed({}, e), {
      ...
      H = e.isForumChannel() ? (0, i.jsxs)("div", {
        children: [(0, i.jsxs)("div", {
          ...
          }), e.defaultForumLayout === a.X.GRID ? (0, i.jsx)(K.Z, {
      ...
      J = Z && null != e.threadMetadata ? (0, i.jsxs)("div", {
        children: [(0, i.jsx)(g.xJW, {
      ...
      $ = e.type === et.d4z.PRIVATE_THREAD && null != e.threadMetadata ? (0, i.jsx)("div", {
      ...
      ei = V.ov.has(e.type) ? (0, i.jsx)("div", {
        children: (0, i.jsx)(g.j7V, {
      ...
      ec = V.Y0.has(e.type) && null != S && S.features.has(et.oNc.NEWS) && e.id !== (null == S ? void 0 : S.rulesChannelId) && e.id !== (null == S ? void 0 : S.publicUpdatesChannelId) ? (0, i.jsx)("div", {
        children: (0, i.jsx)(g.j7V, {
          note: (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsx)("div", {
              children: es.intl.format(es.t.tI7KNT, {
                documentationLink: q.Z.getArticleURL(et.BhN.ANNOUNCEMENT_CHANNELS)
              })
            }), (0, i.jsx)("div", {
              className: eo.marginTop8,
      ...
      ex = V.uC.has(e.type) ? (0, i.jsxs)("div", {
      ...
      ej = this.props.showChannelSummariesSettings ? (0, i.jsx)(g.j7V, {
        note: es.intl.format(es.t.feJW19, {
          helpdeskArticle: q.Z.getArticleURL(et.BhN.CONVERSATION_SUMMARIES)
        }),
        ...
        children: (0, i.jsxs)("div", {
          ...
          children: [es.intl.string(es.t.id3ozs), (0, i.jsx)(g.IGR, {
    ...
    return e.type === et.d4z.GUILD_CATEGORY ? (j = es.intl.string(es.t.OCAkGB), f = "category-name") : e.isForumPost() ? (j = es.intl.string(es.t.uyVrTE), f = "post-title") : Z ? (j = es.intl.string(es.t.j3XWjI), f = "thread-name") : (j = es.intl.string(es.t.PVbHDg), f = "channel-name"), (0, i.jsxs)("div", {
      children: [(0, i.jsx)(g.xJW, {
        title: j,
        ...
        className: s()(eo.marginTop40, eo.marginBottom40)
      }), M, B, U, W, Y, J, H, G, F, $, ei, ec, ej, ex, eb]
    })
  }
  renderBitrate(e) {
  ...
  renderVoiceBitrate(e, t) {
    ...
    return (0, i.jsxs)(E.Z, {
      ...
      }), l > et.epw ? (0, i.jsx)(g.R94, {
        id: eb,
        type: g.geA.DESCRIPTION,
        children: es.intl.format(es.t.SbQJk5, {
          bitrate: et.epw / 1e3
        })
      }) : null]
    })
  ...
  showVoiceSettings() {
    ...
    return null != e && null != e.guild_id && V.vg.has(e.type) && (e.isGuildVocal() || D.tM.getCurrentConfig({
      guildId: e.guild_id,
      location: "9b50bd_1"
    }).enabled)
  }
  ...
  onRenderUserLimit(e) {
    return 0 === (e = Math.round(e)) ? es.intl.string(es.t.XX5ciY) : es.intl.formatToPlainString(es.t["3uHFUV"], {
      num: e
    })
  }
  renderUserLimit(e) {
  ...
  renderRegionOverride(e) {
    ...
    return (0, i.jsxs)(E.Z, {
      direction: E.Z.Direction.VERTICAL,
      children: [(0, i.jsx)(g.vwX, {
        children: es.intl.string(es.t.Ms8bX1)
      }), (0, i.jsx)(g.q4e, {
        options: s,
        value: a,
  ...
  renderJuiceImage(e) {
    ...
    return t = e.type === et.d4z.GUILD_CATEGORY ? (0, h.wj)(l) ? n(309095) : n(925442) : (0, h.wj)(l) ? n(316491) : n(301358), (0, i.jsx)(E.Z, {
  ...
  constructor(e) {
    var t, n;
    super(e), ec(this, "defaultReactionButtonRef", l.createRef()), ec(this, "nameInputRef", l.createRef()), ec(this, "cursorPosition", 0), ec(this, "renderEmojiPicker", e => {
      let {
        closePopout: t
      } = e, {
        channel: n
      ...
      (0, p.pW)({
        type: e ? et.d4z.GUILD_ANNOUNCEMENT : et.d4z.GUILD_TEXT
      })
...
function eR() {
  let {
    ...
    submitting: n,
    subsection: r
  } = (0, d.cj)([W.Z], () => W.Z.getProps()), s = (0, d.e7)([F.Z], () => {
    var e;
    return F.Z.getRegions(null != (e = null == t ? void 0 : t.getGuildId()) ? e : null)
  }), a = (0, d.e7)([B.Z], () => B.Z.theme), o = (0, d.e7)([H.Z], () => H.Z.getGuild(null == t ? void 0 : t.getGuildId())), c = (0, D.C7)(t), u = (0, D.Xb)(t), {
    canManageChannels: h,
    canSendMessages: m
  } = (0, d.cj)([G.Z], () => ({
    canManageChannels: G.Z.can(et.Plq.MANAGE_CHANNELS, t),
    canSendMessages: G.Z.can(et.Plq.SEND_MESSAGES, t)
  })), g = (0, C.ZP)(t), p = U.default.getId(), f = (0, _.v)(), x = null == t ? void 0 : t.id, j = (0, v.ts)(t, !1, !0), N = b.Z.useExperiment({
