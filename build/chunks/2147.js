  ...
  ev = d.ZP.connectStores([B.Z], () => {
    ...
    return {
      ...
      onSave() {
        ...
        e.isThread() && (t = (0, D.Z)(t, !0)), (0, m.wk)(e.id, {
          name: t,
          type: n,
          topic: i,
          bitrate: l,
...
class ey extends l.PureComponent {
  ...
  renderChannelInfo(e, t) {
    ...
    let p, x, {
      ...
      B = M.TK.has(e.type) ? (0, i.jsxs)("div", {
      ...
      J = P ? v : j,
      ee = M.X_.has(e.type) ? (0, i.jsxs)("div", {
        children: [(0, i.jsxs)(g.xJW, {
          children: [(0, i.jsx)(g.vwX, {
            id: ed,
      ...
      em = M.ov.has(e.type) ? (0, i.jsx)("div", {
        children: (0, i.jsx)(g.j7V, {
      ...
      ep = M.Y0.has(e.type) && null != S && S.hasFeature(Y.oNc.NEWS) && e.id !== (null == S ? void 0 : S.rulesChannelId) && e.id !== (null == S ? void 0 : S.publicUpdatesChannelId) ? (0, i.jsx)("div", {
        children: (0, i.jsx)(g.j7V, {
          note: (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsx)("div", {
              children: ei.intl.format(ei.t.tI7KNT, {
      ...
      ef = M.uC.has(e.type) ? (0, i.jsxs)("div", {
      ...
      ex = this.props.showChannelSummariesSettings ? (0, i.jsx)(g.j7V, {
        note: ei.intl.format(ei.t.feJW19, {
        ...
        children: (0, i.jsxs)("div", {
          ...
          children: [ei.intl.string(ei.t.id3ozs), (0, i.jsx)(g.IGR, {
    ...
    return e.type === Y.d4z.GUILD_CATEGORY ? (x = ei.intl.string(ei.t.OCAkGB), p = "category-name") : e.isForumPost() ? (x = ei.intl.string(ei.t.uyVrTE), p = "post-title") : P ? (x = ei.intl.string(ei.t.j3XWjI), p = "thread-name") : (x = ei.intl.string(ei.t.PVbHDg), p = "channel-name"), (0, i.jsxs)("div", {
      children: [(0, i.jsx)(g.xJW, {
        title: x,
        ...
        className: s()(er.marginTop40, er.marginBottom40)
      }), B, V, G, U, ee, eh, H, z, F, eg, em, ep, ex, ef, eb]
    })
  }
  renderBitrate(e) {
  ...
  renderVoiceBitrate(e, t) {
    ...
    return (0, i.jsxs)(S.Z, {
      ...
      }), l > Y.epw ? (0, i.jsx)(g.R94, {
        id: em,
        type: g.geA.DESCRIPTION,
        children: ei.intl.format(ei.t.SbQJk5, {
          bitrate: Y.epw / 1e3
        })
      }) : null]
    })
  ...
  showVoiceSettings() {
    ...
    return null != e && null != e.guild_id && M.vg.has(e.type) && (e.isGuildVocal() || P.tM.getCurrentConfig({
      guildId: e.guild_id,
      location: "9b50bd_1"
    }).enabled)
  }
  ...
  onRenderUserLimit(e) {
    return 0 === (e = Math.round(e)) ? ei.intl.string(ei.t.XX5ciY) : ei.intl.formatToPlainString(ei.t["3uHFUV"], {
      num: e
    })
  }
  renderUserLimit(e) {
  ...
  renderRegionOverride(e) {
    ...
    return (0, i.jsxs)(S.Z, {
      direction: S.Z.Direction.VERTICAL,
      children: [(0, i.jsx)(g.vwX, {
        children: ei.intl.string(ei.t.Ms8bX1)
      }), (0, i.jsx)(g.q4e, {
        options: s,
        value: a,
  ...
  renderJuiceImage(e) {
    ...
    return t = e.type === Y.d4z.GUILD_CATEGORY ? (0, h.wj)(l) ? n(309095) : n(925442) : (0, h.wj)(l) ? n(316491) : n(301358), (0, i.jsx)(S.Z, {
  ...
  constructor(e) {
    var t, n;
    super(e), es(this, "defaultReactionButtonRef", l.createRef()), es(this, "renderEmojiPicker", e => {
      let {
        closePopout: t
      } = e, {
        channel: n
      ...
      null != t && (t.isThread() ? e = (0, D.Z)(e, !1) : Y.TPd.LIMITED_CHANNEL_NAME.has(t.type) && (e = (0, H.Nj)(e)), (0, m.pW)({
        name: e
      }))
...
function eC() {
  ...
  let {
    ...
    submitting: r,
    subsection: s
  } = (0, d.cj)([B.Z], () => B.Z.getProps()), a = (0, d.e7)([U.Z], () => {
    var e;
    return U.Z.getRegions(null != (e = null == n ? void 0 : n.getGuildId()) ? e : null)
  }), o = (0, d.e7)([A.Z], () => A.Z.theme), c = (0, d.e7)([V.Z], () => V.Z.getGuild(null == n ? void 0 : n.getGuildId())), u = (0, P.C7)(n), h = (0, P.Xb)(n), {
    canManageChannels: g,
    canSendMessages: m
  } = (0, d.cj)([G.Z], () => ({
    canManageChannels: G.Z.can(Y.Plq.MANAGE_CHANNELS, n),
    canSendMessages: G.Z.can(Y.Plq.SEND_MESSAGES, n)
  })), p = (0, v.ZP)(n), f = k.default.getId(), x = (0, T.v)(), y = null == n ? void 0 : n.id, C = (0, b.ts)(n, !1, !0), N = j.Z.useExperiment({
    guildId: null == n ? void 0 : n.guild_id,
