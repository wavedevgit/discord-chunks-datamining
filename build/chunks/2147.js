  ...
  eb = d.ZP.connectStores([k.Z], () => {
    ...
    return {
      ...
      onSave() {
        ...
        e.isThread() && (t = (0, P.Z)(t, !0)), (0, m.wk)(e.id, {
          name: t,
          type: n,
          topic: i,
          bitrate: l,
...
class ev extends l.PureComponent {
  ...
  renderChannelInfo(e, t) {
    ...
    let p, x, {
      ...
      X = I ? v : j,
      K = A.X_.has(e.type) ? (0, i.jsxs)("div", {
        children: [(0, i.jsxs)(g.xJW, {
          children: [(0, i.jsx)(g.vwX, {
            id: ec,
      ...
      eu = I && null != e.threadMetadata ? (0, i.jsxs)("div", {
        children: [(0, i.jsx)(g.xJW, {
      ...
      eh = e.type === Q.d4z.PRIVATE_THREAD && null != e.threadMetadata ? (0, i.jsx)("div", {
      ...
      eg = A.ov.has(e.type) ? (0, i.jsx)("div", {
        children: (0, i.jsx)(g.j7V, {
      ...
      em = A.Y0.has(e.type) && null != S && S.hasFeature(Q.oNc.NEWS) && e.id !== (null == S ? void 0 : S.rulesChannelId) && e.id !== (null == S ? void 0 : S.publicUpdatesChannelId) ? (0, i.jsx)("div", {
        children: (0, i.jsx)(g.j7V, {
          note: (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsx)("div", {
              children: en.intl.format(en.t.tI7KNT, {
                documentationLink: F.Z.getArticleURL(Q.BhN.ANNOUNCEMENT_CHANNELS)
              })
            }), (0, i.jsx)("div", {
              className: el.marginTop8,
      ...
      ep = A.uC.has(e.type) ? (0, i.jsxs)("div", {
      ...
      ef = this.props.showChannelSummariesSettings ? (0, i.jsx)(g.j7V, {
        note: en.intl.format(en.t.feJW19, {
          helpdeskArticle: F.Z.getArticleURL(Q.BhN.CONVERSATION_SUMMARIES)
        }),
        ...
        children: (0, i.jsxs)("div", {
          ...
          children: [en.intl.string(en.t.id3ozs), (0, i.jsx)(g.IGR, {
    ...
    return e.type === Q.d4z.GUILD_CATEGORY ? (x = en.intl.string(en.t.OCAkGB), p = "category-name") : e.isForumPost() ? (x = en.intl.string(en.t.uyVrTE), p = "post-title") : I ? (x = en.intl.string(en.t.j3XWjI), p = "thread-name") : (x = en.intl.string(en.t.PVbHDg), p = "channel-name"), (0, i.jsxs)("div", {
      children: [(0, i.jsx)(g.xJW, {
        title: x,
        ...
        className: s()(el.marginTop40, el.marginBottom40)
      }), k, B, V, G, K, eu, W, H, z, eh, eg, em, ef, ep, ej]
    })
  }
  renderBitrate(e) {
  ...
  renderJuiceImage(e) {
    ...
    return t = e.type === Q.d4z.GUILD_CATEGORY ? (0, h.wj)(l) ? n(309095) : n(925442) : (0, h.wj)(l) ? n(316491) : n(301358), (0, i.jsx)(S.Z, {
  ...
  constructor(e) {
    ...
    super(e), er(this, "defaultReactionButtonRef", l.createRef()), er(this, "renderEmojiPicker", e => {
      ...
      null != t && (t.isThread() ? e = (0, P.Z)(e, !1) : Q.TPd.LIMITED_CHANNEL_NAME.has(t.type) && (e = (0, W.Nj)(e)), (0, m.pW)({
        name: e
      }))
...
function ey() {
  let {
    ...
    submitting: n,
    subsection: r
  } = (0, d.cj)([k.Z], () => k.Z.getProps()), s = (0, d.e7)([G.Z], () => {
    var e;
    return G.Z.getRegions(null != (e = null == t ? void 0 : t.getGuildId()) ? e : null)
  }), a = (0, d.e7)([L.Z], () => L.Z.theme), o = (0, d.e7)([B.Z], () => B.Z.getGuild(null == t ? void 0 : t.getGuildId())), c = (0, I.C7)(t), u = (0, I.Xb)(t), {
    canManageChannels: h,
    canSendMessages: g
  } = (0, d.cj)([V.Z], () => ({
    canManageChannels: V.Z.can(Q.Plq.MANAGE_CHANNELS, t),
    canSendMessages: V.Z.can(Q.Plq.SEND_MESSAGES, t)
  })), m = (0, v.ZP)(t), p = M.default.getId(), f = (0, T.v)(), x = null == t ? void 0 : t.id, y = (0, b.ts)(t, !1, !0), C = j.Z.useExperiment({
    guildId: null == t ? void 0 : t.guild_id,
    location: "ChannelSettingsOverview"
  }).enabled, N = l.useCallback(e => {
