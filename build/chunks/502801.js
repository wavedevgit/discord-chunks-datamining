...
function M(n) {
  let {
    ...
    transitionState: r,
    onClose: o
  } = n, [s, A] = l.useState(""), [T, S] = l.useState(!1), [D, N] = l.useState(null), U = (0, E.Wu)([h.Z], () => h.Z.getFriendIDs()), R = (0, E.Wu)([L.Z, g.default], () => U.map(n => g.default.getUser(n)).filter(G.lm).sort((n, e) => {
    var t, i, l, r;
