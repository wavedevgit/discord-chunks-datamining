...
function y(e) {
  ...
  return i.useEffect(() => {
    !N || null == U || null == R || F || B || (0, u.pO)(U) || H({
      onSubscriptionConfirmation: y
    })
  }, [H, N, U, R, F, B, y]), i.useEffect(() => {
  ...
  }, [K, Y]), n = null != S ? S(I, X, T) : null != b ? (0, l.jsx)(c.VY, {}) : N ? (0, l.jsx)(c.TB, {
    planId: I.id,
    onClose: X
  }) : A.current === I.id ? (0, l.jsx)(c.ZP, {
    planId: I.id,
    postSuccessGuild: E,
    onClose: X,
    paymentSourceType: J,
    ...
    children: [(0, l.jsxs)(f.C3, {
      children: [(0, l.jsx)(L.Z, {}), n]
    }), null != W && W, Q && null != q && (0, l.jsx)(m.Z, {
      onClose: X,
