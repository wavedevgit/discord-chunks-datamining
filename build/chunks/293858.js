...
function g(e) {
  let t, {
    ...
    J = (0, j.$)(w, O),
    Q = N && null != D && K;
  l()(null != P, "Expected plan to selected"), l()(null != M, "Expected selectedSkuId"), l()(null != T, "Step should be set");
  let X = i.useCallback(() => {
    r(), null == g || g()
  }, [r, g]);
  return i.useEffect(() => {
    !N || null == U || null == k || B || F || (0, u.pO)(U) || G({
      onSubscriptionConfirmation: g
    })
  }, [G, N, U, k, B, F, g]), i.useEffect(() => {
    null != V && null != V.reminderNotice && z && (0, s.wH)(a.z.GIFTING_PROMOTION_REMINDER, V.dismissibleContentVersion, {
