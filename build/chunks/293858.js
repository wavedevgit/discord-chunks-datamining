...
function g(e) {
  let r, {
    ...
    J = (0, j.$)(w, O),
    Q = N && null != D && K;
  a()(null != P, "Expected plan to selected"), a()(null != M, "Expected selectedSkuId"), a()(null != T, "Step should be set");
  let X = i.useCallback(() => {
    t(), null == g || g()
  }, [t, g]);
  return i.useEffect(() => {
    !N || null == U || null == B || k || F || (0, u.pO)(U) || G({
      onSubscriptionConfirmation: g
    })
  }, [G, N, U, B, k, F, g]), i.useEffect(() => {
    null != V && null != V.reminderNotice && z && (0, s.wH)(l.z.GIFTING_PROMOTION_REMINDER, V.dismissibleContentVersion, {
      dismissAction: b.L.INDIRECT_ACTION
    })
  }, [V, z]), r = null != y ? y(P, X, Z) : null != v ? (0, n.jsx)(c.VY, {}) : N ? (0, n.jsx)(c.TB, {
    planId: P.id,
    onClose: X
  }) : A.current === P.id ? (0, n.jsx)(c.ZP, {
    planId: P.id,
    postSuccessGuild: S,
    onClose: X,
    paymentSourceType: J,
