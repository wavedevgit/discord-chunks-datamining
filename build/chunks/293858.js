...
function S(e) {
  ...
  return i.useEffect(() => {
    !k || null == A || null == U || R || F || (0, u.pO)(A) || B({
      onSubscriptionConfirmation: S
    })
  }, [B, k, A, U, R, F, S]), i.useEffect(() => {
    null != z && null != z.reminderNotice && Y && (0, a.wH)(o.z.GIFTING_PROMOTION_REMINDER, z.dismissibleContentVersion, {
      dismissAction: g.L.INDIRECT_ACTION
    })
  }, [z, Y]), t = null != y ? y(P, q, v) : null != I ? (0, r.jsx)(c.VY, {}) : k ? (0, r.jsx)(c.TB, {
    planId: P.id,
    onClose: q
  }) : w.current === P.id ? (0, r.jsx)(c.ZP, {
    planId: P.id,
    postSuccessGuild: E,
    onClose: q,
    paymentSourceType: V,
