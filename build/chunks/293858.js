...
function E(e) {
  let t, {
    ...
    Q = (0, L.$)(O, Z),
    q = U && null != D && z;
  r()(null != T, "Expected plan to selected"), r()(null != v, "Expected selectedSkuId"), r()(null != b, "Step should be set");
  let J = i.useCallback(() => {
    n(), null == E || E()
  }, [n, E]);
  return i.useEffect(() => {
    !U || null == R || null == w || H || B || (0, u.pO)(R) || F({
      onSubscriptionConfirmation: E
    })
  }, [F, U, R, w, H, B, E]), i.useEffect(() => {
    null != X && null != X.reminderNotice && Y && (0, o.wH)(a.z.GIFTING_PROMOTION_REMINDER, X.dismissibleContentVersion, {
      dismissAction: g.L.INDIRECT_ACTION
    })
  }, [X, Y]), t = null != y ? y(T, J, N) : null != M ? (0, l.jsx)(c.VY, {}) : U ? (0, l.jsx)(c.TB, {
    planId: T.id,
    onClose: J
  }) : k.current === T.id ? (0, l.jsx)(c.ZP, {
    planId: T.id,
    postSuccessGuild: S,
    onClose: J,
    paymentSourceType: Q,
    ...
    planId: T.id,
    onClose: J,
    isDowngrade: null != P && (0, p.GY)(P, T.id, s),
    paymentSourceType: Q,
    hideClose: K,
    startingFractionalPremiumEndsAt: A.current
  }), (0, l.jsxs)(l.Fragment, {
