...
let O = function(e) {
  ...
  } = e, j = (0, d.H)(n.guild_id), _ = l.useCallback(() => {
    j ? (0, u.Ze)(n.guild_id, () => a.default.selectVoiceChannel(n.id)) : a.default.selectVoiceChannel(n.id)
  }, [n.id, n.guild_id, j]), x = t.filter(e => e.type === f.wY.VOICE), v = 4 === x.length ? 2 : 3, E = (0, i.yK)([o.A], () => x.map(e => o.A.getParticipant(n.id, e.id)).filter(g.Vq), [n.id, x]);
  return (0, r.jsxs)("div", {
    className: y.kL,
