...
function E(e) {
  let {
    guild: t
  } = e, n = (0, u.bG)([b.A], () => b.A.can(_.xBc.ADMINISTRATOR, t)), l = t.features.has(_.GuildFeatures.PIN_PERMISSION_MIGRATION_COMPLETE), s = t.features.has(_.GuildFeatures.BYPASS_SLOWMODE_PERMISSION_MIGRATION_COMPLETE), [a, o] = i.useState(true), [c, g] = i.useState(true);
