...
function _(e) {
  ...
  } = (0, o.ZP)(s.Z.GO_LIVE_MODAL_V2), S = (0, d.N)(), b = (0, c.Ng)(), C = (null == S || null == (t = S.subscription_trial) ? true : t.sku_id) === h.Si.TIER_2 || (0, c.Wp)(b, h.Si.TIER_2), y = x.intl.string(p.default["+f+cqq"]);
  return C && (null != S ? y = (0, f.Rt)({
    intervalType: null == S || null == (n = S.subscription_trial) ? true : n.interval,
    intervalCount: null == S || null == (_ = S.subscription_trial) ? true : _.interval_count
