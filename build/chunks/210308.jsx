...
function C(e) {
  ...
  return !l || null == r || m || p ? null : <c.Nq contentType={a.z.NITRO_TENURE_BADGE_LEVEL_UP} timeRecurringConfig={{
...
function O(e) {
  ...
  return <div className={E.contents}>{<o.M0o className={E.closeButton} tooltip={j.intl.string(j.t.cpT0Cg)} color={o.YX$.TERTIARY} size={o.tT7.SIZE_24} icon={(0, i.jsx)(o.Dio, {
        size: "xs",
        color: "currentColor"
      })} onClick={h} />}{null != u && <img src={u} alt={j.intl.string(C.nameUnformatted)} className={E.badgeImage} />}{<o.X6q variant={"heading-md/extrabold"}>{j.intl.string(j.t.VoDxsb)}</o.X6q>}{<o.Text variant={"text-sm/medium"} className={E.subtitle}>{j.intl.formatToPlainString(j.t.ewkaVV, {
        timeMilestone: null == (t = (0, p.q)(C.id, C.tenureReqNumMonths)) ? true : t.toLocaleLowerCase()
      })}</o.Text>}{<l.zx className={E.checkItOutButton} color={l.Tt.WHITE} size={l.Ph.SMALL} onClick={g}>{j.intl.string(j.t.RzWDqa)}</l.zx>}{<div className={E.pointer} />}</div>
}