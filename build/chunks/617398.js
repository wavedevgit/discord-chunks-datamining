/** Chunk was on web.js **/
/** chunk id: 617398, original params: e (module,exports,re quire) **/
function t(e) {
...
function W(e, t) {
  !t || e.beginKeywords && (e.begin = "\\b(" + e.beginKeywords.split(" ").join("|") + ")(?!\\.)(?=\\b|\\s)", e.__beforeBegin = H, e.keywords = e.keywords || e.beginKeywords, delete e.beginKeywords, true === e.relevance && (e.relevance = 0))
}
...
function es(e, t, {
  ...
  let r = 0,
    ...
    a = {},
    s = {};
  for (let e = 1; e <= t.length; e++) s[e + r] = i[e], a[e + r] = true, r += y(t[e - 1]);
  e[n] = s, e[n]._emit = a, e[n]._multi = true
}
...
function ed(e) {
  ...
  function s(n, r) {
    ...
    [Y, z, eu, X].forEach(e => e(n, r)), e.compilerExtensions.forEach(e => e(n, r)), n.__beforeBegin = null, [W, K, q].forEach(e => e(n, r)), n.isCompiled = true;
    let o = null;
    return "object" == typeof n.keywords && n.keywords.$pattern && (n.keywords = Object.assign({}, n.keywords), o = n.keywords.$pattern, delete n.keywords.$pattern), o = o || /\w+/, n.keywords && (n.keywords = $(n.keywords, e.case_insensitive)), i.keywordPatternRe = t(o, true), r && (n.begin || (n.begin = /\B|\b/), i.beginRe = t(i.begin), n.end || n.endsWithParent || (n.end = /\B|\b/), n.end && (i.endRe = t(i.end)), i.terminatorEnd = f(i.end) || "", n.endsWithParent && r.terminatorEnd && (i.terminatorEnd += (n.end ? "|" : "") + r.terminatorEnd)), n.illegal && (i.illegalRe = t(n.illegal)), n.contains || (n.contains = []), n.contains = [].concat(...n.contains.map(function(e) {
...
let em = r,
  ...
  eb = function(e) {
    ...
    function y(e, t, i, a) {
      ...
      function f() {
        ...
        if ("string" == typeof P.subLanguage) {
          ...
          e = y(P.subLanguage, L, true, D[P.subLanguage]), D[P.subLanguage] = e._top
      ...
      function E(e) {
        return 0 === P.matcher.regexIndex ? (L += e[0], 1) : (U = true, 0)
      }
      ...
      try {
        if (C.__emitTokens) C.__emitTokens(t, x);
          ...
          for (P.matcher.considerAll();;) {
            k++, U ? U = false : P.matcher.considerAll(), P.matcher.lastIndex = M;
    ...
    function v(e, t) {
      ...
      let n = O(e),
        i = t.filter(w).filter(D).map(t => y(t, e, false));
      i.unshift(n);
      let [a, s] = i.sort((e, t) => {
  ...
  eO = eb({});
eO.newInstance = () => eb({}), module.exports = eO, eO.HighlightJS = eO, eO.default = eO