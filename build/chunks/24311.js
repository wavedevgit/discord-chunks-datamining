...
function Z(e) {
  let {
    ...
    id: v,
    onCall: p
  } = e, O = (0, o.Aq)(), j = (0, i.e7)([u.default], () => u.default.getId() === t.id), x = (0, i.e7)([d.Z], () => d.Z.isBlocked(t.id)), h = (0, i.e7)([g.Z, c.Z], () => g.Z.getVoiceChannelId() === c.Z.getDMFromUserId(t.id));
  if (j || Z === f.IlC.POPOUT || h || t.bot || t.isProvisional) return null;
  let y = () => {
