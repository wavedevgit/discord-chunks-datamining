...
function A(e) {
  ...
  } = e, W = (0, a.e7)([N.Z], () => N.Z.getChannel(t)), L = (0, a.e7)([O.Z], () => O.Z.getGuild(null == W ? void 0 : W.getGuildId())), M = (0, a.e7)([Z.default], () => Z.default.getCurrentUser()), H = (0, a.e7)([y.Z], () => y.Z.didAgree(null == W ? void 0 : W.guild_id)), U = (null == M ? void 0 : M.nsfwAllowed) === !0, G = (0, w.ZP)(W), F = (0, a.e7)([C.Z], () => (null == L ? void 0 : L.id) != null && C.Z.isLurking(L.id), [L]), z = (0, f.Z)(t), q = (0, a.e7)([p.Z], () => {
    var e;
    return null == (e = p.Z.getResourceForChannel(null == L ? void 0 : L.id, t)) ? void 0 : e.title
  }), X = l.useRef(!1);
  if (l.useEffect(() => {
      null == W || X.current || (X.current = !0, (0, d.yw)(E.rMx.CHANNEL_OPENED, B(T({}, (0, d.$H)(W.id)), {
        channel_view: R
