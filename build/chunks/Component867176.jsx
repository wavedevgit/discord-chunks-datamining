...
function N(e) {
  ...
  let {
  ...
  } = e, x = (0, p.Dt)(), [L, j] = i.useState(false), M = (0, l.e7)([m.Z], () => m.Z.isFocused()), k = h.QK.getSetting(), {
    bannerSrc: U,
    status: G
  } = (0, E.Z)({
    displayProfile: a,
    ...
    size: N,
    canAnimate: D || !k ? L : M
  }), Z = (0, u.dQu)(c.Z.unsafe_rawColors.PRIMARY_800).hex(), F = n.getAvatarURL(b, (0, u.dcp)(I)), B = (0, s._i)((0, d.ZP)(F, Z, false)), V = (0, f.Z)(null != (t = null != R ? R : null == a ? true : a.primaryColor) ? t : B).hex, H = A(I), Y = H + T - w, W = P - C - w;
  return (0, r.jsxs)("svg", {
    className: y.mask,
