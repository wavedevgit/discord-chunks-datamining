...
function B() {
  ...
  }), [], l.pF), s = (0, l.e7)([g.ZP, h.Z], () => h.Z.getChannel(g.ZP.getChannelId())), m = null === (e = r.concat(i).find(e => null != e.screenshare)) || void 0 === e ? void 0 : e.screenshare, y = null === (t = i.find(e => null != e.clips)) || void 0 === t ? void 0 : t.clips, v = (0, l.e7)([p.Z], () => p.Z.theme), D = (0, l.e7)([p.Z], () => p.Z.darkSidebar ? Z.BRd.DARK : void 0), N = (0, l.e7)([f.ZP], () => f.ZP.getSection()), E = function(e) {
    let {
      defaultStats: t,
      streamStats: r,
      videoStreams: a,
