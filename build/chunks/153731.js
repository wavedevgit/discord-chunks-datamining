...
function B() {
  ...
  }), [], s.pF), l = (0, s.e7)([g.Z, h.Z], () => h.Z.getChannel(g.Z.getChannelId())), m = null == (e = r.concat(i).find(e => null != e.screenshare)) ? void 0 : e.screenshare, y = null == (t = i.find(e => null != e.clips)) ? void 0 : t.clips, v = (0, s.e7)([p.Z], () => p.Z.theme), D = (0, s.e7)([p.Z], () => p.Z.darkSidebar ? N.BRd.DARK : void 0), b = (0, s.e7)([f.ZP], () => f.ZP.getSection()), j = function(e) {
    let {
      defaultStats: t,
      streamStats: r,
      videoStreams: a,
      ...
      channel: s,
      connectionState: c
    } = e, d = t.flatMap((e, t) => k(R.Yn.DEFAULT, e, t, a, null == s ? void 0 : s.getGuildId())), m = r.flatMap((e, t) => k(R.Yn.STREAM, e, t, a, null == s ? void 0 : s.getGuildId())), p = [], h = [], y = {
