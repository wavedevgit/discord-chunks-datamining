...
function d(e) {
  ...
  return <o.animated.div ref={m} onMouseDown={S} onMouseUp={A} onMouseMove={e => O.current && T(e.movementX, e.movementY)} onWheel={e => !e.ctrlKey && T(-e.deltaX, -e.deltaY)} onMouseLeave={() => O.current = false} onClick={e => e.stopPropagation()} style={{
      scale: n,
      x: d,
      y: f,
