  ...
  c = e => {
    switch (e.type) {
      case i.L.FIRST_PARTY:
        return {
          type: i.L.FIRST_PARTY, tasks: s(e.tasks), joinOperator: e.join_operator
        };
      case i.L.THIRD_PARTY:
        return {
          type: i.L.THIRD_PARTY, tasks: l(e.tasks), enrollmentUrl: e.enrollment_url, developerApplicationId: e.developer_application_id, joinOperator: e.join_operator
        }
    }
  },
  u = e => {
