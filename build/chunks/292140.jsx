...
var Chunk481060 = require("./481060.js"),
  ...
  Chunk555927 = require("./555927.js"),
  Chunk738762 = require("./738762.js"),
...
function g(e) {
  ...
  }), <i.v2r navId={"now-playing-menu"} onClose={n} aria-label={h.intl.string(h.t.ogxXGh)} onSelect={g}>{m}{<i.kSQ>{b}{_}</i.kSQ>}{<i.kSQ>{O}</i.kSQ>}{<i.kSQ>{E}</i.kSQ>}{y}</i.v2r>
}