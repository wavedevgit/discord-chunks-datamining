...
let el = q.ZP.getEnableHardwareAcceleration() ? f.Xo$ : f.qEK,
  ...
  eu = e => {
    var {
      ...
      "aria-setsize": I,
      listItemRef: O
    } = e, T = en(e, ["route", "selected", "icon", "iconClassName", "avatarWithTextClassName", "interactiveClassName", "text", "children", "locationState", "onClick", "className", "role", "aria-posinset", "aria-setsize", "listItemRef"]);
    ...
    return (0, l.jsx)(v.Z, {
      ...
      children: (0, l.jsx)(f.vjx, {
        as: "div",
        selected: n,
        className: o()(s, $.interactive, $.linkButton, {
          [$.interactiveSelected]: n
        }),
        children: (0, l.jsxs)(u.rU, et(ee({
          to: {
            pathname: t,
            state: C
          },
...
function ec(e) {
  ...
  let {
    ...
    "aria-posinset": K,
    "aria-setsize": Y
  } = e, [Q, q] = r.useState(!1), eu = r.useRef(null), ec = r.useRef(null), {
    avatarSrc: ed,
  ...
  })), eh = (0, E.e7)([B.ZP], () => B.ZP.getMentionCount(i.id) > 0), eg = (0, P.ZP)(i), eI = (0, E.e7)([R.Z], () => R.Z.isFavorite(i.id)), eO = (0, G.L)("PrivateChannel"), eT = (0, j.AK)("PrivateChannel") ? null != F && (d || Q) : null != F, eS = () => {
    q(!0)
  }, eN = () => {
    q(!1)
  }, eA = function(e) {
    ...
    let t = J.NW.formatToPlainString(J.t.hJ5Ap6, {
        name: eg
      }),
      r = J.NW.format(J.t.SSIVOj, {
        name: eg
      });
    i.isManaged() && (t = J.NW.formatToPlainString(J.t.hVGjER, {
      name: eg
    }), r = J.NW.format(J.t.IK1Qvr, {
      name: eg
    })), (0, f.ZDy)(async () => {
      let {
        default: e
      } = await n.e("14604").then(n.bind(n, 960670));
      return n => (0, l.jsx)(e, ee({
        header: t,
        body: r,
        onSubmit: eA
      }, n))
    })
  }, ey = () => i.isSystemDM() ? (0, l.jsx)("div", {
    className: $.subtext,
    ...
    let e = f.EFr.SIZE_32;
    if (i.isMultiUserDM())
      if (i.recipients.length >= 2 && a && null == i.icon) return (0, l.jsx)(Z.Z, {
        "aria-hidden": !0,
      ...
      else return (0, l.jsx)(el, et(ee({}, ef), {
        src: (0, m.x)(i),
        "aria-hidden": !0,
        size: e,
    ...
    let t = null;
    return h.isSystemUser() || (t = (0, p.Z)(I) ? X.Skl.STREAMING : x), (0, l.jsx)(el, et(ee({}, ef), {
      size: f.EFr.SIZE_32,
      src: ed,
      avatarDecoration: eE,
      status: t,
  ...
  }, eD = i.isMultiUserDM(), eZ = i.isSystemDM(), ej = (0, k.Q)(), eU = !eD && !eZ && i.type === X.d4z.DM, ex = eU && (null == h ? void 0 : h.primaryGuild) != null, ew = eU && e_, eM = eU && ep, eG = ex ? (0, l.jsxs)(l.Fragment, {
    children: [eg, (0, l.jsx)(b.ZP, {
  ...
  }) : eg, ek = null != (t = eC || ew || eM) && t, eH = r.useRef(null);
  return (0, l.jsx)(c.mh, {
    id: i.id,
    children: e => {
      var {
      ...
      return (0, l.jsxs)(v.Z, {
        ...
        children: [eO && eh ? (0, l.jsx)("div", {
          ...
          })), eI ? (0, l.jsx)(eo, {}) : null, ew ? (0, l.jsx)(ea, {}) : null, eM ? (0, l.jsx)(es, {}) : null, (0, l.jsx)(ei, {
...
let ed = e => {
  ...
  let i = (0, E.e7)([Y.default], () => Y.default.getUser(t.getRecipientId())),
    ...
    _ = (0, E.e7)([Y.default, K.Z], () => {
      if (t.isMultiUserDM())
        if (a) return Q.default.keys(K.Z.getTypingUsers(t.id)).some(e => {
          var t;
  ...
  return t.isMultiUserDM() ? (0, l.jsx)(ec, ee({
    channel: t,
    selected: n,
    isTyping: _,
