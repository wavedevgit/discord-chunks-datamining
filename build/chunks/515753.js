...
function eu(e) {
  let {
    ...
    "aria-posinset": q,
    "aria-setsize": X
  } = e, [J, ed] = r.useState(!1), [eu, em] = r.useState(!1), [ep, eg] = r.useState(!1), eh = r.useRef(null), ef = r.useRef(null), eb = null != Y ? Y : ef, {
    avatarSrc: ex,
  ...
  }), eE = t.isMultiUserDM(), eC = t.isSystemDM(), eO = (0, V.Q)(), ev = !eE && !eC && t.type === Q.d4z.DM, eS = ev && (null == m ? void 0 : m.primaryGuild) != null, eT = (0, p.e7)([K.ZP], () => K.ZP.isChannelMuted(t.getGuildId(), t.id)), {
    ignored: eI,
    blocked: eN
  } = (0, p.cj)([W.Z], () => ({
    ...
    eg(!0), t.isMultiUserDM() ? (0, f.jW)(e, async () => {
      let {
        default: e
            ...
            children: (0, i.jsx)(O.Z, {
              ...
              name: (0, i.jsx)(y.Z, {
                className: a()(ee.overflowTooltip, {
                  [ee.withDisplayNameStyles]: null == m ? void 0 : m.displayNameStyles
                }),
                children: eQ
              }),
