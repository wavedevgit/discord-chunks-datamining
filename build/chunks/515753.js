  ...
  ec = e => {
    ...
    return (0, r.jsx)(I.Z, {
      ...
      children: (0, r.jsx)(g.vjx, {
        as: "div",
        selected: n,
        className: a()(o, $.interactive, $.linkButton, {
          [$.interactiveSelected]: n
        }),
        children: (0, r.jsxs)(c.rU, et(ee({
          to: {
            pathname: t,
            state: p
          },
...
function ed(e) {
  ...
  let {
    ...
    "aria-posinset": z,
    "aria-setsize": K
  } = e, [q, X] = i.useState(!1), ec = i.useRef(null), ed = i.useRef(null), {
    avatarSrc: eu,
  ...
  })), eb = (0, m.e7)([F.ZP], () => F.ZP.getMentionCount(s.id) > 0), e_ = (0, v.ZP)(s), eN = (0, m.e7)([P.Z], () => P.Z.isFavorite(s.id)), ex = (0, B.L)("PrivateChannel"), eE = (0, Z.AK)("PrivateChannel") ? null != G && (u || q) : null != G, ej = () => {
    X(!0)
  }, eC = () => {
    X(!1)
  }, eO = function(e) {
    ...
    let t = J.NW.formatToPlainString(J.t.hJ5Ap6, {
      ...
      i = J.NW.format(J.t.SSIVOj, {
        name: e_
      });
    s.isManaged() && (t = J.NW.formatToPlainString(J.t.hVGjER, {
      name: e_
    }), i = J.NW.format(J.t.IK1Qvr, {
      name: e_
    })), (0, g.ZDy)(async () => {
      let {
        default: e
      } = await n.e("14604").then(n.bind(n, 960670));
      return n => (0, r.jsx)(e, ee({
        header: t,
        body: i,
        onSubmit: eO
      }, n))
    })
  }, eA = () => s.isSystemDM() ? (0, r.jsx)("div", {
    className: $.subtext,
    children: (0, C.Z)(s.id) ? J.NW.string(J.t.FL5T09) : J.NW.string(J.t.NnY5lZ)
  }) : s.isMultiUserDM() ? (0, r.jsx)("div", {
    className: $.subtext,
    children: J.NW.format(J.t.CxSA5O, {
      members: s.recipients.length + 1
    })
  }) : (0, _.Z)({
    activities: N,
    status: k,
    ...
    let e = g.EFr.SIZE_32;
    if (s.isMultiUserDM())
      if (s.recipients.length >= 2 && l && null == s.icon) return (0, r.jsx)(D.Z, {
        "aria-hidden": !0,
      ...
      else return (0, r.jsx)(er, et(ee({}, eg), {
        src: (0, S.x)(s),
        "aria-hidden": !0,
        size: e,
    ...
    let t = null;
    return b.isSystemUser() || (t = (0, f.Z)(N) ? Q.Skl.STREAMING : k), (0, r.jsx)(er, et(ee({}, eg), {
      size: g.EFr.SIZE_32,
      src: eu,
      avatarDecoration: em,
      status: t,
  ...
  }, eR = s.isMultiUserDM(), eD = s.isSystemDM(), eZ = (0, M.Q)(), ew = !eR && !eD && s.type === Q.d4z.DM, ek = ew && (null == b ? void 0 : b.primaryGuild) != null, eW = ew && eh, eL = ew && ef, eB = ek ? (0, r.jsxs)(r.Fragment, {
    children: [e_, (0, r.jsx)(T.ZP, {
  ...
  }) : e_, eM = null != (t = ep || eW || eL) && t, eU = i.useRef(null);
  return (0, r.jsx)(d.mh, {
    id: s.id,
    children: e => {
      var {
        ...
        children: [ex && eb ? (0, r.jsx)("div", {
          ...
          children: [(0, r.jsx)(L.Z, {
            ...
            children: (0, r.jsx)(j.Z, {
              ...
              decorators: s.isSystemDM() ? (0, r.jsx)(E.Z, {
                className: $.decorator,
                type: E.Z.Types.SYSTEM_DM,
                verified: !0
              }) : null
            })
          })), eN ? (0, r.jsx)(ea, {}) : null, eW ? (0, r.jsx)(el, {}) : null, eL ? (0, r.jsx)(eo, {}) : null, (0, r.jsx)(es, {
...
let eu = 12633 == n.j ? e => {
  ...
  return t.isMultiUserDM() ? (0, r.jsx)(ed, ee({
    channel: t,
    selected: n,
    isTyping: h,
