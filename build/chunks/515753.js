...
let en = Q.ZP.getEnableHardwareAcceleration() ? f.Xo$ : f.qEK,
  ...
  er = e => {
    ...
    return (0, l.jsx)(f.P3F, ee($({
      className: o()(J.closeButton, {
  ...
  es = e => {
    ...
    return (0, l.jsx)(v.Z, {
      ...
      children: (0, l.jsx)(f.vjx, {
        as: "div",
        selected: n,
        className: o()(s, J.interactive, J.linkButton, {
          [J.interactiveSelected]: n
        }),
        children: (0, l.jsxs)(u.rU, ee($({
          to: {
            pathname: t,
            state: C
          },
...
function eu(e) {
  ...
  let {
    ...
    "aria-posinset": W,
    "aria-setsize": z
  } = e, [Y, Q] = r.useState(!1), es = r.useRef(null), eu = r.useRef(null), {
    avatarSrc: ec,
  ...
  })), ep = (0, E.e7)([F.ZP], () => F.ZP.getMentionCount(i.id) > 0), eh = (0, P.ZP)(i), eg = (0, E.e7)([R.Z], () => R.Z.isFavorite(i.id)), eI = (0, M.L)("PrivateChannel"), eO = () => {
    Q(!0)
  }, eT = () => {
    Q(!1)
  }, eS = function(e) {
    ...
    let t = X.NW.formatToPlainString(X.t.hJ5Ap6, {
        name: eh
      }),
      r = X.NW.format(X.t.SSIVOj, {
        name: eh
      });
    i.isManaged() && (t = X.NW.formatToPlainString(X.t.hVGjER, {
      name: eh
    }), r = X.NW.format(X.t.IK1Qvr, {
      name: eh
    })), (0, f.ZDy)(async () => {
      let {
        default: e
    ...
    className: J.subtext,
    children: X.NW.format(X.t.CxSA5O, {
    ...
    let t = null;
    return h.isSystemUser() || (t = (0, p.Z)(I) ? q.Skl.STREAMING : U), (0, l.jsx)(en, ee($({}, eE), {
      size: f.EFr.SIZE_32,
      src: ec,
      avatarDecoration: ed,
      status: t,
  ...
  }, ey = i.isMultiUserDM(), eR = i.isSystemDM(), eD = (0, G.Q)(), eZ = !ey && !eR && i.type === q.d4z.DM, ej = eZ && (null == h ? void 0 : h.primaryGuild) != null, eU = eZ && eC, ex = eZ && e_, ew = ej ? (0, l.jsxs)(l.Fragment, {
    children: [eh, (0, l.jsx)(b.ZP, {
  ...
  }) : eh, eM = null != (t = ef || eU || ex) && t, eG = r.useRef(null);
  return (0, l.jsx)(c.mh, {
    id: i.id,
    children: e => {
      var {
      ...
      return (0, l.jsxs)(v.Z, {
        ...
        "aria-setsize": z,
        "aria-posinset": W,
        children: [eI && ep ? (0, l.jsx)("div", {
          className: o()(J.unreadPill, {
            [J.muted]: eM
          })
        }) : null, (0, l.jsxs)(f.vjx, {
...
let ec = e => {
  ...
  let i = (0, E.e7)([z.default], () => z.default.getUser(t.getRecipientId())),
    ...
    _ = (0, E.e7)([z.default, W.Z], () => {
      if (t.isMultiUserDM())
        if (a) return Y.default.keys(W.Z.getTypingUsers(t.id)).some(e => {
          var t;
