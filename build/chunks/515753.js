...
function ed(e) {
  let {
    ...
    "aria-posinset": G,
    "aria-setsize": z
  } = e, [K, q] = i.useState(!1), X = i.useRef(null), ec = i.useRef(null), {
    avatarSrc: ed,
    ...
    t.isMultiUserDM() ? (0, h.jW)(e, async () => {
      ...
      let {
        default: e
      } = await Promise.all([n.e("26881"), n.e("70205"), n.e("4040"), n.e("53912"), n.e("98254"), n.e("56826"), n.e("15552")]).then(n.bind(n, 131404));
      return n => (0, r.jsx)(e, et(ee({}, n), {
        user: u,
        channel: t,
        channelSelected: l
    ...
    let i = J.NW.formatToPlainString(J.t.hJ5Ap6, {
        name: eS
      }),
      s = J.NW.format(J.t.SSIVOj, {
        name: eS
      });
    t.isManaged() && (i = J.NW.formatToPlainString(J.t.hVGjER, {
      name: eS
    }), s = J.NW.format(J.t.IK1Qvr, {
      name: eS
    })), (0, g.ZDy)(async () => {
      let {
        default: e
    ...
    let e = g.EFr.SIZE_32;
    if (t.isMultiUserDM())
      if (t.recipients.length >= 2 && s && null == t.icon) return (0, r.jsx)(D.Z, {
        "aria-hidden": !0,
      ...
      else return (0, r.jsx)(er, et(ee({}, em), {
        src: (0, S.x)(t),
        "aria-hidden": !0,
        size: e,
    ...
    children: e => {
      ...
      return (0, r.jsxs)(I.Z, {
        ...
        children: [eT && eO ? (0, r.jsx)("div", {
          ...
          })), ev ? (0, r.jsx)(ea, {}) : null, eE ? (0, r.jsx)(el, {}) : null, ej ? (0, r.jsx)(eo, {}) : null, (0, r.jsx)(es, {
