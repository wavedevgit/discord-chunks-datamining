    ...
    return (0, r.jsx)(f.P3F, $(J({
      ...
      children: (0, r.jsx)("div", {
        ...
        children: (0, r.jsx)(f.Dio, {
          size: "md",
          color: "currentColor",
          className: o()(X.closeIcon, {
            [X.closeIconPlated]: null != t
          })
        })
      })
    }))
  ...
  ea = e => {
    ...
    return (0, r.jsx)(P.Z, {
      ...
      children: (0, r.jsx)(f.vjx, {
        as: "div",
        selected: n,
        className: o()(s, X.interactive, X.linkButton, {
          [X.interactiveSelected]: n
        }),
        children: (0, r.jsxs)(c.rU, $(J({
          to: {
            pathname: t,
            state: p
          },
...
function es(e) {
  ...
  let {
    ...
    "aria-posinset": B,
    "aria-setsize": z
  } = e, [K, Y] = l.useState(!1), ea = l.useRef(null), es = l.useRef(null), {
    avatarSrc: ec,
  ...
  })), eh = (0, E.e7)([F.ZP], () => F.ZP.getMentionCount(i.id) > 0), eC = (0, A.ZP)(i), e_ = (0, E.e7)([R.Z], () => R.Z.isFavorite(i.id)), eO = () => {
    Y(!0)
  }, eg = () => {
    Y(!1)
  }, eT = function(e) {
    ...
    i.isMultiUserDM() ? (0, h.jW)(e, async () => {
      let {
        default: e
      } = await Promise.all([n.e("79695"), n.e("70205"), n.e("53912"), n.e("20500")]).then(n.bind(n, 354741));
      ...
      let {
        default: e
      } = await Promise.all([n.e("79695"), n.e("70205"), n.e("98783"), n.e("72149"), n.e("53912"), n.e("56826"), n.e("67740")]).then(n.bind(n, 131404));
      return t => (0, r.jsx)(e, $(J({}, t), {
        user: _,
        channel: i,
        channelSelected: d
    ...
    let e = f.EFr.SIZE_32;
    if (i.isMultiUserDM()) return i.recipients.length >= 2 && a && null == i.icon ? (0, r.jsx)(D.Z, {
      "aria-hidden": !0,
    ...
    let t = null;
    return _.isSystemUser() || (t = (0, C.Z)(g) ? Q.Skl.STREAMING : U), (0, r.jsx)(et, $(J({}, ed), {
      size: f.EFr.SIZE_32,
      src: ec,
      avatarDecoration: eu,
      status: t,
  ...
  }, eP = i.isMultiUserDM(), ey = i.isSystemDM(), eL = (0, M.Q)(), eR = !eP && !ey && i.type === Q.d4z.DM, ej = eR && (null == _ ? void 0 : _.primaryGuild) != null, eD = eR && ef, eZ = eR && ep, eU = ej ? (0, r.jsxs)(r.Fragment, {
    children: [eC, (0, r.jsx)(m.ZP, {
  ...
  }) : eC, [ex, ew] = l.useState(!1), eM = null !== (t = eE || eD || eZ) && void 0 !== t && t, eG = l.useRef(null);
  return (0, r.jsx)(u.mh, {
    id: i.id,
    children: e => {
      var {
...
let ec = e => {
  ...
  let i = (0, E.e7)([z.default], () => z.default.getUser(t.getRecipientId())),
    ...
    h = (0, E.e7)([z.default, B.Z], () => t.isMultiUserDM() ? !!a && K.default.keys(B.Z.getTypingUsers(t.id)).some(e => {
      var t;
      return e !== (null === (t = z.default.getCurrentUser()) || void 0 === t ? void 0 : t.id)
    }) : null != i && B.Z.isTyping(t.id, t.getRecipientId()), [t, i, a]);
  return t.isMultiUserDM() ? (0, r.jsx)(es, J({
    channel: t,
    selected: n,
    isTyping: h,
