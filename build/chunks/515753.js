...
function ed(e) {
  let {
  ...
  }), ej = t.isMultiUserDM(), eE = t.isSystemDM(), eC = (0, U.Q)(), eO = !ej && !eE && t.type === J.d4z.DM, ev = eO && (null == u ? void 0 : u.primaryGuild) != null, eS = (0, m.e7)([Y.ZP], () => Y.ZP.isChannelMuted(t.getGuildId(), t.id)), {
    ignored: eT,
    blocked: eN
  } = (0, m.cj)([z.Z], () => ({
    ignored: z.Z.isIgnored(t.getRecipientId()),
    blocked: z.Z.isBlocked(t.getRecipientId())
  })), eI = eO && eT, ey = eO && eN, eA = (eS || eI || ey) && !(l || X), eP = (0, m.e7)([H.ZP], () => H.ZP.getMentionCount(t.id) > 0), eR = (0, T.ZP)(t), eD = (0, m.e7)([P.Z], () => P.Z.isFavorite(t.id)), {
    ...
    if (t.isMultiUserDM())
      ...
      else return (0, i.jsx)(ei, et(ee({}, e_), {
        src: (0, S.x)(t),
        "aria-hidden": !0,
        size: e,
    ...
    let n = null;
    return u.isSystemUser() || (n = (0, f.Z)(b) ? J.Skl.STREAMING : L), (0, i.jsx)(ei, et(ee({}, e_), {
      size: p.EFr.SIZE_32,
      src: eb,
      avatarDecoration: ex,
      status: n,
    ...
    children: e => {
      ...
      return (0, i.jsxs)(N.Z, {
        ...
        children: [eP ? (0, i.jsx)("div", {
          ...
          })), eD ? (0, i.jsx)(ea, {}) : null, eI ? (0, i.jsx)(el, {}) : null, ey ? (0, i.jsx)(eo, {}) : null, eZ ? (0, i.jsx)(es, {
            icon: p.xhG,
