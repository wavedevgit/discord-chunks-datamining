...
function ec(e) {
  let {
    ...
    "aria-posinset": Y,
    "aria-setsize": K
  } = e, [q, eo] = r.useState(!1), [ec, ed] = r.useState(!1), eu = r.useRef(null), em = r.useRef(null), ep = null != z ? z : em, {
    avatarSrc: eg,
  ...
  }), eb = t.isMultiUserDM(), ex = t.isSystemDM(), e_ = (0, M.Q)(), ej = !eb && !ex && t.type === X.d4z.DM, eE = ej && (null == u ? void 0 : u.primaryGuild) != null, eO = (0, m.e7)([W.ZP], () => W.ZP.isChannelMuted(t.getGuildId(), t.id)), {
    ignored: eC,
    blocked: ev
  } = (0, m.cj)([H.Z], () => ({
    ignored: H.Z.isIgnored(t.getRecipientId()),
    blocked: H.Z.isBlocked(t.getRecipientId())
  })), eS = ej && eC, eT = ej && ev, eN = (eO || eS || eT) && !(l || q), eI = (0, m.e7)([F.ZP], () => F.ZP.getMentionCount(t.id) > 0), ey = (0, T.ZP)(t), eA = (0, m.e7)([P.Z], () => P.Z.isFavorite(t.id)), eP = null != G && (l || q), eR = () => {
    eo(!0)
  }, eD = () => {
    eo(!1)
  }, eZ = () => {
    ...
    if (t.isMultiUserDM())
      ...
      else return (0, i.jsx)(en, ee($({}, ef), {
        src: (0, S.x)(t),
        "aria-hidden": !0,
        size: e,
        status: w ? X.Skl.ONLINE : k,
        isTyping: w
      }));
    o()(null != u, "PrivateChannel.renderAvatar: Invalid prop configuration - no user or channel");
    let n = null;
    return u.isSystemUser() || (n = (0, f.Z)(b) ? X.Skl.STREAMING : k), (0, i.jsx)(en, ee($({}, ef), {
      size: p.EFr.SIZE_32,
      src: eg,
      avatarDecoration: eh,
      status: n,
    ...
    effectDisplayType: q || l ? y.F.ANIMATED : y.F.PLAIN
  }), ez = eE ? (0, i.jsxs)(i.Fragment, {
    children: [eH, (0, i.jsx)(Z.ZP, {
...
let ed = 12633 == n.j ? e => {
  ...
  let s = (0, m.e7)([Y.default], () => Y.default.getUser(t.getRecipientId())),
    ...
    h = (0, m.e7)([Y.default, z.Z], () => {
      if (t.isMultiUserDM())
        if (l) return K.default.keys(z.Z.getTypingUsers(t.id)).some(e => {
          var t;
