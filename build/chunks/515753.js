...
function es(e) {
  ...
  let {
  ...
  })), ep = (0, E.e7)([V.ZP], () => V.ZP.getMentionCount(i.id) > 0), e_ = (0, b.ZP)(i), eh = (0, E.e7)([R.Z], () => R.Z.isFavorite(i.id)), eg = () => {
    Y(!0)
  }, eS = () => {
    Y(!1)
  }, eO = function(e) {
    ...
    let t = null;
    return h.isSystemUser() || (t = (0, _.Z)(S) ? Q.Skl.STREAMING : U), (0, l.jsx)(et, $(J({}, ed), {
      size: f.EFr.SIZE_32,
      src: eu,
      avatarDecoration: ec,
      status: t,
  ...
  }, ev = i.isMultiUserDM(), ey = i.isSystemDM(), eL = (0, M.Q)(), eR = !ev && !ey && i.type === Q.d4z.DM, eD = eR && (null == h ? void 0 : h.primaryGuild) != null, eZ = eR && ef, ej = eR && eC, eU = eD ? (0, l.jsxs)(l.Fragment, {
  ...
  }) : e_, ex = null != (t = eE || eZ || ej) && t, ew = r.useRef(null);
  return (0, l.jsx)(c.mh, {
    id: i.id,
    children: e => {
      var {
      ...
      return (0, l.jsxs)(v.Z, {
        ...
        children: [ep ? (0, l.jsx)("div", {
          ...
          })), eh ? (0, l.jsx)(er, {}) : null, eZ ? (0, l.jsx)(ei, {}) : null, ej ? (0, l.jsx)(eo, {}) : null, (0, l.jsx)(el, {
