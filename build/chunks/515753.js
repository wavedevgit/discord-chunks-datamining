...
let ei = X.ZP.getEnableHardwareAcceleration() ? p.Xo$ : p.qEK,
  ...
  ec = e => {
    var {
      ...
      "aria-setsize": x,
      listItemRef: _
    } = e, j = en(e, ["route", "selected", "icon", "iconClassName", "interactiveClassName", "text", "children", "locationState", "onClick", "className", "role", "aria-posinset", "aria-setsize", "listItemRef"]);
    return (0, i.jsx)(N.Z, {
      className: a()($.channel, {
        [$.fullWidth]: u.tq
      }, h),
      ...
      children: (0, i.jsx)(p.vjx, {
        as: "div",
        selected: n,
        className: a()(l, $.interactive, $.linkButton, {
          [$.interactiveSelected]: n
        }),
        children: (0, i.jsxs)(c.rU, et(ee({
          to: {
            pathname: t,
            state: m
          },
...
function ed(e) {
  let {
    ...
    "aria-posinset": K,
    "aria-setsize": q
  } = e, [X, ec] = r.useState(!1), [ed, eu] = r.useState(!1), em = r.useRef(null), ep = r.useRef(null), eg = null != W ? W : ep, {
    avatarSrc: eh,
  ...
  }), ex = t.isMultiUserDM(), e_ = t.isSystemDM(), ej = (0, U.Q)(), eE = !ex && !e_ && t.type === J.d4z.DM, eO = eE && (null == u ? void 0 : u.primaryGuild) != null, eC = (0, m.e7)([Y.ZP], () => Y.ZP.isChannelMuted(t.getGuildId(), t.id)), {
    ignored: ev,
    blocked: eS
  } = (0, m.cj)([z.Z], () => ({
    ignored: z.Z.isIgnored(t.getRecipientId()),
    blocked: z.Z.isBlocked(t.getRecipientId())
  })), eT = eE && ev, eN = eE && eS, eI = (eC || eT || eN) && !(l || X), ey = (0, m.e7)([H.ZP], () => H.ZP.getMentionCount(t.id) > 0), eA = (0, T.ZP)(t), eP = (0, m.e7)([P.Z], () => P.Z.isFavorite(t.id)), eR = (0, M.L)("PrivateChannel"), eD = null != F && (l || X), eZ = () => {
    ec(!0)
  }, ew = () => {
    ec(!1)
  }, ek = () => {
    ...
    if (t.isMultiUserDM())
      ...
      else return (0, i.jsx)(ei, et(ee({}, eb), {
        src: (0, S.x)(t),
        "aria-hidden": !0,
        size: e,
    ...
    let n = null;
    return u.isSystemUser() || (n = (0, f.Z)(b) ? J.Skl.STREAMING : k), (0, i.jsx)(ei, et(ee({}, eb), {
      size: p.EFr.SIZE_32,
      src: eh,
      avatarDecoration: ef,
      status: n,
  ...
  }), eY = eO ? (0, i.jsxs)(i.Fragment, {
    children: [eW, (0, i.jsx)(Z.ZP, {
    ...
    children: e => {
      ...
      return (0, i.jsxs)(N.Z, {
        ...
        children: [eR && ey ? (0, i.jsx)("div", {
          ...
          })), eP ? (0, i.jsx)(ea, {}) : null, eT ? (0, i.jsx)(el, {}) : null, eN ? (0, i.jsx)(eo, {}) : null, (0, i.jsx)(es, {
