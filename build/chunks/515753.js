...
function es(e) {
  ...
  let {
  ...
  })), e_ = (0, E.e7)([V.ZP], () => V.ZP.getMentionCount(i.id) > 0), ep = (0, v.ZP)(i), eC = (0, E.e7)([Z.Z], () => Z.Z.isFavorite(i.id)), eO = () => {
    Y(!0)
  }, eg = () => {
    Y(!1)
  }, eT = function(e) {
    ...
    let e = f.EFr.SIZE_32;
    if (i.isMultiUserDM()) return i.recipients.length >= 2 && a && null == i.icon ? (0, l.jsx)(R.Z, {
      "aria-hidden": !0,
    ...
    let t = null;
    return C.isSystemUser() || (t = (0, p.Z)(g) ? Q.Skl.STREAMING : U), (0, l.jsx)(et, $(J({}, ed), {
      size: f.EFr.SIZE_32,
      src: ec,
      avatarDecoration: eu,
      status: t,
  ...
  }, eP = i.isMultiUserDM(), ey = i.isSystemDM(), eL = (0, M.Q)(), eZ = !eP && !ey && i.type === Q.d4z.DM, eD = eZ && (null == C ? void 0 : C.primaryGuild) != null, eR = eZ && ef, ej = eZ && eh, eU = eD ? (0, l.jsxs)(l.Fragment, {
    children: [ep, (0, l.jsx)(m.ZP, {
  ...
  }) : ep, ex = null !== (t = eE || eR || ej) && void 0 !== t && t, ew = r.useRef(null);
  return (0, l.jsx)(u.mh, {
    id: i.id,
    children: e => {
      var {
      ...
      return (0, l.jsx)(P.Z, {
        ...
        children: (0, l.jsxs)(f.vjx, {
          ...
          })), eC ? (0, l.jsx)(er, {}) : null, eR ? (0, l.jsx)(ei, {}) : null, ej ? (0, l.jsx)(eo, {}) : null, (0, l.jsx)(el, {
...
let ec = e => {
  ...
  let i = (0, E.e7)([K.default], () => K.default.getUser(t.getRecipientId())),
    ...
    _ = (0, E.e7)([K.default, B.Z], () => t.isMultiUserDM() ? !!a && z.default.keys(B.Z.getTypingUsers(t.id)).some(e => {
      var t;
