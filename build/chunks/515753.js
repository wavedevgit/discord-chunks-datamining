  ...
  en = e => {
    ...
    return (0, l.jsx)(f.P3F, J(X({
      ...
      children: (0, l.jsx)("div", {
        style: n,
        className: o()({
          [q.closeButtonBackgroundPlated]: null != t
        }),
        children: (0, l.jsx)(f.Dio, {
          size: "md",
          color: "currentColor",
          className: o()(q.closeIcon, {
...
function ea(e) {
  ...
  let {
    ...
    "aria-posinset": F,
    "aria-setsize": W
  } = e, [K, z] = r.useState(!1), eo = r.useRef(null), ea = r.useRef(null), {
    avatarSrc: es,
  ...
  })), eh = (0, E.e7)([k.ZP], () => k.ZP.getMentionCount(i.id) > 0), e_ = (0, v.ZP)(i), ep = (0, E.e7)([Z.Z], () => Z.Z.isFavorite(i.id)), eC = () => {
    z(!0)
  }, eO = () => {
    z(!1)
  }, eg = function(e) {
    ...
    let t = null;
    return C.isSystemUser() || (t = (0, p.Z)(g) ? Y.Skl.STREAMING : U), (0, l.jsx)(ee, J(X({}, eu), {
      size: f.EFr.SIZE_32,
      src: es,
      avatarDecoration: ec,
      status: t,
  ...
  }, em = i.isMultiUserDM(), eP = i.isSystemDM(), ey = (0, w.Q)(), eL = !em && !eP && i.type === Y.d4z.DM, eZ = eL && (null == C ? void 0 : C.primaryGuild) != null, eD = eL && eE, eR = eL && ef, ej = eZ ? (0, l.jsxs)(l.Fragment, {
    children: [e_, (0, l.jsx)(m.ZP, {
  ...
  }) : e_, eU = null !== (t = ed || eD || eR) && void 0 !== t && t, ex = r.useRef(null);
  return (0, l.jsx)(u.mh, {
    id: i.id,
    children: e => {
      var {
      ...
      return (0, l.jsx)(P.Z, {
        ...
        children: (0, l.jsxs)(f.vjx, {
          ...
          })), ep ? (0, l.jsx)(el, {}) : null, eD ? (0, l.jsx)(er, {}) : null, eR ? (0, l.jsx)(ei, {}) : null, (0, l.jsx)(en, {
...
let es = e => {
  ...
  let i = (0, E.e7)([W.default], () => W.default.getUser(t.getRecipientId())),
    ...
    _ = (0, E.e7)([W.default, F.Z], () => t.isMultiUserDM() ? !!a && K.default.keys(F.Z.getTypingUsers(t.id)).some(e => {
      var t;
      return e !== (null === (t = W.default.getCurrentUser()) || void 0 === t ? void 0 : t.id)
    }) : null != i && F.Z.isTyping(t.id, t.getRecipientId()), [t, i, a]);
  return t.isMultiUserDM() ? (0, l.jsx)(ea, X({
    channel: t,
    selected: n,
    isTyping: _,
