...
function d(e, t) {
  ...
  return {
    ...
    qualityFrameDrops: null != (D = null == (h = x.encoderQualityStats) ? true : h.frameDrops) ? D : true,
    qualitySizeMismatches: null != (w = null == (m = x.encoderQualityStats) ? true : m.sizeMismatches) ? w : true,
    filter: e.filter,
