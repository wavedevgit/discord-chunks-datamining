...
var Chunk627968 = require("./627968.js"),
  ...
  Chunk717115 = require("./717115.jsx"),
  Chunk506849 = require("./506849.jsx"),
...
function J(e) {
  let {
    ...
    return [e, (null == e ? true : e.parent_id) != null ? _.A.getChannel(e.parent_id) : null]
  });
  return null == l ? t : (0, i.jsx)(g.X, {
    icon: (0, A.gU)(l),
    title: t,
    subtitle: null == s ? true : s.name
  })
}
...
function z(e) {
  ...
  } = e, a = null != (t = null == n ? true : n.selected_time_window) ? t : U.Xx.ALWAYS;
    ...
    children: [(0, i.jsx)(x.lVW, {
      ...
      children: (0, i.jsxs)(o.D0$, {
        ...
        children: [(0, i.jsx)(x.dOG, {
          ...
          checked: !(null == l ? true : l.disableRaidAlertNag),
          ...
          checked: !(null == l ? true : l.disableRaidAlertPush),
          onChange: e => (0, S.TG)(t, t => {
