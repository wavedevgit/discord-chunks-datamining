...
function b(e) {
  ...
  return i.useEffect(() => {
    (null == x ? void 0 : x.id) == null && h.Z.fetchGuildEvent(n, b), m.Z.getGuildEventUserCounts(n, b, null != y ? [y] : []), m.Z.getGuildEventsForCurrentUser(n)
  }, [b, n, null == x ? void 0 : x.id, y]), (0, r.jsx)(g.ZP, {
    guild: E,
    channel: v,
    guildScheduledEvent: x,
    isMember: O,
