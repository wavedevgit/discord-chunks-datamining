...
function b(e) {
  ...
  return i.useEffect(() => {
    (null == x ? void 0 : x.id) == null && h.Z.fetchGuildEvent(n, b), m.Z.getGuildEventUserCounts(n, b, null != E ? [E] : []), m.Z.getGuildEventsForCurrentUser(n)
  }, [b, n, null == x ? void 0 : x.id, E]), (0, r.jsx)(g.ZP, {
    guild: y,
    channel: v,
    guildScheduledEvent: x,
    isMember: C,
