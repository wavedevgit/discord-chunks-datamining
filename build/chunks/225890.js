...
function b(e) {
  ...
  return i.useEffect(() => {
    (null == E ? void 0 : E.id) == null && h.Z.fetchGuildEvent(n, b), m.Z.getGuildEventUserCounts(n, b, null != y ? [y] : []), m.Z.getGuildEventsForCurrentUser(n)
  }, [b, n, null == E ? void 0 : E.id, y]), (0, r.jsx)(g.ZP, {
    guild: x,
    channel: v,
    guildScheduledEvent: E,
    isMember: O,
