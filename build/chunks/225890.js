...
function b(e) {
  ...
  return i.useEffect(() => {
    (null == y ? void 0 : y.id) == null && h.Z.fetchGuildEvent(n, b), m.Z.getGuildEventUserCounts(n, b, null != E ? [E] : []), m.Z.getGuildEventsForCurrentUser(n)
  }, [b, n, null == y ? void 0 : y.id, E]), (0, r.jsx)(g.ZP, {
    guild: x,
    channel: v,
    guildScheduledEvent: y,
    isMember: O,
