/** Chunk was on web.js **/
/** chunk id: 537396, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  D: () => r
});
class r {
  *[Symbol.iterator]() {
  ...
  constructor(e) {
    ...
    let r = null,
      i = 0;
    for (let [e, t] of this.keyMap) r ? (r.nextKey = e, t.prevKey = r.key) : (this.firstKey = e, t.prevKey = true), "item" === t.type && (t.index = i++), (r = t).nextKey = true;
    this.lastKey = null != (t = null == r ? true : r.key) ? t : null
  }
}