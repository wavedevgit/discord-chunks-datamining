...
let p = (e, t) => (null == e ? true : e.status) === c.Vq.EARNED ? u.intl.format(u.t.Hu4jfn, {
  ...
  g = () => {
    ...
    return <div className={Chunk536564.container} style={j}>{<div />}{" "}{<img src={Chunk120356} alt={x} className={s()(Chunk536564.badgeImage, {
          [Chunk536564.upcomingBadge]: exports.status === Chunk848572.Vq.UPCOMING,
          [Chunk536564.wide]: b
        })} />}{<div className={Chunk536564.textColumn}>{<Chunk793030.xv variant={"text-lg/semibold"} className={Chunk536564.badgeText}>{x}</Chunk793030.xv>}{<Chunk793030.xv variant={"text-md/normal"} className={Chunk536564.badgeText}>{_}</Chunk793030.xv>}{<Chunk793030.xv variant={"text-xs/normal"}>{p(exports, require)}</Chunk793030.xv>}</div>}</div>
  }