...
function S() {
  let [e, t] = r.useState(""), a = r.useRef(null), l = (0, u.Wu)([f.Z], () => f.Z.loggedTriggers), s = r.useMemo(() => l.filter(t => 0 === e.length || o()(e, t.experimentId)).sort((e, t) => t.timestamp.getTime() - e.timestamp.getTime()), [l, e]), [c, d] = r.useState(void 0), p = s.find(e => e.key === c), {
    TabBar: b,
    renderSelectedTab: j
  } = (0, y.ZP)({
    tabs: E
