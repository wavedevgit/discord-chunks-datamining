...
function el(e) {
  ...
  }), v = (0, a.e7)([G.default], () => G.default.showKeybindIndicators), _ = (0, a.e7)([A.default], () => A.default.getId()), b = (0, a.e7)([z.Z], () => z.Z.isLocalMute(i.id)), E = (0, a.e7)([R.Z], () => R.Z.getCurrentUserActiveStream()), S = (0, a.Wu)([R.Z], () => null != E ? R.Z.getViewerIds(E) : []), x = (0, y.Z)({
    userId: i.id,
    context: f
...
class es extends(i = o.PureComponent) {
  ...
  renderHeader() {
    ...
    return (0, r.jsxs)(Q.ZP.Bar, {
      className: s()(en.draggableStartArea, {
        [en.preview]: n
      }),
      children: [(0, r.jsxs)(Q.ZP.Content, {
        dynamicSize: !0,
        className: s()(en.content, {
          [en.hidden]: n
        }),
    ...
    return (0, r.jsx)(Q.ZP.Bar, {
      ...
      children: (0, r.jsxs)(Q.ZP.Content, {
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [(null == c ? void 0 : c.id) != null && c.id === (null == l ? void 0 : l.id) ? (0, r.jsx)(E.Z, {
  ...
  render() {
    ...
    let c = $.t_t.UNPINNED;
    return i && (c = $.t_t.PINNED), o && (c = $.t_t.IN_GAME_PREVIEW), n && (c = $.t_t.IN_GAME), (0, r.jsxs)(Q.ZP, {
      type: c,
      width: 380,
...
function ea(e) {
  ...
  return (0, r.jsx)(es, eo(er(eo(er({}, h), {
    application: u
  }), e), {
    sortedVoiceStates: l,
    channel: n,
