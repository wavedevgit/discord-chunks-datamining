...
let u = e => {
  ...
  return <i.Is inputRef={u} inputClassName={s.input} error={d ? "" : true} minLength={2} value={t} onChange={h} placeholder={o.intl.string(o.t.U2JFHR)} name={"emoji_name"} onBlur={g} onFocus={f} required={true} />
}