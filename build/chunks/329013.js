...
let R = () => {
  ...
  D = () => {
    ...
    let {
    ...
    } = (0, m.ZP)(g.Z.USER_SETTINGS), l = (0, s.e7)([h.Z], () => h.Z.isPreview), a = (null == (t = (0, E.N)()) || null == (e = t.subscription_trial) ? void 0 : e.sku_id) === y.Si.TIER_2, c = (0, x.Ng)(), d = (0, x.Wp)(c, y.Si.TIER_2), u = !l || a, {
      enabled: p
      ...
      autoTrackExposure: !u,
      disable: u
    }), _ = (0, b.Q3)("UserSettingsAppearanceClientThemes"), T = () => !l || a ? null : (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsx)(o.zxk, {
        ...
        textOptions: {
          textOverride: p ? A.intl.string(A.t.pj0XBA) : d ? A.intl.formatToPlainString(A.t.bkQ4bG, {
    ...
    return r.useEffect(() => {
      l && v.default.track(I.rMx.PREMIUM_UPSELL_VIEWED, {
      ...
      children: [(0, i.jsx)(f.ZP, {
        ...
        children: p ? (0, i.jsxs)(i.Fragment, {
          children: [(0, i.jsx)(f.ZP.BasicAndGradient, {
...
function Z() {
  ...
  return e !== I.BRd.LIGHT ? null : (0, i.jsx)(o.j7V, {
    hideBorder: !0,
    value: r && (0, a.ap)(e) && !t,
