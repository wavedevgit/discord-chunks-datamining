...
function v(e) {
  ...
  })), C = (0, i.vh)(t.id), A = t.id === v.id, L = (0, c.I5)(v), w = s.ZP.useName(null == Z ? void 0 : Z.guildId, _, t), R = (0, h.Z)({
    user: t,
    currentUser: v,
    guildId: x,
    initialSubsection: N
  ...
  return (0, o.jsxs)("div", {
    ...
    }), S === y.OGo.PENDING_INCOMING && (0, o.jsx)(b.Z.Overlay, {
