...
function v(e) {
  ...
  })), C = (0, i.vh)(t.id), A = t.id === v.id, L = (0, c.I5)(v), w = s.ZP.useName(null == O ? void 0 : O.guildId, _, t), R = (0, g.Z)({
    user: t,
    currentUser: v,
    guildId: x,
    initialSubsection: N
  ...
  return (0, r.jsxs)("div", {
    ...
    }), S === h.OGo.PENDING_INCOMING && (0, r.jsx)(b.Z.Overlay, {
