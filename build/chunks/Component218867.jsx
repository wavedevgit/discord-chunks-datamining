...
let d = Chunk647438.memo(Chunk647438.forwardRef((e, t) => {
  let {
    ...
    role: R = "list"
  } = e, [P, w] = i.useState(false), [D, x] = i.useState(false), L = i.useRef(null), j = i.useRef(0), k = i.useRef(false);
  (0, l.Ng)(() => {
    var e;
  ...
  i.useImperativeHandle(t, () => ({
    ...
    scrollRowIntoView: function(e) {
      ...
      null != i && null != o && o.requestAnimationFrame(() => {
        ...
        } = i, c = G(a), u = s - (T ? c : 0) - r <= j.current, d = l + r >= j.current + D;
        if (u) {
          let i = j.current + c - s,
            o = T ? j.current - i : s;
          null == (t = L.current) || t.scrollTo({
  ...
  }, [U, B, G, Z, d, f, _, h, p, P, W, T, m, M, D]), Q = i.useMemo(() => {
    var e, t, n;
    return {
      top: X,
