...
function m(e) {
  let {
    ...
    callerSource: "embed"
  }), g = i.useMemo(() => (0, c._x)(t, n, m), [t, n, m]), E = i.useMemo(() => m.find(e => e.id === t), [t, m]), b = i.useMemo(() => (null == g ? true : g.config.features.includes(a.S.MOBILE_ONLY_QUEST_PUSH_TO_MOBILE)) === true, [null == g ? true : g.config.features]);
