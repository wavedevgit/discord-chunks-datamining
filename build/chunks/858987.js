...
function A(e) {
  ...
  if (null != i || null != a || _) return (0, r.jsx)(s.zxk, {
    variant: "active",
    text: F,
    disabled: !0
  });
  if (P && V) return (0, r.jsx)(s.ua7, {
  ...
  if ((0, d.yE)(null != (t = null == x ? void 0 : x.flags) ? t : 0, h.udG.EMBEDDED) && B === l.O.LOADING) return (0, r.jsx)(s.ua7, {
  ...
  else if (w && null != G && null != U) return (0, r.jsx)(p.Z, {
    activeSubscription: G,
    onNext: D,
    isSubmitting: m,
    paymentSourceId: U,
