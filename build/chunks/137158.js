  ...
  let {
    ...
    switch (t) {
      case p.QJ.MULTIPLE_CHOICE:
        return {
          icon: m.jE$, text: h.NW.string(h.t.ooKh3t)
        };
      case p.QJ.PARAGRAPH:
        return {
          icon: m.OvV, text: h.NW.string(h.t.gG0JBA)
        };
      case p.QJ.TEXT_INPUT:
        return {
          icon: (0, m.GSL)(g.Z), text: h.NW.string(h.t.w6Q9w8)
        };
      case p.QJ.TERMS:
        return {
          icon: m.snC, text: h.NW.string(h.t["3pz9t7"])
        };
      default:
        return null
    }
...
function j(e) {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [c === p.it.REGULAR ? (0, r.jsxs)("div", {
    ...
    }), "footer" === o && (0, r.jsxs)(m.hjN, {
      className: f.containerFooter,
      children: [(0, r.jsx)(m.ua7, {
        text: h.NW.string(h.t.FoxyPT),
        shouldShow: !a,
        children: e => {
          var t, n;
          return (0, r.jsx)(m.zxk, (t = x({}, e), n = n = {
            className: l()(f.removeButton, f.button),
            size: m.zxk.Sizes.SMALL,
            look: m.zxk.Looks.BLANK,
            onClick: s,
            disabled: !a,
            children: h.NW.string(h.t.N86XcH)
...
function _(e) {
  let {
    ...
    hover: (e, n) => {
      ...
      let {
        index: i
      } = e, s = null == (r = b.current) ? void 0 : r.getBoundingClientRect(), l = n.getClientOffset();
      if (null == s || null == l) return;
      let a = (s.bottom - s.top) / 2,
        o = l.y - s.top;
  ...
  return i.useLayoutEffect(() => (_(v(b)), () => {
    v(null), _(null)
  }), [_, v]), (0, r.jsxs)("div", {
    ref: b,
    "data-dnd-name": "field-".concat(t),
    className: l()(f.dragContainer, {
      [f.dropHovered]: s
    }),
    children: [(0, r.jsx)("div", {
      className: l()(f.dragIconContainer, {
...
function v(e) {
  return (0, r.jsxs)("div", {
    className: l()(f.formFieldContainer, {
    ...
    children: [(0, r.jsx)("div", {
      ...
      children: [(0, r.jsx)(m.P3F, {
        ...
        onClick: e.onEdit,
        "aria-label": h.NW.string(h.t.bt75u7),
