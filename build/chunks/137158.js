  ...
  let {
    ...
    switch (t) {
      case f.QJ.MULTIPLE_CHOICE:
        return {
          icon: g.jE$, text: h.intl.string(h.t.ooKh3t)
        };
      case f.QJ.PARAGRAPH:
        return {
          icon: g.OvV, text: h.intl.string(h.t.gG0JBA)
        };
      case f.QJ.TEXT_INPUT:
        return {
          icon: (0, g.GSL)(p.Z), text: h.intl.string(h.t.w6Q9w8)
        };
      case f.QJ.TERMS:
        return {
          icon: g.snC, text: h.intl.string(h.t["3pz9t7"])
        };
      default:
        return null
    }
...
function _(e) {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [c === f.it.REGULAR ? (0, r.jsxs)("div", {
...
function O(e) {
  let {
    ...
    onDrop: d,
    fieldStyle: m
  } = e, p = (0, a.debounce)(async (e, t, n) => {
    await d(e, t, n)
  }), h = i.useRef(null), [, j] = (0, o.c)({
    type: v,
    item: {
      index: t,
      field: n
    ...
    hover: (e, n) => {
      ...
      let {
        index: i
      } = e, l = null == (r = h.current) ? void 0 : r.getBoundingClientRect(), s = n.getClientOffset();
  ...
  return i.useLayoutEffect(() => (j(O(h)), () => {
    O(null), j(null)
  }), [j, O]), (0, r.jsxs)("div", {
    ref: h,
    "data-dnd-name": "field-".concat(t),
    className: s()(x.dragContainer, {
      [x.dropHovered]: l
    }),
    children: [(0, r.jsx)("div", {
      className: s()(x.dragIconContainer, {
        [x.compact]: m === f.it.COMPACT
      }),
...
function C(e) {
  return (0, r.jsxs)("div", {
    className: s()(x.formFieldContainer, {
