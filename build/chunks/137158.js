  ...
  let {
    ...
    switch (t) {
      case p.QJ.MULTIPLE_CHOICE:
        return {
          icon: m.jE$, text: f.NW.string(f.t.ooKh3t)
        };
      case p.QJ.PARAGRAPH:
        return {
          icon: m.OvV, text: f.NW.string(f.t.gG0JBA)
        };
      case p.QJ.TEXT_INPUT:
        return {
          icon: (0, m.GSL)(g.Z), text: f.NW.string(f.t.w6Q9w8)
        };
      case p.QJ.TERMS:
        return {
          icon: m.snC, text: f.NW.string(f.t["3pz9t7"])
        };
      default:
        return null
    }
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [c === p.it.REGULAR ? (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(m.ua7, {
        ...
        children: e => {
          var t, n;
          return (0, r.jsx)(m.zxk, (t = b({}, e), n = n = {
...
function v(e) {
  let {
    ...
    hover: (e, n) => {
      ...
      let {
        index: i
      } = e, s = null == (r = x.current) ? void 0 : r.getBoundingClientRect(), a = n.getClientOffset();
  ...
  return i.useLayoutEffect(() => (v(_(x)), () => {
    _(null), v(null)
  }), [v, _]), (0, r.jsxs)("div", {
    ref: x,
