...
function D(e) {
  ...
  } = e, l = (0, _.y)(t.id), D = (0, E.k5)(t.id), k = (0, o.e7)([S.Z], () => S.Z.getStageInstanceByChannel(null == l ? void 0 : l.id), [l]), {
  ...
  }), [k, D]), G = null == l ? void 0 : l.id, W = (0, o.Wu)([v.Z], () => [...new Set(v.Z.getMutableParticipants(G, C.pV.SPEAKER).map(e => e.user))], [G]), V = (0, o.e7)([v.Z], () => null != G ? v.Z.getParticipantCount(G, C.pV.AUDIENCE) : 0, [G]), B = (0, o.e7)([j.Z], () => j.Z.can(x.Plq.CONNECT, l)), H = (0, T.Z)(null == l ? void 0 : l.id), F = null == D ? void 0 : D.creator_id, z = (0, o.e7)([A.default], () => A.default.getUser(F), [F]);
  i.useEffect(() => {
    null != F && (0, u.PR)(F)
  }, [F]);
  let {
    ...
    if (null == t || d) {
      if (_) {
        ...
        return (null == a ? void 0 : a.speaker) ? e = w.NW.string(w.t["/cnSFR"]) : null != a && (e = w.NW.string(w.t.btSGOj)), {
          noticeType: 0,
          title: n.topic,
          location: i.name,
