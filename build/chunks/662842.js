...
function U(e) {
  ...
  }), [G, U]), B = null == l ? void 0 : l.id, H = (0, o.Wu)([I.Z], () => [...new Set(I.Z.getMutableParticipants(B, C.pV.SPEAKER).map(e => e.user))], [B]), F = (0, o.e7)([I.Z], () => null != B ? I.Z.getParticipantCount(B, C.pV.AUDIENCE) : 0, [B]), z = (0, o.e7)([A.Z], () => A.Z.can(w.Plq.CONNECT, l)), Y = (0, T.Z)(null == l ? void 0 : l.id), K = null == U ? void 0 : U.creator_id, q = (0, o.e7)([Z.default], () => Z.default.getUser(K), [K]);
  i.useEffect(() => {
    null != K && (0, u.PR)(K)
  }, [K]);
  let {
