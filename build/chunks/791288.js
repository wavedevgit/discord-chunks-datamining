...
function R(e) {
  let {
    ...
    trackClick: n,
    onDismissClick: s
  } = e, o = (0, h.q)(t.id), c = (0, l.e7)([S.Z], () => !S.Z.isNotificationDisabled(x.OverlayNotificationDisabledSetting.GAME_ACTIVITY)), d = r.useCallback(e => {
...
function L(e) {
  let {
    entry: t,
    idx: n
  } = e, s = (0, l.e7)([C.default], () => C.default.getUser(t.author_id)), h = (0, O.kr)(t), f = h ? a.TVs.colors.TEXT_POSITIVE : a.TVs.colors.CONTENT_INVENTORY_OVERLAY_TEXT_SECONDARY, [v, x] = r.useState("unsent"), [b, S] = r.useState(!1), _ = (0, l.e7)([I.default], () => I.default.customInviteMessage), w = (0, l.e7)([j.Z], () => null != s ? j.Z.getAnyStreamForUser(s.id) : null, [s]), {
    isMobileOnline: D,
    status: k
  } = (0, l.cj)([Z.Z], () => null == s ? {
...
function z(e) {
  let {
    onCancel: t,
    onSave: n
  } = e, s = (0, l.e7)([I.default], () => I.default.customInviteMessage), o = r.createRef(), [c, d] = r.useState(null != s ? s : M.NW.string(M.t.DwAcMz)), [h, p] = r.useState(c.length), f = e => {
...
function W(e) {
  let {
    entries: t
  } = e, n = t.slice(0, 5), s = (0, l.e7)([I.default], () => I.default.customInviteMessage), o = M.NW.formatToPlainString(M.t["5uzKGB"], {
...
function V(e, t) {
  let {
    trackView: n,
    trackClick: r
  } = (0, w.R)(k.n0.SendGameInvitesNotification, {
  ...
  return o()(t.length > 0, "Some entries must be present"), {
    ...
    onNotificationShow: () => {
      n(), u.Z.track(T.rMx.OVERLAY_GAME_INVITE_NOTIFICATION_SHOWN, {
