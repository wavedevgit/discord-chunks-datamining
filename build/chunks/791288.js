...
function L(e) {
  let {
    ...
    trackClick: n,
    onDismissClick: o
  } = e, s = (0, h.q)(t.id), c = (0, l.e7)([E.Z], () => !E.Z.isNotificationDisabled(O.OverlayNotificationDisabledSetting.GAME_ACTIVITY)), u = r.useCallback(e => {
  ...
  let L = async e => {
    if (null != o && "unsent" === _) {
      ...
      try {
        ...
        s()(null != r, "Send channel must be defined"), (0, x.uL)(T.Z5c.CHANNEL(r.guild_id, r.id)), await (0, y.p)({
          channel: r,
...
function z(e) {
  let {
    onCancel: t,
    onSave: n
  } = e, o = (0, l.e7)([I.default], () => I.default.customInviteMessage), s = r.useRef(null), [c, u] = r.useState(null != o ? o : R.intl.string(R.t.DwAcMz)), [h, p] = r.useState(c.length), f = e => {
...
function V(e) {
  let {
    entries: t
  } = e, n = t.slice(0, 5), o = (0, l.e7)([I.default], () => I.default.customInviteMessage), s = R.intl.formatToPlainString(R.t["5uzKGB"], {
