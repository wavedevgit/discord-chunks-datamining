...
function R(e) {
  let {
    ...
    trackClick: n,
    onDismissClick: s
  } = e, o = (0, h.q)(t.id), c = (0, a.e7)([x.Z], () => !x.Z.isNotificationDisabled(b.OverlayNotificationDisabledSetting.GAME_ACTIVITY)), u = r.useCallback(e => {
...
function L(e) {
  let {
    entry: t,
    idx: n
  } = e, s = (0, a.e7)([C.default], () => C.default.getUser(t.author_id)), h = (0, _.kr)(t), f = h ? l.TVs.colors.TEXT_POSITIVE : l.TVs.colors.CONTENT_INVENTORY_OVERLAY_TEXT_SECONDARY, [v, b] = r.useState("unsent"), [O, x] = r.useState(!1), P = (0, a.e7)([I.default], () => I.default.customInviteMessage), w = (0, a.e7)([E.Z], () => null != s ? E.Z.getAnyStreamForUser(s.id) : null, [s]), {
    isMobileOnline: k,
    status: D
  } = (0, a.cj)([j.Z], () => null == s ? {
  ...
  let R = async e => {
    if (null != s && "unsent" === v) {
      ...
      try {
        ...
        o()(null != r, "Send channel must be defined"), (0, S.uL)(T.Z5c.CHANNEL(r.guild_id, r.id)), await (0, y.p)({
          channel: r,
  ...
  return null == s ? null : (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)(u.Z, {
      ...
      children: (0, i.jsx)(l.zxk, {
        ...
        size: l.PhG.MAX,
        children: "sent" === v ? O ? (0, i.jsx)(l.kBi, {
          size: "sm"
        }) : (0, i.jsx)(l.kSu, {
          size: "sm",
          color: l.TVs.colors.WHITE
...
function z(e) {
  let {
    onCancel: t,
    onSave: n
  } = e, s = (0, a.e7)([I.default], () => I.default.customInviteMessage), o = r.createRef(), [c, u] = r.useState(null != s ? s : M.NW.string(M.t.DwAcMz)), [h, p] = r.useState(c.length), f = e => {
...
function W(e) {
  let {
    entries: t
  } = e, n = t.slice(0, 5), s = (0, a.e7)([I.default], () => I.default.customInviteMessage), o = M.NW.formatToPlainString(M.t["5uzKGB"], {
    inviteMessage: null != s ? s : M.NW.string(M.t.DwAcMz)
  }), [c, u] = r.useState(!1);
  return (0, i.jsxs)("div", {
...
function V(e, t) {
  let {
    trackView: n,
    trackClick: r
  } = (0, w.R)(D.n0.SendGameInvitesNotification, {
    notif_type: D.n0.SendGameInvitesNotification
  });
  return o()(t.length > 0, "Some entries must be present"), {
    ...
    onNotificationShow: () => {
      n(), d.Z.track(T.rMx.OVERLAY_GAME_INVITE_NOTIFICATION_SHOWN, {
