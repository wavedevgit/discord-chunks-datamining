...
function L(e) {
  let {
    ...
    trackClick: n,
    onDismissClick: s
  } = e, o = (0, h.q)(t.id), c = (0, a.e7)([x.Z], () => !x.Z.isNotificationDisabled(O.OverlayNotificationDisabledSetting.GAME_ACTIVITY)), u = r.useCallback(e => {
...
function M(e) {
  let {
    entry: t,
    idx: n
  } = e, s = (0, a.e7)([Z.default], () => Z.default.getUser(t.author_id)), h = (0, v.kr)(t), f = h ? l.TVs.colors.TEXT_POSITIVE : l.TVs.colors.CONTENT_INVENTORY_OVERLAY_TEXT_SECONDARY, [_, O] = r.useState("unsent"), [b, x] = r.useState(!1), P = (0, a.e7)([j.default], () => j.default.customInviteMessage), w = (0, a.e7)([S.Z], () => null != s ? S.Z.getAnyStreamForUser(s.id) : null, [s]), {
    isMobileOnline: k,
    status: D
  } = (0, a.cj)([N.Z], () => null == s ? {
  ...
  return null == s ? null : (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)(u.Z, {
      ...
      children: (0, i.jsx)(l.zxk, {
        ...
        size: l.PhG.MAX,
        children: "sent" === _ ? b ? (0, i.jsx)(l.kBi, {
          size: "sm"
        }) : (0, i.jsx)(l.kSu, {
          size: "sm",
          color: l.TVs.colors.WHITE
...
function W(e) {
  let {
    onCancel: t,
    onSave: n
  } = e, s = (0, a.e7)([j.default], () => j.default.customInviteMessage), o = r.createRef(), [c, u] = r.useState(null != s ? s : A.NW.string(A.t.DwAcMz)), [h, p] = r.useState(c.length), f = e => {
...
function z(e) {
  let {
    entries: t
  } = e, n = t.slice(0, 5), s = (0, a.e7)([j.default], () => j.default.customInviteMessage), o = A.NW.formatToPlainString(A.t["5uzKGB"], {
    inviteMessage: null != s ? s : A.NW.string(A.t.DwAcMz)
  }), [c, u] = r.useState(!1);
  return (0, i.jsxs)("div", {
    children: [(0, i.jsx)(_.iz, {}), (0, i.jsxs)(l.Text, {
