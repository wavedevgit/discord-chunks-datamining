...
function v() {
  ...
  if (null != j && null != _) return <Chunk481060.PhF isDisabled={require} serialize={e => "".concat(e)} isSelected={e => e === y} options={f} select={C} popoutLayerContext={Chunk246992.O$} popoutWidth={200} />
}