...
class R extends Chunk73800.PureComponent {
  render() {
    ...
    if (null == require) return <Chunk481060.$jN type={Chunk481060.$jN.Type.SPINNING_CIRCLE} />;
    let d = (e = function(e) {
      ...
      u = l().map(Chunk19780, (e, t) => {
        if ("receiverReports" !== t && (!i || "localAddress" !== t)) return <b.ck label={t} value={e} />
      }),
      ...
      g = l().map(Chunk246946, e => (function(e, t, r) {
        let a = <c.Z id={"bitrate-".concat(e)} justify={c.Z.Justify.BETWEEN}>{<span>{"Bitrate:"}</span>}{<span>{t.toFixed(2)}{" Kbps"}</span>}</c.Z>,
          i = <c.Z id={"lost-".concat(e)} justify={c.Z.Justify.BETWEEN}>{<span>{"Packet Loss:"}</span>}{<span>{r.toFixed(0)}{"%"}</span>}</c.Z>;
        return <D.Z label={e} valueRendered={[a, i]}>{e}</D.Z>
      })(e.displayName, e.bitrate, e.lost));
    return <Chunk481060.hjN tag={Chunk481060.RB0.H2} title={Chunk388032.intl.string(Chunk388032.t.wU9INz) + (null != Chunk73800 ? " - " + Chunk73800 : "")} className={Chunk442122.allowSelection}>{(0, Chunk481250.a)(Chunk226961)}{0 === Chunk476221.length ? null : <Chunk481060.$i$ className={Chunk20493.marginBottom20} />}{(0, Chunk481250.a)(Chunk476221)}</Chunk481060.hjN>
  }
}
