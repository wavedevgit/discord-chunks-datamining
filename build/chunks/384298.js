...
function y(e) {
  let {
    ...
    themeType: v
  } = (0, p.z)(), O = (0, a.e7)([f.Z], () => f.Z.isInChannel(t.id)), I = (0, a.e7)([d.Z], () => t.isPrivate() || d.Z.can(g.Plq.CONNECT, t)), {
    chatButtonEnabled: S
  } = (0, _.s)({
  ...
  let T = () => v === m.lY.MODAL || v === m.lY.MODAL_V2 ? E.intl.string(E.t["3xjX0d"]) : t.isDM() || t.isGroupDM() ? E.intl.string(E.t["7hwn2N"]) : t.isGuildStageVoice() ? E.intl.string(E.t.Acqcoq) : E.intl.string(E.t.BXxdl5),
    ...
    N = e => {
      ...
      }), t.isGuildStageVoice() ? (0, u.Cq)(t) : (l.default.selectVoiceChannel(t.id), (0, c.Kh)(t.id)), null == y || y()
    },
    C = e => {
      e.stopPropagation(), null == n || n({
        action: "OPEN_VOICE_CHAT"
      }), s.Z.updateChatOpen(t.id, !0), (0, c.Kh)(t.id), null == y || y()
    };
  return v === m.lY.MODAL_V2 ? (0, r.jsxs)(r.Fragment, {
