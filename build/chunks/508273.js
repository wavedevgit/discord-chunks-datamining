...
function O(e) {
  ...
  } = e, m = i.useRef(null), [_, h] = i.useState(!0), [O, I] = i.useState(!1), S = t.state === x.r2o.ACCEPTING, T = (0, o.e7)([d.Z], () => d.Z.useReducedMotion);
  i.useLayoutEffect(() => {
    var e, t;
  ...
  return null == N ? (0, r.jsx)(y.Z, {}) : (0, r.jsxs)(c.P3F, {
...
function j(e) {
  let {
    ...
    guildId: d,
    ctaType: f
  } = (0, _.ZP)(n, _.F3.INVITE), {
    analyticsLocations: g
  } = (0, m.ZP)(p.Z.INVITE_EMBED), b = i.useCallback(() => {
  ...
  return null == f ? null : (0, r.jsx)(h.o, {
    guildId: d,
    ctaType: f,
    submitting: o,
    onGoToGuild: s,
