...
function C(e) {
  ...
  } = e, p = i.useRef(null), [f, g] = i.useState(!0), [C, j] = i.useState(!1), I = t.state === y.r2o.ACCEPTING, S = (0, o.e7)([u.Z], () => u.Z.useReducedMotion);
  i.useLayoutEffect(() => {
    var e, t;
...
function O(e) {
  ...
  return null == h ? null : (0, r.jsx)(g.o, {
    guildId: m,
    ctaType: h,
    submitting: o,
    onGoToGuild: s,
