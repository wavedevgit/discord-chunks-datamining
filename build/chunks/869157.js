...
function R(e) {
  ...
  i.useEffect(() => {
    let e = Object.values(p).filter(e => e.type === m.Kw.USER && !e.canRead && !v.has(e.id)).map(e => e.id);
...
function D(e) {
  ...
  i.useEffect(() => {
    if (S) {
      var e;
      v.default.track(P.rMx.COMMANDS_MIGRATION_TOOLTIP_VIEWED, A(k({}, (0, p.hH)(a.id)), {
