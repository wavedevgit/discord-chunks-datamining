...
function k(e) {
  ...
  i.useEffect(() => {
    let e = Object.values(p).filter(e => e.type === m.Kw.USER && !e.canRead && !O.has(e.id)).map(e => e.id);
...
function A(e) {
  ...
  i.useEffect(() => {
    if (k) {
      var e;
      O.default.track(P.rMx.COMMANDS_MIGRATION_TOOLTIP_VIEWED, W(Z({}, (0, p.hH)(a.id)), {
