...
function k(e) {
  ...
  let P = (0, a.e7)([C.Z], () => C.Z.getApplicationId()),
    k = (0, a.e7)([_.default], () => null == P ? void 0 : _.default.integrations.find(e => {
      var t;
...
function A(e) {
  ...
  r.useEffect(() => {
    if (A) {
      var e;
      v.default.track(I.rMx.COMMANDS_MIGRATION_TOOLTIP_VIEWED, P(T({}, (0, d.hH)(a.id)), {
