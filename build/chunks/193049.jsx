...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk635774 = require("./635774.js"),
  Chunk387955 = require("./387955.js"),
  Chunk801461 = require("./801461.js"),
  Chunk448624 = require("./448624.js"),
  Chunk981631 = require("./981631.js"),
  Chunk388032 = require("./388032.js"),
  Chunk367019 = require("./367019.js");
...
function A(e) {
  ...
  return i.useLayoutEffect(() => {
    ...
    source: K.username
  }) : G === N.Wq.SUGGESTION && (Y || null != X) && (t = I.intl.string(I.t["i/2SgI"]))), <u.Y0X className={C.modalRoot} impression={{
    ...
    }} transitionState={a} size={u.CgR.DYNAMIC} parentComponent={"PomeloModal"}>{<c.zx onClick={() => {
        M === j.A.SUGGESTIONS || M === j.A.EDIT_SCREEN ? L(j.A.FINISH_LATER) : A()
      }} size={c.zx.Sizes.MIN} look={c.zx.Looks.BLANK} className={C.closeContainer} aria-label={I.intl.string(I.t.cpT0Cg)}><u.Dio size={"custom"} color={"currentColor"} width={15} height={15} className={C.close} /></c.zx>}{<u.hzk className={C.contentContainer}><u.MyZ activeSlide={M} width={480}>{<u.Mi4 id={j.A.INFO}><v.Z user={K} /></u.Mi4>}{<u.Mi4 id={j.A.EDIT_SCREEN}><_.Z user={K} error={U} editState={G} userRef={H} formValues={Q} footerNotice={t} onChangeFormValue={J} onFocusUsername={() => W(N.Wq.EDIT_USERNAME)} onFocusDisplayName={() => W(N.Wq.EDIT_DISPLAY_NAME)} onClose={A} /></u.Mi4>}{<u.Mi4 id={j.A.FINISH_LATER}><x.Z onClose={A} /></u.Mi4>}{<u.Mi4 id={j.A.SUGGESTIONS}><_.Z user={K} error={U} editState={G} userRef={H} formValues={Q} footerNotice={t} onChangeFormValue={J} onFocusUsername={() => W(N.Wq.SUGGESTION)} onFocusDisplayName={() => W(N.Wq.EDIT_DISPLAY_NAME)} onClose={A} usernameSuggestionLoading={Y} oneClickFlow={w} /></u.Mi4>}</u.MyZ></u.hzk>}{ec}</u.Y0X>
}
let R = (e, t, r, i, a) => 0 === e.length ? null : <u.mzw className={C.footer}>{<div className={C.inline}>{e.includes("REMIND_ME_LATER") && <c.zx className={C.unfilledButton} type={"button"} size={c.zx.Sizes.SMALL} look={c.zx.Looks.BLANK} color={c.zx.Colors.CUSTOM} onClick={t.handleRemindMeLater}>{I.intl.string(I.t["1mGbXF"])}</c.zx>}{e.includes("NEXT") && <u.zxk variant={"primary"} size={"sm"} text={I.intl.string(I.t.PDTjLC)} type={"button"} loading={r} onClick={t.handleNext} />}{e.includes("SUBMIT") && <u.zxk variant={"primary"} size={"sm"} text={I.intl.string(I.t.geKm7u)} type={"button"} loading={r} onClick={t.handleNext} />}{e.includes("GET_STARTED") && <u.zxk variant={"primary"} size={"sm"} text={I.intl.string(I.t.LhlgY2)} type={"button"} onClick={t.handleNext} />}{e.includes("GOT_IT") && <u.zxk variant={"primary"} size={"sm"} text={I.intl.string(I.t["NX+WJC"])} type={"button"} onClick={t.onClose} />}{e.includes("UPDATE") && <u.zxk variant={"primary"} size={"sm"} text={I.intl.string(I.t.VZANAA)} type={"button"} disabled={i && !a} loading={r} onClick={t.handleNext} />}</div>}{e.includes("BACK") && <c.zx className={C.unfilledButton} type={"button"} size={c.zx.Sizes.SMALL} look={c.zx.Looks.BLANK} color={c.zx.Colors.CUSTOM} onClick={t.handleBack}>{I.intl.string(I.t["13/7kZ"])}</c.zx>}</u.mzw>