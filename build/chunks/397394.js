...
function G(e) {
  ...
  let {
    onClose: a
  } = x(e, ["guild", "application"]), o = i.useCallback(() => {
    (null == t ? void 0 : t.id) != null && ((0, E.X)(null == t ? void 0 : t.id), null == a || a(), v.default.track(N.rMx.OAUTH2_AUTHORIZE_SUCCESS_GO_TO_GUILD_CLICKED, {
      application_id: null == n ? void 0 : n.id,
      guild_id: null == t ? void 0 : t.id
    }))
  }, [a, null == n ? void 0 : n.id, null == t ? void 0 : t.id]), s = m.z8.getField("entrypoint"), l = i.useCallback(() => {
    null == a || a(), v.default.track(N.rMx.OAUTH2_AUTHORIZE_SUCCESS_CLOSE_CLICKED, {
      application_id: null == n ? void 0 : n.id
    })
  }, [a, null == n ? void 0 : n.id]), u = window.location.pathname.startsWith(N.Z5c.APPLICATION_DIRECTORY), d = i.useCallback(() => {
    (null == n ? void 0 : n.id) != null && (null == a || a(), null != s && (0, g.uL)(""), setImmediate(() => {
  ...
  }, [null == n ? void 0 : n.id, a, s]), f = (0, c.e7)([O.Z, b.Z], () => b.Z.getChannel(O.Z.getChannelId())), p = (0, c.e7)([y.Z], () => y.Z.can(N.Plq.SEND_MESSAGES, f)), h = null != t, I = null == t && p && (!u || null != s);
  return null != t || null != a ? (0, r.jsxs)("div", {
    className: R.buttonsContainer,
    children: [null != a ? h || I ? (0, r.jsx)(_.zxk, {
      variant: "secondary",
      size: "sm",
      ...
      fullWidth: !0,
      onClick: l
    }) : void 0, h && (0, r.jsx)(_.zxk, {
      variant: "primary",
      text: (null == t ? void 0 : t.name.length) > 30 ? C.intl.string(C.t.M35zFB) : C.intl.format(C.t.UdYYPz, {
        guildName: null == t ? void 0 : t.name
      }),
      onClick: o
    }), I && (0, r.jsx)(_.zxk, {
...
function V() {
  return (0, r.jsx)(Z, {
    message: C.intl.string(C.t["/B7kX1"])
  })
}
...
function F(e) {
  let {
    ...
    null == n || n(), v.default.track(N.rMx.OAUTH2_AUTHORIZE_SUCCESS_CLOSE_CLICKED, {
      application_id: t.id
    })
  }, [n, t.id]);
  return (0, r.jsx)("div", {
