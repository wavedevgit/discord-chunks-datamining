...
function U(e) {
  ...
  }, [a, null == n ? void 0 : n.id, null == t ? void 0 : t.id]), l = m.z8.getField("entrypoint"), u = i.useCallback(() => {
    null == a || a(), v.default.track(N.rMx.OAUTH2_AUTHORIZE_SUCCESS_CLOSE_CLICKED, {
      application_id: null == n ? void 0 : n.id
    })
  }, [a, null == n ? void 0 : n.id]), d = window.location.pathname.startsWith(N.Z5c.APPLICATION_DIRECTORY), f = i.useCallback(() => {
    (null == n ? void 0 : n.id) != null && (null == a || a(), null != l && (0, g.uL)(""), setImmediate(() => {
  ...
  }, [null == n ? void 0 : n.id, a, l]), _ = (0, c.e7)([O.Z, b.Z], () => b.Z.getChannel(O.Z.getChannelId())), p = (0, c.e7)([y.Z], () => y.Z.can(N.Plq.SEND_MESSAGES, _)), h = null != t, I = null == t && p && (!d || null != l), S = [];
