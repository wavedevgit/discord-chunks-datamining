      ...
      let r = (() => {
        ...
        return function(t = {}) {
            ...
            l: {
              ...
              ub(e, t, n) {
                if (16384 == (61440 & e.mode)) {
                  ...
                  if (r)
                    for (var i in r.j) throw new eP(55)
                }
          ...
          var eO, ev, eI, eT, eS = null,
              ...
              for (var n = eS, r = "/", i = 0; i < e.length; i++) {
                ...
                if (n = ej(n, e[i]), r = et(r + "/" + e[i]), n.wa && (!a || a && t.gb) && (n = n.wa.root), !a || t.fb) {
                  for (a = 0; 40960 == (61440 & n.mode);)
                    if (n = e$(r), n = eL(r = eo(en(r), n), {
                        Qa: t.Qa + 1
                      }).node, 40 < a++) throw new eP(32)
                }
              }
              return {
                path: r,
            ...
            })), e = Object.assign(new eI, e), -1 == t && (t = eZ()), e.X = t, eN[t] = e),
            eH = {
              open: e => {
            ...
            eJ = () => {
              ...
              }).prototype = Error(), eP.prototype.constructor = eP, [44].forEach(e => {
          ...
          }), eJ(), ew = Array(4096), eW(eb, "/"), eK("/tmp", 16895, 0), eK("/home", 16895, 0), eK("/home/web_user", 16895, 0), (() => {
          ...
          var nE = {
            ...
            _embind_register_class_class_function: function(e, t, n, r, i, a, o) {
              var s = tX(n, r);
              t = ta(t), a = tK(i, a), tw([], [e], function(e) {
                function r() {
                ...
                return void 0 === l[t] ? (r.ea = n - 1, l[t] = r) : (tk(l, t, i), l[t].B[n - 1] = r), tw([], s, function(r) {
                  if (r = t$(i, [r[0], null].concat(r.slice(1)), null, a, o), void 0 === l[t].B ? (r.ea = n - 1, l[t] = r) : l[t].B[n - 1] = r, e.i.oa)
            ...
            _embind_register_class_class_property: function(e, t, n, r, i, a, o, s) {
              t = ta(t), a = tK(i, a), tw([], [e], function(e) {
                ...
                }, Object.defineProperty(e.i.constructor, t, l), tw([], [n], function(n) {
                  n = n[0];
                  var i = {
            ...
            _embind_register_class_function: function(e, t, n, r, i, a, o, s) {
              ...
              t = ta(t), a = tK(i, a), tw([], [e], function(e) {
                ...
                var c = e.i.N,
                  u = c[t];
                return void 0 === u || void 0 === u.B && u.className !== e.name && u.ea === n - 2 ? (r.ea = n - 2, r.className = e.name, c[t] = r) : (tk(c, t, i), c[t].B[n - 2] = r), tw([], l, function(r) {
                  return r = t$(i, r, e, a, o), void 0 === c[t].B ? (r.ea = n - 2, c[t] = r) : c[t].B[n - 2] = r, []
                }), []
              })
            },
            _embind_register_class_property: function(e, t, n, r, i, a, o, s, l, c) {
              t = ta(t), i = tK(r, i), tw([], [e], function(e) {
                e = e[0];
                var r = `${e.name}.${t}`,
                  u = {
                    get() {
                ...
                }, Object.defineProperty(e.i.N, t, u), tw([], l ? [n, o] : [n], function(n) {
                  var o = n[0],
                    u = {
                      get() {
            ...
            fd_seek: function(e, t, n, r, i) {
              ...
              try {
                ...
                var a = eF(e);
                return eQ(a, t, r), X = [a.position >>> 0, ($ = a.position, 1 <= +Math.abs($) ? 0 < $ ? +Math.floor($ / 0x100000000) >>> 0 : ~~+Math.ceil(($ - +(~~$ >>> 0)) / 0x100000000) >>> 0 : 0)], C[i >> 2] = X[0], C[i + 4 >> 2] = X[1], a.Ma && 0 === t && 0 === r && (a.Ma = null), 0
              } catch (e) {
                if (void 0 === e1 || "ErrnoError" !== e.name) throw e;
                return e.aa
              }
          ...
          function nA() {
            ...
            if (!(0 < G)) {
              ...
              J(k), 0 < G || (a.setStatus ? (a.setStatus("Running..."), setTimeout(function() {
                setTimeout(function() {
                  a.setStatus("")
                }, 1), e()
              }, 1)) : e())
