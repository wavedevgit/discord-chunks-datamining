...
let N = Chunk73800.memo(function(e) {
  ...
  return <E.Z repliedAuthor={x} baseMessage={n} channel={S} baseAuthor={Y} referencedMessage={I} content={j} compact={N} isReplyAuthorBlocked={U} isReplyAuthorIgnored={G} showAvatarPopout={R} showUsernamePopout={C} renderPopout={b.Z} onClickAvatar={V} onClickUsername={F} onClickReply={Z} onContextMenu={B} onPopoutRequestClose={H} isReplySpineClickable={w} showReplySpine={D} />
});
...
function C(e) {
  ...
  return null != l && <N baseMessage={t} replyReference={l} referencedMessage={c} channel={n} compact={i} setPopout={o} referencedUsernameProfile={a} referencedAvatarProfile={s} isReplySpineClickable={u} showReplySpine={d} />
}