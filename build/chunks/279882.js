...
class c extends Chunk495852.C {
  ...
  internalBinaryWrite(e, t, n) {
    "" !== e.assetUrl && t.tag(1, r.TD.LengthDelimited).string(e.assetUrl), "" !== e.header && t.tag(2, r.TD.LengthDelimited).string(e.header), "" !== e.body && t.tag(3, r.TD.LengthDelimited).string(e.body), "" !== e.backgroundAssetUrl && t.tag(4, r.TD.LengthDelimited).string(e.backgroundAssetUrl), e.gradient && l.p.internalBinaryWrite(e.gradient, t.tag(5, r.TD.LengthDelimited).fork(), n).join(), "" !== e.textColor && t.tag(6, r.TD.LengthDelimited).string(e.textColor), "" !== e.additionalTerms && t.tag(7, r.TD.LengthDelimited).string(e.additionalTerms), e.asset && s.F.internalBinaryWrite(e.asset, t.tag(8, r.TD.LengthDelimited).fork(), n).join(), e.backgroundAsset && s.F.internalBinaryWrite(e.backgroundAsset, t.tag(9, r.TD.LengthDelimited).fork(), n).join();
