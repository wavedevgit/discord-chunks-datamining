...
function R(e) {
  ...
  return n ? <l.aQ.Provider value={s}><l.ZP type={l.ZP.Types.ATTACHMENT} reason={u.wk.EXPLICIT_CONTENT} obscured={true} isSingleMosaicItem={true} onToggleObscurity={d}>{e => (0, r.jsx)("div", {
        className: a()(A.obscureWrapper, {
          [A.obscure]: e
        }),
        children: t(e)
      })}</l.ZP></l.aQ.Provider> : <r.Fragment>{t(false)}</r.Fragment>
}
...
function w(e) {
  ...
  let w = t[f],
    ...
    x = t.length > 1;
  return <r.Fragment>{<y.ZP>{e => x ? (0, r.jsxs)(r.Fragment, {
      ...
      }) : true}</y.ZP>}{<b.Z items={t} currentIndex={f}>{(e, t) => (0, r.jsx)(R, {
        isObscured: !m && D,
        src: w.url,
