...
let z = e => {
  let {
    ...
    guild: A,
    isMember: R
  } = (0, v.Z)(k, z), B = (0, c.Z)(t), w = null == G ? void 0 : G.channel_id, H = (0, r.e7)([_.Z], () => _.Z.getChannel(w), [w]), M = (0, s.Dt)(), [X, V] = l.useState(O.fL.EVENT_INFO), F = (0, E.Z)(z, L), Y = (0, h.Z)(k, z, L), [W, {
    loading: q,
    error: K
  }] = (0, p.Z)(() => m.Z.getGuildEventUsers(null == G ? void 0 : G.id, L, k));
  l.useEffect(() => {
    null == G ? C() : g.default.track(U.rMx.OPEN_MODAL, {
      type: O.zw,
      guild_id: G.guild_id
    })
  }, [G, C]);
