...
class P {
  ...
  constructor(e) {
    T(this, "rpcServer", void 0), T(this, "transports", void 0), T(this, "rpcCommandHandlers", void 0), T(this, "rpcEventHandlers", void 0), T(this, "stores", void 0), T(this, "registerTransportsForEmbeddedPlatform", void 0), T(this, "handleMessage", e => {
      ...
      if (null == r) return;
      let i = (0, y._J)(n, r);
      this.rpcServer.dispatchToSubscriptions(C.zMe.RELATIONSHIP_UPDATE, {}, e => (0, y.kb)(i, e.socket.application.id))
      ...
      if (null == n) return;
      let r = (0, y._J)(C.OGo.NONE, n);
      this.rpcServer.dispatchToSubscriptions(C.zMe.RELATIONSHIP_UPDATE, {}, e => (0, y.kb)(r, e.socket.application.id))
      ...
      0 !== this.rpcServer.subscriptions.length && i().forEach(f.Z.getMutableRelationships(), (e, t) => {
