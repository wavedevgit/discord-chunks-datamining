...
let S = e => e === O.WX.EXTERNAL,
  ...
  P = e => {
    let {
      ...
      disabled: a,
      entityType: s
    } = e, u = n === N.d4z.GUILD_STAGE_VOICE, d = (0, j.Q)(r, s), m = (0, f.sR)(t, n);
...
function D(e) {
  let {
    ...
    entityType: c,
    channelId: d
  } = n, m = (0, s.e7)([u.Z], () => u.Z.getChannel(d), [d]), x = r.useRef(null);
  r.useEffect(() => {
    if (a && S(c)) {
      var e;
  ...
  let g = Z(i),
    ...
    p = (0, b.xC)(c),
    j = (0, h.xt)(n);
  return null == c || c === O.WX.NONE ? null : S(c) ? (0, l.jsx)(o.xJW, {
...
function R(e) {
  let {
    ...
    guildEvent: n,
    onChange: i
  } = e, a = (0, s.e7)([d.Z], () => d.Z.getGuild(t), [t]), c = (0, v.Z)(t, void 0), u = (0, v.Z)(t, N.d4z.GUILD_VOICE), m = (0, v.Z)(t, N.d4z.GUILD_STAGE_VOICE), x = (0, f.sR)(t, N.d4z.GUILD_VOICE), g = (0, p.q)(a), j = null == a ? void 0 : a.hasFeature(N.oNc.COMMUNITY), b = (0, h.xt)(n), y = _(i, n), S = r.useMemo(() => {
    let e = [I({
      name: E.intl.string(E.t.BVZqJi),
      value: O.WX.VOICE,
      desc: E.intl.string(E.t["EV//4e"]),
      icon: o.gj8
    }, w(O.WX.VOICE, b, u, x.length)), I({
    ...
    return j ? [I({
      ...
      icon: o.ewx
    }, w(O.WX.STAGE_INSTANCE, b, m, g.length)), ...e] : e
...
function A(e) {
  let {
    ...
    entityType: u
  } = r, x = (0, s.e7)([d.Z], () => d.Z.getGuild(t), [t]), g = (0, p.q)(x), h = (0, s.e7)([m.Z], () => m.Z.can(N.Plq.MANAGE_CHANNELS, x)), v = null == x ? void 0 : x.hasFeature(N.oNc.COMMUNITY), f = _(a, r), j = v && !S(u) && 0 === g.length && h && null != u;
  return (0, l.jsxs)("div", {
