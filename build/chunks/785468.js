...
function k(e) {
  ...
  let h = D(i),
    ...
    j = (0, y.xC)(u),
    b = (0, v.xt)(n);
  return null == u || u === E.WX.NONE ? null : T(u) ? (0, r.jsx)(c.xJW, {
...
function A(e) {
  let {
    ...
    guildEvent: n,
    onChange: i
  } = e, a = (0, s.e7)([m.Z], () => m.Z.getGuild(t), [t]), o = (0, p.Z)(t, void 0), u = (0, p.Z)(t, N.d4z.GUILD_VOICE), d = (0, p.Z)(t, N.d4z.GUILD_STAGE_VOICE), x = (0, f.sR)(t, N.d4z.GUILD_VOICE), g = (0, j.q)(a), h = null == a ? void 0 : a.features.has(N.oNc.COMMUNITY), b = (0, v.xt)(n), y = R(i, n), O = l.useMemo(() => {
    let e = [S({
...
function U(e) {
  let {
    ...
    entityType: u
  } = l, d = (0, s.e7)([m.Z], () => m.Z.getGuild(t), [t]), g = (0, j.q)(d), h = (0, s.e7)([x.Z], () => x.Z.can(N.Plq.MANAGE_CHANNELS, d)), v = null == d ? void 0 : d.features.has(N.oNc.COMMUNITY), p = R(a, l), f = v && !T(u) && 0 === g.length && h && null != u;
  return (0, r.jsxs)("div", {
