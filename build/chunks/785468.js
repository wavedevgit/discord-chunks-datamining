...
let I = e => e === O.WX.EXTERNAL,
  ...
  P = e => {
    let {
      ...
      disabled: a,
      entityType: s
    } = e, o = n === N.d4z.GUILD_STAGE_VOICE, d = (0, y.Q)(l, s), x = (0, p.sR)(t, n);
...
function A(e) {
  ...
  let v = D(i),
    ...
    j = (0, b.xC)(u),
    y = (0, h.xt)(n);
  return null == u || u === O.WX.NONE ? null : I(u) ? (0, r.jsx)(c.xJW, {
...
function G(e) {
  let {
    ...
    guildEvent: n,
    onChange: i
  } = e, a = (0, s.e7)([x.Z], () => x.Z.getGuild(t), [t]), o = (0, f.Z)(t, void 0), u = (0, f.Z)(t, N.d4z.GUILD_VOICE), d = (0, f.Z)(t, N.d4z.GUILD_STAGE_VOICE), m = (0, p.sR)(t, N.d4z.GUILD_VOICE), g = (0, j.q)(a), v = null == a ? void 0 : a.features.has(N.oNc.COMMUNITY), y = (0, h.xt)(n), b = R(i, n), E = l.useMemo(() => {
    let e = [S({
...
function k(e) {
  let {
    ...
    entityType: u
  } = l, d = (0, s.e7)([x.Z], () => x.Z.getGuild(t), [t]), g = (0, j.q)(d), v = (0, s.e7)([m.Z], () => m.Z.can(N.Plq.MANAGE_CHANNELS, d)), h = null == d ? void 0 : d.features.has(N.oNc.COMMUNITY), f = R(a, l), p = h && !I(u) && 0 === g.length && v && null != u;
  return (0, r.jsxs)("div", {
