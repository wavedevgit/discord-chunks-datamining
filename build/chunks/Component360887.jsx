...
function j(e) {
  let {
    match: t,
    location: a
  } = e, o = (0, s.parse)(a.search).token, [d, j] = i.useState("loading"), I = i.useRef(false), N = i.useCallback(async e => {
    try {
      g.default.track(_.rMx.ONE_TIME_LOGIN_ATTEMPTED, {
        source: "web_page"
      }), await c.Z.oneTimeLogin(e), j("login_success"), g.default.track(_.rMx.LOGIN_SUCCESSFUL, {
        source: "web_page",
    ...
    p.Z.launch(r, e => {
      e ? (g.default.track(_.rMx.DEEP_LINK_CLICKED, {
        source: "web_page",
    ...
    Promise.resolve().then(n.bind(n, 536285)).then(t => {
      ...
      n.request(_.Etm.DEEP_LINK, {
        ...
        null != t && t ? (g.default.track(_.rMx.DEEP_LINK_CLICKED, {
          source: "web_page",
  ...
  if (i.useEffect(() => {
      ...
      if (g.default.track(_.rMx.ONE_TIME_LOGIN_PAGE_VIEWED, {
          has_token: e,
          device_type: t
  ...
  if ("app_launched" === d) return (0, r.jsx)(b, {
    ...
    buttonOnClick: () => {
      g.default.track(_.rMx.ONE_TIME_LOGIN_CONTINUE_IN_BROWSER_CLICKED, {
        previous_status: d
      }), N(o)
    }
  });
  ...
  if ("error" === d) {
    ...
    return (0, r.jsx)(b, {
      ...
      buttonOnClick: () => {
        g.default.track(_.rMx.ONE_TIME_LOGIN_BACK_TO_LOGIN_CLICKED, {
          error_reason: e
        }), (0, h.uL)(_.Z5c.LOGIN)
      }
    })
