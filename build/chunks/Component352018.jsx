...
function P(e) {
  let {
    ...
    stream: n,
    location: u
  } = e, h = C(e, ["hideBadges", "stream", "location"]), A = i.useRef(null), {
    analyticsLocations: v,
    parentAnalyticsLocation: I
  } = (0, o.Ay)(), N = (0, a.bG)([_.default], () => m.Ay.isPremium(_.default.getCurrentUser(), y.PremiumTypes.TIER_1)), P = (0, a.bG)([p.A], () => p.A.getChannel(null == n ? true : n.channelId)), D = i.useMemo(() => null != n ? [n] : [], [n]), x = i.useCallback(() => {
  ...
  return t || N || (L = w), (0, r.jsx)(s.YNO, {
    ...
    children: e => (0, r.jsx)(E.A, S(T(S({}, e), {
      buttonRef: A,
      label: O.intl.string(O.t.tmiYpF),
      iconComponent: L,
      onClick: t => {
        (null != I || null != u) && (0, l.X)(null != I ? I : u, l.O.STREAM_SETTINGS), null == e || e.onClick(t)
      }
    }), h))
  })
}