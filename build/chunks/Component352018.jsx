...
function P(e) {
  ...
  } = (0, s.Ay)(), N = (0, a.bG)([_.default], () => m.Ay.isPremium(_.default.getCurrentUser(), b.PremiumTypes.TIER_1)), P = (0, a.bG)([p.A], () => p.A.getChannel(null == n ? true : n.channelId)), D = i.useMemo(() => null != n ? [n] : [], [n]), L = i.useCallback(() => {
