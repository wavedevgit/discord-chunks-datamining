...
function Y(e) {
  ...
  if (V(e)) {
    ...
    n = s, "card_error" === e.type && (E.default.track(I.rMx.PAYMENT_SOURCE_CREATION_FAILED, P(w({}, s), {
...
async function J(e, t, n, r, i) {
  ...
  if (n === A.He.CARD) {
    ...
    if (X(t.error)) {
      let n = await (0, f.V)();
      await Q(r), t = await e.confirmSetup({
        redirect: "if_required",
        clientSecret: n,
        elements: r
      })
