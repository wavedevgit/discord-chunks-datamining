...
class I extends(i = Chunk64700.Component) {
  ...
  handleResizeMove(e, t) {
    ...
    }), true), (0, c.A)(E, this.dragState.dragOrientedCoords) || (this.dragState.dragOrientedCoords = E, this.setDOMPositions(this.dragState.dragOrientedCoords)), f || (null != s && s(), this.setState({
      operationStarted: true
