...
function T(e) {
  var t, n, r, i;
  let o = g(e);
  if (o === p.qn.NONE) return {
    attachmentIds: [],
    embedIds: []
  };
  let a = null == (t = e.attachments) ? void 0 : t.filter(e => N({
      type: f.l.Attachment,
      media: e
    }, o)),
...
function D(e, t) {
  ...
  return !(0 === t.length || null == e || 0 === t.filter(t => !C(t, {
    type: f.l.Embed,
    media: e
  })).length || "video" in e && null != e.video && (null == (n = e.video) ? void 0 : n.width) === 0 && (null == (r = e.video) ? void 0 : r.height) === 0 || "thumbnail" in e && null != e.thumbnail && (null == (i = e.thumbnail) ? void 0 : i.width) === 0 && (null == (o = e.thumbnail) ? void 0 : o.height) === 0 || "image" in e && null != e.image && (null == (a = e.image) ? void 0 : a.width) === 0 && (null == (s = e.image) ? void 0 : s.height) === 0 || "images" in e && (null == (l = e.images) ? void 0 : l.some(e => null != e && 0 === e.width && 0 === e.height))) && M(U(e), t)
}
