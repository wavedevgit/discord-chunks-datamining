/** Chunk was on web.js **/
/** chunk id: 999978, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  A: () => a
}), require("./896048.js");
...
function a(e) {
  ...
  return e.apply = n => {
    var r;
    if ("set_selection" === n.type && (null == (r = e.composition) ? true : r.startedInsideInline) && i.ZF.isRange(n.properties) && i.ZF.isRange(n.newProperties) && i.ZF.isCollapsed(n.newProperties)) {
...
function s(e, t, n) {
  ...
  if (null == s) returntrue;
  let [o, l] = s, [c, u] = i.VW.edges(e, l), d = i.ZF.toPoint(e.selection);
  if (null == d) returntrue;
  if (null != a) {
    let [t, n] = a;
    if (i.VW.isEmpty(e, t) || i.VW.isVoid(e, t)) return r.b.removeInline(e, n), true
  }
  if ("line" === t)
    ...
    for (;;) {
      ...
      if (d = t, null != (_ = i.VW.getParentInline(e, t))) {
        ...
        if (i.VW.isEmpty(e, t) || i.VW.isVoid(e, t)) {
          ...
          return null != t && r.b.select(e, t), r.b.removeInline(e, n), true
        }
      }
      let a = i.VW.node(e, t.path);
      if (null == a || !i.l5.isText(a[0])) returntrue;
