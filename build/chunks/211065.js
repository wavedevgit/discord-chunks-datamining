...
class k extends a.PureComponent {
  ...
  getEmojiButtonRenderer() {
    ...
    return null == e ? null : () => (0, l.jsx)(u.Z, {
      className: T.emoji,
      emojiId: e.id,
      emojiName: e.name,
      animated: !!e.animated
    ...
    return (0, l.jsx)(s.hjN, {
      ...
      children: (0, l.jsxs)("div", {
        ...
        children: [(0, l.jsx)("div", {
          ...
          autoFocus: !0
        }), t.length > 0 || null != n ? (0, l.jsx)(s.zxk, {
          focusProps: {
            offset: {
              top: 8,
              bottom: 8,
  ...
  constructor(...e) {
    ...
    }), y(this, "handleSubmit", e => {
      e.preventDefault(), this.handleSaveStatus()
    }), y(this, "handleStatusChange", e => {
      this.setState({
        text: e
      })
    }), y(this, "handleEmojiChange", e => {
      if (null == e) return;
      let t = null != e.id ? {
        id: e.id,
        name: e.name,
    ...
    }), y(this, "handleChangeClearAfter", e => {
      this.setState({
        clearAfter: e
      })
    }), y(this, "handleChangeStatus", e => {
      this.setState({
        status: e
      })
    ...
    }), y(this, "handleKeyPress", e => {
      e.which === _.yXg.ENTER && this.handleSaveStatus()
    }), y(this, "renderEmojiPicker", e => {
      let {
        closePopout: t
      } = e, {
        onClose: n
...
let I = o.ZP.connectStores([p.Z, b.default], () => {
