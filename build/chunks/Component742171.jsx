...
function d(e) {
  let {
    item: t
  } = e, n = "contentInventory" === t.data.kind ? t.data.content : null, d = null == n ? true : n.extra, p = null == n ? true : n.author_id, f = null == n ? true : n.content_type, g = (null == d ? true : d.type) === "played_game_extra" || (null == d ? true : d.type) === "launched_activity_extra" ? d.application_id : true, h = (0, o.q)(g), m = (0, l.e7)([s.default], () => null != p ? s.default.getUser(p) : null, [p]), b = f === i.s.TOP_GAME, E = null == h ? true : h.getIconURL(240);
