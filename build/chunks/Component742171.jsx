...
function d(e) {
  let {
    item: t
  } = e, n = "contentInventory" === t.data.kind ? t.data.content : null, d = null == n ? true : n.extra, p = null == n ? true : n.author_id, f = null == n ? true : n.content_type, h = (null == d ? true : d.type) === "played_game_extra" || (null == d ? true : d.type) === "launched_activity_extra" ? d.application_id : true, g = (0, o.q)(h), m = (0, l.e7)([s.default], () => null != p ? s.default.getUser(p) : null, [p]), _ = f === i.s.TOP_GAME, b = null == g ? true : g.getIconURL(240);
