    ...
    return (0, r.jsxs)(g.Z, {
      ...
      children: [(0, r.jsx)(c.kO8, {
        ...
        children: [null != t.expiresAt ? (0, r.jsxs)(i.Fragment, {
          children: [v.NW.format(v.t.ltVZcH, {
...
class A extends i.PureComponent {
  ...
  renderTitle() {
    ...
    return e = i === S.m8 ? v.NW.string(v.t.odsU6e) : i === S.rX && null != n ? v.NW.formatToPlainString(n.interval === S.rV.MONTH ? v.t.uZjpiI : v.t.bJW1EB, {
      skuName: t.name,
      intervalCount: n.intervalCount
    }) : null == n ? t.name : v.NW.formatToPlainString(n.interval === S.rV.MONTH ? v.t.rCJvqq : v.t.Vd3Iu7, {
      skuName: t.name,
      intervalCount: n.intervalCount
    }), (0, r.jsx)("div", {
            ...
            children: [(0, r.jsxs)(g.Z, {
              ...
              children: [null != d ? (0, r.jsx)(h.Z, {
                ...
                children: [this.renderTitle(), (0, r.jsx)("div", {
                  ...
                  children: v.NW.format(v.t.zMcvcH, {
                    copies: e.length
                  })
                })]
              })]
...
let P = l.ZP.connectStores([x.Z, b.Z, _.Z, m.Z, N.Z, f.default], e => {
  ...
  let s = _.Z.getForGifterSKUAndPlan(f.default.getId(), t, n).filter(e => !e.isClaimed).filter(e => e.giftStyle === r);
  return {
    sku: i,
