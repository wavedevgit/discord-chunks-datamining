...
class y extends r.PureComponent {
  ...
  render() {
    ...
    return (0, i.jsxs)(g.Z, {
      ...
      children: [(0, i.jsx)(c.kO8, {
        ...
        children: [null != t.expiresAt ? (0, i.jsxs)(r.Fragment, {
          children: [T.intl.format(T.t.ltVZcH, {
  ...
  constructor(...e) {
    super(...e), N(this, "_copyModeTimeout", new o.V7), N(this, "state", {
      ...
      (0, O.dM)(t, n), (0, C.JG)(e, () => this.setState({
...
class A extends r.PureComponent {
  ...
  renderTitle() {
    ...
    return e = r === v.m8 ? T.intl.string(T.t.odsU6e) : r === v.rX && null != n ? T.intl.formatToPlainString(n.interval === v.rV.MONTH ? T.t.uZjpiI : T.t.bJW1EB, {
      skuName: t.name,
      intervalCount: n.intervalCount
    }) : null == n ? t.name : T.intl.formatToPlainString(n.interval === v.rV.MONTH ? T.t.rCJvqq : T.t.Vd3Iu7, {
      skuName: t.name,
      intervalCount: n.intervalCount
    }), (0, i.jsx)("div", {
    ...
    return (0, i.jsxs)(u.Z, {
      ...
      children: [(0, i.jsx)(c.P3F, {
          ...
          children: (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsxs)(g.Z, {
              ...
              children: [null != d ? (0, i.jsx)(h.Z, {
                ...
                children: [this.renderTitle(), (0, i.jsx)("div", {
                  className: I.subTextHeader,
                  children: T.intl.format(T.t.zMcvcH, {
                    copies: e.length
                  })
                })]
              })]
        ...
        children: a ? (0, i.jsx)(c.$jN, {
          ...
          children: [n.length < e.length ? this.renderGenerateGiftCodeRow() : null, n.map(e => (0, i.jsx)(y, {
            giftCode: e,
            sku: l,
            hideCode: o
          }, e.code))]
  ...
  constructor(...e) {
    super(...e), N(this, "_loadedAt", null), N(this, "state", {
      isOpen: !1,
      isCreating: !1,
      isHovered: !1
      ...
      this.setState({
        isCreating: !0
      }), await d.Z.createGiftCode(t, n, i), this.setState({
        isCreating: !1,
        isOpen: !0
      })
      ...
      (null == n || null == this._loadedAt || n < this._loadedAt) && i && d.Z.fetchUserGiftCodesForSKU(e, t), this.setState({
...
let P = a.ZP.connectStores([E.Z, _.Z, b.Z, m.Z, x.Z, f.default], e => {
  ...
  let s = b.Z.getForGifterSKUAndPlan(f.default.getId(), t, n).filter(e => !e.isClaimed).filter(e => e.giftStyle === i);
  return {
    sku: r,
