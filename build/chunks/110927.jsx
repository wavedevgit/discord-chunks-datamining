...
function p(e) {
  ...
  return <l.Z modalType={"age_verification"} header={m.intl.string(d.default.RqoA4u)} body={m.intl.string(d.default.RPb8Zm)} problemTitle={m.intl.string(d.default.KZw6kp)} problems={h} freeformNeededProblems={g} onSubmit={j} onClose={t} transitionState={p} otherKey={b.wO.SOMETHING_ELSE} hideHelpDeskLink={true} hideDontShowAgainCheckbox={true} freeformDescription={e => null == e ? null : e.value === b.wO.SOMETHING_ELSE ? m.intl.string(d.default["Q5cQ4+"]) : m.intl.string(d.default.zApKaW)} />
}