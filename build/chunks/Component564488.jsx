...
let g = Chunk473749.memo(function(e) {
  let {
    ...
    isLoading: h
  } = (0, s.w)(), [x] = i.useState(() => !(0, l.Vb)(t)), j = (null == m ? true : m.id) === t.id || n, v = (0, a.U)(null == t ? true : t.id), O = j && null != m ? m : t, y = i.useMemo(() => (0, o.af)(t.name), [null == t ? true : t.name]), C = i.useCallback(() => {
