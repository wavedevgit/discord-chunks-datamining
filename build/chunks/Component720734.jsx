...
function tx(e) {
  ...
  return (0, a.jsx)(g.Z, {
    ...
    children: (0, a.jsx)(eb.Z, {
      ...
      targetElementRef: y,
      clickTrap: true,
      preload: () => (0, ef.Z)(o.id, o.getAvatarURL(P, eb.I), {
        type: "account_popout",
      ...
      children: e => (N(e), (0, a.jsxs)(f.P3F, td(tc({
        innerRef: y,
        style: T
      }, e), {
        onClick: t => {
    ...
    return null == module ? null : (0, Chunk54381.jsxs)(Chunk54381.Fragment, {
      children: [(0, Chunk54381.jsx)(Chunk481060.Wdt, {
        children: e => (0, a.jsxs)("div", {
          ...
          }), this.renderNameZone(e), (0, a.jsx)(tb, td(tc({}, this.props, this.state), {
...
function tj(e) {
  ...
  !v && x ? (t = ti.intl.format(ti.t["18wnuD"], {
    ...
    inputDeviceName: _
  })) : !v && b ? (t = ti.intl.format(ti.t["f+DDY/"], {
    outputDeviceName: y
...
function ty(e) {
  ...
  } = (0, T.ZP)(O.Z.AUDIO_OUTPUT_BUTTON), N = l.useRef(null);
  l.useEffect(() => () => b(), [h, b]);
