...
let U = (e, t) => n => {
  ...
  k = (e, t) => t && [D.WX.STAGE_INSTANCE, D.WX.VOICE].includes(null == e ? void 0 : e.entity_type),
  L = i.memo(function(e) {
    var t;
    let {
      guild: n,
    ...
    }, [n]), O = (0, P.u)(l, o), p = i.useCallback(e => {
      u && null != l && (e.stopPropagation(), (0, s.Bk)(l))
    }, [u, l]), N = i.useCallback(e => {
      v(l)(e)
    }, [l]);
    if (null == E) return null;
    let f = null == O ? void 0 : O.IconComponent,
  ...
  Z = i.memo(function(e) {
    ...
    } = e, E = (0, a.e7)([N.ZP], () => N.ZP.isInterestedInEventRecurrence(n, i), [n, i]), I = e => {
  ...
  j = i.memo(function(e) {
    ...
    } = e, I = null != u ? u : null != n ? (0, R.DK)(n) : null, O = (null == n ? void 0 : n.recurrence_rule) == null || null == I || (0, R.Rp)((0, A.KV)(null == n ? void 0 : n.recurrence_rule), I), T = (0, f.Z)(n), S = i.useCallback(() => {
      s && null != n && (0, p.bO)({
        eventId: n.id,
        recurrenceId: I
      })
