...
let U = (e, t) => n => {
  ...
  k = r.memo(function(e) {
    ...
    }, [n]), E = (0, y.u)(l, o), I = r.useCallback(e => {
      a && null != l && (e.stopPropagation(), (0, d.Bk)(l))
    }, [a, l]), g = r.useCallback(e => {
      L(l)(e)
    }, [l]);
  ...
  j = r.memo(function(e) {
    ...
    } = e, E = (0, s.e7)([S.ZP], () => S.ZP.isInterestedInEventRecurrence(n, r), [n, r]), I = e => {
      e.stopPropagation(), d ? l && h() : _()
    };
    return d ? l ? (0, i.jsx)(a.zx, {
      className: v.button,
  ...
  w = r.memo(function(e) {
    ...
    } = e, E = null != d ? d : null != n ? (0, N.DK)(n) : null, I = (null == n ? void 0 : n.recurrence_rule) == null || null == E || (0, N.Rp)((0, f.KV)(null == n ? void 0 : n.recurrence_rule), E), p = (0, T.Z)(n), C = r.useCallback(() => {
      a && null != n && (0, g.bO)({
        eventId: n.id,
        recurrenceId: E
      })
    ...
    return (0, i.jsx)(h.Z, {
      ...
      children: (0, i.jsxs)(c.P3F, {
        onClick: C,
        children: [null != n.image && (0, i.jsx)(R.Z, {
          source: (0, m.Z)(n),
          className: v.banner
        }), (0, i.jsx)(A.ZP, {
          name: n.name,
