...
class $ extends w.Z {
  ...
  async _doIdentify() {
    ...
    let [n, r, i] = await Promise.all([(0, h.O)() ? f.Z.getCommittedVersions() : {}, (0, h.O)() ? p.Z.getCommittedVersions() : {}, !!(0, h.O)() && _.Z.canUseGuildVersions()]), o = i ? {
      guild_versions: n,
