...
function Z(e) {
  ...
  if (window._ws = null, null != l)
    if (t = l.ws, l.state.gateway !== n) V.verbose("[FAST CONNECT] gatewayURL mismatch: ".concat(l.state.gateway, " !== ").concat(n)), t.close(1e3), t = null;
      ...
      }) : e)), V.log("[FAST CONNECT] successfully took over websocket, state:", B(U({}, e), {
...
class et extends L.Z {
  ...
  _connect(e) {
    ...
    let t = x.a();
    if ((t || !m.Z.canConnectToGateway()) && (V.info("Skipping _connect because socket is paused"), v.default.track(k.rMx.GATEWAY_CONNECT_SKIPPED, {
        actually_skipped: t,
  ...
  _handleClose(e, t, n) {
    if (e = e || !1, this._cleanup(), this.emit("close", {
        code: t,
        reason: n
      }), t === z) return this.connectionState = N.Z.CLOSED, V.warn("[WS CLOSED] because of authentication failure, marking as closed."), this._reset(e, t, n);
    if (this._tryDetectInvalidIOSToken(t, n, e), this.connectionState = N.Z.WILL_RECONNECT, this.nextReconnectIsImmediate) V.info("[WS CLOSED] (".concat(e.toString(), ", ").concat(t, ", ").concat(n, ") retrying immediately.")), this._connect("_handleCloseImmediateReconnect");
      ...
      V.info("[WS CLOSED] (".concat(e.toString(), ", ").concat(t, ", ").concat(n, ") retrying in ").concat((r / 1e3).toFixed(2), " seconds.")), this.gatewayBackoff.fails > Y && this._reset(e, t, n)
    }
  }
  _tryDetectInvalidIOSToken(e, t, n) {
    (0, T.isIOS)() && null != this.token && e === W && t === K && (this.iosGoingAwayEventCount += 1, 3 === this.iosGoingAwayEventCount && d.tn.get({
      ...
      v.default.track(k.rMx.IOS_INVALID_TOKEN_WORKAROUND_TRIGGERED, {
        api_status_code: t
      })
    }, e => {
      let {
      ...
      401 === t && (this.connectionState = N.Z.CLOSED, V.warn("[WS CLOSED] because of manual authentication failure, marking as closed."), this._reset(n, z, "invalid token manually detected")), v.default.track(k.rMx.IOS_INVALID_TOKEN_WORKAROUND_TRIGGERED, {
        api_status_code: t
      })
    }))
  }
  ...
  networkStateChange(e, t) {
    ...
    m.Z.canConnectToGateway() || v.default.track(k.rMx.GATEWAY_CONNECT_SKIPPED, {
      actually_skipped: !1,
      client_app_state: m.Z.getState(),
      connect_reason: t
  ...
  constructor() {
    ...
    }), this.dispatcher = new D.Z(this), this.gatewayBackoff = new a.Z(1e3, 6e4), this.connectionState_ = N.Z.CLOSED, this.webSocket = null, this.seq = 0, this.sessionId = null, this.token = null, this.initialHeartbeatTimeout = null, this.expeditedHeartbeatTimeout = null, this.lastHeartbeatTime = null, this.lastHeartbeatAckTime = null, this.helloTimeout = null, this.heartbeatInterval = null, this.heartbeater = null, this.heartbeatAck = !0, this.connectionStartTime = 0, this.identifyStartTime = 0, this.nextReconnectIsImmediate = !1, this.compressionHandler = (0, R.I)(F), this.hasConnectedOnce = !1, this.isFastConnect = !1, this.identifyCount = 0, this.iosGoingAwayEventCount = 0
  }
}