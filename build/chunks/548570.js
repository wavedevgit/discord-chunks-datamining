...
function H(e) {
  let {
    actuallySkipped: t,
    reason: n
  } = e, r = x.a(), i = k.Pf(), o = m.Z.getState(), a = i.length > 0 ? "".concat(n, " + ").concat(i) : n, s = r ? "paused" : "request_state";
...
function Y(e) {
  ...
  if (window._ws = null, null != l)
    if (t = l.ws, l.state.gateway !== n) V.verbose("[FAST CONNECT] gatewayURL mismatch: ".concat(l.state.gateway, " !== ").concat(n)), t.close(1e3), t = null;
      ...
      var _;
      let e = G({}, l.state);
      null != e.messages && (e.messages = e.messages.map(e => null != e.data && "string" == typeof e.data ? F(G({}, e), {
        data: e.data.substring(0, 100)
      }) : e)), V.log("[FAST CONNECT] successfully took over websocket, state:", F(G({}, e), {
...
class er extends L.Z {
  ...
  _connect(e) {
    ...
    let t = x.a();
    if ((t || !k.RZ()) && (V.info("Skipping _connect because socket is paused"), H({
        reason: e
      }), t)) return;
    ...
    s.Z.mark("\uD83C\uDF10", "Socket._connect"), V.info("[CONNECT] ".concat(i, ", ") + "encoding: ".concat(r, ", ") + "version: ".concat(o, ", ") + "compression: ".concat(null != n ? n : "none")), null !== this.webSocket && (V.error("_connect called with already existing websocket"), this._cleanup(e => e.close(4e3))), this.connectionStartTime = Date.now(), this.helloTimeout = setTimeout(() => {
    ...
    let a = new URL(i);
    a.searchParams.append("encoding", r), a.searchParams.append("v", o.toString()), null != n && a.searchParams.append("compress", n), Y({
  ...
  _handleReconnect() {
    V.verbose("[RECONNECT] gateway requested I reconnect."), this._cleanup(e => e.close(4e3)), this.connectionState = N.Z.WILL_RECONNECT, this._connect("reconnect")
  }
  ...
  _handleHeartbeatTimeout() {
    ...
    V.warn("[ACK TIMEOUT] reconnecting in ".concat((e / 1e3).toFixed(2), " seconds."))
  }
  _handleClose(e, t, n) {
    if (e = e || !1, this._cleanup(), this.emit("close", {
        code: t,
        reason: n
      }), t === Q) return this.connectionState = N.Z.CLOSED, V.warn("[WS CLOSED] because of authentication failure, marking as closed."), this._reset(e, t, n);
    if (this._tryDetectInvalidIOSToken(t, n, e), this.connectionState = N.Z.WILL_RECONNECT, this.nextReconnectIsImmediate) V.info("[WS CLOSED] (".concat(e.toString(), ", ").concat(t, ", ").concat(n, ") retrying immediately.")), this._connect("_handleCloseImmediateReconnect");
      ...
      V.info("[WS CLOSED] (".concat(e.toString(), ", ").concat(t, ", ").concat(n, ") retrying in ").concat((r / 1e3).toFixed(2), " seconds.")), this.gatewayBackoff.fails > K && this._reset(e, t, n)
    }
  }
  _tryDetectInvalidIOSToken(e, t, n) {
    (0, T.isIOS)() && null != this.token && e === z && t === q && (this.iosGoingAwayEventCount += 1, 3 === this.iosGoingAwayEventCount && d.tn.get({
      url: j.ANM.ME,
      headers: {
      ...
      v.default.track(j.rMx.IOS_INVALID_TOKEN_WORKAROUND_TRIGGERED, {
        api_status_code: t
      })
    }, e => {
      let {
      ...
      401 === t && (this.connectionState = N.Z.CLOSED, V.warn("[WS CLOSED] because of manual authentication failure, marking as closed."), this._reset(n, Q, "invalid token manually detected")), v.default.track(j.rMx.IOS_INVALID_TOKEN_WORKAROUND_TRIGGERED, {
        api_status_code: t
      })
    }))
  }
  ...
  _doResume() {
    var e;
    this.connectionState = N.Z.RESUMING, this.dispatcher.resumeAnalytics = (0, w.zH)(Date.now() - this.connectionStartTime), V.info("[RESUME] resuming session ".concat(null != (e = this.sessionId) ? e : "", ", seq: ").concat(this.seq)), this.send(L.j.RESUME, {
      token: this.token,
  ...
  resetSocketOnError(e) {
    ...
    0 === this.dispatchExceptionBackoff._fails ? (V.verbose("Triggering fast reconnect"), this.dispatchExceptionBackoff.fail(() => {}), setTimeout(() => this._connect("resetSocketOnErrorImmediate"), 0)) : this.dispatchExceptionBackoff.fail(() => this._connect("resetSocketOnError")), o && (this.didForceClearGuildHashes = !0, f.Z.dispatch({
      type: "CLEAR_CACHES",
      reason: "Socket reset during ".concat(t)
    })), clearTimeout(this.dispatchSuccessTimer), this.dispatchSuccessTimer = setTimeout(() => this.dispatchExceptionBackoff.succeed(), 2 * $)
  }
  resetSocketOnDispatchError(e) {
    let t = null != e.error.message && e.error.message.indexOf("Guild data was missing from store") >= 0;
    this.resetSocketOnError(F(G({}, e), {
      sentry: !t,
      clearCache: t
    }))
  }
  ...
  expeditedHeartbeat(e) {
    ...
    if (!this.isClosed()) {
      if (this.isConnected()) {
        V.verbose("Performing an expedited heartbeat ".concat(null != t && "" !== t ? "reason: " + t : "")), this.heartbeatAck = !1, this._sendHeartbeat(), null !== this.expeditedHeartbeatTimeout && clearTimeout(this.expeditedHeartbeatTimeout), this.expeditedHeartbeatTimeout = setTimeout(() => {
  ...
  constructor() {
    super(), U(this, "gatewayBackoff", void 0), U(this, "handleIdentify", void 0), U(this, "dispatchExceptionBackoff", new a.Z(1e3, $)), U(this, "dispatchSuccessTimer", 0), U(this, "connectionState_", void 0), U(this, "webSocket", void 0), U(this, "seq", void 0), U(this, "sessionId", void 0), U(this, "token", void 0), U(this, "initialHeartbeatTimeout", void 0), U(this, "expeditedHeartbeatTimeout", void 0), U(this, "heartbeatInterval", void 0), U(this, "helloTimeout", void 0), U(this, "heartbeater", void 0), U(this, "lastHeartbeatTime", void 0), U(this, "lastHeartbeatAckTime", void 0), U(this, "heartbeatAck", void 0), U(this, "connectionStartTime", void 0), U(this, "identifyStartTime", void 0), U(this, "nextReconnectIsImmediate", void 0), U(this, "compressionHandler", void 0), U(this, "hasConnectedOnce", void 0), U(this, "isFastConnect", void 0), U(this, "didForceClearGuildHashes", !1), U(this, "identifyUncompressedByteSize", 0), U(this, "identifyCompressedByteSize", 0), U(this, "analytics", {}), U(this, "identifyCount", 0), U(this, "resumeUrl", null), U(this, "iosGoingAwayEventCount", 0), U(this, "dispatcher", void 0), U(this, "send", (e, t, n) => {
    ...
    }), this.dispatcher = new D.Z(this), this.gatewayBackoff = new a.Z(1e3, 6e4), this.connectionState_ = N.Z.CLOSED, this.webSocket = null, this.seq = 0, this.sessionId = null, this.token = null, this.initialHeartbeatTimeout = null, this.expeditedHeartbeatTimeout = null, this.lastHeartbeatTime = null, this.lastHeartbeatAckTime = null, this.helloTimeout = null, this.heartbeatInterval = null, this.heartbeater = null, this.heartbeatAck = !0, this.connectionStartTime = 0, this.identifyStartTime = 0, this.nextReconnectIsImmediate = !1, this.compressionHandler = (0, P.I)(Z), this.hasConnectedOnce = !1, this.isFastConnect = !1, this.identifyCount = 0, this.iosGoingAwayEventCount = 0
  }
}