...
let N = [Chunk409813.h8.PAYMENT_ELEMENT],
  R = Chunk647438.memo(function(e) {
    var {
      ...
      onChange: s,
      step: c
    } = e, u = A(e, ["wallets", "analyticsContext", "options", "onChange", "step"]);
      ...
      h = i.useCallback(e => {
        if (c === f.h8.PAYMENT_ELEMENT && (null != s && s(e), null != n)) {
          let {
            ...
            activitySessionId: r,
            analyticsData: i
          } = n, a = (0, E.hR)(e.value.type), o = null != a ? E.Ho[a] : e.value.type;
  ...
  P = Chunk647438.memo(function(e) {
    ...
    } = e, s = A(e, ["options", "renderWithoutElement", "billingAddressInfo"]);
    let l = i.useMemo(() => {
        let {
          name: e,
          address: t
  ...
  D = e => {
    ...
    return o || null != s || null == l ? (0, r.jsx)("div", {
