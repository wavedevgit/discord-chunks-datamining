...
function b(e) {
  ...
  }, [j, t]), O = <o.Z image={t.splash} makeURL={e => null != e ? c.ZP.getGuildSplashURL({
      id: t.id,
      splash: e
    }) : null} disabled={!x} onChange={v} hint={h.intl.string(h.t.uPvxqK)} enabled={x} maxFileSizeBytes={p.B} onFileSizeError={() => (0, s.Z)(p.B)} />;
  return b ? O : <l.P3F aria-hidden={true} tabIndex={false} className={f.upsell} onClick={_}>{O}</l.P3F>
}