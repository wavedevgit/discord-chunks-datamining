...
async function r(e) {
  let {
    default: t
  } = await n.e("32990").then(n.t.bind(n, 735630, 19)), r = t.createFile(), a = t.createFile(), l = {};
  e.fileStart = 0, r.onReady = e => {
    for (let t of (a.init({
        duration: e.duration,
        timescale: e.timescale
      }), e.audioTracks)) l[t.id] = t, r.setExtractionOptions(t.id, null, {
      nbSamples: 1 / 0
    }), a.addTrack({
      id: t.id,
