...
class T extends(r = Chunk73800.PureComponent) {
  ...
  render() {
    ...
    let F = "".concat(Z, "%"),
      V = null != Chunk120356 && null != Chunk73800 ? Chunk120356.map((e, t) => {
        let n = o[t],
          r = null != C && C === n,
          a = this.renderMark(n);
        return <div className={s()(m.mark, {
            [m.defaultValue]: r,
            [m.markAbove]: 0 === k,
            [m.markBelow]: 1 === k
          })} style={{
            left: "".concat(e, "%")
          }}>{null != w ? w(n) : (0, i.jsxs)(i.Fragment, {
    ...
    return <S active={require} keyboardFocused={r && Chunk607070.Z.keyboardModeEnabled}>{e => {
        var o;
        return (0, i.jsx)(_.t, {
          ...
          children: (0, i.jsxs)(u.animated.div, {
            ...
            onMouseEnter: () => null == e ? true : e.setHovered(true),
            onMouseLeave: () => null == e ? true : e.setHovered(false),
