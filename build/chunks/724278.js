...
function T(e) {
  ...
  } = (0, u.ZP)(), d = (0, c.e7)([g.ZP], () => g.ZP.getMember(r, i.id), [i, r]), _ = (0, f.X7)(null == d ? void 0 : d.guildId, null == d ? void 0 : d.userId, null != (n = null == d ? void 0 : d.colorStrings) ? n : null);
  return (0, l.jsxs)("div", {
    className: S.row,
...
function R(e) {
  let {
    ...
    recurrenceId: h,
    setRecurrenceId: g
  } = e, v = (0, c.e7)([m.Z], () => null != m.Z.getGuild(t.id), [t.id]), {
    startTime: O,
    endTime: R
  } = (0, b.ZP)(n, h), L = (0, Z.Z)(n.guild_id, n.id, h), B = i.useCallback(e => {
    e.stopPropagation(), null != n && (0, a.Bk)(n)
  }, [n]), D = (0, j.Z)(h, n.id), G = (0, x.Z)(n);
  i.useEffect(() => {
  ...
  return (0, l.jsxs)("div", {
    ...
    children: [(0, l.jsxs)("div", {
      ...
      }, G.id), null != n.description && (0, l.jsx)("div", {
