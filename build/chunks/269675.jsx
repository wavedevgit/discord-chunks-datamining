...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk396828 = require("./396828.js"),
  Chunk293423 = require("./293423.js"),
  Chunk20967 = require("./20967.jsx"),
  Chunk504762 = require("./504762.js"),
  Chunk807152 = require("./807152.js"),
  Chunk176505 = require("./176505.js"),
  Chunk388032 = require("./388032.js"),
  Chunk86492 = require("./86492.js");
...
function P(e) {
  ...
  if (i.useEffect(() => {
    ...
    return <v.z errorType={e} />
  }
  return <div className={T.container}>{<g.Z toolbar={(0, r.jsx)(i.Fragment, {})} className={T.headerBar}>{<g.Z.Icon icon={(0, o.GSL)(E.Z)} aria-hidden={true} />}{<g.Z.Title>{N.intl.string(N.t["KzCF//"])}</g.Z.Title>}</g.Z>}{<div id={C.v} />}{<div className={T.content}>{j ? (0, r.jsx)(o.u2D, {
...
function j(e) {
  ...
  return <_.l guildId={t} refetchOnMount={true}><P guildId={t} /></_.l>
}