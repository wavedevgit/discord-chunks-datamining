...
class U extends l.PureComponent {
  ...
  constructor(e) {
    super(e), D(this, "state", {
    ...
    }), D(this, "_editorRef", void 0), D(this, "_containerRef", l.createRef()), D(this, "_searchBarRef", l.createRef()), D(this, "_searchPopoutRef", l.createRef()), D(this, "handleSetSearchQuery", e => {
      let {
        query: t,
        anchor: n,
        focus: r,
      ...
      a = P.iK(o, a), this.setEditorState(a), l && this.search({
        queryString: P.Sq(a)
      })
    ...
    }), D(this, "renderPopout", () => (0, r.jsx)(A.ZP, {
      ...
      t = P.Hl(t, 0), this.setEditorState(t), null != n && (0, N.cy)({
        searchType: r,
        searchId: n
      ...
      this.handleBlur()
    }), D(this, "handleOption", e => null != e && (-1 === e.state.selectedIndex && e.shouldShowSearchInSelectedChannel() ? e.handleSearchInChannel() : e.selectOption())), D(this, "handleReturn", e => {
      let {
        shiftKey: t
      } = e;
      e.preventDefault();
      ...
      return P.Sq(t).length >= 512 || (t = P.x0(e, t), t = P.Hl(t, 512), t = this.tokenize(t), this.setEditorState(t), n || this.setState({
        focused: !0
      })), "handled"
      ...
      switch (e) {
        ...
        case "delete":
        case "delete-word":
          return t = P.yd(e, t), t = this.tokenize(t), this.setEditorState(t), n || this.setState({
            focused: !0
          }), "handled";
      ...
      return e = null != e ? e.replace(/\n/g, "") : "", t = P.x0(e, t), t = P.Hl(t, 512), t = this.tokenize(t), n || this.setState({
        focused: !0
...
function G(e) {
  ...
  l.useEffect(() => {
    s.current && !t && (s.current = !1, (0, N.IZ)({
      searchId: n,
      searchType: r
...
function z(e) {
  let {
    ...
    type: Z.aib.DMS
  }), []), i = (0, u.e7)([E.Z], () => E.Z.getSearchResultsQueryString(Z.aib.DMS)), o = (0, v.jj)(a, F.sR.MESSAGES, i), c = (0, u.e7)([_.Z], () => {
    let e = _.Z.getTotalCount(o);
    return null != e && e > 0
  }), d = (0, u.e7)([_.Z], () => _.Z.getIsFetching(o)), h = d || c;
  G({
    isSearchActive: h,
    searchId: Z.aib.DMS,
...
function q(e) {
  let {
    ...
    keyboardModeEnabled: n,
    editorState: s
  } = e, a = (0, u.e7)([E.Z], () => E.Z.getCurrentSearchId()), i = (0, w.k)(a), o = (0, u.e7)([E.Z], () => E.Z.isActive(a)), c = (0, u.e7)([E.Z], () => E.Z.hasResults(a)), d = (0, u.e7)([E.Z], () => null != a && E.Z.isSearching(a));
  G({
    isSearchActive: o,
    searchId: a,
    searchType: i
...
function W(e) {
  let {
    className: t
  } = e, n = (0, u.e7)([E.Z], () => E.Z.getCurrentSearchId()), s = (0, u.e7)([S.Z], () => S.Z.keyboardModeEnabled), a = (0, u.e7)([E.Z], () => null != n ? E.Z.getEditorState(n) : null), i = l.useMemo(() => null != a ? a : P.nR(R.Jl(g.ZP)), [a]), o = (0, x.U)({
    location: "Search"
  });
  return n === Z.aib.DMS && o ? (0, r.jsx)(z, {
    className: t,
