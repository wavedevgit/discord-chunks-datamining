...
function W(e) {
  let {
    className: t
  } = e, n = (0, u.e7)([j.Z], () => j.Z.getCurrentSearchId()), l = (0, u.e7)([_.Z], () => _.Z.keyboardModeEnabled), a = (0, u.e7)([j.Z], () => null != n ? j.Z.getEditorState(n) : null), o = i.useMemo(() => null != a ? a : T.nR(P.Jl(h.ZP)), [a]), s = (0, E.U)({
    location: "Search"
  });
