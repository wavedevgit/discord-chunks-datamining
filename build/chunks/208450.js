...
function G(e) {
  let {
    className: t
  } = e, n = (0, u.e7)([j.Z], () => j.Z.getCurrentSearchId()), l = (0, u.e7)([m.Z], () => m.Z.keyboardModeEnabled), a = (0, u.e7)([j.Z], () => null != n ? j.Z.getEditorState(n) : null), o = s.useMemo(() => null != a ? a : E.nR(I.Jl(f.ZP)), [a]), i = (0, S.U)({
    location: "Search"
  });
