...
function H(e) {
  ...
  i.useEffect(() => {
    h.current && !f && (h.current = !1, (0, x.IZ)({
      searchContext: n
    })), !h.current && f && (h.current = !0)
  }, [f, n]);
  let E = i.useCallback(e => {
    ...
    N = v || A,
    D = i.useMemo(() => n.type === k.aib.DMS ? j.intl.string(j.t.m7OrlZ) : N ? (0, r.jsxs)(r.Fragment, {
    ...
    }) : j.intl.string(j.t["5h0QOD"]), [n.type, N, b]);
  return (0, r.jsx)(V, {
    className: t,
    searchContext: n,
    isSearching: c,
