...
class K extends l.PureComponent {
  ...
  constructor(e) {
    super(e), z(this, "state", {
    ...
    }), z(this, "_editorRef", void 0), z(this, "_containerRef", l.createRef()), z(this, "_searchBarRef", l.createRef()), z(this, "_searchPopoutRef", l.createRef()), z(this, "handleSetSearchQuery", e => {
      let {
        query: t,
        anchor: n,
        focus: r,
      ...
      a = N.iK(o, a), this.setEditorState(a), l && this.search({
        queryString: N.Sq(a)
      })
    }), z(this, "handleSelectedIndexChanged", e => {
      var t, n;
      null == (n = this._editorRef) || null == (t = n.editor) || t.setAttribute("aria-activedescendant", null != e ? "".concat(q, "-").concat(e) : void 0), this.setState({
        selectedIndex: e
      })
    }), z(this, "renderPopout", () => (0, r.jsx)(D.ZP, {
      ...
      if (null != t && !n) {
        ...
        }), d.uvj.announce(B.intl.string(B.t.pKCxWF)), this.handleBlur(!0)
      }
      return !0
      ...
      t = N.Hl(t, 0), this.setEditorState(t), null != n && (0, F.cy)({
        searchType: r,
        searchId: n
      ...
      return null != n && n.selectOption() || ((0, Z.X)() && t ? this.search({
        searchEverywhere: !0
      }) : this.search()), "handled"
...
function Q(e) {
  ...
  l.useEffect(() => {
    s.current && !t && (s.current = !1, (0, F.IZ)({
      searchId: n,
      searchType: r
...
function J(e) {
  let {
    ...
    type: H.aib.DMS
  }), []), i = (0, u.e7)([P.Z], () => P.Z.getSearchResultsQueryString(H.aib.DMS)), o = (0, O.jj)(a, U.sR.MESSAGES, i), c = (0, u.e7)([v.Z], () => {
    let e = v.Z.getTotalCount(o);
    return null != e && e > 0
  }), d = (0, u.e7)([v.Z], () => v.Z.getIsFetching(o)), h = d || c;
  Q({
    isSearchActive: h,
    searchId: H.aib.DMS,
...
function V(e) {
  let {
    ...
    keyboardModeEnabled: n,
    editorState: s
  } = e, a = (0, u.e7)([P.Z], () => P.Z.getCurrentSearchId()), i = (0, M.k)(a), o = (0, u.e7)([P.Z], () => P.Z.isActive(a)), c = (0, u.e7)([P.Z], () => P.Z.hasResults(a)), d = (0, u.e7)([P.Z], () => null != a && P.Z.isSearching(a));
  Q({
    isSearchActive: o,
    searchId: a,
    searchType: i
...
function X(e) {
  let {
    className: t
  } = e, n = (0, u.e7)([P.Z], () => P.Z.getCurrentSearchId()), s = (0, u.e7)([y.Z], () => y.Z.keyboardModeEnabled), a = (0, u.e7)([P.Z], () => null != n ? P.Z.getEditorState(n) : null), i = l.useMemo(() => null != a ? a : N.nR(A.Jl(g.ZP)), [a]), o = (0, _.U)({
    location: "Search"
  });
  return n === H.aib.DMS && o ? (0, r.jsx)(J, {
    className: t,
