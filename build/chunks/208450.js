...
class B extends s.PureComponent {
  ...
  constructor(e) {
    super(e), M(this, "state", {
      ...
      a = b.iK(i, a), this.setEditorState(a), s && this.search({
        queryString: b.Sq(a)
      })
    ...
    }), M(this, "renderPopout", () => (0, r.jsx)(T.ZP, {
      ...
      if (!t) {
        ...
        }), h.uvj.announce(A.intl.string(A.t.pKCxWF)), this.handleBlur(!0)
      }
      return !0
      ...
      searchAutocompleteSelectAction: w.ZW.KEY_PRESS
    }) : e.selectOption({
      searchAutocompleteSelectAction: w.ZW.KEY_PRESS
...
function H(e) {
  ...
  s.useEffect(() => {
    r.current && !t && (r.current = !1, (0, k.IZ)({
      searchContext: n
...
function W(e) {
  let {
    className: t,
    searchContext: n
  } = e, l = (0, O.WJ)(n), a = (0, u.e7)([f.Z], () => f.Z.keyboardModeEnabled), o = (0, u.e7)([C.Z], () => null != l ? C.Z.getEditorState(l) : null), i = s.useMemo(() => null != o ? o : b.nR(S.Jl(E.ZP)), [o]);
  return n.type === Z.aib.DMS ? (0, r.jsx)(Q, {
    searchContext: n,
    className: t,
    keyboardModeEnabled: a,
    editorState: i
