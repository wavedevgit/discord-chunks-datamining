...
class F extends s.PureComponent {
  ...
  constructor(e) {
    super(e), w(this, "state", {
      ...
      a = C.iK(o, a), this.setEditorState(a), s && this.search({
        queryString: C.Sq(a)
      })
    ...
    }), w(this, "renderPopout", () => (0, n.jsx)(N.ZP, {
      ...
      t = C.Hl(t, 0), this.setEditorState(t), null != r && (0, I.cy)({
        searchType: n,
        searchId: r
      ...
      return C.Sq(t).length >= 512 || (t = C.x0(e, t), t = C.Hl(t, 512), t = this.tokenize(t), this.setEditorState(t), r || this.setState({
        focused: !0
      })), "handled"
      ...
      switch (e) {
        ...
        case "delete":
        case "delete-word":
          return t = C.yd(e, t), t = this.tokenize(t), this.setEditorState(t), r || this.setState({
            focused: !0
          }), "handled";
      ...
      return e = null != e ? e.replace(/\n/g, "") : "", t = C.x0(e, t), t = C.Hl(t, 512), t = this.tokenize(t), r || this.setState({
        focused: !0
...
function H(e) {
  ...
  s.useEffect(() => {
    l.current && !t && (l.current = !1, (0, I.IZ)({
      searchId: r,
      searchType: n
...
function U(e) {
  let {
    ...
    keyboardModeEnabled: r,
    editorState: l
  } = e, a = (0, u.e7)([x.Z], () => x.Z.getCurrentSearchId()), i = (0, T.k)(a), {
    isSearching: o,
    isSearchActive: c,
    hasResults: h
  } = (0, u.cj)([y.Z], () => {
...
function W(e) {
  let {
    className: t
  } = e, r = (0, u.e7)([x.Z], () => x.Z.getCurrentSearchId()), l = (0, u.e7)([m.Z], () => m.Z.keyboardModeEnabled), a = (0, u.e7)([x.Z], () => null != r ? x.Z.getEditorState(r) : null), i = s.useMemo(() => null != a ? a : C.nR(j.Jl(f.ZP)), [a]), o = (0, _.U)({
    location: "Search"
  });
  return r === M.aib.DMS && o ? (0, n.jsx)(B, {
    className: t,
