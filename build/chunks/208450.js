...
class Z extends i.PureComponent {
  ...
  constructor(e) {
    super(e), j(this, "state", {
    ...
    }), j(this, "_editorRef", void 0), j(this, "_containerRef", i.createRef()), j(this, "_searchBarRef", i.createRef()), j(this, "_searchPopoutRef", i.createRef()), j(this, "handleSetSearchQuery", e => {
      let {
        query: t,
        anchor: n,
        focus: r,
      ...
      " " !== t.charAt(t.length - 1) && (t += " "), null != n && 0 !== n && " " !== s.charAt(n - 1) && " " !== t.charAt(0) && (t = " " + t), o ? (a = b.c2(t, a), n = 0) : a = b.x0(t, a, n, r), a = b.Hl(a, U), a = this.tokenize(a);
      let l = Number(n) + t.length;
      a = b.iK(l, a), this.setEditorState(a), i && this.search({
        queryString: b.Sq(a)
      })
    }), j(this, "handleSelectedIndexChanged", e => {
      var t, n;
      null == (n = this._editorRef) || null == (t = n.editor) || t.setAttribute("aria-activedescendant", null != e ? "".concat(G, "-").concat(e) : void 0), this.setState({
        selectedIndex: e
      })
    }), j(this, "renderPopout", () => (0, r.jsx)(P.ZP, {
      ...
      t = b.Hl(t, 0), this.setEditorState(t), (0, D.cy)({
        searchContext: n
      ...
      this.handleBlur()
    }), j(this, "handleOption", e => null != e && (-1 === e.state.selectedIndex && e.shouldShowSearchInSelectedChannel() ? e.handleSearchInChannel({
      searchAutocompleteSelectAction: L.ZW.KEY_PRESS
    }) : e.selectOption({
      searchAutocompleteSelectAction: L.ZW.KEY_PRESS
      ...
      return b.Sq(t).length >= U || (t = b.x0(e, t), t = b.Hl(t, U), t = this.tokenize(t), this.setEditorState(t), n || this.setState({
        focused: !0
      })), "handled"
      ...
      return e = null != e ? e.replace(/\n/g, "") : "", t = b.x0(e, t), t = b.Hl(t, U), t = this.tokenize(t), n || this.setState({
        focused: !0
...
function F(e) {
  ...
  i.useEffect(() => {
    r.current && !t && (r.current = !1, (0, D.IZ)({
      searchContext: n
...
function V(e) {
  ...
  let d = i.useCallback(e => {
    ...
    N.ZP.refreshSearchQueryAnalyticsId(t), (0, D.tI)({
      searchContext: t,
      query: r,
      queryString: n
