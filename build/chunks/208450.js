...
class W extends s.PureComponent {
  ...
  constructor(e) {
    super(e), B(this, "state", {
      ...
      t = T.Hl(t, 0), this.setEditorState(t), null != n && (0, M.cy)({
        searchType: r,
        searchId: n
...
function K(e) {
  ...
  s.useEffect(() => {
    l.current && !t && (l.current = !1, (0, M.IZ)({
      searchId: n,
      searchType: r
...
function Q(e) {
  let {
    ...
    type: L.aib.DMS
  }), []), i = (0, u.e7)([C.Z], () => C.Z.getSearchResultsQueryString(L.aib.DMS)), o = (0, E.jj)(a, H.sR.MESSAGES, i), c = (0, u.e7)([_.Z], () => {
...
function J(e) {
  let {
    ...
    keyboardModeEnabled: n,
    editorState: l
  } = e, a = (0, u.e7)([C.Z], () => C.Z.getCurrentSearchId()), i = (0, F.k)(a), o = (0, u.e7)([C.Z], () => C.Z.isActive(a)), c = (0, u.e7)([C.Z], () => C.Z.hasResults(a)), d = (0, u.e7)([C.Z], () => null != a && C.Z.isSearching(a));
  K({
    isSearchActive: o,
    searchId: a,
    searchType: i
