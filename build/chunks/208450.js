...
class B extends s.PureComponent {
  ...
  constructor(e) {
    super(e), D(this, "state", {
    ...
    }), D(this, "_editorRef", void 0), D(this, "_containerRef", s.createRef()), D(this, "_searchBarRef", s.createRef()), D(this, "_searchPopoutRef", s.createRef()), D(this, "handleSetSearchQuery", e => {
      let {
        query: t,
        anchor: n,
        focus: r,
    ...
    }), D(this, "renderPopout", () => (0, r.jsx)(w.ZP, {
      ...
      t = I.Hl(t, 0), this.setEditorState(t), null != n && (0, N.cy)({
        searchType: r,
        searchId: n
      ...
      return null != n && n.selectOption() || ((0, T.X)() && t ? this.search({
        searchEverywhere: !0
      }) : this.search()), "handled"
      ...
      return I.Sq(t).length >= 512 || (t = I.x0(e, t), t = I.Hl(t, 512), t = this.tokenize(t), this.setEditorState(t), n || this.setState({
        focused: !0
      })), "handled"
      ...
      switch (e) {
        ...
        case "delete":
        case "delete-word":
          return t = I.yd(e, t), t = this.tokenize(t), this.setEditorState(t), n || this.setState({
            focused: !0
          }), "handled";
      ...
      return e = null != e ? e.replace(/\n/g, "") : "", t = I.x0(e, t), t = I.Hl(t, 512), t = this.tokenize(t), n || this.setState({
        focused: !0
...
function z(e) {
  let {
    ...
    type: M.aib.DMS
  }), []), i = (0, u.e7)([O.Z], () => O.Z.getSearchResultsQueryString(M.aib.DMS)), o = (0, _.jj)(a, F.sR.MESSAGES, i), c = (0, u.e7)([x.Z], () => {
    let e = x.Z.getTotalCount(o);
    return null != e && e > 0
  }), d = (0, u.e7)([x.Z], () => x.Z.getIsFetching(o)), h = d || c;
  G({
    isSearchActive: h,
    searchId: M.aib.DMS,
...
function q(e) {
  let {
    ...
    keyboardModeEnabled: n,
    editorState: l
  } = e, a = (0, u.e7)([O.Z], () => O.Z.getCurrentSearchId()), i = (0, A.k)(a), o = (0, u.e7)([O.Z], () => O.Z.isActive(a)), c = (0, u.e7)([O.Z], () => O.Z.hasResults(a)), d = (0, u.e7)([O.Z], () => null != a && O.Z.isSearching(a));
  G({
    isSearchActive: o,
    searchId: a,
    searchType: i
...
function W(e) {
  let {
    className: t
  } = e, n = (0, u.e7)([O.Z], () => O.Z.getCurrentSearchId()), l = (0, u.e7)([S.Z], () => S.Z.keyboardModeEnabled), a = (0, u.e7)([O.Z], () => null != n ? O.Z.getEditorState(n) : null), i = s.useMemo(() => null != a ? a : I.nR(P.Jl(g.ZP)), [a]), o = (0, b.U)({
    location: "Search"
  });
  return n === M.aib.DMS && o ? (0, r.jsx)(z, {
    className: t,
