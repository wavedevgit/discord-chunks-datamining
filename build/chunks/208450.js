...
class F extends s.PureComponent {
  componentDidMount() {
    var e, t;
    y.S.subscribe(k.CkL.PERFORM_SEARCH, this.search), y.S.subscribe(k.CkL.SET_SEARCH_QUERY, this.handleSetSearchQuery), y.S.subscribe(k.CkL.FOCUS_SEARCH, this.handleFocusSearch), null == (t = this._editorRef) || null == (e = t.editor) || e.setAttribute("aria-haspopup", "listbox")
  }
  ...
  componentWillUnmount() {
    y.S.unsubscribe(k.CkL.PERFORM_SEARCH, this.search), y.S.unsubscribe(k.CkL.SET_SEARCH_QUERY, this.handleSetSearchQuery), y.S.unsubscribe(k.CkL.FOCUS_SEARCH, this.handleFocusSearch)
  }
  tokenize(e) {
    let t = (0, j.kG)(S.Sq(e)).filter(e => e.type !== d.ZP.NON_TOKEN_TYPE);
    return S.lv(t, e, R.ZP)
  }
  clearSearch() {
    let {
      searchContext: e
    } = this.props, t = (0, j.WJ)(e);
  ...
  constructor(e) {
    super(e), w(this, "state", {
    ...
    }), w(this, "_editorRef", void 0), w(this, "_containerRef", s.createRef()), w(this, "_searchBarRef", s.createRef()), w(this, "_searchPopoutRef", s.createRef()), w(this, "handleSetSearchQuery", e => {
      let {
        query: t,
        anchor: r,
        focus: n,
      ...
      a = S.iK(o, a), this.setEditorState(a), s && this.search({
        queryString: S.Sq(a)
      })
    ...
    }), w(this, "renderPopout", () => (0, n.jsx)(P.ZP, {
      ...
      if (!t) {
        let e = (0, j.kG)(r),
          t = (0, j.$G)(e);
        for (let t = 0; t < e.length; t++)(0, j.Fr)(e[t], e[t + 1]) || (r = r.substring(0, e[t].start) + r.substring(e[t].end));
        if (0 === e.length || 0 === Object.keys(t).length) return !1;
        this.props.onSearch({
          queryString: r,
          query: t,
          searchEverywhere: null != n && n
        }), h.uvj.announce(M.intl.string(M.t.pKCxWF)), this.handleBlur(!0)
      }
      return !0
      ...
      this.handleBlur()
    }), w(this, "handleOption", e => null != e && (-1 === e.state.selectedIndex && e.shouldShowSearchInSelectedChannel() ? e.handleSearchInChannel({
      searchAutocompleteSelectAction: A.ZW.KEY_PRESS
    }) : e.selectOption({
      searchAutocompleteSelectAction: A.ZW.KEY_PRESS
      ...
      return this.handleOption(r) || ((0, j.X$)() && t ? this.search({
        searchEverywhere: !0
      }) : this.search()), "handled"
      ...
      return S.Sq(t).length >= 512 || (t = S.x0(e, t), t = S.Hl(t, 512), t = this.tokenize(t), this.setEditorState(t), r || this.setState({
        focused: !0
      })), "handled"
      ...
      switch (e) {
        ...
        case "delete":
        case "delete-word":
          return t = S.yd(e, t), t = this.tokenize(t), this.setEditorState(t), r || this.setState({
            focused: !0
          }), "handled";
      ...
      return e = null != e ? e.replace(/\n/g, "") : "", t = S.x0(e, t), t = S.Hl(t, 512), t = this.tokenize(t), r || this.setState({
        focused: !0
      }), this.setEditorState(t), "handled"
    }), w(this, "setEditorState", e => {
      let {
        searchContext: t
      } = this.props, r = (0, j.WJ)(t);
      ...
      if (e.stopPropagation(), "Escape" === t) {
        if (e.preventDefault(), S.xb(s)) this.blurEditor();
          ...
          let e = S.FZ(s),
            t = (0, j.WJ)(l);
          b.Z.setSearchState(t, e), this.setState({
            focused: !0
          })
        }
        return !0
...
function W(e) {
  ...
  s.useEffect(() => {
    l.current && !t && (l.current = !1, (0, N.IZ)({
      searchId: r,
      searchType: n
...
function H(e) {
  let {
    ...
    let e = v.Z.getTotalCount(i);
    return {
      hasResults: null != e && e > 0,
      isSearching: v.Z.getIsFetching(i),
      isSearchActive: v.Z.hasSearchState(i)
    }
  });
  W({
    isSearchActive: c,
...
function U(e) {
  let {
    className: t,
    searchContext: r
  } = e, l = (0, j.WJ)(r), a = (0, u.e7)([f.Z], () => f.Z.keyboardModeEnabled), i = (0, u.e7)([C.Z], () => null != l ? C.Z.getEditorState(l) : null), o = s.useMemo(() => null != i ? i : S.nR(x.Jl(R.ZP)), [i]);
  return r.type === k.aib.DMS ? (0, n.jsx)(H, {
    searchContext: r,
    className: t,
    keyboardModeEnabled: a,
    editorState: o
