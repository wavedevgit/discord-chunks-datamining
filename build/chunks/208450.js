  ...
  constructor(e) {
    super(e), Z(this, "state", {
      ...
      t = j.Hl(t, 0), this.setEditorState(t), null != n && (0, N.cy)({
        searchType: r,
        searchAnalyticsId: v.Z.getAnalyticsId(n)
      ...
      this.setState({
        ...
        null == e || v.Z.isActive(e) || (0, N.IZ)({
          searchType: t,
          searchAnalyticsId: v.Z.getAnalyticsId(e)
...
function L(e) {
  let {
    className: t
  } = e, n = (0, u.e7)([v.Z], () => v.Z.getCurrentSearchId()), l = (0, u.e7)([v.Z], () => v.Z.getSearchType()), a = (0, u.e7)([v.Z], () => v.Z.isActive(n)), o = (0, u.e7)([v.Z], () => v.Z.hasResults(n)), s = (0, u.e7)([v.Z], () => null != n && v.Z.isSearching(n)), c = (0, u.e7)([_.Z], () => _.Z.keyboardModeEnabled), d = (0, u.e7)([v.Z], () => null != n ? v.Z.getEditorState(n) : null), p = i.useMemo(() => null != d ? d : j.nR(S.Jl(h.ZP)), [d]), m = function(e) {
    let t = i.useRef(null);
    return i.useEffect(() => {
      if (null != e) {
        let n = v.Z.getAnalyticsId(e);
        null != n && (t.current = n)
      }
    }, [e]), t
  }(n), f = i.useRef(a);
