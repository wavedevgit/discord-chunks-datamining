...
class G extends i.PureComponent {
          ...
          children: (0, r.jsx)("div", {
            ...
            children: (0, r.jsx)(d.tEY, {
              ...
              children: (0, r.jsxs)("div", {
                ...
                children: [this.renderInput(u), (0, r.jsx)(m.BK, {
  ...
  constructor(e) {
    super(e), U(this, "state", {
    ...
    }), U(this, "_editorRef", void 0), U(this, "_containerRef", i.createRef()), U(this, "_searchBarRef", i.createRef()), U(this, "_searchPopoutRef", i.createRef()), U(this, "handleSetSearchQuery", e => {
      let {
        query: t,
        anchor: n,
        focus: r,
      ...
      a = T.iK(s, a), this.setEditorState(a), i && this.search({
        queryString: T.Sq(a)
      })
    ...
    }), U(this, "renderPopout", () => (0, r.jsx)(R.ZP, {
      ...
      t = T.Hl(t, 0), this.setEditorState(t), null != n && (0, w.cy)({
        searchType: r,
        searchId: n
      ...
      return null != n && n.selectOption() || ((0, A.X)() && t ? this.search({
        searchEverywhere: !0
      }) : this.search()), "handled"
      ...
      switch (e) {
        ...
        case "delete":
        case "delete-word":
          return t = T.yd(e, t), t = this.tokenize(t), this.setEditorState(t), n || this.setState({
            focused: !0
          }), "handled";
...
function H(e) {
  ...
  i.useEffect(() => {
    l.current && !t && (l.current = !1, (0, w.IZ)({
      searchId: n,
      searchType: r
...
function V(e) {
  let {
    ...
    type: k.aib.DMS
  }), []), o = (0, u.e7)([j.Z], () => j.Z.getSearchResultsQueryString(k.aib.DMS)), s = (0, v.jj)(a, L.sR.MESSAGES, o), c = (0, u.e7)([E.Z], () => {
    let e = E.Z.getTotalCount(s);
    return null != e && e > 0
  }), d = (0, u.e7)([E.Z], () => E.Z.getIsFetching(s)), m = d || c;
  H({
    isSearchActive: m,
    searchId: k.aib.DMS,
...
function z(e) {
  let {
    ...
    keyboardModeEnabled: n,
    editorState: l
  } = e, a = (0, u.e7)([j.Z], () => j.Z.getCurrentSearchId()), o = (0, Z.k)(a), s = (0, u.e7)([j.Z], () => j.Z.isActive(a)), c = (0, u.e7)([j.Z], () => j.Z.hasResults(a)), d = (0, u.e7)([j.Z], () => null != a && j.Z.isSearching(a));
  H({
    isSearchActive: s,
    searchId: a,
    searchType: o
...
function W(e) {
  let {
    className: t
  } = e, n = (0, u.e7)([j.Z], () => j.Z.getCurrentSearchId()), l = (0, u.e7)([_.Z], () => _.Z.keyboardModeEnabled), a = (0, u.e7)([j.Z], () => null != n ? j.Z.getEditorState(n) : null), o = i.useMemo(() => null != a ? a : T.nR(P.Jl(h.ZP)), [a]), s = (0, y.U)({
    location: "Search"
  });
  return n === k.aib.DMS && s ? (0, r.jsx)(V, {
    className: t,
