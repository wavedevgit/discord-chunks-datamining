...
class L extends s.PureComponent {
  ...
  tokenize(e) {
    let t = (0, _.kG)(S.Sq(e)).filter(e => e.type !== d.ZP.NON_TOKEN_TYPE);
    return S.lv(t, e, E.ZP)
  }
  clearSearch() {
    let {
      searchContext: e
    } = this.props, t = (0, _.WJ)(e);
    R.Z.cleanUpSearchState(t)
  }
  handlePastedFiles() {
    return "handled"
  }
          ...
          children: (0, r.jsx)("div", {
            ...
            children: (0, r.jsx)(h.tEY, {
              ...
              children: (0, r.jsxs)("div", {
                ...
                children: [this.renderInput(u), (0, r.jsx)(h.BK9, {
  ...
  constructor(e) {
    super(e), M(this, "state", {
      ...
      var t, n;
      null == (n = this._editorRef) || null == (t = n.editor) || t.setAttribute("aria-activedescendant", null != e ? "".concat(D, "-").concat(e) : void 0), this.setState({
        selectedIndex: e
      })
    }), M(this, "renderPopout", () => (0, r.jsx)(P.ZP, {
      ...
      if (!t) {
        let e = (0, _.kG)(n),
          t = (0, _.$G)(e);
        for (let t = 0; t < e.length; t++)(0, _.Fr)(e[t], e[t + 1]) || (n = n.substring(0, e[t].start) + n.substring(e[t].end));
      ...
      (0, N.PJ)({
        ...
        null == e || e.focus(), this.handleSetSearchQuery({
          query: E.ZP[w.dCx.FILTER_IN].key + "".concat(o, " "),
          replace: !0
        })
      })
    }), M(this, "focusEditor", () => {
      ...
      this.handleBlur()
    }), M(this, "handleOption", e => null != e && (-1 === e.state.selectedIndex && e.shouldShowSearchInSelectedChannel() ? e.handleSearchInChannel({
      ...
      return this.handleOption(n) || ((0, _.X$)() && t ? this.search({
        searchEverywhere: !0
      }) : this.search()), "handled"
      ...
      return S.Sq(t).length >= 512 || (t = S.x0(e, t), t = S.Hl(t, 512), t = this.tokenize(t), this.setEditorState(t), n || this.setState({
        focused: !0
      })), "handled"
      ...
      switch (e) {
        ...
        case "delete":
        case "delete-word":
          return t = S.yd(e, t), t = this.tokenize(t), this.setEditorState(t), n || this.setState({
            focused: !0
          }), "handled";
      ...
      return e = null != e ? e.replace(/\n/g, "") : "", t = S.x0(e, t), t = S.Hl(t, 512), t = this.tokenize(t), n || this.setState({
        focused: !0
      }), this.setEditorState(t), "handled"
    }), M(this, "setEditorState", e => {
      let {
        searchContext: t
      } = this.props, n = (0, _.WJ)(t);
      ...
      if (e.stopPropagation(), "Escape" === t) {
        if (e.preventDefault(), S.xb(s)) this.blurEditor();
          ...
          let e = S.FZ(s),
            t = (0, _.WJ)(l);
          v.Z.setSearchState(t, e), this.setState({
            focused: !0
          })
        }
        return !0
...
function W(e) {
  let {
    className: t,
    searchContext: n
  } = e, l = (0, _.WJ)(n), a = (0, u.e7)([f.Z], () => f.Z.keyboardModeEnabled), i = (0, u.e7)([C.Z], () => null != l ? C.Z.getEditorState(l) : null), o = s.useMemo(() => null != i ? i : S.nR(b.Jl(E.ZP)), [i]);
  return n.type === w.aib.DMS ? (0, r.jsx)(H, {
    searchContext: n,
    className: t,
    keyboardModeEnabled: a,
    editorState: o
