...
class V extends i.PureComponent {
  componentDidMount() {
    var e, t;
    b.S.subscribe(k.CkL.PERFORM_SEARCH, this.search), b.S.subscribe(k.CkL.SET_SEARCH_QUERY, this.handleSetSearchQuery), b.S.subscribe(k.CkL.FOCUS_SEARCH, this.handleFocusSearch), null == (t = this._editorRef) || null == (e = t.editor) || e.setAttribute("aria-haspopup", "listbox")
  }
  ...
  componentWillUnmount() {
    b.S.unsubscribe(k.CkL.PERFORM_SEARCH, this.search), b.S.unsubscribe(k.CkL.SET_SEARCH_QUERY, this.handleSetSearchQuery), b.S.unsubscribe(k.CkL.FOCUS_SEARCH, this.handleFocusSearch)
  }
  tokenize(e) {
  ...
  constructor(e) {
    super(e), G(this, "state", {
    ...
    }), G(this, "_editorRef", void 0), G(this, "_containerRef", i.createRef()), G(this, "_searchBarRef", i.createRef()), G(this, "_searchPopoutRef", i.createRef()), G(this, "handleSetSearchQuery", e => {
      let {
        query: t,
        anchor: n,
        focus: r,
      ...
      if (!t) {
        ...
        }), d.uvj.announce(j.intl.string(j.t.pKCxWF)), this.handleBlur(!0)
      }
      return !0
      ...
      this.handleBlur()
    }), G(this, "handleOption", e => null != e && (-1 === e.state.selectedIndex && e.shouldShowSearchInSelectedChannel() ? e.handleSearchInChannel({
      ...
      if ("Home" === t || "ArrowLeft" === t && n) return e.preventDefault(), i = r ? y.R8(i) : y.eE(i), this.setEditorState(i), !0;
      if ("End" === t || "ArrowRight" === t && n) return e.preventDefault(), i = r ? y.Wg(i) : y.NJ(i), this.setEditorState(i), !0;
...
function H(e) {
  ...
  i.useEffect(() => {
    r.current && !t && (r.current = !1, (0, x.IZ)({
      searchContext: n
...
function Y(e) {
  ...
  let d = i.useCallback(e => {
    ...
    R.ZP.refreshSearchQueryAnalyticsId(t), (0, x.tI)({
      searchContext: t,
      query: r,
      queryString: n
...
function W(e) {
  ...
  let E = i.useCallback(e => {
    ...
    b = i.useMemo(() => h ? (0, r.jsxs)(r.Fragment, {
...
function K(e) {
  ...
  return n.type === k.aib.DMS ? (0, r.jsx)(Y, {
    searchContext: n,
    className: t,
    keyboardModeEnabled: a,
    editorState: l
