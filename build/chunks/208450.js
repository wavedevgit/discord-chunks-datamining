...
function z(e) {
  let {
    className: t
  } = e, n = (0, u.e7)([O.Z], () => O.Z.getCurrentSearchId()), s = (0, u.e7)([S.Z], () => S.Z.keyboardModeEnabled), a = (0, u.e7)([O.Z], () => null != n ? O.Z.getEditorState(n) : null), i = l.useMemo(() => null != a ? a : C.nR(P.Jl(g.ZP)), [a]), o = (0, x.U)({
    location: "Search"
  });
