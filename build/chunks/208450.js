...
class U extends s.PureComponent {
  ...
  constructor(e) {
    super(e), D(this, "state", {
      ...
      a = R.iK(o, a), this.setEditorState(a), s && this.search({
        queryString: R.Sq(a)
      })
    ...
    }), D(this, "renderPopout", () => (0, r.jsx)(k.ZP, {
      ...
      t = R.Hl(t, 0), this.setEditorState(t), null != n && (0, A.cy)({
        searchType: r,
        searchId: n
      ...
      return null != n && n.selectOption() || ((0, N.X)() && t ? this.search({
        searchEverywhere: !0
      }) : this.search()), "handled"
...
function G(e) {
  ...
  s.useEffect(() => {
    l.current && !t && (l.current = !1, (0, A.IZ)({
      searchId: n,
      searchType: r
...
function z(e) {
  let {
    ...
    type: M.aib.DMS
  }), []), i = (0, u.e7)([j.Z], () => j.Z.getSearchResultsQueryString(M.aib.DMS)), o = (0, E.jj)(a, F.sR.MESSAGES, i), c = (0, u.e7)([_.Z], () => {
    let e = _.Z.getTotalCount(o);
    return null != e && e > 0
  }), d = (0, u.e7)([_.Z], () => _.Z.getIsFetching(o)), p = d || c;
  G({
    isSearchActive: p,
    searchId: M.aib.DMS,
...
function q(e) {
  let {
    ...
    keyboardModeEnabled: n,
    editorState: l
  } = e, a = (0, u.e7)([j.Z], () => j.Z.getCurrentSearchId()), i = (0, w.k)(a), o = (0, u.e7)([j.Z], () => j.Z.isActive(a)), c = (0, u.e7)([j.Z], () => j.Z.hasResults(a)), d = (0, u.e7)([j.Z], () => null != a && j.Z.isSearching(a));
  G({
    isSearchActive: o,
    searchId: a,
    searchType: i
...
function W(e) {
  let {
    className: t
  } = e, n = (0, u.e7)([j.Z], () => j.Z.getCurrentSearchId()), l = (0, u.e7)([S.Z], () => S.Z.keyboardModeEnabled), a = (0, u.e7)([j.Z], () => null != n ? j.Z.getEditorState(n) : null), i = s.useMemo(() => null != a ? a : R.nR(T.Jl(g.ZP)), [a]), o = (0, x.U)({
    location: "Search"
  });
