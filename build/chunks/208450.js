...
function L(e) {
  let {
    className: t
  } = e, n = (0, u.e7)([y.Z], () => y.Z.getCurrentSearchId()), l = (0, u.e7)([y.Z], () => y.Z.getSearchType()), a = (0, u.e7)([y.Z], () => y.Z.isActive(n)), o = (0, u.e7)([y.Z], () => y.Z.hasResults(n)), s = (0, u.e7)([y.Z], () => null != n && y.Z.isSearching(n)), c = (0, u.e7)([_.Z], () => _.Z.keyboardModeEnabled), d = (0, u.e7)([y.Z], () => null != n ? y.Z.getEditorState(n) : null), p = i.useMemo(() => null != d ? d : j.nR(S.Jl(h.ZP)), [d]), m = i.useRef(a);
  return i.useEffect(() => {
