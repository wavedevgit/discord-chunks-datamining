...
class H extends s.PureComponent {
  ...
  render() {
    let {
      ...
      focused: l
    } = this.state, i = I.Sq(t).length > 0;
    return null == e ? null : (0, n.jsx)(d.yRy, {
          ...
          children: (0, n.jsx)("div", {
            ...
            children: (0, n.jsx)(d.tEY, {
              ...
              children: (0, n.jsxs)("div", {
                ...
                children: [this.renderInput(u), (0, n.jsx)(d.BK9, {
  ...
  constructor(e) {
    super(e), w(this, "state", {
      ...
      a = I.iK(o, a), this.setEditorState(a), s && this.search({
        queryString: I.Sq(a)
      })
    }), w(this, "handleSelectedIndexChanged", e => {
      var t, r;
      null == (r = this._editorRef) || null == (t = r.editor) || t.setAttribute("aria-activedescendant", null != e ? "".concat(F, "-").concat(e) : void 0), this.setState({
        selectedIndex: e
      })
    }), w(this, "renderPopout", () => (0, n.jsx)(A.ZP, {
      ...
      if (null != t && !r) {
        ...
        }), d.uvj.announce(M.intl.string(M.t.pKCxWF)), this.handleBlur(!0)
      }
      return !0
      ...
      t = I.Hl(t, 0), this.setEditorState(t), null != r && (0, T.cy)({
        searchType: n,
        searchId: r
      ...
      searchAutocompleteSelectAction: Z.Z.KEY_PRESS
    }) : e.selectOption({
      searchAutocompleteSelectAction: Z.Z.KEY_PRESS
      ...
      return this.handleOption(r) || ((0, R.X)() && t ? this.search({
        searchEverywhere: !0
      }) : this.search()), "handled"
      ...
      return I.Sq(t).length >= 512 || (t = I.x0(e, t), t = I.Hl(t, 512), t = this.tokenize(t), this.setEditorState(t), r || this.setState({
        focused: !0
      })), "handled"
      ...
      switch (e) {
        ...
        case "delete":
        case "delete-word":
          return t = I.yd(e, t), t = this.tokenize(t), this.setEditorState(t), r || this.setState({
            focused: !0
          }), "handled";
      ...
      return e = null != e ? e.replace(/\n/g, "") : "", t = I.x0(e, t), t = I.Hl(t, 512), t = this.tokenize(t), r || this.setState({
        focused: !0
...
function U(e) {
  let {
    ...
    return null != e && e > 0
  }), o = (0, u.e7)([b.Z], () => b.Z.getIsFetching(k.aib.DMS)), c = o || i;
  B({
    isSearchActive: c,
    searchId: k.aib.DMS,
...
function W(e) {
  let {
    ...
    keyboardModeEnabled: r,
    editorState: l
  } = e, a = (0, u.e7)([E.Z], () => E.Z.getCurrentSearchId()), i = (0, P.k)(a), o = (0, u.e7)([E.Z], () => E.Z.isActive(a)), c = (0, u.e7)([E.Z], () => E.Z.hasResults(a)), d = (0, u.e7)([E.Z], () => null != a && E.Z.isSearching(a));
  B({
    isSearchActive: o,
    searchId: a,
    searchType: i
...
function G(e) {
  let {
    className: t
  } = e, r = (0, u.e7)([E.Z], () => E.Z.getCurrentSearchId()), l = (0, u.e7)([m.Z], () => m.Z.keyboardModeEnabled), a = (0, u.e7)([E.Z], () => null != r ? E.Z.getEditorState(r) : null), i = s.useMemo(() => null != a ? a : I.nR(j.Jl(f.ZP)), [a]), o = (0, y.U)({
    location: "Search"
  });
  return r === k.aib.DMS && o ? (0, n.jsx)(U, {
    className: t,
