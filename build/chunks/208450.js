...
class H extends s.PureComponent {
  ...
  constructor(e) {
    super(e), L(this, "state", {
    ...
    }), L(this, "renderPopout", () => (0, r.jsx)(k.ZP, {
      ...
      if (null != t && !n) {
        ...
        }), d.uvj.announce(w.intl.string(w.t.pKCxWF)), this.handleBlur(!0)
      }
      return !0
...
function U(e) {
  let {
    ...
    return null != e && e > 0
  }), i = (0, u.e7)([x.Z], () => x.Z.getIsFetching(Z.aib.DMS)), c = i || o;
  B({
    isSearchActive: c,
    searchId: Z.aib.DMS,
  ...
  let d = s.useCallback(e => {
    ...
    (0, P.Fs)(Z.aib.DMS), N.Z.fetchCrossDMMessages({
      searchContext: a,
      selectedPageIndex: 0,
      queryString: t
    })
...
function W(e) {
  ...
  return n === Z.aib.DMS && i ? (0, r.jsx)(U, {
    className: t,
