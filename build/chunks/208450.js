...
r(539658);
let L = (0, g.hQ)(),
  D = c()(T.Z.fetchMessages, 500);
class F extends s.PureComponent {
  componentDidMount() {
    var e, t;
    S.S.subscribe(Z.CkL.PERFORM_SEARCH, this.search), S.S.subscribe(Z.CkL.SET_SEARCH_QUERY, this.handleSetSearchQuery), S.S.subscribe(Z.CkL.FOCUS_SEARCH, this.handleFocusSearch), null == (t = this._editorRef) || null == (e = t.editor) || e.setAttribute("aria-haspopup", "listbox")
  }
  componentDidUpdate(e) {
    ...
    if (t !== e.editorState) {
      let e = (0, C.kG)(y.Sq(t)),
        n = b.g9(e, t);
      x.Z.updateAutocompleteQuery(r, e, n), null != this._editorRef && y.iE(this._editorRef.editor)
    }
  }
  ...
  tokenize(e) {
    let t = (0, C.kG)(y.Sq(e)).filter(e => e.type !== d.ZP.NON_TOKEN_TYPE);
    return y.lv(t, e, I.ZP)
  }
  clearSearch() {
    let {
      searchId: e
  ...
  constructor(e) {
    super(e), w(this, "state", {
      ...
      a = y.iK(o, a), this.setEditorState(a), s && this.search({
        queryString: y.Sq(a)
      })
    }), w(this, "handleSelectedIndexChanged", e => {
      var t, r;
      null == (r = this._editorRef) || null == (t = r.editor) || t.setAttribute("aria-activedescendant", null != e ? "".concat(L, "-").concat(e) : void 0), this.setState({
        selectedIndex: e
      })
      ...
      t = y.Hl(t, 0), this.setEditorState(t), null != r && (0, N.cy)({
        searchType: n,
        searchId: r
      ...
      (0, N.PJ)({
        ...
        null == e || e.focus(), this.handleSetSearchQuery({
          query: I.ZP[Z.dCx.FILTER_IN].key + "".concat(c, " "),
          replace: !0
        })
      })
    }), w(this, "focusEditor", () => {
      ...
      return this.handleOption(r) || ((0, C.X$)() && t ? this.search({
        searchEverywhere: !0
      }) : this.search()), "handled"
      ...
      return y.Sq(t).length >= 512 || (t = y.x0(e, t), t = y.Hl(t, 512), t = this.tokenize(t), this.setEditorState(t), r || this.setState({
        focused: !0
      })), "handled"
      ...
      switch (e) {
        ...
        case "delete":
        case "delete-word":
          return t = y.yd(e, t), t = this.tokenize(t), this.setEditorState(t), r || this.setState({
            focused: !0
          }), "handled";
      ...
      return e = null != e ? e.replace(/\n/g, "") : "", t = y.x0(e, t), t = y.Hl(t, 512), t = this.tokenize(t), r || this.setState({
        focused: !0
...
function B(e) {
  ...
  let h = s.useCallback(e => {
    ...
    (0, N.LQ)(Z.aib.DMS), (0, N.tI)({
      searchType: (0, R.g)(Z.aib.DMS),
      searchId: Z.aib.DMS,
      query: r,
      queryString: t
...
function W(e) {
  let {
    ...
    keyboardModeEnabled: r,
    editorState: l
  } = e, a = (0, u.e7)([v.Z], () => v.Z.getCurrentSearchId()), i = (0, R.k)(a), {
    isSearching: o,
    isSearchActive: c,
    hasResults: h
  } = (0, u.cj)([E.Z], () => {
...
function U(e) {
  let {
    className: t
  } = e, r = (0, u.e7)([v.Z], () => v.Z.getCurrentSearchId()), l = (0, u.e7)([f.Z], () => f.Z.keyboardModeEnabled), a = (0, u.e7)([v.Z], () => null != r ? v.Z.getEditorState(r) : null), i = s.useMemo(() => null != a ? a : y.nR(b.Jl(I.ZP)), [a]), o = (0, j.U)({
    location: "Search"
  });
  return r === Z.aib.DMS && o ? (0, n.jsx)(B, {
    className: t,
