...
function tc(e) {
  let {
    ...
    nameplate: m,
    "data-jump-section": g
  } = e, p = r.useRef(null), h = null != t ? t : p, b = (0, P.Z)(null == a ? void 0 : a.avatarDecoration), _ = (0, eW.NZ)({
    avatarDecoration: b,
    ...
    return (0, O.Z)(() => l(!0), 750), r.useEffect(() => {
      ...
      return eX.S.subscribe(e4.CkL.SHOW_ACCOUNT_PROFILE_POPOUT, t), () => {
  ...
  return null == a ? null : (0, i.jsx)(x.Z, {
    ...
    children: (0, i.jsx)(e_.Z, {
      ...
      targetElementRef: h,
      clickTrap: !0,
      preload: () => (0, ef.Z)(a.id, a.getAvatarURL(void 0, e_.I), {
        type: "account_popout",
        withMutualGuilds: !1,
        withMutualFriends: !1
      }),
...
class td extends r.PureComponent {
  ...
  constructor(...e) {
    super(...e), ti(this, "copiedTimeout", new m.V7), ti(this, "copiedDecayTimeout", new m.V7), ti(this, "speakingWhileMutedTooltipTimeout", new m.V7), ti(this, "lastSpeakingWhileMutedNotificationTime", void 0), ti(this, "state", {
      ...
      if (null == e) return;
      (0, eK.JG)(e3.ZP.getUserTag(e, {
        decoration: "never",
        identifiable: "always"
      })), eY.default.track(e4.rMx.TEXT_COPIED, {
        type: "User Tag"
      });
      let i = {
...
function tm() {
  ...
  return !R && (M && (1 === U ? ea.settings.push(u.z.USER_SAFETY_CONSUMER_EDUCATION_MUTE) : ea.settings.push(u.z.USER_SAFETY_CONSUMER_EDUCATION_BLOCK)), ee && ea.settings.push(u.z.SOUNDBOARD_VOLUME_EDUCATION), V && ea.settings.push(u.z.PER_GUILD_COLLECTIBLES_CUSTOMIZATION_COACHMARK), G && ea.avatar.push(u.z.PREMIUM_SUBSCRIPTION_APRIL_MARKETING_DECO_TOOLTIP), H && ea.avatar.push(u.z.EXPIRING_STATUS_COACHMARK)), (0, i.jsx)(A.Gt, {
    value: et,
    children: (0, i.jsx)(td, {
      currentUser: t,
      activities: r,
...
function tg(e) {
  ...
  return (0, i.jsx)(f.yRy, {
    ...
    align: "center",
    shouldShow: null != h,
    renderPopout: h === u.z.USER_SAFETY_CONSUMER_EDUCATION_BLOCK ? () => (0, i.jsx)(eu.Z, {
      markAsDismissed: b
    }) : h === u.z.USER_SAFETY_CONSUMER_EDUCATION_MUTE ? () => (0, i.jsx)(em.Z, {
      markAsDismissed: b
          ...
          return !s && (ei && o.push(u.z.VOICE_FILTER_EARLY_ACCESS_COACHMARK), o.push(u.z.VOICE_FILTER_LAUNCH_COACHMARK), Y && w && !D && o.push(u.z.VOICE_FILTER_FIRST_USE_COACHMARK)), (0, i.jsx)("div", {
            children: (0, i.jsx)(K.ZP, {
              ...
              children: e => {
                ...
                t === u.z.VOICE_FILTER_EARLY_ACCESS_COACHMARK ? o = (0, i.jsx)(eA.U, {
                  markAsDismissed: s,
                  onCTA: () => X(!0)
