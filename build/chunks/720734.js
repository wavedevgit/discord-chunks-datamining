...
function td(e) {
  let {
    ...
    let e = r.useRef(null),
      ...
      [n, i] = r.useState(),
      [s, l] = r.useState(!1);
    return (0, v.Z)(() => l(!0), 750), r.useEffect(() => {
      let t = t => {
        var n;
        let {
          highlightBadge: r
      ...
      return eJ.S.subscribe(e7.CkL.SHOW_ACCOUNT_PROFILE_POPOUT, t), () => {
  ...
  return null == a ? null : (0, i.jsx)(C.Z, {
    ...
    children: (0, i.jsx)(ej.Z, {
      ...
      children: e => (O(e), (0, i.jsxs)(_.P3F, tl(ts({
        innerRef: h,
        style: I
      }, e), {
        onClick: t => {
        ...
        className: l()(ti.avatarWrapper, !f && ti.experiment, {
          [ti.plated]: null != m
        }),
        children: [(0, i.jsx)(ta, {
...
class tu extends r.PureComponent {
  ...
  renderStatus() {
    ...
    }) : null != s && s !== e7.Skl.UNKNOWN && r.isPomelo() ? (0, i.jsx)(A.Z, {
      hoverText: l,
      forceHover: e,
      children: (0, i.jsx)(y.Z, {
        text: e8.ZP.humanizeStatus(s)
      })
    }) : l
  }
  ...
  constructor(...e) {
    super(...e), tr(this, "copiedTimeout", new m.V7), tr(this, "copiedDecayTimeout", new m.V7), tr(this, "speakingWhileMutedTooltipTimeout", new m.V7), tr(this, "lastSpeakingWhileMutedNotificationTime", void 0), tr(this, "state", {
    ...
    }), tr(this, "audioOnInteractionHandler", (0, F.u)("AudioDeviceMenu", P.Z.ACCOUNT)), tr(this, "handleInputAudioContextMenu", (e, t) => {
      (0, x.jW)(e, async () => {
        let {
          default: e
      ...
      (0, eX.JG)(e8.ZP.getUserTag(e, {
        decoration: "never",
        identifiable: "always"
      })), eK.default.track(e7.rMx.TEXT_COPIED, {
        type: "User Tag"
      });
      let i = {
...
function tg() {
  ...
  let J = (0, d.e7)([eb.Z], () => eb.Z.hasHadOtherUserPlaySoundInSession()),
    ...
    es = (0, d.e7)([ex.Z, eY.default, eM.Z], () => {
      let e, t = ex.Z.getSyncingWith(),
        n = ex.Z.getActivity(),
        i = [];
      if (null != t ? e = t.partyId : null != n && null != n.party && null != n.party.id && (e = n.party.id), null != e) {
        var r;
        i = o()(Array.from(null != (r = eM.Z.getParty(e)) ? r : [])).map(e => eY.default.getUser(e)).filter(e0.lm).value()
      }
      return i.length > 1
    }),
    el = (0, W.Z)({
  ...
  return !A && (M && (1 === U ? eo.settings.push(u.z.USER_SAFETY_CONSUMER_EDUCATION_MUTE) : eo.settings.push(u.z.USER_SAFETY_CONSUMER_EDUCATION_BLOCK)), J && eo.settings.push(u.z.SOUNDBOARD_VOLUME_EDUCATION), V && eo.settings.push(u.z.PER_GUILD_COLLECTIBLES_CUSTOMIZATION_COACHMARK), G && eo.avatar.push(u.z.PREMIUM_SUBSCRIPTION_APRIL_MARKETING_DECO_TOOLTIP), H && eo.avatar.push(u.z.EXPIRING_STATUS_COACHMARK), el && eo.avatar.push(u.z.CUSTOM_STATUS_PROMPTS_COACHMARK)), (0, i.jsx)(R.Gt, {
    value: $,
    children: (0, i.jsx)(tu, {
      currentUser: t,
      activities: r,
...
function tp(e) {
  ...
  return (0, i.jsx)(_.yRy, {
    ...
    align: "center",
    shouldShow: null != p,
    renderPopout: p === u.z.USER_SAFETY_CONSUMER_EDUCATION_BLOCK ? () => (0, i.jsx)(eh.Z, {
      markAsDismissed: h
    }) : p === u.z.USER_SAFETY_CONSUMER_EDUCATION_MUTE ? () => (0, i.jsx)(ef.Z, {
      markAsDismissed: h
...
function th(e) {
  let {
    ...
    activeVoice: A,
    mostRecentlyRequestedVoiceId: D,
    lastInitAttemptMayHaveCrashed: Z
  } = (0, eA.o)(), {
    showSilentLagWarning: w
  } = (0, ey.Y)(), k = null != A, L = (0, eN.z)(A), B = (0, d.e7)([eG.Z], () => eG.Z.isConnected()), {
    Component: U,
    events: V,
    play: G
  } = k ? y : N, F = n || s ? _.v0G : U, H = w ? tn.intl.string(tn.t.ARRV6u) : null, z = (0, M.Z)(t, n, s, a), Y = null != o ? o : null != H ? (0, i.jsxs)("div", {
    className: ti.tooltipWithSubtext,
    children: [(0, i.jsx)(_.Text, {
      variant: "text-sm/medium",
      color: "currentColor",
      children: z
    }), null != H && (0, i.jsx)(_.Text, {
  ...
  } = (0, R.ZP)(P.Z.AUDIO_INPUT_BUTTON), K = (0, eT.Hu)({
    ...
    children: (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsx)(e2.Z, {
        ...
        children: (e, t) => {
          ...
          let l = s ? _.u04 : _.CJ0,
            o = [];
          return !s && (o.push(u.z.VOICE_FILTER_LAUNCH_COACHMARK), q && B && !k && o.push(u.z.VOICE_FILTER_FIRST_USE_COACHMARK)), (0, i.jsx)("div", {
            children: (0, i.jsx)($.ZP, {
              bypassAutoDismiss: !0,
              contentTypes: o,
              children: e => {
                ...
                return t === u.z.VOICE_FILTER_LAUNCH_COACHMARK ? o = (0, i.jsx)(eD.n, {
                  markAsDismissed: s,
                  onCTA: () => J(!0)
                }) : t === u.z.VOICE_FILTER_FIRST_USE_COACHMARK && (o = (0, i.jsx)(eR.v, {
                  markAsDismissed: s,
                  onCTA: () => J(!0)
                })), (0, i.jsx)(_.yRy, {
                  targetElementRef: I,
...
function tf(e) {
  ...
  } = (0, R.ZP)(P.Z.AUDIO_OUTPUT_BUTTON);
  r.useEffect(() => () => p(), [u, p]);
