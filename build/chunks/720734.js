...
function tn(e) {
  let {
    ...
    location: "RTC Avatar"
  }), b = (0, R.Z)(null == s ? void 0 : s.avatarDecoration), _ = (0, eF.NZ)({
    avatarDecoration: b,
    ...
    return (0, S.Z)(() => l(!0), 750), r.useEffect(() => {
      ...
      return ez.S.subscribe(e0.CkL.SHOW_ACCOUNT_PROFILE_POPOUT, t), () => {
  ...
  return null == s ? null : (0, i.jsx)(E.Z, {
    ...
    children: (0, i.jsx)(eE.Z, {
      ...
      children: e => (j(e), (0, i.jsxs)(f.P3F, e4(e9({
        innerRef: g,
        style: v
      }, e), {
        onClick: t => {
...
class ti extends r.PureComponent {
  ...
  renderCopiedSuccess() {
    let {
      copiedStreak: e
    } = this.state, t = [e3.intl.string(e3.t.MSaeTU), e3.intl.string(e3.t.UmrCw8), e3.intl.string(e3.t.gKE0Ji), e3.intl.string(e3.t["4DSKbm"]), e3.intl.string(e3.t["+8ENdX"]), e3.intl.string(e3.t.GlWHv7), e3.intl.string(e3.t.hIzxU1), e3.intl.string(e3.t["26uMPD"]), e3.intl.string(e3.t.uFs7R0), e3.intl.string(e3.t.bLXdcX), e3.intl.string(e3.t.gPg9fX)], n = Math.min(Math.max(0, e - 1), t.length - 1);
  ...
  renderStatus() {
    ...
    }) : null != s && s !== e0.Skl.UNKNOWN && r.isPomelo() ? (0, i.jsx)(y.Z, {
      hoverText: l,
      forceHover: e,
  ...
  renderAvatarWithPopout(e) {
    ...
    return (0, i.jsx)(tn, e4(e9({}, this.props), {
      handleClick: n,
    ...
    return null == e ? null : (0, i.jsx)(f.Wdt, {
      children: e => (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsxs)("div", {
          ...
          }), this.renderNameZone(e), (0, i.jsx)(tr, e4(e9({}, this.props, this.state), {
  ...
  constructor(...e) {
    super(...e), e8(this, "copiedTimeout", new d.V7), e8(this, "copiedDecayTimeout", new d.V7), e8(this, "speakingWhileMutedTooltipTimeout", new d.V7), e8(this, "lastSpeakingWhileMutedNotificationTime", void 0), e8(this, "state", {
      hovered: !1,
      copiedStreak: 0,
      ...
      hoveringOnMute: !1
    }), e8(this, "containerRef", r.createRef()), e8(this, "handleToggleSelfMute", () => {
      let {
        serverMute: e,
        suppress: t,
        selfMute: n
    ...
    }), e8(this, "audioOnInteractionHandler", (0, V.u)("AudioDeviceMenu", A.Z.ACCOUNT)), e8(this, "handleInputAudioContextMenu", (e, t) => {
      (0, _.jW)(e, async () => {
        let {
          default: e
      ...
      (0, eH.JG)(eq.ZP.getUserTag(e, {
        decoration: "never",
        identifiable: "always"
      })), eG.default.track(e0.rMx.TEXT_COPIED, {
        type: "User Tag"
      });
      let i = {
      ...
      let {
        ...
        hoveringOnMute: s
      } = this.state, l = void 0 === this.lastSpeakingWhileMutedNotificationTime || Date.now() - this.lastSpeakingWhileMutedNotificationTime > e7;
...
function tl(e) {
  ...
  return (0, i.jsx)(f.yRy, {
    ...
    align: "center",
    shouldShow: null != h,
    renderPopout: h === c.z.PROFILE_THEMES_FEATURE_EDUCATION_TOOLTIP_TAKE_2 ? () => (0, i.jsx)(em.Z, {}) : h === c.z.USER_SAFETY_CONSUMER_EDUCATION_BLOCK ? () => (0, i.jsx)(eh.Z, {
      markAsDismissed: b
    }) : h === c.z.USER_SAFETY_CONSUMER_EDUCATION_MUTE ? () => (0, i.jsx)(ef.Z, {
      markAsDismissed: b
    }) : h === c.z.SOUNDBOARD_VOLUME_EDUCATION ? () => (0, i.jsx)(e_.Z, {
      markAsDismissed: b
    }) : h === c.z.PER_GUILD_COLLECTIBLES_CUSTOMIZATION_COACHMARK ? () => (0, i.jsx)(ex.Z, {}) : () => (0, i.jsx)(i.Fragment, {}),
    children: () => (0, i.jsx)(eQ.Z, e4(e9({
      ref: u,
      tooltipText: null != t ? e3.intl.formatToPlainString(e3.t.Gzh6ZG, {
        webBuildOverride: t.id
      }) : e3.intl.string(e3.t.cduTBA),
      onClick: s,
      onContextMenu: l,
      icon: (0, i.jsx)(m, {
        size: "refresh_sm",
...
function ta(e) {
  let {
    ...
    activeVoice: y
  } = (0, eI.o)(), R = null != y, D = (0, eT.z)(y), Z = (0, o.e7)([ek.Z], () => ek.Z.isConnected()), {
    Component: w,
    events: k,
    play: B
  } = R ? N : I, M = n || s ? f.v0G : w, {
  ...
  } = (0, P.ZP)(A.Z.AUDIO_INPUT_BUTTON), H = (0, ev.Hu)({
