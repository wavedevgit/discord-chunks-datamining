...
function ta(e) {
  let {
    ...
    nameplate: m,
    "data-jump-section": p
  } = e, g = r.useRef(null), h = null != t ? t : g, b = (0, A.Z)(null == l ? void 0 : l.avatarDecoration), x = (0, eH.NZ)({
    avatarDecoration: b,
    ...
    return (0, O.Z)(() => a(!0), 750), r.useEffect(() => {
      ...
      return eY.S.subscribe(e6.CkL.SHOW_ACCOUNT_PROFILE_POPOUT, t), () => {
  ...
  return null == l ? null : (0, i.jsx)(_.Z, {
    ...
    children: (0, i.jsx)(eh.Z, {
      ...
      targetElementRef: h,
      clickTrap: !0,
      preload: () => (0, ep.Z)(l.id, l.getAvatarURL(void 0, eh.I), {
        type: "account_popout",
        withMutualGuilds: !1,
        withMutualFriends: !1
      }),
      ...
      children: e => (C(e), (0, i.jsxs)(f.P3F, tn(tt({
        innerRef: h,
        style: T
      }, e), {
        onClick: t => {
...
class tl extends r.PureComponent {
  ...
  renderStatus() {
    ...
    }) : null != s && s !== e6.Skl.UNKNOWN && r.isPomelo() ? (0, i.jsx)(N.Z, {
      hoverText: a,
      forceHover: e,
  ...
  renderAvatarWithPopout(e) {
    ...
    return (0, i.jsx)(ta, tn(tt({}, this.props), {
    ...
    return null == e ? null : (0, i.jsx)(f.Wdt, {
      children: e => (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsxs)("div", {
          ...
          }), this.renderNameZone(e), (0, i.jsx)(to, tn(tt({}, this.props, this.state), {
  ...
  constructor(...e) {
    super(...e), te(this, "copiedTimeout", new m.V7), te(this, "copiedDecayTimeout", new m.V7), te(this, "speakingWhileMutedTooltipTimeout", new m.V7), te(this, "lastSpeakingWhileMutedNotificationTime", void 0), te(this, "state", {
      hovered: !1,
      copiedStreak: 0,
      ...
      (0, ez.JG)(eQ.ZP.getUserTag(e, {
        decoration: "never",
        identifiable: "always"
      })), eF.default.track(e6.rMx.TEXT_COPIED, {
        type: "User Tag"
      });
      let i = {
      ...
      let {
        ...
        hoveringOnMute: s
      } = this.state, a = void 0 === this.lastSpeakingWhileMutedNotificationTime || Date.now() - this.lastSpeakingWhileMutedNotificationTime > tr;
...
function tc() {
  ...
  let t = (0, d.e7)([eV.default], () => eV.default.getCurrentUser()),
    ...
    J = (0, d.e7)([em.Z, eV.default, eZ.Z], () => {
      ...
      if (null != t ? e = t.partyId : null != n && null != n.party && null != n.party.id && (e = n.party.id), null != e) {
        var r;
        i = o()(Array.from(null != (r = eZ.Z.getParty(e)) ? r : [])).map(e => eV.default.getUser(e)).filter(eq.lm).value()
      }
      return i.length > 1
    }),
    $ = {
  ...
  return !P && (B && (1 === M ? $.settings.push(u.z.USER_SAFETY_CONSUMER_EDUCATION_MUTE) : $.settings.push(u.z.USER_SAFETY_CONSUMER_EDUCATION_BLOCK)), U && $.settings.push(u.z.PER_GUILD_COLLECTIBLES_CUSTOMIZATION_COACHMARK), V && $.avatar.push(u.z.PREMIUM_SUBSCRIPTION_APRIL_MARKETING_DECO_TOOLTIP), F && $.avatar.push(u.z.EXPIRING_STATUS_COACHMARK)), (0, i.jsx)(y.Gt, {
    value: W,
    children: (0, i.jsx)(tl, {
      currentUser: t,
      activities: r,
...
function td(e) {
  ...
  return (0, i.jsx)(f.yRy, {
    ...
    renderPopout: h === u.z.USER_SAFETY_CONSUMER_EDUCATION_BLOCK ? () => (0, i.jsx)(ed.Z, {
      ...
      markAsDismissed: b
    }) : h === u.z.PER_GUILD_COLLECTIBLES_CUSTOMIZATION_COACHMARK ? () => (0, i.jsx)(eg.Z, {}) : () => (0, i.jsx)(i.Fragment, {}),
    children: () => (0, i.jsx)(e1.Z, tn(tt({
      ref: d,
...
function tu(e) {
  let {
    ...
    nameplate: E,
    accountContainerRef: O
  } = e, C = t || s || n, v = r.useRef(null), S = r.useRef(null), T = (0, eA.b)(C), {
    activeVoice: N,
    mostRecentlyRequestedVoiceId: A,
    lastInitAttemptMayHaveCrashed: P
  } = (0, eC.o)(), {
    showSilentLagWarning: R
  } = (0, eO.Y)(), D = null != N, Z = (0, eE.z)(N), w = (0, d.e7)([eL.Z], () => eL.Z.isConnected()), {
    Component: L,
    events: B,
    play: M
  ...
  } = (0, y.ZP)(I.Z.AUDIO_INPUT_BUTTON), W = (0, e_.Hu)({
            ...
            children: (0, i.jsx)(z.ZP, {
              ...
              children: e => {
                ...
                t === u.z.VOICE_FILTER_EARLY_ACCESS_COACHMARK ? o = (0, i.jsx)(eN.U, {
                  markAsDismissed: s,
                  onCTA: () => X(!0)
                }) : t === u.z.VOICE_FILTER_LAUNCH_COACHMARK ? o = (0, i.jsx)(eT.n, {
                  markAsDismissed: s,
                  onCTA: () => X(!0)
                }) : t === u.z.VOICE_FILTER_FIRST_USE_COACHMARK && (o = (0, i.jsx)(eS.v, {
                  markAsDismissed: s,
                  onCTA: () => X(!0)
                }));
