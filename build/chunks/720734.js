...
function tn(e) {
  let {
    ...
    nameplate: m,
    "data-jump-section": p
  } = e, g = r.useRef(null), h = null != t ? t : g, b = (0, y.Z)(null == l ? void 0 : l.avatarDecoration), x = (0, eU.NZ)({
    avatarDecoration: b,
    size: (0, A.y9)(f.EFr.SIZE_32)
  }), j = (0, f.dQu)(f.TVs.modules.guildbar.AVATAR_SIZE), O = (0, U.Z)("Account") ? 32 : j, {
    ...
    let e = r.useRef(null),
      ...
      [n, i] = r.useState(),
      [s, a] = r.useState(!1);
    return (0, E.Z)(() => a(!0), 750), r.useEffect(() => {
      let t = t => {
        var n;
        let {
          highlightBadge: r
      ...
      return eF.S.subscribe(e0.CkL.SHOW_ACCOUNT_PROFILE_POPOUT, t), () => {
  ...
  return null == l ? null : (0, i.jsx)(_.Z, {
    ...
    children: (0, i.jsx)(eu.Z, {
      ...
      targetElementRef: h,
      clickTrap: !0,
      preload: () => (0, ec.Z)(l.id, l.getAvatarURL(void 0, eu.I), {
        type: "account_popout",
        withMutualGuilds: !1,
        withMutualFriends: !1
      }),
      ...
      children: e => (C(e), (0, i.jsxs)(f.P3F, e4(e7({
        innerRef: h,
        style: T
      }, e), {
        onClick: t => {
...
class ti extends r.PureComponent {
  ...
  renderCopiedSuccess() {
    let {
      copiedStreak: e
    } = this.state, t = [e8.intl.string(e8.t.MSaeTU), e8.intl.string(e8.t.UmrCw8), e8.intl.string(e8.t.gKE0Ji), e8.intl.string(e8.t["4DSKbm"]), e8.intl.string(e8.t["+8ENdX"]), e8.intl.string(e8.t.GlWHv7), e8.intl.string(e8.t.hIzxU1), e8.intl.string(e8.t["26uMPD"]), e8.intl.string(e8.t.uFs7R0), e8.intl.string(e8.t.bLXdcX), e8.intl.string(e8.t.gPg9fX)], n = Math.min(Math.max(0, e - 1), t.length - 1);
  ...
  renderAvatarWithPopout(e) {
    ...
    return (0, i.jsx)(tn, e4(e7({}, this.props), {
    ...
    return null == e ? null : (0, i.jsx)(f.Wdt, {
      children: e => (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsxs)("div", {
          ...
          }), this.renderNameZone(e), (0, i.jsx)(tr, e4(e7({}, this.props, this.state), {
        ...
        }), (0, i.jsx)(X.Z, {}), (0, i.jsx)(V.Z, {})]
      })
    })
  }
  constructor(...e) {
    super(...e), e5(this, "copiedTimeout", new m.V7), e5(this, "copiedDecayTimeout", new m.V7), e5(this, "speakingWhileMutedTooltipTimeout", new m.V7), e5(this, "lastSpeakingWhileMutedNotificationTime", void 0), e5(this, "state", {
      hovered: !1,
      copiedStreak: 0,
      ...
      hoveringOnMute: !1
    }), e5(this, "containerRef", r.createRef()), e5(this, "avatarWithPopoutRef", r.createRef()), e5(this, "handleToggleSelfMute", () => {
      let {
        serverMute: e,
        suppress: t,
        selfMute: n
    ...
    }), e5(this, "audioOnInteractionHandler", (0, M.u)("AudioDeviceMenu", N.Z.ACCOUNT)), e5(this, "handleInputAudioContextMenu", (e, t) => {
      (0, b.jW)(e, async () => {
        let {
          default: e
      ...
      if (null == e) return;
      (0, eV.JG)(eK.ZP.getUserTag(e, {
        decoration: "never",
        identifiable: "always"
      })), eM.default.track(e0.rMx.TEXT_COPIED, {
        type: "User Tag"
      });
      let i = {
      ...
      let {
        ...
        hoveringOnMute: s
      } = this.state, a = void 0 === this.lastSpeakingWhileMutedNotificationTime || Date.now() - this.lastSpeakingWhileMutedNotificationTime > te;
...
function ts() {
  ...
  let t = (0, d.e7)([eL.default], () => eL.default.getCurrentUser()),
    ...
    z = (0, d.e7)([eo.Z, eL.default, eA.Z], () => {
      ...
      if (null != t ? e = t.partyId : null != n && null != n.party && null != n.party.id && (e = n.party.id), null != e) {
        var r;
        i = o()(Array.from(null != (r = eA.Z.getParty(e)) ? r : [])).map(e => eL.default.getUser(e)).filter(eW.lm).value()
      }
      return i.length > 1
    }),
    K = {
  ...
  return !A && (L && K.settings.push(u.z.PER_GUILD_COLLECTIBLES_CUSTOMIZATION_COACHMARK), B && K.avatar.push(u.z.PREMIUM_SUBSCRIPTION_APRIL_MARKETING_DECO_TOOLTIP), U && K.avatar.push(u.z.EXPIRING_STATUS_COACHMARK)), (0, i.jsx)(I.Gt, {
    value: F,
    children: (0, i.jsx)(ti, {
      currentUser: t,
      activities: r,
...
function ta(e) {
  ...
  return (0, i.jsx)(f.yRy, {
    ...
    children: () => (0, i.jsx)(eJ.Z, e4(e7({
      ref: d,
      tooltipText: null != t ? e8.intl.formatToPlainString(e8.t.Gzh6ZG, {
        webBuildOverride: t.id
      }) : e8.intl.string(e8.t.cduTBA),
      onClick: s,
      onContextMenu: a,
      icon: (0, i.jsx)(m, {
        size: "refresh_sm",
...
function tl(e) {
  let {
    ...
    nameplate: E,
    accountContainerRef: O
  } = e, C = t || s || n, v = r.useRef(null), S = r.useRef(null), T = (0, eT.b)(C), {
    activeVoice: y,
    mostRecentlyRequestedVoiceId: A,
    lastInitAttemptMayHaveCrashed: P
  } = (0, e_.o)(), {
    showSilentLagWarning: R
  } = (0, ex.Y)(), D = null != y, Z = (0, eb.z)(y), k = (0, d.e7)([eD.Z], () => eD.Z.isConnected()), {
    Component: L,
    events: B,
    play: M
  } = T, U = n || s ? f.v0G : L, V = R ? e8.intl.string(e8.t.ARRV6u) : null, G = (0, w.Z)(t, n, s, l), F = null != o ? o : null != V ? (0, i.jsxs)("div", {
  ...
  } = (0, I.ZP)(N.Z.AUDIO_INPUT_BUTTON), z = (0, eh.Hu)({
  ...
  return (0, i.jsx)(I.Gt, {
    ...
    children: (0, i.jsxs)("div", {
      ref: v,
      className: a()(e2.micButtonParent, {
        [e2.hasColorGlow]: en
      }),
      children: [(0, i.jsx)(eJ.Z, {
        ...
        children: (e, t) => {
          ...
          let a = s ? f.u04 : f.CJ0,
            o = [];
          return !s && (ei && o.push(u.z.VOICE_FILTER_EARLY_ACCESS_COACHMARK), o.push(u.z.VOICE_FILTER_LAUNCH_COACHMARK), Y && k && !D && o.push(u.z.VOICE_FILTER_FIRST_USE_COACHMARK)), (0, i.jsx)("div", {
            children: (0, i.jsx)(H.ZP, {
              ...
              children: e => {
                ...
                t === u.z.VOICE_FILTER_EARLY_ACCESS_COACHMARK ? o = (0, i.jsx)(eC.U, {
                  markAsDismissed: s,
                  onCTA: () => X(!0)
                }) : t === u.z.VOICE_FILTER_LAUNCH_COACHMARK ? o = (0, i.jsx)(eO.n, {
                  markAsDismissed: s,
                  onCTA: () => X(!0)
...
function to(e) {
  ...
  } = (0, I.ZP)(N.Z.AUDIO_OUTPUT_BUTTON);
  r.useEffect(() => () => g(), [u, g]);
