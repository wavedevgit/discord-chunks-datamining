...
class ts extends r.PureComponent {
  ...
  renderStatus() {
    ...
    }) : null != s && s !== e3.Skl.UNKNOWN && r.hasUniqueUsername() ? (0, i.jsx)(T.Z, {
      hoverText: a,
      forceHover: e,
  ...
  constructor(...e) {
    ...
    }), e7(this, "audioOnInteractionHandler", (0, M.u)("AudioDeviceMenu", N.Z.ACCOUNT)), e7(this, "handleInputAudioContextMenu", (e, t) => {
      (0, b.jW)(e, async () => {
        let {
          default: e
...
function tl() {
  ...
  return !A && (L && X.settings.push(u.z.PER_GUILD_COLLECTIBLES_CUSTOMIZATION_COACHMARK), B && X.avatar.push(u.z.PREMIUM_SUBSCRIPTION_APRIL_MARKETING_DECO_TOOLTIP), U && X.avatar.push(u.z.EXPIRING_STATUS_COACHMARK), F && X.avatar.push(u.z.DISPLAY_NAME_STYLES_COACHMARK)), (0, i.jsx)(I.Gt, {
    value: H,
    children: (0, i.jsx)(ts, {
      currentUser: t,
      activities: r,
