...
function e6(e) {
  let {
    ...
    location: "RTC Avatar"
  }), N = (0, R.Z)(null == s ? void 0 : s.avatarDecoration), b = (0, ew.NZ)({
    avatarDecoration: N,
...
class e3 extends i.PureComponent {
  ...
  renderCopiedSuccess() {
    let {
      copiedStreak: e
    } = this.state, t = [eK.NW.string(eK.t.MSaeTU), eK.NW.string(eK.t.UmrCw8), eK.NW.string(eK.t.gKE0Ji), eK.NW.string(eK.t["4DSKbm"]), eK.NW.string(eK.t["+8ENdX"]), eK.NW.string(eK.t.GlWHv7), eK.NW.string(eK.t.hIzxU1), eK.NW.string(eK.t["26uMPD"]), eK.NW.string(eK.t.uFs7R0), eK.NW.string(eK.t.bLXdcX), eK.NW.string(eK.t.gPg9fX)], n = Math.min(Math.max(0, e - 1), t.length - 1);
    ...
    return null == e ? null : (0, r.jsx)(f.Wdt, {
      children: e => (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsxs)("div", {
          ...
          }), this.renderNameZone(e), (0, r.jsx)(e4, eQ(eJ({}, this.props, this.state), {
  ...
  constructor(...e) {
    super(...e), eX(this, "copiedTimeout", new d.V7), eX(this, "copiedDecayTimeout", new d.V7), eX(this, "speakingWhileMutedTooltipTimeout", new d.V7), eX(this, "lastSpeakingWhileMutedNotificationTime", void 0), eX(this, "state", {
      hovered: !1,
      copiedStreak: 0,
      ...
      if (null == e) return;
      (0, ek.JG)(eU.ZP.getUserTag(e, {
        decoration: "never",
        identifiable: "always"
      })), eZ.default.track(ez.rMx.TEXT_COPIED, {
        type: "User Tag"
      });
      let r = {
      ...
      let {
        ...
        hoveringOnMute: s
      } = this.state, a = void 0 === this.lastSpeakingWhileMutedNotificationTime || Date.now() - this.lastSpeakingWhileMutedNotificationTime > e0;
...
function e4(e) {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(e9, {
      ...
      suppress: o,
      awaitingRemote: i,
      tooltipText: l ? eK.NW.string(eK.t["29gnR0"]) : void 0,
...
function e8() {
  var e;
  let t = (0, l.e7)([eR.default], () => eR.default.getCurrentUser()),
    ...
    d = (0, l.e7)([eC.Z], () => eC.Z.getAnyStreamForUser(n)),
    u = (0, O.Z)({
      userId: n
    }),
    ...
    g = (0, l.e7)([eP.Z], () => eP.Z.hidePersonalInformation),
    p = (0, l.e7)([ey.Z, ev.Z], () => {
    ...
    T = (0, l.e7)([eD.ZP], () => eD.ZP.getPremiumTypeSubscription()),
    I = (0, l.e7)([eI.Z], () => eI.Z.getSpeakingWhileMuted()),
    y = (0, l.e7)([eT.Z], () => eT.Z.hasLayers()),
    R = (0, f.s9z)(f.JQI) || y || eM.s.isDisallowPopupsSet(),
    D = (0, er.b)(),
    k = (0, l.e7)([Y.Z], () => null != Y.Z.getAwaitingRemoteSessionInfo()),
    W = (0, eo.D)(),
    L = (0, E.u)(),
  ...
  let z = (0, l.e7)([ed.Z], () => ed.Z.hasHadOtherUserPlaySoundInSession()),
    K = function() {
      let e = (0, H.wE)(c.z.PROFILE_THEMES_FEATURE_EDUCATION_TOOLTIP_TAKE_2),
        [t, n] = (0, l.Wu)([ei.Z], () => [ei.Z.hasFetchedRelevance, ei.Z.profileThemesRelevanceExceeded]),
        [r, s] = (0, l.Wu)([eD.ZP], () => [eD.ZP.hasFetchedMostRecentPremiumTypeSubscription(), eD.ZP.getMostRecentPremiumTypeSubscription()]),
        {
          enabled: a
        } = es.Z.useExperiment({
          location: "08bd40_1"
  ...
  return !R && (K && $.settings.push(c.z.PROFILE_THEMES_FEATURE_EDUCATION_TOOLTIP_TAKE_2), W && (1 === L ? $.settings.push(c.z.USER_SAFETY_CONSUMER_EDUCATION_MUTE) : $.settings.push(c.z.USER_SAFETY_CONSUMER_EDUCATION_BLOCK)), z && $.settings.push(c.z.SOUNDBOARD_VOLUME_EDUCATION), B && $.settings.push(c.z.PER_GUILD_COLLECTIBLES_CUSTOMIZATION_COACHMARK), M && $.avatar.push(c.z.PREMIUM_SUBSCRIPTION_APRIL_MARKETING_DECO_TOOLTIP), G && $.avatar.push(c.z.EXPIRING_STATUS_COACHMARK)), (0, r.jsx)(P.Gt, {
    value: X,
    children: (0, r.jsx)(e3, {
      currentUser: t,
      activities: s,
...
function e7(e) {
  ...
  return (0, r.jsx)(f.yRy, {
    ...
    align: "center",
    shouldShow: null != h,
    renderPopout: h === c.z.PROFILE_THEMES_FEATURE_EDUCATION_TOOLTIP_TAKE_2 ? () => (0, r.jsx)(ea.Z, {}) : h === c.z.USER_SAFETY_CONSUMER_EDUCATION_BLOCK ? () => (0, r.jsx)(el.Z, {
      markAsDismissed: N
...
function e9(e) {
  let {
    ...
    activeVoice: I
  } = (0, e_.o)(), y = null != I, R = (0, ex.z)(I), D = (0, l.e7)([ey.Z], () => ey.Z.isConnected()), {
    Component: Z,
    events: w,
    play: k
  } = y ? T : v, L = n || s ? f.v0G : Z, {
