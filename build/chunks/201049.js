...
function h(e) {
  ...
  let {
    ...
    guildId: C,
    tag: O
  } = e, N = l.useRef(null), k = null != O, [P, _] = l.useState(null != (n = null == O ? void 0 : O.name) ? n : ""), [I, B] = l.useState(null != O ? {
    id: O.emojiId,
    name: O.emojiName
  } : null), [E, Z] = l.useState(null == O ? void 0 : O.moderated), w = (0, o.e7)([j.ZP], () => (null == I ? void 0 : I.id) != null ? j.ZP.getUsableCustomEmojiById(I.id) : null), S = (null == O ? void 0 : O.name) !== P || (null == O ? void 0 : O.emojiId) !== (null == I ? void 0 : I.id) || (null == O ? void 0 : O.emojiName) !== (null == I ? void 0 : I.name) || E !== (null == O ? void 0 : O.moderated), z = () => {
    if (null != P && S) {
      if (k) {
        v.Z.updateForumTag({
          id: O.id,
