...
function k(e) {
  ...
  let U = (0, s.useCallback)(() => {
      var e, t, n;
      o && (c.push({
        text: null != (e = (0, i.sample)([P.intl.string(N.default.TXLQ3d), P.intl.string(N.default.TC42mZ), P.intl.string(N.default.h3tura), P.intl.string(N.default["sAbI/v"]), P.intl.string(N.default.NJ4o2t), P.intl.string(N.default.sUsj8f), P.intl.string(N.default.jMKjJC), P.intl.string(N.default.J6uWam)])) ? e : "",
        variation: 50 * Math.random()
      }), d([...c]), .05 > Math.random() && F()), T((t = C({}, A), n = n = {
        [(0, l.Z)()]: R
