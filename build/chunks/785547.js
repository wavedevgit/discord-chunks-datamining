...
class Z extends(r = a.Component) {
  ...
  getButtonState() {
    ...
    return null != r ? r : null != t && t.type === N.vxO.UNINSTALLING ? "uninstalling" : (0, x.isWeb)() ? "play" : "unsupported_os"
  }
  renderPlayButton() {
    let {
      libraryApplication: e,
  ...
  renderProgressBar() {
    ...
    let r = n.type === N.vxO.UNINSTALLING ? c.Exd.INDETERMINATE : v.xI(Number(n.progress), Number(n.total));
    return (0, o.jsx)(c.Exd, {
      percent: r,
  ...
  render() {
    ...
    if ("preorder_wait" === n) return this.renderDisabledButton(n, function(e) {
      let t = y.en(e.sku);
      return null != t ? j.NW.formatToPlainString(j.t.Aqe2ZG, {
        date: t
      }) : null
    }(t));
    if ("unsupported_os" === n) return this.renderDisabledButton(n, j.NW.formatToPlainString(j.t.LBm0Aw, {
      operatingSystem: j.NW.string(j.t["0/xHFB"])
    }));
...
function k(e) {
  let {
    libraryApplication: t
  } = e, n = (0, d.O)(), [r, i] = (0, l.Wu)([_.Z, b.Z], () => [(0, h.i)(t, _.Z, b.Z), _.Z.getState(t.id, t.branchId)], [t]), a = (0, l.e7)([g.Z], () => g.Z.isSyncing(t.id, t.branchId), [t]), s = (0, l.e7)([f.Z], () => f.Z.hasNoBuild(t.id, t.branchId), [t]);
  return (0, o.jsx)(Z, T(S({}, e), {
    analyticsContext: n,
    actionState: r,
    dispatchState: i,
    isCloudSyncing: a,
