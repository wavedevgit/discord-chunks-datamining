...
class Z extends(r = a.Component) {
  get analyticsLocation() {
    return T(N({}, this.props.analyticsContext.location), {
  ...
  render() {
    ...
    if ("preorder_wait" === n) return this.renderDisabledButton(n, function(e) {
      let t = y.en(e.sku);
      return null != t ? C.intl.formatToPlainString(C.t.Aqe2ZG, {
        date: t
      }) : null
    }(t));
    if ("unsupported_os" === n) return this.renderDisabledButton(n, C.intl.formatToPlainString(C.t.LBm0Aw, {
      operatingSystem: C.intl.string(C.t["0/xHFB"])
    }));
