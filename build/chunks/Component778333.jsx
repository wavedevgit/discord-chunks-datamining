...
function E(e) {
  ...
  } = e, O = (0, l.e7)([p.default], () => p.default.getId()), v = (null == (t = n.inviter) ? true : t.id) === O, y = n.state === _.r2o.ACCEPTING, {
  ...
  j ? (P = h.intl.string(h.t.xhxnPj), N = u.Z.Button.Colors.PRIMARY) : v && (P = h.intl.string(h.t.ib7Ng4), N = u.Z.Button.Colors.PRIMARY);
