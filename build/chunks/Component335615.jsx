...
function eo(e) {
  let {
  ...
  } = (0, O.ZP)(j.Z.MEMBER_LIST), s = (0, p.e7)([x.Z], () => x.Z.keyboardModeEnabled), o = (0, p.cj)([M.ZP], () => M.ZP.getProps(t.guild_id, t.id)), {
    rows: d,
    groups: h,
    version: g,
    updateMaxRowSeen: m
    ...
    channelId: t.id,
    guildId: t.guild_id
  }), b = i.useRef(null), y = (0, f.UBm)("lg") + (0, f.UBm)("xxs"), _ = i.useCallback((e, t) => {
    let n = b.current;
    if (null == n) return;
    let r = parseInt(t, 10),
