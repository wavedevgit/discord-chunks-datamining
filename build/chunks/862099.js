...
function H(e) {
  ...
  return l || null != a || (0, T._6)(t.id), (0, i.jsxs)(c.zxk, {
    fullWidth: !0,
    className: G.joinButton,
    innerClassName: G.rsvpButton,
    onClick: function() {
      (0, D.Z)(t.id, null, t.guild_id, () => setTimeout(() => (0, T.L_)(t.id), 1e3)), v.default.track(M.rMx.CHANNEL_NOTICE_CTA_CLICKED, {
        guild_id: t.guild_id,
        notice_type: n
      })
    },
...
function F(e) {
  ...
  let {
    guildEvent: n,
    noticeType: r
  } = e, a = (0, w.cS)(n), s = null != a ? (0, A.m)(a, !0) : null, u = (0, w.nE)(n), p = (0, d.KS)(u), {
    startTime: h,
    endTime: f
  } = (0, x.ZP)(n), {
...
function X(e) {
  let {
    ...
    speakers: n,
    voiceType: r
  } = e, a = t.getGuildId(), d = l.useMemo(() => n.slice(0, 3), [n]), p = (0, s.e7)([y.Z], () => y.Z.can(M.Plq.CONNECT, t)), h = (0, O.Z)(t.id), f = U.intl.string(U.t.VJlc0d);
  switch (r) {
    case 1:
...
let Q = l.memo(function(e) {
  ...
  } = (0, p.o)(!0), r = (0, Z.y)(t.id), l = (0, L.k5)(t.id), a = (0, L.Vm)(t.id), o = (0, s.e7)([E.Z], () => E.Z.getStageInstanceByChannel(null == r ? void 0 : r.id), [r]), {
