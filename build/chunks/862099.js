...
function H(e) {
  ...
  return l || null != a || (0, P._6)(t.id), (0, i.jsxs)(c.zxk, {
    ...
    onClick: function() {
      (0, k.Z)(t.id, null, t.guild_id, () => setTimeout(() => (0, P.L_)(t.id), 1e3)), v.default.track(U.rMx.CHANNEL_NOTICE_CTA_CLICKED, {
        guild_id: t.guild_id,
        notice_type: n
      })
    },
...
function q(e) {
  let {
    stageInstance: t,
    channel: n
  } = e, r = (0, s.Wu)([b.Z], () => [...new Set(b.Z.getMutableParticipants(n.id, _.pV.SPEAKER).map(e => e.user))], [n.id]), l = (0, s.e7)([b.Z], () => b.Z.getParticipantCount(n.id, _.pV.AUDIENCE), [n.id]), a = G.NW.formatToPlainString(G.t["+v2pNz"], {
    count: "".concat(l)
  });
  return (0, i.jsx)(V, {
    onClickCloseIcon: () => (0, P.ji)({
...
function X(e) {
  let {
    ...
    speakers: n,
    voiceType: r
  } = e, a = t.getGuildId(), d = l.useMemo(() => n.slice(0, 3), [n]), p = (0, s.e7)([y.Z], () => y.Z.can(U.Plq.CONNECT, t)), h = (0, N.Z)(t.id), f = G.NW.string(G.t.VJlc0d);
  switch (r) {
    case 1:
