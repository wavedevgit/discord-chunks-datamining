  ...
  d = function(e, t) {
    ...
    for (g = 0; g < _.length; ++g)
      if (g !== p) {
        ...
        })), E && t.interpretNumericEntities && "iso-8859-1" === h && (E = s(E)), v.indexOf("[]=") > -1 && (E = o(E) ? [E] : E);
        var O = i.call(n, m);
        O && "combine" === t.duplicates ? n[m] = r.combine(n[m], E) : O && "last" !== t.duplicates || (n[m] = E)
      } return n
  },
  f = function(e, t, n, r) {
    for (var i = r ? t : l(t, n), o = e.length - 1; o >= 0; --o) {
      ...
      if ("[]" === s && n.parseArrays) a = n.allowEmptyArrays && "" === i ? [] : [].concat(i);
        ...
        var c = "[" === s.charAt(0) && "]" === s.charAt(s.length - 1) ? s.slice(1, -1) : s,
          ...
          d = parseInt(u, 10);
        n.parseArrays || "" !== u ? !isNaN(d) && s !== u && String(d) === u && d >= 0 && n.parseArrays && d <= n.arrayLimit ? (a = [])[d] = i : "__proto__" !== u && (a[u] = i) : a = {
          0: i
        }
      }
      i = a
