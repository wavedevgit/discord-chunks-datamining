...
function d(e) {
  ...
  return t.recipients.length >= 2 && m && null == t.icon ? <l.Z aria-label={h["aria-label"]} aria-hidden={h["aria-hidden"]} className={_} recipients={t.recipients} size={null != i ? i : n} isTyping={d} status={f} /> : <o.qEK aria-hidden={h["aria-hidden"]} aria-label={h["aria-label"]} className={_} size={n} src={(0, a.x)(t, 80, p)} />
}
