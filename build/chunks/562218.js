...
let x = [_.O0b.PAST_DUE, _.O0b.PAUSED, _.O0b.BILLING_RETRY],
  y = () => {
    ...
    let {
      ...
      analyticsLocation: j
    } = (0, m.a)(), [I, T] = (0, i.useState)(!1), [E, P] = (0, i.useState)(!1), O = async () => {
      T(!0), P(!1);
      try {
        if (x.includes(g.status)) await (0, s.EO)(g.id, v, j);
          ...
          await (0, s.Mg)(g, {
            ...
            amount: 0,
            currency: g.currency
          }, (0, u.UX)(r, g.currency, g.paymentSourceId), v, j)
        }
        c()
      } catch (e) {
        P(!0), T(!1)
      }
    }, S = null == (e = (0, u.Af)(g)) ? void 0 : e.planId, N = (0, l.Q)(), R = _ === p.p9.TIER_2, D = g.items.some(e => {
      let {
        planId: t
      } = e;
      return !p.dJ.has(t)
    }) && null == g.renewalMutations || (null == (t = g.renewalMutations) ? void 0 : t.items.find(e => {
      let {
        planId: t
      } = e;
      return !p.dJ.has(t)
    ...
    return w.push({
      ...
      transitionState: n,
      title: "".concat(f.intl.format(f.t.LZunzc, {
        planPremiumType: u.ZP.getDisplayPremiumType("".concat(S))
      })),
      subtitle: b(N, _, g),
      actions: w,
      onClose: async () => c(),
      children: E ? (0, r.jsx)(o.k, {
