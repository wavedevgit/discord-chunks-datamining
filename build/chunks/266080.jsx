...
let m = e => {
  ...
  return null == g ? null : <o.JZ title={u.intl.string(u.t.cU96io)} description={u.intl.formatToPlainString(u.t["26mR6+"], {
      guildName: null == g ? true : g.name
    })} buttonText={m ? u.intl.string(u.t["9Ak99v"]) : u.intl.string(u.t.F3qExs)} buttonDisabled={m} buttonVariant={"critical-primary"} onButtonPress={() => {
      (0, i.h7j)(e => {
        var t, n;
