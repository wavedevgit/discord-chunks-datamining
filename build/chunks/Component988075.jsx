...
function _(e) {
  let {
    ...
    size: a,
    spoiler: _
  } = e, p = i.useMemo(() => null != t.contentType && false !== t.contentType.indexOf("/") ? t.contentType.split("/") : ["unknown", "unknown"], [t.contentType]), [h, m] = i.useState(_), g = i.useMemo(() => () => (0, r.jsx)(u.mz, {
    mimeType: p,
    downloadURL: t.url,
    showDownload: true,
