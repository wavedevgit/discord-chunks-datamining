...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk767870 = require("./767870.js"),
  Chunk104494 = require("./104494.js"),
  Chunk639119 = require("./639119.js"),
  Chunk655525 = require("./655525.js"),
  Chunk93237 = require("./93237.js"),
  Chunk138176 = require("./138176.jsx"),
  Chunk924540 = require("./924540.js"),
  Chunk474486 = require("./474486.js"),
  Chunk497334 = require("./497334.js"),
...
let V = e => {
  ...
  H = e => {
    ...
    if (ed === k.a$.NONE || ei || (O = 7, n = <S.Z className={""} startsAt={ep} endsAt={ef} messageStyle={u.aj.SHORT_TIME} upperCase={true} />), el) n = <P.Z />, O = 0;
    else if (ea) {
      let e = (0, j.$q)();
      n = <A._y isTabSelected={F} badgeCopy={G.intl.string(G.t.OS9KPj)} offerExpiresAt={true === e ? null == en ? true : en.expires_at : null} />, O = 4
    } else eO === o.z.VOICE_FILTER_EARLY_ACCESS_PREMIUM_TAB_BADGE ? (n = <A._y isTabSelected={F} badgeCopy={G.intl.string(G.t.y2b7CA)} offerExpiresAt={null} />, O = 2) : ei ? (n = <w.S expiresAt={ef} />, O = 4) : null != eo ? (n = <D.Z copy={eo} showStars={false} />, O = 1) : null != er ? (n = <A.GN userDiscount={er} isTabSelected={F} includesAmountOff={false} />, O = 3) : null == en || eb ? eu && (n = <Z.l isSelected={F} onSelect={() => (0, f.Q3)(o.z.REFERRAL_PROGRAM_PREMIUM_TAB_BADGE, {
        dismissAction: U.L.TAKE_ACTION
      })} />, O = 6) : (n = <A.$H trialOffer={en} isTabSelected={F} />, O = 4);
    let ev = G.intl.string(G.t.Ipxkoq);
    Q && ee && (ev = G.intl.string(G.t["4gwVVl"])), !Q && J && ($ === v.Rx.TRY_NITRO && null != en ? ev = G.intl.string(G.t["3O6A4e"]) : $ === v.Rx.JOIN_NITRO ? ev = G.intl.string(G.t.brBiOz) : $ === v.Rx.GET_NITRO && (ev = G.intl.string(G.t.GayC1t))), es && ec.cohort !== I.xI.Control && (n = <A._y isTabSelected={F} badgeCopy={G.intl.string(G.t.RDE0SU)} offerExpiresAt={null} />, O = 4, ey = () => {
      b.default.track(M.rMx.NITRO_TAB_VISITED, {
        badge_decorator: O,
        has_premium: Q
      }), (0, j.ZL)()
    });
    let eI = <c.Qj{...H = function(e) {
      ...
      className: t,
      children: n
    }, Object.getOwnPropertyDescriptors ? Object.defineProperties(H, Object.getOwnPropertyDescriptors(B)) : (function(e, t) {
      var n = Object.keys(e);
      if (Object.getOwnPropertySymbols) {
    ...
    return es && ec.cohort === I.xI.Static ? <x.X>{eI}</x.X> : eu ? <Z.C>{eI}</Z.C> : eI
  }