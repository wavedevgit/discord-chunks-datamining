...
let b = e => {
  ...
  let n, {
    ...
    A = (0, m._)(v);
  return <div className={s()(f.cardDescription, null == A || null == (t = A.description) ? true : t.className)}>{<p.Z title={r} cardVariantStyleInfo={A} titleClassName={b} subtitle={_} description={j} />}{C && <u.Z className={x} look={a.zx.Looks.BLANK} color={a.zx.Colors.CUSTOM} subscriptionTier={g.Si.TIER_2} textOptions={{
        textOverride: y
      }} showGradient={true} />}{0 !== E.length && (null == (n = null == A ? true : A.descriptionCta) ? true : n.hideOnHoverComponent) !== true && null != O && <a.zx className={x} onClick={O}>{E}</a.zx>}</div>
}