...
function k(e) {
  ...
  } = (0, d.ZP)(), Z = (null == I ? true : I.id) === n.id, R = false === n.nsfwAllowed, L = S.t9, [G, M] = i.useState(true);
  i.useEffect(() => {
  ...
  let {
    wishlist: B,
    error: F
  } = (0, h.kZ)(P, n.id), U = i.useCallback(e => {
    let {
      wishlistId: t,
      action: n,
      productLines: r
