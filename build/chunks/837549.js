/** Chunk was on 75387 **/
/** chunk id: 837549, original params: e,t,r (module,exports,require) **/
"use strict";
require.d(exports, {
  JT: () => c,
  M$: () => d,
...
var Chunk498890 = require("./498890.js");
...
s(c, "empty", {
  dispose: Chunk498890.ZT
});
var u = function() {
    function e() {
      o(this, module), s(this, "isDisposed", false), s(this, "disposables", true);
      for (var t = arguments.length, r = Array(exports), n = 0; Chunk498890 < exports; Chunk498890++) require[Chunk498890] = arguments[Chunk498890];
    ...
    return a(module, [{
      ...
      value: function() {
        if (!this.isDisposed) {
          ...
          this.disposables = [];
          for (var n = 0; Chunk498890 < module; Chunk498890++) exports[Chunk498890].dispose()
        }
      }
    }, {
      key: "dispose",
