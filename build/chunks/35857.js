/** Chunk was on web.js **/
/** chunk id: 35857, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  Z: () => a
});
...
let o = RegExp("(?<prefix>上|下|这)(?:个)?(?:星期|礼拜|周)(?<weekday>" + Object.keys(Chunk627459.GR).join("|") + ")");
class a extends Chunk727916.Z {
  ...
  innerExtract(e, t) {
    ...
    let a = null,
      s = t.groups.prefix;
    "上" == s ? a = "last" : "下" == s ? a = "next" : "这" == s && (a = "this");
