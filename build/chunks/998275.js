...
let o = RegExp(`(?:on\\s{0,3})?(${Chunk615339.lT})(?:\\s{0,3}(?:al|\\-|\\–|fino|alle|allo)?\\s{0,3}(${Chunk615339.lT}))?(?:-|/|\\s{0,3}(?:dal)?\\s{0,3})(${(0,Chunk476858.uJ)(Chunk615339.eB)})(?:(?:-|/|,?\\s{0,3})(${Chunk615339.fp}(?![^\\s]\\d)))?(?=\\W|$)`, "i"),
  l = 1,
  c = 2,
  u = 3,
  d = 4;
