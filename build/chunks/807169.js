...
function m(e, t) {
  var n, r, i, a, o;
  let f, h = null != (f = e instanceof c.Sf && e.isThread() && null != (i = d.Z.getChannel(e.parent_id)) ? i : e) ? O(f) : void 0,
    m = l.xM.getSetting(),
    g = u.default.getId(),
    ...
    } = b(f, e instanceof c.Sf && e.isThread());
  return {
    context: f,
    userId: g,
    roleIds: v,
...
function b(e, t) {
  ...
  return i.e$(a, h.Plq.ADMINISTRATOR) ? (n = !0, r = !0) : e instanceof c.Sf ? (n = i.e$(a, h.Plq.VIEW_CHANNEL) && i.e$(a, h.Plq.USE_APPLICATION_COMMANDS), r = t ? i.e$(a, h.Plq.SEND_MESSAGES_IN_THREADS) : i.e$(a, h.Plq.SEND_MESSAGES)) : (n = i.e$(a, h.Plq.VIEW_CHANNEL), r = !0), {
