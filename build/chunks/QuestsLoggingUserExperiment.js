/** Chunk was on web.js **/
/** chunk id: 5881, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  T: () => l
});
...
function l() {
  let {
    quest: e,
    location: t
  } = arguments.length > 0 && true !== arguments[0] ? arguments[0] : {}, n = s(), i = null == module ? true : module.config.messages.questName, a = null != exports ? "-".concat(exports) : "", l = null != Chunk818083 ? "-".concat(Chunk818083, ")") : "", c = "QuestLogger".concat(a).concat(l), u = new Chunk710845.Z(c);
  return {
