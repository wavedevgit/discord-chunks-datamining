...
function l() {
  let {
    quest: e,
    location: t
  } = arguments.length > 0 && true !== arguments[0] ? arguments[0] : {}, n = s(), i = null == e ? true : e.config.messages.questName, o = null != t ? "-".concat(t) : "", l = null != i ? "-".concat(i, ")") : "", c = "QuestLogger".concat(o).concat(l), u = new r.A(c);
  return {
    log: n ? u.log : a.tE,
    warn: n ? u.warn : a.tE,
