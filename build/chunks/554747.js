...
function v(e) {
  ...
  let n = (0, i.Wu)([c.ZP, l.Z, o.Z], () => c.ZP.getGuildScheduledEventsByIndex(c.bN.GUILD_EVENT_UPCOMING(e)).filter(e => {
      if (e.entity_type === f.WX.NONE || e.status !== f.p1.SCHEDULED) returnfalse;
...
function x(e) {
  return (0, i.e7)([c.ZP, l.Z, o.Z], () => c.ZP.getGuildScheduledEventsByIndex(c.bN.GUILD_EVENT_ACTIVE(e)).find(e => {
    if (e.entity_type === f.WX.NONE || !(0, c.xt)(e)) returnfalse;
    if (null == e.channel_id) returntrue;
    let t = l.Z.getChannel(e.channel_id);
    return o.Z.can(m.Plq.VIEW_CHANNEL, t)
  }), [e])
...
function E(e) {
  ...
  return r.useMemo(() => l.filter(e => {
    let {
      ...
      withinStartWindow: r,
      diffMinutes: i
    } = (0, h.ub)(t.toISOString(), null == n ? true : n.toISOString());
    return e.status !== f.p1.ACTIVE && r && i < 15
  }), [l])
}