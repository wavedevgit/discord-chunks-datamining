...
function h(e) {
  let {
    ...
    onClick: O,
    isActive: k
  } = e, v = (0, s.e7)([d.ZP], () => d.ZP.getGuildScheduledEvent(h)), y = (0, p.Z)(t, null == v ? void 0 : v.id), z = (0, s.e7)([a.Z], () => a.Z.getGuild(null == v ? void 0 : v.guild_id)), C = (0, s.e7)([u.Z], () => u.Z.getChannel(null == v ? void 0 : v.channel_id));
  if (null == v) return null;
  let {
    is_canceled: P = !1
  } = null != y ? y : {}, S = (null == y ? void 0 : y.scheduled_start_time) != null ? new Date(null == y ? void 0 : y.scheduled_start_time) : l, N = (0, b.DK)(v), E = P ? x.p1.CANCELED : x.p1.SCHEDULED;
  N === t && (E = v.status);
  let w = (null == v ? void 0 : v.scheduled_start_time) != null ? (0, b.lh)(y, S, new Date(null == v ? void 0 : v.scheduled_start_time)) : null,
    L = e => {
      e.stopPropagation(), null != z && (0, c.jW)(e, async () => {
        let {
          default: e
