...
function h(e) {
  let {
    ...
    onClick: O,
    isActive: v
  } = e, y = (0, s.e7)([d.ZP], () => d.ZP.getGuildScheduledEvent(h)), z = (0, p.Z)(t, null == y ? void 0 : y.id), C = (0, s.e7)([a.Z], () => a.Z.getGuild(null == y ? void 0 : y.guild_id)), P = (0, s.e7)([u.Z], () => u.Z.getChannel(null == y ? void 0 : y.channel_id));
  if (null == y) return null;
  let {
    is_canceled: k = !1
  } = null != z ? z : {}, S = (null == z ? void 0 : z.scheduled_start_time) != null ? new Date(null == z ? void 0 : z.scheduled_start_time) : l, N = (0, b.DK)(y), w = k ? x.p1.CANCELED : x.p1.SCHEDULED;
  N === t && (w = y.status);
  let E = (null == y ? void 0 : y.scheduled_start_time) != null ? (0, b.lh)(z, S, new Date(null == y ? void 0 : y.scheduled_start_time)) : null,
    _ = e => {
      e.stopPropagation(), null != C && (0, c.jW)(e, async () => {
        let {
          default: e
