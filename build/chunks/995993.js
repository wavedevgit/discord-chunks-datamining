...
function x(e) {
  let {
    guild: t,
    selected: x
  } = e, P = (0, p.Z)(t), S = (0, u.wE)(o.z.CHANNEL_BROWSER_NEW_BADGE_NUX), I = (0, l.Wu)([h.Z], () => Array.from(h.Z.getNewChannelIds(t.id)).filter(e => h.Z.shouldIndicateNewChannel(t.id, e))), N = (0, l.e7)([g.ZP], () => g.ZP.hasUnread(t.id, O.W.GUILD_ONBOARDING_QUESTION)), Z = I.length > b.Cb, w = (0, l.e7)([d.Z, g.ZP], () => {
  ...
  return S && !N && !Z || x || w || (A = (0, r.jsx)(s.IGR, {
