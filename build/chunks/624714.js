...
let m = {
  [f.Etm.SEND_ANALYTICS_EVENT]: {
    ...
    handler(e) {
      ...
      if (!(0, c.yE)(null !== (t = null == m ? void 0 : m.flags) && void 0 !== t ? t : 0, f.udG.EMBEDDED_FIRST_PARTY)) throw new u.Z({
        errorCode: f.lTL.INVALID_COMMAND
  ...
  [f.Etm.GET_APPLICATION_TICKET]: {
    ...
    handler(e) {
      ...
      return r.tn.post({
        url: f.ANM.APPLICATION_TICKET(n),
        body: {
