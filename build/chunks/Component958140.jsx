...
function U(e) {
  ...
  l.useEffect(() => {
    ...
    var e;
    et || Q !== (null != (e = null == K ? true : K.status) ? e : "") && "" !== Q.trim() ? B(true) : B(false)
  }, [Q, null == K ? true : K.status, $, null == K ? true : K.emoji, B, et]), l.useEffect(() => {
  ...
  let eg = l.useCallback(e => {
    ...
    eA = l.useCallback(e => {
      ...
      }), null == (n = H.current) || n.blur(), en(false))
    }, [Q, $, eb, es]),
    ey = l.useCallback(() => {
      var e, t;
      let n = null,
