...
let O = [{
    key: "EVENTS",
    renderIcon: e => <o.Que size={"md"} color={"currentColor"} className={e} />,
    getName: e => {
      let {
        numEvents: t
      } = e;
    ...
    key: "JOIN_SERVERS",
    renderIcon: e => <o.Jmo size={"md"} color={"currentColor"} className={e} />,
    getName: () => Chunk388032.intl.string(Chunk388032.t.K50GHR),
    handler: (e, t) => (0, u.XU)(e.id, t.id)
  }, {
    key: "ADD_SERVERS",
    renderIcon: e => <o.qJs size={"md"} color={"currentColor"} className={e} />,
    ...
    key: "INVITE_MEMBERS",
    renderIcon: e => <o.ejJ className={e} />,
