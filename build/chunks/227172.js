...
let j = {
  ...
  U = e => {
    let {
      ...
      primaryColor: Y,
      secondaryColor: W
    } = (0, N.Z)(null == B ? void 0 : B.src), K = (0, o.e7)([m.default], () => m.default.locale), {
      streamPreviewUrl: z,
      stream: q
    } = (0, v.Z)(n), {
    ...
    } = (0, O.Z)(n, 3), ee = n.extra.platform, et = null != ee ? j[ee] : null, en = ee === a.z.XBOX ? L.ABu.XBOX : ee === a.z.PLAYSTATION ? L.ABu.PLAYSTATION : void 0, er = (0, A.Z)(en), {
      data: ei
    } = (0, h.IX)(n.extra.application_id), ea = (0, d.q)(ei, "MemberListGamingContentPopout"), eo = i.useCallback(e => {
    ...
    let es = (0, r.jsx)(R.Gk, {
        ...
        children: C.W.map((e, t) => (0, r.jsx)(e, {
          entry: n
        }, t))
      }),
      el = null == q ? (0, r.jsx)(P.wG, {
        channel: t,
        headerIcons: null == et ? null : (0, r.jsx)(w.Z, {
          onClick: er,
          Icon: et,
      ...
      ec = (0, l.Z)(H, L.xjy.JOIN) || (0, c.Z)(H) ? (0, r.jsx)(_.Z, {
        activity: H,
        user: V,
