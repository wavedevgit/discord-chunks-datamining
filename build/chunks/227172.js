...
let U = {
  ...
  G = e => {
    let {
      ...
      primaryColor: K,
      secondaryColor: z
    } = (0, C.Z)(null == Z ? void 0 : Z.src), q = (0, a.e7)([g.default], () => g.default.locale), {
      streamPreviewUrl: X,
      stream: Q
    } = (0, I.Z)(n), {
    ...
    } = (0, v.Z)(n, 3), en = n.extra.platform, er = null != en ? U[en] : null, ei = en === o.z.XBOX ? x.ABu.XBOX : en === o.z.PLAYSTATION ? x.ABu.PLAYSTATION : void 0, eo = (0, N.Z)(ei), {
      data: ea
