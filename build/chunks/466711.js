...
function x(e) {
  ...
  } = (0, u.ZP)(c.Z.GIFT_BUTTON), [S, A] = i.useState(!1), N = (0, o.e7)([m.Z], () => !(null === m.Z || void 0 === m.Z ? void 0 : m.Z.hasLayers())), C = (0, o.e7)([g.default], () => g.default.getCurrentUser()), R = null != C ? b.default.age(C.id) : 0, {
    giftBoxAnimation: P,
    trinketsAnimation: x
  } = null != (t = null == n ? void 0 : n.chatGiftIcon) ? t : {}, M = (0, p.u)(), k = void 0 !== M && !s && N && R >= L, [j, U] = (0, f.XR)(k ? a.z.GIFTING_PROMOTION_DESKTOP_FIRST_TIME_COACHMARK : null, (0, d.t)(a.z.GIFTING_PROMOTION_DESKTOP_FIRST_TIME_COACHMARK)), G = null != j, B = S || G, V = (0, y.Ft)(E);
  if (s) return null;
  let F = () => {
      (0, _.Z)({
        isGift: !0,
