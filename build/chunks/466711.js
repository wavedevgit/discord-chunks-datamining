...
function x(e) {
  ...
  } = (0, u.ZP)(c.Z.GIFT_BUTTON), [S, A] = i.useState(!1), N = (0, o.e7)([m.Z], () => !(null === m.Z || void 0 === m.Z ? void 0 : m.Z.hasLayers())), C = (0, o.e7)([g.default], () => g.default.getCurrentUser()), P = null != C ? b.default.age(C.id) : 0, {
    giftBoxAnimation: R,
    trinketsAnimation: x
  } = null != (t = null == n ? void 0 : n.chatGiftIcon) ? t : {}, k = (0, p.u)(), M = void 0 !== k && !s && N && P >= L, [j, U] = (0, f.XR)(M ? a.z.GIFTING_PROMOTION_DESKTOP_FIRST_TIME_COACHMARK : null, (0, d.t)(a.z.GIFTING_PROMOTION_DESKTOP_FIRST_TIME_COACHMARK)), G = null != j, B = S || G, F = (0, y.Ft)(E);
  if (s) return null;
  let V = () => {
      (0, _.Z)({
        isGift: !0,
  ...
  return (0, r.jsx)("div", {
    ...
    children: void 0 !== k && G ? (0, r.jsx)(h.Z, {
      onComplete: () => A(!1),
      onCheckItOutClick: V,
      markAsDismissed: U,
      config: k,
