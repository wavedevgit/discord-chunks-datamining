...
function S(e) {
  ...
  for (let e of n) {
    ...
    if (n.length > 0) {
      let r = void 0 !== o ? v * o : Number.MAX_VALUE;
      n.length > r && (s.includes(e.id) || (n = n.slice(0, r - 1)), n.push({
        type: g.vB.SHOW_ALL,
        guild: e
      })), t.push({
        categoryInfo: {
...
function T(e, t, n) {
  ...
  let {
    ...
    rowLimit: s,
    shownAllGuildIds: l
  } = n, c = null != (r = a.get(t.id)) ? r : [], d = O(c), f = c.length < (0, u.nL)(t) && i, _ = 0 === d.length, p = (f || _) && !o, h = void 0 !== s ? v * s - +!!p : Number.MAX_VALUE, m = d.length;
  m > h && !l.includes(t.id) && (d = d.slice(0, h - 1)), p && d.push({
    type: g.vB.ADD_SOUND,
    guild: t
  }), m > h && d.push({
    type: g.vB.SHOW_ALL,
...
function N(e) {
  let {
    ...
    shownAllGuildIds: n = []
  } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, o = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], u = (0, i.e7)([c.default], () => c.default.getCurrentUser()), f = d.ZP.isPremium(u, y.p9.TIER_2), [b, v, O] = (0, i.Wu)([m.Z], () => [m.Z.getSounds(), m.Z.getFavorites(), m.Z.isFetching()]), N = (0, E.h)(e, !1), C = (0, i.Wu)([s.Z], () => {
    let e = [];
    return N.forEach(t => {
      let n = s.Z.getGuild(t);
      null != n && e.push(n)
    }), e
  }), R = d.ZP.canUseSoundboardEverywhere(u), w = (0, i.e7)([s.Z], () => s.Z.getGuild(null == e ? void 0 : e.guild_id)), D = (0, i.e7)([l.Z], () => {
    let {
    ...
    autoTrackExposure: !0
  }), M = P(), k = (0, i.Wu)([p.Z], () => p.Z.recentlyHeardSoundIds), j = h.w.useExperiment({
    location: "soundboard-useSoundGrid"
  });
  return r.useMemo(() => {
    let e = 0,
  ...
  }, [N, b, v, k, M, x, L, w, D, t, R, C, o, O, f, j.numRows, n])
}
