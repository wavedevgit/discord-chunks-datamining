...
function I(e) {
  ...
  } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], a = (0, i.e7)([c.default], () => c.default.getCurrentUser()), d = u.ZP.isPremium(a, E.p9.TIER_2), [g, v, I] = (0, i.Wu)([p.Z], () => [p.Z.getSounds(), p.Z.getFavorites(), p.Z.isFetching()]), T = (0, m.h)(e, !1), A = (0, i.Wu)([s.Z], () => {
    let e = [];
    return T.forEach(t => {
