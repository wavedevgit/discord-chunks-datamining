...
function T(e) {
  ...
  } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], a = (0, i.e7)([c.default], () => c.default.getCurrentUser()), u = d.ZP.isPremium(a, v.p9.TIER_2), [f, E, b] = (0, i.Wu)([h.Z], () => [h.Z.getSounds(), h.Z.getFavorites(), h.Z.isFetching()]), T = (0, m.h)(e, !1), N = (0, i.Wu)([s.Z], () => {
    let e = [];
    return T.forEach(t => {
  ...
  return r.useMemo(() => {
    ...
    return n ? (I(i, f), {
      ...
      sortById: !1
    }), S(i, R, P, f, t), C || I(i, f), O(i, N, null == R ? void 0 : R.id, f, u), C && I(i, f), i.forEach(t => {
