...
let z = h()("2015-05-15").local(),
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(() => {
        if (s.isDM()) {
          ...
          if (s.isGroupDM()) return (0, r.jsx)(E.Z, {
  ...
  Q = e => {
    ...
    return n = null != S ? S(l, o, i) : (0, r.jsx)("strong", {
      children: i.text
    }), (0, r.jsxs)(g.P3F, {
      tag: "li",
    ...
    super(...e), t = this, H(this, "state", {
      ...
      if (l.type !== i.mode.type) this.setSelectedIndex(-1);
        ...
        let e = k.zV(i.autocompletes, i.mode)[t.selectedIndex],
          n = k.zV(a, l).indexOf(e); - 1 !== n ? this.setSelectedIndex(n) : t.selectedIndex >= s && this.setSelectedIndex(s - 1)
      }
      ...
      return s.map(s => {
        ...
        return (0, r.jsxs)("ul", {
          ...
          children: [u, f, s.results.map(l => {
            ...
            }, (0, S.M)(t, a, c)), "".concat(s.group, "-").concat(l.text, "-").concat(null != (o = l.key) ? o : ""))
          })]
        }, s.group)
      })
    })
