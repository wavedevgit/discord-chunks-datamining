...
let K = h()("2015-05-15").local(),
    ...
    return (0, n.jsxs)("div", {
      ...
      children: [(() => {
        if (i.isDM()) {
          ...
          if (i.isGroupDM()) return (0, n.jsx)(E.Z, {
            "aria-hidden": !0,
        ...
        className: l,
        children: [i.isDM() || i.isGroupDM() ? (0, n.jsx)("span", {
          ...
          if (i.isDM()) {
            let e = i.getRecipientId(),
              t = A.default.getUser(e);
            return null == t ? null : (0, n.jsx)("span", {
  ...
  ee = {
    ...
    [B.dCx.FILTER_HAS]: {
      titleText: () => U.intl.string(U.t.IC7gHB)
    },
    [B.dCx.FILTER_FILE_TYPE]: {
      titleText: () => U.intl.string(U.t.SXIfV1)
    },
    [B.dCx.FILTER_IN]: {
      titleText: () => U.intl.string(U.t.vHyCgo),
      component: e => (0, n.jsx)(X, Q(q({}, e), {
        renderResult: J
      }))
    },
    [B.rtL.DATES]: {
      titleText: () => U.intl.string(U.t.UiL5e3)
    },
    [B.rtL.HISTORY]: {
      ...
      component: function(e) {
        var {
          ...
          renderResult: c,
          group: u
        } = e, d = z(e, ["onSelect", "onFocus", "result", "showFilter", "searchId", "renderResult", "group"]);
        let h = "",
          p = s.useMemo(() => {
            var e;
...
class et extends s.PureComponent {
  ...
  constructor(...e) {
    ...
    super(...e), t = this, G(this, "state", {
    ...
    }), G(this, "renderDatePicker", () => (0, n.jsxs)("div", {
      ...
      return s.map(s => {
        ...
        null != h.titleText && (d = "".concat(s.group, "-header"), u = (0, n.jsx)("div", {
          id: d,
          className: W.header,
