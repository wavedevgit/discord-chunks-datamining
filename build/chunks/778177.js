...
let H = u()("2015-05-15").local(),
  ...
  z = {
    ...
    [M.dCx.FILTER_HAS]: {
      titleText: () => Z.intl.string(Z.t.IC7gHB)
    },
    [M.dCx.FILTER_FILE_TYPE]: {
      titleText: () => Z.intl.string(Z.t.SXIfV1)
    },
    [M.dCx.FILTER_IN]: {
    ...
    [M.rtL.DATES]: {
      titleText: () => Z.intl.string(Z.t.UiL5e3)
    },
    [M.rtL.HISTORY]: {
      ...
      component: function(e) {
        ...
        return (0, n.jsxs)(p.P3F, F(L({
          ...
          "aria-label": Z.intl.formatToPlainString(Z.t.WoiGra, {
            suggestion: d
          }),
