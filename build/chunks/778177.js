...
let z = h()("2015-05-15").local(),
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(() => {
        if (s.isDM()) {
          ...
          if (s.isGroupDM()) return (0, r.jsx)(v.Z, {
      ...
      })(), s.isDM() || s.isGroupDM() ? (0, r.jsx)("span", {
  ...
  Q = e => {
    ...
    return n = null != S ? S(s, o, i) : (0, r.jsx)("strong", {
      children: i.text
    }), (0, r.jsxs)(g.P3F, {
      tag: "li",
...
class V extends l.PureComponent {
  ...
  constructor(...e) {
    ...
    super(...e), t = this, H(this, "state", {
      ...
      if (s.type !== i.mode.type) this.setSelectedIndex(-1);
        ...
        let e = A.zV(i.autocompletes, i.mode)[t.selectedIndex],
          n = A.zV(a, s).indexOf(e); - 1 !== n ? this.setSelectedIndex(n) : t.selectedIndex >= l && this.setSelectedIndex(l - 1)
      }
    ...
    }), H(this, "renderDatePicker", () => (0, r.jsxs)("div", {
      ...
      return l.map(l => {
        ...
        null != h.titleText && (d = "".concat(l.group, "-header"), u = (0, r.jsx)("div", {
          id: d,
          className: D.header,
        ...
        return (0, r.jsxs)("ul", {
          ...
          children: [u, f, l.results.map(s => {
            ...
            }, (0, S.M)(t, a, c)), "".concat(l.group, "-").concat(s.text, "-").concat(null != (o = s.key) ? o : ""))
          })]
        }, l.group)
      })
    })
