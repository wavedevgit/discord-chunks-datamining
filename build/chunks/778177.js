...
let Q = h()("2015-05-15").local(),
  ...
  V = (e, t, r) => {
    ...
    if (null == o) return (0, n.jsx)("strong", {
      children: i
    });
    ...
    return [(0, n.jsx)("img", {
      ...
      src: p
    }, "avatar-".concat(t, "-").concat(o.id)), (0, n.jsx)("span", {
      className: U.displayedNick,
      children: h
    }, "display-nick-".concat(t, "-").concat(o.id)), (0, n.jsx)("span", {
  ...
  X = (e, t, r, s) => {
    ...
    if (null == l) return (0, n.jsx)("strong", {
      children: o
    });
    ...
    return (0, n.jsxs)("div", {
      ...
      children: [(() => {
        if (l.isDM()) {
          ...
          if (l.isGroupDM()) return (0, n.jsx)(j.Z, {
            "aria-hidden": !0,
      ...
      })(), l.isDM() || l.isGroupDM() ? (0, n.jsx)("span", {
  ...
  J = e => {
    ...
    return r = null != b ? b(l, i, o) : (0, n.jsx)("strong", {
      children: o.text
    }), (0, n.jsxs)(g.P3F, {
      tag: "li",
    ...
    [H.rtL.HISTORY]: {
      ...
      component: function(e) {
        var {
          ...
          renderResult: c,
          group: u
        } = e, d = W(e, ["onSelect", "onFocus", "result", "showFilter", "searchId", "renderResult", "group"]);
        let h = "",
          p = s.useMemo(() => {
            var e;
