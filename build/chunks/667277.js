...
function S(e, t, n, g) {
  ...
  var C = (0, u.Z)(null != (w = null != (D = null != (L = null != (x = null == g ? true : g.firstWeekContainsDate) ? x : null == g || null == (M = g.locale) || null == (j = M.options) ? true : j.firstWeekContainsDate) ? L : v.firstWeekContainsDate) ? D : null == (k = v.locale) || null == (U = k.options) ? true : U.firstWeekContainsDate) ? w : 1);
