...
function S(e, t, n, g) {
  ...
  var C = (0, u.Z)(null != (D = null != (w = null != (x = null != (L = null == g ? true : g.firstWeekContainsDate) ? L : null == g || null == (M = g.locale) || null == (k = M.options) ? true : k.firstWeekContainsDate) ? x : v.firstWeekContainsDate) ? w : null == (j = v.locale) || null == (U = j.options) ? true : U.firstWeekContainsDate) ? D : 1);
  ...
  var R, P, D, w, x, L, M, k, j, U, G, B, Z, F, V, H, Y, W, K, z = {
