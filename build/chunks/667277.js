...
function S(e, t, n, g) {
  ...
  var C = (0, u.Z)(null != (D = null != (w = null != (L = null != (x = null == g ? true : g.firstWeekContainsDate) ? x : null == g || null == (M = g.locale) || null == (j = M.options) ? true : j.firstWeekContainsDate) ? L : v.firstWeekContainsDate) ? w : null == (k = v.locale) || null == (U = k.options) ? true : U.firstWeekContainsDate) ? D : 1);
  ...
  var R, P, D, w, L, x, M, j, k, U, G, B, Z, F, V, H, Y, W, K, z = {
