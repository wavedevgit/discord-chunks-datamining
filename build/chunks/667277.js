...
function S(e, t, n, g) {
  ...
  var C = (0, u.Z)(null != (w = null != (D = null != (x = null != (L = null == g ? true : g.firstWeekContainsDate) ? L : null == g || null == (M = g.locale) || null == (k = M.options) ? true : k.firstWeekContainsDate) ? x : v.firstWeekContainsDate) ? D : null == (j = v.locale) || null == (U = j.options) ? true : U.firstWeekContainsDate) ? w : 1);
  ...
  var R, P, w, D, x, L, M, k, j, U, G, B, Z, F, V, H, Y, W, K, z = {
