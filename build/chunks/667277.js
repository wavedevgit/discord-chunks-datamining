...
function S(e, t, n, g) {
  ...
  var C = (0, u.Z)(null != (w = null != (D = null != (L = null != (x = null == g ? true : g.firstWeekContainsDate) ? x : null == g || null == (j = g.locale) || null == (M = j.options) ? true : M.firstWeekContainsDate) ? L : v.firstWeekContainsDate) ? D : null == (k = v.locale) || null == (U = k.options) ? true : U.firstWeekContainsDate) ? w : 1);
  ...
  var R, P, w, D, L, x, j, M, k, U, G, B, Z, F, V, H, Y, W, K, z = {
