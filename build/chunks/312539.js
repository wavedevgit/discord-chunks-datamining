...
function P(e) {
  ...
  let w = u === (null == p ? void 0 : p.guildId) || null == u,
    I = x || s.isSubscriptionGated ? w || null == _ ? (0, r.jsx)(f.Z, {
      iconType: b,
    ...
    Z = null;
  return null != a && (Z = (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(h.Z, {}), (0, r.jsx)(f.Z, {
      iconType: y ? "post" : "message"
    })]
  })), (0, r.jsxs)(g.Z, {
    role: "link",
    onClick: e => {
...
function T(e) {
  let {
    guildId: n,
    children: t
  } = e, i = (0, l.e7)([p.Z], () => p.Z.getGuild(n), [n]);
  return (0, r.jsxs)(_.Z, {
    guild: i,
...
function A(e) {
  let {
    id: n
  } = e, t = (0, j.d)(), i = null == t ? void 0 : t.guildId, o = (0, l.e7)([p.Z], () => {
    var e, t;
