...
function T(e) {
  ...
  let x = o === (null == p ? void 0 : p.guildId) || null == o,
    w = y || s.isSubscriptionGated ? x || null == f ? (0, r.jsx)(_.Z, {
      iconType: h,
      children: null != f ? f : (0, r.jsx)("em", {
        children: Z.intl.string(Z.t.J90oLS)
      })
    }) : (0, r.jsx)(A, {
      guildId: o,
      children: f
    ...
    O = null;
  return null != u && (O = (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(m.Z, {}), (0, r.jsx)(_.Z, {
...
function A(e) {
  let {
    guildId: n,
    children: t
  } = e, i = (0, l.e7)([O.Z], () => O.Z.getGuild(n), [n]);
  return (0, r.jsxs)(b.Z, {
    guild: i,
...
function N(e) {
  let {
    id: n
  } = e, t = (0, j.d)(), i = null == t ? void 0 : t.guildId, c = (0, l.e7)([w.Z], () => {
    var e, t;
