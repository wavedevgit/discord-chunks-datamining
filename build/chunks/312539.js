...
function O(e) {
  ...
  if (null == a) return;
  let h = f === (null == b ? void 0 : b.guildId) ? (0, r.jsx)(s.Z, {
      iconType: a,
      children: o
    }) : (0, r.jsx)(P, {
      guildId: f,
    ...
    y = null;
  return null != c && (y = (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(g.Z, {}), (0, r.jsx)(s.Z, {
      iconType: d ? "post" : "message"
    })]
  })), (0, r.jsxs)(_.Z, {
    role: "link",
    onClick: e => {
...
function P(e) {
  let {
    guildId: n,
    children: t
  } = e, i = (0, l.e7)([v.Z], () => v.Z.getGuild(n), [n]);
  return (0, r.jsx)(f.Z, {
    guild: i,
    children: t
  })
...
function A(e) {
  let {
    id: n
  } = e, t = (0, m.d)(), i = null == t ? void 0 : t.guildId, u = (0, l.e7)([v.Z], () => {
    var e, t;
