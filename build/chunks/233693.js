/** Chunk was on web.js **/
/** chunk id: 233693, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  MO: () => c,
  NB: () => u,
...
class h {
  ...
  updatePaginationState(e) {
    ...
    return this._paginationState = s({}, this._paginationState, e), t && this._rebuildPaginationChunksFromStoredMembers(), [true, t]
  }
  ...
  _findMember(e) {
    ...
    for (; null == a && !((e += t) < 0) && !(e >= this._sortedMemberIds.length);) i = this._sortedMemberIds[e], (null == (a = r.Ay.getMember(this.guildId, i)) ? true : a.joinedAt) == null && (a = null);
    return a
  }
