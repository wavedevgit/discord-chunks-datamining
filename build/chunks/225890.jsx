...
function E(e) {
  ...
  }, [E, n, null == y ? true : y.id, b]), <m.ZP guild={O} channel={v} guildScheduledEvent={y} isMember={I} onAcceptInstantInvite={g.dG} onTransitionToInviteChannel={T} recurrenceId={b} />
}