...
function o(A, e, o) {
  ...
  switch (A.code) {
    ...
    case a.evJ.CREATOR_MONETIZATION_PAYMENT_ACCOUNT_VERIFICATION_REQUIRED:
      ...
      }) : c = i.t.ZVV1go, (0, l.B)(i.intl.string(i.t["+CT/gY"]), c, u);
      break;
    default:
      let g = null != (d = A.getFirstFieldErrorMessage(["published"])) ? d : (null == (s = A.hasFieldErrors) ? true : s.call(A)) ? true : A.message;
