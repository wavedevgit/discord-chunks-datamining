    ...
    e_ = e => {
      ...
      switch (e.type) {
        case v.ld.EXPAND_OR_COLLAPSE_EMOJIS: {
          ...
          }, l = e.sectionCollapsedToThreeRows ? a ? (0, s.wj)(ei) ? et : er : (0, s.wj)(ei) ? Q : X : a ? (0, s.wj)(ei) ? ee : en : (0, s.wj)(ei) ? J : $, c = T.NW.string(e.sectionCollapsedToThreeRows ? T.t.NZI2Zm : T.t["/K2RDA"]);
          return n({
            handleSelect: o,
            icon: (0, r.jsx)("img", {
              className: N.icon,
