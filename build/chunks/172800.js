...
let L = e => {
  let {
    ...
    autoTrackExposure: !1
  }), Q = n(187119), X = n(39874), J = n(853871), $ = n(63149), ee = n(263112), et = n(490567), en = n(292795), er = n(7940), ei = (0, u.ZP)(), ea = p.kJ.getState(), [eo, es] = i.useState(ea.inspectedExpressionPosition), [el, ec] = (0, c.Z)(null, 300), eu = i.useRef(null);
    ...
    e_ = e => {
      ...
      switch (e.type) {
        case v.ld.EXPAND_OR_COLLAPSE_EMOJIS: {
          ...
          }, l = e.sectionCollapsedToThreeRows ? a ? (0, s.wj)(ei) ? et : er : (0, s.wj)(ei) ? Q : X : a ? (0, s.wj)(ei) ? ee : en : (0, s.wj)(ei) ? J : $, c = T.intl.string(e.sectionCollapsedToThreeRows ? T.t.NZI2Zm : T.t["/K2RDA"]);
          return n({
            handleSelect: o,
            icon: (0, r.jsx)("img", {
              className: A.icon,
