      ...
      let t = "".concat(e.rowIndex, "c").concat(e.columnIndex),
        n = function() {
          ...
          let {
            ...
            tabIndex: g,
            onFocus: E
          } = h, b = L(h, ["ref", "tabIndex", "onFocus"]), y = ec.rowIndex === _ && ec.columnIndex === p, v = () => {
        ...
        case I.ld.EXPAND_OR_COLLAPSE_EMOJIS: {
          let {
            ...
            t.stopPropagation(), U.current || G.current || (R(e, {
              isFinalSelection: !0,
              toggleFavorite: !1
            }), (0, _.D)(e.guildId), e.sectionCollapsedToThreeRows || Q(), v.default.track(A.rMx.EMOJI_PICKER_THREE_ROW_COLLAPSE_TOGGLED, {
