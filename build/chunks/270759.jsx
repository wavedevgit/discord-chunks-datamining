...
function x() {
  return <div className={Chunk610725.inviteToolbar}><Chunk518311.Z tooltip={Chunk388032.intl.string(Chunk388032.t.HfOgAw)} location={"PeoplePageHeaderToolbar-CreateDMButton"} /></div>
}
let A = function(e) {
  let {
    initialSection: t
  ...
  let D = e => {
    ...
    U = [{
      ...
      content: <r.Fragment>{P.intl.string(P.t.p6IHGB)}{A > 0 && <u.mAB count={A} className={j.badge} />}</r.Fragment>,
      ...
      show: L > 0,
      content: <r.Fragment>{P.intl.string(P.t["8rSi19"])}{<u.mAB count={L} className={j.badge} />}</r.Fragment>,
      ...
      id: N.pJs.ADD_FRIEND,
      show: true,
      content: <span>{P.intl.string(P.t.j0wbEx)}</span>,
      ariaLabel: P.intl.string(P.t.j0wbEx),
      className: a()(j.item, j.addFriend)
    }];
  return <main className={j.container} aria-label={P.intl.string(P.t.TdEu5e)}>{<h.yY location={P.intl.string(P.t.TdEu5e)} />}{<u.f6W theme={_}>{e => (0, r.jsxs)(b.Z, {
        className: e,
        toolbar: (0, r.jsx)(x, {}),
        scrollable: s.tq,
        role: "navigation",
      ...
      })}</u.f6W>}{<div className={j.tabBody}>{<u.njP.Panel id={Z} className={j.peopleColumn} aria-labelledby={M}>{Z === N.pJs.ADD_FRIEND ? (0, r.jsx)(C.Z, {}) : (0, r.jsx)(S.Z, {
          titleId: M
        })}</u.njP.Panel>}{<div className={j.nowPlayingColumn}><O.Z /></div>}</div>}</main>
}