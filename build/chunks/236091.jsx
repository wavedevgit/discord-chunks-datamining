...
let g = e => {
  ...
  }) ? <l.DY3 text={h.intl.string(h.t.DJXW3N)} color={l.FGA.GREY} className={o()(t, m.clipsEnabledIndicator)}>{<l.G2e icon={l.AlX} shape={l.Dv2.ROUND_LEFT} color={s.Z.unsafe_rawColors.PRIMARY_500.css} className={m.clipBadgeIcon} />}{<l.IGR text={h.intl.string(h.t.pCMkDQ)} shape={l.Dv2.ROUND_RIGHT} color={s.Z.unsafe_rawColors.PRIMARY_500.css} className={m.clipBadgeText} />}</l.DY3> : null
}