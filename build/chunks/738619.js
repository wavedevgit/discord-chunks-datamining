...
class F extends r.PureComponent {
  ...
  logShownEventIfNeeded() {
    ...
    null != t && -1 === N.indexOf(t) && (w.default.track(T.rMx.SHOW_TUTORIAL, {
...
function D(t) {
  let {
    ...
    rateLimitPerUser: m
  } = a, O = r.useRef(null), b = r.useRef(null), [S, y] = r.useState(!1);
  if (r.useLayoutEffect(() => {
    ...
    }, []), 0 === s.length && !(m > 0) && !p) return null != e ? (0, n.jsx)(F, {
    activity: e,
    isFocused: i
  }) : null;
  let [E, Z, I] = s, w = "";
  ...
  return (0, n.jsxs)("div", {
    ...
    children: [(0, n.jsxs)("div", {
      ...
      ref: O,
      children: [s.length > 0 && !1 !== u && (0, n.jsx)(c.bbz, {
...
function M(t) {
  ...
  return a()(e).keys().filter(t => t !== (null == i ? void 0 : i.id)).reject(t => S.Z.isBlockedOrIgnored(t)).map(t => Z.default.getUser(t)).filter(P.lm).map(e => x.ZP.getName(t.guild_id, t.id, e)).value()
}
