...
class M extends r.PureComponent {
  ...
  render() {
    ...
    return (0, n.jsxs)("div", {
      className: o()(A.activityInviteEducation, {
        [A.activityInviteEducationFadeIn]: this.state.fadeIn
      }),
      children: [e ? (0, n.jsx)(c.whL, {
        size: "sm",
        className: A.activityInviteEducationLeftArrow
      }) : (0, n.jsx)("div", {
        className: A.activityInviteEducationArrow
      }), (0, n.jsx)("span", {
...
function k(t) {
  ...
  return 1 === l.length ? Z = _.intl.format(_.t.lJ9sZW, {
    ...
    children: [(0, n.jsxs)("div", {
      ...
      children: [l.length > 0 && !1 !== h && (0, n.jsx)(c.bbz, {
