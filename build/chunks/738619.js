...
function B(e) {
  ...
  return l()(t).keys().filter(e => e !== (null == n ? void 0 : n.id)).reject(e => y.Z.isBlockedOrIgnored(e)).map(e => I.default.getUser(e)).filter(A.lm).map(t => N.ZP.getName(e.guild_id, e.id, t)).value()
}
