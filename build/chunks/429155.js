...
let f = 20,
  _ = i.forwardRef(function(e, t) {
    let {
      ...
      renderUpsell: N,
      setShowUpsell: C
    } = e, R = i.useRef(!1), P = i.useRef(null), w = (0, l.Iu)(e => e.searchQuery), D = _.useStore(e => e.activeCategoryIndex), L = o.C.useExperiment({
      location: "ExpressionPickerList"
    }).moveDefaultToBottom, x = n.map(e => (0, s._O)(e.categoryInfo) ? {
    ...
    return (0, u.Xs)({
      ...
      getListDimensions: function() {
        ...
        return null != (t = null == (e = P.current) ? void 0 : e.getListDimensions(...r)) ? t : {
          height: -1,
          totalHeight: -1
        }
      }
      ...
      className: d.wrapper,
      children: [w.length > 0 && !p && null != O ? O() : (0, r.jsx)(a.Z, {
