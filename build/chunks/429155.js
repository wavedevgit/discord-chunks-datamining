...
let u = 20,
  d = i.forwardRef(function(e, t) {
    let {
      ...
      renderUpsell: T,
      setShowUpsell: A
    } = e, N = i.useRef(!1), C = i.useRef(null), R = (0, s.Iu)(e => e.searchQuery), P = d.useStore(e => e.activeCategoryIndex), w = n.map(e => (0, a._O)(e.categoryInfo) ? {
    ...
    return (0, l.Xs)({
      ...
      className: c.wrapper,
      children: [R.length > 0 && !f && null != b ? b() : (0, r.jsx)(o.Z, {
