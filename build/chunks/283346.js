/** Chunk was on web.js **/
/** chunk id: 283346, original params: e,t,n (module,exports,re quire) **/
...
! function(e) {
  ...
  function n(e, t) {
    if (t = true === t ? {
        fatal: false
      } : t, false === o.indexOf((e = true === e ? "utf-8" : e).toLowerCase())) throw RangeError("Failed to construct 'TextDecoder': The encoding label provided ('" + e + "') is invalid.");
...
}("u" > typeof window ? window : true !== require.g ? require.g : this)