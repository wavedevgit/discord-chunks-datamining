...
function I(e) {
  let {
    text: t,
    language: i
  } = e, o = () => <pre><code className={a()(m.scrollbarGhostHairline, h.codeView, "hljs")}>{t}</code></pre>;
  return <s.GI createPromise={() => Promise.resolve().then(n.bind(n, 364964))} webpackId={364964} render={e => {
...
function T(e) {
  ...
  return <l.ua7 text={"".concat(t ? p.intl.string(p.t.iTcumZ) : p.intl.string(p.t.dcl9MT), " (").concat(a, ")")}>{e => (0, r.jsxs)(l.P3F, y(E({}, e), {
...
function S(e) {
  ...
  return <r.Fragment>{<l.ua7 text={o}>{e => (0, r.jsx)("span", y(E({}, e), {
        className: a()(h.downloadSection, h.attachmentName),
        children: n
      }))}</l.ua7>}{<l.ua7 text={o}>{e => (0, r.jsx)("span", y(E({}, e), {
        className: a()(h.downloadSection, h.formattedSize),
        children: (0, _.IC)(i)
      }))}</l.ua7>}{<l.ua7 text={"".concat(p.intl.string(p.t["1WjMbG"]), " ").concat(o)}>{e => (0, r.jsx)(l.eee, y(E({}, e), {
...
function A(e) {
  ...
  return <l.yRy targetElementRef={o} position={"left"} renderPopout={e => {
      let {
        closePopout: i
      } = e;
...
function N(e) {
  return <l.ua7 text={p.intl.string(p.t["0PQYk5"])}>{t => (0, r.jsx)(l.P3F, y(E({}, t), {
...
function C(e) {
  ...
  let R = (null == b ? true : b.slice(0, O).join("\n")) + C,
    P = (0, u.yx)(R),
    w = c || O < y;
  return <div className={a()(E, h.container)}>{<div className={a()(h.textContainer, {
        [h.expanded]: c
      })}>{null == s ? (0, r.jsx)(l.$jN, {
        className: h.spinner
      }) : (0, r.jsx)(I, {
        text: P,
        language: f
      })}</div>}{<l.Text color={"header-secondary"} className={h.footer} variant={"text-sm/normal"}>{w ? <r.Fragment>{<T expanded={c} setExpanded={d} isWholeFile={v} numLines={y} />}{<N url={n} fileName={i} fileSize={o} language={f} fileContents={s} bytesLeft={g} />}</r.Fragment> : null}{<div className={h.footerGap} />}{<S url={n} fileName={i} fileSize={o} />}{<A language={f} setLanguage={m} />}</l.Text>}</div>
}
...
function R(e) {
  ...
  }))), <l.Y0X transitionState={a} aria-label={p.intl.string(p.t.qxQjc3)} size={l.CgR.LARGE} className={h.modalRoot} parentComponent={"PlaintextFilePreview"}><div className={h.modalContent}>{<l.zJl className={h.modalTextContainer}>{null == c ? (0, r.jsx)(l.$jN, {
          className: h.spinner
        }) : (0, r.jsx)(I, {
          text: m,
          language: d
        })}</l.zJl>}{<l.Text color={"header-secondary"} className={h.footer} variant={"text-sm/normal"}>{<div className={h.footerGap} />}{<S url={t} fileName={n} fileSize={o} />}{<A language={d} setLanguage={f} />}</l.Text>}</div></l.Y0X>
}
let P = Chunk73800.memo(function(e) {
  ...
  return b ? <c.Z url={t} fileName={n} fileSize={o} onClick={u} onContextMenu={d} className={l} /> : <C url={t} fileName={n} fileSize={o} fileContents={g} bytesLeft={E} expanded={f} setExpanded={_} language={p} setLanguage={m} className={a()(h.newMosaicStyle, l)} />
