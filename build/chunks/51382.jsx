...
require("./73800.js");
var Chunk82950 = require("./82950.js"),
...
let d = e => {
  ...
  return <i.Z guild={n} onDismissed={() => {
    ...
    }} title={c.intl.string(c.t["4Y2AS0"])} message={c.intl.string(c.t.wTsxTU)} cta={c.intl.string(c.t.wBoE6O)} image={u} type={s.vID.HUB_STUDY_ROOM} />
}