...
function C(e) {
  ...
  return <span style={E.u$}><u.W5 className={v.positionLayer} targetRef={t} position={"top"} align={"right"} spacing={24} autoInvert={true} clickTrap={true}>{e => {
        let {
          isPositioned: t
        } = e;
...
function P(e) {
  ...
  let A = (0, g.Z)();
  return <m.Z ref={p} context={{
      channel: t,
      type: "channel"
    }} entrypoint={h._b.TEXT} initHistory={A} />
}
