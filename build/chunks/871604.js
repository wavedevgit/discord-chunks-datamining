...
function R(e) {
    ...
    L = i.useCallback(() => {
      if (null != R)
        if (w) {
          ...
          l.__(c._b.TEXT, r, {
            applicationId: R.id
          }), (0, o.Mr3)((0, O.z)(D, null == P ? void 0 : P.guild_id)), null == n || n(), m.default.track(I.rMx.APP_PROFILE_OPEN_APP_BUTTON_CLICKED, {
            application_id: R.id
          })
        } else(0, b.L)(A({
          applicationId: R.id
  ...
  let {
    customInstallUrl: M
  } = R, k = null == M || E.Z.isDiscordUrl(M) ? o.qJs : o.Gr1, j = w ? void 0 : k;
