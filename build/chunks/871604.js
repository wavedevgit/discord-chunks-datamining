...
function w(e) {
    ...
    L = i.useCallback(() => {
      if (null != w)
        if (P) {
          ...
          l.__(c._b.TEXT, r, {
            applicationId: w.id
          }), (0, o.Mr3)((0, O.z)(D, null == R ? void 0 : R.guild_id)), null == n || n(), m.default.track(I.rMx.APP_PROFILE_OPEN_APP_BUTTON_CLICKED, {
            application_id: w.id
          })
        } else(0, b.L)(A({
          applicationId: w.id
  ...
  let {
    customInstallUrl: k
  } = w, j = null == k || E.Z.isDiscordUrl(k) ? o.qJs : o.Gr1, M = P ? void 0 : j;
