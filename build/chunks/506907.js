/** Chunk was on web.js **/
/** chunk id: 506907, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  F: () => u
});
...
function u(e) {
  ...
  return {
    ...
    focusNextRow() {
      m.days ? this.focusNextPage() : (m.weeks || m.months || m.years) && G(P.add({
        weeks: 1
      }))
    },
    focusPreviousRow() {
      m.days ? this.focusPreviousPage() : (m.weeks || m.months || m.years) && G(P.subtract({
        weeks: 1
      }))
    },
    focusNextPage() {
      let e = D.add(H);
      w((0, r.Me)(P.add(H), g, E)), x((0, r.Yn)((0, r.PJ)(P, e, H, p, g, E), H, p))
    },
    focusPreviousPage() {
      let e = D.subtract(H);
      w((0, r.Me)(P.subtract(H), g, E)), x((0, r.Yn)((0, r.PJ)(P, e, H, p, g, E), H, p))
    },
    focusSectionStart() {
    ...
    focusNextSection(e) {
      ...
      m.days ? this.focusNextPage() : m.weeks ? G(P.add({
        months: 1
      })) : (m.months || m.years) && G(P.add({
        years: 1
      }))
    },
    focusPreviousSection(e) {
      if (!e && !m.days) return void G(P.subtract(d(m)));
      m.days ? this.focusPreviousPage() : m.weeks ? G(P.subtract({
        months: 1
      })) : (m.months || m.years) && G(P.subtract({
        years: 1
      }))
    },
    selectFocusedDate() {
