...
class _ extends Chunk317770.Z {
  ...
  handleIncomingVideo(e) {
    ...
    let l = null != a.ZP.getVisibleGame(),
      ...
      _ = h.has(t);
    !l || p || m || g || _ || (f.add(t), i.Z.setDisableLocalVideo(t, u.ZUi.DISABLED, n, false))
  }
