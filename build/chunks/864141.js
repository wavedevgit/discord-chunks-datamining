...
function U(e) {
  ...
  }), K = (0, s.e7)([m.default], () => m.default.locale), z = "en-US" === K || "en-GB" === K, q = () => i.isDM() || i.isGroupDM() ? D.NW.string(D.t["9FaEzs"]) : i.isGuildStageVoice() ? D.NW.string(D.t.QygGCA) : D.NW.string(D.t.msxteH), Q = () => {
    if (t.id !== n.id || !z) return null;
    let e = i.isDM() || i.isGroupDM() ? D.NW.string(D.t["+DsWbW"]) : D.NW.string(D.t.xOVEjY);
    return (0, r.jsx)(l.ua7, {
      text: e,
      children: e => (0, r.jsx)(l.d3s, j(M({}, e), {
        size: "xxs"
      }))
    })
  }, X = () => {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)("div", {
        children: [(0, r.jsxs)(a.X6, {
          ...
          text: D.NW.formatToPlainString(D.t["hq/Qzc"], {
            guildName: Z.name
          }),
          onClick: t
        })]
