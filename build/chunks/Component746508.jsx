...
function eK() {
  ...
  return (0, Chunk255367.jsxs)("div", {
    ref: module,
    className: Chunk787140.noiseCancellationPopout,
    children: [(0, Chunk255367.jsx)(Chunk481060.j7V, {
    ...
    }), (0, Chunk255367.jsx)(Chunk284056.Z, {
      ...
      buttonClassName: Chunk787140.micTestButton,
      ...
      className: a()(Chunk881488.marginBottom8, Chunk881488.marginTop20),
...
function eq() {
  ...
  return (0, Chunk255367.jsx)(Chunk870569.Z, {
    "aria-label": require,
    tooltipText: require,
...
function eX(e) {
  ...
  } = (0, Z.ZP)(), c = (0, eo.Z)(), d = (0, ec.Z)(t), p = (0, u.e7)([C.ZP], () => null != C.ZP.getSelfEmbeddedActivityForLocation(C.ZP.getConnectedActivityLocation())), f = (0, Q.Z)(t), {
    reachedLimit: _,
    limit: O
  ...
  return i.useEffect(() => () => T(), [c.enabled, T]), (0, r.jsx)(eg.Z, eF(eH({
    onChange: v,
...
function eJ(e) {
  let t, {
    ...
    v = f.find(e => e.ownerId === (null == h ? true : h.id)),
    I = (0, eu.E)(n, h, f);
...
class e$ extends Chunk73800.PureComponent {
  renderConnectionStatus() {
    ...
    return null != require ? (e = Chunk981631.Z5c.CHANNEL(require.id, exports.id), u = "".concat(Chunk442837, " / ").concat(require.name)) : e = Chunk981631.Z5c.CHANNEL(Chunk981631.ME, exports.id), (0, Chunk255367.jsx)(Chunk917405.Z, {
      channelId: exports.id,
      quality: Chunk73800,
      state: Chunk120356,
      lastPing: a,
      hasVideo: Chunk512722,
      connectionStatusTextVariant: s ? "text-md/medium" : true,
  ...
  renderNoiseCancellation() {
    ...
    return null != Chunk73800 ? null : (null == Chunk120356 ? true : Chunk120356.isGuildStageVoice()) && null == a.find(e => e.user.id === eb.default.getId() && (0, el.gf)(e.voiceState) === el.xO.ON_STAGE) && (0, Chunk485287.U5)(Chunk120356.id) ? (0, Chunk255367.jsx)(eq, {}) : !require && exports ? (0, Chunk255367.jsx)(Chunk481060.ua7, {
      text: Chunk388032.intl.string(Chunk388032.t["i+SO/f"]),
      tooltipClassName: Chunk787140.noiseCancellationTooltip,
      forceOpen: true,
      children: e => {
        let {
          "aria-label": t
      ...
      position: "top",
      align: "center",
      renderPopout: () => (0, Chunk255367.jsx)(eK, {}),
      children: (t, n) => {
        let {
          isShown: i
        } = n;
  ...
  renderVoiceStates() {
    ...
    return null != module && require && 0 !== exports.length ? (0, Chunk255367.jsx)(Chunk226323.Z, {
      voiceStates: exports,
      channel: module,
      className: Chunk787140.voiceUsers
    }) : null
  }
  renderChannelButtons() {
    ...
    return (0, Chunk255367.jsxs)("div", {
      className: Chunk787140.actionButtons,
      children: [(0, Chunk255367.jsx)(eX, {
        channel: module,
        enableActivities: Chunk688642,
        disabled: !Chunk704215 && Chunk442837
      }), (0, Chunk255367.jsx)(eJ, {
        channel: module,
        canGoLive: exports,
        enableActivities: Chunk688642,
        disabled: module.isGuildStageVoice() && (Chunk704215 && null == a || !Chunk704215 && Chunk442837)
      }), Chunk688642 ? (0, Chunk255367.jsx)(eQ, {
        channel: module,
        enableActivities: Chunk73800
      }) : null, (0, Chunk641015.Z)(module) ? (0, Chunk255367.jsx)(Chunk848543.Z, {
        channel: module,
        focusProps: eW
      }) : null]
    })
  ...
  render() {
    ...
    return null == module ? null : (0, Chunk255367.jsx)(Chunk481060.yRy, {
      ...
      children: () => (0, Chunk255367.jsxs)("div", {
        ref: this.ref,
        className: Chunk787140.container,
        children: [(0, Chunk255367.jsxs)(Chunk600164.Z, {
          className: Chunk787140.connection,
          align: Chunk600164.Z.Align.CENTER,
          children: [(0, Chunk255367.jsx)("div", {
            className: Chunk787140.inner,
            children: this.renderConnectionStatus()
          }), (0, Chunk255367.jsxs)(Chunk600164.Z, {
            grow: 0,
            shrink: 0,
            className: Chunk787140.voiceButtonsContainer,
...
let e1 = (0, Chunk730749.Z)(function(e) {
  let t = (0, B.Z)(),
    ...
    f = (0, u.e7)([ey.Z, Y.Z], () => Y.Z.hasHotspot(eM.v.VOICE_PANEL_INTRODUCTION) && (0, ex.EO)(l) && !ey.Z.isInteractionRequired() && !(null == c ? true : c.isGuildStageVoice())),
