...
function U(e) {
  ...
  let {
    ...
    return f.reduce((n, r) => {
      ...
      return null == a || ((null == e || e !== a.id) && n.push({
        channel: a,
        results: [],
        startIndex: t
      }), t += 1, n[n.length - 1].results.push(r), e = null == a ? void 0 : a.id), n
    }, [])
  }, [f, x]), G = i.useRef([]), Z = U.reduce((e, t) => e + 1 + t.results.length, 0), F = i.useCallback((e, t) => {
    if (!d.Z.keyboardModeEnabled) return;
    let n = G.current,
      r = null != t ? n[t] : void 0;
    if (null == r || null == r.hitRef.current) return;
    let i = r.hitRef.current.getClientRects()[0];
    o(i.top - .5 * i.height, !1, () => {
      var t;
    ...
    setFocus: F,
    onSelect: V
  }), Y = (0, u.nC)(null != (t = null == T ? void 0 : T.content) ? t : ""), W = U.map(e => {
    let {
      channel: t,
      results: n,
      startIndex: i
  ...
  let z = (0, l.mFp)(),
    q = () => _ > 0 && p > 0 ? D.intl.formatToPlainString(D.t["OvJs9/"], {
      count: _ + p
    }) : _ > 0 ? D.intl.formatToPlainString(D.t["n/1QFR"], {
      count: _
    }) : D.intl.formatToPlainString(D.t.ypezTE, {
      count: p
    }),
    $ = () => _ > 0 && p > 0 ? D.intl.formatToPlainString(D.t.EJHRcX, {
      count: _ + p
    }) : _ > 0 ? D.intl.formatToPlainString(D.t.HTE8JC, {
      count: _
    }) : D.intl.formatToPlainString(D.t.e7f8r6, {
      count: p
    }),
    X = () => {
      null == O || O(!x)
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)("div", M(k({
      ref: K
    }, H.getContainerProps(), z), {
      "aria-busy": R,
      children: W
    })), _ > 0 || p > 0 ? (0, r.jsxs)(l.P3F, {
      tag: "div",
...
function G(e) {
  ...
  return (0, v.Em)(t.type) ? (0, r.jsx)(l.P3F, {
...
function B(e) {
  ...
  let {
    ...
    listNavigator: x,
    favoriteSearch: j
  } = e, U = O.cC.useSetting(), B = (0, h.p)(), Z = i.useCallback(e => {
    if (e === N.Z.getChannelId()) return;
    let t = I.Z.getChannel(e);
    null != t && (S.Z.can(P.Plq.VIEW_CHANNEL, t) || t.isPrivate()) && (0, y.Kh)(t.id)
  }, []), F = null != o ? (0, f.F6)(o, C.default, A.Z, !1) : "???", V = j && null != o.guild_id ? null == (t = T.Z.getGuild(o.guild_id)) ? void 0 : t.name : null, H = (null == o ? void 0 : o.parent_id) != null ? I.Z.getChannel(o.parent_id) : null, Y = null != (n = null == H ? void 0 : H.name) ? n : null, W = null != (a = (0, _.KS)(o)) ? a : l.VL1, K = S.Z.can(P.Plq.MANAGE_MESSAGES, o), {
    content: z
  } = (0, g.ZP)({
    content: F,
    embeds: []
  ...
  }), q = i.useRef(null), [$, X] = i.useState(!1);
  i.useEffect(() => {
    let e = q.current;
      ...
      children: [(0, r.jsx)(l.P3F, {
        ...
        children: (0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(W, {
            ...
            text: F,
            shouldShow: $,
            children: e => (0, r.jsxs)("span", M(k({}, e), {
              ref: q,
