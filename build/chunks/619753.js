...
function G(e) {
  ...
  }, []), Z = null != i ? (0, d.F6)(i, D.default, C.Z, !1) : "???", B = G && null != i.guild_id ? null == (t = R.Z.getGuild(i.guild_id)) ? void 0 : t.name : null, V = (null == i ? void 0 : i.parent_id) != null ? p.Z.getChannel(i.parent_id) : null, H = null != (n = null == V ? void 0 : V.name) ? n : null, K = null != (s = (0, _.KS)(i)) ? s : o.VL1, W = S.Z.can(U.Plq.MANAGE_MESSAGES, i), {
    content: q
  } = (0, I.ZP)({
    content: Z,
    embeds: []
