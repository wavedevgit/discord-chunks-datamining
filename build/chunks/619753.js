...
function D(e) {
  ...
  let {
    ...
    if (null == y || y(e, t), e.blocked) c.Z.show({
      ...
      body: R.intl.formatToPlainString(R.t["8t8doK"], {
        name: e.author.username
      }),
      confirmText: R.intl.string(R.t.BddRzc)
    });
    ...
    setFocus: U,
    onSelect: G
  }), H = P.Z.getQuery(l), V = P.Z.getSearchType(l) === w.aib.FAVORITES, z = (0, p.nC)(null != (t = null == H ? void 0 : H.content) ? t : ""), W = N.map(e => {
    let {
      channel: t,
      results: n,
      startIndex: i
    ...
    children: [(0, r.jsx)("div", L(M({
      ...
      children: [(0, r.jsx)("div", {
        ...
        children: E ? g > 0 && b > 0 ? R.intl.formatToPlainString(R.t["OvJs9/"], {
          ...
          count: b
        }) : g > 0 && b > 0 ? R.intl.formatToPlainString(R.t.EJHRcX, {
          count: g + b
        }) : g > 0 ? R.intl.formatToPlainString(R.t.HTE8JC, {
          count: g
...
function B(e) {
  ...
  }, []), H = null != o ? (0, f.F6)(o, N.default, S.Z, !1) : "???", V = D && null != o.guild_id ? null == (t = E.Z.getGuild(o.guild_id)) ? void 0 : t.name : null, z = (null == o ? void 0 : o.parent_id) != null ? O.Z.getChannel(o.parent_id) : null, W = null != (n = null == z ? void 0 : z.name) ? n : null, Y = null != (l = (0, m.KS)(o)) ? l : s.VL1, q = I.Z.can(w.Plq.MANAGE_MESSAGES, o), {
    content: K
  } = (0, y.ZP)({
    content: H,
    embeds: []
