...
function w(e) {
  ...
  }, []), Z = null != i ? (0, d.F6)(i, D.default, C.Z, !1) : "???", B = G && null != i.guild_id ? null == (t = R.Z.getGuild(i.guild_id)) ? void 0 : t.name : null, V = (null == i ? void 0 : i.parent_id) != null ? p.Z.getChannel(i.parent_id) : null, H = null != (n = null == V ? void 0 : V.name) ? n : null, K = null != (s = (0, _.KS)(i)) ? s : o.VL1, W = S.Z.can(x.Plq.MANAGE_MESSAGES, i), {
    content: q
  } = (0, I.ZP)({
    content: Z,
    embeds: []
  ...
  }), Y = l.useRef(null), [J, X] = l.useState(!1);
  l.useEffect(() => {
    let e = Y.current;
      ...
      children: [(0, r.jsx)(o.P3F, {
        ...
        children: (0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(K, {
            ...
            text: Z,
            shouldShow: J,
            children: e => (0, r.jsxs)("span", j(P({}, e), {
              ref: Y,
...
let G = l.memo(function(e) {
  ...
  let {
    ...
    return d.reduce((n, r) => {
      ...
      return null == s || ((null == e || e !== s.id) && n.push({
        ...
        results: [],
        startIndex: t
      }), t += 1, n[n.length - 1].results.push(r), e = null == s ? void 0 : s.id), n
    }, [])
  }, [d, y]), F = l.useRef([]), z = k.reduce((e, t) => e + 1 + t.results.length, 0), Z = l.useCallback((e, t) => {
    if (!E.Z.keyboardModeEnabled) return;
    let n = F.current,
      r = null != t ? n[t] : void 0;
    if (null == r || null == r.hitRef.current) return;
    let l = r.hitRef.current.getClientRects()[0];
    i(l.top - .5 * l.height, !1, () => {
      var t;
    ...
    setFocus: Z,
    onSelect: B
  }), H = (0, c.nC)(null != (t = null == R ? void 0 : R.content) ? t : ""), K = k.map(e => {
    let {
      channel: t,
      results: n,
      startIndex: l
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)("div", j(P({
      ref: W
    }, V.getContainerProps(), q), {
      "aria-busy": L,
      children: K
      ...
      children: [(0, r.jsx)("div", {
        ...
        children: y ? _ > 0 && A > 0 ? U.intl.formatToPlainString(U.t["OvJs9/"], {
          count: _ + A
        }) : _ > 0 ? U.intl.formatToPlainString(U.t["n/1QFR"], {
          count: _
        }) : U.intl.formatToPlainString(U.t.ypezTE, {
          count: A
        }) : _ > 0 && A > 0 ? U.intl.formatToPlainString(U.t.EJHRcX, {
          count: _ + A
        }) : _ > 0 ? U.intl.formatToPlainString(U.t.HTE8JC, {
          count: _
        }) : U.intl.formatToPlainString(U.t.e7f8r6, {
          count: A
        })
      })]
    }) : null, !L && !S && (0, r.jsx)(b.Z, {
      renderPageWrapper: N,
      onPageChange: T,
      offset: v,
