...
let m = e => {
  ...
  if (null != c && (t = p(c)), null != n && null == t && (t = n.getIconURL(_(b))), null == (t = (0, s.Z)(m, t)) && null != i) {
    let e = h(b);
    return <l.Z className={o()(d.gameIcon, E, g)} guild={i} size={e} />
  }
  if (null == t) return y ? <a.IMN size={"md"} color={"currentColor"} className={o()(d.gameIcon, b, g)} /> : null;
  let O = null == n ? true : n.name,
    v = null != O && "" !== O ? u.intl.formatToPlainString(u.t.tiKyYm, {
      applicationName: O
    }) : u.intl.string(u.t["2B/phI"]);
  return <img alt={v} src={t} className={o()(d.gameIcon, b, g)} />
};
m.Sizes = f;
let g = m