...
function v(e) {
  ...
  } = (0, g.Z)(v), T = (0, i.e7)([p.Z], () => p.Z.hidden), P = (0, i.e7)([c.Z], () => c.Z.isFocused()), N = (0, i.e7)([s.Z], () => s.Z.getChannel(v)), R = (0, i.e7)([o.Z], () => o.Z.getGuild(x), [x]), w = (0, h.E)(R), A = null != w && w && (null == N ? true : N.isForumChannel()) === false, [D, L, M, k] = r.useMemo(() => {
    let e;
  ...
  }, [v, S, C, t, x, E, n, j, T, A]), U = r.useRef(0), G = r.useRef(S), H = r.useRef(true), F = r.useRef({
    impressionCappedEntryIds: Z
  }), B = r.useCallback(e => {
    var t;
