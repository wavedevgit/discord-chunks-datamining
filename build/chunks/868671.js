...
function v(e) {
  ...
  } = (0, m.Z)(v), Z = (0, i.e7)([p.Z], () => p.Z.hidden), T = (0, i.e7)([c.Z], () => c.Z.isFocused()), A = (0, i.e7)([a.Z], () => a.Z.getChannel(v)), w = (0, i.e7)([s.Z], () => s.Z.getGuild(j), [j]), R = (0, h.E)(w), M = null != R && R && (null == A ? void 0 : A.isForumChannel()) === !1, [k, L, D, W] = r.useMemo(() => {
    let e;
  ...
  }, [v, I, O, t, j, N, n, x, Z, M, S]), U = r.useRef(0), B = r.useRef(I), H = r.useRef(), F = r.useRef({
    impressionCappedEntryIds: P
  }), G = r.useCallback(e => {
    var t;
