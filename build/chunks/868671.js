...
function x(e) {
  ...
  } = (0, g.Z)(x), T = (0, i.e7)([h.Z], () => h.Z.hidden), N = (0, i.e7)([c.Z], () => c.Z.isFocused()), w = (0, i.e7)([s.Z], () => s.Z.getChannel(x)), R = (0, i.e7)([o.Z], () => o.Z.getGuild(v), [v]), A = (0, p.E)(R), D = null != A && A && (null == w ? void 0 : w.isForumChannel()) === !1, [L, M, k, U] = r.useMemo(() => {
    let e;
  ...
  }, [x, I, C, t, v, Z, n, O, T, D, P]), G = r.useRef(0), F = r.useRef(I), B = r.useRef(void 0), H = r.useRef({
    impressionCappedEntryIds: S
  }), z = r.useCallback(e => {
    var t;
  ...
  }, [S]), r.useEffect(() => (G.current = 0, B.current = Date.now(), () => {
    var e, t;
    if (null == Z || null == B.current || Date.now() - B.current < 3e3) return;
    let n = null != (t = null == (e = F.current) ? void 0 : e.map(e => e.id)) ? t : [],
      r = n.slice(0, G.current);
    !T && N && D && ((0, f.e)(y.rMx.RANKING_ITEMS_SEEN_MUST_BE_SAMPLED, {
      request_id: Z,
