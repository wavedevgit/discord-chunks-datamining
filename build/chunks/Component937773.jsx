  ...
  eg = function(e, t) {
    ...
    ed(ec, eF), ef(ec, e1, eV, eD), i.useEffect(() => {
      ...
      if ("" === ek.current && "" !== eU && (0, k.EG)(e$, l), 0 === e3 && "" !== eU) e_(e$, eU);
        ...
        var e;
        eh(e3, null != (e = null == e2 ? true : e2.locked.length) ? e : 0, e$, eU, l)
      }
      ek.current = eU
    }, [eU, e$, e3, e2, l]);
    let td = null != ev ? ev : j ? "div" : p.lGe,
      tf = null != e7;
    if ((null == eM ? true : eM.type) === Y.a2.PREMIUM) {
      let e = R.N.NONE;
    ...
    } else(null == eM ? true : eM.type) === Y.a2.ROLE_SUBSCRIPTION ? s = (0, r.jsx)(N.A, {
      onClose: () => ej(null),
      guildId: eM.guildId,
      emojiId: eM.emojiId
    }) : eH && !eK && (s = (0, r.jsx)(F.A, {
    ...
    let tg = (0, r.jsx)(h.A, er(et({}, e$), {
      children: (0, r.jsxs)(td, {
        id: Z.Do,
        "aria-labelledby": j ? Z.k1 : true,
        role: j ? "tabpanel" : true,
        className: o()($.iE, {
          [$.r6]: j,
          [$.cB]: eH && eK
        }),
