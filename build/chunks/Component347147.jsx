...
let y = Chunk647438.memo(function(e) {
  ...
  let {
    ...
    mirror: P,
    paused: I
  } = x, [Z, T] = i.useState(false), [N, A] = i.useState(null), [w, M] = i.useState(null), [R, D] = i.useState(0), [k, L] = i.useState({
    x: 0,
    y: 0
  ...
  }, [ed, l, ec, ef]), eC = i.useCallback(e => {
    e.preventDefault(), e.stopPropagation(), ed(.25, {
      x: 0,
      y: 0
    })
  }, [ed]), ev = i.useCallback(e => {
  ...
  }, [H, eS]), eZ = i.useCallback(e => {
    e.preventDefault(), e.stopPropagation(), G(false)
  }, []), eT = i.useCallback(e => {
    e.preventDefault(), e.stopPropagation()
  }, []);
  (0, u.PM)(ei, i.useCallback(e => {
    let {
      width: t,
      height: n
    } = e;
