...
let m = e => {
  let {
    ...
    useRemSizes: m = false,
    children: g = []
  } = e, E = null, b = u.intl.string(u.t.g76OcH), y = t ? d.botTagInvert : d.botTagRegular;
  switch (n) {
    case c.Hb.SYSTEM_DM:
    case c.Hb.OFFICIAL:
      f = true, b = u.intl.string(u.t["7s687u"]), E = u.intl.string(u.t.lKQ7Wl);
      break;
    case c.Hb.SERVER:
    ...
    case c.Hb.NOT_STAFF_WARNING:
      ...
      break;
    case c.Hb.REMIX:
      f = false, E = u.intl.string(u.t.uXDG39);
      break;
    case c.Hb.BOT:
    default:
  ...
  let T = e => (0, r.jsxs)("span", h(_({}, e), {
    className: a()(i, y, m ? d.rem : d.px, {
      [d.botTagOP]: O,
      [d.botTagRemix]: v
    }),
    children: [p ? null : I, g, (0, r.jsx)("span", {
      className: d.botText,
      children: E
    })]
  }));
