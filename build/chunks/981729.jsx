...
let D = e => {
    ...
    return <g.W5 disablePointerEvents={h} targetRef={t} position={r} autoInvert={true} align={n} positionKey={O} spacing={_} nudgeAlignIntoViewport={true}>{e => {
        let {
          position: t,
          nudge: _
        } = e;
...
class j extends(r = Chunk73800.Component) {
  ...
  render() {
    ...
    return null != module && (Chunk120356["aria-label"] = module), <Chunk73800.Fragment>{exports(Chunk120356)}{true === this.props.targetElementRef && <span ref={this.siblingDomRef} style={{
          display: "none"
        }} />}{this.renderTooltip()}</Chunk73800.Fragment>
  }
  ...
  renderTooltip() {
    ...
    } = this.props, m = (Chunk873546.tq || Chunk873546.Em) && true === Chunk377527 && Chunk186325, g = false !== Chunk126663 && !Chunk607070 || true === Chunk126663, E = this.shouldShowTooltip(this.props, this.state) && this.hasDomElement, b = null;
    return b = module instanceof Function ? Chunk476767 ? module() : null : module, <k disableTooltipPointerEvents={Chunk314910} targetElementRef={this.domElementRef} tooltipStyle={s} tooltipClassName={Chunk120356} tooltipContentClassName={Chunk867309} tooltipPointerClassName={Chunk481060} align={exports} position={require} color={r} spacing={Chunk73800} isVisible={Chunk476767} onAnimationRest={Chunk374470} onNonAccessibleClick={Chunk607070 ? this.handleClick : true} allowOverflow={Chunk846519}>{b}</k>
  }
  show() {
    let {
      delay: e,
