    ...
    for (; e.pos < a;) {
      ...
      switch (t) {
        case 1:
          ...
          break;
        case 2:
          o.filters.push(p.internalBinaryRead(e, e.uint32(), n));
          break;
        case 3:
...
class _ extends Chunk495852.C {
    ...
    for (; e.pos < a;) {
      ...
      switch (t) {
        ...
        case 4:
          o.filter = {
            oneofKind: "staff",
            staff: m.internalBinaryRead(e, e.uint32(), n, o.filter.staff)
          };
          break;
        case 5:
          o.filter = {
        ...
        case 7:
          o.filter = {
            ...
            clientLocale: T.internalBinaryRead(e, e.uint32(), n, o.filter.clientLocale)
          };
          break;
        case 8:
          o.filter = {
        ...
        case 11:
          o.filter = {
            oneofKind: "bot",
            bot: ei.internalBinaryRead(e, e.uint32(), n, o.filter.bot)
          };
          break;
        case 12:
          o.filter = {
            oneofKind: "userAgeRange",
            userAgeRange: ea.internalBinaryRead(e, e.uint32(), n, o.filter.userAgeRange)
          };
          break;
        case 13:
          o.filter = {
            oneofKind: "userIdRange",
            userIdRange: eu.internalBinaryRead(e, e.uint32(), n, o.filter.userIdRange)
          };
          break;
        case 14:
          o.filter = {
            oneofKind: "userHasFlag",
            userHasFlag: ef.internalBinaryRead(e, e.uint32(), n, o.filter.userHasFlag)
          };
          break;
        case 15:
          o.filter = {
            oneofKind: "unitIdInRangeByHash",
            unitIdInRangeByHash: ep.internalBinaryRead(e, e.uint32(), n, o.filter.unitIdInRangeByHash)
          };
          break;
        case 16:
          o.filter = {
            oneofKind: "clientReleaseChannel",
            clientReleaseChannel: em.internalBinaryRead(e, e.uint32(), n, o.filter.clientReleaseChannel)
          };
          break;
        case 17:
          o.filter = {
            oneofKind: "always",
            always: eE.internalBinaryRead(e, e.uint32(), n, o.filter.always)
          };
          break;
        case 18:
          o.filter = {
            oneofKind: "clientSystemLocale",
            clientSystemLocale: A.internalBinaryRead(e, e.uint32(), n, o.filter.clientSystemLocale)
          };
          break;
        case 19:
          o.filter = {
            oneofKind: "unitIdInExperiment",
            unitIdInExperiment: ey.internalBinaryRead(e, e.uint32(), n, o.filter.unitIdInExperiment)
          };
          break;
        default:
          let a = n.readUnknownField;
  ...
  internalBinaryWrite(e, t, n) {
    "clientVersion" === e.filter.oneofKind && z.internalBinaryWrite(e.filter.clientVersion, t.tag(2, r.TD.LengthDelimited).fork(), n).join(), "clientOs" === e.filter.oneofKind && U.internalBinaryWrite(e.filter.clientOs, t.tag(3, r.TD.LengthDelimited).fork(), n).join(), "staff" === e.filter.oneofKind && m.internalBinaryWrite(e.filter.staff, t.tag(4, r.TD.LengthDelimited).fork(), n).join(), "userInGuild" === e.filter.oneofKind && E.internalBinaryWrite(e.filter.userInGuild, t.tag(5, r.TD.LengthDelimited).fork(), n).join(), "userIds" === e.filter.oneofKind && y.internalBinaryWrite(e.filter.userIds, t.tag(6, r.TD.LengthDelimited).fork(), n).join(), "clientLocale" === e.filter.oneofKind && T.internalBinaryWrite(e.filter.clientLocale, t.tag(7, r.TD.LengthDelimited).fork(), n).join(), "clientLocation" === e.filter.oneofKind && N.internalBinaryWrite(e.filter.clientLocation, t.tag(8, r.TD.LengthDelimited).fork(), n).join(), "clientIp" === e.filter.oneofKind && M.internalBinaryWrite(e.filter.clientIp, t.tag(9, r.TD.LengthDelimited).fork(), n).join(), "userLocale" === e.filter.oneofKind && v.internalBinaryWrite(e.filter.userLocale, t.tag(10, r.TD.LengthDelimited).fork(), n).join(), "bot" === e.filter.oneofKind && ei.internalBinaryWrite(e.filter.bot, t.tag(11, r.TD.LengthDelimited).fork(), n).join(), "userAgeRange" === e.filter.oneofKind && ea.internalBinaryWrite(e.filter.userAgeRange, t.tag(12, r.TD.LengthDelimited).fork(), n).join(), "userIdRange" === e.filter.oneofKind && eu.internalBinaryWrite(e.filter.userIdRange, t.tag(13, r.TD.LengthDelimited).fork(), n).join(), "userHasFlag" === e.filter.oneofKind && ef.internalBinaryWrite(e.filter.userHasFlag, t.tag(14, r.TD.LengthDelimited).fork(), n).join(), "unitIdInRangeByHash" === e.filter.oneofKind && ep.internalBinaryWrite(e.filter.unitIdInRangeByHash, t.tag(15, r.TD.LengthDelimited).fork(), n).join(), "clientReleaseChannel" === e.filter.oneofKind && em.internalBinaryWrite(e.filter.clientReleaseChannel, t.tag(16, r.TD.LengthDelimited).fork(), n).join(), "always" === e.filter.oneofKind && eE.internalBinaryWrite(e.filter.always, t.tag(17, r.TD.LengthDelimited).fork(), n).join(), "clientSystemLocale" === e.filter.oneofKind && A.internalBinaryWrite(e.filter.clientSystemLocale, t.tag(18, r.TD.LengthDelimited).fork(), n).join(), "unitIdInExperiment" === e.filter.oneofKind && ey.internalBinaryWrite(e.filter.unitIdInExperiment, t.tag(19, r.TD.LengthDelimited).fork(), n).join();
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
    ...
    for (; e.pos < a;) {
      ...
      switch (t) {
        ...
        case 3:
          o.location = {
            oneofKind: "place",
            place: P.internalBinaryRead(e, e.uint32(), n, o.location.place)
          };
          break;
        default:
          let a = n.readUnknownField;
...
class k extends Chunk495852.C {
  ...
  internalBinaryRead(e, t, n, i) {
    ...
    for (; e.pos < a;) {
      ...
      switch (t) {
        case 1:
          o.iosVersion = B.internalBinaryRead(e, e.uint32(), n, o.iosVersion);
          break;
        case 2:
          o.androidVersion = B.internalBinaryRead(e, e.uint32(), n, o.androidVersion);
          break;
        case 3:
          o.macosVersion = B.internalBinaryRead(e, e.uint32(), n, o.macosVersion);
          break;
        case 4:
          o.windowsVersion = B.internalBinaryRead(e, e.uint32(), n, o.windowsVersion);
          break;
        case 5:
          o.playstationVersion = B.internalBinaryRead(e, e.uint32(), n, o.playstationVersion);
          break;
        case 6:
          o.xboxVersion = B.internalBinaryRead(e, e.uint32(), n, o.xboxVersion);
          break;
        case 7:
          o.linuxVersion = B.internalBinaryRead(e, e.uint32(), n, o.linuxVersion);
          break;
        default:
          let a = n.readUnknownField;
          if ("throw" === a) throw new globalThis.Error("Unknown field ".concat(t, " (wire type ").concat(i, ") for ").concat(this.typeName));
...
class G extends Chunk495852.C {
  ...
  internalBinaryRead(e, t, n, i) {
    ...
    for (; e.pos < a;) {
      ...
      switch (t) {
        case 1:
          o.ranges.push(F.internalBinaryRead(e, e.uint32(), n));
          break;
        case 2:
...
class K extends Chunk495852.C {
  ...
  internalBinaryRead(e, t, n, i) {
    ...
    for (; e.pos < a;) {
      ...
      switch (t) {
        case 1:
          o.iosVersion = X.internalBinaryRead(e, e.uint32(), n, o.iosVersion);
          break;
        case 2:
          o.androidVersion = X.internalBinaryRead(e, e.uint32(), n, o.androidVersion);
          break;
        case 3:
          o.webVersion = X.internalBinaryRead(e, e.uint32(), n, o.webVersion);
          break;
        case 4:
          o.nativeVersion = X.internalBinaryRead(e, e.uint32(), n, o.nativeVersion);
          break;
        default:
          let a = n.readUnknownField;
          if ("throw" === a) throw new globalThis.Error("Unknown field ".concat(t, " (wire type ").concat(i, ") for ").concat(this.typeName));
...
class ec extends Chunk495852.C {
  ...
  internalBinaryRead(e, t, n, i) {
    ...
    for (; e.pos < a;) {
      ...
      switch (t) {
        case 1:
          o.minId = el.internalBinaryRead(e, e.uint32(), n, o.minId);
          break;
        case 2:
          o.maxId = el.internalBinaryRead(e, e.uint32(), n, o.maxId);
          break;
        default:
          let a = n.readUnknownField;
          if ("throw" === a) throw new globalThis.Error("Unknown field ".concat(t, " (wire type ").concat(i, ") for ").concat(this.typeName));
