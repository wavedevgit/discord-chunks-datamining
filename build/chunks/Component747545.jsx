...
function S() {
  let [e, t] = i.useState(false), n = (0, a.e7)([h.Z], () => h.Z.isMediaFilterSettingLoading());
  return (i.useEffect(() => {
    let e = new o.V7;
...
function I(e) {
  let {
    ...
    id: P
  } = (0, d.p6)(y.h7.VIDEO_INPUT), w = (0, a.e7)([h.Z], () => h.Z.isVideoAvailable()), R = p.qF.useSetting();
  return (0, r.jsxs)(s.Kqy, {
    gap: 20,
    children: [T(P), h.Z.isEnabled() ? null : (0, r.jsx)(s.Text, {
      ...
      checked: R,
      onChange: e => {
        p.qF.updateSetting(e), m.default.track(E.rMx.UPDATE_USER_SETTINGS_LOCAL, {
      ...
      children: (0, r.jsx)(u.j, {
        ...
        helperText: !i && (0, g.O)() ? O.intl.format(O.t.aJYgRt, {
          onCameraSettingsClick: () => {
            null == A || A(), window.open((0, g.u)(P)), m.default.track(E.rMx.SYSTEM_CAMERA_SETTINGS_OPENED, {
              location_stack: N
            })
          }
        }) : true,
