...
class j extends r.PureComponent {
  ...
  renderTabBar() {
    let {
      selectedSection: e
    } = this.state, t = d.Z.isDeveloper ? (0, i.jsx)(l.njP.Item, {
      id: "DEVELOPER",
  ...
  renderGeneralSettings() {
    ...
    } = this.props, a = !y.Z.isNotificationDisabled(g.OverlayNotificationDisabledSetting.TEXT_CHAT), d = e !== O._vf.DISABLED;
