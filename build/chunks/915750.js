...
class C {
  ...
  constructor({
    ...
    minViewTimeSeconds: c = S,
    isQuestEnrollmentBlocked: f
  }) {
    var O = this;
    b(this, "id", void 0), b(this, "quests", void 0), b(this, "questContent", void 0), b(this, "triggeredByStatusChange", void 0), b(this, "trackGuildAndChannelMetadata", void 0), b(this, "questContentPosition", void 0), b(this, "questContentRowIndex", void 0), b(this, "adDecisionData", void 0), b(this, "heartbeatTimeoutId", void 0), b(this, "lastBeatTime", void 0), b(this, "minViewTimeReachedTimeoutId", void 0), b(this, "minViewTimeSeconds", void 0), b(this, "minViewportPercentage", void 0), b(this, "isQuestEnrollmentBlocked", void 0), b(this, "isRunning", !1), b(this, "onMinViewTimeReached", () => {
    ...
    }), b(this, "commonProperties", e => y(v(y({
      impression_id: this.id
    }, this.adDecisionData), {
      is_quest_enrollment_blocked: this.isQuestEnrollmentBlocked,
      quest_status: (0, d.uk)(e)
    }), (0, d.mH)(this.questContent, this.questContentPosition, this.questContentRowIndex))), b(this, "clone", e => {
      let {
        triggeredByStatusChange: t
      } = e;
      return this.stop(), new C({
      ...
      this.stop(!1), this.lastBeatTime = Date.now(), this.heartbeatTimeoutId = window.setInterval(() => this.beat(), 1e3 * I), this.minViewTimeReachedTimeoutId = window.setTimeout(this.onMinViewTimeReached, 1e3 * this.minViewTimeSeconds), this.quests.forEach(e => {
        (0, m.T)().info("".concat(e.config.messages.questName, " Quest became visible at ").concat((0, d._b)(this.questContent)), {
          impressionId: this.id
        }), (0, d.dA)({
          questId: e.id,
      ...
      }), (0, h.a)("QuestImpressionTracker") && u.Z.increment({
    ...
    }), this.id = (0, a.Z)(), this.adDecisionData = null != n ? n : g.Jp, this.questContent = t, this.questContentPosition = s, this.minViewTimeSeconds = c, this.minViewportPercentage = T, this.quests = Array.isArray(e) ? e : [e], this.trackGuildAndChannelMetadata = i, this.triggeredByStatusChange = r, this.questContentRowIndex = l, this.isQuestEnrollmentBlocked = f
  }
}
let P = (e, t) => {
...
function x(e) {
  let {
    ...
    reference: o,
    focusedChanged: c
  } = e, u = R(e.questOrQuests), d = (0, f.KZ)(e.questContent), p = i.useRef(null), h = (0, s.e7)([_.Z], () => null != _.Z.questEnrollmentBlockedUntil, []);
  return (0, l.ZP)(() => () => {
    ...
    let r = a && t,
      i = (n || c || u) && r,
      o = (n || c) && !r || u;
    (i || o) && null != p.current && p.current.stop(), i && (p.current = new C({
      adDecisionData: d,
  ...
  }, [a, t, c, n, e.questOrQuests, e.questContent, e.questContentPosition, e.questContentRowIndex, e.trackGuildAndChannelMetadata, u, e.minViewTimeSeconds, d, h]), (0, r.jsx)(w.Provider, {
    value: p,
