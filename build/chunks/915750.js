...
n.d(t, {
  ...
  aM: () => V,
  ui: () => F
}), n(388685), n(953529), n(49124), n(642613), n(415506);
var r = n(255367),
  i = n(73800),
  a = n(772848),
  o = n(286379),
...
class k {
  ...
  getBrandSafetyContext() {
    ...
    let d = (null == l ? void 0 : l.banner) !== null && (null == l ? void 0 : l.banner) !== void 0 && null != (e = g.ZP.getGuildBannerURL({
      id: l.id,
      banner: l.banner
    }, !0)) ? e : null;
    return null !== d && (u.selected_guild_banner_url = d), u.guilds.length > P && (u.guilds = u.guilds.slice(0, P), u.truncated = !0), u.channels.length > P && (u.channels = u.channels.slice(0, P), u.truncated = !0), {
  ...
  constructor({
    ...
    A(this, "id", void 0), A(this, "quests", void 0), A(this, "questContent", void 0), A(this, "triggeredByStatusChange", void 0), A(this, "trackGuildAndChannelMetadata", void 0), A(this, "questContentPosition", void 0), A(this, "questContentRowIndex", void 0), A(this, "sourceQuestContent", void 0), A(this, "heartbeatTimeoutId", void 0), A(this, "lastBeatTime", void 0), A(this, "minViewTimeReachedTimeoutId", void 0), A(this, "minViewTimeSeconds", void 0), A(this, "minViewportPercentage", void 0), A(this, "isQuestEnrollmentBlocked", void 0), A(this, "isRunning", !1), A(this, "onMinViewTimeReached", () => {
      this.quests.forEach(e => {
        ...
        (0, u.S)().then(n => {
          null != n && ((0, E.isIOS)() ? r.apple_advertising_id = n.advertisingId : (0, E.isAndroid)() && (r.android_advertising_id = n.advertisingId)), (0, b.dA)({
            questId: e.id,
    ...
    }), A(this, "commonProperties", e => N(R(N({
      impression_id: this.id
    }, (0, y.qe)(e.id, this.questContent)), {
      ...
      this.stop(!1), this.lastBeatTime = Date.now(), this.heartbeatTimeoutId = window.setInterval(() => this.beat(), 1e3 * w), this.minViewTimeReachedTimeoutId = window.setTimeout(this.onMinViewTimeReached, 1e3 * this.minViewTimeSeconds), this.quests.forEach(e => {
...
function F(e) {
  ...
  } = e, d = U(e.questOrQuests), f = i.useRef(null), _ = (0, s.e7)([O.Z], () => null != O.Z.questEnrollmentBlockedUntil, []);
  return (0, l.ZP)(() => () => {
    ...
    let r = a && t,
      i = (n || c || d) && r,
      o = (n || c) && !r || d;
    (i || o) && null != f.current && f.current.stop(), i && (f.current = new k({
  ...
  }, [a, t, c, n, e.questOrQuests, e.questContent, e.questContentPosition, e.questContentRowIndex, e.trackGuildAndChannelMetadata, d, e.minViewTimeSeconds, _, u]), (0, r.jsx)(G.Provider, {
    value: f,
