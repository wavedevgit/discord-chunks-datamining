...
class k {
  ...
  getBrandSafetyContext() {
    ...
    let c = (null == o ? void 0 : o.banner) !== null && (null == o ? void 0 : o.banner) !== void 0 && null != (e = g.ZP.getGuildBannerURL({
      id: o.id,
      banner: o.banner
    }, !0)) ? e : null;
    return null !== c && (l.selected_guild_banner_url = c), l.guilds.length > R && (l.guilds = l.guilds.slice(0, R), l.truncated = !0), l.channels.length > R && (l.channels = l.channels.slice(0, R), l.truncated = !0), {
  ...
  constructor({
    ...
    S(this, "id", void 0), S(this, "quests", void 0), S(this, "questContent", void 0), S(this, "triggeredByStatusChange", void 0), S(this, "trackGuildAndChannelMetadata", void 0), S(this, "questContentPosition", void 0), S(this, "questContentRowIndex", void 0), S(this, "sourceQuestContent", void 0), S(this, "heartbeatTimeoutId", void 0), S(this, "lastBeatTime", void 0), S(this, "minViewTimeReachedTimeoutId", void 0), S(this, "minViewTimeSeconds", void 0), S(this, "minViewportPercentage", void 0), S(this, "isQuestEnrollmentBlocked", void 0), S(this, "isRunning", !1), S(this, "onMinViewTimeReached", () => {
      this.quests.forEach(e => {
        (0, I.T)().info("".concat(e.config.messages.questName, " Quest viewed for at least ").concat(this.minViewTimeSeconds, "s at ").concat((0, b._b)(this.questContent)), {
      ...
      p.quests.forEach(t => {
        if (null != p.lastBeatTime) {
          ...
          (0, I.T)().info("".concat(t.config.messages.questName, " Quest impression ").concat(e ? "terminal " : "", "heartbeat: ").concat(n, "ms since last heartbeat"), {
            impressionId: p.id
          }), (0, b.dA)({
            questId: t.id,
    ...
    }), S(this, "commonProperties", e => A(C(A({
      impression_id: this.id
    }, (0, y.qe)(e.id, this.questContent)), {
      is_quest_enrollment_blocked: this.isQuestEnrollmentBlocked,
      quest_status: (0, b.uk)(e)
    }), (0, b.mH)(this.questContent, this.questContentPosition, this.questContentRowIndex))), S(this, "clone", e => {
      let {
      ...
      this.stop(!1), this.lastBeatTime = Date.now(), this.heartbeatTimeoutId = window.setInterval(() => this.beat(), 1e3 * P), this.minViewTimeReachedTimeoutId = window.setTimeout(this.onMinViewTimeReached, 1e3 * this.minViewTimeSeconds), this.quests.forEach(e => {
        (0, I.T)().info("".concat(e.config.messages.questName, " Quest became visible at ").concat((0, b._b)(this.questContent)), {
          impressionId: this.id
        }), (0, b.dA)({
          questId: e.id,
