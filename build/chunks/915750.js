...
class x {
  ...
  getBrandSafetyContext() {
    ...
    let a = () => {
        ...
        return e.map(e => {
          ...
          let o = null !== r.icon && null != (n = g.ZP.getGuildIconURL({
            id: r.id,
            icon: r.icon,
            size: 44,
            canAnimate: !0
    ...
    return null !== d && (u.selected_guild_banner_url = d), u.guilds.length > C && (u.guilds = u.guilds.slice(0, C), u.truncated = !0), u.channels.length > C && (u.channels = u.channels.slice(0, C), u.truncated = !0), {
  ...
  constructor({
    ...
    A(this, "id", void 0), A(this, "quests", void 0), A(this, "questContent", void 0), A(this, "triggeredByStatusChange", void 0), A(this, "trackGuildAndChannelMetadata", void 0), A(this, "questContentPosition", void 0), A(this, "questContentRowIndex", void 0), A(this, "sourceQuestContent", void 0), A(this, "heartbeatTimeoutId", void 0), A(this, "lastBeatTime", void 0), A(this, "minViewTimeReachedTimeoutId", void 0), A(this, "minViewTimeSeconds", void 0), A(this, "minViewportPercentage", void 0), A(this, "isQuestEnrollmentBlocked", void 0), A(this, "isRunning", !1), A(this, "onMinViewTimeReached", () => {
      ...
      this.stop(!1), this.lastBeatTime = Date.now(), this.heartbeatTimeoutId = window.setInterval(() => this.beat(), 1e3 * R), this.minViewTimeReachedTimeoutId = window.setTimeout(this.onMinViewTimeReached, 1e3 * this.minViewTimeSeconds), this.quests.forEach(e => {
...
function B(e) {
  ...
  return (0, l.ZP)(() => () => {
    ...
    let r = o && t,
      i = (n || c || d) && r,
      a = (n || c) && !r || d;
    (i || a) && null != f.current && f.current.stop(), i && (f.current = new x({
  ...
  }, [o, t, c, n, e.questOrQuests, e.questContent, e.questContentPosition, e.questContentRowIndex, e.trackGuildAndChannelMetadata, d, e.minViewTimeSeconds, _, u]), (0, r.jsx)(j.Provider, {
    value: f,
