...
function y(e) {
  let {
    current: t,
    duration: n
  } = e, l = null != t ? (0, b.yv)(t) : C, o = null != n ? (0, b.yv)(n) : C;
...
function x(e) {
  ...
  let {
    ...
    null != o.current && (0 === z ? (el(Z), q(false), V(Z)) : (B(z), el(0), q(true), V(0)))
  }, [o, z, el, Z, q, B, V]), ei = () => {
    X(true)
  }, ea = () => {
    X(false)
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(j, {
          ...
          children: (0, r.jsx)(u.i, {
            ...
            maxValue: 1,
            onValueChange: e => {
              el(e), B(e), V(e), $ && (J(false), M(false)), F && e > 0 && q(false)
            },
            asValueChanges: e => {
              el(e), $ || (J(true), M(true))
            },
