...
let I = (e, t, n) => {
  ...
  S = e => {
    ...
    return null == A ? null : <b.yR>{<b.wG channel={t} entry={n} userDescription={(0, _.kr)(n) ? v.t["LH+Z39"] : v.t.YuKgmp} title={n.extra.media_title} subtitle={n.extra.media_subtitle} headerIcons={(0, r.jsx)(y.Z, {
          onClick: w,
          Icon: a.omf,
        ...
        })} onClickTitle={x} onClickThumbnail={x} />}{<b.St><b.WT onReaction={u} onVoiceChannelPreview={S} user={A} channel={t} generateReactionImage={L} reactionImageAltText={T(n, A)} entry={n} /></b.St>}</b.yR>
  }