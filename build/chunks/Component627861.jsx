...
function es(e) {
  ...
  let {
    ...
    presenceActivity: h
  } = e, E = (0, K.g)(u, h), C = (0, S.Lz)(h, p.author, "Invite Embed"), v = !(0, J.Z)(h, p, c.id), O = i.useMemo(() => {
    let e = [];
    if (!E) {
      var t;
      e.push({
...
function ed(e) {
  ...
  let {
    ...
    videoBannerSrc: k,
    bannerAspectRatio: F
  } = (0, _.E)(y), G = !(0, J.Z)(A, T, y.id), W = (0, Y.H)(T), X = (0, o.e7)([w.Z], () => w.Z.getGameByName(y.name), [y.name]), {
  ...
  } : null != es ? es : true, [v, ed, ef, ep, x.id, x.guild_id, j, em, T.author.id, T.id, A, es]), e_ = i.useMemo(() => et ? {
  ...
  }, [e_, G, eg]), eC = (0, H.dQ)(y.name, null == (t = T.activity) ? true : t.type), ev = (0, O.N)(y.id).some(e => (0, E.ig)(e) === l.o.GLOBAL) ? (0, r.jsxs)(r.Fragment, {
...
function ep(e) {
  ...
  let {
    ...
    hideParty: d,
    onView: p
  } = e, m = (0, g.O)(s), f = (0, o.e7)([P.default], () => P.default.getId()), _ = (0, o.e7)([D.Z], () => {
    ...
    partySize: E,
    maxPartySize: C
  } = (0, X._)(_), v = i.useMemo(() => b.map(e => {
    let t = M.default.getUser(e);
    return null != t ? t : et.ag
  }), [b]), O = (0, ei.Ps)(null == _ || null == (t = _.party) ? true : t.id) || m.id === T.r9.id, y = (0, r.jsx)(eo, {
    partyMembers: v,
    partySize: E,
    maxPartySize: C,
    guildId: c.guild_id,
