...
function em(e) {
  ...
  let {
    ...
    isGameLaunchable: em
  }), eO = ef(x, R, w, A), ev = (0, z.g)(R, x), eI = (0, Y.L)(x, w, A, N), eT = (0, l.e7)([j.Z], () => null != x && null != x.application_id && j.Z.getState(x.application_id, ei.mFx.JOIN) === ei.OcF.LOADING), eS = i.useMemo(() => eb ? {
