...
class p extends r.EventEmitter {
  updateProps(e) {
    ...
    if (this.props = e, n || r) this.updateResults(r, n), this.state.didInitialQuery || (this.state = _(u({}, this.state), {
      didInitialQuery: !0
    }));
    else if (t) {
  ...
  updateResults() {
    ...
    let {
      ...
      typeInfo: _,
      query: f
    } = c, p = r || n && ((null == (e = this.state.query) ? void 0 : e.queryText) !== f || (null == (t = this.state.query) ? void 0 : t.typeInfo) !== _), h = o.fq.getSetting();
    ...
    let {
      results: g,
      metadata: E
    } = _.queryResults(this.props.channel, this.props.guild, f, i, p), b = 0;
