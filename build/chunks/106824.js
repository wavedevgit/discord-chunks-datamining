...
class m extends r.EventEmitter {
  updateProps(e) {
    ...
    if (this.props = e, n || r) this.updateResults(r, n), this.state.didInitialQuery || (this.state = f(d({}, this.state), {
      didInitialQuery: !0
    }));
    else if (t) {
  ...
  updateResults() {
    ...
    let {
      ...
      typeInfo: g,
      query: E
    } = f, b = u || i && ((null == (e = this.state.query) ? void 0 : e.queryText) !== E || (null == (t = this.state.query) ? void 0 : t.typeInfo) !== g), y = s.fq.getSetting();
    ...
    !A || S ? N = null : null != N && N >= T && (N = T - 1), A && !this.state.isVisible && (0, a.a7)(m, this.props.channel, I), this.setState({
      query: {
        type: m,
        typeInfo: g,
        queryText: E,
  ...
  selectResult(e, t, n) {
    ...
    if (e >= d) return !1;
    let f = null == (i = c.onSelect) ? void 0 : i.call(c, {
      results: u,
      index: e,
