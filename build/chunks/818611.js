...
let I = 3,
  ...
  C = e => {
    ...
    return (0, r.jsx)(l.P3F, y(E({
      className: o()(m.decorationGridItem, a ? m.selected : void 0, n)
    }, s), {
      onClick: i,
      children: t
    }))
  ...
  P = e => {
    let {
      ...
      onSelect: o,
      onOpenShop: c
    } = e, u = (0, f.ZP)(), p = d.ZP.canUseCollectibles(t), g = (e, d, g, b) => {
      let {
        section: y,
        items: O
      } = u[e];
      return (0, s.EQ)(O[d]).with(f.Tm, () => (0, r.jsxs)(C, {
        style: E({}, g),
        isSelected: null === i,
        onSelect: () => o(null),
