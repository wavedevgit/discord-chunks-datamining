  ...
  return (() => {
    var e = {
        ...
        848: e => {
          ...
          e.exports = function(e) {
            ...
            ! function() {
              ...
              i.prototype.rate = 0, i.prototype.targetRate = 0, i.prototype.channels = 0, i.prototype.bufferSize = 0, Object.defineProperty(i.prototype, "bufferDuration", {
                ...
                for (var p = 0; p < i; p++) {
                  ...
                  a(m, h, this._resampleLastSampleData ? this._resampleLastSampleData[_] : true, f), o.push(h)
                }
            ...
            ! function() {
              ...
              }), a.prototype._muted = false, Object.defineProperty(a.prototype, "muted", {
                get: function() {
                  return this._muted
                },
                set: function(e) {
              ...
              return function(e) {
                ...
                r = n(0), i = n(2), e.exports = function(e) {
                  var t = (e = e || {}).sampleRate || 44100,
                    ...
                    c = 1 << n - 2;
                  c -= c % 100;
                  for (var u = r.float_array(s + c + 5), d = r.float_array(s + c + 5), f = c, p = c, _ = r.float_array(s), m = 0; m < s; m++) _[m] = .5 * (1 - Math.cos(2 * Math.PI * m / s));
                  var h = 1 + (s >> 1),
                    g = r.float_array(h),
                    E = r.float_array(h),
                    b = r.float_array(h),
                    ...
                    A = [],
                    N = [];
                  for (m = 0; m < 2; m++) T.push(r.float_array(S)), C.push(r.float_array(S)), A.push(r.float_array(S)), N.push(r.float_array(h));
                  var P = r.float_array(S),
                    ...
                    B = {
                      ...
                      flush: function(e) {
                        ...
                        if (e) {
                          w = Math.max(0, w - e), D = B.mapOutputToInputTime(w);
                  ...
                  var F = function(e, t, n) {
                    ...
                    H = function(e, t, n, r, i, a) {
                      for (var l = e % 2, c = 1 - l, u = N[c], d = I[c], f = T[c], p = C[c], _ = A[c], m = N[l], h = 1; h < m.length; h++) m[h] = t[h] * t[h] + n[h] * n[h];
                      var g = T[l],
                        E = I[l] = function(e, t) {
                      ...
                      if (0 != e && 0 != E) {
                        ...
                        for (G = 0; G < E; G++) {
                          ...
                          var S = Z * o;
                          if (Math.abs(f[v] - Z) < S && u[Math.round(f[v])] > .1 * m[Math.round(Z)]) {
                            var D = F(t, n, Z),
                              w = p[v] + _[v] + V(D, Z, p[v], f[v], a) - D;
                            b[G] = D, y[G] = w, P[G] = Math.cos(w), R[G] = Math.sin(w)
                          } else b[G] = F(t, n, Z), y[G] = 0, P[G] = 1, R[G] = 0
                        }
                        g[E] = 2 * s;
                        var x = g[v = 0],
                          L = g[v + 1],
                        ...
                        for (h = 1; h < t.length - 1; h++) {
                          h >= x && h - x > L - h && (x = g[++v], L = g[v + 1], j = P[v], M = R[v]);
                          var k = t[h] * j - n[h] * M,
                            U = t[h] * M + n[h] * j;
                          t[h] = k, n[h] = U
                        }
                    ...
                    Y = function() {
                      ...
                      r.blit(u, 2 * f, u, 0, s - f), l.inplace(false), l.unpack(g, E, b, y), H(L, g, E, 0, 0, p / f), H(L + 1, b, y, 0, 0, (p + e) / f), r.blit(b, 0, O, 0, h), r.blit(y, 0, v, 0, h), l.repack(g, E, b, y), l.inplace(true);
                      var n = d.length;
                  ...
                  return B.process = function(e) {
                    ...
                    if (1 == a) {
                      if (Z + G > 0) {
                        ...
                        for (l = 0; l < e.length; l++) {
                          ...
                          r.blit(d, 0, h, 0, Z), r.blit(u, 0, h, Z, G), r.blit(e[l], 0, h, Z + G, n), m.push(h)
                        }
                        B.flush(0), n = _, e = m
                      }
                    ...
                    for (var y = 0, O = Z, v = 0, S = 0;;) {
                      ...
                      I <= 0 ? G -= 2 * f : (r.blit(i, y, u, G, I), y += I, G = s - f), S = Y(), D += 2 * f / t, w += S / t, (v = O + S - E) < 0 && (v = 0), r.blit(d, 0, b, O, S - v), O += S
                    }
                ...
                e.exports = function(e) {
                  ...
                  n.inplace = function(e) {
                    ...
                    for (var d = 0; d < a; d++) {
                      ...
                      e || (p *= false);
                      for (var _ = 0; _ < i;) {
                        for (var m = _, h = _ + s, g = 1, E = 0, b = 0; b < o; b++) {
                          var y = t[m],
                            O = r[m],
                            v = t[h],
                            S = r[h];
                          t[m] = y + v, r[m] = O + S, v = y - v, S = O - S, t[h] = v * g - S * E, r[h] = v * E + S * g, m++, h++;
                          var I = g;
                          g = g * f - E * p, E = I * p + E * f
                        }
                        _ += l
                    ...
                    for (var T, C, A = n.m_revTgt, N = 0; N < i; N++) A[N] > N && (C = t[T = A[N]], t[T] = t[N], t[N] = C, C = r[T], r[T] = r[N], r[N] = C)
                  };
                  var d = t >> 1;
                ...
                value: function(e, t) {
                  ...
                  if (s.match(/^https?:|\/\//i)) {
                    var c, u, d, f, p, g = function() {
                        if (1 == E && 1 == b) {
                          var e = d + " " + f + "\nOGVLoader.base = " + JSON.stringify(h.base);
                          try {
                            p = new Blob([e], {
                      ...
                      E = false,
                      b = false;
                    (c = new XMLHttpRequest).open("GET", o, true), c.onreadystatechange = function() {
        ...
        869: (e, t, n) => {
          ...
          S = "undefined" == typeof performance || true === (0, u.default)(performance.now) ? Date.now : performance.now.bind(performance), Z.prototype = Object.create(HTMLElement.prototype, {});
          var B = function(e) {
            (0, s.default)(n, e);
            var t = v(n);
            ...
            function n(e) {
              ...
              return r._enableThreading = !!e.threading, r._enableSIMD = !!e.simd, r._state = C, r._seekState = L, r._detectedType = null, r._canvas = document.createElement("canvas"), r._frameSink = null, r.className = r._instanceId, (0, h.default)((0, o.default)(r), T), r._view = r._canvas, r._view.style.position = "absolute", r._view.style.top = "0", r._view.style.left = "0", r._view.style.width = "100%", r._view.style.height = "100%", r._view.style.objectFit = "contain", r.appendChild(r._view), r._startTime = S(), r._codec = null, r._audioInfo = null, r._videoInfo = null, r._actionQueue = [], r._audioFeeder = null, r._muted = false, r._initialPlaybackPosition = 0, r._initialPlaybackOffset = 0, r._prebufferingAudio = false, r._initialSeekTime = 0, r._currentSrc = "", r._crossOrigin = null, r._streamEnded = false, r._mediaError = null, r._dataEnded = false, r._byteLength = 0, r._duration = null, r._lastSeenTimestamp = null, r._nextProcessingTimer, r._nextFrameTimer = null, r._loading = false, r._started = false, r._paused = true, r._ended = false, r._startedPlaybackInDocument = false, r._stream = true, r._framesProcessed = 0, r._targetPerFrameTime = 1e3 / 60, r._actualPerFrameTime = 0, r._totalFrameTime = 0, r._totalFrameCount = 0, r._playTime = 0, r._bufferTime = 0, r._drawingTime = 0, r._proxyTime = 0, r._totalJitter = 0, r._droppedAudio = 0, r._delayedAudio = 0, r._lateFrames = 0, r._poster = "", r._thumbnail = null, r._frameEndTimestamp = 0, r._audioEndTimestamp = 0, r._decodedFrames = [], r._pendingFrames = [], r._lastFrameDecodeTime = 0, r._lastFrameVideoCpuTime = 0, r._lastFrameAudioCpuTime = 0, r._lastFrameDemuxerCpuTime = 0, r._lastFrameDrawingTime = 0, r._lastFrameBufferTime = 0, r._lastFrameProxyTime = 0, r._lastVideoCpuTime = 0, r._lastAudioCpuTime = 0, r._lastDemuxerCpuTime = 0, r._lastBufferTime = 0, r._lastProxyTime = 0, r._lastDrawingTime = 0, r._lastFrameTimestamp = 0, r._currentVideoCpuTime = 0, r._lastTimeUpdate = 0, r._timeUpdateInterval = 250, r._seekTargetTime = 0, r._bisectTargetTime = 0, r._seekMode = null, r._lastSeekPosition = null, r._seekBisector = null, r._didSeek = null, r._depth = 0, r._needProcessing = false, r._pendingFrame = 0, r._pendingAudio = 0, r._framePipelineDepth = 8, r._frameParallelism = r._enableThreading ? Math.min(16, navigator.hardwareConcurrency) || 1 : 0, r._audioPipelineDepth = 12, r._videoInfo = null, r._audioInfo = null, r._width = 0, r._height = 0, r._volume = 1, r._playbackRate = 1, Object.defineProperties((0, o.default)(r), {
                ...
                seekable: {
                  get: function() {
                    return new b.default(this.duration < 1 / 0 && this._stream && this._stream.seekable && this._codec && this._codec.seekable ? [
                      [0, this._duration]
                    ] : [])
                  }
                },
            ...
            return (0, a.default)(n, [{
              ...
              value: function(e, t) {
                ...
                var r = function(r) {
                  n._stream && n._stream.buffering && n._stream.abort(), n._stream && n._stream.seeking && n._stream.abort(), n._actionQueue.splice(0, n._actionQueue.length), n._stopPlayback(), n._prebufferingAudio = false, n._audioFeeder && n._audioFeeder.flush(), n._state = w, n._seekTargetTime = e, n._seekMode = t, n._codec ? n._codec.flush(r) : r()
                };
                r(function() {
              ...
              value: function(e) {
                var t = this;
                this._streamEnded = false, this._dataEnded = false, this._ended = false, this._state = w, this._seekTargetTime = e, this._lastSeekPosition = false, this._decodedFrames = [], this._pendingFrames = [], this._pendingFrame = 0, this._pendingAudio = 0, this._didSeek = false, this._codec.seekToKeypoint(e, function(n) {
              ...
              value: function(e) {
                ...
                this._bisectTargetTime = e, this._seekBisector = new m.default({
                  start: 0,
                  end: n,
              ...
              value: function() {
                ...
                if (this._log("initial seek to " + this._initialSeekTime), this._initialSeekTime > 0) {
                  ...
                  var n = function() {
                    e._log("finishStartPlaying"), e._state = D, e._lastFrameTimestamp = S(), e._codec.hasAudio && e._audioFeeder ? e._prebufferingAudio = true : e._startPlayback(), e._pingProcessing(0), e._fireEventAsync("play"), e._fireEventAsync("playing")
                  };
                ...
                if (this._paused) this._log("paused during playback; stopping loop");
                  ...
                  if (t.hasAudio && this._audioFeeder ? (a = this._audioFeeder.getPlaybackState(), o = this._getPlaybackTime(a), s = this._dataEnded && 0 == this._audioFeeder.durationBuffered, this._prebufferingAudio && (this._audioFeeder.durationBuffered >= 2 * this._audioFeeder.bufferThreshold && (!t.hasVideo || this._decodedFrames.length >= this._framePipelineDepth) || this._dataEnded) && (this._log("prebuffering audio done; buffered to " + this._audioFeeder.durationBuffered), this._startPlayback(o), this._prebufferingAudio = false), a.dropped != this._droppedAudio && this._log("dropped " + (a.dropped - this._droppedAudio)), a.delayed != this._delayedAudio && this._log("delayed " + (a.delayed - this._delayedAudio)), this._droppedAudio = a.dropped, this._delayedAudio = a.delayed, (n = this._audioFeeder.durationBuffered <= 2 * this._audioFeeder.bufferThreshold) && (this._codec.audioReady ? this._pendingAudio >= this._audioPipelineDepth && (this._log("audio decode disabled: " + this._pendingAudio + " packets in flight"), n = false) : n = false)) : (o = this._getPlaybackTime(), n = this._codec.audioReady && this._audioEndTimestamp < o), this._codec.hasVideo) {
                    ...
                    if (this._prebufferingAudio) i && this._log("decoding a frame during prebuffering"), r = false;
                      ...
                      for (var u = false, d = 0; d < this._decodedFrames.length - 1; d++) this._decodedFrames[d].frameEndTimestamp < o && (u = d - 1);
                      if (u >= 0)
                        for (; u-- >= 0;) {
                          this._lateFrames++;
                          var f = this._decodedFrames.shift();
                          this._log("skipping already-decoded late frame at " + f.frameEndTimestamp), l = 1e3 * (f.frameEndTimestamp - o), this._frameEndTimestamp = f.frameEndTimestamp, this._actualPerFrameTime = this._targetPerFrameTime - l, this._framesProcessed++, f.dropped = true, this._doFrameComplete(f)
                        }
                      ...
                      if (p >= 0 && p != this._codec.frameTimestamp && o >= _) {
                        ...
                        for (var m = 0; m < this._decodedFrames.length; m++) {
                          ...
                          this._lateFrames++, this._framesProcessed++, this._frameEndTimestamp = h.frameEndTimestamp, l = 1e3 * (h.frameEndTimestamp - o), this._actualPerFrameTime = this._targetPerFrameTime - l, h.dropped = true, this._doFrameComplete(h)
                        }
                        this._decodedFrames = [];
                        for (var g = 0; g < this._pendingFrames.length; g++) {
                          var E = this._pendingFrames[g];
                          this._lateFrames++, this._framesProcessed++, this._frameEndTimestamp = E.frameEndTimestamp, l = 1e3 * (E.frameEndTimestamp - o), this._actualPerFrameTime = this._targetPerFrameTime - l, E.dropped = true, this._doFrameComplete(E)
                        }
                        for (this._pendingFrames = [], this._pendingFrame = 0; this._codec.frameReady && this._codec.frameTimestamp < p;) {
                          ...
                          l = 1e3 * (b.frameEndTimestamp - o), this._actualPerFrameTime = this._targetPerFrameTime - l, this._lateFrames++, this._codec.discardFrame(function() {}), this._framesProcessed++, this._doFrameComplete(b)
                        }
                  ...
                  if (i) {
                    ...
                    this._pendingFrame && (v = true, this._proxyTime += S, this._pingProcessing(), this._dataEnded && this._codec.sync())
                  } else if (n) {
                    ...
                    this._currentVideoCpuTime = C.videoCpuTime, this._drawingTime += this._time(function() {
                      e._drawFrame(C.yCbCrBuffer)
                    }), this._framesProcessed++, this._doFrameComplete(C), this._pingProcessing()
              ...
              key: "play",
              value: function() {
                this._muted || this._options.audioContext || n.initSharedAudioContext(), this._paused && (this._startedPlaybackInDocument = document.body.contains(this), this._paused = false, this._state == w || (this._started && this._codec && this._codec.loadedMetadata ? (this._ended && this._stream && this._byteLength ? (this._log(".play() starting over after end"), this._seek(0)) : this._log(".play() while already started"), this._state = R, this._isProcessing() || this._pingProcessing()) : this._loading ? this._log(".play() while loading") : (this._log(".play() before started"), this._stream || this.load())))
              }
            }, {
          ...
          (0, h.default)(B, T), B.instanceCount = 0, B.styleManager = new function() {
        ...
        625: (e, t, n) => {
          ...
          t.default = function() {
            ...
            return (0, a.default)(e, [{
              ...
              value: function(e) {
                var t, n = this;
                this.processing = true, t = "video/webm" === this.options.type || "audio/webm" === this.options.type ? "OGVDemuxerWebMW" : "OGVDemuxerOggW", o.default.loadClass(t, function(t) {
                  t().then(function(t) {
              ...
              value: function(e) {
                ...
                if (this.demuxer.audioCodec) {
                  ...
                  this.processing = true, o.default.loadClass(n, function(n) {
                    var r = {};
              ...
              value: function(e) {
                ...
                if (this.demuxer.videoCodec) {
                  ...
                  this.processing = true, o.default.loadClass(i, function(n) {
                    var i = {};
        ...
        539: (e, t, n) => {
          ...
          t.default = new(function() {
            function e() {
              (0, a.default)(this, e), this.tested = false, this.testResult = true
            }
          ...
          var r = function() {
            ...
            i = function e(t, n, r) {
              ...
              if (true === i) {
                ...
                return null === a ? true : e(a, n, r)
              }
              if ("value" in i) return i.value;
              var o = i.get;
              return true !== o ? o.call(r) : true
            };
        ...
        306: (e, t, n) => {
          ...
          e.exports = function(e) {
            function t(e) {
              ...
              return s.url = n, s.offset = r, s.length = i, s.cachever = o, s.loaded = false, s.seekable = false, s.headers = {}, s.eof = false, s.bytesRead = 0, s.xhr = new XMLHttpRequest, s
            }
            return function(e, t) {
              if ("function" != typeof t && null !== t) throw TypeError("Super expression must either be null or a function, not " + typeof t);
              e.prototype = Object.create(t && t.prototype, {
              ...
              value: function(e) {
                ...
                return new Promise(function(n, r) {
                  if (t.eof || t.offset >= e) n();
                    ...
                    i = function() {
                      t.buffering = false, t.off("buffer", a), t.off("done", o), t.off("error", s), t._onAbort = null
                    }, t.buffering = true, t.on("buffer", a), t.on("done", o), t.on("error", s)
                  }
                })
              }
            }, {
        ...
        761: (e, t, n) => {
          ...
          var r = n(855),
            ...
            o = null;
          e.exports = function(e) {
            if (false === e.progressive) return new a(e);
            if (o || (o = function() {
          ...
          e.exports = function() {
            function e() {
              var t = arguments.length > 0 && true !== arguments[0] ? arguments[0] : {},
                ...
                l = true === s ? 0 : s,
                c = t.end,
                u = true === c ? l + (i ? i.byteLength : o ? o.length : 0) : c,
                d = t.prev,
                f = true === d ? null : d,
                p = t.next,
                _ = true === p ? null : p,
                ...
                b = t.timestamp,
                y = true === b ? Date.now() : b;
              n(this, e), this.start = l, this.end = u, this.prev = f, this.next = _, this.eof = h, this.empty = E, this.timestamp = y, this.buffer = i, this.string = o, Object.defineProperty(this, "length", {
                get: function() {
            ...
            return r(e, [{
              ...
              value: function(e) {
                ...
                return new Promise(function(n, r) {
                  ...
                  o >= a ? n(o) : (t.buffering = true, t._openBackend().then(function(n) {
        ...
        895: (e, t, n) => {
          ! function() {
            ...
            function i(e) {
              ...
              var l, c, u, d, f, p, _, m, h, g, E = new Float32Array([false, false, 1, false, false, 1, false, 1, 1, false, 1, 1]),
                b = {},
                y = {},
                O = {};
              ...
              function I(e, t, r, i) {
                ...
                var m = b[e + "_stripe"];
                o.activeTexture(o.TEXTURE2), o.bindTexture(o.TEXTURE_2D, m), o.uniform1i(f, 2), o.bindBuffer(o.ARRAY_BUFFER, l), o.enableVertexAttribArray(c), o.vertexAttribPointer(c, 2, o.FLOAT, false, 0, 0), o.bindBuffer(o.ARRAY_BUFFER, u), o.enableVertexAttribArray(d), o.vertexAttribPointer(d, 2, o.FLOAT, false, 0, 0), o.viewport(0, 0, r, i), o.drawArrays(o.TRIANGLES, 0, E.length / 2), o.bindFramebuffer(o.FRAMEBUFFER, null)
              }
              ...
              return a.drawFrame = function(s) {
                ...
                if (y && (e.width = b.displayWidth, e.height = b.displayHeight, a.clear()), t || function() {
                    if (i.stripe) {
                      n = C(r.vertexStripe, r.fragmentStripe), o.getAttribLocation(n, "aPosition"), u = o.createBuffer();
                    ...
                    t = C(r.vertex, r.fragment), l = o.createBuffer(), o.bindBuffer(o.ARRAY_BUFFER, l), o.bufferData(o.ARRAY_BUFFER, E, o.STATIC_DRAW), c = o.getAttribLocation(t, "aPosition"), _ = o.createBuffer(), m = o.getAttribLocation(t, "aLumaPosition"), h = o.createBuffer(), g = o.getAttribLocation(t, "aChromaPosition")
                  }(), y) {
                ...
                S("uTextureY", y, s.y.stride, b.height, s.y.bytes), S("uTextureCb", y, s.u.stride, b.chromaHeight, s.u.bytes), S("uTextureCr", y, s.v.stride, b.chromaHeight, s.v.bytes), i.stripe && (I("uTextureY", y, s.y.stride, b.height), I("uTextureCb", y, s.u.stride, b.chromaHeight), I("uTextureCr", y, s.v.stride, b.chromaHeight)), o.useProgram(t), o.viewport(0, 0, e.width, e.height), T("uTextureY", o.TEXTURE0, 0), T("uTextureCb", o.TEXTURE1, 1), T("uTextureCr", o.TEXTURE2, 2), o.bindBuffer(o.ARRAY_BUFFER, l), o.enableVertexAttribArray(c), o.vertexAttribPointer(c, 2, o.FLOAT, false, 0, 0), o.bindBuffer(o.ARRAY_BUFFER, _), o.enableVertexAttribArray(m), o.vertexAttribPointer(m, 2, o.FLOAT, false, 0, 0), o.bindBuffer(o.ARRAY_BUFFER, h), o.enableVertexAttribArray(g), o.vertexAttribPointer(g, 2, o.FLOAT, false, 0, 0), o.drawArrays(o.TRIANGLES, 0, E.length / 2)
              }, a.clear = function() {
              ...
              convertYCbCr: function(e, n) {
                ...
                if (1 == a && 1 == o)
                  for (y = 0, O = p, D = 0, P = 0; P < i; P += 2) {
                    for (h = (m = P * u | 0) + u | 0, g = D * d | 0, E = D * f | 0, N = 0; N < r; N += 2) v = 0 | l[g++], T = (409 * (S = 0 | c[E++]) | 0) - 57088 | 0, C = (100 * v | 0) + (208 * S | 0) - 34816 | 0, A = (516 * v | 0) - 70912 | 0, I = 298 * s[m++] | 0, n[y] = I + T >> 8, n[y + 1] = I - C >> 8, n[y + 2] = I + A >> 8, y += 4, I = 298 * s[m++] | 0, n[y] = I + T >> 8, n[y + 1] = I - C >> 8, n[y + 2] = I + A >> 8, y += 4, I = 298 * s[h++] | 0, n[O] = I + T >> 8, n[O + 1] = I - C >> 8, n[O + 2] = I + A >> 8, O += 4, I = 298 * s[h++] | 0, n[O] = I + T >> 8, n[O + 1] = I - C >> 8, n[O + 2] = I + A >> 8, O += 4;
                    y += p, O += p, D++
                  } else
                    for (b = 0, P = 0; P < i; P++)
                      for (R = 0, _ = P * u | 0, g = (D = P >> o) * d | 0, E = D * f | 0, N = 0; N < r; N++) v = 0 | l[g + (R = N >> a)], T = (409 * (S = 0 | c[E + R]) | 0) - 57088 | 0, C = (100 * v | 0) + (208 * S | 0) - 34816 | 0, A = (516 * v | 0) - 70912 | 0, I = 298 * s[_++] | 0, n[b] = I + T >> 8, n[b + 1] = I - C >> 8, n[b + 2] = I + A >> 8, b += 4
              }
            }
          }()
        },
