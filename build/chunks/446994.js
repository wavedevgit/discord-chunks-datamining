              ...
              convertYCbCr: function(e, n) {
                ...
                if (1 == o && 1 == a)
                  for (y = 0, v = _, w = 0, P = 0; P < i; P += 2) {
                    ...
                    for (b = 0, P = 0; P < i; P++)
                      for (R = 0, p = P * u | 0, g = (w = P >> a) * d | 0, E = w * f | 0, C = 0; C < r; C++) O = 0 | l[g + (R = C >> o)], T = (409 * (I = 0 | c[E + R]) | 0) - 57088 | 0, N = (100 * O | 0) + (208 * I | 0) - 34816 | 0, A = (516 * O | 0) - 70912 | 0, S = 298 * s[p++] | 0, n[b] = S + T >> 8, n[b + 1] = S - N >> 8, n[b + 2] = S + A >> 8, b += 4
              }
            }
          }()
        },
