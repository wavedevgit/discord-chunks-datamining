              ...
              convertYCbCr: function(e, n) {
                ...
                if (1 == o && 1 == a)
                  for (y = 0, O = _, w = 0, R = 0; R < i; R += 2) {
                    ...
                    for (b = 0, R = 0; R < i; R++)
                      for (P = 0, p = R * u | 0, g = (w = R >> a) * d | 0, E = w * f | 0, C = 0; C < r; C++) v = 0 | l[g + (P = C >> o)], S = (409 * (I = 0 | c[E + P]) | 0) - 57088 | 0, A = (100 * v | 0) + (208 * I | 0) - 34816 | 0, N = (516 * v | 0) - 70912 | 0, T = 298 * s[p++] | 0, n[b] = T + S >> 8, n[b + 1] = T - A >> 8, n[b + 2] = T + N >> 8, b += 4
              }
            }
          }()
        },
