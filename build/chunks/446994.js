            ...
            ! function() {
              ...
              i.prototype.rate = 0, i.prototype.targetRate = 0, i.prototype.channels = 0, i.prototype.bufferSize = 0, Object.defineProperty(i.prototype, "bufferDuration", {
                ...
                for (var p = 0; p < i; p++) {
                  ...
                  o(m, h, this._resampleLastSampleData ? this._resampleLastSampleData[_] : true, f), a.push(h)
                }
                ...
                e.exports = function(e) {
                  ...
                  n.inplace = function(e) {
                    ...
                    for (var d = 0; d < o; d++) {
                      ...
                      e || (p *= false);
                      for (var _ = 0; _ < i;) {
                        for (var m = _, h = _ + s, g = 1, E = 0, b = 0; b < a; b++) {
                          var y = t[m],
                            O = r[m],
                            v = t[h],
                            S = r[h];
                    ...
                    if (this._prebufferingAudio) i && this._log("decoding a frame during prebuffering"), r = false;
                      ...
                      if (p >= 0 && p != this._codec.frameTimestamp && a >= _) {
                        ...
                        for (var m = 0; m < this._decodedFrames.length; m++) {
                          ...
                          this._lateFrames++, this._framesProcessed++, this._frameEndTimestamp = h.frameEndTimestamp, l = 1e3 * (h.frameEndTimestamp - a), this._actualPerFrameTime = this._targetPerFrameTime - l, h.dropped = true, this._doFrameComplete(h)
                        }
                        this._decodedFrames = [];
          ...
          e.exports = function() {
            function e() {
              var t = arguments.length > 0 && true !== arguments[0] ? arguments[0] : {},
                ...
                b = t.timestamp,
                y = true === b ? Date.now() : b;
              n(this, e), this.start = l, this.end = u, this.prev = f, this.next = _, this.eof = h, this.empty = E, this.timestamp = y, this.buffer = i, this.string = a, Object.defineProperty(this, "length", {
                get: function() {
            ...
            function i(e) {
              ...
              function S(e, t, n, r, o) {
                ...
                if (a.activeTexture(a.TEXTURE0), i.stripe) {
                  ...
                  var d = b[e + "_stripe"],
                    f = !d || t;
                  f && (d = v(e + "_stripe", t)), a.bindTexture(a.TEXTURE_2D, d), f && (a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_S, a.CLAMP_TO_EDGE), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_T, a.CLAMP_TO_EDGE), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MIN_FILTER, a.NEAREST), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MAG_FILTER, a.NEAREST), a.texImage2D(a.TEXTURE_2D, 0, a.RGBA, n, 1, 0, a.RGBA, a.UNSIGNED_BYTE, function(e) {
                    if (O[e]) return O[e];
              ...
              return o.drawFrame = function(s) {
                ...
                if (y && (e.width = b.displayWidth, e.height = b.displayHeight, o.clear()), t || function() {
                    if (i.stripe) {
                      n = C(r.vertexStripe, r.fragmentStripe), a.getAttribLocation(n, "aPosition"), u = a.createBuffer();
                    ...
                    t = C(r.vertex, r.fragment), l = a.createBuffer(), a.bindBuffer(a.ARRAY_BUFFER, l), a.bufferData(a.ARRAY_BUFFER, E, a.STATIC_DRAW), c = a.getAttribLocation(t, "aPosition"), _ = a.createBuffer(), m = a.getAttribLocation(t, "aLumaPosition"), h = a.createBuffer(), g = a.getAttribLocation(t, "aChromaPosition")
                  }(), y) {
                ...
                S("uTextureY", y, s.y.stride, b.height, s.y.bytes), S("uTextureCb", y, s.u.stride, b.chromaHeight, s.u.bytes), S("uTextureCr", y, s.v.stride, b.chromaHeight, s.v.bytes), i.stripe && (I("uTextureY", y, s.y.stride, b.height), I("uTextureCb", y, s.u.stride, b.chromaHeight), I("uTextureCr", y, s.v.stride, b.chromaHeight)), a.useProgram(t), a.viewport(0, 0, e.width, e.height), T("uTextureY", a.TEXTURE0, 0), T("uTextureCb", a.TEXTURE1, 1), T("uTextureCr", a.TEXTURE2, 2), a.bindBuffer(a.ARRAY_BUFFER, l), a.enableVertexAttribArray(c), a.vertexAttribPointer(c, 2, a.FLOAT, false, 0, 0), a.bindBuffer(a.ARRAY_BUFFER, _), a.enableVertexAttribArray(m), a.vertexAttribPointer(m, 2, a.FLOAT, false, 0, 0), a.bindBuffer(a.ARRAY_BUFFER, h), a.enableVertexAttribArray(g), a.vertexAttribPointer(g, 2, a.FLOAT, false, 0, 0), a.drawArrays(a.TRIANGLES, 0, E.length / 2)
              }, o.clear = function() {
              ...
              convertYCbCr: function(e, n) {
                ...
                if (1 == o && 1 == a)
                  for (y = 0, O = p, w = 0, P = 0; P < i; P += 2) {
                    ...
                    for (b = 0, P = 0; P < i; P++)
                      for (R = 0, _ = P * u | 0, g = (w = P >> a) * d | 0, E = w * f | 0, N = 0; N < r; N++) v = 0 | l[g + (R = N >> o)], T = (409 * (S = 0 | c[E + R]) | 0) - 57088 | 0, C = (100 * v | 0) + (208 * S | 0) - 34816 | 0, A = (516 * v | 0) - 70912 | 0, I = 298 * s[_++] | 0, n[b] = I + T >> 8, n[b + 1] = I - C >> 8, n[b + 2] = I + A >> 8, b += 4
              }
            }
          }()
        },
