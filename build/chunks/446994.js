              ...
              convertYCbCr: function(e, n) {
                ...
                if (1 == a && 1 == o)
                  for (y = 0, O = p, w = 0, P = 0; P < i; P += 2) {
                    ...
                    for (b = 0, P = 0; P < i; P++)
                      for (R = 0, _ = P * u | 0, g = (w = P >> o) * d | 0, E = w * f | 0, N = 0; N < r; N++) v = 0 | l[g + (R = N >> a)], T = (409 * (S = 0 | c[E + R]) | 0) - 57088 | 0, A = (100 * v | 0) + (208 * S | 0) - 34816 | 0, C = (516 * v | 0) - 70912 | 0, I = 298 * s[_++] | 0, n[b] = I + T >> 8, n[b + 1] = I - A >> 8, n[b + 2] = I + C >> 8, b += 4
              }
            }
          }()
        },
