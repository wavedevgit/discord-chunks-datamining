...
function j(e) {
  let {
    ...
    id: I,
    type: Z
  } = j, T = (0, i.e7)([u.Z], () => u.Z.getGuild(j.guild_id), [j.guild_id]), N = (0, i.e7)([d.Z], () => d.Z.getSelectedParticipant(I)), A = (null == N ? true : N.type) === _.fO.STREAM ? N.stream : null, w = (0, i.e7)([a.Z], () => (null == N ? true : N.type) === _.fO.ACTIVITY ? a.Z.getApplication(N.applicationId) : true), M = (0, h.Z)(I), R = (0, y.Z)(I), k = (0, m.Z)(j, T, null == A ? true : A.ownerId, null == w ? true : w.id), L = (0, p.Z)(I), D = (0, C.Z)(), U = (0, c.$A)(I), B = (0, c.j8)(I), H = (0, b.Z)(A, P), F = (0, g.Z)(w, I), V = (0, f.Z)(), G = (0, o.Z)(j);
