...
function S(e) {
  let {
    ...
    id: Z,
    type: T
  } = S, N = (0, r.e7)([u.Z], () => u.Z.getGuild(S.guild_id), [S.guild_id]), A = (0, r.e7)([d.Z], () => d.Z.getSelectedParticipant(Z)), w = (null == A ? true : A.type) === x.fO.STREAM ? A.stream : null, M = (0, r.e7)([a.Z], () => (null == A ? true : A.type) === x.fO.ACTIVITY ? a.Z.getApplication(A.applicationId) : true), R = (0, h.Z)(Z), D = (0, C.Z)(Z), k = (0, g.Z)(S, N, null == w ? true : w.ownerId, null == M ? true : M.id), L = (0, f.Z)(Z), U = (0, v.Z)(), V = (0, c.$A)(Z), H = (0, c.j8)(Z), F = (0, y.Z)(w, I), B = (0, b.Z)(M, Z), G = (0, m.Z)(), W = (0, o.Z)(S), z = (0, p.m)(Z);
  return (0, i.jsxs)(l.v2r, {
    ...
    children: [(0, i.jsx)(l.kSQ, {
      ...
      children: [T === O.d4z.GUILD_STAGE_VOICE ? V : null, T === O.d4z.GUILD_STAGE_VOICE ? H : null, _ || T === O.d4z.GUILD_STAGE_VOICE ? null : L, G, T !== O.d4z.GUILD_STAGE_VOICE ? R : null, T === O.d4z.GUILD_STAGE_VOICE || T === O.d4z.GUILD_VOICE ? D : null]
    }), (0, i.jsx)(l.kSQ, {
      children: W
    }), (0, i.jsxs)(l.kSQ, {
