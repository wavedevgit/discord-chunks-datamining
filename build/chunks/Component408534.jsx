...
function j(e) {
  let {
    ...
    id: P,
    type: Z
  } = j, T = (0, i.e7)([u.Z], () => u.Z.getGuild(j.guild_id), [j.guild_id]), N = (0, i.e7)([d.Z], () => d.Z.getSelectedParticipant(P)), A = (null == N ? true : N.type) === C.fO.STREAM ? N.stream : null, w = (0, i.e7)([o.Z], () => (null == N ? true : N.type) === C.fO.ACTIVITY ? o.Z.getApplication(N.applicationId) : true), R = (0, h.Z)(P), M = (0, _.Z)(P), D = (0, m.Z)(j, T, null == A ? true : A.ownerId, null == w ? true : w.id), L = (0, p.Z)(P), k = (0, y.Z)(), U = (0, c.$A)(P), B = (0, c.j8)(P), F = (0, b.Z)(A, I), G = (0, g.Z)(w, P), H = (0, f.Z)(), V = (0, s.Z)(j);
