...
function j(e) {
  let {
    ...
    id: Z,
    type: T
  } = j, N = (0, r.e7)([u.Z], () => u.Z.getGuild(j.guild_id), [j.guild_id]), A = (0, r.e7)([d.Z], () => d.Z.getSelectedParticipant(Z)), w = (null == A ? true : A.type) === _.fO.STREAM ? A.stream : null, M = (0, r.e7)([a.Z], () => (null == A ? true : A.type) === _.fO.ACTIVITY ? a.Z.getApplication(A.applicationId) : true), R = (0, f.Z)(Z), L = (0, C.Z)(Z), k = (0, g.Z)(j, N, null == w ? true : w.ownerId, null == M ? true : M.id), D = (0, h.Z)(Z), U = (0, v.Z)(), V = (0, c.$A)(Z), F = (0, c.j8)(Z), H = (0, y.Z)(w, I), B = (0, b.Z)(M, Z), G = (0, m.Z)(), z = (0, o.Z)(j), W = (0, p.m)(Z);
