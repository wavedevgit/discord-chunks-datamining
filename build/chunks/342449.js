...
function m(e) {
  let {
    ...
    loading: N,
    loadMore: p
  } = (0, o.qQ)(t, s.z.LATEST_ACTIVITY, g, l.z.MATCH_SOME), b = a.useRef(null);
  (0, o.r7)();
  let T = a.useCallback(e => {
    ...
    y = a.useCallback(e => 0 === e.section ? (0, r.jsx)(f, {
      text: u.NW.formatToPlainString(u.t["4E27f3"], {
        count: x.length
      })
    }, e.section) : 1 === e.section ? (0, r.jsx)(f, {
      text: u.NW.formatToPlainString(u.t.csPc4O, {
        count: j.length
      })
    }, e.section) : (0, r.jsx)(f, {
      text: u.NW.string(u.t["wUNQ+/"])
    }, e.section), [x.length, j.length]),
