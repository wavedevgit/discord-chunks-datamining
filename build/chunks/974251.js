...
let z = i.memo(function(e) {
  ...
  let e_ = (e, t, n) => {
      null != t && "ETOOLARGE" === t.code ? (0, M.G)(q, []) : (0, M.d)(e, q, K, {
        requireConfirm: !0,
  ...
  function ev() {
    (0, c.ZDy)(async () => {
      let {
        default: e
      } = await Promise.all([n.e("2668"), n.e("9134")]).then(n.bind(n, 542055));
  ...
  i.useEffect(() => {
    ...
    return w.S.subscribe(W.CkL.UPLOAD_FILE, e), () => {
  ...
  let eM = eZ ? eT ? {
    ...
    ek = (0, r.jsx)(c.yRy, {
      ...
      onRequestOpen: () => {
        eC && (0, v.EW)(s.z.ACTIVITIES_CHAT_BUTTON_NUX_V2, {
          dismissAction: B.L.TAKE_ACTION
        }), eh("attachMenu")
      },
      onRequestClose: () => {
        (0, c.$sL)() || (eC && (0, v.EW)(s.z.ACTIVITIES_CHAT_MENU_NEW_BADGE, {
          dismissAction: B.L.TAKE_ACTION
        }), eh(null))
      },
      renderPopout: e => {
        switch (ep) {
          case "recentClips":
            return (0, r.jsx)(_.Z, V(G({}, e), {
              onOpenClips: ev,
              lastClipsSession: er
            }));
          case "attachMenu":
            return (0, r.jsx)(L.Z, V(G({}, e), {
              onClose: () => eh(null),
              options: eS,
              channel: q,
              onFileUpload: () => {
