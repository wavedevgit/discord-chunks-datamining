...
let G = i.memo(function(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), ei = (0, o.e7)([y.qc], () => y.qc.hasHotspot(y.v6.CLIPS_CHANNEL_ATTACH_REMINDER)), el = (0, c.s9z)(e => (0, c.DEQ)(e, k.Qr)), ea = (0, o.e7)([E.Z], () => E.Z.hasLayers()), eo = (0, o.e7)([g.Z], () => g.Z.hasClips()), [es, ec] = i.useState(null), eu = (0, m.Go)() && ($ || eo), ed = V.isPrivate(), ep = (0, o.e7)([P.Z], () => ed || P.Z.can(D.Plq.ATTACH_FILES, V) && P.Z.can(D.Plq.SEND_MESSAGES, V)), eh = (0, d.Z)(ee);
  ...
  let eS = "refresh_sm",
    ...
    eI = (0, r.jsx)(c.yRy, {
      ...
      onRequestOpen: () => {
        em && (0, _.Q3)(s.z.ACTIVITIES_CHAT_BUTTON_NUX_V2, {
          dismissAction: L.L.TAKE_ACTION
        }), ec("attachMenu")
      },
      onRequestClose: () => {
        (0, c.$sL)() || (em && (0, _.Q3)(s.z.ACTIVITIES_CHAT_MENU_NEW_BADGE, {
          dismissAction: L.L.TAKE_ACTION
        }), ec(null))
      },
      renderPopout: e => {
