...
let V = i.memo(function(e) {
  ...
  let eg = (e, t, n) => {
      null != t && "ETOOLARGE" === t.code ? (0, R.G)(Y, []) : (0, R.d)(e, Y, q, {
        requireConfirm: !0,
  ...
  i.useEffect(() => {
    ...
    return A.S.subscribe(D.CkL.UPLOAD_FILE, e), () => {
  ...
  let ew = eP ? eS ? {
    ...
    eR = (0, r.jsx)(c.yRy, {
      ...
      onRequestOpen: () => {
        eb && (0, C.EW)(s.z.ACTIVITIES_CHAT_BUTTON_NUX_V2, {
          dismissAction: U.L.TAKE_ACTION
        }), ed("attachMenu")
      },
      onRequestClose: () => {
        (0, c.$sL)() || (eb && (0, C.EW)(s.z.ACTIVITIES_CHAT_MENU_NEW_BADGE, {
          dismissAction: U.L.TAKE_ACTION
        }), ed(null))
      },
      renderPopout: e => {
