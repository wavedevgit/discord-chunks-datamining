...
function D(e) {
  ...
  } = e, l = (0, s.bG)([u.default], () => u.default.getCurrentUser()), d = null == l ? true : l.hasVerifiedEmailOrPhone(), f = null == l ? true : l.verified, _ = (0, p.Ut)();
  ...
  L = (e, t, n) => {
    let {
      ...
      (null == o || null == (i = o.tagName) ? true : i.toLowerCase()) !== "a" || s({
        questId: e,
        questContent: t,
        questContentCTA: o.getAttribute("href") === a ? p.Cy.HOW_TO_HELP_ARTICLE_XBOX : p.Cy.HOW_TO_HELP_ARTICLE_PLAYSTATION,
...
function F(e) {
  ...
  return (0, l.I)(i.useCallback(() => {
    t && ((0, O.Xm)(n, r), (0, o.showToast)((0, o.createToast)(P.intl.string(P.t["+5kSoW"]), o.ToastType.SUCCESS)))
  }, [t, n, r]), 3e3, [], V)
}