...
function C(e) {
  let {
    ...
    channelId: C,
    onClose: Z
  } = e, x = (0, i.e7)([c.default], () => c.default.getUser(n)), O = (0, i.e7)([s.Z], () => {
    var e;
  ...
  }, [w, n, F, C, Z]), D = l.useCallback(() => {
    null != w && ((0, f.LO)(n, w, F), Z())
  }, [w, n, F, Z]), [L, Y] = l.useMemo(() => M ? [R.intl.string(R.t.UNUuen), a.Z.BG_BRAND] : [R.intl.string(R.t.y2b7CA), a.Z.STATUS_DANGER], [M]), z = l.useMemo(() => (0, f.kK)({
    isCurrentUserKeyPersistent: P,
    isOtherUserKeyPersistent: F,
    otherUserNickname: j
  }), [P, F, j]), B = (0, S.P)({
