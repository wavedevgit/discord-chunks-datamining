...
function O(e) {
  ...
  return <y enabled={t} join={n} channel={i} onChange={o} onCameraUnavailable={s} cameraUnavailable={l} hasPermission={c} channelLimitReached={f} channelLimit={p}>{e => {
      var {
        unavailable: t,
        onMouseEnter: i,
        onMouseLeave: o,
