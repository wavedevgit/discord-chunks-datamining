...
function R(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), G = [], B = !S.isDM() || void 0 === S.recipients || S.recipients.length > 1, F = (0, a.e7)([g.default], () => B ? null : g.default.getUser(S.recipients[0])), V = (0, d.R6)("ChannelTextAreaButtons"), Z = (0, f.Nt)() && (null === (t = y.confetti) || void 0 === t ? void 0 : t.button) != null;
  return (o.tq || ((null === (p = y.gifts) || void 0 === p ? void 0 : p.button) != null && null == k && !U && (null == F || E.ZP.isPremiumEligible(F)) && G.push((0, r.jsx)(C, {
    disabled: I,
    channel: S
  }, "gift")), (null === (h = y.gifs) || void 0 === h ? void 0 : h.button) != null && null == k && D && G.push((0, r.jsx)(v.Z, {
    disabled: I,
    type: y
    ...
    disabled: I,
    type: y
  }, "emoji")), V || null == L || G.push(L), (null === (i = y.submit) || void 0 === i ? void 0 : i.button) != null && ((null === (_ = y.submit) || void 0 === _ ? void 0 : _.ignorePreference) || x) && !V && G.push((0, r.jsx)(T.Z, {
    onClick: R,
    disabled: I || M
