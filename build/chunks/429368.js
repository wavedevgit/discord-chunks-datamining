...
let c = (0, Chunk51835.F)(() => ({
  ...
  d = e => {
    var t, n;
    (0, s.QN)();
    let r = (0, a.e7)([l.Z], () => l.Z.purchases),
      i = c(t => {
        var n;
        return (null == e ? true : e.type) !== o.Z.VARIANTS_GROUP ? 0 : null == (n = t.selectionStates.get(e.storeListingId)) ? true : n.selectedVariantIndex
      });
