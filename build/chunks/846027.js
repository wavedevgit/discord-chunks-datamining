  ...
  P = {
    ...
    toggleSelfMute() {
      ...
      return N() ? Promise.resolve() : (C({
        usedKeybind: i,
        location: o
      }), a = a && !d.Z.hasActiveCallKitCall(), (null == (e = f.default.getCurrentUser()) ? void 0 : e.isStaff()) && O.info("Toggling self mute"), d.Z.isEnabled()) ? r.Z.dispatch({
    ...
    setSelfMute(e, t) {
      ...
      N() || (i = i && !d.Z.hasActiveCallKitCall(), (null == (n = f.default.getCurrentUser()) ? void 0 : n.isStaff()) && O.info("Setting self mute", t), r.Z.dispatch({
    ...
    setTemporarySelfMute(e) {
      var t;
      N() || ((null == (t = f.default.getCurrentUser()) ? void 0 : t.isStaff()) && O.info("Setting temporary self mute", e), r.Z.dispatch({
    ...
    setInputDevice(e) {
      ...
      N() || ((null != t || null != n) && T(d.Z.getInputDevices(), d.Z.getInputDeviceId(), e, "Audio Input", {
        location: t,
        analyticsLocations: n
      }), r.Z.dispatch({
    ...
    setOutputDevice(e) {
      ...
      N() || ((null != t || null != n) && T(d.Z.getOutputDevices(), d.Z.getOutputDeviceId(), e, "Audio Output", {
        location: t,
        analyticsLocations: n
      }), r.Z.dispatch({
    ...
    setVideoDevice(e) {
      ...
      N() || ((null != t || null != n) && T(d.Z.getVideoDevices(), d.Z.getVideoDeviceId(), e, "Video", {
        location: t,
        analyticsLocations: n
      }), r.Z.dispatch({
