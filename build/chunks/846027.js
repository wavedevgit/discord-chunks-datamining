...
let T = new Chunk710845.Z("AudioActionCreators");
...
let N = i()((e, t, n) => {
  ...
  },
  {
    enable: P,
    isNotSupported: D,
    trackToggleSelfMute: w,
    trackToggleSelfDeaf: L
  } = R = require("./929782.jsx"),
  x = {
    enable: P,
    toggleSelfMute() {
      var e;
      ...
      return D() ? Promise.resolve() : (w({
        usedKeybind: Chunk954955,
        location: Chunk710845
      }), i = i && !Chunk131951.Z.hasActiveCallKitCall(), (null == (e = Chunk594174.default.getCurrentUser()) ? true : module.isStaff()) && T.info("Toggling self mute"), Chunk131951.Z.isEnabled()) ? Chunk570140.Z.dispatch({
    ...
    setSelfMute(e, t) {
      ...
      D() || (r = r && !_.Z.hasActiveCallKitCall(), (null == (n = m.default.getCurrentUser()) ? true : n.isStaff()) && T.info("Setting self mute", t), a.Z.dispatch({
    ...
    setTemporarySelfMute(e) {
      var t;
      D() || ((null == (t = m.default.getCurrentUser()) ? true : t.isStaff()) && T.info("Setting temporary self mute", e), a.Z.dispatch({
    ...
    setInputDevice(e) {
      ...
      (null != t || null != n) && C(_.Z.getInputDevices(), r, e, "Audio Input", {
        location: t,
        analyticsLocations: n
      }), a.Z.dispatch({
    ...
    setOutputDevice(e) {
      ...
      (null != t || null != n) && C(_.Z.getOutputDevices(), r, e, "Audio Output", {
        location: t,
        analyticsLocations: n
      }), a.Z.dispatch({
    ...
    setVideoDevice(e) {
      ...
      (null != t || null != n) && C(_.Z.getVideoDevices(), r, e, "Video", {
        location: t,
        analyticsLocations: n
      }), a.Z.dispatch({
    ...
    setActiveInputProfile(e) {
      ...
      D() || ((0, c.Z)("active_input_profile", e, null != (t = _.Z.getActiveInputProfile()) ? t : true, n), a.Z.dispatch({
    ...
    setSidechainCompression(e) {
      ...
      D() || ((0, c.Z)("stream_attenuation_enabled", e, _.Z.getSidechainCompression(), t), a.Z.dispatch({
    ...
    setSidechainCompressionStrength(e) {
      ...
      D() || ((0, c.Z)("stream_attenuation_strength", e, _.Z.getSidechainCompressionStrength(), t), a.Z.dispatch({
    ...
    setQoS(e) {
      D() || ((0, c.Z)("quality_of_service_packets_enabled", e, _.Z.getQoS()), a.Z.dispatch({
        type: "AUDIO_SET_QOS",
        enabled: e
      }))
    },
    reset() {
      D() || Chunk570140.Z.dispatch({
        type: "AUDIO_RESET"
      })
    },
    setSilenceWarning(e) {
      D() || ((0, c.Z)("silence_warning_enabled", e, _.Z.getEnableSilenceWarning()), a.Z.dispatch({
        type: "AUDIO_SET_DISPLAY_SILENCE_WARNING",
        enabled: e
      }))
    },
    async setDebugLogging(e) {
      D() || (await (0, c.Z)("debug_logging_enabled", e, _.Z.getDebugLogging()), a.Z.dispatch({
        type: "AUDIO_SET_DEBUG_LOGGING",
        enabled: e
      }))
    },
    setVideoHook(e) {
      D() || ((0, c.Z)("video_hook_enabled", e, _.Z.getVideoHook()), a.Z.dispatch({
        type: "MEDIA_ENGINE_SET_VIDEO_HOOK",
        enabled: e
      }))
    },
    setExperimentalSoundshare(e) {
      D() || ((0, c.Z)("experimental_soundshare_enabled", e, _.Z.getExperimentalSoundshare()), a.Z.dispatch({
        type: "MEDIA_ENGINE_SET_EXPERIMENTAL_SOUNDSHARE",
        enabled: e
      }))
    },
    setUseSystemScreensharePicker(e) {
      D() || ((0, c.Z)("system_screenshare_picker_enabled", e, _.Z.getUseSystemScreensharePicker()), a.Z.dispatch({
        type: "MEDIA_ENGINE_SET_USE_SYSTEM_SCREENSHARE_PICKER",
        enabled: e
      }))
    },
    async setAudioSubsystem(e) {
      D() || (await (0, c.Z)("audio_subsystem", e, _.Z.getAudioSubsystem()), a.Z.dispatch({
    ...
    setAecDump(e) {
      D() || ((0, c.Z)("diagnostic_audio_recording_enabled", e, _.Z.getAecDump()), a.Z.dispatch({
    ...
    setKrispModelOverride(e) {
      !D() && (a.Z.dispatch({
        ...
        model: e
      }), _.Z.getNoiseCancellation() && (this.setNoiseCancellation(false), this.setNoiseCancellation(true)))
    },
