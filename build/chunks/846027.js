...
let N = i()((e, t, n) => {
  ...
  L = {
    ...
    setSelfMute(e, t) {
      ...
      D() || (r = r && !p.Z.hasActiveCallKitCall(), (null == (n = h.default.getCurrentUser()) ? true : n.isStaff()) && I.info("Setting self mute", t), a.Z.dispatch({
    ...
    setTemporarySelfMute(e) {
      var t;
      D() || ((null == (t = h.default.getCurrentUser()) ? true : t.isStaff()) && I.info("Setting temporary self mute", e), a.Z.dispatch({
    ...
    setActiveInputProfile(e) {
      ...
      D() || ((0, c.Z)("active_input_profile", e, null != (t = p.Z.getActiveInputProfile()) ? t : true, n), a.Z.dispatch({
    ...
    setSidechainCompression(e) {
      ...
      D() || ((0, c.Z)("stream_attenuation_enabled", e, p.Z.getSidechainCompression(), t), a.Z.dispatch({
    ...
    setSidechainCompressionStrength(e) {
      ...
      D() || ((0, c.Z)("stream_attenuation_strength", e, p.Z.getSidechainCompressionStrength(), t), a.Z.dispatch({
    ...
    setQoS(e) {
      D() || ((0, c.Z)("quality_of_service_packets_enabled", e, p.Z.getQoS()), a.Z.dispatch({
        type: "AUDIO_SET_QOS",
        enabled: e
      }))
    },
    ...
    setSilenceWarning(e) {
      D() || ((0, c.Z)("silence_warning_enabled", e, p.Z.getEnableSilenceWarning()), a.Z.dispatch({
        type: "AUDIO_SET_DISPLAY_SILENCE_WARNING",
        enabled: e
      }))
    },
    async setDebugLogging(e) {
      D() || (await (0, c.Z)("debug_logging_enabled", e, p.Z.getDebugLogging()), a.Z.dispatch({
        type: "AUDIO_SET_DEBUG_LOGGING",
        enabled: e
      }))
    },
    setVideoHook(e) {
      D() || ((0, c.Z)("video_hook_enabled", e, p.Z.getVideoHook()), a.Z.dispatch({
        type: "MEDIA_ENGINE_SET_VIDEO_HOOK",
        enabled: e
      }))
    },
    setExperimentalSoundshare(e) {
      D() || ((0, c.Z)("experimental_soundshare_enabled", e, p.Z.getExperimentalSoundshare()), a.Z.dispatch({
        type: "MEDIA_ENGINE_SET_EXPERIMENTAL_SOUNDSHARE",
        enabled: e
      }))
    },
    setUseSystemScreensharePicker(e) {
      D() || ((0, c.Z)("system_screenshare_picker_enabled", e, p.Z.getUseSystemScreensharePicker()), a.Z.dispatch({
        type: "MEDIA_ENGINE_SET_USE_SYSTEM_SCREENSHARE_PICKER",
        enabled: e
      }))
    },
    async setAudioSubsystem(e) {
      D() || (await (0, c.Z)("audio_subsystem", e, p.Z.getAudioSubsystem()), a.Z.dispatch({
    ...
    setAecDump(e) {
      D() || ((0, c.Z)("diagnostic_audio_recording_enabled", e, p.Z.getAecDump()), a.Z.dispatch({
