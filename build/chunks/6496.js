...
function I(e) {
  return g.Z.getForumChannelSessionId(e)
}
...
function M(e) {
  ...
  let {
    channelId: _,
    sessionId: p
  } = e, g = l.Z.getChannel(_);
  if (null == g || !g.isForumPost()) return null;
  let m = l.Z.getChannel(g.parent_id);
  return null != m && m.isForumLikeChannel() ? S(y({}, x({
    channelId: m.id,
    sessionId: p
  })), {
    ...
    thread_locked: null !== (u = null === (n = g.threadMetadata) || void 0 === n ? void 0 : n.locked) && void 0 !== u && u,
    thread_auto_archive_duration_minutes: null !== (d = null === (r = g.threadMetadata) || void 0 === r ? void 0 : r.autoArchiveDuration) && void 0 !== d ? d : 0,
    ...
    forum_post_num_reactions: D(g.id),
    forum_post_num_unique_reactions: P(g.id),
    forum_post_applied_tag_ids: w(g.id),
    forum_post_is_pinned: g.hasFlag(E.zZ.PINNED),
    forum_post_is_new: null === (i = h.Z.getReadStateSnapshotAnalytics(g.id)) || void 0 === i ? void 0 : i.isNew,
    forum_post_is_unread: null === (c = h.Z.getReadStateSnapshotAnalytics(g.id)) || void 0 === c ? void 0 : c.hasUnreads,
    forum_post_is_following: o.Z.hasJoined(g.id),
    forum_post_attachment_mimetypes: L(g.id)
  }) : null
}