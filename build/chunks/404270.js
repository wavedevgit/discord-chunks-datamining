...
let x = e => {
  ...
  let {
    className: n
  } = e, i = (0, a.e7)([c.default], () => c.default.getCurrentUser()), x = (0, a.e7)([o.default], () => o.default.locale), j = (0, a.e7)([u.ZP], () => u.ZP.getPremiumTypeSubscription()), N = (0, a.e7)([d.Z], () => null != j ? d.Z.get(j.planId) : void 0), v = null != (t = (0, a.e7)([d.Z], () => null != N ? d.Z.getForSkuAndInterval((0, g.Wz)(f.Si.GUILD), N.interval, N.intervalCount) : void 0)) ? t : f.GP[f.Xh.PREMIUM_MONTH_GUILD];
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(l.X6q, {
      ...
      children: function(e) {
        ...
        return g.ZP.isPremium(t, f.p9.TIER_2) ? h.NW.format(h.t.N3Icb2, {
          price: c,
          originalPrice: d,
        ...
        }) : g.ZP.isPremium(t, f.p9.TIER_1) ? h.NW.format(h.t.nQLVBA, {
          price: c,
          originalPrice: d,
          originalPriceHook: (e, t) => (0, r.jsx)("span", {
            className: b.originalPrice,
