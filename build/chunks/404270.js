    ...
    children: [(0, r.jsx)(l.X6q, {
      ...
      children: function(e) {
        let {
          ...
          interval: s,
          intervalCount: a
        } = e, l = p.ZP.getDefaultPrice(i, p.ZP.isPremium(t)), o = p.ZP.getDefaultPrice(i, !1), c = (0, g.og)((0, g.T4)(l.amount, l.currency), s, a), d = (0, g.og)((0, g.T4)(o.amount, o.currency), s, a);
        return p.ZP.isPremium(t, h.p9.TIER_2) ? f.NW.format(f.t.N3Icb2, {
          price: c,
          originalPrice: d,
        ...
        }) : p.ZP.isPremium(t, h.p9.TIER_1) ? f.NW.format(f.t.nQLVBA, {
          price: c,
          originalPrice: d,
          originalPriceHook: (e, t) => (0, r.jsx)("span", {
            className: b.originalPrice,
