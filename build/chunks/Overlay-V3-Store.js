...
function eo() {
  X(), k = null, x = null, (0, Chunk145597.setPID)(Chunk145597.UNSET_PID), F()
}
...
function es(e) {
  ...
  return N.verbose("Refreshing OOP host window for pid ".concat(t)), j = t, k = t, x = t, (0, d.setPID)(t), K(t), z(), true
}
...
function eg() {
  D = Chunk509140.Z.getNativeModule(), W()
}
