...
let G = {
  ...
  [Chunk981631.Etm.ACCEPT_ACTIVITY_INVITE]: {
    ...
    handler(e) {
      ...
      if (null == s) throw new A.Z({
        errorCode: k.lTL.INVALID_COMMAND
      }, "No application.");
      let u = Promise.resolve(false);
      return n === k.mFx.JOIN && (u = c.Z.join({
        userId: r,
        sessionId: i,
        applicationId: s,
        channelId: l,
        ...
        if (!e) throw new A.Z({
          errorCode: k.lTL.INVALID_INVITE
  ...
  [Chunk981631.Etm.OPEN_SHARE_MOMENT_DIALOG]: (0, Chunk45792.S)(Chunk981631.Etm.OPEN_SHARE_MOMENT_DIALOG, {
    ...
    handler(e) {
      ...
      let l = (0, w.Z)();
      if (!P.Z.isDiscordCdnUrl(r)) throw new A.Z({
