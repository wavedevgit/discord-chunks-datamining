...
function x(t) {
  ...
  let O = () => {
      L(), c.default.track(h.rMx.BOOSTING_UPSELL_CLICKED, {
        guild_id: x.guild_id,
  ...
  return c.default.track(h.rMx.BOOSTING_UPSELL_VIEWED, {
    guild_id: x.guild_id,
    type: T.cd.VIDEO_STAGE_LIMIT,
    is_moderator: b,
    listener_count: k + N
    ...
    children: [(0, e.jsxs)(s.xBx, {
      ...
      className: I.footer,
      children: M ? (0, e.jsxs)(e.Fragment, {
        children: [(0, e.jsx)(a.zx, {
          look: a.iL.LINK,
