/** Chunk was on web.js **/
/** chunk id: 887695, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  FV: () => m,
  Ff: () => b,
...
let p = (0, Chunk23339.xI)(Chunk319060.A.EMOJI_PICKER_CONSTANTS_EMOJI_LIST_PADDING_LEFT),
  ...
  m = e => {
    let {
      ...
      listRef: n,
      searchQuery: i
    } = e, a = r.useRef(i), s = r.useRef(true);
    r.useLayoutEffect(() => {
      if ("" === i && "" !== a.current) {
        var e;
      ...
      if (s.current) {
        var e;
        null == (e = n.current) || e.scrollToSectionTop(t), s.current = false
      }
    }, [t, n]), r.useEffect(() => {
      a.current = i
    }, [i])
