...
function F(e) {
  let {
    ...
    sourceChanged: l,
    onChangeSource: i
  } = e, s = (0, a.e7)([m.ZP, y.Z], () => (0, O.isWindows)() ? (0, T.Z)(m.ZP, y.Z) : null), c = (0, a.e7)([d.Z], () => (null == s ? void 0 : s.id) != null ? d.Z.getApplication(s.id) : null), u = (0, a.e7)([m.ZP], () => m.ZP.getRunningGames()), f = (0, a.Wu)([d.Z], () => u.map(e => null != e.id ? d.Z.getApplication(e.id) : null).filter(I.lm), [u]), x = null;
...
function Y(e) {
  let {
    ...
    p.eo.updateSetting(t), Z.default.track(G.rMx.NOTIFY_STREAM_SETTING_UPDATE, {
      value: t
    })
  }, []);
  return n >= 2 && n <= D.tB ? (0, r.jsx)(o.xJW, {
...
function K(e) {
  ...
  } = e, K = (0, a.e7)([S.Z, _.Z], () => _.Z.getChannel(S.Z.getVoiceChannelId())), q = (0, a.e7)([N.Z], () => N.Z.GPUDriversOutdated), Q = (0, a.e7)([N.Z], () => N.Z.problematicGPUDriver), $ = (0, a.e7)([C.default], () => C.default.getCurrentUser()), ee = (0, E.Z)();
  ...
  return (0, r.jsxs)(l.Fragment, {
    children: [et ? (0, r.jsx)(P.Z, {
      ...
      text: U.intl.format(U.t.RrLvub, {
        helpCenterLink: w.Z.getArticleURL(G.BhN.NVIDIA_DRIVER_ISSUES)
      })
    }) : null, el && (0, r.jsx)(g.Z, {
      look: g.z.WARNING,
