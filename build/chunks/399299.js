...
function F(e) {
  let {
    ...
    sourceChanged: i,
    onChangeSource: l
  } = e, s = (0, o.e7)([m.ZP, y.Z], () => (0, w.isWindows)() ? (0, T.Z)(m.ZP, y.Z) : null), c = (0, o.e7)([d.Z], () => (null == s ? void 0 : s.id) != null ? d.Z.getApplication(s.id) : null), u = (0, o.e7)([m.ZP], () => m.ZP.getRunningGames()), f = (0, o.Wu)([d.Z], () => u.map(e => null != e.id ? d.Z.getApplication(e.id) : null).filter(Z.lm), [u]), p = null;
...
function H(e) {
  let {
    onChange: t,
    guildId: n
  } = e, i = (0, o.e7)([j.Z], () => j.Z.getGuild(n));
  return null == i ? (t(), null) : (0, r.jsx)(a.xJW, {
...
function Y(e) {
  ...
  }), l = x.eo.useSetting(), c = i.useCallback((e, t) => {
    x.eo.updateSetting(t), O.default.track(B.rMx.NOTIFY_STREAM_SETTING_UPDATE, {
      value: t
    })
  }, []);
...
function K(e) {
  ...
  } = e, K = (0, o.e7)([S.Z, _.Z], () => _.Z.getChannel(S.Z.getVoiceChannelId())), q = (0, o.e7)([N.Z], () => N.Z.GPUDriversOutdated), Q = (0, o.e7)([N.Z], () => N.Z.problematicGPUDriver), $ = (0, o.e7)([C.default], () => C.default.getCurrentUser()), ee = (0, E.Z)();
  ...
  return (0, r.jsxs)(i.Fragment, {
    children: [et ? (0, r.jsx)(P.Z, {
      ...
      text: U.intl.string(U.t.q65tS0)
    }) : null, Q ? (0, r.jsx)(V, {
      text: U.intl.format(U.t.RrLvub, {
