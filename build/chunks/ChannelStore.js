...
function ea(e) {
  let t = w;
  for (let n of (M = {}, P = {}, w = {}, j = {}, L = {}, U = {}, F = {}, Z = {}, V = Date.now(), x = e.initialPrivateChannels, e.initialPrivateChannels.forEach(ee), e.guilds)) "partial" === n.dataMode && (a().forEach(t[n.id], en), N.fileOnly("Restoring guild channels for ".concat(n.id, " #:").concat(eL(n.id)))), eo(n);
  ew()
}
...
function eu() {
  N.fileOnly("initializeClear()"), M = {}, P = {}, w = {}, U = {}, j = {}, D = {}, F = {}, L = {}, B = new Set, Z = {}, V = Date.now()
}
