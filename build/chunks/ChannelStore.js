...
let C = new Chunk710845.Z("ChannelStore"),
  R = {},
  P = {},
  w = {},
  D = {},
  ...
  static loadGuildIds(e) {
    ...
    return (0, u.gs)("loadChannels", async () => {
      let e = t.map(e => {
          ...
          if (null != Z[e]) return C.fileOnly("Skipping loading ".concat(e, " because a load is pending")), null;
      ...
      try {
        ...
        for (let n of (C.error("Failed to load channels from disk for " + e.map(e => e.guildId), t), e)) delete Z[n.guildId];
        throw t
      }
      return null
    })
...
function z(e, t, n) {
  ...
  if (null == i) {
    B.add(e), f.Z.restored(e), C.log("load returned null; early returning (guild: ".concat(e, ", database: ").concat(r, ")"));
    return
  }
  let [o, s] = i;
  for (let n of ((0, _.ZP)(o), 0 !== t && (Y += 1), B.add(e), f.Z.restored(e), a.Z.mark("❗", "loaded guild channels (guild: ".concat(e, ")"), s), o)) Object.hasOwn(P, n.id) || en((0, g._H)(n));
  C.verbose("hydration complete (guild: ".concat(e, ", channels: ").concat(o.length, ", guilds_loaded: ").concat(Y, ")"))
}

function q(e, t, n) {
  if (!Object.hasOwn(P, e) && !Object.hasOwn(D, e) && !Object.hasOwn(x, e) && !Object.hasOwn(G, e) && 1 === t) {
...
function Q(e) {
  var t, n, r, i;
  return q(e, 0, "getBasicChannel"), null != (i = null != (r = null != (n = null != (t = P[e]) ? t : D[e]) ? n : x[e]) ? r : G[e]) ? i : f.Z.getBasicChannel(e)
}

function J(e) {
  var t, n, r, i;
  return q(e, 1, "getChannel"), null != (i = null != (r = null != (n = null != (t = P[e]) ? t : D[e]) ? n : x[e]) ? r : G[e]) ? i : V[e]
}
...
function en(e) {
  ...
  P[o] = e, w[a] = null != (t = w[a]) ? t : {}, w[a][o] = e, U[a] = (null != (n = U[a]) ? n : 0) + 1, null != e.linkedLobby ? (M[a] = null != (r = M[a]) ? r : {}, M[a][o] = e) : null == (i = M[a]) || delete i[o]
}
...
function eo(e) {
  let t = w;
  for (let n of (j = {}, P = {}, w = {}, M = {}, x = {}, U = {}, V = {}, Z = {}, F = Date.now(), L = e.initialPrivateChannels, e.initialPrivateChannels.forEach(ee), e.guilds)) "partial" === n.dataMode && (o().forEach(t[n.id], en), C.fileOnly("Restoring guild channels for ".concat(n.id, " #:").concat(ex(n.id)))), ea(n);
  ew()
}
...
function ea(e) {
  ...
  switch (n.op) {
    case "full_sync":
      for (let e of (C.fileOnly("ConnectionOpen contained full channels for ".concat(t, " #:").concat(n.items.length)), X(t), B.add(t), f.Z.restored(t), n.items)) en(e);
      break;
    case "update":
...
function el(e) {
  ...
  P = {}, w = {}, U = {}, M = {}, t.forEach(e => {
    if ("unavailable" === e.data_mode) C.fileOnly("Restoring guild channels b/c unavailable in bg sync, for ".concat(e.id, " #:").concat(ex(e.id))), o().forEach(n[e.id], en);
    else if ("partial" === e.data_mode) {
      var t, r;
      C.fileOnly("Restoring guild channels b/c partial in bg sync, for ".concat(e.id, " #:").concat(ex(e.id))), o().forEach(n[e.id], en);
    ...
    } else C.fileOnly("BG sync contained full channels for ".concat(e.id, " #:").concat(e.channels.length)), X(e.id), B.add(e.id), f.Z.restored(e.id), e.channels.forEach(t => en((0, g.q_)(t, e.id)))
  })
}
...
function ec(e) {
  for (let {
    ...
    of e.channels)
    for (let e of (C.fileOnly("Lazy loaded guild channels for ".concat(t)), (0, _.ZP)(n), B.add(t), f.Z.restored(t), n)) Object.hasOwn(P, e.id) || en((0, g._H)(e));
  returnfalse
}

function eu() {
  C.fileOnly("initializeClear()"), j = {}, P = {}, w = {}, U = {}, M = {}, D = {}, V = {}, x = {}, B = new Set, Z = {}, F = Date.now()
}
...
function ed(e) {
  ...
  for (let e of [n, r])
    for (let t of e) $((0, _.d7)((0, g._H)(t)));
  let i = null == (t = r[0]) ? true : t.guild_id;
...
function e_(e) {
  for (let [t, n] of(W = true, e.guildChannels))
    for (let e of (C.fileOnly("Lazy cache contained full guild channels for ".concat(t, " #:").concat(n.length)), B.add(t), n)) $((0, g._H)(e))
}
...
function eh(e) {
  if (!g.AW.has(e.channel.type)) returnfalse;
  let t = J(e.channel.id);
  if (null == t) t = e.channel;
  else {
    var n;
    t = t.merge(N(S({}, e.channel.toJS()), {
...
function em(e) {
  ...
  $(r.set("permissionOverwrites", N(S({}, r.permissionOverwrites), {
    [n.id]: n
  })))
}
...
function eI(e) {
  ...
  let {
    channel: r
  } = e, i = null != (n = null != (t = P[r.id]) ? t : D[r.id]) ? n : x[r.id];
...
function eS(e) {
  C.fileOnly("GuildDelete of ".concat(e.guild.id)), X(e.guild.id), B.delete(e.guild.id), f.Z.invalidate(e.guild.id)
}
...
class eL extends(r = Chunk442837.ZP.Store) {
  initialize() {
    this.waitFor(Chunk458772.Z, Chunk594174.default, Chunk430824.Z, Chunk853856.Z), this.syncWith([Chunk853856.Z], ew)
  }
  hasChannel(e) {
    return null != Q(e)
  }
  ...
  getChannelIds(e) {
    var t, n;
    return (z(e, 0, "getChannelIds"), null == e) ? b.default.keys(D) : b.default.keys(null != (n = null != (t = f.Z.getGuildBasicChannels(e)) ? t : w[e]) ? n : R)
  }
  ...
  getMutableBasicGuildChannelsForGuild(e) {
    var t, n;
    return z(e, 0, "getMutableBasicGuildChannelsForGuild"), null != (n = null != (t = f.Z.getGuildBasicChannels(e)) ? t : w[e]) ? n : R
  }
  getMutableGuildChannelsForGuild(e) {
    var t;
    return z(e, 1, "getMutableGuildChannelsForGuild"), null != (t = w[e]) ? t : R
  }
  getSortedLinkedChannelsForGuild(e) {
    var t;
    return o().values(null != (t = M[e]) ? t : R).sort((e, t) => b.default.compare(e.id, t.id))
  }
  ...
  getDebugInfo() {
    return {
      ...
      guildSizes: Object.keys(w).sort(Chunk709054.default.compare).map(e => "".concat(e, ": ").concat(ex(e)))
    }
  }
}
