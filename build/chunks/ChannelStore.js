  ...
  static loadGuildIds(e) {
    ...
    return (0, u.gs)("loadChannels", async () => {
      let e = t.map(e => {
          ...
          if (null != Z[e]) return N.fileOnly("Skipping loading ".concat(e, " because a load is pending")), null;
      ...
      try {
        ...
        for (let n of (N.error("Failed to load channels from disk for " + e.map(e => e.guildId), t), e)) delete Z[n.guildId];
        throw t
      }
      return null
    })
...
function z(e, t, n) {
  ...
  if (null == i) {
    B.add(e), f.Z.restored(e), N.log("load returned null; early returning (guild: ".concat(e, ", database: ").concat(r, ")"));
    return
  }
  let [o, s] = i;
  ...
  N.verbose("hydration complete (guild: ".concat(e, ", channels: ").concat(o.length, ", guilds_loaded: ").concat(Y, ")"))
}

function q(e, t, n) {
  if (!Object.hasOwn(P, e) && !Object.hasOwn(D, e) && !Object.hasOwn(L, e) && !Object.hasOwn(G, e) && 1 === t) {
...
function Q(e) {
  var t, n, r, i;
  return q(e, 0, "getBasicChannel"), null != (i = null != (r = null != (n = null != (t = P[e]) ? t : D[e]) ? n : L[e]) ? r : G[e]) ? i : f.Z.getBasicChannel(e)
}

function J(e) {
  var t, n, r, i;
  return q(e, 1, "getChannel"), null != (i = null != (r = null != (n = null != (t = P[e]) ? t : D[e]) ? n : L[e]) ? r : G[e]) ? i : V[e]
}
...
function en(e) {
  ...
  P[o] = e, w[a] = null != (t = w[a]) ? t : {}, w[a][o] = e, U[a] = (null != (n = U[a]) ? n : 0) + 1, null != e.linkedLobby ? (j[a] = null != (r = j[a]) ? r : {}, j[a][o] = e) : null == (i = j[a]) || delete i[o]
}
...
function eo(e) {
  let t = w;
  for (let n of (k = {}, P = {}, w = {}, j = {}, L = {}, U = {}, V = {}, Z = {}, F = Date.now(), x = e.initialPrivateChannels, e.initialPrivateChannels.forEach(ee), e.guilds)) "partial" === n.dataMode && (o().forEach(t[n.id], en), N.fileOnly("Restoring guild channels for ".concat(n.id, " #:").concat(eL(n.id)))), ea(n);
  ew()
}
...
function ea(e) {
  ...
  switch (n.op) {
    case "full_sync":
      for (let e of (N.fileOnly("ConnectionOpen contained full channels for ".concat(t, " #:").concat(n.items.length)), X(t), B.add(t), f.Z.restored(t), n.items)) en(e);
      break;
    case "update":
...
function el(e) {
  ...
  P = {}, w = {}, U = {}, j = {}, t.forEach(e => {
    if ("unavailable" === e.data_mode) N.fileOnly("Restoring guild channels b/c unavailable in bg sync, for ".concat(e.id, " #:").concat(eL(e.id))), o().forEach(n[e.id], en);
    else if ("partial" === e.data_mode) {
      var t, r;
      N.fileOnly("Restoring guild channels b/c partial in bg sync, for ".concat(e.id, " #:").concat(eL(e.id))), o().forEach(n[e.id], en);
...
function ec(e) {
  for (let {
    ...
    of e.channels)
    for (let e of (N.fileOnly("Lazy loaded guild channels for ".concat(t)), (0, _.ZP)(n), B.add(t), f.Z.restored(t), n)) Object.hasOwn(P, e.id) || en((0, g._H)(e));
  returnfalse
}
...
function ev(e) {
  if (null == e) return;
  let t = e.guild_id;
  e.id in D && delete D[e.id], e.id in P && delete P[e.id], e.id in L && delete L[e.id], null != t && (null != w[t] && e.id in w[t] && delete w[t][e.id], null != j[t] && e.id in j[t] && delete j[t][e.id]), ei(e)
}
...
function eI(e) {
  ...
  let {
    channel: r
  } = e, i = null != (n = null != (t = P[r.id]) ? t : D[r.id]) ? n : L[r.id];
...
class ex extends(r = Chunk442837.ZP.Store) {
  ...
  getSortedLinkedChannelsForGuild(e) {
    var t;
    return o().values(null != (t = j[e]) ? t : R).sort((e, t) => b.default.compare(e.id, t.id))
  }
  ...
  getAllThreadsForGuild(e) {
    return o().values(L).filter(t => t.guild_id === e)
  }
