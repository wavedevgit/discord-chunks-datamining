...
function z(e, t, n) {
  ...
  let [o, s] = i;
  for (let n of ((0, p.ZP)(o), 0 !== t && (Y += 1), Z.add(e), f.Z.restored(e), a.Z.mark("❗", "loaded guild channels (guild: ".concat(e, ")"), s), o)) Object.hasOwn(R, n.id) || en((0, g._H)(n));
...
function J(e) {
  var t, n, r, i;
  return q(e, 1, "getChannel"), null != (i = null != (r = null != (n = null != (t = R[e]) ? t : D[e]) ? n : L[e]) ? r : G[e]) ? i : V[e]
}
...
function en(e) {
  ...
  R[o] = e, w[a] = null != (t = w[a]) ? t : {}, w[a][o] = e, U[a] = (null != (n = U[a]) ? n : 0) + 1, null != e.linkedLobby ? (j[a] = null != (r = j[a]) ? r : {}, j[a][o] = e) : null == (i = j[a]) || delete i[o]
}
...
function eo(e) {
  let t = w;
  for (let n of (M = {}, R = {}, w = {}, j = {}, L = {}, U = {}, V = {}, F = {}, B = Date.now(), x = e.initialPrivateChannels, e.initialPrivateChannels.forEach(ee), e.guilds)) "partial" === n.dataMode && (o().forEach(t[n.id], en), N.fileOnly("Restoring guild channels for ".concat(n.id, " #:").concat(eL(n.id)))), ea(n);
  ew()
}
...
function ec(e) {
  for (let {
    ...
    of e.channels)
    for (let e of (N.fileOnly("Lazy loaded guild channels for ".concat(t)), (0, p.ZP)(n), Z.add(t), f.Z.restored(t), n)) Object.hasOwn(R, e.id) || en((0, g._H)(e));
  returnfalse
}
...
function ev(e) {
  if (null == e) return;
  let t = e.guild_id;
  e.id in D && delete D[e.id], e.id in R && delete R[e.id], e.id in L && delete L[e.id], null != t && (null != w[t] && e.id in w[t] && delete w[t][e.id], null != j[t] && e.id in j[t] && delete j[t][e.id]), ei(e)
}
...
function eS(e) {
  ...
  let {
    channel: r
  } = e, i = null != (n = null != (t = R[r.id]) ? t : D[r.id]) ? n : L[r.id];
...
class ex extends(r = Chunk442837.ZP.Store) {
  ...
  getChannelIds(e) {
    var t, n;
    return (z(e, 0, "getChannelIds"), null == e) ? b.default.keys(D) : b.default.keys(null != (n = null != (t = f.Z.getGuildBasicChannels(e)) ? t : w[e]) ? n : P)
  }
  ...
  getMutableBasicGuildChannelsForGuild(e) {
    var t, n;
    return z(e, 0, "getMutableBasicGuildChannelsForGuild"), null != (n = null != (t = f.Z.getGuildBasicChannels(e)) ? t : w[e]) ? n : P
  }
  getMutableGuildChannelsForGuild(e) {
    var t;
    return z(e, 1, "getMutableGuildChannelsForGuild"), null != (t = w[e]) ? t : P
  }
  getSortedLinkedChannelsForGuild(e) {
    var t;
    return o().values(null != (t = j[e]) ? t : P).sort((e, t) => b.default.compare(e.id, t.id))
  }
