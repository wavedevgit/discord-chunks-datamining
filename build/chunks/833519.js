...
function z(e) {
  let {
    ...
    width: o,
    premiumIndicator: l
  } = e, c = (0, s.e7)([I.Z], () => I.Z.getActiveStreamForUser(t.user.id, t.stream.guildId)), u = (0, M.K)(o);
  return (0, r.jsxs)(r.Fragment, {
    children: [n || i ? null : (0, r.jsx)(j.Z, {
      participant: t
...
function q(e) {
  let {
    ...
    wrapperClassName: V,
    paused: z = !1
  } = e, q = A.Z.getVideoComponent(), $ = (0, s.e7)([T.default], () => T.default.getId()), X = (0, m.Z)(), {
    stream: Q,
    user: J,
    streamId: ee
  } = t, et = (0, s.e7)([S.Z], () => S.Z.getChannel(Q.channelId)), en = (0, s.e7)([I.Z], () => I.Z.getActiveStreamForUser(J.id, Q.guildId), [J.id, Q.guildId]), er = (0, s.e7)([I.Z], () => I.Z.getAllActiveStreams().length > 0), ei = (0, s.e7)([N.Z], () => N.Z.isFocused()), ea = (null == en ? void 0 : en.ownerId) === $, eo = ea && !ei && !p, es = null != en ? (0, g.Z)(en, J, J.id === $, eo) : null, el = j < Y;
  (0, d.ZP)(() => {
  ...
  if ((null == en ? void 0 : en.state) === U.jm8.ENDED) return (0, r.jsx)(P.Z, {
    selected: n,
    stream: en,
    width: j
  });
  if (null != ec || (null == en ? void 0 : en.state) === U.jm8.FAILED) return (0, r.jsx)(D.Z, {
  ...
  if (!(null != en && !n && null != q && A.Z.supports(B.AN.VIDEO))) return (0, r.jsxs)("div", {
    className: o()(F.content, F.streamPreview, {
      [F.small]: el
    }),
    children: [(0, r.jsx)(E.Z, {
      noImage: !0,
      noText: !0,
      className: o()(F.absoluteFill, {
