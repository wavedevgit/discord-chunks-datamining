...
function q(e) {
  let {
    ...
    user: $,
    streamId: ee
  } = t, et = (0, s.e7)([S.Z], () => S.Z.getChannel(J.channelId)), en = (0, s.e7)([I.Z], () => I.Z.getActiveStreamForUser($.id, J.guildId), [$.id, J.guildId]), er = (0, s.e7)([I.Z], () => I.Z.getAllActiveStreams().length > 0), ei = (0, s.e7)([N.Z], () => N.Z.isFocused()), eo = (null == en ? void 0 : en.ownerId) === X, ea = eo && !ei && !p, es = null != en ? (0, g.Z)(en, $, $.id === X, ea) : null, el = k < Y;
  (0, d.ZP)(() => {
  ...
  if ((null == en ? void 0 : en.state) === U.jm8.ENDED) return (0, r.jsx)(w.Z, {
    selected: n,
    stream: en,
    width: k
  });
