...
function N(e, t, n, o) {
  ...
  if (null != t) {
    ...
    if (n.numDatapoints >= v) {
      var a;
      return null !== (a = T(e, null == o ? void 0 : o.maxFrameRate, i)) && void 0 !== a ? a : T(n, null == o ? void 0 : o.maxFrameRate, i)
    }
  }
...
function C(e) {
  if (null != e) {
    let n = I(e, E),
      r = I(e, b);
    if (r.numDatapoints >= v) {
      var t;
      return null !== (t = A(n)) && void 0 !== t ? t : A(r)
    }
  }
  return null
}