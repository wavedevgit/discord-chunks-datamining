...
function d(e) {
  let {
    searchContext: t
  } = e, n = u(t), l = i.Z.getState(t, e => e.getQueryString()), a = i.Z.getState(t, e => e.getTextInputValue());
  r.ZP.trackWithMetadata(o.rMx.SEARCH_V2_RESULT_EMPTY, c(s({}, n), {
...
function m(e) {
  ...
  r.ZP.trackWithMetadata(o.rMx.SEARCH_V2_STARTED, c(s({}, n), {
    search_query_length: l.trim().length,
    search_query_content_length: a.trim().length
  }))
}