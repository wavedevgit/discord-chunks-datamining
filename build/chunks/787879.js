...
function U() {
  ...
  return r.map(e => e.id).sort((e, t) => I.default.compare(b.ZP.lastMessageId(t), b.ZP.lastMessageId(e))).reduce((e, t) => (b.ZP.lastMessageTimestamp(t) > Date.now() - T.ib ? e.notifyingChannelIds.push(t) : e.staleChannelIds.push(t), e), {
    notifyingChannelIds: [],
    staleChannelIds: []
  })
}
...
function V(e) {
  ...
  let t = m.Z.getBasicChannel(e),
    n = E.Z.getMessages(e);
  if (n.hasPresent() && 0 !== n.length) return G([...w, ...n.filter(e => {
    var t;
