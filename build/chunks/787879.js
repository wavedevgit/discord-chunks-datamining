...
function G() {
  ...
  return r.map(e => e.id).sort((e, t) => I.default.compare(b.ZP.lastMessageId(t), b.ZP.lastMessageId(e))).reduce((e, t) => (b.ZP.lastMessageTimestamp(t) > Date.now() - S.ib ? e.notifyingChannelIds.push(t) : e.staleChannelIds.push(t), e), {
    notifyingChannelIds: [],
    staleChannelIds: []
  })
}
...
function F(e) {
  ...
  let t = m.Z.getBasicChannel(e),
    n = E.Z.getMessages(e);
  if (n.hasPresent() && 0 !== n.length) return B([...D, ...n.filter(e => {
    var t;
...
function et(e, t) {
  var n;
  if (null == (null == (n = T.Lk.getCurrentConfig({
      location: "NotificationsInboxStore.canLoadMore"
    })) ? void 0 : n.notificationCenterVariant) || null == P || L || t && !U) return !1;
