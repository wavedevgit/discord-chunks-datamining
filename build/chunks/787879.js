...
n.d(t, {
  Z: () => eE
}), n(361932), n(187205), n(539854), n(388685), n(642613), n(387201);
var r, i = n(512722),
  o = n.n(i),
  a = n(442837),
  s = n(570140),
...
function V() {
  ...
  return r.map(e => e.id).sort((e, t) => {
    ...
    return n !== E.ZP.hasUnread(t) ? n ? -1 : 1 : v.default.compare(E.ZP.lastMessageId(t), E.ZP.lastMessageId(e))
...
function W() {
  ...
  for (let e of n)
    if (P[e] = {
      ...
      if (null != t) {
        var i, a;
        P[e].loadState = A.a7.LOADED, P[e].mostRecentMessageId = null != (a = null == (i = t.last()) ? void 0 : i.id) ? a : P[e].mostRecentMessageId
      }
    } L.updateChannelIds(w), Y()
}

function K() {
  P = {}, w = null, D = [], L = new S.Z, x = !1, M = !1, k = !1, U = v.default.fromTimestamp(Date.now()), G = !0, j = !1, Z = null, B = null
}
...
function z() {
  ...
  for (let n of (W(), null != w ? w : [])) {
    let r = H(n);
    null != r && (P[n].loadState = A.a7.LOADED, P[n].mostRecentMessageId = null != (t = null == (e = r.last()) ? void 0 : e.id) ? t : null, Y())
  }
...
function J(e) {
  ...
  if (null == w || (null == (t = o.author) ? void 0 : t.id) === (null == (n = O.default.getCurrentUser()) ? void 0 : n.id)) return !1;
  let a = w.includes(i),
    s = Q(o),
    l = s.mentioned;
  if (!a && !l) {
...
function eo(e) {
  ...
  return null != (null == (t = (0, I.Ag)({
    ...
    autoTrackExposure: !1
  })) ? void 0 : t.notificationCenterVariant) && null != w && !x && !M && (!n || !j) && G
}
...
function e_(e) {
  ...
  let {
    ...
    addedMembers: r,
    removedMemberIds: i
  } = e, o = null == (t = O.default.getCurrentUser()) ? void 0 : t.id;
  if (null == o) return !1;
