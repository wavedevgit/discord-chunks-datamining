...
function V(e) {
  ...
  let n = p.Z.getBasicChannel(e),
    r = m.Z.getMessages(e);
  if (r.hasPresent() && 0 !== r.length) return D.addChannelMessages({
    channel: n,
    channelMessages: r,
...
function W() {
  R = {}, P = null, w = [], D = new T.Z, L = !1, x = !1, M = !1, j = O.default.fromTimestamp(Date.now()), U = !0, k = !1, B = null, G = null
}
...
function ef(e) {
  ...
  let {
    ...
    addedMembers: r,
    removedMemberIds: i
  } = e, o = null == (t = y.default.getCurrentUser()) ? void 0 : t.id;
  if (null == o) return !1;
