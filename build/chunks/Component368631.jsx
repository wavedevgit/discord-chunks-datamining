  ...
  eY = e => {
    ...
    return Object.freeze({
      ...
      [eC.H.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eC.H.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === W.Ay.releaseChannel || "development" === W.Ay.releaseChannel) && eX && G.A.supports(ew.O5.CONNECTION_REPLAY)
      },
      [eC.H.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eR.nc_.VOICE,
        searchableTitles: [eP.intl.string(eP.t["726JHL"])],
        parent: eC.H.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => Y.isPlatformEmbedded && G.A.supports(ew.O5.DEBUG_LOGGING) && null != _.A.fileManager.readLogFiles
      },
      ...
      [eC.H.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          F.default.track(eR.HAw.USER_SETTINGS_MERCH_LINK_CLICKED), (0, H.h)({
            href: e,
            shouldConfirm: true,
            onConfirm: () => {
