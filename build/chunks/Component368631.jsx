/** Chunk was on web.js **/
/** chunk id: 368631, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  AW: () => eG,
  Jn: () => eV,
...
let eU = () => [a.M.CLIENT_THEMES_SETTINGS_BADGE, a.M.DEKSTOP_CUSTOM_APP_ICON_BADGE, a.M.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE],
  eG = () => {
    let e = eU(),
      [t] = (0, O.kn)(e);
  ...
  eB = () => {
    let e = [];
    return L.S.getConfig({
      location: "SettingsRendererConfig"
    }).enabled && e.push(a.M.NITRO_PRIVACY_PERK_NEW_BADGE_V2), e
  },
  eH = () => {
    let e = eB(),
      [t] = (0, O.kn)(e);
  ...
  eW = e => {
    let {
      ...
      isClipsBetaTagShowing: eq = false,
    ...
    return Object.freeze({
      ...
      [eN.H.ACCOUNT_AGE_GROUP]: {
        searchableTitles: [eD.intl.string(eD.t["/52UYy"]), eD.intl.string(eD.t.sK0dmH), eD.intl.string(eD.t.XxRj7f), eD.intl.string(eD.t.yNGjyK), eD.intl.string(eD.t.KPGVWl)],
        section: ew.nc_.ACCOUNT,
        parent: eN.H.ACCOUNT_PROFILE,
        predicate: () => e9
      },
      ...
      [eN.H.VOICE_AND_VIDEO_DEVICES]: {
        section: ew.nc_.VOICE,
        searchableTitles: [eD.intl.string(eD.t.hHMYbb), eD.intl.string(eD.t.dl18zb), eD.intl.string(eD.t.nuFtHH), eD.intl.string(eD.t["3182VD"]), eD.intl.string(eD.t["DGq/PR"])],
        parent: eN.H.VOICE_AND_VIDEO_VOICE
      },
      [eN.H.VOICE_AND_VIDEO_VOLUME_CONTROLS]: {
        section: ew.nc_.VOICE,
        searchableTitles: [eD.intl.string(eD.t.OX2Bnr), eD.intl.string(eD.t.eATD2B), eD.intl.string(eD.t.nuFtHH), eD.intl.string(eD.t["3182VD"]), eD.intl.string(eD.t["DGq/PR"])],
        parent: eN.H.VOICE_AND_VIDEO_VOICE
      },
      ...
      [eN.H.VOICE_AND_VIDEO_INPUT_PROFILE]: {
        section: ew.nc_.VOICE,
        searchableTitles: [eD.intl.string(eD.t.LM3U3k), eD.intl.string(eD.t.nuFtHH), eD.intl.string(eD.t.VZPR0R), eD.intl.string(eD.t.cjPbpT)],
        parent: eN.H.VOICE_AND_VIDEO_VOICE,
        predicate: () => {
          let {
      ...
      [eN.H.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        ...
        parent: eN.H.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => ("canary" === W.Ay.releaseChannel || "development" === W.Ay.releaseChannel) && eZ && G.A.supports(eP.O5.CONNECTION_REPLAY)
      },
      [eN.H.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: ew.nc_.VOICE,
        searchableTitles: [eD.intl.string(eD.t["726JHL"])],
        parent: eN.H.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => Y.isPlatformEmbedded && G.A.supports(eP.O5.DEBUG_LOGGING) && null != _.A.fileManager.readLogFiles
      },
      ...
      [eN.H.STREAMER_MODE_HIDE_DISCORD_WINDOW_FROM_SCREEN_CAPTURE]: {
        ...
        predicate: () => {
          var e, t, n;
          return null != (e = null === _.A || true === _.A || null == (n = _.A.window) || null == (t = n.supportsContentProtection) ? true : t.call(n)) && e
        }
      },
