/** Chunk was on web.js **/
/** chunk id: 403992, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  J: () => a
});
var Chunk473411 = require("./473411.js"),
...
class a {
  ...
  getKeyRightOf(e) {
    ...
    if (this.isRow(c)) {
      ...
      return null != (r = "rtl" === this.direction ? null == (t = (0, i.W)(e)) ? true : t.key : null == (n = (0, i.ue)(e)) ? true : n.key) ? r : null
    }
  ...
  getKeyLeftOf(e) {
    ...
    if (this.isRow(c)) {
      let e = (0, i.iQ)(c, this.collection);
      return null != (r = "rtl" === this.direction ? null == (t = (0, i.ue)(e)) ? true : t.key : null == (n = (0, i.W)(e)) ? true : n.key) ? r : null
    }
    if (this.isCell(c) && null != c.parentKey) {
      let t = this.collection.getItem(c.parentKey);
      if (!t) return null;
  ...
  getFirstKey(e, t) {
    ...
    if (null != l) {
      ...
      if (this.isCell(o) && !t && null != o.parentKey) {
        ...
        return e && null != (r = null == (n = (0, i.ue)((0, i.iQ)(e, this.collection))) ? true : n.key) ? r : null
      }
    }
    if (null != (l = this.findNextKey(true, e => "item" === e.type)) && (o && this.isCell(o) && t || "cell" === this.focusMode)) {
      let e = this.collection.getItem(l);
      if (!e) return null;
      l = null != (s = null == (a = (0, i.ue)((0, i.iQ)(e, this.collection))) ? true : a.key) ? s : null
    }
    return l
  }
  getLastKey(e, t) {
    ...
    if (null != l) {
      ...
      if (this.isCell(o) && !t && null != o.parentKey) {
        ...
        return null != (r = null == (n = (0, i.W)(t)) ? true : n.key) ? r : null
      }
    }
    if (null != (l = this.findPreviousKey(true, e => "item" === e.type)) && (o && this.isCell(o) && t || "cell" === this.focusMode)) {
      let e = this.collection.getItem(l);
      if (!e) return null;
      let t = (0, i.iQ)(e, this.collection);
      l = null != (s = null == (a = (0, i.W)(t)) ? true : a.key) ? s : null
    }
    return l
  }
  getKeyPageAbove(e) {
    ...
    for (; null != s;) {
      ...
      if (t.textValue) {
        ...
        if (0 === this.collator.compare(n, e)) {
          if (this.isRow(t) && "cell" === this.focusMode) return null != (a = null == (r = (0, i.ue)((0, i.iQ)(t, this.collection))) ? true : r.key) ? a : null;
          return t.key
        }
      }
      null != (s = this.findNextKey(s, e => "item" === e.type)) || c || (s = this.getFirstKey(), c = true)
    }
    return null
  }
  constructor(e) {
