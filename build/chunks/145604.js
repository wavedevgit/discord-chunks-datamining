  ...
  componentDidUpdate(e) {
    ...
    if (e.voiceChannelId !== O && null != O) {
      let e = _.ZP.getCurrentGameForAnalytics(),
        t = null != e ? e.name : "",
        n = P.Z.getStageInstanceByChannel(O),
        r = y.ZP.getActiveEventByChannel(O);
      (0, u.yw)(K.rMx.CHANNEL_OPENED, X({}, (0, u.$H)(O))), (0, p.a)(K.rMx.CHANNEL_OPENED_CLICKSTREAM, {
        channelId: O
      });
      let i = null,
    ...
    if ((e.videoEnabled !== L || e.isScreenSharing !== k) && null != O) {
      let e = "none",
      ...
      }, n, this.getGameMetadata(), (0, u.AB)(O)))
    }
...
function J() {
  ...
  }, [d, s]), h = (0, l.e7)([H.ZP], () => H.ZP.getState().section, []), f = (0, l.e7)([V.Z], () => V.Z.getHomeLink(), []), m = (0, l.e7)([O.Z], () => O.Z.isConnected(), []), [b, y] = (0, l.Wu)([L.Z], () => [L.Z.isVideoEnabled(), L.Z.isScreenSharing()], []), I = (0, l.e7)([U.Z], () => U.Z.getPrimaryActivity(), []), C = (0, l.e7)([_.ZP], () => _.ZP.getCurrentGameForAnalytics(), []), S = (0, E.Z)(s), N = (0, l.e7)([v.Z], () => v.Z.getMessageRequestsCount(), []), T = {
    selectedChannelId: t,
    isNSFWChannel: a,
    selectedGuildId: s,
    friendsTabSection: h,
