...
class Q extends i.PureComponent {
  componentDidUpdate(e) {
    ...
    if (e.voiceChannelId !== r && null != r) {
      ...
      (0, u.yw)(K.rMx.CHANNEL_OPENED, X({}, (0, u.$H)(r))), (0, p.a)(K.rMx.CHANNEL_OPENED_CLICKSTREAM, {
        channelId: r
      });
      let s = null,
        h = F.default.getFocusedPID();
      null != h && N.default.getOverlayMethod(h) !== o.gl.Disabled && (F.default.isInstanceLocked() ? s = K.ADE.OVERLAY_LOCKED_ACTIVATED : F.default.isInstanceLocked() || (s = F.default.isPinned(K.Odu.TEXT) ? K.ADE.OVERLAY_UNLOCKED_PINNED : K.ADE.OVERLAY_UNLOCKED)), z.default.track(K.rMx.JOIN_VOICE_CHANNEL, X({
        location: s,
        channel_id: r,
        channel_type: l,
        channel_bitrate: c,
      ...
      }, (0, u.oG)(i, r), (0, u.kO)(i, r, d)))
    }
    if (e.runningGame !== E && null != E && !E.isLauncher) {
      let e = Z.Z.getGameByName(E.name),
        n = _.ZP.getOverrideForGame(E),
        u = L.Z.getGuildIds(),
        d = j.SE.getSetting(),
      ...
      let f = (0, _.b6)(E),
        g = null != (t = N.default.getOverlayMethod(E.pid)) ? t : f.overlayMethod;
      if (setTimeout(async () => {
          var t;
          let n = await (0, T.hj)(E.pid),
            {
              gameName: a,
              gameId: u,
              exe: d,
            ...
            O = (0, S.NW)("ChatAutoAnalytics", !1),
            y = f.enabledLegacy || O && f.enabledOOP,
            I = C.v.legacyEnabled || O && C.v.oopEnabled,
            v = f.source;
          z.default.track(K.rMx.LAUNCH_GAME, {
            ...
            elevated: E.elevated,
            is_launcher: null != (t = null == E ? void 0 : E.isLauncher) && t,
            ...
            distributor_game_id: E.sku,
            hidden_by_distributor: E.hidden
          }), null != d && _.ZP.addExecutableTrackedByAnalytics(d)
        }, 1e4), null != E.name && null != O && Z.Z.shouldReport(E.name)) {
        let e = E.name;
        a.Z.identifyGame(O, e).then(e => a.Z.reportUnverifiedGame(e)).catch(e => new m.Z("AutoAnalytics").error("Cannot identify game", e))
      }
    }
    if ((e.videoEnabled !== d || e.isScreenSharing !== h) && null != r) {
      let e = "none",
        ...
        n = null;
      h ? (e = "screen", n = (0, f.t)()) : d && (e = "camera"), z.default.track(K.rMx.VIDEO_INPUT_TOGGLED, X({
        video_input_type: e,
        video_toggle_source: __OVERLAY__ ? "overlay" : "app",
        enabled_inputs: t,
        preview_enabled: j.qF.getSetting()
      }, n, this.getGameMetadata(), (0, u.AB)(r)))
    }
...
function J() {
  let [e, t] = (0, l.Wu)([k.Z], () => [k.Z.getVoiceChannelId(), k.Z.getChannelId()], []), n = (0, l.e7)([A.Z], () => A.Z.getChannel(t), [t]), a = (0, l.e7)([g.Z], () => (null == n ? void 0 : n.id) != null && g.Z.getChatOpen(n.id), [n]), o = null == n ? void 0 : n.nsfw, s = (0, l.e7)([A.Z], () => A.Z.getChannel(e), [e]), f = (0, l.e7)([M.Z], () => M.Z.getGuildId(), []), m = (0, l.e7)([L.Z], () => L.Z.getGuild(f), [f]), b = (0, l.e7)([B.default], () => B.default.getCurrentUser(), []), y = (0, l.e7)([x.ZP], () => {
    var e, t;
    return null != b && null != f && null != (t = null == (e = x.ZP.getMember(f, b.id)) ? void 0 : e.isPending) && t
  }, [b, f]), C = (0, l.e7)([H.ZP], () => H.ZP.getState().section, []), S = (0, l.e7)([V.Z], () => V.Z.getHomeLink(), []), N = (0, l.e7)([E.Z], () => E.Z.isConnected(), []), [T, P] = (0, l.Wu)([w.Z], () => [w.Z.isVideoEnabled(), w.Z.isScreenSharing()], []), j = (0, l.e7)([U.Z], () => U.Z.getPrimaryActivity(), []), Z = (0, l.e7)([_.ZP], () => _.ZP.getCurrentGameForAnalytics(), []), R = (0, O.Z)(f), D = (0, l.e7)([v.Z], () => v.Z.getMessageRequestsCount(), []), F = {
    selectedChannelId: t,
    isNSFWChannel: o,
    selectedGuildId: f,
    friendsTabSection: C,
  ...
  i.useEffect(() => {
    if (Y && null != ee) {
      ...
      (0, u.yw)(K.rMx.CHANNEL_OPENED, X({}, e, (0, u.$H)(ee))), (0, p.a)(K.rMx.CHANNEL_OPENED_CLICKSTREAM, {
        channelId: ee
      }), W.current.isTextInVoice && (0, u.yw)(K.rMx.TEXT_IN_VOICE_OPENED, {
        channel_is_nsfw: W.current.isNSFWChannel
      })
    }
  }, [Y, ee]), i.useEffect(() => {
    Y && null == et && J === K.Z5c.FRIENDS && (0, h.Z)({
      tab_opened: q
    })
  }, [Y, q, J, et]), i.useEffect(() => {
    if (Y && null != et) {
      var e, t, n, r;
      let i = (n = X({}, $ ? {
        is_pending: $,
      ...
      (0, u.yw)(K.rMx.GUILD_VIEWED, i), (0, p.a)(K.rMx.GUILD_VIEWED_CLICKSTREAM, {
        guildId: et
      })
    }
  }, [Y, et, $]);
  let en = i.useRef(!1);
  return i.useEffect(() => {
    Y && null == et && J === K.Z5c.MESSAGE_REQUESTS && !en.current && (en.current = !0, z.default.track(K.rMx.MESSAGE_REQUESTS_INITIALIZED, {
      num_message_requests: W.current.numMessageRequests
    }))
  }, [Y, et, J]), (0, r.jsx)(Q, X({}, F))
}