...
class J extends i.PureComponent {
  componentDidUpdate(e) {
    ...
    if (e.voiceChannelId !== d && null != d) {
      ...
      (0, u.yw)(q.rMx.CHANNEL_OPENED, X({}, (0, u.$H)(d))), (0, p.a)(q.rMx.CHANNEL_OPENED_CLICKSTREAM, {
        channelId: d
      });
      let i = null,
        l = z.default.getFocusedPID();
      null != l && N.default.getOverlayMethod(l) !== o.gl.Disabled && (z.default.isInstanceLocked() ? i = q.ADE.OVERLAY_LOCKED_ACTIVATED : z.default.isInstanceLocked() || (i = z.default.isPinned(q.Odu.TEXT) ? q.ADE.OVERLAY_UNLOCKED_PINNED : q.ADE.OVERLAY_UNLOCKED)), W.default.track(q.rMx.JOIN_VOICE_CHANNEL, X({
        location: i,
        channel_id: d,
        channel_type: E,
        channel_bitrate: O,
    ...
    if ((e.videoEnabled !== I || e.isScreenSharing !== v) && null != d) {
      let e = "none",
        ...
        n = null;
      v ? (e = "screen", n = (0, f.t)()) : I && (e = "camera"), W.default.track(q.rMx.VIDEO_INPUT_TOGGLED, X({
        video_input_type: e,
...
function $() {
  ...
  }, [b, f]), C = (0, l.e7)([F.ZP], () => F.ZP.getState().section, []), S = (0, l.e7)([H.Z], () => H.Z.getHomeLink(), []), N = (0, l.e7)([E.Z], () => E.Z.isConnected(), []), [T, P] = (0, l.Wu)([R.Z], () => [R.Z.isVideoEnabled(), R.Z.isScreenSharing()], []), j = (0, l.e7)([G.Z], () => G.Z.getPrimaryActivity(), []), A = (0, l.e7)([_.ZP], () => _.ZP.getCurrentGameForAnalytics(), []), x = (0, O.Z)(f), D = (0, l.e7)([v.Z], () => v.Z.getMessageRequestsCount(), []), k = {
    selectedChannelId: t,
    isNSFWChannel: o,
    selectedGuildId: f,
    friendsTabSection: C,
  ...
  i.useEffect(() => {
    if (Y && null != ee) {
      ...
      (0, u.yw)(q.rMx.CHANNEL_OPENED, X({}, e, (0, u.$H)(ee))), (0, p.a)(q.rMx.CHANNEL_OPENED_CLICKSTREAM, {
        channelId: ee
    ...
    Y && null == et && Q === q.Z5c.FRIENDS && (0, h.Z)({
      tab_opened: K
    })
