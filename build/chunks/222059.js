...
function R(e) {
  ...
  let {
    ...
    link: m,
    showProgressBadge: b
  } = e, [O, _] = i.useState(!1), [y, C] = i.useState(!1), [v, j] = i.useState(null), [N, R] = i.useState(0), D = (0, l.Ie)("home"), L = (0, d.oq)().activePanel === d.wh.APP_ICON, M = () => {
      ...
      children: (0, r.jsx)(a.LYs, (t = function(e) {
        ...
        onClick: () => {
          if (!__OVERLAY__ && (null != v && clearTimeout(v), j(setTimeout(M, 500)), R(N + 1), 15 === N)) {
            M();
            let e = !s.K.get(P.wli);
            s.K.set(P.wli, e), e && s.K.set(w.O5, !0), e ? (0, f.GN)("discodo") : (0, f.GN)("user_leave"), C(!0), setTimeout(() => {
              C(!1)
            }, 1e3)
          }
        },
...
function D() {
  let e = (0, j.n)(),
    ...
    g = f === a && a > 0 && n + d === 0,
    E = _.Z.getHomeLink();
  return g && (E = P.Z5c.APPLICATION_STORE), (0, r.jsx)(R, {
    selected: e,
    user: u,
