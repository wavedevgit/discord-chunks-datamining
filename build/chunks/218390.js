...
function ea(e) {
  let {
    ...
    theme: s
  } = e, l = t.hasActiveTrial, a = t.planIdFromItems === Q.Xh.PREMIUM_YEAR_TIER_2, c = n || l, d = null != t.trialEndsAt ? o()(t.trialEndsAt).diff(o()(), "d") : 0, m = Q.GP[t.planIdFromItems], p = k.ZP.formatPriceString(k.ZP.getDefaultPrice(m.id), m.interval);
  if (c) {
    var h, f, b;
    return (0, i.jsxs)(i.Fragment, {
      children: [(l || !a) && (0, i.jsx)(W.Cy, {
        ...
        children: l ? $.intl.format($.t["2CGBrq"], {
          remainingTime: d,
          price: p
        }) : a ? $.intl.format($.t["+qqh6u"], {
    ...
    children: [(0, i.jsxs)("div", {
      ...
      children: [(0, i.jsx)(D.Z, {
        ...
        children: [(0, i.jsx)(W.mn, {
          ...
          children: $.intl.format($.t.sK7fGh, {
            helpCenterLink: w.Z.getArticleURL(J.BhN.FRACTIONAL_PREMIUM_ABOUT)
          })
        })]
      }) : d ? (0, i.jsx)(ea, {
        ...
        children: [(0, i.jsx)(W.Cy, {
          ...
          color: "always-white",
          className: ee.trialHeader,
          children: $.intl.format($.t["/SfHws"], {
            weeks: 1
          })
        })]
      }) : null, (0, i.jsx)(Y.nT, {
        featureSet: m ? Y.uZ.FRACTIONAL_PREMIUM : Y.uZ.DEFAULT
        ...
        children: [(0, i.jsx)(z.Z, {
          ...
          onClick: () => {
            Z.default.track(J.rMx.PREMIUM_SETTINGS_INTERACTED, {
              cta_type: ei,
              target: er
            }), (0, h.xf)(), (0, y.uL)(J.Z5c.APPLICATION_STORE)
          },
...
function ec(e) {
  ...
  let {
    className: n,
    config: r
  } = e, s = (0, c.e7)([C.Z], () => C.Z.useReducedMotion) ? r.getStaticImageUrl() : r.getAnimatedImageUrl(), a = (0, U.Tl)(null != (t = r.gradientConfig) ? t : void 0);
  return (0, i.jsxs)("div", {
  ...
  return (0, i.jsx)(O.Gt, {
    ...
    children: (0, i.jsxs)(i.Fragment, {
      children: [(0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(eo, {}), P && (0, i.jsx)(X.Z, {
          isInSettings: !0
        }), (0, i.jsx)(ed, {}), (0, i.jsx)(q.Z, {
        ...
        innerRef: C,
        onChange: e => {
          e && !D && (Z.default.track(J.rMx.PREMIUM_MARKETING_SURFACE_REACHED_BOTTOM, {
            location_stack: t
          }), w(!0))
        },
