...
function eo(e) {
  let {
    ...
    theme: s
  } = e, l = t.hasActiveTrial, a = t.planIdFromItems === J.Xh.PREMIUM_YEAR_TIER_2, c = n || l, d = null != t.trialEndsAt ? o()(t.trialEndsAt).diff(o()(), "d") : 0, g = J.GP[t.planIdFromItems], p = k.ZP.formatPriceString(k.ZP.getDefaultPrice(g.id), g.interval);
  if (c) {
    var h, f, b;
    return (0, i.jsxs)(i.Fragment, {
      children: [(l || !a) && (0, i.jsx)(W.Cy, {
        ...
        children: l ? ee.intl.format(ee.t["2CGBrq"], {
          remainingTime: d,
          price: p
        }) : a ? ee.intl.format(ee.t["+qqh6u"], {
...
function ec() {
  ...
  return (0, i.jsxs)("div", {
    className: l()(et.tierCard, {
      [et.withTier2Rim]: t || p
    }),
    children: [(0, i.jsxs)("div", {
      className: et.tierInfo,
      children: [(0, i.jsx)(D.Z, {
        className: et.tierTitle
        ...
        children: [(0, i.jsx)(W.Cy, {
          ...
          color: "always-white",
          className: et.trialHeader,
          children: ee.intl.format(ee.t["/SfHws"], {
            weeks: 1
          })
        })]
      }) : null, (0, i.jsx)(K.nT, {
        featureSet: g ? K.uZ.FRACTIONAL_PREMIUM : K.uZ.DEFAULT
        ...
        children: [(0, i.jsx)(Y.Z, {
          ...
          onClick: () => {
            Z.default.track($.rMx.PREMIUM_SETTINGS_INTERACTED, {
              cta_type: er,
              target: es
            }), (0, h.xf)(), (0, y.uL)($.Z5c.APPLICATION_STORE)
          },
...
function ed(e) {
  ...
  let {
    className: r,
    config: s
  } = e, a = (0, c.e7)([j.Z], () => j.Z.useReducedMotion) ? s.getStaticImageUrl() : s.getAnimatedImageUrl(), o = (0, U.Tl)(null != (t = s.gradientConfig) ? t : void 0), d = {
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("img", {
      ...
      children: [null != s.getBackgroundImageUrl && (0, i.jsx)("img", {
        ...
        variant: "text-sm/medium",
        children: s.body()
      }), null != s.additionalTerm && (0, i.jsx)(m.Text, {
  ...
  return (0, i.jsx)(O.Gt, {
    ...
    children: (0, i.jsxs)(i.Fragment, {
      children: [(0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(ec, {}), P && (0, i.jsx)(Q.Z, {
          isInSettings: !0
        ...
        innerRef: j,
        onChange: e => {
          e && !D && (Z.default.track($.rMx.PREMIUM_MARKETING_SURFACE_REACHED_BOTTOM, {
            location_stack: t
          }), w(!0))
        },
