/** Chunk was on 13170 **/
/** chunk id: 446302, original params: e,t,r (module,exports,require) **/
require.d(exports, {
  default: () => b
...
function b(e) {
  ...
  })(r), [r]), P = l.useMemo(() => (function(e) {
    let t = new Set;
    for (let l of e) {
      var r, n;
      (null == (r = l.activity) ? true : r.state) != null && t.add(l.activity.state), (null == (n = l.activity) ? true : n.details) != null && t.add(l.activity.details)
    }
    return Array.from(t).sort((e, t) => e.localeCompare(t))
  })(r), [r]), I = l.useMemo(() => (function(e) {
    let t = new Set;
  ...
  })(r), [r]), [M, B] = l.useState(""), [N, D] = l.useState(""), [Q, U] = l.useState(""), _ = l.useMemo(() => 0 === M.trim().length ? S : S.filter(e => a()(M.toLowerCase(), e.name.toLowerCase())), [S, M]), q = l.useMemo(() => 0 === N.trim().length ? I : I.filter(e => a()(N.toLowerCase(), e.name.toLowerCase())), [I, N]), E = l.useMemo(() => 0 === Q.trim().length ? P : P.filter(e => a()(Q.toLowerCase(), e.toLowerCase())), [P, Q]), z = i.size > 0 || null != b || null != m || null != y, F = l.useMemo(() => {
    if (0 !== i.size) return S.filter(e => i.has(e.userId)).map(e => e.name).join(", ")
  }, [i, S]), A = l.useMemo(() => {
    if (null == m) return;
    let e = I.find(e => e.guildId === m);
    return null == e ? true : e.name
  }, [m, I]), G = l.useMemo(() => null != b ? b : true, [b]), R = l.useMemo(() => null != y ? String(y) : true, [y]);
  return (0, n.jsxs)(s.v2r, {
    ...
    children: [(0, n.jsxs)(s.kSQ, {
      label: "Filter",
      children: [S.length > 0 && (0, n.jsxs)(s.sNh, {
        id: "participants",
        label: h.intl.string(h.t.YQ6dJg),
        subtext: F,
        children: [S.length > 20 && (0, n.jsx)(s.II_, {
          id: "participants-search",
          control: (e, t) => (0, n.jsx)(s.ne, p(f({}, e), {
            query: M,
            onChange: B,
            ref: t,
      ...
      }), I.length > 0 && (0, n.jsxs)(s.sNh, {
        id: "servers",
        label: h.intl.string(h.t["5qyruI"]),
        subtext: A,
        children: [I.length > 20 && (0, n.jsx)(s.II_, {
          id: "servers-search",
          control: (e, t) => (0, n.jsx)(s.ne, p(f({}, e), {
            query: N,
            onChange: D,
      ...
      }), P.length > 0 && (0, n.jsxs)(s.sNh, {
        id: "activities",
        label: h.intl.string(h.t.agRtPG),
        subtext: G,
        children: [P.length > 20 && (0, n.jsx)(s.II_, {
      ...
      }), L.length > 0 && (0, n.jsxs)(s.sNh, {
        id: "years",
        label: h.intl.string(h.t.w9zd68),
        subtext: R,
        children: [(0, n.jsx)(s.k5B, {
          id: "year-all",
          group: "year",
          label: h.intl.string(h.t["2/yeUU"]),
          action: () => w(null),
          checked: null == y
        }), L.map(e => (0, n.jsx)(s.k5B, {
          id: "year-".concat(e),
          group: "year",
          label: String(e),
          action: () => w(e),
