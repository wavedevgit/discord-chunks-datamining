...
function D(e) {
  ...
  async function y() {
    if (null != l) {
      j(null), x(!0);
      try {
        await d.Z.unbanUser(l.id, s.id), m(), v.default.track(S.rMx.GUILD_BAN_REMOVED, Z(R({}, (0, p.hH)(l.id)), {
          target_user_id: s.id,
          reason: a.reason,
          location: O
        }))
  ...
  return (0, r.jsxs)(o.hjN, {
    ...
    children: [(0, r.jsx)("div", {
      ...
      children: (0, r.jsx)(o.R94, {
        ...
        children: T.intl.format(T.t.JcZ36u, {
          onModerationClick: u
        })
      })
    }), (0, r.jsxs)("div", {
...
function M() {
  ...
  let {
    guild: c,
    searchQuery: u
  } = (0, a.e7)([N.Z], () => N.Z.getProps(), [], l.isEqual), p = null != u && u.trim().length > 0, h = (0, m.Z)(p), f = p !== h, [x] = (0, a.e7)([N.Z], () => N.Z.getBans(), [], O.Q), j = null != (e = null == x ? void 0 : x.size) ? e : 0, v = (0, g.ZP)(), C = null != (t = null == c ? void 0 : c.id) ? t : S.lds, y = i.useRef(null), I = i.useCallback(e => null == e || 0 === e.length ? e => null != e : t => {
    ...
    return r
  }, [I]), w = i.useMemo(() => E(x, u, j), [x, E, u, j]), D = null != x, A = w.length % 1e3 == 0 && w.length > 0 && D, M = 0 === w.length, [G, U] = i.useState({
    currentPage: 1,
    pageSize: 100
  });
  i.useEffect(() => {
  ...
  let B = i.useCallback(e => {
    ...
    z = i.useCallback(e => {
      var t, n, r;
      null == (t = y.current) || t.scrollToSectionTop(0), (e + 1) * G.pageSize > w.length && A && !p && (H.current = null != (r = null == (n = w[w.length - 1]) ? void 0 : n.id) ? r : null, B(H.current)), (null != F[e - 1] || A) && U(t => Z(R({}, t), {
        currentPage: e
      }))
    }, [G.pageSize, w, A, F, B, p]),
    H = i.useRef(null);
  i.useEffect(() => {
    B(H.current)
  }, [B]);
  ...
  return null == c ? null : (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(L, {
      ...
      children: (0, r.jsx)(o.DsT, {
        ...
        totalCount: w.length + (A ? G.pageSize : 0),
        pageSize: G.pageSize,
