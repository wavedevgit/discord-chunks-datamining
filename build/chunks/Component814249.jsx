...
function b(e) {
  ...
  } = (0, c.i)(), y = h(t), O = (0, d.i)(n), [A, v] = i.useState(O.blockId), [S, I] = i.useState(O.pageIndex), [T, C] = i.useState(false), N = (e, n) => {
    g(t, e, n)
  ...
  }))), Promise.resolve()), [s, T]), w = i.useMemo(() => null == A ? [] : (0, d.uy)(n, {
    blockId: A,
    pageIndex: S,
    responses: y
  }), [n, A, S, y]), P = i.useCallback(() => {
