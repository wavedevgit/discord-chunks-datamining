...
let et = [Chunk354459.fO.ACTIVITY],
  en = Chunk647438.memo(e => {
    ...
    let {
    ...
    } = e, ex = i.useContext(N.h9) || ev, [eC, eE] = i.useState(false), eS = P.Sb.useSetting(), eI = (0, a.e7)([A.default], () => A.default.isStreamInfoOverlayEnabled), [eP, eN] = i.useState(false), eZ = (0, a.e7)([T.default], () => T.default.getId()), ew = y.type === X.fO.ACTIVITY ? null : y.user, eT = null != (l = null == ew ? true : ew.id) ? l : null, [eA] = (0, g.Z)(y.type === X.fO.ACTIVITY ? [y.applicationId] : []), eR = (0, a.e7)([v.Z], () => v.Z.getEnabled()), eD = (0, a.e7)([D.Z], () => null != eT && D.Z.isLocalVideoDisabled(eT, (0, m.Z)(y.type)), [eT, y.type]), eL = (0, a.e7)([D.Z], () => null != eT ? D.Z.getVideoToggleState(eT, (0, m.Z)(y.type)) : q.ZUi.NONE, [eT, y.type]), eM = eL === q.ZUi.AUTO_PROBING, {
      speaking: ek,
      ringing: eU,
      hasVideo: eG
    } = (0, Y.Z)(y, eZ), eB = (0, a.e7)([I.Z], () => null !== eT && I.Z.isUserPlayingSounds(eT), [eT]), eF = function(e, t, n) {
      var r, i, l, o;
      ...
      return {
        ...
        localMuted: u.muted,
        muted: null != (l = t.type === X.fO.USER && (null == (r = t.voiceState) ? true : r.isVoiceMuted())) && l,
        deafened: null != (o = t.type === X.fO.USER && (null == (i = t.voiceState) ? true : i.isVoiceDeafened())) && o
      }
    }(eZ, y, ea.getGuildId()), eV = y.type === X.fO.STREAM && eT === eZ, eH = (0, a.e7)([Z.Z], () => y.type === X.fO.USER && null != eT ? Z.Z.getEffectForUserId(eT) : null), ez = (0, a.e7)([M.Z], () => M.Z.getVoicePlatformForChannel(ea.id, null != eT ? eT : q.lds)), {
      showGameIcon: eW
    } = O.ZP.useExperiment({
      location: "voice_users"
    }, {
      autoTrackExposure: false
    }), eK = (0, a.e7)([L.Z], () => eW && null != eT ? L.Z.findActivity(eT, e => null != e.application_id && e.type === q.IIU.PLAYING) : null, [eW, eT]), eY = (0, a.e7)([R.Z], () => (null == eK ? true : eK.application_id) != null ? R.Z.getDetectableGame(eK.application_id) : null), eq = (0, a.e7)([f.Z], () => null != eY && (null == eK ? true : eK.application_id) != null ? f.Z.getApplication(null == eK ? true : eK.application_id) : true), eX = (0, S.wV)({
      userId: eT,
      channelId: ea.id
    }), eQ = (0, S.zU)({
      streamKey: y.type === X.fO.STREAM ? y.id : null,
      channelId: ea.id
    }), eJ = i.useMemo(() => y.type === X.fO.STREAM ? null != eQ && eQ : y.type === X.fO.USER && null != eX && eX, [eQ, eX, y.type]);
    i.useEffect(() => {
      eE(eg)
    }, [eg]);
    let e$ = i.useCallback(() => {
    ...
    switch (y.type) {
      case X.fO.STREAM:
        ...
        }), e3 = $.intl.formatToPlainString($.t.gHPz3d, {
      ...
      case X.fO.USER:
        e8 = (0, r.jsx)(W.Z, {
          ...
          participant: y,
          channelId: ea.id
        }), e3 = $.intl.formatToPlainString($.t["iC/x/f"], {
      ...
      case X.fO.ACTIVITY:
        e8 = (0, r.jsx)(V.ZP, {
          ...
          channel: ea,
          width: es
        }), e3 = $.intl.formatToPlainString($.t.YCvOsL, {
        ...
        children: (0, r.jsxs)(E.Z, {
          ...
          children: [(0, r.jsx)(H.Z, {
            ...
            children: (0, r.jsxs)(d.kL8, {
              ...
              children: [null != eH && null != eT ? (0, r.jsx)(w.Z, {
                voiceChannelEffect: eH,
                onComplete: () => (0, Z.H)(eT),
                userId: eT
              }) : null, y.type === X.fO.USER ? (0, r.jsx)("div", {
              ...
              }) : null, et.includes(y.type) ? null : (0, r.jsx)(el, (u = function(e) {
              ...
              }), u)), y.type === X.fO.USER && eR ? (0, r.jsx)(j.Z, {
                userId: y.id,
                channelId: ea.id
...
function er(e) {
  ...
  if (t === X.fO.STREAM) return n === X.wR.XBOX ? (0, r.jsx)(G.Z, {
    className: i
  }) : (0, r.jsx)(d.pzj, {
    size: "md",
    color: "currentColor",
...
let el = Chunk647438.memo(e => {
  let {
    ...
    hideAudioIcon: Z,
    onToggleMute: w
  } = e, T = (0, a.e7)([D.Z], () => null != b && D.Z.isLocalVideoAutoDisabled(b, (0, m.Z)(g)), [b, g]), A = (0, _.Z)({
    userId: b,
    guildId: O.getGuildId()
  }), R = (0, y.j)({
    displayNameStyles: A
  }), L = (0, K.N)(l), M = (0, K.K)(l), [U, G] = i.useState(false);
  i.useEffect(() => {
    let e = false,
      t = () => {
        e !== k.Z.isOpen() && ((e = k.Z.isOpen()) || G(false))
      };
  ...
  return (0, r.jsxs)("div", {
    className: o()(ee.overlayContainer, {
      [ee.compact]: M
    }),
    children: [(0, r.jsx)("div", {
      className: o()(ee.overlayTop, {
        [ee.small]: l < 195
      }),
      children: T || p === q.ZUi.AUTO_PROBING ? t ? (0, r.jsx)("div", {
        className: ee.status,
      ...
      className: o()(ee.overlayBottom, {
        [ee.small]: l < 195
      }),
      children: [(0, r.jsxs)(d.Text, {
        className: o()(ee.experimentOverlayTitle, {
          [ee.compact]: M
        }),
        color: "none",
        variant: M ? "text-sm/normal" : "text-md/normal",
        children: [null != F && g === X.fO.USER && (0, r.jsx)(F, {
          className: o()(ee.experimentTitleIcon, {
            [ee.compact]: M
          }),
          size: "xs",
          color: "currentColor"
        ...
        children: [(0, r.jsx)(ei, {
          onClick: e => {
            e.stopPropagation(), G(true), x(e, true, X.A5.THREE_DOT)
          },
