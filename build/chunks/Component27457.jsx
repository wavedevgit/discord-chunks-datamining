...
let et = [Chunk354459.fO.ACTIVITY],
  en = Chunk647438.memo(e => {
    ...
    } = e, ex = i.useContext(I.h9) || ev, [eC, eE] = i.useState(false), eS = S.Sb.useSetting(), eI = (0, a.e7)([Z.default], () => Z.default.isStreamInfoOverlayEnabled), [eP, eN] = i.useState(false), ew = (0, a.e7)([w.default], () => w.default.getId()), eZ = b.type === Y.fO.ACTIVITY ? null : b.user, eT = null != (l = null == eZ ? true : eZ.id) ? l : null, [eA] = (0, h.Z)(b.type === Y.fO.ACTIVITY ? [b.applicationId] : []), eR = (0, a.e7)([y.Z], () => y.Z.getEnabled()), eD = (0, a.e7)([A.Z], () => null != eT && A.Z.isLocalVideoDisabled(eT, (0, g.Z)(b.type)), [eT, b.type]), eL = (0, a.e7)([A.Z], () => null != eT ? A.Z.getVideoToggleState(eT, (0, g.Z)(b.type)) : K.ZUi.NONE, [eT, b.type]), eM = eL === K.ZUi.AUTO_PROBING, {
      speaking: ek,
      ringing: eU,
      hasVideo: eG
    } = (0, W.Z)(b, ew), eB = (0, a.e7)([E.Z], () => null !== eT && E.Z.isUserPlayingSounds(eT), [eT]), eF = function(e, t, n) {
      var r, i, l, o;
    ...
    }(ew, b, ea.getGuildId()), eV = b.type === Y.fO.STREAM && eT === ew, eH = (0, a.e7)([P.Z], () => b.type === Y.fO.USER && null != eT ? P.Z.getEffectForUserId(eT) : null), ez = (0, a.e7)([D.Z], () => D.Z.getVoicePlatformForChannel(ea.id, null != eT ? eT : K.lds)), {
      showGameIcon: eW
    } = O.ZP.useExperiment({
      location: "voice_users"
    }, {
      autoTrackExposure: false
    }), eK = (0, a.e7)([R.Z], () => eW && null != eT ? R.Z.findActivity(eT, e => null != e.application_id && e.type === K.IIU.PLAYING) : null, [eW, eT]), eY = (0, a.e7)([T.Z], () => (null == eK ? true : eK.application_id) != null ? T.Z.getDetectableGame(eK.application_id) : null), eq = (0, a.e7)([f.Z], () => null != eY && (null == eK ? true : eK.application_id) != null ? f.Z.getApplication(null == eK ? true : eK.application_id) : true), eX = (0, C.wV)({
      userId: eT,
      channelId: ea.id
    }), eQ = (0, C.zU)({
            ...
            children: (0, r.jsxs)(u.kL8, {
              ...
              children: [null != eH && null != eT ? (0, r.jsx)(N.Z, {
                ...
                children: (0, r.jsx)(m.Z, {
                  ...
                  containerDimensions: {
                    width: null != (s = null == e5 || null == (t = e5.current) ? true : t.clientWidth) ? s : 0,
                    height: null != (c = null == e5 || null == (n = e5.current) ? true : n.clientHeight) ? c : 0
                  }
                })
              }) : null, e4, ef ? null : (0, r.jsx)("div", {
...
let el = Chunk647438.memo(e => {
  ...
  i.useEffect(() => {
    let e = false,
      t = () => {
        e !== L.Z.isOpen() && ((e = L.Z.isOpen()) || M(false))
      };
    return L.Z.addChangeListener(t), () => L.Z.removeChangeListener(t)
  }, []);
  let k = !P && h === Y.fO.STREAM && I && (!R || C),
    U = function(e) {
      let {
        localMuted: t,
        serverMuted: n,
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)("div", {
      ...
      children: [(0, r.jsxs)(u.Text, {
        ...
        children: [null != U && h === Y.fO.USER && (0, r.jsx)(U, {
        ...
        children: [(0, r.jsx)(ei, {
          onClick: e => {
            e.stopPropagation(), M(true), v(e, true, Y.A5.THREE_DOT)
          },
