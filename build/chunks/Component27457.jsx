...
let ei = [Chunk354459.fO.ACTIVITY],
  el = Chunk647438.memo(e => {
    ...
    let {
      ...
      forceIdle: ey = false
    } = e, eO = i.useContext(Z.h9) || ey, [ev, ej] = i.useState(false), ex = N.Sb.useSetting(), eC = (0, a.e7)([R.default], () => R.default.isStreamInfoOverlayEnabled), [eE, eS] = i.useState(false), eI = (0, a.e7)([A.default], () => A.default.getId()), eP = y.type === $.fO.ACTIVITY ? null : y.user, eN = null != (l = null == eP ? true : eP.id) ? l : null, [eZ] = (0, f.Z)(y.type === $.fO.ACTIVITY ? [y.applicationId] : []), ew = (0, a.e7)([L.Z], () => null != eN && L.Z.isLocalVideoDisabled(eN, (0, g.Z)(y.type)), [eN, y.type]), eT = (0, a.e7)([L.Z], () => null != eN ? L.Z.getVideoToggleState(eN, (0, g.Z)(y.type)) : J.ZUi.NONE, [eN, y.type]), eA = eT === J.ZUi.AUTO_PROBING, {
      speaking: eR,
      latched: eD,
      ringing: eL,
      hasVideo: eM
    } = (0, Q.Z)(y, eI), ek = (0, a.e7)([P.Z], () => null !== eN && P.Z.isUserPlayingSounds(eN), [eN]), eG = function(e, t, n) {
      var r, i, l, o;
      ...
      return {
        ...
        deafened: null != (o = t.type === $.fO.USER && (null == (i = t.voiceState) ? true : i.isVoiceDeafened())) && o
      }
    }(eI, y, el.getGuildId()), eU = y.type === $.fO.STREAM && eN === eI, eB = (0, a.e7)([w.Z], () => y.type === $.fO.USER && null != eN ? w.Z.getEffectForUserId(eN) : null), eF = (0, a.e7)([k.Z], () => k.Z.getVoicePlatformForChannel(el.id, null != eN ? eN : J.lds)), {
      showGameIcon: eV
    } = v.ZP.useExperiment({
      location: "voice_users"
    }, {
      autoTrackExposure: false
    }), eH = (0, a.e7)([M.Z], () => eV && null != eN ? M.Z.findActivity(eN, e => null != e.application_id && e.type === J.IIU.PLAYING) : null, [eV, eN]), ez = (0, a.e7)([D.Z], () => (null == eH ? true : eH.application_id) != null ? D.Z.getDetectableGame(eH.application_id) : null), eW = (0, a.e7)([h.Z], () => null != ez && (null == eH ? true : eH.application_id) != null ? h.Z.getApplication(null == eH ? true : eH.application_id) : true), eK = (0, I.wV)({
      userId: eN,
      channelId: el.id
    }), eY = (0, I.zU)({
      streamKey: y.type === $.fO.STREAM ? y.id : null,
      channelId: el.id
    }), eq = i.useMemo(() => y.type === $.fO.STREAM ? null != eY && eY : y.type === $.fO.USER && null != eK && eK, [eY, eK, y.type]);
    i.useEffect(() => {
      ej(eh)
    }, [eh]);
    ...
    switch (y.type) {
      ...
      case $.fO.ACTIVITY:
        e0 = (0, r.jsx)(W.ZP, {
          ...
          activityName: null == eZ ? true : eZ.name
        });
        break;
        ...
        children: (0, r.jsxs)(C.Z, {
          ...
          children: [(0, r.jsx)(K.Z, {
            ...
            children: (0, r.jsxs)(u.kL8, {
              ...
              children: [null != eB && null != eN ? (0, r.jsx)(T.Z, {
                voiceChannelEffect: eB,
                onComplete: () => (0, w.H)(eN),
                userId: eN
              }) : null, y.type === $.fO.USER ? (0, r.jsx)("div", {
              ...
              }) : null, ei.includes(y.type) ? null : (0, r.jsx)(ec, (m = function(e) {
...
function es(e) {
  let {
    ...
    participantId: n,
    isContextMenuOpen: l
  } = e, o = i.useMemo(() => (0, _.Z)(t, n), [t, n]), s = (0, a.e7)([E.Z], () => E.Z.getIsAlwaysOnTop(o)), c = i.useCallback(() => {
    S.hY(o, !s)
  }, [o, s]);
  return F.isPlatformEmbedded && V.ZP.supportsFeature(J.eRX.POPOUT_WINDOWS) ? (0, r.jsx)(ea, {
    onClick: c,
...
let ec = Chunk647438.memo(e => {
  let {
    ...
    onToggleMute: A,
    popoutType: R
  } = e, D = (0, a.e7)([L.Z], () => null != v && L.Z.isLocalVideoAutoDisabled(v, (0, g.Z)(_)), [v, _]), M = (0, y.Z)({
    userId: v,
    guildId: j.getGuildId()
  }), k = (0, O.j)({
    displayNameStyles: M
  }), U = (0, X.N)(l), B = (0, X.K)(l), [F, V] = i.useState(false);
  i.useEffect(() => {
    let e = false,
      t = () => {
        e !== G.Z.isOpen() && ((e = G.Z.isOpen()) || V(false))
      };
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)("div", {
      ...
      children: [(0, r.jsxs)(u.Text, {
        ...
        children: [null != z && _ === $.fO.USER && (0, r.jsx)(z, {
        ...
        children: [(0, r.jsx)(ea, {
          onClick: e => {
            e.stopPropagation(), V(true), E(e, true, $.A5.THREE_DOT)
          },
