...
let ee = [Chunk354459.fO.ACTIVITY],
  et = Chunk647438.memo(e => {
    ...
    let {
    ...
    } = e, ex = i.useContext(P.h9) || ev, [eC, eE] = i.useState(false), eS = I.Sb.useSetting(), eI = (0, a.e7)([T.default], () => T.default.isStreamInfoOverlayEnabled), [eP, eN] = i.useState(false), eZ = (0, a.e7)([w.default], () => w.default.getId()), ew = M.type === q.fO.ACTIVITY ? null : M.user, eT = null != (l = null == ew ? true : ew.id) ? l : null, [eA] = (0, g.Z)(M.type === q.fO.ACTIVITY ? [M.applicationId] : []), eR = (0, a.e7)([O.Z], () => O.Z.getEnabled()), eD = (0, a.e7)([R.Z], () => null != eT && R.Z.isLocalVideoDisabled(eT, (0, m.Z)(M.type)), [eT, M.type]), eL = (0, a.e7)([R.Z], () => null != eT ? R.Z.getVideoToggleState(eT, (0, m.Z)(M.type)) : Y.ZUi.NONE, [eT, M.type]), eM = eL === Y.ZUi.AUTO_PROBING, {
      speaking: ek,
      ringing: eU,
      hasVideo: eG
    } = (0, K.Z)(M, eZ), eB = (0, a.e7)([S.Z], () => null !== eT && S.Z.isUserPlayingSounds(eT), [eT]), eF = function(e, t, n) {
      var r, i, l, o;
      ...
      return {
        ...
        localMuted: u.muted,
        muted: null != (l = t.type === q.fO.USER && (null == (r = t.voiceState) ? true : r.isVoiceMuted())) && l,
        deafened: null != (o = t.type === q.fO.USER && (null == (i = t.voiceState) ? true : i.isVoiceDeafened())) && o
      }
    }(eZ, M, ea.getGuildId()), eV = M.type === q.fO.STREAM && eT === eZ, eH = (0, a.e7)([N.Z], () => M.type === q.fO.USER && null != eT ? N.Z.getEffectForUserId(eT) : null), ez = (0, a.e7)([L.Z], () => L.Z.getVoicePlatformForChannel(ea.id, null != eT ? eT : Y.lds)), {
      showGameIcon: eW
    } = y.ZP.useExperiment({
      location: "voice_users"
    }, {
      autoTrackExposure: false
    }), eK = (0, a.e7)([D.Z], () => eW && null != eT ? D.Z.findActivity(eT, e => null != e.application_id && e.type === Y.IIU.PLAYING) : null, [eW, eT]), eY = (0, a.e7)([A.Z], () => (null == eK ? true : eK.application_id) != null ? A.Z.getDetectableGame(eK.application_id) : null), eq = (0, a.e7)([f.Z], () => null != eY && (null == eK ? true : eK.application_id) != null ? f.Z.getApplication(null == eK ? true : eK.application_id) : true), eX = (0, E.wV)({
      userId: eT,
      channelId: ea.id
    }), eQ = (0, E.zU)({
      streamKey: M.type === q.fO.STREAM ? M.id : null,
      channelId: ea.id
    }), eJ = i.useMemo(() => M.type === q.fO.STREAM ? null != eQ && eQ : M.type === q.fO.USER && null != eX && eX, [eQ, eX, M.type]);
    i.useEffect(() => {
      eE(eg)
    }, [eg]);
    let e$ = i.useCallback(() => {
    ...
    switch (M.type) {
      case q.fO.STREAM:
        ...
        }), e3 = J.intl.formatToPlainString(J.t.gHPz3d, {
      ...
      case q.fO.USER:
        e8 = (0, r.jsx)(z.Z, {
          ...
          participant: M,
          channelId: ea.id
        }), e3 = J.intl.formatToPlainString(J.t["iC/x/f"], {
      ...
      case q.fO.ACTIVITY:
        e8 = (0, r.jsx)(F.ZP, {
          ...
          channel: ea,
          width: es
        }), e3 = J.intl.formatToPlainString(J.t.YCvOsL, {
        ...
        children: (0, r.jsxs)(C.Z, {
          ...
          children: [(0, r.jsx)(V.Z, {
            ...
            children: (0, r.jsxs)(d.kL8, {
              ...
              children: [null != eH && null != eT ? (0, r.jsx)(Z.Z, {
                voiceChannelEffect: eH,
                onComplete: () => (0, N.H)(eT),
                userId: eT
              }) : null, M.type === q.fO.USER ? (0, r.jsx)("div", {
              ...
              }) : null, ee.includes(M.type) ? null : (0, r.jsx)(ei, (u = function(e) {
                ...
                onToggleMute: e$,
                participantUserId: eT,
                participantDisplayNameStyles: null == ew ? true : ew.displayNameStyles,
                application: eq,
              ...
              }), u)), M.type === q.fO.USER && eR ? (0, r.jsx)(v.Z, {
                userId: M.id,
                channelId: ea.id
...
function en(e) {
  ...
  if (t === q.fO.STREAM) return n === q.wR.XBOX ? (0, r.jsx)(U.Z, {
    className: i
  }) : (0, r.jsx)(d.pzj, {
    size: "md",
    color: "currentColor",
...
let ei = Chunk647438.memo(e => {
  let {
    ...
    hideAudioIcon: N,
    onToggleMute: Z
  } = e, w = (0, a.e7)([R.Z], () => null != b && R.Z.isLocalVideoAutoDisabled(b, (0, m.Z)(g)), [b, g]), T = (0, _.j)({
    displayNameStyles: y
  }), A = (0, W.N)(l), D = (0, W.K)(l), [L, k] = i.useState(false);
  i.useEffect(() => {
    let e = false,
      t = () => {
        e !== M.Z.isOpen() && ((e = M.Z.isOpen()) || k(false))
      };
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)("div", {
      className: o()($.overlayTop, {
        [$.small]: l < 195
      }),
      children: w || p === Y.ZUi.AUTO_PROBING ? t ? (0, r.jsx)("div", {
        className: $.status,
      ...
      className: o()($.overlayBottom, {
        [$.small]: l < 195
      }),
      children: [(0, r.jsxs)(d.Text, {
        className: o()($.experimentOverlayTitle, {
          [$.compact]: D
        }),
        color: "none",
        variant: D ? "text-sm/normal" : "text-md/normal",
        children: [null != G && g === q.fO.USER && (0, r.jsx)(G, {
          className: o()($.experimentTitleIcon, {
            [$.compact]: D
          }),
          size: "xs",
          color: "currentColor"
        ...
        children: [(0, r.jsx)(er, {
          onClick: e => {
            e.stopPropagation(), k(true), j(e, true, q.A5.THREE_DOT)
          },
