...
let et = [Chunk354459.fO.ACTIVITY],
  en = Chunk647438.memo(e => {
    ...
    let {
      ...
      forceIdle: ej = false,
      inOverlayPopout: ev = false
    } = e, ex = i.useContext(P.h9) || ej, [eC, eE] = i.useState(false), eS = S.Sb.useSetting(), eP = (0, a.e7)([w.default], () => w.default.isStreamInfoOverlayEnabled), [eI, eN] = i.useState(false), eZ = (0, a.e7)([Z.default], () => Z.default.getId()), ew = b.type === Y.fO.ACTIVITY ? null : b.user, eT = null != (l = null == ew ? true : ew.id) ? l : null, [eA] = (0, h.Z)(b.type === Y.fO.ACTIVITY ? [b.applicationId] : []), eR = (0, a.e7)([y.Z], () => y.Z.getEnabled()), eD = (0, a.e7)([A.Z], () => null != eT && A.Z.isLocalVideoDisabled(eT, (0, g.Z)(b.type)), [eT, b.type]), eM = (0, a.e7)([A.Z], () => null != eT ? A.Z.getVideoToggleState(eT, (0, g.Z)(b.type)) : K.ZUi.NONE, [eT, b.type]), eL = eM === K.ZUi.AUTO_PROBING, {
      speaking: ek,
      ringing: eU,
      hasVideo: eG
    } = (0, W.Z)(b, eZ), eB = (0, a.e7)([E.Z], () => null !== eT && E.Z.isUserPlayingSounds(eT), [eT]), eV = function(e, t, n) {
      var r, i, l, o;
    ...
    }(eZ, b, ea.getGuildId()), eF = b.type === Y.fO.STREAM && eT === eZ, eH = (0, a.e7)([I.Z], () => b.type === Y.fO.USER && null != eT ? I.Z.getEffectForUserId(eT) : null), ez = (0, a.e7)([D.Z], () => D.Z.getVoicePlatformForChannel(ea.id, null != eT ? eT : K.lds)), {
      showGameIcon: eW
    } = O.ZP.useExperiment({
...
let el = Chunk647438.memo(e => {
  let {
    ...
    hideAudioIcon: I,
    onToggleMute: N
  } = e, Z = (0, a.e7)([A.Z], () => null != m && A.Z.isLocalVideoAutoDisabled(m, (0, g.Z)(h)), [m, h]), w = (0, b.j)({
    displayNameStyles: O
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)("div", {
      ...
      children: Z || d === K.ZUi.AUTO_PROBING ? t ? (0, r.jsx)("div", {
        className: J.status,
      ...
      children: [(0, r.jsxs)(u.Text, {
        ...
        children: [(0, r.jsx)(ei, {
          onClick: e => {
            e.stopPropagation(), L(true), j(e, true, Y.A5.THREE_DOT)
          },
