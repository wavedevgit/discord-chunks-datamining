...
let m = e => {
  ...
  let [O, y] = i.useState(null != g ? g : ""), C = m.map((e, t) => <span className={u.tag}>{e}{!j && <o.P3F className={u.closeWrapper} onClick={() => p(t)}><o.Dio size={"xs"} color={"currentColor"} className={u.close} /></o.P3F>}</span>), N = i.useCallback(() => {
    let e = O.trim();
    if (0 !== e.length) {
  ...
  return <div className={a()(l, u.inputWrapper, {
      [u.disabled]: j
    })}>{C}{<s.Is{...t = function(e) {
