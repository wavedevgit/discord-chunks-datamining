...
let o = Chunk73800.createContext(null),
  a = {
    Root(e) {
      ...
      return <o.Provider value={a}>{n}</o.Provider>
    },
    NestedContainer(e) {
      let {
      ...
      return <o.Provider value={d}>{a}</o.Provider>
    },
    AutoMeasuredNestedContainer(e) {
      let {
        children: t
      } = e, [n, i, o] = c(true);
      return <a.NestedContainer containerOuterWidth={i} containerInnerWidth={o}>{t(n)}</a.NestedContainer>
    }
  };
