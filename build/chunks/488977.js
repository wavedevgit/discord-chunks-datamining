...
function R(e) {
  ...
  let {
    ...
    className: w,
    sectionName: Z
  } = e, k = r.useRef(null), M = (0, a.e7)([j.Z], () => j.Z.entrypoint()), D = (0, P.L1)(l), U = (0, m.Eb)(D), B = (0, d.R)(l.id), H = (0, a.e7)([C.Z], () => {
    var e;
  ...
  }, W = v.default.getCurrentUser(), F = h.Z.useExperiment({
    location: u.Vh.APP_LAUNCHER_APPLICATION_VIEW_MORE_MENU
  }, {
    autoTrackExposure: !0
  }).enabled, z = (0, f.Z)({
    ...
    application: l
  }), q = (0, g.yE)(null != (t = l.flags) ? t : 0, I.udG.EMBEDDED), Y = "channel" === R.type ? R.channel : void 0;
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)(c.P3F, {
      onClick: () => {
        ...
        (0, y.JG)(e, () => (0, c.showToast)((0, c.createToast)(O.intl.string(O.t["L/PwZW"]), c.ToastType.SUCCESS))), x.default.track(I.rMx.APP_LAUNCHER_APPLICATION_LINK_COPIED, {
          application_id: l.id,
          source: M
        })
      },
        ...
        return (0, i.jsxs)(c.v2r, {
          ...
          children: [(0, i.jsxs)(c.kSQ, {
            children: [B && (0, i.jsx)(c.sNh, {
              ...
              action: () => {
                null == D.customInstallUrl && (0, s.yw)(I.rMx.APP_LAUNCHER_OAUTH2_AUTHORIZE_OPENED, V), (0, N.L)(L(T({}, D), {
                  oauth2Callback: e => {
                    let {
                      location: t
                    } = e;
            ...
            }) : null, F && l instanceof _.ZP ? (0, i.jsx)(c.sNh, {
              id: "report-app",
              color: "danger",
