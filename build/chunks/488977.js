  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)(s.P3F, {
      onClick: () => {
        ...
        (0, C.JG)(e, () => (0, s.showToast)((0, s.createToast)(I.intl.string(I.t["L/PwZW"]), s.ToastType.SUCCESS))), v.default.track(A.rMx.APP_LAUNCHER_APPLICATION_LINK_COPIED, {
          application_id: l.id,
          source: M
        })
      },
      ...
      renderPopout: e => {
        ...
        return (0, i.jsxs)(s.v2r, {
          ...
          children: [(0, i.jsxs)(s.kSQ, {
            ...
            }) : null, F && l instanceof _.ZP ? (0, i.jsx)(s.sNh, {
              id: "report-app",
              color: "danger",
