...
function C(e) {
  ...
  return <s.animated.div className={E.voiceFilterHero} aria-hidden={D} style={M}>{<div className={a()([E.bgGradient, E.bgGradientHighlight])} />}{k(e => <s.animated.div className={E.bgGradient} style={e} />)}{<div className={E.iconWrapper}>{U((e, t) => (0, r.jsx)(s.animated.img, {
        className: E.activeVoiceIcon,
        style: e,
        alt: "",
        src: t
      }, t))}</div>}{<div className={E.descriptionWrapper}>{G((e, t) => (0, r.jsxs)(s.animated.div, {
      ...
      }))}</div>}{<div className={E.buttonWrapper}>{<c.ua7 aria-label={B} tooltipClassName={E.tooltip} tooltipContentClassName={E.tooltipContent} shouldShow={w} text={(0, r.jsxs)(r.Fragment, {
        ...
        })}</c.ua7>}{<c.ua7 shouldShow={w} text={g.intl.string(g.t.UvMx7O)}>{e => (0, r.jsx)(s.animated.div, {
          className: E.buttonWrapper,
          style: j[1],
          children: (0, r.jsx)(c.P3F, v(y({
            className: E.button,
