...
function b(e) {
  ...
  return <u.Z>{<u.Z.Header text={w} />}{<u.Z.Body>{<div className={E.headerLine}>{<u.Z.Icon user={new d.Z(n.inviter)} onClick={S ? C : true} />}{<u.Z.Info title={D} onClick={S ? C : true}>{L}</u.Z.Info>}</div>}{<u.Z.Button onClick={C} submitting={I} isDisabled={v} color={P}>{R}</u.Z.Button>}</u.Z.Body>}</u.Z>
}