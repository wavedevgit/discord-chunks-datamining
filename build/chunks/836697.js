...
function v(e) {
  let {
    onActivate: t
  } = e, [n, v] = i.useState(!1), O = (0, l.e7)([d.Z], () => d.Z.getGuildId()), C = (0, l.e7)([u.Z], () => u.Z.hasFetchedRequestToJoinGuilds), j = (0, f.Z)(), S = (0, s.Z)(O), E = i.useMemo(() => {
    let e = (0, p.qQ)({
  ...
  return (i.useEffect(() => {
    !n && x && S !== O && v(!0)
  }, [n, x, S, O]), 0 === j.length) ? null : (0, r.jsx)(_, {
    onActivate: t,
