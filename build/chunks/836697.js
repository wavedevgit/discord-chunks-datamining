...
function C(e) {
  let {
    onActivate: t,
    children: n
  } = e, l = (0, s.e7)([p.Z], () => p.Z.hasJoinRequestCoackmark()), o = i.useCallback(() => {
    h.ZP.clearCoachmark()
  }, []), u = (0, c.Z)(l), d = i.useRef(null);
  return i.useEffect(() => {
    if (l && l !== u) {
      var e, n, r, i, o;
      t(), null == (o = d.current) || null == (i = o.ref) || null == (r = i.current) || null == (n = r.layerRef) || null == (e = n.current) || e.updatePosition()
    }
  }, [d, l, u, t]), (0, r.jsxs)("div", {
...
function j(e) {
  let {
    onActivate: t
  } = e, n = (0, u.Q3)("PendingGuildJoinRequestsFolderNode"), [l, j] = i.useState(!1), S = (0, s.e7)([f.Z], () => f.Z.getGuildId()), E = (0, s.e7)([p.Z], () => p.Z.hasFetchedRequestToJoinGuilds), x = (0, b.Z)(), I = (0, c.Z)(S), P = i.useMemo(() => {
    let e = (0, m.qQ)({
  ...
  return (i.useEffect(() => {
    !l && w && I !== S && j(!0)
  }, [l, w, I, S]), 0 === x.length) ? null : (0, r.jsx)(C, {
    onActivate: t,
