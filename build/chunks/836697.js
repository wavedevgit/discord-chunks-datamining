...
function y(e) {
  let {
    onActivate: t
  } = e, [n, y] = i.useState(!1), C = (0, l.e7)([d.Z], () => d.Z.getGuildId()), v = (0, l.e7)([u.Z], () => u.Z.hasFetchedRequestToJoinGuilds), j = (0, f.Z)(), E = (0, s.Z)(C), S = i.useMemo(() => {
    let e = (0, p.qQ)({
  ...
  return (i.useEffect(() => {
    !n && x && E !== C && y(!0)
  }, [n, x, E, C]), 0 === j.length) ? null : (0, r.jsx)(_, {
    onActivate: t,
