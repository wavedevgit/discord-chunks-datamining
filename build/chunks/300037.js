...
let C = function(e) {
  let {
    ...
    guildId: n,
    boostingVariant: r
  } = e, C = (0, a.e7)([h.Z], () => h.Z.getGuild(n), [n]), E = (0, a.e7)([f.default], () => f.default.getCurrentUser()), {
    fractionalState: O
  } = (0, c.Z)(), v = (0, p.y)("guild_boosting_setting_guild_info_card", E, O), S = (0, g.Z)(null == C ? void 0 : C.id).total;
