...
let C = function(e) {
  let {
    ...
    guildId: n,
    boostingVariant: r
  } = e, C = (0, l.e7)([g.Z], () => g.Z.getGuild(n), [n]), j = (0, l.e7)([h.default], () => h.default.getCurrentUser()), {
    fractionalState: O
  } = (0, o.Z)(), S = (0, m.y)("guild_boosting_setting_guild_info_card", j, O), v = (0, p.Z)(null == C ? void 0 : C.id).total;
