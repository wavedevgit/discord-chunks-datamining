...
function P(e) {
  let {
    ...
    userId: t.id,
    guildId: N
  }), R = (0, o.e7)([a.Z], () => a.Z.isFetchingUserOutbox(t.id)), D = t.id === n.id, M = (0, o.e7)([d.Z, s.Z], () => {
    let e = D ? d.Z.getStatus() : s.Z.getStatus(t.id);
    return e === l.Skl.OFFLINE || e === l.Skl.INVISIBLE
  }), B = Z.length > 0 || null != G, U = T && null == G && null == k && null != L, F = !M && (B || U), V = C.length > 0;
