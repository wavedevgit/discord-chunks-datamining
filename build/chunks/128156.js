...
function P(e) {
  let {
    ...
    userId: t.id,
    guildId: N
  }), R = (0, o.e7)([l.Z], () => l.Z.isFetchingUserOutbox(t.id)), D = t.id === n.id, G = (0, o.e7)([d.Z, s.Z], () => {
    let e = D ? d.Z.getStatus() : s.Z.getStatus(t.id);
    return e === i.Skl.OFFLINE || e === i.Skl.INVISIBLE
  }), U = E.length > 0 || null != L, M = w && null == L && null == B && null != k, F = !G && (U || M), V = S.length > 0;
