...
function I(e) {
  let {
    ...
    userId: n.id,
    guildId: O
  }), S = (0, r.e7)([a.Z], () => a.Z.isFetchingUserOutbox(n.id)), E = n.id === t.id, U = (0, r.e7)([s.Z, l.Z], () => {
    let e = E ? s.Z.getStatus() : l.Z.getStatus(n.id);
    return e === c.Skl.OFFLINE || e === c.Skl.INVISIBLE
  }), k = C.length > 0 || null != w, B = P && null == w && null == T && null != A, D = !U && (k || B), M = N.length > 0;
  return D || M || !S ? (0, o.jsxs)(c.Ttm, {
    ...
    children: [D ? (0, o.jsxs)(y.Z, {
      ...
      subheading: E ? x.intl.format(x.t["4bk9Ag"], {
