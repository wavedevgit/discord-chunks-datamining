...
function I(e) {
  let {
    ...
    userId: n.id,
    guildId: v
  }), w = (0, i.e7)([l.Z], () => l.Z.isFetchingUserOutbox(n.id)), V = n.id === t.id, E = (0, i.e7)([s.Z, a.Z], () => {
    let e = V ? s.Z.getStatus() : a.Z.getStatus(n.id);
    return e === c.Skl.OFFLINE || e === c.Skl.INVISIBLE
  }), M = N.length > 0 || null != T, U = O && null == T && null == S && null != P, k = !E && (M || U), B = Z.length > 0;
  return k || B || !w ? (0, o.jsxs)(c.Ttm, {
    className: y.scroller,
    fade: !0,
    children: [k ? (0, o.jsxs)(g.Z, {
      heading: _.intl.string(_.t.J6STd3),
      children: [U && (0, o.jsx)(h.Z, {
        user: n,
        currentUser: t,
        voiceChannel: P,
        onClose: C
      ...
      subheading: V ? _.intl.format(_.t["4bk9Ag"], {
