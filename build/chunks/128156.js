...
function P(e) {
  let {
    ...
    userId: t.id,
    guildId: N
  }), D = (0, o.e7)([a.Z], () => a.Z.isFetchingUserOutbox(t.id)), G = t.id === n.id, B = (0, o.e7)([d.Z, s.Z], () => {
    let e = G ? d.Z.getStatus() : s.Z.getStatus(t.id);
    return e === i.Skl.OFFLINE || e === i.Skl.INVISIBLE
  }), F = C.length > 0 || null != L, U = Z && null == L && null == R && null != k, M = !B && (F || U), V = S.length > 0;
  if (!M && !V && D) return (0, r.jsx)("div", {
    className: I.cards,
    children: Array.from({
      length: 8
  ...
  return (0, r.jsxs)(i.Ttm, {
    ...
    children: [M ? (0, r.jsx)(j.Z, {
      ...
      introText: G ? v.intl.format(v.t["4bk9Ag"], {
