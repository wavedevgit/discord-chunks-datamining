...
function P(e) {
  let {
    ...
    userId: t.id,
    guildId: N
  }), M = (0, o.e7)([a.Z], () => a.Z.isFetchingUserOutbox(t.id)), R = t.id === n.id, D = (0, o.e7)([d.Z, s.Z], () => {
    let e = R ? d.Z.getStatus() : s.Z.getStatus(t.id);
    return e === l.Skl.OFFLINE || e === l.Skl.INVISIBLE
  }), B = Z.length > 0 || null != G, F = T && null == G && null == k && null != L, U = !D && (B || F), V = C.length > 0;
  if (!U && !V && M) return (0, r.jsx)("div", {
    className: I.cards,
    children: Array.from({
      length: 8
  ...
  return (0, r.jsxs)(l.Ttm, {
    ...
    fade: !0,
    children: [U ? (0, r.jsx)(h.Z, {
      heading: v.intl.string(v.t.J6STd3),
      children: (0, r.jsxs)("ul", {
        className: I.cards,
        children: [!S && F && (0, r.jsx)("li", {
