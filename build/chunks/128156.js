...
function I(e) {
  let {
    ...
    userId: n.id,
    guildId: O
  }), S = (0, r.e7)([i.Z], () => i.Z.isFetchingUserOutbox(n.id)), M = n.id === t.id, E = (0, r.e7)([s.Z, l.Z], () => {
    let e = M ? s.Z.getStatus() : l.Z.getStatus(n.id);
    return e === c.Skl.OFFLINE || e === c.Skl.INVISIBLE
  }), U = C.length > 0 || null != A, B = N && null == A && null == w && null != T, k = !E && (U || B), D = Z.length > 0;
  return k || D || !S ? (0, o.jsxs)(c.Ttm, {
    className: g.scroller,
    fade: !0,
    children: [k ? (0, o.jsxs)(y.Z, {
