...
function P(e) {
  let {
    ...
    userId: t.id,
    guildId: N
  }), U = (0, o.e7)([l.Z], () => l.Z.isFetchingUserOutbox(t.id)), D = t.id === n.id, R = (0, o.e7)([d.Z, s.Z], () => {
    let e = D ? d.Z.getStatus() : s.Z.getStatus(t.id);
    return e === i.Skl.OFFLINE || e === i.Skl.INVISIBLE
  }), G = E.length > 0 || null != L, M = C && null == L && null == k && null != B, V = !R && (G || M), F = S.length > 0;
  if (!V && !F && U) return (0, r.jsx)("div", {
    className: O.cards,
    children: Array.from({
      length: 8
  ...
  return (0, r.jsxs)(i.Ttm, {
    ...
    children: [V ? (0, r.jsx)(j.Z, {
      ...
      scrollIntoView: A === y.Tb.RECENT_ACTIVITY,
      children: (0, r.jsx)("ul", {
        className: O.cards,
