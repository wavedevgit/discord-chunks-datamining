...
function N(e) {
  let {
    ...
    userId: t.id,
    guildId: P
  }), G = (0, o.e7)([l.Z], () => l.Z.isFetchingUserOutbox(t.id)), k = t.id === n.id, D = (0, o.e7)([d.Z, s.Z], () => {
    let e = k ? d.Z.getStatus() : s.Z.getStatus(t.id);
    return e === i.Skl.OFFLINE || e === i.Skl.INVISIBLE
  }), U = E.length > 0 || null != L, M = C && null == L && null == R && null != B, F = !D && (U || M), V = S.length > 0;
