...
function P(e) {
  let {
    ...
    userId: t.id,
    guildId: w
  }), B = (0, o.e7)([a.Z], () => a.Z.isFetchingUserOutbox(t.id)), G = t.id === n.id, R = (0, o.e7)([u.Z, s.Z], () => {
    let e = G ? u.Z.getStatus() : s.Z.getStatus(t.id);
    return e === i.Skl.OFFLINE || e === i.Skl.INVISIBLE
  }), U = S.length > 0 || null != L, M = E && null == L && null == D && null != k, F = !R && (U || M), V = C.length > 0;
