...
function z(e) {
  let {
    overwrite: t
  } = e, n = (0, o.e7)([S.Z], () => S.Z.channel), l = (0, o.e7)([w.Z], () => null != n ? w.Z.getGuild(n.getGuildId()) : null), r = (0, o.e7)([Z.Z], () => null != l ? Z.Z.getRoles(l.id) : void 0);
  ...
  }, v = m === s, N = n.isForumLikeChannel() && a.e$(t.deny, V.Plq.SEND_MESSAGES), E = a.e$(t.deny, V.Plq.SEND_MESSAGES), O = a.e$(t.deny, V.Plq.READ_MESSAGE_HISTORY), _ = L.Z.generateChannelPermissionSpec(s, n, v, {
  ...
  return (0, i.jsxs)(y.ZP.Content, {
    ...
    children: [_.map((e, n) => (0, i.jsx)(p.Z, {
      spec: e,
      allow: t.allow,
      deny: t.deny,
      onChange: x,
      ...
      children: W.intl.format(W.t.txPV7u, {
        name: f()
      })
    })]
  })
...
function X(e) {
  let {
    ...
    channelId: n,
    user: l
  } = e, r = l.getAvatarURL(t, 32), s = A.ZP.getNickname(t, n, l), a = M.ZP.useUserTag(l), o = null, c = null;
...
function q(e) {
  ...
  return (0, i.jsx)(v.Z, {
    ...
    onRenderResult: e => {
      ...
      if (e instanceof N.Z) return (0, i.jsx)(X, {
        guildId: t.id,
        channelId: n.id,
        user: e
      })
    },
    onFilterResults: (e, t) => 0 === t ? s()(d).filter(t => null == l[t.id] && e(t.name)).sortBy(e => -e.position).value() : s()(u).map(R.default.getUser).filter(_.lm).filter(t => null == l[t.id] && e(t.username.toLowerCase())).sortBy(e => e.username.toLowerCase()).value(),
    onQueryChange: e => {
...
function Y() {
  ...
  let T = s()(r).filter(e => e.type === j.BN.ROLE).map(e => f[e.id]).filter(_.lm).sortBy(e => -e.position).map(e => (0, i.jsx)(m.Z, {
      theme: C,
      roleStyle: N,
      id: e.id,
      role: e,
    ...
    R = s()(v).sortBy(e => e.username.toLowerCase()).map(e => {
    ...
    children: (0, i.jsxs)(d.njP, {
      ...
      children: [(() => {
        ...
        return (0, i.jsx)(d.yRy, {
          ...
          autoInvert: !1,
          clickTrap: !0,
          children: n => (0, i.jsx)(d.njP.Header, G(H({
            ref: e
          }, n), {
            children: (0, i.jsxs)("div", {
