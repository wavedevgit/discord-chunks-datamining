...
function F(e) {
  ...
  }, v = m === s, N = n.isForumLikeChannel() && a.e$(t.deny, B.Plq.SEND_MESSAGES), E = a.e$(t.deny, B.Plq.SEND_MESSAGES), O = a.e$(t.deny, B.Plq.READ_MESSAGE_HISTORY), R = A.Z.generateChannelPermissionSpec(s, n, v, {
...
function z(e) {
  let {
    ...
    channelId: n,
    user: l
  } = e, r = l.getAvatarURL(t, 32), s = P.ZP.getNickname(t, n, l), a = D.ZP.useUserTag(l), o = null, c = null;
...
function J(e) {
  let {
    ...
    onSelect: a,
    position: c
  } = e, d = (0, o.e7)([w.Z], () => w.Z.getRoles(t.id)), u = (0, o.Wu)([O.ZP], () => O.ZP.getMemberIds(t.id));
  return (0, i.jsx)(v.Z, {
    ...
    onRenderResult: e => {
      ...
      if (e instanceof N.Z) return (0, i.jsx)(z, {
        guildId: t.id,
        channelId: n.id,
        user: e
      })
    },
    onFilterResults: (e, t) => 0 === t ? s()(d).filter(t => null == l[t.id] && e(t.name)).sortBy(e => -e.position).value() : s()(u).map(T.default.getUser).filter(R.lm).filter(t => null == l[t.id] && e(t.username.toLowerCase())).sortBy(e => e.username.toLowerCase()).value(),
    onQueryChange: e => {
...
function q() {
  ...
  let Z = s()(r).filter(e => e.type === j.BN.ROLE).map(e => f[e.id]).filter(R.lm).sortBy(e => -e.position).map(e => (0, i.jsx)(m.Z, {
      theme: C,
      roleStyle: N,
      id: e.id,
      role: e,
    ...
    children: (0, i.jsxs)(d.njP, {
      ...
      children: [(() => {
        ...
        return (0, i.jsx)(d.yRy, {
          ...
          autoInvert: !1,
          clickTrap: !0,
          children: n => (0, i.jsx)(d.njP.Header, H(U({
            ref: e
          }, n), {
            children: (0, i.jsxs)("div", {
