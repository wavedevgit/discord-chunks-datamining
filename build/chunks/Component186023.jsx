...
let h = e => {
  let {
    ...
    success_node_id: Z,
    fail_node_id: S
  } = n, [P, T] = i.useState(C), [N, E] = i.useState(true), [k, w] = i.useState(true), [D, R] = i.useState([]), [M, A] = i.useState(true), [B, L] = i.useState(true), U = (0, _.PO)("in_app_report_modal");
  (0, o.ZP)(() => {
    U && (0, u.k0)()
  });
  let G = e => {
    ...
    W = async e => {
      ...
      null != l && A(l), L(I[e.nodeRef].report_type), null == x || x(l)
    }, z = () => {
      var e, n;
