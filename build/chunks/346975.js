...
function eC(e) {
  ...
  return () => 2 === t && !l && a ? (0, r.jsx)(ev, {
    section: t,
    coords: null == n ? void 0 : eg(eh({}, n), {
      position: "absolute"
    }),
    itemRole: "section"
  }, i) : null
...
function eO(e) {
      ...
      let l = i.useRef(null),
        a = i.useCallback((e, t) => {
          for (let n of t) {
            ...
            if (null == t) return;
            let r = Date.now();
            n.intersectionRatio >= .5 ? (0, X.rj)(e, t, r) : (0, X.Ct)(e, t, r)
          }
        }, []);
      return i.useEffect(() => {
        var e;
  ...
  let {
    columns: eP
  } = i.useMemo(() => er ? ep.getRenderOptions(eO) : ei.eU, [er, eO]), eI = i.useMemo(() => N ? Math.round((window.innerHeight - 200) / 118) : 0, [N]), eE = i.useMemo(() => {
    let e = Math.ceil(window.innerHeight / (0, ei.KW)(ep.getWidth(eO))) * eP;
    return _ ? e : 0
  }, [eO, eP, _]), ek = i.useMemo(() => {
    let e = Math.ceil(window.innerHeight / (0, ei.KW)(ep.getWidth(eO))) * eP;
    return y ? e : 0
  }, [eO, eP, y]), eR = i.useMemo(() => {
    let e = Math.ceil(window.innerHeight / (0, ei.KW)(ep.getWidth(eO))) * eP;
    return P && el ? e : 0
  }, [eO, eP, P, el]), eZ = i.useMemo(() => {
    if (er)
      if (!J && el) return [1, 0];
  ...
  }, [er, el, m.length, f.length, J, Y, eI, b, eE, ek, eR]), eM = i.useMemo(() => !J && el ? [
    [],
    []
  ] : Y ? el ? [
    [], b, [],
    ...
    [], m, []
  ], [el, J, Y, b, m, f]), eA = i.useCallback((e, n) => {
    (0, W.B5)({
      guildId: t.guild_id,
      channelId: t.id,
      postId: e.id,
      ...
      source: ed.on.BROWSER
    }) : (ex.current = e.id, (0, R.ok)(e))
  }, [t.guild_id, t.id, ex]), [eL, eF] = i.useState(l + s - 24), eD = i.useCallback((e, n, i) => 0 === e ? (0, r.jsx)(eT, {
    channel: t,
    isEmpty: !L,
    isSearchLoading: P,
  ...
  }, "forum-channel-header") : 2 !== e || Y ? 1 === e && el && !J ? (0, r.jsx)(eS, {
    channel: t,
    coords: n
  }, "archive-or-search-result") : i() : (0, r.jsx)(ew, {
    channel: t,
    coords: n
  }, "archived-missing-reading-history-perm"), [el, Y, b, J, t, L, P, N, F]), ez = (0, g.e7)([B.Z], () => B.Z.hasHidden(t.id)), eB = {
    editorHeight: l,
    isGridLayout: er
  }, eH = i.useRef(eB);
  i.useEffect(() => {
    ...
    let {
      editorHeight: n,
      isGridLayout: r
    } = eH.current, i = r ? eW : ee, l = null == (e = i.current) ? void 0 : e.getScrollerState();
  ...
  let {
    ...
    }, [t]), f = i.useCallback(e => eC({
      section: e.section,
      isShowingSearchResult: h,
      hasActiveThreads: n
    })(), [n, h]), p = i.useCallback(e => d(e.section, void 0, () => {
    ...
    }, [n]), v = i.useCallback((e, t, n) => s(e, t, eC({
      section: e,
      coords: t,
      key: n,
      isShowingSearchResult: c,
      ...
      children: e => (0, r.jsxs)(r.Fragment, {
        children: [u && (0, r.jsx)(p.Z, {
          ...
          children: (0, r.jsx)(x.H, {
            children: eu.intl.string(eu.t.B2panJ)
          })
        }), D ? (0, r.jsx)("div", {
        ...
        }) : null, er ? (0, r.jsx)(es.KT, {
          navigator: e1,
          children: (0, r.jsx)(x.GMG, eh({
            ref: e => {
              var t;
...
function ew(e) {
  ...
  return (0, r.jsx)("div", {
    ...
    children: (0, r.jsx)(x.Text, {
      ...
      children: eu.intl.format(eu.t.TycmzM, {
        channelName: i
      })
    })
  })
...
function eS(e) {
  ...
  return (0, r.jsx)("div", {
    ...
    children: (0, r.jsx)(x.Text, {
      color: "text-muted",
      variant: "text-md/normal",
      children: eu.intl.format(eu.t.OWZJdX, {
        channelName: i
      })
    })
  })
...
function eN(e) {
  let {
    ...
    H.Z.resort(t.id)
  }, [t]), l = (0, g.e7)([U.Z], () => U.Z.getNewThreadCount());
  return 0 === l ? null : (0, r.jsx)(x.P3F, {
    className: em.newPostsButton,
    onClick: n,
    children: (0, r.jsx)(x.Text, {
      color: "text-brand",
      variant: "text-md/medium",
      children: eu.intl.format(eu.t.ue1qfH, {
        count: l
      })
    })
  })
...
function eT(e) {
  ...
  let {
    ...
    tagFilter: q,
    layoutType: X
  } = (0, V.H)(s.id), K = (0, $.AF)(), Q = (0, V.v)(), et = (0, g.e7)([L.Z], () => L.Z.canChatInGuild(s.guild_id)), en = (0, G.r_)(s), ei = (0, k.cD)(s), [ea, es] = i.useState(ei), [, eo] = (0, _.AB)(null != (l = s.getGuildId()) ? l : void 0), ed = (0, P.HL)(s), ex = et && (ei || ea && eo) && !ed, ep = s.isMediaChannel();
  i.useEffect(() => {
    ei && es(!0)
  }, [ei]);
  let {
  ...
  i.useLayoutEffect(ev, [ev, p, ex, B]), (0, z.yp)({
  ...
  i.useLayoutEffect(() => {
    ...
    if (null != ey.current && null != n && null != n.children) {
      let {
        left: e,
        top: t
      } = ey.current.getBoundingClientRect(), r = 0;
  ...
  return (0, r.jsx)("div", eg(eh({
    ...
    children: (0, r.jsxs)(z.I3, {
      children: [null != s.guild_id ? (0, r.jsx)(y.Z, {
        className: a()(em.newMemberBanner, {
          [em.gridViewBanner]: X === h.X.GRID
        }),
        guildId: s.guild_id,
        channel: s
      }) : null, (0, r.jsx)("div", {
        className: a()(em.mainCard, em.header, {
        ...
        children: [eR && (0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(x.X6q, {
            ...
            color: "text-normal",
            children: v ? eu.intl.string(eu.t["/9i3qq"]) : 0 === O ? eu.intl.string(eu.t.DbgHxs) : eu.intl.formatToPlainString(eu.t["tBz/8f"], {
              numPosts: O,
              query: I
            })
          }), !v && (0, r.jsx)(x.P3F, {
            onClick: () => {
              (0, W.zI)({
                guildId: s.guild_id,
                channelId: s.id
              }), H.Z.clearForumSearch(s.id), K.getState().setName("")
            },
            children: (0, r.jsx)(x.Text, {
        ...
        children: [(0, r.jsx)(eI, {
          ...
          children: [(0, r.jsx)("div", {
              ...
              children: (0, r.jsx)(d.SJ, {
                children: e => {
                  ...
                  return (0, r.jsx)("div", eg(eh({
                    ...
                    children: eV.map(e => (0, r.jsx)(er.Z, {
                      className: em.tag,
                      tag: e,
                      onClick: () => eM(e.id),
                      selected: q.has(e.id)
            ...
            children: (e, t) => {
              ...
              return (0, r.jsxs)(x.zxk, eg(eh({}, e), {
                buttonRef: ek,
                size: x.zxk.Sizes.MIN,
                color: x.zxk.Colors.CUSTOM,
                className: a()(em.tagsButton, {
                ...
                }) : eu.intl.string(eu.t.fZ8hzs), n ? (0, r.jsx)(x.u04, {
                  size: "custom",
                  color: "currentColor",
                  width: 20
                }) : (0, r.jsx)(x.CJ0, {
        ...
        children: e => {
          ...
          return t === f.z.FORUM_CHANNEL_HELPER_CARD ? (0, r.jsx)(Y.Z, {
            onDismiss: n
          }) : null
        }
      })]
