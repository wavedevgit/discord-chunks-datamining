...
let v = function(e) {
  let {
    ...
    channel: v,
    draftType: I
  } = e, [T, S] = i.useState(!0), A = (0, o.e7)([f.Z], () => f.Z.hasLayers()), N = (0, o.e7)([_.Z], () => null != v && _.Z.can(y.Plq.ATTACH_FILES, v), [v]), C = null != (0, o.e7)([s.Z], () => s.Z.getActiveCommand(v.id)), R = v.getGuildId(), P = I === c.d.FirstThreadMessage, w = (0, o.e7)([h.default], () => {
    var e;
