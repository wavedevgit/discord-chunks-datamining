...
let p = {
  ...
  h = e => {
    ...
    return t.size > 0 || n.size > 0 || "" !== r.trim() ? f : l.size > 0 ? m : p
  },
  _ = (0, Chunk353640.v)((0, Chunk499867.eh)((e, t) => d(u({}, b), {
    ...
    onSetSearchQuery: t => {
      e(e => {
        ...
        return "" !== t.trim() ? (n.sort = f, n.userHasSelectedSort = false) : e.userHasSelectedSort || (n.sort = h(n)), n
      })
    },
    setQueryPageSize: t => {
      e({
