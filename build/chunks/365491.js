...
let b = {
  ...
  h = e => {
    ...
    return t.size > 0 || l.size > 0 || "" !== n.trim() ? m : r.size > 0 ? g : b
  },
  E = (0, Chunk353640.v)((0, Chunk499867.eh)((e, t) => d(u({}, p), {
    ...
    onSetSearchQuery: t => {
      e(e => {
        ...
        return "" !== t.trim() ? (l.sort = m, l.userHasSelectedSort = false) : e.userHasSelectedSort || (l.sort = h(l)), l
      })
    },
    setQueryPageSize: t => {
      e({
