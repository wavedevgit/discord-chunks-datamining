...
function N(e) {
  if (e > p.Z.Seconds.DAYS_30) {
    ...
    return O.intl.formatToPlainString(O.t["HF7p4+"], {
      count: t
    })
  }
  if (e > 2 * p.Z.Seconds.DAY) {
    let t = Math.round(e / p.Z.Seconds.DAY);
    return O.intl.formatToPlainString(O.t.HkESOj, {
      count: t
    })
  }
...
function R(e) {
  let {
    guildId: t,
    leaderboardId: p
  } = e, I = (0, a.e7)([c.default], () => c.default.getId()), S = (0, a.e7)([u.Z], () => u.Z.getAccount(null, y.ABu.RIOT_GAMES)), N = (0, a.e7)([u.Z], () => u.Z.getAccount(null, y.ABu.LEAGUE_OF_LEGENDS)), R = (0, g.Z)({
    guildId: t,
    leaderboardId: p
  }), {
