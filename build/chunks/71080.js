...
var Chunk197062 = require("./197062.jsx"),
...
function p(e, t, c) {
  ...
  return {
    ...
    [s.Plq.SEND_MESSAGES.toString()]: {
      title: s.TPd.GUILD_THREADS_ONLY.has(u) ? l.intl.string(l.t.nJwAHX) : u === s.d4z.GUILD_CATEGORY ? l.intl.string(l.t.S1VOwd) : l.intl.string(l.t.T32rkC),
      description: (() => {
        switch (u) {
          case s.d4z.GUILD_CATEGORY:
            return l.t.IjeLuu;
          case s.d4z.GUILD_FORUM:
            return (null == c ? true : c.createPostsDisabled) && !e.isMediaChannel() ? r.Z.getForumChannelPermissionText() : l.t.LG9VAi;
    ...
    [s.Plq.MENTION_EVERYONE.toString()]: {
      title: u === s.d4z.GUILD_STAGE_VOICE ? l.intl.string(l.t.VDUAHO) : (null == c ? true : c.inGameMentionsExperiment) ? l.intl.string(l.t.lEO7Wr) : l.intl.string(l.t.Y78KGC),
      description: u === s.d4z.GUILD_CATEGORY ? l.t["HOhg/B"] : u === s.d4z.GUILD_STAGE_VOICE ? l.t.rZn1oO : (null == c ? true : c.inGameMentionsExperiment) ? l.t.wdHpIC : l.t["6IUSdt"],
      ...
      description: (() => {
        switch (u) {
          case s.d4z.GUILD_CATEGORY:
            return l.t["cJRv/g"];
          case s.d4z.GUILD_VOICE:
            return i.Z.getTextInVoiceReadMessageHistoryChannelPermissionText(null == c ? true : c.readMessageHistoryDisabled);
          case s.d4z.GUILD_FORUM:
          case s.d4z.GUILD_MEDIA:
            return l.t.RqCc7i;
          default:
    ...
    [s.Plq.MANAGE_THREADS.toString()]: {
      title: s.TPd.GUILD_THREADS_ONLY.has(u) ? l.intl.string(l.t.ossiZD) : u === s.d4z.GUILD_CATEGORY ? l.intl.string(l.t.QKe7Q3) : l.intl.string(l.t.kEqgr7),
      description: (() => {
        switch (u) {
          case s.d4z.GUILD_CATEGORY:
            return l.t.S31soU;
    ...
    [s.Plq.SEND_MESSAGES_IN_THREADS.toString()]: {
      title: s.TPd.GUILD_THREADS_ONLY.has(u) ? l.intl.string(l.t.fqhqWm) : u === s.d4z.GUILD_CATEGORY ? l.intl.string(l.t["5QlVGy"]) : l.intl.string(l.t.fTE74g),
      description: (() => {
        switch (u) {
          case s.d4z.GUILD_CATEGORY:
            return l.t.DlIVcN;
