/** Chunk was on 70274 **/
/** chunk id: 71080, original params: t,e,i (module,exports,require) **/
require.d(exports, {
  EQ: () => G,
  IG: () => D,
  aC: () => a,
...
var n, r, Chunk230711 = require("./230711.js"),
  Chunk197062 = require("./197062.jsx"),
  Chunk727866 = require("./727866.jsx"),
  Chunk63063 = require("./63063.js"),
  Chunk981631 = require("./981631.js"),
  Chunk388032 = require("./388032.jsx"),
  a = ((n = {})[n.EMPTY_STATE = 0] = "EMPTY_STATE", n[n.ADMINISTRATOR = 1] = "ADMINISTRATOR", n[n.ROLE = 2] = "ROLE", n[n.OWNER = 3] = "OWNER", n[n.MEMBER = 4] = "MEMBER", n[n.USER = 5] = "USER", n[n.GUILD = 6] = "GUILD", n),
  I = ((r = {})[r.ROLES = 0] = "ROLES", r[r.MEMBERS = 1] = "MEMBERS", r[r.USERS = 2] = "USERS", r[r.GUILDS = 3] = "GUILDS", r);
let G = 20,
...
function D(t, e, i) {
  ...
  return {
    ...
    [_.Plq.SEND_MESSAGES.toString()]: {
      title: _.TPd.GUILD_THREADS_ONLY.has(n) ? A.intl.string(A.t.nJwAHR) : n === _.d4z.GUILD_CATEGORY ? A.intl.string(A.t.S1VOwc) : A.intl.string(A.t.T32rkJ),
      description: (() => {
        switch (n) {
          case _.d4z.GUILD_CATEGORY:
            return A.t.IjeLur;
          case _.d4z.GUILD_FORUM:
            return (null == i ? true : i.createPostsDisabled) && !t.isMediaChannel() ? l.Z.getForumChannelPermissionText() : A.t.LG9VAg;
          ...
          case _.d4z.GUILD_VOICE:
            return s.Z.getTextInVoiceSendMessageChannelPermissionText(null == i ? true : i.sendMessagesDisabled);
          default:
            return A.t.WQ6zpa
        }
      })(),
    ...
    [_.Plq.MENTION_EVERYONE.toString()]: {
      title: n === _.d4z.GUILD_STAGE_VOICE ? A.intl.string(A.t.VDUAHB) : (null == i ? true : i.inGameMentionsExperiment) ? A.intl.string(A.t.lEO7Wl) : A.intl.string(A.t.Y78KGB),
      description: n === _.d4z.GUILD_CATEGORY ? A.t["HOhg/P"] : n === _.d4z.GUILD_STAGE_VOICE ? A.t.rZn1oK : (null == i ? true : i.inGameMentionsExperiment) ? A.t.wdHpIC : A.t["6IUSdn"],
      ...
      description: (() => {
        switch (n) {
          case _.d4z.GUILD_CATEGORY:
            return A.t["cJRv/v"];
          case _.d4z.GUILD_VOICE:
            return s.Z.getTextInVoiceReadMessageHistoryChannelPermissionText(null == i ? true : i.readMessageHistoryDisabled);
          case _.d4z.GUILD_FORUM:
          case _.d4z.GUILD_MEDIA:
            return A.t.RqCc7u;
          default:
    ...
    [_.Plq.USE_SOUNDBOARD.toString()]: {
      ...
      description: (() => {
        switch (n) {
          case _.d4z.GUILD_CATEGORY:
            return A.intl.format(A.t["0kBp//"], {
              helpCenterArticle: S.Z.getArticleURL(_.BhN.SOUNDBOARD)
            });
          case _.d4z.GUILD_TEXT:
          case _.d4z.GUILD_FORUM:
          case _.d4z.GUILD_MEDIA:
    ...
    [_.Plq.MANAGE_THREADS.toString()]: {
      title: _.TPd.GUILD_THREADS_ONLY.has(n) ? A.intl.string(A.t.ossiZG) : n === _.d4z.GUILD_CATEGORY ? A.intl.string(A.t.QKe7Q0) : A.intl.string(A.t.kEqgr6),
      description: (() => {
        switch (n) {
          case _.d4z.GUILD_CATEGORY:
            return A.t.S31soa;
    ...
    [_.Plq.SEND_MESSAGES_IN_THREADS.toString()]: {
      title: _.TPd.GUILD_THREADS_ONLY.has(n) ? A.intl.string(A.t.fqhqWl) : n === _.d4z.GUILD_CATEGORY ? A.intl.string(A.t["5QlVGx"]) : A.intl.string(A.t.fTE74u),
      description: (() => {
        switch (n) {
          case _.d4z.GUILD_CATEGORY:
            return A.t.DlIVcH;
