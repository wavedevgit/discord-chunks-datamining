...
let A = (0, C.Mg)(u.Z.GUILD_BOOSTING_SIDEBAR_DISPLAY_CONDITIONAL_BOTTOM_MARGIN),
  R = e => {
    let {
      guild: t,
      onSelect: n
    } = e, [l, o] = i.useState(t.premiumProgressBarEnabled), [s, a] = i.useState(!1), u = (0, c.e7)([_.Z], () => _.Z.can(P.Plq.MANAGE_GUILD, t)), p = async () => {
  ...
  M = e => {
    ...
    } = (0, g.ZP)(p.Z.GUILD_BOOSTING_SIDEBAR_DISPLAY), b = (0, O.Jh)(t.id), C = (0, y.Z)(t.id), A = (0, O.FZ)(b), D = null == A, L = null != A ? A : b, M = (0, c.e7)([S.Z], () => {
      var e;
    ...
    D && (z = (0, O.e9)(L), W = I.intl.format(I.t.B2byER, {
      numBoosts: C
