...
let P = (0, b.Mg)(u.Z.GUILD_BOOSTING_SIDEBAR_DISPLAY_CONDITIONAL_BOTTOM_MARGIN),
  ...
  T = e => {
    let {
      guild: t,
      withMargin: n
    } = e, l = (0, m.Jh)(t.id), u = (0, p.Z)(t.id), b = (0, m.FZ)(l), P = null == b, N = null != b ? b : l, w = (0, c.e7)([O.Z], () => {
      var e;
    ...
    let A = P ? "100%" : "".concat(Math.min(100, u / C.oCV[N] * 100), "%"),
      ...
      [D] = (0, d.q_F)(() => ({
        ...
        config: Z
      }), "respect-motion-settings", [w, u, R, A]),
      L = t.premiumTier < N && w >= C.oCV[N],
      M = (0, v.Z)(t),
      k = j.intl.formatToPlainString(j.t["2oNfMT"], {
        levelName: (0, m.e9)(N)
      }),
    ...
    P && (k = (0, m.e9)(N), U = j.intl.format(j.t.B2byER, {
      numBoosts: u
    })), k = k.toLocaleLowerCase();
    let G = (0, a.JA)("boosts-".concat(t.id));
    return (0, r.jsx)("li", {
      children: (0, r.jsx)(d.ua7, {
        text: L ? j.intl.formatToPlainString(E.default["9CtPjo"], {
          perk: (0, m.nW)(N)
        }) : P ? j.intl.string(j.t["Y+V9go"]) : j.intl.formatToPlainString(j.t.UyDKl5, {
          levelName: (0, m.nW)(N)
        }),
        ...
        delay: 200,
        hideOnClick: !0,
        children: e => (0, r.jsxs)(d.P3F, I(x({}, G, e), {
          "aria-label": void 0,
          role: "button",
          focusProps: {
            offset: {
          ...
          className: o()(S.container, {
            [S.containerWithMargin]: n
          }),
          onContextMenu: e => {
            T && (0, h.vq)(e, e => (0, r.jsx)(y.default, I(x({}, e), {
              guild: t
            })))
          },
          children: [(0, r.jsx)(d.nn4, {
            ...
            className: o()(S.progressBarContainer, {
              [S.progressBarContainerComplete]: P
            }),
