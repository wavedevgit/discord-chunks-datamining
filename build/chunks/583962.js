...
let A = (0, j.Mg)(u.Z.GUILD_BOOSTING_SIDEBAR_DISPLAY_CONDITIONAL_BOTTOM_MARGIN),
  D = e => {
    let {
      guild: t,
      onSelect: n
    } = e, [l, o] = i.useState(t.premiumProgressBarEnabled), [a, s] = i.useState(!1), u = (0, c.e7)([y.Z], () => y.Z.can(I.Plq.MANAGE_GUILD, t)), h = async () => {
  ...
  M = e => {
    ...
    } = (0, g.ZP)(h.Z.GUILD_BOOSTING_SIDEBAR_DISPLAY), b = (0, O.Jh)(t.id), j = (0, _.Z)(t.id), A = (0, O.FZ)(b), R = null == A, L = null != A ? A : b, M = (0, c.e7)([x.Z], () => {
      var e;
    ...
    let B = "".concat(Math.min(100, j / I.oCV[L] * 100), "%"),
      ...
      [W] = (0, d.q_F)(() => ({
        ...
        config: k
      }), "respect-motion-settings", [M, j, U, B]),
      ...
      F = N.NW.formatToPlainString(N.t["2oNfMT"], {
        levelName: (0, O.e9)(L)
      }),
    ...
    R && (F = (0, O.e9)(L), z = N.NW.format(N.t.B2byER, {
      numBoosts: j
    })), l && (F = F.toLocaleLowerCase());
    let Y = (0, s.JA)("boosts-".concat(t.id));
    return (0, r.jsx)("li", {
      children: (0, r.jsx)(d.ua7, {
        text: V ? N.NW.formatToPlainString(E.Z["9CtPjo"], {
          perk: (0, O.nW)(L)
        }) : R ? N.NW.string(N.t["Y+V9go"]) : N.NW.formatToPlainString(N.t.UyDKl5, {
          levelName: (0, O.nW)(L)
        }),
        ...
        delay: 200,
        hideOnClick: !0,
        children: e => (0, r.jsxs)(d.P3F, T(w({}, Y, e), {
          "aria-label": void 0,
          role: "button",
          focusProps: {
            offset: {
          ...
          children: [(0, r.jsx)(d.nn4, {
            ...
            className: o()(Z.progressBarContainer, {
              [Z.progressBarContainerComplete]: R
            }),
