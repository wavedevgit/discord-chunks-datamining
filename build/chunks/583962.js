...
let L = (0, E.Mg)(d.Z.GUILD_BOOSTING_SIDEBAR_DISPLAY_CONDITIONAL_BOTTOM_MARGIN),
  ...
  G = e => {
    let {
      guild: t,
      withMargin: n
    } = e, l = (0, j.Jh)(t.id), d = (0, _.Z)(t.id), E = (0, j.FZ)(l), L = null == E, M = null != E ? E : l, k = (0, c.e7)([S.Z], () => {
      var e;
    ...
    L && (W = (0, j.e9)(M), K = Z.intl.format(Z.t.B2byER, {
      numBoosts: d
    ...
    let [et, en] = (0, g.US)(ee), er = () => et === u.z.BOOSTER_ENHANCED_ROLE_COLORS_COACHMARK ? (0, r.jsx)(m.Z, {
      guild: t,
      markAsDismissed: en
    }) : null;
    return (0, r.jsx)("li", {
      children: (0, r.jsx)(h.ua7, {
        text: H ? Z.intl.formatToPlainString(T.default["9CtPjo"], {
          perk: (0, j.nW)(M)
        }) : L ? Z.intl.string(Z.t["Y+V9go"]) : Z.intl.formatToPlainString(Z.t.UyDKl5, {
          levelName: (0, j.nW)(M)
        }),
        position: "top",
        delay: 200,
        hideOnClick: !0,
        children: e => (0, r.jsx)(h.yRy, {
          targetElementRef: q,
          renderPopout: er,
          position: "right",
          align: "top",
          ...
          children: i => (0, r.jsx)("div", {
            ref: q,
            children: (0, r.jsxs)(h.P3F, D(R({}, Y, e, i), {
              "aria-label": void 0,
              role: "button",
              focusProps: {
                offset: {
              ...
              onContextMenu: e => {
                G && (0, p.vq)(e, e => (0, r.jsx)(I.default, D(R({}, e), {
                  guild: t
                })))
              },
              children: [(0, r.jsx)(h.nn4, {
                ...
                className: o()(A.progressBarContainer, {
                  [A.progressBarContainerComplete]: L
                }),
