...
function f(e) {
  ...
  let {
    ...
    imageDimensions: m,
    onLoadComplete: g
  } = e, E = (0, s.e7)([l.Z], () => l.Z.useReducedMotion), b = null == p || p.asset.isAnimated ? null : p.asset.url, y = null != h && h.asset.isAnimated ? h.asset.url : null, O = null == m ? void 0 : m.width, v = null == m ? void 0 : m.height, I = i.useMemo(() => {
    let e = null != O && null != v ? (0, u.nK)(O, v) : null;
    return null != b ? (0, u.sN)(b, {
      format: "webp",
      width: null == e ? void 0 : e.width,
      height: null == e ? void 0 : e.height
    }) : null != y ? (0, u.f0)(y, null != e ? e : void 0) : null
  }, [b, y, O, v]);
