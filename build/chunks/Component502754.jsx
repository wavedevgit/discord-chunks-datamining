...
function C(e) {
  ...
  }), A = g.hH.useSetting(), x = (0, d.iJ)(i), v = false, C = 0 === l.messages.length || s()(l.messages[0].timestamp).isSame(s()(), "day"), S = null != (t = null == (n = m.default.getUser(f.default.getId())) ? true : n.hasFlag(O.nhx.SPAMMER)) && t, I = [];
  if (!l.collapsed) {
    let e = null,
      t = null,
