...
let j = function(l) {
  ...
  }), [_, y] = r.useState(false), [I, M] = r.useState(null != (n = null == A ? true : A.nick) ? n : ""), [Z, P] = r.useState({});
  (0, d.ZP)(() => {
  ...
  let G = (0, o.sE)(c, {
    ...
    S = r.useCallback(async l => {
      ...
      try {
        ...
        (null == n ? true : n.nick) != null ? l = (null == (u = n.nick) || null == (i = u._errors) || null == (r = i[0]) ? true : r.message) || C.intl.string(C.t.xex86u) : (null == n ? true : n.username) != null && (l = (null == (h = n.username) || null == (x = h._errors) || null == (d = x[0]) ? true : d.message) || C.intl.string(C.t.xex86u)), P({
          nick: l
        })
      }
    }, [c, I, k, s, A, G]);
