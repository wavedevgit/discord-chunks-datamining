...
function C(e) {
  ...
  null != C && C ? u = (0, r.jsx)(s.kZF, {
    ...
    onClick: e => {
      var t;
      t = b.type, (0, O.yw)(v.rMx.CONNECTED_ACCOUNT_VIEWED, {
        platform_type: t,
        other_user_id: N
      }), (0, y.q)({
        href: G,
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [(0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)(s.ua7, {
              overflowOnly: !0,
              text: b.name,
              children: e => (0, r.jsx)(s.Text, g(S({}, e), {
...
let L = c.forwardRef(function(e, t) {
  ...
  let u = n.filter(e => d.Z.isSupported(e.type)).map(e => (0, r.jsx)(C, {
    connectedAccount: e,
    theme: i,
    locale: c,
    userId: o
  }, "".concat(e.type, ":").concat(e.id)));
  if (s === h.lY.MODAL_V2) return (0, r.jsx)("div", {
    ref: t,
