...
function m(e) {
  ...
  return <div className={u.container}>{<i.ua7 text={c.intl.string(c.t.MPFyJy)} aria-label={c.intl.string(c.t.X3Ekj4)}>{e => {
      ...
      }}</i.ua7>}{<i.Text variant={"text-xs/medium"}>{c.intl.format(c.t.Sv8iiY, {
        price: m,
