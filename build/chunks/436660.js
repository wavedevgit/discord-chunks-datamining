...
n.d(t, {
  Q: () => c
}), n(388685), n(784620), n(973216), n(583741), n(35282);
var r = n(327432),
  i = n(91313),
  a = n(887490),
  o = n(42530);
...
let c = function(e, t) {
  ...
  resetSelectionToLineStart(e) {
    let {
      selection: t
    } = e, n = null != t ? f(t)[0].path.slice(0, -1) : [];
    r.YR.select(e, a.bN.start(e, n))
  },
  resetSelectionToLineEnd(e) {
    let {
      selection: t
    } = e, n = null != t ? f(t)[1].path.slice(0, -1) : [];
  ...
  textToText(e, t, n) {
    ...
    a.M8.isExpanded(n) && r.YR.delete(e, {
      ...
      at: c
    }), c = null != c ? c : a.bN.start(e, []), u = null != u ? u : a.bN.end(e, []), d(e, o, c, u, u)
  },
  textToVoid(e, t, n) {
    ...
    r.YR.delete(e, {
      at: n,
      voids: !0
    }), 0 === o.offset && r.YR.insertNodes(e, [{
      text: ""
    }], {
      at: o.path
    }), r.YR.insertNodes(e, [t], {
      at: o
    }), a.bN.hasPath(e, l.path) && a.LC.isText(a.bN.node(e, l.path)[0]) || r.YR.insertNodes(e, [{
      text: ""
    }], {
      at: l.path
    }), d(e, i, o, l, l)
  ...
  keyboardMove(e, t) {
    ...
    if (null == s) return;
    if (void 0 === o && a.M8.isExpanded(s)) return void r.YR.collapse(e, {
      edge: n ? "start" : "end"
    });
    ...
    null != u && ("focus" === o ? r.YR.setSelection(e, {
      focus: u
    }) : r.YR.setSelection(e, {
      focus: u,
      anchor: u
