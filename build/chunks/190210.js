...
function ea(e, t) {
  ...
  let {
    ...
    parentModalKey: eA
  } = e, eN = v.Z.useField("channelDrafts")[j.id], eC = null != (o = null == eN ? void 0 : eN.title) ? o : "", eR = null == eN ? void 0 : eN.heroFile, eP = null == (s = null == eN ? void 0 : eN.publish) || s, ew = null == (u = null == eN ? void 0 : eN.createThread) || u;
  ...
  } = (0, F.TE)(j, V, eU, C), eH = !w.dN.useSetting() && !(0, k.isAndroidWeb)() && null != window.ResizeObserver, eY = !eH || !(null == (n = V.commands) ? void 0 : n.enabled) || !z || f !== W.GI, eW = (0, R.Z)(), {
    fontSize: eK
  } = (0, d.cj)([g.Z], () => ({
  ...
  let [ts, tl] = i.useState(!1), tc = z || ts || f.length > 0 || null != eR || eC.length > 0, {
...
function el(e) {
  ...
  let {
    channelId: i,
    canCreateThread: o
  } = e, a = v.Z.useField("channelDrafts")[i], s = null == (t = null == a ? void 0 : a.createThread) || t, l = null == (n = null == a ? void 0 : a.publish) || n;
