...
n.d(t, {
  Z: () => es
}), n(704826), n(35282), n(539854), n(388685), n(781311), n(190126), n(368063), n(65234), n(111804), n(490233), n(97749);
var r = n(255367),
  i = n(73800),
  a = n(120356),
  o = n.n(a),
...
function eo(e, t) {
  ...
  let {
    ...
    parentModalKey: eA
  } = e, eN = v.Z.useField("channelDrafts")[M.id], eC = null != (a = null == eN ? void 0 : eN.title) ? a : "", ew = null == eN ? void 0 : eN.heroFile, eR = null == (s = null == eN ? void 0 : eN.publish) || s, eP = null == (u = null == eN ? void 0 : eN.createThread) || u;
  l()(null != V, "chat input type must be set");
  let {
    analyticsLocations: eD
  } = (0, b.ZP)(E.Z.CHANNEL_TEXT_AREA), eL = (0, F.qz)(t), ex = i.useRef(null), ek = i.useRef(null), ej = i.useRef(null), eM = i.useRef(null);
  ...
  } = (0, F.TE)(M, V, eU, C), eH = !P.dN.useSetting() && !(0, j.isAndroidWeb)() && null != window.ResizeObserver, eY = !eH || !(null == (n = V.commands) ? void 0 : n.enabled) || !z || f !== W.GI, eW = (0, w.Z)(), {
    fontSize: eK
  } = (0, d.cj)([g.Z], () => ({
    fontSize: g.Z.fontSize,
    isSubmitButtonEnabled: g.Z.isSubmitButtonEnabled
  })), ez = (0, d.e7)([L.Z], () => L.Z.isEnabled()), eq = (0, R.NE)(M);
  (0, F.hJ)(V, eZ);
  let {
    eventEmitter: e$,
    handleEditorSelectionChanged: eX
  } = (0, F.x2)(ek, f, m), eQ = i.useCallback(e => {
    var t;
    let n = [];
    null != ew && n.push({
    ...
    return o.length > 0 && n.push({
      ...
      title: "",
      heroFile: null
    }), null == (t = ek.current) || t.blur(), e_(et(J({}, e), {
      components: n,
    ...
    handleOuterClick: tr
  } = (0, F.iV)(V, e$, ek), ti = (0, F.ae)(ek), ta = (0, F.Sg)(eJ, V, ek), to = (0, F.O1)({
    editorRef: ek,
    disabled: eZ,
    textValue: f,
    channelId: M.id,
  ...
  let [ts, tl] = i.useState(!1), tc = z || ts || f.length > 0 || null != ew || eC.length > 0, {
  ...
  }), tf = i.useRef(null), [t_, tp] = i.useState(!1), th = i.useRef(!1), tm = i.useCallback(() => {
    th.current = !0;
    let e = setTimeout(() => {
      th.current && tp(!0)
    }, 100);
    ...
    null != t && p.Z.remove(M.id, t, D.d.ChannelMessage), (0, v.c)(M.id, {
      heroFile: null
    })
    ...
    children: (0, r.jsxs)(b.Gt, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)("div", {
          ref: ej,
          onScroll: e5,
          className: o()(X.announcementScrollableContainer, {
            [X.themedBackground]: !eT
          }),
          children: (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsxs)("div", {
              ...
              children: [(0, r.jsxs)(c.animated.div, {
                ...
                children: [null != ew ? (0, r.jsx)(ec, {
                  file: ew,
                  onRemoveHeroImage: tE
                }) : null, null != ew ? null : (0, r.jsx)(ed, {
                  channel: M,
                  onImageUploaded: e => (0, v.c)(M.id, {
                    heroFile: e
                  }),
                  onFocus: () => tl(!0)
                }), (0, r.jsx)("input", {
          ...
          children: [(0, r.jsxs)("div", {
            ...
            children: (0, r.jsx)("div", {
              ...
              children: (0, r.jsx)(_.yRy, {
                ...
                position: "top",
                align: "right",
                children: e => (0, r.jsx)(_.zxk, et(J({}, e), {
                  onClick: () => {
...
function el(e) {
  ...
  let {
    channelId: i,
    canCreateThread: a
  } = e, o = v.Z.useField("channelDrafts")[i], s = null == (t = null == o ? void 0 : o.createThread) || t, l = null == (n = null == o ? void 0 : o.publish) || n;
...
function ec(e) {
  ...
  let [s, l] = i.useState(!1), c = i.useCallback(() => {
    l(!0)
  }, []), u = i.useCallback(() => {
    l(!1)
  }, []);
...
function ed(e) {
  ...
  }, [l, c] = i.useState(!1), d = i.useCallback(() => {
    c(!0)
  }, []), h = i.useCallback(() => {
    c(!1)
  }, []);
