...
let en = i.memo(i.forwardRef(function(e, t) {
  var n, l, o, u;
  let {
    textValue: p,
    richValue: g,
    ...
    parentModalKey: eO
  } = e, eE = v.Z.useField("channelDrafts")[k.id], eS = null != (l = null == eE ? void 0 : eE.title) ? l : "", eP = null == eE ? void 0 : eE.heroFile, eI = null == (o = null == eE ? void 0 : eE.publish) || o, eZ = null == (u = null == eE ? void 0 : eE.createThread) || u;
  s()(null != G, "chat input type must be set");
  let {
    analyticsLocations: eT
  } = (0, y.ZP)(_.Z.CHANNEL_TEXT_AREA), eN = (0, H.qz)(t), eA = i.useRef(null), ew = i.useRef(null), eR = i.useRef(null), eM = i.useRef(null);
  ...
  } = (0, H.TE)(k, G, eD, I), eH = !N.dN.useSetting() && !(0, D.isAndroidWeb)() && null != window.ResizeObserver, eG = !eH || !(null == (n = G.commands) ? void 0 : n.enabled) || !q || p !== W.GI, eV = (0, Z.Z)(), {
    fontSize: ez
  } = (0, d.cj)([b.Z], () => ({
    fontSize: b.Z.fontSize,
    isSubmitButtonEnabled: b.Z.isSubmitButtonEnabled
  })), eW = (0, d.e7)([w.Z], () => w.Z.isEnabled()), eY = (0, T.NE)(k);
  (0, H.hJ)(G, eU);
  let {
    eventEmitter: eq,
  ...
  let [tl, ta] = i.useState(!1), to = q || tl || p.length > 0 || null != eP || eS.length > 0, {
  ...
  }), tu = i.useRef(null), [td, tp] = i.useState(!1), th = i.useRef(!1), tf = i.useCallback(() => {
    th.current = !0;
    let e = setTimeout(() => {
      th.current && tp(!0)
    }, 100);
    ...
    null != t && f.Z.remove(k.id, t, A.d.ChannelMessage), (0, v.c)(k.id, {
      heroFile: null
    })
...
function er(e) {
  ...
  let {
    channelId: i,
    canCreateThread: l
  } = e, a = v.Z.useField("channelDrafts")[i], o = null == (t = null == a ? void 0 : a.createThread) || t, s = null == (n = null == a ? void 0 : a.publish) || n;
...
function ei(e) {
  ...
  let [o, s] = i.useState(!1), c = i.useCallback(() => {
    s(!0)
  }, []), u = i.useCallback(() => {
    s(!1)
  }, []);
...
function el(e) {
  ...
  return (0, r.jsx)(S.Z, {
    ...
    look: "blank",
    onChange: e => {
      (0, k.d)(e.currentTarget.files, t, A.d.ChannelMessage, {
        requireConfirm: !0
...
function ea(e) {
  ...
  }, [s, c] = i.useState(!1), d = i.useCallback(() => {
    c(!0)
  }, []), m = i.useCallback(() => {
    c(!1)
  }, []);
