...
let E = e => e ? _.intl.string(_.t.QX14gI) : _.intl.string(_.t.RGadQU),
  C = e => {
    ...
    return (0, i.jsxs)(o.P3F, {
      ...
      children: [t ? _.intl.string(_.t.maZaNz) : _.intl.string(_.t["37C26e"]), t ? (0, i.jsx)(o.u04, {
        size: "md",
        color: "currentColor",
        className: x.arrow
      }) : (0, i.jsx)(o.CJ0, {
  ...
  O = e => {
    ...
    } = e, [s, d] = r.useState(!1), g = (0, f.N)({
      styles: x
    }), m = (0, a.e7)([c.Z], () => c.Z.useReducedMotion), {
      analyticsLocations: _
    } = (0, u.ZP)(), O = (0, p._f)(), S = [g.emoji, g.streaming, g.upload, g.customAppIcons, g.soundboard, O ? g.remix : g.videoBackground, g.superReactions, g.stickersPremiumPerk, g.badgeAlt];
    return (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsx)(o.X6q, {
        ...
        className: l()(x.perkCardContainer, {
          [x.perkCardContainerExpanded]: s
        }),
        children: S.map(e => null != e && (0, i.jsx)(j, function(e) {
