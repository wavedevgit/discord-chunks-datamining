...
let I = e => {
  ...
  }, Z = <v.Z color={u.Tt.CUSTOM} className={P.uploadFileInputContainer} innerClassName={P.uploadThumbnailContainer} onChange={R} multiple={false} aria-hidden={true} filters={S} aria-describedby={T} aria-label={I ? w.intl.string(w.t.MxJI3d) : w.intl.string(w.t.CbiofX)}>{I ? (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsx)(N, {
        mediaAttachments: j,
  ...
  return <div className={P.thumbnailContainer} style={E}>{null != _ ? (0, r.jsx)(p.Z, {
