...
class ta extends i.PureComponent {
  ...
  renderChat() {
    ...
    if (e.isNSFW() && (!i || !t)) return (0, r.jsx)(v.Z, {
      guild: n,
      channelId: e.id
    });
    if (e.isGuildVocal()) return null;
    if (e.isDirectory()) return s()(null != n, "directory channels must exist within a guild"), (0, r.jsx)(L.Z, {
      channel: e,
      guild: n
    });
  ...
  renderSidebar() {
    ...
    else if (o === e7.ULH.PROFILE && t.isPrivate() && !a && !c && !u) return (0, r.jsx)(ew.Z, {
      channel: t
    ...
    } else if (o === e7.ULH.SEARCH && null != e) return (0, r.jsx)(eC.Z, {
      searchId: e
    });
    return null
  }
    ...
    super(...e), tr(this, "state", {
      ...
      switch (e.type) {
        ...
        case e7.d4z.GUILD_VOICE:
          break;
        case e7.d4z.DM:
          a.push(this.renderClipsEnabledIndicatorToolbarItem()), a.push(this.renderStreamQualityLiveIndicatorToolbarItem()), a.push((0, r.jsx)(ea.Z, {
            channel: e
          ...
          break;
        case e7.d4z.GROUP_DM:
          if (a.push(this.renderJoinRequestInterviewButtons()), a.push(this.renderClipsEnabledIndicatorToolbarItem()), a.push(this.renderStreamQualityLiveIndicatorToolbarItem()), a.push((0, r.jsx)(ea.Z, {
              channel: e
            }, "calls")), a.push((0, r.jsx)(et.Z, {
              channel: e
            }, "pins")), !e.isManaged()) {
...
let ts = (0, j.Z)(ta),
  tc = i.memo(function(e) {
    ...
    let {
      providedChannel: n
    } = e, [l, o] = i.useState(null), a = (0, p.e7)([eW.Z], () => eW.Z.getChannelId()), s = (0, p.e7)([eW.Z], () => eW.Z.getVoiceChannelId()), c = (0, p.e7)([eL.Z], () => null != n ? n : eL.Z.getChannel(a), [a, n]), m = (0, p.e7)([eL.Z], () => eL.Z.getChannel(s), [s]), b = null == c ? void 0 : c.parent_id, _ = (0, p.e7)([eL.Z], () => eL.Z.getChannel(b), [b]), y = (0, p.e7)([eH.Z], () => eH.Z.getGuild(null == c ? void 0 : c.guild_id), [c]), {
