...
class tl extends i.PureComponent {
  ...
  constructor(...e) {
    super(...e), tt(this, "state", {
      ...
      return (null == e ? void 0 : e.type) !== e6.fO.STREAM ? null : (0, r.jsx)(G.Z, {
...
let to = (0, j.Z)(tl),
  ta = i.memo(function(e) {
    ...
    let {
      providedChannel: n
    } = e, [l, o] = i.useState(null), a = (0, p.e7)([eV.Z], () => eV.Z.getChannelId()), s = (0, p.e7)([eV.Z], () => eV.Z.getVoiceChannelId()), c = (0, p.e7)([eL.Z], () => null != n ? n : eL.Z.getChannel(a), [a, n]), m = (0, p.e7)([eL.Z], () => eL.Z.getChannel(s), [s]), b = null == c ? void 0 : c.parent_id, _ = (0, p.e7)([eL.Z], () => eL.Z.getChannel(b), [b]), y = (0, p.e7)([eB.Z], () => eB.Z.getGuild(null == c ? void 0 : c.guild_id), [c]), {
    ...
    }), I = (0, p.e7)([N.ZP], () => null != c ? N.ZP.getSelfEmbeddedActivityForChannel(c.id) : null, [c]), A = (0, p.e7)([eG.ZP], () => eG.ZP.isConnected()), w = (0, E.Z)(A), R = A && !1 === w;
    i.useEffect(() => {
