...
class tl extends i.PureComponent {
  ...
  renderSidebar() {
    ...
    } else if (o === e3.ULH.SEARCH && null != e) return (0, r.jsx)(ev.Z, {
      searchId: e
    });
    return null
  }
      ...
      switch (e.type) {
        ...
        case e3.d4z.PUBLIC_THREAD:
          null == t || t.isForumLikeChannel() || o.push((0, r.jsx)(eN.Z, {
            ...
            channel: e
          }, "pins")), e.isArchivedThread() || o.push((0, r.jsx)(Q.Z, {
            channelId: e.id
        ...
        case e3.d4z.GUILD_MEDIA:
          n || (o.push((0, r.jsx)(er.Z, {
            ...
            channel: e
          }, "notifications"))), __OVERLAY__ || o.push((0, r.jsx)(Q.Z, {
            channelId: e.id
          }, "members"));
          break;
        case e3.d4z.GUILD_DIRECTORY:
...
let to = (0, j.Z)(tl),
  ta = i.memo(function(e) {
    ...
    let M = (0, p.e7)([N.ZP], () => {
      ...
      J = (0, ed.Z)(null == C ? void 0 : C.id),
      Q = (0, eM.Z)(G, null == C ? void 0 : C.id),
      {
        section: $,
