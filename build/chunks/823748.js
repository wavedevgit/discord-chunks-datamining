...
let to = (0, j.Z)(ta),
  ts = i.memo(function(e) {
    ...
    }, [o]), v = (0, H.Z)(), j = (0, p.e7)([eW.Z], () => {
      var e;
      return (null != (e = null == v ? void 0 : v.channelId) ? e : eW.Z.getVoiceChannelId()) === (null == c ? void 0 : c.id)
    }), P = (0, p.e7)([I.ZP], () => null != c ? I.ZP.getSelfEmbeddedActivityForChannel(c.id) : null, [c]), N = (0, p.e7)([eV.Z], () => eV.Z.isConnected()), w = (0, E.Z)(N), R = N && !1 === w;
    i.useEffect(() => {
      j && R && null != P && null != c && g.Z.selectParticipant(c.id, (0, T.gN)({
    ...
    i.useEffect(() => {
      ...
      (e || t) && (0, B.EW)(h.z.ACTIVITY_GDM_CALL_TOOLTIP, {
