...
class to extends i.PureComponent {
  ...
  renderSidebar() {
    ...
    else if (o === e7.ULH.PROFILE && t.isPrivate() && !a && !c) return (0, r.jsx)(ew.Z, {
      channel: t
    }, "private-channel-profile-".concat(t.id));
    else if (o === e7.ULH.MEMBERS) switch (t.type) {
      case e7.d4z.GROUP_DM:
        return (0, r.jsx)(x.Z, {
          channel: t
    ...
    } else if (o === e7.ULH.SEARCH && null != e) return (0, r.jsx)(ey.Z, {
      searchId: e
    });
    return null
  }
  openChannelModal() {
    ...
    return null == e || null == t || a || i || (s && (0, g.ZDy)(async () => {
      let {
        default: e
  ...
  constructor(...e) {
    super(...e), tn(this, "state", {
      ...
      return (null == e ? void 0 : e.hasFlag(e3.zZ.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) ? (0, r.jsx)(q.Z, {
        channelId: e.id,
      ...
      return (null == e ? void 0 : e.type) !== e5.fO.STREAM ? null : (0, r.jsx)(z.Z, {
      ...
      switch (e.type) {
        ...
        case e7.d4z.PUBLIC_THREAD:
          o.push((0, r.jsx)(eI.Z, {
            channel: e
          })), null == t || t.isForumLikeChannel() || o.push((0, r.jsx)(eS.Z, {
            channel: t
          }, "browser")), e.isVocalThread() && o.push((0, r.jsx)(ed.Z, {
            channel: e
          }, "thread-call")), o.push((0, r.jsx)(eP.Z, {
            channel: e
...
let ta = (0, O.Z)(to),
  ts = i.memo(function(e) {
    ...
    let {
      providedChannel: n
    } = e, [l, o] = i.useState(null), a = (0, h.e7)([eW.Z], () => eW.Z.getChannelId()), s = (0, h.e7)([eW.Z], () => eW.Z.getVoiceChannelId()), c = (0, h.e7)([eD.Z], () => null != n ? n : eD.Z.getChannel(a), [a, n]), p = (0, h.e7)([eD.Z], () => eD.Z.getChannel(s), [s]), g = null == c ? void 0 : c.parent_id, _ = (0, h.e7)([eD.Z], () => eD.Z.getChannel(g), [g]), x = (0, h.e7)([eF.Z], () => eF.Z.getGuild(null == c ? void 0 : c.guild_id), [c]), {
