...
class tl extends i.PureComponent {
  ...
  constructor(...e) {
    super(...e), tt(this, "state", {
      ...
      return (null == e ? void 0 : e.type) !== e4.fO.STREAM ? null : (0, r.jsx)(H.Z, {
...
let to = (0, j.Z)(tl),
  ta = i.memo(function(e) {
    ...
    let {
      providedChannel: n
    } = e, [l, o] = i.useState(null), a = (0, p.e7)([ez.Z], () => ez.Z.getChannelId()), s = (0, p.e7)([ez.Z], () => ez.Z.getVoiceChannelId()), c = (0, p.e7)([eL.Z], () => null != n ? n : eL.Z.getChannel(a), [a, n]), m = (0, p.e7)([eL.Z], () => eL.Z.getChannel(s), [s]), b = null == c ? void 0 : c.parent_id, _ = (0, p.e7)([eL.Z], () => eL.Z.getChannel(b), [b]), y = (0, p.e7)([eG.Z], () => eG.Z.getGuild(null == c ? void 0 : c.guild_id), [c]), {
    ...
    }, [a]), v = (0, F.Z)(), j = (0, p.e7)([ez.Z], () => {
      var e;
      return (null != (e = null == v ? void 0 : v.channelId) ? e : ez.Z.getVoiceChannelId()) === (null == c ? void 0 : c.id)
    }), P = (0, p.e7)([I.ZP], () => null != c ? I.ZP.getSelfEmbeddedActivityForChannel(c.id) : null, [c]), A = (0, p.e7)([eH.Z], () => eH.Z.isConnected()), w = (0, E.Z)(A), R = A && !1 === w;
    i.useEffect(() => {
