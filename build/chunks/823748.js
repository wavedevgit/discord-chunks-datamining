...
class ts extends i.PureComponent {
  ...
  renderSidebar() {
    ...
    else if (l === e8.ULH.PROFILE && e.isPrivate() && !a && !o && !c) return (0, r.jsx)(eM.Z, {
      channel: e
    }, "private-channel-profile-".concat(e.id));
    else if (l === e8.ULH.MEMBERS) switch (e.type) {
      case e8.d4z.GROUP_DM:
        return (0, r.jsx)(y.Z, {
          channel: e
    ...
    } else if (l === e8.ULH.SEARCH) return (0, r.jsx)(ev.Z, {
