...
class ts extends i.PureComponent {
  ...
  renderSidebar() {
    ...
    if (s()(null != e, "Missing channel in Channel.renderSidebar"), __OVERLAY__ || i);
    else if (l === e5.ULH.PROFILE && e.isPrivate() && !a && !o && !c) return (0, r.jsx)(eM.Z, {
      channel: e
      ...
      case e5.d4z.PUBLIC_THREAD:
      case e5.d4z.PRIVATE_THREAD:
        if (!e.isArchivedThread() && null != n) return (0, r.jsx)(x.Z, {
          channel: e,
          guild: n
        }, "channel-members-".concat(e.id))
    } else if (l === e5.ULH.SEARCH) return (0, r.jsx)(ev.Z, {
...
let tc = (0, O.Z)(ts),
  tu = i.memo(function(e) {
    ...
    let {
      providedChannel: n
    } = e, [l, a] = i.useState(null), o = (0, p.e7)([eY.Z], () => eY.Z.getChannelId()), s = (0, p.e7)([eY.Z], () => eY.Z.getVoiceChannelId()), c = (0, p.e7)([eB.Z], () => null != n ? n : eB.Z.getChannel(o), [o, n]), m = (0, p.e7)([eB.Z], () => eB.Z.getChannel(s), [s]), g = null == c ? void 0 : c.parent_id, _ = (0, p.e7)([eB.Z], () => eB.Z.getChannel(g), [g]), y = (0, p.e7)([eV.Z], () => eV.Z.getGuild(null == c ? void 0 : c.guild_id), [c]), {
