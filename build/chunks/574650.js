...
let P = () => {
  ...
  switch (g) {
    case _.wB.SUBMITTED:
      y = S.NW.string(S.t["5iLvS0"]), m = S.NW.string(S.t.mqtdmZ), h = () => {
        (0, s.h7j)(e => {
          var t, n;
      ...
      break;
    case _.wB.REJECTED:
      y = S.NW.string(S.t.lk30cX), m = S.NW.string(S.t["8RrsHh"]), h = () => {
        (0, s.ZDy)(async () => {
          let {
            default: e
      ...
      break;
    default:
      y = S.NW.string(S.t.G5YKXF), m = S.NW.string(S.t["r8/DT0"]), h = () => {
        (0, E.hk)(P.id)
      }
  }
  return (0, r.jsxs)("div", {
