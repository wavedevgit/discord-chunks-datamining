...
let N = () => {
  ...
  switch (A) {
    case p.wB.SUBMITTED:
      C = T.intl.string(T.t["5iLvS0"]), P = T.intl.string(T.t.mqtdmZ), D = () => {
        (0, c.h7j)(e => {
          var t, n;
          return (0, r.jsx)(c.ConfirmModal, (t = g({
      ...
      break;
    case p.wB.REJECTED:
      C = T.intl.string(T.t.lk30cX), P = T.intl.string(T.t["8RrsHh"]), D = () => {
        (0, c.ZDy)(async () => {
          let {
            default: e
      ...
      break;
    default:
      C = T.intl.string(T.t.G5YKXF), P = T.intl.string(T.t["r8/DT0"]), D = () => {
        (0, E.hk)(N.id)
      }
  }
  return (0, r.jsxs)("div", {
