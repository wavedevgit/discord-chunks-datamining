...
let f = 12633 == n.j ? () => {
  ...
  switch (P) {
    case E.wB.SUBMITTED:
      y = T.intl.string(T.t["5iLvS0"]), b = T.intl.string(T.t.mqtdmZ), D = () => {
        (0, c.h7j)(e => {
          var t, n;
          return (0, i.jsx)(c.ConfirmModal, (t = N({
      ...
      break;
    case E.wB.REJECTED:
      y = T.intl.string(T.t.lk30cX), b = T.intl.string(T.t["8RrsHh"]), D = () => {
        (0, c.ZDy)(async () => {
          let {
            default: e
      ...
      break;
    default:
      y = T.intl.string(T.t.G5YKXF), b = T.intl.string(T.t["r8/DT0"]), D = () => {
        (0, h.hk)(f.id)
      }
  }
  return (0, i.jsxs)("div", {
