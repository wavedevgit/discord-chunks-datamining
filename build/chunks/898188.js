...
function S(e) {
  ...
  let {
    ...
    channelAction: E,
    completed: b
  } = (0, g.P3)(_, f), S = (0, g.K_)(_, null == E ? void 0 : E.channelId), A = (0, l.e7)([u.Z], () => u.Z.useReducedMotion), N = (null == E ? void 0 : E.actionType) === m.oi.VIEW, C = (0, c.dQu)(c.TVs.colors.WHITE), [R, P] = i.useState(!1), [w] = i.useState(new s.Z.Value(0)), [D] = i.useState(new s.Z.Value(0));
  i.useEffect(() => {
    b ? s.Z.timing(w, {
      toValue: 0,
      duration: A ? 1 : 350,
