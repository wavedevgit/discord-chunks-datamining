...
let W = {
    skye: {
      name: Chunk196901.default.tzvUK3,
    ...
    quinn: {
      name: Chunk196901.default["biQVN/"],
    ...
    axel: {
      name: Chunk196901.default.VCZdns,
    ...
    sebastien: {
      name: Chunk196901.default["NmbfH+"],
    ...
    megaphone: {
      name: Chunk196901.default.fPU01d,
    ...
    robot: {
      name: Chunk196901.default.anBE8T,
    ...
    tunes: {
      name: Chunk196901.default.sem63B,
    ...
    ghost: {
      name: Chunk196901.default["lFIyM/"],
    ...
    space_bunny: {
      name: Chunk196901.default["KN+v77"],
    ...
    justus: {
      name: Chunk196901.default.ZVrsKC,
    ...
    harper: {
      name: Chunk196901.default.vIrxZS,
    ...
    villain: {
      name: Chunk196901.default.kHmvdt,
    ...
    solara: {
      name: Chunk196901.default.ndNi1j,
    ...
    cave: {
      name: Chunk196901.default.Xypb3z,
    ...
    deepfried: {
      name: Chunk196901.default.qRFFLK,
...
W["robot-synthetic"] = K(W.robot, {
  name: Chunk196901.default["Ur/62B"]
}), W["chords-2part"] = K(W.tunes, {
  name: Chunk196901.default.TYbrfK
}), W["chords-choir"] = K(W.tunes, {
  name: Chunk196901.default.OnZ6g9
}), W["chords-dev"] = K(W.tunes, {
  name: Chunk196901.default["2XH8tr"]
}), W["robot-dev"] = K(W.robot, {
  name: Chunk196901.default.XhhSOi
}), W["ghost-dev"] = K(W.ghost, {
  name: Chunk196901.default.KmHwvD
}), W["wobble-dev"] = K(W.ghost, {
  name: Chunk196901.default["6PDpse"]
}), W["fan-dev"] = K(W.robot, {
  name: Chunk196901.default["87aX+2"]
}), W["autotune-dev"] = K(W.tunes, {
  name: Chunk196901.default.EYDrRx
})