...
let W = {
    skye: {
      name: Chunk312357.default.tzvUK3,
    ...
    quinn: {
      name: Chunk312357.default["biQVN/"],
    ...
    axel: {
      name: Chunk312357.default.VCZdns,
    ...
    sebastien: {
      name: Chunk312357.default["NmbfH+"],
    ...
    megaphone: {
      name: Chunk312357.default.fPU01d,
    ...
    robot: {
      name: Chunk312357.default.anBE8T,
    ...
    tunes: {
      name: Chunk312357.default.sem63B,
    ...
    ghost: {
      name: Chunk312357.default["lFIyM/"],
    ...
    space_bunny: {
      name: Chunk312357.default["KN+v77"],
    ...
    justus: {
      name: Chunk312357.default.ZVrsKC,
    ...
    harper: {
      name: Chunk312357.default.vIrxZS,
    ...
    villain: {
      name: Chunk312357.default.kHmvdt,
    ...
    solara: {
      name: Chunk312357.default.ndNi1j,
    ...
    cave: {
      name: Chunk312357.default.Xypb3z,
    ...
    deepfried: {
      name: Chunk312357.default.qRFFLK,
...
W["robot-synthetic"] = K(W.robot, {
  name: Chunk312357.default["Ur/62B"]
}), W["chords-2part"] = K(W.tunes, {
  name: Chunk312357.default.TYbrfK
}), W["chords-choir"] = K(W.tunes, {
  name: Chunk312357.default.OnZ6g9
}), W["chords-dev"] = K(W.tunes, {
  name: Chunk312357.default["2XH8tr"]
}), W["robot-dev"] = K(W.robot, {
  name: Chunk312357.default.XhhSOi
}), W["ghost-dev"] = K(W.ghost, {
  name: Chunk312357.default.KmHwvD
}), W["wobble-dev"] = K(W.ghost, {
  name: Chunk312357.default["6PDpse"]
}), W["fan-dev"] = K(W.robot, {
  name: Chunk312357.default["87aX+2"]
}), W["autotune-dev"] = K(W.tunes, {
  name: Chunk312357.default.EYDrRx
})