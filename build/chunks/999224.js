...
let G = {
  ...
  villain: {
    ...
    baseColor: "#3D0109",
    styleKey: "villain",
    previewSoundURLs: [v.Z, b.Z, y.Z, O.Z]
  },
  solara: {
    name: I.Z.ndNi1t,
    iconURL: M.Z,
  ...
  deepfried: {
    ...
    baseColor: "#3D2701",
    styleKey: "deepfried",
    previewSoundURLs: [a.Z, s.Z, l.Z]
  }
};
G.rachel = G.skye, G.alex = G.quinn, G.elliot = G.axel, G.sebastian = G.sebastien, G.justin = G.justus, G.taylor = G.harper, G.monique = G.solara