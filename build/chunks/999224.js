...
let W = {
    skye: {
      name: Chunk151589.default.tzvUK3,
    ...
    quinn: {
      name: Chunk151589.default["biQVN/"],
    ...
    axel: {
      name: Chunk151589.default.VCZdns,
    ...
    sebastien: {
      name: Chunk151589.default["NmbfH+"],
    ...
    megaphone: {
      name: Chunk151589.default.fPU01d,
    ...
    robot: {
      name: Chunk151589.default.anBE8T,
    ...
    tunes: {
      name: Chunk151589.default.sem63B,
    ...
    ghost: {
      name: Chunk151589.default["lFIyM/"],
    ...
    space_bunny: {
      name: Chunk151589.default["KN+v77"],
    ...
    justus: {
      name: Chunk151589.default.ZVrsKC,
    ...
    harper: {
      name: Chunk151589.default.vIrxZS,
    ...
    villain: {
      name: Chunk151589.default.kHmvdt,
    ...
    solara: {
      name: Chunk151589.default.ndNi1j,
    ...
    cave: {
      name: Chunk151589.default.Xypb3z,
    ...
    deepfried: {
      name: Chunk151589.default.qRFFLK,
...
W["robot-synthetic"] = K(W.robot, {
  name: Chunk151589.default["Ur/62B"]
}), W["chords-2part"] = K(W.tunes, {
  name: Chunk151589.default.TYbrfK
}), W["chords-choir"] = K(W.tunes, {
  name: Chunk151589.default.OnZ6g9
}), W["chords-dev"] = K(W.tunes, {
  name: Chunk151589.default["2XH8tr"]
}), W["robot-dev"] = K(W.robot, {
  name: Chunk151589.default.XhhSOi
}), W["ghost-dev"] = K(W.ghost, {
  name: Chunk151589.default.KmHwvD
}), W["wobble-dev"] = K(W.ghost, {
  name: Chunk151589.default["6PDpse"]
}), W["fan-dev"] = K(W.robot, {
  name: Chunk151589.default["87aX+2"]
}), W["autotune-dev"] = K(W.tunes, {
  name: Chunk151589.default.EYDrRx
})