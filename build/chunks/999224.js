...
let W = {
    skye: {
      name: Chunk949812.default.tzvUK3,
    ...
    quinn: {
      name: Chunk949812.default["biQVN/"],
    ...
    axel: {
      name: Chunk949812.default.VCZdns,
    ...
    sebastien: {
      name: Chunk949812.default["NmbfH+"],
    ...
    megaphone: {
      name: Chunk949812.default.fPU01d,
    ...
    robot: {
      name: Chunk949812.default.anBE8T,
    ...
    tunes: {
      name: Chunk949812.default.sem63B,
    ...
    ghost: {
      name: Chunk949812.default["lFIyM/"],
    ...
    space_bunny: {
      name: Chunk949812.default["KN+v77"],
    ...
    justus: {
      name: Chunk949812.default.ZVrsKC,
    ...
    harper: {
      name: Chunk949812.default.vIrxZS,
    ...
    villain: {
      name: Chunk949812.default.kHmvdt,
    ...
    solara: {
      name: Chunk949812.default.ndNi1j,
    ...
    cave: {
      name: Chunk949812.default.Xypb3z,
    ...
    deepfried: {
      name: Chunk949812.default.qRFFLK,
...
W["robot-synthetic"] = K(W.robot, {
  name: Chunk949812.default["Ur/62B"]
}), W["chords-2part"] = K(W.tunes, {
  name: Chunk949812.default.TYbrfK
}), W["chords-choir"] = K(W.tunes, {
  name: Chunk949812.default.OnZ6g9
}), W["chords-dev"] = K(W.tunes, {
  name: Chunk949812.default["2XH8tr"]
}), W["robot-dev"] = K(W.robot, {
  name: Chunk949812.default.XhhSOi
}), W["ghost-dev"] = K(W.ghost, {
  name: Chunk949812.default.KmHwvD
}), W["wobble-dev"] = K(W.ghost, {
  name: Chunk949812.default["6PDpse"]
}), W["fan-dev"] = K(W.robot, {
  name: Chunk949812.default["87aX+2"]
}), W["autotune-dev"] = K(W.tunes, {
  name: Chunk949812.default.EYDrRx
})