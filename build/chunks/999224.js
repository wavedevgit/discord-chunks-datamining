...
let W = {
    skye: {
      name: Chunk148261.default.tzvUK3,
    ...
    quinn: {
      name: Chunk148261.default["biQVN/"],
    ...
    axel: {
      name: Chunk148261.default.VCZdns,
    ...
    sebastien: {
      name: Chunk148261.default["NmbfH+"],
    ...
    megaphone: {
      name: Chunk148261.default.fPU01d,
    ...
    robot: {
      name: Chunk148261.default.anBE8T,
    ...
    tunes: {
      name: Chunk148261.default.sem63B,
    ...
    ghost: {
      name: Chunk148261.default["lFIyM/"],
    ...
    space_bunny: {
      name: Chunk148261.default["KN+v77"],
    ...
    justus: {
      name: Chunk148261.default.ZVrsKC,
    ...
    harper: {
      name: Chunk148261.default.vIrxZS,
    ...
    villain: {
      name: Chunk148261.default.kHmvdt,
    ...
    solara: {
      name: Chunk148261.default.ndNi1j,
    ...
    cave: {
      name: Chunk148261.default.Xypb3z,
    ...
    deepfried: {
      name: Chunk148261.default.qRFFLK,
...
W["robot-synthetic"] = K(W.robot, {
  name: Chunk148261.default["Ur/62B"]
}), W["chords-2part"] = K(W.tunes, {
  name: Chunk148261.default.TYbrfK
}), W["chords-choir"] = K(W.tunes, {
  name: Chunk148261.default.OnZ6g9
}), W["chords-dev"] = K(W.tunes, {
  name: Chunk148261.default["2XH8tr"]
}), W["robot-dev"] = K(W.robot, {
  name: Chunk148261.default.XhhSOi
}), W["ghost-dev"] = K(W.ghost, {
  name: Chunk148261.default.KmHwvD
}), W["wobble-dev"] = K(W.ghost, {
  name: Chunk148261.default["6PDpse"]
}), W["fan-dev"] = K(W.robot, {
  name: Chunk148261.default["87aX+2"]
}), W["autotune-dev"] = K(W.tunes, {
  name: Chunk148261.default.EYDrRx
})