...
let W = {
    skye: {
      name: Chunk441017.default.tzvUK3,
    ...
    quinn: {
      name: Chunk441017.default["biQVN/"],
    ...
    axel: {
      name: Chunk441017.default.VCZdns,
    ...
    sebastien: {
      name: Chunk441017.default["NmbfH+"],
    ...
    megaphone: {
      name: Chunk441017.default.fPU01d,
    ...
    robot: {
      name: Chunk441017.default.anBE8T,
    ...
    tunes: {
      name: Chunk441017.default.sem63B,
    ...
    ghost: {
      name: Chunk441017.default["lFIyM/"],
    ...
    space_bunny: {
      name: Chunk441017.default["KN+v77"],
    ...
    justus: {
      name: Chunk441017.default.ZVrsKC,
    ...
    harper: {
      name: Chunk441017.default.vIrxZS,
    ...
    villain: {
      name: Chunk441017.default.kHmvdt,
    ...
    solara: {
      name: Chunk441017.default.ndNi1j,
    ...
    cave: {
      name: Chunk441017.default.Xypb3z,
    ...
    deepfried: {
      name: Chunk441017.default.qRFFLK,
...
W["robot-synthetic"] = K(W.robot, {
  name: Chunk441017.default["Ur/62B"]
}), W["chords-2part"] = K(W.tunes, {
  name: Chunk441017.default.TYbrfK
}), W["chords-choir"] = K(W.tunes, {
  name: Chunk441017.default.OnZ6g9
}), W["chords-dev"] = K(W.tunes, {
  name: Chunk441017.default["2XH8tr"]
}), W["robot-dev"] = K(W.robot, {
  name: Chunk441017.default.XhhSOi
}), W["ghost-dev"] = K(W.ghost, {
  name: Chunk441017.default.KmHwvD
}), W["wobble-dev"] = K(W.ghost, {
  name: Chunk441017.default["6PDpse"]
}), W["fan-dev"] = K(W.robot, {
  name: Chunk441017.default["87aX+2"]
}), W["autotune-dev"] = K(W.tunes, {
  name: Chunk441017.default.EYDrRx
})