...
let W = {
    skye: {
      name: Chunk698337.default.tzvUK3,
    ...
    quinn: {
      name: Chunk698337.default["biQVN/"],
    ...
    axel: {
      name: Chunk698337.default.VCZdns,
    ...
    sebastien: {
      name: Chunk698337.default["NmbfH+"],
    ...
    megaphone: {
      name: Chunk698337.default.fPU01d,
    ...
    robot: {
      name: Chunk698337.default.anBE8T,
    ...
    tunes: {
      name: Chunk698337.default.sem63B,
    ...
    ghost: {
      name: Chunk698337.default["lFIyM/"],
    ...
    space_bunny: {
      name: Chunk698337.default["KN+v77"],
    ...
    justus: {
      name: Chunk698337.default.ZVrsKC,
    ...
    harper: {
      name: Chunk698337.default.vIrxZS,
    ...
    villain: {
      name: Chunk698337.default.kHmvdt,
    ...
    solara: {
      name: Chunk698337.default.ndNi1j,
    ...
    cave: {
      name: Chunk698337.default.Xypb3z,
    ...
    deepfried: {
      name: Chunk698337.default.qRFFLK,
...
W["robot-synthetic"] = K(W.robot, {
  name: Chunk698337.default["Ur/62B"]
}), W["chords-2part"] = K(W.tunes, {
  name: Chunk698337.default.TYbrfK
}), W["chords-choir"] = K(W.tunes, {
  name: Chunk698337.default.OnZ6g9
}), W["chords-dev"] = K(W.tunes, {
  name: Chunk698337.default["2XH8tr"]
}), W["robot-dev"] = K(W.robot, {
  name: Chunk698337.default.XhhSOi
}), W["ghost-dev"] = K(W.ghost, {
  name: Chunk698337.default.KmHwvD
}), W["wobble-dev"] = K(W.ghost, {
  name: Chunk698337.default["6PDpse"]
}), W["fan-dev"] = K(W.robot, {
  name: Chunk698337.default["87aX+2"]
}), W["autotune-dev"] = K(W.tunes, {
  name: Chunk698337.default.EYDrRx
})