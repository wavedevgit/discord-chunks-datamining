...
let W = {
    skye: {
      name: Chunk799775.default.tzvUK3,
    ...
    quinn: {
      name: Chunk799775.default["biQVN/"],
    ...
    axel: {
      name: Chunk799775.default.VCZdns,
    ...
    sebastien: {
      name: Chunk799775.default["NmbfH+"],
    ...
    megaphone: {
      name: Chunk799775.default.fPU01d,
    ...
    robot: {
      name: Chunk799775.default.anBE8T,
    ...
    tunes: {
      name: Chunk799775.default.sem63B,
    ...
    ghost: {
      name: Chunk799775.default["lFIyM/"],
    ...
    space_bunny: {
      name: Chunk799775.default["KN+v77"],
    ...
    justus: {
      name: Chunk799775.default.ZVrsKC,
    ...
    harper: {
      name: Chunk799775.default.vIrxZS,
    ...
    villain: {
      name: Chunk799775.default.kHmvdt,
    ...
    solara: {
      name: Chunk799775.default.ndNi1j,
    ...
    cave: {
      name: Chunk799775.default.Xypb3z,
    ...
    deepfried: {
      name: Chunk799775.default.qRFFLK,
...
W["robot-synthetic"] = K(W.robot, {
  name: Chunk799775.default["Ur/62B"]
}), W["chords-2part"] = K(W.tunes, {
  name: Chunk799775.default.TYbrfK
}), W["chords-choir"] = K(W.tunes, {
  name: Chunk799775.default.OnZ6g9
}), W["chords-dev"] = K(W.tunes, {
  name: Chunk799775.default["2XH8tr"]
}), W["robot-dev"] = K(W.robot, {
  name: Chunk799775.default.XhhSOi
}), W["ghost-dev"] = K(W.ghost, {
  name: Chunk799775.default.KmHwvD
}), W["wobble-dev"] = K(W.ghost, {
  name: Chunk799775.default["6PDpse"]
}), W["fan-dev"] = K(W.robot, {
  name: Chunk799775.default["87aX+2"]
}), W["autotune-dev"] = K(W.tunes, {
  name: Chunk799775.default.EYDrRx
})