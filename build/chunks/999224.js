...
let W = {
    skye: {
      name: Chunk372329.default.tzvUK3,
    ...
    quinn: {
      name: Chunk372329.default["biQVN/"],
    ...
    axel: {
      name: Chunk372329.default.VCZdns,
    ...
    sebastien: {
      name: Chunk372329.default["NmbfH+"],
    ...
    megaphone: {
      name: Chunk372329.default.fPU01d,
    ...
    robot: {
      name: Chunk372329.default.anBE8T,
    ...
    tunes: {
      name: Chunk372329.default.sem63B,
    ...
    ghost: {
      name: Chunk372329.default["lFIyM/"],
    ...
    space_bunny: {
      name: Chunk372329.default["KN+v77"],
    ...
    justus: {
      name: Chunk372329.default.ZVrsKC,
    ...
    harper: {
      name: Chunk372329.default.vIrxZS,
    ...
    villain: {
      name: Chunk372329.default.kHmvdt,
    ...
    solara: {
      name: Chunk372329.default.ndNi1j,
    ...
    cave: {
      name: Chunk372329.default.Xypb3z,
    ...
    deepfried: {
      name: Chunk372329.default.qRFFLK,
...
W["robot-synthetic"] = K(W.robot, {
  name: Chunk372329.default["Ur/62B"]
}), W["chords-2part"] = K(W.tunes, {
  name: Chunk372329.default.TYbrfK
}), W["chords-choir"] = K(W.tunes, {
  name: Chunk372329.default.OnZ6g9
}), W["chords-dev"] = K(W.tunes, {
  name: Chunk372329.default["2XH8tr"]
}), W["robot-dev"] = K(W.robot, {
  name: Chunk372329.default.XhhSOi
}), W["ghost-dev"] = K(W.ghost, {
  name: Chunk372329.default.KmHwvD
}), W["wobble-dev"] = K(W.ghost, {
  name: Chunk372329.default["6PDpse"]
}), W["fan-dev"] = K(W.robot, {
  name: Chunk372329.default["87aX+2"]
}), W["autotune-dev"] = K(W.tunes, {
  name: Chunk372329.default.EYDrRx
})