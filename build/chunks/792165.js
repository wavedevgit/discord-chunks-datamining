...
function b(e) {
  ...
  let {
    onClose: n,
    markAsDismissed: b
  } = e, y = (0, i.e7)([u.default], () => u.default.getCurrentUser()), x = (t = null == y ? void 0 : y.premiumType) === p.p9.TIER_2 ? v.intl.string(v.t.jqO5Qk) : null == t ? v.intl.string(v.t.f2qjw8) : v.intl.string(v.t.SblICQ), j = _.ZP.canUseCustomCallSounds(y);
  return (0, r.jsxs)(d.Z, {
    isShown: !0,
    type: d.Y.PREMIUM,
