...
function v(e) {
  ...
  let {
    onClose: n,
    markAsDismissed: v
  } = e, y = (0, i.e7)([u.default], () => u.default.getCurrentUser()), x = (t = null == y ? void 0 : y.premiumType) === h.p9.TIER_2 ? _.NW.string(_.t.jqO5Qk) : null == t ? _.NW.string(_.t.f2qjw8) : _.NW.string(_.t.SblICQ), j = p.ZP.canUseCustomCallSounds(y);
  return (0, r.jsxs)(d.Z, {
    isShown: !0,
    type: d.Y.PREMIUM,
