...
function y(e) {
  ...
  let {
    onClose: n,
    markAsDismissed: y
  } = e, j = (0, i.e7)([d.default], () => d.default.getCurrentUser()), C = (t = null == j ? void 0 : j.premiumType) === h.p9.TIER_2 ? b.intl.string(b.t.jqO5Qk) : null == t ? b.intl.string(b.t.f2qjw8) : b.intl.string(b.t.SblICQ), _ = p.ZP.canUseCustomCallSounds(j);
  return (0, r.jsxs)(u.Z, {
    isShown: !0,
    type: u.Y.PREMIUM,
    className: v.upsellOuter,
    backgroundClassName: v.upsellInner,
    children: [null != y ? (0, r.jsx)(o.P3F, {
      className: v.close,
