...
function _(e) {
  ...
  let {
    onClose: n,
    markAsDismissed: _
  } = e, C = (0, i.e7)([d.default], () => d.default.getCurrentUser()), j = (t = null == C ? void 0 : C.premiumType) === h.p9.TIER_2 ? b.intl.string(b.t.jqO5Qk) : null == t ? b.intl.string(b.t.f2qjw8) : b.intl.string(b.t.SblICQ), y = m.ZP.canUseCustomCallSounds(C);
  return (0, r.jsxs)(u.Z, {
    isShown: !0,
    type: u.Y.PREMIUM,
    className: v.upsellOuter,
    backgroundClassName: v.upsellInner,
    children: [null != _ ? (0, r.jsx)(o.P3F, {
      className: v.close,
      ...
      textOptions: {
        textOverride: b.intl.string(b.t.pj0XBA)
      },
