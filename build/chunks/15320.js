...
function E(e) {
  ...
  } = e, j = (0, i.Wu)([f.Z], () => f.Z.getOnboardingResponsesForPrompt(n.id, c.id)), C = 0 === j.length && (null == c ? void 0 : c.required), N = null == c ? void 0 : c.options.filter(e => j.includes(e.id)), E = (0, p.L6)(N), P = (0, p.dX)(N), Z = 0 === j.length, {
    helpText: I,
...
function P(e) {
  ...
  } = e, v = (0, i.Wu)([f.Z], () => f.Z.getOnboardingResponsesForPrompt(n.id, c.id)), j = 0 === v.length && (null == c ? void 0 : c.required), O = null == c ? void 0 : c.options.filter(e => v.includes(e.id)), C = (0, p.L6)(O), N = (0, p.dX)(O), E = 0 === v.length, {
    helpText: P,
