...
function y(e) {
  let {
  ...
  } = e, b = (0, o.Wu)([p.Z], () => p.Z.getOnboardingResponsesForPrompt(n.id, u.id)), O = 0 === b.length && (null == u ? void 0 : u.required), Z = null == u ? void 0 : u.options.filter(e => b.includes(e.id)), y = (0, x.L6)(Z), P = (0, x.dX)(Z), w = 0 === b.length, {
    helpText: D,
    ...
    itemHook: I
  }), R = (0, d.Z)(n.id, 1e3), k = u.options.map(e => E({
    value: e.id
  }, e)), M = u.options.filter(e => b.includes(e.id)).map(e => e.id);
  return (0, r.jsx)("div", {
    className: C.prompt,
            ...
            children: e => {
              ...
              return (0, r.jsx)(i.zx, {
                ...
                children: a ? (0, r.jsxs)(r.Fragment, {
                  children: [N.intl.string(N.t["8SuVoK"]), (0, r.jsx)("span", {
                  ...
                  children: [w ? N.intl.string(N.t["5WxrcX"]) : N.intl.string(N.t.PDTjLC), (0, r.jsx)(m.Z, {
                    className: C.arrow,
...
function P(e) {
  ...
  } = e, _ = (0, o.Wu)([p.Z], () => p.Z.getOnboardingResponsesForPrompt(n.id, u.id)), b = 0 === _.length && (null == u ? void 0 : u.required), E = null == u ? void 0 : u.options.filter(e => _.includes(e.id)), O = (0, x.L6)(E), Z = (0, x.dX)(E), y = 0 === _.length, {
    helpText: P,
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)(s.zJl, {
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: u.options.map(e => (0, r.jsx)(j.Z, {
            guildId: n.id,
            option: e,
            ...
            children: e => {
              ...
              return (0, r.jsx)(i.zx, {
                ...
                children: a ? (0, r.jsxs)(r.Fragment, {
                  ...
                  children: [y ? N.intl.string(N.t["5WxrcX"]) : N.intl.string(N.t.PDTjLC), (0, r.jsx)(m.Z, {
                    className: C.arrow,
                    direction: m.Z.Directions.RIGHT
                  })]
                })
...
function w(e) {
  let {
    ...
    headerId: p,
    disableTracking: x
  } = e, g = (0, o.e7)([u.Z], () => u.Z.getRulesPrompt(t.id));
  l.useEffect(() => {
  ...
  let j = n[i],
    ...
    N = n[0].required;
  l.useEffect(() => {
    x || f.default.track(b.rMx.GUILD_ONBOARDING_STEP_VIEWED, O(E({}, (0, a.hH)(t.id)), {
      step: 0,
      required: N
    }))
  }, [t.id, N, x]);
  let C = e => {
      !x && (f.default.track(b.rMx.GUILD_ONBOARDING_STEP_COMPLETED, O(E({}, (0, a.hH)(t.id)), {
        step: i,
        options_selected: e,
        skipped: 0 === e,
        back: !1,
        in_onboarding: !0,
        is_final_step: !1
      })), i < n.length - 1 && f.default.track(b.rMx.GUILD_ONBOARDING_STEP_VIEWED, O(E({}, (0, a.hH)(t.id)), {
        step: i,
    ...
    I = e => {
      !x && (f.default.track(b.rMx.GUILD_ONBOARDING_STEP_COMPLETED, O(E({}, (0, a.hH)(t.id)), {
        ...
        in_onboarding: !0,
        is_final_step: !1
      })), i > 0 && f.default.track(b.rMx.GUILD_ONBOARDING_STEP_VIEWED, O(E({}, (0, a.hH)(t.id)), {
        step: i - 1,
        required: n[i - 1].required
      }))), m(Math.max(0, i - 1))
    };
