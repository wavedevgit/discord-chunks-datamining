...
function S(e) {
  ...
  } = e, [k, w] = a.useState("0"), B = (0, s.e7)([y.Z], () => N ? y.Z.getGuildId() : null), A = (0, s.e7)([v.default], () => N && null != S ? v.default.getUser(S) : null), T = (0, s.e7)([h.ZP], () => N && null != B && null != S ? h.ZP.getNick(B, S) : null);
  if (null == t || N && null == S || 0 === t.length) return (0, r.jsx)(c.$jN, {
  ...
  let O = t.map((e, t) => (0, r.jsx)(c.njP.Item, {
    ...
    H = I && "video" === V.type && null != i && null != S && null != R && (0, r.jsx)(m.Z, {
