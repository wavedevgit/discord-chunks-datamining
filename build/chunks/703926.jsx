...
let g = {
  ...
  E = Chunk73800.forwardRef(function(e, t) {
    ...
    return <o.P3F className={s.button} innerRef={t} onClick={() => a(i)} onFocus={l} onBlur={c}><img style={{
          width: "100%",
          height: "100%"
        }} alt={""} src={g[i]} className={n ? s.customGiftBoxHighlighted : s.customGiftBox} /></o.P3F>
  })