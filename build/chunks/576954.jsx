...
function T(e) {
  ...
  return <d.JZ title={b.intl.string(b.t.avyV7O)} description={b.intl.string(b.t.naWE6e)} buttonText={s ? b.intl.string(b.t["3SrzRU"]) : b.intl.string(b.t.avyV7O)} onButtonPress={s ? u : c} />
}
...
function S(e) {
    ...
    P = () => {
      (0, s.ZDy)(async () => {
        ...
        return n => {
          ...
          return <e transitionState={i} onClose={o} channelId={t} warningId={y} senderId={v} description={b.intl.string(b.t.DJMZX1)} safetyTipRows={N.map((e, t) => (0, r.jsx)(u.q, {
              index: t,
              listType: "numbered",
              title: e
            }, t))} actionRows={(0, r.jsxs)(r.Fragment, {
              children: [(0, r.jsx)(T, {
                senderId: v,
                channelId: t,
                warningId: y
  ...
  return <m.Q channelId={t} warningId={y} senderId={v} warningType={p.pj.STRANGER_DANGER} header={b.intl.string(b.t.iOkDpK)} description={b.intl.string(b.t.ISUbcH)} onDismiss={A} buttons={[{
