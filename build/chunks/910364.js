...
function S(e) {
  ...
  } = (0, u.ZP)([...Y, s.Z.USER_PROFILE_MODAL]), q = (0, b.ZB)({
    layout: "MODAL",
    userId: n.id,
    sourceSessionId: D,
    guildId: S,
  ...
  }), z = (0, x.ZP)(n.id, V ? S : void 0), J = h.ZP.getName(null == z ? void 0 : z.guildId, E, n), X = (0, a.e7)([I.Z], () => I.Z.getRelationshipType(n.id)), Q = n.id === t.id, $ = (0, f.p)({
    location: "UserProfileModal"
  }), ee = c.useMemo(() => null != k ? k : (0, _.Z)(), [k]), en = c.useMemo(() => null != S ? {
    [S]: [n.id]
  } : {}, [S, n.id]);
  (0, l.$)(en);
