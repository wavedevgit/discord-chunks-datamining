...
function B(e) {
  let {
  ...
  } = (0, u.ZP)([...J, s.Z.USER_PROFILE_MODAL]), $ = (0, I.ZB)({
    layout: "MODAL",
    userId: n.id,
    sourceSessionId: U,
    guildId: B,
    ...
    location: "UserProfileModal"
  }), el = i.useMemo(() => null != H ? H : (0, p.Z)(), [H]), ed = i.useMemo(() => null != B ? {
    [B]: [n.id]
  } : {}, [B, n.id]);
  (0, d.$)(ed);
          ...
          children: [(0, o.jsxs)(A.Z, {
            ...
            children: [(0, o.jsxs)(P.Z, {
              children: [(0, o.jsx)(w.Z, {
                ...
                user: n,
                guildId: B,
                viewProfileItem: ea && (null == eo ? void 0 : eo.guildId) != null ? (null == et ? void 0 : et.guildId) != null ? (0, o.jsx)(a.sNh, {
