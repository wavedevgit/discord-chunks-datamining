...
function P(e) {
  ...
  } = (0, u.ZP)([...V, s.Z.USER_PROFILE_MODAL]), Y = (0, I.ZB)({
    layout: "MODAL",
    userId: n.id,
    sourceSessionId: M,
    guildId: P,
  ...
  }), H = (0, h.ZP)(n.id, F ? P : void 0), K = (0, a.e7)([m.Z], () => m.Z.getRelationshipType(n.id)), z = n.id === t.id, J = (0, _.p)({
    location: "UserProfileModal"
  }), X = c.useMemo(() => null != R ? R : (0, f.Z)(), [R]), Q = c.useMemo(() => null != P ? {
    [P]: [n.id]
  } : {}, [P, n.id]);
  (0, l.$)(Q);
  let $ = c.useRef(null),
          ...
          children: [(0, o.jsxs)(j.Z, {
            ...
            children: [(0, o.jsx)(v.Z, {
              ...
              children: [(0, o.jsx)(y.Z, {
                ...
                onClose: k,
                className: T.toast
              }), null != W.interactionType && (0, o.jsx)(i.animated.div, {
                style: q,
