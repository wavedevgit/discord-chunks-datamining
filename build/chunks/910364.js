...
function U(e) {
  ...
  }), ei = (0, _.ZP)(n.id, X ? U : void 0), eo = (0, _.ZP)(n.id, U), el = (0, r.e7)([h.Z], () => h.Z.getRelationshipType(n.id)), er = n.id === t.id, es = (0, f.p)({
    location: "UserProfileModal"
  }), ec = o.useMemo(() => null != K ? K : (0, p.Z)(), [K]), ea = o.useMemo(() => null != U ? {
    [U]: [n.id]
  } : {}, [U, n.id]);
  (0, a.$)(ea);
  let ed = o.createRef(),
            ...
            children: [(0, i.jsxs)(T.Z, {
              children: [(0, i.jsx)(E.Z, {
                ...
                viewProfileItem: (null == eo ? void 0 : eo.guildId) == null ? null : (null == ei ? void 0 : ei.guildId) != null ? (0, i.jsx)(s.sNh, {
                  ...
                  subtext: L.intl.formatToPlainString(L.t["mn/nW1"], {
                    displayName: I.ZP.getName(void 0, void 0, n)
                  }),
                  action: () => {
                    z(), (0, v.openUserProfileModal)(B(D({}, ee), {
                      showGuildProfile: !1,
                      friendToken: F,
                      sourceAnalyticsLocations: Q
                    })), (0, b.pQ)(D({
                  ...
                  subtext: L.intl.formatToPlainString(L.t["mn/nW1"], {
                    displayName: I.ZP.getName(U, G, n)
                  }),
                  action: () => {
                    z(), (0, v.openUserProfileModal)(B(D({}, ee), {
                      showGuildProfile: !0,
