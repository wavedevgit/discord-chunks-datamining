...
function B(e) {
  ...
  } = (0, u.ZP)([...$, l.Z.USER_PROFILE_MODAL]), X = (0, I.ZB)({
    layout: "MODAL",
    userId: n.id,
    sourceSessionId: V,
    guildId: B,
  ...
  }), et = (0, h.ZP)(n.id, Q ? B : void 0), eo = (0, h.ZP)(n.id, B), ec = (0, r.e7)([b.Z], () => b.Z.getRelationshipType(n.id)), ei = n.id === t.id, er = (0, f.p)({
    location: "UserProfileModal"
  }), ea = c.useMemo(() => null != H ? H : (0, _.Z)(), [H]), ed = c.useMemo(() => null != B ? {
    [B]: [n.id]
  } : {}, [B, n.id]);
  (0, s.$)(ed);
  let es = c.createRef(),
            ...
            children: [(0, o.jsxs)(Z.Z, {
              children: [(0, o.jsx)(P.Z, {
                ...
                viewProfileItem: (null == eo ? void 0 : eo.guildId) == null ? null : (null == et ? void 0 : et.guildId) != null ? (0, o.jsx)(a.sNh, {
                  ...
                  action: () => {
                    z(), (0, g.openUserProfileModal)(G(R({}, X), {
                      showGuildProfile: !1,
                      friendToken: F,
                      sourceAnalyticsLocations: $
                    })), (0, y.pQ)(R({
                  ...
                  subtext: M.intl.formatToPlainString(M.t["mn/nW1"], {
                    displayName: m.ZP.getName(B, D, n)
                  }),
                  action: () => {
                    z(), (0, g.openUserProfileModal)(G(R({}, X), {
                      showGuildProfile: !0,
