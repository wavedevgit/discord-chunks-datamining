...
function C(e, t, n) {
  i.useEffect(() => {
    if (t) return h.S.dispatch(O.CkL.VOICE_MESSAGE_PLAYBACK_STARTED, {
      src: e
...
let P = i.memo(function(e) {
  let t, {
    ...
    {
      playbackSettingsEnabled: k
    } = (0, E.t)("VoiceMessagePlayer"),
    M = i.useRef(null),
    j = i.useMemo(() => null != x && k ? d.ZP.getPlaybackPosition(x) : 0, [x, k]),
    U = (0, s.e7)([d.ZP], () => k ? d.ZP.getPlaybackRate(d.Ir.VOICE_MESSAGE) : 1),
    [G, B] = i.useState(j > 0),
    [F, V] = i.useState(j),
    [Z, H] = i.useState(O),
    [Y, W] = i.useState(!1),
    ...
    es = i.useCallback(e => {
      null != O && null != x && k && (0, u.U)(x, e, O)
    }, [x, O, k]),
    el = i.useCallback(() => {
      z(!1), null == er.current && (er.current = setTimeout(() => {
    ...
    eu = i.useCallback(e => {
      let t = M.current;
      null != t && (V(e), t.currentTime = e, B(!0))
    }, []),
    ed = i.useCallback(() => {
      let e = M.current;
      if (null == e) return;
  ...
  i.useEffect(() => {
    ...
    let e;
    return K && !q && (e = setInterval(() => {
      var e, t;
      es(null != (t = null == (e = M.current) ? void 0 : e.currentTime) ? t : 0)
    }, m.Z.Millis.SECOND)), () => {
