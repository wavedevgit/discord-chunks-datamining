...
async function h() {
  ...
  try {
    let e, t = parseInt((await i.tn.get(u)).text),
    ...
    if (_.verbose("Server revision: ".concat(t, ", Client revision: ").concat(n)), null === n || n !== t) {
      try {
        ...
        _.verbose("Blocked domains list length: ".concat(o.size, " before update")), a.ADDED.forEach(e => {
          ...
          o[e] = !1
        }), e = Object.keys(o).filter(e => o[e]), _.verbose("Delta applied successfully")
      } catch (t) {
      ...
      _.verbose("Blocked domains list length: ".concat(e.length, " after update")), r.Z.time("\uD83D\uDCBE", "Save Blocked Domain List", () => a.Z.dispatch({
