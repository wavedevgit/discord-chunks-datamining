/** Chunk was on web.js **/
/** chunk id: 915287, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  v: () => v
...
function y(e) {
  let {
    ...
    items: u,
    spacerTop: d
  } = e, f = [<div aria-hidden={true} style={{
      height: d
    }} />], _ = [], p = 0;
  if (true === s && null != a && f.push(<i.Fragment>{a()}</i.Fragment>), u.forEach(e => {
      var r;
      switch (e.section !== p && _.length > 0 && (f.push(null != c ? c(p, _) : _), _ = []), p = null != (r = e.section) ? r : 0, e.type) {
        ...
        case "footer":
          ...
          break;
        case "header":
          null != a && true !== s && _.push(a())
      }
    }), _.length > 0) {
    var h;
    f.push(null != (h = null == c ? true : c(p, _)) ? h : _)
  }
  return l()(f)
}
