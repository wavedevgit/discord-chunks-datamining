...
function j(t) {
  let {
    ...
    onClose: j,
    analyticsData: v
  } = t, N = (0, l.e7)([o.Z], () => o.Z.getGuild(e), [e]), m = !!(null == N ? void 0 : N.features.has(g.oNc.INVITES_DISABLED)), [S] = i.useState(!1), [E, C] = i.useState(O.Fl), T = (0, l.e7)([b.Z], () => b.Z.getGuildIncident(e)), I = (0, u.BT)(N), D = (0, p.SG)(T) || m, A = (0, p.sN)(T), [w, P] = i.useState(D), [R, k] = i.useState(A), [M, G] = i.useState(!1), L = w !== D || R !== A || M, Z = m && !I;
  ...
  return (0, r.jsx)(s.Modal, {
    ...
    actions: [{
      ...
      onClick: () => {
        (D || A) && !w && !R ? ((0, d.n)(N.id, !1, !1), (0, a.ZDy)(() => Promise.resolve(t => (0, r.jsx)(f.Z, x(y({}, t), {
          guildId: e
        }))))) : (0, d.n)(N.id, w, R, E);
        let {
          source: t,
