...
let N = i.memo(function(e) {
  let {
    ...
    className: D,
    wrapperClassName: L
  } = e, [x, k] = i.useState(!1), j = n || x || R === g._1z.FOCUSED, M = (0, l.e7)([h.ZP], () => h.ZP.isInputLocked((0, f.getPID)()));
  i.useEffect(() => {
    null == a || a()
  }, [a]);
...
function R(e) {
  let {
    ...
    null == h || h(e, c)
  }, [h, c]), R = i.useCallback((e, t) => null == g ? void 0 : g(e, c, t), [g, c]), {
    props: {
