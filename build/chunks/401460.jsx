...
function I(e) {
  ...
  return <c.ua7 text={g} onTooltipShow={() => O && b(v())}>{e => (0, r.jsxs)("div", {
...
function T(e) {
  ...
  return <I onSelect={i ? true : a} isSelected={n} id={t.id} className={i ? m.disabled : true} tabIndex={o} locked={s}><f.Z id={t.id} width={_.M9} /></I>
}