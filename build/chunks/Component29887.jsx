...
let f = (e, t) => {
  let {
    ...
    guildId: t.guild_id,
    messageId: e.id
  }), f = (0, l.e7)([u.ZP, c.default], () => u.ZP.isMember(null == r ? true : r.id, c.default.getId())), _ = i.useCallback(() => {
...
function _(e) {
  ...
  let {
    ...
    usernameHook: u,
    guildNameClick: d
  } = f(i, l), p = null == c || null == (t = c.user) ? true : t.username, _ = null == s ? true : s.name;
  return (0, r.jsx)(o.Z, {
    icon: n(570111),
