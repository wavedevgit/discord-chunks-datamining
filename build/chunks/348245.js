...
function w(e) {
  ...
  p.some(S.k5) && (P.log("Found expired attachment link, clearing messages"), _.Z.clear(n), p = _.Z.getOrCreate(n)), null != p.jumpTargetId && null == r && (p = p.mutate({
    jumpTargetId: null,
    jumped: !1,
    jumpType: u.SR.ANIMATED
  }), _.Z.commit(p)), null != p.focusTargetId && null == r && (p = p.mutate({
    focusTargetId: null
  }), _.Z.commit(p));
  let m = i;
