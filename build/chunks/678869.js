...
let T = (e, t, n) => {
  let {
    artist: r,
    media: a
  } = e, l = w.t["6iNxrq"], i = g.ZP.getName(t.guild_id, t.id, n);
...
function _(e) {
  ...
  let q = U,
    J = [];
  W.media.provider === l.p.SPOTIFY && (g = () => {
    (0, c.aG)(L)
  }, C = () => {
    (0, c.Z5)(L, B.id)
  }, n = () => {
  ...
  let X = (0, r.jsx)(b.wG, {
    ...
    channel: Z,
    entry: _,
    headerIcons: W.media.provider === l.p.SPOTIFY ? (0, r.jsx)(N.Z, {
      onClick: n,
