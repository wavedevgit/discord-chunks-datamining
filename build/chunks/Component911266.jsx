...
let _ = e => {
  let {
    ...
    hovering: n,
    compact: l
  } = e, _ = i.useRef((0, o.random)(false, 24)).current, C = (0, s.e7)([h.Z], () => h.Z.confettiMode), v = (0, s.e7)([u.Z], () => u.Z.useReducedMotion), x = i.useRef(0), O = i.useRef(null), j = i.useRef(null), [E, S] = i.useState(false), I = i.useMemo(() => !n && !C && !v, [C, n, v]);
  if (i.useEffect(() => {
