...
function eI(e) {
  ...
  } = (0, v.ZP)(), h = (0, _.bp)(), f = (0, u.Wu)([ee.Z], () => ee.Z.getAllActiveStreams()), m = f.find(e => e.ownerId === n.id), g = i.useRef(null), b = i.useRef(null), x = t.getGuildId(), C = i.useCallback(() => {
    if (null == l || l(), !a) return (0, em.Z)();
    (0, eg.Z)(x, t.id, e_.ZY5.GUILD_CHANNEL)
  }, [x, t.id, a, l]), y = (0, U.B4)(), [j, O] = i.useState(!1), E = () => {
...
let eS = i.memo(function(e) {
  let {
    ...
    reducedMotion: d
  } = i.useContext(p.Sfi), [h, f] = i.useState(!1), b = null == s ? void 0 : s.id, _ = (0, u.e7)([ee.Z], () => null != b ? ee.Z.getActiveStreamForStreamKey(b) : null, [b]), x = (null == s ? void 0 : s.type) === ex.fO.STREAM && null != _ && _.ownerId !== (null == t ? void 0 : t.id), C = (0, u.Wu)([ee.Z], () => ee.Z.getAllActiveStreamsForChannel(l.id).filter(e => {
    let {
      ownerId: n
    } = e;
    return n !== (null == t ? void 0 : t.id)
  })), y = (0, k.qY)(l.id), O = i.useRef(null), E = i.useCallback(() => (null == s ? void 0 : s.type) === ex.fO.ACTIVITY && s.applicationId === (null == a ? void 0 : a.applicationId) ? "ACTIVITY" : x ? "STREAM" : null != y ? "EVENT" : "CALL", [s, null == a ? void 0 : a.applicationId, x, y]), [I, P] = i.useState(E()), Z = (0, p.q_F)({
    opacity: h ? .2 : 1,
