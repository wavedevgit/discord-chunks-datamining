...
function ej(e) {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(() => {
      if (x && 0 === f.length) return (0, r.jsx)(Z.ZP, {
        ...
        children: e => {
          ...
          if (t === d.z.TRIAL_NUX_STREAM_COACH_MARK) return O(!0), (0, r.jsx)(U.h, {
            buttonRef: g,
            dismissed: !1,
            onDismiss: () => {
...
let eE = i.memo(function(e) {
  let {
    ...
    reducedMotion: d
  } = i.useContext(p.Sfi), [h, f] = i.useState(!1), b = null == s ? void 0 : s.id, _ = (0, u.e7)([$.Z], () => null != b ? $.Z.getActiveStreamForStreamKey(b) : null, [b]), y = (null == s ? void 0 : s.type) === eg.fO.STREAM && null != _ && _.ownerId !== (null == t ? void 0 : t.id), C = (0, u.Wu)([$.Z], () => $.Z.getAllActiveStreamsForChannel(l.id).filter(e => {
    let {
      ownerId: n
    } = e;
    return n !== (null == t ? void 0 : t.id)
  })), x = (0, M.qY)(l.id), O = i.useRef(null), E = i.useCallback(() => (null == s ? void 0 : s.type) === eg.fO.ACTIVITY && s.applicationId === (null == a ? void 0 : a.applicationId) ? "ACTIVITY" : y ? "STREAM" : null != x ? "EVENT" : "CALL", [s, null == a ? void 0 : a.applicationId, y, x]), [S, P] = i.useState(E()), Z = (0, p.q_F)({
    opacity: h ? .2 : 1,
...
let eP = function(e) {
  ...
  let {
    ...
    exitFullScreen: c,
    idleProps: d
  } = e, h = i.useRef(null), [m, g] = i.useState(void 0), _ = (0, u.e7)([er.default], () => {
