...
function eC(e) {
  ...
  }, [b, t.id, a, o]), O = (0, U.B4)(), [I, T] = i.useState(!1), S = () => {
...
let eP = i.memo(function(e) {
  let {
    ...
    reducedMotion: d
  } = i.useContext(f.Sfi), [_, p] = i.useState(!1), g = null == l ? void 0 : l.id, E = (0, u.e7)([$.Z], () => null != g ? $.Z.getActiveStreamForStreamKey(g) : null, [g]), b = (null == l ? void 0 : l.type) === em.fO.STREAM && null != E && E.ownerId !== (null == t ? void 0 : t.id), y = (0, u.Wu)([$.Z], () => $.Z.getAllActiveStreamsForChannel(o.id).filter(e => {
    let {
      ownerId: n
    } = e;
    return n !== (null == t ? void 0 : t.id)
  })), O = (0, M.qY)(o.id), T = i.useRef(null), S = i.useCallback(() => (null == l ? void 0 : l.type) === em.fO.ACTIVITY && l.applicationId === (null == a ? void 0 : a.applicationId) ? "ACTIVITY" : b ? "STREAM" : null != O ? "EVENT" : "CALL", [l, null == a ? void 0 : a.applicationId, b, O]), [A, C] = i.useState(S()), R = (0, f.q_F)({
    opacity: _ ? .2 : 1,
