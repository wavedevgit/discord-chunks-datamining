...
function eC(e) {
  let {
  ...
  } = (0, v.ZP)(), _ = (0, E.bp)(), p = (0, u.Wu)([J.Z], () => J.Z.getAllActiveStreams()), h = p.find(e => e.ownerId === n.id), m = i.useRef(null), g = i.useRef(null), b = t.getGuildId(), y = i.useCallback(() => {
    if (null == a || a(), !o) return (0, ef.Z)();
    (0, e_.Z)(b, t.id, eh.ZY5.GUILD_CHANNEL)
  }, [b, t.id, o, a]), O = (0, U.B4)(), [I, T] = i.useState(!1), S = () => {
    ...
    if (O && 0 === p.length) return (0, r.jsx)(w.ZP, {
      ...
      children: e => {
        ...
        if (t === d.z.TRIAL_NUX_STREAM_COACH_MARK) return T(!0), (0, r.jsx)(G.h, {
          buttonRef: m,
          dismissed: !1,
          onDismiss: () => {
...
let eR = i.memo(function(e) {
  ...
  } = (0, v.ZP)(), l = (0, u.e7)([I.Z], () => I.Z.getSelectedParticipant(a.id)), {
    reducedMotion: d
  } = i.useContext(f.Sfi), [_, p] = i.useState(!1), g = null == l ? void 0 : l.id, E = (0, u.e7)([J.Z], () => null != g ? J.Z.getActiveStreamForStreamKey(g) : null, [g]), b = (null == l ? void 0 : l.type) === em.fO.STREAM && null != E && E.ownerId !== (null == t ? void 0 : t.id), y = (0, u.Wu)([J.Z], () => J.Z.getAllActiveStreamsForChannel(a.id).filter(e => {
    let {
      ownerId: n
    } = e;
    return n !== (null == t ? void 0 : t.id)
  })), O = (0, k.qY)(a.id), T = i.useRef(null), S = i.useCallback(() => (null == l ? void 0 : l.type) === em.fO.ACTIVITY && l.applicationId === (null == o ? void 0 : o.applicationId) ? "ACTIVITY" : b ? "STREAM" : null != O ? "EVENT" : "CALL", [l, null == o ? void 0 : o.applicationId, b, O]), [A, C] = i.useState(S()), w = (0, f.q_F)({
    opacity: _ ? .2 : 1,
...
let eL = function(e) {
  ...
  let {
    ...
    exitFullScreen: c,
    idleProps: d
  } = e, _ = i.useRef(null), [h, m] = i.useState(void 0), E = (0, u.e7)([er.default], () => {
  ...
  })), k = (0, P.Z)(), j = (0, u.e7)([R.Z], () => null != R.Z.getAwaitingRemoteSessionInfo()), U = null != k, G = (0, u.e7)([en.Z], () => {
    var e;
  ...
  } = (0, v.ZP)(O.Z.VOICE_CONTROL_TRAY), W = (0, X.Hu)({
    location: O.Z.VOICE_CONTROL_TRAY,
    autoTrackExposure: !0
  }), q = (0, B.Z)(n), J = i.useRef(null), ee = i.useRef(null), el = W ? e => {
