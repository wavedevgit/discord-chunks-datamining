  ...
  constructor(...e) {
    ...
    super(...e), t = this, e9(this, "isFirstChange", true), e9(this, "editorRef", null), e9(this, "state", tt(te({}, (0, B.eK)(eN.Z.getDraft(this.props.channel.id, eN.d.ChannelMessage))), {
      ...
      return (0, ez.v)({
        ...
        if (null != c && (O.announcementSendOptions = c), null != s && (O.flags = (0, eF.pj)(null != (y = O.flags) ? y : 0, e3.iLy.IS_COMPONENTS_V2)), o) return f.Z.sendMessage(d.id, v, true, O), (0, e_.A6)(d.id), {
          shouldClear: false,
          shouldRefocus: true
        };
...
class to extends Chunk647438.PureComponent {
  ...
  constructor(...e) {
    super(...e), e9(this, "containerDomRef", i.createRef()), e9(this, "refToChannelTextAreaFormComponent", i.createRef()), e9(this, "inputFormRef", i.createRef()), e9(this, "state", {
      ...
      return t.type === e3.d4z.DM && n ? (0, r.jsx)(ey.Z, {}) : t.isModeratorReportChannel() && t.isArchivedThread() ? (0, r.jsx)(ex.Z, {
        channelId: t.id
