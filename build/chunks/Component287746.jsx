  ...
  constructor(...e) {
    ...
    super(...e), t = this, eY(this, "isFirstChange", true), eY(this, "editorRef", null), eY(this, "state", eJ(eX({}, (0, R.eK)(ex.Z.getDraft(this.props.channel.id, ex.d.ChannelMessage))), {
      ...
      if (null != l) {
        ...
        if (null == e || e === T.bB.CHAT) {
          ...
          let {
            location: t,
            sectionName: n
          } = null != (y = (0, eU._U)(l)) ? y : {}, i = e === T.bB.APPLICATION_LAUNCHER ? j.Z.lastShownEntrypoint() : S._b.TEXT, {
            isAuthorized: r
          } = await (0, w.L)({
            applicationId: l.applicationId,
            channel: p,
      ...
      return (0, eM.v)({
        ...
        if (null != c && (j.announcementSendOptions = c), null != s && (j.flags = (0, d.pj)(null != (y = j.flags) ? y : 0, ez.iLy.IS_COMPONENTS_V2)), o) return m.Z.sendMessage(p.id, E, true, j), (0, ec.A6)(p.id), {
          shouldClear: false,
          shouldRefocus: true
        };
        ...
        } else m.Z.sendMessage(p.id, E, true, j);
...
class e3 extends Chunk473749.PureComponent {
  static getDerivedStateFromProps(e, t) {
    ...
    return n.id !== i ? {
      textAreaFocused: null != n && n.type !== ez.d4z.GUILD_ANNOUNCEMENT && !c.tq && eS.Z.can(ez.Plq.SEND_MESSAGES, n),
              ...
              children: [Chunk516887 && (0, Chunk54381.jsx)(Chunk641861.Z, {
                ...
                children: [(0, Chunk54381.jsx)(Chunk400023.Z, {
                  ...
                  className: a()(Chunk978966.form, {
                    [Chunk978966.formWithLoadedChatInput]: !Chunk456007
                  }),
  ...
  constructor(...e) {
    super(...e), eY(this, "containerDomRef", r.createRef()), eY(this, "refToChannelTextAreaFormComponent", r.createRef()), eY(this, "inputFormRef", r.createRef()), eY(this, "state", {
      ...
      return E._(S._b.TEXT, this.props.chatInputType, {
        applicationId: t
      ...
      return t.type === ez.d4z.DM && n ? (0, i.jsx)(es.Z, {}) : t.isModeratorReportChannel() && t.isArchivedThread() ? (0, i.jsx)(ed.Z, {
        channelId: t.id
      }) : null != l && (0, z.J)(l) && null != r && !eS.Z.can(ez.Plq.ADMINISTRATOR, r) ? (0, i.jsx)(q.T, {
        guild: r,
        disabledUntil: l
      }) : a ? (0, i.jsx)(G.h, {
        guild: r
