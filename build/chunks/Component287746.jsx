/** Chunk was on web.js **/
/** chunk id: 287746, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  Z: () => td
}), require("./388685.js"), require("./35282.js"), require("./781311.js"), require("./997841.js");
var Chunk255367 = require("./255367.js"),
  ...
  Chunk773359 = require("./773359.jsx"),
  Chunk45251 = require("./45251.js"),
  Chunk705533 = require("./705533.js"),
...
function tn(e, t) {
  return t = null != t ? t : {}, Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : tt(Object(t)).forEach(function(n) {
...
function ts(e) {
  ...
  return t ? (0, r.jsx)("section", tn(te({}, n), {
    role: "complementary"
  })) : (0, r.jsx)("main", te({}, n))
}
let tl = Chunk73800.forwardRef((e, t) => (0, r.jsx)(tc, tn(te({}, e), {
  ref: t
})));
...
class tc extends Chunk73800.PureComponent {
  ...
  handleRecallLastCommand(e) {
    ...
    if (null != i) {
      ...
      let e = null != o ? {
        ...
        id: o.id,
        icon: o.icon,
        name: null != (s = null == o || null == (a = o.bot) ? true : a.username) ? s : o.name,
        application: o
      } : null;
      w.Po({
        channelId: t.id,
  ...
  render() {
    let {
    ...
    } = this.state, v = module.type === Chunk981631.d4z.GUILD_ANNOUNCEMENT && Chunk410030 ? (0, Chunk255367.jsx)(Chunk190210.Z, {
      textValue: this.state.textValue,
      richValue: this.state.richValue,
      focused: exports,
      className: Chunk100658.channelTextArea,
      channel: module,
    ...
    }) : (0, Chunk255367.jsx)(Chunk893718.ZP, {
      ...
      pendingScheduledMessage: Chunk410575
    });
    return (0, Chunk255367.jsx)(Chunk481060.yRy, {
      ...
      onRequestClose: () => {
        var e;
        null == Chunk857595 || null == (e = Chunk857595.onCancel) || module.call(Chunk857595), this.setState({
          contentWarningProps: null
        })
      },
      shouldShow: null != Chunk857595,
      renderPopout: e => {
        let {
          closePopout: t
        } = e;
        return l()(null != O, "ChannelTextAreaForm > Popout > renderPopout: contentWarningProps cannot be null"), (0, r.jsx)(b.Z, te({
          onClose: t
        }, O))
      },
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, e9(this, "isFirstChange", true), e9(this, "editorRef", null), e9(this, "state", tn(te({}, (0, B.eK)(ew.Z.getDraft(this.props.channel.id, ew.d.ChannelMessage))), {
      contentWarningProps: null
      ...
      let {
        ...
        onKeyDown: n,
        channel: r
      } = this.props, i = e.shiftKey || e.altKey || e.ctrlKey || e.metaKey, o = 0 !== this.state.textValue.length;
      switch (e.which) {
        case e5.yXg.DELETE:
        ...
        case e5.yXg.ARROW_UP:
          ...
          if (e.preventDefault(), t) ej.Z.getUploadCount(r.id, ew.d.ChannelMessage) > 0 ? eF.S.dispatchToLastSubscribed(e5.CkL.FOCUS_ATTACHMENT_AREA) : eF.S.dispatchToLastSubscribed(e5.CkL.FOCUS_MESSAGES, {
            ...
            let {
              channel: e
            } = this.props, t = ex.Z.getLastChatCommandMessage(e.id), n = ex.Z.getLastEditableMessage(e.id);
      ...
      let r = this.props.channel.id,
        ...
        a = (null != (n = null == o ? true : o.value) ? n : 0) + 1;
      (0, e_.SE)({
        channelId: r,
        userId: i,
      ...
      this.isFirstChange = false, a && this.state.textValue.length < t.length && this.handleIncrementCombo(), a ? h.Z.startTyping(i) : "" === t && h.Z.stopTyping(i), o && r && (0, O.rf)(), this.setState({
        textValue: t,
        richValue: n
      })
      ...
      if (null != o) {
        if (o.inputType === M.iw.BUILT_IN_INTEGRATION) return eF.S.dispatch(e5.CkL.SHAKE_APP, {
          duration: 200,
          intensity: 2
        }), Promise.resolve({
          shouldClear: false,
        ...
        if (null == e || e === M.bB.CHAT) {
          ...
          let {
            location: t,
            sectionName: n
          } = null != (E = (0, eQ._U)(o)) ? E : {}, r = e === M.bB.APPLICATION_LAUNCHER ? C.Z.lastShownEntrypoint() : R._b.TEXT, {
            isAuthorized: i
          } = await (0, U.L)({
            applicationId: o.applicationId,
            channel: d,
        ...
        if (o.inputType !== M.iw.BUILT_IN_TEXT) return Promise.resolve({
          shouldClear: true,
          shouldRefocus: true
        });
        null != n && (t = null != n.content && "" !== n.content ? n.content : t, g = true === n.tts)
      }
      return (0, eY.v)({
        ...
        if (!b)
          if (y === e5.zYc.SLOWMODE_COOLDOWN) return eF.S.dispatch(e5.CkL.SHAKE_APP, {
            duration: 200,
            intensity: 2
        ...
        if (null != n && n.length > 0) {
          let e = (0, eK.KZ)(n);
          if ((0, eK.Bf)(e, null == u ? true : u.id)) return (0, eW.G)(d, e), {
            shouldClear: false,
            shouldRefocus: false
          };
          I.eagerDispatch = false, I.attachmentsToUpload = n, I.onAttachmentUploadError = (e, r, i) => {
            (0, el.A)({
              file: e,
        ...
        if (null != I.scheduledTimestamp) try {
          ...
          return (0, eT.wW)(e.message), {
            shouldClear: false,
            shouldRefocus: false
          }
        } else p.Z.sendMessage(d.id, v, true, I);
        return this.setState((0, B.H2)()), (0, eb.A6)(d.id), (0, eS.qB)(d.id, h.drafts.type), {
          shouldClear: true,
          shouldRefocus: true
        }
      })
    ...
    }), e9(this, "renderAttachButton", (e, t) => (0, r.jsx)(V.Z, {
      className: t,
...
class tu extends Chunk73800.PureComponent {
  ...
  render() {
    ...
    let Z = (0, Chunk255367.jsx)("div", {
        className: Chunk100658.channelBottomBarArea,
      ...
      F = (0, Chunk255367.jsxs)("div", {
        ...
        children: [(0, Chunk255367.jsx)(Chunk155409.Z, {
          ...
          position: "left",
          offsetX: 75,
          children: (0, Chunk255367.jsx)(tl, {
            ref: this.refToChannelTextAreaFormComponent,
            refInstance: this.containerDomRef,
            focused: Chunk667204,
            highlighted: Chunk104919,
            channel: Chunk73800,
            guild: Chunk120356,
            keyboardModeEnabled: Chunk512722,
            onFocus: this.handleInputFocus,
            onBlur: this.handleInputBlur,
            onKeyDown: this.handleInputKeyDown,
            hasModalOpen: l,
            pendingReply: Chunk873546,
            chatInputType: Chunk442837,
            placeholder: Chunk430742,
            accessibilityLabel: Chunk904245,
            shakeIntensity: Chunk410030,
            ...
            pendingScheduledMessage: Chunk499254,
            announcementComposerEnabled: Chunk581364
          })
      ...
      Y = a()({
        [Chunk672.barWithAppLauncherButton]: Chunk450936,
        [Chunk672.barWithAppsDMsUI]: Chunk993766
      }),
      {
        enabled: W
      ...
      K = Chunk436952.qM.getCurrentConfig({
        location: "ChannelChat"
      }).enabled,
      X = Chunk338390 && null != Chunk541099 && null != Chunk827498 && null != Chunk827498.guild_id;
    return (0, Chunk255367.jsx)(Chunk410575.Z, {
      page: (0, Chunk934415.mE)(this.props.channel),
      children: (0, Chunk255367.jsx)(Chunk549006.sW, {
        children: (0, Chunk255367.jsx)(Chunk146128.BV, {
          children: (0, Chunk255367.jsxs)(Chunk459273.I3, {
            ...
            children: [(0, Chunk255367.jsx)(Chunk459273.d9, {
              ...
              className: a()(Chunk100658.chatContent, {
                [Chunk100658.hasWallpaper]: null == Chunk555573 ? true : Chunk555573.isViewable,
              ...
              "aria-label": Chunk388032.intl.formatToPlainString(require, {
                channelName: Chunk73800.name
              }),
              onMouseDown: this.handleChatInteract,
              onKeyDown: this.handleKeyDown,
              onFocus: this.handleChatInteract,
              style: null != Chunk456007 ? Chunk456007 : {},
              children: [(0, Chunk255367.jsx)(Chunk131565.Z, {
                channel: Chunk73800
              }), Chunk355888 && (0, Chunk255367.jsx)(Chunk641861.Z, {
                recipientUser: Chunk541099,
                voiceChannel: Chunk827498
              }), (0, Chunk255367.jsx)(Chunk25007.Z, {
                channel: Chunk73800,
                guild: Chunk120356,
                narrow: Chunk752305
              }), (0, Chunk255367.jsxs)(Chunk481060.y5t, {
                component: (0, Chunk255367.jsx)(Chunk481060.nn4, {
                ...
                children: [(0, Chunk255367.jsx)(Chunk400023.Z, {
                  channel: Chunk73800,
                  forceCozy: Chunk607070,
                  filterAfterTimestamp: Chunk166459,
                  showingQuarantineBanner: Chunk144144,
                  jumpBarClassName: Chunk436660,
                  typingGradient: Chunk10718,
                  isChatInputBottomAligned: Chunk998698
                }), Chunk607070 ? null : null != (t = this.renderMessageBanner({
                  channel: Chunk73800,
                  showQuarantinedUserBanner: Chunk144144,
                  guild: Chunk120356,
                  communicationDisabledUntil: Chunk744061,
                  showAutomodUserProfileChatBlocker: Chunk367907
                })) ? exports : (0, Chunk255367.jsxs)("form", {
                  ref: this.inputFormRef,
                  onSubmit: to,
                  className: a()(Chunk100658.form, {
                    [Chunk100658.formWithLoadedChatInput]: !Chunk974251
                  }),
                  children: [Chunk857595 && (0, Chunk255367.jsx)(Chunk217871.Z, {
                    channelId: Chunk73800.id
                  }), Chunk73800.isPrivate() ? (0, Chunk255367.jsx)(Chunk199649.Z, {
                    channel: Chunk73800,
                    children: Chunk893718
                  }) : (0, Chunk255367.jsx)(Chunk1397.Z, {
                    channel: Chunk73800,
                    children: Chunk893718
                  }), (0, Chunk255367.jsx)(Chunk738619.ZP, {
                    channel: Chunk73800,
                    poggermodeEnabled: Chunk857595,
                    isInTextChannel: true
                  })]
                }), (0, Chunk255367.jsx)(Chunk549006.kw, {})]
              })]
            })]
          })
        })
      })
    }, "messages-".concat(Chunk73800.id))
  }
  constructor(...e) {
    super(...e), e9(this, "containerDomRef", i.createRef()), e9(this, "refToChannelTextAreaFormComponent", i.createRef()), e9(this, "inputFormRef", i.createRef()), e9(this, "state", {
      textAreaFocused: false,
      textAreaHighlighted: false,
      currentChannelId: this.props.channel.id
    }), e9(this, "dispatchGroupRef", i.createRef()), e9(this, "appIconAnimateRef", i.createRef()), e9(this, "handleRequestFocus", e => {
      ...
      var t;
      null == (t = this.dispatchGroupRef.current) || t.bumpDispatchPriority(), (null == e ? true : e.highlight) != null ? this.setState({
        textAreaFocused: true,
        textAreaHighlighted: null == e ? true : e.highlight
      }) : this.setState({
        textAreaFocused: true
      })
      ...
      if (t) switch (e.which) {
        ...
        case e5.yXg.ARROW_RIGHT:
          n === G.Ie.NORMAL && eF.S.dispatch(e5.CkL.FOCUS_CHANNEL_TEXT_AREA, {
      ...
      return N.__(R._b.TEXT, this.props.chatInputType, {
        applicationId: t
      })
      ...
      return t.type === e5.d4z.DM && n ? (0, r.jsx)(eE.Z, {}) : t.isModeratorReportChannel() && t.isArchivedThread() ? (0, r.jsx)(eO.Z, {
        channelId: t.id
      }) : null != o && (0, en.J)(o) && null != i && !eM.Z.can(e5.Plq.ADMINISTRATOR, i) ? (0, r.jsx)(ei.T, {
        guild: i,
        disabledUntil: o
      }) : a ? (0, r.jsx)(et.h, {
        guild: i
...
let td = Chunk73800.memo(function(e) {
  let {
    channel: t,
    guild: n,
    chatInputType: o,
    ...
    channel: t
  }), c = (0, eE.S)(eU.default.getCurrentUser(), t), [u] = (0, er.AB)(null == n ? true : n.id), _ = (0, ee.Ux)(null == n ? true : n.id), p = (0, d.e7)([eU.default], () => eU.default.getCurrentUser()), h = (0, d.e7)([eL.ZP], () => {
    var e, t, r;
    return null != p && null != (r = null == (e = eL.ZP.getMember(null != (t = null == n ? true : n.id) ? t : e5.lds, null == p ? true : p.id)) ? true : e.isPending) && r
  }), m = _ && !h, E = (0, d.e7)([ep.Z], () => ep.Z.isEnabled()), b = (0, eg.Z)(t.id), O = (0, eo.Z)(t.id), I = (0, P.R)({
    channel: t,
    chatInputType: o
