...
function e3(e) {
  ...
  return t ? (0, i.jsx)("section", e0(e$({}, n), {
    role: "complementary"
  })) : (0, i.jsx)("main", e$({}, n))
}
let e4 = Chunk473749.forwardRef((e, t) => (0, i.jsx)(e7, e0(e$({}, e), {
  ref: t
})));
...
class e7 extends Chunk473749.PureComponent {
  ...
  render() {
    ...
    return (0, Chunk54381.jsx)(Chunk481060.yRy, {
      ...
      renderPopout: e => {
        ...
        return s()(null != b, "ChannelTextAreaForm > Popout > renderPopout: contentWarningProps cannot be null"), (0, i.jsx)(et.Z, e$({
          onClose: t
        }, b))
      },
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, eQ(this, "isFirstChange", true), eQ(this, "editorRef", null), eQ(this, "state", e0(e$({}, (0, R.eK)(ej.Z.getDraft(this.props.channel.id, ej.d.ChannelMessage))), {
      contentWarningProps: null
      ...
      switch (e.which) {
        ...
        case eK.yXg.ARROW_UP:
          if (r || l) return;
          if (e.preventDefault(), t) eT.Z.getUploadCount(i.id, ej.d.ChannelMessage) > 0 ? eR.S.dispatchToLastSubscribed(eK.CkL.FOCUS_ATTACHMENT_AREA) : eR.S.dispatchToLastSubscribed(eK.CkL.FOCUS_MESSAGES, {
            atEnd: true
          });
          else {
            let {
        ...
        case eK.yXg.ESCAPE:
          ...
          if (eT.Z.getUploadCount(i.id, ej.d.ChannelMessage) > 0) return void b.Z.clearAll(i.id, ej.d.ChannelMessage)
      }
      null == n || n(e, l)
      ...
      return (0, eD.v)({
        ...
        if (!O)
          if (E === eK.zYc.SLOWMODE_COOLDOWN) return eR.S.dispatch(eK.CkL.SHAKE_APP, {
            duration: 200,
            intensity: 2
        ...
        if (null != n && n.length > 0) {
          ...
          _.eagerDispatch = false, _.attachmentsToUpload = n, _.onAttachmentUploadError = (e, i, r) => {
            (0, J.A)({
              file: e,
              ...
              code: i,
              reason: r
            }) && ("" !== t && "" === ej.Z.getDraft(p.id, ej.d.ChannelMessage) && h.Z.saveDraft(p.id, t, ej.d.ChannelMessage), 0 === eT.Z.getUploadCount(p.id, ej.d.ChannelMessage) && b.Z.setUploads({
              channelId: p.id,
              uploads: n,
    ...
    })), eQ(this, "renderApplicationCommandIcon", (e, t, n) => (0, i.jsx)(D.Z, {
      className: n,
      command: e,
      section: t,
      channel: this.props.channel
...
class e8 extends Chunk473749.PureComponent {
  static getDerivedStateFromProps(e, t) {
    ...
    return n.id !== i ? {
      textAreaFocused: null != n && n.type !== eK.d4z.GUILD_ANNOUNCEMENT && !c.tq && eI.Z.can(eK.Plq.SEND_MESSAGES, n),
  ...
  render() {
    ...
    let w = (0, Chunk54381.jsx)("div", {
      ...
      L = Chunk10718 ? Chunk104919 : Chunk752305,
      {
        enabled: D
    ...
    super(...e), eQ(this, "containerDomRef", r.createRef()), eQ(this, "refToChannelTextAreaFormComponent", r.createRef()), eQ(this, "inputFormRef", r.createRef()), eQ(this, "state", {
      ...
      if (t) switch (e.which) {
        case eK.yXg.ARROW_LEFT:
          n === M.Ie.SIDEBAR && eR.S.dispatch(eK.CkL.FOCUS_CHANNEL_TEXT_AREA, {
            channelId: eZ.Z.getChannelId()
          });
          return;
        case eK.yXg.ARROW_RIGHT:
          n === M.Ie.NORMAL && eR.S.dispatch(eK.CkL.FOCUS_CHANNEL_TEXT_AREA, {
...
let e6 = Chunk473749.memo(function(e) {
  let {
    channel: t,
    guild: n,
    chatInputType: r,
    ...
    channel: t
  }), s = (0, es.S)(eN.default.getCurrentUser(), t), [c] = (0, W.AB)(null == n ? true : n.id), u = (0, H.Ux)(null == n ? true : n.id), d = (0, p.e7)([eN.default], () => eN.default.getCurrentUser()), h = (0, p.e7)([e_.ZP], () => {
    var e, t, i;
