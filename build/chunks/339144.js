...
let N = i.memo(function(e) {
  let t, l, d, N, {
    ...
    B = x(k, L, D),
    W = i.useCallback(() => {
      o()(null != L, "Received null activity"), (0, f.v)(G, f.d.INVITE), O.default.track(S.rMx.OPEN_MODAL, {
    ...
    V = i.useCallback((e, t) => () => {
      (0, f.v)(G, f.d.LEAVE_ACTIVITY), h.Z.leaveActivity({
        location: t,
        applicationId: e,
        showFeedback: !0
      })
    ...
    z = (null != R || null == D || (0, u.R)({
      isContextless: D.location.kind === s.E.CONTEXTLESS
    })) && (Z || P) ? (Z ? (t = !1, l = () => {
      H(), (0, f.v)(G, f.d.STREAM, !1)
    }, d = a.g5r, N = j.NW.string(j.t.S5anIS)) : A ? (t = !1, l = () => {
      F(), (0, f.v)(G, f.d.STREAM, !0)
    }, d = a.hGI, N = null != R ? j.NW.formatToPlainString(j.t.AB5gT0, {
      game: R.name
    }) : j.NW.string(j.t.FeUKeH)) : (t = !0, l = null, d = a.hGI, N = null != T && (0, y.vd)(T.type) ? j.NW.string(j.t.uQn9Bw) : null != w ? j.NW.string(j.t.fBXEoK) : j.NW.string(j.t.n3feND)), (0, r.jsx)("div", {
    ...
    Y = B && null == D ? (0, r.jsx)(C.Z, {
      tooltipText: j.NW.string(j.t["hC/Ze3"]),
      onClick: W,
      icon: a.ejJ
    }) : null,
    K = null == D ? null : (0, r.jsx)(C.Z, {
