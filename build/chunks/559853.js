  ...
  var e = [, (e, t, n) => {
      ...
      let r = (() => {
        ...
        return function(t = {}) {
          ...
          ! function() {
            function e(e) {
              if (v = (I = e = e.exports).memory, L(), x = I.__indirect_function_table, k.unshift(I.__wasm_call_ctors), G--, a.monitorRunDependencies && a.monitorRunDependencies(G), 0 == G && (null !== B && (clearInterval(B), B = null), Z)) {
                var t = Z;
                Z = null, t()
              }
              return e
