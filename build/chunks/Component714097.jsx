...
function m() {
  let e = (0, Chunk442837.e7)([Chunk210887.Z], () => Chunk210887.Z.theme),
    ...
    n = [{
      ...
      tooltip: Chunk388032.intl.string(Chunk202283.default["Dk+OWY"]),
      tooltipAriaLabel: Chunk388032.intl.string(Chunk202283.default["Dk+OWY"])
    }, {
      name: "",
      value: Chunk231338.BR.LIGHT,
      icon: Chunk657707.chG,
      className: _(exports, Chunk231338.BR.LIGHT),
      tooltip: Chunk388032.intl.string(Chunk202283.default["5vlJkY"]),
      tooltipAriaLabel: Chunk388032.intl.string(Chunk202283.default["5vlJkY"])
    }];
