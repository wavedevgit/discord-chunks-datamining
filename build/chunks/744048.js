...
let b = function() {
  ...
  let [I, T] = (0, f.US)(v, E.R.SIDEBAR, !0), S = I === a.z.CLIENT_THEMES_COACHMARK, A = I === a.z.CUSTOM_THEME_COACHMARK;
  return e ? null : (0, r.jsxs)(r.Fragment, {
    children: [(y === m.wh.CLIENT_THEMES || S) && (0, r.jsx)(c.Z, {
      markAsDismissed: S ? T : () => {
    ...
    }), y === m.wh.APP_ICON && (0, r.jsx)(o.Z, {
      isCoachmark: !1,
      markAsDismissed: T
    }), (y === m.wh.CUSTOM_THEME || A) && (0, r.jsx)(u.Z, {
      metadata: null != O ? O : {},
      markAsDismissed: T,
      isCoachmark: A
    })]
