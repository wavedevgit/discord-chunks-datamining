...
function y(e) {
  ...
  } = (0, f.KZ)(), O = null == y ? void 0 : y.guildId, C = (0, o.e7)([d.Z], () => null != O ? d.Z.getGuild(O) : null), E = (0, o.e7)([u.Z], () => u.Z.getGuildId()), P = (0, s.Y)({
    userId: n.id
  }), S = (0, o.e7)([c.default], () => c.default.locale), M = (0, p.Z)(n.id), L = (0, m.Z)(n.id);
