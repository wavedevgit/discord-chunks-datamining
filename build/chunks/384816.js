...
function P(e) {
  let {
    ...
    userId: n.id
  }), w = (0, r.e7)([f.Z], () => f.Z.hidePersonalInformation), R = (0, r.e7)([c.default], () => c.default.locale), M = (0, v.Z)(n.id), L = (0, h.Z)(n.id);
  return (0, l.jsxs)(i.zJl, {
    ...
    }), L.length > 0 && (0, l.jsx)(x.Z, {
      heading: y.intl.string(y.t.PHjkRE),
      children: L.map(e => (0, l.jsx)(j.tH, {
