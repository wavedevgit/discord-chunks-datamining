...
function P(e) {
  ...
  } = (0, p.KZ)(), N = null == P ? void 0 : P.guildId, C = (0, r.e7)([a.Z], () => null != N ? a.Z.getGuild(N) : null), A = (0, r.e7)([d.Z], () => d.Z.getGuildId()), _ = (0, s.Y)({
    userId: n.id
  }), w = (0, r.e7)([f.Z], () => f.Z.hidePersonalInformation), M = (0, r.e7)([u.default], () => u.default.locale), R = (0, v.Z)(n.id), U = (0, g.Z)(n.id);
  return (0, l.jsxs)(i.zJl, {
    fade: !0,
    className: I.scroller,
    children: [(null == P ? void 0 : P.bio) != null && (null == P ? void 0 : P.bio) !== "" && !w && (0, l.jsx)(h.Z, {
      userBio: P.bio,
      setLineClamp: !1
    }), null != C && (0, l.jsx)(Z.Z, {
      user: n,
