...
function b(e, t, n, o) {
  ...
  return r.useEffect(() => {
    if (null != e) return s.Z.hasLoaded(g.yP.PRELOADED_USER_SETTINGS) || E(e, t, n, o), (0, p.kk)(e, {
      groupName: n,
      guildId: t,
      version: o
    }, c), () => {
...
function y(e, t) {
  let n = (0, i.e7)([s.Z], () => {
    ...
    a = (0, h.ig)(e),
    c = null;
  return s.Z.hasLoaded(g.yP.PRELOADED_USER_SETTINGS) ? c = a.find(e => null == n || !(0, u.jl)(n, e)) : null != n && (c = a.find(e => !(0, u.jl)(n, e))), [b(c, o, t), r.useCallback((e, n) => {
    null != c && (0, _.Q3)(c, {
      dismissAction: e,
      groupName: t,
      guildId: o,
...
function O(e, t, n) {
  ...
  return [b(c, a, n, t), r.useCallback((e, r) => {
    null != c && (0, p.wH)(c, t, {
      dismissAction: e,
      groupName: n,
      guildId: a,
...
function v(e, t, n) {
  let o = (0, i.e7)([s.Z], () => {
    ...
    a = (0, i.e7)([l.Z], () => l.Z.getGuildId()),
    c = null;
  return null != e && (c = S(!(0, h.Bh)(e), o, t) ? e : null), [b(c, a, n), r.useCallback((e, t) => {
    null != c && (0, p.Ow)(c, {
      dismissAction: e,
      groupName: n,
      guildId: a,
...
function I(e, t, n, o) {
  let a = (0, i.e7)([l.Z], () => l.Z.getGuildId()),
    s = null;
  return null == e || (0, p.UJ)(e, n, t) || (s = e), [b(s, a, o), r.useCallback((e, t) => {
    null != s && (0, p.JO)(s, n, {
      dismissAction: e,
      groupName: o,
      guildId: a,
