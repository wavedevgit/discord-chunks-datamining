...
function p(e, t, n) {
  let l = (0, i.e7)([a.Z], () => {
    ...
    p = (0, d.i)(e),
    h = null;
  return a.Z.hasLoaded(f.yP.PRELOADED_USER_SETTINGS) ? h = p.find(e => null == l || !(0, s.jl)(l, e)) : null != l && (h = p.find(e => !(0, s.jl)(l, e))), [_(h, c, t, n), r.useCallback((e, n) => {
    null != h && (0, u.EW)(h, {
      dismissAction: e,
      groupName: t,
      guildId: c,
...
function g(e, t, n, a, s) {
  let l = (0, i.e7)([o.Z], () => o.Z.getGuildId()),
    c = null;
  return null == e || (0, u.UJ)(e, n, t) || (c = e), [_(c, l, a, s), r.useCallback((e, t) => {
    null != c && (0, u.JO)(c, n, {
      dismissAction: e,
      groupName: a,
      guildId: l,
