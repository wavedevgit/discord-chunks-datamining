...
function h(e, t) {
  let n = (0, i.e7)([o.Z], () => {
    ...
    c = (0, _.i)(e),
    u = null;
  return o.Z.hasLoaded(f.yP.PRELOADED_USER_SETTINGS) ? u = c.find(e => null == n || !(0, l.jl)(n, e)) : null != n && (u = c.find(e => !(0, l.jl)(n, e))), [p(u, a, t), r.useCallback((e, n) => {
    null != u && (0, d.EW)(u, {
      dismissAction: e,
      groupName: t,
      guildId: a,
