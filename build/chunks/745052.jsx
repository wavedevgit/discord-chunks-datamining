...
function er() {
  let e = Chunk73800.useRef(null),
    ...
    b = Chunk73800.useCallback(e => {
      ...
      return <W.Z index={o} className={a()({
          [$.selected]: null != h && h === u,
          [$.siblingSelected]: null != h && h === c
        })} channel={s.channel} user={s.user} hasSingleMessageRequest={l} />
    }, [Chunk120356, require, Chunk230711]),
    O = Chunk73800.useCallback(() => <Chunk82295.Z className={Chunk596576.sectionTitle}>{exports > 0 ? Chunk388032.intl.formatToPlainString(Chunk388032.t.rA4iWV, {
        count: exports
      }) : Chunk388032.intl.string(Chunk388032.t.flPU6u)}{Chunk442837 && exports > 0 ? <Chunk255367.Fragment>{<Chunk481060.Text className={Chunk596576.titleDivider} variant={"eyebrow"} color={"header-secondary"} tag={"span"}>{"•"}</Chunk481060.Text>}{<Chunk481060.Avr onClick={Chunk112724} textVariant={"text-sm/normal"} text={Chunk388032.intl.string(Chunk388032.t.p6t7RE)} aria-label={Chunk388032.intl.string(Chunk388032.t.p6t7RE)} />}</Chunk255367.Fragment> : null}</Chunk82295.Z>, [exports, Chunk112724, Chunk442837]);
  return (require.length !== exports && Chunk797614.Z.increment({
    name: Chunk286379.V.MESSAGE_REQUEST_COUNT_DRIFT
  }), 0 === require.length) ? <Chunk307947.Z section={Chunk687683.pS.REQUESTS} /> : <Chunk91192.bG navigator={Chunk150063}><Chunk91192.SJ>{t => {
        var {
          ref: i,
          role: l
        } = t, a = function(e, t) {
...
function ei(e) {
  ...
  let a = t - q.R7I;
  return <O.Z sidebarType={O.y.MessageRequestSidebar} maxWidth={a} onWidthChange={n}><E.Z channel={l} baseChannelId={Z.uZ} /></O.Z>
}
let el = e => {
  let t = (0, M.Z)();
  return (i.useEffect(() => {
    (0, I.kk)(u.z.MESSAGE_REQUEST_SETTINGS_COACH_MARK)
  }, []), null == e.targetElementRef.current || L.Z.hasLayers() || (0, p.$sL)()) ? e.children : <C.ZP contentTypes={[u.z.MESSAGE_REQUEST_SETTINGS_COACH_MARK]}>{n => {
      let {
        visibleContent: i,
        markAsDismissed: l
      } = n, a = {
...
let eo = (0, Chunk112724.Z)(function(e) {
  ...
  return (0, v.Tt)({
    location: J.intl.string(J.t.e7GWjY)
  }), <r.Fragment>{<div className={a()(ee.chat, $.container, {
        [ee.threadSidebarOpen]: m,
        [ee.threadSidebarFloating]: m && u
      })}>{<p.f6W theme={l}>{e => (0, r.jsxs)(S.Z, {
          className: e,
          toolbar: true,
        ...
        })}</p.f6W>}{<div className={ee.content}><ea section={y} /></div>}</div>}{m && <ei pageWidth={t} onSidebarResize={(e, t) => {
        d(t)
      }} />}</r.Fragment>
})