...
let E = e => {
  ...
  y = e => {
    var {
      ...
      color: T
    } = e, A = m(e, ["textOptions", "subscriptionTier", "hasActivePromotion", "isPersistentCTA", "useShorterCTA", "showGradient", "confirmationFooter", "paymentModalBanner", "buttonShineClassName", "color"]);
    let N = (0, o.ZP)(),
      C = (0, c.N)(),
      ...
      x = p ? f.intl.string(f.t.J61px8) : null != w ? b(n, y, g, w.discount.amount) : E({
        showTrialCTA: D,
        subscriptionTier: n,
        trialDurationCopy: R,
        isPersistentCTA: g,
