...
function f(e) {
  return (0, r.G)(d, {
    canDrop(e) {
      ...
      let {
        channel: r
      } = e, i = r.getGuildId(), o = null != (n = null == (t = a.Z.getGuild(i)) ? void 0 : t.maxVideoChannelUsers) ? n : -1, d = c.ZP.countVoiceStatesForChannel(r.id), f = null != i && l.Z.hasVideo(r.id) && o > 0 && d >= o + 1;
