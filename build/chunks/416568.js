...
function eu(e) {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(Y.u, {}), l ? (0, r.jsx)(S.Z, {}) : null, (0, r.jsx)(K.Z, {
...
function eh(e) {
  let {
    ...
    let e = D.ZP.getGuildsTree();
    return [e, e.version]
  }), p = (0, h.e7)([E.Z], () => E.Z.lurkingGuildIds()), b = i.useMemo(() => n ? [] : p, [p, n]), _ = (0, h.e7)([C.Z], () => C.Z.isFullscreenInContext()), [x, S] = i.useState(!1), P = i.useCallback(() => S(!0), []), A = i.useCallback(() => S(!1), []), R = i.useRef(!1), [k] = i.useState(() => new f.V7), F = i.useRef(null), H = i.useRef(null), z = (0, u.OP)(), {
    ref: Y
  ...
  let eC = i.useRef(null),
    ...
    ew = (0, r.jsx)(W.Z, {
      ...
      onClick: eP ? eE : void 0
    }),
    eN = eP ? (0, r.jsx)(N.fO, eo(el({
      targetElementRef: eC,
      isGuildBarScrolling: $
    }, eI), {
      children: ew
