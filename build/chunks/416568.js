...
function es(e) {
  let {
    ...
    return i
  }(ev, ["ref"]), e_ = (0, m.mFp)(), [eC, ex] = i.useState(!1), [eP, eN] = i.useState(!1), eS = (0, m.dQu)(g.Z.modules.guildbar.AVATAR_SIZE), eZ = i.useMemo(() => new ea(h, ex, eN, () => {
    var e, t;
