...
function ec(e) {
  let {
    ...
    ref: eO
  } = e_, ej = eo(e_, ["ref"]), eC = (0, m.mFp)(), [ex, eS] = i.useState(!1), [eP, eI] = i.useState(!1), eN = (0, m.dQu)(g.Z.modules.guildbar.AVATAR_SIZE), eZ = i.useMemo(() => new es(h, eS, eI, () => {
    var e, t;
  ...
  let {
    ...
    pathname: eE
  } = (0, c.TH)(), eT = eE.startsWith(et.Z5c.GUILD_DISCOVERY) || eE.startsWith(et.Z5c.GLOBAL_DISCOVERY), eA = eE.startsWith(et.Z5c.GUILD_MEMBER_VERIFICATION_FOR_HUB(""));
  (0, v.Ng)(() => {
  ...
  let eR = i.useCallback(function e(t) {
      switch (t.type) {
        case M.eD.FOLDER:
          return (0, r.jsx)(J.Z, {
            folderNode: t,
