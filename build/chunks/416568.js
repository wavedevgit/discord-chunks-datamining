...
function eu(e) {
  let {
    ...
    return [e, e.version]
  }), b = (0, p.e7)([P.Z], () => P.Z.lurkingGuildIds()), _ = i.useMemo(() => n ? [] : b, [b, n]), ei = (0, p.Wu)([D.Z, A.ZP], () => k.default.keys(D.Z.getGuilds()).filter(e => A.ZP.isCurrentUserGuest(e))), eu = _.concat(ei), ed = (0, p.e7)([j.Z], () => j.Z.isFullscreenInContext()), ep = (0, p.e7)([D.Z], () => D.Z.getGeoRestrictedGuilds()), [eh, ef] = i.useState(!1), eg = i.useCallback(() => ef(!0), []), em = i.useCallback(() => ef(!1), []), eb = i.useRef(!1), [ey] = i.useState(() => new f.V7), e_ = i.useRef(null), ev = i.useRef(null), eO = (0, u.OP)(), {
    ref: ej
  } = eO, ex = ea(eO, ["ref"]), eC = (0, m.mFp)(), [eS, eP] = i.useState(!1), [eI, eN] = i.useState(!1), eZ = (0, m.dQu)(g.Z.modules.guildbar.AVATAR_SIZE), ew = i.useMemo(() => new ec(h, eP, eN, () => {
    var e, t;
        ...
        children: (0, r.jsxs)("ul", eo(el({
          ...
          children: [(0, r.jsx)(B.Z, {
            ...
            children: [(0, r.jsxs)(m.xVE, {
              ...
              }), (0, r.jsx)(K.Z, {}), !n && s ? eQ : null, t ? null : (0, r.jsx)(W.Z, {})]
