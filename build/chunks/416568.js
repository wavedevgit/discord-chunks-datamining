...
function ed(e) {
  let {
    ...
    pathname: o
  } = (0, c.TH)(), s = o.startsWith(et.Z5c.GUILD_MEMBER_VERIFICATION_FOR_HUB("")), a = (0, h.Wu)([D.Z, R.ZP], () => k.default.keys(D.Z.getGuilds()).filter(e => R.ZP.isCurrentUserGuest(e))), u = i.concat(a), {
    entrypoint: d
  } = x.Lk.useExperiment({
    location: "GuildsBar"
  });
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(K.u, {}), d === x.u3.SERVER_RAIL_TOP && (0, r.jsx)(I.Z, {}), l ? (0, r.jsx)(E.Z, {}) : null, (0, r.jsx)(Y.Z, {
      isOnHubVerificationRoute: s
    }), !t && (0, r.jsx)(F.Z, {}), u.map(e => (0, r.jsx)(ee.Z, {
      guildId: e
    }, e)), (0, r.jsx)($.Z, {
      onActivate: n
    })]
...
function eh(e) {
  let {
    ...
    return [e, e.version]
  }), a = s.getRoots(), c = (0, h.Wu)([A.Z], () => A.Z.getGeoRestrictedGuilds()).map(e => (0, r.jsx)(z.Z, {
    id: e.id,
    name: e.name,
    icon: e.icon
  }, e.id));
...
function ep(e) {
  let {
    ...
    let e = L.ZP.getGuildsTree();
    return [e, e.version]
  }), d = (0, h.e7)([S.Z], () => S.Z.lurkingGuildIds()), p = i.useMemo(() => n ? [] : d, [d, n]), b = (0, h.e7)([C.Z], () => C.Z.isFullscreenInContext()), [O, j] = i.useState(!1), E = i.useCallback(() => j(!0), []), A = i.useCallback(() => j(!1), []), R = i.useRef(!1), [D] = i.useState(() => new f.V7), k = i.useRef(null), F = i.useRef(null), V = (0, u.OP)(), {
    ref: H
  } = V, z = es(V, ["ref"]), K = (0, m.mFp)(), [Y, X] = i.useState(!1), $ = (0, m.dQu)(g.Z.modules.guildbar.AVATAR_SIZE), ee = (0, m.dQu)(g.Z.space.SPACE_XS), ei = i.useMemo(() => {
    let e = function(e, t) {
      let n = e + t,
        r = 2 + t;
      return {
