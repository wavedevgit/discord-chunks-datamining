...
function ec(e) {
  ...
  let {
    ...
    pathname: ew
  } = (0, c.TH)(), eT = ew.startsWith(et.Z5c.GUILD_DISCOVERY) || ew.startsWith(et.Z5c.GLOBAL_DISCOVERY), eA = ew.startsWith(et.Z5c.GUILD_MEMBER_VERIFICATION_FOR_HUB(""));
  (0, v.Ng)(() => {
