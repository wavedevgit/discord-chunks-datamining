...
let W = () => {
  ...
  L = e => {
    ...
    let {
    ...
    } = (0, a.ZP)(s.Z.PREMIUM_MARKETING_BENTO_BOX), p = (0, l.Z)({
      ...
      location: "WhatsNewBentoBoxes"
    }).enabled, E = (0, o.rO)(), C = c.Z.getArticleURL(u.BhN.REFERRAL_PROGRAM), S = (t = function(e) {
      ...
      referralProgram: {
        ...
        description: g.NW.format(g.t.jRPQUF, {
          learnMoreLink: C
        }),
        previewImage: I.Z,
