...
function b(e) {
  let {
    code: t,
    message: n
  } = e, [b, E, C] = (0, o.Wu)([f.Z], () => [f.Z.getApplication(t), f.Z.isInvalidApplication(t), f.Z.getApplicationFetchState(t)], [t]), O = (0, o.e7)([d.Z], () => {
    var e;
    return null != (e = d.Z.getGuildId()) ? e : true
  }), [v, y] = i.useState(false), x = i.useCallback(e => {
    e && y(true)
