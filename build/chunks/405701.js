...
function v(e) {
  ...
  i.useEffect(() => {
    ...
    return f.S.subscribe(h.CkL.EMPHASIZE_SLOWMODE_COOLDOWN, e), () => {
...
function I(e) {
  ...
  } = e, i = (0, s.e7)([_.Z], () => _.Z.getSlowmodeCooldownGuess(t.id, n ? _.S.CreateThread : _.S.SendMessage)), a = (0, s.e7)([d.Z], () => n ? d.Z.can(h.Plq.MANAGE_THREADS, t) : d.Z.can(h.Plq.MANAGE_CHANNELS, t) || d.Z.can(h.Plq.MANAGE_MESSAGES, t)), {
    rateLimitPerUser: o
  } = t, l = o > 0;
  return (0, r.jsx)(v, {
    isEnabled: l,
