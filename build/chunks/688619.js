/** Chunk was on web.js **/ ! function(t, n) {
  ...
  }, ek.format.hex = eP, ek.autodetect.push({
    p: 4,
    test: function(e) {
      for (var t = [], n = arguments.length - 1; n-- > 0;) t[n] = arguments[n + 1];
  ...
  }, eJ.format.hsi = ez, eJ.autodetect.push({
    p: 2,
    test: function() {
      for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
  ...
  rQ.normal = rJ(r0(function(e) {
    return e
  })), rQ.multiply = rJ(r0(r1)), rQ.screen = rJ(r0(r5)), rQ.overlay = rJ(r0(r4)), rQ.darken = rJ(r0(r2)), rQ.lighten = rJ(r0(r3)), rQ.dodge = rJ(r0(r8)), rQ.burn = rJ(r0(r6));
  for (var r7 = rQ, r9 = d.type, ie = d.clip_rgb, it = d.TWOPI, ir = Math.pow, ii = Math.sin, ia = Math.cos, io = y, is = function(e, t, n, r, i) {
    ...
    }, iS = E, iA = Math.sqrt, iN = Math.pow, iC = Math.min, iw = Math.max, iR = Math.atan2, iP = Math.abs, iD = Math.cos, iL = Math.sin, ix = Math.exp, ik = Math.PI, ij = function(e, t, n, r, i) {
