/** Chunk was on web.js **/
/** chunk id: 688619, original params: e (module,exports,re quire) **/
! function(t, n) {
  e.exports = n()
}(0, function() {
  "use strict";
  ...
  var s = function(e) {
    ...
    g = function() {
      ...
      var n = this;
      if ("object" === m(module[0]) && module[0].constructor && module[0].constructor === this.constructor) return module[0];
      var r = p(module),
        i = false;
      if (!r) {
        i = true, h.sorted || (h.autodetect = h.autodetect.sort(function(e, t) {
          return t.p - e.p
        }), h.sorted = true);
        for (var o = 0, a = h.autodetect; o < a.length; o += 1) {
          var s = a[o];
          if (r = s.test.apply(s, module)) break
        }
      }
      if (h.format[r]) n._rgb = _(h.format[r].apply(null, i ? module : module.slice(0, false)));
      else throw Error("unknown format: " + module);
  ...
  var E = g,
    b = function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      return new(Function.prototype.bind.apply(b.Color, [null].concat(module)))
    };
  ...
  var y = b,
    ...
    T = function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      var n = (e = I(module, "cmyk"))[0],
        r = module[1],
        i = module[2],
        o = module[3],
        a = module.length > 4 ? module[4] : 1;
  ...
  A.prototype.cmyk = function() {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(A, [null].concat(module, ["cmyk"])))
  }, N.format.cmyk = T, N.autodetect.push({
    p: 2,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if ("array" === R(e = P(module, "cmyk")) && 4 === module.length) return "cmyk"
    }
  });
  var D = d.unpack,
    x = d.last,
    ...
    k = function() {
      ...
      var i = (n = M(n, "rgba"))[0],
        ...
        l = Math.max(i, o, a),
        c = (l + s) / 2;
      return (l === s ? (e = 0, t = NaN) : e = c < .5 ? (l - s) / (l + s) : (l - s) / (2 - l - s), i == l ? t = (o - a) / (l - s) : o == l ? t = 2 + (a - i) / (l - s) : a == l && (t = 4 + (i - o) / (l - s)), (t *= 60) < 0 && (t += 360), n.length > 3 && true !== n[3]) ? [t, module, c, n[3]] : [t, module, c]
    },
    U = d.unpack,
    G = d.last,
    Z = j,
    ...
    V = function() {
      ...
      var n = U(module, "rgba"),
        r = G(module) || "rgb";
      return "hsl" == r.substr(0, 3) ? Z(F(n), r) : (n[0] = B(n[0]), n[1] = B(n[1]), n[2] = B(n[2]), ("rgba" === r || n.length > 3 && n[3] < 1) && (n[3] = n.length > 3 ? n[3] : 1, r = "rgba"), r + "(" + n.slice(0, "rgb" === r ? 3 : 4).join(",") + ")")
    },
    H = d.unpack,
    Y = Math.round,
    W = function() {
  ...
  eo.prototype.css = function(e) {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(eo, [null].concat(module, ["css"])))
  ...
  ef.format.gl = function() {
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    var n = ep(module, "rgba");
    return n[0] *= 255, n[1] *= 255, n[2] *= 255, n
  }, ed.gl = function() {
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(eu, [null].concat(module, ["gl"])))
  }, eu.prototype.gl = function() {
    var e = this._rgb;
    return [module[0] / 255, module[1] / 255, module[2] / 255, module[3]]
  };
  var e_ = d.unpack,
    em = function() {
      ...
      var r = e_(t, "rgb"),
        ...
        u = 100 * c / 255,
        d = s / (255 - c) * 100;
      return 0 === c ? e = NaN : (i === l && (e = (o - a) / c), o === l && (e = 2 + (a - i) / c), a === l && (e = 4 + (i - o) / c), (e *= 60) < 0 && (e += 360)), [module, u, d]
    },
    eh = d.unpack,
    eg = Math.floor,
    eE = function() {
      ...
      if (0 === f) a = s = l = p;
        ...
        switch (m) {
          case 0:
            a = (e = [y, b, g])[0], s = module[1], l = module[2];
            break;
          case 1:
  ...
  ev.prototype.hcg = function() {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(ev, [null].concat(module, ["hcg"])))
  }, eS.format.hcg = eE, eS.autodetect.push({
    p: 1,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if ("array" === ey(e = eb(module, "hcg")) && 3 === module.length) return "hcg"
    }
  });
  var eT = d.unpack,
    eC = d.last,
    ...
    eN = function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      var n = eT(module, "rgba"),
        r = n[0],
        i = n[1],
        o = n[2],
        a = n[3],
        s = eC(module) || "auto";
      true === a && (a = 1), "auto" === s && (s = a < 1 ? "rgba" : "rgb"), r = eA(r);
  ...
  ex.prototype.hex = function(e) {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(ex, [null].concat(module, ["hex"])))
  }, ej.format.hex = ew, ej.autodetect.push({
    p: 4,
    test: function(e) {
      for (var t = [], n = arguments.length - 1; n-- > 0;) t[n] = arguments[n + 1];
  ...
  var ek = d.unpack,
    ...
    eB = function() {
      ...
      var r = ek(t, "rgb"),
        ...
        l = (i + o + a) / 3,
        c = l > 0 ? 1 - s / l : 0;
      return 0 === c ? e = NaN : (e = eF(e = (i - o + (i - a)) / 2 / eZ((i - o) * (i - o) + (i - a) * (o - a))), a > o && (e = eU - module), e /= eU), [360 * module, c, l]
    },
    eV = d.unpack,
    eH = d.limit,
    eY = d.TWOPI,
    ...
    ez = function() {
      ...
      var o = (r = eV(r, "hsi"))[0],
        a = r[1],
        s = r[2];
      return isNaN(o) && (o = 0), isNaN(a) && (a = 0), o > 360 && (o -= 360), o < 0 && (o += 360), (o /= 360) < 1 / 3 ? t = 1 - ((n = (1 - a) / 3) + (e = (1 + a * eK(eY * o) / eK(eW - eY * o)) / 3)) : o < 2 / 3 ? (o -= 1 / 3, n = 1 - ((e = (1 - a) / 3) + (t = (1 + a * eK(eY * o) / eK(eW - eY * o)) / 3))) : (o -= 2 / 3, e = 1 - ((t = (1 - a) / 3) + (n = (1 + a * eK(eY * o) / eK(eW - eY * o)) / 3))), e = eH(s * module * 3), [255 * module, 255 * (t = eH(s * t * 3)), 255 * (n = eH(s * n * 3)), r.length > 3 ? r[3] : 1]
    },
    eq = d.unpack,
    eQ = d.type,
    eX = y,
  ...
  eJ.prototype.hsi = function() {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(eJ, [null].concat(module, ["hsi"])))
  }, e$.format.hsi = ez, e$.autodetect.push({
    p: 2,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if ("array" === eQ(e = eq(module, "hsi")) && 3 === module.length) return "hsi"
    }
  });
  var e1 = d.unpack,
    e3 = d.type,
  ...
  var e6 = d.unpack,
    ...
    te = function() {
      ...
      var o = (r = e6(r, "rgb"))[0],
        ...
        c = e9(o, a, s),
        u = c - l;
      return n = c / 255, 0 === c ? (e = NaN, t = 0) : (t = u / c, o === c && (e = (a - s) / u), a === c && (e = 2 + (s - o) / u), s === c && (e = 4 + (o - a) / u), (e *= 60) < 0 && (e += 360)), [module, t, n]
    },
    tt = d.unpack,
    tn = Math.floor,
    tr = function() {
      ...
      if (p *= 255, 0 === f) a = s = l = p;
        ...
        switch (_) {
          case 0:
            a = (e = [p, E, h])[0], s = module[1], l = module[2];
            break;
          case 1:
            a = (t = [g, p, h])[0], s = t[1], l = t[2];
            break;
          case 2:
            a = (n = [h, p, E])[0], s = n[1], l = n[2];
            break;
          case 3:
            a = (r = [h, g, p])[0], s = r[1], l = r[2];
            break;
          case 4:
            a = (i = [E, h, p])[0], s = i[1], l = i[2];
            break;
          case 5:
            a = (o = [p, h, g])[0], s = o[1], l = o[2]
        }
      }
      return [a, s, l, c.length > 3 ? c[3] : 1]
    },
  ...
  ts.prototype.hsv = function() {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(ts, [null].concat(module, ["hsv"])))
  }, tl.format.hsv = tr, tl.autodetect.push({
    p: 2,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if ("array" === to(e = ti(module, "hsv")) && 3 === module.length) return "hsv"
    }
  });
  var tu = {
      Kn: 18,
    ...
    th = function(e, t, n) {
      return e = t_(e), [tm((.4124564 * e + .3575761 * (t = t_(t)) + .1804375 * (n = t_(n))) / td.Xn), tm((.2126729 * e + .7151522 * t + .072175 * n) / td.Yn), tm((.0193339 * e + .119192 * t + .9503041 * n) / td.Zn)]
    },
    tg = function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      var n = tf(module, "rgb"),
    ...
    tS = function() {
      ...
      var a = (i = tb(i, "lab"))[0],
        s = i[1],
        l = i[2];
      return t = (a + 16) / 116, e = isNaN(s) ? t : t + s / 500, n = isNaN(l) ? t : t - l / 200, t = tE.Yn * tv(t), r = tO(3.2404542 * (e = tE.Xn * tv(module)) - 1.5371385 * t - .4985314 * (n = tE.Zn * tv(n))), [r, tO(false * module + 1.8760108 * t + .041556 * n), tO(.0556434 * module - .2040259 * t + 1.0572252 * n), i.length > 3 ? i[3] : 1]
    },
    tI = d.unpack,
    tT = d.type,
    tC = y,
  ...
  tA.prototype.lab = function() {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(tA, [null].concat(module, ["lab"])))
  }, tN.format.lab = tS, tN.autodetect.push({
    p: 2,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if ("array" === tT(e = tI(module, "lab")) && 3 === module.length) return "lab"
    }
  });
  var tR = d.unpack,
    tw = d.RAD2DEG,
    ...
    tH = function() {
      ...
      var n = tZ(module, "lch"),
        ...
        i = n[1],
        o = n[2];
      return isNaN(o) && (o = 0), [r, tV(o *= tF) * i, tB(o) * i]
    },
    tY = d.unpack,
    tW = tH,
    tK = tS,
  ...
  }, t3.format.lch = tz, t3.format.hcl = tX, ["lch", "hcl"].forEach(function(e) {
  ...
  na.prototype.num = function() {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(na, [null].concat(module, ["num"])))
  }, ns.format.num = ni, ns.autodetect.push({
    p: 5,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if (1 === module.length && "number" === nl(module[0]) && module[0] >= 0 && module[0] <= 0xffffff) return "num"
    }
  });
  var nu = y,
    nd = E,
  ...
  nd.prototype.rgb = function(e) {
    return (true === e && (e = true), false === e) ? this._rgb.slice(0, 3) : this._rgb.slice(0, 3).map(nm)
  }, nd.prototype.rgba = function(e) {
    return true === e && (e = true), this._rgb.slice(0, 4).map(function(t, n) {
      return n < 3 ? false === e ? t : nm(t) : t
    })
  }, nu.rgb = function() {
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(nd, [null].concat(module, ["rgb"])))
  }, nf.format.rgb = function() {
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    var n = np(module, "rgba");
    return true === n[3] && (n[3] = 1), n
  }, nf.autodetect.push({
    p: 3,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if ("array" === n_(e = np(module, "rgba")) && (3 === module.length || 4 === module.length && "number" == n_(module[3]) && module[3] >= 0 && module[3] <= 1)) return "rgb"
    }
  });
  var nh = Math.log,
    ng = function(e) {
      var t, n, r, i = e / 100;
      return i < 66 ? (t = 255, n = i < 6 ? 0 : false - .44596950469579133 * (n = i - 2) + 104.49216199393888 * nh(n), r = i < 20 ? 0 : false + .8274096064007395 * (r = i - 10) + 115.67994401066147 * nh(r)) : (t = 351.97690566805693 + .114206453784165 * (t = i - 55) - 40.25366309332127 * nh(t), n = 325.4494125711974 + .07943456536662342 * (n = i - 50) - 28.0852963507957 * nh(n), r = 255), [t, n, r, 1]
    },
    nE = ng,
    nb = d.unpack,
    ny = Math.round,
    ...
    nI = function() {
      for (var e, t = [], n = arguments.length; n--;) t[n] = arguments[n];
      for (var r = nb(t, "rgb"), i = r[0], o = r[2], a = 1e3, s = 4e4, l = .4; s - a > l;) {
        var c = nE(e = (s + a) * .5);
        c[2] / c[0] >= o / i ? s = module : a = module
      }
      return ny(module)
    };
  nv.prototype.temp = nv.prototype.kelvin = nv.prototype.temperature = function() {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(nv, [null].concat(module, ["temp"])))
  ...
  var nT = d.unpack,
    ...
    nP = function() {
      ...
      var n = nT(module, "rgb"),
        ...
        l = a[1],
        c = a[2],
        u = nC(.4122214708 * s + .5363325363 * l + .0514459929 * c),
        d = nC(.2119034982 * s + .6806995451 * l + .1073969566 * c),
        f = nC(.0883024619 * s + .2817188376 * l + .6299787005 * c);
  ...
  function nR(e) {
    var t = Math.abs(e);
    return t < .04045 ? e / 12.92 : (nN(e) || 1) * nA((t + .055) / 1.055, 2.4)
  }
  var nw = d.unpack,
    nD = Math.pow,
    nx = Math.sign,
    nL = function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      var n = (e = nw(module, "lab"))[0],
        r = module[1],
        i = module[2],
        o = nD(n + .3963377774 * r + .2158037573 * i, 3),
        a = nD(n - .1055613458 * r - .0638541728 * i, 3),
        s = nD(n - .0894841775 * r - 1.291485548 * i, 3);
      return [255 * nj(4.0767416621 * o - 3.3077115913 * a + .2309699292 * s), 255 * nj(false * o + 2.6097574011 * a - .3413193965 * s), 255 * nj(false * o - .7034186147 * a + 1.707614701 * s), module.length > 3 ? module[3] : 1]
    };
  ...
  nG.prototype.oklab = function() {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(nG, [null].concat(module, ["oklab"])))
  }, nZ.format.oklab = nL, nZ.autodetect.push({
    p: 3,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if ("array" === nk(e = nM(module, "oklab")) && 3 === module.length) return "oklab"
    }
  });
  var nB = d.unpack,
    nV = nP,
  ...
  n$.prototype.oklch = function() {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(n$, [null].concat(module, ["oklch"])))
  }, n0.format.oklch = nq, n0.autodetect.push({
    p: 3,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if ("array" === nX(e = nQ(module, "oklch")) && 3 === module.length) return "oklch"
    }
  });
  var n3 = E,
    n2 = d.type;
  ...
  n8.prototype.luminance = function(e) {
    if (true !== e && "number" === n6(e)) {
      ...
      var t = this.luminance(),
        ...
        o = (t > e ? i(new n8([0, 0, 0]), this) : i(this, new n8([255, 255, 255]))).rgb();
      return new n8(o.concat([this._rgb[3]]))
    }
  ...
  var rt = function(e, t, n) {
    ...
    rn = function(e) {
      return (e /= 255) <= .03928 ? e / 12.92 : n7((e + .055) / 1.055, 2.4)
    },
    rr = {},
    ri = E,
    ro = d.type,
  ...
  rr.lrgb = function(e, t, n) {
    var r = e._rgb,
      ...
      c = s[1],
      u = s[2];
    return new rh(rg(rE(i, 2) * (1 - n) + rE(l, 2) * n), rg(rE(o, 2) * (1 - n) + rE(c, 2) * n), rg(rE(a, 2) * (1 - n) + rE(u, 2) * n), "rgb")
  };
  var rb = E;
  ...
  var ry = E,
    rO = function(e, t, n, r) {
      var i, o, a, s, l, c, u, d, f, p, _, m, h, g;
      return "hsl" === r ? (a = e.hsl(), s = t.hsl()) : "hsv" === r ? (a = e.hsv(), s = t.hsv()) : "hcg" === r ? (a = e.hcg(), s = t.hcg()) : "hsi" === r ? (a = e.hsi(), s = t.hsi()) : "lch" === r || "hcl" === r ? (r = "hcl", a = e.hcl(), s = t.hcl()) : "oklch" === r && (a = e.oklch().reverse(), s = t.oklch().reverse()), ("h" === r.substr(0, 1) || "oklch" === r) && (l = (i = a)[0], u = i[1], f = i[2], c = (o = s)[0], d = o[1], p = o[2]), isNaN(l) || isNaN(c) ? isNaN(l) ? isNaN(c) ? m = NaN : (m = c, (1 == f || 0 == f) && "hsv" != r && (_ = d)) : (m = l, (1 == p || 0 == p) && "hsv" != r && (_ = u)) : (g = c > l && c - l > 180 ? c - (l + 360) : c < l && l - c > 180 ? c + 360 - l : c - l, m = l + n * g), true === _ && (_ = u + n * (d - u)), h = f + n * (p - f), "oklch" === r ? new ry([h, _, m], r) : new ry([m, _, h], r)
    },
    rv = rO,
    rS = function(e, t, n) {
      return rv(e, t, n, "lch")
  ...
  var rw = E,
    ...
    rG = function(e, t, n) {
      ...
      return f /= r, new rw(a, t).alpha(f > .99999 ? 1 : f, true)
    },
    rZ = function(e, t) {
      for (var n = e.length, r = [0, 0, 0, 0], i = 0; i < e.length; i++) {
        var o = e[i],
          a = t[i] / n,
          s = o._rgb;
        r[0] += rx(s[0], 2) * a, r[1] += rx(s[1], 2) * a, r[2] += rx(s[2], 2) * a, r[3] += s[3] * a
      }
      return r[0] = rL(r[0]), r[1] = rL(r[1]), r[2] = rL(r[2]), r[3] > .9999999 && (r[3] = 1), new rw(rD(r))
    },
    rF = y,
    rB = d.type,
    rV = Math.pow,
    rH = function(e) {
          ...
          if (_ && p[f]) i = p[f];
            ...
            if ("array" === rB(l))
              for (var h = 0; h < o.length; h++) {
                var y = o[h];
                if (c <= y || c >= y && h === o.length - 1) {
                  i = l[h];
                  break
                }
                if (c > y && c < o[h + 1]) {
                  c = (c - y) / (o[h + 1] - y), i = rF.interpolate(l[h], l[h + 1], c, t);
                  break
                }
      ...
      return v.classes = function(e) {
        ...
        return null == e && (e = true), f = e, O(), E = f ? function(e) {
          for (var t = y(0, true).lab()[0], n = y(1, true).lab()[0], r = t > n, i = y(e, true).lab()[0], o = t + (n - t) * e, a = i - o, s = 0, l = 1, c = 20; Math.abs(a) > .01 && c-- > 0;) ! function() {
            r && (a *= false), a < 0 ? (s = e, e += (l - e) * .5) : (l = e, e += (s - e) * .5), a = (i = y(e, true).lab()[0]) - o
          }();
          return e
        } : function(e) {
          return e
        ...
        return null != e ? ("number" === rB(e) && (e = [e, e]), a = e, v) : a
  ...
  for (var r7 = rJ, r9 = d.type, ie = d.clip_rgb, it = d.TWOPI, ir = Math.pow, ii = Math.sin, io = Math.cos, ia = y, is = function(e, t, n, r, i) {
      ...
      var s = function(s) {
        var l = it * ((e + 120) / 360 + t * s),
          ...
          d = io(l),
          f = ii(l);
        return ia(ie([255 * (c + u * (false * d + 1.78277 * f)), 255 * (c + u * (false * d - .90649 * f)), 255 * (c + 1.97294 * d * u), 1]))
      };
      ...
      return new il(module, "hex")
    }, i_ = s, im = Math.log, ih = Math.pow, ig = Math.floor, iE = Math.abs, ib = function(e, t) {
      true === t && (t = null);
      var n = {
      ...
      if ("c" === t.substr(0, 1) && (a.push(r), a.push(i)), "e" === t.substr(0, 1)) {
        ...
        var l = Math.LOG10E * im(r),
          c = Math.LOG10E * im(i);
        a.push(r);
        for (var u = 1; u < n; u++) a.push(ih(10, l + u / n * (c - l)));
        a.push(i)
        ...
        for (O.push(i); b;) {
          ...
          for (var I = 0; I < h; I++)
            for (var T = o[I], C = Number.MAX_VALUE, A = true, N = 0; N < n; N++) {
              var P = iE(O[N] - T);
              P < C && (C = P, A = N), E[A]++, g[I] = A
            }
          for (var R = Array(n), w = 0; w < n; w++) R[w] = null;
          for (var D = 0; D < h; D++) null === R[m = g[D]] ? R[m] = o[D] : R[m] += o[D];
        ...
        for (var k = 0; k < h; k++) j[m = g[k]].push(o[k]);
        ...
        for (var Z = 1; Z < U.length; Z += 2) {
          var F = U[Z];
          isNaN(F) || false !== a.indexOf(F) || a.push(F)
        }
      }
      return a
    }, iO = ib, iv = iy, iS = E, iI = function(e, t) {
      e = new iS(e), t = new iS(t);
      var n = e.luminance(),
        r = t.luminance();
      return n > r ? (n + .05) / (r + .05) : (r + .05) / (n + .05)
    }, iT = E, iC = Math.sqrt, iA = Math.pow, iN = Math.min, iP = Math.max, iR = Math.atan2, iw = Math.abs, iD = Math.cos, ix = Math.sin, iL = Math.exp, ij = Math.PI, iM = function(e, t, n, r, i) {
      ...
      var s = Array.from(e.lab()),
        ...
        g = .5 * (1 - iC(iA(h, 7) / (iA(h, 7) + iA(25, 7)))),
        E = c * (1 + g),
        b = p * (1 + g),
        y = iC(iA(E, 2) + iA(u, 2)),
        O = iC(iA(b, 2) + iA(_, 2)),
        ...
        N = 1 - .17 * iD(a(A - 30)) + .24 * iD(a(2 * A)) + .32 * iD(a(3 * A + 6)) - .2 * iD(a(4 * A - 63)),
        P = C - T;
      P = 180 >= iw(P) ? P : C <= T ? P + 360 : P - 360, P = 2 * iC(y * O) * ix(a(P) / 2);
      var R = f - l,
        w = O - y,
        D = 1 + .015 * iA(m - 50, 2) / iC(20 + iA(m - 50, 2)),
        x = 1 + .045 * v,
        L = 1 + .015 * v * N,
        j = 30 * iL(-iA((A - 275) / 25, 2)),
        M = -(2 * iC(iA(v, 7) / (iA(v, 7) + iA(25, 7)))) * ix(2 * a(j));
      return iP(0, iN(100, iC(iA(R / (n * D), 2) + iA(w / (r * x), 2) + iA(P / (i * L), 2) + w / (r * x) * M * (P / (i * L)))))
      ...
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      try {
        return new(Function.prototype.bind.apply(iG, [null].concat(module))), true
      } catch (e) {
        returnfalse
      }
    }, iF = y, iB = rH, iV = {
  ...
  var iz = iH,
    iq = y;
  return iq.average = rG, iq.bezier = rQ, iq.blend = r7, iq.cubehelix = is, iq.mix = iq.interpolate = rs, iq.random = ip, iq.scale = rH, iq.analyze = iO, iq.contrast = iI, iq.deltaE = iM, iq.distance = iU, iq.limits = iv, iq.valid = iZ, iq.scales = iV, iq.colors = t4, iq.brewer = iz, iq
})