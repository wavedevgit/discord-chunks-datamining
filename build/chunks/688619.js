/** Chunk was on web.js **/ ! function(t, n) {
  ...
  var tu = {
    ...
    tI = function() {
      ...
      var a = (i = tb(i, "lab"))[0],
        s = i[1],
        l = i[2];
      return t = (a + 16) / 116, e = isNaN(s) ? t : t + s / 500, n = isNaN(l) ? t : t - l / 200, t = tE.Yn * tO(t), r = tv(3.2404542 * (e = tE.Xn * tO(e)) - 1.5371385 * t - .4985314 * (n = tE.Zn * tO(n))), [r, tv(-.969266 * e + 1.8760108 * t + .041556 * n), tv(.0556434 * e - .2040259 * t + 1.0572252 * n), i.length > 3 ? i[3] : 1]
    },
    tS = d.unpack,
    tT = d.type,
    tN = y,
  ...
  var rw = E,
    ...
    rG = function(e, t, n) {
      ...
      return f /= r, new rw(a, t).alpha(f > .99999 ? 1 : f, !0)
    },
    rB = function(e, t) {
    ...
    rH = function(e) {
          ...
          if (p && _[f]) i = _[f];
            ...
            if ("array" === rF(l))
              for (var m = 0; m < o.length; m++) {
                ...
                if (c > y && c < o[m + 1]) {
                  c = (c - y) / (o[m + 1] - y), i = rV.interpolate(l[m], l[m + 1], c, t);
                  break
                }
      ...
      return O.classes = function(e) {
        ...
        return null == e && (e = !0), f = e, v(), E = f ? function(e) {
          for (var t = y(0, !0).lab()[0], n = y(1, !0).lab()[0], r = t > n, i = y(e, !0).lab()[0], o = t + (n - t) * e, a = i - o, s = 0, l = 1, c = 20; Math.abs(a) > .01 && c-- > 0;) ! function() {
            r && (a *= -1), a < 0 ? (s = e, e += (l - e) * .5) : (l = e, e += (s - e) * .5), a = (i = y(e, !0).lab()[0]) - o
          }();
          return e
        } : function(e) {
          return e
        ...
        return null != e ? ("number" === rF(e) && (e = [e, e]), a = e, O) : a
  ...
  for (var r7 = rJ, r9 = d.type, ie = d.clip_rgb, it = d.TWOPI, ir = Math.pow, ii = Math.sin, io = Math.cos, ia = y, is = function(e, t, n, r, i) {
      ...
      var s = function(s) {
        var l = it * ((e + 120) / 360 + t * s),
          ...
          d = io(l),
          f = ii(l);
        return ia(ie([255 * (c + u * (-.14861 * d + 1.78277 * f)), 255 * (c + u * (-.29227 * d - .90649 * f)), 255 * (c + 1.97294 * d * u), 1]))
      };
      ...
      if ("c" === t.substr(0, 1) && (a.push(r), a.push(i)), "e" === t.substr(0, 1)) {
        ...
        for (v.push(i); b;) {
          ...
          for (var S = 0; S < m; S++)
            for (var T = o[S], N = Number.MAX_VALUE, A = void 0, C = 0; C < n; C++) {
              var P = iE(v[C] - T);
              P < N && (N = P, A = C), E[A]++, g[S] = A
            }
    ...
    }, iT = E, iN = Math.sqrt, iA = Math.pow, iC = Math.min, iP = Math.max, iR = Math.atan2, iw = Math.abs, iD = Math.cos, iL = Math.sin, ix = Math.exp, iM = Math.PI, ik = function(e, t, n, r, i) {
      ...
      var s = Array.from(e.lab()),
        ...
        C = 1 - .17 * iD(a(A - 30)) + .24 * iD(a(2 * A)) + .32 * iD(a(3 * A + 6)) - .2 * iD(a(4 * A - 63)),
        P = N - T;
      P = 180 >= iw(P) ? P : N <= T ? P + 360 : P - 360, P = 2 * iN(y * v) * iL(a(P) / 2);
      var R = f - l,
        w = v - y,
        ...
        k = -(2 * iN(iA(O, 7) / (iA(O, 7) + iA(25, 7)))) * iL(2 * a(M));
      return iP(0, iC(100, iN(iA(R / (n * D), 2) + iA(w / (r * L), 2) + iA(P / (i * x), 2) + w / (r * L) * k * (P / (i * x)))))
