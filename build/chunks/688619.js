  ...
  var eS = d.unpack,
    ...
    eC = function() {
      ...
      var n = eS(module, "rgba"),
        ...
        o = n[3],
        s = eA(module) || "auto";
      true === o && (o = 1), "auto" === s && (s = o < 1 ? "rgba" : "rgb"), r = eN(r);
  ...
  var ej = d.unpack,
    ...
    eF = function() {
      ...
      var r = ej(t, "rgb"),
        ...
        l = (i + a + o) / 3,
        c = l > 0 ? 1 - s / l : 0;
      return 0 === c ? e = NaN : (e = eV(e = (i - a + (i - o)) / 2 / eB((i - a) * (i - a) + (i - o) * (a - o))), o > a && (e = eU - module), e /= eU), [360 * module, c, l]
    },
    eZ = d.unpack,
    eH = d.limit,
    eY = d.TWOPI,
  ...
  for (var r7 = rJ, r9 = d.type, ie = d.clip_rgb, it = d.TWOPI, ir = Math.pow, ii = Math.sin, ia = Math.cos, io = y, is = function(e, t, n, r, i) {
      ...
      if ("c" === t.substr(0, 1) && (o.push(r), o.push(i)), "e" === t.substr(0, 1)) {
        ...
        for (O.push(i); b;) {
          ...
          for (var T = 0; T < m; T++)
            for (var S = a[T], A = Number.MAX_VALUE, N = true, C = 0; C < n; C++) {
              var R = iE(O[C] - S);
      ...
      var s = Array.from(e.lab()),
        ...
        C = 1 - .17 * iD(o(N - 30)) + .24 * iD(o(2 * N)) + .32 * iD(o(3 * N + 6)) - .2 * iD(o(4 * N - 63)),
        R = A - S;
      ...
      cool: function() {
        return iF([iV.hsl(180, 1, .9), iV.hsl(250, .7, .4)])
      },
      hot: function() {
