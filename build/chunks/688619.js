...
! function(t, n) {
  ...
  C.prototype.cmyk = function() {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(C, [null].concat(module, ["cmyk"])))
  ...
  var eS = d.unpack,
    ...
    eN = function() {
      ...
      var n = eS(module, "rgba"),
        ...
        a = n[3],
        s = eA(module) || "auto";
      true === a && (a = 1), "auto" === s && (s = a < 1 ? "rgba" : "rgb"), r = eC(r);
      var l = "000000" + (r << 16 | (i = eC(i)) << 8 | (o = eC(o))).toString(16);
      l = l.substr(l.length - 6);
      var c = "0" + eC(255 * a).toString(16);
  ...
  tC.prototype.lab = function() {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(tC, [null].concat(module, ["lab"])))
  }, tN.format.lab = tI, tN.autodetect.push({
    p: 2,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
  ...
  nG.prototype.oklab = function() {
    ...
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if ("array" === nM(e = nk(module, "oklab")) && 3 === module.length) return "oklab"
    }
  });
  var nF = d.unpack,
    nV = nR,
  ...
  for (var r7 = rJ, r9 = d.type, ie = d.clip_rgb, it = d.TWOPI, ir = Math.pow, ii = Math.sin, io = Math.cos, ia = y, is = function(e, t, n, r, i) {
      ...
      if ("c" === t.substr(0, 1) && (a.push(r), a.push(i)), "e" === t.substr(0, 1)) {
        ...
        for (O.push(i); b;) {
          ...
          for (var T = 0; T < m; T++)
            for (var S = o[T], A = Number.MAX_VALUE, C = true, N = 0; N < n; N++) {
              var R = iE(O[N] - S);
        ...
        for (var j = {}, k = 0; k < n; k++) j[k] = [];
        for (var M = 0; M < m; M++) j[h = g[M]].push(o[M]);
    ...
    }, iS = E, iA = Math.sqrt, iC = Math.pow, iN = Math.min, iR = Math.max, iP = Math.atan2, iw = Math.abs, iD = Math.cos, ix = Math.sin, iL = Math.exp, ij = Math.PI, ik = function(e, t, n, r, i) {
      ...
      var s = Array.from(e.lab()),
        ...
        g = .5 * (1 - iA(iC(m, 7) / (iC(m, 7) + iC(25, 7)))),
        E = c * (1 + g),
        b = _ * (1 + g),
        y = iA(iC(E, 2) + iC(u, 2)),
        O = iA(iC(b, 2) + iC(p, 2)),
        ...
        N = 1 - .17 * iD(a(C - 30)) + .24 * iD(a(2 * C)) + .32 * iD(a(3 * C + 6)) - .2 * iD(a(4 * C - 63)),
        R = A - S;
      R = 180 >= iw(R) ? R : A <= S ? R + 360 : R - 360, R = 2 * iA(y * O) * ix(a(R) / 2);
      var P = f - l,
        w = O - y,
        D = 1 + .015 * iC(h - 50, 2) / iA(20 + iC(h - 50, 2)),
        x = 1 + .045 * v,
        L = 1 + .015 * v * N,
        j = 30 * iL(-iC((C - 275) / 25, 2)),
        k = -(2 * iA(iC(v, 7) / (iC(v, 7) + iC(25, 7)))) * ix(2 * a(j));
      return iR(0, iN(100, iA(iC(P / (n * D), 2) + iC(w / (r * x), 2) + iC(R / (i * L), 2) + w / (r * x) * k * (R / (i * L)))))
    }, iM = E, iU = function(e, t, n) {
      true === n && (n = "lab"), e = new iM(e), t = new iM(t);
      var r = e.get(n),
        i = t.get(n),
        o = 0;
      for (var a in r) {
  ...
  var iz = iH,
    iq = y;
  return iq.average = rG, iq.bezier = rX, iq.blend = r7, iq.cubehelix = is, iq.mix = iq.interpolate = rs, iq.random = i_, iq.scale = rH, iq.analyze = iO, iq.contrast = iT, iq.deltaE = ik, iq.distance = iU, iq.limits = iv, iq.valid = iB, iq.scales = iV, iq.colors = t4, iq.brewer = iz, iq
})