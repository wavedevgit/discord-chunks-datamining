/** Chunk was on web.js **/ ! function(t, n) {
  ...
  var ej = d.unpack,
    ...
    eF = function() {
      ...
      var r = ej(t, "rgb"),
        ...
        l = (i + o + a) / 3,
        c = l > 0 ? 1 - s / l : 0;
      return 0 === c ? e = NaN : (e = eV(e = (i - o + (i - a)) / 2 / eB((i - o) * (i - o) + (i - a) * (o - a))), a > o && (e = eU - e), e /= eU), [360 * e, c, l]
    },
    eZ = d.unpack,
    eH = d.limit,
    eW = d.TWOPI,
  ...
  var tP = d.unpack,
    ...
    tH = function() {
      ...
      var n = tB(e, "lch"),
        ...
        i = n[1],
        o = n[2];
      return isNaN(o) && (o = 0), [r, tZ(o *= tV) * i, tF(o) * i]
    },
    tW = d.unpack,
    tY = tH,
    tK = tS,
  ...
  var rV = E,
    ...
    rq = function(e, t, n) {
      ...
      return f /= r, new rV(a, t).alpha(f > .99999 ? 1 : f, !0)
    },
    rQ = function(e, t) {
      ...
      return r[0] = rH(r[0]), r[1] = rH(r[1]), r[2] = rH(r[2]), r[3] > .9999999 && (r[3] = 1), new rV(rF(r))
    },
    rX = b,
    rJ = d.type,
    r$ = Math.pow,
  ...
  for (var iu = r8, id = d.type, i_ = d.clip_rgb, ip = d.TWOPI, ih = Math.pow, ig = Math.sin, im = Math.cos, iE = b, iv = function(e, t, n, r, i) {
      ...
      if ("c" === t.substr(0, 1) && (a.push(r), a.push(i)), "e" === t.substr(0, 1)) {
        ...
        for (var j = 0; j < g; j++) M[h = m[j]].push(o[j]);
        ...
        for (var B = 1; B < U.length; B += 2) {
          var V = U[B];
          isNaN(V) || -1 !== a.indexOf(V) || a.push(V)
        }
      }
      return a
    ...
    }, ik = E, ij = Math.sqrt, iU = Math.pow, iG = Math.min, iB = Math.max, iV = Math.atan2, iF = Math.abs, iZ = Math.cos, iH = Math.sin, iW = Math.exp, iY = Math.PI, iK = function(e, t, n, r, i) {
      ...
      var s = Array.from(e.lab()),
        ...
        p = d[2],
        h = (l + f) / 2,
        g = (ij(iU(c, 2) + iU(u, 2)) + ij(iU(_, 2) + iU(p, 2))) / 2,
        m = .5 * (1 - ij(iU(g, 7) / (iU(g, 7) + iU(25, 7)))),
        E = c * (1 + m),
        v = _ * (1 + m),
        b = ij(iU(E, 2) + iU(u, 2)),
        y = ij(iU(v, 2) + iU(p, 2)),
      ...
      var P = f - l,
        D = y - b,
        w = 1 + .015 * iU(h - 50, 2) / ij(20 + iU(h - 50, 2)),
        L = 1 + .045 * O,
        x = 1 + .015 * O * C,
        M = 30 * iW(-iU((A - 275) / 25, 2)),
        k = -(2 * ij(iU(O, 7) / (iU(O, 7) + iU(25, 7)))) * iH(2 * a(M));
      return iB(0, iG(100, ij(iU(P / (n * w), 2) + iU(D / (r * L), 2) + iU(R / (i * x), 2) + D / (r * L) * k * (R / (i * x)))))
