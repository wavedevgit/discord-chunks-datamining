/** Chunk was on web.js **/ ! function(t, n) {
  ...
  var D = d.unpack,
    ...
    j = function() {
      ...
      var i = (n = k(n, "rgba"))[0],
        ...
        l = Math.max(i, a, o),
        c = (l + s) / 2;
      return (l === s ? (e = 0, t = Number.NaN) : e = c < .5 ? (l - s) / (l + s) : (l - s) / (2 - l - s), i == l ? t = (a - o) / (l - s) : a == l ? t = 2 + (o - i) / (l - s) : o == l && (t = 4 + (i - a) / (l - s)), (t *= 60) < 0 && (t += 360), n.length > 3 && void 0 !== n[3]) ? [t, e, c, n[3]] : [t, e, c]
    },
    U = d.unpack,
    G = d.last,
    B = M,
  ...
  var ej = d.unpack,
    ...
    ez = function() {
      ...
      var a = (r = eZ(r, "hsi"))[0],
        o = r[1],
        s = r[2];
      return isNaN(a) && (a = 0), isNaN(o) && (o = 0), a > 360 && (a -= 360), a < 0 && (a += 360), (a /= 360) < 1 / 3 ? t = 1 - ((n = (1 - o) / 3) + (e = (1 + o * eK(eW * a) / eK(eY - eW * a)) / 3)) : a < 2 / 3 ? (a -= 1 / 3, n = 1 - ((e = (1 - o) / 3) + (t = (1 + o * eK(eW * a) / eK(eY - eW * a)) / 3))) : (a -= 2 / 3, e = 1 - ((t = (1 - o) / 3) + (n = (1 + o * eK(eW * a) / eK(eY - eW * a)) / 3))), e = eH(s * e * 3), [255 * e, 255 * (t = eH(s * t * 3)), 255 * (n = eH(s * n * 3)), r.length > 3 ? r[3] : 1]
    },
    eq = d.unpack,
    eQ = d.type,
    eX = y,
  ...
  var tu = {
    ...
    tI = function() {
      ...
      var o = (i = tb(i, "lab"))[0],
        s = i[1],
        l = i[2];
      return t = (o + 16) / 116, e = isNaN(s) ? t : t + s / 500, n = isNaN(l) ? t : t - l / 200, t = tE.Yn * tO(t), r = tv(3.2404542 * (e = tE.Xn * tO(e)) - 1.5371385 * t - .4985314 * (n = tE.Zn * tO(n))), [r, tv(-.969266 * e + 1.8760108 * t + .041556 * n), tv(.0556434 * e - .2040259 * t + 1.0572252 * n), i.length > 3 ? i[3] : 1]
    },
    tS = d.unpack,
    tT = d.type,
    tN = y,
  ...
  var tP = d.unpack,
    ...
    tM = function() {
      ...
      var n = tP(e, "lab"),
        ...
        o = tD(i * i + a * a),
        s = (tL(a, i) * tw + 360) % 360;
      return 0 === tx(1e4 * o) && (s = Number.NaN), [r, o, s]
    },
    tk = d.unpack,
    tj = tg,
    tU = tM,
  ...
  nO.prototype.temp = nO.prototype.kelvin = nO.prototype.temperature = function() {
    return nS(this._rgb)
  }, nv.temp = nv.kelvin = nv.temperature = function() {
    for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
  ...
  var rw = E,
    ...
    rG = function(e, t, n) {
      ...
      return f /= r, new rw(o, t).alpha(f > .99999 ? 1 : f, !0)
    },
    rB = function(e, t) {
    ...
    rH = function(e) {
      ...
      return O.classes = function(e) {
        ...
        return arguments.length ? (t = e, v(), O) : t
        ...
        return null == e && (e = !0), f = e, v(), E = f ? function(e) {
          for (var t = y(0, !0).lab()[0], n = y(1, !0).lab()[0], r = t > n, i = y(e, !0).lab()[0], a = t + (n - t) * e, o = i - a, s = 0, l = 1, c = 20; Math.abs(o) > .01 && c-- > 0;) ! function() {
            r && (o *= -1), o < 0 ? (s = e, e += (l - e) * .5) : (l = e, e += (s - e) * .5), o = (i = y(e, !0).lab()[0]) - a
          }();
          return e
        } : function(e) {
          return e
        ...
        return null != e ? ("number" === rV(e) && (e = [e, e]), o = e, O) : o
  ...
  for (var r7 = rJ, r9 = d.type, ie = d.clip_rgb, it = d.TWOPI, ir = Math.pow, ii = Math.sin, ia = Math.cos, io = y, is = function(e, t, n, r, i) {
      ...
      if ("c" === t.substr(0, 1) && (o.push(r), o.push(i)), "e" === t.substr(0, 1)) {
        ...
        var h, m = a.length,
          ...
          v = null;
        (v = []).push(r);
        for (var O = 1; O < n; O++) v.push(r + O / n * (i - r));
        for (v.push(i); b;) {
          for (var I = 0; I < n; I++) E[I] = 0;
          for (var S = 0; S < m; S++)
            for (var T = a[S], N = Number.MAX_VALUE, A = void 0, C = 0; C < n; C++) {
              var R = iE(v[C] - T);
              R < N && (N = R, A = C), E[A]++, g[S] = A
            }
      ...
      return o
    }, iv = ib, iO = iy, iI = E, iS = function(e, t) {
      e = new iI(e), t = new iI(t);
      var n = e.luminance(),
        r = t.luminance();
      return n > r ? (n + .05) / (r + .05) : (r + .05) / (n + .05)
    }, iT = E, iN = Math.sqrt, iA = Math.pow, iC = Math.min, iR = Math.max, iP = Math.atan2, iw = Math.abs, iD = Math.cos, iL = Math.sin, ix = Math.exp, iM = Math.PI, ik = function(e, t, n, r, i) {
      ...
      var s = Array.from(e.lab()),
        ...
        p = d[2],
        h = (l + f) / 2,
        m = (iN(iA(c, 2) + iA(u, 2)) + iN(iA(_, 2) + iA(p, 2))) / 2,
        g = .5 * (1 - iN(iA(m, 7) / (iA(m, 7) + iA(25, 7)))),
        E = c * (1 + g),
        b = _ * (1 + g),
        y = iN(iA(E, 2) + iA(u, 2)),
        v = iN(iA(b, 2) + iA(p, 2)),
        ...
        T = I >= 0 ? I : I + 360,
        N = S >= 0 ? S : S + 360,
        A = iw(T - N) > 180 ? (T + N + 360) / 2 : (T + N) / 2,
        C = 1 - .17 * iD(o(A - 30)) + .24 * iD(o(2 * A)) + .32 * iD(o(3 * A + 6)) - .2 * iD(o(4 * A - 63)),
        R = N - T;
      R = 180 >= iw(R) ? R : N <= T ? R + 360 : R - 360, R = 2 * iN(y * v) * iL(o(R) / 2);
      var P = f - l,
        w = v - y,
        D = 1 + .015 * iA(h - 50, 2) / iN(20 + iA(h - 50, 2)),
        L = 1 + .045 * O,
        x = 1 + .015 * O * C,
        M = 30 * ix(-iA((A - 275) / 25, 2)),
        k = -(2 * iN(iA(O, 7) / (iA(O, 7) + iA(25, 7)))) * iL(2 * o(M));
      return iR(0, iC(100, iN(iA(P / (n * D), 2) + iA(w / (r * L), 2) + iA(R / (i * x), 2) + w / (r * L) * k * (R / (i * x)))))
      ...
      cool: function() {
        return iV([iF.hsl(180, 1, .9), iF.hsl(250, .7, .4)])
      },
      hot: function() {
  ...
  var iz = iH,
    iq = y;
  return iq.average = rG, iq.bezier = rQ, iq.blend = r7, iq.cubehelix = is, iq.mix = iq.interpolate = rs, iq.random = i_, iq.scale = rH, iq.analyze = iv, iq.contrast = iS, iq.deltaE = ik, iq.distance = iU, iq.limits = iO, iq.valid = iB, iq.scales = iZ, iq.colors = t4, iq.brewer = iz, iq
})