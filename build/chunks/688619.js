...
! function(t, n) {
  ...
  var D = d.unpack,
    ...
    F = function() {
      ...
      var n = U(module, "rgba"),
        r = G(module) || "rgb";
      return "hsl" == r.substr(0, 3) ? B(Z(n), r) : (n[0] = V(n[0]), n[1] = V(n[1]), n[2] = V(n[2]), ("rgba" === r || n.length > 3 && n[3] < 1) && (n[3] = n.length > 3 ? n[3] : 1, r = "rgba"), r + "(" + n.slice(0, "rgb" === r ? 3 : 4).join(",") + ")")
    },
    H = d.unpack,
    Y = Math.round,
    W = function() {
  ...
  var eM = d.unpack,
    ...
    eV = function() {
      ...
      var r = eM(t, "rgb"),
        ...
        l = (i + a + o) / 3,
        c = l > 0 ? 1 - s / l : 0;
      return 0 === c ? e = NaN : (e = eZ(e = (i - a + (i - o)) / 2 / eB((i - a) * (i - a) + (i - o) * (a - o))), o > a && (e = eU - module), e /= eU), [360 * module, c, l]
    },
    eF = d.unpack,
    eH = d.limit,
    eY = d.TWOPI,
  ...
  var e5 = d.unpack,
    ...
    tr = function() {
      ...
      if (_ *= 255, 0 === f) o = s = l = _;
        ...
        switch (p) {
          case 0:
            o = (e = [_, E, m])[0], s = module[1], l = module[2];
            break;
          case 1:
  ...
  var ry = E,
    rO = function(e, t, n, r) {
      ...
      return "hsl" === r ? (o = e.hsl(), s = t.hsl()) : "hsv" === r ? (o = e.hsv(), s = t.hsv()) : "hcg" === r ? (o = e.hcg(), s = t.hcg()) : "hsi" === r ? (o = e.hsi(), s = t.hsi()) : "lch" === r || "hcl" === r ? (r = "hcl", o = e.hcl(), s = t.hcl()) : "oklch" === r && (o = e.oklch().reverse(), s = t.oklch().reverse()), ("h" === r.substr(0, 1) || "oklch" === r) && (l = (i = o)[0], u = i[1], f = i[2], c = (a = s)[0], d = a[1], _ = a[2]), isNaN(l) || isNaN(c) ? isNaN(l) ? isNaN(c) ? h = NaN : (h = c, (1 == f || 0 == f) && "hsv" != r && (p = d)) : (h = l, (1 == _ || 0 == _) && "hsv" != r && (p = u)) : (g = c > l && c - l > 180 ? c - (l + 360) : c < l && l - c > 180 ? c + 360 - l : c - l, h = l + n * g), true === p && (p = u + n * (d - u)), m = f + n * (_ - f), "oklch" === r ? new ry([m, p, h], r) : new ry([h, p, m], r)
    },
    rv = rO,
    rI = function(e, t, n) {
      return rv(e, t, n, "lch")
  ...
  var rw = E,
    ...
    rH = function(e) {
      var t = "rgb",
        ...
        h = 1,
        m = function(e) {
          if ("string" === rV(e = e || ["#fff", "#000"]) && rZ.brewer && rZ.brewer[e.toLowerCase()] && (e = rZ.brewer[e.toLowerCase()]), "array" === rV(e)) {
  ...
  for (var r7 = rJ, r9 = d.type, ie = d.clip_rgb, it = d.TWOPI, ir = Math.pow, ii = Math.sin, ia = Math.cos, io = y, is = function(e, t, n, r, i) {
      ...
      if ("c" === t.substr(0, 1) && (o.push(r), o.push(i)), "e" === t.substr(0, 1)) {
        ...
        for (O.push(i); b;) {
          ...
          for (var T = 0; T < m; T++)
            for (var S = a[T], A = Number.MAX_VALUE, C = true, N = 0; N < n; N++) {
              var R = iE(O[N] - S);
        ...
        for (var M = 0; M < m; M++) j[h = g[M]].push(a[M]);
        ...
        for (var B = 1; B < U.length; B += 2) {
          var Z = U[B];
          isNaN(Z) || false !== o.indexOf(Z) || o.push(Z)
        }
      }
      return o
      ...
      var P = f - l,
        ...
        k = -(2 * iA(iC(v, 7) / (iC(v, 7) + iC(25, 7)))) * ix(2 * o(j));
      ...
      cool: function() {
        return iV([iZ.hsl(180, 1, .9), iZ.hsl(250, .7, .4)])
      },
      hot: function() {
  ...
  var iz = iH,
    iq = y;
  return iq.average = rG, iq.bezier = rX, iq.blend = r7, iq.cubehelix = is, iq.mix = iq.interpolate = rs, iq.random = i_, iq.scale = rH, iq.analyze = iO, iq.contrast = iT, iq.deltaE = ik, iq.distance = iU, iq.limits = iv, iq.valid = iB, iq.scales = iF, iq.colors = t4, iq.brewer = iz, iq
})