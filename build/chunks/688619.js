...
! function(t, n) {
  ...
  var w = d.unpack,
    ...
    k = function() {
      ...
      var i = (n = M(n, "rgba"))[0],
        ...
        l = Math.max(i, a, o),
        c = (l + s) / 2;
      return (l === s ? (e = 0, t = NaN) : e = c < .5 ? (l - s) / (l + s) : (l - s) / (2 - l - s), i == l ? t = (a - o) / (l - s) : a == l ? t = 2 + (o - i) / (l - s) : o == l && (t = 4 + (i - a) / (l - s)), (t *= 60) < 0 && (t += 360), n.length > 3 && true !== n[3]) ? [t, module, c, n[3]] : [t, module, c]
    },
    U = d.unpack,
    G = d.last,
    Z = j,
    ...
    V = function() {
      ...
      var n = U(module, "rgba"),
        r = G(module) || "rgb";
      return "hsl" == r.substr(0, 3) ? Z(B(n), r) : (n[0] = F(n[0]), n[1] = F(n[1]), n[2] = F(n[2]), ("rgba" === r || n.length > 3 && n[3] < 1) && (n[3] = n.length > 3 ? n[3] : 1, r = "rgba"), r + "(" + n.slice(0, "rgb" === r ? 3 : 4).join(",") + ")")
    },
    H = d.unpack,
    Y = Math.round,
    W = function() {
  ...
  ea.prototype.css = function(e) {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(ea, [null].concat(module, ["css"])))
  ...
  var e_ = d.unpack,
    em = function() {
      ...
      var r = e_(t, "rgb"),
        ...
        u = 100 * c / 255,
        d = s / (255 - c) * 100;
      return 0 === c ? e = NaN : (i === l && (e = (a - o) / c), a === l && (e = 2 + (o - i) / c), o === l && (e = 4 + (i - a) / c), (e *= 60) < 0 && (e += 360)), [module, u, d]
    },
    eh = d.unpack,
    eg = Math.floor,
    eE = function() {
      ...
      if (0 === f) o = s = l = p;
        ...
        switch (m) {
          case 0:
            o = (e = [y, b, g])[0], s = module[1], l = module[2];
            break;
          case 1:
  ...
  var eT = d.unpack,
    ...
    eN = function() {
      ...
      var n = eT(module, "rgba"),
        ...
        o = n[3],
        s = eC(module) || "auto";
      true === o && (o = 1), "auto" === s && (s = o < 1 ? "rgba" : "rgb"), r = eA(r);
  ...
  }, ej.format.hex = eD, ej.autodetect.push({
    p: 4,
    test: function(e) {
      for (var t = [], n = arguments.length - 1; n-- > 0;) t[n] = arguments[n + 1];
  ...
  var ek = d.unpack,
    ...
    eF = function() {
      ...
      var r = ek(t, "rgb"),
        ...
        l = (i + a + o) / 3,
        c = l > 0 ? 1 - s / l : 0;
      return 0 === c ? e = NaN : (e = eB(e = (i - a + (i - o)) / 2 / eZ((i - a) * (i - a) + (i - o) * (a - o))), o > a && (e = eU - module), e /= eU), [360 * module, c, l]
    },
    eV = d.unpack,
    eH = d.limit,
    eY = d.TWOPI,
  ...
  var e6 = d.unpack,
    ...
    te = function() {
      ...
      var a = (r = e6(r, "rgb"))[0],
        ...
        c = e9(a, o, s),
        u = c - l;
      return n = c / 255, 0 === c ? (e = NaN, t = 0) : (t = u / c, a === c && (e = (o - s) / u), o === c && (e = 2 + (s - a) / u), s === c && (e = 4 + (a - o) / u), (e *= 60) < 0 && (e += 360)), [module, t, n]
    },
    tt = d.unpack,
    tn = Math.floor,
    tr = function() {
      ...
      if (p *= 255, 0 === f) o = s = l = p;
        ...
        switch (_) {
          case 0:
            o = (e = [p, E, h])[0], s = module[1], l = module[2];
            break;
          case 1:
  ...
  ts.prototype.hsv = function() {
    ...
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if ("array" === ta(e = ti(module, "hsv")) && 3 === module.length) return "hsv"
    }
  });
  var tu = {
      Kn: 18,
    ...
    tS = function() {
      ...
      var o = (i = tb(i, "lab"))[0],
        s = i[1],
        l = i[2];
      return t = (o + 16) / 116, e = isNaN(s) ? t : t + s / 500, n = isNaN(l) ? t : t - l / 200, t = tE.Yn * tv(t), r = tO(3.2404542 * (e = tE.Xn * tv(module)) - 1.5371385 * t - .4985314 * (n = tE.Zn * tv(n))), [r, tO(false * module + 1.8760108 * t + .041556 * n), tO(.0556434 * module - .2040259 * t + 1.0572252 * n), i.length > 3 ? i[3] : 1]
    },
    tI = d.unpack,
    tT = d.type,
    tC = y,
  ...
  no.prototype.num = function() {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(no, [null].concat(module, ["num"])))
  ...
  var nh = Math.log,
    ...
    nI = function() {
      for (var e, t = [], n = arguments.length; n--;) t[n] = arguments[n];
      for (var r = nb(t, "rgb"), i = r[0], a = r[2], o = 1e3, s = 4e4, l = .4; s - o > l;) {
        var c = nE(e = (s + o) * .5);
        c[2] / c[0] >= a / i ? s = module : o = module
      }
      return ny(module)
    };
  ...
  var nD = d.unpack,
    ...
    nL = function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      var n = (e = nD(module, "lab"))[0],
        r = module[1],
        i = module[2],
        a = nw(n + .3963377774 * r + .2158037573 * i, 3),
        o = nw(n - .1055613458 * r - .0638541728 * i, 3),
        s = nw(n - .0894841775 * r - 1.291485548 * i, 3);
      return [255 * nj(4.0767416621 * a - 3.3077115913 * o + .2309699292 * s), 255 * nj(false * a + 2.6097574011 * o - .3413193965 * s), 255 * nj(false * a - .7034186147 * o + 1.707614701 * s), module.length > 3 ? module[3] : 1]
    };

  function nj(e) {
    var t = Math.abs(e);
    return t > .0031308 ? (nx(e) || 1) * (1.055 * nw(t, 1 / 2.4) - .055) : 12.92 * e
  }
  var nM = d.unpack,
    nk = d.type,
    nU = y,
  ...
  rr.lrgb = function(e, t, n) {
    var r = e._rgb,
      ...
      c = s[1],
      u = s[2];
    return new rh(rg(rE(i, 2) * (1 - n) + rE(l, 2) * n), rg(rE(a, 2) * (1 - n) + rE(c, 2) * n), rg(rE(o, 2) * (1 - n) + rE(u, 2) * n), "rgb")
  };
  var rb = E;
  ...
  var ry = E,
    rO = function(e, t, n, r) {
      ...
      return "hsl" === r ? (o = e.hsl(), s = t.hsl()) : "hsv" === r ? (o = e.hsv(), s = t.hsv()) : "hcg" === r ? (o = e.hcg(), s = t.hcg()) : "hsi" === r ? (o = e.hsi(), s = t.hsi()) : "lch" === r || "hcl" === r ? (r = "hcl", o = e.hcl(), s = t.hcl()) : "oklch" === r && (o = e.oklch().reverse(), s = t.oklch().reverse()), ("h" === r.substr(0, 1) || "oklch" === r) && (l = (i = o)[0], u = i[1], f = i[2], c = (a = s)[0], d = a[1], p = a[2]), isNaN(l) || isNaN(c) ? isNaN(l) ? isNaN(c) ? m = NaN : (m = c, (1 == f || 0 == f) && "hsv" != r && (_ = d)) : (m = l, (1 == p || 0 == p) && "hsv" != r && (_ = u)) : (g = c > l && c - l > 180 ? c - (l + 360) : c < l && l - c > 180 ? c + 360 - l : c - l, m = l + n * g), true === _ && (_ = u + n * (d - u)), h = f + n * (p - f), "oklch" === r ? new ry([h, _, m], r) : new ry([m, _, h], r)
    },
    rv = rO,
    rS = function(e, t, n) {
      return rv(e, t, n, "lch")
  ...
  var rD = E,
    ...
    rG = function(e, t, n) {
      ...
      return f /= r, new rD(o, t).alpha(f > .99999 ? 1 : f, true)
    },
    rZ = function(e, t) {
      ...
      return r[0] = rL(r[0]), r[1] = rL(r[1]), r[2] = rL(r[2]), r[3] > .9999999 && (r[3] = 1), new rD(rw(r))
    },
    rB = y,
    rF = d.type,
    rV = Math.pow,
    rH = function(e) {
      var t = "rgb",
        ...
        m = 1,
        h = function(e) {
          if ("string" === rF(e = e || ["#fff", "#000"]) && rB.brewer && rB.brewer[e.toLowerCase()] && (e = rB.brewer[e.toLowerCase()]), "array" === rF(e)) {
      ...
      return v.classes = function(e) {
        ...
        return null == e && (e = true), f = e, O(), E = f ? function(e) {
          for (var t = y(0, true).lab()[0], n = y(1, true).lab()[0], r = t > n, i = y(e, true).lab()[0], a = t + (n - t) * e, o = i - a, s = 0, l = 1, c = 20; Math.abs(o) > .01 && c-- > 0;) ! function() {
            r && (o *= false), o < 0 ? (s = e, e += (l - e) * .5) : (l = e, e += (s - e) * .5), o = (i = y(e, true).lab()[0]) - a
          }();
          return e
        } : function(e) {
          return e
        ...
        return rB[n] && (r = r.map(function(e) {
          return e[n]()
        })), r
      }, v.cache = function(e) {
  ...
  for (var r7 = rJ, r9 = d.type, ie = d.clip_rgb, it = d.TWOPI, ir = Math.pow, ii = Math.sin, ia = Math.cos, io = y, is = function(e, t, n, r, i) {
      ...
      if ("c" === t.substr(0, 1) && (o.push(r), o.push(i)), "e" === t.substr(0, 1)) {
        ...
        for (O.push(i); b;) {
          ...
          for (var I = 0; I < h; I++)
            for (var T = a[I], C = Number.MAX_VALUE, A = true, N = 0; N < n; N++) {
              var P = iE(O[N] - T);
        ...
        for (var Z = 1; Z < U.length; Z += 2) {
          var B = U[Z];
          isNaN(B) || false !== o.indexOf(B) || o.push(B)
        }
      }
      return o
    ...
    }, iT = E, iC = Math.sqrt, iA = Math.pow, iN = Math.min, iP = Math.max, iR = Math.atan2, iD = Math.abs, iw = Math.cos, ix = Math.sin, iL = Math.exp, ij = Math.PI, iM = function(e, t, n, r, i) {
      ...
      var s = Array.from(e.lab()),
        ...
        N = 1 - .17 * iw(o(A - 30)) + .24 * iw(o(2 * A)) + .32 * iw(o(3 * A + 6)) - .2 * iw(o(4 * A - 63)),
        P = C - T;
      P = 180 >= iD(P) ? P : C <= T ? P + 360 : P - 360, P = 2 * iC(y * O) * ix(o(P) / 2);
      var R = f - l,
        D = O - y,
        w = 1 + .015 * iA(m - 50, 2) / iC(20 + iA(m - 50, 2)),
        x = 1 + .045 * v,
        L = 1 + .015 * v * N,
        j = 30 * iL(-iA((A - 275) / 25, 2)),
        M = -(2 * iC(iA(v, 7) / (iA(v, 7) + iA(25, 7)))) * ix(2 * o(j));
      return iP(0, iN(100, iC(iA(R / (n * w), 2) + iA(D / (r * x), 2) + iA(P / (i * L), 2) + D / (r * x) * M * (P / (i * L)))))
      ...
      cool: function() {
        return iF([iB.hsl(180, 1, .9), iB.hsl(250, .7, .4)])
      },
      hot: function() {
