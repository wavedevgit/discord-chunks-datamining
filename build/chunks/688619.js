...
! function(t, n) {
  ...
  var s = function(e) {
    ...
    g = function() {
      ...
      var n = this;
      if ("object" === h(module[0]) && module[0].constructor && module[0].constructor === this.constructor) return module[0];
      var r = _(module),
        i = false;
      if (!r) {
      ...
      if (m.format[r]) n._rgb = p(m.format[r].apply(null, i ? module : module.slice(0, false)));
  ...
  N.prototype.cmyk = function() {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(N, [null].concat(module, ["cmyk"])))
  }, C.format.cmyk = S, C.autodetect.push({
    p: 2,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if ("array" === P(e = R(module, "cmyk")) && 4 === module.length) return "cmyk"
    }
  });
  var D = d.unpack,
    L = d.last,
  ...
  }, eI.format.hcg = eE, eI.autodetect.push({
    p: 1,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
  ...
  var eS = d.unpack,
    ...
    eC = function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      var n = eS(module, "rgba"),
        r = n[0],
        i = n[1],
        o = n[2],
        a = n[3],
        s = eA(module) || "auto";
      true === a && (a = 1), "auto" === s && (s = a < 1 ? "rgba" : "rgb"), r = eN(r);
  ...
  eL.prototype.hex = function(e) {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(eL, [null].concat(module, ["hex"])))
  ...
  var ek = d.unpack,
    ...
    eF = function() {
      ...
      var r = ek(t, "rgb"),
        ...
        l = (i + o + a) / 3,
        c = l > 0 ? 1 - s / l : 0;
      return 0 === c ? e = NaN : (e = eZ(e = (i - o + (i - a)) / 2 / eB((i - o) * (i - o) + (i - a) * (o - a))), a > o && (e = eU - module), e /= eU), [360 * module, c, l]
    },
    eV = d.unpack,
    eH = d.limit,
    eY = d.TWOPI,
  ...
  eJ.prototype.hsi = function() {
    ...
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if ("array" === eX(e = eq(module, "hsi")) && 3 === module.length) return "hsi"
    }
  });
  var e1 = d.unpack,
    e2 = d.type,
  ...
  e5.prototype.hsl = function() {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(e5, [null].concat(module, ["hsl"])))
  }, e4.format.hsl = W, e4.autodetect.push({
    p: 2,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
  ...
  var e8 = d.unpack,
    ...
    tr = function() {
      ...
      if (_ *= 255, 0 === f) a = s = l = _;
        ...
        switch (p) {
          case 0:
            a = (e = [_, E, m])[0], s = module[1], l = module[2];
            break;
          case 1:
  ...
  var tu = {
    ...
    t_ = Math.pow,
    tp = function(e) {
      return (e /= 255) <= .04045 ? e / 12.92 : t_((e + .055) / 1.055, 2.4)
    },
    th = function(e) {
      return e > td.t3 ? t_(e, 1 / 3) : e / td.t2 + td.t0
    },
    tm = function(e, t, n) {
      return e = tp(e), [th((.4124564 * e + .3575761 * (t = tp(t)) + .1804375 * (n = tp(n))) / td.Xn), th((.2126729 * e + .7151522 * t + .072175 * n) / td.Yn), th((.0193339 * e + .119192 * t + .9503041 * n) / td.Zn)]
    },
    tg = function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      var n = tf(module, "rgb"),
  ...
  tN.prototype.lab = function() {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    return new(Function.prototype.bind.apply(tN, [null].concat(module, ["lab"])))
  }, tC.format.lab = tI, tC.autodetect.push({
    p: 2,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if ("array" === tS(e = tT(module, "lab")) && 3 === module.length) return "lab"
    }
  });
  var tP = d.unpack,
    tw = d.RAD2DEG,
  ...
  nd.prototype.rgb = function(e) {
    ...
    for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
    var n = n_(module, "rgba");
    return true === n[3] && (n[3] = 1), n
  }, nf.autodetect.push({
    p: 3,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if ("array" === np(e = n_(module, "rgba")) && (3 === module.length || 4 === module.length && "number" == np(module[3]) && module[3] >= 0 && module[3] <= 1)) return "rgb"
    }
  });
  var nm = Math.log,
    ng = function(e) {
  ...
  var nS = d.unpack,
    ...
    nR = function() {
      ...
      var n = nS(module, "rgb"),
        ...
        l = a[1],
        c = a[2],
        u = nA(.4122214708 * s + .5363325363 * l + .0514459929 * c),
        d = nA(.2119034982 * s + .6806995451 * l + .1073969566 * c),
        f = nA(.0883024619 * s + .2817188376 * l + .6299787005 * c);
  ...
  function nP(e) {
    var t = Math.abs(e);
    return t < .04045 ? e / 12.92 : (nC(e) || 1) * nN((t + .055) / 1.055, 2.4)
  }
  var nw = d.unpack,
    nD = Math.pow,
    nL = Math.sign,
    nx = function() {
      ...
      return [255 * nM(4.0767416621 * o - 3.3077115913 * a + .2309699292 * s), 255 * nM(false * o + 2.6097574011 * a - .3413193965 * s), 255 * nM(false * o - .7034186147 * a + 1.707614701 * s), module.length > 3 ? module[3] : 1]
    };
  ...
  }, nB.format.oklab = nx, nB.autodetect.push({
    p: 3,
    test: function() {
      for (var e = [], t = arguments.length; t--;) module[t] = arguments[t];
      if ("array" === nk(e = nj(module, "oklab")) && 3 === module.length) return "oklab"
    }
  });
  var nF = d.unpack,
    nV = nR,
  ...
  n5.prototype.darken = function(e) {
    ...
    var t = this,
      n = t.lab();
    return n[0] -= n4.Kn * e, new n5(n, "lab").alpha(t.alpha(), true)
  }, n5.prototype.brighten = function(e) {
    return true === e && (e = 1), this.darken(-e)
  }, n5.prototype.darker = n5.prototype.darken, n5.prototype.brighter = n5.prototype.brighten, E.prototype.get = function(e) {
    var t = e.split("."),
      n = t[0],
      r = t[1],
      i = this[n]();
  ...
  r_.prototype.set = function(e, t, n) {
    ...
    if (s > false) {
      if ("string" == rp(t)) switch (t.charAt(0)) {
          case "+":
          case "-":
            a[s] += +t;
            break;
  ...
  var ry = E,
    rO = function(e, t, n, r) {
      ...
      return "hsl" === r ? (a = e.hsl(), s = t.hsl()) : "hsv" === r ? (a = e.hsv(), s = t.hsv()) : "hcg" === r ? (a = e.hcg(), s = t.hcg()) : "hsi" === r ? (a = e.hsi(), s = t.hsi()) : "lch" === r || "hcl" === r ? (r = "hcl", a = e.hcl(), s = t.hcl()) : "oklch" === r && (a = e.oklch().reverse(), s = t.oklch().reverse()), ("h" === r.substr(0, 1) || "oklch" === r) && (l = (i = a)[0], u = i[1], f = i[2], c = (o = s)[0], d = o[1], _ = o[2]), isNaN(l) || isNaN(c) ? isNaN(l) ? isNaN(c) ? h = NaN : (h = c, (1 == f || 0 == f) && "hsv" != r && (p = d)) : (h = l, (1 == _ || 0 == _) && "hsv" != r && (p = u)) : (g = c > l && c - l > 180 ? c - (l + 360) : c < l && l - c > 180 ? c + 360 - l : c - l, h = l + n * g), true === p && (p = u + n * (d - u)), m = f + n * (_ - f), "oklch" === r ? new ry([m, p, h], r) : new ry([h, p, m], r)
    },
    rv = rO,
    rI = function(e, t, n) {
      return rv(e, t, n, "lch")
  ...
  var rw = E,
    ...
    rB = function(e, t) {
      ...
      return r[0] = rx(r[0]), r[1] = rx(r[1]), r[2] = rx(r[2]), r[3] > .9999999 && (r[3] = 1), new rw(rD(r))
    },
    rZ = y,
    rF = d.type,
    rV = Math.pow,
    rH = function(e) {
      ...
      return v.classes = function(e) {
        ...
        return rZ[n] && (r = r.map(function(e) {
          return e[n]()
        })), r
      }, v.cache = function(e) {
  ...
  rJ.normal = r$(r0(function(e) {
    return e
  })), rJ.multiply = r$(r0(r1)), rJ.screen = r$(r0(r5)), rJ.overlay = r$(r0(r4)), rJ.darken = r$(r0(r2)), rJ.lighten = r$(r0(r3)), rJ.dodge = r$(r0(r8)), rJ.burn = r$(r0(r6));
  for (var r7 = rJ, r9 = d.type, ie = d.clip_rgb, it = d.TWOPI, ir = Math.pow, ii = Math.sin, io = Math.cos, ia = y, is = function(e, t, n, r, i) {
    ...
    }, il = E, ic = "0123456789abcdef", iu = Math.floor, id = Math.random, i_ = function() {
      for (var e = "#", t = 0; t < 6; t++) e += ic.charAt(iu(16 * id()));
      return new il(module, "hex")
    }, ip = s, ih = Math.log, im = Math.pow, ig = Math.floor, iE = Math.abs, ib = function(e, t) {
      true === t && (t = null);
      var n = {
      ...
      return "object" === ip(e) && (e = Object.values(e)), e.forEach(function(e) {
      ...
      true === t && (t = "equal"), true === n && (n = 7), "array" == ip(e) && (e = ib(e));
      var r = e.min,
        i = e.max,
      ...
      if ("c" === t.substr(0, 1) && (a.push(r), a.push(i)), "e" === t.substr(0, 1)) {
        ...
        for (O.push(i); b;) {
          ...
          for (var T = 0; T < m; T++)
            for (var S = o[T], A = Number.MAX_VALUE, N = true, C = 0; C < n; C++) {
              var R = iE(O[C] - S);
        ...
        for (var B = 1; B < U.length; B += 2) {
          var Z = U[B];
          isNaN(Z) || false !== a.indexOf(Z) || a.push(Z)
        }
      }
      return a
    }, iO = ib, iv = iy, iI = E, iT = function(e, t) {
      e = new iI(e), t = new iI(t);
      var n = e.luminance(),
        r = t.luminance();
      return n > r ? (n + .05) / (r + .05) : (r + .05) / (n + .05)
    }, iS = E, iA = Math.sqrt, iN = Math.pow, iC = Math.min, iR = Math.max, iP = Math.atan2, iw = Math.abs, iD = Math.cos, iL = Math.sin, ix = Math.exp, iM = Math.PI, ij = function(e, t, n, r, i) {
      ...
      var s = Array.from(e.lab()),
        ...
        g = .5 * (1 - iA(iN(m, 7) / (iN(m, 7) + iN(25, 7)))),
        E = c * (1 + g),
        b = _ * (1 + g),
        y = iA(iN(E, 2) + iN(u, 2)),
        O = iA(iN(b, 2) + iN(p, 2)),
        ...
        C = 1 - .17 * iD(a(N - 30)) + .24 * iD(a(2 * N)) + .32 * iD(a(3 * N + 6)) - .2 * iD(a(4 * N - 63)),
        R = A - S;
      R = 180 >= iw(R) ? R : A <= S ? R + 360 : R - 360, R = 2 * iA(y * O) * iL(a(R) / 2);
      var P = f - l,
        w = O - y,
        D = 1 + .015 * iN(h - 50, 2) / iA(20 + iN(h - 50, 2)),
        L = 1 + .045 * v,
        x = 1 + .015 * v * C,
        M = 30 * ix(-iN((N - 275) / 25, 2)),
        j = -(2 * iA(iN(v, 7) / (iN(v, 7) + iN(25, 7)))) * iL(2 * a(M));
      return iR(0, iC(100, iA(iN(P / (n * D), 2) + iN(w / (r * L), 2) + iN(R / (i * x), 2) + w / (r * L) * j * (R / (i * x)))))
      ...
      cool: function() {
        return iF([iZ.hsl(180, 1, .9), iZ.hsl(250, .7, .4)])
      },
      hot: function() {
  ...
  var iz = iH,
    iq = y;
  return iq.average = rG, iq.bezier = rX, iq.blend = r7, iq.cubehelix = is, iq.mix = iq.interpolate = rs, iq.random = i_, iq.scale = rH, iq.analyze = iO, iq.contrast = iT, iq.deltaE = ij, iq.distance = iU, iq.limits = iv, iq.valid = iB, iq.scales = iV, iq.colors = t5, iq.brewer = iz, iq
})