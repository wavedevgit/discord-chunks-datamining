/** Chunk was on web.js **/ ! function(t, n) {
  ...
  var tu = {
    ...
    tf = Math.pow,
    tp = function(e) {
      return (e /= 255) <= .04045 ? e / 12.92 : tf((e + .055) / 1.055, 2.4)
    },
    th = function(e) {
  ...
  var nS = d.unpack,
    ...
    nR = function() {
      ...
      var n = nS(e, "rgb"),
        ...
        _ = nA(.0883024619 * s + .2817188376 * l + .6299787005 * c);
      return [.2104542553 * u + .793617785 * d - .0040720468 * _, 1.9779984951 * u - 2.428592205 * d + .4505937099 * _, .0259040371 * u + .7827717662 * d - .808675766 * _]
    };
  ...
  var nw = d.unpack,
    ...
    nx = function() {
      ...
      return [255 * nk(4.0767416621 * a - 3.3077115913 * o + .2309699292 * s), 255 * nk(-1.2684380046 * a + 2.6097574011 * o - .3413193965 * s), 255 * nk(-.0041960863 * a - .7034186147 * o + 1.707614701 * s), e.length > 3 ? e[3] : 1]
    };
  ...
  var rw = E,
    ...
    rG = function(e, t, n) {
      ...
      return _ /= r, new rw(o, t).alpha(_ > .99999 ? 1 : _, !0)
    },
    rB = function(e, t) {
    ...
    rH = function(e) {
      var t = "rgb",
        ...
        y = function(e, r) {
          ...
          var _ = Math.floor(1e4 * (c = Math.min(1, Math.max(0, c = o[0] + c * (1 - o[0] - o[1])))));
          if (p && f[_]) i = f[_];
          else {
            if ("array" === rF(l))
      ...
      return v.classes = function(e) {
        ...
        return null == e && (e = !0), _ = e, O(), E = _ ? function(e) {
        ...
        if (0 == arguments.length) r = l.slice(0);
          ...
          var c = [];
          if (s && s.length > 2)
            for (var u = 1, d = s.length, _ = 1 <= d; _ ? u < d : u > d; _ ? u++ : u--) c.push((s[u - 1] + s[u]) * .5);
          else c = i;
          r = c.map(function(e) {
            return v(e)
          })
  ...
  for (var r7 = rJ, r9 = d.type, ie = d.clip_rgb, it = d.TWOPI, ir = Math.pow, ii = Math.sin, ia = Math.cos, io = y, is = function(e, t, n, r, i) {
      ...
      var s = function(s) {
        var l = it * ((e + 120) / 360 + t * s),
          ...
          d = ia(l),
          _ = ii(l);
        return io(ie([255 * (c + u * (-.14861 * d + 1.78277 * _)), 255 * (c + u * (-.29227 * d - .90649 * _)), 255 * (c + 1.97294 * d * u), 1]))
      };
    ...
    }, iS = E, iA = Math.sqrt, iN = Math.pow, iC = Math.min, iR = Math.max, iP = Math.atan2, iw = Math.abs, iD = Math.cos, iL = Math.sin, ix = Math.exp, ik = Math.PI, iM = function(e, t, n, r, i) {
