/** Chunk was on web.js **/ ! function(t, n) {
  ...
  var s = function(e) {
    ...
    m = function() {
      ...
      var r = _(e),
        i = !1;
      if (!r) {
        i = !0, g.sorted || (g.autodetect = g.autodetect.sort(function(e, t) {
          return t.p - e.p
        }), g.sorted = !0);
        for (var o = 0, a = g.autodetect; o < a.length; o += 1) {
          var s = a[o];
          if (r = s.test.apply(s, e)) break
        }
      }
      if (g.format[r]) {
        var l = g.format[r].apply(null, i ? e : e.slice(0, -1));
        n._rgb = p(l)
  ...
  var ep = d.unpack,
    ...
    eE = function() {
      ...
      if (0 === f) a = s = l = _;
        ...
        switch (h) {
          case 0:
            a = (e = [b, v, m])[0], s = e[1], l = e[2];
            break;
          case 1:
            a = (t = [E, b, m])[0], s = t[1], l = t[2];
            break;
          case 2:
            a = (n = [m, b, v])[0], s = n[1], l = n[2];
            break;
          case 3:
            a = (r = [m, E, b])[0], s = r[1], l = r[2];
            break;
          case 4:
            a = (i = [v, m, b])[0], s = i[1], l = i[2];
            break;
          case 5:
            a = (o = [b, m, E])[0], s = o[1], l = o[2]
        }
      }
  ...
  var e7 = d.unpack,
    ...
    tr = function() {
      ...
      if (_ *= 255, 0 === f) a = s = l = _;
        ...
        switch (p) {
          case 0:
            a = (e = [_, E, g])[0], s = e[1], l = e[2];
            break;
          case 1:
            a = (t = [m, _, g])[0], s = t[1], l = t[2];
            break;
          case 2:
            a = (n = [g, _, E])[0], s = n[1], l = n[2];
            break;
          case 3:
            a = (r = [g, m, _])[0], s = r[1], l = r[2];
            break;
          case 4:
            a = (i = [E, g, _])[0], s = i[1], l = i[2];
            break;
          case 5:
            a = (o = [_, g, m])[0], s = o[1], l = o[2]
        }
      }
      return [a, s, l, c.length > 3 ? c[3] : 1]
    },
  ...
  var ng = Math.log,
    nm = function(e) {
      var t, n, r, i = e / 100;
      return i < 66 ? (t = 255, n = i < 6 ? 0 : -155.25485562709179 - .44596950469579133 * (n = i - 2) + 104.49216199393888 * ng(n), r = i < 20 ? 0 : -254.76935184120902 + .8274096064007395 * (r = i - 10) + 115.67994401066147 * ng(r)) : (t = 351.97690566805693 + .114206453784165 * (t = i - 55) - 40.25366309332127 * ng(t), n = 325.4494125711974 + .07943456536662342 * (n = i - 50) - 28.0852963507957 * ng(n), r = 255), [t, n, r, 1]
    },
    nE = nm,
    nv = d.unpack,
    nb = Math.round,
  ...
  }, nS.format.temp = nS.format.kelvin = nS.format.temperature = nm;
  var nT = d.unpack,
    nN = Math.cbrt,
    nA = Math.pow,
    nC = Math.sign,
  ...
  var nD = d.unpack,
    ...
    nx = function() {
      ...
      var n = (e = nD(e, "lab"))[0],
        r = e[1],
        i = e[2],
        o = nw(n + .3963377774 * r + .2158037573 * i, 3),
        a = nw(n - .1055613458 * r - .0638541728 * i, 3),
  ...
  var rm = E,
    ...
    rb = function(e, t, n) {
      var r = e._rgb,
        ...
        c = s[1],
        u = s[2];
      return new rm(rE(rv(i, 2) * (1 - n) + rv(l, 2) * n), rE(rv(o, 2) * (1 - n) + rv(c, 2) * n), rE(rv(a, 2) * (1 - n) + rv(u, 2) * n), "rgb")
    };
  rr.lrgb = rb;
  var ry = E,
    rO = function(e, t, n) {
  ...
  var rk = E,
    rU = function(e, t, n) {
      var r = e.oklab(),
        i = t.oklab();
      return new rk(r[0] + n * (i[0] - r[0]), r[1] + n * (i[1] - r[1]), r[2] + n * (i[2] - r[2]), "oklab")
    };
  rr.oklab = rU;
  var rG = rI,
    rB = function(e, t, n) {
  ...
  var rF = E,
    ...
    rq = function(e, t, n) {
      ...
      for (var _ = 0; _ < a.length; _++)
        if ("h" === t.charAt(_)) {
          for (var p = rz(c / s[_], l / s[_]) / rW * 180; p < 0;) p += 360;
          for (; p >= 360;) p -= 360;
          a[_] = p
        } else a[_] = a[_] / s[_];
      return f /= r, new rF(a, t).alpha(f > .99999 ? 1 : f, !0)
    },
    rQ = function(e, t) {
      for (var n = e.length, r = [0, 0, 0, 0], i = 0; i < e.length; i++) {
        var o = e[i],
          a = t[i] / n,
          s = o._rgb;
        r[0] += rZ(s[0], 2) * a, r[1] += rZ(s[1], 2) * a, r[2] += rZ(s[2], 2) * a, r[3] += s[3] * a
      }
      return r[0] = rH(r[0]), r[1] = rH(r[1]), r[2] = rH(r[2]), r[3] > .9999999 && (r[3] = 1), new rF(rV(r))
    },
    rX = b,
    rJ = d.type,
    r$ = Math.pow,
          ...
          if (p && _[f]) i = _[f];
            ...
            if ("array" === rJ(l))
              for (var g = 0; g < o.length; g++) {
                var b = o[g];
                if (c <= b || c >= b && g === o.length - 1) {
                  i = l[g];
                  break
                }
                if (c > b && c < o[g + 1]) {
                  c = (c - b) / (o[g + 1] - b), i = rX.interpolate(l[g], l[g + 1], c, t);
                  break
                }
  ...
  for (var iu = r8, id = d.type, i_ = d.clip_rgb, ip = d.TWOPI, ih = Math.pow, ig = Math.sin, im = Math.cos, iE = b, iv = function(e, t, n, r, i) {
      void 0 === e && (e = 300), void 0 === t && (t = -1.5), void 0 === n && (n = 1), void 0 === r && (r = 1), void 0 === i && (i = [0, 1]);
      var o, a = 0;
      "array" === id(i) ? o = i[1] - i[0] : (o = 0, i = [i, i]);
      var s = function(s) {
        var l = ip * ((e + 120) / 360 + t * s),
          c = ih(i[0] + o * s, r),
          u = (0 !== a ? n[0] + s * a : n) * c * (1 - c) / 2,
          d = im(l),
          f = ig(l);
        return iE(i_([255 * (c + u * (-.14861 * d + 1.78277 * f)), 255 * (c + u * (-.29227 * d - .90649 * f)), 255 * (c + 1.97294 * d * u), 1]))
      };
      ...
      if ("c" === t.substr(0, 1) && (a.push(r), a.push(i)), "e" === t.substr(0, 1)) {
        ...
        for (y.push(i); v;) {
          ...
          for (var I = 0; I < g; I++)
            for (var T = o[I], N = Number.MAX_VALUE, A = void 0, C = 0; C < n; C++) {
              var R = iR(y[C] - T);
              R < N && (N = R, A = C), E[A]++, m[I] = A
            }
          for (var P = Array(n), D = 0; D < n; D++) P[D] = null;
          for (var w = 0; w < g; w++) null === P[h = m[w]] ? P[h] = o[w] : P[h] += o[w];
        ...
        for (var k = 0; k < g; k++) M[h = m[k]].push(o[k]);
      ...
      return a
    }, iw = iP, iL = iD, ix = E, iM = function(e, t) {
      e = new ix(e), t = new ix(t);
      var n = e.luminance(),
        r = t.luminance();
      return n > r ? (n + .05) / (r + .05) : (r + .05) / (n + .05)
    }, ij = E, ik = Math.sqrt, iU = Math.pow, iG = Math.min, iB = Math.max, iF = Math.atan2, iV = Math.abs, iZ = Math.cos, iH = Math.sin, iW = Math.exp, iY = Math.PI, iK = function(e, t, n, r, i) {
      ...
      var s = Array.from(e.lab()),
        ...
        p = d[2],
        h = (l + f) / 2,
        g = (ik(iU(c, 2) + iU(u, 2)) + ik(iU(_, 2) + iU(p, 2))) / 2,
        m = .5 * (1 - ik(iU(g, 7) / (iU(g, 7) + iU(25, 7)))),
        E = c * (1 + m),
        v = _ * (1 + m),
        b = ik(iU(E, 2) + iU(u, 2)),
        y = ik(iU(v, 2) + iU(p, 2)),
        ...
        T = S >= 0 ? S : S + 360,
        N = I >= 0 ? I : I + 360,
        A = iV(T - N) > 180 ? (T + N + 360) / 2 : (T + N) / 2,
        C = 1 - .17 * iZ(a(A - 30)) + .24 * iZ(a(2 * A)) + .32 * iZ(a(3 * A + 6)) - .2 * iZ(a(4 * A - 63)),
        R = N - T;
      R = 180 >= iV(R) ? R : N <= T ? R + 360 : R - 360, R = 2 * ik(b * y) * iH(a(R) / 2);
      var P = f - l,
        D = y - b,
        w = 1 + .015 * iU(h - 50, 2) / ik(20 + iU(h - 50, 2)),
        L = 1 + .045 * O,
        x = 1 + .015 * O * C,
        M = 30 * iW(-iU((A - 275) / 25, 2)),
        j = -(2 * ik(iU(O, 7) / (iU(O, 7) + iU(25, 7)))) * iH(2 * a(M));
      return iB(0, iG(100, ik(iU(P / (n * w), 2) + iU(D / (r * L), 2) + iU(R / (i * x), 2) + D / (r * L) * j * (R / (i * x)))))
  ...
  var i6 = i1,
    i5 = b;
  return i5.average = rq, i5.bezier = r5, i5.blend = iu, i5.cubehelix = iv, i5.mix = i5.interpolate = rs, i5.random = iI, i5.scale = r0, i5.analyze = iw, i5.contrast = iM, i5.deltaE = iK, i5.distance = iq, i5.limits = iL, i5.valid = iX, i5.scales = i0, i5.colors = t4, i5.brewer = i6, i5
})