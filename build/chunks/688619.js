/** Chunk was on web.js **/ ! function(t, n) {
  ...
  }, ek.format.hex = ew, ek.autodetect.push({
    p: 4,
    test: function(e) {
      for (var t = [], n = arguments.length - 1; n-- > 0;) t[n] = arguments[n + 1];
  ...
  var nw = d.unpack,
    ...
    nx = function() {
      ...
      return [255 * nk(4.0767416621 * o - 3.3077115913 * a + .2309699292 * s), 255 * nk(-1.2684380046 * o + 2.6097574011 * a - .3413193965 * s), 255 * nk(-.0041960863 * o - .7034186147 * a + 1.707614701 * s), e.length > 3 ? e[3] : 1]
    };
  ...
  rJ.normal = r$(r0(function(e) {
    return e
  })), rJ.multiply = r$(r0(r1)), rJ.screen = r$(r0(r4)), rJ.overlay = r$(r0(r5)), rJ.darken = r$(r0(r3)), rJ.lighten = r$(r0(r2)), rJ.dodge = r$(r0(r8)), rJ.burn = r$(r0(r6));
  for (var r7 = rJ, r9 = d.type, ie = d.clip_rgb, it = d.TWOPI, ir = Math.pow, ii = Math.sin, io = Math.cos, ia = y, is = function(e, t, n, r, i) {
    ...
    }, iT = E, iA = Math.sqrt, iN = Math.pow, iC = Math.min, iP = Math.max, iR = Math.atan2, iw = Math.abs, iD = Math.cos, iL = Math.sin, ix = Math.exp, ik = Math.PI, iM = function(e, t, n, r, i) {
