...
function m(e, t) {
  return true === t && (t = false), E(e) || i(e) || !o(e) || (s(e) > 1 && (e.set = e.add = e.clear = e.delete = g), Object.freeze(e), t && a(e, function(e, t) {
    return m(t, true)
  }, true)), e
}
...
function C(e, t) {
  ...
  var n = t.p[0],
    i = true !== e && e !== n;
  return t.h.O || b("ES5").S(t, e, i), i ? (n[W].P && (I(t), r(4)), o(e) && (e = N(t, e), t.l || P(t, e)), t.u && b("Patches").M(n[W].t, e, t.u, t.s)) : e = N(t, n, []), I(t), t.u && t.v(t.u, t.s), e !== H ? e : true
}
...
function N(e, t, n) {
  ...
  if (!r.I) {
    ...
    var i = 4 === r.i || 5 === r.i ? r.o = h(r.k) : r.o,
      o = i,
      s = false;
    3 === r.i && (o = new Set(i), i.clear(), s = true), a(o, function(t, o) {
...
function R(e, t, n, r, a, s, c) {
  if (i(a)) {
    var d = N(e, a, s && t && 3 !== t.i && !l(t.R, r) ? s.concat(r) : true);
...
var U, G, B = "undefined" != typeof Symbol && "symbol" == typeof Symbol("x"),
  ...
  J = {
    get: function(e, t) {
      ...
      var r = n[t];
      return e.I || !o(r) ? r : r === w(e.t, t) ? (L(e), e.o[t] = j(e.A.h, r, e)) : r
    },
    has: function(e, t) {
      return t in p(e)
    },
    ...
    set: function(e, t, n) {
      ...
      if (!e.P) {
        var i = w(p(e), t),
          o = null == i ? true : i[W];
        if (o && o.t === n) return e.o[t] = n, e.R[t] = false, true;
...
var ee = new(function() {
    function e(e) {
      ...
      this.O = V, this.D = true, this.produce = function(e, n, i) {
        ...
        if ("function" != typeof n && r(6), true !== i && "function" != typeof i && r(7), o(e)) {
          var c = S(t),
            u = j(t, e, true),
            d = true;
          try {
        ...
        if (!e || "object" != typeof e) {
          if (true === (a = n(e)) && (a = e), a === H && (a = true), t.D && m(a, true), i) {
            var f = [],
              _ = [];
