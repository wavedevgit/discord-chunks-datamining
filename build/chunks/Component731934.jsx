      ...
      children: [(0, Chunk951288.jsxs)("div", {
        children: [(0, Chunk951288.jsx)(Chunk481060.Heading, {
          ...
          children: (0, Chunk951288.jsx)(Chunk481060.y5t, {
            children: Chunk388032.intl.string(Chunk893102.default.pHEnV5)
          })
        }), (0, Chunk951288.jsx)(Chunk481060.Text, {
          variant: "text-sm/medium",
          color: "text-muted",
          className: Chunk10198.marginBottom20,
          children: Chunk388032.intl.string(Chunk893102.default["1J/gZ4"])
        })]
      }), (0, Chunk951288.jsx)("img", {
        className: Chunk153437.bannerArt,
        src: Chunk926895,
        alt: Chunk388032.intl.string(Chunk893102.default["r+PDmu"])
      })]
    }), (0, Chunk951288.jsxs)("div", {
      className: Chunk153437.steps,
      children: [(0, Chunk951288.jsx)(L, {
        header: Chunk388032.intl.string(Chunk893102.default["7xxAni"]),
        description: Chunk388032.intl.string(Chunk893102.default["1M9So2"]),
        stepNumber: 1
      }), (0, Chunk951288.jsx)(L, {
        header: Chunk388032.intl.string(Chunk893102.default["AXgx+a"]),
        description: Chunk388032.intl.string(Chunk893102.default.GzMFnb),
        stepNumber: 2
      }), (0, Chunk951288.jsx)(L, {
        header: Chunk388032.intl.string(Chunk893102.default.MZn1tG),
        description: Chunk388032.intl.string(Chunk893102.default["8rLBxD"]),
        stepNumber: 3
      })]
    })]
  })
  ...
  return (0, Chunk951288.jsxs)("div", {
    ...
    children: [(0, Chunk951288.jsxs)("div", {
      children: [(0, Chunk951288.jsx)(Chunk481060.Heading, {
        ...
        variant: "heading-xl/medium",
        children: (0, Chunk951288.jsx)(Chunk481060.y5t, {
          children: Chunk388032.intl.string(Chunk893102.default.zUCWEL)
        })
      }), (0, Chunk951288.jsx)(Chunk481060.Text, {
        variant: "text-sm/medium",
        color: "text-muted",
        className: Chunk10198.marginBottom20,
        children: Chunk388032.intl.format(Chunk893102.default.yMnoDl, {
...
let j = () => {
    let e = (0, Chunk880257.Z)(),
      ...
      a = (0, Chunk785681.o)(Chunk388032.intl.formatToPlainString(Chunk893102.default["+tnO34"], Chunk647438), Chunk388032.intl.formatToPlainString(Chunk893102.default["pu6/U0"], Chunk647438));
    return exports.length > 0 ? (0, Chunk951288.jsx)(k, {
      ...
      children: [(0, Chunk951288.jsx)(Chunk481060.Text, {
        ...
        children: (0, Chunk951288.jsx)(Chunk895328.Z, {
          text: Chunk388032.intl.string(Chunk893102.default.C4ScLD)
        })
      })]
    })
  },
  U = () => {
    let e = (0, Chunk631885.VM)(),
      ...
      n = (0, Chunk785681.o)(Chunk388032.intl.formatToPlainString(Chunk893102.default["1/PzIj"], {
        maxConnections: exports
      }), Chunk388032.intl.formatToPlainString(Chunk893102.default.RcTgiE, {
        maxConnections: exports
      }));
  ...
  G = () => {
    let e = (0, Chunk485664.o)(),
      ...
      n = (0, Chunk278074.EQ)({
        ...
        helpline: true
      }, () => Chunk388032.intl.format(Chunk893102.default["KOwsf/"], {
        helpLink: "https://support.discord.com/hc/articles/7925648993943-Crisis-Text-Line"
      })).with({
        throughline: true
      }, () => Chunk388032.intl.format(Chunk893102.default["6tsC8u"], {
    ...
    return null == require ? null : (0, Chunk951288.jsxs)("div", {
      ...
      children: [(0, Chunk951288.jsx)(Chunk481060.Heading, {
        ...
        children: (0, Chunk951288.jsx)(Chunk481060.y5t, {
          children: Chunk388032.intl.string(Chunk893102.default["7/tVhv"])
        })
      }), (0, Chunk951288.jsx)(Chunk481060.Text, {
  ...
  B = () => {
    let e = (0, Chunk631885.ov)(Chunk292352.ne.PENDING),
      t = (0, Chunk785681.o)(Chunk388032.intl.formatToPlainString(Chunk893102.default.IkAgkG, {
        count: module.length
      }), Chunk388032.intl.formatToPlainString(Chunk893102.default.Q8XnAa, {
        count: module.length
      }));
