...
let O = [Chunk981631.Z5c.ME, Chunk981631.Z5c.COLLECTIBLES_SHOP, Chunk981631.Z5c.NITRO_HOME],
  ...
  y = e => {
    ...
    return <d.G6 errorBoundarySource={"ORBS_DISCOVERY_ONBOARDING_COACHMARK"} targetElementRef={t} targetQuestId={c} renderDiscoveryButton={l} showingCoachmark={a} isGuildBarScrolling={o} onDiscoveryButtonClick={f} innerCoachmarkProps={g} />
  }