...
let g = new Chunk118356.Vy("ClipsSpeakingOverlay");
class j {
  getSoundboardKey(e, t) {
    return "".concat(e, ":").concat(t)
  }
  processSpeakingEvent(e) {
    !this.userSpeakingStates.has(e.userId) && 0 === e.speakingFlags && (this.userSpeakingStates.set(e.userId, true), this.timeline.has(0) || this.timeline.set(0, this.getCurrentSnapshot())), this.userSpeakingStates.set(e.userId, (e.speakingFlags & v.ME.VOICE) === v.ME.VOICE)
  }
...
function x(e) {
  ...
  let {
    ...
    useCurrentTime: v,
    subscribe: b
  } = (0, p.T)(), x = v(), y = null != (t = null == (l = r.decision) ? true : l.timestamp) ? t : 0, [C] = a.useState(() => {
    var e;
