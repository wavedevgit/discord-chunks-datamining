...
function g(e) {
  let {
    application: t
  } = e, n = null == t ? void 0 : t.getIconURL(160, c.$k ? "webp" : "png");
  return (0, r.jsx)("div", {
...
function E(e) {
  ...
  let {
    application: n,
    detectedGame: o
  } = e, a = i.useMemo(() => null == o ? void 0 : o.genres.map(u.P3).join(", "), [o]), l = null != (t = o.name) ? t : null == n ? void 0 : n.name;
  return (0, r.jsxs)("div", {
...
function y(e) {
  let {
    application: t
  } = e, n = i.useMemo(() => (0, d.fP)(), []), [o, a] = i.useState(!1), s = i.useMemo(() => o ? p.intl.string(p.t.tpvw4e) : p.intl.string(p.t["6EwEws"]), [o]);
  return (0, r.jsxs)("div", {
