...
function Y() {
  let e = [];
  return null != M && (j && e.push("foregrounded"), k !== O.hes.DISCONNECTED && k !== O.hes.RTC_DISCONNECTED && e.push("rtc_connected")), {
    active: e.length > 0,
    ver: T,
    reasons: e
  }
...
function ea() {
  ...
  }), _.Z.addChangeListener(et), d.default.addChangeListener(ee), s.Z.subscribe("WINDOW_FOCUS", en), s.Z.subscribe("APP_STATE_UPDATE", er), s.Z.subscribe("CONNECTION_OPEN", J), K(), z(), a.ZP.initialized.then(ei)
}
async function eo() {
  var e;
  ...
  return (() => {
    ...
    if (W() ? ((null == n || (0, b.qK)(n)) && (n = {
        ...
        lastUsedTimestamp: e,
        version: b.EI
      }, D = 0), n.lastUsedTimestamp = e, q(n)) : null != n && (0, b.qK)(n) && (n = null), x = {
        state: "loaded",
        session: n
      }, null != n && a !== n.uuid && t) {
      var o;
