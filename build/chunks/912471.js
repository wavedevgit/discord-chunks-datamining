...
function W() {
  ...
  }), d.Z.addChangeListener(n), c.default.addChangeListener(e), s.Z.subscribe("WINDOW_FOCUS", r), s.Z.subscribe("APP_STATE_UPDATE", i), s.Z.subscribe("LOGOUT", t), V(), o.ZP.initialized.then(x)
}
async function K() {
  let e = null;
  try {
