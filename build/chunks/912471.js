...
function X() {
  ...
  }), d.Z.addChangeListener(t), c.default.addChangeListener(e), s.Z.subscribe("WINDOW_FOCUS", n), s.Z.subscribe("APP_STATE_UPDATE", r), Y(), W(), a.ZP.initialized.then(M)
}
async function Q() {
  let e = null;
  try {
  ...
  return (() => {
    let t = Date.now();
    return H() ? ((null == e || (0, g.qK)(e)) && (e = {
      uuid: (0, r.Z)(),
      createdAtTimestamp: t,
      lastUsedTimestamp: t,
      version: g.EI
    }, P = 0), e.lastUsedTimestamp = t, K(e)) : null != e && (0, g.qK)(e) && (e = null), D = {
      state: "loaded",
      session: e
    }, e
  })()
