...
function K() {
  ...
  }), f.Z.addChangeListener(n), u.default.addChangeListener(e), l.Z.subscribe("WINDOW_FOCUS", r), l.Z.subscribe("APP_STATE_UPDATE", i), l.Z.subscribe("LOGOUT", t), Z(), o.ZP.initialized.then(k)
}
async function z() {
  let e = null;
  try {
  ...
  return (() => {
    let t = Date.now();
    return V() ? ((null == e || (0, E.qK)(e)) && (e = {
      uuid: (0, r.Z)(),
      createdAtTimestamp: t,
      lastUsedTimestamp: t,
      version: E.EI
    }, P = 0), e.lastUsedTimestamp = t, H(e)) : null != e && (0, E.qK)(e) && (e = null), w = {
      state: "loaded",
      session: e
    }, e
  })()
...
function q() {
  ...
  (null == n ? void 0 : n.client_heartbeat_session_id) !== t && (0, i.extendSuperProperties)({
    client_heartbeat_session_id: t
  })
}