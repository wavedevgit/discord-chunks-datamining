...
function P() {
  if (T || null != S && S !== b.hes.DISCONNECTED && S !== b.hes.RTC_DISCONNECTED) try {
    I()
  } catch (e) {
    f.Z.captureException(e)
  } else y && (y = !1, f.Z.addBreadcrumb({
    category: E,
...
function j() {
  ...
  }), u.ZP.addChangeListener(Z), l.Z.subscribe("WINDOW_FOCUS", x), l.Z.subscribe("APP_STATE_UPDATE", L), l.Z.subscribe("LOGIN_SUCCESS", A), P()
}
