...
function R(e) {
  ...
  } = e, u = r.useMemo(() => null != t.cooldownEndsAt ? new Date(t.cooldownEndsAt) : null, [t]), m = (0, E.tl)(t), p = (null == a ? void 0 : a.isPaused) === !0 || d, h = d ? I.intl.format(I.t.hshta2, {
...
function D(e) {
  (0, c.ZDy)(async () => t => (0, i.jsx)(p.default, P(A({}, t), {
    guildBoostSlot: e
  })))
}
