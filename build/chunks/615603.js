...
function A(e) {
  let {
    ...
    useReducedMotion: d,
    fractionalState: u
  } = e, p = r.useMemo(() => null != t.cooldownEndsAt ? new Date(t.cooldownEndsAt) : null, [t]), g = (0, _.tl)(t), h = (null == l ? void 0 : l.isPaused) === !0 && u === S.a$.NONE, f = T.intl.string(T.t.mOWsFx);
  return (0, i.jsxs)("li", {
  ...
  let t, n, s, {
    ...
    w = h && !Z,
    {
      ...
      let e = [],
        ...
        r = !0;
      return o.forEach(s => {
        !(0, _.tl)(s) && n++, s.isOnCooldown() ? i = !0 : r = !1, null != s.premiumGuildSubscription ? e.push(s) : t.push(s)
      }), {
