...
let w = function(e) {
  ...
  let {
    ...
    fractionalState: C
  } = (0, u.Z)(), S = (0, l.e7)([d.Z], () => d.Z.useReducedMotion), w = (0, l.e7)([b.default], () => b.default.getCurrentUser()), k = C === T.a$.FP_SUB_PAUSED, W = (0, N.y)("guild_boost_settings_unapplied", w, C), L = h && !k, {
    ...
    return e
  }, [K, S]), X = i.useMemo(() => M.find(e => e.isAvailable()), [M]);
