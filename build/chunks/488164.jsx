...
class _ extends Chunk73800.PureComponent {
  ...
  constructor(...e) {
    super(...e), c(this, "ref", i.createRef()), c(this, "renderItems", e => {
      ...
      return <s.DBG className={i} placeholder={n} value={new Set([a.value])} onChange={o} onClose={t} showScrollbar={true}>{e => this.renderItems(e)}</s.DBG>
    })
  }
}