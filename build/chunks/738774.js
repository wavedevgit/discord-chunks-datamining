...
function l(e) {
  ...
  let n = r.Z.getMonetizationRestrictionsFetchState(e),
    ...
    l = i.Z.getGuild(e);
  return n === r.M.FETCHED ? s(a) : null == (t = null == l ? void 0 : l.features.has(o.oNc.CREATOR_MONETIZABLE_RESTRICTED)) || t
}
...
function u(e) {
  ...
  let n = r.Z.getMonetizationRestrictionsFetchState(e),
    a = r.Z.getMonetizationRestrictions(e),
    s = i.Z.getGuild(e);
  return n === r.M.FETCHED ? c(a) : null == (t = null == s ? void 0 : s.features.has(o.oNc.CREATOR_MONETIZABLE_RESTRICTED)) || t
}
