...
function I(e) {
  return e.type === _.Ni.MESSAGE || e.type === _.Ni.SUMMARY || e.type === _.Ni.GENERATED_CANDIDATE || e.type === _.Ni.GUILD_EVENT
}
...
async function S(e, t, n) {
  ...
  let l = i.filter(e => null == r[e.id]),
    ...
    o = l.filter(e => e.type === _.Ni.SUMMARY).map(e => ({
      guild_id: e.data.guild_id,
      channel_id: e.data.channel_id,
      summary_id: e.data.summary_id
    })),
    c = l.filter(e => e.type === _.Ni.ACTIVITY).map(e => ({
      user_id: e.data.user_id,
      content_id: e.data.content_id
    })),
    u = l.filter(e => e.type === _.Ni.GENERATED_CANDIDATE).map(e => ({
      content_id: e.data.content_id,
      guild_id: e.data.guild_id,
      channel_id: e.data.channel_id
    }));
