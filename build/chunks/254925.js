  ...
  p = function() {
    ...
    let p = (0, e.e7)([o.Z], () => o.Z.getGuild()),
      y = (0, e.e7)([o.Z], () => o.Z.getGuildProfile()),
      {
        fetchGuildProfile: Z,
        fetchStatus: u
      } = (0, h.u)(null == p ? void 0 : p.id);
    if (t.useEffect(() => {
        u === C.a.NOT_FETCHED && Z()
      }, [Z, u]), u !== C.a.FETCHED) return (0, B.jsx)("div", {
          ...
          children: [(0, B.jsxs)("div", {
            ...
            children: [(0, B.jsx)(f.Text, {
              ...
              children: (0, B.jsx)(f.Text, {
                ...
                children: d.intl.format(P.default.CRbkIy, {
                  onClickEditSetting: () => D.Z.setSection(E.pNK.PROFILE, E.KsC.PROFILE_VISIBILITY)
                })
              })
            })]
          }), O ? (0, B.jsxs)("div", {
            ...
            children: [(0, B.jsx)("label", {
              ...
              onChange: () => {
                ...
                } else D.Z.updateGuildProfile(p.id, {
                  tag: null
                })
              }
            })]
