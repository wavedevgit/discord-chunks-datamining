  ...
  a = function() {
    ...
    let a = (0, w.e7)([t.Z], () => t.Z.getGuild()),
      i = (0, w.e7)([t.Z], () => t.Z.getGuildProfile()),
      {
        fetchGuildProfile: Y,
        fetchStatus: F
      } = (0, v.u)(null == a ? void 0 : a.id);
    if (Q.useEffect(() => {
        F === f.a.NOT_FETCHED && Y()
      }, [Y, F]), F !== f.a.FETCHED) return (0, C.jsx)("div", {
          ...
          children: [(0, C.jsxs)("div", {
            ...
            children: [(0, C.jsx)(D.Text, {
              ...
              children: (0, C.jsx)(D.Text, {
                ...
                children: c.intl.format(X.default.CRbkIy, {
                  onClickEditSetting: () => e.Z.setSection(M.pNK.PROFILE, M.KsC.PROFILE_VISIBILITY)
                })
              })
            })]
          }), N ? (0, C.jsxs)("div", {
            ...
            children: [(0, C.jsx)("label", {
              ...
              onChange: () => {
                ...
                } else e.Z.updateGuildProfile(a.id, {
                  tag: null
                })
              }
            })]
