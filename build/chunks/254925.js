  ...
  w = function() {
    ...
    let w = (0, s.e7)([y.Z], () => y.Z.getGuild()),
      I = (0, s.e7)([y.Z], () => y.Z.getGuildProfile()),
      {
        fetchGuildProfile: R,
        fetchStatus: _
      } = (0, f.u)(null == w ? void 0 : w.id);
    if (a.useEffect(() => {
        (0, c.EW)(l.z.GUILD_TAG_SERVER_SETTINGS_NEW_BADGE, {
          dismissAction: S.L.AUTO
        })
      }, []), a.useEffect(() => {
        _ === m.a.NOT_FETCHED && R()
      }, [R, _]), _ !== m.a.FETCHED) return (0, t.jsx)("div", {
          ...
          children: [(0, t.jsxs)("div", {
            ...
            children: [(0, t.jsx)(o.Text, {
              ...
              children: (0, t.jsx)(o.Text, {
                ...
                children: E.intl.format(T.default.CRbkIy, {
                  onClickEditSetting: () => x.Z.setSection(N.pNK.PROFILE, N.KsC.PROFILE_VISIBILITY)
                })
              })
            })]
          }), L ? (0, t.jsxs)("div", {
            ...
            children: [(0, t.jsx)("label", {
              ...
              onChange: () => {
                ...
                } else x.Z.updateGuildProfile(w.id, {
                  tag: null
                })
              }
            })]
