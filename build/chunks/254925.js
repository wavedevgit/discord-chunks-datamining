  ...
  O = function() {
    ...
    let O = (0, f.e7)([M.Z], () => M.Z.getGuild()),
      V = (0, f.e7)([M.Z], () => M.Z.getGuildProfile()),
      {
        fetchGuildProfile: j,
        fetchStatus: L
      } = (0, Q.u)(null == O ? void 0 : O.id);
    if (t.useEffect(() => {
        (0, n.EW)(r.z.GUILD_TAG_SERVER_SETTINGS_NEW_BADGE, {
          dismissAction: H.L.AUTO
        })
      }, []), t.useEffect(() => {
        L === w.a.NOT_FETCHED && j()
      }, [j, L]), L !== w.a.FETCHED) return (0, B.jsx)("div", {
          ...
          children: [(0, B.jsxs)("div", {
            ...
            children: [(0, B.jsx)(C.Text, {
              ...
              children: (0, B.jsx)(C.Text, {
                ...
                children: p.intl.format(b.default.CRbkIy, {
                  onClickEditSetting: () => i.Z.setSection(d.pNK.PROFILE, d.KsC.PROFILE_VISIBILITY)
                })
              })
            })]
          }), x ? (0, B.jsxs)("div", {
