  ...
  b = function() {
    ...
    let b = (0, e.e7)([D.Z], () => D.Z.getGuild()),
      p = (0, e.e7)([D.Z], () => D.Z.getGuildProfile()),
      {
        fetchGuildProfile: y,
        fetchStatus: Z
      } = (0, C.u)(null == b ? void 0 : b.id);
    if (t.useEffect(() => {
        Z === r.a.NOT_FETCHED && y()
      }, [y, Z]), Z !== r.a.FETCHED) return (0, B.jsx)("div", {
          ...
          children: [(0, B.jsxs)("div", {
            ...
            children: [(0, B.jsx)(f.Text, {
              ...
              children: (0, B.jsx)(f.Text, {
                ...
                children: P.intl.format(c.default.CRbkIy, {
                  onClickEditSetting: () => Q.Z.setSection(l.pNK.PROFILE, l.KsC.PROFILE_VISIBILITY)
                })
              })
            })]
          }), u ? (0, B.jsxs)("div", {
            ...
            children: [(0, B.jsx)("label", {
              ...
              onChange: () => {
                ...
                } else Q.Z.updateGuildProfile(b.id, {
                  tag: null
                })
              }
            })]
