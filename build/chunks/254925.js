  ...
  k = function() {
    ...
    let k = (0, s.e7)([x.Z], () => x.Z.getGuild()),
      _ = (0, s.e7)([x.Z], () => x.Z.getGuildProfile()),
      {
        fetchGuildProfile: w,
        fetchStatus: G
      } = (0, m.u)(null == k ? void 0 : k.id);
    if (i.useEffect(() => {
        (0, d.Q3)(l.z.GUILD_TAG_SERVER_SETTINGS_NEW_BADGE, {
          dismissAction: I.L.AUTO
        })
      }, []), i.useEffect(() => {
        G === u.a.NOT_FETCHED && w()
      }, [w, G]), G !== u.a.FETCHED) return (0, n.jsx)("div", {
          ...
          children: [(0, n.jsxs)("div", {
            ...
            children: [(0, n.jsx)(o.Text, {
              ...
              children: (0, n.jsx)(o.Text, {
                ...
                children: Z.intl.format(E.default.CRbkIy, {
                  onClickEditSetting: () => g.Z.setSection(S.pNK.PROFILE, S.KsC.PROFILE_VISIBILITY)
                })
              })
            })]
          }), L ? (0, n.jsxs)("div", {
            ...
            children: [(0, n.jsx)("label", {
              ...
              onChange: () => {
                ...
                } else g.Z.updateGuildProfile(k.id, {
                  tag: null
                })
              }
            })]
