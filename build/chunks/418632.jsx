...
function b(e) {
  return u.Z.verifyResend().then(() => {
    ...
    null != t && t.email && (n = t.email), (0, d.h7j)(e => <m.default{...f({
...
class x extends(i = Chunk73800.Component) {
  render() {
    ...
    return <Chunk755721.zx look={exports} size={require} color={module} disabled={this.state.isSendingVerificationEmail} onClick={this.handleResendVerification}>{Chunk388032.intl.string(Chunk388032.t.lm1UKi)}</Chunk755721.zx>
  }
  constructor(...e) {
