...
function _(e) {
  let {
    ...
    guildId: n,
    skuPricePreview: a
  } = e, i = (0, v.C)(t), l = (0, f.T4)(a.amount, a.currency), s = (0, o.e7)([h.Z], () => h.Z.getGuild(n));
...
function T(e) {
  ...
  let {
    ...
    guildId: s,
    skuPricePreview: u
  } = e, f = (0, o.e7)([p.Z], () => p.Z.getGuildProduct(l));
      ...
      children: (0, r.jsx)("div", {
        ...
        children: v ? (0, r.jsx)(m.$jN, {}) : (0, r.jsxs)(r.Fragment, {
          children: [(0, r.jsxs)("div", {
            ...
            variant: "text-md/normal",
            color: "text-normal",
            children: [C ? y.intl.string(y.t["A/RnkJ"]) + " " : "", null != Z ? y.intl.format(y.t.IeJDKi, {
              roleName: Z.name,
              emphasisHook: L
            }) : ""]
          }), (0, r.jsx)(m.LZC, {
