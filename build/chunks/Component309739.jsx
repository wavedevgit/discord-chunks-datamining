...
function g() {
  let e = Chunk695346.G6.useSetting(),
    ...
    s = [{
      ...
      name: Chunk388032.intl.string(Chunk512929.default["/sAeRY"])
    }, {
      value: Chunk524437.GI.ACTIVITY_STATUS_OFF,
      name: Chunk388032.intl.string(Chunk512929.default.m3oL7Q)
    }];
  return (0, Chunk54381.jsxs)(Chunk481060.C3N, {
    label: Chunk388032.intl.string(Chunk512929.default.TG0QsS),
    description: Chunk388032.intl.string(Chunk512929.default.OO17Lg),
    children: [(0, Chunk54381.jsx)(Chunk481060.FXm, {
      label: Chunk388032.intl.string(Chunk512929.default["/LHVbt"]),
      options: Chunk921801,
      value: exports,
      onChange: e => n(e)
      ...
      children: [(0, Chunk54381.jsxs)("div", {
        ...
        children: [(0, Chunk54381.jsx)(Chunk481060.Heading, {
          ...
          children: (0, Chunk54381.jsx)(Chunk481060.M14, {
            type: "warning",
            children: Chunk388032.intl.string(Chunk512929.default["xxI0/W"])
          })
        })]
...
function E() {
  ...
  return (0, Chunk54381.jsx)(Chunk921801.F, {
    ...
    children: (0, Chunk54381.jsxs)(Chunk481060.C3N, {
      label: Chunk388032.intl.string(Chunk512929.default["5rYBAQ"]),
      children: [(0, Chunk54381.jsx)(Chunk481060.rsf, {
        label: Chunk388032.intl.string(Chunk512929.default.khuuzv),
        description: Chunk388032.intl.string(Chunk512929.default["8EWsJ8"]),
        id: "allow-friends-to-join-my-game",
        checked: module,
        onChange: e => c.cP.updateSetting(e)
      }), (0, Chunk54381.jsx)(Chunk481060.rsf, {
        label: Chunk388032.intl.string(Chunk512929.default.Uz5Ipi),
        description: Chunk388032.intl.string(Chunk512929.default.CZI2Gb),
...
function b() {
  let e = Chunk695346.G6.useSetting(),
    t = Chunk358085.isPlatformEmbedded ? Chunk388032.intl.string(Chunk512929.default.UQ9RHJ) : Chunk388032.intl.string(Chunk388032.t.oKqC4t);
  return (0, Chunk54381.jsx)(Chunk921801.F, {
    setting: Chunk726985.s6.ACTIVITY_PRIVACY_STATUS,
    children: (0, Chunk54381.jsxs)(Chunk481060.Kqy, {
      gap: 32,
      children: [(0, Chunk54381.jsx)("div", {
        children: Chunk388032.intl.string(Chunk512929.default.t2YsrV)
      }), (0, Chunk54381.jsx)(Chunk481060.rsf, {
        label: Chunk388032.intl.string(Chunk512929.default.WhdCGP),
        description: exports,
