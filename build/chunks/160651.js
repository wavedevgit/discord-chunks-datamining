...
var s, o, l, h, m, c, p, u, d, g, f, v, b, y, x, w, k, S, M, z, A, T, B = /([A-Z])/g,
  C = {
    "&": "&amp;",
    ">": "&gt;",
    "<": "&lt;",
...
function er(e, t, r) {
  ...
  var a = e.charCodeAt(0),
    n = Q[t][a];
  if (!n && e[0] in et && (a = et[e[0]].charCodeAt(0), n = Q[t][a]), !n && "text" === r && j(a) && (n = Q[t][77]), n) return {
    depth: n[0],
    height: n[1],
    italic: n[2],
    skew: n[3],
...
class eo {
  ...
  havingBaseStyle(e) {
    ...
    return this.size === t && this.textSize === eo.BASESIZE && this.style === e ? this : this.extend({
      style: e,
      size: t
    })
  }
...
for (var e6 = "\xd0\xde\xfe", e7 = 0; e7 < e6.length; e7++) {
  var e3 = e6.charAt(e7);
...
var e8 = [
  ...
  te = function(e, t, r) {
    return eC[r][e] && eC[r][e].replace && (e = eC[r][e].replace), {
      value: e,
      metrics: er(e, t, r)
    }
  },
  ...
  tc = {
    ...
    makeOrd: function(e, t, r) {
      ...
      if (o) {
        if ("boldsymbol" === o) {
          var m, c, p = "textord" !== r && te(n, "Math-BoldItalic", a).metrics ? {
    ...
    staticSvg: function(e, t) {
      var [r, a, n] = tm[e], i = ti(["overlay"], [new eS([new eM(r)], {
        width: ep(a),
        height: ep(n),
        style: "width:" + ep(a),
...
var tk = function(e) {
  ...
  tq = function e(t, r, a, n, i) {
    ...
    for (var s = 0; s < t.length; s++) {
      ...
      h ? a.node = o : i && o.hasClass("newline") && (a.node = tM(["leftmost"])), a.insertAfter = (n = s, e => {
        t.splice(n + 1, 0, e), s++
      })
    }
    n && t.pop()
  ...
  t0 = {
    encloseSpan: function(e, t, r, a, n) {
      ...
      if (/fbox|color|angl/.test(t)) {
        ...
        var l = [];
        /^[bx]cancel$/.test(t) && l.push(new ez({
          x1: "0",
          y1: "0",
          x2: "100%",
          y2: "100%",
          "stroke-width": "0.046em"
        })), /^x?cancel$/.test(t) && l.push(new ez({
          x1: "0",
          y1: "100%",
          x2: "100%",
          y2: "0",
    ...
    svgSpan: function(e, t) {
      var {
        ...
        if (H.contains(["widehat", "widecheck", "widetilde", "utilde"], a)) {
          ...
          if (l > 5) "widehat" === a || "widecheck" === a ? (n = 420, r = 2364, s = .42, i = a + "4") : (n = 312, r = 2340, s = .34, i = "tilde4");
          else {
            var h = [1, 1, 2, 2, 3, 3][l];
            "widehat" === a || "widecheck" === a ? (r = [0, 1062, 2364, 2364, 2364][h], n = [0, 239, 300, 360, 420][h], s = [0, .24, .3, .3, .36, .42][h], i = a + h) : (r = [0, 600, 1033, 2339, 2340][h], n = [0, 260, 286, 306, 312][h], s = [0, .26, .286, .3, .306, .34][h], i = "tilde" + h)
          }
...
var t6 = (e, t) => {
    e && "supsub" === e.type ? (o = (l = t1(e.base, "accent")).base, e.base = o, h = function(e) {
      if (e instanceof eb) return e;
      throw Error("Expected span<HtmlDomNode> but got " + String(e) + ".")
    }(tO(e, t)), e.base = l) : o = (l = t1(e, "accent")).base;
    ...
    if (l.isStretchy) m = t0.svgSpan(l, t), m = tc.makeVList({
      ...
      "\\vec" === l.label ? (c = tc.staticSvg("vec", t), p = tc.svgData.vec[1]) : ((c = eA(c = tc.makeOrd({
        mode: l.mode,
        text: l.label
      }, t, "textord"))).italic = 0, p = c.width, i && (s += c.depth)), m = tc.makeSpan(["accent-body"], [c]);
      var o, l, h, m, c, p, u = "\\textcircled" === l.label;
      u && (m.classes.push("accent-full"), s = r.height);
      var d = n;
      u || (d -= p / 2), m.style.left = ep(d), "\\textcircled" === l.label && (m.style.top = ".2em"), m = tc.makeVList({
        positionType: "firstBaseline",
        children: [{
          type: "elem",
          elem: r
...
tx({
  ...
  htmlBuilder(e, t) {
    ...
    return a.classes.push("cd-label-" + e.side), a.style.bottom = ep(.8 - a.depth), a.height = 0, a.depth = 0, a
  },
  mathmlBuilder(e, t) {
  ...
  handler(e, t) {
    for (var r, {
        parser: a
      } = e, n = t1(t[0], "ordgroup").body, s = "", o = 0; o < n.length; o++) s += t1(n[o], "textord").text;
    var l = parseInt(s);
    if (isNaN(l)) throw new i("\\@char has non-numeric argument " + s);
    if (l < 0 || l >= 1114111) throw new i("\\@char with invalid code point " + s);
    return l <= 65535 ? r = String.fromCharCode(l) : (l -= 65536, r = String.fromCharCode((l >> 10) + 55296, (1023 & l) + 56320)), {
      type: "textord",
      mode: a.mode,
      text: r
    }
...
tx({
  ...
  handler(e, t) {
    var {
      parser: r
    } = e, a = t1(t[0], "color-token").color, n = t[1];
    return {
      type: "color",
      mode: r.mode,
      color: a,
...
tx({
  ...
  handler(e) {
    var {
      parser: t,
      funcName: r
    } = e, a = rh(t.gullet.popToken());
    t.gullet.consumeSpaces();
    var n = rm(t);
    return rc(t, a, n, "\\\\globallet" === r), {
      type: "internal",
      mode: t.mode
    }
  }
  ...
  handler(e) {
    var {
      parser: t,
      funcName: r
    } = e, a = rh(t.gullet.popToken()), n = t.gullet.popToken(), i = t.gullet.popToken();
    return rc(t, a, i, "\\\\globalfuture" === r), t.gullet.pushToken(i), t.gullet.pushToken(n), {
      type: "internal",
      mode: t.mode
    }
  }
...
var rp = function(e, t, r) {
  ...
  rb = function(e, t, r) {
    var a = Q["Size4-Regular"][e.charCodeAt(0)] ? Q["Size4-Regular"][e.charCodeAt(0)][4] : Q["Size1-Regular"][e.charCodeAt(0)][4],
      n = new eS([new eM("inner", _(e, Math.round(1e3 * t)))], {
        width: ep(a),
        height: ep(t),
        style: "width:" + ep(a),
    ...
    return i.height = t, i.style.height = ep(t), i.style.width = ep(a), {
      type: "elem",
      elem: i
    }
  },
  ...
  rk = function(e, t, r, a, n, i) {
    ...
    if (m.length > 0) {
      var B = Math.round(1e3 * M),
        C = K(m, Math.round(1e3 * (M - d - b))),
        q = new eM(m, C),
        N = (c / 1e3).toFixed(3) + "em",
      ...
      O.height = B / 1e3, O.style.width = N, O.style.height = I, T.push({
        type: "elem",
        elem: O
      })
    } else {
      if (T.push(rv(h, p, n)), T.push(ry), null === o) T.push(rb(l, M - d - b + .016, a));
      else {
        var E = (M - d - b - y) / 2 + .016;
  ...
  rR = {
    sqrtImage: function(e, t) {
      var r, a, n = t.havingBaseSizing(),
        ...
        h = 0,
        m = 0;
      return "small" === i.type ? (m = 1e3 + 1e3 * o + 80, e < 1 ? s = 1 : e < 1.4 && (s = .7), l = (1 + o + .08) / s, h = (1 + o) / s, (r = rS("sqrtMain", l, m, o, t)).style.minWidth = "0.853em", a = .833 / s) : "large" === i.type ? (m = 1080 * rT[i.size], h = (rT[i.size] + o) / s, l = (rT[i.size] + o + .08) / s, (r = rS("sqrtSize" + i.size, l, m, o, t)).style.minWidth = "1.02em", a = 1 / s) : (l = e + o + .08, h = e + o, (r = rS("sqrtTall", l, m = Math.floor(1e3 * e + o) + 80, o, t)).style.minWidth = "0.742em", a = 1.056), r.height = h, r.style.height = ep(l), {
        span: r,
        advanceWidth: a,
...
var rV = (e, t) => {
    var r, a, n = tc.wrapFragment(tO(e.body, t), t),
      i = e.label.slice(1),
      s = t.sizeMultiplier,
      o = 0,
      l = H.isCharacterBox(e.body);
    if ("sout" === i)(r = tc.makeSpan(["stretchy", "sout"])).height = t.fontMetrics().defaultRuleThickness / s, o = -.5 * t.fontMetrics().xHeight;
    else if ("phase" === i) {
      var h = ec({
          number: .6,
          unit: "pt"
      ...
      var d = 0,
        g = 0,
        f = 0;
      /box/.test(i) ? (f = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness), g = d = t.fontMetrics().fboxsep + ("colorbox" === i ? 0 : f)) : "angl" === i ? (d = 4 * (f = Math.max(t.fontMetrics().defaultRuleThickness, t.minRuleThickness)), g = Math.max(0, .25 - n.depth)) : g = d = .2 * !!l, r = t0.encloseSpan(n, i, d, g, t), /fbox|boxed|fcolorbox/.test(i) ? (r.style.borderStyle = "solid", r.style.borderWidth = ep(f)) : "angl" === i && .049 !== f && (r.style.borderTopWidth = ep(f), r.style.borderRightWidth = ep(f)), o = n.depth + g, e.backgroundColor && (r.style.backgroundColor = e.backgroundColor, e.borderColor && (r.style.borderColor = e.borderColor))
    }
    if (e.backgroundColor) a = tc.makeVList({
      positionType: "individualShift",
      children: [{
        type: "elem",
        elem: r,
...
tx({
  ...
  handler(e, t, r) {
    var {
      parser: a,
      funcName: n
    } = e, i = t1(t[0], "color-token").color, s = t[1];
    return {
      type: "enclose",
      mode: a.mode,
      label: n,
  ...
  handler(e, t, r) {
    var {
      parser: a,
      funcName: n
    } = e, i = t1(t[0], "color-token").color, s = t1(t[1], "color-token").color, o = t[2];
    return {
      type: "enclose",
      mode: a.mode,
      label: n,
...
var r_ = function(e, t) {
    var r, a, n, s, o = e.body.length,
      ...
      d = 5 * u;
    e.colSeparationType && "small" === e.colSeparationType && (d = .2778 * (t.havingStyle(Y.SCRIPT).sizeMultiplier / t.sizeMultiplier));
    var g = "CD" === e.colSeparationType ? ec({
        number: 3,
        unit: "ex"
      }, t) : 12 * u,
      f = 3 * u,
    ...
    if (e.tags && e.tags.some(e => e))
      for (r = 0; r < o; ++r) {
        var R = m[r],
          ...
          E = e.tags[r],
          L = void 0;
        (L = !0 === E ? tc.makeSpan(["eqn-num"], [], t) : !1 === E ? tc.makeSpan([], [], t) : tc.makeSpan([], tC(E, t, !0), t)).depth = R.depth, L.height = R.height, I.push({
          type: "elem",
          elem: L,
          shift: O
        })
    ...
    for (a = 0, s = 0; a < h || s < q.length; ++a, ++s) {
      ...
      if (!(a >= h)) {
        ...
        for (r = 0; r < o; ++r) {
          ...
          if (j) {
            var $ = W.pos - C;
            j.depth = W.depth, j.height = W.height, X.push({
              type: "elem",
              elem: j,
              shift: $
            })
        ...
        X = tc.makeVList({
          positionType: "individualShift",
          children: X
        }, t), X = tc.makeSpan(["col-align-" + (D.align || "c")], [X]), N.push(X), (a < h - 1 || e.hskipBeforeAndAfter) && 0 !== (U = H.deflt(D.postgap, d)) && ((n = tc.makeSpan(["arraycolsep"], [])).style.width = ep(U), N.push(n))
      }
    }
    if (m = tc.makeSpan(["mtable"], N), c.length > 0) {
      for (var _ = tc.makeLineSpan("hline", t, p), Z = tc.makeLineSpan("hdashline", t, p), K = [{
          type: "elem",
          elem: m,
          shift: 0
        }]; c.length > 0;) {
  ...
  rK = function(e, t) {
    ...
    var h = new tF.MathNode("mtable", r),
      m = .5 === e.arraystretch ? .1 : .16 + e.arraystretch - 1 + .09 * !!e.addJot;
...
var r4 = (e, t) => {
  ...
  r5 = (e, t) => {
    var r, a, n, i, s, o, l, h, m, c, p, u = r4(e.size, t.style),
      d = u.fracNum(),
      g = u.fracDen();
    r = t.havingStyle(d);
    ...
    if (e.hasBarLine ? (e.barSize ? (n = ec(e.barSize, t), a = tc.makeLineSpan("frac-line", t, n)) : a = tc.makeLineSpan("frac-line", t), n = a.height, i = a.height) : (a = null, n = 0, i = t.fontMetrics().defaultRuleThickness), u.size === Y.DISPLAY.size || "display" === e.size ? (s = t.fontMetrics().num1, o = n > 0 ? 3 * i : 7 * i, l = t.fontMetrics().denom1) : (n > 0 ? (s = t.fontMetrics().num2, o = i) : (s = t.fontMetrics().num3, o = 3 * i), l = t.fontMetrics().denom2), a) {
      ...
      k < o && (s += .5 * (o - k), l += .5 * (o - k)), h = tc.makeVList({
        positionType: "individualShift",
        children: [{
          type: "elem",
          elem: y,
...
tx({
  ...
  handler(e, t) {
    ...
    var p = "auto",
      u = t[3];
    return "ordgroup" === u.type ? u.body.length > 0 && (p = r7[Number(t1(u.body[0], "textord").text)]) : p = r7[Number((u = t1(u, "textord")).text)], {
      type: "genfrac",
      mode: a.mode,
      numer: n,
      denom: i,
  ...
  handler: (e, t) => {
    var {
      parser: r,
      funcName: a
    } = e, n = t[0], i = I(t1(t[1], "infix").size), s = t[2], o = i.number > 0;
    return {
      type: "genfrac",
      mode: r.mode,
      numer: n,
...
var r8 = (e, t) => {
  ...
  if (a.isOver ? (n = tc.makeVList({
    ...
    }, t)).children[0].children[0].children[1].classes.push("svg-align") : (n = tc.makeVList({
      positionType: "bottom",
...
var ae = (e, t, r, a, n, i, s) => {
    e = tc.makeSpan([], [e]);
    var o, l, h, m = r && H.isCharacterBox(r);
    if (t) {
...
tx({
  ...
  mathmlBuilder: (e, t) => {
    for (var r = tW(e.body, t.withFont("mathrm")), a = !0, n = 0; n < r.length; n++) {
      ...
      else if (i instanceof tF.MathNode) switch (i.type) {
        case "mi":
        case "mn":
        case "ms":
        case "mspace":
...
}), rU["\\operatorname"] = "\\@ifstar\\operatornamewithlimits\\operatorname@", tw({
  type: "ordgroup",
  ...
  htmlBuilder: (e, t) => {
    ...
    return r = tc.makeVList({
      positionType: "firstBaseline",
      children: [{
        type: "elem",
        elem: r
      }]
    }, t), tc.makeSpan(["mord"], [r], t)
  },
  mathmlBuilder: (e, t) => {
  ...
  handler(e, t, r) {
    var {
      parser: a
    } = e, n = r[0], i = t1(t[0], "size"), s = t1(t[1], "size");
    return {
      type: "rule",
      mode: a.mode,
...
tx({
  ...
  handler: (e, t, r) => {
    var {
      parser: a
    } = e, n = !1, i = !1, s = r[0] && t1(r[0], "ordgroup");
    if (s)
...
tw({
  type: "supsub",
  htmlBuilder(e, t) {
    var r, a, n, i, s = am(e, t);
    if (s) return s(e, t);
    var {
      base: o,
      sup: l,
      sub: h
    } = e, m = tO(o, t), c = t.fontMetrics(), p = 0, u = 0, d = o && H.isCharacterBox(o);
    if (l) {
    ...
    } else if (r) p = Math.max(p, n, r.depth + .25 * c.xHeight), i = tc.makeVList({
      positionType: "shift",
      positionData: -p,
      children: [{
        type: "elem",
...
class aM {
  constructor(e, t) {
    this.input = void 0, this.settings = void 0, this.tokenRegex = void 0, this.catcodes = void 0, this.input = e, this.settings = t, this.tokenRegex = RegExp(aS, "g"), this.catcodes = {
      "%": 14,
      "~": 13
    }
  }
...
}, rU["\\noexpand"] = s, o = function(e) {
  var t = e.popToken();
  return e.expandOnce(!0), {
    tokens: [t],
    numArgs: 0
  }
}, rU["\\expandafter"] = o, l = function(e) {
  return {
    tokens: e.consumeArgs(2)[0],
    numArgs: 0
  }
}, rU["\\@firstoftwo"] = l, h = function(e) {
  return {
    tokens: e.consumeArgs(2)[1],
    numArgs: 0
  }
}, rU["\\@secondoftwo"] = h, m = function(e) {
...
}, rU["\\@ifnextchar"] = m, rU["\\@ifstar"] = "\\@ifnextchar *{\\@firstoftwo{#1}}", c = function(e) {
...
class aH {
  ...
  _getExpansion(e) {
    ...
    if ("string" == typeof a) {
      ...
      for (var s = new aM(a, this.settings), o = [], l = s.lex();
...
class aD {
  ...
  parseSymbol() {
    ...
    if (s && ("i" === (t = t.substring(0, s.index)) ? t = "ı" : "j" === t && (t = "ȷ")), eC[this.mode][t]) {
      ...
      var o, l, h = eC[this.mode][t].group,
        m = a.range(e);
      ...
      this.settings.strict && (j(t.charCodeAt(0)) ? "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + t[0] + '" used in math mode', e) : this.settings.reportNonstrict("unknownSymbol", 'Unrecognized Unicode character "' + t[0] + '" (' + t.charCodeAt(0) + ")", e)), o = {
        type: "textord",
        mode: "text",
        loc: a.range(e),
        text: t
...
"undefined" != typeof document && "CSS1Compat" !== document.compatMode && ("undefined" != typeof console && console.warn("Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."), aP = function() {
