...
function g(e) {
  ...
  return <i.Fragment>{<p.C3>{y ? (0, i.jsx)(c.h, {
      ...
      })}</p.C3>}{!y && <p.O3><f.Z onBack={n} backText={h.intl.string(h.t.TQBY1N)} onPrimary={O} primaryCTA={f.g.CONTINUE} primaryText={h.intl.string(h.t["gZhF+/"])} /></p.O3>}</i.Fragment>
}