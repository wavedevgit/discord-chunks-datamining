...
function ef(e, t, n) {
  ...
  for (let e of s) {
    let t = el(e.id),
      ...
      o = P.A.getGuild(i);
    if (F.has(i) && V.has(t) || null == n || null == o || n.id === o.afkChannelId) null == n && (r = null, U = true);
    else {
      ...
      u.filter(e => !d.includes(e.id)).forEach(e => s.push(e)), U ? F.has(i) || (r = null) : (r = o, U = true), F.add(i), V.add(t), G.push({
        channel: n,
        guild: o,
        members: u,
        voiceStates: e
