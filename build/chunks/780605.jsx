...
function A(e) {
  ...
  let J = null != y;
  null != I && (t = <I color={"currentColor"} style={Q()} size={S[q]} className={g.icon} />);
  let $ = i.useRef(null),
    ee = null != W ? W : $,
    et = "expressive" === d,
    en = i.useContext(l.S),
  ...
  let eo = <div className={a()(g.buttonChildren, {
        [g.loading]: D
      })}>{null != t && "start" === A && t}{J && <f.x tag={"span"} variant={T[q]} color={"none"} lineClamp={1}>{y}</f.x>}{null != t && "end" === A && t}</div>,
    ea = V || D,
    es = <c.t{...O(b({}, w), {
  ...
  return et ? <div className={a()(g.expressiveWrapper, {
      [g.fullWidth]: X
    })}>{es}</div> : es
}
...
function N(e) {
  ...
  }), [n]), <div className={g.buttonChildrenWrapper}>{t}{l && <div className={a()(g.spinnerWrapper, {
        [g.fadeIn]: n,
        [g.fadeOut]: !n
      })}><d.$ type={d.R.PULSING_ELLIPSIS} className={a()(g.spinner, g["spinner-".concat(o)])} itemClassName={g.spinnerItem} /></div>}</div>
}
...
function C(e) {
  ...
  }, [t, n]), <r.Fragment>{<u.GlowButtonRive className={a()(g.expressiveRive, g.expressiveBackground)} eventTargetRef={n} fit={"layout"} artboard={"BaseGlowRemapped"} ref={s} withReducedMotion={"short-loop"} />}{!t && <u.GlowButtonRive className={a()(g.expressiveRive, g.expressiveHoverContainer)} fit={"layout"} artboard={o ? "HoverLightmode" : "HoverDarkmode"} />}{<div className={a()(g.expressiveRive, g.expressiveFill)} />}</r.Fragment>
}