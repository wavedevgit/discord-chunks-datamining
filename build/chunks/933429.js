...
let eh = {
    [eA.kVF.DOWNLOAD_NAG]: c.z.NAGBAR_NOTICE_DOWNLOAD,
    [eA.kVF.CONNECT_SPOTIFY]: c.z.NAGBAR_NOTICE_CONNECT_SPOTIFY,
    [eA.kVF.CONNECT_PLAYSTATION]: c.z.NAGBAR_NOTICE_CONNECT_PLAYSTATION,
    [eA.kVF.MFA_SMS_BACKUP]: c.z.NAGBAR_NOTICE_MFA_SMS_BACKUP,
    [eA.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: c.z.NAGBAR_NOTICE_PREMIUM_TIER_TWO_TRIAL_ENDING,
    [eA.kVF.PREMIUM_REACTIVATE]: c.z.NAGBAR_NOTICE_PREMIUM_REACTIVATE,
    [eA.kVF.BOUNCED_EMAIL_DETECTED]: c.z.NAGBAR_BOUNCED_EMAIL_NOTICE,
    [eA.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: c.z.NAGBAR_ACTIVATE_SERVER_SUBSCRIPTION,
    [eA.kVF.PREMIUM_TIER_0_TRIAL_ENDING]: c.z.NAGBAR_NOTICE_PREMIUM_TIER_0_TRIAL_ENDING,
    [eA.kVF.POMELO_ELIGIBLE]: c.z.NAGBAR_NOTICE_POMELO,
    [eA.kVF.CHECKOUT_RECOVERY_NAGBAR]: c.z.CHECKOUT_RECOVERY_NAGBAR,
    [eA.kVF.REPORT_TO_MOD_SURVEY]: c.z.REPORT_TO_MOD_SURVEY_NOTICE
  },
  eU = {
    [eA.kVF.GIFTING_PROMOTION_REMINDER]: c.z.GIFTING_PROMOTION_REMINDER
  },
  eM = {
    [eA.kVF.OUTBOUND_PROMOTION]: c.z.THIRD_PARTY_OUTBOUND_PROMO_NAGBAR
  },
  ev = {
...
function ew(e, t, n) {
  if (null == e) return;
  let r = ev[e];
  (null == r || t || s.K.set(r, !0), eZ.has(e) && (ej[e] = !0), null != n && null != r) ? s.K.set(eF(e), n.format("YYYY-MM-DDTHH:mm:ss.SSSZ")): s.K.remove(eF(e))
}
  ...
  eW = {
    [eA.kVF.GIFTING_PROMOTION_REMINDER]: {
      predicate: () => {
        ...
        return e && t && (0, T.H4)(c.z.GIFTING_PROMOTION_DESKTOP_FIRST_TIME_COACHMARK).isDismissed && !eV(eA.kVF.GIFTING_PROMOTION_REMINDER)
      }
    },
    [eA.kVF.GUILD_RAID_NOTIFICATION]: {
      predicate: () => (0, R.g)().show && !eV(eA.kVF.GUILD_RAID_NOTIFICATION),
      metadata: () => ({
    ...
    [eA.kVF.SPOTIFY_AUTO_PAUSED]: {
      predicate: () => G.Z.wasAutoPaused()
    },
    [eA.kVF.BLOCKED_BY_PROXY]: {
      predicate: () => !eV(eA.kVF.BLOCKED_BY_PROXY) && k.Z.blockedByProxy && L.Z.getCurrentConfig({
    ...
    [eA.kVF.PENDING_MEMBER]: {
      predicate: e => {
        ...
        return null != (r = null != i && null != l && !(null == (t = $.Z.getGuild(i)) ? void 0 : t.features.has(eA.oNc.GUILD_ONBOARDING)) && (null == (n = J.ZP.getMember(i, l.id)) ? void 0 : n.isPending)) && r
      }
    },
    ...
    [eA.kVF.CORRUPT_INSTALLATION]: {
      predicate: () => eS.isPlatformEmbedded && (!a.Z.supported() || eg.Z.isCorruptInstallation())
    },
    ...
    [eA.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK]: {
      predicate: e => {
        ...
        return eN.ZP.canRedeemPremiumPerks(t) && Q.Z.getDetectedOffPlatformPremiumPerks().length > 0
      },
      metadata: () => Q.Z.getDetectedOffPlatformPremiumPerks()[0]
    },
    [eA.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL]: {
      predicate: () => !eV(eA.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL) && Q.Z.getDetectedOffPlatformPremiumPerks().length > 0,
      metadata: () => Q.Z.getDetectedOffPlatformPremiumPerks()[0]
    },
    ...
    [eA.kVF.DOWNLOAD_NAG]: {
      predicate: () => !eS.isPlatformEmbedded && !eV(eA.kVF.DOWNLOAD_NAG)
    },
    ...
    [eA.kVF.CONNECT_SPOTIFY]: {
      predicate: () => !G.Z.hasConnectedAccount() && m.ZP.isObservedAppRunning(_.Z.get(eA.ABu.SPOTIFY).name) && !eV(eA.kVF.CONNECT_SPOTIFY)
    },
    ...
    [eA.kVF.CONNECT_PLAYSTATION]: {
      predicate: () => X.Z.isSuggestedAccountType(eA.ABu.PLAYSTATION) && null == X.Z.getAccount(null, eA.ABu.PLAYSTATION) && !eV(eA.kVF.CONNECT_PLAYSTATION)
    },
    [eA.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: {
      predicate: () => eI.Z.getAlmostExpiringTrialOffers([eP.Si.TIER_2]).length > 0 && !eV(eA.kVF.PREMIUM_TIER_2_TRIAL_ENDING)
    },
    [eA.kVF.PREMIUM_TIER_0_TRIAL_ENDING]: {
      predicate: () => eI.Z.getAlmostExpiringTrialOffers([eP.Si.TIER_0]).length > 0 && !eV(eA.kVF.PREMIUM_TIER_0_TRIAL_ENDING)
    },
    [eA.kVF.PREMIUM_UNCANCEL]: {
      predicate: e => {
        let {
          ...
          currentUser: n
        } = e, r = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = (null == t ? void 0 : t.canceledAt) != null && (null == t ? void 0 : t.status) === eA.O0b.CANCELED && 1 >= l()().diff(l()(t.canceledAt), "days"), o = null != t && l()(t.currentPeriodEnd).isBefore(l()()), a = null != t && t.status === eA.O0b.CANCELED && !o && r <= 7 && r >= 0 && (0, eN.M5)(n, eP.p9.TIER_2) && !i && !n.hasFreePremium() && !t.isPurchasedExternally;
        return !eV(eA.kVF.PREMIUM_UNCANCEL) && a
      },
      metadata: e => {
        var t;
        let {
          premiumSubscription: n
        } = e, r = null != n ? l()(n.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = null != n ? null == (t = (0, eN.Af)(n)) ? void 0 : t.planId : null;
        return {
          daysLeft: r,
    ...
    [eA.kVF.PREMIUM_MISSING_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = null != t ? l()(t.currentPeriodEnd).diff(l()(t.currentPeriodStart).startOf("day"), "days") : 0, o = null != t && l()(t.currentPeriodEnd).isBefore(l()()), a = ep.Z.applicationIdsFetched.has(eP.CL), c = ep.Z.getForApplication(eP.CL), s = null != t ? (0, eN.Af)(t) : null, u = null != s ? eN.ZP.getSkuIdForPlan(s.planId) : null, d = null != c && null != s && Array.from(c).filter(e => {
          let {
            skuId: t,
            consumed: n
          } = e;
          return !n && t === u
        }).length > 0, _ = null != t && r <= (i > 14 ? 7 : 2) && r >= 0 && t.status !== eA.O0b.PAST_DUE && !o && a && !d && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eA.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && null != t.paymentSourceId ? eE.Z.getPaymentSource(t.paymentSourceId) : null, i = null != t && l()(t.currentPeriodEnd).isBefore(l()()), o = null != t && t.status === eA.O0b.PAST_DUE && !i && null != r && r.invalid && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eA.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && l()(t.currentPeriodEnd).isBefore(l()()), i = null != t && t.status === eA.O0b.PAST_DUE && !r && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
        return !eV(eA.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT) && i
      },
      metadata: e => {
        let {
          premiumSubscription: t
    ...
    [eA.kVF.PREMIUM_REACTIVATE]: {
      predicate: () => !eV(eA.kVF.PREMIUM_REACTIVATE) && v.Z.shouldShowReactivateNotice()
    },
    [eA.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && l()(t.currentPeriodEnd).isBefore(l()()), i = null != t && null != t.paymentSourceId ? eE.Z.getPaymentSource(t.paymentSourceId) : null, o = null != i && ey.Uk.has(i.type), a = null != t && t.status === eA.O0b.PAST_DUE && !r && o && !n.hasFreePremium() && !t.isPurchasedExternally;
        return !eV(eA.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT) && a
      },
      metadata: e => {
        let {
          premiumSubscription: t
    ...
    [eA.kVF.POMELO_ELIGIBLE]: {
      predicate: () => (0, h.e)() && !eV(eA.kVF.POMELO_ELIGIBLE)
    },
    [eA.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
      predicate: e => {
        ...
        return null != t && null != y.Z.getMentionRaidDetected(t) && (null == n ? void 0 : n.features.has(eA.oNc.COMMUNITY)) && !eV(eA.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION) || !1
      },
      metadata: e => {
        let {
          selectedGuildId: t
    ...
    [eA.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: {
      predicate: () => !eV(eA.kVF.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== I.Z.getEligibleGuildsForNagActivate().length && (0, O.Lm)()
    },
    ...
    [eA.kVF.QUESTS_PROGRESS_INTERRUPTION]: {
      ...
      metadata: () => {
        let e = H.Z.getCurrentUserActiveStream();
        return {
          streamKey: null != e ? (0, A.V9)(e) : null
        }
      }
    },
    [eA.kVF.CHECKOUT_RECOVERY_NAGBAR]: {
      predicate: e => {
        ...
        let {
          currentUser: n
        } = e, r = null != (t = eE.Z.paymentSources) ? t : {};
        return U.Z.getIsTargeted() && !(0, eN.I5)(n) && 0 !== Object.keys(r).length
      }
    },
    [eA.kVF.BLOCK_USER_FEEDBACK_NAGBAR]: {
      predicate: () => !eV(eA.kVF.BLOCK_USER_FEEDBACK_NAGBAR) && V.L0(),
      metadata: () => ({
...
function eH() {
  ...
  let i = eO.Z.getPremiumSubscription(),
    ...
    a = null != o ? e_.Z.getVoiceStateForChannel(o) : null;
  for (let n of eR.a ? eB : eG)
    ...
    (null == (n = ex.metadata) ? void 0 : n.sampleRate) != null && null == eL[ex.type] && (eL[ex.type] = Math.random() <= ex.metadata.sampleRate);
    let e = !1 === eL[ex.type];
...
function ez() {
  return ec.Z.enabled || delete ej[eA.kVF.STREAMER_MODE], eH()
}
class eY extends(r = o.ZP.Store) {
  initialize() {
    this.syncWith([es.Z, er.Z, Q.Z, eo.Z, j.Z, eI.Z, Y.Z, X.Z, W.Z, P.Z, x.Z, H.Z], eH), this.waitFor(ed.default, ea.Z, $.Z, J.ZP, ei.Z, ee.Z, ec.Z, f.Z, eo.Z, eu.Z, G.Z, m.ZP, er.Z, ef.Z, em.Z, eT.Z, et.Z, eO.Z, eg.Z, Q.Z, eE.Z, en.Z, j.Z, ep.Z, eI.Z, X.Z, D.Z, I.Z, k.Z, x.Z, H.Z)
  }
  hasNotice() {
...
let eK = new eY(u.Z, {
  ...
  DISPATCH_APPLICATION_ERROR: function() {
    return delete ej[eA.kVF.DISPATCH_ERROR], eH()
  },
  DISPATCH_APPLICATION_LAUNCH_SETUP_START: function() {
    return delete ej[eA.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS], eH()
  },
  ...
  NOTICE_DISMISS: function(e) {
    return null != ex && (null == e.id || e.id === ex.id) && (ew(ex.type, e.isTemporary, e.untilAtLeast), eH())
  },
