...
let eU = {
  ...
  eb = {
    [eC.kVF.GIFTING_PROMOTION_REMINDER]: s.z.GIFTING_PROMOTION_REMINDER
  },
  eM = {
    [eC.kVF.OUTBOUND_PROMOTION]: s.z.THIRD_PARTY_OUTBOUND_PROMO_NAGBAR
  },
  ek = {
  ...
  eZ = new Set([eC.kVF.NO_INPUT_DETECTED, eC.kVF.NO_INPUT_DEVICES_DETECTED, eC.kVF.STREAMER_MODE, eC.kVF.VIDEO_UNSUPPORTED_BROWSER, eC.kVF.SPOTIFY_AUTO_PAUSED, eC.kVF.DISPATCH_ERROR, eC.kVF.DISPATCH_ERROR, eC.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS, eC.kVF.BLOCKED_BY_PROXY]),
  ej = {},
  ev = {},
  eL = Object.freeze({
    id: null,
...
function eV(e, t, n) {
  if (null == e) return;
  let r = ek[e];
  (null == r || t || c.K.set(r, !0), eZ.has(e) && (ej[e] = !0), null != n && null != r) ? c.K.set(ex(e), n.format("YYYY-MM-DDTHH:mm:ss.SSSZ")): c.K.remove(ex(e))
}
  ...
  ez = {
    [eC.kVF.GIFTING_PROMOTION_REMINDER]: {
      predicate: () => {
        ...
        return e && t && (0, T.H4)(s.z.GIFTING_PROMOTION_DESKTOP_FIRST_TIME_COACHMARK).isDismissed && !eG(eC.kVF.GIFTING_PROMOTION_REMINDER)
      }
    },
    [eC.kVF.GUILD_RAID_NOTIFICATION]: {
      predicate: () => (0, C.g)().show && !eG(eC.kVF.GUILD_RAID_NOTIFICATION),
      metadata: () => ({
    ...
    [eC.kVF.LURKING_GUILD]: {
      predicate: e => {
        ...
        return null != t && g.Z.isLurking(t)
      }
    },
    [eC.kVF.VOICE_DISABLED]: {
      predicate: () => null != er.Z.getRemoteDisconnectVoiceChannelId()
    },
    ...
    [eC.kVF.H264_DISABLED]: {
      predicate: e => {
        let {
          voiceChannelId: t
        } = e, n = K.Z.getChannel(t);
        return !$.Z.getOpenH264() && null != t && eE.Z.hasVideo(t) && null != n && n.isGuildStageVoice()
      }
    },
    ...
    [eC.kVF.BLOCKED_BY_PROXY]: {
      predicate: () => !eG(eC.kVF.BLOCKED_BY_PROXY) && v.Z.blockedByProxy && j.Z.getCurrentConfig({
    ...
    [eC.kVF.PENDING_MEMBER]: {
      predicate: e => {
        ...
        return null != (r = null != i && null != l && !(null == (t = Q.Z.getGuild(i)) ? void 0 : t.hasFeature(eC.oNc.GUILD_ONBOARDING)) && (null == (n = J.ZP.getMember(i, l.id)) ? void 0 : n.isPending)) && r
      }
    },
    ...
    [eC.kVF.CORRUPT_INSTALLATION]: {
      predicate: () => eS.isPlatformEmbedded && (!a.Z.supported() || eP.Z.isCorruptInstallation())
    },
    [eC.kVF.VIDEO_UNSUPPORTED_BROWSER]: {
      predicate: e => {
        ...
        return null != t && eE.Z.hasVideo(t) && !$.Z.supports(eg.AN.VIDEO) && !eG(eC.kVF.VIDEO_UNSUPPORTED_BROWSER)
      }
    },
    ...
    [eC.kVF.DOWNLOAD_NAG]: {
      predicate: () => !eS.isPlatformEmbedded && !eG(eC.kVF.DOWNLOAD_NAG)
    },
    ...
    [eC.kVF.CONNECT_SPOTIFY]: {
      predicate: () => !G.Z.hasConnectedAccount() && R.ZP.isObservedAppRunning(d.Z.get(eC.ABu.SPOTIFY).name) && !eG(eC.kVF.CONNECT_SPOTIFY)
    },
    ...
    [eC.kVF.CONNECT_PLAYSTATION]: {
      predicate: () => X.Z.isSuggestedAccountType(eC.ABu.PLAYSTATION) && null == X.Z.getAccount(null, eC.ABu.PLAYSTATION) && !eG(eC.kVF.CONNECT_PLAYSTATION)
    },
    [eC.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: {
      predicate: () => eI.Z.getAlmostExpiringTrialOffers([ef.Si.TIER_2]).length > 0 && !eG(eC.kVF.PREMIUM_TIER_2_TRIAL_ENDING)
    },
    [eC.kVF.PREMIUM_TIER_0_TRIAL_ENDING]: {
      predicate: () => eI.Z.getAlmostExpiringTrialOffers([ef.Si.TIER_0]).length > 0 && !eG(eC.kVF.PREMIUM_TIER_0_TRIAL_ENDING)
    },
    [eC.kVF.PREMIUM_UNCANCEL]: {
      predicate: e => {
        let {
          ...
          currentUser: n
        } = e, r = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = (null == t ? void 0 : t.canceledAt) != null && (null == t ? void 0 : t.status) === eC.O0b.CANCELED && 1 >= l()().diff(l()(t.canceledAt), "days"), o = null != t && l()(t.currentPeriodEnd).isBefore(l()()), a = null != t && t.status === eC.O0b.CANCELED && !o && r <= 7 && r >= 0 && (0, ep.M5)(n, ef.p9.TIER_2) && !i && !n.hasFreePremium() && !t.isPurchasedExternally;
        return !eG(eC.kVF.PREMIUM_UNCANCEL) && a
      },
      metadata: e => {
        var t;
        let {
    ...
    [eC.kVF.PREMIUM_MISSING_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = null != t ? l()(t.currentPeriodEnd).diff(l()(t.currentPeriodStart).startOf("day"), "days") : 0, o = null != t && l()(t.currentPeriodEnd).isBefore(l()()), a = eT.Z.applicationIdsFetched.has(ef.CL), s = eT.Z.getForApplication(ef.CL), c = null != t ? (0, ep.Af)(t) : null, u = null != c ? ep.ZP.getSkuIdForPlan(c.planId) : null, E = null != s && null != c && Array.from(s).filter(e => {
          let {
            skuId: t,
            consumed: n
          } = e;
          return !n && t === u
        }).length > 0, d = null != t && r <= (i > 14 ? 7 : 2) && r >= 0 && t.status !== eC.O0b.PAST_DUE && !o && a && !E && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
        return !eG(eC.kVF.PREMIUM_MISSING_PAYMENT) && d
      },
      metadata: e => {
        var t;
        let {
    ...
    [eC.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && null != t.paymentSourceId ? e_.Z.getPaymentSource(t.paymentSourceId) : null, i = null != t && l()(t.currentPeriodEnd).isBefore(l()()), o = null != t && t.status === eC.O0b.PAST_DUE && !i && null != r && r.invalid && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eC.kVF.PREMIUM_REACTIVATE]: {
      predicate: () => !eG(eC.kVF.PREMIUM_REACTIVATE) && M.Z.shouldShowReactivateNotice()
    },
    ...
    [eC.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && l()(t.currentPeriodEnd).isBefore(l()()), i = null != t && null != t.paymentSourceId ? e_.Z.getPaymentSource(t.paymentSourceId) : null, o = null != i && ey.Uk.has(i.type), a = null != t && t.status === eC.O0b.PAST_DUE && !r && o && !n.hasFreePremium() && !t.isPurchasedExternally;
        return !eG(eC.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT) && a
      },
      metadata: e => {
        let {
          premiumSubscription: t
    ...
    [eC.kVF.POMELO_ELIGIBLE]: {
      predicate: () => (0, h.e)() && !eG(eC.kVF.POMELO_ELIGIBLE)
    },
    [eC.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
      predicate: e => {
        let {
          selectedGuildId: t
        } = e, n = null != t ? Q.Z.getGuild(t) : null;
        return null != t && null != m.Z.getMentionRaidDetected(t) && (null == n ? void 0 : n.hasFeature(eC.oNc.COMMUNITY)) && !eG(eC.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION) || !1
      },
      metadata: e => {
        let {
          selectedGuildId: t
    ...
    [eC.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: {
      predicate: () => !eG(eC.kVF.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== I.Z.getEligibleGuildsForNagActivate().length && (0, O.Lm)()
    },
    ...
    [eC.kVF.QUESTS_PROGRESS_INTERRUPTION]: {
      predicate: () => {
        ...
        if (null == e) return !1;
        let t = (0, P.V9)(e),
          n = L.Z.getStreamHeartbeatFailure(t);
    ...
    [eC.kVF.CHECKOUT_RECOVERY_NAGBAR]: {
      predicate: e => {
        ...
        return U.Z.getIsTargeted() && !(0, ep.I5)(n) && 0 !== Object.keys(r).length
      }
    },
    [eC.kVF.BLOCK_USER_FEEDBACK_NAGBAR]: {
      predicate: () => !eG(eC.kVF.BLOCK_USER_FEEDBACK_NAGBAR) && V.L0(),
      metadata: () => ({
...
function eW() {
  ...
  let i = eO.ZP.getPremiumSubscription(),
    l = ed.Z.isLocalizedPromoEnabled,
    o = el.Z.getGuildId(),
  ...
  for (let n of eD.a ? eB : ew)
    if (null != ez[n] && ez[n].predicate({
      ...
      let l = null == (e = (t = ez[n]).metadata) ? void 0 : e.call(t, {
        currentUser: r,
        premiumSubscription: i,
        selectedGuildId: o
      });
    ...
    (null == (n = eF.metadata) ? void 0 : n.sampleRate) != null && null == ev[eF.type] && (ev[eF.type] = Math.random() <= eF.metadata.sampleRate);
    let e = !1 === ev[eF.type];
...
function eY() {
  return ea.Z.enabled || delete ej[eC.kVF.STREAMER_MODE], eW()
}
class eH extends(r = o.ZP.Store) {
  initialize() {
    this.syncWith([es.Z, en.Z, q.Z, el.Z, Z.Z, eI.Z, Y.Z, X.Z, B.Z, D.Z, L.Z, z.Z], eW), this.waitFor(eu.default, eo.Z, Q.Z, J.ZP, er.Z, $.Z, ea.Z, p.Z, el.Z, ec.Z, G.Z, R.ZP, en.Z, eR.Z, eA.Z, eN.Z, ee.Z, eO.ZP, eP.Z, q.Z, e_.Z, et.Z, Z.Z, eT.Z, eI.Z, X.Z, g.Z, I.Z, v.Z, L.Z, z.Z)
  }
  hasNotice() {
    return null != eF && null != eF.type
  }
  getNotice() {
    return null == ec.Z.getAction() ? eF : null
  }
  isNoticeDismissed(e) {
    return eG(e)
  }
...
let eK = new eH(u.Z, {
  ...
  GUILD_MEMBER_ADD: function(e) {
    return e.user.id === W.default.getId() && eW()
  },
  ...
  DISPATCH_APPLICATION_ERROR: function() {
    return delete ej[eC.kVF.DISPATCH_ERROR], eW()
  },
  DISPATCH_APPLICATION_LAUNCH_SETUP_START: function() {
    return delete ej[eC.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS], eW()
  },
  ...
  NOTICE_DISMISS: function(e) {
    return null != eF && (null == e.id || e.id === eF.id) && (eV(eF.type, e.isTemporary, e.untilAtLeast), eW())
  },
