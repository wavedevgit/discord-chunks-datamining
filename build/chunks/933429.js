...
function eG(e, t, n) {
  if (null == e) return;
  let r = eZ[e];
  (null == r || t || c.K.set(r, !0), eL.has(e) && (ev[e] = !0), null != n && null != r) ? c.K.set(ex(e), n.format("YYYY-MM-DDTHH:mm:ss.SSSZ")): c.K.remove(ex(e))
}
...
let eB = [ef.kVF.QUARANTINED, ef.kVF.AUTOMOD_QUARANTINED_USER_PROFILE, ef.kVF.VIEWING_ROLES, ef.kVF.INVITED_TO_SPEAK, ef.kVF.LURKING_GUILD, ef.kVF.VOICE_DISABLED, ef.kVF.NO_INPUT_DEVICES_DETECTED, ef.kVF.NO_INPUT_DETECTED, ef.kVF.HARDWARE_MUTE, ef.kVF.H264_DISABLED, ef.kVF.DISPATCH_ERROR, ef.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS, ef.kVF.SPOTIFY_AUTO_PAUSED, ef.kVF.WIN32_DEPRECATED_MESSAGE, ef.kVF.WIN7_8_DEPRECATED_MESSAGE, ef.kVF.MACOS_19_DEPRECATED_MESSAGE, ef.kVF.BLOCKED_BY_PROXY, ef.kVF.VOICE_CONNECTED_LAST_SESSION, ef.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION, ef.kVF.GUILD_RAID_NOTIFICATION, ef.kVF.GIFTING_PROMOTION_REMINDER, ef.kVF.QUESTS_PROGRESS_INTERRUPTION, ef.kVF.UNCLAIMED_ACCOUNT, ef.kVF.POMELO_ELIGIBLE, ef.kVF.PENDING_MEMBER, ef.kVF.CHECKOUT_RECOVERY_NAGBAR, ef.kVF.OUTBOUND_PROMOTION, ef.kVF.CORRUPT_INSTALLATION, ef.kVF.VIDEO_UNSUPPORTED_BROWSER, ef.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK, ef.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL, ef.kVF.STREAMER_MODE, ef.kVF.SCHEDULED_MAINTENANCE, ef.kVF.BOUNCED_EMAIL_DETECTED, ef.kVF.UNVERIFIED_ACCOUNT, ef.kVF.PREMIUM_TIER_2_TRIAL_ENDING, ef.kVF.PREMIUM_TIER_0_TRIAL_ENDING, ef.kVF.PREMIUM_UNCANCEL, ef.kVF.PREMIUM_MISSING_PAYMENT, ef.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT, ef.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT, ef.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT, ef.kVF.PREMIUM_REACTIVATE, ef.kVF.ACTIVATE_SERVER_SUBSCRIPTION, ef.kVF.MFA_SMS_BACKUP, ef.kVF.APPLICATION_TEST_MODE, ef.kVF.LOCALIZED_PRICING, ef.kVF.DOWNLOAD_NAG, ef.kVF.CONNECT_SPOTIFY, ef.kVF.CONNECT_PLAYSTATION, ef.kVF.SURVEY, ef.kVF.SERVER_USAGE_SURVEY, ef.kVF.SAFETY_USER_SENTIMENT_NAGBAR, ef.kVF.UU_MIGRATION, ef.kVF.BLOCK_USER_FEEDBACK_NAGBAR],
  ...
  ez = {
    ...
    [ef.kVF.GUILD_RAID_NOTIFICATION]: {
      predicate: () => (0, D.g)().show && !ew(ef.kVF.GUILD_RAID_NOTIFICATION),
      metadata: () => ({
    ...
    [ef.kVF.BLOCKED_BY_PROXY]: {
      predicate: () => !ew(ef.kVF.BLOCKED_BY_PROXY) && F.Z.blockedByProxy && V.Z.getCurrentConfig({
    ...
    [ef.kVF.VIDEO_UNSUPPORTED_BROWSER]: {
      predicate: e => {
        ...
        return null != t && e_.Z.hasVideo(t) && !et.Z.supports(eU.AN.VIDEO) && !ew(ef.kVF.VIDEO_UNSUPPORTED_BROWSER)
      }
    },
    ...
    [ef.kVF.SERVER_USAGE_SURVEY]: {
      predicate: e => {
        ...
        return null != t && C.Z.getCurrentConfig({
          location: "notice_store"
        }).showSurvey && !ew(ef.kVF.SERVER_USAGE_SURVEY)
      },
      metadata: e => {
        let {
          selectedGuildId: t,
    ...
    [ef.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: {
      predicate: () => eO.Z.getAlmostExpiringTrialOffers([eg.Si.TIER_2]).length > 0 && !ew(ef.kVF.PREMIUM_TIER_2_TRIAL_ENDING)
    },
    [ef.kVF.PREMIUM_TIER_0_TRIAL_ENDING]: {
      predicate: () => eO.Z.getAlmostExpiringTrialOffers([eg.Si.TIER_0]).length > 0 && !ew(ef.kVF.PREMIUM_TIER_0_TRIAL_ENDING)
    },
    [ef.kVF.PREMIUM_UNCANCEL]: {
      predicate: e => {
        let {
          ...
          currentUser: n
        } = e, r = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = (null == t ? void 0 : t.canceledAt) != null && (null == t ? void 0 : t.status) === ef.O0b.CANCELED && 1 >= l()().diff(l()(t.canceledAt), "days"), o = null != t && l()(t.currentPeriodEnd).isBefore(l()()), a = null != t && t.status === ef.O0b.CANCELED && !o && r <= 7 && r >= 0 && (0, eR.M5)(n, eg.p9.TIER_2) && !i && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [ef.kVF.PREMIUM_MISSING_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = null != t ? l()(t.currentPeriodEnd).diff(l()(t.currentPeriodStart).startOf("day"), "days") : 0, o = null != t && l()(t.currentPeriodEnd).isBefore(l()()), a = eS.Z.applicationIdsFetched.has(eg.CL), s = eS.Z.getForApplication(eg.CL), c = null != t ? (0, eR.Af)(t) : null, u = null != c ? eR.ZP.getSkuIdForPlan(c.planId) : null, E = null != s && null != c && Array.from(s).filter(e => {
          let {
            skuId: t,
            consumed: n
          } = e;
    ...
    [ef.kVF.PREMIUM_REACTIVATE]: {
      predicate: () => !ew(ef.kVF.PREMIUM_REACTIVATE) && Z.Z.shouldShowReactivateNotice()
    },
    ...
    [ef.kVF.POMELO_ELIGIBLE]: {
      predicate: () => (0, k.e)() && !ew(ef.kVF.POMELO_ELIGIBLE) && !(0, U.ov)()
    },
    [ef.kVF.UU_MIGRATION]: {
      predicate: () => (0, k.e)() && !ew(ef.kVF.UU_MIGRATION) && (0, U.ov)()
    },
    [ef.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
      predicate: e => {
        ...
        return null != t && null != g.Z.getMentionRaidDetected(t) && (null == n ? void 0 : n.hasFeature(ef.oNc.COMMUNITY)) && !ew(ef.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION) || !1
      },
      metadata: e => {
        let {
          selectedGuildId: t
    ...
    [ef.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: {
      predicate: () => !ew(ef.kVF.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== I.Z.getEligibleGuildsForNagActivate().length && (0, N.Lm)()
    },
    [ef.kVF.SAFETY_USER_SENTIMENT_NAGBAR]: {
      predicate: e => {
        let {
    ...
    [ef.kVF.QUESTS_PROGRESS_INTERRUPTION]: {
      predicate: () => {
        ...
        return null != n && Date.now() - n.firstFailedAt >= eh.Ot
      },
      metadata: () => {
        let e = Y.Z.getCurrentUserActiveStream();
        return {
    ...
    [ef.kVF.CHECKOUT_RECOVERY_NAGBAR]: {
      predicate: e => {
        ...
        return b.Z.getIsTargeted() && !(0, eR.I5)(n) && 0 !== Object.keys(r).length && (0, L.Y)()
      }
    },
    [ef.kVF.BLOCK_USER_FEEDBACK_NAGBAR]: {
      predicate: () => !ew(ef.kVF.BLOCK_USER_FEEDBACK_NAGBAR) && w.S(),
      metadata: () => ({
...
function eY() {
  ...
  let i = eT.ZP.getPremiumSubscription(),
    l = eN.Z.isLocalizedPromoEnabled,
    o = ea.Z.getGuildId(),
...
function eH() {
  return ec.Z.enabled || delete ev[ef.kVF.STREAMER_MODE], eY()
}
class eK extends(r = o.ZP.Store) {
  ...
  getNotice() {
    return null == eE.Z.getAction() ? eF : null
  }
  isNoticeDismissed(e) {
    return ew(e)
  }
}
ek(eK, "displayName", "NoticeStore");
let eX = new eK(u.Z, {
  ...
  GUILD_MEMBER_ADD: function(e) {
    return e.user.id === H.default.getId() && eY()
  },
  ...
  NOTICE_DISMISS: function(e) {
    return null != eF && (null == e.id || e.id === eF.id) && (eG(eF.type, e.isTemporary, e.untilAtLeast), eY())
  },
