...
let eb = {
  ...
  ev = new Set([ef.kVF.NO_INPUT_DETECTED, ef.kVF.NO_INPUT_DEVICES_DETECTED, ef.kVF.STREAMER_MODE, ef.kVF.VIDEO_UNSUPPORTED_BROWSER, ef.kVF.SPOTIFY_AUTO_PAUSED, ef.kVF.DISPATCH_ERROR, ef.kVF.DISPATCH_ERROR, ef.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS, ef.kVF.BLOCKED_BY_PROXY]),
  eZ = {},
  eL = {},
  ej = Object.freeze({
    id: null,
...
function eF(e, t, n) {
  if (null == e) return;
  let r = eM[e];
  (null == r || t || c.K.set(r, !0), ev.has(e) && (eZ[e] = !0), null != n && null != r) ? c.K.set(eV(e), n.format("YYYY-MM-DDTHH:mm:ss.SSSZ")): c.K.remove(eV(e))
}
  ...
  eW = {
    [ef.kVF.GIFTING_PROMOTION_REMINDER]: {
      predicate: () => {
        ...
        return e && t && (0, T.H4)(s.z.GIFTING_PROMOTION_DESKTOP_FIRST_TIME_COACHMARK).isDismissed && !eG(ef.kVF.GIFTING_PROMOTION_REMINDER)
      }
    },
    [ef.kVF.GUILD_RAID_NOTIFICATION]: {
      predicate: () => (0, R.g)().show && !eG(ef.kVF.GUILD_RAID_NOTIFICATION),
      metadata: () => ({
    ...
    [ef.kVF.BLOCKED_BY_PROXY]: {
      predicate: () => !eG(ef.kVF.BLOCKED_BY_PROXY) && x.Z.blockedByProxy && j.Z.getCurrentConfig({
    ...
    [ef.kVF.PENDING_MEMBER]: {
      predicate: e => {
        ...
        return null !== (r = null != i && null != l && !(null === (t = $.Z.getGuild(i)) || void 0 === t ? void 0 : t.hasFeature(ef.oNc.GUILD_ONBOARDING)) && (null === (n = J.ZP.getMember(i, l.id)) || void 0 === n ? void 0 : n.isPending)) && void 0 !== r && r
      }
    },
    ...
    [ef.kVF.CORRUPT_INSTALLATION]: {
      predicate: () => eP.isPlatformEmbedded && (!a.Z.supported() || eC.Z.isCorruptInstallation())
    },
    [ef.kVF.VIDEO_UNSUPPORTED_BROWSER]: {
      predicate: e => {
        ...
        return null != t && ed.Z.hasVideo(t) && !ee.Z.supports(ey.AN.VIDEO) && !eG(ef.kVF.VIDEO_UNSUPPORTED_BROWSER)
      }
    },
    ...
    [ef.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL]: {
      predicate: () => !eG(ef.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL) && Q.Z.getDetectedOffPlatformPremiumPerks().length > 0,
      metadata: () => Q.Z.getDetectedOffPlatformPremiumPerks()[0]
    },
    ...
    [ef.kVF.DOWNLOAD_NAG]: {
      predicate: () => !eP.isPlatformEmbedded && !eG(ef.kVF.DOWNLOAD_NAG)
    },
    ...
    [ef.kVF.SERVER_USAGE_SURVEY]: {
      predicate: e => {
        ...
        return null != t && A.Z.getCurrentConfig({
          location: "notice_store"
        }).showSurvey && !eG(ef.kVF.SERVER_USAGE_SURVEY)
      },
      metadata: e => {
        let {
          selectedGuildId: t,
    ...
    [ef.kVF.CONNECT_SPOTIFY]: {
      predicate: () => !w.Z.hasConnectedAccount() && S.ZP.isObservedAppRunning(d.Z.get(ef.ABu.SPOTIFY).name) && !eG(ef.kVF.CONNECT_SPOTIFY)
    },
    ...
    [ef.kVF.CONNECT_PLAYSTATION]: {
      predicate: () => q.Z.isSuggestedAccountType(ef.ABu.PLAYSTATION) && null == q.Z.getAccount(null, ef.ABu.PLAYSTATION) && !eG(ef.kVF.CONNECT_PLAYSTATION)
    },
    [ef.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: {
      predicate: () => eT.Z.getAlmostExpiringTrialOffers([em.Si.TIER_2]).length > 0 && !eG(ef.kVF.PREMIUM_TIER_2_TRIAL_ENDING)
    },
    [ef.kVF.PREMIUM_TIER_0_TRIAL_ENDING]: {
      predicate: () => eT.Z.getAlmostExpiringTrialOffers([em.Si.TIER_0]).length > 0 && !eG(ef.kVF.PREMIUM_TIER_0_TRIAL_ENDING)
    },
    [ef.kVF.PREMIUM_UNCANCEL]: {
      predicate: e => {
        let {
          ...
          currentUser: n
        } = e, r = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = (null == t ? void 0 : t.canceledAt) != null && (null == t ? void 0 : t.status) === ef.O0b.CANCELED && 1 >= l()().diff(l()(t.canceledAt), "days"), o = null != t && l()(t.currentPeriodEnd).isBefore(l()()), a = null != t && t.status === ef.O0b.CANCELED && !o && r <= 7 && r >= 0 && (0, ep.M5)(n, em.p9.TIER_2) && !i && !n.hasFreePremium() && !t.isPurchasedExternally;
        return !eG(ef.kVF.PREMIUM_UNCANCEL) && a
      },
      metadata: e => {
        var t;
        let {
          premiumSubscription: n
        } = e, r = null != n ? l()(n.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = null != n ? null === (t = (0, ep.Af)(n)) || void 0 === t ? void 0 : t.planId : null;
        return {
          daysLeft: r,
    ...
    [ef.kVF.PREMIUM_MISSING_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = null != t ? l()(t.currentPeriodEnd).diff(l()(t.currentPeriodStart).startOf("day"), "days") : 0, o = null != t && l()(t.currentPeriodEnd).isBefore(l()()), a = eO.Z.applicationIdsFetched.has(em.CL), s = eO.Z.getForApplication(em.CL), c = null != t ? (0, ep.Af)(t) : null, u = null != c ? ep.ZP.getSkuIdForPlan(c.planId) : null, E = null != s && null != c && Array.from(s).filter(e => {
          let {
            skuId: t,
            consumed: n
          } = e;
        ...
        return !eG(ef.kVF.PREMIUM_MISSING_PAYMENT) && d
      },
      metadata: e => {
        var t;
        let {
    ...
    [ef.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && null != t.paymentSourceId ? eN.Z.getPaymentSource(t.paymentSourceId) : null, i = null != t && l()(t.currentPeriodEnd).isBefore(l()()), o = null != t && t.status === ef.O0b.PAST_DUE && !i && null != r && r.invalid && !n.hasFreePremium() && !t.isPurchasedExternally;
        return !eG(ef.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT) && o
      },
      metadata: e => {
        let {
          premiumSubscription: t
    ...
    [ef.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT]: {
      predicate: e => {
        ...
        return !eG(ef.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT) && i
      },
      metadata: e => {
        let {
          premiumSubscription: t
    ...
    [ef.kVF.MFA_SMS_BACKUP]: {
      predicate: e => {
        ...
        return null != t && t.mfaEnabled && !t.hasFlag(ef.xW$.MFA_SMS) && !t.hasFlag(ef.xW$.STAFF) && !t.hasFlag(ef.xW$.PARTNER) && !eG(ef.kVF.MFA_SMS_BACKUP)
      }
    },
    ...
    [ef.kVF.PREMIUM_REACTIVATE]: {
      predicate: () => !eG(ef.kVF.PREMIUM_REACTIVATE) && k.Z.shouldShowReactivateNotice()
    },
    [ef.kVF.LOCALIZED_PRICING]: {
      predicate: e => {
        ...
        return !eG(ef.kVF.LOCALIZED_PRICING) && t
      },
      metadata: e => {
        let {
          premiumSubscription: t
    ...
    [ef.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && l()(t.currentPeriodEnd).isBefore(l()()), i = null != t && null != t.paymentSourceId ? eN.Z.getPaymentSource(t.paymentSourceId) : null, o = null != i && eh.Uk.has(i.type), a = null != t && t.status === ef.O0b.PAST_DUE && !r && o && !n.hasFreePremium() && !t.isPurchasedExternally;
        return !eG(ef.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT) && a
      },
      metadata: e => {
        let {
          premiumSubscription: t
    ...
    [ef.kVF.POMELO_ELIGIBLE]: {
      predicate: () => (0, y.e)() && !eG(ef.kVF.POMELO_ELIGIBLE) && !(0, h.ov)()
    },
    [ef.kVF.UU_MIGRATION]: {
      predicate: () => (0, y.e)() && !eG(ef.kVF.UU_MIGRATION) && (0, h.ov)()
    },
    [ef.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
      predicate: e => {
        ...
        return null != t && null != D.Z.getMentionRaidDetected(t) && (null == n ? void 0 : n.hasFeature(ef.oNc.COMMUNITY)) && !eG(ef.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION) || !1
      },
      metadata: e => {
        let {
          selectedGuildId: t
    ...
    [ef.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: {
      predicate: () => !eG(ef.kVF.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== I.Z.getEligibleGuildsForNagActivate().length && (0, N.Lm)()
    },
    [ef.kVF.SAFETY_USER_SENTIMENT_NAGBAR]: {
      predicate: e => {
        let {
    ...
    [ef.kVF.BLOCK_USER_FEEDBACK_NAGBAR]: {
      predicate: () => !eG(ef.kVF.BLOCK_USER_FEEDBACK_NAGBAR) && G.S(),
      metadata: () => ({
...
function ez() {
  ...
  for (let n of eD.a ? eB : ew)
    if (null != eW[n] && eW[n].predicate({
      ...
      let l = null === (e = (t = eW[n]).metadata) || void 0 === e ? void 0 : e.call(t, {
        currentUser: r,
        premiumSubscription: i,
        selectedGuildId: o
      });
    ...
    (null === (n = ex.metadata) || void 0 === n ? void 0 : n.sampleRate) != null && null == eL[ex.type] && (eL[ex.type] = Math.random() <= ex.metadata.sampleRate);
    let e = !1 === eL[ex.type];
...
function eY() {
  return es.Z.enabled || delete eZ[ef.kVF.STREAMER_MODE], ez()
}
class eH extends(r = o.ZP.Store) {
  initialize() {
    this.syncWith([ec.Z, er.Z, Q.Z, eo.Z, L.Z, eT.Z, H.Z, q.Z, W.Z, C.Z, V.Z, z.Z], ez), this.waitFor(eE.default, ea.Z, $.Z, J.ZP, ei.Z, ee.Z, es.Z, O.Z, eo.Z, eu.Z, w.Z, S.ZP, er.Z, eA.Z, eR.Z, eS.Z, et.Z, eI.ZP, eC.Z, Q.Z, eN.Z, en.Z, L.Z, eO.Z, eT.Z, q.Z, g.Z, I.Z, x.Z, V.Z, z.Z)
  }
  hasNotice() {
...
let eK = new eH(u.Z, {
  ...
  DISPATCH_APPLICATION_ERROR: function() {
    return delete eZ[ef.kVF.DISPATCH_ERROR], ez()
  },
  DISPATCH_APPLICATION_LAUNCH_SETUP_START: function() {
    return delete eZ[ef.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS], ez()
  },
