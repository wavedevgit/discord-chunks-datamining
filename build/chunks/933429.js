...
let ev = {
  ...
  eM = {
    [eN.kVF.GIFTING_PROMOTION_REMINDER]: a.z.GIFTING_PROMOTION_REMINDER
  },
  ek = {
    [eN.kVF.OUTBOUND_PROMOTION]: a.z.THIRD_PARTY_OUTBOUND_PROMO_NAGBAR
  },
  eU = {
...
let eB = [eN.kVF.QUARANTINED, eN.kVF.AUTOMOD_QUARANTINED_USER_PROFILE, eN.kVF.VIEWING_ROLES, eN.kVF.INVITED_TO_SPEAK, eN.kVF.LURKING_GUILD, eN.kVF.VOICE_DISABLED, eN.kVF.NO_INPUT_DEVICES_DETECTED, eN.kVF.NO_INPUT_DETECTED, eN.kVF.HARDWARE_MUTE, eN.kVF.H264_DISABLED, eN.kVF.DISPATCH_ERROR, eN.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS, eN.kVF.SPOTIFY_AUTO_PAUSED, eN.kVF.WIN32_DEPRECATED_MESSAGE, eN.kVF.WIN7_8_DEPRECATED_MESSAGE, eN.kVF.MACOS_19_DEPRECATED_MESSAGE, eN.kVF.BLOCKED_BY_PROXY, eN.kVF.VOICE_CONNECTED_LAST_SESSION, eN.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION, eN.kVF.GUILD_RAID_NOTIFICATION, eN.kVF.GIFTING_PROMOTION_REMINDER, eN.kVF.QUESTS_PROGRESS_INTERRUPTION, eN.kVF.UNCLAIMED_ACCOUNT, eN.kVF.POMELO_ELIGIBLE, eN.kVF.PENDING_MEMBER, eN.kVF.CHECKOUT_RECOVERY_NAGBAR, eN.kVF.OUTBOUND_PROMOTION, eN.kVF.CORRUPT_INSTALLATION, eN.kVF.VIDEO_UNSUPPORTED_BROWSER, eN.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK, eN.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL, eN.kVF.STREAMER_MODE, eN.kVF.SCHEDULED_MAINTENANCE, eN.kVF.BOUNCED_EMAIL_DETECTED, eN.kVF.UNVERIFIED_ACCOUNT, eN.kVF.PREMIUM_TIER_2_TRIAL_ENDING, eN.kVF.PREMIUM_TIER_2_DISCOUNT_ENDING, eN.kVF.PREMIUM_TIER_0_TRIAL_ENDING, eN.kVF.PREMIUM_UNCANCEL, eN.kVF.PREMIUM_MISSING_PAYMENT, eN.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT, eN.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT, eN.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT, eN.kVF.PREMIUM_REACTIVATE, eN.kVF.ACTIVATE_SERVER_SUBSCRIPTION, eN.kVF.MFA_SMS_BACKUP, eN.kVF.APPLICATION_TEST_MODE, eN.kVF.DOWNLOAD_NAG, eN.kVF.CONNECT_SPOTIFY, eN.kVF.CONNECT_PLAYSTATION, eN.kVF.SURVEY, eN.kVF.SAFETY_USER_SENTIMENT_NAGBAR, eN.kVF.BLOCK_USER_FEEDBACK_NAGBAR, eN.kVF.IGNORE_USER_FEEDBACK_NAGBAR, eN.kVF.REPORT_TO_MOD_SURVEY],
  ...
  ez = {
    ...
    [eN.kVF.NO_INPUT_DETECTED]: {
      predicate: () => C.Z.hasActiveErrorOfType(f.u.NO_AUDIO_INPUT_DETECTED)
    },
    [eN.kVF.NO_INPUT_DEVICES_DETECTED]: {
      predicate: () => C.Z.hasActiveErrorOfType(f.u.NO_INPUT_DEVICES)
    },
    ...
    [eN.kVF.BLOCKED_BY_PROXY]: {
      predicate: () => !eG(eN.kVF.BLOCKED_BY_PROXY) && Z.Z.blockedByProxy && x.Z.getCurrentConfig({
    ...
    [eN.kVF.CORRUPT_INSTALLATION]: {
      predicate: () => eC.isPlatformEmbedded && (!s.Z.supported() || em.Z.isCorruptInstallation())
    },
    ...
    [eN.kVF.DOWNLOAD_NAG]: {
      predicate: () => !eC.isPlatformEmbedded && !eG(eN.kVF.DOWNLOAD_NAG)
    },
    ...
    [eN.kVF.CONNECT_SPOTIFY]: {
      predicate: () => !B.Z.hasConnectedAccount() && T.ZP.isObservedAppRunning(h.Z.get(eN.ABu.SPOTIFY).name) && !eG(eN.kVF.CONNECT_SPOTIFY)
    },
    ...
    [eN.kVF.WIN7_8_DEPRECATED_MESSAGE]: {
      predicate: () => {
        if ((null === u.Z || void 0 === u.Z ? void 0 : u.Z.process.platform) === "win32") try {
    ...
    [eN.kVF.MACOS_19_DEPRECATED_MESSAGE]: {
      predicate: () => {
        if ((null === u.Z || void 0 === u.Z ? void 0 : u.Z.process.platform) === "darwin") try {
    ...
    [eN.kVF.CONNECT_PLAYSTATION]: {
      predicate: () => J.Z.isSuggestedAccountType(eN.ABu.PLAYSTATION) && null == J.Z.getAccount(null, eN.ABu.PLAYSTATION) && !eG(eN.kVF.CONNECT_PLAYSTATION)
    },
    [eN.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: {
      predicate: () => eI.Z.getAlmostExpiringTrialOffers([eA.Si.TIER_2]).length > 0 && !eG(eN.kVF.PREMIUM_TIER_2_TRIAL_ENDING)
    },
    [eN.kVF.PREMIUM_TIER_0_TRIAL_ENDING]: {
      predicate: () => eI.Z.getAlmostExpiringTrialOffers([eA.Si.TIER_0]).length > 0 && !eG(eN.kVF.PREMIUM_TIER_0_TRIAL_ENDING)
    },
    ...
    [eN.kVF.PREMIUM_UNCANCEL]: {
      predicate: e => {
        let {
          ...
          currentUser: n
        } = e, i = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, r = (null == t ? void 0 : t.canceledAt) != null && (null == t ? void 0 : t.status) === eN.O0b.CANCELED && 1 >= l()().diff(l()(t.canceledAt), "days"), o = null != t && l()(t.currentPeriodEnd).isBefore(l()()), s = null != t && t.status === eN.O0b.CANCELED && !o && i <= 7 && i >= 0 && (0, eO.M5)(n, eA.p9.TIER_2) && !r && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eN.kVF.PREMIUM_MISSING_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, i = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, r = null != t ? l()(t.currentPeriodEnd).diff(l()(t.currentPeriodStart).startOf("day"), "days") : 0, o = null != t && l()(t.currentPeriodEnd).isBefore(l()()), s = eg.Z.applicationIdsFetched.has(eA.CL), a = eg.Z.getForApplication(eA.CL), c = null != t ? (0, eO.Af)(t) : null, d = null != c ? eO.ZP.getSkuIdForPlan(c.planId) : null, u = null != a && null != c && Array.from(a).filter(e => {
          let {
            skuId: t,
            consumed: n
          } = e;
          return !n && t === d
        }).length > 0, h = null != t && i <= (r > 14 ? 7 : 2) && i >= 0 && t.status !== eN.O0b.PAST_DUE && !o && s && !u && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eN.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, i = null != t && null != t.paymentSourceId ? eE.Z.getPaymentSource(t.paymentSourceId) : null, r = null != t && l()(t.currentPeriodEnd).isBefore(l()()), o = null != t && t.status === eN.O0b.PAST_DUE && !r && null != i && i.invalid && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eN.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, i = null != t && l()(t.currentPeriodEnd).isBefore(l()()), r = null != t && t.status === eN.O0b.PAST_DUE && !i && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eN.kVF.PREMIUM_REACTIVATE]: {
      predicate: () => !eG(eN.kVF.PREMIUM_REACTIVATE) && k.Z.shouldShowReactivateNotice()
    },
    [eN.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, i = null != t && l()(t.currentPeriodEnd).isBefore(l()()), r = null != t && null != t.paymentSourceId ? eE.Z.getPaymentSource(t.paymentSourceId) : null, o = null != r && eb.Uk.has(r.type), s = null != t && t.status === eN.O0b.PAST_DUE && !i && o && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eN.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: {
      predicate: () => !eG(eN.kVF.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== p.Z.getEligibleGuildsForNagActivate().length && (0, E.Lm)()
    },
    ...
    [eN.kVF.CHECKOUT_RECOVERY_NAGBAR]: {
      predicate: e => {
        ...
        let {
          currentUser: n
        } = e, i = null != (t = eE.Z.paymentSources) ? t : {};
...
function eH() {
  ...
  for (let n of eR.a ? eW : eB)
    if (null != ez[n] && ez[n].predicate({
      ...
      let o = null == (e = (t = ez[n]).metadata) ? void 0 : e.call(t, {
        currentUser: i,
        premiumSubscription: r,
        selectedGuildId: l
      });
