...
let ez = [eR.kVF.QUARANTINED, eR.kVF.AUTOMOD_QUARANTINED_USER_PROFILE, eR.kVF.VIEWING_ROLES, eR.kVF.INVITED_TO_SPEAK, eR.kVF.LURKING_GUILD, eR.kVF.VOICE_DISABLED, eR.kVF.NO_INPUT_DEVICES_DETECTED, eR.kVF.NO_INPUT_DETECTED, eR.kVF.HARDWARE_MUTE, eR.kVF.H264_DISABLED, eR.kVF.DISPATCH_ERROR, eR.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS, eR.kVF.SPOTIFY_AUTO_PAUSED, eR.kVF.WIN32_DEPRECATED_MESSAGE, eR.kVF.WIN7_8_DEPRECATED_MESSAGE, eR.kVF.MACOS_19_DEPRECATED_MESSAGE, eR.kVF.BLOCKED_BY_PROXY, eR.kVF.VOICE_CONNECTED_LAST_SESSION, eR.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION, eR.kVF.GUILD_RAID_NOTIFICATION, eR.kVF.GIFTING_PROMOTION_REMINDER, eR.kVF.QUESTS_PROGRESS_INTERRUPTION, eR.kVF.UNCLAIMED_ACCOUNT, eR.kVF.POMELO_ELIGIBLE, eR.kVF.PENDING_MEMBER, eR.kVF.CHECKOUT_RECOVERY_NAGBAR, eR.kVF.OUTBOUND_PROMOTION, eR.kVF.CORRUPT_INSTALLATION, eR.kVF.VIDEO_UNSUPPORTED_BROWSER, eR.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK, eR.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL, eR.kVF.STREAMER_MODE, eR.kVF.SCHEDULED_MAINTENANCE, eR.kVF.BOUNCED_EMAIL_DETECTED, eR.kVF.UNVERIFIED_ACCOUNT, eR.kVF.PREMIUM_TIER_2_TRIAL_ENDING, eR.kVF.PREMIUM_TIER_2_DISCOUNT_ENDING, eR.kVF.PREMIUM_TIER_0_TRIAL_ENDING, eR.kVF.PREMIUM_UNCANCEL, eR.kVF.PREMIUM_MISSING_PAYMENT, eR.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT, eR.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT, eR.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT, eR.kVF.PREMIUM_REACTIVATE, eR.kVF.ACTIVATE_SERVER_SUBSCRIPTION, eR.kVF.MFA_SMS_BACKUP, eR.kVF.APPLICATION_TEST_MODE, eR.kVF.DOWNLOAD_NAG, eR.kVF.CONNECT_SPOTIFY, eR.kVF.CONNECT_PLAYSTATION, eR.kVF.SURVEY, eR.kVF.SAFETY_USER_SENTIMENT_NAGBAR, eR.kVF.BLOCK_USER_FEEDBACK_NAGBAR, eR.kVF.IGNORE_USER_FEEDBACK_NAGBAR, eR.kVF.REPORT_TO_MOD_SURVEY],
  ...
  eY = {
    ...
    [eR.kVF.BLOCKED_BY_PROXY]: {
      predicate: () => !eW(eR.kVF.BLOCKED_BY_PROXY) && F.Z.blockedByProxy && Z.Z.getCurrentConfig({
    ...
    [eR.kVF.CORRUPT_INSTALLATION]: {
      predicate: () => eO.isPlatformEmbedded && (!s.Z.supported() || em.Z.isCorruptInstallation())
    },
    ...
    [eR.kVF.STREAMER_MODE]: {
      predicate: () => ed.Z.enabled
    },
    [eR.kVF.DOWNLOAD_NAG]: {
      predicate: () => !eO.isPlatformEmbedded && !eW(eR.kVF.DOWNLOAD_NAG)
    },
    ...
    [eR.kVF.CONNECT_SPOTIFY]: {
      predicate: () => !W.Z.hasConnectedAccount() && T.ZP.isObservedAppRunning(h.Z.get(eR.ABu.SPOTIFY).name) && !eW(eR.kVF.CONNECT_SPOTIFY)
    },
    ...
    [eR.kVF.CONNECT_PLAYSTATION]: {
      predicate: () => Q.Z.isSuggestedAccountType(eR.ABu.PLAYSTATION) && null == Q.Z.getAccount(null, eR.ABu.PLAYSTATION) && !eW(eR.kVF.CONNECT_PLAYSTATION)
    },
    [eR.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: {
      predicate: () => eg.Z.getAlmostExpiringTrialOffers([ey.Si.TIER_2]).length > 0 && !eW(eR.kVF.PREMIUM_TIER_2_TRIAL_ENDING)
    },
    [eR.kVF.PREMIUM_TIER_0_TRIAL_ENDING]: {
      predicate: () => eg.Z.getAlmostExpiringTrialOffers([ey.Si.TIER_0]).length > 0 && !eW(eR.kVF.PREMIUM_TIER_0_TRIAL_ENDING)
    },
    ...
    [eR.kVF.PREMIUM_UNCANCEL]: {
      predicate: e => {
        let {
          ...
          currentUser: n
        } = e, i = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, r = (null == t ? void 0 : t.canceledAt) != null && (null == t ? void 0 : t.status) === eR.O0b.CANCELED && 1 >= l()().diff(l()(t.canceledAt), "days"), o = null != t && l()(t.currentPeriodEnd).isBefore(l()()), s = null != t && t.status === eR.O0b.CANCELED && !o && i <= 7 && i >= 0 && (0, eT.M5)(n, ey.p9.TIER_2) && !r && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eR.kVF.PREMIUM_MISSING_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, i = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, r = null != t ? l()(t.currentPeriodEnd).diff(l()(t.currentPeriodStart).startOf("day"), "days") : 0, o = null != t && l()(t.currentPeriodEnd).isBefore(l()()), s = ef.Z.applicationIdsFetched.has(ey.CL), a = ef.Z.getForApplication(ey.CL), c = null != t ? (0, eT.Af)(t) : null, d = null != c ? eT.ZP.getSkuIdForPlan(c.planId) : null, u = null != a && null != c && Array.from(a).filter(e => {
          let {
            skuId: t,
            consumed: n
          } = e;
          return !n && t === d
        }).length > 0, h = null != t && i <= (r > 14 ? 7 : 2) && i >= 0 && t.status !== eR.O0b.PAST_DUE && !o && s && !u && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eR.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, i = null != t && null != t.paymentSourceId ? ep.Z.getPaymentSource(t.paymentSourceId) : null, r = null != t && l()(t.currentPeriodEnd).isBefore(l()()), o = null != t && t.status === eR.O0b.PAST_DUE && !r && null != i && i.invalid && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eR.kVF.PREMIUM_REACTIVATE]: {
      predicate: () => !eW(eR.kVF.PREMIUM_REACTIVATE) && k.Z.shouldShowReactivateNotice()
    },
    [eR.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, i = null != t && l()(t.currentPeriodEnd).isBefore(l()()), r = null != t && null != t.paymentSourceId ? ep.Z.getPaymentSource(t.paymentSourceId) : null, o = null != r && eP.Uk.has(r.type), s = null != t && t.status === eR.O0b.PAST_DUE && !i && o && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eR.kVF.POMELO_ELIGIBLE]: {
      predicate: () => (0, D.e)() && !eW(eR.kVF.POMELO_ELIGIBLE)
    },
    ...
    [eR.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: {
      predicate: () => !eW(eR.kVF.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== p.Z.getEligibleGuildsForNagActivate().length && (0, E.Lm)()
    },
    ...
    [eR.kVF.CHECKOUT_RECOVERY_NAGBAR]: {
      predicate: e => {
        ...
        let {
          currentUser: n
        } = e, i = null != (t = ep.Z.paymentSources) ? t : {};
...
function eK() {
  ...
  for (let n of eA.a ? eH : ez)
    if (null != eY[n] && eY[n].predicate({
      ...
      let o = null == (e = (t = eY[n]).metadata) ? void 0 : e.call(t, {
        currentUser: i,
        premiumSubscription: r,
        selectedGuildId: l
      });
