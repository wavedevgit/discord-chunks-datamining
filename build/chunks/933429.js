...
let eU = {
  ...
  eM = {
    [eg.kVF.GIFTING_PROMOTION_REMINDER]: c.z.GIFTING_PROMOTION_REMINDER
  },
  ev = {
    [eg.kVF.OUTBOUND_PROMOTION]: c.z.THIRD_PARTY_OUTBOUND_PROMO_NAGBAR
  },
  ek = {
...
let eB = [eg.kVF.QUARANTINED, eg.kVF.AUTOMOD_QUARANTINED_USER_PROFILE, eg.kVF.VIEWING_ROLES, eg.kVF.INVITED_TO_SPEAK, eg.kVF.LURKING_GUILD, eg.kVF.VOICE_DISABLED, eg.kVF.NO_INPUT_DEVICES_DETECTED, eg.kVF.NO_INPUT_DETECTED, eg.kVF.HARDWARE_MUTE, eg.kVF.H264_DISABLED, eg.kVF.DISPATCH_ERROR, eg.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS, eg.kVF.SPOTIFY_AUTO_PAUSED, eg.kVF.WIN32_DEPRECATED_MESSAGE, eg.kVF.WIN7_8_DEPRECATED_MESSAGE, eg.kVF.MACOS_19_DEPRECATED_MESSAGE, eg.kVF.BLOCKED_BY_PROXY, eg.kVF.VOICE_CONNECTED_LAST_SESSION, eg.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION, eg.kVF.GUILD_RAID_NOTIFICATION, eg.kVF.GIFTING_PROMOTION_REMINDER, eg.kVF.QUESTS_PROGRESS_INTERRUPTION, eg.kVF.UNCLAIMED_ACCOUNT, eg.kVF.POMELO_ELIGIBLE, eg.kVF.PENDING_MEMBER, eg.kVF.CHECKOUT_RECOVERY_NAGBAR, eg.kVF.OUTBOUND_PROMOTION, eg.kVF.CORRUPT_INSTALLATION, eg.kVF.VIDEO_UNSUPPORTED_BROWSER, eg.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK, eg.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL, eg.kVF.STREAMER_MODE, eg.kVF.SCHEDULED_MAINTENANCE, eg.kVF.BOUNCED_EMAIL_DETECTED, eg.kVF.UNVERIFIED_ACCOUNT, eg.kVF.PREMIUM_TIER_2_TRIAL_ENDING, eg.kVF.PREMIUM_TIER_0_TRIAL_ENDING, eg.kVF.PREMIUM_UNCANCEL, eg.kVF.PREMIUM_MISSING_PAYMENT, eg.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT, eg.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT, eg.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT, eg.kVF.PREMIUM_REACTIVATE, eg.kVF.ACTIVATE_SERVER_SUBSCRIPTION, eg.kVF.MFA_SMS_BACKUP, eg.kVF.APPLICATION_TEST_MODE, eg.kVF.LOCALIZED_PRICING, eg.kVF.DOWNLOAD_NAG, eg.kVF.CONNECT_SPOTIFY, eg.kVF.CONNECT_PLAYSTATION, eg.kVF.SURVEY, eg.kVF.SAFETY_USER_SENTIMENT_NAGBAR, eg.kVF.UU_MIGRATION, eg.kVF.BLOCK_USER_FEEDBACK_NAGBAR, eg.kVF.IGNORE_USER_FEEDBACK_NAGBAR, eg.kVF.REPORT_TO_MOD_SURVEY],
  ...
  ez = {
    ...
    [eg.kVF.BLOCKED_BY_PROXY]: {
      predicate: () => !eV(eg.kVF.BLOCKED_BY_PROXY) && j.Z.blockedByProxy && Z.Z.getCurrentConfig({
    ...
    [eg.kVF.CORRUPT_INSTALLATION]: {
      predicate: () => eN.isPlatformEmbedded && (!a.Z.supported() || eR.Z.isCorruptInstallation())
    },
    ...
    [eg.kVF.DOWNLOAD_NAG]: {
      predicate: () => !eN.isPlatformEmbedded && !eV(eg.kVF.DOWNLOAD_NAG)
    },
    ...
    [eg.kVF.CONNECT_SPOTIFY]: {
      predicate: () => !V.Z.hasConnectedAccount() && f.ZP.isObservedAppRunning(_.Z.get(eg.ABu.SPOTIFY).name) && !eV(eg.kVF.CONNECT_SPOTIFY)
    },
    ...
    [eg.kVF.CONNECT_PLAYSTATION]: {
      predicate: () => X.Z.isSuggestedAccountType(eg.ABu.PLAYSTATION) && null == X.Z.getAccount(null, eg.ABu.PLAYSTATION) && !eV(eg.kVF.CONNECT_PLAYSTATION)
    },
    [eg.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: {
      predicate: () => ep.Z.getAlmostExpiringTrialOffers([eP.Si.TIER_2]).length > 0 && !eV(eg.kVF.PREMIUM_TIER_2_TRIAL_ENDING)
    },
    [eg.kVF.PREMIUM_TIER_0_TRIAL_ENDING]: {
      predicate: () => ep.Z.getAlmostExpiringTrialOffers([eP.Si.TIER_0]).length > 0 && !eV(eg.kVF.PREMIUM_TIER_0_TRIAL_ENDING)
    },
    ...
    [eg.kVF.PREMIUM_MISSING_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = null != t ? l()(t.currentPeriodEnd).diff(l()(t.currentPeriodStart).startOf("day"), "days") : 0, o = null != t && l()(t.currentPeriodEnd).isBefore(l()()), a = eT.Z.applicationIdsFetched.has(eP.CL), c = eT.Z.getForApplication(eP.CL), s = null != t ? (0, ef.Af)(t) : null, u = null != s ? ef.ZP.getSkuIdForPlan(s.planId) : null, d = null != c && null != s && Array.from(c).filter(e => {
          let {
            skuId: t,
            consumed: n
          } = e;
          return !n && t === u
        }).length > 0, _ = null != t && r <= (i > 14 ? 7 : 2) && r >= 0 && t.status !== eg.O0b.PAST_DUE && !o && a && !d && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eg.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && null != t.paymentSourceId ? eO.Z.getPaymentSource(t.paymentSourceId) : null, i = null != t && l()(t.currentPeriodEnd).isBefore(l()()), o = null != t && t.status === eg.O0b.PAST_DUE && !i && null != r && r.invalid && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eg.kVF.PREMIUM_REACTIVATE]: {
      predicate: () => !eV(eg.kVF.PREMIUM_REACTIVATE) && v.Z.shouldShowReactivateNotice()
    },
    ...
    [eg.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && l()(t.currentPeriodEnd).isBefore(l()()), i = null != t && null != t.paymentSourceId ? eO.Z.getPaymentSource(t.paymentSourceId) : null, o = null != i && eb.Uk.has(i.type), a = null != t && t.status === eg.O0b.PAST_DUE && !r && o && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eg.kVF.POMELO_ELIGIBLE]: {
      predicate: () => (0, h.e)() && !eV(eg.kVF.POMELO_ELIGIBLE) && !(0, D.ov)()
    },
    [eg.kVF.UU_MIGRATION]: {
      predicate: () => (0, h.e)() && !eV(eg.kVF.UU_MIGRATION) && (0, D.ov)()
    },
    ...
    [eg.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: {
      predicate: () => !eV(eg.kVF.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== I.Z.getEligibleGuildsForNagActivate().length && (0, O.Lm)()
    },
