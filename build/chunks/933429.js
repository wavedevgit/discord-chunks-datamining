...
let ev = {
  ...
  eM = {
    [eg.kVF.GIFTING_PROMOTION_REMINDER]: s.z.GIFTING_PROMOTION_REMINDER
  },
  eL = {
...
function eG(e, t, n) {
  if (null == e) return;
  let r = eL[e];
  (null == r || t || c.K.set(r, !0), eZ.has(e) && (ek[e] = !0), null != n && null != r) ? c.K.set(eV(e), n.format("YYYY-MM-DDTHH:mm:ss.SSSZ")): c.K.remove(eV(e))
}
...
let eW = [eg.kVF.QUARANTINED, eg.kVF.AUTOMOD_QUARANTINED_USER_PROFILE, eg.kVF.VIEWING_ROLES, eg.kVF.INVITED_TO_SPEAK, eg.kVF.LURKING_GUILD, eg.kVF.VOICE_DISABLED, eg.kVF.NO_INPUT_DEVICES_DETECTED, eg.kVF.NO_INPUT_DETECTED, eg.kVF.HARDWARE_MUTE, eg.kVF.H264_DISABLED, eg.kVF.DISPATCH_ERROR, eg.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS, eg.kVF.SPOTIFY_AUTO_PAUSED, eg.kVF.WIN32_DEPRECATED_MESSAGE, eg.kVF.WIN7_8_DEPRECATED_MESSAGE, eg.kVF.MACOS_19_DEPRECATED_MESSAGE, eg.kVF.BLOCKED_BY_PROXY, eg.kVF.VOICE_CONNECTED_LAST_SESSION, eg.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION, eg.kVF.GUILD_RAID_NOTIFICATION, eg.kVF.GIFTING_PROMOTION_REMINDER, eg.kVF.QUESTS_PROGRESS_INTERRUPTION, eg.kVF.UNCLAIMED_ACCOUNT, eg.kVF.POMELO_ELIGIBLE, eg.kVF.PENDING_MEMBER, eg.kVF.CHECKOUT_RECOVERY_NAGBAR, eg.kVF.OUTBOUND_PROMOTION, eg.kVF.CORRUPT_INSTALLATION, eg.kVF.VIDEO_UNSUPPORTED_BROWSER, eg.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK, eg.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL, eg.kVF.STREAMER_MODE, eg.kVF.SCHEDULED_MAINTENANCE, eg.kVF.BOUNCED_EMAIL_DETECTED, eg.kVF.UNVERIFIED_ACCOUNT, eg.kVF.PREMIUM_TIER_2_TRIAL_ENDING, eg.kVF.PREMIUM_TIER_0_TRIAL_ENDING, eg.kVF.PREMIUM_UNCANCEL, eg.kVF.PREMIUM_MISSING_PAYMENT, eg.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT, eg.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT, eg.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT, eg.kVF.PREMIUM_REACTIVATE, eg.kVF.ACTIVATE_SERVER_SUBSCRIPTION, eg.kVF.MFA_SMS_BACKUP, eg.kVF.APPLICATION_TEST_MODE, eg.kVF.LOCALIZED_PRICING, eg.kVF.DOWNLOAD_NAG, eg.kVF.CONNECT_SPOTIFY, eg.kVF.CONNECT_PLAYSTATION, eg.kVF.SURVEY, eg.kVF.SERVER_USAGE_SURVEY, eg.kVF.SAFETY_USER_SENTIMENT_NAGBAR, eg.kVF.UU_MIGRATION, eg.kVF.BLOCK_USER_FEEDBACK_NAGBAR],
  ...
  ez = {
    ...
    [eg.kVF.NO_INPUT_DEVICES_DETECTED]: {
    ...
    [eg.kVF.SPOTIFY_AUTO_PAUSED]: {
      predicate: () => W.Z.wasAutoPaused()
    },
    [eg.kVF.BLOCKED_BY_PROXY]: {
      predicate: () => !ew(eg.kVF.BLOCKED_BY_PROXY) && F.Z.blockedByProxy && x.Z.getCurrentConfig({
    ...
    [eg.kVF.PENDING_MEMBER]: {
      predicate: e => {
        ...
        return null !== (r = null != i && null != l && !(null === (t = ee.Z.getGuild(i)) || void 0 === t ? void 0 : t.hasFeature(eg.oNc.GUILD_ONBOARDING)) && (null === (n = $.ZP.getMember(i, l.id)) || void 0 === n ? void 0 : n.isPending)) && void 0 !== r && r
      }
    },
    [eg.kVF.OUTBOUND_PROMOTION]: {
      predicate: () => (0, k.tq)()
    },
    [eg.kVF.CORRUPT_INSTALLATION]: {
      predicate: () => ef.isPlatformEmbedded && (!a.Z.supported() || eC.Z.isCorruptInstallation())
    },
    ...
    [eg.kVF.STREAMER_MODE]: {
      predicate: () => ec.Z.enabled
    },
    [eg.kVF.DOWNLOAD_NAG]: {
      predicate: () => !ef.isPlatformEmbedded && !ew(eg.kVF.DOWNLOAD_NAG)
    },
    ...
    [eg.kVF.SERVER_USAGE_SURVEY]: {
      predicate: e => {
        ...
        return null != t && P.Z.getCurrentConfig({
          location: "notice_store"
        }).showSurvey && !ew(eg.kVF.SERVER_USAGE_SURVEY)
      },
      metadata: e => {
        let {
          selectedGuildId: t,
    ...
    [eg.kVF.CONNECT_SPOTIFY]: {
      predicate: () => !W.Z.hasConnectedAccount() && f.ZP.isObservedAppRunning(E.Z.get(eg.ABu.SPOTIFY).name) && !ew(eg.kVF.CONNECT_SPOTIFY)
    },
    ...
    [eg.kVF.CONNECT_PLAYSTATION]: {
      predicate: () => J.Z.isSuggestedAccountType(eg.ABu.PLAYSTATION) && null == J.Z.getAccount(null, eg.ABu.PLAYSTATION) && !ew(eg.kVF.CONNECT_PLAYSTATION)
    },
    [eg.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: {
      predicate: () => eT.Z.getAlmostExpiringTrialOffers([eD.Si.TIER_2]).length > 0 && !ew(eg.kVF.PREMIUM_TIER_2_TRIAL_ENDING)
    },
    [eg.kVF.PREMIUM_TIER_0_TRIAL_ENDING]: {
      predicate: () => eT.Z.getAlmostExpiringTrialOffers([eD.Si.TIER_0]).length > 0 && !ew(eg.kVF.PREMIUM_TIER_0_TRIAL_ENDING)
    },
    [eg.kVF.PREMIUM_UNCANCEL]: {
      predicate: e => {
        let {
          ...
          currentUser: n
        } = e, r = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = (null == t ? void 0 : t.canceledAt) != null && (null == t ? void 0 : t.status) === eg.O0b.CANCELED && 1 >= l()().diff(l()(t.canceledAt), "days"), o = null != t && l()(t.currentPeriodEnd).isBefore(l()()), a = null != t && t.status === eg.O0b.CANCELED && !o && r <= 7 && r >= 0 && (0, eA.M5)(n, eD.p9.TIER_2) && !i && !n.hasFreePremium() && !t.isPurchasedExternally;
      ...
      metadata: e => {
        ...
        } = e, r = null != n ? l()(n.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = null != n ? null === (t = (0, eA.Af)(n)) || void 0 === t ? void 0 : t.planId : null;
        return {
          daysLeft: r,
    ...
    [eg.kVF.PREMIUM_MISSING_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = null != t ? l()(t.currentPeriodEnd).diff(l()(t.currentPeriodStart).startOf("day"), "days") : 0, o = null != t && l()(t.currentPeriodEnd).isBefore(l()()), a = eS.Z.applicationIdsFetched.has(eD.CL), s = eS.Z.getForApplication(eD.CL), c = null != t ? (0, eA.Af)(t) : null, u = null != c ? eA.ZP.getSkuIdForPlan(c.planId) : null, d = null != s && null != c && Array.from(s).filter(e => {
          let {
            skuId: t,
            consumed: n
          } = e;
          return !n && t === u
        }).length > 0, E = null != t && r <= (i > 14 ? 7 : 2) && r >= 0 && t.status !== eg.O0b.PAST_DUE && !o && a && !d && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eg.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && null != t.paymentSourceId ? eN.Z.getPaymentSource(t.paymentSourceId) : null, i = null != t && l()(t.currentPeriodEnd).isBefore(l()()), o = null != t && t.status === eg.O0b.PAST_DUE && !i && null != r && r.invalid && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eg.kVF.PREMIUM_REACTIVATE]: {
      predicate: () => !ew(eg.kVF.PREMIUM_REACTIVATE) && L.Z.shouldShowReactivateNotice()
    },
    ...
    [eg.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && l()(t.currentPeriodEnd).isBefore(l()()), i = null != t && null != t.paymentSourceId ? eN.Z.getPaymentSource(t.paymentSourceId) : null, o = null != i && eh.Uk.has(i.type), a = null != t && t.status === eg.O0b.PAST_DUE && !r && o && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eg.kVF.POMELO_ELIGIBLE]: {
      predicate: () => (0, U.e)() && !ew(eg.kVF.POMELO_ELIGIBLE) && !(0, b.ov)()
    },
    [eg.kVF.UU_MIGRATION]: {
      predicate: () => (0, U.e)() && !ew(eg.kVF.UU_MIGRATION) && (0, b.ov)()
    },
    ...
    [eg.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: {
      predicate: () => !ew(eg.kVF.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== N.Z.getEligibleGuildsForNagActivate().length && (0, I.Lm)()
    },
    [eg.kVF.SAFETY_USER_SENTIMENT_NAGBAR]: {
      predicate: e => {
        let {
    ...
    [eg.kVF.CHECKOUT_RECOVERY_NAGBAR]: {
      predicate: e => {
        ...
        return v.Z.getIsTargeted() && !(0, eA.I5)(n) && 0 !== Object.keys(r).length && (0, Z.Y)()
      }
    },
...
function eH() {
  ...
  for (let n of em.a ? eB : eW)
    ...
    (null === (n = eF.metadata) || void 0 === n ? void 0 : n.sampleRate) != null && null == ej[eF.type] && (ej[eF.type] = Math.random() <= eF.metadata.sampleRate);
    let e = !1 === ej[eF.type];
...
function eY() {
  return ec.Z.enabled || delete ek[eg.kVF.STREAMER_MODE], eH()
}
...
let eX = new eK(u.Z, {
  ...
  DISPATCH_APPLICATION_ERROR: function() {
    return delete ek[eg.kVF.DISPATCH_ERROR], eH()
  },
  DISPATCH_APPLICATION_LAUNCH_SETUP_START: function() {
    return delete ek[eg.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS], eH()
  },
