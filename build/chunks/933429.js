...
let eD = {
  ...
  eM = {
    [eN.kVF.GIFTING_PROMOTION_REMINDER]: s.z.GIFTING_PROMOTION_REMINDER
  },
  ej = {
    [eN.kVF.OUTBOUND_PROMOTION]: s.z.THIRD_PARTY_OUTBOUND_PROMO_NAGBAR
  },
  ex = {
...
let eV = [eN.kVF.QUARANTINED, eN.kVF.AUTOMOD_QUARANTINED_USER_PROFILE, eN.kVF.VIEWING_ROLES, eN.kVF.INVITED_TO_SPEAK, eN.kVF.LURKING_GUILD, eN.kVF.VOICE_DISABLED, eN.kVF.NO_INPUT_DEVICES_DETECTED, eN.kVF.NO_INPUT_DETECTED, eN.kVF.HARDWARE_MUTE, eN.kVF.H264_DISABLED, eN.kVF.DISPATCH_ERROR, eN.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS, eN.kVF.SPOTIFY_AUTO_PAUSED, eN.kVF.WIN32_DEPRECATED_MESSAGE, eN.kVF.WIN7_8_DEPRECATED_MESSAGE, eN.kVF.MACOS_19_DEPRECATED_MESSAGE, eN.kVF.BLOCKED_BY_PROXY, eN.kVF.VOICE_CONNECTED_LAST_SESSION, eN.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION, eN.kVF.GUILD_RAID_NOTIFICATION, eN.kVF.GIFTING_PROMOTION_REMINDER, eN.kVF.QUESTS_PROGRESS_INTERRUPTION, eN.kVF.UNCLAIMED_ACCOUNT, eN.kVF.POMELO_ELIGIBLE, eN.kVF.PENDING_MEMBER, eN.kVF.CHECKOUT_RECOVERY_NAGBAR, eN.kVF.OUTBOUND_PROMOTION, eN.kVF.CORRUPT_INSTALLATION, eN.kVF.VIDEO_UNSUPPORTED_BROWSER, eN.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK, eN.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL, eN.kVF.STREAMER_MODE, eN.kVF.SCHEDULED_MAINTENANCE, eN.kVF.BOUNCED_EMAIL_DETECTED, eN.kVF.UNVERIFIED_ACCOUNT, eN.kVF.PREMIUM_TIER_2_TRIAL_ENDING, eN.kVF.PREMIUM_TIER_0_TRIAL_ENDING, eN.kVF.PREMIUM_UNCANCEL, eN.kVF.PREMIUM_MISSING_PAYMENT, eN.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT, eN.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT, eN.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT, eN.kVF.PREMIUM_REACTIVATE, eN.kVF.ACTIVATE_SERVER_SUBSCRIPTION, eN.kVF.MFA_SMS_BACKUP, eN.kVF.APPLICATION_TEST_MODE, eN.kVF.DOWNLOAD_NAG, eN.kVF.CONNECT_SPOTIFY, eN.kVF.CONNECT_PLAYSTATION, eN.kVF.SURVEY, eN.kVF.SAFETY_USER_SENTIMENT_NAGBAR, eN.kVF.BLOCK_USER_FEEDBACK_NAGBAR, eN.kVF.IGNORE_USER_FEEDBACK_NAGBAR, eN.kVF.REPORT_TO_MOD_SURVEY],
  ...
  eW = {
    ...
    [eN.kVF.VOICE_DISABLED]: {
      predicate: () => null != ei.Z.getRemoteDisconnectVoiceChannelId()
    },
    [eN.kVF.VOICE_CONNECTED_LAST_SESSION]: {
      predicate: () => null != ei.Z.getLastSessionVoiceChannelId()
    },
    [eN.kVF.NO_INPUT_DETECTED]: {
      predicate: () => T.Z.hasActiveErrorOfType(h.u.NO_AUDIO_INPUT_DETECTED)
    },
    [eN.kVF.NO_INPUT_DEVICES_DETECTED]: {
      predicate: () => T.Z.hasActiveErrorOfType(h.u.NO_INPUT_DEVICES)
    },
    ...
    [eN.kVF.SPOTIFY_AUTO_PAUSED]: {
      predicate: () => V.Z.wasAutoPaused()
    },
    [eN.kVF.BLOCKED_BY_PROXY]: {
      predicate: () => !eG(eN.kVF.BLOCKED_BY_PROXY) && U.Z.blockedByProxy && L.Z.getCurrentConfig({
    ...
    [eN.kVF.OUTBOUND_PROMOTION]: {
      predicate: () => (0, k.tq)()
    },
    [eN.kVF.CORRUPT_INSTALLATION]: {
      predicate: () => eh.isPlatformEmbedded && (!o.Z.supported() || eg.Z.isCorruptInstallation())
    },
    ...
    [eN.kVF.STREAMER_MODE]: {
      predicate: () => es.Z.enabled
    },
    [eN.kVF.DOWNLOAD_NAG]: {
      predicate: () => !eh.isPlatformEmbedded && !eG(eN.kVF.DOWNLOAD_NAG)
    },
    ...
    [eN.kVF.CONNECT_SPOTIFY]: {
      predicate: () => !V.Z.hasConnectedAccount() && m.ZP.isObservedAppRunning(_.Z.get(eN.ABu.SPOTIFY).name) && !eG(eN.kVF.CONNECT_SPOTIFY)
    },
    ...
    [eN.kVF.CONNECT_PLAYSTATION]: {
      predicate: () => X.Z.isSuggestedAccountType(eN.ABu.PLAYSTATION) && null == X.Z.getAccount(null, eN.ABu.PLAYSTATION) && !eG(eN.kVF.CONNECT_PLAYSTATION)
    },
    [eN.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: {
      predicate: () => eO.Z.getAlmostExpiringTrialOffers([eb.Si.TIER_2]).length > 0 && !eG(eN.kVF.PREMIUM_TIER_2_TRIAL_ENDING)
    },
    [eN.kVF.PREMIUM_TIER_0_TRIAL_ENDING]: {
      predicate: () => eO.Z.getAlmostExpiringTrialOffers([eb.Si.TIER_0]).length > 0 && !eG(eN.kVF.PREMIUM_TIER_0_TRIAL_ENDING)
    },
    [eN.kVF.PREMIUM_UNCANCEL]: {
      predicate: e => {
        let {
          ...
          currentUser: n
        } = e, r = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = (null == t ? void 0 : t.canceledAt) != null && (null == t ? void 0 : t.status) === eN.O0b.CANCELED && 1 >= l()().diff(l()(t.canceledAt), "days"), a = null != t && l()(t.currentPeriodEnd).isBefore(l()()), o = null != t && t.status === eN.O0b.CANCELED && !a && r <= 7 && r >= 0 && (0, eT.M5)(n, eb.p9.TIER_2) && !i && !n.hasFreePremium() && !t.isPurchasedExternally;
      ...
      metadata: e => {
        ...
        } = e, r = null != n ? l()(n.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = null != n ? null == (t = (0, eT.Af)(n)) ? void 0 : t.planId : null;
        return {
          daysLeft: r,
    ...
    [eN.kVF.PREMIUM_MISSING_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, i = null != t ? l()(t.currentPeriodEnd).diff(l()(t.currentPeriodStart).startOf("day"), "days") : 0, a = null != t && l()(t.currentPeriodEnd).isBefore(l()()), o = ef.Z.applicationIdsFetched.has(eb.CL), s = ef.Z.getForApplication(eb.CL), c = null != t ? (0, eT.Af)(t) : null, u = null != c ? eT.ZP.getSkuIdForPlan(c.planId) : null, d = null != s && null != c && Array.from(s).filter(e => {
          let {
            skuId: t,
            consumed: n
          } = e;
          return !n && t === u
        }).length > 0, _ = null != t && r <= (i > 14 ? 7 : 2) && r >= 0 && t.status !== eN.O0b.PAST_DUE && !a && o && !d && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eN.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && null != t.paymentSourceId ? eE.Z.getPaymentSource(t.paymentSourceId) : null, i = null != t && l()(t.currentPeriodEnd).isBefore(l()()), a = null != t && t.status === eN.O0b.PAST_DUE && !i && null != r && r.invalid && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eN.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && l()(t.currentPeriodEnd).isBefore(l()()), i = null != t && t.status === eN.O0b.PAST_DUE && !r && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eN.kVF.PREMIUM_REACTIVATE]: {
      predicate: () => !eG(eN.kVF.PREMIUM_REACTIVATE) && x.Z.shouldShowReactivateNotice()
    },
    [eN.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, r = null != t && l()(t.currentPeriodEnd).isBefore(l()()), i = null != t && null != t.paymentSourceId ? eE.Z.getPaymentSource(t.paymentSourceId) : null, a = null != i && eA.Uk.has(i.type), o = null != t && t.status === eN.O0b.PAST_DUE && !r && a && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eN.kVF.POMELO_ELIGIBLE]: {
      predicate: () => (0, D.e)() && !eG(eN.kVF.POMELO_ELIGIBLE)
    },
    ...
    [eN.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: {
      predicate: () => !eG(eN.kVF.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== O.Z.getEligibleGuildsForNagActivate().length && (0, p.Lm)()
    },
    ...
    [eN.kVF.QUESTS_PROGRESS_INTERRUPTION]: {
      ...
      metadata: () => {
        let e = H.Z.getCurrentUserActiveStream();
        return {
          streamKey: null != e ? (0, N.V9)(e) : null
        }
      }
    },
