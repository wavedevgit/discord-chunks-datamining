...
function eK() {
  ...
  for (let n of em.a ? eW : ez)
    ...
    (null == (n = ex.metadata) ? void 0 : n.sampleRate) != null && null == eF[ex.type] && (eF[ex.type] = Math.random() <= ex.metadata.sampleRate);
    let e = !1 === eF[ex.type];
    (eB(ex.type) || e) && (ex = null)
  }
}
