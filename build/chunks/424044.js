...
let x = e => {
  let {
    location: t
  } = e, n = (0, o.e7)([m.default], () => m.default.isAuthenticated()), x = (0, o.e7)([d.Z], () => d.Z.hasLoadedExperiments), N = (0, h.oK)("RSL - Landing Page"), [v, E] = i.useState(!1), [I, j] = i.useState(_.NW.string(_.t["9exy+f"])), [S, O] = i.useState(!0), C = e => {
    switch (e) {
  ...
  return i.useEffect(() => {
    ...
    let e = async e => {
      ...
      try {
        ...
        null != n ? j(_.NW.string(_.t.e6mZMj)) : C(null === (t = n.body) || void 0 === t ? void 0 : t.code)
      } catch (e) {
