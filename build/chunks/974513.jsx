...
function x(e) {
  let {
    ...
    c ? (0, s.h7j)(n => <s.ConfirmModal{...h(p({
  ...
  return <div className={n}><s.eee onClick={u}><s.Text variant={"text-sm/medium"} color={"text-link"}>{c ? g.intl.string(g.t.OmpxW1) : g.intl.string(g.t.ozsQBA)}</s.Text></s.eee></div>
}