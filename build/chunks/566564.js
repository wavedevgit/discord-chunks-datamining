...
let P = e => {
    ...
    if (l.useEffect(() => {
      ...
      }, [P, y, k.length, O, h, E, c, d]), null != P) return (0, r.jsx)(g.Z, {
      onRetry: L,
      errorOrigin: g.i.SHOP_PAGE,
      errorMessage: P.message
    });
    if (y || 0 === k.length) return (0, r.jsxs)("div", {
  ...
  k = e => {
    let {
      ...
      tab: o,
      transitionState: p
    } = e, f = (0, d.R)("CollectiblesFeedShop"), g = (0, h.R)(), b = (0, u.sp)(), [m, _] = l.useState(x.IV), [C, v] = l.useState(!1);
    return l.useEffect(() => {
      if (null != n.current) {
        let e = () => {
