...
let x = e => {
    ...
    if (null != x) return (0, r.jsx)(d.Z, {
      onRetry: y,
      errorOrigin: d.i.SHOP_PAGE,
      errorMessage: x.message
    });
    if (C || 0 === O.length) return (0, r.jsxs)("div", {
    ...
    let S = (e, l) => {
      ...
      return (0, r.jsx)("div", {
        className: o()(v.blockContainer, {
          [v.topBlockContainer]: 0 === l
        }),
        children: c
      }, l)
    };
    return (0, r.jsx)(r.Fragment, {
      children: O.map((e, t) => S(e, t))
    })
  },
  O = e => {
    let {
    ...
    } = e, u = (0, c.R)("CollectiblesFeedShop");
    return (0, r.jsx)("div", {
      className: o()(v.shop, {
        [v.shopFullscreen]: t
      }),
      children: (0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(x, {
          ...
          isFetchingCategories: i,
          tab: a
        }), a !== _.AW.CATALOG && l >= u && (0, r.jsxs)("div", {
