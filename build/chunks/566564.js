...
let j = e => {
    ...
    if (l.useEffect(() => {
      ...
      }, [E, k, P.length, j, x, S, u, v]), null != E) return (0, r.jsx)(p.Z, {
      onRetry: B,
      errorOrigin: p.i.SHOP_PAGE,
      errorMessage: E.message
    });
    if (k || 0 === P.length) return (0, r.jsxs)("div", {
    ...
    let I = (e, t) => {
      ...
      return (0, r.jsx)("div", {
        className: o()(O.blockContainer, {
          [O.topBlockContainer]: 0 === t
        }),
        children: l
      }, t)
    };
