...
let L = e => {
    ...
    } = (0, _.Z)(), [S, j] = l.useState(!1), L = (0, d.sp)(), k = null != (t = null == L ? void 0 : L.sessionId) ? t : "";
    l.useEffect(() => {
      (0, g.n)({
        sessionId: k,
    ...
    if (l.useEffect(() => {
      ...
      }, [N, I, A.length, m, p, k, c, u]), null != N) return (0, n.jsx)(h.Z, {
      onRetry: w,
      errorOrigin: h.i.SHOP_PAGE,
      errorMessage: N.message
    });
    if (I || 0 === A.length) return (0, n.jsxs)("div", {
