...
let P = e => {
    ...
    } = (0, m.Z)(), v = (0, d.sp)(), x = null != (t = null == v ? void 0 : v.sessionId) ? t : "";
    l.useEffect(() => {
      (0, f.n)({
        sessionId: x,
  ...
  L = e => {
    let {
      ...
      tab: a,
      transitionState: g
    } = e, f = (0, p.R)("CollectiblesFeedShop"), h = (0, b.R)(), m = (0, d.sp)(), [_, C] = l.useState(x.IV), [O, E] = l.useState(!1);
    return l.useEffect(() => {
      if (null != n.current) {
        let e = () => {
