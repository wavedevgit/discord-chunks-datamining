...
let j = e => {
    ...
    } = (0, f.Z)(), x = (0, u.sp)(), j = null != (t = null == x ? void 0 : x.sessionId) ? t : "";
    l.useEffect(() => {
      (0, g.n)({
        sessionId: j,
    ...
    if (l.useEffect(() => {
      ...
      }, [P, y, k.length, S, O, j, c, d]), null != P) return (0, r.jsx)(b.Z, {
      onRetry: I,
  ...
  y = e => {
    ...
    } = e, p = (0, d.R)("CollectiblesFeedShop"), g = (0, u.sp)();
    return (0, r.jsx)("div", {
      className: i()(E.shop, {
        [E.shopFullscreen]: t
      }),
