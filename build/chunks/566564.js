...
let P = e => {
    ...
    } = (0, m.Z)(), [y, x] = l.useState(!1), j = (0, u.sp)(), P = null != (t = null == j ? void 0 : j.sessionId) ? t : "";
    l.useEffect(() => {
      (0, f.n)({
        sessionId: P,
    ...
    if (l.useEffect(() => {
      ...
      }, [k, L, I.length, E, b, P, c, d]), null != k) return (0, n.jsx)(g.Z, {
      onRetry: A,
      errorOrigin: g.i.SHOP_PAGE,
      errorMessage: k.message
    });
    if (L || 0 === I.length) return (0, n.jsxs)("div", {
  ...
  L = e => {
    let {
      ...
      tab: a,
      transitionState: p
    } = e, f = (0, d.R)("CollectiblesFeedShop"), g = (0, b.R)(), h = (0, u.sp)(), [m, _] = l.useState(y.IV), [C, O] = l.useState(!1);
    return l.useEffect(() => {
      if (null != r.current) {
        let e = () => {
      ...
      children: [(0, n.jsxs)("div", {
        ...
        children: [(0, n.jsx)(P, {
          ...
          tab: a,
          isFullScreen: t
        }), a !== y.AW.CATALOG && m >= f && (0, n.jsxs)("div", {
