...
let P = e => {
    ...
    } = (0, b.Z)(), S = (0, u.sp)(), E = null != (t = null == S ? void 0 : S.sessionId) ? t : "";
    l.useEffect(() => {
      (0, g.n)({
        sessionId: E,
    ...
    if (l.useEffect(() => {
      ...
      }, [P, j, k.length, O, h, E, c, d]), null != P) return (0, r.jsx)(f.Z, {
      onRetry: L,
  ...
  k = e => {
    let {
      ...
      tab: o,
      transitionState: p
    } = e, g = (0, d.R)("CollectiblesFeedShop"), f = (0, h.R)(), b = (0, u.sp)(), [m, _] = l.useState(S.IV), [C, v] = l.useState(!1);
    return l.useEffect(() => {
      if (null != n.current) {
        let e = () => {
