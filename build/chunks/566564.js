...
let L = e => {
    ...
    } = (0, _.Z)(), [S, j] = l.useState(!1), L = (0, d.sp)(), I = null != (t = null == L ? void 0 : L.sessionId) ? t : "";
    l.useEffect(() => {
      (0, g.n)({
        sessionId: I,
    ...
    if (l.useEffect(() => {
      ...
      }, [N, k, w.length, m, p, I, c, u]), null != N) return (0, n.jsx)(h.Z, {
      onRetry: B,
      errorOrigin: h.i.SHOP_PAGE,
      errorMessage: N.message
    });
    if (k || 0 === w.length) return (0, n.jsxs)("div", {
  ...
  I = e => {
    let {
      ...
      handleScroll: g
    } = (0, c.z)(f, i), h = (0, p.R)("CollectiblesFeedShop"), b = (0, m.R)(), _ = (0, d.sp)(), [O, v] = l.useState(x.IV), [C, E] = l.useState(!1);
    return l.useEffect(() => {
      if (null != f.current) {
        let e = () => {
