...
let L = e => {
    ...
    if (l.useEffect(() => {
      ...
      }, [k, L, I.length, m, p, T, c, u]), null != k) return (0, n.jsx)(h.Z, {
      onRetry: N,
  ...
  k = e => {
    let {
      ...
      tab: a,
      transitionState: g
    } = e, f = (0, p.R)("CollectiblesFeedShop"), h = (0, m.R)(), b = (0, d.sp)(), [_, C] = l.useState(x.IV), [O, v] = l.useState(!1);
    return l.useEffect(() => {
      if (null != r.current) {
        let e = () => {
      ...
      children: [(0, n.jsxs)("div", {
        ...
        children: [(0, n.jsx)(L, {
          ...
          tab: a,
          isFullScreen: t
        }), a !== x.AW.CATALOG && _ >= f && (0, n.jsxs)("div", {
