...
function y(e, t) {
  ...
  return !_ || null == e.reactions || 0 === e.reactions.length || e.isPoll() && !(0, l.eQ)(e) ? null : <a.sNh id={"remove-emoji-reactions"} label={h.intl.string(h.t["zx/e4O"])} color={"danger"}>{m.map(e => {
      var t, i;
...
function O(e) {
  ...
  return <img className={o} src={null != n.id ? f.ZP.getEmojiURL({
      id: n.id,
      animated: n.animated && (!i || a),
      size: 18
    }) : _.ZP.getURL(null != (t = n.name) ? t : "")} alt={""} />
}