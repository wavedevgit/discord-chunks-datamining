...
let f = [{
    key: "channelName",
    cellClassName: l()(Chunk616182.cell, Chunk616182.channelName),
    render(e) {
      let {
        channelName: t
      } = e;
    ...
    key: "channelId",
    cellClassName: l()(Chunk616182.cell, Chunk616182.channelId),
    render(e) {
      let {
        channelId: t
      } = e;
  ...
  x = [{
    ...
    key: "loadState",
    cellClassName: l()(Chunk616182.cell, Chunk616182.loadState),
    render(e) {
      let {
        loadState: t
      } = e;
