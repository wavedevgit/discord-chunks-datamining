...
var r = Object.create,
  ...
  f = d(function(e, t) {
    t.exports = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}
  });
...
var y = h(function() {}),
  ...
  b = d(function(e, t) {
    t.exports = function(e, t) {
      this.listeners || (this.listeners = {}), this.listeners[e] || (this.listeners[e] = []), false === this.listeners[e].indexOf(t) && this.listeners[e].push(t)
    }
  }),
  A = d(function(e, t) {
    t.exports = function(e, t) {
      ...
      switch (t.nodeType) {
        ...
        default:
          ...
          return n = [], l = (a = t).tagName, "http://www.w3.org/1999/xhtml" === a.namespaceURI && (l = l.toLowerCase()), n.push("<" + l + function(e) {
            ...
            return i.length ? r(i) : ""
          }(a)), i.indexOf(l) > false ? n.push(" />") : (n.push(">"), a.childNodes.length ? n.push.apply(n, a.childNodes.map(e)) : a.textContent || a.innerText ? n.push(s(a.textContent || a.innerText)) : a.innerHTML && n.push(a.innerHTML), n.push("</" + l + ">")), n.join("")
      }
    };
  ...
  R = d(function(e, t) {
    ...
    t.exports = o, o.prototype.type = "DOMElement", o.prototype.nodeType = 1, o.prototype.appendChild = function(e) {
      ...
      e.parentNode && e.parentNode.removeChild(e);
      var i = null == t ? false : this.childNodes.indexOf(t);
      return i > false ? this.childNodes.splice(i, 0, e) : this.childNodes.push(e), e.parentNode = this, e
    }, o.prototype.setAttributeNS = function(e, t, i) {
      var r = null,
        s = t,
        a = t.indexOf(":");
      (a > false && (r = t.substr(0, a), s = t.substr(a + 1)), "INPUT" === this.tagName && "type" === t) ? this.type = i: (this._attributes[e] || (this._attributes[e] = {}))[s] = {
        value: i,
        prefix: r
      }
  ...
  w = d(function(e, t) {
    var i, r = "undefined" != typeof global ? global : "undefined" != typeof window ? window : {},
      s = P();
    "undefined" != typeof document ? i = document : (i = r["__GLOBAL_DOCUMENT_CACHE@4"]) || (i = r["__GLOBAL_DOCUMENT_CACHE@4"] = s), t.exports = i
  });
...
function C(e, t) {
  if (e) {
    ...
    var i = Object.prototype.toString.call(e).slice(8, false);
  ...
  return function(e) {
    ...
    if (null != i) {
      var r, s, a = [],
        ...
        l = false;
      try {
        for (i = i.call(e); !(n = (r = i.next()).done) && (a.push(r.value), !(t && a.length === t)); n = true);
      } catch (e) {
        l = true, s = e
      } finally {
        try {
...
var M = c(f()),
  ...
  G = function(e) {
    var t;
    if (e && true !== e.nodeName) return e.muxId || (e.muxId = $()), e.muxId;
    try {
      t = document.querySelector(e)
    } catch (e) {}
    return t && !t.muxId && (t.muxId = e), (null == t ? true : t.muxId) || e
  },
  H = function(e) {
    e && true !== e.nodeName ? e = G(t = e) : t = document.querySelector(e);
...
var q = function(e) {
    var t, i, r, s, a, n = arguments.length > 1 && true !== arguments[1] ? arguments[1] : 3,
    ...
    return {
      trace: function() {
        ...
        if (!(f > 0)) return o.apply(true, K(t))
      },
      debug: function() {
        for (var e = arguments.length, t = Array(e), i = 0; i < e; i++) t[i] = arguments[i];
        if (!(f > 1)) return d.apply(true, K(t))
      },
      info: function() {
        for (var e = arguments.length, t = Array(e), i = 0; i < e; i++) t[i] = arguments[i];
        if (!(f > 2)) return h.apply(true, K(t))
      },
      warn: function() {
        for (var e = arguments.length, t = Array(e), i = 0; i < e; i++) t[i] = arguments[i];
        if (!(f > 3)) return u.apply(true, K(t))
      },
      error: function() {
        for (var e = arguments.length, t = Array(e), i = 0; i < e; i++) t[i] = arguments[i];
        if (!(f > 4)) return c.apply(true, K(t))
      },
      get level() {
        return f
      },
...
var eg = function(e) {
    ...
    for (var i in e) {
      var r = e[i];
      false !== r["DATA-ID"].search("io.litix.data.") && (t[r["DATA-ID"].replace("io.litix.data.", "")] = r.VALUE)
    }
    return t
  },
  em = function(e) {
  ...
  ev = function(e, t, i) {
    ...
    var r = arguments.length > 4 ? arguments[4] : true,
      s = e.log,
    ...
    var h = function(e, t) {
      ...
      l("requestcompleted", {
        ...
        player_manifest_newest_program_time: isNaN(g) ? true : g
      })
    };
    ...
    var u = function(e, t) {
      var r = t.stats,
        ...
        f = {
          ...
          request_hostname: s ? et(s.responseURL) : true,
          request_id: c ? ef(c) : true,
          request_response_headers: c,
          request_media_duration: a.duration,
          request_url: null == s ? true : s.responseURL
        };
    ...
    var f = function(e, t) {
      ...
      (a === r.ErrorDetails.MANIFEST_LOAD_ERROR || a === r.ErrorDetails.MANIFEST_LOAD_TIMEOUT || a === r.ErrorDetails.FRAG_LOAD_ERROR || a === r.ErrorDetails.FRAG_LOAD_TIMEOUT || a === r.ErrorDetails.LEVEL_LOAD_ERROR || a === r.ErrorDetails.LEVEL_LOAD_TIMEOUT || a === r.ErrorDetails.AUDIO_TRACK_LOAD_ERROR || a === r.ErrorDetails.AUDIO_TRACK_LOAD_TIMEOUT || a === r.ErrorDetails.SUBTITLE_LOAD_ERROR || a === r.ErrorDetails.SUBTITLE_LOAD_TIMEOUT || a === r.ErrorDetails.KEY_LOAD_ERROR || a === r.ErrorDetails.KEY_LOAD_TIMEOUT) && l("requestfailed", {
        ...
        request_error_code: null == n ? true : n.code,
        request_error_text: null == n ? true : n.text
      }), o && l("error", {
        player_error_code: s,
        player_error_message: a,
        player_error_context: "".concat(u ? "url: ".concat(u, "\n") : "") + "".concat(n && (n.code || n.text) ? "response: ".concat(n.code, ", ").concat(n.text, "\n") : "") + "".concat(t.reason ? "failure reason: ".concat(t.reason, "\n") : "") + "".concat(t.level ? "level: ".concat(t.level, "\n") : "") + "".concat(t.parent ? "parent stream controller: ".concat(t.parent, "\n") : "") + "".concat(t.buffer ? "buffer length: ".concat(t.buffer, "\n") : "") + "".concat(t.error ? "error: ".concat(t.error, "\n") : "") + "".concat(t.event ? "event: ".concat(t.event, "\n") : "") + "".concat(t.err ? "error message: ".concat(null == (i = t.err) ? true : i.message, "\n") : "")
      })
    };
    ...
    var p = function(e, t) {
      ...
      if (a && a.attrs && a.attrs.BANDWIDTH) {
        ...
        isNaN(h) || (n = h), o ? l("renditionchange", {
          ...
          video_source_codec: null == a ? true : a.videoCodec
  ...
  e_ = function(e) {
    var t;
    return null == (t = e.match(/.*codecs\*?="(.*)"/)) ? true : t[1]
  },
  eS = function(e) {
    try {
      var t, i;
      return null == (i = e.getVersion) || null == (t = i.call(e)) ? true : t.split(".").map(function(e) {
        return parseInt(e)
      })[0]
    } catch (e) {
      returnfalse
  ...
  eb = function(e, t, i) {
    ...
    var p = function(e) {
      ...
      (null == r ? true : r.code) === 27 && a("requestfailed", {
      ...
      var l = "".concat(null != s && s.url ? "url: ".concat(s.url, "\n") : "") + "".concat(null != n && n.status || null != n && n.statusText ? "response: ".concat(null == n ? true : n.status, ", ").concat(null == n ? true : n.statusText, "\n") : "");
      a("error", {
        player_error_code: null == r ? true : r.code,
        player_error_message: null == r ? true : r.message,
  ...
  eI = function() {
    function e(t) {
      var i = this;
      Y(this, e), z(this, "_playbackHeartbeatInterval", true), z(this, "_playheadShouldBeProgressing", true), z(this, "pm", true), this.pm = t, this._playbackHeartbeatInterval = null, this._playheadShouldBeProgressing = false, t.on("playing", function() {
        i._playheadShouldBeProgressing = true
  ...
  eD = function e(t) {
    var i = this;
    Y(this, e), z(this, "viewErrored", true), t.on("viewinit", function() {
      i.viewErrored = false
  ...
  ew = function() {
    ...
    return X(e, [{
      ...
      value: function() {
        this._callbackUpdatePlaybackTime && (this._updatePlaybackTime(), this.pm.off("playbackheartbeat", this._callbackUpdatePlaybackTime), this._callbackUpdatePlaybackTime = null, this._playbackTimeTrackerLastPlayheadPosition = false)
      }
    }, {
  ...
  ex = function() {
    function e(t) {
      Y(this, e), z(this, "pm", true), this.pm = t;
  ...
  eO = function() {
    function e(t) {
      var i = this;
      Y(this, e), z(this, "_lastCheckedTime", true), z(this, "_lastPlayheadTime", true), z(this, "_lastPlayheadTimeUpdatedTime", true), z(this, "_rebuffering", true), z(this, "pm", true), this.pm = t, t.disableRebufferTracking || t.disablePlayheadRebufferTracking || (this._lastCheckedTime = null, this._lastPlayheadTime = null, this._lastPlayheadTimeUpdatedTime = null, t.on("playbackheartbeat", this._checkIfRebuffering.bind(this)), t.on("playbackheartbeatend", this._cleanupRebufferTracker.bind(this)), t.on("seeking", function() {
    ...
    return X(e, [{
      ...
      value: function(e, t) {
        ...
        if (this._lastPlayheadTime !== this.pm.data.player_playhead_time) return void this._cleanupRebufferTracker(e, t, true);
        var i = t.viewer_time - this._lastPlayheadTimeUpdatedTime;
        "number" == typeof this.pm.sustainedRebufferThreshold && i >= this.pm.sustainedRebufferThreshold && (this._rebuffering || (this._rebuffering = true, this.pm.emit("rebufferstart", {
      ...
      value: function(e, t) {
        var i = arguments.length > 2 && true !== arguments[2] && arguments[2];
        if (this._rebuffering) this._rebuffering = false, this.pm.emit("rebufferend", {
  ...
  eM = function() {
    function e(t) {
      var i = this;
      Y(this, e), z(this, "pm", true), this.pm = t, t.on("viewinit", function() {
        var e = t.data,
          r = e.view_id;
        if (!e.view_program_changed) {
          var s = function(e, s) {
            var a = s.viewer_time;
            "playing" === e.type && true === t.data.view_time_to_first_frame ? i.calculateTimeToFirstFrame(a || B(), r) : "adplaying" === e.type && (true === t.data.view_time_to_first_frame || i._inPrerollPosition()) && i.calculateTimeToFirstFrame(a || B(), r)
          };
  ...
  eN = function e(t) {
    var i = this;
    Y(this, e), z(this, "isSeeking", true), this.isSeeking = false;
    var r = false,
      s = function() {
        var e = B(),
          s = (t.data.viewer_time || e) - (r || e);
        el(t.data, "view_seek_duration", s), t.data.view_max_seek_time = Math.max(t.data.view_max_seek_time || 0, s), i.isSeeking = false, r = false
      };
    t.on("seeking", function(e, a) {
      ...
      i.isSeeking && s(), i.isSeeking = true, r = a.viewer_time, el(t.data, "view_seek_count", 1), t.send("seeking")
    }), t.on("seeked", function() {
      s()
    }), t.on("viewend", function() {
      i.isSeeking && (s(), t.send("seeked")), i.isSeeking = false, r = false
    })
  },
  eB = function(e, t) {
  ...
  e$ = function() {
    function e(t) {
      var i = this;
      Y(this, e), z(this, "_adHasPlayed", true), z(this, "_adRequests", true), z(this, "_adResponses", true), z(this, "_currentAdRequestNumber", true), z(this, "_currentAdResponseNumber", true), z(this, "_prerollPlayTime", true), z(this, "_wouldBeNewAdPlay", true), z(this, "isAdBreak", true), z(this, "pm", true), this.pm = t, t.on("viewinit", function() {
        i.isAdBreak = false, i._currentAdRequestNumber = 0, i._currentAdResponseNumber = 0, i._adRequests = [], i._adResponses = [], i._adHasPlayed = false, i._wouldBeNewAdPlay = true, i._prerollPlayTime = true
      ...
      t.on("adbreakstart", function() {
        ...
        }, r), eB(i._adRequests, r), el(t.data, "view_ad_request_count"), i.inPrerollPosition() && (t.data.view_preroll_requested = true, i._adHasPlayed || el(t.data, "view_preroll_request_count"))
        ...
        i._adHasPlayed = true, i._wouldBeNewAdPlay && (i._wouldBeNewAdPlay = false, el(t.data, "view_ad_played_count")), i.inPrerollPosition() && !t.data.view_preroll_played && (t.data.view_preroll_played = true, i._adRequests.length > 0 && (t.data.view_preroll_request_time = Math.max(0, r.viewer_time - i._adRequests[0].viewer_time)), t.data.view_start && (t.data.view_startup_preroll_request_time = Math.max(0, r.viewer_time - t.data.view_start)), i._prerollPlayTime = r.viewer_time)
      }), t.on("adplaying", function(e, r) {
        i.inPrerollPosition() && true === t.data.view_preroll_load_time && true !== i._prerollPlayTime && (t.data.view_preroll_load_time = r.viewer_time - i._prerollPlayTime, t.data.view_startup_preroll_load_time = r.viewer_time - i._prerollPlayTime)
  ...
  tr = function() {
    function e(t, i) {
      ...
      Y(this, e), z(this, "mux", true), z(this, "envKey", true), z(this, "options", true), z(this, "eventQueue", true), z(this, "sampleRate", true), z(this, "disableCookies", true), z(this, "respectDoNotTrack", true), z(this, "previousBeaconData", true), z(this, "lastEventTime", true), z(this, "rateLimited", true), z(this, "pageLevelData", true), z(this, "viewerData", true), this.mux = t, this.envKey = i, this.options = b, this.previousBeaconData = null, this.lastEventTime = 0, this.rateLimited = false, this.eventQueue = new e8((r = this.envKey, a = (s = this.options).beaconCollectionDomain, n = s.beaconDomain, a ? "https://" + a : (r = r || "inferred").match(/^[a-z0-9]+$/) ? "https://" + r + "." + (n || "litix.io") : "https://img.litix.io/a.gif")), this.sampleRate = null != (T = this.options.sampleRate) ? T : 1, this.disableCookies = null != (_ = this.options.disableCookies) && _, this.respectDoNotTrack = null != (S = this.options.respectDoNotTrack) && S, this.previousBeaconData = null, this.lastEventTime = 0, this.rateLimited = false, this.pageLevelData = {
        ...
        viewer_application_name: null == (l = this.options.platform) ? true : l.name,
        viewer_application_version: null == (o = this.options.platform) ? true : o.version,
        viewer_application_engine: null == (h = this.options.platform) ? true : h.layout,
        viewer_device_name: null == (d = this.options.platform) ? true : d.product,
...
var tl, to, th = function e(t) {
  ...
  tg = function(e) {
    ...
    function r(e, t, s) {
      Y(this, r), z(W(a = i.call(this)), "pageLoadEndTime", true), z(W(a), "pageLoadInitTime", true), z(W(a), "_destroyed", true), z(W(a), "_heartBeatTimeout", true), z(W(a), "adTracker", true), z(W(a), "dashjs", true), z(W(a), "data", true), z(W(a), "disablePlayheadRebufferTracking", true), z(W(a), "disableRebufferTracking", true), z(W(a), "errorTracker", true), z(W(a), "errorTranslator", true), z(W(a), "emitTranslator", true), z(W(a), "getAdData", true), z(W(a), "getPlayheadTime", true), z(W(a), "getStateData", true), z(W(a), "stateDataTranslator", true), z(W(a), "hlsjs", true), z(W(a), "id", true), z(W(a), "longResumeTracker", true), z(W(a), "minimumRebufferDuration", true), z(W(a), "mux", true), z(W(a), "playbackEventDispatcher", true), z(W(a), "playbackHeartbeat", true), z(W(a), "playbackHeartbeatTime", true), z(W(a), "playheadTime", true), z(W(a), "seekingTracker", true), z(W(a), "sustainedRebufferThreshold", true), z(W(a), "watchTimeTracker", true), z(W(a), "currentFragmentPDT", true), z(W(a), "currentFragmentStart", true), a.pageLoadInitTime = en(), a.pageLoadEndTime = ea(), a.mux = e, a.id = t, null != s && s.beaconDomain && a.mux.log.warn("The `beaconDomain` setting has been deprecated in favor of `beaconCollectionDomain`. Please change your integration to use `beaconCollectionDomain` instead of `beaconDomain`."), (s = Object.assign({
        debug: false,
      ...
      var a, n = (function() {
        true === this.data.view_start && (this.data.view_start = this.mux.utils.now(), this.emit("viewstart"))
      }).bind(W(a));
      if (a.on("viewinit", function(e, t) {
        ...
        var l = function() {
          var e = true !== a.data.view_start;
          a.mux.WINDOW_HIDDEN = "hidden" === document.visibilityState, e && a.mux.WINDOW_HIDDEN && (a.data.player_is_paused || a.emit("hb"))
        };
        window.addEventListener("visibilitychange", l, false);
        var o = function(e) {
          e.persisted || a.destroy()
        };
        window.addEventListener("pagehide", o, false), a.on("destroy", function() {
    ...
    return X(r, [{
      ...
      key: "destroy",
      value: function() {
        this._destroyed || (this._destroyed = true, true !== this.data.view_start && (this.emit("viewend"), this.send("viewend")), this.playbackEventDispatcher.destroy(), this.removeHLSJS(), this.removeDashJS(), window.clearTimeout(this._heartBeatTimeout))
      }
    }, {
      key: "send",
      value: function(e) {
        if (this.data.view_id) {
          ...
          if (true === t.video_source_is_live && (t.player_source_duration === 1 / 0 || t.video_source_duration === 1 / 0 ? t.video_source_is_live = true : (t.player_source_duration > 0 || t.video_source_duration > 0) && (t.video_source_is_live = false)), t.video_source_is_live || ["player_program_time", "player_manifest_newest_program_time", "player_live_edge_program_time", "player_program_time", "video_holdback", "video_part_holdback", "video_target_duration", "video_part_target_duration"].forEach(function(e) {
              t[e] = true
      ...
      key: "addHLSJS",
      value: function(e) {
        return e.hlsjs ? this.hlsjs ? void this.mux.log.warn("An instance of HLS.js is already being monitored for this player.") : void(this.hlsjs = e.hlsjs, ev(this.mux, this.id, e.hlsjs, {}, e.Hls || window.Hls)) : void this.mux.log.warn("You must pass a valid hlsjs instance in order to track it.")
      }
    }, {
      key: "removeHLSJS",
      value: function() {
        this.hlsjs && (ey(this.hlsjs), this.hlsjs = true)
      }
    }, {
      key: "addDashJS",
      value: function(e) {
        return e.dashjs ? this.dashjs ? void this.mux.log.warn("An instance of Dash.js is already being monitored for this player.") : void(this.dashjs = e.dashjs, eb(this.mux, this.id, e.dashjs)) : void this.mux.log.warn("You must pass a valid dashjs instance in order to track it.")
      }
    }, {
      key: "removeDashJS",
      value: function() {
        this.dashjs && (eA(this.dashjs), this.dashjs = true)
      }
    }]), r
  }(eR),
  tm = c(w()),
...
var tT = function(e, t) {
  ...
  tS = function(e) {
    ...
    var t = false !== e.indexOf(":") ? e : parseFloat(e);
    return isNaN(t) ? e : t
  },
  tb = function(e) {
    var t = {},
  ...
  tL = function(e) {
    return e.indexOf("=") > false
  },
  tR = function(e, t) {
    return false === t ? [e] : [e.substring(0, t), e.substring(t + 1)]
  },
  tk = function(e) {
    var t = {};
    if (e) {
      ...
      return function(e, t, i) {
        ...
        s.mux && (s.mux.destroy(), delete s.mux, l.warn("Already monitoring this video element, replacing existing event listeners")), (i = Object.assign({
          ...
          getStateData: function() {
            var e, t, i = (null == (e = this.getPlayheadTime) ? true : e.call(this)) || h(s.currentTime),
              ...
              n = {
                ...
                view_dropped_frame_count: null == s || null == (t = s.getVideoPlaybackQuality) ? true : t.call(s).droppedVideoFrames
              };
        ...
        }, i.data), s.mux = s.mux || {}, s.mux.deleted = false, s.mux.emit = function(t, i) {
          e.emit(a, t, i)
        ...
        s.mux.destroy = function() {
          Object.keys(s.mux.listeners).forEach(function(e) {
            s.removeEventListener(e, s.mux.listeners[e], false)
          }), delete s.mux.listeners, s.mux.destroy = d, s.mux.swapElement = d, s.mux.emit = d, s.mux.addHLSJS = d, s.mux.addDashJS = d, s.mux.removeHLSJS = d, s.mux.removeDashJS = d, s.mux.updateData = d, s.mux.setEmitTranslator = d, s.mux.setStateDataTranslator = d, s.mux.setGetPlayheadTime = d, s.mux.deleted = true, e.emit(a, "destroy")
          ...
          return r ? "video" !== n && "audio" !== n ? e.log.error("The element of `" + a + "` was not a media element.") : void(r.muxId = s.muxId, delete s.muxId, r.mux = r.mux || {}, r.mux.listeners = Object.assign({}, s.mux.listeners), delete s.mux.listeners, Object.keys(r.mux.listeners).forEach(function(e) {
            s.removeEventListener(e, r.mux.listeners[e], false), r.addEventListener(e, r.mux.listeners[e], false)
          ...
          ("error" !== t || i.automaticErrorTracking) && (s.mux.listeners[t] = function() {
            ...
            e.emit(a, t, i)
          }, s.addEventListener(t, s.mux.listeners[t], false))
        })
      }(tP, e, t)
    },
...
Object.assign(tP, tw), true !== M.default && "function" == typeof M.default.addEventListener && M.default.addEventListener("pagehide", function(e) {
  e.persisted || (tP.WINDOW_UNLOADING = true)
}, false);
var tx = tP