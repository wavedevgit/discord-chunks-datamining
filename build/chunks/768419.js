...
function eb() {
  S.default.track(w.rMx.SPOTIFY_LISTEN_ALONG_ENDED, {
...
function eN(e) {
  ...
  return null != c && null != u && null != u.id && !!(0, P.Ps)(u.id) && (null != a && (n = a.context_uri), null != i && eb(), null != a && void((0, R.hY)(s.accountId, s.accessToken, c, null != (t = a.type) ? t : P.Hw.TRACK, {
    contextUri: n,
    deviceId: l.id
...
function eP() {
  ...
  es = !0, (0, R.wO)(t.accountId, t.accessToken), S.default.track(w.rMx.SPOTIFY_AUTO_PAUSED), J.info("Playback auto paused")
}
...
function ek(e) {
  ...
  if ((null == t ? void 0 : t.desktopSettings) != null) {
    ...
    null != e && E.ZP.getObservedAppNameForWindow(e) === M.name && n ? (el = new f.Xp).start(B, eP) : (null == el || el.stop(), el = null)
...
class eU extends(o = u.ZP.Store) {
  initialize() {
    this.waitFor(y.Z, I.Z), this.syncWith([v.Z], () => eR()), (0, R.k1)()
  }
  hasConnectedAccount() {
