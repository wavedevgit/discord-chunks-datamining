...
function C(e) {
  ...
  let {
    ...
    setSeenTutorial: P,
    closePopout: w
  } = e, R = l.useRef(null), [D, M] = (0, v.Ay)(R), {
    loadState: L,
    channels: G
  } = D, {
    maybeLoadMore: k
  } = M, U = (0, u.bG)([h.A], () => h.A.messageGroupSpacing);
  t = R, n = D, i = M, l.useLayoutEffect(() => {
    ...
    let a = null == (e = l.getScrollerNode()) ? true : e.children;
    if (null == a) return;
    let s = a[r];
    if (null == s) return;
    let {
    ...
    (s.offsetTop < o || s.offsetTop > o + c) && l.scrollTo({
      to: s.offsetTop
    })
  }), s = D, y = M, l.useEffect(() => {
    let e = () => {
    ...
    return m._.subscribe(x.jej.MARK_TOP_INBOX_CHANNEL_READ, e), () => {
      m._.unsubscribe(x.jej.MARK_TOP_INBOX_CHANNEL_READ, e)
    }
  }, [y, s.channels]), C = M, l.useEffect(() => {
    let e = e => {
  ...
  }, []), l.useEffect(() => (f.h.subscribe("CONNECTION_OPEN", w), () => {
    f.h.unsubscribe("CONNECTION_OPEN", w)
  }), [w]), (0, p.Ay)(() => (m._.subscribe(x.jej.INBOX_MARK_ALL_UNREADS_READ, M.markAllRead), () => {
  ...
  if (0 === G.length) {
    return (0, r.jsx)(O.A, {
      ...
      tip: (null == (I = o().os) ? true : I.family) === "OS X" ? E.intl.string(E.t.w9uDOW) : E.intl.string(E.t.BiUJC6)
    })
  }
  return (0, r.jsx)(c.hD, {
    navigator: V,
    children: (0, r.jsx)(c.PR, {
      children: e => {
        ...
        return (0, r.jsxs)(d.ChK, (t = function(e) {
          ...
          onScroll: L === v.mJ.Done ? true : k,
          className: a()(_.XG, "group-spacing-".concat(U)),
          children: [T ? (0, r.jsx)(S, {
            setSeenTutorial: P
          }) : null, (0, j.A)(G, M, N), L === v.mJ.Done ? null : (0, r.jsx)(d.y$y, {
            className: _.u1
          })]
