...
function C(e) {
  ...
  let {
    ...
    setSeenTutorial: P,
    closePopout: w
  } = e, R = l.useRef(null), [D, L] = (0, _.Ay)(R), {
    loadState: M,
    channels: G
  } = D, {
    maybeLoadMore: k
  ...
  }), [w]), (0, h.Ay)(() => (b._.subscribe(x.jej.INBOX_MARK_ALL_UNREADS_READ, L.markAllRead), () => {
    ...
    children: (0, r.jsx)(c.PR, {
      children: e => {
        ...
        return (0, r.jsxs)(d.ChK, (t = function(e) {
          ...
          onScroll: M === _.mJ.Done ? true : k,
          className: s()(E.XG, "group-spacing-".concat(U)),
          children: [T ? (0, r.jsx)(S, {
            setSeenTutorial: P
          }) : null, (0, j.A)(G, L, N), M === _.mJ.Done ? null : (0, r.jsx)(d.y$y, {
            className: E.u1
          })]
