...
let _ = function(e) {
  ...
  } = e, _ = t.filter(m.Io), x = (0, d.J)(n.guild_id), C = i.useCallback(() => {
    x ? (0, u.hk)(n.guild_id, () => s.default.selectVoiceChannel(n.id)) : s.default.selectVoiceChannel(n.id)
  }, [n.id, n.guild_id, x]), y = (0, c.Q3)("ChannelCallEmpty"), v = (0, o._q$)("ChannelCallEmpty"), j = 4 === _.length ? 2 : 3;
  return (0, r.jsxs)("div", {
    ...
    children: [y && (0, r.jsx)(f.Z, {}), (0, r.jsx)("div", {
      ...
      children: (0, r.jsx)(o.Text, {
        ...
        children: 0 === _.length ? g.intl.string(g.t.zSqdra) : 1 === _.length ? g.intl.formatToPlainString(g.t.BUyJIC, {
          a: (0, p.Z)(n, _[0])
        }) : 2 === _.length ? g.intl.formatToPlainString(g.t.dcyZf3, {
          a: (0, p.Z)(n, _[0]),
          b: (0, p.Z)(n, _[1])
        }) : _.length > 2 ? g.intl.formatToPlainString(g.t["44/Obm"], {
          a: (0, p.Z)(n, _[0]),
          b: (0, p.Z)(n, _[1]),
          n: _.length - 2
        }) : void 0
