...
let _ = function(e) {
  ...
  }, [n.id, n.guild_id, y]), x = (0, c.Q3)("ChannelCallEmpty"), v = (0, a._q$)("ChannelCallEmpty"), j = 4 === _.length ? 2 : 3;
  return (0, r.jsxs)("div", {
    ...
    children: [x && (0, r.jsx)(f.Z, {}), (0, r.jsx)("div", {
      ...
      children: (0, r.jsx)(a.Text, {
        ...
        children: 0 === _.length ? g.NW.string(g.t.zSqdra) : 1 === _.length ? g.NW.formatToPlainString(g.t.BUyJIC, {
          a: (0, p.Z)(n, _[0])
        }) : 2 === _.length ? g.NW.formatToPlainString(g.t.dcyZf3, {
          a: (0, p.Z)(n, _[0]),
          b: (0, p.Z)(n, _[1])
        }) : _.length > 2 ? g.NW.formatToPlainString(g.t["44/Obm"], {
          a: (0, p.Z)(n, _[0]),
          b: (0, p.Z)(n, _[1]),
          n: _.length - 2
        }) : void 0
