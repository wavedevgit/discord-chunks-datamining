...
let y = function(e) {
  ...
  } = e, y = t.filter(m.Io), _ = (0, d.J)(n.guild_id), C = i.useCallback(() => {
    _ ? (0, u.hk)(n.guild_id, () => s.default.selectVoiceChannel(n.id)) : s.default.selectVoiceChannel(n.id)
  }, [n.id, n.guild_id, _]), x = (0, c.Q3)("ChannelCallEmpty"), v = (0, a._q$)("ChannelCallEmpty"), j = 4 === y.length ? 2 : 3;
  return (0, r.jsxs)("div", {
    ...
    children: [x && (0, r.jsx)(f.Z, {}), (0, r.jsx)("div", {
      ...
      children: y.slice(0, 5).map(e => (0, r.jsx)(h.ZP, {
        participant: e,
        channel: n,
        className: b.tile,
        paused: !0,
      ...
      children: (0, r.jsx)(a.Text, {
        ...
        children: 0 === y.length ? g.NW.string(g.t.zSqdra) : 1 === y.length ? g.NW.formatToPlainString(g.t.BUyJIC, {
          a: (0, p.Z)(n, y[0])
        }) : 2 === y.length ? g.NW.formatToPlainString(g.t.dcyZf3, {
          a: (0, p.Z)(n, y[0]),
          b: (0, p.Z)(n, y[1])
        }) : y.length > 2 ? g.NW.formatToPlainString(g.t["44/Obm"], {
          a: (0, p.Z)(n, y[0]),
          b: (0, p.Z)(n, y[1]),
          n: y.length - 2
        }) : void 0
