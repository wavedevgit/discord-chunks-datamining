...
function I(e) {
  let {
    ...
    return a.fS(t, u.BO) && (t = C.Plq.ADMINISTRATOR), n => (0, i.jsx)(e, P(S({}, n), {
    ...
    children: [V > 0 ? (0, i.jsx)(c.Wn, {
      ...
      return M ? Y && (n = w.intl.string(w.t.XTwtW1)) : n = null != l ? w.intl.string(w.t.tybdam) : w.intl.string(w.t.z2hjk5), (0, i.jsx)(_.Z, {
        bar: (0, i.jsx)(c.ua7, {
          ...
          text: n,
          shouldShow: null != n,
          children: t => (0, i.jsx)(c.zxk, P(S({}, t), {
            variant: "secondary",
            disabled: Y || !M,
...
function E(e) {
  let t = (0, v.U)(e);
  return P(S({}, t), {
    results: t.results.roles.map(e => P(S({}, e), {
      type: d.Kw.ROLE
    })).concat(t.results.members.map(e => P(S({}, e), {
      type: d.Kw.USER
    })))
  })
}