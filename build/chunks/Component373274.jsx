...
let eg = e => {
  ...
  } = (0, b.ZP)(m.Z.GUILD_CHANNEL_LIST), d = (0, u.e7)([w.Z], () => w.Z.getChannel(n)), f = (0, u.e7)([w.Z], () => w.Z.getChannel(r)), h = (0, u.e7)([R.Z], () => R.Z.getGuildId()), _ = (0, C.DM)(t), y = l.useRef(null), O = l.useCallback((e, t) => {
    let n = y.current;
    if (null != n)
