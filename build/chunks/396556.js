/** Chunk was on 42604 **/
/** chunk id: 396556, original params: e,t,r (module,exports,require) **/
"use strict";
require.d(exports, {
  a: () => u
});
...
var a = ["canDrag", "beginDrag", "isDragging", "endDrag"],
  ...
  c = function() {
    ...
    return e = [{
        ...
        key: "endDrag",
        value: function() {
          this.props && this.spec.endDrag && this.spec.endDrag(this.props, this.monitor, (0, Chunk487146.Al)(this.ref))
        }
      }],
      function(e, t) {
