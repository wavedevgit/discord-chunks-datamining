...
function p(t) {
  ...
  return <form onSubmit={E}><r.I transitionState={e} trackingProps={{
        impression: f,
        impressionType: i.ImpressionTypes.MODAL
      }} graphic={{
        src: u,
        type: "image"
      }} title={h} subtitle={c.intl.string(c.t.SZJow8)} actions={[{
        ...
        loading: R,
        type: "submit"
      }]} onClose={d}><l.Kqy gap={8}>{<l.xJW title={c.intl.string(c.t["8mZX6O"])} error={b}><l.oil value={S} onChange={w} inputRef={v} /></l.xJW>}{<l.Text variant={"text-sm/normal"}>{c.intl.format(c.t.P0sak5, {
            onResend: A
          })}</l.Text>}</l.Kqy></r.I></form>
}