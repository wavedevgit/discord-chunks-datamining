...
function b(e) {
  ...
  } = e, O = (0, a.e7)([f.default], () => f.default.getId()), v = (null == (t = n.inviter) ? void 0 : t.id) === O, I = n.state === m.r2o.ACCEPTING, {
  ...
  let C = S ? A : N,
    w = g.intl.string(g.t.ib7Ng4),
    R = u.Z.Button.Colors.GREEN;
  S ? (w = g.intl.string(g.t.xhxnPj), R = u.Z.Button.Colors.PRIMARY) : v && (w = g.intl.string(g.t.ib7Ng4), R = u.Z.Button.Colors.PRIMARY);
  let P = v ? g.intl.string(g.t.eQyu1N) : g.intl.string(g.t.PYJHW1),
