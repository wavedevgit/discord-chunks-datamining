...
function v(e) {
  ...
  } = e, y = (0, a.e7)([p.default], () => p.default.getId()), x = (null === (t = n.inviter) || void 0 === t ? void 0 : t.id) === y, j = n.state === g.r2o.ACCEPTING, {
    analyticsLocations: O
  } = (0, c.ZP)(s.Z.INVITE_EMBED), E = (0, a.e7)([f.Z], () => {
    var e;
  ...
  E ? (S = _.NW.string(_.t.xhxnPj), T = d.Z.Button.Colors.PRIMARY) : x && (S = _.NW.string(_.t.ib7Ng4), T = d.Z.Button.Colors.PRIMARY);
