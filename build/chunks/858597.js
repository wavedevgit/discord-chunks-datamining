...
let C = function(t) {
  let {
    ...
    warningType: a,
    transitionToSlide: g
  } = t, C = (0, S.o)(), L = (0, S.Q)(), y = (0, x.q)(s), k = null != (0, p.M)(s), I = (0, o.e7)([b.Z], () => b.Z.isIgnored(e), [e]), M = (0, o.e7)([b.Z], () => b.Z.isBlocked(e), [e]), v = r.useCallback(t => {
    (0, h.qc)({
      channelId: s,
      warningId: l,
      senderId: e,
  ...
  }, [s, l, e, a, k]), F = r.useCallback(() => {
    (0, c.Mr3)(f.X_), v(h.NM.USER_SAFETY_TOOLS_BLOCK_CONFIRM)
  }, [v]), P = r.useCallback(() => {
    u.Z.unblockUser(e, {
      location: f.DL
    }), v(h.NM.USER_SAFETY_TOOLS_UNBLOCK)
  }, [e, v]), Z = r.useCallback(() => {
    ...
    onPress: () => {
      M ? (P(), _.Z.showUnblockSuccessToast(e, s)) : (0, c.ZDy)(async () => {
        let {
          default: t
