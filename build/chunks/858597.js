...
let C = function(t) {
  let {
    ...
    warningType: a,
    transitionToSlide: g
  } = t, C = (0, S.o)(), L = (0, S.Q)(), y = (0, x.q)(s), k = null != (0, p.M)(s), M = (0, o.e7)([b.Z], () => b.Z.isIgnored(e), [e]), I = (0, o.e7)([b.Z], () => b.Z.isBlocked(e), [e]), v = r.useCallback(t => {
    (0, h.qc)({
      channelId: s,
      warningId: l,
      senderId: e,
    ...
    onPress: () => {
      I ? (P(), _.Z.showUnblockSuccessToast(e, s)) : (0, c.ZDy)(async () => {
        let {
          default: t
