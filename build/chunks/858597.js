...
let L = function(t) {
  let {
    ...
    warningType: a,
    transitionToSlide: R
  } = t, L = (0, _.o)(), y = (0, _.Q)(), M = (0, p.q)(s), I = null != (0, O.M)(s), v = (0, o.e7)([x.Z], () => x.Z.isIgnored(e), [e]), F = (0, o.e7)([x.Z], () => x.Z.isBlocked(e), [e]), k = r.useCallback(t => {
    (0, A.qc)({
      channelId: s,
      warningId: l,
      senderId: e,
  ...
  }, [s, l, e, a, I]), P = r.useCallback(() => {
    (0, u.Mr3)(N.X_), k(A.NM.USER_SAFETY_TOOLS_BLOCK_CONFIRM)
  }, [k]), Z = r.useCallback(() => {
    d.Z.unblockUser(e, {
      location: N.DL
    }), k(A.NM.USER_SAFETY_TOOLS_UNBLOCK)
  }, [e, k]), Y = r.useCallback(() => {
    ...
    onPress: () => {
      F ? (Z(), b.Z.showUnblockSuccessToast(e, s)) : (0, u.ZDy)(async () => {
        let {
          default: t
