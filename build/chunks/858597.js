...
let C = function(t) {
  let {
    ...
    warningType: a,
    transitionToSlide: g
  } = t, C = (0, S.o)(), L = (0, S.Q)(), y = (0, N.q)(i), k = null != (0, x.M)(i), I = (0, l.e7)([b.Z], () => b.Z.isIgnored(e), [e]), M = (0, l.e7)([b.Z], () => b.Z.isBlocked(e), [e]), v = s.useCallback(t => {
    (0, O.qc)({
      channelId: i,
      warningId: o,
      senderId: e,
  ...
  }, [i, o, e, a, k]), F = s.useCallback(() => {
    (0, c.Mr3)(E.X_), v(O.NM.USER_SAFETY_TOOLS_BLOCK_CONFIRM)
  }, [v]), P = s.useCallback(() => {
    u.Z.unblockUser(e, {
      location: E.DL
    }), v(O.NM.USER_SAFETY_TOOLS_UNBLOCK)
  }, [e, v]), W = s.useCallback(() => {
    ...
    onPress: () => {
      M ? (P(), _.Z.showUnblockSuccessToast(e, i)) : (0, c.ZDy)(async () => {
        let {
          default: t
  ...
  return (0, r.jsxs)(A.Z, {
    children: [(0, r.jsx)(R, {
      children: Z.map(t => w(t))
    }), (0, r.jsx)(R, {
      children: Y.map(t => w(t))
    }), (0, r.jsx)(R, {
      children: U.map(t => w(t))
    })]
  })
}