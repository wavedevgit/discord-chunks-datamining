...
function N() {
  let {
    activeVoice: e
  } = (0, m.o)(), t = (0, l.e7)([_.Z], () => _.Z.getVoiceFilterPlaybackEnabled()), n = i.useCallback(() => {
...
function C(e) {
  ...
  let {} = e, {
    ...
    toggleLoopback: u,
    isLoopbackEnabled: f
  } = N(), _ = f ? c.Iy5 : c.X_q, b = i.useCallback(() => (0, p.v6)(null), []), O = (0, c.dQu)(c.TVs.colors.BACKGROUND_BASE_LOWER).hex(), C = (0, c.dQu)(c.TVs.colors.WHITE).hex(), w = i.useRef(0), R = n !== a ? w.current + 1 : w.current;
  i.useEffect(() => {
    w.current = R
  }, [R]);
  let P = null != n,
    ...
    U = (0, c.Yzy)(null == l ? void 0 : l.iconURL, {
      key: R,
      from: {
        opacity: 0,
        scale: 80 / 88,
    ...
    G = (0, c.Yzy)(null == l ? void 0 : l.name, {
      key: R,
      from: {
        opacity: 0,
        scale: L ? .9 : 1,
