...
function N(e) {
  ...
  }(), S = I ? c.Iy5 : c.X_q, T = i.useCallback(() => (0, f.v6)(null), []), P = (0, c.dQu)(c.TVs.colors.BACKGROUND_SECONDARY).hex(), A = (0, c.dQu)(c.TVs.colors.WHITE).hex(), w = i.useRef(0), Z = n !== a ? w.current + 1 : w.current;
  i.useEffect(() => {
    w.current = Z
  }, [Z]);
  let k = null != n,
    ...
    B = (0, c.Yzy)(null == N ? void 0 : N.name, {
      key: Z,
      from: {
        opacity: 0,
        scale: null == a ? 1 : .5,
  ...
  return (0, r.jsxs)(l.animated.div, {
    ...
    children: [(0, r.jsx)("div", {
    ...
    }), W(e => (0, r.jsx)(l.animated.div, {
      className: b.bgGradient,
      style: e
    })), (0, r.jsx)("div", {
      className: b.iconWrapper,
      children: U((e, t) => (0, r.jsx)(l.animated.img, {
      ...
      children: B((e, t) => (0, r.jsxs)(l.animated.div, {
