...
function I(e) {
  ...
  }(), P = T ? c.Iy5 : c.X_q, A = i.useCallback(() => (0, h.v6)(null), []), w = (0, c.dQu)(c.TVs.colors.BACKGROUND_SECONDARY).hex(), Z = (0, c.dQu)(c.TVs.colors.WHITE).hex(), k = (0, s.e7)([f.Z], () => f.Z.isConnected()), R = i.useRef(0), D = n !== a ? R.current + 1 : R.current;
  i.useEffect(() => {
    R.current = D
  }, [D]);
  let L = null != n,
