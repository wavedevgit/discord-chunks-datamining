...
let el = e => {
      ...
      children: [(0, r.jsx)(Y.Qj, er(en({
        onClick: () => {
          ...
          h ? (z.default.track(Q.rMx.GIFT_INTENT_BADGE_CLICKED, {
            gift_intent_type: J.hX.FRIEND_ANNIVERSARY
          }), e = Q.pJs.ALL, b.Z.setSection(Q.pJs.ALL), (0, Z.Gk)()) : e = F.ZP.getState().section, (0, O.Z)({
            tab_opened: e
          })
        },
  ...
  ea = e => {
    ...
    } = e, i = ei(e, ["selected", "hideGameUpdateProgressIndicator"]);
    ...
    return (0, r.jsx)(Y.Qj, er(en({
      ...
      children: (0, r.jsx)(q.Z, {
        className: a()(et.downloadProgressCircle, {
  ...
  return (0, r.jsxs)("nav", {
    ...
    children: [(0, r.jsx)(k.Z, {
      ...
      children: (0, r.jsx)("div", {
        ref: g,
        className: a()(et.searchBar, {
          [et.themedHeaderMobile]: u.tq
        }),
    ...
    }), (0, r.jsxs)(K.Z, er(en({}, e), {
      version: h,
      selectedChannelId: p,
      showDMHeader: !0,
      listScrollerRef: b,
      children: [(0, r.jsx)(el, {
        selected: null != h ? h === Q.Z5c.FRIENDS : l === Q.Z5c.FRIENDS
      ...
      }, "library") : null, c ? (0, r.jsx)(es, {
        selected: null == h ? null != l && l.startsWith(Q.Z5c.MESSAGE_REQUESTS) : h === Q.Z5c.MESSAGE_REQUESTS
      ...
      }, "discord-shop"), d ? (0, r.jsx)(ec, {
        selected: null != l && l.startsWith(Q.Z5c.FAMILY_CENTER) || null != h && h.startsWith(Q.Z5c.FAMILY_CENTER)
      }, "family-center") : null, (0, r.jsx)(ef, {}, "section-divider-top")]
    }))]
  })
});
...
function eg() {
  let e = (0, d.e7)([B.Z], () => B.Z.getHomeLink()),
    ...
    u = (0, w.i)({
      selected: null == c ? t : c.startsWith(Q.Z5c.APPLICATION_STORE)
    }),
    p = (0, N.a)(),
    h = function() {
