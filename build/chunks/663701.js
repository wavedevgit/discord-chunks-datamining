...
let es = e => {
  ...
  ep = e => {
    let {
      selected: t
    } = e, n = en.intl.string(er.default.Rkdixs), l = (0, c.JA)("family-center"), [a, o] = i.useState(!0);
    return (0, r.jsx)(X.Qj, ea(el({
      selected: t,
  ...
  return (0, r.jsxs)("nav", {
    ...
    children: [(0, r.jsx)(G.Z, {
      ...
      children: [(0, r.jsx)(es, {
        ...
        selected: g === $.Z5c.COLLECTIBLES_SHOP || (null == l ? void 0 : l.startsWith($.Z5c.COLLECTIBLES_SHOP)),
        listItemRef: b,
        listScrollerRef: _,
        locationState: {
          analyticsSource: {
