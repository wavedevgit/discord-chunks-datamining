...
let er = e => {
    ...
    i.useEffect(() => {
      h && (0, E.h)({
        ...
        properties: {
          gift_intent_type: X.hX.FRIEND_ANNIVERSARY
        }
      })
    }, [h]);
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(z.Qj, et(ee({
        onClick: () => {
          h && (H.default.track(K.rMx.GIFT_INTENT_BADGE_CLICKED, {
            gift_intent_type: X.hX.FRIEND_ANNIVERSARY
          }), b.Z.setSection(K.pJs.ALL), (0, A.Gk)())
        },
  ...
  ei = e => {
    ...
    } = e, i = en(e, ["selected", "hideGameUpdateProgressIndicator"]);
    let l = (0, c.JA)("library");
    return (0, r.jsx)(z.Qj, et(ee({
      selected: t,
      ...
      children: (0, r.jsx)(Y.Z, {
        className: a()($.downloadProgressCircle, {
          [$.hideGameUpdateProgressIndicator]: n
        })
      })
    }))
  ...
  eo = e => {
    let {
      selected: t
    } = e, n = Q.intl.string(J.default.Rkdixs), l = (0, c.JA)("family-center"), [a, o] = i.useState(!0);
    return (0, r.jsx)(z.Qj, et(ee({
      selected: t,
...
let ed = i.memo(function(e) {
  ...
  return (0, r.jsxs)("nav", {
    ...
    children: [(0, r.jsx)(D.Z, {
    ...
    }), (0, r.jsxs)(W.Z, et(ee({}, e), {
      version: h,
      selectedChannelId: p,
      showDMHeader: !0,
      listScrollerRef: b,
      children: [(0, r.jsx)(er, {
        selected: null != h ? h === K.Z5c.FRIENDS : l === K.Z5c.FRIENDS
      }, "friends"), n && t ? (0, r.jsx)(ei, {
        ...
        selected: null == h ? null != l && l.startsWith(K.Z5c.MESSAGE_REQUESTS) : h === K.Z5c.MESSAGE_REQUESTS
      }, "message-requests") : null, s ? (0, r.jsx)(x.g, {
      ...
      }, "discord-shop"), d ? (0, r.jsx)(eo, {
        selected: null != l && l.startsWith(K.Z5c.FAMILY_CENTER) || null != h && h.startsWith(K.Z5c.FAMILY_CENTER)
      }, "family-center") : null, (0, r.jsx)(ep, {}, "section-divider-top")]
    }))]
  })
});
...
function eh() {
  let e = (0, d.e7)([V.Z], () => V.Z.getHomeLink()),
    ...
    u = (0, x.i)({
      selected: null == c ? t : c.startsWith(K.Z5c.APPLICATION_STORE)
    }),
    p = (0, S.a)(),
    h = function() {
