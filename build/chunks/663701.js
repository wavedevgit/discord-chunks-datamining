...
let el = e => {
  ...
  ec = e => {
    let {
      selected: t
    } = e, n = $.NW.string(ee.Z.Rkdixs), l = (0, c.JA)("family-center"), [a, o] = i.useState(!0);
    return (0, r.jsx)(Y.Qj, er(en({
      selected: t,
...
let eh = i.memo(function(e) {
  let {
    ...
    selectedChannelId: g,
    path: m
  } = e, b = i.useRef(null), _ = i.useRef(null), E = i.useRef(null);
  return (0, r.jsxs)("nav", {
    ...
    children: [(0, r.jsx)(M.Z, {
      ...
      children: (0, r.jsx)("div", {
        ...
        children: s ? (0, r.jsx)(f.zxk, {
          ...
          type: "button",
          className: a()(et.searchBarComponent, {
            [et.themedSearchBarMobile]: u.tq
          }),
          onClick: ed,
          children: $.NW.string($.t.LzcpeX)
        })
