      ...
      children: [(0, r.jsx)(z.Qj, et(ee({
        onClick: () => {
          h && (H.default.track(K.rMx.GIFT_INTENT_BADGE_CLICKED, {
            gift_intent_type: X.hX.FRIEND_ANNIVERSARY
          }), m.Z.setSection(K.pJs.ALL), (0, A.Gk)())
        },
...
let ed = i.memo(function(e) {
  let {
    ...
    selectedChannelId: h,
    path: g
  } = e, m = i.useRef(null), b = i.useRef(null), _ = i.useRef(null);
  return (0, r.jsxs)("nav", {
    ...
    children: [(0, r.jsx)(D.Z, {
      ...
      children: (0, r.jsx)("div", {
        ...
        children: s ? (0, r.jsx)(f.zxk, {
          ...
          type: "button",
          className: a()($.searchBarComponent, {
            [$.themedSearchBarMobile]: u.tq
          }),
          onClick: ec,
          children: Q.intl.string(Q.t.LzcpeX)
        })
      ...
      listScrollerRef: _,
      children: [(0, r.jsx)(er, {
        selected: null != g ? g === K.Z5c.FRIENDS : l === K.Z5c.FRIENDS
        ...
        selected: null != l && l.startsWith(K.Z5c.FAMILY_CENTER) || null != g && g.startsWith(K.Z5c.FAMILY_CENTER)
      }, "family-center") : null, s ? (0, r.jsx)(ep, {}, "section-divider-top") : null]
    }))]
  })
});
