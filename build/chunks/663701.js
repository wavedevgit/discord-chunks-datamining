...
let en = e => {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(F.Qj, ee($({
        onClick: () => {
          h && (V.default.track(Y.rMx.GIFT_INTENT_BADGE_CLICKED, {
            gift_intent_type: q.hX.FRIEND_ANNIVERSARY
          }), m.Z.setSection(Y.pJs.ALL), (0, j.Gk)())
        },
  ...
  er = e => {
    ...
    } = e, i = et(e, ["selected", "hideGameUpdateProgressIndicator"]);
  ...
  return (0, r.jsxs)("nav", {
    ...
    children: [(0, r.jsx)(R.Z, {
      ...
      children: (0, r.jsx)("div", {
        ref: g,
        className: a()(J.searchBar, {
          [J.themedHeaderMobile]: u.tq
        }),
      ...
      listScrollerRef: b,
      children: [(0, r.jsx)(en, {
        selected: null != h ? h === Y.Z5c.FRIENDS : l === Y.Z5c.FRIENDS
      }, "friends"), n && t ? (0, r.jsx)(er, {
      ...
      }, "library") : null, c ? (0, r.jsx)(el, {
        selected: null == h ? null != l && l.startsWith(Y.Z5c.MESSAGE_REQUESTS) : h === Y.Z5c.MESSAGE_REQUESTS
      }, "message-requests") : null, s ? (0, r.jsx)(Z.g, {
      ...
      }, "discord-shop"), d ? (0, r.jsx)(ea, {
        selected: null != l && l.startsWith(Y.Z5c.FAMILY_CENTER) || null != h && h.startsWith(Y.Z5c.FAMILY_CENTER)
      }, "family-center") : null, (0, r.jsx)(ed, {}, "section-divider-top")]
    }))]
  })
});
...
function ep() {
  let e = (0, d.e7)([B.Z], () => B.Z.getHomeLink()),
    ...
    u = (0, Z.i)({
      selected: null == c ? t : c.startsWith(Y.Z5c.APPLICATION_STORE)
    }),
    p = (0, C.a)(),
    h = function() {
