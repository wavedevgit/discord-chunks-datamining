      ...
      children: [(0, r.jsx)(Y.Qj, er(en({
        onClick: () => {
          ...
          h ? (z.default.track(X.rMx.GIFT_INTENT_BADGE_CLICKED, {
            gift_intent_type: J.hX.FRIEND_ANNIVERSARY
          }), e = X.pJs.ALL, b.Z.setSection(X.pJs.ALL), (0, Z.Gk)()) : e = F.ZP.getState().section, (0, O.Z)({
            tab_opened: e
          })
        },
...
let eh = i.memo(function(e) {
  ...
  return (0, r.jsxs)("nav", {
    ...
    children: [(0, r.jsx)(k.Z, {
      ...
      listScrollerRef: b,
      children: [(0, r.jsx)(el, {
        selected: null != h ? h === X.Z5c.FRIENDS : l === X.Z5c.FRIENDS
        ...
        selected: null == h ? null != l && l.startsWith(X.Z5c.MESSAGE_REQUESTS) : h === X.Z5c.MESSAGE_REQUESTS
        ...
        selected: null != l && l.startsWith(X.Z5c.FAMILY_CENTER) || null != h && h.startsWith(X.Z5c.FAMILY_CENTER)
...
function eg() {
  let e = (0, d.e7)([B.Z], () => B.Z.getHomeLink()),
    ...
    u = (0, w.i)({
      selected: null == c ? t : c.startsWith(X.Z5c.APPLICATION_STORE)
    }),
    p = (0, N.a)(),
    h = function() {
