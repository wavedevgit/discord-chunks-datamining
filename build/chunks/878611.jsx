...
let f = {
  ...
  react(e, t, n) {
    ...
    return null == i && (null != u || "@everyone" === f || "@here" === f) ? <o.Z{...d(c({
      inlinePreview: n.formatInline
    }, e), {
      children: t(e.content, n)
    })} /> : <a.Z className={"mention"} userId={i} channelId={s} viewingChannelId={_} parsedUserId={l} content={t(e.content, n)} inlinePreview={n.noStyleAndInteraction} />
  }
}