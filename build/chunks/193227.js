...
function T(e) {
  ...
  let {
    ...
    currentPage: c,
    handlePageChange: u
  } = e, g = (0, d.sp)(), f = (0, v.R)(), h = null != (t = null == g ? void 0 : g.sessionId) ? t : "", {
    noCache: _,
    includeUnpublished: O
  } = (0, C.Z)(), y = l.useMemo(() => n.filter(e => null == e.unpublishedAt || e.unpublishedAt > new Date).filter(e => {
    let {
      products: t
    } = e;
    return t.length > 0
