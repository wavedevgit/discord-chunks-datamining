...
function Z(e) {
  ...
  } = e, n = (0, _.GG)(null == t ? void 0 : t.id)[0];
  return null != t && null != n ? (0, i.jsx)("div", {
    className: P.formItem,
    children: n.subscription_listings_ids.map(e => (0, i.jsx)(x.Z, {
      guildId: t.id,
      groupListingId: e,
      listingId: e
    }, e))
...
let w = function() {
  let [e, t] = r.useState(A.Si.TIER_2), [n, _] = r.useState(null), x = (0, a.Wu)([I.Z], () => I.Z.getGuildsArray()), [w] = (0, a.Wu)([N.ZP], () => [N.ZP.getPremiumSubscription()]);
  (0, S.t)();
  let k = x.map(e => ({
      value: e,
      label: e.name
