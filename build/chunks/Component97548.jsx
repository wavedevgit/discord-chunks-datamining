...
function I(e) {
  ...
  let T, C, N, {
    ...
    } = (I = V && Y || z && U, j = !V && Y || !z && U, T = (0, l.yK)([h.A], () => null == W ? [] : h.A.getAllActiveStreamsForChannel(W)), C = r.useMemo(() => new Set(T.map(e => (0, c._z)(e))), [T]), N = (0, l.bG)([u.A], () => null == W ? false : u.A.getParticipantsVersion(W)), {
