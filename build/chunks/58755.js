...
function g(e) {
  ...
  }), u = l.find(e => e.name === i), f = null != u ? (0, r.jsx)(v, {
    onClose: () => o(null),
    scale: u,
    setState: n
  }) : s;
      ...
      children: [(0, r.jsx)(d.xJW, {
        ...
        children: (0, r.jsx)("div", {
          ...
          children: Object.entries(N).map((e, n) => {
            let [a, c] = e, u = (0, x.HI)(c), m = (0, o.Z)((0, s.Z)("black"), c) > 4.5 ? "black" : "white", h = S[a];
            return (0, r.jsxs)("div", {
              style: {
                backgroundColor: u
              },
...
function j(e) {
  let {
    scale: t,
    onRemove: n
  } = e, o = a.useMemo(() => Object.values((0, x.XM)(t)).map(e => (0, l.Z)((0, i.Z)(e, x.HW.sRGB), {
    format: "hex"
  })), [t]);
  return (0, r.jsxs)("li", {
