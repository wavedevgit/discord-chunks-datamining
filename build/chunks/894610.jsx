...
let c = (0, Chunk755930.Yn)([(0, Chunk755930.nn)({
  ...
  renderHeader: () => <Chunk755930.qN>{Chunk388032.intl.string(Chunk388032.t.OGpGqK)}</Chunk755930.qN>,
  sort: (0, Chunk755930.Qg)(e => e.listing.name.toLowerCase())
}), (0, Chunk755930.GW)({
  key: "PAYMENTS_COUNT",
  cellClassName: Chunk963877.paymentsCountColumn,
  renderHeader: () => <Chunk755930.qN>{Chunk388032.intl.string(Chunk388032.t.vpHXJy)}</Chunk755930.qN>,
  ...
  renderHeader: () => <Chunk755930.qN>{Chunk388032.intl.string(Chunk388032.t.VodAGR)}</Chunk755930.qN>,
  getAmount(e) {
    let {
      listing: t
    } = e;
...
function d(e) {
  ...
  return null == s || 0 === s.length ? null : <l.ZP columns={c} data={d} initialSortKey={"LISTING_NAME"} />
}