...
function k(e) {
  ...
  }), b.default.track(C.rMx.CLIPS_SETTINGS_UPDATED, {
    reminders_enabled: e
  })
}
...
function B(e) {
  ...
  }), n && b.default.track(C.rMx.CLIPS_SETTINGS_UPDATED, {
...
async function V(e) {
  ...
  try {
    ...
    return n.thumbnail = o, n.length = e, N.jF.info("Clip save succeeded with ".concat(e, "ms and thumbnail ").concat(null != (f = null == o ? void 0 : o.length) ? f : 0, " bytes thumbnail.")), await s.updateClipMetadata(i, JSON.stringify(n)), D(P({}, n), {
      filepath: i
    })
  } catch (i) {
...
async function H(e) {
  ...
  try {
    ...
    N.jF.error("Clip Failed to Save", e), null == T || T.stop(), (0, d.GN)("clip_error", .5), o.Z.dispatch({
