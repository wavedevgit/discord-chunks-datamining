...
let C = e => {
  let {
    ...
    hovering: n,
    compact: l
  } = e, C = i.useRef((0, a.random)(-6, 24)).current, v = (0, s.e7)([h.Z], () => h.Z.confettiMode), y = (0, s.e7)([u.Z], () => u.Z.useReducedMotion), x = i.useRef(0), j = i.useRef(null), O = i.useRef(null), [N, E] = i.useState(!1), P = i.useMemo(() => !n && !v && !y, [v, n, y]);
  if (i.useEffect(() => {
      n || E(!1), n && v && E(!0)
    }, [n, v]), i.useEffect(() => {
