...
let C = e => {
  let {
    ...
    hovering: n,
    compact: l
  } = e, C = i.useRef((0, a.random)(-6, 24)).current, v = (0, s.e7)([h.Z], () => h.Z.confettiMode), y = (0, s.e7)([u.Z], () => u.Z.useReducedMotion), x = i.useRef(0), j = i.useRef(null), O = i.useRef(null), [N, E] = i.useState(!1), I = i.useMemo(() => !n && !v && !y, [v, n, y]);
  if (i.useEffect(() => {
      n || E(!1), n && v && E(!0)
    }, [n, v]), i.useEffect(() => {
      !y && (N || (!1 === n && (x.current = 0, null != j.current && (clearTimeout(j.current), j.current = null)), x.current = Date.now(), j.current = setTimeout(() => {
        let e = x.current;
    ...
    }, [v, N, n, t, y]), !(0, m.p7)("Message Confetti Peak") || !(0, b.Uw)(t)) return null;
  let P = (0, b.Eq)(t);
