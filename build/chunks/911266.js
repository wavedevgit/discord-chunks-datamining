...
let y = e => {
  let {
    ...
    hovering: n,
    compact: l
  } = e, y = i.useRef((0, o.random)(-6, 24)).current, C = (0, s.e7)([h.Z], () => h.Z.confettiMode), x = (0, s.e7)([u.Z], () => u.Z.useReducedMotion), v = i.useRef(0), j = i.useRef(null), O = i.useRef(null), [E, I] = i.useState(!1), P = i.useMemo(() => !n && !C && !x, [C, n, x]);
  if (i.useEffect(() => {
      n || I(!1), n && C && I(!0)
    }, [n, C]), i.useEffect(() => {
