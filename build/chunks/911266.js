...
let y = e => {
  let {
    ...
    hovering: n,
    compact: l
  } = e, y = i.useRef((0, o.random)(-6, 24)).current, x = (0, s.e7)([h.Z], () => h.Z.confettiMode), C = (0, s.e7)([u.Z], () => u.Z.useReducedMotion), v = i.useRef(0), j = i.useRef(null), O = i.useRef(null), [E, I] = i.useState(!1), S = i.useMemo(() => !n && !x && !C, [x, n, C]);
  if (i.useEffect(() => {
      n || I(!1), n && x && I(!0)
    }, [n, x]), i.useEffect(() => {
