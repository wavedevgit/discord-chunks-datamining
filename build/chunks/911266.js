...
let x = e => {
  let {
    ...
    hovering: n,
    compact: l
  } = e, x = i.useRef((0, o.random)(-6, 24)).current, y = (0, s.e7)([h.Z], () => h.Z.confettiMode), C = (0, s.e7)([u.Z], () => u.Z.useReducedMotion), v = i.useRef(0), j = i.useRef(null), O = i.useRef(null), [E, I] = i.useState(!1), P = i.useMemo(() => !n && !y && !C, [y, n, C]);
  if (i.useEffect(() => {
      n || I(!1), n && y && I(!0)
    }, [n, y]), i.useEffect(() => {
