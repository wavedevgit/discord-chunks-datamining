...
function p(e) {
  let {
    id: t,
    features: n
  } = e, _ = (0, o.e7)([s.default], () => s.default.getId()), p = (0, o.e7)([l.ZP], () => {
    var e;
  ...
  }), g = (0, a.Z)(), E = r.useMemo(() => p ? 0 : g.includes(t) ? 1 : (null == n ? void 0 : n.includes(f.oNc.MEMBER_VERIFICATION_GATE_ENABLED)) && (null == n ? void 0 : n.includes(f.oNc.MEMBER_VERIFICATION_MANUAL_APPROVAL)) && (null != h || e.visibility === d.k.PUBLIC_WITH_RECRUITMENT) && !m ? 2 : null != h ? 4 : (null == n ? void 0 : n.includes(f.oNc.DISCOVERABLE)) ? 3 : null, [n, t, m, p, g, e.visibility, h]);
  return {
    guildId: t,
    ctaType: E,
    validInviteKey: h
