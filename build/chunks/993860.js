...
function E(e, t, n) {
  let {
    id: m,
    features: g
  } = e, E = (0, o.e7)([c.default], () => c.default.getId()), b = (0, o.e7)([d.Z], () => d.Z.getGuild(m)), y = (0, o.e7)([p.default], () => p.default.getUser(E), [E]), O = (0, o.e7)([u.ZP], () => {
    var e;
    ...
    return T.includes(m) ? 2 : (null == g ? true : g.includes(h.GuildFeatures.MEMBER_VERIFICATION_GATE_ENABLED)) && (null == g ? true : g.includes(h.GuildFeatures.MEMBER_VERIFICATION_MANUAL_APPROVAL)) && (null != v || e.visibility === _.k.PUBLIC_WITH_RECRUITMENT) && !S ? 3 : null != v ? 5 : (null == g ? true : g.includes(h.GuildFeatures.DISCOVERABLE)) ? 4 : null
  }, [O, T, m, g, v, e.visibility, e.tag, S, t, b, I, y]);
  return {
    guildId: m,
    ctaType: C,
    validInviteKey: v
