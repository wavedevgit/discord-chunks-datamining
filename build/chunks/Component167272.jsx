...
function R(e) {
  ...
  } = (0, p.Ay)(f.A.USER_PROFILE_ACTIVITY_BUTTONS), F = M === w.d.MODAL || M === w.d.MODAL_V2, V = M === w.d.POPOUT, B = (() => j ? V && (null == R ? true : R.type) === N.$pd.PLAYING && (null == L ? true : L.id) != null ? (0, r.jsx)(d.A, {
    applicationId: L.id,
    onAction: P,
    onClose: D
