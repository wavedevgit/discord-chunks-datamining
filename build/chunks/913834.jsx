...
function f(e) {
  ...
  return <div className={d.badge} onMouseEnter={E} onMouseLeave={b}><o.yRy targetElementRef={f} animation={o.yRy.Animation.TRANSLATE} align={"center"} autoInvert={true} nudgeAlignIntoViewport={true} position={"top"} shouldShow={_} renderPopout={() => (0, r.jsx)(l.Z, {
        guildId: t.id,
        previewMode: true,
