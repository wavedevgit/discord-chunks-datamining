...
let v = {
  ...
  j = Chunk73800.memo(function(e) {
    ...
    let Z = i.useCallback(e => {
      ...
      T = i.useRef(null);
    return <a.yRy targetElementRef={T} shouldShow={(null == j ? true : j.popout) != null && !(x || I)} nudgeAlignIntoViewport={true} animationPosition={"bottom"} position={"right"} renderPopout={S}>{e => {
        var i, s;
