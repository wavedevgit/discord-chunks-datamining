  ...
  switch (t) {
    ...
    case V.Si.TIER_2:
      switch (a) {
        ...
        case V.Si.TIER_2:
          return e.interval === V.rV.MONTH ? Y.intl.formatToPlainString(Y.t["RqUv8/"], {
...
function et(e) {
  ...
  } = (0, h.wD)(), ev = (0, y.MY)(eh), eI = ep && (0, y.pO)(eh), eS = (0, N.cF)(ed, eI, ey), eT = (0, C.Z)({
    location: "PremiumPlanSelectStep"
  });
  b = null != b ? b : eu, g = null != g ? g : el, l()(void 0 !== g, "should not be undefined");
  let [eA, eN] = (0, c.Wu)([E.Z], () => [null != g ? E.Z.get(g.planId) : null, null != U ? E.Z.get(U) : null]), eC = (0, w.N)(en), eP = null == eC ? void 0 : eC.subscription_trial, eR = (0, R.Ng)(), ew = null == eR || null == (t = eR.discount) ? void 0 : t.plan_ids, eD = null != eN ? eN : ed, eL = i.useCallback(e => {
    null != G ? G(e) : ec(e)
  }, [G, ec]), ex = null != Q ? Q : ef;
  ...
  let eB = !eI && (ep || !eM && !ej) && eG && ei,
    ...
    eX = (e, t, n) => {
      ...
      if (n && null != eQ && null != eU && U === V.Xh.PREMIUM_MONTH_TIER_2) return (0, r.jsxs)("div", {
        children: [(0, r.jsx)(u.Text, {
          variant: "text-sm/normal",
          className: K.trialPlanSelectHeader,
    ...
    eJ = () => {
      if (ev === y.xr.CUSTOM_MESSAGE_EMOJI_SOUNDBOARD && null != eE) return (0, r.jsx)(M.Z, {
  ...
  return (0, r.jsxs)("div", {
    className: o()(eI ? K.stepBodyCustomGift : K.stepBody, {
      [K.paddingForHalloweenBanner]: eT
    }),
