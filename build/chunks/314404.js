  ...
  switch (t) {
    ...
    case F.Si.TIER_2:
      switch (o) {
        ...
        case F.Si.TIER_2:
          return e.interval === F.rV.MONTH ? W.NW.formatToPlainString(W.t["RqUv8/"], {
...
function $(e) {
  ...
  let {
    ...
    giftingOrigin: eg,
    claimableRewards: eE,
    setSelectedGiftingPromotionReward: eb
  } = (0, h.wD)(), ey = (0, y.MY)(e_), ev = ef && (0, y.pO)(e_), eO = (0, A.cF)(eu, ev, eE), eI = (0, C.Z)({
    location: "PremiumPlanSelectStep"
  });
  b = null != b ? b : ec, g = null != g ? g : es, l()(void 0 !== g, "should not be undefined");
  let [eS, eT] = (0, c.Wu)([E.Z], () => [null != g ? E.Z.get(g.planId) : null, null != U ? E.Z.get(U) : null]), eN = (0, w.N)(et), eA = null == eN ? void 0 : eN.subscription_trial, eC = (0, P.Ng)(), eR = null == eC || null == (t = eC.discount) ? void 0 : t.plan_ids, eP = null != eT ? eT : eu, ew = i.useCallback(e => {
    null != G ? G(e) : el(e)
  }, [G, el]), eD = null != Q ? Q : ed;
  ...
  let eU = !ev && (ef || !ex && !eM) && ej && er,
    ...
    eK = (e, t, n) => {
      ...
      if (t) {
        ...
        return (0, r.jsxs)("div", {
          children: [(0, r.jsx)(u.Text, {
            ...
            children: t ? W.NW.format(W.t.nG95hI, {
              endDate: en
      ...
      if (n && null != eY && null != ek && U === F.Xh.PREMIUM_MONTH_TIER_2) return (0, r.jsxs)("div", {
        children: [(0, r.jsx)(u.Text, {
          variant: "text-sm/normal",
          className: K.trialPlanSelectHeader,
    ...
    ez = () => {
      if (ey === y.xr.CUSTOM_MESSAGE_EMOJI_SOUNDBOARD && null != em) return (0, r.jsx)(k.Z, {
    ...
    e0 = () => eK(eN, ex, eM),
    e1 = () => eF ? (0, r.jsx)(d.Z, {
      message: W.NW.formatToPlainString(W.t["9hnZoK"], {
        kunaPriceWithCurrency: (0, I.T4)(7.5345 * eB.amount, H.pK.HRK)
      })
    }) : null,
  ...
  return (0, r.jsxs)("div", {
    className: a()(ev ? K.stepBodyCustomGift : K.stepBody, {
      [K.paddingForHalloweenBanner]: eI
    }),
    children: [e3 && (0, r.jsx)(M.n, {
      ...
      children: [(0, r.jsx)(V.s, {
        ...
        giftRecipient: e_
      }), eQ && eJ(), ez(), null != eS && !ef && !e3 && (0, r.jsx)("div", {
        className: K.bodyText,
        children: J(eS, b)
      }), !eQ && e0(), !eQ && e$(), (0, r.jsx)("div", {
        children: eU && null != eP && null != eB ? (0, r.jsxs)("div", {
      ...
      }), !eQ && e1(), !ef && !eW && er && (0, r.jsx)(d.Z, {
        message: W.NW.format(W.t.Om31w8, {
...
function et(e) {
  ...
  return h && (y = g.h8.REVIEW), (0, A.id)(_, i, o) && f !== g.h8.SELECT_FREE_SKU && (y = g.h8.SELECT_FREE_SKU), (0, r.jsx)(u.zxk, {
    onClick: () => t(y),
    children: E
  })
}