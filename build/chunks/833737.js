...
let C = (0, c.Z)((0, u.Z)(function(e) {
  ...
  let {
  ...
  } = (0, f.ZP)(d.Z.CONTEXT_MENU), U = (0, s.O)(), R = null != (t = null == T ? void 0 : T[0]) ? t : w[0], k = (0, O.sE)(u, {
    location: R,
    targetUserId: n.id
  }), L = (0, i.e7)([Z.Z], () => {
    var e;
    ...
    location: R,
    channelId: c
  }), Q = (0, P.Z)(n, u, null != c ? c : L, R), H = (0, h.Z)(c, A), W = (0, v.Z)(n, u), X = (0, S.Z)(n.id, u, !1, R), z = (0, b.Z)({
    id: n.id,
    label: N.intl.string(N.t["/AXYnJ"]),
    onSuccess: q
  }), J = (0, m.Z)(n, u), $ = !!(null == n ? void 0 : n.isNonUserBot());
