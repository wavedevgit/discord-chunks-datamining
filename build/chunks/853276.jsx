...
let h = Chunk73800.forwardRef(function(e, t) {
  ...
  return null == h ? <div className={a()(m.chipletValue, {
      [m.isEditing]: d,
      [m.isSelected]: c
    })} ref={t}>{s}</div> : (null != (n = null == f ? true : f.length) ? n : 0) + (null != (l = null == b ? true : b.length) ? l : 0) > 70 ? <o.ua7 aria-label={h.message} text={() => (0, r.jsxs)("div", {
      "aria-label": h.message,
      children: [h.message, " ", (0, r.jsx)("span", {
        className: m.errorOverflowValue,
        children: b
      })]
    })} tooltipClassName={m.errorTooltip} color={o.ua7.Colors.RED} position={"left"} forceOpen={u || true}>{e => (0, r.jsxs)("div", p(g({
      ref: t,
    ...
    }))}</o.ua7> : <div ref={t} className={a()(m.chipletValue, {
      [m.isEditing]: d,
      [m.isError]: null != h && !d
    })}>{<span>{f}</span>}{<o.ua7 text={h.message} color={o.ua7.Colors.RED} position={"top"} forceOpen={u || true}>{e => (0, r.jsx)("span", p(g({}, e), {
        className: m.errorValue,
        children: b
      }))}</o.ua7>}{<span>{x}</span>}</div>
});
...
function f(e) {
  ...
  return <div className={m.chipletFlexContainer}><div ref={I} className={a()(m.chipletContainer, {
        [m.isEditing]: O,
        [m.smallBlink]: !O && !S,
        [m.isSelected]: f,
        [m.isSelecting]: b,
        [m.isError]: null != x && !O
      })}>{<o.P3F tag={"div"} onBlur={() => D(false)} onClick={k} ignoreKeyPress={true} onMouseEnter={() => P(true)} onMouseLeave={() => P(false)} className={a()(m.chipletContainerInner, {
          [m.isSelecting]: b,
          [m.isEditing]: O
        })} ref={_}>{<input className={a()(m.chipletInput, {
            [m.isEditing]: O,
            [m.isSelecting]: b
          })} ref={v} onChange={Z} onKeyDownCapture={A} value={t} style={{
            width: R > 0 ? R : "calc(".concat(t.length, "ch + 10px)")
          }} />}{<h ref={C} value={t} isEditing={O} isSelected={f} error={x} forceShowErrorTooltip={T || O} />}</o.P3F>}{!O && <o.P3F className={m.closeIconContainer} onClick={L}><o.Dio size={"xxs"} color={"currentColor"} className={m.closeIcon} /></o.P3F>}</div></div>
}