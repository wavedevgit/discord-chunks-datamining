  ...
  get displayMessage() {
    ...
    switch (this.code) {
      ...
      case i.ff.POST_INSTALL_FAILED:
        ...
        return a.intl.formatToPlainString(a.t.hP0B3N, {
          name: l
        });
      ...
      case i.ff.DISK_PERMISSION_DENIED:
        return a.intl.formatToPlainString(a.t.EjWbOz, {
          path: e
        });
      case i.ff.INVALID_DRIVE:
        return a.intl.formatToPlainString(a.t["08L2TE"], {
          path: e
        });
      ...
      default:
        return a.intl.formatToPlainString(a.t.r477WF, {
