...
function X() {
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)(T.X6q, {
      ...
      gap: 16,
      children: e.map(e => (0, i.jsx)(T.qXd, {
        color: T.DM8[e],
  ...
  return (0, i.jsxs)(i.Fragment, {
    children: [(0, i.jsx)(D.Z, {
      ...
      children: (0, i.jsx)(y.ZP, {
        type: y.yH.SETTINGS,
        children: (0, i.jsx)(y.ZP.Basic, {
          className: U.themeSelectionGroup
        })
      })
    })]
  })
...
function ea() {
  let [e, t] = r.useState("md"), [n, s] = r.useState("start"), [a, o] = r.useState(!0), c = ["primary", "secondary", "critical-primary", "critical-secondary", "active", "overlay-primary", "overlay-secondary"], d = [...c, "expressive"].map(t => (0, i.jsx)(es, {
    component: u.z,
    variant: t,
  ...
  }, t + e)), g = [...c, "icon-only"].map(t => (0, i.jsx)(es, {
    component: p.h,
    variant: t,
    icon: T.gw7,
    size: e,
...
function eu() {
  let [e, t] = r.useState(T.FGA.PRIMARY), n = r.useMemo(() => Object.entries(T.FGA).map(e => {
    let [t, n] = e;
    return {
      label: t,
      value: n
...
function eh() {
  let [e, t] = r.useState(""), [n, s] = r.useState(""), [a, l] = r.useState(""), o = (0, A.U)("UserSettingsDesignSystems");
  return (0, i.jsxs)("div", {
    className: U.section,
    children: [(0, i.jsx)(T.X6q, {
      variant: "heading-xl/semibold",
...
function ef(e) {
  let {
    transitionState: t
  } = e, [n, s] = r.useState(!1), [a, l] = r.useState(T.CgR.SMALL), [o, c] = r.useState(!1), d = n ? U.modalOutlines : "";
...
function e_(e) {
  let {
    transitionState: t,
    onClose: n
  } = e, [s, a] = r.useState("md"), [l, o] = r.useState("Demo Modal"), [c, d] = r.useState("Header body copy"), [u, m] = r.useState(!1), [p, g] = r.useState(!1), [h, f] = r.useState(!1), [x, _] = r.useState(!1), [v, S] = r.useState(!1);
  return (0, i.jsxs)(b.I, {
    transitionState: t,
    onClose: n,
    size: s,
