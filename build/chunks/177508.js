...
function T() {
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)(d.X6q, {
      ...
      gap: 16,
      children: e.map(e => (0, i.jsx)(d.qXd, {
        color: d.DM8[e],
...
function Z() {
  let [e, t] = r.useState(!1), n = j.flatMap(e => [...O.map(t => (0, i.jsxs)(d.zxk, {
    ...
    className: x.sectionDivider
  }, e + "divider")]), s = S.flatMap(e => (0, i.jsx)(d.zxk, {
