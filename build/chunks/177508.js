...
function ex(e) {
  let {
    transitionState: t,
    onClose: n
  } = e, [s, a] = r.useState("md"), [l, o] = r.useState("Demo Modal"), [c, d] = r.useState("Header body copy"), [u, m] = r.useState(!1), [p, g] = r.useState(!1), [h, b] = r.useState(!1), [x, E] = r.useState(!1), [v, T] = r.useState(!1);
  return (0, i.jsxs)(f.I, {
    transitionState: t,
    onClose: n,
    size: s,
