...
function Y() {
  return (0, i.jsxs)("div", {
    className: M.root,
    children: [(0, i.jsx)(K, {}), (0, i.jsx)(es, {}), (0, i.jsx)(ep, {}), (0, i.jsx)(eg, {}), (0, i.jsx)(em, {}), (0, i.jsx)(ed, {}), (0, i.jsx)(eu, {}), (0, i.jsx)(ec, {}), (0, i.jsx)(eo, {}), (0, i.jsx)(eO, {}), (0, i.jsx)(q, {}), (0, i.jsx)(ev, {})]
  })
}
    ...
    children: [(0, i.jsx)(R.Z, {
      ...
      children: (0, i.jsx)(I.ZP, {
        ...
        children: (0, i.jsx)(I.ZP.Basic, {
          className: M.themeSelectionGroup
        })
      })
    })]
  })
...
function er(e) {
  ...
  let [a, l] = r.useState(!1), o = r.useRef(-1);
...
function es() {
  let [e, t] = r.useState("md"), [n, s] = r.useState("start"), [a, o] = r.useState(!0), c = ["primary", "secondary", "critical-primary", "critical-secondary", "active", "overlay-primary", "overlay-secondary"], p = [...c, "expressive"].map(t => (0, i.jsx)(er, {
    component: d.z,
    variant: t,
  ...
  }, t + e)), h = [...c, "icon-only"].map(t => (0, i.jsx)(er, {
    component: m.h,
    variant: t,
    icon: S.gw7,
    size: e,
...
function el(e) {
  ...
  return (0, i.jsxs)(S.Kqy, {
    ...
    children: [(0, i.jsxs)(S.Kqy, {
      ...
      gap: 16,
      className: a()(M.floatingControlsContent, {
        [M.floatingControlsContentHidden]: !s
      }),
      children: t
    })]
  })
...
function eg() {
  let [e, t] = r.useState(""), [n, s] = r.useState(""), [a, l] = r.useState(""), o = (0, y.U)("UserSettingsDesignSystems");
  return (0, i.jsxs)("div", {
    className: M.section,
    children: [(0, i.jsx)(S.X6q, {
      variant: "heading-xl/semibold",
...
function eh(e) {
  let {
    transitionState: t
  } = e, [n, s] = r.useState(!1), [a, l] = r.useState(S.CgR.SMALL), [o, c] = r.useState(!1), d = n ? M.modalOutlines : "";
...
function ex(e) {
  let {
    transitionState: t,
    onClose: n
  } = e, [s, a] = r.useState("md"), [l, o] = r.useState("Demo Modal"), [c, d] = r.useState("Header body copy"), [u, m] = r.useState(!1), [p, g] = r.useState(!1), [h, b] = r.useState(!1), [x, O] = r.useState(!1), [v, T] = r.useState(!1);
  return (0, i.jsxs)(f.I, {
    transitionState: t,
    onClose: n,
    size: s,
