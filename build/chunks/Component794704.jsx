...
function eU(e) {
  ...
  let [er, ei] = i.useMemo(() => W ? ["text-muted", m.TVs.colors.TEXT_MUTED.css] : Y && z ? ["text-feedback-warning", m.TVs.colors.TEXT_FEEDBACK_WARNING.css] : Y && K ? ["text-feedback-positive", m.TVs.colors.TEXT_FEEDBACK_POSITIVE.css] : Y && Q ? ["text-strong", m.TVs.colors.TEXT_STRONG.css] : ["interactive-normal", m.TVs.colors.INTERACTIVE_NORMAL.css], [W, Y, z, K, Q]);
