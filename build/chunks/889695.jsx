...
function S(e) {
  ...
  return (P.roles.forEach(e => {
    ...
    forceRoles: k,
    context: o
  }), s.$e(O.Plq.MANAGE_GUILD, O.Plq.MANAGE_ROLES)) || (0, u.eM)(o, n)) ? <div className={I.container}><c.hQY placeholder={v.intl.string(v.t.Sojqsr)} value={w} onChange={D} autoFocus={true}>{e => {
      ...
      }}</c.hQY></div> : <c.Text variant={"text-md/medium"}>{v.intl.string(v.t.MNSTbW)}</c.Text>
}