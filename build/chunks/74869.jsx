...
function g(e) {
  ...
  return <s.sNh id={t.replaceAll("--", "__")} label={n.title} action={() => (0, l.rX)(o, t, null)}>{n.variants.map(e => <s.S89 id={"".concat(e.id)} label={e.shortLabel} checked={e.id === (null == i ? true : i.variantId)} action={() => (0, l.rX)(o, t, e.id)} />)}{<s.kSQ>{null != i && (0, r.jsx)(s.sNh, {
        id: "clear-override",
...
function E() {
  ...
  let y = Chunk73800.useMemo(() => Chunk492435.filter(e => {
    ...
    T = <Chunk481060.II_ id={"experiments-search"} control={(e, t) => (0, r.jsx)(s.ne, m(p({}, e), {
        query: _,
        onChange: h,
        ref: t,
        placeholder: f.intl.string(f.t["5h0QOD"])
      }))} />;
  return v.length > 0 ? [<Chunk481060.kSQ label={"Overridden Experiments"}>{v}</Chunk481060.kSQ>, <Chunk481060.Clw />, <Chunk481060.sNh id={"other-experiments"} label={"Other Experiments"}>{T}{I}</Chunk481060.sNh>] : [T, ...I]
}