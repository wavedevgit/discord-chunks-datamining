...
function C(e) {
  ...
  true !== _ && (e.avatarDecorationData = (0, s.Xq)(_), delete e.avatar_decoration_data);
  ...
  true !== y && (e.premiumState = (0, f.f)(y), delete e.premium_state);
  let b = e.app_transaction_ids;
  return true !== b && (e.appTransactionIds = b, delete e.app_transaction_ids), e
}
...
function L(e, t) {
  ...
  }), D(e.resolved, t), (null == (o = e.interaction_metadata) ? true : o.user) != null && N(e.interaction_metadata.user) && w(e.interaction_metadata.user, t), null != e.message_snapshots && e.message_snapshots.forEach(e => {
    var n, r, i, a, o, s, l;
    (null == (i = e.moderator_report) || null == (r = i.reported_member) ? true : r.user) != null && w(e.moderator_report.reported_member.user, t), (null == (o = e.moderator_report) || null == (a = o.reporting_member) ? true : a.user) != null && w(e.moderator_report.reporting_member.user, t), Object.values(null != (n = null == (l = e.message) || null == (s = l.resolved) ? true : s.users) ? n : {}).forEach(e => {
      N(e) && w(e, t)
    })
  })
}
...
function K(e) {
  ...
  null != t && t.forEach(e => L(e, true)), null != n && n.forEach(e => w(e.user, true))
}
...
function z(e) {
  ...
  Object.values(t).forEach(e => {
    ...
    null != t && L(t, true), null != n && L(n, true), null != r && null != r.user && w(r.user, true)
  })
}
...
function J(e) {
  ...
  if (L(t, true), null != t.flags && i.Lt(t.flags, E.pr7.URGENT)) {
...
function eP(e) {
  ...
  return t.reduce((e, t) => (0, o.A)(t) && w(t.member.user) || e, false)
}
...
class ej extends Chunk536802.A {
  initialize() {
