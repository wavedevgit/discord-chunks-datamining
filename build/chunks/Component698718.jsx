...
var Chunk627968 = require("./627968.js"),
  ...
  Chunk379600 = require("./379600.jsx"),
...
let e3 = Chunk64700.forwardRef((e, t) => (0, l.jsx)(e5, e0(e$({}, e), {
  ref: t
})));
e3.displayName = "ChannelTextAreaForm";
class e5 extends Chunk64700.PureComponent {
  focusEditor() {
    var e;
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, eQ(this, "isFirstChange", true), eQ(this, "editorRef", null), eQ(this, "state", e0(e$({}, (0, M.ur)(eC.A.getDraft(this.props.channel.id, eC.C.ChannelMessage))), {
      contentWarningProps: null
      ...
      return (0, ek.i)({
        ...
        if (null != o && (x.announcementSendOptions = o), null != s && (x.flags = (0, d.UI)(null != (y = x.flags) ? y : 0, eY.pr7.IS_COMPONENTS_V2)), a) return m.A.sendMessage(u.id, C, true, x).then(() => {
          if (g) {
            var e;
        ...
        } else m.A.sendMessage(u.id, C, true, x).then(() => {
          if (g) {
            var e;
            eb._(null != (e = u.parent_id) ? e : true)
          }
...
let e9 = Chunk64700.memo(function(e) {
  let {
    channel: t,
    guild: n,
    chatInputType: r,
    ...
    channel: t
  }), o = (0, eo.L)(eP.default.getCurrentUser(), t), [c] = (0, z.c)(null == n ? true : n.id), u = (0, V.uZ)(null == n ? true : n.id), d = (0, h.bG)([eP.default], () => eP.default.getCurrentUser()), f = (0, h.bG)([eS.Ay], () => {
    var e, t, l;
    return null != d && null != (e = null == (l = eS.Ay.getMember(null != (t = null == n ? true : n.id) ? t : eY.dJq, null == d ? true : d.id)) ? true : l.isPending) && e
