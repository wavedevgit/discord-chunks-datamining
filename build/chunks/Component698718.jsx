...
require.d(exports, {
  A: () => e3
}), require("./896048.js"), require("./747238.js"), require("./733351.js"), require("./938796.js");
var Chunk627968 = require("./627968.js"),
  ...
  Chunk582968 = require("./582968.jsx"),
...
let e1 = Chunk64700.forwardRef((e, t) => (0, l.jsx)(e2, eX(eZ({}, e), {
  ref: t
})));
e1.displayName = "ChannelTextAreaForm";
class e2 extends Chunk64700.PureComponent {
  focusEditor() {
    var e;
  ...
  handleRecallLastCommand(e) {
    ...
    if (null != r) {
      ...
      let e = null != i ? {
        ...
        id: i.id,
        icon: i.icon,
        name: null != (a = null == i || null == (s = i.bot) ? true : s.username) ? a : i.name,
        application: i
      } : null;
      x.Gf({
        channelId: t.id,
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, eJ(this, "isFirstChange", true), eJ(this, "editorRef", null), eJ(this, "state", eX(eZ({}, (0, M.ur)(eE.A.getDraft(this.props.channel.id, eE.C.ChannelMessage))), {
      contentWarningProps: null
      ...
      let l = this.props.channel.id,
        ...
        a = (null != (n = null == i ? true : i.value) ? n : 0) + 1;
      (0, el.oG)({
        channelId: l,
        userId: r,
      ...
      this.isFirstChange = false, a && this.state.textValue.length < t.length && this.handleIncrementCombo(), a ? g.A.startTyping(r) : "" === t && g.A.stopTyping(r), i && l && (0, y.Bm)(), this.setState({
        textValue: t,
        richValue: n
      })
      ...
      if (null != r) {
        ...
        if (null == e || e === N.iw.CHAT) {
          ...
          let {
            location: t,
            sectionName: n
          } = null != (y = (0, eF.bV)(r)) ? y : {}, l = e === N.iw.APPLICATION_LAUNCHER ? C.A.lastShownEntrypoint() : S.s4.TEXT, {
            isAuthorized: i
          } = await (0, R.q)({
            applicationId: r.applicationId,
            channel: h,
        ...
        null != n && (t = null != n.content && "" !== n.content ? n.content : t, _ = true === n.tts)
      }
      return (0, eM.i)({
        ...
        if (!E)
          if (O === eW.X8x.SLOWMODE_COOLDOWN) return eR._.dispatch(eW.jej.SHAKE_APP, {
            duration: 200,
            intensity: 2
        ...
        let x = eX(eZ({}, m.A.getSendMessageOptions({
          content: t,
          channelId: h.id,
          uploads: n,
          stickers: l,
          ...
          isGif: a,
          pendingReply: p,
          alsoForwardToChannelId: b && null != (i = h.parent_id) ? i : true,
          scheduledTimestamp: null == (y = this.props.pendingScheduledMessage) ? true : y.scheduledTimestamp
        })), {
          location: ez.Hx.CHAT_INPUT
        });
        if (null != c && (x.announcementSendOptions = c), null != s && (x.gifMetadata = s), null != o && (x.flags = (0, d.UI)(null != (v = x.flags) ? v : 0, eW.pr7.IS_COMPONENTS_V2)), a) return m.A.sendMessage(h.id, S, true, x).then(() => {
          if (b) {
            var e;
            eb._(null != (e = h.parent_id) ? e : true)
          }
        }), (0, ec.Jx)(h.id), eg.B({
          channelId: h.id,
          enabled: false
        ...
        if (null != n && n.length > 0) {
          let e = (0, eL.LJ)(n);
          if ((0, eL.fJ)(e, null == u ? true : u.id)) return (0, ek.V)(h, e), {
            shouldClear: false,
            shouldRefocus: false
          };
          x.eagerDispatch = false, x.attachmentsToUpload = n, x.onAttachmentUploadError = (e, l, r) => {
            (0, X.k)({
              file: e,
              ...
              code: l,
              reason: r
            }) && ("" !== t && "" === eE.A.getDraft(h.id, eE.C.ChannelMessage) && f.A.saveDraft(h.id, t, eE.C.ChannelMessage), 0 === eI.A.getUploadCount(h.id, eE.C.ChannelMessage) && A.A.setUploads({
              channelId: h.id,
              uploads: n,
        ...
        } else m.A.sendMessage(h.id, S, true, x).then(() => {
          if (b) {
            var e;
            eb._(null != (e = h.parent_id) ? e : true)
          }
        });
        return this.setState((0, M.N3)()), (0, ec.Jx)(h.id), (0, em.x5)(h.id, g.drafts.type), eg.B({
          channelId: h.id,
          enabled: false
        }), {
          shouldClear: true,
      ...
      var t, n;
      let l = null == (t = this.editorRef) ? true : t.getSlateEditor();
...
class e7 extends Chunk64700.PureComponent {
...
let e3 = Chunk64700.memo(function(e) {
  let {
    channel: t,
    guild: n,
    chatInputType: r,
    ...
    channel: t
  }), o = (0, eo.L)(eT.default.getCurrentUser(), t), [c] = (0, z.c)(null == n ? true : n.id), u = (0, V.uZ)(null == n ? true : n.id), d = (0, h.bG)([eT.default], () => eT.default.getCurrentUser()), f = (0, h.bG)([eC.Ay], () => {
    var e, t, l;
    return null != d && null != (e = null == (l = eC.Ay.getMember(null != (t = null == n ? true : n.id) ? t : eW.dJq, null == d ? true : d.id)) ? true : l.isPending) && e
