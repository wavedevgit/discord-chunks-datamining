...
class c extends(r = Chunk647438.PureComponent) {
  getNeighborBounds() {
    let {
      ...
      maxVisiblePages: t,
      selectedPage: n
    } = this.props, r = Math.ceil(exports / 2), i = Math.floor(exports / 2), o = [1, module], [a, s] = o = require <= r ? [1, exports] : require > module - Chunk647438 ? [module - exports + 1, module] : [require - r + 1, require + Chunk647438];
  ...
  getPageList() {
    ...
    }), i -= 2), [Chunk392711, ...l, ...a().range(r, Chunk647438 + 1).map(e => ({
      type: "PAGE",
      key: "page-".concat(e),
      targetPage: e,
      selected: e === t,
