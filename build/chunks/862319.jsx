...
function h(e) {
  ...
  return <div className={m.container}>{s.map(e => (0, r.jsxs)("div", {
      className: m.row,
...
function f(e) {
  ...
  return <a.P3F className={l()(m.importRoleCard, {
      [m.disabled]: o
    ...
    }} aria-disabled={o}>{<a.lZ8 size={"custom"} width={23} height={23} color={"currentColor"} className={m.rowIcon} />}{<a.Text variant={"text-md/normal"} color={"header-primary"} className={m.rowText}>{u.intl.string(u.t.xK9pBA)}</a.Text>}{<s.Z direction={s.Z.Directions.RIGHT} className={m.caret} />}</a.P3F>
}