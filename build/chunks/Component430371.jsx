...
function I(e) {
  ...
  let ec = i.useMemo(() => Q && $ ? D / (U - 2 * es) : ee && null != z && z.width > 0 && z.height > 0 ? z.width / z.height : S, [ee, z, Q, D, U, es, $]),
    eu = U - 2 * es,
    ed = Q && $ ? D : eu * ec,
    ep = Math.floor(Math.min(D, ed) / ec),
    eh = U > D / ec + 72 + P + 8;
  n = en || Q ? en ? false : false : 40 + Math.max(0, 72 - (U - ep) / 2), i.useEffect(() => {
    let e = setTimeout(() => {
      K(false)
    }, 250);
    return () => {
