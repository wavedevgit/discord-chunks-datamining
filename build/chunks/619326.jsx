...
function j(e) {
  ...
  let v = t === m.p6O,
    _ = v ? d : t,
    O = <o.dz2 size={"custom"} width={32} height={24} color={x(t)} />,
    y = (0, o.arW)({
...
function v(e) {
  ...
  return t = null == s || s < 440 ? <j value={n} onChange={i} disabled={l} /> : <b defaultColor={m.p6O} colors={m.pmI} value={n} onChange={i} disabled={l} />, <div ref={a}>{t}</div>
}