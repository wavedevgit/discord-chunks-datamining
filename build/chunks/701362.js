...
function C(e) {
  ...
  let [c, d] = (0, a.Wu)([h.Z, O.Z, b.Z, f.Z], () => (0, j.p9)(o, h.Z, O.Z, b.Z, f.Z)), p = (0, a.e7)([m.Z], () => m.Z.getStreamForUser(i.id, o.getGuildId())), v = (0, a.e7)([m.Z], () => m.Z.getActiveStreamForApplicationStream(p)), P = (0, a.e7)([g.default], () => g.default.getId()), N = (0, S.Cf)(p), E = (0, a.e7)([y.Z], () => (0, S.Um)(p, y.Z)), I = l.useMemo(() => ({
    [o.guild_id]: [i.id]
  }), [o.guild_id, i.id]);
