...
function w(e) {
  ...
  let [c, d] = (0, o.Wu)([h.Z, _.Z, v.Z, f.Z], () => (0, O.p9)(a, h.Z, _.Z, v.Z, f.Z)), p = (0, o.e7)([m.Z], () => m.Z.getStreamForUser(l.id, a.getGuildId())), y = (0, o.e7)([m.Z], () => m.Z.getActiveStreamForApplicationStream(p)), x = (0, o.e7)([g.default], () => g.default.getId()), S = (0, j.Cf)(p), I = (0, o.e7)([b.Z], () => (0, j.Um)(p, b.Z)), P = i.useMemo(() => ({
    [a.guild_id]: [l.id]
  }), [a.guild_id, l.id]);
