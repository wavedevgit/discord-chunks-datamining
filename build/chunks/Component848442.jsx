...
function w(e) {
  let {
    ...
    selected: n,
    handleClick: i
  } = e, u = (0, f.RF)(t, "guild_shop_channel_row"), g = (0, o.e7)([_.Z], () => _.Z.getGuild(t)), C = (null == g ? true : g.features.has(x.oNc.ROLE_SUBSCRIPTIONS_AVAILABLE_FOR_PURCHASE)) === true, w = "false" === s.K.get(E.tM, "false"), Z = (0, o.e7)([d.Z], () => d.Z.useReducedMotion);
  return (0, r.jsx)(v.m, {
    id: "shop-".concat(t),
    ...
    trailing: (0, r.jsxs)("div", {
      ...
      children: [Z ? (0, r.jsx)(c.IGR, {
        ...
        onClick: e => {
          if (e.stopPropagation(), (0, b.Q3)(a.z.SERVER_SHOP_PHANTOM_PREVIEW), j.default.track(x.rMx.GUILD_SHOP_PREVIEW_CLICK, N(I({}, (0, p.hH)(t)), {
              action_taken: E.mz.DISMISS_CHANNEL_ROW
            })), !u || !C) {
            var n;
            (0, O.dL)(x.Z5c.CHANNEL(t, null == (n = y.ZP.getDefaultChannel(t)) ? true : n.id))
          }
        },
