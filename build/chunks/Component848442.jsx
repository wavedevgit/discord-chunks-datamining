...
function w(e) {
  let {
    ...
    selected: n,
    handleClick: i
  } = e, u = (0, f.RF)(t, "guild_shop_channel_row"), g = (0, o.e7)([y.Z], () => y.Z.getGuild(t)), E = (null == g ? true : g.features.has(j.oNc.ROLE_SUBSCRIPTIONS_AVAILABLE_FOR_PURCHASE)) === true, w = "false" === a.K.get(S.tM, "false"), Z = (0, o.e7)([d.Z], () => d.Z.useReducedMotion);
  return (0, r.jsx)(v.m, {
    id: "shop-".concat(t),
    ...
    trailing: (0, r.jsxs)("div", {
      ...
      children: [Z ? (0, r.jsx)(c.IGR, {
        ...
        onClick: e => {
          if (e.stopPropagation(), (0, b.Q3)(s.z.SERVER_SHOP_PHANTOM_PREVIEW), C.default.track(j.rMx.GUILD_SHOP_PREVIEW_CLICK, N(P({}, (0, h.hH)(t)), {
              action_taken: S.mz.DISMISS_CHANNEL_ROW
            })), !u || !E) {
            var n;
            (0, O.dL)(j.Z5c.CHANNEL(t, null == (n = _.ZP.getDefaultChannel(t)) ? true : n.id))
          }
        },
...
function Z(e) {
  let {
    ...
    a.K.set(S.tM, "true"), (0, O.uL)(j.Z5c.CHANNEL(t.id, E.oC.GUILD_SHOP))
  };
  return l ? (0, r.jsx)(w, {
    guildId: t.id,
    selected: i,
