...
function w(e) {
  let {
    ...
    selected: n,
    handleClick: i
  } = e, u = (0, f.RF)(t, "guild_shop_channel_row"), g = (0, o.e7)([_.Z], () => _.Z.getGuild(t)), C = (null == g ? true : g.features.has(x.oNc.ROLE_SUBSCRIPTIONS_AVAILABLE_FOR_PURCHASE)) === true, w = "false" === s.K.get(S.tM, "false"), Z = (0, o.e7)([d.Z], () => d.Z.useReducedMotion);
  return (0, r.jsx)(j.m, {
    id: "shop-".concat(t),
...
function Z(e) {
  let {
    ...
    s.K.set(S.tM, "true"), (0, O.uL)(x.Z5c.CHANNEL(t.id, C.oC.GUILD_SHOP))
  };
  return l ? (0, r.jsx)(w, {
    guildId: t.id,
    selected: i,
