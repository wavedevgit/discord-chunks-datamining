...
function Z(e) {
  let {
    ...
    selected: n,
    handleClick: i
  } = e, u = (0, h.RF)(t, "guild_shop_channel_row"), g = (0, o.e7)([y.Z], () => y.Z.getGuild(t)), x = (null == g ? true : g.features.has(C.GuildFeatures.ROLE_SUBSCRIPTIONS_AVAILABLE_FOR_PURCHASE)) === true, Z = "false" === s.K.get(E.tM, "false"), T = (0, o.e7)([d.Z], () => d.Z.useReducedMotion);
  return (0, r.jsx)(v.m, {
    id: "shop-".concat(t),
