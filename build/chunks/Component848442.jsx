...
function w(e) {
  let {
    ...
    selected: n,
    handleClick: i
  } = e, u = (0, h.RF)(t, "guild_shop_channel_row"), g = (0, o.e7)([y.Z], () => y.Z.getGuild(t)), x = (null == g ? true : g.features.has(C.oNc.ROLE_SUBSCRIPTIONS_AVAILABLE_FOR_PURCHASE)) === true, w = "false" === s.K.get(E.tM, "false"), Z = (0, o.e7)([d.Z], () => d.Z.useReducedMotion);
  return (0, r.jsx)(v.m, {
    id: "shop-".concat(t),
    ...
    trailing: (0, r.jsxs)("div", {
      ...
      children: [Z ? (0, r.jsx)(c.IGR, {
        ...
        onClick: e => {
          if (e.stopPropagation(), (0, b.Q3)(a.z.SERVER_SHOP_PHANTOM_PREVIEW), j.default.track(C.rMx.GUILD_SHOP_PREVIEW_CLICK, N(P({}, (0, p.hH)(t)), {
              action_taken: E.mz.DISMISS_CHANNEL_ROW
            })), !u || !x) {
            var n;
            (0, O.dL)(C.Z5c.CHANNEL(t, null == (n = _.ZP.getDefaultChannel(t)) ? true : n.id))
          }
        },
...
function Z(e) {
  let {
    ...
    s.K.set(E.tM, "true"), (0, O.uL)(C.Z5c.CHANNEL(t.id, x.oC.GUILD_SHOP))
  };
  return l ? (0, r.jsx)(w, {
    guildId: t.id,
    selected: i,
