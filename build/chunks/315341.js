...
let b = [{
  ...
  run(e) {
    ...
    for (let t in s) {
      ...
      null != i && (r = !0, (0, p.i7)(e, null != (n = i.guild_id) ? n : "0", i.id, e => {
  ...
  run(e) {
    ...
    return !1 === r[f.vID.INVITE] && g(e, i.z.CHANNEL_NOTICE_INVITE) && (n = !0), !1 === r[f.vID.QUICKSWITCHER] && g(e, i.z.CHANNEL_NOTICE_QUICKSWITCHER) && (n = !0), !1 === r[f.vID.GUILD_BOOSTING] && g(e, i.z.CHANNEL_NOTICE_PREMIUM_GUILD_SUBSCRIPTION) && (n = !0), n
  },
  cleanup() {
