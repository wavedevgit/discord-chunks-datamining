...
function r(e, t) {
  ...
  let m = t[c];
  if (null == m || "" === m) returnfalse;
  let f = null == u ? true : u.match(/SelectableChoice\/(\d+)/),
    g = null == f ? true : f[1];
  switch (o) {
    case "Selected":
  ...
  return i >= o.length ? [] : o[i].filter(t => (function(e, t) {
    ...
    for (let e in n)
      if ("Type" !== e && "inPage" !== e && "object" == typeof n[e]) {
        ...
        } else if ("Else" === i.Type) returntrue
      } returnfalse
  })(e.Questions[t], a))
}
        ...
        if (null != t) {
          let n = function(e, t) {
            ...
            for (let i of e.SkipLogic) {
              ...
              let u = null == o ? true : o.match(/SelectableChoice\/(\d+)/),
                d = null == u ? true : u[1],
                p = false;
              switch (l) {
                case "Selected":
                ...
                case "LessThanOrEqualTo":
                  ...
                  break;
                case "Contains":
                  p = c.includes(null != (n = null == a ? true : a.toString()) ? n : "");
                  break;
                case "DoesNotContain":
                  p = !c.includes(null != (r = null == a ? true : a.toString()) ? r : "")
              }
              if (p) {
