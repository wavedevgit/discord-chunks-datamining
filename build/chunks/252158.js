...
let x = {
  [v.u.NO_AUDIO_INPUT_DETECTED]: {
    getActiveErrors: e => {
      ...
      if (null != r && null != o && !1 === p.Z.getInputDetected() && !i) return [C({
  ...
  [v.u.STREAM_FAILED_TO_START]: {
    getActiveErrors: e => {
      ...
      return t.filter(e => e.state === T.jm8.FAILED).map(e => C({
  ...
  [v.u.STREAM_RECONNECTING]: {
    getActiveErrors: e => {
      ...
      return t.filter(e => e.state === T.jm8.RECONNECTING).map(e => C({
