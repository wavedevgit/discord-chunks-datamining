...
function N(e) {
  let {
    ...
    isBannerVisible: n,
    disableBoostClick: i
  } = e, a = (0, l.Q3)("PremiumGuildBadge"), c = (0, o.e7)([m.default, h.ZP], () => {
  ...
  let p = e => {
      e.stopPropagation(), e.preventDefault(), c && !i && (0, f.f)({
        guildId: t.id,
        location: {
...
function C(e) {
  let {
    ...
    disableColor: n,
    disableBoostClick: i
  } = e, o = (0, c.Z)(t), f = (0, l.Q3)("GuildStatusBadge"), {
    entrypoints: _
  } = (0, p._k)({
    location: "guild_status_badge"
  });
  return o ? (0, r.jsx)("div", {
    className: a()(y.guildIconV2Container, {
      [y.invitesRefresh]: _
    }),
    children: (0, r.jsx)(d.Z, {
      ...
      className: a()(y.guildBadge, {
        [y.disableColor]: n
      }),
      disableBoostClick: i
    })
  }) : (0, r.jsx)("div", {
    className: a()(y.guildIconContainer, {
      [y.invitesRefresh]: _
    }),
