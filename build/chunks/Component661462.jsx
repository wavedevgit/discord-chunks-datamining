...
function j(e) {
  ...
  return i === g.oh.ACTIVITY ? (0, r.jsx)(s.Z, {
    user: t,
    currentUser: n,
    displayProfile: a,
    guildId: o,
    ...
    subsection: l,
    onClose: b
  }) : i === g.oh.MUTUAL_FRIENDS ? (0, r.jsx)(u.Z, {
    user: t,
    guildId: o,
    channelId: c,
    onClose: b
  }) : i === g.oh.MUTUAL_GUILDS ? (0, r.jsx)(d.Z, {
    user: t,
    onClose: b
  }) : i === g.oh.WIDGETS ? (0, r.jsx)(f.C, {
    user: t,
    guildId: o,
    channelId: c
  }) : null
...
function y(e) {
  ...
  let {
    ...
    subsection: v,
    text: h
  }, _] = i.useState(m(p({}, null != (t = d.find(e => {
    let {
      section: t
    } = e;
    return t === f
