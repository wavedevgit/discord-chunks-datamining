...
function O(e) {
  ...
  }, [D]), null == A) ? null : (C = G ? v.intl.format(v.t.z847Tk, {
    wallpaper_name: null != (n = null == D ? void 0 : D.label) ? n : v.intl.string(v.t["UQMV/P"])
  ...
  }), w ? k || Z ? V && F ? S = v.intl.formatToPlainString(v.t.PzTpVV, {
    wallpaperName: null != (j = null == D ? void 0 : D.label) ? j : v.intl.string(v.t["UQMV/P"])
  }) : G || H || !F || (S = v.intl.format(v.t.JwUhHh, {
    onClickNitro: () => {
      (0, u.uL)(x.Z5c.NITRO_HOME)
    }
  })) : S = v.intl.format(v.t.dBxFsL, {
    learnMoreLink: p.Z.getArticleURL(x.BhN.DM_WALLPAPERS)
  }) : S = v.intl.string(v.t["6JSOu7"]), (null == U ? void 0 : U.isViewable) && F && !G && (I = (0, r.jsx)(a.zxk, {
    className: E.action,
    onClick: () => {
      g.X(T, A, {
        shouldClear: !V,
