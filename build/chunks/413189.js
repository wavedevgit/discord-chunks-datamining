...
function O(e) {
  ...
  }, [k]), null == A) ? null : (j = F ? v.NW.format(v.t.z847Tk, {
    wallpaper_name: null != (n = null == k ? void 0 : k.label) ? n : v.NW.string(v.t["UQMV/P"])
  }) : v.NW.format(v.t["+lKndX"], {
    username: null == Z ? void 0 : Z.nick,
    wallpaper_name: null != (O = null == k ? void 0 : k.label) ? O : v.NW.string(v.t["UQMV/P"])
  }), w ? R ? G && W ? C = v.NW.formatToPlainString(v.t.PzTpVV, {
    wallpaperName: null != (N = null == k ? void 0 : k.label) ? N : v.NW.string(v.t["UQMV/P"])
  }) : F || B || !W || (C = v.NW.format(v.t.JwUhHh, {
    onClickNitro: () => {
      (0, u.uL)(x.Z5c.NITRO_HOME)
    }
  })) : C = v.NW.format(v.t.dBxFsL, {
    learnMoreLink: p.Z.getArticleURL(x.BhN.DM_WALLPAPERS)
  }) : C = v.NW.string(v.t["6JSOu7"]), (null == M ? void 0 : M.isViewable) && W && !F && (S = (0, r.jsx)(l.zxk, {
    className: E.action,
    onClick: () => {
      g.X(T, A, {
        shouldClear: !G
