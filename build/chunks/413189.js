...
function O(e) {
  ...
  let {
    ...
    location: "ChatWallpaperSetSystemMessage"
  }).enabled, Z = (0, s.ZP)(I), k = (0, o.wjy)((0, l.ZP)()), {
    chatWallpaper: R,
  ...
  })), M = L === I.id, W = (0, a.e7)([d.default], () => d.default.getCurrentUser()), U = (null == W ? void 0 : W.id) === I.author.id, F = (0, c.m)(x.p9.TIER_2), B = (0, _.P)(null === (t = S.wallpaper) || void 0 === t ? void 0 : t.setterId), G = h.t(S);
  return (i.useEffect(() => {
    null == R && f.Z.shouldFetchWallpapers && g.k9()
  }, [R]), null == P) ? null : (N = k ? U ? y.NW.format(y.t.z847Tk, {
    wallpaper_name: null !== (n = null == R ? void 0 : R.label) && void 0 !== n ? n : y.t["UQMV/P"]
  ...
  }), A ? G && M ? j = y.NW.formatToPlainString(y.t.PzTpVV, {
    wallpaperName: null == R ? void 0 : R.label
  }) : U || F || !M || (j = y.NW.format(y.t.JwUhHh, {
    onClickNitro: () => {
      (0, u.uL)(v.Z5c.NITRO_HOME)
    }
  })) : j = y.NW.string(y.t["6JSOu7"]), A && w && M && k && B && (C = (0, r.jsx)(o.zxk, {
    className: E.action,
    onClick: () => {
      g.X(S, P, {
        shouldClear: !G
