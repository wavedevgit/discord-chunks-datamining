...
function y(e) {
  ...
  return (i.useEffect(() => {
  ...
  }, [M]), null == w) ? null : (j = V ? O.intl.format(O.t.z847Tk, {
    ...
    wallpaperName: null != (I = null == M ? void 0 : M.label) ? I : O.intl.string(O.t["UQMV/P"])
  }) : V || H || !B || (S = O.intl.format(O.t.JwUhHh, {
    onClickNitro: () => {
      (0, d.uL)(C.Z5c.NITRO_HOME)
    }
  })) : S = O.intl.format(O.t.dBxFsL, {
    learnMoreLink: m.Z.getArticleURL(C.BhN.DM_WALLPAPERS)
  }) : S = O.intl.string(O.t["6JSOu7"]), (null == F ? void 0 : F.isViewable) && B && !V && (T = (0, r.jsx)("div", {
    className: x.action,
