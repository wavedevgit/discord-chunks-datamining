...
function x(e) {
  ...
  }, [M]), null == w) ? null : (j = H ? y.intl.format(y.t.z847Tk, {
    wallpaper_name: null != (n = null == M ? void 0 : M.label) ? n : y.intl.string(y.t["UQMV/P"])
  ...
  }), Z ? L || R ? z && B ? S = y.intl.formatToPlainString(y.t.PzTpVV, {
    wallpaperName: null != (I = null == M ? void 0 : M.label) ? I : y.intl.string(y.t["UQMV/P"])
  }) : H || V || !B || (S = y.intl.format(y.t.JwUhHh, {
    onClickNitro: () => {
      (0, d.uL)(C.Z5c.NITRO_HOME)
    }
  })) : S = y.intl.format(y.t.dBxFsL, {
    learnMoreLink: m.Z.getArticleURL(C.BhN.DM_WALLPAPERS)
  }) : S = y.intl.string(y.t["6JSOu7"]), (null == F ? void 0 : F.isViewable) && B && !H && (T = (0, r.jsx)("div", {
    className: v.action,
