...
function N(e) {
  ...
  }, [k]), null == A) ? null : (j = F ? E.NW.format(E.t.z847Tk, {
    wallpaper_name: null != (n = null == k ? void 0 : k.label) ? n : E.NW.string(E.t["UQMV/P"])
  }) : E.NW.format(E.t["+lKndX"], {
    username: null == Z ? void 0 : Z.nick,
    wallpaper_name: null != (N = null == k ? void 0 : k.label) ? N : E.NW.string(E.t["UQMV/P"])
  }), w ? R ? G && W ? C = E.NW.formatToPlainString(E.t.PzTpVV, {
    wallpaperName: null != (O = null == k ? void 0 : k.label) ? O : E.NW.string(E.t["UQMV/P"])
  }) : F || B || !W || (C = E.NW.format(E.t.JwUhHh, {
    onClickNitro: () => {
      (0, u.uL)(x.Z5c.NITRO_HOME)
    }
  })) : C = E.NW.format(E.t.dBxFsL, {
    learnMoreLink: p.Z.getArticleURL(x.BhN.DM_WALLPAPERS)
  }) : C = E.NW.string(E.t["6JSOu7"]), (null == M ? void 0 : M.isViewable) && W && !F && (S = (0, r.jsx)(l.zxk, {
    className: v.action,
    onClick: () => {
      g.X(T, A, {
        shouldClear: !G
