...
function O(e) {
  ...
  }, [M]), null == w) ? null : (I = H ? C.intl.format(C.t.z847Tk, {
    wallpaper_name: null != (n = null == M ? void 0 : M.label) ? n : C.intl.string(C.t["UQMV/P"])
  ...
  }), Z ? D || R ? z && B ? S = C.intl.formatToPlainString(C.t.PzTpVV, {
    wallpaperName: null != (j = null == M ? void 0 : M.label) ? j : C.intl.string(C.t["UQMV/P"])
