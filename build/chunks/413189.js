...
function O(e) {
  ...
  }, [L]), null == A) ? null : (C = G ? E.intl.format(E.t.z847Tk, {
    wallpaper_name: null != (n = null == L ? void 0 : L.label) ? n : E.intl.string(E.t["UQMV/P"])
  ...
  }), w ? k || Z ? V && F ? S = E.intl.formatToPlainString(E.t.PzTpVV, {
    wallpaperName: null != (j = null == L ? void 0 : L.label) ? j : E.intl.string(E.t["UQMV/P"])
  }) : G || H || !F || (S = E.intl.format(E.t.JwUhHh, {
    onClickNitro: () => {
      (0, u.uL)(y.Z5c.NITRO_HOME)
    }
  })) : S = E.intl.format(E.t.dBxFsL, {
    learnMoreLink: p.Z.getArticleURL(y.BhN.DM_WALLPAPERS)
  }) : S = E.intl.string(E.t["6JSOu7"]), (null == U ? void 0 : U.isViewable) && F && !G && (I = (0, r.jsx)(a.zxk, {
    className: v.action,
    onClick: () => {
      g.X(T, A, {
        shouldClear: !V,
