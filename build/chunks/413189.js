...
function O(e) {
  ...
  return (i.useEffect(() => {
  ...
  }, [D]), null == w) ? null : (I = H ? v.intl.format(v.t.z847Tk, {
  ...
  }), Z ? k || R ? z && B ? S = v.intl.formatToPlainString(v.t.PzTpVV, {
    ...
    learnMoreLink: m.Z.getArticleURL(x.BhN.DM_WALLPAPERS)
  }) : S = v.intl.string(v.t["6JSOu7"]), (null == F ? void 0 : F.isViewable) && B && !H && (T = (0, r.jsx)(a.zx, {
    className: C.action,
    onClick: () => {
      _.X(P, w, {
        shouldClear: !z,
