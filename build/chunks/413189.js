...
function E(e) {
  ...
  let {
    ...
    location: "ChatWallpaperSetSystemMessage"
  }).enabled, w = (0, l.ZP)(C), Z = (0, a.wjy)((0, o.ZP)()), {
    chatWallpaper: k,
  ...
  })), L = D === C.id, M = (0, i.e7)([u.default], () => u.default.getCurrentUser()), W = (null == M ? void 0 : M.id) === C.author.id, U = (0, s.m)(v.p9.TIER_2), F = (0, g.P)(null === (t = I.wallpaper) || void 0 === t ? void 0 : t.setterId), B = f.t(I);
  return null == T ? null : (O = Z ? W ? x.NW.format(x.t.z847Tk, {
    wallpaper_name: null !== (n = null == k ? void 0 : k.label) && void 0 !== n ? n : x.t["UQMV/P"]
