...
function h(e) {
  ...
  return <div className={a()(p.emptyPreviewContainer, s)}>{t ? (0, r.jsx)(l.$jN, {}) : (0, r.jsxs)(r.Fragment, {
...
function m(e) {
  ...
  return null == y ? <h className={n} isLoading={E} noText={o} noImage={a} previewText={m ? true : _.intl.string(_.t.pgUTZG)} /> : <div className={n}><img src={y} alt={""} className={p.image} /></div>
}