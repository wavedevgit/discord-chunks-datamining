...
function g(e) {
  let {
    ...
    fractionalState: a,
    activationDate: o
  } = e, g = t ? d.intl.string(d.t["hT6i//"]) : d.intl.string(d.t["3G0CTE"]), m = t ? void 0 === o ? null : d.intl.format(d.t["0Vwb/v"], {
    activateDate: o
...
let m = function(e) {
  let {
    ...
    className: n,
    activationDate: r
  } = e, c = (0, o.jp)(t), m = c.length > 0, p = (0, a.ZP)(t.endsAt, a.aj.SHORT_TIME), h = m ? c : p;
  return (0, i.jsx)("div", {
    children: (0, i.jsxs)("div", {
