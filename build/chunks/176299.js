...
let ej = (0, u.Un)({
  ...
  ek = e => {
    let {
      ...
      messageId: o,
      threadId: c
    } = t.params, u = (0, h.e7)([eo.Z], () => eo.Z.getGuild(l)), d = (0, h.e7)([ea.ZP], () => null == l ? null : ea.ZP.getSelfMember(l)), p = (0, h.e7)([F.Z], () => {
      if (null == l) return;
      let e = F.Z.getData(l);
    ...
    if ((0, M.p3)(u, d)) return (0, r.jsx)(U.Z, {
      guildId: l,
      channelId: a
    });
  ...
  ez = function() {
    ...
    return function(t) {
      ...
      return Object.values(ev.AW).includes(n) ? (0, r.jsx)(j.Z, eT({
        isFullScreen: e,
        tab: n
      }, t)) : (0, r.jsx)(j.Z, eT({
        isFullScreen: e
...
function e$(e) {
  ...
  let I = i.useRef(null),
    v = i.useCallback((e, t) => {
      ...
      let i = t - e;
      null == (n = I.current) || n.style.setProperty("--custom-overdrag", "".concat(1 + Math.min(Math.abs(i / e_.p8), .25))), m && (A.useAppSidebarState.setState({
        isOpen: !r
      }), r && eJ(e_.p8))
    }, [m]),
    C = i.useCallback(() => {
    ...
    S = i.useCallback(e => {
      var t;
      document.body.classList.remove(eN.dragging), document.body.classList.remove(eN.draggingMin), document.body.classList.remove(eN.draggingMax), document.body.classList.remove(eN.collapsing), null == (t = I.current) || t.style.setProperty("--custom-overdrag", "0px"), f.K.set(e_.nT, e), eu.default.track(ey.rMx.CHANNEL_SIDEBAR_RESIZED, {
        width: e
      })
    }, []),
    T = (0, E.Z)({
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [f && !u && !E && (0, r.jsx)(B.Z, {
      ...
      children: (0, r.jsxs)("div", {
        className: eN.base,
        "data-fullscreen": j,
        children: [E && !j && (0, r.jsx)(ej, {}), d.tq ? null : (0, r.jsx)(em.Z, {}), (0, r.jsxs)("div", {
          className: eN.content,
          children: [(0, r.jsx)(P.Z, {}), (0, r.jsx)(e$, {
