...
let ex = (0, u.Un)({
  ...
  e1 = e => {
    ...
    switch (t.params.feature) {
      case "friends":
        return (0, r.jsx)(ee.Z, {
          initialSection: eS.pJs.ONLINE
        });
      case "addFriends":
        return (0, r.jsx)(ee.Z, {
          initialSection: eS.pJs.ADD_FRIEND
        });
      case "pendingFriends":
        return (0, r.jsx)(ee.Z, {
          initialSection: eS.pJs.PENDING
        });
      case "sessionManagement":
        return (0, r.jsx)(s.l_, {
          to: eS.Z5c.SETTINGS("sessions")
        });
      case "connections":
        return (0, r.jsx)(s.l_, {
          to: {
      ...
      case "family-center":
        return (0, r.jsx)(s.l_, {
          to: eS.Z5c.FAMILY_CENTER
        });
      case "account-standing":
        return (0, r.jsx)(s.l_, {
          to: eS.Z5c.SETTINGS("account", "account-standing")
        });
      case "authorized-apps":
        return (0, r.jsx)(s.l_, {
          to: eS.Z5c.SETTINGS("authorized-apps")
        });
      case "open-shop":
        return (0, r.jsx)(s.l_, {
          to: eS.Z5c.COLLECTIBLES_SHOP_FULLSCREEN
        });
      case "editProfile":
        return (0, r.jsx)(s.l_, {
          to: {
      ...
      case "connected-games":
        return (0, r.jsx)(s.l_, {
          to: eS.Z5c.SETTINGS("content-and-social", "connected-games")
        });
      case "boost":
        let n = t.params.guildId;
        return (0, r.jsx)(s.l_, {
          to: eS.Z5c.POWERUP_STORE(n)
        });
      case "boost-settings":
        return (0, r.jsx)(s.l_, {
          to: eS.Z5c.SETTINGS("guild-boosting")
        });
      default:
        return (0, r.jsx)(s.l_, {
          to: eS.Z5c.ME
...
function e5(e) {
  ...
  let y = i.useRef(null),
    ...
    S = i.useCallback(e => {
      var t;
      document.body.classList.remove(eA.dragging), document.body.classList.remove(eA.draggingMin), document.body.classList.remove(eA.draggingMax), document.body.classList.remove(eA.collapsing), null == (t = y.current) || t.style.setProperty("--custom-overdrag", "0px"), h.K.set(ev.nT, e), eg.default.track(eS.rMx.CHANNEL_SIDEBAR_RESIZED, {
        width: e
      })
    }, []),
    N = (0, O.Z)({
...
function e4() {
  ...
  let t = (0, p.e7)([ef.ZP], () => ef.ZP.hasNotice()),
    ...
    l = function() {
      ...
      return i.useEffect(() => el.Z.addRouteChangeListener(e => {
  ...
  return (0, r.jsx)("div", {
    ...
    children: (0, r.jsx)(D.Z.Provider, {
      ...
      children: (0, r.jsxs)("div", {
        className: eA.base,
        "data-fullscreen": v,
        children: [!v && (0, r.jsx)(ex, {}), d.tq ? null : (0, r.jsx)(eE.Z, {}), (0, r.jsxs)("div", {
          className: eA.content,
          children: [(0, r.jsx)(N.Z, {}), (0, r.jsx)(e5, {
            ...
            children: (0, r.jsxs)(y.Z.Provider, {
              ...
              children: [(0, r.jsxs)(s.rs, {
                children: [(0, r.jsx)(I.Z, {
                  ...
                  path: [eS.Z5c.CHANNEL_THREAD_VIEW(ea.Hw.guildId(), ea.Hw.channelId(), ":threadId", ":messageId?"), eS.Z5c.CHANNEL(eS.ME, ea.Hw.channelId()), eS.Z5c.CHANNEL(ea.Hw.guildId(), ea.Hw.channelId({
                    optional: !0
                  }), ":messageId?")],
                  render: eH,
