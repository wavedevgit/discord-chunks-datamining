...
let ex = (0, u.Un)({
  ...
  eU = e => {
    let {
      ...
      messageId: o,
      threadId: c
    } = t.params, u = (0, p.e7)([ed.Z], () => ed.Z.getGuild(l)), d = (0, p.e7)([eu.ZP], () => null == l ? null : eu.ZP.getSelfMember(l)), h = (0, p.e7)([B.Z], () => {
      if (null == l) return;
      let e = B.Z.getData(l);
  ...
  eG = i.memo(function() {
    ...
    return window.location.pathname.startsWith(eC.Z5c.CHANNEL(eC.STv)) ? ("sidebar" !== n && (0, ea.dL)(ec.Z.defaultRoute), (0, r.jsx)(X.Z, {
...
function e3(e) {
  ...
  let y = i.useRef(null),
    v = i.useCallback((e, t) => {
      ...
      let i = t - e;
      null == (n = y.current) || n.style.setProperty("--custom-overdrag", "".concat(1 + Math.min(Math.abs(i / ey.p8), .25))), O && (T.useAppSidebarState.setState({
        isOpen: !r
      }), r && e1(ey.p8))
    }, [O]),
    C = i.useCallback(() => {
            ...
            children: (0, r.jsxs)(E.Z.Provider, {
              ...
              children: [(0, r.jsxs)(s.rs, {
                children: [(0, r.jsx)(v.Z, {
                  ...
                  disableTrack: !0
                }), f === q.jP.SIDEBAR && (0, r.jsx)(v.Z, {
                  path: eC.Z5c.CHANNEL(eC.STv, el.Hw.channelId({
                    optional: !0
                  }), ":messageId?"),
                  render: eB,
                  disableTrack: !0
