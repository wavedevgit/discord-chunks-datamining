...
let eN = (0, u.Un)({
  ...
  eA = e => {
    let {
      ...
      channelId: o,
      messageId: a
    } = t.params, c = (0, p.e7)([et.Z], () => et.Z.getGuild(l)), u = (0, p.e7)([ee.ZP], () => null == l ? null : ee.ZP.getSelfMember(l)), d = (0, p.e7)([W.Z], () => {
      if (null == l) return;
      let e = W.Z.getData(l);
    ...
    }), h = (0, T.C4)(l, "channel_renderer"), f = (0, L.jS)(l, "ChannelRenderer");
    if (null != l && null != o && (0, em.AB)(o)) switch (o) {
      ...
      case em.oC.MEMBER_APPLICATIONS:
        return f ? (0, r.jsx)(s.l_, {
          to: eg.Z5c.CHANNEL(l, em.oC.MEMBER_SAFETY)
        }) : (0, r.jsx)(eI, {
          guildId: l
        });
    ...
    if ((0, R.p3)(c, u)) return (0, r.jsx)(D.Z, {
      guildId: l,
      channelId: o
    });
  ...
  eZ = i.memo(function() {
    ...
    return window.location.pathname.startsWith(eg.Z5c.GLOBAL_DISCOVERY) || window.location.pathname.startsWith(eg.Z5c.GUILD_DISCOVERY) || (0, K.OG)() ? (0, r.jsx)(Z.Z, {}) : null != e ? (0, r.jsx)(M.Z, {
      selectedChannelId: n,
      guildId: e
    }, e) : (0, r.jsx)(ed.Z, {})
  }),
  ...
  eM = function() {
    ...
    return function(t) {
      ...
      return Object.values(eb.AW).includes(n) ? (0, r.jsx)(C.Z, eO({
        isFullScreen: e,
        tab: n
      }, t)) : (0, r.jsx)(C.Z, eO({
        isFullScreen: e
...
function eF(e) {
  ...
  i.useLayoutEffect(() => {
    if (E) {
      ...
      let n = e => {
        e.metaKey && "b" === e.key && S.useAppSidebarState.setState(e => ({
          isOpen: !e.isOpen
        }))
      };
  ...
  let y = i.useRef(null),
    I = i.useCallback((e, t) => {
      ...
      let i = t - e;
      null === (n = y.current) || void 0 === n || n.style.setProperty("--custom-overdrag", "".concat(1 + Math.min(Math.abs(i / ep.p8), .25))), E && (S.useAppSidebarState.setState({
        isOpen: !r
      }), r && eH(ep.p8))
    }, [E]),
    C = i.useCallback(() => {
    ...
    A = i.useCallback(() => {
      S.useAppSidebarState.setState(e => ({
        isOpen: !e.isOpen
      }))
    }, []);
...
function ez() {
  ...
  let t = (0, p.e7)([er.ZP], () => er.ZP.hasNotice()),
    ...
    f = (0, s.$B)([eg.Z5c.CHANNEL(eg.ME, Q.Hw.channelId()), eg.Z5c.CHANNEL(Q.Hw.guildId(), Q.Hw.channelId({
      optional: !0
    }), ":messageId?")]),
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [h && !u && !_ && (0, r.jsx)(U.Z, {
      ...
      children: (0, r.jsxs)("div", {
        className: eE.base,
        "data-fullscreen": T,
        children: [_ && !T && (0, r.jsx)(eN, {}), d.tq ? null : (0, r.jsx)(eu.Z, {}), (0, r.jsxs)("div", {
          className: eE.content,
          children: [(0, r.jsx)(I.Z, {}), (0, r.jsx)(eF, {
            ...
            children: (0, r.jsx)(E.Z.Provider, {
              ...
              children: (0, r.jsxs)(s.rs, {
                children: [(0, r.jsx)(N.Z, {
                  ...
                  path: [eg.Z5c.CHANNEL_THREAD_VIEW(Q.Hw.guildId(), Q.Hw.channelId(), ":threadId", ":messageId?"), eg.Z5c.CHANNEL(eg.ME, Q.Hw.channelId()), eg.Z5c.CHANNEL(Q.Hw.guildId(), Q.Hw.channelId({
                    optional: !0
                  }), ":messageId?")],
                  render: ex,
