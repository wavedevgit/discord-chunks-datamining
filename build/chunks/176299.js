...
let ev = (0, u.Un)({
    ...
    if (null != l && null != a && (0, eb.AB)(a)) switch (a) {
      ...
      case eb.oC.MEMBER_APPLICATIONS:
        return f ? (0, r.jsx)(s.l_, {
          to: em.Z5c.CHANNEL(l, eb.oC.MEMBER_SAFETY)
        }) : (0, r.jsx)(eT, {
          guildId: l
        });
  ...
  ek = e => {
    ...
    return null != t.params.guildId ? (0, r.jsx)(R.Z, {
  ...
  eW = function() {
    ...
    return function(t) {
      ...
      return Object.values(e_.AW).includes(n) ? (0, r.jsx)(S.Z, ey({
        isFullScreen: e,
        tab: n
      }, t)) : (0, r.jsx)(S.Z, ey({
        isFullScreen: e
  ...
  ez = e => {
    ...
    switch (t.params.feature) {
      case "friends":
        return (0, r.jsx)(K.Z, {
          initialSection: em.pJs.ONLINE
        });
      case "addFriends":
        return (0, r.jsx)(K.Z, {
          initialSection: em.pJs.ADD_FRIEND
        });
      case "pendingFriends":
        return (0, r.jsx)(K.Z, {
          initialSection: em.pJs.PENDING
        });
      case "sessionManagement":
        return (0, r.jsx)(s.l_, {
          to: em.Z5c.SETTINGS("sessions")
        });
      case "connections":
        return (0, r.jsx)(s.l_, {
          to: {
      ...
      case "family-center":
        return (0, r.jsx)(s.l_, {
          to: em.Z5c.FAMILY_CENTER
        });
      case "account-standing":
        return (0, r.jsx)(s.l_, {
          to: em.Z5c.SETTINGS("account", "account-standing")
        });
      case "authorized-apps":
        return (0, r.jsx)(s.l_, {
          to: em.Z5c.SETTINGS("authorized-apps")
        });
      case "open-shop":
        return (0, r.jsx)(s.l_, {
          to: em.Z5c.COLLECTIBLES_SHOP_FULLSCREEN
        });
      case "editProfile":
        return (0, r.jsx)(s.l_, {
          to: {
            pathname: em.Z5c.SETTINGS("profile-customization")
          }
        });
      case "gift":
      case "store":
...
function eq(e) {
  ...
  let y = i.useRef(null),
    v = i.useCallback((e, t) => {
      ...
      let i = t - e;
      null == (n = y.current) || n.style.setProperty("--custom-overdrag", "".concat(1 + Math.min(Math.abs(i / eh.p8), .25))), E && (T.useAppSidebarState.setState({
        isOpen: !r
      }), r && eK(eh.p8))
    }, [E]),
    C = i.useCallback(() => {
    ...
    S = i.useCallback(e => {
      var t;
      document.body.classList.remove(eN.dragging), document.body.classList.remove(eN.draggingMin), document.body.classList.remove(eN.draggingMax), document.body.classList.remove(eN.collapsing), null == (t = y.current) || t.style.setProperty("--custom-overdrag", "0px"), h.K.set(eh.nT, e), el.default.track(em.rMx.CHANNEL_SIDEBAR_RESIZED, {
        width: e
      })
    }, []),
    P = (0, _.Z)({
...
function eQ() {
  ...
  let t = (0, p.e7)([ei.ZP], () => ei.ZP.hasNotice()),
    ...
    f = (0, s.$B)([em.Z5c.CHANNEL(em.ME, J.Hw.channelId()), em.Z5c.CHANNEL(J.Hw.guildId(), J.Hw.channelId({
      optional: !0
    }), ":messageId?")]),
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [h && !u && !_ && (0, r.jsx)(G.Z, {
      ...
      children: (0, r.jsxs)("div", {
        className: eN.base,
        "data-fullscreen": P,
        children: [_ && !P && (0, r.jsx)(ev, {}), d.tq ? null : (0, r.jsx)(ed.Z, {}), (0, r.jsxs)("div", {
          className: eN.content,
          children: [(0, r.jsx)(C.Z, {}), (0, r.jsx)(eq, {
