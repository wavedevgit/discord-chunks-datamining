...
let eI = (0, u.Un)({
  ...
  eU = function() {
    ...
    return function(t) {
      ...
      return Object.values(eb.AW).includes(n) ? (0, r.jsx)(S.Z, eN({
        isFullScreen: e,
        tab: n
      }, t)) : (0, r.jsx)(S.Z, eN({
        isFullScreen: e
...
function eY(e) {
  ...
  let y = i.useRef(null),
    v = i.useCallback((e, t) => {
      ...
      let i = t - e;
      null == (n = y.current) || n.style.setProperty("--custom-overdrag", "".concat(1 + Math.min(Math.abs(i / ep.p8), .25))), E && (T.useAppSidebarState.setState({
        isOpen: !r
      }), r && ez(ep.p8))
    }, [E]),
    C = i.useCallback(() => {
    ...
    S = i.useCallback(e => {
      var t;
      document.body.classList.remove(eO.dragging), document.body.classList.remove(eO.draggingMin), document.body.classList.remove(eO.draggingMax), document.body.classList.remove(eO.collapsing), null == (t = y.current) || t.style.setProperty("--custom-overdrag", "0px"), h.K.set(ep.nT, e), ei.default.track(eg.rMx.CHANNEL_SIDEBAR_RESIZED, {
        width: e
      })
    }, []),
    P = (0, _.Z)({
