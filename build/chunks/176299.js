...
let eN = (0, u.Un)({
  ...
  eA = e => {
    ...
    }), d = (0, S.C4)(i, "channel_renderer"), h = (0, x.jS)(i, "ChannelRenderer"), g = (0, Y.Ek)(a, "ChannelRenderer");
    if (null != i && null != l && (0, em.AB)(l)) switch (l) {
      ...
      case em.oC.MEMBER_APPLICATIONS:
        return h ? (0, r.jsx)(s.l_, {
          to: ef.Z5c.CHANNEL(i, em.oC.MEMBER_SAFETY)
        }) : (0, r.jsx)(eI, {
          guildId: i
        });
  ...
  eZ = i.memo(function() {
    ...
    return window.location.pathname.startsWith(ef.Z5c.GLOBAL_DISCOVERY) || window.location.pathname.startsWith(ef.Z5c.GUILD_DISCOVERY) || (0, K.OG)() ? (0, r.jsx)(A.Z, {}) : null != e ? (0, r.jsx)(k.Z, {
      selectedChannelId: n,
      guildId: e
    }, e) : (0, r.jsx)(ed.Z, {})
  }),
  ...
  eB = e => {
    ...
    switch (t.params.feature) {
      case "friends":
        return (0, r.jsx)(z.Z, {
          initialSection: ef.pJs.ONLINE
        });
      case "addFriends":
        return (0, r.jsx)(z.Z, {
          initialSection: ef.pJs.ADD_FRIEND
        });
      case "pendingFriends":
        return (0, r.jsx)(z.Z, {
          initialSection: ef.pJs.PENDING
        });
      case "sessionManagement":
        return (0, r.jsx)(s.l_, {
          to: ef.Z5c.SETTINGS("sessions")
        });
      case "connections":
        return (0, r.jsx)(s.l_, {
          to: {
      ...
      case "family-center":
        return (0, r.jsx)(s.l_, {
          to: ef.Z5c.FAMILY_CENTER
        });
      case "account-standing":
        return (0, r.jsx)(s.l_, {
          to: ef.Z5c.SETTINGS("account", "account-standing")
        });
      case "authorized-apps":
        return (0, r.jsx)(s.l_, {
          to: ef.Z5c.SETTINGS("authorized-apps")
        });
      case "open-shop":
        return (0, r.jsx)(s.l_, {
          to: ef.Z5c.COLLECTIBLES_SHOP_FULLSCREEN
        });
      case "editProfile":
        return (0, r.jsx)(s.l_, {
          to: {
            pathname: ef.Z5c.SETTINGS("profile-customization")
          }
        });
      case "gift":
      case "store":
...
function ez() {
  ...
  let t = (0, p.e7)([er.ZP], () => er.ZP.hasNotice()),
    ...
    a = function() {
      var e;
      let t = (0, s.TH)();
      return (null === (e = (0, s.LX)(t.pathname, ef.Z5c.GUILD_BOOSTING_MARKETING(X.Hw.guildId()))) || void 0 === e ? void 0 : e.isExact) === !0
    }(),
    u = function() {
      var e;
      let t = (0, s.TH)();
    ...
    g = (0, s.$B)([ef.Z5c.CHANNEL(ef.ME, X.Hw.channelId()), ef.Z5c.CHANNEL(X.Hw.guildId(), X.Hw.channelId({
      optional: !0
    }), ":messageId?")]),
            ...
            children: (0, r.jsx)(_.Z.Provider, {
              ...
              children: (0, r.jsxs)(s.rs, {
                children: [(0, r.jsx)(O.Z, {
                  ...
                  path: [ef.Z5c.CHANNEL_THREAD_VIEW(X.Hw.guildId(), X.Hw.channelId(), ":threadId", ":messageId?"), ef.Z5c.CHANNEL(ef.ME, X.Hw.channelId()), ef.Z5c.CHANNEL(X.Hw.guildId(), X.Hw.channelId({
                    optional: !0
                  }), ":messageId?")],
                  render: ex,
                  ...
                  path: ef.Z5c.GUILD_MEMBER_VERIFICATION(X.Hw.guildId()),
                  render: ew,
                  impressionName: c.ImpressionNames.GUILD_MEMBER_VERIFICATION,
                  disableTrack: !0
                }), (0, r.jsx)(O.Z, {
                  path: ef.Z5c.GUILD_MEMBER_VERIFICATION_FOR_HUB(X.Hw.guildId(), ":inviteCode?"),
                  render: eR,
