...
let b = () => <img className={Chunk738134.notificationBadge} src={require("./808824.js")} alt={""} />,
  ...
  h = (0, Chunk73800.forwardRef)(function(e, t) {
    ...
    return <o.P3F onClick={k ? true : y} className={i()(d.clickable, {
        [d.disabled]: m
      })} id={null != r ? r : "balance-widget-pill"}><span onMouseDown={p} onMouseEnter={m ? true : () => E(true)} onMouseLeave={m ? true : () => E(false)} ref={t} className={i()(d.container, R, g, {
          [d.containerLoading]: k,
          [d.inModalOverlay]: C,
          [d.disabled]: m
        })}>{<div className={i()(d.orbsLottieContainer, k ? d.orbIconloading : true)}><s.ZP{...function(e) {
          ...
          })} /></div>}{<c.Z value={D} onValueChange={V} onValueReached={T} targetTotalCounterTime={A} className={k ? d.counterLoading : true} />}{O && <b />}</span></o.P3F>
  })