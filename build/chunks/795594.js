...
let ec = e => {
  ...
  e_ = e => {
    let {
      ...
      locale: p,
      id: g
    } = e, b = a.id, v = i.useMemo(() => M.ZP.createFromServer(a), [a]), I = (0, F.yE)(v.flags, $.udG.EMBEDDED), T = (0, f.e7)([q.Z], () => {
      var e, t, n, r;
    ...
    }), A = a.bot, P = (0, f.e7)([j.Z], () => j.Z.getDMFromUserId(null == A ? void 0 : A.id)), {
    ...
    }), [G, Z] = i.useState(!1), [W, K] = i.useState(!1), Q = D.Z.useExperiment({
      ...
      let e = P;
      null == e && (e = await y.Z.ensurePrivateChannel(A.id)), U ? O.Z.updateAppDMOverrideSettings(null, e, a.id, {
        muted: !1
    ...
    }) : null, eg = (0, X.O)(a.id), eE = () => (0, r.jsxs)("div", {
      className: en.footer,
      children: [eg && (0, r.jsx)(el, {
        application: a,
  ...
  ep = () => {
    ...
    let d = e => {
      ...
      T = () => null == t || null == v ? (0, r.jsx)(E.$jN, {
        ...
        children: [y(), v.sort((e, t) => Number(t.id) - Number(e.id)).map(e => (0, r.jsx)(e_, eo({
          locale: a,
          onDelete: () => d(e),
