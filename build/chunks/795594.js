...
let ep = e => {
  ...
  eb = e => {
    let {
    ...
    }), A = o.bot, R = (0, _.e7)([B.Z], () => B.Z.getDMFromUserId(null == A ? void 0 : A.id)), {
    ...
    }), [M, G] = i.useState(!1), [V, F] = i.useState(!1), W = x.Z.useExperiment({
      location: "Authorized Applications"
    }, {
      autoTrackExposure: !0
    }).enabled, q = () => {
      ...
      if (null != o.description && "" !== o.description) return (0, r.jsx)(g.Text, {
        ...
        variant: "text-sm/normal",
        color: "text-normal",
        children: (0, k.parseBioReact)(o.description)
      })
    }, [o.description]), ee = () => {
    ...
    }, [R, A, L, o.id]), ef = () => T.enabled ? (0, r.jsxs)("div", {
