...
let eh = e => {
  ...
  eg = (e, t) => {
    ...
    return (0, D.Z)(e) && (n = ea.intl.formatToPlainString(ea.t["paC+UV"], {
      applicationName: e.name
    ...
    })), (0, E.h7j)(e => (0, r.jsx)(T.default, eu({
      title: n,
      body: i,
  ...
  eb = e => {
    let {
      ...
      locale: d,
      id: _
    } = e, p = i.useMemo(() => G.ZP.createFromServer(a), [a]), h = k.Z.useExperiment({
      ...
      if (e.length > 0 || null != u && u.length > 0) return (0, r.jsx)(E.xJW, {
        faded: !0,
      ...
      if (null != a.description && "" !== a.description) return (0, r.jsx)(E.xJW, {
        faded: !0,
  ...
  ey = e => {
    let {
    ...
    }), [x, M] = i.useState(!1), [B, V] = i.useState(!1), Z = k.Z.useExperiment({
      location: "Authorized Applications"
    }, {
      autoTrackExposure: !0
    }).enabled, K = () => {
      ...
      }, J.fy.INFREQUENT_USER_ACTION), C.ZP.trackWithMetadata(er.rMx.NOTIFICATION_SETTINGS_UPDATED, {
      ...
      let e = N;
      null == e && (e = await y.Z.ensurePrivateChannel(A.id)), D ? v.Z.updateAppDMOverrideSettings(null, e, a.id, {
        muted: !1
    ...
    }, [N, A, D, a.id]), ef = () => T.enabled ? (0, r.jsxs)("div", {
  ...
  ev = () => {
    ...
    let f = e => {
      ...
      T = () => null == t || null == I ? (0, r.jsx)(E.$jN, {
        className: el.marginTop20,
        type: E.$jN.Type.SPINNING_CIRCLE
      }) : 0 === t.length ? v(ea.intl.string(ea.t.CpPv5u), ea.intl.string(ea.t["E+SM6e"])) : 0 === I.length ? (0, r.jsxs)(r.Fragment, {
        children: [O(), v(null, ea.intl.string(ea.t.EVWFNj))]
      }) : (0, r.jsxs)(r.Fragment, {
        children: [O(), I.sort((e, t) => Number(t.id) - Number(e.id)).map(e => u ? (0, r.jsx)(ey, eu({
          locale: a,
          onDelete: () => f(e),
    ...
    return e ? (0, r.jsx)(S.Z, {}) : (0, r.jsx)(E.hjN, {
      tag: E.RB0.H1,
