...
n.d(t, {
  J: () => ef,
  Z: () => e_
}), n(997841), n(388685), n(539854), n(953529), n(781311), n(642613);
var r = n(255367),
  i = n(73800),
  a = n(120356),
  o = n.n(a),
...
let el = e => {
  ...
  ec = (e, t) => {
    let n = ee.intl.string(ee.t.DT39Aw),
      i = ee.intl.formatToPlainString(ee.t.QWGvxM, {
        applicationName: e.name
      });
    return (0, R.Z)(e) && (n = ee.intl.formatToPlainString(ee.t["paC+UV"], {
      applicationName: e.name
    }), i = (0, r.jsxs)(r.Fragment, {
      children: [ee.intl.formatToPlainString(ee.t.inM1Ym, {
        applicationName: e.name
      }), (0, r.jsx)(X.Z, {
        look: X.z.WARNING,
      ...
      children: [i, (0, r.jsx)(X.Z, {
        className: et.infoBox,
        children: ee.intl.format(ee.t.KRnERk, {
          applicationName: e.name
        })
      })]
    })), (0, g.h7j)(e => (0, r.jsx)(I.default, ea({
      title: n,
      body: i,
  ...
  ed = e => {
    let {
      ...
      locale: p,
      id: E
    } = e, v = a.id, I = i.useMemo(() => x.ZP.createFromServer(a), [a]), T = (0, V.yE)(I.flags, J.udG.EMBEDDED), S = (0, _.e7)([z.Z], () => {
      var e, t, n, r;
    ...
    }), [Y, W] = i.useState(!1), [X, ei] = i.useState(!1), eo = () => {
      let e = [];
        ...
        children: t => {
          ...
          return (0, r.jsxs)(r.Fragment, {
            children: [(0, r.jsxs)(m.P, {
              ...
              children: ee.intl.format(ee.t.nZOS8v, {
      ...
      K.hW.updateAsync("applications", t => {
        v in t.appSettings ? null == t.appSettings[v].appDmSettings ? t.appSettings[v].appDmSettings = h.c$.create({
          allowMobilePush: e
        }) : t.appSettings[v].appDmSettings.allowMobilePush = e : t.appSettings[v] = h.dp.create({
          appDmSettings: h.c$.create({
            allowMobilePush: e
          })
        })
      }, K.fy.INFREQUENT_USER_ACTION), A.ZP.trackWithMetadata(J.rMx.NOTIFICATION_SETTINGS_UPDATED, {
      ...
      children: [(0, r.jsx)(g.X6q, {
        ...
        note: (null == U ? void 0 : U.end_time) != null ? ee.intl.format(ee.t.j7h4AA, {
      ...
      }) : null, T && R.enabled ? (0, r.jsx)(g.j7V, {
        hideBorder: !0,
        onChange: ep,
        className: et.dmSettingsSwitch,
    ...
    }) : null, eg = (0, q.O)(a.id), eE = (0, P.Z)(a), eb = () => (0, r.jsxs)("div", {
      className: et.footer,
      children: [eE ? (0, r.jsx)(es, {
        className: et.warningContainer,
        text: ee.intl.format(ee.t.j4B7ER, {
  ...
  e_ = () => {
    ...
    let c = e => {
      ...
      y = () => null == t || null == b ? (0, r.jsx)(g.$jN, {
        className: er.marginTop20,
        type: g.$jN.Type.SPINNING_CIRCLE
      }) : 0 === t.length ? m(ee.intl.string(ee.t.CpPv5u), ee.intl.string(ee.t["E+SM6e"])) : 0 === b.length ? (0, r.jsxs)(r.Fragment, {
        children: [h(), m(null, ee.intl.string(ee.t.EVWFNj))]
      }) : (0, r.jsxs)(r.Fragment, {
        children: [h(), b.sort((e, t) => Number(t.id) - Number(e.id)).map(e => (0, r.jsx)(ed, ea({
          locale: n,
          onDelete: () => c(e),
    ...
    return e ? (0, r.jsx)(v.Z, {}) : (0, r.jsx)(g.hjN, {
      tag: g.RB0.H1,
