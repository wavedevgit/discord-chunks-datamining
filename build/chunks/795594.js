...
let ec = e => {
  ...
  ef = e => {
    let {
      ...
      locale: p,
      id: g
    } = e, b = a.id, v = i.useMemo(() => k.ZP.createFromServer(a), [a]), I = (0, V.yE)(v.flags, $.udG.EMBEDDED), T = (0, _.e7)([q.Z], () => {
      var e, t, n, r;
  ...
  ep = () => {
    ...
    let d = e => {
      ...
      T = () => null == t || null == v ? (0, r.jsx)(E.$jN, {
        ...
        children: [y(), v.sort((e, t) => Number(t.id) - Number(e.id)).map(e => (0, r.jsx)(ef, eo({
          locale: a,
          onDelete: () => d(e),
