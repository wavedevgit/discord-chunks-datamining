...
let ep = e => {
  ...
  eb = e => {
    let {
      ...
      locale: p,
      id: E
    } = e, y = a.id, O = i.useMemo(() => U.ZP.createFromServer(a), [a]), I = (0, Y.yE)(O.flags, en.udG.EMBEDDED), S = (0, _.e7)([J.Z], () => {
      var e, t, n, r;
      ...
      let e = R;
      null == e && (e = await b.Z.ensurePrivateChannel(A.id)), L ? v.Z.updateAppDMOverrideSettings(null, e, a.id, {
        muted: !1
  ...
  ev = () => {
    ...
    let d = e => {
      ...
      }) : 0 === t.length ? y(ei.intl.string(ei.t.CpPv5u), ei.intl.string(ei.t["E+SM6e"])) : 0 === v.length ? (0, r.jsxs)(r.Fragment, {
        children: [b(), y(null, ei.intl.string(ei.t.EVWFNj))]
      }) : (0, r.jsxs)(r.Fragment, {
        children: [b(), v.sort((e, t) => Number(t.id) - Number(e.id)).map(e => u ? (0, r.jsx)(eb, ec({
          locale: a,
          onDelete: () => d(e),
