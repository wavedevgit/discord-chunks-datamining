...
let eh = e => {
  ...
  eg = (e, t) => {
    let n = ea.intl.string(ea.t.DT39Aw),
      i = ea.intl.formatToPlainString(ea.t.QWGvxM, {
        applicationName: e.name
      });
    return (0, w.Z)(e) && (n = ea.intl.formatToPlainString(ea.t["paC+UV"], {
      applicationName: e.name
    }), i = (0, r.jsxs)(r.Fragment, {
      children: [ea.intl.formatToPlainString(ea.t.inM1Ym, {
        applicationName: e.name
      }), (0, r.jsx)(et.Z, {
        look: et.z.WARNING,
    ...
    })), (0, ee.Z)(e.id) && (i = (0, r.jsxs)(r.Fragment, {
      children: [i, (0, r.jsx)(et.Z, {
        className: eo.infoBox,
        children: ea.intl.format(ea.t.KRnERk, {
          applicationName: e.name
        })
      })]
    })), (0, g.h7j)(e => (0, r.jsx)(S.default, eu({
      title: n,
      body: i,
  ...
  eE = e => {
    let {
      ...
      null != t.terms_of_service_url && (0, K.q)({
        href: t.terms_of_service_url,
        shouldConfirm: !0
      })
    }, a = () => {
      null != t.privacy_policy_url && (0, K.q)({
      ...
      return (0, r.jsxs)("div", {
        ...
        children: [t, (0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(g.X6q, {
            ...
            color: "text-normal",
            children: ea.intl.format(ea.t.yOApCA, {
              date: n
            })
          })]
        }), h ? (0, r.jsx)(g.zxk, {
  ...
  ey = e => {
    let {
      ...
      locale: p,
      id: E
    } = e, y = a.id, O = i.useMemo(() => U.ZP.createFromServer(a), [a]), I = (0, W.yE)(O.flags, er.udG.EMBEDDED), S = (0, _.e7)([$.Z], () => {
      var e, t, n, r;
    ...
    }), [M, G] = i.useState(!1), [V, F] = i.useState(!1), Y = x.Z.useExperiment({
      location: "Authorized Applications"
    }, {
      autoTrackExposure: !0
    }).enabled, K = () => {
        ...
        children: t => {
          ...
          return (0, r.jsxs)(r.Fragment, {
            children: [(0, r.jsxs)(m.P, {
              ...
              children: ea.intl.format(ea.t.nZOS8v, {
      ...
      J.hW.updateAsync("applications", t => {
      ...
      }, J.fy.INFREQUENT_USER_ACTION), N.ZP.trackWithMetadata(er.rMx.NOTIFICATION_SETTINGS_UPDATED, {
      ...
      children: [(0, r.jsx)(g.X6q, {
        ...
        note: (null == w ? void 0 : w.end_time) != null ? ea.intl.format(ea.t.j7h4AA, {
    ...
    }) : null, e_ = (0, ee.O)(a.id), em = () => (0, r.jsxs)("div", {
      className: eo.footer,
      children: [e_ && (0, r.jsx)(ep, {
        application: a,
  ...
  eO = () => {
    ...
    let d = e => {
        ...
        E.Z.delete(t), Y.S.safeDispatch(er.CkL.HIDE_APP_LAUNCHER_BUTTON_APP_INSTALLED_EDUCATION, {
          applicationId: n.id
        });
        let r = o.get(n.id);
      ...
      }) : 0 === t.length ? y(ea.intl.string(ea.t.CpPv5u), ea.intl.string(ea.t["E+SM6e"])) : 0 === v.length ? (0, r.jsxs)(r.Fragment, {
        children: [b(), y(null, ea.intl.string(ea.t.EVWFNj))]
      }) : (0, r.jsxs)(r.Fragment, {
        children: [b(), v.sort((e, t) => Number(t.id) - Number(e.id)).map(e => u ? (0, r.jsx)(ey, eu({
          locale: a,
          onDelete: () => d(e),
          selectedChannelId: null == s ? void 0 : s.id,
          selectedGuildId: null != c ? c : void 0
        }, e), e.id) : (0, r.jsx)(eb, eu({
          locale: a,
          onDelete: () => d(e),
          selectedChannelId: null == s ? void 0 : s.id,
          selectedGuildId: null != c ? c : void 0
