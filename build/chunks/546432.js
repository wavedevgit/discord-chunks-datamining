...
let D = e => {
  ...
  d && y.push((0, i.jsx)(m.Z, {
    ...
    children: e => (0, i.jsx)(s.P3F, T(S({}, e), {
...
function V(e) {
  let {
    ...
    renderVisualPlaceholderComponent: T,
    className: L,
    ...
    type: $,
    contentType: K
  } = n, [Q, ee] = o.useState(!1), [et, en] = o.useState(!1), ei = t.getChannelId(), eo = j.Z.getChannel(ei), er = (0, I.Z)(ei), el = c.P.useExperiment({
    location: "MediaMosaicItem"
  }, {
    autoTrackExposure: !0
  }).imageRecsEnabled, ea = o.useMemo(() => null != K && -1 !== K.indexOf("/") ? K.split("/") : ["unknown", "unknown"], [K]), es = "IMAGE" === $ && !y.uo.test(n.downloadUrl) && !((y.YG.test(n.downloadUrl) || y.FH.test(n.downloadUrl)) && !0 === n.srcIsAnimated), eu = !1;
  if (U) {
    (null == J || null == X) && (eu = !0);
    let e = (0, v.Dc)({
      width: null != J ? J : 0,
...
let W = function(e) {
  ...
  let {
    ...
    height: x,
    type: y
  } = n, I = a(n, (0, f.V)(r.channel_id, r.author.id)), [j, O] = o.useState(null != I), b = u === M.hV.MOSAIC, P = !b && (null != p && p < 200 || null != x && x < 50), E = "IMAGE" === y || "VIDEO" === y, A = (0, w.R_)(y), L = d && null != I && (0, g.bR)(p, x), [D, W] = o.useState(!1), F = () => {
    W(!0)
  }, _ = () => {
    W(!1)
  }, H = function() {
    let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
    return (0, i.jsx)(V, T(S({}, m), {
      item: n,
      message: r,
      getObscureReason: a,
      hiddenSpoilers: e,
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [null != I ? (0, i.jsx)(h.ZP, {
      ...
      obscurityControlClassName: l()({
        [N.obscureVideoSpacing]: "VIDEO" === y && d && !j && D
      }),
