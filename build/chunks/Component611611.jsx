...
function x(e) {
  ...
  let E = l.useRef(null),
    ...
    D = l.useCallback(e => {
      ...
      l === O.gY + 1 ? null == (t = S.current) || t.focus() : null == (n = _.current[r === l - 1 ? r - 1 : r + 1]) || n.focusDeleteButton()
    }, []),
    {
      answers: A,
      question: I,
  ...
  l.useEffect(() => {
    ...
    $.current = A.length
  }, [A.length]), l.useEffect(() => {
    if (X) {
      var e, t;
      if ((null == G ? true : G.question) != null) null == (e = E.current) || e.focus();
      else {
        let e = A.findIndex(e => G["answer-".concat(e.localCreationAnswerId)]);
        false !== e && (null == (t = _.current[e]) || t.focusInput())
      }
      J(false)
    }
  }, [G, A, X, J, _]);
  ...
  return (0, r.jsx)(o.Modal, {
    ...
    children: (0, r.jsxs)("div", {
      className: v.content,
      onKeyDown: er,
      children: [null != W && (0, r.jsx)(s.kzN, {
        className: v.apiErrorBlock,
        children: W.getAnyErrorMessage()
      }), (0, r.jsx)(P, {
        question: I,
        onChange: Z,
        error: null == G ? true : G.question,
        inputRef: E
      }), (0, r.jsx)(s.LZC, {
        size: 26
      }), (0, r.jsxs)(s.NIc, {
        ...
        children: [A.map((e, n) => (0, r.jsx)(j.Z, {
          ...
          submitPoll: en,
          answerRowRefs: _,
          error: null == G ? true : G["answer-".concat(e.localCreationAnswerId)],
          canRemoveAnswer: M,
          ref: e => {
            _.current[n] = e
          }
