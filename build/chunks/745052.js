...
let es = (0, g.Z)(function(e) {
  ...
  (0, b.ZP)(() => {
    h.Y(Q.Z5c.MESSAGE_REQUESTS), (0, A.e)("message-requests"), k.default.track(Q.rMx.MESSAGE_REQUESTS_VIEWED, {
  ...
  let [y, v] = i.useState(X.pS.REQUESTS), C = e => {
    v(e)
  };
  return (0, I.Tt)({
