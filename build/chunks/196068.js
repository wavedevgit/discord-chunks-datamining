...
let w = e => {
  ...
  } = e, n = (0, p.a0)(), S = (0, o.e7)([m.default], () => E.ZP.isPremiumExactly(m.default.getCurrentUser(), v.p9.TIER_2)), {
    enabled: N,
    getNitroCTA: w
  } = _.g.useExperiment({
  ...
  let k = e => (0, r.jsxs)(l.qXd, {
    ...
    children: [(0, r.jsx)(l.RyX, {
      ...
      className: T.text,
      children: [I.intl.string(I.t["5JMiOj"]), " ", I.intl.format(I.t.fjSvsL, {
        onClick: L
      })]
    }) : I.intl.string(I.t["5JMiOj"]) : I.intl.string(I.t["Pzh+Gx"]), (0, r.jsx)(l.NoS, {
      noticeType: O.kVF.OUTBOUND_PROMOTION,
      onClick: () => {
