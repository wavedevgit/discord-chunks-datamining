...
let g = e => {
  ...
  } = e, n = (0, O.a0)(), g = (0, o.e7)([T.default], () => p.ZP.isPremiumExactly(T.default.getCurrentUser(), f.p9.TIER_2)), {
    enabled: y,
    getNitroCTA: m
  } = I.g.useExperiment({
  ...
  let k = e => (0, r.jsxs)(s.qXd, {
    ...
    }) : C.NW.string(C.t["5JMiOj"]) : C.NW.string(C.t["Pzh+Gx"]), (0, r.jsx)(s.NoS, {
      noticeType: P.kVF.OUTBOUND_PROMOTION,
      onClick: () => {
