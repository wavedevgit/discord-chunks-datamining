...
(function() {
  ...
  3: [function(e, t, n) {
    ...
    }), n.shimMediaStream = c, n.shimOnTrack = u, n.shimGetSendersWithDtmf = d, n.shimGetStats = f, n.shimSenderReceiverGetStats = _, n.shimAddTrackRemoveTrackWithNative = p, n.shimAddTrackRemoveTrack = h, n.shimPeerConnection = g, n.fixNegotiationNeeded = m;
    var a = s(e("../utils.js"));
    ...
    function u(e) {
      if ((void 0 === e ? "undefined" : r(e)) !== "object" || !e.RTCPeerConnection || "ontrack" in e.RTCPeerConnection.prototype) a.wrapPeerConnectionEvent(e, "track", function(e) {
          ...
          s = function(e, i) {
            ...
            if (e && "object" === r(e.video)) {
              ...
              if (l && ("user" === l.exact || "environment" === l.exact || "user" === l.ideal || "environment" === l.ideal) && !(t.mediaDevices.getSupportedConstraints && t.mediaDevices.getSupportedConstraints().facingMode && !c)) {
                ...
                var u = void 0;
                if ("environment" === l.exact || "environment" === l.ideal ? u = ["back", "rear"] : ("user" === l.exact || "user" === l.ideal) && (u = ["front"]), u) return t.mediaDevices.enumerateDevices().then(function(t) {
      ...
      if (e.RTCPeerConnection) {
        ...
        var n = function(e) {
          ...
          s = function(e, n) {
            ...
            return o.length > 0 ? r = parseInt(o[0].substr(19), 10) : "firefox" === t.browser && -1 !== n && (r = 0x7ffffff5), r
          },
  ...
  7: [function(e, t, n) {
    ...
    }), n.shimOnTrack = c, n.shimPeerConnection = u, n.shimSenderGetStats = d, n.shimReceiverGetStats = f, n.shimRemoveStream = _, n.shimRTCDataChannel = p, n.shimAddTransceiver = h, n.shimCreateOffer = g, n.shimCreateAnswer = m;
    var a = s(e("../utils"));
  ...
  11: [function(e, t, n) {
    ...
    n.extractVersion = s, n.wrapPeerConnectionEvent = l, n.disableLog = c, n.disableWarnings = u, n.log = d, n.deprecated = f, n.detectBrowser = _, n.compactObject = h, n.walkStats = g, n.filterStats = m;
    var o = !0,
      a = !0;
    ...
    function g(e, t, n) {
      !(!t || n.has(t.id)) && (n.set(t.id, t), Object.keys(t).forEach(function(r) {
        r.endsWith("Id") ? g(e, e.get(t[r]), n) : r.endsWith("Ids") && t[r].forEach(function(t) {
          g(e, e.get(t), n)
        })
      }))
    }
