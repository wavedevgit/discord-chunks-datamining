  ...
  return (0, i.jsx)(o.aVo, {
    ...
    renderRow: function(e) {
      ...
      switch (b) {
        case W.m$.ROLES:
          var C;
          j = (x = n[v]).rowType === W.aC.ROLE && (null === (C = x.tags) || void 0 === C ? void 0 : C.guild_connections) === null ? (0, i.jsx)(p.Z, {
            className: M.shield,
            color: x.colorString,
            size: 20
          }) : (0, i.jsx)(o.lZ8, {
...
function U(e) {
  let {
    ...
    roles: c,
    members: d
  } = e, u = (0, a.e7)([Z.Z], () => Z.Z.can(D.Pl.ADMINISTRATOR, t)), h = T.Uu(D.Pl.VIEW_CHANNEL, t), g = T.Uu(D.Pl.ADMINISTRATOR, t);
  async function m() {
  ...
  return r.isCategory() ? (p.title = A.NW.string(A.t.lEPAZ2), p.subtitle = A.NW.string(A.t["RQUk6+"]), p.formLabel = A.NW.string(A.t["8VIxJi"])) : r.type === L.d4z.GUILD_VOICE && (p.subtitle = A.NW.string(A.t.cLjvKi)), (0, i.jsxs)("div", {
...
let z = a.ZP.connectStores([C.Z, Z.Z, S.ZP, w.Z], () => {
  ...
  let {
    ...
    locked: g,
    permissionUpdates: m
  } = e, [p, f] = r.useState(!T.Uu(D.Pl.SEND_MESSAGES, s));
