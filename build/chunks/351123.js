  ...
  return (0, r.jsx)(o.aVo, {
    ...
    renderRow: function(e) {
      ...
      switch (b) {
        case W.m$.ROLES:
          var C;
          j = (x = n[v]).rowType === W.aC.ROLE && (null == (C = x.tags) ? void 0 : C.guild_connections) === null ? (0, r.jsx)(p.Z, {
            className: M.shield,
            color: x.colorString,
            size: 20
          }) : (0, r.jsx)(o.lZ8, {
...
function G(e) {
  let {
    ...
    channel: i,
    permissionUpdates: l
  } = e, c = (0, a.e7)([w.Z], () => w.Z.getRoles(t.id)), d = R.RZ(t, c, i, v.yP, l), u = (0, a.e7)([S.ZP], () => R.cR(S.ZP.getMemberIds(t.id), i, t, v.yP, l)), h = (0, N.nG)(i.id);
...
function U(e) {
  let {
    ...
    roles: c,
    members: d
  } = e, u = (0, a.e7)([Z.Z], () => Z.Z.can(L.Pl.ADMINISTRATOR, t)), h = T.Uu(L.Pl.VIEW_CHANNEL, t), g = T.Uu(L.Pl.ADMINISTRATOR, t);
  async function m() {
    let e = i.accessPermissions,
      s = O.default.getCurrentUser();
    if (!l && null != await (0, j.T)(t.id, i.id)) return void(0, o.ZDy)(async () => {
      let {
        ConfirmModal: e
  ...
  return i.isCategory() ? (p.title = A.NW.string(A.t.lEPAZ2), p.subtitle = A.NW.string(A.t["RQUk6+"]), p.formLabel = A.NW.string(A.t["8VIxJi"])) : i.type === D.d4z.GUILD_VOICE && (p.subtitle = A.NW.string(A.t.cLjvKi)), (0, r.jsxs)("div", {
...
let z = a.ZP.connectStores([C.Z, Z.Z, S.ZP, w.Z], () => {
  ...
  return {
    canSyncChannel: null != n && Z.Z.can(L.Pl.MANAGE_ROLES, n),
    category: n,
    channel: t,
    filteredMembers: i,
    filteredRoles: r,
  ...
  let {
    ...
    locked: g,
    permissionUpdates: m
  } = e, [p, f] = i.useState(!T.Uu(L.Pl.SEND_MESSAGES, s));
