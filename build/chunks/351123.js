  ...
  return (0, i.jsx)(o.aVo, {
    ...
    renderRow: function(e) {
      ...
      switch (b) {
        case L.m$.ROLES:
          var N;
          x = (j = n[y]).rowType === L.aC.ROLE && (null == (N = j.tags) ? void 0 : N.guild_connections) === null ? (0, i.jsx)(p.Z, {
            className: B.shield,
            color: j.colorString,
            size: 20
          }) : (0, i.jsx)(o.lZ8, {
        ...
        case L.m$.MEMBERS:
          j = l[y], u = (0, i.jsxs)(i.Fragment, {
            ...
            }), null != j.nickname && (0, i.jsx)(o.Text, {
              color: "text-muted",
      ...
      return (0, i.jsxs)(f.Z, {
        ...
        children: [(0, i.jsx)(f.Z, {
          ...
          children: _.zB(j.rowType)
        }), j.rowType !== L.aC.EMPTY_STATE && (0, i.jsx)(o.DY3, {
          className: B.removeIconContainer,
          text: null != r ? r : a(j.rowType, j.disabled),
          children: (0, i.jsx)(o.P3F, {
            onClick: () => {
              var e, n, i;
              return S && null != j && (e = j.id, n = j.name, i = j.rowType, void c.Z.show({
    ...
    renderSection: function(e) {
      ...
      switch (t) {
        case L.m$.ROLES:
          return (0, i.jsx)(F, {
            title: k.intl.string(k.t.LPJmLy)
          }, "roles-title");
        case L.m$.MEMBERS:
          return (0, i.jsx)(F, {
            title: k.intl.string(k.t["9Oq93t"])
          }, "members-title")
      }
    },
    sectionHeight: 49
    ...
    children: [(0, i.jsx)(P.Z, {
      ...
      children: [(0, i.jsxs)(f.Z, {
        ...
        children: [(0, i.jsx)(o.vwX, {
          ...
          shouldShow: !h,
          children: e => (0, i.jsx)(o.zxk, W(V({}, e), {
...
function G(e) {
  let {
    ...
    roles: c,
    members: d
  } = e, u = (0, a.e7)([Z.Z], () => Z.Z.can(M.Pl.ADMINISTRATOR, t)), h = R.Uu(M.Pl.VIEW_CHANNEL, t), g = R.Uu(M.Pl.ADMINISTRATOR, t);
  async function m() {
  ...
  return l.isCategory() ? (p.title = k.intl.string(k.t.lEPAZ2), p.subtitle = k.intl.string(k.t["RQUk6+"]), p.formLabel = k.intl.string(k.t["8VIxJi"])) : l.type === D.d4z.GUILD_VOICE && (p.subtitle = k.intl.string(k.t.cLjvKi)), (0, i.jsxs)("div", {
...
let z = a.ZP.connectStores([N.Z, Z.Z, S.ZP, O.Z, E.Z], () => {
  ...
  let {
    ...
    locked: g,
    permissionUpdates: m
  } = e, [p, f] = l.useState(!R.Uu(M.Pl.SEND_MESSAGES, s));
  if (null == s || null == d) return null;
  let x = {
    title: k.intl.string(k.t.BAZMBg),
    subtitle: k.intl.string(k.t.XLrZys)
  };
  return s.isCategory() && (x.title = k.intl.string(k.t["/uELTk"]), x.subtitle = k.intl.string(k.t["8iAg3d"])), (0, i.jsxs)(i.Fragment, {
    children: [(0, i.jsx)(o.vwX, {
      tag: "h1",
      children: x.title
    }), (0, i.jsx)(o.R94, {
      children: x.subtitle
    }), null != r && t ? g ? (0, i.jsx)(A.Z, {
      canSync: !1,
      icon: o.DuK,
      noticeText: k.intl.format(k.t.ETJqLi, {
        categoryName: r.name
      })
    }) : (0, i.jsx)(A.Z, {
      ...
      canSync: !0,
      icon: (0, o.GSL)(T.Z),
      noticeText: k.intl.format(k.t.OIhm0N, {
        categoryName: r.name
      }),
      onClick: function() {
        null != r && (0, o.ZDy)(async () => {
          ...
          return t => (0, i.jsx)(e, W(V({}, t), {
            ...
            onConfirm: async () => {
              ...
              null != e && null == t[e] && (t[e] = R.we(e)), await (0, j.u)(s, t[e].deny, t[e].allow) && (0, u.wk)(s.id, {
