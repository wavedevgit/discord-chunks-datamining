  ...
  return (0, i.jsx)(o.aVo, {
    ...
    renderRow: function(e) {
      ...
      switch (b) {
        case W.m$.ROLES:
          var C;
          j = (x = n[v]).rowType === W.aC.ROLE && (null == (C = x.tags) ? void 0 : C.guild_connections) === null ? (0, i.jsx)(p.Z, {
            className: M.shield,
            color: x.colorString,
            size: 20
          }) : (0, i.jsx)(o.lZ8, {
      ...
      return (0, i.jsxs)(f.Z, {
        ...
        }), x.rowType !== W.aC.EMPTY_STATE && (0, i.jsx)(o.DY3, {
...
function G(e) {
  let {
    ...
    channel: r,
    permissionUpdates: l
  } = e, c = (0, a.e7)([w.Z], () => w.Z.getRoles(t.id)), d = R.RZ(t, c, r, v.yP, l), u = (0, a.e7)([S.ZP], () => R.cR(S.ZP.getMemberIds(t.id), r, t, v.yP, l)), h = (0, N.nG)(r.id);
    ...
    children: [(0, i.jsx)(I.Z, {
      ...
      children: [(0, i.jsxs)(f.Z, {
        ...
        children: [(0, i.jsx)(o.vwX, {
          ...
          shouldShow: !h,
          children: e => (0, i.jsx)(o.zxk, B(k({}, e), {
...
function U(e) {
  let {
    ...
    roles: c,
    members: d
  } = e, u = (0, a.e7)([O.Z], () => O.Z.can(L.Pl.ADMINISTRATOR, t)), h = E.Uu(L.Pl.VIEW_CHANNEL, t), g = E.Uu(L.Pl.ADMINISTRATOR, t);
  async function m() {
    let e = r.accessPermissions,
      s = Z.default.getCurrentUser();
    if (!l && null != await (0, j.T)(t.id, r.id)) return void(0, o.ZDy)(async () => {
      let {
        ConfirmModal: e
      } = await Promise.resolve().then(n.bind(n, 878678));
      return n => (0, i.jsx)(e, B(k({}, n), {
  ...
  return r.isCategory() ? (p.title = A.NW.string(A.t.lEPAZ2), p.subtitle = A.NW.string(A.t["RQUk6+"]), p.formLabel = A.NW.string(A.t["8VIxJi"])) : r.type === D.d4z.GUILD_VOICE && (p.subtitle = A.NW.string(A.t.cLjvKi)), (0, i.jsxs)("div", {
...
let z = a.ZP.connectStores([C.Z, O.Z, S.ZP, w.Z], () => {
  ...
  if (null != t) {
    ...
    if (null != e) {
      ...
      }, {}), i = R.kA(e, a, t, t.accessPermissions, l), r = R.cR(n, t, e, t.accessPermissions, l), s = R.Yk(t, l)
    }
  }
  return {
  ...
  let {
    ...
    locked: g,
    permissionUpdates: m
  } = e, [p, f] = r.useState(!E.Uu(L.Pl.SEND_MESSAGES, s));
  if (null == s || null == d) return null;
  let j = {
    title: A.NW.string(A.t.BAZMBg),
    subtitle: A.NW.string(A.t.XLrZys)
  };
  return s.isCategory() && (j.title = A.NW.string(A.t["/uELTk"]), j.subtitle = A.NW.string(A.t["8iAg3d"])), (0, i.jsxs)(i.Fragment, {
    children: [(0, i.jsx)(o.vwX, {
      tag: "h1",
      children: j.title
    }), (0, i.jsx)(o.R94, {
      children: j.subtitle
    }), null != l && t ? g ? (0, i.jsx)(P.Z, {
      canSync: !1,
      icon: o.DuK,
