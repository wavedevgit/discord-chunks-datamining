...
let _ = e => {
  let {
    ...
    reportId: _,
    reportType: b
  } = e, h = (0, i.e7)([m.Z], () => m.Z.isBlocked(t.id), [t.id]), f = (0, i.e7)([u.Z], () => u.Z.getChannel(n), [n]), v = l.useMemo(() => p.ZP.getName(null == f ? void 0 : f.guild_id, null == f ? void 0 : f.id, t), [f, t]), j = l.useCallback(() => {
