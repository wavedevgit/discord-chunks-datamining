...
function o(e) {
  let [t, n] = r.useState([e]), [i, l] = r.useState(0), a = r.useMemo(() => t[i], [t, i]), o = r.useCallback(e => {
    let r = e(a);
    if (s()(a, r)) return;
    let o = t.slice(0, i + 1);
...
function c(e, t) {
  ...
  let p = r.useCallback(e => {
    ...
    C = r.useCallback(e => {
      ...
      0 === c.length || n && r === a || ((0, l.flushSync)(() => {
        u(e => {
          let {
            tags: t,
            value: n
