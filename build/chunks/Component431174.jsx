...
function x(e) {
  let {
    ...
    channelId: c,
    messageId: u
  } = (0, A.Tu)(), [_, b] = i.useState(""), [y, x] = i.useState(false), O = "" !== _ && y, E = i.useCallback(() => {
    b((0, h.$m)(u, c, a))
...
function j(e) {
  ...
  } = e, c = true === t.isSelected, u = true === t.didSelfVote, d = true === t.isVictor, m = t.shouldAnimateTransition;
  return (0, r.jsxs)("div", {
    className: a()(v.Fk, {
      [v.EK]: i !== _.CQ.LIST,
      [v.wH]: c
