...
function j() {
  let {
    type: e
  } = (0, o.UO)(), s = (0, g.vJ)(e), n = (0, u.l)().get("error-code"), r = l.useCallback(() => {
    window.close()
  }, []), j = l.useMemo(() => {
    switch (s) {
      case m.ABu.AMAZON_MUSIC:
        return (0, t.jsx)("div", {
          ...
          children: i.tq ? h.intl.format(h.t["0EikXl"], {
            link: () => (0, t.jsx)(d.eee, {
              href: p,
              children: p
            })
      ...
      case m.ABu.YOUTUBE:
        if (n === m.evJ.UNKNOWN_ACCOUNT.toString()) return (0, t.jsx)("div", {
          className: a()(v.message, v.details),
  ...
  return (0, t.jsxs)(g.UV, {
    ...
    children: [(0, t.jsx)("div", {
      ...
      children: h.intl.format(h.t.E62dXl, {
        name: b.name
      })
    }), (0, t.jsx)("div", {
      className: a()(v.message, v.details),
    ...
    }) : null, null != n ? (0, t.jsx)("div", {
      className: a()(v.message, v.errorDetails),
      children: h.intl.format(h.t.LElyIC, {
        errorCode: n
      })
    }) : null]
  })
