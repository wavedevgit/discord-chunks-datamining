...
function p() {
  let {
    type: e
  } = (0, o.UO)(), s = (0, f.vJ)(e), n = (0, d.l)().get("error-code"), l = t.useCallback(() => {
    window.close()
  }, []), p = t.useMemo(() => {
    switch (s) {
      ...
      case g.ABu.YOUTUBE:
        if (n === g.evJ.UNKNOWN_ACCOUNT.toString()) return (0, r.jsx)("div", {
          className: a()(h.message, h.details),
  ...
  return (0, r.jsxs)(f.UV, {
    ...
    }) : null, null != n ? (0, r.jsx)("div", {
      className: a()(h.message, h.errorDetails),
      children: m.NW.format(m.t.LElyIC, {
        errorCode: n
      })
    }) : null]
  })
