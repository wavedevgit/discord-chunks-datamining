...
function x() {
  let {
    type: e
  } = (0, o.UO)(), s = (0, f.vJ)(e), n = (0, d.l)().get("error-code"), r = l.useCallback(() => {
    window.close()
  }, []), x = l.useMemo(() => {
    switch (s) {
      case g.ABu.AMAZON_MUSIC:
        return (0, t.jsx)("div", {
          ...
          children: i.tq ? m.intl.format(m.t["0EikXl"], {
            link: () => (0, t.jsx)(c.eee, {
              href: v,
              children: v
            })
  ...
  return (0, t.jsxs)(f.UV, {
    ...
    children: [(0, t.jsx)("div", {
      ...
      children: m.intl.format(m.t.E62dXl, {
        name: j.name
      })
    }), (0, t.jsx)("div", {
      className: a()(h.message, h.details),
      ...
      children: m.intl.format(m.t.LElyIC, {
        errorCode: n
      })
    }) : null]
  })
