    ...
    if (this.font.truncate === s.GX.None && _(e, t), this.font.truncate === s.GX.Truncate && _(e = f(e), t), this.font.truncate === s.GX.Wrap) {
      ...
      for (null != t.h && (r = t.h / d, i()(r > 0, "DiscordCavas: boundingBox.h of ".concat(t.h, " results in 0 visible lines with font size of ").concat(d))); n.length > 0;)
        if ((c = this.context.measureText(o + " " + n[0])).width > l) {
          let e = !1;
          if (s + 1 >= r && n.length > 0 && (e = !0), "" !== o ? (_(e ? f(o + "...") : o, {
              x: t.x,
              y: t.y + d * s
            }), o = "") : _(f(null != (a = n.shift()) ? a : ""), {
              x: t.x,
              y: t.y + d * s
            }), e) break;
          s += 1
        } else o += " ".concat(n.shift()), 0 === n.length && _(o, {
          x: t.x,
          y: t.y + d * s
        })
    }
    ...
    if (null != n) {
      ...
      if (a === s.JU.Cover) {
        ...
        if (h > p) {
          ...
          i = d(c({}, {
            x: 0,
            y: (a.h - e) * (null != (u = null == r || null == (l = r.focus) ? void 0 : l.y) ? u : .5)
          }), {
            w: o.width,
            h: e
          })
          ...
          let e = a.h * h;
          i = d(c({}, {
            x: (o.width - e) * (null != (f = null == r || null == (_ = r.focus) ? void 0 : _.x) ? f : .5),
            y: 0
          }), {
            w: e,
            h: o.height
