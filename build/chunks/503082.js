...
class d {
  ...
  getImage(t, e, i) {
    ...
    return this.imageMap.set(t, c(l({}, r), {
      [n]: o
    ...
    if (null != i) {
      ...
      if (a === o.JU.Cover) {
        ...
        if (g > x) {
          ...
          n = c(l({}, {
            x: 0,
            y: (a.h - t) * (null != (u = null == s || null == (h = s.focus) ? void 0 : h.y) ? u : .5)
          }), {
            w: r.width,
            h: t
          })
          ...
          let t = a.h * g;
          n = c(l({}, {
            x: (r.width - t) * (null != (f = null == s || null == (d = s.focus) ? void 0 : d.x) ? f : .5),
            y: 0
          }), {
            w: t,
            h: r.height
