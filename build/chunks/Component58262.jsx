...
function y(e) {
  ...
  } = e, A = (0, s.bG)([p.default], () => p.default.getId()), v = (null == (t = n.inviter) ? true : t.id) === A, S = n.state === g.elq.ACCEPTING, {
  ...
  let R = T ? C : N,
    ...
    P = "active";
  T ? (w = E.intl.string(E.t.xhxnPn), P = "secondary") : v && (w = E.intl.string(E.t.ib7Ng1), P = "secondary");
