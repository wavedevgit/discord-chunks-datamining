...
function M(e) {
  ...
  } = (0, f.ZP)(d.Z.GIFT_BUTTON), [a, u] = i.useState(!1), y = (0, s.e7)([E.Z], () => !(null === E.Z || void 0 === E.Z ? void 0 : E.Z.hasLayers())), P = (0, s.e7)([b.default], () => b.default.getCurrentUser()), w = null != P ? v.default.age(P.id) : 0, M = !t && y && w >= L, {
    enabled: k
  } = m.O.useExperiment({
