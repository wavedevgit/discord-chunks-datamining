...
function S(e) {
  ...
  } = e, f = (0, a.e7)([o.Z], () => o.Z.useReducedMotion), _ = (0, a.e7)([p.default], () => p.default.getCurrentUser()), j = r.useMemo(() => null != n.cooldownEndsAt ? new Date(n.cooldownEndsAt) : null, [n]), C = r.useMemo(() => null != j && j > new Date, [j]), S = (0, g.tl)(n), T = (0, c.Z)(), I = r.useRef(null);
  return (0, i.jsxs)("div", {
