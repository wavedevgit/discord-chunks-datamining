...
function v(e) {
  ...
  } = e, f = (0, l.e7)([o.Z], () => o.Z.useReducedMotion), x = (0, l.e7)([p.default], () => p.default.getCurrentUser()), E = r.useMemo(() => null != n.cooldownEndsAt ? new Date(n.cooldownEndsAt) : null, [n]), j = r.useMemo(() => null != E && E > new Date, [E]), v = (0, g.tl)(n), T = (0, c.Z)();
  return (0, i.jsxs)("div", {
