...
function v(e) {
  let {
    ...
    if (o) {
      ...
      return c.isPausedForFractionalPremium && (e = d.endsAt.toDate()), O.intl.format(O.t.Z4ULRE, {
        date: e
      })
    }
  ...
  return o || t === j.Eu4.NONE ? (0, i.jsx)("div", {
...
function S(e) {
  ...
  } = e, f = (0, a.e7)([o.Z], () => o.Z.useReducedMotion), _ = (0, a.e7)([p.default], () => p.default.getCurrentUser()), j = r.useMemo(() => null != n.cooldownEndsAt ? new Date(n.cooldownEndsAt) : null, [n]), C = r.useMemo(() => null != j && j > new Date, [j]), S = (0, g.tl)(n), T = (0, c.Z)(), N = r.useRef(null);
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsxs)("div", {
      ...
      children: [(0, i.jsx)(x.Z, {
        ...
        children: null != j && C && !S ? (0, i.jsx)(b.Z, {
          className: E.boostDescriptionInnerContainer,
          cooldown: j.getTime()
        }) : (0, i.jsx)(v, {
          guildTier: t,
      ...
      className: E.boostContainerSeparator
    })]
  })
}
...
function N(e) {
  let {
    ...
    premiumSubscription: r
  } = e, s = (0, a.e7)([m.Z], () => m.Z.getGuild(t), [t]), l = f.default.fromTimestamp(Date.now());
  if (n.forEach(e => {
...
function y(e) {
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("div", {
      className: E.container,
      children: f.default.keys(l).map(e => (0, i.jsx)(T, {
        guildId: e,
