...
function S(e) {
  ...
  return o || t === E.Eu4.NONE ? (0, i.jsx)("div", {
...
function v(e) {
  ...
  } = e, f = (0, l.e7)([o.Z], () => o.Z.useReducedMotion), x = (0, l.e7)([m.default], () => m.default.getCurrentUser()), E = r.useMemo(() => null != n.cooldownEndsAt ? new Date(n.cooldownEndsAt) : null, [n]), C = r.useMemo(() => null != E && E > new Date, [E]), v = (0, p.tl)(n), T = (0, c.Z)(), N = r.useRef(null);
  return (0, i.jsxs)("div", {
...
function y(e) {
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("div", {
      className: O.container,
      children: f.default.keys(a).map(e => (0, i.jsx)(T, {
        guildId: e,
