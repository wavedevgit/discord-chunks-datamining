...
let p = e => {
  ...
  let {
    ...
    scale: 1
  }), [O, v] = (0, i.useState)(1), S = (0, a.q_F)(null != l ? {
    from: {
    ...
    blur: 0
  }), I = (0, i.useMemo)(() => Math.round((750 + (200 * Math.random() - 100)) * _), [_]), T = 5, [C, A] = (0, i.useState)(0), [N, P] = (0, i.useState)(1), R = (0, a.q_F)({
    xOffset: C,
    config: {
      tension: 10,
      friction: 10,
