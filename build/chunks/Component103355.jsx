...
function f(e) {
  ...
  let B = r.useMemo(() => n === x.XG.CANCELED || (null == S ? true : S.is_canceled) ? 5 : n === x.XG.ACTIVE ? 3 : x.lV.has(n) ? 4 : _ ? 2 : +!!k, [n, null == S ? true : S.is_canceled, _, k]),
    ...
    }(B, L, f, w, D),
    {
      ...
      switch (n) {
        case 3:
          o = r, u = null != s ? true : "text-feedback-positive";
          break;
        case 4:
          c = d.O4;
          break;
