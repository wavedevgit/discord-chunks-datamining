...
function d(e) {
  ...
  }, [E]), [v, O] = r.useReducer(C, {
    focusedIndex: d,
    itemCount: n
  }), {
    itemCount: x,
    focusedIndex: y
  } = v, [I] = r.useState(() => (0, a.P2)(O, 16));
  return r.useEffect(() => {
      O({
    ...
    function(e) {
      let {
        ...
        makeId: C = a.qR,
        getIndexFromId: v
      } = e, O = r.useRef(n), x = r.useRef(v);
      x.current = v, O.current = n;
      let y = r.useRef(E);
      r.useEffect(() => {
        y.current = E
      }, [E]);
      let [I, j] = r.useState(!1), [S] = r.useState(() => new a.$o(e => () => {
        let t = null != x.current && "string" == typeof e ? x.current(e) : e;
      ...
      r.useLayoutEffect(() => {
        let e = L.current;
        if (null != e) return e.addEventListener("focusin", Z), e.addEventListener("focus", R), e.addEventListener("focusout", D), () => {
      ...
      let M = r.useCallback(() => ({
        ...
        k = r.useCallback(e => {
          ...
          return {
            role: "listitem",
            "aria-setsize": h ? O.current : void 0,
            "aria-posinset": h ? n + 1 : void 0,
            id: C(t, n),
            tabIndex: _ && n === d ? 0 : -1,
            onFocus: S.get(null != x.current ? C(t, n) : n)
          }
        }, [C, t, d, _, S, h]);
      return r.useMemo(() => ({
        dispatch: g,
