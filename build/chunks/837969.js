...
function _(e) {
  let {
    ...
    makeId: v = o.qR,
    getIndexFromId: I
  } = e, T = r.useRef(n), S = r.useRef(I);
  S.current = I, T.current = n;
  let A = r.useRef(O);
  r.useEffect(() => {
    A.current = O
  }, [O]);
  let [N, C] = r.useState(!1), [w] = r.useState(() => new o.$o(e => () => {
  ...
  r.useLayoutEffect(() => {
    let e = U.current;
    if (null != e) return e.addEventListener("focusin", k), e.addEventListener("focus", j), e.addEventListener("focusout", M), () => {
...
function p(e) {
  let {
    ...
    enabled: p = !0,
    onDispatch: h
  } = e, m = r.useCallback((e, t) => {
    let n = (0, i.Z)(e, t);
    return null != h && h(e, n, t), n
  }, [h]), [g, E] = r.useReducer(m, {
    focusedIndex: a,
    itemCount: n
  }), {
    itemCount: b,
    focusedIndex: y
  } = g, [O] = r.useState(() => (0, o.P2)(E, 16));
  return r.useEffect(() => {
    E({
