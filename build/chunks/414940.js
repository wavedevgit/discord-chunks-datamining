  ...
  e.deleteBackward = n => {
    ...
    if (null != e.selection) {
      ...
      r.o.withSingleEntry(e, () => {
        (null == c ? true : c[0].type) === "blockQuote" && a.Kh.isAtStart(s, c) && i.b.setNodes(e, {
          type: "line"
        }, {
          at: l
        }), (null == d ? true : d[0].type) === "blockQuote" && a.Kh.isAtEnd(o, d) && i.b.setNodes(e, {
          type: "line"
        }, {
          at: u
        }), n(t)
...
function c(e) {
  ...
  for (let l of a.VW.blocks(e)) {
    ...
    if ((null != _ || null != p || t) && (i.b.setNodes(e, {
      ...
      var n, r;
      let s = null != (n = null != (r = null == _ ? true : _[0].length) ? r : null == p ? true : p[0].length) ? n : 0,
        o = a.PW.child(u, 0);
      i.b.delete(e, {
        at: {
          anchor: {
