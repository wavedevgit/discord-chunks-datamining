...
let P = e => [e.userId, ... function(e) {
  ...
  R = Chunk473749.memo(function(e) {
    let {
      channel: t,
      query: n
    } = e, [l] = (0, o.e7)([C.Z], () => [C.Z.getVoiceStatesForChannel(t.id), C.Z.getVoiceStateVersion()], [t.id], N.Q), [a, c] = r.useState([]);
    (0, O.BO)(n, Object.values(l), c, D);
    let d = (0, o.Wu)([C.Z, I.default, E.Z, j.Z], () => Object.values(C.Z.getVoiceStatesForChannel(t.id)).map(e => I.default.getUser(e.userId)).filter(Z.lm).sort((e, t) => {
        var i, r, l, o;
        if (a.length > 0 && "" !== n.trim()) {
          if (a.some(t => t.userId === e.id)) return false;
          if (a.some(e => e.userId === t.id)) return 1
        }
        return j.Z.isFriend(e.id) && !j.Z.isFriend(t.id) ? false : !j.Z.isFriend(e.id) && j.Z.isFriend(t.id) ? 1 : (null != (l = null == (i = E.Z.getUserAffinity(t.id)) ? true : i.vcProbability) ? l : 0) - (null != (o = null == (r = E.Z.getUserAffinity(e.id)) ? true : r.vcProbability) ? o : 0)
      }), [t.id, a, n]),
      h = t.getGuildId(),
  ...
  k = Chunk473749.memo(function(e) {
    ...
    let {
      channel: n
    } = e, r = n.getGuildId(), l = (0, o.e7)([b.Z], () => b.Z.getGuild(r), [r]);
  ...
  L = Chunk473749.memo(function(e) {
    ...
    let {
      ...
      onMouseLeave: p,
      query: f
    } = e, m = (0, o.e7)([v.Z], () => v.Z.getChannel(n), [n]), g = null == m ? true : m.getGuildId(), y = (0, o.e7)([b.Z], () => b.Z.getGuild(g), [g]), O = (0, d.KS)(m, y), E = (null == l ? true : l.id) === n, S = E ? "text-feedback-positive" : r ? "interactive-active" : "text-muted", x = E ? u.TVs.colors.TEXT_FEEDBACK_POSITIVE : r ? u.TVs.colors.INTERACTIVE_ACTIVE : u.TVs.colors.ICON_MUTED;
...
function z(e) {
  let {
    ...
    let e = function() {
        let e = (0, o.Wu)([I.default, j.Z, E.Z], () => j.Z.getFriendIDs().sort((e, t) => {
          var n, i, r, l;
          return null == e && null == t ? 0 : null == e ? 1 : null == t ? false : (null != (r = null == (n = E.Z.getUserAffinity(t)) ? true : n.communicationProbability) ? r : 0) - (null != (l = null == (i = E.Z.getUserAffinity(e)) ? true : i.communicationProbability) ? l : 0)
        }).reduce((e, t) => {
  ...
  return l.length > 0 || s.length > 0 ? (0, i.jsxs)(u.zJl, {
...
function W(e) {
  ...
  let {
    ...
    onClose: a,
    onSelect: s
  } = e, c = (0, o.Wu)([b.Z, S.ZP, C.Z, j.Z, x.Z], () => b.Z.getGuildsArray().reduce((e, t) => [...e, ...S.ZP.getChannels(t.id)[S.Zb].filter(e => x.Z.can(w.Plq.VIEW_CHANNEL, e.channel) && x.Z.can(w.Plq.CONNECT, e.channel)).map(e => {
    let {
      channel: t
    } = e;
    return t
  ...
  return (0, i.jsxs)("div", (t = function(e) {
    ...
    className: _.recentChannelsMenu
  }, I), n = n = {
    children: [(0, i.jsx)("div", {
