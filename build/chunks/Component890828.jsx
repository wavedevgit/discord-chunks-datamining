...
let P = e => [e.userId, ... function(e) {
  ...
  D = Chunk473749.memo(function(e) {
    let {
      channel: t,
      query: n
    } = e, [l] = (0, a.e7)([j.Z], () => [j.Z.getVoiceStatesForChannel(t.id), j.Z.getVoiceStateVersion()], [t.id], Z.Q), [o, u] = r.useState([]);
    (0, O.BO)(n, Object.values(l), u, k);
    let d = (0, a.Wu)([j.Z, I.default, v.Z, x.Z], () => Object.values(j.Z.getVoiceStatesForChannel(t.id)).map(e => I.default.getUser(e.userId)).filter(C.lm).sort((e, t) => {
        var i, r, l, a;
...
function V(e) {
  let {
    ...
    let e = function() {
        ...
        return (0, a.Wu)([j.Z, E.Z, S.Z], () => Array.from(e.map(e => j.Z.getDiscoverableVoiceStateForUser(e.id)).reduce((e, t) => {
...
function W(e) {
  ...
  let {
    ...
    onClose: o,
    onSelect: s
  } = e, u = (0, a.Wu)([_.Z, b.ZP, j.Z, x.Z, S.Z], () => _.Z.getGuildsArray().reduce((e, t) => [...e, ...b.ZP.getChannels(t.id)[b.Zb].filter(e => S.Z.can(N.Plq.VIEW_CHANNEL, e.channel) && S.Z.can(N.Plq.CONNECT, e.channel)).map(e => {
    let {
      channel: t
    } = e;
    return t
