...
let P = e => [e.userId, ... function(e) {
  ...
  L = Chunk473749.memo(function(e) {
    ...
    let {
      ...
      onMouseLeave: p,
      query: f
    } = e, m = (0, a.e7)([v.Z], () => v.Z.getChannel(n), [n]), g = null == m ? true : m.getGuildId(), O = (0, a.e7)([S.Z], () => S.Z.getGuild(g), [g]), y = (0, d.KS)(m, O), E = (null == l ? true : l.id) === n, b = E ? "text-feedback-positive" : r ? "interactive-active" : "text-muted", x = E ? u.TVs.colors.TEXT_FEEDBACK_POSITIVE : r ? u.TVs.colors.INTERACTIVE_ACTIVE : u.TVs.colors.ICON_MUTED;
