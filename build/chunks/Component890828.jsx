...
function W(e) {
  ...
  let {
    ...
    onClose: l,
    onSelect: c
  } = e, u = (0, a.Wu)([_.Z, E.ZP, j.Z, I.Z, S.Z], () => _.Z.getGuildsArray().reduce((e, t) => [...e, ...E.ZP.getChannels(t.id)[E.Zb].filter(e => S.Z.can(w.Plq.VIEW_CHANNEL, e.channel) && S.Z.can(w.Plq.CONNECT, e.channel)).map(e => {
    let {
      channel: t
    } = e;
    return t
