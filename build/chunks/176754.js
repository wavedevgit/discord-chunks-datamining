...
let h = e => {
  ...
  let {
    ...
    y: 0
  }), f = (null == d ? void 0 : d.path) === "sine" ? Math.sin : Math.cos, [b, x] = (0, a.useState)(1), _ = (0, o.q_F)(null != r ? {
    from: {
    ...
    scale: 1
  }), [j, O] = (0, a.useState)(1), C = (0, o.q_F)(null != i ? {
    from: {
    ...
    blur: 0
  }), E = (0, a.useMemo)(() => Math.round(750 + (200 * Math.random() - 100)), []), [v, S] = (0, a.useState)(0), [T, N] = (0, a.useState)(1), I = (0, o.q_F)({
    xOffset: v,
    config: {
      tension: 10,
      friction: 10,
