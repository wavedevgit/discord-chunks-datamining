...
let y = 24,
  O = e => {
    let {
      ...
      level: f = 1,
      ref: p
    } = e, h = <c.y5t forceLevel={f}><c.X6q variant={"text-md/medium"} color={d ? "header-secondary" : true} className={a()(t, _.title, {
          [_.titleClickable]: null != s
        })} id={u}>{i}</c.X6q></c.y5t>;
    return null != s ? <c.P3F innerRef={p} onClick={s} onContextMenu={o} onKeyDown={l} className={a()(n, _.titleWrapper)}>{h}</c.P3F> : <div ref={p} className={a()(n, _.titleWrapper)} onContextMenu={o} onKeyDown={l}>{h}</div>
  },
  v = Chunk73800.forwardRef(function(e, t) {
    ...
    return null == G && "string" == typeof I && (G = I), <c.ua7 text={I} color={T} position={S} align={A} hideOnClick={R} shouldShow={!N} spacing={C}>{e => {
        let {
          onMouseEnter: g,
          onMouseLeave: y,
          onFocus: I,
  ...
  T = e => {
    ...
    return <f.Z className={a()(_.dot, t)} />
  };
...
function S(e) {
  ...
  return "right" === t ? <c.Fbu size={"md"} color={"currentColor"} className={a()(_.caret, n)} /> : <c.V7D size={"md"} color={"currentColor"} className={a()(_.caret, n)} />
}
let A = e => {
  let {
    className: t,
  ...
  return <section className={a()(t, _.container, {
      [_.themed]: !y,
      [_.transparent]: y,
      [_.themedMobile]: l.tq,
      [_.showToolbar]: O
    })} aria-label={m} aria-labelledby={g} role={E} ref={v}><c.JcV containerRef={v}>{<div className={a()(_.upperContainer, {
          [_.showToolbar]: O
        })}>{<div className={a()(_.children, n, {
            [_.scrollable]: b,
            [_.showToolbar]: O
          })} onDoubleClick={h}>{l.tq && null != I ? <s.r onClick={I} className={_.hamburger} /> : null}{d}</div>}{null != p ? <div className={a()(_.toolbar, o, {
            [_.showToolbar]: O
          })}>{p}</div> : null}</div>}{f}</c.JcV></section>
};
