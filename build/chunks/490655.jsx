...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk919196 = require("./919196.js"),
  Chunk731072 = require("./731072.js"),
  Chunk494118 = require("./494118.js"),
  Chunk37607 = require("./37607.jsx"),
  Chunk351644 = require("./351644.jsx"),
  Chunk108053 = require("./108053.jsx"),
  Chunk981631 = require("./981631.js"),
  Chunk388032 = require("./388032.jsx"),
  Chunk498181 = require("./498181.js");
...
let Z = Chunk73800.memo(function(e) {
  ...
  switch (t) {
    case N.b4C.TWITCH:
      null != X[N.ABu.TWITCH] && (Q = <v.Z guild={l} integrations={X[N.ABu.TWITCH]} editedIntegration={P} labelText={S.intl.string(S.t.q4pBGx)} platformType={N.ABu.TWITCH} descriptionText={S.intl.string(S.t.V9kNqq)} helpText={S.intl.format(S.t.ro1jEB, {
          connectAction: () => (0, u.Z)({
      ...
      break;
    case N.b4C.YOUTUBE:
      null != X[N.ABu.YOUTUBE] && (Q = <v.Z guild={l} integrations={X[N.ABu.YOUTUBE]} editedIntegration={P} labelText={S.intl.string(S.t.aS6cKy)} platformType={N.ABu.YOUTUBE} descriptionText={S.intl.string(S.t["7Tv7JC"])} helpText={S.intl.format(S.t["4OSAQ0"], {
          connectAction: () => (0, u.Z)({
    ...
    case N.b4C.APPLICATION:
      ...
      null != et && (Q = <j.Z guild={l} applicationIntegration={et} editedWebhook={k} selectableWebhookChannels={U} errors={D} canNavigate={V} />);
      break;
    case N.b4C.CHANNEL_FOLLOWING:
      Q = <O.Z followedChannelWebhooks={J} editedWebhook={k} selectableWebhookChannels={U} canNavigate={V} errors={D} />;
      break;
    case N.b4C.WEBHOOKS:
      Q = <C.Z guild={l} channel={Z} customWebhooks={$} editedWebhook={k} selectableWebhookChannels={function(e) {
          ...
          return e
        }({}, U, W)} canNavigate={V} refToScroller={R} errors={D} />;
      break;
    case N.b4C.LOBBIES_LINKED:
      Q = <y.Z guild={l} />;
      break;
    default:
      Q = <_.Z guild={l} channel={Z} applicationIntegrations={q} builtInIntegrations={X} customWebhooks={$} followedChannelWebhooks={J} isLoadingWebhooks={A || null == l} canCreateWebhook={null != H} onManageCustomWebhooks={() => {
  ...
  return <i.Fragment>{<p.Z align={p.Z.Align.CENTER} className={I.breadcrumbs}>{t === N.b4C.OVERVIEW ? (0, i.jsx)(s.vwX, {
        tag: "h1",
