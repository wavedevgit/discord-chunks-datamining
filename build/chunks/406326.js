...
function m(e) {
  ...
  return (0, r.jsxs)("header", {
    ...
    children: [(0, r.jsx)(g, f({}, e)), (0, r.jsxs)(a.njP, {
...
function g(e) {
  ...
  return (0, r.jsxs)("div", {
    ...
    role: "status",
    children: [o ? (0, r.jsx)(a.ua7, {
      text: p.intl.formatToPlainString(p.t["4Y3O+P"], {
        count: l
      }),
      children: n => {
        var i, l;
        return (0, r.jsxs)("div", (i = f({
          className: h.totalResultsWrapper
        }, n), l = l = {
...
function b(e) {
  ...
  if (t) return (0, r.jsx)(a.Text, {
    variant: "text-md/medium",
    color: "header-secondary",
    children: p.intl.string(p.t.uixzLS)
  });
  {
    if (n) return (0, r.jsx)(a.Text, {
      variant: "text-md/medium",
      color: "text-muted",
    ...
    if (l === d.aib.DMS && s) return (0, r.jsx)(_, {
      totalResults: i,
      searchId: l
    });
...
function _(e) {
  let {
    totalResults: t,
    searchId: n
  } = e, o = t.toLocaleString(), c = (0, l.e7)([s.Z], () => s.Z.getSearchResultsQueryString(n)), f = i.useMemo(() => (0, u.j2)(null != c ? c : "", d.dCx.FILTER_IN), [c]);
  return (0, r.jsxs)("div", {
