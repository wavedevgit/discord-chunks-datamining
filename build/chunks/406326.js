...
function g(e) {
  ...
  return (0, n.jsxs)("header", {
    ...
    children: [(0, n.jsx)(m, f({}, e)), (0, n.jsxs)(a.njP, {
      orientation: "horizontal",
      className: p.searchHeaderTabList,
      selectedItem: t,
      onItemSelect: r,
      children: [(0, n.jsx)(a.njP.Item, {
        id: d.QIO.NEWEST,
...
function m(e) {
  ...
  return (0, n.jsxs)("div", {
    ...
    role: "status",
    children: [o ? (0, n.jsx)(a.ua7, {
      text: h.intl.formatToPlainString(h.t["4Y3O+P"], {
        count: l
      }),
      children: r => {
        var s, l;
        return (0, n.jsxs)("div", (s = f({
          className: p.totalResultsWrapper
        }, r), l = l = {
...
function b(e) {
  let {
    ...
    location: "TotalResultsText"
  });
  if (t) return (0, n.jsx)(a.Text, {
    variant: "text-md/medium",
    color: "header-secondary",
    children: h.intl.string(h.t.uixzLS)
  });
  {
    if (r) return (0, n.jsx)(a.Text, {
      variant: "text-md/medium",
      color: "text-muted",
    ...
    if (l === d.aib.DMS && i) return (0, n.jsx)(y, {
      totalResults: s,
      searchId: l
    });
    ...
    return (0, n.jsx)(a.Text, {
      ...
      children: h.intl.format(h.t.ZGVL3t, {
        count: e
      })
    })
  }
...
function y(e) {
  let {
    totalResults: t,
    searchId: r
  } = e, o = t.toLocaleString(), c = (0, l.e7)([i.Z], () => i.Z.getSearchResultsQueryString(r)), f = s.useMemo(() => (0, u.j2)(null != c ? c : "", d.dCx.FILTER_IN), [c]);
  return (0, n.jsxs)("div", {
