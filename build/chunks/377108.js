/** Chunk was on web.js **/
/** chunk id: 377108, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  EO: () => l,
  JM: () => _,
...
class c extends Chunk495852.C {
    ...
    for (; e.pos < a;) {
      ...
      switch (t) {
        ...
        case 5:
          ...
          break;
        case 6:
          o.emojiFrecency = v.internalBinaryRead(e, e.uint32(), n, o.emojiFrecency);
          break;
        case 7:
          o.applicationCommandFrecency = I.internalBinaryRead(e, e.uint32(), n, o.applicationCommandFrecency);
          break;
        case 8:
          o.favoriteSoundboardSounds = N.internalBinaryRead(e, e.uint32(), n, o.favoriteSoundboardSounds);
          break;
        case 9:
          o.applicationFrecency = L.internalBinaryRead(e, e.uint32(), n, o.applicationFrecency);
          break;
        case 10:
          o.heardSoundFrecency = R.internalBinaryRead(e, e.uint32(), n, o.heardSoundFrecency);
          break;
        case 11:
          o.playedSoundFrecency = D.internalBinaryRead(e, e.uint32(), n, o.playedSoundFrecency);
          break;
        case 12:
          o.guildAndChannelFrecency = M.internalBinaryRead(e, e.uint32(), n, o.guildAndChannelFrecency);
          break;
        case 13:
  ...
  internalBinaryWrite(e, t, n) {
    e.versions && s.L.internalBinaryWrite(e.versions, t.tag(1, r.TD.LengthDelimited).fork(), n).join(), e.favoriteGifs && f.internalBinaryWrite(e.favoriteGifs, t.tag(2, r.TD.LengthDelimited).fork(), n).join(), e.favoriteStickers && h.internalBinaryWrite(e.favoriteStickers, t.tag(3, r.TD.LengthDelimited).fork(), n).join(), e.stickerFrecency && E.internalBinaryWrite(e.stickerFrecency, t.tag(4, r.TD.LengthDelimited).fork(), n).join(), e.favoriteEmojis && y.internalBinaryWrite(e.favoriteEmojis, t.tag(5, r.TD.LengthDelimited).fork(), n).join(), e.emojiFrecency && v.internalBinaryWrite(e.emojiFrecency, t.tag(6, r.TD.LengthDelimited).fork(), n).join(), e.applicationCommandFrecency && I.internalBinaryWrite(e.applicationCommandFrecency, t.tag(7, r.TD.LengthDelimited).fork(), n).join(), e.favoriteSoundboardSounds && N.internalBinaryWrite(e.favoriteSoundboardSounds, t.tag(8, r.TD.LengthDelimited).fork(), n).join(), e.applicationFrecency && L.internalBinaryWrite(e.applicationFrecency, t.tag(9, r.TD.LengthDelimited).fork(), n).join(), e.heardSoundFrecency && R.internalBinaryWrite(e.heardSoundFrecency, t.tag(10, r.TD.LengthDelimited).fork(), n).join(), e.playedSoundFrecency && D.internalBinaryWrite(e.playedSoundFrecency, t.tag(11, r.TD.LengthDelimited).fork(), n).join(), e.guildAndChannelFrecency && M.internalBinaryWrite(e.guildAndChannelFrecency, t.tag(12, r.TD.LengthDelimited).fork(), n).join(), e.emojiReactionFrecency && v.internalBinaryWrite(e.emojiReactionFrecency, t.tag(13, r.TD.LengthDelimited).fork(), n).join();
...
class d extends Chunk495852.C {
  ...
  internalBinaryWrite(e, t, n) {
    ...
    false !== e.hideTooltip && t.tag(2, r.TD.Varint).bool(e.hideTooltip);
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
class g extends Chunk495852.C {
  ...
  binaryReadMap1(e, t, n) {
    ...
    e[null != o ? o : "0"] = null != a ? a : C.create()
  }
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.stickers)) t.tag(1, r.TD.LengthDelimited).fork().tag(1, r.TD.Bit64).fixed64(i), t.tag(2, r.TD.LengthDelimited).fork(), C.internalBinaryWrite(e.stickers[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
class O extends Chunk495852.C {
  ...
  binaryReadMap1(e, t, n) {
    ...
    e[null != o ? o : ""] = null != a ? a : C.create()
  }
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.emojis)) t.tag(1, r.TD.LengthDelimited).fork().tag(1, r.TD.LengthDelimited).string(i), t.tag(2, r.TD.LengthDelimited).fork(), C.internalBinaryWrite(e.emojis[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
class S extends Chunk495852.C {
  ...
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.applicationCommands)) t.tag(1, r.TD.LengthDelimited).fork().tag(1, r.TD.LengthDelimited).string(i), t.tag(2, r.TD.LengthDelimited).fork(), C.internalBinaryWrite(e.applicationCommands[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
class P extends Chunk495852.C {
  ...
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.heardSounds)) t.tag(1, r.TD.LengthDelimited).fork().tag(1, r.TD.LengthDelimited).string(i), t.tag(2, r.TD.LengthDelimited).fork(), C.internalBinaryWrite(e.heardSounds[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
class w extends Chunk495852.C {
  ...
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.playedSounds)) t.tag(1, r.TD.LengthDelimited).fork().tag(1, r.TD.LengthDelimited).string(i), t.tag(2, r.TD.LengthDelimited).fork(), C.internalBinaryWrite(e.playedSounds[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
class x extends Chunk495852.C {
  ...
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.applications)) t.tag(1, r.TD.LengthDelimited).fork().tag(1, r.TD.LengthDelimited).string(i), t.tag(2, r.TD.LengthDelimited).fork(), C.internalBinaryWrite(e.applications[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
class j extends Chunk495852.C {
  ...
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.guildAndChannels)) t.tag(1, r.TD.LengthDelimited).fork().tag(1, r.TD.Bit64).fixed64(i), t.tag(2, r.TD.LengthDelimited).fork(), C.internalBinaryWrite(e.guildAndChannels[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
