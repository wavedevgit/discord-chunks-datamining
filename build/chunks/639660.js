...
function h(e) {
  ...
  } = (0, _._)(t, "GuildPowerupNotificationContainer"), Z = [];
  I && Z.push(s.z.VANITY_URL_POWERUP_ROLLBACK_NOTIFICATION);
  let [O, P] = (0, l.ZT)(Z, t), T = null != O && null != N, w = (0, c.W)(t, "GuildPowerupNotificationContainer"), S = [];
  T || C || (S.push(s.z.GUILD_POWERUPS_OVERVIEW_SIDEBAR_COACHMARK), w && S.push(s.z.BOOSTER_ENHANCED_ROLE_COLORS_ADMIN_UPSELL));
  let [y, A] = (0, l.US)(S), R = (e => {
    let n = [];
    return C && n.push((0, r.jsx)(f.Z, {
      guildId: t,
      powerups: h
    }, "expiring-powerups")), T && n.push((0, r.jsx)(m.Z, {
      notificationConfig: N,
      markAsDismissed: e => {
        P(e)
      }
    }, "rollback-notification")), null != e && (e === s.z.GUILD_POWERUPS_OVERVIEW_SIDEBAR_COACHMARK ? n.push((0, r.jsx)(p.Z, {
      markAsDismissed: A
    }, "info-card")) : e === s.z.BOOSTER_ENHANCED_ROLE_COLORS_ADMIN_UPSELL && n.push((0, r.jsx)(d.Z, {
      guildId: t,
