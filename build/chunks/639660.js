...
function j(e) {
  ...
  }), j = (0, c.W)(t, "GuildPowerupNotificationContainer"), E = [];
  E.push(s.z.GUILD_POWERUPS_OVERVIEW_SIDEBAR_COACHMARK), j && E.push(s.z.BOOSTER_ENHANCED_ROLE_COLORS_ADMIN_UPSELL);
  let h = (0, u.Z)(t),
    [C, I] = (0, l.US)(E),
    N = h.length > 0 ? (0, r.jsx)(m.Z, {
      guildId: t,
      powerups: h
    }) : C === s.z.GUILD_POWERUPS_OVERVIEW_SIDEBAR_COACHMARK ? (0, r.jsx)(p.Z, {
      markAsDismissed: I
    }) : C === s.z.BOOSTER_ENHANCED_ROLE_COLORS_ADMIN_UPSELL ? (0, r.jsx)(d.Z, {
      guildId: t,
      perk: f.rm.ENHANCED_ROLE_COLORS,
      markAsDismissed: I
    }) : void 0;
  return null != N || n ? (0, r.jsxs)("div", {
