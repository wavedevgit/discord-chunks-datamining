...
function h(e) {
  ...
  }), h = (0, c.W)(n, "GuildPowerupNotificationContainer"), j = [];
  j.push(a.z.GUILD_POWERUPS_OVERVIEW_SIDEBAR_COACHMARK), h && j.push(a.z.BOOSTER_ENHANCED_ROLE_COLORS_ADMIN_UPSELL);
  let C = (0, u.Z)(n),
    [E, Z] = (0, s.US)(j),
    N = C.length > 0 ? (0, r.jsx)(p.Z, {
      guildId: n,
      powerups: C
    }) : E === a.z.GUILD_POWERUPS_OVERVIEW_SIDEBAR_COACHMARK ? (0, r.jsx)(m.Z, {
      markAsDismissed: Z
    }) : E === a.z.BOOSTER_ENHANCED_ROLE_COLORS_ADMIN_UPSELL ? (0, r.jsx)(d.Z, {
      guildId: n,
      perk: _.r.ENHANCED_ROLE_COLORS,
      markAsDismissed: Z
    }) : void 0;
  return null != N || t ? (0, r.jsxs)("div", {
