...
function en(e) {
  let {
    ...
    copyText: n,
    copyFeedbackText: i
  } = e, [l, a] = s.useState(!1), [o, c] = s.useState(!1), d = () => {
    (0, L.JG)(t, () => {
      c(!0), a(!0)
    })
  };
...
function er(e) {
  ...
  }), l = (0, j.C)(i), a = (0, g.e7)([R.Z], () => R.Z.getGuild(t)), o = (null == i ? void 0 : i.role_id) != null && (null == i ? void 0 : i.attachments_count) === 0 ? W.intl.string(W.t.H11qcX) : l, c = s.useCallback(async () => {
...
function es(e) {
  ...
  let {
    ...
    requireCurrentGuild: !1
  }), a = (0, g.e7)([C.Z], () => C.Z.getGuildProductFetchState(s) === C.M.FETCHING), o = null == l ? void 0 : l.role_id, c = (0, g.e7)([R.Z], () => null != o ? R.Z.getRole(i, o) : void 0, [i, o]), d = (null != (n = null == l || null == (t = l.attachments) ? void 0 : t.length) ? n : 0) > 0, u = null != c;
  return a ? (0, r.jsx)("div", {
    className: Y.guildProductBenefits,
    children: (0, r.jsx)(m.$jN, {})
  }) : null != l && (d || u) ? (0, r.jsxs)("div", {
    className: Y.guildProductBenefits,
...
class el extends(i = s.PureComponent) {
  ...
  renderStatus() {
    ...
    switch (e.status) {
      ...
      case F.PyE.REFUNDED:
        if (e.amountRefunded !== e.amount) return (0, r.jsx)("span", {
  ...
  renderPaymentIdField() {
    ...
    return (0, r.jsx)("li", {
      ...
      children: (0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)("div", {
          children: W.intl.string(W.t["UQim+v"])
        }), (0, r.jsx)(en, {
          value: e.id,
  ...
  renderPaymentBreakdown() {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [null != e.paymentSource ? (0, r.jsx)(G.Z, {
        paymentSource: e.paymentSource,
        locale: t,
        descriptionClassName: Y.paymentText,
        showLabels: !0,
        showPaymentSourceIcon: !0
      }) : e.paymentGateway === z.gg.APPLE_PARTNER ? (0, r.jsx)(G.Z, {
        ...
        children: [this.renderPaymentIdField(), !i && l > 0 ? (0, r.jsxs)(s.Fragment, {
          children: [(0, r.jsx)(et, {
          ...
          cost: (0, V.T4)(o, d)
        }), e.isGuildProductPurchase && null != u && null != e.sku && (0, r.jsx)(er, {
          guildId: u,
          guildProductListingId: e.sku.id
        }), c > 0 && (0, r.jsxs)(r.Fragment, {
          children: [(0, r.jsx)(et, {
  ...
  renderRefundDetails() {
    ...
    return e = i.includes("SKU_TYPE") ? W.intl.format(W.t["5lvoVV"], {
      supportURL: a
    }) : l ? n.isPremiumSubscription || n.isPremiumGuildSubscription ? W.intl.format(W.t.EPYteX, {
      dateLimit: o,
      supportURL: a
    }) : n.isGift ? W.intl.format(W.t["16eP/P"], {
      dateLimit: o,
      supportURL: a
      ...
      playtimeLimit: 2,
      supportURL: a
    }) : n.isCollectible ? W.intl.string(W.t.s9TZMz) : n.isGift ? W.intl.formatToPlainString(W.t.owlOWV, {
      dateLimit: o
    }) : n.isPremiumSubscription || n.isPremiumGuildSubscription ? W.intl.formatToPlainString(W.t.dk7vyM, {
      dateLimit: o
  ...
  renderRefundActions(e) {
    ...
    let i = e.includes("PURCHASE_DATE") ? m.Dio : m.dz2;
    return (0, r.jsxs)("div", {
      className: Y.refundActions,
      children: [(0, r.jsx)("div", {
        className: Y.refundRules,
        children: !n.isCollectible && this.renderRefundCriteria(W.intl.string(W.t.H0RNz8), i, W.intl.formatToPlainString(W.t["7dtXa2"], {
  ...
  renderDescription() {
    ...
    if (null != p && 0 !== p.items.length) {
      let n = [],
        s = null;
      if (p.type === F.NYc.PREMIUM) p.items.forEach(e => {
        let {
          planId: t,
          quantity: i
        } = e;
        ...
        if (null != d) {
          ...
          n.push(W.intl.format(e, {
            planName: d.name
          })), s = d.skuId
        }
      } else p.type === F.NYc.APPLICATION && (null != d && (s = d.skuId), null != l ? n.push(W.intl.formatToPlainString(W.t["0wL/VF"], {
        tier: null == g ? void 0 : g.name
      })) : n.push(W.intl.string(W.t["9czSYm"])));
      t = 0 !== n.length ? n.join(", ") : i.description, e = (0, r.jsx)(x.Z, {
        className: Y.descriptionIcon,
        guildClassName: Y.guildDescriptionIcon,
        game: l,
        guild: a,
        size: x.Z.Sizes.XSMALL,
        skuId: null != s ? s : null == g ? void 0 : g.id
      })
    } else if (null != g) {
      var f;
      if (t = i.isGuildProductPurchase && i.isSoftDeletedProduct ? W.intl.string(W.t.O7uLm5) : g.name, null != o) {
        let t = (0, y.Zt)(o);
        e = (0, r.jsx)(A.Z, {
          disableAnimation: !u,
          isInteracting: u,
      ...
      } else e = (null == (f = i.sku) ? void 0 : f.productLine) === F.POd.COLLECTIBLES ? (0, r.jsx)(m.EOn, {
        size: "custom",
        width: 23,
        height: 23,
        color: "currentColor",
    ...
    let b = (0, r.jsx)("div", {
      ...
      _ = i.isGift ? (0, r.jsx)(m.ua7, {
        text: W.intl.string(W.t.QddTpq),
        children: e => (0, r.jsx)(m.OgN, q({
          size: "md",
          color: "currentColor",
  ...
  render() {
    ...
    return (0, r.jsx)(d.mh, {
      id: e.id,
      children: e => (0, r.jsxs)(m.P3F, X(q({
        onClick: this.handleExpandInfo,
        className: a()(i ? Y.payment : Y.hoverablePayment, t, {
          [Y.compact]: n
        }),
        focusProps: {
          offset: 4
...
function ea(e) {
  ...
  let {
    ...
    compactMode: a,
    className: o
  } = e, c = null != i.sku && J.includes(i.sku.type), d = null != i.sku && c ? i.sku.applicationId : null, u = null == (t = i.sku) ? void 0 : t.applicationId, m = (null == (n = i.subscription) ? void 0 : n.type) === F.NYc.APPLICATION, {
  ...
  let x = (0, g.e7)([R.Z], () => R.Z.getGuild(null == h ? void 0 : h.guildId)),
    E = c ? h : void 0,
    C = i.subscription,
    j = (0, g.e7)([Z.Z], () => null != C && C.type !== F.NYc.PREMIUM ? Z.Z.get(C.items[0].planId) : null);
  return (0, r.jsx)(el, {
    applicationStatistics: p,
    application: m ? _ : E,
    guild: x,
