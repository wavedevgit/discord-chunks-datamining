...
class el extends(i = s.PureComponent) {
  ...
  renderDescription() {
    ...
    if (null != g && 0 !== g.items.length) {
      let n = [],
        s = null;
      if (g.type === F.NYc.PREMIUM) g.items.forEach(e => {
        let {
          planId: t,
          quantity: i
        } = e;
      ...
      } else g.type === F.NYc.APPLICATION && (null != d && (s = d.skuId), null != l ? n.push(W.intl.formatToPlainString(W.t["0wL/VF"], {
      ...
      } else e = (null == (f = i.sku) ? void 0 : f.productLine) === F.POd.COLLECTIBLES ? (0, r.jsx)(p.EOn, {
        size: "custom",
        width: 23,
        height: 23,
        color: "currentColor",
...
function ea(e) {
  ...
  let {
    ...
    compactMode: a,
    className: o
  } = e, c = null != i.sku && J.includes(i.sku.type), d = null != i.sku && c ? i.sku.applicationId : null, u = null == (t = i.sku) ? void 0 : t.applicationId, p = (null == (n = i.subscription) ? void 0 : n.type) === F.NYc.APPLICATION, {
