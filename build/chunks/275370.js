...
let m = e => {
  let {
    ...
    m()
  }, [m]), x = (0, d.Z)(), [y, O] = o.useState(!1), g = o.useCallback(() => {
    O(!0)
  }, []), {
    acceptLinkRequest: v,
    isAcceptLoading: _
  ...
  return i()(!x, "FamilyCenterAcceptLinkModal should only be rendered for teens."), (0, n.jsxs)(u.Z, {
    transitionState: s,
    "aria-label": h.intl.string(b.default.rlNJwc),
    className: j.root,
    children: [(0, n.jsx)(u.Z.Error, {
      error: y ? h.intl.string(b.default.pegSMz) : void 0
    }), (0, n.jsxs)(l.hzk, {
      children: [(0, n.jsx)(u.Z.Header, {
        ...
        children: [(0, n.jsx)(f.Z, {
          ...
          color: "text-default",
          children: h.intl.format(b.default.snlFqa, {
            username: a.ZP.getName(t)
          })
        })]
      })]
    }), (0, n.jsx)(l.mzw, {
