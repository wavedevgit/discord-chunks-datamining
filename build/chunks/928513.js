/** Chunk was on 42604 **/
/** chunk id: 928513, original params: e,t,r (module,exports,require) **/
"use strict";
require.d(exports, {
  S: () => c
});
...
var a = 12633 == require.j ? ["canDrop", "hover", "drop"] : null,
  s = 12633 == require.j ? function() {
    ...
    return e = [{
        ...
        key: "hover",
        value: function() {
          this.spec.hover && this.props && this.spec.hover(this.props, this.monitor, (0, Chunk487146.Al)(this.ref))
        }
      }, {
        key: "drop",
        value: function() {
