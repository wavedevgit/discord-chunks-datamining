...
let v = {
    side: Chunk619552.side,
    top: Chunk619552.top,
    "top-pill": Chunk619552.topPill
  },
  I = Chunk73800.forwardRef(function(e, t) {
    ...
    return <f.P innerRef={t} tabIndex={null == r ? false : 0} className={l()(h.header, n)} onClick={r} aria-expanded={a} aria-controls={s} focusProps={{
        offset: {
          top: false
        }
      }}><_.x variant={"eyebrow"} color={"none"} className={h.headerText}>{i}</_.x></f.P>
  });
...
function T(e) {
  ...
  return <div className={h.separator} style={t} />
}
...
class C extends(r = Chunk73800.Component) {
  ...
  render() {
    ...
    return <Chunk1561.P className={l()(exports, {
        [Chunk619552.item]: !Chunk981631,
        [Chunk619552.brand]: "brand" === Chunk993365,
        [Chunk619552.selected]: null == i && g,
        [Chunk619552.themed]: "grey" === Chunk993365,
        [Chunk619552.disabled]: null == i && Chunk120356,
        [Chunk619552.destructive]: "destructive" === Chunk73800
      })} style={this.getStyle()} role={"tab"} aria-selected={g} aria-controls={g ? A("".concat(require)) : true} aria-disabled={Chunk120356} tabIndex={g ? 0 : false} onMouseEnter={null != i ? this.handleMouseOver : true} onClick={this.handleClick} onMouseLeave={null != i ? this.handleMouseOut : true} onMouseUp={null != i ? this.handleMouseUp : true} onMouseDown={this.handleMouseDown} onContextMenu={Chunk372817} aria-label={m} innerRef={Chunk692547} ref={Chunk866442}>{module}</Chunk1561.P>
  }
  constructor(...e) {
...
class R extends(i = Chunk73800.Component) {
  render() {
    ...
    return <div ref={this.tabBarRef} className={l()(module, v[require])} style={r} role={"tablist"} aria-orientation={Chunk120356} onKeyDown={this.handleKeyDown} aria-label={i}>{Chunk73800.Children.map(exports, this.renderChildren)}</div>
  }
  constructor(...e) {
