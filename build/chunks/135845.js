...
function v(e) {
  ...
  let D = E === k.id,
    ...
    M = i.useCallback(() => {
      let e = "noop";
      w ? (j(), e = "transition") : (C(), e = "accept"), (0, s.r$)({
        invite: v,
        action: e,
        inviter_id: N
      }, A)
  ...
  W && !Z ? a = D ? x.NW.string(x.t.oBLoZG) : x.NW.formatToPlainString(x.t["0QJmAw"], {
    name: k.username
  }) : (t = x.NW.string(x.t["I6JG4+"]), n = d.Z.Button.Colors.GREEN, w && (t = x.NW.string(x.t["Q1W99/"]), n = d.Z.Button.Colors.PRIMARY), a = D ? x.NW.string(x.t["4hyaHh"]) : x.NW.formatToPlainString(x.t.QmlLEh, {
    name: k.username
  }));
  let F = I === O.id && null != U ? (0, r.jsx)(d.Z.Channel, {
    channel: U
  }) : x.NW.formatToPlainString(x.t.u0vaDA, {
    guildName: O.name
  });
  return (0, r.jsxs)(d.Z, {
    children: [(0, r.jsx)(d.Z.Header, {
      text: x.NW.string(x.t["wS+5WV"])
    }), (0, r.jsxs)(d.Z.Body, {
