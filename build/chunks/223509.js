...
function ep(e, t) {
  var n, r, i, et, en, er, eo, ea, es, el, ec, eu, ed, ep, eh, em, eg, eE, eb, ey, eO, ev, eI, eT, eS = 0,
    eA = new o.Buf8(4),
  ...
  i: for (;;) switch (n.mode) {
    ...
    case A:
      ...
      n.head && (n.head.time = ea), 512 & n.flags && (eA[0] = 255 & ea, eA[1] = ea >>> 8 & 255, eA[2] = ea >>> 16 & 255, eA[3] = ea >>> 24 & 255, n.check = s(n.check, eA, 4, 0)), ea = 0, es = 0, n.mode = C;
    case C:
      for (; es < 16;) {
        if (0 === er) break i;
        er--, ea += r[et++] << es, es += 8
      }
      n.head && (n.head.xflags = 255 & ea, n.head.os = ea >> 8), 512 & n.flags && (eA[0] = 255 & ea, eA[1] = ea >>> 8 & 255, n.check = s(n.check, eA, 2, 0)), ea = 0, es = 0, n.mode = N;
    case N:
      if (1024 & n.flags) {
        for (; es < 16;) {
          if (0 === er) break i;
    ...
    case Z:
      for (; n.have < n.ncode;) {
        ...
        n.lens[eC[n.have++]] = 7 & ea, ea >>>= 3, es -= 3
      }
      for (; n.have < 19;) n.lens[eC[n.have++]] = 0;
      if (n.lencode = n.lendyn, n.lenbits = 7, eI = {
          bits: n.lenbits
        }, ev = c(u, n.lens, 0, 19, n.lencode, 0, n.work, eI), n.lenbits = eI.bits, ev) {
    ...
    case F:
      ...
      if (n.lenbits = 9, eI = {
          bits: n.lenbits
        }, ev = c(d, n.lens, 0, n.nlen, n.lencode, 0, n.work, eI), n.lenbits = eI.bits, ev) {
        e.msg = "invalid literal/lengths set", n.mode = $;
        break
      }
      if (n.distbits = 6, n.distcode = n.distdyn, eI = {
          bits: n.distbits
        }, ev = c(f, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, eI), n.distbits = eI.bits, ev) {
  ...
  return (e.next_out = en, e.avail_out = eo, e.next_in = et, e.avail_in = er, n.hold = ea, n.bits = es, (n.wsize || ec !== e.avail_out && n.mode < $ && (n.mode < X || t !== _)) && e_(e, e.output, e.next_out, ec - e.avail_out)) ? (n.mode = ee, O) : (el -= e.avail_in, ec -= e.avail_out, e.total_in += el, e.total_out += ec, n.total += ec, n.wrap && ec && (e.adler = n.check = n.flags ? s(n.check, i, ec, e.next_out - ec) : a(n.check, i, ec, e.next_out - ec)), e.data_type = n.bits + 64 * !!n.last + 128 * (n.mode === j) + 256 * (n.mode === V || n.mode === U), (0 === el && 0 === ec || t === _) && ev === m && (ev = v), ev)
}
...
function eg(e, t) {
  var n, r, i = t.length;
  return e && e.state && (0 === (n = e.state).wrap || n.mode === L) ? n.mode === L && (r = a(r = 1, t, i, 0)) !== n.check ? y : e_(e, t, i, i) ? (n.mode = ee, O) : (n.havedict = 1, m) : b
}
