...
function ea(e) {
  var t;
  return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = S, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new o.Buf32(et), t.distcode = t.distdyn = new o.Buf32(en), t.sane = 1, t.back = -1, m) : v
}
...
function ep(e, t) {
  var n, r, i, et, en, er, eo, ea, es, el, ec, eu, ed, ep, eh, em, eg, eE, ev, eb, ey, eO, eI, eS, eT = 0,
    eN = new o.Buf8(4),
  ...
  i: for (;;) switch (n.mode) {
    ...
    case C:
      ...
      n.mode = R;
    case R:
      if (1024 & n.flags && ((eu = n.length) > er && (eu = er), eu && (n.head && (ey = n.head.extra_len - n.length, n.head.extra || (n.head.extra = Array(n.head.extra_len)), o.arraySet(n.head.extra, r, et, eu, ey)), 512 & n.flags && (n.check = s(n.check, r, eu, et)), er -= eu, et += eu, n.length -= eu), n.length)) break i;
      n.length = 0, n.mode = P;
    case P:
      if (2048 & n.flags) {
        if (0 === er) break i;
        ...
        if (512 & n.flags && (n.check = s(n.check, r, eu, et)), er -= eu, et += eu, ey) break i
    ...
    case F:
      ...
      if (n.lenbits = 9, eI = {
          bits: n.lenbits
        }, eO = c(d, n.lens, 0, n.nlen, n.lencode, 0, n.work, eI), n.lenbits = eI.bits, eO) {
        e.msg = "invalid literal/lengths set", n.mode = $;
        break
      }
      if (n.distbits = 6, n.distcode = n.distdyn, eI = {
          bits: n.distbits
        }, eO = c(f, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, eI), n.distbits = eI.bits, eO) {
...
function eg(e, t) {
  var n, r, i = t.length;
  return e && e.state && (0 === (n = e.state).wrap || n.mode === x) ? n.mode === x && (r = a(r = 1, t, i, 0)) !== n.check ? b : e_(e, t, i, i) ? (n.mode = ee, y) : (n.havedict = 1, m) : v
}
