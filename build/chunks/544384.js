...
function E(e, t, n) {
  ...
  return i.useMemo(() => {
    ...
    return 1 === r.length && r[0].ownerId === (null == a ? void 0 : a.ownerId) ? [] : r.map(t => ({
      stream: t,
...
function b(e) {
  ...
  let {
    ...
    onClose: p,
    onSelect: b,
    appContext: y = m.IlC.APP,
    disableChangeWindows: O = !1,
    onInteraction: v
  } = e, I = null != (t = o.find(e => e.ownerId === (null == i ? void 0 : i.id))) ? t : null, S = E(n, i, o), T = (0, c.Z)(I, y), {
      ...
      children: [(0, r.jsx)(a.kSQ, {
        children: S.map(e => {
          ...
          return (0, r.jsx)(a.sNh, {
            id: t.ownerId,
            label: g.intl.formatToPlainString(g.t["7rkg+/"], {
              username: n
            }),
            icon: a.g5r,
            action: () => (0, d.Z)(t)
