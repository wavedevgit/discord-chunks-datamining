...
function g(t) {
  ...
  } = (0, o.XJ)(null != f ? f : g), [v, h] = (0, r.Wu)([c.ZP], () => [c.ZP.isActive(e), c.ZP.getGuildScheduledEvent(e)]), y = (0, u.Z)(n, null == h ? void 0 : h.id), O = null != h && p(h), j = (null == h ? void 0 : h.recurrence_rule) != null && !b, E = (0, s.zI)(e, n);
  ...
  let _ = t => {
    (0, i.h7j)(r => {
      ...
      return (0, l.jsxs)(i.ConfirmModal, (o = function(t) {
        ...
        }), (0, l.jsx)("br", {}), (j || t) && (0, l.jsx)(i.Text, {
          variant: "text-md/normal",
          children: d.intl.format(d.t.ZcpcyM, {})
        })]
      }, Object.getOwnPropertyDescriptors ? Object.defineProperties(o, Object.getOwnPropertyDescriptors(c)) : (function(t, e) {
        var n = Object.keys(t);
