...
let _ = e => {
  ...
  return <c.JZ title={x.intl.formatToPlainString(x.t.TRp5wc, {
      username: f
    })} description={x.intl.string(x.t["yM/+AA"])} buttonText={j ? x.intl.string(x.t.E8x4Nj) : x.intl.string(x.t.HITUcX)} buttonDisabled={j} onButtonPress={O} />
}