...
async function f(e) {
  ...
  let n = [];
  l.intl.setLocale(e), n.push(), n.push((async () => {
    await (0, c.f)(), await (0, s.eD)(), await (0, i.loadAllMessagesInLocale)(e)
  })()), null != r && (r.setLocale(e), n.push(r.loadPromise)), n.push(p(e)), n.push(_(e)), n.push(m(e)), await Promise.all(n).catch(n => t.setLoadingFailed(n, e)), t.setLoadingSucceeded(e)
}
async function p(e) {
  let t = u.getState(),
    r = n(602473).q[e];
