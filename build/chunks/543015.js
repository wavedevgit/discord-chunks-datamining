...
let eu = l.memo(function(e) {
  let {
    ...
    let i = (0, h.e7)([X.ZP], () => X.ZP.getCurrentSidebarChannelId(r.parent_id) === r.id),
      ...
      s = function(e) {
        let {
        ...
        } = e, i = (0, L.p)(), a = l.useMemo(() => null != t ? (0, A.Z)(t, null == t ? void 0 : t.messageSnapshots[0]) : null, [t]), {
          hasSpoilerEmbeds: s,
          content: o
        } = l.useMemo(() => (null == a ? void 0 : a.content) != null && "" !== a.content ? (0, H.ZP)(a, {
          formatInline: n,
          ...
          hasSpoilerEmbeds: !1,
          content: null
        }, [n, a, r, i]), c = (0, P.eL)(t, s), d = (0, P.vg)(t, s);
        return null == t ? null : {
          hasSpoilerEmbeds: s,
          content: o,
          firstMedia: c,
  ...
  return (0, r.jsxs)("div", {
    ...
    onClick: I,
    onContextMenu: k,
    className: a()(eo.container, es.container, c, {
      [eo.isOpen]: x
    }),
    children: [(0, r.jsx)(f.P3F, ed({
      onClick: I,
      focusProps: {
        ringTarget: y
      },
      ...
      children: [(0, r.jsx)(f.y5t, {
        children: (0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(em, {
            ...
            containerWidth: d,
            originalAuthor: _
          }), (null == v ? void 0 : v.blocked) || null == C ? null : (0, r.jsx)(ev, {
            channel: g,
            firstMedia: C
          })]
        })
...
function em(e) {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(k.ZP, {
      ...
      className: a()(eo.header, {
        [eo.withNewBadgeOverflow]: m
      }),
      children: (0, r.jsxs)("div", {
...
let eh = l.memo(function(e) {
  let {
    ...
    hasUnreads: s,
    originalAuthor: o
  } = e, c = (0, h.e7)([T.Z], () => T.Z.isLoading(n.id)), d = (0, h.e7)([Y.Z], () => Y.Z.can(el.Plq.MANAGE_MESSAGES, n)), u = W.cC.useSetting(), m = (0, h.e7)([Q.Z], () => Q.Z.getGuildId()), {
...
function eg(e) {
  let {
    ...
    facepileRef: n,
    firstMessage: l
  } = e, i = (0, _.Q)(t.id), a = (null == l ? void 0 : l.reactions) != null && l.reactions.length > 0;
  return (0, r.jsxs)("div", {
    className: es.footer,
    children: [(0, r.jsxs)("div", {
      ...
      children: [a || null == l ? null : (0, r.jsx)(ex, {
        firstMessage: l,
        channel: t
      }), (0, r.jsx)(ef, {
        channel: t,
...
function ef(e) {
  ...
  return (0, r.jsxs)("div", {
    className: a()(eo.messageCountBox, {
      [eo.hasRead]: l && null == s
    }),
    children: [(0, r.jsx)("span", {
...
function ex(e) {
  let {
    firstMessage: t,
    channel: n
  } = e, l = (0, h.e7)([K.Z], () => K.Z.getChannel(n.parent_id)), i = (0, N.Bs)(l), {
    disableReactionCreates: a,
    isLurking: s,
    isPendingMember: o
  } = (0, U.Z)(n);
  return null == i || a ? null : (0, r.jsx)(G.le, {
...
function ep(e) {
  ...
  let {
    ...
    sortOrder: l
  } = (0, w.H)(n.parent_id), i = (0, N.xw)(n, l), a = null == (t = n.threadMetadata) ? void 0 : t.createTimestamp, s = null == a ? null : ea.intl.formatToPlainString(ea.t["13euCQ"], {
    timestamp: (0, et.vc)(d()(a), "LLLL")
  });
