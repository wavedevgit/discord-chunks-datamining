...
function S() {
  ...
  return s ? (0, r.jsx)(m.Z, {}) : (e = null == t && 0 === n.length ? u ? (0, r.jsx)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      tag: d.RB0.H5,
      title: x.size > 0 ? C.NW.string(C.t.mMEmRE) : C.NW.string(C.t.Vij32N),
      children: [(0, r.jsx)(d.R94, {
        ...
        onClick: () => {
          x.size > 0 ? (0, p.L$)(Array.from(x)) : (0, p.L$)(n.map(e => e.id_hash))
        },
        children: x.size > 0 ? C.NW.formatToPlainString(C.t["83CPLi"], {
          count: x.size
...
function v(e) {
  ...
  let {
    ...
    checked: m,
    useChecks: g
  } = e, f = null != (l = null == (t = o.client_info) ? void 0 : t.location) ? l : null == (n = o.client_info) ? void 0 : n.ip, b = null == (i = o.client_info) ? void 0 : i.platform, {
    text: _,
    icon: N
  } = function(e) {
  ...
  }(null == (s = o.client_info) ? void 0 : s.os), E = c ? null : (0, h.p)(o.approx_last_used_time), j = [_, b].filter(x.lm), S = [f, E].filter(x.lm);
  return (0, r.jsxs)("div", {
