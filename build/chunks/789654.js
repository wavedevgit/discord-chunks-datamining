...
function T(e) {
  let {
    ...
    n(t => {
      ...
      return null == n[e] ? j(_({}, t), {
        rawColorOverrides: j(_({}, n), {
          [e]: {
            color: u.b[e].hex,
            highlight: !1
          }
