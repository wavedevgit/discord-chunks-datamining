...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk355589 = require("./355589.js"),
  Chunk542581 = require("./542581.js"),
  Chunk639184 = require("./639184.js"),
  Chunk404616 = require("./404616.js"),
  Chunk470623 = require("./470623.js"),
  Chunk749913 = require("./749913.js"),
  Chunk219664 = require("./219664.jsx"),
  Chunk895932 = require("./895932.js"),
...
function eC(e) {
  ...
  return <ei.oL channel={t}><eN channel={t} guild={n} sidebarState={i} /></ei.oL>
}
...
function ew(e) {
  ...
  return <div className={l()(ep.card, ep.archivedDividerRow, ep.columnsSpan)} style={n} data-item-role={t}><div className={ep.emptyMainCard}><p.X6q variant={"eyebrow"} className={ep.archivedDivider} id={ey(i)}>{ex.intl.string(ex.t["3+LO19"])}</p.X6q></div></div>
}
...
function eP(e) {
  ...
  return () => 2 === t && !a && l ? <ew section={t} coords={null == n ? true : ej(eb({}, n), {
      position: "absolute"
    })} itemRole={"section"} /> : null
}
...
function eN(e) {
  ...
  }, [t.guild_id, t.id, ew]), [eG, eq] = i.useState(a + s - 24), eW = i.useCallback((e, n, i) => 0 === e ? <eZ channel={t} isEmpty={!H} isSearchLoading={I} numResults={null == x ? true : x.length} coords={n} onHeightChange={eq}>{!O && (0, r.jsx)(ee.Z, {
      channel: t,
      hasAnyThread: U,
      hasActiveThreads: H
    }, t.id)}</eZ> : 2 !== e || en ? 1 === e && eC && !et ? <eE channel={t} coords={n} /> : i() : <eI channel={t} coords={n} />, [eC, en, x, et, t, H, I, O, U]), eX = (0, g.e7)([q.Z], () => q.Z.hasHidden(t.id)), eK = {
    editorHeight: a,
    isGridLayout: eo
  }, eJ = i.useRef(eK);
  i.useEffect(() => {
  ...
  let {
    ...
    let {
      ...
      if (3 === e.section) return __OVERLAY__ ? null : <div data-item-role={"item"} className={l()(ep.loadingCard, ep["loadingCard-".concat(e.row % 3)])} />;
      let t = a[e.section][e.row],
        n = null != f && (0, N.UD)(f) ? E.ZP : er.ZP;
      return <li className={ep.card} data-item-role={"item"}><p.y5t><n className={ep.mainCard} threadId={t} goToThread={u} observePostVisibilityAnalytics={m} /></p.y5t></li>
    ...
    return {
      ...
      renderGridItem: i.useCallback((e, t, i, s, o) => {
        if (0 === e) return null;
        let c = n[e][t];
        return null != c ? <el.Z id={"".concat(s)} threadId={c} className={l()(ep.card, ep.mainCard)} goToThread={a} observePostVisibilityAnalytics={m} coords={i} gridCoords={o.coordinates[s]} gridSectionBoundaries={o.boundaries} /> : __OVERLAY__ ? null : <div style={eb({}, i)} data-item-role={"item"} className={l()(ep.loadingCard, ep["loadingCard-".concat(t % 3)])} />
      }, [n, a, m]),
      getSectionProps: C,
  ...
  return <div className={ep.container} ref={eN} data-member-list-open={tc}><p.Wdt>{e => (0, r.jsxs)(r.Fragment, {
...
function eI(e) {
  ...
  return <div className={l()(ep.missingReadHistoryPermission, ep.columnsSpan)} style={n}><p.Text color={"text-muted"} variant={"text-md/normal"}>{ex.intl.format(ex.t.TycmzM, {
        channelName: i
      })}</p.Text></div>
}
...
function eE(e) {
  ...
  return <div className={l()(ep.missingReadHistoryPermission, ep.columnsSpan)} style={n}><p.Text color={"text-muted"} variant={"text-md/normal"}>{ex.intl.format(ex.t.OWZJdX, {
        channelName: i
      })}</p.Text></div>
}
...
function eR(e) {
  ...
  return 0 === a ? null : <p.P3F className={ep.newPostsButton} onClick={n}><p.Text color={"text-brand"} variant={"text-md/medium"}>{ex.intl.format(ex.t.ue1qfH, {
        count: a
      })}</p.Text></p.P3F>
}
...
function ek(e) {
  ...
  return <p.yRy targetElementRef={a} renderPopout={e => {
      let {
        closePopout: n
      } = e;
      return (0, r.jsx)(es.Z, {
