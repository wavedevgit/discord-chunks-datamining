/** Chunk was on web.js **/
/** chunk id: 989479, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  CV: () => o,
  E9: () => v,
...
let a = {
  ...
  f = `(?:${(0,Chunk476858.uJ)(c)}|[0-9]+|[0-9]+\\.[0-9]+|пол|несколько|пар(?:ы|у)|\\s{0,3})`;

function p(e) {
  let t = e.toLowerCase();
  return true !== c[t] ? c[t] : t.match(/несколько/) ? 3 : t.match(/пол/) ? .5 : t.match(/пар/) ? 2 : "" === t ? 1 : parseFloat(t)
}
let _ = `(?:${(0,Chunk476858.uJ)(u)}|[0-9]{1,2}(?:го|ого|е|ое)?)`;
