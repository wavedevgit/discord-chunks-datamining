...
function D(e) {
  ...
  g = m(p({}, g), {
    ...
    [n.id]: n
  })), null != y && n.type === d.NYc.GUILD && (y = w({
    activeSubscriptions: y,
    record: n
  })), null != O && n.type === d.NYc.APPLICATION && (y = w({
...
function L(e) {
  ...
  if (v = !0, null != t) {
    ...
    if (t.user_id !== e && !I) {
      P.log("[handleMostRecentSubscriptionFetch] Skipping adding Subscription into SubscriptionStore because of userId mismatch"), (0, u.g9)("[handleMostRecentSubscriptionFetch] Skipping adding Subscription into SubscriptionStore because of userId mismatch", {
        extra: {
          authUserId: e,
          subscriptionId: t.id,
...
function x(e) {
  ...
  if (T = !0, null != t) {
    let e = c.default.getId();
    if (t.user_id !== e && !I) {
      P.log("[handlePreviousSubscriptionFetch] Skipping adding Subscription into SubscriptionStore because of userId mismatch"), (0, u.g9)("[handlePreviousSubscriptionFetch] Skipping adding Subscription into SubscriptionStore because of userId mismatch", {
        extra: {
          authUserId: e,
          subscriptionId: t.id,
          subscriptionUserId: t.user_id
...
function F(e, t) {
  ...
  for (let n in r) {
    ...
    if (!B(i)) {
      if (!I) {
        let e = c.default.getId();
        P.log("user id mismatch between logged in user and SubscriptionStore user"), (0, u.g9)("user id mismatch between logged in user and SubscriptionStore user", {
          extra: {
            authUserId: e,
            subscriptionId: i.id,
