...
let A = {
  ...
  async setIcon(e, t, n) {
    ...
    m.default.track(y.rMx.CHANNEL_ICON_EDIT_PROGRESSED, T(I({}, o), {
      status: "initiated"
    }));
    try {
      ...
      var a, s;
      throw m.default.track(y.rMx.CHANNEL_ICON_EDIT_PROGRESSED, T(I({}, o), {
        status: "failed",
  ...
  async updateChannel(e, t, n) {
    ...
    i && m.default.track(y.rMx.CHANNEL_ICON_EDIT_PROGRESSED, T(I({}, s), {
      status: "initiated"
    }));
    try {
      let n = await r.tn.patch({
      ...
      return null == a || (null == o ? void 0 : o.isThread()) || l.Z.checkGuildTemplateDirty(a), i && m.default.track(y.rMx.CHANNEL_ICON_EDIT_PROGRESSED, T(I({}, s), {
        status: "success"
      })), n
    } catch (e) {
      if (i) {
        var c, u;
        m.default.track(y.rMx.CHANNEL_ICON_EDIT_PROGRESSED, T(I({}, s), {
          status: "failed",
