...
function p(e) {
  let {
    ...
    contentMessage: y
  }).content : null, [y, E, t]), S = p.length, A = null, O = null, v = null;
  if (S > 0 || b.length > 0) {
    var x, C, P, L;
    let e = (0, s.countBy)(p, e => (0, d.aw)(e, !0)),
      t = null != (P = e.IMAGE) ? P : 0,
      n = null != (L = e.VIDEO) ? L : 0;
    t > 0 && n > 0 ? (A = g.intl.formatToPlainString(g.t.Lr0Toq, {
      image_count: t,
      video_count: n
    }), O = o.Ka2) : n > 0 ? (A = g.intl.formatToPlainString(g.t.SJ6pPT, {
      count: n
    }), O = o.g8d) : t > 0 ? (A = g.intl.formatToPlainString(g.t.h4pFfX, {
      count: t
    }), O = 1 === t ? o.XBm : o.Ka2) : (A = g.intl.formatToPlainString(g.t["89ihS0"], {
      count: S
    }), O = o.Ujz), n > 0 && S === n ? v = (0, l.jsxs)("div", {
    ...
    }) : (null == (C = b[0]) || null == (x = C.thumbnail) ? void 0 : x.proxyURL) != null && (v = (0, l.jsx)("div", {
      className: m.attachmentPreview,
      children: (0, l.jsx)(u.ZP, {
  ...
  return S > 1 && null != v && (v = (0, l.jsxs)("div", {
