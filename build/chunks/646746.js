...
function p(e) {
  let {
    ...
    contentMessage: y
  }).content : null, [y, E, t]), S = p.length, A = null, O = null, N = null;
  if (S > 0 || b.length > 0) {
    var v, x, C, P;
    let e = (0, s.countBy)(p, e => (0, d.aw)(e, !0)),
      t = null != (C = e.IMAGE) ? C : 0,
      n = null != (P = e.VIDEO) ? P : 0;
    t > 0 && n > 0 ? (A = g.NW.formatToPlainString(g.t.Lr0Toq, {
      image_count: t,
      video_count: n
    }), O = o.Ka2) : n > 0 ? (A = g.NW.formatToPlainString(g.t.SJ6pPT, {
      count: n
    }), O = o.g8d) : t > 0 ? (A = g.NW.formatToPlainString(g.t.h4pFfX, {
      count: t
    }), O = 1 === t ? o.XBm : o.Ka2) : (A = g.NW.formatToPlainString(g.t["89ihS0"], {
      count: S
    }), O = o.Ujz), n > 0 && S === n ? N = (0, l.jsxs)("div", {
    ...
    }) : (null == (x = b[0]) || null == (v = x.thumbnail) ? void 0 : v.proxyURL) != null && (N = (0, l.jsx)("div", {
      className: m.attachmentPreview,
      children: (0, l.jsx)(u.ZP, {
  ...
  return S > 1 && null != N && (N = (0, l.jsxs)("div", {
