...
let m = e => {
  ...
  I = async e => {
    ...
    if (t.name === p) return;
    let i = y(e, t.name);
    "profile_effects" === n ? T(e, t, r) : O(t) ? "collection" === n || null === n ? f.has(t.name) ? r.collectionFiles.push(t) : r.ignoredFilenames.push(i) : "avatar_decorations" === n ? r.avatarDecorationFiles.push(t) : r.ignoredFilenames.push(i) : r.ignoredFilenames.push(i)
  }, A = async (e, t, n) => {
