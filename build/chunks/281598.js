...
let h = e => {
  ...
  O = e => (0, o.tw)(e.type) || (0, o.X2)(e.type) || (0, o.yn)(e.name),
  ...
  S = async e => {
    ...
    for (let n of e)
      if (n.isDirectory) {
        let e = n,
          r = e.name;
        "collection" === r || "avatar_decorations" === r ? await C(e, r, t) : "profile_effects" === r ? await A(e, t) : await N(e, t)
      } else if (n.isFile) {
      let e = n;
    ...
    } = (0, Chunk619899.N9)(), o = Chunk473749.useCallback(async e => {
      let r = await P(e);
