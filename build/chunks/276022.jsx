...
function g(e) {
  ...
  let x = [];
  return w && T && x.push(<a.sNh id={"manage-server-integration"} label={m.intl.string(m.t.IuSJT0)} action={D} />), P && R && x.push(<a.sNh id={"manage-authorized-app"} label={m.intl.string(m.t.V8ruv7)} action={L} />), x
}