...
function I(e) {
  ...
  return <div className={h.container}><u._ position={b} id={0} width={C} ref={T} onMove={w} onResize={P} maxX={t} maxY={o} edgeOffsetTop={S} edgeOffsetBottom={70} edgeOffsetLeft={16} edgeOffsetRight={16} resizeConfig={R}><div className={h.tileContainer}>{_.map(e => (0, r.jsx)(f.ZP, {
          participant: e,
          channel: l,
          onContextMenu: n,
