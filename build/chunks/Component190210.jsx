...
let er = Chunk647438.memo(Chunk647438.forwardRef(function(e, t) {
  ...
  } = (0, _.ZP)(C.Z.CHANNEL_TEXT_AREA), eN = (0, V.qz)(t), eA = i.useRef(null), ew = i.useRef(null), eM = i.useRef(null), eR = i.useRef(null);
  ...
  } = (0, V.TE)(k, D, ek, I), eH = !A.dN.useSetting() && !(0, L.isAndroidWeb)() && null != window.ResizeObserver, eV = !eH || !(null == (n = D.commands) ? true : n.enabled) || !G || p !== q.GI, eG = (0, T.Z)(), {
    fontSize: ez
  } = (0, d.cj)([y.Z], () => ({
  ...
  } = (0, V.x2)(ew, p, h), eX = i.useCallback(e => {
    let t = e => {
        if (e.shouldClear) {
          var t;
          (0, O.c)(k.id, {
