...
class N {
  ...
  constructor(e, t) {
    O(this, "ProtoClass", void 0), O(this, "type", void 0), O(this, "logger", void 0), O(this, "beforeSendCallbacks", void 0), O(this, "lastSendTime", void 0), O(this, "persistChanges", void 0), this.ProtoClass = e, this.type = t, this.beforeSendCallbacks = [], this.lastSendTime = 0, this.persistChanges = async () => {
...
function L(e) {
  return C.updateAsync("userContent", t => {
...
function x(e, t) {
  return C.updateAsync("userContent", n => {
...
function G() {
  return C.updateAsync("userContent", e => {
...
function B() {
  return C.updateAsync("userContent", e => {
    ...
    for (let n of d.V_)(0, d.O2)(n) ? t = (0, h.GV)(t, n) : e.recurringDismissibleContentStates[n] = {
