...
class T {
  ...
  constructor(e, t) {
    y(this, "ProtoClass", void 0), y(this, "type", void 0), y(this, "logger", void 0), y(this, "beforeSendCallbacks", void 0), y(this, "lastSendTime", void 0), y(this, "persistChanges", void 0), this.ProtoClass = e, this.type = t, this.beforeSendCallbacks = [], this.lastSendTime = 0, this.persistChanges = async () => {
...
function D(e, t) {
  return A.updateAsync("userContent", n => {
...
function U() {
  return A.updateAsync("userContent", e => {
    ...
    for (let n of d.V_)(0, d.O2)(n) ? t = (0, p.GV)(t, n) : e.recurringDismissibleContentStates[n] = {
