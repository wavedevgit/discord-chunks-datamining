...
let m = e => {
    ...
    return t && i ? N.NW.string(N.t.bXTClZ) : t && (a === u.Si.TIER_2 || r) ? (0, l.Rt)({
      intervalType: null == s ? void 0 : s.interval,
      intervalCount: null == s ? void 0 : s.interval_count
    }) : t ? N.NW.formatToPlainString(N.t.nTmm2t, {
      freeTrialText: n
    }) : void 0
  },
  T = (e, t, a, n) => t || a ? N.NW.string(N.t.fkPGam) : e === u.Si.TIER_2 ? N.NW.formatToPlainString(N.t.bkQ4bG, {
    percent: n
  }) : void 0,
  b = e => {
    var {
    ...
    let R = (0, s.ZP)(),
      ...
      U = b ? N.NW.string(N.t.J61px8) : null != p ? T(a, v, E, p.discount.amount) : m({
        showTrialCTA: P,
        subscriptionTier: a,
        trialDurationCopy: S,
        isPersistentCTA: E,
