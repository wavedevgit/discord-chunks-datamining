...
let I = e => {
    ...
    return (0, r.jsxs)("div", {
      className: o()(h.info, {
        [h.withDisplayNameStyles]: O && null != y
      }, f),
  ...
  T = e => {
    ...
    } = e, p = y(e, ["user", "nick", "forceUsername", "showAccountIdentifier", "overrideDiscriminator", "forcePomelo", "hideBotTag", "hideDiscriminator"]);
    ...
    if (A || S !== E) {
      let e = S === E && A && i ? _.ZP.getUserTag(t, {
          forcePomelo: l
        }) : S,
