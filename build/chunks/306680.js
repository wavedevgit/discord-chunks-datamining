...
class eM {
  ...
  _ack(e, t) {
    ...
    eL(() => c.tn.post({
      ...
      null != e && (ep === a && i === B.default.getId() && (ep = e.body.token), f.Z.dispatch({
        type: "MESSAGE_ACKED"
...
function e$(e) {
  ...
  eA(), ep = null, eh || o.partial || eM.clearAll(), eh = !1, o.entries.forEach(e => {
    var t, n;
...
function e9(e) {
  ...
  let h = t === i || n === i;
  if (h && ek(s) && !o || null != r && r.isInstanceFocused() && h && r.isInstanceLocked() && r.isPinned(ee.Odu.TEXT)) return s.ack({
    messageId: a.id
  });
