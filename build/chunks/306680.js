...
function eA() {
  eI = Date.now() - 7 * k.Z.Millis.DAY, eS = Date.now() - 3 * k.Z.Millis.DAY, clearTimeout(eT), eT = setTimeout(() => {
    f.Z.dispatch({
...
class eM {
  ...
  rebuildChannelState(e) {
    ...
    if (this.ackMessageId = null != (t = null != e ? e : this._ackMessageId) ? t : this.guessAckMessageId(), this.isManualAck = null != e, this.oldestUnreadMessageId = null, this.estimated = !1, this.unreadCount = 0, r && (this.mentionCount = 0), this.hasUnread()) {
      ...
      }), this.estimated = !s.hasPresent() || !(i || o) && s.length === this.unreadCount, this.oldestUnreadMessageId = null != (n = this._oldestUnreadMessageId) ? n : a
    }
  ...
  delete() {
    ...
    es.log("Deleting ReadState", this.channelId, this.type, {
      ...
      oldFormErrors: !0,
      rejectWithError: !0
    }), null == (e = eM._readStates[this.type]) || delete e[this.channelId], eM._mentionChannels.delete(this.channelId)
  }
...
function e$(e) {
  ...
  eA(), ep = null, eh || a.partial || eM.clearAll(), eh = !1, a.entries.forEach(e => {
    var t, n;
...
function e5(e) {
  ...
  eA(), ep = null, ef = n, e_ = F.ZP.getCurrentSidebarChannelId(ef), eM.clearAll(), t.forEach(e => {
...
function e9(e) {
  ...
  let h = t === i || n === i;
  if (h && ek(s) && !a || null != r && r.isInstanceFocused() && h && r.isInstanceLocked() && r.isPinned(ee.Odu.TEXT)) return s.ack({
    messageId: o.id
  });
...
function ti(e) {
  ...
  if (e.ownerId === (null == n ? void 0 : n.id)) return eM.get(e.id)._persisted = !0, tL({
    channelId: t,
    messageId: e.id,
    manual: !1
  })
...
function t_(e) {
  ...
  } = e, n = t.guild_id, r = eM.get(t.guild_id, ei.W.GUILD_EVENT);
...
function tM(e) {
  ...
  let {
    ...
    ackedId: r,
    local: i
  } = e, o = null == (t = J.default.getCurrentUser()) ? void 0 : t.id;
...
function tj(e, t, n, r) {
  var i;
  let o = eM.get(e, t);
  return n !== o.ackMessageId && o.lastMessageId !== o.ackMessageId && (null != o.lastMessageId || 0 !== o.mentionCount) && (n = null != (i = null != n ? n : o.lastMessageId) ? i : G.default.fromTimestamp(o.getAckTimestamp()), o.ack({
    messageId: n,
    local: null == r || r
  }))
}
...
function tq(e) {
  ...
  for (let e in t) {
    ...
    let i = t[e],
      o = eM.getIfExists(e);
    if (null != o)
      for (let e of [null == (n = i.new_messages) ? void 0 : n[0]].concat(null != (r = i.modified_messages) ? r : []).filter(j.lm)) 1 === G.default.compare(e.id, o.lastMessageId) && (o.lastMessageId = e.id)
  }
}
