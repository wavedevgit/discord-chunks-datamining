...
function eA() {
  eI = Date.now() - 7 * M.Z.Millis.DAY, eT = Date.now() - 3 * M.Z.Millis.DAY, clearTimeout(eS), eS = setTimeout(() => {
    f.Z.dispatch({
...
class ek {
  static forEach(e) {
    for (let t of ek._readStates.values())
  ...
  ack(e) {
    ...
    }, l || o ? 0 : 3e3)), this.outgoingAck = t), !0)
  }
  takeSnapshot() {
    let {
      default: e
  ...
  _ack(e, t) {
    ...
    eL(() => c.tn.post({
      ...
      null != r && (ep === o && i === B.default.getId() && (ep = r.body.token), f.Z.dispatch({
        type: "MESSAGE_ACKED"
  ...
  delete() {
    ...
    es.log("Deleting ReadState", this.channelId, this.type, {
      ...
      oldFormErrors: !0,
      rejectWithError: !0
    }), null == (e = ek._readStates.get(this.type)) || e.delete(this.channelId), ek._mentionChannels.delete(this.channelId)
  }
...
function e$(e) {
  ...
  eA(), ep = null, eh || o.partial || ek.clearAll(), eh = !1, o.entries.forEach(e => {
    var t, n;
...
function e4(e) {
  ...
  eA(), ep = null, ef = n, e_ = Z.ZP.getCurrentSidebarChannelId(ef), ek.clearAll(), t.forEach(e => {
...
function tI(e) {
  ...
  tA(ef), tA(e_);
  let o = !1;
  return ef !== t && (o = tN(ef) || o, o = tN(e_) || o), (ef === t || (null == r ? void 0 : r.type) != null && ee.TPd.GUILD_THREADS_ONLY.has(r.type)) && (o = eQ({
    section: ee.jXE.CHANNEL,
...
function tR(e, t) {
  if (null == e) return !1;
  let n = ek.get(e);
  return t || n.hasUnread() || (n.oldestUnreadMessageIdStale = !0), eQ({
    section: ee.jXE.CHANNEL,
