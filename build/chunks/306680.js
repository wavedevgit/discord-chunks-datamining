...
class ek {
  ...
  _ack(e, t) {
    ...
    eL(() => c.tn.post({
      ...
      null != r && (ep === a && i === B.default.getId() && (ep = r.body.token), _.Z.dispatch({
        type: "MESSAGE_ACKED"
...
function e5(e) {
  ...
  eA(), ep = null, e_ = n, ef = V.ZP.getCurrentSidebarChannelId(e_), ek.clearAll(), t.forEach(e => {
...
function tf(e) {
  ...
  if (r.lastMessageId = t.id, t_(t)) return void tM({
...
function tI(e) {
  ...
  tA(e_), tA(ef);
  let a = !1;
  return e_ !== t && (a = tN(e_) || a, a = tN(ef) || a), (e_ === t || (null == r ? void 0 : r.type) != null && ee.TPd.GUILD_THREADS_ONLY.has(r.type)) && (a = eQ({
    section: ee.jXE.CHANNEL,
...
function tq(e) {
  ...
  for (let e in t) {
    ...
    let i = t[e],
      a = ek.getIfExists(e);
    if (null != a)
      for (let e of [null == (n = i.new_messages) ? void 0 : n[0]].concat(null != (r = i.modified_messages) ? r : []).filter(j.lm)) 1 === G.default.compare(e.id, a.lastMessageId) && (a.lastMessageId = e.id)
  }
}
