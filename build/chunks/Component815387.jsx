...
let eD = Object.freeze({
    ...
    [Chunk981631.uaV.RECIPIENT_ADD]: function(e) {
      let {
        ...
        author: o
      } = t, a = t.getChannelId(), s = (0, l.e7)([z.default], () => z.default.getUser(t.mentions[0]), [t]), c = K.ZP.getName(null, a, s), u = (0, en.l)({
        user: o,
        channelId: a,
        guildId: n.guild_id,
        messageId: t.id
    ...
    [Chunk981631.uaV.RECIPIENT_REMOVE]: function(e) {
      let {
        ...
        author: o
      } = t, a = t.getChannelId(), s = (0, l.e7)([z.default], () => z.default.getUser(t.mentions[0]), [t]), c = (0, en.l)({
        user: o,
        channelId: a,
        guildId: n.guild_id,
        messageId: t.id
    ...
    [Chunk981631.uaV.CALL]: function(e) {
      let {
        ...
        id: a,
        author: s
      } = t, u = k.default.getId(), d = t.getChannelId(), p = (0, l.e7)([U.Z], () => U.Z.isCallActive(d, a), [d, a]), m = (0, l.e7)([W.Z], () => W.Z.getVoiceState(eP.ME, u)), f = !p && null != t.call && !t.call.participants.includes(u), g = p && (null == m || m.channelId !== d), _ = i.useCallback(() => c.default.selectVoiceChannel(d), [d]), h = (0, en.l)({
        user: s,
        channelId: d,
        guildId: o.guild_id,
        messageId: t.id
    ...
    [Chunk981631.uaV.CHANNEL_PINNED_MESSAGE]: function(e) {
      let {
        ...
        author: o
      } = t, a = t.getChannelId(), s = i.useCallback(() => {
    ...
    [Chunk981631.uaV.GUILD_BOOST]: eZ,
    [Chunk981631.uaV.GUILD_BOOST_TIER_1]: eZ,
    [Chunk981631.uaV.GUILD_BOOST_TIER_2]: eZ,
    [Chunk981631.uaV.GUILD_BOOST_TIER_3]: eZ,
    ...
    [Chunk981631.uaV.GUILD_STREAM]: function(e) {
      let {
        ...
        messageReference: c
      } = t, d = t.getChannelId(), p = (0, l.e7)([H.Z], () => H.Z.findActivity(s, e => e.type === eP.IIU.PLAYING), [s]), m = (0, l.e7)([F.Z], () => null != c ? F.Z.getChannel(c.channel_id) : null, [c]), f = null == c ? true : c.guild_id, g = (0, en.l)({
        user: a,
        channelId: d,
        guildId: o.guild_id,
        messageId: t.id
    ...
    [Chunk981631.uaV.GUILD_DISCOVERY_DISQUALIFIED]: function(e) {
      let {
        message: t,
        compact: n
      } = e, i = t.getChannelId(), o = (0, l.e7)([F.Z], () => F.Z.getChannel(i), [i]), a = null != o ? o.getGuildId() : null;
    ...
    [Chunk981631.uaV.THREAD_CREATED]: function(e) {
      let {
        ...
        var i;
        let l = F.Z.getChannel(null == (i = t.messageReference) ? true : i.channel_id);
        null != l && (0, a.jW)(e, async () => {
          let {
            default: e
    ...
    [Chunk981631.uaV.AUTO_MODERATION_ACTION]: function(e) {
      ...
      return (0, b.nY)(t) ? (0, r.jsx)(er.Z, {
        message: t,
        compact: n,
        channel: i
      }) : null
    },
    [Chunk981631.uaV.GUILD_INCIDENT_ALERT_MODE_ENABLED]: eR,
    [Chunk981631.uaV.GUILD_INCIDENT_ALERT_MODE_DISABLED]: eR,
    ...
    [Chunk981631.uaV.STAGE_START]: function(e) {
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(ev.Z, {
          ...
          compact: i,
          usernameHook: o
        }), null != a && a.name === t.content ? (0, r.jsx)(x.Z, {
          code: "".concat(n.guild_id, "-").concat(a.id)
        }) : null]
      })
    },
    ...
    [Chunk981631.uaV.STAGE_RAISE_HAND]: function(e) {
      ...
      let {
        ...
        guildId: a.guild_id,
        messageId: i.id
      }), d = (0, l.e7)([G.Z], () => G.Z.can(eP.Plq.MUTE_MEMBERS, a)), p = (0, l.e7)([Z.Z], () => Z.Z.getParticipant(a.id, i.author.id)), m = new Date(q.default.extractTimestamp(i.id)).toISOString() === new Date(null != (n = null == p || null == (t = p.voiceState) ? true : t.requestToSpeakTimestamp) ? n : 0).toISOString(), f = d && (null == p ? true : p.rtsState) === R.xO.REQUESTED_TO_SPEAK && m;
      return (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(eE.Z, {
          ...
          variant: "secondary",
          onClick: () => {
            (0, w.DT)(a, i.author.id, false), s.Z.deleteMessage(a.id, i.id, true)
          },
    ...
    [Chunk981631.uaV.PREMIUM_REFERRAL]: function(e) {
      let {
        message: t,
        compact: n
      } = e;
    ...
    [Chunk981631.uaV.GIFTING_PROMPT]: function(e) {
      let {
        message: t,
        channel: n
      } = e, i = t.giftingPrompt, o = (0, l.e7)([z.default], () => z.default.getUser(null == i ? true : i.recipientUserId));
  ...
  eL = Chunk647438.memo(function(e) {
    ...
    if (null == a) {
      var s;
      return s = Error("unknown message type ".concat(t.type)), X.Z.captureException(s), new _.Z("SystemMessage").error("", s), null
    }
