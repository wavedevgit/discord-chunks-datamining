...
function ek(e) {
  let {
    ...
    id: s,
    author: l
  } = t, u = k.default.getId(), d = t.getChannelId(), f = (0, a.e7)([U.Z], () => U.Z.isCallActive(d, s), [d, s]), _ = (0, a.e7)([Y.Z], () => Y.Z.getVoiceState(eR.ME, u)), p = !f && null != t.call && !t.call.participants.includes(u), h = f && (null == _ || _.channelId !== d), m = i.useCallback(() => c.default.selectVoiceChannel(d), [d]), g = (0, et.l)({
    user: l,
    channelId: d,
    guildId: o.guild_id,
    messageId: t.id,
...
function eK(e) {
  let {
    ...
    messageReference: c
  } = t, d = t.getChannelId(), f = (0, a.e7)([F.Z], () => F.Z.findActivity(l, e => e.type === eR.IIU.PLAYING), [l]), _ = (0, a.e7)([G.Z], () => null != c ? G.Z.getChannel(c.channel_id) : null, [c]), p = null == c ? true : c.guild_id, h = (0, et.l)({
    user: s,
    channelId: d,
    guildId: o.guild_id,
    messageId: t.id
...
function e2(e) {
  ...
  let {
    ...
    guildId: s.guild_id,
    messageId: i.id
  }), d = (0, a.e7)([Z.Z], () => Z.Z.can(eR.Plq.MUTE_MEMBERS, s)), f = () => {
    (0, D.DT)(s, i.author.id, false), l.Z.deleteMessage(s.id, i.id, true)
  }, _ = (0, a.e7)([w.Z], () => w.Z.getParticipant(s.id, i.author.id)), p = new Date(q.default.extractTimestamp(i.id)).toISOString() === new Date(null != (n = null == _ || null == (t = _.voiceState) ? true : t.requestToSpeakTimestamp) ? n : 0).toISOString(), h = d && (null == _ ? true : _.rtsState) === L.xO.REQUESTED_TO_SPEAK && p;
  return (0, r.jsxs)(r.Fragment, {
...
function ts(e) {
  ...
  return null == s ? (ej(Error("unknown message type ".concat(t.type))), null) : (0, r.jsx)($.ZP, {
    message: t,
