...
function l(e) {
  let {
    filter: t,
    layoutDelegate: n
  } = e, l = (0, i.q)(e), c = (0, a.useMemo)(() => e.disabledKeys ? new Set(e.disabledKeys) : new Set, [e.disabledKeys]), d = (0, a.useCallback)(e => new(0, r.D)(t ? t(e) : e), [t]), f = (0, a.useMemo)(() => ({
    suppressTextValueWarning: e.suppressTextValueWarning
  }), [e.suppressTextValueWarning]), p = (0, s.K)(e, d, f), _ = (0, a.useMemo)(() => new(0, o.Z)(p, l, {
    layoutDelegate: n
  }), [p, l, n]);
  return u(p, _), {
    collection: p,
  ...
  (0, a.useEffect)(() => {
    if (null != t.focusedKey && !e.getItem(t.focusedKey) && n.current) {
      ...
      let u = n.current.getItem(t.focusedKey),
        ...
        _ = Math.min(p > 1 ? Math.max((null != (o = null == u ? true : u.index) ? o : 0) - p + 1, 0) : null != (a = null == u ? true : u.index) ? a : 0, (null != (s = null == f ? true : f.length) ? s : 0) - 1),
        m = null,
        h = false;
      for (; _ >= 0;) {
