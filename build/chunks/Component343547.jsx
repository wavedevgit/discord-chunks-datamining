...
let j = Chunk975571.A.getArticleURL(Chunk652215.MVz.ORBS_REWARDS_FAQ),
  M = 720;

function k(e, t) {
  let n = e.program_current_state,
    i = null != e.next_reward_date && "" !== e.next_reward_date ? (0, o.default)(new Date(e.next_reward_date), new Date) : null,
  ...
  switch (n) {
    ...
    case m.L.PAYMENT_PROCESSING:
      return {
        displayTotalLifetimeRewards: false, displayProgressBar: false, actionButton: (0, r.jsx)(c.$nd, {
          ...
          variant: t ? "overlay-primary" : "secondary",
          onClick: () => (0, y.openUserSettings)(E.X.BILLING_PANEL, {
    ...
    case m.L.PAYMENT_ERROR:
      return {
        displayTotalLifetimeRewards: null != a, displayProgressBar: false, actionButton: (0, r.jsx)("span", {
    ...
    case m.L.PREMIUM_CHURNING:
      return {
        ...
        }), headerText: C.intl.string(T.default.ISnOet), subheaderText: C.intl.format(T.default["vjaRZ/"], {
          helpdeskArticle: j
        })
      };
    default:
...
let U = e => {
  ...
  })), o = (0, f.A)("(min-width: ".concat(M, "px)")), g = (0, p.DP)(), E = i.useMemo(() => ({
    hueRotate: 25,
