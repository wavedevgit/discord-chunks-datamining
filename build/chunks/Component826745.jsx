/** Chunk was on web.js **/
/** chunk id: 826745, original params: e,t,n (module,exports,re quire) **/
"use strict";
let r;
require.d(exports, {
  y: () => b
...
class b extends(i = Chunk64700.PureComponent) {
  ...
  get selectionStart() {
    var e, t;
    return null != (e = null == (t = this._textArea) ? true : t.selectionStart) ? e : 0
  }
  get selectionEnd() {
    var e, t;
    return null != (e = null == (t = this._textArea) ? true : t.selectionEnd) ? e : 0
  }
  get value() {
    var e, t;
    return null != (e = null == (t = this._textArea) ? true : t.value) ? e : ""
  }
  render() {
    let e = this.props,
      {
