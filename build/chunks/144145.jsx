...
function P(e) {
  let {
    ...
    return n || !i ? null : <a.sNh id={"xbox-connect"} action={() => c.Z.open(I.oAB.CONNECTIONS)} label={C.intl.formatToPlainString(C.t.XWSHTU, {
        platform: T
      })} />
  }(e), j = function(e) {
    let {
  ...
  for (let e of j) {
    ...
    null != t && null != t.type && x.push(function(e, t) {
      ...
      return <a.sNh id={"join-".concat(i.session_id)} label={t ? C.intl.formatToPlainString(C.t.wFAvxM, {
          name: l.toString()
        }) : C.intl.string(C.t.OKsSCQ)} action={c} />
    }(e, n), function(e, t) {
      let {
        activity: n,
        game: i,
      ...
      return <a.sNh id={"play-".concat(n.session_id)} action={function() {
          ...
          name: i.name
        }) : C.intl.string(C.t.XKUw8v)} subtext={d} />
    }(e, n))
  }
  return [P, ...x]
}