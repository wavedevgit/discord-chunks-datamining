...
class d extends Chunk73800.Component {
  ...
  render() {
    ...
    return this.state.focused ? e = {
      visibility: "hidden",
      pointerEvents: "none"
    } : c.opacity = 0, (0, Chunk255367.jsx)("div", {
      className: a()(Chunk658993.outer, exports),
      children: (0, Chunk255367.jsxs)("div", {
        className: Chunk658993.container,
        children: [(0, Chunk255367.jsx)("input", {
          type: "text",
          className: Chunk658993.input,
          ref: this.inputRef,
          style: c,
          value: this.state.value,
          name: require,
          maxLength: Chunk120356,
          autoComplete: Chunk73800,
