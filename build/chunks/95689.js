...
let I = (0, Chunk509613.qs)(Chunk313789.n.EXPERIMENTAL_UNREADS, {
  ...
  setValue: function(t) {
    s.Z.setAccountFlag(T.c.USE_NEW_NOTIFICATIONS, t), t || (l.K.set("turnedOffNewNotifications", true), c.default.track(S.rMx.NOTIFICATION_MIGRATION_OPTOUT, {
      num_guilds_with_new_setting: r.Z.getGuildsArray().filter(t => a.ZP.resolveGuildUnreadSetting(t) === E.i.ONLY_MENTIONS).length
    }))
  },
