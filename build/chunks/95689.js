...
let E = (0, Chunk509613.qs)(Chunk313789.n.EXPERIMENTAL_UNREADS, {
  ...
  setValue: function(t) {
    s.Z.setAccountFlag(S.c.USE_NEW_NOTIFICATIONS, t), t || (l.K.set("turnedOffNewNotifications", true), c.default.track(T.rMx.NOTIFICATION_MIGRATION_OPTOUT, {
      num_guilds_with_new_setting: u.Z.getGuildsArray().filter(t => a.ZP.resolveGuildUnreadSetting(t) === g.i.ONLY_MENTIONS).length
    }))
  },
