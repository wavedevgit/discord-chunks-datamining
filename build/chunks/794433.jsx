...
let h = Object.freeze({
  SMALL: Chunk910788.small,
  MEDIUM: Chunk910788.medium,
  LARGE: Chunk910788.large
});
var m = function(e) {
...
class g extends(r = Chunk73800.Component) {
  ...
  render() {
    ...
    return null != _ && _.length > 0 && ("string" == typeof _[0] ? _.forEach((e, t) => y.push(<l.eee focusProps={{
        offset: 4
      }} className={f.tag} onClick={this.handleRemoveTag.bind(this, t)}>{e}{<l.Dio size={"md"} color={"currentColor"} className={f.close} aria-label={d.intl.string(d.t.N86XcH)} />}</l.eee>)) : (b = true, _.forEach((e, t) => y.push(<l.eee className={s()(f.tag, f.richTag)} onClick={this.handleRemoveTag.bind(this, t)}>{("MEMBER" === e.type || "USER" === e.type) && null != e.avatar && <l.qEK src={e.avatar} aria-hidden={true} size={l.EFr.SIZE_16} />}{"ROLE" === e.type && null != e.color && <span className={f.tagRoleColor} style={{
          backgroundColor: e.color
        }} />}{"GUILD" === e.type && null != e.guild && <c.Z guild={e.guild} active={true} size={c.Z.Sizes.SMOL} />}{<span className={f.tagLabel}>{e.label}</span>}{<l.Dio size={"md"} color={"currentColor"} className={f.close} aria-label={d.intl.string(d.t.N86XcH)} />}</l.eee>)))), <Chunk481060.tEY focusTarget={this.ref} ringTarget={this.containerRef}><Chunk481060.f6W theme={r}>{r => (0, i.jsx)("div", {
        ...
        })}</Chunk481060.f6W></Chunk481060.tEY>
  }
  constructor(...e) {
