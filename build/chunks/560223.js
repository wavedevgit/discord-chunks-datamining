...
let E = e => {
  ...
  C = e => {
    ...
    } = e, N = r.useRef(null), I = (0, u.Er)(), y = (0, m.v)(I), A = s === f.gM.WHATS_NEW, P = (0, u.IY)(), R = (0, p.x)();
    r.useEffect(() => {
      A && !y && (P(), R())
    }, [P, R, A, y]);
    let D = () => {
    ...
    return (0, i.jsxs)(i.Fragment, {
      children: [(null == k || null == (t = k.tenureRewardCollectible) ? void 0 : t.name) === h.I.TENURE_REWARD_COLLECTIBLE && (0, i.jsx)(a.O_, {
        ref: F,
        ...
        children: [(0, i.jsx)(E, {
          ...
          children: U.map((e, t) => {
            var n, r;
            return (0, i.jsx)(_.Z, (n = function(e) {
              ...
              confettiCanvas: e.name === h.I.TENURE_REWARD_COLLECTIBLE ? G : void 0
            }, e), r = r = {
              forceShadow: C
