...
function H(e) {
  ...
  }), M = e.lockVoiceStateForResume && null != e.channelId ? e.channelId : null, (0, O.isIOS)() && j === A.$7l.BACKGROUND && (null == e.channelId ? I.Wb.close(true) : I.Wb.isClosed() && (S.Y(false), I.Wb.connect())), false
}
...
function J(e) {
  return (0, O.isIOS)() ? (f.default.isAuthenticated() && (j === A.$7l.INACTIVE && e.state === A.$7l.BACKGROUND && null == I.GC.channelId ? I.Wb.close(true) : j === A.$7l.BACKGROUND && e.state === A.$7l.ACTIVE && I.Wb.isClosed() && (S.Y(false), I.Wb.connect())), j = e.state) : e.state === A.$7l.ACTIVE && (S.Y(false), f.default.isAuthenticated() && I.Wb.resetBackoff("App state is active")), false
}
