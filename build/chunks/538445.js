...
function S(e) {
  ...
  let {
    guild: n,
    markAsDismissed: i
  } = e, S = (null == n ? void 0 : n.premiumProgressBarEnabled) === !0 ? p.DF.LEFT_TOP : p.DF.TOP_CENTER, I = S === p.DF.TOP_CENTER || S === p.DF.LEFT_TOP ? j[S] : "", P = (0, d.Z)(n, c.Z.GUILD_BOOSTING_ENHANCED_ROLE_COLOR_COACHMARK, O.jXE.BOOSTER_ENHANCED_ROLE_COLORS_COACHMARK), N = (0, s.e7)([g.default], () => g.default.getCurrentUser()), w = (t = n.id, (0, s.e7)([f.Z], () => {
