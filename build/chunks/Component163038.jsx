...
function Z(e) {
  let {
    ...
    snapshot: n,
    index: u
  } = e, f = i.useMemo(() => new d.r(t, n, u), [t, n, u]), _ = (0, o.e7)([N.Z, L.default, w.Z, D.Z, R.Z, p.Z], () => f.getForwardInfo(N.Z, L.default, w.Z, D.Z, R.Z, p.Z).footerInfo, [f], s.Z), m = i.useCallback(() => {
    var e, n;
