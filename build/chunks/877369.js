...
t.byteLength = function(e) {
  ...
  for (var t, r = e.length, i = r % 3, l = [], o = 0, u = r - i; o < u; o += 16383) l.push(function(e, t, r) {
    for (var i, l = [], o = t; o < r; o += 3) i = (e[o] << 16 & 0xff0000) + (e[o + 1] << 8 & 65280) + (255 & e[o + 2]), l.push(n[i >> 18 & 63] + n[i >> 12 & 63] + n[i >> 6 & 63] + n[63 & i]);
    return l.join("")
  }(e, o, o + 16383 > u ? u : o + 16383));
  return 1 === i ? l.push(n[(t = e[r - 1]) >> 2] + n[t << 4 & 63] + "==") : 2 === i && l.push(n[(t = (e[r - 2] << 8) + e[r - 1]) >> 10] + n[t >> 4 & 63] + n[t << 2 & 63] + "="), l.join("")
};
for (var n = [], r = [], i = "undefined" != typeof Uint8Array ? Uint8Array : Array, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", o = 0, u = l.length; o < u; ++o) n[o] = l[o], r[l.charCodeAt(o)] = o;
