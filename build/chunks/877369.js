...
e.byteLength = function(t) {
  ...
  for (var e, r = t.length, i = r % 3, l = [], a = 0, o = r - i; a < o; a += 16383) l.push(function(t, e, r) {
    for (var i, l = [], a = e; a < r; a += 3) i = (t[a] << 16 & 0xff0000) + (t[a + 1] << 8 & 65280) + (255 & t[a + 2]), l.push(n[i >> 18 & 63] + n[i >> 12 & 63] + n[i >> 6 & 63] + n[63 & i]);
    return l.join("")
