...
class h extends u.Z {
  ...
  handleHandoff(e) {
    ...
    null != n ? r.tn.post({
      ...
      (0, a.Vb)(t.user), o.Z.loginToken(t.token, !1), p(!0, l)
    }, e => {
      if (null != i && p(!1, l), o.Z.setFingerprint(i), (0, a.lx)(), l === s.F.ROLE_SUBSCRIPTION) {
        var t;
    ...
    }) : null != i ? (o.Z.setFingerprint(i), p(!1, l), (0, a.lx)()) : (o.Z.setFingerprint(i), (0, a.by)())
  }
  constructor(...e) {
    var t, n;
