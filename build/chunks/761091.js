...
function j(e) {
  ...
  return T && w.push(O.z.GUILD_HUB_HEADER_OPTIONS), !N && S && P && null != I && I.length > 0 ? w.push(O.z.GUILD_NEW_MEMBER_ACTIONS_PROGRESS_BAR) : e.premiumProgressBarEnabled && w.push(O.z.GUILD_PREMIUM_PROGRESS_BAR), !T && S && w.push(O.z.GUILD_HOME), t && w.push(O.z.GUILD_SCHEDULED_EVENTS), !T && A && R && w.push(O.z.CHANNELS_AND_ROLES), j && w.push(O.z.GUILD_ROLE_SUBSCRIPTIONS), C && w.push(O.z.GUILD_SHOP), x && E && w.push(O.z.GUILD_GAME_SHOP), (Z && (A || D) || n && e.features.has(v.GuildFeatures.MEMBER_VERIFICATION_MANUAL_APPROVAL)) && w.push(O.z.GUILD_MOD_DASH_MEMBER_SAFETY), M && w.push(O.z.GUILD_BOOSTS), L && k && w.push(O.z.GAME_SERVERS), w
}