...
function w(e) {
  let {
    channel: t,
    gotoChannel: n
  } = e, i = (0, s.e7)([E.default], () => t.isDM() ? E.default.getUser(t.getRecipientId()) : null), l = null == i ? (0, p.x)(t) : i.getAvatarURL(void 0, 40);
...
function Z(e) {
  let {
    channel: t,
    gotoChannel: n
  } = e, i = (0, s.e7)([v.Z], () => v.Z.getGuild(t.guild_id));
...
function T(e) {
  let {
    ...
    gotoChannel: n,
    mentionCount: i
  } = e, o = (0, s.e7)([v.Z], () => v.Z.getGuild(t.guild_id)), c = (0, s.e7)([y.Z], () => y.Z.getChannel(t.parent_id)), u = (0, s.e7)([j.ZP], () => j.ZP.getIsMentionLowImportance(t.id)), d = (0, g.KS)(t, o), h = (0, f.ZP)(t, !1), p = null == c ? null == o ? void 0 : o.name : "".concat(null == o ? void 0 : o.name, " › ").concat(c.name), b = t.isMultiUserDM() ? S.intl.formatToPlainString(S.t.CxSA5O, {
