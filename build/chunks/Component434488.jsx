...
function M(e) {
  ...
  } = (0, h.ZP)(p.Z.VC_TILE_ACTIVITY_SHELF_BUTTON), {
    enabled: u
  } = d.c.useExperiment({
...
function k(e) {
  ...
  } = (0, h.ZP)(p.Z.VC_TILE_ACTIVITY_INVITE), {
    entrypoints: f
  } = (0, b._k)({
...
function j(e) {
  ...
  } = (0, h.ZP)(p.Z.VC_TILE_ACTIVITY_SUGGESTION), C = i.useMemo(() => ({
    channel: t,
    type: "channel"
  }), [t]);
  return (0, r.jsx)(h.Gt, {
