...
function S(e) {
  let {
    soundboardSound: t,
    closePicker: O
  } = e, S = (0, d.Iu)(e => e.searchQuery), T = (0, i.e7)([E.Z], () => null != t && E.Z.isFavoriteSound(t.soundId)), N = (0, i.e7)([_.Z], () => _.Z.getGuild(null == t ? void 0 : t.guildId)), A = (0, i.e7)([l.Z], () => l.Z.useReducedMotion, []), C = (0, i.e7)([h.Z], () => h.Z.isFocused()), P = (0, i.e7)([p.ZP], () => p.ZP.getKeybindForAction(b.kg4.SOUNDBOARD_HOLD));
  ...
  let R = () => {
    ...
    L = null != P && (0, m.isWindows)() && !w ? y.NW.format(y.t.udMTtr, {
