...
function T(e) {
  ...
  return n.length > 0 && t.push({
    ...
    debug: n.map(e => "\n    - #".concat(e.name)).join(""),
    apply: (e, t) => {
      for (let r of n) w(e, t, r.id, !1), C(e, t, r.id, e => {
        e.muted = !1, e.mute_config = null
      })
    }
  }), t
