...
n.d(t, {
  ...
  n_: () => g,
  xp: () => m
}), n(65234), n(111804), n(490233), n(97749), n(388685), n(467055), n(642613);
var r = n(512722),
  i = n.n(r),
  a = n(392711),
  o = n.n(a);
...
function g(e) {
  let {
    ...
    operatorText: i,
    value: a
  } = e, o = null, l = Math.round(Number(a));
  switch (r) {
    case d.iO.EQUAL:
  ...
  if (null != i && (o = i), o instanceof s._H && null != r) switch (t) {
    case _.ABu.REDDIT:
      switch (n) {
        case d.PC.CREATED_AT:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.formatToPlainString(f.t.TPbtEh, {
              days: l
            })
          });
          break;
        case d.PC.REDDIT_TOTAL_KARMA:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.formatToPlainString(f.t.P2JAER, {
              karma: l
            })
          });
          break;
        case d.PC.REDDIT_GOLD:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.string(f.t["+/5TCw"])
          });
          break;
        case d.PC.REDDIT_MOD:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.string(f.t["9rPbEh"])
          });
          break;
        default:
          return null
    ...
    case _.ABu.STEAM:
      switch (n) {
        ...
        case d.PC.STEAM_GAME_COUNT:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.formatToPlainString(f.t.H9eLoa, {
              count: l
            })
          });
          break;
        case d.PC.STEAM_ITEM_COUNT_TF2:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.formatToPlainString(f.t.MceZJy, {
              count: l
            })
          });
          break;
        case d.PC.STEAM_ITEM_COUNT_DOTA2:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.formatToPlainString(f.t.dMnRam, {
              count: l
            })
          });
          break;
    ...
    case _.ABu.TWITTER:
      switch (n) {
        ...
        case d.PC.TWITTER_VERIFIED:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.string(f.t.xRygZG)
          });
          break;
        case d.PC.TWITTER_FOLLOWERS_COUNT:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.formatToPlainString(f.t.bkajam, {
              count: l
            })
          });
          break;
        case d.PC.TWITTER_STATUSES_COUNT:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.formatToPlainString(f.t.MI7NKi, {
              count: l
            })
          });
          break;
    ...
    case _.ABu.PAYPAL:
      switch (n) {
        ...
        case d.PC.PAYPAL_VERIFIED:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.string(f.t.slSQuL)
          });
          break;
        default:
          return null
    ...
    case _.ABu.EBAY:
      switch (n) {
        ...
        case d.PC.EBAY_TOP_RATED_SELLER:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.string(f.t.TEEYwc)
          });
          break;
        case d.PC.EBAY_POSITIVE_FEEDBACK_PERCENTAGE:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.formatToPlainString(f.t.rl9Vg4, {
              value: l
            })
          });
          break;
        case d.PC.EBAY_UNIQUE_POSITIVE_FEEDBACK_COUNT:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.formatToPlainString(f.t.QP5W1d, {
              count: l
            })
          });
          break;
        case d.PC.EBAY_UNIQUE_NEGATIVE_FEEDBACK_COUNT:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.formatToPlainString(f.t["6ZFYdH"], {
              count: l
            })
          });
          break;
    ...
    case _.ABu.TIKTOK:
      switch (n) {
        case d.PC.TIKTOK_VERIFIED:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.string(f.t.uv7et7)
          });
          break;
        case d.PC.TIKTOK_FOLLOWER_COUNT:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.formatToPlainString(f.t.qIPDR0, {
              count: l
            })
          });
          break;
        case d.PC.TIKTOK_FOLLOWING_COUNT:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.formatToPlainString(f.t.zRta4e, {
              count: l
            })
          });
          break;
        case d.PC.TIKTOK_LIKES_COUNT:
          o = f.intl.format(o, {
            platformQuantityHook: () => f.intl.formatToPlainString(f.t.ar0WW1, {
              count: l
            })
          });
          break;
...
function b(e) {
  ...
  let f = r.roles.map(e => s[e]).filter(e => {
      var t;
