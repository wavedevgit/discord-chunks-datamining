    ...
    case _.ABu.REDDIT:
      switch (n) {
        case f.PC.CREATED_AT:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.formatToPlainString(p.t.TPbtEh, {
              days: l
            })
          });
          break;
        case f.PC.REDDIT_TOTAL_KARMA:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.formatToPlainString(p.t.P2JAER, {
              karma: l
            })
          });
          break;
        case f.PC.REDDIT_GOLD:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.string(p.t["+/5TCw"])
          });
          break;
        case f.PC.REDDIT_MOD:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.string(p.t["9rPbEh"])
          });
          break;
        default:
          return null
    ...
    case _.ABu.STEAM:
      switch (n) {
        ...
        case f.PC.STEAM_GAME_COUNT:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.formatToPlainString(p.t.H9eLoa, {
              count: l
            })
          });
          break;
        case f.PC.STEAM_ITEM_COUNT_TF2:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.formatToPlainString(p.t.MceZJy, {
              count: l
            })
          });
          break;
        case f.PC.STEAM_ITEM_COUNT_DOTA2:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.formatToPlainString(p.t.dMnRam, {
              count: l
            })
          });
          break;
    ...
    case _.ABu.TWITTER:
      switch (n) {
        ...
        case f.PC.TWITTER_VERIFIED:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.string(p.t.xRygZG)
          });
          break;
        case f.PC.TWITTER_FOLLOWERS_COUNT:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.formatToPlainString(p.t.bkajam, {
              count: l
            })
          });
          break;
    ...
    case _.ABu.PAYPAL:
      switch (n) {
        ...
        case f.PC.PAYPAL_VERIFIED:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.string(p.t.slSQuL)
          });
          break;
        default:
          return null
    ...
    case _.ABu.EBAY:
      switch (n) {
        ...
        case f.PC.EBAY_TOP_RATED_SELLER:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.string(p.t.TEEYwc)
          });
          break;
        case f.PC.EBAY_POSITIVE_FEEDBACK_PERCENTAGE:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.formatToPlainString(p.t.rl9Vg4, {
              value: l
            })
          });
          break;
        case f.PC.EBAY_UNIQUE_POSITIVE_FEEDBACK_COUNT:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.formatToPlainString(p.t.QP5W1d, {
              count: l
            })
          });
          break;
        case f.PC.EBAY_UNIQUE_NEGATIVE_FEEDBACK_COUNT:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.formatToPlainString(p.t["6ZFYdH"], {
              count: l
            })
          });
          break;
    ...
    case _.ABu.TIKTOK:
      switch (n) {
        case f.PC.TIKTOK_VERIFIED:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.string(p.t.uv7et7)
          });
          break;
        case f.PC.TIKTOK_FOLLOWER_COUNT:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.formatToPlainString(p.t.qIPDR0, {
              count: l
            })
          });
          break;
        case f.PC.TIKTOK_FOLLOWING_COUNT:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.formatToPlainString(p.t.zRta4e, {
              count: l
            })
          });
          break;
        case f.PC.TIKTOK_LIKES_COUNT:
          o = p.intl.format(o, {
            platformQuantityHook: () => p.intl.formatToPlainString(p.t.ar0WW1, {
              count: l
            })
          });
          break;
...
function y(e) {
  ...
  let {
    ...
    guildRoles: s,
    channel: d,
    onlyChannelConnectionRoles: f = !1
  } = e;
