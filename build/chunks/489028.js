...
function P(e) {
  ...
  } = (0, b.JH)(), p = (0, j.mY)(), f = i.useMemo(() => n.map(e => ({
    label: e.name,
    value: e.id
  })), [n]), h = async () => {
    await d(t, a, N.wW.GUILD_ROLE_SUBSCRIPTIONS) && (g(t.id), (0, _.B)({
      Icon: C.Z,
...
let w = e => {
  let {
    guild: t
  } = e, n = (0, l.e7)([f.default], () => f.default.getCurrentUser()), c = (0, p.eM)(t, n), b = (0, o.Ob)(t), j = (0, l.e7)([h.Z], () => h.Z.isFocused()), {
    teams: _,
    loading: C
  } = (0, g.Z)({
    ...
    (0, a.Z)(e)
  }, [t, c, b, w]), Z = i.useCallback(e => c ? (0, r.jsx)(u.Z, {
    onClick: R,
    children: e
  }) : e, [R, c]);
  return C ? (0, r.jsx)(s.$jN, {}) : (0, r.jsxs)(r.Fragment, {
    children: [!c && (0, r.jsx)(v.Z, {
      ...
      children: [(0, r.jsx)(s.R94, {
        ...
        disabled: !c,
        children: E.intl.format(E.t["5mfqpa"], {
          onCreateTeamHook: Z
        })
      }), w ? (0, r.jsx)(P, {
        guild: t,
