/** Chunk was on 87955 **/
/** chunk id: 230304, original params: e,t,a (module,exports,require) **/
...
class d {
  start() {
    r.info("ML signal handler started"), Chunk431927.Z.start(this.handleMLResult.bind(this), () => {})
  }
  stop() {
    Chunk431927.Z.stop(), this.emotionHistory = [], this.yellHistory = [], r.info("ML signal handler stopped")
  }
  getState() {
    return {
