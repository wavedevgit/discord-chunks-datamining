...
function R(e) {
  let {
    ...
    isSelected: r,
    disabled: s
  } = e, a = y.ZP.useName(t), d = y.ZP.useUserTag(t, {
    decoration: "never"
  }), c = (0, o.e7)([b.Z], () => b.Z.getNickname(t.id)), g = (0, o.e7)([S.Z], () => S.Z.getStatus(t.id)), m = i.useCallback(() => n(t.id), [n, t.id]);
  return (0, l.jsx)(A, {
    icon: (0, l.jsx)(h.Z, {
      "aria-hidden": !0,
      size: u.EFr.SIZE_32,
...
function M(e) {
  ...
  let {
    ...
    isSelected: a,
    disabled: o
  } = e, d = i.useCallback(() => s(r.id), [s, r.id]), c = null !== (t = (0, v.ZP)(r)) && void 0 !== t ? t : "", h = null !== (n = (0, I._)(r)) && void 0 !== n ? n : "";
  return (0, l.jsx)(A, {
    icon: (0, l.jsx)(x.Z, {
      "aria-hidden": !0,
      size: u.EFr.SIZE_32,
...
function W(e) {
  let {
    ...
    switch (c.type) {
      ...
      case C.bm.DM:
        let h = c.item;
        return a = null !== (i = r.includes(h.id)) && void 0 !== i && i, (0, l.jsx)(R, {
          user: h,
          isSelected: a,
          onToggle: n,
          disabled: o
      ...
      case C.bm.CHANNEL:
        let g = c.item;
        return a = null !== (s = r.includes(g.id)) && void 0 !== s && s, (0, l.jsx)(M, {
          channel: g,
          isSelected: a,
          onToggle: n,
          disabled: o
  ...
  return 0 === t.length ? (0, l.jsx)(u.OZU, {
    children: P.NW.string(P.t.ojoWgY)
  }) : (0, l.jsx)(a.bG, {
    navigator: c,
...
function L(e) {
  let {
    ...
    guild: v,
    inviteChannel: x,
    generateInviteLink: I
  } = e, [S, b] = i.useState(""), y = i.useRef(null), A = i.useRef(null), [R, M] = i.useState(!1), [L, U] = i.useState(!1), D = (0, o.e7)([E.Z], () => E.Z.hideInstantInvites), z = (0, o.e7)([f.Z], () => {
    var e;
    ...
    B("")
  }, [B]), [F, G] = i.useState([]), H = i.useCallback(e => {
    G(t => {
    ...
    let e;
    return null === (e = m && void 0 !== v.vanityURLCode ? v.vanityURLCode : (null == z ? void 0 : z.invite_code) !== void 0 ? z.invite_code : null !== a ? a.code : null) ? null : (0, _.tV)({
      baseCode: e
    })
  }, [m, v, z, a]), Y = i.useCallback(async () => {
    if (L || null === q) return;
    U(!0);
    let e = r.filter(e => F.includes(e.item.id)).map(e => {
      var t;
      let n;
      ...
      children: [(0, l.jsxs)("div", {
        ...
        children: [(0, l.jsx)("div", {
          ...
          children: (0, l.jsxs)(u.X6q, {
            ...
            children: [P.NW.string(P.t.BN75l5), (0, l.jsx)("span", {
          ...
          children: e => (0, l.jsx)(u.zxk, k(O({
            ...
            children: R ? (0, l.jsxs)(l.Fragment, {
              children: [(0, l.jsx)(u.dz2, {
                ...
                children: P.NW.string(P.t.WqhZsr)
              })]
            }) : (0, l.jsxs)(l.Fragment, {
