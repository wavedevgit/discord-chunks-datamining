...
let {
  INVITE_OPTIONS_7_DAYS: en,
  INVITE_OPTIONS_UNLIMITED: el
} = B.ZP, ei = {
  max_age: en.value,
  max_uses: el.value
};
...
function es(e) {
  let {
    ...
    decoration: "never"
  }), [u, d] = (0, c.Wu)([W.Z, L.Z], () => [W.Z.getNickname(t.id), L.Z.getStatus(t.id)], [t]), g = i.useCallback(() => n(t.id), [n, t.id]);
  return (0, l.jsx)(er, {
    icon: (0, l.jsx)(p.Z, {
      "aria-hidden": !0,
      size: h.EFr.SIZE_32,
...
function eo(e) {
  ...
  let {
    ...
    isSelected: a,
    disabled: o
  } = e, u = (0, c.e7)([k.Z], () => k.Z.getGuild(null == r ? void 0 : r.guild_id)), d = i.useCallback(() => s(r.id), [s, r.id]), h = null != (t = (0, _.ZP)(r)) ? t : "", g = null != (n = null == u ? void 0 : u.name) ? n : "";
  return (0, l.jsx)(er, {
    icon: (0, l.jsx)(y.Z, {
      size: y.E.SMALL_32,
      guild: u,
...
function eu(e) {
  let {
    ...
    switch (h.type) {
      ...
      case B.bm.DM:
        let g = h.item;
        return u = null != (i = r.includes(g.id)) && i, (0, l.jsx)(es, {
          user: g,
          isSelected: u,
          onToggle: n,
          disabled: a
      ...
      case B.bm.GROUP_DM:
        let m = h.item;
        return u = null != (s = r.includes(m.id)) && s, (0, l.jsx)(ea, {
          channel: m,
          isSelected: u,
          onToggle: n,
          disabled: a
      ...
      case B.bm.CHANNEL:
        let p = h.item;
        return u = null != (o = r.includes(p.id)) && o, (0, l.jsx)(eo, {
          channel: p,
          isSelected: u,
          onToggle: n,
          disabled: a
  ...
  }, [t, r, n, a]), g = i.useCallback(() => 48, []);
  return 0 === t.length ? (0, l.jsx)(h.OZU, {
    children: $.NW.string($.t.ojoWgY)
  }) : (0, l.jsx)(d.bG, {
    navigator: u,
...
function ed(e) {
  ...
  let y = (0, E.Z)({
    ...
    } = (0, f.ZP)(N.Z.INSTANT_INVITE_MODAL),
    ev = i.useCallback(e => {
      var t;
      null == (t = em.current) || t.scrollTo({
        to: 0
      }), F(e), (0, m.C)(e)
    }, [F]),
    ex = i.useCallback(() => {
  ...
  (0, v.ZP)(() => {
    switch (eP && U.default.track(J.rMx.INVITE_SUGGESTION_OPENED, {
        location: d,
  ...
  let eA = i.useCallback(() => {
    ...
    ew = i.useCallback(async () => {
      ...
      if (e_ && null != r.vanityURLCode) i = r.vanityURLCode;
        ...
        let e = null != (t = R.Z.getInvite(ej.id, {
          targetType: el.target_type,
          targetUserId: el.target_user_id,
          targetApplicationId: el.target_application_id
        })) ? t : null;
        null !== e && (0, z.m)(e, el) || (await g.ZP.createInvite(ej.id, el, d), e = null != (n = R.Z.getInvite(ej.id, {
          targetType: el.target_type,
          targetUserId: el.target_user_id,
          targetApplicationId: el.target_application_id
        })) ? n : null), i = null != (l = null == e ? void 0 : e.code) ? l : null
      }
      return null == i ? null : (ea(!1), (0, G.tV)({
        baseCode: i
      }))
    }, [ej, e_, r, el, d]),
    ek = i.useCallback(async () => {
      ...
      try {
        ...
        let n = eC.filter(e => C.includes(e.item.id)).map(e => {
          var n;
          let l, i = ep[0],
