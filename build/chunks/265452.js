...
function z(e) {
  let {
    ...
    isSelected: s,
    disabled: r
  } = e, a = w.ZP.useName(t), d = w.ZP.useUserTag(t, {
    decoration: "never"
...
function V(e) {
  ...
  return 0 === t.length ? (0, l.jsx)(u.OZU, {
    children: M.NW.string(M.t.ojoWgY)
  }) : (0, l.jsx)(a.bG, {
    navigator: c,
...
function G(e) {
  let {
    ...
    inviteKey: a,
    sending: c
  } = e, [h] = (0, o.Wu)([_.Z], () => [_.Z.hideInstantInvites]), [g, m] = i.useState(!1), v = (0, k.Z)(a), x = h ? M.NW.string(M.t["6HzNgY"]) : v;
        ...
        children: e => (0, l.jsx)(u.zxk, U(L({
          ...
          children: g ? (0, l.jsxs)(l.Fragment, {
            children: [(0, l.jsx)(u.dz2, {
              ...
              children: M.NW.string(M.t.WqhZsr)
            })]
          }) : (0, l.jsxs)(l.Fragment, {
...
function H(e) {
  let {
    ...
    _("")
  }, [_]), [w, k] = i.useState([]), L = i.useCallback(e => {
    k(t => {
    ...
    let e;
    return null === (e = h && void 0 !== m.vanityURLCode ? m.vanityURLCode : (null == D ? void 0 : D.invite_code) !== void 0 ? D.invite_code : null !== a ? a.code : null) ? null : (0, O.tV)({
      baseCode: e
    })
  }, [h, m, D, a]), B = i.useCallback(async () => {
    if (E || null === z) return;
    y(!0);
    let e = s.filter(e => w.includes(e.item.id)).map(e => {
      var t;
      let n;
      ...
      children: [(0, l.jsxs)("div", {
        ...
        children: [(0, l.jsx)("div", {
          ...
          children: (0, l.jsxs)(u.X6q, {
            ...
            children: [M.NW.string(M.t.BN75l5), (0, l.jsx)("span", {
