...
function et(e) {
  let {
    ...
    isSelected: r,
    disabled: s
  } = e, a = L.ZP.useName(t), o = L.ZP.useUserTag(t, {
    decoration: "never"
  }), [u, h] = (0, d.Wu)([k.Z, R.Z], () => [k.Z.getNickname(t.id), R.Z.getStatus(t.id)], [t]), g = i.useCallback(() => n(t.id), [n, t.id]);
  return (0, l.jsx)(ee, {
    icon: (0, l.jsx)(m.Z, {
      "aria-hidden": !0,
      size: c.EFr.SIZE_32,
...
function ei(e) {
  let {
    ...
    scrollerRef: s,
    disabled: a
  } = e, o = i.useMemo(() => [t.length], [t.length]), d = (0, x.Z)("instant_invite_modal", s), h = i.useCallback(e => {
    var i, s, o;
    let u, {
      section: d,
      row: c
    ...
    switch (h.type) {
      ...
      case W.bm.DM:
        let g = h.item;
        return u = null != (i = r.includes(g.id)) && i, (0, l.jsx)(et, {
          user: g,
          isSelected: u,
          onToggle: n,
          disabled: a
      ...
      case W.bm.GROUP_DM:
        let m = h.item;
        return u = null != (s = r.includes(m.id)) && s, (0, l.jsx)(en, {
          channel: m,
          isSelected: u,
          onToggle: n,
          disabled: a
      ...
      case W.bm.CHANNEL:
        let v = h.item;
        return u = null != (o = r.includes(v.id)) && o, (0, l.jsx)(el, {
          channel: v,
          isSelected: u,
          onToggle: n,
          disabled: a
  ...
  return 0 === t.length ? (0, l.jsx)(c.OZU, {
    children: Y.NW.string(Y.t.ojoWgY)
  }) : (0, l.jsx)(u.bG, {
    navigator: d,
...
function er(e) {
  ...
  let b = (0, j.Z)({
    ...
    } = (0, I.ZP)(p.Z.INSTANT_INVITE_MODAL),
    eu = i.useCallback(e => {
      var t;
      null == (t = ea.current) || t.scrollTo({
        to: 0
      }), R(e), (0, g.C)(e)
    }, [R]),
    ed = i.useCallback(() => {
    ...
    {
      canCreateApplicationBypassInvites: eN,
    ...
    eE = i.useCallback(async () => {
      ...
      if (ev && null != r.vanityURLCode) i = r.vanityURLCode;
        ...
        let e = null != (t = Z.Z.getInvite(em.id, {
          targetType: L.target_type,
          targetUserId: L.target_user_id,
          targetApplicationId: L.target_application_id
        })) ? t : null;
        null !== e && (0, D.m)(e, L) || (await h.ZP.createInvite(em.id, L, u), e = null != (n = Z.Z.getInvite(em.id, {
          targetType: L.target_type,
          targetUserId: L.target_user_id,
          targetApplicationId: L.target_application_id
        })) ? n : null), i = null != (l = null == e ? void 0 : e.code) ? l : null
      }
      return null == i ? null : (ee(!1), (0, V.tV)({
        baseCode: i
      }))
    }, [em, ev, r, L, u]),
