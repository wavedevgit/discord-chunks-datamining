...
function Q(e) {
  let {
    ...
    isSelected: s,
    disabled: r
  } = e, a = M.ZP.useName(t), d = M.ZP.useUserTag(t, {
    decoration: "never"
  }), [c, h] = (0, o.Wu)([w.Z, A.Z], () => [w.Z.getNickname(t.id), A.Z.getStatus(t.id)], [t]), m = i.useCallback(() => n(t.id), [n, t.id]);
  return (0, l.jsx)(J, {
    icon: (0, l.jsx)(g.Z, {
      "aria-hidden": !0,
      size: u.EFr.SIZE_32,
...
function $(e) {
  ...
  let {
    ...
    isSelected: a,
    disabled: o
  } = e, d = i.useCallback(() => r(s.id), [r, s.id]), c = null != (t = (0, I.ZP)(s)) ? t : "", h = null != (n = (0, T._)(s)) ? n : "";
  return (0, l.jsx)(J, {
    icon: (0, l.jsx)(j.Z, {
      "aria-hidden": !0,
      size: u.EFr.SIZE_32,
...
function ee(e) {
  ...
  let {
    ...
    isSelected: a,
    disabled: d
  } = e, u = (0, o.e7)([y.Z], () => y.Z.getGuild(null == s ? void 0 : s.guild_id)), c = i.useCallback(() => r(s.id), [r, s.id]), h = null != (t = (0, I.ZP)(s)) ? t : "", g = null != (n = null == u ? void 0 : u.name) ? n : "";
  return (0, l.jsx)(J, {
    icon: (0, l.jsx)(E.Z, {
      size: E.E.SMALL_32,
      guild: u,
...
function et(e) {
  let {
    ...
    switch (h.type) {
      ...
      case R.bm.DM:
        let g = h.item;
        return d = null != (i = s.includes(g.id)) && i, (0, l.jsx)(Q, {
          user: g,
          isSelected: d,
          onToggle: n,
          disabled: o
      ...
      case R.bm.GROUP_DM:
        let m = h.item;
        return d = null != (r = s.includes(m.id)) && r, (0, l.jsx)($, {
          channel: m,
          isSelected: d,
          onToggle: n,
          disabled: o
      ...
      case R.bm.CHANNEL:
        let x = h.item;
        return d = null != (a = s.includes(x.id)) && a, (0, l.jsx)(ee, {
          channel: x,
          isSelected: d,
          onToggle: n,
          disabled: o
  ...
  return 0 === t.length ? (0, l.jsx)(u.OZU, {
    children: z.NW.string(z.t.ojoWgY)
  }) : (0, l.jsx)(a.bG, {
    navigator: c,
...
function en(e) {
  ...
  let [E, T] = i.useState([]), [y, A] = i.useState(""), [w, M] = i.useState(q({}, X, null == I ? {} : {
    ...
    var t;
    null == (t = ee.current) || t.scrollTo({
      to: 0
    }), A(e), (0, h.C)(e)
  }, [A]), ei = i.useCallback(() => {
    el("")
  }, [el]), es = i.useCallback(e => M(t => q({}, t, e)), [M]), er = i.useCallback(() => {
    T([]), M(q({}, X)), ei(), K(!1), Q(null)
  }, [ei]), ea = i.useCallback(e => {
    T(t => {
  ...
  }, [s.id, a]), ed = (0, o.e7)([Z.Z], () => null != eo && Z.Z.can(F.Plq.CREATE_INSTANT_INVITE, eo), [eo]), eu = (0, o.e7)([O.Z], () => {
  ...
  }, [eo, j, x, I, J]), ec = !ed && !(null == eo ? void 0 : eo.isGuildVocal()) && void 0 !== s.vanityURLCode, eh = null === eu || !ed, eg = (0, N.Z)(eo), em = (null == eo ? void 0 : eo.type) === F.d4z.GUILD_VOICE && !ec && !eh && !eg, {
    enabled: ex
  } = S.o.useExperiment({
    guildId: s.id,
    ...
    var e;
    let t, n = null != (e = b.Z.getStageInstanceByChannel(null == eo ? void 0 : eo.id)) ? e : null;
    return null === (t = ec && null != s.vanityURLCode ? s.vanityURLCode : (null == n ? void 0 : n.invite_code) != null ? n.invite_code : null != eu ? eu.code : null) ? null : (0, W.tV)({
      baseCode: t
    })
  }, [ec, s, eu, eo]), ej = i.useCallback(() => {
    let e = null == eo ? void 0 : eo.id;
    (0, d.Z)(w, X) && ec || null != e && c.ZP.createInvite(e, w, g).catch(e => {
      Q(e)
    })
  }, [eo, w, ec, g]), eS = i.useCallback(() => {
    er(), n()
  }, [er, n]), eE = i.useCallback(async () => {
    if (Y || null === ef) return;
    K(!0);
    let e = eI.filter(e => E.includes(e.item.id)).map(e => {
      var t;
      let n, l = F.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
