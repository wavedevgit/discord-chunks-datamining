...
function es(e) {
  ...
  let {
    ...
    isSelected: a,
    disabled: o
  } = e, u = (0, c.e7)([M.Z], () => M.Z.getGuild(null == r ? void 0 : r.guild_id)), d = i.useCallback(() => s(r.id), [s, r.id]), g = null != (t = (0, _.ZP)(r)) ? t : "", h = null != (n = null == u ? void 0 : u.name) ? n : "";
  return (0, l.jsx)(el, {
    icon: (0, l.jsx)(y.Z, {
      size: y.E.SMALL_32,
      guild: u,
