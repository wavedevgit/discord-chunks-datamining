...
function B(e) {
  let {
    ...
    isSelected: r,
    disabled: s
  } = e, a = O.ZP.useName(t), d = O.ZP.useUserTag(t, {
    decoration: "never"
  }), [c, g] = (0, o.Wu)([y.Z, E.Z], () => [y.Z.getNickname(t.id), E.Z.getStatus(t.id)], [t]), m = i.useCallback(() => n(t.id), [n, t.id]);
  return (0, l.jsx)(z, {
    icon: (0, l.jsx)(h.Z, {
      "aria-hidden": !0,
      size: u.EFr.SIZE_32,
...
function V(e) {
  ...
  let {
    ...
    isSelected: a,
    disabled: o
  } = e, d = i.useCallback(() => s(r.id), [s, r.id]), c = null !== (t = (0, v.ZP)(r)) && void 0 !== t ? t : "", h = null !== (n = (0, f._)(r)) && void 0 !== n ? n : "";
  return (0, l.jsx)(z, {
    icon: (0, l.jsx)(N.Z, {
      "aria-hidden": !0,
      size: u.EFr.SIZE_32,
...
function F(e) {
  let {
    ...
    scrollerRef: s,
    disabled: o
  } = e, d = i.useMemo(() => [t.length], [t.length]), c = (0, m.Z)("instant_invite_modal", s), h = i.useCallback(e => {
    var i, s;
    let a, {
      section: d,
      row: u
    ...
    switch (c.type) {
      ...
      case w.bm.DM:
        let h = c.item;
        return a = null !== (i = r.includes(h.id)) && void 0 !== i && i, (0, l.jsx)(B, {
          user: h,
          isSelected: a,
          onToggle: n,
          disabled: o
      ...
      case w.bm.CHANNEL:
        let g = c.item;
        return a = null !== (s = r.includes(g.id)) && void 0 !== s && s, (0, l.jsx)(V, {
          channel: g,
          isSelected: a,
          onToggle: n,
          disabled: o
  ...
  return 0 === t.length ? (0, l.jsx)(u.OZU, {
    children: W.NW.string(W.t.ojoWgY)
  }) : (0, l.jsx)(a.bG, {
    navigator: c,
...
function G(e) {
  ...
  } else d = n.name, c = null === s ? null : (0, l.jsxs)("div", {
...
function H(e) {
  let {
    ...
    inviteKey: a,
    sending: c
  } = e, [h] = (0, o.Wu)([_.Z], () => [_.Z.hideInstantInvites]), [g, m] = i.useState(!1), v = i.useRef(null), x = (0, A.Z)(a), N = h ? W.NW.string(W.t["6HzNgY"]) : x, I = i.useCallback(() => (m(!0), (0, P.JG)(x), v.current = setTimeout(() => {
    m(!1)
  }, 1e3), () => {
        ...
        children: e => (0, l.jsx)(u.zxk, D(U({
          ...
          children: g ? (0, l.jsxs)(l.Fragment, {
            children: [(0, l.jsx)(u.dz2, {
              ...
              children: W.NW.string(W.t["+5kSoa"])
            })]
          }) : (0, l.jsxs)(l.Fragment, {
            children: [(0, l.jsx)(u.xPt, {
              ...
              children: W.NW.string(W.t.WqhZsr)
            })]
          })
        }))
      }), (0, l.jsxs)(u.zxk, {
...
function q(e) {
  let {
    ...
    guild: m,
    channel: v,
    generateInviteLink: x
  } = e, [p, N] = i.useState(""), I = i.useRef(null), f = i.useRef(null), [E, y] = i.useState(!1), _ = i.useCallback(e => {
    var t;
    null === (t = f.current) || void 0 === t || t.scrollTo({
      to: 0
    }), N(e), (0, c.C)(e)
  }, [N]), Z = i.useCallback(() => {
    _("")
  }, [_]), [P, O] = i.useState([]), A = i.useCallback(e => {
    O(t => {
    ...
    let e;
    return null === (e = h && void 0 !== m.vanityURLCode ? m.vanityURLCode : (null == D ? void 0 : D.invite_code) !== void 0 ? D.invite_code : null !== a ? a.code : null) ? null : (0, k.tV)({
      baseCode: e
    })
  }, [h, m, D, a]), B = i.useCallback(async () => {
    if (E || null === z) return;
    y(!0);
    let e = r.filter(e => P.includes(e.item.id)).map(e => {
      var t;
      let n;
  ...
  if (i.useEffect(() => {
      !h && d && x()
    }, [U, h, d, x]), null !== z && null !== U) return (0, l.jsxs)(u.Y0X, {
    className: s()(L.modal, {
      [L.disabled]: E
    }),
    transitionState: t,
      ...
      children: [(0, l.jsxs)("div", {
        ...
        children: [(0, l.jsx)("div", {
          ...
          children: (0, l.jsxs)(u.X6q, {
            ...
            children: [W.NW.string(W.t.BN75l5), (0, l.jsx)("span", {
              children: null === a && "No Invite Key"
            }), (0, l.jsx)("span", {
              children: null === a && "No Invite"
            })]
          })
        }), (0, l.jsx)(u.olH, {
