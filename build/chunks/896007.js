...
function p(e) {
  ...
  }), N.push(m(u.pNK.PROFILE, y)), N.push(m(u.pNK.TAG, y)), N.push(m(u.pNK.ENGAGEMENT, y)), N.push(m(u.pNK.BOOST_PERKS, y)), O && (N.push({
    section: g.DIVIDER
  }), N.push({
    section: g.HEADER,
  ...
  }), N.push(m(u.pNK.MEMBERS, y)), N.push(m(u.pNK.ROLES, y)), N.push(m(u.pNK.INVITES, y)), N.push(m(u.pNK.ACCESS, y))), N.push({
    section: g.DIVIDER
  }), N.push({
    section: g.HEADER,
  ...
  }), N.push(m(u.pNK.SAFETY, y)), N.push(m(u.pNK.MODERATION, y)), N.push(m(u.pNK.AUDIT_LOG, y)), N.push(m(u.pNK.BANS, y)), N.push(m(u.pNK.GUILD_AUTOMOD, y)));
  let E = c.hasFeature(u.oNc.COMMUNITY) && j,
    S = C();
  return (p || E || S) && (N.push({
    section: g.DIVIDER
  }), N.push(m(u.pNK.COMMUNITY, y)), N.push(m(u.pNK.ONBOARDING, y)), N.push(m(u.pNK.ANALYTICS, y)), N.push(m(u.pNK.COMMUNITY_WELCOME, y)), N.push(m(u.pNK.DISCOVERY_LANDING_PAGE, y)), N.push(m(u.pNK.ROLE_SUBSCRIPTIONS, y)), N.push(m(u.pNK.GUILD_PRODUCTS, y)), N.push(m(u.pNK.ROLE_SUBSCRIPTIONS_STORE_PAGE, y))), N.push({
    section: g.DIVIDER
