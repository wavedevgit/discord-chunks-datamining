...
function f(e) {
  ...
  }), N.push(g(d.pNK.INTEGRATIONS, E)), N.push(g(d.pNK.APP_DIRECTORY, E));
  ...
  return (f || S || T) && (N.push({
    section: p
  }), N.push(g(d.pNK.COMMUNITY, E)), N.push(g(d.pNK.ONBOARDING, E)), N.push(g(d.pNK.ANALYTICS, E)), N.push(g(d.pNK.COMMUNITY_WELCOME, E)), N.push(g(d.pNK.DISCOVERY_LANDING_PAGE, E)), N.push(g(d.pNK.ROLE_SUBSCRIPTIONS, E)), N.push(g(d.pNK.GUILD_PRODUCTS, E)), N.push(g(d.pNK.ROLE_SUBSCRIPTIONS_STORE_PAGE, E))), N.push({
    section: p
  }), N.push(g(d.pNK.GUILD_PREMIUM, E)), N.push(g(d.pNK.GUILD_TEMPLATES, E)), N.push(g(d.pNK.DELETE, E)), N.filter(o.lm)
}
let h = {
  generateSections: f
}