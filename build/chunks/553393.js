...
function Z(e) {
  ...
  }), X = (0, T.tP)(v), Q = (null == v || null == (t = v.userStatus) ? void 0 : t.claimedAt) != null, J = (null == v || null == (m = v.userStatus) ? void 0 : m.enrolledAt) != null, $ = (null == v || null == (g = v.userStatus) ? void 0 : g.completedAt) != null, ee = (0, s.e7)([E.Z], () => E.Z.getState().theme), et = (0, l.wj)(ee) ? x.BR.DARK : x.BR.LIGHT, en = (0, s.e7)([h.Z], () => h.Z.useReducedMotion), {
    ref: er,
    height: ei
  } = (0, _.ZP)(), [ea, eo] = i.useState(en), es = (0, p.Aq)(), el = (0, o.eg)(), ec = (0, A.up)(D.dr.MEMBERS_LIST);
  i.useEffect(() => {
    let e = el.current;
      ...
      F(j, z) && null != z ? ((0, I._3)({
        ...
        return t => (0, r.jsx)(e, U({
          ...
          onConfirm: () => ((0, I._3)({
            ...
            trackGuildAndChannelMetadata: !0,
            sourceQuestContent: S.jn.MEMBERS_LIST
          }), d.default.selectVoiceChannel(z.id), (0, f.iV)(j))
        }, t))
      })) : eh()
    },
    eE = $ && !Q ? {
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(u.X6q, {
            ...
            children: [(0, r.jsx)(u.Text, {
              ...
              children: k.intl.format(k.t["Lm8/mJ"], {
          ...
          children: (0, r.jsxs)("div", {
            ...
            }), "reward" === eE.tileAssetType && (0, r.jsx)(R.Z, {
              className: M.assetTile,
              quest: v,
              questContent: S.jn.MEMBERS_LIST,
              learnMoreStyle: "icon",
