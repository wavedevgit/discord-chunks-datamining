...
let v = {
  async handleVoiceConnect(e) {
    ...
    return ((0, l.Fd)(new Set([...R, ...P])) && (S = !0), S || v || s || !(R.size > 0) && !(P.size > 0)) ? !T && !v && (0, m._)(t) ? new Promise(e => {
      (0, i.ZDy)(async () => {
        let {
          default: i
    ...
    }) : (v || s || a.default.selectVoiceChannel(t.id), !__OVERLAY__ && (s || w || b || I) && O(t, A), !0) : new Promise(e => {
      (0, i.ZDy)(async () => {
        let {
          default: i
