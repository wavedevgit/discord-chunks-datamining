...
let v = {
  async handleVoiceConnect(e) {
    ...
    return ((0, l.Fd)(new Set([...P, ...w])) && (S = !0), S || v || s || !(P.size > 0) && !(w.size > 0)) ? !T && !v && (0, m._)(t) ? new Promise(e => {
      (0, i.ZDy)(async () => {
        let {
          default: i
    ...
    }) : (v || s || o.default.selectVoiceChannel(t.id), !__OVERLAY__ && (s || R || b || I) && O(t, A), !0) : new Promise(e => {
      (0, i.ZDy)(async () => {
        let {
          default: i
