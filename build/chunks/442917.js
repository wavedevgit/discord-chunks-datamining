...
class ep extends i.PureComponent {
  ...
  render() {
    let {
      ...
      isVideoEnabled: i,
      width: o
    } = this.props, a = (0, I.F6)(e, H.default, Z.Z), s = (null == n ? void 0 : n.id) === V.default.getId() && i, l = this.renderStreamState(), c = this.activeStreamForSelectedParticipant, u = null;
