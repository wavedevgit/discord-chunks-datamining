...
class ep extends i.PureComponent {
  ...
  render() {
    let {
      ...
      isVideoEnabled: i,
      width: o
    } = this.props, a = (0, I.F6)(e, H.default, V.Z), s = (null == n ? void 0 : n.id) === Z.default.getId() && i, l = this.renderStreamState(), c = this.activeStreamForSelectedParticipant, u = null;
    return (null == n ? void 0 : n.type) !== es.fO.ACTIVITY && (null != l ? u = l : ((null == n ? void 0 : n.type) === es.fO.USER || (null == n ? void 0 : n.type) === es.fO.STREAM) && (u = (0, r.jsx)(Q.Z, {
