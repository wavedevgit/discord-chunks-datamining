...
class ef extends i.PureComponent {
  ...
  componentDidMount() {
    ...
    Y.default.track(ei.rMx.VIDEO_LAYOUT_TOGGLED, ec({
      video_layout: "pip"
    }, (0, g.AB)(e.id)))
  }
  ...
  renderStreamState() {
    ...
    if (null != o) {
      if ((null == t ? void 0 : t.type) === eo.fO.STREAM) return (0, r.jsx)(X.Z, {
        stream: t.stream,
        width: n,
        avError: o
      });
      if ((null == t ? void 0 : t.type) === eo.fO.USER) return (0, r.jsx)(ee.Z, {
        userId: t.user.id,
        width: n,
        avError: o
      })
  ...
  render() {
    let {
      ...
      isVideoEnabled: i,
      width: o
    } = this.props, a = (0, O.F6)(e, V.default, F.Z), s = (null == n ? void 0 : n.id) === G.default.getId() && i, l = this.renderStreamState(), c = null;
    return (null == n ? void 0 : n.type) !== eo.fO.ACTIVITY && (null != l ? c = l : ((null == n ? void 0 : n.type) === eo.fO.USER || (null == n ? void 0 : n.type) === eo.fO.STREAM) && (c = (0, r.jsx)(q.Z, {
  ...
  constructor(...e) {
    super(...e), el(this, "state", {
    ...
    }), el(this, "renderDisconnectButton", () => (0, r.jsx)(x.Z, {
      ...
      return a()((0, eo._5)(e) || (null == e ? void 0 : e.type) === eo.fO.ACTIVITY, "Cannot render participants for participant type ".concat(null == e ? void 0 : e.type)), (0, r.jsx)(D.Z, {
      ...
      return null == n || n.state === ei.jm8.ENDED ? null : (0, r.jsx)(j.Z, {
        stream: n,
        className: ea.rightTrayIcon,
...
function e_(e) {
  let {
    channel: t,
    width: n
  } = e, i = (0, c.e7)([Z.Z], () => Z.Z.getSpeaker(t.id)), o = (0, c.e7)([E.Z], () => E.Z.getParticipant(t.id, i), [t.id, i]), a = (0, c.e7)([B.Z], () => l()(B.Z.getVideoDevices()).values().first()), s = (0, c.e7)([H.Z], () => null != o && o.type !== eo.fO.ACTIVITY && o.type !== eo.fO.HIDDEN_STREAM ? H.Z.getStreamId(o.user.id, t.getGuildId(), (0, b.Z)(o.type)) : null, [o, t]), u = null == a || a.disabled, d = !u, f = (0, c.e7)([B.Z], () => !u && B.Z.isVideoEnabled(), [u]), _ = (0, c.e7)([B.Z], () => (0, T.Z)(B.Z)), p = (0, c.e7)([G.default], () => G.default.getId()), h = (0, c.e7)([U.Z], () => U.Z.getCurrentUserActiveStream()), m = (0, I.Z)(null != o ? o : void 0), g = (0, c.Wu)([U.Z], () => U.Z.getAllActiveStreams());
  return (0, r.jsx)(ef, {
    channel: t,
    streamId: s,
