...
class ep extends i.PureComponent {
  get viewProperties() {
    let {
      ...
      currentUserId: t,
      channel: n
    } = this.props, r = (0, es._5)(e), i = null != e && e.type !== es.fO.ACTIVITY && e.user.id === t;
    return {
      canPopout: r && !i,
      canSettings: r && i,
      canStopStream: r,
  ...
  componentDidMount() {
    ...
    z.default.track(ea.rMx.VIDEO_LAYOUT_TOGGLED, ed({
      video_layout: "pip"
    }, (0, E.AB)(e.id)))
  }
  ...
  renderStreamState() {
    ...
    if (null != o && null == a) {
      if ((null == t ? void 0 : t.type) === es.fO.STREAM) return (0, r.jsx)($.Z, {
        stream: t.stream,
        width: n,
        avError: o
      });
      else if ((null == t ? void 0 : t.type) === es.fO.USER) return (0, r.jsx)(en.Z, {
        userId: t.user.id,
        width: n,
        avError: o
      })
  ...
  render() {
    let {
      ...
      isVideoEnabled: i,
      width: o
    } = this.props, a = (0, I.F6)(e, H.default, Z.Z), s = (null == n ? void 0 : n.id) === F.default.getId() && i, l = this.renderStreamState(), c = this.activeStreamForSelectedParticipant, u = null;
  ...
  constructor(...e) {
    super(...e), eu(this, "state", {
      ...
      return a()((0, es._5)(e) || (null == e ? void 0 : e.type) === es.fO.ACTIVITY, "Cannot render participants for participant type ".concat(null == e ? void 0 : e.type)), (0, r.jsx)(x.Z, {
...
function eh(e) {
  let {
    channel: t,
    width: n
  } = e, i = (0, c.e7)([Y.Z], () => Y.Z.getSpeaker(t.id)), o = (0, c.e7)([b.Z], () => b.Z.getParticipant(t.id, i), [t.id, i]), a = (0, c.e7)([V.Z], () => l()(V.Z.getVideoDevices()).values().first()), s = (0, c.e7)([W.Z], () => null != o && o.type !== es.fO.ACTIVITY && o.type !== es.fO.HIDDEN_STREAM ? W.Z.getStreamId(o.user.id, t.getGuildId(), (0, y.Z)(o.type)) : null, [o, t]), d = null == a || a.disabled, f = !d, _ = (0, c.e7)([V.Z], () => !d && V.Z.isVideoEnabled(), [d]), p = (0, c.e7)([V.Z], () => (0, N.Z)(V.Z)), h = (0, c.e7)([F.default], () => F.default.getId()), m = (0, c.e7)([B.Z], () => B.Z.getCurrentUserActiveStream()), g = null != o && "user" in o ? o.user.id : "", E = (0, T.Z)((null == o ? void 0 : o.type) === es.fO.STREAM ? u.Yn.STREAM : u.Yn.DEFAULT, g), O = (0, S.Z)(g), v = (0, c.Wu)([B.Z], () => B.Z.getAllActiveStreams());
  return (0, r.jsx)(ep, {
    channel: t,
    streamId: s,
