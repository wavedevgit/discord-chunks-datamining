...
class el extends i.PureComponent {
  ...
  componentWillUnmount() {
    ...
    Z.default.track(ee.rMx.VIDEO_LAYOUT_TOGGLED, eo({
      video_layout: m.Z.getLayout(e.id)
    }, (0, g.AB)(e.id)))
  }
  renderStreamState() {
  ...
  constructor(...e) {
    super(...e), ei(this, "state", {
      ...
      (0, A.XU)(n, t.id), _.Z.channelListScrollTo(n, t.id);
...
let ec = c.ZP.connectStores([j.Z, B.Z, m.Z, k.default, M.Z, V.Z, F.Z], e => {
  let {
    channel: t
  } = e, n = B.Z.getSpeaker(t.id), r = m.Z.getParticipant(t.id, n), i = l()(j.Z.getVideoDevices()).values().first(), o = null == i || i.disabled, a = null != r && r.type !== et.fO.ACTIVITY && r.type !== et.fO.HIDDEN_STREAM ? V.Z.getStreamId(r.user.id, t.getGuildId(), (0, E.Z)(r.type)) : null, s = !1 === o, c = !o && j.Z.isVideoEnabled(), u = (0, O.Z)(j.Z), d = k.default.getId(), f = M.Z.getCurrentUserActiveStream(), _ = !1;
  return {
    channel: t,
    streamId: a,
