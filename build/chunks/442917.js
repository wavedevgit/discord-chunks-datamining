...
class ep extends i.PureComponent {
  ...
  componentDidMount() {
    ...
    z.default.track(eo.rMx.VIDEO_LAYOUT_TOGGLED, ed({
      video_layout: "pip"
    }, (0, E.AB)(e.id)))
  }
  ...
  renderStreamState() {
    ...
    if (null != a && null == o) {
      if ((null == t ? void 0 : t.type) === es.fO.STREAM) return (0, r.jsx)(J.Z, {
        stream: t.stream,
        width: n,
        avError: a
      });
  ...
  render() {
    let {
      ...
      isVideoEnabled: i,
      width: a
    } = this.props, o = (0, I.F6)(e, H.default, V.Z), s = (null == n ? void 0 : n.id) === Z.default.getId() && i, l = this.renderStreamState(), c = this.activeStreamForSelectedParticipant, u = null;
  ...
  constructor(...e) {
    super(...e), eu(this, "state", {
    ...
    }), eu(this, "renderDisconnectButton", () => (0, r.jsx)(j.Z, {
      ...
      return o()((0, es._5)(e) || (null == e ? void 0 : e.type) === es.fO.ACTIVITY, "Cannot render participants for participant type ".concat(null == e ? void 0 : e.type)), (0, r.jsx)(x.Z, {
    ...
    }), eu(this, "renderPopoutIcon", () => (0, r.jsx)(M.Z, {
      className: el.rightTrayIcon,
      popoutOpen: !1,
      ...
      return null == n || n.state === eo.jm8.ENDED ? null : (0, r.jsx)(G.Z, {
        stream: n,
        className: el.rightTrayIcon,
