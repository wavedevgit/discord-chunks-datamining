...
class e_ extends i.PureComponent {
  get viewProperties() {
    let {
      ...
      currentUserId: t,
      channel: n
    } = this.props, r = (0, eo._5)(e), i = null != e && e.type !== eo.fO.ACTIVITY && e.user.id === t;
    return {
      canPopout: r && !i,
      canSettings: r && i,
      canStopStream: r,
  ...
  componentDidMount() {
    ...
    K.default.track(ea.rMx.VIDEO_LAYOUT_TOGGLED, eu({
      video_layout: "pip"
    }, (0, E.AB)(e.id)))
  }
  ...
  renderStreamState() {
    ...
    if (null != a) {
      if ((null == t ? void 0 : t.type) === eo.fO.STREAM) return (0, r.jsx)(J.Z, {
        stream: t.stream,
        width: n,
        avError: a
      });
      else if ((null == t ? void 0 : t.type) === eo.fO.USER) return (0, r.jsx)(et.Z, {
        userId: t.user.id,
        width: n,
        avError: a
      })
  ...
  render() {
    let {
      ...
      isVideoEnabled: i,
      width: a
    } = this.props, o = (0, I.F6)(e, Z.default, V.Z), s = (null == n ? void 0 : n.id) === B.default.getId() && i, l = this.renderStreamState(), c = this.activeStreamForSelectedParticipant, u = null;
    return (null == n ? void 0 : n.type) !== eo.fO.ACTIVITY && (null != l ? u = l : ((null == n ? void 0 : n.type) === eo.fO.USER || (null == n ? void 0 : n.type) === eo.fO.STREAM) && (u = (0, r.jsx)(Q.Z, {
  ...
  constructor(...e) {
    super(...e), ec(this, "state", {
      screensharePopoutOpen: !1
    }), ec(this, "_ref", i.createRef()), ec(this, "handleVideo", e => {
    ...
    }), ec(this, "renderDisconnectButton", () => (0, r.jsx)(M.Z, {
      ...
      return o()((0, eo._5)(e) || (null == e ? void 0 : e.type) === eo.fO.ACTIVITY, "Cannot render participants for participant type ".concat(null == e ? void 0 : e.type)), (0, r.jsx)(L.Z, {
    ...
    }), ec(this, "renderPopoutIcon", () => (0, r.jsx)(k.Z, {
      className: es.rightTrayIcon,
      popoutOpen: !1,
      ...
      return null == n || n.state === ea.jm8.ENDED ? null : (0, r.jsx)(U.Z, {
        stream: n,
        className: es.rightTrayIcon,
...
function ep(e) {
  let {
    channel: t,
    width: n
  } = e, i = (0, c.e7)([H.Z], () => H.Z.getSpeaker(t.id)), a = (0, c.e7)([b.Z], () => b.Z.getParticipant(t.id, i), [t.id, i]), o = (0, c.e7)([F.Z], () => l()(F.Z.getVideoDevices()).values().first()), s = (0, c.e7)([W.Z], () => null != a && a.type !== eo.fO.ACTIVITY && a.type !== eo.fO.HIDDEN_STREAM ? W.Z.getStreamId(a.user.id, t.getGuildId(), (0, y.Z)(a.type)) : null, [a, t]), d = null == o || o.disabled, f = !d, _ = (0, c.e7)([F.Z], () => !d && F.Z.isVideoEnabled(), [d]), p = (0, c.e7)([F.Z], () => (0, N.Z)(F.Z)), h = (0, c.e7)([B.default], () => B.default.getId()), m = (0, c.e7)([G.Z], () => G.Z.getCurrentUserActiveStream()), g = (0, S.Z)((null == a ? void 0 : a.type) === eo.fO.STREAM ? u.Yn.STREAM : u.Yn.DEFAULT, null != a && "user" in a ? a.user.id : ""), E = (0, c.Wu)([G.Z], () => G.Z.getAllActiveStreams());
  return (0, r.jsx)(e_, {
    channel: t,
    streamId: s,
