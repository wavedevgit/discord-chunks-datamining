...
class e_ extends i.PureComponent {
  ...
  componentDidMount() {
    ...
    K.default.track(eo.rMx.VIDEO_LAYOUT_TOGGLED, eu({
      video_layout: "pip"
    }, (0, E.AB)(e.id)))
  }
  ...
  renderStreamState() {
    ...
    if (null != o) {
      if ((null == t ? void 0 : t.type) === ea.fO.STREAM) return (0, r.jsx)(J.Z, {
        stream: t.stream,
        width: n,
        avError: o
      });
  ...
  render() {
    let {
      ...
      isVideoEnabled: i,
      width: o
    } = this.props, a = (0, I.F6)(e, Z.default, V.Z), s = (null == n ? void 0 : n.id) === B.default.getId() && i, l = this.renderStreamState(), c = null;
    return (null == n ? void 0 : n.type) !== ea.fO.ACTIVITY && (null != l ? c = l : ((null == n ? void 0 : n.type) === ea.fO.USER || (null == n ? void 0 : n.type) === ea.fO.STREAM) && (c = (0, r.jsx)(Q.Z, {
  ...
  constructor(...e) {
    super(...e), ec(this, "state", {
      ...
      return null == n || n.state === eo.jm8.ENDED ? null : (0, r.jsx)(U.Z, {
        stream: n,
        className: es.rightTrayIcon,
