...
n.d(t, {
  Z: () => f
}), n(361932), n(187205), n(49124), n(388685), n(539854);
var r = n(255367),
  l = n(73800),
  i = n(481060),
  o = n(259580),
...
function f(e) {
  ...
  }, p = l.useMemo(() => null == t || 0 === t.length ? [] : t.flatMap(e => {
    let t = (0, c.z)(e);
    return null != t ? [{
      tag: e,
      metadata: t
    }] : []
  }), [JSON.stringify(t)]), [m, g] = l.useState([]), [b, h] = l.useState(296), [j, y] = l.useState(!1), x = l.useRef(null), O = l.useRef(0);
  l.useLayoutEffect(() => {
    O.current = 0
  }, [JSON.stringify(t)]);
  let v = l.useRef(null);
  ...
  return (0, r.jsxs)("div", {
    ...
    }), m.length < p.length ? j ? (0, r.jsx)(i.DY3, {
