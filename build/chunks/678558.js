...
let w = e => {
  let {
    ...
    fractionalState: H
  } = (0, f.Z)(), W = (0, p.y)("guild_boosting_subscribe_button", Z, H);
  g.Z.hasFetched || (0, c.X8)();
  let Y = (0, b.vx)(g.Z.boostSlots),
    K = null != A ? Math.max((0, b.KK)(a, A), 1) : 1,
    z = (0, b.aq)({
  ...
  return (($ = null !== Q && !(Y.length > 0) && (null == Q ? void 0 : Q.isPausedOrPausePending) && (H === O.a$.NONE || J)) && (X = (0, r.jsxs)("div", {
    className: S.button,
    ...
    text: z,
    "aria-label": !1,
    children: e => (0, r.jsx)(l.gtL, C(N(C(N({}, e), {
      disabled: !0,
