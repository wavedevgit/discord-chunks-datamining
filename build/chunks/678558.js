...
let D = e => {
  ...
  } = (0, _.ZP)(), V = (0, d.bp)() === v.IlC.POPOUT, [F, Z] = i.useState(!1), H = (0, s.e7)([g.default], () => g.default.getCurrentUser()), {
    fractionalState: Y
  } = (0, f.Z)(), W = (0, h.y)("guild_boosting_subscribe_button", H, Y), K = (0, s.e7)([E.Z], () => E.Z.hasFetched);
  i.useEffect(() => {
    K || (0, u.X8)()
  }, [K]);
