...
let P = (0, Chunk624138.Mg)(Chunk477690.Z.STICKERS_CONSTANTS_STICKER_CATEGORY_LIST_PADDING),
  ...
  B = e => {
    let {
      ...
      let f, g = (null == (c = n[0]) ? true : c.type) === b.Ih.FAVORITE,
        ...
        P = n.length > 0,
        D = n.length;
      if (0 === o && g) return <div role={"listitem"} aria-setsize={D} aria-posinset={o}><l.P3F aria-label={T.intl.string(T.t.y3LQCA)} className={a()(S.stickerCategory, S.stickerCategoryGeneric, {
            [S.stickerCategoryGenericDisabled]: P && !g,
            [S.stickerCategoryGenericSelected]: !m && g && 0 === t,
            [S.stickerCategoryGenericLast]: !C
          })} onClick={s}><l.r7p size={"custom"} color={"currentColor"} className={S.stickerCategoryGenericIcon} height={L} width={L} /></l.P3F></div>;
      if (o === A && C) return <div role={"listitem"} aria-setsize={D} aria-posinset={o}><l.P3F aria-label={T.intl.string(T.t.RxAmVF)} className={a()(S.stickerCategory, S.stickerCategoryGeneric, S.stickerCategoryGenericLast, {
            [S.stickerCategoryGenericDisabled]: P && !C,
            [S.stickerCategoryGenericSelected]: !m && C && t === A
          })} onClick={s}><l.T39 size={"custom"} color={"currentColor"} className={S.stickerCategoryGenericIcon} height={L} width={L} /></l.P3F></div>;
      let x = t === o,
        M = n[o],
        k = n[o + 1],
      ...
      if (M.type === b.Ih.GUILD || M.type === b.Ih.EMPTY_GUILD_UPSELL) {
        ...
        null != e && (f = e.id, G = e.name, B = <u.Z guild={e} isSelected={x} />)
      } else if (U) {
        let e = E.Z.getStickerPack(M.id);
        null != e && (G = e.name, B = <O.Z disableAnimation={!x || m} size={w} sticker={(0, y.Zt)(e)} />)
      }
      return <i.Fragment>{<l.ua7 position={"right"} text={G} tooltipContentClassName={S.__invalid_tooltip}>{e => (0, r.jsx)("div", {
            role: "listitem",
            "aria-setsize": D,
            "aria-posinset": o,
          ...
          })}</l.ua7>}{j ? <hr className={S.guildCategorySeparator} /> : null}</i.Fragment>
    ...
    return {
      ...
      onScroll: i.useCallback(e => {
        var t;
        let n = null == (t = o.current) ? true : t.getListDimensions();
  ...
  Z = e => {
    let {
      stickersListRef: t,
      channel: n
    } = e, o = i.useRef(null), [s, c] = i.useState(true), u = d.ZN.useStore(e => e.activeCategoryIndex), f = (0, g.Sd)(n), {
    ...
    return <_.Z className={S.categoryList} categoryListRef={o} expressionsListRef={t} store={d.ZN} listPadding={k} onScroll={v} renderCategoryListItem={y} rowCount={f.length} categories={f} categoryHeight={O}>{e => E && s && (0, r.jsx)(l.P3F, {
        className: a()(S.standardStickerShortcut, {
