...
function S(e, t) {
  let {
    ...
    resolution: y,
    fps: v
  } = (0, o.cj)([u.Z], () => u.Z.getState()), S = (0, o.e7)([_.Z], () => _.Z.getGoLiveSource()), A = (0, o.e7)([h.default], () => h.default.getCurrentUser()), N = (0, o.e7)([f.Z], () => {
    var t;
  ...
  let w = n === g.tI.PRESET_DOCUMENTS ? g.ws.FPS_30 : v,
    D = g.af.map(e => {
      ...
      return <a.k5B group={"stream-settings-fps"} id={"stream-settings-fps-".concat(t)} label={n} checked={t === v} action={() => P(i, y, t, m.Qqv.RESOLUTION)} />
    }),
    L = g.km.map(e => {
      let {
        value: t,
      ...
      return <a.k5B group={"stream-settings-resolution"} id={"stream-settings-resolution-".concat(t)} label={n} checked={t === y} action={() => P(i, t, w, m.Qqv.RESOLUTION)} />
    });
  return <r.Fragment>{<a.kSQ label={b.intl.string(b.t.SkkeIi)}>{D}</a.kSQ>}{<a.kSQ label={b.intl.string(b.t.rHyPXl)}>{L}</a.kSQ>}</r.Fragment>
}