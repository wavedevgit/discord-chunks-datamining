...
function u(e) {
  ...
  return e.apply = n => {
    var r;
    if ("set_selection" === n.type && (null == (r = e.composition) ? true : r.startedInsideInline) && a.M8.isRange(n.properties) && a.M8.isRange(n.newProperties) && a.M8.isCollapsed(n.newProperties)) {
    ...
    if (null != e.selection && a.M8.isExpanded(e.selection)) {
      ...
      if (null != d) {
        ...
        p && a.Jz.equals(c, i) ? c = null != (n = a.bN.before(e, i)) ? n : a.bN.start(e, []) : !p && a.Jz.equals(c, o) && (c = null != (r = a.bN.after(e, o)) ? r : a.bN.end(e, []))
      }
      if (null != f) {
        let [, t] = f, [n, r] = a.bN.edges(e, t);
        !p && a.Jz.equals(u, n) ? u = null != (o = a.bN.before(e, n)) ? o : a.bN.start(e, []) : p && a.Jz.equals(u, r) && (u = null != (l = a.bN.after(e, r)) ? l : a.bN.end(e, []))
      }
...
function d(e, t, n) {
  ...
  if (null == s || null == o || "block" === t) returntrue;
