...
function O(e) {
  let {
    ...
    application: E,
    activity: y
  } = t, b = y.client_platform_config[(0, v.Z)((0, u.getOS)())], g = null != b.label_until && Date.now() < Date.parse(b.label_until), m = (0, h.Z)({
    applicationId: E.id,
    size: c,
    names: o
  }), A = null != y.activity_preview_video_asset_id ? (0, _.Z)(E.id, y.activity_preview_video_asset_id) : null, O = (0, f.ZP)("channel" === n.type ? n.channel : void 0).find(e => {
    let {
      embeddedActivity: t
    } = e;
...
function P(e) {
  ...
  } = e, l = 0, r = "channel" === t.type ? t.channel : void 0, a = (0, y.Z)(), c = (0, b.Z)({
    fetchesApplication: i
  }), u = (0, o.q)(n, i), d = (0, f.ZP)(r).find(e => {
    let {
      embeddedActivity: t
    } = e;
...
function Z(e) {
  ...
  switch (m) {
    ...
    case 2:
      return () => {
        d.ZP.isLaunchingActivity() || (null != O && o.leaveActivity({
          location: O.location,
          applicationId: t
        }), null == c || c({
          applicationId: t
