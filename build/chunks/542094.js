...
function w(e) {
  let {
    ...
    application: v,
    activity: O
  } = t, E = O.client_platform_config[(0, b.Z)((0, u.getOS)())], P = null != E.label_until && Date.now() < Date.parse(E.label_until), g = (0, m.Z)({
    applicationId: v.id,
    size: a,
    names: c
  }), h = null != O.activity_preview_video_asset_id ? (0, y.Z)(v.id, O.activity_preview_video_asset_id) : null, w = (0, f.ZP)("channel" === n.type ? n.channel : void 0).find(e => {
    let {
      embeddedActivity: t
    } = e;
...
function Z(e) {
  ...
  } = e, r = 0, l = "channel" === t.type ? t.channel : void 0, o = (0, O.Z)(), a = (0, E.Z)({
...
function A(e) {
  ...
  switch (g) {
    ...
    case 2:
      return () => {
        d.ZP.isLaunchingActivity() || (null != w && c.leaveActivity({
          location: w.location,
          applicationId: t
        }), null == a || a({
          applicationId: t
