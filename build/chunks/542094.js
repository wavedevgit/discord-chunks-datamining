...
function _(e) {
  let {
    ...
    application: f,
    activity: y
  } = t, O = y.client_platform_config[(0, b.Z)((0, u.getOS)())], m = null != O.label_until && Date.now() < Date.parse(O.label_until), P = (0, g.Z)({
    applicationId: f.id,
    size: c,
    names: a
  }), Z = null != y.activity_preview_video_asset_id ? (0, E.Z)(f.id, y.activity_preview_video_asset_id) : null, h = (0, v.ZP)("channel" === n.type ? n.channel : void 0).find(e => {
    let {
      embeddedActivity: t
    } = e;
...
function A(e) {
  ...
  } = e, r = 0, l = "channel" === t.type ? t.channel : void 0, o = (0, O.Z)(), c = (0, m.Z)({
    fetchesApplication: i
  }), u = (0, a.q)(n, i), d = (0, v.ZP)(l).find(e => {
    let {
      embeddedActivity: t
    } = e;
...
function I(e) {
  ...
  switch (_) {
    ...
    case 2:
      return () => {
        p.ZP.isLaunchingActivity() || (null != I && c.leaveActivity({
          location: I.location,
          applicationId: t
        }), null == u || u({
          applicationId: t
