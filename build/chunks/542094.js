...
function w(e) {
  let {
    ...
    application: f,
    activity: v
  } = t, b = v.client_platform_config[(0, m.Z)((0, s.getOS)())], O = Date.now(), Z = null != b.label_until && O < Date.parse(b.label_until) && null != b.label_from && O > Date.parse(b.label_from), g = (0, h.Z)({
    applicationId: f.id,
    size: a,
    names: u
  }), P = null != v.activity_preview_video_asset_id ? (0, E.Z)(f.id, v.activity_preview_video_asset_id) : null, _ = (0, y.ZP)("channel" === n.type ? n.channel : void 0).find(e => {
    let {
      embeddedActivity: t
    } = e;
...
function I(e) {
  ...
  } = e, r = 0, l = "channel" === t.type ? t.channel : void 0, o = (0, O.Z)(), a = (0, Z.Z)({
    fetchesApplication: i
  }), c = (0, u.q)(n, i), d = (0, y.ZP)(l).find(e => {
    let {
      embeddedActivity: t
    } = e;
...
function S(e) {
  ...
  } = e, _ = null != (t = null == n ? void 0 : n.id) ? t : "", w = I({
    context: l,
    applicationId: _,
    fetchesApplication: Z
  }), {
    analyticsLocations: A
  } = (0, o.ZP)(), S = (0, O.Z)(), j = (0, c.A)(n);
  if (null == n) return () => {
    null == s || s({
      applicationId: ""
    })
