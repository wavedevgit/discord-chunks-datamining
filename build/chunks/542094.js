...
function A(e) {
  let {
    ...
    application: b,
    activity: E
  } = t, h = E.client_platform_config[(0, v.Z)((0, u.getOS)())], m = null != h.label_until && Date.now() < Date.parse(h.label_until), _ = (0, g.Z)({
    applicationId: b.id,
    size: c,
    names: r
  }), O = null != E.activity_preview_video_asset_id ? (0, y.Z)(b.id, E.activity_preview_video_asset_id) : null, A = (0, f.ZP)("channel" === n.type ? n.channel : void 0).find(e => {
    let {
      embeddedActivity: t
    } = e;
...
function I(e) {
  ...
  } = e, a = 0, o = "channel" === t.type ? t.channel : void 0, l = (0, E.Z)(), c = (0, h.Z)({
    fetchesApplication: i
  }), u = (0, r.q)(n, i), p = (0, f.ZP)(o).find(e => {
    let {
      embeddedActivity: t
    } = e;
...
function w(e) {
  ...
  switch (_) {
    ...
    case 1:
      return async () => {
        p.ZP.isLaunchingActivity() || await (0, d.Z)({
          applicationId: t,
    ...
    case 2:
      return () => {
        p.ZP.isLaunchingActivity() || (null != A && r.leaveActivity({
          location: A.location,
          applicationId: t
        }), null == c || c({
          applicationId: t
