...
function w(e) {
  let {
    ...
    application: f,
    activity: v
  } = t, y = v.client_platform_config[(0, m.Z)((0, s.getOS)())], g = Date.now(), O = null != y.label_until && g < Date.parse(y.label_until) && null != y.label_from && g > Date.parse(y.label_from), h = (0, Z.Z)({
    applicationId: f.id,
    size: a,
    names: u
  ...
  return {
    ...
    labelType: O ? y.label_type : l.ww.NONE,
    staffReleasePhase: T
  }
}
