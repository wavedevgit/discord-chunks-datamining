...
function Z(e) {
  let {
    ...
    application: v,
    activity: y
  } = t, O = y.client_platform_config[(0, E.Z)((0, u.getOS)())], _ = null != O.label_until && Date.now() < Date.parse(O.label_until), P = (0, m.Z)({
    applicationId: v.id,
    size: a,
    names: c
  }), g = null != y.activity_preview_video_asset_id ? (0, b.Z)(v.id, y.activity_preview_video_asset_id) : null, Z = (0, f.ZP)("channel" === n.type ? n.channel : void 0).find(e => {
    let {
      embeddedActivity: t
    } = e;
...
function A(e) {
  ...
  } = e, r = 0, l = "channel" === t.type ? t.channel : void 0, o = (0, y.Z)(), a = (0, O.Z)({
