...
function I(e) {
  let {
    ...
    application: f,
    activity: v
  } = t, b = v.client_platform_config[(0, _.Z)((0, u.getOS)())], h = null != b.label_until && Date.now() < Date.parse(b.label_until), m = (0, g.Z)({
    applicationId: f.id,
    size: c,
    names: a
  }), A = null != v.activity_preview_video_asset_id ? (0, y.Z)(f.id, v.activity_preview_video_asset_id) : null, O = (0, E.ZP)("channel" === n.type ? n.channel : void 0).find(e => {
    let {
      embeddedActivity: t
    } = e;
...
function Z(e) {
  ...
  } = e, l = 0, r = "channel" === t.type ? t.channel : void 0, o = (0, b.Z)(), c = (0, h.Z)({
    fetchesApplication: i
  }), u = (0, a.q)(n, i), d = (0, E.ZP)(r).find(e => {
    let {
      embeddedActivity: t
    } = e;
...
function w(e) {
  ...
  } = (0, o.ZP)(), w = (0, b.Z)(), C = (0, d.GK)(null != O ? O : void 0);
  switch (I) {
    case 0:
      return async () => {
    ...
    case 1:
      return async () => {
        p.ZP.isLaunchingActivity() || await (0, s.Z)({
          applicationId: t,
    ...
    case 2:
      return () => {
        p.ZP.isLaunchingActivity() || (null != w && c.leaveActivity({
          location: w.location,
          applicationId: t
        }), null == u || u({
          applicationId: t
