...
function _(e) {
  let {
    ...
    application: v,
    activity: E
  } = t, O = E.client_platform_config[(0, y.Z)((0, u.getOS)())], P = null != O.label_until && Date.now() < Date.parse(O.label_until), g = (0, m.Z)({
    applicationId: v.id,
    size: a,
    names: c
  }), Z = null != E.activity_preview_video_asset_id ? (0, b.Z)(v.id, E.activity_preview_video_asset_id) : null, _ = (0, f.ZP)("channel" === n.type ? n.channel : void 0).find(e => {
    let {
      embeddedActivity: t
    } = e;
...
function A(e) {
  ...
  } = e, r = 0, l = "channel" === t.type ? t.channel : void 0, o = (0, E.Z)(), a = (0, O.Z)({
...
function w(e) {
  ...
  switch (g) {
    ...
    case 2:
      return () => {
        d.ZP.isLaunchingActivity() || (null != _ && c.leaveActivity({
          location: _.location,
          applicationId: t
        }), null == a || a({
          applicationId: t
