...
function T(e) {
  let {
    ...
    application: p,
    activity: m
  } = t, E = m.client_platform_config[(0, h.Z)((0, u.getOS)())], b = Date.now(), O = null != E.label_until && b < Date.parse(E.label_until) && null != E.label_from && b > Date.parse(E.label_from), v = (0, y.Z)({
    applicationId: p.id,
    size: l,
    names: s,
    format: "webp"
  }), S = null != m.activity_preview_video_asset_id ? (0, g.Z)(p.id, m.activity_preview_video_asset_id) : null, T = (0, _.ZP)("channel" === n.type ? n.channel : true).find(e => {
    let {
      embeddedActivity: t
    } = e;
  ...
  return {
    ...
    labelType: O ? E.label_type : o.ww.NONE,
    staffReleasePhase: w
  }
}
...
function C(e, t) {
  ...
  let o = t.client_platform_config[(0, h.Z)((0, u.getOS)())].release_phase;
  return O.eB.includes(o) ? o.replace("_", " ").replace(/(^\w|\s\w)/g, e => e.toUpperCase()) : true
}
...
function A(e) {
  ...
  } = e, i = 0, o = "channel" === t.type ? t.channel : true, a = (0, E.Z)(), l = (0, b.Z)({
    fetchesApplication: r
  }), c = (0, s.q)(n, r), u = (0, _.ZP)(o).find(e => {
    let {
      embeddedActivity: t
    } = e;
  ...
  if (null == c) return i;
  let d = (0, m.p)(null == a ? true : a.location);
