...
function h(e) {
  let {
    ...
    application: v,
    activity: E
  } = t, O = E.client_platform_config[(0, y.Z)((0, u.getOS)())], g = null != O.label_until && Date.now() < Date.parse(O.label_until), P = (0, m.Z)({
    applicationId: v.id,
    size: c,
    names: a
  }), Z = null != E.activity_preview_video_asset_id ? (0, b.Z)(v.id, E.activity_preview_video_asset_id) : null, h = (0, f.ZP)("channel" === n.type ? n.channel : void 0).find(e => {
    let {
      embeddedActivity: t
    } = e;
...
function w(e) {
  ...
  } = e, r = 0, l = "channel" === t.type ? t.channel : void 0, o = (0, E.Z)(), c = (0, O.Z)({
  ...
  if (null == u) return r;
  let p = (0, v.p)(null == o ? void 0 : o.location);
...
function A(e) {
  ...
  switch (P) {
    ...
    case 2:
      return () => {
        d.ZP.isLaunchingActivity() || (null != h && a.leaveActivity({
          location: h.location,
          applicationId: t
        }), null == c || c({
          applicationId: t
