...
function Z(e) {
  let {
    ...
    application: v,
    activity: m
  } = t, E = m.client_platform_config[(0, b.Z)((0, u.getOS)())], g = null != E.label_until && Date.now() < Date.parse(E.label_until), P = (0, O.Z)({
    applicationId: v.id,
    size: a,
    names: c
  }), h = null != m.activity_preview_video_asset_id ? (0, y.Z)(v.id, m.activity_preview_video_asset_id) : null, Z = (0, f.ZP)("channel" === n.type ? n.channel : void 0).find(e => {
    let {
      embeddedActivity: t
    } = e;
...
function _(e) {
  ...
  } = e, r = 0, o = "channel" === t.type ? t.channel : void 0, l = (0, m.Z)(), a = (0, E.Z)({
    fetchesApplication: i
  }), u = (0, c.q)(n, i), d = (0, f.ZP)(o).find(e => {
    let {
      embeddedActivity: t
    } = e;
