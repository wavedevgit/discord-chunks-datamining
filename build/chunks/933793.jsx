...
function h(t) {
  let n = (0, a.e7)([u.Z], () => u.Z.getChannel(t.parent_id)),
    e = (0, d.Xb)(t),
    h = (0, o.kF)(t);
  return (null == n ? true : n.isForumLikeChannel()) && e ? t.hasFlag(c.zZ.PINNED) ? <l.sNh id={"unpin-thread"} label={f.intl.string(f.t.trD8am)} action={() => s.Z.unpin(t)} /> : <l.sNh id={"pin-thread"} label={f.intl.string(f.t.EnaWho)} action={function() {
      null != h ? r.Z.show({
