...
class h extends(r = Chunk73800.PureComponent) {
  render() {
    ...
    return <Chunk600164.Z className={s()(Chunk925231.note, _[exports], Chunk73800)} align={Chunk600164.Z.Align.CENTER}>{<module className={s()(Chunk925231.icon, p[r], Chunk120356)} color={"currentColor"} />}{<div>{require}</div>}</Chunk600164.Z>
  }
}
