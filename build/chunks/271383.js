...
function ed(e) {
  ...
  return e_(t, Object.values(n).map(e => e.owner).filter(E.lm))
}
...
function e_(e, t) {
  ...
  return null == r ? (C.warn("Guild ".concat(e, " not found during batchUpdateGuildMembers.")), !1) : (t.forEach(t => {
    var i;
    let o = n[t.user.id];
    n[t.user.id] = z({
      userId: t.user.id,
...
function eO(e) {
  ...
  let {
    ...
    removedRoleIds: l,
    flags: c
  } = e, u = y.default.getId(), d = R[i], f = null != d ? d[u] : null;
  if (null == f) return !1;
...
function eT(e) {
  ...
  (null == (t = n.resolved) ? void 0 : t.members) != null && null != r && eb({
    id: r,
    members: Object.entries(n.resolved.members).map(e => {
      var t, r;
      let [i, o] = e, a = null == (r = n.resolved) || null == (t = r.users) ? void 0 : t[i];
...
function eN(e) {
  ...
  null == n || n.isPrivate() || eb({
    id: n.guild_id,
    members: Object.entries(e.resolved.members).map(t => {
      var n, r;
      let [i, o] = t, a = null == (r = e.resolved) || null == (n = r.users) ? void 0 : n[i];
      if (null != a) return A(T({}, o), {
        user: a
      })
    }).filter(e => null != e)
