...
function eo(e) {
  ...
  } = (0, f.cj)([w.Z], () => w.Z.getState()), eh = i.useRef(null), ep = i.useRef(Date.now()), ex = (0, f.e7)([P.Z, N.Z], () => N.Z.getChannel(P.Z.getVoiceChannelId())), eg = (0, f.e7)([y.ZP, A.Z], () => (0, L.isWindows)() ? (0, z.Z)(y.ZP, A.Z) : null), e_ = (0, f.e7)([R.default], () => {
