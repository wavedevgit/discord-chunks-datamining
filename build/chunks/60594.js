...
function ef(e) {
  ...
  let eN = (0, m.e7)([D.default], () => {
    ...
    [eP, eR] = null != (i = (0, V.Z)(ex, eN, eT)) ? i : [en.LY.RESOLUTION_720, en.ws.FPS_30],
    {
      lastPickerAction: ek
  ...
  async function tr() {
    ...
    let i = eq,
      s = e$,
      o = e0;
    (0, H.Z)(i, s, o, eN, eT, r) || (i = en.tI.PRESET_VIDEO, s = en.LY.RESOLUTION_720, o = en.ws.FPS_30), (0, g.Rc)({
      preset: i,
      resolution: s,
      frameRate: o,
  ...
  let ti = l.useCallback((e, t, n) => {
      ...
      if (!(0, H.Z)(e, t, n, eN, eT, c)) {
        let [e, r] = (0, V.Z)(en.tI.PRESET_VIDEO, eN, eT);
        t = e, n = r
      }
