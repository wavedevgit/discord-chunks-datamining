...
let ef = e => {
  ...
  return t === m.z.GO_LIVE_SYSTEM_PICKER_COACHMARK ? (0, r.jsx)(P.ZP, {
...
function em(e) {
  ...
  let {
  ...
  } = (0, f.cj)([k.Z], () => k.Z.getState()), eS = i.useRef(null), eC = i.useRef(Date.now()), ey = (0, f.e7)([D.Z, A.Z], () => A.Z.getChannel(D.Z.getVoiceChannelId())), eO = (0, f.e7)([T.ZP, G.Z], () => (0, z.isWindows)() ? (0, K.Z)(T.ZP, G.Z) : null), eZ = (0, f.e7)([B.default], () => {
    let e = B.default.getCurrentUser();
    return a()(null != e, "GoLiveModal: user cannot be undefined"), e
  }), eI = null != (t = null == ey ? void 0 : ey.getGuildId()) ? t : em, ew = (0, f.e7)([M.Z], () => {
    var e;
    ...
    lastPickerAction: eE
  } = (0, f.e7)([J.ZP], () => J.ZP.getPickerState()), eP = L.Z.getUseSystemScreensharePicker();
  (0, J.UB)();
  ...
  async function e9() {
    ...
    if (null == ey && !await (0, y.Z)({
        channelId: n
      })) return;
    let l = eX,
      s = eK,
      o = eQ;
    (0, V.Z)(l, s, o, eZ, ew, r) || (l = er.tI.PRESET_VIDEO, s = er.LY.RESOLUTION_720, o = er.ws.FPS_30), (0, b.Rc)({
      preset: l,
      resolution: s,
      frameRate: o,
    ...
    })), null != eA && eM(el.L.AUTO_DISMISS), eP || (async () => {
  ...
  let ti = i.useCallback(e => {
    ...
    to = function(e) {
      switch (e) {
        ...
        case 1:
          return eo.intl.formatToPlainString(eo.t.sbbPhY, {
            buttonName: eo.intl.string(eo.t.FiBjwc)
          });
        case 3:
          return null;
        default:
