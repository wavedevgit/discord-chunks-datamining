...
function eo(e) {
  ...
  let {
  ...
  } = (0, f.cj)([w.Z], () => w.Z.getState()), ep = i.useRef(null), ex = i.useRef(Date.now()), eg = (0, f.e7)([P.Z, N.Z], () => N.Z.getChannel(P.Z.getVoiceChannelId())), e_ = (0, f.e7)([y.ZP, k.Z], () => (0, L.isWindows)() ? (0, F.Z)(y.ZP, k.Z) : null), ev = (0, f.e7)([R.default], () => {
    let e = R.default.getCurrentUser();
    return a()(null != e, "GoLiveModal: user cannot be undefined"), e
  }), ej = null != (t = null == eg ? void 0 : eg.getGuildId()) ? t : eo, eb = (0, f.e7)([T.Z], () => {
    var e;
    ...
    lastPickerAction: ey
  } = (0, f.e7)([z.ZP], () => z.ZP.getPickerState()), eO = E.Z.getUseSystemScreensharePicker();
  (0, z.UB)();
  ...
  async function e2() {
    ...
    let l = eG,
      s = ez,
      o = eH;
    (0, U.Z)(l, s, o, ev, eb, r) || (l = q.tI.PRESET_VIDEO, s = q.LY.RESOLUTION_720, o = q.ws.FPS_30), (0, x.Rc)({
      preset: l,
      resolution: s,
      frameRate: o,
    ...
    })), null != ew && eN($.L.AUTO_DISMISS), eO || (async () => {
