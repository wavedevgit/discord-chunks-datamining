...
let eo = e => {
  ...
  return t === m.z.GO_LIVE_SYSTEM_PICKER_COACHMARK ? (0, r.jsx)(I.ZP, {
...
function ea(e) {
  ...
  } = (0, f.cj)([N.Z], () => N.Z.getState()), ex = i.useRef(null), eg = i.useRef(Date.now()), e_ = (0, f.e7)([R.Z, T.Z], () => T.Z.getChannel(R.Z.getVoiceChannelId())), ev = (0, f.e7)([O.ZP, A.Z], () => (0, D.isWindows)() ? (0, H.Z)(O.ZP, A.Z) : null), ej = (0, f.e7)([k.default], () => {
    let e = k.default.getCurrentUser();
    return a()(null != e, "GoLiveModal: user cannot be undefined"), e
  }), eS = null != (t = null == e_ ? void 0 : e_.getGuildId()) ? t : ea, eb = (0, f.e7)([E.Z], () => {
    var e;
    return null != eS ? null == (e = E.Z.getGuild(eS)) ? void 0 : e.premiumTier : null
  }), [eC, ey] = null != (l = (0, W.Z)(ef, ej, eb)) ? l : [Q.LY.RESOLUTION_720, Q.ws.FPS_30], {
    lastPickerAction: eO
  } = (0, f.e7)([F.ZP], () => F.ZP.getPickerState()), eZ = P.Z.getUseSystemScreensharePicker();
  (0, F.UB)();
  ...
  async function e3() {
    ...
    let l = eW,
      s = eF,
      o = eV;
    (0, G.Z)(l, s, o, ej, eb, r) || (l = Q.tI.PRESET_VIDEO, s = Q.LY.RESOLUTION_720, o = Q.ws.FPS_30), (0, x.Rc)({
      preset: l,
      resolution: s,
      frameRate: o,
    ...
    })), null != eN && eT(ee.L.AUTO_DISMISS), eZ || (async () => {
      await Z.Z.hasPermission(et.Eu.SCREEN_RECORDING, {
  ...
  let e7 = i.useCallback((e, t, n) => {
      ...
      if (!(0, G.Z)(e, t, n, ej, eb, c)) {
        let [e, r] = (0, W.Z)(Q.tI.PRESET_VIDEO, ej, eb);
        t = e, n = r
      }
      n !== eV && eY(n), t !== eF && eH(t), l !== t || s !== n ? ez(Q.tI.PRESET_CUSTOM) : e !== eW && ez(e)
    }, [e_, eM, ej, eb, eV, eF, eW]),
    e8 = i.useCallback(e => {
      (0, z.t)(), (0, z.T)(null != e ? e : e0)
    }, [e0]);
  ...
  let e9 = i.useCallback(e => {
    ...
    ta = (0, r.jsxs)(h.MyZ, {
      springConfig: es(el({}, c.config.stiff), {
        clamp: !0
      }),
      activeSlide: eP,
      width: 480,
      children: [(0, r.jsx)(h.Mi4, {
        ...
        children: (0, r.jsx)("div", {
          ...
          children: (0, r.jsx)(V.Z, {
            ...
            sourceChanged: ek,
            selectSource: K,
            onChangeSelectedFPS: e => e7(eW, eF, e),
            onChangeSelectedResolution: e => e7(eW, e, eV),
            onChangeSelectedPreset: e => e7(e, eF, eV),
