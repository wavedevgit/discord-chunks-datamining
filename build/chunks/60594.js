...
function ef(e) {
  ...
  } = (0, m.cj)([R.Z], () => R.Z.getState()), ej = i.useRef(null), eS = i.useRef(Date.now()), eb = (0, m.e7)([L.Z, k.Z], () => k.Z.getChannel(L.Z.getVoiceChannelId())), eC = (0, m.e7)([N.ZP, B.Z], () => (0, W.isWindows)() ? (0, X.Z)(N.ZP, B.Z) : null), ey = (0, m.e7)([S.ZP], () => S.ZP.getCurrentEmbeddedActivity()), eO = (null == ey ? void 0 : ey.location.kind) === f.E.CONTEXTLESS, eZ = (0, y.q)(null == ey ? void 0 : ey.applicationId), [eI, ew] = i.useState(null);
  i.useEffect(() => {
    (0, j.R)() && (async () => {
      var e;
  ...
  async function tr() {
    ...
    let l = eq,
      s = e$,
      o = e0;
    (0, H.Z)(l, s, o, eN, eE, r) || (l = en.tI.PRESET_VIDEO, s = en.LY.RESOLUTION_720, o = en.ws.FPS_30), (0, g.Rc)({
      preset: l,
      resolution: s,
      frameRate: o,
    ...
    })), null != eD && eB(ei.L.AUTO_DISMISS), eA || (async () => {
