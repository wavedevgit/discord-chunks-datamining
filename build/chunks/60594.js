...
let ea = e => {
  ...
  return t === f.z.GO_LIVE_SYSTEM_PICKER_COACHMARK ? (0, r.jsx)(I.ZP, {
...
function ec(e) {
  ...
  async function e6() {
    ...
    let i = eX,
      o = eK,
      a = eQ;
    (0, z.Z)(i, o, a, eZ, eO, r) || (i = ee.tI.PRESET_VIDEO, o = ee.LY.RESOLUTION_720, a = ee.ws.FPS_30), (0, x.Rc)({
      preset: i,
      resolution: o,
      frameRate: a,
