...
let eu = e => {
  ...
  return t === h.z.GO_LIVE_SYSTEM_PICKER_COACHMARK ? (0, r.jsx)(E.ZP, {
...
function ef(e) {
  ...
  } = (0, m.cj)([R.Z], () => R.Z.getState()), ev = i.useRef(Date.now()), eb = (0, m.e7)([M.Z, W.Z], () => W.Z.getChannel(M.Z.getVoiceChannelId())), eS = (0, m.e7)([w.ZP, D.Z], () => (0, U.isWindows)() ? (0, X.Z)(w.ZP, D.Z) : null), eN = (0, m.e7)([b.ZP], () => b.ZP.getCurrentEmbeddedActivity()), eC = (null == eN ? void 0 : eN.location.kind) === f.E.CONTEXTLESS, ey = (0, C.q)(null == eN ? void 0 : eN.applicationId), [eZ, eI] = i.useState(null);
  i.useEffect(() => {
    (0, v.R)({
      isContextless: eC
    }) && (async () => {
  ...
  let eO = (0, m.e7)([L.default], () => {
      let e = L.default.getCurrentUser();
      return o()(null != e, "GoLiveModal: user cannot be undefined"), e
    }),
    ew = null != (t = null == eb ? void 0 : eb.getGuildId()) ? t : ef,
    eT = (0, m.e7)([k.Z], () => {
      var e;
      return null != ew ? null == (e = k.Z.getGuild(ew)) ? void 0 : e.premiumTier : null
    }),
    [eE, eP] = null != (l = (0, V.Z)(ep, eO, eT)) ? l : [en.LY.RESOLUTION_720, en.ws.FPS_30],
    {
      lastPickerAction: eR
    } = (0, m.e7)([J.ZP], () => J.ZP.getPickerState()),
  ...
  async function tn() {
    ...
    let l = eK,
      s = eQ,
      a = e1;
    (0, H.Z)(l, s, a, eO, eT, r) || (l = en.tI.PRESET_VIDEO, s = en.LY.RESOLUTION_720, a = en.ws.FPS_30), (0, g.Rc)({
      preset: l,
      resolution: s,
      frameRate: a,
    ...
    if (null == eV ? void 0 : eV.id.startsWith("prepicked:")) c = J.ZP.getStreamStartOptions();
      ...
      let e = (0, $.Z)(eS, eV, w.ZP.getRunningGames()),
      ...
      await T.Z.hasPermission(el.Eu.SCREEN_RECORDING, {
  ...
  i.useEffect(() => {
    let e = (0, U.isWindows)() ? (0, X.Z)(w.ZP, D.Z) : null,
  ...
  function ts(e) {
    ...
    let t = (0, $.Z)(eS, eV, w.ZP.getRunningGames());
  ...
  let ta = i.useCallback(e => {
    ...
    td = function(e) {
      switch (e) {
        ...
        case 1:
          return es.NW.formatToPlainString(es.t.sbbPhY, {
            buttonName: es.NW.string(es.t.FiBjwc)
          });
        case 3:
          return null;
        default:
