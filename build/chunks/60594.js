...
function ef(e) {
  ...
  } = (0, m.cj)([R.Z], () => R.Z.getState()), ev = i.useRef(Date.now()), eb = (0, m.e7)([M.Z, W.Z], () => W.Z.getChannel(M.Z.getVoiceChannelId())), eS = (0, m.e7)([O.ZP, D.Z], () => (0, U.isWindows)() ? (0, X.Z)(O.ZP, D.Z) : null), eN = (0, m.e7)([b.ZP], () => b.ZP.getCurrentEmbeddedActivity()), eC = (null == eN ? void 0 : eN.location.kind) === f.E.CONTEXTLESS, ey = (0, C.q)(null == eN ? void 0 : eN.applicationId), [eZ, eI] = i.useState(null);
  i.useEffect(() => {
    (0, v.R)({
      isContextless: eC
    }) && (async () => {
  ...
  async function tn() {
    ...
    let l = eK,
      s = eQ,
      a = e1;
    (0, H.Z)(l, s, a, ew, eT, r) || (l = en.tI.PRESET_VIDEO, s = en.LY.RESOLUTION_720, a = en.ws.FPS_30), (0, g.Rc)({
      preset: l,
      resolution: s,
      frameRate: a,
