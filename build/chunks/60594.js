...
let eu = e => {
  ...
  return t === h.z.GO_LIVE_SYSTEM_PICKER_COACHMARK ? (0, r.jsx)(T.ZP, {
...
function ef(e) {
  ...
  } = (0, m.cj)([R.Z], () => R.Z.getState()), ej = l.useRef(Date.now()), eS = (0, m.e7)([L.Z, k.Z], () => k.Z.getChannel(L.Z.getVoiceChannelId())), eb = (0, m.e7)([N.ZP, B.Z], () => (0, W.isWindows)() ? (0, X.Z)(N.ZP, B.Z) : null), eC = (0, m.e7)([S.ZP], () => S.ZP.getCurrentEmbeddedActivity()), ey = (null == eC ? void 0 : eC.location.kind) === f.E.CONTEXTLESS, eO = (0, y.q)(null == eC ? void 0 : eC.applicationId), [eZ, ew] = l.useState(null);
  l.useEffect(() => {
    (0, j.R)() && (async () => {
      var e;
  ...
  async function tn() {
    ...
    if (null == eS && !await (0, b.Z)({
        channelId: n
      })) return;
    let i = eK,
      s = eQ,
      o = e1;
    (0, H.Z)(i, s, o, eI, eE, r) || (i = en.tI.PRESET_VIDEO, s = en.LY.RESOLUTION_720, o = en.ws.FPS_30), (0, g.Rc)({
      preset: i,
      resolution: s,
      frameRate: o,
  ...
  let to = l.useCallback(e => {
    ...
    td = function(e) {
      switch (e) {
        ...
        case 1:
          return es.intl.formatToPlainString(es.t.sbbPhY, {
            buttonName: es.intl.string(es.t.FiBjwc)
          });
        case 3:
          return null;
        default:
