...
function ef(e) {
  ...
  } = (0, m.cj)([W.Z], () => W.Z.getState()), ej = l.useRef(Date.now()), eb = (0, m.e7)([L.Z, k.Z], () => k.Z.getChannel(L.Z.getVoiceChannelId())), eC = (0, m.e7)([I.ZP, G.Z], () => (0, F.isWindows)() ? (0, K.Z)(I.ZP, G.Z) : null), eN = (0, m.e7)([b.ZP], () => b.ZP.getCurrentEmbeddedActivity()), eS = (null == eN ? void 0 : eN.location.kind) === f.E.CONTEXTLESS, ey = (0, S.q)(null == eN ? void 0 : eN.applicationId), [eZ, ew] = l.useState(null);
  l.useEffect(() => {
    (0, j.R)({
      isContextless: eS
    }) && (async () => {
  ...
  let eO = (0, m.e7)([D.default], () => {
    ...
    {
      lastPickerAction: eR
    } = (0, m.e7)([Y.ZP], () => Y.ZP.getPickerState()),
  ...
  async function tn() {
    ...
    if (null == eb && !await (0, C.Z)({
        channelId: n
      })) return;
    let i = eK,
      s = eQ,
      o = e1;
    (0, V.Z)(i, s, o, eO, eP, r) || (i = er.tI.PRESET_VIDEO, s = er.LY.RESOLUTION_720, o = er.ws.FPS_30), (0, p.Rc)({
      preset: i,
      resolution: s,
      frameRate: o,
    ...
    if (null == eV ? void 0 : eV.id.startsWith("prepicked:")) c = Y.ZP.getStreamStartOptions();
      ...
      await T.Z.hasPermission(es.Eu.SCREEN_RECORDING, {
  ...
  function ts(e) {
    ...
    z.ZP.supportsFeature(el.eRX.ELEVATED_HOOK) && (null == t ? void 0 : t.elevated) ? function() {
      var e;
