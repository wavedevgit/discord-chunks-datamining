...
function P(e) {
  let {
    ...
    loadId: t
  }), A = 0 === o.length && !f, Z = i.useContext(d.AnalyticsContext), [w, L] = i.useState((0, g.PM)()), [D, R] = i.useState(true), M = i.useRef(D), [k, U] = i.useState(3), G = i.useRef(k), H = i.useRef(null), B = i.useCallback(e => {
