...
function S(e) {
  ...
  return null == l && null != n.id ? l = p.ZP.getEmojiURL({
    ...
    animated: !!a,
    size: 20
  }) : null == l && (l = h.ZP.getURL(c)), <s.ua7 text={n.allNamesString} hideOnClick={true} spacing={16} forceOpen={i}>{e => (0, r.jsx)("div", I(O({
...
function A(e, t) {
  ...
  return p && n.length > 0 ? <s.kSQ className={b.wrapper}>{n.map((e, t) => {
      var n;
