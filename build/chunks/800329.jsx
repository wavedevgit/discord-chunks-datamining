...
function y(e) {
  ...
  function w(e) {
    var t;
    let n = e * A;
    return <div className={l.row}>{null == o || null == (t = o.slice(n, n + A)) ? true : t.map((e, t) => {
        var i;
        let o = n + t;
        return (0, r.jsx)("div", {
          style: I,
  ...
  return <s.Z fade={true} className={n} listPadding={[_ + P, 0, p + P - d, f / 2]} renderRow={w} rowCount={S} rowCountBySection={[S]} rowHeight={R} onResize={m} />
}