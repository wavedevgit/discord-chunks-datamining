...
let b = function(e) {
  let {
    ...
    entryPoint: n,
    onClose: b
  } = e, [L, C] = o.useState(s.z.AGE_VERIFICATION_SURVEY_MODAL_GET_STARTED), T = o.useRef(L), [P, R] = (0, a.US)([L], void 0, !0), {
    loading: x,
    initiateAgeVerification: h
  } = (0, m.WD)(b), M = o.useMemo(() => (0, i.Z)(), []), y = o.useRef(!1);
  return o.useEffect(() => {
    T.current = P
  }, [P]), o.useLayoutEffect(() => () => {
    if (y.current) return;
    let e = T.current;
    null != e && (y.current = !0, E.Z.maybeOpenAgeVerificationUserFeedback({
    ...
    actionBarInput: (0, r.jsxs)(u.Z, {
      ...
      children: [O.intl.string(O.t["aA6q//"]), (0, r.jsx)(c.Gr1, {
        size: "xs",
        color: "currentColor"
      })]
    }),
    children: [(0, N.uH)(M).map((e, t) => {
      let {
        title: n,
        description: o
      } = e;
