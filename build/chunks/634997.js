...
let h = function(e) {
  let {
    ...
    entryPoint: r,
    onClose: h
  } = e, [j, A] = o.useState(l.z.AGE_VERIFICATION_SURVEY_MODAL_GET_STARTED), m = o.useRef(j), [x, C] = (0, u.US)([j], void 0, !0), {
    loading: v,
    initiateAgeVerification: S
  } = (0, y.WD)(h), k = o.useMemo(() => (0, i.Z)(), []), I = o.useRef(!1);
  return o.useEffect(() => {
    m.current = x
  }, [x]), o.useLayoutEffect(() => () => {
    if (I.current) return;
    let e = m.current;
    null != e && (I.current = !0, p.Z.maybeOpenAgeVerificationUserFeedback({
      location: "age_verification_get_started_modal",
      visibleContent: e
    }))
  }, []), o.useEffect(() => {
    (0, d.lA)(k, d.d_.PRIMARY, r)
  }, [k, r]), (0, n.jsxs)(c.Modal, {
    transitionState: t,
    onClose: h,
