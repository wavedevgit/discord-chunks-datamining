...
let A = function(e) {
  let {
    ...
    entryPoint: n,
    onClose: A
  } = e, [L, C] = i.useState(l.z.AGE_VERIFICATION_SURVEY_MODAL_GET_STARTED), x = i.useRef(L), [T, P] = (0, a.US)([L], void 0, !0), {
    loading: R,
    initiateAgeVerification: h
  } = (0, p.WD)(A), j = i.useMemo(() => (0, o.Z)(), []), v = i.useRef(!1);
  return i.useEffect(() => {
    x.current = T
  }, [T]), i.useLayoutEffect(() => () => {
    if (v.current) return;
    let e = x.current;
    null != e && (v.current = !0, _.Z.maybeOpenAgeVerificationUserFeedback({
      location: "age_verification_get_started_modal",
      visibleContent: e
    }))
  }, []), i.useEffect(() => {
    (0, I.lA)(j, I.d_.PRIMARY, n)
  }, [j, n]), (0, r.jsxs)(s.Modal, {
    transitionState: t,
    onClose: A,
