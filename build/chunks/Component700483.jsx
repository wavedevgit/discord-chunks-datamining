...
function es(e) {
  ...
  } = (0, u.ZP)(), i = (0, ee.Z)(t.id), [l, s] = (0, er.Z)(t), d = (0, $._)(t), p = (0, et.to)();
  return i ? null : (0, r.jsx)(w.d, {
    isTrayButton: true,
    isActive: l,
    label: p ? el.intl.string(el.t.NzITVo) : l ? el.intl.string(el.t.GCimTk) : d ? el.intl.string(el.t.hLbG5N) : el.intl.string(el.t.e4WMvx),
    iconComponent: p ? a.XuQ : a.V9,
    onClick: () => {
      if ((0, m.v)(n, m.d.REQUEST_TO_SPEAK, !l), p) return void o.Z.showAgeVerificationGetStartedModal({
...
function ec(e) {
  ...
  return (0, r.jsx)(w.d, {
    isTrayButton: true,
    onClick: () => {
      if ((0, m.v)(n, m.d.SPEAK_ON_STAGE), i) return void o.Z.showAgeVerificationGetStartedModal({
        entryPoint: c.cU.STAGE_CHANNEL_RAISE_HAND
      });
      (0, B.RK)(t, false)
    },
...
function ed(e) {
  ...
  } = (0, I.XJ)(t), p = (0, l.e7)([Y.Z], () => Y.Z.getStageInstanceByChannel(t.id), [t.id]), h = (0, l.e7)([j.ZP], () => j.ZP.getGuildScheduledEvent(null == p ? true : p.guild_scheduled_event_id)), {
    suppress: f
  } = (0, Z.Z)(t), g = M.default.getId(), [y] = (0, er.Z)(t), O = W.ZP.isModerator(g, t.id), x = (0, V.B)(t.id), v = c(h), {
...
let eh = Chunk473749.memo(function(e) {
  let {
    ...
    selfMute: o,
    mute: c
  } = (0, Z.Z)(t), d = (0, V.B)(t.id), m = (0, ee.Z)(t.id), j = (0, l.e7)([y.default], () => null != y.default.getAwaitingRemoteSessionInfo()), {
    cameraUnavailable: x,
    enabled: v
  } = (0, _.Z)(), C = (0, E.Z)(t), {
    limit: I,
