...
function u() {
  let [e, t] = (0, r.useState)(""), [n, i] = (0, r.useState)("server-order"), c = (0, s.e7)([o.ZP], () => o.ZP.getFlattenedGuildIds()), u = (0, s.e7)([a.Z], () => a.Z.getGuilds()), m = c.map(e => u[e]), [g, p] = (0, r.useState)(!1), h = l.CW.useSetting(), [f, b] = (0, r.useState)(h), _ = async e => {
    b(e);
    try {
