...
class k extends Chunk73800.PureComponent {
  ...
  render() {
    ...
    let N = (0, Chunk896007.vE)({
      ...
      I = (0, Chunk978946.r)();
    return <div>{<Chunk503089.ZP theme={require} sidebarTheme={Chunk73800} section={A && null != Chunk442837 ? Chunk442837 : I} onSetSection={Chunk434404.Z.setSection} onClose={Chunk37234.xf} title={"" !== Chunk100527.name ? Chunk100527.name : Chunk388032.intl.string(Chunk388032.t["154/bG"])} sections={Chunk981631} />}{<Chunk918658.d guildId={Chunk100527.id} />}</div>
  }
}
...
function B() {
  ...
  return <Chunk906732.Gt value={Chunk978946}><k{...n = function(e) {
