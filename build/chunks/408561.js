...
function E(e) {
  let {
    ...
    onClose: E,
    channel: v
  } = e, g = (0, s.Z)(f.TL), m = (0, r.e7)([d.default], () => d.default.getUser(v.getRecipientId()));
  return a.useEffect(() => {
    ...
    body: O.intl.formatToPlainString(O.t["7kb7z8"], {
