...
function v(e) {
  let {
    ...
    onClose: v,
    channel: g
  } = e, m = (0, s.Z)(f.TL), h = (0, r.e7)([d.default], () => d.default.getUser(g.getRecipientId()));
  return a.useEffect(() => {
    ...
    body: E.intl.formatToPlainString(E.t["7kb7z8"], {
