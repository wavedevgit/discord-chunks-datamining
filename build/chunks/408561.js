...
function x(e) {
  let {
    ...
    onClose: x,
    channel: g
  } = e, v = (0, s.Z)(h.TL), p = (0, o.e7)([d.default], () => d.default.getUser(g.getRecipientId()));
  return l.useEffect(() => {
    ...
    body: b.intl.formatToPlainString(b.t["7kb7z8"], {
