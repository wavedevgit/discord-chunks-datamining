...
function y(e) {
  let {
    ...
    selectedTab: y,
    handleTransition: k
  } = e, S = (0, b.ZP)(), P = (0, s.e7)([h.default], () => h.default.getCurrentUser()), E = (null == P ? void 0 : P.isStaff()) || (null == P ? void 0 : P.isStaffPersonal()) || !1, {
    enabled: w
  } = (0, g.W)({
  ...
  let I = n ? C.DR : a,
    T = l.useCallback(() => {
      t && (I(), (0, u.Ou)()), (0, f.navigateToQuestHome)({
