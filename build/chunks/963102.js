...
function k(e) {
  let {
    ...
    displayText: a,
    handleTransition: i
  } = e, [o, s] = l.useState(!1), u = l.useRef(null), [d, p] = l.useState(0), b = e => {
...
function T(e) {
  let {
    ...
    selectedTab: x,
    handleTransition: T
  } = e, I = (0, p.ZP)(), L = (0, s.e7)([_.default], () => _.default.getCurrentUser()), B = (null == L ? void 0 : L.isStaff()) || (null == L ? void 0 : L.isStaffPersonal()) || !1, {
    enabled: w
  } = (0, h.WX)({
    ...
    children: e => (0, r.jsxs)(b.Z, {
      ...
      children: [(0, r.jsxs)(c.P3F, {
        ...
        children: N.map(e => {
          ...
          return t === S.AW.CATALOG && A ? (0, r.jsx)(k, {
            tab: t,
