...
function ee(e) {
  ...
  return (null == t ? void 0 : t.channelId) != null && Z.Z.canWithPartialContext(U.Plq.VIEW_CHANNEL, {
...
function en(e, t, n) {
  ...
  for (let e of t) {
    ...
    let v = function(e) {
      ...
      }), null) : e === m.XB ? m.r9 : e.startsWith(C.H) ? X(e.slice(C.H.length)) : e.startsWith(E._) ? J(e.slice(E._.length)) : (q(e), null)
    }(h);
    if ((0, c.Z)(f)) {
      let t = (0, s.a)();
      if ((0, u.ZP)({
    ...
    }), (A = i().orderBy(A, [et], ["desc"])).length !== t.length && (_ = !0), L.add(v.id), U.push({
      game: v,
      activity: f,
      activityUser: e,
  ...
  for (let e of t) {
    ...
    if (F.has(l) && G.has(n) || null == r || null == o || r.id === o.afkChannelId) null == r && (h = null, B = !0);
      ...
      a.filter(e => !v.includes(e.id)).forEach(e => t.push(e)), B ? F.has(l) || (h = null) : (h = o, B = !0), F.add(l), G.add(n), V.push({
        channel: r,
        guild: o,
        members: a,
        voiceStates: e
