...
function en(e, t, n) {
  ...
  for (let e of t) {
    ...
    let m = function(e) {
      ...
      }), null) : e === v.XB ? v.r9 : e.startsWith(E.H) ? X(e.slice(E.H.length)) : e.startsWith(x._) ? J(e.slice(x._.length)) : (q(e), null)
    }(h);
    if ((0, u.Z)(f)) {
      let t = (0, s.a)();
      if ((0, c.ZP)({
    ...
    if (!N.JE(f) || null == m || k.has(m.id)) continue;
    let T = null != f ? $(f) : null;
