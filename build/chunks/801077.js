...
function ed(e, t, n) {
  ...
  for (let e of t) {
    ...
    }), (L = o().orderBy(L, [eu], ["desc"])).length !== t.length && (E = !0), I.add(g.id), O.push({
      game: g,
      activity: f,
      activityUser: e,
  ...
  for (let e of t) {
    let n = es(e.id),
      ...
      a = P.Z.getGuild(i);
    if (G.has(i) && U.has(n) || null == r || null == a || r.id === a.afkChannelId) null == r && (f = null, L = !0);
    else {
      ...
      s.filter(e => !m.includes(e.id)).forEach(e => t.push(e)), L ? G.has(i) || (f = null) : (f = a, L = !0), G.add(i), U.add(n), j.push({
        channel: r,
        guild: a,
        members: s,
        voiceStates: e
