...
function en(e, t, n) {
  ...
  for (let e of t) {
    ...
    }), (_ = i().orderBy(_, [et], ["desc"])).length !== t.length && (w = !0), M.add(m.id), k.push({
      game: m,
      activity: h,
      activityUser: e,
  ...
  for (let e of t) {
    ...
    if (W.has(l) && V.has(n) || null == r || null == o || r.id === o.afkChannelId) null == r && (f = null, B = !0);
      ...
      a.filter(e => !m.includes(e.id)).forEach(e => t.push(e)), B ? W.has(l) || (f = null) : (f = o, B = !0), W.add(l), V.add(n), G.push({
        channel: r,
        guild: o,
        members: a,
        voiceStates: e
