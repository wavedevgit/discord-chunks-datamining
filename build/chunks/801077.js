...
function ed(e, t, n) {
  var r, i, o, s, d;
  let _, f = x.default.getCurrentUser(),
  ...
  for (let e of t) {
    ...
    let L = [];
    L = null != _ && null != _.party && null != _.party.id ? Array.from(null != (s = C.Z.getParty(_.party.id)) ? s : []).reduce((e, t) => {
  ...
  for (let e of t) {
    ...
    if (G.has(i) && U.has(n) || null == r || null == o || r.id === o.afkChannelId) null == r && (_ = null, L = !0);
      ...
      s.filter(e => !m.includes(e.id)).forEach(e => t.push(e)), L ? G.has(i) || (_ = null) : (_ = o, L = !0), G.add(i), U.add(n), j.push({
        channel: r,
        guild: o,
        members: s,
        voiceStates: e
...
function eO() {
  if (!ey()) return !1;
  J.clear(), q = eE(z = eg(ef(e_(el(Array.from(ee()).reduce((e, t) => {
    let n = x.default.getUser(t);
