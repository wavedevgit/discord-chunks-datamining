...
function er(e) {
  ...
  return (null == t ? void 0 : t.channelId) != null && _.Z.canWithPartialContext(U.Plq.VIEW_CHANNEL, {
...
function ei(e, t, n) {
  var r, l, o, a, s, h;
  let p, f = D.default.getCurrentUser(),
  ...
  for (let e of t) {
    ...
    let O = function(e) {
      ...
      return null != t ? t : "string" != typeof e ? (new N.Z("NowPlayingViewStore").error("Unknown type for applicationId: ".concat(typeof e, ", value: ").concat(e), {
        tags: {
          source: "ACTIVITIES"
        }
      }), null) : e === E.XB ? E.r9 : e.startsWith(I.H) ? $(e.slice(I.H.length)) : e.startsWith(C._) ? ee(e.slice(C._.length)) : (et(e), null)
    }(p);
    if ((0, d.Z)(h)) {
      let t = (0, u.a)();
      if ((0, c.ZP)({
    ...
    let A = [];
    A = null != h && null != h.party && null != h.party.id ? Array.from(null != (a = T.Z.getParty(h.party.id)) ? a : []).reduce((e, t) => {
    ...
    }), (A = i().orderBy(A, [el], ["desc"])).length !== t.length && (x = !0), R.add(O.id), S.push({
      game: O,
      activity: h,
      activityUser: e,
  ...
  for (let e of t) {
    ...
    if (G.has(l) && V.has(n) || null == r || null == o || r.id === o.afkChannelId) null == r && (p = null, L = !0);
      ...
      a.filter(e => !O.includes(e.id)).forEach(e => t.push(e)), L ? G.has(l) || (p = null) : (p = o, L = !0), G.add(l), V.add(n), B.push({
        channel: r,
        guild: o,
        members: a,
        voiceStates: e
...
function eo(e) {
  return 0 !== e.voiceChannels.length && !!(0, O.$W)("now-playing-view-store") && e.voiceChannels.length > 0 && e.voiceChannels.some(e => {
    let {
      voiceStates: t
    } = e;
...
function ea(e) {
  return 0 !== e.voiceChannels.length && !!(0, O.$W)("now-playing-view-store") && e.voiceChannels.length > 0 && e.voiceChannels.every(e => {
    let {
      voiceStates: t
    } = e;
  ...
  ! function() {
    ...
    if (l && t.forEach(e => {
        let t = (0, o.EQ)({
          ...
          blockeeExperimentEnabled: !0,
          party: o.P.when(eo)
        }, () => O.h9.DERANK).otherwise(() => O.h9.SHOW);
        ...
        } = (0, O.p7)("now-playing-view-store"), r = n && es(e), l = t && ea(e);
