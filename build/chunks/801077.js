...
function et(e) {
  ...
  return (null == t ? void 0 : t.channelId) != null && Z.Z.canWithPartialContext(k.Plq.VIEW_CHANNEL, {
...
function er(e, t, n) {
  var r, l, o, a, d, f;
  let h, g = R.default.getCurrentUser(),
  ...
  for (let e of t) {
    ...
    let N = function(e) {
      ...
      }), null) : e === x.XB ? x.r9 : e.startsWith(C.H) ? J(e.slice(C.H.length)) : e.startsWith(E._) ? q(e.slice(E._.length)) : ($(e), null)
    }(h);
    if ((0, u.Z)(f)) {
      let t = (0, s.a)();
      if ((0, c.ZP)({
    ...
    }), (A = i().orderBy(A, [en], ["desc"])).length !== t.length && (w = !0), M.add(N.id), k.push({
      game: N,
      activity: f,
      activityUser: e,
  ...
  for (let e of t) {
    ...
    if (W.has(l) && F.has(n) || null == r || null == o || r.id === o.afkChannelId) null == r && (h = null, G = !0);
      ...
      let e = D.Z.getVoiceStatesForChannel(r.id),
        ...
        }).filter(U.lm).orderBy([en], ["desc"]).value();
      a.filter(e => !N.includes(e.id)).forEach(e => t.push(e)), G ? W.has(l) || (h = null) : (h = o, G = !0), W.add(l), F.add(n), V.push({
        channel: r,
        guild: o,
        members: a,
        voiceStates: e
