...
let O = (0, a.Z)(e => {
  ...
  let {
  ...
  }), [a.id]), S = (0, c.Io)(a.id), Z = (0, c.Rk)(a.id, u.pV.AUDIENCE), N = (0, l.e7)([s.Z], () => null != E ? s.Z.getParticipant(a.id, E) : null), T = (0, c.w8)(a.id, u.pV.SPEAKER), A = T.filter(j), w = null != T.find(e => e.type === u.Ui.STREAM), R = v(y), k = x(y, P), M = {
    [u.pV.SPEAKER]: k,
    [u.pV.AUDIENCE]: R,
    [u.pV.SELECTED]: 1
    ...
    speakerTileWidth: F,
    speakerTileHeight: G
  } = C(y, k), H = I ? y - 32 : Math.min(y - 64, 3 * F + 8), V = e => e === D.length - 1 || 0 === Z && 1 === e, [z, W] = i.useState(!1), [Y, q] = i.useState(!1);
  return (0, r.jsx)(h.Z, {
    sections: B,
    renderSection: e => {
      let {
