...
let O = (0, o.Z)(e => {
  ...
  let {
  ...
  }), [o.id]), P = (0, c.Io)(o.id), S = (0, c.Rk)(o.id, u.pV.AUDIENCE), Z = (0, l.e7)([s.Z], () => null != E ? s.Z.getParticipant(o.id, E) : null), T = (0, c.w8)(o.id, u.pV.SPEAKER), A = T.filter(j), w = null != T.find(e => e.type === u.Ui.STREAM), R = v(y), k = x(y, I), M = {
    [u.pV.SPEAKER]: k,
    [u.pV.AUDIENCE]: R,
    [u.pV.SELECTED]: 1
    ...
    speakerTileWidth: B,
    speakerTileHeight: F
  } = C(y, k), G = N ? y - 32 : Math.min(y - 64, 3 * B + 8), H = e => e === D.length - 1 || 0 === S && 1 === e, [V, z] = i.useState(!1), [Y, q] = i.useState(!1);
  return (0, r.jsx)(h.Z, {
    sections: U,
    renderSection: e => {
      let {
    ...
    rowHeight: e => null == W[e][0] ? 0 : 0 === e ? G / g.Q + 8 : 1 === e ? V ? 0 : F : 98 * !Y,
    renderFooter: e => {
      let {
        section: t
      } = e;
