...
let j = (0, a.Z)(e => {
  ...
  }), [a.id]), P = (0, c.Io)(a.id), Z = (0, c.Rk)(a.id, u.pV.AUDIENCE), N = (0, l.e7)([s.Z], () => null != E ? s.Z.getParticipant(a.id, E) : null), T = (0, c.w8)(a.id, u.pV.SPEAKER), A = T.filter(O), w = null != T.find(e => e.type === u.Ui.STREAM), R = v(y), M = x(y, I), D = {
    [u.pV.SPEAKER]: M,
    [u.pV.AUDIENCE]: R,
    [u.pV.SELECTED]: 1
  }, L = (0, d.Dx)(a.id), [k, U] = (0, d.aP)(a.id, D, L), B = [Math.max(null != (t = k[0]) ? t : 1, 1), Math.max(null != (n = k[1]) ? n : 1, 1), k[2]], {
    speakerTileWidth: F,
    speakerTileHeight: H
  } = C(y, M), G = S ? y - 32 : Math.min(y - 64, 3 * F + 8), V = e => e === k.length - 1 || 0 === Z && 1 === e, [z, W] = i.useState(!1), [Y, q] = i.useState(!1);
  return (0, r.jsx)(h.Z, {
    sections: B,
    renderSection: e => {
      let {
