...
let C = (0, a.Z)(e => {
  ...
  }), [a.id]), S = (0, c.Io)(a.id), P = (0, c.Rk)(a.id, d.pV.AUDIENCE), T = (0, l.e7)([o.Z], () => null != E ? o.Z.getParticipant(a.id, E) : null), N = (0, c.w8)(a.id, d.pV.SPEAKER), w = N.filter(v), R = null != N.find(e => e.type === d.Ui.STREAM), A = x(y), D = O(y, I), L = {
    [d.pV.SPEAKER]: D,
    [d.pV.AUDIENCE]: A,
    [d.pV.SELECTED]: 1
  }, M = (0, u.Dx)(a.id), [k, U] = (0, u.aP)(a.id, L, M), G = [Math.max(null != (t = k[0]) ? t : 1, 1), Math.max(null != (n = k[1]) ? n : 1, 1), k[2]], {
    speakerTileWidth: F,
    speakerTileHeight: B
  } = j(y, D), H = Z ? y - 32 : Math.min(y - 64, 3 * F + 8), z = e => e === k.length - 1 || 0 === P && 1 === e, [V, W] = i.useState(!1), [Y, K] = i.useState(!1);
  return (0, r.jsx)(p.Z, {
    sections: G,
    renderSection: e => {
      let {
