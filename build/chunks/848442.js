...
function N(e) {
  let {
    ...
    selected: n,
    handleClick: i
  } = e, u = (0, f.RF)(t, "guild_shop_channel_row"), g = (0, o.e7)([O.Z], () => O.Z.getGuild(t)), S = (null == g ? void 0 : g.hasFeature(j.oNc.ROLE_SUBSCRIPTIONS_AVAILABLE_FOR_PURCHASE)) === !0, N = "false" === a.K.get(E.tM, "false"), Z = (0, o.e7)([d.Z], () => d.Z.useReducedMotion);
  return (0, r.jsx)(C.m, {
    id: "shop-".concat(t),
      ...
      children: [Z ? (0, r.jsx)(c.IGR, {
        ...
        onClick: e => {
          if (e.stopPropagation(), (0, b.EW)(s.z.SERVER_SHOP_PHANTOM_PREVIEW), v.default.track(j.rMx.GUILD_SHOP_PREVIEW_CLICK, w(I({}, (0, h.hH)(t)), {
            ...
            var n;
            (0, _.dL)(j.Z5c.CHANNEL(t, null == (n = y.ZP.getDefaultChannel(t)) ? void 0 : n.id))
          }
        },
...
function Z(e) {
  let {
    ...
    a.K.set(E.tM, "true"), (0, _.uL)(j.Z5c.CHANNEL(t.id, S.oC.GUILD_SHOP))
  };
  return l ? (0, r.jsx)(N, {
    guildId: t.id,
    selected: i,
