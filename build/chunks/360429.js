...
function M(e) {
  let {
    ...
    return (t = d ? A.NW.string(A.t.S5anIS) : a ? A.NW.string(A.t.q3O3Jy) : A.NW.string(A.t["7Xq/nZ"]), n || !d && a && (null == o ? void 0 : o.isGuildStageVoice())) ? null : (0, r.jsx)(l.sNh, {
      id: "watch",
      label: t,
      action: a ? function() {
        (0, s.g)((0, m.V9)(e)), (0, P.Ws)(W.Odu.GO_LIVE, {
          type: P.Qu.GO_LIVE,
          value: P.bk.DISABLED,
          userId: e.ownerId
        })
      } : function() {
        c.default.selectVoiceChannel(e.channelId), (0, s.rn)(e), (0, P.Ws)(W.Odu.GO_LIVE, {
          type: P.Qu.GO_LIVE,
          value: P.bk.ENABLED,
          userId: e.ownerId
        })
    ...
    return n || !t || !a || (0, E.isWeb)() ? null : (0, r.jsxs)(l.kSQ, {
      children: [(0, r.jsx)(l.S89, {
        ...
        control: (e, t) => (0, r.jsx)(l._wy, D(L({}, e), {
          ref: t,
          value: s,
          maxValue: 100,
    ...
    return (0, r.jsx)(l.II_, {
      ...
      control: (e, i) => (0, r.jsx)(l._wy, D(L({}, e), {
        ref: i,
        value: n,
        maxValue: 300,
        onChange: t,
