...
function h(e) {
  ...
  return <a.Z guild={t} onDismissed={() => n(u.L.UNKNOWN)} cta={p.intl.string(p.t["oPAx7+"])} message={p.intl.format(p.t.AcaNY2, {
      boostsNeeded: h
    })} type={c.vID.GUILD_BANNER} image={f} onClick={() => (0, o.Z)({
      analyticsLocations: g,
      ...
      guild: t,
      perks: (0, d.XO)()
    })} imageMarginTop={15} imageMarginX={22} />
}