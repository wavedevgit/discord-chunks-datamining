...
function p() {
  ...
  return {
    ...
    comment: Math.random() > .5 ? m(s.x) : void 0,
    tags: Math.random() > .3 ? (e = s.T, t = Math.floor(3 * Math.random()) + 1, [...e].sort(() => .5 - Math.random()).slice(0, t)) : void 0
  }
}

function x(e) {
  var t;
  let a, s = null != (t = i.Z.getOverrideWidgets()) ? t : [];
  a = e === n.g.FAVORITE ? p() : function(e, t) {
  ...
  let m = [];
  e === n.g.FAVORITE ? m.push(a.applicationId) : a.forEach(e => {
