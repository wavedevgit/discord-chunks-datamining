...
function E(e, t) {
  ...
  return ((0, f.Z)({
    ...
    disableTrack: I || !E
  }, [e.id]), I) ? null : S ? <d.sNh id={"ring"} label={E ? (0, l.jsxs)("div", {
      className: N.label,
      children: [y.intl.string(y.t["3Hv9qa"]), T && (0, l.jsx)(C, {})]
    }) : y.intl.string(y.t.bHa9kJ)} subtext={E ? (0, l.jsx)(P, {
      channel: o
    }) : null} action={() => {
      T && L(_.L.TAKE_ACTION), c.Z.ring(t, [e.id], "user_context_menu"), E && null != t && (0, p.Kh)(t)
    }} className={N.menuItem} /> : A ? <d.sNh id={"stop-ringing"} label={(0, l.jsxs)("div", {
      className: N.label,
    ...
    }} className={N.menuItem} /> : null
}
let P = e => {
    let {
      channel: t
    } = e, n = (0, m.ZP)(t);
    return <div className={N.subtext}>{<d.gj8 size={"xs"} />}{<d.Text variant={"text-xs/medium"} className={N.channelName}>{n}</d.Text>}</div>
  },
  C = () => <Chunk481060.IGR color={Chunk831209.Z.BG_BRAND} text={Chunk388032.intl.string(Chunk388032.t.y2b7CA)} />