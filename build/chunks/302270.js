...
function U(e) {
  ...
  }), [n.id]), y = (0, N.B)(n.id), v = (0, P.Rk)(n.id, Z.pV.REQUESTED_TO_SPEAK_ONLY), {
    hasParticipantsPanel: E
  } = (0, f.Z)({
    location: "StageChannelCallHeader"
  }), I = E && x, S = (0, C.Q3)("StageChannelCallHeader");
  return (0, r.jsxs)(p.Gt, {
    value: s,
    children: [(0, r.jsx)(_.Z, {
      channelId: n.id
    }, "clips-enabled-indicator"), !S && !t && (0, r.jsx)(b.Z, {
      className: D.button
    }, "clips"), !l && y ? (0, r.jsx)("div", {
      className: D.button,
...
function B(e) {
  ...
  } = e, h = (0, g.ZP)(l), f = (0, o.e7)([A.Z], () => A.Z.getStageInstanceByChannel(l.id)), m = (0, P.Io)(l.id), b = (0, P.Rk)(l.id, Z.pV.AUDIENCE), _ = (0, o.e7)([E.Z], () => E.Z.getGuild(l.guild_id), [l.guild_id]), j = null != (t = null == _ ? void 0 : _.maxStageVideoChannelUsers) ? t : 0, O = (null == _ ? void 0 : _.isCommunity()) ? j < M.TU7 : (null == _ ? void 0 : _.premiumTier) !== M.Eu4.TIER_3 && j <= M.eez, N = (0, R.Z)(l), w = (0, o.e7)([I.Z], () => I.Z.can(T.yP, l)), B = (0, C.Q3)("StageChannelCallHeader"), F = () => {
    u.Z.updateStageVideoLimitBoostUpsellDismissed(l.id, !0), S.default.track(M.rMx.BOOSTING_UPSELL_CLICKED, {
      guild_id: l.guild_id,
  ...
  i.useEffect(() => {
    ...
    N && S.default.track(M.rMx.BOOSTING_UPSELL_VIEWED, {
      guild_id: n.guild_id,
      type: k.cd.VIDEO_STAGE_LIMIT,
      is_moderator: e,
      listener_count: r + t
      ...
      return (0, r.jsxs)(y.ZP, {
        ...
        children: [(0, r.jsx)(y.ZP.Icon, {
          ...
          children: [(0, r.jsx)(c.S6n, {
            ...
            children: L.intl.format(L.t.chmM9P, {
              count: m
            })
          }), (0, r.jsx)(c.BFJ, {
            size: "xs",
            ...
            color: B ? "text-muted" : "header-secondary",
            className: D.speakerCount,
            children: L.intl.format(L.t["+v2pNz"], {
              count: b
            })
          })]
        })]
