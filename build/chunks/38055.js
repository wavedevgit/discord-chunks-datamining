...
function L(e, t) {
  ...
  L = null != j && null != X ? es ? null == $ || null == (c = $.getOutboundStats()) ? void 0 : c.find(e => e.quality === I.y7) : null == $ ? void 0 : $.getInboundStats(X.ownerId) : es ? null != (m = i().maxBy(null != (h = null == $ ? void 0 : $.getOutboundStats()) ? h : [], e => e.num_frames)) ? m : null : null != ec ? null == $ ? void 0 : $.getInboundStats(ec) : null, (0, g.q)().then(t => {
