...
function w(e, t) {
  ...
  let w = (0, v.hp)(e),
    ...
    M = R(t),
    k = null != t.streamKey ? M : _.ZP.getRTCConnection(),
  ...
  m = null != t.streamKey && null != x ? H ? null == k ? void 0 : null === (o = k.getOutboundStats()) || void 0 === o ? void 0 : o.find(e => e.quality === O.y7) : null == k ? void 0 : k.getInboundStats(x.ownerId) : H ? null !== (h = i().maxBy(null !== (c = null == k ? void 0 : k.getOutboundStats()) && void 0 !== c ? c : [], e => e.num_frames)) && void 0 !== h ? h : null : null != t.userId ? null == k ? void 0 : k.getInboundStats(t.userId) : null, (0, g.q)().then(n => {
    ...
    let eR = {
      ...
      media_session_id: null !== (P = null !== (R = t.mediaSessionId) && void 0 !== R ? R : _.ZP.getMediaSessionId()) && void 0 !== P ? P : null,
      ...
      voice_backend_version: null !== (q = null === (r = _.ZP.getRTCConnection()) || void 0 === r ? void 0 : r.getVoiceVersion()) && void 0 !== q ? q : null,
      rtc_worker_backend_version: null !== (Q = null === (i = _.ZP.getRTCConnection()) || void 0 === i ? void 0 : i.getRtcWorkerVersion()) && void 0 !== Q ? Q : null,
      guild_region: null !== (X = p.Z.getRegion(_.ZP.getHostname())) && void 0 !== X ? X : null,
      hostname: null !== (J = _.ZP.getHostname()) && void 0 !== J ? J : null,
