...
if (o) {
  ...
  })[R] = U, U.constructor = M, I(M, j)) : er && N && l(j, "name", C), b && E(B) !== Z && b(B, Z);
...
})[R], a && (ee(M, "byteLength", L), ee(G, "buffer", x), ee(G, "byteLength", x), ee(G, "byteOffset", x)), u(B, {
  getInt8: function(e) {
