...
require.d(exports, {
  R: () => b,
  q7: () => R
}), require("./896048.js"), require("./321073.js"), require("./134528.js"), require("./947204.js");
...
let b = {
    audioJitterBuffer: true,
    audioJitterDelay: true,
    audioJitterTarget: true,
    audioPlayoutUnderruns: true,
    decryptAttempts: true,
    decryptDuration: true,
    decryptInvalidNonceCount: true,
    decryptMissingKeyCount: true,
    encryptAttempts: true,
    encryptDuration: true,
    encryptMaxAttempts: true,
    encryptMissingKeyCount: true,
    fractionLost: true,
    framesCaptured: true,
    framesRendered: true,
    hqSimulcastStreamEncoded: true,
    lqSimulcastStreamEncoded: true,
    noiseCancellerFrames: true,
    noiseCancellerProcessTime: true,
    sinkWantAsInt: true,
    sinkWantLocalAsInt: true,
    sumOfSquaredFramesDurations: true,
    timestamp: true,
    type: true,
    videoJitterBuffer: true,
    videoJitterDelay: true,
