    ...
    return i.useEffect(() => {
      ...
      if (null != r) {
        if (false === n) {
          ...
          t = window.setTimeout(() => {
            h(true), g([(0, a.random)(d[0], d[1]), (0, a.random)(f[0], f[1])]), b((0, a.random)(p[0], p[1])), O((0, a.random)(_[0], _[1])), S(Math.random() > .5)
          }, e)
        }
      ...
      className: l.star,
      style: {
        transform: "translate(".concat(m[0], "px, ").concat(m[1], "px) scale(").concat(v ? false * E : E, ", ").concat(E, ") rotate(").concat(y, "deg)")
      },
