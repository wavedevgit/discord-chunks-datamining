...
function W(e, t) {
  let [n, i] = r.useState(null != e && e > Date.now() - 1e4), [l, o] = r.useState(!1), [a, s] = r.useState(!0);
  return (0, h.ZP)(() => {
    n && !t && (s(!1), setTimeout(() => {
      o(!0)
    }, 16))
...
let G = r.memo(function(e) {
    let {
      ...
      ref: v,
      width: b
    } = (0, g.ZP)(), y = (0, s.e7)([O.Z], () => O.Z.useReducedMotion), I = p ? "entering" : "exiting", {
      width: P
    } = (0, a.useSpring)(V(A({}, R[I]), {
      width: f ? b : u
    })), {
      opacity: j
    } = (0, a.useSpring)(V(A({}, L[I]), {
      opacity: +!!f,
      onRest: () => {
        f || h(!0)
      }
    ...
    return (0, i.jsx)(a.animated.div, {
      className: o()(_.connectedAnimationContainer, {
        [_.right]: d
      }),
      style: {
        width: P,
      ...
      children: (0, i.jsxs)("div", {
        ...
        children: [d && (0, i.jsx)(c.Fmz, {
          ...
          children: (0, i.jsx)(c.Text, {
            ...
            color: "text-normal",
            children: T.intl.format(T.t.uFcRen, {
              nick: t
            })
          })
        }), !d && (0, i.jsx)(c.Fmz, {
  ...
  Y = r.memo(function(e) {
    let {
      ...
      onWatchStream: F,
      connectedOn: R
    } = e, L = (0, s.e7)([w.default], () => w.default.getId() === a.id, [a.id]), {
      ref: Y,
      width: K
    } = (0, g.ZP)(), {
      showConnectedAnimation: B
    } = W(R, x), Q = null == T ? void 0 : T.sessionId, q = t.id, H = a.id, [J] = (0, s.e7)([E.Z], () => {
      var e;
      return [null != (e = E.Z.getVoiceStateForChannel(q, H)) ? e : E.Z.getVoiceStateForSession(H, Q), E.Z.getVoiceStateVersion()]
    }, [q, H, Q], N.Q), $ = x ? T : null != J ? J : T, [X, ee, et] = (0, s.Wu)([Z.Z], () => L ? [!Z.Z.isSupported() || Z.Z.isSelfMute() || Z.Z.isSelfMutedTemporarily(), Z.Z.isSelfDeaf(), !1] : [!Z.Z.isSupported() || Z.Z.isLocalMute(a.id), !1, Z.Z.isLocalVideoDisabled(a.id)], [L, a.id]), en = (0, s.e7)([j.Z], () => {
      let e = j.Z.getCurrentUserActiveStream();
      return null != e && e.ownerId !== a.id && j.Z.getViewerIds(e).filter(e => e === a.id).length > 0
    }, [a.id]), ei = x && (null == T ? void 0 : T.discoverable), er = (0, m.Z)({
      userId: a.id,
      context: I
    }) || ei, el = (0, s.e7)([j.Z], () => j.Z.getStreamForUser(a.id, S)), eo = null != el, ea = r.useCallback(() => {
      (A || null != eo) && V(null)
    }, [V, A, eo]), es = r.useCallback(() => (0, i.jsx)(b.Z, {
      user: a,
      channel: t,
      onWatch: () => {
        null != el && ((0, p.rn)(el, {
          forceMultiple: !0,
          noFocus: !0
        }), ea(), F(null != el ? el : null))
      },
      onAction: () => F,
      previewIsOpen: A,
      location: k.Sbl.UNLOCKED_OVERLAY,
      hideTip: !0
    }), [a, t, el, A, ea, F]), ec = r.useCallback(e => {
      l || null == v || v(e, a)
    }, [l, v, a]), eu = r.useCallback(() => {
      l || null != eo && V(a.id)
    }, [l, V, eo, a]), ed = l || x, ef = r.useMemo(() => D(h), [h]), ep = r.useMemo(() => M(ef), [ef]), eg = r.useMemo(() => a.getAvatarURL(S, ep), [a, S, ep]);
    return f === k.OYC.ONLY_WHILE_SPEAKING && ed && !er || null == $ ? null : n ? (0, i.jsxs)(c.P3F, {
      ...
      onMouseEnter: eu,
      onMouseLeave: ea,
      children: [ed && (d === k.wC$.NEVER || !er && d === k.wC$.ONLY_WHILE_SPEAKING) ? null : (0, i.jsx)(c.yRy, {
        position: "left",
        renderPopout: es,
        shouldShow: A,
        onRequestClose: ea,
      ...
      children: [(0, i.jsx)(z, {
        ...
        isSettingsPreview: x,
        voiceBackgroundWidth: K
      }), ed && (d === k.wC$.NEVER || !er && d === k.wC$.ONLY_WHILE_SPEAKING) ? null : (0, i.jsx)(c.yRy, {
        position: "right",
        renderPopout: es,
        shouldShow: A,
        onRequestClose: ea,
  ...
  K = r.memo(function(e) {
    let {
      ...
      voiceState: y,
      connectedOn: P
    } = o, [j, w] = r.useState(null), [Z, E] = r.useState(null);
    r.useEffect(() => {
      c && E(null)
    }, [c]), r.useEffect(() => {
      null != j && (0, C.Ws)(k.Odu.VOICE_V3, {
        type: C.Qu.GO_LIVE,
    ...
    let N = e => {
      ...
      _ = r.useCallback(e => {
        ...
        })), null != e && null != o && (0, C.Ws)(k.Odu.VOICE_V3, {
          type: C.Qu.GO_LIVE,
          value: C.bk.ENABLED,
          userId: e.ownerId
        })
