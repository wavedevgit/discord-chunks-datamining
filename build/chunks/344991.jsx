...
function b(e) {
  ...
  return <div className={_.iconContainer} style={{
      height: n,
      width: n
    }}>{t}</div>
}
...
function O(e) {
  ...
  let H = e => {
    ...
    K = (e, t) => {
      ...
      return null != a ? <b icon={a} iconSize={i} /> : null
    },
    z = 0 === C.size || T,
    q = {
      isProcessing: F,
  ...
  return <i.Fragment>{<div className={_.container}>{Z ? (0, r.jsx)(s.VcW, m({
        className: _.badges,
        ...
        clearable: true,
        centerCaret: true
      }, q), x)}</div>}{null != B ? <c.st{...E(m({}, (0, c.c4)(B)), {
      className: p.error
    })} /> : null}</i.Fragment>
}