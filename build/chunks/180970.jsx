...
function m(e) {
  ...
  return <_.Z modalType={"block_user"} header={u.intl.string(u.t["+2qQAQ"])} body={u.intl.string(u.t["+0Rsvb"])} problemTitle={u.intl.string(u.t.TXomWV)} problems={p} freeformNeededProblems={d} onSubmit={f} onClose={t} transitionState={m} otherKey={b.F5.SOMETHING_ELSE} hideHelpDeskLink={true} hideDontShowAgainCheckbox={true} />
}