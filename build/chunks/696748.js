...
class v extends i.PureComponent {
  ...
  renderConflict() {
    ...
    return (0, r.jsxs)(c.hzk, {
      ...
      children: [(0, r.jsx)("div", {
        className: E.description,
        children: g.intl.format(g.t.eyXUPz, {
          applicationName: e.name
        })
      }), this.renderConflictButton(g.intl.string(g.t.AQUmkp), t.remote.timestamp, E.conflictDownloadArt, this.handleChooseDownload), (0, r.jsxs)(_.Z, {
      ...
      }), this.renderConflictButton(g.intl.string(g.t.AXVws7), t.next.timestamp, E.conflictUploadArt, this.handleChooseUpload)]
    })
  }
  render() {
    let {
      cloudSyncState: e,
      transitionState: t
    } = this.props, n = e.type === m.TzF.CONFLICT ? g.intl.string(g.t.oNbO1d) : g.intl.string(g.t.as4Tgo);
