...
function p(e) {
  ...
  let {
    ...
    height: y,
    ref: N
  } = (0, c.Z)(), O = p ? y : 59 + (null != C ? C : 100) + 101, w = (0, o.q_F)({
    from: {
      height: 0
    },
    to: {
    ...
    config: h,
    delay: 1e3
  }), S = (0, d.Fg)(), Z = S === u.BR.LIGHT ? "#FFFFFF" : "#1C1D23", T = S === u.BR.LIGHT ? "#EBEDEF" : "#26272F", H = S === u.BR.LIGHT ? "#CCCCCC" : "#1A1A1E";
  return (0, n.jsx)("div", {
    className: f.container,
    ref: N,
    children: (0, n.jsxs)(s.animated.div, {
      className: f.heightContainer,
      style: (t = function(e) {
      ...
      children: [(0, n.jsx)(x, {
        className: f.scrollSvg,
        paperColor: Z,
        paperColorAlt: T,
        axleColor: H
      }), (0, n.jsx)("div", {
        className: a()(f.content, p && f.fullHeight),
        ref: b,
        children: (0, n.jsx)("div", {
          className: a()(f.innerContent, p && f.fullHeight),
          style: {
            backgroundColor: Z
          },
          children: (0, n.jsx)(s.animated.div, {
            className: a()(f.contentAnimContainer, p && f.fullHeight),
            style: P,
            children: i
          })
        })
