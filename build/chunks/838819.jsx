...
let D = e => {
  ...
  F = function(e) {
    ...
    return eo && !t ? null : <g.Gt value={es}><O.k0 newValue={{
          sessionId: a,
          pageCategory: Y,
          pageSize: w.kN
        }}><D onClose={M} shouldAddEventListener={t && !er}><div className={i()(R.shop, {
              [Z.shopTakeOver]: B
            })} ref={t ? el : ea} tabIndex={false}>{<k.I isFullScreen={t} isLayer={er} onClose={M} handleTransition={et} selectedTab={$} />}{<div className={i()(R.shopViewWrapper, {
                [R.visible]: ee === w.f7.VISIBLE,
                [R.in]: ee === w.f7.IN,
                [R.out]: ee === w.f7.OUT
              })}><P.Z tab={$} isFullScreen={t} refreshCategories={z} transitionToTab={et} transitionState={ee} sortedCategories={G} updateAnalyticsState={Q} /></div>}</div></D></O.k0></g.Gt>
  }