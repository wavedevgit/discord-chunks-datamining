...
function b(e) {
  ...
  return Object.values(b).every(e => 0 === e) ? null : <o.ua7 text={(0, c.QX)(b, {
      days: f.t.qVGNkZ,
      hours: f.t.wyg9a2,
      minutes: f.t.IzmIlZ
    })}>{e => {
...
function O(e) {
  ...
  return <m isTabSelected={n} badgeCopy={s} offerExpiresAt={i.expires_at} />
}
...
function h(e) {
  ...
  return <m isTabSelected={t} badgeCopy={i ? l : f.intl.string(f.t["/DTtr6"])} offerExpiresAt={n.expires_at} />
}
...
function m(e) {
  ...
  return null != i ? <b expiresAt={i} isTabSelected={t} trialDuration={n} /> : <div className={s()(p.premiumTrialBadge, p.premiumOfferUnackedBadge)}><o.Text variant={"eyebrow"} className={p.premiumOfferBadgeCopy}>{n}</o.Text></div>
}