...
let M = function(A) {
  let {
    ...
    secondaryColor: l,
    isDisabled: E = !1
  } = A, c = (0, f.e7)([Q.Z], () => Q.Z.getProps().originalProfile), P = null != c && c.tag !== t;
  return (0, B.jsxs)("div", {
    className: g,
    children: [(0, B.jsx)(r.vwX, {
      ...
      children: (0, B.jsx)(r.Text, {
        variant: "text-xs/medium",
        children: s.intl.format(o.default["4ZKDXl"], {
          articleUrl: n.Z.getArticleURL(D.BhN.SERVER_TAGS)
        })
      })
    })]
  })
