...
let y = function(e) {
  let {
    ...
    secondaryColor: g,
    isDisabled: j = !1
  } = e, C = (0, s.e7)([f.Z], () => f.Z.getProps().originalProfile), v = null != C && C.tag !== a;
  return (0, t.jsxs)("div", {
    className: n,
    children: [(0, t.jsx)(l.vwX, {
      ...
      children: (0, t.jsx)(l.Text, {
        variant: "text-xs/medium",
        children: p.intl.format(h.default["4ZKDXl"], {
          articleUrl: c.Z.getArticleURL(u.BhN.SERVER_TAGS)
        })
      })
    })]
  })
