...
let y = function(e) {
  let {
    ...
    secondaryColor: v,
    isDisabled: C = !1
  } = e, b = (0, s.e7)([p.Z], () => p.Z.getProps().originalProfile), N = null != b && b.tag !== i;
  return (0, n.jsxs)("div", {
    className: r,
    children: [(0, n.jsx)(o.vwX, {
      ...
      children: (0, n.jsx)(o.Text, {
        variant: "text-xs/medium",
        children: g.intl.format(f.default["4ZKDXl"], {
          articleUrl: u.Z.getArticleURL(h.BhN.SERVER_TAGS)
        })
      })
    })]
  })
