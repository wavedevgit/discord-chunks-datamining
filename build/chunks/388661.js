...
let g = function(e) {
  let {
    ...
    secondaryColor: j,
    isDisabled: v = !1
  } = e, b = (0, s.e7)([f.Z], () => f.Z.getProps().originalProfile), C = null != b && b.tag !== a;
  return (0, n.jsxs)("div", {
    className: r,
    children: [(0, n.jsx)(l.vwX, {
      ...
      children: (0, n.jsx)(l.Text, {
        variant: "text-xs/medium",
        children: h.intl.format(p.default["4ZKDXl"], {
          articleUrl: c.Z.getArticleURL(m.BhN.SERVER_TAGS)
        })
      })
    })]
  })
