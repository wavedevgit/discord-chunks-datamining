...
class f extends s.y {
  ...
  static clearAll(e) {
    return _ = e, null == f._clearAllPromise && (f._clearAllPromise = new Promise(t => {
      requestIdleCallback(() => {
        f.clearPersistQueue(e), f.allPersistKeys.forEach(t => {
  ...
  static clearPersistQueue(e) {
    ...
    }), f._writePromises.clear(), f._writeResolvers.clear()
  }
  static getAllStates() {
    return Promise.all(Array.from(f._writePromises.values())).then(() => {
      let e = {};
      return f.allPersistKeys.forEach(t => {
        var n;
  ...
  static destroy() {
    _ = null, s.y.destroy(), f.clearPersistQueue({
      type: "all"
    }), f.allPersistKeys.clear(), f.userAgnosticPersistKeys.clear()
  }
  initializeIfNeeded() {
    if (!this._isInitialized) {
      ...
      let {
        state: t,
        requiresPersist: n
      } = f.migrateAndReadStoreState(this.getClass().persistKey, this.getClass().migrations);
  ...
  static migrateAndReadStoreState(e, t) {
    if (null != _ && f.shouldClear(_, e)) return o.K.remove(e), {
      state: void 0,
      requiresPersist: !1
    };
  ...
  asyncPersist() {
    ...
    return null != r || (r = new Promise(t => {
      ...
      f._writeResolvers.set(e, [t, requestIdleCallback(r, {
        timeout: 500
      })])
    }), f._writePromises.set(e, r)), r
  }
  persist() {
    let {
      persistKey: e
