...
function $(e) {
  let {
    ...
    analyticsSubscriptionType: d = Z.NYc.PREMIUM,
    onComplete: p,
    transitionState: m,
    initialPlanId: v,
    subscriptionTier: R,
    ...
    setSelectedPlanNotification: eI,
    setStep: eS,
    setPurchaseError: eT,
    ...
    purchaseType: eM,
    defaultPlanId: ek
  } = (0, x.JL)(), ej = (0, j.Z)(), eU = c.CgR.SMALL;
  eu || (null == ej ? void 0 : ej.isLargeModal) ? eU = c.CgR.LARGE : (eN === M.h8.ADD_PAYMENT_STEPS || ed || (null == ej ? void 0 : ej.isDynamicModal)) && (eU = c.CgR.DYNAMIC);
  let {
    isGift: eG,
    giftRecipient: eB,
  ...
  }), eW = (0, S.Ng)(), eY = null != R && !eG && (0, S.Wp)(eW, R), [eK, ez] = i.useState({
    load_id: eC.loadId,
  ...
  i.useEffect(() => {
    ...
    if (null != ek && null != eh ? eO(ek) : eO(v), null != es) ev(es);
    else if (null != v) {
      var e;
      ev(null === (e = C.Z.get(v)) || void 0 === e ? void 0 : e.skuId)
    }
  }, [eO, ev, v, es, ek, eh]);
  let eQ = i.useCallback(() => {
      let e = (0, w.MY)(eB) === w.xr.CUSTOM_MESSAGE_EMOJI_SOUNDBOARD,
        t = Date.now();
      P.default.track(Z.rMx.PAYMENT_FLOW_SUCCEEDED, Q(z({}, eK), {
        is_custom_message_edited: eG && e && null != eF ? eF !== W.NW.string(W.t.ZkOo1d) : void 0,
    ...
    eX = i.useMemo(() => () => null == U ? void 0 : U(eg === k.A.COMPLETED, eb), [U, eg, eb]),
    eJ = (0, s.Z)(() => Date.now(), [eN]),
    e$ = i.useCallback(function(e) {
      ...
      let s = null != n ? n : eN;
      if (null === s || o) {
        P.default.track(Z.rMx.PAYMENT_FLOW_LOADED, Q(z({}, eK), {
      ...
      P.default.track(Z.rMx.PAYMENT_FLOW_STEP, Q(z({}, eK, r), {
        from_step: s,
        to_step: e === M.h8.ADD_PAYMENT_STEPS ? M.h8.PAYMENT_TYPE : e,
        step_duration_ms: a - eJ,
        flow_duration_ms: a - eC.startTime
      }))
    }, [eS, el, eT, eI, eN, eh, eK, eJ, eC.startTime, eQ, p, ep, eX, eD]);
  (0, T.bp)(eN, eA, e$, eE), (0, M.dZ)(eN, eg, eE), (0, A.p)(eN, eR, e$), (0, E.Z)(eX), (0, N.w)(eP, () => U(!1), eG), (0, T.D6)(eA);
  let e0 = {
      initialPlanId: v,
      subscriptionTier: R,
      handleStepChange: e$,
...
function ee(e) {
  let {
    ...
    autoTrackExposure: !1
  }), [C, P] = i.useState(!0), w = (0, l.e7)([R.Z], () => R.Z.applicationIdsFetched.has(H.CL));
  return (i.useEffect(() => {
    P(!_ || !h || g)
  ...
  }, [c, u, f, w, n, C, o, t, E, b, A, y, S, T, I, N]), C) ? (0, r.jsx)(F.Z, {}) : f ? (0, r.jsx)(m.Vq, {
    onClose: s
  }) : null
}