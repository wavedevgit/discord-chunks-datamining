...
function ee(e) {
  let {
    ...
    purchaseType: ek,
    defaultPlanId: ej
  } = (0, x.JL)(), eU = (0, j.Z)(), eG = c.CgR.SMALL;
  ...
  }), eY = (0, S.Ng)(), eK = null != R && !eB && (0, S.Wp)(eY, R), [ez, eq] = i.useState({
    load_id: eR.loadId,
  ...
  i.useEffect(() => {
    ...
    if (null != ej && null != em ? eI(ej) : eI(v), null != el) ey(el);
    else if (null != v) {
      var e;
      ey(null === (e = C.Z.get(v)) || void 0 === e ? void 0 : e.skuId)
    }
  }, [eI, ey, v, el, ej, em]);
  let eX = i.useCallback(() => {
      ...
      eB && null != eF && null != n && r && (0, O.n)(n) && (0, y.Ni)(eF.id)
    }, [ez, eZ, eV, eF, eB, eH, eR.startTime, eQ, n]),
    eJ = i.useMemo(() => () => null == U ? void 0 : U(eE === k.A.COMPLETED, ev), [U, eE, ev]),
    e$ = (0, s.Z)(() => Date.now(), [eC]),
    e0 = i.useCallback(function(e) {
      let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
        ...
        a = Date.now();
      if (e === M.h8.CONFIRM && (eX(), null == p || p(i), eh)) {
        eJ();
        return
      }
      ...
      P.default.track(H.rMx.PAYMENT_FLOW_STEP, X(q({}, ez, r), {
        from_step: s,
