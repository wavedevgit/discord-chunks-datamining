...
function ee(e) {
  let {
    ...
    purchaseType: eU,
    defaultPlanId: eG
  } = (0, x.JL)(), eB = (0, j.Z)(), eF = c.CgR.SMALL;
  e_ || (null == eB ? void 0 : eB.isLargeModal) ? eF = c.CgR.LARGE : (eR === k.h8.ADD_PAYMENT_STEPS || ep || (null == eB ? void 0 : eB.isDynamicModal)) && (eF = c.CgR.DYNAMIC);
  let {
    isGift: eV,
    giftRecipient: eZ,
  ...
  }), ez = (0, S.Ng)(), eq = null != U && !eV && (0, S.Wp)(ez, U), [eQ, eX] = i.useState(q({
    load_id: ew.loadId,
  ...
  i.useEffect(() => {
    eX(e => {
      let n = null != eS ? (0, D.aS)(eS.id, !1, eV, ex) : void 0;
      return q(X(q({}, e), {
        subscription_plan_id: null == eS ? void 0 : eS.id,
  ...
  let e$ = i.useCallback(() => {
      let e = (0, w.MY)(eZ) === w.xr.CUSTOM_MESSAGE_EMOJI_SOUNDBOARD,
        t = Date.now();
      R.default.track(H.rMx.PAYMENT_FLOW_SUCCEEDED, X(q({}, eQ), {
        is_custom_message_edited: eV && e && null != eH ? eH !== W.intl.string(W.t.ZkOo1d) : void 0,
        is_custom_emoji_sound_available: eV && e,
        emoji_name: eV && e && (null == eY ? void 0 : eY.id) == null ? null == eY ? void 0 : eY.surrogates : void 0,
        sound_id: eV && e ? null == eW ? void 0 : eW.soundId : void 0,
      ...
      eV && null != eZ && null != a && n && (0, v.n)(a) && (0, O.Ni)(eZ.id)
    }, [eQ, eY, eH, eZ, eV, eW, ew.startTime, eJ, a]),
    ...
    e2 = i.useCallback(function(e) {
      let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
        ...
        o = Date.now();
      if (e === k.h8.CONFIRM && (e$(), null == m || m(i), eg)) return void e0();
      eN(e), null == ed || ed(e), eC(null), eA(null), e === k.h8.ADD_PAYMENT_STEPS && (u.Z.wait(f.fw), u.Z.wait(_.pB));
      let s = null != n ? n : eR;
      if (null === s || a) return void R.default.track(H.rMx.PAYMENT_FLOW_LOADED, X(q({}, eQ), {
        initial_step: null != s ? s : e,
        continue_session_initial_step: eE,
        has_saved_payment_source: ek
      }));
      R.default.track(H.rMx.PAYMENT_FLOW_STEP, X(q({}, eQ, r), {
        from_step: s,
...
function et(e) {
  let {
    ...
    autoTrackExposure: !1
  }), [C, R] = i.useState(!0), w = (0, l.e7)([P.Z], () => P.Z.applicationIdsFetched.has(Y.CL));
  return (i.useEffect(() => {
    R(!_ || !h || g)
  }, [g, h, _]), (0, p.Z)("Payment Modal", C, 5, {
    hasFetchedSubscriptions: _,
    hasFetchedSubscriptionPlans: h,
    currencyLoading: g
  }, {
    ...
    null != c ? a(k.h8.ADD_PAYMENT_STEPS, {
      emitPaymentFlowLoadedEvent: !0,
      trackedFromStep: c
    }) : null != n ? a(I && N ? k.h8.PLAN_SELECT : k.h8.REVIEW) : e ? (b((0, U.nA)(E, u, O)), a(k.h8.REVIEW)) : null != t ? a(k.h8.PLAN_SELECT) : a(k.h8.SKU_SELECT)
  }, [c, u, f, w, n, C, a, t, E, b, A, O, S, T, I, N]), C) ? (0, r.jsx)(V.Z, {}) : f ? (0, r.jsx)(m.Vq, {
    onClose: s
  }) : null
}
