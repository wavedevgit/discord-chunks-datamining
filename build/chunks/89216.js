...
function g(e) {
  ...
  let {
    ...
    selected: s,
    onChange: i
  } = e, r = null != (l = (0, h.KS)(a)) ? l : c.VL1, o = n.useCallback(() => {
    i(a)
  }, [a, i]);
...
function N(e) {
  let {
    ...
    return (null != (e = a[v.sH]) ? e : []).concat(null != (l = a[v.Zb]) ? l : []).filter(e => (0, x.Z)(e.channel)).map(e => e.channel)
  }), [j, N] = n.useState(0), _ = h.find(e => e.id === m), [k, T] = n.useState(null != _ ? [_] : []), y = (0, p.Dt)(), z = k.length === h.length, I = n.useCallback(() => {
    N(1)
  }, [N]), L = n.useCallback(e => {
    T(l => l.includes(e) ? [...i().pull(l, e)] : [...l, e])
  }, [T]), A = n.useCallback(() => {
    z ? T([]) : T(h)
  }, [z, h, T]), P = n.useCallback(() => {
    k.forEach(e => {
