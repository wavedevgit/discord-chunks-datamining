        ...
        children: [(0, t.jsxs)("li", {
          ...
          children: [(0, t.jsx)("div", {
            ...
            children: (0, t.jsx)(d.Z, {
              emojiName: null == (a = p.ZP.getByName("eyes")) ? void 0 : a.surrogates
            })
          }), (0, t.jsx)(c.Text, {
            variant: "text-md/normal",
            color: "text-muted",
            children: v.intl.format(v.t["8JzOBg"], {
              emphasisHook: o
            })
          })]
        }), (0, t.jsxs)("li", {
          ...
          children: [(0, t.jsx)("div", {
            className: C.iconWrapper,
            children: (0, t.jsx)(d.Z, {
              emojiName: null == (n = p.ZP.getByName("star_struck")) ? void 0 : n.surrogates
            })
          }), (0, t.jsx)(c.Text, {
            variant: "text-md/normal",
            color: "text-muted",
            children: v.intl.format(v.t.UcGDkp, {
              emphasisHook: o
            })
          })]
        }), (0, t.jsxs)("li", {
          ...
          children: [(0, t.jsx)("div", {
            className: C.iconWrapper,
            children: (0, t.jsx)(d.Z, {
              emojiName: null == (s = p.ZP.getByName("books")) ? void 0 : s.surrogates
            })
          }), (0, t.jsx)(c.Text, {
            variant: "text-md/normal",
            color: "text-muted",
            children: v.intl.format(v.t.kALJ5u, {
              emphasisHook: o
            })
          })]
        })]
...
function b(e) {
  ...
  let {
    ...
    selected: s,
    onChange: i
  } = e, r = null != (a = (0, x.KS)(l)) ? a : c.VL1, o = n.useCallback(() => {
    i(l)
  }, [l, i]);
...
function g(e) {
  let {
    ...
    return (null != (e = l[j.sH]) ? e : []).concat(null != (a = l[j.Zb]) ? a : []).filter(e => (0, m.Z)(e.channel)).map(e => e.channel)
  }), [p, g] = n.useState(0), N = x.find(e => e.id === d), [y, k] = n.useState(null != N ? [N] : []), _ = (0, u.Dt)(), T = y.length === x.length, z = n.useCallback(() => {
    g(1)
  }, [g]), E = n.useCallback(e => {
    k(a => a.includes(e) ? [...i().pull(a, e)] : [...a, e])
  }, [k]), Z = n.useCallback(() => {
    T ? k([]) : k(x)
  }, [T, x, k]), A = n.useCallback(() => {
    y.forEach(e => {
      let a = (0, h._A)(e, e.accessPermissions, !0);
      (0, o.hw)(e.id, [a]), l()
    })
  }, [y, l]);
  return 0 === p ? (0, t.jsx)(c.Y0X, {
    transitionState: a,
    "aria-labelledby": _,
    size: c.CgR.SMALL,
    ...
    children: [(0, t.jsxs)(c.hzk, {
      ...
      children: [(0, t.jsxs)("div", {
        ...
        children: [(0, t.jsx)(c.Text, {
          ...
          color: "text-muted",
          children: v.intl.format(v.t.rrYCq6, {
            count: x.length
          })
        }), (0, t.jsxs)(c.P3F, {
        ...
        children: (0, t.jsx)(c.Text, {
          ...
          children: v.intl.format(v.t["OP/pKi"], {
            emphasisHook: e => (0, t.jsx)(c.Text, {
              tag: "span",
              variant: "text-xs/medium",
              color: "interactive-active",
              children: e
            }),
            brandHook: e => (0, t.jsx)(c.Text, {
              tag: "span",
              variant: "text-xs/normal",
              color: "text-brand",
              children: e
