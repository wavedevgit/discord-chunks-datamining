...
function b(e) {
  ...
  let {
    ...
    selected: s,
    onChange: i
  } = e, r = null != (l = (0, x.KS)(a)) ? l : o.VL1, c = n.useCallback(() => {
    i(a)
  }, [a, i]);
...
function g(e) {
  let {
    ...
    var e, l;
    let a = j.ZP.getChannels(s);
    return (null != (e = a[j.sH]) ? e : []).concat(null != (l = a[j.Zb]) ? l : []).filter(e => (0, m.Z)(e.channel)).map(e => e.channel)
  }), [p, g] = n.useState(0), k = x.find(e => e.id === d), [N, _] = n.useState(null != k ? [k] : []), T = (0, u.Dt)(), y = N.length === x.length, z = n.useCallback(() => {
    g(1)
  }, [g]), I = n.useCallback(e => {
