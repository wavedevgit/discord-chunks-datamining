...
function p() {
  let e = (0, Chunk442837.e7)([Chunk778825.Z], () => Chunk778825.Z.getIsSubmitDisabled()),
    ...
    [p, h] = Chunk473749.useState(false),
    m = Chunk473749.useMemo(() => (null == require ? true : require.message) != null ? null == require ? true : require.message : (null == require ? true : require.guild_tag) !== true && require.guild_tag.length > 0 ? require.guild_tag[0] : Object.keys(null != require ? require : {}).length > 0 ? Chunk388032.intl.string(Chunk388032.t.s35OuK) : null, [require]),
    g = Chunk473749.useCallback(async () => {
      ...
      if (Object.keys(Chunk442837).length > 0) {
        ...
        if (_ = Chunk388032 && null != (e = null == Chunk54381 ? true : Chunk54381.ok) && module, null == Chunk54381 ? true : Chunk54381.ok) {
      ...
      if (Object.keys(Chunk796027).length > 0) {
        ...
        _ = Chunk388032 && null != (r = null == module ? true : module.ok) && Chunk54381, (null == module ? true : module.ok) ? (0, Chunk18438.pG)() : (0, Chunk647699.v)()
      }
