  ...
  let C = Z.Z.getHighestRole(j),
    ...
    M = v && !h ? S.map(n => {
      let r = n.managed || !Z.Z.isRoleHigher(j, C, n),
        i = -1 !== x.indexOf(n.id);
      return r && !i ? null : (0, l.jsx)(o.S89, {
        id: n.id,
        label: () => m(n, y, _),
        disabled: r,
        action: () => {
          x.includes(n.id) ? (c.Z.updateMemberRoles(t, e, x.filter(e => e !== n.id), [], [n.id]), E(s.jQ.REMOVE_ROLE)) : (c.Z.updateMemberRoles(t, e, x.concat([n.id]), [n.id], []), E(s.jQ.ADD_ROLE))
        },
        checked: i
      }, n.id)
    }) : S.filter(e => -1 !== x.indexOf(e.id)).map(e => (0, u.pM)(j.id, e.id) ? null : (0, l.jsx)(o.sNh, {
      id: e.id,
      label: () => m(e, y, _)
    }, e.id));
  return 0 === M.filter(f.lm).length ? null : n ? M : (0, l.jsx)(o.sNh, {
    id: "roles",
