  ...
  let _ = Z.Z.getHighestRole(N),
    ...
    C = y && !O ? E.map(t => {
      ...
      return r && !i ? null : (0, l.jsx)(a.S89, {
        ...
        disabled: r,
        action: () => {
          x.includes(t.id) ? (c.Z.updateMemberRoles(n, e, x.filter(e => e !== t.id), [], [t.id]), P(s.jQ.REMOVE_ROLE)) : (c.Z.updateMemberRoles(n, e, x.concat([t.id]), [t.id], []), P(s.jQ.ADD_ROLE))
        },
        checked: i
      }, t.id)
    }) : E.filter(e => -1 !== x.indexOf(e.id)).map(e => (0, u.pM)(N.id, e.id) ? null : (0, l.jsx)(a.sNh, {
      id: e.id,
      label: () => m(e, j)
    }, e.id));
  return 0 === C.filter(b.lm).length ? null : t ? C : (0, l.jsx)(a.sNh, {
    id: "roles",
