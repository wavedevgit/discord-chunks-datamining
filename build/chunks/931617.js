  ...
  let C = Z.Z.getHighestRole(j),
    ...
    S = _ && !m ? I.map(t => {
      ...
      return i && !r ? null : (0, l.jsx)(a.S89, {
        ...
        disabled: i,
        action: () => {
          y.includes(t.id) ? (c.Z.updateMemberRoles(n, e, y.filter(e => e !== t.id), [], [t.id]), x(s.jQ.REMOVE_ROLE)) : (c.Z.updateMemberRoles(n, e, y.concat([t.id]), [t.id], []), x(s.jQ.ADD_ROLE))
        },
        checked: r
      }, t.id)
    }) : I.filter(e => -1 !== y.indexOf(e.id)).map(e => (0, u.pM)(j.id, e.id) ? null : (0, l.jsx)(a.sNh, {
      id: e.id,
      label: () => h(e, v, E)
    }, e.id));
