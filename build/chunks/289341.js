...
function h(e) {
  ...
  let {
    ...
    applicationId: E
  } = h.params, [_] = (0, c.Z)([E]), O = null == _ || null == (t = _.bot) ? true : t.id, I = (0, i.e7)([d.default], () => d.default.getCurrentUser());
  return r.useEffect(() => {
    null != O && null != I && (async () => {
      try {
        var e;
        let t = new URL(location.href),
          ...
          {
            customId: i
          } = await (0, f.ur)(E, t.searchParams.get("link_id"), t.searchParams.get("custom_id"));
        await (0, p.Z)({
