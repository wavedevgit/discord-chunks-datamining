...
let h = "".concat("#").concat("itemSkuId", "="),
  ...
  O = e => {
    ...
    } = e, d = (0, a.e7)([i.Z], () => i.Z.useReducedMotion), b = r.useRef(null), p = (0, l.TH)(), h = p.pathname === g.Z5c.COLLECTIBLES_SHOP ? o.Z.HOME_PAGE_SHOP_TAB : p.pathname === g.Z5c.COLLECTIBLES_SHOP_FULLSCREEN ? o.Z.COLLECTIBLES_SHOP_FULLSCREEN : o.Z.COLLECTIBLES_SHOP, {
