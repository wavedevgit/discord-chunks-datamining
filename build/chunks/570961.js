...
function E(e, t, n) {
  T(e, m.Z.editedOnboardingPrompts.map(e => e.id === t ? N({}, e, n) : e))
}
...
function j(e, t, n) {
  let l = {
    ...
    i = !1;
  return n.title.length <= 0 && (l.title = g.intl.string(g.t.h8Hg1d), i = !0), n.options.length <= 0 && (l.options = g.intl.string(g.t["64tF+f"]), i = !0), n.inOnboarding && t.filter(e => e.inOnboarding).length > h.b3 && (l.config = g.intl.formatToPlainString(g.t["cTb/rq"], {
    numQuestions: h.b3
  }), i = !0), l.optionErrors = n.options.map(l => b(e, t, n, l)), (i = i || l.optionErrors.some(e => null != e)) ? l : null
}
