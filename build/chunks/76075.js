...
let v = function(n) {
  let {
    ...
    transitionState: e,
    onClose: v
  } = n, R = (0, s.q)("MemberVerificationRejectedModal"), C = (0, r.Dt)(), _ = (0, l.e7)([x.Z], () => x.Z.getRequest(t), [t]), b = (0, l.e7)([d.Z], () => d.Z.getGuild(t), [t]), Z = (0, l.e7)([u.default], () => {
    var n;
    return null == (n = u.default.getCurrentUser()) ? void 0 : n.id
  }), T = (0, l.e7)([c.ZP], () => null != Z ? c.ZP.getMember(t, Z) : null, [Z, t]), y = () => {
    v(), null == T && (0, h.Z)()
  }, P = async () => {
  ...
  return R ? (0, i.jsx)(a.u, {
    transitionState: e,
    onClose: v,
    title: (null == b ? void 0 : b.name) != null ? g.intl.formatToPlainString(g.t["P+/gzM"], {
      guildName: b.name
    }) : g.intl.string(g.t.gBPcuL),
    actions: [{
    ...
    children: (null == _ ? void 0 : _.rejectionReason) != null && (null == _ ? void 0 : _.rejectionReason) !== "" ? (0, i.jsxs)(o.Text, {
      ...
      children: [(0, i.jsx)("span", {
        ...
        children: null == _ ? void 0 : _.rejectionReason
      })]
    }) : null
  }) : (0, i.jsx)(o.Y0X, {
    size: o.CgR.DYNAMIC,
