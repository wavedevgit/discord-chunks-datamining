...
let h = function(n) {
  let {
    ...
    transitionState: e,
    onClose: h
  } = n, v = (0, a.e7)([p.Z], () => p.Z.getRequest(t), [t]), C = (0, a.e7)([u.Z], () => u.Z.getGuild(t), [t]), R = (0, a.e7)([c.default], () => {
    var n;
  ...
  }, [t, null == x ? void 0 : x.isPending, h]), k = o.useMemo(() => [{
  ...
  return (0, i.jsx)(l.u, {
    transitionState: e,
    onClose: h,
    title: (null == C ? void 0 : C.name) != null ? g.intl.formatToPlainString(g.t["P+/gzM"], {
      guildName: C.name
    }) : g.intl.string(g.t.gBPcuL),
    actions: k,
    children: (null == v ? void 0 : v.rejectionReason) != null && (null == v ? void 0 : v.rejectionReason) !== "" ? (0, i.jsxs)(r.Text, {
      ...
      children: [(0, i.jsx)("span", {
        ...
        children: null == v ? void 0 : v.rejectionReason
      })]
    }) : null
  })
}