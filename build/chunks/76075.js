...
let v = function(n) {
  let {
    ...
    transitionState: e,
    onClose: v
  } = n, R = (0, s.q)("MemberVerificationRejectedModal"), C = (0, r.Dt)(), _ = (0, l.e7)([x.Z], () => x.Z.getRequest(t), [t]), b = (0, l.e7)([c.Z], () => c.Z.getGuild(t), [t]), Z = (0, l.e7)([u.default], () => {
    var n;
    return null == (n = u.default.getCurrentUser()) ? void 0 : n.id
  }), T = (0, l.e7)([d.ZP], () => null != Z ? d.ZP.getMember(t, Z) : null, [Z, t]), y = () => {
    v(), null == T && (0, h.Z)()
  }, P = async () => {
