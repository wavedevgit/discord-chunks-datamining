...
function A(e) {
  ...
  let {
    ...
    onDisable: c,
    onCrashDisabled: u
  } = e, m = l.useMemo(() => new o.SpringValue(1), []), h = l.useRef(null), [b, g] = l.useState(!1), [O, S] = l.useState(!1), j = (0, d.e7)([y.default], () => y.default.getCurrentUser());
