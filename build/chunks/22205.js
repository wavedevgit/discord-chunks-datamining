...
function x(e) {
  ...
  let {
    ...
    onDisable: c,
    onCrashDisabled: u
  } = e, _ = i.useMemo(() => new s.SpringValue(1), []), h = i.useRef(null), [g, E] = i.useState(!1), [O, v] = i.useState(!1), I = (0, d.e7)([b.default], () => b.default.getCurrentUser());
  (0, m.ZP)(() => (h.current = setTimeout(T, L), p.Z.track(C.rMx.NOTIFICATION_VIEWED, {
  ...
  render() {
    ...
    return null != n ? i ? (0, r.jsx)(T.Z, {
      ...
      children: (0, r.jsx)(x, {
        ...
        onReload: () => {
          p.Z.setReloadOverlay((0, v.getPID)()), this.setState({
            showError: !1
          })
        }
      })
