...
function M(e) {
  ...
  let {
    ...
    onDisable: a,
    onCrashDisabled: u
  } = e, p = r.useMemo(() => new s.SpringValue(1), []), m = r.useRef(null), [v, g] = r.useState(!1), [x, C] = r.useState(!1), j = (0, d.e7)([y.default], () => y.default.getCurrentUser());
  (0, b.ZP)(() => (m.current = setTimeout(w, D), f.Z.track(S.rMx.NOTIFICATION_VIEWED, {
  ...
  let w = r.useCallback(() => {
    ...
    N = r.useCallback(e => {
      x || (C(!0), null == o || o(), f.Z.track(S.rMx.NOTIFICATION_CLICKED, {
        notif_type: E.n0.OverlayCrashed,
        action_type: "reload"
    ...
    return null != n ? r ? (0, i.jsx)(w.Z, {
      ...
      children: (0, i.jsx)(M, {
        ...
        onLock: () => {
          ...
          f.Z.setInputLocked(!0, t), this.setState({
            showError: !1
          })
        },
        onDisable: () => {
        ...
        onCrashDisabled: () => {
          var e;
          let t = null != (e = this.pid) ? e : (0, j.getPID)();
          f.Z.updateOverlayState(t, m.mM.OVERLAY_CRASHED_DISABLED), this.setState({
            showError: !1
          })
        },
        onReload: () => {
          f.Z.setReloadOverlay((0, j.getPID)()), this.setState({
            showError: !1
          })
        }
      })
