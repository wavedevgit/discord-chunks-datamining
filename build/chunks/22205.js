...
function x(e) {
  ...
  let {
    ...
    onDisable: c,
    onCrashDisabled: u
  } = e, f = i.useMemo(() => new s.SpringValue(1), []), m = i.useRef(null), [g, y] = i.useState(!1), [O, v] = i.useState(!1), I = (0, d.e7)([E.default], () => E.default.getCurrentUser());
  ...
  let T = i.useCallback(() => {
    ...
    w = i.useCallback(e => {
      O || (v(!0), null == o || o(), p.Z.track(C.rMx.NOTIFICATION_CLICKED, {
        notif_type: N.n0.OverlayCrashed,
        action_type: "reload"
    ...
    return null != n ? i ? (0, r.jsx)(T.Z, {
      ...
      children: (0, r.jsx)(x, {
        ...
        onCrashDisabled: () => {
          var e;
          let t = null != (e = this.pid) ? e : (0, O.getPID)();
          p.Z.updateOverlayState(t, I.mM.OVERLAY_CRASHED_DISABLED), this.setState({
            showError: !1
          })
        },
        onReload: () => {
          p.Z.setReloadOverlay((0, O.getPID)()), this.setState({
            showError: !1
          })
        }
      })
