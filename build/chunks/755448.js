...
e.exports = function(e, r) {
  var i, o, a, s, l, c, u, d, f, _, p, h, m, g, E, b, v, y, O, I, S, T, N, A, C;
  i = e.state, o = e.next_in, A = e.input, a = o + (e.avail_in - 5), s = e.next_out, C = e.output, l = s - (r - e.avail_out), c = s + (e.avail_out - 257), u = i.dmax, d = i.wsize, f = i.whave, _ = i.wnext, p = i.window, h = i.hold, m = i.bits, g = i.lencode, E = i.distcode, b = (1 << i.lenbits) - 1, v = (1 << i.distbits) - 1;
  r: do
      for (m < 15 && (h += A[o++] << m, m += 8, h += A[o++] << m, m += 8), y = g[h & b];;) {
        if (h >>>= O = y >>> 24, m -= O, 0 == (O = y >>> 16 & 255)) C[s++] = 65535 & y;
        else if (16 & O)
          for (I = 65535 & y, (O &= 15) && (m < O && (h += A[o++] << m, m += 8), I += h & (1 << O) - 1, h >>>= O, m -= O), m < 15 && (h += A[o++] << m, m += 8, h += A[o++] << m, m += 8), y = E[h & v];;) {
