...
function H(e) {
  ...
  } = (0, T.zb)(), ec = (0, u.a5)(ee), ep = (null == (r = (0, _.Z)()) ? void 0 : r.planSelectionBanner) != null, eu = ea && ec && null != eC && eC.length > 0 && ep, e_ = (0, M.m)(X, Q), {
    newPlans: ex
  } = c.ZP.useExperiment({
    location: "d17fd6_3"
  }, {
    autoTrackExposure: !1
  }), ef = (0, l.e7)([g.default], () => g.default.getCurrentUser()), em = !ea && null != $ && $ === k.Si.TIER_2 && null != ef && ef.hasHadPremium() && J && null == q && (0, c.aQ)(e_), eh = (0, m.N)(K), ej = !ea && null != eh && null != $ && k.nG[eh.trial_id].skus.includes($), eL = (0, f.Ng)(), eg = null == eL || null == (n = eL.discount) ? void 0 : n.plan_ids.some(e => k.GP[e].skuId === $), eb = !ea && null != eL && null != $ && eg, ey = null != (o = ej || eb) && o, eS = i.useMemo(() => (0, v.V7)({
    skuId: $,
    isPremium: ei,
