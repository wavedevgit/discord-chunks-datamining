...
function B(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), ej = (0, a.e7)([g.default], () => g.default.getCurrentUser()), ef = !es && null != $ && $ === R.Si.TIER_2 && null != ej && ej.hasHadPremium() && J && null == q && (0, c.aQ)(ex), e_ = (0, f.N)(K), em = !es && null != e_ && null != $ && R.nG[e_.trial_id].skus.includes($), eL = (0, j.Ng)(), eg = null == eL || null == (t = eL.discount) ? void 0 : t.plan_ids.some(e => R.GP[e].skuId === $), ey = !es && null != eL && null != $ && eg, eS = null != (r = em || ey) && r, eE = l.useMemo(() => (0, v.V7)({
    skuId: $,
    isPremium: el,
    multiMonthPlans: ef ? eh : [],
    currentSubscription: q,
    defaultPlanId: et
  }), [$, el, eh, q, ef, et]), ev = ey && eE.includes(R.Xh.PREMIUM_MONTH_TIER_2) ? R.Xh.PREMIUM_MONTH_TIER_2 : eE[0], eb = (0, a.e7)([y.Z], () => y.Z.get(ev)), eP = [{
  ...
  let eM = null != (B = null == ew ? void 0 : ew.message) ? B : F.intl.string(F.t.R0RpRU),
    ...
    eU = null;
  return (eU = null != ed ? ed : ek ? (0, i.jsx)(m.Z, {}) : (0, i.jsx)(_.Z, {}), eN) ? (0, i.jsx)(w.Z, {}) : (s()(null != en, "Step should be set"), s()(eE.length > 0, "Premium plan options should be set"), (0, i.jsxs)(i.Fragment, {
    children: [(0, i.jsx)(A.P, {
      giftMessage: eo
    }), !(es && (0, S.pO)(ea)) && (0, i.jsx)(I.Z, {
