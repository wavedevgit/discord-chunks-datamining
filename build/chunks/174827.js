...
function B(e) {
  ...
  let {
    ...
    planSelectBanner: eo
  } = (0, P.zb)(), ea = (0, p.a5)(J), eC = (null === (t = (0, _.Z)()) || void 0 === t ? void 0 : t.planSelectionBanner) != null, ed = er && ea && null != es && es.length > 0 && eC, ec = null != V ? Q[V] : null, {
    newPlans: eu
  } = c.ZP.useExperiment({
    location: "d17fd6_3"
  }, {
    autoTrackExposure: !1
  }), ep = (0, o.e7)([g.default], () => g.default.getCurrentUser()), e_ = !er && null != q && q === A.Si.TIER_2 && null != ep && ep.hasHadPremium() && X && null == K && (0, c.aQ)(ec), ex = (0, h.N)(Y), ef = !er && null != ex && null != q && A.nG[ex.trial_id].skus.includes(q), eh = (0, f.Ng)(), ej = null == eh ? void 0 : null === (n = eh.discount) || void 0 === n ? void 0 : n.plan_ids.some(e => A.GP[e].skuId === q), em = !er && null != eh && null != q && ej, eL = null !== (l = ef || em) && void 0 !== l && l, eg = i.useMemo(() => (0, b.V7)({
    skuId: q,
    isPremium: en,
    multiMonthPlans: e_ ? eu : [],
    currentSubscription: K,
    defaultPlanId: ee
  }), [q, en, eu, K, e_, ee]), eS = em && eg.includes(A.Xh.PREMIUM_MONTH_TIER_2) ? A.Xh.PREMIUM_MONTH_TIER_2 : eg[0], ey = (0, o.e7)([S.Z], () => S.Z.get(eS)), eE = [{
    planId: null == ey ? void 0 : ey.id,
    quantity: 1
  }], [eb, eN] = i.useState(eL), [eI, ev] = (0, u.ED)({
    items: eE,
    renewal: !1,
    preventFetch: !eL,
    applyEntitlements: !0,
  ...
  }, [eI, eL]), (0, C.Z)("Payment Modal Plan Select Step", eb, 5, {
  ...
  let eP = null !== (B = null == ev ? void 0 : ev.message) && void 0 !== B ? B : R.NW.string(R.t.R0RpRU),
    ...
    ew = null;
  return (ew = null != eo ? eo : eO ? (0, r.jsx)(m.Z, {}) : (0, r.jsx)(j.Z, {}), eZ) ? (0, r.jsx)(T.Z, {}) : (s()(null != $, "Step should be set"), s()(eg.length > 0, "Premium plan options should be set"), (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(O.P, {
      giftMessage: el
    }), !(er && (0, y.pO)(ei)) && (0, r.jsx)(M.Z, {
      isEligibleForTrial: ef
    }), (0, r.jsxs)(Z.C3, {
      children: [eM && (0, r.jsx)("hr", {
        className: F.planSelectSeparatorUpper
      }), ew, (0, r.jsx)(k.Z, {}), (0, r.jsx)(w.Z, {}), eT ? (0, r.jsx)(a.kzN, {
        children: eP
      }) : (0, r.jsx)(L.O, {
        planOptions: eg,
        ...
        children: [(0, r.jsx)("hr", {
          ...
          children: R.NW.format(R.t.BHtnqK, {
            link: E.Z.getArticleURL(U.BhN.PREMIUM_DETAILS_CANCEL_SUB)
          })
        })]
      })]
    }), (0, r.jsxs)(Z.O3, {
      children: [ed && (0, r.jsx)(x.c, {}), (0, r.jsx)(a.mzw, {
