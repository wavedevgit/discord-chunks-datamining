...
function H(e) {
  ...
  let {
    ...
    priceOptions: el,
    isPremium: ei,
    premiumRebrandBackgroundClassName: er
  } = (0, P.JL)(), {
    isGift: es,
    giftRecipient: ea,
    giftMessage: eo,
    ...
    autoTrackExposure: !1
  }), ej = (0, a.e7)([g.default], () => g.default.getCurrentUser()), ef = !es && null != $ && $ === R.Si.TIER_2 && null != ej && ej.hasHadPremium() && J && null == q && (0, c.aQ)(ex), em = (0, f.N)(K), e_ = !es && null != em && null != $ && R.nG[em.trial_id].skus.includes($), eL = (0, j.Ng)(), eg = null == eL || null == (t = eL.discount) ? void 0 : t.plan_ids.some(e => R.GP[e].skuId === $), ey = !es && null != eL && null != $ && eg, eS = null != (r = e_ || ey) && r, eE = i.useMemo(() => (0, v.V7)({
    skuId: $,
    isPremium: ei,
    multiMonthPlans: ef ? eh : [],
    currentSubscription: q,
    defaultPlanId: et
  }), [$, ei, eh, q, ef, et]), ev = ey && eE.includes(R.Xh.PREMIUM_MONTH_TIER_2) ? R.Xh.PREMIUM_MONTH_TIER_2 : eE[0], eb = (0, a.e7)([y.Z], () => y.Z.get(ev)), eP = [{
    planId: null == eb ? void 0 : eb.id,
    quantity: 1
  }], [eZ, eO] = i.useState(eS), [eI, ew] = (0, u.ED)({
    items: eP,
    renewal: !1,
    preventFetch: !eS,
    applyEntitlements: !0,
  ...
  let eM = null != (H = null == ew ? void 0 : ew.message) ? H : F.intl.string(F.t.R0RpRU),
    ...
    eU = null;
  return (eU = null != ed ? ed : eN ? (0, l.jsx)(_.Z, {}) : (0, l.jsx)(m.Z, {}), ek) ? (0, l.jsx)(w.Z, {}) : (s()(null != en, "Step should be set"), s()(eE.length > 0, "Premium plan options should be set"), (0, l.jsxs)(l.Fragment, {
    children: [(0, l.jsx)(A.P, {
      ...
      }), eU, (0, l.jsx)(N.Z, {}), (0, l.jsx)(k.Z, {}), eA ? (0, l.jsx)(o.kzN, {
        children: eM
      }) : (0, l.jsx)(L.O, {
        planOptions: eE,
