...
function H(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), ef = (0, a.e7)([g.default], () => g.default.getCurrentUser()), ej = !es && null != $ && $ === R.Si.TIER_2 && null != ef && ef.hasHadPremium() && J && null == q && (0, c.aQ)(ex), e_ = (0, j.N)(K), em = !es && null != e_ && null != $ && R.nG[e_.trial_id].skus.includes($), eL = (0, f.Ng)(), eg = null == eL || null == (t = eL.discount) ? void 0 : t.plan_ids.some(e => R.GP[e].skuId === $), ey = !es && null != eL && null != $ && eg, eE = null != (r = em || ey) && r, eS = l.useMemo(() => (0, v.V7)({
    skuId: $,
    isPremium: el,
    multiMonthPlans: ej ? eh : [],
    currentSubscription: q,
    defaultPlanId: et
  }), [$, el, eh, q, ej, et]), ev = ey && eS.includes(R.Xh.PREMIUM_MONTH_TIER_2) ? R.Xh.PREMIUM_MONTH_TIER_2 : eS[0], eP = (0, a.e7)([y.Z], () => y.Z.get(ev)), eZ = [{
    planId: null == eP ? void 0 : eP.id,
    quantity: 1
  }], [eb, eO] = l.useState(eE), [eI, eM] = (0, u.ED)({
    items: eZ,
    renewal: !1,
    preventFetch: !eE,
    applyEntitlements: !0,
  ...
  let ew = null != (H = null == eM ? void 0 : eM.message) ? H : B.intl.string(B.t.R0RpRU),
    ...
    eN = null;
  return (eN = null != ed ? ed : eU ? (0, i.jsx)(m.Z, {}) : (0, i.jsx)(_.Z, {}), ek) ? (0, i.jsx)(M.Z, {}) : (s()(null != en, "Step should be set"), s()(eS.length > 0, "Premium plan options should be set"), (0, i.jsxs)(i.Fragment, {
    children: [(0, i.jsx)(A.P, {
      ...
      }), eN, (0, i.jsx)(U.Z, {}), (0, i.jsx)(k.Z, {}), eA ? (0, i.jsx)(o.kzN, {
        children: ew
      }) : (0, i.jsx)(L.O, {
        planOptions: eS,
