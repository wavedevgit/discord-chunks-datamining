/** Chunk was on 67544 **/
/** chunk id: 639133, original params: e,t,n (module,exports,require) **/
require.d(exports, {
  Z: () => Z
}), require("./388685.js");
...
function _(e) {
  ...
  return (0, s.useEffect)(() => {
    l()
  }, []), <div className={y.container}>{<div className={y.message}>{<img src={null == t ? true : t.avatar} alt={""} className={y.avatar} />}{<div className={y.messageContent}>{<div className={y.authorName}>{<o.xv variant={"text-md/medium"} color={"text-primary"}>{null == t ? true : t.username}</o.xv>}{<o.xv variant={"text-sm/normal"} color={"text-muted"}>{(0, a.Y4)(new Date)}</o.xv>}</div>}{<o.xv variant={"text-md/normal"} color={"text-secondary"}>{null == t ? true : t.content}</o.xv>}</div>}</div>}{<div className={y.input}>{null != n ? (0, r.jsxs)(r.Fragment, {
      ...
      }) : null == t ? true : t.responses.map((e, t) => (0, r.jsx)(u.Z, {
...
let C = [Chunk477839.FK.MESSAGE_1, Chunk477839.FK.MESSAGE_2, Chunk477839.FK.MESSAGE_3];

function Z(e) {
  var t;
  let {
    isPaused: n
  } = e, o = (0, s.useRef)(null), a = (0, s.useRef)(false), [u, f] = (0, s.useState)(0), [g, b] = (0, s.useState)(null), y = P()[u], [h, x] = (0, c.Z)(m.yN.MESSAGES), v = null != (t = h.count) ? t : 0;
  (0, l.Z)(C, v);
  let O = (0, d.eR)(N),
    j = (e, t, n) => {
      b({
  ...
  return ((0, s.useEffect)(() => () => clearTimeout(a.current), []), u >= P().length) ? null : <p.Z ref={o} isPaused={n} itemId={m.yN.MESSAGES} chance={.1} points={0} maxDrops={1} width={0} height={0}>{e => (0, r.jsx)(_, {
      currentMessage: y,
      response: g,
      handleResponse: j,
      index: e,
