...
class K extends Chunk98597.ZP {
  ...
  renderVoiceUsers() {
    ...
    return <Chunk207055.Z channel={module} voiceStates={Chunk73800} collapsed={exports} tabIndex={require} location={Chunk981631.Sbl.GUILD_CHANNEL_LIST} numAudience={Chunk120356} />
  }
  renderChannelInfo() {
  ...
  render() {
    let {
      ...
      shouldShowGuildVerificationPopout: C
    } = this.state, v = this.getVoiceStatesCount(), j = <li className={o()(this.getModeClass(), {
        [Chunk915887.disabled]: this.isDisabled()
      })} data-dnd-name={module.name}>{<Chunk481060.yRy targetElementRef={this.channelItemRef} position={"right"} renderPopout={this.renderPopout} spacing={0} onRequestClose={this.closeGuildVerificationPopout} shouldShow={Chunk431328}>{() => (0, Chunk255367.jsx)(Chunk481060.ua7, {
        ...
        })}</Chunk481060.yRy>}{this.renderVoiceUsers()}</li>;
    return Chunk888651 && (j = Chunk475179(Chunk427679)), Chunk146773 && (j = Chunk120356(Chunk442837(Chunk427679))), Chunk427679
  }
  constructor(...e) {
    super(...e), H(this, "channelItemRef", i.createRef()), H(this, "state", {
      ...
      if (t) return <O.Z type={O.R.VOICE} guildId={e.guild_id} closePopout={this.closeGuildVerificationPopout} />;
      ...
      if (!t) return <a.ua7 text={B.intl.string(B.t.ZXxLQk)}>{t => {
          let {
            onMouseEnter: i,
            onMouseLeave: l,
            onFocus: s,
