...
let W = e => {
  ...
  q = e => {
    var t, {
      ...
      p = B(e, ["index"]);
    let [m, g] = i.useState("default"), E = (0, s.JA)("".concat(o)), v = null == (t = b.default.getCurrentUser()) ? void 0 : t.isStaff(), {
      isRich: O,
      appName: I
