...
function R(e, t) {
  return <f.Z sticker={e} isInteracting={t} size={40} />
}
...
let D = {
  ...
  renderResults(e) {
    ...
    return <r.Fragment>{(0, m.HI)({
      ...
      }) : null}{h && g && <o.ZP.Divider className={O.divider} />}{(0, m.HI)({
        query: u,
        selectedIndex: c,
        autocompletes: a,
        onHover: d,
      ...
      })}{(h || g) && s.length > 0 && <o.ZP.Divider className={O.divider} />}{(0, m.HI)({
        query: u,
        selectedIndex: c,
        autocompletes: s,
        onHover: d,
