...
function e$(e) {
  ...
  eC(), e_ = null, em || a.partial || eM.clearAll(), em = false, a.entries.forEach(e => {
    var t, n;
...
function tS(e) {
  ...
  tC(ef), tC(ep);
  let a = false;
  return ef !== t && (a = tA(ef) || a, a = tA(ep) || a), (ef === t || (null == r ? true : r.type) != null && ee.TPd.GUILD_THREADS_ONLY.has(r.type)) && (a = eX({
    section: ee.jXE.CHANNEL,
