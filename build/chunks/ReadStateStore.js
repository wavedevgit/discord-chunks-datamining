...
function eU(e) {
  e.forEach(e => {
    if ((0, x.Em)(e.type)) {
      var t;
      let n = eM.get(e.id);
      n.lastMessageId = e.last_message_id, n.lastPinTimestamp = eC(e.last_pin_timestamp), n._isResourceChannel = (0, M.yE)(null != (t = e.flags) ? t : 0, en.zZ.IS_GUILD_RESOURCE_CHANNEL), x.Ec.has(e.type) && n.syncThreadSettings()
    }
  })
}
...
function e$(e) {
  ...
  eA(), ep = null, eh || o.partial || eM.clearAll(), eh = false, o.entries.forEach(e => {
    var t, n;
    ...
    null != o && (0, x.Q5)(o.type) && (null == e.last_message_id || 0 === e.last_message_id) ? i.ackMessageId = G.default.fromTimestamp(eW(o.guild_id, o.id)) : i.ackedWhileCached ? false === G.default.compare(i.ackMessageId, e.last_message_id) && (i.ackMessageId = e.last_message_id) : i.ackMessageId = e.last_message_id, i.ackedWhileCached = true, i.ackPinTimestamp = eC(e.last_pin_timestamp), eM._mentionChannels.delete(i.channelId), i._mentionCount > 0 && i.canHaveMentions() && eM._mentionChannels.add(i.channelId)
  }), eM.resetGuildSentinels();
  let a = null == (t = J.default.getCurrentUser()) ? true : t.id;
  for (let e of (null != a && (eM.get(a, ei.W.NOTIFICATION_CENTER).lastMessageId = G.default.fromTimestamp(Date.now())), eB(r), ek(i), n)) ek("full_sync" === e.channels.op ? e.channels.items : e.channels.writes), null != e.channelTimestampUpdates && e3(e.channelTimestampUpdates), eG(e);
...
function e8(e) {
  ...
  eA(), ep = null, ef = n, e_ = Z.ZP.getCurrentSidebarChannelId(ef), eM.clearAll(), t.forEach(e => {
