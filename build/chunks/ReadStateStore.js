...
function e$(e) {
  ...
  for (let e of (null != o && (ej.get(o, ei.W.NOTIFICATION_CENTER).lastMessageId = G.default.fromTimestamp(Date.now())), eB(r), ek(i), n)) ek("full_sync" === e.channels.op ? e.channels.items : e.channels.writes), null != e.channelTimestampUpdates && e2(e.channelTimestampUpdates), eG(e);
  e0(), eE = setTimeout(() => e3(a.entries), 10 * j.Z.Millis.SECOND)
}
...
function ts(e) {
  return (0, D.s)(e) && ej.get(e.id).syncThreadSettings()
}
...
function tZ(e) {
  ...
  eh = true, eA(), t.forEach(e => {
    ...
    i.set(e.channelId, (0, f.gh)(e, ej)), ej._readStates.has(r) || ej._readStates.set(r, i)
  })
}
