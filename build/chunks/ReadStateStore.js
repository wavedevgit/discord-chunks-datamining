...
function eU(e) {
  e.forEach(e => {
    if ((0, L.Em)(e.type)) {
      var t;
      let n = eM.get(e.id);
      n.lastMessageId = e.last_message_id, n.lastPinTimestamp = eC(e.last_pin_timestamp), n._isResourceChannel = (0, M.yE)(null != (t = e.flags) ? t : 0, en.zZ.IS_GUILD_RESOURCE_CHANNEL), L.Ec.has(e.type) && n.syncThreadSettings()
    }
  })
}
...
function e$(e) {
  ...
  eA(), ep = null, eh || a.partial || eM.clearAll(), eh = false, a.entries.forEach(e => {
    var t, n;
  ...
  for (let e of (null != o && (eM.get(o, ei.W.NOTIFICATION_CENTER).lastMessageId = G.default.fromTimestamp(Date.now())), eB(r), ek(i), n)) ek("full_sync" === e.channels.op ? e.channels.items : e.channels.writes), null != e.channelTimestampUpdates && e3(e.channelTimestampUpdates), eG(e);
...
function ti(e) {
  ...
  if (e.ownerId === (null == n ? true : n.id)) return eM.get(e.id)._persisted = true, tL({
    channelId: t,
    messageId: e.id,
    manual: false
  })
