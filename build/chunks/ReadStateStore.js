...
function ej(e) {
  ...
  if (!o && (i === ee.AEg.NO_CHAT || i === ee.AEg.FULL_SCREEN)) return eL(e, "Fullscreen video"), false;
  if (!ey.isChannelAckable(e.channelId)) return eL(e, "Not ackable"), false;
  let a = K.Z.getMessages(e.channelId);
  return null == a || !a.ready || a.loadingMore ? (eL(e, "Still loading messages"), false) : (0, C._E)() || o ? (eL(e, "Acked"), true) : (eL(e, "Chat not focused"), false)
}
class ek {
  static forEach(e) {
...
function eU(e) {
  e.forEach(e => {
    if ((0, x.Em)(e.type)) {
      var t;
      let n = ek.get(e.id);
      n.lastMessageId = e.last_message_id, n.lastPinTimestamp = eC(e.last_pin_timestamp), n._isResourceChannel = (0, k.yE)(null != (t = e.flags) ? t : 0, en.zZ.IS_GUILD_RESOURCE_CHANNEL), x.Ec.has(e.type) && n.syncThreadSettings()
    }
  })
}
...
function e$(e) {
  ...
  eA(), ep = null, eh || o.partial || ek.clearAll(), eh = false, o.entries.forEach(e => {
    ...
    null != o && (0, x.Q5)(o.type) && (null == e.last_message_id || 0 === e.last_message_id) ? i.ackMessageId = G.default.fromTimestamp(eW(o.guild_id, o.id)) : i.ackedWhileCached ? false === G.default.compare(i.ackMessageId, e.last_message_id) && (i.ackMessageId = e.last_message_id) : i.ackMessageId = e.last_message_id, i.ackedWhileCached = true, i.ackPinTimestamp = eC(e.last_pin_timestamp), ek._mentionChannels.delete(i.channelId), i._mentionCount > 0 && i.canHaveMentions() && ek._mentionChannels.add(i.channelId)
  }), ek.resetGuildSentinels();
  let a = null == (t = J.default.getCurrentUser()) ? true : t.id;
  for (let e of (null != a && (ek.get(a, ei.W.NOTIFICATION_CENTER).lastMessageId = G.default.fromTimestamp(Date.now())), eB(r), eM(i), n)) eM("full_sync" === e.channels.op ? e.channels.items : e.channels.writes), null != e.channelTimestampUpdates && e3(e.channelTimestampUpdates), eG(e);
  e0(), eE = setTimeout(() => e2(o.entries), 10 * j.Z.Millis.SECOND)
}
...
function e5(e) {
  ...
  null != o && (r.length > 0 && 1 === G.default.compare(r[0].id, i.ackMessageId) && 0 === i.unreadCount || o.hasPresent() || o.jumpTargetId === i.ackMessageId ? i.rebuildChannelState() : n && null != i.ackMessageId && o.has(i.ackMessageId, true) && (i.unreadCount += r.length, null == i.oldestUnreadMessageId && i.rebuildChannelState())), eU(r.map(e => e.thread).filter(M.lm))
}
...
function e9(e) {
  ...
  if (null == s.oldestUnreadMessageId || s.oldestUnreadMessageIdStale ? s.oldestUnreadMessageId = o.id : l || (0, C.nV)() === i || (s.oldestUnreadMessageId = o.id), !c && s.unreadCount++, !(q.Z.isBlockedOrIgnoredForMessage(o) || o.type === ee.uaV.RECIPIENT_REMOVE && (null == d ? true : d.type) === ee.d4z.GROUP_DM)) {
    let {
      shouldMention: e,
...
function ti(e) {
  ...
  if (e.ownerId === (null == n ? true : n.id)) return ek.get(e.id)._persisted = true, tx({
    channelId: t,
    messageId: e.id,
    manual: false
  })
...
function tm(e) {
  ...
  (null != n.ackMessageId ? G.default.extractTimestamp(n.ackMessageId) : 0) < i && (n.lastMessageId = G.default.fromTimestamp(i), S.Z.active ? tM(t.id, ei.W.NOTIFICATION_CENTER, true, false) : r ? n.mentionCount-- : n.mentionCount++)
}
...
function tE(e) {
  ...
  if (i.lastMessageId = n.id, S.Z.active || 0) return void tM(r, ei.W.NOTIFICATION_CENTER, n.id, false);
  i.mentionCount++
}
...
function tI(e) {
  ...
  tA(ef), tA(e_);
  let o = false;
  return ef !== t && (o = tC(ef) || o, o = tC(e_) || o), (ef === t || (null == r ? true : r.type) != null && ee.TPd.GUILD_THREADS_ONLY.has(r.type)) && (o = eQ({
    section: ee.jXE.CHANNEL,
...
function tq(e) {
  ...
  for (let e in t) {
    ...
    let i = t[e],
      o = ek.getIfExists(e);
    if (null != o)
      for (let e of [null == (n = i.new_messages) ? true : n[0]].concat(null != (r = i.modified_messages) ? r : []).filter(M.lm)) 1 === G.default.compare(e.id, o.lastMessageId) && (o.lastMessageId = e.id)
  }
}
