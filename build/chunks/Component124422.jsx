...
function d(t, n, d) {
  ...
  } = (0, o.XJ)(null != d ? d : n), b = (0, i.e7)([a.ZP], () => a.ZP.getGuildScheduledEvent(t), [t]), p = f(b), v = null != (0, c.qY)(null != (g = null == d ? true : d.id) ? g : u.lds), h = null != b && (0, a.xt)(b);
  return !p || h || v ? null : (0, l.jsx)(r.sNh, {
    ...
    action: function() {
      null != b && (0, r.ZDy)(async () => {
        let {
          default: t
        } = await Promise.all([e.e("84722"), e.e("72375")]).then(e.bind(e, 296864));
        return n => {
          var e, i;
