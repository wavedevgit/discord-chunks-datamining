...
let _ = i.memo(function(e) {
  let {
    channel: t
  } = e, _ = (0, u.h)(t.id), C = (0, d.o)(t.id), x = (0, p.M)(t.id), v = (0, o.f9)(), j = (0, l.e7)([f.Z], () => f.Z.hasLayers()), O = i.useCallback(() => C ? b.NW.string(b.t["16QyDg"]) : null != x ? b.NW.string(b.t.kCN9i4) : null, [C, x]), E = i.useMemo(() => (C || null != x) && !v && !j, [C, x, v, j]), [N, I] = i.useState(O());
  i.useEffect(() => {
    null != x && null != _ && (a.uvj.announce(b.NW.string(b.t.acsXuL)), setTimeout(() => {
      (0, c.T)(t.id, [x.id])
    }, 5e3), (0, h.KQ)({
      channelId: t.id,
  ...
  let P = i.useCallback(() => {
    null != x && (0, c.T)(t.id, [x.id]), null != _ && ((0, a.ZDy)(async () => {
      let {
        default: e
  ...
  return null == _ ? null : (0, r.jsx)(a.ua7, {
    forceOpen: E,
    text: N,
    color: a.FGA.BRAND,
    position: "bottom",
