...
let y = i.memo(function(e) {
  let {
    channel: t
  } = e, y = (0, d.h)(t.id), j = (0, u.o)(t.id), O = (0, h.M)(t.id), x = (0, a.f9)(), v = (0, l.e7)([f.Z], () => f.Z.hasLayers()), C = i.useCallback(() => j ? b.intl.string(b.t["16QyDg"]) : null != O ? b.intl.string(b.t.kCN9i4) : null, [j, O]), E = i.useMemo(() => (j || null != O) && !x && !v, [j, O, x, v]), [Z, I] = i.useState(C());
  i.useEffect(() => {
    null != O && null != y && (s.uvj.announce(b.intl.string(b.t.acsXuL)), setTimeout(() => {
      (0, c.T)(t.id, [O.id])
    }, 5e3), (0, p.KQ)({
      channelId: t.id,
  ...
  return null == y ? null : (0, r.jsx)(s.ua7, {
    forceOpen: E,
    text: Z,
    color: s.FGA.BRAND,
    position: "bottom",
