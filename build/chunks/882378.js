...
let y = i.memo(function(e) {
  let {
    channel: t
  } = e, y = (0, u.h)(t.id), x = (0, d.o)(t.id), C = (0, p.M)(t.id), v = (0, a.f9)(), j = (0, l.e7)([f.Z], () => f.Z.hasLayers()), O = i.useCallback(() => x ? b.intl.string(b.t["16QyDg"]) : null != C ? b.intl.string(b.t.kCN9i4) : null, [x, C]), E = i.useMemo(() => (x || null != C) && !v && !j, [x, C, v, j]), [I, S] = i.useState(O());
  i.useEffect(() => {
    null != C && null != y && (o.uvj.announce(b.intl.string(b.t.acsXuL)), setTimeout(() => {
      (0, c.T)(t.id, [C.id])
    }, 5e3), (0, h.KQ)({
      channelId: t.id,
  ...
  let P = i.useCallback(() => {
    null != C && (0, c.T)(t.id, [C.id]), null != y && ((0, o.ZDy)(async () => {
      let {
        default: e
