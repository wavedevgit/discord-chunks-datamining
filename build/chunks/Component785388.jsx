...
function en(e, t, n, i) {
  let a = null == e.id ? G.ZP.getURL(e.name) : U.ZP.getEmojiURL({
    id: e.id,
    animated: e.animated,
    size: t
  });
...
function eu(e) {
  let {
    ...
    var e;
    return null == b ? null : null != (e = h.find(e => (0, C.ir)(e.emoji, b.emoji))) ? e : null
  }, [h, b]), A = (0, u.e7)([g.Z], () => g.Z.saturation), N = (0, u.e7)([R.Z], () => (0, f.wj)(R.Z.theme));
  if (i.useEffect(() => {
