...
function et(e, t, n, i) {
  let o = null == e.id ? U.ZP.getURL(e.name) : M.ZP.getEmojiURL({
    id: e.id,
    animated: e.animated,
    size: t
  });
...
function ei(e) {
  ...
  } = e, d = (0, u.e7)([R.default], () => R.default.getId()), _ = (0, u.e7)([k.default], () => k.default.getUser(n.id), [n]), m = (0, C.$R)(o), E = (0, u.e7)([L.Z], () => L.Z.can(F.Plq.MANAGE_MESSAGES, o) && m) || d === n.id, b = (0, u.e7)([w.ZP, P.Z, j.Z], () => G.ZP.getName(a, o.id, n));
