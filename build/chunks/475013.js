...
let N = () => {
  let {
    guild: e
  } = (0, a.cj)([x.Z], () => x.Z.getProps()), t = (0, a.e7)([f.Z], () => f.Z.formState), n = (0, a.e7)([f.Z], () => f.Z.errorMessage);
  return (0, r.jsx)(c.Z, {
    errorMessage: n,
    onSave: () => {
      if (null == e) return;
      let {
        id: t
      } = e, n = f.Z.editedRoleIds.map(e => f.Z.getRole(e)).filter(g.lm), r = f.Z.getSortDeltas(), i = null, l = null;
