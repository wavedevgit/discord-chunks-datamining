...
let C = () => {
  let {
    guild: e
  } = (0, l.cj)([b.Z], () => b.Z.getProps()), t = (0, l.e7)([h.Z], () => h.Z.formState), n = (0, l.e7)([h.Z], () => h.Z.errorMessage);
  return (0, r.jsx)(c.Z, {
    errorMessage: n,
    onSave: () => {
      if (null == e) return;
      let {
        id: t
      } = e, n = h.Z.editedRoleIds.map(e => h.Z.getRole(e)).filter(g.lm), r = h.Z.getSortDeltas(), i = null, s = null;
