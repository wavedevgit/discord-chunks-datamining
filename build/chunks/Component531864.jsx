    ...
    return l.useEffect(() => {
      ...
      children: p.map((e, t) => {
        ...
        let {
          ...
          size: h,
          skuId: m
        } = e, C = null == (l = _[t]) ? true : l.items[0], b = null == (a = _[t]) ? true : a.type, E = b === s.Z.AVATAR_DECORATION ? 384 : 512;
        return (0, r.jsxs)("div", {
          className: g.asset,
          style: {
            top: n ? -f - E : o,
          ...
          children: [null != C && b === s.Z.AVATAR_DECORATION && (0, r.jsx)(u.R, {
            item: C
          }), null != C && b === s.Z.PROFILE_EFFECT && (0, r.jsx)(i.Z, {
