...
function V(e) {
  let {
    ...
    ref: v,
    width: O
  } = (0, p.ZP)(), [E, L] = i.useState(3), [V, z] = i.useState(!n), [W, Y] = (0, h.Z)(false, 2e3), q = (0, o.e7)([Z.Z], () => Z.Z.getChannel(t), [t]), {
    firstMessage: K
  } = (0, w.cl)(q), X = (0, o.e7)([I.Z], () => I.Z.hasJoined(t)), {
    disableReactionUpdates: Q,
    disableReactionCreates: J,
    isLurking: $,
    isGuest: ee,
    isPendingMember: et
  } = (0, b.Z)(q), en = (0, j.nw)(q), er = (0, o.e7)([Z.Z], () => Z.Z.getChannel(s)), ei = (0, A.Bs)(er), el = (0, o.e7)([f.Z], () => f.Z.shouldDisplayPrompt(t) && true === n, [t, n]), ea = i.useCallback(e => {
    let t = e[0];
    if (null != t && n) {
