...
function G(e) {
  let {
    ...
    ref: x,
    width: O
  } = (0, p.ZP)(), [E, D] = i.useState(3), [G, z] = i.useState(!n), [W, q] = (0, h.Z)(false, 2e3), Y = (0, o.e7)([Z.Z], () => Z.Z.getChannel(t), [t]), {
    firstMessage: K
  ...
  if (i.useEffect(() => {
      null != O && (D(Math.floor((O - 280) / 58)), es(false))
