...
let I = (0, Chunk419954.zD)(Chunk780964.X.EXPERIMENTAL_UNREADS, {
  useTitle: () => _.intl.string(_.t["k6m/si"]),
  useSubtitle: () => _.intl.string(_.t.LGynPs),
  useValue: () => (0, n.bG)([a.Ay], () => a.Ay.useNewNotifications),
  setValue: function(t) {
    s.A.setAccountFlag(E.i.USE_NEW_NOTIFICATIONS, t), t || (l.w.set("turnedOffNewNotifications", true), T.default.track(S.HAw.NOTIFICATION_MIGRATION_OPTOUT, {
      num_guilds_with_new_setting: u.A.getGuildsArray().filter(t => a.Ay.resolveGuildUnreadSetting(t) === d.e.ONLY_MENTIONS).length
    }))
  },
