...
class b extends i.Z {
  ...
  constructor(e) {
    var t, n, i, a, s, l, c, u, d, _, p, m, g, E, b, y, O, v, I, S, T, A, N, C, P, R, w, D, L, x, k, M;
    ...
    this.id = e.id, this.username = null != (i = e.username) ? i : "", this.discriminator = null != (a = e.discriminator) ? a : f.fo$, this.avatar = null != (s = e.avatar) ? s : null, this.avatarDecoration = null != (l = e.avatar_decoration_data) ? l : e.avatarDecorationData, this.email = null != (c = e.email) ? c : null, this.verified = null != (u = e.verified) && u, this.bot = null != (d = e.bot) && d, this.system = null != (_ = e.system) && _, this.mfaEnabled = null != (m = null != (p = e.mfa_enabled) ? p : e.mfaEnabled) && m, this.mobile = null != (g = e.mobile) && g, this.desktop = null != (E = e.desktop) && E, this.premiumType = j === f.WND ? null : j, this.flags = null != (b = e.flags) ? b : 0, this.publicFlags = null != (O = null != (y = e.public_flags) ? y : e.publicFlags) ? O : 0, this.purchasedFlags = null != (I = null != (v = e.purchased_flags) ? v : e.purchasedFlags) ? I : 0, this.premiumUsageFlags = null != (T = null != (S = e.premium_usage_flags) ? S : e.premiumUsageFlags) ? T : 0, this.phone = null != (A = e.phone) ? A : null, this.nsfwAllowed = null != (N = e.nsfw_allowed) ? N : e.nsfwAllowed, this.ageVerificationStatus = null != (C = e.age_verification_status) ? C : e.ageVerificationStatus, this.guildMemberAvatars = null != (P = e.guildMemberAvatars) ? P : {}, this.hasBouncedEmail = null != (w = null != (R = e.has_bounced_email) ? R : e.hasBouncedEmail) && w, this.personalConnectionId = null != (L = null != (D = e.personal_connection_id) ? D : e.personalConnectionId) ? L : null, this.globalName = null != (x = e.global_name) ? x : e.globalName, this.banner = e.banner, this.primaryGuild = (0, o.l)(null != (M = null != (k = e.primary_guild) ? k : e.primaryGuild) ? M : null), this.collectibles = e.collectibles, Object.defineProperties(this, {
      hasFlag: {
        writable: !1,
        configurable: !1,
        value: e => {
