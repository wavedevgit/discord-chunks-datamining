...
class b extends Chunk81825.Z {
  ...
  constructor(e) {
    var t, n, i, a, l, c, u, d, f, p, m, g, E, b, y, O, v, I, S, T, A, C, N, R, P, w, D, x, L, j, M, k, U;
    ...
    this.id = e.id, this.username = null != (i = e.username) ? i : "", this.discriminator = null != (a = e.discriminator) ? a : _.fo$, this.avatar = null != (l = e.avatar) ? l : null, this.avatarDecoration = null != (c = e.avatar_decoration_data) ? c : e.avatarDecorationData, this.email = null != (u = e.email) ? u : null, this.verified = null != (d = e.verified) && d, this.bot = null != (f = e.bot) && f, this.system = null != (p = e.system) && p, this.mfaEnabled = null != (g = null != (m = e.mfa_enabled) ? m : e.mfaEnabled) && g, this.mobile = null != (E = e.mobile) && E, this.desktop = null != (b = e.desktop) && b, this.premiumType = G === _.WND ? null : G, this.flags = null != (y = e.flags) ? y : 0, this.publicFlags = null != (v = null != (O = e.public_flags) ? O : e.publicFlags) ? v : 0, this.purchasedFlags = null != (S = null != (I = e.purchased_flags) ? I : e.purchasedFlags) ? S : 0, this.premiumUsageFlags = null != (A = null != (T = e.premium_usage_flags) ? T : e.premiumUsageFlags) ? A : 0, this.phone = null != (C = e.phone) ? C : null, this.nsfwAllowed = null != (N = e.nsfw_allowed) ? N : e.nsfwAllowed, this.ageVerificationStatus = null != (R = e.age_verification_status) ? R : e.ageVerificationStatus, this.guildMemberAvatars = null != (P = e.guildMemberAvatars) ? P : {}, this.hasBouncedEmail = null != (D = null != (w = e.has_bounced_email) ? w : e.hasBouncedEmail) && D, this.personalConnectionId = null != (L = null != (x = e.personal_connection_id) ? x : e.personalConnectionId) ? L : null, this.globalName = null != (j = e.global_name) ? j : e.globalName, this.banner = e.banner, this.primaryGuild = (0, s.l)(null != (k = null != (M = e.primary_guild) ? M : e.primaryGuild) ? k : null), this.collectibles = e.collectibles, this.displayNameStyles = null != (U = e.displayNameStyles) ? U : (0, o.bN)(e.display_name_styles), Object.defineProperties(this, {
      hasFlag: {
        writable: false,
        configurable: false,
        enumerable: false,
