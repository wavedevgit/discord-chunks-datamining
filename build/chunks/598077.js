...
class b extends i.Z {
  ...
  constructor(e) {
    var t, n, i, a, o, s, l, c, u, _, p, m, g, E, b, y, v, O, I, S, T, A, N, C, P, R, w, D, L, x, M, k;
    ...
    this.id = e.id, this.username = null != (i = e.username) ? i : "", this.discriminator = null != (a = e.discriminator) ? a : d.fo$, this.avatar = null != (o = e.avatar) ? o : null, this.avatarDecoration = null != (s = e.avatar_decoration_data) ? s : e.avatarDecorationData, this.email = null != (l = e.email) ? l : null, this.verified = null != (c = e.verified) && c, this.bot = null != (u = e.bot) && u, this.system = null != (_ = e.system) && _, this.mfaEnabled = null != (m = null != (p = e.mfa_enabled) ? p : e.mfaEnabled) && m, this.mobile = null != (g = e.mobile) && g, this.desktop = null != (E = e.desktop) && E, this.premiumType = j === d.WND ? null : j, this.flags = null != (b = e.flags) ? b : 0, this.publicFlags = null != (v = null != (y = e.public_flags) ? y : e.publicFlags) ? v : 0, this.purchasedFlags = null != (I = null != (O = e.purchased_flags) ? O : e.purchasedFlags) ? I : 0, this.premiumUsageFlags = null != (T = null != (S = e.premium_usage_flags) ? S : e.premiumUsageFlags) ? T : 0, this.phone = null != (A = e.phone) ? A : null, this.nsfwAllowed = null != (N = e.nsfw_allowed) ? N : e.nsfwAllowed, this.ageVerificationStatus = null != (C = e.age_verification_status) ? C : e.ageVerificationStatus, this.guildMemberAvatars = null != (P = e.guildMemberAvatars) ? P : {}, this.hasBouncedEmail = null != (w = null != (R = e.has_bounced_email) ? R : e.hasBouncedEmail) && w, this.personalConnectionId = null != (L = null != (D = e.personal_connection_id) ? D : e.personalConnectionId) ? L : null, this.globalName = null != (x = e.global_name) ? x : e.globalName, this.banner = e.banner, this.primaryGuild = (0, f.lt)(null != (k = null != (M = e.primary_guild) ? M : e.primaryGuild) ? k : null), this.collectibles = e.collectibles, Object.defineProperties(this, {
      hasFlag: {
        writable: !1,
        configurable: !1,
        value: e => {
