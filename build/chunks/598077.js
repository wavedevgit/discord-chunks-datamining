...
class E extends i.Z {
  ...
  addGuildAvatarHash(e, t) {
    ...
    let n = m(h({}, this.guildMemberAvatars), {
      [e]: t
    });
    return this.merge({
  ...
  removeGuildAvatarHash(e) {
    ...
    let t = m(h({}, this.guildMemberAvatars), {
      [e]: void 0
    });
    return this.merge({
  ...
  constructor(e) {
    ...
    this.id = e.id, this.username = null !== (i = e.username) && void 0 !== i ? i : "", this.discriminator = null !== (o = e.discriminator) && void 0 !== o ? o : u.fo$, this.avatar = null !== (a = e.avatar) && void 0 !== a ? a : null, this.avatarDecoration = null !== (s = e.avatar_decoration_data) && void 0 !== s ? s : e.avatarDecorationData, this.email = null !== (l = e.email) && void 0 !== l ? l : null, this.verified = null !== (c = e.verified) && void 0 !== c && c, this.bot = null !== (f = e.bot) && void 0 !== f && f, this.system = null !== (_ = e.system) && void 0 !== _ && _, this.mfaEnabled = null !== (g = null !== (h = e.mfa_enabled) && void 0 !== h ? h : e.mfaEnabled) && void 0 !== g && g, this.mobile = null !== (m = e.mobile) && void 0 !== m && m, this.desktop = null !== (E = e.desktop) && void 0 !== E && E, this.premiumType = k === u.WND ? null : k, this.flags = null !== (v = e.flags) && void 0 !== v ? v : 0, this.publicFlags = null !== (y = null !== (b = e.public_flags) && void 0 !== b ? b : e.publicFlags) && void 0 !== y ? y : 0, this.purchasedFlags = null !== (S = null !== (O = e.purchased_flags) && void 0 !== O ? O : e.purchasedFlags) && void 0 !== S ? S : 0, this.premiumUsageFlags = null !== (T = null !== (I = e.premium_usage_flags) && void 0 !== I ? I : e.premiumUsageFlags) && void 0 !== T ? T : 0, this.phone = null !== (N = e.phone) && void 0 !== N ? N : null, this.nsfwAllowed = null !== (A = e.nsfw_allowed) && void 0 !== A ? A : e.nsfwAllowed, this.guildMemberAvatars = null !== (C = e.guildMemberAvatars) && void 0 !== C ? C : {}, this.hasBouncedEmail = null !== (P = null !== (R = e.has_bounced_email) && void 0 !== R ? R : e.hasBouncedEmail) && void 0 !== P && P, this.personalConnectionId = null !== (w = null !== (D = e.personal_connection_id) && void 0 !== D ? D : e.personalConnectionId) && void 0 !== w ? w : null, this.globalName = null !== (L = e.global_name) && void 0 !== L ? L : e.globalName, this.banner = e.banner, this.primaryGuild = (0, d.lt)(null !== (M = null !== (x = e.primary_guild) && void 0 !== x ? x : e.primaryGuild) && void 0 !== M ? M : null), this.collectibles = e.collectibles, Object.defineProperties(this, {
      hasFlag: {
        writable: !1,
        configurable: !1,
        value: e => {
