...
function B() {
  j = h.Z.getProps().results.filter(e => e.type === _.h8.TEXT_CHANNEL && 0 === e.record.type).map(e => e.record.id)
}
...
let V = new Z(d.Z, {
  ...
  RECEIVE_CHANNEL_SUMMARIES(e) {
    ...
    R[n] = (0, l.sortBy)(a, e => I.default.extractTimestamp(e.startId)).reverse();
    let c = w(N({}, P[n]), {
      fetching: !1,
      error: void 0,
      lastReceivedAt: i
  ...
  REQUEST_CHANNEL_SUMMARIES(e) {
    var t;
    P[e.channelId] = w(N({}, null != (t = P[e.channelId]) ? t : {}), {
      fetching: !0,
  ...
  UPDATE_VISIBLE_MESSAGES(e) {
    ...
    if (null != t)
      if (null != i && i.channelId === t && null != i.summaryId) {
        ...
        var n;
        a = null == (n = R[t]) ? void 0 : n.findIndex(t => F(e.topVisibleMessage, e.bottomVisibleMessage, t.startId, t.endId))
      }
  },
  ...
  RECEIVE_CHANNEL_AFFINITIES(e) {
    ...
    L = null != n ? n : [], x = null != (t = null == n ? void 0 : n.reduce((e, t) => (e[t.channel_id] = t.affinity, e), {})) ? t : {}, k = w(N({}, k), {
      status: "ok",
      lastResponse: Date.now()
    })
  },
  ...
  RECEIVE_CHANNEL_SUMMARIES_BULK(e) {
    let {
      ...
      let o = null != (i = P[t]) ? i : {},
        s = a[t];
      return null != s && (e.summariesByChannel[t] = s), e.summaryFetchStatusByChannel[t] = w(N({}, o), {
        fetching: !1,
        error: r,
        lastReceivedAt: n
      }), e
    ...
    R = N({}, R, o.summariesByChannel), P = N({}, P, o.summaryFetchStatusByChannel)
  },
  CONVERSATION_SUMMARY_UPDATE(e) {
    ...
    let {
      ...
      summaries: a,
      guild_id: o
    } = e, s = Date.now(), l = c().chain(a).sortBy(e => I.default.extractTimestamp(e.start_id)).filter(e => Object.keys(e).length > 0).map(e => (0, T.b)(e, i)).reverse().value(), u = null != (n = R[i]) ? n : [], d = c().chain(l).concat(u).sortBy(e => I.default.extractTimestamp(e.startId)).takeRight(U).uniqBy("id").reverse().value();
    R[i] = d, P[i] = w(N({}, P[i]), {
      error: void 0,
      fetching: null != (r = null == (t = P[i]) ? void 0 : t.fetching) && r,
      lastReceivedAt: s
    })
  },
