...
function x(e) {
  let t = (0, h.A)(e.id),
    ...
    P = (0, a.fw)(e.id),
    w = [],
    R = e.features.has(_.GuildFeatures.HUB),
    D = e.features.has(_.GuildFeatures.COMMUNITY),
    L = (0, O.w)(!(0, g.WW)(e.id)),
    M = e.features.has(_.GuildFeatures.ENABLED_MODERATION_EXPERIENCE_FOR_NON_COMMUNITY),
    G = (0, b.A)(e.id);
  (0, m.Ao)("useGuildActionRows");
  let k = (0, f.C$)(e.id, "useGuildActionRows"),
    U = e.features.has(_.GuildFeatures.GAME_SERVERS),
    V = (0, i.ws)(e, {
      location: "guild-action-rows"
    });
  return R && w.push(j.n.GUILD_HUB_HEADER_OPTIONS), !T && S && N && null != I && I.length > 0 ? w.push(j.n.GUILD_NEW_MEMBER_ACTIONS_PROGRESS_BAR) : V && w.push(j.n.GUILD_PREMIUM_PROGRESS_BAR), !R && S && w.push(j.n.GUILD_HOME), t && w.push(j.n.GUILD_SCHEDULED_EVENTS), !R && D && L && w.push(j.n.CHANNELS_AND_ROLES), x && w.push(j.n.GUILD_ROLE_SUBSCRIPTIONS), v && w.push(j.n.GUILD_SHOP), E && C && w.push(j.n.GUILD_GAME_SHOP), (P && (D || M) || n && e.features.has(_.GuildFeatures.MEMBER_VERIFICATION_MANUAL_APPROVAL)) && w.push(j.n.GUILD_MOD_DASH_MEMBER_SAFETY), G && w.push(j.n.GUILD_BOOSTS), k && U && w.push(j.n.GAME_SERVERS), w
}