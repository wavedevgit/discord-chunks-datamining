...
let X = Chunk647438.forwardRef(function(e, t) {
  ...
  } = i.useContext(m.h), eb = i.useRef(null), ey = q(S.soundId, eb.current), eO = (0, l.e7)([p.Z], () => p.Z.useReducedMotion), ev = i.useRef(F), eI = i.useRef(new c.Xp), eS = S.soundId === Z, eT = "sound-".concat(S.soundId), eA = (0, s.JA)(eT), eC = null != ed || null != ef, eN = !(0, C.Nq)(e_, S, T) && !eo, eR = B || X && !eN, eP = null != (O = g.Wq.useStore().bottomPosition) ? O : 0, ew = (null != (I = null == (a = eb.current) ? true : a.getBoundingClientRect().bottom) ? I : 0) + 50 > eP ? "top" : "bottom", [eD, eL] = i.useState(false), ex = i.useCallback(() => {
    eL(true)
  }, []), eM = i.useCallback(() => {
    eL(false)
  }, []), ek = eN && en;
