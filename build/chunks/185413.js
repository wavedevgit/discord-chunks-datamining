  ...
  let C = j.iI(k, a, n, s, R),
    {
      ...
      renderEmptyText: e => w.intl.format(w.t.ErpIY2, {
        query: e
      })
    };
  return (0, r.jsx)(N, {
...
function N(e) {
  ...
  return (0, r.jsxs)("div", {
    className: R.content,
    children: [(null == (t = p) && b && (t = w.intl.string(w.t.f7VbhI)), null == t || "" === t) ? null : (0, r.jsx)(a.Text, {
...
function P(e) {
  let {
    ...
    newChannel: d,
    inSettings: x
  } = e, [h, p] = l.useState(!1), [g, j] = l.useState({}), v = (0, i.e7)([m.Z], () => m.Z.getChannel(o), [o]), T = (0, i.e7)([b.Z], () => b.Z.getGuild(null == v ? void 0 : v.getGuildId()));
  if (l.useEffect(() => {
      f.default.track(S.rMx.OPEN_MODAL, {
        type: "Grant Channel Access"
      })
    }, []), null == v || null == T) return null;
