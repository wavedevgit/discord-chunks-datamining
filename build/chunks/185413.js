  ...
  let L = g.iI(k, a, n, s, O),
    {
      ...
      renderEmptyText: e => T.intl.format(T.t.ErpIY2, {
        query: e
      })
    };
  return (0, r.jsx)(M, {
    ...
    onClickRow: function(e) {
      ...
      d(n => {
        ...
        if (t in r) delete r[t];
          ...
          let n;
          e.rowType === v.aC.ROLE || e.rowType === v.aC.ADMINISTRATOR ? n = {
            type: o.Fj.ROLE,
            label: e.name,
            color: e.colorString
          } : (e.rowType === v.aC.MEMBER || e.rowType === v.aC.OWNER) && (n = {
            type: o.Fj.MEMBER,
            label: e.name,
            avatar: e.avatarURL
          }), null != n && (r[t] = {
...
function M(e) {
  ...
  return (0, r.jsxs)("div", {
    className: w.content,
    children: [(null == (t = p) && b && (t = T.intl.string(T.t.f7VbhI)), null == t || "" === t) ? null : (0, r.jsx)(a.Text, {
