...
function eu(e) {
  ...
  let {
    ...
    selfMute: u,
    mute: c
  } = (0, R.Z)(n), p = u || c || s, h = (0, y.Z)(u, c, s, false), {
    Component: f,
    play: g,
    events: O
  } = (0, G.b)(p);
...
function ec(e) {
  ...
  r.useEffect(() => () => p(), [u, p]);
  let g = () => {
      (0, S.Z)(s, ei.jXE.OVERLAY), (0, $.Ws)(ei.Odu.QUICK_ACTIONS, {
        type: $.Qu.AUDIO,
...
function ed(e) {
  ...
  let {
    voiceChannel: n,
    locked: o
  } = e, a = r.useRef(null), s = (0, l.e7)([B.Z], () => B.Z.isVideoEnabled()), u = (0, l.e7)([B.Z], () => Object.values(B.Z.getVideoDevices())[0]), h = null == (t = null == u ? true : u.disabled) || t, f = false === h, m = (0, A.Z)(n), g = e => {
...
function eh(e) {
  ...
  let {
    ...
    mute: p,
    suppress: f
  } = (0, R.Z)(o), m = (0, l.e7)([B.Z], () => B.Z.isDeaf()), O = null == o || p || f || m, {
  ...
  } = (0, u.j)(), j = ea(a), I = (0, l.e7)([_.Z, F.default], () => _.Z.isUserPlayingSounds(F.default.getId()), []) ? "green" : true;
  return (0, i.jsx)(d.yRy, {
    targetElementRef: s,
    clickTrap: true,
    renderPopout: e => {
      ...
      return O || null == o ? (0, i.jsx)(i.Fragment, {}) : (0, i.jsx)(P.Z, {
        guildId: c,
        channel: o,
        onClose: j(t),
