...
function ec(e) {
  ...
  let E = ea(l),
    ...
    x = (0, o.e7)([et.Z], () => et.Z.isLimitedInteractionOverrideEnabled(I)),
    j = (0, V.Hu)({
...
function ef(e) {
  ...
  } = (0, c.j)(), I = ea(a), x = (0, o.e7)([P.Z, B.default], () => P.Z.isUserPlayingSounds(B.default.getId()), []) ? "green" : true;
  return (0, i.jsx)(d.yRy, {
    targetElementRef: s,
    clickTrap: true,
    renderPopout: e => {
