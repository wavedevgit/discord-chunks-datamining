...
function w(e) {
  let {
    guild: t
  } = e, n = (0, o.e7)([f.Z], () => null != t && f.Z.can(I.Plq.MANAGE_GUILD, t), [t]), l = i.useCallback(async e => {
    let {
      value: n
    } = e;
    try {
    ...
    let e = (0, v.IF)(null == t ? void 0 : t.features.has(I.oNc.COMMUNITY)).map(e => P(T({}, e), {
...
function R(e) {
  let {
    ...
    className: n,
    withDivider: l = !0
  } = e, s = (0, m.pn)("GuildExplicitContentFilter"), d = (0, o.e7)([f.Z], () => null != t && f.Z.can(I.Plq.MANAGE_GUILD, t), [t]), u = i.useCallback(async e => {
    let {
      value: n
    } = e;
    try {
    ...
    let e = (0, v.MF)(null == t ? void 0 : t.features.has(I.oNc.COMMUNITY)).map(e => P(T({}, e), {
      tooltipPosition: "left"
    }));
    return (0, v.LJ)(e)
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(c.Text, {
          ...
          children: E.intl.format(s ? E.t.BI4ukJ : E.t.zOmxND, {
            helpdeskArticle: j.Z.getArticleURL(I.BhN.SAFE_DIRECT_MESSAGING)
          })
        })]
      }), (0, r.jsx)(N.Z, {
...
async function Z(e, t) {
  ...
  let n = e.features;
  return t ? n.add(I.oNc.ENABLED_MODERATION_EXPERIENCE_FOR_NON_COMMUNITY) : n.delete(I.oNc.ENABLED_MODERATION_EXPERIENCE_FOR_NON_COMMUNITY), await _.Z.saveGuild(e.id, {
    features: n
  })
}
...
function D(e) {
  let {
    guild: t
  } = e, n = (0, o.e7)([f.Z], () => null != t && f.Z.can(I.Plq.MANAGE_GUILD, t), [t]), l = t.features.has(I.oNc.COMMUNITY), a = (0, p.n2)(t.id), [s, d] = i.useState(t.features.has(I.oNc.ENABLED_MODERATION_EXPERIENCE_FOR_NON_COMMUNITY)), u = i.useCallback(async e => {
    d(e), await Z(t, e)
  }, [t]);
...
function A(e) {
  let {
    guild: t,
    mfaLevel: n
  } = e, l = (0, o.e7)([f.Z], () => null != t && f.Z.can(I.Plq.MANAGE_GUILD, t), [t]), a = (0, o.e7)([b.default], () => b.default.getCurrentUser()), {
...
function k() {
  let {
    guild: e,
    mfaLevel: t
  } = (0, o.cj)([O.Z], () => O.Z.getProps(), []), n = (0, o.e7)([x.Z], () => x.Z.enabled, []);
