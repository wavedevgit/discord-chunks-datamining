...
function S(e) {
  let {
    ...
    let e = (0, b.IF)(null == t ? void 0 : t.hasFeature(O.oNc.COMMUNITY)).map(e => E(I({}, e), {
      tooltipPosition: "left"
    }));
    return (0, b.LJ)(e)
  }, [t]), a = i.useMemo(() => l.find(e => e.value === (null == t ? void 0 : t.verificationLevel)), [t, l]);
  return (0, r.jsxs)("div", {
...
function T(e) {
  let {
    ...
    className: n,
    withDivider: s = !0
  } = e, a = (0, o.e7)([p.Z], () => null != t && p.Z.can(O.Plq.MANAGE_GUILD, t), [t]), d = i.useCallback(async e => {
    let {
      value: n
    } = e;
    try {
    ...
    let e = (0, b.MF)(null == t ? void 0 : t.hasFeature(O.oNc.COMMUNITY)).map(e => E(I({}, e), {
      tooltipPosition: "left"
    }));
    return (0, b.LJ)(e)
    ...
    children: [s && (0, r.jsx)(c.$i$, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(c.Text, {
          ...
          color: "header-secondary",
          variant: "text-sm/normal",
          children: C.NW.format(C.t.zOmxND, {
            helpdeskArticle: x.Z.getArticleURL(O.BhN.SAFE_DIRECT_MESSAGING)
          })
        })]
      }), (0, r.jsx)(v.Z, {
...
function w(e) {
  let {
    guild: t
  } = e, n = (0, o.e7)([p.Z], () => null != t && p.Z.can(O.Plq.MANAGE_GUILD, t), [t]), s = t.hasFeature(O.oNc.COMMUNITY), l = (0, g.n2)(t.id), [a, d] = i.useState(t.hasFeature(O.oNc.ENABLED_MODERATION_EXPERIENCE_FOR_NON_COMMUNITY)), u = i.useCallback(async e => {
    d(e), await P(t, e)
  }, [t]);
  return s || !l ? null : (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsxs)("div", {
      className: y.setupContainer,
      children: [(0, r.jsx)(c.j7V, {
        ...
        children: (0, r.jsxs)("div", {
          ...
          children: [(0, r.jsxs)(c.Text, {
            color: "header-primary",
            variant: "text-md/semibold",
            children: [C.NW.string(C.t.jDarm5), (0, r.jsx)(m.Z, {
              className: y.betaTag
            })]
          }), (0, r.jsx)(c.Text, {
            color: "header-secondary",
...
function R(e) {
  let {
    guild: t,
    mfaLevel: n
  } = e, s = (0, o.e7)([p.Z], () => null != t && p.Z.can(O.Plq.MANAGE_GUILD, t), [t]), l = (0, o.e7)([f.default], () => f.default.getCurrentUser()), {
  ...
  }, [l, t]), g = n === O.BpS.ELEVATED, h = (0, a.throttle)(async e => {
