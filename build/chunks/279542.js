...
function R(e) {
  let {
    guild: t,
    mfaLevel: n
  } = e, l = (0, o.e7)([p.Z], () => null != t && p.Z.can(C.Plq.MANAGE_GUILD, t), [t]), s = (0, o.e7)([f.default], () => f.default.getCurrentUser()), {
  ...
  }, [s, t]), g = n === C.BpS.ELEVATED, h = (0, a.throttle)(async e => {
...
function Z() {
  let {
    guild: e,
    mfaLevel: t
  } = (0, o.cj)([_.Z], () => _.Z.getProps(), []), n = (0, o.e7)([h.Z], () => h.Z.enabled, []);
