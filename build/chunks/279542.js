...
function S(e) {
  let {
    guild: t
  } = e, n = (0, o.e7)([p.Z], () => null != t && p.Z.can(C.Plq.MANAGE_GUILD, t), [t]), s = i.useCallback(async e => {
    let {
      value: n
    } = e;
    try {
    ...
    let e = (0, x.IF)(null == t ? void 0 : t.hasFeature(C.oNc.COMMUNITY)).map(e => E(I({}, e), {
...
function T(e) {
  let {
    ...
    className: n,
    withDivider: s = !0
  } = e, l = (0, o.e7)([p.Z], () => null != t && p.Z.can(C.Plq.MANAGE_GUILD, t), [t]), d = i.useCallback(async e => {
    let {
      value: n
    } = e;
    try {
    ...
    let e = (0, x.MF)(null == t ? void 0 : t.hasFeature(C.oNc.COMMUNITY)).map(e => E(I({}, e), {
      tooltipPosition: "left"
    }));
    return (0, x.LJ)(e)
...
function w(e) {
  let {
    guild: t
  } = e, n = (0, o.e7)([p.Z], () => null != t && p.Z.can(C.Plq.MANAGE_GUILD, t), [t]), s = t.hasFeature(C.oNc.COMMUNITY), a = (0, g.n2)(t.id), [l, d] = i.useState(t.hasFeature(C.oNc.ENABLED_MODERATION_EXPERIENCE_FOR_NON_COMMUNITY)), u = i.useCallback(async e => {
    d(e), await P(t, e)
  }, [t]);
...
function R(e) {
  let {
    guild: t,
    mfaLevel: n
  } = e, s = (0, o.e7)([p.Z], () => null != t && p.Z.can(C.Plq.MANAGE_GUILD, t), [t]), a = (0, o.e7)([f.default], () => f.default.getCurrentUser()), {
