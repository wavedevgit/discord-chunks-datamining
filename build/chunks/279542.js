...
function P(e) {
  let {
    ...
    let e = (0, j.IF)(null == t ? void 0 : t.features.has(N.oNc.COMMUNITY)).map(e => T(S({}, e), {
...
function w(e) {
  let {
    ...
    let e = (0, j.MF)(null == t ? void 0 : t.features.has(N.oNc.COMMUNITY)).map(e => T(S({}, e), {
      tooltipPosition: "left"
    }));
    return (0, j.LJ)(e)
...
function D(e) {
  let {
    guild: t,
    mfaLevel: n
  } = e, l = (0, o.e7)([h.Z], () => null != t && h.Z.can(N.Plq.MANAGE_GUILD, t), [t]), a = (0, o.e7)([x.default], () => x.default.getCurrentUser()), {
