...
if (T) {
  ...
  N.ZP.on("NOTIFICATION_CLICK", (t, n) => {
    ...
    constructor(t, {
      ...
      C(this, "id", G._id++), C(this, "title", void 0), C(this, "body", void 0), C(this, "icon", void 0), C(this, "onshow", function() {}), C(this, "onclick", function() {}), C(this, "onclose", function() {}), t.includes("\0") ? (A.warn("Notification title contains null character, setting to empty string"), this.title = "") : this.title = t, n.includes("\0") ? (A.warn("Notification body contains null character, setting to empty string"), this.body = "") : this.body = n, this.icon = i, setImmediate(() => this.onshow()), e[this.id] = this, N.ZP.send("NOTIFICATION_SHOW", {
        id: this.id,
        title: this.title,
        body: this.body,
        icon: this.icon
  ...
  }, C(r, "permission", "granted"), C(r, "_id", 0), G = r
}
let U = {};
if (null === c.Z || void 0 === c.Z ? void 0 : c.Z.features.supports("notifications")) try {
...
function K() {
  return (null == i ? void 0 : i.authorizationStatus) === "authorized" && (!k || (0, p.R)({
...
let Q = {
  ...
  showNotification: async function(e, t, n, i, r) {
    ...
    let m = null != (o = null == r ? void 0 : r.tag) ? o : null,
      ...
      T = e => {
        var t;
        null == (t = r.onShown) || t.call(r), r.omitViewTracking || j.default.track(x.rMx.NOTIFICATION_VIEWED, i), V && setTimeout(() => e.close(), 5e3)
      };
    if (null == r.sound || C || Y(r.sound, null != (a = r.volume) ? a : 1, r.soundpack), r.isUserAvatar && null != e && (e = await
        function(e) {
          let t = new Image;
          return t.src = e, t.crossOrigin = "anonymous", new Promise((n, i) => {
            t.onload = () => {
              "" !== t.src && n(function(e) {
      ...
      if (null != r.messageRecord && o.enabled) {
        ...
        if (l.senderIdentifier = t.id, l.senderDisplayName = S.ZP.getName(i, e, t), l.senderAvatar = t.getAvatarURL(i, 128, !1, !1), l.attachments = [], o.includeStickers)
          for (let e of (0, O.cv)(r.messageRecord)) {
            ...
            null != t && l.attachments.push({
              url: t,
              type: "image/png"
            })
          }
        if (o.includeImages)
          for (let e of r.messageRecord.attachments) !(0, w.yE)(null != (c = e.flags) ? c : 0, x.J0y.CONTAINS_EXPLICIT_MEDIA) && !(0, w.yE)(null != (d = e.flags) ? d : 0, x.J0y.IS_SPOILER) && (null == (s = e.content_type) ? void 0 : s.startsWith("image/")) && l.attachments.push({
            url: e.proxy_url,
            type: e.content_type
          })
      }
