...
async function M(t) {
  ...
  if (await L()) try {
    await b.ZP.invoke("NOTIFICATIONS_SEND_NOTIFICATION", {
      sound: D(t, n)
    });
    return
  } catch (t) {
...
if (k) {
  ...
  b.ZP.on("NOTIFICATION_CLICK", (i, n) => {
  ...
  }), b.ZP.send("NOTIFICATIONS_CLEAR"), e = class {
    ...
    constructor(i, {
      ...
      S(this, "id", G._id++), S(this, "title", void 0), S(this, "body", void 0), S(this, "icon", void 0), S(this, "onshow", function() {}), S(this, "onclick", function() {}), S(this, "onclose", function() {}), i.includes("\0") ? (F.warn("Notification title contains null character, setting to empty string"), this.title = "") : this.title = i, n.includes("\0") ? (F.warn("Notification body contains null character, setting to empty string"), this.body = "") : this.body = n, this.icon = e, setImmediate(() => this.onshow()), t[this.id] = this, b.ZP.send("NOTIFICATION_SHOW", {
        id: this.id,
        title: this.title,
        body: this.body,
        icon: this.icon
  ...
  }, S(e, "permission", "granted"), S(e, "_id", 0), G = e
}
let V = {};
if (null === s.Z || void 0 === s.Z ? void 0 : s.Z.features.supports("notifications")) {
  ...
  }(null === s.Z || void 0 === s.Z ? void 0 : s.Z.features.supports("notifications_provisional")) && Y().then(t => {
...
async function H(t, i, n, e, o) {
  ...
  let Y = null != (l = null == o ? void 0 : o.tag) ? l : null,
    ...
    q = t => {
      var i;
      null == (i = o.onShown) || i.call(o), o.omitViewTracking || O.default.track(E.rMx.NOTIFICATION_VIEWED, e), R && setTimeout(() => t.close(), 5e3)
    };
  if (null == o.sound || H || B(o.sound, null != (r = o.volume) ? r : 1, o.soundpack), o.isUserAvatar && null != t && (t = await
      function(t) {
        let i = new Image;
        return i.src = t, i.crossOrigin = "anonymous", new Promise((n, e) => {
          i.onload = () => {
            "" !== i.src && n(function(t) {
    ...
    if (null != o.messageRecord && l.enabled) {
      ...
      if (a.senderIdentifier = i.id, a.senderDisplayName = C.ZP.getName(e, t, i), a.senderAvatar = i.getAvatarURL(e, 128, !1, !1), a.attachments = [], l.includeStickers)
        for (let t of (0, p.cv)(o.messageRecord)) {
          ...
          null != i && a.attachments.push({
            url: i,
            type: "image/png"
          })
        }
      if (l.includeImages)
        for (let t of o.messageRecord.attachments) !(0, _.yE)(null != (u = t.flags) ? u : 0, E.J0y.CONTAINS_EXPLICIT_MEDIA) && !(0, _.yE)(null != (I = t.flags) ? I : 0, E.J0y.IS_SPOILER) && (null == (s = t.content_type) ? void 0 : s.startsWith("image/")) && a.attachments.push({
          url: t.proxy_url,
          type: t.content_type
        })
    }
...
let q = {
  ...
  requestPermission: function(t) {
    if (null === s.Z || void 0 === s.Z ? void 0 : s.Z.features.supports("notifications")) try {
      b.ZP.invoke("NOTIFICATIONS_GET_AUTHORIZATION").then(i => {
        t(i)
      }).catch(() => {
        t(!1)
      });
