...
if (w) {
  ...
  }, R(r, "permission", "granted"), R(r, "_id", 0), V = r
}
let F = {};
if (null === l.Z || void 0 === l.Z ? void 0 : l.Z.features.supports("notifications")) {
  ...
  }(null === l.Z || void 0 === l.Z ? void 0 : l.Z.features.supports("notifications_provisional")) && Y().then(e => {
...
function Z(e) {
  ...
  null != V && V.requestPermission(async () => {
    null != e && e(await H())
  })
}
async function H() {
