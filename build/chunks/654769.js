...
let L = Chunk358085.isPlatformEmbedded && (0, Chunk358085.isWindows)(),
  j = L && 10 > parseFloat(Chunk579806.Z.os.release),
  k = true;
if (L && !j) {
  let [e, , t] = Chunk579806.Z.os.release.split(".");
  k = parseInt(module) > 10 || parseInt(exports) >= 15063
}
let M = new Chunk710845.Z("NotificationUtils"),
...
async function G() {
  if (null === Chunk579806.Z || true === Chunk579806.Z ? true : Chunk579806.Z.features.supports("notifications")) try {
    ...
    M.warn("Fetching native notification settings failed with error: ", module)
  }
  return null
}
...
if (j) {
  ...
  Chunk998502.ZP.on("NOTIFICATION_CLICK", (t, n) => {
    ...
    constructor(t, {
      ...
      P(this, "id", K._id++), P(this, "title", true), P(this, "body", true), P(this, "icon", true), P(this, "onshow", function() {}), P(this, "onclick", function() {}), P(this, "onclose", function() {}), t.includes("\0") ? (M.warn("Notification title contains null character, setting to empty string"), this.title = "") : this.title = t, n.includes("\0") ? (M.warn("Notification body contains null character, setting to empty string"), this.body = "") : this.body = n, this.icon = r, setImmediate(() => this.onshow()), e[this.id] = this, N.ZP.send("NOTIFICATION_SHOW", {
        id: this.id,
        title: this.title,
        body: this.body,
        icon: this.icon
...
if (null === Chunk579806.Z || true === Chunk579806.Z ? true : Chunk579806.Z.features.supports("notifications")) {
  try {
    ...
    M.warn("Native notification setup failed with error: ", module)
