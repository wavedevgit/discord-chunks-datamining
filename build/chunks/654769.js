...
n.d(t, {
  Z: () => J
}), n(388685), n(35282), n(358797), n(457542), n(539854), n(997841);
var o, a = n(392711),
  l = n.n(a),
  s = n(525654),
  c = n.n(s),
...
if (P) {
  ...
  A.ZP.on("NOTIFICATION_CLICK", (t, n) => {
    ...
    constructor(t, {
      ...
      y(this, "id", G._id++), y(this, "title", void 0), y(this, "body", void 0), y(this, "icon", void 0), y(this, "onshow", function() {}), y(this, "onclick", function() {}), y(this, "onclose", function() {}), t.includes("\0") ? (R.warn("Notification title contains null character, setting to empty string"), this.title = "") : this.title = t, n.includes("\0") ? (R.warn("Notification body contains null character, setting to empty string"), this.body = "") : this.body = n, this.icon = e, setImmediate(() => this.onshow()), i[this.id] = this, A.ZP.send("NOTIFICATION_SHOW", {
        id: this.id,
        title: this.title,
        body: this.body,
        icon: this.icon
  ...
  }, y(o, "permission", "granted"), y(o, "_id", 0), G = o
}
let V = {};
if (null === r.Z || void 0 === r.Z ? void 0 : r.Z.features.supports("notifications")) try {
...
function K() {
  return (null == e ? void 0 : e.authorizationStatus) === "authorized" && (!F || (0, h.R)({
    location: "shouldUseNative"
  }).enabled)
}
async function H(i) {
...
let J = {
  ...
  showNotification: async function(i, t, n, e, o) {
    ...
    let N = null != (l = null == o ? void 0 : o.tag) ? l : null,
      ...
      P = i => {
        var t;
        null == (t = o.onShown) || t.call(o), o.omitViewTracking || C.default.track(E.rMx.NOTIFICATION_VIEWED, e), D && setTimeout(() => i.close(), 5e3)
      };
    if (null == o.sound || y || B(o.sound, null != (s = o.volume) ? s : 1, o.soundpack), o.isUserAvatar && null != i && (i = await
        function(i) {
          let t = new Image;
      ...
      if (null != o.messageRecord && l.enabled) {
        ...
        if (l.includeImages)
          for (let i of o.messageRecord.attachments) !(0, O.yE)(null != (r = i.flags) ? r : 0, E.J0y.CONTAINS_EXPLICIT_MEDIA) && !(0, O.yE)(null != (d = i.flags) ? d : 0, E.J0y.IS_SPOILER) && (null == (c = i.content_type) ? void 0 : c.startsWith("image/")) && a.attachments.push({
            url: i.proxy_url,
            type: i.content_type
          })
      }
