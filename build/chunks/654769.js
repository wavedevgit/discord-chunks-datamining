...
e.d(i, {
  Z: () => q
}), e(388685), e(35282), e(358797), e(539854), e(997841);
var n, o = e(392711),
  a = e.n(o),
  l = e(525654),
  r = e.n(l),
...
if (P) {
  ...
  b.ZP.on("NOTIFICATION_CLICK", (i, e) => {
  ...
  }), b.ZP.send("NOTIFICATIONS_CLEAR"), n = class {
    ...
    constructor(i, {
      ...
      y(this, "id", G._id++), y(this, "title", void 0), y(this, "body", void 0), y(this, "icon", void 0), y(this, "onshow", function() {}), y(this, "onclick", function() {}), y(this, "onclose", function() {}), i.includes("\0") ? (F.warn("Notification title contains null character, setting to empty string"), this.title = "") : this.title = i, e.includes("\0") ? (F.warn("Notification body contains null character, setting to empty string"), this.body = "") : this.body = e, this.icon = n, setImmediate(() => this.onshow()), t[this.id] = this, b.ZP.send("NOTIFICATION_SHOW", {
        id: this.id,
        title: this.title,
        body: this.body,
        icon: this.icon
  ...
  }, y(n, "permission", "granted"), y(n, "_id", 0), G = n
}
let V = {};
...
async function H(t, i, e, n, o) {
  ...
  let Y = null != (l = null == o ? void 0 : o.tag) ? l : null,
    ...
    q = t => {
      var i;
      null == (i = o.onShown) || i.call(o), o.omitViewTracking || A.default.track(E.rMx.NOTIFICATION_VIEWED, n), R && setTimeout(() => t.close(), 5e3)
    };
  if (null == o.sound || H || B(o.sound, null != (r = o.volume) ? r : 1, o.soundpack), o.isUserAvatar && null != t && (t = await (0, I.D)(t)), M) {
    ...
    if (null != o.messageRecord && l.enabled) {
      ...
      if (l.includeImages)
        for (let t of o.messageRecord.attachments) !(0, _.yE)(null != (u = t.flags) ? u : 0, E.J0y.CONTAINS_EXPLICIT_MEDIA) && !(0, _.yE)(null != (h = t.flags) ? h : 0, E.J0y.IS_SPOILER) && (null == (s = t.content_type) ? void 0 : s.startsWith("image/")) && a.attachments.push({
          url: t.proxy_url,
          type: t.content_type
        })
    }
