...
async function U() {
  if (null === r.Z || void 0 === r.Z ? void 0 : r.Z.features.supports("notifications")) try {
...
async function L(i) {
  ...
  if (await D()) try {
    await y.ZP.invoke("NOTIFICATIONS_SEND_NOTIFICATION", {
      sound: z(i, n)
    });
    return
  } catch (i) {
...
if (S) {
  ...
  y.ZP.on("NOTIFICATION_CLICK", (t, n) => {
  ...
  }), y.ZP.send("NOTIFICATIONS_CLEAR"), e = class {
    ...
    constructor(t, {
      ...
      k(this, "id", W._id++), k(this, "title", void 0), k(this, "body", void 0), k(this, "icon", void 0), k(this, "onshow", function() {}), k(this, "onclick", function() {}), k(this, "onclose", function() {}), t.includes("\0") ? (P.warn("Notification title contains null character, setting to empty string"), this.title = "") : this.title = t, n.includes("\0") ? (P.warn("Notification body contains null character, setting to empty string"), this.body = "") : this.body = n, this.icon = e, setImmediate(() => this.onshow()), i[this.id] = this, y.ZP.send("NOTIFICATION_SHOW", {
        id: this.id,
        title: this.title,
        body: this.body,
        icon: this.icon
  ...
  }, k(e, "permission", "granted"), k(e, "_id", 0), W = e
}
let G = {};
if (null === r.Z || void 0 === r.Z ? void 0 : r.Z.features.supports("notifications")) {
  ...
  }(null === r.Z || void 0 === r.Z ? void 0 : r.Z.features.supports("notifications_provisional")) && H().then(i => {
...
async function q(i, t, n, e, o) {
  ...
  let H = null != (l = null == o ? void 0 : o.tag) ? l : null,
    ...
    K = i => {
      var t;
      null == (t = o.onShown) || t.call(o), o.omitViewTracking || b.default.track(A.rMx.NOTIFICATION_VIEWED, e), R && setTimeout(() => i.close(), 5e3)
    };
  if (null == o.sound || q || B(o.sound, null != (s = o.volume) ? s : 1, o.soundpack), o.isUserAvatar && null != i && (i = await
      function(i) {
        let t = new Image;
        return t.src = i, t.crossOrigin = "anonymous", new Promise((n, e) => {
          t.onload = () => {
            "" !== t.src && n(function(i) {
    ...
    if (null != o.messageRecord && l.enabled) {
      ...
      if (l.includeImages)
        for (let i of o.messageRecord.attachments) !(0, Z.yE)(null != (u = i.flags) ? u : 0, A.J0y.CONTAINS_EXPLICIT_MEDIA) && !(0, Z.yE)(null != (h = i.flags) ? h : 0, A.J0y.IS_SPOILER) && (null == (r = i.content_type) ? void 0 : r.startsWith("image/")) && a.attachments.push({
          url: i.proxy_url,
          type: i.content_type
        })
    }
...
let K = {
  ...
  requestPermission: function(i) {
    if (null === r.Z || void 0 === r.Z ? void 0 : r.Z.features.supports("notifications")) try {
      y.ZP.invoke("NOTIFICATIONS_GET_AUTHORIZATION").then(t => {
        i(t)
      }).catch(() => {
        i(!1)
      });
    ...
    null != W && W.requestPermission(async () => {
      null != i && i(await V())
    })
  },
  showNotification: q,
