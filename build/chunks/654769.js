...
async function x(i) {
  ...
  if (await L()) try {
    await _.ZP.invoke("NOTIFICATIONS_SEND_NOTIFICATION", {
      sound: M(i, n)
    });
    return
  } catch (i) {
...
if (F) {
  ...
  _.ZP.on("NOTIFICATION_CLICK", (t, n) => {
  ...
  }), _.ZP.send("NOTIFICATIONS_CLEAR"), o = class {
    ...
    constructor(t, {
      ...
      y(this, "id", U._id++), y(this, "title", void 0), y(this, "body", void 0), y(this, "icon", void 0), y(this, "onshow", function() {}), y(this, "onclick", function() {}), y(this, "onclose", function() {}), t.includes("\0") ? (P.warn("Notification title contains null character, setting to empty string"), this.title = "") : this.title = t, n.includes("\0") ? (P.warn("Notification body contains null character, setting to empty string"), this.body = "") : this.body = n, this.icon = e, setImmediate(() => this.onshow()), i[this.id] = this, _.ZP.send("NOTIFICATION_SHOW", {
        id: this.id,
        title: this.title,
        body: this.body,
        icon: this.icon
  ...
  }, y(o, "permission", "granted"), y(o, "_id", 0), U = o
}
let G = {};
if (null === r.Z || void 0 === r.Z ? void 0 : r.Z.features.supports("notifications")) try {
...
let H = {
  ...
  requestPermission: function(i) {
    if (null === r.Z || void 0 === r.Z ? void 0 : r.Z.features.supports("notifications")) try {
      _.ZP.invoke("NOTIFICATIONS_GET_AUTHORIZATION").then(t => {
        i(t)
      }).catch(() => {
        i(!1)
      }).finally(() => {
  ...
  showNotification: async function(i, t, n, e, o) {
    ...
    let v = null !== (l = null == o ? void 0 : o.tag) && void 0 !== l ? l : null,
      ...
      L = i => {
        var t;
        null === (t = o.onShown) || void 0 === t || t.call(o), o.omitViewTracking || T.default.track(k.rMx.NOTIFICATION_VIEWED, e), R && setTimeout(() => i.close(), 5e3)
      };
    if (null == o.sound || F || q(o.sound, null !== (s = o.volume) && void 0 !== s ? s : 1, o.soundpack), o.isUserAvatar && null != i && (i = await
        function(i) {
          let t = new Image;
      ...
      if (null != o.messageRecord && l.enabled) {
        ...
        if (l.includeImages)
          for (let i of o.messageRecord.attachments) !(0, b.yE)(null !== (r = i.flags) && void 0 !== r ? r : 0, k.J0y.CONTAINS_EXPLICIT_MEDIA) && !(0, b.yE)(null !== (u = i.flags) && void 0 !== u ? u : 0, k.J0y.IS_SPOILER) && (null === (c = i.content_type) || void 0 === c ? void 0 : c.startsWith("image/")) && a.attachments.push({
            url: i.proxy_url,
            type: i.content_type
          })
      }
