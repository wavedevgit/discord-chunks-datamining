...
if (S) {
  ...
  A.ZP.on("NOTIFICATION_CLICK", (t, n) => {
    ...
    constructor(t, {
      ...
      E(this, "id", G._id++), E(this, "title", void 0), E(this, "body", void 0), E(this, "icon", void 0), E(this, "onshow", function() {}), E(this, "onclick", function() {}), E(this, "onclose", function() {}), t.includes("\0") ? (R.warn("Notification title contains null character, setting to empty string"), this.title = "") : this.title = t, n.includes("\0") ? (R.warn("Notification body contains null character, setting to empty string"), this.body = "") : this.body = n, this.icon = e, setImmediate(() => this.onshow()), i[this.id] = this, A.ZP.send("NOTIFICATION_SHOW", {
        id: this.id,
        title: this.title,
        body: this.body,
        icon: this.icon
  ...
  }, E(o, "permission", "granted"), E(o, "_id", 0), G = o
}
let V = {};
if (null === c.Z || void 0 === c.Z ? void 0 : c.Z.features.supports("notifications")) try {
...
let J = {
  ...
  showNotification: async function(i, t, n, e, o) {
    ...
    let m = null != (l = null == o ? void 0 : o.tag) ? l : null,
      ...
      S = i => {
        var t;
        null == (t = o.onShown) || t.call(o), o.omitViewTracking || C.default.track(k.rMx.NOTIFICATION_VIEWED, e), U && setTimeout(() => i.close(), 5e3)
      };
    if (null == o.sound || E || H(o.sound, null != (s = o.volume) ? s : 1, o.soundpack), o.isUserAvatar && null != i && (i = await
        function(i) {
          let t = new Image;
      ...
      if (null != o.messageRecord && l.enabled) {
        ...
        if (l.includeImages)
          for (let i of o.messageRecord.attachments) !(0, y.yE)(null != (c = i.flags) ? c : 0, k.J0y.CONTAINS_EXPLICIT_MEDIA) && !(0, y.yE)(null != (d = i.flags) ? d : 0, k.J0y.IS_SPOILER) && (null == (r = i.content_type) ? void 0 : r.startsWith("image/")) && a.attachments.push({
            url: i.proxy_url,
            type: i.content_type
          })
      }
