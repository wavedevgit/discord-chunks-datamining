...
if (k) {
  ...
  C.ZP.on("NOTIFICATION_CLICK", (t, n) => {
  ...
  }), C.ZP.send("NOTIFICATIONS_CLEAR"), r = class {
    ...
    constructor(t, {
      ...
      P(this, "id", Y._id++), P(this, "title", void 0), P(this, "body", void 0), P(this, "icon", void 0), P(this, "onshow", function() {}), P(this, "onclick", function() {}), P(this, "onclose", function() {}), t.includes("\0") ? (j.warn("Notification title contains null character, setting to empty string"), this.title = "") : this.title = t, n.includes("\0") ? (j.warn("Notification body contains null character, setting to empty string"), this.body = "") : this.body = n, this.icon = r, setImmediate(() => this.onshow()), e[this.id] = this, C.ZP.send("NOTIFICATION_SHOW", {
        id: this.id,
        title: this.title,
        body: this.body,
        icon: this.icon
  ...
  }, P(r, "permission", "granted"), P(r, "_id", 0), Y = r
}
let W = {};
  ...
  try {
    C.ZP.on("NOTIFICATIONS_RECEIVED_RESPONSE", (e, t, n) => {
      if ("dismiss" === t) delete W[n];
        ...
        var r, i, a;
        let e = W[n];
        N.isPlatformEmbedded ? C.ZP.focus() : window.focus(), (null == e || null == (r = e.options) ? void 0 : r.omitClickTracking) || (T.default.track(R.rMx.NOTIFICATION_ACTION, w({
          action: "CLICK"
        }, e.trackingProps)), T.default.track(R.rMx.NOTIFICATION_CLICKED, e.clickTrackingProps)), null == e || null == (a = e.options) || null == (i = a.onClick) || i.call(a)
      }
    }), C.ZP.invoke("NOTIFICATIONS_REMOVE_ALL_NOTIFICATIONS")
  } catch (e) {
    j.warn("Native notification setup failed with error: ", e)
  }(null === l.Z || void 0 === l.Z ? void 0 : l.Z.features.supports("notifications_provisional")) && q().then(e => {
...
function K(e) {
  ...
  null != Y && Y.requestPermission(async () => {
    null != e && e(await z())
  })
}
async function z() {
...
async function Q(e, t, n, r, i) {
  ...
  let J = null != (o = null == i ? void 0 : i.tag) ? o : null,
    ...
    ee = (e, t) => {
      ...
      null == (n = i.onShown) || n.call(i), i.omitViewTracking || (T.default.track(R.rMx.NOTIFICATION_ACTION, w({
        action: "VIEW"
      }, t)), T.default.track(R.rMx.NOTIFICATION_VIEWED, Q)), U && setTimeout(() => e.close(), 5e3)
    };
  if (null == i.sound || $ || (X(i.sound, null != (s = i.volume) ? s : 1, i.soundpack), r.ping = !0), i.isUserAvatar && null != e && (e = await (0, p.D)(e)), x && y.Z.taskbarFlash && C.ZP.flashFrame(!0), B) {
    ...
    if (null != i.messageRecord && o.enabled) {
      ...
      if (o.includeImages)
        for (let e of i.messageRecord.attachments) !(0, S.yE)(null != (u = e.flags) ? u : 0, R.J0y.CONTAINS_EXPLICIT_MEDIA) && !(0, S.yE)(null != (h = e.flags) ? h : 0, R.J0y.IS_SPOILER) && (null == (l = e.content_type) ? void 0 : l.startsWith("image/")) && a.attachments.push({
          url: e.proxy_url,
          type: e.content_type
        })
    }
  ...
  return (ee(g, r), g.onclick = () => {
    var e;
    N.isPlatformEmbedded ? C.ZP.focus() : (window.focus(), g.close()), i.omitClickTracking || (T.default.track(R.rMx.NOTIFICATION_ACTION, w({
      action: "CLICK"
    }, r)), T.default.track(R.rMx.NOTIFICATION_CLICKED, q)), null == (e = i.onClick) || e.call(i)
  }, M) ? {
    notification: g,
    trackingProps: r
  } : {
