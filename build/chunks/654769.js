...
async function K(e, t, n, r, i) {
  ...
  if (null == i.sound || Y || W(i.sound, null != (s = i.volume) ? s : 1, i.soundpack), i.isUserAvatar && null != e && (e = await (0, _.D)(e)), R && b.Z.taskbarFlash && N.ZP.flashFrame(!0), U) {
    ...
    if (null != i.messageRecord && o.enabled) {
      ...
      if (o.includeImages)
        for (let e of i.messageRecord.attachments) !(0, S.yE)(null != (u = e.flags) ? u : 0, C.J0y.CONTAINS_EXPLICIT_MEDIA) && !(0, S.yE)(null != (p = e.flags) ? p : 0, C.J0y.IS_SPOILER) && (null == (l = e.content_type) ? void 0 : l.startsWith("image/")) && a.attachments.push({
          url: e.proxy_url,
          type: e.content_type
        })
    }
