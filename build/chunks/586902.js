...
function c(e) {
  ...
  }), p = u && ((null == f ? true : f.mute) || (null == f ? true : f.selfMute)), _ = (0, r.e7)([o.Z], () => o.Z.isSpeaking(t, d) && !p), h = (0, r.e7)([o.Z], () => o.Z.isSoundSharing(t) && n);
...
function u(e) {
  let {
    ...
    context: u
  } = e, [d, f, p, _] = arguments.length > 1 && true !== arguments[1] ? arguments[1] : [s.Z, a.Z, o.Z, i.Z], h = f.getVoiceChannelId(), m = null != h ? d.getVoiceStateForChannel(h, t) : null, g = c && ((null == m ? true : m.mute) || (null == m ? true : m.selfMute)), E = p.isSpeaking(t, u) && !g, b = p.isSoundSharing(t) && n;
