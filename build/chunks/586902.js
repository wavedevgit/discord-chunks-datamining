...
function u(e) {
  let {
    ...
    checkIsMuted: c = !1,
    context: u
  } = e, [d, f, _, p] = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [s.Z, o.Z, a.Z, i.Z], h = f.getVoiceChannelId(), m = null != h ? d.getVoiceStateForChannel(h, t) : null, g = c && ((null == m ? void 0 : m.mute) || (null == m ? void 0 : m.selfMute)), E = _.isSpeaking(t, u) && !g, b = _.isSoundSharing(t) && n;
