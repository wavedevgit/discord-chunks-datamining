...
function P(e) {
  ...
  (null == a ? void 0 : a.status) !== y.L.DOWNLOADING && (c.Z.dispatch(I({
    ...
    if (null == t ? void 0 : t.USER_CANCELED_DOWNLOAD) A.info("User canceled the download for Voice Filter dependency", e);
      ...
      A.error(n, I({
        reason: t
      }, e)), _.default.track(O.rMx.VOICE_FILTER_ERROR, {
        error_message: n,
        cause: (0, f.X)(Error(t))
...
async function x() {
  ...
  if (!R) try {
    ...
    A.warn("Failed to refresh voice filters catalog: ".concat(e.message)), _.default.track(O.rMx.VOICE_FILTER_ERROR, {
  ...
  if (!(b.Z.isNativeModuleLoaded() || b.Z.isNativeModuleLoading()) && !__OVERLAY__) {
    ...
    try {
      ...
      d.Z.getMediaEngine().on(l.aB.VoiceFiltersFailed, e => {
        A.warn("Voice Filters failed in process: ".concat(e)), _.default.track(O.rMx.VOICE_FILTER_ERROR, {
      ...
      A.warn("Failed to load Voice Filters module: ".concat(e.message)), _.default.track(O.rMx.VOICE_FILTER_ERROR, {
