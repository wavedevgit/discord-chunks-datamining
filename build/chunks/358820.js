...
function C(e) {
  ...
  if ((null == a ? void 0 : a.status) === E.L.DOWNLOADED) return void l.Z.dispatch(I(O({
    type: "VOICE_FILTER_FILE_READY"
  }, e), {
    fetchedFromNetwork: !1,
    analyticsContext: t
  }));
  (null == a ? void 0 : a.status) !== E.L.DOWNLOADING && (l.Z.dispatch(O({
    type: "VOICE_FILTER_DOWNLOAD_STARTED"
  }, e)), h.ZP.downloadVoiceFilterFile(n, i, t => {
    let {
      downloadedBytes: n,
      totalBytes: r
    } = t;
    ...
    if (null == t ? void 0 : t.USER_CANCELED_DOWNLOAD) S.info("User canceled the download for Voice Filter dependency", e);
      ...
      S.error(n, O({
        reason: t
      }, e)), d.default.track(b.rMx.VOICE_FILTER_ERROR, {
        error_message: n,
        cause: (0, f.X)(Error(t))
...
async function P(e) {
  ...
  try {
    ...
    S.error("failed to set voice filter", t), l.Z.dispatch({
...
async function R() {
  ...
  try {
    ...
    S.warn("Failed to refresh voice filters catalog: ".concat(e.message)), d.default.track(b.rMx.VOICE_FILTER_ERROR, {
      error_message: "Failed to refresh voice filters catalog",
      cause: (0, f.X)(e)
    }), p.Z.captureException(e), await l.Z.dispatch({
...
async function D() {
  if (!(g.Z.isNativeModuleLoaded() || g.Z.isNativeModuleLoading()) && !__OVERLAY__) {
    if (!(0, _.isWindows)() && !(0, _.isMac)()) return void l.Z.dispatch({
    ...
    try {
      ...
      await t.setupResources(), void 0 !== t.setVoiceFilterLaggingCallback && await t.setVoiceFilterLaggingCallback(A), void 0 !== t.setVoiceFilterReadyCallback && await t.setVoiceFilterReadyCallback(e => {
        l.Z.dispatch({
      ...
      u.Z.getMediaEngine().on(s.aB.VoiceFiltersFailed, e => {
        S.warn("Voice Filters failed in process: ".concat(e)), d.default.track(b.rMx.VOICE_FILTER_ERROR, {
      ...
      S.warn("Failed to load Voice Filters module: ".concat(e.message)), d.default.track(b.rMx.VOICE_FILTER_ERROR, {
        error_message: "Failed to load Voice Filters module",
        cause: (0, f.X)(e)
      }), p.Z.captureException(e), l.Z.dispatch({
        type: "VOICE_FILTER_NATIVE_MODULE_STATE_CHANGE",
        state: E.O.FAILED
      })
    }
