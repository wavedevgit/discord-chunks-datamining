...
async function en(e) {
  ...
  let n = await eo(e);
  R.verbose("Overlay method for pid ".concat(e, ": ").concat((0, y.P_)(n.overlayMethod))), $(e, g.zE.SCREEN_TYPE_RESOLUTION), await ea(e, n), ef(y.HD), k = n.overlayMethod, eL.emitChange(), await s.Z.updateTrackedGame(e, t)
}
async function er(e) {
  var t, n, r;
