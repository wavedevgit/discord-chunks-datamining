...
function et(e, t) {
  ...
  if (!a.enabledOOP && a.enabledLegacy) return F() ? A(T({}, (0, y.qT)(i)), {
...
async function en(e) {
  ...
  let n = await ea(e);
  R.verbose("Overlay method for pid ".concat(e, ": ").concat((0, y.P_)(n.overlayMethod))), $(e, g.zE.SCREEN_TYPE_RESOLUTION), await eo(e, n), ef(y.HD), M = n.overlayMethod, eL.emitChange(), await s.Z.updateTrackedGame(e, t)
}
async function er(e) {
  var t, n, r;
...
async function ed(e) {
  ...
  t && (R.info("determineFullscreenOverlayMethodSwaps has changes"), eL.emitChange(), V(null, "fullscreen_overlay_method_swap_changes", {
...
function eR(e) {
  X(e.pid) && Q(e.pid, "successfullyShown", true), V(e.pid, "overlay_successfully_shown", {
    pid: e.pid
  });
  let t = W(e.pid);
