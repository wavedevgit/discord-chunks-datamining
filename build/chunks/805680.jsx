...
function J(e) {
  ...
  return <m.Z section={k.jXE.EXPRESSION_PICKER}><T.W5 className={a()(F.positionLayer, eD)} targetRef={l} position={J} align={$} spacing={8} autoInvert={true} clickTrap={true}>{e => {
        var t;
        let {
          isPositioned: n
        } = e;
