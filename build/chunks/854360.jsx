...
function m(e) {
  ...
  let [v, h] = i.useState(""), [M, C] = i.useState(false), A = (0, u.sE)(t, {
    location: m,
    targetUserId: n.id
  }), {
    isModReportClosed: S,
  ...
  }, [t, n.id, v, A, y, M, j]), x = i.useCallback(e => {
    h(e)
  }, []);
  return null != y && P ? <a.Modal{...E(b({}, j), {
    title: g.intl.formatToPlainString(g.t["1Ie87u"], {
      user: n.username
    }),
    subtitle: g.intl.format(g.t["/yH0UV"], {
      user: "@".concat(_.ZP.getName(n))
    }),
    actions: [{
    ...
    actionBarInput: S ? true : (0, r.jsx)(o.XZJ, {
      value: M,
      onChange: (e, t) => {
        C(t)
      },
