/** Chunk was on web.js **/
/** chunk id: 647307, original params: e,t,n (module,exports,re quire) **/
Object.defineProperty(exports, "__esModule", {
  value: true
});
var Chunk64700 = require("./64700.js"),
  Chunk877508 = require("./877508.js"),
  a = function(e) {
...
function b(e) {
  var t = e.riveLoaded,
    ...
    M = r.useCallback(function() {
      var e, t, n, r, i = null != (t = null == (e = a.current) ? true : e.clientWidth) ? t : 0,
        s = null != (r = null == (n = a.current) ? true : n.clientHeight) ? r : 0;
      return C && c ? {
        width: i,
  ...
  r.useEffect(function() {
    if (N && a.current && n) {
      ...
      if (i) {
        var o = t !== h || r !== _;
        if (d.fitCanvasToArtboardHeight && o && (a.current.style.height = r + "px", s = true), d.useDevicePixelRatio) {
          if (o || t * D !== A || r * D !== O) {
            var c = D * t,
              u = D * r;
            i.width = c, i.height = u, i.style.width = t + "px", i.style.height = r + "px", v({
              width: c,
              height: u
            }), s = true
          }
        } else o && (i.width = t, i.height = r, v({
          width: t,
          height: r
        }), s = true);
        g({
  ...
  }, [i, a, P, D, M, I, T, O, A, _, h, l, N, C, R, n]), r.useEffect(function() {
    v({
      width: 0,
      height: 0
    })
...
function T(e, t) {
  ...
  var w = r.useCallback(function(e) {
    return a.default.createElement(I, s({
      setContainerRef: v,
      setCanvasRef: A
    }, e))
  }, [A, v]);
...
exports.default = function(e) {
...
}, exports.useResizeCanvas = b, exports.useRive = T, exports.useRiveFile = function(e) {
  var t = this,
    n = r.useState(null),
    a = n[0],
    s = n[1],
  ...
  return r.useEffect(function() {
    ...
    if (e) {
      var a = null;
      f(a = null != i ? e.instanceByName(i) || null : s ? (null == (t = e.defaultInstance) ? true : t.call(e)) || null : l ? (null == (n = e.instance) ? true : n.call(e)) || null : (null == (r = e.defaultInstance) ? true : r.call(e)) || null), c && a && c.viewModelInstance !== a && c.bindViewModelInstance(a)
    } else f(null)
  }, [e, i, s, l, c]), d
...
}, Object.keys(Chunk877508).forEach(function(e) {
