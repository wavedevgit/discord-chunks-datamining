...
function E(e) {
  let t = (0, l.e7)([g.Z], () => g.Z.getNotificationStateForGuild(e), [e]),
    ...
    E = function(e, t) {
      let [n, r] = (0, c.US)(null != t ? [o.z.GUILD_POWERUP_PERKS_COACHMARK] : []), l = n === o.z.GUILD_POWERUP_PERKS_COACHMARK, {
      ...
      }(e, t), [f, g] = (0, c.XR)(null != t && !l && a > 0 ? o.z.GUILD_POWERUP_NEW_PERK_AVAILABLE_COACHMARK : null, a), m = f === o.z.GUILD_POWERUP_NEW_PERK_AVAILABLE_COACHMARK, y = i.useMemo(() => {
        ...
        let r = function(e, t, n) {
          ...
          let l = null != (i = null == (r = d.Z.getGuild(e)) ? void 0 : r.premiumTier) ? i : C.Eu4.NONE,
            s = Array.from(v.KW.values()).map(e => {
          ...
          if (0 !== s.length) {
            if (1 === s.length && !(0, u.OY)(o.C.GUILD_POWERUP_SINGLE_SKU_PURCHASE_COACHMARK, e)) return {
            ...
            if (s.length > 1 && !(0, u.OY)(o.C.GUILD_POWERUP_CHOICE_SKU_PURCHASE_COACHMARK, e)) return {
              type: b.J.PERKS_PURCHASABLE,
              powerups: s,
              markAsDismissed: t => {
        ...
        if (null != r) return r
      }, [e, t, l, m, s]), [j, E] = (0, c.bf)(null != y ? o.z.GUILD_POWERUP_NOTIFICATION : null, {
