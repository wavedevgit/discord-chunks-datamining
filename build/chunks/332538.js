...
function j(e) {
  let t = (0, l.e7)([g.Z], () => g.Z.getNotificationStateForGuild(e), [e]),
    n = (0, l.e7)([m.Z], () => m.Z.getStateForGuild(e)),
    {
      ...
      return i.useMemo(() => {
        ...
        let {
          unlockedPowerups: c
        } = t, u = (0, O.h)(c), d = null != (i = null == n ? void 0 : n.lastSeenWarningNotification) ? i : Date.now(), h = new Date(null == (e = u[u.length - 1]) ? void 0 : e.ends_at).getTime(), p = null != (o = null == n ? void 0 : n.lastBoostCount) ? o : 0;
      ...
      let [n, r] = (0, c.US)(null != t ? [o.z.GUILD_POWERUP_PERKS_COACHMARK] : []), {
        ...
        let i = function(e, t, n) {
          ...
          let l = null != (i = null == (r = d.Z.getGuild(e)) ? void 0 : r.premiumTier) ? i : v.Eu4.NONE,
            s = Array.from(y.KW.values()).map(e => {
        ...
        if (null != i) return i
      }, [e, t, n, l]), [a, f] = (0, c.bf)(null != s ? o.z.GUILD_POWERUP_NOTIFICATION : null, {
        cooldownDurationMs: b.d
      });
      return i.useMemo(() => {
        if (null != t) {
          if (n === o.z.GUILD_POWERUP_PERKS_COACHMARK) return {
  ...
  if (null !== n && (null != f || C || null != j)) return {
    trailing: f,
    showUnread: C,
    popout: j
  }
