...
function m(e) {
  let t = (0, a.e7)([u.Z], () => {
    ...
    m = (0, a.e7)([p.Z], () => p.Z.getStateForGuild(e)),
    {
      ...
      let {
        unlocked: l
      } = m, a = (0, f.h)(l), u = null !== (n = null == o ? void 0 : o.lastSeenWarningNotification) && void 0 !== n ? n : Date.now(), d = new Date(null === (e = a[a.length - 1]) || void 0 === e ? void 0 : e.ends_at).getTime(), p = null !== (i = null == o ? void 0 : o.lastBoostCount) && void 0 !== i ? i : 0;
    ...
    y = i.useMemo(() => {
      ...
      if (null == o) return;
      let b = new Set(null !== (a = Array.from(null !== (i = d.values()) && void 0 !== i ? i : []).map(e => {
        var t;
        return null == m ? void 0 : null === (t = m.powerups) || void 0 === t ? void 0 : t.get(e.sku_id)
      }).filter(e => (null == e ? void 0 : e.type) === g.Us.LEVEL).map(e => e.skuId)) && void 0 !== a ? a : []).difference(new Set(null !== (s = null == o ? void 0 : o.seenLevelSkuIds) && void 0 !== s ? s : []));
      if (b.size > 0) {
  ...
  if (n && null !== m && (null != b || v || null != y)) return {
    trailing: b,
    showUnread: v,
    popout: y
  }
