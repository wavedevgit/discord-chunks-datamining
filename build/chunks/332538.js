...
function E(e) {
  let t = (0, l.e7)([g.Z], () => g.Z.getNotificationStateForGuild(e), [e]),
    ...
    E = function(e, t) {
      let [n, r] = (0, c.US)(null != t ? [o.z.GUILD_POWERUP_PERKS_COACHMARK] : []), l = n === o.z.GUILD_POWERUP_PERKS_COACHMARK, {
        available: a
      } = (0, O.Z)(e), s = function(e, t) {
      ...
      }(e, t), [f, g] = (0, c.XR)(null != t && !l && s > 0 ? o.z.GUILD_POWERUP_NEW_PERK_AVAILABLE_COACHMARK : null, s), m = f === o.z.GUILD_POWERUP_NEW_PERK_AVAILABLE_COACHMARK, y = i.useMemo(() => {
        ...
        let r = function(e, t, n) {
          ...
          let l = null != (i = null == (r = d.Z.getGuild(e)) ? void 0 : r.premiumTier) ? i : C.Eu4.NONE,
            a = Array.from(v.KW.values()).map(e => {
          ...
          if (0 !== a.length) {
            if (1 === a.length && !(0, u.OY)(o.C.GUILD_POWERUP_SINGLE_SKU_PURCHASE_COACHMARK, e)) return {
            ...
            if (a.length > 1 && !(0, u.OY)(o.C.GUILD_POWERUP_CHOICE_SKU_PURCHASE_COACHMARK, e)) return {
              type: b.J.PERKS_PURCHASABLE,
              powerups: a,
              markAsDismissed: t => {
        ...
        if (null != r) return r
      }, [e, t, l, m, a]), [j, E] = (0, c.bf)(null != y ? o.z.GUILD_POWERUP_NOTIFICATION : null, {
        cooldownDurationMs: b.d
      });
      return i.useMemo(() => {
        if (null != t) {
          if (l) return {
  ...
  if (null !== n && (null != f || j || null != E)) return {
    trailing: f,
    showUnread: j,
    popout: E
  }
