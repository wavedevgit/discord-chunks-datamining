...
function v(e) {
  let t = (0, l.e7)([f.Z], () => f.Z.getNotificationStateForGuild(e), [e]),
    n = (0, l.e7)([g.Z], () => g.Z.getStateForGuild(e)),
    {
      ...
      return i.useMemo(() => {
        ...
        let {
          unlocked: c
        } = t, u = (0, _.h)(c), d = null != (i = null == n ? void 0 : n.lastSeenWarningNotification) ? i : Date.now(), p = new Date(null == (e = u[u.length - 1]) ? void 0 : e.ends_at).getTime(), h = null != (l = null == n ? void 0 : n.lastBoostCount) ? l : 0;
    ...
    j = function(e, t) {
      let [n, r] = (0, c.cv)(null != t ? [o.z.GUILD_POWERUP_PERKS_COACHMARK] : []), {
        ...
        if (null != i) return i
      }, [e, t, n, l]), [s, d] = (0, c.Tt)(null != a ? o.z.GUILD_POWERUP_NOTIFICATION : null, {
        cooldownDurationMs: m.d
      });
      return i.useMemo(() => {
        if (null != t) {
          if (n === o.z.GUILD_POWERUP_PERKS_COACHMARK) return {
            type: m.J.PERKS_AVAILABLE,
            powerups: Array.from(y.KW.values()).map(e => t.powerups.get(e)).filter(p.lm),
            markAsDismissed: r
          };
  ...
  if (null !== n && (null != v || O || null != j)) return {
    trailing: v,
    showUnread: O,
    popout: j
  }
