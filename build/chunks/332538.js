...
function y(e) {
  let t = (0, l.e7)([h.Z], () => h.Z.getNotificationStateForGuild(e), [e]),
    n = (0, l.e7)([f.Z], () => f.Z.getStateForGuild(e)),
    {
      ...
      return i.useMemo(() => {
        ...
        let {
          unlocked: c
        } = t, u = (0, b.h)(c), d = null != (i = null == n ? void 0 : n.lastSeenWarningNotification) ? i : Date.now(), p = new Date(null == (e = u[u.length - 1]) ? void 0 : e.ends_at).getTime(), h = null != (o = null == n ? void 0 : n.lastBoostCount) ? o : 0;
    ...
    O = function(e, t) {
      let [n, r] = (0, c.cv)(null != t ? [o.z.GUILD_POWERUP_PERKS_COACHMARK] : []), {
        ...
        let i = function(e, t, n) {
          let r = Array.from(_.KW.values()).map(e => {
        ...
        if (null != i) return i
      }, [e, t, n, l]), [s, h] = (0, c.Tt)(null != a ? o.z.GUILD_POWERUP_NOTIFICATION : null, {
        cooldownDurationMs: g.d
      });
      return i.useMemo(() => {
        if (null != t) {
          if (n === o.z.GUILD_POWERUP_PERKS_COACHMARK) return {
            type: g.J.PERKS_AVAILABLE,
            powerups: Array.from(_.KW.values()).map(e => t.powerups.get(e)).filter(d.lm),
            markAsDismissed: r
          };
  ...
  if (null !== n && (null != y || v || null != O)) return {
    trailing: y,
    showUnread: v,
    popout: O
  }
