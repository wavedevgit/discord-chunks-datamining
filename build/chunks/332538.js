...
function S(e) {
  let t = (0, l.e7)([m.Z], () => m.Z.getNotificationStateForGuild(e), [e]),
    ...
    S = function(e, t) {
      let [n, r] = (0, u.US)(null != t ? [o.z.GUILD_POWERUP_PERKS_COACHMARK] : []), l = n === o.z.GUILD_POWERUP_PERKS_COACHMARK, {
      ...
      }(e, t), [c, g] = (0, u.XR)(null != t && !l && s > 0 ? o.z.GUILD_POWERUP_NEW_PERK_AVAILABLE_COACHMARK : null, s), m = c === o.z.GUILD_POWERUP_NEW_PERK_AVAILABLE_COACHMARK, b = i.useMemo(() => {
        ...
        let r = function(e, t, n) {
          ...
          let l = null != (i = null == (r = h.Z.getGuild(e)) ? void 0 : r.premiumTier) ? i : E.Eu4.NONE,
            a = Array.from(j.KW.values()).map(e => {
        ...
        if (null != r) return r
      }, [e, t, l, m, a]), [v, C] = (0, u.bf)(null != b ? o.z.GUILD_POWERUP_NOTIFICATION : null, {
  ...
  if (null !== n && (null != g || x || null != S)) return {
    trailing: g,
    showUnread: x,
    popout: S
  }
