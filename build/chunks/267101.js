...
let f = e => {
  ...
  p = function(e, t) {
    ...
    }, o = (0, i.e7)([l.Z], () => l.Z.isConnected()), a = (0, i.e7)([u.Z], () => u.Z.getGuildId());
    return r.useEffect(() => {
      let r = c.Z.getGuildProductFetchState(t);
      if ((!n || a === e) && o && r === c.M.NOT_FETCHED) try {
        s.cf(e, t)
      } catch (e) {}
    }, [e, t, o, a, n]), (0, i.e7)([c.Z], () => c.Z.getGuildProduct(t))
  },
  E = function(e) {
    let {
      publishedOnly: t
    } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
    return (0, i.e7)([c.Z, o.Z], () => c.Z.getGuildProductsForGuild(e, {
