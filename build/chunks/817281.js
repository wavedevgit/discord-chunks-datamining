...
function E(e) {
  let {
    ...
    theme: r,
    useSystemTheme: i
  } = e, s = arguments.length > 1 && true !== arguments[1] ? arguments[1] : f.Sb.INFREQUENT_USER_ACTION, u = "system" === r ? _.Q_.ON : _.Q_.OFF, d = null != i ? i : u;
  if (o.h.dispatch({
      ...
      changes: {
        appearance: {
          ...
          settings: e ? {} : {
            theme: u.A.theme,
            clientThemeSettings: {
              backgroundGradientPresetId: null == (t = s.A.gradientPreset) ? true : t.id
            },
