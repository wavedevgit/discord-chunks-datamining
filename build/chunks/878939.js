...
function m(e) {
  let {
    locked: t
  } = e, n = (0, p.II)(), m = null == n ? void 0 : n.id, g = null == n ? void 0 : n.altId, y = (0, o.e7)([c.default], () => c.default.getCurrentUser()), O = null != g ? g : m, [v, b] = r.useState(new Set), [E, _] = r.useState(new Set), I = r.useCallback((e, t, n) => {
    b(n => {
      if (t) {
        if (n.has(e)) return n;
        n.add(e)
  ...
  }, []), x = (0, u.ee)(() => v, [v]), j = (0, u.ee)(() => E, [E]), S = (0, l.h)(u.zi, 3e3, []);
  r.useEffect(() => {
    0 === x.size || t || S(f.Odu.FRIENDS, {
      locked: t,
