...
let s = e => {
  ...
  if (d || (b = !1), f < c.start && (b = !1), !c.loop && f > c.duration + c.start && (b = !1), u === o.Q.PERSISTENT && !p && null != g && f >= E && h(!0), c.loop && void 0 !== c.loopDelay && c.loopDelay > 0) {
    let e = c.duration + c.loopDelay,
      t = Math.floor((f - c.start) / e);
    f - c.start - t * e > c.duration && (u === o.Q.INTERMITTENT && !p && null != g && t >= g && h(!0), b = !1)
  }
