...
let f = function(e) {
  ...
  return <div className={t}>{<o.vwX className={h.sectionTitle}>{p.intl.string(g.default.zSbMdX)}</o.vwX>}{<div className={h.pickerGrid}>{m.Ek.map(e => <o.P3F className={a()(h.pickerItem, {
          [h.pickerItemSelected]: e.primary === f && e.secondary === b
        })} onClick={() => O(e)}><d.v badge={l} width={32} height={32} primaryTintColor={e.primary} secondaryTintColor={e.secondary} /></o.P3F>)}{<c.Z popoutTargetRef={v} showSecondaryColor={m.ER[l] >= 2} palette={{
          primary: f,
          secondary: b
        ...
        }} shouldShow={x} onRequestClose={() => j(false)}>{e => {
          var t, n;
