...
function j(e, t, n, r, a) {
  ...
  if (l) return a = a(e), l = "" === r ? "." + D(e, 0) : r, T(a) ? (n = "", null != l && (n = l.replace(w, "$&/") + "/"), j(a, t, n, "", function(e) {
    return e
  })) : null != a && (R(a) && (a = N(a, n + (null == a.key || e && e.key === a.key ? "" : ("" + a.key).replace(w, "$&/") + "/") + l)), t.push(a)), 1;
  l = 0;
  var c = "" === r ? "." : r + ":";
  if (T(e))
...
exports.Children = {
  ...
  return C(e.type, i, true, true, o, r)
