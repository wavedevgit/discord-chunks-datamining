...
let j = [16, 16, 14, 14, 12, 10, 8],
  N = function(e) {
    ...
    let {
      name: P
    } = s, w = null != s.discoverySplash && /^data:/.test(s.discoverySplash) ? s.discoverySplash : g.ZP.getGuildDiscoverySplashURL({
      id: s.id,
      splash: s.discoverySplash,
      size: 240 * (0, m.x_)()
    }), R = (0, l.wj)(E) ? b : x, D = null != (t = g.ZP.getGuildIconURL({
      id: s.id,
      icon: s.icon,
      size: 40
    })) ? t : void 0, Z = null != s.description ? s.description : y, k = null != O ? O : null == s ? void 0 : s.memberCount, A = null != C ? C : null == s ? void 0 : s.presenceCount, W = null;
    if (null != D) W = (0, r.jsx)("img", {
      src: D,
      alt: "",
      className: h.avatar
    });
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [null != A && (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)("div", {
              ...
              children: v ? f.NW.formatToPlainString(f.t.YMor7u, {
                count: A
              }) : f.NW.formatToPlainString(f.t["LC+S+v"], {
                membersOnline: A
              })
            })]
          }), null != k && (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)("div", {
              ...
              children: v ? f.NW.formatToPlainString(f.t.YMor7u, {
                count: k
              }) : f.NW.formatToPlainString(f.t.zRl6XV, {
                count: k
              })
            })]
          })]
