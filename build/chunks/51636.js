...
let R = {
  ...
  D = r.memo(e => {
    let {
      ...
      cardType: O,
      confettiCanvas: S
    } = e, w = null == e ? void 0 : e.onCtaClick, k = (0, c.e7)([m.Z], () => m.Z.useReducedMotion), [L, M] = r.useState(!1), [B, U] = r.useState(!1), V = (0, b.Er)(), G = (0, b.IB)(), [F, H] = r.useState(!1), [z, W] = r.useState(t === C.I.TENURE_REWARD_COLLECTIBLE && G && (null == V ? void 0 : V.nitroTenureStatus) === v.EB.REDEEMABLE);
    r.useEffect(() => {
    ...
    let {
      ...
      null != w && f.default.track(T.rMx.PERK_DISCOVERABILITY_CARD_CTA_CLICKED, {
        card_type: (0, a.snakeCase)(t),
        function_name: (0, a.snakeCase)(w.name)
      })
    }, 800), er = r.useRef(null);
    e = P(A({
      onMouseEnter: en
    }, e), {
      onCtaClick: null != w ? () => {
    ...
    return (r.useEffect(() => {
    ...
    }), n) ? t === C.I.UPCOMING_DROP_UNTIMED ? (0, i.jsx)("div", {
      ...
      children: (0, i.jsx)("div", {
        className: l()(y.flipCardContainer, {
          [y.forceShadow]: x
        }),
      ...
      children: (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(Z, P(A({}, e), {
          ref: t === C.I.TENURE_REWARD_COLLECTIBLE ? er : void 0
        })), z && (0, i.jsx)(_.Z, {
          speedValues: R,
          numBursts: 3,
      ...
      children: (0, i.jsx)("div", {
        ...
        children: (0, i.jsxs)(u.P3F, {
          ...
          children: [(0, i.jsx)("div", {
            ...
            className: y.flipCardFront,
            children: (0, i.jsx)(Z, P(A({}, q.upcomingDropUntimed), {
              pillText: ""
            }))
          }), (0, i.jsx)("div", {
            className: y.flipCardBack,
    ...
    }) : (0, i.jsx)(D, P(A({}, q.upcomingDropUntimed), {
      forceShadow: x
    }))
  });
...
let Z = r.forwardRef((e, t) => {
  ...
  let {
    ...
    perkImage: v,
    imageOverlayText: T
  } = e, I = b === j.gM.CARD_CAROUSEL_FIRST_ROW || b === j.gM.CARD_CAROUSEL_SECOND_ROW || b === j.gM.CARD_CAROUSEL_THIRD_ROW, N = "" !== o || "" !== c || "" !== a && f === j.zW.REWARD, A = (0, x._)(f);
  return (0, i.jsxs)(u.P3F, {
    ...
    onClick: _,
    children: [null != C && (0, i.jsx)(u.Text, {
