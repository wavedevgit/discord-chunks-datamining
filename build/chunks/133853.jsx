...
class p extends(s = Chunk73800.Component) {
  componentDidMount() {
  ...
  render() {
    return <Chunk748780.Z.a href={Chunk981631.Z5c.INDEX} target={"_blank"} rel={"noopener"} className={r()(Chunk464425.logo, this.props.className)} style={this.getAnimatedStyle()} />
  }
  constructor(...t) {
