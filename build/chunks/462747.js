...
function T(e) {
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("div", {
      ...
      children: v.NW.format(v.t.BdQTfX, {
        userRemainCount: n
      })
    })]
  })
...
function y(e) {
  ...
  return null == o ? null : (0, i.jsx)(u.Z, {
    ...
    children: (e, a) => {
      ...
      return (0, i.jsxs)(d.P3F, E(h({
        className: r()(N.listRow, N.interactiveRow, {
          [N.selected]: _
        }),
    ...
    children: (0, i.jsx)(L, {
      ...
      onContextMenu: function(e, n) {
        (0, o.jW)(e, async () => {
          let {
            default: e
          } = await Promise.all([t.e("26881"), t.e("69220"), t.e("79075")]).then(t.bind(t, 881351));
          return t => (0, i.jsx)(e, E(h({}, t), {
            user: n
          }))
        })
      },
