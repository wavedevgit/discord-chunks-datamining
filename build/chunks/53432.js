...
function E() {
  let e = p.jU.useSetting(),
    ...
    T = [(0, r.jsxs)(a.kSQ, {
      children: [I, v, O(m.BRd.DARKER, g.intl.string(g.t.b8Cei4)), O(m.BRd.MIDNIGHT, g.intl.string(g.t.Do4ZJy)), O("system", g.intl.string(g.t["7rOU6u"]))]
    }, "theme-items"), , ];
  return T.push((0, r.jsxs)(a.kSQ, {
    label: "UI Density",
  ...
  }, "list-density")), T.push((0, r.jsxs)(a.kSQ, {
