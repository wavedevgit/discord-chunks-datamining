...
let V = e => {
  ...
  H = {
    ...
    escape: k(L({}, a().defaultRules.escape), {
      match: (e, t, n) => !1 === t.allowEscape ? null : a().defaultRules.escape.match(e, t, n)
    }),
    blockQuote: k(L({}, a().defaultRules.blockQuote), {
    ...
    link: b.ZP,
    autolink: k(L({}, a().defaultRules.autolink), {
      parse: F
    }),
    mailto: k(L({}, a().defaultRules.mailto), {
      match: a().inlineRegex(/^<([^\s<>@]+@[^\s<>@]+\.[^\s<>@]+)>/),
      requiredFirstCharacters: ["<"]
    }),
    tel: k(L({}, a().defaultRules.mailto), {
      requiredFirstCharacters: ["<"],
    ...
    text: I.ZP,
    inlineCode: k(L({}, a().defaultRules.inlineCode), {
      parse(e, t, n) {
    ...
    mention: {
      ...
      parse(e, t, n) {
        ...
        null == o && "@Clyde" === e[0] && (0, s.gJ)(Z(n), a) && (i = R.fL);
        let c = e[1],
    ...
    staticRouteLink: {
      ...
      parse(e, t, n) {
        var r;
        let [, i, o] = e, a = (0, T.l)(i), s = (0, T.W)(i, o, null == (r = Z(n)) ? void 0 : r.id);
