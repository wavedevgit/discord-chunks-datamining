...
let B = e => {
  ...
  F = {
    ...
    escape: L(w({}, o().defaultRules.escape), {
    ...
    link: E.ZP,
    autolink: L(w({}, o().defaultRules.autolink), {
      parse: G
    }),
    ...
    inlineCode: L(w({}, o().defaultRules.inlineCode), {
      parse(e, t, n) {
        ...
        return !0 === n.parseInlineCodeChildContent ? L(w({}, r), {
    ...
    staticRouteLink: {
      ...
      parse(e, t, n) {
        var r;
        let [, i, a] = e, o = (0, T.l)(i), s = (0, T.W)(i, a, null == (r = V(n)) ? void 0 : r.id);
  ...
  ee = (0, A.Z)([{
    highlightWord: {
      ...
      match(e, t) {
        ...
        let r = !J(e, n);
        if (r)
          do n = e.indexOf(t.highlightWord, n + 1), r = !J(e, n); while (r && -1 !== n);
        if (-1 === n) return null;
