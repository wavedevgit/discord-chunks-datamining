...
let V = () => {
  ...
  let em = [w.h.HOME, w.h.WHATS_NEW, w.h.BEST_OF_NITRO, w.h.PLANS, w.h.COMPARE],
    ...
    ej = (0, i.jsxs)("div", {
      className: a()(M.container, M.responsiveContainer, {
        [M.containerBackground]: z
      }),
      "data-cy": "tier-0-marketing-page",
      children: [ed && (0, i.jsx)(k.Z, {
        navBarSections: ep,
        activeSectionId: eg
      }), (0, i.jsx)("div", {
        className: M.heroHeaderSideGradient
      }), (0, i.jsx)("img", {
        src: U,
        ...
        innerRef: V,
        onChange: e => {
          e && !Q && (_.default.track(B.rMx.PREMIUM_MARKETING_SURFACE_REACHED_BOTTOM, {
            location_stack: ec
          }), $(!0))
        },
