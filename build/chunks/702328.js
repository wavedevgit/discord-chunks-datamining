...
let W = () => {
  ...
  let ex = [B.h.HOME, B.h.WHATS_NEW, B.h.BEST_OF_NITRO, B.h.PLANS, B.h.COMPARE],
    ...
    eT = ef ? F : H,
    eN = (0, i.jsxs)("div", {
      className: a()(eT.container, eT.responsiveContainer, {
        [eT.containerBackground]: ef || X
      }),
      ...
      children: [ef && (0, i.jsxs)(i.Fragment, {
        ...
        children: [(0, i.jsx)("div", {
          className: H.heroHeaderSideGradient
        }), (0, i.jsx)("img", {
          src: z,
        ...
        innerRef: W,
        onChange: e => {
          e && !ei && (x.default.track(V.rMx.PREMIUM_MARKETING_SURFACE_REACHED_BOTTOM, {
            location_stack: eh
          }), er(!0))
        },
        children: (0, i.jsx)("div", {
