...
function E(e) {
  ...
  }, [j, S]), <div className={p.displayNameContainer}>{<a.animated.div style={{
        opacity: N.opacity,
        y: N.y
      }}>{<o.X6q className={p.title} color={"header-primary"} variant={"heading-xl/extrabold"}>{v.header}</o.X6q>}{<div className={p.subtitle}>{<o.X6q color={"header-secondary"} variant={"heading-sm/medium"}>{v.subtitle}</o.X6q>}{null != v.link && <o.Text className={p.link} color={"header-secondary"} variant={"text-sm/medium"}>{v.link}</o.Text>}</div>}</a.animated.div>}{<d.Z{...t = function(e) {
