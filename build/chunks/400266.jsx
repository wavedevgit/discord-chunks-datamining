...
function d(e) {
  ...
  let m = 352;
  return "track" === _ ? m = 80 : ("episode" === _ || "show" === _) && (m = 232), <iframe className={o()(c.embedSpotify, t)} src={l.C7.EMBED(d)} style={{
      maxWidth: 400,
      minWidth: 300,
      width: "100%",
      height: m
    }} frameBorder={0} sandbox={"allow-forms allow-modals allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"} allow={"clipboard-write"} />
}