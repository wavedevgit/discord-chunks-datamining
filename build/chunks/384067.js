...
let h = e => {
  ...
  let {
    ...
    handleTransition: m,
    tab: _
  } = e, C = null == (t = u.Z.getCategoryByStoreListingId(h.categoryStoreListingId)) ? void 0 : t.skuId, v = l.useRef(null), O = l.useRef(null), [S, x] = l.useState();
  l.useEffect(() => {
    let e = O.current;
    if (null == e) return;
    let t = () => {
  ...
  return (0, r.jsx)(o.$, {
    ...
    children: (0, r.jsxs)("div", {
      ref: v,
      className: i()(f.row, f.between, f.bannerBlockContainer, f.centeredSection, {
        [f.extraRounded]: P
      }),
      children: [(0, r.jsx)("div", {
        className: i()(f.wideBannerBackgroundImg, {
          [f.extraRounded]: P
        }),
        children: (0, r.jsx)("img", {
          ...
          src: y,
          alt: h.title,
          className: i()(f.wideBannerArt, {
            [f.wideBannerArtOrbs]: P
          }),
          style: {
