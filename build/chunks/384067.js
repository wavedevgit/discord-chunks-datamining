...
let p = e => {
  ...
  let {
    ...
    handleTransition: b,
    tab: C
  } = e, _ = null === (t = c.Z.getCategoryByStoreListingId(p.categoryStoreListingId)) || void 0 === t ? void 0 : t.skuId, v = l.useRef(null), x = l.useRef(null), [k, j] = l.useState();
  l.useEffect(() => {
    let e = x.current;
    if (null == e) return;
    let t = () => {
  ...
  let S = null != _ ? _ : "",
    ...
    } = (0, u.E)(S, "home", "marketing wide banner"),
    O = p.bannerUrl;
  return null == O ? null : (0, r.jsx)(s.$, {
    innerRef: v,
    onChange: y,
    threshold: 0,
