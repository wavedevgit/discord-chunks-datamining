...
function m() {
  ...
  })), [t, n] = Chunk647438.useState(() => (true === window.__CLIPS_DEBUG__ && (window.__CLIPS_DEBUG__ = {
    emotion: false,
    yell: false,
    wakeWord: false,
    whisper: false
  ...
  })), [m, p] = Chunk647438.useState(Chunk894694.x0.KILL), [h, x] = Chunk647438.useState(1), [g, f] = Chunk647438.useState(""), [b, v] = Chunk647438.useState(""), j = Chunk647438.useCallback(e => {
    let a = !t[e];
