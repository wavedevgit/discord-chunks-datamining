...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk830746 = require("./830746.js"),
  Chunk731934 = require("./731934.js"),
  Chunk521450 = require("./521450.js"),
...
function z(e) {
  ...
  return <u.njP className={G.settingsTabBar} aria-label={V.intl.string(U.default.RZqaJi)} selectedItem={t} type={"top"} look={"brand"} onItemSelect={n}>{<u.njP.Item className={G.settingsTabBarItem} id={k.dG.ACTIVITY}>{V.intl.string(U.default.bdBmq6)}</u.njP.Item>}{<u.njP.Item className={G.settingsTabBarItem} id={k.dG.REQUESTS} aria-label={V.intl.string(U.default["gVWG+/"])}>{V.intl.string(U.default["gVWG+/"])}{r > 0 ? <u.mAB className={G.badge} count={r} /> : null}</u.njP.Item>}{s ? <u.njP.Item className={G.settingsTabBarItem} id={k.dG.SETTINGS}>{V.intl.string(V.t["3D5yo6"])}</u.njP.Item> : null}</u.njP>
}
...
function W(e) {
  ...
  return <u.f6W theme={t}>{e => (0, i.jsxs)(j.Z, {
...
function Y() {
  ...
  }, [Chunk210887]), Chunk210887) ? null : <main className={Chunk347362.container} aria-label={Chunk388032.intl.string(Chunk916723.default.RZqaJi)}>{<Chunk252618.yY location={Chunk388032.intl.string(Chunk916723.default.RZqaJi)} />}{<z section={Chunk873546} handleItemSelect={e => {
        m(e)
      }} />}{<Chunk481060.njP.Panel id={Chunk873546} aria-labelledby={Chunk100527} className={Chunk347362.contentPanel}><div>{F[Chunk873546]()}</div></Chunk481060.njP.Panel>}</main>
}
...
function K() {
  ...
  let J = Chunk731934 !== Chunk292352.dG.SETTINGS ? Chunk731934 : Chunk292352.dG.ACTIVITY,
    Q = H[J];
  return <Chunk906732.Gt value={module}><main className={a()(Chunk347362.container, Chunk347362.containerSidenav)} aria-label={Chunk388032.intl.string(Chunk916723.default.RZqaJi)}>{<Chunk252618.yY location={Chunk388032.intl.string(Chunk916723.default.RZqaJi)} />}{<W theme={Chunk830746} section={J} handleItemSelect={e => {
          w(e)
        }} />}{<Chunk481060.njP.Panel id={J} aria-labelledby={F} className={Chunk347362.contentPanel}><Chunk481060.Ttm><div className={Chunk347362.sideNavContent}>{Q()}</div></Chunk481060.Ttm></Chunk481060.njP.Panel>}</main></Chunk906732.Gt>
}