...
if (a && (d(eH, "href", eY("serialize", "setHref")), d(eH, "origin", eY("getOrigin")), d(eH, "protocol", eY("getProtocol", "setProtocol")), d(eH, "username", eY("getUsername", "setUsername")), d(eH, "password", eY("getPassword", "setPassword")), d(eH, "host", eY("getHost", "setHost")), d(eH, "hostname", eY("getHostname", "setHostname")), d(eH, "port", eY("getPort", "setPort")), d(eH, "pathname", eY("getPathname", "setPathname")), d(eH, "search", eY("getSearch", "setSearch")), d(eH, "searchParams", eY("getSearchParams")), d(eH, "hash", eY("getHash", "setHash"))), u(eH, "toJSON", function() {
