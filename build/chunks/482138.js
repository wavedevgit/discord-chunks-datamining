...
var r, Chunk98405 = require("./98405.js"),
  ...
  ea = /[\t\n\r]/g,
  es = function(e) {
    var t, n, r, i, o, a, s, l = F(e, ".");
    if (l.length && "" === l[l.length - 1] && l.length--, (t = l.length) > 4) return e;
    for (r = 0, n = []; r < t; r++) {
      if ("" === (i = l[r])) return e;
      if (o = 10, i.length > 1 && "0" === x(i, 0) && (o = L(J, i) ? 16 : 8, i = B(i, 8 === o ? 1 : 2)), "" === i) a = 0;
      else {
  ...
  eB = function(e, t, n) {
    ...
    if (t) {
      ...
      if (true !== n && (r = new eB(n, true)), i = this.parse(a, null, r)) throw new P(i);
...
eB.prototype = {
  ...
  parse: function(e, t, n) {
    var i, o, a, s, l = this,
      ...
      _ = false,
      g = false;
    for (e = b(e), t || (l.scheme = "", l.username = "", l.password = "", l.host = null, l.port = null, l.path = [], l.query = null, l.fragment = null, l.cannotBeABaseURL = false, e = G(e, ei, ""), e = G(e, eo, "$1")), i = m(e = G(e, ea, "")); u <= i.length;) {
      switch (o = i[u], c) {
        case eO:
          if (o && L(q, o)) d += V(o), c = ev;
          else {
            if (t) return W;
            c = eS;
            continue
        ...
        case eT:
          ...
          continue;
        case eC:
          if (l.scheme = n.scheme, o === r) l.username = n.username, l.password = n.password, l.host = n.host, l.port = n.port, l.path = h(n.path), l.query = n.query;
          else if ("/" === o || "\\" === o && l.isSpecial()) c = eA;
          else if ("?" === o) l.username = n.username, l.password = n.password, l.host = n.host, l.port = n.port, l.path = h(n.path), l.query = "", c = eZ;
          else if ("#" === o) l.username = n.username, l.password = n.password, l.host = n.host, l.port = n.port, l.path = h(n.path), l.query = n.query, l.fragment = "", c = eF;
          else {
        ...
        case eU:
          if (o === r || "/" === o || "\\" === o && l.isSpecial() || !t && ("?" === o || "#" === o)) {
            if (ey(d) ? (l.shortenPath(), "/" === o || "\\" === o && l.isSpecial() || U(l.path, "")) : eb(d) ? "/" === o || "\\" === o && l.isSpecial() || U(l.path, "") : ("file" === l.scheme && !l.path.length && eg(d) && (l.host && (l.host = ""), d = x(d, 0) + ":"), U(l.path, d)), d = "", "file" === l.scheme && (o === r || "?" === o || "#" === o))
              for (; l.path.length > 1 && "" === l.path[0];) Z(l.path);
            "?" === o ? (l.query = "", c = eZ) : "#" === o && (l.fragment = "", c = eF)
          } else d += em(o, ep);
          break;
        case eG:
          "?" === o ? (l.query = "", c = eZ) : "#" === o ? (l.fragment = "", c = eF) : o !== r && (l.path[0] += em(o, ed));
          break;
        case eZ:
          t || "#" !== o ? o !== r && ("'" === o && l.isSpecial() ? l.query += "%27" : "#" === o ? l.query += "%23" : l.query += em(o, ed)) : (l.fragment = "", c = eF);
          break;
        case eF:
          o !== r && (l.fragment += em(o, ef))
      }
      u++
    }
  },
