...
if (a && (d(eH, "href", eW("serialize", "setHref")), d(eH, "origin", eW("getOrigin")), d(eH, "protocol", eW("getProtocol", "setProtocol")), d(eH, "username", eW("getUsername", "setUsername")), d(eH, "password", eW("getPassword", "setPassword")), d(eH, "host", eW("getHost", "setHost")), d(eH, "hostname", eW("getHostname", "setHostname")), d(eH, "port", eW("getPort", "setPort")), d(eH, "pathname", eW("getPathname", "setPathname")), d(eH, "search", eW("getSearch", "setSearch")), d(eH, "searchParams", eW("getSearchParams")), d(eH, "hash", eW("getHash", "setHash"))), u(eH, "toJSON", function() {
