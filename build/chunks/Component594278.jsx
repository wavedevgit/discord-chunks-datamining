...
let m = function(e) {
  let {
    ...
    renderItem: f
  } = e, b = i.useMemo(() => new s.Xp, []), [p, h] = i.useState(d.n.LEFT), [x, j] = i.useState(0), [v, O] = i.useState(false), [y, C] = i.useState(false), N = i.useCallback((e, t) => {
    j(n => {
      let r = n + t;
    ...
    y || N(t, 1)
  }, [N, t, y]), I = i.useCallback(() => {
    y || N(t, false)
  }, [N, t, y]);
  return i.useEffect(() => {
    null != m && (v ? v && b.stop() : b.start(m, E))
  }, [v, b, m, E]), (0, r.jsxs)("div", {
    className: g.root,
    onMouseEnter: () => O(true),
