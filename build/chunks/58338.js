...
function h(e) {
  ...
  return (0, i.jsxs)(s.sNh, {
    ...
    children: [function(e) {
      let [t, n] = r.useState(!1), [d, h] = r.useState(!1), E = (0, l.e7)([g.ZP], () => g.ZP.getGuildUnreadSetting(e)), y = (0, l.e7)([g.ZP], () => g.ZP.getMessageNotifications(e)), j = d ? u.s8.CUSTOM : (0, u.gs)(E, y), _ = t => {
        h(!1);
        let n = {
