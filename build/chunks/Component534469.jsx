...
function er(e) {
  ...
  let {
    ...
    defaultValue: G,
    popouts: H
  }), es = (0, u.e7)([p.Z], () => p.Z.keyboardModeEnabled), ec = G || es && T, eu = ec || eo, {
    content: ed,
    hasSpoilerEmbeds: ep
  } = (0, D.Z)(o, {
    ...
    viewingChannelId: O
  }), eh = (0, R.Z)(s, h, es), ef = (0, N.ZP)(o), em = (0, w.iG)(o, C), eg = (0, w.Gx)(o), eb = (0, F.Z)(e, ed, false), ey = i.useCallback(() => (0, v.XU)(g, h, s), [g, h, s]), eC = (0, f.p9)({
    guildId: g,
