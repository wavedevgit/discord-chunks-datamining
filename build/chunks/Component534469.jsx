...
function ei(e) {
  ...
  let {
    ...
    selected: J,
    setPopout: et
  } = (0, L.Z)(o.id, q.d$), en = O.RS.useSetting(), ei = O.NA.useSetting(), er = (0, u.e7)([v.Z], () => v.Z.getMessageByReference(j)), el = (0, m.A)((null != (n = o.editedTimestamp) ? n : o.timestamp).valueOf()), {
    handleMouseEnter: ea,
    handleMouseLeave: eo,
    isHovered: es
  } = (0, M.tn)({
    ...
    defaultValue: J,
    popouts: G
  }), ec = (0, u.e7)([p.Z], () => p.Z.keyboardModeEnabled), eu = J || ec && D, ed = eu || es, ep = (0, u.e7)([E.Z], () => E.Z.isDeveloper), {
    content: eh,
    hasSpoilerEmbeds: ef
  } = (0, k.Z)(o, {
    ...
    viewingChannelId: x
  }), em = (0, R.Z)(s, h, ec), eg = (0, T.ZP)(o), eb = (0, w.iG)(o, C), ey = (0, w.Gx)(o), eC = (0, H.Z)(e, eh, false), ev = r.useCallback(() => (0, _.XU)(g, h, s), [g, h, s]), e_ = (0, f.p9)({
    guildId: g,
...
let er = Chunk473749.memo(function(e) {
  ...
  let eo = K.OBS.has(_.type) ? _.messageReference : true,
    ...
    eA = eg || eT || eN && eE,
    ew = eA || ex,
    eM = (0, u.e7)([x.Z], () => _.hasFlag(K.iLy.HAS_THREAD) && x.Z.getChannel(S.default.castMessageIdAsChannelId(_.id))),
  ...
  l = _.type === K.uaV.CUSTOM_GIFT ? "" : !eT && eX ? (0, V.Z)(e, eD) : (0, H.Z)(e, eD, eT);
  let eQ = _.id === el,
    e$ = (0, i.jsx)(d.tEY, {
      offset: {
        left: 4,
      ...
      children: (0, i.jsxs)("li", {
        ...
        children: [(0, y.Uw)(_) && (0, i.jsx)(g.Z, {
          ...
          className: a()(ei, {
            ...
            [X.selected]: eA,
            [X.replying]: (null == eB ? true : eB.message.id) === _.id,
