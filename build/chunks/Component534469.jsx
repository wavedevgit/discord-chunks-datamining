...
function ei(e) {
  ...
  let {
    ...
    selected: J,
    setPopout: et
  } = (0, L.Z)(o.id, q.d$), en = O.RS.useSetting(), ei = O.NA.useSetting(), er = (0, u.e7)([_.Z], () => _.Z.getMessageByReference(j)), el = (0, m.A)((null != (n = o.editedTimestamp) ? n : o.timestamp).valueOf()), {
    handleMouseEnter: ea,
    handleMouseLeave: eo,
    isHovered: es
  } = (0, M.tn)({
    ...
    viewingChannelId: x
  }), eg = (0, R.Z)(s, h, ec), eb = (0, T.ZP)(o), eC = (0, w.iG)(o, y), ey = (0, w.Gx)(o), e_ = (0, H.Z)(e, eh, false), ev = r.useCallback(() => (0, v.XU)(g, h, s), [g, h, s]), eO = (0, f.p9)({
    guildId: g,
...
let er = Chunk473749.memo(function(e) {
  ...
  let eo = K.OBS.has(v.type) ? v.messageReference : true,
    ...
    eA = eg || eT || eN && eE,
    ew = eA || ex,
    eM = (0, u.e7)([x.Z], () => v.hasFlag(K.iLy.HAS_THREAD) && x.Z.getChannel(S.default.castMessageIdAsChannelId(v.id))),
    ...
    e0 = (0, i.jsx)(d.tEY, {
      ...
      children: (0, i.jsxs)("li", {
        ...
        children: [(0, C.Uw)(v) && (0, i.jsx)(g.Z, {
          ...
          zalgo: !eT,
          childrenRepliedMessage: ea || v.type !== K.uaV.REPLY ? true : (0, W.Z)($(Q({}, e), {
            setPopout: eb,
