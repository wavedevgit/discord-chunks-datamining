...
function ei(e) {
  ...
  let {
    ...
    defaultValue: J,
    popouts: G
  }), ec = (0, u.e7)([p.Z], () => p.Z.keyboardModeEnabled), eu = J || ec && D, ed = eu || es, ep = (0, u.e7)([O.Z], () => O.Z.isDeveloper), {
    content: eh,
    hasSpoilerEmbeds: ef
  } = (0, k.Z)(o, {
    ...
    viewingChannelId: j
  }), em = (0, R.Z)(s, h, ec), eg = (0, T.ZP)(o), eb = (0, w.iG)(o, C), ey = (0, w.Gx)(o), eC = (0, F.Z)(e, eh, false), ev = r.useCallback(() => (0, _.XU)(g, h, s), [g, h, s]), e_ = (0, f.p9)({
    guildId: g,
...
let er = Chunk473749.memo(function(e) {
  ...
  let eo = K.OBS.has(_.type) ? _.messageReference : true,
    ...
    eA = eg || eT || eN && eO,
    ew = eA || ej,
    eM = (0, u.e7)([j.Z], () => _.hasFlag(K.iLy.HAS_THREAD) && j.Z.getChannel(S.default.castMessageIdAsChannelId(_.id))),
      ...
      children: (0, i.jsxs)("li", {
        ...
        children: [(0, y.Uw)(_) && (0, i.jsx)(g.Z, {
          ...
          className: a()(ei, {
            ...
            [X.selected]: eA,
            [X.replying]: (null == eV ? true : eV.message.id) === _.id,
