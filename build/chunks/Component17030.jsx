...
function b(e) {
  ...
  } = e, v = r.useRef(null), x = (0, l.e7)([p.Z, d.Z], () => d.Z.getChannel(p.Z.getVoiceChannelId())), O = r.useCallback(() => null != t ? (0, i.jsx)(o.Z, {
    emojiId: t.id,
    emojiName: t.name,
    animated: !!t.animated
  }) : null != b ? (0, i.jsx)(f.Z, {
  ...
  return (0, i.jsx)(a.yRy, {
    ...
    renderPopout: e => {
      ...
      return (0, i.jsx)(c.Z, {
        channel: x,
        guildId: null != (t = null == x ? true : x.guild_id) ? t : true,
        closePopout: r,
        onSelectEmoji: e => {
          let {
            emoji: t,
