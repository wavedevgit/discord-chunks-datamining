...
function h(e) {
  let {
    ...
    size: a,
    spoiler: h
  } = e, m = (0, s.e7)([f.Z], () => f.Z.getChannelId()), g = i.useMemo(() => null != t.contentType && -1 !== t.contentType.indexOf("/") ? t.contentType.split("/") : ["unknown", "unknown"], [t.contentType]), [E, b] = i.useState(h), y = i.useMemo(() => () => (0, r.jsx)(d.mz, {
    mimeType: g,
    downloadURL: t.url,
    showDownload: !0,
