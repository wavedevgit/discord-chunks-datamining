...
function et(e) {
  ...
  let {
    ...
    size: 160,
    format: N.$k ? "webp" : "png"
  }), g = k.default.extractTimestamp(r.id), p = s()().diff(s()(g), "days") <= J.G, x = o.some(e => (0, O.ig)(e) === u.o.GLOBAL), v = null != (t = n.name) ? t : null == r ? true : r.name;
...
function er(e) {
  ...
  } = (0, y.ZP)(), v = (0, m.e7)([C.default], () => C.default.locale), h = i.useMemo(() => (0, G.fP)(), []), j = (0, m.Wu)([M.Z], () => {
    var e;
...
function el(e) {
  ...
  } = (0, y.ZP)(), r = (0, _.q)(t), l = (0, m.e7)([P.Z], () => P.Z.getGame(t));
