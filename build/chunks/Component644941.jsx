...
let $ = e => {
  ...
  }), [I, N] = i.useState(null), S = (0, D.N)(r), [C, Z] = i.useState(null), L = (0, h.q)(r), M = (0, d.e7)([P.Z], () => P.Z.getGame(r)), _ = null != (t = null == M ? true : M.name) ? t : null == L ? true : L.name, R = (e, t) => {
    var n;
    (0, T.UE)({
      gameName: null != _ ? _ : "",
      applicationId: r,
