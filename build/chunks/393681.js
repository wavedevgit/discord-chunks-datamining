...
class J extends r.PureComponent {
  ...
  renderPomeloWarning() {
    return this.props.shouldRenderPomeloWarning ? (0, i.jsxs)(u.Wn, {
      className: W.accountWarningBodyText,
      messageType: u.QYI.WARNING,
      children: [this.props.forceMigrationExperiment ? Y.intl.format(Y.t.zT1hgo, {
        date: (0, x.IE)(this.props.locale)
      }) : Y.intl.format(Y.t.pdYZys, {}), " ", "", (0, i.jsx)(_.Z, {
        className: W.noticeTextButton,
        onClick: () => (0, O.Z)(z.Kq.USER_SETTINGS),
  ...
  renderSecuritySettings() {
    ...
    return (0, i.jsxs)(u.hjN, {
      ...
      tag: "h1",
      children: [t.mfaEnabled ? (0, i.jsx)(u.hjN, {
        ...
        children: (0, i.jsx)("div", {
          children: (0, i.jsx)(u.zxk, {
            ...
            onClick: () => (0, u.h7j)(e => (0, i.jsx)(G.default, X(q({}, e), {
              onSuccess: e.onClose
            }))),
  ...
  renderSecuritySettingsRedesign() {
    return (0, i.jsxs)(i.Fragment, {
      children: [this.renderConfirmModals(), (0, i.jsx)(S.F, {
  ...
  renderUnhidden() {
    ...
    return (0, i.jsx)(L.N, {
      ...
      children: (0, i.jsx)(B.Z, {
        ...
        onTabChange: e => {
          R.default.track(H.rMx.MY_ACCOUNT_PAGE_TAB_NAVIGATE, {
            target_tab_name: e === F.s6.ACCOUNT_SECURITY_TAB ? "SECURITY" : "STANDING"
          })
        },
  ...
  handleDisableAccount() {
    ...
    return (null != (e = null == r ? void 0 : r.filter(e => e.owner_user_id === n.id)) ? e : []).length > 0 ? void this.setState({
      shouldRenderOwnedTeamsModal: !0
    }) : l.length > 0 ? void this.setState({
      shouldRenderOwnedGuildsModal: !0
    }) : void(n.isClaimed() ? (0, u.h7j)(e => (0, i.jsx)(h.Z, X(q({}, e), {
