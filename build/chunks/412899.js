...
function G(A) {
  let {
    userRoles: e,
    position: t
  } = A, r = R(A, ["userRoles", "position"]), l = (0, p.Dt)();
  return (0, n.jsxs)(u.VqE, {
    ...
    children: [(0, n.jsx)("div", {
      ...
      children: [(0, n.jsx)(u.U65, {
        ...
        id: l,
        children: L.intl.format(L.t.PCs0oq, {
          numRoles: e.length
        })
      })]
    }), (0, n.jsx)(z, N(Z({}, r), {
...
let U = r.forwardRef(function(A, e) {
  ...
  let o, {
    ...
    F = null != (a = (0, f.wK)(U, .6)) ? a : void 0,
    X = h.Z.unsafe_rawColors.WHITE_500.css,
    z = (0, f._i)(U);
  null != z && .3 > (0, f.Bd)(z) && (X = h.Z.unsafe_rawColors.PRIMARY_630.css), o = m ? (0, n.jsx)(D.Z, {
    className: x.roleFlowerStar,
    iconClassName: v ? x.roleVerifiedIcon : void 0,
    color: U,
    size: 14
  }) : "dot" === T ? (0, n.jsx)(u.FhE, {
    className: x.roleDot,
  ...
  let k = r.useMemo(() => {
    var e;
    return Z({
      borderColor: p ? void 0 : F
    }, null != (e = A.style) ? e : {})
  }, [F, p, A.style]);
  return (0, n.jsx)(u.tEY, {
    children: (0, n.jsxs)("div", N(Z({
      ref: e,
      ...
      children: [(0, n.jsxs)(u.P3F, {
        className: i()(v && x.roleRemoveButtonCanRemove, x.roleRemoveButton),
        onClick: v ? w : void 0,
        tabIndex: v ? P : -1,
        focusProps: {
        ...
        "aria-hidden": !v,
        "aria-label": L.intl.formatToPlainString(L.t.QrxwhY, {
          roleName: C.name
        }),
        children: [o, v ? (0, n.jsx)(u.Dio, {
          size: "md",
          color: X,
          className: x.roleRemoveIcon,
          "aria-hidden": !0
        }) : null]
      }), null != j ? (0, n.jsx)(I.Z, N(Z({
...
function F(A) {
  ...
  return (0, n.jsx)(u.yRy, {
    ...
    renderPopout: e => {
      ...
      return (0, n.jsx)(G, N(Z({}, A), {
        position: null != t ? t : "top"
      }))
    },
    position: "top",
    align: "center",
    children: A => (0, n.jsx)(u.tEY, {
      children: (0, n.jsx)("button", N(Z(N(Z({
        ref: a
      }, A), {
...
function X(A) {
  let e = r.useRef(null),
    ...
    E = V.Z.getHighestRole(t),
    d = O.ZP.getMember(t.id, l.id),
    C = A => (0, w.Gy)(t.id, A.id) && !A.managed && V.Z.isRoleHigher(t, E, A) && (null == d || -1 === d.roles.indexOf(A.id));
  return (0, n.jsx)(u.yRy, {
    targetElementRef: e,
    renderPopout: A => {
      let {
...
function z(A) {
  let e, {
    ...
    M = r.useCallback(A => {
      let e = s; - 1 === e.indexOf(A) && (e = e.concat([A])), b.Z.updateMemberRoles(l.id, t.id, e, [A], [])
    }, [s, l.id, t.id]),
    [I, p] = r.useState(null),
    H = (0, c.e7)([P.Z], () => P.Z.getRoles(l.id)),
    Q = r.useMemo(() => {
      let A = Object.values(H).filter(A => s.includes(A.id)).sort((A, e) => {
        var t, n;
  ...
  let G = !E && V.Z.can(m.Plq.MANAGE_ROLES, l),
    z = T.e9(l, y.id),
  ...
  return null != I && 0 !== O ? e = (0, n.jsx)(F, N(Z({}, A), {
    numRolesHidden: O
  })) : G && (e = (0, n.jsx)(X, N(Z({}, A), {
    handleAddRole: M
  }))), (0, n.jsx)(g.bG, {
    ...
    children: (0, n.jsx)(g.SJ, {
      children: A => {
        ...
        return (0, n.jsxs)("div", N(Z({
          className: i()(x.root, u),
