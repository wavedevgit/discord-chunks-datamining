...
function w(e) {
  let {
    userRoles: t,
    position: r
  } = e, l = P(e, ["userRoles", "position"]), i = (0, Z.Dt)();
  return (0, n.jsxs)(f.VqE, {
    ...
    children: [(0, n.jsx)("div", {
      ...
      children: (0, n.jsx)("div", {
        className: C.overflowRolesPopoutArrow
      })
    }), (0, n.jsxs)(A.Z, {
      className: C.overflowRolesPopoutHeader,
      align: A.Z.Align.CENTER,
      children: [(0, n.jsx)(f.U65, {
        size: "xs",
        ...
        id: i,
        children: D.NW.format(D.t.PCs0oq, {
          numRoles: t.length
        })
      })]
    }), (0, n.jsx)(B, L(x({}, l), {
...
let G = l.forwardRef(function(e, t) {
  ...
  let {
    ...
    onRemove: g,
    guildId: A,
    disableBorderColor: Z,
    onMouseDown: H
  } = e, y = (0, c.JA)(_.id), {
    tabIndex: j
  } = y, I = P(y, ["tabIndex"]), m = (0, N.p9)({
    roleId: _.id,
    size: 16,
    guildId: A
  }), V = (0, d.e7)([O.Z], () => O.Z.roleStyle), S = (null === (i = _.tags) || void 0 === i ? void 0 : i.guild_connections) === null, R = l.useCallback(e => {
    (0, p.jW)(e, async () => {
      let {
        default: e
      } = await r.e("5396").then(r.bind(r, 731646));
      return t => (0, n.jsx)(e, L(x({}, t), {
        id: _.id,
        label: D.NW.string(D.t.sMsaLi)
      }))
    })
  }, [_.id]), U = (0, f.dQu)(E.Z.unsafe_rawColors.PRIMARY_300).hsl(), w = null !== (o = _.colorString) && void 0 !== o ? o : U, G = null !== (s = (0, u.wK)(w, .6)) && void 0 !== s ? s : void 0, W = E.Z.unsafe_rawColors.WHITE_500.css, F = (0, u._i)(w);
  null != F && .3 > (0, u.Bd)(F) && (W = E.Z.unsafe_rawColors.PRIMARY_630.css), h = S ? (0, n.jsx)(b.Z, {
  ...
  let B = l.useMemo(() => {
    var t;
    return x({
      borderColor: Z ? void 0 : G
    }, null !== (t = e.style) && void 0 !== t ? t : {})
  }, [G, Z, e.style]);
  return (0, n.jsx)(f.tEY, {
    children: (0, n.jsxs)("div", L(x({
      ref: t,
      ...
      children: [(0, n.jsxs)(f.P3F, {
        className: a()(v && C.roleRemoveButtonCanRemove, C.roleRemoveButton),
        onClick: v ? g : void 0,
        tabIndex: v ? j : -1,
        focusProps: {
          focusClassName: C.roleRemoveIconFocused
        },
        "aria-hidden": !v,
        "aria-label": D.NW.formatToPlainString(D.t.QrxwhY, {
          roleName: _.name
        }),
        children: [h, v ? (0, n.jsx)(f.Dio, {
          size: "md",
          color: W,
          className: C.roleRemoveIcon,
          "aria-hidden": !0
        }) : null]
      }), null != m ? (0, n.jsx)(T.Z, L(x({
...
function B(e) {
  ...
  } = e, g = l.useRef({}), b = l.useCallback(e => {
    var t;
  ...
  }, [o, i.id, r.id]), A = l.useCallback(e => {
    let t = o; - 1 === t.indexOf(e) && (t = t.concat([e])), H.Z.updateMemberRoles(i.id, r.id, t, [e], [])
  }, [o, i.id, r.id]), [T, Z] = l.useState(null), N = (0, d.e7)([j.Z], () => j.Z.getRoles(i.id)), y = l.useMemo(() => {
    let e = Object.values(N).filter(e => o.includes(e.id)).sort((e, t) => {
      var r, n;
  ...
  return null != T && 0 !== S ? t = (0, n.jsx)(W, L(x({}, e), {
    numRolesHidden: S
  })) : B && (t = (0, n.jsx)(F, L(x({}, e), {
    handleAddRole: A
  }))), (0, n.jsx)(c.bG, {
    ...
    children: (0, n.jsx)(c.SJ, {
      children: e => {
        ...
        return (0, n.jsxs)("div", L(x({
          className: a()(C.root, f),
          "aria-label": D.NW.formatToPlainString(D.t.PCs0oq, {
            numRoles: o.length
          }),
          ref: r
        }, l), {
