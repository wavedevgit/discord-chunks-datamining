...
function w(e) {
  let {
    userRoles: t,
    position: n
  } = e, l = W(e, ["userRoles", "position"]), a = (0, h.Dt)();
...
let z = l.forwardRef(function(e, t) {
  ...
  let E, {
    ...
    z = null != (o = O.colorString) ? o : w,
    k = null != (i = (0, _.wK)(z, .6)) ? i : void 0,
    H = A.Z.unsafe_rawColors.WHITE_500.css,
    V = (0, _._i)(z);
  null != V && .3 > (0, _.Bd)(V) && (H = A.Z.unsafe_rawColors.PRIMARY_630.css), E = y ? (0, r.jsx)(R.Z, {
  ...
  return (0, r.jsx)(T.yRy, {
    ...
    children: e => (0, r.jsx)(T.tEY, {
      children: (0, r.jsx)("button", F(G(F(G({
        ...
        className: s()(j.overflowButton, a)
      }), o), {
        children: "+".concat(n)
      }))
    })
...
function V(e) {
  ...
  let w = !N && M.Z.can(y.Plq.MANAGE_ROLES, a),
    V = b.e9(a, P.id),
    ...
    Y = L.map(e => {
      ...
      return (0, r.jsx)(z, {
        className: O,
        role: e,
        canRemove: w && b.r6(a, P.id, V, e) || (null == (t = e.tags) ? void 0 : t.guild_connections) === null && n.id === P.id,
        onRemove: () => R(e),
        ref: t => {
          var n;
  ...
  return null != S && 0 !== C ? t = (0, r.jsx)(k, F(G({}, e), {
    numRolesHidden: C
  })) : w && (t = (0, r.jsx)(H, F(G({}, e), {
    handleAddRole: p
  }))), (0, r.jsx)(c.bG, {
