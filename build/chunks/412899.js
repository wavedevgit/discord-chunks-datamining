...
function U(A) {
  let {
    userRoleIds: e,
    position: t
  } = A, r = R(A, ["userRoleIds", "position"]), l = (0, I.Dt)();
  return (0, n.jsxs)(E.VqE, {
    ...
    children: [(0, n.jsx)("div", {
      ...
      children: (0, n.jsx)("div", {
        className: Z.overflowRolesPopoutArrow
      })
    }), (0, n.jsxs)(D.Z, {
...
let F = r.forwardRef(function(A, e) {
  ...
  let o, {
    ...
    z = (0, v._i)(U);
  null != z && .3 > (0, v.Bd)(z) && (X = h.Z.unsafe_rawColors.PRIMARY_630.css), o = m ? (0, n.jsx)(w.Z, {
  ...
  let k = r.useMemo(() => {
    var e;
    return N({
      borderColor: H ? void 0 : F
    }, null != (e = A.style) ? e : {})
  }, [F, H, A.style]);
  return (0, n.jsx)(E.tEY, {
    children: (0, n.jsxs)("div", S(N({
      ref: e,
      ...
      children: [(0, n.jsxs)(E.P3F, {
        ...
        tabIndex: f ? P : -1,
        focusProps: {
          focusClassName: Z.roleRemoveIconFocused
        },
        "aria-hidden": !f,
...
function X(A) {
  ...
  return (0, n.jsx)(E.yRy, {
    ...
    children: A => (0, n.jsx)(E.tEY, {
      children: (0, n.jsx)("button", S(N(S(N({
        ref: a
      }, A), {
        className: i()(Z.overflowButton, l)
      }), s), {
        children: "+".concat(t)
      }))
    })
...
function k(A) {
  ...
  return null != I && 0 !== P ? e = (0, n.jsx)(X, S(N({}, A), {
    numRolesHidden: P
  })) : U && (e = (0, n.jsx)(z, S(N({}, A), {
    handleAddRole: M
  }))), (0, n.jsx)(g.bG, {
