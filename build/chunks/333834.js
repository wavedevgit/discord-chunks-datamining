...
function R(e) {
  ...
  let V = i.useCallback(() => {
    ...
    W = i.useMemo(() => {
      let e = [];
      return z ? e.push(a()) : H ? e.push((0, r.jsx)(A, {}, "empty-state")) : P ? (e.push(...n.map(e => d([e], !0))), e.push(...t.map(e => d([e], !1)))) : s().each(T, t => {
        0 !== F[t].length && (e.push((0, r.jsx)(Z, {
          group: t,
          isOpen: G[t],
          toggleOpenedState: () => {
            let e = G[t];
        ...
        }, t)), G[t] && e.push(...F[t].map(e => d(e, t === x.KZ.UNREAD))))
      }), e
    }, [t, n, a, G, B, F, P, d, H, z]),
    K = W[W.length - 1],
