...
function I(e) {
  let {
    ...
    className: Z,
    listName: T
  } = e, A = i.useRef(null), R = (0, h.Z)(T, A), D = (0, u.e7)([b.Z], () => b.Z.unreadMessageIds), {
  ...
  i.useEffect(() => {
    ...
    return g.S.subscribe(O.CkL.SCROLL_PAGE_DOWN, t), g.S.subscribe(O.CkL.SCROLL_PAGE_UP, e), () => {
  ...
  null == n ? G = [(0, r.jsx)("div", {
    className: o()(_.emptyPlaceholder, _.loadingPlaceholder),
    children: (0, r.jsx)(d.$jN, {})
  }, "spinner")] : 0 === n.length ? G.push((0, r.jsx)(i.Fragment, {
    children: I(p.Z.theme)
  }, "empty-state")) : (a().each(n, e => {
    B[(0, y.Qz)(e, D)].push(w(e, "sidebar" === L))
  }), G = [], a().each([y.dm.UNREAD, y.dm.TODAY, y.dm.YESTERDAY, y.dm.OLDER], e => {
    if (0 === B[e].length) {
      e === y.dm.UNREAD && (G.push((0, r.jsx)(x, {
        group: e,
        isOpen: k[e],
        toggleOpenedState: () => M(t => j(C({}, t), {
          [e]: !t[e]
        }))
  ...
  }), G.push((0, r.jsx)(d.LZC, {
    size: 8
  }, "spacer")));
  let V = null;
  null != n && n.length > 0 && null != v && s && (V = (0, r.jsx)("div", {
