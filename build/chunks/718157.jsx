...
function u(e) {
  ...
  return 0 === g.length ? <a.$jN /> : <a.VcW value={n.primaryCategoryId === c.o3 ? null : n.primaryCategoryId} placeholder={d.intl.string(d.t.XqMe3N)} options={h} onChange={p} isDisabled={u} clearable={m} />
}