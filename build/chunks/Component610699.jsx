...
function F(e) {
  ...
  let y = i.useCallback(() => {
    ...
    M = (0, c.e7)([_.ZP], () => {
      var e;
      return ((null == (e = s.channel) ? true : e.id) != null ? _.ZP.getEmbeddedActivitiesForChannel(s.channel.id) : []).some(e => {
        let {
          applicationId: t
        } = e;
        return b.id === t
    ...
    G = (0, c.Wu)([_.ZP], () => null != j ? _.ZP.getEmbeddedActivitiesForChannel(j.id).filter(e => e.applicationId === b.id).flatMap(e => Array.from(e.userIds)) : [], [j, b.id]),
  ...
  let Y = H && !k || H && w;
  return (k || (o = x.intl.string(x.t.hHGrWz)), null == s.code || "" === s.code || null == N) ? null : (0, r.jsx)(h.Gt, {
    value: U,
    children: (0, r.jsx)(V, {
      app: N,
      activityUsers: B,
...
function V(e) {
  let {
    ...
    submitting: f,
    disabled: p,
    disabledReason: p && null != h ? h : true,
    onClick: O
  }], [_, a, f, p, h, O]);
