...
function g(e) {
  let {
    ...
    channelId: y
  }), C = I && !t, [N, R] = (0, l.US)(C ? [o.z.CHAT_WALLPAPERS_DM_LIST_COACHMARK] : [], true, true), P = N === o.z.CHAT_WALLPAPERS_DM_LIST_COACHMARK, [w, D] = (0, l.US)(P ? [o.z.CHAT_WALLPAPERS_PICKER_COACHMARK] : []), x = (0, a.ZP)(e => e.recentlyShown[0]), L = (0, s.Nj)(o.z.CHAT_WALLPAPERS_PICKER_COACHMARK);
  if (r.useMemo(() => {
      S && true === O && !L && w !== o.z.CHAT_WALLPAPERS_PICKER_COACHMARK && d.default.track(h.rMx.CHAT_WALLPAPER_PICKER_COACHMARK_NOT_SHOW_REASON, {
        channel_id: y,
        channel_type: v,
        is_settings_open: t,
        is_dark_theme: A,
        is_overseer_dismissible_content_selected: P,
        last_dismissible_content_winner: null != x ? o.z[x] : "None"
      })
    }, [O, S, v, y, L, w]), !I) return;
  let j = P && w === o.z.CHAT_WALLPAPERS_PICKER_COACHMARK;
