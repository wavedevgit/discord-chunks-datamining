...
function g(e) {
  let {
    ...
    channelId: y
  }), N = I && !t, [C, R] = (0, l.US)(N ? [a.z.CHAT_WALLPAPERS_DM_LIST_COACHMARK] : [], void 0, !0), P = C === a.z.CHAT_WALLPAPERS_DM_LIST_COACHMARK, [w, D] = (0, l.US)(P ? [a.z.CHAT_WALLPAPERS_PICKER_COACHMARK] : []), L = (0, o.ZP)(e => e.recentlyShown[0]), x = (0, s.Nj)(a.z.CHAT_WALLPAPERS_PICKER_COACHMARK);
  if (r.useMemo(() => {
      S && !0 === O && !x && w !== a.z.CHAT_WALLPAPERS_PICKER_COACHMARK && d.default.track(h.rMx.CHAT_WALLPAPER_PICKER_COACHMARK_NOT_SHOW_REASON, {
        channel_id: y,
        channel_type: v,
        is_settings_open: t,
        is_dark_theme: A,
