...
function m(e) {
  ...
  if (r.useMemo(() => {
      O && (null == S ? void 0 : S.isChatWallpaperEnabled) === !0 && !D && R !== a.z.CHAT_WALLPAPERS_PICKER_COACHMARK && u.default.track(p.rMx.CHAT_WALLPAPER_PICKER_COACHMARK_NOT_SHOW_REASON, {
        channel_id: S.id,
        channel_type: S.type,
        is_settings_open: t,
        is_dark_theme: I,
