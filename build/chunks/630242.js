...
function c(e) {
  let {
    ...
    openPickerForChannel: c,
    setLastShownChatWallpaperPickerType: u,
    lastShownChatWallpaperPickerType: d
  } = (0, s.B)(), f = (0, r.e7)([a.Z], () => a.Z.getCurrentlySelectedChannelId()), {
    canAccessPicker: _
  } = (0, l.m)({
    location: "useChatWallpaperPickerConfig",
    selectedChannelId: f
  }), p = _ && !t, [h, m] = (0, o.US)(p ? [i.z.CHAT_WALLPAPERS_PICKER_COACHMARK] : []);
  if (!_) return;
