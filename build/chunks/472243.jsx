...
var Chunk120356 = require("./120356.js"),
  ...
  Chunk694320 = require("./694320.js"),
  Chunk981631 = require("./981631.js"),
  Chunk474936 = require("./474936.js"),
  Chunk388032 = require("./388032.jsx"),
  Chunk317727 = require("./317727.js");
...
function I(e) {
  ...
  let B = M >= 0;
  return <c.Gt value={G}><div className={o()(A, E.characterCount)}>{<div className={E.flairContainer}>{D && B ? <s.ua7 text={g.intl.formatToPlainString(g.t.vcvHa2, {
            maxLength: R
          })} position={"top"}>{e => (0, r.jsx)(s.SrA, y({
            size: "md",
            color: "currentColor",
            className: E.premiumFlair
          }, e))}</s.ua7> : null}{k || j ? null : <s.ua7 text={U} position={"top"}>{e => (0, r.jsx)(s.Text, v(y({
            ...
            children: M
          }))}</s.ua7>}</div>}{<s.nn4>{g.intl.format(g.t.qH8uFR, {
          count: M
        })}</s.nn4>}{L && !k ? <p.Z className={E.upsell} iconOnly={(null == (i = O.upsellLongMessages) ? true : i.iconOnly) || false} remaining={M} /> : null}</div></c.Gt>
}