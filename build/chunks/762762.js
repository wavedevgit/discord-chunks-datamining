...
function s(e, t, r) {
  ...
  return n.useMemo(() => {
    ...
    let {
      allPowerups: o,
      unlockedPowerups: i
    } = s, c = r ? null == (e = Object.values(i).find(e => {
      var r;
      return (null == (r = e.sku) ? void 0 : r.dependent_sku_id) === t.skuId
    })) ? void 0 : e.sku_id : t.dependencies.find(e => null == i[e]);
    return {
      disabled: null != c,
      reason: null != c && null != o[c] ? a.intl.formatToPlainString(r ? l.default.vCEBiY : l.default["1B8AZm"], {
        perk: null == (n = o[c]) ? void 0 : n.title
      }) : void 0
    }
