...
function g(e) {
  ...
  return (l.useEffect(() => {
    (0, o.zO)(t.guildId)
  }, [t.guildId]), null == n) ? null : <i.xJW title={m.intl.string(m.t["ldCE/v"])} titleClassName={I.infoTitle}><A.WM>{<A._2 icon={(0, r.jsx)(i.lZ8, {
          size: "custom",
          width: A.Mn,
          height: A.Mn
        })} name={(0, r.jsx)(i.Text, {
        ...
        })} />}{f !== u.qc.NO_GATE && <A._2 icon={(0, r.jsx)(i.snC, {
          size: "custom",
          width: A.Mn,
          height: A.Mn
        })} name={(0, r.jsx)(i.Text, {
