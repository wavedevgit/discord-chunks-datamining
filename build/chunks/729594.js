...
i.prototype.parse = function(e, t, n) {
  ...
  if (v = v.trim(), !n && 1 === e.split("#").length) {
    var y = s.exec(v);
    if (y) return this.path = v, this.href = v, this.pathname = y[1], y[2] ? (this.search = y[2], t ? this.query = g.parse(this.search.substr(1)) : this.query = this.search.substr(1)) : t && (this.search = "", this.query = {}), this
  }
  var O = o.exec(v);
  if (O) {
    var I = (O = O[0]).toLowerCase();
    this.protocol = I, v = v.substr(O.length)
  }
  if (n || O || v.match(/^\/\/[^@/]+@[^@/]+/)) {
    var S = "//" === v.substr(0, 2);
    S && !(O && h[O]) && (v = v.substr(2), this.slashes = !0)
  }
  if (!h[O] && (S || O && !m[O])) {
    for (var T, A, N = -1, C = 0; C < u.length; C++) {
      var R = v.indexOf(u[C]); - 1 !== R && (-1 === N || R < N) && (N = R)
    } - 1 !== (A = -1 === N ? v.lastIndexOf("@") : v.lastIndexOf("@", N)) && (T = v.slice(0, A), v = v.slice(A + 1), this.auth = decodeURIComponent(T)), N = -1;
    for (var C = 0; C < c.length; C++) {
      var R = v.indexOf(c[C]); - 1 !== R && (-1 === N || R < N) && (N = R)
    } - 1 === N && (N = v.length), this.host = v.slice(0, N), v = v.slice(N), this.parseHost(), this.hostname = this.hostname || "";
        ...
        if (L && !L.match(f)) {
          ...
          if (!x.match(f)) {
            var j = w.slice(0, C),
              U = w.slice(C + 1),
              G = L.match(_);
            G && (j.push(G[1]), U.unshift(G[2])), U.length && (v = "/" + U.join(".") + v), this.hostname = j.join(".");
            break
          }
        }
      }
    ...
    var B = this.port ? ":" + this.port : "",
      F = this.hostname || "";
    this.host = F + B, this.href += this.host, P && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== v[0] && (v = "/" + v))
  }
  if (!p[I])
    for (var C = 0, D = l.length; C < D; C++) {
      ...
      if (-1 !== v.indexOf(V)) {
        ...
        Z === V && (Z = escape(V)), v = v.split(V).join(Z)
      }
    }
  var H = v.indexOf("#"); - 1 !== H && (this.hash = v.substr(H), v = v.slice(0, H));
  var W = v.indexOf("?");
  if (-1 !== W ? (this.search = v.substr(W), this.query = v.substr(W + 1), t && (this.query = g.parse(this.query)), v = v.slice(0, W)) : t && (this.search = "", this.query = {}), v && (this.pathname = v), m[I] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
    var B = this.pathname || "",
      Y = this.search || "";
    this.path = B + Y
  }
  ...
  var E = n.pathname && "/" === n.pathname.charAt(0),
    ...
    v = b || E || n.host && e.pathname,
    y = v,
    O = n.pathname && n.pathname.split("/") || [],
    _ = e.pathname && e.pathname.split("/") || [],
    I = n.protocol && !m[n.protocol];
  if (I && (n.hostname = "", n.port = null, n.host && ("" === O[0] ? O[0] = n.host : O.unshift(n.host)), n.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === _[0] ? _[0] = e.host : _.unshift(e.host)), e.host = null), v = v && ("" === _[0] || "" === O[0])), b) n.host = e.host || "" === e.host ? e.host : n.host, n.hostname = e.hostname || "" === e.hostname ? e.hostname : n.hostname, n.search = e.search, n.query = e.query, O = _;
  ...
  if (!v && !y)
    for (; N--; N) O.unshift("..");
  v && "" !== O[0] && (!O[0] || "/" !== O[0].charAt(0)) && O.unshift(""), A && "/" !== O.join("/").substr(-1) && O.push("");
  ...
  return (v = v || n.host && O.length) && !R && O.unshift(""), O.length > 0 ? n.pathname = O.join("/") : (n.pathname = null, n.path = null), (null !== n.pathname || null !== n.search) && (n.path = (n.pathname ? n.pathname : "") + (n.search ? n.search : "")), n.auth = e.auth || n.auth, n.slashes = n.slashes || e.slashes, n.href = n.format(), n
}, i.prototype.parseHost = function() {
  var e = this.host,
    t = a.exec(e);
  t && (":" !== (t = t[0]) && (this.port = t.substr(1)), e = e.substr(0, e.length - t.length)), e && (this.hostname = e)
}, t.parse = E, t.resolve = v, t.resolveObject = y, t.format = b, t.Url = i