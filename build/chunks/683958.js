...
function C(e) {
  ...
  let J = l.useCallback(e => {
    ...
    $ = l.useCallback(async function(e) {
      ...
      t && (E(!0), P()), n.forEach(async e => {
        var t, n;
        let r = d.Z.getChannel(e);
        if (null == r) return;
        let l = null != (n = null == (t = s.options) ? void 0 : t.reduce((e, t) => (e[t.name] = [{
            type: "text",
            text: t.value
          }], e), {})) ? n : {},
