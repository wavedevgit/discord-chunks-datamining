/** Chunk was on 53682 **/
n.d(t, {
  ApplicationCommandShareModal: () => w
}), n(388685), n(35282);
var r = n(255367),
  l = n(73800),
  i = n(481060),
...
function w(e) {
  ...
  let J = l.useCallback(e => {
    ...
    $ = l.useCallback(async function(e) {
      ...
      t && (C(!0), S()), n.forEach(async e => {
        var t, n;
        let r = c.Z.getChannel(e);
        if (null == r) return;
        let l = null != (n = null == (t = g.options) ? void 0 : t.reduce((e, t) => (e[t.name] = [{
            type: "text",
            text: t.value
          }], e), {})) ? n : {},
  ...
  if (K) return (0, r.jsx)(i.Y0X, O(j({
    ...
    children: (0, r.jsx)(i.hzk, {
      children: y.intl.string(y.t.yAk8ZW)
    })
  }));
  let et = H.length > 0 ? (0, r.jsx)(p.F, {
    paddingBottom: 16,
    paddingTop: 16,
    rowData: H,
