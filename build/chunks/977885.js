...
function _(e) {
  let {
    ...
    searchQueryString: r,
    getLimit: a,
    onFetchMessagesStart: h,
    onFetchMessagesSuccess: g
  } = e, _ = (0, p.jj)(t, n[0], r);
  ...
  m.Z.incrementSearchCount(t, v), v && (0, f.ZT)({
    searchContext: t
  });
  ...
  return l.Z.dispatch({
    ...
    let {
      body: n
    } = e, a = Object.entries(n.tabs);
    l.Z.dispatch({
      type: "SEARCH_MESSAGES_SUCCESS",
      guildId: y,
      data: a.map(e => {
        var l, a, s;
        let [c, u] = e, d = (0, p.jj)(t, c, r), m = u.cursor;
        return {
          id: d,
...
function O(e) {
  ...
  x(), c.Z.cancelInFlightRequests(e), (0, f.tI)({
    searchContext: e
  });
  let t = d.Z.getState(e, e => e.getQueryString()),
    n = d.Z.getState(e, e => e.isInitialSearchQuery()) ? function(e) {
      switch (e.type) {
