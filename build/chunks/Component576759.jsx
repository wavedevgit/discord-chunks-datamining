...
function b(e) {
  let {
    ...
    data: v
  } = (0, c.IX)(t), I = (0, o.q)(v, s.Z.USER_PROFILE_ACTIVITY_CLOUD_PLAY_SECTION), {
    themeType: T
  } = (0, p.z)(), S = T === m.l.MODAL || T === m.l.MODAL_V2, A = (0, f.L)(y), C = I && S && null != v && !A, N = C ? [i.z.CLOUD_PLAY_NEW_BADGE] : [], [R] = (0, d.US)(N);
