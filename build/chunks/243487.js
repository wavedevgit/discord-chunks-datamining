...
function R(e) {
  let {
    ...
    size: i,
    locked: o
  } = e, c = (0, D.e5)(i), u = (0, a.Wu)([w.default, h.Z], () => t.map(e => {
    var t;
...
let G = i.memo(function(e) {
  ...
  } = e, j = (0, C.ee)(() => (function(e) {
    let [t, n] = e;
    return new Set(n)
  })(l), [l]), [P, w] = l, x = w.length > 0 && null != n && null != o && (!d || p), S = (0, a.Wu)([y.Z], () => Array.from(j).map(e => y.Z.getStreamForUser(e, f)).filter(E.lm).map(e => e.ownerId), [f, j]);
  i.useEffect(() => {
    x && (0, C.zi)(_.Odu.VOICE_V3, {
  ...
  return x ? (0, r.jsxs)(r.Fragment, {
    children: [Z.map(e => {
    ...
    }), 1 === N.length && null != k && (0, r.jsx)(D.ZP, {
      sortedVoiceState: k,
      channel: o,
      widgetId: t,
      flipped: !b,
      ...
      displayUserMode: u,
      locked: d
    }, N[0]), N.length > 1 && (0, r.jsx)(R, {
      hiddenVoiceStates: N,
      voiceStateMap: P,
      size: (0, D.px)(v),
      locked: d
    })]
  }) : d || !g ? null : (0, r.jsx)(V.E, {
...
function F(e) {
  ...
  let {
    isSettingsPreview: n
  } = e, o = (0, a.e7)([j.Z, h.Z], () => h.Z.getChannel(j.Z.getVoiceChannelId())), l = (0, p.ZP)(o), s = function(e) {
    let t = (0, a.e7)([j.Z, h.Z], () => h.Z.getChannel(j.Z.getVoiceChannelId())),
      [n] = (0, a.e7)([S.ZP, O.Z, j.Z, h.Z], () => {
        let e = h.Z.getChannel(j.Z.getVoiceChannelId());
        return null == e ? [
          [], -1
        ] : e.isGuildStageVoice() ? [O.Z.getMutableParticipants(e.id, m.pV.SPEAKER), O.Z.getParticipantsVersion(e.id)] : [S.ZP.getVoiceStatesForChannel(e), S.ZP.getVoiceStateVersion(e.getGuildId())]
      }, [], Z.Q),
      r = (0, b.Es)(null == t ? void 0 : t.id, n),
      o = i.useMemo(() => new Map(r.map(e => [e.user.id, e])), [r]),
      l = (0, a.e7)([v.default], () => v.default.getId());
    return [o, (0, a.Wu)([x.Z, j.Z, P.Z, g.Z], () => {
      let t = Array.from(r.map(e => {
        let {
          user: t
        } = e;
        return t.id
  ...
  }(M.Yn.DEFAULT), d = (0, a.e7)([y.Z], () => y.Z.getStreamerActiveStreamMetadata()), w = (0, k.II)(), E = (0, u.q)(null == w ? void 0 : w.id), C = (0, a.cj)([y.Z, I.default], () => {
