...
function U(e) {
  ...
  let {
    ...
    locked: u,
    flipped: f
  } = e, p = (0, A.e5)(c), g = (0, a.Wu)([j.default, y.Z], () => r.map(e => {
    var t;
  ...
  }).filter(E.lm), [r, l, p]), m = null != (t = g[0]) ? t : G(0), h = null != (n = g[1]) ? n : G(1);
  return (0, i.jsxs)("div", {
...
let z = r.memo(function(e) {
  let {
    ...
    anchorLeft: O,
    avatarSizeMode: b,
    maxDisplayedVoiceStates: y = V.At
  } = e, I = (0, k.ee)(() => (function(e) {
    let [t, n] = e;
    return new Set(n)
  })(o), [o]), [P, j] = o, w = j.length > 0 && null != n && null != l && (!d || f), S = (0, a.Wu)([v.Z], () => Array.from(I).map(e => v.Z.getStreamForUser(e, p)).filter(E.lm).map(e => e.ownerId), [p, I]);
  r.useEffect(() => {
    w && (0, k.zi)(D.Odu.VOICE_V3, {
  ...
  return w ? (0, i.jsxs)("div", {
    className: R.voiceUserContainer,
    children: [N.map(e => {
      let r = P.get(e);
      return null == r ? null : (0, i.jsx)(A.ZP, {
        sortedVoiceState: r,
        channel: l,
        widgetId: t,
        flipped: !O,
    ...
    }), _ && 1 === x.length && null != C && (0, i.jsx)(A.ZP, {
      sortedVoiceState: C,
      channel: l,
      widgetId: t,
      flipped: !O,
...
function Y(e) {
  ...
  let {
    isSettingsPreview: n
  } = e, l = (0, a.e7)([I.Z, y.Z], () => y.Z.getChannel(I.Z.getVoiceChannelId())), o = (0, f.ZP)(l), s = function(e, t) {
    let n = (0, a.e7)([I.Z, y.Z], () => y.Z.getChannel(I.Z.getVoiceChannelId())),
      [i] = (0, a.e7)([S.ZP, m.Z, I.Z, y.Z], () => {
        let e = y.Z.getChannel(I.Z.getVoiceChannelId());
        return null == e ? [
          [], -1
        ] : e.isGuildStageVoice() ? [m.Z.getMutableParticipants(e.id, h.pV.SPEAKER), m.Z.getParticipantsVersion(e.id)] : [S.ZP.getVoiceStatesForChannel(e), S.ZP.getVoiceStateVersion(e.getGuildId())]
      }, [], N.Q),
      l = (0, O.Es)(null == n ? void 0 : n.id, i),
      o = r.useMemo(() => new Map(l.map(e => [e.user.id, e])), [l]),
      s = (0, a.e7)([b.default], () => b.default.getId());
    return [o, (0, a.Wu)([w.Z, I.Z, P.Z, g.Z], () => {
  ...
  }(M.Yn.DEFAULT, e.maxDisplayedVoiceStates), d = (0, a.e7)([v.Z], () => v.Z.getStreamerActiveStreamMetadata()), j = (0, _.II)(), E = (0, u.q)(null == j ? void 0 : j.id), x = (0, a.cj)([v.Z, Z.default], () => {
  ...
  return (0, i.jsx)(z, W(L(W(L({}, x), {
    ...
    title: null != o ? o : "",
    streamMetadata: d,
    streamApplication: null != (t = x.streamApplication) ? t : {
      id: null,
