...
function I(e) {
  let {
    ...
    colorPickerFooter: T,
    showEyeDropper: S
  } = e, A = i.useRef(null), C = (0, u.dQu)(c.Z.colors.BACKGROUND_BASE_LOW).hex(), N = c.Z.colors.BACKGROUND_ACCENT.css, R = (0, _.DP)(a), P = (0, l.Rf)(a), w = P === C ? N : P, D = (0, f.Lq)(R ? p.Ilk.WHITE_500 : p.Ilk.PRIMARY_530), L = (0, d.Z)(I), x = (0, d.Z)(T), [j, M] = i.useState((0, s.Z)());
  return i.useEffect(() => {
    (L !== I || x !== T) && M((0, s.Z)())
