...
function v(e) {
  let {
    ...
    colorPickerFooter: S,
    showEyeDropper: I
  } = e, T = i.useRef(null), C = (0, u.dQu)(c.Z.colors.BACKGROUND_BASE_LOW).hex(), A = c.Z.colors.BACKGROUND_MOD_MUTED.css, N = (0, f.DP)(a), P = (0, l.Rf)(a), w = P === C ? A : P, R = N ? c.Z.unsafe_rawColors.WHITE.css : c.Z.unsafe_rawColors.PRIMARY_530.css, D = (0, d.Z)(v), x = (0, d.Z)(S), [L, j] = i.useState((0, s.Z)());
  return i.useEffect(() => {
    (D !== v || x !== S) && j((0, s.Z)())
