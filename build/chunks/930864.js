...
function w(e) {
  ...
  let {
    channel_id: T,
    id: L
  } = t, R = r.useMemo(() => (0, u.dL)(T), [T]), [A, M] = r.useState(!1), k = (0, i.e7)([f.Z], () => {
    var e;
  ...
  let en = r.useMemo(() => (0, a.throttle)(() => {
    ...
    er = r.useCallback(async function(e) {
      ...
      let {
        ...
        closeAfterSend: d
      } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, b = null != (r = f.Z.getMessage(T, L)) ? r : t;
