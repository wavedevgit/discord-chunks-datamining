...
let h = e => {
  ...
  let y = n === l.Hb.ORIGINAL_POSTER,
    O = n === l.Hb.REMIX,
    v = null;
  d && (v = <a.u text={E} align={"center"} position={"top"}>{e => (0, r.jsx)(s.kSu, p(f({}, e), {
  ...
  switch (n) {
    case l.Hb.REMIX:
      return <a.u text={c.intl.string(c.t.xb0str)} position={"top"}>{e => I(e)}</a.u>;
    case l.Hb.ORIGINAL_POSTER:
      return <a.u text={c.intl.string(c.t.uN6Emp)} position={"top"}>{e => I(e)}</a.u>;
    default:
      return I()
  }
};
