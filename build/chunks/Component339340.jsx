...
function S(e) {
  let {
    ...
    onClose: A
  } = e, C = (0, o.e7)([d.Z], () => d.Z.getChannelStatus(t)), N = (0, o.e7)([m.Z], () => m.Z.getMediaSessionId()), [R, P] = i.useState(null != C ? C : ""), [w, D] = i.useState(false), [x, L] = i.useState(null), j = (0, o.e7)([g.default], () => g.default.getCurrentUser()), k = R.length > T;
  i.useEffect(() => {
