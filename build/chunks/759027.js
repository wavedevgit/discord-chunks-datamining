...
function y(e) {
  ...
  let {
    subscription: O,
    onUpdated: E
  } = e, [T, S] = r.useState(!1), [P, w] = r.useState(!1), [I, R] = r.useState(!1), [k, A] = r.useState(!1), [Z, D] = r.useState(null), L = e => (null == e && (e = O.status), e in g) ? g[e] : "Unknown status ".concat(e), B = e => {
    let t = new Date(e);
