...
function y(e) {
  ...
  let {
    subscription: T,
    onUpdated: N
  } = e, [E, S] = r.useState(!1), [P, w] = r.useState(!1), [I, R] = r.useState(!1), [k, A] = r.useState(!1), [Z, D] = r.useState(null), L = e => (null == e && (e = T.status), e in g) ? g[e] : "Unknown status ".concat(e), M = e => {
    let t = new Date(e);
    ...
    N()
  }, B = (null == (t = b.GP[T.planIdFromItems]) ? void 0 : t.premiumType) === b.p9.TIER_0, z = null == (a = T.metadata) ? void 0 : a.ended_at, G = null != z ? new Date(z).toISOString().substring(0, 10) : "", V = T.hasActiveTrial, H = (null == (l = T.metadata) ? void 0 : l.active_discount_id) != null;
  return (0, n.jsxs)("div", {
