...
function y(e) {
  ...
  let {
    ...
    E()
  }, F = (null == (t = f.GP[N.planIdFromItems]) ? void 0 : t.premiumType) === f.p9.TIER_0, G = null == (a = N.metadata) ? void 0 : a.ended_at, z = null != G ? new Date(G).toISOString().substring(0, 10) : "", V = N.hasActiveTrial, H = (null == (l = N.metadata) ? void 0 : l.active_discount_id) != null;
  return (0, n.jsxs)("div", {
