...
function y(e) {
  ...
  let {
    subscription: O,
    onUpdated: E
  } = e, [T, S] = r.useState(!1), [P, w] = r.useState(!1), [I, R] = r.useState(!1), [k, Z] = r.useState(!1), [A, D] = r.useState(null), L = e => (null == e && (e = O.status), e in g) ? g[e] : "Unknown status ".concat(e), B = e => {
    let t = new Date(e);
  ...
  return (0, n.jsxs)("div", {
    ...
    children: [V && (0, n.jsx)(o.P3F, {
      ...
      children: [(0, n.jsxs)(o.Text, {
        ...
        variant: "text-md/normal",
        children: ["ID: ", O.id, " "]
      }), O.status !== p.O0b.ACTIVE && (0, n.jsxs)(o.Text, {
        variant: "text-md/normal",
        ...
        children: [(0, n.jsxs)(o.Text, {
          variant: "text-md/normal",
          children: ["Pause Reason: ", O.pauseReason in j ? j[O.pauseReason] : "Unknown pause reason ".concat(O.pauseReason)]
