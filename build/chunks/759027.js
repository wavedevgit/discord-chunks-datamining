...
function y(e) {
  ...
  let {
    subscription: O,
    onUpdated: E
  } = e, [T, S] = r.useState(!1), [P, w] = r.useState(!1), [I, R] = r.useState(!1), [k, A] = r.useState(!1), [Z, D] = r.useState(null), L = e => (null == e && (e = O.status), e in j) ? j[e] : "Unknown status ".concat(e), M = e => {
    let t = new Date(e);
    ...
    E()
  }, F = (null == (t = f.GP[O.planIdFromItems]) ? void 0 : t.premiumType) === f.p9.TIER_0, z = null == (a = O.metadata) ? void 0 : a.ended_at, G = null != z ? new Date(z).toISOString().substring(0, 10) : "", V = O.hasActiveTrial, H = (null == (l = O.metadata) ? void 0 : l.active_discount_id) != null;
  return (0, n.jsxs)("div", {
