...
function y(e) {
  ...
  let {
    subscription: h,
    onUpdated: y
  } = e, [C, N] = r.useState(!1), [O, E] = r.useState(!1), [T, S] = r.useState(null), P = e => (null == e && (e = h.status), e in g) ? g[e] : "Unknown status ".concat(e), I = e => {
    let t = new Date(e);
    ...
    y()
  }, R = (null == (t = b.GP[h.planIdFromItems]) ? void 0 : t.premiumType) === b.p9.TIER_0, A = null == (n = h.metadata) ? void 0 : n.ended_at, Z = null != A ? new Date(A).toISOString().substring(0, 10) : "";
  return (0, a.jsxs)("div", {
    ...
    children: [(0, a.jsxs)("div", {
      ...
      children: [(0, a.jsxs)(o.Text, {
        ...
        variant: "text-md/normal",
        children: ["ID: ", h.id, " "]
      }), h.status !== p.O0b.ACTIVE && (0, a.jsxs)(o.Text, {
        variant: "text-md/normal",
        children: ["Dates: ", (0, d.vc)(h.createdAt, "LL"), " - ", (0, d.vc)(h.currentPeriodEnd, "LL")]
      }), (0, a.jsxs)(o.Text, {
        variant: "text-md/normal",
        children: ["Status: ", P()]
      }), h.status === p.O0b.PAUSED && (0, a.jsxs)(a.Fragment, {
        children: [(0, a.jsxs)(o.Text, {
          variant: "text-md/normal",
