  ...
  i.useEffect(() => {
    let i = t(),
      l = new a.Fh(e, () => {
        let e = t(),
          l = n(i, e);
        null == l || y.Z.isSoundDisabled(l) || (0, p.GN)(l, null != r ? r : .4), i = e
      });
...
function Z() {
  return j([Chunk592125.Z, Chunk19780.Z, Chunk944486.Z, Chunk258609.Z], () => {
    ...
    return {
      channelType: exports,
      guildId: require,
      connected: Chunk73800 === Chunk981631.hes.RTC_CONNECTED,
      connectHasStarted: !Chunk255367 && Chunk73800 !== Chunk981631.hes.DISCONNECTED || Chunk73800 === Chunk981631.hes.RTC_CONNECTED,
...
function G() {
  return j([Chunk944486.Z, Chunk317381.ZP, Chunk314897.default], () => {
    let e = Chunk944486.Z.getVoiceChannelId(),
      ...
      c = (0, Chunk823379.lm)(Chunk255367) ? Chunk317381.ZP.getEmbeddedActivitiesForChannel(Chunk255367) : Chunk317381.i6,
      u = (0, Chunk823379.lm)(require) ? Chunk317381.ZP.getSelfEmbeddedActivityForLocation(require) : null;
    return {
      connectedActivityLocation: require,
      voiceChannelId: module,
      currentUserId: Chunk73800,
...
function B() {
  return (0, Chunk255367.jsxs)(Chunk255367.Fragment, {
    children: [(0, Chunk255367.jsx)(x, {}), (0, Chunk255367.jsx)(A, {}), (0, Chunk255367.jsx)(Z, {}), (0, Chunk255367.jsx)(w, {}), (0, Chunk255367.jsx)(R, {}), (0, Chunk255367.jsx)(k, {}), (0, Chunk255367.jsx)(U, {}), (0, Chunk255367.jsx)(M, {}), (0, Chunk255367.jsx)(G, {}), (0, Chunk255367.jsx)(L, {}), (0, Chunk255367.jsx)(D, {}), (0, Chunk255367.jsx)(V, {})]
  })
}