...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk617379 = require("./617379.js"),
  Chunk324081 = require("./324081.js"),
  Chunk305248 = require("./305248.js"),
  Chunk520116 = require("./520116.js"),
...
let S = Chunk73800.memo(function(e) {
    ...
    return <s.animated.div ref={l} style={f}><x{...E({}, e)} /></s.animated.div>
  }),
  x = Chunk73800.memo(function(e) {
    ...
    return <div className={j.channel}><u.y5t component={(0, r.jsxs)(O.Z, {
          channel: s,
          gotoChannel: a,
        ...
        })}>{t.collapsed ? null : "messages" === t.type ? (0, r.jsx)(y.Z, {
          channel: t,
          channelRecord: s,
          gotoChannel: a
...
function I(e) {
  ...
  return <u.M0o className={j.markReadButton} tooltip={o ? v.intl.string(v.t["5lLMhI"]) : v.intl.string(v.t.e6RscX)} color={u.YX$.TERTIARY} icon={o ? (0, r.jsx)(u.W6s, {
      size: "xs",
      color: "currentColor"
    }) : (0, r.jsx)(u.dz2, {
      size: "xs",
...
function P(e) {
  ...
  return <u.ua7 text={v.intl.string(v.t.iTcumZ)}>{e => {
      var n, i;
