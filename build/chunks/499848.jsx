...
class h extends Chunk73800.PureComponent {
  render() {
    ...
    if (null == require || null == module || 0 === module.length) return <Chunk481060.$jN type={Chunk481060.$jN.Type.SPINNING_CIRCLE} />;
    ...
    return <Chunk481060.hjN tag={Chunk481060.RB0.H2} title={y}>{(0, Chunk481250.V)(module, exports, Chunk73800, require, Chunk442837)}</Chunk481060.hjN>
  }
}
