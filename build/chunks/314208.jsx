...
function S(e) {
  return e.isActiveThread() ? <P channel={e} /> : <I channel={e} />
}
...
function P(e) {
  ...
  return null == n ? <T channel={t} /> : <C channel={t} message={n} />
}
...
function T(e) {
  ...
  return <s.Text className={N.subtext} variant={"text-sm/normal"} color={"header-secondary"}>{w.intl.string(w.t.Jmh6n5)}{"\xa0 • \xa0"}{(0, y.Ye)(n)}</s.Text>
}
...
function C(e) {
  ...
  let c = (0, a.e7)([x.default], () => {
    ...
    T = l.useMemo(() => {
      ...
      return <r.Fragment>{s}{null != l ? l : <span>{t}</span>}{a}</r.Fragment>
    }, [n, w, S, P]);
  return <s.Text className={N.subtext} variant={"text-sm/normal"} color={"header-secondary"}>{<o.Z className={N.avatar} user={c} size={s.EFr.SIZE_16} />}{<s.PUh name={f} colorString={j} colorStrings={Z} className={N.authorName} />}{":\xa0"}{T}{"\xa0 • \xa0"}{(0, y.Ye)(p.default.extractTimestamp(n.id))}</s.Text>
}
...
function I(e) {
  ...
  return <s.Text className={N.subtext} variant={"text-sm/normal"} color={"header-secondary"}>{null == v ? (0, r.jsxs)(r.Fragment, {
