...
class j extends r.PureComponent {
  ...
  _micTestStop() {
    ...
    t && (n && i && e && u.Z.toggleSelfDeaf(), u.Z.setLoopback("mic_test", !1), this.setState({
      isMicTesting: !1,
      didDeafenUser: !1
  ...
  render() {
    let {
      ...
      isMicTesting: p,
      volume: h
    } = this.state, f = e && !p ? x.intl.string(x.t["9viE2N"]) : null;
...
function C(e) {
  ...
  let {
    ...
    let e = p.Z.getInputDeviceId(),
      ...
      i = p.Z.getOutputDeviceId(),
      r = p.Z.getOutputDevices(),
      s = l().find(r, e => {
        let {
          id: t
        } = e;
