...
function g(t) {
  ...
  } = (0, c.ZP)(), T = null != (e = null != (n = null == x ? void 0 : x[0]) ? n : null == k ? void 0 : k[0]) ? e : null, _ = (0, a.e7)([p.default], () => p.default.getUser(w), [w]), [S, Z] = (0, f.ZP)(w, g), [E, P] = i.useState(!1), U = i.useCallback(async () => {
    if (null != _) {
      P(!0);
      try {
