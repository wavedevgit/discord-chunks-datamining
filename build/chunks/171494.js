...
function g(t) {
  ...
  } = (0, c.ZP)(), D = null != (e = null != (n = null == y ? void 0 : y[0]) ? n : null == k ? void 0 : k[0]) ? e : null, T = (0, i.e7)([h.default], () => h.default.getUser(_), [_]), [N, E] = (0, p.ZP)(_, g), [I, P] = a.useState(!1), S = a.useCallback(async () => {
    if (null != T) {
      P(!0);
      try {
  ...
  }, [g, T, _, j, D]), Z = a.useCallback(() => {
    E || j()
  }, [E, j]);
  return ((0, o.ZP)(() => {
    null != T && m.default.track(f.rMx.OPEN_MODAL, {
      type: x.av,
      guild_id: g,
      other_user_id: T.id
    })
    ...
    (null == T || null == g) && j()
  }), null == T || null == g) ? null : (0, l.jsxs)(s.Y0X, {
    transitionState: C,
    "aria-labelledby": w,
    ...
    children: [(0, l.jsxs)(s.xBx, {
      ...
      children: [(0, l.jsx)(s.Text, {
        ...
        children: b.intl.format(b.t["t+abNT"], {
          username: T.username,
          countdown: t => null == N ? null : (0, l.jsx)(u.Z, {
