...
function k(t) {
  ...
  } = (0, c.ZP)(), D = null != (l = null != (n = null == y ? void 0 : y[0]) ? n : null == x ? void 0 : x[0]) ? l : null, S = (0, e.e7)([m.default], () => m.default.getUser(v), [v]), [Z, _] = (0, p.ZP)(v, k), [E, N] = i.useState(!1), U = i.useCallback(async () => {
    if (null != S) {
      N(!0);
      try {
