...
function h(e) {
  let {
    ...
    let e = A ? s.v0G : m ? s.wE8 : s.nRN;
    return h || m || A ? (0, r.jsx)("div", {
    ...
    className: d.border,
    style: N
  }, "border"), R = () => h && i ? (0, r.jsxs)(r.Fragment, {
    children: [w(), P()]
  }) : h || m || A ? (0, r.jsx)(r.Fragment, {
    children: P()
  }) : (0, r.jsx)(r.Fragment, {
    children: w()
  }), D = () => {
    ...
    return null != v ? i = n === s.EFr.SIZE_32 ? l.QS.AVATAR_CALL_ICON_32 : l.QS.AVATAR_CALL_ICON : (h || m || A) && (i = l.QS.AVATAR_VOICE_CALL_80), (0, r.jsxs)("div", {
