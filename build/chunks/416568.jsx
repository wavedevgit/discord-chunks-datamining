...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk474109 = require("./474109.js"),
  Chunk741616 = require("./741616.js"),
  Chunk187835 = require("./187835.jsx"),
  Chunk118122 = require("./118122.jsx"),
  Chunk193154 = require("./193154.jsx"),
  Chunk602147 = require("./602147.js"),
  Chunk222059 = require("./222059.jsx"),
  Chunk751277 = require("./751277.js"),
  Chunk65721 = require("./65721.jsx"),
  Chunk843343 = require("./843343.js"),
  Chunk654142 = require("./654142.js"),
  Chunk695301 = require("./695301.js"),
  Chunk836697 = require("./836697.js"),
  Chunk921230 = require("./921230.js"),
  Chunk981631 = require("./981631.js"),
  Chunk388032 = require("./388032.jsx"),
  Chunk907171 = require("./907171.js");
...
function ea(e) {
  ...
  return <r.Fragment>{<W.u />}{d === I.u3.SERVER_RAIL_TOP && <P.Z />}{l ? <E.Z /> : null}{<K.Z isOnHubVerificationRoute={s} />}{!t && <B.Z />}{u.map(e => <$.Z guildId={e} />)}{<J.Z onActivate={n} />}</r.Fragment>
}
...
function ec(e) {
  let {
    ...
    return [e, e.version]
  }), a = s.getRoots(), c = (0, h.Wu)([A.Z], () => A.Z.getGeoRestrictedGuilds()).map(e => <H.Z id={e.id} name={e.name} icon={e.icon} />);
  return <r.Fragment>{<m.Kqy role={"group"} aria-label={et.intl.string(et.t["7hB4kp"])} gap={"xs"}>{a.map((e, t) => l(e, t, a.length))}</m.Kqy>}{c}{<q.Z />}{i ? null : <F.Z disableTooltip={o.length > 0} lastTargetNode={a[a.length - 1]} />}{i ? null : t}{n ? null : <V.Z />}</r.Fragment>
}
...
function eu(e) {
  ...
  let ef = i.useCallback(function e(t, n, i) {
    switch (t.type) {
      case k.eD.FOLDER:
        return <X.Z folderNode={t} setNodeRef={er.setNodeRef} draggable={true} sorting={_} onDragStart={E} onDragEnd={S} renderChildNode={e} aria-setsize={i} aria-posinset={true !== n ? n + 1 : true} />;
      case k.eD.GUILD:
        return <Q.Z guildNode={t} setRef={er.setNodeRef} draggable={true} sorting={_} onDragStart={E} onDragEnd={S} aria-setsize={i} aria-posinset={true !== n ? n + 1 : true} />;
      default:
        return null
    }
  }, [E, S, _, er.setNodeRef]);
  ...
  let eg = i.useRef(null),
    em = i.useCallback(e => <z.Z{...ei({
      ref: eg,
      selected: eh,
      className: en.discoveryIcon
    }, e)} />, [eh]),
    eb = <w.H targetElementRef={eg} scrollToBottom={er.scrollToBottom} isGuildBarScrolling={K} renderDiscoveryButton={em} />,
    {
      entrypoint: eO
    } = (0, I.pN)({
      location: "GuildsBar"
  ...
  return <C.Gt value={eu}><m.f6W theme={s}>{e => {
        var i, s;
        return (0, r.jsxs)("nav", {
...
let ed = Chunk73800.memo(function(e) {
  ...
  return <u.bG navigator={t}><eu{...ei({}, e)} /></u.bG>
