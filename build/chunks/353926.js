...
function el(e) {
  ...
  s.K.remove(O), t || (s.K.remove(v), s.K.remove(I), s.K.remove(S), k = {}, M = {}), D = {}, w = y(E({}, w), {
    rawUserExperiments: []
  }), C = {}, N = !1
}
...
function ed() {
  var e, t, n;
  let r = [null != (e = s.K.get(v)) ? e : {}, null != (t = s.K.get(I)) ? t : {}, null != (n = s.K.get(S)) ? n : {}];
  k = {}, M = {};
  let o = !i().isEmpty(r[0]);
  for (let e of r)
    for (let t in e) {
      let n = e[t];
      null == n || n.type !== h.xY.USER && n.type !== h.xY.GUILD || null == n.bucket || !0 !== n.override || n.fromCookie ? (delete e[t], o = !0) : n.type === h.xY.USER ? k[t] = n : M[t] = n
    }
  let a = (0, c._S)();
  for (let e in a) k[e] = {
    type: h.xY.USER,
...
function eh(e) {
  ...
  let {
    ...
    experimentType: i,
    skipCleanup: o
  } = e, a = null != i ? i : null == (t = R[n]) ? void 0 : t.type;
  if (null == a) return !1;
  if (null == r ? (k = E({}, k), delete k[n], M = E({}, M), delete M[n]) : "user" === a ? k = y(E({}, k), {
      [n]: {
        type: a,
        revision: 1,
        population: 0,
