...
function Q(e) {
  ...
  if (n.type === h.xY.USER) {
    ...
    } else f.default.track(e, a, {
      flush: !0,
      fingerprint: o
    })
  }
  c ? R.set(_, p) : (C[Y(t, n, r, u)] = {
    time: Date.now(),
    hash: W(n)
  }, eh(C))
}
...
function et(e) {
  var t;
  !U && "CONNECTION_OPEN" === e.type && H(e.user) && (U = !0), "EXPERIMENTS_FETCH_SUCCESS" === e.type && N && "ready_payload" === w.source && f.default.track(m.rMx.EXPERIMENT_FETCH_IGNORED, {
...
function ea(e, t) {
  ...
  let _ = null;
  return null != a.holdoutName && null != a.holdoutControlBucket && a.holdoutName !== t && (null == (_ = ea(e, a.holdoutName)) ? void 0 : _.bucket) != null && (!0 !== _.override && Q({
    experimentId: a.holdoutName,
    descriptor: _
  }), (null == _ ? void 0 : _.bucket) === a.holdoutControlBucket) ? null : {
    type: h.xY.GUILD,
    guildId: e,
    revision: a.revision,
    bucket: d,
...
function es(e) {
  ...
  if (!U && H(n) && (U = !0), N = t.hasLoadedExperiments, C = t.trackedExposureExperiments, D = t.loadedUserExperiments, k = t.userExperimentOverrides, M = t.guildExperimentOverrides, w = y(E({}, w), {
...
function ep() {
  try {
    ...
    A.error("Error saving user experiment overrides, unsaved data will be lost", e), f.default.track(m.rMx.EXPERIMENT_SAVE_EXPOSURE_FAILED, {
      module: "discord_app",
  ...
  try {
    ...
    A.error("Error saving guild experiment overrides, unsaved data will be lost", e), f.default.track(m.rMx.EXPERIMENT_SAVE_EXPOSURE_FAILED, {
      module: "discord_app",
      call: "ExperimentStore.saveExperimentOverrides"
    })
  }
...
function eh(e) {
  try {
    ...
    A.error("Error saving tracked exposure experiments, unsaved data will be lost", e), f.default.track(m.rMx.EXPERIMENT_SAVE_EXPOSURE_FAILED, {
      module: "discord_app",
...
class eb extends _.Z {
  ...
  getExperimentOverrideDescriptor(e) {
    var t;
    return U ? null != (t = k[e]) ? t : M[e] : null
  }
