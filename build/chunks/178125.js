...
function j(e) {
  let {
    ...
    onClose: l,
    parentId: o
  } = e, d = (0, a.e7)([u.ZP], () => u.ZP.getFlattenedGuildIds()[0]), [s, h] = i.useState(d), [m, x] = i.useState(!1);
...
function p(e) {
  let {
    ...
    hideMutedChannels: l,
    parentId: r
  } = e, d = (0, a.e7)([s.Z], () => s.Z.getCategories(n)), c = (0, g.Z)(d), u = i.useRef(null);
  return i.useEffect(() => {
    var e;
    ...
    ref: u,
    children: c.map(e => e.type === o.d.GUILD_CATEGORY ? (0, t.jsx)(N, {
      name: e.name
    }, e.id) : (0, t.jsx)(C, {
      channel: e,
      hideMutedChannels: l,
