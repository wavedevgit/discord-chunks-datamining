...
let s = new Set([Chunk281598.jE.HERO_BANNER_STATIC, Chunk281598.jE.HERO_LOGO, Chunk281598.jE.PDP_BACKGROUND, Chunk281598.jE.LOGO, Chunk281598.jE.MOBILE_BANNER, Chunk281598.jE.MOBILE_BACKGROUND]),
  ...
  h = {
    ...
    [Chunk281598.jE.HERO_BANNER_RIVE]: c,
      ...
      validateShopAssetPackage: Chunk473749.useCallback(async e => {
        try {
          ...
          n = await (0, l.LY)([t]), (e => {
            ...
            let o = Object.values(l.jE).filter(e => !s.has(e)).filter(e => !r.has(e));
            ...
            f({
              ...
              addError: n
            }), g(l.aB.AVATAR_DECORATION, t.avatarDecorationFiles, n, a)
          })({
            files: n,
            addError: m,
            addWarning: p
