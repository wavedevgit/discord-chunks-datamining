...
let o = new Set([a.jE.SHOP_ALL_BANNER_STATIC, a.jE.HERO_BANNER_STATIC, a.jE.HERO_LOGO, a.jE.PDP_BACKGROUND, a.jE.PDP_LOGO, a.jE.COLLECTED_MODAL_BG, a.jE.MOBILE_BANNER, a.jE.MOBILE_BACKGROUND]),
  ...
  b = async e => {
    ...
    let {
      names: t,
      addError: n
    } = e, r = /^[a-z]+(_[a-z]+)*(\.[a-z0-9]+)?$/, a = t.filter(e => !r.test(e));
    a.length > 0 && n("File names must be in lowercase snake case", a)
  }, g = (e, t, n, r) => {
    let a = t.size,
      l = a > 1e6 ? "".concat((a / 1e6).toFixed(2), "MB") : "".concat((a / 1e3).toFixed(2), "KB"),
    ...
    let a = p[e];
    if (null != a)
      for (let e of t) e.name.endsWith(".txt") || g(a, e, n, r)
  }, j = (e, t, n) => {
    for (let r of e) {
      let e = (0, a.BU)(r),
        l = null != e ? p[e] : null;
    ...
    let s = Object.values(a.jE).filter(e => !o.has(e)).filter(e => !l.has(e));
    ...
    let [e, t] = r.useState(!1), [n, o] = r.useState({}), [s, c] = r.useState({}), d = r.useCallback(function(e) {
    ...
    return {
      ...
      errors: s,
      warnings: n,
      validateShopAssetPackage: r.useCallback(async e => {
        try {
