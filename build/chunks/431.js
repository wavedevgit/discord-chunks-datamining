...
function v(e) {
  ...
  null == t && null == n && null == r && A(), null != t ? (b.userTrialOffers[t.trial_id] = t, b.userDiscountOffers = {}) : null != n ? (b.userDiscountOffers[n.discount_id] = n, b.userTrialOffers = {}) : null != r && (b.userDiscountOffers[r.discount_id] = r, b.userTrialOffers = {}), b.userOffersLastFetchedAtDate = Date.now(), b.isFetching = !1, b.lastFetchSuccessful = !0
}
...
class w extends(r = i.ZP.PersistedStore) {
  initialize(e) {
    b = null != e ? e : E, this.waitFor(l.default), this.syncWith([l.default], N), this.syncWith([d.Z], C), this.syncWith([a.Z], P)
  }
  getUserTrialOffer(e) {
...
_(w, "displayName", "UserOfferStore"), _(w, "persistKey", "UserOfferStore"), _(w, "migrations", [e => {
  ...
  if (null != e) return (null == e ? void 0 : e.isFetching) == null ? m(p({}, e), {
    isFetching: !1
  }) : e
}]);
let D = new w(o.Z, {
