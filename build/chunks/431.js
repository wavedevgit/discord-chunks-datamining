...
class x extends(r = i.ZP.PersistedStore) {
  ...
  shouldFetchOffer() {
    ...
    }), r = t ? n : b, i = O.userOffersLastFetchedAtDate, a = null != (e = O.isFetching) && e;
  ...
  canFractionalPremiumUserUseOffer() {
    let e = u.default.getCurrentUser();
    return (0, l.C)("user-offer-store", e) && d.Z.isFractionalPremiumActive({
      excludeReverseTrial: !0
    }) && null == _.ZP.getPremiumTypeSubscription()
  }
  getReferrer(e) {
    var t;
...
h(x, "displayName", "UserOfferStore"), h(x, "persistKey", "UserOfferStore"), h(x, "migrations", [e => {
  ...
  if (null != e) return (null == e ? void 0 : e.isFetching) == null ? E(m({}, e), {
    isFetching: !1
  }) : e
}]);
let M = new x(a.Z, {
