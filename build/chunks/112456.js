...
(function() {
  ...
  i.date = function(e, t) {
    ...
    var o = 5184e3;
    if (n < 5184e3 && n > -o) return n >= 0 ? "about a month ago" : "in about a month";
    ...
    return (t = true === t ? 1024 : t, e <= 0) ? "0 bytes" : (e < t && true === n && (n = 0), true === o && (o = " "), i.intword(e, ["bytes", "KB", "MB", "GB", "TB", "PB"], t, n, r, a, o))
