...
function g(e) {
  ...
  return <u.Z message={m.intl.format(m.t.chw89f, {
      currentListing: x.name,
      nextListing: _.name,
      changeDate: j
    })} error={null == f ? true : f.message} onClick={() => g(n)} submitting={h} ctaMessage={m.intl.string(m.t.De4wIy)} className={s} />
}