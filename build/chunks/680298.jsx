...
function p(e) {
  ...
  return <l.P3F onClick={h} className={d.item} onContextMenu={x}>{<div className={d.identifier}>{<j className={d.icon} size={"md"} color={"currentColor"} />}{<l.Text variant={"text-md/normal"}>{v}</l.Text>}</div>}{<div className={d.statusContainer}>{f ? (0, i.jsxs)("div", {
