...
function h(e) {
  ...
  return 0 === b.length ? null : (t = 1 === b.length ? p.intl.formatToPlainString(p.t["Egq+Gx"], {
    ...
    b: b[1].name,
    c: b[2].name
  }) : p.intl.string(p.t.MvfowM), <o.Z guild={n} onDismissed={g} message={t} type={d.vID.APPLICATION_SUBSCRIPTION_EXPIRATION} image={f} onClick={() => {
      g(), s.Z.open(n.id, d.pNK.INTEGRATIONS)
    }} imageMarginTop={6} imageMarginX={46} cta={p.intl.string(p.t.Rr3MAQ)} />)
}