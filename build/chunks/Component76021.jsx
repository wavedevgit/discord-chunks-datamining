...
function g(e, t, _) {
  if (d.isPlatformEmbedded)(0, i.ZDy)(async () => {
    ...
    let n = s.Z.getChannel(t),
      r = (0, o.Z)(f.ApplicationStreamPresets.PRESET_CUSTOM, f.ApplicationStreamResolutions.RESOLUTION_1080, f.ApplicationStreamFPS.FPS_30, u.default.getCurrentUser(), null == (h = l.Z.getGuild(e)) ? true : h.premiumTier, n) ? {
        width: 1920,
        height: 1080
      } : {
        width: 1280,
