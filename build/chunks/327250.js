...
function T(e) {
  let {
    ...
    guildId: n,
    onClose: i
  } = e, l = t.id, s = (0, o.e7)([C.Z, y.Z, g.default], () => l === g.default.getId() ? C.Z.getStatus() : y.Z.getStatus(l, n), [l, n]);
  return (0, r.jsxs)("div", {
    className: P.topRow,
...
function A(e) {
  ...
  return (0, r.jsx)(a.ua7, {
    text: n,
    children: e => (0, r.jsx)(a.P3F, N(Z({}, c, e), {
      tag: t,
      "aria-label": n,
...
function w(e) {
  let {
    ...
    member: i,
    guildId: l
  } = e, m = (0, o.e7)([_.Z], () => _.Z.getGuild(l)), {
    canKickUser: b,
    canBanUser: y,
    canModerateMembers: C
  } = (0, o.cj)([x.Z, v.default, _.Z], () => ({
