...
function w(e) {
  let {
    ...
    guildId: n,
    onClose: i
  } = e, l = t.id, s = (0, o.e7)([j.Z, x.Z, g.default], () => l === g.default.getId() ? j.Z.getStatus() : x.Z.getStatus(l, n), [l, n]);
  return (0, r.jsxs)("div", {
    className: N.topRow,
...
function k(e) {
  let {
    ...
    member: i,
    guildId: l
  } = e, m = (0, o.e7)([y.Z], () => y.Z.getGuild(l)), {
    canKickUser: _,
    canBanUser: x,
    canModerateMembers: j
  } = (0, o.cj)([C.Z, O.default, y.Z], () => ({
