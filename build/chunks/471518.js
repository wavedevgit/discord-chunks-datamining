...
async function N(e) {
  ...
  let a = new r.Z(y, v),
    o = (e, t) => 429 === e.status && a.fails < O && (a.fail(() => {
      t(void 0, o)
    }), !0);
  try {
...
async function P(e) {
  ...
  } = null != i ? i : {}, v = Date.now(), O = m.Z.getFetchState({
    query: n,
    guildId: r,
    page: o,
    pageSize: d,
...
async function D() {
  ...
  } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = d.default.disableAppCollectionsCache, r = Date.now(), a = h.Z.getFetchState({
    surface: e,
    activeState: t
