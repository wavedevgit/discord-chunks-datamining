...
let u = (e, t, n) => {
  ...
  d = e => {
    let {
      ...
      emoji: d
    } = (0, i.cj)([o.ZP, a.Z], () => u(o.ZP, a.Z, t)), f = null != s, _ = null != s && s.hasFeature(c.oNc.DISCOVERABLE), p = (!f || _) && null != t, [h, m] = r.useState(p), [g, E] = r.useState(null), b = null != s ? l.JO.createFromGuildRecord(s) : null, [y, O] = r.useState(b), [v, I] = r.useState(null), S = r.useRef(n);
    return r.useEffect(() => {
      S.current = n
    }), r.useEffect(() => {
      var e, n;
