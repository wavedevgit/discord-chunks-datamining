...
function S(e) {
  let {
    ...
    setRules: n,
    guild: s
  } = e, a = s.rulesChannelId, l = s.hasFeature(v.oNc.PREVIEW_ENABLED), c = (0, u.e7)([h.Z], () => null != a ? h.Z.getChannel(a) : null), d = (0, u.e7)([b.ZP], () => b.ZP.getDefaultChannel(s.id)), [g, p] = i.useState(null), [f, I] = i.useState(null), S = i.useCallback(e => {
    if (t.length !== N.X2)
  ...
  }, [g, t, n]), D = t.length === N.X2, Z = i.useMemo(() => {
