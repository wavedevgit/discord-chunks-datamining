...
function E(e) {
  let {
    ...
    hover: (e, t) => {
      ...
      let {
        index: r
      } = e, i = null == (n = y.current) ? void 0 : n.getBoundingClientRect(), l = t.getClientOffset();
      if (null == i || null == l) return;
      let a = (i.bottom - i.top) / 2,
        o = l.y - i.top;
      r < s && o < a || r > s && o > a || f(e.rule, s, !1)
    },
    drop: e => {
      f(e.rule, s, !0)
    }
  });
  if (i.useLayoutEffect(() => (w(E), R(Z(y)), () => {
      w(null), Z(null)
    }), [w, Z, R]), i.useEffect(() => {
  ...
  return (0, r.jsx)("div", {
    ref: y,
    className: l()(O.draggableInputContainer, {
      [O.dragging]: x
    }),
    "data-dnd-name": D,
    children: (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(m.P3F, {
        ...
        children: (0, r.jsx)(h.Z, {
          ...
          onChange: (e, t, n) => {
            let r = t;
            r.length > N.fn && (r = r.slice(0, N.fn)), t !== r && (t = r, n = (0, p.JM)(r)), a(t), P({
              textValue: t,
              richValue: n
            })
          },
...
function S(e) {
  let {
    ...
    setRules: n,
    guild: s
  } = e, l = s.rulesChannelId, a = s.hasFeature(_.oNc.PREVIEW_ENABLED), c = (0, u.e7)([f.Z], () => null != l ? f.Z.getChannel(l) : null), d = (0, u.e7)([x.ZP], () => x.ZP.getDefaultChannel(s.id)), [g, p] = i.useState(null), [h, I] = i.useState(null), S = i.useCallback(e => {
    if (t.length !== N.X2)
      if (null != e && "" === t[t.length - 1].value) {
        let r = [...t];
        r[t.length - 1] = y(C({}, r[t.length - 1]), {
          value: e
        }), n(r), I(r.length - 1)
      } else n([...t, {
        id: o()(),
