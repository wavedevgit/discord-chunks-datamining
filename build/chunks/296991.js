...
function E(e) {
  let {
    ...
    previewEnabled: v,
    isDragEnabled: y
  } = e, N = i.useRef(null), E = i.useRef(null), [{
    textValue: S,
    richValue: T
    ...
    hover: (e, t) => {
      ...
      let {
        index: r
      } = e, i = null == (n = N.current) ? void 0 : n.getBoundingClientRect(), s = t.getClientOffset();
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(m.P3F, {
        ...
        children: (0, r.jsx)(h.Z, {
          ...
          onChange: (e, t, n) => {
            let r = t;
            r.length > _.fn && (r = r.slice(0, _.fn)), t !== r && (t = r, n = (0, p.JM)(r)), a(t), P({
              textValue: t,
              richValue: n
            })
          },
...
function S(e) {
  let {
    ...
    setRules: n,
    guild: l
  } = e, s = l.rulesChannelId, a = l.hasFeature(v.oNc.PREVIEW_ENABLED), c = (0, u.e7)([f.Z], () => null != s ? f.Z.getChannel(s) : null), d = (0, u.e7)([x.ZP], () => x.ZP.getDefaultChannel(l.id)), [g, p] = i.useState(null), [h, I] = i.useState(null), S = i.useCallback(e => {
    if (t.length !== _.X2)
  ...
  }, [g, t, n]), Z = t.length === _.X2, D = i.useMemo(() => {
