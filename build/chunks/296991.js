...
function S(e) {
  let {
    ...
    textValue: T,
    richValue: P
  }, w] = i.useState((0, f.eK)(t.value)), [, R, Z] = (0, c.c)({
    type: E,
    item: {
      rule: t,
      index: l
    ...
    hover: (e, t) => {
      ...
      let {
        index: r
      } = e, i = null == (n = I.current) ? void 0 : n.getBoundingClientRect(), s = t.getClientOffset();
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(g.P3F, {
        ...
        children: (0, r.jsx)(h.Z, {
          ...
          onChange: (e, t, n) => {
            let r = t;
            r.length > v.fn && (r = r.slice(0, v.fn)), t !== r && (t = r, n = (0, f.JM)(r)), a(t), w({
              textValue: t,
              richValue: n
            })
          },
...
function T(e) {
  let {
    ...
    setRules: n,
    guild: l
  } = e, s = l.rulesChannelId, a = l.features.has(O.oNc.PREVIEW_ENABLED), c = (0, u.e7)([x.Z], () => null != s ? x.Z.getChannel(s) : null), d = (0, u.e7)([b.ZP], () => b.ZP.getDefaultChannel(l.id)), [m, p] = i.useState(null), [f, h] = i.useState(null), E = i.useCallback(e => {
    if (t.length !== v.X2)
      if (null != e && "" === t[t.length - 1].value) {
        let r = [...t];
        r[t.length - 1] = I(N({}, r[t.length - 1]), {
          value: e
        }), n(r), h(r.length - 1)
      } else n([...t, {
        id: o()(),
  ...
  }, [m, t, n]), Z = t.length === v.X2, D = i.useMemo(() => {
