  ...
  L = async (e, t, n) => {
    ...
    try {
      ...
      (null == e ? void 0 : e.logPerf) && (0, b.n)({
        ...
        unpublishedCategoriesShown: null == e ? void 0 : e.includeUnpublished,
        cacheDisabled: null == e ? void 0 : e.noCache
      }), i && (0, _.v)("fetchCollectiblesCategories completed ".concat(a.body.length, " categories")), s.Z.dispatch({
    ...
    try {
      ...
      (null == e ? void 0 : e.variantsReturnStyle) === a.v.VARIANTS_GROUP && (n.query = {
      ...
      let e = new c.Hx(n);
      throw (0, O.G)(e), t && (0, _.v)("fetchCollectiblesPurchases failed: ".concat(e.message)), s.Z.dispatch({
