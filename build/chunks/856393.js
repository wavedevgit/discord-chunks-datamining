...
function es(e) {
  ...
  } = (0, g.ZP)(), d = t.getGuildId(), p = (0, s.e7)([D.Z], () => D.Z.getMostRecentSelectedTextChannelId(d), [d]), h = R.default.getId(), f = !(0, s.e7)([b.Z], () => b.Z.isFullscreenInContext(n)) && (!U.isPlatformEmbedded || U.isPlatformEmbedded && B.ZP.supportsFeature(ee.eRX.POPOUT_WINDOWS)), m = null != c && c.type !== et.fO.ACTIVITY && c.user.id !== h, x = i.useMemo(() => {
    var e;
...
function ec(e) {
  let {
    channel: t
  } = e, n = (0, f.bp)(), i = (0, s.e7)([L.Z], () => L.Z.can(ee.Plq.CREATE_INSTANT_INVITE, t)), l = (0, s.e7)([M.Z], () => M.Z.getGuild(t.guild_id)), o = (0, s.e7)([V.Z], () => V.Z.getStageInstanceByChannel(t.id)), a = i || (null == o ? void 0 : o.invite_code) != null, c = (0, O.Q3)("StageChannelInviteButton");
...
function eu(e) {
  ...
  return w && R && (U = "0px"), t = R ? (0, r.jsx)(Q.Z, {
    ...
    renderChatToasts: () => !M || _ || S ? null : (0, r.jsx)(x.ZP, {
...
function ed(e) {
  ...
  }), [t.id]), N = (0, s.e7)([M.Z], () => M.Z.getGuild(t.guild_id), [t.guild_id]), {
  ...
  let {
    width: A = 0,
    ref: w
  } = (0, p.ZP)(), R = A - 550, k = !O || O && S === ee.IlC.POPOUT;
  return (0, r.jsx)(g.Gt, {
    value: E,
