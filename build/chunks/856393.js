...
function eu(e) {
  ...
  } = (0, b.ZP)(), d = t.getGuildId(), p = (0, s.e7)([U.Z], () => U.Z.getMostRecentSelectedTextChannelId(d), [d]), h = M.default.getId(), f = !(0, s.e7)([_.Z], () => _.Z.isFullscreenInContext(n)) && (!B.isPlatformEmbedded || B.isPlatformEmbedded && F.ZP.supportsFeature(et.eRX.POPOUT_WINDOWS)), m = null != c && c.type !== en.fO.ACTIVITY && c.user.id !== h, g = i.useMemo(() => {
    var e;
...
function ed(e) {
  let {
    channel: t
  } = e, n = (0, m.bp)(), i = (0, s.e7)([k.Z], () => k.Z.can(et.Plq.CREATE_INSTANT_INVITE, t)), l = (0, s.e7)([L.Z], () => L.Z.getGuild(t.guild_id)), a = (0, s.e7)([z.Z], () => z.Z.getStageInstanceByChannel(t.id)), o = i || (null == a ? void 0 : a.invite_code) != null;
...
function ep(e) {
  ...
  let l, {
    ...
    P = (0, s.e7)([_.Z], () => _.Z.getSelectedParticipant(c.id)),
    I = f && j !== et.IlC.POPOUT,
    [Z, A] = i.useState(0),
    {
  ...
  let R = (0, s.e7)([D.Z], () => D.Z.getToastsEnabled(c.id)),
    M = (0, ee.Z)(c) ? null != P ? "84px" : "124px" : null != P ? "0px" : "48px";
  return w && (M = "0px"), l = w ? (0, r.jsx)(J.Z, {
    ...
    renderBottomRight: () => O ? (0, r.jsx)(b.Gt, {
      value: v,
      children: (0, r.jsx)(eu, {
        channel: c,
        appContext: j,
    ...
    renderChatToasts: () => !R || y || I ? null : (0, r.jsx)(C.ZP, {
...
function eh(e) {
  let {
    channel: t
  } = e, [l, o] = i.useState(!1), u = i.useCallback(() => {
    o(!l)
  }, [l, o]), {
    popoutWindow: p,
  ...
  } = (0, b.ZP)(g.Z.STAGE_CHANNEL_CALL), P = (0, m.bp)(), {
    chatOpen: I,
  ...
  let {
    width: w = 0,
    ref: R
  } = (0, h.ZP)(), M = w - 550, D = !O || O && P === et.IlC.POPOUT;
  return (0, r.jsx)(b.Gt, {
    value: E,
        ...
        children: [(0, r.jsx)(d.f6W, {
          ...
          children: e => (0, r.jsx)("div", {
            className: a()(ei.callContainer, e, {
              [ei.sidebarVisible]: l,
              [ei.sidebarOrChatVisible]: l || I || N
            }),
            children: (0, r.jsx)(Z.ZP, {
              timeout: 2e3,
              children: e => (0, r.jsx)(ep, {
                channel: t,
                toggleRequestToSpeakSidebar: u,
