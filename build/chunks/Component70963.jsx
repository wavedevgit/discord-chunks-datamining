...
function m(e) {
  let {
    ...
    themeType: g
  } = (0, d.E)(), E = g === _.d.MODAL_V2, b = (0, i.bG)([u.A], () => u.A.isInChannel(t.id));
  if (!(0, i.bG)([c.A], () => {
      let e = (0, s.r9)() && (0, s.UK)(t.id);
      return (t.isPrivate() || c.A.can(p.xBc.CONNECT, t)) && !e
    })) return null;
  let y = () => g === _.d.MODAL || g === _.d.MODAL_V2 ? h.intl.string(h.t["3xjX0U"]) : t.isDM() || t.isGroupDM() ? h.intl.string(h.t["7hwn2A"]) : t.isGuildStageVoice() ? h.intl.string(h.t.Acqcot) : h.intl.string(h.t.BXxdl7),
