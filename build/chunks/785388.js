...
let Y = e => {
    let {
      ...
      channelId: n,
      messageId: o
    } = e, [s, a] = r.useState(!0), [c, u] = r.useState([]), d = r.useMemo(() => {
  ...
  q = r.memo(function(e) {
    let {
      ...
      let o = null == e.id ? D.ZP.getURL(e.name) : k.ZP.getEmojiURL({
        id: e.id,
        animated: e.animated,
        size: 24
      });
    ...
    })(t, 0, z.emoji, l()(z.emoji, z.emojiText)), [t]), f = a === _.O.BURST, m = f ? G.t.VmiNjY : G.t.cNfs19, g = G.intl.formatToPlainString(m, {
      name: d,
      n: n
    }), b = r.useMemo(() => {
      let e = {};
      if (f) {
        ...
        o ? (e.background = null != (t = (0, c.wK)(l, s)) ? t : "", e.border = "1px solid ".concat(null != (n = (0, c.wK)(l, 1.1 * s)) ? n : "")) : (e.background = null != (i = (0, c.wK)(l, .025)) ? i : "", e.border = "1px solid ".concat(null != (r = (0, c.wK)(l, .05)) ? r : ""))
      }
      return e
    }, [f, u, o]), O = r.useMemo(() => {
      let e = {};
...
function $(e) {
  let {
    ...
    onRemoveReactor: a,
    disableManage: c = !1
  } = e, d = (0, u.e7)([R.default], () => R.default.getId()), p = (0, u.e7)([L.default], () => L.default.getUser(n.id), [n]), g = (0, E.$R)(o), O = (0, u.e7)([A.Z], () => A.Z.can(V.Plq.MANAGE_MESSAGES, o) && g) || d === n.id, v = (0, u.e7)([w.ZP, I.Z, M.Z], () => U.ZP.getName(l, o.id, n));
  return (0, i.jsxs)(b.Z, {
...
class Q extends r.PureComponent {
  ...
  componentDidUpdate(e) {
    a().isEqual(this.props.reaction, e.reaction) && this.props.reactionType === e.reactionType || this.setState({
      lastId: null,
      loadingMore: !1
    }, () => this.loadMore())
  }
  ...
  render() {
    ...
    return 0 === t.length && this.state.loadingMore ? l.push(length) : (l.push(t.length), e && l.push(1)), (0, i.jsxs)("div", {
      ...
      children: [o === _.O.BURST && (0, i.jsx)(Y, {
        emoji: n.emoji,
  ...
  constructor(...e) {
    super(...e), W(this, "scrollerRef", r.createRef()), W(this, "state", {
      lastId: null,
      loadingMore: !1
    }), W(this, "handleScroll", () => {
      let {
      ...
      }, "hasMore") : null : 0 === a.length && this.state.loadingMore ? (0, i.jsx)(h.$jN, {
        className: z.spinner
...
let ee = u.ZP.connectStores([N.Z], e => {
  let {
    ...
    reaction: n,
    reactionType: i
  } = e, r = N.Z.getReactions(t.getChannelId(), t.id, n.emoji, V.pTL, i);
  if (null == r) return {
    reactors: [],
    hasMore: !1
  };
...
function et(e) {
  let {
    ...
    onClose: s,
    transitionState: a,
    "aria-label": c = G.intl.string(G.t.gHp0Cw)
  } = e, p = (0, u.e7)([I.Z], () => I.Z.getChannel(t.getChannelId())), f = null == p ? void 0 : p.getGuildId(), m = (0, u.e7)([Z.Z, j.Z], () => {
    var e, n;
  ...
  }, [m, S]), E = (0, u.e7)([g.Z], () => g.Z.saturation), R = (0, u.e7)([C.Z], () => (0, d.wj)(C.Z.theme));
  if (r.useEffect(() => {
      (0 === m.length || null == S && null == x) && setImmediate(s)
    }, [s, m.length, x, S]), null == S || null == x) return (0, i.jsx)(h.$jN, {});
