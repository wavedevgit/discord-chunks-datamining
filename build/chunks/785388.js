...
function $(e) {
  let {
    ...
    onRemoveReactor: s,
    disableManage: c = !1
  } = e, d = (0, u.e7)([N.default], () => N.default.getId()), p = (0, u.e7)([k.default], () => k.default.getUser(n.id), [n]), g = (0, I.$R)(l), j = (0, u.e7)([M.Z], () => M.Z.can(G.Plq.MANAGE_MESSAGES, l) && g) || d === n.id, O = (0, u.e7)([w.ZP, C.Z, _.Z], () => U.ZP.getName(o, l.id, n));
  return (0, i.jsxs)(b.Z, {
