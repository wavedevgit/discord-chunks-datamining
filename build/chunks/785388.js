...
class q extends r.PureComponent {
  render() {
    let {
      ...
      reactionType: o,
      colors: s
    } = this.props, l = X(e), u = function(e, t, n, r) {
    ...
    }(e, 0, G.emoji, a()(G.emoji, G.emojiText)), d = o === x.O.BURST, p = d ? H.t.VmiNjY : H.t.cNfs19, m = H.intl.formatToPlainString(p, {
      name: l,
      n: t
    }), f = {}, g = {};
    if (d) {
...
function $(e) {
  let {
    ...
    onRemoveReactor: l,
    disableManage: c = !1
  } = e, d = (0, u.e7)([E.default], () => E.default.getId()), p = (0, u.e7)([k.default], () => k.default.getUser(n.id), [n]), g = (0, P.$R)(o), j = (0, u.e7)([A.Z], () => A.Z.can(V.Plq.MANAGE_MESSAGES, o) && g) || d === n.id, v = (0, u.e7)([N.ZP, I.Z, M.Z], () => U.ZP.getName(a, o.id, n));
  return (0, i.jsxs)(b.Z, {
...
function et(e) {
  ...
  }, [f, T]), P = (0, u.e7)([g.Z], () => g.Z.saturation), E = (0, u.e7)([R.Z], () => (0, d.wj)(R.Z.theme));
  if (r.useEffect(() => {
