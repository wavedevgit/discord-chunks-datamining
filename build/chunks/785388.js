...
let Y = e => {
  ...
  q = r.memo(function(e) {
    let {
    ...
    })(t, 0, H.emoji, l()(H.emoji, H.emojiText)), [t]), m = s === T.O.BURST, f = m ? G.t.VmiNjY : G.t.cNfs19, g = G.intl.formatToPlainString(f, {
      name: d,
      n: n
    }), b = r.useMemo(() => {
      let e = {};
      if (m) {
        ...
        o ? (e.background = null != (t = (0, c.wK)(l, a)) ? t : "", e.border = "1px solid ".concat(null != (n = (0, c.wK)(l, 1.1 * a)) ? n : "")) : (e.background = null != (i = (0, c.wK)(l, .025)) ? i : "", e.border = "1px solid ".concat(null != (r = (0, c.wK)(l, .05)) ? r : ""))
      }
      return e
    }, [m, u, o]), O = r.useMemo(() => {
      let e = {};
...
function $(e) {
  let {
    ...
    onRemoveReactor: s,
    disableManage: c = !1
  } = e, d = (0, u.e7)([R.default], () => R.default.getId()), p = (0, u.e7)([L.default], () => L.default.getUser(n.id), [n]), g = (0, E.$R)(o), O = (0, u.e7)([A.Z], () => A.Z.can(V.Plq.MANAGE_MESSAGES, o) && g) || d === n.id, j = (0, u.e7)([w.ZP, I.Z, M.Z], () => U.ZP.getName(l, o.id, n));
  return (0, i.jsxs)(b.Z, {
...
class Q extends r.PureComponent {
  ...
  render() {
    ...
    return 0 === t.length && this.state.loadingMore ? l.push(length) : (l.push(t.length), e && l.push(1)), (0, i.jsxs)("div", {
      ...
      children: [o === T.O.BURST && (0, i.jsx)(Y, {
        emoji: n.emoji,
...
function et(e) {
  ...
  } = e, p = (0, u.e7)([I.Z], () => I.Z.getChannel(t.getChannelId())), m = null == p ? void 0 : p.getGuildId(), f = (0, u.e7)([Z.Z, v.Z], () => {
    var e, n;
  ...
  }, [f, S]), E = (0, u.e7)([g.Z], () => g.Z.saturation), R = (0, u.e7)([C.Z], () => (0, d.wj)(C.Z.theme));
  if (r.useEffect(() => {
      (0 === f.length || null == S && null == _) && setImmediate(a)
    }, [a, f.length, _, S]), null == S || null == _) return (0, i.jsx)(h.$jN, {});
