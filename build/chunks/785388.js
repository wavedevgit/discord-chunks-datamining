...
function $(e) {
  let {
    ...
    onRemoveReactor: s,
    disableManage: c = !1
  } = e, d = (0, u.e7)([R.default], () => R.default.getId()), p = (0, u.e7)([L.default], () => L.default.getUser(n.id), [n]), g = (0, E.$R)(o), j = (0, u.e7)([A.Z], () => A.Z.can(V.Plq.MANAGE_MESSAGES, o) && g) || d === n.id, O = (0, u.e7)([w.ZP, I.Z, M.Z], () => U.ZP.getName(l, o.id, n));
  return (0, i.jsxs)(b.Z, {
...
function et(e) {
  ...
  }, [f, x]), E = (0, u.e7)([g.Z], () => g.Z.saturation), R = (0, u.e7)([C.Z], () => (0, d.wj)(C.Z.theme));
  if (r.useEffect(() => {
      (0 === f.length || null == x && null == _) && setImmediate(a)
    }, [a, f.length, _, x]), null == x || null == _) return (0, i.jsx)(h.$jN, {});
