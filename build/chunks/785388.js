...
let Y = e => {
  ...
  q = r.memo(function(e) {
    let {
    ...
    })(t, 0, G.emoji, o()(G.emoji, G.emojiText)), [t]), m = a === x.O.BURST, g = m ? H.t.VmiNjY : H.t.cNfs19, f = H.intl.formatToPlainString(g, {
      name: d,
      n: n
    }), b = r.useMemo(() => {
      let e = {};
      if (m) {
        ...
        l ? (e.background = null != (t = (0, c.wK)(o, s)) ? t : "", e.border = "1px solid ".concat(null != (n = (0, c.wK)(o, 1.1 * s)) ? n : "")) : (e.background = null != (i = (0, c.wK)(o, .025)) ? i : "", e.border = "1px solid ".concat(null != (r = (0, c.wK)(o, .05)) ? r : ""))
      }
      return e
    }, [m, u, l]), j = r.useMemo(() => {
      let e = {};
...
function $(e) {
  let {
    ...
    onRemoveReactor: a,
    disableManage: c = !1
  } = e, d = (0, u.e7)([R.default], () => R.default.getId()), p = (0, u.e7)([k.default], () => k.default.getUser(n.id), [n]), f = (0, E.$R)(l), j = (0, u.e7)([M.Z], () => M.Z.can(V.Plq.MANAGE_MESSAGES, l) && f) || d === n.id, v = (0, u.e7)([w.ZP, I.Z, _.Z], () => U.ZP.getName(o, l.id, n));
  return (0, i.jsxs)(b.Z, {
...
class Q extends r.PureComponent {
  ...
  render() {
    ...
    return 0 === t.length && this.state.loadingMore ? o.push(length) : (o.push(t.length), e && o.push(1)), (0, i.jsxs)("div", {
      ...
      children: [l === x.O.BURST && (0, i.jsx)(Y, {
        emoji: n.emoji,
...
let ee = u.ZP.connectStores([Z.Z], e => {
  let {
    ...
    reaction: n,
    reactionType: i
  } = e, r = Z.Z.getReactions(t.getChannelId(), t.id, n.emoji, V.pTL, i);
  if (null == r) return {
    reactors: [],
    hasMore: !1
  };
...
function et(e) {
  ...
  } = e, p = (0, u.e7)([I.Z], () => I.Z.getChannel(t.getChannelId())), m = null == p ? void 0 : p.getGuildId(), g = (0, u.e7)([A.Z, O.Z], () => {
    var e, n;
  ...
  }, [g, S]), E = (0, u.e7)([f.Z], () => f.Z.saturation), R = (0, u.e7)([N.Z], () => (0, d.wj)(N.Z.theme));
  if (r.useEffect(() => {
      (0 === g.length || null == S && null == P) && setImmediate(s)
    }, [s, g.length, P, S]), null == S || null == P) return (0, i.jsx)(h.$jN, {});
