...
let Y = e => {
    let {
      ...
      channelId: n,
      messageId: l
    } = e, [a, s] = o.useState(!0), [c, u] = o.useState([]), d = o.useMemo(() => {
  ...
  q = o.memo(function(e) {
    let {
      ...
      reactionType: s,
      colors: u
    } = e, d = o.useMemo(() => X(t), [t]), p = o.useMemo(() => (function(e, t, n, o) {
      let l = null == e.id ? U.ZP.getURL(e.name) : k.ZP.getEmojiURL({
        id: e.id,
        animated: e.animated,
        size: 24
      });
    ...
    })(t, 0, F.emoji, r()(F.emoji, F.emojiText)), [t]), m = s === T.O.BURST, f = m ? H.t.VmiNjY : H.t.cNfs19, g = H.intl.formatToPlainString(f, {
      name: d,
      n: n
    }), b = o.useMemo(() => {
      let e = {};
      if (m) {
        ...
        l ? (e.background = null != (t = (0, c.wK)(r, a)) ? t : "", e.border = "1px solid ".concat(null != (n = (0, c.wK)(r, 1.1 * a)) ? n : "")) : (e.background = null != (i = (0, c.wK)(r, .025)) ? i : "", e.border = "1px solid ".concat(null != (o = (0, c.wK)(r, .05)) ? o : ""))
      }
      return e
    }, [m, u, l]), j = o.useMemo(() => {
      let e = {};
...
function $(e) {
  let {
    ...
    onRemoveReactor: s,
    disableManage: c = !1
  } = e, d = (0, u.e7)([P.default], () => P.default.getId()), p = (0, u.e7)([L.default], () => L.default.getUser(n.id), [n]), g = (0, N.$R)(l), j = (0, u.e7)([M.Z], () => M.Z.can(G.Plq.MANAGE_MESSAGES, l) && g) || d === n.id, v = (0, u.e7)([Z.ZP, C.Z, _.Z], () => D.ZP.getName(r, l.id, n));
  return (0, i.jsxs)(b.Z, {
...
class Q extends o.PureComponent {
  ...
  render() {
    ...
    return 0 === t.length && this.state.loadingMore ? r.push(length) : (r.push(t.length), e && r.push(1)), (0, i.jsxs)("div", {
  ...
  constructor(...e) {
    super(...e), W(this, "scrollerRef", o.createRef()), W(this, "state", {
      lastId: null,
      loadingMore: !1
    }), W(this, "handleScroll", () => {
      let {
...
let ee = u.ZP.connectStores([w.Z], e => {
  let {
    ...
    reaction: n,
    reactionType: i
  } = e, o = w.Z.getReactions(t.getChannelId(), t.id, n.emoji, G.pTL, i);
  if (null == o) return {
    reactors: [],
    hasMore: !1
  };
...
function et(e) {
  ...
  } = e, p = (0, u.e7)([C.Z], () => C.Z.getChannel(t.getChannelId())), m = null == p ? void 0 : p.getGuildId(), f = (0, u.e7)([A.Z, O.Z], () => {
    var e, n;
  ...
  }, [f, E]), N = (0, u.e7)([g.Z], () => g.Z.saturation), P = (0, u.e7)([I.Z], () => (0, d.wj)(I.Z.theme));
  if (o.useEffect(() => {
      (0 === f.length || null == E && null == S) && setImmediate(a)
    }, [a, f.length, S, E]), null == E || null == S) return (0, i.jsx)(h.$jN, {});
