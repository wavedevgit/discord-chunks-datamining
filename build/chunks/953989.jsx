...
function m(e) {
  ...
  return <div className={n}>{<o.X6q variant={"heading-sm/semibold"} color={"header-primary"}>{d.intl.string(d.t.Fbjlu7)}</o.X6q>}{<ul className={u.outerContainer}>{m.map((e, t) => (0, r.jsx)("li", {
