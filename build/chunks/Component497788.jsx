...
let E = e => {
  ...
  }), x = l.useMemo(() => a.Z.getCategoryForProduct(n.rewardSkuId), [n.rewardSkuId]), y = (0, o.e7)([c.Z], () => c.Z.getPurchase(n.rewardSkuId)), {
    products: j
  } = ((e, t, n) => {
    let r = (0, h.Z)(),
      i = (0, o.e7)([a.Z], () => a.Z.products),
      s = l.useMemo(() => e ? [] : i.size > 0 ? r(t.rankedSkuIds).filter(e => e.skuId !== t.rewardSkuId || null != n) : [], [e, r, t.rankedSkuIds, i, n, t.rewardSkuId]),
      c = (0, d.a)()(s),
      u = (0, g.l)(c);
    return {
      products: (0, _.St)(u)
