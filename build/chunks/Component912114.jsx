...
let E = function(e) {
  let {
    ...
    location: E
  } = e, S = (0, s.e7)([g.Z], () => g.Z.getChannel(t)), P = null == S ? true : S.name, I = (0, m.cO)(S), [Z, N] = i.useState(null != P ? P : ""), [T, A] = i.useState(true), w = true !== T, {
    ...
    children: (0, r.jsx)("form", {
      onSubmit: e => {
        ...
        if (b.default.track(C.rMx.GDM_EDIT_INTERACTED, O(x({}, R), {
            action: "saved",
            new_name_set: "" !== Z,
            new_icon_set: (i ? T : null == S ? true : S.icon) != null,
            name_changed: r,
            icon_changed: i
          })), r || i) {
          let e = {};
          r && (e.name = Z), i && (e.icon = T), u.Z.updateChannel(t, e, E).catch(y.g6)
        }
        n()
      },
