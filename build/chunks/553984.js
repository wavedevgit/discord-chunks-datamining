...
function E(e) {
  let {
    hiddenFilters: t
  } = e, n = (0, u.fJ)(), l = (0, i.useRef)(null), [o, a] = (0, i.useState)(!1), [h, p] = (0, i.useState)(!1), g = (0, f.NV)(), {
    selectedFilter: y,
    setSelectedFilter: C
  } = (0, d.Z)();
...
function S(e) {
  let {
    className: t
  } = e, n = (0, u.fJ)(), l = y(), a = (0, i.useRef)(null), [h, C] = (0, i.useState)(!1), [v, j] = (0, i.useState)(!1), E = (0, f.NV)(), {
    selectedFilter: S,
    setSelectedFilter: I
    ...
    renderPopout: e => {
      ...
      return (0, r.jsx)(s.v2r, O(b({
        ...
        children: l.map(e => (0, r.jsx)(s.sNh, {
          id: e,
          action: () => {
            (e === S || e === f.V5.ALL) && S !== f.V5.ALL ? (I(f.V5.ALL), P(!1)) : I(e), (0, u.RZ)({
              section: e,
              enabled: S !== e,
              viewId: n
            })
