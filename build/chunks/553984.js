...
function b(e) {
  let {
    selectedFilter: t,
    setSelectedFilter: n
  } = e, l = d.by, s = g(), [a, c] = (0, i.useState)(m), u = s.filter(e => !a[e]);
  return (0, r.jsxs)("div", {
    className: h.filters,
    children: [(0, r.jsx)(o.njP, {
      ...
      selectedItem: t,
      className: h.tabBar,
      children: s.flatMap(e => (0, r.jsx)(o.njP.Item, {
        id: e,
        "aria-label": e,
        children: (0, r.jsx)(y, {
          setIsVisible: t => {
...
function O(e) {
  let {
    ...
    hiddenFilters: n,
    selectedFilter: l
  } = e, s = (0, i.useRef)(null), [c, u] = (0, i.useState)(!1), [g, m] = (0, i.useState)(!1), b = d.by;
  return 0 === n.length ? null : (0, r.jsx)(o.yRy, {
    position: "bottom",
    align: "left",
    shouldShow: c,
    targetElementRef: s,
    ...
    renderPopout: e => {
      ...
      return (0, r.jsx)(o.v2r, f(p({
        onSelect: () => {},
        navId: "notifications-sidebar-filters",
        "aria-label": "Notifications Sidebar Filters"
      }, s), {
        onClose: () => i(),
        children: n.map(e => (0, r.jsx)(o.sNh, {
          id: e,
          action: () => t(t => t === e ? d.V5.ALL : e),
          label: b[e],
          dontCloseOnAction: !0,
          icon: e === l ? (0, r.jsx)(o.dz2, {
            size: "sm"
          }) : void 0
        }, e))
      }))
    },
    children: e => (0, r.jsx)(o.P3F, f(p({}, e), {
