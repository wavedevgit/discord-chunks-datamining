    ...
    super(e), t = this, en(this, "textAreaRef", r.createRef()), en(this, "draftDidChange", function() {
      ...
      return 0 === t.length ? Promise.resolve({
        ...
        return (p.Z.sendMessage(n.id, I.ZP.parse(n, t), true, er(ei({}, s), {
          location: $.dy.OVERLAY
        })), this.setState((0, S.H2)()), (0, T.A6)(n.id), r) ? (f.Z.deactivateAllRegions(), {
          shouldClear: false,
          shouldRefocus: false
        }) : {
          shouldClear: true,
      ...
      children: (0, Chunk54381.jsxs)(Chunk473749.Fragment, {
        children: [!a && !Chunk430742 && (0, Chunk54381.jsx)(Chunk25007.Z, {
          ...
          children: (0, Chunk54381.jsx)("div", {
            className: l()(Chunk970980.messagesContainer, {
          ...
          children: Chunk823748 ? (0, Chunk54381.jsx)(Chunk518084.ZP.Background, {
            ...
            children: (0, Chunk54381.jsx)(Chunk518084.ZP.Background, {
              ...
              children: (0, Chunk54381.jsx)("div", {
                className: l()(Chunk970980.activateKeybind, Chunk970980.__invalid_mediumBackgroundOpacity),
...
function ec(e) {
  ...
  return null != l && null != p && Q.TPd.GUILD_THREADS_ONLY.has(l.type) ? (0, i.jsx)(b.Z, {}) : (0, i.jsx)(ea, ei({
    guild: p,
    channel: l,
    user: _,
    opacity: d,
