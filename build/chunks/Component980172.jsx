...
let J = Chunk837921.Ay.getEnableHardwareAcceleration() ? Chunk397927.JsQ : Chunk397927.euF;
...
function et(e) {
  ...
  let {
    className: o,
    user: l
  } = e, c = i.useRef(null), p = (0, A.Jz)(), _ = (0, v.g)(), h = (0, y.EC)(), m = null != (t = null == h || null == (a = h.nick) ? true : a[0]) ? t : null, [g, E] = i.useState(false);
  i.useEffect(() => {
    E(null != c.current && c.current.scrollWidth > c.current.clientWidth)
  }, [l.username]);
  let b = !l.isClaimed(),
    O = p && !l.hasUniqueUsername() && !l.hasVerifiedEmailOrPhone() || b,
    S = O ? z.intl.string(z.t["7Ngnyr"]) : true;
  return (0, r.jsxs)("div", {
    className: s()(q.ZZ, o),
...
function en(e) {
  ...
  let {
    user: a,
    className: o
  } = e, l = (0, y.EC)(), c = null != (t = null == l || null == (n = l.nick) ? true : n[0]) ? t : null, p = M.Ay.getGlobalName(a), _ = i.useRef(null), [h, m] = i.useState(false);
  return i.useEffect(() => {
...
function ea(e) {
  ...
  function p() {
    (0, f.qfG)(e => (0, r.jsx)(D.default, $(Z({}, e), {
      title: z.intl.string(z.t["3CTiKi"]),
      children: a.hasFlag(Y.nhx.MFA_SMS) ? z.intl.string(z.t.jrhJyo) : true,
...
function es(e) {
  ...
  }), a = G.Q_.useSetting(), s = i.useRef(null);
  return a && j.p5 ? (0, r.jsx)(f.YNO, {
    targetElementRef: s,
    renderPopout: e => {
      let {
        closePopout: t
...
function eo(e) {
  let {
    className: t
  } = e, n = (0, m.b8)(), a = (0, m.yM)(), o = !n || a, l = i.useMemo(() => n ? a ? z.intl.string(z.t.sK0dmH) : z.intl.string(z.t.XxRj7f) : z.intl.string(z.t.UX0Ode), [n, a]);
  return (0, r.jsxs)("div", {
    className: s()(q.ZZ, t),
    children: [(0, r.jsx)("div", {
      className: q.NQ,
