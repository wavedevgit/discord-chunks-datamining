...
function h(t) {
  ...
  let {
    ...
    successRedirect: f,
    platformType: p
  } = t, [j, k] = o.useState(""), [_, b] = o.useState(null), [g, S] = o.useState(!1), N = null != (n = null == (e = r.Z.get(p)) ? void 0 : e.name) ? n : d.intl.string(d.t["bU/GZm"]), v = async () => {
    S(!0), b(null);
    try {
      let t = await (0, c.H)(p, {
        location: x,
