...
class N extends(r = Chunk73800.Component) {
  ...
  render() {
    ...
    return <Chunk73800.Fragment>{module(T(v({
      ...
      })}{<Chunk481060.y5t forceLevel={2}>{this.renderLayer()}</Chunk481060.y5t>}</Chunk73800.Fragment>
  }
  renderLayer() {
    ...
    return Chunk40851 && !Chunk574254 ? null : <Chunk302901.mh layerContext={null != Chunk846519 ? Chunk846519 : Chunk314910.nz}><Chunk539907.j ref={this.layerRef} onMount={this.handlePopoutShow} onUnmount={this.handlePopoutHide} id={this.popoutId} targetRef={this.domElementRef} position={module} align={exports} nudgeAlignIntoViewport={require} useRawTargetDimensions={r} spacing={Chunk73800} autoInvert={Chunk97613} fixed={s} positionKey={null != Chunk867309 ? Chunk867309 : String(Chunk481060)} disablePointerEvents={Chunk374470} onPositionChange={this.handlePopoutPositionChange} clickTrap={Chunk952265}>{this.renderPopout}</Chunk539907.j></Chunk302901.mh>
  }
  toggleShow(e) {
...
O(N, "defaultProps", {
  ...
  spacing: 0,
  loadingComponent: <Chunk920676.x />
