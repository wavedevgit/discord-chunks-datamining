...
require("./73800.js");
var Chunk685072 = require("./685072.js"),
...
function g(e) {
  ...
  return <h tooltipText={f.intl.string(f.t.SMKyio)} onClick={() => {
...
function m(e) {
  ...
  return <h tooltipText={f.intl.string(f.t["6vrfgo"])} onClick={() => {
...
function b(e) {
  ...
  return t.isGuildStageVoice() ? <g channel={t} /> : <m channel={t} />
}