...
function h(e, t) {
  let n = function(e, t) {
    ...
    if (null == e.applicationId || !(0, l.Lt)(e.flags, d.pr7.SENT_BY_SOCIAL_LAYER_INTEGRATION) || !t.isDM() || e.author.id === o.default.getId() || null != e.activity || (0, l.Lt)(null != (n = t.recipientFlags) ? n : 0, r.o.DISMISSED_IN_GAME_MESSAGE_NUX) || f.has(t.id)) return null;
    let a = p(e, t.id);
    f.set(t.id, e.id);
  ...
  let h = function(e, t) {
    ...
    return null == h || a.A.wasClipSharedInChannel(h.id, t.id) ? null : (n = t.id, r = (0, u.Ay)({
      channelId: n,
      type: 66,
      content: "",
      author: e.author,
      state: d.cmJ.SENT
    }), (s = (0, c.rh)(r)).timestamp = e.timestamp, s.messageReference = {
      channel_id: n,
      message_id: e.id
    }, s)
  }(e, t);
