...
function A(e) {
  ...
  let $ = i.useCallback(e => {
    ...
    ee = (0, l.Z)(K);
  return null == z || "" === z ? <span{...v(y({}, J), {
    ref: $,
    className: a()("emoji", "emoji-text"),
    children: null != x ? x : p
  })} /> : <r.Fragment>{<u.aO channelId={g} messageId={b} emojiName={p} disable={false === Y || false === V} emojiRef={ee} />}{P ? <img{...v(y({}, J), {
      ref: $,
      src: z,
...
function C(e) {
  return null == e.emojiId && null == e.emojiName && null == e.src ? null : e.animated && true === e.shouldAnimate ? <N{...y({}, e)} /> : <A{...y({}, e)} />
}