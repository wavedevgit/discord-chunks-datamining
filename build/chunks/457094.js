...
let e6 = (0, m.l)(e => {
    ...
    return null != n && (0, K.h)(() => f.Z.open(n.section, n.subsection, {
  ...
  e9 = o.ZP.connectStores([Y.Z, eB.Z, eM.default], () => ({
    ...
    render() {
      ...
      if (null == n) return (0, r.jsx)(a.l_, {
        to: e1.Z5c.DEFAULT_LOGGED_OUT
      });
      if (e) {
        let e = tl(t);
        return null == e || (e.params.guildId === e1.ME || null != eV.Z.getGuild(e.params.guildId)) && null != eG.Z.getChannel(e.params.channelId) ? (0, r.jsx)(a.l_, {
          to: t
        }) : (0, r.jsx)(a.l_, {
          to: i
        })
  ...
  te = (0, m.l)((0, T.e)(j.Z, null, {
    passProps: !1
  })),
  tt = (0, T.e)(q.default, null, {
    passProps: !1
  }),
...
let ti = [{
  ...
  render: function(e) {
    ...
    return eX.Z.whenInitialized(() => {
      ...
      to: e1.Z5c.APPLICATION_LIBRARY
    })
  }
}, {
  path: [e1.Z5c.GUILD_CREATE],
  render: function() {
    return (0, K.h)(() => R.Z.openCreateGuildModal({
  ...
  render: function() {
    return (0, K.h)(() => f.Z.open(e1.oAB.INVENTORY)), (0, r.jsx)(a.l_, {
      to: eB.Z.defaultRoute
    })
  },
  isSessionRequired: !0
}, {
  path: [e1.Z5c.WELCOME(eE.Hw.guildId({
    optional: !0
  }), eE.Hw.channelId({
    optional: !0
  }))],
  render: function(e) {
    ...
    (0, eo.c)(e8.M5.MARKETING_UNCLAIMED);
  ...
  path: [e1.Z5c.GUILD_EVENT_DETAILS(eE.Hw.guildId({
    optional: !0
  }), ":guildEventId")],
  render: function(e) {
    let {
  ...
  path: [e1.Z5c.CHANNEL_THREAD_VIEW(eE.Hw.guildId(), eE.Hw.channelId(), ":threadId", ":messageId?"), e1.Z5c.CHANNEL(eE.Hw.guildId(), eE.Hw.channelId({
    optional: !0
  }), ":messageId?"), e1.Z5c.ACTIVITY, e1.Z5c.ACTIVITIES, e1.Z5c.ACTIVITIES_HAPPENING_NOW, e1.Z5c.ACTIVITY_DETAILS(":applicationId"), e1.Z5c.APPLICATION_LIBRARY, e1.Z5c.APPLICATION_STORE, e1.Z5c.MESSAGE_REQUESTS, e1.Z5c.COLLECTIBLES_SHOP, e1.Z5c.COLLECTIBLES_SHOP_FULLSCREEN, e1.Z5c.COLLECTIBLES_SHOP_PRODUCT_DETAIL(":skuId"), e1.Z5c.GUILD_DISCOVERY, e1.Z5c.QUEST_HOME, e1.Z5c.GLOBAL_DISCOVERY, e1.Z5c.GUILD_MEMBER_VERIFICATION(eE.Hw.guildId()), e1.Z5c.GUILD_MEMBER_VERIFICATION_FOR_HUB(eE.Hw.guildId(), ":inviteCode?"), e1.Z5c.GUILD_BOOSTING_MARKETING(eE.Hw.guildId()), e1.Z5c.FEATURE(":feature"), e1.Z5c.FAMILY_CENTER, e1.Z5c.NOTIFICATIONS_INBOX(eE.Hw.channelId({
    optional: !0
  }), ":messageId?")],
  render: te,
  isSessionRequired: !0,
...
class to extends i.PureComponent {
  componentDidMount() {
    e$.ZP.setZoomFactor(b.Z.zoom), ey.Z.init(), P.Z.initialize(), eh.Z.initialize(), H.Z.initialize(), ek.Z.initialize(), F.Z.initialize(), eg.Z.initialize(), k.Z.initialize(), er.Z.initialize(), _.Z.init(), W.Z.init(), z.Z.init(), es.Z.initialize(), v.Z.initialize(), G.Z.initialize(), em.Z.initialize(), I.ZP.initialize(), eD.Z.initialize(), ep.Z.initialize(), y.Z.initialize(), et.Z.init(), eq.Z.init(), eQ.Z.init(), O.Z.initialize(), eA.Z.init(), eK.Z.init(), eL.Z.init(), eN.Z.initialize(), eT.Z.initialize(), ex.Z.initialize(), ew.Z.init(), U.Z.initialize(), E.Z.initialize(), eI.Z.initialize(), eS.Z.initialize(), eu.Z.initialize(), ec.Z.initialize(), ed.Z.initialize(), x.Z.initialize(), L.Z.initialize(), V.Z.initialize(), en.Z.init({
      hasModalOpen: s.$sL,
    ...
    }), M.Z.init(), ei.Z.initialize(), eb.Z.initialize(), ef.Z.initialize(), D.Z.initialize(), A.Z.initialize(), Z.Z.initialize(), C.Z.initialize(), this.rewriterUnlisten = e_.Z.addRouteRewriter(this.ensureChannelMatchesGuild), this.historyUnlisten = e_.Z.addRouteChangeListener(this.handleHistoryChange)
  }
  componentWillUnmount() {
    ey.Z.terminate(), ek.Z.terminate(), eg.Z.terminate(), eh.Z.terminate(), P.Z.terminate(), I.ZP.terminate(), eD.Z.terminate(), y.Z.terminate(), em.Z.terminate(), ep.Z.terminate(), ex.Z.terminate(), O.Z.terminate(), U.Z.terminate(), ei.Z.terminate(), E.Z.terminate(), eb.Z.terminate(), eI.Z.terminate(), eS.Z.terminate(), eu.Z.terminate(), ec.Z.terminate(), ed.Z.terminate(), x.Z.terminate(), L.Z.terminate(), ef.Z.terminate(), D.Z.terminate(), B.Z.terminate(), A.Z.terminate(), Z.Z.terminate(), C.Z.terminate(), V.Z.terminate(), this.historyUnlisten(), this.rewriterUnlisten()
  }
  handleHistoryChange(e) {
    ...
    function(e, t) {
      ...
      let {
        ...
        messageId: o,
        threadId: s
      } = tr(n), c = (0, eE.Ss)(r), u = (0, eE.cq)(i), h = (0, eE.cq)(s), f = eW.Z.getGuildId(), g = f !== r;
        ...
        if (null != s && h) {
          ...
          if (null != i && null != s && e)
            if (t)(0, eO.dL)(e1.Z5c.CHANNEL(r, s, o));
              ...
              null != o && (e.initialMessageId = o), ev.Z.openThreadAsSidebar({
                guildId: r,
                baseChannelId: i,
                channelId: s,
                details: e
  ...
  ensureChannelMatchesGuild(e) {
    ...
    let {
      ...
      channelId: i,
      threadId: l
    } = tr(n), a = (0, eE.Ss)(r) && r !== e1.ME && r !== e1.I_8;
    if (null != i && (0, eE.cq)(i) && !(0, e3.AB)(i) && a) {
      let n = eG.Z.getChannel(i);
      if (null == n) ej.Z.loadThread(i).then(() => ta({
        channelId: i,
        guildId: r,
        pathname: t
      }));
      ...
      if (null != l) {
        ...
        if (null == n) ej.Z.loadThread(l).then(() => ta({
          channelId: l,
          guildId: r,
          pathname: t
        }));
        else if ((null == n ? void 0 : n.parent_id) !== i) return ev.Z.closeChannelSidebar(i), {
