...
let e7 = !1;
(0, I.D)(), a.ZP.initialize(), eO.Z.loadServer(), eQ.isPlatformEmbedded && (eJ.ZP.on("USER_SETTINGS_OPEN", (e, t) => {
...
let e9 = (0, m.l)(e => {
    ...
    return null != n && (0, z.h)(() => f.Z.open(n.section, n.subsection, {
  ...
  e6 = a.ZP.connectStores([F.Z, eG.Z, ek.default], () => ({
    ...
    render() {
      ...
      if (e) {
        let e = ti(t);
        return null == e || (e.params.guildId === e0.ME || null != eW.Z.getGuild(e.params.guildId)) && null != eU.Z.getChannel(e.params.channelId) ? (0, r.jsx)(o.l_, {
          to: t
        }) : (0, r.jsx)(o.l_, {
          to: i
        })
  ...
  e8 = (0, m.l)((0, S.e)(P.Z, null, {
    passProps: !1
  })),
  te = (0, S.e)(Y.default, null, {
    passProps: !1
  }),
...
let tr = [{
  ...
  render: function(e) {
    ...
    return (0, z.h)(() => (0, eA.openUserProfileModal)({
      userId: a,
      friendToken: i,
      sourceAnalyticsLocations: [C.Z.URI_SCHEME],
      analyticsLocation: {
  ...
  render: function() {
    return (0, z.h)(() => w.Z.openCreateGuildModal({
  ...
  render: function() {
    return (0, z.h)(() => f.Z.open(e0.oAB.INVENTORY)), (0, r.jsx)(o.l_, {
      to: eG.Z.defaultRoute
    })
  },
  isSessionRequired: !0
  ...
  render: function(e) {
    ...
    return (0, z.h)(() => {
      Q.Z.open(n, (0, J.Z)(e0.pNK, i), void 0, (0, J.Z)(e0.KsC, l))
    }), (0, r.jsx)(o.l_, {
      to: e0.Z5c.CHANNEL(n)
    })
  },
...
class to extends i.PureComponent {
  componentDidMount() {
    eJ.ZP.setZoomFactor(b.Z.zoom), eO.Z.init(), T.Z.initialize(), ep.Z.initialize(), W.Z.initialize(), eD.Z.initialize(), V.Z.initialize(), ef.Z.initialize(), D.Z.initialize(), en.Z.initialize(), _.Z.init(), H.Z.init(), B.Z.init(), ea.Z.initialize(), y.Z.initialize(), U.Z.initialize(), eg.Z.initialize(), v.ZP.initialize(), eR.Z.initialize(), ed.Z.initialize(), N.Z.initialize(), K.Z.init(), ee.Z.init(), eK.Z.init(), eX.Z.init(), O.Z.initialize(), ej.Z.init(), eY.Z.init(), ex.Z.init(), eC.Z.initialize(), eS.Z.initialize(), eZ.Z.initialize(), eL.Z.init(), M.Z.initialize(), E.Z.initialize(), eN.Z.initialize(), eI.Z.initialize(), ec.Z.initialize(), es.Z.initialize(), eu.Z.initialize(), Z.Z.initialize(), x.Z.initialize(), et.Z.init({
      hasModalOpen: s.$sL,
    ...
    }), k.Z.init(), er.Z.initialize(), em.Z.initialize(), eh.Z.initialize(), R.Z.initialize(), j.Z.initialize(), A.Z.initialize(), this.rewriterUnlisten = eb.Z.addRouteRewriter(this.ensureChannelMatchesGuild), this.historyUnlisten = eb.Z.addRouteChangeListener(this.handleHistoryChange)
  }
  componentWillUnmount() {
    eO.Z.terminate(), eD.Z.terminate(), ef.Z.terminate(), ep.Z.terminate(), T.Z.terminate(), v.ZP.terminate(), eR.Z.terminate(), N.Z.terminate(), eg.Z.terminate(), ed.Z.terminate(), eZ.Z.terminate(), O.Z.terminate(), M.Z.terminate(), er.Z.terminate(), E.Z.terminate(), em.Z.terminate(), eN.Z.terminate(), eI.Z.terminate(), ec.Z.terminate(), es.Z.terminate(), eu.Z.terminate(), Z.Z.terminate(), x.Z.terminate(), eh.Z.terminate(), R.Z.terminate(), G.Z.terminate(), j.Z.terminate(), A.Z.terminate(), this.historyUnlisten(), this.rewriterUnlisten()
  }
  handleHistoryChange(e) {
    ...
    function(e, t) {
      ...
      let {
        ...
        messageId: a,
        threadId: s
      } = tn(n), c = (0, e_.Ss)(r), u = (0, e_.cq)(i), h = (0, e_.cq)(s), f = eF.Z.getGuildId(), g = f !== r;
      if (c && g && d.Z.selectGuild(r), c && u) {
        ...
        if (null != s && h) {
          ...
          if (null != i && null != s && e) {
            if (t)(0, eE.dL)(e0.Z5c.CHANNEL(r, s, a));
            else {
              let e = {
                type: ey.Ff.THREAD
              };
              null != a && (e.initialMessageId = a), ev.Z.openThreadAsSidebar({
                guildId: r,
                baseChannelId: i,
                channelId: s,
                details: e
        ...
        } else null == i || o || ev.Z.closeChannelSidebar(i);
        ...
        } else(o && c || !g && !o) && ei.Z.closeSidebar()
      } else !tt.some(t => {
        var n;
  ...
  ensureChannelMatchesGuild(e) {
    ...
    let {
      ...
      channelId: i,
      threadId: l
    } = tn(n), o = (0, e_.Ss)(r) && r !== e0.ME && r !== e0.I_8;
    if (null != i && (0, e_.cq)(i) && !(0, e1.AB)(i) && o) {
