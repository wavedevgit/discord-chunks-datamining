...
let e4 = !1;
(0, S.D)(), o.ZP.initialize(), eO.Z.loadServer(), eX.isPlatformEmbedded && (eJ.ZP.on("USER_SETTINGS_OPEN", (e, t) => {
  eB.Z.getLayers().includes(e0.S9g.USER_SETTINGS) || f.Z.open(null != t ? t : e0.oAB.ACCOUNT)
...
let e6 = (0, m.l)(e => {
    ...
    return null != n && (0, Y.h)(() => f.Z.open(n.section, n.subsection, {
      ...
      children: [(0, r.jsx)(a.l_, {
        to: eG.Z.defaultRoute
      }), ";"]
    })
  }),
  e9 = o.ZP.connectStores([W.Z, eG.Z, ek.default], () => ({
    ...
    render() {
      ...
      if (null == n) return (0, r.jsx)(a.l_, {
        to: e0.Z5c.DEFAULT_LOGGED_OUT
      });
      if (e) {
        let e = ti(t);
        return null == e || (e.params.guildId === e0.ME || null != eV.Z.getGuild(e.params.guildId)) && null != eU.Z.getChannel(e.params.channelId) ? (0, r.jsx)(a.l_, {
          to: t
        }) : (0, r.jsx)(a.l_, {
          to: i
        })
...
let tr = [{
  ...
  render: function(e) {
    ...
    return (0, Y.h)(() => (0, eA.openUserProfileModal)({
      userId: o,
      friendToken: i,
      sourceAnalyticsLocations: [N.Z.URI_SCHEME],
      analyticsLocation: {
        section: e0.jXE.DIRECT_ROUTE_ACCESS
      }
    })), (0, r.jsx)(a.l_, {
      to: eG.Z.defaultRoute
    })
  ...
  render: function(e) {
    ...
    return eq.Z.whenInitialized(() => {
      ...
      to: e0.Z5c.APPLICATION_LIBRARY
    })
  }
}, {
  path: [e0.Z5c.GUILD_CREATE],
  render: function() {
    return (0, Y.h)(() => R.Z.openCreateGuildModal({
  ...
  render: function() {
    return (0, Y.h)(() => f.Z.open(e0.oAB.INVENTORY)), (0, r.jsx)(a.l_, {
      to: eG.Z.defaultRoute
    })
  },
  isSessionRequired: !0
}, {
  path: [e0.Z5c.WELCOME(e_.Hw.guildId({
    optional: !0
  }), e_.Hw.channelId({
    optional: !0
  }))],
  ...
  path: [e0.Z5c.GUILD_EVENT_DETAILS(e_.Hw.guildId({
    optional: !0
  }), ":guildEventId")],
  render: function(e) {
    let {
...
class ta extends i.PureComponent {
  componentDidMount() {
    eJ.ZP.setZoomFactor(b.Z.zoom), eO.Z.init(), P.Z.initialize(), ep.Z.initialize(), B.Z.initialize(), eD.Z.initialize(), H.Z.initialize(), ef.Z.initialize(), k.Z.initialize(), en.Z.initialize(), _.Z.init(), z.Z.init(), F.Z.init(), eo.Z.initialize(), v.Z.initialize(), G.Z.initialize(), eg.Z.initialize(), I.ZP.initialize(), eR.Z.initialize(), ed.Z.initialize(), y.Z.initialize(), ee.Z.init(), eK.Z.init(), eQ.Z.init(), O.Z.initialize(), ej.Z.init(), eY.Z.init(), ex.Z.init(), eS.Z.initialize(), eN.Z.initialize(), eZ.Z.initialize(), eL.Z.init(), U.Z.initialize(), E.Z.initialize(), ey.Z.initialize(), eC.Z.initialize(), ec.Z.initialize(), es.Z.initialize(), eu.Z.initialize(), x.Z.initialize(), L.Z.initialize(), et.Z.init({
      hasModalOpen: s.$sL,
    ...
    }), M.Z.init(), er.Z.initialize(), em.Z.initialize(), eh.Z.initialize(), D.Z.initialize(), A.Z.initialize(), Z.Z.initialize(), C.Z.initialize(), this.rewriterUnlisten = eb.Z.addRouteRewriter(this.ensureChannelMatchesGuild), this.historyUnlisten = eb.Z.addRouteChangeListener(this.handleHistoryChange)
  }
  componentWillUnmount() {
    eO.Z.terminate(), eD.Z.terminate(), ef.Z.terminate(), ep.Z.terminate(), P.Z.terminate(), I.ZP.terminate(), eR.Z.terminate(), y.Z.terminate(), eg.Z.terminate(), ed.Z.terminate(), eZ.Z.terminate(), O.Z.terminate(), U.Z.terminate(), er.Z.terminate(), E.Z.terminate(), em.Z.terminate(), ey.Z.terminate(), eC.Z.terminate(), ec.Z.terminate(), es.Z.terminate(), eu.Z.terminate(), x.Z.terminate(), L.Z.terminate(), eh.Z.terminate(), D.Z.terminate(), V.Z.terminate(), A.Z.terminate(), Z.Z.terminate(), C.Z.terminate(), this.historyUnlisten(), this.rewriterUnlisten()
  }
  handleHistoryChange(e) {
    ...
    ! function(e) {
      if (W.Z.isConnected() || W.Z.isTryingToConnect()) return;
    ...
    function(e, t) {
      ...
      let {
        ...
        messageId: o,
        threadId: s
      } = tn(n), c = (0, e_.Ss)(r), u = (0, e_.cq)(i), h = (0, e_.cq)(s), f = ez.Z.getGuildId(), g = f !== r;
      if (c && g && d.Z.selectGuild(r), c && u) {
        ...
        if (null != s && h) {
          ...
          if (null != i && null != s && e)
            if (t)(0, eE.dL)(e0.Z5c.CHANNEL(r, s, o));
              ...
              null != o && (e.initialMessageId = o), eI.Z.openThreadAsSidebar({
                guildId: r,
                baseChannelId: i,
                channelId: s,
                details: e
        ...
        } else null == i || a || eI.Z.closeChannelSidebar(i);
  ...
  ensureChannelMatchesGuild(e) {
    if (!W.Z.isConnected()) return null;
    let {
      pathname: t
    } = e, n = ti(t);
    ...
    let {
      ...
      channelId: i,
      threadId: l
    } = tn(n), a = (0, e_.Ss)(r) && r !== e0.ME && r !== e0.I_8;
    if (null != i && (0, e_.cq)(i) && !(0, e1.AB)(i) && a) {
      let n = eU.Z.getChannel(i);
      if (null == n) eP.Z.loadThread(i).then(() => tl({
        channelId: i,
        guildId: r,
        pathname: t
      }));
      ...
      if (null != l) {
        ...
        if (null == n) eP.Z.loadThread(l).then(() => tl({
          channelId: l,
          guildId: r,
          pathname: t
        }));
        else if ((null == n ? void 0 : n.parent_id) !== i) return eI.Z.closeChannelSidebar(i), {
