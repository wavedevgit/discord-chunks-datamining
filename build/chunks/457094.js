...
let e9 = (0, m.l)(e => {
  ...
  te = o.ZP.connectStores([K.Z, eH.Z, eG.default], () => ({
    ...
    render() {
      ...
      if (e) {
        let e = ta(t);
        return null == e || (e.params.guildId === e3.ME || null != eF.Z.getGuild(e.params.guildId)) && null != eB.Z.getChannel(e.params.channelId) ? (0, r.jsx)(a.l_, {
          to: t
        }) : (0, r.jsx)(a.l_, {
          to: i
        })
...
class ts extends i.PureComponent {
  componentDidMount() {
    e0.ZP.setZoomFactor(b.Z.zoom), ev.Z.init(), P.Z.initialize(), eg.Z.initialize(), F.Z.initialize(), eU.Z.initialize(), z.Z.initialize(), eb.Z.initialize(), M.Z.initialize(), ei.Z.initialize(), _.Z.init(), Y.Z.init(), W.Z.init(), eu.Z.initialize(), v.Z.initialize(), V.Z.initialize(), e_.Z.initialize(), I.ZP.initialize(), eM.Z.initialize(), ef.Z.initialize(), y.Z.initialize(), en.Z.init(), x.Z.init(), eJ.Z.init(), O.Z.initialize(), ex.Z.init(), eQ.Z.init(), eR.Z.init(), eP.Z.initialize(), ej.Z.initialize(), ew.Z.initialize(), eD.Z.init(), G.Z.initialize(), E.Z.initialize(), eC.Z.initialize(), eT.Z.initialize(), ep.Z.initialize(), ed.Z.initialize(), eh.Z.initialize(), L.Z.initialize(), w.Z.initialize(), H.Z.initialize(), er.Z.init({
      hasModalOpen: s.$sL,
    ...
    }), U.Z.init(), el.Z.initialize(), eE.Z.initialize(), em.Z.initialize(), k.Z.initialize(), A.Z.initialize(), Z.Z.initialize(), C.Z.initialize(), this.rewriterUnlisten = eO.Z.addRouteRewriter(this.ensureChannelMatchesGuild), this.historyUnlisten = eO.Z.addRouteChangeListener(this.handleHistoryChange)
  }
