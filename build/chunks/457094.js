...
let ti = [{
  ...
  path: [e1.Z5c.WELCOME(eO.Hw.guildId({
    optional: !0
  }), eO.Hw.channelId({
    optional: !0
  }))],
  ...
  path: [e1.Z5c.GUILD_EVENT_DETAILS(eO.Hw.guildId({
    optional: !0
  }), ":guildEventId")],
  render: function(e) {
    let {
  ...
  path: [e1.Z5c.CHANNEL_THREAD_VIEW(eO.Hw.guildId(), eO.Hw.channelId(), ":threadId", ":messageId?"), e1.Z5c.CHANNEL(eO.Hw.guildId(), eO.Hw.channelId({
    optional: !0
  }), ":messageId?"), e1.Z5c.ACTIVITY, e1.Z5c.ACTIVITIES, e1.Z5c.ACTIVITIES_HAPPENING_NOW, e1.Z5c.ACTIVITY_DETAILS(":applicationId"), e1.Z5c.APPLICATION_LIBRARY, e1.Z5c.APPLICATION_STORE, e1.Z5c.MESSAGE_REQUESTS, e1.Z5c.COLLECTIBLES_SHOP, e1.Z5c.COLLECTIBLES_SHOP_FULLSCREEN, e1.Z5c.COLLECTIBLES_SHOP_PRODUCT_DETAIL(":skuId"), e1.Z5c.GUILD_DISCOVERY, e1.Z5c.QUEST_HOME, e1.Z5c.GLOBAL_DISCOVERY, e1.Z5c.GUILD_MEMBER_VERIFICATION(eO.Hw.guildId()), e1.Z5c.GUILD_MEMBER_VERIFICATION_FOR_HUB(eO.Hw.guildId(), ":inviteCode?"), e1.Z5c.GUILD_BOOSTING_MARKETING(eO.Hw.guildId()), e1.Z5c.FEATURE(":feature"), e1.Z5c.FAMILY_CENTER, e1.Z5c.NOTIFICATIONS_INBOX(eO.Hw.channelId({
    optional: !0
  }), ":messageId?")],
  render: te,
  isSessionRequired: !0,
...
class to extends i.PureComponent {
  componentDidMount() {
    e$.ZP.setZoomFactor(b.Z.zoom), eI.Z.init(), P.Z.initialize(), ef.Z.initialize(), F.Z.initialize(), eM.Z.initialize(), z.Z.initialize(), em.Z.initialize(), M.Z.initialize(), ei.Z.initialize(), _.Z.init(), Y.Z.init(), W.Z.init(), ec.Z.initialize(), v.Z.initialize(), B.Z.initialize(), eb.Z.initialize(), I.ZP.initialize(), ek.Z.initialize(), eh.Z.initialize(), y.Z.initialize(), en.Z.init(), x.Z.init(), eX.Z.init(), O.Z.initialize(), eZ.Z.init(), eq.Z.init(), eL.Z.init(), eT.Z.initialize(), eP.Z.initialize(), ew.Z.initialize(), eR.Z.init(), G.Z.initialize(), E.Z.initialize(), ev.Z.initialize(), eN.Z.initialize(), ed.Z.initialize(), eu.Z.initialize(), ep.Z.initialize(), w.Z.initialize(), L.Z.initialize(), H.Z.initialize(), er.Z.init({
      hasModalOpen: s.$sL,
  ...
  handleHistoryChange(e) {
    ...
    function(e, t) {
      ...
      let {
        ...
        messageId: o,
        threadId: s
      } = tr(n), c = (0, eO.Ss)(r), u = (0, eO.cq)(i), h = (0, eO.cq)(s), f = eY.Z.getGuildId(), g = f !== r;
  ...
  ensureChannelMatchesGuild(e) {
    ...
    let {
      ...
      channelId: i,
      threadId: l
    } = tr(n), a = (0, eO.Ss)(r) && r !== e1.ME && r !== e1.I_8;
