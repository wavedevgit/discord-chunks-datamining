...
let e7 = !1;
(0, S.DL)(), o.ZP.initialize(), eI.Z.loadServer(), eJ.isPlatformEmbedded && (e$.ZP.on("USER_SETTINGS_OPEN", (e, t) => {
...
let e6 = (0, m.l)(e => {
  ...
  e9 = o.ZP.connectStores([K.Z, eV.Z, eU.default], () => ({
    ...
    render() {
      ...
      if (e) {
        let e = tl(t);
        return null == e || (e.params.guildId === e1.ME || null != eH.Z.getGuild(e.params.guildId)) && null != eB.Z.getChannel(e.params.channelId) ? (0, r.jsx)(a.l_, {
          to: t
        }) : (0, r.jsx)(a.l_, {
          to: i
        })
...
let ti = [{
  ...
  render: function() {
    return (0, q.h)(() => f.Z.open(e1.oAB.INVENTORY)), (0, r.jsx)(a.l_, {
      to: eV.Z.defaultRoute
    })
  },
  isSessionRequired: !0
  ...
  path: [e1.Z5c.CHANNEL_THREAD_VIEW(eE.Hw.guildId(), eE.Hw.channelId(), ":threadId", ":messageId?"), e1.Z5c.CHANNEL(eE.Hw.guildId(), eE.Hw.channelId({
    optional: !0
  }), ":messageId?"), e1.Z5c.ACTIVITY, e1.Z5c.ACTIVITIES, e1.Z5c.ACTIVITIES_HAPPENING_NOW, e1.Z5c.ACTIVITY_DETAILS(":applicationId"), e1.Z5c.APPLICATION_LIBRARY, e1.Z5c.APPLICATION_STORE, e1.Z5c.MESSAGE_REQUESTS, e1.Z5c.COLLECTIBLES_SHOP, e1.Z5c.COLLECTIBLES_SHOP_FULLSCREEN, e1.Z5c.COLLECTIBLES_SHOP_PRODUCT_DETAIL(":skuId"), e1.Z5c.GUILD_DISCOVERY, e1.Z5c.QUEST_HOME, e1.Z5c.GLOBAL_DISCOVERY, e1.Z5c.GUILD_MEMBER_VERIFICATION(eE.Hw.guildId()), e1.Z5c.GUILD_MEMBER_VERIFICATION_FOR_HUB(eE.Hw.guildId(), ":inviteCode?"), e1.Z5c.GUILD_BOOSTING_MARKETING(eE.Hw.guildId()), e1.Z5c.GUILD_FEATURE(":feature", eE.Hw.guildId()), e1.Z5c.FEATURE(":feature"), e1.Z5c.FAMILY_CENTER, e1.Z5c.NOTIFICATIONS_INBOX(eE.Hw.channelId({
    optional: !0
  }), ":messageId?")],
  render: te,
  isSessionRequired: !0,
...
class to extends i.PureComponent {
  componentDidMount() {
    e$.ZP.setZoomFactor(b.Z.zoom), eI.Z.init(), P.Z.initialize(), ef.Z.initialize(), F.Z.initialize(), eM.Z.initialize(), z.Z.initialize(), em.Z.initialize(), M.Z.initialize(), ei.Z.initialize(), _.Z.init(), Y.Z.init(), W.Z.init(), ec.Z.initialize(), v.Z.initialize(), B.Z.initialize(), eb.Z.initialize(), I.ZP.initialize(), ek.Z.initialize(), eh.Z.initialize(), y.Z.initialize(), en.Z.init(), x.Z.init(), eQ.Z.init(), E.Z.initialize(), eZ.Z.init(), eq.Z.init(), eL.Z.init(), eT.Z.initialize(), eP.Z.initialize(), ew.Z.initialize(), eR.Z.init(), G.Z.initialize(), O.Z.initialize(), ev.Z.initialize(), eN.Z.initialize(), ed.Z.initialize(), eu.Z.initialize(), ep.Z.initialize(), w.Z.initialize(), L.Z.initialize(), H.Z.initialize(), er.Z.init({
      hasModalOpen: s.$sL,
    ...
    }), U.Z.init(), el.Z.initialize(), e_.Z.initialize(), eg.Z.initialize(), k.Z.initialize(), A.Z.initialize(), Z.Z.initialize(), C.Z.initialize(), this.rewriterUnlisten = eO.Z.addRouteRewriter(this.ensureChannelMatchesGuild), this.historyUnlisten = eO.Z.addRouteChangeListener(this.handleHistoryChange)
  }
  componentWillUnmount() {
    eI.Z.terminate(), eM.Z.terminate(), em.Z.terminate(), ef.Z.terminate(), P.Z.terminate(), I.ZP.terminate(), ek.Z.terminate(), y.Z.terminate(), eb.Z.terminate(), eh.Z.terminate(), ew.Z.terminate(), E.Z.terminate(), G.Z.terminate(), el.Z.terminate(), O.Z.terminate(), e_.Z.terminate(), ev.Z.terminate(), eN.Z.terminate(), ed.Z.terminate(), eu.Z.terminate(), ep.Z.terminate(), w.Z.terminate(), L.Z.terminate(), eg.Z.terminate(), k.Z.terminate(), V.Z.terminate(), A.Z.terminate(), Z.Z.terminate(), C.Z.terminate(), H.Z.terminate(), this.historyUnlisten(), this.rewriterUnlisten()
  }
  handleHistoryChange(e) {
    ...
    function(e, t) {
      ...
      let {
        ...
        messageId: o,
        threadId: s
      } = tr(n), c = (0, eE.Ss)(r), u = (0, eE.cq)(i), h = (0, eE.cq)(s), f = eY.Z.getGuildId(), g = f !== r;
  ...
  ensureChannelMatchesGuild(e) {
    ...
    if (null != i && (0, eE.cq)(i) && !(0, e3.AB)(i) && a) {
      ...
      if (null == n) eA.Z.loadThread(i).then(() => ta({
        channelId: i,
        guildId: r,
        pathname: t
      }));
      ...
      if (null != l) {
        ...
        if (null == n) eA.Z.loadThread(l).then(() => ta({
          channelId: l,
          guildId: r,
          pathname: t
        }));
        else if ((null == n ? void 0 : n.parent_id) !== i) return eC.Z.closeChannelSidebar(i), {
