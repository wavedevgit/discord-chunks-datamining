...
let e8 = [{
  ...
  render: function(e) {
    ...
    return null != n && (0, F.h)(() => g.Z.open(n.section, n.subsection, {
  ...
  render: function() {
    return (0, F.h)(() => g.Z.open(eJ.oAB.INVENTORY)), (0, r.jsx)(o.l_, {
      to: eM.Z.defaultRoute
    })
  },
  isSessionRequired: !0
...
class tn extends i.PureComponent {
  componentDidMount() {
    ...
    }), D.Z.init(), et.Z.initialize(), eg.Z.initialize(), ed.Z.initialize(), w.Z.initialize(), P.Z.initialize(), j.Z.initialize(), this.rewriterUnlisten = ef.Z.addRouteRewriter(this.ensureChannelMatchesGuild), this.historyUnlisten = ef.Z.addRouteChangeListener(this.handleHistoryChange)
  }
  ...
  handleHistoryChange(e) {
    ...
    function(e, t) {
      ...
      let {
        ...
        messageId: a,
        threadId: s
      } = e6(n), c = (0, em.Ss)(r), u = (0, em.cq)(i), h = (0, em.cq)(s), g = eB.Z.getGuildId(), f = g !== r;
