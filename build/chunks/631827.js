...
function r(e, t) {
  ...
  return s(d = null != t.bucketPredicates && t.bucketPredicates.length > 0 ? f >= p.length ? o(p, null != (l = t.bucketPredicates) ? l : []) : a(p, null != (c = t.bucketPredicates) ? c : [], f) : [p], null != (u = t.sortComparers) ? u : [], f).slice(0, f)
}
