...
function g(e) {
  let {
    position: t,
    onChange: n
  } = e, [o] = r.useState(() => "notification-position-selector-".concat(h++)), g = t === s._vf.DISABLED ? c.intl.string(c.t.R6LxVf) : c.intl.formatToPlainString(c.t["XXHDM/"], {
    position: p(t)
  });
  return (0, i.jsxs)("div", {
    children: [(0, i.jsx)(a.tEY, {
      ...
      children: (0, i.jsx)("div", {
        ...
        children: f.map(e => (0, i.jsxs)("label", {
          ...
          children: [p(e), e === s._vf.DISABLED ? (0, i.jsx)(a.t6m, {
            size: "md",
            color: "currentColor",
