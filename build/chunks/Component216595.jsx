...
function A(e) {
  let {
    channel: t
  } = e, r = (0, o.bG)([p.A], () => p.A.getGuild(t.guild_id));
  return null != r ? (0, n.jsx)(f.A, {
    className: S.Kk,
    guild: r,
    size: f.A.Sizes.SMALLER,
    "aria-hidden": true
...
function y(e) {
  let {
    channel: t
  } = e, r = (0, o.bG)([p.A], () => p.A.getGuild(t.guild_id)), l = (0, u.Ay)(t, false), s = (0, d.gU)(t, r), a = t.isPrivate() || null == s, i = t.isDM() ? g.intl.formatToPlainString(g.t.smD7XV, {
    username: l
  }) : l;
  return (0, n.jsxs)("div", {
    className: S.yP,
