...
class p extends(r = Chunk73800.PureComponent) {
  ...
  renderIcon() {
    return this.props.icon ? <div className={Chunk436980.iconContainer}><Chunk481060.gj8 size={"xs"} color={"currentColor"} colorClass={Chunk436980.foreground} className={Chunk436980.icon} /></div> : null
  }
  render() {
    let {
      className: e
    } = this.props;
    return <div className={s()(module, Chunk436980.container)} ref={e => {
        this._ref = e
      }}>{this.renderIcon()}{this.renderUsers()}</div>
  }
  constructor(...e) {
    super(...e), f(this, "_ref", true), f(this, "defaultRenderUser", (e, t, n, r) => {
      ...
      return null == _ ? <div className={s()(u.emptyUser, t)} /> : <l.qEK tabIndex={0} src={_.getAvatarURL(f, (0, l.pxk)(a))} size={a} aria-label={_.username} className={s()(t, d.cursorPointer, u.avatarSize)} onClick={e => null != o ? o(e, _, this._ref) : null} />
    })
  }
}
f(p, "defaultProps", {
