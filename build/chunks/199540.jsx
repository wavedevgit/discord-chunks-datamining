...
function g(e) {
  ...
  return null == i ? <div className={o()(f.folderPreviewGuildIcon, f.folderPreviewGuildIconError)}><a.Mgn color={"currentColor"} /></div> : <u.Z guild={i} animate={n} size={u.Z.Sizes.MINI} iconSize={l} lossless={true} className={f.folderPreviewGuildIcon} tabIndex={false} />
}
...
function m(e) {
  let {
    ...
    children: l
  } = t, s = n && i, c = <div className={f.folderIconWrapper}><div className={f.folderIcon}><a.ROc size={"sm"} color={"currentColor"} /></div></div>, u = <div className={f.folderPreviewWrapper}><div className={f.folderPreview}>{l.slice(0, 4).map(e => (0, r.jsx)(g, {
        guildId: e.id,
        animate: n
      }, e.id))}</div></div>;
...
function b(e) {
  ...
  return <a.tEY><a.P3F{...t = function(e) {
