...
let x = (e, t) => g.ZP.getName(e.getGuildId(), e.id, t.user),
  O = function(e) {
    ...
    } = e, O = (0, u.J)(n.guild_id), v = i.useCallback(() => {
      O ? (0, d.hk)(n.guild_id, () => s.default.selectVoiceChannel(n.id)) : s.default.selectVoiceChannel(n.id)
    }, [n.id, n.guild_id, O]), j = t.filter(e => e.type === m.Ui.VOICE), C = 4 === j.length ? 2 : 3, I = (0, l.Wu)([o.Z], () => j.map(e => o.Z.getParticipant(n.id, e.id)).filter(f.lm), [n.id, j]);
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(h.Z, {}), (0, r.jsx)("div", {
        ...
        children: (0, r.jsx)(a.Text, {
          ...
          children: 0 === j.length ? _.intl.string(_.t.FUVhyC) : 1 === j.length ? _.intl.formatToPlainString(_.t.EQwZlN, {
            a: x(n, j[0])
          }) : 2 === j.length ? _.intl.formatToPlainString(_.t.zBcKoA, {
            a: x(n, j[0]),
            b: x(n, j[1])
          }) : j.length > 2 ? _.intl.formatToPlainString(_.t["3AqFaG"], {
            a: x(n, j[0]),
            b: x(n, j[1]),
            n: j.length - 2
          }) : true
