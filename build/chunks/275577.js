/** Chunk was on 33622 **/
/** chunk id: 275577, original params: e,a,t (module,exports,require) **/
require.d(exports, {
  o: () => c
});
...
function s(e) {
  let a = r.findIndex(([a, t, u]) => !!(e.year < a) || e.year === a && !!(e.month < t) || e.year === a && e.month === t && !!(e.day < u));
  return false === a ? r.length - 1 : 0 === a ? 0 : a - 1
}
...
class c extends Chunk274738.IQ {
  fromJulianDay(e) {
  ...
  constrainDate(e) {
    ...
    if (null != t) {
      let [u, n, r] = t, i = u - o[a];
      e.year = Math.max(1, Math.min(i, e.year)), e.year === i && (e.month = Math.min(n, e.month), e.month === n && (e.day = Math.min(r, e.day)))
    }
    if (1 === e.year && a >= 0) {
      let [, t, u] = r[a];
