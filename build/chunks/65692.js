...
function g(e) {
  let {
    userId: t
  } = e, n = (0, s.e7)([o.default], () => o.default.getId());
  u()(n !== t, "[useSecureFramesPairwiseFingerprint] Should not pass current user id.");
  let [i, g] = r.useState(null), [_, y] = r.useState(!1), m = (0, s.e7)([d.Z], () => d.Z.getSecureFramesRosterMapEntry(t)), S = (0, s.e7)([d.Z], () => d.Z.getSecureFramesRosterMapEntry(n)), h = r.useCallback(e => {
    g(l.fromByteArray(e)), y(!1)
  }, []), p = r.useCallback(async (e, t, n, r) => {
    if (c.Z.supports(E.AN.MLS_PAIRWISE_FINGERPRINTS)) {
      var l;
      null == (l = d.Z.getRTCConnection()) || l.getMLSPairwiseFingerprint(f.Xj, n, e => {
        h(new Uint8Array(e))
      })
