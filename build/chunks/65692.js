...
function g(e) {
  let {
    userId: t
  } = e, n = (0, a.e7)([c.default], () => c.default.getId());
  u()(n !== t, "[useSecureFramesPairwiseFingerprint] Should not pass current user id.");
  let [i, g] = r.useState(null), [_, y] = r.useState(!1), m = (0, a.e7)([d.Z], () => d.Z.getSecureFramesRosterMapEntry(t)), S = (0, a.e7)([d.Z], () => d.Z.getSecureFramesRosterMapEntry(n)), h = r.useCallback(e => {
