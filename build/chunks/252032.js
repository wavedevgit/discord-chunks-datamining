...
function C(e) {
  let {
    ...
    id: u
  } = n, h = t.getGuildId(), g = (0, a.e7)([_.Z], () => _.Z.getGuild(h), [h]), E = t.type === y.d4z.GUILD_ANNOUNCEMENT, I = null != g && g.features.has(y.oNc.NEWS), S = E && I, {
    editingMessage: C,
    editingTextValue: R,
    editingRichValue: P
  } = (0, a.cj)([f.Z], () => ({
  ...
  }), [c]), D = (0, a.e7)([d.default], () => d.default.getId()), L = i.useCallback((e, r, i) => {
    let {
      content: a
  ...
  }, [C, S, D, t, n]), x = i.useCallback(e => (0, i.createElement)(w, A(T({}, e), {
    className: v.channelTextArea,
    key: u
  })), [u]);
  return null != R && null != P ? (0, r.jsx)(b.Z, {
    ref: void 0,
    channel: t,
    message: n,
    textValue: R,
...
function w(e) {
  ...
  } = e, [_, p] = i.useState(!0), m = i.useCallback(() => p(!0), []), g = i.useCallback(() => p(!1), []);
