...
function p(e) {
  ...
  let {
    ...
    return null != i ? <i size={"custom"} color={"currentColor"} width={t} height={t} /> : null
  }, y = e => <span className={_.label}>{e.label}</span>, O = i.useMemo(() => (0, u.tx)(e.defaultValues, null == g ? true : g.id, n), [e.defaultValues, g, n]);
  return <d.ZP selectActionComponent={e} queryOptions={E} renderIcon={b} renderOptionLabel={y} defaultValues={O} />
}