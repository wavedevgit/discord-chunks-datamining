...
let P = function(e) {
  let {
    ...
    toggleSidebar: E,
    hideSidebar: S = !1
  } = e, j = l.useRef(null), P = l.useRef(null), _ = (0, g.Z)(i), N = (0, p.Yzy)(S, {
    from: {
      position: "absolute",
      opacity: 0
    },
  ...
  }, "animate-always"), w = l.useCallback(e => {
    j.current = e, null != h && (h.current = e)
  }, [h]);
  l.useLayoutEffect(() => {
    null != j.current && _ !== i && j.current.scrollTo({
      to: 0
    })
  }, [i, _, j]);
  let T = (0, s.jsx)(C, {
  ...
  function D() {
    return null == r ? null : (0, s.jsx)(p.oXn, {
      className: a()(v.noticeRegion, {
        [v.noticeRegionHiddenSidebar]: S
      }),
      children: r
    }, i)
  }
  return (0, s.jsx)(s.Fragment, {
    children: N((e, r) => (0, s.jsxs)(c.animated.div, {
      style: e,
