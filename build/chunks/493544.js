...
let C = function(e) {
  let {
    ...
    toggleSidebar: E,
    hideSidebar: j = !1
  } = e, S = l.useRef(null), C = l.useRef(null), _ = (0, g.Z)(i), w = (0, p.Yzy)(j, {
    from: {
      position: "absolute",
      opacity: 0
    },
  ...
  l.useLayoutEffect(() => {
    null != S.current && _ !== i && S.current.scrollTo({
      to: 0
    })
  }, [i, _, S]);
  let T = (0, s.jsx)(P, {
  ...
  return (0, s.jsx)(s.Fragment, {
    children: w((e, r) => (0, s.jsxs)(c.animated.div, {
      ...
      children: [!r && (null == t ? null : (0, s.jsx)(p.f6W, {
        ...
        if ("custom" === v) return (0, s.jsxs)(f.W, {
          component: "div",
          className: m.contentRegion,
          children: [t, n, !d.tq && T, D()]
        });
        if ("scrollableCustom" === v) return (0, s.jsxs)(f.W, {
          component: "div",
          className: m.contentRegion,
