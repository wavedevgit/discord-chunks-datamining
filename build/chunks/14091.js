...
class W extends s.PureComponent {
  ...
  constructor(...e) {
    super(...e), D(this, "scrollerRef", s.createRef()), D(this, "scrollTo", (e, t, r) => {
      ...
      h.QY(e, !t)
    }), D(this, "renderFooter", () => this.props.isFeedbackVisible ? (0, n.jsx)(k.Z, {
      searchId: this.props.searchId,
      searchType: this.props.searchType,
      dismissFeedbackEntrypoint: this.props.dismissFeedbackEntrypoint
    }) : null), D(this, "renderHeader", () => {
      let {
        searchId: e,
        searchMode: t,
        search: {
      ...
      return (0, n.jsxs)(U, {
        children: [(0, n.jsx)(N.Z, {}), (0, n.jsx)("div", {
      ...
      let {
        showNoResultsAlt: e
      } = this.props.search, t = e ? w.intl.string(w.t["VrK/2d"]) : w.intl.string(w.t.V6nAfH);
      return (0, n.jsxs)(U, {
        children: [(0, n.jsx)("div", {
      ...
      return u ? this.renderError() : c ? this.renderIndexing() : o ? null : i > 0 ? (0, n.jsx)(Z.Z, {
        search: s,
        searchResults: e,
...
function G(e) {
  let {
  ...
  } = e, i = (0, c.cj)([x.Z], () => x.Z.getResultsState(t), [t]), o = (0, R.k)(t), u = (0, c.e7)([x.Z], () => x.Z.getAnalyticsId(t)), {
    searchResults: d,
    ignoreCount: p,
    blockCount: f
  } = (0, T.Z)(t), {
    ...
    let r = H(t);
    h.oO(t, e, r)
  }, [t, i.isSearching]), b = s.useDeferredValue(d), E = s.useDeferredValue(i);
...
function Q(e) {
  ...
  s.useEffect(() => {
    ...
    c && (u || t !== a.current && (a.current = t, f.Z.possiblyShowFeedbackModal(L.nw.SEARCH_RESULTS, () => o(!0), () => o(!1))))
  }, [c, u, t]);
  let d = s.useCallback(() => {
    o(!1)
  }, []);
  return l && t === M.aib.DMS ? (0, n.jsx)(q, {
    theme: r,
    isFeedbackVisible: i,
