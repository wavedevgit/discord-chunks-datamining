...
class B extends i.PureComponent {
  ...
  constructor(...e) {
    super(...e), k(this, "state", {
      ...
      p.QY(e, !t)
    }), k(this, "renderFooter", () => this.props.isFeedbackVisible ? (0, r.jsx)(N.Z, {
      dismissFeedbackEntrypoint: this.props.dismissFeedbackEntrypoint
    }) : null), k(this, "renderHeader", () => {
      let {
        searchMode: e
      } = this.state, {
        totalResults: t,
...
function F(e) {
  ...
  } = e, a = (0, c.cj)([C.Z], () => C.Z.getResultsState(t), [t]), {
    searchAnalyticsId: o,
    searchType: s
  } = (0, c.cj)([C.Z], () => ({
...
function G(e) {
  let {
    ...
    type: T.aib.DMS
  }), []), o = (0, b.WJ)(a), s = (0, c.e7)([C.Z], () => C.Z.getSearchResultsQueryString(o)), u = (0, b.jj)(a, w.sR.MESSAGES, s), d = (0, c.cj)([g.Z], () => {
    var e, t, n, r;
    return {
...
function H(e) {
  ...
  return l && t === T.aib.DMS ? (0, r.jsx)(G, {
    theme: n,
    isFeedbackVisible: o,
