...
function B(e) {
  ...
  }), o = (0, R.k)(t), u = (0, c.e7)([x.Z], () => x.Z.getAnalyticsId(t)), {
    searchResults: h,
    ignoreCount: d,
    blockCount: p
  } = (0, A.Z)(t), {
...
function q(e) {
  ...
  s.useEffect(() => {
    ...
    c && (u || t !== a.current && (a.current = t, p.Z.possiblyShowFeedbackModal(k.nw.SEARCH_RESULTS, () => o(!0), () => o(!1))))
  }, [c, u, t]);
  let h = s.useCallback(() => {
    o(!1)
  }, []);
