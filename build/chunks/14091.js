...
class A extends s.Component {
  ...
  constructor(...e) {
    var t, n, r;
    super(...e), t = this, n = "autoAnalytics", r = function() {
...
function F(e) {
  ...
  let {
    showNoResultsAlt: y
  } = l, x = y ? k.intl.string(k.t["VrK/2d"]) : k.intl.string(k.t.V6nAfH);
  return (0, r.jsxs)(M, {
    children: [(0, r.jsx)("div", {
...
let L = s.memo(function(e) {
  ...
  s.useEffect(() => (f.S.subscribe(T.CkL.SEARCH_RESULTS_CLOSE, v), () => {
...
function B(e) {
  let {
    ...
    return s.useEffect(() => {
      ...
      l && (a || e !== t.current && (t.current = e, h.Z.possiblyShowFeedbackModal(N.nw.SEARCH_RESULTS, () => r(!0), () => r(!1))))
    }, [l, a, e]), {
    ...
    null != r && null != s && (n && t.type === T.aib.DMS ? _.Z.fetchCrossDMMessages({
      searchContext: t,
      selectedPageIndex: 0,
    ...
    if (null != r && null != s)
      ...
      } else _.Z.fetchMessages({
        searchId: i,
        queryString: r,
        searchQuery: s,
        offset: e * T.vpv
      })
  }, [n, o.isSearching, t, i, j]), E = s.useDeferredValue(p), P = s.useDeferredValue(o), k = s.useDeferredValue(u);
