...
class Z extends i.Component {
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, j(this, "autoAnalytics", function() {
      ...
      let n = 0,
        ...
        i = 0,
        a = 0;
      null != t.props.searchResults && l()(t.props.searchResults).flatten().filter(e => e.isSearchHit).forEach(e => {
...
function H(e) {
  ...
  let {
    showNoResultsAlt: v
  } = a, I = v ? x.intl.string(x.t["VrK/2d"]) : x.intl.string(x.t.V6nAfH);
  return (0, r.jsxs)(F, {
    children: [(0, r.jsx)("div", {
      className: o()(k.noResultsImage, {
        [k.alt]: v
      })
    }), (0, r.jsx)("div", {
      className: o()(k.emptyResultsText, k.noResults, {
        [k.alt]: v
      }),
      children: I
    })]
...
let Y = i.memo(function(e) {
  let {
    ...
    isFavoritesSearch: v
  } = e, T = i.useRef(null), A = i.useCallback(() => {
    S.Z.cleanUpSearchState(t)
  }, [t]);
  i.useEffect(() => (p.S.subscribe(D.CkL.SEARCH_RESULTS_CLOSE, A), () => {
  ...
  let C = i.useCallback((e, t, n) => {
    ...
    U = i.useCallback((e, t) => {
      ...
      {
        let e = x.intl.formatToPlainString(x.t["E+2azc"], {
          maxPages: n
        });
  ...
  return (0, r.jsxs)("section", {
    ...
    children: [(0, r.jsx)(I.Z, {
      ...
      children: [K && !n.isSearching && (0, r.jsx)(u.Wn, {
        className: k.paginationLimitHeader,
        messageType: u.QYI.WARNING,
        children: x.intl.formatToPlainString(x.t["E+2azc"], {
          maxPages: z
        })
      }), (0, r.jsx)(H, {
        searchResults: s,
...
function W(e) {
  ...
  return i.useEffect(() => {
    ...
    a && (o || e !== t.current && (t.current = e, d.Z.possiblyShowFeedbackModal(L.nw.SEARCH_RESULTS, () => r(!0), () => r(!1))))
  }, [a, o, e]), {
...
function K(e) {
  let {
  ...
  } = W(t), s = (0, b.WJ)(t), l = (0, c.cj)([g.Z, E.Z], () => {
    var e, t, n, r, i;
    return {
    ...
    null != r && null != i && (n && t.type === D.aib.DMS ? S.Z.fetchCrossDMMessages({
      searchContext: t,
      selectedPageIndex: 0,
      queryString: r,
      searchMode: e
  ...
  }, [n, l.isSearching, t, s, O]), T = i.useCallback(e => {
    if (l.isSearching) return;
    let r = B(t),
      i = E.Z.getSearchResultsQuery(s);
    null != r && null != i && (n && t.type === D.aib.DMS ? S.Z.fetchCrossDMMessages({
  ...
  }, [n, l.isSearching, t, s, h]), A = (0, c.e7)([E.Z], () => E.Z.getSearchResultsQuery(s)), N = t.type === D.aib.FAVORITES, C = i.useCallback(e => m.Z.setShowBlockedResults(s, e), [s]), R = i.useDeferredValue(d), P = i.useDeferredValue(l), L = i.useDeferredValue(u);
