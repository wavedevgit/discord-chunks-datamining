...
function U(e) {
  let {
    ...
    return s.useEffect(() => {
      ...
      l && (a || e !== t.current && (t.current = e, p.Z.possiblyShowFeedbackModal(M.nw.SEARCH_RESULTS, () => n(!0), () => n(!1))))
    }, [l, a, e]), {
    ...
    null != r && null != n && (l && t.type === Z.aib.DMS ? I.Z.fetchCrossDMMessages({
      searchContext: t,
      selectedPageIndex: 0,
  ...
  }, [l, u.isSearching, t, o, _]), P = s.useDeferredValue(g), T = s.useDeferredValue(u), N = s.useDeferredValue(h);
