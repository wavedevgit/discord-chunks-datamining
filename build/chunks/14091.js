...
let z = [],
  W = i.memo(function(e) {
    ...
    i.useEffect(() => (m.S.subscribe(D.CkL.SEARCH_RESULTS_CLOSE, N), () => {
...
function V(e) {
  let {
    ...
    return i.useEffect(() => {
      ...
      l && (a || e !== t.current && (t.current = e, p.Z.possiblyShowFeedbackModal(L.nw.SEARCH_RESULTS, () => r(!0), () => r(!1))))
    }, [l, a, e]), {
    ...
    null != r && null != i && (n && t.type === D.aib.DMS ? I.Z.fetchCrossDMMessages({
      searchContext: t,
      selectedPageIndex: 0,
      queryString: r,
      searchMode: e
  ...
  }, [n, o.isSearching, t, s, _]), S = i.useCallback(e => {
    if (o.isSearching) return;
    let r = I.Z.getSearchInputText(t),
      i = x.Z.getSearchResultsQuery(s);
    null != r && null != i && (n && t.type === D.aib.DMS ? I.Z.fetchCrossDMMessages({
  ...
  }, [n, o.isSearching, t, s, m]), Z = (0, c.e7)([x.Z], () => x.Z.getSearchResultsQuery(s)), P = t.type === D.aib.FAVORITES, T = i.useCallback(e => b.Z.setShowBlockedResults(s, e), [s]), N = i.useDeferredValue(d), w = i.useDeferredValue(o), A = i.useDeferredValue(u);
