...
function W(e) {
  let {
  ...
  } = e, o = (0, c.cj)([j.Z], () => j.Z.getResultsState(t), [t]), i = (0, R.k)(t), u = (0, c.e7)([j.Z], () => j.Z.getAnalyticsId(t)), {
    searchResults: d,
    ignoreCount: p,
    blockCount: f
  } = (0, P.Z)(t), {
    ...
    let n = H(t);
    h.oO(t, e, n)
  }, [t, o.isSearching]), x = s.useDeferredValue(d), O = s.useDeferredValue(o);
