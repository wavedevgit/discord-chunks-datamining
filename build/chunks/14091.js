...
class H extends i.PureComponent {
  ...
  constructor(...e) {
    super(...e), D(this, "state", {
      ...
      searchQuery: null
    }), D(this, "scrollerRef", i.createRef()), D(this, "scrollTo", (e, t, n) => {
      ...
      p.QY(e, !t)
    }), D(this, "renderFooter", () => this.props.isFeedbackVisible ? (0, r.jsx)(A.Z, {
      ...
      return a ? this.renderError() : o ? this.renderIndexing() : l ? null : i > 0 ? (0, r.jsx)(T.Z, {
...
function G(e) {
  ...
  } = e, a = (0, c.cj)([C.Z], () => C.Z.getResultsState(t), [t]), s = (0, S.k)(t), u = (0, c.e7)([C.Z], () => C.Z.getAnalyticsId(t)), d = i.useCallback(e => {
...
function V(e) {
  let {
    ...
    type: w.aib.DMS
  }), []), a = (0, b.WJ)(o), s = (0, c.e7)([C.Z], () => C.Z.getSearchResultsQueryString(a)), u = (0, b.jj)(o, k.sR.MESSAGES, s), [d, p] = i.useState(0);
  i.useEffect(() => {
    p(0)
  }, [s]);
...
function z(e) {
  ...
  i.useEffect(() => {
    ...
    c && (u || t !== o.current && (o.current = t, f.Z.possiblyShowFeedbackModal(R.nw.SEARCH_RESULTS, () => s(!0), () => s(!1))))
  }, [c, u, t]);
  let d = i.useCallback(() => {
    s(!1)
  }, []);
  return l && t === w.aib.DMS ? (0, r.jsx)(V, {
    theme: n,
    isFeedbackVisible: a,
