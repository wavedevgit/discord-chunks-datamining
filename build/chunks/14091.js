...
class G extends i.PureComponent {
  ...
  constructor(...e) {
    super(...e), U(this, "scrollerRef", i.createRef()), U(this, "scrollTo", (e, t, n) => {
      ...
      p.QY(e, !t)
    }), U(this, "renderFooter", () => this.props.isFeedbackVisible ? (0, r.jsx)(w.Z, {
      searchId: this.props.searchId,
      searchType: this.props.searchType,
      dismissFeedbackEntrypoint: this.props.dismissFeedbackEntrypoint
    }) : null), U(this, "renderHeader", () => {
      let {
        searchId: e,
        searchMode: t,
        search: {
      ...
      let {
        showNoResultsAlt: e
      } = this.props.search, t = e ? D.intl.string(D.t["VrK/2d"]) : D.intl.string(D.t.V6nAfH);
      return (0, r.jsxs)(H, {
        children: [(0, r.jsx)("div", {
          className: o()(L.noResultsImage, {
            [L.alt]: e
          })
        }), (0, r.jsx)("div", {
          className: o()(L.emptyResultsText, L.noResults, {
            [L.alt]: e
          }),
          children: t
        })]
      })
    }), U(this, "renderError", () => (0, r.jsxs)(H, {
      children: [(0, r.jsx)("div", {
      ...
      return d ? this.renderError() : u ? this.renderIndexing() : c ? null : s > 0 ? (0, r.jsx)(A.Z, {
        search: i,
        searchResults: e,
...
function V(e) {
  ...
  } = e, a = (0, c.cj)([C.Z], () => C.Z.getResultsState(t), [t]), s = (0, I.k)(t), u = (0, c.e7)([C.Z], () => C.Z.getAnalyticsId(t)), {
    searchResults: d,
    ignoreCount: h,
    blockCount: f
  } = (0, P.Z)(t), {
...
function z(e) {
  let {
    ...
    type: R.aib.DMS
  }), []), a = (0, b.WJ)(o), s = (0, c.e7)([C.Z], () => C.Z.getSearchResultsQueryString(a)), u = (0, b.jj)(o, M.sR.MESSAGES, s), [d, p] = i.useState(0);
  i.useEffect(() => {
    p(0)
  }, [s]);
...
function W(e) {
  ...
  i.useEffect(() => {
    ...
    c && (u || t !== o.current && (o.current = t, f.Z.possiblyShowFeedbackModal(k.nw.SEARCH_RESULTS, () => s(!0), () => s(!1))))
  }, [c, u, t]);
  let d = i.useCallback(() => {
    s(!1)
  }, []);
  return l && t === R.aib.DMS ? (0, r.jsx)(z, {
    theme: n,
    isFeedbackVisible: a,
