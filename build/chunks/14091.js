...
class U extends s.PureComponent {
  ...
  constructor(...e) {
    super(...e), F(this, "scrollerRef", s.createRef()), F(this, "scrollTo", (e, t, r) => {
      ...
      return (0, n.jsxs)(B, {
        children: [(0, n.jsx)(I.Z, {}), (0, n.jsx)("div", {
      ...
      return u ? this.renderError() : c ? this.renderIndexing() : o ? null : i > 0 ? (0, n.jsx)(T.Z, {
        search: s,
        searchResults: e,
...
function Q(e) {
  let {
  ...
  }), u = (0, E.k)(i), h = (0, c.e7)([x.Z], () => x.Z.getAnalyticsId(i)), {
    searchResults: d,
    ignoreCount: p,
    blockCount: g
  } = (0, k.Z)(i), {
    ...
    null != t && null != r && P.Z.fetchMessages({
      searchId: i,
      queryString: t,
      searchQuery: r,
      searchMode: e,
  ...
  }, [i, o.isSearching]), j = s.useDeferredValue(d), v = s.useDeferredValue(o);
...
function G(e) {
  ...
  s.useEffect(() => {
    ...
    c && (u || t !== a.current && (a.current = t, p.Z.possiblyShowFeedbackModal(w.nw.SEARCH_RESULTS, () => o(!0), () => o(!1))))
  }, [c, u, t]);
  let h = s.useCallback(() => {
    o(!1)
  }, []);
  return l && t.type === M.aib.DMS ? (0, n.jsx)(q, {
    theme: r,
    searchContext: t,
    isFeedbackVisible: i,
