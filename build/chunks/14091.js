...
class D extends s.Component {
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, A(this, "autoAnalytics", function() {
...
function B(e) {
  ...
  let {
    showNoResultsAlt: S
  } = l, b = S ? w.intl.string(w.t["VrK/2d"]) : w.intl.string(w.t.V6nAfH);
  return (0, r.jsxs)(F, {
    children: [(0, r.jsx)("div", {
      className: a()(Z.noResultsImage, {
        [Z.alt]: S
      })
    }), (0, r.jsx)("div", {
      className: a()(Z.emptyResultsText, Z.noResults, {
        [Z.alt]: S
      }),
      children: b
    })]
...
let H = s.memo(function(e) {
  let {
    ...
    onPageChange: x,
    searchMode: S
  } = e, b = s.useRef(null), v = s.useCallback(() => {
    O.Z.cleanUpSearchState(t)
  }, [t]);
  s.useEffect(() => (f.S.subscribe(N.CkL.SEARCH_RESULTS_CLOSE, v), () => {
  ...
  let _ = s.useCallback((e, t, n) => {
    ...
    k = s.useCallback((e, t) => {
      ...
      {
        let e = w.intl.formatToPlainString(w.t["E+2azc"], {
          maxPages: n
        });
  ...
  return (0, r.jsxs)("section", {
    ...
    children: [(0, r.jsx)(j.Z, {
      ...
      children: [W && !n.isSearching && (0, r.jsx)(u.Wn, {
        className: Z.paginationLimitHeader,
        messageType: u.QYI.WARNING,
        children: w.intl.formatToPlainString(w.t["E+2azc"], {
          maxPages: U
        })
      }), (0, r.jsx)(B, {
        searchResults: o,
...
function Q(e) {
  let {
    ...
    return s.useEffect(() => {
      ...
      l && (a || e !== t.current && (t.current = e, h.Z.possiblyShowFeedbackModal(k.nw.SEARCH_RESULTS, () => r(!0), () => r(!1))))
    }, [l, a, e]), {
    ...
    null != r && null != s && (n && t.type === N.aib.DMS ? O.Z.fetchCrossDMMessages({
      searchContext: t,
      selectedPageIndex: 0,
  ...
  }, [n, o.isSearching, t, i, C]), I = s.useCallback(e => {
    if (o.isSearching) return;
    let r = M(i),
      s = y.Z.getSearchResultsQuery(i);
    if (null != r && null != s)
      ...
      } else O.Z.fetchMessages({
        searchId: i,
        queryString: r,
        searchQuery: s,
        offset: e * N.vpv
      })
  }, [n, o.isSearching, t, i, j]), P = s.useDeferredValue(p), R = s.useDeferredValue(o), T = s.useDeferredValue(u);
