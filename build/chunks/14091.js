...
class B extends s.PureComponent {
  ...
  constructor(...e) {
    super(...e), L(this, "scrollerRef", s.createRef()), L(this, "scrollTo", (e, t, r) => {
    ...
    }), L(this, "renderFooter", () => this.props.isFeedbackVisible ? (0, n.jsx)(T.Z, {
      ...
      return (0, n.jsxs)(H, {
        children: [(0, n.jsx)(R.Z, {}), (0, n.jsx)("div", {
      ...
      return (0, n.jsxs)(H, {
        children: [(0, n.jsx)("div", {
          className: a()(D.noResultsImage, {
            [D.alt]: e
          })
        }), (0, n.jsx)("div", {
          className: a()(D.emptyResultsText, D.noResults, {
            [D.alt]: e
          }),
          children: t
        })]
      })
    }), L(this, "renderError", () => (0, n.jsxs)(H, {
      children: [(0, n.jsx)("div", {
...
function U(e) {
  let {
    ...
    return s.useEffect(() => {
      ...
      l && (a || e !== t.current && (t.current = e, p.Z.possiblyShowFeedbackModal(Z.nw.SEARCH_RESULTS, () => n(!0), () => n(!1))))
    }, [l, a, e]), {
    ...
    null != r && null != n && (l && t.type === M.aib.DMS ? I.Z.fetchCrossDMMessages({
      searchContext: t,
      selectedPageIndex: 0,
  ...
  }, [l, u.isSearching, t, o, S]), R = s.useCallback(e => {
    if (u.isSearching) return;
    let r = F(o),
      n = b.Z.getSearchResultsQuery(o);
    if (null != r && null != n)
      ...
      } else I.Z.fetchMessages({
        searchId: o,
        queryString: r,
        searchQuery: n,
        offset: e * M.vpv
      })
  }, [l, u.isSearching, t, o, y]), P = s.useDeferredValue(g), T = s.useDeferredValue(u), N = s.useDeferredValue(h);
