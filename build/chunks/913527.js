...
e = n.nmd(e),
  function(t, n) {
    ...
    }), eu(0, ["YYYY", 4], 0, "year"), eu(0, ["YYYYY", 5], 0, "year"), eu(0, ["YYYYYY", 6, !0], 0, "year"), $("year", "y"), er("year", 1), eL("Y", eN), eL("YY", ey, em), eL("YYYY", eT, eE), eL("YYYYY", eS, eb), eL("YYYYYY", eS, eb), eU(["YYYYY", "YYYYYY"], eV), eU("YYYY", function(e, n) {
