  ...
  constructor(...e) {
    super(...e), x(this, "state", {
      ...
      let {
        ...
        handlePin: t,
        pinned: n
      } = this.props, l = n ? E.intl.string(E.t.cSu80j) : E.intl.string(E.t.cM8Vnm);
