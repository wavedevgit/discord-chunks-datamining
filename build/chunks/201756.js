...
function L(e) {
  ...
  } = e, o = l.useRef(null), i = l.useRef(null), L = l.useRef(null), I = l.useRef(null), P = l.useRef(null), M = (0, c.e7)([f.Z], () => f.Z.getSearchStateByGuildId(t), [t], s()), V = (0, c.e7)([m.Z, C.Z], () => m.Z.can(O.Plq.MANAGE_GUILD, C.Z.getGuild(t)), [t]), {
    selectedUserIds: E,
    addUsers: T,
    clearSelection: k
  } = (0, h.Z)(t), A = M.requireUnusualDmActivity || M.requireCommunicationDisabled || M.requireUnusualAccountActivity || M.requireUsernameQuarantined, B = M.selectedRoleIds.size > 0, W = null != M.selectedJoinDateOption.afterDate, U = M.selectedSort === b.d$.ORDER_BY_GUILD_JOINED_AT_ASC, F = null != M.selectedAccountAgeOption.afterDate, z = M.selectedSort === b.d$.ORDER_BY_USER_ID_ASC || M.selectedSort === b.d$.ORDER_BY_USER_ID_DESC, q = null != M.selectedSourceInviteCode && "" !== M.selectedSourceInviteCode, G = null != M.selectedJoinSourceType, Y = q || G, [K, X] = l.useState(null == u.K.get(R, null)), J = l.useCallback(() => {
