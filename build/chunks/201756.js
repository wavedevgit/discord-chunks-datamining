...
function R(e) {
  ...
  } = e, o = l.useRef(null), a = l.useRef(null), R = l.useRef(null), P = l.useRef(null), I = l.useRef(null), M = (0, c.e7)([f.Z], () => f.Z.getSearchStateByGuildId(t), [t], s()), V = (0, c.e7)([m.Z, C.Z], () => m.Z.can(y.Plq.MANAGE_GUILD, C.Z.getGuild(t)), [t]), {
    selectedUserIds: E,
    addUsers: T,
    clearSelection: k
  } = (0, h.Z)(t), A = M.requireUnusualDmActivity || M.requireCommunicationDisabled || M.requireUnusualAccountActivity || M.requireUsernameQuarantined, B = M.selectedRoleIds.size > 0, U = null != M.selectedJoinDateOption.afterDate, F = M.selectedSort === b.d$.ORDER_BY_GUILD_JOINED_AT_ASC, z = null != M.selectedAccountAgeOption.afterDate, q = M.selectedSort === b.d$.ORDER_BY_USER_ID_ASC || M.selectedSort === b.d$.ORDER_BY_USER_ID_DESC, G = null != M.selectedSourceInviteCode && "" !== M.selectedSourceInviteCode, Y = null != M.selectedJoinSourceType, W = G || Y, [X, K] = l.useState(null == u.K.get(L, null)), J = l.useCallback(() => {
