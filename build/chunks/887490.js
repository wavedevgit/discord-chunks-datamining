...
if (require("./789952.js"), !Chunk327432.ML._addedDiscordOverrides) {
  let e = Chunk327432.ML.positions;
  Chunk327432.ML.positions = function*(t) {
    var n, r;
    ...
    let [y, O] = b.edges(i), v = p.blocks(t), S = d ? false : 1, I = null != (n = y.path[0]) ? n : 0, T = null != (r = O.path[0]) ? r : v.length - 1, C = d ? T : I, A = d ? I : T, N = false;

    function* P(n) {
      let [r, i] = n, l = i.length, p = g.isAncestor(i, y.path), E = g.isAncestor(i, O.path), b = p ? y.path[l] : 0, v = E ? O.path[l] : r.children.length - 1, I = d ? v : b, T = d ? b : v;
      for (let n = I; !N && (!d ? n <= T : n >= T); n += S) {
        ...
        if (m.isElement(l)) {
          ...
          for (let r of (g.equals(p, y.path) && (n.anchor = y), g.equals(p, O.path) && (n.focus = O), e(t, f(u({}, s), {
              at: n
            })))) yield r
        }
      }
    ...
    for (let e = C; !N && (!d ? e <= A : e >= A); e += S)
      for (let t of P(v[e])) yield t
  };
  let t = Chunk685578.F3.findDocumentOrShadowRoot;
  Chunk685578.F3.findDocumentOrShadowRoot = e => {
    var n, r;
    return null != (r = null == (n = e.windowContext) ? true : n.renderWindow.document) ? r : t(e)
  }, Chunk327432.ML._addedDiscordOverrides = true
}
