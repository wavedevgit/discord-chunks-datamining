...
let b = function(e) {
  var {
    ...
    disableShine: I,
    applicationId: T,
    shinyButtonClassName: S,
    showGradient: A = !1,
    confirmationFooter: N,
    paymentModalBanner: C,
    color: R,
    iconColor: P = "currentColor"
  } = e, w = g(e, ["subscriptionTier", "onClick", "size", "className", "textOptions", "iconClassName", "postSuccessGuild", "onSubscribeModalClose", "premiumModalAnalyticsLocation", "showIcon", "disableShine", "applicationId", "shinyButtonClassName", "showGradient", "confirmationFooter", "paymentModalBanner", "color", "iconColor"]);
