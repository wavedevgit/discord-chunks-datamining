...
let P = function(e) {
  ...
  let K = (0, a.e7)([p.default], () => p.default.getCurrentUser()),
    ...
    ee = e => {
      var t;
      if (e.preventDefault(), null == K) return void(0, _.uL)(y.Z5c.LOGIN, {
      ...
      if (!K.isClaimed()) return void(0, l.ZDy)(async () => {
        let {
          default: e
        ...
        return t => {
          ...
          return (0, r.jsx)(e, A(S({}, i), {
            onClose: n
          }))
        }
      });
      if (!K.verified) return void(0, l.ZDy)(async () => {
        let {
          default: e
      ...
      let o = J ? null == (t = X.subscription_trial) ? void 0 : t.id : null,
        a = y.Qqv.BUY;
      null != o ? a = y.Qqv.TRIAL : V && (a = y.Qqv.GIFT), (0, f.Z)({
        isGift: V,
        initialPlanId: null,
        subscriptionTier: i,
        analyticsLocations: Q,
  ...
  if (H && (null == P ? void 0 : P.expressiveButtonText) != null) return (0, r.jsx)(s.z, {
    onClick: ee,
    variant: "expressive",
  ...
  return null != $.buttonTooltipText ? (0, r.jsx)(l.ua7, {
