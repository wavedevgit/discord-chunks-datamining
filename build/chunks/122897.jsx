...
function h() {
  ...
  return <Chunk838436.U setting={Chunk726985.s6.PRIVACY_DIRECT_MESSAGE_SPAM_FILTER_V2}>{<Chunk838436.H header={Chunk388032.intl.string(Chunk388032.t.tiCXaG)} description={Chunk388032.intl.format(Chunk388032.t.RvjRRE, {
        appealLink: Chunk63063.Z.getArticleURL(Chunk981631.BhN.SAFE_DIRECT_MESSAGING)
      })} />}{<Chunk481060.FXm className={Chunk889652.radioGroup} radioItemClassName={Chunk889652.radioGroupItem} value={h} options={(0, Chunk78451.c7)()} onChange={e => {
        let {
          value: t
        } = e;
