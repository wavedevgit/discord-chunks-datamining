...
function b(e) {
  ...
  let [j, h] = i.useState(""), [x, v] = i.useState(!1), C = (0, c.sE)(t, {
    location: b,
    targetUserId: n.id
  }), {
    isModReportClosed: M,
    ...
    if (o.Z.kickUser(t, n.id, j, E).then(() => {
        x && null != E && s.Z.resolveFlag(E)
      }), C(c.jQ.KICK), null != E) {
      var e;
      null == (e = y.onClose) || e.call(y)
    }
  }, [t, n.id, j, C, E, x, y]), T = i.useCallback(e => {
    h(e)
  }, []);
  return null != E && A ? (0, r.jsxs)(a.Y0X, O(m({}, y), {
    ...
    children: [(0, r.jsx)(a.xBx, {
      ...
      children: (0, r.jsxs)(a.Kqy, {
        ...
        children: [(0, r.jsx)(a.olH, {
          ...
          children: f.intl.formatToPlainString(f.t["1Ie87u"], {
            user: n.username
          })
        })]
      })
