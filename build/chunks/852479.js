...
function f(e) {
  let {
    guild: t,
    onSubmit: o
  } = e, f = (0, a.e7)([C.Z], () => C.Z.getMembersCountByGuildId(t.id, c.R_.NEW_GUILD_MEMBER), [t.id]), h = (0, a.e7)([C.Z], () => {
    let e = C.Z.getNewMemberTimestamp(t.id);
    return i()(e).format("h:mm A")
  }, [t.id]), j = (0, a.e7)([C.Z], () => C.Z.hasDefaultSearchStateByGuildId(t.id), [t.id]), g = l.useCallback(() => {
  ...
  }, [g, j]), O = new Intl.NumberFormat(m.NW.currentLocale).format(f), y = (0, u.nX)(t.id), v = (0, u.xC)(t.id), N = l.useMemo(() => 1 + +!!y + +!!v, [y, v]);
