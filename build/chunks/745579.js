...
let s = t => {
  let e = Date.now() + t;
  return (0, a.KC)(new Date, new Date(e)) ? o.intl.data.formatTime(e, {
    format: "short"
  ...
  switch (t) {
    case i.FO.TODAY:
      if (e) return "".concat(o.intl.formatToPlainString(o.t.Rea2gY, {
        hours: 24
      }), " (").concat(s(l.Z.Millis.DAY), ")");
      return o.intl.string(o.t.GQmLra);
    case i.FO.HOURS_4:
      if (e) return "".concat(o.intl.formatToPlainString(o.t.Rea2gY, {
        hours: 4
      }), " (").concat(s(4 * l.Z.Millis.HOUR), ")");
