...
function J(e) {
  ...
  return (0, c.jsx)(c.Fragment, {
    children: Object.keys(y).sort((e, n) => {
      ...
      }), (null == I ? void 0 : I.type) === U.ABu.STEAM && (m = D.intl.string(D.t.NcZh6O)), (0, c.jsxs)(p.P3F, {
...
function $(e) {
  ...
  })), !0 === N.hasMetadata && (a = (0, c.jsx)(p.j7V, {
    className: Y.accountConnectedPrivacyOptionsSwitchItem,
    hideBorder: !0,
    value: m,
    disabled: !f,
...
function ee(e) {
  ...
  return o.useEffect(() => {
    ...
    _ && null != eo && eo.roles.includes(i.id) && (A(!1), ea.length > 0 ? s(2) : null == t || t(), R.default.track(U.rMx.PASSPORT_CHALLENGE_FINISHED, q({
      role_id: i.id
    }, (0, y.hH)(a))))
