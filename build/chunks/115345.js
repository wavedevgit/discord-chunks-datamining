...
function U(e, t) {
  let [n, i] = r.useState(w.nf), [a, s] = r.useState({});
  (0, _.D)();
...
function B() {
  ...
  W(t), y.default.track(R.rMx.NOTIFICATION_MIGRATION_COMPLETED, {
    auto_migrated: !0,
...
function Z(e, t, n, r, i) {
  var a;
  let [o, s, l] = p.Z.hasConsented(R.pjP.PERSONALIZATION) ? (0, N.q)(e, t, n, r, !0) : (0, N.A)(e, n), c = null != (a = n.filter(t => t.guild_id === e.id)[0]) ? a : {}, u = (0, A.Z)(e, null != i ? i : o, c, r, t);
  return {
    guildId: e.id,
    mode: o,
    debugReason: l,
...
function V(e) {
  let [t, n] = r.useState(!1), [i, a] = r.useState(!1), o = r.useCallback(async t => {
...
function Y(e) {
  ...
  return () => {
    y.default.track(R.rMx.NOTIFICATION_MIGRATION_COMPLETED, M(k({}, n), {
      auto_migrated: !0,
      pre_selected_server_ids: Object.values(e).filter(e => e.mode === w.AR.UseGreyDot).map(e => e.guildId),
...
async function $() {
  s.K.set("turnedOffNewNotifications", !0), y.default.track(R.rMx.NOTIFICATION_MIGRATION_OPTOUT, {
    num_guilds_with_new_setting: g.Z.getGuildsArray().filter(e => b.ZP.resolveGuildUnreadSetting(e) === P.i.ONLY_MENTIONS).length
  });
  let e = await (0, S.Tn)(),
