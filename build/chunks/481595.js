...
function j(e) {
  ...
  return i.useEffect(() => {
    ee && B === $ && $ !== O.c && null == ei && (0, u.x2)(et.applicationId, et.id, $, {
      isGift: Q
    }).then(() => {
      q(null)
    }).catch(e => {
  ...
  }, [$, ee, B, et.applicationId, et.id, ei, q, Q]), (0, r.jsxs)("div", {
    className: M.stepBody,
    children: [ea ? (0, r.jsx)(f.Z, {
      icon: (0, c.GSL)(S.Z),
      iconSize: f.Z.Sizes.SMALL,
      color: f.Z.Colors.WARNING,
      className: M.errorBlock,
      children: x.intl.string(x.t.OvMyMT)
    }, "TEST_MODE") : null, (0, T.yE)(j.flags, L.udG.EMBEDDED) && z === h.O.ERROR ? (0, r.jsx)(f.Z, {
      icon: (0, c.GSL)(S.Z),
      iconSize: f.Z.Sizes.SMALL,
      ...
      children: (0, r.jsx)(p.Z, {
        ...
        purchaseType: W,
        isGift: Q,
        checkboxLabel: et.productLine === L.POd.COLLECTIBLES ? x.intl.format(x.t["1EdAlZ"], {
