...
function L(e) {
  ...
  let {
    guild: r,
    width: h
  } = e, P = (0, c.e7)([b.ZP], () => b.ZP.getSection(_.oC.GUILD_HOME)), [L, H] = l.useState(false), [T, D] = l.useState(O.$Y6), R = P === O.ULH.SIDEBAR_CHAT, B = (0, s.mFp)(), W = (0, c.e7)([x.Z], () => x.Z.getSettings(r.id)), U = null == W ? true : W.welcomeMessage, G = (0, C.Z)(r.id), F = !G && (null != (t = null == W || null == (n = W.resourceChannels) ? true : n.length) ? t : 0) === 0, z = (0, o.Z)("(max-width: 1300px)"), V = h - O.PrS - T, q = R && V < M || z || F;
  return (l.useEffect(() => {
    if (W === x.P)(0, p.cP)(r.id);
    else if (null != W) {
      var e, n, t, a, l;
      g.default.track(O.rMx.SERVER_GUIDE_VIEWED, A(S({}, (0, u.hH)(r.id)), {
