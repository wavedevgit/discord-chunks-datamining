...
function A(e) {
  ...
  return Z > _ ? t = 72 : n = 72, (0, r.jsxs)("div", {
    className: E.media,
    children: [(0, g.Yi)({
      src: v,
      maxHeight: n,
...
function M(e) {
  let {
    resource: n
  } = e, t = (0, s.e7)([j.Z], () => j.Z.getChannel(n.channelId)), a = (0, s.e7)([v.Z], () => v.Z.getMessages(n.channelId)), u = (0, s.e7)([_.Z], () => _.Z.can(P.Plq.VIEW_CHANNEL, t)), h = a.first(), f = (0, y.Z)(h), g = (0, d.zy)(h, !1), p = (null == g ? void 0 : g.length) > 0 ? g[0] : null, b = null != t && null == a.first() && !a.loadingMore && !a.ready && !a.hasFetched && u;
  if (l.useEffect(() => {
      b && c.Z.fetchMessages({
  ...
  return (0, r.jsxs)(o.P3F, {
    ...
    }), null != n.icon && null != C ? (0, r.jsx)("div", {
      className: E.media,
...
function D(e) {
  ...
  return 0 === l.length ? t ? null : (0, r.jsxs)("div", {
