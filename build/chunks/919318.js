...
function M(e) {
  let {
    resource: n
  } = e, l = (0, s.e7)([j.Z], () => j.Z.getChannel(n.channelId)), a = (0, s.e7)([_.Z], () => _.Z.getMessages(n.channelId)), u = (0, s.e7)([v.Z], () => v.Z.can(P.Plq.VIEW_CHANNEL, l)), h = a.first(), f = (0, y.Z)(h), g = (0, d.zy)(h, !1), x = (null == g ? void 0 : g.length) > 0 ? g[0] : null, b = null != l && null == a.first() && !a.loadingMore && !a.ready && !a.hasFetched && u;
  if (r.useEffect(() => {
      b && o.Z.fetchMessages({
