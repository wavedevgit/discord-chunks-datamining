...
let h = m("en-US"),
  ...
  E = new Chunk469571.IntlManager({
    initialLocale: g,
    defaultLocale: "en-US"
  }).withFormatters({
    format: (0, Chunk469571.makeReactFormatter)({
      $i: (e, t) => (0, r.jsx)("em", {
        children: e
      }, t),
    ...
    formatToPlainString: Chunk469571.stringFormatter,
    formatToMarkdownString: Chunk469571.markdownFormatter,
    formatToParts: Chunk469571.astFormatter
  }),
  b = e => (0, c.j1)(e, E)