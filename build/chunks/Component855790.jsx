...
let b = Chunk652215.UVF.DEFAULT,
  g = 1,
  y = Chunk64700.createContext({
    type: b,
    opacity: g
  }),
  A = Chunk64700.createContext(true),
  m = e => {
    let {
      children: t,
      className: n
...
v.Background = e => {
  ...
  return (0, r.jsx)(y.Consumer, {
    children: e => {
      ...
      {
        if (i.includes(t.type)) return (0, r.jsx)(A.Provider, {
          value: o,
          children: t
        });
