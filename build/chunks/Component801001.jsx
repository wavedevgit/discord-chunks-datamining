...
function C(e) {
  let {
    ...
    prompt: N,
    index: P
  } = e, S = (0, j.Dt)(), w = (0, a.e7)([v.ZP], () => v.ZP.getDefaultChannel(C.id)), [E, Z] = i.useState(() => {
    var e;
  ...
  }), [z, J] = i.useState({}), A = i.useRef(null);
  i.useLayoutEffect(() => {
    var e;
  ...
  let F = i.useCallback(() => {
    ...
    }, [_, M, E, C, n, r, null == h ? true : h.id, N, D, k]),
    H = i.useMemo(() => [{
...
function I(e) {
  let {
    guild: t,
    roleIds: n
  } = e, i = (0, a.e7)([g.Z], () => g.Z.getManyRoles(t.id, n).find(h.F));
