...
var n, Chunk255367 = require("./255367.js"),
  ...
  Chunk66037 = require("./66037.js"),
  Chunk248108 = require("./248108.js"),
...
class m extends(n = Chunk73800.PureComponent) {
  render() {
    ...
    return N(null != Chunk330711.Z ? Chunk330711.Z.getLocale().toLowerCase() : "").map(l => null != l.links ? <o.Z title={l.title} links={l.links} isOpen={m === l.title} isMobile={t} avoidRouter={u} TrackClick={s} onClose={this.closeSubNav} onOpen={this.openSubNav} /> : l.external && null != l.route ? <li className={n.listItemInactive} role={"none"}><s className={n.mainNavLink} eventName={_} data={l.linkClicked ? {
          linkClicked: l.linkClicked
        } : {}} href={l.route} rel={"me"}>{l.title}</s></li> : null != l.route ? <li className={e(l.route) ? n.listItemActive : n.listItemInactive} role={"none"}><i.Z avoidRouter={u} to={l.route} from={c.j_.MAIN_NAVIGATION_MENU} tabIndex={a ? 0 : false} role={"menuitem"}><s tag={"span"} className={n.mainNavLink} eventName={_} data={{
            linkClicked: l.linkClicked
          }}>{l.title}</s></i.Z></li> : [])
  }
  constructor(...e) {
