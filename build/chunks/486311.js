...
let y = {
  ...
  _ = i.memo(function(e) {
    let {
      guildId: t,
      selected: l
    } = e, _ = (0, p.Z)(t), v = i.useCallback(() => {
      (0, c.jd)(t), (0, u.Z)(t)
    }, [t]), O = i.useCallback(() => {
      var e;
      switch (null == _ || null == (e = _.popout) ? void 0 : e.type) {
        case h.Us.LEVEL:
          return (0, r.jsx)(d.j, b({
            guildId: t
          }, _.popout));
        case h.Us.PERK:
          return (0, r.jsx)(d.$, b({
    ...
    }, [t, null == _ ? void 0 : _.popout]), [j, x] = i.useState(!1), [C, S] = i.useState(null), P = null == C ? "animation" : "LOOP";
    i.useEffect(() => {
    ...
    return (0, r.jsx)(a.yRy, {
      ...
      children: e => {
        ...
        return (0, r.jsx)(s.m, (i = b({}, e), c = c = {
          ...
          text: (0, r.jsx)("span", {
            className: o()({
              [m.textImportant]: (null == _ ? void 0 : _.showUnread) === !0
            }),
