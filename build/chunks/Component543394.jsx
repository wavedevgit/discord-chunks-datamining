...
function C(e) {
  ...
  return (0, l.Z)({
    ...
    children: [(0, r.jsx)(o.Ji, {
      ...
      environment: N,
      ref: x,
      requestAnimationFrame: null != (t = null == w ? true : w.requestAnimationFrame) ? t : requestAnimationFrame,
      cancelAnimationFrame: null != (n = null == w ? true : w.cancelAnimationFrame) ? n : cancelAnimationFrame
    }), (0, r.jsx)(d.Z, {
      itemId: f.yN.RAIN,
