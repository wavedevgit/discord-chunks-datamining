...
class c {
  updateVoiceStates(e, t) {
    t === this.channelId ? (this.totalParticipants.add(e), this.maxVoiceStateCount = Math.max(o.ZP.countVoiceStatesForChannel(t), this.maxVoiceStateCount)) : (null == t && e in this.totalSpeakers && (this.totalSpeakers[e] = s.Dg.NONE), e === this.userId && null != t && this.setChannelId(t))
  }
  getStats() {
    return {
