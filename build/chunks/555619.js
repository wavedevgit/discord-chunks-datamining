/** Chunk was on web.js **/
/** chunk id: 555619, original params: e,t,n (module,exports,re quire) **/
"use strict";
let r;
...
let U = "undefined" == typeof FinalizationRegistry ? {
  register: () => {},
  unregister: () => {}
...
class G {
  ...
  get type() {
    return R[r.intounderlyingbytesource_type(this.__wbg_ptr)]
  }
  cancel() {
    let e = this.__destroy_into_raw();
