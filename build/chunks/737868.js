...
let T = e => {
  ...
  let {
    ...
    onSave: z,
    onClose: I
  } = e, D = i.useRef(null), L = (0, f.Dt)(), [B, R] = i.useState(null != Z ? Z.channel_id : null), [A, H] = i.useState(null != Z ? Z.description : ""), [M, K] = i.useState(null != Z ? {
    id: Z.emoji_id,
    name: Z.emoji_name
  } : null), [W, Y] = i.useState(!1), q = (0, o.e7)([p.ZP], () => (null == M ? void 0 : M.id) != null ? p.ZP.getUsableCustomEmojiById(M.id) : null), G = (0, o.e7)([g.ZP], () => g.ZP.getChannels(T)[g.sH], [T]), V = (0, o.e7)([N.Z], () => N.Z.get(T)), X = null != (l = null == V || null == (n = V.welcome_channels) ? void 0 : n.map(e => e.channel_id)) ? l : [], [$, U] = i.useState(!1);
  i.useEffect(() => {
  ...
  G.forEach(e => {
    ...
    v.Uu(y.Plq.VIEW_CHANNEL, n) && ((null == Z ? void 0 : Z.channel_id) === n.id || !X.includes(n.id)) && F.push({
      value: n.id,
              ...
              children: (0, t.jsx)(a.yRy, {
                ...
                children: (e, n) => {
                  ...
                  return (0, t.jsx)(a.DY3, {
                    ...
                    forceOpen: $,
                    children: (0, t.jsx)(j.Z, (l = function(e) {
                      ...
                      tabIndex: 0,
                      renderButtonContents: null != M && (null != M.id || null != M.name) ? () => (0, t.jsx)(s.Z, {
                        className: P.emoji,
                        emojiId: M.id,
                        emojiName: M.name,
