...
function z(e) {
  let {
  ...
  } = (0, m.R4)("user-profile-stream-activity-card-web"), et = (0, s.e7)([T.Z], () => T.Z.getGuild(null == o ? void 0 : o.guildId)), en = (0, s.e7)([S.Z], () => S.Z.getChannel(null == o ? void 0 : o.channelId)), er = (0, s.Wu)([P.ZP], () => null != en ? P.ZP.getVoiceStatesForChannel(en).map(e => {
    let {
      user: t
    } = e;
    return t
    ...
    previewUrl: el,
    isLoading: ec
  } = (0, b.Z)(null == o ? void 0 : o.guildId, null == o ? void 0 : o.channelId, null == o ? void 0 : o.ownerId), [eu, ed] = (0, y.wq)(en), ef = (0, s.e7)([N.Z], () => null != en && N.Z.canBasicChannel(F.S7T.CONNECT, en)), e_ = (0, s.e7)([C.Z], () => C.Z.getRelationshipType(t.id));
  i.useEffect(() => {
    if (ee) {
      var e;
      R.default.track(F.rMx.USER_VOICE_ACTIVITY_VIEWED, {
    ...
    children: (0, r.jsxs)(x.Z, {
      ...
      children: [(0, r.jsx)(M.Z, {
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [em(), eg(), Q === V.y0.FULL_SIZE && eb()]
        }), eE()]
      }), Q !== V.y0.FULL_SIZE && eb()]
    })
  })
