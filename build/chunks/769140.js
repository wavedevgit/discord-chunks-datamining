...
function Z(e) {
  let {
    ...
    themeType: V,
    theme: H
  } = (0, N.z)(), Y = (0, a.e7)([O.Z], () => O.Z.getGuild(null == i ? void 0 : i.guildId)), W = (0, a.e7)([y.Z], () => y.Z.getChannel(null == i ? void 0 : i.channelId)), K = (0, a.Wu)([T.ZP], () => null != W ? T.ZP.getVoiceStatesForChannel(W).map(e => {
    let {
      user: t
    } = e;
    return t
    ...
    previewUrl: J,
    isLoading: $
  } = (0, E.Z)(null == i ? void 0 : i.guildId, null == i ? void 0 : i.channelId, null == i ? void 0 : i.ownerId), [ee, et] = (0, b.wq)(W), en = (0, _.Kt)() && (0, _.zd)(null == W ? void 0 : W.id), er = (0, a.e7)([v.Z], () => null != W && !en && v.Z.canBasicChannel(M.S7T.CONNECT, W)), ei = (0, u.Z)($ ? null : J), eo = $ || null == J ? ei : J;
