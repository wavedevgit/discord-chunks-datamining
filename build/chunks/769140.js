...
function Z(e) {
  let {
    ...
    themeType: V,
    theme: H
  } = (0, N.z)(), Y = (0, o.e7)([O.Z], () => O.Z.getGuild(null == i ? void 0 : i.guildId)), W = (0, o.e7)([y.Z], () => y.Z.getChannel(null == i ? void 0 : i.channelId)), K = (0, o.Wu)([T.ZP], () => null != W ? T.ZP.getVoiceStatesForChannel(W).map(e => {
    let {
      user: t
    } = e;
    return t
  ...
  } = (0, h.ZP)(p.Z.USER_PROFILE_LIVE_ACTIVITY_CARD), $ = (0, S.Z)({
    display: "live",
    ...
    previewUrl: Q,
    isLoading: J
  } = (0, E.Z)(null == i ? void 0 : i.guildId, null == i ? void 0 : i.channelId, null == i ? void 0 : i.ownerId), [ee, et] = (0, b.wq)(W), en = (0, _.Kt)() && (0, _.zd)(null == W ? void 0 : W.id), er = (0, o.e7)([v.Z], () => null != W && !en && v.Z.canBasicChannel(k.S7T.CONNECT, W)), ei = (0, u.Z)(J ? null : Q), ea = J || null == Q ? ei : Q;
  ...
  let eo = () => {
    ...
    el = () => V === x.lY.MODAL || V === x.lY.MODAL_V2 ? null : (0, r.jsx)(P.Z, {
      user: t,
      guild: Y,
      channel: W,
      onAction: $,
