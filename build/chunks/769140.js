...
function B(e) {
  let {
  ...
  } = (0, p.ZP)(_.Z.USER_PROFILE_LIVE_ACTIVITY_CARD), q = (0, T.Z)({
    display: "live",
    ...
    previewUrl: Q,
    isLoading: J
  } = (0, g.Z)(null == i ? void 0 : i.guildId, null == i ? void 0 : i.channelId, null == i ? void 0 : i.ownerId), [$, ee] = (0, E.wq)(Y), et = (0, o.e7)([O.Z], () => null != Y && O.Z.canBasicChannel(x.S7T.CONNECT, Y)), en = (0, u.Z)(J ? null : Q), er = J || null == Q ? en : Q;
  ...
  let ei = () => {
      ...
      return null == er && J ? (0, r.jsx)("div", {
        ...
        }), V !== L.lY.MODAL && V !== L.lY.MODAL_V2 && (0, r.jsxs)(r.Fragment, {
    ...
    eo = () => V === L.lY.MODAL || V === L.lY.MODAL_V2 ? null : (0, r.jsx)(P.Z, {
      user: t,
      guild: H,
      channel: Y,
      onAction: q,
