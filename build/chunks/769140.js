...
function H(e) {
  let {
  ...
  }, q = (0, a.e7)([I.Z], () => I.Z.getGuild(null == i ? void 0 : i.guildId)), Q = (0, a.e7)([O.Z], () => O.Z.getChannel(null == i ? void 0 : i.channelId)), X = (0, a.Wu)([N.ZP], () => null != Q ? N.ZP.getVoiceStatesForChannel(Q).map(e => {
    let {
      user: t
    } = e;
    return t
    ...
    previewUrl: en,
    isLoading: er
  } = (0, g.Z)(null == i ? void 0 : i.guildId, null == i ? void 0 : i.channelId, null == i ? void 0 : i.ownerId), [ei, eo] = (0, E.wq)(Q), ea = (0, a.e7)([S.Z], () => null != Q && S.Z.canBasicChannel(U.S7T.CONNECT, Q)), es = (0, u.Z)(er ? null : en), el = er || null == en ? es : en;
