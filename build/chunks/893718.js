...
function ew(e, t, n) {
  let [r, a] = (0, R.Iu)(e => [e.activeView, e.activeViewType], u.X), o = (0, f.e7)([O.Z], () => O.Z.shouldShowPopup() && O.Z.activeViewType() === e), s = (0, C.Q3)("ChannelTextAreaContainer");
  i.useEffect(() => () => {
    (0, R._Q)(e)
  }, [e]);
...
function eL(e, t) {
  ...
  })), tf = (0, f.e7)([H.Z], () => H.Z.isEnabled()), tp = i.useRef(R);
  tp.current = R;
