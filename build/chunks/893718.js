...
function eI(e) {
  ...
  return i.useCallback((e, i) => {
    var c, u;
    n || ((0, U.Hc)(i, r, a, o.drafts.type) ? ((0, en._H)({
      sticker: e,
...
function eT(e, t) {
  return i.useCallback((n, r, i) => {
    let a = e.current;
    null != n && null != a && (K.default.track(ec.rMx.SOUNDMOJI_SELECT, {
      channel_id: t.id,
      guild_id: t.guild_id,
...
function ew(e, t, n) {
  let [r, a] = (0, R.Iu)(e => [e.activeView, e.activeViewType], u.X), o = (0, _.e7)([O.Z], () => O.Z.shouldShowPopup() && O.Z.activeViewType() === e), s = (0, C.Q3)("ChannelTextAreaContainer");
  i.useEffect(() => () => {
    (0, R._Q)(e)
  }, [e]);
...
function eL(e, t) {
  ...
  let {
    ...
    renderAppLauncherButton: q,
    renderAppCommandButton: en,
    renderLeftAccessories: ed,
    pendingReply: e_,
    onChange: ep,
    onResize: eh,
    onBlur: em,
    ...
    children: eW,
    disableThemedBackground: eK = !1,
    emojiPickerCloseOnModalOuterClick: ez,
    parentModalKey: eq,
    onCommandSentinelTyped: eX,
    pendingScheduledMessage: eQ
  } = e;
  c()(null != Y, "chat input type must be set");
  let {
    analyticsLocations: eJ
  } = (0, y.ZP)(b.Z.CHANNEL_TEXT_AREA), e$ = (0, C.R6)("ChannelTextAreaContainer"), e0 = (0, C.Q3)("ChannelTextAreaContainer"), e1 = eC(t), e2 = i.useRef(null), e3 = i.useRef(null), e4 = i.useRef(null), e5 = i.useRef(null);
  ...
  } = eP(Z, Y, e9, G), ts = Y.toolbarType === J.OW.STATIC, tl = !B.dN.useSetting() && !(0, X.isAndroidWeb)() && null != window.ResizeObserver, tc = !tl || !(null == (n = Y.commands) ? void 0 : n.enabled) || !W || R !== eu.GI, tu = (0, L.Z)(), {
    isSubmitButtonEnabled: td,
    fontSize: tf
  } = (0, _.cj)([E.Z], () => ({
    fontSize: E.Z.fontSize,
    isSubmitButtonEnabled: E.Z.isSubmitButtonEnabled
  })), t_ = (0, _.e7)([H.Z], () => H.Z.isEnabled()), tp = i.useRef(R);
  tp.current = R;
  let th = i.useCallback((e, t, n) => {
    var r;
  ...
  } = eN(), tT = eO(tb, Y, e3), tS = ev(e3), tA = eI({
    editorRef: e3,
    disabled: tr,
    textValue: R,
    channelId: Z.id,
  ...
  return (0, r.jsx)(N.f6, {
    ...
    children: (0, r.jsxs)(y.Gt, {
      ...
      children: [tF && ts ? (0, r.jsx)(el.Z, {
        ...
        children: [tz || tq ? null : (0, r.jsx)(er.Z, {
          bars: tZ
        }), (0, r.jsxs)("div", {
          ref: e4,
          onScroll: tC,
          ...
          children: [(0, r.jsx)(et.Z, {
            channelId: Z.id,
            chatInputType: Y
          }), Y.hideAttachmentArea ? null : (0, r.jsx)(ea.Z, {
            channelId: Z.id,
            type: Y,
            canAttachFiles: ti
          }), (0, r.jsxs)("div", {
            ...
            onMouseDown: tj,
            children: [e$ ? null : tB, (0, r.jsx)(p.tEY, {
              ringTarget: e1,
        ...
        }), e$ && !Y.hideAccessoryBar ? t0 : null, tc ? null : (0, r.jsx)(I.Z, {
          ref: e2,
          channel: Z,
          canOnlyUseTextCommands: tU
        }), (0, r.jsx)(S.Z, {
