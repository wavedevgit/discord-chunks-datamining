...
function eE(e, t, o, a, s) {
  let [l, c] = i.useState(!1), u = i.useCallback((i, d, f, _, m) => {
    ...
    if (l) return;
    c(!0);
    let y = null != (E = null == (g = x.Z.getStickerPreview(s, t.drafts.type)) ? void 0 : g.map(e => e.id)) ? E : [],
    ...
    e({
      ...
      d && (em(s) ? h.Z.saveDraft(s, "", t.drafts.type) : f && (null == (r = o.current) || r.clearValue(), null == (i = a.current) || i.hide())), f && (c(!1), (0, N._Q)(), u && (null == (n = o.current) || n.focus()))
    })
  }, [o, a, e, l, t, s]);
  return {
    submitting: l,
...
function eb(e, t, n) {
  return i.useCallback(r => {
    var i, o;
    t === X.Ie.CREATE_FORUM_POST || t === X.Ie.CREATE_ANNOUNCEMENT_POST ? null == (o = n.current) || o.insertGIF(r) : e(r.url, void 0, void 0, !0), (0, N._Q)(), null == (i = n.current) || i.focus()
  }, [n, e, t])
}
...
function eC(e, t, n, r) {
  let i = e.getGuildId(),
    ...
    a = (0, _.e7)([G.ZP, H.default], () => {
      ...
      return null != (t = null != i && null != n ? null == (e = G.ZP.getMember(i, n.id)) ? void 0 : e.isPending : null) && t
    }),
    s = (0, _.cj)([B.Z], () => {
      var i, o;
      let s = e.isPrivate(),
        ...
        u = (!(null == (i = t.permissions) ? void 0 : i.requireCreateTherads) || c) && (!(null == (o = t.permissions) ? void 0 : o.requireSendMessages) || f.e$(l, es.Plq.SEND_MESSAGES)),
...
function ew(e, t) {
  let [n, r] = i.useState(null), o = i.useCallback(() => {
    var e, n;
    let i, o = null == (e = t.current) ? void 0 : e.getSlateEditor();
    null != o && (i = null == (n = eo.bN.getSelectedParentOfType(o, S.un)) ? void 0 : n[0].type), r(null != i ? i : null)
  }, [t]);
...
function eD(e, t) {
  ...
  let {
    ...
    return {
      ...
      activeCommandSection: (null == (t = j.commands) ? void 0 : t.enabled) ? v.Z.getActiveCommandSection(k.id) : null
    }
  }), {
    isLurking: e2,
    isPendingMember: e3,
  ...
  } = eC(k, j, e0, L), e7 = j.toolbarType === X.OW.STATIC, e9 = !U.dN.useSetting() && !(0, z.isAndroidWeb)() && null != window.ResizeObserver, te = !e9 || !(null == (n = j.commands) ? void 0 : n.enabled) || !G || f !== el.GI, tt = (0, w.Z)(), {
    fontSize: tn
  } = (0, _.cj)([g.Z], () => ({
  ...
  let to = i.useCallback((e, t, n) => {
    var r;
    t === el.GI && "" === ti.current && (null == (r = j.commands) ? void 0 : r.enabled) && (null == eV || eV()), null == W || W(e, t, n)
  ...
  let tR = null != Y,
    ...
    tw = null;
  null != e0 ? tw = null == V ? void 0 : V(e0, e1, eu.attachButton) : (!e5 || e6) && (tw = null == Z ? void 0 : Z(tR, eu.attachButton));
