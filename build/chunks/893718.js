...
function em(e, t, a, o, s) {
  let [l, c] = i.useState(!1), u = i.useCallback((i, d, _, f, m) => {
    var g, E, b;
    if (l) return;
    c(!0);
...
function eR(e, t) {
  ...
  } = eA(M, U, e$, L), e8 = U.toolbarType === q.OW.STATIC, e7 = !j.dN.useSetting() && !(0, K.isAndroidWeb)() && null != window.ResizeObserver, e9 = !e7 || !(null == (n = U.commands) ? void 0 : n.enabled) || !G || _ !== eo.GI, te = (0, P.Z)(), {
    fontSize: tt
  } = (0, f.cj)([g.Z], () => ({
