...
function eR(e, t) {
  ...
  let {
    ...
    parseCustomEmojisForCharCount: eH = !1
  } = e;
  c()(null != U, "chat input type must be set");
  let {
    analyticsLocations: eY
  } = (0, b.ZP)(E.Z.CHANNEL_TEXT_AREA), eW = eT(t), eK = i.useRef(null), ez = i.useRef(null), eq = i.useRef(null), eX = i.useRef(null);
  ...
  } = eA(k, U, e0, L), e7 = U.toolbarType === q.OW.STATIC, e9 = !j.dN.useSetting() && !(0, K.isAndroidWeb)() && null != window.ResizeObserver, te = !e9 || !(null == (n = U.commands) ? void 0 : n.enabled) || !G || _ !== eo.GI, tt = (0, P.Z)(), {
    fontSize: tn
  } = (0, f.cj)([g.Z], () => ({
    fontSize: g.Z.fontSize
  })), tr = (0, f.e7)([V.Z], () => V.Z.isEnabled()), ti = i.useRef(_);
  ti.current = _;
  ...
  } = eI(), tp = eg(tc, U, ez), th = eE(ez), tm = eb({
    editorRef: ez,
    disabled: e4,
    textValue: _,
    channelId: k.id,
