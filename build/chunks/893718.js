  ...
  let [s, l] = i.useState(!1), c = i.useCallback((i, u, d, f, _) => {
    ...
    if (null == u && !f && !_ && (0, L.CB)(y, o)) {
      l(!1), (0, p.ZDy)(async () => {
        let {
          default: e
        } = await Promise.all([n.e("25292"), n.e("90508"), n.e("95477"), n.e("28467"), n.e("22173"), n.e("75450")]).then(n.bind(n, 273602));
    ...
    e({
      ...
      let {
        shouldClear: i,
        shouldRefocus: s
      } = e, c = eO(i, t), u = null != a.current;
      c && (ev(o) ? h.Z.saveDraft(o, "", t.drafts.type) : u && (null == (r = a.current) || r.clearValue())), u && (l(!1), (0, P._Q)(), s && (null == (n = a.current) || n.focus()))
    })
  }, [a, e, s, t, o]);
  return {
    submitting: s,
...
function eA(e) {
  ...
  return i.useCallback((e, i) => {
    var c, u;
    n || ((0, V.Hc)(i, r, a, o.drafts.type) ? ((0, ea._H)({
      sticker: e,
      stickerSelectLocation: i,
      isReplacement: null != G.Z.getStickerPreview(a, o.drafts.type),
      analyticsLocations: l
    }), (0, B.eu)(a, e, o.drafts.type)) : (s({
      value: "",
      uploads: void 0,
      stickers: [e.id]
...
function eN(e, t) {
  return i.useCallback((n, r, i) => {
    let a = e.current;
    null != n && null != a && (Q.default.track(ef.rMx.SOUNDMOJI_SELECT, {
      channel_id: t.id,
      guild_id: t.guild_id,
...
function ex(e, t, n) {
  let [r, a] = (0, P.Iu)(e => [e.activeView, e.activeViewType], u.X), o = (0, _.e7)([v.Z], () => v.Z.shouldShowPopup() && v.Z.activeViewType() === e), s = (0, C.Q3)("ChannelTextAreaContainer");
  i.useEffect(() => () => {
    (0, P._Q)(e)
  }, [e]);
...
function ej(e, t) {
  var n, a, s, l, u, f, h, v, P, w, L, x, j, G, B;
  let {
    textValue: V,
    richValue: F,
    className: H,
    ...
    renderAppLauncherButton: eb,
    renderAppCommandButton: ev,
  ...
  } = eL(ea, ep, tu, Q), tE = ep.toolbarType === et.OW.STATIC, tb = !Z.dN.useSetting() && !(0, $.isAndroidWeb)() && null != window.ResizeObserver, ty = !tb || !(null == (n = ep.commands) ? void 0 : n.enabled) || !em || V !== e_.GI, tv = (0, M.Z)(), {
  ...
  } = eR(), tM = eS(tR, ep, tr), tk = eT(tr), tj = eA({
    editorRef: tr,
    disabled: tp,
    textValue: V,
    channelId: ea.id,
  ...
  let tJ = tb && null != F && !tp && ep.showCharacterCount && null == tu,
    ...
    nn = e9 ? tp ? null : (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [null == eO ? void 0 : eO(), tX, t5 ? (0, r.jsx)(m.Z, {
          channel: ea,
          poggermodeEnabled: !1
        }) : null]
      }), (0, r.jsxs)("div", {
  ...
  return (0, r.jsx)(N.f6, {
    ...
    children: (0, r.jsxs)(y.Gt, {
      ...
      children: [t$ && tE ? (0, r.jsx)(ed.Z, {
        ...
        children: [t6 || t8 ? null : (0, r.jsx)(eo.Z, {
          bars: t1
        }), (0, r.jsxs)("div", {
          ref: ti,
          onScroll: tG,
          ...
          children: [(0, r.jsx)(ei.Z, {
            ...
            children: [e9 ? null : tX, (0, r.jsx)(p.tEY, {
              ...
              children: [t4 ? (0, r.jsx)(A.Z, {
                channel: ea
              }) : null, null != (x = null == ev ? void 0 : ev()) ? x : null, (null == (l = ep.submit) ? void 0 : l.button) != null && ((null == (u = ep.submit) ? void 0 : u.ignorePreference) || tO) ? (0, r.jsx)(er.Z, {
                onClick: tw,
                disabled: tp || t3
              }) : null]
            }) : ne]
          })]
        }), e9 && !ep.hideAccessoryBar ? nn : null, ty ? null : (0, r.jsx)(I.Z, {
          ref: tn,
          channel: ea,
          canOnlyUseTextCommands: tq
        }), (0, r.jsx)(T.Z, {
