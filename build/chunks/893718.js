...
function eR(e, t) {
  ...
  } = eA(k, U, e0, L), e7 = U.toolbarType === q.OW.STATIC, e9 = !j.dN.useSetting() && !(0, K.isAndroidWeb)() && null != window.ResizeObserver, te = !e9 || !(null == (n = U.commands) ? void 0 : n.enabled) || !G || f !== eo.GI, tt = (0, P.Z)(), {
    fontSize: tn
  } = (0, _.cj)([g.Z], () => ({
