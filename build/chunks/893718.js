  ...
  let [s, l] = i.useState(!1), c = i.useCallback((i, u, d, f, _) => {
    ...
    if (null == u && !f && !_ && (0, L.CB)(y, a)) {
      l(!1), (0, p.ZDy)(async () => {
        let {
          default: e
        } = await Promise.all([n.e("25292"), n.e("90508"), n.e("28467"), n.e("22173"), n.e("40694"), n.e("27115")]).then(n.bind(n, 273602));
...
function ex(e, t, n) {
  let [r, o] = (0, P.Iu)(e => [e.activeView, e.activeViewType], u.X), a = (0, _.e7)([O.Z], () => O.Z.shouldShowPopup() && O.Z.activeViewType() === e), s = (0, C.Q3)("ChannelTextAreaContainer");
  i.useEffect(() => () => {
    (0, P._Q)(e)
  }, [e]);
...
function ej(e, t) {
  ...
  let {
    ...
    renderAppCommandButton: eO,
    renderLeftAccessories: ev,
    pendingReply: ej,
    onChange: eU,
    onResize: eG,
    onBlur: eB,
  ...
  } = (0, y.ZP)(b.Z.CHANNEL_TEXT_AREA), e9 = (0, C.R6)("ChannelTextAreaContainer"), te = (0, C.Q3)("ChannelTextAreaContainer"), tt = ew(t), tn = i.useRef(null), tr = i.useRef(null), ti = i.useRef(null), to = i.useRef(null);
  ...
  } = eL(eo, ep, tu, Q), tE = ep.toolbarType === et.OW.STATIC, tb = !Z.dN.useSetting() && !(0, $.isAndroidWeb)() && null != window.ResizeObserver, ty = !tb || !(null == (n = ep.commands) ? void 0 : n.enabled) || !em || F !== e_.GI, tO = (0, k.Z)(), {
  ...
  } = eR(), tk = eS(tR, ep, tr), tM = eT(tr), tj = eA({
    editorRef: tr,
    disabled: tp,
    textValue: F,
    channelId: eo.id,
  ...
  let tJ = tb && null != V && !tp && ep.showCharacterCount && null == tu,
    ...
    nn = e9 ? tp ? null : (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [null == ev ? void 0 : ev(), tX, t5 ? (0, r.jsx)(m.Z, {
          channel: eo,
          poggermodeEnabled: !1
        }) : null]
      }), (0, r.jsxs)("div", {
  ...
  return (0, r.jsx)(N.f6, {
    ...
    children: (0, r.jsxs)(y.Gt, {
      ...
      children: [t$ && tE ? (0, r.jsx)(ed.Z, {
        ...
        children: [t6 || t8 ? null : (0, r.jsx)(ea.Z, {
          bars: t1
        }), (0, r.jsxs)("div", {
          ref: ti,
          onScroll: tG,
          ...
          children: [(0, r.jsx)(ei.Z, {
            ...
            children: [e9 ? null : tX, (0, r.jsx)(p.tEY, {
              ...
              children: [t4 ? (0, r.jsx)(A.Z, {
                channel: eo
              }) : null, null != (x = null == eO ? void 0 : eO()) ? x : null, (null == (l = ep.submit) ? void 0 : l.button) != null && ((null == (u = ep.submit) ? void 0 : u.ignorePreference) || tv) ? (0, r.jsx)(er.Z, {
                onClick: tw,
                disabled: tp || t3
              }) : null]
            }) : ne]
