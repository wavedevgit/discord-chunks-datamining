...
function ex(e, t, n) {
  let [r, o] = (0, R.Iu)(e => [e.activeView, e.activeViewType], u.X), a = (0, _.e7)([O.Z], () => O.Z.shouldShowPopup() && O.Z.activeViewType() === e), s = (0, C.Q3)("ChannelTextAreaContainer");
  i.useEffect(() => () => {
    (0, R._Q)(e)
  }, [e]);
...
function ej(e, t) {
  ...
  } = eL(eo, ep, tu, Q), tE = ep.toolbarType === et.OW.STATIC, tb = !Z.dN.useSetting() && !(0, $.isAndroidWeb)() && null != window.ResizeObserver, ty = !tb || !(null == (n = ep.commands) ? void 0 : n.enabled) || !em || V !== e_.GI, tO = (0, M.Z)(), {
