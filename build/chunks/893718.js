  ...
  let [s, l] = i.useState(!1), c = i.useCallback((i, u, d, f, _) => {
    ...
    if (null == u && !f && !_ && (0, C.CB)(y, o)) {
      l(!1), (0, p.ZDy)(async () => {
        let {
          default: e
        } = await Promise.all([n.e("25292"), n.e("90508"), n.e("28467"), n.e("38626"), n.e("40694"), n.e("56179"), n.e("22173"), n.e("21815")]).then(n.bind(n, 273602));
...
function ey(e, t) {
  return i.useCallback((n, r, i) => {
    let a = e.current;
    null != n && null != a && (H.default.track(ea.rMx.SOUNDMOJI_SELECT, {
      channel_id: t.id,
      guild_id: t.guild_id,
      sound_guild_id: n.guildId,
      sound_id: n.soundId,
      source: r
    }), a.insertSound(n)), i && (0, A._Q)(), null == a || a.focus()
  }, [e, t.id, t.guild_id])
}
...
function eR(e, t) {
  ...
  let {
    ...
    "aria-labelledby": ex,
    setEditorRef: ek,
    autoCompletePosition: eM,
    children: ej,
    disableThemedBackground: eU = !1,
    emojiPickerCloseOnModalOuterClick: eG,
    parentModalKey: eB,
  ...
  } = eA(M, U, eJ, L), e6 = U.toolbarType === q.OW.STATIC, e8 = !j.dN.useSetting() && !(0, K.isAndroidWeb)() && null != window.ResizeObserver, e7 = !e8 || !(null == (n = U.commands) ? void 0 : n.enabled) || !G || f !== eo.GI, e9 = (0, P.Z)(), {
    fontSize: te
  } = (0, _.cj)([g.Z], () => ({
    fontSize: g.Z.fontSize
  })), tt = (0, _.e7)([V.Z], () => V.Z.isEnabled()), tn = i.useRef(f);
  tn.current = f;
  let tr = i.useCallback((e, t, n) => {
    var r;
  ...
  let {
  ...
  } = eI(), tf = eg(ts, U, eW), t_ = eE(eW), tp = eb({
    editorRef: eW,
    disabled: e2,
    textValue: f,
    channelId: M.id,
    ...
    handleTab: tb,
    handleEnter: ty,
    handleMoveSelection: tO
  } = eC(tc, eY, e7), {
    expressionPickerView: tv,
    shouldHideExpressionPicker: tI,
