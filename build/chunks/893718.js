...
function ex(e, t, n) {
  let [r, o] = (0, P.Iu)(e => [e.activeView, e.activeViewType], u.X), a = (0, _.e7)([v.Z], () => v.Z.shouldShowPopup() && v.Z.activeViewType() === e), s = (0, C.Q3)("ChannelTextAreaContainer");
  i.useEffect(() => () => {
    (0, P._Q)(e)
  }, [e]);
...
function ej(e, t) {
  ...
  } = eR(), tM = eS(tR, ep, tr), tk = eT(tr), tj = eN({
    editorRef: tr,
    disabled: tp,
    textValue: V,
    channelId: eo.id,
