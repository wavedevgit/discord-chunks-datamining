...
function M(e) {
  ...
  return t.completed && (n = Z, i = A.intl.string(A.t.f6RTAA)), (0, r.jsxs)("div", {
...
let U = i.memo(function(e) {
    ...
    } = (0, c.ZP)(), m = (0, S.I)(l, s), h = i.useCallback(async () => {
      if (m || (0, x.wt)(l), null != l.item_enum && l.item_enum === v.AM.FIND_FRIENDS) return void(0, a.ZDy)(async () => {
        let {
          default: e
    ...
    l.type === v.O7.INCOMING_FRIEND_REQUESTS && null != l.other_user ? g = (0, r.jsx)(N.Z, {
      userId: l.other_user.id
    }) : l.type === v.O7.INCOMING_GAME_FRIEND_REQUESTS && null != l.other_user && (g = (0, r.jsx)(N.Z, {
      userId: l.other_user.id,
