...
let M = i.memo(function(e) {
    ...
    let {
      ...
      if (p || (0, y.wt)(l), null != l.item_enum && l.item_enum === v.AM.FIND_FRIENDS) return void(0, a.ZDy)(async () => {
        let {
          default: e
    ...
    l.type === v.O7.INCOMING_FRIEND_REQUESTS && null != l.other_user ? h = (0, r.jsx)(I.Z, {
      userId: l.other_user.id
    }) : l.type === v.O7.INCOMING_GAME_FRIEND_REQUESTS && null != l.other_user && (h = (0, r.jsx)(I.Z, {
      userId: l.other_user.id,
