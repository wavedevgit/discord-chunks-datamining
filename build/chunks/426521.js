...
function R(e) {
  ...
  let {
    item: l
  } = e, s = null == (t = l.message) ? void 0 : t.content;
...
function D(e) {
  ...
  return t.completed && (n = w, i = P.intl.string(P.t.f6RTAA)), (0, r.jsxs)("div", {
...
let M = i.memo(function(e) {
    ...
    let {
      ...
      if (p || (0, y.wt)(l), null != l.item_enum && l.item_enum === x.AM.FIND_FRIENDS) return void(0, a.ZDy)(async () => {
        let {
          default: e
      ...
      if (null != l.deeplink) {
        let t = E.Z.safeParseWithQuery(l.deeplink);
        if (null == t) return;
        let n = t.hostname,
          r = t.path;
        if (null == n || null == r) return;
        if (E.Z.isDiscordHostname(n)) {
    ...
    l.type === x.O7.INCOMING_FRIEND_REQUESTS && null != l.other_user ? h = (0, r.jsx)(I.Z, {
      userId: l.other_user.id
    }) : l.type === x.O7.INCOMING_GAME_FRIEND_REQUESTS && null != l.other_user && (h = (0, r.jsx)(I.Z, {
      userId: l.other_user.id,
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)(a.kL8, {
        ...
        children: [p ? null : (0, r.jsx)("div", {
          ...
          }), (null == (t = l.message) ? void 0 : t.content) != null ? (0, r.jsx)(R, {
            item: l
          }) : null, null != l.callout ? (0, r.jsx)(k, {
            item: l
          }) : null, (0, r.jsx)(a.Text, {
