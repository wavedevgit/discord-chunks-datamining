...
let _ = e => {
  ...
  return <d.ZP title={x.intl.formatToPlainString(x.t["Q1o/f3"], {
      username: v
    })} description={x.intl.string(x.t.G08MKi)} buttonText={h ? x.intl.string(x.t.ot2tSk) : x.intl.string(x.t["l+7PZW"])} buttonDisabled={h} onButtonPress={j} buttonColor={"application" === b.name && h ? a.zx.Colors.WHITE : a.zx.Colors.RED} buttonLook={"application" === b.name && h ? a.zx.Looks.LINK : a.zx.Looks.FILLED} />
}