...
function m() {
  ...
  return <div className={Chunk596993.container}>{require}{require.length > 0 && p && m && <Chunk481060.ua7 text={Chunk388032.intl.string(Chunk388032.t.L99HQk)}>{e => (0, i.jsx)(s.Mgn, function(e) {
