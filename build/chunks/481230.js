...
function f(e) {
  ...
  if (s.Z.dispatch({
    ...
    (0, h.Z)(b, p.jXE.REGISTER), u.default.track(p.rMx.AGE_GATE_ACTION, {
  ...
  return d.Z.post({
    ...
    let t = new a.Z(e);
    throw null != t.getFieldErrors("date_of_birth") && o.wE(g.L0.REGISTER), u.default.track(p.rMx.REGISTER_SUBMIT_ERRORED, {
