...
function m(e) {
  ...
  if (a.Z.dispatch({
    ...
    (0, p.Z)(x, g.jXE.REGISTER), u.default.track(g.rMx.AGE_GATE_ACTION, {
  ...
  return d.Z.post({
    ...
    let t = new l.Z(e);
    throw null != t.getFieldErrors("date_of_birth") && s.wE(h.L0.REGISTER), u.default.track(g.rMx.REGISTER_SUBMIT_ERRORED, {
