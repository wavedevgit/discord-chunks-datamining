...
function _(e) {
  ...
  if (s.Z.dispatch({
    ...
    (0, p.Z)(E, m.jXE.REGISTER), d.default.track(m.rMx.AGE_GATE_ACTION, {
  ...
  return h.Z.post({
    ...
    let t = new o.Z(e);
    throw null != t.getFieldErrors("date_of_birth") && a.wE(f.L0.REGISTER), d.default.track(m.rMx.REGISTER_SUBMIT_ERRORED, {
