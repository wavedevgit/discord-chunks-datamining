/** Chunk was on web.js **/
/** chunk id: 873298, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  AN: () => g,
  Ar: () => S,
  ...
  oP: () => eY,
  wL: () => eB
}), require("./734808.js"), require("./896048.js"), require("./65821.js"), require("./927092.js"), require("./212978.js"), require("./201528.js"), require("./393431.js"), require("./752391.js"), require("./532706.js"), require("./42231.js"), require("./232424.js"), require("./757074.js"), require("./949626.js"), require("./767709.js"), require("./65162.js"), require("./321073.js");
    ...
    for (; e.pos < s;) {
      ...
      switch (t) {
        ...
        case 20:
          ...
          break;
        case 21:
          a.safetySettings = e6.internalBinaryRead(e, e.uint32(), n, a.safetySettings);
          break;
        case 22:
          a.icymiSettings = e8.internalBinaryRead(e, e.uint32(), n, a.icymiSettings);
          break;
        case 23:
...
class x extends Chunk324281.G {
  ...
  internalBinaryWrite(e, t, n) {
    0 !== e.currentTab && t.tag(1, r.O0.Varint).int32(e.currentTab), false !== e.viewedTutorial && t.tag(2, r.O0.Varint).bool(e.viewedTutorial);
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.f$.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
class H extends Chunk324281.G {
  ...
  internalBinaryWrite(e, t, n) {
    false !== e.collapsedInInbox && t.tag(1, r.O0.Varint).bool(e.collapsedInInbox), e.iconEmoji && B.internalBinaryWrite(e.iconEmoji, t.tag(2, r.O0.LengthDelimited).fork(), n).join(), e.customNotificationSoundConfig && K.internalBinaryWrite(e.customNotificationSoundConfig, t.tag(3, r.O0.LengthDelimited).fork(), n).join();
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.f$.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
class J extends Chunk324281.G {
  ...
  internalBinaryWrite(e, t, n) {
    false !== e.useBlur && t.tag(1, r.O0.Varint).bool(e.useBlur);
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.f$.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
let ee = new J;
class et extends Chunk324281.G {
  create(e) {
    let t = {
...
let en = new et;
class er extends Chunk324281.G {
  create(e) {
    let t = {
...
let eu = new ec;
class ed extends Chunk324281.G {
  create(e) {
    let t = {
...
let ef = new ed;
class ep extends Chunk324281.G {
  create(e) {
    let t = {
...
let e_ = new ep;
class eh extends Chunk324281.G {
  create(e) {
    let t = {
      restrictedGuildIds: [],
...
let em = new eh;
class eg extends Chunk324281.G {
  create(e) {
    let t = {};
    return globalThis.Object.defineProperty(t, a.$, {
      enumerable: false,
...
let eD = new eP;
class ex extends Chunk324281.G {
  create(e) {
    let t = {};
    return globalThis.Object.defineProperty(t, a.$, {
      enumerable: false,
...
let eL = new ex;
class ej extends Chunk324281.G {
  create(e) {
    let t = {
      folders: [],
      guildPositions: []
...
let eM = new ej;
class ek extends Chunk324281.G {
  create(e) {
    let t = {
      guildIds: []
    };
...
class eG extends Chunk324281.G {
  ...
  internalBinaryWrite(e, t, n) {
    ...
    false !== e.muted && t.tag(2, r.O0.Varint).bool(e.muted);
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.f$.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
let eV = new eG;
class eF extends Chunk324281.G {
  create(e) {
    let t = {
      nickname: "",
      type: 0,
...
class eH extends Chunk324281.G {
  ...
  internalBinaryWrite(e, t, n) {
    false !== e.muted && t.tag(1, r.O0.Varint).bool(e.muted), 0 !== e.volume && t.tag(2, r.O0.Bit32).float(e.volume), "0" !== e.modifiedAt && t.tag(3, r.O0.Bit64).fixed64(e.modifiedAt), false !== e.soundboardMuted && t.tag(4, r.O0.Varint).bool(e.soundboardMuted);
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.f$.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
let eY = new eH;
class eW extends Chunk324281.G {
  create(e) {
    let t = {
      user: {},
      stream: {}
...
let eK = new eW;
class ez extends Chunk324281.G {
  create(e) {
    let t = {};
    return globalThis.Object.defineProperty(t, a.$, {
      enumerable: false,
...
let eZ = new eX;
class eQ extends Chunk324281.G {
  create(e) {
    let t = {
      soundId: "0",
      guildId: "0"
...
let e0 = new eJ;
class e1 extends Chunk324281.G {
  create(e) {
    let t = {};
    return globalThis.Object.defineProperty(t, a.$, {
      enumerable: false,
...
let e2 = new e1;
class e3 extends Chunk324281.G {
  create(e) {
    let t = {
  ...
  internalBinaryWrite(e, t, n) {
    0 !== e.safetySettingsPreset && t.tag(1, r.O0.Varint).int32(e.safetySettingsPreset), false !== e.ignoreProfileSpeedbumpDisabled && t.tag(2, r.O0.Varint).bool(e.ignoreProfileSpeedbumpDisabled);
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.f$.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
let e6 = new e3;
class e4 extends Chunk324281.G {
  create(e) {
    let t = {
      currentTab: 0
    };
...
let e5 = new e4;
class e7 extends Chunk324281.G {
  create(e) {
    let t = {
      feedGeneratedAt: "0"
    };
...
let e8 = new e7;
class e9 extends Chunk324281.G {
  create(e) {
    let t = {
      appSettings: {}
    };
  ...
  binaryReadMap1(e, t, n) {
    ...
    for (; t.pos < i;) {
      ...
      switch (e) {
        case 1:
          ...
          break;
        case 2:
          s = tn.internalBinaryRead(t, t.uint32(), n);
          break;
        default:
    ...
    e[null != a ? a : "0"] = null != s ? s : tn.create()
  }
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.appSettings)) t.tag(1, r.O0.LengthDelimited).fork().tag(1, r.O0.Bit64).fixed64(i), t.tag(2, r.O0.LengthDelimited).fork(), tn.internalBinaryWrite(e.appSettings[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.f$.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
let te = new e9;
class tt extends Chunk324281.G {
  create(e) {
    let t = {};
    return globalThis.Object.defineProperty(t, a.$, {
      enumerable: false,
    ...
    for (; e.pos < s;) {
      ...
      switch (t) {
        case 1:
          ...
          break;
        case 2:
          a.appSharingSettings = ts.internalBinaryRead(e, e.uint32(), n, a.appSharingSettings);
          break;
        default:
          let s = n.readUnknownField;
          if ("throw" === s) throw new globalThis.Error("Unknown field ".concat(t, " (wire type ").concat(i, ") for ").concat(this.typeName));
  ...
  internalBinaryWrite(e, t, n) {
    e.appDmSettings && ti.internalBinaryWrite(e.appDmSettings, t.tag(1, r.O0.LengthDelimited).fork(), n).join(), e.appSharingSettings && ts.internalBinaryWrite(e.appSharingSettings, t.tag(2, r.O0.LengthDelimited).fork(), n).join();
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.f$.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
let tn = new tt;
class tr extends Chunk324281.G {
  create(e) {
    let t = {
  ...
  internalBinaryWrite(e, t, n) {
    false !== e.allowMobilePush && t.tag(2, r.O0.Varint).bool(e.allowMobilePush);
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.f$.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
let ti = new tr;
class ta extends Chunk324281.G {
  create(e) {
    let t = {
  ...
  internalBinaryWrite(e, t, n) {
    false !== e.disableApplicationActivitySharing && t.tag(1, r.O0.Varint).bool(e.disableApplicationActivitySharing);
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.f$.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
let ts = new ta;
class to extends Chunk324281.G {
  create(e) {
    let t = {
      alwaysDeliver: false
    };
  ...
  internalBinaryWrite(e, t, n) {
    false !== e.alwaysDeliver && t.tag(1, r.O0.Varint).bool(e.alwaysDeliver);
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.f$.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
let tl = new to;
class tc extends Chunk324281.G {
  create(e) {
    let t = {};
    return globalThis.Object.defineProperty(t, a.$, {
      enumerable: false,
...
let tu = new tc;
class td extends Chunk324281.G {
  create(e) {
    let t = {};
    return globalThis.Object.defineProperty(t, a.$, {
      enumerable: false,
...
let tf = new td;
class tp extends Chunk324281.G {
  create(e) {
    let t = {
      inAppFeedbackStates: {}
    };
  ...
  binaryReadMap1(e, t, n) {
    ...
    for (; t.pos < i;) {
      ...
      switch (e) {
        case 1:
          ...
          break;
        case 2:
          s = tu.internalBinaryRead(t, t.uint32(), n);
          break;
        default:
    ...
    e[null != a ? a : 0] = null != s ? s : tu.create()
  }
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.inAppFeedbackStates)) t.tag(1, r.O0.LengthDelimited).fork().tag(1, r.O0.Varint).int32(parseInt(i)), t.tag(2, r.O0.LengthDelimited).fork(), tu.internalBinaryWrite(e.inAppFeedbackStates[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    returnfalse !== i && (true == i ? r.f$.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
