...
function E(e) {
  ...
  return (0, i.jsxs)(l.Drp, {
    ...
    children: [function(e) {
      let [t, n] = r.useState(false), [E, S] = r.useState(false), _ = (0, s.bG)([b.Ay], () => b.Ay.getGuildUnreadSetting(e)), j = (0, s.bG)([b.Ay], () => b.Ay.getMessageNotifications(e)), N = E ? g.N9.CUSTOM : (0, g.jU)(_, j), v = t => {
        S(false);
        let n = {
      ...
      return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsxs)(l.rXV, {
          children: [(0, i.jsx)(l.iDA, {
            ...
            action: () => ((0, d.i)(e, g.N9.ALL_MESSAGES), S(false))
          }), (0, i.jsx)(l.iDA, {
            id: "essentials",
            group: "notification-preset",
            checked: N === g.N9.MENTIONS,
            label: f.intl.string(f.t.y59NJm),
            action: () => ((0, d.i)(e, g.N9.MENTIONS), S(false))
          }), (0, i.jsx)(l.iDA, {
            id: "nothing",
            group: "notification-preset",
            checked: N === g.N9.NOTHING,
            label: f.intl.string(f.t["pGn/bJ"]),
            action: () => ((0, d.i)(e, g.N9.NOTHING), S(false))
          }), (0, i.jsx)(l.iDA, {
            id: "custom",
            group: "notification-preset",
            checked: N === g.N9.CUSTOM,
            action: () => (n(true), S(true)),
          ...
          children: [(0, i.jsxs)(l.Drp, {
            ...
            children: [(0, i.jsx)(l.iDA, {
              ...
              subtext: _ !== y.e.ONLY_MENTIONS && j === h.orn.ALL_MESSAGES ? f.intl.string(f.t.eP8yWU) : true
            })]
            ...
            children: [(0, i.jsx)(l.iDA, {
              ...
              subtext: _ !== y.e.ALL_MESSAGES && j !== h.orn.ALL_MESSAGES ? f.intl.string(f.t.idXSbI) : true
            }), (0, i.jsx)(l.iDA, {
              group: "notification-preset",
