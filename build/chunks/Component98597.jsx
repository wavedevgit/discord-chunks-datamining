...
function Z(e) {
  ...
  return (0, s.e7)([O.Z, v.Z], () => n || v.Z.getGuildId() === C.I_8 || !O.Z.can(C.Plq.MANAGE_CHANNELS, t) && !O.Z.can(C.Plq.MANAGE_ROLES, t) && !O.Z.can(C.Plq.MANAGE_WEBHOOKS, t) || (0, b.r8)(t.type) && !O.Z.can(C.Plq.VIEW_CHANNEL, t) || t.isGuildVocal() && !O.Z.can(C.Plq.CONNECT, t) || !b.dF.has(t.type) || t.isModeratorReportChannel()) ? null : (0, i.jsx)(c.u, {
    asContainer: true,
...
function w(e) {
  ...
  } = e, v = (0, s.e7)([y.Z], () => y.Z.getGuild(t.getGuildId())), j = (0, s.e7)([g.Z], () => g.Z.getStageInstanceByChannel(t.id), [t.id]), S = (0, s.e7)([f.ZP], () => f.ZP.getActiveEventByChannel(t.id), [t.id]), P = (0, s.e7)([O.Z], () => (0, h.b)(O.Z, v, t, j)), N = (0, s.e7)([], () => (null == t ? true : t.type) === C.d4z.GUILD_VOICE ? x.intl.string(x.t["EE+P0H"]) : x.intl.string(x.t["0jeAXt"])), Z = l.useRef(null);
