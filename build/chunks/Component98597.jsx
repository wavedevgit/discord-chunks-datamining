...
function T(e) {
  ...
  if ((0, s.e7)([y.Z, j.Z], () => n || j.Z.getGuildId() === x.I_8 || !y.Z.can(x.Plq.MANAGE_CHANNELS, t) && !y.Z.can(x.Plq.MANAGE_ROLES, t) && !y.Z.can(x.Plq.MANAGE_WEBHOOKS, t) || (0, b.r8)(t.type) && !y.Z.can(x.Plq.VIEW_CHANNEL, t) || t.isGuildVocal() && !y.Z.can(x.Plq.CONNECT, t) || !b.dF.has(t.type) || t.isModeratorReportChannel())) return null;
