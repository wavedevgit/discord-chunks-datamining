...
function N(e) {
  ...
  } = (0, O.B)(), n = (0, i.useCallback)(() => {
    o.default.selectPrivateChannel(e.id), t(e.id), u.default.track(b.rMx.CHAT_WALLPAPER_DM_CONTEXT_MENU_ENTRY_POINT_CLICKED, {
      channel_id: e.id
    })
  }, [e.id, t]), {
    canAccessPicker: N,
  ...
  return ((0, c.Z)({
    ...
    label: (0, r.jsxs)("div", {
      className: h.label,
      children: [p.NW.string(p.t.GixvUl), (0, r.jsx)(a.IGR, {
