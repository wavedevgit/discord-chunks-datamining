...
function W(e) {
  ...
  }, [eh, W]), ej = r.useMemo(() => void 0 !== ex ? [ex, ...eh.filter(e => e.integration.id !== ex.integration.id)] : eh, [eh, ex]), ev = (0, u.s9z)(u.JQI), [eO, ey] = r.useState(!1), e_ = r.useRef(0), eC = () => {
  ...
  let eN = ej.map(e => {
      ...
      return null != l.user ? o.push({
        ...
        hasNextSection: !0,
        onButtonClick: () => {
          J(r.id), C.default.track(P.rMx.APP_MANAGE_CTA_CLICKED, {
            application_id: r.id,
  ...
  if (el) {
    let e, t, r, o, a;
    eE.push((n = F.length, n > 0 ? t = (0, i.jsx)(u.LJT, {
      size: "xs"
    ...
    }, "webhooks"))), (null == H ? void 0 : H.type) === P.d4z.GUILD_VOICE || (null == H ? void 0 : H.type) != null && P.TPd.GUILD_THREADS_ONLY.has(H.type) || eE.push((l = V.length, l > 0 ? (a = (0, i.jsx)(u.LJT, {
      size: "xs"
    }), o = $) : (r = A.intl.string(A.t["ZwSt+f"]), o = () => open(S.Z.getArticleURL(P.BhN.CHANNEL_FOLLOWING))), (0, i.jsx)(w.Z, {
  ...
  null == H && ec.length > 0 && eE.push((a = ec.length, (0, i.jsx)(w.Z, {
    ...
    let r, l, o, a, s = b.Z.get(P.ABu.TWITCH);
    return e > 0 ? (a = (0, i.jsx)(u.LJT, {
      size: "xs"
    }), l = A.intl.formatToPlainString(A.t.FFpnT0, {
      count: t
    }), o = () => n(P.ABu.TWITCH)) : (r = A.intl.string(A.t.bkvGkp), l = A.intl.string(A.t.Qq3X2N), o = () => (0, f.Z)({
    ...
    let r, l, o, a, s = b.Z.get(P.ABu.YOUTUBE);
    return e > 0 ? (a = (0, i.jsx)(u.LJT, {
      size: "xs"
    }), l = A.intl.formatToPlainString(A.t.b2g5vL, {
      count: t
    }), o = () => n(P.ABu.YOUTUBE)) : (r = A.intl.string(A.t.xEyQ3d), l = A.intl.string(A.t.T0ivgY), o = () => (0, f.Z)({
  ...
  return (0, i.jsxs)(u.hjN, {
    ...
    children: [(0, i.jsx)(u.R94, {
      ...
      children: [eE, ew && (0, i.jsxs)(i.Fragment, {
        children: [eE.length > 0 ? (0, i.jsx)(u.$i$, {
          className: D.divider
        }) : null, (0, i.jsx)(u.X6q, {
        ...
        children: [eE.length > 0 || ew ? (0, i.jsx)(u.$i$, {
          className: D.divider
        }) : null, (0, i.jsx)(u.X6q, {
          variant: "heading-md/semibold",
          className: D.sectionHeader,
