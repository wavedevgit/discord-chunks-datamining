...
let C = e => {
  ...
  } = (0, E.Z)(t.id), b = (0, f.Z)(T, t), [G, w] = i.useState(), A = (0, u.e7)([m.default], () => t.isOwner(m.default.getId()), [t]), U = (0, u.e7)([O.Z], () => O.Z.can(t.isThread() ? h.Plq.MANAGE_THREADS : h.Plq.MANAGE_CHANNELS, t), [t]), L = (0, u.e7)([_.Z], () => {
    var e;
