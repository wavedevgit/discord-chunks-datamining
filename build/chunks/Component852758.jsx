...
function T() {
  ...
  })), T = Chunk1964.Z.getVerificationTypes(module), [O, P] = Chunk647438.useState(0), k = (0, Chunk110924.Z)(T);
  (0, Chunk213609.Z)({
  ...
  return Chunk647438.useEffect(() => (Chunk714338.Z.disable(), () => {
    ...
    (null == k ? true : k[0]) === Chunk981631.PUi.PHONE && (null == T ? true : T[0]) === Chunk981631.PUi.EMAIL && (0, Chunk481060.ZDy)(async () => {
      let {
        default: e
  ...
  }, [T, k]), (0, Chunk951288.jsx)(Chunk762756.Z, {
    types: T,
    captchaKey: O,
    onCaptchaVerify: e => {
      s.tn.post({
