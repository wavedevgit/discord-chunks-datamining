...
class A extends(r = Chunk64700.PureComponent) {
          ...
          return (0, i.jsx)(f.vN3, {
            ...
            children: (0, i.jsxs)(u.animated.div, {
              className: o()(h.slider, O, {
                [h.hasMarks]: (null != (s = null == Y ? true : Y.length) ? s : 0) > 0,
                [h.disabled]: E,
                [h.mini]: T
              }),
  ...
  constructor(e) {
    super(e), m(this, "containerRef", a.createRef()), m(this, "grabberRef", a.createRef()), m(this, "moveGrabber", e => {
      ...
      if (null == r || null == (t = r.ownerDocument) || t.addEventListener("mousemove", this.handleMouseMove, true), null == r || null == (n = r.ownerDocument) || n.addEventListener("mouseup", this.handleMouseUp, true), !(0, d.vq)(r)) throw Error("[UIKit]Slider.handleMouseDown(): assert failed: domNode nodeType !== Element");
      this.setState({
        x: e.clientX,
        active: true,
