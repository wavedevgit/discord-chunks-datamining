...
function S() {
  ...
  let R = true,
    D = true;
  return y && 1 === A.length && (A.includes(Chunk726985.s6.PROFILE_SERVER_PROFILES) ? (P(Chunk526761.NB.GUILD), D = false) : A.includes(Chunk726985.s6.PROFILE_USER_PROFILE) && (P(Chunk526761.NB.USER_PROFILE), R = false)), <Chunk481060.y5t component={(0, Chunk255367.jsx)(Chunk481060.X6q, {
      variant: "heading-lg/semibold",
      children: Chunk388032.intl.string(Chunk388032.t["vi7f+v"])
    })}>{<Chunk481060.njP className={Chunk545784.tabBar} type={"top"} look={"brand"} selectedItem={I} onItemSelect={P}>{D ? <Chunk481060.njP.Item className={Chunk545784.tabBarItem} id={Chunk526761.NB.USER_PROFILE}>{Chunk388032.intl.string(Chunk388032.t["2p07FR"])}</Chunk481060.njP.Item> : null}{R ? <Chunk481060.njP.Item className={Chunk545784.tabBarItem} id={Chunk526761.NB.GUILD}>{Chunk388032.intl.string(Chunk388032.t.kPHroa)}</Chunk481060.njP.Item> : null}</Chunk481060.njP>}{I === Chunk526761.NB.GUILD ? <Chunk851894.Z selectedGuild={S} /> : <Chunk216045.Z />}</Chunk481060.y5t>
}