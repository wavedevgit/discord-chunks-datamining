...
function z(e, t) {
  ...
  return null == t ? e : L(x({}, e), {
    presence: L(x({}, e.presence), {
      activity: null != (n = N.Z.getApplicationActivity(e.user.id, t)) ? n : null
    })
  })
}
...
async function J(e, t, n) {
  ...
  if ("string" == typeof n)
    if (e.transport === A.He.POST_MESSAGE) {
      let e = (0, u.ZP)(t);
      if (null == e || !W(n, [e])) throw new P.Z({
        closeCode: Z.$VG.INVALID_ORIGIN
      }, "Invalid Origin")
    } else {
      let e = await X(t);
      if (r = f.ZP.createFromServer(e), !W(n, e.rpc_origins)) throw new P.Z({
        closeCode: Z.$VG.INVALID_ORIGIN
      }, "Invalid Origin")
