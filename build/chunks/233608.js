...
function O(t) {
  ...
  return {
    ...
    SOUNDBOARD_DESCRIPTION: R.intl.format(R.t.fVE8y8, {
      helpCenterArticle: a.Z.getArticleURL(I.BhN.SOUNDBOARD)
    }),
  ...
  generateChannelPermissionSpec: function(t, i, n, E) {
    ...
    switch (i.type) {
      case I.d4z.GUILD_CATEGORY:
        return [A.zO(p, R.intl.string(R.t.AkPxc3)), A.Ny(p, R.intl.string(R.t.Ny49TE)), A.vq(p, R.intl.string(R.t.cKobOz), {
          showPrivateThreads: !0,
          showCreateThreads: !0,
          inSoundmojiExperiment: f,
          inPinPermissionExperiment: U
        }), A.WV(p, R.intl.string(R.t["46Ra1d"])), A.xU(p, R.intl.string(R.t["rrh/W1"])), ...(l = c.showStageChannelPermissions, _ = () => A.kv(p, R.intl.string(R.t.yniaur)), l ? [_()] : []), A.uu(p, R.intl.string(R.t.b8lplZ))];
      case I.d4z.GUILD_VOICE:
        return [A.zO(p, R.intl.string(R.t.ouHggI), {
          showManageWebhooks: !0
        }), A.Ny(p, R.intl.string(R.t.Ny49TE)), A.WV(p, R.intl.string(R.t["46Ra1d"])), A.aW(p, R.intl.string(R.t.iqlsnJ), {
          sectionDescription: C ? R.intl.format(R.t["4Z9FbW"], {
            setUpAutomod: () => {
              S.Z.open(t, I.pNK.GUILD_AUTOMOD)
            }
          }) : void 0,
          inSoundmojiExperiment: f
        }), A.uu(p, R.intl.string(R.t.b8lplZ)), A.xU(p, R.intl.string(R.t["rrh/W1"]))];
      case I.d4z.GUILD_STAGE_VOICE:
        return [A.zO(p, R.intl.string(R.t.ouHggI), {
          showManageWebhooks: !1
        }), A.Ny(p, R.intl.string(R.t.Ny49TE)), A.FX(p, R.intl.string(R.t["46Ra1d"]), u), A.kv(p, R.intl.string(R.t.yniaur)), A.uu(p, R.intl.string(R.t.b8lplZ)), A.aW(p, R.intl.string(R.t.iqlsnJ), {
          sectionDescription: C ? R.intl.format(R.t["4Z9FbW"], {
            setUpAutomod: () => {
              S.Z.open(t, I.pNK.GUILD_AUTOMOD)
            }
      ...
      case I.d4z.GUILD_MEDIA:
        ...
        return [A.zO(p, R.intl.string(R.t.ouHggI)), A.Ny(p, R.intl.string(R.t.Ny49TE)), A.vq(p, L, {
          ...
          inSoundmojiExperiment: f,
          inPinPermissionExperiment: U
        }), A.xU(p, R.intl.string(R.t["rrh/W1"])), ...(T = () => A.WV(p, R.intl.string(R.t["46Ra1d"])), D ? [T()] : [])];
      default:
        return [A.zO(p, R.intl.string(R.t.ouHggI)), A.Ny(p, R.intl.string(R.t.Ny49TE)), A.vq(p, R.intl.string(R.t.cKobOz), {
          showPrivateThreads: i.type !== I.d4z.GUILD_ANNOUNCEMENT,
          showCreateThreads: !0,
          inSoundmojiExperiment: f,
          inPinPermissionExperiment: U
        }), A.xU(p, R.intl.string(R.t["rrh/W1"])), ...(a = () => A.WV(p, R.intl.string(R.t["46Ra1d"])), D ? [a()] : [])]
    }
  },
  generateGuildPermissionSpec: function(t) {
    var i;
    let n = new Set;
    return t.features.has(I.oNc.COMMUNITY) || n.add(I.Plq.VIEW_GUILD_ANALYTICS.toString()), i = A.s4(O(t.id)), 0 === n.size ? i : i.map(t => {
      var i, E;
      return i = function(t) {
