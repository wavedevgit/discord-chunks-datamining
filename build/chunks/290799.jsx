...
let f = [{
  ...
  _ = function(e) {
    ...
    return <div className={a()(d.wrapper, t)}>{<s.X6q className={d.heading} variant={"heading-xxl/bold"}>{u.intl.string(u.t.HPJ6Nj)}</s.X6q>}{<ul className={d.list}>{f.map((e, t) => {
          let i = n === t;
          return (0, r.jsxs)("div", {
