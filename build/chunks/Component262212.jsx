  ...
  return (0, r.jsx)("div", {
    ...
    children: (0, r.jsx)("div", {
      ...
      children: (0, r.jsx)(o.zxk, {
        variant: "primary",
        fullWidth: true,
        text: i.type === p.Us.LEVEL ? g.intl.string(g.t["0Q61kF"]) : g.intl.string(g.t.Xa11Ep),
        onClick: a
      })
    })
  })
...
function v(e) {
  let {
    ...
    powerup: i,
    onError: o
  } = e, s = (0, c.ZP)(n, i).type !== p.A3.INACTIVE, d = (0, a.Z)(n, i, "GuildPowerupCardFooterAdmin"), f = s || !d, h = !s;
  return (0, r.jsxs)("div", {
    className: l()(m.container, t),
