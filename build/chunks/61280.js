...
function O(e) {
  let {
    ...
    selectedChannel: C,
    channelListRow: S
  } = e, j = t.getModeratorReportChannelId(), E = (0, i.e7)([d.Z], () => null == j ? null : d.Z.getChannel(j), [j]), {
    hasUnread: x,
    numUnread: P
  } = (0, i.cj)([p.ZP], () => null == j ? {
    hasUnread: !1,
  ...
  }, [j]), I = (0, i.e7)([u.Z], () => null == j ? 0 : u.Z.getNewThreadCount(t.id, j));
  if (!(0, a._5)(t.id)) return null;
  let w = P > 0 ? _.intl.format(y.default["/wHkWV"], {
      count: P
    }) : _.intl.string(y.default["kI3X9/"]),
    {
      record: N,
      threadIds: Z = [],
      threadCount: T = 0
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(f.m, {
      ...
      showUnread: x,
      trailing: I > 0 ? (0, r.jsx)(l.Text, {
        variant: "text-xs/semibold",
        color: "text-brand",
        children: _.intl.format(_.t.GkAbqa, {
          count: (0, l.NGo)(I)
        })
      }) : null
    }), null != N && T > 0 ? (0, r.jsx)(g.Z, {
      withGuildIcon: !1,
      channel: N,
      sortedThreadIds: Z,
      selectedChannel: C,
