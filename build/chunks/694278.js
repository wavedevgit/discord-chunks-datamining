...
function p(e) {
  ...
  let {
    ...
    onClose: m,
    hideColors: y
  } = e, [_, g] = a.useState(p.verificationLevel), [x, f] = a.useState(null), h = p.features.has(d.oNc.COMMUNITY), j = (0, c.IF)(h, y).filter(e => !e.disabled), v = a.useCallback(async () => {
    null != x && f(null);
    try {
  ...
  return (0, n.jsx)(s.Z, (t = function(e) {
