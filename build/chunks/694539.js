...
let j = {
  ...
  C = e => {
    let {
      ...
      upsertConfig: s
    } = (0, p.E)(), C = (0, o.e7)([m.default], () => m.default.getCurrentUser()), [S, v] = i.useState(!0), T = i.useRef(null), [I, y] = i.useState(!1), [A, P] = i.useState(!1), [R, D] = i.useState([]), [Z, w] = i.useState(t.name), [k, W] = i.useState(j), L = i.useMemo(() => ({
    ...
    }, [R, k, Z]), null == C) ? (0, r.jsx)("div", {}) : (0, r.jsxs)("div", {
      className: N.root,
          ...
          children: [(0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)(c.Text, {
              ...
              children: [(0, r.jsx)(c.zxk, {
                ...
                color: c.Ttl.BRAND,
                onClick: () => {
                  (0, g.JG)((0, h.HV)(R)), (0, c.showToast)((0, c.createToast)("Copied to clipboard!", c.ToastType.SUCCESS))
                },
