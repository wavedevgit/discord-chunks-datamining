...
let _ = e => {
  let {
    ...
    upsertConfig: s
  } = (0, p.E)(), _ = (0, o.e7)([m.default], () => m.default.getCurrentUser()), [E, j] = i.useState(!0), O = i.useRef(null), [C, S] = i.useState(!1), [v, T] = i.useState(!1), [I, y] = i.useState([]), [A, P] = i.useState(t.name);
  i.useEffect(() => {
  ...
  }, [I, A]), null == _) ? (0, r.jsx)("div", {}) : (0, r.jsxs)("div", {
    className: N.root,
