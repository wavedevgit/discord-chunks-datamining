...
function E(e) {
  ...
  for (let {
    ...
    T((0, r.jsx)(f.Z.ApplicationStreamingSection, {
    ...
    if (v.length > 1 && j.type === _.IIU.PLAYING && !(0, o.Z)(j) && null != A) T((0, r.jsx)(f.Z.GameSection, {
      ...
      null != t && T((0, r.jsx)(f.Z.EmbeddedActivitySection, {
        activity: j,
        participants: e,
        channel: t,
        guildId: t.guild_id
      }, "embedded-activity-".concat(j.application_id)))
    } else if ((null != j.assets || (0, o.Z)(j)) && j.type === _.IIU.PLAYING) T((0, r.jsx)(f.Z.RichPresenceSection, {
      activity: j,
      ...
      let e = N.length > 0 && N[0].members.length > 1,
        n = Z.length > 1;
      T((0, r.jsx)(f.Z.TwitchSection, {
        guildId: null == C ? void 0 : C.id,
        activity: j,
        user: e || n ? x : null,
        getAssetImage: h.getAssetImage
      }, "streaming-".concat(null !== (m = j.session_id) && void 0 !== m ? m : t)))
    } else(0, s.Z)(j) ? T((0, r.jsx)(f.Z.SpotifySection, {
      activity: j,
      isSolo: 1 === y.length,
      partySize: {
        knownSize: Z.length,
      ...
      getAssetImage: h.getAssetImage,
      members: Z
    }, "spotify-".concat(null !== (O = j.session_id) && void 0 !== O ? O : t, "-").concat(x.id))) : (null != j.assets || (0, o.Z)(j)) && j.type === _.IIU.LISTENING ? T((0, r.jsx)(f.Z.RichPresenceSection, {
      activity: j,
      getAssetImage: h.getAssetImage
    }, "rich-presence-".concat(null !== (I = j.session_id) && void 0 !== I ? I : t, "-").concat(x.id))) : (0, c.Z)(j) && T((0, r.jsx)(f.Z.XboxSection, {
      title: A.name
