...
function x(e) {
  ...
  return null != t ? C.intl.formatToPlainString(C.t["0wJXSk"], {
    name: t
...
function G(e) {
  ...
  let J = function() {
    ...
    $ = () => {
      ...
      return null != x && e.push((0, r.jsx)(v.Z, L(w({
        stream: x,
        game: null == n ? void 0 : n.find(d.Z)
      }, t), {
        showChannelName: !0
      }), "stream")), B.forEach((n, i) => {
        e.push((0, r.jsx)(T.Z, w({
          activity: n
        }, t), "activity-".concat(i)))
      }), K && e.push((0, r.jsx)(S.Z, L(w({
        channel: l
      }, t), {
        showChannelName: !0
      }), "voice")), e
    ...
    et = () => 0 === z ? null : q && !F ? D ? (0, r.jsxs)("div", {
