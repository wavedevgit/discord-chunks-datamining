...
function C(e) {
  ...
  let V = (null == G ? void 0 : G.state) != null,
    ...
    q = () => {
      ...
      return null != j && e.push((0, r.jsx)(b.Z, N({
        stream: j,
        game: null == n ? void 0 : n.find(u.Z)
      }, t))), B.forEach(n => {
        e.push((0, r.jsx)(y.Z, N({
          activity: n
        }, t)))
      }), H && e.push((0, r.jsx)(v.Z, N({
        channel: A
      }, t))), e
    },
    Q = () => {
      let e = q();
      return 0 === e.length ? null : W && V && !F ? (0, r.jsxs)(r.Fragment, {
        children: [e[0], (0, r.jsxs)(l.xv, {
          variant: "text-".concat(R, "/medium"),
          className: C,
          color: "text-positive",
          children: ["(+", Y - 1, ")"]
        })]
      }) : W && !F ? e.map((e, t) => (0, r.jsxs)(i.Fragment, {
        children: [0 !== t && z(), e]
      }, t)) : e[0]
    },
    X = () => {
