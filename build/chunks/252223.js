...
function S(e) {
  ...
  let L = (null == o ? void 0 : o.discoverable) !== !1 ? o : null,
    ...
    k = i.useMemo(() => {
      var e;
      return null != (e = null == n ? void 0 : n.filter(e => {
        let {
          type: t
        } = e;
  ...
  let j = (null == x ? void 0 : x.state) != null,
    ...
    H = () => {
      ...
      return null != L && e.push((0, r.jsx)(h.Z, I({
        stream: L,
        game: null == n ? void 0 : n.find(c.Z)
      }, t))), k.forEach(n => {
        e.push((0, r.jsx)(m.Z, I({
          activity: n
        }, t)))
      }), G && e.push((0, r.jsx)(E.Z, I({
        channel: v
      }, t))), e
    },
    Y = () => {
      let e = H();
      return 0 === e.length ? null : F && j && !M ? (0, r.jsxs)(r.Fragment, {
        children: [e[0], (0, r.jsxs)(s.xv, {
          variant: "text-".concat(A, "/medium"),
          className: S,
          color: "text-positive",
          children: ["(+", B - 1, ")"]
        })]
      }) : F && !M ? e.map((e, t) => (0, r.jsxs)(i.Fragment, {
        children: [0 !== t && Z(), e]
      }, t)) : e[0]
    },
    W = () => {
