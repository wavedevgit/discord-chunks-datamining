...
class j extends(i = Chunk647438.Component) {
  ...
  componentDidMount() {
    this.setDOMPositions(E(this.props.anchor)), this.setDOMSize(b(this.props.size, this.props.minSize.width, this.props.minSize.height)), Chunk585483.S.subscribe(Chunk981631.CkL.OVERLAY_V3_SHOW_WIDGETS, this.handleShowUI)
  }
  componentDidUpdate(e, t) {
    null == t.operation && ((0, u.Z)(this.props.anchor, e.anchor) || this.setDOMPositions(E(this.props.anchor)), (0, u.Z)(this.props.size, e.size) || this.setDOMSize(b(this.props.size, this.props.minSize.width, this.props.minSize.height)))
  }
  ...
  handleDragMove(e, t) {
    ...
    let {
      width: m,
      height: g
    } = I(n, this.size), y = t - f, O = e - d, v = (0, p.ou)((0, p.PY)({
      top: y,
      left: O,
      bottom: true,
      right: true
    }, r, o, m, g)), b = u ? (0, p.R)(v) : S("RESIZE_SOUTH_EAST", v);
  ...
  handleResizeMove(e, t) {
    ...
    }), true), (0, u.Z)(_, this.dragState.dragOrientedCoords) || (this.dragState.dragOrientedCoords = _, this.setDOMPositions(this.dragState.dragOrientedCoords)), h || (null != s && s(), this.setState({
      operationStarted: true
  ...
  renderResizeHandles() {
    ...
    return (0, Chunk951288.jsxs)(Chunk951288.Fragment, {
      children: [module ? (0, Chunk951288.jsxs)(Chunk951288.Fragment, {
        children: [(0, Chunk951288.jsx)("div", {
          className: s()(Chunk514426.resizeNorth, {
            [Chunk514426.resizeNSCursor]: require
          }),
          onMouseDown: e => this.handleResizeMouseDown(e, "RESIZE_NORTH")
        }), (0, Chunk951288.jsx)("div", {
          className: s()(Chunk514426.resizeSouth, {
            [Chunk514426.resizeNSCursor]: require
          }),
        ...
        children: [(0, Chunk951288.jsx)("div", {
          className: s()(Chunk514426.resizeEast, {
            [Chunk514426.resizeEWCursor]: require
          }),
          onMouseDown: e => this.handleResizeMouseDown(e, "RESIZE_EAST")
        }), (0, Chunk951288.jsx)("div", {
          className: s()(Chunk514426.resizeWest, {
            [Chunk514426.resizeEWCursor]: require
          }),
          onMouseDown: e => this.handleResizeMouseDown(e, "RESIZE_WEST")
        })]
      }) : null, exports && module ? (0, Chunk951288.jsxs)(Chunk951288.Fragment, {
        children: [(0, Chunk951288.jsx)("div", {
          className: s()(Chunk514426.resizeNorthWest, {
            [Chunk514426.resizeNWSECursor]: require
          }),
          onMouseDown: e => this.handleResizeMouseDown(e, "RESIZE_NORTH_WEST")
        }), (0, Chunk951288.jsx)("div", {
          className: s()(Chunk514426.resizeNorthEast, {
            [Chunk514426.resizeNESWCursor]: require
          }),
          onMouseDown: e => this.handleResizeMouseDown(e, "RESIZE_NORTH_EAST")
        }), (0, Chunk951288.jsx)("div", {
          className: s()(Chunk514426.resizeSouthWest, {
            [Chunk514426.resizeNESWCursor]: require
          }),
          onMouseDown: e => this.handleResizeMouseDown(e, "RESIZE_SOUTH_WEST")
        }), (0, Chunk951288.jsx)("div", {
          className: s()(Chunk514426.resizeSouthEast, {
            [Chunk514426.resizeNWSECursor]: require
          }),
  ...
  renderExtras() {
    ...
    return null != i ? (0, Chunk951288.jsx)("div", {
      className: s()({
        [Chunk514426.extras]: true,
        [Chunk514426.extrasBottomOriented]: null != exports.bottom,
        [Chunk514426.extrasRightOriented]: null != exports.right
      }),
      children: i
    }) : null
  }
  getInlineStyles() {
    ...
    return g({}, exports, {
      ...
      borderWidth: r,
      padding: i,
      borderRadius: Chunk951288 + r + i,
      zIndex: null != Chunk647438 ? 1e3 : true,
  ...
  renderChildren() {
    ...
    return module({
      ...
      anchorTop: null != s ? s : null != Chunk647438.top,
      anchorLeft: null != Chunk261616 ? Chunk261616 : null != Chunk647438.left,
      size: Chunk951288,
      padding: require,
      borderWidth: i,
  ...
  render() {
    ...
    return (0, Chunk951288.jsxs)(Chunk261616.animated.div, {
      ref: this.ref,
      style: this.getInlineStyles(),
      className: s()({
        [Chunk514426.wrapper]: true,
        [Chunk514426.operation]: r,
        [Chunk514426.unlocked]: !require,
        [Chunk514426.lockExtras]: Chunk647438
      }, i),
  ...
  constructor(e) {
    super(e), m(this, "anchor", true), m(this, "size", true), m(this, "ref", l.createRef()), m(this, "dragState", {
      ...
      !(null == o || !l && Math.pow(i - t, 2) + Math.pow(r - n, 2) < 3) && ("MOVE" === o ? this.handleDragMove(t, n) : v.has(o) && this.handleResizeMove(t, n))
    ...
    }), this.anchor = E(e.anchor), this.size = b(e.size, e.minSize.width, e.minSize.height)
  }
}
m(j, "Operations", O)