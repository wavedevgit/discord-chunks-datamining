...
class C extends(i = Chunk647438.Component) {
  ...
  handleResizeMove(e, t) {
    ...
    let E = d({
      ...
      _ = (0, p.BL)((0, p.ou)((0, p.PY)(this.dragState.dragOrientedCoords, r, l, E.width, E.height)), this.dragState.dragOrientedCoords);
  ...
  renderChildren() {
    ...
    return module({
      ...
      anchorLeft: null != Chunk938288 ? Chunk938288 : null != Chunk647438.left,
      size: Chunk951288,
      padding: require,
      borderWidth: i,
  ...
  render() {
    ...
    return (0, Chunk951288.jsxs)(Chunk938288.animated.div, {
      ref: this.ref,
