...
class C extends(i = Chunk647438.Component) {
  ...
  componentDidMount() {
    this.setDOMPositions(S(this.props.anchor)), this.setDOMSize(E(this.props.size, this.props.minSize.width, this.props.minSize.height)), Chunk585483.S.subscribe(Chunk981631.CkL.OVERLAY_V3_SHOW_WIDGETS, this.handleShowUI)
  }
  componentDidUpdate(e, t) {
    null == t.operation && ((0, c.Z)(this.props.anchor, e.anchor) || this.setDOMPositions(S(this.props.anchor)), (0, c.Z)(this.props.size, e.size) || this.setDOMSize(E(this.props.size, this.props.minSize.width, this.props.minSize.height)))
  }
  ...
  handleDragMove(e, t) {
    ...
    let {
      width: m,
      height: g
    } = x(n, this.size), O = t - h, y = e - d, v = (0, p.ou)((0, p.PY)({
      top: O,
      left: y,
      bottom: true,
      right: true
    }, r, l, m, g)), E = c ? (0, p.R)(v) : j("RESIZE_SOUTH_EAST", v);
  ...
  handleResizeMove(e, t) {
    ...
    let S = d({
      ...
      b = (0, p.BL)((0, p.ou)((0, p.PY)(this.dragState.dragOrientedCoords, r, l, S.width, S.height)), this.dragState.dragOrientedCoords);
    this.setDOMSize(O(g({}, S), {
  ...
  renderChildren() {
    ...
    return module({
      ...
      anchorLeft: null != Chunk488290 ? Chunk488290 : null != Chunk647438.left,
      size: Chunk951288,
      padding: require,
      borderWidth: i,
  ...
  render() {
    ...
    return (0, Chunk951288.jsxs)(Chunk488290.animated.div, {
      ...
      className: s()({
        ...
        [Chunk514426.operation]: Chunk647438,
        [Chunk514426.unlocked]: !require,
        [Chunk514426.forceShowExtras]: r && require,
        [Chunk514426.lockExtras]: Chunk120356
      }, i),
  ...
  constructor(e) {
    super(e), m(this, "anchor", true), m(this, "size", true), m(this, "ref", o.createRef()), m(this, "dragState", {
      ...
      let {
        width: s,
        height: u
      } = x(i, this.size), c = (0, p.PY)(this.anchor, o, a, s, u);
      if ("MOVE" === e) {
        let {
          x: e,
          y: i
