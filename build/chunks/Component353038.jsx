...
class j extends(i = Chunk647438.Component) {
  ...
  handleDragMove(e, t) {
    ...
    let {
      width: m,
      height: g
    } = x(n, this.size), y = t - f, O = e - d, b = (0, p.ou)((0, p.PY)({
      top: y,
      left: O,
      bottom: true,
      right: true
  ...
  renderChildren() {
    ...
    return module({
      ...
      anchorLeft: null != Chunk815061 ? Chunk815061 : null != Chunk647438.left,
      size: Chunk951288,
      padding: require,
      borderWidth: i,
  ...
  render() {
    ...
    return (0, Chunk951288.jsxs)(Chunk815061.animated.div, {
      ref: this.ref,
  ...
  constructor(e) {
    super(e), m(this, "anchor", true), m(this, "size", true), m(this, "ref", l.createRef()), m(this, "dragState", {
      ...
      !(null == o || !l && Math.pow(i - t, 2) + Math.pow(r - n, 2) < 3) && ("MOVE" === o ? this.handleDragMove(t, n) : b.has(o) && this.handleResizeMove(t, n))
      ...
      let {
        width: s,
        height: c
      } = x(i, this.size), u = (0, p.PY)(this.anchor, l, a, s, c);
      if ("MOVE" === e) {
        let {
          x: e,
          y: i
      ...
      if (t) {
        let {
          ...
          width: n,
          height: r
        } = x(this.ref.current, this.size), o = (0, p.PY)(this.anchor, e, t, n, r), l = (0, p.R)(o);
