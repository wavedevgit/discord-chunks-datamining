/** Chunk was on web (https://canary.discord.comweb.6d4953f88f353958.js.js) **/ ! function(e, t) {
  ...
  var d, f = ["", "0", "00", "000", "0000", "00000", "000000", "0000000", "00000000", "000000000", "0000000000", "00000000000", "000000000000", "0000000000000", "00000000000000", "000000000000000", "0000000000000000", "00000000000000000", "000000000000000000", "0000000000000000000", "00000000000000000000", "000000000000000000000", "0000000000000000000000", "00000000000000000000000", "000000000000000000000000", "0000000000000000000000000"],
    ...
    _ = [0, 0, 0x2000000, 0x290d741, 0x1000000, 0x2e90edd, 0x39aa400, 0x267bf47, 0x1000000, 0x290d741, 1e7, 0x12959c3, 0x222c000, 0x3bd7765, 7529536, 0xadcea1, 0x1000000, 0x1704f61, 0x206fc40, 0x2cddcf9, 64e6, 4084101, 5153632, 6436343, 7962624, 9765625, 0xb54ba0, 0xdaf26b, 0x1069c00, 0x138f9ad, 243e5, 0x1b4d89f, 0x2000000, 0x25528a1, 0x2b54a20, 0x3216b93, 0x39aa400];
  o.prototype.toString = function(e, t) {
    if (t = 0 | t || 1, 16 === (e = e || 10) || "hex" === e) {
      ...
      for (var n, i = 0, o = 0, a = 0; a < this.length; a++) {
        ...
        o = s >>> 24 - i & 0xffffff, (i += 2) >= 26 && (i -= 26, a--), n = 0 !== o || a !== this.length - 1 ? f[6 - l.length] + l + n : l + n
      }
  ...
  o.prototype.toArrayLike = function(e, t, n) {
    ...
    return n > 0 && (this.words[i] = ~this.words[i] & 0x3ffffff >> 26 - n), this._strip()
  ...
  Math.imul || (E = g), o.prototype.mulTo = function(e, t) {
    ...
    for (var n = 0, i = 0; i < this.length; i++) {
      var o = (0 | this.words[i]) * e,
        a = (0x3ffffff & o) + (0x3ffffff & n);
      n >>= 26, n += (o / 0x4000000 | 0) + (a >>> 26), this.words[i] = 0x3ffffff & a
    }
    ...
    var t = e < 0;
    t && (e = -e), r(e <= 0x3ffffff);
    for (var n = 0x4000000 % e, i = 0, o = this.length - 1; o >= 0; o--) i = (n * i + (0 | this.words[o])) % e;
    return t ? -i : i
    ...
    for (var n = 0, i = this.length - 1; i >= 0; i--) {
      var o = (0 | this.words[i]) + 0x4000000 * n;
  ...
  S.prototype._tmp = function() {
  ...
  }, i(I, S), I.prototype.split = function(e, t) {
  ...
  }, i(T, S), i(N, S), i(A, S), A.prototype.imulK = function(e) {
    for (var t = 0, n = 0; n < e.length; n++) {
    ...
    return new R(e)
  }, i(R, C), R.prototype.convertTo = function(e) {
