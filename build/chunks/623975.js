/** Chunk was on web.js **/
/** chunk id: 623975, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  Z: () => a
});
var Chunk376606 = require("./376606.js"),
...
function O(e) {
  ...
  for (let n = 0; n < _ && !y(t, p); n++) {
    ...
    if (s === c) {
      ...
      if (1 === t) I(a, n, l[0].text);
      else {
        let e = {};
        for (let t = 0; t < l.length; t++) e[`${l[t].languageCode}-${l[t].countryCode}`] = l[t].text;
        I(a, n, e)
      }
    } else s === d ? I(a, n, v(t.slice(r + 8, r + o - 7))) : s === f && I(a, n, v(t.slice(r + 8, r + 12)));
    p += 12
  }
  return a
}
