...
function X(e) {
  ...
  let {
    ...
    reducedMotion: l,
    isExpanded: d
  } = e, [p, f] = s.useState(!1), x = s.useRef(null), h = (0, S.fh)(o, S.eC.QUEST_BAR_HERO_VIDEO), b = (0, P.z0)(o, c.X.WATCH_VIDEO, P.n1.VIDEO, P.O.THUMBNAIL), j = (0, y.km)(e => e.getVideoProgressState);
  s.useEffect(() => {
...
function Y(e) {
  let {
    quest: t,
    taskDetails: n
  } = e, o = s.useMemo(() => E.r.build(t.config), [t.config]);
  return (0, r.jsxs)("ul", {
    ...
    children: [(0, r.jsx)("div", {
      children: (0, r.jsxs)("div", {
        className: a()(U.questPromoContent, {
          [U.questPromoContentWithCopySimplification]: P
        }),
        ref: u,
        children: [(0, r.jsxs)("div", {
          className: U.details,
...
function $(e) {
  ...
  let {
    ...
    onCtxMenuClose: x,
    onCtxMenuSelect: h
  } = e, j = (null == (t = n.userStatus) ? void 0 : t.completedAt) != null, y = o.percentComplete > 0, O = (0, b.z)(n), [w, S, P] = (0, b.me)(n, o), E = s.useRef(null), T = (0, b.B6)(n.config.expiresAt), N = (0, b._s)({
    quest: n
...
let ee = s.forwardRef(function(e, t) {
  ...
  } = (0, b.zB)(y), E = s.useCallback(() => {
    let e = y.config.features.includes(Z.S7.START_QUEST_CTA),
      t = e ? x.jZ.START_QUEST : x.jZ.ACCEPT_QUEST;
    (0, h.AH)(y.id, {
      questContent: v.jn.QUEST_BAR_V2,
      questContentCTA: t
    }), w && (0, R.openVideoQuestModal)(y), S && e && P()
  }, [y, w, S, P]), T = (null == (n = y.userStatus) ? void 0 : n.enrolledAt) != null, N = d && u;
