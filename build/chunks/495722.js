...
function F(e) {
  ...
  let {
    ...
    onClick: s,
    reducedMotion: i
  } = e, [l, c] = o.useState(!1), m = o.useRef(null), f = (0, O.z)(O.i.QUEST_BAR_PREVIEW_VIDEO, n), g = (0, O.z)(O.i.VIDEO_PLAYER_THUMBNAIL, n), x = (0, v.km)(e => e.getVideoProgressState);
  o.useEffect(() => {
  ...
  return (0, r.jsxs)(u.P3F, {
    ...
    children: [null != g && (0, r.jsx)("img", {
      ...
      className: a()(Q.assetBodyVideoPreviewVideo, {
        [Q.assetBodyVideoPreviewVisible]: j
      }),
      controls: !1,
...
function X(e) {
  let {
    quest: t,
    taskDetails: n
  } = e, s = o.useMemo(() => w.r.build(t.config), [t.config]);
  return (0, r.jsxs)("ul", {
    children: [(0, r.jsx)(u.Text, {
      ...
      tag: "li",
      variant: "text-xs/normal",
      children: V.NW.formatToPlainString(V.t["W8/b3d"], {
...
function Y(e) {
  let {
    ...
    isExpanded: f,
    onAcceptQuest: g
  } = e, x = (0, c.e7)([h.Z], () => h.Z.isEnrolling(t.id), [t]), b = o.useMemo(() => (0, C.fh)(t, C.eC.QUEST_BAR_HERO), [t]), v = o.useRef(null);
  o.useEffect(() => {
    ...
    children: [(0, r.jsx)("div", {
      children: (0, r.jsxs)("div", {
        className: a()(Q.questPromoContent, {
          [Q.questPromoContentWithCopySimplification]: O
        }),
        ref: m,
        children: [(0, r.jsxs)("div", {
          className: Q.details,
          children: [(0, r.jsx)(z, {
            ...
            children: V.NW.format(V.t.EQa7oq, {
          ...
          "aria-label": "".concat(V.NW.formatToPlainString(V.t.coKAb2, {
            rewardsDuration: w
          })).concat(null != P ? " • ".concat(P) : ""),
          text: null != w && O && (0, r.jsx)(S.Z, {
            quest: t,
            orientation: "stack",
            withPremiumHighlight: !1
          }),
          shouldShow: null != w && O,
          children: e => (0, r.jsx)(u.zxk, H(U({}, e), {
      ...
      }), b.isAnimated ? (0, r.jsx)(E.Fl, {
        id: "QuestBarV2ContentExpanded_heroAnimated",
        children: e => {
          var t;
          return null != e.current && (v.current = e.current), (0, r.jsx)(p.Z, {
            ref: e,
            autoPlay: !d && f,
            loop: !0,
            muted: !0,
...
function G(e) {
  ...
  let {
    ...
    onCtxMenuClose: h,
    onCtxMenuSelect: v
  } = e, _ = (null == (t = n.userStatus) ? void 0 : t.completedAt) != null, C = s.percentComplete > 0, O = (0, x.z)(n), [w, S, P] = (0, x.me)(n, s), E = o.useRef(null), Z = (0, x.B6)(n.config.expiresAt), z = (0, x._s)({
    quest: n
    ...
    children: [(0, r.jsx)(i.animated.div, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(u.Text, {
          ...
          children: V.NW.format(V.t["pX+fmp"], {
            expirationDate: Z
          })
        }), (0, r.jsx)(N.r, {
          onOpen: g,
          ...
          showShareLink: !0,
          children: e => (0, r.jsx)(u.P3F, H(U({}, e), {
        ...
        children: (!_ || G) && !(0, j.Gd)(n) && (0, l.EQ)(w).with(b.LI.SELECT, () => (0, r.jsx)(W.Z, {
        ...
        })).with(b.LI.CONSOLE, () => (0, r.jsx)(k.Z, {
          quest: n,
          taskDetails: s
        })).exhaustive()
      }), (0, r.jsxs)(A.n, {
        children: [X && (0, r.jsx)(F, {
          quest: n,
          onClick: Y,
          reducedMotion: m
        }), (0, r.jsx)(R.yD, {
...
let J = o.forwardRef(function(e, t) {
  ...
  let {
    ...
    useReducedMotion: C,
    taskDetails: O
  } = e, w = (0, j.q8)(_), S = (0, j.Vl)(_), P = o.useCallback(() => {
  ...
  }, [_, w, S]), E = (null == (n = _.userStatus) ? void 0 : n.enrolledAt) != null, N = d && u;
