...
function X(e) {
  ...
  let {
    ...
    reducedMotion: l,
    isExpanded: d
  } = e, [p, f] = s.useState(!1), x = s.useRef(null), h = (0, S.fh)(o, S.eC.QUEST_BAR_HERO_VIDEO), b = (0, E.z0)(o, c.X.WATCH_VIDEO, E.n1.VIDEO, E.O.THUMBNAIL), j = (0, y.km)(e => e.getVideoProgressState);
  s.useEffect(() => {
  ...
  return (0, r.jsxs)(m.P3F, {
    ...
    children: [null != b && (0, r.jsx)("img", {
      ...
      className: a()(U.assetBodyVideoPreviewVideo, {
        [U.assetBodyVideoPreviewVisible]: O
      }),
      controls: !1,
...
function Y(e) {
  let {
    quest: t,
    taskDetails: n
  } = e, o = s.useMemo(() => P.r.build(t.config), [t.config]);
  return (0, r.jsxs)("ul", {
    children: [(0, r.jsx)(m.Text, {
      ...
      tag: "li",
      variant: "text-xs/normal",
      children: H.intl.formatToPlainString(H.t["W8/b3d"], {
        rewardName: o.defaultRewardName
      })
    })]
  })
}
...
function J(e) {
  let {
    ...
    isExpanded: x,
    onAcceptQuest: h
  } = e, b = (0, d.e7)([j.Z], () => j.Z.isEnrolling(t.id), [t]), v = s.useMemo(() => (0, S.fh)(t, S.eC.QUEST_BAR_HERO), [t]), y = s.useRef(null);
  s.useEffect(() => {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)("div", {
      children: (0, r.jsxs)("div", {
        className: a()(U.questPromoContent, {
          [U.questPromoContentWithCopySimplification]: E
        }),
        ref: u,
        children: [(0, r.jsxs)("div", {
          className: U.details,
          children: [(0, r.jsx)(K, {
            ...
            children: H.intl.format(H.t.EQa7oq, {
          ...
          "aria-label": "".concat(H.intl.formatToPlainString(H.t.coKAb2, {
            rewardsDuration: P
          })).concat(null != N ? " • ".concat(N) : ""),
          text: null != P && E && (0, r.jsx)(T.Z, {
            quest: t,
            orientation: "stack",
    ...
    }), R && null != B && (0, r.jsx)(i.animated.div, {
...
function $(e) {
  ...
  let {
    ...
    onCtxMenuClose: x,
    onCtxMenuSelect: h
  } = e, j = (null == (t = n.userStatus) ? void 0 : t.completedAt) != null, y = o.percentComplete > 0, O = (0, b.z)(n), [w, S, E] = (0, b.me)(n, o), P = s.useRef(null), T = (0, b.B6)(n.config.expiresAt), N = (0, b._s)({
    quest: n
  }), A = (0, _.q8)(n), K = (0, b.Jf)(n), Y = s.useCallback(() => {
    ...
    children: [(0, r.jsx)(i.animated.div, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(m.Text, {
          ...
          children: H.intl.format(H.t["pX+fmp"], {
            expirationDate: T
          })
        }), (0, r.jsx)(k.r, {
          onOpen: g,
          ...
          showShareLink: !0,
          children: e => (0, r.jsx)(m.P3F, F(z({}, e), {
        ...
        children: (!j || G) && !(0, _.Gd)(n) && (0, l.EQ)(w).with(v.LI.SELECT, () => (0, r.jsx)(W.Z, {
          onConsole: () => E(Z.cd.CONSOLE),
          onDesktop: () => E(Z.cd.DESKTOP)
        })).with(v.LI.DESKTOP, () => (0, r.jsxs)(r.Fragment, {
          children: [G && (0, r.jsx)(L.Z, {
            quest: n,
            taskDetails: o
          }), (0, r.jsx)(M.Z, {
            quest: n
          })]
        })).with(v.LI.CONSOLE, () => (0, r.jsx)(D.Z, {
          quest: n,
          taskDetails: o
        })).exhaustive()
      }), (0, r.jsxs)(B.n, {
...
let ee = s.forwardRef(function(e, t) {
  ...
  let {
    ...
    (0, h.AH)(y.id, {
      questContent: v.jn.QUEST_BAR_V2,
      questContentCTA: t
    }), w && (0, R.openVideoQuestModal)(y), S && e && E()
  }, [y, w, S, E]), T = (null == (n = y.userStatus) ? void 0 : n.enrolledAt) != null, N = d && u;
