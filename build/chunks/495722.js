...
function X(e) {
  ...
  let {
    ...
    reducedMotion: l,
    isExpanded: u
  } = e, [p, f] = s.useState(!1), x = s.useRef(null), h = (0, E.fh)(o, E.eC.QUEST_BAR_HERO_VIDEO), b = (0, w.z0)(o, c.X.WATCH_VIDEO, w.n1.VIDEO, w.O.THUMBNAIL), j = (0, y.km)(e => e.getVideoProgressState);
  s.useEffect(() => {
...
function Y(e) {
  let {
    quest: t,
    taskDetails: n
  } = e, o = s.useMemo(() => T.r.build(t.config), [t.config]);
  return (0, r.jsxs)("ul", {
    children: [(0, r.jsx)(m.Text, {
      ...
      tag: "li",
      variant: "text-xs/normal",
      children: U.intl.formatToPlainString(U.t["W8/b3d"], {
...
function $(e) {
  ...
  let {
    ...
    onCtxMenuClose: x,
    onCtxMenuSelect: h
  } = e, j = (null == (t = n.userStatus) ? void 0 : t.completedAt) != null, y = o.percentComplete > 0, C = (0, b.z)(n), [S, E, w] = (0, b.me)(n, o), T = s.useRef(null), P = (0, b.B6)(n.config.expiresAt), N = (0, b._s)({
    quest: n
  }), A = (0, v.q8)(n), K = (0, b.Jf)(n), Y = s.useCallback(() => {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(i.animated.div, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: (!j || G) && !(0, v.Gd)(n) && (0, l.EQ)(S).with(_.LI.SELECT, () => (0, r.jsx)(M.Z, {
          onConsole: () => w(W.cd.CONSOLE),
          onDesktop: () => w(W.cd.DESKTOP)
        })).with(_.LI.DESKTOP, () => (0, r.jsxs)(r.Fragment, {
...
let ee = s.forwardRef(function(e, t) {
  ...
  let {
    ...
    useReducedMotion: C,
    taskDetails: O
  } = e, S = (0, v.q8)(y), E = (0, v.Vl)(y), {
    launchInGameActivity: w
  } = (0, b.zB)(y), T = s.useCallback(() => {
    ...
    (0, h.AH)(y.id, {
      ...
      questContentCTA: t,
      sourceQuestContent: _.jn.QUEST_BAR_V2
    }), S && (0, k.openVideoQuestModal)({
      quest: y,
      sourceQuestContent: _.jn.QUEST_BAR_V2
    }), E && e && w()
  }, [y, S, E, w]), P = (null == (n = y.userStatus) ? void 0 : n.enrolledAt) != null, N = u && d;
