...
function W(e) {
  ...
  let {
    ...
    reducedMotion: l,
    isExpanded: u
  } = e, [p, f] = o.useState(!1), x = o.useRef(null), h = (0, E.fh)(s, E.eC.QUEST_BAR_HERO_VIDEO), b = (0, S.z0)(s, c.X.WATCH_VIDEO, S.n1.VIDEO, S.O.THUMBNAIL), j = (0, y.km)(e => e.getVideoProgressState);
  o.useEffect(() => {
...
function H(e) {
  let {
    ...
    isExpanded: g,
    onAcceptQuest: x
  } = e, h = (0, u.e7)([j.Z], () => j.Z.isEnrolling(t.id), [t]), b = o.useMemo(() => (0, E.fh)(t, E.eC.QUEST_BAR_HERO), [t]), _ = (0, O.CR)({
    quest: t
  }), v = (0, C.h)({
    location: Q.dr.QUESTS_BAR,
    questConfig: t.config
  }), y = o.useMemo(() => (0, E.fh)(t, E.eC.HERO_IMAGE), [t]), S = o.useMemo(() => null == y ? {} : {
    backgroundImage: "url(".concat(y.url, ")")
  }, [y]), w = (0, f.ZP)(), T = (0, p.wj)(w);
...
function F(e) {
  ...
  let {
    ...
    onCtxMenuClose: x,
    onCtxMenuSelect: h
  } = e, j = (null == (t = n.userStatus) ? void 0 : t.completedAt) != null, y = s.percentComplete > 0, C = (0, b.z)(n), [O, E, S] = (0, b.me)(n, s), w = o.useRef(null), P = (0, b.B6)(n.config.expiresAt), Z = (0, b._s)({
    quest: n
  }), U = (0, v.q8)(n), H = (0, b.Jf)(n), z = o.useCallback(() => {
    (0, N.openVideoQuestModal)({
      quest: n,
      sourceQuestContent: _.jn.QUEST_BAR_V2
    })
  }, [n]), F = null != H ? H.percentComplete : s.percentComplete;
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(i.animated.div, {
