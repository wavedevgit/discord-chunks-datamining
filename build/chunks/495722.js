...
function U(e) {
  ...
  let {
    ...
    reducedMotion: i,
    isExpanded: l
  } = e, [c, m] = o.useState(!1), f = o.useRef(null), g = (0, O.z)(O.i.QUEST_BAR_PREVIEW_VIDEO, n), x = (0, O.z)(O.i.VIDEO_PLAYER_THUMBNAIL, n), h = (0, j.km)(e => e.getVideoProgressState);
  o.useEffect(() => {
  ...
  return (0, r.jsxs)(u.P3F, {
    ...
    children: [null != x && (0, r.jsx)("img", {
      ...
      className: a()(Z.assetBodyVideoPreviewVideo, {
        [Z.assetBodyVideoPreviewVisible]: y
      }),
      controls: !1,
...
function z(e) {
  let {
    quest: t,
    taskDetails: n
  } = e, s = o.useMemo(() => C.r.build(t.config), [t.config]);
  return (0, r.jsxs)("ul", {
    children: [(0, r.jsx)(u.Text, {
      ...
      tag: "li",
      variant: "text-xs/normal",
      children: W.intl.formatToPlainString(W.t["W8/b3d"], {
    ...
    children: [(0, r.jsx)("div", {
      children: (0, r.jsxs)("div", {
        className: a()(Z.questPromoContent, {
          [Z.questPromoContentWithCopySimplification]: C
        }),
        ref: m,
        children: [(0, r.jsxs)("div", {
          className: Z.details,
          ...
          "aria-label": "".concat(W.intl.formatToPlainString(W.t.coKAb2, {
            rewardsDuration: S
          })).concat(null != E ? " • ".concat(E) : ""),
          text: null != S && C && (0, r.jsx)(w.Z, {
            quest: t,
            orientation: "stack",
...
function X(e) {
  ...
  let {
    ...
    onCtxMenuClose: j,
    onCtxMenuSelect: y
  } = e, _ = (null == (t = n.userStatus) ? void 0 : t.completedAt) != null, O = s.percentComplete > 0, C = (0, g.z)(n), [w, S, P] = (0, g.me)(n, s), H = o.useRef(null), z = (0, g.B6)(n.config.expiresAt), F = (0, g._s)({
    quest: n
  }), K = (0, b.q8)(n), X = (0, g.Jf)(n), Y = o.useCallback(() => {
    ...
    children: [(0, r.jsx)(i.animated.div, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(u.Text, {
          ...
          children: W.intl.format(W.t["pX+fmp"], {
            expirationDate: z
          })
        }), (0, r.jsx)(E.r, {
          onOpen: x,
        ...
        children: (!_ || G) && !(0, b.Gd)(n) && (0, l.EQ)(w).with(h.LI.SELECT, () => (0, r.jsx)(D.Z, {
        ...
        children: [K && (0, r.jsx)(U, {
          ...
          isProgressing: C,
          activeScreen: w,
          showBackButton: w !== h.LI.SELECT && S.length > 1 && !O && !C,
          onBack: () => P(null),
          taskDetails: s
        })]
      })]
