...
function Z(e) {
  ...
  let {
    ...
    reducedMotion: l,
    isExpanded: u
  } = e, [p, g] = s.useState(!1), x = s.useRef(null), h = (0, E.fh)(o, E.eC.QUEST_BAR_HERO_VIDEO), j = (0, S.z0)(o, c.X.WATCH_VIDEO, S.n1.VIDEO, S.O.THUMBNAIL), _ = (0, C.km)(e => e.getVideoProgressState);
  s.useEffect(() => {
...
function F(e) {
  ...
  let {
    ...
    onCtxMenuClose: j,
    onCtxMenuSelect: b
  } = e, C = (null == (t = n.userStatus) ? void 0 : t.completedAt) != null, y = o.percentComplete > 0, O = (0, _.z)(n), [E, S, T] = (0, _.me)(n, o), P = s.useRef(null), W = (0, _.B6)(n.config.expiresAt), U = (0, _._s)({
    quest: n
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(i.animated.div, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: !C && !(0, h.Gd)(n) && (0, l.EQ)(E).with(v.LI.SELECT, () => (0, r.jsx)(Q.Z, {
...
let X = s.forwardRef(function(e, t) {
  ...
  }, [C, E, S, T]), N = (null == (n = C.userStatus) ? void 0 : n.enrolledAt) != null, A = u && d;
