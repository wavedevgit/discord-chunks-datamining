...
function x() {
  ...
  for (let {
    ...
    h.Z.applicationIdsFetching.has(r.id) || h.Z.isEntitledToSku(g.default.getCurrentUser(), t, r.id, r.id) || !i.available ? null != O[t] && (delete O[t], e = !0) : (O[t] = {
      skuId: t,
      applicationId: n
    }, e = !0)
  }
    ...
    for (let {
      ...
      if (null != t && n !== E.GQo.DISCORD)
        for (let {
          ...
          of E.Lg6) r !== t || v.includes(n) || null == y[n] && (h.Z.applicationIdsFetched.has(r) || h.Z.applicationIdsFetching.has(r) || null != h.Z.getForSku(n) || d.yD(r), y[n] = {
          skuId: n,
          applicationId: r
        }, e = !0);
    return e && x(), e
