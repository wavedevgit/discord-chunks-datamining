...
function O() {
  ...
  for (let {
    ...
    _.Z.applicationIdsFetching.has(r.id) || _.Z.isEntitledToSku(h.default.getCurrentUser(), t, r.id, r.id) || !i.available ? null != y[t] && (delete y[t], e = !0) : (y[t] = {
      skuId: t,
      applicationId: n
    }, e = !0)
  }
    ...
    for (let {
      ...
      if (null != t && n !== E.GQo.DISCORD)
        for (let {
          ...
          of E.Lg6) r !== t || C.includes(n) || null == v[n] && (_.Z.applicationIdsFetched.has(r) || _.Z.applicationIdsFetching.has(r) || null != _.Z.getForSku(n) || d.yD(r), v[n] = {
          skuId: n,
          applicationId: r
        }, e = !0);
    return e && O(), e
