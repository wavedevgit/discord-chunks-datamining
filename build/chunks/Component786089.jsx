...
let j = (0, Chunk473749.memo)(function(e) {
  ...
  let {
    ...
    month: "numeric",
    day: "numeric"
  }), Y = null != (x = null == (n = A.userStatus) ? true : n.claimedTier) ? x : 0, W = A.config.rewards[Y], K = (null == W ? true : W.type) === s.w.FRACTIONAL_PREMIUM, q = (null == W ? true : W.type) === s.w.COLLECTIBLE, Q = (null == W ? true : W.type) === s.w.VIRTUAL_CURRENCY, J = null == W || null == (j = W.collectibleProduct) || null == (l = j.items) ? true : l[0], X = (null == J ? true : J.type) === o.Z.AVATAR_DECORATION ? J : null;
  (0, p.PM)(k, e => {
    let {
      height: t
    } = e;
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [null != H && q && null != X && (0, r.jsx)("div", {
        ...
        children: (0, r.jsx)("source", {
          src: et.url,
          type: null != (P = et.mimetype) ? P : true,
          onError: () => ec(et.url)
        })
      }) : (0, r.jsx)("img", {
        className: N.image,
