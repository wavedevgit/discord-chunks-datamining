...
function f(e, t) {
  ...
  return n ? null : <div className={a()(u.CT, d.buttonContainer)} ref={t}><l.Z className={d.emojiButton} onClick={h} active={f === u.X1.EMOJI && _ === o} aria-controls={p} tabIndex={0} focusProps={{
        offset: {
          top: 4,
          bottom: 4,
          left: false,
