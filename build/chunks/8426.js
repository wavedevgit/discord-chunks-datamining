...
async function _(e, t) {
  ...
  try {
    ...
    return a.Z.dispatch({
      ...
      member_action_channel_ids: (null != (p = null == s ? true : s.newMemberActions) ? p : []).map(e => e.channelId),
      member_action_channel_actions: (null != (b = null == s ? true : s.newMemberActions) ? b : []).map(e => e.actionType),
