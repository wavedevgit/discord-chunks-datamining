...
function f(e) {
  ...
  i.useEffect(() => {
    if (null == k) return;
    let e = t => {
      null != t.data && "number" == typeof t.data && (G.current = t.data, t.data > 0 && ("halt" === y && P.reducedMotion.enabled && k.isPlaying && k.pause(), k.off(s.EventType.Advance, e)))
    };
