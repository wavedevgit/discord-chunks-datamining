/** Chunk was on web.js **/
/** chunk id: 218035, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  Z: () => E,
  c: () => g
...
function g(e) {
  ...
  function y(e) {
    ...
    }, c.UE.notifications(e))
  }
  return <r.Fragment>{e.isForumLikeChannel() ? <r.Fragment>{<o.S89 id={"new-forum-threads-created"} label={d.intl.string(d.t.Rkgjpq)} checked={_} action={() => a.Z.setForumThreadsCreated(e, !_)} />}{<o.Clw />}</r.Fragment> : null}{b.map(t => {
      let {
        setting: n,
        label: i
      } = t;
      return <o.k5B group={"channel-notifications"} id={"".concat(n)} label={i} subtext={n === u.bL.NULL ? m(f, e, E) : true} action={() => y(n)} checked={n === g} />
    })}</r.Fragment>
}
...
function E(e) {
  ...
  let a = g(e),
    ...
    p = (0, s.p2)(e),
    m = _ === u.bL.NULL && e.isGuildStageVoice() ? d.intl.format(d.t.L2hmY2, {}) : null == (n = h(e, p)) || null == (t = n.find(e => {
      let {
        setting: t
      } = e;
      return t === c
    })) ? true : t.label;
  return null != a ? <o.sNh id={"channel-notifications"} label={d.intl.string(d.t.h850Sk)} subtext={m}>{a}</o.sNh> : null
}