/** Chunk was on 8016 (9264cb374b220b31.js) **/
e.d(l, {
  C: () => L
}), e(411104), e(47120);
var h, t, r = e(200651),
...
var v = ((t = v || {}).PREMIUM_ACTIVATED = "PREMIUM_ACTIVATED", t.PREMIUM_UPDATED = "PREMIUM_UPDATED", t.PREMIUM_UPGRADED = "PREMIUM_UPGRADED", t.GUILD_BOOST_APPLIED = "GUILD_BOOST_APPLIED", t.PREMIUM_PAYMENT_STARTED = "PREMIUM_PAYMENT_STARTED", t);
class g extends(h = s.PureComponent) {
  componentDidMount() {
    this.animate()
  }
  animate() {
  ...
  getContainerStyle() {
    let {
      flashColor: a
    } = this.props, l = E.FLASH_TIME_PERCENT, e = E.FLASH_DURATION_PERCENT, h = (0, A.Cj)(a, 0);
    return {
      backgroundColor: this.animation.interpolate({
        inputRange: [0, l, l, l + e, 1],
        outputRange: [h, h, a, a, h]
      })
    }
  }
  getShineStyle() {
    return i.Z.accelerate({
      transform: [{
  ...
  getSvgBorderGradientId() {
    ...
    switch (l) {
      case "GUILD_BOOST_APPLIED":
        return M.Rj.PREMIUM_GUILD;
      case "PREMIUM_ACTIVATED":
      case "PREMIUM_PAYMENT_STARTED":
      case "PREMIUM_UPGRADED":
      case "PREMIUM_UPDATED":
        if (a === m.p9.TIER_0) return M.Rj.PREMIUM_TIER_0;
        if (a === m.p9.TIER_1) return M.Rj.PREMIUM_TIER_1;
  ...
  render() {
    ...
    return (0, r.jsxs)("div", {
      className: c()(C.container, a),
      children: [this.renderSvgBorder(), (0, r.jsxs)(i.Z.div, {
        className: C.animationContainer,
        style: this.getContainerStyle(),
        children: [(0, r.jsx)(p.ZX5, {
          className: C.shine,
