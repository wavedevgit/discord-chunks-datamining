...
function Z(e) {
  ...
  let n = (0, f.Z)(),
    ...
    m = (0, i.e7)([a.Z], () => a.Z.getGuild(N), [N]),
    v = (0, i.e7)([s.Z], () => null != Z ? s.Z.getVoiceStateForChannel(Z, e.id) : null, [Z, e.id]),
    p = (null === (t = o.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) === e.id,
    O = (0, g.Z)(),
    h = (0, i.e7)([d.ZP], () => d.ZP.getPermissionsForUser(e.id, Z), [Z, e.id]),
    j = (0, c.B)(Z);
  if (null == n || null == m || null == v || h.speaker) return null;
  let x = () => {
    p ? (0, u.RK)(n, !1) : (0, u._0)(n, e.id)
  };
  return j ? (0, l.jsx)(r.sNh, {
    id: "invite-speaker",
