...
function k(e) {
  let {
    ...
    maxSizeCallback: s,
    sectionName: d,
    commandOrigin: f = l.bB.APPLICATION_LAUNCHER
  } = e, {
    channel: _
  } = r, p = async () => {
    try {
...
function j(e) {
  ...
  return C(e) ? {
    iconURL: f.ZP.getApplicationIconURL(S(O({}, r), {
      id: e.id,
      icon: e.icon
    })),
    name: e.name,
...
function W(e) {
  _.S.dispatchToLastSubscribed(E.CkL.OPEN_APP_LAUNCHER, {
    applicationId: e
  })
}