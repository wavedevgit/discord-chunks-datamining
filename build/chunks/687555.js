...
function M(e) {
  let {
    onShare: t
  } = e, r = (0, C.e7)([j.Z], () => j.Z.getRecipientStatus()), [i, l] = s.useState([]), [o, d] = s.useState(new Set), [h, f] = s.useState(!1);
  return s.useEffect(() => {
    (async () => {
      let e = [];
      for (let [t, a] of r)
...
function U(e) {
  ...
  return "light" === (0, C.e7)([g.Z], () => g.Z.theme) ? (0, a.jsx)(u.Eep, {
    className: t,
    src: R,
    width: 55,
    height: 38
...
let A = function(e) {
  let {
    onClose: t,
    onShare: r
  } = e, i = (0, C.e7)([j.Z], () => j.Z.getReferralsRemaining()), [l, p] = s.useState(""), g = (0, f.Z)(l, 400), [_, L] = s.useState(new Map), [R, E] = s.useState(!1), {
    eligibleUsers: w,
    fetchUsers: N,
    hasError: U,
    isFetching: A,
  ...
  if (U) return (0, a.jsx)(P, {
    onClose: t
  });
  if (0 === i) return (0, a.jsx)(M, {
    onShare: r
  });
  ...
  return (0, a.jsxs)("div", {
    children: [(0, a.jsxs)("div", {
      ...
      children: [I ? (0, a.jsx)(Z, {}) : (0, a.jsx)(O, {
    ...
    }), I ? (0, a.jsx)(F, {}) : (0, a.jsxs)(d.w0, {
      className: S.list,
      children: [w.map(e => (0, a.jsx)(v.Z, {
      ...
      }, e.id)), A && (0, a.jsx)(u.$jN, {}), (0, a.jsx)("div", {
        ref: B
      })]
    }), (0, a.jsx)("div", {
      className: n()(S.footer, S.footerSeparator),
