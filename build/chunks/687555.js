...
function U(e) {
  let {
    onShare: t
  } = e, r = (0, d.e7)([_.Z], () => _.Z.getRecipientStatus()), [s, l] = i.useState([]), [o, C] = i.useState(new Set), [f, p] = i.useState(!1);
  return i.useEffect(() => {
    (async () => {
      let e = [];
      for (let [t, a] of r)
...
let B = function(e) {
  let {
    onClose: t,
    onShare: r
  } = e, s = (0, d.e7)([_.Z], () => _.Z.getReferralsRemaining()), [l, x] = i.useState(""), h = (0, p.Z)(l, 400), [j, L] = i.useState(new Map), [w, b] = i.useState(!1), {
    eligibleUsers: N,
    fetchUsers: Z,
    hasError: M,
    isFetching: B,
