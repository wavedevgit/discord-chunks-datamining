...
function M(e) {
  let {
    onShare: t
  } = e, r = (0, d.e7)([g.Z], () => g.Z.getRecipientStatus()), [s, l] = i.useState([]), [o, C] = i.useState(new Set), [p, u] = i.useState(!1);
  return i.useEffect(() => {
    (async () => {
      let e = [];
      for (let [t, a] of r)
...
let A = function(e) {
  let {
    onClose: t,
    onShare: r
  } = e, s = (0, d.e7)([g.Z], () => g.Z.getReferralsRemaining()), [l, f] = i.useState(""), m = (0, u.Z)(l, 400), [_, y] = i.useState(new Map), [b, N] = i.useState(!1), {
    eligibleUsers: Z,
    fetchUsers: F,
    hasError: B,
    isFetching: A,
