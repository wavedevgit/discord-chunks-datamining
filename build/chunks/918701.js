...
function e_(e) {
  ...
  if ((null == (n = r.userStatus) ? void 0 : n.enrolledAt) != null) {
    ...
    return t >= .75 ? k.intl.string(k.t.gvCR4O) : t >= .45 && t <= .55 ? k.intl.string(k.t.JNx8sL) : t > 0 ? k.intl.string(k.t.JMbfnZ) : k.intl.string(k.t["7e5k7O"])
  }
  return k.intl.formatToPlainString(k.t.EQa7oq, {
...
function eE(e) {
  ...
  if (a >= 12) {
    ...
    return k.intl.formatToPlainString(k.t.PClsr6, {
      years: e
    })
  } {
    if (a > 0) return k.intl.formatToPlainString(k.t.kridzM, {
      months: a
    });
    let e = (0, r.Z)(i, n);
    if (!(e >= 7)) return k.intl.formatToPlainString(k.t.k2UNz8, {
      days: e
    });
    {
      let t = Math.ceil(e / 7);
      return k.intl.formatToPlainString(k.t.EmoBDw, {
        weeks: t
      })
    }
  }
...
function eA(e, t) {
  I.Z.captureException(e, G(j({}, t), {
    tags: G(j({}, null == t ? void 0 : t.tags), {
      app_context: "quests"
    })
  }))
}
...
function ej(e, t) {
  ...
  (0, v.q)({
    ...
    onConfirm: () => {
      ...
      }), E.S.dispatch(L.CkL.QUEST_GAME_LINK_OPENED), (0, _.Z)(n)
    }
  }), (0, S.dA)({
    questId: e.id,
...
let eU = (e, t) => {
  ...
  eK = e => {
    ...
    for (let e of Object.values(null != (n = null == (t = r.userStatus) ? void 0 : t.progress) ? n : {}).sort((e, t) => {
      ...
      if (null != t && (null == i ? void 0 : i.has(t))) return eY({
        quest: r,
        taskType: t,
        includeTaskTypes: i
      })
  ...
  ez = (e, t) => {
    if (e.config.taskConfig.type !== u.L.FIRST_PARTY) return {
      progressSeconds: 0,
      targetSeconds: 1,
      targetMinutes: 1,
      percentComplete: 0,
...
function ts(e) {
  ...
  let {
    ...
    quest: o
  }), u = null != s ? s : null == a ? void 0 : a.platform, d = c ? eM({
    quest: o,
...
function tl(e) {
  ...
  return t ? null == i ? k.intl.formatToPlainString(k.t.Piihy8, {
    gamePublisher: n
...
let tE = e => e.percentComplete > 0 ? k.intl.formatToPlainString(k.t["c59/Tk"], {
  remainTime: e0(e)
}) : k.intl.formatToPlainString(k.t.GNsKiY, {
  remainTime: e0(e)
});
