...
function eg(e) {
  ...
  if (a >= 12) {
    ...
    if (a > 0) return x.intl.formatToPlainString(x.t.kridzM, {
      months: a
    });
    let e = (0, r.Z)(i, n);
...
function eM(e, t) {
  ...
  (0, O.q)({
    ...
    onConfirm: () => {
      ...
      }), g.S.dispatch(D.CkL.QUEST_GAME_LINK_OPENED), (0, f.Z)(n)
    }
  }), (0, I.dA)({
    questId: e.id,
...
let ej = (e, t) => {
  ...
  eW = e => {
    ...
    for (let e of Object.values(null != (n = null == (t = r.userStatus) ? void 0 : t.progress) ? n : {}).sort((e, t) => {
      ...
      if (null != t && (null == i ? void 0 : i.has(t))) return eH({
        quest: r,
        taskType: t,
        includeTaskTypes: i
      })
...
function ta(e) {
  ...
  let {
    ...
    quest: o
  }), u = null != s ? s : null == a ? void 0 : a.platform, d = c ? ek({
    quest: o,
...
let tg = e => e.percentComplete > 0 ? x.intl.formatToPlainString(x.t["c59/Tk"], {
  remainTime: e$(e)
