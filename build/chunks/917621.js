...
class I extends i.PureComponent {
  ...
  renderPartyStatus() {
    ...
    return !l || i || this.isEmbeddedActivityApplication() || e !== y.mFx.JOIN ? this.isActionType(y.mFx.LISTEN) || this.isActionType(y.mFx.WATCH) ? null != s && null != s.details && null != s.state && (0, b.Z)(s) ? [(0, r.jsx)("div", {
      className: v.details,
  ...
  renderActionButton() {
    ...
    return null != p ? p : !this.isDeadInvite() && this.isActionType(y.mFx.LISTEN) && null != l && null != s && null != a && (0, E.Ps)(l) ? c(C(j({}, d), {
      activity: a,
      user: s.author
  ...
  render() {
    let {
      ...
      name: n,
      activity: i
    } = this.props, l = this.isActionType(y.mFx.JOIN) || this.isActionType(y.mFx.JOIN_REQUEST), c = this.isDeadInvite(), u = null;
