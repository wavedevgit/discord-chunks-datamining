...
class I extends i.PureComponent {
  ...
  renderHeaderText() {
    ...
    switch (e) {
      case y.mFx.LISTEN:
        return E.intl.formatToPlainString(E.t["/8czHx"], {
          name: t
        });
      case y.mFx.WATCH:
        return E.intl.formatToPlainString(E.t.BBJXVl, {
          name: t
        });
      case y.mFx.JOIN:
  ...
  renderPartyStatus() {
    ...
    }, "state")] : this.isActionType(y.mFx.LISTEN) ? E.intl.string(E.t.gXYoq6) : E.intl.string(E.t.eyKDl5) : this.isActionType(y.mFx.JOIN_REQUEST) ? this.isPartyFull() ? E.intl.string(E.t.jfrMtr) : this.hasPartySize() && 0 !== d ? E.intl.formatToPlainString(E.t.XWapnZ, {
      number: d - u
    }) : null : this.isInParty() ? E.intl.string(E.t.KC26NT) : t || n || i || this.isEmbeddedActivityApplication() ? this.isPartyFull() ? E.intl.string(E.t.jfrMtr) : this.hasPartySize() && 0 !== d ? E.intl.formatToPlainString(E.t.XWapnZ, {
      number: d - u
    }) : null : E.intl.formatToPlainString(E.t.SqJBnJ, {
      name: a
  ...
  renderActionButton() {
    ...
    return null != p ? p : !this.isDeadInvite() && this.isActionType(y.mFx.LISTEN) && null != l && null != s && null != a && (0, x.Ps)(l) ? c(C(j({}, d), {
      activity: a,
      user: s.author
