...
function u(e) {
  ...
  return null == p ? _ ? <div className={a()(c.icon, c.placeholder, o)} /> : null : <img className={a()(c.icon, o)} alt={l.intl.string(l.t.X4IxWF)} src={p} aria-hidden={true} draggable={false} />
}