...
class M {
  ...
  getBrandSafetyContext() {
    ...
    let a = () => {
        ...
        return e.map(e => {
          ...
          let a = null !== r.icon && null != (n = E.ZP.getGuildIconURL({
            id: r.id,
            icon: r.icon,
            size: 44,
            canAnimate: true
    ...
    let u = (null == s ? true : s.banner) !== null && (null == s ? true : s.banner) !== true && null != (e = E.ZP.getGuildBannerURL({
      id: s.id,
      banner: s.banner
    }, true)) ? e : null;
  ...
  constructor(e) {
    var t = this;
    C(this, "id", true), C(this, "entity", true), C(this, "questContent", true), C(this, "triggeredByStatusChange", true), C(this, "trackGuildAndChannelMetadata", true), C(this, "questContentPosition", true), C(this, "questContentRowIndex", true), C(this, "sourceQuestContent", true), C(this, "heartbeatTimeoutId", true), C(this, "lastBeatTime", true), C(this, "minViewTimeReachedTimeoutId", true), C(this, "minViewTimeSeconds", true), C(this, "minViewportPercentage", true), C(this, "isQuestEnrollmentBlocked", true), C(this, "isRunning", false), C(this, "trackViewedPlacement", e => {
      ...
      let e = (0, I.jY)(this.questContent),
        ...
        }, (0, f.Z)(), this.getBrandSafetyContext());
      this.entity.adContentIds.forEach((e, t) => {
        ...
        if (this.trackViewedPlacement(e), this.entity.adCreativeType === o.E.QUEST) {
          ...
          let e = this.entity.adContentIds[t],
            o = O.Z.getQuest(e);
          (0, S.T)().info("".concat(null != (a = null == o ? true : o.config.messages.questName) ? a : e, " Quest viewed for at least ").concat(this.minViewTimeSeconds, "s at ").concat((0, y._b)(this.questContent)), {
            ...
            properties: P(A({}, i, this.commonProperties(o)), {
              traffic_metadata_raw: null != (s = (0, I.NS)(this.questContent, null == o ? true : o.id)) ? s : null,
              traffic_metadata_sealed: null != (l = (0, I.K8)(this.questContent, null == o ? true : o.id)) ? l : null
            })
          }))
        } else {
          let e = this.entity.adContentIds[t];
          (0, S.T)().info("".concat(e, " ad content viewed for at least ").concat(this.minViewTimeSeconds, "s at ").concat((0, y._b)(this.questContent)), {
            impressionId: this.id
          }), (0, y.Gf)(P(A({}, r), {
            shouldExtendSession: n,
            adContentId: e,
        ...
        t.entity.adContentIds.forEach((a, s) => {
          if (t.entity.adCreativeType === o.E.QUEST) {
            ...
            let a = t.entity.adContentIds[s],
              o = O.Z.getQuest(a);
            (0, S.T)().info("".concat(null != (l = null == o ? true : o.config.messages.questName) ? l : a, " Quest impression ").concat(e ? "terminal " : "", "heartbeat: ").concat(n, "ms since last heartbeat"), {
              impressionId: t.id
            }), (0, y.dA)(P(A({}, r), {
              questId: a,
            ...
            let a = t.entity.adContentIds[s];
            (0, S.T)().info("".concat(a, " ad content impression ").concat(e ? "terminal " : "", "heartbeat: ").concat(n, "ms since last heartbeat"), {
              impressionId: t.id
            }), (0, y.Gf)(P(A({}, r), {
              adContentId: a,
    ...
    }), C(this, "commonProperties", e => A({
      impression_id: this.id,
      is_quest_enrollment_blocked: this.isQuestEnrollmentBlocked,
      quest_status: null == e ? true : (0, y.uk)(e)
    }, (0, y.mH)(this.questContent, this.questContentPosition, this.questContentRowIndex))), C(this, "clone", e => {
      let {
        triggeredByStatusChange: t
      } = e;
      return this.stop(), new M(A({
      ...
      this.entity.adContentIds.forEach((e, t) => {
        if (this.entity.adCreativeType === o.E.QUEST) {
          ...
          let e = this.entity.adContentIds[t],
            o = O.Z.getQuest(e);
          (0, S.T)().info("".concat(null != (i = null == o ? true : o.config.messages.questName) ? i : e, " Quest became visible at ").concat((0, y._b)(this.questContent)), {
            impressionId: this.id
          }), (0, y.dA)(P(A({}, n), {
            questId: e,
            event: T.rMx.QUEST_CONTENT_LOADED,
            properties: P(A({}, r, this.commonProperties(o)), {
              traffic_metadata_raw: null != (a = (0, I.NS)(this.questContent, null == o ? true : o.id)) ? a : null,
              traffic_metadata_sealed: null != (s = (0, I.K8)(this.questContent, null == o ? true : o.id)) ? s : null
            })
          }))
        } else {
          let e = this.entity.adContentIds[t];
          (0, S.T)().info("".concat(e, " ad content became visible at ").concat((0, y._b)(this.questContent)), {
            impressionId: this.id
          }), (0, y.Gf)(P(A({}, n), {
            adContentId: e,
            adCreativeType: this.entity.adCreativeType,
    ...
    this.id = (0, a.Z)(), this.questContent = i, this.questContentPosition = u, this.minViewTimeSeconds = h, this.minViewportPercentage = x, this.trackGuildAndChannelMetadata = c, this.triggeredByStatusChange = l, this.questContentRowIndex = p, this.isQuestEnrollmentBlocked = m, this.sourceQuestContent = g, o.E.QUEST, this.entity = {
      adContentIds: n,
      adCreativeType: r
    }
  }
...
function Z(e) {
  let {
    adContentIds: t,
    adCreativeType: n
  } = e, r = (0, l.e7)([O.Z], () => n !== o.E.QUEST || 1 !== t.length ? null : O.Z.getQuest(t[0]), [t, n]), a = i.useMemo(() => null == r ? null : (0, y.uk)(r), [r]), s = (0, u.Z)(a);
  return a !== s
}
let F = Chunk473749.createContext(true);
...
function H(e) {
  ...
  } = e, f = Z(e), p = i.useRef(null), _ = (0, l.e7)([O.Z], () => null != O.Z.questEnrollmentBlockedUntil, []);
  return (0, c.ZP)(() => () => {
    ...
    if ((i || s) && null != p.current && p.current.stop(), i) {
      ...
      e.adCreativeType, o.E.QUEST, p.current = new M(P(A({}, t), {
