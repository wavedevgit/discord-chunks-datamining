...
function h(e) {
  ...
  let {
    ...
    mentions: f,
    type: h
  } = n, _ = (0, o.ZP)(n), b = n.getChannelId(), E = (0, l.e7)([u.default], () => u.default.getUser(f[0]), [f]), x = (0, o.JZ)(d, i), v = (0, s.l)({
    user: d,
    channelId: b,
    guildId: i.guild_id,
    messageId: n.id
  })(x), y = (0, o.Sw)(E, i), C = (0, s.l)({
    user: E,
    channelId: b,
    guildId: i.guild_id,
    messageId: n.id
  })(y), O = null != (t = m[h]) ? t : null;
...
function _(e) {
  ...
  let {
    ...
    author: a,
    type: u
  } = n, d = (0, o.ZP)(n), m = n.getChannelId(), h = (0, o.JZ)(a, i), _ = (0, s.l)({
    user: a,
    channelId: m,
    guildId: i.guild_id,
    messageId: n.id
