...
function p() {
  let [e, t] = (0, Chunk442837.Wu)([Chunk352527.Z], () => [Chunk352527.Z.enabled, Chunk352527.Z.keepOpen]), n = (0, Chunk442837.e7)([Chunk944486.Z], () => Chunk944486.Z.getVoiceChannelId()), p = (0, Chunk442837.e7)([Chunk592125.Z], () => Chunk592125.Z.getChannel(require), [require]), m = null == p ? true : p.getGuildId();
  return module && null != p ? (0, Chunk54381.jsx)(Chunk333031.Z, {
    className: Chunk295108.container,
