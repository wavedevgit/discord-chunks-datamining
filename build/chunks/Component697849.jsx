...
function O(e) {
  let {
    ...
    onActionTaken: c,
    recurrenceId: o
  } = e, a = (0, g.xt)(t), u = (0, s.e7)([g.ZP], () => g.ZP.isInterestedInEventRecurrence(t.id, o), [o, t]), _ = (0, v.ZP)(t), f = (0, s.e7)([d.Z], () => d.Z.isLurking(n.id), [n.id]), h = (0, b.T)(null == r ? true : r.id, t.id), x = (0, P.Z)({
    guild: n,
    channel: r,
