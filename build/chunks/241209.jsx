...
var i, r, Chunk255367 = require("./255367.js"),
  ...
  Chunk532901 = require("./532901.js"),
  Chunk204227 = require("./204227.js"),
...
let O = j(_({}, d().defaultRules), {
    heading: j(_({}, d().defaultRules.heading), {
      react(e, t, n) {
        ...
        return <m.Z tag={i}>{t(e.content, n)}</m.Z>
      }
    }),
    paragraph: j(_({}, d().defaultRules.paragraph), {
      react: (e, t, n) => <div className={f.paragraph}>{t(e.content, n)}</div>
    }),
    ...
    blockQuote: j(_({}, d().defaultRules.blockQuote), {
      react: (e, t, n) => <blockquote className={f.blockquote}>{C(e)}</blockquote>
    }),
    ...
    inlineCode: j(_({}, Chunk428595.Z.RULES.inlineCode), {
      order: 6,
      react: (e, t, n) => <code className={f.codeInline}>{C(e)}</code>
    }),
    codeBlock: j(_({}, d().defaultRules.codeBlock), {
      react(e, t, i) {
        let r = () => <pre><code className={o()(b.scrollbarGhostHairline, "hljs")}>{C(e)}</code></pre>;
        return <u.GI createPromise={() => Promise.resolve().then(n.bind(n, 364964))} webpackId={364964} renderFallback={r} render={t => {
...
class T extends(r = Chunk73800.PureComponent) {
  render() {
    ...
    return <div className={o()(Chunk204227.markdown, module)}>{Chunk73800}</div>
  }
}
