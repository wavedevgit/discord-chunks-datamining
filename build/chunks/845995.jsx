...
let d = function() {
  ...
  return <Chunk906732.Gt value={d}><Chunk270394.Z invites={exports} guild={require} showChannel={true} hide={module} withV2Actions={true} canCreateInvites={true} /></Chunk906732.Gt>
}