...
function P(e) {
  let {
    ...
    context: w,
    icon: E
  } = e, Z = O.Z.getGuild(t), m = b.default.getId(), D = (0, l.e7)([d.default], () => d.default.getUser(P)), N = (0, l.e7)([p.ZP], () => p.ZP.isGuestOrLurker(t, P), [t, P]);
  ...
  return <o.sNh id={"change-nickname"} label={(0, n.jsx)("div", {
