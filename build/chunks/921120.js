    ...
    return l.useEffect(() => {
      ...
      children: g.map((e, t) => {
        ...
        let {
          ...
          size: h,
          skuId: b
        } = e, _ = null == (l = m[t]) ? void 0 : l.items[0], O = null == (i = m[t]) ? void 0 : i.type, v = O === o.Z.AVATAR_DECORATION ? 384 : 512;
        return (0, n.jsxs)("div", {
          className: p.asset,
          style: {
            top: r ? -f - v : a,
          ...
          children: [null != _ && O === o.Z.AVATAR_DECORATION && (0, n.jsx)(u.R, {
            item: _
          }), null != _ && O === o.Z.PROFILE_EFFECT && (0, n.jsx)(s.Z, {
