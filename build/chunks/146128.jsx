...
function E(e) {
  ...
  return <g.Provider value={l}>{t}</g.Provider>
}
...
function b(e) {
  ...
  return n && null != u.Z.emojiAnimationType ? o(<E>{t}</E>, u.Z.emojiAnimationType) : t
}
...
function O(e) {
  ...
  return l || _ === h.IlC.OVERLAY || !f || null == n || null == t || u || null == c || !m(i) ? null : <y emojiRef={c} channelId={t} messageId={n} emojiName={i} />
}