...
function D(e) {
  ...
  return (0, i.jsxs)(i.Fragment, {
    children: [(0, i.jsx)(o.vwX, {
      children: j.intl.string(j.t.bWVN1N)
    }), l]
  })
}
...
function k(e) {
  ...
  return (0, i.jsxs)(o.hjN, {
    ...
    children: [(0, i.jsx)(o.j7V, {
      ...
      children: [(0, i.jsx)(Z, {
        children: j.intl.string(j.t.a18Sur)
      }), (0, i.jsx)(o.iRW, {
        disabled: c,
        markers: y,
        stickToMarkers: !0,
      ...
      className: O.formItem,
      children: [(0, i.jsx)(Z, {
        children: j.intl.string(j.t.xoldVl)
      }), (0, i.jsx)(o.iRW, {
        disabled: c,
        markers: A,
        stickToMarkers: !0,
...
function B(e) {
  let {
    ...
    updateSettings: a
  } = e, c = (0, l.e7)([d.Z], () => d.Z.useReducedMotion), u = !t || !n || c, g = (e, t) => {
...
function G(e) {
  ...
  let p = e => {
      if (e.enabled && !1 === s.enabled) {
        var t;
        n(!0), (0, g.GN)("poggermode_enabled"), m.S.dispatch(C.CkL.SHAKE_APP, {
          duration: 2e3,
  ...
  return r.useEffect(() => (window.addEventListener("mousemove", _), () => window.removeEventListener("mousemove", _)), []), (0, i.jsxs)(i.Fragment, {
    children: [(0, i.jsx)(o.X6q, {
...
function z() {
  let [e, t] = r.useState(0), [n, s] = r.useState(H(e)), [a, c] = r.useState(!1), g = (0, l.e7)([d.Z], () => d.Z.useReducedMotion), m = a && !g;
  return r.useEffect(() => {
    let t = setTimeout(() => {
      s(H(e))
    }, 500);
