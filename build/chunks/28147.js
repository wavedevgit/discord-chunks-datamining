...
function M(e) {
  ...
  let {
    ...
    commandResults: a,
    query: o
  } = e, m = a.length > 4, C = r.useMemo(() => m ? a.slice(0, 4) : a, [a, m]), [_, v] = r.useState(!1), N = null != (t = (0, s.Z)(_)) ? t : _, g = r.useCallback(() => v(e => !e), []), E = (null != (n = (0, s.Z)(o)) ? n : o)[0] !== o[0], T = _ && !E;
