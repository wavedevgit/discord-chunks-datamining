...
function W(e, t, n) {
  ...
  return (0, r.jsx)(f.yRy, {
    ...
    children: e => {
      ...
      if (o.type === x.uaV.CHAT_INPUT_COMMAND || o.type === x.uaV.INTERACTION_PREMIUM_UPSELL) return (0, r.jsx)(f.P3F, G(M({}, i), {
        tag: "span",
        onClick: s,
        innerRef: n,
        children: (0, r.jsxs)("div", {
          className: a()(j.appLauncherOnboardingCommandName, j.clickable),
...
function q(e) {
  ...
  let n, {
    ...
    A = i.useRef(null),
    C = i.useRef(null),
    P = i.useMemo(() => (e, t, n) => (l()(null != t, "ExecutedCommand: user cannot be undefined"), l()(null != b, "ExecutedCommand: currentUser cannot be undefined"), l()(null != s, "ExecutedCommand: channel cannot be undefined"), (0, r.jsx)(I.Z, G(M({}, e), {
      user: t,
      currentUser: b,
      guildId: s.guild_id,
      channelId: s.id,
    ...
    x = i.useMemo(() => e => (l()(null != s, "ExecutedCommand: channel cannot be null"), (0, r.jsx)(w.Z, G(M({}, e), {
      channel: s,
      messageId: o.id,
    ...
    B = (null == k ? true : k.type) === _.B8.APPLICATION_COMMAND && null != o.messageReference && null != e.renderTargetMessage,
    ...
    let e = () => {
      ...
      t = () => (0, r.jsx)(f.P3F, {
        ...
        children: (0, r.jsx)("div", {
          className: a()(j.commandName, j.clickable),
          children: L.intl.string(L.t.YTgRvr)
        })
      });
    n = z ? L.intl.format(L.t.kfV8WF, {
      userHook: X,
      activityHook: t
    }) : L.intl.format(L.t["6FeSyc"], {
      userHook: X
    })
  }
  return (0, r.jsx)(E.Gt, {
    value: c,
    children: (0, r.jsx)("div", {
      className: a()(j.repliedMessage, j.messageSpine, j.executedCommand, V),
