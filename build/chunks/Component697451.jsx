...
function W(e, t, n) {
  ...
  return (0, r.jsx)(f.yRy, {
    ...
    children: e => {
      ...
      if (a.type === x.uaV.CHAT_INPUT_COMMAND || a.type === x.uaV.INTERACTION_PREMIUM_UPSELL) return (0, r.jsx)(f.P3F, G(k({}, i), {
        tag: "span",
        onClick: s,
        innerRef: n,
...
function q(e) {
  ...
  let n, {
    ...
    j = (0, O.t0)(a),
    U = (null == j ? true : j.type) === _.B8.APPLICATION_COMMAND && null != j.target_user ? new S.Z(j.target_user) : null,
