...
class ea extends r.Component {
  ...
  renderRefreshButton() {
    return !this.state.didSave || this.isDirty() ? null : (0, i.jsx)(T.Z, {
      grow: 0,
  ...
  renderLinkButton() {
    ...
    return null == e || 0 === Object.keys(e).length ? null : (0, i.jsx)(T.Z, {
      grow: 0,
      direction: T.Z.Direction.HORIZONTAL_REVERSE,
      children: (0, i.jsx)(T.Z.Child, {
        grow: 0,
