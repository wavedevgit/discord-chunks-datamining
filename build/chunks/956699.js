...
class et extends r.Component {
  ...
  render() {
    ...
    let s = !n && !t && this.getAvailableProjects().length > 0,
      l = $(null != r ? r : {}) && "stable" !== window.GLOBAL_ENV.RELEASE_CHANNEL ? (0, i.jsx)(p.Text, {
        color: "text-danger",
