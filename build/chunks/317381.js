...
function J(e) {
  ...
  let m = (0, b.pY)(c),
    ...
    F = {
      ...
      customId: null != (a = null == w ? void 0 : w.customId) ? a : null == B ? void 0 : B.customId
    };
  N && null != w && L.set(w.applicationId, A({}, w, F));
  let V = !P;
  null != w && c.id === w.location.id && d === w.applicationId && (!N && Array.from(w.userIds).some(e => e === T) || V) ? ee(w) : N && (null == w || w.applicationId !== d || w.location.id !== c.id) && (C === u.default.getSessionId() && ea({
    applicationId: d,
    launchId: f,
    compositeInstanceId: _,
    location: c,
  ...
  let H = (0, b.wq)(c);
  if (null != H) {
    let e = (null != (o = M.get(H)) ? o : []).filter(e => e.location.id !== c.id);
...
function er(e) {
  ...
  let {
    channel: r
  } = e, i = null != (t = k.get(r.id)) ? t : [];
  k.set(r.id, []);
  let a = X(r.guild_id),
    o = (null != (n = x.get(a)) ? n : []).filter(e => (0, b.pY)(e.location) !== r.id);
...
function ea(e) {
  ...
  let {
    ...
    customId: T,
    inviterUserId: A
  } = e, N = (0, g.ZP)(i), C = u.default.getSessionId();
  ...
  L.set(i, D), p.S.dispatch(S.CkL.OPEN_EMBEDDED_ACTIVITY, {
    location: c,
    applicationId: i,
    isFirstActivityInChannel: E,
    isStart: y,
    ...
    embeddedActivity: D,
    inviterUserId: A
  }), (0, m.R)() ? (z = I.Ez.ACTIVITY_POPOUT_WINDOW, s.Z.wait(() => {
    s.Z.dispatch({
      type: "ACTIVITY_POPOUT_WINDOW_OPEN"
    })
  })) : P !== f.Z.getChannelId() || (0, O.Z)(P) ? c.kind === a.E.CONTEXTLESS ? (z = I.Ez.PANEL, q = I.MI.NO_CHAT) : z = I.Ez.PIP : z = I.Ez.PANEL, K.set(eS(c.id, i), Date.now())
}
...
function ec(e) {
  ...
  null != r && L.set(r.applicationId, C(A({}, r), {
    config: n
  }))
}
...
class eA extends(i = o.ZP.PersistedStore) {
  initialize(e) {
    var t, n;
...
T(eA, "displayName", "EmbeddedActivitiesStore"), T(eA, "persistKey", "EmbeddedActivities"), T(eA, "migrations", [e => C(A({}, e), {
  seenFeaturedActivities: [],
  shouldShowNewActivityIndicator: !1
}), e => (delete e.seenFeaturedActivities, A({}, e)), e => (delete e.seenActivities, A({}, e)), e => (delete e.currentFreeActivity, delete e.lastFreeActivityRotationTimestampMs, delete e.freePeriodActivities, delete e.shouldShowFreeActivityIndicator, A({}, e)), e => C(A({}, e), {
  seenNewActivities: {},
  seenUpdatedActivities: {}
}), e => {
  var t;
...
}, e => (delete e.usersHavePlayedByApp, A({}, e)), e => (e.surfacesToShowNewActivityIndicator = new Set, e.shouldShowNewActivityIndicator && e.surfacesToShowNewActivityIndicator.add(l.eR.VOICE_LAUNCHER), delete e.shouldShowNewActivityIndicator, A({}, e)), e => C(A({}, e), {
  lastCheckedForBadgeableActivities: null
})]);
let eN = new eA(s.Z, {
