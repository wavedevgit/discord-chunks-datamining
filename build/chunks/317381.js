...
function ec(e) {
  ...
  let {
    ...
    customId: I,
    inviterUserId: T
  } = e, C = (0, y.ZP)(i), R = d.default.getSessionId();
  ...
  })) : P !== _.Z.getChannelId() || (0, S.Z)(P) ? c.kind === o.E.CONTEXTLESS ? (J = A.Ez.PANEL, $ = A.MI.NO_CHAT) : J = A.Ez.PIP : J = A.Ez.PANEL, X.set(eC(c.id, i), Date.now())
}
