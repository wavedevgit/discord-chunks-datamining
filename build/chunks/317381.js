...
function $(e) {
  ...
  let g = (0, v.pY)(c),
    ...
    Z = {
      ...
      userIds: new Set(N),
      participants: h,
      referrerId: null !== (i = null == L ? void 0 : L.referrerId) && void 0 !== i ? i : null == V ? void 0 : V.referrerId,
      customId: null !== (o = null == L ? void 0 : L.customId) && void 0 !== o ? o : null == V ? void 0 : V.customId
    };
...
function eo(e) {
  ...
  })) : q = P !== f.Z.getChannelId() || (0, O.Z)(P) ? S.Ez.PIP : S.Ez.PANEL, z.set(eS(c.id, i), Date.now())
}
...
N(eN, "displayName", "EmbeddedActivitiesStore"), N(eN, "persistKey", "EmbeddedActivities"), N(eN, "migrations", [e => R(A({}, e), {
