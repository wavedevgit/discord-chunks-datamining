...
function J(e) {
  ...
  let b = (0, v.pY)(u),
    ...
    O = null != y && 0 === y.length,
    S = null !== (r = k.get(u.id)) && void 0 !== r ? r : P,
    T = S.find(e => e.applicationId === d),
    A = h.map(e => e.userId),
    C = c.default.getId(),
    R = A.some(e => e === C),
    D = null === (t = h.find(e => e.userId === C)) || void 0 === t ? void 0 : t.sessionId,
    w = h.some(e => (0, E.J)(e)),
    B = L.get(d),
    F = G.get(U(null != b ? b : null, d)),
    ...
    Z = {
      ...
      userIds: new Set(A),
      participants: h,
      referrerId: null !== (i = null == B ? void 0 : B.referrerId) && void 0 !== i ? i : null == V ? void 0 : V.referrerId,
      customId: null !== (o = null == B ? void 0 : B.customId) && void 0 !== o ? o : null == V ? void 0 : V.customId
    };
  R && null != B && L.set(B.applicationId, N({}, B, Z));
  let H = !w;
  null != B && u.id === B.location.id && d === (null == B ? void 0 : B.applicationId) && (!R && Array.from(B.userIds).some(e => e === C) || H) ? (L.delete(d), _.S.dispatch(I.CkL.RELEASE_ACTIVITY_WEB_VIEW)) : R && (null == B || B.applicationId !== d || B.location.id !== u.id) && D === c.default.getSessionId() && ei({
    applicationId: d,
    launchId: f,
    compositeInstanceId: p,
    location: u,
  ...
  A.length > 0 && W.push(Z), k.set(u.id, W);
  let Y = (0, v.wq)(u);
  if (null != Y) {
    let e = (null !== (a = j.get(Y)) && void 0 !== a ? a : []).filter(e => e.location.id !== u.id);
    A.length > 0 && e.push(Z), j.set(Y, e)
  }
  if (null != b) {
    let e = (null !== (s = M.get(b)) && void 0 !== s ? s : []).filter(e => e.applicationId !== d),
      t = X((0, v.jS)(u)),
      n = (null !== (l = x.get(t)) && void 0 !== l ? l : []).filter(e => e.applicationId !== d || e.location.id !== u.id);
    A.length > 0 && (e.push(Z), n.push(Z)), M.set(b, e), x.set(t, n)
  }
}
...
function ee(e) {
  ...
  M.clear(), x.clear(), k.clear(), j.clear(), t.forEach(e => $(e))
}
...
function en(e) {
  ...
  M.set(r.id, []);
  let o = X(r.guild_id),
    a = (null !== (n = x.get(o)) && void 0 !== n ? n : []).filter(e => (0, v.pY)(e.location) !== r.id);
...
function ei(e) {
  ...
  let {
    ...
    customId: T,
    inviterUserId: N
  } = e, A = (0, m.ZP)(i), C = c.default.getSessionId();
  if (null == A || null == C || (null === (t = L.get(i)) || void 0 === t ? void 0 : t.location.id) === l.id) return !1;
  let R = (0, v.pY)(l),
    P = u.Z.getChannel(R),
    D = null == P ? void 0 : P.getGuildId();
  if (null == f.default.getCurrentUser() || !(0, g.sq)() && null == D && !(null !== (n = null == P ? void 0 : P.isPrivate()) && void 0 !== n && n)) return !1;
  r = l;
  let w = {
    applicationId: i,
    url: A,
  ...
  L.set(i, w), _.S.dispatch(I.CkL.OPEN_EMBEDDED_ACTIVITY, {
    location: l,
    applicationId: i,
    isFirstActivityInChannel: E,
    isStart: b,
...
function es(e) {
  ...
  if (null == n) return !1;
  let r = L.get(null !== (t = n.application_id) && void 0 !== t ? t : "");
  if (null == r) return !1;
  L.set(r.applicationId, N({}, r))
}
...
function el(e) {
  ...
  null != r && L.set(r.applicationId, C(N({}, r), {
    config: n
  }))
}
...
function eh(e) {
  ...
  R.everLaunchedActivities.add(t), em({
    applicationId: t,
    channelId: n
  })
}
...
class eT extends(i = o.ZP.PersistedStore) {
  ...
  getSelfEmbeddedActivityForChannel(e) {
    var t;
    return null == e ? null : null !== (t = Array.from(L.values()).find(t => (0, v.pY)(t.location) === e)) && void 0 !== t ? t : null
  }
  ...
  getEmbeddedActivitiesForGuild(e) {
    var t;
    return null !== (t = x.get(e)) && void 0 !== t ? t : P
  }
  ...
  getEmbeddedActivitiesForLocation(e) {
    var t;
    return null !== (t = k.get(e.id)) && void 0 !== t ? t : P
  }
  getEmbeddedActivitiesForStartingChannel(e) {
    var t;
    return null !== (t = j.get(e)) && void 0 !== t ? t : P
  }
  ...
  getShelfActivities(e) {
    var t;
    let n = X(e);
    return null !== (t = B.get(n)) && void 0 !== t ? t : D
  }
  ...
  getGridOrientationLockStateForApp(e) {
    var t, n;
    return null !== (n = null !== (t = H.get(e)) && void 0 !== t ? t : Z.get(e)) && void 0 !== n ? n : this.getOrientationLockStateForApp(e)
  }
