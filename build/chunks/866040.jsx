...
function m(e) {
  ...
  return <o.Ttm className={d.popout}>{t.map(e => (0, r.jsx)(s.Z, {
      user: e,
...
function g(e) {
  ...
  return null != f ? <o.ze6 theme={d}><l.Z targetElementRef={u} user={f} guildId={null == a ? true : a.guild_id} channelId={null == a ? true : a.id} onClosePopout={s}>{t}</l.Z></o.ze6> : <o.ze6 theme={d}><o.yRy targetElementRef={u} renderPopout={() => {
