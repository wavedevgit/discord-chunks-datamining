...
function d(e) {
  ...
  } = e, E = (0, l.e7)([o.Z], () => o.Z.isConnected()), O = (0, l.e7)([u.Z], () => null != t ? u.Z.getSubscriptionGroupListingsForGuildFetchState(t) : u.M.FETCHED), _ = i.useRef(s), S = i.useCallback(() => {
    if (null == t || !E || !0 === f) return;
    let e = u.Z.getSubscriptionGroupListingsForGuildFetchState(t);
    (_.current || e === u.M.NOT_FETCHED) && (_.current = !1, a.FP(t, {
      includeSoftDeleted: d,
      countryCode: p
    }))
  }, [E, t, d, p, f]), g = i.useMemo(() => O === u.M.FETCHED && !0 !== _.current, [O, _]);
