...
class S extends Chunk73800.PureComponent {
  ...
  render() {
    ...
    return <Chunk748780.Z.div className={a()(Chunk95072.transition, require)} style={this.getWidthStyle()}>{<div className={a()(Chunk95072.spriteWrapper, Chunk893354.horizontal, Chunk893354.justifyCenter, Chunk893354.alignCenter)}><Chunk748780.Z.div className={Chunk120356} style={this.getSpriteStyle()} /></div>}{<Chunk748780.Z.div style={this.getScaleStyle()}>{exports}</Chunk748780.Z.div>}</Chunk748780.Z.div>
  }
  constructor(...e) {
...
function N(e) {
  let {
    ...
    return <S className={m.participant} width={(0, d.pxk)(E)} theme={g}><p.Z userId={a.id} src={a.getAvatarURL(u, (0, d.pxk)(E), l && b)} size={E} muted={null != (t = null == s ? true : s.isVoiceMuted()) && t} deafen={null != (i = null == s ? true : s.isVoiceDeafened()) && i} speaking={l} ringing={c} onClick={t => null == o ? true : o(e, t)} onContextMenu={t => null == n ? true : n(e, t)} /></S>
  });
  return <c.W component={"div"} className={a()(m.root, i)}>{y}</c.W>
}