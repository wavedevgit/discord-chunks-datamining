...
function ez() {
  ...
  } = (0, A.ZP)(), t = (0, u.e7)([et.Z], () => et.Z.isMuted()), n = t ? eD.NW.string(eD.t.ScHlfn) : eD.NW.string(eD.t.zqxfra);
  return (0, r.jsx)(ej.Z, {
    "aria-label": n,
    tooltipText: n,
    icon: t ? f.xjP : f.RZG,
...
function eY(e) {
  ...
  } = (0, A.ZP)(), c = (0, k.Q3)("ConnectedVideoButton"), {
    coloredIconsEnabled: d,
    simplifiedSettingsEnabled: h
  } = (0, ei.Z)({
    location: "ConnectedVideoButton"
  }), m = (0, el.Z)(), b = (0, eo.Z)(t), _ = (0, u.e7)([y.ZP], () => null != y.ZP.getSelfEmbeddedActivityForLocation(y.ZP.getConnectedActivityLocation())), E = (0, K.Z)(t), {
    reachedLimit: O,
    limit: I
  } = (0, ea.Z)(t), v = i.useCallback(() => {
    (0, ec.Z)()
  }, []), C = (0, N.bp)(), S = i.useCallback(e => {
  ...
  return i.useEffect(() => () => j(), [m.enabled, j]), (0, r.jsx)(eh.Z, eW(eG({
    onChange: S,
      ...
      return (0, r.jsx)(f.yRy, {
        ...
        children: (e, l) => {
          ...
          return (0, r.jsx)(f.ua7, {
            text: i,
            children: e => (0, r.jsx)(f.zxk, eW(eG({
              buttonRef: o
            }, p, e, u), {
              onClick: t => {
                var n;
...
function eK(e) {
  ...
  } = (0, A.ZP)(), d = o === eL.IlC.POPOUT, p = (0, C.KF)(t.id), h = (0, C.g5)(p), {
    userInActivity: g
  } = (0, u.cj)([y.ZP], () => ({
  ...
  return n ? (0, r.jsx)(f.ua7, {
    text: h,
    children: e => (0, r.jsxs)(f.zxk, eW(eG(eW(eG({}, e), {
      fullWidth: !0,
...
function eq(e) {
  ...
  return (0, r.jsx)(f.yRy, {
    ...
    children: e => {
      ...
      return (0, r.jsx)(f.ua7, {
        text: T,
        children: e => (0, r.jsx)(f.zxk, eW(eG(eW(eG({}, e), {
          buttonRef: c,
...
class eQ extends i.PureComponent {
  ...
  renderNoiseCancellation() {
    ...
    return null != i ? null : (null == l ? void 0 : l.isGuildStageVoice()) && null == a.find(e => e.user.id === eg.default.getId() && (0, en.gf)(e.voiceState) === en.xO.ON_STAGE) && (0, ee.U5)(l.id) ? (0, r.jsx)(ez, {}) : !n && t ? (0, r.jsx)(f.ua7, {
  ...
  constructor(...e) {
    super(...e), eU(this, "ref", i.createRef()), eU(this, "handleChannelLinkClick", e => {
      var t;
      let {
        guild: n,
        channel: r
...
let eJ = (0, E.Z)(function(e) {
  ...
  } = (0, A.ZP)(j.Z.RTC_PANEL), R = (0, I.Z)(null != h ? h : eL.lds, null == p ? void 0 : p.id), D = (0, S.Z)(null == p ? void 0 : p.id);
  return (0, r.jsx)(A.Gt, {
    value: w,
    children: (0, r.jsxs)("div", {
