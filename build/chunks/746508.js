...
function eK() {
  ...
  (0, g.Tbt)(e), i.useEffect(() => {
    eT.default.track(eR.rMx.OPEN_POPOUT, {
...
function eq() {
  ...
  } = (0, Z.ZP)(), t = (0, u.e7)([er.Z], () => er.Z.isMuted()), n = t ? eU.intl.string(eU.t.ScHlfn) : eU.intl.string(eU.t.zqxfra);
  return (0, r.jsx)(eZ.Z, {
    "aria-label": n,
    tooltipText: n,
    icon: t ? g.xjP : g.RZG,
...
function eX(e) {
  ...
  return i.useEffect(() => () => N(), [c.enabled, N]), (0, r.jsx)(ef.Z, eF(eH({
    onChange: y,
      ...
      return (0, r.jsx)(g.yRy, {
        ...
        children: (e, l) => {
          ...
          return (0, r.jsx)(g.ua7, {
            text: i,
            children: e => (0, r.jsx)(g.zxk, eF(eH({
              buttonRef: o
            }, u, e, c), {
              onClick: t => {
                var n;
...
function eQ(e) {
  ...
  } = (0, Z.ZP)(), s = i === eR.IlC.POPOUT, c = (0, N.KF)(t.id), p = (0, N.g5)(c), {
    userInActivity: h
  } = (0, u.cj)([v.ZP], () => ({
  ...
  return n ? (0, r.jsx)(g.ua7, {
    ...
    children: e => (0, r.jsx)(U.Xf, {
      ...
      children: n => {
        ...
        return (0, r.jsxs)(g.zxk, eF(eH(eF(eH({}, e), {
          fullWidth: !0,
          size: g.zxk.Sizes.MEDIUM
        }), _), {
          onClick: () => {
            ...
            O(), (0, j.Z)({
              ...
              openInPopout: s,
              analyticsLocations: l
            }), null == (n = e.onClick) || n.call(e), (0, w.v)(o, w.d.ACTIVITY), i === d.z.ACTIVITIES_VOICE_LAUNCHER_BADGE && c(ek.L.TAKE_ACTION)
          },
          onMouseEnter: () => {
            var t;
...
function eJ(e) {
  ...
  return (0, r.jsx)(g.yRy, {
    ...
    children: e => {
      ...
      return (0, r.jsx)(g.ua7, {
        text: S,
        children: e => (0, r.jsx)(g.zxk, eF(eH(eF(eH({}, e), {
          buttonRef: c,
          size: g.zxk.Sizes.MEDIUM,
          onClick: r => {
            var i;
...
class e$ extends i.PureComponent {
  renderConnectionStatus() {
    ...
    return null != n ? (e = eR.Z5c.CHANNEL(n.id, t.id), u = "".concat(u, " / ").concat(n.name)) : e = eR.Z5c.CHANNEL(eR.ME, t.id), (0, r.jsx)(q.Z, {
      channelId: t.id,
      quality: i,
      state: l,
      lastPing: a,
  ...
  renderNoiseCancellation() {
    ...
    return null != i ? null : (null == l ? void 0 : l.isGuildStageVoice()) && null == a.find(e => e.user.id === em.default.getId() && (0, ei.gf)(e.voiceState) === ei.xO.ON_STAGE) && (0, en.U5)(l.id) ? (0, r.jsx)(eq, {}) : !n && t ? (0, r.jsx)(g.ua7, {
...
let e1 = (0, E.Z)(function(e) {
  let {
  ...
  }), l = (0, B.Z)(), a = (0, u.e7)([G.Z], () => G.Z.getAwaitingRemoteSessionInfo()), o = (0, u.e7)([eC.default], () => eC.default.getCurrentUser()), s = (0, u.cj)([eI.Z], () => null != l ? {
    ...
    channelId: c
  } = s, d = ez(s, ["channelId"]), p = (0, u.e7)([eb.Z], () => eb.Z.getChannel(c), [c]), h = null == p ? void 0 : p.getGuildId(), f = (0, u.e7)([e_.Z], () => e_.Z.getGuild(h), [h]), m = (0, u.cj)([eE.Z], () => ({
  ...
  })), b = (0, u.e7)([eE.Z, W.Z], () => W.Z.hasHotspot(eM.v.VOICE_PANEL_INTRODUCTION) && (0, ej.EO)(o) && !eE.Z.isInteractionRequired() && !(null == p ? void 0 : p.isGuildStageVoice())), _ = (0, u.e7)([eS.Z], () => null != c && eS.Z.hasVideo(c), [c]), O = (0, u.e7)([eg.Z], () => eg.Z.getCurrentUserActiveStream()), E = (0, u.e7)([eO.Z], () => eO.Z.hasLayers()), y = (0, u.e7)([Y.Z], () => Y.Z.isViewingRoles(h)), I = (0, u.e7)([ey.Z], () => y && !ey.Z.can(eR.Plq.VIEW_CHANNEL, p), [y, p]), v = el.Fg.useSetting(), [S, N, P] = (0, u.Wu)([eN.ZP, J.Z], () => (null == p ? void 0 : p.isGuildStageVoice()) ? [J.Z.getMutableParticipants(p.id, $.pV.SPEAKER), J.Z.getParticipantsVersion(p.id), null] : [null, null, null != p ? eN.ZP.getVoiceStatesForChannel(p) : null], [p]), j = i.useMemo(() => {
    var e, t;
  ...
  }, [S, N, P]), [x, L] = i.useState(!1), w = (0, k.Z)("RTCConnection");
  i.useEffect(() => {
    (y || I) && L(!1)
  }, [y, I, L]);
  let {
    analyticsLocations: R
  } = (0, Z.ZP)(A.Z.RTC_PANEL), D = (0, C.Z)(null != h ? h : eR.lds, null == p ? void 0 : p.id), M = (0, T.Z)(null == p ? void 0 : p.id);
  return (0, r.jsx)(Z.Gt, {
    value: R,
    children: (0, r.jsxs)("div", {
      className: eG.wrapper,
      children: [null != l || null != a ? (0, r.jsx)(V.Z, {
        voiceState: l,
        awaitingRemoteSessionInfo: a
      }) : null, (0, r.jsx)(e$, eF(eH({}, e, m, d), {
        enableActivities: D,
        remoteVoiceState: l,
        guild: f,
        channel: p,
