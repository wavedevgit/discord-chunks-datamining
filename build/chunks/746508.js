...
let e1 = (0, O.Z)(function(e) {
  let {
    ...
    channelId: c
  } = s, d = ez(s, ["channelId"]), p = (0, u.e7)([eb.Z], () => eb.Z.getChannel(c), [c]), h = null == p ? void 0 : p.getGuildId(), f = (0, u.e7)([e_.Z], () => e_.Z.getGuild(h), [h]), m = (0, u.cj)([eO.Z], () => ({
  ...
  })), b = (0, u.e7)([eO.Z, W.Z], () => W.Z.hasHotspot(eM.v.VOICE_PANEL_INTRODUCTION) && (0, ej.EO)(o) && !eO.Z.isInteractionRequired() && !(null == p ? void 0 : p.isGuildStageVoice())), _ = (0, u.e7)([eS.Z], () => null != c && eS.Z.hasVideo(c), [c]), E = (0, u.e7)([eg.Z], () => eg.Z.getCurrentUserActiveStream()), O = (0, u.e7)([eE.Z], () => eE.Z.hasLayers()), y = (0, u.e7)([Y.Z], () => Y.Z.isViewingRoles(h)), I = (0, u.e7)([ey.Z], () => y && !ey.Z.can(eR.Plq.VIEW_CHANNEL, p), [y, p]), v = el.Fg.useSetting(), [S, N, P] = (0, u.Wu)([eN.ZP, J.Z], () => (null == p ? void 0 : p.isGuildStageVoice()) ? [J.Z.getMutableParticipants(p.id, $.pV.SPEAKER), J.Z.getParticipantsVersion(p.id), null] : [null, null, null != p ? eN.ZP.getVoiceStatesForChannel(p) : null], [p]), j = i.useMemo(() => {
    var e, t;
