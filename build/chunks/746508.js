...
function ez() {
  let e = i.useRef(null);
  (0, f.Tbt)(e), i.useEffect(() => {
    eS.default.track(eL.rMx.OPEN_POPOUT, {
      type: eL.jXE.NOISE_CANCELLATION_POPOUT
    })
  }, []);
...
function eW() {
  ...
  } = (0, A.ZP)(), t = (0, u.e7)([et.Z], () => et.Z.isMuted()), n = t ? eD.intl.string(eD.t.ScHlfn) : eD.intl.string(eD.t.zqxfra);
  return (0, r.jsx)(ej.Z, {
    "aria-label": n,
    tooltipText: n,
    icon: t ? f.xjP : f.RZG,
...
function eY(e) {
  let {
  ...
  } = (0, A.ZP)(), c = (0, ei.Z)(), d = (0, ea.Z)(t), h = (0, u.e7)([I.ZP], () => null != I.ZP.getSelfEmbeddedActivityForLocation(I.ZP.getConnectedActivityLocation())), m = (0, K.Z)(t), {
    reachedLimit: b,
    limit: _
  } = (0, el.Z)(t), O = i.useCallback(() => {
    (0, es.Z)()
  }, []), E = (0, y.bp)(), v = i.useCallback(e => {
    ...
    play: N,
    events: T
  } = (0, p.o)(c.enabled ? "disable" : "enable");
  return i.useEffect(() => () => N(), [c.enabled, N]), (0, r.jsx)(ep.Z, eB(eG({
    onChange: v,
    ...
    children: e => {
      var {
        ...
        iconComponent: l,
        iconColor: c
      } = e, u = eV(e, ["unavailable", "isActive", "label", "iconComponent", "iconColor"]);
      let d = (0, r.jsx)(S, {
        size: "md",
...
function eK(e) {
  ...
  } = (0, A.ZP)(), s = i === eL.IlC.POPOUT, c = (0, S.KF)(t.id), d = (0, S.g5)(c), {
    userInActivity: p
  } = (0, u.cj)([I.ZP], () => ({
    userInActivity: null != I.ZP.getSelfEmbeddedActivityForChannel(t.id)
  })), h = (0, C.a)({
    surface: E.eR.VOICE_LAUNCHER
  }), g = c !== S.jy.CAN_LAUNCH, {
    Component: m,
    events: b,
    play: _
    ...
    children: e => (0, r.jsxs)(f.zxk, eB(eG(eB(eG({}, e), {
      ...
      onClick: () => {
        ...
        _(), (0, P.Z)({
          ...
          openInPopout: s,
          analyticsLocations: l
        }), null == (n = e.onClick) || n.call(e), (0, L.v)(o, L.d.ACTIVITY)
      },
      onMouseEnter: () => {
        var t;
  ...
  return (0, r.jsx)(f.yRy, {
    ...
    renderPopout: e => {
      ...
      return (0, r.jsx)(eo.Z, {
        ...
        onInteraction: (0, w.u)("ManageStreamsMenu", p, {
          entrypoint: ew.A5.OTHER_BUTTON
        })
      })
    },
    position: "top",
...
class eQ extends i.PureComponent {
  renderConnectionStatus() {
    ...
    return null != n ? (e = eL.Z5c.CHANNEL(n.id, t.id), u = "".concat(u, " / ").concat(n.name)) : e = eL.Z5c.CHANNEL(eL.ME, t.id), (0, r.jsx)(Y.Z, {
      channelId: t.id,
      quality: i,
      state: l,
      lastPing: a,
  ...
  renderNoiseCancellation() {
    ...
    return null != i ? null : (null == l ? void 0 : l.isGuildStageVoice()) && null == a.find(e => e.user.id === ef.default.getId() && (0, en.gf)(e.voiceState) === en.xO.ON_STAGE) && (0, ee.U5)(l.id) ? (0, r.jsx)(eW, {}) : !n && t ? (0, r.jsx)(f.ua7, {
  ...
  render() {
    ...
    return null == e ? null : (0, r.jsx)(f.yRy, {
  ...
  constructor(...e) {
    super(...e), eU(this, "ref", i.createRef()), eU(this, "krispButtonRef", i.createRef()), eU(this, "handleChannelLinkClick", e => {
      var t;
      let {
        guild: n,
        channel: r
...
function eX(e) {
  ...
  return i.useEffect(() => () => s(), [l, s]), (0, r.jsx)(ej.Z, eB(eG({}, t), {
    ref: a,
    onClick: e => {
...
let eJ = (0, O.Z)(function(e) {
  let {
  ...
  }), l = (0, U.Z)(), a = (0, u.e7)([M.Z], () => M.Z.getAwaitingRemoteSessionInfo()), o = (0, u.e7)([eI.default], () => eI.default.getCurrentUser()), s = (0, u.cj)([eE.Z], () => null != l ? {
    ...
    channelId: c
  } = s, d = eV(s, ["channelId"]), p = (0, u.e7)([eg.Z], () => eg.Z.getChannel(c), [c]), h = null == p ? void 0 : p.getGuildId(), g = (0, u.e7)([em.Z], () => em.Z.getGuild(h), [h]), m = (0, u.cj)([e_.Z], () => ({
  ...
  })), b = (0, u.e7)([e_.Z, F.Z], () => F.Z.hasHotspot(eR.v.VOICE_PANEL_INTRODUCTION) && (0, eT.EO)(o) && !e_.Z.isInteractionRequired() && !(null == p ? void 0 : p.isGuildStageVoice())), _ = (0, u.e7)([ev.Z], () => null != c && ev.Z.hasVideo(c), [c]), O = (0, u.e7)([eh.Z], () => eh.Z.getCurrentUserActiveStream()), E = (0, u.e7)([eb.Z], () => eb.Z.hasLayers()), y = (0, u.e7)([z.Z], () => z.Z.isViewingRoles(h)), I = (0, u.e7)([eO.Z], () => y && !eO.Z.can(eL.Plq.VIEW_CHANNEL, p), [y, p]), C = er.Fg.useSetting(), [S, T, P] = (0, u.Wu)([eC.ZP, Q.Z], () => (null == p ? void 0 : p.isGuildStageVoice()) ? [Q.Z.getMutableParticipants(p.id, X.pV.SPEAKER), Q.Z.getParticipantsVersion(p.id), null] : [null, null, null != p ? eC.ZP.getVoiceStatesForChannel(p) : null], [p]), Z = i.useMemo(() => {
    var e, t;
  ...
  }, [S, T, P]), [x, L] = i.useState(!1), w = (0, D.Z)("RTCConnection");
  i.useEffect(() => {
    (y || I) && L(!1)
  }, [y, I, L]);
  let {
    analyticsLocations: R
  } = (0, A.ZP)(j.Z.RTC_PANEL), k = (0, v.Z)(null != h ? h : eL.lds, null == p ? void 0 : p.id), V = (0, N.Z)(null == p ? void 0 : p.id);
  return (0, r.jsx)(A.Gt, {
    value: R,
    children: (0, r.jsxs)("div", {
