...
function eY(e) {
  let {
    ...
    (0, w.v)(a, w.d.CAMERA, e), e ? (0, eh.Z)(n, y) : n()
  }, [t, y, a]), S = b || n || _, {
    Component: T,
    play: P,
    events: j
...
function eK(e) {
  ...
  } = (0, x.ZP)(), p = a === ew.IlC.POPOUT, h = (0, T.KF)(t.id), f = (0, T.g5)(h), {
    userInActivity: m
  } = (0, u.cj)([I.ZP], () => ({
    userInActivity: null != I.ZP.getSelfEmbeddedActivityForChannel(t.id)
  })), b = (0, N.O)(), _ = (0, S.a)(), E = h !== T.jy.CAN_LAUNCH, {
    enabled: O
  } = y.c.useExperiment({
  ...
  return n ? (0, r.jsx)(g.ua7, {
    ...
    children: e => (0, r.jsxs)(g.zxk, eV(eW(eV(eW({}, e), {
      ...
      innerClassName: eM.buttonContents,
      wrapperClassName: eM.button,
      children: [_ ? (0, r.jsx)(j.r, {
        top: -1,
        right: -1
      }) : null, O ? (0, r.jsx)(g.iWm, {
        size: i ? "md" : "sm",
        color: "currentColor",
...
class eQ extends i.PureComponent {
  ...
  renderNoiseCancellation() {
    ...
    return null != i ? null : (null == l ? void 0 : l.isGuildStageVoice()) && null == o.find(e => e.user.id === em.default.getId() && (0, er.gf)(e.voiceState) === er.xO.ON_STAGE) && (0, et.U5)(l.id) ? (0, r.jsx)(ez, {}) : !n && t ? (0, r.jsx)(g.ua7, {
