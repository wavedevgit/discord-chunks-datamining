...
function ez() {
  ...
  } = (0, Z.ZP)(), t = (0, u.e7)([et.Z], () => et.Z.isMuted()), n = t ? eD.NW.string(eD.t.ScHlfn) : eD.NW.string(eD.t.zqxfra);
  return (0, r.jsx)(ej.Z, {
    "aria-label": n,
    tooltipText: n,
    icon: t ? g.xjP : g.RZG,
...
function eY(e) {
  ...
  } = (0, Z.ZP)(), s = (0, k.Q3)("ConnectedVideoButton"), {
    coloredIconsEnabled: c,
    simplifiedSettingsEnabled: d
  } = (0, ei.Z)({
    location: "ConnectedVideoButton"
  }), p = (0, el.Z)(), f = (0, ea.Z)(t), b = (0, u.e7)([y.ZP], () => null != y.ZP.getSelfEmbeddedActivityForLocation(y.ZP.getConnectedActivityLocation())), _ = (0, K.Z)(t), {
    reachedLimit: E,
    limit: O
  } = (0, eo.Z)(t), v = i.useCallback(() => {
    (0, ec.Z)()
  }, []), I = (0, N.bp)(), C = i.useCallback(e => {
    if (eE.Z.isVideoEnabled() === e) return;
    let n = () => {
      var n;
      m.Z.setVideoEnabled(e), e && (0, z.uL)(ew.Z5c.CHANNEL(null !== (n = t.getGuildId()) && void 0 !== n ? n : ew.ME, t.id))
    };
    (0, w.v)(a, w.d.CAMERA, e), e ? (0, ep.Z)(n, I) : n()
  }, [t, I, a]), S = b || n || _, {
    Component: T,
    play: P,
    events: j
  } = (0, h.o)(p.enabled ? "disable" : "enable");
  return i.useEffect(() => () => P(), [p.enabled, P]), (0, r.jsx)(eh.Z, eW(eG({
    onChange: C,
      ...
      return (0, r.jsx)(g.yRy, {
        renderPopout: e => {
          ...
          return (0, r.jsx)(x.Z, {
            onClose: t,
            simplified: d,
            onInteraction: (0, L.u)("VideoDeviceMenu", a)
          })
        },
        position: "top",
        align: "center",
        ...
        children: (e, l) => {
          ...
          return (0, r.jsx)(g.ua7, {
            text: i,
            children: e => (0, r.jsx)(g.zxk, eW(eG({}, u, e, d), {
              onClick: t => {
                var n;
...
function eK(e) {
  let {
    channel: t,
    enableActivities: n
  } = e, i = (0, k.Q3)("ConnectedActivityButton"), {
  ...
  } = (0, Z.ZP)(), p = a === ew.IlC.POPOUT, h = (0, S.KF)(t.id), f = (0, S.g5)(h), {
    userInActivity: m
  } = (0, u.cj)([y.ZP], () => ({
    userInActivity: null != y.ZP.getSelfEmbeddedActivityForChannel(t.id)
  })), b = (0, C.a)(), _ = h !== S.jy.CAN_LAUNCH, {
    enabled: E
  } = v.c.useExperiment({
  ...
  return n ? (0, r.jsx)(g.ua7, {
    text: f,
    children: e => (0, r.jsxs)(g.zxk, eW(eG(eW(eG({}, e), {
      fullWidth: !0,
      ...
      onClick: () => {
        ...
        T(), (0, j.Z)({
          ...
          openInPopout: p,
          analyticsLocations: s
        }), null === (n = e.onClick) || void 0 === n || n.call(e), (0, w.v)(c, w.d.ACTIVITY)
      },
      onMouseEnter: () => {
        var t;
      ...
      wrapperClassName: ek.button,
      focusProps: eB,
      children: [b ? (0, r.jsx)(P.r, {
        top: -1,
        right: -1
      }) : null, E ? (0, r.jsx)(g.iWm, {
        size: i ? "md" : "sm",
        color: "currentColor",
  ...
  return (0, r.jsx)(g.yRy, {
    renderPopout: e => {
      ...
      return (0, r.jsx)(es.Z, {
        ...
        onInteraction: (0, L.u)("ManageStreamsMenu", c, {
    ...
    children: e => {
      ...
      return (0, r.jsx)(g.ua7, {
        text: S,
        children: e => (0, r.jsx)(g.zxk, eW(eG(eW(eG({}, e), {
...
class eQ extends i.PureComponent {
  renderConnectionStatus() {
    ...
    return null != n ? (e = ew.Z5c.CHANNEL(n.id, t.id), s = "".concat(s, " / ").concat(n.name)) : e = ew.Z5c.CHANNEL(ew.ME, t.id), (0, r.jsx)(Y.Z, {
      channelId: t.id,
      quality: i,
      state: l,
      lastPing: o,
      ...
      children: (0, r.jsx)(g.tEY, {
        children: (0, r.jsx)(c.rU, {
          ...
          children: (0, r.jsx)(eA.Z, {
            ...
            children: this.props.isVisualRefreshEnabled ? (0, r.jsx)(g.Text, {
  ...
  renderNoiseCancellation() {
    ...
    return null != i ? null : (null == l ? void 0 : l.isGuildStageVoice()) && null == o.find(e => e.user.id === eg.default.getId() && (0, en.gf)(e.voiceState) === en.xO.ON_STAGE) && (0, ee.U5)(l.id) ? (0, r.jsx)(ez, {}) : !n && t ? (0, r.jsx)(g.ua7, {
  ...
  render() {
    ...
    return null == e ? null : (0, r.jsx)(g.yRy, {
  ...
  constructor(...e) {
    super(...e), eU(this, "handleChannelLinkClick", e => {
      var t;
      let {
        guild: n,
        channel: r
      } = this.props;
      s()(null != r, "Channel is null during navigation click"), e.stopPropagation(), _.Z.channelListScrollTo(null !== (t = null == n ? void 0 : n.id) && void 0 !== t ? t : ew.ME, r.id), (0, w.v)(A.Z.RTC_PANEL, w.d.CHANNEL_LINK)
      ...
      (0, b.jW)(e, async () => {
        ...
        return n => (0, r.jsx)(Z.Gt, {
          ...
          children: (0, r.jsx)(e, eW(eG({}, n), {
            channel: t,
            onInteraction: (0, L.u)("RTCConnectionMenu", A.Z.RTC_PANEL)
          }))
        })
      })
...
function eX(e) {
  ...
  return i.useEffect(() => () => a(), [l, a]), (0, r.jsx)(ej.Z, eW(eG({}, t), {
    onClick: e => {
...
let eJ = (0, O.Z)(function(e) {
  let t = (0, k.Q3)("ConnectedRTCConnection"),
    ...
    v = (0, u.e7)([eO.Z], () => N && !eO.Z.can(ew.Plq.VIEW_CHANNEL, p), [N, p]),
    y = er.Fg.useSetting(),
  ...
  } = (0, Z.ZP)(A.Z.RTC_PANEL), R = (0, I.Z)(null != h ? h : ew.lds, null == p ? void 0 : p.id), D = (0, T.Z)(null == p ? void 0 : p.id);
  return (0, r.jsx)(Z.Gt, {
    value: L,
    children: (0, r.jsxs)("div", {
      className: ek.wrapper,
      children: [null != l || null != o ? (0, r.jsx)(G.Z, {
        voiceState: l,
        awaitingRemoteSessionInfo: o
      }) : null, (0, r.jsx)(eQ, eW(eG({}, e, m, d), {
        enableActivities: R,
        remoteVoiceState: l,
        guild: f,
        channel: p,
