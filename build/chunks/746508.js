...
function eF() {
  ...
  (0, f.Tbt)(e), i.useEffect(() => {
    eS.default.track(ex.rMx.OPEN_POPOUT, {
...
function ez() {
  ...
  } = (0, A.ZP)(), t = (0, u.e7)([et.Z], () => et.Z.isMuted()), n = t ? eR.intl.string(eR.t.ScHlfn) : eR.intl.string(eR.t.zqxfra);
  return (0, r.jsx)(eP.Z, {
    "aria-label": n,
    tooltipText: n,
    icon: t ? f.xjP : f.RZG,
...
function eW(e) {
  ...
  return i.useEffect(() => () => T(), [d.enabled, T]), (0, r.jsx)(ep.Z, eG(eU({
    onChange: C,
      ...
      return (0, r.jsx)(f.yRy, {
        ...
        children: (e, l) => {
          ...
          return (0, r.jsx)(f.ua7, {
            text: i,
            children: e => (0, r.jsx)(f.zxk, eG(eU({
              buttonRef: o
            }, d, e, u), {
              onClick: t => {
                var n;
...
function eY(e) {
  let {
    ...
    parentAnalyticsLocation: s
  } = (0, A.ZP)(), c = l === ex.IlC.POPOUT, d = (0, S.KF)(t.id), p = (0, S.g5)(d), {
    userInActivity: h
  } = (0, u.cj)([I.ZP], () => ({
  ...
  return n ? (0, r.jsx)(f.ua7, {
    text: p,
    children: e => (0, r.jsxs)(f.zxk, eG(eU(eG(eU({}, e), {
      fullWidth: !0,
...
class eq extends i.PureComponent {
  renderConnectionStatus() {
    ...
    return null != n ? (e = ex.Z5c.CHANNEL(n.id, t.id), s = "".concat(s, " / ").concat(n.name)) : e = ex.Z5c.CHANNEL(ex.ME, t.id), (0, r.jsx)(Y.Z, {
      channelId: t.id,
      quality: i,
      state: l,
      lastPing: a,
  ...
  renderNoiseCancellation() {
    ...
    return null != i ? null : (null == l ? void 0 : l.isGuildStageVoice()) && null == a.find(e => e.user.id === ef.default.getId() && (0, en.gf)(e.voiceState) === en.xO.ON_STAGE) && (0, ee.U5)(l.id) ? (0, r.jsx)(ez, {}) : !n && t ? (0, r.jsx)(f.ua7, {
      ...
      children: () => (0, r.jsxs)("div", {
        ...
        children: [(0, r.jsxs)(D.Z, {
          ...
          children: [(0, r.jsx)("div", {
            ...
            children: [t ? this.renderNoiseCancellation() : null, (0, r.jsx)(eA.Z, {
              channel: e
            })]
          })]
  ...
  constructor(...e) {
    ...
    }), eM(this, "renderVoicePanelIntroduction", () => (0, r.jsxs)("div", {
...
let eQ = (0, E.Z)(function(e) {
  ...
  } = (0, A.ZP)(j.Z.RTC_PANEL), w = (0, v.Z)(null != p ? p : ex.lds, null == d ? void 0 : d.id), R = (0, N.Z)(null == d ? void 0 : d.id);
  return (0, r.jsx)(A.Gt, {
    value: L,
    children: (0, r.jsxs)("div", {
      className: eD.wrapper,
      children: [null != n || null != l ? (0, r.jsx)(G.Z, {
        voiceState: n,
        awaitingRemoteSessionInfo: l
      }) : null, (0, r.jsx)(eq, eG(eU({}, e, g, c), {
        enableActivities: w,
        remoteVoiceState: n,
        guild: h,
        channel: d,
