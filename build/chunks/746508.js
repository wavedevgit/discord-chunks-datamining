...
function eW() {
  ...
  (0, f.Tbt)(e), i.useEffect(() => {
    eN.default.track(eL.rMx.OPEN_POPOUT, {
...
function eY() {
  ...
  } = (0, A.ZP)(), t = (0, u.e7)([en.Z], () => en.Z.isMuted()), n = t ? ek.intl.string(ek.t.ScHlfn) : ek.intl.string(ek.t.zqxfra);
  return (0, r.jsx)(eA.Z, {
    "aria-label": n,
    tooltipText: n,
    icon: t ? f.xjP : f.RZG,
...
function eK(e) {
  let {
  ...
  } = (0, A.ZP)(), c = (0, M.Q3)("ConnectedVideoButton"), d = (0, el.Z)(), h = (0, eo.Z)(t), m = (0, u.e7)([y.ZP], () => null != y.ZP.getSelfEmbeddedActivityForLocation(y.ZP.getConnectedActivityLocation())), b = (0, q.Z)(t), {
    reachedLimit: _,
    limit: E
  } = (0, ea.Z)(t), O = i.useCallback(() => {
    (0, ec.Z)()
  }, []), v = (0, I.bp)(), C = i.useCallback(e => {
    ...
    play: T,
    events: P
  } = (0, p.o)(d.enabled ? "disable" : "enable");
  return i.useEffect(() => () => T(), [d.enabled, T]), (0, r.jsx)(eh.Z, eV(eB({
    onChange: C,
    ...
    children: e => {
      var {
        ...
        iconComponent: l,
        iconColor: u
      } = e, d = eH(e, ["unavailable", "isActive", "label", "iconComponent", "iconColor"]);
      let p = (0, r.jsx)(N, {
        size: c ? "md" : "sm",
        className: a()(eM.buttonIcon, {
          [eM.withText]: !S
        }),
        color: "currentColor"
      });
      return (0, r.jsx)(f.yRy, {
        ...
        children: (e, l) => {
          ...
          return (0, r.jsx)(f.ua7, {
            text: i,
            children: e => (0, r.jsx)(f.zxk, eV(eB({
              buttonRef: o
            }, d, e, u), {
              onClick: t => {
                var n;
...
function eq(e) {
  let {
    channel: t,
    enableActivities: n
  } = e, i = (0, M.Q3)("ConnectedActivityButton"), l = (0, I.bp)(), {
    analyticsLocations: o,
    parentAnalyticsLocation: s
  } = (0, A.ZP)(), c = l === eL.IlC.POPOUT, d = (0, S.KF)(t.id), p = (0, S.g5)(d), {
    userInActivity: h
  } = (0, u.cj)([y.ZP], () => ({
  ...
  return n ? (0, r.jsx)(f.ua7, {
    text: p,
    children: e => (0, r.jsxs)(f.zxk, eV(eB(eV(eB({}, e), {
      fullWidth: !0,
      ...
      onClick: () => {
        ...
        E(), (0, P.Z)({
          ...
          openInPopout: c,
          analyticsLocations: o
        }), null == (n = e.onClick) || n.call(e), (0, w.v)(s, w.d.ACTIVITY)
      },
      onMouseEnter: () => {
        var t;
...
function eQ(e) {
  ...
  return (0, r.jsx)(f.yRy, {
    ...
    children: e => {
      ...
      return (0, r.jsx)(f.ua7, {
        text: N,
        children: e => (0, r.jsx)(f.zxk, eV(eB(eV(eB({}, e), {
          buttonRef: c,
...
class eX extends i.PureComponent {
  renderConnectionStatus() {
    ...
    return null != n ? (e = eL.Z5c.CHANNEL(n.id, t.id), u = "".concat(u, " / ").concat(n.name)) : e = eL.Z5c.CHANNEL(eL.ME, t.id), (0, r.jsx)(K.Z, {
      channelId: t.id,
      quality: i,
      state: l,
      lastPing: a,
      ...
      children: (0, r.jsx)(f.tEY, {
        children: (0, r.jsx)(c.rU, {
          ...
          children: (0, r.jsx)(ex.Z, {
            ...
            children: this.props.isVisualRefreshEnabled ? (0, r.jsx)(f.Text, {
  ...
  renderNoiseCancellation() {
    ...
    return null != i ? null : (null == l ? void 0 : l.isGuildStageVoice()) && null == a.find(e => e.user.id === eg.default.getId() && (0, er.gf)(e.voiceState) === er.xO.ON_STAGE) && (0, et.U5)(l.id) ? (0, r.jsx)(eY, {}) : !n && t ? (0, r.jsx)(f.ua7, {
  ...
  constructor(...e) {
    super(...e), eG(this, "ref", i.createRef()), eG(this, "krispButtonRef", i.createRef()), eG(this, "handleChannelLinkClick", e => {
      var t;
      let {
        guild: n,
        channel: r
...
function eJ(e) {
  ...
  return i.useEffect(() => () => s(), [l, s]), (0, r.jsx)(eA.Z, eV(eB({}, t), {
    ref: a,
    onClick: e => {
...
let e$ = (0, E.Z)(function(e) {
  ...
  } = (0, A.ZP)(j.Z.RTC_PANEL), H = (0, v.Z)(null != g ? g : eL.lds, null == h ? void 0 : h.id), F = (0, N.Z)(null == h ? void 0 : h.id);
  return (0, r.jsx)(A.Gt, {
    value: k,
    children: (0, r.jsxs)("div", {
      className: eM.wrapper,
      children: [null != a || null != o ? (0, r.jsx)(B.Z, {
        voiceState: a,
        awaitingRemoteSessionInfo: o
      }) : null, (0, r.jsx)(eX, eV(eB({}, e, b, p), {
        enableActivities: H,
        remoteVoiceState: a,
        guild: m,
        channel: h,
