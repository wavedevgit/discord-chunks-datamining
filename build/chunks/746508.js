...
function eY(e) {
  ...
  }), m = (0, el.Z)(), b = (0, eo.Z)(t), _ = (0, u.e7)([I.ZP], () => null != I.ZP.getSelfEmbeddedActivityForLocation(I.ZP.getConnectedActivityLocation())), E = (0, K.Z)(t), {
    reachedLimit: O,
    limit: v
  } = (0, ea.Z)(t), C = i.useCallback(() => {
    (0, ec.Z)()
  }, []), S = (0, y.bp)(), N = i.useCallback(e => {
...
function eK(e) {
  ...
  } = (0, A.ZP)(), d = o === eL.IlC.POPOUT, p = (0, S.KF)(t.id), h = (0, S.g5)(p), {
    userInActivity: g
  } = (0, u.cj)([I.ZP], () => ({
...
class eQ extends i.PureComponent {
  ...
  renderNoiseCancellation() {
    ...
    return null != i ? null : (null == l ? void 0 : l.isGuildStageVoice()) && null == a.find(e => e.user.id === eg.default.getId() && (0, en.gf)(e.voiceState) === en.xO.ON_STAGE) && (0, ee.U5)(l.id) ? (0, r.jsx)(eW, {}) : !n && t ? (0, r.jsx)(f.ua7, {
...
let eJ = (0, E.Z)(function(e) {
  ...
  } = (0, A.ZP)(j.Z.RTC_PANEL), R = (0, v.Z)(null != h ? h : eL.lds, null == p ? void 0 : p.id), D = (0, N.Z)(null == p ? void 0 : p.id);
  return (0, r.jsx)(A.Gt, {
    value: w,
    children: (0, r.jsxs)("div", {
