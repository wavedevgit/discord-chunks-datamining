...
function ez() {
  ...
  (0, g.Tbt)(e), i.useEffect(() => {
    eT.default.track(eL.rMx.OPEN_POPOUT, {
...
function eY() {
  ...
  } = (0, x.ZP)(), t = (0, u.e7)([en.Z], () => en.Z.isMuted()), n = t ? ek.NW.string(ek.t.ScHlfn) : ek.NW.string(ek.t.zqxfra);
  return (0, r.jsx)(eA.Z, {
    "aria-label": n,
    tooltipText: n,
    icon: t ? g.xjP : g.RZG,
...
function eK(e) {
  ...
  } = (0, x.ZP)(), s = (0, M.Q3)("ConnectedVideoButton"), {
    coloredIconsEnabled: c,
    simplifiedSettingsEnabled: d
  } = (0, el.Z)({
    location: "ConnectedVideoButton"
  }), p = (0, eo.Z)(), f = (0, es.Z)(t), b = (0, u.e7)([I.ZP], () => null != I.ZP.getSelfEmbeddedActivityForLocation(I.ZP.getConnectedActivityLocation())), _ = (0, q.Z)(t), {
    reachedLimit: E,
    limit: O
  } = (0, ea.Z)(t), N = i.useCallback(() => {
    (0, eu.Z)()
  }, []), y = (0, v.bp)(), C = i.useCallback(e => {
  ...
  return i.useEffect(() => () => P(), [p.enabled, P]), (0, r.jsx)(ef.Z, eV(eW({
    onChange: C,
      ...
      return (0, r.jsx)(g.yRy, {
        ...
        children: (e, l) => {
          ...
          return (0, r.jsx)(g.ua7, {
            text: i,
            children: e => (0, r.jsx)(g.zxk, eV(eW({}, u, e, d), {
              onClick: t => {
                var n;
...
function eq(e) {
  let {
    channel: t,
    enableActivities: n
  } = e, i = (0, M.Q3)("ConnectedActivityButton"), {
  ...
  } = (0, x.ZP)(), p = a === eL.IlC.POPOUT, h = (0, T.KF)(t.id), f = (0, T.g5)(h), {
    userInActivity: m
  } = (0, u.cj)([I.ZP], () => ({
    userInActivity: null != I.ZP.getSelfEmbeddedActivityForChannel(t.id)
  })), b = (0, S.a)(N.eR.VOICE_LAUNCHER), _ = h !== T.jy.CAN_LAUNCH, {
    enabled: E
  } = y.c.useExperiment({
  ...
  return n ? (0, r.jsx)(g.ua7, {
    text: f,
    children: e => (0, r.jsxs)(g.zxk, eV(eW(eV(eW({}, e), {
      fullWidth: !0,
      ...
      onClick: () => {
        ...
        P(), (0, A.Z)({
          ...
          openInPopout: p,
          analyticsLocations: s
        }), null === (n = e.onClick) || void 0 === n || n.call(e), (0, L.v)(c, L.d.ACTIVITY)
      },
      onMouseEnter: () => {
        var t;
  ...
  return (0, r.jsx)(g.yRy, {
    renderPopout: e => {
      ...
      return (0, r.jsx)(ec.Z, {
        ...
        onInteraction: (0, R.u)("ManageStreamsMenu", c, {
    ...
    children: e => {
      ...
      return (0, r.jsx)(g.ua7, {
        text: S,
        children: e => (0, r.jsx)(g.zxk, eV(eW(eV(eW({}, e), {
...
class eX extends i.PureComponent {
  renderConnectionStatus() {
    ...
    return null != n ? (e = eL.Z5c.CHANNEL(n.id, t.id), s = "".concat(s, " / ").concat(n.name)) : e = eL.Z5c.CHANNEL(eL.ME, t.id), (0, r.jsx)(K.Z, {
      channelId: t.id,
      quality: i,
      state: l,
      lastPing: o,
  ...
  renderNoiseCancellation() {
    ...
    return null != i ? null : (null == l ? void 0 : l.isGuildStageVoice()) && null == o.find(e => e.user.id === em.default.getId() && (0, er.gf)(e.voiceState) === er.xO.ON_STAGE) && (0, et.U5)(l.id) ? (0, r.jsx)(eY, {}) : !n && t ? (0, r.jsx)(g.ua7, {
  ...
  constructor(...e) {
    super(...e), eG(this, "handleChannelLinkClick", e => {
      var t;
      let {
        guild: n,
        channel: r
...
function eJ(e) {
  ...
  return i.useEffect(() => () => a(), [l, a]), (0, r.jsx)(eA.Z, eV(eW({}, t), {
    onClick: e => {
...
let e$ = (0, O.Z)(function(e) {
  let t = (0, M.Q3)("ConnectedRTCConnection"),
    ...
    s = (0, u.cj)([ev.ZP], () => null != l ? {
      channelId: l.channelId,
      rtcConnectionQuality: eL.IE4.FINE,
      rtcConnectionState: eL.hes.RTC_CONNECTED,
      rtcConnectionLastPing: 0
    } : {
      channelId: ev.ZP.getChannelId(),
      rtcConnectionQuality: ev.ZP.getQuality(),
      rtcConnectionState: ev.ZP.getState(),
      rtcConnectionLastPing: ev.ZP.getLastPing()
    }),
    {
      channelId: c
    } = s,
  ...
  } = (0, x.ZP)(Z.Z.RTC_PANEL), R = (0, C.Z)(null != h ? h : eL.lds, null == p ? void 0 : p.id), D = (0, P.Z)(null == p ? void 0 : p.id);
  return (0, r.jsx)(x.Gt, {
    value: L,
    children: (0, r.jsxs)("div", {
