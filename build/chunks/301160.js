...
function j(e) {
  let {
    guildId: i,
    initialTierEmojiIds: o,
    onSubmit: l,
    transitionToManageEmoji: j,
    transitionState: h,
    onClose: x
  } = e, u = (0, m.Z)(i), [_, f] = a.useState(new Set), C = _.size > 0, p = (0, s.Dt)();
  return (0, t.jsx)("form", {
    onSubmit: function(e) {
    ...
    children: (0, t.jsxs)(n.Y0X, {
      ...
      children: [(0, t.jsxs)(n.xBx, {
        ...
        children: [(0, t.jsx)(n.Text, {
          ...
          size: 16
        }), null != u && u.length > 0 && (0, t.jsx)("div", {
          className: c.emojiContainer,
          children: u.map(e => null != o && o.has(e.id) ? null : (0, t.jsx)(d, {
            emoji: e,
            onChange: () => {
              var i;
