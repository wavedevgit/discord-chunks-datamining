...
function x(e) {
  let {
    ...
    onSubmit: r,
    transitionToManageEmoji: x,
    transitionState: h,
    onClose: u
  } = e, _ = (0, m.Z)(t), [f, p] = a.useState(new Set), C = f.size > 0, v = (0, l.Dt)();
  return (0, o.jsx)("form", {
    onSubmit: function(e) {
    ...
    children: (0, o.jsxs)(s.Y0X, {
      ...
      children: [(0, o.jsxs)(s.xBx, {
        ...
        children: [(0, o.jsx)(s.Text, {
          ...
          children: c.intl.format(c.t["OnK+Cw"], {
            transitionToManageEmoji: x
          })
        }), (0, o.jsx)(s.LZC, {
          size: 16
        }), null != _ && _.length > 0 && (0, o.jsx)("div", {
          className: d.emojiContainer,
          children: _.map(e => null != i && i.has(e.id) ? null : (0, o.jsx)(j, {
            emoji: e,
            onChange: () => {
              var t;
              return t = e.id, void p(e => {
                let i = new Set(e);
