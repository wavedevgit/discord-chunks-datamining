...
function j(e) {
  let {
    ...
    transitionState: h,
    onClose: x
  } = e, u = (0, c.Z)(i), [_, f] = a.useState(new Set), C = _.size > 0, p = (0, s.Dt)();
  return (0, o.jsx)("form", {
    onSubmit: function(e) {
    ...
    children: (0, o.jsxs)(n.Y0X, {
      ...
      children: [(0, o.jsxs)(n.xBx, {
        ...
        children: [(0, o.jsx)(n.Text, {
          ...
          children: r.intl.format(r.t["OnK+Cw"], {
            transitionToManageEmoji: j
          })
        }), (0, o.jsx)(n.LZC, {
          size: 16
        }), null != u && u.length > 0 && (0, o.jsx)("div", {
          className: m.emojiContainer,
          children: u.map(e => null != t && t.has(e.id) ? null : (0, o.jsx)(d, {
            emoji: e,
            onChange: () => {
              var i;
        ...
        children: [(0, o.jsx)(n.zxk, {
          type: "submit",
          disabled: !C,
          children: r.intl.format(r.t.pX74jo, {
            totalEmoji: _.size
          })
        }), (0, o.jsx)(n.zxk, {
