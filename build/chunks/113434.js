...
let ef = e => {
  ...
  ep = () => {
    ...
    } = ed(), n = e.length > 0, r = t.length > 0, i = n && !r || !n && r, o = y.Z.getArticleURL(k.BhN.QUEST_HOW_TO_PLAYSTATION), a = y.Z.getArticleURL(k.BhN.QUEST_HOW_TO_XBOX), s = j.intl.format(j.t.beN4DA, {
      psHelpdeskArticle: o,
...
function eE(e) {
  ...
  return a ? j.intl.formatToPlainString(j.t.lOVr0N, {
    claimDate: s
...
function ey(e, t) {
  let [n, i] = eb(e.id), o = r.useMemo(() => (0, P.yH)(e), [e]), l = o.includes(x.cd.DESKTOP), c = o.includes(x.cd.CONSOLE), u = J(e), d = $(e), f = r.useMemo(() => (0, a.EQ)(t).with({
    percentComplete: 0
  }, () => null).with({
  ...
  }, () => c && l ? C.LI.SELECT : c ? C.LI.CONSOLE : C.LI.DESKTOP).exhaustive(), [c, l, f, _, n]), o, i]
}
...
function eA(e, t, n) {
  ...
  if (l) return j.intl.formatToPlainString(j.t.APddvL, {
    expirationDate: o
  });
  if (t)
