...
function es(e, t, n) {
  ...
  if ((0, R.$J)(e)) return U.NW.format(U.t.Ajlcd3, {
    minutes: r,
    onClick: o,
    gameTitle: x.r.build(e.config).application.name
  });
  ...
  if ((0, R.pO)(e) && (0, R.KM)(e)) return U.NW.format(U.t["1NaRSk"], {
    minutes: r
  });
  let s = U.t["6zWtV1"];
  return (0, R.Nj)({
...
function ev(e, t) {
  let [n, i] = ey(e.id), o = r.useMemo(() => (0, R.yH)(e), [e]), l = o.includes(M.cd.DESKTOP), c = o.includes(M.cd.CONSOLE), u = $(e), d = ee(e), f = r.useMemo(() => (0, a.EQ)(t).with({
    percentComplete: 0
  }, () => null).with({
