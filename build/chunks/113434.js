...
let ef = e => {
  ...
  ep = () => {
    ...
    } = ed(), n = e.length > 0, r = t.length > 0, i = n && !r || !n && r, o = v.Z.getArticleURL(k.BhN.QUEST_HOW_TO_PLAYSTATION), a = v.Z.getArticleURL(k.BhN.QUEST_HOW_TO_XBOX), s = U.NW.format(U.t.beN4DA, {
      psHelpdeskArticle: o,
...
function ey(e, t) {
  let [n, i] = eb(e.id), o = r.useMemo(() => (0, P.yH)(e), [e]), l = o.includes(M.cd.DESKTOP), c = o.includes(M.cd.CONSOLE), u = J(e), d = $(e), f = r.useMemo(() => (0, a.EQ)(t).with({
    percentComplete: 0
  }, () => null).with({
