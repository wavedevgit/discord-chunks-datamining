...
function ey(e, t) {
  let [n, i] = eb(e.id), a = r.useMemo(() => (0, R.yH)(e), [e]), l = a.includes(x.cd.DESKTOP), c = a.includes(x.cd.CONSOLE), u = J(e), d = $(e), f = r.useMemo(() => (0, o.EQ)(t).with({
    percentComplete: 0
  }, () => null).with({
  ...
  }, () => c && l ? C.LI.SELECT : c ? C.LI.CONSOLE : C.LI.DESKTOP).exhaustive(), [c, l, f, _, n]), a, i]
}
