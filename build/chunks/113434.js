...
function es(e, t, n) {
  ...
  if ((0, P.$J)(e)) return U.NW.format(U.t.Ajlcd3, {
    minutes: r,
    onClick: o,
    gameTitle: x.r.build(e.config).application.name
  });
  if ((0, P.q8)(e)) {
    ...
    return null == t ? U.NW.string(U.t["o+e9ys"]) : U.NW.formatToPlainString(U.t["9m9MnZ"], {
      videoTitle: t
    })
  }
  if (null != i) return i.title;
  if ((0, P.pO)(e) && (0, P.KM)(e)) return U.NW.format(U.t["1NaRSk"], {
    minutes: r
  });
  let s = U.t["6zWtV1"];
  return (0, P.Nj)({
    quest: e
  }) && (s = U.t["wmOh/v"]), U.NW.format(s, {
    minutes: r,
  ...
  let n = (0, P.Xv)(e),
    {
      product: r,
      isFetching: i
    } = (0, h.T)(x.r.build(e).defaultReward.skuId);
  return {
...
let e_ = e => {
    let {
      ...
      beforeRequest: i,
      afterRequest: o
    } = e, [a, s] = r.useState([]), [c, u] = r.useState(!1), f = (0, d.e7)([E.Z], () => E.Z.getAccounts());
    return r.useEffect(() => {
  ...
  eh = () => {
    ...
    } = ef(), n = e.length > 0, r = t.length > 0, i = n && !r || !n && r, o = v.Z.getArticleURL(k.BhN.QUEST_HOW_TO_PLAYSTATION), a = v.Z.getArticleURL(k.BhN.QUEST_HOW_TO_XBOX), s = U.NW.format(U.t.beN4DA, {
      psHelpdeskArticle: o,
      xboxHelpdeskArticle: a
    }), l = U.NW.format(U.t.HVS7np, {
...
function eb(e) {
  ...
  return a ? U.NW.formatToPlainString(U.t.lOVr0N, {
    claimDate: s
...
function ev(e, t) {
  let [n, i] = ey(e.id), o = r.useMemo(() => (0, P.yH)(e), [e]), l = o.includes(M.cd.DESKTOP), c = o.includes(M.cd.CONSOLE), u = $(e), d = ee(e), f = r.useMemo(() => (0, a.EQ)(t).with({
    percentComplete: 0
  }, () => null).with({
  ...
  return [r.useMemo(() => (0, a.EQ)({
    ...
    currentProgressingPlatform: M.cd.CONSOLE
  }, () => R.LI.CONSOLE).with({
    currentProgressingPlatform: M.cd.DESKTOP
  }, () => R.LI.DESKTOP).with({
...
function eN(e) {
  ...
  if ((null == (n = e.userStatus) ? void 0 : n.enrolledAt) != null && l > 0) {
    ...
    return U.NW.formatToPlainString(U.t.lVZaXF, {
      percent: e
    })
  }
...
function eA(e, t, n) {
  ...
  if (l) return U.NW.formatToPlainString(U.t.APddvL, {
    expirationDate: o
  });
  if (t)
...
function eC(e, t) {
  ...
  return r.useMemo(() => (null == n ? void 0 : n.config.cosponsorMetadata) == null ? null : (0, L.Rt)(e, n.config.cosponsorMetadata.logotype, {
...
function eR(e) {
  ...
  if (null == n) return U.NW.formatToPlainString(U.t.l9uXLy, {
    decorationName: t
  });
  let l = U.NW.formatToPlainString(U.t.o97tNj, {
      rewardName: t
    }),
    ...
    p = s ? c : f,
    h = i ? _ : p;
  return o ? h : U.NW.formatToPlainString(U.t.tTlItr, {
    duration: n,
    decorationName: t
  })
}
