...
let ef = e => {
    let {
      ...
      beforeRequest: i,
      afterRequest: a
    } = e, [o, s] = r.useState([]), [c, d] = r.useState(!1), f = (0, u.e7)([g.Z], () => g.Z.getAccounts());
    return r.useEffect(() => {
...
function ey(e, t) {
  let [n, i] = eb(e.id), a = r.useMemo(() => (0, A.yH)(e), [e]), l = a.includes(x.cd.DESKTOP), c = a.includes(x.cd.CONSOLE), u = J(e), d = $(e), f = r.useMemo(() => (0, o.EQ)(t).with({
    percentComplete: 0
  }, () => null).with({
