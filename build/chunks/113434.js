...
function V(e) {
  ...
  }), r = new Map(t.map(e => [e.id, e])), i = G(t), o = B(t), a = [], s = [];
...
function et(e, t, n) {
  ...
  if ((0, N.$J)(e)) return L.NW.format(L.t.Ajlcd3, {
    minutes: r,
    onClick: o,
    gameTitle: P.r.build(e.config).application.name
  });
  if ((0, N.q8)(e)) {
    ...
    return null == t ? L.NW.string(L.t["o+e9ys"]) : L.NW.formatToPlainString(L.t["9m9MnZ"], {
      videoTitle: t
    })
  }
  if (null != i) return i.title;
  if ((0, N.pO)(e) && (0, N.KM)(e)) return L.NW.format(L.t["1NaRSk"], {
    minutes: r
  });
  let s = L.t["6zWtV1"];
  return (0, N.Nj)({
    quest: e
  }) && (s = L.t["wmOh/v"]), L.NW.format(s, {
    minutes: r,
  ...
  let n = (0, N.Xv)(e),
    {
      product: r,
      isFetching: i
    } = (0, _.T)(P.r.build(e).defaultReward.skuId);
  return {
...
let es = e => {
  ...
  ec = () => {
    ...
    } = ea(), n = e.length > 0, r = t.length > 0, i = n && !r || !n && r, o = g.Z.getArticleURL(D.BhN.QUEST_HOW_TO_PLAYSTATION), a = g.Z.getArticleURL(D.BhN.QUEST_HOW_TO_XBOX), s = L.NW.format(L.t.beN4DA, {
      psHelpdeskArticle: o,
      xboxHelpdeskArticle: a
    }), l = L.NW.format(L.t.HVS7np, {
...
function ef(e) {
  let t = (0, d.e7)([p.default], () => p.default.locale),
    ...
    o = 100 * i,
    a = null != r ? "".concat(null == r ? void 0 : r.progress, "/").concat(null == r ? void 0 : r.target) : (0, E.T3)(t, i, {
      roundingMode: "floor"
    });
  return {
    completedRatio: i,
...
function e_(e) {
  ...
  return a ? L.NW.formatToPlainString(L.t.lOVr0N, {
    claimDate: s
...
function eh(e, t) {
  let [n, i] = ep(e.id), o = r.useMemo(() => (0, N.yH)(e), [e]), l = o.includes(w.cd.DESKTOP), c = o.includes(w.cd.CONSOLE), u = K(e), d = z(e), f = r.useMemo(() => (0, a.EQ)(t).with({
    percentComplete: 0
  }, () => null).with({
  ...
  }, () => w.cd.CONSOLE).exhaustive(), [t]), _ = u ? w.cd.DESKTOP : d ? w.cd.CONSOLE : null;
  return [r.useMemo(() => (0, a.EQ)({
    lastPlatformProgress: f,
    currentProgressingPlatform: _,
    selectedPlatform: n
  }).with({
    currentProgressingPlatform: w.cd.CONSOLE
  }, () => T.LI.CONSOLE).with({
    currentProgressingPlatform: w.cd.DESKTOP
  }, () => T.LI.DESKTOP).with({
  ...
  }, () => c && l ? T.LI.SELECT : c ? T.LI.CONSOLE : T.LI.DESKTOP).exhaustive(), [c, l, f, _, n]), o, i]
}
...
function ev(e) {
  ...
  if ((null === (n = e.userStatus) || void 0 === n ? void 0 : n.enrolledAt) != null && i.percentComplete > 0) {
    let e = (0, E.T3)(r, i.percentComplete, {
      roundingMode: "floor"
    });
    return L.NW.formatToPlainString(L.t.lVZaXF, {
      percent: e
    })
  }
...
function ey(e, t, n) {
  ...
  return s ? L.NW.formatToPlainString(L.t.APddvL, {
    expirationDate: o
  }) : t ? n === T.LI.SELECT ? L.NW.string(L.t.sWUpNz) : c : (0, N.q8)(e) ? L.NW.string(L.t["o+e9ys"]) : a.percentComplete > 0 ? l ? (0, N.AV)({
    quest: e,
    taskDetails: a
  }) : L.NW.string(L.t.mOrpXF) : L.NW.string(L.t.S6UUc3)
}
...
function eO(e, t) {
  ...
  return r.useMemo(() => (null == n ? void 0 : n.config.cosponsorMetadata) == null ? null : (0, R.Rt)(e, n.config.cosponsorMetadata.logotype, {
...
function eI(e) {
  let t = P.r.build(e).defaultReward.messages.name,
    ...
    o = (0, N.f$)(e),
    a = (0, v.eB)();
  if (null == n) return L.NW.formatToPlainString(L.t.l9uXLy, {
    decorationName: t
  });
  let s = L.NW.formatToPlainString(L.t.o97tNj, {
      rewardName: t
    }),
    ...
    f = a ? l : u,
    _ = i ? d : f;
  return o ? _ : L.NW.formatToPlainString(L.t.tTlItr, {
    duration: n,
    decorationName: t
  })
}
