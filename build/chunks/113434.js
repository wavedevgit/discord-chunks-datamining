...
function B() {
  ...
  return r.useEffect(() => {
    "cache-only" !== e.fetchPolicy && ("cache-and-network" !== e.fetchPolicy && ("cache-or-network" !== e.fetchPolicy || 0 !== s) || !l || t || a || (n(!0), (0, N.xw)(), (0, N.w)(R.Ok.DESKTOP_ACCOUNT_PANEL_AREA, "use_quests_".concat(e.callerSource))))
...
function W(e) {
  ...
  }), r = new Map(t.map(e => [e.id, e])), i = V(t), o = H(t), a = [], s = [];
...
function ea(e, t, n, r) {
  ...
  if ((0, A.$J)(e)) return j.intl.format(j.t.Ajlcd3, {
    minutes: i,
    onClick: a,
    gameTitle: L.r.build(e.config).application.name
  });
  if ((0, A.q8)(e)) {
    ...
    return null == n ? j.intl.string(j.t["o+e9ys"]) : j.intl.formatToPlainString(j.t["9m9MnZ"], {
      videoTitle: n
    })
  }
  if (null != o) return o.title;
  if ((0, A.pO)(e) && (0, A.KM)(e)) return j.intl.format(j.t["1NaRSk"], {
    minutes: i
  });
  let s = j.t["6zWtV1"];
  return (0, A.Nj)({
...
let ef = e => {
    let {
      ...
      beforeRequest: i,
      afterRequest: o
    } = e, [a, s] = r.useState([]), [c, d] = r.useState(!1), f = (0, u.e7)([g.Z], () => g.Z.getAccounts());
    return r.useEffect(() => {
  ...
  ep = () => {
    ...
    } = ed(), n = e.length > 0, r = t.length > 0, i = n && !r || !n && r, o = y.Z.getArticleURL(M.BhN.QUEST_HOW_TO_PLAYSTATION), a = y.Z.getArticleURL(M.BhN.QUEST_HOW_TO_XBOX), s = j.intl.format(j.t.beN4DA, {
      psHelpdeskArticle: o,
...
function eg(e) {
  let t = (0, u.e7)([m.default], () => m.default.locale),
    ...
    o = 100 * i,
    a = null != r ? "".concat(null == r ? void 0 : r.progress, "/").concat(null == r ? void 0 : r.target) : (0, O.T3)(t, i, {
      roundingMode: "floor"
    });
  return {
    completedRatio: i,
...
function eE(e, t) {
  ...
  return s ? j.intl.formatToPlainString(j.t.lOVr0N, {
    claimDate: l
...
function ey(e, t) {
  let [n, i] = eb(e.id), o = r.useMemo(() => (0, A.yH)(e), [e]), l = o.includes(x.cd.DESKTOP), c = o.includes(x.cd.CONSOLE), u = J(e), d = $(e), f = r.useMemo(() => (0, a.EQ)(t).with({
    percentComplete: 0
  }, () => null).with({
  ...
  }, () => c && l ? R.LI.SELECT : c ? R.LI.CONSOLE : R.LI.DESKTOP).exhaustive(), [c, l, f, _, n]), o, i]
}
...
function eS(e) {
  ...
  if ((null == (n = e.userStatus) ? void 0 : n.enrolledAt) != null && l > 0) {
    ...
    return j.intl.formatToPlainString(j.t.lVZaXF, {
      percent: e
    })
  }
...
function eA(e) {
  ...
  let {
    ...
    activeScreen: a
  } = e, s = Q(r.useMemo(() => L.r.build(n.config).rewardsExpireAt, [n.config])), l = er(n), c = ei(n), u = (null == (t = n.userStatus) ? void 0 : t.completedAt) != null, d = et(n), f = (0, w.DD)({
    quest: n,
  ...
  if (u) return j.intl.formatToPlainString(j.t.APddvL, {
    expirationDate: s
  });
  if (i)
...
function eC(e) {
  ...
  let l = j.intl.formatToPlainString(j.t.o97tNj, {
      rewardName: t
    }),
    ...
    p = s ? c : f,
    h = i ? _ : p;
  return o ? h : j.intl.formatToPlainString(j.t.tTlItr, {
    duration: n,
    decorationName: t
  })
}
