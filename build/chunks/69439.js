...
function O(e) {
  ...
  })), M = (null == (t = S.userStatus) ? void 0 : t.enrolledAt) != null, Z = (null == (n = S.userStatus) ? void 0 : n.completedAt) != null, W = Z && (null == (O = S.userStatus) ? void 0 : O.claimedAt) == null, U = (0, d.iQ)(S), H = !(0, d.zi)(S), z = (0, p._Q)(S), F = (0, d.Xv)(S.config), X = (0, d.PB)(S), K = (0, d.HJ)(S), Y = (0, d.Vl)(S), G = (0, p.Rf)(S), [J, $, ee] = (0, p.me)(S, G), et = H && z === p.OH.ACCEPTED, en = et && J === g.LI.SELECT, er = et && !en && $.length > 1, es = s.useCallback(e => {
  ...
  }), eu = (null == (E = S.userStatus) ? void 0 : E.claimedAt) != null, ed = null;
