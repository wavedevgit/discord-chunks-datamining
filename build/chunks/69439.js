...
function y(e) {
  ...
  } = e, A = (0, o.e7)([l.Z], () => l.Z.useReducedMotion), R = (0, x.g2)({
    useReducedMotion: A
  }), B = (0, u.O5)(), k = (0, p._s)({
    quest: E
  ...
  })), L = (null == (t = E.userStatus) ? void 0 : t.enrolledAt) != null, M = (null == (n = E.userStatus) ? void 0 : n.completedAt) != null, Z = M && (null == (y = E.userStatus) ? void 0 : y.claimedAt) == null, W = (0, d.iQ)(E), U = !(0, d.zi)(E), H = (0, p._Q)(E), z = (0, d.Xv)(E.config), F = (0, d.PB)(E), X = (0, d.HJ)(E), K = (0, d.Vl)(E), Y = (0, p.Rf)(E), [G, J, $] = (0, p.me)(E, Y), ee = U && H === p.OH.ACCEPTED, et = ee && G === g.LI.SELECT, en = ee && !et && J.length > 1, er = s.useCallback(e => {
    $(e), e === h.cd.DESKTOP && T([])
  }, [$, T]), {
    text: es,
    onClick: eo
  ...
  }), el = (null == (O = E.userStatus) ? void 0 : O.claimedAt) != null, ec = null;
  return (W && Z ? ec = (0, r.jsx)(a.zx, {
    color: a.Tt.BRAND,
    submitting: Q,
    onClick: null != eo ? eo : void 0,
    className: _.button,
    children: es
  }) : M ? ec = F ? (0, r.jsxs)(r.Fragment, {
  ...
  }) : (0, d.$J)(E) && !I && G !== g.LI.DESKTOP ? k ? (0, r.jsx)(a.zx, {
    color: a.Tt.PRIMARY,
    className: _.button,
    onClick: null != eo ? eo : void 0,
    children: es
  ...
  }) : F || K && E.config.features.includes(h.S7.START_QUEST_CTA) ? (0, r.jsx)(a.zx, {
    color: a.Tt.BRAND,
    onClick: null != eo ? eo : void 0,
    className: _.button,
    children: es
