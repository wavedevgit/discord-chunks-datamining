...
function U(e) {
  ...
  let ei = (0, l.e7)([y.Z], () => y.Z.hidePersonalInformation),
    ...
    es = q === b.A.PURCHASING || q === b.A.COMPLETED,
    el = (0, v.Kp)({
      isTrial: !1,
      isGift: et,
      selectedSkuId: X,
  ...
  return null != o && (ed = z ? (0, r.jsx)(G, {
    ...
    children: [!ec && el && (0, r.jsxs)("div", {
      ...
      isActive: U,
      ref: k,
      children: null != o && (0, T.R4)(o, D, W) ? (0, r.jsx)(F, {
        premiumSubscription: o,
        newPlan: er,
        onInvoiceError: H,
        planGroup: W,
...
function F(e) {
  ...
  return (i.useEffect(() => {
    ...
    finePrint: (0, r.jsx)(d.Z, {
      subscriptionPlan: s,
      paymentSourceType: null === (t = b[null !== (n = f.paymentSourceId) && void 0 !== n ? n : ""]) || void 0 === t ? void 0 : t.type,
      basePrice: o,
