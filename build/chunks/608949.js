...
d(g, "displayName", "GuildPowerupsNotificationStore"), d(g, "persistKey", "GuildPowerupsNotificationStore"), d(g, "migrations", [e => (Object.entries(e).forEach(t => {
  let [n, r] = t, i = null == r.seenLevelSkuIds || null == r.seenPerkSkuIds ? h(p({}, r), {
    seenLevelSkuIds: [],
    seenPerkSkuIds: []
  }) : r;
  e[n] = i
