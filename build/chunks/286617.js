...
function i(e, t, n, i) {
  ...
  let l = e.hasConnectedAccount(),
    ...
    d = e.getSyncingWith(),
    f = e.getActivity(),
    p = null != (a = null != (o = null == u ? true : u.id) ? o : null == f ? true : f.sync_id) ? a : e.getLastPlayedTrackId(),
    _ = n.id === t.getId(),
    h = l && !c,
    m = null != p && p === (null == i ? true : i.sync_id),
    g = (null == f ? true : f.party) != null && (null == i || null == (s = i.party) ? true : s.id) === f.party.id,
