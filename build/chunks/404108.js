/** Chunk was on web.js **/
/** chunk id: 404108, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  p: () => _
});
...
function _(e) {
  ...
  (0, p.useEffect)(() => {
    _ === n.focusedKey && n.isFocused && (b ? (0, f.vX)(g.current) : y ? y() : document.activeElement !== g.current && g.current && (0, c.l)(g.current))
  ...
  let N = n.isLink(_) && "override" === S,
    ...
    F = e => {
      if (A) {
        var t;
        A(), null == (t = g.current) || t.dispatchEvent(new CustomEvent("react-aria-item-action", {
          bubbles: true
        }))
      }
  ...
  if (E ? (B.onPressStart = e => {
    ...
    }), C["data-collection"] = (0, r.EG)(n.collection), C["data-key"] = _, B.preventFocusOnPress = b, b && (B = (0, o.v)(B, {
      onPressStart(e) {
  ...
  }, q = "none" !== S && n.isLink(_) ? e => {
    i.Fe.isOpening || e.preventDefault()
  } : true;
  return {
    itemProps: (0, o.v)(C, P || x || b && !O ? H : {}, k ? K : {}, {
      onDoubleClick: W,
