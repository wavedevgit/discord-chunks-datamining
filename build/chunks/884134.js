...
function et(e) {
  ...
  let {
    ...
    setGradientAngle: C
  } = (0, N.Ig)(), [x, k] = i.useState(null != (t = f[0]) ? t : N.Dp), B = (0, s.e7)([A.Z], () => A.Z.theme), V = (0, O.Nj)(l.z.CUSTOM_THEME_ENTRYPOINT_GRADIENT), {
    analyticsLocations: F
  } = (0, b.ZP)(E.Z.CUSTOM_THEMES_EDITOR), Z = async () => {
    _.current = !0, await (0, h.ZI)({
      theme: B,
    ...
    }), (0, w.u7)(f, m, v, B, F), null == a || a(M.L.TAKE_ACTION), V || (0, O.Q3)(l.z.CUSTOM_THEME_ENTRYPOINT_GRADIENT), (0, y.Ll)(), (0, S.UD)()
  }, H = () => {
