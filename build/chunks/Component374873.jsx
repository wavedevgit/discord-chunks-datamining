...
let R = Chunk64700.memo(function(e) {
  ...
  D = Chunk64700.memo(function(e) {
    ...
    })), R = (0, c.bG)([y.Ay], () => y.Ay.getMember(C, s.user.id)), D = (0, b.gn)(i.guild_id, null == R ? true : R.userId, null != (t = null == R ? true : R.colorStrings) ? t : null), L = l.useMemo(() => ({
      [C]: [s.user.id]
    }), [C, s.user.id]);
