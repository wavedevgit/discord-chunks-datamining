...
function y(e, t, n, r) {
  ...
  let a = (0, l.UB)(e, t),
    c = false;
  if (i.origin === u && (c = true), (0, o.iT)() && i.origin === _ && (c = true), i.searchParams.delete("width"), i.searchParams.delete("height"), i.searchParams.delete("quality"), i.searchParams.delete("size"), c)
    if ((0, o.iT)()) {
