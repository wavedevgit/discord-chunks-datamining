  ...
  uploadFiles: async function(e) {
    ...
    return H.nonce = K, G.on("start", e => {
      ...
      if (t !== w.evJ.GUILD_FILE_UPLOAD_RATE_LIMITED_ACCESS) {
        ...
        "" !== H.content && "" === P.Z.getDraft(k, U) && r.Z.saveDraft(k, H.content, U), 0 === E.Z.getUploadCount(k, U) && l.Z.setUploads({
          channelId: k,
          uploads: D,
          draftType: U
        })
      ...
      let n = (0, j.ZC)(t);
      null != n && ((0, O.gA)(y.D1), (0, _.I)({
        name: n.name,
        id: n.id
      }, void 0, !0, v.LL.MessageSent))
    }), null == B || null == (t = B.confettiPotionData) || t.callback(), await G.uploadFiles(D, H), z.resolve(), z.promise
  },
  cancel(e, t) {
    i.Z.dispatch({
