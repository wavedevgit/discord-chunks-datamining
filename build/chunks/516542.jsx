...
function O(e) {
  ...
  return <div className={y.container}><p.ZP innerClassName={y.textArea} onChange={P} placeholder={E} accessibilityLabel={_} channel={O} textValue={I} richValue={j} type={u.Ie.OVERLAY_INLINE_REPLY} allowNewLines={false} onBlur={Z} onFocus={w} focused={C} onSubmit={A} onKeyDown={T} autoCompletePosition={"bottom"} disableThemedBackground={true} /></div>
}