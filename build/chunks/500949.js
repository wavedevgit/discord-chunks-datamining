...
let {
  SemanticColors: H
} = Chunk521904.V, z = H, V = CSS.supports("color", "color(display-p3 1 0 0)") && CSS.supports("color", "color(display-p3 1 0 0 / 1)");
...
function er(e) {
  let {
    ...
    lightness: l,
    easingStrength: o = 1
  } = e, s = F[e.colorSpace], c = (0, A.Z)(n, s), d = (0, D.CD)(c, "white", 1 - r, {
    space: s,
    outputSpace: i.Z
