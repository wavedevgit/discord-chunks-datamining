...
let k = function(e) {
  let {
    entrypoint: t = D.EZ.UserSettings
  } = e;
  (0, j.z)(_.X);
  let n = (0, f.Q)(),
    {
  ...
  r.useEffect(() => {
    ...
    F || v.default.track(Z.rMx.PREMIUM_MARKETING_PAGE_VIEWED, {
      location_stack: s,
  ...
  let q = (0, l.e7)([E.Z], () => E.Z.enabled),
    ...
    J = q ? (0, i.jsx)(m.Z, {}) : n ? (0, i.jsx)(x.c8, {}) : X && W ? (0, i.jsx)(h.Gt, {
      value: k,
      children: (0, i.jsx)(R.Z, {
        userId: M
      })
    }) : L && G && !F ? null : (0, i.jsx)("div", {
  ...
  return null != J ? (0, i.jsxs)(i.Fragment, {
    ...
    value: k,
    children: [X && !Y && (0, i.jsx)(p.Z, {}), (0, i.jsx)(P.Z, {
      entrypoint: t
    })]
  })
}