...
function b(e) {
  let {
    ...
    currentUser: j,
    multiAccountUsers: w
  } = (0, i.cj)([d.default, u.Z], () => ({
    currentUser: d.default.getCurrentUser(),
    multiAccountUsers: u.Z.getUsers()
  })), [y, P] = r.useState(!1), [v, R] = r.useState(f.lds), [A, N] = r.useState(null);
  r.useEffect(() => {
    if (y) N((0, n.jsx)(l.Wn, {
      messageType: l.QYI.ERROR,
      className: _.infoMessage,
      children: g.intl.format(g.t.HAuRSE, {
        maxNumAccounts: m.$H
      })
    })), R(f.lds);
    else if (null != v) {
      let e = d.default.getUser(v);
      null != e && N((0, n.jsx)(l.Wn, {
        messageType: l.QYI.POSITIVE,
        className: _.infoMessage,
        children: g.intl.format(g.t["09qidX"], {
          username: e.username
        })
      })), P(!1)
    }
  ...
  let S = null;
  return 0 === b ? S = (0, n.jsxs)(n.Fragment, {
