...
let q = function() {
  let e = (0, l.e7)([A.ZP], () => A.ZP.getPremiumTypeSubscription()),
    ...
    W = (0, l.e7)([A.ZP], () => {
      var e;
      return Object.values(null != (e = A.ZP.getSubscriptions()) ? e : {}).filter(e => e.type === U.NYc.GUILD).filter(e => e.status !== U.O0b.ENDED).length
    }),
    z = (0, f.Z)({
      forceFetch: !0
    }),
    ...
    Q = !q && (z.fractionalState !== M.a$.NONE || z.unactivatedUnits.length > 0);
  return (i.useEffect(() => (c.Z.wait(() => {
    (0, g.Y2)(), d.jg(), (0, u.X8)(), d.tZ()
  }), function() {
    p.Z.clearSubsection()
  }), []), v.Z.enabled) ? (0, r.jsx)(h.Z, {}) : m && x ? P === V.cP ? (0, r.jsx)(j.Z, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [n ? (0, r.jsx)(B.Yn, {}) : null, null != e ? (0, r.jsx)(B.ZP, {
        ...
        busy: N,
        subscriptions: t
      }) : (0, r.jsx)(B.MM, {}), Q && (0, r.jsxs)("section", {
        children: [(0, r.jsx)(o.X6q, {
          variant: "heading-md/bold",
          className: H.accountCreditTitle,
