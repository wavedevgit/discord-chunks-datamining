...
function C(e) {
  ...
  return null == y || null == w || null == B ? null : <div className={i()(R.container, D)}>{<h.Z guildId={C} userId={s} onNavigate={b} />}{<u.Den className={S.innerContainer} ref={L} onScroll={k}><T.Z searchResults={Z} search={B} renderEmbeds={true} blockCount={0} ignoreCount={0} scrollTo={p.dG4} onPageChange={F} onBlockedResultsClick={p.dG4} /></u.Den>}</div>
}