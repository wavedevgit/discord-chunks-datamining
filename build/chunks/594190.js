...
function eL() {
  let e = !1;
  return Q = o().values(N.Z.libraryApplications).reduce((t, n) => {
...
class e2 extends(i = c.ZP.Store) {
  initialize() {
    ...
    this.waitFor(A.Z, m.Z, S.Z), W = a.gamesSeen, this.syncWith([m.Z], e1), this.syncWith([N.Z, A.Z, C.Z], o().throttle(eL, 1e3)), s && eP()
  }
  getVisibleGame() {
