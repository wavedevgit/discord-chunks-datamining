...
function ey(e) {
  ...
  if (null != o) return o;
  let a = null != e.exeName && "" !== e.exeName ? e.exeName : null != (i = null == (n = e.exePath.split("/").pop()) ? void 0 : n.split("\\").pop()) ? i : "",
...
function eL() {
  let e = !1;
  return Q = a().values(N.Z.libraryApplications).reduce((t, n) => {
...
}!__OVERLAY__ && ((0, L.isDesktop)() || U.iP) && (eo = function() {
  let e = [],
    t = new Set;
  r = {};
  let n = A.Z.games,
...
class e2 extends(i = c.ZP.Store) {
  initialize() {
    ...
    if (a().values(null != (t = o.gameOverrides) ? t : {}).forEach(e => {
      ...
      }), ei.enableOverlay = null != (n = o.enableOverlay) ? n : {}, ei.enableOverlayV3 = null != (r = o.enableOverlayV3) ? r : {}, ei.enableDetection = null != (i = o.enableDetection) ? i : {}, ex(), Array.isArray(o.gamesSeen))
      for (let e of o.gamesSeen) "number" == typeof e.id && (e.nativeProcessObserverId = e.id, delete e.id, s = !0);
    this.waitFor(A.Z, m.Z, S.Z), W = o.gamesSeen, this.syncWith([m.Z], e1), this.syncWith([N.Z, A.Z, C.Z], a().throttle(eL, 1e3)), s && eP()
  }
  getVisibleGame() {
