...
n.d(t, {
  ...
  ik: () => eN,
  rH: () => ev
}), n(388685), n(35282), n(539854), n(704826), n(290780), n(642613);
var i, a = n(392711),
  o = n.n(a),
  s = n(913527),
  l = n.n(s),
...
function eg(e) {
  ...
  return null != e.id && (t.id = e.id), null != e.nativeProcessObserverId && (t.nativeProcessObserverId = e.nativeProcessObserverId), null != e.name && (t.name = e.name), e.add && (t.add = !0), e.block && (t.block = !0), null != e.distributor && (t.distributor = e.distributor), eE(t, e), t
}
...
W.forEach(e => {
  var t;
  eh.set(e.name.toLowerCase(), e), (null != (t = e.executables) ? t : []).forEach(t => {
...
function eT(e) {
  ...
  return null != t && (0, O.YB)("getRawOverlayGameStatus") && eI.has(t)
}
...
function eD() {
  let e = !1;
  return X = o().values(N.Z.libraryApplications).reduce((t, n) => {
...
function ek(e) {
  null != e && 0 !== e.length && (e.forEach(e => {
    if (er.gamesSeen.some(t => {
        if (t.name === e.name) {
          ...
          return t.distributor !== e.distributor && (t.distributor = e.distributor), eE(t, e), !0
        }
        return !1
      }));
    else {
  ...
  }), er.gamesSeen.sort((e, t) => t.lastFocused - e.lastFocused), eR(), w.Z.setRecentGames(eM().map(e => eP(e, e3, A.Z, N.Z))))
}
...
function eU() {
  $ = (J = J.map(e => e.distributor === M.GQo.ROBLOX ? (0, T.ON)(e, S.Z.getCurrentSubgameInfo()) : e)).length > 0 ? J[0] : null, ek(J)
}
...
function eY(e) {
  ...
  (null == r.lastFocused || 0 === r.lastFocused) && (r.lastFocused = Math.floor(Date.now() / 1e3)), er.gameOverrides[t] = V(G({}, r), {
    add: !0
  }), ek(J), eL(), eR(), eO()
}
...
function eq(e) {
  ...
  t.length > 0 && R.default.track(M.rMx.GAME_DETECTION_DEBUGGING_KEYWORD_MATCH, {
    keywords: K,
    paths: t,
    debugging_level: ef,
    interval_seconds: e_
...
function eX(e) {
  ...
  } = e, i = n !== er.enableOverlay[ev(t)], a = r !== er.enableOverlayV3[ev(t)];
  if (i && (er.enableOverlay[ev(t)] = n), a && null != r && (er.enableOverlayV3[ev(t)] = r), eR(), !__OVERLAY__ && null != (null != t.id ? A.Z.getDetectableGame(t.id) : null)) {
    var o, s;
...
function eQ(e) {
  ...
  er.enableDetection[ev(t)] = !n, eR(), J.length > 0 && J.some(e => e.distributor === M.GQo.ROBLOX) && eU(), R.default.track(M.rMx.USER_SETTINGS_GAME_DETECTION_TOGGLE, {
    enabled: !n
  })
}
...
function eJ(e) {
  ...
  let r = ev(n);
  delete er.gameOverrides[t], er.gameOverrides[r] = n, em(er.enableOverlay, t, r), em(er.enableDetection, t, r), em(en, t, r), er.gamesSeen.forEach(n => {
...
function e$(e) {
  let t = ev(e.game);
  delete er.gameOverrides[t], delete er.enableOverlay[t], delete er.enableDetection[t], er.gamesSeen = er.gamesSeen.filter(e => ev(e) !== t), en[t] && (J.forEach(e => {
    t === ev(e) && (e.hidden = !0)
  }), delete en[t], eO()), eL(), eR()
}
...
function e1() {
  m.Z.hasLoadedExperiments && Y.length > 0 && (ek(Y), Y = [])
}!__OVERLAY__ && ((0, L.isDesktop)() || j.iP) && (ei = function() {
  let e = [],
    t = new Set;
  r = {};
  let n = A.Z.games,
  ...
  }), e = e.filter(e => null != e.executables && e.executables.length > 0), x.ZP.setObservedGamesCallback(e, e => {
    let n = [],
      i = {};
...
class e2 extends(i = c.ZP.Store) {
  initialize() {
    ...
    if (o().values(null != (t = a.gameOverrides) ? t : {}).forEach(e => {
      ...
      }), er.enableOverlay = null != (n = a.enableOverlay) ? n : {}, er.enableOverlayV3 = null != (r = a.enableOverlayV3) ? r : {}, er.enableDetection = null != (i = a.enableDetection) ? i : {}, eL(), Array.isArray(a.gamesSeen))
      for (let e of a.gamesSeen) "number" == typeof e.id && (e.nativeProcessObserverId = e.id, delete e.id, s = !0);
    this.waitFor(A.Z, m.Z, S.Z), Y = a.gamesSeen, this.syncWith([m.Z], e1), this.syncWith([N.Z, A.Z, C.Z], o().throttle(eD, 1e3)), s && eR()
  }
  getVisibleGame() {
    return null == $ || eC($) ? $ : null
  }
  ...
  getRunningVerifiedApplicationIds() {
    return this.getRunningGames().map(e => A.Z.getGameByName(e.name)).filter(D.lm).map(e => e.id)
  }
  getGameForPID(e) {
    var t;
  ...
  getObservedAppNameForWindow(e) {
    var t, n;
    return null != (n = null == (t = ee.find(t => (0, g.Z)(e, t.windowHandle))) ? void 0 : t.name) ? n : null
  }
