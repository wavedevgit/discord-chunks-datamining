...
Y.forEach(e => {
  var t;
  ep.set(e.name.toLowerCase(), e), (null != (t = e.executables) ? t : []).forEach(t => {
...
function ew() {
  let e = !1;
  return q = o().values(A.Z.libraryApplications).reduce((t, n) => {
...
function eH(e) {
  ...
  (null == r.lastFocused || 0 === r.lastFocused) && (r.lastFocused = Math.floor(Date.now() / 1e3)), en.gameOverrides[t] = B(U({}, r), {
    add: !0
  }), ex(Q), eD(), eC(), ey()
}
...
function eq(e) {
  ...
  } = e, i = n !== en.enableOverlay[eO(t)], a = r !== en.enableOverlayV3[eO(t)];
...
function eQ(e) {
  ...
  let r = eO(n);
  delete en.gameOverrides[t], en.gameOverrides[r] = n, eh(en.enableOverlay, t, r), eh(en.enableDetection, t, r), eh(et, t, r), en.gamesSeen.forEach(n => {
...
function eJ(e) {
  let t = eO(e.game);
  delete en.gameOverrides[t], delete en.enableOverlay[t], delete en.enableDetection[t], en.gamesSeen = en.gamesSeen.filter(e => eO(e) !== t), et[t] && (Q.forEach(e => {
    t === eO(e) && (e.hidden = !0)
  }), delete et[t], ey()), eD(), eC()
}
...
class e1 extends(i = c.ZP.Store) {
  initialize() {
    ...
    if (o().values(null != (t = a.gameOverrides) ? t : {}).forEach(e => {
      ...
      }), en.enableOverlay = null != (n = a.enableOverlay) ? n : {}, en.enableOverlayV3 = null != (r = a.enableOverlayV3) ? r : {}, en.enableDetection = null != (i = a.enableDetection) ? i : {}, eD(), Array.isArray(a.gamesSeen))
      for (let e of a.gamesSeen) "number" == typeof e.id && (e.nativeProcessObserverId = e.id, delete e.id, s = !0);
    this.waitFor(S.Z, m.Z), H = a.gamesSeen, this.syncWith([m.Z], e0), this.syncWith([A.Z, S.Z, N.Z], o().throttle(ew, 1e3)), s && eC()
  }
  getVisibleGame() {
