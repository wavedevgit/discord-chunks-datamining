...
function ek(e) {
  ...
  }), er.gamesSeen.sort((e, t) => t.lastFocused - e.lastFocused), eR(), P.Z.setRecentGames(eM().map(e => eP(e))))
}
...
function eQ(e) {
  ...
  er.enableDetection[ev(t)] = !n, eR(), C.default.track(M.rMx.USER_SETTINGS_GAME_DETECTION_TOGGLE, {
    enabled: !n
  })
}
