...
function O(e) {
  ...
  }), [k, M] = i.useState(false), [G, U] = i.useState(false), B = null != (t = L.options) ? t : L.optionErrors.filter(p.lm)[0], F = L.config, H = l.options.length >= j.fY, W = (0, g.kl)(n.id, Array.from(w), [l]).length - w.size, V = i.useRef(null), z = i.useRef(x);
  return (i.useEffect(() => {
    z.current = x
  }), i.useLayoutEffect(() => {
    setTimeout(() => {
