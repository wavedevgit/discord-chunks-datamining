...
class b extends(r = Chunk73800.Component) {
  ...
  renderSingleItem() {
    ...
    return <div className={s()(Chunk838013.singleItemWrapper, Chunk838013.viewport, r)}><div className={Chunk838013.singleItem} style={{
          width: require.width,
          height: require.height
        }}>{module(exports[0], 0)}</div></div>
  }
  renderCarouselItems() {
    let e, {
        animatedIndex: t,
      ...
      h = this.getItemStyle(),
      m = (e = Chunk112724 > 0 ? [...Chunk120356.slice(-Chunk112724), ...Chunk120356, ...Chunk120356.slice(0, Chunk112724)] : Chunk120356).map((e, t) => <div style={h} className={u.item}>{o(e, t - c, this.interpolateValueForItem(t - c))}</div>);
    return <Chunk748780.Z.div className={Chunk838013.carousel} style={{
        opacity: r,
  ...
  render() {
    ...
    return 1 === module.length ? this.renderSingleItem() : <div className={s()({
        [Chunk838013.viewport]: require
      }, exports)}>{this.renderCarouselItems()}</div>
  }
  constructor(...e) {
