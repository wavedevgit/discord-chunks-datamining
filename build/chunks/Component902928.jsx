...
let f = e => {
  ...
  return n.clientId === i.t.PLAYSTATION_APPLICATION_ID || n.clientId === i.t.PLAYSTATION_STAGING_APPLICATION_ID ? p = d.Z : x && (p = u.Z), null != n.twoWayLinkCode ? h = l.intl.string(l.t.QhATl5) : x && (h = l.intl.string(l.t.vBPvKy)), (0, r.jsxs)("div", {
    className: c.content,
