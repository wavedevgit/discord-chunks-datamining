...
function v(e) {
  let {
    ...
    autoTrackExposure: !0
  }).enabled, C = (0, o.e7)([g.Z], () => g.Z.getUserProfile(t.id)), P = null == C ? void 0 : C.application, R = (0, f.Z)({
    user: t,
  ...
  return k.every(e => e.every(e => null == e)) ? null : (0, r.jsx)(a.yRy, {
    targetElementRef: I,
    renderPopout: e => {
      let {
        closePopout: t
      ...
      return (0, r.jsx)(a.v2r, {
        ...
        children: k.map((e, t) => (0, r.jsx)(a.kSQ, {
          children: e.map(e => e)
        }, t))
      })
    },
