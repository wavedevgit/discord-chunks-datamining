...
let v = e => {
  let {
    ...
    showWumpus: I,
    isPurchased: S = !1
  } = e, T = (0, a.e7)([f.Z], () => (0, s.wj)(f.Z.theme)), N = null != n ? (0, h.EU)(n) : i, A = (0, a.e7)([_.Z], () => _.Z.getStatus(t.id)), C = T ? "#706F74" : "#aaaab2";
  return (0, r.jsxs)("div", {
    className: o()(v, g.nameplatePreview, {
      [g.nameplatePurchased]: S && !y
    }),
    style: {
      color: T ? "white" : "black"
    },
    children: [null != N && (0, r.jsx)(d.Z, {
      ...
      children: [(0, r.jsx)("div", {
        ...
        children: (0, r.jsx)(c.Z, {
          ...
          name: (0, r.jsx)("div", {
            className: o()(g.placeholderUsername, g.placeholderUsernameColor)
          }),
          innerClassName: g.avatarWithTextInnerClassName,
          selected: !1
        })
