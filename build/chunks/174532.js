...
class u {
  start() {
    ...
    this.listeningUsers.clear(), this.listening.reset(), this.speaking.reset(), this.participation.reset(), this.muted.reset(), this.connected.reset(), this.voiceFilterSpeaking.clear(), this.timesUntilSpeakingDurationMilestonesMs.clear(), this.connected.start(), this.connection.on(r.S.Speaking, (e, t, n) => {
