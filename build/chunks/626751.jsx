...
function f(e) {
  ...
  let {
    channel: f,
    message: _
  } = e, p = null != (n = null == (t = _.roleSubscriptionData) ? true : t.is_renewal) && n ? (0, u.Md)() : (0, u.Q8)(), h = f.guild_id, m = (0, o.e7)([s.Z], () => {
    var e;
  ...
  return g ? null : <a.Z channel={f} message={_} buttonLabels={p} stickers={u.HG} event={d.rMx.ROLE_SUBSCRIPTION_PURCHASE_SYSTEM_MESSAGE_CTA_CLICKED} eventProperties={E} />
}