...
function h(e, t, n) {
  let {
    item: h
  } = e, m = (0, p.q)(_(i.Z), "@react-aria/tag"), g = (0, a.Me)(), {
    onRemove: E
  } = r.L.get(t) || {}, {
    rowProps: b,
    gridCellProps: y,
    ...
    descriptionProps: v,
    ...S
  } = O, I = t.disabledKeys.has(h.key) || h.props.isDisabled, T = e => {
  ...
  let A = E && ("keyboard" === C || "virtual" === C) ? m.format("removeDescription") : "",
    N = (0, o.P)(A),
    P = h.key === t.selectionManager.focusedKey,
