...
let p = 12633 == n.j ? function(e) {
  ...
  } = (0, s.ZP)(o.Z.PREMIUM_TIER_2_DISCOUNT_ENDING_NOTICE), g = (0, d.Ng)(), f = (0, l.Z)(null != g && null != g.expires_at ? Date.parse(g.expires_at) : 0);
  return null == g || (null == (t = g.discount) ? void 0 : t.plan_ids.some(e => u.GP[e].skuId !== p)) || null == g.expires_at || Object.values(f).every(e => 0 === e) ? null : (0, i.jsxs)(r.qXd, {
    ...
    }(f, Number(g.discount.amount)), (0, i.jsx)(r.EyT, {
      onClick: () => {
        (0, a.Z)({
          subscriptionTier: p,
          analyticsLocations: I,
