...
function H(e, t, n) {
  ...
  return i.useMemo(() => {
    ...
    for (let r of n) {
      ...
      let o = (0, x.lQ)(e, n.id);
      if (null != o && (null == (i = o.userStatus) ? true : i.enrolledAt) != null && (null == (l = o.userStatus) ? true : l.completedAt) == null) return {
        source: r,
        quest: o
      }
    }
...
function J(e) {
  let {
    onSourceSelect: t,
    selectedSource: n
  } = e, [l, s] = i.useState([]), [c, d] = i.useState({}), h = i.useRef(new u.Xp);
  i.useEffect(() => {
    let e = h.current,
      t = () => {
