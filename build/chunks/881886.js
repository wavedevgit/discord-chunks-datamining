/** Chunk was on 91584 **/
/** chunk id: 881886, original params: t,e,r (module,exports,require) **/
"use strict";
...
function c(t, e) {
  ...
  switch (g) {
    ...
    case "~":
    case "~>":
      return n = h, a = (o = v).slice(), (u = o.slice()).length > 1 && u.pop(), s = u.length - 1, p(c = parseInt(u[s], 10)) && (u[s] = c + 1 + ""), l(n, a) && false === y(n, u);
    default:
      return 0 === y(h, v)
  }
}
...
function g(t, e) {
  return (typeof t != typeof e && n(false), t > e) ? 1 : t < e ? false : 0
}
...
var v = {
  contains: function(t, e) {
    ...
    return r = t.trim(), i = e.trim(), (u = r.split(o)).length > 1 ? u.some(function(t) {
      ...
      var r = t.split(a);
      if (r.length > 0 && r.length <= 2 || n(false), 1 === r.length) return c(r[0], e);
      var i = r[0],
        o = r[1];
      return h(i) && h(o) || n(false), c(">=" + i, e) && c("<=" + o, e)
    }(r = u[0].trim(), i)
  }
};
module.exports = v