...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk404488 = require("./404488.js"),
  Chunk605276 = require("./605276.js"),
  Chunk869764 = require("./869764.js"),
  Chunk919318 = require("./919318.js"),
...
let k = Chunk404488.q + 300 + 64,
  M = Chunk73800.memo(function(e) {
    ...
    return <h.Z channelId={O.oC.GUILD_HOME} guildId={n.id} className={i()(w.title, w.background)} innerClassname={w.headerBarInner}>{<h.Z.Icon icon={c.Vy8} aria-hidden={true} />}{<h.Z.Title>{<c.nn4>{n.name}</c.nn4>}{P.intl.string(P.t.VbpLyc)}</h.Z.Title>}</h.Z>
  });
...
function L(e) {
  ...
  return (r.useEffect(() => {
    ...
    q && W !== b.P && o.Z.escapeToDefaultChannel(a.id)
  }, [a.id, q, W]), q) ? null : <l.Fragment>{<div className={i()(E.chat, w.background, {
        [E.threadSidebarOpen]: H,
        [E.threadSidebarFloating]: H && L
      })}>{<M guild={a} />}{<c.yWw{...A(S({}, B), {
      ...
      })} />}</div>}{H ? <v.Z pageWidth={h} onSidebarResize={(e, n) => {
        T(n), R(e)
      }} /> : null}</l.Fragment>
}