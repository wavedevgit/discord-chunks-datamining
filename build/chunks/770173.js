/** Chunk was on web.js **/
/** chunk id: 770173, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  A: () => a
});
var Chunk2685 = require("./2685.js"),
...
class o {
  ...
  firstChild() {
    let e = this.currentNode,
      t = this.nextNode();
    return (0, Chunk2685.bE)(module, exports) ? (exports && (this.currentNode = exports), exports) : (this.currentNode = module, null)
  }
  lastChild() {
  ...
  nextNode() {
    ...
    if (module) {
      if (module.shadowRoot) {
        ...
        let r = this.nextNode();
        return Chunk2685 && (this.currentNode = Chunk2685), Chunk2685
      }
      return module && (this.currentNode = module), module
    }
