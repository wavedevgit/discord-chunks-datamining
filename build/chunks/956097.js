...
class b extends(r = l.ZP.Store) {
  ...
  async configureLicense() {
    try {
      ...
      if ((null == t ? void 0 : t.code) === "MissingRegistration" && (await this.runCommand("registration", "new"), t = await this.runCommand("registration", "show")), (null == t || null == (e = t.account) ? void 0 : e.type) === "free" && m.Z.getCurrentConfig({
  ...
  async connect() {
    if (this.clientEnabled) {
      this.logEvent({
        status: "Configuring"
      }), await this.configureLicense(), await this.configureExceptions();
      try {
        this.logEvent({
...
s = "WarpClientStore", (i = "displayName") in b ? Object.defineProperty(b, i, {
  value: s,
  enumerable: !0,
  configurable: !0,
  writable: !0
