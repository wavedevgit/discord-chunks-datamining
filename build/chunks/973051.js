...
function g(e) {
  ...
  } = e, O = l.useRef(null), C = (0, i.e7)([c.Z], () => c.Z.getRulesPrompt(n.id)), [y, N] = l.useState(null != (t = null == C ? void 0 : C.response) && t), E = (0, i.e7)([c.Z], () => c.Z.get(n.id)), P = l.useRef(null), Z = l.useRef(null), I = l.useCallback(async () => {
    if (null != E && null != C) {
      try {
