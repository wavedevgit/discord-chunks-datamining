...
function v(e) {
  ...
  } = e, E = l.useRef(null), O = (0, o.e7)([u.Z], () => u.Z.getRulesPrompt(n.id)), [I, Z] = l.useState(null != (t = null == O ? void 0 : O.response) && t), y = (0, o.e7)([u.Z], () => u.Z.get(n.id)), P = l.useRef(null), w = l.useRef(null), D = l.useCallback(async () => {
    if (null != y && null != O) {
      try {
        await c.ZP.submitVerificationForm(n.id, j(g({}, y), {
          formFields: [j(g({}, O), {
            response: I
          })]
        }))
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsxs)(s.h21, {
        ...
        children: [(0, r.jsx)("div", {
          ...
          children: -1 !== C && (0, r.jsxs)(i.zx, {
            innerClassName: x.buttonInner,
            onClick: () => {
              !N && (f.default.track(h.rMx.GUILD_ONBOARDING_STEP_COMPLETED, j(g({}, (0, a.hH)(n.id)), {
                step: -1,
                skipped: !1,
                back: !0,
                options_selected: 0,
                in_onboarding: !0,
                is_final_step: !1
              })), C >= 0 && f.default.track(h.rMx.GUILD_ONBOARDING_STEP_VIEWED, j(g({}, (0, a.hH)(n.id)), {
                step: C,
          ...
          children: [(0, r.jsx)(s.Text, {
            ...
            children: [p.intl.string(p.t["8SuVoK"]), (0, r.jsx)("span", {
