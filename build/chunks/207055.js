...
let w = i.memo(e => {
  ...
  let {
    ...
    return t.has(w)
  }), [w, g.id]), H = (0, p.Z)(null != F ? [F.applicationId] : []), V = (0, P.Hr)("voice_users_eligibility_check", !1), z = (0, a.e7)([v.Z, j.Z], () => R ? j.Z.getActivities() : v.Z.getActivities(w, g.guild_id)).find(e => null != e.application_id && e.type === N.IIU.PLAYING), W = (0, a.e7)([d.Z], () => (null == z ? void 0 : z.application_id) != null ? d.Z.getApplication(null == z ? void 0 : z.application_id) : void 0);
...
let R = [],
  k = function(e) {
    let {
      ...
      className: C,
      children: j
    } = e, [O, E] = i.useState(null), [I, S] = i.useState(!1), P = i.useRef(null), T = (0, m.Es)(l.id, null != c ? c : R), k = i.useRef(new s.sW(50, () => {
