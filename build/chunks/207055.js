...
let w = i.memo(e => {
  ...
  let {
    ...
    return t.has(w)
  }), [w, g.id]), H = (0, p.Z)(null != F ? [F.applicationId] : []), V = (0, S.Hr)("voice_users_eligibility_check", !1), z = (0, a.e7)([v.Z, j.Z], () => R ? j.Z.getActivities() : v.Z.getActivities(w, g.guild_id)).find(e => null != e.application_id && e.type === N.IIU.PLAYING), W = (0, a.e7)([d.Z], () => (null == z ? void 0 : z.application_id) != null ? d.Z.getApplication(null == z ? void 0 : z.application_id) : void 0);
  null != W && S.ZP.trackExposure({
    location: "voice_users"
  });
  let [Y, q] = (0, a.Wu)([b.Z], () => [b.Z.getStreamForUser(w, g.getGuildId()), b.Z.getActiveStreamForUser(w, g.getGuildId())], [g, w]), K = (0, a.e7)([O.Z], () => O.Z.getSessionById(x)), X = P.ZP.useName(s), Q = (0, a.e7)([I.Z], () => I.Z.getVoicePlatformForChannel(g.id, w), [g.id, w]), J = (0, m.Eu)(g.id, w);
  return (0, r.jsx)(f.Z, {
