...
let w = i.memo(e => {
  ...
  let {
    ...
    sessionId: C,
    nick: A
  } = e, w = s.id, R = (0, o.e7)([_.default], () => _.default.getId() === w, [w]), [k, M, L] = (0, o.Wu)([x.Z], () => R ? [!x.Z.isSupported() || x.Z.isSelfMute() || x.Z.isSelfMutedTemporarily(), x.Z.isSelfDeaf(), !1] : [!x.Z.isSupported() || x.Z.isLocalMute(w), !1, x.Z.isLocalVideoDisabled(w)], [R, w]), D = (0, o.e7)([E.Z], () => E.Z.isPrioritySpeaker(w)), U = (0, c.Z)({
    userId: w,
    checkSoundSharing: !0
  }), B = (0, o.e7)([y.ZP], () => y.ZP.isGuestOrLurker(g.guild_id, w)), G = (0, o.e7)([h.Z], () => h.Z.getGuildRingingUsers(g.id).has(w)), F = (0, o.e7)([u.ZP], () => u.ZP.getEmbeddedActivitiesForChannel(g.id).find(e => {
    let {
      userIds: t
    } = e;
    return t.has(w)
