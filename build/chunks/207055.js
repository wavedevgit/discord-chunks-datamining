...
let w = i.memo(e => {
  ...
  let {
    ...
    return t.has(w)
  }), [w, g.id]), G = (0, p.Z)(null != H ? [H.applicationId] : []), V = (0, I.Hr)("voice_users_eligibility_check", !1), z = (0, o.e7)([v.Z, O.Z], () => R ? O.Z.getActivities() : v.Z.getActivities(w, g.guild_id)).find(e => null != e.application_id && e.type === T.IIU.PLAYING), W = (0, o.e7)([d.Z], () => (null == z ? void 0 : z.application_id) != null ? d.Z.getApplication(null == z ? void 0 : z.application_id) : void 0);
