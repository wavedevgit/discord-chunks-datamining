...
let w = i.memo(e => {
  ...
  let {
    ...
    sessionId: x,
    nick: A
  } = e, w = s.id, R = (0, o.e7)([_.default], () => _.default.getId() === w, [w]), [M, D, k] = (0, o.Wu)([C.Z], () => R ? [!C.Z.isSupported() || C.Z.isSelfMute() || C.Z.isSelfMutedTemporarily(), C.Z.isSelfDeaf(), !1] : [!C.Z.isSupported() || C.Z.isLocalMute(w), !1, C.Z.isLocalVideoDisabled(w)], [R, w]), L = (0, o.e7)([E.Z], () => E.Z.isPrioritySpeaker(w)), U = (0, c.Z)({
    userId: w,
    checkSoundSharing: !0
    ...
    return t.has(w)
  }), [w, g.id]), G = (0, p.Z)(null != H ? [H.applicationId] : []), V = (0, P.Hr)("voice_users_eligibility_check", !1), z = (0, o.e7)([v.Z, j.Z], () => R ? j.Z.getActivities() : v.Z.getActivities(w, g.guild_id)).find(e => null != e.application_id && e.type === T.IIU.PLAYING), W = (0, o.e7)([d.Z], () => (null == z ? void 0 : z.application_id) != null ? d.Z.getApplication(null == z ? void 0 : z.application_id) : void 0);
