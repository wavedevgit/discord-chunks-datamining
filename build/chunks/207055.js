...
let Z = i.memo(e => {
  ...
  let {
    ...
    sessionId: O,
    nick: A
  } = e, k = a.id, j = (0, s.e7)([I.default], () => I.default.getId() === k, [k]), [G, Z, F] = (0, s.Wu)([S.Z], () => j ? [!S.Z.isSupported() || S.Z.isSelfMute() || S.Z.isSelfMutedTemporarily(), S.Z.isSelfDeaf(), !1] : [!S.Z.isSupported() || S.Z.isLocalMute(k), !1, S.Z.isLocalVideoDisabled(k)], [j, k]), V = (0, s.e7)([P.Z], () => P.Z.isPrioritySpeaker(k)), H = (0, c.Z)({
    userId: k,
    checkSoundSharing: !0
...
let F = 50,
  ...
  Y = function(e) {
    let {
      ...
      className: E,
      children: b
    } = e, [v, T] = i.useState(null), [S, C] = i.useState(!1), R = i.useRef(null), P = (0, y.Es)(o.id, null != c ? c : H), w = i.useRef(new l.sW(F, () => {
