...
let k = i.memo(e => {
  ...
  let {
    ...
    sessionId: D,
    nick: k
  } = e, L = x.id, U = (0, o.e7)([j.default], () => j.default.getId() === L, [L]), [B, F, H] = (0, o.Wu)([E.Z], () => U ? [!E.Z.isSupported() || E.Z.isSelfMute() || E.Z.isSelfMutedTemporarily(), E.Z.isSelfDeaf(), !1] : [!E.Z.isSupported() || E.Z.isLocalMute(L), !1, E.Z.isLocalVideoDisabled(L)], [U, L]), G = (0, o.e7)([T.Z], () => T.Z.isPrioritySpeaker(L)), V = (0, c.Z)({
    userId: L,
    checkSoundSharing: !0
    ...
    return t.has(L)
  }), [L, S.id]), q = (0, p.Z)(null != Y ? [Y.applicationId] : []), K = (0, o.e7)([P.Z, I.Z], () => U ? I.Z.getActivities() : P.Z.getActivities(L, S.guild_id)).find(e => null != e.application_id && e.type === R.IIU.PLAYING), X = null != (n = (0, d.IX)(null == K ? void 0 : K.application_id).data) ? n : void 0, [Q, J] = (0, o.Wu)([v.Z], () => [v.Z.getStreamForUser(L, S.getGuildId()), v.Z.getActiveStreamForUser(L, S.getGuildId())], [S, L]), $ = (0, o.e7)([Z.Z], () => Z.Z.getSessionById(D)), ee = A.ZP.useName(x), et = (0, o.e7)([N.Z], () => N.Z.getVoicePlatformForChannel(S.id, L), [S.id, L]), {
    enableHangStatus: en
  } = m.n.useExperiment({
    guildId: S.guild_id,
    location: "VoiceUsers"
  }), er = (0, f.ZP)(S, !0, x), ei = (0, o.e7)([g.Z], () => U ? g.Z.getHangStatusActivity() : null, [U]), el = (0, b.j)(L), ea = (0, C.Eu)(S.id, L), {
...
let L = [],
  U = function(e) {
    let {
      ...
      className: _,
      children: y
    } = e, [v, O] = i.useState(null), [E, I] = i.useState(!1), Z = i.useRef(null), T = (0, C.Es)(l.id, null != c ? c : L), N = i.useRef(new s.sW(50, () => {
