...
let Z = i.memo(e => {
  ...
  let {
    ...
    sessionId: O,
    nick: A
  } = e, j = o.id, M = (0, s.e7)([I.default], () => I.default.getId() === j, [j]), [G, Z, F] = (0, s.Wu)([S.Z], () => M ? [!S.Z.isSupported() || S.Z.isSelfMute() || S.Z.isSelfMutedTemporarily(), S.Z.isSelfDeaf(), !1] : [!S.Z.isSupported() || S.Z.isLocalMute(j), !1, S.Z.isLocalVideoDisabled(j)], [M, j]), V = (0, s.e7)([R.Z], () => R.Z.isPrioritySpeaker(j)), H = (0, c.Z)({
    userId: j,
    checkSoundSharing: !0
    ...
    return t.has(j)
  }), [j, l.id]), z = (0, f.Z)(null != K ? [K.applicationId] : []), q = (0, s.e7)([N.Z, C.Z], () => M ? C.Z.getActivities() : N.Z.getActivities(j, l.guild_id)).find(e => null != e.application_id && e.type === x.IIU.PLAYING), $ = null != (n = (0, d.IX)(null == q ? void 0 : q.application_id).data) ? n : void 0, [X, Q] = (0, s.Wu)([v.Z], () => [v.Z.getStreamForUser(j, l.getGuildId()), v.Z.getActiveStreamForUser(j, l.getGuildId())], [l, j]), J = (0, s.e7)([w.Z], () => w.Z.getSessionById(O)), ee = D.ZP.useName(o), et = (0, s.e7)([P.Z], () => P.Z.getVoicePlatformForChannel(l.id, j), [l.id, j]), {
    enableHangStatus: en
  } = h.n.useExperiment({
    guildId: l.guild_id,
    location: "VoiceUsers"
  }), er = (0, p.ZP)(l, !0, o), ei = (0, s.e7)([m.Z], () => M ? m.Z.getHangStatusActivity() : null, [M]), ea = (0, g.j)(j), eo = (0, y.Eu)(l.id, j), {
...
let F = 50,
  ...
  Y = function(e) {
    let {
      ...
      className: E,
      children: b
    } = e, [v, T] = i.useState(null), [S, C] = i.useState(!1), w = i.useRef(null), R = (0, y.Es)(a.id, null != c ? c : H), P = i.useRef(new l.sW(F, () => {
      ...
      return null != m && m > 0 ? i.push((0, r.jsx)(L.ul, {
        collapsed: u,
        numAudience: m
      })) : u && R.length > d + 1 && i.push((0, r.jsx)(L.XX, {
        numUsers: R.length - d
      })), i
    }, G = (0, s.Wu)([N.Z], () => {
      if (u) return [];
