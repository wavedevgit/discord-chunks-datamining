...
let w = i.memo(e => {
  ...
  let {
    ...
    userId: w,
    checkSoundSharing: !0
  }), B = (0, o.e7)([C.ZP], () => C.ZP.isGuestOrLurker(g.guild_id, w)), G = (0, o.e7)([h.Z], () => h.Z.getGuildRingingUsers(g.id).has(w)), F = (0, o.e7)([u.ZP], () => u.ZP.getEmbeddedActivitiesForChannel(g.id).find(e => {
    let {
      userIds: t
    } = e;
    return t.has(w)
  }), [w, g.id]), H = (0, p.Z)(null != F ? [F.applicationId] : []), V = (0, P.Hr)("voice_users_eligibility_check", !1), z = (0, o.e7)([v.Z, j.Z], () => R ? j.Z.getActivities() : v.Z.getActivities(w, g.guild_id)).find(e => null != e.application_id && e.type === N.IIU.PLAYING), W = (0, o.e7)([d.Z], () => (null == z ? void 0 : z.application_id) != null ? d.Z.getApplication(null == z ? void 0 : z.application_id) : void 0);
  null != W && P.ZP.trackExposure({
    location: "voice_users"
  });
  let [Y, q] = (0, o.Wu)([b.Z], () => [b.Z.getStreamForUser(w, g.getGuildId()), b.Z.getActiveStreamForUser(w, g.getGuildId())], [g, w]), K = (0, o.e7)([O.Z], () => O.Z.getSessionById(y)), X = S.ZP.useName(s), Q = (0, o.e7)([I.Z], () => I.Z.getVoicePlatformForChannel(g.id, w), [g.id, w]), J = (0, m.Eu)(g.id, w);
  return (0, r.jsx)(f.Z, {
...
let R = [],
  M = function(e) {
    ...
    let G = (() => {
      ...
      return null != C && C > 0 ? i.push((0, r.jsx)(Z.ul, {
        collapsed: u,
        numAudience: C
