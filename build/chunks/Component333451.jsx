...
function D(e) {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(g.Z, {
      ...
      description: S.intl.formatToPlainString(S.t.sQBgs2, {
      ...
      icon: u.Ucv,
      iconClassName: A.perkIconGuild,
      description: S.intl.formatToPlainString(S.t["1A6vXi"], {
        percent: (0, y.T3)(n, T.Rr / 100)
      }),
      color: u.TVs.unsafe_rawColors.GUILD_BOOSTING_PINK.css
    }), t ? (0, r.jsx)(g.Z, {
      icon: u.EO4,
...
function w(e) {
  ...
  let {
    ...
    theme: L
  } = (0, u.TCT)(), M = (0, l.ap)(L) ? c.zx.Colors.PRIMARY : c.zx.Colors.WHITE, k = null == n || null == n.premiumSubscriptionType, j = O.ZP.getPrice(T.Xh.PREMIUM_MONTH_TIER_2, false, false, R), U = (0, v.T4)(j.amount, j.currency), G = (0, h.N)(), B = null == G ? true : G.trial_id, Z = (null == G || null == (t = G.subscription_trial) ? true : t.sku_id) === T.Si.TIER_2;
  return i.useEffect(() => {
    ...
    children: [(0, r.jsxs)(u.hzk, {
      ...
      children: [(0, r.jsx)(u.olH, {
        ...
        className: o()(A.upsellImage, {
          [A.upsellImageWithTrialOffer]: Z
        })
      }), (0, r.jsx)("div", {
        className: A.bodyText,
        children: null != B ? S.intl.string(S.t.AoSzEr) : S.intl.format(S.t["7vePZb"], {
          monthlyPrice: U
        })
      }), (0, r.jsx)(D, {
