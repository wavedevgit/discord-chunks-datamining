...
function w(e) {
  ...
  let {
    ...
    theme: L
  } = (0, u.TCT)(), M = (0, l.ap)(L) ? c.zx.Colors.PRIMARY : c.zx.Colors.WHITE, j = null == n || null == n.premiumSubscriptionType, k = O.ZP.getPrice(T.Xh.PREMIUM_MONTH_TIER_2, false, false, R), U = (0, v.T4)(k.amount, k.currency), G = (0, h.N)(), B = null == G ? true : G.trial_id, Z = (null == G || null == (t = G.subscription_trial) ? true : t.sku_id) === T.Si.TIER_2;
  return i.useEffect(() => {
