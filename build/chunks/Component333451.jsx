  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(g.Z, {
      ...
      description: T.intl.formatToPlainString(T.t.sQBgs2, {
        numFreeGuildSubscriptions: S.cb
      }),
...
function D(e) {
  ...
  let {
    ...
    theme: L
  } = (0, u.TCT)(), M = (0, l.ap)(L) ? c.zx.Colors.PRIMARY : c.zx.Colors.WHITE, j = null == n || null == n.premiumSubscriptionType, k = O.ZP.getPrice(S.Xh.PREMIUM_MONTH_TIER_2, false, false, R), U = (0, v.T4)(k.amount, k.currency), G = (0, h.N)(), B = null == G ? true : G.trial_id, Z = (null == G || null == (t = G.subscription_trial) ? true : t.sku_id) === S.Si.TIER_2;
  return i.useEffect(() => {
    ...
    children: [(0, r.jsxs)(u.hzk, {
      ...
      children: [(0, r.jsx)(u.olH, {
        ...
        children: null != B ? T.intl.string(T.t.AoSzEr) : T.intl.format(T.t["7vePZb"], {
          monthlyPrice: U
        })
      }), (0, r.jsx)(w, {
