    ...
    let {
      ...
      if (e instanceof _.Ay) {
        let {
          brand: t,
          label: n
        } = N(e, a), r = e === C || null == l || (null == l ? true : l.includes(e.paymentGateway));
        return {
          value: e.id,
          label: n,
          brand: t,
...
function L(e) {
  let {
    ...
    renderOptionValue: e => {
      ...
      }) : w(null == t.value ? true : x.get(t.value), t, f)
    },
    renderOptionLabel: e => w(null == e.value ? true : x.get(e.value), e, f),
