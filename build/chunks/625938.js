...
let P = e => {
  ...
  D = e => {
    let {
      currentStatus: t,
      channel: a
    } = e, s = i.useRef(E.Z.getRecentCustomStatuses()), [N, w] = i.useState(!1), R = (0, b.V)(), [D, L] = i.useState(null != t ? t : null), x = (0, c.e7)([h.default], () => h.default.getCurrentUser()), k = i.useMemo(() => [], []), j = i.useRef(null).current;
    i.useEffect(() => (N || k.push(u.z.HANG_STATUS_NEW_BADGE), () => {
