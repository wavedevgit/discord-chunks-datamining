...
let P = e => {
  ...
  Z = e => {
    let {
      currentStatus: t,
      channel: l
    } = e, o = i.useRef(_.Z.getRecentCustomStatuses()), [Z, T] = i.useState(!1), N = (0, y.V)(), [A, w] = i.useState(null != t ? t : null), R = (0, c.e7)([m.default], () => m.default.getCurrentUser()), M = i.useMemo(() => [], []), D = i.useRef(null).current;
