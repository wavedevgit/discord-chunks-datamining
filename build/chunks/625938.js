...
let w = e => {
  ...
  D = e => {
    let {
      currentStatus: t,
      channel: o
    } = e, s = i.useRef(E.Z.getRecentCustomStatuses()), [N, R] = i.useState(!1), P = (0, b.V)(), [D, L] = i.useState(null != t ? t : null), x = (0, c.e7)([h.default], () => h.default.getCurrentUser()), M = i.useMemo(() => [], []), k = i.useRef(null).current;
