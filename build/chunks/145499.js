...
let I = (e, t) => e < (0, b.A3)(y.Eu4.NONE) ? y.Eu4.NONE : e < (0, b.A3)(y.Eu4.TIER_1) ? y.Eu4.TIER_1 : e < (0, b.A3)(y.Eu4.TIER_2) ? y.Eu4.TIER_2 : e < (0, b.A3)(y.Eu4.TIER_3) || null != t && t.hasFeature(y.oNc.MORE_STICKERS) && e < c.D.MAX_STICKER_SLOTS ? y.Eu4.TIER_3 : y.Eu4.NONE,
  ...
  T = () => (0, r.jsx)("div", {
    className: O.placeholderCard,
    children: (0, r.jsx)("img", {
      className: O.placeholderImg,
  ...
  w = e => {
    ...
    } = (0, u.ZP)(), S = (0, h.Z)(t.id).available, w = t.hasFeature(y.oNc.MORE_STICKERS) ? y.Eu4.TIER_3 : t.premiumTier, R = t.hasFeature(y.oNc.MORE_STICKERS) ? y.oCV[y.Eu4.TIER_3] : S;
    if (i.useEffect(() => {
        let e = !1;
        return (async () => {
    ...
    let D = (e, n) => {
        let r = null;
        n === y.Eu4.TIER_1 ? r = y.Qqv.TIER_1 : n === y.Eu4.TIER_2 ? r = y.Qqv.TIER_2 : n === y.Eu4.TIER_3 && (r = y.Qqv.TIER_3), (0, g.Z)({
          analyticsLocations: f,
          analyticsLocation: {
      ...
      renderTier: e => {
        ...
        return H ? i = (0, r.jsx)(m.Z, {
          ...
          children: [M && (0, r.jsxs)("div", {
            ...
            className: a()(O.emptyTierWrapper, O.unusedTierWrapper),
            ...
            className: O.emptyTierWrapper,
            children: [(0, r.jsx)("img", {
              alt: C.NW.string(C.t.BAhsws),
              className: O.emptyTierImage,
              src: U
            }), (0, r.jsx)(o.Text, {
              className: O.unlockTierCtaHeading,
              variant: "text-md/normal",
              color: "header-secondary",
              children: c.tier === y.Eu4.TIER_1 ? C.NW.formatToPlainString(C.t.psMYu7, {
                numAdditional: G
              ...
              color: o.zxk.Colors.GREEN,
              onClick: () => D(y.oCV[c.tier] - S, c.tier),
