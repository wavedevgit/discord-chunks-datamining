...
let I = (e, t) => e < (0, x.A3)(O.Eu4.NONE) ? O.Eu4.NONE : e < (0, x.A3)(O.Eu4.TIER_1) ? O.Eu4.TIER_1 : e < (0, x.A3)(O.Eu4.TIER_2) ? O.Eu4.TIER_2 : e < (0, x.A3)(O.Eu4.TIER_3) || null != t && t.hasFeature(O.oNc.MORE_STICKERS) && e < c.D.MAX_STICKER_SLOTS ? O.Eu4.TIER_3 : O.Eu4.NONE,
  E = e => {
    ...
    return (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsx)(o.X6q, {
        ...
        children: C.NW.format(C.t.ZLoNtr, {
          numTotal: a,
          numAvailable: (0, x.Qi)(i, s)
        })
      })]
    })
  },
  ...
  P = e => {
    ...
    return (0, r.jsx)(o.zxk, {
      ...
      disabled: !i,
      children: C.NW.string(C.t.O1REe3)
    })
  },
  w = e => {
    let {
      ...
      isLoading: s
    } = (0, j.Z)(t.id), c = (0, a.e7)([b.Z], () => {
      var e;
      return null != (e = b.Z.getStickersByGuildId(t.id)) ? e : []
    }, [t]), {
      analyticsLocations: d
    } = (0, u.ZP)(), f = (0, h.Z)(t.id).available, S = t.hasFeature(O.oNc.MORE_STICKERS) ? O.Eu4.TIER_3 : t.premiumTier, w = t.hasFeature(O.oNc.MORE_STICKERS) ? O.oCV[O.Eu4.TIER_3] : f;
    if (i.useEffect(() => {
        window.dispatchEvent(new Event("resize"))
      }, [c]), s) return (0, r.jsx)(o.$jN, {});
    let R = (e, n) => {
        let r = null;
        n === O.Eu4.TIER_1 ? r = O.Qqv.TIER_1 : n === O.Eu4.TIER_2 ? r = O.Qqv.TIER_2 : n === O.Eu4.TIER_3 && (r = O.Qqv.TIER_3), (0, g.Z)({
          analyticsLocations: d,
          analyticsLocation: {
      ...
      Z = [{
        ...
        title: (0, r.jsx)(E, {
          ...
          currentGuildTier: S,
          tier: O.Eu4.NONE,
          children: C.NW.string(C.t.tfVXhI)
        })
      }, {
        tier: O.Eu4.TIER_1,
        title: (0, r.jsx)(E, {
          ...
          currentGuildTier: S,
          tier: O.Eu4.TIER_1,
          children: C.NW.string(C.t.nzXtaW)
        })
      }, {
        tier: O.Eu4.TIER_2,
        title: (0, r.jsx)(E, {
          ...
          currentGuildTier: S,
          tier: O.Eu4.TIER_2,
          children: C.NW.string(C.t["h33/ub"])
        })
      }, {
        tier: O.Eu4.TIER_3,
        title: (0, r.jsx)(E, {
          ...
          currentGuildTier: S,
          tier: O.Eu4.TIER_3,
          children: C.NW.string(C.t.BfF6EB)
        })
      }];
    return (0, r.jsx)(N.Z, {
      tiers: Z,
      renderTier: e => {
        ...
        return H ? i = (0, r.jsx)(m.Z, {
          ...
          children: [M && (0, r.jsxs)("div", {
            ...
            className: l()(y.emptyTierWrapper, y.unusedTierWrapper),
            ...
            children: [(0, r.jsx)("img", {
              ...
              variant: "text-md/normal",
              color: "header-secondary",
              children: d.tier === O.Eu4.TIER_1 ? C.NW.formatToPlainString(C.t.psMYu7, {
                numAdditional: G
              }) : C.NW.formatToPlainString(C.t.bLykER, {
                numAdditional: G,
                numTotal: E
              })
            }), (0, r.jsx)(o.zxk, {
              color: o.zxk.Colors.GREEN,
              onClick: () => R(O.oCV[d.tier] - f, d.tier),
              children: C.NW.string(C.t.dtFw5e)
            })]
          })]
        }, d.tier)
      }
