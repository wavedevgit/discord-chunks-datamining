...
let P = (e, t) => e < (0, j.A3)(N.Eu4.NONE) ? N.Eu4.NONE : e < (0, j.A3)(N.Eu4.TIER_1) ? N.Eu4.TIER_1 : e < (0, j.A3)(N.Eu4.TIER_2) ? N.Eu4.TIER_2 : e < (0, j.A3)(N.Eu4.TIER_3) || null != t && t.features.has(N.oNc.MORE_STICKERS) && e < c.D.MAX_STICKER_SLOTS ? N.Eu4.TIER_3 : N.Eu4.NONE,
  ...
  k = e => {
    ...
    } = (0, u.ZP)(), b = (0, h.Z)(t.id), R = t.features.has(N.oNc.MORE_STICKERS) ? N.Eu4.TIER_3 : t.premiumTier, k = t.features.has(N.oNc.MORE_STICKERS) ? N.oCV[N.Eu4.TIER_3] : b, A = (0, x.Z)(t.id);
    if (i.useEffect(() => {
    ...
    return (0, r.jsx)(O.Z, {
      ...
      renderTier: e => {
        ...
        }, Q = E.intl.string(E.t.g7lkra), t.premiumTier + 1 !== u.tier && ($ = !0, i = E.intl.string(E.t.mTMkY2))) : ($ = !0, i = E.intl.string(E.t.hwPEJS)));
        let ee = F === h + 1 && F > R,
          et = z || ee || h > R;
        return ee ? l = (0, r.jsx)(m.Z, {
          guild: t,
          size: o.zxk.Sizes.SMALL,
          ...
          children: [H && (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)("img", {
              ...
              variant: "text-md/normal",
              color: "header-secondary",
              children: u.tier === N.Eu4.TIER_1 ? E.intl.formatToPlainString(E.t.psMYu7, {
                numAdditional: V
              ...
              children: e => {
                var t, n;
                return (0, r.jsx)(o.zxk, (t = T({}, e), n = n = {
                  color: o.zxk.Colors.GREEN,
                  disabled: $,
                  onClick: J,
                  children: Q
