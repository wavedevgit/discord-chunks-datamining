...
let M = e => {
  ...
  U = e => {
    ...
    en === L.a$.NONE || Q || (E = 7, n = (0, r.jsx)(I.Z, {
      className: "",
      startsAt: er,
      endsAt: ei,
    ...
    }), B || (t = k.localizeBadge), E = 5) : (n = (0, r.jsx)(T.$H, {
      trialOffer: q,
      isTabSelected: B
    }), E = 4);
    let eu = (0, r.jsx)(c.Qj, (U = function(e) {
      ...
      locationState: H,
      onClick: () => {
        el === o.z.FRACTIONAL_NITRO_DURATION_LEFT_PILL && ea(R.L.TAKE_ACTION), b.default.track(w.rMx.NITRO_TAB_VISITED, {
          badge_decorator: E,
          has_premium: Y
      ...
      className: t,
      children: n
    }, Object.getOwnPropertyDescriptors ? Object.defineProperties(U, Object.getOwnPropertyDescriptors(G)) : (function(e, t) {
      var n = Object.keys(e);
      if (Object.getOwnPropertySymbols) {
