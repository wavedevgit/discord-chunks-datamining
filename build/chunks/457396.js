...
let V = e => {
    let {
      selected: t
    } = e, n = (0, a.e7)([g.default], () => g.default.getCurrentUser()), r = (0, a.e7)([b.Z], () => b.Z.getPremiumTypeSubscription()), i = (0, T.N)(), l = (0, N.Ng)(), o = (0, y.Vi)(), s = (0, L.V)(), c = (0, O.Qo)(n, r), u = (0, a.e7)([E.Z], () => E.Z.getCreatedAtOverride()), d = t || null != i || null != l || o || null != s || c, p = null != u ? u : null == n ? void 0 : n.createdAt;
  ...
  H = e => {
    ...
    if (eu === k.a$.NONE || ei || (E = 7, n = (0, r.jsx)(S.Z, {
        className: "",
        startsAt: ed,
        endsAt: ep,
        messageStyle: u.aj.SHORT_TIME,
        upperCase: !0
      })), ea) n = (0, r.jsx)(P.Z, {}), E = 0;
    else if (eo) {
      let e = (0, j.$q)();
      n = (0, r.jsx)(A._y, {
        isTabSelected: z,
    ...
    } else e_ === o.z.VOICE_FILTER_EARLY_ACCESS_PREMIUM_TAB_BADGE ? (n = (0, r.jsx)(A._y, {
      isTabSelected: z,
      badgeCopy: G.intl.string(G.t.y2b7CA),
      offerExpiresAt: null
    }), E = 2) : ei ? (n = (0, r.jsx)(w.S, {
      expiresAt: ep
    }), E = 4) : null != es ? (n = (0, r.jsx)(D.Z, {
      copy: es,
      showStars: !1
    }), E = 1) : null != er ? (n = (0, r.jsx)(A.GN, {
      userDiscount: er,
      isTabSelected: z,
      includesAmountOff: !1
    }), E = 3) : null == en || em ? ec ? (n = (0, r.jsx)(Z.l, {
      isSelected: z,
      onSelect: () => (0, h.Q3)(o.z.REFERRAL_PROGRAM_PREMIUM_TAB_BADGE, {
        dismissAction: U.L.TAKE_ACTION
      })
    }), E = 6) : el && (n = (0, r.jsx)(x.k, {
      entryPoint: x.U.PrivateMessages
    }), z || (t = B.localizeBadge), E = 5) : (n = (0, r.jsx)(A.$H, {
      trialOffer: en,
      isTabSelected: z
    }), E = 4);
    let eE = G.intl.string(G.t.Ipxkoq);
    Q && ee && (eE = G.intl.string(G.t["4gwVVl"])), !Q && J && ($ === I.Rx.TRY_NITRO && null != en ? eE = G.intl.string(G.t["3O6A4e"]) : $ === I.Rx.JOIN_NITRO ? eE = G.intl.string(G.t.brBiOz) : $ === I.Rx.GET_NITRO && (eE = G.intl.string(G.t.GayC1t)));
