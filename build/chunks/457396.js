...
let G = "NitroTabButton",
  V = e => {
    let {
      selected: t
    } = e, n = (0, a.e7)([f.default], () => f.default.getCurrentUser()), r = (0, a.e7)([m.ZP], () => m.ZP.getPremiumTypeSubscription()), i = (0, C.N)(), l = (0, v.Ng)(), o = (0, P.Vi)(), s = (0, N.$_)(), c = (0, x.V)(), u = (0, _.Qo)(n, r), d = (0, a.e7)([E.Z], () => E.Z.getCreatedAtOverride()), p = (0, I.m)({
      location: G
  ...
  B = e => {
    ...
    let K = (0, a.e7)([f.default], () => f.default.getCurrentUser()),
      ...
      [ep, eh] = (0, h.US)(ee ? [o.z.REVERSE_TRIAL_NITRO_TAB_BADGE_V2] : [], void 0, !0);
    if (i.useEffect(() => {
        !0 === F && ep === o.z.REVERSE_TRIAL_NITRO_TAB_BADGE_V2 && eh(k.L.AUTO_DISMISS)
      }, [eh, ep, F]), !V({
        selected: F
      })) return null;
    ea === R.a$.NONE || ee || (I = 7, E = (0, r.jsx)(y.Z, {
      className: "",
      startsAt: eo,
      endsAt: es,
    ...
    }), I = 4) : null != er ? (E = (0, r.jsx)(L.Z, {
      copy: er,
      showStars: !1
    }), I = 1) : null != ei ? (E = (0, r.jsx)(L.Z, {
      copy: ei,
      showStars: !1
    }), I = 1) : null != $ ? (E = (0, r.jsx)(j.GN, {
      userDiscount: $,
      isTabSelected: F,
      includesAmountOff: !1
    }), I = 3) : null == J || ed ? el ? (E = (0, r.jsx)(A.l, {
      isSelected: F,
      onSelect: () => (0, p.EW)(o.z.REFERRAL_PROGRAM_PREMIUM_TAB_BADGE, {
        dismissAction: k.L.TAKE_ACTION
      })
    }), I = 6) : et && (E = (0, r.jsx)(T.k, {
      entryPoint: T.U.PrivateMessages
    }), F || (t = U.localizeBadge), I = 5) : (E = (0, r.jsx)(j.$H, {
      trialOffer: J,
      isTabSelected: F
    }), I = 4);
    let ef = (0, r.jsx)(c.Qj, (B = function(e) {
      ...
      locationState: W,
      onClick: () => {
        ec === o.z.FRACTIONAL_NITRO_DURATION_LEFT_PILL && eu(k.L.TAKE_ACTION), b.default.track(D.rMx.NITRO_TAB_VISITED, {
          badge_decorator: I,
          has_premium: Q
