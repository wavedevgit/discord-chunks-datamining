...
let U = e => {
    let {
      selected: t
    } = e, n = (0, a.e7)([f.default], () => f.default.getCurrentUser()), r = (0, a.e7)([m.ZP], () => m.ZP.getPremiumTypeSubscription()), i = (0, v.N)(), l = (0, I.Ng)(), o = (0, T.Vi)(), s = (0, S.$_)(), c = (0, Z.V)(), u = (0, _.Qo)(n, r), d = (0, a.e7)([E.Z], () => E.Z.getCreatedAtOverride()), p = t || null != i || null != l || o || null != s || null != c || u, h = null != d ? d : null == n ? void 0 : n.createdAt;
    return p || null != n && null != h && Date.now() - h.getTime() > 12096e5
  },
  G = e => {
    let t, n, E, G;
    var B, V, {
    ...
    let eh = (0, r.jsx)(c.Qj, (B = function(e) {
      ...
      locationState: z,
      onClick: () => {
        es === o.z.FRACTIONAL_NITRO_DURATION_LEFT_PILL && ec(D.L.TAKE_ACTION), b.default.track(R.rMx.NITRO_TAB_VISITED, {
          badge_decorator: G,
          has_premium: q
