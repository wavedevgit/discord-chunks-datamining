...
let V = e => {
    let {
      selected: t
    } = e, n = (0, a.e7)([g.default], () => g.default.getCurrentUser()), r = (0, a.e7)([b.Z], () => b.Z.getPremiumTypeSubscription()), i = (0, T.N)(), l = (0, N.Ng)(), o = (0, y.Vi)(), s = (0, w.V)(), c = (0, O.Qo)(n, r), u = (0, a.e7)([E.Z], () => E.Z.getCreatedAtOverride()), d = t || null != i || null != l || o || null != s || c, p = null != u ? u : null == n ? void 0 : n.createdAt;
  ...
  H = e => {
    ...
    } else e_ === o.z.VOICE_FILTER_EARLY_ACCESS_PREMIUM_TAB_BADGE ? (n = (0, r.jsx)(Z._y, {
      isTabSelected: z,
      badgeCopy: G.intl.string(G.t.y2b7CA),
      offerExpiresAt: null
    }), E = 2) : ei ? (n = (0, r.jsx)(L.S, {
      expiresAt: ep
    }), E = 4) : null != es ? (n = (0, r.jsx)(D.Z, {
      copy: es,
      showStars: !1
    }), E = 1) : null != er ? (n = (0, r.jsx)(Z.GN, {
      userDiscount: er,
      isTabSelected: z,
      includesAmountOff: !1
    }), E = 3) : null == en || em ? ec ? (n = (0, r.jsx)(x.l, {
      isSelected: z,
    ...
    }), z || (t = B.localizeBadge), E = 5) : (n = (0, r.jsx)(Z.$H, {
      trialOffer: en,
      isTabSelected: z
    }), E = 4);
