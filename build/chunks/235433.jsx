...
function b(e) {
  ...
  return b || j ? <m.Z title={g.intl.string(h.default["86GtGB"])} className={n} showPremiumIcon={x}><div className={f.buttonsContainer}>{b && <s.zxk variant={"primary"} size={"sm"} text={g.intl.string(h.default.vJqrIi)} onClick={O} />}{j && <s.zxk variant={"secondary"} size={"sm"} text={g.intl.string(h.default.ymq8WV)} onClick={v} loading={C} />}</div></m.Z> : null
}