...
let f = "MULTIPLE_CHOICE",
  j = e => {
    let {
      ...
      onReorder: u,
      isDropHovered: m
    } = e, g = l.useRef(null), b = l.useRef(null), [, j, y] = (0, o.c)({
      type: f,
      item: {
        choice: t,
        index: n
      ...
      hover: (e, t) => {
        ...
        let {
          index: l
        } = e, a = null == (r = g.current) ? void 0 : r.getBoundingClientRect(), i = t.getClientOffset();
    ...
    return l.useLayoutEffect(() => (j(b), y(_(g)), () => {
      j(null), _(null)
    }), [j, _, y]), (0, r.jsxs)("div", {
      ref: g,
  ...
  y = function(e) {
    ...
    let {
      ...
      onSave: c,
      onClose: p
    } = e, [f, y] = l.useState(null != (t = null == o ? void 0 : o.label) ? t : ""), [_, v] = l.useState(null != (n = null == o ? void 0 : o.choices) ? n : [""]), [C, I] = l.useState(null), [O, E] = l.useState(null), w = (e, t) => {
      null != C && I(null);
      let n = e.replace(/(\r\n|\n|\r)/g, " ");
    ...
    return (0, r.jsxs)(g.Z, (a = function(e) {
      ...
      children: [(0, r.jsx)(d.oil, {
        ...
        onReorder: k,
        isDropHovered: t === O
      }, "choice-".concat(t))), _.length !== b.mb && (0, r.jsx)("div", {
