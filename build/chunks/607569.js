...
let y = "MULTIPLE_CHOICE",
  v = e => {
    let {
      ...
      hover: (e, t) => {
        ...
        let {
          index: l
        } = e, a = null == (r = b.current) ? void 0 : r.getBoundingClientRect(), i = t.getClientOffset();
  ...
  j = function(e) {
    ...
    let {
      ...
      onSave: c,
      onClose: g
    } = e, [y, j] = l.useState(null != (t = null == o ? void 0 : o.label) ? t : ""), [C, _] = l.useState(null != (n = null == o ? void 0 : o.choices) ? n : [""]), [I, O] = l.useState(null), [w, E] = l.useState(null), P = (e, t) => {
      null != I && O(null);
      let n = e.replace(/(\r\n|\n|\r)/g, " ");
