...
let x = "MULTIPLE_CHOICE",
  y = e => {
    let {
      ...
      hover: (e, t) => {
        ...
        let {
          index: l
        } = e, i = null == (r = m.current) ? void 0 : r.getBoundingClientRect(), a = t.getClientOffset();
  ...
  v = function(e) {
    ...
    let {
      ...
      onSave: c,
      onClose: p
    } = e, [x, v] = l.useState(null != (t = null == o ? void 0 : o.label) ? t : ""), [j, C] = l.useState(null != (n = null == o ? void 0 : o.choices) ? n : [""]), [_, I] = l.useState(null), [O, w] = l.useState(null), E = (e, t) => {
      null != _ && I(null);
      let n = e.replace(/(\r\n|\n|\r)/g, " ");
