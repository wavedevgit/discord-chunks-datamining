...
n.d(t, {
  default: () => C
}), n(388685), n(704826), n(35282), n(781311);
var l = n(255367),
  r = n(73800),
  o = n(120356),
  a = n.n(o),
...
let f = "MULTIPLE_CHOICE",
  j = e => {
    let {
      ...
      onReorder: m,
      isDropHovered: b
    } = e, g = r.useRef(null), h = r.useRef(null), [, j, C] = (0, i.c)({
      type: f,
      item: {
        choice: t,
        index: n
      ...
      hover: (e, t) => {
        ...
        let {
          index: r
        } = e, o = null == (l = g.current) ? void 0 : l.getBoundingClientRect(), a = t.getClientOffset();
    ...
    return r.useLayoutEffect(() => (j(h), C(y(g)), () => {
      j(null), y(null)
    }), [j, y, C]), (0, l.jsxs)("div", {
      ref: g,
      className: a()(_.draggableInputContainer, {
        [_.dragging]: b
      }),
      "data-dnd-name": t,
      children: [(0, l.jsx)("div", {
        ...
        children: [(0, l.jsx)(u.oil, {
          autoFocus: !0,
          onChange: e => o(e),
          placeholder: x.intl.formatToPlainString(x.t["Ep/pbG"], {
            index: n + 1
          }),
          value: t
        }), (0, l.jsx)(d.zx, {
  ...
  C = function(e) {
    ...
    let {
      ...
      onSave: c,
      onClose: d
    } = e, [p, f] = r.useState(null != (t = null == i ? void 0 : i.label) ? t : ""), [C, y] = r.useState(null != (n = null == i ? void 0 : i.choices) ? n : [""]), [v, I] = r.useState(null), [O, N] = r.useState(null), z = (e, t) => {
      null != v && I(null);
      let n = e.replace(/(\r\n|\n|\r)/g, " ");
    ...
    return (0, l.jsxs)(g.Z, (o = function(e) {
      ...
      children: [(0, l.jsx)(u.oil, {
        ...
        onReorder: E,
        isDropHovered: t === O
      }, "choice-".concat(t))), C.length !== h.mb && (0, l.jsx)("div", {
