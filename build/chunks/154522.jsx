...
function g(e) {
  ...
  return o ? <ul className={j.cardContainer} aria-label={b.intl.string(b.t.qe4kTU)}>{m.map(e => (0, n.jsx)("li", {
      className: j.card,
