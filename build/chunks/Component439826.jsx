...
function R(e) {
  ...
  let {
    ...
    ref: p,
    height: g = 0
  } = (0, u.ZP)([o]), f = (null == (t = n.userStatus) ? true : t.completedAt) != null, x = (0, h.z)(n), {
    type: _,
    hints: b
  } = s.useMemo(() => f || x ? {
    type: 2,
...
function B(e) {
  ...
  let {
    ...
    }) : (0, b.R)(T.dr.QUEST_HOME_DESKTOP) ? await (0, E.enrollAndStartVideoQuestWithErrorHandling)(m, {
      questContent: x.jn.QUEST_HOME_DESKTOP,
