...
function R(e) {
  var t = e.DecoratedComponent,
    ...
    N = function(e) {
      ...
      function d(e) {
        var n;
        return b(this, d), w(A(n = t.call(this, e)), "decoratedRef", (0, i.createRef)()), w(A(n), "handlerId", void 0), w(A(n), "manager", void 0), w(A(n), "handlerMonitor", void 0), w(A(n), "handlerConnector", void 0), w(A(n), "handler", void 0), w(A(n), "disposable", void 0), w(A(n), "currentType", void 0), w(A(n), "handleChange", function() {
        ...
        value: function(e) {
          if (this.handlerMonitor && this.manager && this.handlerConnector && e !== this.currentType) {
            ...
            var a = this.manager.getMonitor(),
              o = a.subscribeToStateChange(this.handleChange, {
                handlerIds: [r]
              });
