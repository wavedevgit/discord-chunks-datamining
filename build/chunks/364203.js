  ...
  return (0, p.Z)({
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(d.lBU, {
        text: w.NW.string(w.t.oW0eUV)
      }), (0, r.jsx)(d.olH, {
        className: D.coachmarkCloseIcon,
        onClick: () => {
          v.default.track(C.rMx.CHAT_WALLPAPER_PICKER_CANCEL_CLICKED, {
...
let Z = i.forwardRef(e => {
  ...
  return i.useEffect(() => {
    ...
    children: e => (0, r.jsx)("div", {
      ...
      children: (0, r.jsx)(d.P3F, k(x({}, e, h), {
...
function Y(e) {
  ...
  return (0, r.jsxs)(d.Kqy, {
    ...
    children: [(0, r.jsx)(d.XZJ, {
      ...
      value: i,
      onChange: (e, t) => {
        v.default.track(C.rMx.CHAT_WALLPAPER_PICKER_BLUR_TOGGLED, {
          selected: t
        }), o(t)
      },
...
let z = function(e) {
  ...
  } = (0, _.ZP)(f.Z.CHAT_WALLPAPER_PICKER), {
  ...
  let j = i.useCallback(() => {
    ...
    q = i.useCallback(e => {
      ...
      null != n && (v.default.track(C.rMx.CHAT_WALLPAPER_WALLPAPER_OPTION_SELECTED, {
        wallpaper_id: n.id,
