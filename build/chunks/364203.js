...
function C(e) {
  ...
  return (0, r.jsx)(c.ua7, {
    ...
    children: e => (0, r.jsx)("div", {
      ...
      children: (0, r.jsx)(c.P3F, I(y({}, e, d), {
        tabIndex: d.tabIndex,
        onClick: t ? m.dG4 : () => n(i),
        children: u
      }))
...
let D = function(e) {
  let {
    className: t,
    position: n = m.VD2.BOTTOM_RIGHT
  } = e, [o, l] = i.useState(null), [u, E] = i.useState(!1), v = (0, _.e)(u ? _.x.BLURRED : _.x.DEFAULT);
  (0, p.W)();
  let {
    closePickerForChannel: y
  } = (0, h.B)(), [O, I] = (0, d.US)(v.length > 0 ? [s.z.CHAT_WALLPAPERS_PICKER_COACHMARK] : []), S = O === s.z.CHAT_WALLPAPERS_PICKER_COACHMARK, C = () => {
    y(), S && I(g.L.USER_DISMISS)
  }, D = () => {};
  return 0 === v.length ? null : (0, r.jsx)(f.Z, {
