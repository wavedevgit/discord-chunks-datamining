...
function w(e) {
  ...
  return (0, r.jsx)(u.ua7, {
    ...
    children: e => (0, r.jsx)("div", {
      ...
      children: (0, r.jsx)(u.P3F, N(S({}, e, d), {
        tabIndex: d.tabIndex,
        onClick: t ? b.dG4 : () => n(i),
        children: c
      }))
...
let M = function(e) {
  let {
    className: t,
    position: n = b.VD2.BOTTOM_RIGHT
  } = e, {
    activePickerChannelId: o,
    closePickerForChannel: c
  } = (0, E.B)(), [d, y] = i.useState(null), I = i.useRef(!1), S = (0, s.e7)([p.Z], () => {
    var e;
  ...
  let [T, N] = i.useState(!1), A = (0, h.e)(T ? h.x.BLURRED : h.x.DEFAULT);
  (0, m.W)();
  let w = i.useCallback(() => {
      c()
    }, [c]),
  ...
  return 0 === A.length || null == o ? null : (0, r.jsx)(_.Z, {
    className: a()(O.draggableContainer, t),
    defaultPosition: n,
    children: (0, r.jsxs)("div", {
      className: O.container,
      children: [G ? (0, r.jsx)(R, {
        handleClose: B
      }) : (0, r.jsx)(P, {
        handleClose: B
      }), (0, r.jsx)("div", {
