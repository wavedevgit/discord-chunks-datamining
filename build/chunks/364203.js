  ...
  return (0, f.Z)({
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(c.lBU, {
        text: R.NW.string(R.t.oW0eUV)
      }), (0, r.jsx)(c.olH, {
        className: P.coachmarkCloseIcon,
        onClick: () => {
          E.default.track(A.rMx.CHAT_WALLPAPER_PICKER_CANCEL_CLICKED, {
...
let F = i.forwardRef(e => {
  ...
  return i.useEffect(() => {
    ...
    children: e => (0, r.jsx)("div", {
      ...
      children: (0, r.jsx)(c.P3F, x(D({}, e, p), {
...
function H(e) {
  ...
  return (0, r.jsxs)(c.Kqy, {
    ...
    children: [(0, r.jsx)(c.XZJ, {
      ...
      value: i,
      onChange: (e, t) => {
        E.default.track(A.rMx.CHAT_WALLPAPER_PICKER_BLUR_TOGGLED, {
          selected: t
        }), o(t)
      },
...
let Y = function(e) {
  let {
    className: t,
    position: n = A.VD2.BOTTOM_RIGHT,
    config: o
  } = e, {
    analyticsLocations: s
  } = (0, d.ZP)(u.Z.CHAT_WALLPAPER_PICKER), {
    activePickerChannelId: f,
    closePicker: _,
    setPreviewWallpaperId: h
  } = (0, I.B)(), m = (0, T.Z)(f), R = (0, p.m)(C.p9.TIER_2), [w, D] = i.useState(!1), L = (0, v.e)(), x = (0, S.u)();
  (0, y.W)();
  ...
  let j = i.useCallback(() => {
    ...
    K = i.useCallback(() => {
      null != f && null != m && void 0 !== m.wallpaperId && (E.default.track(A.rMx.CHAT_WALLPAPER_PICKER_APPLY_CLICKED, {
    ...
    q = i.useCallback(e => {
      ...
      null != n && (E.default.track(A.rMx.CHAT_WALLPAPER_WALLPAPER_OPTION_SELECTED, {
        wallpaper_id: n.id,
  ...
  return Q = M ? (0, r.jsx)("div", {
    ...
    children: (0, r.jsx)(g.Z, {
      ...
      children: (0, r.jsxs)("div", {
        ...
        children: [(null == o ? void 0 : o.pickerType) === 1 ? (0, r.jsx)(G, {
          handleClose: Y,
