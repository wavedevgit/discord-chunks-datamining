  ...
  return (0, h.Z)({
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(d.lBU, {
        text: L.NW.string(L.t.oW0eUV)
      }), (0, r.jsx)(d.olH, {
        className: x.coachmarkCloseIcon,
        onClick: () => {
          O.default.track(P.rMx.CHAT_WALLPAPER_PICKER_CANCEL_CLICKED, {
...
function W(e) {
  ...
  return i.useEffect(() => {
    ...
    children: e => (0, r.jsx)("div", {
      ...
      children: (0, r.jsx)(d.P3F, U(k({}, e, p), {
...
function Y(e) {
  ...
  return i.useEffect(() => {
    ...
    children: [c && (0, r.jsx)(d.$jN, {
      className: x.previewLoadingSpinner
    }), (0, r.jsx)("img", {
      src: (0, m.I)(s.icon),
      alt: a,
      width: G,
...
function z(e) {
  ...
  return (0, r.jsxs)(d.Kqy, {
    ...
    children: [(0, r.jsx)(d.XZJ, {
      ...
      value: i,
      onChange: (e, t) => {
        O.default.track(P.rMx.CHAT_WALLPAPER_PICKER_BLUR_TOGGLED, {
          selected: t
        }), o(t)
      },
...
let Q = function(e) {
  let {
    className: t,
    position: o = P.VD2.TOP_RIGHT,
    config: s
  } = e, {
    analyticsLocations: l
  } = (0, p.ZP)(_.Z.CHAT_WALLPAPER_PICKER), {
    activePickerChannelId: c,
    closePicker: h,
    setPreviewWallpaperId: m
  } = (0, I.B)(), g = (0, R.Z)(c), b = (0, E.m)(D.p9.TIER_2), [y, M] = i.useState(!1), k = (0, T.e)(y), j = (0, C.u)();
  (0, N.W)();
  ...
  let $ = i.useCallback(() => {
      null != c && null != g && void 0 !== g.wallpaperId && (O.default.track(P.rMx.CHAT_WALLPAPER_PICKER_APPLY_CLICKED, {
    ...
    et = i.useCallback(e => {
      ...
      null != n && (O.default.track(P.rMx.CHAT_WALLPAPER_WALLPAPER_OPTION_SELECTED, {
        wallpaper_id: n.id,
  ...
  return ei = G || er ? (0, r.jsxs)("div", {
    ...
    children: (0, r.jsx)(v.Z, {
      ...
      children: (0, r.jsxs)("div", {
        ...
        ref: F,
        onKeyDown: en,
        children: [(null == s ? void 0 : s.pickerType) === I.j.COACHMARK ? (0, r.jsx)(Z, {
          handleClose: J,
