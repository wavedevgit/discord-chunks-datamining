/** Chunk was on 68880 **/ ! function(r, n) {
  ...
  X.VERSION = "0.7.36", X.BROWSER = U([l, h, s]), X.CPU = U([d]), X.DEVICE = U([c, p, f, g, y, m, v, _, b]), X.ENGINE = X.OS = U([l, h]), typeof e !== o ? (t.exports && (e = t.exports = X), e.UAParser = X) : typeof define === i && define.amd ? define(function() {
    return X
