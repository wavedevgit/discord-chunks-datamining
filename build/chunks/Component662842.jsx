...
function D(e) {
  ...
  } = e, l = (0, _.y)(t.id), d = (0, O.k5)(t.id), j = (0, o.e7)([N.Z], () => N.Z.getStageInstanceByChannel(null == l ? true : l.id), [l]), {
  ...
  }), [j, d]), U = null == l ? true : l.id, G = (0, o.Wu)([C.Z], () => [...new Set(C.Z.getMutableParticipants(U, S.pV.SPEAKER).map(e => e.user))], [U]), B = (0, o.e7)([C.Z], () => null != U ? C.Z.getParticipantCount(U, S.pV.AUDIENCE) : 0, [U]), V = (0, o.e7)([P.Z], () => P.Z.can(Z.Plq.CONNECT, l)), H = (0, T.Z)(null == l ? true : l.id), F = null == d ? true : d.creator_id, z = (0, o.e7)([x.default], () => x.default.getUser(F), [F]);
  i.useEffect(() => {
    null != F && (0, u.PR)(F)
  }, [F]);
  let {
