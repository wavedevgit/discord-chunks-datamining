...
function S(e) {
  ...
  } = (0, v.d)(), k = (0, o.e7)([h.Z], () => h.Z.getUserParticipantCount(P.id), [P]), M = (0, b.bt)(P.id, t), L = i.useCallback(() => {
    (0, a.j)(() => {
      v.d.setState({
  ...
  let D = (0, o.e7)([y.Z], () => P.isPrivate() || (0, m.b)(y.Z, w, P), [w, P]),
  ...
  }, []), null != w && !U && (!(k >= 2) || !F || G || H || V ? B && 1 === k && D && (F && !G ? z.push(e => (0, r.jsx)(C.h, {
    channel: P,
    guild: w,
    width: e,
    inPopout: A,
