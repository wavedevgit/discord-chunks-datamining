...
function I(e) {
  ...
  } = e, A = (0, c.bp)() === O.IlC.POPOUT, w = (0, a.e7)([_.Z], () => _.Z.getGuild(S.guild_id), [S.guild_id]), {
    dismissedActivityEntryPointTileChannel: R
  } = (0, v.d)(), k = (0, a.e7)([h.Z], () => h.Z.getUserParticipantCount(S.id), [S]), M = (0, b.bt)(S.id, t), L = i.useCallback(() => {
    (0, o.j)(() => {
      v.d.setState({
  ...
  }, []), null != w && !U && (!(k >= 2) || !G || H || F || V ? B && 1 === k && D && (G && !H ? z.push(e => (0, r.jsx)(C.h, {
    channel: S,
    guild: w,
    width: e,
    inPopout: A,
