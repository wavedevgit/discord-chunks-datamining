...
function eo(e) {
  ...
  let R = o.length > 0;
  return <div className={X.container}>{C ? <ea /> : null}{<es searchQuery={o} setSearchQuery={a} placeholder={h ? q.intl.string(q.t.ziyFv7) : q.intl.string(q.t["pw+r5e"])} />}{<p.Ttm ref={s} className={X.scrollableContent} fade={true}>{R ? (0, r.jsx)(Y.Z, {
        context: t,
        query: o,
        entrypoint: n,
        isScrollCloseToBottom: l
...
function ea() {
  return <div className={Chunk355563.developerShelfControlsContainer}>{<Chunk481060.Text className={Chunk355563.developerShelfControlsLabel} variant={"text-sm/normal"}>{Chunk388032.intl.string(Chunk388032.t.tZ3FNj)}</Chunk481060.Text>}{<Chunk427996.W hideSearch={true} />}</div>
}
...
function es(e) {
  ...
  }, [l, f]), <div className={X.searchBarContainer}><p.E1j ref={e => {
        var t;
        s.current = null != (t = null == e ? true : e.containerRef.current) ? t : null
      }} placeholder={o} query={t} onChange={h} onClear={d} onFocus={_} autoFocus={true} /></div>
}
...
function ec(e) {
  ...
  return (i.useEffect(() => {
    ...
    apps: f,
    onlyActivityApps: a
  }), l || p) ? null : <div>{<V.Z title={u} buttonType={V.Z.buttonTypes.VIEW_MORE} onClickViewButton={_} />}{<div className={X.sectionContentContainer}><div className={X.frecentList}>{f.map((e, n) => {
          let {
            application: i
          } = e;
...
function eu(e) {
  ...
  return (i.useEffect(() => {
    o(u)
  }, [o, u]), u) ? null : <div>{<div ref={e => {
        l.current = e
      }}><V.Z title={q.intl.string(q.t.shUONj)} /></div>}{<div className={X.sectionTwoColumnContentContainer}>{a.map((e, t) => {
        let {
          application: i
        } = e;
        return (0, r.jsx)(G.qR, {
...
function ed(e) {
  ...
  return (i.useEffect(() => {
    n(d)
  }, [d, n]), d) ? null : <div>{<div ref={e => {
        u.current = e
      }}><V.Z title={q.intl.string(q.t.KfkuGR)} buttonType={V.Z.buttonTypes.VIEW_MORE} onClickViewButton={c} /></div>}{<div className={X.sectionRowsContentContainer}>{s ? en.map(e => (0, r.jsx)(B.Z, {
        look: G.U4.ROW
      }, e)) : l.map((e, n) => {
        let {
          application: i
...
function ef(e) {
  ...
  return (i.useEffect(() => {
    ...
    return <div>{<V.Z.Loading />}{<div className={i === G.U4.ROW ? X.sectionRowsContentContainer : X.sectionTwoColumnContentContainer}>{n.map(e => (0, r.jsx)(B.Z, {
          look: i
        }, e))}</div>}</div>
  }) : s.map((e, n) => <e_ recommendationsSection={e} remainingActivities={c} isInstallOnDemand={l} position={n} context={t} />)
}
...
function e_(e) {
  ...
  return <div>{<div ref={e => {
        b.current = e
      }}><V.Z title={o.title} buttonType={V.Z.buttonTypes.VIEW_MORE} onClickViewButton={E} /></div>}{<div className={t === G.U4.ROW ? X.sectionRowsContentContainer : X.sectionTwoColumnContentContainer}>{g.map((e, n) => {
        let i, {
          collectionItemId: o,
