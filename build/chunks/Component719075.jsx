...
let _ = e => {
    let {
    ...
    } = e, d = (0, i.e7)([s.default], () => s.default.getCurrentUser()), f = (0, x.jB)(), _ = c.ZP.canUseCollectibles(d), {
      isDisabled: y
    } = (0, m.G)(t.skuId), {
      isPurchased: C,
      ...
      isRented: E,
      rentalExpiresAt: O
    } = (0, p.L)(t), T = (0, u.G1)(t), N = (0, u.rN)(t), P = r.useMemo(() => (0, u.BH)(t, _), [t, _]), w = (0, g.Iw)(t), {
