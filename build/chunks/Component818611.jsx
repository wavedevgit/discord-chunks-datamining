...
let _ = () => 80,
  P = e => {
    ...
    return (0, r.jsx)(o.P3F, f(g({
      className: a()(v.decorationGridItem, l ? v.selected : true, n)
    }, s), {
      onClick: i,
      children: t
    }))
  ...
  O = e => {
    var {
      ...
      isSelected: o = false
    } = e, u = j(e, ["user", "avatarDecoration", "innerRef", "section", "canUsePremiumCollectibles", "isSelected"]);
    let m = i.useRef(null),
      {
