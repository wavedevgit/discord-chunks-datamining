...
let j = () => 80,
  P = e => {
    var {
      ...
      onSelect: i,
      isSelected: l = false
    } = e, o = b(e, ["children", "className", "onSelect", "isSelected"]);
    return (0, r.jsx)(s.P3F, h(g({
  ...
  O = e => {
    let {
      ...
      onSelect: a,
      onOpenShop: c
    } = e, d = (0, p.ZP)(), f = u.ZP.canUseCollectibles(t);
    return (0, r.jsx)(s.GMG, {
      ...
      renderItem: (e, u, h, b) => {
        ...
        if ((0, o.M)(S)) {
          let e = (null == i ? true : i.skuId) === S.skuId;
          return (0, r.jsx)(y, {
            style: g({}, h),
            user: t,
            avatarDecoration: S,
