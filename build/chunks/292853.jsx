...
function E(e) {
  ...
  return <div className={a()(_.chatHeaderBar, {
      [_.narrow]: n
    })}>{<s.Text className={_.chatHeaderBarText} variant={"text-sm/normal"} color={"text-default"}>{f.intl.string(f.t.iOWmmJ)}</s.Text>}{<s.zxk size={"sm"} variant={"primary"} onClick={o} text={f.intl.string(f.t.ZtIlQk)} icon={s.qJs} />}</div>
}