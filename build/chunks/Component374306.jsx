...
function g(e) {
  let {
    ...
    tagFilter: _,
    tagSetting: y
  } = (0, c.H)(t.id), v = (0, i.e7)([o.Z, p.Z], () => !!(o.Z.getThreadIds(t.id, b, _, y).length > 0) || !!(p.Z.getThreads(t.id, b, _, y).length > 0), [t.id, b, _, y]), j = t.isMediaChannel();
  if (!n || m || j && v) return null;
