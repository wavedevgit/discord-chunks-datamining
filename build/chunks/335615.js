...
let et = Y.ZP.getEnableHardwareAcceleration(),
  ...
  er = i.memo(function(e) {
    let {
      ...
      premiumSince: O,
      nameplate: j
    } = e, E = ee(e, ["colorString", "colorStrings", "colorRoleName", "colorRoleId", "isOwner", "nick", "user", "currentUser", "activities", "applicationStream", "status", "channel", "guildId", "isTyping", "isMobileOnline", "premiumSince", "nameplate"]), S = i.useRef(null), [I, P] = i.useState(!1), Z = null != O ? new Date(O) : null, N = i.useCallback(e => {
      (0, m.jW)(e, async () => {
        let {
          default: e
        } = await Promise.all([n.e("79695"), n.e("98783"), n.e("97589"), n.e("7717"), n.e("74800")]).then(n.bind(n, 757387)), t = G.Z.isInChannel(B.Z.getVoiceChannelId(), u.id);
  ...
  ei = i.memo(function(e) {
    let {
      ...
      user: l,
      index: o
    } = e, a = (0, c.JA)("".concat(o)), s = (0, h.e7)([F.Z], () => F.Z.isTyping(i.id, l.id)), u = (0, h.e7)([H.default], () => H.default.getCurrentUser()), d = (0, h.e7)([U.Z], () => {
      var e;
      return null != t ? null == (e = U.Z.getRole(i.guild_id, t)) ? void 0 : e.name : void 0
    }, [i, t]), p = (0, R.K)({
      user: l
    });
    return (0, r.jsx)(er, $(J({}, n, a), {
      isTyping: s,
      currentUser: u,
      colorRoleName: d,
      nameplate: p
...
class ea extends i.Component {
  ...
  constructor(...e) {
    super(...e), Q(this, "_list", null), Q(this, "_areActivitiesExperimentallyHidden", !1), Q(this, "lastReportedAnalyticsChannel", void 0), Q(this, "setList", e => {
      ...
      if ((0, j.R)(o)) return (0, i.createElement)(j.Z, $(J({}, o), {
      ...
      if (0 === t) {
        ...
        return (0, r.jsx)(k.Z, {
          ...
          position: "left",
          inlineSpecs: en,
          children: (0, i.createElement)(el, $(J({}, o), {
            key: "section-".concat(e),
            guildId: l.guild_id
          }))
        }, "section-".concat(t))
      }
      return (0, i.createElement)(el, $(J({}, o), {
        key: "section-".concat(t),
        guildId: l.guild_id
      }))
...
function es(e) {
  ...
  } = (0, v.ZP)(C.Z.MEMBER_LIST), a = (0, h.e7)([y.Z], () => y.Z.keyboardModeEnabled), s = (0, h.cj)([L.ZP], () => L.ZP.getProps(t.guild_id, t.id)), {
    rows: d,
    groups: p,
    version: m,
    updateMaxRowSeen: g
