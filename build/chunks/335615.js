...
let et = Y.ZP.getEnableHardwareAcceleration(),
  ...
  er = i.memo(function(e) {
    let {
      ...
      premiumSince: O,
      nameplate: j
    } = e, E = ee(e, ["colorString", "colorStrings", "colorRoleName", "colorRoleId", "isOwner", "nick", "user", "currentUser", "activities", "applicationStream", "status", "channel", "guildId", "isTyping", "isMobileOnline", "premiumSince", "nameplate"]), S = i.useRef(null), [I, P] = i.useState(!1), Z = null != O ? new Date(O) : null, T = i.useCallback(e => {
      (0, m.jW)(e, async () => {
        let {
          default: e
