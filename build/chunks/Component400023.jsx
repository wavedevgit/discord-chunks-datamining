...
let q = (0, Chunk203463.animated)(Chunk481060.eTT),
  K = Chunk647438.memo(function(e) {
    ...
    let {
      ...
      jumpBarClassName: M,
      typingGradient: R
    } = e, [k, K] = r.useState(null != (n = E.Z.isAtBottom(m.id)) && n), Y = r.useMemo(() => v ? (0, L.aJ)({
      compact: true,
      messageGroups: 30,
      groupRange: 4,
      attachments: 8,
    ...
    }), Q = (0, c.e7)([C.Z], () => Z.Z.can(H.Plq.READ_MESSAGE_HISTORY, m) ? null : C.Z.getViewingRolesTimestamp(m.getGuildId())), {
      channelStreamMarkup: $,
      newMessagesBar: ee,
      jumpToPresentBar: et,
    ...
    let er = (0, u.mFp)(),
      ...
      eu = r.useMemo(() => R ? k ? F.chatTypingGradientAtBottom : F.chatTypingGradientNotAtBottom : F.chatGradient, [R, k]),
      ed = r.useMemo(() => R ? k ? F.typingGradientAtBottom : F.typingGradientNotAtBottom : F.gradientDefault, [R, k]);
