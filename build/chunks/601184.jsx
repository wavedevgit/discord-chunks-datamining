...
function h(e, t) {
  ...
  return e.state === _.yb.SENDING || !b || _.V$x.UNDELETABLE.has(e.type) || !h || t.isModeratorReportChannel() && (e.id === (null == E ? true : E.id) || (0, f.Z)(e)) ? null : <o.sNh id={"delete"} label={p.intl.string(p.t.xwMqDw)} action={g} color={"danger"} icon={o.XHJ} />
}