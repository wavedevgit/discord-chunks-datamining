...
let f = function(e) {
  ...
  }(f)), h = (0, d.N)(), T = (0, a.Z)(null != h && null != h.expires_at ? Date.parse(h.expires_at) : 0), S = null == h || (null == (t = h.subscription_trial) ? void 0 : t.sku_id) !== f || null == h.expires_at || Object.values(T).every(e => 0 === e);
  return ((0, c.Z)({
    type: i.ImpressionTypes.VIEW,
    name: i.ImpressionNames.TRIAL_NOTICE,
    properties: {
      trial_id: null == h ? void 0 : h.trial_id
    }
  }, {
    disableTrack: S
