...
let T = function(e) {
  ...
  }(T)), S = (0, d.N)(), N = (0, o.Z)(null != S && null != S.expires_at ? Date.parse(S.expires_at) : 0), A = null == S || (null == (t = S.subscription_trial) ? void 0 : t.sku_id) !== T || null == S.expires_at || Object.values(N).every(e => 0 === e);
  return ((0, s.Z)({
    ...
    children: [(0, r.jsx)(l.RyX, {
      ...
      switch (e) {
        case _.Si.TIER_0:
          return t.days > 0 ? O.intl.formatToPlainString(O.t.sP5OqK, {
            days: t.days
        ...
        case _.Si.TIER_2:
          return t.days > 0 ? O.intl.formatToPlainString(O.t["4prs5e"], {
            days: t.days
          }) : t.hours > 0 ? O.intl.formatToPlainString(O.t.OD5nIS, {
            hours: t.hours
          }) : O.intl.formatToPlainString(O.t.rvyXjI, {
            minutes: Math.max(t.minutes, 1)
          });
        default:
          throw Error("Unsupported subscription tier: ".concat(e))
