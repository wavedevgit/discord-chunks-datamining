...
let B = Chunk647438.memo(function e(t) {
  var n;
  let i, {
      channel: l,
      message: s,
  ...
  return ea ? (0, r.jsx)(e, G(U({}, t), {
    ...
    channel: q,
    hasThread: false
  })) : (m.Z.isBlockedForMessage(s) ? i = L.t["+FcYMz"] : m.Z.isIgnoredForMessage(s) ? i = L.t.VFWjc3 : (0, _.DQ)(s) && W && (i = L.t.xfkfTE), true !== i) ? (0, r.jsx)(F, {
    className: M,
    compact: R,
    count: 1,
    collapsedReason: i
