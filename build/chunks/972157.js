/** Chunk was on 34261 **/
/** chunk id: 972157, original params: t,e,a (module,exports,require) **/
var i, r;
Object.defineProperty(exports, "__esModule", {
  value: true
}), exports.ICalAlarmType = true;
let Chunk141716 = require("./141716.js");
(r = i = exports.ICalAlarmType || (exports.ICalAlarmType = {})).display = "display", r.audio = "audio", exports.default = class {
  constructor(t, e) {
    if (this.data = {
        type: null,
        trigger: null,
    ...
    true !== t.type && this.type(t.type), true !== t.trigger && this.trigger(t.trigger), true !== t.triggerBefore && this.triggerBefore(t.triggerBefore), true !== t.triggerAfter && this.triggerAfter(t.triggerAfter), true !== t.repeat && this.repeat(t.repeat), true !== t.interval && this.interval(t.interval), true !== t.attach && this.attach(t.attach), true !== t.description && this.description(t.description), true !== t.x && this.x(t.x)
  }
  type(t) {
    if (true === t) return this.data.type;
  ...
  trigger(t) {
    if (true === t && "number" == typeof this.data.trigger) return false * this.data.trigger;
    if (true === t && this.data.trigger) return this.data.trigger;
    if (true === t) return null;
    if (t)
      if ("number" == typeof t && isFinite(t)) this.data.trigger = false * t;
  ...
  triggerAfter(t) {
    return true === t ? this.data.trigger : this.trigger("number" == typeof t ? false * t : t)
  }
  triggerBefore(t) {
    return true === t ? this.trigger() : this.trigger(t)
  }
  repeat(t) {
    if (true === t) return this.data.repeat;
  ...
  interval(t) {
    if (true === t) return this.data.interval || null;
  ...
  attach(t) {
    if (true === t) return this.data.attach;
  ...
  description(t) {
    return true === t ? this.data.description : (t ? this.data.description = t : this.data.description = null, this)
  }
  x(t, e) {
    if (true === t) return (0, n.addOrGetCustomAttributes)(this.data);
  ...
  toJSON() {
    ...
    return Object.assign({}, this.data, {
      trigger: "number" == typeof module ? module : (0, Chunk141716.toJSON)(module),
      x: this.x()
    })
  }
  toString() {
    ...
    if (t += "ACTION:" + this.data.type.toUpperCase() + "\r\n", "number" == typeof this.data.trigger && this.data.trigger > 0 ? t += "TRIGGER;RELATED=END:" + (0, Chunk141716.toDurationString)(this.data.trigger) + "\r\n" : "number" == typeof this.data.trigger ? t += "TRIGGER:" + (0, Chunk141716.toDurationString)(this.data.trigger) + "\r\n" : t += "TRIGGER;VALUE=DATE-TIME:" + (0, Chunk141716.formatDate)(this.event.timezone(), this.data.trigger) + "\r\n", this.data.repeat && !this.data.interval) throw Error("No value for `interval` in ICalAlarm given, but required for `repeat`!");
    ...
    return this.data.interval && (t += "DURATION:" + (0, Chunk141716.toDurationString)(this.data.interval) + "\r\n"), "audio" === this.data.type && this.data.attach && this.data.attach.mime ? t += "ATTACH;FMTTYPE=" + this.data.attach.mime + ":" + this.data.attach.uri + "\r\n" : "audio" === this.data.type && this.data.attach ? t += "ATTACH;VALUE=URI:" + this.data.attach.uri + "\r\n" : "audio" === this.data.type && (t += "ATTACH;VALUE=URI:Basso\r\n"), "display" === this.data.type && this.data.description ? t += "DESCRIPTION:" + (0, Chunk141716.escape)(this.data.description) + "\r\n" : "display" === this.data.type && (t += "DESCRIPTION:" + (0, Chunk141716.escape)(this.event.summary()) + "\r\n"), t += (0, Chunk141716.generateCustomAttributes)(this.data), t += "END:VALARM\r\n"
  }
}