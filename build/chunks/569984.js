...
function Z(e, t) {
  ...
  if (null != t.userStatus)
    for (let a of Object.values(null != (r = null == (n = t.userStatus) ? void 0 : n.progress) ? r : {})) !(0, T.isNil)(a) && A.T.DESKTOP.has(a.eventName) && ((null == (i = a.heartbeat) ? void 0 : i.lastBeatAt) != null ? _.add(e) : (null == (o = a.heartbeat) ? void 0 : o.lastBeatAt) == null && _.delete(e))
}
...
function J(e) {
  ...
  r = !1, o = new Map;
  let s = new Map;
  for (let e of t) o.set(e.id, e), s.set(e.id, (0, w.zi)(e)), e.targetedContent.includes(R.jn.QUEST_BAR) && (0, L.T)({
...
function ev(e) {
  ...
  H(t.questId, {
    userStatus: t
  }), null == t.claimedAt && (p = new Map(p)).delete(t.questId), null == t.enrolledAt && ((E = new Map(E)).delete(t.questId), D.ZP.getState().resetQuest(t.questId));
