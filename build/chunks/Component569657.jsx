...
function y(e) {
  let {
    guild: t
  } = e, n = (0, d.e7)([h.Z], () => h.Z.can(j.Plq.ADMINISTRATOR, t)), l = t.features.has(j.GuildFeatures.PIN_PERMISSION_MIGRATION_COMPLETE), s = t.features.has(j.GuildFeatures.BYPASS_SLOWMODE_PERMISSION_MIGRATION_COMPLETE), [a, o] = i.useState(true), [c, g] = i.useState(true);
...
async function E(e, t) {
  try {
    await b.Z.migratePermissions(e, t)
  } catch (e) {
    m.Z.show({
