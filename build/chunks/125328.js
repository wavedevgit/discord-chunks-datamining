...
module.exports = {
  pack: function(e, s, l) {
    var c, u, d, f = t(l),
      ...
      g = +(e < 0 || 0 === e && 1 / e < 0),
      E = 0;
    for ((e = n(e)) != e || e === 1 / 0 ? (u = +(e != e), c = _) : (d = r(2, -(c = i(a(e) / o))), e * d < 1 && (c--, d *= 2), c + m >= 1 ? e += h / d : e += h * r(2, 1 - m), e * d >= 2 && (c++, d /= 2), c + m >= _ ? (u = 0, c = _) : c + m >= 1 ? (u = (e * d - 1) * r(2, s), c += m) : (u = e * r(2, m - 1) * r(2, s), c = 0)); s >= 8;) f[E++] = 255 & u, u /= 256, s -= 8;
