...
let N = e => {
  let {
    ...
    width: s,
    height: c
  } = (0, o.ZP)(), [p, h] = i.useState(y.hO.INITIAL), N = (0, l.e7)([b.Z], () => b.Z.getRequest(t)), T = (0, l.e7)([d.Z], () => d.Z.getGuild(t)), {
  ...
  let A = i.useCallback(() => {
    ...
    }, w = x(v.intl.format(v.t["9ZezpK"], {
      name: null == j ? void 0 : j.name
    }), A), L = x(v.intl.format(v.t.fJwWVl, {
      name: null == j ? void 0 : j.name
    }), A);
  return (0, r.jsxs)("div", {
    className: C.page,
