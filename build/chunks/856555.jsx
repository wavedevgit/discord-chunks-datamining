...
let b = e => <d.M4{...g({
  ...
  O = e => {
    ...
    return <d.WS defaultCoachmarkAlign={"bottom"} targetElementRef={n} positionControlRef={t} popoutElement={(0, r.jsx)(b, g({}, a))} calculateVisibility={s} spacing={12}>{l}</d.WS>
  },
  E = e => {
    let {
      listScrollerRef: t
  ...
  y = e => {
    var t, n, {
      ...
      l = m(e, ["children"]);
    return <u.x errorSource={"ORBS_SHOP_ONBOARDING_COACHMARK"} renderCustomErrorComponent={() => i}><O{...t = g({}, l), n = n = {
        children: i
