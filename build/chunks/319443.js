...
function z(e) {
  let {
    ...
    onClickBack: a
  } = e, s = (0, o.e7)([y.Z], () => y.Z.getApplication(t)), [d, u] = i.useState(n), p = i.useCallback(() => {
    u(n)
  }, [n]);
  return (0, r.jsxs)("div", {
...
let U = function() {
  ...
  let {
    ...
    $(e), es && ed(), y()
  }, [es, ed, $, y]), ef = i.useCallback(e => (0, T.ph)({
    applicationId: e
  }), []), eb = el || es, ex = i.useCallback(() => {
