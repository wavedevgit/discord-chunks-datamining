...
function U(e) {
  let {
    ...
    onClickBack: a
  } = e, s = (0, o.e7)([O.Z], () => O.Z.getApplication(t)), [d, u] = i.useState(n), p = i.useCallback(() => {
    u(n)
  }, [n]);
  return (0, r.jsxs)("div", {
...
let V = function() {
  ...
  let n = (0, o.e7)([v.default], () => !v.default.isAuthenticated()),
    ...
    Y = (null == V ? void 0 : V.type) === A.m_.CATEGORY ? V.categoryId : void 0,
    {
      applicationId: W,
      section: X
    } = (null == V ? void 0 : V.type) === A.m_.APPLICATION ? V : {},
    {
      query: q,
      categoryId: K
    } = (null == V ? void 0 : V.type) === A.m_.SEARCH ? V : {},
    ...
    $ = i.useMemo(() => J.find(e => e.id === Number(K)), [J, K]),
    {
      ...
      selectedTab: et,
      onSelectTab: en
    } = (0, T.i)(null == Y ? void 0 : Y.toString()),
    [er, ei] = i.useState(!0),
  ...
  }, [el, ea, null == es ? void 0 : es.id]), i.useEffect(() => {
    y.CP()
  }, []), i.useEffect(() => {
    H && y.g5()
  }, [H]), i.useEffect(() => A.aQ.setState({
    lastItem: V
  }), [V]);
  let {
    enabled: ec
    ...
    autoTrackExposure: !0
  }), ed = null != W, eu = (null == V ? void 0 : V.type) === A.m_.SEARCH, {
    searchQuery: ep,
    onSearchTextChange: em,
    onClearSearch: eh,
    onSearchSubmit: eg
  } = (0, N.M)({
    initialQuery: null != q ? q : ""
    ...
    en(e), eu && eh(), k()
  }, [eu, eh, en, k]), eC = i.useCallback(e => (0, L.ph)({
    applicationId: e
  }), []), ej = ed || eu, ey = i.useCallback(() => {
    ...
    t > 0 && (0, E.zZ)(G.rMx.APP_DIRECTORY_PAGE_SCROLLED, {
      scroll_visible_percentile: (t + n) / r,
      current_page: i
    })
  }, 200), eO = i.useCallback((e, t) => {
    a(e), eI({
  ...
  }, [eI, a]), eP = ec ? c.iWm : c.jje;
  return (0, r.jsxs)("div", {
    className: l()(B.outerContainer, {
      [B.loggedOutContainer]: n
    }),
    children: [n ? (0, r.jsx)(F, {}) : null, (0, r.jsxs)("div", {
      ...
      children: [eo ? (0, r.jsxs)(h.a, {
        ...
        children: [!ej && (0, r.jsx)(m.z6, {
          ...
          children: [eu && (0, r.jsx)(m.Cm, {
            ...
            children: null != q && "" !== q ? z.intl.formatToPlainString(z.t.zHdzqa, {
              query: q
            }) : z.intl.formatToPlainString(z.t.Qhj5Bg, {
              categoryName: null != (e = null == $ ? void 0 : $.name) ? e : z.intl.string(z.t.E407b2)
            })
          }), (0, r.jsx)(_.Z, {
            query: ep,
        ...
        children: [!ej && (0, r.jsx)(m.z6, {
          ...
          children: [eu ? (0, r.jsx)(m.Cm, {
            ...
            children: null != q && "" !== q ? z.intl.formatToPlainString(z.t.zHdzqa, {
              ...
              categoryName: null != (t = null == $ ? void 0 : $.name) ? t : z.intl.string(z.t.E407b2)
            })
          }) : (0, r.jsx)(g.Z, {
            tabs: ee,
            selectedTab: et,
      ...
      }) : et === M.GLOBAL_DISCOVERY_APPS_FEATURED_CATEGORY_ID.toString() ? (0, r.jsx)(w.Z, {
