...
let F = function() {
  ...
  let n = (0, s.e7)([v.default], () => !v.default.isAuthenticated()),
    ...
    H = (null == F ? void 0 : F.type) === A.m_.CATEGORY ? F.categoryId : void 0,
    {
      applicationId: Y,
      section: X
    } = (null == F ? void 0 : F.type) === A.m_.APPLICATION ? F : {},
    {
      query: q,
      categoryId: K
    ...
    $ = a.useMemo(() => J.find(e => e.id === Number(K)), [J, K]),
    {
      ...
      selectedTab: et,
      onSelectTab: en
    } = (0, T.i)(null == H ? void 0 : H.toString()),
    [er, ea] = a.useState(!0),
  ...
  let {
    ...
    autoTrackExposure: !0
  }), ed = null != Y, eu = (null == F ? void 0 : F.type) === A.m_.SEARCH, {
    searchQuery: ep,
        ...
        children: [!ej && (0, r.jsx)(m.z6, {
          ...
          children: [eu && (0, r.jsx)(m.Cm, {
            ...
            children: null != q && "" !== q ? z.NW.formatToPlainString(z.t.zHdzqa, {
              ...
              categoryName: null != (e = null == $ ? void 0 : $.name) ? e : z.NW.string(z.t.E407b2)
            })
          }), (0, r.jsx)(_.Z, {
            query: ep,
        ...
        children: [!ej && (0, r.jsx)(m.z6, {
          ...
          children: [eu ? (0, r.jsx)(m.Cm, {
            ...
            children: null != q && "" !== q ? z.NW.formatToPlainString(z.t.zHdzqa, {
              ...
              categoryName: null != (t = null == $ ? void 0 : $.name) ? t : z.NW.string(z.t.E407b2)
            })
          }) : (0, r.jsx)(g.Z, {
            tabs: ee,
            selectedTab: et,
