...
function z(e) {
  let {
    ...
    onClickBack: a
  } = e, o = (0, s.e7)([y.Z], () => y.Z.getApplication(t)), [d, u] = i.useState(n), p = i.useCallback(() => {
    u(n)
  }, [n]);
  return (0, r.jsxs)("div", {
...
let U = function() {
  ...
  let {
    ...
    autoTrackExposure: !0
  }), el = null != F, eo = (null == R ? void 0 : R.type) === E.m_.SEARCH, {
    searchQuery: es,
    ...
    $(e), eo && ed(), y()
  }, [eo, ed, $, y]), ef = i.useCallback(e => (0, A.ph)({
    applicationId: e
  }), []), eb = el || eo, ev = i.useCallback(() => {
