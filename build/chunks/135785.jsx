...
let h = e => {
  ...
  return n = null != f ? f : b ? "always-white" : "text-default", <a.Zbd className={s()(g.container, h, {
      [g.centerText]: b
    })} type={a.Zbd.Types.CUSTOM}>{<a.Mgn size={"custom"} width={20} height={20} color={"currentColor"} className={s()(g.icon, {
        [g.lightThemeColorOnly]: b
      })} />}{<a.Text variant={"text-sm/medium"} color={n}>{j ? p.intl.format(p.t["tYuv+f"], {
