...
function p(e) {
  ...
  return <div className={d.nitroUpsellContainer}>{<a.SrA className={d.nitroWheel} size={"md"} color={l.JX.PREMIUM_TIER_2} />}{<a.Text className={d.nitroText} variant={"text-md/medium"}>{m}</a.Text>}</div>
}