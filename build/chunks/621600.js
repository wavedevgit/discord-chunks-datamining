...
function I(e) {
  ...
  }, C = N(I), P = N(A(h, g), y), R = O(C, P, "RETURN_PREVIOUS_WHEN_CHANGED"), w = a.Z.getChannel(g), D = null != (n = R("channel_flags")) ? n : 0, L = (null != (s = P.channel_flags) ? s : 0) ^ D, x = 0 === (0, l.M1)(L, f.ic.FAVORITED, f.ic.OPT_IN_ENABLED), k = null != (d = null == (t = o.Z.getLastMessage(g)) ? void 0 : t.type) ? d : null;
  r.ZP.trackWithMetadata(c.rMx.NOTIFICATION_SETTINGS_UPDATED, m(p({}, P, i.Z.getStats(h)), {
    location: T,
    guild_id: h,
    channel_id: g,
    update_type: _,
