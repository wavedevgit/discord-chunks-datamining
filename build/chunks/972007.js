...
let u = e => {
  let {
    ...
    selectedUsers: n,
    limit: i
  } = e, u = (0, a.bG)([c.A], () => c.A.getRecipientStatus()), d = (0, a.bG)([c.A], () => c.A.getReferralsRemaining()), [p, m] = r.useState(0), [f, g] = r.useState([]), [_, h] = r.useState(false), [b, A] = r.useState(false), [y, v] = r.useState(new Map);
