...
let _ = e => {
  ...
  return (0, r.jsx)(s.$, {
    ...
    children: (0, r.jsxs)(c.P3F, {
      ...
      onClick: () => {
        S("shop marketing tile", x), u.default.track(f.rMx.COLLECTIBLES_SHOP_ELEMENT_CLICKED, {
      ...
      children: [null != O && (0, r.jsx)(c.IGR, {
        ...
        lineClamp: 4,
        className: i()(m.featuredBlockBodyText, {
          [m.featuredBlockNameplate]: P
        }),
        style: {
          color: null != (a = null == v ? void 0 : v.bannerTextColor) ? a : "white"
        },
        ...
        color: c.Ttl.WHITE,
        onClick: e => {
          S("shop marketing take me there button", x), e.stopPropagation(), u.default.track(f.rMx.COLLECTIBLES_SHOP_ELEMENT_CLICKED, {
            collectibles_shop_session_id: null == T ? void 0 : T.sessionId,
            sku_id: x,
            page_type: "home",
            page_section: null == T ? void 0 : T.pageSection,
