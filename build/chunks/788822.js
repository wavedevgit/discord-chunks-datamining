...
let m = e => {
  ...
  return (0, r.jsx)(o.$, {
    ...
    children: (0, r.jsxs)(s.P3F, {
      ...
      onClick: () => {
        O("shop marketing tile", x), c.default.track(b.rMx.COLLECTIBLES_SHOP_ELEMENT_CLICKED, {
      ...
      children: [null != v && (0, r.jsx)(s.IGR, {
        disableColor: !0,
        text: v,
        className: h.featuredBlockBadge
      }), (0, r.jsxs)("div", {
        className: h.featuredBlockTextContainer,
        children: [false, null != j && (0, r.jsx)(s.X6q, {
          lineClamp: 4,
          className: h.featuredBlockBodyText,
          style: {
            color: null != (i = null == C ? void 0 : C.bannerTextColor) ? i : "white"
          },
        ...
        color: s.Ttl.WHITE,
        onClick: e => {
          O("shop marketing take me there button", x), e.stopPropagation(), c.default.track(b.rMx.COLLECTIBLES_SHOP_ELEMENT_CLICKED, {
            collectibles_shop_session_id: null == P ? void 0 : P.sessionId,
            sku_id: x,
            page_type: "home",
            page_section: null == P ? void 0 : P.pageSection,
