...
function O(e) {
  ...
  let {
    primaryColor: L,
    secondaryColor: D
  } = (0, p.Z)(null != P ? P : S), M = "linear-gradient(45deg, ".concat(L, ", ").concat(D, ")"), U = (0, s.e7)([d.Z], () => d.Z.useReducedMotion), F = l.useRef(!1), B = (0, u.O)(e => {
    if (!1 === F.current && e) {
      var t;
      null == R || null == (t = R.onView) || t.call(R), (0, _.GF)(R.id, R.linkType, R.referrerId, R.activityCustomId), F.current = !0
    }
  }, void 0), G = g.wS && null != A ? (0, i.jsx)(c.zxk, {
  ...
  }) : null, V = null != S, z = null != T && !1 === U, W = V || z, K = 0 === N ? E.bannerAspectRatioBot : E.bannerAspectRatioActivity, Y = l.useRef(null), X = l.useCallback(() => {
    let e = Y.current;
    null != e && ("hidden" === getComputedStyle(e).visibility ? e.pause() : e.play())
  }, []), q = l.useMemo(() => !!z && new URL(T).pathname.endsWith(".gif"), [z, T]), Q = l.useMemo(() => {
    if (null != k) return e => {
        ...
        children: [null != O && (0, i.jsxs)("div", {
          ...
          children: [(0, i.jsxs)(v, {
            ...
            className: o()(E.contentWrapper, {
              [E.contentWrapperClickable]: null != Q
            }),
          ...
          children: Z.map((e, t) => {
            let {
              ...
              submitting: o,
              trackingArea: s
            } = e, u = null != a, d = 0 === t, p = null != r ? (0, i.jsxs)(i.Fragment, {
