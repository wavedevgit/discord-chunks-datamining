...
class T extends(n = o.PureComponent) {
  ...
  renderDefaultForm() {
    ...
    let {
      country: t
    } = this.props, s = !this.hasError("email") && this.hasError("password"), n = (0, r.jsxs)(o.Fragment, {
  ...
  renderDisabledAccount() {
    let {
      authBoxClassName: e,
      theme: t
    } = this.props, s = this.props.loginStatus === P.u34.ACCOUNT_DISABLED, n = s ? v.intl.string(v.t["j3rC+f"]) : v.intl.string(v.t.ZFWofn), o = s ? v.intl.string(v.t["6eNTWV"]) : v.intl.string(v.t.pCBti4);
  ...
  renderResetPhonePassword() {
    ...
    return (0, r.jsx)(h.Z, S({
      resetToken: e,
      onLoginSuccess: e => {
        this.setState({
          errors: {}
        }), u.Z.switchAccountToken(e)
      }
    }, this.props))
  }
  ...
  constructor(e) {
    super(e), N(this, "loginRef", void 0), N(this, "passwordRef", void 0), N(this, "codeRef", void 0), N(this, "handleAuthToken", async e => {
      ...
      try {
        ...
        (0, d.h7j)(e => {
          var t, n;
          return (0, r.jsx)(d.ConfirmModal, (t = S({
      ...
      null == e || e.preventDefault(), u.Z.loginReset(!0), this.setState({
        password: "",
        loginPrefix: "",
        login: "",
        code: "",
