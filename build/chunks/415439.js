...
async function j(e, t, n) {
  ...
  if (null != i) {
    let s, d = null == h.Z.getDMFromUserId(i.id);
    try {
      s = (0, l.R)({
        isContextless: (0, a.Kb)(e)
      }) ? await r.Z.getOrEnsurePrivateChannel(i.id) : await r.Z.openPrivateChannel({
        recipientIds: [i.id],
    ...
    if (f.default.track(E.rMx.APP_DMS_QUICK_LAUNCHER_CLICKED, {
        application_id: e.id,
        is_new_dm: d,
        channel_id: s
...
function C(e, t) {
  s.ZP.updatedUnsyncedSettings({
    showPlayAgain: e
  }), e || f.default.track(E.rMx.APP_DMS_QUICK_LAUNCHER_HIDDEN, {
    source: t
  })
}
