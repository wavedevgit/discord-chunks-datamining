...
e = require.nmd(module),
  function() {
    ...
    function r(e, t) {
      let r, i, o, a, s, l, c, u;
      for ("string" == typeof e && (e = n(e)), r = 3 & e.length, i = e.length - r, o = t, s = 0xcc9e2d51, l = 0x1b873593, u = 0; u < i;) c = 255 & e[u] | (255 & e[++u]) << 8 | (255 & e[++u]) << 16 | (255 & e[++u]) << 24, ++u, o ^= c = (65535 & (c = (c = (65535 & c) * s + (((c >>> 16) * s & 65535) << 16) | 0) << 15 | c >>> 17)) * l + (((c >>> 16) * l & 65535) << 16) | 0, o = (65535 & (a = (65535 & (o = o << 13 | o >>> 19)) * 5 + (((o >>> 16) * 5 & 65535) << 16) | 0)) + 27492 + (((a >>> 16) + 58964 & 65535) << 16);
      switch (c = 0, r) {
        case 3:
          c ^= (255 & e[u + 2]) << 16;
        case 2:
          c ^= (255 & e[u + 1]) << 8;
        case 1:
          c ^= 255 & e[u], o ^= c = (65535 & (c = (c = (65535 & c) * s + (((c >>> 16) * s & 65535) << 16) | 0) << 15 | c >>> 17)) * l + (((c >>> 16) * l & 65535) << 16) | 0
      }
