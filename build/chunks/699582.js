...
function k(e, t, n, r, i) {
  ...
  for (var h = "-u", m = 0, g = r.length; m < g;) {
    ...
    if (c.call(n, "[[" + E + "]]")) {
      var A = n["[[" + E + "]]"]; - 1 !== O.call(b, A) && A !== y && (y = A, v = "")
    }
    p["[[" + E + "]]"] = y, h += v, m++
  }
  if (h.length > 2) var N = o.substring(0, l),
    C = o.substring(l),
    o = N + h + C;
  return p["[[locale]]"] = o, p
}
...
function ep() {
  for (var e = /[.?*+^$[\]\\(){}|-]/g, t = RegExp.lastMatch || "", n = RegExp.multiline ? "m" : "", r = {
      input: RegExp.input
    }, i = new e_, a = !1, o = {}, s = 1; s <= 9; s++) a = (o["$" + s] = RegExp["$" + s]) || a;
  if (t = t.replace(e, "\\$&"), a)
    for (var s = 1; s <= 9; s++) {
      var l = o["$" + s];
...
}), ef.prototype = f(null), e_.prototype = f(null), t.default = o