...
function m() {
  let e = (0, Chunk442837.e7)([Chunk999382.Z], () => Chunk999382.Z.getGuild()),
    ...
    f = Chunk647438.useMemo(() => (null == require ? true : require.status) === 429 ? Chunk388032.intl.string(Chunk163466.default["bFRS/s"]) : null == require ? true : require.getAnyErrorMessage(), [require]),
