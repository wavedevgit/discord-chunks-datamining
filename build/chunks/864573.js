...
function P(e) {
  ...
  let {
    ...
    height: P,
    windowKey: C
  } = e, w = u.Mq[b.yN.BOUNCING_LOGO], E = (0, s.useRef)(null), S = (0, s.useRef)([]), I = (0, g.eR)(x), k = (0, s.useRef)([]), M = (0, i.e7)([d.Z], () => d.Z.getNumPurchasesForItemUpgrade(b.yN.BOUNCING_LOGO, b.uv.BOUNCING_LOGO_MORE_LOGOS)) + 1, W = (0, i.e7)([d.Z], () => d.Z.hasPurchasedUpgrade(b.yN.BOUNCING_LOGO, b.uv.BOUNCING_LOGO_CORNERS)), R = (0, i.e7)([d.Z], () => d.Z.getNumPurchasesForItemUpgrade(b.yN.BOUNCING_LOGO, b.uv.BOUNCING_LOGO_SPEED)), A = (0, i.e7)([d.Z], () => d.Z.hasPurchasedUpgrade(b.yN.BOUNCING_LOGO, b.uv.BOUNCING_LOGO_COLORS)), T = null != (t = b.SZ[R]) ? t : b.SZ["0"], L = a / 1920 * T, B = P / 1080 * T, [D, F] = (0, p.Z)(b.yN.BOUNCING_LOGO), U = (0, s.useRef)(null != (n = D.count) ? n : 0);
  (0, s.useEffect)(() => {
    var e;
    U.current = null != (e = D.count) ? e : 0
  }, [D.count]), (0, m.Z)(O, U.current), (0, s.useEffect)(() => {
    N.onload = () => {
      k.current = v.map(e => (function(e, t) {
        let n = (0, c.oo)(t),
  ...
  let G = (0, s.useCallback)(e => {
      S.current.forEach(t => {
        ...
        let n = t.x <= 0,
          ...
          s = t.y <= 0,
          o = t.y >= P - 53;
        n ? t.directionX = 1 : r && (t.directionX = -1), s ? t.directionY = 1 : o && (t.directionY = -1), (n || r || s || o) && (F({
          count: U.current + 1
        }), A && (t.color = _()))
      })
    }, [A, P, F, L, B, a]),
    ...
    V = (0, s.useCallback)(() => {
      ...
      null != t && (t.clearRect(0, 0, a, P), S.current.forEach(e => {
        let {
          x: n,
          y: r,
          color: s
