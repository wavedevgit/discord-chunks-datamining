...
function x(e) {
  ...
  let {
    ...
    subscriptionGroup: C,
    renewalSkuId: O
  } = e, E = (0, a.y)(n, 100), v = (0, m.KK)(C.flags), S = v ? s.QTo : s.tBG, T = v ? f.intl.string(f.t["46YF2N"]) : f.intl.string(f.t.fFyGiI), N = null == (t = p.metadata) ? void 0 : t.application_subscription_guild_id, I = (0, r.e7)([d.Z], () => v && null != N ? d.Z.getGuild(N) : void 0, [N, v]), y = (0, r.e7)([u.Z], () => {
    if (null != O) return u.Z.get(O)
  }, [O]), A = (0, g.p)(p.currentPeriodEnd);
  return (0, i.jsxs)("div", {
    children: [(0, i.jsxs)("div", {
      className: b.header,
      children: [null != E && (0, i.jsx)(s.Eep, {
        src: E.href,
