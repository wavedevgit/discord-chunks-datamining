...
function _(e) {
  ...
  let {
    ...
    subscriptionGroup: j,
    renewalSkuId: C
  } = e, O = (0, l.y)(n, 100), S = (0, m.KK)(j.flags), v = S ? s.QTo : s.tBG, T = S ? f.intl.string(f.t["46YF2N"]) : f.intl.string(f.t.fFyGiI), I = null == (t = g.metadata) ? void 0 : t.application_subscription_guild_id, N = (0, r.e7)([d.Z], () => S && null != I ? d.Z.getGuild(I) : void 0, [I, S]), y = (0, r.e7)([u.Z], () => {
