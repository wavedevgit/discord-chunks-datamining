...
let E = e => r.useMemo(() => {
  ...
  p = e => {
    let {
      ...
      noticeType: n
    } = e, r = E(n), [a, c] = (0, d.Tt)(t, r, u.R.NOTICE_BAR);
    if (null == a) return null;
    if (a === l.z.NAGBAR_NOTICE_OFFER_EXPIRING) {
      if (n === h.kVF.PREMIUM_TIER_2_TRIAL_ENDING) return (0, i.jsx)(s.Z, {
        dismissCurrentNotice: () => c(u.L.USER_DISMISS),
        subscriptionTier: _.Si.TIER_2
      });
      if (n === h.kVF.PREMIUM_TIER_2_DISCOUNT_ENDING) return (0, i.jsx)(o.Z, {
        dismissCurrentNotice: () => c(u.L.USER_DISMISS),
        subscriptionTier: _.Si.TIER_2
      })
    }
