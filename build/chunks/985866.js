...
function V(e) {
  ...
  let {
  ...
  } = e, l = (0, d.wj)((0, C.ZP)()), p = (0, T.h)({
    location: L.dr.REWARD_CODE_MODAL,
    questConfig: r.config
  }), _ = (0, u.dQu)(c.Z.colors.INTERACTIVE_NORMAL).hex(), f = p ? _ : r.config.colors.primary, m = {
    border: "1px solid ".concat(f),
    background: "\n    linear-gradient(\n      150deg,\n      transparent 68%,\n      ".concat((0, j.aD)(f, .2), " 85%,\n      transparent 100%\n    ),\n    linear-gradient(\n      150deg,\n      transparent 13%,\n      ").concat((0, j.aD)(f, .6), " 44%,\n      transparent 76%\n    ),\n    ").concat(l ? "var(--black)" : "var(--white)", "\n    ")
  }, h = (0, A.B)(r, !1), b = (null == (t = r.userStatus) ? void 0 : t.claimedAt) != null || null != o, {
    header: g,
    subHeader: y
  } = function(e) {
    var t, r, n, o;
    let {
      ...
      claimRewardCopy: l
    } = e, c = (null == (t = a.userStatus) ? void 0 : t.claimedAt) != null || null != s, d = i ? "" : M.intl.string(M.t.UUKbio), u = i ? (0, R.o9)({
      quest: a,
      idx: null != (n = null == s ? void 0 : s.tier) ? n : null == (r = a.userStatus) ? void 0 : r.claimedTier
    }) : null, p = P.r.build(a.config), _ = null != u && null != (o = u.messages.name) ? o : p.defaultRewardName, f = i ? l : p.defaultRewardName;
    return {
...
function z(e) {
  ...
  let {
  ...
  }), A = P.r.build(s.config).rewardPlatforms, N = A.length > 1, [D, U] = o.useState(N ? null : A[0]), z = o.useRef(new i.qA), F = o.useRef(null), [Q, G] = o.useState(null), X = (0, l.e7)([h.Z], () => h.Z.useReducedMotion), H = (0, l.e7)([w.Z], () => w.Z.hidePersonalInformation), {
    ...
    quest: s
  }), et = !0 === j ? (0, B.b)(s) : $, er = N && (null == (t = s.userStatus) ? void 0 : t.claimedAt) == null && null == et, {
    claimCode: en,
    fetchCode: eo,
    hasError: ea,
    setHasError: es
      ...
      children: (0, n.jsxs)(u.Y0X, {
        ...
        children: [(0, n.jsxs)("div", {
          ...
          children: [(0, n.jsx)(u.olH, {
            ...
            children: [ec, ed, ep, ef, em, null != s.config.cosponsorMetadata && null != ex && (0, n.jsxs)("div", {
