...
function U(e) {
  ...
  let {
  ...
  } = e, l = (0, c.wj)((0, C.ZP)()), p = (0, I.h)({
    location: q.dr.REWARD_CODE_MODAL,
    questConfig: r.config
  }), _ = (0, u.dQu)(d.Z.colors.INTERACTIVE_NORMAL).hex(), m = p ? _ : r.config.colors.primary, f = {
    border: "1px solid ".concat(m),
    background: "\n    linear-gradient(\n      150deg,\n      transparent 68%,\n      ".concat((0, O.aD)(m, .2), " 85%,\n      transparent 100%\n    ),\n    linear-gradient(\n      150deg,\n      transparent 13%,\n      ").concat((0, O.aD)(m, .6), " 44%,\n      transparent 76%\n    ),\n    ").concat(l ? "var(--black)" : "var(--white)", "\n    ")
  }, g = (0, B.B)(r, !1), h = (null == (t = r.userStatus) ? void 0 : t.claimedAt) != null || null != o, {
    header: b,
    subHeader: y
  } = function(e) {
    var t, r, n, o;
    ...
    }) : null, p = A.r.build(a.config), _ = null != u && null != (o = u.messages.name) ? o : p.defaultRewardName, m = i ? l : p.defaultRewardName;
    return {
  ...
  return (0, n.jsxs)("div", {
    ...
    children: [(0, n.jsxs)("div", {
      ...
      style: {
        "--custom-reward-tile-border-color": p ? _ : r.config.colors.primary
      },
      children: [x && !w && (0, n.jsx)(u.$jN, {
...
function Q(e) {
  ...
  let {
  ...
  }), B = A.r.build(s.config).rewardPlatforms, N = B.length > 1, [L, z] = o.useState(N ? null : B[0]), Q = o.useRef(new i.qA), F = o.useRef(null), [G, X] = o.useState(null), H = (0, l.e7)([g.Z], () => g.Z.useReducedMotion), V = (0, l.e7)([w.Z], () => w.Z.hidePersonalInformation), {
    ...
    quest: s
  }), et = !0 === O ? (0, P.b)(s) : J, er = N && (null == (t = s.userStatus) ? void 0 : t.claimedAt) == null && null == et, {
    claimCode: en,
    fetchCode: eo,
    hasError: ea,
    setHasError: es
  ...
  let ed = null != el ? (0, n.jsx)(u.X6q, {
    ...
    eu = o.useMemo(() => B.map(e => ({
      label: (0, R.t2)(e),
      value: e
    })), [B]),
    ep = null;
  er && (ep = (0, n.jsxs)(u.xJW, {
      ...
      children: (0, n.jsxs)(u.Y0X, {
        ...
        children: [(0, n.jsxs)("div", {
          ...
          children: [(0, n.jsx)(u.olH, {
            ...
            children: [ed, ec, ep, em, ef, null != s.config.cosponsorMetadata && null != ev && (0, n.jsxs)("div", {
              ...
              children: [(0, n.jsx)("img", {
                ...
                children: y.Z.parse(s.config.cosponsorMetadata.redemptionInstructions, !1, {
                  allowLinks: !0
                })
              })]
            })]
