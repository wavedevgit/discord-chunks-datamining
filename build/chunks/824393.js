...
function L(e) {
  ...
  let {
    ...
    quest: m,
    location: g
  } = e, E = i.useRef(null), [b, y] = i.useState(null), O = i.useRef(new s.qA), v = (0, l.e7)([_.Z], () => _.Z.useReducedMotion), T = (null == (t = m.userStatus) ? void 0 : t.claimedAt) != null, [N, C] = i.useState({
    state: "loading"
  });
  i.useEffect(() => {
    T || (0, I.QB)(m.id, S.y$.CROSS_PLATFORM, g).then(e => {
...
function M(e) {
  ...
  return a.fractionalState === N.a$.NONE ? (0, r.jsx)("div", {
...
function j(e) {
  ...
  let d = o.isFractionalPremiumActive ? C.intl.string(C.t["1ku8i4"]) : C.intl.format(C.t.fI1nLy, {
    helpCenterLink: O.Z.getArticleURL(T.BhN.FRACTIONAL_PREMIUM_ABOUT),
    duration: t
  });
