...
function L(e) {
  ...
  let {
    ...
    quest: m,
    location: g
  } = e, E = i.useRef(null), [b, y] = i.useState(null), O = i.useRef(new s.qA), v = (0, l.e7)([f.Z], () => f.Z.useReducedMotion), S = (null == (t = m.userStatus) ? void 0 : t.claimedAt) != null, [N, C] = i.useState({
    state: "loading"
  });
  i.useEffect(() => {
