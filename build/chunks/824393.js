...
function R(e) {
  ...
  let {
    ...
    quest: p,
    location: j
  } = e, _ = a.useRef(null), [f, g] = a.useState(null), v = a.useRef(new i.qA), L = (0, C.e7)([m.Z], () => m.Z.useReducedMotion), O = (null == (t = p.userStatus) ? void 0 : t.claimedAt) != null, [M, k] = a.useState({
    state: "loading"
  });
  a.useEffect(() => {
    O || (0, N.QB)(p.id, H.y$.CROSS_PLATFORM, j).then(e => {
      if ((null == e ? void 0 : e.claimedAt) != null) return void k({
        state: "claimed",
        entitlements: e
      });
      k({
