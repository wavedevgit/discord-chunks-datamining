...
function k(e) {
  ...
  let {
    ...
    loadingState: E
  } = e, I = null == (t = g.metadata) ? void 0 : t.application_subscription_guild_id, {
    renewalMutations: y,
    planId: D
  } = g, {
    appId: Z,
  ...
  }), et = (0, N.p)(g.currentPeriodEnd), en = 0 === E;
  return (0, r.jsxs)(l.l, {
...
function U(e) {
  ...
  } = (0, m.ZP)(), [x, C] = s.useState(!1), j = (0, g.q)(t.id), S = (0, o.e7)([O.Z], () => O.Z.getParentSKU(i.skuId), [i.skuId]), v = s.useMemo(() => null == S ? [] : (0, y.$)(i.id, S, j.subscriptions), [i.id, j, S]), I = 0 !== v.length, N = async () => {
    try {
      C(!0);
      let {
        subscription: e
