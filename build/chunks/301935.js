...
function L(e) {
  ...
  let {
    ...
    let e, t = O.Z.get(A),
      ...
      l = a && null != E ? C.Z.getGuild(E) : void 0,
      o = (0, N.Jf)(u, n);
...
function V(e) {
  ...
  } = (0, p.ZP)(), [j, C] = s.useState(!1), O = (0, h.q)(t.id), S = (0, o.e7)([v.Z], () => v.Z.getParentSKU(i.skuId), [i.skuId]), T = s.useMemo(() => null == S ? [] : (0, A.$)(i.id, S, O.subscriptions), [i.id, O, S]), I = 0 !== T.length, y = async () => {
    try {
      C(!0);
      let {
        subscription: e
