...
function U(e) {
  ...
  } = (0, m.ZP)(), [x, j] = s.useState(!1), C = (0, g.q)(t.id), S = (0, o.e7)([O.Z], () => O.Z.getParentSKU(i.skuId), [i.skuId]), v = s.useMemo(() => null == S ? [] : (0, y.$)(i.id, S, C.subscriptions), [i.id, C, S]), I = 0 !== v.length, N = async () => {
    try {
      j(!0);
      let {
        subscription: e
