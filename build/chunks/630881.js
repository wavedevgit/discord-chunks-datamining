  ...
  return (() => {
      ...
      L = function() {
        ...
        return Object.defineProperty(t.prototype, "viewModelCount", {
          ...
          if (this.eventCleanup && this.eventCleanup(), !this.shouldDisableRiveListeners) {
            ...
            e && "isTouchScrollEnabled" in e && (r = e.isTouchScrollEnabled), this.eventCleanup = (0, _.registerTouchInteractions)({
              canvas: this.canvas,
    ...
    var k = function() {
        ...
        return Object.defineProperty(e.prototype, "runtimeInstance", {
          ...
          if (t < e.length - 1) {
            var r, i, o, a, s, l, u, d, f, _, p, h, m = this.internalViewModelInstance(e[t]);
