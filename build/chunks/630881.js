              ...
              _drawImageMesh: function(t, r, i, o, s, l, c, d, f, _) {
                ...
                if (console.assert(E <= Math.min(m, p)), console.assert(b <= Math.min(g, h)), !(0 >= E || 0 >= b)) {
                  ...
                  this.H.push(function() {
                    ...
                    let e = u.canvas();
                    e && P.drawImage(e, N, C, y, v, c, d, E, b), P.restore()
                  })
                }
              },
  ...
  return (() => {
    ...
    var k = function() {
        ...
        return Object.defineProperty(e.prototype, "runtimeInstance", {
          ...
          if (t < e.length - 1) {
            var r, i, a, o, s, l, u, d, f, _, p, h, m = this.internalViewModelInstance(e[t]);
