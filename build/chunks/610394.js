  ...
  constructor() {
    N(this, "gpuBoostRequests", new Set), N(this, "isGPUBoosted", !1), N(this, "isDisabledGPUBoost", !1), N(this, "toggleGPUBoost", (e, t) => {
      ...
      try {
        ...
        (null === (n = e.message) || void 0 === n ? void 0 : n.includes("IPC method called after context was released")) && this.resetGPUBoosts(), w.error("Error during GPU boost request flush:", e), $(null != B ? B : m.R2, e)
      }
    })
  }
}
...
class K {
  ...
  setClickZones(e) {
    ...
    try {
      ...
      w.error("Error setting capture zones:", e), $(null != B ? B : m.R2, e)
    }
  }
  clearClickZones() {
...
function er() {
  try {
    ...
    w.error("Error clearing tracked games:", e), $(m.R2, e)
  }
}
...
function ea(e) {
  ...
  try {
    ...
    w.error("Error during overlay lock:", e), $(null != B ? B : m.R2, e)
  }
}

function es(e) {
  let t = d.ZP.getGameForPID(e);
  a.Z.setAssociatedGame(null != B ? B : m.R2, e, t)
}
async function el(e) {
  ...
  try {
    ...
    }), l.Z.window.setBackgroundThrottling(!1), g.ZP.IsHardwareAcceleratedGPUSchedulingEnabled() && j.toggleGPUBoost("HARDWARE_ACCELERATED_GPU_SCHEDULING_ENABLED", !0), j.toggleGPUBoost("OVERLAY_RENDERING", !0), es(e), B = e, (0, m.tB)(e), w.info("Getting Native Handle for pid", e);
...
function ec() {
  ...
  try {
    ...
    w.error("Error destroying overlay window:", e), $(null != B ? B : m.R2, e)
  }
  try {
    l.Z.window.setBackgroundThrottling(!0)
  } catch (e) {
    w.error("Error setting background throttling:", e), $(null != B ? B : m.R2, e)
  }
  eg(), x.clear(), null != B && eu(B), B = null, (0, m.tB)(null != B ? B : m.R2)
}
...
function ed(e) {
  try {
    w.verbose("Refreshing OOP host window for pid ".concat(e)), es(e), x.delete(null != B ? B : m.R2), B = e, (0, m.tB)(null != B ? B : m.R2);
    ...
    w.error("failed to refresh out of process overlay host window", e), $(null != B ? B : m.R2, e)
  }
}
...
function e_() {
  if (null == G ? z.storeClickZones() : z.refreshClickZones(), null != G) {
    ...
    if (e !== F) {
      F = e;
      try {
        "function" == typeof(null == k ? void 0 : k.setLimitedInteraction) ? (w.info("Setting limited interaction", e), k.setLimitedInteraction(e), g.ZP.setFocusable(I.$J, !e)) : w.info("No setLimitedInteraction function found, skipping")
      } catch (e) {
...
let eE = (() => {
  ...
  async function t() {
    ...
    try {
      ...
      null == r || null === (e = r.init) || void 0 === e || e.call(r), r.setCaptureZoneCallback(ef), r.setHostWindowCallbacks(el, ec, ed), r.setFocusCallback(ep), null === (t = r.setFocusLostCallback) || void 0 === t || t.call(r, eh), null === (n = r.setSuccessfullyShownCallback) || void 0 === n || n.call(r, em), k = r, (0, m.vR)(!0), eo(), w.info("OverlayV3 Module Loaded")
    } catch (e) {
      throw w.error("failed loading overlay module", e), (0, m.vR)(!1), e
    }
  }
  return () => (null == e && (e = t()), e)
})();
...
function eC() {
  w.verbose("Maybe Enable Overlay"), ei() ? (eb(E.v.oopEnabled), (0, m.vR)(!0), eE()) : U && eb(!1)
}
