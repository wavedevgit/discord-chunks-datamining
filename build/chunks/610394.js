...
async function ef(e) {
  ...
  try {
    ...
    }), F = null, await (0, I.f)(K), $(e, {
      renderer_started: !0,
      fullscreen_type: await (0, v.hj)(e, 0),
      graphics_info_after: new Date().getTime() - t
    }), s.Z.window.setBackgroundThrottling(!1), h.ZP.IsHardwareAcceleratedGPUSchedulingEnabled() && j.toggleGPUBoost(b.zS.HARDWARE_ACCELERATED_GPU_SCHEDULING_ENABLED, !0), j.toggleGPUBoost(b.zS.OVERLAY_RENDERING, !0), eu(e), Z = e, (0, m.setPID)(e), L.info("Getting Native Handle for pid", e);
    let n = await ed();
    if (null == n) return L.error("Failed to get native handle for pid", e), en(e, Error("Failed to get native handle for pid")), "";
    return L.info("Native Handle for pid ".concat(e, ":"), n), a.Z.updateOverlayState(e, b.mM.OVERLAY_RENDERING), $(e, {
