...
async function ef(e) {
  ...
  try {
    ...
    }), F = null, await (0, I.f)(K), J(e, {
      renderer_started: !0,
      fullscreen_type: await (0, v.hj)(e, 0),
      graphics_info_after: new Date().getTime() - t
    }), s.Z.window.setBackgroundThrottling(!1), h.ZP.IsHardwareAcceleratedGPUSchedulingEnabled() && M.toggleGPUBoost(b.zS.HARDWARE_ACCELERATED_GPU_SCHEDULING_ENABLED, !0), M.toggleGPUBoost(b.zS.OVERLAY_RENDERING, !0), eu(e), Z = e, (0, m.setPID)(e), L.info("Getting Native Handle for pid", e);
    let n = await ed();
    if (null == n) return L.error("Failed to get native handle for pid", e), en(e, Error("Failed to get native handle for pid")), "";
    return L.info("Native Handle for pid ".concat(e, ":"), n), o.Z.updateOverlayState(e, b.mM.OVERLAY_RENDERING), J(e, {
      renderer_started_after: new Date().getTime() - t
    }), eT(!1), O.Z.resetWindowState(), n
  } catch (t) {
  ...
  async function t() {
    ...
    try {
      ...
      throw L.error("failed loading overlay module", e), (0, m.setOutOfProcessSupport)(!1), (0, g.V6)(e, b.gl.OutOfProcess, {
        extra: et(null != Z ? Z : m.UNSET_PID, "module_load")
      }), e
    }
  }
  return () => (null == e && (e = t()), e)
