...
async function e_(e) {
  ...
  try {
    ...
    }), s.Z.window.setBackgroundThrottling(!1), h.ZP.IsHardwareAcceleratedGPUSchedulingEnabled() && j.toggleGPUBoost(b.zS.HARDWARE_ACCELERATED_GPU_SCHEDULING_ENABLED, !0), j.toggleGPUBoost(b.zS.OVERLAY_RENDERING, !0), eu(e), V = e, (0, m.setPID)(e), L.info("Getting Native Handle for pid", e);
    let n = await ed();
    if (null == n) return L.error("Failed to get native handle for pid", e), en(e, Error("Failed to get native handle for pid")), "";
    return L.info("Native Handle for pid ".concat(e, ":"), n), o.Z.updateOverlayState(e, b.mM.OVERLAY_RENDERING), $(e, {
