...
class L {
  constructor() {
    R(this, "gpuBoostRequests", new Set), R(this, "isGPUBoosted", !1), R(this, "isDisabledGPUBoost", !1), R(this, "toggleGPUBoost", (e, t) => {
      ...
      try {
        ...
        (null == (n = e.message) ? void 0 : n.includes("IPC method called after context was released")) && this.resetGPUBoosts(), x.error("Error during GPU boost request flush:", e), eo(null != V ? V : m.UNSET_PID, e)
      }
    })
  }
}
...
function ed() {
  if (!Z) return void ec();
  let e = new Set(u.ZP.getRunningGames().filter(e => u.ZP.getOverlayEnabledForGame(e)).map(e => e.pid));
...
async function ep() {
  ...
  for (let i = 0; i < t; i++) {
    ...
    try {
      var n, r;
      let e = null != (r = await (null === s.Z || void 0 === s.Z || null == (n = s.Z.window) ? void 0 : n.getNativeHandle(N.$J))) ? r : "";
      if ("" !== e) return e
    } catch (e) {
      if (o) throw e;
...
async function eh(e) {
  ...
  try {
    ...
    en(e, r), M(e, "renderer_window_mounted", r), s.Z.window.setBackgroundThrottling(!1), h.ZP.IsHardwareAcceleratedGPUSchedulingEnabled() && G.toggleGPUBoost(y.zS.HARDWARE_ACCELERATED_GPU_SCHEDULING_ENABLED, !0), G.toggleGPUBoost(y.zS.OVERLAY_RENDERING, !0), e_(e), V = e, (0, m.setPID)(e), x.info("Getting Native Handle for pid", e);
    let i = await ep();
...
function em() {
  ...
  eI(), j.clear(), v.Z.resetWindowState(!1), null != V && eg(V), V = null, (0, m.setPID)(null != V ? V : m.UNSET_PID)
}
...
function ey(e) {
  ...
  if (null == e ? $.storeClickZones() : $.refreshClickZones(), e !== F && M(e, "renderer_window_focus_flushed", {
    ...
    if (t !== H) {
      H = t;
      try {
        "function" == typeof(null == B ? void 0 : B.setLimitedInteraction) ? (x.info("Setting limited interaction", t), M(e, "focus_and_interaction_set", {
...
let eA = (() => {
  ...
  async function t() {
    ...
    try {
      ...
      null == r || null == (e = r.init) || e.call(r), r.setCaptureZoneCallback(eb), r.setHostWindowCallbacks(eh, em, eE), r.setFocusCallback(eO), null == (t = r.setFocusLostCallback) || t.call(r, ev), null == (n = r.setSuccessfullyShownCallback) || n.call(r, eS), B = r, (0, m.setOutOfProcessSupport)(!0), ed(), x.info("OverlayV3 Module Loaded"), M((0, m.getPID)(), "overlay_v3_module_loaded")
    } catch (e) {
      throw x.error("failed loading overlay module", e), (0, m.setOutOfProcessSupport)(!1), (0, E.V6)(e, y.gl.OutOfProcess, {
        extra: ei(null != V ? V : m.UNSET_PID, "module_load")
      }), e
    }
  }
  return () => (null == e && (e = t()), e)
...
function ek() {
  x.verbose("Maybe Enable Overlay"), eu() ? (eC(b.v.oopEnabled), (0, m.setOutOfProcessSupport)(!0), eA()) : Z && eC(!1)
}
