...
let j = i.memo(function(e) {
    let {
      channelId: t,
      width: n
    } = e, l = (0, s.e7)([d.Z], () => d.Z.useReducedMotion), a = (0, s.e7)([_.ZP], () => _.ZP.getMostRecentMessageCombo(t), [t]), [u, p] = i.useState(!1);
    i.useEffect(() => {
  ...
  E = i.memo(function(e) {
    let {
      ...
      ref: p,
      width: m = 0
    } = (0, u.ZP)(), [g, C] = i.useState(!1), y = (0, x.Z)(t), E = a && d && l;
    i.useEffect(() => {
      E && C(!0);
