  ...
  renderHeader() {
    ...
    return h = exports.features.has(Chunk981631.oNc.HUB) ? (0, Chunk951288.jsxs)("div", {
      ...
      children: [(0, Chunk951288.jsx)(Chunk481060.X6q, {
        className: a()(Chunk869306.hubInviteTitle, Chunk869306.headerCloseButtonSpacing),
        id: this._headerId,
        ...
        size: "sm",
        query: Chunk990547,
        className: Chunk869306.hubFriendSearch,
      ...
      className: Chunk869306.header,
      children: [(0, Chunk951288.jsx)("div", {
        className: Chunk869306.__invalid_headerTopRow,
        children: (0, Chunk951288.jsx)(Chunk481060.vwX, {
          id: this._headerId,
          tag: "h2",
          className: a()(Chunk10198.marginBottom4, Chunk869306.headerCloseButtonSpacing, Chunk869306.headerText),
          children: module
        })
      }), Chunk442837, (0, Chunk951288.jsx)(Chunk481060.E1j, {
        size: "sm",
        query: Chunk990547,
        className: Chunk869306.searchBar,
        onChange: this.handleQueryChange,
        placeholder: Chunk388032.intl.string(Chunk388032.t.CmSHY2),
        autoFocus: true,
        onClear: this.handleClearSearch
