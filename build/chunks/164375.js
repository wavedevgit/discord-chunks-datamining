...
let p = e => {
    ...
    return i && o ? (0, s.jsxs)(s.Fragment, {
      children: [m.NW.string(m.t.xbRNIy), (0, s.jsx)("br", {}), m.NW.string(m.t["Bp2/np"])]
    }) : i ? (0, s.jsxs)(s.Fragment, {
      children: [m.NW.format(m.t.iKtixc, {
        n: t
      }), (0, s.jsx)("br", {}), m.NW.string(m.t.SN1hrq)]
    }) : o ? (0, s.jsxs)(s.Fragment, {
      children: [m.NW.format(m.t["6IRwub"], {
        n: n
      }), (0, s.jsx)("br", {}), m.NW.string(m.t["6AKLRk"])]
    }) : null
  },
  x = e => {
    let {
      ...
      blockedUserIds: n,
      ignoredUserIds: i
    } = e, r = a.Z.getChannel(t), c = n.length > 0, d = i.length > 0, l = [{
      icon: (0, s.jsx)("div", {
        className: f.icon,
...
function N(e) {
  ...
  return i.useEffect(() => {
    ...
    onDismissAndStay: () => {
      a(), (0, d.O)(t), c.default.track(h.rMx.GDM_BLOCKED_USER_WARNING_ENGAGEMENT, {
    ...
    onDismissAndLeave: () => {
      a(), (0, d.O)(t), r.Z.closePrivateChannel(t, !0, !0), c.default.track(h.rMx.GDM_BLOCKED_USER_WARNING_ENGAGEMENT, {
