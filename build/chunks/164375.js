...
function N(e) {
  ...
  return s.useEffect(() => {
    ...
    onDismissAndStay: () => {
      o(), (0, u.O)(t), c.default.track(f.rMx.GDM_BLOCKED_USER_WARNING_ENGAGEMENT, {
    ...
    onDismissAndLeave: () => {
      o(), (0, u.O)(t), a.Z.closePrivateChannel(t, !0, !0), c.default.track(f.rMx.GDM_BLOCKED_USER_WARNING_ENGAGEMENT, {
