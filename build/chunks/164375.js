...
let p = e => {
    ...
    return i && r ? (0, s.jsxs)(s.Fragment, {
      ...
      children: [h.NW.format(h.t.iKtixc, {
        n: t
      }), (0, s.jsx)("br", {}), h.NW.string(h.t.SN1hrq)]
    }) : r ? (0, s.jsxs)(s.Fragment, {
      children: [h.NW.format(h.t["6IRwub"], {
        n: n
      }), (0, s.jsx)("br", {}), h.NW.string(h.t["6AKLRk"])]
    }) : null
  },
  x = e => {
    let {
      ...
      blockedUserIds: n,
      ignoredUserIds: i
    } = e, o = a.Z.getChannel(t), c = n.length > 0, d = i.length > 0, l = [{
      icon: (0, s.jsx)("div", {
        className: f.icon,
...
function N(e) {
  ...
  return i.useEffect(() => {
    ...
    onDismissAndStay: () => {
      a(), (0, d.O)(t), c.default.track(m.rMx.GDM_BLOCKED_USER_WARNING_ENGAGEMENT, {
    ...
    onDismissAndLeave: () => {
      a(), (0, d.O)(t), o.Z.closePrivateChannel(t, !0, !0), c.default.track(m.rMx.GDM_BLOCKED_USER_WARNING_ENGAGEMENT, {
