...
function G(e) {
  ...
  let {
    message: n,
    compact: l
  } = e, a = S.default.getUser((0, E.Sw)(n)), o = null == (t = I.Z.getBasicChannel(n.channel_id)) ? void 0 : t.guild_id, c = null != o && null != a ? j.ZP.getMember(o, a.id) : null, {
    avatarSrc: u,
...
function V(e) {
  ...
  let {
    ...
    raidType: g,
    resolvedReason: _
  } = (0, E.FL)(n), v = (0, p.e7)([I.Z], () => I.Z.getChannel(n.channel_id), [n.channel_id]), O = null != (t = null == v ? void 0 : v.guild_id) ? t : null, {
    shouldShowIncidentActions: x
  } = (0, h.mI)(O), y = (0, N.sR)(n.author.id, n.channel_id), j = i.useCallback(() => {
