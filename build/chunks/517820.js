...
function H(e) {
  ...
  let {
    message: n,
    compact: o
  } = e, a = N.default.getUser((0, b.Sw)(n)), s = null == (t = S.Z.getBasicChannel(n.channel_id)) ? void 0 : t.guild_id, c = null != s && null != a ? A.ZP.getMember(s, a.id) : null, {
    avatarSrc: u,
...
function W(e) {
  ...
  let {
    message: n,
    compact: o
  } = e, a = null == (t = S.Z.getBasicChannel(n.channel_id)) ? void 0 : t.guild_id, {
    raidDatetime: s,
    decisionId: c,
...
function K(e) {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      className: a()(M.centeredRowContainer, M.cardFooter, {
        [M.compact]: t
      }),
      children: s
    })]
