...
function H(e) {
  ...
  let {
    ...
    raidType: _,
    resolvedReason: g
  } = (0, E.FL)(n), O = (0, p.e7)([I.Z], () => I.Z.getChannel(n.channel_id), [n.channel_id]), y = null != (t = null == O ? void 0 : O.guild_id) ? t : null, {
    shouldShowIncidentActions: v
  } = (0, h.mI)(y), x = (0, N.sR)(n.author.id, n.channel_id), j = i.useCallback(() => {
