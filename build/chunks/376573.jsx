/** Chunk was on 66050 **/
/** chunk id: 376573, original params: e,t,r (module,exports,require) **/
require.d(exports, {
  default: () => d
});
...
function d(e) {
  ...
  return <c.v2r navId={"guild-shop-context"} aria-label={f.intl.string(f.t.g3KvYG)} onClose={i.Zy} onSelect={r}><c.kSQ><c.sNh id={"role-subscription-copy-link"} label={f.intl.string(f.t.WqhZsr)} action={() => {
          var e, r;
