/** Chunk was on web.js **/
/** chunk id: 394839, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  A: () => D
}), require("./896048.js");
...
let y = 4,
  O = Math.round((Chunk838541.Rk - y) / 2);
...
function P(e) {
  let {
    ...
    footer: o,
    displayGridItem: l
  } = e, c = t.item.type, u = b(g({}, t, "IMAGE" === c && R(t.className), "VIDEO" === c && w(t.className)), {
    displayGridItem: l,
