...
function T(e) {
  let {
    ...
    onClose: l,
    guildId: T
  } = e, _ = (0, d.Dt)(), D = (0, a.e7)([v.Z], () => v.Z.getGuild(T)), G = (0, Z.Z)(null == D ? void 0 : D.id), L = (0, O.ZP)(T), R = r.useRef(m.ZP.ackMessageId(T, w.W.GUILD_EVENT)), M = (0, E.Z)();
  return r.useEffect(() => {
    ...
    children: [(0, i.jsxs)(c.xBx, {
        ...
        children: [(0, i.jsx)("div", {
          ...
          onClick: () => {
            (0, c.ZDy)(async () => {
              let {
                default: e
              } = await Promise.all([t.e("71418"), t.e("49049"), t.e("82758"), t.e("61"), t.e("76010")]).then(t.bind(t, 779250));
              return n => {
                var t, r;
      ...
      className: S.content,
      "data-migration-pending": !0,
      children: L.length > 0 ? L.map(e => (0, i.jsx)(P.Z, {
        guildEvent: e,
        guildId: T,
        onActionTaken: l,
