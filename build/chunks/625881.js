...
let j = function(e) {
  let {
    ...
    onConfirm: j,
    userDiscountOffer: E
  } = e, [O, P] = r.useState(!1), [v, N] = r.useState(!1), I = async e => {
    try {
      N(!0), P(!1), await o.tn.post({
    ...
    N(!1)
  }, T = (0, u.ZP)(), S = (0, l.wj)(T) ? g : C, R = (0, _._)(t, b.Xh.PREMIUM_MONTH_TIER_2, E), w = (0, m.aS)(b.Xh.PREMIUM_MONTH_TIER_2, !1, !1, {
    currency: t.currency,
