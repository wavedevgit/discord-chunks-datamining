...
let E = function(e) {
  let {
    ...
    onConfirm: E,
    userDiscountOffer: O
  } = e, [P, g] = i.useState(!1), [v, N] = i.useState(!1), I = async e => {
    try {
      N(!0), g(!1), await o.tn.post({
    ...
    N(!1)
  }, T = (0, u.ZP)(), S = (0, l.wj)(T) ? C : j, R = (0, _._)(t, b.Xh.PREMIUM_MONTH_TIER_2, O), w = (0, m.aS)(b.Xh.PREMIUM_MONTH_TIER_2, !1, !1, {
    currency: t.currency,
