...
ei.Header = er, ei.Body = e => {
  ...
  } = e, h = l.useRef(null), f = (0, S.ZP)(a, !0);
  return (0, i.jsx)($, {
    children: (0, i.jsxs)("div", {
        ...
        children: (0, i.jsxs)("div", {
          ...
          children: [null != r.getIconURL(32) ? (0, i.jsx)("img", {
            ...
            children: (0, i.jsx)("div", {
              ...
              style: {
                fontSize: null != (n = q[r.acronym.length]) ? n : q[q.length - 1]
              },
              children: r.acronym
            })
          }), (0, i.jsx)("div", {
  ...
  let {
    ...
    onPreviewClick: o,
    guildId: c
  } = e, d = (0, s.e7)([k.Z], () => k.Z.getChannel(a.channelId)), [p, h] = (0, A.wq)(d), f = (0, i.jsxs)(u.P3F, {
    onClick: p ? o : void 0,
  ...
  let {
    ...
    participants: a,
    activityUser: o
  } = e, [c, d] = l.useState(null), p = t.application_id;
  l.useEffect(() => {
    null != p && (0, B.hR)(p, ["embedded_background"]).then(e => {
      let [t] = e;
      return d(t)
    })
  }, [p]);
  let f = (0, s.Wu)([M.default, D.default], () => Array.from(a).map(e => D.default.getId() === e ? null : M.default.getUser(e)).filter(V.lm)),
    m = (0, h.O)(),
    {
  ...
  let O = null != t.created_at && t.created_at > 0 ? {
      start: t.created_at
    } : void 0,
    y = (0, B.xF)(E.id, c, 300);
  return (0, i.jsxs)($, {
