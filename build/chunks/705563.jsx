...
function v(e) {
  ...
  return <div className={g.buttons}>{<o.ua7 text={m.intl.string(m.t.cdPGbG)} shouldShow={N}>{e => (0, r.jsx)(o.zxk, O(b({
        variant: "active",
        size: "sm",
        ...
        onClick: C,
        disabled: N
      }))}</o.ua7>}{<o.zxk variant={"critical-primary"} size={"sm"} text={m.intl.string(m.t.hDtbs7)} onClick={R} disabled={P || v.applicationStatus !== _.wB.SUBMITTED} />}{n && <o.zxk onClick={w} variant={"secondary"} size={"sm"} text={m.intl.string(m.t.iXAna2)} />}{E && <a.ZP.Divider />}</div>
}