...
function b(e) {
  ...
  return (0, r.jsx)(O, {
    ...
    header: g.NW.formatToPlainString(f.Z["Zg/m9P"], {
      perkName: n.title
    }),
    content: g.NW.formatToPlainString(f.Z["1EGXSE"], {
      perkName: n.title
    }),
...
function _(e) {
  ...
  return (0, r.jsx)(O, {
    ...
    content: g.NW.formatToPlainString(f.Z.IJP4YG, {
      perks: l
    }),
    buttonCTA: g.NW.string(g.t.RzWDqa),
    onClick: () => (0, u.Z)(t),
...
function y(e) {
  ...
  return (0, r.jsx)(O, {
    ...
    header: g.NW.formatToPlainString(f.Z.LmpChI, {
      guildName: o
    }),
    content: n.length > 1 ? g.NW.formatToPlainString(f.Z.wcQOqK, {
      perks: c
    }) : g.NW.formatToPlainString(f.Z.ZF8NT0, {
      perk: c
    }),
...
function v(e) {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [Array.isArray(t) && 1 === t.length ? (0, r.jsx)(d.m, {
      className: m.image,
      powerup: t[0]
    }) : (0, r.jsx)(d.g, {
      className: m.image
