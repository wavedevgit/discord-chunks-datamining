...
function b(e) {
  ...
  return (0, r.jsx)(O, {
    ...
    header: f.NW.formatToPlainString(h.Z["Zg/m9P"], {
      perkName: n.title
    }),
    content: f.NW.formatToPlainString(h.Z["1EGXSE"], {
      perkName: n.title
    }),
...
function _(e) {
  ...
  return (0, r.jsx)(O, {
    ...
    content: f.NW.formatToPlainString(h.Z.IJP4YG, {
      perks: l
    }),
    buttonCTA: f.NW.string(f.t.RzWDqa),
    onClick: () => (0, u.Z)(t),
...
function y(e) {
  ...
  return (0, r.jsx)(O, {
    ...
    header: f.NW.formatToPlainString(h.Z.LmpChI, {
      guildName: o
    }),
    content: n.length > 1 ? f.NW.formatToPlainString(h.Z.wcQOqK, {
      perks: c
    }) : f.NW.formatToPlainString(h.Z.ZF8NT0, {
      perk: c
    }),
