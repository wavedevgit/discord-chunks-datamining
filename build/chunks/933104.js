...
function h(e) {
  ...
  return (0, r.jsx)(g, {
    ...
    content: i >= n.cost ? u.NW.formatToPlainString(c.Z.h8CFJi, {
      boostCount: i,
      perkName: n.title
    }) : u.NW.formatToPlainString(c.Z["+DlJ7+"], {
      perkName: n.title
    }),
...
function f(e) {
  ...
  return (0, r.jsx)(g, {
    ...
    header: u.NW.formatToPlainString(c.Z["Zg/m9P"], {
      perkName: n.title
    }),
    content: u.NW.formatToPlainString(c.Z["1EGXSE"], {
      perkName: n.title
    }),
