/** Chunk was on web.js **/
/** chunk id: 460166, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  Z: () => s
});
var Chunk822632 = require("./822632.js"),
  ...
  Chunk245170 = require("./245170.js"),
  Chunk657063 = require("./657063.js");
let s = {
  read: c
};
...
function Z(e, t) {
  let n = B(e);
  true !== e.value["rdf:Description"] && (e = e.value["rdf:Description"]), (0, r.wB)(n, B(e), F(e));
  let i = V(e);
  return {
    value: i,
    attributes: n,
