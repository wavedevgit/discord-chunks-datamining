/** Chunk was on web.js **/
/** chunk id: 955047, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  G: () => s,
  J: () => l
});
var Chunk346417 = require("./346417.js"),
  Chunk507310 = require("./507310.js");
...
class l extends Chunk507310.V {
  *[Symbol.iterator]() {
  ...
  getFirstKey() {
    var e, t;
    return null != (t = null == (e = (0, Chunk346417.l8)(this.body.childNodes)) ? true : module.key) ? exports : null
  }
  getLastKey() {
    var e, t;
    return null != (t = null == (e = (0, Chunk346417.s)(this.body.childNodes)) ? true : module.key) ? exports : null
  }
  getItem(e) {
    var t;
