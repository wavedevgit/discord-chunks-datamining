  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: [t, u, o ? (0, r.jsx)(s.zx, {
        ...
        color: s.zx.Colors.PRIMARY,
        onClick: d,
        children: [f.intl.string(f.t["0GWElZ"]), (0, r.jsx)(a.ZSh, {
          size: "xxs",
          color: "currentColor"
        })]
      })]
...
function _(e) {
  let {
    ...
    onEdit: n,
    disableGoodStatus: s
  } = e, d = (0, l.Wu)([o.Z], () => o.Z.getDefaultChannelIds(t)), u = (0, l.e7)([o.Z], () => (0, c.kl)(t, o.Z.getDefaultChannelIds(t), o.Z.getOnboardingPrompts(t)).length), m = i.useMemo(() => new Set(d), [d]), [, j] = (0, c.VF)(t, m), _ = j.length, v = b(t), O = (0, g.O4)(t), C = (0, l.e7)([o.Z], () => o.Z.isAdvancedMode(t)), y = C ? f.intl.formatToPlainString(f.t.nHwnLC, {
...
function v(e) {
  let {
    ...
    onEdit: n,
    disableGoodStatus: i
  } = e, s = (0, l.Wu)([o.Z], () => o.Z.getDefaultChannelIds(t)), d = (0, l.Wu)([o.Z], () => o.Z.getOnboardingPrompts(t)), u = d.length, [m, g] = (0, c.dF)(t, d, s), p = m.length, b = m.length + g.length, j = p / b * 100, _ = (0, l.e7)([o.Z], () => o.Z.isAdvancedMode(t)), v = u > 0, O = "none";
  return v && (j >= 85 && !i ? O = "good" : j < 85 && (O = "warning")), (0, r.jsx)(x, {
...
function O(e) {
  let {
    ...
    onEdit: n,
    disableGoodStatus: s
  } = e, c = (0, l.e7)([m.Z], () => m.Z.getSettings()), g = (0, l.e7)([o.Z], () => o.Z.getEnabled(t)), p = (0, d.uo)(c), b = c.enabled, j = i.useCallback(() => {
    (0, u.To)(t, !b)
  }, [t, b]), _ = !(0, d.av)(c), v = "none";
  _ && (p && !s ? v = "good" : p || (v = "required"));
  let O = f.intl.string(f.t.GMOwOD);
  p ? _ || (O = f.intl.string(f.t.wHOoyM)) : O = f.intl.string(f.t.wXFbgY);
  let C = null;
  return _ && g && (C = (0, r.jsx)(a.rsf, {
