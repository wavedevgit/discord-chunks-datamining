  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: [t, d, a ? (0, r.jsx)(l.zxk, {
        ...
        color: l.zxk.Colors.PRIMARY,
        onClick: c,
        children: [p.NW.string(p.t["0GWElZ"]), (0, r.jsx)(l.ZSh, {
          size: "xxs",
          color: "currentColor"
        })]
      })]
...
function j(e) {
  let {
    ...
    onEdit: n,
    disableGoodStatus: c
  } = e, d = (0, s.Wu)([a.Z], () => a.Z.getDefaultChannelIds(t)), u = (0, s.e7)([a.Z], () => (0, o.kl)(t, a.Z.getDefaultChannelIds(t), a.Z.getOnboardingPrompts(t)).length), b = i.useMemo(() => new Set(d), [d]), [, j] = (0, o.VF)(t, b), N = j.length, _ = x(t), v = (0, m.O4)(t), O = (0, s.e7)([a.Z], () => a.Z.isAdvancedMode(t)), C = O ? p.NW.formatToPlainString(p.t.nHwnLC, {
...
function N(e) {
  let {
    ...
    onEdit: n,
    disableGoodStatus: i
  } = e, c = (0, s.Wu)([a.Z], () => a.Z.getDefaultChannelIds(t)), d = (0, s.Wu)([a.Z], () => a.Z.getOnboardingPrompts(t)), u = d.length, [m, g] = (0, o.dF)(t, d, c), x = m.length, b = m.length + g.length, j = x / b * 100, N = (0, s.e7)([a.Z], () => a.Z.isAdvancedMode(t)), _ = u > 0, v = "none";
...
function _(e) {
  let {
    ...
    onEdit: n,
    disableGoodStatus: o
  } = e, m = (0, s.e7)([u.Z], () => u.Z.getSettings()), g = (0, s.e7)([a.Z], () => a.Z.getEnabled(t)), x = (0, c.uo)(m), b = m.enabled, j = i.useCallback(() => {
    (0, d.To)(t, !b)
  }, [t, b]), N = !(0, c.av)(m), _ = "none";
  N && (x && !o ? _ = "good" : x || (_ = "required"));
  let v = p.NW.string(p.t.GMOwOD);
  x ? N || (v = p.NW.string(p.t.wHOoyM)) : v = p.NW.string(p.t.wXFbgY);
  let O = null;
  return N && g && (O = (0, r.jsx)(l.rsf, {
