...
class ev extends d.Z {
  ...
  constructor({
    ...
    let _ = x.Z.supports(es.AN.FIRST_FRAME_CALLBACK) && x.Z.supports(es.AN.REMOTE_USER_MULTI_STREAM);
    if (i === es.Yn.DEFAULT) {
      let t = (null == (d = L.Z.getChannel(this.channelId)) ? void 0 : d.type) === eo.d4z.GUILD_STAGE_VOICE;
      this._localMediaSinkWantsManager = new Q.ZP(e, t, _), this._localMediaSinkWantsManager.on(Q.ai.Update, e => {
