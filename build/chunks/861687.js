...
class eI extends Chunk47770.Z {
  ...
  _chooseExperiments(e) {
    ...
    this.context === el.Yn.DEFAULT && (0, I.f)("RtcConnection").enabled && t.push("audio_transport_cc"), N.Z.getCurrentConfig({
  ...
  _handleDisconnect(e, t, n, r) {
    ...
    if (this.state !== es.hes.DISCONNECTED) {
      ...
      M.Z.getMediaEngine().getCodecSurvey().then(e => {
        let n = JSON.parse(e);
      ...
      let n = U.Z.shouldIncludePreferredRegion() ? U.Z.getPreferredRegion() : null,
        i = M.Z.getSettings(),
        o = x.Z.getChannel(this.channelId),
      ...
      })(), w.Z.getKrispModel(), M.Z.getKrispEnableStats() ? M.Z.getMediaEngine().getNoiseCancellationStats() : Promise.resolve(null)]).then(e => {
        let [{
  ...
  _handleReady(e, t, n, r, i, o, a) {
    ...
    let b = ["unk"];
    this.context === el.Yn.STREAM && (b.push("nvRelaxRc=250"), b.push("nvNewPresets")), h.setVideoEncoderExperiments(b.join(",")), h.on(f.Sh.Speaking, (e, t, n) => {
    ...
    }), h.on(f.Sh.Ping, this._handlePing.bind(this)), h.on(f.Sh.PingTimeout, this._handlePingTimeout.bind(this)), h.on(f.Sh.OutboundLossRate, this._handleOutboundLossRate.bind(this)), h.on(f.Sh.SoundshareTrace, this._handleSoundshareTrace.bind(this)), h.on(f.Sh.LocalVideoDisabled, this._handleLocalVideoDisabled.bind(this)), h.on(f.Sh.Stats, z.Z.create()), h.on(f.Sh.RemoteStreamsReady, this._handleRemoteStreamsReady.bind(this)), h.on(f.Sh.UsersMerged, this.handleUsersMerged.bind(this)), h.on(f.Sh.NoiseCancellationError, e => {
  ...
  _handleMLSFailure(e, t) {
    ...
    null != r ? (r.count++, null != this._mlsSessionResetStartTime && r.countDuringReset++) : this._mlsFailures.set(n, {
      source: e,
      reason: t,
      count: 1,
  ...
  _trackMLSFailures(e) {
    ...
    for (let {
      ...
      of this._mlsFailures.values()) B.default.track(es.rMx.MLS_FAILURES, ef(eu({}, this._getAnalyticsProperties()), {
      media_session_id: n,
      parent_media_session_id: this.parentMediaSessionId,
      failure_source: e,
      failure_reason: i,
