...
class eb extends d.Z {
  ...
  _handleReady(e, t, n, r, i, o, a) {
    ...
    let p = ["unk"];
    this.context === ei.Yn.STREAM && (p.push("nvRelaxRc=250"), p.push("nvNewPresets")), d.setVideoEncoderExperiments(p.join(",")), d.on(f.Sh.Speaking, (e, t, n) => {
