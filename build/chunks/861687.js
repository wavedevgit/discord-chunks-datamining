...
class eI extends Chunk47770.Z {
  get quality() {
    let e = this.getLastPing();
    return this.state !== Chunk981631.hes.RTC_CONNECTED || true === module ? Chunk981631.IE4.UNKNOWN : module > em || null != this._outboundLossRate && this._outboundLossRate > eE ? Chunk981631.IE4.BAD : module > eg || null != this._outboundLossRate && this._outboundLossRate > eb ? Chunk981631.IE4.AVERAGE : Chunk981631.IE4.FINE
  }
  get endpoint() {
  ...
  setNextChannelId(e) {
    ...
    this.logger.info("Updating channel: ".concat(e, "(").concat(n, ")")), w.Z.getCurrentConfig({
  ...
  _chooseExperiments(e) {
    let t = [];
    if (this._recordingEnabled && t.push("connection_log"), j.Z.supports(el.AN.FIXED_KEYFRAME_INTERVAL) && t.push("fixed_keyframe_interval"), 0 !== this._supportedBandwidthEstimationExperiments.length) {
      let e = C.Z.workerExperimentString();
      null != e && t.push(e)
    }
    this.context === el.Yn.DEFAULT && (0, I.f)("RtcConnection").enabled && t.push("audio_transport_cc"), t.push("keyframe_on_join"), R.Z.getCurrentConfig({
  ...
  _handleConnect(e) {
    ...
    this.logger.info("Connected to RTC server."), this._fetchAsyncResourcesPromise.finally(() => {
      e.identify({
        ...
        video: j.Z.supports(el.AN.VIDEO),
  ...
  _handleDisconnect(e, t, n, r) {
    ...
    if (this.state !== es.hes.DISCONNECTED) {
      ...
      if (null != e && this.context === el.Yn.DEFAULT) {
        if (e.stop(), this._sentVideo) {
          e.getOutboundStats().forEach(t => {
            var n;
            (null != (n = t.num_frames) ? n : 0) > 0 && B.default.track(es.rMx.VIDEO_STREAM_ENDED, ef(eu(ef(eu({}, this._getAnalyticsProperties()), {
          ...
          null != t && t.camera_enabled_duration > 0 && B.default.track(es.rMx.VIDEO_CALL_ENDED, ef(eu({}, t), {
            media_session_id: this.getMediaSessionId()
          }))
        }
        e.getInboundParticipants().forEach(t => {
          ...
          (null != (n = null == i ? true : i.num_frames) ? n : 0) > 0 && B.default.track(es.rMx.VIDEO_STREAM_ENDED, eu(ef(eu({}, this._getAnalyticsProperties()), {
            app_hardware_acceleration_enabled: Z.Z.getAppHardwareAccelerationEnabled(),
            media_session_id: this.getMediaSessionId(),
            sender_user_id: t,
            reason: r,
      ...
      j.Z.getMediaEngine().getCodecSurvey().then(e => {
        ...
        B.default.track(es.rMx.VOICE_CODEC_DETECTED, ef(eu({}, n), {
      ...
      let n = U.Z.shouldIncludePreferredRegion() ? U.Z.getPreferredRegion() : null,
        i = j.Z.getSettings(),
        o = L.Z.getChannel(this.channelId),
        a = null == (u = N.Z.getConnectionStats(this.getMediaEngineConnectionId())) || null == (c = u.stats.rtp.outbound.find(e => "audio" === e.type)) ? true : c.sampleRateMismatchPercent,
  ...
  _handleReady(e, t, n, r, i, o, a) {
    var s;
    this.setState(es.hes.RTC_CONNECTING), this.port = n, this._chooseExperiments(null != a ? a : []), 0 === o.length && o.push({
      type: el.Tr.VIDEO,
      rid: "100",
      ssrc: i + 1,
      rtxSsrc: i + 2,
    ...
    let l = j.Z.getMediaEngine(),
      ...
      h = (0, _.zO)(),
      g = l.connect(this.context, this.userId, eu({
        ssrc: i,
        address: t,
        port: n,
        modes: r,
    ...
    this.context === el.Yn.STREAM && (y.push("nvRelaxRc=250"), y.push("nvNewPresets")), g.setVideoEncoderExperiments(y.join(",")), g.on(f.Sh.Speaking, (e, t, n) => {
      ...
      let n = U.Z.shouldIncludePreferredRegion() ? U.Z.getPreferredRegion() : null;
      this.logger.error("Error occurred while connecting to RTC server: ".concat(t)), B.default.track(es.rMx.VOICE_CONNECTION_FAILURE, ef(eu({}, this._getAnalyticsProperties()), {
        hostname: this.hostname,
        port: this.port,
        protocol: this.protocol,
        error: t,
      ...
      if (n === es.hes.RTC_CONNECTING && this.state === es.hes.RTC_DISCONNECTED ? this.reconnect() : this.state === es.hes.NO_ROUTE && (0 === this._backoff.fails && this._handleNoRoute(), this._backoff.fail(this.reconnect)), this.state === es.hes.RTC_CONNECTED) {
        ...
        if (this._connecting) {
          ...
          B.default.track(es.rMx.VOICE_CONNECTION_SUCCESS, eu(ef(eu({}, n), {
            hostname: this.hostname,
            port: this.port,
            protocol: this.protocol,
            ...
            participant_type: this.getVoiceParticipantType(),
            join_voice_id: this.joinVoiceId
          }), this.stateHistory.getVoiceConnectionSuccessStats())), B.default.track(es.rMx.VOICE_CONNECTION_TTC_COLLECTED, {
            ...
            time_3_media_engine_create_native_connection: null == (o = g.transportInfo) ? true : o.createConnectionTime,
            time_4_media_engine_connect_to_socket: null == (a = g.transportInfo) ? true : a.connectTime,
    ...
    }), g.on(f.Sh.Ping, this._handlePing.bind(this)), g.on(f.Sh.PingTimeout, this._handlePingTimeout.bind(this)), g.on(f.Sh.OutboundLossRate, this._handleOutboundLossRate.bind(this)), g.on(f.Sh.SoundshareTrace, this._handleSoundshareTrace.bind(this)), g.on(f.Sh.LocalVideoDisabled, this._handleLocalVideoDisabled.bind(this)), g.on(f.Sh.Stats, z.Z.create()), g.on(f.Sh.RemoteStreamsReady, this._handleRemoteStreamsReady.bind(this)), g.on(f.Sh.UsersMerged, this.handleUsersMerged.bind(this)), g.on(f.Sh.NoiseCancellationError, e => {
  ...
  _handleSpeaking(e, t, n, r) {
    ...
    if (null != i && this.userId !== t) {
      var o;
      r !== el.Dg.NONE && i.createUser(t, n), null == (o = this._localMediaSinkWantsManager) || o.setAudioSSRC(t, n)
    }
  }
  handleFlags(e, t) {
  ...
  _handleVideoStreamId(e) {
    ...
    if (this.emit(q.z.Video, this.guildId, this.channelId, o, a, this.streamServerId), null != a && null == this.getOrCreateVideoQuality() && this.logger.error("_handleVideoStreamId: Unable to create videoQuality."), null != this._videoQuality && this.userId === o && l.forEach(e => {
        var t, n;
  ...
  _handleRemoteStreamsReady(e) {
    ...
    B.default.track(es.rMx.VOICE_CONNECTION_REMOTE_STREAMS_CREATED, ef(eu({}, this._getAnalyticsProperties()), {
      number_of_users: e,
      duration_ms: t
    }))
  }
  ...
  _handleControlPing(e) {
    j.Z.supports(el.AN.NATIVE_PING) || this._handlePing(e)
  }
  _handlePing(e) {
    if (true !== e) {
      for (this._pings.push({
          time: Date.now(),
          value: e
        }); this._pings.length >= ep;) this._pings.shift();
  ...
  _handleClientDisconnect(e) {
    ...
    if (null != s && this.context === el.Yn.DEFAULT) {
      ...
      null != t && n > 0 && (B.default.track(es.rMx.VIDEO_STREAM_ENDED, eu(ef(eu({}, this._getAnalyticsProperties()), {
        app_hardware_acceleration_enabled: Z.Z.getAppHardwareAccelerationEnabled(),
        media_session_id: this.getMediaSessionId(),
        sender_user_id: e,
  ...
  _handleMediaSessionId(e) {
    ...
    B.default.track(es.rMx.MEDIA_SESSION_JOINED, ef(eu({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      raw_thermal_state: t
    })), p.Z.dispatch({
  ...
  _trackSecureFrameTransition(e) {
    ...
    B.default.track(es.rMx.SECURE_FRAMES_TRANSITION, ef(eu({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      sender_user_id: this.userId,
      transition_id: e,
  ...
  _storeSecureFrameNextTransitionData(e) {
    return null == this._secureFramesNextTransitionState && (this._secureFramesNextTransitionState = {
      creationTime: (0, _.zO)()
    }), this._secureFramesNextTransitionState = eu({}, this._secureFramesNextTransitionState, e)
  }
  _storeSecureFrameTransitionData(e, t) {
    let n = this._secureFramesTransitionStates.get(e);
    null == n && (n = this._storeSecureFrameNextTransitionData({}), this._secureFramesNextTransitionState = true), this._secureFramesTransitionStates.set(e, eu({}, n, t)), this._secureFramesMaxConcurrentTransitions = Math.max(this._secureFramesMaxConcurrentTransitions, this._secureFramesTransitionStates.size)
  }
  _handleSecureFramesInit(e) {
    var t, n;
    let r = (0, _.zO)();
    e > 0 ? (this.logger.info("DAVE protocol init with protocol version: ".concat(e)), null == (t = this._connection) || t.prepareSecureFramesEpoch(ey, e, this.trueChannelId), this._sendMLSKeyPackage(), this._storeSecureFrameNextTransitionData({
      initReceivedTime: r,
      initFinishedTime: (0, _.zO)(),
      protocolVersion: e
    })) : null == (n = this._connection) || n.prepareSecureFramesTransition(eO, e, () => {
      let t = false;
      try {
        var n;
  ...
  _handleSecureFramesRosterChange(e, t) {
    ...
    Object.entries(e).forEach(e => {
      let [t, o] = e;
      n.push(ev(t)), null == o || 0 === o.byteLength ? (i++, this._secureFramesRosterMap.delete(ev(t))) : (r++, this._secureFramesRosterMap.set(ev(t), o))
  ...
  constructor({
    ...
    super(), ec(this, "context", true), ec(this, "userId", true), ec(this, "sessionId", true), ec(this, "guildId", true), ec(this, "parentMediaSessionId", true), ec(this, "hostname", true), ec(this, "state", true), ec(this, "_videoQuality", true), ec(this, "_soundshareStats", true), ec(this, "logger", true), ec(this, "streamServerId", true), ec(this, "streamChannelId", true), ec(this, "_channelId", true), ec(this, "_nextChannelId", true), ec(this, "joinVoiceId", true), ec(this, "channelIds", true), ec(this, "_endpoint", true), ec(this, "port", true), ec(this, "token", true), ec(this, "protocol", true), ec(this, "voiceVersion", true), ec(this, "rtcWorkerVersion", true), ec(this, "_socket", true), ec(this, "_backoff", true), ec(this, "_destroyed", true), ec(this, "_pings", true), ec(this, "_pingBadCount", true), ec(this, "_pingTimeouts", true), ec(this, "_mediaSessionId", true), ec(this, "_voiceQuality", true), ec(this, "_voiceQualityPeriodicStatsInterval", true), ec(this, "_voiceQualityPeriodicStatsSequenceId", true), ec(this, "_systemResponsiveness", true), ec(this, "_systemResources", true), ec(this, "_noiseCancellationError", true), ec(this, "_voiceDuration", true), ec(this, "_videoHealthManager", true), ec(this, "_sentVideo", true), ec(this, "_outboundLossRate", true), ec(this, "_recordingEnabled", true), ec(this, "_selectedExperiments", true), ec(this, "_localMediaSinkWantsManager", true), ec(this, "_goLiveQualityManager", true), ec(this, "_remoteVideoSinkWants", true), ec(this, "_connection", true), ec(this, "_mediaEngineConnectionId", true), ec(this, "_createdTime", true), ec(this, "_connectStartTime", true), ec(this, "_connectCompletedTime", true), ec(this, "_rtcConnectionId", true), ec(this, "_connectCount", true), ec(this, "_connected", true), ec(this, "_connecting", true), ec(this, "_encountered_socket_failure", true), ec(this, "_inputDetected", true), ec(this, "_encryptionMode", true), ec(this, "stateHistory", true), ec(this, "_supportedBandwidthEstimationExperiments", true), ec(this, "_bandwidthEstimationExperiment", true), ec(this, "_secureFramesState", true), ec(this, "_userIds", true), ec(this, "_secureFramesRosterMap", new Map), ec(this, "_nextFailureId", 0), ec(this, "_mlsFailures", []), ec(this, "_secureFramesTransitionStates", new Map), ec(this, "_secureFramesNextTransitionState", true), ec(this, "_secureFramesMaxConcurrentTransitions", 0), ec(this, "_secureFramesTransitionPrepareCount", 0), ec(this, "_secureFramesTransitionExecuteCount", 0), ec(this, "_secureFramesLastBecameAloneTime", true), ec(this, "_mlsSessionResetStartTime", true), ec(this, "_numNoiseCancellationChanges", 0), ec(this, "_fetchAsyncResourcesPromise", true), ec(this, "_lastSentSpeakingStatus", true), ec(this, "_lastSentSSRC", true), ec(this, "powerMonitorListener", true), ec(this, "reconnect", () => {
      let e = this._socket;
    ...
    }), ec(this, "_alertMLSFailureDebouced", a()(this._alertMLSFailure, 100)), ec(this, "_handleNetworkOnline", () => {
      ...
      if (null != this._voiceQuality) {
        ...
        if (this.shouldReportPeriodicStats(e))
          for (let t of e) B.default.track(es.rMx.VOICE_QUALITY_PERIODIC_STATS, ef(eu({}, this._getAnalyticsProperties()), {
            media_session_id: this.getMediaSessionId(),
    ...
    } else i === el.Yn.STREAM && (this._goLiveQualityManager = new v.Z(true), this._goLiveQualityManager.on(v.y.RequestedSSRCsUpdate, (e, t, n) => {
      var r;
      null == (r = this._connection) || r.createUser(e, t, n)
