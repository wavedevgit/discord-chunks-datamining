...
n.d(t, {
  Z: () => eI
}), n(35282), n(415506), n(539854), n(457542), n(388685), n(49124);
var r = n(654861),
  i = n.n(r),
  a = n(954955),
  o = n.n(a),
...
class eI extends d.Z {
  ...
  _chooseExperiments(e) {
    ...
    if (k.Z.supports(el.AN.FIXED_KEYFRAME_INTERVAL) && t.push("fixed_keyframe_interval"), 0 !== this._supportedBandwidthEstimationExperiments.length) {
  ...
  _handleDisconnect(e, t, n, r) {
    ...
    this.logger.info("Disconnected from RTC server, clean: ".concat(t, ", code: ").concat(n, ", reason: ").concat(r, ", state: ").concat(this.state)), t || !this._connecting || this._encountered_socket_failure || (B.default.track(es.rMx.VOICE_CONNECTION_SOCKET_FAILURE, e_(eu({}, this._getAnalyticsProperties()), {
      hostname: this.hostname,
    ...
    if (this.state !== es.hes.DISCONNECTED) {
      ...
      if (null != e && this.context === el.Yn.DEFAULT) {
        if (e.stop(), this._sentVideo) {
          e.getOutboundStats().forEach(t => {
            var n;
            (null != (n = t.num_frames) ? n : 0) > 0 && B.default.track(es.rMx.VIDEO_STREAM_ENDED, e_(eu(e_(eu({}, this._getAnalyticsProperties()), {
          ...
          null != t && t.camera_enabled_duration > 0 && B.default.track(es.rMx.VIDEO_CALL_ENDED, e_(eu({}, t), {
            media_session_id: this.getMediaSessionId()
          }))
        }
        e.getInboundParticipants().forEach(t => {
          ...
          (null != (n = null == i ? void 0 : i.num_frames) ? n : 0) > 0 && B.default.track(es.rMx.VIDEO_STREAM_ENDED, eu(e_(eu({}, this._getAnalyticsProperties()), {
            app_hardware_acceleration_enabled: V.Z.getAppHardwareAccelerationEnabled(),
            media_session_id: this.getMediaSessionId(),
            sender_user_id: t,
            reason: r,
      ...
      k.Z.getMediaEngine().getCodecSurvey().then(e => {
        ...
        B.default.track(es.rMx.VOICE_CODEC_DETECTED, e_(eu({}, n), {
      ...
      let n = U.Z.shouldIncludePreferredRegion() ? U.Z.getPreferredRegion() : null,
        ...
        s = e_(eu(e_(eu({}, this._getAnalyticsProperties()), {
          hostname: this.hostname,
          port: this.port,
      ...
      Promise.all([(async () => {
        ...
        B.default.track(es.rMx.VOICE_DISCONNECT, e_(eu({}, s), {
          battery_usage: t,
          krisp_nc_model: n,
  ...
  _handleReady(e, t, n, r, i, a, o) {
    ...
    let l = k.Z.getMediaEngine(),
      ...
      g = (0, f.zO)() - d;
    h.setUseElectronVideo(l.supports(el.AN.ELECTRON_VIDEO)), k.Z.supports(el.AN.IMAGE_QUALITY_MEASUREMENT) && h.setVideoQualityMeasurement("imageQualityWebrtcPsnrDb:5000,imageQualityVmaf_v061:5000,hwdec");
    let b = ["unk"];
    this.context === el.Yn.STREAM && (b.push("nvRelaxRc=250"), b.push("nvNewPresets")), h.setVideoEncoderExperiments(b.join(",")), h.on(_.Sh.Speaking, (e, t, n) => {
      ...
      let n = U.Z.shouldIncludePreferredRegion() ? U.Z.getPreferredRegion() : null;
      this.logger.error("Error occurred while connecting to RTC server: ".concat(t)), B.default.track(es.rMx.VOICE_CONNECTION_FAILURE, e_(eu({}, this._getAnalyticsProperties()), {
        hostname: this.hostname,
        port: this.port,
        protocol: this.protocol,
        error: t,
      ...
      if (n === es.hes.RTC_CONNECTING && this.state === es.hes.RTC_DISCONNECTED ? this.reconnect() : this.state === es.hes.NO_ROUTE && (0 === this._backoff.fails && this._handleNoRoute(), this._backoff.fail(this.reconnect)), this.state === es.hes.RTC_CONNECTED) {
        ...
        if (this._connecting) {
          ...
          B.default.track(es.rMx.VOICE_CONNECTION_SUCCESS, eu(e_(eu({}, n), {
            hostname: this.hostname,
            port: this.port,
            protocol: this.protocol,
    ...
    }), h.on(_.Sh.Ping, this._handlePing.bind(this)), h.on(_.Sh.PingTimeout, this._handlePingTimeout.bind(this)), h.on(_.Sh.OutboundLossRate, this._handleOutboundLossRate.bind(this)), h.on(_.Sh.SoundshareTrace, this._handleSoundshareTrace.bind(this)), h.on(_.Sh.LocalVideoDisabled, this._handleLocalVideoDisabled.bind(this)), h.on(_.Sh.Stats, z.Z.create()), h.on(_.Sh.RemoteStreamsReady, this._handleRemoteStreamsReady.bind(this)), h.on(_.Sh.UsersMerged, this.handleUsersMerged.bind(this)), h.on(_.Sh.NoiseCancellationError, e => {
      this._noiseCancellationError = e
    }), h.on(_.Sh.MLSFailure, this._handleMLSFailure.bind(this)), h.setRemoteVideoSinkWants(this._remoteVideoSinkWants), this._connection = h, this._mediaEngineConnectionId = h.mediaEngineConnectionId
  }
  ...
  _handleRemoteStreamsReady(e) {
    ...
    B.default.track(es.rMx.VOICE_CONNECTION_REMOTE_STREAMS_CREATED, e_(eu({}, this._getAnalyticsProperties()), {
      number_of_users: e,
      duration_ms: t
    }))
  }
  ...
  _handleClientDisconnect(e) {
    ...
    if (null != s && this.context === el.Yn.DEFAULT) {
      ...
      null != t && n > 0 && (B.default.track(es.rMx.VIDEO_STREAM_ENDED, eu(e_(eu({}, this._getAnalyticsProperties()), {
        app_hardware_acceleration_enabled: V.Z.getAppHardwareAccelerationEnabled(),
        media_session_id: this.getMediaSessionId(),
        sender_user_id: e,
  ...
  _handleMediaSessionId(e) {
    ...
    B.default.track(es.rMx.MEDIA_SESSION_JOINED, e_(eu({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      raw_thermal_state: t
    })), p.Z.dispatch({
  ...
  _trackSecureFrameTransition(e) {
    ...
    B.default.track(es.rMx.SECURE_FRAMES_TRANSITION, e_(eu({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      sender_user_id: this.userId,
      transition_id: e,
  ...
  _handleMLSPrepareCommitTransition(e, t) {
    ...
    null == (n = this._connection) || n.prepareMLSCommitTransition(e, t, (n, i, a) => {
      n ? (this._trackMLSFailures({
        recovered: !0
      }), this._mlsSessionResetStartTime = void 0, this._handleSecureFramesRosterChange(a, e), this._maybeSendSecureFramesTransitionReady(e)) : (this.logger.warn("Failed to process MLS commit for transition ID ".concat(e)), this._mlsSessionResetStartTime = (0, f.zO)(), this._flagMLSInvalidCommitWelcome(e), this._handleSecureFramesInit(i)), this._storeSecureFrameTransitionData(e, {
        protocolVersion: i,
  ...
  _handleMLSWelcome(e, t) {
    ...
    null == (n = this._connection) || n.processMLSWelcome(e, t, (n, i, a) => {
      n ? (this._trackMLSFailures({
        recovered: !0
      }), this._mlsSessionResetStartTime = void 0, this._handleSecureFramesRosterChange(a, e), this._maybeSendSecureFramesTransitionReady(e)) : (this._mlsSessionResetStartTime = (0, f.zO)(), this._flagMLSInvalidCommitWelcome(e), this._sendMLSKeyPackage()), this._storeSecureFrameTransitionData(e, {
        protocolVersion: i,
  ...
  _trackMLSFailures(e) {
    let {
      recovered: t
    } = e, n = this.getMediaSessionId(), r = null != this._mlsSessionResetStartTime ? (0, f.zO)() - this._mlsSessionResetStartTime : void 0;
    for (let {
        source: e,
        reason: i,
        count: a,
      ...
      of this._mlsFailures.values()) B.default.track(es.rMx.MLS_FAILURES, e_(eu({}, this._getAnalyticsProperties()), {
      media_session_id: n,
      parent_media_session_id: this.parentMediaSessionId,
      failure_source: e,
      failure_reason: i,
  ...
  constructor({
    ...
    super(), ec(this, "context", void 0), ec(this, "userId", void 0), ec(this, "sessionId", void 0), ec(this, "guildId", void 0), ec(this, "parentMediaSessionId", void 0), ec(this, "hostname", void 0), ec(this, "state", void 0), ec(this, "_videoQuality", void 0), ec(this, "_soundshareStats", void 0), ec(this, "logger", void 0), ec(this, "streamServerId", void 0), ec(this, "streamChannelId", void 0), ec(this, "_channelId", void 0), ec(this, "channelIds", void 0), ec(this, "_endpoint", void 0), ec(this, "port", void 0), ec(this, "token", void 0), ec(this, "protocol", void 0), ec(this, "voiceVersion", void 0), ec(this, "rtcWorkerVersion", void 0), ec(this, "_socket", void 0), ec(this, "_backoff", void 0), ec(this, "_destroyed", void 0), ec(this, "_pings", void 0), ec(this, "_pingBadCount", void 0), ec(this, "_pingTimeouts", void 0), ec(this, "_mediaSessionId", void 0), ec(this, "_voiceQuality", void 0), ec(this, "_voiceQualityPeriodicStatsInterval", void 0), ec(this, "_voiceQualityPeriodicStatsSequenceId", void 0), ec(this, "_systemResponsiveness", void 0), ec(this, "_systemResources", void 0), ec(this, "_noiseCancellationError", void 0), ec(this, "_voiceDuration", void 0), ec(this, "_videoHealthManager", void 0), ec(this, "_sentVideo", void 0), ec(this, "_outboundLossRate", void 0), ec(this, "_recordingEnabled", void 0), ec(this, "_selectedExperiments", void 0), ec(this, "_localMediaSinkWantsManager", void 0), ec(this, "_goLiveQualityManager", void 0), ec(this, "_remoteVideoSinkWants", void 0), ec(this, "_connection", void 0), ec(this, "_mediaEngineConnectionId", void 0), ec(this, "_createdTime", void 0), ec(this, "_connectStartTime", void 0), ec(this, "_connectCompletedTime", void 0), ec(this, "_rtcConnectionId", void 0), ec(this, "_connectCount", void 0), ec(this, "_connected", void 0), ec(this, "_connecting", void 0), ec(this, "_encountered_socket_failure", void 0), ec(this, "_inputDetected", void 0), ec(this, "_encryptionMode", void 0), ec(this, "stateHistory", void 0), ec(this, "_supportedBandwidthEstimationExperiments", void 0), ec(this, "_bandwidthEstimationExperiment", void 0), ec(this, "_secureFramesState", void 0), ec(this, "_userIds", void 0), ec(this, "_secureFramesRosterMap", new Map), ec(this, "_mlsFailures", new Map), ec(this, "_secureFramesTransitionStates", new Map), ec(this, "_secureFramesNextTransitionState", void 0), ec(this, "_secureFramesMaxConcurrentTransitions", 0), ec(this, "_secureFramesTransitionPrepareCount", 0), ec(this, "_secureFramesTransitionExecuteCount", 0), ec(this, "_secureFramesLastBecameAloneTime", void 0), ec(this, "_mlsSessionResetStartTime", void 0), ec(this, "_numNoiseCancellationChanges", 0), ec(this, "_fetchAsyncResourcesPromise", void 0), ec(this, "_lastSentSpeakingStatus", void 0), ec(this, "_lastSentSSRC", void 0), ec(this, "powerMonitorListener", void 0), ec(this, "reconnect", () => {
      let e = this._socket;
      ...
      if (null != this._voiceQuality) {
        ...
        if (this.shouldReportPeriodicStats(e))
          for (let t of e) B.default.track(es.rMx.VOICE_QUALITY_PERIODIC_STATS, e_(eu({}, this._getAnalyticsProperties()), {
            media_session_id: this.getMediaSessionId(),
      ...
      let e = x.Z.getChannel(this.channelId),
        t = null == e ? void 0 : e.type;
      B.default.track(es.rMx.VOICE_CONNECTION_CONNECTING, e_(eu({}, this.getAudioDeviceStates(), this.getVideoDeviceStates()), {
        guild_id: this.guildId,
        channel_id: this.channelId,
        rtc_connection_id: this.getRTCConnectionId(),
        hostname: this.hostname,
    ...
    }), this.userId = e, this.sessionId = t, this.guildId = n, this._channelId = r, this.channelIds = new Set([r]), this.streamServerId = a, this.streamChannelId = s, this.parentMediaSessionId = l, this.logger = new b.Z("RTCConnection(".concat(this.trueServerId, ", ").concat(this.context, ")")), this.logger.enableNativeLogger(!0), this._endpoint = null, this.hostname = null, this.port = null, this.token = null, this.voiceVersion = null, this.rtcWorkerVersion = null, this.state = es.hes.AWAITING_ENDPOINT, this.stateHistory = new X.K(this.state), this._socket = null, this._backoff = new u.Z(1e3, 1e4), this._destroyed = !1, this._pings = [], this._pingBadCount = 0, this._pingTimeouts = [], this._mediaSessionId = null, this._voiceQuality = null, this._voiceQualityPeriodicStatsInterval = null, this._voiceQualityPeriodicStatsSequenceId = 0, this._systemResponsiveness = null, this._noiseCancellationError = 0, this._voiceDuration = null, this._videoQuality = null, this._videoHealthManager = null, this._sentVideo = !1, this._outboundLossRate = null, this._createdTime = (0, f.zO)(), this._connectStartTime = 0, this._connectCompletedTime = 0, this._rtcConnectionId = (0, c.Z)(), this._connectCount = 0, this._connected = !1, this._connecting = !1, this._encountered_socket_failure = !1, this._inputDetected = !1, this._selectedExperiments = [], this._secureFramesState = null, this._userIds = new Set([e]), this._secureFramesRosterMap.clear(), this._mlsFailures.clear(), this._mediaEngineConnectionId = null, this._lastSentSpeakingStatus = 0, this._lastSentSSRC = void 0;
    let d = k.Z.supports(el.AN.FIRST_FRAME_CALLBACK) && k.Z.supports(el.AN.REMOTE_USER_MULTI_STREAM);
    if (i === el.Yn.DEFAULT) {
      var _;
    ...
    } else i === el.Yn.STREAM && (this._goLiveQualityManager = new v.Z(!0), this._goLiveQualityManager.on(v.y.RequestedSSRCsUpdate, (e, t, n) => {
      var r;
      null == (r = this._connection) || r.createUser(e, t, n)
    ...
    this._remoteVideoSinkWants = J.Yy, eo.w.on(eo.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged), eo.w.on(eo.e.WindowVisibilityChanged, this.windowVisibilityChanged), j.ZP.shouldRecordNextConnection() ? (this._recordingEnabled = !0, g.TC(!1)) : this._recordingEnabled = !1, this._soundshareStats = new $.Z, Z.Z.addOnlineCallback(this._handleNetworkOnline), Z.Z.addOfflineCallback(this._handleNetworkOffline), (0, H.isDesktop)() && (this.powerMonitorListener = K.Z.remotePowerMonitor.on("resume", this._handlePowerResume)), this._supportedBandwidthEstimationExperiments = [], this._bandwidthEstimationExperiment = null, k.Z.getMediaEngine().getSupportedBandwidthEstimationExperiments(e => {
