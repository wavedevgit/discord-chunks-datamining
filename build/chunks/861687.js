...
n.d(t, {
  Z: () => eO
}), n(35282), n(415506), n(539854), n(388685), n(49124);
var r = n(654861),
  i = n.n(r),
  o = n(954955),
  a = n.n(o),
...
class eO extends d.Z {
  get quality() {
    let e = this.getLastPing();
    return this.state !== eo.hes.RTC_CONNECTED || void 0 === e ? eo.IE4.UNKNOWN : e > ep || null != this._outboundLossRate && this._outboundLossRate > em ? eo.IE4.BAD : e > eh || null != this._outboundLossRate && this._outboundLossRate > eg ? eo.IE4.AVERAGE : eo.IE4.FINE
  }
  get endpoint() {
  ...
  connect(e, t) {
    ...
    if (this.endpoint = e, this.token = t, (n !== this.endpoint || r !== t) && (this._cleanupSocket(), this._mediaSessionId = null, null != n && (this._rtcConnectionId = (0, c.Z)(), p.Z.dispatch({
        ...
        connection: this
      }))), null == this.endpoint) return void this.setState(eo.hes.AWAITING_ENDPOINT);
    let i = this._socket;
  ...
  destroy() {
    var e, t, n, r, i, o, a;
    if (this.logger.info("Destroy RTCConnection"), F.Z.removeOnlineCallback(this._handleNetworkOnline), F.Z.removeOfflineCallback(this._handleNetworkOffline), (0, V.isDesktop)() && (null == (o = (a = this).powerMonitorListener) || o.call(a)), ei.w.off(ei.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged), ei.w.off(ei.e.WindowVisibilityChanged, this.windowVisibilityChanged), this._backoff.cancel(), this._cleanupSocket(), null == (e = this._voiceQuality) || e.stop(), this._voiceQuality = null, clearInterval(this._voiceQualityPeriodicStatsInterval), this._voiceQualityPeriodicStatsInterval = null, this._voiceQualityPeriodicStatsSequenceId = 0, null == (t = this._systemResponsiveness) || t.stop(), this._systemResponsiveness = null, this._noiseCancellationError = 0, null == (n = this._voiceDuration) || n.stop(), this._voiceDuration = null, null == (r = this._videoQuality) || r.stop(), this._videoQuality = null, this._videoHealthManager = null, this._secureFramesState = null, null == (i = this._localMediaSinkWantsManager) || i.reset(), null != this._connection) {
  ...
  shouldSendSpeaking(e, t) {
    ...
    let n = (0, B.yE)(e, ea.Dg.PRIORITY),
      r = (0, B.yE)(this._lastSentSpeakingStatus, ea.Dg.PRIORITY);
    return (this._lastSentSSRC !== t || n !== r) && (void 0 !== this._lastSentSSRC || e !== ea.Dg.NONE) && (this._lastSentSSRC === t || e !== ea.Dg.NONE) && (this._lastSentSpeakingStatus = e, this._lastSentSSRC = t, !0)
  }
  sendSpeaking(e, t) {
    let n = this._socket;
  ...
  setSimulcastDebugOverride(e, t, n) {
    var r, i;
    t === this.context && (t === ea.Yn.DEFAULT ? null == (r = this._localMediaSinkWantsManager) || r.setSimulcastDebugOverride(e, n) : null == (i = this._goLiveQualityManager) || i.setSimulcastDebugOverride(n))
  }
  setVideoSize(e, t, n) {
    var r, i;
  ...
  _chooseExperiments(e) {
    ...
    if (L.Z.supports(ea.AN.FIXED_KEYFRAME_INTERVAL) && t.push("fixed_keyframe_interval"), 0 !== this._supportedBandwidthEstimationExperiments.length) {
      ...
      autoTrackExposure: !0
    }).enabled && t.push("network_aware_socket"), this._selectedExperiments = t
  }
  _handleConnecting(e) {
  ...
  _handleConnect(e) {
    ...
    this.logger.info("Connected to RTC server."), e.identify({
      ...
      video: L.Z.supports(ea.AN.VIDEO),
      streamParameters: L.Z.getVideoStreamParameters(this.context)
    }), this.setState(eo.hes.AUTHENTICATING)
  }
  _handleDisconnect(e, t, n, r) {
    var i, o, a, s, l, c, u, d, f, _, p, h, m, g, E, b, y, v, I, S, T;
    this.logger.info("Disconnected from RTC server, clean: ".concat(t, ", code: ").concat(n, ", reason: ").concat(r, ", state: ").concat(this.state)), t || !this._connecting || this._encountered_socket_failure || (U.default.track(eo.rMx.VOICE_CONNECTION_SOCKET_FAILURE, eu(el({}, this._getAnalyticsProperties()), {
      hostname: this.hostname,
    ...
    if (this.state !== eo.hes.DISCONNECTED) {
      ...
      if (null != e && this.context === ea.Yn.DEFAULT) {
        if (e.stop(), this._sentVideo) {
          e.getOutboundStats().forEach(t => {
            var n;
            (null != (n = t.num_frames) ? n : 0) > 0 && U.default.track(eo.rMx.VIDEO_STREAM_ENDED, eu(el(eu(el({}, this._getAnalyticsProperties()), {
          ...
          null != t && t.camera_enabled_duration > 0 && U.default.track(eo.rMx.VIDEO_CALL_ENDED, eu(el({}, t), {
            media_session_id: this.getMediaSessionId()
          }))
        }
        e.getInboundParticipants().forEach(t => {
          ...
          (null != (n = null == i ? void 0 : i.num_frames) ? n : 0) > 0 && U.default.track(eo.rMx.VIDEO_STREAM_ENDED, el(eu(el({}, this._getAnalyticsProperties()), {
            app_hardware_acceleration_enabled: G.Z.getAppHardwareAccelerationEnabled(),
            media_session_id: this.getMediaSessionId(),
            sender_user_id: t,
            reason: r,
      ...
      L.Z.getMediaEngine().getCodecSurvey().then(e => {
        ...
        U.default.track(eo.rMx.VOICE_CODEC_DETECTED, eu(el({}, n), {
      ...
      let n = M.Z.shouldIncludePreferredRegion() ? M.Z.getPreferredRegion() : null,
        ...
        a = null == (u = C.Z.getConnectionStats(this.getMediaEngineConnectionId())) || null == (c = u.stats.rtp.outbound.find(e => "audio" === e.type)) ? void 0 : c.sampleRateMismatchPercent,
      ...
      (async () => {
        ...
        U.default.track(eo.rMx.VOICE_DISCONNECT, eu(el({}, s), {
          battery_usage: t
        }))
    ...
    this.setState(eo.hes.DISCONNECTED, {
      willReconnect: A
    })
  }
  _handleResuming(e) {
  ...
  _handleReady(e, t, n, r, i, o, a) {
    var s;
    this.setState(eo.hes.RTC_CONNECTING), this.port = n, this._chooseExperiments(null != a ? a : []), 0 === o.length && o.push({
      type: ea.Tr.VIDEO,
      rid: "100",
      ssrc: i + 1,
      rtxSsrc: i + 2,
    ...
    let l = L.Z.getMediaEngine(),
      ...
      u = null != (s = w.default.getStaticAuthSessionId()) ? s : void 0,
      d = l.connect(this.context, this.userId, el({
        ssrc: i,
        address: t,
        port: n,
        modes: r,
    ...
    d.setUseElectronVideo(l.supports(ea.AN.ELECTRON_VIDEO)), L.Z.supports(ea.AN.IMAGE_QUALITY_MEASUREMENT) && d.setVideoQualityMeasurement("imageQualityWebrtcPsnrDb:5000,imageQualityVmaf_v061:5000,hwdec");
    let p = ["unk"];
    this.context === ea.Yn.STREAM && (p.push("nvRelaxRc=250"), p.push("nvNewPresets")), d.setVideoEncoderExperiments(p.join(",")), d.on(f.Sh.Speaking, (e, t, n) => {
      this.userId === e && this.sendSpeaking(t, n), this.emit(K.z.Speaking, ey(e), t)
    }), d.on(f.Sh.ToggleMuteFromNative, () => {
      this.context === ea.Yn.DEFAULT && m.Z.toggleSelfMute({
        playSoundEffect: !1
      })
    }), d.on(f.Sh.NativeMuteChanged, e => {
      this.context === ea.Yn.DEFAULT && E.Z.nativeMuteChanged(e)
      ...
      null != this._localMediaSinkWantsManager && (this._localMediaSinkWantsManager.setFirstFrameReceived(t), this.emit(K.z.Video, this.guildId, this.channelId, ey(e), n, this.rtcServerId)), null != this._goLiveQualityManager && (this._goLiveQualityManager.setFirstFrameReceived(t), this.emit(K.z.Video, this.guildId, this.channelId, ey(e), n, this.rtcServerId))
    }), d.on(f.Sh.Silence, e => {
      ...
      let n = M.Z.shouldIncludePreferredRegion() ? M.Z.getPreferredRegion() : null;
      this.logger.error("Error occurred while connecting to RTC server: ".concat(t)), U.default.track(eo.rMx.VOICE_CONNECTION_FAILURE, eu(el({}, this._getAnalyticsProperties()), {
        hostname: this.hostname,
        port: this.port,
        protocol: this.protocol,
        error: t,
      ...
      let n = this.state;
      switch (t) {
        case ea.$j.DISCONNECTED:
          this.setState(eo.hes.RTC_DISCONNECTED);
          break;
        case ea.$j.CONNECTING:
        ...
        case ea.$j.NO_ROUTE:
          ...
          break;
        case ea.$j.ICE_CHECKING:
          this.setState(eo.hes.ICE_CHECKING);
          break;
        case ea.$j.DTLS_CONNECTING:
      ...
      if (n === eo.hes.RTC_CONNECTING && this.state === eo.hes.RTC_DISCONNECTED ? this.reconnect() : this.state === eo.hes.NO_ROUTE && (0 === this._backoff.fails && this._handleNoRoute(), this._backoff.fail(this.reconnect)), this.state === eo.hes.RTC_CONNECTED) {
        ...
        if (this._connecting) {
          ...
          U.default.track(eo.rMx.VOICE_CONNECTION_SUCCESS, el(eu(el({}, this._getAnalyticsProperties()), {
            hostname: this.hostname,
            port: this.port,
            protocol: this.protocol,
    ...
    }), d.on(f.Sh.MLSFailure, this._handleMLSFailure.bind(this)), d.setRemoteVideoSinkWants(this._remoteVideoSinkWants), this._connection = d, this._mediaEngineConnectionId = d.mediaEngineConnectionId
  }
  _handleSpeaking(e, t, n, r) {
    let i = this._connection;
    if (null != i && this.userId !== t) {
      var o;
      r !== ea.Dg.NONE && (i.createUser(t, n), p.Z.dispatch({
  ...
  getOrCreateVideoQuality() {
    if (null != this._connection && null == this._videoQuality) {
      ...
      if (e) {
        ...
        this._videoQuality.on(et.d.FpsUpdate, e)
      }
    }
  ...
  _handleVideoStreamId(e) {
    ...
    if (this.emit(K.z.Video, this.guildId, this.channelId, o, a, this.rtcServerId), null != a && null == this.getOrCreateVideoQuality() && this.logger.error("_handleVideoStreamId: Unable to create videoQuality."), null != this._videoQuality && this.userId === o && l.forEach(e => {
        var t, n;
  ...
  _handleRemoteStreamsReady(e) {
    ...
    U.default.track(eo.rMx.VOICE_CONNECTION_REMOTE_STREAMS_CREATED, eu(el({}, this._getAnalyticsProperties()), {
      number_of_users: e,
      duration_ms: t
    }))
  }
  ...
  _handleControlPing(e) {
    L.Z.supports(ea.AN.NATIVE_PING) || this._handlePing(e)
  }
  _handlePing(e) {
    if (void 0 !== e) {
  ...
  _handleClientDisconnect(e) {
    ...
    if (null != s && this.context === ea.Yn.DEFAULT) {
      let t = s.getInboundStats(e),
        n = null != (o = null == t ? void 0 : t.num_frames) ? o : 0;
      null != t && n > 0 && (U.default.track(eo.rMx.VIDEO_STREAM_ENDED, el(eu(el({}, this._getAnalyticsProperties()), {
        app_hardware_acceleration_enabled: G.Z.getAppHardwareAccelerationEnabled(),
        media_session_id: this.getMediaSessionId(),
        sender_user_id: e,
  ...
  _handleCodecs(e, t) {
    ...
    null != n && null != this.protocol ? n.setCodecs(null != e && "" !== e ? e : ea.ad.OPUS, null != t && "" !== t ? t : ea.ad.H264, this.context) : this.logger.warn("Cannot set codecs on connection with protocol:", this.protocol)
  }
  _handleSDP(e) {
  ...
  _handleMediaSessionId(e) {
    ...
    U.default.track(eo.rMx.MEDIA_SESSION_JOINED, eu(el({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      raw_thermal_state: t
    })), p.Z.dispatch({
  ...
  _trackSecureFrameTransition(e) {
    ...
    U.default.track(eo.rMx.SECURE_FRAMES_TRANSITION, eu(el({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      sender_user_id: this.userId,
      transition_id: e,
  ...
  _handleSecureFramesInit(e) {
    var t, n;
    let r = (0, _.zO)();
    e > 0 ? (this.logger.info("DAVE protocol init with protocol version: ".concat(e)), null == (t = this._connection) || t.prepareSecureFramesEpoch(eE, e, this.trueChannelId), this._sendMLSKeyPackage()) : null == (n = this._connection) || n.prepareSecureFramesTransition(eb, e, () => {
      let t = (0, _.zO)(),
        n = !1;
      try {
        var i;
      ...
      e > 0 && (this._storeSecureFrameTransitionData(eb, {
        initReceivedTime: r,
        initFinishedTime: t,
        protocolVersion: e,
  ...
  _handleSecureFramesRosterChange(e) {
    ...
    Object.entries(e).forEach(e => {
      let [n, r] = e;
      t.push(ey(n)), null == r || 0 === r.byteLength ? this._secureFramesRosterMap.delete(ey(n)) : this._secureFramesRosterMap.set(ey(n), r)
  ...
  _handleSecureFramesPrepareEpoch(e, t) {
    ...
    let r = e.toString();
    null == (n = this._connection) || n.prepareSecureFramesEpoch(r, t, this.trueChannelId), r === eE && this._sendMLSKeyPackage()
  }
  _sendMLSKeyPackage() {
    var e;
  ...
  _handleMLSProposals(e, t) {
    ...
    this.logger.info("Received MLS proposals"), null == (n = this._connection) || n.processMLSProposals(t, n => {
      var i, o;
      let a = (0, _.zO)();
      this.logger.info("Sending MLS commit welcome message"), e.sendMLSCommitWelcome(n), null == this._secureFramesNextTransitionState && (this._secureFramesNextTransitionState = {
        firstProposalsReceivedTime: r,
        firstProposalsFinishedTime: a
      }), this._secureFramesNextTransitionState.lastProposalsReceivedTime = r, this._secureFramesNextTransitionState.lastProposalsFinishedTime = a, this._secureFramesNextTransitionState.totalProposalsSize = (null != (i = this._secureFramesNextTransitionState.totalProposalsSize) ? i : 0) + t.byteLength, this._secureFramesNextTransitionState.totalCommitWelcomeSize = (null != (o = this._secureFramesNextTransitionState.totalCommitWelcomeSize) ? o : 0) + n.byteLength
    })
  }
  _handleMLSPrepareCommitTransition(e, t) {
    ...
    null == (n = this._connection) || n.prepareMLSCommitTransition(e, t, (n, i, o) => {
      n ? (this._handleSecureFramesRosterChange(o), this._maybeSendSecureFramesTransitionReady(e), this._recoverMLSFailures()) : (this.logger.warn("Failed to process MLS commit for transition ID ".concat(e)), this._flagMLSInvalidCommitWelcome(e), this._handleSecureFramesInit(i)), this._storeSecureFrameTransitionData(e, {
        protocolVersion: i,
  ...
  _handleMLSWelcome(e, t) {
    ...
    null == (n = this._connection) || n.processMLSWelcome(e, t, (n, i, o) => {
      n ? (this._handleSecureFramesRosterChange(o), this._maybeSendSecureFramesTransitionReady(e), this._recoverMLSFailures()) : (this._flagMLSInvalidCommitWelcome(e), this._sendMLSKeyPackage()), this._storeSecureFrameTransitionData(e, {
        protocolVersion: i,
  ...
  _trackMLSFailures() {
    ...
    for (let [n, r, i, o] of e) U.default.track(eo.rMx.MLS_FAILURES, eu(el({}, this._getAnalyticsProperties()), {
      media_session_id: t,
      parent_media_session_id: this.parentMediaSessionId,
      failure_source: n,
      failure_reason: r,
  ...
  _alertMLSFailure(e, t) {
    ...
    ((null == n ? void 0 : n.isStaff()) || (null == n ? void 0 : n.isStaffPersonal())) && h.Z.show({
  ...
  constructor({
    ...
    guildId: n,
    channelId: r,
    context: i = ea.Yn.DEFAULT,
    rtcServerId: o,
    parentMediaSessionId: s
  }) {
    var l, d;
    super(), es(this, "context", void 0), es(this, "userId", void 0), es(this, "sessionId", void 0), es(this, "guildId", void 0), es(this, "parentMediaSessionId", void 0), es(this, "hostname", void 0), es(this, "state", void 0), es(this, "_videoQuality", void 0), es(this, "_soundshareStats", void 0), es(this, "logger", void 0), es(this, "rtcServerId", void 0), es(this, "_channelId", void 0), es(this, "channelIds", void 0), es(this, "_endpoint", void 0), es(this, "port", void 0), es(this, "token", void 0), es(this, "protocol", void 0), es(this, "voiceVersion", void 0), es(this, "rtcWorkerVersion", void 0), es(this, "_socket", void 0), es(this, "_backoff", void 0), es(this, "_destroyed", void 0), es(this, "_pings", void 0), es(this, "_pingBadCount", void 0), es(this, "_pingTimeouts", void 0), es(this, "_mediaSessionId", void 0), es(this, "_voiceQuality", void 0), es(this, "_voiceQualityPeriodicStatsInterval", void 0), es(this, "_voiceQualityPeriodicStatsSequenceId", void 0), es(this, "_systemResponsiveness", void 0), es(this, "_systemResources", void 0), es(this, "_noiseCancellationError", void 0), es(this, "_voiceDuration", void 0), es(this, "_videoHealthManager", void 0), es(this, "_sentVideo", void 0), es(this, "_outboundLossRate", void 0), es(this, "_recordingEnabled", void 0), es(this, "_selectedExperiments", void 0), es(this, "_localMediaSinkWantsManager", void 0), es(this, "_goLiveQualityManager", void 0), es(this, "_remoteVideoSinkWants", void 0), es(this, "_connection", void 0), es(this, "_mediaEngineConnectionId", void 0), es(this, "_createdTime", void 0), es(this, "_connectStartTime", void 0), es(this, "_connectCompletedTime", void 0), es(this, "_rtcConnectionId", void 0), es(this, "_connectCount", void 0), es(this, "_connected", void 0), es(this, "_connecting", void 0), es(this, "_encountered_socket_failure", void 0), es(this, "_inputDetected", void 0), es(this, "_encryptionMode", void 0), es(this, "stateHistory", void 0), es(this, "_supportedBandwidthEstimationExperiments", void 0), es(this, "_bandwidthEstimationExperiment", void 0), es(this, "_secureFramesState", void 0), es(this, "_userIds", void 0), es(this, "_secureFramesRosterMap", new Map), es(this, "_mlsFailuresRecovered", void 0), es(this, "_mlsFailures", void 0), es(this, "_secureFramesTransitionStates", new Map), es(this, "_secureFramesNextTransitionState", void 0), es(this, "_secureFramesMaxConcurrentTransitions", 0), es(this, "_secureFramesTransitionPrepareCount", 0), es(this, "_secureFramesTransitionExecuteCount", 0), es(this, "_lastSentSpeakingStatus", void 0), es(this, "_lastSentSSRC", void 0), es(this, "powerMonitorListener", void 0), es(this, "reconnect", () => {
      let e = this._socket;
    ...
    }), es(this, "_alertMLSFailureDebouced", a()(this._alertMLSFailure, 100)), es(this, "_handleNetworkOnline", () => {
      ...
      if (null != this._voiceQuality) {
        ...
        if (this.shouldReportPeriodicStats(e))
          for (let t of e) U.default.track(eo.rMx.VOICE_QUALITY_PERIODIC_STATS, eu(el({}, this._getAnalyticsProperties()), {
            media_session_id: this.getMediaSessionId(),
      ...
      let e = D.Z.getChannel(this.channelId),
        t = null == e ? void 0 : e.type;
      U.default.track(eo.rMx.VOICE_CONNECTION_CONNECTING, eu(el({}, this.getAudioDeviceStates(), this.getVideoDeviceStates()), {
        guild_id: this.guildId,
        channel_id: this.channelId,
        rtc_connection_id: this.getRTCConnectionId(),
        hostname: this.hostname,
    ...
    }), this.context = i, this.logger = new b.Z("RTCConnection(".concat(null != (l = null != o ? o : n) ? l : r, ", ").concat(this.context, ")")), this.logger.enableNativeLogger(!0), this.userId = e, this.sessionId = t, this.guildId = n, this._channelId = r, this.channelIds = new Set([r]), this.rtcServerId = o, this.parentMediaSessionId = s, this._endpoint = null, this.hostname = null, this.port = null, this.token = null, this.voiceVersion = null, this.rtcWorkerVersion = null, this.state = eo.hes.AWAITING_ENDPOINT, this.stateHistory = new z.K(this.state), this._socket = null, this._backoff = new u.Z(1e3, 1e4), this._destroyed = !1, this._pings = [], this._pingBadCount = 0, this._pingTimeouts = [], this._mediaSessionId = null, this._voiceQuality = null, this._voiceQualityPeriodicStatsInterval = null, this._voiceQualityPeriodicStatsSequenceId = 0, this._systemResponsiveness = null, this._noiseCancellationError = 0, this._voiceDuration = null, this._videoQuality = null, this._videoHealthManager = null, this._sentVideo = !1, this._outboundLossRate = null, this._createdTime = (0, _.zO)(), this._connectStartTime = 0, this._connectCompletedTime = 0, this._rtcConnectionId = (0, c.Z)(), this._connectCount = 0, this._connected = !1, this._connecting = !1, this._encountered_socket_failure = !1, this._inputDetected = !1, this._selectedExperiments = [], this._secureFramesState = null, this._userIds = new Set([e]), this._secureFramesRosterMap.clear(), this._mlsFailuresRecovered = {}, this._mlsFailures = {}, this._mediaEngineConnectionId = null, this._lastSentSpeakingStatus = 0, this._lastSentSSRC = void 0;
    let f = L.Z.supports(ea.AN.FIRST_FRAME_CALLBACK) && L.Z.supports(ea.AN.REMOTE_USER_MULTI_STREAM);
    if (i === ea.Yn.DEFAULT) {
      let t = (null == (d = D.Z.getChannel(this.channelId)) ? void 0 : d.type) === eo.d4z.GUILD_STAGE_VOICE;
    ...
    } else i === ea.Yn.STREAM && (this._goLiveQualityManager = new v.Z(!0), this._goLiveQualityManager.on(v.y.RequestedSSRCsUpdate, (e, t, n) => {
      var r;
      null == (r = this._connection) || r.createUser(e, t, n)
    ...
    this._remoteVideoSinkWants = Q.Yy, ei.w.on(ei.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged), ei.w.on(ei.e.WindowVisibilityChanged, this.windowVisibilityChanged), k.ZP.shouldRecordNextConnection() ? (this._recordingEnabled = !0, g.TC(!1)) : this._recordingEnabled = !1, this._soundshareStats = new X.Z, F.Z.addOnlineCallback(this._handleNetworkOnline), F.Z.addOfflineCallback(this._handleNetworkOffline), (0, V.isDesktop)() && (this.powerMonitorListener = Y.Z.remotePowerMonitor.on("resume", this._handlePowerResume)), this._supportedBandwidthEstimationExperiments = [], this._bandwidthEstimationExperiment = null, L.Z.getMediaEngine().getSupportedBandwidthEstimationExperiments(e => {
