...
n.d(t, {
  Z: () => eO
}), n(35282), n(415506), n(539854), n(388685), n(784620), n(973216), n(49124);
var r = n(654861),
  i = n.n(r),
  o = n(954955),
  a = n.n(o),
...
class eO extends d.Z {
  ...
  destroy() {
    var e, t, n, r, i, o, a;
    if (this.logger.info("Destroy RTCConnection"), V.Z.removeOnlineCallback(this._handleNetworkOnline), V.Z.removeOfflineCallback(this._handleNetworkOffline), (0, Z.isDesktop)() && (null == (o = (a = this).powerMonitorListener) || o.call(a)), ei.w.off(ei.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged), ei.w.off(ei.e.WindowVisibilityChanged, this.windowVisibilityChanged), this._backoff.cancel(), this._cleanupSocket(), null == (e = this._voiceQuality) || e.stop(), this._voiceQuality = null, clearInterval(this._voiceQualityPeriodicStatsInterval), this._voiceQualityPeriodicStatsInterval = null, this._voiceQualityPeriodicStatsSequenceId = 0, null == (t = this._systemResponsiveness) || t.stop(), this._systemResponsiveness = null, this._noiseCancellationError = 0, null == (n = this._voiceDuration) || n.stop(), this._voiceDuration = null, null == (r = this._videoQuality) || r.stop(), this._videoQuality = null, this._videoHealthManager = null, this._secureFramesState = null, null == (i = this._localMediaSinkWantsManager) || i.reset(), null != this._connection) {
  ...
  shouldSendSpeaking(e, t) {
    ...
    let n = (0, F.yE)(e, ea.Dg.PRIORITY),
      r = (0, F.yE)(this._lastSentSpeakingStatus, ea.Dg.PRIORITY);
  ...
  _chooseExperiments(e) {
    ...
    if (x.Z.supports(ea.AN.FIXED_KEYFRAME_INTERVAL) && t.push("fixed_keyframe_interval"), 0 !== this._supportedBandwidthEstimationExperiments.length) {
  ...
  _handleConnect(e) {
    ...
    this.logger.info("Connected to RTC server."), e.identify({
      ...
      video: x.Z.supports(ea.AN.VIDEO),
  ...
  _handleDisconnect(e, t, n, r) {
    ...
    this.logger.info("Disconnected from RTC server, clean: ".concat(t, ", code: ").concat(n, ", reason: ").concat(r, ", state: ").concat(this.state)), t || !this._connecting || this._encountered_socket_failure || (G.default.track(eo.rMx.VOICE_CONNECTION_SOCKET_FAILURE, eu(el({}, this._getAnalyticsProperties()), {
      hostname: this.hostname,
    ...
    if (this.state !== eo.hes.DISCONNECTED) {
      ...
      null != e && this.context === ea.Yn.DEFAULT && (e.stop(), this._sentVideo && e.getOutboundStats().forEach(t => {
        var n;
        (null != (n = t.num_frames) ? n : 0) > 0 && G.default.track(eo.rMx.VIDEO_STREAM_ENDED, eu(el(eu(el({}, this._getAnalyticsProperties()), {
        ...
        (null != (n = null == i ? void 0 : i.num_frames) ? n : 0) > 0 && G.default.track(eo.rMx.VIDEO_STREAM_ENDED, el(eu(el({}, this._getAnalyticsProperties()), {
          app_hardware_acceleration_enabled: B.Z.getAppHardwareAccelerationEnabled(),
          media_session_id: this.getMediaSessionId(),
          sender_user_id: t,
          reason: r,
      ...
      x.Z.getMediaEngine().getCodecSurvey().then(e => {
        ...
        G.default.track(eo.rMx.VOICE_CODEC_DETECTED, eu(el({}, n), {
      ...
      (async () => {
        ...
        G.default.track(eo.rMx.VOICE_DISCONNECT, eu(el({}, s), {
          battery_usage: t
        }))
      })
    }
  ...
  _handleReady(e, t, n, r, i, o, a) {
    ...
    let u = x.Z.getMediaEngine(),
      d = w.Z.getPersistentCodesEnabled(),
      p = null != (s = D.default.getStaticAuthSessionId()) ? s : void 0,
      h = u.connect(this.context, this.userId, el({
        ssrc: i,
        address: t,
        port: n,
        modes: r,
    ...
    h.setUseElectronVideo(u.supports(ea.AN.ELECTRON_VIDEO)), x.Z.supports(ea.AN.IMAGE_QUALITY_MEASUREMENT) && h.setVideoQualityMeasurement("imageQualityWebrtcPsnrDb:5000,imageQualityVmaf_v061:5000,hwdec");
    let g = ["unk"];
    if (this.context === ea.Yn.STREAM) {
      g.push("nvRelaxRc=250"), g.push("nvNewPresets");
      let e = x.Z.getGpuBrand();
      if ((null == e ? void 0 : e.startsWith("NVIDIA")) && parseInt(null != (c = null == (l = e.match(/\d+/)) ? void 0 : l.at(0)) ? c : "0", 10) >= 5e3) {
        let {
          useHevcBlackwellConfig: e
    ...
    h.setVideoEncoderExperiments(g.join(",")), h.on(f.Sh.Speaking, (e, t, n) => {
      ...
      let n = j.Z.shouldIncludePreferredRegion() ? j.Z.getPreferredRegion() : null;
      this.logger.error("Error occurred while connecting to RTC server: ".concat(t)), G.default.track(eo.rMx.VOICE_CONNECTION_FAILURE, eu(el({}, this._getAnalyticsProperties()), {
        hostname: this.hostname,
        port: this.port,
        protocol: this.protocol,
        error: t,
      ...
      if (n === eo.hes.RTC_CONNECTING && this.state === eo.hes.RTC_DISCONNECTED ? this.reconnect() : this.state === eo.hes.NO_ROUTE && (0 === this._backoff.fails && this._handleNoRoute(), this._backoff.fail(this.reconnect)), this.state === eo.hes.RTC_CONNECTED) {
        ...
        if (this._connecting) {
          ...
          G.default.track(eo.rMx.VOICE_CONNECTION_SUCCESS, el(eu(el({}, this._getAnalyticsProperties()), {
            hostname: this.hostname,
            port: this.port,
            protocol: this.protocol,
  ...
  _handleRemoteStreamsReady(e) {
    ...
    G.default.track(eo.rMx.VOICE_CONNECTION_REMOTE_STREAMS_CREATED, eu(el({}, this._getAnalyticsProperties()), {
      number_of_users: e,
      duration_ms: t
    }))
  }
  ...
  _handleControlPing(e) {
    x.Z.supports(ea.AN.NATIVE_PING) || this._handlePing(e)
  }
  _handlePing(e) {
    if (void 0 !== e) {
  ...
  _handleClientConnect(e) {
    ...
    }), this.emit(K.z.ClientConnect, e), null == (t = this._goLiveQualityManager) || t.updateCallUserIds(this._userIds), null == (n = this._localMediaSinkWantsManager) || n.updateCallUserIds(this._userIds)
  }
  _handleClientDisconnect(e) {
    var t, n, r, i, o;
    let a = this._videoQuality;
    if (null != a && this.context === ea.Yn.DEFAULT) {
      let t = a.getInboundStats(e),
        n = null != (i = null == t ? void 0 : t.num_frames) ? i : 0;
      null != t && n > 0 && (G.default.track(eo.rMx.VIDEO_STREAM_ENDED, el(eu(el({}, this._getAnalyticsProperties()), {
        app_hardware_acceleration_enabled: B.Z.getAppHardwareAccelerationEnabled(),
        media_session_id: this.getMediaSessionId(),
        sender_user_id: e,
        ...
        hostname: this.hostname,
        hardware_enabled: x.Z.getHardwareEncoding()
      }), t, a.getNetworkStats(), a.getCodecUsageStats("receiver", e))), a.destroyUser(e), null == (o = this._videoHealthManager) || o.deleteUser(e))
    }
  ...
  _handleMediaSessionId(e) {
    ...
    G.default.track(eo.rMx.MEDIA_SESSION_JOINED, eu(el({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      raw_thermal_state: t
    })), p.Z.dispatch({
  ...
  _trackSecureFrameTransition(e, t) {
    G.default.track(eo.rMx.SECURE_FRAMES_TRANSITION, eu(el({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      sender_user_id: this.userId,
      transition_id: e,
  ...
  _handleSecureFramesInit(e) {
    ...
    e > 0 ? (this.logger.info("DAVE protocol init with protocol version: ".concat(e)), null == (t = this._connection) || t.prepareSecureFramesEpoch(eE, e, this.trueChannelId), this._sendMLSKeyPackage()) : null == (n = this._connection) || n.prepareSecureFramesTransition(eb, e, () => {
      var t;
      e > 0 && this._trackSecureFrameTransition(eb, e), null == (t = this._connection) || t.executeSecureFramesTransition(eb)
    })
  }
  ...
  _handleSecureFramesPrepareTransition(e, t) {
    var n;
    this.logger.info("Preparing DAVE protocol transition: ".concat(e, ", protocol version: ").concat(t)), null == (n = this._connection) || n.prepareSecureFramesTransition(e, t, () => {
  ...
  _handleMLSProposals(e, t) {
    var n;
    this.logger.info("Received MLS proposals"), null == (n = this._connection) || n.processMLSProposals(t, t => {
      this.logger.info("Sending MLS commit welcome message"), e.sendMLSCommitWelcome(t)
    })
  }
  _handleMLSPrepareCommitTransition(e, t) {
    var n;
    this.logger.info("Received MLS commit for transition ID ".concat(e)), null == (n = this._connection) || n.prepareMLSCommitTransition(e, t, (t, n, r) => {
  ...
  _handleMLSWelcome(e, t) {
    var n;
    this.logger.info("Received MLS welcome for transition ID ".concat(e)), null == (n = this._connection) || n.processMLSWelcome(e, t, (t, n, r) => {
  ...
  _trackMLSFailures() {
    ...
    for (let [n, r, i, o] of e) G.default.track(eo.rMx.MLS_FAILURES, eu(el({}, this._getAnalyticsProperties()), {
      media_session_id: t,
      parent_media_session_id: this.parentMediaSessionId,
      failure_source: n,
      failure_reason: r,
  ...
  constructor({
    ...
    super(), es(this, "context", void 0), es(this, "userId", void 0), es(this, "sessionId", void 0), es(this, "guildId", void 0), es(this, "parentMediaSessionId", void 0), es(this, "hostname", void 0), es(this, "state", void 0), es(this, "_videoQuality", void 0), es(this, "_soundshareStats", void 0), es(this, "logger", void 0), es(this, "rtcServerId", void 0), es(this, "_channelId", void 0), es(this, "channelIds", void 0), es(this, "_endpoint", void 0), es(this, "port", void 0), es(this, "token", void 0), es(this, "protocol", void 0), es(this, "voiceVersion", void 0), es(this, "rtcWorkerVersion", void 0), es(this, "_socket", void 0), es(this, "_backoff", void 0), es(this, "_destroyed", void 0), es(this, "_pings", void 0), es(this, "_pingBadCount", void 0), es(this, "_pingTimeouts", void 0), es(this, "_mediaSessionId", void 0), es(this, "_voiceQuality", void 0), es(this, "_voiceQualityPeriodicStatsInterval", void 0), es(this, "_voiceQualityPeriodicStatsSequenceId", void 0), es(this, "_systemResponsiveness", void 0), es(this, "_systemResources", void 0), es(this, "_noiseCancellationError", void 0), es(this, "_voiceDuration", void 0), es(this, "_videoHealthManager", void 0), es(this, "_sentVideo", void 0), es(this, "_outboundLossRate", void 0), es(this, "_recordingEnabled", void 0), es(this, "_selectedExperiments", void 0), es(this, "_localMediaSinkWantsManager", void 0), es(this, "_goLiveQualityManager", void 0), es(this, "_remoteVideoSinkWants", void 0), es(this, "_connection", void 0), es(this, "_mediaEngineConnectionId", void 0), es(this, "_createdTime", void 0), es(this, "_connectStartTime", void 0), es(this, "_connectCompletedTime", void 0), es(this, "_rtcConnectionId", void 0), es(this, "_connectCount", void 0), es(this, "_connected", void 0), es(this, "_connecting", void 0), es(this, "_encountered_socket_failure", void 0), es(this, "_inputDetected", void 0), es(this, "_encryptionMode", void 0), es(this, "stateHistory", void 0), es(this, "_supportedBandwidthEstimationExperiments", void 0), es(this, "_bandwidthEstimationExperiment", void 0), es(this, "_secureFramesState", void 0), es(this, "_userIds", void 0), es(this, "_secureFramesRosterMap", new Map), es(this, "_mlsFailuresRecovered", void 0), es(this, "_mlsFailures", void 0), es(this, "_lastSentSpeakingStatus", void 0), es(this, "_lastSentSSRC", void 0), es(this, "powerMonitorListener", void 0), es(this, "reconnect", () => {
      ...
      if (null != this._voiceQuality) {
        ...
        if (this.shouldReportPeriodicStats(e))
          for (let t of e) G.default.track(eo.rMx.VOICE_QUALITY_PERIODIC_STATS, eu(el({}, this._getAnalyticsProperties()), {
            media_session_id: this.getMediaSessionId(),
      ...
      let e = L.Z.getChannel(this.channelId),
        t = null == e ? void 0 : e.type;
      G.default.track(eo.rMx.VOICE_CONNECTION_CONNECTING, eu(el({}, this.getAudioDeviceStates(), this.getVideoDeviceStates()), {
        guild_id: this.guildId,
        channel_id: this.channelId,
        rtc_connection_id: this.getRTCConnectionId(),
        hostname: this.hostname,
    ...
    let f = x.Z.supports(ea.AN.FIRST_FRAME_CALLBACK) && x.Z.supports(ea.AN.REMOTE_USER_MULTI_STREAM);
    if (i === ea.Yn.DEFAULT) {
    ...
    this._remoteVideoSinkWants = Q.Yy, ei.w.on(ei.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged), ei.w.on(ei.e.WindowVisibilityChanged, this.windowVisibilityChanged), M.ZP.shouldRecordNextConnection() ? (this._recordingEnabled = !0, g.TC(!1)) : this._recordingEnabled = !1, this._soundshareStats = new X.Z, V.Z.addOnlineCallback(this._handleNetworkOnline), V.Z.addOfflineCallback(this._handleNetworkOffline), (0, Z.isDesktop)() && (this.powerMonitorListener = Y.Z.remotePowerMonitor.on("resume", this._handlePowerResume)), this._supportedBandwidthEstimationExperiments = [], this._bandwidthEstimationExperiment = null, x.Z.getMediaEngine().getSupportedBandwidthEstimationExperiments(e => {
