...
function eN() {
  let e = [],
    t = (0, Chunk379649.zO)();
  for (let n of eA) module.push(ep(ef({}, require), {
    t: exports - require.t
  }));
  return JSON.stringify(module)
}
class eR extends Chunk47770.Z {
  recordEvent(e) {
    for (eA.push(ep(ef({}, e), {
        t: (0, _.zO)(),
  ...
  _chooseExperiments(e) {
    let t = [];
    if (this._recordingEnabled && t.push("connection_log"), j.Z.supports(ec.AN.FIXED_KEYFRAME_INTERVAL) && t.push("fixed_keyframe_interval"), 0 !== this._supportedBandwidthEstimationExperiments.length) {
      let e = C.Z.workerExperimentString();
      null != e && t.push(e)
    }
    this.context === ec.Yn.DEFAULT && (0, I.f)("RtcConnection").enabled && t.push("audio_transport_cc"), t.push("keyframe_on_join"), R.Z.getCurrentConfig({
  ...
  _handleDisconnect(e, t, n, r) {
    ...
    this.logger.info("Disconnected from RTC server, clean: ".concat(t, ", code: ").concat(n, ", reason: ").concat(r, ", state: ").concat(this.state)), t || !this._connecting || this._encountered_socket_failure || (Z.default.track(el.rMx.VOICE_CONNECTION_SOCKET_FAILURE, ep(ef({}, this._getAnalyticsProperties()), {
      hostname: this.hostname,
    ...
    if (this.state !== el.hes.DISCONNECTED) {
      ...
      if (null != e && this.context === ec.Yn.DEFAULT) {
        if (e.stop(), this._sentVideo) {
          e.getOutboundStats().forEach(t => {
            var n;
            (null != (n = t.num_frames) ? n : 0) > 0 && Z.default.track(el.rMx.VIDEO_STREAM_ENDED, ep(ef(ep(ef({}, this._getAnalyticsProperties()), {
          ...
          null != t && t.camera_enabled_duration > 0 && Z.default.track(el.rMx.VIDEO_CALL_ENDED, ep(ef({}, t), {
            media_session_id: this.getMediaSessionId()
          }))
        }
        e.getInboundParticipants().forEach(t => {
          ...
          (null != (n = null == i ? true : i.num_frames) ? n : 0) > 0 && Z.default.track(el.rMx.VIDEO_STREAM_ENDED, ef(ep(ef({}, this._getAnalyticsProperties()), {
            app_hardware_acceleration_enabled: F.Z.getAppHardwareAccelerationEnabled(),
            media_session_id: this.getMediaSessionId(),
            sender_user_id: t,
            reason: r,
      ...
      j.Z.getMediaEngine().getCodecSurvey().then(e => {
        ...
        Z.default.track(el.rMx.VOICE_CODEC_DETECTED, ep(ef({}, n), {
      ...
      Promise.all([(async () => {
        ...
        Z.default.track(el.rMx.VOICE_DISCONNECT, ep(ef({}, s), {
          battery_usage: t,
          krisp_nc_model: n,
  ...
  _handleReady(e, t, n, r, i, a, o) {
    ...
    let l = j.Z.getMediaEngine(),
      ...
      d = (0, _.zO)(),
      h = l.connect(this.context, this.userId, ef({
        ssrc: i,
        address: t,
        port: n,
        modes: r,
    ...
    let b = ["unk"];
    this.context === ec.Yn.STREAM && (b.push("nvRelaxRc=250"), b.push("nvNewPresets")), j.Z.getUseVaapiEncoder() && b.push("vaapi"), (0, D.i)("RTCConnection").enabled && b.push("wmf-software-h264"), this.context === ec.Yn.STREAM && "streamer" === this.getVoiceParticipantType() && (0, P.t)("handleReady").enabled && b.push("useCaptureDeviceForEncode"), h.setVideoEncoderExperiments(b.join(",")), h.on(f.Sh.Speaking, (e, t, n) => {
      this.userId === e && this.sendSpeaking(t, n), this.emit(X.z.Speaking, eT(e), t)
      ...
      this._handleVideoStreamId({
        ...
        100 === t.quality && this.emit(X.z.VideoSourceQualityChanged, this.guildId, this.channelId, eT(e), t.maxResolution, t.maxFrameRate, this.context)
      }))
    }), h.on(f.Sh.FirstFrame, (e, t, n) => {
      null != this._localMediaSinkWantsManager && (this._localMediaSinkWantsManager.setFirstFrameReceived(t), this.emit(X.z.Video, this.guildId, this.channelId, eT(e), n, this.streamServerId)), null != this._goLiveQualityManager && (this._goLiveQualityManager.setFirstFrameReceived(t), this.emit(X.z.Video, this.guildId, this.channelId, eT(e), n, this.streamServerId))
    }), h.on(f.Sh.Silence, e => {
      ...
      let n = G.Z.shouldIncludePreferredRegion() ? G.Z.getPreferredRegion() : null;
      this.logger.error("Error occurred while connecting to RTC server: ".concat(t)), Z.default.track(el.rMx.VOICE_CONNECTION_FAILURE, ep(ef({}, this._getAnalyticsProperties()), {
        hostname: this.hostname,
        port: this.port,
        protocol: this.protocol,
        error: t,
      ...
      if (n === el.hes.RTC_CONNECTING && this.state === el.hes.RTC_DISCONNECTED ? this.reconnect() : this.state === el.hes.NO_ROUTE && (0 === this._backoff.fails && this._handleNoRoute(), this._backoff.fail(this.reconnect)), this.state === el.hes.RTC_CONNECTED) {
        ...
        if (this._connecting) {
          ...
          Z.default.track(el.rMx.VOICE_CONNECTION_SUCCESS, ef(ep(ef({}, n), {
            hostname: this.hostname,
            port: this.port,
            protocol: this.protocol,
            ...
            participant_type: this.getVoiceParticipantType(),
            join_voice_id: this.joinVoiceId,
            is_camera_enabled: j.Z.getMediaEngine().getVideoInputDeviceId() !== ec.Av && h.context === ec.Yn.DEFAULT
          }), this.stateHistory.getVoiceConnectionSuccessStats()));
          let r = performance.now(),
            i = (e, t) => null == e || null == t ? null : e - t;
          Z.default.track(el.rMx.VOICE_CONNECTION_TTC_COLLECTED, {
  ...
  _handleRemoteStreamsReady(e) {
    ...
    Z.default.track(el.rMx.VOICE_CONNECTION_REMOTE_STREAMS_CREATED, ep(ef({}, this._getAnalyticsProperties()), {
      number_of_users: e,
      duration_ms: t
    }))
  }
  ...
  _handleClientDisconnect(e) {
    ...
    if (null != s && this.context === ec.Yn.DEFAULT) {
      ...
      null != t && n > 0 && (Z.default.track(el.rMx.VIDEO_STREAM_ENDED, ef(ep(ef({}, this._getAnalyticsProperties()), {
        app_hardware_acceleration_enabled: F.Z.getAppHardwareAccelerationEnabled(),
        media_session_id: this.getMediaSessionId(),
        sender_user_id: e,
  ...
  _handleMediaSessionId(e) {
    ...
    Z.default.track(el.rMx.MEDIA_SESSION_JOINED, ep(ef({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      raw_thermal_state: t
    })), p.Z.dispatch({
  ...
  _trackSecureFrameTransition(e) {
    ...
    Z.default.track(el.rMx.SECURE_FRAMES_TRANSITION, ep(ef({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      sender_user_id: this.userId,
      transition_id: e,
  ...
  _trackMLSFailures(e) {
    ...
    for (let {
      ...
      of this._mlsFailures) Z.default.track(el.rMx.MLS_FAILURES, ep(ef({}, this._getAnalyticsProperties()), {
      media_session_id: i,
      parent_media_session_id: this.parentMediaSessionId,
      failure_id: e,
    ...
    super(), ed(this, "context", true), ed(this, "userId", true), ed(this, "sessionId", true), ed(this, "guildId", true), ed(this, "parentMediaSessionId", true), ed(this, "hostname", true), ed(this, "state", true), ed(this, "_videoQuality", true), ed(this, "_soundshareStats", true), ed(this, "logger", true), ed(this, "streamServerId", true), ed(this, "streamChannelId", true), ed(this, "_channelId", true), ed(this, "_nextChannelId", true), ed(this, "joinVoiceId", true), ed(this, "channelIds", true), ed(this, "_endpoint", true), ed(this, "port", true), ed(this, "token", true), ed(this, "protocol", true), ed(this, "voiceVersion", true), ed(this, "rtcWorkerVersion", true), ed(this, "_socket", true), ed(this, "_backoff", true), ed(this, "_destroyed", true), ed(this, "_pings", true), ed(this, "_pingBadCount", true), ed(this, "_pingTimeouts", true), ed(this, "_mediaSessionId", true), ed(this, "_voiceQuality", true), ed(this, "_voiceQualityPeriodicStatsInterval", true), ed(this, "_voiceQualityPeriodicStatsSequenceId", true), ed(this, "_systemResponsiveness", true), ed(this, "_systemResources", true), ed(this, "_noiseCancellationError", true), ed(this, "_voiceDuration", true), ed(this, "_videoHealthManager", true), ed(this, "_sentVideo", true), ed(this, "_outboundLossRate", true), ed(this, "_recordingEnabled", true), ed(this, "_selectedExperiments", true), ed(this, "_localMediaSinkWantsManager", true), ed(this, "_goLiveQualityManager", true), ed(this, "_remoteVideoSinkWants", true), ed(this, "_connection", true), ed(this, "_mediaEngineConnectionId", true), ed(this, "_createdTime", true), ed(this, "_connectStartTime", true), ed(this, "_connectCompletedTime", true), ed(this, "_rtcConnectionId", true), ed(this, "_connectCount", true), ed(this, "_connectionSerial", true), ed(this, "_connected", true), ed(this, "_connecting", true), ed(this, "_encountered_socket_failure", true), ed(this, "_inputDetected", true), ed(this, "_encryptionMode", true), ed(this, "stateHistory", true), ed(this, "_supportedBandwidthEstimationExperiments", true), ed(this, "_bandwidthEstimationExperiment", true), ed(this, "_secureFramesState", true), ed(this, "_userIds", true), ed(this, "_secureFramesRosterMap", new Map), ed(this, "_nextFailureId", 0), ed(this, "_mlsFailures", []), ed(this, "_secureFramesTransitionStates", new Map), ed(this, "_secureFramesNextTransitionState", true), ed(this, "_secureFramesMaxConcurrentTransitions", 0), ed(this, "_secureFramesTransitionPrepareCount", 0), ed(this, "_secureFramesTransitionExecuteCount", 0), ed(this, "_secureFramesLastBecameAloneTime", true), ed(this, "_mlsSessionResetStartTime", true), ed(this, "_mlsInitReceivedTime", true), ed(this, "_numNoiseCancellationChanges", 0), ed(this, "_fetchAsyncResourcesPromise", true), ed(this, "_lastSentSpeakingStatus", true), ed(this, "_lastSentSSRC", true), ed(this, "powerMonitorListener", true), ed(this, "reconnect", () => {
      ...
      if (null != this._voiceQuality) {
        ...
        if (this.shouldReportPeriodicStats(e))
          for (let t of e) Z.default.track(el.rMx.VOICE_QUALITY_PERIODIC_STATS, ep(ef({}, this._getAnalyticsProperties()), {
            media_session_id: this.getMediaSessionId(),
      ...
      let e = M.Z.getChannel(this.channelId),
        t = null == e ? true : e.type;
      Z.default.track(el.rMx.VOICE_CONNECTION_CONNECTING, ep(ef({}, this.getAudioDeviceStates(), this.getVideoDeviceStates()), {
        guild_id: this.guildId,
        channel_id: this.channelId,
        rtc_connection_id: this.getRTCConnectionId(),
        hostname: this.hostname,
