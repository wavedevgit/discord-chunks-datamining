...
function eN() {
  let e = [],
    t = (0, _.zO)();
  for (let n of eC) e.push(e_(ef({}, n), {
    t: t - n.t
  }));
...
class eP extends Chunk47770.Z {
  ...
  get quality() {
    ...
    return this.state !== el.hes.RTC_CONNECTED || true === e ? el.IE4.UNKNOWN : e > eE || null != this._outboundLossRate && this._outboundLossRate > ey ? el.IE4.BAD : e > eb || null != this._outboundLossRate && this._outboundLossRate > eO ? el.IE4.AVERAGE : el.IE4.FINE
  }
  get endpoint() {
  ...
  connect(e, t) {
    ...
    let i = this._socket;
    null != i && this._cleanupSocket(), null != this._nextChannelId && (this._channelId = this._nextChannelId, this._nextChannelId = true), (i = this._socket = new $.ZP(this.endpoint, this.context)).on($.VG.Connecting, this._handleConnecting.bind(this, i)), i.on($.VG.Connect, this._handleConnect.bind(this, i)), i.on($.VG.Disconnect, this._handleDisconnect.bind(this, i)), i.on($.VG.Resuming, this._handleResuming.bind(this, i)), i.on($.VG.Ready, this._handleReady.bind(this, i)), i.on($.VG.Speaking, this._handleSpeaking.bind(this, i)), i.on($.VG.Video, this._handleVideo.bind(this, i)), i.on($.VG.Ping, this._handleControlPing.bind(this)), i.on($.VG.ClientDisconnect, this._handleClientDisconnect.bind(this)), i.on($.VG.ClientConnect, this._handleClientConnect.bind(this)), i.on($.VG.Codecs, this._handleCodecs.bind(this)), i.on($.VG.MediaSessionId, this._handleMediaSessionId.bind(this)), i.on($.VG.MediaSinkWants, this._handleMediaSinkWants.bind(this)), i.on($.VG.VoiceBackendVersion, this._handleCodeVersion.bind(this)), i.on($.VG.KeyframeInterval, this._handleKeyframeInterval.bind(this)), i.on($.VG.Flags, this.handleFlags.bind(this)), i.on($.VG.Platform, this.handlePlatform.bind(this)), i.on($.VG.BandwidthEstimationExperiment, this._handleBandwidthEstimationExperiment.bind(this)), i.on($.VG.SecureFramesInit, this._handleSecureFramesInit.bind(this)), i.on($.VG.SecureFramesPrepareTransition, this._handleSecureFramesPrepareTransition.bind(this)), i.on($.VG.SecureFramesPrepareEpoch, this._handleSecureFramesPrepareEpoch.bind(this)), i.on($.VG.SecureFramesExecuteTransition, this._handleSecureFramesExecuteTransition.bind(this)), i.on($.VG.MLSExternalSenderPackage, this._handleMLSExternalSenderPackage.bind(this)), i.on($.VG.MLSProposals, this._handleMLSProposals.bind(this, i)), i.on($.VG.MLSPrepareCommitTransition, this._handleMLSPrepareCommitTransition.bind(this)), i.on($.VG.MLSWelcome, this._handleMLSWelcome.bind(this)), i.on($.VG.ReceiveMessage, this._recordMessageEvent.bind(this, 4)), i.on($.VG.SendMessage, this._recordMessageEvent.bind(this, 5)), this._connectStartTime = (0, _.zO)(), this._connectCount++, this._connecting = true, null != i && this._socket === i && (this._trackVoiceConnectionConnecting(), this._encountered_socket_failure = false, i.connect())
  }
  ...
  setVideoSize(e, t, n) {
    var r, i;
    null == t || (0, W.isAndroid)() || (0, W.isIOS)() || null == (i = this._localMediaSinkWantsManager) || i.setVideoSize(e, t.width * t.height), null == (r = this._goLiveQualityManager) || r.setVideoSize(e, t, n)
  }
  clearJoinVoiceId() {
  ...
  _chooseExperiments(e) {
    let t = [];
    if (this._recordingEnabled && t.push("connection_log"), U.Z.supports(ec.AN.FIXED_KEYFRAME_INTERVAL) && t.push("fixed_keyframe_interval"), 0 !== this._supportedBandwidthEstimationExperiments.length) {
  ...
  _handleConnect(e) {
    ...
    this.logger.info("Connected to RTC server."), this._fetchAsyncResourcesPromise.finally(() => {
      e.identify({
        ...
        token: t,
        maxDaveProtocolVersion: U.Z.getSupportedSecureFramesProtocolVersion(),
        video: U.Z.supports(ec.AN.VIDEO),
  ...
  _handleDisconnect(e, t, n, r) {
    ...
    this.logger.info("Disconnected from RTC server, clean: ".concat(t, ", code: ").concat(n, ", reason: ").concat(r, ", state: ").concat(this.state)), t || !this._connecting || this._encountered_socket_failure || (V.default.track(el.rMx.VOICE_CONNECTION_SOCKET_FAILURE, e_(ef({}, this._getAnalyticsProperties()), {
      ...
      code: n,
      reason: r
    })), this._encountered_socket_failure = true), G.Z.getRemoteDisconnectVoiceChannelId() === this.channelId && (null == (l = this._connection) || l.wasRemoteDisconnected());
    let A = "Force Close" !== r;
    if (A) {
    ...
    if (this.state !== el.hes.DISCONNECTED) {
      ...
      if (null != e && this.context === ec.Yn.DEFAULT) {
        if (e.stop(), this._sentVideo) {
          e.getOutboundStats().forEach(t => {
            var n;
            (null != (n = t.num_frames) ? n : 0) > 0 && V.default.track(el.rMx.VIDEO_STREAM_ENDED, e_(ef(e_(ef({}, this._getAnalyticsProperties()), {
              app_hardware_acceleration_enabled: H.Z.getAppHardwareAccelerationEnabled(),
          ...
          null != t && t.camera_enabled_duration > 0 && V.default.track(el.rMx.VIDEO_CALL_ENDED, e_(ef({}, t), {
            media_session_id: this.getMediaSessionId()
          }))
        }
        e.getInboundParticipants().forEach(t => {
          ...
          (null != (n = null == i ? true : i.num_frames) ? n : 0) > 0 && V.default.track(el.rMx.VIDEO_STREAM_ENDED, ef(e_(ef({}, this._getAnalyticsProperties()), {
            app_hardware_acceleration_enabled: H.Z.getAppHardwareAccelerationEnabled(),
            media_session_id: this.getMediaSessionId(),
            sender_user_id: t,
            reason: r,
      ...
      let n = F.Z.shouldIncludePreferredRegion() ? F.Z.getPreferredRegion() : null,
        ...
        s = e_(ef(e_(ef({}, this._getAnalyticsProperties()), {
          ...
          no_input_detected_notice: U.Z.getNoInputDetectedNotice(),
          ...
          audio_subsystem: U.Z.getMediaEngine().getAudioSubsystem(),
          audio_layer: U.Z.getMediaEngine().getAudioLayer(),
          ...
          krisp_sdk_version: U.Z.getState().krispVersion,
          ...
          soundshare_experimental: U.Z.getExperimentalSoundshare(),
          join_voice_id: this.joinVoiceId,
          bypass_system_input_processing: i.bypassSystemInputProcessing,
          system_microphone_mode: U.Z.getSystemMicrophoneMode()
        });
      Promise.all([(async () => {
        var e, t;
      ...
      })(), L.Z.getKrispModel(), U.Z.getKrispEnableStats() ? U.Z.getMediaEngine().getNoiseCancellationStats() : Promise.resolve(null)]).then(e => {
        let [{
          batteryUsageRounded: t
        }, n, r] = e;
        V.default.track(el.rMx.VOICE_DISCONNECT, e_(ef({}, s), {
          battery_usage: t,
          krisp_nc_model: n,
  ...
  _handleReady(e, t, n, r, i, a, o) {
    ...
    let l = U.Z.getMediaEngine(),
      c = j.Z.getPersistentCodesEnabled(),
    ...
    U.Z.getUseVaapiEncoder() && E.push("vaapi"), this.context === ec.Yn.STREAM && "streamer" === this.getVoiceParticipantType() && (0, x.t)("handleReady").enabled && E.push("useCaptureDeviceForEncode"), f.setVideoEncoderExperiments(E.join(",")), f.on(p.Sh.Speaking, (e, t, n) => {
      ...
      switch (this._voiceQuality = new eo.Z(f), this._voiceQuality.start(), this._voiceQuality.on(eo.B.InputDeviceSampleRateChanged, e => {
        ...
        case "udp":
          this.logger.info("Sending UDP info to RTC server.", i, this._selectedExperiments), e.once($.VG.Encryption, (e, t) => {
          ...
          break;
        case "webrtc":
          this.logger.info("Sending local SDP to RTC server."), e.once($.VG.SDP, this._handleSDP.bind(this)), e.selectProtocol(r, this.getRTCConnectionId(), i);
          break;
        default:
      ...
      let n = k.Z.getChannel(this.channelId),
        r = (null == n ? true : n.type) === el.d4z.GUILD_STAGE_VOICE;
      if (!U.Z.isVideoDecoderFallbackEnabled() || r) {
        if (!this._videoDecoderFallbackSuppressed) {
          let e = U.Z.isVideoDecoderFallbackEnabled() ? "stage channel" : "not in fallback treatment";
      ...
      let n = F.Z.shouldIncludePreferredRegion() ? F.Z.getPreferredRegion() : null;
      this.logger.error("Error occurred while connecting to RTC server: ".concat(t)), V.default.track(el.rMx.VOICE_CONNECTION_FAILURE, e_(ef({}, this._getAnalyticsProperties()), {
        hostname: this.hostname,
        port: this.port,
        protocol: this.protocol,
        error: t,
      ...
      if (n === el.hes.RTC_CONNECTING && this.state === el.hes.RTC_DISCONNECTED ? this.reconnect() : this.state === el.hes.NO_ROUTE && (0 === this._backoff.fails && this._handleNoRoute(), this._backoff.fail(this.reconnect)), this.state === el.hes.RTC_CONNECTED) {
        ...
        if (this._connecting) {
          ...
          V.default.track(el.rMx.VOICE_CONNECTION_SUCCESS, ef(e_(ef({}, n), {
            hostname: this.hostname,
            port: this.port,
            protocol: this.protocol,
            ...
            participant_type: this.getVoiceParticipantType(),
            join_voice_id: this.joinVoiceId,
            is_camera_enabled: U.Z.getMediaEngine().getVideoInputDeviceId() !== ec.Av && f.context === ec.Yn.DEFAULT
  ...
  getOrCreateVideoQuality() {
    if (null != this._connection && null == this._videoQuality) {
      this._videoQuality = new ei.S(this._connection), this._videoQuality.updateCallUserIdsCount(this._userIds.size), this._videoQuality.start();
      let {
        featureEnabled: e,
        windowLength: t,
      ...
      if (e) {
        this._videoHealthManager = new er.y(t, n, r, i), null != this._localMediaSinkWantsManager && (this._localMediaSinkWantsManager.videoHealthManager = this._videoHealthManager);
        let e = (e, t, n) => {
          var r, i;
  ...
  _handleRemoteStreamsReady(e) {
    ...
    V.default.track(el.rMx.VOICE_CONNECTION_REMOTE_STREAMS_CREATED, e_(ef({}, this._getAnalyticsProperties()), {
      number_of_users: e,
      duration_ms: t
    }))
  }
  ...
  _handleControlPing(e) {
    U.Z.supports(ec.AN.NATIVE_PING) || this._handlePing(e)
  }
  _handlePing(e) {
    if (true !== e) {
  ...
  _handleClientDisconnect(e) {
    ...
    if (null != s && this.context === ec.Yn.DEFAULT) {
      ...
      null != t && n > 0 && (V.default.track(el.rMx.VIDEO_STREAM_ENDED, ef(e_(ef({}, this._getAnalyticsProperties()), {
        app_hardware_acceleration_enabled: H.Z.getAppHardwareAccelerationEnabled(),
        media_session_id: this.getMediaSessionId(),
        sender_user_id: e,
  ...
  _handleMediaSessionId(e) {
    ...
    V.default.track(el.rMx.MEDIA_SESSION_JOINED, e_(ef({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      raw_thermal_state: t
    })), h.Z.dispatch({
  ...
  _trackSecureFrameTransition(e) {
    ...
    V.default.track(el.rMx.SECURE_FRAMES_TRANSITION, e_(ef({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      sender_user_id: this.userId,
      transition_id: e,
  ...
  _trackMLSFailures(e) {
    ...
    for (let {
      ...
      of this._mlsFailures) V.default.track(el.rMx.MLS_FAILURES, e_(ef({}, this._getAnalyticsProperties()), {
      media_session_id: i,
      parent_media_session_id: this.parentMediaSessionId,
      failure_id: e,
  ...
  getInputDeviceName() {
    ...
    return null == (e = U.Z.getInputDevices()[t]) ? true : e.name
  }
  getOutputDeviceName() {
    var e;
    let t = U.Z.getOutputDeviceId();
    return null == (e = U.Z.getOutputDevices()[t]) ? true : e.name
  }
  getVideoDeviceName() {
    var e;
    let t = U.Z.getVideoDeviceId();
    return null == (e = U.Z.getVideoDevices()[t]) ? true : e.name
  }
  ...
  constructor({
    ...
    super(), ed(this, "context", true), ed(this, "userId", true), ed(this, "sessionId", true), ed(this, "guildId", true), ed(this, "parentMediaSessionId", true), ed(this, "hostname", true), ed(this, "state", true), ed(this, "_videoQuality", true), ed(this, "logger", true), ed(this, "streamServerId", true), ed(this, "streamChannelId", true), ed(this, "_channelId", true), ed(this, "_nextChannelId", true), ed(this, "joinVoiceId", true), ed(this, "channelIds", true), ed(this, "_endpoint", true), ed(this, "port", true), ed(this, "token", true), ed(this, "protocol", true), ed(this, "voiceVersion", true), ed(this, "rtcWorkerVersion", true), ed(this, "_socket", true), ed(this, "_backoff", true), ed(this, "_destroyed", true), ed(this, "_pings", true), ed(this, "_pingBadCount", true), ed(this, "_pingTimeouts", true), ed(this, "_mediaSessionId", true), ed(this, "_voiceQuality", true), ed(this, "_voiceQualityPeriodicStatsInterval", true), ed(this, "_voiceQualityPeriodicStatsSequenceId", true), ed(this, "_systemResponsiveness", true), ed(this, "_systemResources", true), ed(this, "_noiseCancellationError", true), ed(this, "_voiceDuration", true), ed(this, "_videoHealthManager", true), ed(this, "_sentVideo", true), ed(this, "_videoDecoderFallbackSuppressed", true), ed(this, "_outboundLossRate", true), ed(this, "_recordingEnabled", true), ed(this, "_selectedExperiments", true), ed(this, "_localMediaSinkWantsManager", true), ed(this, "_goLiveQualityManager", true), ed(this, "_remoteVideoSinkWants", true), ed(this, "_connection", true), ed(this, "_mediaEngineConnectionId", true), ed(this, "_createdTime", true), ed(this, "_connectStartTime", true), ed(this, "_connectCompletedTime", true), ed(this, "_rtcConnectionId", true), ed(this, "_connectCount", true), ed(this, "_connectionSerial", true), ed(this, "_connected", true), ed(this, "_connecting", true), ed(this, "_encountered_socket_failure", true), ed(this, "_inputDetected", true), ed(this, "_encryptionMode", true), ed(this, "stateHistory", true), ed(this, "_supportedBandwidthEstimationExperiments", true), ed(this, "_bandwidthEstimationExperiment", true), ed(this, "_secureFramesState", true), ed(this, "_userIds", true), ed(this, "_secureFramesRosterMap", new Map), ed(this, "reconnecting", false), ed(this, "_nextFailureId", 0), ed(this, "_mlsFailures", []), ed(this, "_secureFramesTransitionStates", new Map), ed(this, "_secureFramesNextTransitionState", true), ed(this, "_secureFramesMaxConcurrentTransitions", 0), ed(this, "_secureFramesTransitionPrepareCount", 0), ed(this, "_secureFramesTransitionExecuteCount", 0), ed(this, "_secureFramesLastBecameAloneTime", true), ed(this, "_mlsSessionResetStartTime", true), ed(this, "_mlsInitReceivedTime", true), ed(this, "_numNoiseCancellationChanges", 0), ed(this, "_fetchAsyncResourcesPromise", true), ed(this, "_lastSentSpeakingStatus", true), ed(this, "_lastSentSSRC", true), ed(this, "powerMonitorListener", true), ed(this, "reconnect", () => {
      ...
      if (null != this._voiceQuality) {
        ...
        if (this.shouldReportPeriodicStats(e))
          for (let t of e) V.default.track(el.rMx.VOICE_QUALITY_PERIODIC_STATS, e_(ef({}, this._getAnalyticsProperties()), {
            media_session_id: this.getMediaSessionId(),
      ...
      input_device: this.getInputDeviceName(),
      input_device_count: Object.keys(U.Z.getInputDevices()).length,
      output_device: this.getOutputDeviceName(),
      output_device_count: Object.keys(U.Z.getOutputDevices()).length
    })), ed(this, "getVideoDeviceStates", () => ({
      camera_device: this.getVideoDeviceName(),
      camera_device_count: Object.keys(U.Z.getVideoDevices()).length
    })), ed(this, "_trackVoiceConnectionConnecting", () => {
      let e = k.Z.getChannel(this.channelId),
        t = null == e ? true : e.type;
      V.default.track(el.rMx.VOICE_CONNECTION_CONNECTING, e_(ef({}, this.getAudioDeviceStates(), this.getVideoDeviceStates()), {
        guild_id: this.guildId,
        channel_id: this.channelId,
        rtc_connection_id: this.getRTCConnectionId(),
        hostname: this.hostname,
    ...
    this._remoteVideoSinkWants = ee.Yy, es.w.on(es.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged), es.w.on(es.e.WindowVisibilityChanged, this.windowVisibilityChanged), Z.ZP.shouldRecordNextConnection() ? (this._recordingEnabled = true, E.TC(false)) : this._recordingEnabled = false, Y.Z.addOnlineCallback(this._handleNetworkOnline), Y.Z.addOfflineCallback(this._handleNetworkOffline), (0, W.isDesktop)() && (this.powerMonitorListener = q.Z.remotePowerMonitor.on("resume", this._handlePowerResume)), this._supportedBandwidthEstimationExperiments = [], this._bandwidthEstimationExperiment = null, U.Z.getMediaEngine().getSupportedBandwidthEstimationExperiments(e => {
