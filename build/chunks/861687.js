...
class ev extends d.Z {
  ...
  _handleReady(e, t, n, r, i, a, o) {
    ...
    let l = x.Z.getMediaEngine(),
      ...
      d = l.connect(this.context, this.userId, ec({
        ssrc: i,
        address: t,
        port: n,
        modes: r,
    ...
    let p = ["unk"];
    this.context === es.Yn.STREAM && (p.push("nvRelaxRc=250"), p.push("nvNewPresets")), d.setVideoEncoderExperiments(p.join(",")), d.on(_.Sh.Speaking, (e, t, n) => {
      ...
      if (n === eo.hes.RTC_CONNECTING && this.state === eo.hes.RTC_DISCONNECTED ? this.reconnect() : this.state === eo.hes.NO_ROUTE && (0 === this._backoff.fails && this._handleNoRoute(), this._backoff.fail(this.reconnect)), this.state === eo.hes.RTC_CONNECTED) {
        ...
        if (this._connecting) {
          ...
          G.default.track(eo.rMx.VOICE_CONNECTION_SUCCESS, ec(ed(ec({}, this._getAnalyticsProperties()), {
            hostname: this.hostname,
            port: this.port,
            protocol: this.protocol,
        ...
        null == (r = this._localMediaSinkWantsManager) || r.setConnection(d), null == (i = this._goLiveQualityManager) || i.update(), this._connectCompletedTime = (0, f.zO)(), this._connected = !0, this._connecting = !1, this._encountered_socket_failure = !1
    ...
    }), d.on(_.Sh.Ping, this._handlePing.bind(this)), d.on(_.Sh.PingTimeout, this._handlePingTimeout.bind(this)), d.on(_.Sh.OutboundLossRate, this._handleOutboundLossRate.bind(this)), d.on(_.Sh.SoundshareTrace, this._handleSoundshareTrace.bind(this)), d.on(_.Sh.LocalVideoDisabled, this._handleLocalVideoDisabled.bind(this)), d.on(_.Sh.Stats, K.Z.create()), d.on(_.Sh.RemoteStreamsReady, this._handleRemoteStreamsReady.bind(this)), d.on(_.Sh.UsersMerged, this.handleUsersMerged.bind(this)), d.on(_.Sh.NoiseCancellationError, e => {
      this._noiseCancellationError = e
    }), d.on(_.Sh.MLSFailure, this._handleMLSFailure.bind(this)), d.setRemoteVideoSinkWants(this._remoteVideoSinkWants), this._connection = d, this._mediaEngineConnectionId = d.mediaEngineConnectionId
  }
