...
class eO extends d.Z {
  get quality() {
    ...
    return this.state !== ea.hes.RTC_CONNECTED || void 0 === e ? ea.IE4.UNKNOWN : e > ep || null != this._outboundLossRate && this._outboundLossRate > em ? ea.IE4.BAD : e > eh || null != this._outboundLossRate && this._outboundLossRate > eg ? ea.IE4.AVERAGE : ea.IE4.FINE
  }
  get endpoint() {
  ...
  destroy() {
    var e, t, n, r, i, a, o;
    if (this.logger.info("Destroy RTCConnection"), V.Z.removeOnlineCallback(this._handleNetworkOnline), V.Z.removeOfflineCallback(this._handleNetworkOffline), (0, Z.isDesktop)() && (null == (a = (o = this).powerMonitorListener) || a.call(o)), ei.w.off(ei.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged), ei.w.off(ei.e.WindowVisibilityChanged, this.windowVisibilityChanged), this._backoff.cancel(), this._cleanupSocket(), null == (e = this._voiceQuality) || e.stop(), this._voiceQuality = null, clearInterval(this._voiceQualityPeriodicStatsInterval), this._voiceQualityPeriodicStatsInterval = null, this._voiceQualityPeriodicStatsSequenceId = 0, null == (t = this._systemResponsiveness) || t.stop(), this._systemResponsiveness = null, this._noiseCancellationError = 0, null == (n = this._voiceDuration) || n.stop(), this._voiceDuration = null, null == (r = this._videoQuality) || r.stop(), this._videoQuality = null, this._videoHealthManager = null, this._secureFramesState = null, null == (i = this._localMediaSinkWantsManager) || i.reset(), null != this._connection) {
  ...
  shouldSendSpeaking(e, t) {
    ...
    let n = (0, F.yE)(e, eo.Dg.PRIORITY),
      r = (0, F.yE)(this._lastSentSpeakingStatus, eo.Dg.PRIORITY);
  ...
  _chooseExperiments(e) {
    ...
    if (x.Z.supports(eo.AN.FIXED_KEYFRAME_INTERVAL) && t.push("fixed_keyframe_interval"), 0 !== this._supportedBandwidthEstimationExperiments.length) {
  ...
  _handleDisconnect(e, t, n, r) {
    ...
    this.logger.info("Disconnected from RTC server, clean: ".concat(t, ", code: ").concat(n, ", reason: ").concat(r, ", state: ").concat(this.state)), t || !this._connecting || this._encountered_socket_failure || (G.default.track(ea.rMx.VOICE_CONNECTION_SOCKET_FAILURE, eu(el({}, this._getAnalyticsProperties()), {
      hostname: this.hostname,
    ...
    if (this.state !== ea.hes.DISCONNECTED) {
      ...
      null != e && this.context === eo.Yn.DEFAULT && (e.stop(), this._sentVideo && e.getOutboundStats().forEach(t => {
        var n;
        (null != (n = t.num_frames) ? n : 0) > 0 && G.default.track(ea.rMx.VIDEO_STREAM_ENDED, eu(el(eu(el({}, this._getAnalyticsProperties()), {
        ...
        (null != (n = null == i ? void 0 : i.num_frames) ? n : 0) > 0 && G.default.track(ea.rMx.VIDEO_STREAM_ENDED, el(eu(el({}, this._getAnalyticsProperties()), {
          app_hardware_acceleration_enabled: B.Z.getAppHardwareAccelerationEnabled(),
          media_session_id: this.getMediaSessionId(),
          sender_user_id: t,
          reason: r,
      ...
      x.Z.getMediaEngine().getCodecSurvey().then(e => {
        ...
        G.default.track(ea.rMx.VOICE_CODEC_DETECTED, eu(el({}, n), {
      ...
      (async () => {
        ...
        G.default.track(ea.rMx.VOICE_DISCONNECT, eu(el({}, s), {
          battery_usage: t
        }))
      })
    }
  ...
  _handleReady(e, t, n, r, i, a, o) {
    ...
    h.setUseElectronVideo(u.supports(eo.AN.ELECTRON_VIDEO)), x.Z.supports(eo.AN.IMAGE_QUALITY_MEASUREMENT) && h.setVideoQualityMeasurement("imageQualityWebrtcPsnrDb:5000,imageQualityVmaf_v061:5000,hwdec");
    let g = ["unk"];
    ...
    h.setVideoEncoderExperiments(g.join(",")), h.on(f.Sh.Speaking, (e, t, n) => {
      ...
      let n = j.Z.shouldIncludePreferredRegion() ? j.Z.getPreferredRegion() : null;
      this.logger.error("Error occurred while connecting to RTC server: ".concat(t)), G.default.track(ea.rMx.VOICE_CONNECTION_FAILURE, eu(el({}, this._getAnalyticsProperties()), {
        hostname: this.hostname,
        port: this.port,
        protocol: this.protocol,
        error: t,
      ...
      if (n === ea.hes.RTC_CONNECTING && this.state === ea.hes.RTC_DISCONNECTED ? this.reconnect() : this.state === ea.hes.NO_ROUTE && (0 === this._backoff.fails && this._handleNoRoute(), this._backoff.fail(this.reconnect)), this.state === ea.hes.RTC_CONNECTED) {
        ...
        if (this._connecting) {
          ...
          G.default.track(ea.rMx.VOICE_CONNECTION_SUCCESS, el(eu(el({}, this._getAnalyticsProperties()), {
            hostname: this.hostname,
            port: this.port,
            protocol: this.protocol,
  ...
  _handleSpeaking(e, t, n, r) {
    ...
    if (null != i && this.userId !== t) {
      var a;
      r !== eo.Dg.NONE && (i.createUser(t, n), p.Z.dispatch({
  ...
  _handleVideoStreamId(e) {
    ...
    if (this.emit(K.z.Video, this.guildId, this.channelId, a, o, this.rtcServerId), null != o && null == this.getOrCreateVideoQuality() && this.logger.error("_handleVideoStreamId: Unable to create videoQuality."), null != this._videoQuality && this.userId === a && l.forEach(e => {
        var t, n;
  ...
  _handleRemoteStreamsReady(e) {
    ...
    G.default.track(ea.rMx.VOICE_CONNECTION_REMOTE_STREAMS_CREATED, eu(el({}, this._getAnalyticsProperties()), {
      number_of_users: e,
      duration_ms: t
    }))
  }
  ...
  _handleClientDisconnect(e) {
    ...
    if (null != o && this.context === eo.Yn.DEFAULT) {
      ...
      null != t && n > 0 && (G.default.track(ea.rMx.VIDEO_STREAM_ENDED, el(eu(el({}, this._getAnalyticsProperties()), {
        app_hardware_acceleration_enabled: B.Z.getAppHardwareAccelerationEnabled(),
        media_session_id: this.getMediaSessionId(),
        sender_user_id: e,
        ...
        hostname: this.hostname,
        hardware_enabled: x.Z.getHardwareEncoding()
      }), t, o.getNetworkStats(), o.getCodecUsageStats("receiver", e))), o.destroyUser(e), null == (a = this._videoHealthManager) || a.deleteUser(e))
    }
  ...
  _handleMediaSessionId(e) {
    ...
    G.default.track(ea.rMx.MEDIA_SESSION_JOINED, eu(el({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      raw_thermal_state: t
    })), p.Z.dispatch({
  ...
  _trackSecureFrameTransition(e, t) {
    G.default.track(ea.rMx.SECURE_FRAMES_TRANSITION, eu(el({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      sender_user_id: this.userId,
      transition_id: e,
  ...
  _trackMLSFailures() {
    ...
    for (let [n, r, i, a] of e) G.default.track(ea.rMx.MLS_FAILURES, eu(el({}, this._getAnalyticsProperties()), {
      media_session_id: t,
      parent_media_session_id: this.parentMediaSessionId,
      failure_source: n,
      failure_reason: r,
  ...
  constructor({
    ...
    super(), es(this, "context", void 0), es(this, "userId", void 0), es(this, "sessionId", void 0), es(this, "guildId", void 0), es(this, "parentMediaSessionId", void 0), es(this, "hostname", void 0), es(this, "state", void 0), es(this, "_videoQuality", void 0), es(this, "_soundshareStats", void 0), es(this, "logger", void 0), es(this, "rtcServerId", void 0), es(this, "_channelId", void 0), es(this, "channelIds", void 0), es(this, "_endpoint", void 0), es(this, "port", void 0), es(this, "token", void 0), es(this, "protocol", void 0), es(this, "voiceVersion", void 0), es(this, "rtcWorkerVersion", void 0), es(this, "_socket", void 0), es(this, "_backoff", void 0), es(this, "_destroyed", void 0), es(this, "_pings", void 0), es(this, "_pingBadCount", void 0), es(this, "_pingTimeouts", void 0), es(this, "_mediaSessionId", void 0), es(this, "_voiceQuality", void 0), es(this, "_voiceQualityPeriodicStatsInterval", void 0), es(this, "_voiceQualityPeriodicStatsSequenceId", void 0), es(this, "_systemResponsiveness", void 0), es(this, "_systemResources", void 0), es(this, "_noiseCancellationError", void 0), es(this, "_voiceDuration", void 0), es(this, "_videoHealthManager", void 0), es(this, "_sentVideo", void 0), es(this, "_outboundLossRate", void 0), es(this, "_recordingEnabled", void 0), es(this, "_selectedExperiments", void 0), es(this, "_localMediaSinkWantsManager", void 0), es(this, "_goLiveQualityManager", void 0), es(this, "_remoteVideoSinkWants", void 0), es(this, "_connection", void 0), es(this, "_mediaEngineConnectionId", void 0), es(this, "_createdTime", void 0), es(this, "_connectStartTime", void 0), es(this, "_connectCompletedTime", void 0), es(this, "_rtcConnectionId", void 0), es(this, "_connectCount", void 0), es(this, "_connected", void 0), es(this, "_connecting", void 0), es(this, "_encountered_socket_failure", void 0), es(this, "_inputDetected", void 0), es(this, "_encryptionMode", void 0), es(this, "stateHistory", void 0), es(this, "_supportedBandwidthEstimationExperiments", void 0), es(this, "_bandwidthEstimationExperiment", void 0), es(this, "_secureFramesState", void 0), es(this, "_userIds", void 0), es(this, "_secureFramesRosterMap", new Map), es(this, "_mlsFailuresRecovered", void 0), es(this, "_mlsFailures", void 0), es(this, "_lastSentSpeakingStatus", void 0), es(this, "_lastSentSSRC", void 0), es(this, "powerMonitorListener", void 0), es(this, "reconnect", () => {
      ...
      if (null != this._voiceQuality) {
        ...
        if (this.shouldReportPeriodicStats(e))
          for (let t of e) G.default.track(ea.rMx.VOICE_QUALITY_PERIODIC_STATS, eu(el({}, this._getAnalyticsProperties()), {
            media_session_id: this.getMediaSessionId(),
      ...
      let e = L.Z.getChannel(this.channelId),
        t = null == e ? void 0 : e.type;
      G.default.track(ea.rMx.VOICE_CONNECTION_CONNECTING, eu(el({}, this.getAudioDeviceStates(), this.getVideoDeviceStates()), {
        guild_id: this.guildId,
        channel_id: this.channelId,
        rtc_connection_id: this.getRTCConnectionId(),
        hostname: this.hostname,
    ...
    } else i === eo.Yn.STREAM && (this._goLiveQualityManager = new v.Z(!0), this._goLiveQualityManager.on(v.y.RequestedSSRCsUpdate, (e, t, n) => {
      var r;
      null == (r = this._connection) || r.createUser(e, t, n)
