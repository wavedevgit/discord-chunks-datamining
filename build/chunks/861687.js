...
class eE extends f.Z {
  ...
  set endpoint(e) {
    if (null == e) this._endpoint = null, this.hostname = null;
      ...
      let {
        hostname: n,
        port: r
      } = null !== (t = F.Z.toURLSafe(e)) && void 0 !== t ? t : {}, i = null != r ? parseInt(r) : NaN;
  ...
  setState(e) {
    ...
    this.logger.info("RTC connection state: ".concat(this.state, " => ").concat(e)), this.state = e, this.stateHistory.update(this.state), this.emit(W.z.State, e, {
  ...
  _handleDisconnect(e, t, n, r) {
    ...
    this.logger.info("Disconnected from RTC server, clean: ".concat(t, ", code: ").concat(n, ", reason: ").concat(r, ", state: ").concat(this.state)), t || !this._connecting || this._encountered_socket_failure || (U.default.track(en.rMx.VOICE_CONNECTION_SOCKET_FAILURE, es(eo({}, this._getAnalyticsProperties()), {
      hostname: this.hostname,
    ...
    if (this.state !== en.hes.DISCONNECTED) {
      ...
      null != e && this.context === er.Yn.DEFAULT && (e.stop(), this._sentVideo && e.getOutboundStats().forEach(t => {
        var n;
        (null !== (n = t.num_frames) && void 0 !== n ? n : 0) > 0 && U.default.track(en.rMx.VIDEO_STREAM_ENDED, es(eo(es(eo({}, this._getAnalyticsProperties()), {
        ...
        (null !== (n = null == i ? void 0 : i.num_frames) && void 0 !== n ? n : 0) > 0 && U.default.track(en.rMx.VIDEO_STREAM_ENDED, eo(es(eo({}, this._getAnalyticsProperties()), {
          media_session_id: this.getMediaSessionId(),
          sender_user_id: t,
          reason: r,
      ...
      U.default.track(en.rMx.VOICE_DISCONNECT, es(eo(es(eo({}, this._getAnalyticsProperties()), {
        hostname: this.hostname,
        port: this.port,
      ...
      L.Z.getMediaEngine().getCodecSurvey().then(e => {
        ...
        U.default.track(en.rMx.VOICE_CODEC_DETECTED, es(eo({}, t), {
    ...
    this.setState(en.hes.DISCONNECTED, {
      willReconnect: S
    })
  }
  _handleResuming(e) {
  ...
  _handleReady(e, t, n, r, i, o, a) {
    var s;
    this.setState(en.hes.RTC_CONNECTING), this.port = n, null != a && this._chooseExperiments(a), 0 === o.length && o.push({
      type: er.Tr.VIDEO,
      rid: "100",
      ssrc: i + 1,
      rtxSsrc: i + 2,
    ...
    let l = L.Z.getMediaEngine(),
      ...
      d = l.connect(this.context, this.userId, eo({
        ssrc: i,
        address: t,
        port: n,
        modes: r,
    ...
    let f = ["unk"];
    this.context === er.Yn.STREAM && (f.push("nvRelaxRc=250"), f.push("nvNewPresets")), d.setVideoEncoderExperiments(f.join(",")), d.on(_.Sh.Speaking, (e, t, n) => {
      this.userId === e && this.sendSpeaking(t, n), this.emit(W.z.Speaking, eg(e), t)
    }), d.on(_.Sh.ToggleMuteFromNative, () => {
      this.context === er.Yn.DEFAULT && g.Z.toggleSelfMute({
        playSoundEffect: !1
      })
    }), d.on(_.Sh.NativeMuteChanged, e => {
      this.context === er.Yn.DEFAULT && v.Z.nativeMuteChanged(e)
      ...
      switch (this._voiceQuality = new ee.Z(d), this._voiceQuality.start(), this._voiceQualityPeriodicStatsSequenceId = 0, this._voiceQualityPeriodicStatsInterval = setInterval(this._handleVoiceQualityPeriodicsStats, 3e5), this._systemResponsiveness = new Q.Z(d), this._systemResponsiveness.start(), this._noiseCancellationError = 0, this._voiceDuration = new $.Z(this.userId, d), this._voiceDuration.start(d.getSelfMute(), d.getVoiceFilterId()), this.protocol = r, r) {
        case "udp":
          this.logger.info("Sending UDP info to RTC server.", i, this._selectedExperiments), e.once(K.V.Encryption, (e, t) => {
      ...
      this.logger.error("Error occurred while connecting to RTC server: ".concat(t)), U.default.track(en.rMx.VOICE_CONNECTION_FAILURE, es(eo({}, this._getAnalyticsProperties()), {
        hostname: this.hostname,
        port: this.port,
        protocol: this.protocol,
        error: t,
      ...
      if (n === en.hes.RTC_CONNECTING && this.state === en.hes.RTC_DISCONNECTED ? this.reconnect() : this.state === en.hes.NO_ROUTE && (0 === this._backoff.fails && this._handleNoRoute(), this._backoff.fail(this.reconnect)), this.state === en.hes.RTC_CONNECTED) {
        ...
        if (this._connecting) {
          ...
          U.default.track(en.rMx.VOICE_CONNECTION_SUCCESS, eo(es(eo({}, this._getAnalyticsProperties()), {
            hostname: this.hostname,
            port: this.port,
            protocol: this.protocol,
  ...
  _handleSpeaking(e, t, n, r) {
    ...
    if (null != i && this.userId !== t) {
      var o;
      r !== er.Dg.NONE && (i.createUser(t, n), h.Z.dispatch({
  ...
  _handleVideoStreamId(e) {
    ...
    if (this.emit(W.z.Video, this.guildId, this.channelId, o, a, this.rtcServerId), null != a && null == this.getOrCreateVideoQuality() && this.logger.error("_handleVideoStreamId: Unable to create videoQuality."), null != this._videoQuality && this.userId === o && l.forEach(e => {
        var t, n;
  ...
  _handleRemoteStreamsReady(e) {
    ...
    U.default.track(en.rMx.VOICE_CONNECTION_REMOTE_STREAMS_CREATED, es(eo({}, this._getAnalyticsProperties()), {
      number_of_users: e,
      duration_ms: t
    }))
  }
  ...
  _handlePing(e) {
    if (void 0 !== e) {
      for (this._pings.push({
          time: Date.now(),
          value: e
        }); this._pings.length >= ec;) this._pings.shift();
  ...
  _handleClientConnect(e) {
    ...
    }), this.emit(W.z.ClientConnect, e), null === (t = this._goLiveQualityManager) || void 0 === t || t.updateCallUserIds(this._userIds), null === (n = this._localMediaSinkWantsManager) || void 0 === n || n.updateCallUserIds(this._userIds)
  }
  _handleClientDisconnect(e) {
    ...
    if (null != a && this.context === er.Yn.DEFAULT) {
      ...
      null != t && n > 0 && (U.default.track(en.rMx.VIDEO_STREAM_ENDED, eo(es(eo({}, this._getAnalyticsProperties()), {
        media_session_id: this.getMediaSessionId(),
        sender_user_id: e,
  ...
  _handleMediaSessionId(e) {
    ...
    U.default.track(en.rMx.MEDIA_SESSION_JOINED, es(eo({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      raw_thermal_state: t
    })), h.Z.dispatch({
  ...
  _trackSecureFrameTransition(e, t) {
    U.default.track(en.rMx.SECURE_FRAMES_TRANSITION, es(eo({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      sender_user_id: this.userId,
      transition_id: e,
  ...
  _handleSecureFramesInit(e) {
    var t, n;
    e > 0 ? (this.logger.info("DAVE protocol init with protocol version: ".concat(e)), null === (t = this._connection) || void 0 === t || t.prepareSecureFramesEpoch(eh, e, this.trueChannelId), this._sendMLSKeyPackage()) : null === (n = this._connection) || void 0 === n || n.prepareSecureFramesTransition(em, e, () => {
      var t;
  ...
  _trackMLSFailures() {
    ...
    for (let [n, r, i, o] of e) U.default.track(en.rMx.MLS_FAILURES, es(eo({}, this._getAnalyticsProperties()), {
      media_session_id: t,
      parent_media_session_id: this.parentMediaSessionId,
      failure_source: n,
      failure_reason: r,
  ...
  constructor({
    ...
    guildId: n,
    channelId: r,
    context: i = er.Yn.DEFAULT,
    rtcServerId: o,
    parentMediaSessionId: a
  }) {
    var l, c;
    super(), ei(this, "context", void 0), ei(this, "userId", void 0), ei(this, "sessionId", void 0), ei(this, "guildId", void 0), ei(this, "parentMediaSessionId", void 0), ei(this, "hostname", void 0), ei(this, "state", void 0), ei(this, "_videoQuality", void 0), ei(this, "_soundshareStats", void 0), ei(this, "logger", void 0), ei(this, "rtcServerId", void 0), ei(this, "_channelId", void 0), ei(this, "channelIds", void 0), ei(this, "_endpoint", void 0), ei(this, "port", void 0), ei(this, "token", void 0), ei(this, "protocol", void 0), ei(this, "voiceVersion", void 0), ei(this, "rtcWorkerVersion", void 0), ei(this, "_socket", void 0), ei(this, "_backoff", void 0), ei(this, "_destroyed", void 0), ei(this, "_pings", void 0), ei(this, "_pingBadCount", void 0), ei(this, "_pingTimeouts", void 0), ei(this, "_mediaSessionId", void 0), ei(this, "_voiceQuality", void 0), ei(this, "_voiceQualityPeriodicStatsInterval", void 0), ei(this, "_voiceQualityPeriodicStatsSequenceId", void 0), ei(this, "_systemResponsiveness", void 0), ei(this, "_noiseCancellationError", void 0), ei(this, "_voiceDuration", void 0), ei(this, "_videoHealthManager", void 0), ei(this, "_sentVideo", void 0), ei(this, "_outboundLossRate", void 0), ei(this, "_recordingEnabled", void 0), ei(this, "_selectedExperiments", void 0), ei(this, "_localMediaSinkWantsManager", void 0), ei(this, "_goLiveQualityManager", void 0), ei(this, "_remoteVideoSinkWants", void 0), ei(this, "_connection", void 0), ei(this, "_createdTime", void 0), ei(this, "_connectStartTime", void 0), ei(this, "_connectCompletedTime", void 0), ei(this, "_rtcConnectionId", void 0), ei(this, "_connectCount", void 0), ei(this, "_connected", void 0), ei(this, "_connecting", void 0), ei(this, "_encountered_socket_failure", void 0), ei(this, "_inputDetected", void 0), ei(this, "_encryptionMode", void 0), ei(this, "stateHistory", void 0), ei(this, "_supportedBandwidthEstimationExperiments", void 0), ei(this, "_bandwidthEstimationExperiment", void 0), ei(this, "_secureFramesState", void 0), ei(this, "_userIds", void 0), ei(this, "_secureFramesRosterMap", new Map), ei(this, "_mlsFailuresRecovered", void 0), ei(this, "_mlsFailures", void 0), ei(this, "_lastSentSpeakingStatus", void 0), ei(this, "_lastSentSSRC", void 0), ei(this, "powerMonitorListener", void 0), ei(this, "reconnect", () => {
      let e = this._socket;
    ...
    }), ei(this, "_alertMLSFailureDebouced", s()(this._alertMLSFailure, 100)), ei(this, "_handleNetworkOnline", () => {
      ...
      if (null != this._voiceQuality) {
        ...
        if (this.shouldReportPeriodicStats(e))
          for (let t of e) U.default.track(en.rMx.VOICE_QUALITY_PERIODIC_STATS, es(eo({}, this._getAnalyticsProperties()), {
            media_session_id: this.getMediaSessionId(),
      ...
      let e = D.Z.getChannel(this.channelId),
        t = null == e ? void 0 : e.type;
      U.default.track(en.rMx.VOICE_CONNECTION_CONNECTING, es(eo({}, this.getAudioDeviceStates(), this.getVideoDeviceStates()), {
        guild_id: this.guildId,
        channel_id: this.channelId,
        rtc_connection_id: this.getRTCConnectionId(),
        hostname: this.hostname,
      ...
      let {
        revertOcclusionTrackingChanges: i
      } = P.C.getCurrentConfig({
        location: "Incoming Video Enabled Changed"
      });
      i ? null === (n = this._videoQuality) || void 0 === n || n.setOcclusionIncomingVideoEnabled(e) : null === (r = this.getOrCreateVideoQuality()) || void 0 === r || r.setOcclusionIncomingVideoEnabled(e)
    }), ei(this, "windowVisibilityChanged", e => {
      var t, n;
      let {
        revertOcclusionTrackingChanges: r
      } = P.C.getCurrentConfig({
        location: "Window Viz Changed"
      });
      r ? null === (t = this._videoQuality) || void 0 === t || t.setWindowOcclusionState(!e) : null === (n = this.getOrCreateVideoQuality()) || void 0 === n || n.setWindowOcclusionState(!e)
    }), this.context = i, this.logger = new b.Z("RTCConnection(".concat(null !== (l = null != o ? o : n) && void 0 !== l ? l : r, ", ").concat(this.context, ")")), this.logger.enableNativeLogger(!0), this.userId = e, this.sessionId = t, this.guildId = n, this._channelId = r, this.channelIds = new Set([r]), this.rtcServerId = o, this.parentMediaSessionId = a, this._endpoint = null, this.hostname = null, this.port = null, this.token = null, this.voiceVersion = null, this.rtcWorkerVersion = null, this.state = en.hes.AWAITING_ENDPOINT, this.stateHistory = new Y.K(this.state), this._socket = null, this._backoff = new d.Z(1e3, 1e4), this._destroyed = !1, this._pings = [], this._pingBadCount = 0, this._pingTimeouts = [], this._mediaSessionId = null, this._voiceQuality = null, this._voiceQualityPeriodicStatsInterval = null, this._voiceQualityPeriodicStatsSequenceId = 0, this._systemResponsiveness = null, this._noiseCancellationError = 0, this._voiceDuration = null, this._videoQuality = null, this._videoHealthManager = null, this._sentVideo = !1, this._outboundLossRate = null, this._createdTime = (0, p.zO)(), this._connectStartTime = 0, this._connectCompletedTime = 0, this._rtcConnectionId = (0, u.Z)(), this._connectCount = 0, this._connected = !1, this._connecting = !1, this._encountered_socket_failure = !1, this._inputDetected = !1, this._selectedExperiments = [], this._secureFramesState = null, this._userIds = new Set([e]), this._secureFramesRosterMap.clear(), this._mlsFailuresRecovered = {}, this._mlsFailures = {}, this._lastSentSpeakingStatus = 0, this._lastSentSSRC = void 0;
    ...
    if (i === er.Yn.DEFAULT) {
      ...
      this._localMediaSinkWantsManager = new z.ZP(e, t, f), this._localMediaSinkWantsManager.on(z.ai.Update, e => {
    ...
    } else i === er.Yn.STREAM && (this._goLiveQualityManager = new I.Z(!0), this._goLiveQualityManager.on(I.y.RequestedSSRCsUpdate, (e, t, n) => {
      var r;
      null === (r = this._connection) || void 0 === r || r.createUser(e, t, n)
    ...
    this._remoteVideoSinkWants = z.Yy, et.w.on(et.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged), et.w.on(et.e.WindowVisibilityChanged, this.windowVisibilityChanged), M.ZP.shouldRecordNextConnection() ? (this._recordingEnabled = !0, E.TC(!1)) : this._recordingEnabled = !1, this._soundshareStats = new q.Z, B.Z.addOnlineCallback(this._handleNetworkOnline), B.Z.addOfflineCallback(this._handleNetworkOffline), (0, V.isDesktop)() && (this.powerMonitorListener = Z.Z.remotePowerMonitor.on("resume", this._handlePowerResume)), this._supportedBandwidthEstimationExperiments = [], this._bandwidthEstimationExperiment = null, L.Z.getMediaEngine().getSupportedBandwidthEstimationExperiments(e => {
