...
class ey extends d.Z {
  ...
  connect(e, t) {
    ...
    if (this.endpoint = e, this.token = t, (n !== this.endpoint || r !== t) && (this._cleanupSocket(), this._mediaSessionId = null, null != n && (this._rtcConnectionId = (0, c.Z)(), p.Z.dispatch({
        ...
        connection: this
      }))), null == this.endpoint) return void this.setState(ei.hes.AWAITING_ENDPOINT);
    let i = this._socket;
  ...
  destroy() {
    var e, t, n, r, i, a, o;
    if (this.logger.info("Destroy RTCConnection"), V.Z.removeOnlineCallback(this._handleNetworkOnline), V.Z.removeOfflineCallback(this._handleNetworkOffline), (0, F.isDesktop)() && (null == (a = (o = this).powerMonitorListener) || a.call(o)), er.w.off(er.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged), er.w.off(er.e.WindowVisibilityChanged, this.windowVisibilityChanged), this._backoff.cancel(), this._cleanupSocket(), null == (e = this._voiceQuality) || e.stop(), this._voiceQuality = null, clearInterval(this._voiceQualityPeriodicStatsInterval), this._voiceQualityPeriodicStatsInterval = null, this._voiceQualityPeriodicStatsSequenceId = 0, null == (t = this._systemResponsiveness) || t.stop(), this._systemResponsiveness = null, this._noiseCancellationError = 0, null == (n = this._voiceDuration) || n.stop(), this._voiceDuration = null, null == (r = this._videoQuality) || r.stop(), this._videoQuality = null, this._videoHealthManager = null, this._secureFramesState = null, null == (i = this._localMediaSinkWantsManager) || i.reset(), null != this._connection) {
  ...
  _chooseExperiments(e) {
    ...
    if (L.Z.supports(ea.AN.FIXED_KEYFRAME_INTERVAL) && t.push("fixed_keyframe_interval"), 0 !== this._supportedBandwidthEstimationExperiments.length) {
      ...
      autoTrackExposure: !0
    }).enabled && t.push("keyframe_on_join"), this._selectedExperiments = t
  }
  _handleConnecting(e) {
  ...
  _handleDisconnect(e, t, n, r) {
    var i, a, o, s, l, c, u, d, f, _, p, h, m, g, E, b, y, O, I, S, T;
    ...
    if (this.state !== ei.hes.DISCONNECTED) {
      ...
      null != e && this.context === ea.Yn.DEFAULT && (e.stop(), this._sentVideo && e.getOutboundStats().forEach(t => {
        var n;
        (null != (n = t.num_frames) ? n : 0) > 0 && U.default.track(ei.rMx.VIDEO_STREAM_ENDED, ec(es(ec(es({}, this._getAnalyticsProperties()), {
        ...
        (null != (n = null == i ? void 0 : i.num_frames) ? n : 0) > 0 && U.default.track(ei.rMx.VIDEO_STREAM_ENDED, es(ec(es({}, this._getAnalyticsProperties()), {
          app_hardware_acceleration_enabled: G.Z.getAppHardwareAccelerationEnabled(),
          media_session_id: this.getMediaSessionId(),
          sender_user_id: t,
          reason: r,
  ...
  _handleReady(e, t, n, r, i, a, o) {
    var s, l, c;
    this.setState(ei.hes.RTC_CONNECTING), this.port = n, null != o && this._chooseExperiments(o), 0 === a.length && a.push({
      type: ea.Tr.VIDEO,
      rid: "100",
      ssrc: i + 1,
      rtxSsrc: i + 2,
    ...
    h.setUseElectronVideo(u.supports(ea.AN.ELECTRON_VIDEO)), L.Z.supports(ea.AN.IMAGE_QUALITY_MEASUREMENT) && h.setVideoQualityMeasurement("imageQualityWebrtcPsnrDb:5000,imageQualityVmaf_v061:5000,hwdec");
    let g = ["unk"];
    ...
    h.setVideoEncoderExperiments(g.join(",")), h.on(f.Sh.Speaking, (e, t, n) => {
      this.userId === e && this.sendSpeaking(t, n), this.emit(W.z.Speaking, eb(e), t)
      ...
      this._handleVideoStreamId({
        ...
        100 === t.quality && this.emit(W.z.VideoSourceQualityChanged, this.guildId, this.channelId, eb(e), t.maxResolution, t.maxFrameRate, this.context)
      }))
    }), h.on(f.Sh.FirstFrame, (e, t, n) => {
      null != this._localMediaSinkWantsManager && (this._localMediaSinkWantsManager.setFirstFrameReceived(t), this.emit(W.z.Video, this.guildId, this.channelId, eb(e), n, this.rtcServerId)), null != this._goLiveQualityManager && (this._goLiveQualityManager.setFirstFrameReceived(t), this.emit(W.z.Video, this.guildId, this.channelId, eb(e), n, this.rtcServerId))
    }), h.on(f.Sh.Silence, e => {
      ...
      let n = k.Z.shouldIncludePreferredRegion() ? k.Z.getPreferredRegion() : null;
      this.logger.error("Error occurred while connecting to RTC server: ".concat(t)), U.default.track(ei.rMx.VOICE_CONNECTION_FAILURE, ec(es({}, this._getAnalyticsProperties()), {
        hostname: this.hostname,
        port: this.port,
        protocol: this.protocol,
        error: t,
      ...
      if (n === ei.hes.RTC_CONNECTING && this.state === ei.hes.RTC_DISCONNECTED ? this.reconnect() : this.state === ei.hes.NO_ROUTE && (0 === this._backoff.fails && this._handleNoRoute(), this._backoff.fail(this.reconnect)), this.state === ei.hes.RTC_CONNECTED) {
        ...
        if (this._connecting) {
          ...
          U.default.track(ei.rMx.VOICE_CONNECTION_SUCCESS, es(ec(es({}, this._getAnalyticsProperties()), {
            hostname: this.hostname,
            port: this.port,
            protocol: this.protocol,
  ...
  _handleVideoStreamId(e) {
    ...
    if (this.emit(W.z.Video, this.guildId, this.channelId, a, o, this.rtcServerId), null != o && null == this.getOrCreateVideoQuality() && this.logger.error("_handleVideoStreamId: Unable to create videoQuality."), null != this._videoQuality && this.userId === a && l.forEach(e => {
        var t, n;
  ...
  _handleRemoteStreamsReady(e) {
    ...
    U.default.track(ei.rMx.VOICE_CONNECTION_REMOTE_STREAMS_CREATED, ec(es({}, this._getAnalyticsProperties()), {
      number_of_users: e,
      duration_ms: t
    }))
  }
  ...
  _handlePing(e) {
    if (void 0 !== e) {
      for (this._pings.push({
          time: Date.now(),
          value: e
        }); this._pings.length >= ed;) this._pings.shift();
      e > e_ && this._pingBadCount++, this.emit(W.z.Ping, this._pings, this.quality)
    }
  }
  ...
  _handleClientConnect(e) {
    ...
    }), this.emit(W.z.ClientConnect, e), null == (t = this._goLiveQualityManager) || t.updateCallUserIds(this._userIds), null == (n = this._localMediaSinkWantsManager) || n.updateCallUserIds(this._userIds)
  }
  _handleClientDisconnect(e) {
    var t, n, r, i, a;
    let o = this._videoQuality;
    if (null != o && this.context === ea.Yn.DEFAULT) {
  ...
  _handleMediaSessionId(e) {
    ...
    U.default.track(ei.rMx.MEDIA_SESSION_JOINED, ec(es({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      raw_thermal_state: t
    })), p.Z.dispatch({
  ...
  _trackSecureFrameTransition(e, t) {
    U.default.track(ei.rMx.SECURE_FRAMES_TRANSITION, ec(es({}, this._getAnalyticsProperties()), {
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      sender_user_id: this.userId,
      transition_id: e,
  ...
  _handleSecureFramesInit(e) {
    var t, n;
    e > 0 ? (this.logger.info("DAVE protocol init with protocol version: ".concat(e)), null == (t = this._connection) || t.prepareSecureFramesEpoch(eg, e, this.trueChannelId), this._sendMLSKeyPackage()) : null == (n = this._connection) || n.prepareSecureFramesTransition(eE, e, () => {
      var t;
  ...
  _trackMLSFailures() {
    ...
    for (let [n, r, i, a] of e) U.default.track(ei.rMx.MLS_FAILURES, ec(es({}, this._getAnalyticsProperties()), {
      media_session_id: t,
      parent_media_session_id: this.parentMediaSessionId,
      failure_source: n,
      failure_reason: r,
  ...
  constructor({
    ...
    super(), eo(this, "context", void 0), eo(this, "userId", void 0), eo(this, "sessionId", void 0), eo(this, "guildId", void 0), eo(this, "parentMediaSessionId", void 0), eo(this, "hostname", void 0), eo(this, "state", void 0), eo(this, "_videoQuality", void 0), eo(this, "_soundshareStats", void 0), eo(this, "logger", void 0), eo(this, "rtcServerId", void 0), eo(this, "_channelId", void 0), eo(this, "channelIds", void 0), eo(this, "_endpoint", void 0), eo(this, "port", void 0), eo(this, "token", void 0), eo(this, "protocol", void 0), eo(this, "voiceVersion", void 0), eo(this, "rtcWorkerVersion", void 0), eo(this, "_socket", void 0), eo(this, "_backoff", void 0), eo(this, "_destroyed", void 0), eo(this, "_pings", void 0), eo(this, "_pingBadCount", void 0), eo(this, "_pingTimeouts", void 0), eo(this, "_mediaSessionId", void 0), eo(this, "_voiceQuality", void 0), eo(this, "_voiceQualityPeriodicStatsInterval", void 0), eo(this, "_voiceQualityPeriodicStatsSequenceId", void 0), eo(this, "_systemResponsiveness", void 0), eo(this, "_systemResources", void 0), eo(this, "_noiseCancellationError", void 0), eo(this, "_voiceDuration", void 0), eo(this, "_videoHealthManager", void 0), eo(this, "_sentVideo", void 0), eo(this, "_outboundLossRate", void 0), eo(this, "_recordingEnabled", void 0), eo(this, "_selectedExperiments", void 0), eo(this, "_localMediaSinkWantsManager", void 0), eo(this, "_goLiveQualityManager", void 0), eo(this, "_remoteVideoSinkWants", void 0), eo(this, "_connection", void 0), eo(this, "_mediaEngineConnectionId", void 0), eo(this, "_createdTime", void 0), eo(this, "_connectStartTime", void 0), eo(this, "_connectCompletedTime", void 0), eo(this, "_rtcConnectionId", void 0), eo(this, "_connectCount", void 0), eo(this, "_connected", void 0), eo(this, "_connecting", void 0), eo(this, "_encountered_socket_failure", void 0), eo(this, "_inputDetected", void 0), eo(this, "_encryptionMode", void 0), eo(this, "stateHistory", void 0), eo(this, "_supportedBandwidthEstimationExperiments", void 0), eo(this, "_bandwidthEstimationExperiment", void 0), eo(this, "_secureFramesState", void 0), eo(this, "_userIds", void 0), eo(this, "_secureFramesRosterMap", new Map), eo(this, "_mlsFailuresRecovered", void 0), eo(this, "_mlsFailures", void 0), eo(this, "_lastSentSpeakingStatus", void 0), eo(this, "_lastSentSSRC", void 0), eo(this, "powerMonitorListener", void 0), eo(this, "reconnect", () => {
    ...
    }), eo(this, "_alertMLSFailureDebouced", o()(this._alertMLSFailure, 100)), eo(this, "_handleNetworkOnline", () => {
      ...
      if (null != this._voiceQuality) {
        ...
        if (this.shouldReportPeriodicStats(e))
          for (let t of e) U.default.track(ei.rMx.VOICE_QUALITY_PERIODIC_STATS, ec(es({}, this._getAnalyticsProperties()), {
            media_session_id: this.getMediaSessionId(),
      ...
      let e = D.Z.getChannel(this.channelId),
        t = null == e ? void 0 : e.type;
      U.default.track(ei.rMx.VOICE_CONNECTION_CONNECTING, ec(es({}, this.getAudioDeviceStates(), this.getVideoDeviceStates()), {
        guild_id: this.guildId,
        channel_id: this.channelId,
        rtc_connection_id: this.getRTCConnectionId(),
        hostname: this.hostname,
    ...
    } else i === ea.Yn.STREAM && (this._goLiveQualityManager = new O.Z(!0), this._goLiveQualityManager.on(O.y.RequestedSSRCsUpdate, (e, t, n) => {
      var r;
      null == (r = this._connection) || r.createUser(e, t, n)
    ...
    this._remoteVideoSinkWants = q.Yy, er.w.on(er.e.IncomingVideoEnabledChanged, this.incomingVideoEnabledChanged), er.w.on(er.e.WindowVisibilityChanged, this.windowVisibilityChanged), M.ZP.shouldRecordNextConnection() ? (this._recordingEnabled = !0, g.TC(!1)) : this._recordingEnabled = !1, this._soundshareStats = new Q.Z, V.Z.addOnlineCallback(this._handleNetworkOnline), V.Z.addOfflineCallback(this._handleNetworkOffline), (0, F.isDesktop)() && (this.powerMonitorListener = H.Z.remotePowerMonitor.on("resume", this._handlePowerResume)), this._supportedBandwidthEstimationExperiments = [], this._bandwidthEstimationExperiment = null, L.Z.getMediaEngine().getSupportedBandwidthEstimationExperiments(e => {
