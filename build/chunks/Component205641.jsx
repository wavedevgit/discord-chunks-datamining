...
class x extends(r = Chunk473749.Component) {
  ...
  async hoverAnimate(e) {
    ...
    this.currentAnimation = d.Z.parallel([s, l]), await (null == (t = this.currentAnimation) ? true : t.start()), this.hoverAnimate(e * f.HOVERING.Y_VALUE_MODIFIER)
  }
  ...
  async flyAnimate() {
    ...
    let t = Chunk82923.Z.spring(this.y, {
      ...
      a = Chunk82923.Z.parallel([i, Chunk54381, Chunk473749]),
