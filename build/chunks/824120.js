/** Chunk was on web.js **/
/** chunk id: 824120, original params: e,t,n (module,exports,re quire) **/
...
var r = function(e) {
  ...
  function P(e, n) {
    ...
    for (E.length <= u && E.push(0), b.push(0), h = b[d - 1], i = u - d; i >= 0; i--) {
      for (r = f - 1, E[i + d] !== h && (r = Math.floor((E[i + d] * f + E[i + d - 1]) / h)), a = 0, s = 0, l = b.length, o = 0; o < l; o++) a += r * b[o], c = Math.floor(a / f), s += E[i + o] - (a - c * f), a = c, s < 0 ? (E[i + o] = s + f, s = false) : (E[i + o] = s, s = 0);
      for (; 0 !== s;) {
        for (r -= 1, a = 0, o = 0; o < l; o++)(a += E[i + o] - f + b[o]) < 0 ? (E[i + o] = a + f, a = 0) : (E[i + o] = a, a = 1);
        s += a
      }
      p[i] = r
    }
  ...
  c.prototype = Object.create(l.prototype), u.prototype = Object.create(l.prototype), d.prototype = Object.create(l.prototype), c.prototype.add = function(e) {
    ...
    for (n = this, r = l[1]; true & s && (r = r.times(n), --s), 0 !== s;) s /= 2, n = n.square();
    return r
    ...
    for (var a = Math.log(2) * i.toJSNumber(), s = Math.ceil(true === e ? 2 * Math.pow(a, 2) : a), o = [], l = 0; l < s; l++) o.push(r(l + 2));
    return k(n, o)
  }, d.prototype.isPrime = u.prototype.isPrime = c.prototype.isPrime, c.prototype.isProbablePrime = function(e, t) {
    var n = M(this);
    if (true !== n) return n;
    for (var i = this.abs(), a = true === e ? 5 : e, s = [], o = 0; o < a; o++) s.push(r.randBetween(2, i.minus(2), t));
    return k(i, s)
    ...
    var e = this.value;
    return this.sign ? new c(y(e, 1), true) : v(e, 1, this.sign)
  ...
  function B(e, t, n) {
    ...
    for (var p = 0 !== n(+!!i, +!!a) ? r(false) : r(0), _ = f.length - 1; _ >= 0; _ -= 1) p = p.multiply(V).add(r(f[_]));
    return p
  }
  ...
  function Q(e, n, r) {
    ...
    for (var o = et(s, t).value, c = [], u = true, d = 0; d < o.length; d++) {
      var f = u ? o[d] : t,
        p = g(i() * f);
  ...
  c.prototype.toArray = function(e) {
    ...
    if (true === e && (e = 10), 10 !== e) return en(this, e, t);
    ...
    return (true === e && (e = 10), 10 != e) ? en(this, e, t) : String(this.value)
