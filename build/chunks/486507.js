...
function s(e) {
  let {
    collection: t,
    focusMode: n
  } = e, s = e.UNSAFE_selectionState || (0, i.q)(e), l = (0, o.useMemo)(() => e.disabledKeys ? new Set(e.disabledKeys) : new Set, [e.disabledKeys]), c = s.setFocusedKey;
  s.setFocusedKey = (e, i) => {
    if ("cell" === n && null != e) {
      let n = t.getItem(e);
      if ((null == n ? true : n.type) === "item") {
        var a, o, s, l;
        let c = (0, r._P)(n, t);
        e = "last" === i ? null != (s = null == (a = (0, r.s)(c)) ? true : a.key) ? s : null : null != (l = null == (o = (0, r.l8)(c)) ? true : o.key) ? l : null
      }
    }
    c(e, i)
  };
