...
class f extends i.PureComponent {
  ...
  renderTitleAccessory(e, t) {
    return e === p.Pl.MANAGE_MESSAGES && t ? (0, r.jsx)(s.DY3, {
  ...
  renderComponent(e) {
    ...
    let {
      ...
      locked: p,
      permissionRender: m
    } = this.props, g = null != (t = this.props.inPinPermissionExperiment) && t, f = null == m ? void 0 : m(a), h = !!(p || f), x = "string" == typeof f ? this.renderDisabledIndicator(f) : null, j = o()({
      [b.title]: null != x
    });
    return null == d ? (0, r.jsxs)(u.Z, {
      disabled: h,
      value: this.getOverwriteValue(a),
      onChange: e => this.handleChange(a, e),
      note: (0, c._u)(i),
      helpdeskArticleId: l,
      children: [x, (0, r.jsx)("span", {
        className: j,
        children: n
      }), this.renderTitleAccessory(a, g)]
    }, String(a)) : (0, r.jsxs)(s.j7V, {
      disabled: h,
