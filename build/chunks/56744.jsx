...
let _ = Chunk73800.memo(function(e) {
  ...
  return <d.Z repliedAuthor={b} baseAuthor={y} baseMessage={t} channel={n} referencedMessage={f} content={m} compact={_} isReplyAuthorBlocked={g} isReplyAuthorIgnored={E} isReplySpineClickable={false} showReplySpine={true} />
});

function p(e, t, n, i, o) {
  return e.type !== f.uaV.REPLY || null == n ? null : <_ baseMessage={e} channel={t} referencedMessage={i} compact={o} />
}