...
let I = [{
  ...
  S = e => {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(c.Text, {
        ...
        variant: "text-xxs/normal",
        color: "text-muted",
        children: [o ? v.NW.format(v.t.LFVi6O, {
          dateAcquired: d
  ...
  T = e => {
    let {
      ...
      product: T,
      purchase: N
    } = (0, f.Z)(null == o ? void 0 : o.skuId), A = b.ZP.canUseCollectibles(t), C = (0, u.qS)(N), R = (0, u.G1)(T), P = !A && C, w = (0, h.M)(!R || A), D = (0, _.k)(T), L = i.useMemo(() => P ? v.NW.string(v.t.zrBmQE) : (0, s.EQ)([R, A, w]).with([!0, !0, !1], () => v.NW.string(v.t.L5hyz8)).with([!0, !1, !0], () => v.NW.string(v.t.q0PlFh)).with([!0, !1, !1], () => v.NW.string(v.t.ucqOV1)).otherwise(() => v.NW.string(v.t.UROtt7)), [P, R, A, w]);
    return null != T && (null == N || P) ? (0, r.jsxs)("div", {
