...
let I = [{
  ...
  S = e => {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(c.Text, {
        ...
        variant: "text-xxs/normal",
        color: "text-muted",
        children: [a ? v.intl.format(v.t.LFVi6O, {
          dateAcquired: d
  ...
  T = e => {
    let {
      ...
      product: T,
      purchase: A
    } = (0, f.Z)(null == a ? void 0 : a.skuId), N = b.ZP.canUseCollectibles(t), C = (0, u.qS)(A), P = (0, u.G1)(T), R = !N && C, w = (0, h.M)(!P || N), D = (0, _.k)(T), L = i.useMemo(() => R ? v.intl.string(v.t.zrBmQE) : (0, s.EQ)([P, N, w]).with([!0, !0, !1], () => v.intl.string(v.t.L5hyz8)).with([!0, !1, !0], () => v.intl.string(v.t.q0PlFh)).with([!0, !1, !1], () => v.intl.string(v.t.ucqOV1)).otherwise(() => v.intl.string(v.t.UROtt7)), [R, P, N, w]);
