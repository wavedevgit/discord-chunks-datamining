...
function ea() {
  ...
  let o = !module.search.includes("response_type"),
    [a, l] = Chunk473749.useState(false),
    u = Chunk473749.useRef(false),
    [d, f] = Chunk473749.useState(null),
    p = !Chunk873546.tq && !a && (Chunk120356 || !Chunk314897.default.isAuthenticated());
  if (Chunk473749.useEffect(() => {
      if (Chunk873546.eL && Chunk120356) {
        ...
        if (o) n.request(J.Etm.DEEP_LINK, {
          type: $.jE.OAUTH2,
          params: {
            search: e.search
          }
  ...
  return (0, Chunk54381.jsx)(Chunk787025.G, {
    removeChildWrapper: true,
    children: (0, Chunk54381.jsx)(es, eo(er({
...
function es(e) {
  let {
    ...
    noPadding: f,
    modalSize: p
  } = ec(er({}, e)), _ = v.w.useExperiment({
    location: "oauth2_authorize"
  }), m = null != o || null != s || null != u ? (0, r.jsxs)("div", {
    className: et.authorize,
    children: [o, (0, r.jsxs)("div", {
      className: et.contentWrapper,
      children: [(0, r.jsxs)("div", {
        className: a()(et.content, d ? et.contentBackground : null, f ? et.noPadding : null),
...
function ec(e) {
  ...
  let [eR, ew] = i.useState(null), [eD, ex] = i.useState(null), [eL, ej] = i.useState(null), [eM, ek] = i.useState(false), [eU, eG] = i.useState(false), eZ = null == eR ? true : eR.guilds, [eF, eB] = i.useState(null != ep ? ep : null), [eV, eH] = i.useState(null != e_ ? e_ : null), [eY, eW] = i.useState(L.Hn), [eK, ez] = i.useState(false), eq = i.useMemo(() => (null == eR ? true : eR.user) != null ? new D.Z(eR.user) : null, [null == eR ? true : eR.user]), eQ = (0, T.Z)(null != (t = null == eR ? true : eR.application) ? t : null), eX = i.useMemo(() => null == eZ ? true : eZ.find(e => e.id === eF), [eZ, eF]), [eJ, e$] = i.useState(null), e0 = i.useMemo(() => {
    var e;
  ...
  let tr = i.useCallback(async e => {
      ...
      try {
        ...
        let n = await (0, k.Iq)({
          ...
          guildId: eJ === u.Y.GUILD_INSTALL && null != eF ? eF : true,
          channelId: eJ === u.Y.GUILD_INSTALL && null != eV ? eV : true,
          dmSettings: {
            allowMobilePush: eK
          }
        });
        if (e && await (0, I.x9)($, e9), null != eO) eO({
          application: null == eR ? true : eR.application,
          location: n.location,
          guild: eX
        }), null == eS || eS();
    ...
    }, [ev, eE, eO, null == eR ? true : eR.application, eX, eS, $, e5, en, er, ei, eo, ea, es, e6, eY, eF, eJ, eV, e9, eK]),
    ti = i.useRef(false),
    to = i.useCallback(async () => {
      ...
      if (!e7.current && !ti.current) {
        ...
        try {
          ...
          ew((0, U.d)(e)), ec === F.s.NONE && e.authorized && !tt && tr(true), (0, y.yw)(J.rMx.OAUTH2_AUTHORIZE_VIEWED, {
  ...
  i.useEffect(() => {
    ...
    if (null == eD && (!e0 || null != e1) && eP)
      ...
      } else ta.length > 1 ? ex("SELECT_INSTALL_TYPE") : (1 === ta.length ? e$(ta[0]) : null != em ? e$(em) : e$(u.Y.GUILD_INSTALL), ex("AUTHORIZE_SCOPES"))
  }, [eA, ta, e1, e0, em, eD, eP]), i.useEffect(() => {
    if (null == eJ || null != eR || null != eL) return;
    eJ === u.Y.USER_INSTALL && (eB(null), eH(null));
    let e = e5.filter(e => !Z.ak.includes(e));
    0 === e5.length ? ej(Error("No scopes were provided.")) : e.length > 0 ? ej(Error("Invalid scope: ".concat(e[0]))) : (0, G._$)(e6) ? ej(Error("Invalid permission(s) provided.")) : to()
  ...
  switch (eD) {
    ...
    case "SELECT_INSTALL_TYPE":
      ...
      O = (0, r.jsx)(z.Z, {
        application: e1,
        onSelect: tu
      }), t_ = false, tm = false, th = false, tg = true;
      break;
    case "AUTHORIZE_SCOPES":
      if (null == eR || null == eq || null == eJ) return {
        label: ee.intl.string(ee.t.ZTNur7),
        body: (0, r.jsx)(el, {})
      };
      let tE = null == eL || eL instanceof Error ? {} : eL,
        tb = null == eZ ? true : eZ.sort((e, t) => e.name.toLowerCase().localeCompare(t.name.toLowerCase())),
        ...
        tv = (0, p.yE)(null != (n = eR.application.flags) ? n : 0, J.udG.EMBEDDED) && eJ === u.Y.USER_INSTALL && e4.enabled;
      O = (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(V.Z, {
          ...
          error: (null != (a = null != (o = tE[d.x.BOT]) ? o : tE[d.x.APPLICATIONS_COMMANDS]) ? a : [])[0],
          selectedGuildId: eF,
          onGuildChange: eB,
          guilds: null != tb ? tb : [],
          disabled: "" !== eF && null != eF && true === eh
        }) : null, ty ? (0, r.jsx)(X.Z, {
      ...
      }), e5.includes(d.x.BOT) && !f.fS(e6, L.Hn) && (A = "AUTHORIZE_BOT_PERMISSIONS"), ta.length > 1 && (C = "SELECT_INSTALL_TYPE"), tp = tO && null == eX || ty && null == eV, tf = true;
      break;
  ...
  let tS = [];
  if (t_ && null != eR) {
    let e = null != (h = null == eR ? true : eR.application.approximate_guild_count) ? h : null == eR || null == (_ = eR.bot) ? true : _.approximate_guild_count;
  ...
  return tm && null != eR && null != eq && (q = (0, r.jsx)(K.Z, {
    user: eq,
    application: eR.application,
    bot: eR.bot,
    accountScopes: e8,
...
function eu(e, t) {
  ...
  l && a === J.Z5c.OAUTH2_AUTHORIZED ? (0, h.openModal)(e => (0, r.jsx)(Q.jO, er({
    guild: t.guild,
    application: t.application
  }, e))) : l && (null == a ? true : a.startsWith(J.Z5c.OAUTH2_ERROR)) ? (0, h.openModal)(e => {
    var t, n;
    let i = null != (n = null != (t = null == s ? true : s.get("error_description")) ? t : null == s ? true : s.get("error")) ? n : ee.intl.string(ee.t.mqn873);
    return Array.isArray(i) && (i = i[0]), (0, r.jsx)(q.j, eo(er({}, e), {
...
function ef(e, t) {
  (0, h.openModal)(t => (0, r.jsx)(es, eo(er({}, t, e), {
...
function ep(e) {
  ...
  return null != i && null != o && (j.Z.isDiscordHostname(n) || r === window.location.host) && (i.startsWith("/api".concat(J.ANM.OAUTH2_AUTHORIZE)) || i.startsWith(J.Z5c.OAUTH2_AUTHORIZE)) ? (0, M.y)(o) : null
}