...
function x(e) {
  ...
  let {
    ...
    onAdoptTag: r,
    onEditProfile: s
  } = (0, g.Z)(e.guild.id, () => t(h.L.TAKE_ACTION)), c = [{
  ...
  return (0, i.jsxs)(i.Fragment, {
    children: [e.children, (0, i.jsx)(l.J2, {
...
function _(e) {
  function t(t) {
    ...
    }), (0, d.Qd)(s.C.ADOPT_CLAN_IDENTITY_NOTICE, e.guild.id, true, h.L.DISMISS), null == (n = e.onDismiss) || n.call(e, t)
  }
  let {
    isAdopting: n,
    onAdoptTag: r,
    onEditProfile: c
  } = (0, g.Z)(e.guild.id, () => t(h.L.TAKE_ACTION)), u = [{
    text: f.intl.string(f.t.jwEaiY),
    loading: n,
    onClick: r,
    variant: "primary"
...
function j(e) {
  let t = (0, r.e7)([u.Z], () => u.Z.getGuild(e.guildId)),
    n = (0, m.S3)(e.guildId);
  return null != t && (0, p.jq)(t) && null !== n ? "changed" === n ? (0, i.jsx)(x, {
    guild: t,
