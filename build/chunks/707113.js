...
function p(e) {
  let {
    ...
    onPageChange: i,
    onMemberSelect: o
  } = e, p = t.id, N = (0, s.e7)([u.Z], () => u.Z.getEstimatedMemberSearchCountByGuildId(p), [p]), g = (0, d.$j)(p), C = (0, d.M3)(p), _ = l.useCallback(e => {
    null != e && (null == o || o(e))
  }, [o]), v = (0, m.xb)(C, g, N), E = l.useRef(null), T = l.useRef(null), I = l.useCallback(() => {
    var e;
