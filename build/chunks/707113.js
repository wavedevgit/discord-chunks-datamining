...
function p(e) {
  let {
    ...
    onPageChange: i,
    onMemberSelect: s
  } = e, p = t.id, N = (0, o.e7)([u.Z], () => u.Z.getEstimatedMemberSearchCountByGuildId(p), [p]), g = (0, d.$j)(p), _ = (0, d.M3)(p), C = l.useCallback(e => {
    null != e && (null == s || s(e))
  }, [s]), v = (0, m.xb)(_, g, N), E = l.useRef(null), T = l.useRef(null), I = l.useCallback(() => {
    var e;
