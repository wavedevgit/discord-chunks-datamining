...
function w(e) {
  ...
  return (0, n.jsx)(a.zJl, {
    ...
    fade: !0,
    children: null == s && l ? (0, n.jsx)("div", {
      className: y.empty,
      children: (0, n.jsx)(a.$jN, {})
    }) : (null != s || l) && (null == s ? void 0 : s.length) !== 0 ? null == s ? void 0 : s.map(e => {
      let {
        guild: r,
        nick: s
      } = e;
