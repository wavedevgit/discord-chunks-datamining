...
function V(e) {
  let {
    ...
    isUnread: s,
    groupedMessages: d
  } = e, p = n.type === L.d4z.UNKNOWN ? u.VL1 : (0, f.KS)(n, null), m = (0, h.ZP)(n, false), b = (0, c.e7)([w.Z], () => w.Z.getGuild(n.getGuildId())), {
    nick: y,
    colorString: _
  } = (0, O.ZP)(t), {
    avatarSrc: x,
    ...
    animateOnHover: true
  }), E = n.type !== L.d4z.GUILD_ANNOUNCEMENT || null == b, I = (0, v.x)({
    channel: n,
    message: t,
    user: t.author,
    compact: true,
