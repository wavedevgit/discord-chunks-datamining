...
function F(e) {
  let {
    ...
    animateOnHover: true
  }), S = n.type !== L.d4z.GUILD_ANNOUNCEMENT || null == b, P = (0, j.x)({
    channel: n,
    message: t,
    user: t.author,
    compact: true,
...
function W(e) {
  let {
    ...
    return (0, i.useMemo)(() => {
      ...
      } else j = f ? U.intl.string(U.t.sad2PD) : i ? U.intl.string(U.t.p0oZm5) : s > 1 ? U.intl.formatToPlainString(U.t.rtfTKi, {
        count: s
...
let K = (0, Chunk647438.memo)(function(e) {
  ...
  }), _ = i.useMemo(() => "".concat(null == f ? true : f.author.username, ": ").concat(null == m ? true : m.name), [null == f ? true : f.author.username, null == m ? true : m.name]), y = null != (t = null == a ? true : a.map(e => e.message).filter(e => null != e)) ? t : [];
