/** Chunk was on 5410 **/
/** chunk id: 308564, original params: e,t,r (module,exports,require) **/
"use strict";
require.d(exports, {
  a: () => u
});
...
var a = ["canDrag", "beginDrag", "isDragging", "endDrag"],
  ...
  c = function() {
    ...
    return e = [{
        ...
        key: "endDrag",
        value: function() {
          this.props && this.spec.endDrag && this.spec.endDrag(this.props, this.monitor, (0, Chunk639443.Al)(this.ref))
        }
      }],
      function(e, t) {
