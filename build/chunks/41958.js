...
function A(e, t, n) {
  for (var r in n && (C(n = a({}, n), t), t = a(a({}, n), t)), C(e, t), Object.assign(e, t), T) null == e[r] && (e[r] = T[r]);
  var i = e.mass,
    s = e.frequency,
    l = e.damping;
...
function W(e, t) {
  ...
  return new Promise(function(t, l) {
    ...
    f ? h() : (c = L(r.delay || 0, n), (d = j(r.pause, n)) ? (i.resumeQueue.add(p), s.pause()) : (s.resume(), p()))
  })
}
var K = function(e, t) {
  ...
  ef = function(e) {
    ...
    return n.advance = function(e) {
          ...
          if (!f) {
            ...
            if (o.is.und(a.duration))
              if (a.decay) {
                ...
                for (var b = null == c.lastVelocity ? m : c.lastVelocity, y = a.precision || (h == d ? .005 : Math.min(1, .001 * Math.abs(d - h))), O = a.restVelocity || y / 10, v = a.clamp ? 0 : a.bounce, I = !o.is.und(v), T = h == d ? c.v0 > 0 : h < d, S = false, A = 1, C = Math.ceil(e / 1), N = 0; N < C && !(!(Math.abs(b) > O) && (f = Math.abs(d - _) <= y)); ++N) {
      ...
      var T = o.is.arr(t.to) || o.is.fun(t.to),
        ...
        C = S.decay,
        N = S.velocity;
      t.config && !T && A(S, L(t.config, r), t.config !== a.config ? L(a.config, r) : true);
      var R = f.getAnimated(this);
      if (!R || o.is.und(m)) return n(q(this, true));
      var P = o.is.und(t.reset) ? l && !t.default : !o.is.und(E) && j(t.reset, r),
        w = P ? E : this.get(),
        D = Y(m),
        x = o.is.num(D) || o.is.arr(D) || o.isAnimatedString(D),
        M = !T && (!x || j(a.immediate || t.immediate, r));
      if (O)
      ...
      if (!G) {
        ...
        (O || F) && (G = !(Z = o.isEqual(Y(w), D))), o.isEqual(S.decay, C) && o.isEqual(S.velocity, N) || (G = true)
      }
      if (Z && this.is(ec) && (i.changed && !P ? G = true : G || this._stop()), !T) {
        (G || o.getFluidConfig(d)) && (i.values = R.getPayload(), i.toValues = v ? null : U == f.AnimatedString ? [1] : o.toArray(D)), i.immediate = M, i.onStart = ep(c("onStart"), r), i.onChange = ep(c("onChange"), r);
        var V = i.onRest,
...
var ey = ["onStart", "onChange", "onRest"],
  ...
  ev = function() {
    ...
    return exports.is = function(e) {
      ...
      var s = (r.size || !a && Chunk947870.size) && this.get();
      Chunk698091.flush(r, function(e) {
        return e(s)
      }), a || (this._phase = el, Chunk698091.flush(Chunk947870, function(e) {
        var t = e[0],
          n = e[1];
        n.value = s, t(n)
      }))
...
}), exports.BailSignal = er, exports.Controller = ev, exports.FrameValue = ea, exports.Interpolation = eW, exports.Spring = eV, exports.SpringContext = ew, exports.SpringHandle = ex, exports.SpringValue = ef, exports.Trail = eH, exports.Transition = eY, exports.config = v, exports.inferTo = H, exports.interpolate = ez, exports.to = eK, exports.update = eq, exports.useChain = O, exports.useSpring = ej, exports.useSprings = eL, exports.useTrail = eM, exports.useTransition = eZ