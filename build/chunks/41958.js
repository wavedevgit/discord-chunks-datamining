  ...
  ef = function(e) {
    ...
    return n.advance = function(e) {
      ...
      var P = a.is.und(t.reset) ? l && !t.default : !a.is.und(E) && M(t.reset, r),
        ...
        j = !S && (!x || M(o.immediate || t.immediate, r));
      if (O)
      ...
      if (Z && this.is(ec) && (i.changed && !P ? G = true : G || this._stop()), !S) {
        (G || a.getFluidConfig(d)) && (i.values = R.getPayload(), i.toValues = v ? null : U == f.AnimatedString ? [1] : a.toArray(D)), i.immediate = j, i.onStart = ep(c("onStart"), r), i.onChange = ep(c("onChange"), r);
        var V = i.onRest,
...
}), exports.BailSignal = er, exports.Controller = ev, exports.FrameValue = eo, exports.Interpolation = eW, exports.Spring = eV, exports.SpringContext = ew, exports.SpringHandle = ex, exports.SpringValue = ef, exports.Trail = eH, exports.Transition = eY, exports.config = v, exports.inferTo = H, exports.interpolate = ez, exports.to = eK, exports.update = eq, exports.useChain = O, exports.useSpring = eM, exports.useSprings = eL, exports.useTrail = ej, exports.useTransition = eZ