  ...
  ef = function(e) {
    ...
    return n.advance = function(e) {
      ...
      var P = o.is.und(t.reset) ? l && !t.default : !o.is.und(E) && j(t.reset, r),
        ...
        k = !T && (!x || j(a.immediate || t.immediate, r));
      if (O)
        if (k) R = this._updateNode(D);
        else {
          var M = this._getNodeType(m);
          if (M !== R.constructor) throw Error("Cannot animate between " + R.constructor.name + " and " + M.name + ', as the "to" prop suggests')
        } var U = R.constructor,
        G = !!v,
        Z = false;
      if (!G) {
...
function eT(e, t, n) {
  ...
  return s ? l.push(W(++e._lastAsyncId, {
    ...
    actions: {
      ...
      resume: o.noop,
      start: function(t, n) {
        t.onRest = a, t.cancel ? M(t, "cancel") && en(c, t.callId) : n(ee(s, t, c, e))
      }
    }
