  ...
  ef = function(e) {
    ...
    return n.advance = function(e) {
      ...
      var S = a.is.arr(t.to) || a.is.fun(t.to),
        ...
        C = T.decay,
        N = T.velocity;
      t.config && !S && A(T, x(t.config, r), t.config !== o.config ? x(o.config, r) : true);
