...
function Z(e) {
  let {
  ...
  }, eo = () => (0, u.Z)(i) && null != Z ? (0, r.jsxs)("div", {
    ...
    if ((0, u.Z)(i) && null != V) return (0, r.jsx)(R.Z, {
      variant: "text-xs/normal",
      text: j.intl.formatToPlainString(j.t["hq/Qzc"], {
        guildName: V.name
      }),
      onClick: () => {
        (0, E.X)(V.id), J({
    ...
    return (null == (n = i.assets) ? void 0 : n.large_text) != null ? (0, r.jsx)(p._, {
    ...
    children: (0, r.jsxs)(N.Z, {
      ...
      children: [(0, r.jsx)(C.Z, F(B({
        ...
        children: [(0, r.jsxs)("div", {
          className: U.content,
          children: [!t.bot && ea(), (0, r.jsxs)("div", {
            className: U.details,
            children: [ed(), !t.bot && (0, r.jsx)(A.Z, {
              user: t,
              activity: i,
              className: U.badges
