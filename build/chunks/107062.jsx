...
let R = (e, t) => A.intl.formatToPlainString(A.t.tAwI1t, {
  ...
  D = e => {
    ...
    let z = <v.PZ location={v.Gt.POPOUT} entry={n} />,
      q = <I.wG channel={t} userDescription={(0, b.kr)(n) ? A.t.vPg1JS : A.t.rPqqtr} title={n.extra.activity_name} subtitle={M} badges={z} entry={n} showCoverImage={false} onClickTitle={D ? true : Y} onClickSubtitle={D ? true : Y} onClickThumbnail={D ? true : Y} />,
      X = (0, l.Z)(k, S.xjy.JOIN) || (0, c.Z)(k),
      Q = X ? <u.Z embeddedActivity={j} activity={k} user={x} ButtonComponent={e => (0, r.jsx)(I.Ll, C({
          IconComponent: a.YVR
        }, e))} /> : null,
      J = K ? a.iWm : a.jje,
      $ = D ? null : <I.Ll onClick={Y} IconComponent={J}>{A.intl.string(A.t.GDWYR0)}</I.Ll>,
      ee = [X && !D ? Q : $].filter(h.lm);
    return <I.yR>{q}{<I.St><I.WT onReaction={m} onVoiceChannelPreview={N} user={x} channel={t} generateReactionImage={W} reactionImageAltText={R(n, x)} entry={n} buttons={ee} /></I.St>}</I.yR>
  }