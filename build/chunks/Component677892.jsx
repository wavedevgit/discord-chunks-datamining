...
function O(e) {
  let {
    ...
    onEdit: n,
    disableGoodStatus: c
  } = e, d = (0, l.Wu)([s.Z], () => s.Z.getDefaultChannelIds(t)), u = (0, l.e7)([s.Z], () => (0, o.kl)(t, s.Z.getDefaultChannelIds(t), s.Z.getOnboardingPrompts(t)).length), g = i.useMemo(() => new Set(d), [d]), [, m] = (0, o.VF)(t, g), v = m.length, O = j(t), C = (0, f.O4)(t), y = (0, l.e7)([s.Z], () => s.Z.isAdvancedMode(t)), N = y ? b.intl.formatToPlainString(b.t.nHwnLK, {
...
function C(e) {
  let {
    ...
    onEdit: n,
    disableGoodStatus: i
  } = e, c = (0, l.Wu)([s.Z], () => s.Z.getDefaultChannelIds(t)), d = (0, l.Wu)([s.Z], () => s.Z.getOnboardingPrompts(t)), u = d.length, [g, m] = (0, o.dF)(t, d, c), f = g.length, p = g.length + m.length, j = f / p * 100, v = (0, l.e7)([s.Z], () => s.Z.isAdvancedMode(t)), O = u > 0, C = "none";
  return O && (j >= 85 && !i ? C = "good" : j < 85 && (C = "warning")), (0, r.jsx)(x, {
...
function y(e) {
  let {
    ...
    onEdit: n,
    disableGoodStatus: o
  } = e, d = (0, l.e7)([g.Z], () => g.Z.getSettings()), m = (0, l.e7)([s.Z], () => s.Z.getEnabled(t)), f = (0, c.uo)(d), p = d.enabled, j = i.useCallback(() => {
    (0, u.To)(t, !p)
  }, [t, p]), v = !(0, c.av)(d), O = "none";
  v && (f && !o ? O = "good" : f || (O = "required"));
  let C = b.intl.string(b.t.GMOwOD);
  f ? v || (C = b.intl.string(b.t.wHOoyE)) : C = b.intl.string(b.t.wXFbgZ);
  let y = null;
  return v && m && (y = (0, r.jsx)("div", {
