...
function T(e) {
  let {
    ...
    path: n,
    basePath: r
  } = c.Z.getState(), i = _.Z.getPrivateChannelIds(), a = __OVERLAY__ ? i : [...b(), ...i], o = (null == t ? O(null != n ? n : r) : null != t ? a.indexOf(t) : 0) + e;
...
function S(e, t) {
  ...
  let o = y((null != n ? a.indexOf(n) : false) + e, a.length);
  v(t, a[o])
}
...
function A() {
  ...
  null == exports ? T(module) : S(module, exports)
}