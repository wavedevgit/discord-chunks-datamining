...
function h(e) {
  ...
  return <div ref={g} className={l.__invalid_submenuContainer}>{<div ref={E} />}{t}{n ? <o.j targetRef={E} autoInvert={true} nudgeAlignIntoViewport={true} fixed={true} spacing={4} position={"right"} align={"top"}>{() => d.length > 0 && (0, r.jsx)("div", {
