...
let K = Chunk647438.memo(function(e) {
  ...
  } = e, O = (0, P.ee)(() => W(o), [o]), [v, I] = o, S = I.length > 0 && null != n && null != a && (!d || f), T = (0, s.Wu)([E.Z], () => Array.from(O).map(e => E.Z.getStreamForUser(e, _)).filter(C.lm).map(e => e.ownerId), [_, O]);
  i.useEffect(() => {
    S && (0, P.zi)(j.Odu.VOICE_V3, {
