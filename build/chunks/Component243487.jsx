...
function q(e) {
  ...
  let {
    isSettingsPreview: n
  } = e, i = (0, s.e7)([O.Z, y.Z], () => y.Z.getChannel(O.Z.getVoiceChannelId())), a = (0, f.ZP)(i), o = z(k.Yn.DEFAULT, e.maxDisplayedVoiceStates), l = (0, s.e7)([E.Z], () => E.Z.getStreamerActiveStreamMetadata()), c = (0, L.II)(), d = (0, u.q)(null == c ? true : c.id), p = (0, s.cj)([E.Z, A.default, w.Z], () => {
    ...
    return {
      ...
      streamApplication: (null == l ? true : l.pid) === w.Z.getTargetPID() ? (0, _.Z)(c) : null,
      stream: e
    }
  });
