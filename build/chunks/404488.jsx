...
function u(e) {
  ...
  let m = n - c.PrS - d;
  return <a.Z sidebarType={a.y.HomeSidebar} maxWidth={m} onWidthChange={t}><i.Z channelId={u.channelId} baseChannelId={o.oC.GUILD_HOME} channelViewSource={"Home View"} isResourceChannelView={true} /></a.Z>
}