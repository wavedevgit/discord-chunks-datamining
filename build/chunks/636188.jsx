...
function P(e) {
  ...
  return <o.P3F className={a()(l, N.backgroundOption, {
      [N.backgroundOptionSelected]: c,
      [N.backgroundOptionDisabled]: d
    })} onMouseLeave={u} onBlur={m} onClick={d ? true : n}>{c ? <div className={N.backgroundOptionRing} /> : null}{<div className={N.backgroundOptionInner}>{s}{<div className={N.backgroundOptionContent}>{<t className={N.backgroundIconOptionIcon} color={"currentColor"} size={"custom"} width={18} height={18} />}{<o.Text className={N.backgroundOptionText} color={"none"} variant={"text-sm/normal"}>{r}</o.Text>}</div>}</div>}</o.P3F>
}
...
function R(e) {
  ...
  if (r.useEffect(() => {
      new Image().src = n
    }, [n]), !s || null == t) return <div className={N.backgroundImageOption} style={{
  ...
  return <img onMouseMove={() => l(true)} onMouseLeave={() => l(false)} className={N.backgroundImageOption} src={a ? n : o} alt={t.id} />
}
...
function D(e) {
  ...
  let v = (0, d.O)(),
    ...
    D = _ ? <g.Z className={N.backgroundImageOption} src={r} loop={true} playOnHover={true} muted={true} /> : <R isAnimated={x} option={(0, j.rD)(t) ? t : true} source={r} />;
...
function Z() {
  return <div className={Chunk191908.customBackgroundTooltip}>{<Chunk481060.SrA size={"md"} color={"currentColor"} className={Chunk191908.customBackgroundTooltipIcon} />}{<Chunk481060.Text variant={"text-sm/normal"}>{Chunk388032.intl.string(Chunk388032.t["T+yRY2"])}</Chunk481060.Text>}</div>
}
...
function w(e) {
  ...
  return <o.DY3 text={c} className={N.newBackgroundTooltipContainer}>{<P className={N.__invalid_backgroundOptionBlurred} disabled={r} icon={o.FmF} onClick={t} onMouseLeave={a} onBlur={a} text={(0, i.jsxs)("div", {
      ...
      })}>{<div className={N.backgroundCustomInlineUpsellBackground} />}{<div className={N.backgroundCustomInlineUpsellBackgroundDarkener} />}</P>}{s && <o.IGR text={I.intl.string(I.t.y2b7CA)} className={N.newTextBadge} />}</o.DY3>
}
...
function k(e) {
  ...
  }), <w onClick={t} tooltipText={I.intl.string(I.t.IqE0T0)} />
}
...
function L(e) {
  ...
  return <w disabled={r} onClick={function() {
      (0, o.ZDy)(async () => {
        let {
          default: e
...
function M(e) {
  ...
  return <p.Gt value={h}><div className={d ? N.backgroundOptionsSmall : N.backgroundOptionsLarge}>{<P selected={null == s} icon={o.t6m} onClick={() => a(null)} text={I.intl.string(I.t.fUdMeH)} />}{<P className={N.__invalid_backgroundOptionBlurred} selected={s === C.f7} icon={o.yMH} onClick={() => a(C.f7)} text={I.intl.string(I.t.LhSyLy)}><div className={N.backgroundOptionBlurBackground} /></P>}{t ? <L onAddBackgroundImage={c} disabled={g} /> : <k onClick={l} />}{u.map(e => <o.ua7 text={(0, i.jsx)(Z, {})} aria-label={I.intl.string(I.t["T+yRY2"])}>{t => {
          let n = (0, x.rI)({
            userId: e.user_id,
            assetId: e.id,
            assetHash: e.asset,
        ...
        return <o.ua7 text={e.name} aria-label={e.name}>{n => (0, r.createElement)(D, A(y({}, n), {
            key: e.id,
            option: e.id,
            source: e.source,
            selected: s === e.id,
