...
function j() {
  let e = o.useContext(C),
    [, t] = o.useState({});
  return o.useEffect(() => (e.invalidate = () => t({}), () => {
    e.invalidate = () => null
  }), [e]), k.ringsEnabled && e.visible ? (0, a.jsx)("div", {
...
function G(e) {
  ...
  U(() => {
    ...
    if (null != e && null != n) return e.addEventListener("focusin", i, !0), e.addEventListener("focusout", o, !0), () => {
