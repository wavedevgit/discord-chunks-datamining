...
function G(e) {
  let {
    ...
    onSubmit: a,
    onClose: o
  } = e, c = n.role_benefits.benefits, [u, g] = i.useState(() => new Set(c)), p = i.useMemo(() => c.filter(I.rC), [c]), h = (0, S.Z)(p), f = i.useMemo(() => c.filter(I.lL), [c]), x = i.useMemo(() => new Set(h.filter(e => l.some(t => t.ref_id === e.ref_id))), [h, l]), j = i.useMemo(() => new Set(f.filter(e => s.some(t => (0, d.Z)(e, t)))), [s, f]), _ = (0, b.Dt)();
