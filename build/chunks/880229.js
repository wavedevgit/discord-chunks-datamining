...
function A(e) {
  ...
  let {
    ...
    emojiName: i,
    className: l
  } = e, s = (0, c.e7)([j.ZP], () => null != n ? j.ZP.getCustomEmojiById(n) : void 0);
  return (0, r.jsx)(g.Z, {
    emojiId: n,
    emojiName: i,
...
function M(e) {
  let {
    ...
    selectedBenefits: s,
    onToggleBenefit: a
  } = e, o = i.every(e => s.has(e));
  return i.length > 0 ? (0, r.jsxs)(m.hjN, {
    title: t,
    className: R.section,
    children: [i.length - l.size > 1 && (0, r.jsx)("div", {
      className: R.list,
      children: (0, r.jsx)(L, {
        icon: (0, r.jsx)(m.avL, {
          size: "md",
...
function G(e) {
  let {
    ...
    onSubmit: a,
    onClose: o
  } = e, c = n.role_benefits.benefits, [d, g] = i.useState(() => new Set(c)), p = i.useMemo(() => c.filter(I.rC), [c]), f = (0, S.Z)(p), h = i.useMemo(() => c.filter(I.lL), [c]), x = i.useMemo(() => new Set(f.filter(e => l.some(t => t.ref_id === e.ref_id))), [f, l]), j = i.useMemo(() => new Set(h.filter(e => s.some(t => (0, u.Z)(e, t)))), [s, h]), _ = (0, b.Dt)();
  ...
  return (0, r.jsx)("form", {
    onSubmit: function(e) {
      ...
      a(t.filter(I.rC).filter(e => !x.has(e)), t.filter(I.lL).filter(e => !j.has(e))), o()
    },
    children: (0, r.jsxs)(m.Y0X, {
      ...
      children: [(0, r.jsxs)(m.xBx, {
        children: [(0, r.jsx)(m.X6q, {
          ...
          children: w.intl.format(w.t["7zpiYG"], {
            tierName: n.name
          })
        }), (0, r.jsx)(m.olH, {
...
function U(e) {
  ...
  return (0, r.jsxs)(m.P3F, {
    ...
    children: [(0, r.jsx)("div", {
      className: R.rowIconWrapper,
      children: null != a ? (0, r.jsx)(x.Z, function(e) {
      ...
      children: [(0, r.jsx)(m.Text, {
        ...
        variant: "text-sm/normal",
        children: w.intl.format(w.t["2KzH8/"], {
          num: l
        })
      })]
    }), (0, r.jsx)("div", {
...
function B(e) {
  let {
    guild: t,
    onSelect: n
  } = e, l = (0, c.e7)([C.Z], () => C.Z.getRoles(t.id)), s = (0, c.e7)([O.Z], () => O.Z.getCategories(t.id)), o = i.useMemo(() => s._categories.flatMap(e => s[e.channel.id].filter(e => {
    let {
      channel: t
    } = e;
    ...
    return t
  })), [s]), u = i.useMemo(() => Object.values(l).flatMap(e => {
    var n;
  ...
  return u.length > 0 ? (0, r.jsx)("div", {
    className: R.list,
    children: u.map(e => (0, r.jsx)(U, {
      guildId: t.id,
      role: e.role,
  ...
  return (0, r.jsxs)("form", {
    ...
    children: [(0, r.jsxs)(m.xBx, {
      children: [(0, r.jsx)(m.X6q, {
        id: D,
        variant: "heading-md/semibold",
        children: w.intl.format(w.t.iuPodH, {
          roleName: c.name
        })
      }), (0, r.jsx)(m.olH, {
        className: R.modalCloseButton,
