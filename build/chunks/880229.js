...
function P(e) {
  ...
  let {
    ...
    emojiName: l,
    className: r
  } = e, o = (0, c.e7)([v.ZP], () => null != n ? v.ZP.getCustomEmojiById(n) : void 0);
  return (0, i.jsx)(x.Z, {
    emojiId: n,
    emojiName: l,
...
function F(e) {
  ...
  return l.length > 0 ? (0, i.jsxs)(u.hjN, {
    title: t,
    className: E.section,
...
function H(e) {
  let {
    ...
    onSubmit: a,
    onClose: s
  } = e, c = n.role_benefits.benefits, [h, x] = l.useState(() => new Set(c)), f = l.useMemo(() => c.filter(S.rC), [c]), j = (0, T.Z)(f), p = l.useMemo(() => c.filter(S.lL), [c]), g = l.useMemo(() => new Set(j.filter(e => r.some(t => t.ref_id === e.ref_id))), [j, r]), _ = l.useMemo(() => new Set(p.filter(e => o.some(t => (0, d.Z)(e, t)))), [o, p]);
  ...
  function b(e) {
    ...
    a(t.filter(S.rC).filter(e => !g.has(e)), t.filter(S.lL).filter(e => !_.has(e))), s()
  }
  return (0, i.jsx)("form", {
    onSubmit: b,
    children: (0, i.jsxs)(m.Modal, {
      transitionState: t,
      onClose: s,
      title: B.intl.format(B.t["7zpiYG"], {
        tierName: n.name
      }).toString(),
      actions: [{
        variant: "secondary",
      ...
      children: [0 === j.length && 0 === p.length && (0, i.jsx)(u.Text, {
        variant: "text-md/normal",
...
function K(e) {
  ...
  return (0, i.jsxs)(u.P3F, {
    ...
    children: [(0, i.jsx)("div", {
      className: E.rowIconWrapper,
      children: null != a ? (0, i.jsx)(g.Z, function(e) {
      ...
      children: [(0, i.jsx)(u.Text, {
        ...
        variant: "text-sm/normal",
        children: B.intl.format(B.t["2KzH8/"], {
          num: r
        })
      })]
    }), (0, i.jsx)("div", {
...
function W(e) {
  let {
    guild: t,
    onSelect: n
  } = e, r = (0, c.e7)([N.Z], () => N.Z.getRoles(t.id)), o = (0, c.e7)([w.Z], () => w.Z.getCategories(t.id)), s = l.useMemo(() => o._categories.flatMap(e => o[e.channel.id].filter(e => {
    let {
      channel: t
    } = e;
    ...
    return t
  })), [o]), d = l.useMemo(() => Object.values(r).flatMap(e => {
    var n;
...
function q(e) {
  let {
    ...
    guildId: n,
    onSelect: l
  } = e, r = (0, c.e7)([k.Z], () => k.Z.getGuild(n));
  return null == r ? null : (0, i.jsxs)(i.Fragment, {
    children: [(0, i.jsxs)(u.xBx, {
  ...
  return (0, i.jsxs)("form", {
    ...
    children: [(0, i.jsxs)(u.xBx, {
      ...
      children: [(0, i.jsx)(u.X6q, {
        id: R,
        variant: "heading-md/semibold",
        children: B.intl.format(B.t.iuPodH, {
          roleName: c.name
        })
      }), (0, i.jsx)(u.olH, {
        "data-migration-pending": !0,
      ...
      "data-migration-pending": !0,
      className: E.modalContent,
      children: [m.length > 1 && (0, i.jsx)("div", {
        className: E.list,
        children: (0, i.jsx)(L, {
          icon: (0, i.jsx)(u.avL, {
            size: "md",
