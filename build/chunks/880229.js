...
function G(e) {
  let {
    ...
    onSubmit: a,
    onClose: o
  } = e, c = n.role_benefits.benefits, [u, g] = i.useState(() => new Set(c)), p = i.useMemo(() => c.filter(I.rC), [c]), f = (0, S.Z)(p), h = i.useMemo(() => c.filter(I.lL), [c]), x = i.useMemo(() => new Set(f.filter(e => l.some(t => t.ref_id === e.ref_id))), [f, l]), j = i.useMemo(() => new Set(h.filter(e => s.some(t => (0, d.Z)(e, t)))), [s, h]), _ = (0, b.Dt)();
...
function B(e) {
  let {
    ...
    return t
  })), [s]), d = i.useMemo(() => Object.values(l).flatMap(e => {
    var n;
