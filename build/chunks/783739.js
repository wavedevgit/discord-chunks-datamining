...
function N(e) {
  ...
  } = e, n = (0, s.e7)([f.Z], () => f.Z.boostSlots), N = r.useMemo(() => Object.values(n), [n]), I = (0, s.e7)([h.default], () => h.default.getCurrentUser()), y = b.ZP.isPremium(I, v.p9.TIER_2), A = (0, s.e7)([m.Z], () => m.Z.affinities), P = (0, s.e7)([p.ZP], () => p.ZP.getFlattenedGuildIds()), R = A.length > 0 || P.length > 0, D = N.length > 0, Z = r.useMemo(() => N.filter(e => null != e.premiumGuildSubscription), [N]), w = Z.length > 0, k = N.length > Z.length, L = (0, s.e7)([g.Z], () => g.Z.getCurrentUserAppliedBoosts()), {
    fractionalState: B
  } = (0, l.Z)({
    forceFetch: !0
