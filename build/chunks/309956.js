...
let p = {
  ...
  f = (e, t) => {
    let {
      ...
      reset: g,
      setCurrentTab: h
    } = (0, s.S)(), b = n.useMemo(() => e !== u.AW.ORBS || r ? (0, u.RE)(e) && i ? u.AW.CATALOG : e : u.AW.HOME, [e, r, i]), [m, _] = n.useState(b), [O, v] = n.useState(u.f7.VISIBLE);
    n.useEffect(() => {
      h(m)
    }, [m, h]), n.useEffect(() => {
    ...
    let C = e => new Promise(t => setTimeout(t, e)),
      ...
      y = n.useCallback(async (e, r) => {
        ...
        _(n), r && v(u.f7.IN), t || S.push(d.Z5c.COLLECTIBLES_SHOP_WITH_TAB(n), {
          shallow: !0
        }), v(u.f7.VISIBLE)
      }, [S, t, i, f, g, m, E]);
    return {
