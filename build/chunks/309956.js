...
let p = {
  ...
  g = (e, t) => {
    let {
      ...
      reset: f,
      setCurrentTab: b
    } = (0, s.S)(), h = r.useMemo(() => e !== u.AW.ORBS || n ? (0, u.RE)(e) && a ? u.AW.CATALOG : e : u.AW.HOME, [e, n, a]), [m, _] = r.useState(h), [v, C] = r.useState(u.f7.VISIBLE);
    r.useEffect(() => {
      b(m)
    }, [m, b]), r.useEffect(() => {
      _(h)
    ...
    let O = e => new Promise(t => setTimeout(t, e)),
      ...
      y = r.useCallback(async (e, n) => {
        ...
        _(r), n && C(u.f7.IN), t || S.push(d.Z5c.COLLECTIBLES_SHOP_WITH_TAB(r), {
          shallow: !0
        }), C(u.f7.VISIBLE)
      }, [S, t, a, g, f, m, E]);
    return {
