  ...
  p = (e, t, n) => {
    ...
    return {
      ...
      transitionToTab: r.useCallback(async (t, r) => {
        r ? (C(c.f7.OUT), await O(1.1 * c.lb), m(t), n || v.push(u.Z5c.COLLECTIBLES_SHOP_WITH_TAB(t), {
          shallow: !0
        }), C(c.f7.IN)) : (p ? ((0, c.RE)(t) ? g(d[t]) : f(), m(c.AW.CATALOG)) : m(t), n || v.push(u.Z5c.COLLECTIBLES_SHOP_WITH_TAB(t), {
          shallow: !0
