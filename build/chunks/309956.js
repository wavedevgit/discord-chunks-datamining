...
let p = {
  ...
  f = (e, t) => {
    let {
      ...
      reset: g,
      setCurrentTab: b
    } = (0, s.S)(), h = n.useMemo(() => e !== u.AW.ORBS || r ? (0, u.RE)(e) && a ? u.AW.CATALOG : e : u.AW.HOME, [e, r, a]), [m, _] = n.useState(h), [v, C] = n.useState(u.f7.VISIBLE);
    n.useEffect(() => {
      b(m)
    }, [m, b]), n.useEffect(() => {
      _(h)
    ...
    let O = e => new Promise(t => setTimeout(t, e)),
      ...
      y = n.useCallback(async (e, r) => {
        ...
        _(n), r && C(u.f7.IN), t || S.push(d.Z5c.COLLECTIBLES_SHOP_WITH_TAB(n), {
          shallow: !0
        }), C(u.f7.VISIBLE)
      }, [S, t, a, f, g, m, E]);
    return {
