  ...
  p = (e, t, n) => {
    ...
    return {
      ...
      transitionToTab: r.useCallback(async (t, r) => {
        t === c.AW.HOME && p && h(), r ? (O(c.f7.OUT), await v(1.1 * c.lb), _(t), n || E.push(u.Z5c.COLLECTIBLES_SHOP_WITH_TAB(t), {
          shallow: !0
        }), O(c.f7.IN)) : (p ? ((0, c.RE)(t) ? f(d[t]) : g(), _(c.AW.CATALOG)) : _(t), n || E.push(u.Z5c.COLLECTIBLES_SHOP_WITH_TAB(t), {
          shallow: !0
