...
let p = {
  ...
  f = (e, t, r) => {
    let {
      ...
      clear: m
    } = (0, c.a)(), _ = n.useMemo(() => t !== u.AW.ORBS || o ? (0, u.RE)(t) && f ? u.AW.CATALOG : t : u.AW.HOME, [t, o, f]), [O, C] = n.useState(_), [v, E] = n.useState(u.f7.VISIBLE);
    n.useEffect(() => {
      b(O)
    }, [O, b]), n.useEffect(() => {
    ...
    let S = e => new Promise(t => setTimeout(t, e)),
      ...
      x = n.useCallback(async (t, n) => {
        ...
        C(l), n && E(u.f7.IN), r || y.push(d.Z5c.COLLECTIBLES_SHOP_WITH_TAB(l), {
          shallow: !0
