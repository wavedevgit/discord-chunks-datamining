...
let p = {
  ...
  g = (e, t) => {
    let {
      ...
      reset: f,
      setCurrentTab: h
    } = (0, s.S)(), b = n.useMemo(() => e !== u.AW.ORBS || r ? (0, u.RE)(e) && a ? u.AW.CATALOG : e : u.AW.HOME, [e, r, a]), [_, m] = n.useState(b), [v, C] = n.useState(u.f7.VISIBLE);
    n.useEffect(() => {
      h(_)
    }, [_, h]), n.useEffect(() => {
    ...
    let O = e => new Promise(t => setTimeout(t, e)),
      ...
      y = n.useCallback(async (e, r) => {
        ...
        m(n), r && C(u.f7.IN), t || S.push(d.Z5c.COLLECTIBLES_SHOP_WITH_TAB(n), {
          shallow: !0
        }), C(u.f7.VISIBLE)
      }, [S, t, a, g, f, _, E]);
    return {
