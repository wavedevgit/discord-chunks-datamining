...
function Q() {
  ...
  return U = null != Chunk77498.Z.lastFetched && Chunk283595.Z.fetched, !s().isEqual(o, k) && (k = o, Chunk358085.isPlatformEmbedded && Chunk998502.ZP.setSystemTrayApplications(V(k).map(e => e.application).slice(0, x)), true)
}
