...
class P extends i.PureComponent {
  ...
  getErrorMessage(e) {
    ...
    return i === j.evJ.INVALID_GIFT_SELF_REDEMPTION ? C.intl.string(C.t.wa9h7O) : i === j.evJ.INVALID_GIFT_REDEMPTION_OWNED && (null == n ? void 0 : n.productLine) === j.POd.COLLECTIBLES ? C.intl.string(C.t.mdLtb2) : null != t || i === j.evJ.INVALID_GIFT_REDEMPTION_OWNED ? C.intl.format(C.t.PIdmg4, {
      libraryLink: j.Z5c.APPLICATION_LIBRARY
    }) : e.isClaimed || i === j.evJ.INVALID_GIFT_REDEMPTION_EXHAUSTED ? C.intl.string(C.t.ilcBeX) : i === j.evJ.INVALID_GIFT_REDEMPTION_FRAUD_REJECTED ? C.intl.string(C.t.ypuSd3) : void 0
  }
  renderSpinner(e) {
