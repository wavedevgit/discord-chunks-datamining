...
function U(e) {
  ...
  if (s instanceof f.YB) {
    ...
    if (f.Le.has(s.type)) {
      ...
      let t = h === (null == (n = b.default.getCurrentUser()) ? true : n.id) && d.A.hasJoined(s.id);
      return G(s, U({
        user: a,
        context: e,
        overwrites: o,
  ...
  if (null == i) return T;
  if (!(h === (null == (t = b.default.getCurrentUser()) ? true : t.id) && c.A.isViewingRoles(i.id)) && (0, p.bM)(i, h)) return L(C, i, h, u);
