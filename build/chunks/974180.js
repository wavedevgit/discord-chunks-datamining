...
er(eC, "displayName", "NotificationStore"), new eC(s.Z, __OVERLAY__ ? {} : {
  NOTIFICATIONS_SET_PERMISSION_STATE: function(e) {
    ...
    t !== ei.$Ab.ENABLED || ee.isPlatformEmbedded || Q.Z.showNotification(n(185672), ea.intl.string(ea.t.VSgOVl), ea.intl.string(ea.t["1UJvqa"]), {
  ...
  GUILD_SCHEDULED_EVENT_UPDATE: function(e) {
    ...
    t.notification_type === el.sy.EVENT_START && (t.entity_type === el.WX.STAGE_INSTANCE || t.entity_type === el.WX.VOICE ? function(e) {
      ...
      if (null != t && null != n) Q.Z.showNotification(n.getIconURL(128), ea.intl.formatToPlainString(ea.t.bOu6Wl, {
        guildName: n.name
      }), ea.intl.formatToPlainString(ea.t.mYyaRE, {
        topic: e.name
      }), {
        notif_type: "GUILD_SCHEDULED_EVENT_UPDATE",
        guild_id: n.id
  ...
  WINDOW_HIDDEN: function() {
    ...
    let i = !1;
    return null != ef && (i = e_.includes(ef)), !!i && (Q.Z.showNotification(n(95045), ea.intl.string(ea.t.VSgOVl), ea.intl.string(ea.t["+J/F6+"]), {
  ...
  MESSAGE_REMINDER_DUE: function(e) {
    ...
    Q.Z.showNotification(l, ea.intl.string(ea.t.IjZJBw), a, {
