...
to(tZ, "displayName", "NotificationStore"), new tZ(s.Z, __OVERLAY__ ? {} : {
  ...
  MESSAGE_CREATE: function(t) {
    ...
    if (s.Z.dispatch({
        ...
        title: y,
        body: P
      }), (0, U.R)(u, f.guild_id), z.Z.getDesktopType() === tl.qrD.NEVER) return S && tt.Z.playNotificationSound(tu, ts, h), !1;
