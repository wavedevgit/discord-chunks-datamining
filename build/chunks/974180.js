...
async function eE(e) {
  ...
  t && (i.forEach(e => {
    ...
    let l = e_(t);
    n = new Set([...n, ...l])
  }), await N.ZP.fetchApplications([...n], !1)), i.forEach(e => {
    let {
      activities: n,
      user: i
    } = e;
...
ei(eS, "displayName", "NotificationStore"), new eS(u.Z, __OVERLAY__ ? {} : {
  ...
  MESSAGE_CREATE: function(e) {
    ...
    if (u.Z.dispatch({
        ...
        title: O,
        body: L
      }), (0, y.R)(s, g.guild_id), H.Z.getDesktopType() === ee.qrD.NEVER) return T && K.Z.playNotificationSound(el, ea, I), !1;
