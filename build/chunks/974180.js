...
ee(eu, "displayName", "NotificationStore"), new eu(o.Z, __OVERLAY__ ? {} : {
  NOTIFICATIONS_SET_PERMISSION_STATE: function(e) {
    let {
      enabled: t
    } = e;
    t !== X.$Ab.ENABLED || Y.isPlatformEmbedded || W.Z.showNotification(n(185672), $.intl.string($.t.VSgOVl), $.intl.string($.t["1UJvqa"]), {
  ...
  MESSAGE_CREATE: function(e) {
    ...
    if (o.Z.dispatch({
        ...
        title: R,
        body: M
      }), (0, I.R)(u, h.guild_id), k.Z.getDesktopType() === X.qrD.NEVER) return E && (0, v.t)(u, !0), !1;
    let U = null != (a = D.Z.getMessage(s, u.id)) ? a : (0, y.e5)(u);
    W.Z.showNotification(w, R, M, {
  ...
  ACTIVITY_START: function(e) {
    ...
    if (es() || n.type !== X.IIU.PLAYING) return !1;
    {
      ...
      return W.Z.showNotification(l, a, o, {
  ...
  VOICE_STATE_UPDATES: function(e) {
    ...
    null != s && null != c && null != u && W.Z.showNotification(s.getIconURL(128), c.name, $.intl.formatToPlainString($.t.sqnsSE, {
  ...
  STAGE_INSTANCE_UPDATE: function(e) {
    ...
    el.add(t.id), W.Z.showNotification(r.getIconURL(128), $.intl.formatToPlainString($.t.bZ4OkZ, {
      guildName: r.name
  ...
  GUILD_SCHEDULED_EVENT_UPDATE: function(e) {
    ...
    t.notification_type === Q.sy.EVENT_START && (t.entity_type === Q.WX.STAGE_INSTANCE || t.entity_type === Q.WX.VOICE ? function(e) {
      ...
      if (null != n && null != l && null != r && null != a && M.Z.can(i.$e(X.Plq.CONNECT, X.Plq.VIEW_CHANNEL), l)) W.Z.showNotification(r.getIconURL(128), $.intl.formatToPlainString($.t.bOu6Wl, {
        guildName: r.name
      ...
      if (null != t && null != n) W.Z.showNotification(n.getIconURL(128), $.intl.formatToPlainString($.t.bOu6Wl, {
        guildName: n.name
        ...
        onClick() {
          u.Z.transitionToGuildSync(e.guild_id), (0, b.bO)({
            eventId: e.id
          })
        },
        isUserAvatar: !1
  ...
  WINDOW_HIDDEN: function() {
    ...
    let r = !1;
    return null != ei && (r = ea.includes(ei)), !!r && (W.Z.showNotification(n(95045), $.intl.string($.t.VSgOVl), $.intl.string($.t["+J/F6+"]), {
  ...
  MESSAGE_REMINDER_DUE: function(e) {
    ...
    W.Z.showNotification(i, $.intl.string($.t.IjZJBw), l, {
