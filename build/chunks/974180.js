...
j(td, "displayName", "NotificationStore"), new td(o.Z, __OVERLAY__ ? {} : {
  NOTIFICATIONS_SET_PERMISSION_STATE: function(t) {
    let {
      enabled: e
    } = t;
    e !== J.$Ab.ENABLED || Y.isPlatformEmbedded || q.Z.showNotification(n(185672), $.intl.string($.t.VSgOVl), $.intl.string($.t["1UJvqa"]), {
  ...
  MESSAGE_CREATE: function(t) {
    ...
    if (S && (p && q.Z.playNotificationSound("message3", .4, y), !ti) || !T) return !1;
    ...
    if (o.Z.dispatch({
        ...
        title: L,
        body: M
      }), (0, h.R)(d, g.guild_id), k.Z.getDesktopType() === J.qrD.NEVER) return p && q.Z.playNotificationSound(Q, tt, y), !1;
  ...
  VOICE_STATE_UPDATES: function(t) {
    ...
    null != u && null != s && null != d && q.Z.showNotification(u.getIconURL(128), s.name, $.intl.formatToPlainString($.t.sqnsSE, {
  ...
  STAGE_INSTANCE_UPDATE: function(t) {
    ...
    ta.add(e.id), q.Z.showNotification(i.getIconURL(128), $.intl.formatToPlainString($.t.bZ4OkZ, {
      guildName: i.name
  ...
  GUILD_SCHEDULED_EVENT_UPDATE: function(t) {
    ...
    e.notification_type === K.sy.EVENT_START && (e.entity_type === K.WX.STAGE_INSTANCE || e.entity_type === K.WX.VOICE ? function(t) {
      if (tu()) return;
      let e = t.channel_id;
      ...
      if (null != n && null != a && null != i && null != r && M.Z.can(l.$e(J.Plq.CONNECT, J.Plq.VIEW_CHANNEL), a)) q.Z.showNotification(i.getIconURL(128), $.intl.formatToPlainString($.t.bOu6Wl, {
        guildName: i.name
    ...
    }(e) : e.entity_type === K.WX.EXTERNAL && function(t) {
      if (tu()) return;
      let e = W.default.getCurrentUser(),
        n = L.Z.getGuild(t.guild_id);
      if (null != e && null != n) q.Z.showNotification(n.getIconURL(128), $.intl.formatToPlainString($.t.bOu6Wl, {
        guildName: n.name
      }), $.intl.formatToPlainString($.t.mYyaRE, {
        topic: t.name
      }), {
        notif_type: "GUILD_SCHEDULED_EVENT_UPDATE",
        guild_id: n.id
  ...
  WINDOW_HIDDEN: function() {
    ...
    let i = !1;
    return null != tl && (i = tr.includes(tl)), !!i && (q.Z.showNotification(n(95045), $.intl.string($.t.VSgOVl), $.intl.string($.t["+J/F6+"]), {
  ...
  MESSAGE_REMINDER_DUE: function(t) {
    ...
    q.Z.showNotification(l, $.intl.string($.t.IjZJBw), a, {
