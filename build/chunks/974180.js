...
function eN(e, t, n) {
  let i = e.filter(e => e.type === ea.IIU.PLAYING && null != e.application_id).map(e => e.application_id);
  return n === u.Tv.ONLY_GAMES_PLAYED ? i.filter(e => T.Z.currentUserApplicationIds.has(e)) : i
}
async function eI(e) {
  ...
  t && (i.forEach(e => {
  ...
  }), await p.ZP.fetchApplications([...n], !1)), i.forEach(e => {
    let {
      activities: n,
      user: i,
      guildId: r
    ...
    ! function(e, t, n, i) {
      ...
      (0, l.difference)(a, e).filter(e => {
        ...
        if (null == eS[t] ? eS[t] = {
            [e]: i
          } : null == eS[t][e] && (eS[t][e] = i), n) {
          var l, a;
          let n = N.Z.getApplication(e);
          null != n && (l = n, a = t, (0, E.PR)(a).then(e => {
            var t;
            (0, L.m)(e.getAvatarURL(null, 64), null != (t = l.getIconURL(64)) ? t : null).then(t => {
              et.Z.showNotification(t, eu.intl.formatToPlainString(eu.t.SRy0Cg, {
                username: ee.ZP.getName(null, null, e)
              }), l.name, {
...
class eA extends(i = r.ZP.Store) {
  initialize() {
    this.waitFor(K.default, x.Z, q.Z, Y.Z, F.Z, X.Z, B.Z, $.Z, P.Z)
  }
}
eo(eA, "displayName", "NotificationStore"), new eA(s.Z, __OVERLAY__ ? {} : {
  ...
  MESSAGE_CREATE: function(e) {
    ...
    if (T && (p && et.Z.playNotificationSound("message3", .4, C), !eg) || !S) return !1;
    ...
    let {
      ...
      title: y,
      body: P
    } = (0, R.Xi)(f, o, _), L = !(0, O._x)("NotificationStore.handleMessage", null == E ? void 0 : E.id);
    if (s.Z.dispatch({
        ...
        title: y,
        body: P
      }), (0, D.R)(o, f.guild_id), q.Z.getDesktopType() === ea.qrD.NEVER) return p && et.Z.playNotificationSound(es, ed, C), !1;
    let k = null != (r = z.Z.getMessage(u, o.id)) ? r : (0, U.e5)(o);
    et.Z.showNotification(m, y, P, {
  ...
  ACTIVITY_START: function(e) {
    ...
    if (eC() || n.type !== ea.IIU.PLAYING) return !1;
    {
      ...
      return et.Z.showNotification(a, r, u, {
  ...
  VOICE_STATE_UPDATES: function(e) {
    ...
    null != o && null != s && null != d && et.Z.showNotification(o.getIconURL(128), s.name, eu.intl.formatToPlainString(eu.t.sqnsSE, {
  ...
  STAGE_INSTANCE_UPDATE: function(e) {
    ...
    if (null == n || null == l || null == i || null == r || !(0, R.LL)(n, r, l) || !B.Z.can(a.$e(ea.Plq.CONNECT, ea.Plq.VIEW_CHANNEL), l) || eE.has(t.id)) return !1;
    eE.add(t.id), et.Z.showNotification(i.getIconURL(128), eu.intl.formatToPlainString(eu.t.bZ4OkZ, {
      guildName: i.name
  ...
  GUILD_SCHEDULED_EVENT_UPDATE: function(e) {
    ...
    t.notification_type === er.sy.EVENT_START && (t.entity_type === er.WX.STAGE_INSTANCE || t.entity_type === er.WX.VOICE ? function(e) {
      if (eC()) return;
      let t = e.channel_id;
      ...
      if (null != n && null != l && null != i && null != r && B.Z.can(a.$e(ea.Plq.CONNECT, ea.Plq.VIEW_CHANNEL), l)) et.Z.showNotification(i.getIconURL(128), eu.intl.formatToPlainString(eu.t.bOu6Wl, {
        guildName: i.name
    ...
    }(t) : t.entity_type === er.WX.EXTERNAL && function(e) {
      if (eC()) return;
      let t = K.default.getCurrentUser(),
        n = Y.Z.getGuild(e.guild_id);
      if (null != t && null != n) et.Z.showNotification(n.getIconURL(128), eu.intl.formatToPlainString(eu.t.bOu6Wl, {
        guildName: n.name
      }), eu.intl.formatToPlainString(eu.t.mYyaRE, {
        topic: e.name
      }), {
        notif_type: "GUILD_SCHEDULED_EVENT_UPDATE",
        guild_id: n.id
        ...
        onClick() {
          f.Z.transitionToGuildSync(e.guild_id), (0, v.bO)({
            eventId: e.id
          })
        },
        isUserAvatar: !1
  ...
  WINDOW_HIDDEN: function() {
    ...
    let i = !1;
    return null != e_ && (i = eT.includes(e_)), !!i && (et.Z.showNotification(n(95045), eu.intl.string(eu.t.VSgOVl), eu.intl.string(eu.t["+J/F6+"]), {
  ...
  MESSAGE_REMINDER_DUE: function(e) {
    ...
    et.Z.showNotification(l, eu.intl.string(eu.t.IjZJBw), a, {
