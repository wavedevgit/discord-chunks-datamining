  ...
  t && (i.forEach(e => {
    ...
    ! function(e, t, n, i) {
      ...
      (0, l.difference)(a, e).filter(e => {
        ...
        if (null == e_[t] ? e_[t] = {
            [e]: i
          } : null == e_[t][e] && (e_[t][e] = i), n) {
          var l, a;
          let n = N.Z.getApplication(e);
          null != n && (l = n, a = t, (0, _.PR)(a).then(e => {
            var t;
            (0, O.m)(e.getAvatarURL(null, 64), null != (t = l.getIconURL(64)) ? t : null).then(t => {
              ee.Z.showNotification(t, er.intl.formatToPlainString(er.t.SRy0Cg, {
                username: $.ZP.getName(null, null, e)
              }), l.name, {
...
eu(eZ, "displayName", "NotificationStore"), new eZ(s.Z, __OVERLAY__ ? {} : {
  NOTIFICATIONS_SET_PERMISSION_STATE: function(e) {
    let {
      enabled: t
    } = e;
    t !== el.$Ab.ENABLED || et.isPlatformEmbedded || ee.Z.showNotification(n(185672), er.intl.string(er.t.VSgOVl), er.intl.string(er.t["1UJvqa"]), {
  ...
  MESSAGE_CREATE: function(e) {
    ...
    if (S && (p && ee.Z.playNotificationSound("message3", .4, C), !ef) || !T) return !1;
    ...
    if (s.Z.dispatch({
        ...
        title: y,
        body: P
      }), (0, U.R)(o, f.guild_id), q.Z.getDesktopType() === el.qrD.NEVER) return p && ee.Z.playNotificationSound(eo, es, C), !1;
    let O = null != (r = z.Z.getMessage(u, o.id)) ? r : (0, D.e5)(o);
    ee.Z.showNotification(v, y, P, {
  ...
  ACTIVITY_START: function(e) {
    ...
    if (eh() || n.type !== el.IIU.PLAYING) return !1;
    {
      ...
      return ee.Z.showNotification(a, r, u, {
  ...
  VOICE_STATE_UPDATES: function(e) {
    ...
    null != o && null != s && null != d && ee.Z.showNotification(o.getIconURL(128), s.name, er.intl.formatToPlainString(er.t.sqnsSE, {
  ...
  STAGE_INSTANCE_UPDATE: function(e) {
    ...
    eE.add(t.id), ee.Z.showNotification(i.getIconURL(128), er.intl.formatToPlainString(er.t.bZ4OkZ, {
      guildName: i.name
  ...
  GUILD_SCHEDULED_EVENT_UPDATE: function(e) {
    ...
    t.notification_type === ea.sy.EVENT_START && (t.entity_type === ea.WX.STAGE_INSTANCE || t.entity_type === ea.WX.VOICE ? function(e) {
      if (eh()) return;
      let t = e.channel_id;
      ...
      if (null != n && null != l && null != i && null != r && x.Z.can(a.$e(el.Plq.CONNECT, el.Plq.VIEW_CHANNEL), l)) ee.Z.showNotification(i.getIconURL(128), er.intl.formatToPlainString(er.t.bOu6Wl, {
        guildName: i.name
    ...
    }(t) : t.entity_type === ea.WX.EXTERNAL && function(e) {
      if (eh()) return;
      let t = K.default.getCurrentUser(),
        n = Y.Z.getGuild(e.guild_id);
      if (null != t && null != n) ee.Z.showNotification(n.getIconURL(128), er.intl.formatToPlainString(er.t.bOu6Wl, {
        guildName: n.name
      }), er.intl.formatToPlainString(er.t.mYyaRE, {
        topic: e.name
      }), {
        notif_type: "GUILD_SCHEDULED_EVENT_UPDATE",
        guild_id: n.id
  ...
  WINDOW_HIDDEN: function() {
    ...
    let i = !1;
    return null != eg && (i = eT.includes(eg)), !!i && (ee.Z.showNotification(n(95045), er.intl.string(er.t.VSgOVl), er.intl.string(er.t["+J/F6+"]), {
  ...
  MESSAGE_REMINDER_DUE: function(e) {
    ...
    ee.Z.showNotification(l, er.intl.string(er.t.IjZJBw), a, {
