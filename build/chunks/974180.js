...
async function eE(e) {
  ...
  t && (i.forEach(e => {
    ...
    ! function(e, t, n) {
      ...
      (0, l.difference)([...null != (a = ec[t]) ? a : []], e).filter(e => null != e).forEach(e => ec[t].delete(e)), r.length > 0 && null == ec[t] && (ec[t] = new Set), r.forEach(e => {
        if (ec[t].add(e), n) {
          var i, l;
...
ei(eT, "displayName", "NotificationStore"), new eT(u.Z, __OVERLAY__ ? {} : {
  NOTIFICATIONS_SET_PERMISSION_STATE: function(e) {
    let {
      enabled: t
    } = e;
    t !== ee.$Ab.ENABLED || $.isPlatformEmbedded || K.Z.showNotification(n(185672), en.intl.string(en.t.VSgOVl), en.intl.string(en.t["1UJvqa"]), {
  ...
  MESSAGE_CREATE: function(e) {
    ...
    if (N && (S && K.Z.playNotificationSound("message3", .4, I), !eu) || !p) return !1;
    ...
    if (u.Z.dispatch({
        ...
        title: O,
        body: L
      }), (0, v.R)(s, g.guild_id), H.Z.getDesktopType() === ee.qrD.NEVER) return S && K.Z.playNotificationSound(el, ea, I), !1;
    let w = null != (r = F.Z.getMessage(o, s.id)) ? r : (0, y.e5)(s);
    K.Z.showNotification(R, O, L, {
  ...
  VOICE_STATE_UPDATES: function(e) {
    ...
    null != u && null != s && null != d && K.Z.showNotification(u.getIconURL(128), s.name, en.intl.formatToPlainString(en.t.sqnsSE, {
  ...
  STAGE_INSTANCE_UPDATE: function(e) {
    ...
    ed.add(t.id), K.Z.showNotification(i.getIconURL(128), en.intl.formatToPlainString(en.t.bZ4OkZ, {
      guildName: i.name
  ...
  GUILD_SCHEDULED_EVENT_UPDATE: function(e) {
    ...
    t.notification_type === et.sy.EVENT_START && (t.entity_type === et.WX.STAGE_INSTANCE || t.entity_type === et.WX.VOICE ? function(e) {
      if (ep()) return;
      let t = e.channel_id;
      ...
      if (null != n && null != l && null != i && null != r && W.Z.can(a.$e(ee.Plq.CONNECT, ee.Plq.VIEW_CHANNEL), l)) K.Z.showNotification(i.getIconURL(128), en.intl.formatToPlainString(en.t.bOu6Wl, {
        guildName: i.name
    ...
    }(t) : t.entity_type === et.WX.EXTERNAL && function(e) {
      if (ep()) return;
      let t = X.default.getCurrentUser(),
        n = V.Z.getGuild(e.guild_id);
      if (null != t && null != n) K.Z.showNotification(n.getIconURL(128), en.intl.formatToPlainString(en.t.bOu6Wl, {
        guildName: n.name
      }), en.intl.formatToPlainString(en.t.mYyaRE, {
        topic: e.name
      }), {
        notif_type: "GUILD_SCHEDULED_EVENT_UPDATE",
        guild_id: n.id
        ...
        onClick() {
          c.Z.transitionToGuildSync(e.guild_id), (0, I.bO)({
            eventId: e.id
          })
        },
        isUserAvatar: !1
  ...
  WINDOW_HIDDEN: function() {
    ...
    let i = !1;
    return null != es && (i = ef.includes(es)), !!i && (K.Z.showNotification(n(95045), en.intl.string(en.t.VSgOVl), en.intl.string(en.t["+J/F6+"]), {
  ...
  MESSAGE_REMINDER_DUE: function(e) {
    ...
    K.Z.showNotification(l, en.intl.string(en.t.IjZJBw), a, {
