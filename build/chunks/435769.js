...
var Chunk527758 = require("./527758.js"),
  Chunk47312 = require("./47312.js"),
  Chunk64700 = require("./64700.js"),
  Chunk392852 = require("./392852.js"),
...
let d = function(e) {
  function t(t) {
    var r;
    return (r = e.call(this, t) || this)._hcaptcha = true, r.renderCaptcha = r.renderCaptcha.bind((0, n.A)(r)), r.resetCaptcha = r.resetCaptcha.bind((0, n.A)(r)), r.removeCaptcha = r.removeCaptcha.bind((0, n.A)(r)), r.isReady = r.isReady.bind((0, n.A)(r)), r.loadCaptcha = r.loadCaptcha.bind((0, n.A)(r)), r.handleOnLoad = r.handleOnLoad.bind((0, n.A)(r)), r.handleSubmit = r.handleSubmit.bind((0, n.A)(r)), r.handleExpire = r.handleExpire.bind((0, n.A)(r)), r.handleError = r.handleError.bind((0, n.A)(r)), r.handleOpen = r.handleOpen.bind((0, n.A)(r)), r.handleClose = r.handleClose.bind((0, n.A)(r)), r.handleChallengeExpired = r.handleChallengeExpired.bind((0, n.A)(r)), r.ref = i.createRef(), r.apiScriptRequested = false, r.state = {
      isApiReady: false,
      isRemoved: false,
      elementId: t.id,
      captchaId: ""
  ...
  return r.componentDidMount = function() {
    var e = this,
      ...
      r = (0, o.CC)(t);
    (this._hcaptcha = r.window.hcaptcha || true, true !== this._hcaptcha) ? this.setState({
      isApiReady: true
    }, function() {
      e.renderCaptcha()
    }): this.loadCaptcha()
