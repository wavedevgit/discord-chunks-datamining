...
function R(e) {
  ...
  return h ? <a.zx variant={"secondary"} size={"md"} onClick={v} text={O} /> : <s.zx data-migration-pending={true} className={y.CTAMessageButtonOuter} innerClassName={y.CTAMessageButton} color={s.Tt.PRIMARY} onMouseEnter={() => g(true)} onMouseLeave={() => g(false)} onClick={v}>{<u.Z className={y.CTAMessageSticker} isInteracting={m} sticker={b} size={28} />}{O}</s.zx>
}
...
function P(e) {
  ...
  return null != l && c ? <div className={y.CTAMessage}><R currentUser={l} channel={t} message={n} buttonLabels={i} stickers={o} event={a} eventProperties={s} /></div> : null
}