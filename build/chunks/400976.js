/** Chunk was on web.js **/
/** chunk id: 400976, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  $k: () => N,
  AK: () => T,
  ...
  u6: () => O,
  v5: () => P
}), require("./896048.js"), require("./864466.js"), require("./443073.js"), require("./65821.js"), require("./321073.js"), require("./457529.js"), require("./591487.js"), require("./727858.js"), require("./747238.js"), require("./775443.js"), require("./733351.js");
var Chunk267721 = require("./267721.js"),
  i = require.n(Chunk267721),
  Chunk128080 = require("./128080.js"),
  s = require.n(Chunk128080),
  Chunk909203 = require("./909203.js"),
  l = require.n(Chunk909203),
  Chunk214958 = require("./214958.js"),
  u = require.n(Chunk214958),
  Chunk316179 = require("./316179.js"),
...
function S(e) {
  ...
  if (A.type = n, A.protocol = y, A.payloads = l, A.setup = r, A.mid = t, A.rtcpMux = "rtcp-mux", A.direction = a, A.ssrcs = f, f.length > 0 && (null != E && (A.ssrcGroups = i()(f, g).map(e => {
      let t = e[0].id;
      return {
        semantics: "FID",
  ...
  switch (n) {
    case "audio":
      if ("Firefox" === u().name) A.ext = h.filter(e => "urn:ietf:params:rtp-hdrext:ssrc-audio-level" === e.uri);
      else if (A.ext = h.filter(e => "urn:ietf:params:rtp-hdrext:ssrc-audio-level" === e.uri || "http://www.ietf.org/id/draft-holmer-rmcat-transport-wide-cc-extensions-01" === e.uri), A.rtcpFb = [{
          type: "transport-cc",
          payload: l
        }], true === O) {
        var v;
        null == (v = A.rtcpFb) || v.push({
          type: "nack",
          payload: l
        })
      }
      A.rtp.push({
        ...
        payload: l,
        rate: 48e3
      }), o === p.UK.OPUS && A.fmtp.push({
        config: "minptime=10;useinbandfec=1;usedtx=".concat(b ? "0" : "1"),
        payload: l
      }), A.maxptime = 60;
      break;
    case "video":
      A.ext = h.filter(e => "urn:ietf:params:rtp-hdrext:toffset" === e.uri || "http://www.webrtc.org/experiments/rtp-hdrext/abs-send-time" === e.uri || "urn:3gpp:video-orientation" === e.uri || "http://www.ietf.org/id/draft-holmer-rmcat-transport-wide-cc-extensions-01" === e.uri || "http://www.webrtc.org/experiments/rtp-hdrext/playout-delay" === e.uri), A.rtp.push({
        codec: o,
        payload: l,
        rate: 9e4
      });
      let S = "x-google-max-bitrate=".concat(c);
      o === p.UK.H264 ? S += ";level-asymmetry-allowed=1;packetization-mode=1;profile-level-id=42e01f" : o === p.UK.H265 && (S += ";level-id=180;profile-id=1;tier-flag=0;tx-mode=SRST"), A.fmtp.push({
        config: S,
        payload: l
      }), A.rtcpFb = [{
        type: "ccm",
...
function T(e) {
  ...
  return d.forEach(e => {
    ...
    "" !== m ? t = A(m, d, "audio" === g ? "a" : "v") : (t = [], "sendonly" === E ? E = "inactive" : "sendrecv" === E && (E = "recvonly"));
    let y = "audio" === g ? r : s,
      O = "audio" === g ? i : o,
      v = "audio" === g ? null : u,
      I = "audio" === g ? a : l;
  ...
  let n = d.parse(e).media.reduce((e, n) => {
    ...
    switch (e.outboundStreams.push({
      ...
      case "audio":
        ...
        }), "sendrecv" === l && null != (r = null == s ? true : s.find(e => "cname" === e.attribute)) && (e.audioSSRC = r.id);
        break;
      case "video":
        (t ? [p.UK.H265, p.UK.H264, p.UK.VP8, p.UK.VP9] : [p.UK.H264, p.UK.VP8, p.UK.VP9]).forEach((t, n) => {
          let r = C(a, o, i, t, n);
          null != r && e.codecs.push(r)
        }), "sendrecv" === l && (null != (r = null == s ? true : s.find(e => "cname" === e.attribute)) && (e.videoSSRC = r.id), null != (r = null == s ? true : s.findLast(e => "cname" === e.attribute)) && (r.id === e.videoSSRC && E.warn("Unable to find a unique rtx SSRC!"), e.rtxSSRC = r.id))
    }
    return e
  }, {
    outboundStreams: [],
...
function R(e, t) {
  ...
  let {
    codecs: r
  } = N(e, t), i = r.find(e => e.name === p.UK.VP8), a = RegExp("^a=ice|a=extmap|a=fingerprint|opus|VP8|".concat(null != (n = null == i ? true : i.rtxPayloadType) ? n : 0, " rtx"), "i");
  return {
