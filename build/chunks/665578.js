...
function w(e) {
  let {
    ...
    return a.fS(t, u.BO) && (t = C.Plq.ADMINISTRATOR), n => (0, i.jsx)(e, E(I({}, n), {
...
function P(e) {
  let t = (0, v.U)(e);
  return E(I({}, t), {
    results: t.results.roles.map(e => E(I({}, e), {
      type: d.Kw.ROLE
    })).concat(t.results.members.map(e => E(I({}, e), {
      type: d.Kw.USER
    })))
  })
}