...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk256226 = require("./256226.js"),
  Chunk314172 = require("./314172.js"),
...
function x(e) {
  ...
  let F = i.useMemo(() => "roles-".concat((0, o.Z)()), []),
    ...
    W = (j ? d : R).map((e, i) => {
      var o;
      return <b.Z role={e} guildId={l.id} style={{
          maxWidth: j || i !== R.length - 1 ? w : M
        }} disableBorderColor={true} ref={t => A(e.id, t)} onRemove={() => E(e)} canRemove={(null == (o = e.tags) ? true : o.guild_connections) === null ? t.id === n.id : _ && m.r6(l, n.id, f, e)} />
    }),
    {
  ...
  return <s.bG navigator={V}><s.SJ>{e => {
        var {
          ref: t
        } = e, n = C(e, ["ref"]);
...
function M(e) {
  ...
  return 0 !== h.length || T ? <x user={t} currentUser={n} guild={o} guildMember={s} roles={h} highestRole={b} canManageRoles={y} onAddRole={I} onRemoveRole={v} /> : null
}