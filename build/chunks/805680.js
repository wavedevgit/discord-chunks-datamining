...
let q = k.Om + U.Su.MEDIUM,
  ...
  Q = e => {
    let {
      ...
      drawerRef: n,
      orientation: r
    } = e, a = (0, d.e7)([P.ZP], () => P.ZP.expressionPickerWidth), [o, s] = i.useState(window.innerWidth), [c, u] = i.useState(null != a ? a : k._j.MIN), _ = i.useMemo(() => {
      switch (c) {
        case k._j.MIN:
          return k.Om;
        case k._j.MAX:
...
function J(e) {
  ...
  let {
    ...
    renderWindow: ed,
    windowDispatch: e_
  } = i.useContext(E.ZP), ef = (0, d.e7)([C.Z], () => !C.Z.hasLoadedStickerPacks), ep = (0, S.V2)({
  ...
  i.useLayoutEffect(() => {
    ...
    return ed.addEventListener("mousedown", ev), ed.addEventListener("contextmenu", ev), e_.subscribe(M.CkL.POPOUT_CLOSE, eI), D.S.subscribe(M.CkL.CLOSE_GIF_PICKER, e), () => {
      ed.removeEventListener("mousedown", ev), ed.removeEventListener("contextmenu", ev), e_.unsubscribe(M.CkL.POPOUT_CLOSE, eI), D.S.unsubscribe(M.CkL.CLOSE_GIF_PICKER, e)
    }
  }, [ec, eI, ev, ed, e_]), (0, p.Tbt)(er);
  let [eT, eS] = (0, y.US)(ep ? [_.z.SOUNDMOJI_BADGE] : [], void 0, !1), [eA, eN] = i.useState(!1);
  i.useEffect(() => {
    ...
    if (null != eo.current && !ei.current) {
      var e, t, n, r;
      ec === k.X1.EMOJI ? (null == ea || null == (e = ea.current) ? void 0 : e.onPickerOpen) != null && (null == ea || null == (t = ea.current) || t.onPickerOpen(), ei.current = !0) : ec === k.X1.STICKER ? (null == ea || null == (n = ea.current) ? void 0 : n.onPickerOpen) == null || ef || (null == ea || null == (r = ea.current) || r.onPickerOpen(), ei.current = !0) : (b.ZP.trackWithMetadata(M.rMx.EXPRESSION_PICKER_OPENED, {
        ...
        return (0, r.jsx)("section", {
          ...
          children: n ? (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)("div", {
              ...
              }) : null, ec === k.X1.STICKER && eb ? (0, r.jsx)(R.Z, {
                isLoading: ef,
                channel: K,
                containerWidth: es,
                onSelectSticker: Y,
              ...
              }) : null, ec === k.X1.GIF && eE ? (0, r.jsx)(I.Z, {
                onSelectGIF: Z,
                hideFavorites: h,
                persistSearch: !0
              }) : null, ec === k.X1.EMOJI ? (0, r.jsx)(O.Z, {
                hasTabWrapper: !0,
