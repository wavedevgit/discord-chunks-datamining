...
function J(e) {
  ...
  let {
    ...
    parentModalKey: en
  } = e, er = i.useRef(null), ei = i.useRef(!1), eo = i.useRef(null), ea = i.useRef(null), {
    drawerWidth: es,
  ...
  i.useEffect(() => {
    ...
    if (null != ea.current && !ei.current) {
      var e, t, n, r;
      ec === M.X1.EMOJI ? (null == eo || null == (e = eo.current) ? void 0 : e.onPickerOpen) != null && (null == eo || null == (t = eo.current) || t.onPickerOpen(), ei.current = !0) : ec === M.X1.STICKER ? (null == eo || null == (n = eo.current) ? void 0 : n.onPickerOpen) == null || e_ || (null == eo || null == (r = eo.current) || r.onPickerOpen(), ei.current = !0) : (b.ZP.trackWithMetadata(k.rMx.EXPRESSION_PICKER_OPENED, {
