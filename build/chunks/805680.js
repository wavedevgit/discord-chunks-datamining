...
let q = k.Om + U.Su.MEDIUM,
  ...
  Q = e => {
    let {
      ...
      drawerRef: n,
      orientation: r
    } = e, a = (0, d.e7)([P.ZP], () => P.ZP.expressionPickerWidth), [o, s] = i.useState(window.innerWidth), [c, u] = i.useState(null != a ? a : k._j.MIN), f = i.useMemo(() => {
      switch (c) {
        case k._j.MIN:
          return k.Om;
        case k._j.MAX:
...
function J(e) {
  ...
  }), eh = (0, d.e7)([w.Z], () => w.Z.isOpen()), em = null != en, eg = (0, _.Jw)(null != en ? en : ""), eE = (null == (t = z.gifs) ? void 0 : t.allowSending) && !c.tq && null != Z, eb = (null == (n = z.stickers) ? void 0 : n.allowSending) && null != Y, ey = !(null == (a = z.expressionPicker) ? void 0 : a.onlyEmojis) && (eE || eb), {
  ...
  let [eT, eS] = (0, y.US)(ep ? [f.z.SOUNDMOJI_BADGE] : [], void 0, !1), [eA, eN] = i.useState(!1);
  i.useEffect(() => {
    ...
    if (null != eo.current && !ei.current) {
      var e, t, n, r;
      ec === k.X1.EMOJI ? (null == ea || null == (e = ea.current) ? void 0 : e.onPickerOpen) != null && (null == ea || null == (t = ea.current) || t.onPickerOpen(), ei.current = !0) : ec === k.X1.STICKER ? (null == ea || null == (n = ea.current) ? void 0 : n.onPickerOpen) == null || e_ || (null == ea || null == (r = ea.current) || r.onPickerOpen(), ei.current = !0) : (b.ZP.trackWithMetadata(M.rMx.EXPRESSION_PICKER_OPENED, {
