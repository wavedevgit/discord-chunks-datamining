...
let $ = G.Om + F.Su.MEDIUM,
  ...
  et = e => {
    let {
      ...
      drawerRef: n,
      orientation: r
    } = e, a = (0, f.e7)([x.ZP], () => x.ZP.expressionPickerWidth), [o, s] = i.useState(window.innerWidth), [c, u] = i.useState(null != a ? a : G._j.MIN), d = i.useMemo(() => {
      switch (c) {
        case G._j.MIN:
          return G.Om;
        case G._j.MAX:
      ...
      null == t && null != n.current && (n.current.style.width = ""), E.ZP.updatedUnsyncedSettings({
...
function en(e) {
  ...
  }), ef = (0, U.Iu)(e => e.activeView), e_ = (0, w.fQ)(X), {
    renderWindow: ep,
    windowDispatch: eh
  } = i.useContext(O.ZP), em = (0, f.e7)([D.Z], () => !D.Z.hasLoadedStickerPacks), eg = (0, R.V2)({
    location: "expression_picker"
  }), eE = (0, f.e7)([M.Z], () => M.Z.isOpen()), eb = null != ea, ey = (0, p.Jw)(null != ea ? ea : ""), eO = (0, S.h)({
    location: "expression_picker",
    autoTrackExposure: !1
  }), ev = i.useCallback(e => {
    var t;
  ...
  i.useLayoutEffect(() => {
    ...
    return ep.addEventListener("mousedown", ev), ep.addEventListener("contextmenu", ev), eh.subscribe(B.CkL.POPOUT_CLOSE, eI), k.S.subscribe(B.CkL.CLOSE_GIF_PICKER, e), () => {
  ...
  }, [ef, eI, ev, ep, eh]), (0, g.Tbt)(eo);
  let [eT, eS] = (0, I.US)(eg ? [_.z.SOUNDMOJI_BADGE] : [], void 0, !1), [eA, eN] = i.useState(!1);
  i.useEffect(() => {
    ...
    if (null != ec.current && !es.current) {
      var e, t, n, r;
      ef === G.X1.EMOJI ? (null == el || null == (e = el.current) ? void 0 : e.onPickerOpen) != null && (null == el || null == (t = el.current) || t.onPickerOpen(), es.current = !0) : ef === G.X1.STICKER ? (null == el || null == (n = el.current) ? void 0 : n.onPickerOpen) == null || em || (null == el || null == (r = el.current) || r.onPickerOpen(), es.current = !0) : (v.ZP.trackWithMetadata(B.rMx.EXPRESSION_PICKER_OPENED, {
      ...
      children: e => {
        ...
        return (0, r.jsx)("section", {
          className: o()(W.positionContainer, {
            [W.positionContainerOnlyEmoji]: !eL
          }),
          ref: eo,
          role: "dialog",
          ...
          children: n ? (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)("div", {
                ...
                children: (0, r.jsxs)("div", {
                  ...
                  children: [eC ? (0, r.jsx)(ee, {
                    ...
                    children: (0, r.jsxs)("div", {
                      ...
                      children: [Y.intl.string(Y.t.EHlAMT), null != eT && (0, r.jsx)(g.IGR, {
                        text: Y.intl.string(Y.t.y2b7CA)
                      })]
                    })
                  }), eO && ef === G.X1.EMOJI && (0, r.jsx)("div", {
              ...
              }) : null, ef === G.X1.STICKER && eR ? (0, r.jsx)(L.Z, {
                isLoading: em,
                channel: X,
                containerWidth: eu,
                onSelectSticker: z,
              ...
              }) : null, ef === G.X1.GIF && eC ? (0, r.jsx)(N.Z, {
                onSelectGIF: x,
                hideFavorites: m,
                persistSearch: !0
              }) : null, ef === G.X1.EMOJI ? (0, r.jsx)(T.Z, {
                hasTabWrapper: !0,
              ...
              }) : null, ef === G.X1.SOUNDBOARD ? (0, r.jsx)("div", {
