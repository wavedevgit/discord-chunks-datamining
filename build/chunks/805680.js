...
let J = U.Om + F.Su.MEDIUM,
  ...
  ee = e => {
    let {
      ...
      drawerRef: n,
      orientation: r
    } = e, a = (0, f.e7)([L.ZP], () => L.ZP.expressionPickerWidth), [o, s] = i.useState(window.innerWidth), [c, u] = i.useState(null != a ? a : U._j.MIN), d = i.useMemo(() => {
      switch (c) {
        case U._j.MIN:
          return U.Om;
        case U._j.MAX:
...
function et(e) {
  ...
  }), ef = (0, j.Iu)(e => e.activeView), e_ = (0, P.fQ)(X), {
    renderWindow: ep,
    windowDispatch: eh
  } = i.useContext(y.ZP), em = (0, f.e7)([w.Z], () => !w.Z.hasLoadedStickerPacks), eg = (0, C.V2)({
    location: "expression_picker"
  }), eE = (0, f.e7)([x.Z], () => x.Z.isOpen()), eb = null != ea, ey = (0, h.Jw)(null != ea ? ea : ""), eO = (0, T.h)({
    location: "expression_picker",
    autoTrackExposure: !1
  }), ev = i.useCallback(e => {
    var t;
    if (!eb && (0, h.$s)() || eb && !(ey && ei) || eE || e.defaultPrevented) return;
    let {
      target: n
    } = e;
  ...
  i.useEffect(() => {
    ...
    (!eb && (0, h.$s)() || eb && !ey) && (0, j._Q)()
  }, [ey, eb]), i.useEffect(() => {
    if (null != ec.current && !es.current) {
      var e, t, n, r;
      ef === U.X1.EMOJI ? (null == el || null == (e = el.current) ? void 0 : e.onPickerOpen) != null && (null == el || null == (t = el.current) || t.onPickerOpen(), es.current = !0) : ef === U.X1.STICKER ? (null == el || null == (n = el.current) ? void 0 : n.onPickerOpen) == null || em || (null == el || null == (r = el.current) || r.onPickerOpen(), es.current = !0) : (O.ZP.trackWithMetadata(G.rMx.EXPRESSION_PICKER_OPENED, {
        ...
        return (0, r.jsx)("section", {
          ...
          children: n ? (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)("div", {
              ...
              children: [eL ? (0, r.jsx)("nav", {
              ...
              }) : null, ef === U.X1.STICKER && eR ? (0, r.jsx)(D.Z, {
                isLoading: em,
                channel: X,
                containerWidth: eu,
                onSelectSticker: z,
              ...
              }) : null, ef === U.X1.GIF && eC ? (0, r.jsx)(A.Z, {
                onSelectGIF: W,
                hideFavorites: g,
                persistSearch: !0
              }) : null, ef === U.X1.EMOJI ? (0, r.jsx)(I.Z, {
                hasTabWrapper: !0,
                ...
                containerWidth: eu,
                includeCreateEmojiButton: L,
                emojiSize: null != eu && eu < J ? F.Su.MEDIUM : F.Su.LARGE,
                pickerIntention: V.Hz.CHAT,
                closePopout: eI,
                onSelectEmoji: K,
              ...
              }) : null, ef === U.X1.SOUNDBOARD ? (0, r.jsx)("div", {
