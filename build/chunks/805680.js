...
let J = U.Om + V.Su.MEDIUM,
  $ = i.memo(function(e) {
    var {
      ...
      autoFocus: a = !1,
      "aria-controls": s
    } = e, l = X(e, ["isActive", "className", "viewType", "autoFocus", "aria-controls"]);
    return (0, r.jsx)(m.zxk, q(K({
      role: "tab",
      autoFocus: a,
      ...
      className: o()(n, Y.navButton, Y.navItem, {
        [Y.navButtonActive]: t
      }),
  ...
  ee = e => {
    let {
      ...
      drawerRef: n,
      orientation: r
    } = e, a = (0, _.e7)([L.ZP], () => L.ZP.expressionPickerWidth), [o, s] = i.useState(window.innerWidth), [c, u] = i.useState(null != a ? a : U._j.MIN), d = i.useMemo(() => {
      switch (c) {
        case U._j.MIN:
          return U.Om;
        case U._j.MAX:
      ...
      null == t && null != n.current && (n.current.style.width = ""), g.ZP.updatedUnsyncedSettings({
...
function et(e) {
  ...
  let {
    ...
    position: et,
    align: en,
    positionLayerClassName: er,
    closeOnModalOuterClick: ei = !1,
    parentModalKey: ea
  } = e, eo = i.useRef(null), es = i.useRef(!1), el = i.useRef(null), ec = i.useRef(null), {
    drawerWidth: eu,
    handleDrawerResizeHandleMouseDown: ed
  } = ee({
    positionContainerRef: eo,
    drawerRef: ec,
    orientation: "left" === en ? b.y.HORIZONTAL_RIGHT : b.y.HORIZONTAL_LEFT
  }), e_ = (0, j.Iu)(e => e.activeView), ef = (0, P.fQ)(X), {
    renderWindow: ep,
    windowDispatch: eh
  } = i.useContext(y.ZP), em = (0, _.e7)([w.Z], () => !w.Z.hasLoadedStickerPacks), eg = (0, C.V2)({
    location: "expression_picker"
  }), eE = (0, _.e7)([x.Z], () => x.Z.isOpen()), eb = null != ea, ey = (0, p.Jw)(null != ea ? ea : ""), eO = (0, T.h)({
    location: "expression_picker",
    autoTrackExposure: !1
  }), ev = i.useCallback(e => {
    var t;
  ...
  }, [e_, eI, ev, ep, eh]), (0, m.Tbt)(eo);
  let [eT, eS] = (0, v.US)(eg ? [f.z.SOUNDMOJI_BADGE] : [], void 0, !1), [eA, eN] = i.useState(!1);
  i.useEffect(() => {
    e_ === U.X1.SOUNDBOARD && eN(!0)
  }, [e_]), i.useEffect(() => () => {
    ...
    if (null != ec.current && !es.current) {
      var e, t, n, r;
      e_ === U.X1.EMOJI ? (null == el || null == (e = el.current) ? void 0 : e.onPickerOpen) != null && (null == el || null == (t = el.current) || t.onPickerOpen(), es.current = !0) : e_ === U.X1.STICKER ? (null == el || null == (n = el.current) ? void 0 : n.onPickerOpen) == null || em || (null == el || null == (r = el.current) || r.onPickerOpen(), es.current = !0) : (O.ZP.trackWithMetadata(G.rMx.EXPRESSION_PICKER_OPENED, {
      ...
      children: e => {
        ...
        return (0, r.jsx)("section", {
          className: o()(Y.positionContainer, {
            [Y.positionContainerOnlyEmoji]: !eL
          }),
          ref: eo,
          role: "dialog",
          ...
          children: n ? (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)("div", {
              ...
              className: o()(Y.contentWrapper, {
                [Y.emojiStudioActive]: eO
              }),
              children: [eL ? (0, r.jsx)("nav", {
                className: Y.nav,
                children: (0, r.jsxs)("div", {
                  ...
                  children: [eC ? (0, r.jsx)($, {
                    id: V._3,
                    "aria-controls": V.vO,
                    "aria-selected": e_ === U.X1.GIF,
                    isActive: e_ === U.X1.GIF,
                    viewType: U.X1.GIF,
                    children: H.intl.string(H.t["6gUTsb"])
                  }) : null, eR ? (0, r.jsx)($, {
                    id: Z.ED,
                    "aria-controls": Z.nZ,
                    "aria-selected": e_ === U.X1.STICKER,
                    isActive: e_ === U.X1.STICKER,
                    autoFocus: !ef,
                    ...
                    id: V.td,
                    "aria-controls": V.cZ,
                    "aria-selected": e_ === U.X1.EMOJI,
                    isActive: e_ === U.X1.EMOJI,
                    viewType: U.X1.EMOJI,
                    children: H.intl.string(H.t.Xu3wEx)
                  }), eg && eD && (0, r.jsx)($, {
                    id: V.Hr,
                    "aria-controls": V.gV,
                    "aria-selected": e_ === U.X1.SOUNDBOARD,
                    isActive: e_ === U.X1.SOUNDBOARD,
                    viewType: U.X1.SOUNDBOARD,
                    children: (0, r.jsxs)("div", {
                      className: Y.soundmojiLabelContainer,
                      children: [H.intl.string(H.t.EHlAMT), null != eT && (0, r.jsx)(m.IGR, {
                        text: H.intl.string(H.t.y2b7CA)
                      })]
                    })
                  }), eO && e_ === U.X1.EMOJI && (0, r.jsx)("div", {
              ...
              }) : null, e_ === U.X1.STICKER && eR ? (0, r.jsx)(D.Z, {
                isLoading: em,
                channel: X,
                containerWidth: eu,
                onSelectSticker: z,
              ...
              }) : null, e_ === U.X1.GIF && eC ? (0, r.jsx)(A.Z, {
                onSelectGIF: W,
                hideFavorites: g,
                persistSearch: !0
              }) : null, e_ === U.X1.EMOJI ? (0, r.jsx)(I.Z, {
                hasTabWrapper: !0,
              ...
              }) : null, e_ === U.X1.SOUNDBOARD ? (0, r.jsx)("div", {
