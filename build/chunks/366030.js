...
function A(e) {
  let {
    eligibilityStates: t
  } = e, n = (0, f.ZP)(), o = (0, p.dQu)(u.Z.unsafe_rawColors.GREEN_330).hex(), l = a().groupBy(t, e => "".concat(e.connection_type).concat(null != e.application_id ? ":".concat(e.application_id) : ""));
  return (0, r.jsx)(r.Fragment, {
    children: Object.keys(l).map(e => {
      ...
      return C.SJ.includes(null != (t = null == h ? void 0 : h.id) ? t : "") ? a = (0, r.jsx)(E.Z, {
        className: I.botTag,
        color: o,
        size: 16
      }) : null != O && (a = (0, r.jsx)(y.Z, {
        className: I.botTag,
        ...
        children: [(0, r.jsxs)("div", {
          ...
          return i()(null != n, "connectionMetadataField is null"), i()(null != o, "operator is null"), i()(null != l, "value is null"), (0, r.jsx)(D, {
            connectionType: t,
...
function L(e) {
  ...
  o.useEffect(() => {
    x.default.track(Z.rMx.PASSPORT_ROLE_POPOUT_VIEWED, M({
      other_user_id: s,
      role_id: a
    }, (0, h.JS)(u), (0, h.hH)(d)))
  }, [s, a, u, d]);
...
function G(e) {
  ...
  } = (0, O.ZP)(), u = (0, S.Z)(l, t, s.id, !0), d = (0, c.e7)([w.Z], () => w.Z.getGuildRoleConnectionEligibility(null == u ? void 0 : u.id)), [g, f] = o.useState(null == d), b = o.useRef(null);
