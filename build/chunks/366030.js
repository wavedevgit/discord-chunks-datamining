...
function L(e) {
  let {
    eligibilityStates: t
  } = e, n = (0, b.ZP)(), o = (0, m.dQu)(u.Z.unsafe_rawColors.GREEN_330).hex(), l = s().groupBy(t, e => "".concat(e.connection_type).concat(null != e.application_id ? ":".concat(e.application_id) : ""));
  return (0, r.jsx)(r.Fragment, {
    children: Object.keys(l).map(e => {
      ...
      return C.SJ.includes(null != (t = null == b ? void 0 : b.id) ? t : "") ? s = (0, r.jsx)(T.Z, {
        className: M.botTag,
        color: o,
        size: 16
        ...
        children: [(0, r.jsxs)("div", {
          ...
          return i()(null != n, "connectionMetadataField is null"), i()(null != o, "operator is null"), i()(null != l, "value is null"), (0, r.jsx)(A, {
            connectionType: t,
...
function G(e) {
  ...
  o.useEffect(() => {
    w.default.track(_.rMx.PASSPORT_ROLE_POPOUT_VIEWED, D({
      other_user_id: a,
      role_id: s
    }, (0, O.JS)(u), (0, O.hH)(d)))
  }, [a, s, u, d]);
...
function U(e) {
  ...
  } = (0, y.ZP)(), u = (0, E.Z)(l, t, a.id, !0), d = (0, c.e7)([S.Z], () => S.Z.getGuildRoleConnectionEligibility(null == u ? void 0 : u.id)), [p, f] = o.useState(null == d), b = o.useRef(null);
