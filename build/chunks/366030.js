...
function Z(e) {
  ...
  return (0, r.jsx)(r.Fragment, {
    children: Object.keys(o).map(e => {
      ...
      return S.SJ.includes(null != (t = null == m ? void 0 : m.id) ? t : "") ? l = (0, r.jsx)(R.Z, {
        className: M.botTag,
        color: i,
        size: 16
...
function F(e) {
  ...
  return t = 1 === a.length && 1 === a[0].length ? x.intl.string(x.t.jDym4O) : 1 === a.length ? x.intl.format(x.t["0eBj39"], {}) : x.intl.format(x.t.D7uftL, {}), (0, r.jsxs)("div", {
    className: M.popout,
...
function V(e) {
  ...
  } = (0, b.ZP)(), u = (0, N.Z)(o, t, s.id, !0), d = (0, c.e7)([A.Z], () => A.Z.getGuildRoleConnectionEligibility(null == u ? void 0 : u.id)), [f, h] = i.useState(null == d), m = i.useRef(null);
  if (null == u) return null;
  async function g() {
    a()(null != u, "visibleConnectionsRole is null"), f && null == d && (await p.Z.fetchGuildRoleConnectionsEligibility(o.id, u.id), h(!1))
  }
