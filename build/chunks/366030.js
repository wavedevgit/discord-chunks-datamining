...
function Z(e) {
  ...
  return (0, r.jsx)(r.Fragment, {
    children: Object.keys(a).map(e => {
      ...
      return S.SJ.includes(null != (t = null == m ? void 0 : m.id) ? t : "") ? l = (0, r.jsx)(w.Z, {
        className: k.botTag,
        color: i,
        size: 16
...
function F(e) {
  ...
  i.useEffect(() => {
    T.default.track(D.rMx.PASSPORT_ROLE_POPOUT_VIEWED, M({
      other_user_id: s,
      role_id: l
    }, (0, E.JS)(u), (0, E.hH)(d)))
  }, [s, l, u, d]);
...
function V(e) {
  ...
  } = (0, b.ZP)(), u = (0, N.Z)(a, t, s.id, !0), d = (0, c.e7)([A.Z], () => A.Z.getGuildRoleConnectionEligibility(null == u ? void 0 : u.id)), [f, h] = i.useState(null == d), m = i.useRef(null);
