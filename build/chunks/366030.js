...
function A(e) {
  let {
    eligibilityStates: t
  } = e, n = (0, f.ZP)(), l = (0, p.dQu)(u.Z.unsafe_rawColors.GREEN_330).hex(), o = a().groupBy(t, e => "".concat(e.connection_type).concat(null != e.application_id ? ":".concat(e.application_id) : ""));
    ...
    children: Object.keys(o).map(e => {
      ...
      return C.SJ.includes(null != (t = null == h ? void 0 : h.id) ? t : "") ? a = (0, r.jsx)(E.Z, {
        ...
        children: [(0, r.jsxs)("div", {
          ...
          return i()(null != n, "connectionMetadataField is null"), i()(null != l, "operator is null"), i()(null != o, "value is null"), (0, r.jsx)(D, {
            connectionType: t,
...
function G(e) {
  ...
  } = (0, O.ZP)(), u = (0, S.Z)(o, t, s.id, !0), d = (0, c.e7)([w.Z], () => w.Z.getGuildRoleConnectionEligibility(null == u ? void 0 : u.id)), [g, f] = l.useState(null == d), b = l.useRef(null);
