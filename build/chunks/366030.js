...
function L(e) {
  let {
    eligibilityStates: t
  } = e, n = (0, b.ZP)(), l = (0, m.dQu)(u.Z.unsafe_rawColors.GREEN_330).hex(), o = a().groupBy(t, e => "".concat(e.connection_type).concat(null != e.application_id ? ":".concat(e.application_id) : ""));
  return (0, r.jsx)(r.Fragment, {
    children: Object.keys(o).map(e => {
      ...
      return w.SJ.includes(null != (t = null == b ? void 0 : b.id) ? t : "") ? a = (0, r.jsx)(T.Z, {
        className: M.botTag,
        color: l,
        size: 16
      }) : null != O && (a = (0, r.jsx)(v.Z, {
        className: M.botTag,
...
function B(e) {
  ...
  } = (0, y.ZP)(), u = (0, E.Z)(o, t, s.id, !0), d = (0, c.e7)([S.Z], () => S.Z.getGuildRoleConnectionEligibility(null == u ? void 0 : u.id)), [p, f] = l.useState(null == d), b = l.useRef(null);
