...
let m = new Set(["PageDown", "PageUp", "Home", "End", "ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"]),
  ...
  f = {
    ...
    keydown(e, t) {
      ...
      let N = null != f && "BODY" === f.tagName;
      return !(i.Z.keyboardModeEnabled && !N && !/^[a-zA-Z0-9]$/.test(t) || l.S.hasSubscribers(u.CkL.MODAL_CLOSE) || s.Z.hasLayers()) && ("Tab" === t && l.S.hasSubscribers(u.CkL.TEXTAREA_FOCUS) && null != document.querySelector('[data-can-focus="true"]') ? (e.preventDefault(), l.S.dispatch(u.CkL.TEXTAREA_FOCUS), !1) : !(o.Z.isConnected() && a.Z.getMode() === u.pM4.PUSH_TO_TALK && !a.Z.isSelfMute() && Object.values(a.Z.getShortcuts()).map(d.d2).some(t => t.map(e => e.keyCode).includes(e.keyCode))) && void(e.metaKey || e.ctrlKey || m.has(t) || l.S.dispatchToLastSubscribed(u.CkL.TEXTAREA_FOCUS)))
    }
  }