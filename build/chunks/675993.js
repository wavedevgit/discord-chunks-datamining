...
function D(e) {
  ...
  }, [l]), v = (0, u.e7)([f.Z], () => f.Z.inDevModeForApplication(l.id)), [y, g] = r.useState(C), {
    friends: j
  } = (0, h.Z)(l), P = (t = j, r.useMemo(() => {
    var e, n, i, r;
    if (0 === t.length) return "";
    let l = d().sample(1 === t.length ? X : q);
    return s()(l, "intl message arrays should not be empty"), k.NW.format(l, {
  ...
  }, [t])), T = null != o, L = E.PM.useExperiment({
    location: "AppLauncherProfile"
  }), {
    isSlideReady: w
  } = (0, O.hH)(), [R, M] = r.useState(!1);
  r.useEffect(() => {
    w && M(!0)
  }, [w]);
  let {
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [L.enabled ? (0, i.jsxs)("div", {
    ...
    }) : null, W && 0 !== j.length ? (0, i.jsxs)(m.njP, {
      ...
      children: [T ? (0, i.jsxs)("div", {
        ...
        children: [L.enabled ? null : (0, i.jsx)(H, {
          application: l
        }), (0, i.jsx)(V, {
          application: l
        }), _.length > 0 ? (0, i.jsx)(G, {
          description: _
        }) : null, v ? (0, i.jsx)("div", {
...
function z(e) {
  ...
  } = e, d = (0, v.Fs)(n, l.id), u = (0, y.q)(l.id), f = null == u || null == (t = u.bot) ? void 0 : t.id, h = (0, _.Z)({
    context: n,
    application: l,
    botUserId: f
  }), {
    analyticsLocations: b
  } = (0, C.ZP)(), [x, N] = r.useState(!1), g = E.PM.useExperiment({
    location: "AppLauncherAppProfile.PrimaryEntryPointArea()"
  });
  if (r.useEffect(() => {
      if (!(0, I.BQ)(l) || !(0, I.ye)(l)) return;
      let e = setTimeout(() => {
        (null == d || null == f) && P.default.track(R.rMx.APP_LAUNCHER_PEP_BUTTON_NOT_RENDERED, {
          application_id: l.id,
    ...
    }, [l, d, f, h]), !(0, I.BQ)(l) || !(0, I.ye)(l)) return null;
  let j = m.PhG.MAX;
  return null != d && null != f ? (0, i.jsxs)("div", {
    className: a()({
    ...
    }), h && null != f ? g.altLayout ? (0, i.jsx)("div", {
      ...
      children: (0, i.jsx)("div", {
        ...
        children: (0, i.jsx)(m.XZJ, {
          ...
          children: (0, i.jsxs)(m.Text, {
            ...
            children: [k.NW.string(k.t["e+CzPj"]), (0, i.jsx)(m.ua7, {
              text: k.NW.string(k.t.QOZI8f),
              children: e => {
                var t, n;
                return (0, i.jsx)(p.d, (t = W({}, e), n = n = {
                  size: "xs"
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("div", {
      ...
      children: (0, i.jsx)(m.Text, {
        ...
        style: {
          maxHeight: b ? void 0 : u.minHeightOverride
        },
        children: o
      })
    }), null != d && d > 1 && !n.enabled ? (0, i.jsxs)(m.P3F, {
