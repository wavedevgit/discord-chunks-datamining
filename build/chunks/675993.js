...
function j(e) {
  ...
  let {
    application: n
  } = e, i = (0, O.BQ)(n) ? n.name : null != (t = (0, O.$d)(n)) ? t : "", a = (0, O.vJ)(n);
  return (0, r.jsxs)("div", {
...
function G(e) {
  ...
  } = e, d = (0, h.Fs)(n, a.id), f = (0, m.q)(a.id), g = null == f || null == (t = f.bot) ? void 0 : t.id, E = (0, p.Z)({
    context: n,
    application: a,
    botUserId: g
  }), {
  ...
  if (i.useEffect(() => {
    ...
    }, [a, d, g, E]), !(0, O.BQ)(a) || !(0, O.ye)(a)) return null;
  let v = l.Ph.MAX;
