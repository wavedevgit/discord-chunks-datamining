...
function V(e) {
  ...
  }, [l]), C = (0, d.e7)([m.Z], () => m.Z.inDevModeForApplication(l.id)), {
    isSlideReady: P
  } = (0, S.hH)(), [N, E] = r.useState(!1);
  r.useEffect(() => {
    P && E(!0)
  }, [P]);
  let w = null != a,
    R = O.PM.useExperiment({
    ...
    K = (t = V, r.useMemo(() => {
      ...
      return s()(l, "intl message arrays should not be empty"), D.intl.format(l, {
    ...
    ee = r.useMemo(() => {
      if (null == $) return [];
      let e = $.entries.reduce((e, t) => W(H({}, e), {
        [t.content.id]: t.content
      }), {});
      return V.reduce((t, n) => {
        let i = e[X[n.id]];
        return null != i && (0, g.Mq)(i) ? [...t, i] : t
      }, [])
    }, [$, V, X]).map(e => (0, i.jsx)(T.Z, {
      entry: e,
      onClose: async () => {},
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [R.enabled || Z ? (0, i.jsxs)("div", {
    ...
    }) : null, Z && 0 !== V.length ? (0, i.jsxs)(p.njP, {
      className: B.tabBar,
      ...
      children: [w ? (0, i.jsxs)("div", {
        ...
        children: [R.enabled || Z ? null : (0, i.jsx)(z, {
          application: l
        }), (0, i.jsx)(G, {
          application: l
        }), x.length > 0 ? (0, i.jsx)(Y, {
          description: x
        }) : null, C ? (0, i.jsx)("div", {
        ...
        }) : null, R.enabled || Z ? null : (0, i.jsx)(q, {
          context: n,
          application: l,
          sectionName: h,
...
function z(e) {
  ...
  let {
    application: n
  } = e, r = (0, I.BQ)(n) ? n.name : null != (t = (0, I.$d)(n)) ? t : "", l = (0, I.vJ)(n);
  return (0, i.jsxs)("div", {
...
function q(e) {
  ...
  let {
    ...
    hasCommands: s,
    isDeveloperOfThisApp: c
  } = e, u = (0, x.Fs)(n, l.id), d = (0, C.q)(l.id), m = null == d || null == (t = d.bot) ? void 0 : t.id, f = (0, y.Z)({
    context: n,
    application: l,
    botUserId: m
  }), {
    analyticsLocations: h
  } = (0, _.ZP)(), [b, v] = r.useState(!1), g = O.PM.useExperiment({
    location: "AppLauncherAppProfile.PrimaryEntryPointArea()"
  }), {
    enabled: j
  } = A.X.useExperiment({
    location: "AppLauncherProfile.PrimaryEntryPointArea()"
  });
  if (r.useEffect(() => {
      if (!(0, I.BQ)(l) || !(0, I.ye)(l)) return;
      let e = setTimeout(() => {
        (null == u || null == m) && E.default.track(k.rMx.APP_LAUNCHER_PEP_BUTTON_NOT_RENDERED, {
          application_id: l.id,
    ...
    }, [l, u, m, f]), !(0, I.BQ)(l) || !(0, I.ye)(l)) return null;
  let P = p.PhG.MAX;
  return null != u && null != m ? (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsxs)("div", {
      ...
      }), f && null != m ? g.altLayout ? (0, i.jsx)("div", {
        ...
        children: (0, i.jsx)("div", {
          ...
          children: (0, i.jsx)(p.XZJ, {
            ...
            children: (0, i.jsxs)(p.Text, {
              ...
              children: [D.intl.string(D.t["e+CzPj"]), (0, i.jsx)(p.ua7, {
                text: D.intl.string(D.t.QOZI8f),
                children: e => (0, i.jsx)(p.d3s, W(H({}, e), {
                  size: "xs"
                }))
              })]
            })
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("div", {
      ...
      children: (0, i.jsx)(p.Text, {
        ...
        style: {
          maxHeight: b ? void 0 : d.minHeightOverride
        },
        children: a
      })
    }), null != u && u > 1 && !n.enabled ? (0, i.jsxs)(p.P3F, {
