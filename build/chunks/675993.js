...
function k(e) {
  ...
  }, [n]), C = (0, o.e7)([u.Z], () => u.Z.inDevModeForApplication(n.id)), [_, y] = r.useState(h), v = null != l, A = N.PM.useExperiment({
    location: "AppLauncherProfile"
  }), {
    isSlideReady: I
  } = (0, P.hH)(), [O, S] = r.useState(!1);
  r.useEffect(() => {
    I && S(!0)
  }, [I]);
  let {
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [A.enabled ? (0, i.jsxs)("div", {
    ...
    }) : null, R && 0 !== w.length ? (0, i.jsxs)(c.njP, {
      ...
      children: [v ? (0, i.jsxs)("div", {
        ...
        children: [A.enabled ? null : (0, i.jsx)(W, {
          application: n
        }), (0, i.jsx)(D, {
          application: n
        }), b.length > 0 ? (0, i.jsx)(H, {
          description: b
        }) : null, C ? (0, i.jsx)("div", {
...
function W(e) {
  ...
  let {
    application: n
  } = e, r = (0, j.BQ)(n) ? n.name : null != (t = (0, j.$d)(n)) ? t : "", l = (0, j.vJ)(n);
  return (0, i.jsxs)("div", {
...
function U(e) {
  ...
  } = e, p = (0, b.Fs)(n, l.id), m = (0, C.q)(l.id), x = null == m || null == (t = m.bot) ? void 0 : t.id, _ = (0, h.Z)({
    context: n,
    application: l,
    botUserId: x
  }), {
    analyticsLocations: y
  } = (0, f.ZP)(), [g, P] = r.useState(!1), E = N.PM.useExperiment({
    location: "AppLauncherAppProfile.PrimaryEntryPointArea()"
  });
  if (r.useEffect(() => {
      if (!(0, j.BQ)(l) || !(0, j.ye)(l)) return;
      let e = setTimeout(() => {
        (null == p || null == x) && v.default.track(S.rMx.APP_LAUNCHER_PEP_BUTTON_NOT_RENDERED, {
          application_id: l.id,
    ...
    }, [l, p, x, _]), !(0, j.BQ)(l) || !(0, j.ye)(l)) return null;
  let A = c.PhG.MAX;
  return null != p && null != x ? (0, i.jsxs)("div", {
    ...
    }), _ && null != x ? E.altLayout ? (0, i.jsx)("div", {
      ...
      children: (0, i.jsx)("div", {
        ...
        children: (0, i.jsx)(c.XZJ, {
          ...
          children: (0, i.jsxs)(c.Text, {
            ...
            children: [T.NW.string(T.t["e+CzPj"]), (0, i.jsx)(c.ua7, {
              text: T.NW.string(T.t.QOZI8f),
              children: e => {
                var t, n;
                return (0, i.jsx)(s.d, (t = R({}, e), n = n = {
                  size: "xs"
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("div", {
      ...
      children: (0, i.jsx)(c.Text, {
        ...
        style: {
          maxHeight: b ? void 0 : p.minHeightOverride
        },
        children: o
      })
    }), null != d && d > 1 && !n.enabled ? (0, i.jsxs)(c.P3F, {
