...
function T(e) {
  ...
  let {
    application: n
  } = e, l = (0, x.BQ)(n) ? n.name : null != (t = (0, x.$d)(n)) ? t : "", r = (0, x.vJ)(n);
  return (0, i.jsxs)("div", {
...
function w(e) {
  ...
  } = e, u = (0, f.Fs)(n, r.id), d = (0, h.q)(r.id), b = null == d || null == (t = d.bot) ? void 0 : t.id, _ = (0, m.Z)({
    context: n,
    application: r,
    botUserId: b
  }), {
  ...
  if (l.useEffect(() => {
    ...
    }, [r, u, b, _]), !(0, x.BQ)(r) || !(0, x.ye)(r)) return null;
  let y = c.PhG.MAX;
