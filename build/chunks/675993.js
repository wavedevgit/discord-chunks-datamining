...
function H(e) {
  ...
  }, [l]), x = (0, d.e7)([m.Z], () => m.Z.inDevModeForApplication(l.id)), {
    isSlideReady: P
  } = (0, I.hH)(), [N, O] = r.useState(!1);
  r.useEffect(() => {
    P && O(!0)
  }, [P]);
  let w = null != a,
    ...
    G = (t = B, r.useMemo(() => {
      ...
      return s()(l, "intl message arrays should not be empty"), M.intl.format(l, {
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [L ? (0, i.jsx)("div", {
    ...
    }) : null, L && 0 !== B.length ? (0, i.jsxs)(p.njP, {
      className: D.tabBar,
      ...
      children: [w ? (0, i.jsxs)("div", {
        ...
        children: [L ? null : (0, i.jsx)(V, {
          application: l
        }), (0, i.jsx)(F, {
          application: l
        }), v.length > 0 ? (0, i.jsx)(X, {
          description: v
        }) : null, x ? (0, i.jsx)("div", {
...
function V(e) {
  ...
  let {
    application: n
  } = e, r = (0, A.BQ)(n) ? n.name : null != (t = (0, A.$d)(n)) ? t : "", l = (0, A.vJ)(n);
  return (0, i.jsxs)("div", {
...
function z(e) {
  ...
  } = e, c = (0, v.Fs)(n, l.id), u = (0, x.q)(l.id), d = null == u || null == (t = u.bot) ? void 0 : t.id, m = (0, y.Z)({
    context: n,
    application: l,
    botUserId: d
  }), {
  ...
  if (r.useEffect(() => {
      ...
      let e = setTimeout(() => {
        (null == c || null == d) && O.default.track(Z.rMx.APP_LAUNCHER_PEP_BUTTON_NOT_RENDERED, {
          application_id: l.id,
    ...
    }, [l, c, d, m]), !(0, A.BQ)(l) || !(0, A.ye)(l)) return null;
  let b = p.PhG.MAX;
  return null != c && null != d ? (0, i.jsxs)("div", {
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("div", {
      ...
      children: (0, i.jsx)(p.Text, {
        ...
        style: {
          maxHeight: h ? void 0 : u.minHeightOverride
        },
        children: o
      })
    }), null != c && c > 1 ? (0, i.jsxs)(p.P3F, {
