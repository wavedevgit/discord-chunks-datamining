...
function k(e) {
  ...
  for (let [o, [a, s]] of Object.entries(P)) {
    ...
    let l = null != (i = s.flags) ? i : 0,
      c = (0, f.Ix)(l);
    "string" == typeof(null == (r = s.metadata) ? void 0 : r.embedded_activity_instance_id) && (c = (0, f.Pu)(c, e, s.metadata.embedded_activity_instance_id)), c !== l ? (t[o] = [a, N(T({}, s), {
      flags: c
    })], n = !0) : t[o] = [a, s]
  }
...
class U extends(i = c.ZP.Store) {
  ...
  getActivityForPID(e) {
    for (let [t, n] of Object.values(P))
      if (t === e) return n;
    return null
  }
}
