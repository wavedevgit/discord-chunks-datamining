...
function x(e) {
  ...
  for (let [a, [o, s]] of Object.entries(C)) {
    ...
    let l = null != (i = s.flags) ? i : 0,
      c = (0, f.Ix)(l);
    "string" == typeof(null == (r = s.metadata) ? void 0 : r.embedded_activity_instance_id) && (c = (0, f.Pu)(c, e, s.metadata.embedded_activity_instance_id)), c !== l ? (t[a] = [o, A(S({}, s), {
      flags: c
    })], n = !0) : t[a] = [o, s]
  }
  n && (C = t, P())
...
class k extends(i = c.ZP.Store) {
  ...
  getActivityForPID(e) {
    for (let [t, n] of Object.values(C))
      if (t === e) return n;
    return null
  }
}
