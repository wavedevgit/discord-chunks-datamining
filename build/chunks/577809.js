...
let w = e => {
  ...
  B = e => {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(a.X6q, {
        ...
        className: E.header,
        children: o ? F.NW.format(F.t.cgX47e, {
          guildName: s
  ...
  W = e => {
    ...
    let {
      ...
      onComplete: A,
      isPreview: L = !1
    } = e, D = (0, y.N0)(M, null == T ? void 0 : T.guild, L), {
      guildProfile: q,
      fetchGuildProfile: Z
    } = (0, f.u)(M), z = (0, m.h)(), G = (0, i.e7)([g.ZP, _.default], () => g.ZP.isMember(M, _.default.getId())), [V, J] = l.useState(!1);
    l.useEffect(() => {
    ...
    l.useEffect(() => {
      ...
      null != M && b.default.track(P.rMx.OPEN_MODAL, {
        type: S.N4,
        guild_id: M
      })
    }, [M]);
    ...
    let ey = async () => {
      ...
      try {
        await (0, o.S2)({
          email: ee,
          password: en
        }), Q(!1), eh(y.KJ.EMAIL_CONFIRMATION)
      } catch (n) {
        var e, t;
