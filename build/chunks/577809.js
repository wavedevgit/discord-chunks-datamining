...
let F = e => {
  ...
  M = e => {
    ...
    let {
      ...
      guildProfile: Z,
      fetchGuildProfile: G
    } = (0, m.u)(L), W = (0, f.h)(), q = (0, l.e7)([I.ZP, h.default], () => I.ZP.isMember(L, h.default.getId())), [U, z] = r.useState(!1);
    r.useEffect(() => {
    ...
    r.useEffect(() => {
      ...
      null != L && v.default.track(j.rMx.OPEN_MODAL, {
        type: O.N4,
        guild_id: L
      })
    }, [L]);
    ...
    let eS = async () => {
      ...
      try {
        await (0, s.S2)({
          email: ee,
          password: en
        }), Q(!1), eg(S.KJ.EMAIL_CONFIRMATION)
      } catch (n) {
        var e, t;
