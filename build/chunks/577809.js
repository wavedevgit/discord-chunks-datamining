...
let M = e => {
  ...
  k = e => {
    ...
    return (0, l.jsxs)("div", {
      ...
      children: [(0, l.jsx)(i.X6q, {
        ...
        className: F.header,
        children: o ? T.NW.format(T.t.cgX47e, {
          guildName: s
  ...
  B = e => {
    ...
    let {
      ...
      onComplete: A,
      isPreview: D = !1
    } = e, Z = (0, S.N0)(W, null == R ? void 0 : R.guild, D), {
      guildProfile: L,
      fetchGuildProfile: q
    } = (0, f.u)(W), z = (0, m.h)(), G = (0, r.e7)([g.ZP, x.default], () => g.ZP.isMember(W, x.default.getId())), [J, V] = a.useState(!1);
    a.useEffect(() => {
    ...
    a.useEffect(() => {
      ...
      null != W && N.default.track(P.rMx.OPEN_MODAL, {
        type: O.N4,
        guild_id: W
      })
    }, [W]);
    ...
    let eS = async () => {
      ...
      try {
        await (0, o.S2)({
          email: ee,
          password: en
        }), X(!1), ep(S.KJ.EMAIL_CONFIRMATION)
      } catch (n) {
        var e, t;
            ...
            switch (eh) {
              ...
              case S.KJ.VERIFICATION_FORM:
                return (0, l.jsxs)("div", {
                  ...
                  }), null != Y && (0, l.jsx)(i.Text, {
                    variant: "text-xs/normal",
                    color: "text-danger",
                    children: Y
                  }), null == Y && K && (0, l.jsxs)("div", {
