...
let M = e => {
  ...
  W = e => {
    ...
    let {
      ...
      onComplete: B,
      isPreview: D = !1
    } = e, L = (0, O.N0)(R, null == T ? void 0 : T.guild, D), {
      guildProfile: Z,
      fetchGuildProfile: z
    } = (0, m.u)(R), q = (0, f.h)(), V = (0, l.e7)([g.ZP, h.default], () => g.ZP.isMember(R, h.default.getId())), [J, G] = i.useState(!1);
    i.useEffect(() => {
    ...
    i.useEffect(() => {
      ...
      null != R && v.default.track(E.rMx.OPEN_MODAL, {
        type: S.N4,
        guild_id: R
      })
    }, [R]);
    ...
    let eO = async () => {
      ...
      try {
        await (0, s.S2)({
          email: ee,
          password: en
        }), Q(!1), ep(O.KJ.EMAIL_CONFIRMATION)
      } catch (n) {
        var e, t;
