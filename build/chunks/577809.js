...
let k = e => {
  ...
  W = e => {
    ...
    let {
      ...
      onComplete: q,
      isPreview: A = !1
    } = e, D = (0, E.N0)(B, null == S ? void 0 : S.guild, A), {
      guildProfile: z,
      fetchGuildProfile: K
    } = (0, h.u)(B), L = (0, m.h)(), Z = (0, o.e7)([g.ZP, p.default], () => g.ZP.isMember(B, p.default.getId())), [H, V] = l.useState(!1);
    l.useEffect(() => {
    ...
    l.useEffect(() => {
      ...
      null != B && v.default.track(F.rMx.OPEN_MODAL, {
        type: O.N4,
        guild_id: B
      })
    }, [B]);
    ...
    let eE = async () => {
      ...
      try {
        await (0, s.S2)({
          email: ee,
          password: en
        }), Y(!1), ex(E.KJ.EMAIL_CONFIRMATION)
      } catch (n) {
        var e, t;
      ...
      try {
        await (null == q ? void 0 : q((e = function(e) {
