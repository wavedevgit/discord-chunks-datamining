...
function O(e, t) {
  ...
  switch (t) {
    case I.A.INVITE:
      return {
        joinType: I.A.INVITE, requireTerms: n, termRules: v()
      };
    case I.A.APPLY:
      return {
        joinType: I.A.APPLY, pendingVerificationFields: y()
      };
    case I.A.DISCOVERABLE:
      return {
        joinType: I.A.DISCOVERABLE, settingsView: S(), requireTerms: n, termRules: v()
      }
  }
}
...
function L() {
  ...
  switch (i.joinType) {
    ...
    case I.A.APPLY:
      ...
      l = null == s ? null != a : null != a && !o().isEqual(s, a), C = {
