...
function O(e, t) {
  ...
  switch (t) {
    case m.A.INVITE:
      return {
        joinType: m.A.INVITE, requireTerms: n, termRules: A()
      };
    case m.A.APPLY:
      return {
        joinType: m.A.APPLY, pendingVerificationFields: y()
      };
    case m.A.DISCOVERABLE:
      return {
        joinType: m.A.DISCOVERABLE, settingsView: v(), requireTerms: n, termRules: A()
      }
  }
}
...
function R() {
  ...
  switch (i.joinType) {
    ...
    case m.A.APPLY:
      ...
      l = null == s ? null != a : null != a && !o().isEqual(s, a), N = {
...
class F extends(r = s.ZP.Store) {
  initialize() {
    this.waitFor(E.Z, u.Z, f.ZP), this.syncWith([E.Z, u.Z], () => {
      R()
    })
  }
  get pendingState() {
