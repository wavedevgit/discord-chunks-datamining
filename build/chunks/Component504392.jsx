...
function R(e) {
  ...
  let L = (0, s.e7)([v.Z], () => v.Z.getStateForGuild(t)),
    M = (0, x.Z)(t),
    G = o.useRef(false),
    {
      shouldShow: D,
    ...
    B = null == i && null != V,
    W = [];
  D && B && W.push(l.z.VANITY_URL_POWERUP_ROLLBACK_MODAL);
  ...
  }, []), [null == L ? true : L.powerupCatalog, R]), H = z.flatMap(e => e.listings).filter(e => "multiPerk" === e.type).map(e => e.group), X = (0, N.f)(H, t);
  return (o.useEffect(() => {
    if (null != i && !G.current)
      for (let e of z)
        ...
        children: z.map(e => {
          ...
          return (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsxs)("div", {
              ...
              className: a()(A.powerupContainer, A.powerupHorizontalPadding, {
