...
function O(e) {
  let {
    channelId: t
  } = e, O = (0, l.e7)([g.Z], () => g.Z.getChannel(t)), x = (0, l.e7)([g.Z], () => g.Z.getChannel(null == O ? void 0 : O.parent_id)), v = (0, l.e7)([b.Z], () => b.Z.getGuild(null == O ? void 0 : O.getGuildId())), C = (0, o.ZP)(O), E = i.useRef(!1);
  if (i.useEffect(() => {
