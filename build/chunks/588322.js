...
function j(e) {
  let {
    channelId: t
  } = e, j = (0, l.e7)([g.Z], () => g.Z.getChannel(t)), O = (0, l.e7)([g.Z], () => g.Z.getChannel(null == j ? void 0 : j.parent_id)), v = (0, l.e7)([b.Z], () => b.Z.getGuild(null == j ? void 0 : j.getGuildId())), C = (0, o.ZP)(j), E = i.useRef(!1);
  if (i.useEffect(() => {
