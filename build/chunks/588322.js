...
function y(e) {
  let {
    channelId: t
  } = e, y = (0, l.e7)([m.Z], () => m.Z.getChannel(t)), v = (0, l.e7)([m.Z], () => m.Z.getChannel(null == y ? void 0 : y.parent_id)), j = (0, l.e7)([b.Z], () => b.Z.getGuild(null == y ? void 0 : y.getGuildId())), O = (0, s.ZP)(y), E = i.useRef(!1);
  if (i.useEffect(() => {
