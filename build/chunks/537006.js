  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)("div", {
      ...
      children: n ? (0, r.jsxs)(c.gtL, {
        ...
        onClick: () => {
          s({
            action: y.yM.VIEW_PREMIUM_PERKS
          }), (0, h.uL)(O.Z5c.APPLICATION_STORE), null == i || i()
        },
        ...
        onClick: () => {
          s({
            action: y.yM.GET_PREMIUM
          }), null == i || i()
        },
        textOptions: {
          textOverride: T.intl.string(T.t.x6rkDg)
        },
...
function C(e) {
  let {
    ...
    themeType: u
  } = (0, E.z)(), d = u === y.lY.MODAL, p = (0, f.wE)(l.z.USER_PROFILE_PREMIUM_AND_SHOP_ENTRY_POINTS), h = (0, s.e7)([m.Z], () => m.Z.getGuildId());
  if (i.useEffect(() => {
      if (!p) return (0, f.kk)(l.z.USER_PROFILE_PREMIUM_AND_SHOP_ENTRY_POINTS), () => {
        (0, _.gE)({
  ...
  return d ? (0, r.jsx)("div", {
    className: o()(S.upsellContainer, a),
    children: (0, r.jsxs)("div", {
      className: o()(S.upsellContent, S.upsellRowContent),
    ...
    className: o()(S.upsellContainer, a),
    children: (0, r.jsxs)("div", {
      className: o()(S.upsellContent, S.upsellDefaultContent),
      children: [(0, r.jsxs)("div", {
