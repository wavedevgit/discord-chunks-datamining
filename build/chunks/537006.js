  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)("div", {
      ...
      children: n ? (0, r.jsxs)(u.gtL, {
        ...
        onClick: () => {
          s({
            action: v.yM.VIEW_PREMIUM_PERKS
          }), (0, g.uL)(I.Z5c.APPLICATION_STORE), null == i || i()
        },
        ...
        onClick: () => {
          s({
            action: v.yM.GET_PREMIUM
          }), null == i || i()
        },
        textOptions: {
          textOverride: A.intl.string(A.t.x6rkDg)
        },
...
function P(e) {
  let {
    ...
    themeType: c
  } = (0, y.z)(), d = c === v.lY.MODAL, _ = (0, p.Nj)(l.z.USER_PROFILE_PREMIUM_AND_SHOP_ENTRY_POINTS), m = (0, s.e7)([E.Z], () => E.Z.getGuildId());
  if (i.useEffect(() => {
      if (!_) return (0, h.kk)(l.z.USER_PROFILE_PREMIUM_AND_SHOP_ENTRY_POINTS), () => {
        (0, f.gE)({
