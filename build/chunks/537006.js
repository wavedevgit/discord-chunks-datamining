...
function P(e) {
  let {
    ...
    themeType: c
  } = (0, y.z)(), d = c === v.lY.MODAL, f = (0, p.Nj)(l.z.USER_PROFILE_PREMIUM_AND_SHOP_ENTRY_POINTS), m = (0, s.e7)([E.Z], () => E.Z.getGuildId());
  if (i.useEffect(() => {
      if (!f) return (0, h.kk)(l.z.USER_PROFILE_PREMIUM_AND_SHOP_ENTRY_POINTS), () => {
        (0, _.gE)({
