...
function C(e) {
  let {
    ...
    themeType: u
  } = (0, E.z)(), d = u === y.lY.MODAL, p = (0, _.wE)(l.z.USER_PROFILE_PREMIUM_AND_SHOP_ENTRY_POINTS), h = (0, s.e7)([m.Z], () => m.Z.getGuildId());
  if (i.useEffect(() => {
      if (!p) return (0, _.kk)(l.z.USER_PROFILE_PREMIUM_AND_SHOP_ENTRY_POINTS), () => {
        (0, f.gE)({
