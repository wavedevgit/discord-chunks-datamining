  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)("div", {
      ...
      children: n ? (0, r.jsxs)(c.gtL, {
        ...
        onClick: () => {
          s({
            action: O.yM.VIEW_PREMIUM_PERKS
          }), (0, m.uL)(v.Z5c.APPLICATION_STORE), null == i || i()
        },
        ...
        onClick: () => {
          s({
            action: O.yM.GET_PREMIUM
          }), null == i || i()
        },
        textOptions: {
          textOverride: S.intl.string(S.t.x6rkDg)
        },
        subscriptionTier: T.Si.TIER_2,
        premiumModalAnalyticsLocation: {
          section: v.jXE.USER_PROFILE
        },
        className: A.upsellButton,
        size: t ? c.zxk.Sizes.TINY : c.zxk.Sizes.SMALL,
        look: c.zxk.Looks.FILLED,
...
function R(e) {
  let {
    ...
    themeType: u
  } = (0, b.z)(), d = u === O.lY.MODAL, h = (0, _.Nj)(l.z.USER_PROFILE_PREMIUM_AND_SHOP_ENTRY_POINTS), m = (0, s.e7)([g.Z], () => g.Z.getGuildId());
  if (i.useEffect(() => {
      if (!h) return (0, p.kk)(l.z.USER_PROFILE_PREMIUM_AND_SHOP_ENTRY_POINTS), () => {
        (0, f.gE)({
