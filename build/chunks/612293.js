...
function j(e) {
  ...
  } = e, x = (0, l.e7)([h.ZP], () => null != P && null != f ? h.ZP.getMember(P, f.id) : null), S = null != P ? null == x || null == (r = x.collectibles) || null == (t = r.nameplate) ? void 0 : t.skuId : null == f || null == (d = f.collectibles) || null == (c = d.nameplate) ? void 0 : c.skuId, w = O.find(e => e.skuId === S), {
    pendingNameplate: R
  } = (0, b.Zx)(f, P), [I, A] = (0, a.useState)(() => {
    var e;
    return void 0 !== R ? R : null != (e = null != E ? E : w) ? e : null
  }), N = (null == I ? void 0 : I.skuId) === (void 0 === R ? null == w ? void 0 : w.skuId : null == R ? void 0 : R.skuId), [k, T] = (0, a.useState)(() => null != I && O.some(e => e.id === I.id)), D = (0, a.useCallback)(e => {
    j(), (0, u.mK)({
      analyticsLocations: C,
