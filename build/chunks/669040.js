...
let W = 0,
  ...
  $ = (0, x.Mg)(f.Z.EMOJI_PICKER_CONSTANTS_EMOJI_LIST_PADDING_BOTTOM),
  X = (0, x.Mg)(f.Z.EMOJI_PICKER_CONSTANTS_EMOJI_LIST_SEARCH_RESULTS_PADDING_TOP),
  Q = (0, x.Mg)(f.Z.EXPRESSION_PICKER_CONSTANTS_EXPRESSION_PICKER_LIST_SECTION_HEADING_HEIGHT),
  J = (0, x.Mg)(f.Z.EMOJI_PICKER_CONSTANTS_EMOJI_SECTION_MARGIN_BOTTOM),
  ee = 16,
  ...
  ea = e => {
    let {
      ...
      let n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
        r = new Set(t),
        i = t.has(e);
      i ? r.delete(e) : r.add(e), null != n && P.default.track(Z.rMx.EXPRESSION_PICKER_CATEGORY_COLLAPSE_TOGGLED, {
        location: ea.location,
        tab: F.X1.EMOJI,
        collapsed: !i,
        guild_id: n.id
      }), e === B.UX.SOUNDMOJI && P.default.track(Z.rMx.SOUNDMOJI_EMOJI_PICKER_SECTION_TOGGLED, {
        collapsed: !i
      }), g(r)
    ...
    }), [a, m, s, es, ed, c, f, O, v, A, N, w, ef, R, D, L, x, ei]);
    i.useEffect(() => () => {
      var e, t;
    ...
    let ep = i.useMemo(() => l().memoize(e => {
        ...
        let d = W === e,
          ...
          g = s === B.En.SOUNDMOJI ? (0, r.jsx)(_.P3F, {
            ...
            onClick: () => {
              (0, b.hr)(F.X1.SOUNDBOARD), P.default.track(Z.rMx.SOUNDMOJI_EMOJI_PICKER_VIEW_ALL_CLICK)
            },
    ...
    return {
      listPadding: i.useMemo(() => ["" !== p ? X : z, q, $, K], [p]),
      renderRow: e_,
      renderSection: em,
      renderSectionHeader: ep,
      renderSectionFooter: eg,
      sectionMarginBottom: eb,
      sectionHeaderHeight: i.useCallback(e => m[e].type === B.En.SEARCH_RESULTS ? 0 : Q, [m]),
  ...
  eo = i.memo(function(e) {
    ...
    } = e, B = i.useRef(!1), F = E.kJ.useStore(e => e.activeCategoryIndex), K = (0, b.Iu)(e => e.searchQuery), z = w.Yk.useSetting(), q = (0, u.e7)([R.default], () => R.default.getCurrentUser()), $ = (0, D.I5)(q), {
      location: X
    } = (0, h.O)(), {
      analyticsLocations: Q
    } = (0, m.ZP)(), [J, ee] = i.useState(0), [et, en] = i.useState(!1), [er, eo] = i.useState(0), {
      listPadding: el,
      renderRow: ec,
      renderSection: eu,
    ...
    return i.useEffect(() => {
      et && P.default.track(Z.rMx.PREMIUM_UPSELL_VIEWED, {
