...
let Y = 0,
  ...
  ei = e => {
    let {
      ...
      emojiListRef: ei
    } = e, eo = (0, h.O)(), ea = i.useRef(B.xAR), es = i.useMemo(() => "" !== n ? d.Z.convert.toCodePoint(n) : "", [n]), el = i.useCallback(e => {
      let t = m[e],
        n = m[e + 1];
      ...
      let n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
        r = new Set(t),
        i = t.has(e);
      i ? r.delete(e) : r.add(e), null != n && R.default.track(B.rMx.EXPRESSION_PICKER_CATEGORY_COLLAPSE_TOGGLED, {
        location: eo.location,
        tab: F.X1.EMOJI,
        collapsed: !i,
        guild_id: n.id
      }), e === G.UX.SOUNDMOJI && R.default.track(B.rMx.SOUNDMOJI_EMOJI_PICKER_SECTION_TOGGLED, {
        collapsed: !i
      }), g(r)
    }, [eo, t, g]), ed = i.useCallback(e => {
      let {
        columnIndex: t,
        visibleRowIndex: n
      } = e, r = e.type === j.ld.SOUNDMOJI ? null : e.type === j.ld.EMOJI ? e.emoji.allNamesString : e.name;
      ea.current !== B.xAR && window.cancelAnimationFrame(ea.current), ea.current = window.requestAnimationFrame(() => {
    ...
    let ep = i.useMemo(() => l().memoize(e => {
      ...
      eg = i.useCallback(e => ec(e) ? eh ? (0, r.jsx)(N.fi, {}) : (0, r.jsx)(N.ZP, {
        ...
        className: H.nitroBottomDivider
      }) : null, [er, ec, el, eh]),
  ...
  eo = i.memo(function(e) {
    ...
    } = e, F = i.useRef(!1), W = E.kJ.useStore(e => e.activeCategoryIndex), K = (0, b.Iu)(e => e.searchQuery), z = C.Yk.useSetting(), q = (0, u.e7)([P.default], () => P.default.getCurrentUser()), Q = (0, w.I5)(q), {
      location: X
    } = (0, h.O)(), {
      analyticsLocations: J
    } = (0, m.ZP)(), [$, ee] = i.useState(0), [et, en] = i.useState(!1), [eo, ea] = i.useState(0), {
      listPadding: es,
      renderRow: el,
      renderSection: ec,
    ...
    return i.useEffect(() => {
      et && R.default.track(B.rMx.PREMIUM_UPSELL_VIEWED, {
