...
let K = 0,
  ...
  ea = e => {
    let {
      ...
      emojiListRef: ea
    } = e, es = (0, h.O)(), el = i.useRef(V.xAR), ec = i.useMemo(() => "" !== n ? d.Z.convert.toCodePoint(n) : "", [n]), eu = (0, E.h)({
    ...
    }), [o, m, s, ec, ep, c, f, v, A, N, P, R, eh, D, L, x, H, ea]);
    i.useEffect(() => () => {
      var e, t;
    ...
    let eg = i.useMemo(() => l().memoize(e => {
        ...
        let u = l === F.En.GUILD ? null != o ? (0, r.jsx)(j.Z, {
            guild: o,
            height: et,
            width: et
          }) : null : null != s ? (0, r.jsx)(M.Z, {
            categoryId: s,
            height: et,
            width: et,
            size: "custom"
        ...
        null != s && (d = (0, k.Y1)(s, null == o ? void 0 : o.toString()));
        let f = en === e,
          p = i.isNitroLocked,
          h = p && !f,
          g = p && f;
        return l === F.En.SOUNDMOJI && (n = (0, r.jsx)(_.P3F, {
        ...
        })), l === F.En.GUILD && eu && (n = (0, r.jsx)(B.I, {
          guildId: null == o ? void 0 : o.id
        })), (0, r.jsx)(I.Z, {
          className: a()(W.header, K, {
      ...
      eb = i.useCallback((e, n) => {
        ...
        return (0, r.jsx)("div", {
          className: a()(W.categorySection, {
            ...
            [W.categorySectionNitroDivider]: o || s
          }),
          children: n
        }, e)
      }, [t, m, ef, ed]),
      ey = i.useCallback(e => ef(e) ? eE ? (0, r.jsx)(C.fi, {}) : (0, r.jsx)(C.ZP, {
        glowOpacity: eo
      }) : ed(e) ? (0, r.jsx)("div", {
  ...
  es = i.memo(function(e) {
    ...
    } = e, B = i.useRef(!1), F = b.kJ.useStore(e => e.activeCategoryIndex), Z = (0, y.Iu)(e => e.searchQuery), z = P.Yk.useSetting(), q = (0, u.e7)([R.default], () => R.default.getCurrentUser()), Q = (0, D.I5)(q), {
      location: X
    } = (0, h.O)(), {
      analyticsLocations: J
    } = (0, m.ZP)(), [$, ee] = i.useState(0), [et, en] = i.useState(!1), [er, ei] = i.useState(0), {
      listPadding: es,
      renderRow: el,
      renderSection: ec,
