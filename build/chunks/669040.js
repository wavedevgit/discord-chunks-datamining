...
let W = 0,
  ...
  eo = e => {
    let {
      ...
      emojiListRef: ei
    } = e, eo = (0, h.O)(), ea = i.useRef(Z.xAR), es = i.useMemo(() => "" !== n ? d.Z.convert.toCodePoint(n) : "", [n]), el = i.useCallback(e => {
      let t = m[e],
        n = m[e + 1];
    ...
    }), [o, m, s, es, ed, c, f, O, v, A, N, R, ef, P, D, L, x, ei]);
    i.useEffect(() => () => {
      var e, t;
    ...
    let ep = i.useMemo(() => l().memoize(e => {
        ...
        null != o && (u = (0, M.Y1)(o, null == i ? void 0 : i.name));
        let d = W === e,
          f = n.isNitroLocked,
          p = f && !d,
          h = f && d,
      ...
      em = i.useCallback((e, n) => {
        ...
        return (0, r.jsx)("div", {
          className: a()(Y.categorySection, {
            ...
            [Y.categorySectionNitroDivider]: o || s
          }),
          children: n
        }, e)
      }, [t, m, ec, el]),
  ...
  ea = i.memo(function(e) {
    ...
    } = (0, m.ZP)(), [$, ee] = i.useState(0), [et, en] = i.useState(!1), [er, ea] = i.useState(0), {
      listPadding: el,
      renderRow: ec,
      renderSection: eu,
