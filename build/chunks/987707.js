...
function N(A) {
  ...
  return A.reverse().forEach(A => {
    ...
    if (c.actionType === d.vB8.DELETE && (null != a || null != o)) {
      ...
      (c.targetType === d.KFR.CHANNEL || c.targetType === d.KFR.CHANNEL_OVERWRITE) && null !== g && (0, v.r8)(g.oldValue) && (A = "#".concat(A)), null == x[c.targetType] ? x[c.targetType] = {
        [c.targetId]: A
      } : x[c.targetType][c.targetId] = A
    }
    t = 0, e.unshift(c)
  }), e
}
