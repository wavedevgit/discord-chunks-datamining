...
function w(e) {
  ...
  return e.reverse().forEach(e => {
    ...
    if (_.actionType === g.vB8.DELETE && (null != o || null != u)) {
      ...
      (_.targetType === g.KFR.CHANNEL || _.targetType === g.KFR.CHANNEL_OVERWRITE) && null !== c && (0, d.r8)(c.oldValue) && (e = "#".concat(e)), null == y[_.targetType] ? y[_.targetType] = {
        [_.targetId]: e
...
i = "GuildSettingsAuditLogStore", (l = "displayName") in B ? Object.defineProperty(B, l, {
  value: i,
  enumerable: !0,
  configurable: !0,
  writable: !0
