...
function G(e) {
  ...
  return e.reverse().forEach(e => {
    ...
    if (d.actionType === I.vB8.DELETE && (null != o || null != E)) {
      ...
      (d.targetType === I.KFR.CHANNEL || d.targetType === I.KFR.CHANNEL_OVERWRITE) && null !== c && (0, _.r8)(c.oldValue) && (e = "#".concat(e)), null == j[d.targetType] ? j[d.targetType] = {
        [d.targetId]: e
...
s = "GuildSettingsAuditLogStore", (l = "displayName") in z ? Object.defineProperty(z, l, {
  value: s,
  enumerable: !0,
  configurable: !0,
  writable: !0
