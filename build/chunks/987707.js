...
function j(e) {
  ...
  return e.reverse().forEach(e => {
    ...
    if (d.actionType === T.vB8.DELETE && (null != o || null != E)) {
      ...
      (d.targetType === T.KFR.CHANNEL || d.targetType === T.KFR.CHANNEL_OVERWRITE) && null !== c && (0, _.r8)(c.oldValue) && (e = "#".concat(e)), null == y[d.targetType] ? y[d.targetType] = {
        [d.targetId]: e
      } : y[d.targetType][d.targetId] = e
    }
    n = 0, t.unshift(d)
  }), t
}
...
let W = new F(c.Z, {
  ...
  AUDIT_LOG_FETCH_SUCCESS: function(e) {
    var t;
    x = 0, D = !1, L = !1, m = !0, M = !1, O = j(e.logs), g = e.integrations, R = e.webhooks, p = e.guildScheduledEvents, S = null !== (t = e.automodRules) && void 0 !== t ? t : [], h = e.threads, U = e.applicationCommands, e.logs.length < T.Rg9 && (m = !1)
  },
  ...
  AUDIT_LOG_FETCH_NEXT_PAGE_SUCCESS: function(e) {
    ...
    if (C = !1, g = n, R = r, p = l, S = a, h = i, U = s, (0 === t.length || t.length < T.Rg9) && (m = !1), t.length > 0) {
      let e = j(t);
      O = [...O, ...e]
    }
  },
