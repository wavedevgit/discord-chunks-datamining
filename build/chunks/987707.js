...
t.d(e, {
  Z: () => S
}), t(583741), t(539854), t(388685), t(290780);
var n, r, l, i = t(392711),
  s = t.n(i),
  a = t(149765),
  o = t(442837),
  g = t(570140),
...
function Z(A) {
  ...
  return A.reverse().forEach(A => {
    ...
    if (c.actionType === u.vB8.DELETE && (null != a || null != o)) {
      ...
      (c.targetType === u.KFR.CHANNEL || c.targetType === u.KFR.CHANNEL_OVERWRITE) && null !== g && (0, v.r8)(g.oldValue) && (A = "#".concat(A)), null == L[c.targetType] ? L[c.targetType] = {
        [c.targetId]: A
      } : L[c.targetType][c.targetId] = A
    }
    t = 0, e.unshift(c)
  }), e
}
...
l = "GuildSettingsAuditLogStore", (r = "displayName") in R ? Object.defineProperty(R, r, {
  value: l,
  enumerable: !0,
  configurable: !0,
  writable: !0
