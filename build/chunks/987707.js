...
function y(e) {
  ...
  return e.reverse().forEach(e => {
    ...
    if (d.actionType === T.vB8.DELETE && (null != o || null != E)) {
      ...
      (d.targetType === T.KFR.CHANNEL || d.targetType === T.KFR.CHANNEL_OVERWRITE) && null !== u && (0, _.r8)(u.oldValue) && (e = "#".concat(e)), null == x[d.targetType] ? x[d.targetType] = {
        [d.targetId]: e
