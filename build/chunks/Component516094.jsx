...
function w(e) {
  ...
  let {
    ...
    var e;
    return null == r.timeline || (null == (e = r.decision) ? true : e.timestamp) == null ? [] : r.timeline.filter(e => e.signal.type === g.Gy.GAME_EVENT)
  }, [r.timeline, null == (t = r.decision) ? true : t.timestamp]), o = a.useCallback(e => {
    var t, l;
    if (null == i || i <= 0 || (null == (t = r.decision) ? true : t.timestamp) == null) return null;
    let n = (e - ((null == (l = r.decision) ? true : l.timestamp) - r.length)) / 1e3;
    return n < 0 || n > i ? null : n / i * 100
  }, [i, null == (l = r.decision) ? true : l.timestamp, r.length]);
...
function O(e) {
  ...
  let {
    ...
    var e;
    return null == r.timeline || (null == (e = r.decision) ? true : e.timestamp) == null ? [] : r.timeline.filter(e => e.signal.type === g.Gy.SOUNDBOARD && true === e.signal.playing)
  }, [r.timeline, null == (t = r.decision) ? true : t.timestamp]), o = a.useCallback(e => {
    var t, l;
    if (null == i || i <= 0 || (null == (t = r.decision) ? true : t.timestamp) == null) return null;
    let n = (e - ((null == (l = r.decision) ? true : l.timestamp) - r.length)) / 1e3;
...
function A(e) {
  ...
  let {
    ...
    var e;
    return null == r.timeline || (null == (e = r.decision) ? true : e.timestamp) == null ? [] : r.timeline.filter(e => e.signal.type === g.Gy.PHRASE)
  }, [r.timeline, null == (t = r.decision) ? true : t.timestamp]), o = a.useCallback(e => {
    var t, l;
    if (null == i || i <= 0 || (null == (t = r.decision) ? true : t.timestamp) == null) return null;
    let n = (e - ((null == (l = r.decision) ? true : l.timestamp) - r.length)) / 1e3;
...
let I = function(e) {
  let {
    ...
    subscribe: I,
    seek: R
  } = (0, y.T)(), M = u(), P = a.useRef(null), [U, D] = a.useState(false), [z, G] = a.useState(null), B = a.useRef(null), _ = a.useRef(null), [K, V] = a.useState(false), [F, W] = a.useState(null);
  a.useEffect(() => I({
    onPlay: () => {
      G(null), V(false)
    }
  ...
  let q = a.useRef(null),
    ...
    Y = a.useCallback((e, t) => {
      ...
      let l = ((0, s.clamp)(e, F.left, F.right) - F.left) / F.width * c,
        n = (0, s.clamp)(l, 0, c),
        a = z;
      null == a && t && (a = n <= v ? "start" : n >= b ? "end" : "playhead", m && (A(), V(true)), G(a)), "start" === a ? E(n) : "end" === a ? w(n) : "playhead" === a && R((0, s.clamp)(n, v, b))
    }, [c, F, z, v, b, m, A, E, w, R]),
    Z = a.useCallback(e => {
      if (null == c) return;
  ...
  a.useEffect(() => (document.addEventListener("mousemove", el), document.addEventListener("mouseup", en), () => {
    ...
    !async function() {
      ...
      let s = null == i ? true : i.getContext("2d", {
        willReadFrequently: true
      });
      if (null == s) return;
      let o = Q.current;
      if ((null == (e = o[r]) ? true : e.length) === r) {
