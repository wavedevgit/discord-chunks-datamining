...
function m(e) {
  let {
    applicationId: l,
    size: a = "default"
  } = e, t = (0, s.e7)([d.Z], () => d.Z.getApplicationWidgetApplicationConfig(l));
  return (0, i.jsxs)("div", {
    className: n()(p.container, {
      [p.sizeSmall]: "small" === a
    }),
...
function v(e) {
  ...
  return "default" !== a || null == t ? null : (0, i.jsxs)("div", {
    className: p.footer,
    children: [(0, i.jsx)(r.uIJ, {
      ...
      children: m ? n ? u.intl.format(u.t.wiyuG9, {
