...
let S = Chunk73800.memo(function(e) {
  let {
    ...
    className: j
  })), [t, n, j]), Q = r.useCallback(e => null != o || null != S ? <div className={E.extrasContainer}>{null == o ? true : o(t)}{null == S ? true : S(t, e)}</div> : null, [t, o, S]), K = (0, a.e7)([O.ZP], () => O.ZP.hasRenderDebugMode(g.GO.WidgetAreas)), X = r.useMemo(() => {
    if (null != I) return e => I(x(_({}, e), {
      widget: t
    }))
  }, [I, t]);
  return <y.Z className={l()({
      [E.debug]: K,
      [E.debugUnpinned]: K && !D,
      [E.debugPinned]: K && D
    }, C)} id={k} size={U} anchor={V} container={H} minSize={null != z ? z : {
      width: 0,
      height: 0
    }} hidden={!B} locked={w} resizeX={null != W && W} resizeY={null != F && F} style={{
      zIndex: R
    }} dragAnywhere={null != G && G} active={!w} onUpdate={T} onClick={A} targetWindow={Z} renderExtras={Q} resizeValidation={X}>{Y}</y.Z>
})