...
class em extends(l = r.PureComponent) {
  ...
  renderFooter() {
    ...
    if (n) {
      ...
      null != r ? e = el.NW.string(el.t["1b9nen"]) : null != s ? e = el.NW.string(el.t.iI1gMj) : null != l ? e = el.NW.string(el.t.KaWCyM) : (null == o ? void 0 : o.isGuildStageVoice()) && (e = el.NW.string(el.t["2frWa2"])), c = (0, i.jsxs)(T.Z, {
        direction: T.Z.Direction.VERTICAL,
...
let ev = r.forwardRef(function(e, t) {
  ...
  let [es] = (0, C.Z)(null != c ? [c] : []), ea = (0, y.Z)({
    guildId: U
  ...
  }, [eI, Q, Z, o, null == es ? void 0 : es.id, O, u, eP, ew, eO, eE, ek, eA]), eW = (0, f.Z)(Z), eL = (0, f.Z)((0, F.yE)(eA, g.$.IS_APPLICATION_BYPASS)), eU = null != eW && eW !== Z, eD = null != eL && eL !== (0, F.yE)(eA, g.$.IS_APPLICATION_BYPASS);
  r.useEffect(() => {
    !eI && (eU || eD) && eM()
  }, [eM, eU, eD, eI]);
  let {
