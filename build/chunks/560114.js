...
class ev extends(l = s.PureComponent) {
  componentDidMount() {
    ...
    if (h && z.default.track(et.rMx.INVITE_SUGGESTION_OPENED, {
        location: l,
    ...
    } else(null == d ? void 0 : d.id) != null || z.default.track(et.rMx.OPEN_MODAL, {
  ...
  renderFooter() {
    ...
    let {
      ...
      maxAge: u
    } = d, c = null, h = (0, K.Z)(null !== (e = this.getInviteKey()) && void 0 !== e ? e : "");
    if (n) {
      let e = el.NW.string(el.t.MLkj7O);
      null != s ? e = el.NW.string(el.t["1b9nen"]) : null != r ? e = el.NW.string(el.t.iI1gMj) : null != l ? e = el.NW.string(el.t.KaWCyM) : (null == o ? void 0 : o.isGuildStageVoice()) && (e = el.NW.string(el.t["2frWa2"])), c = (0, i.jsxs)(y.Z, {
        direction: y.Z.Direction.VERTICAL,
        ...
        children: e => {
          ...
          return (0, i.jsx)(p.P3F, {
            ...
            children: (0, i.jsx)(p.ewm, {
              size: "sm",
              color: m.Z.unsafe_rawColors.PRIMARY_400.css
            })
          })
        }
      })]
...
let ex = s.forwardRef(function(e, t) {
  ...
  } = (0, f.ZP)(j.Z.INSTANT_INVITE_MODAL), Z = (0, v.e7)([B.Z, M.Z, O.ZP], () => {
    if (null != r) return r;
  ...
  let L = null != r ? r.getGuildId() : null != a ? a.id : null,
    ...
    [el] = s.useState(() => {
      let e = new Set;
      return null != u && null != K ? K.forEach(t => {
        let {
          user: n
        } = t;
        e.add(n.id)
      }) : null != L && null != J && A !== ee.Iq.EMBEDDED_APPLICATION && J.rows.forEach(t => {
  ...
  let [er] = (0, E.Z)(null != c ? [c] : []), ea = (0, T.Z)({
    guildId: L
  }), eo = null != D ? D.code : void 0, eu = null == D ? void 0 : D.maxAge, ex = null == D ? void 0 : D.maxUses, em = null == D ? void 0 : D.temporary, ep = a.vanityURLCode, eN = null != ep && ep.length > 0, eI = !Q && !(null == Z ? void 0 : Z.isGuildVocal()) && eN, eS = (null == Z ? void 0 : Z.type) === et.d4z.GUILD_VOICE, ej = null !== (n = null == D ? void 0 : D.flags) && void 0 !== n ? n : 0, ef = (0, C.Z)(Z);
  ...
  let [eE, eC] = s.useState({
    ...
    maxUses: null != ex && 0 !== ex ? ex : eg.value,
    ...
    e === ee.RV.SETTINGS && null != t ? eT(t) : m()
  }, [eT, eE, m]), eR = s.useCallback(() => {
    ...
    0 === eP && 0 === ew && !eA && eI ? e_({
      ...
      networkError: e,
      showVanityURL: eI
    }))), ew !== ec.value && ek !== ec.value && e_({
      savedMaxAge: ec.value
    })
  }, [eI, Q, Z, o, null == er ? void 0 : er.id, A, u, ew, eP, eA, e_, ek, eM]), eW = (0, S.Z)(Z), eU = (0, S.Z)((0, F.yE)(eM, g.$.IS_APPLICATION_BYPASS)), eL = null != eW && eW !== Z, eB = null != eU && eU !== (0, F.yE)(eM, g.$.IS_APPLICATION_BYPASS);
  s.useEffect(() => {
    !eI && (eL || eB) && eR()
  }, [eR, eL, eB, eI]);
  let {
