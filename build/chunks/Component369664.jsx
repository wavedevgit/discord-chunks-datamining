...
let ej = e => {
    ...
    let {
      error: n,
      allowClick: i = false
    } = e, o = null == (t = (0, G.hp)(n)) ? true : t.errorCode, a = eP.intl.formatToPlainString(eP.t.ejOT95, {
      errorCode: o
    }), s = (0, r.jsx)(f.Text, {
...
let eY = Chunk473749.memo(function() {
  var e, t;
  let o = (0, Chunk442837.e7)([Chunk594174.default], () => Chunk594174.default.getCurrentUser()),
  ...
  switch (c.type) {
    ...
    case Chunk981631.kVF.NO_INPUT_DETECTED:
      if ((0, Chunk647085.q)({
        ...
        else if (0 === ex) return (0, Chunk54381.jsx)(eZ, {
          deviceGuid: Chunk475808,
          noticeType: c.type
        })
      }
    ...
    case Chunk981631.kVF.SURVEY: {
      ...
      return (0, Chunk54381.jsxs)(Chunk481060.qXd, {
        ...
        children: [(0, Chunk54381.jsx)(Chunk481060.RyX, {
          ...
          noticeType: Chunk981631.kVF.SURVEY,
          onClick: () => {
            a ? (0, Chunk126916.q)(Chunk319498) : window.open(Chunk913527, "_blank"), (0, Chunk491428.hZ)(exports, false)
          },
    ...
    case Chunk981631.kVF.BLOCK_USER_FEEDBACK_NAGBAR:
      return (0, Chunk54381.jsxs)(Chunk481060.qXd, {
        ...
        children: [(0, Chunk54381.jsx)(Chunk481060.RyX, {
          ...
          onClick: () => {
            var e;
            (0, Chunk496729.Z)(), eH(null == (e = c.metadata) ? true : module.dismissUntil)
          },
          noticeType: Chunk981631.kVF.BLOCK_USER_FEEDBACK_NAGBAR,
