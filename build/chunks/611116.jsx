...
function g(e) {
  ...
  return <div className={a()(b.boxBackdrop, t)}>{<l.X6q className={b.bentoSectionHeader} variant={"display-md"} color={"header-primary"}>{r}</l.X6q>}{<div className={b.bentoBoxesGrid}>{n.map((e, t) => {
        let n;
        switch (e.length) {
          case 3:
            n = o.y$.SMALL;
      ...
      })}</div>}{g && <div className={u.bentoSideGradient} />}</div>
}
