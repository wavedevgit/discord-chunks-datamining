...
let p = o.memo(function(e) {
    let {
      ...
      application: C,
      tooltipPosition: v
    } = e, x = o.useMemo(() => new Date(p), [p]), O = o.useMemo(() => (0, l.Hg)(x), [x]), I = o.useMemo(() => null != f ? (0, l.vc)(x, f) : i ? (0, l.vc)(x, "LT") : (0, l.Y4)(x, !0), [x, f, i]), E = o.useMemo(() => i ? (0, u.Z)(I) : null, [i, I]), S = o.useMemo(() => y ? d.intl.formatToPlainString(d.t.CDzOFR, {
      timeFormatted: O
    }) : O, [y, O]);
    return (0, a.jsx)("span", {
      className: r()(n, E, {
