...
async function g(e) {
  let {
    loadUntilMessageId: t,
    onlyUnread: n = !1
  } = e, r = [], a = u.ZP.getNotifyingChannelIds();
  if (null == a) return;
  ...
  for (let e of (a.sort((e, t) => c.default.compare(l.ZP.lastMessageId(t), l.ZP.lastMessageId(e))), a)) {
    ...
    (n ? (null == (p = f[e]) ? void 0 : p.loadState) === u.a7.UNLOADED : (null == (m = f[e]) ? void 0 : m.loadState) !== u.a7.LOADED) && r.push(o.Z.fetchMessages({
      channelId: e,
      limit: n ? d.W9 : d.AQ,
      isPreload: n
    }))
  ...
  if (s.ZP.hasMore && !s.ZP.loading && r.push(h(E)), 0 === r.length) return void i.Z.dispatch({
  ...
  try {
    await Promise.all(r), i.Z.dispatch({
      type: "NOTIFICATIONS_INBOX_LOAD_MORE_INBOX_SUCCESS",
      onlyUnread: n,
      requestedMessageId: t
    })
