...
function p(e) {
  ...
  return <c.Z modalType={"voice_filter"} header={s.intl.string(s.t.zZAORE)} impression={{
    ...
    }} ratingOptions={d} ratingTextLabels={u} problemTitle={s.intl.string(s.t.FJmoxM)} problems={m} freeformNeededProblems={b} onSubmit={function(e) {
      var t, o;
      let {
        rating: i,
        problem: n,
    ...
    }} onClose={t} transitionState={o} otherKey={"other"} />
}