...
function L(e) {
  let {
    application: t,
    guild: n
  } = e, l = (0, O.Tq)(n.id), s = (0, O.uP)(n.id), a = s.some(e => null != e.name && null != e.subscription_plans[0] && null != e.description && null != e.image_asset), c = (0, i.yK)([p.A], () => s.map(e => p.A.getRole(n.id, e.role_id)), [n.id, s]).some(e => null != e && 0 !== e.color), o = s.some(e => e.role_benefits.benefits.length > 0), d = null != t && n.features.has(P.GuildFeatures.ROLE_SUBSCRIPTIONS_ENABLED), u = [{
...
function M(e) {
  ...
  return (0, c.T)(n), t = a ? s === P.nd0.ROLE_SUBSCRIPTION_EMOJI ? I.Oi.EMOJIS : I.Oi.TIERS : I.Oi.PAYMENT, (0, r.jsx)(j.H, {
    guildId: n.id,
    refetchOnMount: true,
          ...
          children: (0, r.jsx)(l.m, {
            ...
            children: (0, r.jsx)(s.Button, {
              ...
              onClick: () => {
                ...
                }), (0, v.SY)(n.id), (0, g.pX)(P.BVt.CHANNEL(n.id, w.VV.ROLE_SUBSCRIPTIONS))
              },
