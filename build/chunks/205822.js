...
let v = new s.Z("UploadArea");

function m() {
  return (0, r.jsxs)("div", {
    children: [(0, r.jsx)("div", {
      className: o()(p.sparkleWhite, f.sparkleOne)
    }), (0, r.jsx)("div", {
      className: o()(p.sparkleWhite, f.sparkleTwo)
    }), (0, r.jsx)("div", {
      className: o()(p.lightWhite, f.lightOne)
    }), (0, r.jsx)("div", {
      className: o()(p.lightWhite, f.lightTwo)
    }), (0, r.jsx)("div", {
      className: o()(p.crossWhite, f.crossOne)
    }), (0, r.jsx)("div", {
      className: o()(p.crossWhite, f.crossTwo)
    }), (0, r.jsx)("div", {
      className: o()(p.popWhite, f.popOne)
    })]
  })
}
class b extends i.Component {
  ...
  constructor(...e) {
    ...
    super(...e), t = this, g(this, "state", {
      isDragging: !1,
      isOverZone: !1
    }), g(this, "dragOverTimeout", null), g(this, "elementDOMRef", i.createRef()), g(this, "isAllDropFiles", e => {
      ...
      if (null != i) {
        if ("move" === i.effectAllowed ? i.dropEffect = "move" : i.dropEffect = "copy", (0, a.nfh)(c.A) && (0, a.Mr3)(c.A), e.stopPropagation(), e.preventDefault(), null == (t = (n = this.props).onDragOver) || t.call(n, e), !this.state.isDragging) {
