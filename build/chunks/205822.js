...
function M() {
  return (0, n.jsxs)("div", {
    children: [(0, n.jsx)("div", {
      className: i()(p.sparkleWhite, f.sparkleOne)
    }), (0, n.jsx)("div", {
      className: i()(p.sparkleWhite, f.sparkleTwo)
    }), (0, n.jsx)("div", {
      className: i()(p.lightWhite, f.lightOne)
    }), (0, n.jsx)("div", {
      className: i()(p.lightWhite, f.lightTwo)
    }), (0, n.jsx)("div", {
      className: i()(p.crossWhite, f.crossOne)
    }), (0, n.jsx)("div", {
      className: i()(p.crossWhite, f.crossTwo)
    }), (0, n.jsx)("div", {
      className: i()(p.popWhite, f.popOne)
    })]
  })
}
class d extends h.Component {
  ...
  constructor(...e) {
    ...
    super(...e), t = this, Z(this, "state", {
      isDragging: !1,
      isOverZone: !1
    }), Z(this, "dragOverTimeout", null), Z(this, "elementDOMRef", h.createRef()), Z(this, "isAllDropFiles", e => {
      ...
      return !h && !v || (e.stopPropagation(), e.preventDefault(), n.effectAllowed = "none", n.dropEffect = "none", r && (t.setState({
        isDragging: !1
      }), (0, s.openUploadError)({
      ...
      if (null != h) {
        if ("move" === h.effectAllowed ? h.dropEffect = "move" : h.dropEffect = "copy", (0, l.nfh)(s.A) && (0, l.Mr3)(s.A), e.stopPropagation(), e.preventDefault(), null === (t = (r = this.props).onDragOver) || void 0 === t || t.call(r, e), !this.state.isDragging) {
          let e = null === (n = this.elementDOMRef.current) || void 0 === n ? void 0 : n.ownerDocument.defaultView;
          (null != e && h.types instanceof e.DOMStringList && h.types.contains("application/x-moz-file") || -1 !== h.types.indexOf("Files")) && this.setState(e => e.isDragging ? {} : {
            isDragging: !0
          })
        }
