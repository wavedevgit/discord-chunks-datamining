...
function _(e) {
  let {
    ...
    showFormStyleSurvey: h,
    hideNeutralOption: O,
    showVibesHoneypot: g
  } = (0, l.X)({
    location: "VoiceCallFeedback"
  }), v = h ? p.intl.string(p.t.xv0BJi) : p.intl.string(p.t.Ss6tlZ), y = h ? void 0 : p.intl.string(p.t.tLi4cX), x = O ? [b.aZ.BAD, b.aZ.GOOD] : void 0, j = h ? {
