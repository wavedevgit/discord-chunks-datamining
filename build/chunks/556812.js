/** Chunk was on web.js **/
/** chunk id: 556812, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  c: () => o
});
...
class o {
  ...
  write(e, t, n) {
        ...
        case "enum":
          ...
          if (l)
            if ((0, a.vA)(Array.isArray(s)), l == i.sA.PACKED) this.packed(t, u, r.no, s);
              ...
              for (let e of s) this.scalar(t, u, r.no, e, true);
          else true === s ? (0, a.vA)(r.opt) : this.scalar(t, u, r.no, s, o || r.opt);
          break;
        case "message":
          if (l)
    ...
    false !== s && (true === s ? r.f$.onWrite : s)(this.info.typeName, e, t)
  }
  mapEntry(e, t, n, s, o) {
    ...
    switch (this.scalar(e, n.K, 1, l, true), n.V.kind) {
      case "scalar":
        this.scalar(e, n.V.T, 2, o, true);
        break;
      case "enum":
        this.scalar(e, i.LN.INT32, 2, o, true);
        break;
      case "message":
  ...
  message(e, t, n, i, a) {
    true !== a && (n.internalBinaryWrite(a, e.tag(i, r.O0.LengthDelimited).fork(), t), e.join())
  }
  scalar(e, t, n, r, i) {
