...
function U(e) {
  ...
  let {
    ...
    closePopout: m,
    onFocus: y
  } = e, T = (0, o.e7)([d.Z], () => d.Z.useReducedMotion), U = (0, o.e7)([b.default], () => b.default.getCurrentUser()), B = C.ZP.canUseFancyVoiceChannelReactions(U), G = (0, o.e7)([v.Z], () => v.Z.getState().animationType), F = i.useRef(!1), H = (0, f.wC)(n.guild_id), V = (0, l.uniqBy)([...H, ...D], "name").filter(e => !_.ZP.isEmojiFilteredOrLocked({
    emoji: e,
    channel: n,
    intention: M
  })).slice(0, N.e5), z = (null != (t = j.Z.recentlyUsedEmojis) ? t : []).filter(e => !V.slice(0, N.e5 - 1).some(t => t.name === e.name));
  ...
  let W = (0, O.Iu)(G),
    ...
    K = e => {
      F.current = e, e && p.ZP.trackWithMetadata(Z.rMx.VOICE_CHANNEL_EFFECT_EMOJI_PICKER_EXPANDED, {
        channel_id: X,
        guild_id: Q
      })
    },
      ...
      return (0, r.jsx)(s.yRy, {
        ...
        renderPopout: () => (0, r.jsx)("div", {
          ...
          children: (0, r.jsx)(g.ZP, {
            ...
            onClick: () => {
              u.Z.open(Z.oAB.ACCESSIBILITY, null, {
