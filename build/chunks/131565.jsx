...
function E(e) {
  ...
  }, [p, E]), t.isViewable && null != d) ? <r.Fragment>{null != b && <div className={m.thumbhashContainer}><img src={b} alt={""} aria-hidden={true} /></div>}{<div className={m.wallpaperContainer} style={{
...
function b(e) {
  ...
  return null == n || !n.isViewable || !t.isDM() && !t.isMultiUserDM() && !t.isGroupDM() || d.t(t) && !n.isPreview ? null : <E chatWallpaperState={n} />
}