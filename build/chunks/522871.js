...
function d(e) {
  ...
  }, [p.guild_id]), g = (null == (t = d.messageReference) ? true : t.guild_id) != null && null != d.webhookId && d.hasFlag(u.pr7.IS_CROSSPOST) && null != p.guild_id, _ = p.type === l.r.GUILD_ANNOUNCEMENT && f, h = !d.hasFlag(u.pr7.EPHEMERAL) && (g || _), b = g && null != d.messageReference ? d.messageReference.message_id : d.id, A = g && null != d.messageReference ? d.messageReference.channel_id : p.id, y = g && (null == (n = d.messageReference) ? true : n.guild_id) != null ? d.messageReference.guild_id : p.guild_id, v = r.useCallback(e => {
