...
let T = function(e, t, n) {
  ...
  return T.current = n, r.useCallback(n => {
    ...
    switch (n.key.toLowerCase()) {
      case "backspace":
        r && (O.A.can(N.xBc.MANAGE_MESSAGES, L) || M.canDeleteOwnMessage(G)) && (n.preventDefault(), (0, I.RC)(L, M, n));
        break;
      case "c":
      ...
      case "+":
        (r || D) && function(e) {
          ...
          return !r && n
        }(L) && (n.preventDefault(), v._.dispatchKeyed(N.zOV.TOGGLE_REACTION_POPOUT, M.id, {
          emojiPicker: true
        }));
        break;
      case "r":
        ...
        break;
      case "f":
        (r || D) && (0, i.p)(M) && (n.preventDefault(), (0, a.fO)({
          message: M,
          source: "keyboard-shortcut"
        }));
        break;
      case "s":
        r && "" !== M.content && (n.preventDefault(), n.stopPropagation(), f.A.isSpeakingMessage(t, e) ? (0, d.pr)() : (0, d.kP)(L, M));
        break;
      case "t":
