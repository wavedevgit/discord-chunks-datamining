...
function G() {
  ...
  }), e = u.name) : null != a && (a.isDM() || a.isGroupDM()) ? (e = L.intl.string(L.t.YUU0RE), f = (0, r.jsx)(s.gw7, {
    size: "xs"
  })) : t.pathname.startsWith(x.Z5c.GLOBAL_DISCOVERY) ? (e = L.intl.string(L.t["4nEZLi"]), f = (0, r.jsx)(s.Jmo, {
    size: "xs"
  })) : t.pathname.startsWith(x.Z5c.NITRO_HOME) ? (e = L.intl.string(L.t.Ipxkoq), f = (0, r.jsx)(s.SrA, {
    size: "xs"
  })) : t.pathname.startsWith(x.Z5c.COLLECTIBLES_SHOP) ? (e = L.intl.string(L.t.pWG4zc), f = (0, r.jsx)(s.EOn, {
    size: "xs"
  })) : t.pathname.startsWith(x.Z5c.FRIENDS) ? (e = L.intl.string(L.t.TdEu5e), f = (0, r.jsx)(s.iFz, {
    size: "xs"
  })) : t.pathname.startsWith(x.Z5c.FAMILY_CENTER) && (e = L.intl.string(R.default.RZqaJi), f = (0, r.jsx)(s.BFJ, {
    size: "xs"
...
let B = i.memo(function() {
  ...
  return a ? null : (0, r.jsx)(s.Wdt, {
    children: e => (0, r.jsx)(s.f6W, {
      theme: l,
      children: i => (0, r.jsx)(Z.T, {
        className: i,
        leading: t && (0, r.jsxs)(r.Fragment, {
          children: [(0, r.jsx)(s.P3F, M(k({}, e), {
            className: D.button,
            onClick: () => {
              U.setState({
