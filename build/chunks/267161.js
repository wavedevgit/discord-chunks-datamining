...
function F() {
  let e, t = (0, l.TH)(),
    ...
    E = null != f ? Z.ZP.getApplicationIconURL({
      id: f.id,
      icon: f.icon,
      bot: f.bot
    }) : void 0,
    O = null;
  return null != f && g && b ? (e = f.name, O = (0, r.jsx)("img", {
    className: G.appIcon,
    alt: M.intl.string(M.t.X4IxWF),
    src: E,
    "aria-hidden": !0,
    draggable: !1
  })) : null != u ? (O = h ? (0, r.jsx)(c.r7p, {
    size: "xs"
  }) : (0, r.jsx)(_.Z, {
    guild: u,
    size: _.Z.Sizes.MINI,
  ...
  }), e = u.name) : null != a && (a.isDM() || a.isGroupDM()) ? (e = M.intl.string(M.t.YUU0RE), O = (0, r.jsx)(c.gw7, {
    size: "xs"
  })) : t.pathname.startsWith(R.Z5c.GLOBAL_DISCOVERY) ? (e = M.intl.string(M.t["4nEZLi"]), O = (0, r.jsx)(c.Jmo, {
    size: "xs"
  })) : t.pathname.startsWith(R.Z5c.NITRO_HOME) ? (e = M.intl.string(M.t.Ipxkoq), O = (0, r.jsx)(c.SrA, {
    size: "xs"
  })) : t.pathname.startsWith(R.Z5c.COLLECTIBLES_SHOP) ? (e = M.intl.string(M.t.pWG4zc), O = (0, r.jsx)(c.EOn, {
    size: "xs"
  })) : t.pathname.startsWith(R.Z5c.FRIENDS) ? (e = M.intl.string(M.t.TdEu5e), O = (0, r.jsx)(c.iFz, {
    size: "xs"
  })) : t.pathname.startsWith(R.Z5c.FAMILY_CENTER) && (e = M.intl.string(U.default.RZqaJi), O = (0, r.jsx)(c.BFJ, {
    size: "xs"
  })), null != e && "" !== e && (0, r.jsxs)("div", {
    className: G.title,
    children: [O, (0, r.jsx)(c.Text, {
