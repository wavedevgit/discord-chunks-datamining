...
class m extends Chunk73800.PureComponent {
  ...
  render() {
    ...
    return <Chunk481060.OoM renderCustomBreadcrumb={this.renderCustomBreadcrumb} onBreadcrumbClick={this.handleClick} breadcrumbs={require} activeId={Chunk73800} />
  }
  constructor(...e) {
    ...
    }), g(this, "renderCustomBreadcrumb", (e, t) => <u.Z.Title className={t ? null : h.breadcrumb} muted={!t}>{e.label}</u.Z.Title>)
  }
}
