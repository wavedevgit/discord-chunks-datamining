...
function m(e) {
  ...
  return <c.uf status={m} cost={u ? o.cost : true} className={i} />
}
...
function g(e) {
  ...
  return <r.Fragment>{<c.aB label={p.title} isActive={j} isWarning={h} badge={m} canRollback={E} onClick={I} onMouseOver={() => null == x ? true : x(true)} onMouseLeave={() => null == x ? true : x(false)} className={g} ref={e => {
        C.current = e, P.current = e
      }}>{_}</c.aB>}{!E && v && <u.Z powerup={p} targetRef={C} isCardVisible={O} />}</r.Fragment>
}