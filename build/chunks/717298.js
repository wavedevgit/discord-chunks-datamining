...
function Q(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), er = i.useRef(performance.now()), ei = (0, m.e7)([C.Z], () => C.Z.getUseSystemScreensharePicker() && ((0, w.isLinux)() || (0, w.isMac)() && c().satisfies(null === x.Z || void 0 === x.Z ? void 0 : x.Z.os.release, Y.jR))), {
    analyticsLocations: el
  } = (0, v.ZP)(_.Z.GO_LIVE_MODAL_V2), es = (0, m.e7)([O.default], () => O.default.getCurrentUser()), eo = (0, A.Z)(), {
    state: ea,
    dispatch: ec
  } = (0, B.Ti)(a, es, eo, (0, w.isWindows)() && null != a && Q ? "confirm" : "source_select"), ed = (0, b.zX)({
    location: "GoLiveModalV2"
  });
  ...
  let eZ = i.useCallback(() => {
    ...
    ew = (0, r.jsxs)(h.mzw, {
      className: s()(K.footer, {
        [K.footerShadow]: !eu && ep
      }),
      separator: !1,
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(H.Z, {
          nativePickerEnabled: ei
        }), (0, r.jsxs)("div", {
          className: K.rightButtonGroup,
          children: [ej && (0, r.jsx)(F.Z, {
            onClose: n
          }), e_ && !eg && (0, r.jsx)(k.Z, {
