...
function F(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), V = i.useRef(performance.now()), Y = (0, f.e7)([b.Z], () => b.Z.getUseSystemScreensharePicker() && (0, y.isMac)() && o().satisfies(null === x.Z || void 0 === x.Z ? void 0 : x.Z.os.release, G.jR)), J = (0, f.e7)([N.default], () => N.default.getCurrentUser()), X = !Z.ZP.canStreamQuality(Z.ZP.StreamQuality.HIGH, J), {
    analyticsLocations: K
  } = (0, _.ZP)(g.Z.GO_LIVE_MODAL_V2), q = !F && null != a, Q = (0, E.Z)(), {
    state: $,
    dispatch: ee
  } = (0, R.Ti)(a, J, Q), et = !q && H && (!Y || $.sourceType === u.vA.CAMERA);
  (0, D.Z)(Y, ee);
  let en = i.useMemo(() => {
      let e = [{
    ...
    children: (0, r.jsxs)(m.Y0X, {
      ...
      children: [q ? (0, r.jsx)(P.Z, {
        ...
        children: [(0, r.jsx)(m.xBx, {
          ...
          className: z.content,
          children: Y && er !== u.vA.CAMERA ? (0, r.jsx)(W.Z, {
            onSourceSelect: es
          }) : (0, r.jsx)(k.Z, {
            onClick: function(e) {
              if (!H) return ei(e);
        ...
        children: [(0, r.jsx)(L.Z, {
          nativePickerEnabled: Y
        }), (0, r.jsxs)("div", {
          className: z.rightButtonGroup,
          children: [Y && er !== u.vA.CAMERA && (0, r.jsx)(m.zxk, {
