...
function $(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), ei = i.useRef(performance.now()), el = (0, m.e7)([y.Z], () => y.Z.getUseSystemScreensharePicker() && ((0, w.isLinux)() || (0, w.isMac)() && c().satisfies(null === x.Z || void 0 === x.Z ? void 0 : x.Z.os.release, X.jR))), {
    analyticsLocations: es
  } = (0, v.ZP)(_.Z.GO_LIVE_MODAL_V2), eo = (0, m.e7)([Z.default], () => Z.default.getCurrentUser()), ea = (0, A.Z)(), {
    state: ec,
    dispatch: ed
  } = (0, G.Ti)(a, eo, ea, (0, w.isWindows)() && null != a && $ ? "confirm" : "source_select"), {
    ...
    children: (0, r.jsxs)(h.Y0X, {
      ...
      children: [e_ ? (0, r.jsx)(L.Z, {
        ...
        children: [(0, r.jsx)(h.xBx, {
          ...
          className: q.content,
          children: el && eO !== f.vA.CAMERA ? (0, r.jsx)(U.Z, {
            onSourceSelect: ew
          }) : (0, r.jsx)(W.Z, {
            onClick: function(e) {
              function t() {
