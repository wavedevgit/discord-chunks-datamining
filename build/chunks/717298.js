...
function F(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), V = l.useRef(performance.now()), Y = (0, f.e7)([b.Z], () => b.Z.getUseSystemScreensharePicker() && (0, Z.isMac)() && o().satisfies(null === x.Z || void 0 === x.Z ? void 0 : x.Z.os.release, B.jR)), J = (0, f.e7)([C.default], () => C.default.getCurrentUser()), X = !I.ZP.canStreamQuality(I.ZP.StreamQuality.HIGH, J), {
    ...
    children: (0, r.jsxs)(m.Y0X, {
      ...
      children: [q ? (0, r.jsx)(P.Z, {
        ...
        children: [(0, r.jsx)(m.xBx, {
          ...
          className: W.content,
          children: Y && er !== u.vA.CAMERA ? (0, r.jsx)(k.Z, {
            onSourceSelect: es
          }) : (0, r.jsx)(A.Z, {
            onClick: function(e) {
              if (!H) return el(e);
