...
function $(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), ei = i.useRef(performance.now()), el = (0, m.e7)([C.Z], () => C.Z.getUseSystemScreensharePicker() && ((0, Z.isLinux)() || (0, Z.isMac)() && c().satisfies(null === x.Z || void 0 === x.Z ? void 0 : x.Z.os.release, Y.jR))), {
    ...
    children: (0, r.jsxs)(h.Y0X, {
      ...
      children: [ev ? (0, r.jsx)(k.Z, {
        ...
        children: [(0, r.jsx)(h.xBx, {
          ...
          className: q.content,
          children: el && eI !== f.vA.CAMERA ? (0, r.jsx)(U.Z, {
            onSourceSelect: eN
          }) : (0, r.jsx)(G.Z, {
            onClick: function(e) {
              function t() {
