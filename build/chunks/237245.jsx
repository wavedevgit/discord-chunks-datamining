...
function I(e) {
  ...
  return <s.Z message={H ? y.intl.string(y.t.V2G2Ym) : true} onSaveText={H ? y.intl.string(y.t["qjtt/v"]) : true} submitting={P} errorMessage={R} onReset={k} onSave={F} disabled={H && !z} />
}
...
function E() {
  ...
  return null == module || null == require ? null : module.joinType === Chunk384632.A.DISCOVERABLE && module.settingsView === Chunk386885.U.INELIGIBLE ? <Chunk852860.Z message={Chunk388032.intl.string(Chunk388032.t.TEXwRk)} onReset={() => Chunk434404.Z.init(require.id, Chunk981631.pNK.ACCESS)} /> : <I pendingState={module} dirtyState={exports} originalGuild={Chunk481060} settingsGuild={require} settingsMetadata={Chunk73800} settingsProfile={Chunk881052} />
}