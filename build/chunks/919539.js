...
function T(e) {
  let {
    ingress: t,
    guildId: n
  } = e, T = (0, f.c_)(), N = (0, p.q)(), I = h.h2.useSetting().includes(n), y = h.mX.useSetting(), A = h.zA.useSetting().includes(n), P = r.useCallback(e => {
    let i = (0, m.gl)();
...
function N(e) {
  let {
    ingress: t = C.f4.USER_SETTINGS_PRIVACY_SAFETY,
    guildId: n
  } = e, r = (0, f.is)();
  return (0, i.jsx)(T, {
    ingress: t,
