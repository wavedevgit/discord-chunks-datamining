...
function C(e, t) {
  return S(e).reduce((e, n) => {
    ...
    if (n.type === p.S8) return e.push({
      type: "checkbox",
      key: n.props.id,
      navigable: true,
      props: n.props
    }), e;
    if (n.type === p.k5) return e.push({
      type: "radio",
      key: n.props.id,
      navigable: true,
      props: n.props
    }), e;
    else if (n.type === p.m7) return e.push({
      type: "switch",
      key: n.props.id,
      navigable: true,
      props: n.props
    }), e;
    else if (n.type === p.II) return e.push(null != n.props.control ? {
      type: "control",
      key: n.props.id,
      navigable: true,
      props: n.props
...
function P(e) {
  ...
  let {
    ...
    onInteraction: T,
    forceIconsLeft: S
  } = e, A = C(b, S), P = N(A), D = i.useRef([]);
  l()(D.current, P) || (D.current = P);
  let L = (0, _.c)("Menu"),
    x = null == (t = A.find(e => null != e.key)) ? true : t.key,
    M = (0, c.Z)({
      navId: n,
      items: D.current,
