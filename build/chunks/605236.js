...
function k(e, t, n) {
  !((0, p.cI)(e) || f.Z.hasUserHitDCCap(e, null == t ? void 0 : t.guildId)) && (n || (a.Z.dispatch({
    ...
    onAdded: () => {
      var n;
      let [r, a] = (0, p.Aq)();
      (0, _.cm)(e, null == t ? void 0 : t.guildId), l.default.track(b.rMx.DISMISSIBLE_CONTENT_SHOWN, {
        type: i.z[e],
        content_count: r,
...
function F(e, t) {
  var n;
  let [r] = (0, p.Aq)(), a = f.Z.getRenderedAtTimestamp(e), o = new Date, s = null == a ? null : o.getTime() - a;
