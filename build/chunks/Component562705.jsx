...
function j(e) {
  let {
    groupName: t,
    targetElementRef: n
  } = e, r = (0, h.Z)(), s = (0, i.e7)([o.Z], () => o.Z.useReducedMotion), m = (0, d.Z)(e => e.isOpen), p = (0, i.e7)([u.Z], () => u.Z.getLayers().includes(x.S9g.USER_SETTINGS));
...
function y(e) {
  ...
  let {
    ...
    i(g.L.USER_DISMISS)
  }, [i]), y = b.vK[n], C = v.intl.formatToPlainString(v.t.ewkaVR, {
