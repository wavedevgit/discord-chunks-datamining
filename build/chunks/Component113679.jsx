...
function g(e) {
  let {
    guild: t
  } = e, n = (0, l.e7)([o.Z], () => null != t && o.Z.can(c.Plq.MANAGE_GUILD, t), [t]), g = t.features.has(c.GuildFeatures.COMMUNITY), [f, m] = i.useState(t.features.has(c.GuildFeatures.ENABLED_MODERATION_EXPERIENCE_FOR_NON_COMMUNITY)), b = i.useCallback(async e => {
