...
function m(e) {
  let {
    guild: t
  } = e, n = i.useId(), m = (0, l.e7)([o.Z], () => null != t && o.Z.can(u.Plq.MANAGE_GUILD, t), [t]), p = t.features.has(u.GuildFeatures.COMMUNITY), [f, h] = i.useState(t.features.has(u.GuildFeatures.ENABLED_MODERATION_EXPERIENCE_FOR_NON_COMMUNITY)), x = i.useCallback(async e => {
