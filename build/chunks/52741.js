...
function j(e) {
  ...
  let {
    ...
    headingColor: H
  } = e, A = (0, o.e7)([d.Z], () => d.Z.getPremiumTypeSubscription()), U = (0, o.e7)([u.default], () => u.default.getCurrentUser()), G = (0, C.t7)(), k = (0, C.lr)(), D = N === h.p9.TIER_0 ? h.Si.TIER_0 : h.Si.TIER_2, V = (null == A ? void 0 : A.hasActiveTrial) ? null == U ? void 0 : U.premiumType : G ? h.p9.TIER_2 : null, B = (0, g.N)(), F = (0, p.Ng)(), W = null == B ? void 0 : B.subscription_trial;
  if (!w && !E && null != V && N === V && null != A && null != A.planIdFromItems) {
    ...
    return (0, n.jsx)(c.X6q, {
      ...
      children: b === h.C.PREMIUM_TRIAL ? v.intl.format(v.t["2CGBrq"], {
        remainingTime: e,
        price: o
  ...
  if (!w && !E && _) {
    ...
    if (b === h.C.PREMIUM_TRIAL) return (0, n.jsx)(c.X6q, {
      variant: L,
      color: H,
      className: l()(I.trialHeader, O),
    ...
    if (null != F) return (0, n.jsx)(c.X6q, {
      variant: L,
      color: H,
      className: l()(I.trialHeader, O),
      children: (0, n.jsx)(T, {
