...
function j(e) {
  ...
  let {
    ...
    headingColor: H
  } = e, A = (0, o.e7)([d.ZP], () => d.ZP.getPremiumTypeSubscription()), U = (0, o.e7)([u.default], () => u.default.getCurrentUser()), D = (0, C.t7)(), G = (0, C.lr)(), k = b === h.p9.TIER_0 ? h.Si.TIER_0 : h.Si.TIER_2, V = (null == A ? void 0 : A.hasActiveTrial) ? null == U ? void 0 : U.premiumType : D ? h.p9.TIER_2 : null, F = (0, g.N)(), W = (0, p.Ng)(), B = null == F ? void 0 : F.subscription_trial;
  if (!w && !E && null != V && b === V && null != A && null != A.planIdFromItems) {
    ...
    return (0, i.jsx)(c.X6q, {
      ...
      children: N === h.C.PREMIUM_TRIAL ? I.intl.format(I.t["2CGBrq"], {
        remainingTime: e,
        price: o
  ...
  if (!w && !E && _) {
    ...
    if (N === h.C.PREMIUM_TRIAL) return (0, i.jsx)(c.X6q, {
      variant: O,
      color: H,
      className: l()(v.trialHeader, M),
    ...
    if (null != W) return (0, i.jsx)(c.X6q, {
      variant: O,
      color: H,
      className: l()(v.trialHeader, M),
      children: (0, i.jsx)(T, {
