...
function O(e) {
  let {
    children: t
  } = e, n = [a.z.LEADERBOARD_NUX_COACHMARK], [s, c] = (0, d.US)(n, void 0), u = (0, l.e7)([h.default], () => h.default.getCurrentUser()), p = i.useRef(null);
  return s !== a.z.LEADERBOARD_NUX_COACHMARK || null == u ? t : (0, r.jsx)(o.yRy, {
    targetElementRef: p,
    renderPopout: () => j({
      user: u,
      markAsDismissed: c
