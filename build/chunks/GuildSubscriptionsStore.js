...
function C(e, t) {
  ...
  T.forEach(i => {
    var o;
    i !== v.Z.getGuildId() && i !== b.Z.getGuildId() && i !== (null == (o = m.Z.getChannel(O.Z.getChannelId())) ? true : o.getGuildId()) && (null == r || r.guildId !== i) && (T.clearWithoutFlushing(i, e), t && (n[i] = T.get(i)))
