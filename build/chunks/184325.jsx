...
var Chunk120356 = require("./120356.js"),
  ...
  Chunk927513 = require("./927513.js"),
  Chunk768865 = require("./768865.js"),
  Chunk617136 = require("./617136.js"),
  Chunk497505 = require("./497505.js"),
  Chunk703656 = require("./703656.js"),
  Chunk317257 = require("./317257.js"),
  Chunk976015 = require("./976015.js"),
...
let j = e => {
  ...
  return t.id === m.l.ORB_PROFILE_BADGE ? <g.Z showSubtext={!i && !t.isPreviewMode} /> : true !== n && t.id !== P.a ? <d.Z profileBadge={t} tenureBadge={n} /> : t.description
};
...
function U(e) {
  ...
  return <div className={o()(D.container, i)} aria-label={w.intl.string(w.t.VWV0y8)} role={"group"}>{n.map((e, t) => {
      var n;
        ...
        y = t => {
          ...
          if (E) {
            if (t.preventDefault(), b.default.track(N.rMx.TIERED_TENURE_BADGE_CLICKED, {
              ...
              (null == g ? true : g.userId) === (null == F ? true : F.id) ? (0, h.uL)(N.Z5c.NITRO_HOME) : (0, f.k)({
                analyticsLocations: G,
                displayProfile: g
              }), null == L || L();
              return
