...
function k(e) {
  ...
  let g = a.useRef(null),
    ...
    el = a.useCallback(() => {
      if (!(0, p.D$)(N, R, T)) return void u.Z.show({
  ...
  a.useEffect(() => {
    ...
    if ($) {
      ...
      if ((null == V ? void 0 : V.question) != null) null == (e = g.current) || e.focus();
        ...
        let e = R.findIndex(e => V["answer-".concat(e.localCreationAnswerId)]); - 1 !== e && (null == (t = A.current[e]) || t.focus())
      }
      ee(!1)
    }
  }, [V, R, $, ee, A, P]);
    ...
    children: [(0, r.jsxs)(c.xBx, {
      ...
      children: [null != G && (0, r.jsx)(c.kzN, {
        ...
        children: [(0, r.jsx)(c.vwX, {
          ...
          className: o()(er ? v.addAnswerButtonDefault : v.addAnswerButtonImageOnly, {
            [v.canRemoveMoreAnswers]: K
          }),
          onClick: Y ? q : void 0,
