  ...
  N = {
    [_.Etm.SET_ACTIVITY]: {
      ...
      handler(e) {
        ...
        if (![b.He.IPC, b.He.WEBSOCKET, b.He.POST_MESSAGE].includes(v.transport)) throw new f.Z({
          errorCode: _.lTL.INVALID_COMMAND
        }, 'command not available from "'.concat(v.transport, '" transport'));
        if (null == C && b.He.IPC === v.transport) throw new f.Z({
          errorCode: _.lTL.INVALID_COMMAND
        ...
        if (null == U && (S.type = _.IIU.PLAYING), null != D) {
          ...
          if (null != R && i().intersection(e, [R.id]).length > 0 && !O.includes(v.application.id)) throw new f.Z({
        ...
        if (null == L) I = Promise.resolve([]);
          ...
          I = (0, p.hR)(v.application.id, [L.large_image, L.small_image])
        }
        return I.then(e => {
          var t, n;
          let [r, i] = e;
          ...
          return null != l && (s.has_match_secret = !!l.match, s.has_join_secret = !!l.join), null != L && (s.has_images = !!(L.large_image || L.small_image)), null != o && (s.party_max = null != o.size && o.size[1] > 0 ? o.size[1] : void 0, s.party_id = o.id), d.default.track(_.rMx.ACTIVITY_UPDATED, s), S
        })
      }
    }
  }