  ...
  b = {
    [g.Etm.SET_ACTIVITY]: {
      ...
      handler(e) {
        ...
        if (null != C && (b.button_urls = C.map(e => e.url), a.buttons = C.map(e => e.label)), a.metadata = b, null != I)
          for (let e of Object.keys(I)) Date.now().toString().length - I[e].toString().length > 2 && (I[e] = Math.floor(I[e] * d.Z.Millis.SECOND));
