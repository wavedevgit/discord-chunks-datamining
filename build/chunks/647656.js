  ...
  O = {
    [_.Etm.SET_ACTIVITY]: {
      ...
      handler(e) {
        ...
        if (null != L && (C.button_urls = L.map(e => e.url), I.buttons = L.map(e => e.label)), I.metadata = C, null != w)
          for (let e of Object.keys(w)) Date.now().toString().length - w[e].toString().length > 2 && (w[e] = Math.floor(w[e] * f.Z.Millis.SECOND));
