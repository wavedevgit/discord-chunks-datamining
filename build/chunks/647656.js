  ...
  O = {
    [_.Etm.SET_ACTIVITY]: {
      ...
      handler(e) {
        ...
        if (![b.He.IPC, b.He.WEBSOCKET, b.He.POST_MESSAGE].includes(O.transport)) throw new g.Z({
          errorCode: _.lTL.INVALID_COMMAND
        }, 'command not available from "'.concat(O.transport, '" transport'));
        if (null == y && b.He.IPC === O.transport) throw new g.Z({
          errorCode: _.lTL.INVALID_COMMAND
        }, "nonzero pid required");
        if (null == I) return a.Z.dispatch({
        ...
        if (null != T && (0, o.Kb)(T) && N) {
          ...
          if ((null == e ? void 0 : e.applicationId) === T.id) {
            ...
            null != t && (C.embedded_activity_instance_id = t, P |= (0, c.Z)({
              flags: P,
              embeddedActivity: e
            })), I.party = function(e) {
              ...
              size: null != (r = null == (n = I.party) ? void 0 : n.size) ? r : c.M
            }, null != (l = I.party) ? l : {})
          }
        }
        let j = (0, u.S5)(I, N);
        ...
        if (null == R && (I.type = _.IIU.PLAYING), null != x) {
          ...
          if (null != Z && i().intersection(e, [Z.id]).length > 0 && !E.includes(O.application.id)) throw new g.Z({
            errorCode: _.lTL.INVALID_ACTIVITY_SECRET
          }, "secrets cannot match the party id");
          if (i().uniq(e).length < e.length) throw new g.Z({
            errorCode: _.lTL.INVALID_ACTIVITY_SECRET
          }, "secrets must be unique");
          if (null != w) throw new g.Z({
            errorCode: _.lTL.INVALID_ACTIVITY_SECRET
          }, "secrets cannot currently be sent with buttons")
        }
        if (null != w && (C.button_urls = w.map(e => e.url), I.buttons = w.map(e => e.label)), I.metadata = C, null != L)
          for (let e of Object.keys(L)) Date.now().toString().length - L[e].toString().length > 2 && (L[e] = Math.floor(L[e] * f.Z.Millis.SECOND));
