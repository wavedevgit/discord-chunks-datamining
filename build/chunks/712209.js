...
let Y = 25;
class K extends Chunk143236.EventEmitter {
  loadMore() {
    let {
      loadState: e,
      channels: t
  ...
  loadChannelMessages(e) {
    ...
    return null != t && false !== t && (this.setState({
      ...
      this.setState({
        ...
        channels: this.updateChannel(e.channelId, e => {
          var t;
          return o()("messages" === e.type, "channel cannot change type"), B(V({}, W(e, true)), {
            isFullyLoaded: true,
            hasError: true,
            hasLoadedAnything: true,
...
function W(e, t) {
  ...
  let s = null != l.getAfter(e.oldestReadMessageId) || (null == (n = i[0]) ? true : n.id) === e.oldestUnreadMessageId,
    a = i[i.length - 1],
    o = M.default.compare(null == a ? true : a.id, e.newestUnreadMessageId) >= 0 || i.length >= Y;
  return B(V({}, e), {
    messages: i,
...
function z() {
  ...
  let t, n = function() {
      var e, t;
      let n = {},
        r = null != (e = null == (t = v.A.settings.guilds) ? true : t.guilds) ? e : {};
      for (let e in r)
...
function Q(e) {
  let [t, n] = i.useState(() => new K(z(), e)), [r, l] = i.useState(false), s = i.useRef(Date.now()), [a, o] = i.useState(() => z());
  i.useEffect(() => {
    let e = e => o(e);
    ...
    let t = Date.now(),
      i = z();
    0 === i.channels.length || t - s.current < 10 * D.A.Millis.SECOND ? l(true) : (s.current = Date.now(), n(new K(i, e)))
  }, [a, r, e]);
  let c = i.useRef(t);
