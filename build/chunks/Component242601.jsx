...
class e_ extends Chunk647438.PureComponent {
  ...
  constructor(...e) {
    super(...e), ep(this, "historyUnlisten", () => {}), ep(this, "guildHeaderRef", i.createRef()), ep(this, "guildHeaderDropdownButtonRef", i.createRef()), ep(this, "showTimeout", new d.V7), ep(this, "state", {
      ...
      let h = [];
      return (a && h.push(u.z.STUDENT_HUB_PRIVACY_SETTINGS_TOOLTIP), t && h.push(u.z.GUILD_HEADER_BOOST_PROGRESS_BAR_UPSELL), n && h.push(u.z.GUILD_HEADER_ROLE_SUBSCRIPTION_UPSELL), i && h.push(u.z.GUILD_HEADER_INVITE_SPLASH), l && h.push(u.z.GUILD_DISCOVERY_LANDING_PAGE_SETTINGS_UPSELL), d && h.push(u.z.GUILD_POWERUP_PERKS_COACHMARK), p && h.push(u.z.BOOSTER_ENHANCED_ROLE_COLORS_COACHMARK), 0 === h.length) ? this.renderGuildHeaderDropdownButton(e) : (o && h.push(u.z.MEDIA_CHANNEL_UPSELL), s && h.push(u.z.SERVER_SUBSCRIPTION_TIER_TEMPLATE_UPSELL), c && h.push(u.z.PREMIUM_CUSTOM_NOTIFICATION_SOUNDS_COACHMARK), (0, r.jsx)(er.Z, {
        contentTypes: h,
        guild: f,
...
function eO(e) {
  ...
  let eC = (0, I.Nj)(u.z.PREMIUM_TUTORIAL_SERVER_MENU_TOOLTIP),
    ...
    eA = (0, R.Z)(n),
    ex = (0, D.Z)(null == Z ? true : Z.id, n) && (null == o ? true : o.premiumProgressBarEnabled) === false;
  return (0, r.jsx)(e_, {
    guildId: n,
    hideSelectedChannel: l,
    guild: o,
    ...
    shouldRenderGuildPowerupPerkCoachmark: false === eA,
    shouldRenderBoosterEnhancedRoleColorsCoachmark: ex
  })
}