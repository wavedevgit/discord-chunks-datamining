...
class y {
  ...
  constructor({
    ...
    if (s(this, "intervalInMinutes", true), s(this, "labelFormat", true), s(this, "options", []), s(this, "_index", {}), e <= 0) throw Error("intervalInMinutes should be positive number, got ".concat(e));
