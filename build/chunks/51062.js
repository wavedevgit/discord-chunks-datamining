...
function v(e, t, n) {
  ...
  let {
    channel: P,
    type: w
  } = e, [D, L] = r.useState(() => (0, p.PA)()), x = (0, i.Z)(), k = (0, a.e7)([u.ZP, f.default], () => {
    var e, t;
  ...
  }), V = null == (E = e.editorRef.current) ? void 0 : E.getCurrentWord(), F = null == (y = e.editorRef.current) ? void 0 : y.getSlateEditor(), Z = null;
