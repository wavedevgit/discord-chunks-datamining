...
function v(e) {
  ...
  let I = y ? <l.Text className={g.cooldownText} variant={"text-xs/medium"} color={f ? "text-danger" : "text-muted"} tabularNumbers={true}>{<l.ANZ size={"xxs"} color={"currentColor"} className={g.slowModeIcon} />}{t}</l.Text> : <l.Text className={g.cooldownText} variant={"text-sm/medium"} color={f ? "text-danger" : "text-muted"} tabularNumbers={true}>{t}{<l.ANZ size={"xs"} color={"currentColor"} className={g.slowModeIcon} />}</l.Text>;
  return <l.ua7 text={v}>{e => (0, r.jsx)("div", O(b({
...
function I(e) {
  ...
  return <v isEnabled={l} rateLimitPerUser={a} isBypassSlowmode={o} slowmodeCooldownGuess={i} />
}