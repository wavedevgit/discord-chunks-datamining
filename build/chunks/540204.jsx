...
function f() {
  ...
  let _ = Chunk73800.useMemo(() => {
    ...
    j = Chunk73800.useCallback(e => {
      ...
      return null == e || "" === e.value || t ? <div className={g.clydeIconContainer}><a.gw7 size={"sm"} color={"white"} aria-hidden={true} className={g.guildSelectOptionIcon} /></div> : <l.Z className={g.guildSelectOptionIcon} guild={p[e.value]} size={l.Z.Sizes.SMALLER} active={true} />
    }, [Chunk388032]);
  return <Chunk481060.VcW wrapperClassName={Chunk867198.searchableSelect} onChange={e => {
      t(e)
    }} value={module} options={_} renderOptionPrefix={j} />
}