...
function j(e, t, j) {
  ...
  return [_ ? (0, l.jsx)(o.sNh, {
    id: "remove",
    label: y.isForumPost() ? O.intl.formatToPlainString(O.t.v2KNNz, {
      user: e.username
  ...
  }) : null, (0, s.BK)(e, E) ? (0, l.jsx)(o.sNh, {
    id: "kick",
    label: _ ? O.intl.formatToPlainString(O.t["1Ie87u"], {
      user: e.username
    ...
    action: () => (0, o.ZDy)(async () => {
      ...
      return n => (0, l.jsx)(t, m(h({}, n), {
        guildId: E.id,
        user: e
      }))
    })
  }) : null, (0, s.mm)(e, E) ? (0, l.jsx)(o.sNh, {
    id: "ban",
    label: _ ? O.intl.formatToPlainString(O.t.i62APT, {
      user: e.username
