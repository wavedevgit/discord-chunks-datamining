...
function Q(e) {
  ...
  let {
  ...
  } = e, i = (0, u.wj)((0, w.ZP)()), d = (0, m.dQu)(c.Z.colors.INTERACTIVE_NORMAL).hex(), p = {
    border: "1px solid ".concat(d),
    background: "\n    linear-gradient(\n      150deg,\n      transparent 68%,\n      ".concat((0, A.aD)(d, .2), " 85%,\n      transparent 100%\n    ),\n    linear-gradient(\n      150deg,\n      transparent 13%,\n      ").concat((0, A.aD)(d, .6), " 44%,\n      transparent 76%\n    ),\n    ").concat(i ? "var(--black)" : "var(--white)", "\n    ")
  }, f = (null == (t = n.userStatus) ? true : t.claimedAt) != null || null != a, {
    header: g,
    subHeader: h
  } = function(e) {
    var t, n, r, a;
    ...
    } = e, i = (null == (t = o.userStatus) ? true : t.claimedAt) != null || null != s, c = l ? "" : q.intl.string(q.t.UUKbik), d = l ? (0, Z.o9)({
      quest: o,
      idx: null != (r = null == s ? true : s.tier) ? r : null == (n = o.userStatus) ? true : n.claimedTier
    }) : null, u = (0, Z.w8)(o.config), p = null != d && null != (a = d.messages.name) ? a : u, m = l ? q.intl.string(q.t.cfY4PE) : u;
    return {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      style: {
        "--custom-reward-tile-border-color": d
      },
      children: [y && !C && (0, r.jsx)(m.$jN, {
...
function H(e) {
  ...
  }), z = s.config.rewardsConfig.platforms, H = z.length > 1, [U, W] = a.useState(H ? null : z[0]), $ = a.useRef(new l.qA), F = a.useRef(null), [Y, G] = a.useState(null), V = (0, i.e7)([y.Z], () => y.Z.useReducedMotion), J = (0, i.e7)([O.Z], () => O.Z.hidePersonalInformation), {
  ...
  let ed = null;
  D && null != er ? ed = q.intl.string(q.t.srzsU2) : null != er ? ed = q.intl.string(q.t.PJBpda) : ea && (ed = q.intl.string(q.t.JRU8dq));
  ...
  ea && (ef = (0, r.jsx)(d.B6, {
    ...
    errorMessage: ec ? q.intl.string(q.t.rbZBMR) : true,
  ...
  let ew = a.useMemo(() => en ? (0, Z.o9)({
    ...
    ey = a.useMemo(() => (null == ew ? true : ew.redemptionLink) == null || "" === ew.redemptionLink ? null : (null == er ? true : er.code) == null || "" === er.code ? ew.redemptionLink : ew.redemptionLink.replace(L.Dp, encodeURIComponent(er.code)), [ew, er]),
    eb = (0, E.G$)({
      claimCode: eo,
      fetchCode: es,
      hasError: ec,
  ...
  ea ? eO = q.intl.string(q.t.SLZMi1) : !ea && ec ? eO = q.intl.string(q.t.gNJHHp) : ex && (eO = q.intl.string(q.t["+zx47d"]));
      ...
      children: (0, r.jsxs)(m.Y0X, {
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(m.olH, {
            ...
            children: [eu, ep, ef, eh, eC, null != s.config.cosponsorMetadata && null != eT && (0, r.jsxs)("div", {
