...
function y(e) {
  let {
    member: t
  } = e, n = (0, a.e7)([h.Z], () => h.Z.getGuild(t.guildId)), l = (0, a.e7)([p.Z], () => p.Z.getRoles(t.guildId)), y = i.useMemo(() => null == n ? [] : null == t.highestRoleId ? t.roles : Object.values(l).filter(e => e.id !== t.highestRoleId && t.roles.includes(e.id)).sort((e, t) => {
    var n, r;
    return null != (r = null != (n = null == e ? void 0 : e.position) ? n : 0 - (null == t ? void 0 : t.position)) ? r : 0
  }).map(e => e.id), [t.roles, t.highestRoleId, n, l]), C = (0, a.e7)([c.Z], () => c.Z.getEnhancedMember(t.guildId, t.userId), [t.guildId, t.userId]), x = (0, u.zq)(C), v = (0, u.vN)(t), j = (0, a.e7)([f.Z], () => f.Z.can(g.Plq.MANAGE_ROLES, n), [n]);
  return null == n ? null : (0, r.jsx)(s.xJW, {
    ...
    children: (0, r.jsx)(m.WM, {
      children: (0, r.jsx)(m._2, {
        description: t.roles.length > 0 || j ? (0, r.jsxs)("div", {
