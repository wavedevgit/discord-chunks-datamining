...
function $(e) {
  ...
  return (0, r.jsx)(l.u, {
    ...
    children: (0, r.jsxs)("div", {
      className: a()(F.iconContainer, n),
      children: [(0, r.jsx)(k.Z, {
        src: c,
        className: F.iconCard,
        "aria-hidden": true,
...
function ee(e) {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [A ? (0, r.jsxs)("div", {
      ...
      onMouseLeave: P,
      onBlur: P,
      className: a()(F.bannerImageContainer, {
        [F.mediumBanner]: "medium_banner" === n,
        [F.largeBanner]: "large_banner" === n
      }),
      ...
      className: a()(F.appDetailsContainer, {
      ...
      children: [(0, r.jsx)(k.Z, {
        ...
        className: F.appDetails,
        children: [(0, r.jsxs)("div", {
          className: F.appDetailsHeaderContainer,
          children: [(0, r.jsx)(c.Heading, {
            ...
            className: F.promotedLabelWrapperNonBanner,
...
function en(e) {
  ...
  let o = (0, E.fD)(t, i);
  return null == o ? null : (0, r.jsx)(l.u, {
    __unsupportedReactNodeAsText: o,
    children: (0, r.jsx)("img", {
      className: F.staffBadge,
      alt: o,
      src: V
    })
  })
...
function ei(e) {
  ...
  let d = a()(F.bannerImage, {
    [F.disableFadeIn]: o
  });
  return (0, r.jsxs)(r.Fragment, {
    children: [null != l && c ? (0, r.jsx)("div", {
      className: F.activityVideoContainer,
      children: (0, r.jsx)("div", {
        className: a()(F.activityVideo, {
          [F.videoFadeOut]: !n
        }),
...
function eo(e) {
  let {
    ...
    fallbackColor: n,
    disableFadeIn: i
  } = e, o = (0, s.e7)([p.Z], () => p.Z.useReducedMotion), l = (0, R.aN)({
    id: t.id,
    banner: t.banner,
    canAnimate: !o,
    size: 600
  });
  return null == l ? (0, r.jsx)(ea, {
    fallbackColor: n,
    disableFadeIn: i
  }) : (0, r.jsx)("img", {
    src: l,
...
function ec(e) {
  ...
  return y === E.JS.START || y === E.JS.JOIN ? l ? (0, r.jsx)(X, K(Y({}, d), {
    ...
    imageStyle: F.darkenImage,
    enableVideoBanner: false,
    disabled: true,
    children: (0, r.jsx)("div", {
      className: F.voiceLauncherAppCardContainer,
