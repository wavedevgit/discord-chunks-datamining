...
function P(e) {
  let {
    ...
    onClose: M,
    transitionState: U
  } = n, G = (0, p.Dt)(), V = L.length % 2 == 0, H = (0, o.e7)([c.Z], () => c.Z.useReducedMotion), [B, F] = i.useState(Date.now()), [z, W] = i.useState(0), [Y, K] = i.useState(0), [q, Q] = i.useState(!1), [X, J] = i.useState(!0), $ = i.useRef(B), ee = i.useRef(z), et = i.useRef(Y), en = i.useRef(q), er = i.useRef(X), [ei, el] = i.useState(S), ea = i.useRef(!1);
