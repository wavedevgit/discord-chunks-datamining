...
function P(e) {
  let {
    ...
    onClose: M,
    transitionState: U
  } = n, G = (0, p.Dt)(), V = L.length % 2 == 0, H = (0, o.e7)([c.Z], () => c.Z.useReducedMotion), [B, F] = i.useState(Date.now()), [z, W] = i.useState(0), [Y, K] = i.useState(0), [q, X] = i.useState(!1), [Q, J] = i.useState(!0), $ = i.useRef(B), ee = i.useRef(z), et = i.useRef(Y), en = i.useRef(q), er = i.useRef(Q), [ei, el] = i.useState(S), ea = i.useRef(!1);
      ...
      children: [(0, r.jsx)(s.X6q, {
        ...
        onPlay: e => {
          b.default.track(O.rMx.CHANGE_LOG_VIDEO_INTERACTED, {
            change_log_id: R
          }), F(Date.now()), X(!0), J(e.currentTarget.muted)
        },
        onEnded: e => {
