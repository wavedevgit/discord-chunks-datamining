...
function S(e) {
      ...
      if (t > 0) {
        ...
        return {
          badge: (0, r.jsx)(c.mAB, {
            ...
            className: o()(E.badgeTransition, E.grayBadge, {
              [E.selected]: n
            })
          }),
          dimensions: {
  ...
  }(I), T = P === b.jP.LEGACY ? c.xx7 : c.Dkj, A = (0, s.e7)([g.Z], () => g.Z.getChannelId()), R = i.useMemo(() => {
    if (P === b.jP.SIDEBAR) return C.Z5c.NOTIFICATIONS_INBOX(null != A ? A : void 0)
  }, [P, A]);
  return (0, r.jsxs)(h.H, {
    ref: m,
    children: [(0, r.jsx)(d.Z, {
      ...
      children: (0, r.jsx)(c.aRk, {
        ...
        lowerBadge: N,
        lowerBadgeSize: w,
        children: (0, r.jsx)(c.LYs, (t = function(e) {
