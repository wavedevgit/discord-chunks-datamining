...
function S(e) {
  ...
  let {
    ...
    popoutProps: x,
    ref: E
  } = e, P = (0, l.Ie)("notifications-inbox"), [I, w] = i.useState(!1), N = (0, y.D)(), Z = S || N, {
    anyUnread: T,
  ...
  }), L = (0, o.e7)([m.Z], () => m.Z.getChannelId()), M = i.useMemo(() => {
    if ("sidebar" === D) return C.Z5c.NOTIFICATIONS_INBOX(null != L ? L : void 0)
  }, [D, L]);
  return (0, r.jsxs)(u.H, {
    ref: E,
    children: ["sidebar" === D && (0, r.jsx)(c.Z, {
      selected: Z,
      hovered: I,
      unread: T,
      className: j.pill
...
function x() {
  ...
  return "sidebar" === t ? (0, r.jsx)(S, {}) : "popout" === t ? (0, r.jsx)(O.Z, {
    targetElementRef: e,
