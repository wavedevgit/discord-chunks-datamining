...
function R(e) {
  ...
  } = e, U = (0, o.Z)(R), [Z, B] = l.useState(!1), [G, J] = l.useState(A), [w, H] = l.useState(null), [z, K] = l.useState(d().shuffle(R)), [Y, X] = l.useState(""), Q = (0, E.Dt)(), V = (0, O.Z)(G), W = (0, O.Z)(Z), q = (0, O.Z)(w), ee = (0, O.Z)(y), et = (0, O.Z)(Y), en = null;
  return null == G ? en = "RATING" : G !== S.aZ.GOOD && null == w ? en = "PROBLEM" : null != w && I.includes(w.value) && (en = "FREEFORM"), l.useEffect(() => {
    ...
    children: [(0, a.jsxs)(u.xBx, {
      ...
      children: (0, a.jsx)(u.xJW, {
        title: h,
        className: r()(_.problemInfo, _.presetList, {
          [_.marginBottom16]: M
        }),
