...
function j(e) {
  ...
  } = e, M = (0, d.Z)(j), [B, $] = a.useState(!1), [w, G] = a.useState(C), [H, z] = a.useState(null), [K, J] = a.useState(u().shuffle(j)), [W, V] = a.useState(""), X = (0, O.Dt)(), Y = (0, f.Z)(w), q = (0, f.Z)(B), Q = (0, f.Z)(H), ee = (0, f.Z)(A), et = (0, f.Z)(W), en = null;
  return null == w ? en = "RATING" : w !== p.aZ.GOOD && null == H ? en = "PROBLEM" : null != H && y.includes(H.value) && (en = "FREEFORM"), a.useEffect(() => {
    u().isEqual(M, j) || J((0, x.Bi)(j, D))
  }, [j, M, D]), (0, o.ZP)(() => (h.default.track(m.rMx.OPEN_MODAL, {
    type: n,
    ...
    children: [(0, l.jsxs)(c.xBx, {
      ...
      children: (0, l.jsx)(c.xJW, {
        title: v,
        className: r()(S.problemInfo, S.presetList, {
          [S.marginBottom16]: k
        }),
