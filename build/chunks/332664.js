...
function j(e) {
  ...
  } = e, U = (0, d.Z)(j), [B, $] = a.useState(!1), [w, G] = a.useState(k), [H, z] = a.useState(null), [K, Y] = a.useState(u().shuffle(j)), [V, J] = a.useState(""), Q = (0, O.Dt)(), W = (0, f.Z)(w), X = (0, f.Z)(B), q = (0, f.Z)(H), ee = (0, f.Z)(A), et = (0, f.Z)(V), en = null;
  return null == w ? en = "RATING" : w !== x.aZ.GOOD && null == H ? en = "PROBLEM" : null != H && C.includes(H.value) && (en = "FREEFORM"), a.useEffect(() => {
    u().isEqual(U, j) || Y((0, p.Bi)(j, y))
  }, [j, U, y]), (0, c.ZP)(() => (v.default.track(m.rMx.OPEN_MODAL, {
    type: n,
