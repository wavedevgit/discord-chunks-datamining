...
function d(e) {
  var t, n, a = l(e),
    ...
    d = 0,
    _ = s > 0 ? o - 4 : o;
  for (n = 0; n < _; n += 4) t = r[e.charCodeAt(n)] << 18 | r[e.charCodeAt(n + 1)] << 12 | r[e.charCodeAt(n + 2)] << 6 | r[e.charCodeAt(n + 3)], c[d++] = t >> 16 & 255, c[d++] = t >> 8 & 255, c[d++] = 255 & t;
...
function f(e, t, n) {
  for (var r = [], i = t; i < n; i += 3) r.push(_((e[i] << 16 & 0xff0000) + (e[i + 1] << 8 & 65280) + (255 & e[i + 2])));
  return r.join("")
}

function p(e) {
  for (var t, r = e.length, i = r % 3, a = [], o = 16383, s = 0, l = r - i; s < l; s += o) a.push(f(e, s, s + o > l ? l : s + o));
