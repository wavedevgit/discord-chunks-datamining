...
let eg = (0, Chunk915089.Ld)(),
  em = (0, Chunk915089.Ld)(),
  ep = (0, Chunk915089.Ld)(),
  ef = (0, Chunk95701.createChannelRecord)({
    id: "1",
  ...
  ey = Chunk311907.Ay.connectStores([Chunk863036.A], () => {
    let {
      channel: e,
      submitting: t
    } = W.A.getProps();
    return {
      ...
      onSave() {
        ...
        e.isThread() && (t = (0, G.A)(t, true)), (0, b.RT)(e.id, {
          name: t,
          type: n,
          topic: l,
          bitrate: i,
          ...
          rateLimitPerUser: o,
          defaultThreadRateLimitPerUser: c,
          autoArchiveDuration: null == u ? true : u.autoArchiveDuration,
          locked: null == u ? true : u.locked,
          invitable: null == u ? true : u.invitable,
          defaultAutoArchiveDuration: d,
          template: h,
          rtcRegion: g,
          videoQualityMode: m,
...
class eO extends Chunk64700.PureComponent {
  ...
  getSlowmodeHelpText() {
    ...
    return (null == e ? true : e.isForumLikeChannel()) ? ea.intl.format(ea.t.EIQq9v, eA) : (null == e ? true : e.isThread()) ? ea.intl.format(ea.t["8sTC8t"], eA) : ea.intl.format(ea.t.wW2MWu, eA)
  }
  getCooldownSliderMarker(e) {
    return (0, $.$)(e, true)
  }
  getAutoArchiveDurationSliderMarker(e) {
    return (0, $.$)(e * q.A.Seconds.MINUTE, true)
  }
  renderChannelInfo(e, t) {
    ...
    let g, m, {
      ...
      w = T && (null == (o = e.availableTags) ? true : o.every(e => e.moderated)),
      M = (null == (h = z.default.getCurrentUser()) ? true : h.isStaff()) === true,
      ...
      ec = V.xR.has(e.type) && null != y && y.features.has(el.GuildFeatures.NEWS) && e.id !== (null == y ? true : y.rulesChannelId) && e.id !== (null == y ? true : y.publicUpdatesChannelId) ? (0, l.jsxs)(f.BJc, {
        gap: 4,
        children: [(0, l.jsx)(f.dOG, {
      ...
      eb = this.props.showChannelSummariesSettings ? (0, l.jsx)(f.dOG, {
        ...
        checked: !e.hasFlag(ei.lx.SUMMARIES_DISABLED) && (null == y ? true : y.features.has(el.GuildFeatures.SUMMARIES_ENABLED_BY_USER)),
        disabled: !p || !(null == y ? true : y.features.has(el.GuildFeatures.SUMMARIES_ENABLED_BY_USER))
      }) : null,
  ...
  constructor(e) {
    ...
    super(e), eu(this, "defaultReactionButtonRef", i.createRef()), eu(this, "nameInputRef", i.createRef()), eu(this, "cursorPosition", 0), eu(this, "renderEmojiPicker", e => {
      ...
      if (null == l) return;
      l.isThread() ? e = (0, G.A)(e, false) : el.kvI.LIMITED_CHANNEL_NAME.has(l.type) && (e = (0, Q.an)(e));
...
function eC() {
  let {
    ...
    var e;
    return J.A.getRegions(null != (e = null == t ? true : t.getGuildId()) ? e : null)
  }), a = (0, g.bG)([U.A], () => U.A.theme), o = (0, g.bG)([Y.A], () => Y.A.getGuild(null == t ? true : t.getGuildId())), c = (0, k.NI)(t), u = (0, k.H_)(t), {
    canManageChannels: d,
    canSendMessages: h
  } = (0, g.cf)([Z.A], () => ({
    canManageChannels: Z.A.can(el.xBc.MANAGE_CHANNELS, t),
    canSendMessages: Z.A.can(el.xBc.SEND_MESSAGES, t)
  })), m = (0, O.Ay)(t), p = F.default.getId(), f = (0, I.p)(), b = null == t ? true : t.id, x = (0, y.cI)(t, false, true), j = A.A.useExperiment({
  ...
  return (0, l.jsx)(eO, {
    ...
    theme: a,
    guild: o,
    canManageChannels: (null == t ? true : t.isThread()) ? c : d,
    canSendMessages: h,
    isThreadModerator: u,
    canManageThread: c,
    subsection: r,
