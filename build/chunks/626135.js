...
function H(e) {
  ...
  a.client_performance_cpu = f.Z.getCurrentCPUUsagePercent(), a.client_performance_memory = f.Z.getCurrentMemoryUsageKB(), a.cpu_core_count = f.Z.getCPUCoreCount(), a.accessibility_features = B(), a.rendered_locale = m.intl.currentLocale, a.uptime_app = Math.floor((performance.now() - x) / 1e3);
