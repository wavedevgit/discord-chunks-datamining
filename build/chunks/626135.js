...
function H(e) {
  ...
  o.client_performance_cpu = f.Z.getCurrentCPUUsagePercent(), o.client_performance_memory = f.Z.getCurrentMemoryUsageKB(), o.cpu_core_count = f.Z.getCPUCoreCount(), o.accessibility_features = B(), o.rendered_locale = m.intl.currentLocale, o.uptime_app = Math.floor((performance.now() - x) / 1e3);
