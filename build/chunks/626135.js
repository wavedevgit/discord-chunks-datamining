...
let j = {
  ...
  [p.rMx.ACK_MESSAGES]: e => e.location_object_type === p.Qqv.ACK_MANUAL ? void 0 : {
    throttlePeriod: P,
...
function H(e) {
  ...
  a.client_performance_cpu = _.Z.getCurrentCPUUsagePercent(), a.client_performance_memory = _.Z.getCurrentMemoryUsageKB(), a.cpu_core_count = _.Z.getCPUCoreCount(), a.accessibility_features = B(), a.rendered_locale = m.intl.currentLocale, a.uptime_app = Math.floor((performance.now() - x) / 1e3);
