...
function j(e) {
  let {
    ...
    onClose: l,
    searchContext: a
  } = e, i = (0, d.Dt)(), F = r.useMemo(() => (0, p.s5)(a), [a]), j = (0, s.e7)([h.Z, x.Z], () => {
    let e = h.Z.getChannel(x.Z.getChannelId());
    return null != e ? (0, p.nl)(e) : "general"
  }), T = (0, C.I)(a), {
    searchFilters: E
  } = (0, m.hE)(T), I = r.useMemo(() => (0, p.nI)(T), [T]), O = r.useMemo(() => [...E[b.dCx.FILTER_BEFORE], ...E[b.dCx.FILTER_AFTER], ...E[b.dCx.FILTER_ON]], [E]), {
    options: R,
    query: N,
    setQuery: k,
    setQueryString: L,
  ...
  } = (0, m.HJ)(a, b.dCx.FILTER_MENTIONS, E[b.dCx.FILTER_MENTIONS]), H = (0, m.Zc)(F), Z = (0, p.R6)(a), {
    options: z,
    query: J,
    setQuery: W,
    handleClearFilter: K,
  ...
  } = (0, m.ur)(a, E[b.dCx.FILTER_IN]), et = r.useCallback(e => {
    if (null == e) return;
  ...
  } = (0, m.fI)(O), ed = r.useMemo(() => N.length + M.length + J.length + V.length + er.length, [N, M, J, V, er]), eh = r.useCallback(() => {
  ...
  }, [eu, D, Y, ee, B, I, ed, l]), ex = r.useCallback(() => {
    P(), w(), K(), $(), ec()
  }, [P, w, K, $, ec]);
