...
function m(e) {
  ...
  return (0, n.jsxs)("div", {
    ...
    children: [(0, n.jsx)(d.P, {
      ...
      "aria-label": _.intl.formatToPlainString(_.t["2LwBlF"], {
        filterNumber: t + 1
      }),
...
function v(e) {
  ...
  } = (0, E.zL)(i, N[f.dCx.FILTER_PINNED]), eA = r.useMemo(() => {
    let e = 0;
    return j && H.length > 0 && (e += H.length), M && Z.length > 0 && (e += Z.length), A && eo.length > 0 && (e += eo.length), et.length > 0 && (e += et.length), eC.length > 0 && (e += eC.length), P && eR.length > 0 && (e += eR.length), null !== eN && (e += 1), e
  }, [j, H, M, Z, A, eo, et, eC, P, eR, eN]), eP = r.useMemo(() => {
  ...
  }), eD = r.useMemo(() => !((!j || (0, E.Ek)(H, N[f.dCx.FILTER_FROM])) && (!M || (0, E.Ek)(Z, N[f.dCx.FILTER_MENTIONS])) && (!A || (0, E.Ek)(eo, N[f.dCx.FILTER_IN])) && (0, E.Ek)(et, N[f.dCx.FILTER_HAS]) && (0, E.LE)(eC, N.dateFilters) && (!P || (0, E.Ek)(eR, N[f.dCx.FILTER_AUTHOR_TYPE])) && (0, E.Ek)(eN, N[f.dCx.FILTER_PINNED])), [j, H, N, M, Z, A, eo, et, eC, P, eR, eN]), eH = r.useCallback(() => {
  ...
  return (0, n.jsxs)(o.Modal, {
    ...
    children: [j && (0, n.jsx)(L, {
      label: _.intl.string(_.t.Qz6eOR),
      sublabel: _.intl.string(_.t["2JyXnO"]),
      textPlaceholder: _.intl.formatToPlainString(_.t["V4WMj/"], {
        username: d
      }),
      value: H,
      onChange: B,
      ...
      textPlaceholder: _.intl.formatToPlainString(_.t.K4l507, {
        channelName: u
      }),
      value: eo,
      onChange: es,
