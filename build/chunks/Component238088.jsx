...
function f(e) {
  ...
  return (0, n.jsxs)("div", {
    ...
    children: [(0, n.jsx)(c.q4e, {
      ...
      "aria-label": F.intl.formatToPlainString(F.t["2LwBlJ"], {
        filterNumber: t + 1
      }),
...
function I(e) {
  let {
    ...
    onClose: l,
    searchContext: a
  } = e, i = (0, d.Dt)(), f = r.useMemo(() => (0, C.s5)(a), [a]), I = (0, s.e7)([h.Z, x.Z], () => {
    let e = h.Z.getChannel(x.Z.getChannelId());
    return null != e ? (0, C.nl)(e) : "general"
  }), T = (0, p.I)(a), {
    searchFilters: v
  } = (0, m.hE)(T), R = r.useMemo(() => (0, C.nI)(T), [T]), j = r.useMemo(() => [...v[b.dCx.FILTER_BEFORE], ...v[b.dCx.FILTER_AFTER], ...v[b.dCx.FILTER_ON]], [v]), {
    options: N,
    query: O,
    setQuery: k,
    setQueryString: L,
  ...
  } = (0, m.HJ)(a, b.dCx.FILTER_MENTIONS, v[b.dCx.FILTER_MENTIONS]), H = (0, m.Zc)(f), Z = (0, C.R6)(a), {
    options: z,
    query: J,
    setQuery: W,
    handleClearFilter: K,
  ...
  } = (0, m.ur)(a, v[b.dCx.FILTER_IN]), et = r.useCallback(e => {
    if (null == e) return;
  ...
  } = (0, m.fI)(j), ed = r.useMemo(() => O.length + Q.length + J.length + V.length + er.length, [O, Q, J, V, er]), eh = r.useMemo(() => !(0, m.Ek)(O, v[b.dCx.FILTER_FROM]) || !(0, m.Ek)(Q, v[b.dCx.FILTER_MENTIONS]) || !(0, m.Ek)(V, v[b.dCx.FILTER_IN]) || !(0, m.Ek)(J, v[b.dCx.FILTER_HAS]) || !(0, m.LE)(er, j), [O, v, Q, J, V, er, j]), ex = r.useCallback(() => {
  ...
  }, [eu, P, Y, ee, B, R, l]), eg = r.useCallback(() => {
    M(), w(), K(), $(), ec()
  }, [M, w, K, $, ec]);
  return (0, n.jsxs)(o.Modal, {
    ...
    children: [(0, n.jsx)(_, y({
      ...
      textPlaceholder: F.intl.formatToPlainString(F.t.K4l509, {
        channelName: I
      }),
      value: V,
      onChange: X,
