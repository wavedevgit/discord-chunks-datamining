...
function T(e) {
  ...
  let a = i ? P.intl.formatToPlainString(P.t.uqZgYW, {
      guildName: n.name
    }) : P.intl.formatToPlainString(P.t.velJeX, {
      guildName: n.name
    }),
...
function B(e) {
  let {
    guildId: n,
    selectedSection: t
  } = e, i = (0, o.e7)([v.Z], () => v.Z.getGuild(n)), s = (0, O.Z)(i), [u, m] = r.useState(null != t ? t : N.l7.CUSTOMIZE);
  r.useEffect(() => {
    null != t && m(t)
  }, [t]);
    ...
    children: [(0, l.jsxs)("div", {
      ...
      children: [(0, l.jsx)(T, {
        ...
        children: [s && (0, l.jsxs)(d.njP, {
          ...
          }, N.l7.CUSTOMIZE), (0, l.jsxs)(d.njP.Item, {
            className: E.tabBarItem,
            id: N.l7.BROWSE,
            "aria-label": P.intl.string(P.t.et6wam),
            children: [P.intl.string(P.t.et6wam), (0, l.jsx)(d.IGR, {
