...
function v(e) {
  ...
  return n.has(m.q.AUTOMOD_QUARANTINED_USERNAME_OR_GUILD_NICKNAME) || n.has(m.q.AUTOMOD_QUARANTINED_BIO) ? (0, r.jsx)(_, {
    guild: t
  }) : n.has(m.q.AUTOMOD_QUARANTINED_SERVER_TAG) ? (0, r.jsx)(C, {
    guild: t
  }) : (0, r.jsx)(_, {
    guild: t
  })
