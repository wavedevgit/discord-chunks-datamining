...
function T(e) {
  ...
  let {
    ...
    null != l.current && (0 === X ? (es(Z), W(!1), ea(S.id, Z)) : (V(X), es(0), W(!0), ea(S.id, 0)))
  }, [l, X, es, Z, W, ea, S.id, V]), eu = () => {
    ee(!0)
  }, ed = () => {
    ee(!1)
  }, em = o.useCallback(e => {
