...
function j(e) {
  let {
    current: t,
    duration: n
  } = e, l = null != t ? (0, E.yv)(t) : h, o = null != n ? (0, E.yv)(n) : h;
...
function _(e) {
  ...
  let {
    ...
    onVolumeChange: R
  } = e, M = (0, f.km)(e => e.volume), V = (0, f.km)(e => e.setVolume), B = (0, f.km)(e => e.muted), F = (0, f.km)(e => e.setMuted), Z = (0, f.km)(e => e.transcriptEnabled), q = (0, f.km)(e => e.captionEnabled), U = (0, f.km)(e => e.fullScreenEnabled), Q = (0, s.e7)([m.Z], () => m.Z.useReducedMotion), G = (0, s.e7)([m.Z], () => m.Z.keyboardModeEnabled), [Y, z] = l.useState(B ? 0 : M), [H, X] = l.useState(!1), [W, K] = l.useState(!1), [{
    volumeAnimSpring: $
  }, J] = (0, d.q_F)(() => ({
    from: {
      volumeAnimSpring: 0
  ...
  l.useEffect(() => {
    ...
    $.stop()
  }), [W, H, J, Q, $]), l.useEffect(() => (window.addEventListener("keydown", eo), () => {
    window.removeEventListener("keydown", eo)
  }), [eo]);
  let ei = 0 === Y ? d.OyP : Y < .5 ? d.X2j : d.gj8,
    {
      icon: ea,
      label: es
    } = S[E];
