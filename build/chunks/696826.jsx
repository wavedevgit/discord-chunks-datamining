...
function A(e, t, n) {
  ...
  return <mask id={n}>{<a.animated.rect x={s} y={o} width={c} height={l} rx={i} ry={i} fill={"white"} />}{<a.animated.rect x={u} y={d} width={f} height={_} rx={p} ry={p} fill={"black"} />}{<a.animated.polygon points={S(t)} fill={"black"} transform={h} style={{
        transformOrigin: m
      }} />}{<a.animated.circle fill={"black"} cx={E} cy={g} r={b} />}</mask>
}
