...
function m(e) {
  ...
  return null == n || null == S ? null : <_.O3><a.mzw align={c.Z.Align.CENTER} data-migration-pending={true}><div className={f.promotionalFooter}>{<a.Xo$ aria-label={null == h ? true : h.username} size={g} src={null == h ? true : h.getAvatarURL(true, (0, a.pxk)(g), !j)} avatarDecoration={b} />}{<o.zx variant={"primary"} text={S.collectRewardButtonText()} onClick={() => {
            r(), (0, d.Z)({
              product: n,
