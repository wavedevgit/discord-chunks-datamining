/** Chunk was on web.js **/ ! function(e, r) {
  ...
  var H = function(e, t) {
    ...
    W = function(e) {
      ...
      t.useEffect(function() {
        var e = !0;
        return "async" !== a.tag || d.stripe ? "sync" === a.tag && a.stripe && !p.current && (p.current = !0, a.stripe.initCustomCheckout(r).then(function(e) {
      ...
      var r = "".concat(X(e), "Element"),
        i = function(n) {
          var i, a = n.id,
            ...
            D = t.useRef(null),
            L = t.useRef(null);
          v(P, "blur", u), v(P, "focus", d), v(P, "escape", p), v(P, "click", h), v(P, "loaderror", m), v(P, "loaderstart", g), v(P, "networkschange", E), v(P, "confirm", b), v(P, "cancel", y), v(P, "shippingaddresschange", O), v(P, "shippingratechange", T), v(P, "change", _), f && (i = "expressCheckout" === e ? f : function() {
            f(P)
