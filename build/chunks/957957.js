      ...
      var r = "".concat(Q(e), "Element"),
        i = function(n) {
          var i, a = n.id,
            ...
            D = t.useRef(null),
            L = t.useRef(null);
          v(R, "blur", u), v(R, "focus", d), v(R, "escape", p), v(R, "click", h), v(R, "loaderror", m), v(R, "loaderstart", g), v(R, "networkschange", E), v(R, "confirm", b), v(R, "cancel", y), v(R, "shippingaddresschange", O), v(R, "shippingratechange", S), v(R, "change", _), f && (i = "expressCheckout" === e ? f : function() {
            f(R)
