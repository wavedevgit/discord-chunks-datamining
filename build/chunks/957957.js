      ...
      var r = "".concat(X(e), "Element"),
        i = function(n) {
          var i, a = n.id,
            ...
            D = t.useRef(null),
            L = t.useRef(null);
          v(P, "blur", u), v(P, "focus", d), v(P, "escape", p), v(P, "click", h), v(P, "loaderror", m), v(P, "loaderstart", g), v(P, "networkschange", E), v(P, "confirm", b), v(P, "cancel", y), v(P, "shippingaddresschange", O), v(P, "shippingratechange", T), v(P, "change", f), _ && (i = "expressCheckout" === e ? _ : function() {
            _(P)
