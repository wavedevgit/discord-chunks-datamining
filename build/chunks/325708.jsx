...
function g(e) {
  ...
  return <div onMouseDown={s} className={p.resizeHandle} />
}
...
function E(e) {
  ...
  return <r.Fragment>{!T && <div style={{
        minWidth: N
      }} />}{<C><div className={a()(p.chatLayerWrapper, {
          [p.hidden]: false
        })}>{<div className={a()(p.chatTarget, {
            [p.floating]: T,
            [p.notFloating]: !T
          })} style={{
            width: N
          }} />}{!T && <g minWidth={I} maxWidth={n} resizableNode={E} onResize={O} onResizeEnd={v} />}{<div ref={E} className={a()(p.container, {
            [p.floating]: T
          })} style={{
            width: A
          }}>{d}</div>}</div></C>}</r.Fragment>
}