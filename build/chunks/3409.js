...
function eA(e) {
  ...
  let [s, c] = i.useState(() => ({
    ...
    token: null
  })), [I, T, S, A, N] = (0, l.Wu)([x.Z], () => [x.Z.braintreeEmail, x.Z.braintreeNonce, x.Z.error, x.Z.venmoUsername, x.Z.adyenPaymentData]), [C, R] = (0, l.Wu)([M.Z], () => [M.Z.error, M.Z.isAwaitingAuthentication]);
  i.useEffect(() => {
    let e = e => {
      let {
        billingAddress: t
  ...
  let [P, w] = i.useState(!1), [D, L] = i.useState(!1), [U, G] = i.useState(null), B = i.useRef(null), V = (0, l.e7)([M.Z], () => M.Z.isAwaitingAuthentication), [Z, W] = (0, l.Wu)([j.Z], () => [j.Z.purchaseTokenAuthState, j.Z.purchaseTokenHash]);
  return i.useEffect(() => {
