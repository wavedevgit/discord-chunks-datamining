...
function eP(e) {
  ...
  let [eZ, eH] = i.useState(g), [eY, eW] = i.useState(null), [eK, ez] = i.useState(eF(g)), eq = (0, l.e7)([M.Z], () => M.Z.redirectedPaymentSourceId), eX = (0, l.e7)([z.Z], () => z.Z.cashAppPayComponent), eQ = {
    completeSteps: tm,
  ...
  let {
    ...
    setP24BankState: td,
    selectedSkuId: tf
  } = m, t_ = null != tf ? tf : "", tp = (0, l.e7)([B.Z], () => B.Z.get(t_), [t_]), th = null == tp || null == (t = tp.eligiblePaymentGateways) ? void 0 : t.map(e => e.valueOf());
  ...
  switch (eZ) {
    ...
    case C.h8.PAYMENT_ELEMENT:
      ...
      tN.shouldRender = !0, tN.stripePaymentElementProps = {
        onChange: e => {
        ...
        switch (t) {
          ...
          case X.He.CASH_APP:
            try {
              ...
              let {
                paymentSource: e
              } = await (0, d.Dk)(e7.info, t, H, to, ea);
