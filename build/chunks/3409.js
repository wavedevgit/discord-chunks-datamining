...
function ew(e) {
  ...
  let [P, w] = i.useState(!1), [D, L] = i.useState(!1), [x, M] = i.useState(null), B = i.useRef(null), Z = (0, l.e7)([j.Z], () => j.Z.isAwaitingAuthentication), [F, V] = (0, l.Wu)([G.Z], () => [G.Z.purchaseTokenAuthState, G.Z.purchaseTokenHash]);
  return i.useEffect(() => {
