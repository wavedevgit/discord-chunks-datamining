...
function A(e) {
  ...
  let {
    onDismiss: P
  } = e, f = (0, l.e7)([d.Z], () => d.Z.getGuildId()), C = (0, l.e7)([E.Z], () => null != f ? E.Z.getChannelId(f) : null, [f]), D = null != f ? f : null, g = (0, l.e7)([u.Z], () => null != D ? u.Z.getGuild(D) : null, [D]), {
    shouldShowIncidentActions: m,
    incidentData: y,
    isUnderLockdown: h
  } = (0, I.mI)(D), U = (0, s.n2)(null != (t = null == g ? void 0 : g.id) ? t : T.lds), b = i.useCallback(() => null != g && (0, c._X)(g.id), [g]);
  if (null == g || null == y || !m) return null;
  let M = e => {
      if (e && U && C !== S.oC.MEMBER_SAFETY && b()) return void _.default.track(T.rMx.APP_NOTICE_PRIMARY_CTA_OPENED, {
