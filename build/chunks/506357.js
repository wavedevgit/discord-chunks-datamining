...
function S(e) {
  ...
  let {
    onDismiss: I
  } = e, S = (0, a.e7)([f.Z], () => f.Z.getGuildId()), A = (0, a.e7)([d.Z], () => null != S ? d.Z.getChannelId(S) : null, [S]), N = null != S ? S : null, C = (0, a.e7)([u.Z], () => null != N ? u.Z.getGuild(N) : null, [N]), {
    shouldShowIncidentActions: w,
    incidentData: R,
    isUnderLockdown: P
  } = (0, p.mI)(N), D = (0, l.n2)(null != (t = null == C ? void 0 : C.id) ? t : g.lds), L = i.useCallback(() => null != C && (0, c._X)(C.id), [C]);
  ...
  let x = e => {
    ...
    j = (0, m.OY)(R, C.name);
  if (null != (null != (O = R.dmsDisabledUntil) ? O : R.invitesDisabledUntil) && P) return (0, r.jsxs)(o.qXd, {
    className: y.notice,
    color: o.DM8.NEUTRAL,
  ...
  let M = (0, m.CG)(R) ? b.intl.formatToPlainString(b.t.tZTx2N, {
      guildName: C.name
    }) : (0, m.kk)(R) ? b.intl.formatToPlainString(b.t["1bSmxs"], {
      guildName: C.name
