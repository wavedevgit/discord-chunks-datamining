...
function A(e) {
  ...
  let {
    ...
    incidentData: g,
    isUnderLockdown: h
  } = (0, O.mI)(f), U = (0, s.n2)(null != (t = null == m ? void 0 : m.id) ? t : N.lds), b = i.useCallback(() => null != m && (0, c._X)(m.id), [m]);
  ...
  let M = e => {
    ...
    Z = (0, T.OY)(g, m.name);
  if (null != (null != (A = g.dmsDisabledUntil) ? A : g.invitesDisabledUntil) && h) return (0, r.jsxs)(o.qXd, {
    className: R.notice,
    color: o.DM8.NEUTRAL,
