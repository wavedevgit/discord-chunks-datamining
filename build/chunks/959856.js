...
class N extends l.Z {
  ...
  constructor() {
    super(), S(this, "Video", v.Z), S(this, "Camera", O.Z), S(this, "_audioContext", null), S(this, "outputVolume", I.Qx), S(this, "sourceId", I.w5), S(this, "sinkId", I.w5), S(this, "enabled", !1), S(this, "connections", new Set), S(this, "interacted", !1), S(this, "loopback", null), S(this, "voiceActivityInput", null), S(this, "pendingDesktopInputs", {}), S(this, "enablePromise", null), S(this, "handleActiveSinksChange", (e, t) => {
    ...
    }), S(this, "handleDeviceChange", () => (0, E.PW)().then(e => {
      let [t, n, r] = e;
    ...
    }), this.on("newListener", this.handleNewListener), this.on("removeListener", this.handleRemoveListener), (0, p.px)(this.handleActiveSinksChange), (0, f.Z)(this)
  }
}