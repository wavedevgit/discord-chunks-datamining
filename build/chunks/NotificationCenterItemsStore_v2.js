...
function G(e) {
  ...
  r !== h.OGo.FRIEND || null == t.user || o || (y.notifCenterLocalItems = y.notifCenterLocalItems.map(e => M(e, _.O7.INCOMING_FRIEND_REQUESTS, t.user.id) ? b(g({}, e), {
    acked: true,
    forceUnacked: false,
    local_id: "incoming_friend_requests_accepted_".concat(a.id, "_").concat(e.id),
    type: _.O7.INCOMING_FRIEND_REQUESTS_ACCEPTED
  }) : e)), (r === h.OGo.BLOCKED || o) && (y.notifCenterLocalItems = y.notifCenterLocalItems.filter(e => !M(e, _.O7.INCOMING_FRIEND_REQUESTS, n) && !M(e, _.O7.INCOMING_FRIEND_REQUESTS_ACCEPTED, n) && !M(e, _.O7.INCOMING_GAME_FRIEND_REQUESTS, n) && !M(e, _.O7.INCOMING_GAME_FRIEND_REQUESTS_ACCEPTED, n)))
}
