...
let O = [c.h8.PAYMENT_ELEMENT],
  v = i.memo(function(e) {
    ...
    } = e, s = b(e, ["wallets", "options", "originalPaymentType"]);
    let l = i.useMemo(() => {
      if (null == o || !(0, f.qH)(o)) return;
      let e = (0, u.rI)();
      return (0, f.Ko)(o) ? [(0, f.ZK)(o, e)] : [f.zK[o]]
    }, [o]);
    return (0, r.jsx)(a.PaymentElement, m({
      id: "stripe-payment-element",
      options: m(E(m({}, null != l && {
  ...
  I = i.memo(function(e) {
    ...
    } = e, i = b(e, ["options", "renderWithoutElement"]);
    let o = (0, r.jsx)(a.AddressElement, m({
      options: m({
        mode: "billing"
      }, t)
    }, i));
