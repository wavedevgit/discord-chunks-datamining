...
let I = [c.h8.PAYMENT_ELEMENT],
  T = i.memo(function(e) {
    var {
      ...
      options: s,
      onChange: l
    } = e, c = O(e, ["originalPaymentType", "wallets", "analyticsContext", "options", "onChange"]);
    let f = i.useMemo(() => {
      ...
      h = i.useCallback(e => {
        if (null != l && l(e), null != o) {
          let {
            ...
            activitySessionId: n,
            analyticsData: r
          } = o, i = (0, _.hR)(e.value.type), a = null != i ? _.Ho[i] : e.value.type;
    ...
    return (0, r.jsx)(a.PaymentElement, E({
      id: "stripe-payment-element",
      options: E(y(E({}, null != f && {
  ...
  S = i.memo(function(e) {
    ...
    } = e, i = O(e, ["options", "renderWithoutElement"]);
    let o = (0, r.jsx)(a.AddressElement, E({
      options: E({
        mode: "billing"
      }, t)
    }, i));
