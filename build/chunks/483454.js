...
let v = e => ({
  ...
  T = i.memo(function(e) {
    var {
      enforcePaymentMethodTypes: t,
      wallets: n = [],
      options: i
    } = e, o = y(e, ["enforcePaymentMethodTypes", "wallets", "options"]);
    let s = (0, a.useElements)();
    return (0, d.ZP)(() => {
      null != s && null != t && s.update({
        paymentMethodTypes: t
      })
    }), (0, r.jsx)(a.PaymentElement, g({
  ...
  S = i.memo(function(e) {
    ...
    } = e, i = y(e, ["options", "renderWithoutElement"]);
    let o = (0, r.jsx)(a.AddressElement, g({
      options: g({
        mode: "billing"
      }, t)
    }, i));
  ...
  A = e => {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)("div", {
        className: s()(l ? h.visible : h.hidden, {
          [h.cardElementContainer]: t === f.h8.CREDIT_CARD_INFORMATION
        }),
        children: i && (0, r.jsx)(T, g({}, a))
      }), (0, r.jsx)("div", {
        className: s()(h.addressElementContainer, c ? h.visible : h.hidden),
        children: (0, r.jsx)(S, b(g({}, o), {
