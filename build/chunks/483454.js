...
let T = e => ({
    enabled: p.Z.getCurrentConfig(e).enabled
  }),
  S = e => {
    let {
      shouldGenerateSetupIntent: t
    } = e, [n, r] = i.useState(null), a = i.useCallback(async () => {
      t && r(await (0, u.R5)())
    }, [t]);
    (0, d.ZP)(() => {
      a()
  ...
  D = i.memo(function(e) {
    var {
      ...
      customPaymentMethods: n,
      wallets: o = [],
      options: s,
      originalPaymentType: l
    } = e, c = v(e, ["paymentMethodTypes", "customPaymentMethods", "wallets", "options", "originalPaymentType"]);
    let u = (0, a.useElements)(),
      d = i.useRef(!1);
    i.useEffect(() => {
      if (null != u && !d.current) {
        let e = b({
          customPaymentMethods: null != n ? n : P()
        }, null != t && {
          paymentMethodTypes: t
        });
    ...
    return (0, r.jsx)(a.PaymentElement, b({
      id: "stripe-payment-element",
      options: b(O(b({}, null != f && {
  ...
  L = i.memo(function(e) {
    ...
    } = e, i = v(e, ["options", "renderWithoutElement"]);
    let o = (0, r.jsx)(a.AddressElement, b({
      options: b({
        mode: "billing"
      }, t)
    }, i));
    return n ? o : (0, r.jsx)(a.Elements, {
      stripe: (0, _.d2)(),
      children: o
    })
  }),
  ...
  k = e => {
    let {
      step: t,
      stripePaymentElementProps: n,
      stripeAddressElementProps: o,
      elementsRef: l,
      originalPaymentType: c,
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [null != u && (0, r.jsx)("div", {
        className: s()(_ ? g.visible : g.hidden, {
          [g.cardElementContainer]: t === f.h8.CREDIT_CARD_INFORMATION
        }),
        children: (0, r.jsx)(D, O(b({}, n), {
          originalPaymentType: c
        }))
      }), (0, r.jsx)("div", {
        className: s()(g.addressElementContainer, p ? g.visible : g.hidden),
        children: (0, r.jsx)(L, O(b({}, o), {
