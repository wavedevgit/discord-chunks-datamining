...
let eo = (0, Chunk624138.Mg)(Chunk477690.Z.EMOJI_PICKER_CONSTANTS_EMOJI_CONTAINER_PADDING_HORIZONTAL),
...
let eu = (e, t) => {
  ...
  eE = function(e, t) {
    ...
    let s, {
      ...
      eV = i.useRef(null);
    null == c && null != ek && (c = ek);
    let eH = null != (o = null != (n = null == c ? true : c.getGuildId()) ? n : f) ? o : null,
    ...
    })), e5 = (0, U.DV)(eB, c, l, eP), e4 = null == e5 ? 0 : e5.locked.length + e5.unlocked.length, e6 = D.d4.useSetting(), e8 = i.useMemo(() => new Set(e6), [e6]), e7 = i.useCallback(e => {
    ...
    ef(eu, eF), e_(eu, e3, eV, ex), i.useEffect(() => {
      eE || (0, S.ql)("")
      ...
      if ("" === eG.current && "" !== eB && (0, U.PC)(e1, l), 0 === e4 && "" !== eB) eh(e1, eB);
      else if ("" !== eB && eG.current !== eB) {
        var e;
        em(e4, null != (e = null == e5 ? true : e5.locked.length) ? e : 0, e1, eB, l)
      }
      eG.current = eB
    }, [eB, e1, e4, e5, l]);
    ...
    if ((null == ej ? true : ej.type) === Y.Bg.PREMIUM) {
      let e = w.p.NONE;
      2 === j ? e = w.p.PARENT_CONTAINER : 1 === j && (e = w.p.TAB_PARENT_CONTAINER), s = <q.Z onLearnMore={ts} emojiDescriptor={ej.emojiDescriptor} pickerIntention={l} analyticsLocation={e1} onClose={() => eU(null)} channel={c} containerContext={e} />
    } else(null == ej ? true : ej.type) === Y.Bg.ROLE_SUBSCRIPTION ? s = <C.Z onClose={() => eU(null)} guildId={ej.guildId} emojiId={ej.emojiId} /> : eY && !ez && (s = <Z.Z onDismiss={() => eW(false)} />);
    let th = (e, t) => {
        ta(e, ei(en({}, t), {
          isBurst: eY
        }))
      ...
      tg = <H.Z channel={c} pickerIntention={l} emojiListRef={eF} onKeyDown={e => {
          null == td || td(e), null == eL || eL(e)
        }} searchBarRef={eV} onFocus={eD} autoFocus={ex} accessory={eM} headerClassName={ey} diversitySurrogate={e3} isBurstReaction={eY} onBurstReactionToggle={tm} renderHeader={eA} showAddEmojiButton={ew} />,
      tE = [];
    ...
    let tb = <h.Z{...ei(en({}, e1), {
      children: (0, r.jsxs)(t_, {
        ...
        children: [R ? null : tg, (0, r.jsxs)("div", {
          ...
          className: a()(ee.categoryList, eC),
          emojiListRef: eF,
          sectionDescriptors: tt,
          intention: l,
          channel: c,
