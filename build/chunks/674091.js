...
}(0, function(e, t, r, i, o, a, s, l, c, u, d, f, _, p, h, m, g, E, b, y, v, O, I, S, T, N, A, C, P, R, w, D, L, x, M, k, j, U, G, B, V, F, Z, H, W, Y, K, z, q, Q, X, J, $, ee, et, en, er, ei, eo, ea, es, el, ec) {
  "use strict";
        ...
        return tl(t_(e = t.call.apply(t, [this].concat(i))), "state", {
          ...
          for (var t = tL(e.props.minDate), n = tL(e.props.maxDate), r = []; !e4.default(t, n);) {
            ...
            r.push(ed.default.createElement("option", {
              key: i,
              value: i
            }, tN(t, e.props.dateFormat, e.props.locale))), t = ey.default(t, 1)
          }
          return r
        }), tl(t_(e), "onSelectChange", function(t) {
          e.onChange(t.target.value)
      ...
      function n() {
        ...
        return tl(t_(e = t.call.apply(t, [this].concat(i))), "state", {
          ...
          for (var t = [], n = e.props.format ? e.props.format : "p", r = e.props.intervals, i = tw(tI(e.props.selected)), o = 1440 / r, a = e.props.injectTimes && e.props.injectTimes.sort(function(e, t) {
              return e - t
            }), s = e.props.selected || e.props.openToDate || tI(), l = eC.default(s), c = eA.default(s), u = eU.default(ej.default(i, c), l), d = 0; d < o; d++) {
