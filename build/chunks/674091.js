/** Chunk was on web.js **/ ! function(e, r) {
...
}(0, function(e, t, r, i, o, a, s, l, c, u, d, f, _, p, h, m, g, E, b, v, y, O, I, S, T, A, N, C, R, P, w, D, L, x, M, k, j, U, G, B, F, V, Z, H, W, Y, K, z, q, Q, X, J, $, ee, et, en, er, ei, eo, ea, es, el, ec) {
  "use strict";
  ...
  function tS(e, t, n, r, i) {
    ...
    return Array.isArray(t) ? (t.forEach(function(t) {
      ...
      var t = e[0];
      return "p" === t || "P" === t ? a ? (0, tv[t])(e, a.formatLong) : t : e
  ...
  function nd(e, t) {
    for (var n = [], r = tL(e), i = tL(t); !e4.default(r, i);) n.push(tI(r)), r = ev.default(r, 1);
    return n
  }
  var nf = function(e) {
      tu(n, e);
        ...
        return tl(t_(e = t.call.apply(t, [this].concat(i))), "state", {
          ...
          for (var t = tL(e.props.minDate), n = tL(e.props.maxDate), r = []; !e4.default(t, n);) {
            ...
            r.push(ed.default.createElement("option", {
              key: i,
              value: i
            }, tA(t, e.props.dateFormat, e.props.locale))), t = ev.default(t, 1)
          }
          return r
        }), tl(t_(e), "onSelectChange", function(t) {
          e.onChange(t.target.value)
        ...
        return tl(t_(e = t.call.apply(t, [this].concat(i))), "MONTH_REFS", tm(Array(12)).map(function() {
          ...
          if (!e.props.disabledKeyboardNavigation) switch (r) {
            case "Enter":
              ...
              break;
            case "ArrowRight":
              e.handleMonthNavigation(11 === n ? 0 : n + 1, ev.default(e.props.preSelection, 1));
              break;
            case "ArrowLeft":
    ...
    nS = function(e) {
      ...
      function n(e) {
        ...
        return to(this, n), tl(t_(r = t.call(this, e)), "handleClickOutside", function(e) {
          ...
          }, r.renderHeader(), ed.default.createElement(nv, tc({
            onDayClick: r.handleDayClick,
            date: r.state.date
          }, r.props))) : void 0
