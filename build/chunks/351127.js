  ...
  return (0, l.e7)([s.ZP, u.default, a.Z], () => {
    ...
    for (let e of n) {
      ...
      if (r.e$(A, t)) {
        ...
        }(r.e$(m.permissions, d.Plq.ADMINISTRATOR) || r.Db(m.permissions, t)) && l[e].push(m.id), (0, i.eM)(E, _) && l[e].push(_.id)
      }
    }
    return l
  }, [E, t, n, e])
