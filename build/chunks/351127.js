...
let A = Object.keys(E.Plq),
  T = Array.from(new Set([..._.$X, ...E.yYS, E.Plq.ADMINISTRATOR, E.Plq.KICK_MEMBERS, E.Plq.BAN_MEMBERS, E.Plq.MANAGE_GUILD, E.Plq.MANAGE_CHANNELS, E.Plq.MANAGE_ROLES, E.Plq.MANAGE_MESSAGES, E.Plq.MANAGE_THREADS, E.Plq.MANAGE_GUILD_EXPRESSIONS, E.Plq.CREATE_GUILD_EXPRESSIONS, E.Plq.MANAGE_EVENTS, E.Plq.CREATE_EVENTS, E.Plq.MODERATE_MEMBERS, E.Plq.MENTION_EVERYONE, E.Plq.MANAGE_WEBHOOKS])).map(e => {
  ...
  return (0, l.e7)([a.ZP, c.default, o.Z], () => {
    ...
    for (let e of n) {
      ...
      if (r.e$(m, t)) {
        ...
        }((0, i.Fs)(T, E.Plq.ADMINISTRATOR) || (0, i._N)(T, t)) && l[e].push(T.id), (0, s.eM)(_, A) && l[e].push(A.id)
      }
    }
    return l
  }, [_, t, n, e])
