...
function h() {
  ...
  return <Chunk838436.U setting={Chunk726985.s6.PRIVACY_DATA_IMPROVE_DISCORD_V2}><Chunk51331.Z title={Chunk388032.intl.string(Chunk388032.t.XuADY2)} note={Chunk388032.intl.format(Chunk388032.t.igTSGx, {
        helpdeskArticle: Chunk63063.Z.getArticleURL(Chunk981631.BhN.DATA_PRIVACY_CONTROLS)
      })} value={module} onChange={exports} /></Chunk838436.U>
}