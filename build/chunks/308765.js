...
let i = {
  ...
  VoiceFilterManager: {
    actions: ["VOICE_FILTER_REQUEST_SWITCH", "VOICE_FILTER_PREFETCH", "VOICE_FILTER_DOWNLOAD_FAILED", "VOICE_FILTER_DOWNLOAD_CANCELED", "VOICE_FILTER_FILE_READY", "VOICE_FILTER_APPLIED", "VOICE_FILTER_APPLY_FAILED", "VOICE_FILTER_CATALOG_FETCH_SUCCESS"],
  ...
  GuildPowerupsSystemMessageManager: {
    actions: ["POST_CONNECTION_OPEN"],
    inlineRequire: () => n(57451).Z,
    neverLoadBeforeConnectionOpen: !0
  },
  AVErrorManager: {
