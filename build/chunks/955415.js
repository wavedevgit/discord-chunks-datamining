...
let O = e => {
  ...
  x = e => {
    ...
    let {
      ...
      user: f,
      className: g
    } = e, h = null != (t = (0, o.ZP)(i)) ? t : "", O = v.QK.useSetting();
    ...
    return null != n ? (0, r.jsx)(p.Z, {
      ...
      className: x,
      animate: O
    }) : null != i ? (0, r.jsx)(s.qEK, {
      onClick: u,
      src: (0, c.x)(i),
      size: s.EFr.SIZE_56,
      className: x,
      "aria-label": h
    }) : null != f ? (0, r.jsx)(s.qEK, {
      onClick: u,
...
P.Colors = s.zxk.Colors, P.Looks = s.zxk.Looks, P.defaultProps = {
  className: null,
  isDisabled: !1
};
let S = e => {
  ...
  I = e => {
    let {
      guild: t
    } = e, [n, i] = l.useState(!1), s = g.ZP.getGuildSplashURL({
      id: t.id,
      splash: t.splash,
      size: 400 * (0, f.x_)()
    });
    return null == s ? null : (0, r.jsx)("div", {
      ...
      children: (0, r.jsx)("img", {
        src: s,
        alt: "",
        className: a()(j.inviteSplashImage, {
          [j.inviteSplashImageLoaded]: n
        }),
        onLoad: () => i(!0)
      })
    })
