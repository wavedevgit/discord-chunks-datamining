...
function P(e) {
  ...
  } = e, n = (0, b.Q3)("AppLauncherPlusButton");
...
function j(e) {
  ...
  return (0, r.jsx)(s.P3F, {
    className: a()(C.clickable, {
      [C.disabledClickable]: m
    }),
    onClick: b,
...
function x(e) {
  let {
    ...
    frecentApps: n
  } = (0, y.ZC)(), [l, o] = i.useState(void 0), {
    analyticsLocations: s
  } = (0, f.ZP)(h.Z.APP_DMS_QUICK_LAUNCHER_FRECENCY), c = i.useRef(!1), u = i.useMemo(() => n.filter(O.lm).slice(0, 8), [n]);
  return i.useLayoutEffect(() => {
    var e;
    c.current || (c.current = !0, E.default.track(I.rMx.APP_DMS_QUICK_LAUNCHER_IMPRESSION, {
