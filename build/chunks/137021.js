...
function v(e) {
  ...
  let [w] = (0, c.Z)([m]), k = (0, s.e7)([h.default], () => h.default.getCurrentUser()), [T, D] = l.useState(!1), [R, M] = l.useState(""), [I, A] = l.useState("");
  l.useEffect(() => {
    A((0, u.H)({
      applicationId: m,
  ...
  let B = l.useCallback(() => {
    ...
    K = l.useCallback(async e => {
      ...
      let t = j.intl.formatToMarkdownString(j.t.dZJpdH, {
        ...
        n = "".concat(E, "\n\n").concat(t);
      D(!0), (await Promise.all(e.map(f.qx))).filter(y.lm).forEach(async e => {
        let t = p.Z.getChannel(e);
        null != t && await o.Z.sendMessage(e, d.ZP.parse(t, n), !1)
      }), (0, a.showToast)((0, a.createToast)(j.intl.formatToPlainString(j.t.jQULqK, {
        applicationName: w.name
      }), a.ToastType.SUCCESS)), L(!0), P()
    }, [E, I, P, L, w]),
    Q = G.length > 0 ? (0, r.jsx)(g.Q, {
      paddingBottom: 16,
      paddingTop: 16,
      rowData: G,
