  ...
  checkGuilds() {
    s.ZP.useNewNotifications && Object.values(o.Z.getGuilds()).forEach(e => {
      ...
      for (let t of Object.values(s.ZP.getChannelOverrides(e.id)))
        if (null != t.message_notifications && t.message_notifications !== _.bL.NULL || null != t.flags && (0, c.EB)(t.flags, f.ic.UNREADS_ALL_MESSAGES | f.ic.UNREADS_ONLY_MENTIONS)) return;
      ...
      for (let r of t) n[r.id] = {
        flags: (0, d.pq)(s.ZP.getChannelIdFlags(e.id, r.id), f.ic.UNREADS_ALL_MESSAGES)
      };
