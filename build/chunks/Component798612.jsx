...
function d(e) {
  ...
  return (0, r.jsx)(u.A, function(e) {
    ...
    analyticsSource: {
      page: (null == t ? true : t.getGuildId()) != null ? p.liQ.GUILD_CHANNEL : (null == t ? true : t.isGroupDM()) || (null == t ? true : t.isPrivate()) ? p.liQ.DM_CHANNEL : null
    },
    analyticsLocation: {
