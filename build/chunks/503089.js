...
class w extends s.PureComponent {
  ...
  validNavigation() {
    ...
    }), this._intensity = Math.min(this._intensity + C, x), p.S.dispatch(m.CkL.EMPHASIZE_NOTICE), !1) : (this._intensity = P, !0)
  }
  renderSidebar(e) {
    let {
      section: t,
  ...
  constructor(...e) {
    super(...e), y(this, "_unmounted", !1), y(this, "_intensity", P), y(this, "_subscribedStores", []), y(this, "scrollerRef", s.createRef()), y(this, "state", S(j({}, E), {
      ...
      s === m.oAB.ACCOUNT && this.props.isEligibleForPomelo ? y = (0, r.jsx)(o.P4T, {
        size: "custom",
        width: 20,
        height: 20,
      ...
      let j = s === m.oAB.PREMIUM ? (0, r.jsx)(d.Z, {
        label: i,
        isSelected: t,
        decoration: y
      }) : null == y ? i : (0, r.jsxs)("div", {
