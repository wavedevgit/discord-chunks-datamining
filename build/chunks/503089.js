...
class w extends s.PureComponent {
  ...
  validNavigation() {
    ...
    }), this._intensity = Math.min(this._intensity + E, C), p.S.dispatch(v.CkL.EMPHASIZE_NOTICE), !1) : (this._intensity = S, !0)
  }
  renderSidebar(e) {
    let {
      section: t,
  ...
  renderNotice(e) {
    ...
    return null == n || n.some(e => e.showNotice()) ? (0, r.jsx)(s, {
      theme: t
    }) : null
  }
  render() {
  ...
  constructor(...e) {
    super(...e), _(this, "_unmounted", !1), _(this, "_intensity", S), _(this, "_subscribedStores", []), _(this, "scrollerRef", s.createRef()), _(this, "state", y(j({}, x), {
      ...
      let {
        ...
        let {
          notice: s
        } = null != (r = n.find(t => e === t.section)) ? r : {}, i = null != s ? s.stores : null;
        null != i && i.forEach(e => {
      ...
      this.validNavigation() && !r && (i(), g.Z.addBreadcrumb({
        category: "settings",
      ...
      s === v.oAB.ACCOUNT && this.props.isEligibleForPomelo ? _ = (0, r.jsx)(l.P4T, {
        size: "custom",
        width: 20,
        height: 20,
        color: o.Z.colors.STATUS_WARNING.css
      }) : null != e.decoration ? _ = (0, r.jsx)(l.Text, {
        variant: "text-md/normal",
        color: "text-muted",
        children: e.decoration
      }) : null != n && (null == b ? void 0 : b.includes(n)) && !t ? _ = null != g ? g : (0, r.jsx)(l.IGR, {
        text: h.intl.string(h.t.y2b7CA)
      }) : null != f ? _ = f : null != m && m > 0 && (_ = (0, r.jsx)(l.mAB, {
        count: m
      }));
      let j = s === v.oAB.PREMIUM ? (0, r.jsx)(d.Z, {
        label: i,
        isSelected: t,
        decoration: _
      }) : null == _ ? i : (0, r.jsxs)("div", {
