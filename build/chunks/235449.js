...
function N(e, t, n, a) {
  let {
    ...
    c.Z.can(v.Pl.READ_MESSAGE_HISTORY, e) && x.Z.loadArchivedThreads({
      guildId: e.guild_id,
      channelId: e.id,
      sortOrder: t,
      tagFilter: n,
  ...
  }, [e, t, n, a, h]), j = r.useRef(f);
  return r.useEffect(() => {
    j.current = f
  }), r.useEffect(() => {
    g && j.current()
  }, [e.id, t, n, g]), r.useEffect(() => {
    i.Z.resort(e.id)
  }, [e.id]), {
    threadIds: (0, s.Wu)([m.Z, o.Z, c.Z], () => l()(m.Z.getThreads(e.id, t, n, a)).filter(e => {
