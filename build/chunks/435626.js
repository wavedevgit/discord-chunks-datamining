...
function I(t) {
  ...
  return (0, s.ZP)(() => {
    ...
    children: [(0, i.jsx)(v, {}), (0, i.jsxs)(r.Y0X, {
      size: r.CgR.DYNAMIC,
      transitionState: n,
...
function N(t) {
  let {
    ...
    t === b.Si.TIER_2 ? a = m.Qqv.NITRO_STANDARD : t === b.Si.TIER_0 && (a = m.Qqv.NITRO_BASIC), (0, h.Z)({
      isGift: !0,
      giftRecipient: e,
      ...
      analyticsObject: (i = function(t) {
        ...
        objectType: a
      }, Object.getOwnPropertyDescriptors ? Object.defineProperties(i, Object.getOwnPropertyDescriptors(o)) : (function(t, e) {
        var n = Object.keys(t);
