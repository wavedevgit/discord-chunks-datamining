...
let y = e => {
  ...
  return (0 === t && (O ? (x = g.intl.string(g.t.IRxUlJ), P = g.intl.string(g.t.fiNVio)) : C ? (x = g.intl.string(g.t.vW8iUF), P = g.intl.string(g.t["50gfOj"])) : v ? (x = g.intl.string(g.t.vdSOp6), P = g.intl.string(g.t.lm1UKi)) : S ? (x = g.intl.formatToPlainString(g.t.v1ktYW, {
