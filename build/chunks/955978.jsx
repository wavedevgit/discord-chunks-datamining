...
function y(e, t, n) {
  ...
  let b = u.Z.getCurrentlySelectedChannelId(),
    ...
    I = <div className={g.nowPlayingNotification}>{<div className={g.nowPlayingNotificationIcon}><o.Z user={O} aria-hidden={true} size={r.EFr.SIZE_24} /></div>}{<div className={g.body}><r.Text variant={"text-sm/medium"} color={"interactive-normal"} className={g.bodyText}>{m.intl.format(m.t["q7/rgo"], {
