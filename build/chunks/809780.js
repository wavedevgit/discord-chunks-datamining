  ...
  loadChannelMessages(e) {
    ...
    return null != t && !1 !== t && (this.setState({
      ...
      this.setState({
        ...
        channels: this.updateChannel(e.channelId, e => {
          var t;
          return s()("messages" === e.type, "channel cannot change type"), B(G({}, W(e, !0)), {
            isFullyLoaded: !0,
            hasError: !0,
            hasLoadedAnything: !0,
...
function K() {
  let e = function() {
    ...
    t = function(e) {
      let t = [];
      return E.Z.getSortedPrivateChannels().forEach(n => Y(e, t, null, n.id)), T.ZP.getFlattenedGuildIds().forEach(n => {
        if (null == n) return;
...
function Q(e) {
  let [t, n] = l.useState(() => new z(K(), e)), [r, i] = l.useState(!1), o = l.useRef(Date.now()), [a, s] = l.useState(() => K());
  l.useEffect(() => {
    let e = e => s(e);
