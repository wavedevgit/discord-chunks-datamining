...
function $(e) {
  let [t, n] = l.useState(() => new K(q(), e)), [r, i] = l.useState(false), o = l.useRef(Date.now()), [a, s] = l.useState(() => q());
  l.useEffect(() => {
    let e = e => s(e);
