  ...
  loadChannelMessages(e) {
    ...
    return null != t && !1 !== t && (this.setState({
      ...
      this.setState({
        ...
        channels: this.updateChannel(e.channelId, e => {
          var t;
          return s()("messages" === e.type, "channel cannot change type"), V(B({}, K(e, !0)), {
            isFullyLoaded: !0,
            hasError: !0,
            hasLoadedAnything: !0,
...
function K(e, t) {
  ...
  let o = null != i.getAfter(e.oldestReadMessageId) || (null == (n = l[0]) ? void 0 : n.id) === e.oldestUnreadMessageId,
    a = l[l.length - 1],
    s = M.default.compare(null == a ? void 0 : a.id, e.newestUnreadMessageId) >= 0 || l.length >= z;
  return V(B({}, e), {
    messages: l,
...
function J(e) {
  let [t, n] = l.useState(() => new W(Y(), e)), [r, i] = l.useState(!1), o = l.useRef(Date.now()), [a, s] = l.useState(() => Y());
  l.useEffect(() => {
    let e = e => s(e);
