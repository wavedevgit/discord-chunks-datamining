...
class z extends o.EventEmitter {
  ...
  loadChannelMessages(e) {
    ...
    return null != t && !1 !== t && (this.setState({
      ...
      this.setState({
        ...
        channels: this.updateChannel(e.channelId, e => {
          var t;
          return a()("messages" === e.type, "channel cannot change type"), B(G({}, W(e, !0)), {
            isFullyLoaded: !0,
            hasError: !0,
            hasLoadedAnything: !0,
  ...
  constructor(e, t) {
    super(), U(this, "state", void 0), U(this, "scrollerRef", void 0), U(this, "undoStack", void 0), U(this, "maybeLoadMore", void 0), U(this, "reloadMessages", void 0), U(this, "getNumUnreadChannels", void 0), U(this, "markChannelRead", void 0), U(this, "undoMarkChannelRead", void 0), U(this, "markGuildRead", void 0), U(this, "deleteChannel", void 0), U(this, "markAllRead", void 0), U(this, "toggle", void 0), U(this, "handleUserGuildSettingsStoreChange", void 0), U(this, "handleJoinedThreadsStoreChange", void 0), U(this, "handleActiveThreadsStoreChange", void 0), this.state = e, this.scrollerRef = t, this.undoStack = [], this.maybeLoadMore = () => {
      ...
      d.Z.wait(() => (0, m.Z)([e], M.jXE.INBOX)), this.setState({
...
function Y(e, t, n, r) {
  ...
  i.isNSFW() && !I.Z.didAgree(i.guild_id) ? t.push(B(G({}, u), {
    type: "nsfw"
...
function Q(e) {
  let [t, n] = l.useState(() => new z(K(), e)), [r, i] = l.useState(!1), o = l.useRef(Date.now()), [s, a] = l.useState(() => K());
  l.useEffect(() => {
    let e = e => a(e);
  ...
  }, [null == s ? void 0 : s.channels, null == s ? void 0 : s.loadState]), l.useEffect(() => (N.Z.addChangeListener(t.reloadMessages), () => N.Z.removeChangeListener(t.reloadMessages)), [t.reloadMessages]), l.useEffect(() => (A.ZP.addChangeListener(t.handleUserGuildSettingsStoreChange), () => A.ZP.removeChangeListener(t.handleUserGuildSettingsStoreChange)), [t]), l.useEffect(() => (y.Z.addChangeListener(t.handleJoinedThreadsStoreChange), () => y.Z.removeChangeListener(t.handleJoinedThreadsStoreChange)), [t]), l.useEffect(() => (O.Z.addChangeListener(t.handleActiveThreadsStoreChange), () => O.Z.removeChangeListener(t.handleActiveThreadsStoreChange)), [t]), [s, t]
}