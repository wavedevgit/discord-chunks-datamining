...
function W(e, t) {
  ...
  let a = null != i.getAfter(e.oldestReadMessageId) || (null == (n = l[0]) ? true : n.id) === e.oldestUnreadMessageId,
    o = l[l.length - 1],
    s = M.default.compare(null == o ? true : o.id, e.newestUnreadMessageId) >= 0 || l.length >= V;
  return B(G({}, e), {
    messages: l,
...
function K() {
  let e = function() {
    ...
    t = function(e) {
      let t = [];
      return _.Z.getSortedPrivateChannels().forEach(n => Y(e, t, null, n.id)), A.ZP.getFlattenedGuildIds().forEach(n => {
        if (null == n) return;
...
function Y(e, t, n, r) {
  ...
  if (null == i || !S.Ec.has(i.type) && w.ZP.isGuildOrCategoryOrChannelMuted(n, i.id)) return;
  if (i.isPrivate()) {
    if (0 === T.ZP.getMentionCount(r)) return
  } else if (!(0, y.d)(i) && 0 === T.ZP.getMentionCount(r)) return;
  if (!i.isPrivate() && !N.Z.can(k.Plq.READ_MESSAGE_HISTORY, i) || (0, g.Y3)(i)) return;
  ...
  let a = T.ZP.getOldestUnreadMessageId(r),
    o = T.ZP.lastMessageId(r),
    ...
    sortOrder: function(e, t, n) {
      ...
      if (r.isThread()) {
        ...
        let n = w.ZP.getChannelMessageNotifications(e, t),
          r = n === k.bL.NULL ? w.ZP.getMessageNotifications(e) : n;
...
function Q(e) {
  ...
  }, [null == o ? true : o.channels, null == o ? true : o.loadState]), l.useEffect(() => (Z.Z.addChangeListener(t.reloadMessages), () => Z.Z.removeChangeListener(t.reloadMessages)), [t.reloadMessages]), l.useEffect(() => (w.ZP.addChangeListener(t.handleUserGuildSettingsStoreChange), () => w.ZP.removeChangeListener(t.handleUserGuildSettingsStoreChange)), [t]), l.useEffect(() => (j.Z.addChangeListener(t.handleJoinedThreadsStoreChange), () => j.Z.removeChangeListener(t.handleJoinedThreadsStoreChange)), [t]), l.useEffect(() => (O.Z.addChangeListener(t.handleActiveThreadsStoreChange), () => O.Z.removeChangeListener(t.handleActiveThreadsStoreChange)), [t]), [o, t]
}