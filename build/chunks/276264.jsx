...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk771173 = require("./771173.js"),
  Chunk385499 = require("./385499.js"),
  Chunk693728 = require("./693728.js"),
  Chunk554300 = require("./554300.js"),
  Chunk558602 = require("./558602.js"),
  Chunk821795 = require("./821795.js"),
  Chunk892567 = require("./892567.js"),
  Chunk7284 = require("./7284.js"),
  Chunk172751 = require("./172751.jsx"),
  Chunk736144 = require("./736144.js"),
  Chunk884902 = require("./884902.js"),
  Chunk113434 = require("./113434.js"),
  Chunk569984 = require("./569984.js"),
  Chunk553393 = require("./553393.js"),
...
let V = (0, Chunk624138.Mg)(Chunk477690.Z.MEMBER_LIST_ITEM_AVATAR_DECORATION_PADDING),
  ...
  Y = Chunk73800.memo(function(e) {
    ...
    return null != t && t && null == n ? <c.ua7 text={null != i ? i : M.intl.string(M.t.pclUFB)}>{e => (0, r.jsx)(c.CEn, B(U({
        size: "md",
        color: "currentColor"
      }, e), {
  ...
  W = Chunk73800.memo(function(e) {
    ...
    return null == t ? null : <c.ua7 text={M.intl.formatToPlainString(M.t.IWkAq6, {
        date: t
      })}>{e => (0, r.jsx)(c.P3F, {
        onClick: n,
        tabIndex: false,
  ...
  K = Chunk73800.memo(function(e) {
    ...
    let n = L.Hb.BOT;
    return <h.Z className={k.botTag} type={n} verified={t.isVerifiedBot()} />
  }),
  z = Chunk73800.memo(function(e) {
    ...
    return <r.Fragment>{<K user={t} />}{<Y isOwner={n} lostPermissionTooltipText={i} ownerTooltipText={o} />}{<W premiumSince={a} onClickPremiumGuildIcon={s} />}</r.Fragment>
  }),
  q = Chunk73800.memo(function(e) {
    ...
    return <r.Fragment>{f ? <y.Z userName={null != o ? o : ""} displayNameStyles={s.displayNameStyles} effectDisplayType={u ? b.F.ANIMATED : b.F.STATIC} loop={true} /> : <c.PUh roleName={t} colorString={n} colorStrings={i} name={o} className={k.name} nameTextClassName={d} animateRoleGradient={u} />}{!a && <v.ZP primaryGuild={null == s ? true : s.primaryGuild} userId={null == s ? true : s.id} contextGuildId={l} disableGuildProfile={true} className={k.clanTag} />}</r.Fragment>
  }),
  X = Chunk73800.memo(function(e) {
    ...
    return E = m ? true : E, <r.Fragment>{<g{...B(U({}, a), {
        size: c.EFr.SIZE_32,
        src: s,
        isMobile: l,
        isTyping: d,
      ...
      })} />}{<I.Z confettiSpawnRef={p} shouldFire={d && null != h && t.id !== h.id} confettiLocation={x.Hn.MEMBER_USER} />}</r.Fragment>
  }),
  Q = Chunk73800.memo(function(e) {
    let {
      hideSubtext: t,
    ...
    return t || !h ? null : <p.Z location={"MemberListSubtext"} user={c} activities={o} applicationStream={s} voiceChannel={l} animateEmoji={d} hideEmoji={m} hasQuest={null != _} hideTooltip={n} />
  }),
  J = Chunk73800.memo(function(e) {
    ...
    let {
      ...
      onFocus: eR
    } = eC, eP = Z(eC, ["onFocus"]), ew = (0, T.X7)(G, ed, null != l ? l : null), eD = (0, s.e7)([A.Z], () => null != A.Z.questEnrollmentBlockedUntil, []), [eL, ex] = i.useState(false);
    i.useEffect(() => {
      n && ex(false)
    }, [n]);
    let eM = (0, S.fN)(v),
    ...
    return null == y ? <m.Z avatarSize={c.EFr.SIZE_32} className={k.placeholder} /> : <c.yRy targetElementRef={eh} renderPopout={eF} position={"bottom"} shouldShow={ek} nudgeAlignIntoViewport={false} useRawTargetDimensions={true} animation={c.yRy.Animation.NONE} spacing={-H}>{() => (0, r.jsx)(g.Z, U({
        ref: eh,
        selected: n,
