  ...
  return (0, r.jsx)("div", {
    ...
    children: (0, r.jsx)("div", {
      ...
      children: t.map((e, t) => (0, r.jsxs)("div", {
        ...
        children: [null != e.emoji ? (0, r.jsx)(l.Z, {
...
function v(e) {
  let {
    ...
    minValues: h,
    disabled: g
  } = e, v = i.useMemo(() => n.filter(e => e.default).map(e => e.value), [n]), {
    state: I,
    ...
    type: t,
    values: v
  }), C = l > 1, R = S === f.gH.LOADING, [P, w] = i.useState(!1), [D, L] = i.useState(() => new Set(n.filter(e => e.default).map(e => e.value))), [x, M] = i.useState(D), k = i.useMemo(() => n.some(e => null != e.emoji), [n]);
  i.useEffect(() => {
  ...
  return (0, r.jsxs)(i.Fragment, {
    children: [(0, r.jsx)("div", {
      ...
      children: (0, r.jsx)(s.PhF, m({
        isProcessing: R,
        isDisabled: g || S === f.gH.DISABLED || A,
        className: p.select,
        options: n.map(e => E(m({}, e), {
          disabled: C && !D.has(e.value) && D.size === l
        })),
        ...
        renderOptionLabel: e => (0, r.jsx)(b, E(m({}, e), {
          isDisabled: C && !D.has(e.value) && D.size === l,
          isOffset: k
        })),
        renderOptionValue: e => C ? (0, r.jsx)(O, {
          options: e
        }) : (0, r.jsx)(y, m({}, e[0]))
      }, G))
    }), null != N ? (0, r.jsx)(u.st, E(m({}, (0, u.c4)(N)), {
      className: p.error
    })) : null]
  })
}