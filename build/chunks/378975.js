...
function T(e) {
  ...
  let {
    ...
    type: t,
    values: T
  } : void 0), w = null != S.modal, D = u > 1, L = C === p.gH.LOADING, [x, M] = i.useState(!1), [k, j] = i.useState(() => new Set(n.filter(e => e.default).map(e => e.value))), [U, G] = i.useState(k), B = i.useMemo(() => n.some(e => null != e.emoji), [n]);
  i.useEffect(() => {
