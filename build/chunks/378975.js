...
function h(e) {
  let {
    ...
    type: t,
    values: P
  }), N = c > 1, I = S === p.gH.LOADING, [k, Z] = l.useState(!1), [T, D] = l.useState(() => new Set(r.filter(e => e.default).map(e => e.value))), [L, R] = l.useState(T), _ = l.useMemo(() => r.some(e => null != e.emoji), [r]);
  l.useEffect(() => {
