...
function v(e) {
  let {
    ...
    type: t,
    values: v
  }), C = l > 1, w = S === f.gH.LOADING, [R, P] = i.useState(!1), [D, L] = i.useState(() => new Set(n.filter(e => e.default).map(e => e.value))), [x, k] = i.useState(D), j = i.useMemo(() => n.some(e => null != e.emoji), [n]);
  i.useEffect(() => {
