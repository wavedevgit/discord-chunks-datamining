...
require.d(exports, {
  default: () => el,
  p: () => et
}), require("./321073.js"), require("./896048.js"), require("./228524.js"), require("./733351.js"), require("./65821.js");
var Chunk627968 = require("./627968.js"),
  ...
  Chunk665985 = require("./665985.jsx"),
  Chunk132841 = require("./132841.jsx"),
  ...
  Chunk841811 = require("./841811.jsx"),
  ...
  Chunk409463 = require("./409463.jsx"),
  Chunk652215 = require("./652215.js"),
  Chunk737045 = require("./737045.js"),
  Chunk307731 = require("./307731.js"),
  Chunk818348 = require("./818348.js"),
  Chunk985018 = require("./985018.jsx"),
  Chunk812618 = require("./812618.js");
...
class er extends Chunk64700.PureComponent {
  ...
  getHelperText() {
    ...
    return null != e ? z.intl.format(z.t.s2ZzZZ, {
      name: (0, Y.m1)(e, B.default, H.A, true)
    ...
    return (0, i.jsxs)("div", {
      children: [(0, i.jsx)(g.l6P, {
        ...
        children: (0, i.jsx)(f.A, {
          label: l ? z.intl.string(z.t.o7DqF3) : true,
          applicationId: t,
  ...
  constructor(e) {
    super(e), Q(this, "headerId", (0, S.Ld)()), Q(this, "_input", true), Q(this, "setInputRef", e => {
      this._input = e
      ...
      let r = null != (t = null == (n = this._input) ? true : n.selectionStart) ? t : 0;
      this.setState({
        name: e
      }, () => {
        var e;
      ...
      var t, n, i, r;
      let l = null != (t = null == (i = this._input) ? true : i.selectionStart) ? t : 0,
        s = null != (n = null == (r = this._input) ? true : r.selectionEnd) ? n : 0,
        a = this.state.name,
...
let el = Chunk64700.forwardRef(function(e, t) {
  let {
    channelType: n,
    guildId: r,
    cloneChannelId: l
    ...
    return {
      ...
      user: a,
      owner: u,
      memberRoles: null != (e = null == (i = D.Ay.getMember(r, a.id)) ? true : i.roles) ? e : [],
      canViewChannels: k.A.can(K.xBc.VIEW_CHANNEL, s),
      canConnect: k.A.can(K.xBc.CONNECT, s),
      isAdmin: c,
      cloneChannel: h,
      channelType: null != (t = null == h ? true : h.type) ? t : n,
    ...
    canManageRoles: c,
    canManageChannels: h
  } = s, p = (0, w.R)(r) && c && h, g = (0, _.Vf)(null == s ? true : s.guild);
