    ...
    case 1:
      return (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(A, {
          ...
          disabled: l,
          onClick: () => (function(e) {
            let t = N.isPlatformEmbedded && v.ZP.supportsFeature(j.eRX.WEBAUTHN) ? v.ZP.webAuthnAuthenticate : e => {
...
function R(e) {
  ...
  } = e, s = (0, l.e7)([_.default], () => _.default.getIsPasswordlessActive()), {
    state: u,
    rsaKeyPair: d,
    cancel: p,
    handleFailure: m
  } = function(e) {
    let [t, n] = i.useState(0), [r, s] = i.useState(!1), [l, a] = i.useState({
      step: 0
    ...
    return i.useEffect(() => {
      ...
      let _ = () => {
        h ? (h = !1, i.send(JSON.stringify({
          op: "heartbeat"
        }))) : (s("heartbeat timeout, reconnecting."), i.close(), f())
      };
      return i.onmessage = async t => {
        ...
        s("cleaning up"), i.onopen = () => null, i.onmessage = () => null, i.onclose = () => null, i.onerror = () => null, i.close(1e3), p.cancel(), null != d && clearTimeout(d), null != c && clearInterval(c)
      }
    }, [m, e, t, p, f]), {
      state: l,
      rsaKeyPair: c,
