    ...
    case 1:
      return (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(A, {
          ...
          disabled: o,
          onClick: () => (function(e) {
            let t = b.isPlatformEmbedded && O.ZP.supportsFeature(S.eRX.WEBAUTHN) ? O.ZP.webAuthnAuthenticate : e => {
...
function R(e) {
  let {
    ...
    let [t, n] = i.useState(0), [r, l] = i.useState(!1), [o, s] = i.useState({
      step: 0
    }), [c, u] = i.useState(null), d = (0, g.Z)(), p = i.useMemo(() => new a.Z(1500, 3e4), []), m = (0, h.Z)(() => {
      s({
        step: 0
