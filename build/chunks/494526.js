    ...
    case 1:
      return (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(A, {
          ...
          disabled: o,
          onClick: () => (function(e) {
            let t = x.isPlatformEmbedded && v.ZP.supportsFeature(j.eRX.WEBAUTHN) ? v.ZP.webAuthnAuthenticate : e => {
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(d.Z, {
          ...
          children: O.NW.format(O.t.Cbl5JC, {
            username: "".concat(E.ZP.getUserTag(e))
          })
        }), (0, r.jsx)(c.zxk, {
...
function R(e) {
  ...
  } = e, s = (0, o.e7)([_.default], () => _.default.getIsPasswordlessActive()), {
    state: u,
    rsaKeyPair: d,
    cancel: g,
    handleFailure: f
  } = function(e) {
    let [t, n] = i.useState(0), [r, s] = i.useState(!1), [o, a] = i.useState({
      step: 0
    }), [c, u] = i.useState(null), d = (0, h.Z)(), g = i.useMemo(() => new l.Z(1500, 3e4), []), f = (0, p.Z)(() => {
      a({
        step: 0
      }), d ? n(e => e + 1) : (P.info("document is not visible, will defer reconnection when document becomes visible."), s(!0))
    }), m = i.useCallback(() => {
      P.error("Could not complete QR code login, trying to restart with a new QR code."), a({
        step: 0
      }), g.pending || g.fail(f)
    }, [f, g]);
    return i.useEffect(() => {
      ...
      return i.onmessage = async t => {
        ...
        switch (r.op) {
          ...
          case "pending_remote_init": {
            ...
            s("handshake complete awaiting remote auth."), a({
              step: 1,
              fingerprint: e
            });
            return
        ...
        s("connected, handshaking with fingerprint: ".concat(e)), i.send(JSON.stringify({
          op: "init",
        ...
        s("cleaning up"), i.onopen = () => null, i.onmessage = () => null, i.onclose = () => null, i.onerror = () => null, i.close(1e3), g.cancel(), null != d && clearTimeout(d), null != c && clearInterval(c)
      }
    }, [f, e, t, g, m]), {
      state: o,
      rsaKeyPair: c,
  ...
  return i.useEffect(() => {
    4 === u.step && null != u.ticket && a.tn.post({
