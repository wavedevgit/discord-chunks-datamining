...
function H() {
  ...
  let {
    ...
    location: "settings"
  }), K = null != (n = null == (e = R.default.getCurrentUser()) ? void 0 : e.isStaff()) && n, q = (0, v.y0)({
    location: "settings"
  }), X = (0, S.v4)({
    location: "settings"
  }), Q = (0, c.Q)(), J = (0, j.Zy)({
    location: V.dr.USER_SETTINGS_SEARCH_GIFT_INVENTORY
  }), {
    enabled: $
  } = x.Z.useExperiment({
    ...
    location: "settings"
  }), es = null == (l = (0, b.Z)()) || l, el = (null == (t = (0, O.s)()) ? void 0 : t.length) > 0, {
    hasBlockedUsers: ea,
    hasIgnoredUsers: eo
  } = (0, r.cj)([A.Z], () => ({
  ...
  }), [en, H, ea, eo, ee, el, et, er, M, es, J, X, q, Y, G, K, ei, U, Q, W, $, Z, N, ec, ed, eu, em, eg, ep, eh])
}

function z(e) {
  let {
    searchResults: t
  } = (0, M.E)(), n = H(), i = n[e], r = Object.fromEntries(Object.entries(n).filter(e => {
    let [t, n] = e;
    ...
    for (let t of (l.add(e), Object.entries(s).filter(t => {
        let [n, i] = t;
        return i === e
      }).map(e => {
        let [t] = e;
  ...
  return e.forEach(e => {
    0 !== e.settings.length && (!0 === e.divider && i.push({
      ...
      i.push((r = function(e) {
        ...
        tabPredicate: () => null == n || e === U.s6.SEARCH_NO_RESULTS && 0 === n.size || s.has(e) || n.has(e)
    ...
    n = function() {
      ...
      return i.useMemo(() => [{
        ...
        settings: [...n.map(e => {
          ...
          return t
        }).flat(1), U.s6.SEARCH_NO_RESULTS]
      }], [n])
    }();
  return i.useMemo(() => W(n, t, new Set(e)), [n, t, e])
}
