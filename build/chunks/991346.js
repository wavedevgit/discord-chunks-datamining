...
function V() {
  ...
  let {
    ...
    location: "settings"
  }), z = null != (n = null == (e = y.default.getCurrentUser()) ? void 0 : e.isStaff()) && n, Y = (0, O.y0)({
    location: "settings"
  }), W = (0, j.v4)({
    location: "settings"
  }), K = (0, o.Q)(), q = (0, E.Zy)({
    ...
    autoTrackExposure: !0
  }), Q = (0, r.e7)([T.Z], () => T.Z.hasLibraryApplication()), J = (0, r.e7)([S.default], () => S.default.hasTOTPEnabled()), $ = R.Sb.useSetting(), ee = (0, p.Z)(), {
    hypeSquadRemoved: et
  } = m.Z.useExperiment({
    location: "settings"
...
function G(e) {
  let {
    searchResults: t
  } = (0, k.E)(), n = V(), i = n[e], r = Object.fromEntries(Object.entries(n).filter(e => {
    let [t, n] = e;
  ...
  return e.forEach(e => {
    0 !== e.settings.length && (!0 === e.divider && i.push({
      ...
      i.push((r = function(e) {
        ...
        tabPredicate: () => null == n || e === L.s6.SEARCH_NO_RESULTS && 0 === n.size || s.has(e) || n.has(e)
