...
function U() {
  ...
  let {
    ...
    location: "settings"
  }), H = null !== (n = null === (e = y.default.getCurrentUser()) || void 0 === e ? void 0 : e.isStaff()) && void 0 !== n && n, z = (0, C.y0)({
    location: "settings"
  }), Y = (0, j.v4)({
    location: "settings"
  }), K = (0, o.Q)(), q = (0, _.Zy)({
    ...
    autoTrackExposure: !0
  }), J = (0, i.e7)([S.Z], () => S.Z.hasLibraryApplication()), Q = (0, i.e7)([O.default], () => O.default.hasTOTPEnabled()), $ = R.Sb.useSetting(), ee = (0, p.Z)(), {
    hypeSquadRemoved: et
  } = m.Z.useExperiment({
    location: "settings"
  }), en = null === (a = (0, h.Z)()) || void 0 === a || a, er = (null === (t = (0, E.s)()) || void 0 === t ? void 0 : t.length) > 0, {
    hasBlockedUsers: ei,
    hasIgnoredUsers: es
  } = (0, i.cj)([T.Z], () => ({
