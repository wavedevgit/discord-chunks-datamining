...
function F() {
  ...
  let {
    ...
    location: "settings"
  }), Y = null != (n = null == (e = P.default.getCurrentUser()) ? void 0 : e.isStaff()) && n, K = (0, S.y0)({
    location: "settings"
  }), q = (0, O.v4)({
    location: "settings"
  }), X = (0, c.Q)(), Q = (0, C.Zy)({
    ...
    autoTrackExposure: !0
  }), $ = (0, r.e7)([N.Z], () => N.Z.hasLibraryApplication()), ee = (0, r.e7)([v.default], () => v.default.hasTOTPEnabled()), et = Z.Sb.useSetting(), en = (0, h.Z)(), {
    hypeSquadRemoved: ei
  } = g.Z.useExperiment({
    location: "settings"
  }), er = null == (l = (0, f.Z)()) || l, es = (null == (t = (0, j.s)()) ? void 0 : t.length) > 0, {
    hasBlockedUsers: el,
    hasIgnoredUsers: ea
  } = (0, r.cj)([y.Z], () => ({
    ...
    isEnabled: eg
  } = (0, o.D)("SettingRendererUtils");
  return i.useMemo(() => (0, w.i)({
    unseenGiftCount: T,
...
function H(e) {
  let {
    searchResults: t
  } = (0, B.E)(), n = F(), i = n[e], r = Object.fromEntries(Object.entries(n).filter(e => {
    let [t, n] = e;
  ...
  return e.forEach(e => {
    0 !== e.settings.length && (!0 === e.divider && i.push({
      ...
      i.push((r = function(e) {
        ...
        tabPredicate: () => null == n || e === M.s6.SEARCH_NO_RESULTS && 0 === n.size || s.has(e) || n.has(e)
