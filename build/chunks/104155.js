...
function y(e) {
  let {
    guildId: n
  } = e, [s, c] = r.useState(""), v = (0, i.e7)([h.Z], () => h.Z.getGuild(n)), y = (0, i.e7)([m.ZP], () => m.ZP.getChannels(n)), O = (0, i.e7)([u.Z], () => u.Z.getCategories(n)), I = (0, g.Fo)(n, O, y, s), N = (0, i.e7)([p.Z], () => p.Z.canWithPartialContext(_.Plq.MANAGE_CHANNELS, {
    guildId: n
  })), Z = (0, i.e7)([d.ZP], () => null != d.ZP.getCurrentSidebarChannelId(C.oC.CHANNEL_BROWSER)), w = r.useCallback(() => c(""), [c]), P = r.useCallback(() => {
    (0, o.ZDy)(async () => {
      let {
        default: e
  ...
  return null == v ? null : (0, l.jsxs)("div", {
    ...
    children: [(0, l.jsxs)("div", {
      ...
      children: [(0, l.jsx)(o.E1j, {
        ...
        query: s,
        onChange: e => {
          "" === s && "" !== e && f.default.track(_.rMx.SEARCH_STARTED, {
