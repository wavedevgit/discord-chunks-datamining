...
function v(e) {
  let {
    guildId: n
  } = e, [o, s] = r.useState(""), b = (0, i.e7)([m.Z], () => m.Z.getGuild(n)), v = (0, i.e7)([u.ZP], () => u.ZP.getChannels(n)), y = (0, i.e7)([d.Z], () => d.Z.getCategories(n)), O = (0, f.Fo)(n, y, v, o), Z = (0, i.e7)([h.Z], () => h.Z.canWithPartialContext(x.Plq.MANAGE_CHANNELS, {
    guildId: n
