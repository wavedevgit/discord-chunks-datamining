...
function v(e) {
  let {
    guildId: n
  } = e, [o, s] = r.useState(""), b = (0, i.e7)([m.Z], () => m.Z.getGuild(n)), v = (0, i.e7)([u.ZP], () => u.ZP.getChannels(n)), y = (0, i.e7)([d.Z], () => d.Z.getCategories(n)), O = (0, f.Fo)(n, y, v, o), I = (0, i.e7)([h.Z], () => h.Z.canWithPartialContext(x.Plq.MANAGE_CHANNELS, {
    guildId: n
  })), N = (0, i.e7)([c.ZP], () => null != c.ZP.getCurrentSidebarChannelId(_.oC.CHANNEL_BROWSER)), Z = r.useCallback(() => s(""), [s]), w = r.useCallback(() => {
    (0, a.ZDy)(async () => {
      let {
        default: e
      } = await Promise.all([t.e("45094"), t.e("58106")]).then(t.bind(t, 218613));
      return t => {
        var r, i;
