...
let s = {
  ...
  l = (i.HeQ.EPS, i.HeQ.BANCONTACT, i.HeQ.IDEAL, i.HeQ.SOFORT, i.HeQ.GIROPAY, i.HeQ.SEPA_DEBIT, i.HeQ.PAYSAFE_CARD, (e, t, n, i) => {
    if (null == e) return "";
    let s = (0, r.q9)(e);
    return t === a.pK.EUR ? n ? o.intl.formatToPlainString(o.t["+5bXbW"], {
      country: s
    }) : o.intl.formatToPlainString(o.t["0jblPj"], {
      currencyISOCode: t.toUpperCase()
    }) : i ? o.intl.formatToPlainString(o.t["dBFL//"], {
      countryName: s
    }) : o.intl.formatToPlainString(o.t.RJ4939, {
      country: s
    })
  })