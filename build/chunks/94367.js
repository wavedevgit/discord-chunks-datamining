  ...
  if (r.parsed = a.dL(r.str), r.parsed) {
    ...
    if ("color" === e) {
      ...
      for (let a of o.Z.all) {
        ...
        if (o && (n.includes(o.id) || o.ids?.filter(e => n.includes(e)).length)) {
          let n, u = Object.keys(a.coords).map((e, t) => r.parsed.args[t] || 0);
          return o.coordGrammar && (n = c(a, o, "color", u)), t && Object.assign(t, {
            formatId: "color",
            types: n
          }), o.id.startsWith("--") && !e.startsWith("--") && s.Z.warn(`${a.name} is a non-standard space and not currently supported in the CSS spec. Use prefixed color(${o.id}) instead of color(${e}).`), e.startsWith("--") && !o.id.startsWith("--") && s.Z.warn(`${a.name} is a standard space and supported in the CSS spec. Use color(${o.id}) instead of prefixed color(${e}).`), {
            spaceId: a.id,
            coords: u,
            alpha: i
          }
    ...
    for (let n of o.Z.all) {
      ...
      if (o && "function" === o.type) {
        ...
        let u = r.parsed.args;
        return o.coordGrammar && (s = c(n, o, e, u)), t && Object.assign(t, {
          formatId: o.name,
          types: s
        }), {
          spaceId: n.id,
