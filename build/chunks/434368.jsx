...
function j(e) {
  ...
  return <s.v2r navId={"member-safety-flags"} onClose={n} aria-label={b.intl.string(b.t.k9m8Rk)} onSelect={m.dG4}><s.kSQ>{<s.S89 id={"toggle-require-unusual-dm-activity"} label={(0, r.jsxs)("div", {
        ...
        })} action={g} checked={o.requireUnusualDmActivity} />}{<s.S89 id={"toggle-require-communication-disabled"} label={(0, r.jsxs)("div", {
          className: p.checkboxLabel,
        ...
        })} action={x} checked={o.requireCommunicationDisabled} />}{<r.Fragment>{<s.S89 id={"toggle-require-unusual-account-activity"} label={(0, r.jsxs)("div", {
            className: p.checkboxLabel,
          ...
          })} action={v} checked={o.requireUnusualAccountActivity} />}{<s.S89 id={"toggle-require-username-quarantined"} label={(0, r.jsxs)("div", {
            className: p.checkboxLabel,
          ...
          })} action={y} checked={o.requireUsernameQuarantined} />}</r.Fragment>}</s.kSQ></s.v2r>
}