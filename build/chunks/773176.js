...
let eh = i.memo(function(e) {
  let {
    channel: t,
    message: n
  } = e, i = (0, b.q5)(t.guild_id).filter(e => !q.ZP.isEmojiFilteredOrLocked({
    emoji: e,
    channel: t,
...
function ef(e) {
  let {
    ...
    }), [t, y]), O = (0, M.U)(t, n), j = (0, L.NE)(t, n), S = (0, L.Ek)(n), I = (0, u.e7)([E.Z], () => null != t.guild_id && E.Z.isLurking(t.guild_id), [t]), P = (0, u.e7)([H.ZP], () => null != t.guild_id && H.ZP.isCurrentUserGuest(t.guild_id), [t]), Z = s.id === p, T = (C || n.canDeleteOwnMessage(p)) && h && !ei.V$x.UNDELETABLE.has(n.type);
    ...
    let N = (0, X.a4)(n),
      ...
      W = t.getGuildId(),
      q = null != W && n.type === ei.uaV.USER_JOIN && z.Z.canWithPartialContext(ei.Plq.MANAGE_GUILD, {
        guildId: W
      }),
      K = (0, x.a)(n),
      {
    ...
    F || W.default.track(ei.rMx.MESSAGE_POPOUT_MENU_OPENED_DESKTOP, {
      message_id: n.id,
      channel: n.channel_id
    }), ea({
      moreUtilities: !F
    })
  }, [F, ea, n]), em = i.useCallback(() => {
    ea({
      emojiPicker: !q
    })
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [R ? (0, r.jsxs)(r.Fragment, {
      children: [l && es ? (0, r.jsx)(ee.sF, {
        label: eo.intl.string(eo.t.zBoHlZ),
        icon: p.VuL,
        onClick: e => (0, et.F4)(t, n, e)
      }, "copy-id") : null, l ? (0, r.jsx)(ee.sF, {
        ...
        icon: p.idN,
        onClick: () => (0, et.zW)(t)
      }, "configure") : null, eg ? (0, r.jsx)(ee.sF, {
      ...
      children: [eI && !R ? (0, r.jsxs)(r.Fragment, {
        ...
        icon: p.l22,
        onClick: () => {
          W.default.track(ei.rMx.CONFETTI_POTION_ENTRYPOINT_CLICKED, {
      ...
      icon: p.n$P,
      onClick: e => (0, et.HH)(t, n, e)
    }, "reply-other") : null, h ? (0, r.jsx)(ee.sF, {
