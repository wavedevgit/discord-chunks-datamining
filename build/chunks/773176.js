...
let eu = [y.ZP.getByName("100"), y.ZP.getByName("laughing"), y.ZP.getByName("sparkling_heart")].filter(q.lm);
...
let eh = i.memo(function(e) {
  let {
    ...
    guildId: t.guild_id
  })), l = (i.length >= 3 ? i : [...(0, _.Z)(i.concat(eu)).values()]).slice(0, 3), o = n.reactions.filter(e => e.me);
  return (0, r.jsx)(r.Fragment, {
    children: l.map(e => {
      ...
      let l = o.find(t => (0, A.ir)(t.emoji, (0, A.g1)(e))),
        ...
        c = null != l ? ea.NW.formatToPlainString(ea.t.vjeruL, {
          emojiName: s
        }) : ea.NW.formatToPlainString(ea.t.L1JQwM, {
          emojiName: s
        });
      return (0, r.jsx)($.sF, {
...
function ef(e) {
  let {
    ...
    let {
      ...
      author: s
    } = n, u = (0, c.e7)([G.Z], () => G.Z.getGuild(t.guild_id), [t.guild_id]), d = (0, c.e7)([W.default], () => W.default.getId()), p = (0, L.$R)(t), m = (0, L.Gu)(t), g = D.nc.useSetting(), b = D.Sb.useSetting(), y = (0, c.e7)([F.Z], () => null == t.guild_id || F.Z.canChatInGuild(t.guild_id), [t]), {
      canManageMessages: _,
      canAddNewReactions: x
    } = (0, c.cj)([H.Z], () => ({
      canAddNewReactions: y && H.Z.can(ei.Plq.ADD_REACTIONS, t),
      canManageMessages: H.Z.can(ei.Plq.MANAGE_MESSAGES, t)
    }), [t, y]), v = (0, R.U)(t, n), j = (0, L.NE)(t, n), E = (0, L.Ek)(n), N = (0, c.e7)([O.Z], () => null != t.guild_id && O.Z.isLurking(t.guild_id), [t]), I = (0, c.e7)([B.ZP], () => null != t.guild_id && B.ZP.isCurrentUserGuest(t.guild_id), [t]), P = s.id === d, S = (_ || n.canDeleteOwnMessage(d)) && p && !ei.V$x.UNDELETABLE.has(n.type);
    n.type === ei.uaV.AUTO_MODERATION_ACTION && (S = S && _);
    let Z = (0, K.a4)(n),
      T = (0, Q.Z)(n, t, _),
      ...
      U = t.type === ei.d4z.GUILD_ANNOUNCEMENT && null != u && u.hasFeature(ei.oNc.NEWS) && (P || _) && (0, f.Z)(n),
      V = t.getGuildId(),
    ...
    U || V.default.track(ei.rMx.MESSAGE_POPOUT_MENU_OPENED_DESKTOP, {
      message_id: n.id,
      channel: n.channel_id
    }), eo({
      moreUtilities: !U
    })
  }, [U, eo, n]), eg = i.useCallback(() => {
    eo({
      emojiPicker: !Y
    })
  }, [Y, eo]), ey = (0, L.$R)(t), e_ = n.hasFlag(ei.iLy.CROSSPOSTED), [eC, ex] = (0, m.cv)(A ? [u.z.MESSAGE_FORWARDING_DESKTOP_UTILITIES_NEW_BADGE] : []), ev = eC === u.z.MESSAGE_FORWARDING_DESKTOP_UTILITIES_NEW_BADGE, [ej, eO] = i.useState(!1), eE = i.useCallback(() => {
    eO(!0)
  }, []), eN = i.useCallback(() => {
    eO(!1)
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [w ? (0, r.jsxs)(r.Fragment, {
      ...
      children: [eP && !w ? (0, r.jsxs)(r.Fragment, {
        ...
        icon: d.l22,
        onClick: () => {
          V.default.track(ei.rMx.CONFETTI_POTION_ENTRYPOINT_CLICKED, {
      ...
      icon: d.or_,
      onClick: () => (0, ee.gK)(t, n)
    }, "thread") : null, !j && T ? (0, r.jsx)($.sF, {
      label: ea.NW.string(ea.t["39d0Wl"]),
      icon: d.or_,
      onClick: () => (0, ee.qe)(t, n)
    }, "view-thread") : null, g ? (0, r.jsx)($.sF, {
      label: e_ ? ea.NW.string(ea.t["1kWJAg"]) : ea.NW.string(ea.t["MFGE5+"]),
      icon: d.MqZ,
      onClick: () => (0, ee.Xl)(t, n),
      disabled: e_
...
function em(e) {
  let {
    channel: t,
    message: n
  } = e, i = (0, c.e7)([v.Z], () => null != v.Z.getMessage(n.id), [n.id]), l = null == n.interaction || null != n.interactionData && (0, j.$s)(n.interactionData);
  return (0, r.jsxs)(r.Fragment, {
    children: [!i && l && (0, r.jsx)($.sF, {
...
let ey = i.memo(function(e) {
  let {
    ...
    isHeader: i,
    isReply: l
  } = e, a = (0, c.e7)([U.Z], () => U.Z.isEditing(t.id, n.id), [t.id, n.id]), s = function(e) {
    let {
      channel: t,
      message: n
    } = e;
    return n.state === ei.yb.SEND_FAILED ? (0, r.jsx)(em, {
      channel: t,
      message: n
    }) : null
  }(e), u = function(e) {
