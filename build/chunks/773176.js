...
let eh = i.memo(function(e) {
  let {
    ...
    guildId: t.guild_id
  })), l = (i.length >= 3 ? i : [...(0, y.Z)(i.concat(eu)).values()]).slice(0, 3), o = n.reactions.filter(e => e.me);
  return (0, r.jsx)(r.Fragment, {
    children: l.map(e => {
      var i;
      let l = o.find(t => (0, A.ir)(t.emoji, (0, A.g1)(e))),
        a = null != l ? ea.intl.string(ea.t.wunKKC) : ea.intl.string(ea.t.XVx5BA),
        s = null == e.id ? e.uniqueName : e.name,
        c = null != l ? ea.intl.formatToPlainString(ea.t.vjeruL, {
          emojiName: s
        }) : ea.intl.formatToPlainString(ea.t.L1JQwM, {
          emojiName: s
        });
      return (0, r.jsx)($.sF, {
...
function ef(e) {
  let {
    ...
    let {
      ...
      author: s
    } = n, u = (0, c.e7)([H.Z], () => H.Z.getGuild(t.guild_id), [t.guild_id]), d = (0, c.e7)([U.default], () => U.default.getId()), p = (0, D.$R)(t), m = (0, D.Gu)(t), g = L.nc.useSetting(), b = L.Sb.useSetting(), _ = (0, c.e7)([G.Z], () => null == t.guild_id || G.Z.canChatInGuild(t.guild_id), [t]), {
      canManageMessages: y,
    ...
    }), [t, _]), v = (0, R.U)(t, n), O = (0, D.NE)(t, n), E = (0, D.Ek)(n), S = (0, c.e7)([j.Z], () => null != t.guild_id && j.Z.isLurking(t.guild_id), [t]), I = (0, c.e7)([F.ZP], () => null != t.guild_id && F.ZP.isCurrentUserGuest(t.guild_id), [t]), P = s.id === d, Z = (y || n.canDeleteOwnMessage(d)) && p && !ei.V$x.UNDELETABLE.has(n.type);
  ...
  }, [Y, eo]), eg = (0, D.$R)(t), e_ = n.hasFlag(ei.iLy.CROSSPOSTED), [ey, eC] = (0, m.cv)(A ? [u.z.MESSAGE_FORWARDING_DESKTOP_UTILITIES_NEW_BADGE] : []), ex = ey === u.z.MESSAGE_FORWARDING_DESKTOP_UTILITIES_NEW_BADGE, [ev, eO] = i.useState(!1), ej = i.useCallback(() => {
    eO(!0)
  }, []), eE = i.useCallback(() => {
    eO(!1)
  ...
  let eP = (0, N.Z)(t),
    ...
    eT = i.useCallback(e => {
      try {
        ...
        (0, d.showToast)((0, d.createToast)(ea.intl.string(ea.t.xsfC2d), d.ToastType.FAILURE))
      }
    }, [t.id, n.id]);
  return (0, r.jsxs)(r.Fragment, {
    children: [w ? (0, r.jsxs)(r.Fragment, {
      children: [l && es ? (0, r.jsx)($.sF, {
        ...
        label: en ? ea.intl.string(ea.t.LHUP9P) : ea.intl.string(ea.t["9p3D9v"]),
        icon: en ? d.plf : d.gt9,
      ...
      children: [eI && !w ? (0, r.jsxs)(r.Fragment, {
        ...
        icon: d.l22,
        onClick: () => {
          z.default.track(ei.rMx.CONFETTI_POTION_ENTRYPOINT_CLICKED, {
      ...
      onTooltipHide: eE,
      showNewBadge: !ev && ex
    }, "forward") : null, O && !A ? (0, r.jsx)($.sF, {
      label: ea.intl.string(ea.t.rBIGBA),
      icon: d.or_,
      onClick: () => (0, ee.gK)(t, n)
    }, "thread") : null, !O && T ? (0, r.jsx)($.sF, {
...
function em(e) {
  let {
    channel: t,
    message: n
  } = e, i = (0, c.e7)([v.Z], () => null != v.Z.getMessage(n.id), [n.id]), l = null == n.interaction || null != n.interactionData && (0, O.$s)(n.interactionData);
  return (0, r.jsxs)(r.Fragment, {
