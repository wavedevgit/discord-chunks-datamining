...
let eh = i.memo(function(e) {
  let {
    ...
    guildId: t.guild_id
  })), l = (i.length >= 3 ? i : [...(0, y.Z)(i.concat(eu)).values()]).slice(0, 3), a = n.reactions.filter(e => e.me);
  return (0, r.jsx)(r.Fragment, {
    children: l.map(e => {
      ...
      let l = a.find(t => (0, A.ir)(t.emoji, (0, A.g1)(e))),
        ...
        c = null != l ? eo.intl.formatToPlainString(eo.t.vjeruL, {
          emojiName: s
        }) : eo.intl.formatToPlainString(eo.t.L1JQwM, {
          emojiName: s
        });
      return (0, r.jsx)($.sF, {
...
function ef(e) {
  let {
    ...
    let {
      ...
      author: s
    } = n, u = (0, c.e7)([H.Z], () => H.Z.getGuild(t.guild_id), [t.guild_id]), d = (0, c.e7)([U.default], () => U.default.getId()), p = (0, L.$R)(t), m = (0, L.Gu)(t), g = k.nc.useSetting(), b = k.Sb.useSetting(), _ = (0, c.e7)([G.Z], () => null == t.guild_id || G.Z.canChatInGuild(t.guild_id), [t]), {
      canManageMessages: y,
    ...
    }), [t, _]), v = (0, R.U)(t, n), O = (0, L.NE)(t, n), E = (0, L.Ek)(n), S = (0, c.e7)([j.Z], () => null != t.guild_id && j.Z.isLurking(t.guild_id), [t]), I = (0, c.e7)([F.ZP], () => null != t.guild_id && F.ZP.isCurrentUserGuest(t.guild_id), [t]), P = s.id === d, Z = (y || n.canDeleteOwnMessage(d)) && p && !ei.V$x.UNDELETABLE.has(n.type);
  ...
  }, [B, ea, n]), em = i.useCallback(() => {
    ea({
      emojiPicker: !Y
    })
  }, [Y, ea]), eg = (0, L.$R)(t), e_ = n.hasFlag(ei.iLy.CROSSPOSTED), [ey, eC] = (0, m.cv)(A ? [u.z.MESSAGE_FORWARDING_DESKTOP_UTILITIES_NEW_BADGE] : []), ex = ey === u.z.MESSAGE_FORWARDING_DESKTOP_UTILITIES_NEW_BADGE, [ev, eO] = i.useState(!1), ej = i.useCallback(() => {
    eO(!0)
  }, []), eE = i.useCallback(() => {
    eO(!1)
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [w ? (0, r.jsxs)(r.Fragment, {
      ...
      onClick: () => (0, ee.Xl)(t, n),
      disabled: e_
    }, "publish") : null, o && w ? (0, r.jsx)($.sF, {
      label: eo.intl.string(eo.t.oyYWHB),
      icon: d.XHJ,
      onClick: e => (0, ee.$Z)(t, n, e),
      dangerous: !0,
      separator: !w
    }, "delete") : null, w && o ? null : (0, r.jsx)(d.yRy, {
      targetElementRef: ed,
      renderPopout: e => {
        let {
          updatePosition: i,
...
let e_ = i.memo(function(e) {
  let {
    ...
    isHeader: i,
    isReply: l
  } = e, o = (0, c.e7)([B.Z], () => B.Z.isEditing(t.id, n.id), [t.id, n.id]), s = function(e) {
    let {
      channel: t,
      message: n
    } = e;
  ...
  return o || null == s && null == u ? null : (0, r.jsx)("div", {
