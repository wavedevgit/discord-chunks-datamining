...
function ef(e) {
  let {
    ...
    }), [t, y]), j = (0, M.U)(t, n), O = (0, k.NE)(t, n), S = (0, k.Ek)(n), P = (0, u.e7)([E.Z], () => null != t.guild_id && E.Z.isLurking(t.guild_id), [t]), I = (0, u.e7)([H.ZP], () => null != t.guild_id && H.ZP.isCurrentUserGuest(t.guild_id), [t]), Z = s.id === p, N = (C || n.canDeleteOwnMessage(p)) && h && !ei.V$x.UNDELETABLE.has(n.type);
