...
t.a(e, async function(e, r) {
  try {
    ...
    function c({
      ...
      let r = n[e.type];
      if (o(r, e.type), Array.isArray(e.value)) return i.createElement(r, null, i.createElement(s, {
        nodes: e.value,
        renderers: n,
        state: t
      }));
      switch (e.type) {
        ...
        case "quote":
          let c = n.paragraph;
          return o(c, "paragraph"), i.createElement(r, null, e.value.lines.map(e => i.createElement(c, {
            key: e,
            value: e,
            renderers: n,
            state: t
        ...
        case "list":
          let a = n.listItem ?? "li";
          return i.createElement(r, e.value, e.value.items.map((e, r) => i.createElement(a, {
            key: r
          }, i.createElement(s, {
            nodes: e.content,
            renderers: n,
        ...
        case "small":
          return i.createElement(r, null, i.createElement(s, {
            nodes: e.value.content,
            renderers: n,
            state: t
          }));
    ...
    let s = (0, i.memo)(function({
      ...
      return i.createElement(i.Fragment, null, e.map((e, r) => i.createElement(c, {
        key: r,
        node: e,
        renderers: n,
        state: t
