...
function x(e, t) {
  g.Z.getAllActiveStreamKeys().includes(e) || N.start(t ? R : P, () => {
    a.Z.dispatch({
...
class k extends s.Z {
  constructor(...e) {
    super(...e), I(this, "handleStreamWatch", e => {
      ...
      x(t, null == i ? void 0 : i.isGuildStageVoice()), n || d.Z.getAllActiveStreams().forEach(e => {
        let n = (0, y.V9)(e);
      ...
      N.stop(), t === v.si2.STREAM_FULL && ((0, l.kr)(S({
        type: l.u.STREAM_FULL
      }, (0, c.rT)(n))), (0, o.aP)(n, !1), this.platformShowStreamFull())
      ...
      if (null != n)
        for (let e of t) n.channelId === e.id && L((0, y.V9)(n), e.rtcRegion)
