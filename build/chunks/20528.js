  ...
  constructor(...e) {
    super(...e), I(this, "handleStreamWatch", e => {
      let {
        ...
        channelId: r
      } = (0, v.my)(t), i = _.Z.getChannel(r);
      L(t, null == i ? void 0 : i.isGuildStageVoice()), n || d.Z.getAllActiveStreams().forEach(e => {
        let n = (0, v.V9)(e);
      ...
      if (null != n)
        for (let e of t) n.channelId === e.id && D((0, v.V9)(n), e.rtcRegion)
