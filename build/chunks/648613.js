...
function v(e) {
  let {
    ...
    isGift: N,
    children: C
  } = e, R = (0, i.e7)([d.default], () => d.default.getCurrentUser()), P = (0, i.e7)([_.ZP], () => _.ZP.getPremiumTypeSubscription()), {
    analyticsLocations: w
  } = (0, s.ZP)(), D = (0, f.N)(), L = !N && null != D && null != m && p.nG[D.trial_id].skus.includes(m);
  return C({
    onClick: e => {
      var i;
