...
function T(e, t, n, r) {
  ...
  if ((0, f.$J)(e)) return s ? g.intl.format(g.t.gbtCpW, {
    onClick: o,
    minutes: i
  ...
  if (s) return g.intl.format(g.t.Hu8SKW, {
    targetMinutes: i
  });
  if ((0, f.q8)(e)) {
    let t = (0, f.z1)(e.config),
      n = null == t ? true : t.messages.videoTitle;
    return null == n ? g.intl.string(g.t["o+e9yh"]) : g.intl.formatToPlainString(g.t["9m9Mna"], {
      videoTitle: n
    })
  }
  if (null != a) return a.title;
  if ((0, f.pO)(e))
    if ((0, f.KM)(e)) return g.intl.format(g.t["1NaRSs"], {
      minutes: i
    });
    else return g.intl.format(g.t.xHXCyf, {
      minutes: i,
  ...
  return (0, f.Nj)({
    quest: e
  }) && (l = e.config.features.includes(p.S7.NON_GAMING_PLAY_QUEST) ? g.t.fe7Xec : g.t["wmOh/q"]), g.intl.format(l, {
    minutes: i,
    gameTitle: e.config.messages.gameTitle
  })
}
...
function S(e) {
  ...
  return I(t = a && u ? d ? _ ? g.t.ztXW8V : g.t["eb/Sna"] : _ ? g.t["1AcTqm"] : g.t.ziB0HF : u || null != o ? _ ? g.t.enQ3jU : g.t.AwuMRS : _ ? g.t["e+K3xJ"] : g.t.NIimTt, {
    gameTitle: c,
...
function A(e) {
  let t, {
    ...
    u = (0, f.f$)(n.config),
    d = (0, f._p)(n.config);
  return I(t = a && u ? d ? g.t["eb/Sna"] : g.t.ziB0HF : u || null != o ? g.t.AwuMRS : g.t.NIimTt, {
    gameTitle: c,
    targetMinutes: l,
    rewardNameWithArticle: s,
    duration: o,
...
function C(e) {
  let t, {
    ...
    d = (0, f._p)(n.config),
    _ = n.config.features.includes(p.S7.NON_GAMING_PLAY_QUEST);
  return I(t = a && u ? d ? _ ? g.t.ztXW8V : g.t["eb/Sna"] : _ ? g.t["1AcTqm"] : g.t.ziB0HF : u || null != o ? _ ? g.t.enQ3jU : g.t.AwuMRS : _ ? g.t["03VJqu"] : g.t.FZL5Q5, {
    gameTitle: c,
    streamingDurationRequirement: l,
    rewardNameWithArticle: s,
    duration: o,
...
function R(e, t, n, r) {
  var i;
  let a, o = (0, f.z1)(e.config),
    s = null != (i = null == o ? true : o.messages.videoTitle) ? i : "video",
    l = (0, f.B3)(e.config),
    c = (0, f.f$)(e.config),
    u = (0, f._p)(e.config);
  return I(a = c && n ? u ? g.t["xqX+r5"] : g.t["vs/xBu"] : c || null != t ? g.t["W/HkLO"] : e.id === p.V6 ? g.t.Rsd5bL : g.t["g+InPC"], {
    videoTitle: s,
...
function P(e) {
  let {
    ...
    withoutMarkdown: r,
    questContent: i
  } = e, a = n.targetMinutes, o = (0, f.B3)(t.config);
  return (0, f.KM)(t) ? I(g.t.VYwSSu, {
    streamingDurationRequirement: a,
    questReward: o
  }, r) : t.config.features.includes(p.S7.CLOUD_GAMING_ACTIVITY) ? i === d.jn.QUESTS_EMBED ? I(g.t["C+2RxC"], {
...
function D(e) {
  let t, {
    ...
    u = (0, f.f$)(n.config),
    d = (0, f._p)(n.config);
  return I(t = a && u ? d ? g.t["X8Yt/1"] : g.t.smG9ql : u || null != o ? g.t.BLyDvO : g.t["hkJ+Gs"], {
    gameTitle: c,
    streamingDurationRequirement: l,
    duration: o,
    questReward: s
...
function w(e) {
  ...
  }, s = n.config.features.find(e => e in o), l = null != (t = null != s ? o[s] : null) ? t : g.t.CDeHul;
...
function L(e) {
  ...
  if (i) return g.intl.formatToPlainString(g.t["1votF6"], {
    rewardNameWithArticle: l,
    targetMinutes: c
  });
  let d = (0, _.C)({
...
function x(e) {
  let {
    ...
    onGameSheetOpened: u,
    onGameSheetClosed: d
  } = e, _ = (0, c.I5)(s, m.PremiumTypes.TIER_2), p = (0, f.Kr)(t.config), h = (0, f.$J)(t) && (0, f.$H)(t);
  if ((0, f.Pb)(t)) return L({
    quest: t,
    taskDetails: n,
    sourceQuestContent: a,
    withoutMarkdown: o,
  ...
  else if ((0, f.pO)(t)) return P({
    quest: t,
    taskDetails: n,
    withoutMarkdown: o,
    questContent: r
  });
  return null != i ? i.description : D({
    quest: t,
    taskDetails: n,
    withoutMarkdown: o,
    hasNitro: _,
...
function k(e) {
  let {
    ...
    questContent: n,
    sourceQuestContent: r
  }), s = (0, i.e7)([o.default], () => o.default.getCurrentUser()), l = (0, u.Jf)(t);
  return M(O(b({}, e), {
...
function j(e, t, n) {
  ...
  let a = (0, u.Rf)(e),
    ...
    c = (0, u.B6)(null == (i = e.userStatus) ? true : i.claimedAt);
  return l ? g.intl.formatToPlainString(g.t.lOVr0O, {
    claimDate: c
...
function U(e) {
  ...
  let {
    ...
    onGameSheetOpened: l,
    onGameSheetClosed: c
  } = e, _ = r.config.rewardsConfig.rewardsExpireAt, h = (0, u.B6)(_), m = (0, u.Rf)(r), E = (0, u.Jf)(r), b = (null == (t = r.userStatus) ? true : t.completedAt) != null, y = (null == (n = r.userStatus) ? true : n.enrolledAt) != null, O = m.percentComplete > 0, v = (0, u.z)(r), I = k({
    quest: r,
  ...
  if (b) return g.intl.formatToPlainString(g.t.APddvF, {
    expirationDate: h
  });
  if (i)
  ...
  if (T > 0)
    if (!v) return g.intl.string(g.t.mOrpXG);
      ...
      quest: r,
      taskDetails: m,
      thirdPartyTaskDetails: null != E ? E : true
    });
...
function G(e) {
  ...
  let r = (0, i.e7)([a.default], () => a.default.locale),
    ...
    [s] = (0, u.me)(e, o),
    c = (0, u.Jf)(e),
    _ = (null == (t = e.userStatus) ? true : t.completedAt) != null,
    p = null != c ? c.percentComplete : o.percentComplete;
  if (_) return g.intl.string(g.t["ij5E/5"]);
  if ((null == (n = e.userStatus) ? true : n.enrolledAt) != null && p > 0) {
    let e = (0, l.T3)(r, p, {
      roundingMode: "floor"
    });
    return g.intl.formatToPlainString(g.t.lVZaXD, {
      percent: e
    })
  }
  return s === d.LI.SELECT ? g.intl.string(g.t.EMrUHQ) : (0, f.$J)(e) ? g.intl.string(g.t.mOrpXG) : g.intl.string(g.t["7e5k7L"])
}

function B(e) {
  return (0, f.$J)(e) || (0, f.pO)(e) ? 0 : (0, f.Dr)({
    quest: e
  }) ? 1 : (0, f.q8)(e) ? 2 : 3 * !!(0, f.Vl)(e)
}
...
function F(e) {
  ...
  switch (Z(t)) {
    ...
    case 3:
      return t.config.features.includes(p.S7.START_QUEST_CTA) ? g.intl.string(n ? g.t.CkUzLd : g.t["hRIVy+"]) : g.intl.string(g.t.l7E81v)
  }
}
...
function V(e) {
  ...
  let {
    ...
    quest: a
  }), c = null != s ? s : null == o ? true : o.platform, u = l ? (0, f.o9)({
    quest: a,
