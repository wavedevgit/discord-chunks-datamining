...
function v(e) {
  let t, {
    ...
    d = (0, l.f$)(n.config),
    _ = (0, l._p)(n.config);
  return O(t = a && d ? _ ? h.t["eb/SnZ"] : h.t.ziB0HB : d || null != o ? h.t.AwuMRU : h.t.NIimTk, {
    gameTitle: u,
...
function T(e) {
  let t, {
    ...
    d = (0, l.f$)(n.config),
    _ = (0, l._p)(n.config);
  return O(t = a && d ? _ ? h.t["eb/SnZ"] : h.t.ziB0HB : d || null != o ? h.t.AwuMRU : h.t.FZL5Q0, {
    gameTitle: u,
    streamingDurationRequirement: c,
    rewardNameWithArticle: s,
    duration: o,
...
function A(e, t, n, r, i) {
  var a;
  let o, s = f.r.build(e.config).defaultWatchVideoTask,
    c = null != (a = null == s ? void 0 : s.messages.videoTitle) ? a : "video",
    u = f.r.build(e.config).defaultRewardNameWithArticle,
    d = (0, l.f$)(e.config),
    p = (0, l._p)(e.config);
  return O(o = d && n ? p ? h.t["xqX+r6"] : h.t["vs/xBg"] : d || null != t ? h.t["W/HkLC"] : e.id === _.V6 ? h.t.Rsd5bG : i ? h.t["g+InPD"] : h.t.yMsQ7e, {
    videoTitle: c,
...
function C(e) {
  let t, {
    ...
    d = (0, l.f$)(n.config),
    _ = (0, l._p)(n.config);
  return O(t = a && d ? _ ? h.t["X8Yt//"] : h.t.smG9qq : d || null != o ? h.t.BLyDvL : h.t["hkJ+Gh"], {
    gameTitle: u,
    streamingDurationRequirement: c,
    duration: o,
    questReward: s
...
function R(e) {
  ...
  } = e, c = (0, o.I5)(a, p.p9.TIER_2), u = (0, l.Kr)(t.config);
...
function D(e) {
  ...
  return w(b(g({}, e), {
    ...
    withVideoQuestShortDescription: (0, d.z)({
      location: e.location
    })
  }))
}
...
function M(e) {
  ...
  return (0, c.f)({
    location: e,
    autoTrackExposure: t
  }) ? h.intl.string(h.t.Av9jcX) : h.intl.string(h.t.cfY4PD)
}