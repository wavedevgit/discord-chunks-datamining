...
function b(e) {
  let t, {
    ...
    f = (0, l.f$)(n.config),
    p = (0, l._p)(n.config);
  return v(t = o && f ? p ? _.t["eb/SnZ"] : _.t.ziB0HB : f || null != a ? _.t.AwuMRU : _.t.NIimTk, {
    gameTitle: u,
...
function O(e) {
  let t, {
    ...
    f = (0, l.f$)(n.config),
    p = (0, l._p)(n.config);
  return v(t = o && f ? p ? _.t["eb/SnZ"] : _.t.ziB0HB : f || null != a ? _.t.AwuMRU : _.t.FZL5Q0, {
    gameTitle: u,
    streamingDurationRequirement: c,
    rewardNameWithArticle: s,
    duration: a,
...
function S(e, t, n, r) {
  ...
  let s = null !== (o = null === (i = e.config.videoMetadata) || void 0 === i ? void 0 : i.messages.videoTitle) && void 0 !== o ? o : "video",
    ...
    u = (0, l.f$)(e.config),
    f = (0, l._p)(e.config);
  return v(a = u && n ? f ? _.t["xqX+r6"] : _.t["vs/xBg"] : u ? _.t["W/HkLC"] : _.t.yMsQ7e, {
    videoTitle: s,
...
function N(e) {
  let t, {
    ...
    f = (0, l.f$)(n.config),
    p = (0, l._p)(n.config);
  return v(t = o && f ? p ? _.t["X8Yt//"] : _.t.smG9qq : f || null != a ? _.t.BLyDvL : _.t["hkJ+Gh"], {
    gameTitle: u,
    streamingDurationRequirement: c,
    duration: a,
    questReward: s
