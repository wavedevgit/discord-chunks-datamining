...
function T(e, t, n, r) {
  var i, a;
  let o, s = null != (a = null == (i = e.config.videoMetadata) ? void 0 : i.messages.videoTitle) ? a : "video",
    c = d.r.build(e.config).defaultReward.messages.nameWithArticle,
    u = (0, l.f$)(e.config),
    _ = (0, l._p)(e.config);
  return y(o = u && n ? _ ? p.t["xqX+r6"] : p.t["vs/xBg"] : u || null != t ? p.t["W/HkLC"] : e.id === f.V6 ? p.t.Rsd5bG : p.t.yMsQ7e, {
    videoTitle: s,
...
function A(e) {
  let {
    ...
    taskDetails: n,
    withoutMarkdown: r
  } = e, i = n.targetMinutes, a = d.r.build(t.config).defaultReward.messages.nameWithArticle;
  return y(p.t.VYwSSk, {
    streamingDurationRequirement: i,
    questReward: a
  }, r)
