...
function O(e) {
  let t, {
    ...
    f = (0, l.f$)(n.config),
    _ = (0, l._p)(n.config);
  return y(t = a && f ? _ ? p.t["eb/SnZ"] : p.t.ziB0HB : f || null != o ? p.t.AwuMRU : p.t.NIimTk, {
    gameTitle: u,
...
function I(e) {
  let t, {
    ...
    f = (0, l.f$)(n.config),
    _ = (0, l._p)(n.config);
  return y(t = a && f ? _ ? p.t["eb/SnZ"] : p.t.ziB0HB : f || null != o ? p.t.AwuMRU : p.t.FZL5Q0, {
    gameTitle: u,
    streamingDurationRequirement: c,
    rewardNameWithArticle: s,
    duration: o,
...
function S(e, t, n, r, i) {
  var a;
  let o, s = d.r.build(e.config).defaultWatchVideoTask,
    c = null != (a = null == s ? void 0 : s.messages.videoTitle) ? a : "video",
    u = d.r.build(e.config).defaultRewardNameWithArticle,
    _ = (0, l.f$)(e.config),
    h = (0, l._p)(e.config);
  return y(o = _ && n ? h ? p.t["xqX+r6"] : p.t["vs/xBg"] : _ || null != t ? p.t["W/HkLC"] : e.id === f.V6 ? p.t.Rsd5bG : i ? p.t["g+InPD"] : p.t.yMsQ7e, {
    videoTitle: c,
...
function A(e) {
  let {
    ...
    taskDetails: n,
    withoutMarkdown: r
  } = e, i = n.targetMinutes, a = d.r.build(t.config).defaultRewardNameWithArticle;
  return y(p.t.VYwSSk, {
    streamingDurationRequirement: i,
    questReward: a
  }, r)
...
function N(e) {
  let t, {
    ...
    f = (0, l.f$)(n.config),
    _ = (0, l._p)(n.config);
  return y(t = a && f ? _ ? p.t["X8Yt//"] : p.t.smG9qq : f || null != o ? p.t.BLyDvL : p.t["hkJ+Gh"], {
    gameTitle: u,
    streamingDurationRequirement: c,
    duration: o,
    questReward: s
...
function C(e) {
  let {
    ...
    withoutMarkdown: i,
    currentUser: a,
    withVideoQuestShortDescription: s = !1
  } = e, c = (0, o.I5)(a, _.p9.TIER_2), u = (0, l.Kr)(t.config);
  if ((0, l.$J)(t) && (0, l.$H)(t)) return O({
    quest: t,
    taskDetails: n,
    withoutMarkdown: i,
    hasNitro: c,
...
function w(e) {
  let {
    ...
    questContent: n,
    sourceQuestContent: r
  }), l = (0, i.e7)([a.default], () => a.default.getCurrentUser()), c = (0, s.Jf)(t);
  return P(E(m({}, e), {
    connectedConsoleLinkOnClick: o,
    withoutMarkdown: !1,
    currentUser: l,
    thirdPartyTaskDetails: null != c ? c : void 0,
    withVideoQuestShortDescription: (0, u.z)({
      location: e.location
    })
  }))
}
