...
function I(e, t, n, r) {
  ...
  let a, o = u.r.build(e.config).defaultWatchVideoTask,
    ...
    f = (0, s.f$)(e.config),
    p = (0, s._p)(e.config);
  return E(a = f && n ? p ? _.t["xqX+r6"] : _.t["vs/xBg"] : f || null != t ? _.t["W/HkLC"] : e.id === d.V6 ? _.t.Rsd5bG : _.t["g+InPD"], {
    videoTitle: l,
...
function S(e) {
  let t, {
    ...
    f = (0, s.f$)(n.config),
    p = (0, s._p)(n.config);
  return E(t = a && f ? p ? _.t["X8Yt//"] : _.t.smG9qq : f || null != o ? _.t.BLyDvL : _.t["hkJ+Gh"], {
    gameTitle: d,
    streamingDurationRequirement: c,
    duration: o,
    questReward: l
...
function A(e) {
  let {
    ...
    onGameSheetOpened: o,
    onGameSheetClosed: s
  } = e, l = u.r.build(t.config).defaultRewardNameWithArticle, {
    targetMinutes: d,
    applications: f
  } = n;
  if (i) return _.intl.formatToPlainString(_.t["1votFx"], {
    rewardNameWithArticle: l,
    targetMinutes: d
  });
  let p = (0, c.C)({
...
function C(e) {
  let {
    ...
    onGameSheetOpened: u,
    onGameSheetClosed: d
  } = e, _ = (0, o.I5)(l, f.p9.TIER_2), p = (0, s.Kr)(t.config), h = (0, s.$J)(t) && (0, s.$H)(t);
