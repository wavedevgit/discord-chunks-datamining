...
function k(t) {
  let {
    ...
    onClose: j,
    transitionState: N
  } = t, y = (0, c.Dt)(), T = (0, d.q)("MaskedLinkModal"), {
    protocol: E,
    authorityPrefix: I,
    hostname: M,
    theRestOfTheUrl: R,
    ...
    D(), h.default.track(g.rMx.MASKED_LINK_MODAL_CLICKED, {
      is_trust_url_selected: A,
      action_type: "confirm"
    })
  }, X = () => {
    L(), h.default.track(g.rMx.MASKED_LINK_MODAL_CLICKED, {
      is_trust_url_selected: A,
      action_type: "cancel"
    })
  };
  ...
  let {
    ...
    children: t => {
      ...
      return e === r.z.NITRO_PRIVATE_BROWSING_SURVEY ? (0, a.jsx)(u.f, {
        onClose: () => n(p.L.TAKE_ACTION)
      }) : null
    }
  }) : null;
  return T ? (0, a.jsxs)(l.Modal, {
    size: "md",
    transitionState: N,
    onClose: j,
    ...
    children: [(0, a.jsxs)(s.Ttm, {
      ...
      children: (0, a.jsx)(s.Text, {
        ...
        children: k ? _.intl.format(_.t["haA+X1"], {
          protocol: E.replace(":", "")
        }) : _.intl.format(_.t.ZgXDsL, {
          domain: M
        })
      })
    }), z]
