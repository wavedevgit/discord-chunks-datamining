...
function b(e) {
  let {
    ...
    onClose: g,
    transitionState: j
  } = e, v = (0, c.Dt)(), y = (0, s.q)("MaskedLinkModal"), {
    protocol: O,
    authorityPrefix: C,
    hostname: k,
    theRestOfTheUrl: N,
    ...
    M(), d.default.track(h.rMx.MASKED_LINK_MODAL_CLICKED, {
      is_trust_url_selected: S,
      action_type: "confirm"
    })
  }, L = () => {
    T(), d.default.track(h.rMx.MASKED_LINK_MODAL_CLICKED, {
      is_trust_url_selected: S,
      action_type: "cancel"
    })
  };
  return (0, o.Z)({
    ...
    children: [(0, r.jsxs)(a.Ttm, {
      ...
      children: (0, r.jsx)(a.Text, {
        ...
        children: b ? x.intl.format(x.t["haA+X1"], {
          protocol: O.replace(":", "")
        }) : x.intl.format(x.t.ZgXDsL, {
          domain: k
        })
      })
    })]
