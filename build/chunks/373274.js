...
class ef extends(r = l.PureComponent) {
    ...
    if (null != l && null != i)
      if (null != l.threadOffset) {
        let [e] = i.getScrollPosition(l.section, l.row), {
          ...
          density: a = "default"
        } = this.props, s = l.threadOffset * ep(o, a);
  ...
  isUnreadVisible() {
    ...
    return null != t && t.getItems().some(n => {
      ...
      return !!(0, Z.vc)(o.record.type) && (!a.isCollapsed || !a.isMuted) && !o.isMuted && !!t.isItemVisible(r, i, !0) && (0, I.d)(o.record)
    })
  }
  renderTopUnread() {
    let {
  ...
  constructor(...e) {
    super(...e), ec(this, "_list", null), ec(this, "unreadTopRef", l.createRef()), ec(this, "unreadBottomRef", l.createRef()), ec(this, "state", {
      ...
      let {
        category: b,
        channel: _
      } = m, y = b instanceof R.VR, v = _.record, x = "".concat(t).concat(_.id);
      switch (v.type) {
      ...
      if (!E.Z.shouldShow("voice-conversations")) return;
      let {
        guildChannels: e
...
let eg = e => {
  ...
  } = (0, b.ZP)(m.Z.GUILD_CHANNEL_LIST), d = (0, u.e7)([w.Z], () => w.Z.getChannel(n)), p = (0, u.e7)([w.Z], () => w.Z.getChannel(r)), h = (0, u.e7)([D.Z], () => D.Z.getGuildId()), _ = (0, S.DM)(t), v = l.useRef(null), O = l.useCallback((e, t) => {
    let n = v.current;
    if (null != n)
