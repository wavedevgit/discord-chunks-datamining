...
class eb extends(r = l.PureComponent) {
  ...
  constructor(...e) {
    super(...e), ep(this, "_list", null), ep(this, "unreadTopRef", l.createRef()), ep(this, "unreadBottomRef", l.createRef()), ep(this, "state", {
    ...
    }), ep(this, "jumpToChannel", e => this.scrollToChannel(e, !0, es.Q1)), ep(this, "jumpToChannelWithMentionsAndUnreads", (e, t) => {
      let [n, r] = t;
    ...
    }), ep(this, "updateChannelListScroll", a().throttle(e => {
      ...
      if (u.record.isGuildVoice()) {
        ...
        if (null != e && e.length > 0) {
          let t = 32 * e.length;
          (u.isCollapsed || d.isCollapsed) && (t = 32), s += t + h.TVs.space.SPACE_XS.resolve({
            density: a
          })
        }
...
ep(eb, "contextType", s.qB), ep(eb, "defaultProps", {
  density: "default"
});
let e_ = e => {
  let {
    ...
    let n = y.current;
    if (null != n)
      if (ec.Xyh.test(t) || (0, eu.AB)(t)) n.scrollToChannel(t, !1, 2 * es.yE, () => {
