...
class e_ extends(r = l.PureComponent) {
  componentDidMount() {
    this.setState({
      initialized: !0
    }), (0, V.Q5)(this.getVisibleChannels)
  }
  ...
  constructor(...e) {
    ...
    }), ef(this, "jumpToChannel", e => this.scrollToChannel(e, !0, ec.Q1)), ef(this, "jumpToChannelWithMentionsAndUnreads", (e, t) => {
      let [n, r] = t;
...
ef(e_, "contextType", s.qB), ef(e_, "defaultProps", {
  density: "default"
});
let eO = e => {
  let {
