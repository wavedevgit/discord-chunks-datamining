...
class ef extends(r = o.PureComponent) {
  ...
  scrollToChannel(e) {
    ...
    if (null != o && null != i) {
      if (null != o.threadOffset) {
        let [e] = i.getScrollPosition(o.section, o.row), {
          isRefreshEnabled: l = !1,
          density: a = "default"
        } = this.props, s = o.threadOffset * ep(l, a);
  ...
  isUnreadVisible() {
    ...
    return null != t && t.getItems().some(n => {
      ...
      return !!(0, E.vc)(l.record.type) && (!a.isCollapsed || !a.isMuted) && !l.isMuted && !!t.isItemVisible(r, i, !0) && (0, I.d)(l.record)
    })
  }
  renderTopUnread() {
    let {
  ...
  renderList() {
    ...
    let c = this.context,
      ...
      h = 0;
    null != n ? h = l ? ei.hl : ei.Q0 : t.hasCommunityInfoSubheader() && !r && (h = ei.JD);
    let f = l && "compact" === a ? 8 : ei.$k;
  ...
  constructor(...e) {
    super(...e), ec(this, "_list", null), ec(this, "unreadTopRef", o.createRef()), ec(this, "unreadBottomRef", o.createRef()), ec(this, "state", {
      ...
      if (p.record.type === eo.d4z.GUILD_CATEGORY) return 40;
      let {
        isFavoritesPerk: f
      ...
      for (let e of (f && l === eo.I_8 && !p.record.isDM() && !p.record.isGroupDM() && !p.record.isGuildStageVoice() && (c = this.props.isRefreshEnabled ? 46 : ei.GQ), p.threadIds)) {
        let {
        ...
        c += ep(t, n);
        let i = r[p.id];
        null != i && i.length > 0 && (c += o === e ? i.length * eh(this.props.isRefreshEnabled) : eh(this.props.isRefreshEnabled), c += ei.cx)
      }
      if (p.record.isGuildVoice()) {
        let e = r[p.id];
        if (null != e && e.length > 0) {
          let t = e.length * eh(this.props.isRefreshEnabled);
          (p.isCollapsed || h.isCollapsed) && (t = eh(this.props.isRefreshEnabled)), c += t + (a ? d.TVs.space.SPACE_XS.resolve({
            density: s
          }) : ei.cx)
        }
      ...
      if (null != p.subtitle && (c += ei.NY), p.record.isGuildStageVoice()) {
        var g, m;
        let e = null !== (g = r[p.id]) && void 0 !== g ? g : [],
          t = null !== (m = i[p.id]) && void 0 !== m ? m : [];
        if (null != e && e.length > 0) {
...
ec(ef, "contextType", s.qB), ec(ef, "defaultProps", {
  isRefreshEnabled: !1,
  density: "default"
});
let eg = e => {
  ...
  } = (0, b.ZP)(m.Z.GUILD_CHANNEL_LIST), d = (0, u.e7)([w.Z], () => w.Z.getChannel(n)), p = (0, u.e7)([w.Z], () => w.Z.getChannel(r)), h = (0, u.e7)([D.Z], () => D.Z.getGuildId()), v = (0, S.DM)(t), _ = o.useRef(null), O = o.useCallback((e, t) => {
    let n = _.current;
    if (null != n) {
