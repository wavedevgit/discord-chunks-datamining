...
function p(e) {
  ...
  return r.useEffect(() => {
    if (b && null != j) {
      ...
      null == (t = P.current) || null == (e = t.ref) || e.focus()
  ...
  }, [b, j]), <div className={d.imageSelectionContainer}>{<o.tEY within={true}><div className={a()(d.uploadButton, {
          [d.disabled]: q,
          [d.hidden]: null != v
        })} aria-disabled={q}>{<o.FmF size={"xs"} color={"currentColor"} aria-hidden={true} />}{<o.Text variant={"text-xxs/normal"} color={"text-muted"} aria-hidden={true}>{h}</o.Text>}{<i.ZP ref={V} tabIndex={0} onChange={(e, t) => {
            null != t && (U(t.name), x(e), m(e, f))
          }} aria-label={h} />}</div></o.tEY>}{null != v && <div className={d.customImageActionContainer}>{<o.ua7 text={s.intl.string(s.t.AQYXMD)} hideOnClick={true}>{e => (0, n.jsx)(o.P3F, u(c({}, e), {
        ...
        }))}</o.ua7>}{<o.ua7 text={s.intl.string(s.t.WxqWU1)} hideOnClick={true}>{e => (0, n.jsx)(o.P3F, u(c({}, e), {
          className: d.customImageAction,
          onClick: K,
