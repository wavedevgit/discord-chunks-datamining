...
let O = e => {
  let {
    ...
    messageId: O,
    reportedTimestamp: v
  } = e, S = _.default.getUser(t), I = i.useMemo(() => a ? (0, f.Z)((0, h.vc)(l()(), "LT")) : null, [a]), T = (0, p.l)({
    user: S,
    channelId: s.id,
    guildId: n,
    messageId: O
  })((0, u.JZ)(S, s)), C = null != S ? S.getAvatarURL(n, (0, c.dcp)(c.EFr.SIZE_16)) : y, A = null != S ? g.intl.format(m.default["+zqXZs"], {
    username: S.username,
    onUserClick: T
