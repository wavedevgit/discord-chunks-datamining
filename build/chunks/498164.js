...
let w = {
  ...
  [Z.Etm.GUILD_TEMPLATE_BROWSER]: {
    ...
    async handler(e) {
      ...
      let {
        guildTemplate: i
      } = await O.Z.resolveGuildTemplate(t);
      ...
      return new Promise((e, i) => {
        a.Z.wait(() => {
          d.Z.resolveGiftCode(t, !0, !0).then(i => {
            ...
            P.ZP.focus(), S.default.track(Z.rMx.OPEN_MODAL, {
              type: "gift_accept",
              location: Z.SaU
            }), (0, l.ZDy)(async () => {
              let {
      ...
      switch (P.ZP.focus(), t) {
        ...
        case A.jE.QUEST_HOME:
          null != n ? ((0, y.dL)({
            ...
            hash: n.questId
          }), L(n.fingerprint, (0, A.O)(t))) : (0, y.dL)(Z.Z5c.QUEST_HOME);
          break;
  ...
  [Z.Etm.CONNECTIONS_CALLBACK]: {
    ...
    handler: async e => {
      ...
      if (!_.g.getCurrentConfig({
        ...
        }).enabled && !v.Z.hasPendingAuthorizedState(l)) throw new j.Z({
        errorCode: Z.lTL.INVALID_CONNECTION_CALLBACK_STATE
      }, "Provider authorization did not originate from this discord client");
      try {
        return v.Z.deletePendingAuthorizedState(l), await u.Z.callback(t, {
          code: n,
          openid_params: r,
          iss: i,
          state: l
