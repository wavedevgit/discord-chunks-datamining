  ...
  [C.Etm.GUILD_TEMPLATE_BROWSER]: {
    ...
    async handler(e) {
      ...
      return v.ZP.focus(), (0, l.ZDy)(async () => {
        let {
          default: e
        } = await Promise.all([n.e("10778"), n.e("99138")]).then(n.bind(n, 766775));
        return t => {
          var n, l;
        ...
        o.Z.wait(() => {
          u.Z.resolveGiftCode(t, !0, !0).then(i => {
            ...
            v.ZP.focus(), E.default.track(C.rMx.OPEN_MODAL, {
              ...
              let {
                default: e
              } = await Promise.all([n.e("92446"), n.e("56309")]).then(n.bind(n, 409858));
      ...
      switch (v.ZP.focus(), t) {
        ...
        case I.jE.QUEST_HOME:
          null != n ? ((0, g.dL)({
            ...
            hash: n.questId
          }), T(n.fingerprint, (0, I.O)(t))) : (0, g.dL)(C.Z5c.QUEST_HOME);
          break;
        ...
        case I.jE.FEATURES:
        case I.jE.SHOP:
          (null == n ? void 0 : n.path) != null && ((0, g.dL)({
            pathname: n.path
          }), T(n.fingerprint, (0, I.O)(t)))
      }
    }
