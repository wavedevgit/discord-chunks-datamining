...
function Z(e, t) {
  null != e && I.default.track(A.rMx.EXTERNAL_DYNAMIC_LINK_RECEIVED, {
    invite_code: null,
    has_auth_token: null,
      ...
      return new Promise((e, i) => {
        a.Z.wait(() => {
          d.Z.resolveGiftCode(t, !0, !0).then(i => {
            ...
            N.ZP.focus(), I.default.track(A.rMx.OPEN_MODAL, {
              type: "gift_accept",
              location: A.SaU
            }), (0, l.ZDy)(async () => {
              let {
                default: e
              } = await Promise.all([n.e("92446"), n.e("51139")]).then(n.bind(n, 409858));
      ...
      switch (N.ZP.focus(), t) {
        ...
        case j.jE.QUEST_HOME:
          null != n ? ((0, E.dL)({
            ...
            hash: n.questId
          }), Z(n.fingerprint, (0, j.O)(t))) : (0, E.dL)(A.Z5c.QUEST_HOME);
          break;
        ...
        case j.jE.FEATURES:
        case j.jE.SHOP:
          (null == n ? void 0 : n.path) != null && ((0, E.dL)({
            pathname: n.path
          }), Z(n.fingerprint, (0, j.O)(t)));
          break;
        case j.jE.ACTIVITIES:
          ...
          }(n.applicationId, n.url), Z(n.fingerprint, (0, j.O)(t)), !0;
          return !1
      }
    }
  },
  ...
  [A.Etm.CONNECTIONS_CALLBACK]: {
    ...
    handler: async e => {
      ...
      try {
        ...
        if ((null == e ? void 0 : e.status) === 400) throw new T.Z({
