...
function E(e) {
  ...
  return x && !P && !N || E || w || (A = <a.IGR color={s.Z.colors.BADGE_BRAND_BG.css} text={v.intl.string(v.t.y2b7CA)} className={j.newChannel} />), <O.m id={"channels-".concat(t.id)} renderIcon={e => (0, r.jsx)(a.H$4, {
      size: "md",
      color: "currentColor",
      className: e
    })} text={S ? v.intl.string(v.t.h9mGOD) : v.intl.string(v.t.et6wam)} selected={E} onClick={Z} onContextMenu={T} trailing={A} />
}