...
function m(e) {
  ...
  return <l.Fragment>{<u.Z.SlideHeader onClose={g} headerAlignStart={x} />}{null != j && <u.Z.SlideContent><u.Z.SlideError error={j} /></u.Z.SlideContent>}{<u.Z.SlideFooter mfaChallenge={t} setSlide={m} leadingButton={(0, l.jsx)(a.zxk, {
        variant: "primary",
