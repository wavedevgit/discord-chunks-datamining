...
let E = e => {
  ...
  } = (0, _.o)(), C = (0, v.z)(t.id), T = t.id === E, N = !t.available && !t.temporarilyAvailable, A = t.temporarilyAvailable && !n && !T, w = !T && t.id === P, [D, Z] = i.useState(false);
  i.useEffect(() => {
    let e = w ? setTimeout(() => Z(w), 200) : true;
    return () => {
  ...
  let L = (0, h.J_)({
    ...
    k = null == C ? true : C.previewSoundURLs,
    [U, R] = i.useState(0),
    {
      isPlaying: V,
      playSound: F,
      stopSound: G,
      preloadSound: B
    } = (0, d.Z)(null != k ? k[U] : null, {
      soundId: t.id
    }),
    W = I[t.styleKey],
    H = i.useCallback(() => {
      n || !N ? ((0, m.v6)(E === t.id ? null : t.id, l), A && f.default.track(y.rMx.VOICE_FILTER_LIMITED_TIME_VOICE_SELECTED, j({
        voice_filter_id: t.id
      }, (0, g.w)(l)))) : (0, u.i)()
    }, [n, N, E, t.id, l, A]),
    Y = i.useCallback(() => {
      f.default.track(y.rMx.VOICE_FILTER_PREVIEW_PLAYED, j({
        voice_filter_id: t.id
      }, (0, g.w)(l))), F({
        volume: .5,
        outputChannel: O.w.VOICE
      }), (.25 > Math.random() || U > 0) && null != k && R(e => (e + 1) % k.length)
    }, [l, F, U, k, t.id]),
  ...
  return (0, r.jsxs)("div", {
    ...
    }), null != k && (0, r.jsx)(c.ua7, {
      text: S.intl.string(V ? S.t.ItuPbm : S.t["0gtbEx"]),
      children: e => (0, r.jsx)(c.P3F, x(j({}, e), {
        className: a()([I.hoverButtonCircle, I.previewButton], {
          [I.visible]: V
        }),
        onClick: V ? G : Y,
        "aria-label": S.intl.formatToPlainString(S.t.gDzvjY, {
          voiceFilterName: z
        }),
