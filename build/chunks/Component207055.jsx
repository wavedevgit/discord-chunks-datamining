...
let U = Chunk473749.memo(e => {
  ...
  }), G = (0, o.e7)([A.Z], () => A.Z.getVoiceVolume(T), [T]), z = (0, o.e7)([A.Z], () => A.Z.isCurrentUserPTTLatched()), W = k && z, q = (0, o.e7)([P.ZP], () => P.ZP.isGuestOrLurker(y.guild_id, T)), K = (0, o.e7)([h.Z], () => h.Z.getGuildRingingUsers(y.id).has(T)), Y = (0, o.e7)([u.ZP], () => u.ZP.getEmbeddedActivitiesForChannel(y.id).find(e => {
    let {
      userIds: t
    } = e;
    return t.has(T)
  }), [T, y.id]), X = (0, p.Z)(null != Y ? [Y.applicationId] : []), J = (0, O.Z)(T, y.guild_id)[0], Q = null != (n = (0, d.IX)(null == J ? true : J.application_id).data) ? n : true, [$, ee] = (0, o.Wu)([j.Z], () => [j.Z.getStreamForUser(T, y.getGuildId()), j.Z.getActiveStreamForUser(T, y.getGuildId())], [y, T]), et = (0, o.e7)([N.Z], () => N.Z.getSessionById(E)), en = M.ZP.useName(C), ei = (0, o.e7)([w.Z], () => w.Z.getVoicePlatformForChannel(y.id, T), [y.id, T]), {
    enableHangStatus: er
  } = (0, m.bN)({
    guildId: y.guild_id,
    location: "VoiceUsers"
  }), el = (0, f.ZP)(y, true, C), ea = (0, o.e7)([g.Z], () => k ? g.Z.getHangStatusActivity() : null, [k]), eo = (0, b.j)(T), es = (0, x.Eu)(y.id, T), {
