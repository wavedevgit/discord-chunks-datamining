...
let U = Chunk647438.memo(e => {
  ...
  let {
    ...
    sessionId: O,
    nick: Z
  } = e, T = y.id, k = (0, o.e7)([S.default], () => S.default.getId() === T, [T]), [U, B, H] = (0, o.Wu)([I.Z], () => k ? [!I.Z.isSupported() || I.Z.isSelfMute() || I.Z.isSelfMutedTemporarily(), I.Z.isSelfDeaf(), false] : [!I.Z.isSupported() || I.Z.isLocalMute(T), false, I.Z.isLocalVideoDisabled(T)], [k, T]), V = (0, o.e7)([A.Z], () => A.Z.isPrioritySpeaker(T)), F = (0, c.Z)({
    userId: T,
    ...
    guildId: C.guild_id,
    location: "VoiceUsers"
  }), er = (0, f.ZP)(C, true, y), el = (0, o.e7)([g.Z], () => k ? g.Z.getHangStatusActivity() : null, [k]), ea = (0, b.j)(T), eo = (0, j.Eu)(C.id, T), {
