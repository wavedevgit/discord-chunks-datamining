...
let L = Chunk647438.memo(e => {
  ...
  let {
    ...
    sessionId: P,
    nick: D
  } = e, L = v.id, k = (0, o.e7)([j.default], () => j.default.getId() === L, [L]), [U, B, G] = (0, o.Wu)([S.Z], () => k ? [!S.Z.isSupported() || S.Z.isSelfMute() || S.Z.isSelfMutedTemporarily(), S.Z.isSelfDeaf(), false] : [!S.Z.isSupported() || S.Z.isLocalMute(L), false, S.Z.isLocalVideoDisabled(L)], [k, L]), H = (0, o.e7)([T.Z], () => T.Z.isPrioritySpeaker(L)), F = (0, c.Z)({
    userId: L,
...
let k = [],
  U = function(e) {
    ...
    return null == G && null == _ ? null : (0, r.jsxs)(v.eJ, {
