...
let k = [],
  U = function(e) {
    let {
      ...
      children: C,
      isThread: v = false
    } = e, [O, E] = r.useState(null), [S, Z] = r.useState(false), T = r.useRef(null), N = (0, _.Es)(l.id, null != c ? c : k), A = r.useRef(new s.sW(50, () => {
