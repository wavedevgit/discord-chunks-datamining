...
let l = e => {
    var t, n;
    return (null == (t = e.features) ? true : t.includes(o.GuildFeatures.MEMBER_VERIFICATION_GATE_ENABLED)) && (null == (n = e.features) ? true : n.includes(o.GuildFeatures.MEMBER_VERIFICATION_MANUAL_APPROVAL))
  },
  c = e => {
