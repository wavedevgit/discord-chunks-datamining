...
function O() {
  let [e, t] = Chunk647438.useState(() => E ? y() : true);
...
function et() {
  ...
  if (require.overflow = "hidden", require.setProperty(ee, Chunk647438 + "px"), Chunk647438 && (require[r] = Chunk647438 + "px"), exports) {
    var l, c;
    let e = (null == (l = window.visualViewport) ? true : Chunk603113.offsetLeft) || 0;
    Object.assign(require, {
      position: "fixed",
      top: -(Chunk274676 - Math.floor((null == (c = window.visualViewport) ? true : Chunk863785.offsetTop) || 0)) + "px",
      left: -(Chunk951288 - Math.floor(module)) + "px",
      right: "0"
    })
  }
  return () => {
    Object.assign(require, {
      ...
      left: "",
      right: ""
    }), window.scrollTo(Chunk951288, Chunk274676))
  }
}
let en = () => {},
