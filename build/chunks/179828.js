...
function x(e) {
  let {
    ...
    onAddRole: p,
    onRemoveRole: m
  } = e, g = f && null != a, x = o.useRef(null), _ = o.useMemo(() => "roles-".concat((0, i.Z)()), []), O = (0, l.ZP)({
    id: _,
    isEnabled: !0,
    scrollToStart: j.Cyb,
    scrollToEnd: j.Cyb,
    wrap: !0
  }), Z = d.length, N = 0 === Z ? h.NW.string(h.t["vR7M+/"]) : h.NW.formatToPlainString(h.t.PCs0oq, {
    numRoles: Z
  }), P = d.map(e => {
    var o;
    return (0, r.jsx)(I.Z, {
...
function _(e) {
  ...
  } = (0, m.KZ)(), I = (0, c.e7)([u.ZP], () => u.ZP.getMember(i.id, n.id)), y = (0, c.e7)([f.Z], () => f.Z.getRoles(i.id)), v = null == I ? void 0 : I.roles, _ = o.useMemo(() => null == v || 0 === v.length ? [] : Object.values(y).filter(e => v.includes(e.id)).sort((e, n) => {
    var t, r;
    let o = (null == (t = e.tags) ? void 0 : t.guild_connections) !== null,
      i = (null == (r = n.tags) ? void 0 : r.guild_connections) !== null;
    return o && !i ? 1 : !o && i ? -1 : 0
  }), [y, v]), O = b.e9(i, t.id), [Z] = (0, c.Wu)([p.Z], () => [p.Z.can(j.Plq.MANAGE_ROLES, i), null != i ? p.Z.getGuildVersion(i.id) : null]), N = o.useCallback(e => {
    var t, r;
    s({
      action: "REMOVE_ROLE"
    });
