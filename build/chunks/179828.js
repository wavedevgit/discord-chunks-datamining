...
function x(e) {
  let {
    ...
    onAddRole: p,
    onRemoveRole: m
  } = e, h = f && null != a, x = r.useRef(null), _ = r.useMemo(() => "roles-".concat((0, i.Z)()), []), Z = (0, l.ZP)({
    id: _,
    isEnabled: !0,
    scrollToStart: y.Cyb,
    scrollToEnd: y.Cyb,
...
function _(e) {
  ...
  } = (0, m.KZ)(), I = (0, c.e7)([u.ZP], () => u.ZP.getMember(i.id, n.id)), g = (0, c.e7)([f.Z], () => f.Z.getRoles(i.id)), v = null == I ? void 0 : I.roles, _ = r.useMemo(() => null == v || 0 === v.length ? [] : Object.values(g).filter(e => v.includes(e.id)).sort((e, n) => {
    var t, o;
    let r = (null == (t = e.tags) ? void 0 : t.guild_connections) !== null,
      i = (null == (o = n.tags) ? void 0 : o.guild_connections) !== null;
    return r && !i ? 1 : !r && i ? -1 : 0
  }), [g, v]), Z = b.e9(i, t.id), [O] = (0, c.Wu)([p.Z], () => [p.Z.can(y.Plq.MANAGE_ROLES, i), null != i ? p.Z.getGuildVersion(i.id) : null]), N = r.useCallback(e => {
    var t, o;
    s({
      action: "REMOVE_ROLE"
    });
  ...
  }, [v, i.id, n.id, s]), E = r.useCallback(e => {
    s({
      action: "ADD_ROLE"
    });
    let t = null != v ? v : []; - 1 === t.indexOf(e) && (t = t.concat([e])), d.Z.updateMemberRoles(i.id, n.id, t, [e], [])
  }, [v, i.id, n.id, s]), P = O && null != I;
  return 0 !== _.length || P ? (0, o.jsx)(h.Z, {
