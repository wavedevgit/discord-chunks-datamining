...
function E(e) {
  let {
    ...
    onAddRole: p,
    onRemoveRole: g
  } = e, j = f && null != c, m = r.useRef(null), E = r.useMemo(() => "roles-".concat((0, i.Z)()), []), T = (0, o.ZP)({
    id: E,
    isEnabled: !0,
    scrollToStart: x.Cyb,
    scrollToEnd: x.Cyb,
    wrap: !0
  }), S = u.length, N = 0 === S ? O.intl.string(O.t["vR7M+/"]) : O.intl.formatToPlainString(O.t.PCs0oq, {
    numRoles: S
  }), A = u.map(e => {
    var r;
    return (0, l.jsx)(h.Z, {
...
function T(e) {
  ...
  } = (0, j.KZ)(), h = (0, a.e7)([p.Z], () => p.Z.getGuild(i)), b = (0, a.e7)([f.Z], () => f.Z.getRoles(i)), y = (0, a.e7)([d.ZP], () => d.ZP.getMember(i, n.id)), T = null == y ? void 0 : y.roles, S = r.useMemo(() => null == T || 0 === T.length ? [] : Object.values(b).filter(e => T.includes(e.id)).sort((e, n) => {
    var t, l;
    let r = (null == (t = e.tags) ? void 0 : t.guild_connections) !== null,
      i = (null == (l = n.tags) ? void 0 : l.guild_connections) !== null;
    return r && !i ? 1 : !r && i ? -1 : 0
  }), [b, T]), [N] = (0, a.Wu)([g.Z], () => [g.Z.can(x.Plq.MANAGE_ROLES, h), g.Z.getGuildVersion(i)]), A = r.useCallback(e => {
    var t, l;
    s({
      action: "REMOVE_ROLE"
    });
