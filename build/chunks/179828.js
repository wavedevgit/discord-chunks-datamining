...
function x(e) {
  let {
    ...
    scrollToEnd: I.Cyb,
    wrap: !0
  }), O = d.length, Z = 0 === O ? j.NW.string(j.t["vR7M+/"]) : j.NW.formatToPlainString(j.t.PCs0oq, {
    numRoles: O
  }), N = d.map(e => {
    var o;
    return (0, r.jsx)(g.Z, {
...
function _(e) {
  ...
  } = (0, m.KZ)(), g = (0, c.e7)([u.ZP], () => u.ZP.getMember(i.id, n.id)), y = (0, c.e7)([f.Z], () => f.Z.getRoles(i.id)), h = null == g ? void 0 : g.roles, _ = o.useMemo(() => null == h || 0 === h.length ? [] : Object.values(y).filter(e => h.includes(e.id)).sort((e, n) => {
    var t, r;
    let o = (null === (t = e.tags) || void 0 === t ? void 0 : t.guild_connections) !== null,
      i = (null === (r = n.tags) || void 0 === r ? void 0 : r.guild_connections) !== null;
    return o && !i ? 1 : !o && i ? -1 : 0
  }), [y, h]), O = b.e9(i, t.id), [Z] = (0, c.Wu)([p.Z], () => [p.Z.can(I.Plq.MANAGE_ROLES, i), null != i ? p.Z.getGuildVersion(i.id) : null]), N = o.useCallback(e => {
    var t, r;
    s({
      action: "REMOVE_ROLE"
    });
