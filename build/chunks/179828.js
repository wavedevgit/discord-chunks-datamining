...
function _(e) {
  ...
  } = (0, m.KZ)(), v = (0, c.e7)([u.ZP], () => u.ZP.getMember(i.id, n.id)), y = (0, c.e7)([f.Z], () => f.Z.getRoles(i.id)), h = null == v ? void 0 : v.roles, _ = o.useMemo(() => null == h || 0 === h.length ? [] : Object.values(y).filter(e => h.includes(e.id)).sort((e, n) => {
    var t, r;
