...
function T(e) {
  let {
    ...
    onAddRole: p,
    onRemoveRole: h
  } = e, v = f && null != a, j = r.useRef(null), b = r.useMemo(() => "roles-".concat((0, i.Z)()), []), T = (0, o.ZP)({
    id: b,
    isEnabled: !0,
    scrollToStart: Z.Cyb,
    scrollToEnd: Z.Cyb,
    wrap: !0
  }), S = c.length, N = 0 === S ? y.intl.string(y.t["vR7M+/"]) : y.intl.formatToPlainString(y.t.PCs0oq, {
    numRoles: S
  }), A = c.map(e => {
    var r;
    return (0, l.jsx)(m.Z, {
...
function S(e) {
  ...
  } = (0, v.KZ)(), m = (0, d.e7)([p.Z], () => p.Z.getGuild(i)), x = (0, d.e7)([u.ZP], () => u.ZP.getMember(i, n.id)), O = null == x ? void 0 : x.roles, S = (0, d.Wu)([f.Z], () => f.Z.getManyRoles(i, null != O ? O : []).sort(j.Z), [O, i]), [N] = (0, d.Wu)([h.Z], () => [h.Z.can(Z.Plq.MANAGE_ROLES, m), h.Z.getGuildVersion(i)]), A = r.useCallback(e => {
    var t, l;
    s({
      action: "REMOVE_ROLE"
    });
  ...
  let _ = N && null != x;
  return 0 !== S.length || _ ? (0, l.jsx)(b.Z, P(I({
