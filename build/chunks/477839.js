...
let eT = () => ({
  ...
  4: {
    ...
    description: s.intl.format(o.default.RDskBQ, {
      grassIconHook: i.Z
    }),
    pointsDescription: o.default.QMkrPj,
    cost: 70,
...
let eL = {
  ...
  ex = () => ({
    ...
    3: {
      ...
      description: s.intl.formatToPlainString(o.default.ttVnXV, {
        count: eL[3]
      })
    },
    4: {
    ...
    8: {
      ...
      description: s.intl.formatToPlainString(o.default["3RaLUF"], {
        level: eL[8]
      })
    },
    9: {
    ...
    14: {
      ...
      description: s.intl.formatToPlainString(o.default.AmNmLy, {
        count: eL[14]
      })
    },
    15: {
    ...
    17: {
      ...
      description: s.intl.formatToPlainString(o.default.C34HAQ, {
        count: eL[16]
      })
    },
    18: {
    ...
    20: {
      ...
      description: s.intl.formatToPlainString(o.default["59Cedn"], {
        count: eL[19]
      })
    },
    21: {
