...
let eT = () => ({
  ...
  4: {
    ...
    description: s.NW.format(o.Z.RDskBQ, {
      grassIconHook: i.Z
    }),
    pointsDescription: o.Z.QMkrPj,
    cost: 70,
...
let eL = {
  ...
  ex = () => ({
    0: {
      ...
      description: s.NW.formatToPlainString(o.Z["87JVSk"], {
        count: eL[0]
      })
    },
    1: {
    ...
    3: {
      ...
      description: s.NW.formatToPlainString(o.Z.ttVnXV, {
        count: eL[3]
      })
    },
    4: {
    ...
    8: {
      ...
      description: s.NW.formatToPlainString(o.Z["3RaLUF"], {
        level: eL[8]
      })
    },
    9: {
    ...
    13: {
      ...
      description: s.NW.formatToPlainString(o.Z.gNIyY2, {
        count: eL[13]
      })
    },
    14: {
      ...
      description: s.NW.formatToPlainString(o.Z.AmNmLy, {
        count: eL[14]
      })
    },
    15: {
    ...
    17: {
      ...
      description: s.NW.formatToPlainString(o.Z.C34HAQ, {
        count: eL[16]
      })
    },
    18: {
    ...
    20: {
      ...
      description: s.NW.formatToPlainString(o.Z["59Cedn"], {
        count: eL[19]
      })
    },
    21: {
