...
var r = n(562858),
  ...
  eE = n(255785),
  eb = n(429413);
let ev = "1344176506041139230",
  ey = [200, 500, 1e3],
  eO = 5,
  eI = "https://discord.com/settings/clicker-game";
var eS = function(e) {
...
let eN = () => ({
  ...
  4: {
    ...
    description: s.NW.format(a.Z.RDskBQ, {
      grassIconHook: i.Z
    }),
    pointsDescription: a.Z.QMkrPj,
    cost: 70,
...
let ex = {
    ...
    5: 6,
    6: 9,
    7: Object.values(eS).length + Object.values(eT).length,
    8: 5,
    9: 10,
    10: 15,
    11: 20,
  ...
  eM = () => ({
    0: {
      ...
      description: s.NW.formatToPlainString(a.Z["87JVSk"], {
        count: ex[0]
      })
    },
    1: {
    ...
    3: {
      ...
      description: s.NW.formatToPlainString(a.Z.ttVnXV, {
        count: ex[3]
      })
    },
    4: {
    ...
    12: {
      icon: S,
      name: s.NW.string(a.Z.Xx5El5),
      description: s.NW.formatToPlainString(a.Z.GVCjU1, {
        count: ex[12]
      })
    },
    13: {
    ...
    14: {
      ...
      description: s.NW.formatToPlainString(a.Z.AmNmLy, {
        count: ex[14]
      })
    },
    15: {
    ...
    17: {
      ...
      description: s.NW.formatToPlainString(a.Z.C34HAQ, {
        count: ex[16]
      })
    },
    18: {
    ...
    20: {
      ...
      description: s.NW.formatToPlainString(a.Z["59Cedn"], {
        count: ex[19]
      })
    },
    21: {
