...
let eS = () => ({
  ...
  4: {
    ...
    description: s.intl.format(a.default.RDskBQ, {
      grassIconHook: i.Z
    }),
    pointsDescription: a.default.QMkrPj,
    cost: 70,
...
let eL = {
  ...
  ex = () => ({
    0: {
      ...
      description: s.intl.formatToPlainString(a.default["87JVSk"], {
        count: eL[0]
      })
    },
    1: {
    ...
    3: {
      ...
      description: s.intl.formatToPlainString(a.default.ttVnXV, {
        count: eL[3]
      })
    },
    4: {
    ...
    8: {
      ...
      description: s.intl.formatToPlainString(a.default["3RaLUF"], {
        level: eL[8]
      })
    },
    9: {
    ...
    13: {
      ...
      description: s.intl.formatToPlainString(a.default.gNIyY2, {
        count: eL[13]
      })
    },
    14: {
      ...
      description: s.intl.formatToPlainString(a.default.AmNmLy, {
        count: eL[14]
      })
    },
    15: {
    ...
    17: {
      ...
      description: s.intl.formatToPlainString(a.default.C34HAQ, {
        count: eL[16]
      })
    },
    18: {
    ...
    20: {
      ...
      description: s.intl.formatToPlainString(a.default["59Cedn"], {
        count: eL[19]
      })
    },
    21: {
