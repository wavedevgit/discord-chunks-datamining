...
let S = /\.gif($|\?|#)/i,
  ...
  R = 400,
  P = 300;
class w extends(r = Chunk73800.Component) {
  static isAnimated(e) {
    let {
      src: t,
      original: n,
  ...
  getRatio() {
    ...
    return Chunk255367 === Chunk217702.hV.MOSAIC && Chunk73800 ? (0, Chunk956664.rn)({
      width: module,
      height: exports,
      maxWidth: require,
      maxHeight: r
  ...
  render() {
    let {
      ...
      alt: module,
      readyState: L,
      onContextMenu: null != Chunk73800 ? Chunk73800 : true,
      zoomable: k,
  ...
  constructor(e) {
    super(e), O(this, "state", {
      ...
      return this.props.shouldRenderAccessory ? n ? r : <d.Z /> : null
