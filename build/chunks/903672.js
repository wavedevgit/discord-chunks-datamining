...
function A(e) {
  let {
    ...
    badgeState: l,
    closePopout: c
  } = e, f = (0, s.e7)([O.Z, v.Z], () => O.Z.getChannel(v.Z.getChannelId())), {
    messages: m,
    hasMore: _,
    loading: y,
    guildFilter: j,
  ...
  return (0, r.jsx)(d.ZP, {
    className: o()(w.recentMentionsPopout, {
      [w.widerInbox]: Z
    }),
