...
let D = Chunk647438.memo(function(e) {
    ...
    let eg = (null != V || null == H || (0, p.R)()) && (U || k) ? (U ? (l = false, a = () => {
      ...
      }, h = c.g5r, D = Z.intl.string(Z.t.S5anIc)) : F ? (l = false, a = () => {
        el(), (0, _.v)(J, _.d.STREAM, true)
      }, h = c.hGI, D = null != V ? Z.intl.formatToPlainString(Z.t.AB5gTy, {
        game: V.name
      }) : Z.intl.string(Z.t.FeUKeA)) : (l = true, a = null, h = c.hGI, D = null != B && (0, C.vd)(B.type) ? Z.intl.string(Z.t.uQn9B8) : null != G ? Z.intl.string(Z.t.fBXEoJ) : Z.intl.string(Z.t.n3feNG)), (0, r.jsx)("div", {
