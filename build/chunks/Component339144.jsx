...
let D = Chunk473749.memo(function(e) {
    ...
    let a, s, p, y, {
      ...
      er = i.useCallback((e, t) => () => {
        (0, b.v)($, b.d.LEAVE_ACTIVITY), h.Z.leaveActivity({
          location: t,
          applicationId: e,
          showFeedback: true
        })
    ...
    return null == ed && null == ef && null == ep && null == eh && null == em && null == eu ? null : (0, r.jsxs)("div", {
      className: A.actions,
      children: [null != (t = null != eu ? eu : em) ? t : ef, ed, null != (l = null != ep ? ep : eh) ? l : eg, eb]
    })
  }),
