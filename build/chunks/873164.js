  ...
  constructor(...e) {
    super(...e), f(this, "startingTime", 0), f(this, "loaded", !1), f(this, "_onStoreChange", s().debounce(() => {
      ...
      let t = {
        ...
        state: null == (e = a.Z.getLastAction()) ? d.NW.string(u.Z.HXxY0N) : "purchase-item" === e.type ? d.NW.formatToPlainString(u.Z.QfiQys, {
          name: (0, c.w2)()[e.id].name
        }) : "purchase-item-upgrade" === e.type ? d.NW.formatToPlainString(u.Z.GJwbPj, {
          name: (0, c.r7)()[e.id].name
        }) : "unlock-achievement" === e.type ? d.NW.formatToPlainString(u.Z.hUterq, {
