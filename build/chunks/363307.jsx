...
function O(e) {
  ...
  return <r.Fragment>{<m.Z ref={n} isPaused={t} itemId={g.yN.NAGBAR} chance={.2} points={0} maxDrops={1} width={0} height={0}>{e => (0, r.jsxs)("div", {
      ...
      })}</m.Z>}{<p.Z renderedPoints={y} onRemovePoint={e => {
        O(t => {
          let n = x({}, t);
          return delete n[e], n
        })
      }} offset={j} fullWidth={false} />}</r.Fragment>
}