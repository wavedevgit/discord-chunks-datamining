    ...
    return (0, r.ZT)(t, e), t.fromDate = function(e) {
      ...
      for (t && (this.minute += Math.floor((1439 - (60 * this.hour + this.minute)) / e) * e);;) {
        ...
        var i = (0, a.qq)(this.minute, 60),
          o = i.div,
          s = i.mod;
        if (o && (this.minute = s, this.addHours(o, false, n)), ((0, a.cS)(n) || (0, a.q9)(n, this.hour)) && ((0, a.cS)(r) || (0, a.q9)(r, this.minute))) break
      }
      ...
      for (t && (this.second += Math.floor((86399 - (3600 * this.hour + 60 * this.minute + this.second)) / e) * e);;) {
        ...
        var o = (0, a.qq)(this.second, 60),
          s = o.div,
          l = o.mod;
        if (s && (this.second = l, this.addMinutes(s, false, n, r)), ((0, a.cS)(n) || (0, a.q9)(n, this.hour)) && ((0, a.cS)(r) || (0, a.q9)(r, this.minute)) && ((0, a.cS)(i) || (0, a.q9)(i, this.second))) break
      }
