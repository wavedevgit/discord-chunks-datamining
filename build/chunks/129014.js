/** Chunk was on web.js **/
/** chunk id: 129014, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  default: () => g
}), require("./65821.js"), require("./747238.js"), require("./457529.js");
...
let d = Chunk652215.xEi + Chunk652215.sJq - 1;

function f(e, t) {
  if (null == e || null == t) throw Error("cmd and name required");
  return "".concat(e, ":").concat(t)
}
let p = Chunk488428.parse(location.search.slice(1)),
  _ = parseInt(null != p.rpc && "" !== p.rpc ? p.rpc : Chunk652215.xEi, 10),
  h = null;
class m extends Chunk143236.EventEmitter {
  get port() {
    return _
  }
  get connected() {
