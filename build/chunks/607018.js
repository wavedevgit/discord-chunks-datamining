...
let E = i.forwardRef(function(e, t) {
  let {
    ...
    transitionState: m,
    reason: R
  } = e, f = (0, l.e7)([d.default], () => d.default.getCurrentUser()), g = (0, l.e7)([c.Z], () => c.Z.getAction()), [C, I] = i.useState(null), [y, P] = i.useState(null), [b, _] = i.useState(null), [x, j] = i.useState(!1), N = i.useCallback(async e => {
    j(!0);
    try {
