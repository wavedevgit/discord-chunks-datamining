...
let E = i.forwardRef(function(e, t) {
  let {
    ...
    transitionState: m,
    reason: R
  } = e, f = (0, r.e7)([d.default], () => d.default.getCurrentUser()), C = (0, r.e7)([c.Z], () => c.Z.getAction()), [g, I] = i.useState(null), [y, P] = i.useState(null), [b, _] = i.useState(null), [x, j] = i.useState(!1), N = i.useCallback(async e => {
    j(!0);
    try {
    ...
    j(!1)
  }, [f, R, C]), v = i.useCallback(async e => {
    if (null != g && null != f) {
      j(!0);
      try {
        let {
          token: t
        } = await a.Z.verifyPhone(g, e);
        _(null), P(t)
      } catch (e) {
        _(new l.Z(e))
      }
