...
let x = e => {
    ...
    let {
      ...
      [a.G.AVATAR_DECORATION]: v.intl.string(v.t.dRZYND),
      [a.G.PROFILE_EFFECT]: v.intl.string(v.t["1cNjt7"]),
      [a.G.NAMEPLATE]: v.intl.string(v.t.V68Fq6),
      [a.G.BUNDLE]: v.intl.string(v.t.FYFppq)
    }, {
      itemTypeFilters: o,
      onToggleItemType: s
    } = (0, h.S)();
