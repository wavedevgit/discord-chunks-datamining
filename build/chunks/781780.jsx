...
function c(e) {
  ...
  return null != s && "" !== s && (f.guild_id = s), null != u && "" !== u && (f.channel_id = u), <i.J allowPopups={(0, o.h)(p)} referrerPolicy={l.um.has(d.applicationId) ? "no-referrer" : "origin"} url={d.url} queryParams={f} className={a.iframe} shouldRefocus={false} />
}