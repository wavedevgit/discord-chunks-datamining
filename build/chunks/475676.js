...
function S(e) {
  ...
  if (0 === w.users.length || null == D || null == x) return (0, r.jsx)(A, {
    application: j,
    selected: v
  });
  let {
    sort_by_statistic_id: M
  } = w.guild_settings, U = null != (b = null == L || null == (f = L.statistics) || null == (n = f[M]) ? void 0 : n.value) ? b : 0, {
    currentRank: G
  } = D;
  return y = D.userId === P ? O.intl.formatToPlainString(O.t["eU+JxM"], {
    rank: G
