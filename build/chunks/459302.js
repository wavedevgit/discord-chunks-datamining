/** Chunk was on web.js **/
/** chunk id: 459302, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  A: () => s
});
...
function s(e, t) {
  ...
  function f() {
    switch (s.symbol) {
      case "last":
        return s.nextSymbol(), false;
      case "first":
        return s.nextSymbol(), 1;
      case "second":
        return s.nextSymbol(), s.accept("last") ? false : 2;
      case "third":
        return s.nextSymbol(), s.accept("last") ? false : 3;
      case "nth":
