...
function q(e) {
    ...
    ee = i.useCallback(async () => {
      ...
      async function n(n) {
        ...
        let i = await z(n),
          ...
          s = E.Z.getChannel(i);
        p.Z.sendMessage(i, null != j ? w.ZP.parse(s, B.intl.formatToPlainString(B.t.jQULqK, {
      ...
      let i = x.Z.getInviteSuggestionRows().filter(e => U.includes(e.item.id)).map(e => n(e));
      ...
      try {
        await Promise.all(i), null != j && (0, u.showToast)((0, u.createToast)(B.intl.formatToPlainString(B.t.jQULqK, {
  ...
  return null == Q ? (0, n.jsx)(u.$jN, {}) : (0, n.jsxs)(u.Y0X, (t = function(e) {
  ...
  return (0, n.jsxs)(u.P3F, {
    ...
    children: [(0, n.jsxs)("div", {
      ...
      children: [(0, n.jsx)("div", {
        ...
        children: [(0, n.jsx)(u.Text, {
          variant: "text-md/semibold",
          className: r()(G.rowName, {
            [G.disabled]: l
          }),
          children: o
        }), (0, n.jsx)(u.Text, {
          variant: "text-xs/medium",
          className: r()(G.rowSubName, {
            [G.disabled]: l
          }),
          children: c
        })]
...
function K(e) {
  ...
  }, [r]), U.ZP.canCopyImage(a)) ? (0, n.jsxs)(u.zxk, {
