...
function q(e) {
  ...
  let [j] = (0, _.Z)([l]), D = (0, d.e7)([O.default], () => O.default.getCurrentUser()), [P, M] = i.useState(""), [U, q] = i.useState([]), [V, X] = i.useState(null), [Q, Y] = i.useState(null);
  i.useEffect(() => {
    (async () => {
    ...
    ee = i.useCallback(async () => {
      ...
      async function a(a) {
        ...
        let i = await z(a),
          ...
          s = E.Z.getChannel(i);
        f.Z.sendMessage(i, null != j ? w.ZP.parse(s, G.intl.formatToPlainString(G.t.jQULqK, {
      ...
      let i = x.Z.getInviteSuggestionRows().filter(e => U.includes(e.item.id)).map(e => a(e));
      ...
      try {
        await Promise.all(i), null != j && (0, u.showToast)((0, u.createToast)(G.intl.formatToPlainString(G.t.jQULqK, {
  ...
  return null == Q ? (0, a.jsx)(u.$jN, {}) : (0, a.jsxs)(u.Y0X, (t = function(e) {
    ...
    children: [(0, a.jsxs)(u.xBx, {
      ...
      children: (0, a.jsxs)("div", {
        ...
        children: [(0, a.jsx)(K, {
          ...
          mediaUrl: r
        }), U.length >= 10 ? (0, a.jsx)(u.Text, {
          variant: "text-xs/normal",
          children: G.intl.format(G.t.mdE9iI, {
            maxShares: 10
          })
        }) : null, (0, a.jsx)(u.zxk, {
          onClick: ee,
  ...
  return (0, a.jsxs)(u.P3F, {
    ...
    children: [(0, a.jsxs)("div", {
      ...
      children: [(0, a.jsx)("div", {
        ...
        children: [(0, a.jsx)(u.Text, {
          variant: "text-md/semibold",
          className: r()(B.rowName, {
            [B.disabled]: l
          }),
          children: o
        }), (0, a.jsx)(u.Text, {
          variant: "text-xs/medium",
          className: r()(B.rowSubName, {
            [B.disabled]: l
          }),
          children: c
        })]
...
function K(e) {
  ...
  }, [r]), U.ZP.canCopyImage(n)) ? (0, a.jsxs)(u.zxk, {
    look: u.zxk.Looks.LINK,
    color: u.zxk.Colors.LINK,
    onClick: c,
    innerClassName: B.copyButton,
    children: [r ? (0, a.jsx)(u.owK, {
      size: "md",
      color: "currentColor"
    }) : (0, a.jsx)(u.TIy, {
      size: "xs",
