...
function H(e) {
  ...
  let [j] = (0, I.Z)([r]), D = (0, d.e7)([Z.default], () => Z.default.getCurrentUser()), [U, k] = i.useState(""), [H, z] = i.useState([]), [K, Q] = i.useState(null), [W, X] = i.useState(null), [Y, J] = i.useState(!1);
  i.useEffect(() => {
    (async () => {
