    ...
    $ = i.useCallback(async () => {
      ...
      async function n(n) {
        ...
        g.Z.uploadFiles({
          channelId: i,
          uploads: r,
          parsedMessage: null != C ? w.ZP.parse(s, F.intl.formatToPlainString(F.t.jQULqK, {
      ...
      try {
        await Promise.all(i), null != C && (0, u.showToast)((0, u.createToast)(F.intl.formatToPlainString(F.t.jQULqK, {
