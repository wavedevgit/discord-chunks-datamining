...
let ev = e => {
    ...
    let {
      ...
      location: i,
      allowClick: l = !1
    } = e, a = null == (t = (0, R.hp)(n)) ? void 0 : t.errorCode, o = ey.intl.formatToPlainString(ey.t["ejOT9/"], {
      errorCode: a
    }), {
      avErrorUIEnabled: s
    } = (0, k.JN)({
  ...
  eO = () => (0, r.jsxs)(c.qXd, {
    ...
    }), ey.intl.string(ey.t.o3zuY2), (0, r.jsx)(ev, {
  ...
  ej = () => (0, r.jsxs)(c.qXd, {
    ...
    }), ey.intl.string(ey.t.nCO9bG), (0, r.jsx)(ev, {
  ...
  eC = () => (0, r.jsxs)(c.qXd, {
    ...
    }), ey.intl.string(ey.t.dNAJ19), (0, r.jsx)(ev, {
      allowClick: !0,
      error: R.u.NO_AUDIO_INPUT_DETECTED,
...
let eI = 12633 == n.j ? i.memo(function() {
  ...
  i.useEffect(() => {
    ...
    if (null != R && R.type === eh.kVF.SURVEY && null != R.metadata) {
      let {
        metadata: e
      } = R, t = D.Z.getUserExperimentDescriptor(e.id);
  ...
  switch (R.type) {
    ...
    case eh.kVF.VOICE_DISABLED:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ey.intl.string(ey.t.bOQ3jY), (0, r.jsx)(c.NoS, {
          onClick: () => {
    ...
    case eh.kVF.VOICE_CONNECTED_LAST_SESSION:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ey.intl.string(ey.t.jY2lUF), (0, r.jsx)(c.NoS, {
          onClick: () => {
    ...
    case eh.kVF.SPOTIFY_AUTO_PAUSED:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ey.intl.string(ey.t["D8Cp7+"]), (0, r.jsx)(c.NoS, {
    ...
    case eh.kVF.UNCLAIMED_ACCOUNT:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DEFAULT,
        children: [ey.intl.string(ey.t["f+Zaoq"]), (0, r.jsx)(c.NoS, {
    ...
    case eh.kVF.SCHEDULED_MAINTENANCE:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ey.intl.format(ey.t.yb96S0, R.metadata), (0, r.jsx)(c.u3T, {
    ...
    case eh.kVF.HARDWARE_MUTE:
      ...
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DANGER,
        children: [ey.intl.format(ey.t.qoDex8, {
          vendorName: eD.name,
          modelName: eM.name
        }), (0, r.jsx)(c.RyX, {
          onClick: () => {
    ...
    case eh.kVF.STREAMER_MODE:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ey.intl.string(ey.t.iEgBXl), (0, r.jsx)(c.NoS, {
    ...
    case eh.kVF.H264_DISABLED:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ey.intl.string(ey.t.HcErZW), (0, r.jsx)(c.EyT, {
          onClick: () => {
            (0, f.jN)(eh.S9g.USER_SETTINGS), O.Z.setSection(eh.oAB.VOICE)
          },
    ...
    case eh.kVF.CORRUPT_INSTALLATION:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DANGER,
        children: [ey.intl.string(ey.t.ugxmk5), (0, r.jsx)(c.u3T, {
    ...
    case eh.kVF.VIDEO_UNSUPPORTED_BROWSER:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ey.intl.string(ey.t.wVjKGh), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.VIDEO_UNSUPPORTED_BROWSER,
          onClick: () => {
            (0, c.ZDy)(async () => {
              let {
    ...
    case eh.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          children: [null != eK ? ey.intl.formatToPlainString(ey.t["pHj+z8"], {
            name: "".concat(eK),
            progress: ez,
            total: eW
    ...
    case eh.kVF.APPLICATION_TEST_MODE:
      ...
      return (0, r.jsx)(c.qXd, {
        ...
        children: (0, r.jsxs)(T.Z, {
          ...
          align: T.Z.Align.CENTER,
          children: [(0, r.jsx)("div", {
            children: ey.intl.format(ey.t.Fv5HrK, {
              applicationName: R.metadata.applicationName
            })
          }), (0, r.jsx)(em.Z, {
    ...
    case eh.kVF.PREMIUM_UNCANCEL:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          color: "currentColor",
          className: ex.premiumIcon
        }), eA === eg.p9.TIER_1 ? ey.intl.formatToPlainString(ey.t.fXv4ws, {
          daysLeft: R.metadata.daysLeft
        }) : eA === eg.p9.TIER_0 ? ey.intl.formatToPlainString(ey.t.ZOHZMj, {
          daysLeft: R.metadata.daysLeft
        }) : ey.intl.formatToPlainString(ey.t.outyHh, {
          daysLeft: R.metadata.daysLeft
        }), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_UNCANCEL,
          onClick: () => {
    ...
    case eh.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ey.intl.string(ey.t.LlZaoa), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT,
          onClick: () => {
            var e, t;
    ...
    case eh.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ey.intl.string(ey.t["30YfCg"]), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT,
          onClick: () => {
            var e, t;
            eS(null == (t = R.metadata) || null == (e = t.premiumSubscription) ? void 0 : e.currentPeriodEnd), O.Z.open(eh.oAB.SUBSCRIPTIONS)
    ...
    case eh.kVF.PREMIUM_MISSING_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eA === eg.p9.TIER_1 ? ey.intl.formatToPlainString(ey.t.b6QUvb, {
          daysLeft: R.metadata.daysLeft
        }) : eA === eg.p9.TIER_0 ? ey.intl.formatToPlainString(ey.t["tURZ/P"], {
          daysLeft: R.metadata.daysLeft
        }) : ey.intl.formatToPlainString(ey.t.AyC74O, {
          daysLeft: R.metadata.daysLeft
        }), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_MISSING_PAYMENT,
          onClick: () => {
    ...
    case eh.kVF.QUARANTINED:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [ey.intl.string(ey.t.DVFJYW), (0, r.jsx)(c.u3T, {
          href: e_.Z,
          target: "_blank",
    ...
    case eh.kVF.BLOCKED_BY_PROXY:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.WARNING,
        children: [ey.intl.string(ey.t.Ugijzs), (0, r.jsx)(c.u3T, {
    ...
    case eh.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ey.intl.string(ey.t.B8ruyc), (0, r.jsx)(c.EyT, {
          onClick: () => {
            null != C && (0, U.UE)(C, eQ, () => {
              eS(eq), (0, U.T9)(C)
            })
    ...
    case eh.kVF.SAFETY_USER_SENTIMENT_NAGBAR:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ey.intl.string(ey.t.I1nKfH), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.SAFETY_USER_SENTIMENT_NAGBAR,
          onClick: () => {
            (0, c.ZDy)(async () => {
              let {
    ...
    case eh.kVF.BLOCK_USER_FEEDBACK_NAGBAR:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ey.intl.string(ey.t["0klLS0"]), (0, r.jsx)(c.NoS, {
          onClick: () => {
            var e;
