...
let ev = e => {
    ...
    let {
      ...
      location: i,
      allowClick: l = !1
    } = e, a = null == (t = (0, R.hp)(n)) ? void 0 : t.errorCode, o = ex.intl.formatToPlainString(ex.t["ejOT9/"], {
      errorCode: a
    }), {
      avErrorUIEnabled: s
    } = (0, k.JN)({
  ...
  ej = () => (0, r.jsxs)(c.qXd, {
    ...
    }), ex.intl.string(ex.t.nCO9bG), (0, r.jsx)(ev, {
  ...
  eC = () => (0, r.jsxs)(c.qXd, {
    ...
    children: [(0, r.jsx)(c.RyX, {
    ...
    }), ex.intl.string(ex.t.dNAJ19), (0, r.jsx)(ev, {
      allowClick: !0,
      error: R.u.NO_AUDIO_INPUT_DETECTED,
      ...
      children: ex.intl.string(ex.t.I6YlBw)
    })]
  });
...
let eI = 12633 == n.j ? i.memo(function() {
  ...
  if (null != eN) return (0, r.jsx)(Z.q, {
    dismissibleContent: eN,
    noticeType: R.type
  });
  if (null != eT) return (0, r.jsx)(w.c, {
  ...
  switch (R.type) {
    ...
    case eh.kVF.WIN32_DEPRECATED_MESSAGE:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.intl.format(ex.t["08KQ1N"], {
          helpCenterLink: ed.Z.getArticleURL(eh.BhN.WIN32_DEPRECATE)
        })]
      });
    case eh.kVF.WIN7_8_DEPRECATED_MESSAGE:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          helpCenterLink: ed.Z.getArticleURL(eh.BhN.WIN7_8_DEPRECATE)
        })]
      });
    case eh.kVF.MACOS_19_DEPRECATED_MESSAGE:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.intl.format(ex.t.q8VPLi, {
          helpCenterLink: ed.Z.getArticleURL(eh.BhN.MACOS_19_DEPRECATE)
        })]
      });
    case eh.kVF.GENERIC:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), R.message, null != R.buttonText ? (0, r.jsx)(c.NoS, {
          onClick: R.callback,
          noticeType: eh.kVF.GENERIC,
    ...
    case eh.kVF.VOICE_CONNECTED_LAST_SESSION:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.intl.string(ex.t.jY2lUF), (0, r.jsx)(c.NoS, {
          onClick: () => {
    ...
    case eh.kVF.SPOTIFY_AUTO_PAUSED:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.intl.string(ex.t["D8Cp7+"]), (0, r.jsx)(c.NoS, {
          onClick: () => O.Z.open(eh.oAB.VOICE),
          noticeType: eh.kVF.SPOTIFY_AUTO_PAUSED,
          children: ex.intl.string(ex.t.NiTd0d)
        }), (0, r.jsx)(c.eee, {
          className: ey.textLinkSmall,
          href: ed.Z.getArticleURL(eh.BhN.SPOTIFY_AUTO_PAUSED),
          target: "_blank",
          children: ex.intl.string(ex.t.CiqAIS)
        })]
      });
    case eh.kVF.UNCLAIMED_ACCOUNT:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DEFAULT,
        children: [ex.intl.string(ex.t["f+Zaoq"]), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.UNCLAIMED_ACCOUNT,
          onClick: () => eI && null != C ? (0, B.hk)(C) : N.j(),
          children: ex.intl.string(ex.t.fiNVio)
        })]
      });
    case eh.kVF.UNVERIFIED_ACCOUNT:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DEFAULT,
        children: [ex.intl.string(ex.t["3sWbf3"]), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.UNVERIFIED_ACCOUNT,
          onClick: () => {
            p.Z.verifyResend(), u.Z.show({
              title: ex.intl.string(ex.t.LykQYm),
              body: ex.intl.format(ex.t.azKEPz, {
                email: null == h ? void 0 : h.email
              }),
              secondaryConfirmText: ex.intl.string(ex.t.oP5zGB),
              onConfirmSecondary: N.j
            })
          },
          children: ex.intl.string(ex.t.WnX4Jy)
        })]
      });
    case eh.kVF.SCHEDULED_MAINTENANCE:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.intl.format(ex.t.yb96S0, R.metadata), (0, r.jsx)(c.u3T, {
    ...
    case eh.kVF.HARDWARE_MUTE:
      ...
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DANGER,
        children: [ex.intl.format(ex.t.qoDex8, {
          vendorName: eL.name,
          modelName: eM.name
        }), (0, r.jsx)(c.RyX, {
          onClick: () => {
          ...
          children: ex.intl.string(ex.t["Yl/Rio"])
        })]
      });
    case eh.kVF.STREAMER_MODE:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.intl.string(ex.t.iEgBXl), (0, r.jsx)(c.NoS, {
          onClick: () => y.Z.setEnabled(!1),
          noticeType: eh.kVF.STREAMER_MODE,
          children: ex.intl.string(ex.t.R9GHyc)
        })]
      });
    case eh.kVF.H264_DISABLED:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.intl.string(ex.t.HcErZW), (0, r.jsx)(c.EyT, {
          onClick: () => {
            (0, f.jN)(eh.S9g.USER_SETTINGS), O.Z.setSection(eh.oAB.VOICE)
          },
          children: ex.intl.string(ex.t["51hI/v"])
        })]
      });
    case eh.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK:
      if (null == R.metadata) return null;
      let {
        skuId: eU, applicationId: eF
      } = R.metadata, eB = eo.Z.get(eU), eG = I.Z.getApplication(eF);
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          children: ex.intl.string(ex.t.KEwPY2)
        })]
      });
    case eh.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL: {
      ...
      let {
        skuId: e,
        applicationId: t
      } = R.metadata, n = eo.Z.get(e), i = I.Z.getApplication(t);
    ...
    case eh.kVF.SERVER_USAGE_SURVEY:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          children: ex.intl.string(ex.t["4RQks7"])
        })]
      });
    case eh.kVF.CORRUPT_INSTALLATION:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DANGER,
        children: [ex.intl.string(ex.t.ugxmk5), (0, r.jsx)(c.u3T, {
          href: ed.Z.getArticleURL(eh.BhN.CORRUPT_INSTALLATION),
          target: "_blank",
          children: ex.intl.string(ex.t["6ik4Xl"])
        })]
      });
    case eh.kVF.VIDEO_UNSUPPORTED_BROWSER:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.intl.string(ex.t.wVjKGh), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.VIDEO_UNSUPPORTED_BROWSER,
          onClick: () => {
            (0, c.ZDy)(async () => {
              let {
    ...
    case eh.kVF.DISPATCH_ERROR:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), null == eV ? void 0 : eV.displayMessage, (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.DISPATCH_ERROR,
    ...
    case eh.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          children: [null != eK ? ex.intl.formatToPlainString(ex.t["pHj+z8"], {
            name: "".concat(eK),
            progress: ez,
            total: eW
          }) : ex.intl.formatToPlainString(ex.t["lHZn+P"], {
            progress: ez,
            total: eW
          }), (0, r.jsx)(c.$jN, {
    ...
    case eh.kVF.APPLICATION_TEST_MODE:
      ...
      if (null != es.Z.testModeEmbeddedApplicationId) return (0, r.jsx)(c.qXd, {
        ...
        children: (0, r.jsxs)(T.Z, {
          ...
          children: [(0, r.jsx)("div", {
            children: ex.intl.format(ex.t["1qxVe3"], {
      ...
      return (0, r.jsx)(c.qXd, {
        ...
        children: (0, r.jsxs)(T.Z, {
          ...
          align: T.Z.Align.CENTER,
          children: [(0, r.jsx)("div", {
            children: ex.intl.format(ex.t.Fv5HrK, {
              applicationName: R.metadata.applicationName
            })
          }), (0, r.jsx)(em.Z, {
    ...
    case eh.kVF.PREMIUM_UNCANCEL:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          color: "currentColor",
          className: ey.premiumIcon
        }), eA === eg.p9.TIER_1 ? ex.intl.formatToPlainString(ex.t.fXv4ws, {
          daysLeft: R.metadata.daysLeft
        }) : eA === eg.p9.TIER_0 ? ex.intl.formatToPlainString(ex.t.ZOHZMj, {
          daysLeft: R.metadata.daysLeft
          ...
          onClick: () => {
            var e, t;
            eS(null == (t = R.metadata) || null == (e = t.premiumSubscription) ? void 0 : e.currentPeriodEnd), (0, c.ZDy)(async () => {
              let {
                default: e
          ...
          children: eA === eg.p9.TIER_1 ? ex.intl.string(ex.t.BkbUPD) : eA === eg.p9.TIER_0 ? ex.intl.string(ex.t.Px978f) : ex.intl.string(ex.t.LW5tCA)
        })]
      });
    case eh.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT:
      let {
        daysPastDue: eY, dismissUntil: eX
      } = R.metadata;
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.WARNING,
        children: [(0, r.jsx)(c.RyX, {
          ...
          children: ex.intl.string(ex.t.q8rxeX)
        })]
      });
    ...
    case eh.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.intl.string(ex.t["30YfCg"]), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT,
          onClick: () => {
            var e, t;
            eS(null == (t = R.metadata) || null == (e = t.premiumSubscription) ? void 0 : e.currentPeriodEnd), O.Z.open(eh.oAB.SUBSCRIPTIONS)
          },
          children: ex.intl.string(ex.t.U5pKWF)
        })]
      });
    case eh.kVF.PREMIUM_MISSING_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
        ...
        }), eA === eg.p9.TIER_1 ? ex.intl.formatToPlainString(ex.t.b6QUvb, {
          daysLeft: R.metadata.daysLeft
        }) : eA === eg.p9.TIER_0 ? ex.intl.formatToPlainString(ex.t["tURZ/P"], {
          daysLeft: R.metadata.daysLeft
        }) : ex.intl.formatToPlainString(ex.t.AyC74O, {
          daysLeft: R.metadata.daysLeft
        }), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_MISSING_PAYMENT,
          onClick: () => {
          ...
          children: eA === eg.p9.TIER_1 ? ex.intl.string(ex.t.lboF5O) : eA === eg.p9.TIER_0 ? ex.intl.string(ex.t["4UPwOj"]) : ex.intl.string(ex.t["P/VvGR"])
        })]
      });
    case eh.kVF.BACK_TO_PREVIOUS_SCREEN:
      return (0, r.jsx)(V.h, {
        buttonText: null != (l = R.buttonText) ? l : ex.intl.string(ex.t["/g10LC"]),
        onGoBack: R.callback,
        onDismiss: () => eS(),
        showCloseButton: !0
      });
    ...
    case eh.kVF.QUARANTINED:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [ex.intl.string(ex.t.DVFJYW), (0, r.jsx)(c.u3T, {
          href: e_.Z,
          target: "_blank",
          children: ex.intl.string(ex.t.kvHdFB)
        }), (0, r.jsx)(c.eee, {
    ...
    case eh.kVF.BLOCKED_BY_PROXY:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.WARNING,
        children: [ex.intl.string(ex.t.Ugijzs), (0, r.jsx)(c.u3T, {
    ...
    case eh.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.intl.string(ex.t.B8ruyc), (0, r.jsx)(c.EyT, {
          onClick: () => {
            null != C && (0, U.UE)(C, eQ, () => {
              eS(eq), (0, U.T9)(C)
            })
          },
          children: ex.intl.string(ex.t.oX14Eh)
        }), null != C ? (0, r.jsx)(c.EyT, {
          onClick: () => z.Z.open(C, eh.pNK.GUILD_AUTOMOD, void 0, eh.KsC.AUTOMOD_MENTION_SPAM),
          children: ex.intl.string(ex.t["1R7QIy"])
        }) : null]
      });
    case eh.kVF.SAFETY_USER_SENTIMENT_NAGBAR:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
        ...
        }), ex.intl.string(ex.t.I1nKfH), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.SAFETY_USER_SENTIMENT_NAGBAR,
          onClick: () => {
            (0, c.ZDy)(async () => {
              let {
          ...
          children: ex.intl.string(ex.t.l5xYnJ)
        })]
      });
    ...
    case eh.kVF.BLOCK_USER_FEEDBACK_NAGBAR:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.intl.string(ex.t["0klLS0"]), (0, r.jsx)(c.NoS, {
          onClick: () => {
            var e;
            (0, $.ZZ)(), eS(null == (e = R.metadata) ? void 0 : e.dismissUntil)
          },
          noticeType: eh.kVF.BLOCK_USER_FEEDBACK_NAGBAR,
          children: ex.intl.string(ex.t.e4y2VF)
        })]
      });
