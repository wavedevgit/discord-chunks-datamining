...
let ey = e => {
    ...
    let {
      ...
      location: i,
      allowClick: l = !1
    } = e, a = null == (t = (0, D.hp)(n)) ? void 0 : t.errorCode, o = ev.intl.formatToPlainString(ev.t["ejOT9/"], {
      errorCode: a
    }), {
      avErrorUIEnabled: s
    } = (0, L.JN)({
  ...
  eI = () => (0, r.jsxs)(c.qXd, {
    ...
    }), ev.intl.string(ev.t.o3zuY2), (0, r.jsx)(ey, {
  ...
  ej = () => (0, r.jsxs)(c.qXd, {
    ...
    }), ev.intl.string(ev.t.nCO9bG), (0, r.jsx)(ey, {
  ...
  eS = () => (0, r.jsxs)(c.qXd, {
    ...
    }), ev.intl.string(ev.t.dNAJ19), (0, r.jsx)(ey, {
      allowClick: !0,
      error: D.u.NO_AUDIO_INPUT_DETECTED,
...
let eN = 12633 == n.j ? i.memo(function() {
  var e, t;
  ...
  i.useEffect(() => {
    ...
    if (null != I && I.type === eh.kVF.SURVEY && null != I.metadata) {
      let {
        metadata: e
      } = I, t = k.Z.getUserExperimentDescriptor(e.id);
  ...
  } = q.b.getCurrentConfig({
    location: "AppNotice"
  });
  if (ew && null != ey && (L === eh.kVF.PREMIUM_TIER_2_TRIAL_ENDING || L === eh.kVF.PREMIUM_TIER_2_DISCOUNT_ENDING)) return (0, r.jsx)(Z.W, {
    dismissibleContent: ey,
    noticeType: I.type
  });
  if (null != eN) return (0, r.jsx)(R.q, {
    dismissibleContent: eN,
    noticeType: I.type
  });
  if (null != eP) return (0, r.jsx)(w.c, {
    dismissibleContent: eP
  });
  if (null != eA) return (0, r.jsx)(A.A, {
  ...
  switch (I.type) {
    ...
    case eh.kVF.VOICE_DISABLED:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ev.intl.string(ev.t.bOQ3jY), (0, r.jsx)(c.NoS, {
          onClick: () => {
    ...
    case eh.kVF.VOICE_CONNECTED_LAST_SESSION:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ev.intl.string(ev.t.jY2lUF), (0, r.jsx)(c.NoS, {
          onClick: () => {
    ...
    case eh.kVF.SPOTIFY_AUTO_PAUSED:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ev.intl.string(ev.t["D8Cp7+"]), (0, r.jsx)(c.NoS, {
    ...
    case eh.kVF.UNCLAIMED_ACCOUNT:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DEFAULT,
        children: [ev.intl.string(ev.t["f+Zaoq"]), (0, r.jsx)(c.NoS, {
    ...
    case eh.kVF.UNVERIFIED_ACCOUNT:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DEFAULT,
        children: [ev.intl.string(ev.t["3sWbf3"]), (0, r.jsx)(c.NoS, {
    ...
    case eh.kVF.SCHEDULED_MAINTENANCE:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ev.intl.format(ev.t.yb96S0, I.metadata), (0, r.jsx)(c.u3T, {
    ...
    case eh.kVF.HARDWARE_MUTE:
      ...
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DANGER,
        children: [ev.intl.format(ev.t.qoDex8, {
          vendorName: eU.name,
          modelName: eF.name
        }), (0, r.jsx)(c.RyX, {
          onClick: () => {
    ...
    case eh.kVF.STREAMER_MODE:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ev.intl.string(ev.t.iEgBXl), (0, r.jsx)(c.NoS, {
    ...
    case eh.kVF.H264_DISABLED:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ev.intl.string(ev.t.HcErZW), (0, r.jsx)(c.EyT, {
          onClick: () => {
            (0, f.jN)(eh.S9g.USER_SETTINGS), x.Z.setSection(eh.oAB.VOICE)
          },
    ...
    case eh.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK:
      ...
      } = I.metadata, eV = ec.Z.get(eB), eH = S.Z.getApplication(eG);
    ...
    case eh.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL: {
      ...
      let {
        skuId: e,
        applicationId: t
      } = I.metadata, n = ec.Z.get(e), i = S.Z.getApplication(t);
    ...
    case eh.kVF.CORRUPT_INSTALLATION:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DANGER,
        children: [ev.intl.string(ev.t.ugxmk5), (0, r.jsx)(c.u3T, {
    ...
    case eh.kVF.VIDEO_UNSUPPORTED_BROWSER:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ev.intl.string(ev.t.wVjKGh), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.VIDEO_UNSUPPORTED_BROWSER,
          onClick: () => {
            (0, c.ZDy)(async () => {
              let {
    ...
    case eh.kVF.DISPATCH_ERROR:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), null == eW ? void 0 : eW.displayMessage, (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.DISPATCH_ERROR,
    ...
    case eh.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          children: [null != eX ? ev.intl.formatToPlainString(ev.t["pHj+z8"], {
            name: "".concat(eX),
            progress: eK,
            total: eY
    ...
    case eh.kVF.PREMIUM_UNCANCEL:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          color: "currentColor",
          className: eO.premiumIcon
        }), eZ === eb.p9.TIER_1 ? ev.intl.formatToPlainString(ev.t.fXv4ws, {
          daysLeft: I.metadata.daysLeft
        }) : eZ === eb.p9.TIER_0 ? ev.intl.formatToPlainString(ev.t.ZOHZMj, {
          daysLeft: I.metadata.daysLeft
        }) : ev.intl.formatToPlainString(ev.t.outyHh, {
          daysLeft: I.metadata.daysLeft
        }), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_UNCANCEL,
          onClick: () => {
            var e, t;
            eT(null == (t = I.metadata) || null == (e = t.premiumSubscription) ? void 0 : e.currentPeriodEnd), (0, c.ZDy)(async () => {
              let {
                default: e
    ...
    case eh.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ev.intl.string(ev.t.LlZaoa), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT,
          onClick: () => {
            var e, t;
    ...
    case eh.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ev.intl.string(ev.t["30YfCg"]), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT,
          onClick: () => {
            var e, t;
            eT(null == (t = I.metadata) || null == (e = t.premiumSubscription) ? void 0 : e.currentPeriodEnd), x.Z.open(eh.oAB.SUBSCRIPTIONS)
    ...
    case eh.kVF.PREMIUM_MISSING_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eZ === eb.p9.TIER_1 ? ev.intl.formatToPlainString(ev.t.b6QUvb, {
          daysLeft: I.metadata.daysLeft
        }) : eZ === eb.p9.TIER_0 ? ev.intl.formatToPlainString(ev.t["tURZ/P"], {
          daysLeft: I.metadata.daysLeft
        }) : ev.intl.formatToPlainString(ev.t.AyC74O, {
          daysLeft: I.metadata.daysLeft
        }), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_MISSING_PAYMENT,
          onClick: () => {
    ...
    case eh.kVF.QUARANTINED:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DANGER,
        children: [ev.intl.string(ev.t.DVFJYW), (0, r.jsx)(c.u3T, {
          href: eE.Z,
          target: "_blank",
    ...
    case eh.kVF.BLOCKED_BY_PROXY:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.WARNING,
        children: [ev.intl.string(ev.t.Ugijzs), (0, r.jsx)(c.u3T, {
    ...
    case eh.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ev.intl.string(ev.t.B8ruyc), (0, r.jsx)(c.EyT, {
          onClick: () => {
            null != g && (0, F.UE)(g, e$, () => {
              eT(eJ), (0, F.T9)(g)
            })
    ...
    case eh.kVF.SAFETY_USER_SENTIMENT_NAGBAR:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ev.intl.string(ev.t.I1nKfH), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.SAFETY_USER_SENTIMENT_NAGBAR,
          onClick: () => {
            (0, c.ZDy)(async () => {
              let {
    ...
    case eh.kVF.BLOCK_USER_FEEDBACK_NAGBAR:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ev.intl.string(ev.t["0klLS0"]), (0, r.jsx)(c.NoS, {
          onClick: () => {
            var e;
