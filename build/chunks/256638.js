...
let ev = e => {
    ...
    let {
      ...
      location: i,
      allowClick: a = !1
    } = e, l = null == (t = (0, R.hp)(n)) ? void 0 : t.errorCode, o = ex.NW.formatToPlainString(ex.t["ejOT9/"], {
      errorCode: l
    }), {
      avErrorUIEnabled: s
    } = (0, k.JN)({
  ...
  switch (R.type) {
    ...
    case eh.kVF.VOICE_DISABLED:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.NW.string(ex.t.bOQ3jY), (0, r.jsx)(c.NoS, {
          onClick: () => {
    ...
    case eh.kVF.VOICE_CONNECTED_LAST_SESSION:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.NW.string(ex.t.jY2lUF), (0, r.jsx)(c.NoS, {
          onClick: () => {
    ...
    case eh.kVF.SPOTIFY_AUTO_PAUSED:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.NW.string(ex.t["D8Cp7+"]), (0, r.jsx)(c.NoS, {
    ...
    case eh.kVF.UNCLAIMED_ACCOUNT:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DEFAULT,
        children: [ex.NW.string(ex.t["f+Zaoq"]), (0, r.jsx)(c.NoS, {
    ...
    case eh.kVF.SCHEDULED_MAINTENANCE:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.NW.format(ex.t.yb96S0, R.metadata), (0, r.jsx)(c.u3T, {
    ...
    case eh.kVF.HARDWARE_MUTE:
      ...
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DANGER,
        children: [ex.NW.format(ex.t.qoDex8, {
          vendorName: eL.name,
          modelName: eM.name
        }), (0, r.jsx)(c.RyX, {
          onClick: () => {
    ...
    case eh.kVF.STREAMER_MODE:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.NW.string(ex.t.iEgBXl), (0, r.jsx)(c.NoS, {
    ...
    case eh.kVF.H264_DISABLED:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.NW.string(ex.t.HcErZW), (0, r.jsx)(c.EyT, {
          onClick: () => {
            (0, f.jN)(eh.S9g.USER_SETTINGS), O.Z.setSection(eh.oAB.VOICE)
          },
    ...
    case eh.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK:
      if (null == R.metadata) return null;
      let {
        skuId: eW, applicationId: eU
      } = R.metadata, eF = eo.Z.get(eW), eB = S.Z.getApplication(eU);
    ...
    case eh.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL: {
      ...
      let {
        skuId: e,
        applicationId: t
      } = R.metadata, n = eo.Z.get(e), i = S.Z.getApplication(t);
    ...
    case eh.kVF.CORRUPT_INSTALLATION:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DANGER,
        children: [ex.NW.string(ex.t.ugxmk5), (0, r.jsx)(c.u3T, {
    ...
    case eh.kVF.VIDEO_UNSUPPORTED_BROWSER:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.NW.string(ex.t.wVjKGh), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.VIDEO_UNSUPPORTED_BROWSER,
          onClick: () => {
            (0, c.ZDy)(async () => {
              let {
    ...
    case eh.kVF.DISPATCH_ERROR:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), null == eH ? void 0 : eH.displayMessage, (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.DISPATCH_ERROR,
    ...
    case eh.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          children: [null != eK ? ex.NW.formatToPlainString(ex.t["pHj+z8"], {
            name: "".concat(eK),
            progress: eV,
            total: ez
    ...
    case eh.kVF.APPLICATION_TEST_MODE:
      ...
      if (null != es.Z.testModeEmbeddedApplicationId) return (0, r.jsx)(c.qXd, {
        ...
        children: (0, r.jsxs)(T.Z, {
          ...
          children: [(0, r.jsx)("div", {
            children: ex.NW.format(ex.t["1qxVe3"], {
      ...
      return (0, r.jsx)(c.qXd, {
        ...
        children: (0, r.jsxs)(T.Z, {
          ...
          align: T.Z.Align.CENTER,
          children: [(0, r.jsx)("div", {
            children: ex.NW.format(ex.t.Fv5HrK, {
              applicationName: R.metadata.applicationName
            })
          }), (0, r.jsx)(em.Z, {
    ...
    case eh.kVF.PREMIUM_UNCANCEL:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          color: "currentColor",
          className: ey.premiumIcon
        }), eA === eg.p9.TIER_1 ? ex.NW.formatToPlainString(ex.t.fXv4ws, {
          daysLeft: R.metadata.daysLeft
        }) : eA === eg.p9.TIER_0 ? ex.NW.formatToPlainString(ex.t.ZOHZMj, {
          daysLeft: R.metadata.daysLeft
        }) : ex.NW.formatToPlainString(ex.t.outyHh, {
          daysLeft: R.metadata.daysLeft
        }), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_UNCANCEL,
          onClick: () => {
            var e, t;
            eC(null == (t = R.metadata) || null == (e = t.premiumSubscription) ? void 0 : e.currentPeriodEnd), (0, c.ZDy)(async () => {
              let {
                default: e
              } = await Promise.all([n.e("17938"), n.e("69635")]).then(n.bind(n, 561623));
              return t => {
                var n, i;
    ...
    case eh.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.NW.string(ex.t.LlZaoa), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT,
          onClick: () => {
            var e, t;
    ...
    case eh.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.NW.string(ex.t["30YfCg"]), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT,
          onClick: () => {
            var e, t;
            eC(null == (t = R.metadata) || null == (e = t.premiumSubscription) ? void 0 : e.currentPeriodEnd), O.Z.open(eh.oAB.SUBSCRIPTIONS)
    ...
    case eh.kVF.PREMIUM_MISSING_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eA === eg.p9.TIER_1 ? ex.NW.formatToPlainString(ex.t.b6QUvb, {
          daysLeft: R.metadata.daysLeft
        }) : eA === eg.p9.TIER_0 ? ex.NW.formatToPlainString(ex.t["tURZ/P"], {
          daysLeft: R.metadata.daysLeft
        }) : ex.NW.formatToPlainString(ex.t.AyC74O, {
          daysLeft: R.metadata.daysLeft
        }), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_MISSING_PAYMENT,
          onClick: () => {
    ...
    case eh.kVF.QUARANTINED:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [ex.NW.string(ex.t.DVFJYW), (0, r.jsx)(c.u3T, {
          href: e_.Z,
          target: "_blank",
    ...
    case eh.kVF.BLOCKED_BY_PROXY:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.WARNING,
        children: [ex.NW.string(ex.t.Ugijzs), (0, r.jsx)(c.u3T, {
    ...
    case eh.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.NW.string(ex.t.B8ruyc), (0, r.jsx)(c.EyT, {
          onClick: () => {
            null != j && (0, W.UE)(j, eQ, () => {
              eC(eq), (0, W.T9)(j)
            })
    ...
    case eh.kVF.SAFETY_USER_SENTIMENT_NAGBAR:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.NW.string(ex.t.I1nKfH), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.SAFETY_USER_SENTIMENT_NAGBAR,
          onClick: () => {
            (0, c.ZDy)(async () => {
              let {
    ...
    case eh.kVF.BLOCK_USER_FEEDBACK_NAGBAR:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), ex.NW.string(ex.t["0klLS0"]), (0, r.jsx)(c.NoS, {
          onClick: () => {
            var e;
