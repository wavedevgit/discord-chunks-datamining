...
let eO = e => {
  ...
  ex = () => (0, r.jsxs)(c.qXd, {
    ...
    }), eE.intl.string(eE.t.o3zuY2), (0, r.jsx)(eO, {
  ...
  ey = () => (0, r.jsxs)(c.qXd, {
    ...
    }), eE.intl.string(eE.t.nCO9bG), (0, r.jsx)(eO, {
  ...
  eI = () => (0, r.jsxs)(c.qXd, {
    ...
    }), eE.intl.string(eE.t.dNAJ19), (0, r.jsx)(eO, {
      allowClick: !0,
      error: R.u.NO_AUDIO_INPUT_DETECTED,
...
let eS = 12633 == n.j ? i.memo(function() {
  var e, t;
  ...
  i.useEffect(() => {
    ...
    if (null != I && I.type === eg.kVF.SURVEY && null != I.metadata) {
      let {
        metadata: e
      } = I, t = M.Z.getUserExperimentDescriptor(e.id);
  ...
  switch (I.type) {
    ...
    case eg.kVF.WIN32_DEPRECATED_MESSAGE:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          helpCenterLink: ed.Z.getArticleURL(eg.BhN.WIN32_DEPRECATE)
        })]
      });
    case eg.kVF.WIN7_8_DEPRECATED_MESSAGE:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          helpCenterLink: ed.Z.getArticleURL(eg.BhN.WIN7_8_DEPRECATE)
        })]
      });
    case eg.kVF.MACOS_19_DEPRECATED_MESSAGE:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          helpCenterLink: ed.Z.getArticleURL(eg.BhN.MACOS_19_DEPRECATE)
        })]
      });
    case eg.kVF.GENERIC:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), I.message, null != I.buttonText ? (0, r.jsx)(c.NoS, {
          onClick: I.callback,
          noticeType: eg.kVF.GENERIC,
    ...
    case eg.kVF.SCHEDULED_MAINTENANCE:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eE.intl.format(eE.t.yb96S0, I.metadata), (0, r.jsx)(c.u3T, {
    ...
    case eg.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK:
      if (null == I.metadata) return null;
      let {
        skuId: eM, applicationId: ek
      } = I.metadata, eU = eo.Z.get(eM), eF = S.Z.getApplication(ek);
    ...
    case eg.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL: {
      ...
      let {
        skuId: e,
        applicationId: t
      } = I.metadata, n = eo.Z.get(e), i = S.Z.getApplication(t);
    ...
    case eg.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          children: [null != ez ? eE.intl.formatToPlainString(eE.t["pHj+z8"], {
            name: "".concat(ez),
            progress: eV,
            total: eH
    ...
    case eg.kVF.PREMIUM_UNCANCEL:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          color: "currentColor",
          className: eC.premiumIcon
        }), eN === e_.p9.TIER_1 ? eE.intl.formatToPlainString(eE.t.fXv4ws, {
          daysLeft: I.metadata.daysLeft
        }) : eN === e_.p9.TIER_0 ? eE.intl.formatToPlainString(eE.t.ZOHZMj, {
          daysLeft: I.metadata.daysLeft
          ...
          onClick: () => {
            var e, t;
            ej(null == (t = I.metadata) || null == (e = t.premiumSubscription) ? void 0 : e.currentPeriodEnd), (0, c.ZDy)(async () => {
              let {
                default: e
    ...
    case eg.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT:
      let {
        daysPastDue: eW, dismissUntil: eK
      } = I.metadata;
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.WARNING,
        children: [(0, r.jsx)(c.RyX, {
    ...
    case eg.kVF.PREMIUM_MISSING_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eN === e_.p9.TIER_1 ? eE.intl.formatToPlainString(eE.t.b6QUvb, {
          daysLeft: I.metadata.daysLeft
        }) : eN === e_.p9.TIER_0 ? eE.intl.formatToPlainString(eE.t["tURZ/P"], {
          daysLeft: I.metadata.daysLeft
