...
let ev = e => {
    ...
    let {
      ...
      location: i,
      allowClick: l = !1
    } = e, a = null == (t = (0, R.hp)(n)) ? void 0 : t.errorCode, o = eE.intl.formatToPlainString(eE.t["ejOT9/"], {
      errorCode: a
    }), {
      avErrorUIEnabled: s
    } = (0, k.JN)({
  ...
  eO = () => (0, r.jsxs)(c.qXd, {
    ...
    }), eE.intl.string(eE.t.o3zuY2), (0, r.jsx)(ev, {
  ...
  ej = () => (0, r.jsxs)(c.qXd, {
    ...
    }), eE.intl.string(eE.t.nCO9bG), (0, r.jsx)(ev, {
  ...
  eC = () => (0, r.jsxs)(c.qXd, {
    ...
    }), eE.intl.string(eE.t.dNAJ19), (0, r.jsx)(ev, {
      allowClick: !0,
      error: R.u.NO_AUDIO_INPUT_DETECTED,
  ...
  switch (R.type) {
    ...
    case eh.kVF.VOICE_DISABLED:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eE.intl.string(eE.t.bOQ3jY), (0, r.jsx)(c.NoS, {
          onClick: () => {
    ...
    case eh.kVF.VOICE_CONNECTED_LAST_SESSION:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eE.intl.string(eE.t.jY2lUF), (0, r.jsx)(c.NoS, {
          onClick: () => {
    ...
    case eh.kVF.SPOTIFY_AUTO_PAUSED:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eE.intl.string(eE.t["D8Cp7+"]), (0, r.jsx)(c.NoS, {
    ...
    case eh.kVF.UNCLAIMED_ACCOUNT:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DEFAULT,
        children: [eE.intl.string(eE.t["f+Zaoq"]), (0, r.jsx)(c.NoS, {
    ...
    case eh.kVF.SCHEDULED_MAINTENANCE:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eE.intl.format(eE.t.yb96S0, R.metadata), (0, r.jsx)(c.u3T, {
    ...
    case eh.kVF.HARDWARE_MUTE:
      ...
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DANGER,
        children: [eE.intl.format(eE.t.qoDex8, {
          vendorName: eL.name,
          modelName: eM.name
        }), (0, r.jsx)(c.RyX, {
          onClick: () => {
    ...
    case eh.kVF.STREAMER_MODE:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eE.intl.string(eE.t.iEgBXl), (0, r.jsx)(c.NoS, {
    ...
    case eh.kVF.H264_DISABLED:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eE.intl.string(eE.t.HcErZW), (0, r.jsx)(c.EyT, {
          onClick: () => {
            (0, f.jN)(eh.S9g.USER_SETTINGS), O.Z.setSection(eh.oAB.VOICE)
          },
    ...
    case eh.kVF.SERVER_USAGE_SURVEY:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          children: eE.intl.string(eE.t["4RQks7"])
        })]
      });
    case eh.kVF.CORRUPT_INSTALLATION:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DANGER,
        children: [eE.intl.string(eE.t.ugxmk5), (0, r.jsx)(c.u3T, {
    ...
    case eh.kVF.VIDEO_UNSUPPORTED_BROWSER:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eE.intl.string(eE.t.wVjKGh), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.VIDEO_UNSUPPORTED_BROWSER,
          onClick: () => {
            (0, c.ZDy)(async () => {
              let {
    ...
    case eh.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          children: [null != eK ? eE.intl.formatToPlainString(eE.t["pHj+z8"], {
            name: "".concat(eK),
            progress: ez,
            total: eW
    ...
    case eh.kVF.APPLICATION_TEST_MODE:
      ...
      if (null != es.Z.testModeEmbeddedApplicationId) return (0, r.jsx)(c.qXd, {
        ...
        children: (0, r.jsxs)(T.Z, {
          ...
          children: [(0, r.jsx)("div", {
            children: eE.intl.format(eE.t["1qxVe3"], {
      ...
      return (0, r.jsx)(c.qXd, {
        ...
        children: (0, r.jsxs)(T.Z, {
          ...
          align: T.Z.Align.CENTER,
          children: [(0, r.jsx)("div", {
            children: eE.intl.format(eE.t.Fv5HrK, {
              applicationName: R.metadata.applicationName
            })
          }), (0, r.jsx)(em.Z, {
    ...
    case eh.kVF.PREMIUM_UNCANCEL:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          color: "currentColor",
          className: ey.premiumIcon
        }), eA === eg.p9.TIER_1 ? eE.intl.formatToPlainString(eE.t.fXv4ws, {
          daysLeft: R.metadata.daysLeft
        }) : eA === eg.p9.TIER_0 ? eE.intl.formatToPlainString(eE.t.ZOHZMj, {
          daysLeft: R.metadata.daysLeft
        }) : eE.intl.formatToPlainString(eE.t.outyHh, {
          daysLeft: R.metadata.daysLeft
        }), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_UNCANCEL,
          onClick: () => {
          ...
          children: eA === eg.p9.TIER_1 ? eE.intl.string(eE.t.BkbUPD) : eA === eg.p9.TIER_0 ? eE.intl.string(eE.t.Px978f) : eE.intl.string(eE.t.LW5tCA)
        })]
      });
    ...
    case eh.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eE.intl.string(eE.t.LlZaoa), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT,
          onClick: () => {
            var e, t;
    ...
    case eh.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eE.intl.string(eE.t["30YfCg"]), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT,
          onClick: () => {
            var e, t;
            eS(null == (t = R.metadata) || null == (e = t.premiumSubscription) ? void 0 : e.currentPeriodEnd), O.Z.open(eh.oAB.SUBSCRIPTIONS)
    ...
    case eh.kVF.PREMIUM_MISSING_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
        ...
        }), eA === eg.p9.TIER_1 ? eE.intl.formatToPlainString(eE.t.b6QUvb, {
          daysLeft: R.metadata.daysLeft
        }) : eA === eg.p9.TIER_0 ? eE.intl.formatToPlainString(eE.t["tURZ/P"], {
          daysLeft: R.metadata.daysLeft
        }) : eE.intl.formatToPlainString(eE.t.AyC74O, {
          daysLeft: R.metadata.daysLeft
        }), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.PREMIUM_MISSING_PAYMENT,
          onClick: () => {
          ...
          children: eA === eg.p9.TIER_1 ? eE.intl.string(eE.t.lboF5O) : eA === eg.p9.TIER_0 ? eE.intl.string(eE.t["4UPwOj"]) : eE.intl.string(eE.t["P/VvGR"])
        })]
      });
    case eh.kVF.BACK_TO_PREVIOUS_SCREEN:
      return (0, r.jsx)(V.h, {
        buttonText: null != (l = R.buttonText) ? l : eE.intl.string(eE.t["/g10LC"]),
        onGoBack: R.callback,
        onDismiss: () => eS(),
        showCloseButton: !0
      });
    ...
    case eh.kVF.QUARANTINED:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [eE.intl.string(eE.t.DVFJYW), (0, r.jsx)(c.u3T, {
          href: e_.Z,
          target: "_blank",
    ...
    case eh.kVF.BLOCKED_BY_PROXY:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.WARNING,
        children: [eE.intl.string(eE.t.Ugijzs), (0, r.jsx)(c.u3T, {
    ...
    case eh.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eE.intl.string(eE.t.B8ruyc), (0, r.jsx)(c.EyT, {
          onClick: () => {
            null != C && (0, U.UE)(C, eQ, () => {
              eS(eq), (0, U.T9)(C)
            })
    ...
    case eh.kVF.SAFETY_USER_SENTIMENT_NAGBAR:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eE.intl.string(eE.t.I1nKfH), (0, r.jsx)(c.NoS, {
          noticeType: eh.kVF.SAFETY_USER_SENTIMENT_NAGBAR,
          onClick: () => {
            (0, c.ZDy)(async () => {
              let {
    ...
    case eh.kVF.BLOCK_USER_FEEDBACK_NAGBAR:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eE.intl.string(eE.t["0klLS0"]), (0, r.jsx)(c.NoS, {
          onClick: () => {
            var e;
