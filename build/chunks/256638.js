...
let eN = e => {
    ...
    let {
      ...
      location: i,
      allowClick: a = !1
    } = e, o = null == (t = (0, k.hp)(n)) ? void 0 : t.errorCode, s = eO.intl.formatToPlainString(eO.t["ejOT9/"], {
      errorCode: o
    }), {
      avErrorUIEnabled: l
    } = (0, j.JN)({
    ...
    return a ? (0, r.jsx)(c.P3F, {
      ...
      onClick: () => a && open(e_.Z.getArticleURL(eg.BhN.AV_ERROR_CODES)),
      children: u
    }) : u
  },
  eC = () => (0, r.jsxs)(c.qXd, {
    ...
    }), eO.intl.string(eO.t.o3zuY2), (0, r.jsx)(eN, {
      error: k.u.NO_INPUT_DEVICES,
  ...
  ew = () => (0, r.jsxs)(c.qXd, {
    ...
    }), eO.intl.string(eO.t.nCO9bG), (0, r.jsx)(eN, {
  ...
  eR = () => (0, r.jsxs)(c.qXd, {
    ...
    }), eO.intl.string(eO.t.dNAJ19), (0, r.jsx)(eN, {
      allowClick: !0,
      error: k.u.NO_AUDIO_INPUT_DETECTED,
...
let ex = i.memo(function() {
  ...
  i.useEffect(() => {
    ...
    if (null != S && S.type === eg.kVF.SURVEY && null != S.metadata) {
      let {
        metadata: e
      } = S, t = U.Z.getUserExperimentDescriptor(e.id);
      null != t && (0, M.W9)(e.id, t), (async () => {
        var e, t;
        (null == (e = S.metadata) ? void 0 : e.id) != null && await (0, O.g8)(null == (t = S.metadata) ? void 0 : t.id)
      })()
    }
  }, [S]);
  ...
  let {
    useRecurringNotices: ex
  } = $.b.getCurrentConfig({
    location: "AppNotice"
  });
  if (ex && null != em && (j === eg.kVF.PREMIUM_TIER_2_TRIAL_ENDING || j === eg.kVF.PREMIUM_TIER_2_DISCOUNT_ENDING)) return (0, r.jsx)(L.W, {
    dismissibleContent: em,
    noticeType: S.type
  });
  if (null != eI) return (0, r.jsx)(x.q, {
    dismissibleContent: eI,
    noticeType: S.type
  });
  if (null != eS) return (0, r.jsx)(D.c, {
    dismissibleContent: eS
  });
  if (null != eN) return (0, r.jsx)(P.A, {
  ...
  switch (S.type) {
    ...
    case eg.kVF.WIN32_DEPRECATED_MESSAGE:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          helpCenterLink: e_.Z.getArticleURL(eg.BhN.WIN32_DEPRECATE)
        })]
      });
    case eg.kVF.WIN7_8_DEPRECATED_MESSAGE:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          helpCenterLink: e_.Z.getArticleURL(eg.BhN.WIN7_8_DEPRECATE)
        })]
      });
    case eg.kVF.MACOS_19_DEPRECATED_MESSAGE:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          helpCenterLink: e_.Z.getArticleURL(eg.BhN.MACOS_19_DEPRECATE)
        })]
      });
    case eg.kVF.GENERIC:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), S.message, null != S.buttonText ? (0, r.jsx)(c.NoS, {
          onClick: S.callback,
          noticeType: eg.kVF.GENERIC,
    ...
    case eg.kVF.VOICE_DISABLED:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eO.intl.string(eO.t.bOQ3jY), (0, r.jsx)(c.NoS, {
          onClick: () => {
    ...
    case eg.kVF.VOICE_CONNECTED_LAST_SESSION:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eO.intl.string(eO.t.jY2lUF), (0, r.jsx)(c.NoS, {
          onClick: () => {
    ...
    case eg.kVF.SPOTIFY_AUTO_PAUSED:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eO.intl.string(eO.t["D8Cp7+"]), (0, r.jsx)(c.NoS, {
    ...
    case eg.kVF.UNCLAIMED_ACCOUNT:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DEFAULT,
        children: [eO.intl.string(eO.t["f+Zaoq"]), (0, r.jsx)(c.NoS, {
    ...
    case eg.kVF.UNVERIFIED_ACCOUNT:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DEFAULT,
        children: [eO.intl.string(eO.t["3sWbf3"]), (0, r.jsx)(c.NoS, {
          noticeType: eg.kVF.UNVERIFIED_ACCOUNT,
          onClick: () => {
            f.Z.verifyResend(), u.Z.show({
    ...
    case eg.kVF.HARDWARE_MUTE:
      ...
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DANGER,
        children: [eO.intl.format(eO.t.qoDex8, {
          vendorName: eZ.name,
          modelName: eF.name
        }), (0, r.jsx)(c.RyX, {
          onClick: () => {
    ...
    case eg.kVF.STREAMER_MODE:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eO.intl.string(eO.t.iEgBXl), (0, r.jsx)(c.NoS, {
    ...
    case eg.kVF.H264_DISABLED:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eO.intl.string(eO.t.HcErZW), (0, r.jsx)(c.EyT, {
          onClick: () => {
            (0, p.jN)(eg.S9g.USER_SETTINGS), I.Z.setSection(eg.oAB.VOICE)
          },
    ...
    case eg.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK:
      if (null == S.metadata) return null;
      let {
        skuId: eV, applicationId: eH
      } = S.metadata, eY = ec.Z.get(eV), eW = N.Z.getApplication(eH);
    ...
    case eg.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL: {
      ...
      let {
        skuId: e,
        applicationId: t
      } = S.metadata, n = ec.Z.get(e), i = N.Z.getApplication(t);
    ...
    case eg.kVF.CORRUPT_INSTALLATION:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DANGER,
        children: [eO.intl.string(eO.t.ugxmk5), (0, r.jsx)(c.u3T, {
    ...
    case eg.kVF.VIDEO_UNSUPPORTED_BROWSER:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eO.intl.string(eO.t.wVjKGh), (0, r.jsx)(c.NoS, {
          noticeType: eg.kVF.VIDEO_UNSUPPORTED_BROWSER,
          onClick: () => {
            (0, c.ZDy)(async () => {
              let {
    ...
    case eg.kVF.DISPATCH_ERROR:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), null == ez ? void 0 : ez.displayMessage, (0, r.jsx)(c.NoS, {
          noticeType: eg.kVF.DISPATCH_ERROR,
    ...
    case eg.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          children: [null != eX ? eO.intl.formatToPlainString(eO.t["pHj+z8"], {
            name: "".concat(eX),
            progress: eq,
            total: e$
    ...
    case eg.kVF.APPLICATION_TEST_MODE:
      if (null == S.metadata) return null;
      if (null != eu.Z.testModeEmbeddedApplicationId) return (0, r.jsx)(c.qXd, {
        color: c.DM8.WARNING,
    ...
    case eg.kVF.PREMIUM_UNCANCEL:
      return (0, r.jsxs)(c.qXd, {
        color: ek === eE.p9.TIER_1 ? c.DM8.PREMIUM_TIER_1 : ek === eE.p9.TIER_0 ? c.DM8.PREMIUM_TIER_0 : c.DM8.PREMIUM_TIER_2,
        children: [(0, r.jsx)(c.RyX, {
          noticeType: eg.kVF.PREMIUM_UNCANCEL,
          onClick: () => {
            var e, t;
            eD(null == (t = S.metadata) || null == (e = t.premiumSubscription) ? void 0 : e.currentPeriodEnd)
          }
        }), (0, r.jsx)(c.SrA, {
          size: "md",
          color: "currentColor",
          className: ev.premiumIcon
        }), ek === eE.p9.TIER_1 ? eO.intl.formatToPlainString(eO.t.fXv4ws, {
          daysLeft: S.metadata.daysLeft
        }) : ek === eE.p9.TIER_0 ? eO.intl.formatToPlainString(eO.t.ZOHZMj, {
          daysLeft: S.metadata.daysLeft
        }) : eO.intl.formatToPlainString(eO.t.outyHh, {
          daysLeft: S.metadata.daysLeft
        }), (0, r.jsx)(c.NoS, {
          noticeType: eg.kVF.PREMIUM_UNCANCEL,
          onClick: () => {
          ...
          children: ek === eE.p9.TIER_1 ? eO.intl.string(eO.t.BkbUPD) : ek === eE.p9.TIER_0 ? eO.intl.string(eO.t.Px978f) : eO.intl.string(eO.t.LW5tCA)
        })]
      });
    case eg.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eO.intl.format(eO.t.zxU0Ki, {
          daysPastDue: eQ
        }), (0, r.jsx)(c.NoS, {
          noticeType: eg.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT,
          onClick: () => {
            eD(eJ), I.Z.open(eg.oAB.SUBSCRIPTIONS)
          },
    ...
    case eg.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eO.intl.string(eO.t.LlZaoa), (0, r.jsx)(c.NoS, {
          noticeType: eg.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT,
          onClick: () => {
            var e, t;
            eD(null == (t = S.metadata) || null == (e = t.premiumSubscription) ? void 0 : e.currentPeriodEnd), I.Z.open(eg.oAB.SUBSCRIPTIONS)
          },
    ...
    case eg.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eO.intl.string(eO.t["30YfCg"]), (0, r.jsx)(c.NoS, {
          noticeType: eg.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT,
          onClick: () => {
            var e, t;
            eD(null == (t = S.metadata) || null == (e = t.premiumSubscription) ? void 0 : e.currentPeriodEnd), I.Z.open(eg.oAB.SUBSCRIPTIONS)
    ...
    case eg.kVF.PREMIUM_MISSING_PAYMENT:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
        ...
        }), ek === eE.p9.TIER_1 ? eO.intl.formatToPlainString(eO.t.b6QUvb, {
          daysLeft: S.metadata.daysLeft
        }) : ek === eE.p9.TIER_0 ? eO.intl.formatToPlainString(eO.t["tURZ/P"], {
          daysLeft: S.metadata.daysLeft
        }) : eO.intl.formatToPlainString(eO.t.AyC74O, {
          daysLeft: S.metadata.daysLeft
        }), (0, r.jsx)(c.NoS, {
          noticeType: eg.kVF.PREMIUM_MISSING_PAYMENT,
          onClick: () => {
          ...
          children: ek === eE.p9.TIER_1 ? eO.intl.string(eO.t.lboF5O) : ek === eE.p9.TIER_0 ? eO.intl.string(eO.t["4UPwOj"]) : eO.intl.string(eO.t["P/VvGR"])
        })]
      });
    ...
    case eg.kVF.QUARANTINED:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.DANGER,
        children: [eO.intl.string(eO.t.DVFJYW), (0, r.jsx)(c.u3T, {
          href: eb.Z,
          target: "_blank",
    ...
    case eg.kVF.BLOCKED_BY_PROXY:
      return (0, r.jsxs)(c.qXd, {
        color: c.DM8.WARNING,
        children: [eO.intl.string(eO.t.Ugijzs), (0, r.jsx)(c.u3T, {
    ...
    case eg.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION:
      ...
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eO.intl.string(eO.t.B8ruyc), (0, r.jsx)(c.EyT, {
          onClick: () => {
            null != h && (0, B.UE)(h, e1, () => {
              eD(e0), (0, B.T9)(h)
            })
    ...
    case eg.kVF.SAFETY_USER_SENTIMENT_NAGBAR:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eO.intl.string(eO.t.I1nKfH), (0, r.jsx)(c.NoS, {
          noticeType: eg.kVF.SAFETY_USER_SENTIMENT_NAGBAR,
          onClick: () => {
            (0, c.ZDy)(async () => {
              let {
    ...
    case eg.kVF.PREMIUM_TIER_2_TRIAL_ENDING:
      ...
      return (0, r.jsx)(Q.Z, {
        dismissCurrentNotice: () => {
          (0, R.Q3)(ed.m9[eg.kVF.PREMIUM_TIER_2_TRIAL_ENDING]), eD(e2)
        },
        subscriptionTier: eE.Si.TIER_2
      });
    ...
    case eg.kVF.QUESTS_PROGRESS_INTERRUPTION:
      return (0, r.jsxs)(c.qXd, {
        ...
        children: [(0, r.jsx)(c.RyX, {
          ...
          onClick: () => {
            var e;
            (null == (e = S.metadata) ? void 0 : e.streamKey) != null && (0, J.nE)(S.metadata.streamKey)
          }
    ...
    case eg.kVF.BLOCK_USER_FEEDBACK_NAGBAR:
      return (0, r.jsxs)(c.qXd, {
        ...
        }), eO.intl.string(eO.t["0klLS0"]), (0, r.jsx)(c.NoS, {
          onClick: () => {
            var e;
