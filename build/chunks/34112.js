...
function A(e) {
  let {
    ...
    headerHeight: c,
    query: d
  } = e, m = (0, u.e7)([y.Z], () => y.Z.getRoleMemberCount(n.id), [n.id]), g = (0, u.e7)([v.Z], () => v.Z.getHighestRole(n), [n]), h = d.trim();
  i.useEffect(() => {
    (0, C.E)(n.id)
  }, [n.id]);
  let f = i.useRef(!1);
  i.useEffect(() => {
    f.current || "" === d.trimStart() || (O.default.track(T.rMx.SEARCH_STARTED, {
      search_type: "Roles"
    }), f.current = !0)
  }, [d]);
...
function M(e) {
  ...
  } = e, A = (0, I.T)(d, p, u), L = null != A, [M, U] = i.useState(!1), B = i.useMemo(() => ({
    type: k,
    item: () => (v(u.id), {
      id: u.id,
      position: f
  ...
  return (0, r.jsxs)(m.P3F, {
    ...
    children: [(0, r.jsx)("div", {
      ...
      children: [(null == (t = u.tags) ? void 0 : t.guild_connections) === null ? (0, r.jsx)(h.Z, {
        ...
        children: u.name
      }), (null == (l = u.tags) ? void 0 : l.subscription_listing_id) != null && (0, r.jsx)(_.Z, {
      ...
      position: "right",
      children: e => (0, r.jsxs)(m.P3F, D(Z({}, e), {
...
function G(e) {
  ...
  let {
    ...
    enableTooltip: g,
    className: p,
    defaultIconClassName: h
  } = e, {
    hasGradient: x,
    stops: b,
    gradientId: _
  } = (0, d.De)(null == (t = o.colorStrings) ? void 0 : t.primaryColor, null == (n = o.colorStrings) ? void 0 : n.secondaryColor, null == (i = o.colorStrings) ? void 0 : i.tertiaryColor), v = (0, j.p9)({
    guildId: a,
    roleId: o.id,
    size: u
  });
  if (null != v) return (0, r.jsx)(f.Z, D(Z({}, v), {
    className: p,
    enableTooltip: g
  }));
  let O = null != (l = o.colorString) ? l : (0, c.Rf)(T.p6O);
  return x && (O = "url(#".concat(_, ")")), (0, r.jsxs)(r.Fragment, {
    children: [x && (0, r.jsx)("svg", {
      width: "0",
      height: "0",
      style: {
        position: "absolute"
