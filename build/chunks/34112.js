...
function A(e) {
  let {
    ...
    headerHeight: c,
    query: u
  } = e, m = (0, d.e7)([C.Z], () => C.Z.getRoleMemberCount(n.id), [n.id]), p = (0, d.e7)([_.Z], () => _.Z.getHighestRole(n), [n]), h = u.trim();
  i.useEffect(() => {
    (0, O.E)(n.id)
  }, [n.id]);
  let f = i.useRef(!1);
...
function L(e) {
  ...
  let {
    ...
    setEditRoleId: S,
    setSelectedSection: A
  } = e, k = (0, N.T)(g, h, d), L = null != k, [G, U] = i.useState(!1), B = i.useMemo(() => ({
    type: D,
    item: () => (v(d.id), {
      id: d.id,
      position: b
