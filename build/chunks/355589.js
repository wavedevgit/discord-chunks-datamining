...
class G {
  addStep(e) {
    ++this.currentIndex, this.steps.push(z({
...
let q = e => {
  ...
  X = e => {
    ...
    return {
      ...
      clickHandler: () => {
        V(M.ZI.TAGS), f.ZP.open(e.id), (0, g.ZDy)(async () => {
          let {
            default: t
          } = await n.e("21971").then(n.bind(n, 201049));
          return n => (0, r.jsx)(t, B(z({}, n), {
            channelId: e.id,
            guildId: e.guild_id
          }))
        })
  ...
  W = e => {
    ...
    return {
      ...
      clickHandler: () => {
        V(M.ZI.DEFAULT_REACTION), (0, g.ZDy)(async () => {
          let {
            default: t
  ...
  K = (e, t, i) => ({
    ...
    description: t ? L.intl.string(L.t["8hI5vr"]) : L.intl.format(L.t.ysxcAw, {
      onClick: e => {
        null != i && (e.preventDefault(), e.stopPropagation(), (0, E.qz)(), (0, g.ZDy)(async () => {
          let {
            default: e
          } = await n.e("18417").then(n.bind(n, 740696));
          return t => (0, r.jsx)(e, B(z({}, t), {
            guildId: i
          }))
        }))
      }
  ...
  $ = (e, t, n, r) => {
    ...
    i.useEffect(() => (n || !e || t ? clearTimeout(l.current) : l.current = setTimeout(() => {
      r()
    }, 60 * O.Z.Millis.SECOND), () => clearTimeout(l.current)), [e, t, r, n])
  },
  ee = (e, t, n) => {
    (0, x.ZP)(() => {
      e && t && n()
  ...
  et = e => {
    let {
      ...
      guildId: l,
      channel: a
    } = e, s = (0, h.e7)([C.Z], () => null != l ? C.Z.getRoles(l) : void 0), o = i.useCallback(() => {
  ...
  ea = e => {
    let {
      ...
      hasAnyThread: a,
      handleHide: s
    } = e, [o, c] = i.useState(!1), d = (0, k.c)(l.id), u = (0, h.e7)([S.Z], () => S.Z.hasHidden(l.id)), f = function(e, t, l, a) {
      ...
      return i.useMemo(() => {
        ...
        return null == e || null == t || s || null == o || i.addStep(function(e, t, i, l) {
          ...
          return {
            ...
            clickHandler: () => {
              V(M.ZI.PERMISSIONS), (0, g.ZDy)(async () => {
                let {
                  default: t
                } = await n.e("78704").then(n.bind(n, 560602));
                return l(!0), n => (0, r.jsx)(t, B(z({}, n), {
                  channel: i,
                  guild: e,
                  permission: a,
        ...
        }(e, o, t, a)), s || i.addStep(q(t)), i.addStep(X(t)), i.addStep(W(t)), i.addStep(K(l, s, null == e ? void 0 : e.id)), i
      }, [t, e, o, l, a])
    }(t, l, a, c), p = f.isAllDone();
    return $(p, d || u || !Y(l.id), o, s), {
      onboardingSteps: f,
      isHidden: u,
      isDismissed: d,
      isAllDone: p
  ...
  ed = e => {
    let {
      ...
      hasAnyThread: t,
      handleHide: j
    }), P = !w && !O, N = (0, Z.AF)(), E = n.isMediaChannel(), k = e => N.getState().setOnboardingExpanded(e);
    return (ee(S, P, j), et({
      isAllDone: S,
      isVisible: P,
      canManageChannel: o,
      ...
      t && P || k(!0)
    }), null == s) ? null : P && o ? E ? t ? null : (0, r.jsx)(v.Z, {
      channel: n
    }) : (0, r.jsx)(r.Fragment, {
