...
class X {
  addStep(e) {
    ++this.currentIndex, this.steps.push(U({
...
let K = e => {
  ...
  J = e => {
    ...
    return {
      ...
      clickHandler: () => {
        W(F.ZI.TAGS), f.ZP.open(e.id), (0, g.ZDy)(async () => {
          let {
            default: t
  ...
  Y = e => {
    ...
    return {
      ...
      clickHandler: () => {
        W(F.ZI.DEFAULT_REACTION), (0, g.ZDy)(async () => {
          let {
            default: t
  ...
  Q = (e, t, i) => ({
    ...
    description: t ? z.intl.string(z.t["8hI5vr"]) : z.intl.format(z.t.ysxcAw, {
      onClick: e => {
  ...
  en = (e, t, n, r) => {
    ...
    i.useEffect(() => (n || !e || t ? clearTimeout(a.current) : a.current = setTimeout(() => {
      r()
    }, 60 * N.Z.Millis.SECOND), () => clearTimeout(a.current)), [e, t, r, n])
  },
  er = (e, t, n) => {
    (0, p.ZP)(() => {
      e && t && n()
  ...
  ec = e => {
    let {
      ...
      hasAnyThread: l,
      handleHide: s
    } = e, [o, c] = i.useState(!1), d = (0, Z.c)(a.id), u = (0, h.e7)([P.Z], () => P.Z.hasHidden(a.id)), f = function(e, t, a, l) {
      ...
      return i.useMemo(() => {
        ...
        return null == e || null == t || s || null == o || i.addStep(function(e, t, i, a) {
          ...
          return {
            ...
            clickHandler: () => {
              W(F.ZI.PERMISSIONS), (0, g.ZDy)(async () => {
                let {
                  default: t
                } = await n.e("78704").then(n.bind(n, 560602));
                return a(!0), n => (0, r.jsx)(t, V(U({}, n), {
                  channel: i,
                  guild: e,
                  permission: l,
        ...
        }(e, o, t, l)), s || i.addStep(K(t)), i.addStep(J(t)), i.addStep(Y(t)), i.addStep(Q(a, s, null == e ? void 0 : e.id)), i
      }, [t, e, o, a, l])
    }(t, a, l, c), x = f.isAllDone();
    return en(x, d || u || !ee(a.id), o, s), {
      onboardingSteps: f,
      isHidden: u,
      isDismissed: d,
      isAllDone: x
  ...
  eh = e => {
    let {
      ...
      tagFilter: s
    } = (0, R.H)(i.id), o = (0, h.e7)([O.Z], () => O.Z.getGuild(i.getGuildId())), m = (0, k.r_)(i), {
      transitions: f,
      setVisible: x
    } = ea(), b = el(a), j = ed(), S = $(i.id, x), {
      onboardingSteps: N,
      isDismissed: T,
      isHidden: P,
      isAllDone: I
      ...
      hasAnyThread: t,
      handleHide: S
    }), E = !P && !T, M = (0, L.AF)(), Z = i.isMediaChannel(), F = e => M.getState().setOnboardingExpanded(e);
    return (er(I, E, S), ei({
      isAllDone: I,
      isVisible: E,
      canManageChannel: m,
