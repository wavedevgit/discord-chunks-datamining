...
class X {
  addStep(e) {
    ++this.currentIndex, this.steps.push(H({
...
let W = e => {
  ...
  K = e => {
    ...
    return {
      ...
      clickHandler: () => {
        q(L.ZI.TAGS), f.ZP.open(e.id), (0, g.ZDy)(async () => {
          let {
            default: t
          } = await n.e("21971").then(n.bind(n, 201049));
          return n => (0, r.jsx)(t, U(H({}, n), {
            channelId: e.id,
            guildId: e.guild_id
          }))
        })
  ...
  J = e => {
    ...
    return {
      ...
      clickHandler: () => {
        q(L.ZI.DEFAULT_REACTION), (0, g.ZDy)(async () => {
          let {
            default: t
  ...
  Y = (e, t, i) => ({
    ...
    description: t ? D.intl.string(D.t["8hI5vr"]) : D.intl.format(D.t.ysxcAw, {
      onClick: e => {
        null != i && (e.preventDefault(), e.stopPropagation(), (0, R.qz)(), (0, g.ZDy)(async () => {
          let {
            default: e
  ...
  er = e => {
    let {
      ...
      guildId: l,
      channel: a
    } = e, s = (0, h.e7)([y.Z], () => null != l ? y.Z.getRoles(l) : void 0), o = i.useCallback(() => {
  ...
  ea = e => {
    ...
    return (0, r.jsx)("div", {
      ...
      "aria-label": D.intl.formatToPlainString(D.t.PCs0oq, {
        numRoles: n.length
      }),
  ...
  eo = e => {
    let {
      ...
      hasAnyThread: a,
      handleHide: s
    } = e, [o, c] = i.useState(!1), d = (0, Z.c)(l.id), u = (0, h.e7)([P.Z], () => P.Z.hasHidden(l.id)), f = function(e, t, l, a) {
      ...
      return i.useMemo(() => {
        ...
        return null == e || null == t || s || null == o || i.addStep(function(e, t, i, l) {
          ...
          return {
            ...
            clickHandler: () => {
              q(L.ZI.PERMISSIONS), (0, g.ZDy)(async () => {
                let {
                  default: t
        ...
        }(e, o, t, a)), s || i.addStep(W(t)), i.addStep(K(t)), i.addStep(J(t)), i.addStep(Y(l, s, null == e ? void 0 : e.id)), i
      }, [t, e, o, l, a])
  ...
  em = e => {
    let {
      ...
      tagFilter: s
    } = (0, E.H)(i.id), o = (0, h.e7)([y.Z], () => y.Z.getGuild(i.getGuildId())), m = (0, k.r_)(i), {
      transitions: f,
      setVisible: x
    } = ei(), b = el(l), j = ec(), w = Q(i.id, x), {
      onboardingSteps: S,
      isDismissed: N,
      isHidden: P,
      isAllDone: T
      ...
      hasAnyThread: t,
      handleHide: w
    }), I = !P && !N, R = (0, A.AF)(), Z = i.isMediaChannel(), L = e => R.getState().setOnboardingExpanded(e);
    return (en(T, I, w), er({
      isAllDone: T,
      isVisible: I,
      canManageChannel: m,
      ...
      t && I || L(!0)
    }), null == o) ? null : (0, C.iZ)(i) ? n ? null : (0, r.jsx)(_.q, {}) : I && m ? Z ? t ? null : (0, r.jsx)(v.Z, {
      channel: i
    }) : (0, r.jsx)(r.Fragment, {
