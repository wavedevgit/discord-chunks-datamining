...
function O(A) {
  ...
  } = (0, v.ZP)(), w = u.nm(l), M = u.QM(l), Q = null == (e = u.V$(I.zUn.REASON, l)) ? void 0 : e.newValue, O = u.J5(l), P = (0, c.LJ)(l.id), V = (0, o.e7)([B.ZP], () => null != l.userId ? B.ZP.getMember(s.guildId, l.userId) : null, [s.guildId, l.userId]), j = (0, C.X7)(null == V ? void 0 : V.guildId, null == V ? void 0 : V.userId, null != (t = null == V ? void 0 : V.colorStrings) ? t : null), T = r.useCallback(A => e => {
    e.preventDefault(), e.stopPropagation(), null != A && (0, h.RE)(A, E)
  }, [E]), y = r.useCallback(() => null == l.user ? null : (0, n.jsx)(g.ua7, {
