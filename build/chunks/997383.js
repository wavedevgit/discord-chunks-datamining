...
n.d(t, {
  Z: () => I
}), n(388685), n(704826), n(35282), n(781311), n(457542), n(190126), n(368063), n(65234), n(111804), n(490233), n(97749), n(539854), n(642613);
var r = n(392711),
  i = n.n(r),
  a = n(159635),
  o = n.n(a),
...
class I {
  ...
  setOptions(e) {
    ...
    t ? this.options = E({}, this.options, e) : this.options = e, null != this.options.blacklist ? this._userBlacklist = Array.from(this.options.blacklist).map(e => e.startsWith("user:") ? e.replace("user:", "") : "").filter(e => "" !== e) : this._userBlacklist = null
  }
  search(e, t) {
  ...
  queryVoiceChannels(e, t) {
    ...
    } = this.options, r = v(m.h8.VOICE_CHANNEL, this.options);
    return d.ZP.queryChannels({
      query: e,
      guildId: n,
      limit: t,
  ...
  queryGroupDMs(e, t) {
    ...
    let {
      blacklist: n
    } = this.options, r = v(m.h8.GROUP_DM, this.options), i = null != n ? e => !n.has("channel:".concat(e.id)) : void 0;
  ...
  queryApplications(e, t) {
    return this._include(m.h8.APPLICATION) ? d.ZP.queryApplications({
      query: e,
      limit: t,
      fuzzy: !0
    }) : []
  ...
  queryInAppNavigations(e, t) {
    return this._include(m.h8.IN_APP_NAVIGATION) ? d.ZP.queryInAppNavigations({
      query: e,
      limit: t,
      fuzzy: !0
    }) : []
  ...
  constructor(e, t, n = b, r = y) {
    g(this, "query", ""), g(this, "options", y), g(this, "results", []), g(this, "_userResults", []), g(this, "_groupDMResults", []), g(this, "_textChannelResults", []), g(this, "_voiceChannelResults", []), g(this, "_guildResults", []), g(this, "_applicationResults", []), g(this, "_linkResults", []), g(this, "_inAppNavigations", []), g(this, "_asyncTimeout", void 0), g(this, "userSearchContext", void 0), g(this, "onResultsChange", void 0), g(this, "resultTypes", void 0), g(this, "_userBlacklist", null), g(this, "_limit", void 0), g(this, "parseUserResults", e => {
      let {
        results: t
      } = e;
      ...
      clearTimeout(this._asyncTimeout), this.results = i()([...this._userResults, ...this._groupDMResults, ...this._textChannelResults, ...this._voiceChannelResults, ...this._guildResults, ...this._linkResults, ...this._inAppNavigations]).uniqBy(e => "".concat(e.type, "-").concat(e.record.id)).sort(h.Z).value(), this.onResultsChange(this.results, this.query)
