...
let g = e => {
  let {
    ...
    reportId: g,
    reportType: f
  } = e, h = (0, i.e7)([u.Z], () => u.Z.isBlocked(t.id), [t.id]), x = (0, i.e7)([c.Z], () => c.Z.getChannel(n), [n]), v = l.useMemo(() => m.ZP.getName(null == x ? true : x.guild_id, null == x ? true : x.id, t), [x, t]), _ = l.useCallback(() => {
