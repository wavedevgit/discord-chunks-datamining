...
let _ = e => {
  let {
    ...
    reportId: _,
    reportType: x
  } = e, h = (0, i.e7)([u.Z], () => u.Z.isBlocked(t.id), [t.id]), b = (0, i.e7)([c.Z], () => c.Z.getChannel(n), [n]), f = l.useMemo(() => m.ZP.getName(null == b ? true : b.guild_id, null == b ? true : b.id, t), [b, t]), v = l.useCallback(() => {
