...
let I = (0, Chunk624138.Mg)(Chunk477690.Z.STICKERS_CONSTANTS_STICKER_DIMENSION),
  ...
  S = e => {
    ...
    } = (0, c.ZP)(s.Z.STICKER_MESSAGE), S = <span className={E.stickerName}>{<a.B7q size={"xs"} color={"currentColor"} className={E.stickerIcon} />}{(null != b ? b : t).name}</span>;
    return <c.Gt value={O}><a.yRy align={"center"} animation={a.yRy.Animation.TRANSLATE} positionKey={m} onRequestClose={() => {
          _(true)
        }} renderPopout={e => (0, r.jsx)(h.Z, v(y({}, e), {
          renderableSticker: t,
          channel: n,
          refreshPositionKey: () => g(String(Date.now()))
        }))} targetElementRef={l}>{e => {
          let {
            onClick: n
          } = e;
