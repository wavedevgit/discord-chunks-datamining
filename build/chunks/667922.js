...
function y(e, t) {
  let {
    reducedMotion: n
  } = r.useContext(a.Sfi), g = (0, u.$R)(t), y = (0, l.e7)([f.Z], () => (t.isPrivate() || f.Z.can(h.Plq.ADD_REACTIONS, t)) && g, [t, g]), v = (0, o.MZ)(t.getGuildId());
  if (!d.nc.getSetting() || !y || e.type === h.uaV.GUILD_INVITE_REMINDER) return null;
  let j = v.filter(e => !b.ZP.isEmojiFilteredOrLocked({
    emoji: e,
    channel: t,
