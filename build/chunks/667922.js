...
function E(e, t) {
  let {
    reducedMotion: n
  } = r.useContext(a.Sfi), g = (0, u.$R)(t), E = (0, l.e7)([f.Z], () => (t.isPrivate() || f.Z.can(p.Plq.ADD_REACTIONS, t)) && g, [t, g]), v = (0, o.MZ)(t.getGuildId());
  if (!d.nc.getSetting() || !E || e.type === p.uaV.GUILD_INVITE_REMINDER) return null;
  let j = v.filter(e => !h.ZP.isEmojiFilteredOrLocked({
    emoji: e,
    channel: t,
