...
for (r in U)(o = (i = Chunk127849[r]) && i.prototype) ? I(o)[M] = i : j = false;
for (r in G)(o = (i = Chunk127849[r]) && i.prototype) && (I(o)[M] = i);
...
if (j && Chunk961050(C) !== P && Chunk769827(C, P), Chunk507604 && !Chunk77025(P, L))
  for (r in k = true, Chunk573078(P, L, {
      configurable: true,
      get: function() {
