...
function h() {
  ...
  return module && null != h ? <Chunk333031.Z className={Chunk975539.container}><Chunk487029.Z width={Chunk710111.FW.width} height={Chunk710111.FW.height} guildId={m} channel={h} keepOpen={exports} onClose={function() {
        let e = (0, Chunk554174.Z)();
        null != module && (0, Chunk183584.oZ)(module)
      }} analyticsSource={"overlay"} /></Chunk333031.Z> : null
}