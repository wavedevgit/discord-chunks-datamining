...
function p(e) {
  let {
    guildId: t,
    scrollToQuestions: n
  } = e, p = (0, i.e7)([a.Z], () => a.Z.isAdvancedMode(t)), h = (0, i.e7)([c.Z], () => c.Z.editedDefaultChannelIds), [f, x] = (0, o.VF)(t, h), [b, j] = (0, d.OA)(t, [...h]), N = p ? j.length : x.length, _ = p ? b.length : f.length, v = N < u.md, O = _ >= u.X, C = j.length - x.length, y = (0, r.jsx)(l.owK, {
    size: "sm",
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      foregroundColors: S,
      percents: E,
      size: l.yGy.Sizes.XSMALL
    }), (0, r.jsxs)("div", {
      className: g.requiredItem,
      children: [v ? I : y, (0, r.jsx)(l.Text, {
