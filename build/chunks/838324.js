...
function p(e) {
  let {
    guildId: t,
    scrollToQuestions: n
  } = e, p = (0, i.e7)([l.Z], () => l.Z.isAdvancedMode(t)), f = (0, i.e7)([c.Z], () => c.Z.editedDefaultChannelIds), [h, b] = (0, o.VF)(t, f), [x, j] = (0, d.OA)(t, [...f]), N = p ? j.length : b.length, v = p ? x.length : h.length, _ = N < u.md, y = v >= u.X, O = j.length - b.length, C = (0, r.jsx)(a.owK, {
    size: "sm",
