...
function S(e) {
  return (0, i.G)(C, {
    drop(e, t) {
      ...
      if (0 !== m.length) {
        ...
        if (m = m.filter(e => {
            ...
            return n.type === v.d4z.GUILD_CATEGORY || null == r ? O.Z.can(v.Plq.MANAGE_CHANNELS, f) : O.Z.can(v.Plq.MANAGE_CHANNELS, r)
    ...
    canDrop(e, t) {
      ...
      if (y.Z.getGuildId() === v.I_8) returntrue;
    ...
    canDrag(e) {
      ...
      if (null == i) returnfalse;
      if ((0, p.r1)(i.id) && O.Z.can(v.Plq.MANAGE_CHANNELS, i)) return (0, d.N)() && (0, o.ZDy)(async () => {
        let {
          default: e
    ...
    beginDrag(e) {
      ...
      return {
        ...
        channelList: (0, c.Z)(a._categories, a, e => {
          ...
          return t.type === v.d4z.GUILD_CATEGORY && null != a[t.id] && 0 === a[t.id].length ? o === v.I_8 || O.Z.can(v.Plq.MANAGE_CHANNELS, t) && O.Z.can(v.Plq.VIEW_CHANNEL, t) : !f.Z.isCollapsed(t.parent_id)
        }),
        guildId: r
      }
    }
