    ...
    drop(e, t) {
      ...
      if (0 !== m.length) {
        ...
        if (m = m.filter(e => {
            ...
            return n.type === j.d4z.GUILD_CATEGORY || null == r ? O.Z.can(j.Plq.MANAGE_CHANNELS, h) : O.Z.can(j.Plq.MANAGE_CHANNELS, r)
    ...
    beginDrag(e) {
      ...
      return {
        ...
        channelList: (0, c.Z)(a._categories, a, e => {
          ...
          return t.type === j.d4z.GUILD_CATEGORY && null != a[t.id] && 0 === a[t.id].length ? o === j.I_8 || O.Z.can(j.Plq.MANAGE_CHANNELS, t) && O.Z.can(j.Plq.VIEW_CHANNEL, t) : !h.Z.isCollapsed(t.parent_id)
        }),
        guildId: r
      }
    }
