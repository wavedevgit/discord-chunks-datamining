...
function m(e) {
  ...
  return i.useEffect(() => {
    s || a()
  }, [a, s]), <div onMouseEnter={n} onMouseLeave={o}>{t(d({
      closePopout: a
    }, l))}</div>
}
let g = Chunk73800.forwardRef(function(e, t) {
  ...
  let D = I && !g || O,
    L = O;
  return <a.yRy targetElementRef={u} animation={a.yRy.Animation.FADE} shouldShow={D} animationPosition={"top"} position={"top"} align={_} spacing={16} onRequestClose={() => {
