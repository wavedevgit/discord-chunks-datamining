...
function p(e, t, n) {
  return i.useMemo(() => {
    let i = [e, t, n].filter(e => null != e),
      ...
      s = i.map((e, t) => <stop offset={"".concat(t * a, "%")} style={{
          stopColor: e
        }} />),
      l = i.join("");
    return {
...
function h(e, t) {
  return i.useMemo(() => {
    ...
    let i = new RegExp(d),
      o = [],
      s = 0;
    for (; null !== (n = i.exec(e));) n.index > s && o.push(e.slice(s, n.index)), o.push(<span className={a()(u.emoji, t)}>{n[0]}</span>), s = i.lastIndex;
