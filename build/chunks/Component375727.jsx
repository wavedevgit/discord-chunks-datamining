...
let w = new Chunk710845.Z("EmojiStudio"),
  T = e => {
    ...
    let {
      userImage: n,
      guildId: i
    } = e, [h, T] = r.useState(n), k = (0, s.e7)([g.Z, x.Z, f.Z], () => {
      let e = x.Z.getGuildId(),
        t = g.Z.getGuild(e);
      return f.Z.can(O.Plq.CREATE_GUILD_EXPRESSIONS, t) && null != t ? t.id : null
    }), [A, P] = r.useState(null != i ? i : k), [D, z] = r.useState(null), [G, L] = r.useState(null), [Z, B] = r.useState(""), [U, H] = r.useState(null), [F, V] = r.useState(() => Date.now()), J = r.useRef(0), W = r.useRef(0), Y = r.useRef(false), K = r.useCallback(e => {
      let {
        reason: t
      } = e, n = null != D ? D : G;
    ...
    let X = r.useCallback(async () => {
      ...
      $ = r.useCallback(e => {
        ...
        null != t && _.ZP.isDataTooBig(t) && (r = b.ze.TOO_BIG), z(null != l ? l : r), n < J.current || null != t && (H(t), J.current = n)
      }, []),
      Q = r.useCallback(() => {
        W.current++
      }, []),
      ee = r.useCallback(e => {
        ...
        T(e), B(t => {
          var n, l;
          if ("" !== t) return t;
          let r = null != (l = null == e || null == (n = e.file) ? true : n.name) ? l : "",
            i = r.lastIndexOf("."),
            a = false === i ? r : r.substring(0, i);
