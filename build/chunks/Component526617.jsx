...
function ef(e) {
  let {
    ...
    allSounds: eL,
    soundCounts: ej
  } = (0, B.ZP)(a, {}, eh), [eM, ek] = i.useState([]), eU = (0, B.FS)(ex, eM, eR), eG = (0, b.Iu)(e => e.isNitroLockedSectionVisible), [eB, eZ] = i.useState(false), eF = i.useMemo(() => eU.filter(e => e.items.length > 0), [eU]), eV = i.useMemo(() => eF.findLastIndex(e => !!(0, D._O)(e.categoryInfo) && e.categoryInfo.isNitroLocked), [eF]), eH = !eA && J && false !== eV, eY = A.T4.useSetting(), eW = i.useMemo(() => new Set(eY), [eY]), eK = null == a, ez = D.ZP.canUseCustomCallSounds(eS), eq = i.useCallback(e => {
