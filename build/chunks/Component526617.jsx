...
function eu(e) {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [l && (0, r.jsx)(I.ZP, {
      ...
      className: a()(q.sectionContainer, {
        [q.sectionContainerNitroLocked]: s
      }),
      children: (0, r.jsx)(c.P3F, {
        className: a()(q.sectionHeader, {
          [q.notFirstSectionHeader]: 0 !== o
        }),
        onClick: i,
        "aria-expanded": !n,
...
function ef(e) {
  let {
  ...
  }), [eO]), [eI, eT] = i.useState(null), eS = (0, l.e7)([C.default], () => C.default.getCurrentUser()), eA = (0, D.I5)(eS, K.p9.TIER_2), eN = (0, l.e7)([R.Z], () => {
    var e;
    return R.Z.getVoiceState(t, null != (e = null == eS ? true : eS.id) ? e : Y.lds)
  }), eC = (null == eN ? true : eN.selfDeaf) || (null == eN ? true : eN.mute) || (null == eN ? true : eN.suppress), eR = (0, b.Iu)(e => e.searchQuery), eP = null != eR && "" !== eR, ew = (0, m.Dt)(), eD = L.C.useExperiment({
    location: "SoundboardSoundGrid"
  }), {
    categories: eL,
    allSounds: ex,
    soundCounts: eM
  } = (0, B.ZP)(o, {}, eh), [ek, ej] = i.useState([]), eU = (0, B.FS)(eL, ek, eR), eG = (0, b.Iu)(e => e.isNitroLockedSectionVisible), eB = eU.filter(e => e.items.length > 0), eZ = eB.findLastIndex(e => !!(0, D._O)(e.categoryInfo) && e.categoryInfo.isNitroLocked), eF = !eA && J && false !== eZ, eV = A.T4.useSetting(), eH = i.useMemo(() => new Set(eV), [eV]), eY = null == o, eW = D.ZP.canUseCustomCallSounds(eS), eK = i.useCallback(e => {
    eH.has(e) ? eH.delete(e) : eH.add(e), A.T4.updateSetting(Array.from(eH))
  }, [eH]), ez = i.useCallback((e, t, n) => {
    if (null != I && !P) return I(e, n);
    let r = (0, k.Nq)(eS, e, o, false);
    if (null != I && P && r) I(e, n);
    else if (!X && r && (0, k.C0)(o)) {
      var i;
      (0, k.GN)(e, null != (i = null == o ? true : o.id) ? i : Y.lds, t), eP && w.default.track(Y.rMx.SEARCH_RESULT_SELECTED, {
  ...
  }, [X, eS, o, J, eP, eR, I, P]), eq = i.useCallback((e, t) => {
    switch (e.item.type) {
      case M.vB.SOUND:
        var n;
        let r = null != (n = el[null == e ? true : e.category]) ? n : null;
        return ez(e.item.sound, null == r ? eb : [...eb, r], (null == t ? true : t.shiftKey) !== true);
      case M.vB.ADD_SOUND:
        return g(), (0, H.Z)(e.item.guild.id)
    }
  }, [eb, ez, g]), eX = i.useCallback((e, n, i, s, l) => {
  ...
  }, [eB, J, eA, t, X, eq, o, eY, eW, eC, eb, ef, eF, em]), eQ = i.useCallback((e, t) => {
  ...
  }, [eJ]), e0 = i.useCallback(e => 0 === e ? eo : eQ(e, t) ? ei : er, [t, eQ]), e1 = i.useCallback(e => {
    let t = e === eB.length - 1;
    return eF && t ? 60 : eF && e === eZ ? 20 : 0
  }, [eB.length, eF, eZ]), e2 = i.useCallback((e, n) => {
    let i = "".concat(e.key),
      o = J && ec(e.categoryInfo, eA, t),
      a = eQ(n, t),
      s = eH.has(i),
      l = () => {
    ...
    return (0, r.jsx)(eu, {
      ...
      collapsed: s,
      index: n,
      isSectionNitroLocked: o && eF,
      showNitroDivider: a && eF
    }, "header-".concat(i))
  }, [eH, eK, t, eQ, J, eA, eF]), e3 = i.useCallback((e, t) => {
    let n = t === eB.length - 1,
      i = t === eZ;
    return eF && n ? (0, r.jsx)("div", {
      className: a()(q.lastSectionFooter, {
        [q.nitroLocked]: i
      })
    }) : eF && t === eZ ? (0, r.jsx)("div", {
      className: a()(q.smallPaddingFooter, q.nitroLocked)
    }) : null
  }, [eZ, eF, eB.length]), e5 = i.useCallback(e => ej((0, G.cK)(e, Array.from(ex.values()).flat(), eS, o, eb)), [o, eS, ex, eb]), e4 = i.useCallback(e => {
    (0, u.jW)(e, async () => {
      let {
        default: e
  ...
  }, [eb]), e6 = i.useCallback(() => em ? (0, r.jsx)(O.Hh, {
    renderPopout: () => (0, r.jsx)(O.hq, {}),
    tooltipText: z.intl.string(z.t["19lt29"]),
    position: "top",
    clickableClassName: a()(q.settingsClickArea, q.settingsSoundmojiClickArea),
  ...
  }), [em, e4]), e8 = i.useCallback(e => (0, r.jsx)(Z.Z, {
    soundboardListRef: e,
    categories: eL,
    ...
    guildId: t,
    inExpressionPicker: em
  }), [eL, eF, e_, t, em]), e7 = i.useCallback(() => eF ? (0, r.jsx)(v.p, {
  ...
  }) : null, [e$, eF, eD.alwaysStickyUpsell, eG]), e9 = i.useCallback(e => {
    var t;
  ...
  }, [eE]), tn = (0, l.e7)([N.Z], () => N.Z.getMediaSessionId());
  return (0, h.Z)({
