      ...
      switch (e.type) {
        ...
        case g.c.OPEN_FRIEND_MODAL:
          ...
          (0, o.openUserProfileModal)({
            userId: e.userId,
            guildId: null != (n = e.guildId) ? n : true,
            channelId: e.channelId,
    ...
    handleContextMenu: r.useCallback(e => {
      ...
      switch (e.type) {
        case g.K.FRIEND_ROW: {
          ...
          (0, i.L3)(e.event, async () => {
            ...
            return n => (0, l.jsx)(e, E(m({}, n), {
              ...
              widgetType: p.uss.FRIENDS,
              friendGroupId: r,
              showManageFriendGroupsItems: true
            }))
          }, {
        ...
        case g.K.GUILD_TEXT_CHANNEL: {
          ...
          }), (null == (t = r.isModeratorReportChannel) ? true : t.call(r)) ? (0, i.L3)(e.event, async () => {
            let {
              default: e
        ...
        case g.K.VOICE_USER: {
          ...
          let o = null != (r = null == a ? true : a.id) ? r : null;
          (0, c.YX)(p.uss.FRIENDS, {
            type: c.Z5.TEXT_CHAT,
            value: c.IP.SETTINGS_OPENED,
