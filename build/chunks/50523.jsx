...
function O(e) {
  ...
  let {
    ...
    embedUrl: T,
    referrerId: S
  } = e, A = null == O || null == (t = O.bot) ? true : t.id, N = (0, c.ms)({
    context: {
      type: "contextless"
    },
    applicationId: O.id,
    botUserId: null == O || null == (n = O.bot) ? true : n.id
  }), C = null != O && (0, l.ye)(O), R = null != A && C && N, {
    analyticsLocations: P
  } = (0, a.ZP)(o.Z.ACTIVITY_CUSTOM_LINK), w = (0, i.e7)([p.Z], () => p.Z.getChannelId()), D = (0, b.KF)(w), L = (0, i.e7)([g.ZP], () => {
    if (null == w) return;
    let e = g.ZP.getEmbeddedActivitiesForChannel(w).filter(e => e.applicationId === O.id);
    return e.length > 0 ? e[0].compositeInstanceId : true
  }), x = (0, i.e7)([g.ZP], () => g.ZP.getCurrentEmbeddedActivity()), M = (0, E.Z)(), k = D === b.jy.CAN_LAUNCH, j = null != v ? v : I.customId, U = [];
  k && U.push({
    ...
    disabledReason: null != L && (null == x ? true : x.compositeInstanceId) === L ? y.intl.string(y.t.wJNK8P) : true
  }), R && !k && U.push({
  ...
  let G = (0, _.G)(O);
  return <d.W actions={U} onClickContent={G} embedUrl={T} header={O.name} iconSrc={h.ZP.getApplicationIconURL({
      id: O.id,
      icon: O.icon,
      bot: O.bot
    })} info={(0, r.jsx)("div", {
      children: I.description
    })} staticBannerSrc={I.getAssetURL()} title={I.title} trackingConfig={{
      id: O.id,
