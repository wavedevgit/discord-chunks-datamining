  ...
  return i.useLayoutEffect(() => {
    ...
    function t() {
      ...
      let {
        width: o,
        height: s
      } = E.current, l = null != (n = null == (e = h.current) ? void 0 : e.videoWidth) ? n : 0, c = null != (r = null == (t = h.current) ? void 0 : t.videoHeight) ? r : 0;
      if (o !== l || s !== c) {
        let e = {
          width: l,
          height: c
    ...
    let e = h.current;
    if (null != e)
      if (!a) return f.info("attaching srcObject for ".concat(n)), e.srcObject = m(n), () => {
