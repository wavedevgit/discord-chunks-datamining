...
let el = 72,
  ...
  es = r.memo(function(e) {
    let {
      ...
      ref: T,
      height: x
    } = (0, b.ZP)(), S = (0, K.xH)(e => e.setCardHeight, d.X);
    r.useEffect(() => {
      null != x && S(t, x)
    }, [x, S, t]), r.useEffect(() => {
    ...
    return (0, i.jsxs)("div", {
      ...
      }), (null == O ? void 0 : O.blocked) || null == y ? null : (0, i.jsx)(eO, {
        channel: m,
        firstMedia: y
      })]
    })
...
function eh(e) {
  let {
    ...
    facepileRef: n,
    firstMessage: r
  } = e, o = (0, x.Q)(t.id), l = (null == r ? void 0 : r.reactions) != null && r.reactions.length > 0;
  return (0, i.jsxs)("div", {
    className: ei.footer,
