...
let ei = 72,
  ...
  ec = a.memo(function(e) {
    ...
    return (0, r.jsxs)("div", {
      ...
      }), (null == x ? void 0 : x.blocked) || null == O ? null : (0, r.jsx)(ev, {
        channel: g,
        firstMedia: O
      })]
    })
...
function eh(e) {
  let {
    ...
    facepileRef: n,
    firstMessage: a
  } = e, s = (0, P.Q)(t.id), l = (null == a ? void 0 : a.reactions) != null && a.reactions.length > 0;
  return (0, r.jsxs)("div", {
    className: ea.footer,
...
function ep(e) {
  ...
  let {
    ...
    sortOrder: a
  } = (0, U.H)(n.parent_id), s = (0, H.xw)(n, a), l = null == (t = n.threadMetadata) ? void 0 : t.createTimestamp, i = null == l ? null : er.intl.formatToPlainString(er.t["13euCQ"], {
