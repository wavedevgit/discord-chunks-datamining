...
function Y(e, t, n, i) {
  ...
  r.useEffect(() => {
    ...
    let r = R.Z.getThreadIds(e.id, t, n, i),
      o = L.Z.getThreadIdsMissingCounts(e.guild_id, r).filter(e => (0, k.nU)(e, [S.ZP])).slice(0, H).map(e => ({
        threadId: e,
        ackMessageId: S.ZP.getTrackedAckMessageId(e)
      }));
    o.length > 0 && l.Z.dispatch({
...
function W(e) {
  return (0, s.e7)([g.Z, O.Z], () => {
    let t = a()(g.Z.getThreadsForParent(e.guild_id, e.parent_id)).keys().filter(e => {
      var t;
...
function er(e) {
  let {
    ...
    hasSpoilerEmbeds: !1,
    content: null
  }, [t, n, i, a]), l = (0, P.eL)(t, o), c = (0, P.vg)(t, o);
  return {
    hasSpoilerEmbeds: o,
    content: s,
    firstMedia: l,
...
function em(e) {
  let {
    ...
    tagFilter: i,
    tagSetting: a,
    shouldAutomaticallyAck: o
  } = e, l = (0, s.Wu)([R.Z], () => R.Z.getThreadIds(t.id, n, i, a)), u = eh(t.guild_id, t.id), d = (0, s.e7)([R.Z], () => o && (u > 0 || R.Z.getCanAckThreads()), [o, u]);
  return r.useEffect(() => {
    d && (0, c.U6)(t, {
