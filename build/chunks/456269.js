...
function Y(e, n, t, l) {
  ...
  r.useEffect(() => {
    ...
    let r = A.Z.getThreadIds(e.id, n, t, l),
      i = N.Z.getThreadIdsMissingCounts(e.guild_id, r).filter(e => (0, U.nU)(e, [S.ZP])).slice(0, 180).map(e => ({
        threadId: e,
...
function X(e) {
  return (0, a.e7)([E.Z, b.Z], () => {
    let n = u()(E.Z.getThreadsForParent(e.guild_id, e.parent_id)).keys().filter(e => {
      var n;
...
function en(e) {
  let {
    ...
    hasSpoilerEmbeds: !1,
    content: null
  }, [n, t, l, u]), o = (0, j.eL)(n, i), d = (0, j.vg)(n, i);
  return {
    hasSpoilerEmbeds: i,
    content: a,
    firstMedia: o,
...
function eg(e) {
  ...
  } = e, o = (0, a.Wu)([A.Z], () => A.Z.getThreadIds(n.id, t, l, u)), s = ef(n.guild_id, n.id), c = (0, a.e7)([A.Z], () => i && (s > 0 || A.Z.getCanAckThreads()), [i, s]);
  return r.useEffect(() => {
    c && (0, d.U6)(n)
  }, [n, c]), o
}