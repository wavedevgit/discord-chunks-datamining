...
function G(e) {
  return (0, a.e7)([v.Z, P.Z], () => {
    let t = u()(v.Z.getThreadsForParent(e.guild_id, e.parent_id)).keys().filter(e => {
      var t;
      return (null == (t = P.Z.getChannel(e)) ? void 0 : t.hasFlag(D.zZ.PINNED)) === !0
    }).head();
...
function x(e) {
  ...
  return r.useMemo(() => {
    var n, r, l;
    let u = null != (l = null == e || null == (r = e.appliedTags) || null == (n = r.map(e => t[e])) ? void 0 : n.filter(A.lm)) ? l : H;
...
function B(e) {
  let t = null == e ? void 0 : e.defaultReactionEmoji,
    n = (0, a.e7)([c.ZP], () => (null == t ? void 0 : t.emojiId) != null ? c.ZP.getUsableCustomEmojiById(t.emojiId) : null);
...
function K(e) {
  ...
  let n = (0, a.e7)([O.default], () => O.default.getUser(e.ownerId)),
    l = (0, a.e7)([y.Z], () => {
      var t;
      return null == (t = y.Z.getMessage(e.id)) ? void 0 : t.firstMessage
    }),
...
function V(e) {
  ...
  let r = O.default.getUser(e.ownerId),
    l = null == (t = y.Z.getMessage(e.id)) ? void 0 : t.firstMessage,
...
function W(e) {
  let {
    ...
    hasSpoilerEmbeds: i,
    content: a
  } = r.useMemo(() => (null == t ? void 0 : t.content) != null && "" !== t.content ? (0, g.ZP)(t, {
    formatInline: n,
    ...
    hasSpoilerEmbeds: !1,
    content: null
  }, [t, n, l, u]), o = (0, w.eL)(t, i), d = (0, w.vg)(t, i);
  return {
    hasSpoilerEmbeds: i,
    content: a,
    firstMedia: o,
...
function ee(e) {
  return (0, a.cj)([b.Z, S.ZP], () => {
    var t;
    let n = b.Z.getGuild(null != (t = e.getGuildId()) ? t : F.lds);
...
function er(e, t) {
  let n = en((0, a.e7)([P.Z], () => P.Z.getChannel(null == e ? void 0 : e.parent_id), [e]));
  return r.useMemo(() => {
...
function ed(e) {
  ...
  return r.useEffect(() => {
    c && (0, d.U6)(t, {
      ...
      objectType: F.Qqv.ACK_AUTOMATIC
    })
  }, [t, c]), o
}