...
function m() {
  ...
  return <Chunk838436.U setting={Chunk726985.s6.PRIVACY_AND_SAFETY_PERSISTENT_VERIFICATION_CODES}><Chunk51331.Z value={module} onChange={Chunk90641.Z.updatePersistentCodesEnabled} title={Chunk388032.intl.string(Chunk388032.t["opi/XF"])} note={Chunk388032.intl.format(Chunk388032.t["/T+ZlJ"], {
