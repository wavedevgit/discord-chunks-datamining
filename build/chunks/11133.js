...
function d(e) {
  ...
  if ((null == e ? true : e.status_display_type) === r.D.NAME && null != n ? p = n : (null == e ? true : e.status_display_type) === r.D.STATE && null != f ? p = f : (null == e ? true : e.status_display_type) === r.D.DETAILS && null != d && (p = d), (0, a.Z)(e)) {
    let e = (0, i.Z)(n);
    return {
      text: e,
      tooltip: e
