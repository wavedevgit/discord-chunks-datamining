...
function u(e) {
  ...
  if ((null == e ? void 0 : e.type) === l.IIU.PLAYING && null != n) return {
    text: c.NW.format(c.t.lFApm5, {
      game: n
    }),
    tooltip: c.NW.formatToPlainString(c.t.lFApm5, {
      game: n
    })
  };
  if ((0, o.Z)(e) && t && null != d) {
    ...
    return {
      text: c.NW.format(c.t.Vnuxub, {
        name: e
      }),
      tooltip: c.NW.formatToPlainString(c.t.Vnuxub, {
        name: e
      })
    }
  }
  return (0, s.dS)(e) && null != n ? {
    text: c.NW.format(c.t.pW3Ip6, {
      name: n
    }),
    tooltip: c.NW.formatToPlainString(c.t.pW3Ip6, {
      name: n
    })
    ...
    text: c.NW.format(c.t.QQ2wVF, {
      name: n
    }),
    tooltip: c.NW.formatToPlainString(c.t.QQ2wVF, {
      name: n
    })
  } : (null == e ? void 0 : e.type) === l.IIU.STREAMING && null != u ? {
    text: c.NW.format(c.t["0wJXSk"], {
      name: u
    }),
    tooltip: c.NW.formatToPlainString(c.t["0wJXSk"], {
      name: u
    })
