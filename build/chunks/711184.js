...
class k extends s.Component {
  ...
  renderHeaderCopy() {
    ...
    return t ? g.intl.string(g.t.fMgJMz) : r ? g.intl.string(g.t.mW2CNz) : g.intl.formatToPlainString(g.t["4n8Pb2"], {
      currentQuestion: e + 1,
