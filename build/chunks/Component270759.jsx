...
let Z = function(e) {
  ...
  let k = e => {
    ...
    G = [{
      ...
      content: j.intl.string(j.t.PfjFjY),
      className: x.item
    }, {
      id: N.pJs.PENDING,
      show: L.filter(N.pJs.PENDING).length > 0,
      content: (0, r.jsxs)(r.Fragment, {
        children: [j.intl.string(j.t.p6IHGB), Z > 0 && (0, r.jsx)(c.mAB, {
          count: Z,
          className: x.badge
        })]
      }),
      ...
      show: R > 0,
      content: (0, r.jsxs)(r.Fragment, {
        children: [j.intl.string(j.t["8rSi19"]), (0, r.jsx)(c.mAB, {
          count: R,
          className: x.badge
        })]
      }),
      ariaLabel: j.intl.formatToPlainString(j.t.AbMQp6, {
        count: R.toString()
      }),
      className: x.item
    }, {
      ...
      content: (0, r.jsx)("span", {
        children: j.intl.string(j.t.j0wbEx)
      }),
      ariaLabel: j.intl.string(j.t.j0wbEx),
  ...
  B && G.unshift({
    id: N.pJs.YOU,
    show: true,
    content: j.intl.string(j.t.LuZzxs),
    className: x.item
  });
  let V = null,
    H = (0, r.jsx)("div", {
