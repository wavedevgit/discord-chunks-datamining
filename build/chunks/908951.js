...
function y(e) {
  let {
    ...
    disabled: R = !1
  } = e, D = (0, c.e7)([_.Z], () => _.Z.hidePersonalInformation), [Z, w] = (0, c.Wu)([x.Z], () => [x.Z.paymentSources, x.Z.hasFetchedPaymentSources]), k = (0, b.V)((0, C.yb)(t)), {
    ...
    P.currency !== r.currency || P.currency === r.currency && P.total !== r.total ? await A(r, () => {
      i(e, n, s)
    }, () => {
      U(!1)
    }) : i(e, n, s)
