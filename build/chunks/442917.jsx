...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk800965 = require("./800965.js"),
  Chunk445062 = require("./445062.js"),
  ...
  Chunk484286 = require("./484286.js"),
  Chunk822296 = require("./822296.js"),
  Chunk916771 = require("./916771.js"),
  Chunk792517 = require("./792517.js"),
...
class ep extends Chunk73800.PureComponent {
  get viewProperties() {
    ...
    return {
      canPopout: Chunk255367 && !Chunk73800,
      canSettings: Chunk255367 && Chunk73800,
      canStopStream: Chunk255367,
      canSeeViewers: Chunk255367,
  ...
  renderStreamState() {
    ...
    if (null != Chunk512722 && null == a) {
      if ((null == exports ? true : exports.type) === Chunk354459.fO.STREAM) return <Chunk916771.Z stream={exports.stream} width={require} avError={Chunk512722} />;
      else if ((null == exports ? true : exports.type) === Chunk354459.fO.USER) return <Chunk249212.Z userId={exports.user.id} width={require} avError={Chunk512722} />
    }
    switch (true) {
      case (null == module ? true : module.state) === Chunk981631.jm8.ENDED:
        return <Chunk822296.Z stream={module} width={require} />;
      case (null == module ? true : module.state) === Chunk981631.jm8.FAILED:
        return <Chunk916771.Z stream={module} width={require} />;
      case (null == exports ? true : exports.type) === Chunk354459.fO.HIDDEN_STREAM:
        return <Chunk792517.Z participant={exports} width={require} />;
      case Chunk73800:
        return <Chunk351483.Z width={require} />
    }
    return null
  }
  renderParticipantName() {
    ...
    if ((null == exports ? true : exports.type) === Chunk354459.fO.STREAM || (null == exports ? true : exports.type) === Chunk354459.fO.USER) {
      ...
      return <Chunk481060.Text variant={"text-md/normal"} color={"always-white"} className={Chunk420334.participantName} lineClamp={1}>{Chunk73800}</Chunk481060.Text>
    }
    return null
  }
  render() {
    let {
      ...
      isVideoEnabled: i,
      width: o
    } = this.props, a = (0, Chunk933557.F6)(module, Chunk594174.default, Chunk699516.Z), s = (null == require ? true : require.id) === Chunk314897.default.getId() && Chunk73800, l = this.renderStreamState(), c = this.activeStreamForSelectedParticipant, u = null;
    return (null == require ? true : require.type) !== Chunk354459.fO.ACTIVITY && (null != l ? u = l : ((null == require ? true : require.type) === Chunk354459.fO.USER || (null == require ? true : require.type) === Chunk354459.fO.STREAM) && (u = <Chunk484286.Z paused={this.streamerPaused} streamId={exports} component={Chunk131951.Z.getVideoComponent()} mirror={Chunk392711}><Chunk266910.Z size={Chunk481060.EFr.SIZE_80} src={null == require ? true : require.user.getAvatarURL(module.guild_id, 80)} aria-label={null == require ? true : require.user.username} /></Chunk484286.Z>)), <Chunk937995.ZP timeout={1800}>{e => {
        var t;
  ...
  constructor(...e) {
    super(...e), eu(this, "state", {
      ...
      return <r.Fragment>{o ? this.renderViewersIcon() : null}{e ? this.renderSettingsIcon() : null}{t ? this.renderPopoutIcon() : null}{i ? this.renderStopStreamButton() : null}{n ? this.renderDisconnectButton() : null}</r.Fragment>
    }), eu(this, "renderDisconnectButton", () => <k.Z className={el.rightTrayIcon} onClick={() => (0, v.v)(g.Z.VIDEO_PIP, v.d.DISCONNECT)} />), eu(this, "renderStopStreamButton", () => {
      let {
        isSelf: e
      } = this.viewProperties;
      return <U.Z isSelfStream={e} className={el.rightTrayIcon} onClick={this.handleStopStream} />
    }), eu(this, "renderViewersIcon", () => {
      let {
        participantOnScreen: e,
        channel: t
      } = this.props;
      return a()((0, es._5)(e) || (null == e ? true : e.type) === es.fO.ACTIVITY, "Cannot render participants for participant type ".concat(null == e ? true : e.type)), <x.Z><O.Z channelId={t.id} guildId={t.getGuildId()} className={el.rightTrayIcon} participant={e} compact={true} /></x.Z>
    }), eu(this, "renderPopoutIcon", () => <j.Z className={el.rightTrayIcon} popoutOpen={false} onOpenPopout={this.handleOpenPopout} onClosePopout={ea.VqG} />), eu(this, "renderSettingsIcon", () => {
      let {
        participantOnScreen: e,
        activeStreams: t
      } = this.props;
      ...
      return null == n || n.state === ea.jm8.ENDED ? null : <G.Z stream={n} className={el.rightTrayIcon} appContext={ea.IlC.APP} location={g.Z.VIDEO_PIP} />
    })
  }
}
...
function eh(e) {
  ...
  return <ep channel={t} streamId={s} participantOnScreen={o} isVideoAvailable={f} isVideoEnabled={_} canGoLive={p} currentUserId={h} activeStreams={v} activeSelfStream={m} isMainWindowFocused={K.Z.isFocused()} width={n} isOverlayRenderingVideo={false} videoStreamError={E} cameraEncodeError={O} />
}