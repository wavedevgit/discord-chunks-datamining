...
function y(e) {
  ...
  }), [L, D] = i.useState({}), M = i.useRef(null);
  return i.useLayoutEffect(() => {
    ...
    children: [(0, l.jsxs)("div", {
      ...
      }), null == L.roles ? null : (0, l.jsx)(a.pdY, {
        error: L.roles
      }), (0, l.jsx)(O, {
        guild: p,
        roleIds: Z
...
function O(e) {
  let {
    guild: t,
    roleIds: n
  } = e, i = (0, s.e7)([j.Z], () => j.Z.getRoles(t.id)), r = Array.from(n).map(e => i[e]).filter(x.lm).find(p.F);
