...
function O(e) {
  let {
    ...
    prompt: O,
    index: C
  } = e, P = (0, u.Dt)(), _ = (0, s.e7)([h.ZP], () => h.ZP.getDefaultChannel(x.id)), [B, S] = i.useState(() => {
    var e;
  ...
  }), [M, D] = i.useState({}), q = i.useRef(null);
...
function I(e) {
  let {
    guild: t,
    roleIds: n
  } = e, i = (0, s.e7)([j.Z], () => j.Z.getRoles(t.id)), l = Array.from(n).map(e => i[e]).filter(v.lm).find(x.F);
