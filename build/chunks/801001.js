...
function P(e) {
  let {
    ...
    prompt: P,
    index: _
  } = e, w = (0, v.Dt)(), Z = (0, s.e7)([p.ZP], () => p.ZP.getDefaultChannel(f.id)), [k, E] = l.useState(() => {
    var e;
  ...
  }), [X, z] = l.useState({}), Y = l.useRef(null);
  l.useLayoutEffect(() => {
    var e;
  ...
  return (0, i.jsxs)(c.IX, {
    ...
    children: [(0, i.jsx)("div", {
      ...
      }), null == X.roles ? null : (0, i.jsx)(u.pdY, {
        error: X.roles
      }), (0, i.jsx)(S, {
        guild: f,
        roleIds: q
...
function S(e) {
  let {
    guild: t,
    roleIds: n
  } = e, l = (0, s.e7)([x.Z], () => x.Z.getRoles(t.id)), r = Array.from(n).map(e => l[e]).filter(g.lm).find(f.F);
