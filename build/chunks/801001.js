  ...
  return (0, i.jsxs)(c.IX, {
    ...
    children: [(0, i.jsx)("div", {
      ...
      children: [(0, i.jsx)(m.Text, {
        ...
        color: "text-muted",
        children: C.intl.format(C.t.yjS3zs, {
          index: w + 1
        })
      }), (0, i.jsx)(m.X6q, {
        id: Z,
...
function _(e) {
  let {
    guild: t,
    roleIds: n
  } = e, r = (0, s.e7)([g.Z], () => g.Z.getRoles(t.id)), l = Array.from(n).map(e => r[e]).filter(f.lm).find(b.F);
  return null == l ? null : (0, i.jsx)("div", {
    ...
    children: (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsx)(m.P4T, {
        ...
        variant: "text-sm/normal",
        children: C.intl.format(C.t["5zPJER"], {
          permissions: (0, b.i)(t, l).join(", ")
        })
      })]
    })
  })
