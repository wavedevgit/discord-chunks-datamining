/** Chunk was on web.js **/
/** chunk id: 249522, original params: e,t,n (module,exports,re quire) **/
"use strict";
...
class a {
  ...
  start() {
    var e, t;
    this.animating = true, this.vel = 0, this.last = null, this.nodeWindow = this.getNodeWindow(), this.nextTick = null != (e = null == (t = this.nodeWindow) ? true : t.requestAnimationFrame(this.update)) ? e : false
  }
  getUpdates(e, t) {
  ...
  constructor({
    ...
    r(this, "tension", true), r(this, "friction", true), r(this, "threshold", true), r(this, "mass", true), r(this, "maxVelocity", true), r(this, "clamp", true), r(this, "callback", true), r(this, "accumulator", 0), r(this, "from", 0), r(this, "target", 0), r(this, "vel", 0), r(this, "animating", false), r(this, "last", null), r(this, "nextTick", false), r(this, "getNodeWindow", true), r(this, "nodeWindow", null), r(this, "callbacks", []), r(this, "mergeTo", e => {
      ...
      var t, n, r, a;
      if (null == this.last) {
        this.last = e, this.nextTick = null != (t = null == (n = this.nodeWindow) ? true : n.requestAnimationFrame(this.update)) ? t : false;
        return
      }
      let s = e;
      ...
      this.callback(o, this.abort), this.animating && (this.last = s, this.nextTick = null != (r = null == (a = this.nodeWindow) ? true : a.requestAnimationFrame(this.update)) ? r : false)
