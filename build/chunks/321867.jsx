...
function C(t) {
  ...
  let A = <s.Z className={v.__invalid_getNitroLink} size={a.zx.Sizes.SMALL} look={a.zx.Looks.LINK} color={a.zx.Colors.LINK} subscriptionTier={b.Si.TIER_2} textOptions={{
      textOverride: g.intl.format(g.t["944tDg"], {})
    }} showIcon={false} premiumModalAnalyticsLocation={{
      section: e,
      object: m.qAy.BUTTON_CTA
    }} disableShine={true} />;
  return <u.Z reducedRightPadding={true} className={v.nitroPreviewUpsell} text={g.intl.format(g.t.Og8039, {})} button={A} />
}