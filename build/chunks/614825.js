...
class P extends i.Component {
  ...
  renderActions(e, t, n) {
    ...
    }, u = o.id !== l.user_id || (0, y.I5)(o) || !o.verified || (0, N.B)(l), p = this.renderExpirationDate(e, t, n);
  ...
  renderExpirationDate(e, t, n) {
    ...
    if (void 0 !== r.redeemed_at && !n && null !== i) return C.NW.formatToPlainString(C.t.nP0ivb, {
      date: (0, b.vc)(s()(i), "LL")
    });
  ...
  render() {
    let {
      ...
      currentUser: t,
      recipientHasNitro: n
    } = this.props, i = (0, N.B)(e), a = t.id === e.referrer_id;
    return (0, r.jsxs)("div", {
