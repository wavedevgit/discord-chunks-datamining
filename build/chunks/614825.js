...
class Z extends i.Component {
  renderTitle(e, t, n) {
    ...
    if (e && void 0 === r.redeemed_at) return N.intl.formatToPlainString(N.t.Mptau7, {
      username: l
    });
    ...
    switch (O.Z.getCurrentConfig({
      ...
      case 1:
        return N.intl.formatToPlainString(N.t["L/leCw"], {
          receiver: l
        });
      case 2:
        return N.intl.formatToPlainString(N.t.febG6u, {
          receiver: l
        });
      case 3:
      ...
      case 4:
        return N.intl.formatToPlainString(N.t.PVQOi4, {
          receiver: l
        });
      default:
  ...
  renderBody(e, t, n) {
    ...
    if (e && !n && void 0 === r.redeemed_at) return N.intl.format(N.t.LwCwT0, {
      helpdeskArticle: x.Z.getArticleURL(T.BhN.REFERRAL_PROGRAM)
    });
    if (t) return null;
    ...
    switch (O.Z.getCurrentConfig({
      ...
      case 1:
        return N.intl.format(N.t.Ylrdnp, {
          sender: l
        });
      case 2:
        return N.intl.format(N.t["8XzXzc"], {
          sender: l
        });
      case 3:
  ...
  renderExpirationDate(e, t, n) {
    ...
    if (void 0 !== r.redeemed_at && !n && null !== i) return N.intl.formatToPlainString(N.t.nP0ivb, {
      date: (0, E.vc)(s()(i), "LL")
    });
    if (e || void 0 === r.expires_at) return null;
    let l = s()(r.expires_at);
    return t ? N.intl.formatToPlainString(N.t.PuSHfX, {
      date: (0, E.vc)(s()(l), "LL")
    }) : (0, j.F6)(l.valueOf())
  }
  renderMedia() {
  ...
  render() {
    let {
      ...
      currentUser: t,
      recipientHasNitro: n
    } = this.props, i = (0, I.B)(e), l = t.id === e.referrer_id;
    return (0, r.jsxs)("div", {
...
function R(e) {
  ...
  }), [n, t]), a = _.default.getCurrentUser(), o = (0, u.e7)([_.default], () => null != i && (0, v.I5)(void 0 !== a && i.user_id === a.id ? a : _.default.getUser(i.user_id))), s = (0, u.e7)([b.Z], () => {
    var e;
