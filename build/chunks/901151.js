...
function E(e) {
  let {
    ...
    let t = e.join(", "),
      r = n.length - 3;
    return r > 0 ? _.intl.format(_.t.sHFdTk, {
      gameList: t,
      plusMoreHook: (e, t) => (0, i.jsx)(l.Text, {
        tag: "span",
        variant: "text-sm/medium",
        color: "text-muted",
        children: _.intl.format(_.t["EADv+/"], {
          count: r
        })
      }, t)
    }) : e.join(", ")
    ...
    for (let t = 0; t < 3; t++) {
      ...
      let {
        ...
        name: l,
        id: a
      } = r, c = o.ZP.getApplicationIconURL({
        id: r.id,
        icon: s
      });
      e.push((0, i.jsx)("img", {
  ...
  return (0, i.jsx)(p.Z, {
    children: e ? (0, i.jsx)(l.$jN, {}) : t.length > 0 ? (0, i.jsxs)(i.Fragment, {
      ...
      children: [(0, i.jsx)(l.Text, {
        ...
        color: "text-muted",
        children: _.intl.format(_.t.V8wClJ, {
