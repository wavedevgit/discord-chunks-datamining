...
function a(e, t, n) {
  ...
  let {
    ...
    icon: p,
    size: n
  }), f = r.useMemo(() => null != g && g.length > t ? g.slice(0, t) : g, [g, t]), x = null != g && g.length > t ? g.length - t : null, b = null == u ? void 0 : u.slug, j = null != b ? l.EYA.ROLE_SUBSCRIPTION_STORE_PAGE(b) : void 0, N = null == m || null == (a = m.guild) ? void 0 : a.name, _ = null == m || null == (o = m.role_subscription) ? void 0 : o.subscriber_count, v = !c && null != N && null != p && null != h;
  return v ? {
