...
function a(e, t, n) {
  ...
  let {
  ...
  } = (0, l.Z)(e), m = null == d ? void 0 : d.store_page, g = r.useMemo(() => {
    var e, t;
    let n = function(e) {
        let t = new Set;
    ...
    icon: p,
    size: n
  }), f = r.useMemo(() => null != g && g.length > t ? g.slice(0, t) : g, [g, t]), x = null != g && g.length > t ? g.length - t : null, b = null == d ? void 0 : d.slug, j = null != b ? s.EYA.ROLE_SUBSCRIPTION_STORE_PAGE(b) : void 0, _ = null == m || null == (a = m.guild) ? void 0 : a.name, v = null == m || null == (o = m.role_subscription) ? void 0 : o.subscriber_count, O = !c && null != _ && null != p && null != h;
  return O ? {
