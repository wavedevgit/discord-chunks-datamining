...
function s(e, t, n) {
  ...
  }, [null == g ? true : g.role_subscription]), f = null == g ? true : g.guild.icon_hash, b = i.ZP.getGuildIconURL({
    id: e,
    icon: f,
    size: n
  }), p = r.useMemo(() => null != m && m.length > t ? m.slice(0, t) : m, [m, t]), h = null != m && m.length > t ? m.length - t : null, x = null == u ? true : u.slug, j = null != x ? a.EYA.ROLE_SUBSCRIPTION_STORE_PAGE(x) : true, v = null == g || null == (s = g.guild) ? true : s.name, O = null == g || null == (o = g.role_subscription) ? true : o.subscriber_count, y = !c && null != v && null != f && null != b;
  return y ? {
