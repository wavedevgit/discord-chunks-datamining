...
function C(e) {
  ...
  return null == n ? null : (0, r.jsx)(c.Text, {
...
class M extends l.PureComponent {
  render() {
    let {
      ...
      action: n,
      themeOverride: l
    } = this.props, s = null != l ? p["themeOverride".concat((0, g.De)(l))] : null, a = i()(p.icon, D[e], n === h.rsA.MESSAGE_DELETE ? p.targetMessage : n === h.rsA.AUTO_MODERATION_BLOCK_MESSAGE || n === h.rsA.AUTO_MODERATION_FLAG_TO_CHANNEL || n === h.rsA.AUTO_MODERATION_USER_COMMUNICATION_DISABLED || n === h.rsA.AUTO_MODERATION_QUARANTINE_USER ? p.autoModerationBlockMessage : ({
      ...
      E = o().flatten(t.changes.map(s => {
        ...
        let {
          ...
          if ((t.action === h.rsA.CHANNEL_UPDATE || t.action === h.rsA.CHANNEL_CREATE) && s.key === h.zUn.TYPE) {
            var e, n;
            return {
              oldValue: null != (e = s.oldValue) ? e : (0, N.a5)({
                type: s.oldValue
              }),
              newValue: null != (n = s.newValue) ? n : (0, N.a5)({
                type: s.newValue
              })
            }
          }
          ...
          return t.action === h.rsA.GUILD_UPDATE && s.key === h.zUn.OWNER_ID ? {
            oldValue: f.ZP.getUserTag(s.oldValue, {
              mode: "username"
            }),
            newValue: f.ZP.getUserTag(s.newValue, {
              mode: "username"
            })
          } : s
        })(), E = (() => {
          if (t.action === h.rsA.MEMBER_ROLE_UPDATE) return function(e) {
            let {
              newValue: t
            } = e;
          ...
          if (t.targetType === h.KFR.ROLE || t.action === h.rsA.CHANNEL_OVERWRITE_CREATE || t.action === h.rsA.CHANNEL_OVERWRITE_UPDATE) return function(e, t) {
            let {
              newValue: n
            } = e;
          ...
          if ((t.action === h.rsA.CHANNEL_UPDATE || t.action === h.rsA.THREAD_UPDATE) && s.key === h.zUn.FLAGS) return function(e) {
            let {
              newValue: t,
              oldValue: n
            } = e, l = [];
          ...
          if ((t.action === h.rsA.ONBOARDING_PROMPT_UPDATE || t.action === h.rsA.ONBOARDING_PROMPT_CREATE) && s.key === h.zUn.OPTIONS) return function(e, t, n) {
            let {
              newValue: l,
              oldValue: s
            } = e, i = e => {
              ...
              let {
                title: l,
                id: s
              } = n, E = e.role_ids.map(i).filter(R.lm), u = e.channel_ids.map(a).filter(R.lm), _ = n.role_ids.map(i).filter(R.lm), d = n.channel_ids.map(a).filter(R.lm), A = o().difference(_, E), T = o().difference(E, _), I = o().difference(d, u), O = o().difference(u, d), N = [];
              return (o().isEqual(e.title, n.title) || N.push("title"), o().isEqual(e.description, n.description) || N.push("description"), 0 === A.length && 0 === T.length && 0 === I.length && 0 === O.length && 0 === N.length) ? null : (0, r.jsxs)("li", {
                children: [(0, r.jsxs)("div", {
                  ...
                  children: [(0, r.jsx)(M, {
                    ...
                    variant: "text-md/normal",
                    children: U.intl.format(U.t["WZO+iY"], {
                      title: l
                    })
                  })]
                }), (0, r.jsxs)("div", {
                  className: p.onboardingChangeLogItemChanges,
                  children: [A.length > 0 && (0, r.jsx)(c.Text, {
                    variant: "text-md/normal",
                    children: U.intl.format(U.t["R+km+f"], {
                      roles: A.join(", ")
                    })
                  }), T.length > 0 && (0, r.jsx)(c.Text, {
                    variant: "text-md/normal",
                    children: U.intl.format(U.t.xIVRoa, {
                      roles: T.join(", ")
                    })
                  }), I.length > 0 && (0, r.jsx)(c.Text, {
                    variant: "text-md/normal",
                    children: U.intl.format(U.t.iYowX1, {
                      channels: I.join(", ")
                    })
                  }), O.length > 0 && (0, r.jsx)(c.Text, {
                    variant: "text-md/normal",
                    children: U.intl.format(U.t.JLdJpK, {
                      channels: O.join(", ")
                    })
                  }), N.map((t, l) => (0, r.jsx)(c.Text, {
                    variant: "text-md/normal",
            ...
            }, u = o().keyBy(null != s ? s : [], "id"), _ = o().keyBy(null != l ? l : [], "id"), d = o().difference(Object.keys(_), Object.keys(u)).map(e => _[e]), A = o().difference(Object.keys(u), Object.keys(_)).map(e => u[e]), O = o().intersection(Object.keys(_), Object.keys(u));
            return (0, r.jsxs)("ul", {
              ...
              children: [d.map(e => {
                let {
                  ...
                  title: s,
                  id: o
                } = e, E = (null != n ? n : []).map(i).filter(R.lm), u = (null != l ? l : []).map(a).filter(R.lm);
                return (0, r.jsxs)("li", {
                  children: [(0, r.jsxs)("div", {
                    className: p.onboardingChangeLogItemTitle,
                    children: [(0, r.jsx)(M, {
                      ...
                      variant: "text-md/normal",
                      children: U.intl.format(U.t.CZ1tys, {
                        title: s
                      })
                    })]
                  }), (0, r.jsxs)("div", {
                    className: p.onboardingChangeLogItemChanges,
                    children: [E.length > 0 && (0, r.jsx)(c.Text, {
                      variant: "text-md/normal",
                      children: U.intl.format(U.t["gt/5z8"], {
                        roles: E.join(", ")
                      })
                    }), u.length > 0 && (0, r.jsx)(c.Text, {
                      variant: "text-md/normal",
                      children: U.intl.format(U.t["4q006e"], {
                        channels: u.join(", ")
                      })
                    })]
                  })]
                ...
                children: (0, r.jsxs)("div", {
                  ...
                  children: [(0, r.jsx)(M, {
                    ...
                    variant: "text-md/normal",
                    children: U.intl.format(U.t["m3dt+P"], {
                      title: e.title
                    })
                  })]
                })
              }, e.id)), O.map(e => E(u[e], _[e]))]
            }, "options")
          }(s, t, n);
          if (t.action === h.rsA.HOME_SETTINGS_CREATE || t.action === h.rsA.HOME_SETTINGS_UPDATE) return function(e, t) {
            let {
              oldValue: n,
              newValue: l,
              key: s
              ...
              case h.zUn.WELCOME_MESSAGE:
                return ((e, t) => {
                  ...
                  let o = O.default.getUser(null == t || null == (n = t.author_ids) ? void 0 : n[0]),
                    ...
                    u = (null == o ? void 0 : o.id) !== (null == E ? void 0 : E.id) ? (0, r.jsx)("li", {
                    ...
                    children: [u.map(e => (0, r.jsx)("li", {
                      children: (0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)(M, {
                          ...
                          variant: "text-md/normal",
                          children: U.intl.format(U.t["oFSu6+"], {
                            name: e.title
                          })
                        })]
                      })
                      ...
                      children: (0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)(M, {
                          ...
                          variant: "text-md/normal",
                          children: U.intl.format(U.t.GssWam, {
                            name: e.title
                          })
                        })]
                      })
                    ...
                    children: [u.map(e => (0, r.jsx)("li", {
                      children: (0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)(M, {
                          ...
                          variant: "text-md/normal",
                          children: U.intl.format(U.t.HlGndH, {
                            name: e.title
                          })
                        })]
                      })
                      ...
                      children: (0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)(M, {
                          ...
                          variant: "text-md/normal",
                          children: U.intl.format(U.t["7pysg4"], {
                            name: e.title
                          })
                        })]
                      })
