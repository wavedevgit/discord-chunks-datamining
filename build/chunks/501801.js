...
function P(A) {
  ...
  return null == t ? null : (0, n.jsx)(v.Text, {
...
class j extends r.PureComponent {
  render() {
    let {
      ...
      action: t,
      themeOverride: r
    } = this.props, l = null != r ? b["themeOverride".concat((0, D.De)(r))] : null, s = i()(b.icon, O[A], t === p.rsA.MESSAGE_DELETE ? b.targetMessage : t === p.rsA.AUTO_MODERATION_BLOCK_MESSAGE || t === p.rsA.AUTO_MODERATION_FLAG_TO_CHANNEL || t === p.rsA.AUTO_MODERATION_USER_COMMUNICATION_DISABLED || t === p.rsA.AUTO_MODERATION_QUARANTINE_USER ? b.autoModerationBlockMessage : ({
    ...
    let o = 0,
      h = a().flatten(e.changes.map(l => {
        ...
        let {
          ...
          if (e.action === p.rsA.MEMBER_ROLE_UPDATE) return function(A) {
            let {
              newValue: e
            } = A;
          ...
          if (e.targetType === p.KFR.ROLE || e.action === p.rsA.CHANNEL_OVERWRITE_CREATE || e.action === p.rsA.CHANNEL_OVERWRITE_UPDATE) return function(A, e) {
            let {
              newValue: t
            } = A;
          ...
          if ((e.action === p.rsA.CHANNEL_UPDATE || e.action === p.rsA.THREAD_UPDATE) && l.key === p.zUn.FLAGS) return function(A) {
            let {
              newValue: e,
              oldValue: t
            } = A, r = [];
          ...
          if ((e.action === p.rsA.ONBOARDING_PROMPT_UPDATE || e.action === p.rsA.ONBOARDING_PROMPT_CREATE) && l.key === p.zUn.OPTIONS) return function(A, e, t) {
            let {
              newValue: r,
              oldValue: l
            } = A, i = A => {
              ...
              let {
                title: r,
                id: l
              } = t, o = A.role_ids.map(i).filter(w.lm), g = A.channel_ids.map(s).filter(w.lm), f = t.role_ids.map(i).filter(w.lm), c = t.channel_ids.map(s).filter(w.lm), h = a().difference(f, o), E = a().difference(o, f), u = a().difference(c, g), d = a().difference(g, c), C = [];
              return (a().isEqual(A.title, t.title) || C.push("title"), a().isEqual(A.description, t.description) || C.push("description"), 0 === h.length && 0 === E.length && 0 === u.length && 0 === d.length && 0 === C.length) ? null : (0, n.jsxs)("li", {
                children: [(0, n.jsxs)("div", {
                  ...
                  }), E.length > 0 && (0, n.jsx)(v.Text, {
                    variant: "text-md/normal",
                    children: H.intl.format(H.t.xIVRoa, {
                      roles: E.join(", ")
                    })
                  }), u.length > 0 && (0, n.jsx)(v.Text, {
                    variant: "text-md/normal",
                    children: H.intl.format(H.t.iYowX1, {
                      channels: u.join(", ")
                    })
                  }), d.length > 0 && (0, n.jsx)(v.Text, {
                    variant: "text-md/normal",
                    children: H.intl.format(H.t.JLdJpK, {
                      channels: d.join(", ")
                    })
                  }), C.map((e, r) => (0, n.jsx)(v.Text, {
                    variant: "text-md/normal",
            ...
            }, g = a().keyBy(null != l ? l : [], "id"), f = a().keyBy(null != r ? r : [], "id"), c = a().difference(Object.keys(f), Object.keys(g)).map(A => f[A]), h = a().difference(Object.keys(g), Object.keys(f)).map(A => g[A]), E = a().intersection(Object.keys(f), Object.keys(g));
            return (0, n.jsxs)("ul", {
              ...
              children: [c.map(A => {
                let {
                  ...
                  title: l,
                  id: a
                } = A, o = (null != t ? t : []).map(i).filter(w.lm), g = (null != r ? r : []).map(s).filter(w.lm);
                return (0, n.jsxs)("li", {
                  children: [(0, n.jsxs)("div", {
                    className: b.onboardingChangeLogItemTitle,
                    children: [(0, n.jsx)(j, {
                    ...
                    className: b.onboardingChangeLogItemChanges,
                    children: [o.length > 0 && (0, n.jsx)(v.Text, {
                      variant: "text-md/normal",
                      children: H.intl.format(H.t["gt/5z8"], {
                        roles: o.join(", ")
                      })
                    }), g.length > 0 && (0, n.jsx)(v.Text, {
                      variant: "text-md/normal",
              ...
              }, A.id)), E.map(A => o(g[A], f[A]))]
            }, "options")
          }(l, e, t);
          if (e.action === p.rsA.HOME_SETTINGS_CREATE || e.action === p.rsA.HOME_SETTINGS_UPDATE) return function(A, e) {
            let {
              oldValue: t,
              newValue: r,
              key: l
              ...
              case p.zUn.WELCOME_MESSAGE:
                return ((A, e) => {
                  ...
                  let a = C.default.getUser(null == e || null == (t = e.author_ids) ? void 0 : t[0]),
                    ...
                    g = (null == a ? void 0 : a.id) !== (null == o ? void 0 : o.id) ? (0, n.jsx)("li", {
                    ...
                    f = (null == e ? void 0 : e.message) !== A.message ? (0, n.jsx)("li", {
                      children: (0, n.jsx)("div", {
                        className: b.onboardingChangeLogItemTitle,
                        children: (0, n.jsx)(v.Text, {
                          variant: "text-md/normal",
              ...
              case p.zUn.NEW_MEMBER_ACTIONS:
                return ((A, e) => {
                  ...
                  return (0, n.jsxs)("ul", {
                    ...
                    }, A.channel_id)), f.map(A => (0, n.jsx)("li", {
                      children: (0, n.jsxs)("div", {
                        className: b.onboardingChangeLogItemTitle,
                        children: [(0, n.jsx)(j, {
                          actionType: p.vB8.DELETE,
        ...
        return function(A) {
          ...
          let u = H.intl.format(l, {
            ...
            oldTagHook: (A, e) => (0, n.jsx)(E.Z, {
              tag: o,
              size: E.Z.Sizes.SMALL
            }, e),
            newTagHook: (A, e) => (0, n.jsx)(E.Z, {
              tag: g,
              size: E.Z.Sizes.SMALL
            }, e),
            oldEmojiHook: (A, e) => (0, n.jsx)(c.Z, {
              emojiId: o
            }, e),
            newEmojiHook: (A, e) => (0, n.jsx)(c.Z, {
              emojiId: g
            }, e),
            applicationHook: (A, e) => {
              var t;
              return (0, n.jsx)(P, {
                applicationId: null != (t = null == o ? void 0 : o.application_id) ? t : null == g ? void 0 : g.application_id
              }, e)
            }
          });
          return null == u ? null : (0, n.jsxs)("div", {
            className: b.detail,
            style: {
              position: "relative",
              top: 1
            ...
            children: [(0, n.jsxs)(v.Text, {
              ...
              children: [s < 10 ? "0".concat(s) : s, (0, n.jsx)("span", {
                className: b.dash,
                children: "—"
              })]
            }), (0, n.jsxs)("div", {
