...
function P(A) {
  ...
  return null == t ? null : (0, n.jsx)(c.Text, {
      ...
      h = a().flatten(e.changes.map(l => {
          ...
          if ((e.action === p.rsA.ONBOARDING_PROMPT_UPDATE || e.action === p.rsA.ONBOARDING_PROMPT_CREATE) && l.key === p.zUn.OPTIONS) return function(A, e, t) {
            let {
              ...
              let {
                title: r,
                id: l
              } = t, o = A.role_ids.map(i).filter(w.lm), g = A.channel_ids.map(s).filter(w.lm), f = t.role_ids.map(i).filter(w.lm), v = t.channel_ids.map(s).filter(w.lm), h = a().difference(f, o), u = a().difference(o, f), E = a().difference(v, g), d = a().difference(g, v), C = [];
              return (a().isEqual(A.title, t.title) || C.push("title"), a().isEqual(A.description, t.description) || C.push("description"), 0 === h.length && 0 === u.length && 0 === E.length && 0 === d.length && 0 === C.length) ? null : (0, n.jsxs)("li", {
                children: [(0, n.jsxs)("div", {
                  ...
                  children: [h.length > 0 && (0, n.jsx)(c.Text, {
                    variant: "text-md/normal",
                    children: H.intl.format(H.t["R+km+f"], {
                      roles: h.join(", ")
                    })
                  }), u.length > 0 && (0, n.jsx)(c.Text, {
                    variant: "text-md/normal",
                    children: H.intl.format(H.t.xIVRoa, {
                      roles: u.join(", ")
                    })
                  }), E.length > 0 && (0, n.jsx)(c.Text, {
                    variant: "text-md/normal",
                    children: H.intl.format(H.t.iYowX1, {
                      channels: E.join(", ")
                    })
                  }), d.length > 0 && (0, n.jsx)(c.Text, {
                    variant: "text-md/normal",
                    children: H.intl.format(H.t.JLdJpK, {
                      channels: d.join(", ")
                    })
                  }), C.map((e, r) => (0, n.jsx)(c.Text, {
                    variant: "text-md/normal",
            ...
            }, g = a().keyBy(null != l ? l : [], "id"), f = a().keyBy(null != r ? r : [], "id"), v = a().difference(Object.keys(f), Object.keys(g)).map(A => f[A]), h = a().difference(Object.keys(g), Object.keys(f)).map(A => g[A]), u = a().intersection(Object.keys(f), Object.keys(g));
            return (0, n.jsxs)("ul", {
              ...
              children: [v.map(A => {
                ...
                return (0, n.jsxs)("li", {
                  children: [(0, n.jsxs)("div", {
                    ...
                    className: b.onboardingChangeLogItemChanges,
                    children: [o.length > 0 && (0, n.jsx)(c.Text, {
                      variant: "text-md/normal",
                      children: H.intl.format(H.t["gt/5z8"], {
                        roles: o.join(", ")
                      })
                    }), g.length > 0 && (0, n.jsx)(c.Text, {
                      variant: "text-md/normal",
        ...
        return function(A) {
          ...
          let E = H.intl.format(l, {
            ...
            oldTagHook: (A, e) => (0, n.jsx)(u.Z, {
              tag: o,
              size: u.Z.Sizes.SMALL
            }, e),
            newTagHook: (A, e) => (0, n.jsx)(u.Z, {
              tag: g,
              size: u.Z.Sizes.SMALL
            }, e),
