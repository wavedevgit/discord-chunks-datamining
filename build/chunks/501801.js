      ...
      A = o().flatten(t.changes.map(i => {
        ...
        let {
          ...
          return t.action === R.rsA.GUILD_UPDATE && i.key === R.zUn.OWNER_ID ? {
            oldValue: N.ZP.getUserTag(i.oldValue, {
              mode: "username"
            }),
            newValue: N.ZP.getUserTag(i.newValue, {
              mode: "username"
            })
          } : i
        })(), A = (() => {
          ...
          if ((t.action === R.rsA.ONBOARDING_PROMPT_UPDATE || t.action === R.rsA.ONBOARDING_PROMPT_CREATE) && i.key === R.zUn.OPTIONS) return function(e, t, n) {
            ...
            }, c = o().keyBy(null != i ? i : [], "id"), d = o().keyBy(null != l ? l : [], "id"), _ = o().difference(Object.keys(d), Object.keys(c)).map(e => d[e]), A = o().difference(Object.keys(c), Object.keys(d)).map(e => c[e]), m = o().intersection(Object.keys(d), Object.keys(c));
            return (0, r.jsxs)("ul", {
