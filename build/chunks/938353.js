...
class e1 extends(r = a.Component) {
  ...
  renderCodedLinks(e) {
    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
      ...
      if (n === N.g.EVENT) return (0, i.jsx)(k.Z, {
        code: r
      }, r);
      ...
      } else if (n === N.g.GUILD_PRODUCT) return (0, i.jsx)(R.Z, {
        code: r
      }, r);
  ...
  renderPublishBump(e) {
    return this.props.channel.type !== eB.d4z.GUILD_ANNOUNCEMENT || this.props.isMessageSnapshot ? null : (0, i.jsx)(E.Z, {
      channelId: e.channel_id,
      messageId: e.id
    })
  }
  renderEphemeralAccessories(e) {
    return (0, eE.Pv)(e) ? (0, i.jsx)(eT.Z, {
      message: e,
      onDeleteMessage: () => {
...
function e3(e) {
  ...
  }), [f, n]), y = (0, w.ux)(n.guild_id), [, E] = (0, Z.AB)(n.guild_id), v = (0, ei.$R)(n), N = (o === r.author.id || x) && r.author.id !== eB.LAt && !1 !== a && !(0, eg.yE)(r.flags, eB.iLy.EPHEMERAL) && v && 1 === (0, eO.Z)(r), O = o === r.author.id && v && !l, j = r.author.id === o, S = r.isFirstMessageInForumPost(n), I = (0, eC.Z)({
    channel: n,
    canChat: f,
    renderReactions: p,
    canAddNewReactions: b,
  ...
  }), T = (0, B.A)((null != (t = r.editedTimestamp) ? t : r.timestamp).valueOf()), P = (0, z.Z)(null == n ? void 0 : n.id), A = (0, X.Z)(r), R = (0, C.V)(n.id, r.author.id), k = (0, eN._)(n), D = (0, ex.ro)(r.id, r.channel_id);
