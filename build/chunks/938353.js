...
function eq() {
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("img", {
      ...
      color: "text-muted",
      children: eH.NW.format(eH.t["G/H+s7"], {
        onClick: () => (0, Q.z)()
      })
    })]
  })
...
let eQ = 15 * ef.Z.Millis.MINUTE,
  ...
  e0 = e => () => {
    ...
    return null != r && null != a && (V.uo.test(n) || l && (V.YG.test(n) || V.FH.test(n))) ? (0, i.jsx)(eP.Z, {
      width: r,
      height: a,
      src: n,
      url: t,
...
class e1 extends(r = a.Component) {
  ...
  shouldComponentUpdate(e, t) {
    ...
    return !(0, d.Z)(this.state, t) || !(0, d.Z)(this.props, e, ["message", "channel"]) || i.type !== o.type || c !== l || s.codedLinks !== a.codedLinks || s.flags !== a.flags || s.giftCodes !== a.giftCodes || s.attachments !== a.attachments || s.embeds !== a.embeds || s.components !== a.components || s.activity !== a.activity || (n = s.reactions) !== (r = a.reactions) && (n.length !== r.length || !!n.some((e, t) => {
      let {
        emoji: n,
        count: i,
        burst_count: a
  ...
  renderCodedLinks(e) {
    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
      ...
      if (n === N.g.INVITE) return this.shouldRenderInvite(r) ? (0, i.jsx)(eA.Z, {
        code: r,
        author: e.author,
        getAcceptInviteContext: this.getAcceptInviteContext
      }, r) : null;
      if (n === N.g.TEMPLATE) return (0, i.jsx)(D.Z, {
        code: r
      }, r);
      if (n === N.g.EVENT) return (0, i.jsx)(R.Z, {
        code: r
      }, r);
      if (n === N.g.CHANNEL_LINK) return (0, i.jsx)(eS.Z, {
        code: r,
        messageData: e
      }, r);
      if (n === N.g.APP_DIRECTORY_PROFILE) return (0, i.jsx)(A.Z, {
        code: r,
        message: e,
        embedUrl: a
      }, r);
      ...
      } else if (n === N.g.GUILD_PRODUCT) return (0, i.jsx)(k.Z, {
        code: r
      }, r);
      else if (n === N.g.SERVER_SHOP) return (0, i.jsx)(O.Z, {
        guildId: r
      }, r);
      else if (n === N.g.QUESTS_EMBED) return (0, i.jsx)($.Z, {
        questId: r
      }, r);
      else if (n === N.g.APP_DIRECTORY_STOREFRONT) return (0, i.jsx)(x.P, {
        appId: r,
        message: e
      }, r);
      else if (n === N.g.APP_DIRECTORY_STOREFRONT_SKU) {
        let t = (0, b.Q)(r);
        return null == t ? null : (0, i.jsx)(x.F, {
          appId: t.applicationId,
          skuId: t.skuId,
          message: e
        }, r)
      } else if (n === N.g.APP_OAUTH2_LINK) return (0, i.jsx)(y.Z, {
        applicationId: r,
        embedUrl: a
      }, r);
  ...
  renderPublishBump(e) {
    return this.props.channel.type !== eB.d4z.GUILD_ANNOUNCEMENT || this.props.isMessageSnapshot ? null : (0, i.jsx)(v.Z, {
      channelId: e.channel_id,
      messageId: e.id
    })
  }
  renderEphemeralAccessories(e) {
    return (0, ev.Pv)(e) ? (0, i.jsx)(eT.Z, {
      message: e,
      onDeleteMessage: () => {
  ...
  renderStickersAccessories(e) {
    ...
    return 0 === t.length ? null : t.map(e => (0, i.jsx)(er.Z, {
      channel: n,
      isInteracting: r,
      renderableSticker: e
    }, e.id))
  ...
  renderThreadAccessories(e) {
    if (e.hasFlag(eB.iLy.HAS_THREAD) && !1 !== this.props.renderThreadAccessory) return (0, i.jsx)(ea.Z, {
      message: e,
      compact: this.props.compact
    })
  }
  renderThreadRoleMentionWarning(e) {
    if (e.hasFlag(eB.iLy.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) && this.props.isCurrentUser && !(Date.now() - e_.default.extractTimestamp(e.id) >= eQ)) return (0, i.jsx)("div", {
  ...
  renderInteractionPremiumUpsell(e) {
    ...
    return e.type !== s.u.INTERACTION_PREMIUM_UPSELL || null == t ? null : (0, i.jsx)(eL.Z, {
      applicationId: t,
  ...
  renderEmbeddedApplicationInstanceEmbed(e) {
    ...
    return null == t || null == n ? null : (0, i.jsx)(eI.Z, {
      application: t,
  ...
  renderMediaPostEmbeds(e) {
    return e.embeds.flatMap(t => t.type !== eB.hBH.POST_PREVIEW || null == t.url ? [] : (0, i.jsx)(K.Z, {
      embedUrl: t.url,
      message: e,
  ...
  renderSafetyPolicyNotice(e) {
    return 1 === e.embeds.length && e.embeds[0].type === eB.hBH.SAFETY_POLICY_NOTICE ? (0, i.jsx)(ee.i, {
      message: e
    }) : null
  }
  renderSafetySystemNotification(e) {
    return 1 === e.embeds.length && e.embeds[0].type === eB.hBH.SAFETY_SYSTEM_NOTIFICATION ? (0, i.jsx)(et.g, {
      embed: e.embeds[0]
    }) : null
  }
  renderVoiceChannelInvite(e, t) {
    if (1 === e.embeds.length && e.embeds[0].type === eB.hBH.VOICE_CHANNEL) return (0, i.jsx)(L.H, {
      message: e,
      channel: t
    })
  }
  ...
  renderForwardedMessage(e) {
    return 0 === e.messageSnapshots.length ? null : (0, i.jsx)(T.Z, {
      message: e
    })
  }
  render() {
    ...
    } = this.state, s = this.renderCodedLinks(t), c = this.renderGiftCodes(t), u = this.renderReferralTrial(t), d = this.renderAttachments(t), p = this.renderCtaButton(), m = this.renderSocialProofingFileSizeNitroUpsell(t), f = this.renderEmbeds(t), h = this.renderActivityInvite(t), g = this.renderReactions(t), _ = this.renderPublishBump(t), b = this.renderEphemeralAccessories(t), x = this.renderStickersAccessories(t), y = this.renderThreadAccessories(t), v = this.renderComponentAccessories(t), E = this.renderThreadRoleMentionWarning(t), N = this.renderEmbeddedApplicationInstanceEmbed(t), O = this.renderInteractionPremiumUpsell(t), j = this.renderMediaPostEmbeds(t), C = this.renderSafetyPolicyNotice(t), S = this.renderSafetySystemNotification(t), I = this.renderVoiceChannelInvite(t, n), T = this.renderMediaObscureNotice(t), P = this.renderPoll(t, r), A = this.renderForwardedMessage(t);
    return null == s && null == d && null == f && null == h && null == g && null == c && null == u && null == _ && null == b && null == x && null == y && null == v && null == N && null == E && null == j && null == C && null != O && null == P && null == I && null == A ? null : (0, i.jsxs)("div", {
      id: (0, eZ.bX)(t),
  ...
  constructor(...e) {
    super(...e), eK(this, "state", {
      ...
      let {
        ...
        isSearchResult: u
      } = this.props, d = r.channel_id, p = r.id, m = (0, ey.BP)(e, d, p, s, c);
      return e.type === eB.hBH.GIFT ? null : (0, i.jsx)(P.h.Provider, {
        value: e$(e.url, e.image, e.video),
        children: (0, i.jsx)(E.ZP, eY({
          className: eV.embedWrapper,
          embed: e,
    ...
    }), eK(this, "renderEmbedTitle", (e, t) => e.type === eB.hBH.RICH ? G.Z.parseEmbedTitle(t, !0, {
      channelId: this.props.channel.id
    }) : t), eK(this, "renderEmbedDescription", (e, t, n) => e.type === eB.hBH.RICH ? G.Z.parse(t, !0, {
      channelId: this.props.channel.id,
      allowLinks: !0,
      allowEmojiLinks: !0,
...
function e3(e) {
  ...
  let {
    ...
    isMessageSnapshot: l
  } = e, o = (0, c.e7)([eo.default], () => eo.default.getId()), s = el.x4.useSetting(), u = el.RS.useSetting(), d = el.NA.useSetting() && !(0, ej.Z)(e.message), p = el.nc.useSetting() && !1 !== e.renderReactions, m = el.QK.useSetting(), f = (0, c.e7)([ec.Z], () => null == n.guild_id || ec.Z.canChatInGuild(n.guild_id), [n]), h = (0, c.e7)([F.Z], () => null != n.guild_id && F.Z.isLurking(n.guild_id), [n]), g = (0, c.e7)([es.ZP], () => es.ZP.isCurrentUserGuest(n.guild_id), [n]), _ = (0, c.e7)([es.ZP, ed.default], () => {
    var e, t;
  ...
  }), [f, n]), y = (0, w.ux)(n.guild_id), [, v] = (0, Z.AB)(n.guild_id), E = (0, ei.$R)(n), N = (o === r.author.id || x) && r.author.id !== eB.LAt && !1 !== a && !(0, eg.yE)(r.flags, eB.iLy.EPHEMERAL) && E && 1 === (0, eO.Z)(r), O = o === r.author.id && E && !l, j = r.author.id === o, S = r.isFirstMessageInForumPost(n), I = (0, eC.Z)({
    channel: n,
    canChat: f,
    renderReactions: p,
    canAddNewReactions: b,
  ...
  }), T = (0, B.A)((null != (t = r.editedTimestamp) ? t : r.timestamp).valueOf()), P = (0, z.Z)(null == n ? void 0 : n.id), A = (0, X.Z)(r), k = (0, C.V)(n.id, r.author.id), R = (0, eN._)(n), D = (0, ex.ro)(r.id, r.channel_id);
