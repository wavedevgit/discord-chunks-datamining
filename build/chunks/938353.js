...
class e1 extends(r = l.Component) {
  ...
  renderPublishBump(e) {
    return this.props.channel.type !== eG.d4z.GUILD_ANNOUNCEMENT || this.props.isMessageSnapshot ? null : (0, i.jsx)(v.Z, {
...
function e3(e) {
  ...
  }), [f, n]), y = (0, w.ux)(n.guild_id), [, v] = (0, Z.AB)(n.guild_id), E = (0, ei.$R)(n), O = (o === r.author.id || x) && r.author.id !== eG.LAt && !1 !== l && !(0, eg.yE)(r.flags, eG.iLy.EPHEMERAL) && E && 1 === (0, ej.Z)(r), j = o === r.author.id && E && !a, C = r.author.id === o, I = r.isFirstMessageInForumPost(n), N = (0, eS.Z)({
    channel: n,
    canChat: f,
    renderReactions: p,
    canAddNewReactions: b,
  ...
  }), T = (0, G.A)((null != (t = r.editedTimestamp) ? t : r.timestamp).valueOf()), P = (0, W.Z)(null == n ? void 0 : n.id), A = (0, X.Z)(r), R = (0, S.V)(n.id, r.author.id), k = (0, eO._)(n), D = (0, ex.ro)(r.id, r.channel_id);
