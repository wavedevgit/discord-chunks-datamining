...
class e6 extends(r = l.Component) {
  ...
  renderCodedLinks(e) {
    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
      ...
      if (n === y.g.INVITE) return this.shouldRenderInvite(r) ? (0, i.jsx)(eD.Z, {
        code: r,
        message: e,
        getAcceptInviteContext: this.getAcceptInviteContext
      }, r) : null;
      if (n === y.g.TEMPLATE) return (0, i.jsx)(k.Z, {
        code: r
      }, r);
      if (n === y.g.EVENT) return (0, i.jsx)(M.Z, {
        code: r
      }, r);
      ...
      } else if (n === y.g.GUILD_PRODUCT) return (0, i.jsx)(L.Z, {
        code: r
      }, r);
      else if (n === y.g.SERVER_SHOP) return (0, i.jsx)(I.Z, {
        guildId: r
      }, r);
      ...
      } else if (n === y.g.APP_OAUTH2_LINK) return (0, i.jsx)(v.Z, {
        applicationId: r
      }, r);
  ...
  renderPublishBump(e) {
    return this.props.channel.type !== eY.d4z.GUILD_ANNOUNCEMENT || this.props.isMessageSnapshot ? null : (0, i.jsx)(O.Z, {
      channelId: e.channel_id,
      messageId: e.id
    })
  }
  renderEphemeralAccessories(e) {
    return (0, eI.Pv)(e) ? (0, i.jsx)(eZ.Z, {
      message: e,
      onDeleteMessage: () => {
  ...
  renderThreadRoleMentionWarning(e) {
    if (e.hasFlag(eY.iLy.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) && this.props.isCurrentUser && !(Date.now() - ev.default.extractTimestamp(e.id) >= e5)) return (0, i.jsx)("div", {
  ...
  constructor(...e) {
    super(...e), e$(this, "state", {
      ...
      let {
        ...
        isSearchResult: m,
        shouldAgeVerify: f
      } = this.props, g = r.channel_id, _ = r.id, h = (0, ey.BP)(e, g, _, d, p);
    ...
    }), e$(this, "renderEmbedTitle", (e, t) => e.type === eY.hBH.RICH ? H.Z.parseEmbedTitle(t, !0, {
      channelId: this.props.channel.id
    }) : t), e$(this, "renderEmbedDescription", (e, t, n) => e.type === eY.hBH.RICH ? H.Z.parse(t, !0, {
      channelId: this.props.channel.id,
      allowLinks: !0,
      allowEmojiLinks: !0,
...
function e4(e) {
  ...
  }), [f, n]), C = (0, R.ux)(n.guild_id), [, v] = (0, D.AB)(n.guild_id), O = (0, eo.$R)(n), x = (o === r.author.id || E) && r.author.id !== eY.LAt && !1 !== l && !(0, eC.yE)(r.flags, eY.iLy.EPHEMERAL) && O && 1 === (0, eT.Z)(r), y = o === r.author.id && O && !a, I = r.author.id === o, S = r.isFirstMessageInForumPost(n), N = (0, eP.Z)({
    channel: n,
    canChat: f,
    renderReactions: p,
    canAddNewReactions: b,
  ...
  }), P = (0, V.A)((null != (t = r.editedTimestamp) ? t : r.timestamp).valueOf()), A = (0, K.Z)(null == n ? void 0 : n.id), w = (0, q.Z)(r), Z = (0, T.v)(r), L = (0, eS._)(n), M = (0, ex.ro)(r.id, r.channel_id), k = (0, j.m8)();
