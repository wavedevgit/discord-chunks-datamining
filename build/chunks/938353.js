...
function e8(e) {
  ...
  }), [f, n]), y = (0, k.ux)(n.guild_id), [, v] = (0, D.AB)(n.guild_id), E = (0, eo.$R)(n), O = (o === r.author.id || x) && r.author.id !== eV.LAt && !1 !== a && !(0, ex.yE)(r.flags, eV.iLy.EPHEMERAL) && E && 1 === (0, eS.Z)(r), N = o === r.author.id && E && !l, j = r.author.id === o, S = r.isFirstMessageInForumPost(n), I = (0, eT.Z)({
    channel: n,
    canChat: f,
    renderReactions: p,
    canAddNewReactions: b,
