...
function e3() {
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("img", {
      ...
      color: "text-muted",
      children: eq.intl.format(eq.t["G/H+s7"], {
        onClick: () => (0, J.z)()
      })
    })]
  })
...
let e2 = 15 * eb.Z.Millis.MINUTE,
  ...
  e8 = e => () => {
    let {
      ...
      height: l,
      flags: a
    } = e, o = (0, eC.yE)(a, z.hR.IS_ANIMATED);
    return null != r && null != l && (W.uo.test(n) || o && (W.YG.test(n) || W.FH.test(n))) ? (0, i.jsx)(eR.Z, {
      width: r,
      height: l,
      src: n,
      url: t,
...
class e6 extends(r = l.Component) {
  ...
  renderCodedLinks(e) {
    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
      ...
      if (n === y.g.INVITE) return this.shouldRenderInvite(r) ? (0, i.jsx)(eL.Z, {
        code: r,
        message: e,
        getAcceptInviteContext: this.getAcceptInviteContext
      }, r) : null;
      if (n === y.g.TEMPLATE) return (0, i.jsx)(M.Z, {
        code: r
      }, r);
      if (n === y.g.EVENT) return (0, i.jsx)(k.Z, {
        code: r
      }, r);
      if (n === y.g.CHANNEL_LINK) return (0, i.jsx)(eA.Z, {
        code: r,
        message: e
      }, r);
      if (n === y.g.APP_DIRECTORY_PROFILE) return (0, i.jsx)(Z.Z, {
        code: r,
        message: e
      }, r);
      ...
      } else if (n === y.g.GUILD_PRODUCT) return (0, i.jsx)(D.Z, {
        code: r
      }, r);
      else if (n === y.g.SERVER_SHOP) return (0, i.jsx)(j.Z, {
        guildId: r
      }, r);
      else if (n === y.g.QUESTS_EMBED) return (0, i.jsx)(ee.Z, {
        questId: r
      }, r);
      else if (n === y.g.APP_DIRECTORY_STOREFRONT) return (0, i.jsx)(E.P, {
        appId: r,
        message: e
      }, r);
      ...
      } else if (n === y.g.APP_OAUTH2_LINK) return (0, i.jsx)(x.Z, {
        applicationId: r
      }, r);
  ...
  renderPublishBump(e) {
    return this.props.channel.type !== eY.d4z.GUILD_ANNOUNCEMENT || this.props.isMessageSnapshot ? null : (0, i.jsx)(v.Z, {
      channelId: e.channel_id,
      messageId: e.id
    })
  }
  renderEphemeralAccessories(e) {
    return (0, ej.Pv)(e) ? (0, i.jsx)(eZ.Z, {
      message: e,
      onDeleteMessage: () => {
  ...
  renderThreadAccessories(e) {
    if (e.hasFlag(eY.iLy.HAS_THREAD) && !1 !== this.props.renderThreadAccessory) return (0, i.jsx)(es.Z, {
      message: e,
      compact: this.props.compact
    })
  }
  renderThreadRoleMentionWarning(e) {
    if (e.hasFlag(eY.iLy.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) && this.props.isCurrentUser && !(Date.now() - ex.default.extractTimestamp(e.id) >= e2)) return (0, i.jsx)("div", {
  ...
  renderMediaPostEmbeds(e) {
    return e.embeds.flatMap(t => t.type !== eY.hBH.POST_PREVIEW || null == t.url ? [] : (0, i.jsx)(Y.Z, {
      embedUrl: t.url,
      message: e,
  ...
  renderSafetyPolicyNotice(e) {
    return 1 === e.embeds.length && e.embeds[0].type === eY.hBH.SAFETY_POLICY_NOTICE ? (0, i.jsx)(er.i, {
      message: e
    }) : null
  }
  renderSafetySystemNotification(e) {
    return 1 === e.embeds.length && e.embeds[0].type === eY.hBH.SAFETY_SYSTEM_NOTIFICATION ? (0, i.jsx)(ei.g, {
      embed: e.embeds[0]
    }) : null
  }
  ...
  renderForwardedMessage(e) {
    if (e.messageSnapshots.length > 0 && !(0, et.Gi)(e, this.props.channel)) return (0, i.jsx)(A.Z, {
      message: e
    })
  }
  renderEditedTag(e, t) {
  ...
  render() {
    ...
    } = this.state, s = this.renderEditedTag(t, r), c = this.renderCodedLinks(t), u = this.renderGiftCodes(t), d = this.renderReferralTrial(t), p = this.renderAttachments(t), m = this.renderCtaButton(), f = this.renderSocialProofingFileSizeNitroUpsell(t), g = this.renderEmbeds(t), _ = this.renderActivityInvite(t), h = this.renderReactions(t), b = this.renderPublishBump(t), E = this.renderEphemeralAccessories(t), C = this.renderStickersAccessories(t), x = this.renderThreadAccessories(t), v = this.renderComponentAccessories(t), O = this.renderThreadRoleMentionWarning(t), y = this.renderEmbeddedApplicationInstanceEmbed(t), j = this.renderInteractionPremiumUpsell(t), I = this.renderMediaPostEmbeds(t), S = this.renderSafetyPolicyNotice(t), T = this.renderSafetySystemNotification(t), N = this.renderMediaObscureNotice(t), P = this.renderPoll(t, n), A = this.renderForwardedMessage(t), w = this.renderReportedMessage(t);
    return null == c && null == p && null == g && null == _ && null == h && null == u && null == d && null == b && null == E && null == C && null == x && null == v && null == y && null == O && null == I && null == S && null != j && null == P && null == A && null == w ? null : (0, i.jsxs)("div", {
      id: (0, ek.bX)(t),
  ...
  constructor(...e) {
    super(...e), e$(this, "state", {
      ...
      let {
        ...
        isSearchResult: u,
        shouldAgeVerify: d
      } = this.props, p = r.channel_id, m = r.id, f = (0, ey.BP)(e, p, m, s, c);
      return e.type === eY.hBH.GIFT ? null : (0, i.jsx)(w.h.Provider, {
        value: (0, eW.P)(e.url, e.image, e.video),
        children: (0, i.jsx)(O.ZP, e0({
          embed: e,
    ...
    }), e$(this, "renderEmbedTitle", (e, t) => e.type === eY.hBH.RICH ? V.Z.parseEmbedTitle(t, !0, {
      channelId: this.props.channel.id
    }) : t), e$(this, "renderEmbedDescription", (e, t, n) => e.type === eY.hBH.RICH ? V.Z.parse(t, !0, {
      channelId: this.props.channel.id,
      allowLinks: !0,
      allowEmojiLinks: !0,
...
function e4(e) {
  ...
  let {
    ...
    isMessageSnapshot: a
  } = e, o = (0, c.e7)([ed.default], () => ed.default.getId()), s = ec.x4.useSetting(), u = ec.RS.useSetting(), d = ec.NA.useSetting() && !(0, eN.Z)(e.message), p = ec.nc.useSetting() && !1 !== e.renderReactions, m = ec.QK.useSetting(), f = (0, c.e7)([em.Z], () => null == n.guild_id || em.Z.canChatInGuild(n.guild_id), [n]), g = (0, c.e7)([G.Z], () => null != n.guild_id && G.Z.isLurking(n.guild_id), [n]), _ = (0, c.e7)([ep.ZP], () => ep.ZP.isCurrentUserGuest(n.guild_id), [n]), h = (0, c.e7)([ep.ZP, eg.default], () => {
    var e, t;
  ...
  }), [f, n]), C = (0, R.ux)(n.guild_id), [, x] = (0, L.AB)(n.guild_id), v = (0, eo.$R)(n), O = (o === r.author.id || E) && r.author.id !== eY.LAt && !1 !== l && !(0, eC.yE)(r.flags, eY.iLy.EPHEMERAL) && v && 1 === (0, eT.Z)(r), y = o === r.author.id && v && !a, j = r.author.id === o, S = r.isFirstMessageInForumPost(n), N = (0, eP.Z)({
    channel: n,
    canChat: f,
    renderReactions: p,
    canAddNewReactions: b,
  ...
  }), P = (0, H.A)((null != (t = r.editedTimestamp) ? t : r.timestamp).valueOf()), A = (0, K.Z)(null == n ? void 0 : n.id), w = (0, q.Z)(r), Z = (0, T.v)(r), D = (0, eS._)(n), k = (0, eO.ro)(r.id, r.channel_id), M = (0, I.m8)();
