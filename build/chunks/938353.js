...
function eq() {
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("img", {
      ...
      color: "text-muted",
      children: eV.intl.format(eV.t["G/H+s7"], {
        onClick: () => (0, Q.z)()
      })
    })]
  })
...
let eQ = 15 * ef.Z.Millis.MINUTE,
  ...
  e0 = e => () => {
    ...
    return null != r && null != l && (z.uo.test(n) || a && (z.YG.test(n) || z.FH.test(n))) ? (0, i.jsx)(eP.Z, {
      width: r,
      height: l,
      src: n,
      url: t,
...
class e1 extends(r = l.Component) {
  ...
  renderCodedLinks(e) {
    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
      ...
      else if (n === O.g.APP_DIRECTORY_STOREFRONT) return (0, i.jsx)(y.P, {
        appId: r,
        message: e
      }, r);
  ...
  renderPublishBump(e) {
    return this.props.channel.type !== eG.d4z.GUILD_ANNOUNCEMENT || this.props.isMessageSnapshot ? null : (0, i.jsx)(x.Z, {
      channelId: e.channel_id,
      messageId: e.id
    })
  }
  renderEphemeralAccessories(e) {
    return (0, ex.Pv)(e) ? (0, i.jsx)(eT.Z, {
      message: e,
      onDeleteMessage: () => {
  ...
  renderThreadAccessories(e) {
    if (e.hasFlag(eG.iLy.HAS_THREAD) && !1 !== this.props.renderThreadAccessory) return (0, i.jsx)(el.Z, {
      message: e,
      compact: this.props.compact
    })
  }
  renderThreadRoleMentionWarning(e) {
    if (e.hasFlag(eG.iLy.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) && this.props.isCurrentUser && !(Date.now() - e_.default.extractTimestamp(e.id) >= eQ)) return (0, i.jsx)("div", {
  ...
  renderEmbeddedApplicationInstanceEmbed(e) {
    ...
    return null == t || null == n ? null : (0, i.jsx)(eN.Z, {
      application: t,
  ...
  renderMediaPostEmbeds(e) {
    return e.embeds.flatMap(t => t.type !== eG.hBH.POST_PREVIEW || null == t.url ? [] : (0, i.jsx)(K.Z, {
      embedUrl: t.url,
      message: e,
  ...
  renderSafetyPolicyNotice(e) {
    return 1 === e.embeds.length && e.embeds[0].type === eG.hBH.SAFETY_POLICY_NOTICE ? (0, i.jsx)(ee.i, {
      message: e
    }) : null
  }
  renderSafetySystemNotification(e) {
    return 1 === e.embeds.length && e.embeds[0].type === eG.hBH.SAFETY_SYSTEM_NOTIFICATION ? (0, i.jsx)(et.g, {
      embed: e.embeds[0]
    }) : null
  }
  renderVoiceChannelInvite(e, t) {
    if (1 === e.embeds.length && e.embeds[0].type === eG.hBH.VOICE_CHANNEL) return (0, i.jsx)(L.H, {
      message: e,
      channel: t
    })
  }
  ...
  render() {
    ...
    } = this.state, s = this.renderCodedLinks(t), c = this.renderGiftCodes(t), u = this.renderReferralTrial(t), d = this.renderAttachments(t), p = this.renderCtaButton(), m = this.renderSocialProofingFileSizeNitroUpsell(t), f = this.renderEmbeds(t), h = this.renderActivityInvite(t), g = this.renderReactions(t), _ = this.renderPublishBump(t), b = this.renderEphemeralAccessories(t), y = this.renderStickersAccessories(t), E = this.renderThreadAccessories(t), x = this.renderComponentAccessories(t), v = this.renderThreadRoleMentionWarning(t), O = this.renderEmbeddedApplicationInstanceEmbed(t), j = this.renderInteractionPremiumUpsell(t), C = this.renderMediaPostEmbeds(t), S = this.renderSafetyPolicyNotice(t), I = this.renderSafetySystemNotification(t), N = this.renderVoiceChannelInvite(t, n), T = this.renderMediaObscureNotice(t), P = this.renderPoll(t, r), A = this.renderForwardedMessage(t);
    return null == s && null == d && null == f && null == h && null == g && null == c && null == u && null == _ && null == b && null == y && null == E && null == x && null == O && null == v && null == C && null == S && null != j && null == P && null == N && null == A ? null : (0, i.jsxs)("div", {
      id: (0, eZ.bX)(t),
  ...
  constructor(...e) {
    super(...e), eK(this, "state", {
      ...
      let {
        ...
        isSearchResult: u
      } = this.props, d = r.channel_id, p = r.id, m = (0, eE.BP)(e, d, p, s, c);
      return e.type === eG.hBH.GIFT ? null : (0, i.jsx)(P.h.Provider, {
    ...
    }), eK(this, "renderEmbedTitle", (e, t) => e.type === eG.hBH.RICH ? H.Z.parseEmbedTitle(t, !0, {
      channelId: this.props.channel.id
    }) : t), eK(this, "renderEmbedDescription", (e, t, n) => e.type === eG.hBH.RICH ? H.Z.parse(t, !0, {
      channelId: this.props.channel.id,
      allowLinks: !0,
      allowEmojiLinks: !0,
...
function e3(e) {
  ...
  let {
    ...
    isMessageSnapshot: a
  } = e, o = (0, c.e7)([eo.default], () => eo.default.getId()), s = ea.x4.useSetting(), u = ea.RS.useSetting(), d = ea.NA.useSetting() && !(0, eC.Z)(e.message), p = ea.nc.useSetting() && !1 !== e.renderReactions, m = ea.QK.useSetting(), f = (0, c.e7)([ec.Z], () => null == n.guild_id || ec.Z.canChatInGuild(n.guild_id), [n]), h = (0, c.e7)([B.Z], () => null != n.guild_id && B.Z.isLurking(n.guild_id), [n]), g = (0, c.e7)([es.ZP], () => es.ZP.isCurrentUserGuest(n.guild_id), [n]), _ = (0, c.e7)([es.ZP, ed.default], () => {
    var e, t;
  ...
  }), [f, n]), E = (0, w.ux)(n.guild_id), [, x] = (0, Z.AB)(n.guild_id), v = (0, ei.$R)(n), O = (o === r.author.id || y) && r.author.id !== eG.LAt && !1 !== l && !(0, eg.yE)(r.flags, eG.iLy.EPHEMERAL) && v && 1 === (0, ej.Z)(r), j = o === r.author.id && v && !a, C = r.author.id === o, I = r.isFirstMessageInForumPost(n), N = (0, eS.Z)({
    channel: n,
    canChat: f,
    renderReactions: p,
    canAddNewReactions: b,
  ...
  }), T = (0, G.A)((null != (t = r.editedTimestamp) ? t : r.timestamp).valueOf()), P = (0, W.Z)(null == n ? void 0 : n.id), A = (0, X.Z)(r), R = (0, S.V)(n.id, r.author.id), k = (0, eO._)(n), D = (0, ey.ro)(r.id, r.channel_id);
