...
class e8 extends(r = l.Component) {
  ...
  renderCodedLinks(e) {
    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
      ...
      } else if (n === O.g.APP_OAUTH2_LINK) return (0, i.jsx)(v.Z, {
        applicationId: r
      }, r);
  ...
  renderPublishBump(e) {
    return this.props.channel.type !== eK.d4z.GUILD_ANNOUNCEMENT || this.props.isMessageSnapshot ? null : (0, i.jsx)(y.Z, {
...
function e6(e) {
  ...
  }), [f, n]), x = (0, Z.ux)(n.guild_id), [, v] = (0, R.AB)(n.guild_id), y = (0, eo.$R)(n), C = (o === r.author.id || E) && r.author.id !== eK.LAt && !1 !== l && !(0, eE.yE)(r.flags, eK.iLy.EPHEMERAL) && y && 1 === (0, eS.Z)(r), O = o === r.author.id && y && !a, j = r.author.id === o, I = r.isFirstMessageInForumPost(n), T = (0, eN.Z)({
    channel: n,
    canChat: f,
    renderReactions: p,
    canAddNewReactions: b,
  ...
  }), N = (0, H.A)((null != (t = r.editedTimestamp) ? t : r.timestamp).valueOf()), P = (0, K.Z)(null == n ? void 0 : n.id), A = (0, q.Z)(r), w = (0, S.v)(r), k = (0, eI._)(n), L = (0, ey.ro)(r.id, r.channel_id);
