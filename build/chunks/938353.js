...
let e2 = 15 * eb.Z.Millis.MINUTE,
  ...
  e8 = e => () => {
    let {
      ...
      height: l,
      flags: a
    } = e, o = (0, ex.yE)(a, W.hR.IS_ANIMATED);
    return null != r && null != l && (K.uo.test(n) || o && (K.YG.test(n) || K.FH.test(n))) ? (0, i.jsx)(eR.Z, {
      width: r,
      height: l,
      src: n,
      url: t,
...
class e6 extends(r = l.Component) {
  ...
  renderCodedLinks(e) {
    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
      ...
      if (n === O.g.INVITE) return this.shouldRenderInvite(r) ? (0, i.jsx)(eL.Z, {
        code: r,
        message: e,
        getAcceptInviteContext: this.getAcceptInviteContext
      }, r) : null;
      if (n === O.g.TEMPLATE) return (0, i.jsx)(M.Z, {
        code: r
      }, r);
      if (n === O.g.EVENT) return (0, i.jsx)(D.Z, {
        code: r
      }, r);
      if (n === O.g.CHANNEL_LINK) return (0, i.jsx)(eA.Z, {
        code: r,
        message: e
      }, r);
      if (n === O.g.APP_DIRECTORY_PROFILE) return (0, i.jsx)(Z.Z, {
        code: r,
        message: e
      }, r);
      ...
      else if (n === O.g.QUESTS_EMBED) return (0, i.jsx)(et.Z, {
        questId: r
      }, r);
      ...
      } else if (n === O.g.APP_OAUTH2_LINK) return (0, i.jsx)(y.Z, {
        applicationId: r
      }, r);
  ...
  renderThreadAccessories(e) {
    if (e.hasFlag(eY.iLy.HAS_THREAD) && !1 !== this.props.renderThreadAccessory) return (0, i.jsx)(ec.Z, {
      message: e,
      compact: this.props.compact
    })
  }
  renderThreadRoleMentionWarning(e) {
    if (e.hasFlag(eY.iLy.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) && this.props.isCurrentUser && !(Date.now() - ey.default.extractTimestamp(e.id) >= e2)) return (0, i.jsx)("div", {
  ...
  renderMediaPostEmbeds(e) {
    return e.embeds.flatMap(t => t.type !== eY.hBH.POST_PREVIEW || null == t.url ? [] : (0, i.jsx)(X.Z, {
      embedUrl: t.url,
      message: e,
  ...
  renderSafetyPolicyNotice(e) {
    return 1 === e.embeds.length && e.embeds[0].type === eY.hBH.SAFETY_POLICY_NOTICE ? (0, i.jsx)(ei.i, {
      message: e
    }) : null
  }
  renderSafetySystemNotification(e) {
    return 1 === e.embeds.length && e.embeds[0].type === eY.hBH.SAFETY_SYSTEM_NOTIFICATION ? (0, i.jsx)(el.g, {
      embed: e.embeds[0]
    }) : null
  }
  renderVoiceChannelInvite(e, t) {
    if (1 === e.embeds.length && e.embeds[0].type === eY.hBH.VOICE_CHANNEL) return (0, i.jsx)(U.H, {
      message: e,
      channel: t
    })
  }
  ...
  constructor(...e) {
    ...
    }), e$(this, "renderEmbedTitle", (e, t) => e.type === eY.hBH.RICH ? z.Z.parseEmbedTitle(t, !0, {
      channelId: this.props.channel.id
    }) : t), e$(this, "renderEmbedDescription", (e, t, n) => e.type === eY.hBH.RICH ? z.Z.parse(t, !0, {
      channelId: this.props.channel.id,
      allowLinks: !0,
      allowEmojiLinks: !0,
...
function e4(e) {
  ...
  let {
    ...
    isMessageSnapshot: a
  } = e, o = (0, c.e7)([ed.default], () => ed.default.getId()), s = eu.x4.useSetting(), u = eu.RS.useSetting(), d = eu.NA.useSetting() && !(0, eN.Z)(e.message), p = eu.nc.useSetting() && !1 !== e.renderReactions, m = eu.QK.useSetting(), f = (0, c.e7)([em.Z], () => null == n.guild_id || em.Z.canChatInGuild(n.guild_id), [n]), h = (0, c.e7)([H.Z], () => null != n.guild_id && H.Z.isLurking(n.guild_id), [n]), g = (0, c.e7)([ep.ZP], () => ep.ZP.isCurrentUserGuest(n.guild_id), [n]), _ = (0, c.e7)([ep.ZP, eh.default], () => {
    var e, t;
  ...
  }), [f, n]), x = (0, R.ux)(n.guild_id), [, y] = (0, L.AB)(n.guild_id), v = (0, es.$R)(n), C = (o === r.author.id || E) && r.author.id !== eY.LAt && !1 !== l && !(0, ex.yE)(r.flags, eY.iLy.EPHEMERAL) && v && 1 === (0, eT.Z)(r), O = o === r.author.id && v && !a, j = r.author.id === o, S = r.isFirstMessageInForumPost(n), N = (0, eP.Z)({
    channel: n,
    canChat: f,
    renderReactions: p,
    canAddNewReactions: b,
  ...
  }), P = (0, V.A)((null != (t = r.editedTimestamp) ? t : r.timestamp).valueOf()), A = (0, Y.Z)(null == n ? void 0 : n.id), w = (0, Q.Z)(r), Z = (0, T.v)(r), k = (0, eS._)(n), D = (0, eC.ro)(r.id, r.channel_id), M = (0, I.m8)();
