...
function e$() {
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("img", {
      ...
      color: "text-muted",
      children: eK.intl.format(eK.t["G/H+s7"], {
        onClick: () => (0, Q.z)()
      })
    })]
  })
...
let e0 = 15 * eg.Z.Millis.MINUTE,
  ...
  e5 = e => () => {
    ...
    return null != r && null != l && (z.uo.test(n) || a && (z.YG.test(n) || z.FH.test(n))) ? (0, i.jsx)(ew.Z, {
      width: r,
      height: l,
      src: n,
      url: t,
...
class e8 extends(r = l.Component) {
  ...
  renderCodedLinks(e) {
    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
      ...
      if (n === O.g.INVITE) return this.shouldRenderInvite(r) ? (0, i.jsx)(eZ.Z, {
        code: r,
        message: e,
      ...
      if (n === O.g.CHANNEL_LINK) return (0, i.jsx)(eT.Z, {
        code: r,
        message: e
      }, r);
      ...
      else if (n === O.g.QUESTS_EMBED) return (0, i.jsx)($.Z, {
        questId: r
      }, r);
      else if (n === O.g.APP_DIRECTORY_STOREFRONT) return (0, i.jsx)(x.P, {
        appId: r,
        message: e
      }, r);
      ...
      } else if (n === O.g.APP_OAUTH2_LINK) return (0, i.jsx)(E.Z, {
        applicationId: r,
        embedUrl: l
      }, r);
  ...
  renderPublishBump(e) {
    return this.props.channel.type !== ez.d4z.GUILD_ANNOUNCEMENT || this.props.isMessageSnapshot ? null : (0, i.jsx)(y.Z, {
      channelId: e.channel_id,
      messageId: e.id
    })
  }
  renderEphemeralAccessories(e) {
    return (0, eO.Pv)(e) ? (0, i.jsx)(eA.Z, {
      message: e,
      onDeleteMessage: () => {
  ...
  renderStickersAccessories(e) {
    ...
    return 0 === t.length ? null : t.map(e => (0, i.jsx)(el.Z, {
      channel: n,
      isInteracting: r,
      renderableSticker: e
    }, e.id))
  ...
  renderThreadAccessories(e) {
    if (e.hasFlag(ez.iLy.HAS_THREAD) && !1 !== this.props.renderThreadAccessory) return (0, i.jsx)(eo.Z, {
      message: e,
      compact: this.props.compact
    })
  }
  renderThreadRoleMentionWarning(e) {
    if (e.hasFlag(ez.iLy.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) && this.props.isCurrentUser && !(Date.now() - ex.default.extractTimestamp(e.id) >= e0)) return (0, i.jsx)("div", {
  ...
  renderInteractionPremiumUpsell(e) {
    ...
    return e.type !== s.u.INTERACTION_PREMIUM_UPSELL || null == t ? null : (0, i.jsx)(eU.Z, {
      applicationId: t,
  ...
  renderEmbeddedApplicationInstanceEmbed(e) {
    ...
    return null == t || null == n ? null : (0, i.jsx)(eP.Z, {
      application: t,
  ...
  renderMediaPostEmbeds(e) {
    return e.embeds.flatMap(t => t.type !== ez.hBH.POST_PREVIEW || null == t.url ? [] : (0, i.jsx)(K.Z, {
      embedUrl: t.url,
      message: e,
  ...
  renderSafetyPolicyNotice(e) {
    return 1 === e.embeds.length && e.embeds[0].type === ez.hBH.SAFETY_POLICY_NOTICE ? (0, i.jsx)(en.i, {
      message: e
    }) : null
  }
  renderSafetySystemNotification(e) {
    return 1 === e.embeds.length && e.embeds[0].type === ez.hBH.SAFETY_SYSTEM_NOTIFICATION ? (0, i.jsx)(er.g, {
      embed: e.embeds[0]
    }) : null
  }
  renderVoiceChannelInvite(e, t) {
    if (1 === e.embeds.length && e.embeds[0].type === ez.hBH.VOICE_CHANNEL) return (0, i.jsx)(L.H, {
      message: e,
      channel: t
    })
  }
  renderMediaObscureNotice(e) {
    ...
    return 0 === t.length && 0 === n.length ? null : (0, i.jsx)(I.Z, {
      message: e
    })
  }
  renderPoll(e, t) {
  ...
  renderReportedMessage(e) {
    if (e.messageSnapshots.length > 0 && (0, ee.Q3)(e, this.props.channel)) return (0, i.jsx)(et.Z, {
      message: e
    })
  }
  renderForwardedMessage(e) {
    if (e.messageSnapshots.length > 0 && !(0, ee.Q3)(e, this.props.channel)) return (0, i.jsx)(T.Z, {
      message: e
    })
  }
  renderEditedTag(e, t) {
  ...
  render() {
    ...
    return null == u && null == m && null == g && null == _ && null == b && null == d && null == p && null == x && null == E && null == y && null == v && null == O && null == C && null == j && null == I && null == N && null != S && null == w && null == P && null == Z && null == R ? null : (0, i.jsxs)("div", {
      id: (0, ek.bX)(t),
  ...
  constructor(...e) {
    super(...e), eq(this, "state", {
      ...
      return e.type === ez.hBH.GIFT ? null : (0, i.jsx)(P.h.Provider, {
        value: e3(e.url, e.image, e.video),
        children: (0, i.jsx)(v.ZP, eQ({
          className: eY.embedWrapper,
          embed: e,
    ...
    }), eq(this, "renderEmbedTitle", (e, t) => e.type === ez.hBH.RICH ? H.Z.parseEmbedTitle(t, !0, {
      channelId: this.props.channel.id
    }) : t), eq(this, "renderEmbedDescription", (e, t, n) => e.type === ez.hBH.RICH ? H.Z.parse(t, !0, {
      channelId: this.props.channel.id,
      allowLinks: !0,
      allowEmojiLinks: !0,
...
function e2(e) {
  ...
  let {
    ...
    isMessageSnapshot: a
  } = e, o = (0, c.e7)([ec.default], () => ec.default.getId()), s = es.x4.useSetting(), u = es.RS.useSetting(), d = es.NA.useSetting() && !(0, eI.Z)(e.message), p = es.nc.useSetting() && !1 !== e.renderReactions, m = es.QK.useSetting(), f = (0, c.e7)([ed.Z], () => null == n.guild_id || ed.Z.canChatInGuild(n.guild_id), [n]), h = (0, c.e7)([B.Z], () => null != n.guild_id && B.Z.isLurking(n.guild_id), [n]), g = (0, c.e7)([eu.ZP], () => eu.ZP.isCurrentUserGuest(n.guild_id), [n]), _ = (0, c.e7)([eu.ZP, em.default], () => {
    var e, t;
  ...
  }), [f, n]), E = (0, w.ux)(n.guild_id), [, y] = (0, Z.AB)(n.guild_id), v = (0, ea.$R)(n), O = (o === r.author.id || x) && r.author.id !== ez.LAt && !1 !== l && !(0, eb.yE)(r.flags, ez.iLy.EPHEMERAL) && v && 1 === (0, eS.Z)(r), j = o === r.author.id && v && !a, C = r.author.id === o, I = r.isFirstMessageInForumPost(n), N = (0, eN.Z)({
    channel: n,
    canChat: f,
    renderReactions: p,
    canAddNewReactions: b,
  ...
  }), T = (0, G.A)((null != (t = r.editedTimestamp) ? t : r.timestamp).valueOf()), P = (0, W.Z)(null == n ? void 0 : n.id), A = (0, X.Z)(r), R = (0, S.V)(n.id, r.author.id), k = (0, eC._)(n), D = (0, ey.ro)(r.id, r.channel_id);
  return (0, i.jsx)(e8, eJ(eQ(eJ(eQ({
    canSuppressEmbeds: O,
