...
class e8 extends(r = l.Component) {
  ...
  renderPublishBump(e) {
    return this.props.channel.type !== eK.d4z.GUILD_ANNOUNCEMENT || this.props.isMessageSnapshot ? null : (0, i.jsx)(C.Z, {
  ...
  render() {
    ...
    return null == u && null == m && null == h && null == _ && null == b && null == d && null == p && null == E && null == x && null == v && null == C && null == y && null == j && null == O && null == S && null == T && null != I && null == w && null == P && null == Z && null == R ? null : (0, i.jsxs)("div", {
      id: (0, eL.bX)(t),
...
function e6(e) {
  ...
  }), [f, n]), x = (0, Z.ux)(n.guild_id), [, v] = (0, R.AB)(n.guild_id), C = (0, eo.$R)(n), y = (o === r.author.id || E) && r.author.id !== eK.LAt && !1 !== l && !(0, eE.yE)(r.flags, eK.iLy.EPHEMERAL) && C && 1 === (0, eS.Z)(r), O = o === r.author.id && C && !a, j = r.author.id === o, I = r.isFirstMessageInForumPost(n), T = (0, eN.Z)({
    channel: n,
    canChat: f,
    renderReactions: p,
    canAddNewReactions: b,
