...
class e8 extends(r = l.Component) {
  ...
  renderCodedLinks(e) {
    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
      ...
      if (n === y.g.INVITE) return this.shouldRenderInvite(r) ? (0, i.jsx)(eR.Z, {
        code: r,
        message: e,
      ...
      if (n === y.g.CHANNEL_LINK) return (0, i.jsx)(eP.Z, {
        code: r,
        message: e
      }, r);
  ...
  renderThreadAccessories(e) {
    if (e.hasFlag(eK.iLy.HAS_THREAD) && !1 !== this.props.renderThreadAccessory) return (0, i.jsx)(es.Z, {
      message: e,
      compact: this.props.compact
    })
  }
  renderThreadRoleMentionWarning(e) {
    if (e.hasFlag(eK.iLy.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) && this.props.isCurrentUser && !(Date.now() - eC.default.extractTimestamp(e.id) >= e3)) return (0, i.jsx)("div", {
  ...
  constructor(...e) {
    super(...e), eJ(this, "state", {
      ...
      return e.type === eK.hBH.GIFT ? null : (0, i.jsx)(w.h.Provider, {
...
function e6(e) {
  ...
  }), [f, n]), C = (0, R.ux)(n.guild_id), [, x] = (0, L.AB)(n.guild_id), v = (0, eo.$R)(n), O = (o === r.author.id || E) && r.author.id !== eK.LAt && !1 !== l && !(0, eE.yE)(r.flags, eK.iLy.EPHEMERAL) && v && 1 === (0, eS.Z)(r), y = o === r.author.id && v && !a, j = r.author.id === o, S = r.isFirstMessageInForumPost(n), N = (0, eN.Z)({
    channel: n,
    canChat: f,
    renderReactions: p,
    canAddNewReactions: b,
