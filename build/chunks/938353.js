...
function e4(e) {
  ...
  let {
    ...
    isMessageSnapshot: a
  } = e, o = (0, c.e7)([ed.default], () => ed.default.getId()), s = eu.x4.useSetting(), u = eu.RS.useSetting(), d = eu.NA.useSetting() && !(0, eN.Z)(e.message), p = eu.nc.useSetting() && !1 !== e.renderReactions, m = eu.QK.useSetting(), f = (0, c.e7)([em.Z], () => null == n.guild_id || em.Z.canChatInGuild(n.guild_id), [n]), g = (0, c.e7)([H.Z], () => null != n.guild_id && H.Z.isLurking(n.guild_id), [n]), h = (0, c.e7)([ep.ZP], () => ep.ZP.isCurrentUserGuest(n.guild_id), [n]), _ = (0, c.e7)([ep.ZP, eg.default], () => {
    var e, t;
  ...
  }), [f, n]), x = (0, R.ux)(n.guild_id), [, y] = (0, k.AB)(n.guild_id), v = (0, es.$R)(n), C = (o === r.author.id || E) && r.author.id !== eY.LAt && !1 !== l && !(0, ex.yE)(r.flags, eY.iLy.EPHEMERAL) && v && 1 === (0, eT.Z)(r), O = o === r.author.id && v && !a, j = r.author.id === o, S = r.isFirstMessageInForumPost(n), N = (0, eP.Z)({
    channel: n,
    canChat: f,
    renderReactions: p,
    canAddNewReactions: b,
  ...
  }), P = (0, V.A)((null != (t = r.editedTimestamp) ? t : r.timestamp).valueOf()), A = (0, Y.Z)(null == n ? void 0 : n.id), w = (0, Q.Z)(r), Z = (0, T.v)(r), L = (0, eS._)(n), D = (0, eC.ro)(r.id, r.channel_id), M = (0, I.m8)();
