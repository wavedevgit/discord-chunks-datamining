...
function m(e, t) {
  ...
  return i.useMemo(() => o.map(i => {
    ...
    return <s.sNh id={"translate-".concat(i.value)} label={i.name} icon={() => (0, r.jsx)("img", {
        alt: "",
        src: o,
        className: _.flagIcon
      })} action={() => e(i.value, i.name)} disabled={t} />
  }), [e, t, o])
}
...
function g(e, t) {
  let n = c.C.useExperiment({
    ...
    u = m(i, a);
  return null != e.content && "" !== e.content.trim() && (null == n ? true : n.enableAIFeatures) ? l ? <s.sNh id={"revert-translation"} label={f.intl.string(f.t.JC9BXl)} icon={s.os0} action={o} disabled={a} /> : <s.sNh id={"translate"} label={a ? f.intl.string(f.t.SVKIdX) : f.intl.string(f.t["6epDlZ"])} action={() => i()} disabled={a}>{u}</s.sNh> : null
}