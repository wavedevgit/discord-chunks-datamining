...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk617552 = require("./617552.js"),
  Chunk473179 = require("./473179.js"),
  Chunk932174 = require("./932174.js"),
  Chunk225639 = require("./225639.js"),
  Chunk981631 = require("./981631.js"),
  Chunk388032 = require("./388032.js"),
  Chunk951927 = require("./951927.js");
...
function V(e) {
  let {
    ...
    return <u.DY3 text={i} position={"bottom"}><img src={e.getAvatarURL(null == n ? true : n.guild_id, J)} alt={i} className={M.avatar} /></u.DY3>
  ...
  let es = <p.Z application={i} size={24} className={M.appIcon} />;
  return H && (es = <u.DY3 text={V.compositeInstanceId} position={"bottom"}>{es}</u.DY3>), <u.f6W theme={W.BRd.DARK}>{e => (0, r.jsxs)("div", {
