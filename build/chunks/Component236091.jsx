...
let g = e => {
  ...
  return (0, r.e7)([u.Z, s.Z, p.Z, c.ZP], () => {
    ...
    return null != i && !!p.Z.getSettings().clipsEnabled && !!n || null != r && !!p.Z.getSettings().decoupledClipsEnabled && !!g || s.Z.getParticipants(t).some(e => e.type === f.fO.USER && p.Z.isClipsEnabledForUser(e.user.id))
  }) ? (0, i.jsx)(a.u, {
