...
function G() {
  __OVERLAY__ || p.K.set(D, {
    ...
    knownThreadIds: f()(x).values().concat(f().values(j)).filter(E.lm).uniq().filter(e => {
      ...
      return k.has(e) || null != t && m.Ec.has(t.type)
    }).value()
  })
}
...
function q(e, t) {
  ...
  let n = null != O.Z.getGuild(t) ? t : null,
    r = !1;
  s === e && (s = null, r = !0), x[U(n)] === e && (x[U(n)] = B(U(n)), I.Z.getGuildId() === n && (0, g.dL)(T.Z5c.CHANNEL(t, x[U(n)])), r = !0), null != n && j[n] === e && (delete j[n], r = !0), r && G()
}
...
function en() {
  x = {}, o = null, i = void 0, j = {}, a = {}, s = null, p.K.remove(D)
}
