...
function Y(e) {
  r = e.sessionId, s = e.selectedVoiceChannelId, x = {}, k = {}, a = e.selectedChannelId, x[e.selectedGuildId] = e.selectedChannelId, V(e.selectedGuildId, a), Z()
}
...
function K(e) {
  ...
  null == n && (n = B(t)), null != a && n !== a && (i = a), a = n, V(t, n), x[U(t)] !== n && (k[U(t)] = x[U(t)], x[U(t)] = a), G()
}
