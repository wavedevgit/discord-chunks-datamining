...
let r = function() {
  ...
  function d(e, t) {
    for (var n, r, i = e.childNodes, o = i.length; o--;) 3 === (r = (n = i[o]).nodeType) ? t.push(n) : 1 !== r || "ownerSVGElement" in n || a.test(n.nodeName.toLowerCase()) || d(n, t);
    return t
  }
  ...
  function p(e, t) {
    for (var r, i, o, a, s, c, u, p, _, m, h, g, E, b = d(e, []), y = b.length; y--;) {
      for (o = false, a = document.createDocumentFragment(), c = (s = b[y]).nodeValue, p = 0; u = n.exec(c);) {
        if ((_ = u.index) !== p && a.appendChild(l(c.slice(p, _), true)), g = f(h = u[0]), p = _ + h.length, E = t.callback(g, t), g && E) {
          ...
          m.className = t.className, m.alt = h, m.src = E, o = true, a.appendChild(m)
        }
        m || a.appendChild(l(h, false)), m = null
      }
      o && (p < c.length && a.appendChild(l(c.slice(p), true)), s.parentNode.replaceChild(a, s))
    }
    return e
  }
