  ...
  function _(e, t) {
    return y(e, function(e) {
      var n, r, i = e,
        ...
        o = t.callback(a, t);
      if (a && o) {
        for (r in i = "<img ".concat('class="', t.className, '" ', 'draggable="false" ', 'alt="', e, '"', ' src="', o, '"'), n = t.attributes(e, a)) n.hasOwnProperty(r) && 0 !== r.indexOf("on") && false === i.indexOf(" " + r + "=") && (i = i.concat(" ", r, '="', c(n[r]), '"'));
        i = i.concat("/>")
      }
      return i
    })
