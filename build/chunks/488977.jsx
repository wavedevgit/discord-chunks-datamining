...
function x(e) {
  ...
  return <div className={R.container}>{<l.P3F onClick={() => {
        let e = Y ? (0, f.H)({
          applicationId: o.id,
      ...
      }} className={a()(R.clickable, D)} aria-label={C.intl.string(C.t.WqhZsr)}><l.xPt size={"sm"} color={l.TVs.colors.INTERACTIVE_ACTIVE} /></l.P3F>}{<l.yRy targetElementRef={M} renderPopout={e => {
        let {
          closePopout: t
        } = e;
      ...
      }} align={"right"} position={"bottom"}>{e => (0, r.jsx)(l.P3F, L(w({
        innerRef: M
      }, e), {
        onClick: e.onClick,
