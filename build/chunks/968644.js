...
function m(e) {
  let {
    ...
    itemHook: p
  } = e, f = null == t ? void 0 : t.id, g = (0, l.Wu)([a.Z], () => null != f ? a.Z.getManyRoles(f, m) : [], [f, m]), x = (0, l.Wu)([i.Z, s.default, o.Z], () => Array.from(h).map(e => i.Z.getChannel(e)).filter(c.lm).map(e => (0, r.F6)(e, s.default, o.Z, !0))), _ = g.map(e => "@".concat(e.name)), C = (null == n ? void 0 : n.singleSelect) ? "" : d.intl.string(d.t.JshhEh), b = "";
...
function h(e) {
  let {
    ...
    itemHook: h
  } = e, p = null == t ? void 0 : t.id, f = (0, l.Wu)([a.Z], () => null != p ? a.Z.getManyRoles(p, u) : [], [p, u]), g = (0, l.Wu)([i.Z, s.default, o.Z], () => Array.from(m).map(e => i.Z.getChannel(e)).filter(c.lm).map(e => (0, r.F6)(e, s.default, o.Z, !0))), x = f.map(e => "@".concat(e.name)), _ = (null == n ? void 0 : n.singleSelect) ? "" : d.intl.string(d.t.JshhEh);
