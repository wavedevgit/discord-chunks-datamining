...
function er(e) {
  ...
  let eI = null,
    ...
    eP = eo.map((e, t) => {
      if (e.type === Q.ys_.DIVIDER) {
        ...
        return null != eu ? null : e.isSummaryDivider ? (0, r.jsx)(I.Z, {
          index: t,
          item: e,
          channel: f,
  ...
  if (B.hasMoreBefore && null == eu || eS.unshift((0, r.jsx)(m.Z, {
    ...
    } else ej.includes(K.E.NEW_MESSAGES) && (i = (0, r.jsx)(V.LE, {
      content: $.NW.format(e, {
        count: er,
        timestamp: l
      }),
  ...
  if (null == i && (0, c.Lp)(f) && eC && ej.includes(K.E.SUMMARIES) && (i = (0, r.jsx)(V.BO, {
      channel: f,
      scrollManager: es
