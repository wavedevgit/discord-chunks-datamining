...
function eo(e) {
  ...
  let eT = null,
    ...
    eA = I.map((e, t) => {
      if (e.type === $.ys_.DIVIDER) {
        ...
        return null != J ? null : e.isSummaryDivider ? (0, r.jsx)(C.Z, {
          index: t,
          item: e,
          channel: l,
      ...
      if (e.type === $.ys_.FORUM_POST_ACTION_BAR) return (0, r.jsx)(m.Z, {
      ...
      if (e.type === $.ys_.MESSAGE_GROUP_BLOCKED || e.type === $.ys_.MESSAGE_GROUP_IGNORED || e.type === $.ys_.MESSAGE_GROUP_SPAMMER) {
        let t;
        return t = e.type === $.ys_.MESSAGE_GROUP_BLOCKED ? Q.t["+FcYMz"] : e.type === $.ys_.MESSAGE_GROUP_IGNORED ? Q.t.VFWjc3 : Q.t.xfkfTE, (0, r.jsx)(F.Z, {
          unreadId: q.j1,
          messages: e,
          channel: l,
          compact: O,
  ...
  if (_.hasMoreBefore && null == J || eS.unshift((0, r.jsx)(h.Z, {
      channel: l,
      showingBanner: eo
    }, "empty-message")), _.hasMoreAfter && eS.push((0, r.jsx)(Y.ZP, ee({
      compact: O
    }, B), "has-more-after")), !eo && ef && ed() && eS.push((0, r.jsx)(W.Z, {
      channel: l
    })), p > 0 && y && ed()) {
    let e, t, n = R.ZP.getOldestUnreadTimestamp(l.id),
    ...
    if (R.ZP.isEstimated(l.id) ? (e = s ? Q.t.wvtbbG : Q.t.tHqbtr, t = Q.t.vaPWFR) : (e = s ? Q.t.BctFHx : Q.t["3wXb9P"], t = Q.t["4H8ldH"]), ep && (0, c.tW)(l) && eb.includes(z.E.SUMMARIES)) {
      ...
      if ((0, d.yw)($.rMx.SUMMARIES_UNREAD_BAR_VIEWED, {
        ...
        if (eh) {
          let e = s > 0 ? (0, r.jsxs)(r.Fragment, {
            children: [(0, r.jsx)(o.Text, {
              ...
              variant: "text-sm/medium",
              color: "currentColor",
              children: Q.intl.format(Q.t.CBftDQ, {
                count: s
              })
            })]
          }) : (0, r.jsx)(o.Text, {
