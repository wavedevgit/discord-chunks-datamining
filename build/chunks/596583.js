...
var s = r(120356),
  ...
  S = r(974149);
let R = (e, t) => {
    f.Z.hasLayers() && (0, u.xf)(), c.Z.openPrivateChannel({
      recipientIds: e
    }), t()
  },
  E = e => {
    let {
      ...
      size: C.EFr.SIZE_56
    }), o = g.ZP.getName(t), d = t.username !== o && r === m.Fz.SUCCESS, c = r === m.Fz.FAIL;
    return (0, a.jsxs)("div", {
  ...
  w = e => {
    ...
    return n > 0 && (h = b.intl.formatToPlainString(b.t.iWtOfH, {
      numReferrals: f
    })), 0 === f && (h = b.intl.string(b.t["7VBEub"])), (0, a.jsxs)("div", {
