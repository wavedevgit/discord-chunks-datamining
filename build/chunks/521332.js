...
function h(e) {
  let {
    ...
    reportType: d,
    reportSubType: h
  } = e, f = (0, i.e7)([u.Z], () => u.Z.getChannel(n)), v = (0, m.jc)(t, null == f ? void 0 : f.type), j = (0, p.i_)(d, h, s);
  return 0 === v.length ? null : (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(o.X6q, {
      ...
      onClick: () => {
        l.Z.open(_.oAB.CONTENT_AND_SOCIAL), a(), c.ZP.trackWithMetadata(_.rMx.IAR_SETTINGS_UPSELLS_ACTION, {
          report_id: s,
          report_type: d.name,
          report_subtype: h,
