...
function f(e) {
  let {
    ...
    reportType: u,
    reportSubType: f
  } = e, v = (0, i.e7)([m.Z], () => m.Z.getChannel(n)), j = (0, p.jc)(t, null == v ? void 0 : v.type), C = (0, _.i_)(u, f, c);
  return 0 === j.length ? null : (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(l.X6q, {
      ...
      onClick: () => {
        s.Z.open(b.oAB.CONTENT_AND_SOCIAL), a(), d.ZP.trackWithMetadata(b.rMx.IAR_SETTINGS_UPSELLS_ACTION, {
          report_id: c,
          report_type: u.name,
          report_subtype: f,
