...
function g(e) {
  let {
    guild: t
  } = e, n = t.getIconURL(20, !1, !0), i = (0, l.Zg)(t.name);
  return (0, r.jsx)(a.ZP, {
...
function b(e) {
  let {
    guildIds: t
  } = e, n = (0, o.e7)([u.Z], () => u.Z.getGuildId()), l = (0, o.Wu)([c.Z], () => t.map(e => c.Z.getGuild(e)), [t]), a = (0, i.useMemo)(() => l.filter(e => null != e), [l]), {
    visibleGuilds: b,
    numTruncated: y,
    ...
    let e = [...a];
    if (null != n) {
      let t = a.findIndex(e => e.id === n); - 1 !== t && (e.splice(t, 1), e.unshift(a[t]))
    }
    return 4 === e.length ? {
      visibleGuilds: e,
      numTruncated: 0,
