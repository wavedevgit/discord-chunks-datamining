...
class K extends i.PureComponent {
  componentDidMount() {
    ...
    if (y.default.track(w.rMx.INVITE_VIEWED, {
        invite_code: n
      }, {
        flush: !0
      }), (0, I.e)("invite"), !M.KO) {
      let e = this.getInviteKey();
      A.Z.launch("discord://" + w.Z5c.INVITE(e), () => void 0)
    }
    if (!t && e) {
      let e = this.getInviteKey(),
        {
  ...
  componentDidUpdate(e) {
    ...
    if (n !== e.nativeAppState && n === w.kEZ.OPEN && this.track(w.rMx.INVITE_APP_INVOKED, !1), this.getMode() === z.REGISTER && r && !e.authenticated) {
      ...
      null != e && ((0, v.c)(k.M5.INVITE_UNCLAIMED), null != t.guild ? i(w.Z5c.APP_WITH_INVITE_AND_GUILD_ONBOARDING(t.code)) : d.ZP.transitionToInvite(t, i))
    }
  }
  getInviteKey() {
  ...
  renderInvalidInvite() {
    ...
    return (0, r.jsxs)(m.ZP, {
      children: [(0, r.jsx)(m.Ee, {
        ...
        className: s()(G.marginTop8, G.marginBottom8),
        children: U.intl.string(U.t.kux01N)
      }), (0, r.jsx)(m.DK, {
        children: e ? U.intl.string(U.t["5AkWAQ"]) : U.intl.string(U.t["+qUJAg"])
      }), this.renderButton(U.intl.string(U.t.fIv16O)), (0, r.jsx)(m.zx, {
  ...
  renderErrorInvite() {
    ...
    return (0, r.jsxs)(m.ZP, {
      ...
      }), (null == (t = this.state.error) ? void 0 : t.code) === w.evJ.INVALID_CANNOT_FRIEND_SELF ? this.renderButton(U.intl.string(U.t.fIv16O)) : this.renderButton(U.intl.string(U.t.ohMvm5), this.handleAccept)]
    })
  }
  renderExpiredInvite() {
  ...
  renderAuthenticatedHeader() {
    ...
    return null != e.stage_instance && null != e.guild ? (0, r.jsx)(_.Z, {
      ...
      guild: e.guild
    }) : null != e.guild_scheduled_event ? (0, r.jsx)(f.r, {
      channel: e.channel,
  ...
  renderAuthenicatedFooter() {
    ...
    return (null != e.stage_instance || null != e.guild_scheduled_event) && null != e.guild ? (0, r.jsx)(m.ZP, {
  ...
  renderAuthenticatedOrDownload() {
    let {
      invite: e
    } = this.props, t = null != e.stage_instance ? U.intl.string(U.t["5UKyUl"]) : U.intl.string(U.t.ohMvm5);
    return (0, r.jsxs)("div", {
  ...
  renderContinue() {
    return (0, r.jsxs)(m.ZP, {
      children: [(0, r.jsx)(m.Dx, {
        children: U.intl.string(U.t.fOc4go)
  ...
  render() {
    ...
    switch (e.state) {
      ...
      case w.r2o.RESOLVED:
        var s;
        if (n && (0, C.yE)(null != (s = e.flags) ? s : 0, o.$.IS_GUEST_INVITE)) return d.ZP.openApp(e.code), u.x.set(E.J, e.code), this.renderAppOpened(() => i(w.Z5c.APP));
...
let H = c.ZP.connectStores([N.Z, S.Z, j.default, x.Z, g.Z], e => {
  var t;
  let {
    inviteKey: n
  } = e;
