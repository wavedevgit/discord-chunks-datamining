...
class H extends i.PureComponent {
  componentDidMount() {
    ...
    if (y.default.track(L.rMx.INVITE_VIEWED, {
        invite_code: n
      }, {
        flush: !0
      }), (0, O.e)("invite"), !M.KO) {
  ...
  componentDidUpdate(e) {
    ...
    if (n !== e.nativeAppState && n === L.kEZ.OPEN && this.track(L.rMx.INVITE_APP_INVOKED, !1), this.getMode() === z.REGISTER && r && !e.authenticated) {
      ...
      if (null != e)
        if ((0, I.c)(k.M5.INVITE_UNCLAIMED), null != t.guild) {
          var a, c, u;
  ...
  track(e, t, n) {
    let {
      invite: r
    } = this.props, i = this.getInviteKey(), l = (0, b.jX)(i), a = t ? {
  ...
  renderInvalidInvite() {
    ...
    return (0, r.jsxs)(g.ZP, {
      children: [(0, r.jsx)(g.Ee, {
        ...
        children: e ? B.intl.string(B.t["5AkWAQ"]) : B.intl.string(B.t["+qUJAg"])
      }), this.renderButton(B.intl.string(B.t.fIv16O)), (0, r.jsx)(g.zx, {
  ...
  renderErrorInvite() {
    ...
    return (0, r.jsxs)(g.ZP, {
      ...
      }), (null == (t = this.state.error) ? void 0 : t.code) === L.evJ.INVALID_CANNOT_FRIEND_SELF ? this.renderButton(B.intl.string(B.t.fIv16O)) : this.renderButton(B.intl.string(B.t.ohMvm5), this.handleAccept)]
    })
  }
  renderExpiredInvite() {
  ...
  renderAuthenicatedFooter() {
    ...
    return (null != e.stage_instance || null != e.guild_scheduled_event) && null != e.guild ? (0, r.jsx)(g.ZP, {
  ...
  renderAuthenticatedOrDownload() {
    let {
      invite: e
    } = this.props, t = null != e.stage_instance ? B.intl.string(B.t["5UKyUl"]) : B.intl.string(B.t.ohMvm5);
    return (0, r.jsxs)("div", {
  ...
  renderContinue() {
    return (0, r.jsxs)(g.ZP, {
      children: [(0, r.jsx)(g.Dx, {
        children: B.intl.string(B.t.fOc4go)
  ...
  render() {
    ...
    switch (e.state) {
      ...
      case L.r2o.RESOLVING:
        return D.a ? this.renderSpinner(B.intl.string(B.t.MKDeyM)) : this.renderSpinner(B.intl.string(B.t["Z+hCVV"]));
...
let K = c.ZP.connectStores([S.Z, j.Z, N.default, x.Z, p.Z], e => {
  var t;
  let {
    inviteKey: n
  } = e;
