...
function g(e) {
  ...
  return <_.Z><c.Z currentWindow={E} iconClassName={o()(n, p.controlIcon)} sliderClassName={i} className={t} value={(0, d.P)(y)} muted={O} maxValue={f.isPlatformEmbedded ? 200 : 100} onValueChange={e => h(e, s, O, g)} onToggleMute={() => {
