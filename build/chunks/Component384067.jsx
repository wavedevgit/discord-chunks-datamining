...
let b = e => {
  ...
  let {
    ...
    handleTransition: h,
    tab: _
  } = e, v = null == (t = u.Z.getCategoryByStoreListingId(b.categoryStoreListingId)) ? true : t.skuId, O = l.useRef(null), C = l.useRef(null), [E, y] = l.useState();
  l.useEffect(() => {
    let e = C.current;
    if (null == e) return;
    let t = () => {
