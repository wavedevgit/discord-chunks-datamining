...
function d(t, e, d) {
  ...
  } = (0, o.XJ)(null != d ? d : e), b = (0, r.e7)([c.ZP], () => c.ZP.getGuildScheduledEvent(t), [t]), p = f(b), v = null != (0, a.qY)(null != (g = null == d ? void 0 : d.id) ? g : u.lds), h = null != b && (0, c.xt)(b);
  return !p || h || v ? null : (0, l.jsx)(i.sNh, {
    ...
    action: function() {
      null != b && (0, i.ZDy)(async () => {
        let {
          default: t
        } = await Promise.all([n.e("84722"), n.e("49757")]).then(n.bind(n, 296864));
        return e => {
          var n, r;
