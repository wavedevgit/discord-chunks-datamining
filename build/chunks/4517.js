...
function J(e) {
  ...
  } = (0, T.KZ)(), [c, f] = i.useState(!1), [_, p] = i.useState(!1), g = i.useRef(null), E = i.useRef(!1), b = (0, m.Z)({
...
let $ = i.forwardRef(function(e, t) {
  ...
  let {
    ...
    location: "UserProfileCustomStatusBubble"
  }), w = null != d ? F : 0, L = null != I && P ? z : 0, k = Z + w + L, j = H + w + L, U = i.useRef(null), G = i.useRef(null), B = i.useRef(null), V = i.useRef(k), Q = i.useRef(j), X = null != d && null == p && null == I, [J, $] = i.useState(!1), [ee, et] = i.useState(!0), [en, er] = i.useState(!X && S), ei = S && J;
  i.useLayoutEffect(() => {
  ...
  let ec = e => {
    ...
    eu = null != I && P ? (0, r.jsx)(y.Z, {
      label: I,
      className: M.labelRow
    }) : null,
    ed = null != d ? (0, r.jsx)(_.Z, {
      emoji: d,
      animate: h,
      hideTooltip: !1,
      tooltipDelay: D.vB,
    ...
    ef = null != p ? (0, r.jsx)(u.Text, {
      variant: "text-sm/normal",
      className: M.statusText,
      children: p
    }) : null,
    e_ = void 0 === O || null != d && R ? null : (0, r.jsx)(u.Text, {
      variant: "text-sm/normal",
      color: "text-muted",
...
function ee(e) {
  var {
    ...
    text: n,
    onCloseProfile: a
  } = e, o = B(e, ["emoji", "text", "onCloseProfile"]);
  let [s, l] = i.useState(!1);
  return (0, r.jsx)($, G(j({}, o), {
    emoji: t,
    text: n,
    className: M.editable,
    onShowToolbar: l,
    renderToolbar: e => (0, r.jsx)(w.Z, {
      isVisible: s,
      isExpandable: e,
      onCloseProfile: a
    })
...
function et(e) {
  var {
    ...
    channelId: s,
    themeType: l
  } = e, c = B(e, ["emoji", "text", "user", "guildId", "channelId", "themeType"]);
  let {
    ...
    interactionSource: f,
    resetInteraction: _
  } = (0, N.Xo)(), p = f === D.n_.STATUS && d === D.P.REACT, h = f === D.n_.STATUS && d === D.P.REPLY, m = p || h, g = i.useRef(null), E = i.useRef(t), b = i.useRef(n);
  i.useEffect(() => {
    f === D.n_.STATUS && ((E.current !== t || b.current !== n) && _(), E.current = t, b.current = n)
  }, [f, _, t, n]);
  let [y, v] = i.useState(!1), I = i.useCallback(e => {
    (e || !m) && v(e)
  }, [m]), S = () => {
    if (null == t) return n;
