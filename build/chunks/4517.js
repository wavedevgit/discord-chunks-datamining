...
function ee(e) {
  ...
  let O = function() {
    ...
    S = () => {
      E.current || (p(!0), f(!1)), b.current = setTimeout(() => {
        p(!1)
      }, Q)
    },
...
let et = i.forwardRef(function(e, t) {
  ...
  }), P = null != d ? Z : 0, R = null != v ? q : 0, w = H + P + R, D = Y + P + R, x = i.useRef(null), j = i.useRef(null), U = i.useRef(null), G = i.useRef(w), B = i.useRef(D), F = null != d && null == p && null == v, [V, Q] = i.useState(!1), [J, $] = i.useState(!0), [ee, et] = i.useState(!F && I), en = I && V, er = (0, l.e7)([f.Z], () => f.Z.useReducedMotion), [ei] = i.useState(() => new c.V7);
  ...
  let es = e => {
    ...
    el = null != v ? (0, r.jsx)(O.Z, {
      label: v,
      className: M.labelRow
    }) : null,
    ec = null != d ? (0, r.jsx)(_.Z, {
      emoji: d,
      animate: h,
      hideTooltip: !1,
      tooltipDelay: L.vB,
    ...
    ed = void 0 === y || null != d && N ? null : (0, r.jsx)(u.Text, {
      variant: "text-sm/normal",
      color: "text-muted",
...
function er(e) {
  ...
  let {
    ...
    interactionSource: _,
    resetInteraction: p
  } = (0, C.Xo)(), h = _ === L.n_.STATUS && f === L.P.REACT, m = _ === L.n_.STATUS && f === L.P.REPLY, g = h || m, E = i.useRef(null), y = i.useRef(t), O = i.useRef(n);
  i.useEffect(() => {
    _ === L.n_.STATUS && ((y.current !== t || O.current !== n) && p(), y.current = t, O.current = n)
  }, [_, p, t, n]);
  let [v, S] = i.useState(!1), T = i.useCallback(e => {
    (e || !g) && S(e)
