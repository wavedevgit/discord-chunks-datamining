...
function W(e) {
  ...
  }, f = null != o ? o.label() : R.NW.string(R.t.evw0o6), _ = (0, r.jsxs)("div", {
...
let K = i.forwardRef(function(e, t) {
  ...
  }), L = null != _ ? j : 0, x = null != S ? Z : 0, M = U + L + x, k = G + L + x, W = i.useRef(null), K = i.useRef(null), z = i.useRef(null), q = i.useRef(M), Q = i.useRef(k), X = null != _ && null == p, [J, $] = i.useState(!1), [ee, et] = i.useState(!0), [en, er] = i.useState(!X && T), ei = !X && T && J;
  i.useLayoutEffect(() => {
  ...
  let [es, el] = (0, u.q_F)(() => ({
    ...
    label: S
  }) : null, ed = null != _ ? (0, r.jsx)(f.Z, {
    emoji: _,
    animate: g,
    hideTooltip: !1,
    tooltipDelay: C.vB,
    className: P.statusEmoji
  }) : null, ef = null != p ? (0, r.jsx)(u.Text, {
    variant: "text-sm/normal",
    className: P.statusText,
    children: p
  }) : null, e_ = void 0 === O || null != _ && D ? null : (0, r.jsx)(u.Text, {
    variant: "text-sm/normal",
    color: "text-muted",
...
function z(e) {
  var {
    ...
    text: n,
    onCloseProfile: o
  } = e, a = M(e, ["emoji", "text", "onCloseProfile"]);
  let [s, l] = i.useState(!1);
  return (0, r.jsx)(K, x(D({}, a), {
    emoji: t,
    text: n,
...
function q(e) {
  var {
    ...
    channelId: s,
    profileType: l
  } = e, c = M(e, ["emoji", "text", "user", "guildId", "channelId", "profileType"]);
  let {
    ...
    interactionSource: f,
    resetInteraction: _
  } = (0, I.Xo)(), p = f === C.n_.STATUS && d === C.P.REACT, h = f === C.n_.STATUS && d === C.P.REPLY, m = p || h, g = i.useRef(null), E = i.useRef(t), y = i.useRef(n);
  i.useEffect(() => {
    f === C.n_.STATUS && ((E.current !== t || y.current !== n) && _(), E.current = t, y.current = n)
  }, [f, _, t, n]);
  let [O, A] = i.useState(!1), R = i.useCallback(e => {
    (e || !m) && A(e)
  }, [m]), w = () => {
    if (null == t) return n;
...
function Q(e) {
  ...
  let T = null != (t = null == m ? void 0 : m.emoji) ? t : null,
    ...
    A = null != N && "" !== N ? N : null;
  return null != T || null != A || v ? null == T && null == A ? (0, r.jsx)(p.Gt, {
    value: E,
