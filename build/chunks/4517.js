...
let q = i.forwardRef(function(e, t) {
    ...
    }, d = null != a ? a.label() : P.intl.string(P.t.evw0o6), f = (0, r.jsxs)("div", {
      className: w.content,
  ...
  X = i.forwardRef(function(e, t) {
    ...
    i.useEffect(() => () => eu.stop(), [eu]), i.useEffect(() => {
    ...
    i.useLayoutEffect(() => {
      ...
      es(t > e), J.current = e, $.current = t, ef({
        maxHeight: "".concat(Math.min(ei ? J.current : $.current, ei ? M : j), "px")
      })
    }, [el, p, _, I, ef, ei, M, j]);
    let e_ = e => {
        eo && (e ? ef({
      ...
      em = null != p ? (0, r.jsx)(u.Text, {
        variant: "text-sm/normal",
        className: w.statusText,
        children: p
      }) : null,
      eg = void 0 === O || null != _ && C ? null : (0, r.jsx)(u.Text, {
        variant: "text-sm/normal",
        color: "text-muted",
  ...
  Q = i.forwardRef(function(e, t) {
    var {
      ...
      label: o,
      onCloseProfile: s
    } = e, l = M(e, ["emoji", "text", "label", "onCloseProfile"]);
    let [c, u] = i.useState(!1);
    return (0, r.jsx)(X, k(L({}, l), {
      ref: t,
      emoji: n,
      text: a,
      label: o,
...
let $ = i.forwardRef(function(e, t) {
  ...
  let {
    ...
    prompt: h,
    disableToolbar: g = !1
  } = e, b = M(e, ["location", "user", "onCloseProfile", "previewText", "previewEmoji", "previewLabel", "placeholderText", "prompt", "disableToolbar"]), y = (0, E.Z)(o.id), {
