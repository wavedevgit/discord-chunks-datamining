...
let B = i.forwardRef(function(e, t) {
  ...
  V = i.forwardRef(function(e, t) {
    ...
    i.useEffect(() => () => et.stop(), [et]), i.useEffect(() => {
    ...
    i.useLayoutEffect(() => {
      ...
      J(t > e), Z.current = e, H.current = t, er({
        maxHeight: "".concat(Math.min(q ? Z.current : H.current, q ? j : U), "px")
      })
    }, [$, p, _, I, er, q, j, U]);
    let ei = e => {
        Q && (e ? er({
      ...
      es = null != p ? (0, r.jsx)(u.Text, {
        variant: "text-sm/normal",
        className: D.statusText,
        children: p
      }) : null,
      el = void 0 === O || null != _ && C ? null : (0, r.jsx)(u.Text, {
        variant: "text-sm/normal",
        color: "text-muted",
