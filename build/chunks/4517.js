...
let B = i.forwardRef(function(e, t) {
  ...
  Z = i.forwardRef(function(e, t) {
    ...
    i.useLayoutEffect(() => {
      ...
      J(t > e), H.current = e, Y.current = t, ei({
        maxHeight: "".concat(Math.min($ ? H.current : Y.current, $ ? U : B), "px")
      })
    }, [ee, p, _, S, ei, $, U, B]);
    let ea = e => {
        Q && (e ? ei({
      ...
      ec = void 0 === I || null != _ && L ? null : (0, r.jsx)(u.Text, {
        variant: "text-sm/normal",
        color: "text-muted",
...
function V(e) {
  ...
  let {
    ...
    interactionSource: _,
    resetInteraction: p
  } = (0, T.Xo)(), h = _ === w.n_.STATUS && f === w.P.REACT, m = _ === w.n_.STATUS && f === w.P.REPLY, E = h || m, b = i.useRef(null), O = i.useRef(t), I = i.useRef(n);
  i.useEffect(() => {
    _ === w.n_.STATUS && ((O.current !== t || I.current !== n) && p(), O.current = t, I.current = n)
  }, [_, p, t, n]);
  let [C, R] = i.useState(!1), P = i.useCallback(e => {
    (e || !E) && R(e)
...
let H = i.forwardRef(function(e, t) {
  ...
  return null != C || null != R || S ? null == C && null == R ? (0, r.jsx)(p.Gt, {
    value: v,
