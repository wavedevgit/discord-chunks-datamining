...
let ee = i.forwardRef(function(e, t) {
  ...
  let {
    ...
    isEligibleForCustomStatusLabels: R
  } = (0, m.Z)({
    location: "UserProfileCustomStatusBubble"
  }), w = null != d ? Z : 0, D = null != I && R ? q : 0, x = H + w + D, j = Y + w + D, U = i.useRef(null), G = i.useRef(null), B = i.useRef(null), F = i.useRef(x), V = i.useRef(j), X = null != d && null == p && null == I, [J, $] = i.useState(!1), [ee, et] = i.useState(!0), [en, er] = i.useState(!X && S), ei = S && J, eo = (0, l.e7)([f.Z], () => f.Z.useReducedMotion), [ea] = i.useState(() => new c.V7);
  ...
  i.useLayoutEffect(() => {
    ...
    er(t > e), F.current = e, V.current = t, el({
  ...
  let ec = e => {
    ...
    e_ = void 0 === v || null != d && P ? null : (0, r.jsx)(u.Text, {
      variant: "text-sm/normal",
      color: "text-muted",
...
function en(e) {
  var {
    ...
    channelId: l,
    themeType: c
  } = e, u = F(e, ["emoji", "text", "label", "user", "guildId", "channelId", "themeType"]);
  let {
  ...
  let [T, N] = i.useState(!1), D = i.useCallback(e => {
    (e || !E) && N(e)
  }, [E]), x = e => null == e ? null : null != e.id ? "`" + ":".concat(e.name, ":") + "`" : I.ZP.translateSurrogatesToInlineEmoji(e.name), k = (e, t) => null == e ? t : "".concat(e, " ").concat(t), j = () => {
    let e = x(t),
      r = null == n ? e : k(e, n);
