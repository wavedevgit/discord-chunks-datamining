...
function c(e) {
  return (0, r.e7)([o.ZP, i.Z, s.default], () => {
    ...
    let c = o.ZP.isOptInEnabled(e),
      u = null != (r = null == (t = i.Z.getGuild(e)) ? void 0 : t.features.has(l.oNc.COMMUNITY)) && r,
...
function u(e) {
  ...
  return null != e && null != t && null != n && (t.features.has(l.oNc.COMMUNITY) || n.isStaff()) && o.ZP.isOptInEnabled(e)
}
...
function d(e) {
  return (0, r.e7)([i.Z, a.Z], () => {
    ...
    let n = i.Z.getGuild(e),
      ...
      s = null != (t = null == n ? void 0 : n.features.has(l.oNc.GUILD_ONBOARDING_EVER_ENABLED)) && t;
    return null != n && r && o && !s
  })
}