...
function y(e) {
  let {
    ...
    primaryColor: i,
    secondaryColor: p
  } = e, [h, y] = (0, s.Wu)([c.Z], () => [c.Z.desaturateUserColors, c.Z.syncProfileThemeWithUserTheme]), O = (0, _.f)(t), v = y ? null == O ? void 0 : O.overlaySyncedWithUserTheme : null == O ? void 0 : O.overlay;
  return {
