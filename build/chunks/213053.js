...
function b(e) {
  let {
    ...
    primaryColor: i,
    secondaryColor: _
  } = e, [p, b] = (0, s.Wu)([c.Z], () => [c.Z.desaturateUserColors, c.Z.syncProfileThemeWithUserTheme]), y = (0, f.fq)(t), v = b ? null == y ? void 0 : y.overlaySyncedWithUserTheme : null == y ? void 0 : y.overlay;
  return {
