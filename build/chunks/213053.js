...
function y(e) {
  let {
    ...
    secondaryColor: p,
    forceUserTheme: h = !1
  } = e, [y, O] = (0, s.Wu)([c.Z], () => [c.Z.desaturateUserColors, c.Z.syncProfileThemeWithUserTheme]), v = (0, f.f)(t), I = O || h ? null == v ? void 0 : v.overlaySyncedWithUserTheme : null == v ? void 0 : v.overlay;
  return {
