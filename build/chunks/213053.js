...
function g(e) {
  let {
    ...
    primaryColor: n,
    secondaryColor: i
  } = e, [_, g] = (0, s.Wu)([c.Z], () => [c.Z.desaturateUserColors, c.Z.syncProfileThemeWithUserTheme]), E = (0, f.fq)(t), b = (0, f.wu)(t, n, g), y = (0, f.lM)(t, n), v = (0, f.e4)(t, i), O = g ? null == E ? void 0 : E.overlaySyncedWithUserTheme : null == E ? void 0 : E.overlay;
  return {
