...
function d(e) {
  ...
  return h.length > 0 || m.length > 0 || p(), <c.$ messageId={n} channelId={t} isReportFalsePositiveLoading={E} analyticsContext={a.UU.EXPLICIT_MEDIA_OBSCURED_FALSE_POSITIVE_FLOW} onConfirmPress={g} attachmentPreview={1 === h.length && 0 === m.length ? h[0] : true} embedPreview={1 === m.length && 0 === h.length ? m[0] : true} transitionState={_} onClose={p} />
}