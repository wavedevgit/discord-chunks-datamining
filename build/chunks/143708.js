...
function g(e) {
  ...
  return v ? (t = f.intl.string(f.t["F/OLvL"]), g = f.intl.string(f.t.C89OLC)) : (g = f.intl.string(f.t["YVub5+"]), b ? t = f.intl.string(f.t["57nBt7"]) : null != O && y ? (t = f.intl.formatToPlainString(f.t["9Akp1t"], {
    username: O
