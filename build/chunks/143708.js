...
function _(e) {
  ...
  return O ? (t = f.intl.string(f.t["F/OLvL"]), _ = f.intl.string(f.t.C89OLC)) : (_ = f.intl.string(f.t["YVub5+"]), b ? t = f.intl.string(f.t["57nBt7"]) : null != v && x ? (t = f.intl.formatToPlainString(f.t["9Akp1t"], {
    username: v
