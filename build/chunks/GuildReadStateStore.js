...
function W(e, t) {
  ...
  if (null == n) {
    ...
    for (let t in u) {
      ...
      if (!p && a) continue;
      let _ = !o && (!a || p) && d;
      (_ || p) && M(n, l, c) && (_ && (r.unreadByType[A.P.CHANNEL] = true, r.unreadChannelId = t), p && (f ? r.lowImportanceMentionCount += l : r.highImportanceMentionCount += l, r.mentionCounts[n.id] = {
        count: l,
        isMentionLowImportance: f
      }))
    }
