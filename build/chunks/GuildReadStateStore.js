...
function F(e, t, n) {
  ...
  }), (t.unread !== n.unread || t.lowImportanceMentionCount !== n.lowImportanceMentionCount || t.highImportanceMentionCount !== n.highImportanceMentionCount) && (C[null != e ? e : A] = t, null != e && (t.unread ? N.add(e) : N.delete(e)), P++, D(null != e ? e : A), B(t, n), true)
}
...
function Y(e, t) {
  ...
  if (null == n) {
    ...
    for (let t in d)
      for (let n in d[t]) {
        !r.unreadByType[S.W.CHANNEL] && g.ZP.hasUnread(n) && !l.Z.isMuted(n) && !e && (r.unreadByType[S.W.CHANNEL] = true, r.unreadChannelId = n);
  ...
  Z(r);
  let i = w(n);
  return (r.unread !== i.unread || r.highImportanceMentionCount !== i.highImportanceMentionCount || r.lowImportanceMentionCount !== i.lowImportanceMentionCount) && (C[null != n ? n : A] = r, null != n && (r.unread ? N.add(n) : N.delete(n)), P++, D(null != n ? n : A), B(r, i), true)
}
  ...
  for (let e of (r && n.entries.forEach(e => {
      if (null != e.mention_count && e.mention_count > 0)
        if (null == e.read_state_type || e.read_state_type === S.W.CHANNEL) {
          var t;
          i.add(null == (t = p.Z.getChannel(e.id)) ? true : t.guild_id)
        } else i.add(e.id)
...
function ea(e) {
  ...
  return i()(t).map(e => {
    ...
    var t;
    return null == (t = p.Z.getChannel(e)) ? true : t.getGuildId()
