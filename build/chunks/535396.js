...
let c = "1340102344645283891",
  ...
  v = () => ({
    ...
    [o.oNc.AUDIO_BITRATE_128_KBPS]: {
      perkIcon: i.Ro.AUDIO,
      description: s.intl.formatToPlainString(s.t.zoT1ZG, {
        bitrate: a.HO[o.Eu4.TIER_1].limits.bitrate / 1e3
      })
    },
    [o.oNc.INVITE_SPLASH]: {
    ...
    [o.oNc.AUDIO_BITRATE_256_KBPS]: {
      perkIcon: i.Ro.AUDIO,
      description: s.intl.formatToPlainString(s.t.zoT1ZG, {
        bitrate: a.HO[o.Eu4.TIER_2].limits.bitrate / 1e3
      })
    },
    [o.oNc.ROLE_ICONS]: {
    ...
    [o.oNc.MAX_FILE_SIZE_50_MB]: {
      ...
      description: s.intl.formatToPlainString(s.t["aFRl5+"], {
        uploadSizeLimit: s.intl.string(s.t.M6qV8v)
      })
    },
    [o.oNc.BANNER]: {
      perkIcon: i.Ro.CUSTOMIZATION,
    ...
    [o.oNc.AUDIO_BITRATE_384_KBPS]: {
      perkIcon: i.Ro.AUDIO,
      description: s.intl.formatToPlainString(s.t.zoT1ZG, {
        bitrate: a.HO[o.Eu4.TIER_3].limits.bitrate / 1e3
      })
    },
    [o.oNc.VANITY_URL]: {
    ...
    [o.oNc.MAX_FILE_SIZE_100_MB]: {
      perkIcon: i.Ro.UPLOAD,
      description: s.intl.formatToPlainString(s.t["aFRl5+"], {
        uploadSizeLimit: s.intl.string(s.t.yMOW8P)
      })
    }
  })