...
function C(e) {
  ...
  return null == n ? null : <u.f src={n.getIconURL(E.Si.LARGE)} size={40} />
}
...
function N(e, t) {
  ...
  for (let r of t) switch (r.type) {
    ...
    case O.nc.CONTENT_INVENTORY:
      (0, h.Rb)("welcomeNotification").allowActivityWidget && (E.renderFooter = () => <m.lX gamingId={null == e ? true : e.id} maxUserShowCount={5} className={S.container} />, E.onNotificationShow = () => {
  ...
  let N = (0, d.zu)(r.z.OVERLAY_OOP_WELCOME_NUX),
    ...
    P = null != e ? <C game={e} /> : <img src={n(328756)} className={x.icon} alt={""} />;
  return j(I({
    icon: P,
    title: w,
    body: Z,
