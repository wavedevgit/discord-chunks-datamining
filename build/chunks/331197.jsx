...
function P(e) {
  ...
  let J = i.useRef(null);
  return <l.y targetElementRef={J} shouldShow={Y && (A === v.D.SOUNDBOARD || null == A) || A === v.D.SOUNDBOARD} animation={l.y.Animation.FADE} animationPosition={"top"} position={"top"} align={"center"} spacing={16} onRequestClose={() => {
