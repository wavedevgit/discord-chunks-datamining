...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk262317 = require("./262317.js"),
  Chunk981631 = require("./981631.js"),
  Chunk524484 = require("./524484.js"),
  Chunk50259 = require("./50259.js");
...
let Z = Chunk73800.memo(e => {
  ...
  return <E.Z shakeLocation={M.oZ.VOICE_USER} isShaking={H}><L.ZP{...B(U({}, e), {
      nick: null != A ? A : ee,
      canDrag: e.canDrag && !Y,
      disconnected: ea,
...
let F = 50,
  ...
  Y = function(e) {
    let {
      ...
      let e = u && P.length > d + 1 ? P.slice(0, d) : P,
        ...
        i = e.map(e => {
          ...
          return <Z user={a} nick={s} isSelfOnOtherClient={I.default.getId() === a.id && l.sessionId !== I.default.getSessionId()} mute={l.isVoiceMuted()} deaf={l.isVoiceDeafened()} video={l.selfVideo} serverMute={l.mute} serverDeaf={l.deaf} sessionId={null != (i = l.sessionId) ? i : ""} channel={o} collapsed={u} canDrag={n && A.Z.can(x.Plq.MOVE_MEMBERS, o)} showPreview={M} hidePreview={j} previewIsOpen={S} shouldShowHoverPopout={v === a.id} tabIndex={p} location={h} />
        });
      return null != m && m > 0 ? i.push(<L.ul collapsed={u} numAudience={m} />) : u && P.length > d + 1 && i.push(<L.XX numUsers={P.length - d} />), i
    }, G = (0, s.Wu)([N.Z], () => {
      if (u) return [];
      let e = new Set;
    ...
    (0, f.Z)(G);
    let B = U();
    return null == B && null == b ? null : <O.eJ className={a()(E, k.list, {
        [k.collapsed]: u,
        [k.withGuildIcon]: g
      })} collapsed={u}>{B}{b}</O.eJ>
  }