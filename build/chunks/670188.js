...
let O = (0, a.pxk)(a.EFr.SIZE_80),
  ...
  T = i.memo(function(e) {
    ...
    let z = i.useCallback(() => null == M || null == x ? Promise.resolve() : null != T ? T() : (0, d.Z)(M.id, null != v ? v : M.getAvatarURL(m, O), {
      ...
      q = i.useCallback(e => null == M ? null : (null == H.current && (H.current = Date.now()), U) ? (0, r.jsx)(a.xxz, {}) : null != N ? N(e) : (0, r.jsx)(f.Z, b(g({}, L, e), {
        userId: M.id,
        user: M,
        guildId: m,
        channelId: E,
      ...
      X = i.useCallback(() => {
        K(), B.current = !1, Z.current = setTimeout(() => {
          B.current || (H.current = void 0, j(!1))
        }, _.Ig)
      }, [K]);
    return null == M || null == x ? t(I, S) : D ? (0, r.jsx)("div", {
