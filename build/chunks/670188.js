...
function T(e) {
  ...
  let R = i.useRef(void 0),
    w = i.useCallback(() => null != O ? O() : (0, d.Z)(n.id, null != E ? E : n.getAvatarURL(s, v), {
      type: "popout",
...
function A(e) {
  ...
  (0, s.zq)(Y);
  let W = i.useCallback(() => null != A ? A() : (0, d.Z)(n.id, null != T ? T : n.getAvatarURL(c, v), {
      type: "popout",
      withMutualGuilds: n.id !== a.id,
      withMutualFriends: !n.bot && n.id !== a.id,
      guildId: c,
    ...
    K = i.useCallback(e => (null == x.current && (x.current = Date.now()), j) ? (0, r.jsx)(o.xxz, {}) : null != N ? N(e, x.current) : (0, r.jsx)(f.Z, b(g({}, e), {
      user: n,
      currentUser: a,
      guildId: c,
      channelId: p,
