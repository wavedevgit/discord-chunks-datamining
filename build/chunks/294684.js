...
if (Chunk477732(eE, {
    ...
    URLSearchParams: eg
  }), !Chunk394227 && Chunk880181(V)) {
  var eb = Chunk46015(Z.has),
    ey = Chunk46015(Z.set),
    eO = function(e) {
      if (I(e)) {
        var t, n = e.body;
        if (O(n) === x) return eb(t = e.headers ? new V(e.headers) : new V, "content-type") || ey(t, "content-type", "application/x-www-form-urlencoded;charset=UTF-8"), S(e, {
          body: A(0, T(n)),
          headers: A(0, t)
        })
      }
