...
if (_(eE, {
  ...
  var eb = l(Z.has),
    ...
    eO = function(e) {
      if (I(e)) {
        var t, n = e.body;
        if (O(n) === x) return eb(t = e.headers ? new V(e.headers) : new V, "content-type") || ey(t, "content-type", "application/x-www-form-urlencoded;charset=UTF-8"), T(e, {
          body: A(0, S(n)),
          headers: A(0, t)
        })
      }
  ...
  if (E(G) && r({
    ...
    F.constructor = ev, ev.prototype = F, r({
      global: !0,
      constructor: !0,
      dontCallGetSet: !0,
      forced: !0
