...
if (Chunk477732(eE, {
    ...
    delete: function(e) {
      for (var t = j(this), n = P(arguments.length, 1), r = t.entries, i = S(e), a = n < 2 ? true : arguments[1], o = true === a ? a : S(a), s = 0; s < r.length;) {
        var l = r[s];
    ...
    has: function(e) {
      for (var t = j(this).entries, n = P(arguments.length, 1), r = S(e), i = n < 2 ? true : arguments[1], a = true === i ? i : S(i), o = 0; o < t.length;) {
        var s = t[o++];
  ...
  var eb = Chunk46015(V.has),
    ...
    eO = function(e) {
      if (I(e)) {
        var t, n = e.body;
        if (O(n) === x) return eb(t = e.headers ? new Z(e.headers) : new Z, "content-type") || ey(t, "content-type", "application/x-www-form-urlencoded;charset=UTF-8"), T(e, {
          body: A(0, S(n)),
          headers: A(0, t)
        })
      }
