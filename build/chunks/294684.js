...
if (_(eE, {
  ...
  var eb = l(Z.has),
    ...
    eO = function(e) {
      if (I(e)) {
        var t, n = e.body;
        if (O(n) === x) return eb(t = e.headers ? new F(e.headers) : new F, "content-type") || ey(t, "content-type", "application/x-www-form-urlencoded;charset=UTF-8"), S(e, {
          body: A(0, T(n)),
          headers: A(0, t)
        })
      }
  ...
  if (E(G) && r({
    ...
    V.constructor = ev, ev.prototype = V, r({
      global: !0,
      constructor: !0,
      dontCallGetSet: !0,
      forced: !0
