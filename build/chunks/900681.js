...
function _(e) {
  let {
    ...
    primaryColor: n
  } = e, s = t.filter(e => e !== b.U6).join(", "), a = (0, l.dQu)(l.TVs.colors.BACKGROUND_FLOATING), o = (0, u.pX)(n, a.hex()), c = i.useRef(null), [d, m] = i.useState(!1);
  if (i.useEffect(() => {
      let e = c.current;
...
function O(e) {
  let {
    ...
    text: e,
    selected: o.has(e)
  }, e), [o]), d = i.useCallback(e => (0, r.jsx)(l.te1, {
    items: e,
    renderItem: c,
    onTooltipShow: s
  }), [c, s]);
...
function I(e) {
  ...
  let {
    ...
    bannerHash: G,
    gameActivity: U
  } = n, B = (0, o.Z)(n.games), [F, z] = i.useState(!1), H = i.useRef(null), [V, Y] = i.useState(!1), K = i.useCallback(() => {
    z(!0)
  }, []), q = i.useCallback(() => {
    z(!1)
