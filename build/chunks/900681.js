...
function b(e) {
  let {
    ...
    primaryColor: i
  } = e, l = t.filter(e => e !== v.U6).join(", "), a = (0, s.dQu)(s.TVs.colors.BACKGROUND_FLOATING), o = (0, d.pX)(i, a.hex()), c = r.useRef(null), [u, m] = r.useState(!1);
  if (r.useEffect(() => {
      let e = c.current;
      null != e && null != e.offsetWidth && null != e.scrollWidth && m(e.offsetWidth < e.scrollWidth)
    }, []), 0 === l.length) return null;
  let f = null != o ? {
    color: o.css()
  } : void 0;
...
function N(e) {
  ...
  return null == t ? null : i ? (0, n.jsx)("div", {
...
function y(e) {
  let {
    ...
    traitsToHighlight: i,
    onInteraction: l
  } = e, o = r.useMemo(() => null == i ? new Set : new Set(i), [i]), c = r.useCallback(e => (0, n.jsx)(h.Z, {
    className: a()(I.thinTrait, {
      [I.selectedTrait]: o.has(e)
    }),
    text: e,
    selected: o.has(e)
  }, e), [o]), u = r.useCallback(e => (0, n.jsx)(s.te1, {
    items: e,
    renderItem: c,
    onTooltipShow: l
  }), [c, l]);
...
function T(e) {
  ...
  let {
    ...
    bannerHash: B,
    gameActivity: U
  } = i, Z = (0, o.Z)(i.games), [k, W] = r.useState(!1), H = r.useRef(null), [Y, z] = r.useState(!1), J = r.useCallback(() => {
    W(!0)
  }, []), q = r.useCallback(() => {
    W(!1)
  }, []), K = E.NW.formatToPlainString(E.t["0WHArK"], {
    count: i.memberCount
  }), Q = null != P ? P : (0, m.pY)(i.id, B), X = null == l && null == Q ? {
    background: "linear-gradient(90deg, ".concat(V, ", ").concat(M, ")")
  } : void 0, $ = null != l ? l : null != Q ? (0, n.jsx)("img", {
    alt: E.NW.string(E.t.nH6S2d),
    src: Q,
    className: I.bannerImage
  }) : null, ee = r.useMemo(() => (0, v.HR)(i.traits, T), [i.traits, T]);
  r.useEffect(() => {
    let e = H.current;
