...
function b(e) {
  let {
    ...
    primaryColor: n
  } = e, l = t.filter(e => e !== E.U6).join(", "), a = (0, s.dQu)(s.TVs.colors.BACKGROUND_FLOATING), o = (0, d.pX)(n, a.hex()), c = r.useRef(null), [u, m] = r.useState(!1);
  if (r.useEffect(() => {
      let e = c.current;
...
function y(e) {
  let {
    ...
    traitsToHighlight: n,
    onInteraction: l
  } = e, o = r.useMemo(() => null == n ? new Set : new Set(n), [n]), c = r.useCallback(e => (0, i.jsx)(h.Z, {
    className: a()(p.thinTrait, {
      [p.selectedTrait]: o.has(e)
    }),
    text: e,
    selected: o.has(e)
  }, e), [o]), u = r.useCallback(e => (0, i.jsx)(s.te1, {
    items: e,
    renderItem: c,
    onTooltipShow: l
  }), [c, l]);
...
function T(e) {
  ...
  let {
    ...
    bannerHash: B,
    gameActivity: U
  } = n, Z = (0, o.Z)(n.games), [k, W] = r.useState(!1), H = r.useRef(null), [Y, z] = r.useState(!1), J = r.useCallback(() => {
    W(!0)
  }, []), q = r.useCallback(() => {
    W(!1)
  }, []), K = I.NW.formatToPlainString(I.t["0WHArK"], {
    count: n.memberCount
  }), Q = null != P ? P : (0, m.pY)(n.id, B), X = null == l && null == Q ? {
    background: "linear-gradient(90deg, ".concat(V, ", ").concat(M, ")")
  } : void 0, $ = null != l ? l : null != Q ? (0, i.jsx)("img", {
    alt: I.NW.string(I.t.nH6S2d),
    src: Q,
    className: p.bannerImage
  }) : null, ee = r.useMemo(() => (0, E.HR)(n.traits, T), [n.traits, T]);
  r.useEffect(() => {
    let e = H.current;
