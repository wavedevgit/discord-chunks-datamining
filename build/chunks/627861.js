...
function e_(e) {
  ...
  }, [g]), S = (0, V.dQ)(c.name, null == (t = f.activity) ? void 0 : t.type);
  if (O) {
...
function ep(e, t) {
  return {
    ...
    isGameLaunchable: (0, s.e7)([L.Z, T.Z, U.Z, R.Z], () => (0, F.t)({
...
function em(e) {
  ...
  let {
    ...
    videoBannerSrc: U,
    bannerAspectRatio: B
  } = (0, m.E)(I), Z = !(0, K.Z)(P, C, I.id), F = ea(C), H = (0, s.e7)([D.Z], () => D.Z.getGameByName(I.name), [I.name]), {
    openGameProfileModal: Y,
    isGameLaunchable: q
  } = ep(I.id, C.author.id), {
    openGameProfileModal: X,
    isGameLaunchable: Q
  } = ep(null == H ? void 0 : H.id, C.author.id), ee = (0, $.Z)({
    application: I,
    ...
    isGameLaunchable: q
  }), eo = ef(P, A, C, I), es = eu(A, P), el = ec(P, C, I, S), e_ = i.useMemo(() => ei ? {
  ...
  } : null != er ? er : void 0, [O, ei, el, eo, T.id, T.guild_id, S, es, C.author.id, C.id, P, er]), em = i.useMemo(() => q ? {
  ...
  } : null != er ? er : void 0, [I.id, q, Q, null == H ? void 0 : H.id, er]), eg = (0, g.G)(I), eE = i.useMemo(() => null != Y ? Y : null != X ? X : null != eg && x ? eg : void 0, [x, Y, X, eg]), eb = i.useMemo(() => {
    let e = [];
    return Z || null == e_ ? Z && null != em && e.push(em) : e.push(e_), e
  }, [em, Z, e_]), ey = (0, V.dQ)(I.name, null == (t = C.activity) ? void 0 : t.type), eO = (0, v.N)(I.id).some(e => (0, b.ig)(e) === a.o.GLOBAL) ? (0, r.jsxs)(r.Fragment, {
...
function eg(e) {
  ...
  let {
    ...
    hideParty: u,
    onView: d
  } = e, f = (0, h.O)(o), _ = (0, s.e7)([w.default], () => w.default.getId()), p = (0, s.e7)([k.Z], () => {
  ...
  }), [g]), O = (0, ee.Ps)(null == p || null == (t = p.party) ? void 0 : t.id) || f.id === C.r9.id, v = (0, r.jsx)(ei, {
    partyMembers: y,
    partySize: E,
    maxPartySize: b,
    guildId: l.guild_id,
