...
function eo(e) {
  ...
  let {
    ...
    presenceActivity: _
  } = e, y = el(u, _), x = (0, C.Lz)(_, p.author, "Invite Embed"), E = !(0, K.Z)(_, p, c.id), v = i.useMemo(() => {
    let e = [];
    if (!y) {
      var t;
      e.push({
  ...
  }, [y, _, x]), O = ea(c.name, null == (t = p.activity) ? void 0 : t.type);
  if (E) {
...
function es(e, t) {
  return {
    ...
    isGameLaunchable: (0, a.e7)([w.Z, O.Z, D.Z, T.Z], () => (0, B.t)({
...
function ec(e, t, n, r, i) {
  if (e.author.id === r) {
    if (n.isPrivate()) {
      ...
      if (null != e) return i ? J.intl.formatToPlainString(J.t.JddpNz, {
    ...
    return i ? J.intl.formatToPlainString(J.t["2N1kNT"], {
      appName: t.name
    }) : J.intl.formatToPlainString(J.t.IA6uDQ, {
      appName: t.name
    })
  }
  return i ? J.intl.formatToPlainString(J.t.XE8axM, {
...
function eu(e) {
  ...
  let {
    ...
    videoBannerSrc: D,
    bannerAspectRatio: B
  } = (0, g.E)(O), V = (0, G.GK)(O), X = (0, z.Z)(), Q = !(0, K.Z)(w, N, O.id), ee = et(N), eo = (0, a.e7)([A.Z], () => A.Z.getGameByName(O.name), [O.name]), {
    openGameProfileModal: eu,
    isGameLaunchable: ed
  } = es(O.id, N.author.id), {
    openGameProfileModal: ep,
    isGameLaunchable: em
  } = es(null == eo ? void 0 : eo.id, N.author.id), ef = function(e) {
    let {
      presenceActivity: t,
    ...
    isGameLaunchable: ed
  }), eh = !(null == w || !(0, K.Z)(w, N, O.id) || !(0, W.Z)(w, q.xjy.SYNC) || !F.isPlatformEmbedded || el(S, w)), eg = el(S, w), e_ = function(e, t, n, r) {
    var i;
    if (t.author.id === r || !(0, K.Z)(e, t, n.id) || (null == (i = t.activity) ? void 0 : i.type) !== q.mFx.JOIN_REQUEST || !(0, W.Z)(e, q.xjy.JOIN)) return !1;
    let l = en(e);
    return !(!ei(l) || er(l))
  }(w, N, O, C), eb = i.useMemo(() => ef ? {
  ...
  } : void 0, [v, ef, e_, eh, j.id, j.guild_id, C, eg, N.author.id, N.id, w]), ey = i.useMemo(() => Z && V ? {
  ...
  } : void 0, [v, V, O.id, j.id, X, Z, ed, em, null == eo ? void 0 : eo.id]), ex = (0, _.z)(O), eE = i.useMemo(() => null != ex ? ex : null != eu ? {
    label: J.intl.string(J.t["HO/oXl"]),
    trackingArea: f.j_.VIEW,
    onClick: e => {
      eu(e)
  ...
  } : void 0, [ex, eu, ep]), ev = i.useMemo(() => {
    let e = [];
    return Q || null == eb ? Q && null != ey && e.push(ey) : e.push(eb), null != eE && e.push(eE), e
  }, [ey, Q, eb, eE]), eO = ea(O.name, null == (t = N.activity) ? void 0 : t.type), ej = Z ? (0, p.H)({
    applicationId: O.id,
    referrerId: C
  }) : void 0;
