...
function es(e) {
  ...
  let {
    ...
    presenceActivity: _
  } = e, b = eo(u, _), E = (0, S.Lz)(_, p.author, "Invite Embed"), C = !(0, Y.Z)(_, p, c.id), v = i.useMemo(() => {
    let e = [];
    if (!b) {
      var t;
      e.push({
  ...
  }, [_]), O = (0, V.dQ)(c.name, null == (t = p.activity) ? void 0 : t.type);
  if (C) {
    ...
    let e = null != _ && null != _.details && null != _.state ? et.intl.formatToPlainString(et.t.JCvHt7, {
        track: _.details,
        artist: _.state
      }) : c.name,
...
function ed(e) {
  ...
  let {
    ...
    bot: null
  }, eg = i.useMemo(() => G && null != ep && null != ef && null != em && (0, m.ye)(em) ? {
  ...
  } : null, [v, G, em, ep, ef]), eh = function(e) {
    let {
      presenceActivity: t,
    ...
    isGameLaunchable: ee
  }), e_ = !(null == Z || !(0, Y.Z)(Z, N, O.id) || !(0, K.Z)(Z, $.xjy.SYNC) || !B.isPlatformEmbedded || eo(S, Z)), eb = eo(S, Z), eE = function(e, t, n, r) {
    var i;
    if (t.author.id === r || !(0, Y.Z)(e, t, n.id) || (null == (i = t.activity) ? void 0 : i.type) !== $.mFx.JOIN_REQUEST || !(0, K.Z)(e, $.xjy.JOIN)) return !1;
    let l = (0, W._)(e);
    return !(!ea(l) || el(l))
  }(Z, N, O, I), ex = i.useMemo(() => eh ? {
  ...
  } : null != eg ? eg : void 0, [v, eh, eE, e_, j.id, j.guild_id, I, eb, N.author.id, N.id, Z, eg]), eC = i.useMemo(() => ee ? {
  ...
  } : null != eg ? eg : void 0, [O.id, ee, es, null == Q ? void 0 : Q.id, eg]), ev = (0, E.G)(O), ey = i.useMemo(() => null != J ? J : null != er ? er : null != ev && R ? ev : void 0, [R, J, er, ev]), eO = i.useMemo(() => {
    let e = [];
    return z || null == ex ? z && null != eC && e.push(eC) : e.push(ex), e
  }, [eC, z, ex]), ej = (0, V.dQ)(O.name, null == (t = N.activity) ? void 0 : t.type), eI = (0, y.N)(O.id).some(e => (0, C.ig)(e) === l.o.GLOBAL) ? (0, r.jsxs)(r.Fragment, {
...
function ep(e) {
  ...
  let {
    ...
    hideParty: u,
    onView: d
  } = e, p = (0, _.O)(a), m = (0, o.e7)([N.default], () => N.default.getId()), f = (0, o.e7)([k.Z], () => {
    ...
    partySize: b,
    maxPartySize: E
  } = (0, W._)(f), x = i.useMemo(() => h.map(e => {
    let t = D.default.getUser(e);
    return null != t ? t : Q.ag
  }), [h]), C = (0, ee.Ps)(null == f || null == (t = f.party) ? void 0 : t.id) || p.id === T.r9.id, v = (0, r.jsx)(er, {
    partyMembers: x,
    partySize: b,
    maxPartySize: E,
    guildId: s.guild_id,
