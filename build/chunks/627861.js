...
function en(e) {
  ...
  } = e, o = Math.max(n, t.length), c = (0, G.yy)({
    maxPartySize: i,
    partySize: o,
    activityActionType: a
  }), u = [...t];
...
function eo(e) {
  ...
  let {
    ...
    presenceActivity: h
  } = e, E = ea(u, h), C = (0, j.Lz)(h, p.author, "Invite Embed"), v = !(0, W.Z)(h, p, c.id), O = i.useMemo(() => {
    let e = [];
    if (!E) {
      var t;
      e.push({
  ...
  }, [h]), y = (0, G.dQ)(c.name, null == (t = p.activity) ? void 0 : t.type);
  if (v) {
    ...
    let e = null != h && null != h.details && null != h.state ? ee.intl.formatToPlainString(ee.t.JCvHt7, {
        track: h.details,
        artist: h.state
      }) : c.name,
...
function es(e, t) {
  return {
    ...
    isGameLaunchable: (0, o.e7)([w.Z, y.Z, M.Z, N.Z], () => (0, B.t)({
...
function eu(e) {
  ...
  let {
    ...
    bot: D
  } = x, L = k.ZP.getApplicationIconURL({
    id: x.id,
    icon: x.icon,
    bot: D
  }), {
    ...
    videoBannerSrc: U,
    bannerAspectRatio: B
  } = (0, _.E)(x), V = !(0, W.Z)(w, T, x.id), Y = er(T), q = (0, o.e7)([A.Z], () => A.Z.getGameByName(x.name), [x.name]), {
    ...
    isGameLaunchable: $
  }), em = !(null == w || !(0, W.Z)(w, T, x.id) || !(0, z.Z)(w, J.xjy.SYNC) || !F.isPlatformEmbedded || ea(j, w)), ef = ea(j, w), eg = function(e, t, n, r) {
    var i;
    if (t.author.id === r || !(0, W.Z)(e, t, n.id) || (null == (i = t.activity) ? void 0 : i.type) !== J.mFx.JOIN_REQUEST || !(0, z.Z)(e, J.xjy.JOIN)) return !1;
    let l = (0, H._)(e);
    return !(!el(l) || ei(l))
  }(w, T, x, I), e_ = i.useMemo(() => ep ? {
  ...
  } : null != ed ? ed : void 0, [v, ep, eg, em, y.id, y.guild_id, I, ef, T.author.id, T.id, w, ed]), eh = i.useMemo(() => $ ? {
  ...
  } : null != ed ? ed : void 0, [x.id, $, eo, null == q ? void 0 : q.id, ed]), eb = (0, h.G)(x), eE = i.useMemo(() => null != Q ? Q : null != en ? en : null != eb && R ? eb : void 0, [R, Q, en, eb]), eC = i.useMemo(() => {
    let e = [];
    return V || null == e_ ? V && null != eh && e.push(eh) : e.push(e_), e
  }, [eh, V, e_]), ev = (0, G.dQ)(x.name, null == (t = T.activity) ? void 0 : t.type), eO = (0, O.N)(x.id).some(e => (0, E.ig)(e) === l.o.GLOBAL) ? (0, r.jsxs)(r.Fragment, {
...
function ed(e) {
  ...
  let {
    ...
    hideParty: u,
    onView: d
  } = e, p = (0, g.O)(a), m = (0, o.e7)([T.default], () => T.default.getId()), f = (0, o.e7)([R.Z], () => {
  ...
  }), [h]), v = (0, $.Ps)(null == f || null == (t = f.party) ? void 0 : t.id) || p.id === S.r9.id, O = (0, r.jsx)(en, {
    partyMembers: C,
    partySize: b,
    maxPartySize: E,
    guildId: s.guild_id,
