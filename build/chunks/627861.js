...
function eu(e) {
  ...
  let {
    ...
    presenceActivity: g
  } = e, b = ec(u, g), E = (0, T.Lz)(g, p.author, "Invite Embed"), y = !(0, q.Z)(g, p, c.id), x = i.useMemo(() => {
    let e = [];
    if (!b) {
      var t;
      e.push({
...
function em(e) {
  ...
  } : null != eh ? eh : void 0, [v, eb, eC, eE, I.id, I.guild_id, S, ey, P.author.id, P.id, R, eh]), ev = i.useMemo(() => en ? {
  ...
  }, [ev, K, ex]), eS = (0, W.dQ)(j.name, null == (t = P.activity) ? void 0 : t.type), eT = k ? (0, g.H)({
    applicationId: j.id,
    referrerId: S
  }) : void 0, eN = (0, O.N)(j.id).some(e => (0, x.ig)(e) === l.o.GLOBAL) ? (0, r.jsxs)(r.Fragment, {
...
function ef(e) {
  ...
  let {
    ...
    partySize: h,
    maxPartySize: E
  } = (0, Y._)(f), y = i.useMemo(() => _.map(e => {
    let t = M.default.getUser(e);
    return null != t ? t : $.ag
  }), [_]), C = (0, en.Ps)(null == f || null == (t = f.party) ? void 0 : t.id) || p.id === N.r9.id, x = (0, r.jsx)(el, {
    partyMembers: y,
    partySize: h,
    maxPartySize: E,
    guildId: s.guild_id,
