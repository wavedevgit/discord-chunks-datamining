...
function es(e) {
  ...
  let {
    ...
    presenceActivity: h
  } = e, b = eo(u, h), E = (0, S.Lz)(h, p.author, "Invite Embed"), C = !(0, Y.Z)(h, p, c.id), v = i.useMemo(() => {
    let e = [];
    if (!b) {
      var t;
      e.push({
...
function ec(e, t) {
  return {
    ...
    isGameLaunchable: (0, o.e7)([Z.Z, j.Z, k.Z, P.Z], () => (0, G.t)({
...
function ed(e) {
  ...
  let {
  ...
  } : null, [v, G, em, ep, ef]), eg = function(e) {
    let {
      presenceActivity: t,
    ...
    isGameLaunchable: ee
  }), eh = !(null == Z || !(0, Y.Z)(Z, N, O.id) || !(0, K.Z)(Z, $.xjy.SYNC) || !B.isPlatformEmbedded || eo(S, Z)), eb = eo(S, Z), eE = function(e, t, n, r) {
    var i;
    if (t.author.id === r || !(0, Y.Z)(e, t, n.id) || (null == (i = t.activity) ? void 0 : i.type) !== $.mFx.JOIN_REQUEST || !(0, K.Z)(e, $.xjy.JOIN)) return !1;
    let l = (0, W._)(e);
    return !(!ea(l) || el(l))
  }(Z, N, O, I), ey = i.useMemo(() => eg ? {
  ...
  } : null != e_ ? e_ : void 0, [v, eg, eE, eh, j.id, j.guild_id, I, eb, N.author.id, N.id, Z, e_]), eC = i.useMemo(() => ee ? {
  ...
  } : null != e_ ? e_ : void 0, [O.id, ee, es, null == Q ? void 0 : Q.id, e_]), ev = (0, E.G)(O), ex = i.useMemo(() => null != J ? J : null != er ? er : null != ev && R ? ev : void 0, [R, J, er, ev]), eO = i.useMemo(() => {
    let e = [];
    return z || null == ey ? z && null != eC && e.push(eC) : e.push(ey), e
  }, [eC, z, ey]), ej = (0, V.dQ)(O.name, null == (t = N.activity) ? void 0 : t.type), eI = (0, x.N)(O.id).some(e => (0, C.ig)(e) === l.o.GLOBAL) ? (0, r.jsxs)(r.Fragment, {
...
function ep(e) {
  ...
  let {
    ...
    hideParty: u,
    onView: d
  } = e, p = (0, h.O)(a), m = (0, o.e7)([N.default], () => N.default.getId()), f = (0, o.e7)([D.Z], () => {
    ...
    partySize: b,
    maxPartySize: E
  } = (0, W._)(f), y = i.useMemo(() => g.map(e => {
    let t = M.default.getUser(e);
    return null != t ? t : Q.ag
  }), [g]), C = (0, ee.Ps)(null == f || null == (t = f.party) ? void 0 : t.id) || p.id === T.r9.id, v = (0, r.jsx)(er, {
    partyMembers: y,
    partySize: b,
    maxPartySize: E,
    guildId: s.guild_id,
