...
function ea(e) {
  ...
  let {
    ...
    presenceActivity: _
  } = e, E = el(u, _), x = (0, j.Lz)(_, p.author, "Invite Embed"), y = !(0, z.Z)(_, p, c.id), v = i.useMemo(() => {
    let e = [];
    if (!E) {
      var t;
      e.push({
...
function eo(e, t) {
  return {
    ...
    isGameLaunchable: (0, o.e7)([A.Z, C.Z, L.Z, T.Z], () => (0, F.t)({
...
function ec(e) {
  ...
  } : null != ec ? ec : void 0, [x, eu, em, ed, C.id, C.guild_id, O, ep, S.author.id, S.id, A, ec]), eg = i.useMemo(() => q ? {
  ...
  }, [eg, F, ef]), eE = (0, B.dQ)(v.name, null == (t = S.activity) ? void 0 : t.type), ex = (0, y.N)(v.id).some(e => (0, E.ig)(e) === l.o.GLOBAL) ? (0, r.jsxs)(r.Fragment, {
...
function eu(e) {
  ...
  }), [_]), y = (0, J.Ps)(null == f || null == (t = f.party) ? void 0 : t.id) || p.id === I.r9.id, v = (0, r.jsx)(et, {
    partyMembers: x,
    partySize: b,
    maxPartySize: E,
    guildId: s.guild_id,
