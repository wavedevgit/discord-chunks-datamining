...
function eu(e) {
  ...
  }, [_]), O = (0, W.dQ)(c.name, null == (t = p.activity) ? void 0 : t.type);
  if (y) {
    ...
    let e = null != _ && null != _.details && null != _.state ? er.intl.formatToPlainString(er.t.JCvHt7, {
        track: _.details,
        artist: _.state
      }) : c.name,
...
function em(e) {
  ...
  let {
    ...
    bot: null
  }, eh = i.useMemo(() => V && null != ef && null != eg && null != e_ && (0, m.ye)(e_) ? {
  ...
  } : null, [v, V, e_, ef, eg]), eb = function(e) {
    let {
      presenceActivity: t,
  ...
  } : null != eh ? eh : void 0, [j.id, en, eu, null == $ ? void 0 : $.id, eh]), eO = (0, y.G)(j), ej = i.useMemo(() => null != ee ? ee : null != el ? el : null != eO && L ? eO : void 0, [L, ee, el, eO]), eI = i.useMemo(() => {
    let e = [];
    return K || null == ex ? K && null != ev && e.push(ev) : e.push(ex), e
  }, [ev, K, ex]), eS = (0, W.dQ)(j.name, null == (t = P.activity) ? void 0 : t.type), eT = L ? (0, _.H)({
    applicationId: j.id,
    referrerId: S
...
function ef(e) {
  ...
  let {
    ...
    hideParty: u,
    onView: d
  } = e, p = (0, b.O)(a), m = (0, o.e7)([P.default], () => P.default.getId()), f = (0, o.e7)([D.Z], () => {
