...
function el(e) {
  ...
  } = e, o = Math.max(n, t.length), c = (0, W.yy)({
    maxPartySize: i,
    partySize: o,
    activityActionType: a
  }), u = [...t];
...
function eu(e) {
  ...
  let {
    ...
    presenceActivity: g
  } = e, b = ec(u, g), E = (0, T.Lz)(g, p.author, "Invite Embed"), y = !(0, Q.Z)(g, p, c.id), C = i.useMemo(() => {
    let e = [];
    if (!b) {
      var t;
      e.push({
  ...
  }, [g]), O = (0, W.dQ)(c.name, null == (t = p.activity) ? void 0 : t.type);
  if (y) {
    ...
    let e = null != g && null != g.details && null != g.state ? er.intl.formatToPlainString(er.t.JCvHt7, {
        track: g.details,
        artist: g.state
      }) : c.name,
...
function ed(e, t) {
  return {
    ...
    isGameLaunchable: (0, o.e7)([R.Z, I.Z, U.Z, A.Z], () => (0, V.t)({
...
function em(e) {
  ...
  let {
    ...
    bot: L
  } = j, D = F.ZP.getApplicationIconURL({
    id: j.id,
    icon: j.icon,
    bot: L
  }), {
    ...
    isGameLaunchable: eu
  } = ed(null == $ ? void 0 : $.id, P.author.id), em = j.thirdPartySkus.find(e => {
    let {
      distributor: t
    } = e;
    ...
    bot: null
  }, eh = i.useMemo(() => V && null != ef && null != e_ && null != eg && (0, m.ye)(eg) ? {
  ...
  } : null, [v, V, eg, ef, e_]), eb = function(e) {
    let {
      presenceActivity: t,
    ...
    isGameLaunchable: en
  }), eE = !(null == R || !(0, Q.Z)(R, P, j.id) || !(0, q.Z)(R, et.xjy.SYNC) || !H.isPlatformEmbedded || ec(T, R)), ey = ec(T, R), ex = function(e, t, n, r) {
    var i;
    if (t.author.id === r || !(0, Q.Z)(e, t, n.id) || (null == (i = t.activity) ? void 0 : i.type) !== et.mFx.JOIN_REQUEST || !(0, q.Z)(e, et.xjy.JOIN)) return !1;
    let l = (0, X._)(e);
    return !(!es(l) || eo(l))
  }(R, P, j, S), eC = i.useMemo(() => eb ? {
  ...
  } : null != eh ? eh : void 0, [v, eb, ex, eE, I.id, I.guild_id, S, ey, P.author.id, P.id, R, eh]), ev = i.useMemo(() => en ? {
  ...
  } : null != eh ? eh : void 0, [j.id, en, eu, null == $ ? void 0 : $.id, eh]), eO = (0, y.G)(j), ej = i.useMemo(() => null != ee ? ee : null != el ? el : null != eO && k ? eO : void 0, [k, ee, el, eO]), eI = i.useMemo(() => {
    let e = [];
    return K || null == eC ? K && null != ev && e.push(ev) : e.push(eC), e
  }, [ev, K, eC]), eS = (0, W.dQ)(j.name, null == (t = P.activity) ? void 0 : t.type), eT = k ? (0, g.H)({
    applicationId: j.id,
    referrerId: S
  }) : void 0, eN = (0, O.N)(j.id).some(e => (0, C.ig)(e) === l.o.GLOBAL) ? (0, r.jsxs)(r.Fragment, {
...
function ef(e) {
  ...
  let {
    ...
    hideParty: u,
    onView: d
  } = e, p = (0, b.O)(a), m = (0, o.e7)([P.default], () => P.default.getId()), f = (0, o.e7)([L.Z], () => {
    ...
    partySize: h,
    maxPartySize: E
  } = (0, X._)(f), y = i.useMemo(() => _.map(e => {
    let t = M.default.getUser(e);
    return null != t ? t : $.ag
  }), [_]), x = (0, en.Ps)(null == f || null == (t = f.party) ? void 0 : t.id) || p.id === N.r9.id, C = (0, r.jsx)(el, {
    partyMembers: y,
    partySize: h,
    maxPartySize: E,
    guildId: s.guild_id,
