...
function ee(e) {
  ...
  t = s === q.mFx.LISTEN ? l > 0 ? J.intl.formatToPlainString(J.t.Zogooq, {
    partySize: c,
    maxPartySize: l
  }) : J.intl.formatToPlainString(J.t.UGei0t, {
    partySize: c
  }) : l > 0 ? J.intl.formatToPlainString(J.t.gLu7NT, {
    partySize: c,
    maxPartySize: l
  }) : J.intl.formatToPlainString(J.t["65JnWF"], {
    partySize: c
  });
  let u = [...n];
...
function el(e, t) {
  switch (t) {
    case q.mFx.LISTEN:
      return J.intl.formatToPlainString(J.t["/8czHx"], {
        name: e
      });
    case q.mFx.WATCH:
      return J.intl.formatToPlainString(J.t.BBJXVl, {
        name: e
      });
    case q.mFx.JOIN:
...
function ea(e) {
  ...
  let {
    ...
    presenceActivity: _
  } = e, x = ei(u, _), y = (0, C.Lz)(_, p.author, "Invite Embed"), E = !(0, K.Z)(_, p, c.id), v = i.useMemo(() => {
    let e = [];
    if (!x) {
      var t;
      e.push({
  ...
  }, [x, _, y]), O = el(c.name, null == (t = p.activity) ? void 0 : t.type);
  if (E) {
    ...
    let e = null != _ && null != _.details && null != _.state ? J.intl.formatToPlainString(J.t.JCvHt7, {
        track: _.details,
        artist: _.state
      }) : c.name,
...
function eo(e, t) {
  return {
    ...
    isGameLaunchable: (0, a.e7)([w.Z, O.Z, L.Z, T.Z], () => (0, B.t)({
...
function es(e) {
  ...
  let {
    ...
    bot: R
  } = O, k = M.ZP.getApplicationIconURL({
    id: O.id,
    icon: O.icon,
    bot: R
  }), {
    ...
    videoBannerSrc: L,
    bannerAspectRatio: B
  } = (0, g.E)(O), V = (0, G.GK)(O), X = (0, z.Z)(), Q = !(0, K.Z)(w, N, O.id), ee = (0, a.e7)([A.Z], () => A.Z.getGameByName(O.name), [O.name]), {
    openGameProfileModal: ea,
    isGameLaunchable: es
  } = eo(O.id, N.author.id), {
    openGameProfileModal: ec,
    isGameLaunchable: eu
  } = eo(null == ee ? void 0 : ee.id, N.author.id), ed = function(e) {
    let {
      presenceActivity: t,
    ...
    isGameLaunchable: es
  }), ep = !(null == w || !(0, K.Z)(w, N, O.id) || !(0, W.Z)(w, q.xjy.SYNC) || !F.isPlatformEmbedded || ei(S, w)), em = ei(S, w), ef = function(e, t, n) {
    var r;
  ...
  }, [v, ed, ef, ep, j.id, j.guild_id, C, em, N.author.id, N.id, w]), eg = i.useMemo(() => {
    let e = [];
    return Z && V ? e.push({
    ...
    }) : eu && (null == ee ? void 0 : ee.id) != null && e.push({
      label: J.intl.string(J.t.RscU7O),
      trackingArea: f.j_.PLAY,
      onClick: () => {
        c.Z.launch({
  ...
  }, [v, V, O.id, j.id, X, Z, es, eu, null == ee ? void 0 : ee.id]), e_ = (0, _.z)(O), eb = i.useMemo(() => {
    let e = [];
    return null != e_ ? e.push(e_) : null != ea ? e.push({
      label: J.intl.string(J.t["HO/oXl"]),
      trackingArea: f.j_.VIEW,
      onClick: e => {
        ea(e)
  ...
  }, [e_, ea, ec]), ex = i.useMemo(() => {
    let e = [];
    return Q ? e.push(...eg) : e.push(...eh), e.push(...eb), e
  }, [eg, Q, eh, eb]), ey = el(O.name, null == (t = N.activity) ? void 0 : t.type), eE = Z ? (0, p.H)({
    applicationId: O.id,
    referrerId: C
  }) : void 0, ev = (0, E.Ns)(O.id).some(e => (0, x.ig)(e) === l.o.GLOBAL) ? (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(o.YqE, {
      size: "xxs",
      color: "currentColor"
    }), J.intl.string(J.t.TsWCdX)]
  }) : null, eO = null != (y = null == w || null == (n = w.timestamps) ? void 0 : n.start) ? y : null == w ? void 0 : w.created_at, ej = Q || null == eO ? null : (0, r.jsxs)(r.Fragment, {
...
function ec(e) {
  ...
  let {
    ...
    hideParty: u,
    onView: d
  } = e, p = (0, h.O)(o), m = (0, a.e7)([N.default], () => N.default.getId()), f = (0, a.e7)([R.Z], () => {
    ...
    partySize: b,
    maxPartySize: x
  } = et(f), y = i.useMemo(() => _.map(e => {
    let t = D.default.getUser(e);
    return null != t ? t : new I.Z({
      discriminator: "0005"
    })
  }), [_]), E = (0, Q.Ps)(null == f || null == (t = f.party) ? void 0 : t.id) || p.id === S.r9.id, v = (0, r.jsx)(ee, {
    partyMembers: y,
    partySize: b,
    maxPartySize: x,
    guildId: s.guild_id,
