...
function es(e) {
  ...
  let {
    ...
    presenceActivity: h
  } = e, b = eo(u, h), E = (0, S.Lz)(h, p.author, "Invite Embed"), x = !(0, Y.Z)(h, p, c.id), C = i.useMemo(() => {
    let e = [];
    if (!b) {
      var t;
      e.push({
...
function ed(e) {
  ...
  let {
    ...
    bot: L
  } = O, D = U.ZP.getApplicationIconURL({
    id: O.id,
    icon: O.icon,
    bot: L
  }), {
  ...
  } : null, [C, G, em, ep, ef]), eg = function(e) {
    let {
      presenceActivity: t,
  ...
  } : null != e_ ? e_ : void 0, [C, eg, eE, eh, j.id, j.guild_id, I, eb, N.author.id, N.id, Z, e_]), ex = i.useMemo(() => ee ? {
...
function ep(e) {
  ...
  let {
    ...
    hideParty: u,
    onView: d
  } = e, p = (0, h.O)(a), m = (0, o.e7)([N.default], () => N.default.getId()), f = (0, o.e7)([L.Z], () => {
  ...
  }), [g]), x = (0, ee.Ps)(null == f || null == (t = f.party) ? void 0 : t.id) || p.id === T.r9.id, C = (0, r.jsx)(er, {
    partyMembers: y,
    partySize: b,
    maxPartySize: E,
    guildId: s.guild_id,
