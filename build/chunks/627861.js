...
function es(e, t) {
  return {
    ...
    isGameLaunchable: (0, o.e7)([w.Z, y.Z, k.Z, N.Z], () => (0, B.t)({
...
function eu(e) {
  ...
  let {
    ...
    presenceActivity: w
  } = e, Z = (0, C.A)(O), R = (0, p.ye)(O), {
    bot: L
  } = O, D = M.ZP.getApplicationIconURL({
    id: O.id,
    icon: O.icon,
    bot: L
  }), {
  ...
  } : null != ed ? ed : void 0, [x, ep, eg, em, y.id, y.guild_id, j, ef, T.author.id, T.id, w, ed]), eh = i.useMemo(() => $ ? {
