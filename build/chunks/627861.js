...
function em(e) {
  ...
  let {
    ...
    isGameLaunchable: J
  } = ep(null == H ? void 0 : H.id, C.author.id), ee = (0, X.Z)({
    application: I,
  ...
  } : null != er ? er : void 0, [O, ei, el, ea, T.id, T.guild_id, S, es, C.author.id, C.id, w, er]), em = i.useMemo(() => q ? {
  ...
  } : null != er ? er : void 0, [I.id, q, J, null == H ? void 0 : H.id, er]), eg = (0, g.G)(I), eE = i.useMemo(() => null != Y ? Y : null != Q ? Q : null != eg && x ? eg : void 0, [x, Y, Q, eg]), eb = i.useMemo(() => {
    let e = [];
    return Z || null == e_ ? Z && null != em && e.push(em) : e.push(e_), e
  }, [em, Z, e_]), ey = (0, V.dQ)(I.name, null == (t = C.activity) ? void 0 : t.type), eO = (0, v.N)(I.id).some(e => (0, b.ig)(e) === o.o.GLOBAL) ? (0, r.jsxs)(r.Fragment, {
