...
function $(e) {
  ...
  t = s === X.mFx.LISTEN ? l > 0 ? Q.intl.formatToPlainString(Q.t.Zogooq, {
    partySize: c,
    maxPartySize: l
...
function ea(e) {
  ...
  let {
    ...
    presenceActivity: _
  } = e, b = ei(u, _), E = (0, I.Lz)(_, p.author, "Invite Embed"), x = !(0, W.Z)(_, p, c.id), v = i.useMemo(() => {
    let e = [];
    if (!b) {
      var t;
      e.push({
  ...
  }, [b, _, E]), O = el(c.name, null == (t = p.activity) ? void 0 : t.type);
  if (x) {
    ...
    let e = null != _ && null != _.details && null != _.state ? Q.intl.formatToPlainString(Q.t.JCvHt7, {
        track: _.details,
        artist: _.state
      }) : c.name,
...
function ec(e) {
  ...
  let {
    ...
    videoBannerSrc: U,
    bannerAspectRatio: H
  } = (0, b.E)(C), V = !(0, W.Z)(R, P, C.id), Y = ee(P), q = (0, a.e7)([Z.Z], () => Z.Z.getGameByName(C.name), [C.name]), {
    openGameProfileModal: $,
    isGameLaunchable: ea
  } = eo(C.id, P.author.id), {
    openGameProfileModal: ec,
    isGameLaunchable: eu
  } = eo(null == q ? void 0 : q.id, P.author.id), ed = C.thirdPartySkus.find(e => {
    let {
      distributor: t
    } = e;
    ...
    isGameLaunchable: ea
  }), e_ = !(null == R || !(0, W.Z)(R, P, C.id) || !(0, z.Z)(R, X.xjy.SYNC) || !G.isPlatformEmbedded || ei(N, R)), eb = ei(N, R), eE = function(e, t, n, r) {
    var i;
  ...
  } : null != eh ? eh : void 0, [j, eg, eE, e_, S.id, S.guild_id, I, eb, P.author.id, P.id, R, eh]), ex = i.useMemo(() => ea ? {
  ...
  } : null != eh ? eh : void 0, [C.id, ea, eu, null == q ? void 0 : q.id, eh]), ev = (0, E.z)(C), eO = i.useMemo(() => null != $ ? {
    label: Q.intl.string(Q.t["HO/oXl"]),
    trackingArea: g.j_.VIEW,
    onClick: e => {
      $(e)
  ...
  }, [ex, V, ey, eO]), eC = el(C.name, null == (t = P.activity) ? void 0 : t.type), eS = k ? (0, f.H)({
    applicationId: C.id,
    referrerId: I
  }) : void 0, eI = (0, O.N)(C.id).some(e => (0, x.ig)(e) === l.o.GLOBAL) ? (0, r.jsxs)(r.Fragment, {
...
function eu(e) {
  ...
  }), [g]), x = (0, q.Ps)(null == f || null == (t = f.party) ? void 0 : t.id) || p.id === N.r9.id, v = (0, r.jsx)($, {
    partyMembers: y,
    partySize: b,
    maxPartySize: E,
    guildId: s.guild_id,
