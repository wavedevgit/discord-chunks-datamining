...
function es(e) {
  ...
  let {
    ...
    presenceActivity: h
  } = e, E = eo(u, h), C = (0, S.Lz)(h, p.author, "Invite Embed"), v = !(0, K.Z)(h, p, c.id), O = i.useMemo(() => {
    let e = [];
    if (!E) {
      var t;
      e.push({
  ...
  }, [h]), y = (0, V.dQ)(c.name, null == (t = p.activity) ? void 0 : t.type);
  if (v) {
    ...
    let e = null != h && null != h.details && null != h.state ? et.intl.formatToPlainString(et.t.JCvHt7, {
        track: h.details,
        artist: h.state
      }) : c.name,
...
function ec(e, t) {
  return {
    ...
    isGameLaunchable: (0, o.e7)([Z.Z, y.Z, k.Z, P.Z], () => (0, G.t)({
...
function ed(e) {
  ...
  let {
    ...
    presenceActivity: A
  } = e, Z = (0, C.A)(x), R = (0, p.ye)(x), {
    bot: D
  } = x, L = U.ZP.getApplicationIconURL({
    id: x.id,
    icon: x.icon,
    bot: D
  }), {
    ...
    videoBannerSrc: k,
    bannerAspectRatio: F
  } = (0, _.E)(x), G = !(0, K.Z)(A, T, x.id), H = ei(T), X = (0, o.e7)([w.Z], () => w.Z.getGameByName(x.name), [x.name]), {
    openGameProfileModal: Q,
    isGameLaunchable: J
  } = ec(x.id, T.author.id), {
    openGameProfileModal: ee,
    isGameLaunchable: er
  } = ec(null == X ? void 0 : X.id, T.author.id), es = (0, q.Z)({
    application: x,
    location: "RichPresenceActivityInviteEmbed",
    analyticsLocations: v
  }), ed = i.useMemo(() => null == es ? null : {
    ...
    isGameLaunchable: J
  }), em = !(null == A || !(0, K.Z)(A, T, x.id) || !(0, W.Z)(A, $.xjy.SYNC) || !B.isPlatformEmbedded || eo(j, A)), ef = eo(j, A), eg = function(e, t, n, r) {
    var i;
    if (t.author.id === r || !(0, K.Z)(e, t, n.id) || (null == (i = t.activity) ? void 0 : i.type) !== $.mFx.JOIN_REQUEST || !(0, W.Z)(e, $.xjy.JOIN)) return !1;
    let l = (0, z._)(e);
    return !(!ea(l) || el(l))
  }(A, T, x, I), e_ = i.useMemo(() => ep ? {
  ...
  } : null != ed ? ed : void 0, [v, ep, eg, em, y.id, y.guild_id, I, ef, T.author.id, T.id, A, ed]), eh = i.useMemo(() => J ? {
  ...
  } : null != ed ? ed : void 0, [x.id, J, er, null == X ? void 0 : X.id, ed]), eb = (0, h.G)(x), eE = i.useMemo(() => null != Q ? Q : null != ee ? ee : null != eb && R ? eb : void 0, [R, Q, ee, eb]), eC = i.useMemo(() => {
    let e = [];
    return G || null == e_ ? G && null != eh && e.push(eh) : e.push(e_), e
  }, [eh, G, e_]), ev = (0, V.dQ)(x.name, null == (t = T.activity) ? void 0 : t.type), eO = (0, O.N)(x.id).some(e => (0, E.ig)(e) === l.o.GLOBAL) ? (0, r.jsxs)(r.Fragment, {
...
function ep(e) {
  ...
  let {
    ...
    hideParty: d,
    onView: p
  } = e, m = (0, g.O)(s), f = (0, o.e7)([N.default], () => N.default.getId()), _ = (0, o.e7)([D.Z], () => {
    ...
    partySize: E,
    maxPartySize: C
  } = (0, z._)(_), v = i.useMemo(() => b.map(e => {
    let t = M.default.getUser(e);
    return null != t ? t : Q.ag
  }), [b]), O = (0, ee.Ps)(null == _ || null == (t = _.party) ? void 0 : t.id) || m.id === T.r9.id, x = (0, r.jsx)(er, {
    partyMembers: v,
    partySize: E,
    maxPartySize: C,
    guildId: c.guild_id,
  ...
  return O ? (0, r.jsx)(es, {
    ...
    presenceActivity: _
  }) : (null == (l = u.activity) ? void 0 : l.type) === $.mFx.STREAM_REQUEST ? (0, r.jsx)(I.Z, {
    analyticsLocations: a,
    application: m,
    channel: c,
    currentUserId: f,
