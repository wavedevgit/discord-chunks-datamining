...
function ea(e) {
  ...
  let {
    ...
    presenceActivity: h
  } = e, b = el(u, h), E = (0, S.Lz)(h, p.author, "Invite Embed"), C = !(0, Y.Z)(h, p, c.id), x = i.useMemo(() => {
    let e = [];
    if (!b) {
      var t;
      e.push({
  ...
  }, [h]), O = (0, V.dQ)(c.name, null == (t = p.activity) ? void 0 : t.type);
  if (C) {
...
function es(e) {
  ...
  let {
    ...
    autoTrackExposure: !0
  }), J = !(0, Y.Z)(R, P, j.id), et = en(P), ea = (0, a.e7)([w.Z], () => w.Z.getGameByName(j.name), [j.name]), {
    openGameProfileModal: es,
    isGameLaunchable: ec
  } = eo(j.id, P.author.id), {
    openGameProfileModal: eu,
    isGameLaunchable: ed
  } = eo(null == ea ? void 0 : ea.id, P.author.id), ep = j.thirdPartySkus.find(e => {
    let {
      distributor: t
    } = e;
    ...
    bot: null
  }, e_ = i.useMemo(() => q && null != em && null != eg && null != ef && (0, p.ye)(ef) ? {
  ...
  } : null, [O, q, ef, em, eg]), eh = function(e) {
    let {
      presenceActivity: t,
    ...
    isGameLaunchable: ec
  }), eb = !(null == R || !(0, Y.Z)(R, P, j.id) || !(0, K.Z)(R, Q.xjy.SYNC) || !B.isPlatformEmbedded || el(T, R)), eE = el(T, R), ey = function(e, t, n, r) {
    var i;
    if (t.author.id === r || !(0, Y.Z)(e, t, n.id) || (null == (i = t.activity) ? void 0 : i.type) !== Q.mFx.JOIN_REQUEST || !(0, K.Z)(e, Q.xjy.JOIN)) return !1;
    let l = (0, W._)(e);
    return !(!ei(l) || er(l))
  }(R, P, j, S), eC = i.useMemo(() => eh ? {
  ...
  } : null != e_ ? e_ : void 0, [O, eh, ey, eb, I.id, I.guild_id, S, eE, P.author.id, P.id, R, e_]), ex = i.useMemo(() => ec ? {
  ...
  } : null != e_ ? e_ : void 0, [j.id, ec, ed, null == ea ? void 0 : ea.id, e_]), ev = (0, E.G)(j), eO = i.useMemo(() => null != es ? es : null != eu ? eu : null != ev && k ? ev : void 0, [k, es, eu, ev]), ej = i.useMemo(() => {
    let e = [];
    return J || null == eC ? J && null != ex && e.push(ex) : e.push(eC), e
  }, [ex, J, eC]), eI = (0, V.dQ)(j.name, null == (t = P.activity) ? void 0 : t.type), eS = k ? (0, f.H)({
    applicationId: j.id,
    referrerId: S
  }) : void 0, eT = (0, v.N)(j.id).some(e => (0, C.ig)(e) === l.o.GLOBAL) ? (0, r.jsxs)(r.Fragment, {
...
function ec(e) {
  ...
  let {
    ...
    partySize: b,
    maxPartySize: E
  } = (0, W._)(f), y = i.useMemo(() => _.map(e => {
    let t = D.default.getUser(e);
    return null != t ? t : q.ag
  }), [_]), C = (0, J.Ps)(null == f || null == (t = f.party) ? void 0 : t.id) || p.id === T.r9.id, x = (0, r.jsx)(et, {
    partyMembers: y,
    partySize: b,
    maxPartySize: E,
    guildId: s.guild_id,
