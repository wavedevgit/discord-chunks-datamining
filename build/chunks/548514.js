  ...
  let {
    ...
    return a.useEffect(() => {
      ...
      onClickInstallApplication: a.useCallback(() => {
        if ((0, S.zZ)(T.rMx.APP_DIRECTORY_INSTALL_CLICKED, {
            application_id: e.id
...
let M = a.forwardRef(function(e, t) {
  let {
  ...
  } = (0, h.ZP)(), P = a.useCallback(() => {
    (0, S.zZ)(T.rMx.APP_DIRECTORY_APPLICATION_LINK_COPIED, {
      application_id: n.id
    ...
    let b = a.useCallback(async () => {
      if (null != i) {
        if ((0, S.zZ)(T.rMx.APP_DIRECTORY_LAUNCH_CLICKED, {
            application_id: r
