...
let O = () => {
  ...
  y = t => {
    ...
    if (T) return <c.$jN type={c.$jN.Type.SPINNING_CIRCLE} />;
    let M = (0, x.Xw)({
        product: B,
        pairedProduct: true,
        overrideTitle: y,
    ...
    return <d.Gt value={R}><div ref={G}>{<o.O_ ref={D} className={k.confettiCanvas} environment={F} />}{<a.I graphic={{
            type: "dynamic",
          ...
          }} title={M} subtitle={null != q ? q : true} onClose={l} transitionState={e} actions={z} />}{null != V ? <I.i options={V} /> : <h.Z confettiTarget={G.current} confettiCanvas={$} sprites={(0, m.vK)(B.categorySkuId)} />}</div></d.Gt>
  }