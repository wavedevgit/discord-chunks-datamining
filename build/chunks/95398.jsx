...
let v = e => {
    ...
    return <div className={a()(m.spoilerWarning, t)}>{h.intl.string(h.t["F+x38P"])}</div>
  },
  I = e => {
    let {
      className: t,
    ...
    return <div className={a()(m.explicitContentWarning, t)}>{i ? null : (0, r.jsxs)(r.Fragment, {
  ...
  T = e => {
    ...
    switch (t) {
      case _.wk.SPOILER:
        return <v className={n} />;
      case _.wk.EXPLICIT_CONTENT:
      case _.wk.GORE_CONTENT:
        return <I isSingleMosaicItem={i} className={n} />;
      case _.wk.POTENTIAL_EXPLICIT_CONTENT:
        return <I isSingleMosaicItem={i} className={n} obscureOnly={true} />;
      default:
        return (0, p.vE)(t)
    }
  },
  S = e => {
    ...
    return t !== _.wk.EXPLICIT_CONTENT && t !== _.wk.GORE_CONTENT ? null : <div className={a()(m.obscureButtonContainer, o)}><l.P3F className={m.obscureHoverButton} onClick={i} aria-label={h.intl.string(h.t.ex5G9v)}>{n ? (0, r.jsx)(l.tEF, {
          size: "md",
          color: "currentColor"
        }) : (0, r.jsx)(l.kZF, {
          size: "md",
...
class N extends Chunk73800.PureComponent {
  renderWithTooltip(e) {
    return <l.ua7 position={"left"} text={this.state.visible ? null : this.tooltipText}>{t => {
        let {
          onMouseEnter: n,
          onMouseLeave: r
        } = t;
