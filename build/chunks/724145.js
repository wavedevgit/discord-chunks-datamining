...
let k = () => (0, r.jsx)("div", {
  ...
  M = e => {
    ...
    let {
      ...
      e && (null == a || a(), null != o && o(P.L.PRIMARY), null != u && ((0, w.Yk)({
        isPersisted: !0,
        themeName: c.Us[u.id],
        analyticsLocations: s
      }), (0, _.ZI)({
    ...
    return (0, r.jsx)(O.Z, {
      ...
      textOptions: {
        textOverride: f ? L.intl.string(L.t.IJI7ys) : (null == p || null == (i = p.subscription_trial) ? void 0 : i.sku_id) === D.Si.TIER_2 ? h : L.intl.string(L.t.mr4K7O)
      },
...
function G(e) {
  ...
  i.useEffect(() => d(R.rMx.CLIENT_THEME_PREVIEW_VIEWED), [d]), i.useEffect(() => {
    s && T.default.track(R.rMx.PREMIUM_UPSELL_VIEWED, {
  ...
  return i.useEffect(() => {
    ...
    children: (0, r.jsx)("div", {
      ...
      children: (0, r.jsxs)(f.y5t, {
        children: [n ? (0, r.jsx)(k, {}) : (0, r.jsx)(j, {
          markAsDismissed: t
        }), (0, r.jsx)(f.Ttm, {
