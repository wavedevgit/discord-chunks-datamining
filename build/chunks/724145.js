...
let M = () => (0, r.jsx)("div", {
  ...
  j = e => {
    ...
    let {
    ...
    } = (0, E.ZP)(g.Z.CLIENT_THEMES_EDITOR), [u, _] = (0, l.Wu)([I.default, A.Z], () => [A.Z.gradientPreset, S.ZP.isPremium(I.default.getCurrentUser())]), p = (0, y.N)(), h = (0, S.Rt)({
      ...
      e && (null == a || a(), null != o && o(w.L.PRIMARY), null != u && ((0, R.Yk)({
        isPersisted: !0,
        themeName: c.Us[u.id],
        analyticsLocations: s
      }), (0, f.ZI)({
    ...
    return (0, r.jsx)(O.Z, {
      ...
      textOptions: {
        textOverride: _ ? L.intl.string(L.t.IJI7ys) : (null == p || null == (i = p.subscription_trial) ? void 0 : i.sku_id) === D.Si.TIER_2 ? h : L.intl.string(L.t.mr4K7O)
      },
