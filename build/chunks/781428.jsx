...
var r, Chunk255367 = require("./255367.js"),
  ...
  Chunk913583 = require("./913583.js"),
  Chunk144114 = require("./144114.js"),
  Chunk541692 = require("./541692.js"),
  Chunk952802 = require("./952802.js"),
...
function Q() {
  return <Chunk388905.ZP><Chunk481060.$jN /></Chunk388905.ZP>
}
class $ extends(r = Chunk73800.PureComponent) {
  ...
  renderHandOffAvailable() {
    ...
    return <Chunk388905.ZP className={module}>{<Chunk388905.Hh />}{<Chunk388905.Dx className={Chunk20493.marginBottom8}>{Chunk388032.intl.string(Chunk388032.t.S6RMND)}</Chunk388905.Dx>}{<Chunk388905.DK>{Chunk388032.intl.string(Chunk388032.t.YZiJbm)}</Chunk388905.DK>}</Chunk388905.ZP>
  }
  renderHandOffContinue() {
    ...
    return null == module ? null : <Chunk388905.ZP className={require}>{<Chunk388905.qE src={module.getAvatarURL(true, 100)} size={Chunk481060.EFr.DEPRECATED_SIZE_100} className={Chunk20493.marginBottom20} />}{<Chunk388905.Dx className={Chunk20493.marginBottom8}>{Chunk388032.intl.format(Chunk388032.t.ot19ho, {
          name: module.toString()
        })}</Chunk388905.Dx>}{<Chunk388905.DK className={Chunk20493.marginBottom40}>{Chunk388032.intl.string(Chunk388032.t["2xkqzc"])}</Chunk388905.DK>}{<Chunk388905.gO>{<Chunk388905.zx onClick={() => exports(Chunk981631.Z5c.APP)} className={Chunk20493.marginBottom8}>{Chunk388032.intl.format(Chunk388032.t.fohtv7, {
            name: module.toString()
          })}</Chunk388905.zx>}{<Chunk388905.zx look={Chunk388905.zx.Looks.LINK} color={Chunk388905.zx.Colors.LINK} onClick={this.handleReset}>{Chunk388032.intl.string(Chunk388032.t.nO564e)}</Chunk388905.zx>}</Chunk388905.gO>}</Chunk388905.ZP>
  }
  renderDisabledAccount() {
    ...
    return <Chunk388905.ZP tag={"form"} onSubmit={this.handleReset} className={module}><Chunk481060.y5t component={(0, Chunk255367.jsx)(Chunk388905.Dx, {
          className: Chunk20493.marginBottom8,
          children: require
        })}>{<Chunk388905.DK className={Chunk20493.marginBottom20}>{r}</Chunk388905.DK>}{<Chunk388905.gO>{<Chunk388905.zx color={Chunk388905.zx.Colors.BRAND} type={"submit"}>{Chunk388032.intl.string(Chunk388032.t.JhDw5u)}</Chunk388905.zx>}{<div className={a()(Chunk20493.marginTop8, Chunk555763.needAccount)}>{Chunk388032.intl.format(Chunk388032.t.js2rr6, {
              onClick: this.handleCancelAccountDeletion
            })}</div>}</Chunk388905.gO>}</Chunk481060.y5t></Chunk388905.ZP>
  }
  renderResolving() {
    let {
      authBoxClassName: e,
    ...
    return <Chunk388905.ZP className={module}>{<Chunk588705.R />}{<Chunk388905.gO className={Chunk20493.marginTop20}>{<Chunk952802.Z className={Chunk20493.marginBottom20} alpha2={exports.alpha2} countryCode={exports.code.split(" ")[0]} label={Chunk388032.intl.string(Chunk388032.t.tUjnxs)} onChange={(e, t) => this.setState({
            login: e,
            loginPrefix: t
          })} setRef={this.setLoginRef} autoCapitalize={"none"} autoComplete={"off"} autoCorrect={"off"} spellCheck={"false"} value={this.state.login} autoFocus={true} required={true} />}{<Chunk388905.II className={Chunk20493.marginBottom20} label={Chunk388032.intl.string(Chunk388032.t["CIGa+/"])} onChange={e => this.setState({
            password: e
          })} type={"password"} setRef={this.setPasswordRef} autoComplete={"off"} spellCheck={"false"} value={this.state.password} required={true} />}{<Chunk388905.zx className={Chunk20493.marginBottom8} type={"submit"} disabled={true}>{Chunk388032.intl.string(Chunk388032.t.dKhVQE)}</Chunk388905.zx>}{<Chunk388905.zx disabled={true} look={Chunk388905.zx.Looks.LINK} color={Chunk388905.zx.Colors.LINK}>{Chunk388032.intl.string(Chunk388032.t.wWIufn)}</Chunk388905.zx>}{<Chunk388905.zx disabled={true} className={Chunk20493.marginTop4} look={Chunk388905.zx.Looks.LINK} color={Chunk388905.zx.Colors.LINK}>{Chunk388032.intl.string(Chunk388032.t.tmE73t)}</Chunk388905.zx>}</Chunk388905.gO>}</Chunk388905.ZP>
  }
  renderDefaultForm(e) {
    var t;
    let n, {
    ...
    return n = null == r || p ? null != l ? <U.Z giftCode={l} /> : <div className={W.header}>{<b.Dx className={q.marginBottom8}>{K.intl.string(K.t["7fNJgI"])}</b.Dx>}{false === (0, M.isAndroidWeb)() ? <b.DK>{K.intl.string(K.t.euS7r6)}</b.DK> : null}</div> : <G.Z invite={r} />, <v.Z direction={v.Z.Direction.HORIZONTAL} align={v.Z.Align.CENTER}>{<div className={W.mainLoginContainer}>{this.canShowChooseAccount && this.state.dismissedChooseAccount && <b.zx onClick={() => {
            this.setState(e => X(J({}, e), {
              dismissedChooseAccount: false
            }))
          }} look={b.zx.Looks.LINK} color={b.zx.Colors.PRIMARY} className={W.goBackButton}><div className={W.content}>{<h.V7D size={"xs"} color={"currentColor"} className={W.caret} />}{<h.Text variant={"text-md/normal"}>{K.intl.string(K.t["1MrpWF"])}</h.Text>}</div></b.zx>}{n}{<h.y5t><b.gO className={q.marginTop20}>{<T.Z alpha2={s.alpha2} countryCode={s.code.split(" ")[0]} className={q.marginBottom20} label={K.intl.string(K.t.tUjnxs)} error={null != (t = this.renderError("login")) ? t : this.renderError("email")} onChange={(e, t) => this.setState({
                login: e,
                loginPrefix: t
              })} setRef={this.setLoginRef} autoCapitalize={"none"} autoComplete={"webauthn"} autoCorrect={"off"} spellCheck={"false"} value={this.state.login} autoFocus={!d && !c && !u} required={true} />}{<b.II label={K.intl.string(K.t["CIGa+/"])} error={this.renderError("password")} onChange={e => this.setState({
                password: e
              })} name={"password"} type={"password"} setRef={this.setPasswordRef} autoComplete={"off"} spellCheck={"false"} autoFocus={d && !c && !u} value={this.state.password} required={true} />}{<b.zx onClick={this.handleForgotPassword} look={b.zx.Looks.LINK} color={b.zx.Colors.LINK} className={a()(q.marginBottom20, q.marginTop4)}>{K.intl.string(K.t.wWIufn)}</b.zx>}{<b.zx type={"submit"} submitting={o === V.u34.LOGGING_IN} color={p ? b.zx.Colors.GREEN : b.zx.Colors.BRAND} className={q.marginBottom8}>{p ? K.intl.string(K.t.wvVThI) : K.intl.string(K.t.dKhVQE)}</b.zx>}{<div className={q.marginTop4}>{<span className={W.needAccount}>{K.intl.string(K.t.tmE73t)}</span>}{<b.zx onClick={this.handleGotoRegister} look={b.zx.Looks.LINK} color={b.zx.Colors.LINK} className={W.smallRegisterLink}>{K.intl.string(K.t.pV8xeX)}</b.zx>}</div>}</b.gO></h.y5t>}</div>}{<h.y5t>{e ? (0, i.jsx)(F.Z, {
  ...
  renderDefault() {
    ...
    return <div className={Chunk555763.__invalid_pageContainer}>{<Chunk388905.ZP onSubmit={this.handleLogin} tag={"form"} className={module} expanded={true}>{this.renderDefaultForm(true)}</Chunk388905.ZP>}{exports && <Chunk86779.Z />}</div>
  }
  renderGuildTemplate(e) {
    return <z.Z onSubmit={this.handleLogin} tag={"form"} className={a()(this.props.authBoxClassName, W.horizontalAuthBox)}>{() => [(0, i.jsx)(I.Z, {
        guildTemplate: e
      }, "template"), this.renderDefaultForm(false)]}</z.Z>
  }
  renderMFA() {
    let e = {
    ...
    return <Chunk388905.ZP style={{
        padding: 0
      }}><Chunk124860.Cd mfaFinish={this.handleTokenSubmitMFA} mfaChallenge={module} onEarlyClose={() => {
          Chunk570140.Z.dispatch({
            type: "LOGIN_RESET"
          })
        }} width={480} /></Chunk388905.ZP>
  }
  renderIPAuthorization() {
    ...
    return <Chunk388905.ZP tag={"form"} className={module}><Chunk379760.Z title={Chunk388032.intl.string(Chunk388032.t.w55Ocn)} subtitle={Chunk388032.intl.format(Chunk388032.t.CfRZBg, {
          onResendClick: this.handleResendCode
        })} error={exports} onSubmit={this.handleIPAuthorize} onCancel={this.loginReset} /></Chunk388905.ZP>
  }
  renderPasswordRecovery() {
    ...
    return <Chunk388905.ZP tag={"form"} className={module}><Chunk379760.Z title={Chunk388032.intl.string(Chunk388032.t["+xqy3d"])} subtitle={Chunk388032.intl.format(Chunk388032.t.ef4uZ2, {
          onResendClick: this.handleResendCode
        })} error={exports} onSubmit={this.handlePasswordReset} onCancel={this.loginReset} /></Chunk388905.ZP>
  }
  renderChooseAccount() {
    return <Chunk913583.Z onDismiss={() => {
        this.setState(e => X(J({}, e), {
  ...
  render() {
    ...
    if (Chunk120356 || Chunk533126) return <Q />;
