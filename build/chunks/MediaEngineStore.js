...
function t$() {
  e$.on(Chunk46973.aB.Connection, e => {
    ...
    }), e.setBitRate(eg.Z.bitrate), e.applyVideoQualityMode(eI.Z.mode), e$.supports(eR.AN.ASYNC_VIDEO_INPUT_DEVICE_INIT) && e$.setAsyncVideoInputDeviceInit((0, B.p)("setupMediaEngine").enabled)
...
function ry(e) {
  ...
  null != o && (e$.setClipsSource(null), (0, ed.isWindows)() && null != o.desktopSource.soundshareId && T.pn(o.desktopSource.soundshareId)), null != a && nd(a, s), o = c;
  let u = tG(),
    d = tZ().videoHook;
  e$.setClipsSource({
    desktopDescription: {
