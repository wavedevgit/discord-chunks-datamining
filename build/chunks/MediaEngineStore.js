...
function rl(e) {
  ...
  null != o && (eW.setClipsSource(null), (0, ea.isWindows)() && null != o.desktopSource.soundshareId && T.pn(o.desktopSource.soundshareId)), null != l && t9(l, c), o = d;
  let f = tR(),
    _ = tw().videoHook;
  eW.setClipsSource({
    desktopDescription: {
...
function ru(e) {
  ...
  if ((null == a ? true : a.desktopSettings) != null) {
    ...
    ea.isPlatformEmbedded && true === o && ({
      soundshareId: e,
      soundshareSession: r
    } = t7(c), null != e && t9(e, r)), tj(s), tk(s === eI.Yn.STREAM && e6, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
