...
function tY(e) {
  let t = tF(e.context),
    n = !e2 || t.mute || t.deaf;
  e.context === eP.Yn.DEFAULT ? n = n || te || tt || tn || !et.Z.didHavePermission(eC.Eu.AUDIO) : e.context === eP.Yn.STREAM && (n = true), e.setSelfMute(n), e.setSelfDeaf(t.deaf), e.context === eP.Yn.DEFAULT && T.Z.updateNativeMute()
}
...
function nT(e) {
  ...
  if (I[c] === eT.ZUi.AUTO_PROBING && u === eT.ZUi.AUTO_ENABLED && (0, ee.Z)(c, p ? eP.fC.AUTO_DISABLE : eP.fC.AUTO_ENABLE, E), I[c] = u, t7({
      videoToggleStateMap: I
    ...
    if (!p && !g || p && !tD) return;
    (0, ee.Z)(c, p ? eP.fC.AUTO_DISABLE : eP.fC.AUTO_ENABLE, E), p ? tw.add(c) : tw.delete(c)
