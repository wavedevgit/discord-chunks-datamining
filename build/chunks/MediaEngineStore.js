...
function rm(e) {
  ...
  if ((null == a ? true : a.desktopSettings) != null) {
    ...
    ea.isPlatformEmbedded && true === o && ({
      soundshareId: e,
      soundshareSession: r
    } = nr(c), null != e && ni(e, r)), tU(s), tG(s === eI.Yn.STREAM && e6, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
...
class rw extends(u = Chunk442837.ZP.Store) {
  ...
  getInputDeviceId() {
    return t6(e$, tx().inputDeviceId)
  }
  getOutputDeviceId() {
    return t6(e0, tx().outputDeviceId)
  }
  getVideoDeviceId() {
    return t6(e1, tx().videoDeviceId)
  }
  getInputDevices() {
    return e$
  }
