...
function tQ() {
  eJ.on(Chunk46973.aB.Connection, e => {
    ...
    if ((0, ed.isWindows)() ? (null == tx ? true : tx.startsWith("NVIDIA")) || (null == tx ? true : tx.startsWith("AMD")) ? e.setExperimentFlag(eR.V8.SIGNAL_AV1, true) : e.setExperimentFlag(eR.V8.SIGNAL_AV1_DECODE, true) : ((0, ed.isMac)() || (0, ed.isLinux)()) && e.setExperimentFlag(eR.V8.SIGNAL_AV1_DECODE, true), (0, ed.isWindows)() && e.setExperimentFlag(eR.V8.SIGNAL_AV1_HARDWARE_DECODE, true), (0, ed.isWeb)()) {
      let {
        enabled: t
    ...
    e.on(b.Sh.Speaking, (t, n) => {
      ...
      eM.warn("voiceactivitydetectorerror event: ".concat(e)), (0, D.kr)({
        ...
        options: eL(ew({}, tB(eR.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: false
        })
      }), v.Z.dispatch({
    ...
    (0, D.kr)(t === D.u.VIDEO_ENCODE_ERROR ? eL(ew({
      type: t
    }, n), {
  ...
  }), nV(), nY(), t3.reset(), (0, Chunk704806.q)().then(e => {
...
function nu(e) {
  ...
  let t = tB();
  if (t1() && (t2() ? rc(eR.iA.AUTOMATIC) : t.automaticAudioSubsystem && ru()), eJ.supports(eR.AN.OFFLOAD_ADM_CONTROLS)) {
    let e = false;
...
function nv(e) {
  ...
  if (I[c] === eT.ZUi.AUTO_PROBING && u === eT.ZUi.AUTO_ENABLED && (0, $.Z)(c, p ? eR.fC.AUTO_DISABLE : eR.fC.AUTO_ENABLE, E), I[c] = u, t8({
      videoToggleStateMap: I
  ...
  y && !p && tR.delete(c), p ? h[c] = true : delete h[c], t8({
    disabledLocalVideos: h
...
function nC(e) {
  ...
  t8({
    mode: n,
    modeOptions: r
  }, t), eJ.eachConnection(tZ), t3.update()
}
...
function nP(e) {
  ...
  t = nt(e8, t), e4 = performance.now(), t8({
    inputDeviceId: t
  }), eJ.setAudioInputDevice(t)
}
...
function nx(e) {
  ...
  }), eJ.setAudioInputBypassSystemProcessing(n.bypassSystemInputProcessing), t3.update(), nH()
}
...
function rn() {
  !rt() || __OVERLAY__ || th || tm ? (0, Chunk358085.isWeb)() && eJ.supports(Chunk65154.AN.NOISE_CANCELLATION) ? (tm = true, r.emitChange()) : (0, Chunk358085.isWeb)() && t8({
    noiseCancellation: false
  }) : (th = true, re())
}
