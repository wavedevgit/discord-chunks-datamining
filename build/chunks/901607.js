/** Chunk was on web.js **/
/** chunk id: 901607, original params: e,t,n (module,exports,re quire) **/
"use strict";
...
module.exports = (0, require("./65183.js").Map)({
  ...
  "unordered-list-item": {
    element: "li",
    wrapper: Chunk647438.createElement("ul", {
      className: Chunk606166("public/DraftStyleDefault/ul")
    })
  },
  "ordered-list-item": {
    element: "li",
    wrapper: Chunk647438.createElement("ol", {
  ...
  "code-block": {
    element: "pre",
    wrapper: Chunk647438.createElement("pre", {
