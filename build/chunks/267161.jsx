...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk300986 = require("./300986.js"),
  Chunk314451 = require("./314451.js"),
  Chunk35583 = require("./35583.jsx"),
  Chunk821020 = require("./821020.js"),
  Chunk370774 = require("./370774.js"),
  Chunk340137 = require("./340137.js"),
...
function z() {
  let e, t = (0, Chunk114858.TH)(),
    ...
    E = null;
  return null != Chunk111666 && Chunk300986 ? (e = Chunk111666.name, E = <img className={Chunk103609.appIcon} alt={Chunk388032.intl.string(Chunk388032.t.X4IxWF)} src={Chunk314451} aria-hidden={true} draggable={false} />) : Chunk540059 ? (e = Chunk388032.intl.string(Chunk388032.t.HcoRu7), E = <Chunk481060.Dkj size={"xs"} />) : null != Chunk174556 ? (E = Chunk320007 ? <Chunk481060.r7p size={"xs"} /> : <Chunk565138.Z guild={Chunk174556} size={Chunk565138.Z.Sizes.MINI} active={true} className={Chunk103609.guildIcon} />, e = Chunk174556.name) : null != Chunk97519 && (Chunk97519.isDM() || Chunk97519.isGroupDM()) ? (e = Chunk388032.intl.string(Chunk388032.t.YUU0RE), E = <Chunk481060.gw7 size={"xs"} />) : exports.pathname.startsWith(Chunk981631.Z5c.GLOBAL_DISCOVERY) ? (e = Chunk388032.intl.string(Chunk388032.t["4nEZLi"]), E = <Chunk481060.Jmo size={"xs"} />) : exports.pathname.startsWith(Chunk981631.Z5c.NITRO_HOME) ? (e = Chunk388032.intl.string(Chunk388032.t.Ipxkoq), E = <Chunk481060.SrA size={"xs"} />) : exports.pathname.startsWith(Chunk981631.Z5c.COLLECTIBLES_SHOP) ? (e = Chunk388032.intl.string(Chunk388032.t.pWG4zc), E = <Chunk481060.EOn size={"xs"} />) : exports.pathname.startsWith(Chunk981631.Z5c.FRIENDS) ? (e = Chunk388032.intl.string(Chunk388032.t.TdEu5e), E = <Chunk481060.iFz size={"xs"} />) : exports.pathname.startsWith(Chunk981631.Z5c.FAMILY_CENTER) && (e = Chunk388032.intl.string(Chunk916723.default.RZqaJi), E = <Chunk481060.BFJ size={"xs"} />), null != module && "" !== module && <div className={Chunk103609.title}>{Chunk35583}{<Chunk481060.Text variant={"text-sm/medium"} lineClamp={1}>{module}</Chunk481060.Text>}</div>
}
let W = Chunk73800.memo(function() {
  ...
  return Chunk370774 ? null : <Chunk481060.Wdt>{e => (0, r.jsx)(s.f6W, {
      theme: b,
...
function Y() {
  return <svg xmlns={"http://www.w3.org/2000/svg"} className={Chunk103609.icon} width={"24"} height={"24"} viewBox={"0 0 24 24"} fill={"none"} stroke={"currentColor"} stroke-width={"2"} stroke-linecap={"round"} stroke-linejoin={"round"}>{<rect width={"18"} height={"18"} x={"3"} y={"3"} rx={"2"} />}{<path d={"M9 3v18"} />}</svg>
}