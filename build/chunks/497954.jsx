...
let g = e => {
  ...
  }, [t, g, n]), v = l.useMemo(() => x || _, [x, _]);
  return <o.JZ title={p.intl.formatToPlainString(p.t.U3yyFh, {
      username: h
    })} description={p.intl.string(p.t.naWE6e)} buttonText={v ? p.intl.string(p.t.nDdxOD) : p.intl.string(p.t.ICYEfX)} buttonDisabled={v} onButtonPress={f} />
}