...
function B(e, t) {
  ...
  let r = {
    ...
    o = e.getChannelId(),
    a = _.Z.getReactions(o, e.id, r, b.$J, u.O.VOTE),
    s = f.Z.getChannel(o),
    l = null == s || s.isPrivate() ? null : s.getGuildId();
  return i()(Array.from(null != (n = null == a ? void 0 : a.values()) ? n : [])).reject(e => m.Z.isBlockedOrIgnored(e.id)).take(b.$J).map(e => E.ZP.getName(l, null == s ? void 0 : s.id, e)).value()
}
