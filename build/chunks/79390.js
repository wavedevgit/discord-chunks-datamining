...
function F(e, t) {
  ...
  if (2 === e.length)
    if (n > 0) return v.intl.formatToPlainString(v.t.YBnZKy, {
      a: e[0],
      b: e[1],
      n: n.toLocaleString()
    });
    else return v.intl.formatToPlainString(v.t["O5+f5e"], {
      a: e[0],
      b: e[1]
    });
  return 3 !== e.length ? v.intl.formatToPlainString(v.t.yVX6kJ, {
    n: n.toLocaleString()
  }) : n > 0 ? v.intl.formatToPlainString(v.t["ThXp+P"], {
    a: e[0],
    b: e[1],
    c: e[2],
    n: n.toLocaleString()
