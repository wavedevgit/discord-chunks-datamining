...
function j(e, t) {
  var n, r, i, a;
  let o = null != (a = null == (i = e.embeds[0]) || null == (r = i.fields) || null == (n = r.find(e => "poll_question_text" === e.rawName)) ? void 0 : n.rawValue) ? a : "";
...
function U(e) {
  let t = (0, d.ZH)(e),
    n = j(e, b.Dv);
  return O.intl.format(O.t.Vn97KS, {
    username: t.nick,
    title: n
  })
}
...
function B(e, t) {
  ...
  return i()(Array.from(null != (n = null == o ? void 0 : o.values()) ? n : [])).reject(e => m.Z.isBlockedOrIgnored(e.id)).take(b.$J).map(e => E.ZP.getName(l, null == s ? void 0 : s.id, e)).value()
}

function V(e, t) {
  let n = Math.max(0, t - e.length);
  if (1 === e.length)
    if (n > 0) return O.intl.formatToPlainString(O.t["SV/iZm"], {
      a: e[0],
      n: n.toLocaleString()
    });
    else return e[0];
  if (2 === e.length)
    if (n > 0) return O.intl.formatToPlainString(O.t.YBnZKy, {
      a: e[0],
      b: e[1],
      n: n.toLocaleString()
    });
    else return O.intl.formatToPlainString(O.t["O5+f5e"], {
      a: e[0],
      b: e[1]
    });
  return 3 !== e.length ? O.intl.formatToPlainString(O.t.yVX6kJ, {
    n: n.toLocaleString()
  }) : n > 0 ? O.intl.formatToPlainString(O.t["ThXp+P"], {
    a: e[0],
    b: e[1],
    c: e[2],
    n: n.toLocaleString()
  }) : O.intl.formatToPlainString(O.t["0UzBMz"], {
    a: e[0],
    b: e[1],
    c: e[2]
  })
