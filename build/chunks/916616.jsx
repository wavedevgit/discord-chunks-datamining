...
let A = Chunk73800.forwardRef((e, t) => {
  ...
  var {
    ...
    children: j = e => {
      ...
      return <img className={null != o ? o : true} alt={null != i ? i : m.intl.string(m.t.X4IxWF)} src={t} style={R(n, a)} />
    },
    renderAccessory: U,
    onClick: G,
    tabIndex: B,
  ...
  "" !== f && c !== p.zo9.ERROR ? n = j({
    ...
    className: s,
    mediaLayoutType: D
  }) : c !== p.zo9.LOADING && (n = <N size={K} mediaLayoutType={D} alt={b} />), n = <_.N readyState={c} aspectRatio={z} placeholder={h} placeholderVersion={E} placeholderStyle={R(K, D)}>{n}</_.N>;
  let q = null != U ? U() : null;
  return q = null != q ? q : x, <l.tEY ringTarget={Y} focusTarget={W}><div{...I(O({
      ref: t,
...
function N(e) {
  ...
  return <div className={g.imageErrorWrapper} style={P(t, n)}><img src={(0, s.ap)(o) ? b : E} className={g.imageError} alt={null != i ? i : m.intl.string(m.t.X4IxWF)} /></div>
}
