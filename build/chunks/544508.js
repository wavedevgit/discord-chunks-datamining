...
let j = i.forwardRef(function(e, t) {
  ...
  N = i.forwardRef(function(e, t) {
    let {
      ...
      username: M,
      globalName: L
    } = N, k = i.useRef(null), R = i.useRef(null), D = i.useMemo(() => r.merge({
      discriminator: "0000"
    }), [r]), [Z, U] = (0, c.q_F)(() => ({
      opacity: 0,
      y: 5
    ...
    return i.useEffect(() => {
      !G && _ === p.Wq.PREVIEW && r.username.includes(p.nA) && (W(window.innerWidth / 2 + 150, 0, {
        velocity: {
          type: "static-random",
          minValue: {
            x: 0,
    ...
    }, [W, _, r, G]), (0, n.jsxs)("div", {
      className: s()(b.userCardContainer, {
        [b.shinyCard]: _ === p.Wq.PREVIEW
      }),
      children: [(0, n.jsxs)("div", {
        ...
        children: [(0, n.jsx)(g.Z, {
          ...
          displayProfile: v,
          themeType: y.lY.SIDEBAR
        }), _ === p.Wq.PREVIEW && null != z && (0, n.jsx)("div", {
      ...
      }), _ !== p.Wq.PREVIEW && (0, n.jsxs)(l.animated.div, {
        style: {
          opacity: Z.opacity,
          y: Z.y
        },
        className: b.inputContainer,
        children: [_ === p.Wq.EDIT_DISPLAY_NAME && (0, n.jsxs)(n.Fragment, {
        ...
        }), (_ === p.Wq.EDIT_USERNAME || _ === p.Wq.SUGGESTION) && (0, n.jsxs)(n.Fragment, {
          children: [(0, n.jsx)(c.Text, {
            className: b.textPadding,
            color: "text-muted",
            variant: "text-sm/semibold",
          ...
          children: (() => {
            if (null != o) return (0, n.jsx)(O.Z, {
              type: "error",
              children: o
            });
            if (null != C) {
              if (_ !== p.Wq.SUGGESTION) return (0, n.jsx)(c.Text, {
                variant: "text-sm/normal",
                children: C
              });
              else if (!A) return (0, n.jsx)(O.Z, {
                type: "success",
                children: C
              })
            }
            return null == C && null == o && (_ === p.Wq.EDIT_USERNAME || _ === p.Wq.SUGGESTION) ? (0, n.jsx)(h.Z, {
              username: M,
              oneClickFlow: w
            }) : null
          })()
        })]
      }), _ === p.Wq.PREVIEW && (0, n.jsxs)("div", {
