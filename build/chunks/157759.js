...
let f = e => {
  let {
    application: t,
    reportId: n
  } = e, [f, g] = l.useState(!1), [v, j] = l.useState(!1), N = (0, i.e7)([b.Z, m.Z], () => {
    var e;
  ...
  let Z = l.useCallback(() => {
      j(!1), s.ZP.trackWithMetadata(h.rMx.IAR_REMOVE_APP_BUTTON_CLICKED, {
        guild_id: N,
        application_id: t.id,
        report_id: n
  ...
  return null != t && null != N && f && I ? (0, r.jsx)(u.ZP, {
