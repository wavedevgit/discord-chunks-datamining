...
let _ = e => {
  let {
    application: t,
    reportId: n
  } = e, [_, g] = l.useState(!1), [v, j] = l.useState(!1), N = (0, i.e7)([b.Z, m.Z], () => {
    var e;
  ...
  let O = l.useCallback(() => {
      j(!1), s.ZP.trackWithMetadata(f.rMx.IAR_REMOVE_APP_BUTTON_CLICKED, {
        guild_id: N,
        application_id: t.id,
        report_id: n
    ...
    I = (0, i.e7)([p.Z, x.Z], () => {
      ...
      if (null == e) return !1;
      let n = p.Z.can(f.Plq.MANAGE_GUILD, e),
        r = null == t.bot || p.Z.canManageUser(f.Plq.MANAGE_GUILD, t.bot.id, e);
      return n && r
    });
