...
function E(e) {
  ...
  return <c.M0o tooltip={C.intl.string(C.t["8k+6QU"])} color={c.YX$.TERTIARY} icon={(0, r.jsx)(c.W6s, {
      size: "xs",
      color: "currentColor"
    })} className={j.controlButton} onClick={t} />
}
...
function S(e) {
  ...
  return <div className={o()(v.container, {
      [v.widerInbox]: P
    })}><c.y5t component={(0, r.jsx)(_.Z, {
        tab: a.X.FOR_YOU,
        setTab: t,
        badgeState: n,
        closePopout: l,
      ...
      })}><f.Z initialized={C} items={N} loading={S} loadMore={x} /></c.y5t></div>
}