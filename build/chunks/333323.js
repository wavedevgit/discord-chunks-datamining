...
function D(e) {
  ...
  let {
    guild: a,
    width: m
  } = e, P = (0, s.e7)([g.ZP], () => g.ZP.getSection(O.oC.GUILD_HOME)), [D, R] = r.useState(!1), [L, T] = r.useState(N.$Y6), B = P === N.ULH.SIDEBAR_CHAT, H = (0, c.mFp)(), W = (0, s.e7)([b.Z], () => b.Z.getSettings(a.id)), U = null == W ? void 0 : W.welcomeMessage, z = (0, C.Z)(a.id), G = !z && (null != (t = null == W || null == (n = W.resourceChannels) ? void 0 : n.length) ? t : 0) === 0, F = (0, d.Z)("(max-width: 1300px)"), q = m - N.PrS - L, V = B && q < A || F || G;
  return (r.useEffect(() => {
