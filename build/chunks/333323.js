...
function W(e) {
  ...
  let {
    guild: a,
    width: h
  } = e, P = (0, s.e7)([g.ZP], () => g.ZP.getSection(O.oC.GUILD_HOME)), [W, D] = r.useState(!1), [T, R] = r.useState(y.$Y6), L = P === y.ULH.SIDEBAR_CHAT, B = (0, c.mFp)(), H = (0, s.e7)([b.Z], () => b.Z.getSettings(a.id)), U = null == H ? void 0 : H.welcomeMessage, z = (0, C.Z)(a.id), G = !z && (null != (l = null == H || null == (n = H.resourceChannels) ? void 0 : n.length) ? l : 0) === 0, F = (0, d.Z)("(max-width: 1300px)"), q = h - y.PrS - T, V = L && q < A || F || G;
  return (r.useEffect(() => {
  ...
  }, [a.id, G, H]), G) ? null : (0, t.jsxs)(t.Fragment, {
