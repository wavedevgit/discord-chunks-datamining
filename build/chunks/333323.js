...
function W(e) {
  ...
  let {
    guild: a,
    width: h
  } = e, P = (0, s.e7)([f.ZP], () => f.ZP.getSection(O.oC.GUILD_HOME)), [W, R] = r.useState(!1), [D, T] = r.useState(y.$Y6), L = P === y.ULH.SIDEBAR_CHAT, B = (0, c.mFp)(), H = (0, s.e7)([b.Z], () => b.Z.getSettings(a.id)), z = null == H ? void 0 : H.welcomeMessage, U = (0, C.Z)(a.id), F = !U && (null != (l = null == H || null == (n = H.resourceChannels) ? void 0 : n.length) ? l : 0) === 0, G = (0, d.Z)("(max-width: 1300px)"), q = h - y.PrS - D, V = L && q < A || G || F;
  return (r.useEffect(() => {
