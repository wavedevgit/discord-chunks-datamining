...
function D(e) {
  ...
  let {
    guild: a,
    width: h
  } = e, P = (0, s.e7)([g.ZP], () => g.ZP.getSection(O.oC.GUILD_HOME)), [D, R] = l.useState(!1), [W, T] = l.useState(y.$Y6), L = P === y.ULH.SIDEBAR_CHAT, B = (0, o.mFp)(), H = (0, s.e7)([b.Z], () => b.Z.getSettings(a.id)), U = null == H ? void 0 : H.welcomeMessage, z = (0, C.Z)(a.id), F = !z && (null != (t = null == H || null == (n = H.resourceChannels) ? void 0 : n.length) ? t : 0) === 0, G = (0, d.Z)("(max-width: 1300px)"), q = h - y.PrS - W, V = L && q < A || G || F;
  return (l.useEffect(() => {
  ...
  }, [a.id, F, H]), F) ? null : (0, r.jsxs)(r.Fragment, {
