...
function L(e) {
  ...
  let {
    guild: a,
    width: h
  } = e, P = (0, s.e7)([g.ZP], () => g.ZP.getSection(O.oC.GUILD_HOME)), [L, T] = r.useState(!1), [D, R] = r.useState(N.$Y6), H = P === N.ULH.SIDEBAR_CHAT, B = (0, c.mFp)(), W = (0, s.e7)([b.Z], () => b.Z.getSettings(a.id)), U = null == W ? void 0 : W.welcomeMessage, G = (0, C.Z)(a.id), q = !G && (null != (t = null == W || null == (n = W.resourceChannels) ? void 0 : n.length) ? t : 0) === 0, z = (0, d.Z)("(max-width: 1300px)"), F = h - N.PrS - D, V = H && F < k || z || q;
  return (r.useEffect(() => {
  ...
  }, [a.id, q, W]), q) ? null : (0, l.jsxs)(l.Fragment, {
