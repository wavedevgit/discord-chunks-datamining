...
function D(e) {
  ...
  let {
    guild: a,
    width: h
  } = e, P = (0, s.e7)([g.ZP], () => g.ZP.getSection(O.oC.GUILD_HOME)), [D, T] = r.useState(!1), [R, L] = r.useState(y.$Y6), B = P === y.ULH.SIDEBAR_CHAT, H = (0, c.mFp)(), W = (0, s.e7)([b.Z], () => b.Z.getSettings(a.id)), U = null == W ? void 0 : W.welcomeMessage, z = (0, C.Z)(a.id), G = !z && (null != (l = null == W || null == (n = W.resourceChannels) ? void 0 : n.length) ? l : 0) === 0, F = (0, d.Z)("(max-width: 1300px)"), q = h - y.PrS - R, V = B && q < A || F || G;
  return (r.useEffect(() => {
  ...
  }, [a.id, G, W]), G) ? null : (0, t.jsxs)(t.Fragment, {
