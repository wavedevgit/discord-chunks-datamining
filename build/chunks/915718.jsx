...
class D extends Chunk73800.PureComponent {
  ...
  renderVoiceCallButton() {
    ...
    let y = <Chunk665149.ZP.Icon ref={this.iconRef} icon={Chunk481060.Csw} onClick={this.handleVoiceClick} disabled={Chunk590293} tooltip={module} tooltipColor={exports} />;
    return <Chunk243778.ZP contentTypes={Chunk451576}>{e => {
        let {
          visibleContent: t,
          markAsDismissed: l
        } = e;
  ...
  render() {
    return <Chunk73800.Fragment>{this.renderVoiceCallButton()}{this.renderVideoCallButton()}</Chunk73800.Fragment>
  }
  constructor(...e) {
...
function k(e) {
  ...
  }, []), s || (null == S ? true : S.bot)) ? null : <D channel={n} mode={o} inCall={c} callActive={g} isProvisional={null != (t = null == S ? true : S.isProvisional) && t} callUnavailable={b} notFriend={x} isBlocked={O} appContext={I} canShowTooltip={R} canShowActivityGdmTooltip={T} dismissibleContentTypes={Z} useReducedMotion={f} />
}