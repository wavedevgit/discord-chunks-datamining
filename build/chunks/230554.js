...
let m = (e, t, n) => ({
  ...
  getCurrentWord() {
    let t = e.selection;
    if (null == t || !_.Ew.isValid(e, t) || _.M8.isExpanded(t) || (0, f.L6)(e)) return {
      word: null,
      isAtStart: !1
    };
    let [n, r] = _.bN.node(e, _.C0.parent(t.anchor.path)), [i, a] = _.bN.node(e, t.anchor.path), o = t.anchor.offset;
