...
let h = (e, t, n) => ({
  ...
  getCurrentWord() {
    let t = e.selection;
    if (null == t || !f.Ew.isValid(e, t) || f.M8.isExpanded(t) || (0, p.L6)(e)) return {
      word: null,
      isAtStart: false
    };
    ...
    u.T.withSingleEntry(e, () => {
      ...
      if (null != r && a && (d.Q.removeInlineChildren(e, o), i = false), E(e, n, r, i), null != r && a) {
        ...
        if (o = f.q.updateElement(e, o), null != n) {
          ...
          (0, _.Gg)(e, o, t.id, r) && (o = f.q.updateElement(e, o))
        }
  ...
  insertAutocomplete(n) {
    let r = arguments.length > 1 && true !== arguments[1] ? arguments[1] : null,
      {
        addSpace: i = true,
        replaceFullWord: o = false
      } = arguments.length > 2 && true !== arguments[2] ? arguments[2] : {};
    u.T.withSingleEntry(e, () => {
      let a = c.HZ(e),
        s = null != a && g(t, a[0]);
      if (s) d.Q.removeInlineChildren(e, a), i = false;
      else {
        let {
          word: t,
          fullWord: n
        ...
        null != t && t.length > 0 && d.Q.delete(e, {
          ...
          unit: "character",
          reverse: true
        }), o && null != t && null != n && n.length - t.length > 0 && d.Q.delete(e, {
