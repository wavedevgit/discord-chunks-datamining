...
let p = (e, t, n) => ({
  ...
  getCurrentWord() {
    ...
    let [n, r] = u.bN.node(e, u.C0.parent(t.anchor.path)), [i, a] = u.bN.node(e, t.anchor.path), o = t.anchor.offset;
    if (!u.C0.hasPrevious(a) && u.LC.isText(i)) {
      let e = i.text.substring(0, o);
      if (u.aj.isType(n, "applicationCommand") && o < n.command.displayName.length + 2) return {
        word: e,
        isAtStart: !0
      }
    }
  ...
  insertEmoji(t) {
    ...
    l.T.withSingleEntry(e, () => {
      ...
      m(e, ":".concat(n.name, ":"), null != n.id ? "<".concat(a, ":").concat(o.replace(/:/g, ""), ":").concat(n.id, ">") : null, r)
    })
  }
});
