...
function ep(e) {
  let {
    ...
    let {
      ...
      firstMessage: v
    } = (0, u.e7)([y.Z], () => y.Z.getMessage(t.id), [t.id]), _ = k.nc.useSetting(), O = k.Sb.useSetting(), E = (0, u.e7)([B.Z], () => null == t.guild_id || B.Z.canChatInGuild(t.guild_id), [t]), {
      canManageMessages: j,
    ...
    let G = (0, K.a4)(n),
      ...
      ee = t.type === ei.d4z.GUILD_ANNOUNCEMENT && null != p && p.features.has(ei.GuildFeatures.NEWS) && (A || j) && (0, f.Z)(n),
      et = t.getGuildId(),
