...
function b(e) {
  let {
    ...
    "aria-label": b,
    delay: x = h
  } = e, [_, j] = r.useState(0), [C, E] = r.useState(!1), [O, v] = r.useState(!1), [S] = r.useState(() => new a.V7), [T] = r.useState(() => new a.V7);
  if (r.useEffect(() => () => {
      S.stop(), T.stop()
  ...
  let N = _ >= f.length - 1,
    ...
    y = C ? I : l.FGA.PRIMARY,
    A = () => {
      null == m || m(), (0, c.JG)(n), o.default.track(u.rMx.TEXT_COPIED), O || j(_ + 1), v(!0), E(!0), S.start(p, () => v(!1)), T.start(g, () => j(0))
    };
