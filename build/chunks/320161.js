...
function b(e) {
  let {
    ...
    "aria-label": b,
    delay: _ = h
  } = e, [x, E] = r.useState(0), [C, O] = r.useState(!1), [j, S] = r.useState(!1), [v] = r.useState(() => new l.V7), [T] = r.useState(() => new l.V7);
  if (r.useEffect(() => () => {
      v.stop(), T.stop()
  ...
  let N = x >= f.length - 1,
    ...
    y = C ? I : a.FGA.PRIMARY,
    A = () => {
      null == m || m(), (0, c.JG)(n), o.default.track(u.rMx.TEXT_COPIED), j || E(x + 1), S(!0), O(!0), v.start(g, () => S(!1)), T.start(p, () => E(0))
    };
