  ...
  constructor(e) {
    ...
    super(e), t = this, et(this, "draftDidChange", function() {
      ...
      return 0 === t.length ? Promise.resolve({
        ...
        return (p.Z.sendMessage(n.id, P.ZP.parse(n, t), !0, a), this.setState((0, C.H2)()), (0, T.A6)(n.id), r) ? (f.Z.deactivateAllRegions(), {
          shouldClear: !1,
          shouldRefocus: !1
        }) : {
          shouldClear: !0,
  ...
  constructor(...e) {
    super(...e), et(this, "handlePin", () => {
      ...
      null != t && null != r && (0, u.jW)(e, async () => {
        let {
          default: e
        } = await Promise.all([n.e("26881"), n.e("4040"), n.e("53912"), n.e("56826"), n.e("19196")]).then(n.bind(n, 131404));
