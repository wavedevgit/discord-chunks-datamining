  ...
  constructor(e) {
    ...
    super(e), t = this, en(this, "textAreaRef", r.createRef()), en(this, "draftDidChange", function() {
      ...
      return 0 === t.length ? Promise.resolve({
        ...
        return (p.Z.sendMessage(n.id, N.ZP.parse(n, t), !0, s), this.setState((0, j.H2)()), (0, D.A6)(n.id), r) ? (f.Z.deactivateAllRegions(), {
          shouldClear: !1,
          shouldRefocus: !1
        }) : {
          shouldClear: !0,
    ...
    return e = y && null != s ? (0, i.jsx)(O.Z, {
      ...
      children: (0, i.jsxs)(r.Fragment, {
        children: [!a && !h && (0, i.jsx)(E.Z, {
          ...
          children: _ ? (0, i.jsx)(Q.ZP.Background, {
            opacityOverride: a || h ? null : el,
            ...
            children: (0, i.jsx)(Q.ZP.Background, {
              ...
              children: (0, i.jsx)("div", {
                ...
                children: null != t.name && t.name.length > 0 ? ee.intl.formatToPlainString(ee.t["9TkYMD"], {
                  keybind: d,
