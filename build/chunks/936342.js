...
e.exports = function(e, t, n, h, m) {
  ...
  if (void 0 === m) return !!n && ("Undefined" === b || (l(h) ? i(c, _, s, e, t, h) : i(c, _, s, e, t, {
  ...
  if (!m["[[Configurable]]"]) {
    if ("[[Configurable]]" in h && h["[[Configurable]]"] || "[[Enumerable]]" in h && !_(h["[[Enumerable]]"], m["[[Enumerable]]"]) || !u(h) && !_(l(h), l(m))) return !1;
    if (l(m)) {
      if ("[[Get]]" in h && !_(h["[[Get]]"], m["[[Get]]"]) || "[[Set]]" in h && !_(h["[[Set]]"], m["[[Set]]"])) return !1
    } else if (!m["[[Writable]]"] && ("[[Writable]]" in h && h["[[Writable]]"] || "[[Value]]" in h && !_(h["[[Value]]"], m["[[Value]]"]))) return !1
  }
  return "Undefined" === b || (c(m) && l(h) ? i(c, _, s, e, t, {
