...
function D(e) {
  let {
    ...
    imageUrl: s,
    mimeType: d
  } = e, m = (0, o.e7)([P.Z], () => P.Z.getChannel(u)), {
    Component: p,
    events: f,
    play: O
  } = (0, i.w)(), [b, E] = l.useState(!1), g = l.useRef(null);
  return null == m ? null : (b || O(), (0, r.jsx)(a.yRy, {
    targetElementRef: g,
    renderPopout: e => {
      let {
        closePopout: t
...
function U(e) {
  let {
    ...
    imageUrl: P,
    mimeType: D
  } = e, U = (0, o.e7)([j.Z], () => j.Z.getGuild(i.guild_id)), {
    fetchState: x,
    imageRecCommandContexts: Z
  } = (0, M.h)({
    channelId: i.id
  }), k = x === w.M.FETCHING, F = (0, g.g)(i), L = (0, p.PL)(!0, !0), H = (0, p.LD)(i.guild_id, !0);
  l.useEffect(() => {
    (x === w.M.ERROR || x === w.M.FETCHED && 0 === Z.length) && n()
  }, [x, Z.length, n]), l.useEffect(() => {
    var e, t;
  ...
  let G = l.useCallback(async e => {
    ...
    B = l.useCallback(async (e, t, n, r) => {
      var l, o;
      if (!F) return;
      let a = e.applicationId,
        c = (null == (l = L.result) ? void 0 : l.sections[a]) != null,
        s = (null == (o = H.result) ? void 0 : o.sections[a]) != null;
      await G(r), null != f.Z.getActiveCommand(i.id) && m.Po({
        channelId: i.id,
        command: null,
        section: null
      }), c || s || p.ZP.queryInstallOnDemandApp(e.applicationId, i.id), m.Po({
        channelId: i.id,
        command: e,
        section: t,
        location: n,
  ...
  return (0, r.jsxs)(a.v2r, {
    ...
    children: [(0, r.jsx)(a.sNh, {
      ...
      navigable: !1,
      disabled: !0
    }, "menu-image-rec-header"), (0, r.jsx)(a.Clw, {}), k ? (0, r.jsx)(a.sNh, {
