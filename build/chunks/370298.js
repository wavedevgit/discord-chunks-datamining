...
function D(e) {
  let {
    ...
    events: f,
    play: b
  } = (0, a.w)(), [O, E] = l.useState(!1), g = l.useRef(null);
  return null == m ? null : (O || b(), (0, r.jsx)(i.yRy, {
    targetElementRef: g,
    renderPopout: e => {
      let {
        closePopout: t
    ...
    children: e => {
      ...
      return (0, r.jsx)(i.ua7, {
        ...
        children: e => {
          var n, l;
          return (0, r.jsx)(i.P3F, (n = R({}, e), l = l = {
            className: c,
            focusProps: {
              offset: 2
            },
...
function x(e) {
  let {
    ...
    channelId: a.id
  }), k = U === w.M.FETCHING, F = (0, g.g)(a), L = (0, p.PL)(!0, !0), G = (0, p.LD)(a.guild_id, !0);
  l.useEffect(() => {
    ...
    }), _.default.track(I.rMx.APP_IMAGE_RECS_MENU_VIEWED, {
  ...
  let B = l.useCallback(async e => {
      let t = await fetch(j),
        ...
        r = D.join("/"),
        l = new File([n], "image".concat((0, M.Q)({
          contentType: r
        })), {
          type: r
        });
    ...
    H = l.useCallback(async (e, t, n, r) => {
      ...
      let i = e.applicationId,
        ...
        s = (null == (o = G.result) ? void 0 : o.sections[i]) != null;
      await B(r), null != f.Z.getActiveCommand(a.id) && m.Po({
        channelId: a.id,
        command: null,
        section: null
      }), c || s || p.ZP.queryInstallOnDemandApp(e.applicationId, a.id), m.Po({
        channelId: a.id,
        command: e,
        section: t,
        location: n,
        ...
        location: n,
        sectionName: t.name
      }), N.S.dispatch(I.CkL.FOCUS_CHANNEL_TEXT_AREA, {
        channelId: a.id
      })
    }, [a.id, B, F, L, G]),
    V = l.useCallback(async (e, t, n) => {
      ...
      let o = e.applicationId,
        i = (null == (r = L.result) ? void 0 : r.sections[o]) != null,
        c = (null == (l = G.result) ? void 0 : l.sections[o]) != null;
    ...
    children: [(0, r.jsx)(i.sNh, {
      ...
      children: Z.filter(e => null != e.imageOption).map(e => {
        let t = e.overrideSendCommand,
          ...
          c = e.imageOption;
        return null == c ? null : (0, r.jsx)(i.sNh, {
          id: e.command.id,
          action: () => {
            o ? H(e.command, e.section, b.Vh.IMAGE_RECS_MENU, c) : V(l ? t : e.command, b.Vh.IMAGE_RECS_MENU, l ? n.imageOption : c)
          },
          ...
          children: l ? (0, r.jsxs)(r.Fragment, {
            children: [(0, r.jsx)(i.sNh, {
              ...
              icon: i.Uuj
            }, "".concat(e.command.id, "-send")), (0, r.jsx)(i.sNh, {
