...
function M(e) {
  let {
    ...
    events: p,
    play: h
  } = (0, o.w)(), [m, g] = i.useState(!1), E = i.useRef(null);
    ...
    children: e => {
      ...
      return (0, r.jsx)(s.ua7, {
        ...
        children: e => (0, r.jsx)(s.P3F, j(x({}, e), {
          ...
          "aria-label": P.intl.string(P.t.emnnEB),
          children: (0, r.jsx)(_, {
            size: "custom",
            width: 20,
            height: 20,
...
function U(e) {
  let {
    ...
    imageUrl: I,
    mimeType: L
  } = e, k = (0, a.e7)([S.Z], () => S.Z.getGuild(o.guild_id)), {
    fetchState: j,
    imageRecCommandContexts: M
  } = (0, C.h)({
    channelId: o.id
  }), U = j === w.M.FETCHING, G = (0, E.g)(o), B = (0, _.PL)(!0, !0), Z = (0, _.LD)(o.guild_id, !0);
  i.useEffect(() => {
    (j === w.M.ERROR || j === w.M.FETCHED && 0 === M.length) && n()
  }, [j, M.length, n]), i.useEffect(() => {
    var e, t;
    if (U || 0 === M.length) return;
    let n = [];
    M.forEach(e => {
      n.push(Number(e.command.id)), null != e.overrideSendCommand && n.push(Number(e.overrideSendCommand.id))
    }), A.default.track(R.rMx.APP_IMAGE_RECS_MENU_VIEWED, {
  ...
  return (0, r.jsxs)(s.v2r, {
    ...
    onClose: n,
    "aria-label": P.intl.string(P.t.P3ShV1),
    children: [(0, r.jsx)(s.sNh, {
      ...
      render: () => (0, r.jsx)(s.Text, {
        ...
        children: P.intl.string(P.t.emnnEB)
      }),
      navigable: !1,
      disabled: !0
        ...
        return null == l ? null : (0, r.jsx)(s.sNh, {
          ...
          children: i ? (0, r.jsxs)(r.Fragment, {
            children: [(0, r.jsx)(s.sNh, {
              ...
              label: P.intl.string(P.t["M+BhUV"]),
              subtext: P.intl.string(P.t.zXFjJS),
              action: () => H(t, h.Vh.IMAGE_RECS_SUBMENU, n.imageOption),
              icon: s.Uuj
            }, "".concat(e.command.id, "-send")), (0, r.jsx)(s.sNh, {
              id: "".concat(e.command.id, "-edit"),
              label: P.intl.string(P.t["wTaN+P"]),
              subtext: P.intl.string(P.t.bIB3bm),
              action: () => {
