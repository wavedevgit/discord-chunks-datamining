...
function T(e) {
  let {
    ...
    footer: S,
    isGift: A = !1,
    giftMessage: N = b.intl.string(b.t.DrgnS0),
    hideBreadcrumbs: C = !1,
    isLoading: R = !1,
    purchaseError: P,
  ...
  let {
    stripe: U,
    paymentElementsEnabled: G
  } = (0, p.JL)();
  R = R || null == U;
  let B = i.useRef(new l.V7);
  i.useEffect(() => {
    let e = B.current;
    return null != U || e.isStarted() ? null != U && e.stop() : e.start(10 * g.Z.Millis.SECOND, () => {
  ...
  return (0, r.jsxs)(a.Elements, {
    ...
    children: [T, (0, r.jsxs)("div", {
      ...
      children: [A && n !== h.h8.CONFIRM ? (0, r.jsx)(u.Z, {
        ...
        children: (0, r.jsx)(c.OoM, {
          ...
          breadcrumbs: t.filter(e => !h.Ck.has(e) && !I.has(e)).map(e => ({
            id: e,
            label: (0, h.DJ)(e)
          }))
        })
