...
function T(e) {
  ...
  } = (0, l.ZP)(), [P, D] = i.useState(c), L = w(s), [x, k] = (0, f.L)(n, {
    location: L
  }), {
    id: j
  } = (0, f.p)(n), M = null != p ? p : j, U = (0, a.e7)([u.Z], () => N(u.Z)), G = (0, r.jsx)(o.R94, {
    type: o.R94.Types.DESCRIPTION,
    className: g.marginTop8,
    children: C()
  }), B = i.useCallback(e => {
    if (e === v) D(!0), d.default.track(_.rMx.DEVICES_LIST_SHOW_MORE_CLICKED, {
      device_type: n,
      location: L,
      location_stack: R,
      ...
      var t;
      (null == (t = null == E ? void 0 : E(e)) || t) && S(e, {
        location: L,
        analyticsLocations: R
      })
    }
