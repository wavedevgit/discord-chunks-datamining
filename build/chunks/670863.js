...
function y(e) {
  ...
  let {
    ...
    [m.h7.AUDIO_INPUT]: {
      ...
      getWarningMessage: () => g.intl.format(g.t["1iK6UV"], {
    ...
    [m.h7.AUDIO_OUTPUT]: {
      ...
      getWarningMessage: () => g.intl.format(g.t.Ow0dbG, {
  ...
  } = (0, s.ZP)(), [N, Z] = i.useState(h), D = E(y), [A, k] = (0, f.L)(n, {
    location: D
  }), {
    id: L
  } = (0, f.p)(n), M = (0, l.e7)([u.Z], () => C(u.Z)), R = (0, r.jsx)(a.R94, {
    type: a.R94.Types.DESCRIPTION,
    className: v.marginTop8,
    children: w()
  }), U = i.useCallback(e => {
    if (e === b) Z(!0), d.default.track(p.rMx.DEVICES_LIST_SHOW_MORE_CLICKED, {
      device_type: n,
      location: D,
      location_stack: T,
      ...
      var t;
      (null == (t = null == j ? void 0 : j(e)) || t) && I(e, {
        location: D,
        analyticsLocations: T
      })
    }
  }, [n, D, A.length, k.length, T, j, I]), V = null != (t = x.renderOptionLabel) ? t : function(e) {
    let {
      label: t
    } = e;
    return (0, r.jsxs)("div", {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(a.q4e, function(e) {
