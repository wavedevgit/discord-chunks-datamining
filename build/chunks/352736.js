...
function A(t) {
  return (0, r.Rp)(E.intl.formatToParts(E.t["ihxM9/"], {
    username: t,
...
let g = {
  stringify: function(t, e) {
    ...
    switch (t.type) {
      case T.uaV.RECIPIENT_ADD:
        if (null == C) return;
        return (0, r.Rp)(E.intl.formatToParts(E.t["7/Xl0d"], {
          username: g,
          usernameOnClick: T.dG4,
      ...
      case T.uaV.RECIPIENT_REMOVE:
        if (null == C) return;
        let P = t.author;
        if (null == P || P.id === C.id) return (0, r.Rp)(E.intl.formatToParts(E.t["Qn5+LS"], {
          username: g,
          usernameOnClick: T.dG4
        }));
        return (0, r.Rp)(E.intl.formatToParts(E.t.QtZ0RE, {
          username: g,
          usernameOnClick: T.dG4,
          otherUsername: _.ZP.getName(null, I, C),
          otherUsernameOnClick: T.dG4
      ...
      case T.uaV.CALL:
        ...
        if (null != O && -1 === O.participants.indexOf(m.default.getId())) return (0, r.Rp)(E.intl.formatToParts(E.t.DbgSAw, {
          username: g,
          usernameOnClick: T.dG4
        }));
        return;
      case T.uaV.CHANNEL_NAME_CHANGE:
        return (0, r.Rp)(E.intl.formatToParts(e.isForumPost() ? E.t["qa0e/v"] : E.t.XCPMEB, {
          username: g,
          usernameOnClick: T.dG4,
          channelName: t.content
        }));
      case T.uaV.CHANNEL_ICON_CHANGE:
        return (0, r.Rp)(E.intl.formatToParts(E.t.wypJZ2, {
          username: g,
          usernameOnClick: T.dG4
        }));
      case T.uaV.CHANNEL_PINNED_MESSAGE:
        return (0, r.Rp)(E.intl.formatToParts(E.t["/M60j4"], {
          username: g,
          usernameOnClick: T.dG4
        }));
      case T.uaV.USER_JOIN:
        return (0, r.Rp)(E.intl.formatToParts(R(t.id), {
          username: g,
          usernameOnClick: T.dG4
        }));
      ...
      case T.uaV.GUILD_BOOST_TIER_3:
        ...
        return null == G || null == f.Z.getGuild(G.getGuildId()) ? A(g) : (0, r.Rp)(E.intl.formatToParts(E.t["ihxM9/"], {
          username: g,
          usernameOnClick: T.dG4
        }));
      ...
      case T.uaV.AUTO_MODERATION_ACTION:
        if (null == (h = t.embeds) ? void 0 : h.some(t => {
            let {
              type: e
            } = t;
          ...
          return null == e ? null : (0, r.Rp)(E.intl.formatToParts(E.t["a+lJKi"], {
            guildName: e.name
          }))
        }
        return t.content;
      case T.uaV.GUILD_INCIDENT_ALERT_MODE_ENABLED:
        ...
        return null == U ? null : (0, r.Rp)(E.intl.formatToParts(E.t.iOuWPj, {
          username: g,
          guildName: U.name,
          time: "" !== S ? new Date(S).toLocaleString(E.intl.currentLocale, {
            hour: "numeric",
            minute: "2-digit"
          }) : ""
        }));
      case T.uaV.GUILD_INCIDENT_ALERT_MODE_DISABLED:
        ...
        return null == V ? null : (0, r.Rp)(E.intl.formatToParts(E.t.axmbpq, {
          username: g,
          guildName: V.name
        }));
      default:
  ...
  getSystemMessageBotJoin: function(t) {
    return null == h[t] ? null : E.intl.format(E.t.xw1Ij4, {
      learnOnClick: {
