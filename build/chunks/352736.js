  ...
  stringify: function(t, e) {
    ...
    switch (t.type) {
      ...
      case E.uaV.GUILD_BOOST_TIER_3:
        ...
        return null == S || null == m.Z.getGuild(S.getGuildId()) ? G(A) : (0, r.Rp)(p.NW.formatToParts(p.t["ihxM9/"], {
          username: A,
          usernameOnClick: E.dG4
        }));
      ...
      case E.uaV.AUTO_MODERATION_ACTION:
        if (null == (T = t.embeds) ? void 0 : T.some(t => {
          ...
          return null == e ? null : (0, r.Rp)(p.NW.formatToParts(p.t["a+lJKi"], {
            guildName: e.name
          }))
        }
        return t.content;
      case E.uaV.GUILD_INCIDENT_ALERT_MODE_ENABLED:
        ...
        return null == M ? null : (0, r.Rp)(p.NW.formatToParts(p.t.iOuWPj, {
          username: A,
          guildName: M.name,
          time: "" !== k ? new Date(k).toLocaleString(p.NW.currentLocale, {
            hour: "numeric",
            minute: "2-digit"
          }) : ""
        }));
      case E.uaV.GUILD_INCIDENT_ALERT_MODE_DISABLED:
        ...
        return null == v ? null : (0, r.Rp)(p.NW.formatToParts(p.t.axmbpq, {
          username: A,
          guildName: v.name
        }));
      default:
