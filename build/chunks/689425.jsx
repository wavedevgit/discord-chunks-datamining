...
class _ extends(r = Chunk73800.PureComponent) {
  ...
  render() {
    ...
    return <Chunk748780.Z.div ref={this._ref} className={require} onMouseDown={this.handleMouseDown} style={Chunk981631} onDragStart={this.handleHTMLDragStart}>{r}</Chunk748780.Z.div>
  }
  constructor(e) {
