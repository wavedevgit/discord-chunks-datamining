...
function p(n) {
  ...
  let {
    ...
    application: p,
    onClose: h
  } = n, _ = (0, d.Dt)(), [j, C] = e.useState(null == p || null == (t = p.team) ? void 0 : t.id), {
    teams: v
  } = (0, u.Z)(), b = e.useMemo(() => v.filter(n => n.payout_account_status === x.C.ACTIVE).map(n => ({
    label: n.name,
    value: n.id
  })), [v]), f = (null == p || null == (i = p.team) ? void 0 : i.id) !== j, [k, {
    loading: N,
    error: w
  }] = (0, o.Z)(c.ZP.transferApplication), z = async () => {
    a()(null != p, "no application"), a()(null != j, "no team selected"), null != await k({
      applicationId: p.id,
      teamId: j
    }) && h()
