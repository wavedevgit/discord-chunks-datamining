...
function h(n) {
  ...
  let {
    ...
    application: h,
    onClose: N
  } = n, _ = (0, d.Dt)(), [p, j] = s.useState(null == h || null == (e = h.team) ? void 0 : e.id), {
    teams: v
  } = (0, u.Z)(), C = s.useMemo(() => v.filter(n => n.payout_account_status === x.C.ACTIVE).map(n => ({
    label: n.name,
    value: n.id
  })), [v]), b = (null == h || null == (t = h.team) ? void 0 : t.id) !== p, [W, {
    loading: f,
    error: k
  }] = (0, c.Z)(o.ZP.transferApplication), w = async () => {
