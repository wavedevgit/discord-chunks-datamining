...
function h(n) {
  ...
  let {
    ...
    application: h,
    onClose: _
  } = n, p = (0, d.Dt)(), [j, v] = e.useState(null == h || null == (t = h.team) ? void 0 : t.id), {
    teams: C
  } = (0, u.Z)(), b = e.useMemo(() => C.filter(n => n.payout_account_status === x.C.ACTIVE).map(n => ({
    label: n.name,
    value: n.id
  })), [C]), f = (null == h || null == (i = h.team) ? void 0 : i.id) !== j, [k, {
    loading: N,
    error: w
  }] = (0, c.Z)(o.ZP.transferApplication), z = async () => {
    a()(null != h, "no application"), a()(null != j, "no team selected"), null != await k({
      applicationId: h.id,
      teamId: j
    }) && _()
