...
let d = () => {
  ...
  return <div className={Chunk977003.container}>{<Chunk481060.Text variant={"text-md/normal"}>{"Shop Home Override"}</Chunk481060.Text>}{<Chunk481060.q4e className={Chunk977003.selector} options={exports} value={module} onChange={e => {
        (0, s.fi)(e)
      }} />}</div>
}