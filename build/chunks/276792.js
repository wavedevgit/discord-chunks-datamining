...
function N(e) {
  ...
  let w = "" !== v.helpArticleId ? () => (0, r.jsxs)(r.Fragment, {
  ...
  null != v.heroArtVideoSubtitles && (L.subtitles = v.heroArtVideoSubtitles.map(e => ({
    locale: e.locale,
    src: e.link,
    isDefault: !1
  }))), ("" !== v.heroArtImageLinkDarkTheme || "" !== v.heroArtImageLinkLightTheme) && (L = {
    type: "image",
