...
function E(e) {
  ...
  let x = "" !== I.helpArticleId ? () => (0, r.jsxs)(r.Fragment, {
  ...
  null != I.heroArtVideoSubtitles && (Z.subtitles = I.heroArtVideoSubtitles.map(e => ({
    locale: e.locale,
    src: e.link,
    isDefault: !1
  }))), ("" !== I.heroArtImageLinkDarkTheme || "" !== I.heroArtImageLinkLightTheme) && (Z = {
    type: "image",
    src: N ? I.heroArtImageLinkLightTheme : I.heroArtImageLinkDarkTheme
  });
  let w = "" !== I.modalTopPill ? () => (0, r.jsx)(d.mn, {
    text: I.modalTopPill,
