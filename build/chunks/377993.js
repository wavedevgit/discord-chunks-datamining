...
function w(e) {
  let {
    ...
    status: u,
    activities: d
  } = e, p = (0, a.e7)([x.Z], () => null != x.Z.getTypingUsers(o.id)[t.id]), f = (0, a.e7)([y.default], () => y.default.getCurrentUser()), C = (0, a.e7)([b.Z], () => b.Z.isMobileOnline(t.id)), j = (0, a.e7)([_.Z], () => _.Z.getNickname(t.id)), E = (0, h.Z)(t.id), Z = i.useRef(null), T = e => {
    (0, s.jW)(e, async () => {
      let {
        default: e
...
function k(e) {
  let {
    ...
    listItems: c
  } = (0, a.e7)([_.Z, y.default, b.Z], () => {
    let e = (0, j.T)(t.recipients, y.default),
      n = {};
    for (let t of e) {
      var r, i, l;
      _.Z.isFriend(t.id) || t.id === (null == (r = y.default.getCurrentUser()) ? void 0 : r.id) ? n[t.id] = {
      ...
      children: (0, r.jsx)("aside", {
        ...
        children: (0, r.jsxs)(o.Ttm, {
          ...
          children: [(0, r.jsxs)(f.Z, {
            ...
            children: ["".concat(S.intl.string(S.t["9Oq93t"]), "—").concat(c.length, " "), h && (0, r.jsx)(p.Z, {
