...
let v = 8,
  ...
  _ = r.memo(function(e) {
    let {
      ...
      height: S,
      pinned: j
    })), N = (0, c.Z)(n), Z = o === h.C5.VERTICAL, w = 0, P = 0, T = (0, s.Yzy)(Z ? C.map((e, t) => O(y({}, e), {
      ...
      config: E,
      trail: 100 * (n === N)
    }, n !== N ? "animate-never" : "respect-motion-settings"), k = (0, p.ee)(() => new Set(I.map(e => e.user.id)), [I, x]), D = (0, p.ee)(() => new Set(I.filter(e => _.has((0, u.V9)(e.stream))).map(e => e.user.id)), [I, _, x]);
    return r.useEffect(() => {
      0 !== k.size && (0, p.zi)(m.Odu.GO_LIVE, {
