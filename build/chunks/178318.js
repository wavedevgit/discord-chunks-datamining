...
function T() {
  ...
  i.listen(E.V6Z + e % E.frH, "127.0.0.1", t)
}
...
class x extends Chunk76238.Z {
  send(e) {
    (u.default.isLoggingOverlayEvents || e.cmd !== E.Etm.OVERLAY && e.evt !== E.zMe.OVERLAY) && y.info("Socket Emit: ".concat(this.id), (0, g.Z)(e)), null != r && "etf" === this.encoding ? this._socket.send(r.pack(e), {
      binary: true
...
class P extends Chunk76238.Z {
  send(e) {
    (u.default.isLoggingOverlayEvents || e.cmd !== E.Etm.OVERLAY) && y.info("Socket Emit: ".concat(this.id), e), this._sendCallback(e)
  }
  close(e, t) {
...
class A extends Chunk836560.EventEmitter {
  ...
  handleMessage(e, t) {
    ...
    try {
      ...
      return
    }(u.default.isLoggingOverlayEvents || n.cmd !== E.Etm.OVERLAY) && y.info("Socket Message: ".concat(e.id), (0, g.Z)(n)), this.emit("request", e, n)
  }
  constructor() {
    var e;
    super();
