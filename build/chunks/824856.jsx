...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk993553 = require("./993553.js"),
  Chunk53524 = require("./53524.js");
...
function b(e) {
  ...
  return null == C ? null : <l.l className={a()(f.wrapper, s)} header={(0, i.jsxs)(i.Fragment, {
    ...
    })}>{!(0, p.Ew)(_) && <div className={f.description}><h.Z variant={"text-sm/medium"}>{_}</h.Z></div>}{null != x && x.length > 0 && <div className={f.benefits}>{x.map(e => {
        let {
          id: t,
          name: n,
          description: r,
