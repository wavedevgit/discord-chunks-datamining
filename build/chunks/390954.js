...
class j extends s.PureComponent {
  ...
  render() {
    ...
    } = this.props, c = a().values(t).sort((t, n) => t.id === e ? -1 : n.id === e ? 1 : p.default.compare(t.id, n.id)), d = this.state.editingPayment, m = c.findIndex(e => e.id === d), g = c.map((t, a) => (0, r.jsx)(C, {
      locale: n,
      paymentSource: t,
      isDefault: e === t.id,
