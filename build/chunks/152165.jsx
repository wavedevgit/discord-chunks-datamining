...
let d = Chunk73800.memo(function(e) {
  ...
  return <svg className={s()(c.nativePickerGuide, t)} width={"392"} height={"254"} viewBox={"0 0 392 254"} fill={"none"} xmlns={"http://www.w3.org/2000/svg"}>{true !== n || f ? (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsxs)("g", {
        clipPath: u("clip0"),
