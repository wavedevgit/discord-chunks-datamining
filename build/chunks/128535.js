...
let b = e => 0 === e.length ? f.warning : f.danger,
  v = (e, t) => 0 === e.length ? C.intl.formatToPlainString(C.t.gX0Qc3, {
    gameTitle: t
  }) : C.intl.formatToPlainString(C.t["28Ql29"], {
    gameTitle: t
  }),
  y = e => {
    let {
    ...
    (0, g.Nj)({
      quest: t
    }) && x.push((0, d.isWeb)() ? C.intl.string(C.t["0UTkPz"]) : C.intl.string(C.t.XGRUho));
    let j = [...x, ...s.map(e => {
