...
let p = ["1366494385738354769", "1385035256125591633"],
  g = e => {
    ...
    return <div className={a()(d.col2, d.centeredSection)}>{null == n ? true : n.subblocks.map((e, n) => {
  ...
  f = e => {
    ...
    return <div className={a()(d.col2, d.centeredSection)}><s.k0 newValue={{
          categoryPosition: 1,
          pageCategory: null != l ? l.name : null == i ? true : i.name,
          pageSection: "featured_block",
          tilePosition: +(null == l)
        }}>{null != l && <c.q category={l} badgeText={p} handleTransition={t} />}{null != i && <c.q category={i} badgeText={u.intl.string(u.t["o/oRJC"])} handleTransition={t} />}</s.k0></div>
  },
  b = e => {
    let {
      isLoading: t,
    ...
    return t ? <div className={a()(d.col2, d.centeredSection)}>{<div className={a()(d.skeleton, d.featuredBlock)}><div className={d.skeletonBody} /></div>}{<div className={a()(d.skeleton, d.featuredBlock)}><div className={d.skeletonBody} /></div>}</div> : null != i ? <g featuredBlockRecord={i} handleTransition={n} isLoading={false} /> : <f categories={l} handleTransition={n} isLoading={false} />
  }