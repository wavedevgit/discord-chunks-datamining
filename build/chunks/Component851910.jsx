...
let g = [8, 16, 11, 13, 6],
  ...
  m = "translate(".concat(12.33 - 15 * f, ", ").concat(1 - 15.5 * f, ") scale(").concat(f, ")");
...
function T(e) {
  let {
    ...
    return i.useEffect(() => {
      let e;
      if (r.current = t.firstState, a.current = null, l(t.states[t.firstState].getHeights()), !o) return;
      a.current = {
        now: Date.now(),
  ...
  return T ? (0, l.jsx)("span", {
    ...
    children: (0, l.jsxs)("svg", {
      ...
      children: [C, (0, l.jsx)("g", {
        ...
        children: D.map((e, n) => {
          let i = e.height;
          return (0, l.jsx)(r.animated.rect, {
            x: _ + 4 * n,
            y: i.to(e => (f - e) / 2),
            width: 2,
            height: i,
