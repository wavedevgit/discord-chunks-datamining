...
class f extends Chunk73800.PureComponent {
  render() {
    ...
    let n = this.props,
      ...
      f = +(null != Chunk442837);
    return (f += Chunk73800.length) < 2 ? null : <Chunk585237.Z{...e = function(e) {
  ...
  constructor(...e) {
    super(...e), d(this, "renderContextMenu", () => {
      let {
        ...
        onMenuSelect: i
      } = this.props, l = e.map(e => e.id !== n ? <a.sNh id={"".concat(e.id)} label={e.id} action={() => {
          o.Zy(), null == t || t(e)
        }} /> : null);
      return <a.v2r onSelect={i} navId={"test-store-listing"} aria-label={u.intl.string(u.t.ogxXGh)} onClose={o.Zy}>{l}</a.v2r>
