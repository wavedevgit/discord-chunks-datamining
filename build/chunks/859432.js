...
let V = r.memo(function(e) {
  ...
  a()(null != J, "GuildHeaderPopout: user cannot be undefined"), r.useEffect(() => {
    M.default.track(B.rMx.GUILD_DROPDOWN_MENU_VIEWED, {
      guild_id: t.id
    })
  });
  ...
  return ei || er ? (0, i.jsx)(d.v2r, {
    ...
    onClose: l,
    "aria-label": Q.intl.string(Q.t.HpQykZ),
    children: [(0, i.jsxs)(d.kSQ, {
      children: [ey && (0, i.jsx)(d.sNh, {
        id: "add-channel",
        label: Q.intl.string(Q.t["6uDHk5"]),
        color: "brand",
        icon: d.oFk,
        action: () => (0, d.ZDy)(async () => {
          let {
            default: e
    ...
    children: [(0, i.jsxs)(d.kSQ, {
      ...
      }), (0, N.up)(t) && (0, N.jq)(t) && (0, i.jsx)(d.sNh, {
        id: "guild-tag",
      ...
      children: [en && J.isStaff() && eO ? (0, i.jsx)(d.sNh, {
        id: "create-deadchat",
        label: "Deadchat Ping",
        icon: d.eQA,
        action: () => {
      ...
      }) : null, en && J.isStaff() && ej ? (0, i.jsx)(d.sNh, {
      ...
      children: [eb, (0, i.jsx)(d.sNh, {
        id: "notifications",
        label: (0, i.jsxs)("div", {
          className: Y.newBadgeRow,
          children: [Q.intl.string(Q.t.h850Sk), eI && (0, i.jsx)(d.IGR, {
      ...
      children: [ep, et && t.isCommunity() ? (0, i.jsx)(d.sNh, {
        id: "report-raid",
        label: Q.intl.string(Q.t.cswId3),
        icon: d.b7C,
        color: "danger",
        action: () => (0, I.J)(t.id)
      }) : null, en ? null : (0, i.jsx)(d.sNh, {
        id: "leave",
        label: Q.intl.string(Q.t.J2TBi4),
        icon: d.PBZ,
        color: "danger",
