...
let Q = r.memo(function(e) {
  ...
  l()(null != Y, "GuildHeaderPopout: user cannot be undefined"), r.useEffect(() => {
  ...
  return $ || ee ? (0, i.jsx)(s.v2r, {
    ...
    children: [(0, i.jsx)(s.kSQ, {
      ...
      children: [X && Y.isStaff() && eg ? (0, i.jsx)(s.sNh, {
        id: "create-deadchat",
        label: "Deadchat Ping",
        icon: s.eQA,
        action: () => {
      ...
      }) : null, X && Y.isStaff() && ef ? (0, i.jsx)(s.sNh, {
      ...
      children: [eo, (0, i.jsx)(s.sNh, {
        id: "notifications",
        label: (0, i.jsxs)("div", {
          className: M.newBadgeRow,
          children: [R.NW.string(R.t.h850Sk), eO && (0, i.jsx)(s.IGR, {
      ...
      children: [ed, K && t.isCommunity() ? (0, i.jsx)(s.sNh, {
        id: "report-raid",
        label: R.NW.string(R.t.cswId3),
        icon: s.b7C,
        color: "danger",
        action: () => (0, D.J)(t.id)
      }) : null, X ? null : (0, i.jsx)(s.sNh, {
        id: "leave",
        label: R.NW.string(R.t.J2TBi4),
        icon: s.PBZ,
        color: "danger",
