...
let z = r.memo(function(e) {
  let {
    ...
    onClose: l,
    onSelect: z
  } = e, X = (0, o.e7)([L.default], () => L.default.getCurrentUser());
  ...
  return er || el ? (0, i.jsx)(s.v2r, {
    ...
    children: [(0, i.jsxs)(s.kSQ, {
      ...
      }), (0, S.up)(t) && (0, S.jq)(t) && (0, i.jsx)(s.sNh, {
        id: "guild-tag",
      ...
      children: [ei && X.isStaff() && ex ? (0, i.jsx)(s.sNh, {
        id: "create-deadchat",
        label: "Deadchat Ping",
        icon: s.eQA,
        action: () => {
      ...
      }) : null, ei && X.isStaff() && eP ? (0, i.jsx)(s.sNh, {
      ...
      children: [eb, (0, i.jsx)(s.sNh, {
        ...
        label: (0, i.jsxs)("div", {
          ...
          children: [Y.intl.string(Y.t.h850Sk), ew && (0, i.jsx)(s.IGR, {
      ...
      children: [ey, en && t.features.has(R.oNc.COMMUNITY) ? (0, i.jsx)(s.sNh, {
        id: "report-raid",
