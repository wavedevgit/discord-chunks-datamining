...
let X = a.memo(function(e) {
  let {
    ...
    onClose: r,
    onSelect: X
  } = e, q = (0, o.e7)([B.default], () => B.default.getCurrentUser());
  l()(null != q, "GuildHeaderPopout: user cannot be undefined"), a.useEffect(() => {
    F.default.track(H.rMx.GUILD_DROPDOWN_MENU_VIEWED, {
      guild_id: t.id
    })
  });
  ...
  return ea || er ? (0, i.jsx)(c.v2r, {
    ...
    children: [(0, i.jsxs)(c.kSQ, {
      ...
      children: [ei && q.isStaff() && eO ? (0, i.jsx)(c.sNh, {
        id: "create-deadchat",
        label: "Deadchat Ping",
        icon: c.eQA,
        action: () => {
      ...
      }) : null, ei && q.isStaff() && em ? (0, i.jsx)(c.sNh, {
      ...
      children: [eb, (0, i.jsx)(c.sNh, {
        ...
        label: (0, i.jsxs)("div", {
          ...
          children: [Y.intl.string(Y.t.h850Sk), eI && (0, i.jsx)(c.IGR, {
      ...
      children: [eh, en && t.features.has(H.oNc.COMMUNITY) ? (0, i.jsx)(c.sNh, {
        id: "report-raid",
        label: Y.intl.string(Y.t.cswId3),
        icon: c.b7C,
        color: "danger",
        action: () => (0, P.J)(t.id)
      }) : null, ei ? null : (0, i.jsx)(c.sNh, {
        id: "leave",
        label: Y.intl.string(Y.t.J2TBi4),
        icon: c.PBZ,
        color: "danger",
