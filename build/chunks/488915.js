...
let T = new c.h(e => [S(e.application_id), ...e.subscription_listings_ids.map(_)], e => e.id),
  h = new c.h(e => [S(e.application_id), O(e.subscription_plans[0].id)], e => e.id),
  b = new c.h(e => [I(e.applicationId, e.isValid(null, f.Z), e.guildId), g(e.isValid(null, f.Z), e.guildId)], e => e.id),
  N = {},
  C = {};
...
o = "ApplicationSubscriptionStore", (l = "displayName") in m ? Object.defineProperty(m, l, {
  value: o,
  enumerable: !0,
  configurable: !0,
  writable: !0
...
let P = new m(d.Z, {
  ...
  APPLICATION_SUBSCRIPTIONS_FETCH_LISTINGS: function(e) {
    ...
    let r = T.get(n);
    if (null != r)
      for (let e of r.subscription_listings_ids) h.delete(e)
  },
