...
let E = new s.h(e => [p(e.application_id), ...e.subscription_listings_ids.map(_)], e => e.id),
  b = new s.h(e => [p(e.application_id), h(e.subscription_plans[0].id)], e => e.id),
  y = new s.h(e => [m(e.applicationId, e.isValid(null, u.Z), e.guildId), g(e.isValid(null, u.Z), e.guildId)], e => e.id),
  O = {},
  v = {};
