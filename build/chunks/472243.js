...
function S(e) {
  ...
  let {
    ...
    className: N
  } = e, A = (0, a.e7)([f.default], () => p.ZP.canUseIncreasedMessageLength(f.default.getCurrentUser())), C = (0, u.Z)(), R = null != I ? I : C, P = null !== (v = null != T ? T : I) && void 0 !== v ? v : C / 10, D = S.length, w = null != y.upsellLongMessages && (null != D ? D : 0) > h.J6R && A, L = null != y.upsellLongMessages && !A, x = (null === (n = (0, d.N)()) || void 0 === n ? void 0 : null === (t = n.subscription_trial) || void 0 === t ? void 0 : t.sku_id) === m.Si.TIER_2, M = R - D, j = M > P, k = M < 0 && x, U = 0 === M ? g.NW.string(g.t.tU6YQ0) : M > 0 ? g.NW.formatToPlainString(g.t.qH8uFR, {
    count: M
