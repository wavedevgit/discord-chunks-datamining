...
function I(e) {
  ...
  let {
    ...
    className: A
  } = e, N = (0, o.e7)([f.default], () => _.ZP.canUseIncreasedMessageLength(f.default.getCurrentUser())), C = (0, u.Z)(), w = null != T ? T : C, R = null != (b = null != S ? S : T) ? b : C / 10, P = I.length, D = null != O.upsellLongMessages && (null != P ? P : 0) > h.J6R && N, L = null != O.upsellLongMessages && !N, x = (null == (n = (0, d.N)()) || null == (t = n.subscription_trial) ? void 0 : t.sku_id) === m.Si.TIER_2, k = w - P, j = k > R, M = k < 0 && x, U = 0 === k ? g.intl.string(g.t.tU6YQ0) : k > 0 ? g.intl.formatToPlainString(g.t.qH8uFR, {
    count: k
