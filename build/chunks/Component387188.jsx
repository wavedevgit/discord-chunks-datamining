...
function v(e) {
  let {
    message: t,
    className: n
  } = e, [a, s] = i.useState(false), d = t.getChannelId(), f = (0, g.xE)(t.content), _ = i.useCallback(() => {
    null != f && (0, p.rU)(d, t.id, {
      id: f.id,
      name: f.name
    }, p.TW.MESSAGE)
  }, [d, f, t.id]);
...
function I(e) {
  let {
    ...
    compact: n,
    usernameHook: a
  } = e, o = t.content, [l, u] = i.useState(false), p = (0, d.ZP)(t), O = a(p), v = (0, g.xE)(o), I = i.useCallback(() => {
