...
var Chunk587061 = require("./587061.js"),
  ...
  Chunk314910 = require("./314910.js"),
  Chunk22205 = require("./22205.jsx"),
  Chunk746106 = require("./746106.js"),
...
class z extends(r = Chunk73800.Component) {
  ...
  render() {
    ...
    return <Chunk688642.VK><Chunk746106.w windowKey={r}><Chunk899663.Z><Chunk481060.JcV containerRef={this.rootRef}>{<q guestWindow={Chunk512722} className={u}><Chunk280492>{<Chunk686546.Co />}{<Chunk40851.Wu appContext={Chunk981631.IlC.POPOUT} renderWindow={Chunk512722}><Chunk260035.m><Chunk314910.yP>{<div className={Chunk728294.popout}>{Chunk175724 && <Chunk950796.TF windowKey={r} short={true} />}{null}{<div className={s()(Chunk728294.content, Chunk731965)}>{require}</div>}</div>}{!Chunk442837 && <Chunk481060.nKe />}{<Chunk490173.Z />}{<Chunk314910.Un />}</Chunk314910.yP></Chunk260035.m></Chunk40851.Wu>}</Chunk280492></q>}{<Chunk670481.OU />}</Chunk481060.JcV></Chunk899663.Z></Chunk746106.w></Chunk688642.VK>
  }
  constructor(...e) {
...
let q = Chunk73800.forwardRef(function(e, t) {
    ...
    }, [n, l]), <div data-popout-root={true} ref={t} className={s()(d, r)}>{a}</div>
  }),
  X = Chunk73800.forwardRef(function(e, t) {
    ...
    return null == n ? null : <p.Sle><I.Gt value={l}><z{...W(H({
          ref: t
        }, e), {
          guestWindow: n,
          focused: r,
