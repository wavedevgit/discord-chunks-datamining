...
function X(e) {
  let {
    ...
    let e = Date.now();
    return s()(L.Z.getSpeakers()).map(e => D.Z.getParticipant(t, e)).filter(e => null != e && e.type === V.fO.USER && e.speaking && !(0, E.ZP)(e)).sortBy(t => -L.Z.getSpeakingDuration(t.user.id, e)).slice(0, 3).value()
  });
  return 0 === i.length ? null : (0, r.jsx)(r.Fragment, {
    children: i.map((e, t) => (0, r.jsx)(u.ua7, {
      ...
      children: l => (0, r.jsx)(M.ZP, K(q({}, l), {
        className: o()(Y.speaker, {
          [Y.last]: t === i.length - 1
        }),
        user: e.user,
        speaking: !0,
...
function Q(e) {
  let {
    ...
    isChatOpen: s,
    exitFullScreen: E
  } = e, M = i.useRef(null), L = i.useRef(null), {
  ...
  }), [$]), ei = (0, U.Z)(n), el = n.isGuildVoice() && !s, {
    hasParticipantsPanel: eo
  } = (0, F.Z)({
    location: "ChannelCallHeaderToolbar"
  ...
  return ee && eh.push((0, r.jsx)(X, {
    channelId: $,
    guildId: n.guild_id
  }, "current-speaker")), eh.push((0, r.jsx)(g.Z, {
    className: Y.button,
    channelId: $
  ...
  }, "call-members-popout")), a && !J && eh.push(null != et ? (0, r.jsx)(A.Z, {
    className: Y.button,
    channelId: $
    ...
    onClose: ep,
    className: Y.button
  }, "recents"))), es && !ec && eh.push((0, r.jsx)(j.Z, {
    className: Y.button
  }, "for-later")), J || eh.push((0, r.jsx)(u.yRy, {
    targetElementRef: L,
    position: "bottom",
    renderPopout: e => {
      let {
      ...
      return (0, r.jsx)(Z.Z, {
        children: (0, r.jsx)(B.Z, {
          ...
          appContext: l,
          exitFullScreen: E,
          onInteraction: (0, H.u)("ChannelCallOverflowMenu", Q, {
            entrypoint: V.A5.THREE_DOT
          })
        })
      })
    },
  ...
  }, "participants-list-button")), el && eh.push((0, r.jsx)(N.T, {
    channelId: n.id,
    className: o()(Y.button, {
      [Y.lastButton]: er
    }),
