...
var s = function(e, t) {
  ...
  for (var g = n.visualViewport ? n.visualViewport.width : innerWidth, E = n.visualViewport ? n.visualViewport.height : innerHeight, b = window.scrollX || pageXOffset, y = window.scrollY || pageYOffset, O = e.getBoundingClientRect(), v = O.height, I = O.width, S = O.top, T = O.right, A = O.bottom, N = O.left, C = "start" === s || "nearest" === s ? S : "end" === s ? A : S + v / 2, R = "center" === l ? N + I / 2 : "end" === l ? T : N, P = [], w = 0; w < h.length; w++) {
    ...
    if (p === D) Y = "start" === s ? C : "end" === s ? C - E : "nearest" === s ? a(y, y + E, E, F, H, y + C, y + C + v, v) : C - E / 2, W = "start" === l ? R : "center" === l ? R - g / 2 : "end" === l ? R - g : a(b, b + g, g, V, Z, b + R, b + R + I, I), Y = Math.max(0, Y + y), W = Math.max(0, W + b);
    else {
      Y = "start" === s ? C - k - F : "end" === s ? C - U + H + z : "nearest" === s ? a(k, U, x, F, H + z, C, C + v, v) : C - (k + x / 2) + z / 2, W = "start" === l ? R - G - V : "center" === l ? R - (G + M / 2) + K / 2 : "end" === l ? R - j + Z + K : a(G, j, M, V, Z + K, R, R + I, I);
      var X = D.scrollLeft,
        J = D.scrollTop;
