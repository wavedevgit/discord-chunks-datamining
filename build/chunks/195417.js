...
"use strict";
require("./601301.js");
var r, Chunk834647 = require("./834647.js"),
  ...
  Chunk552614 = require("./552614.js"),
  Chunk311017 = require("./311017.js"),
  Chunk596479 = require("./596479.js"),
  v = require("./34714.js").codeAt,
  Chunk267448 = require("./267448.js"),
  Chunk57284 = require("./57284.js"),
  Chunk469516 = require("./469516.js"),
  Chunk978887 = require("./978887.js"),
  Chunk352893 = require("./352893.js"),
  Chunk605944 = require("./605944.js"),
  w = Chunk605944.set,
  S = Chunk605944.getterFor("URL"),
  N = Chunk352893.URLSearchParams,
  x = Chunk352893.getState,
  P = Chunk308227.URL,
  R = Chunk308227.TypeError,
  F = Chunk308227.parseInt,
  O = Math.floor,
  E = Math.pow,
  I = Chunk675879("".charAt),
  M = Chunk675879(/./.exec),
  T = Chunk675879([].join),
  B = Chunk675879(1..toString),
  D = Chunk675879([].pop),
  L = Chunk675879([].push),
  V = Chunk675879("".replace),
  j = Chunk675879([].shift),
  U = Chunk675879("".split),
  q = Chunk675879("".slice),
  K = Chunk675879("".toLowerCase),
  H = Chunk675879([].unshift),
  z = "Invalid scheme",
  W = "Invalid host",
  G = "Invalid port",
  $ = /[a-z]/i,
  ...
  ec = function(e) {
    ...
    if ("object" == typeof e) {
      for (n = 0, t = "", r = el(e); n < 8; n++)(!a || 0 !== e[n]) && (a && (a = false), r === n ? (t += n ? ":" : "::", a = true) : (t += B(e[n], 16), n < 7 && (t += ":")));
      return "[" + t + "]"
    }
    return e
  },
  ...
  eV = function(e, t, n) {
    ...
    if (t) {
      ...
      if (true !== n && (r = new eV(n, true)), a = this.parse(i, null, r)) throw new R(a);
...
eV.prototype = {
  ...
  parse: function(e, t, n) {
    var a = t || eg,
      ...
      l = false,
      c = false;
    for (e = b(e), t || (this.scheme = "", this.username = "", this.password = "", this.host = null, this.port = null, this.path = [], this.query = null, this.fragment = null, this.cannotBeABaseURL = false, e = V(e, er, ""), e = V(e, ea, "$1")), u = m(e = V(e, eo, "")); o <= u.length;) {
      switch (d = u[o], a) {
        case eg:
          if (d && M($, d)) i += K(d), a = eb;
          else {
        ...
        case eb:
          if (d && (M(Y, d) || "+" === d || "-" === d || "." === d)) i += K(d);
            ...
            i = "", "file" === this.scheme ? a = eO : this.isSpecial() && n && n.scheme === this.scheme ? a = e_ : this.isSpecial() ? a = eS : "/" === u[o + 1] ? (a = ek, o++) : (this.cannotBeABaseURL = true, L(this.path, ""), a = eB)
          } else {
            if (t) return z;
            i = "", a = eA, o = 0;
            continue
        ...
        case eA:
          ...
          if (n.cannotBeABaseURL && "#" === d) {
            this.scheme = n.scheme, this.path = y(n.path), this.query = n.query, this.fragment = "", this.cannotBeABaseURL = true, a = eL;
            break
          }
        ...
        case eE:
          ...
          n && "file" === n.scheme && !ev(T(y(u, o), "")) && (ey(n.path[0], true) ? L(this.path, n.path[0]) : this.host = n.host), a = eT;
          continue;
        case eI:
          if (d === r || "/" === d || "\\" === d || "?" === d || "#" === d) {
            if (!t && ey(i)) a = eT;
  ...
  parseHost: function(e) {
    var t, n, r;
    if ("[" === I(e, 0)) {
      if ("]" !== I(e, e.length - 1) || !(t = es(q(e, 1, false)))) return W;
      this.host = t
...
var ej = function(e) {
    var t = p(this, eU),
      n = _(arguments.length, 1) > 1 ? arguments[1] : true,
      r = w(t, new eV(e, false, n));
...
if (Chunk414123 && (Chunk530383(eU, "href", eq("serialize", "setHref")), Chunk530383(eU, "origin", eq("getOrigin")), Chunk530383(eU, "protocol", eq("getProtocol", "setProtocol")), Chunk530383(eU, "username", eq("getUsername", "setUsername")), Chunk530383(eU, "password", eq("getPassword", "setPassword")), Chunk530383(eU, "host", eq("getHost", "setHost")), Chunk530383(eU, "hostname", eq("getHostname", "setHostname")), Chunk530383(eU, "port", eq("getPort", "setPort")), Chunk530383(eU, "pathname", eq("getPathname", "setPathname")), Chunk530383(eU, "search", eq("getSearch", "setSearch")), Chunk530383(eU, "searchParams", eq("getSearchParams")), Chunk530383(eU, "hash", eq("getHash", "setHash"))), Chunk735811(eU, "toJSON", function() {
    return S(this).serialize()
  }, {
    enumerable: true
  }), Chunk735811(eU, "toString", function() {
    return S(this).serialize()
  }, {
    enumerable: true
  }), P) {
  ...
  eK && Chunk735811(ej, "createObjectURL", Chunk241091(eK, P)), eH && Chunk735811(ej, "revokeObjectURL", Chunk241091(eH, P))
}
Chunk469516(ej, "URL"), Chunk834647({
  global: true,
  constructor: true,
  forced: !Chunk633555,
  sham: !Chunk414123
