...
let W = i.memo(function(e) {
  ...
  } = e, g = i.useContext(h.ZP), [O, S] = i.useState(null), [w, x] = i.useState(!1), [k, U] = i.useState(null), G = (0, m.Iu)(e => null != e.activeView), B = i.useRef(null), [V, W] = i.useState(""), [Y, K] = i.useState(""), [z, q] = i.useState(!1), [Q, X] = i.useState(!1), J = (0, N.Z)(V, w, o), {
    analyticsLocations: $
  ...
  let ei = J.length > 0,
    ...
    ec = i.useRef(!1);
  i.useEffect(() => {
    eo && (el.current = J), eo !== ec.current && (g.emit(eo ? "sticker-suggestions-shown" : "sticker-suggestions-hidden"), eo && ((0, A.Tk)(V), K(V))), ec.current = eo
  }, [g, eo, J, V]);
  let eu = !eo,
    ed = eo ? J : el.current;
  return (0, r.jsx)(p.Gt, {
