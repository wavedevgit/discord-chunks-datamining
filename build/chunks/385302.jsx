...
function _(e, t) {
  ...
  return !(0, i.e7)([u.Z], () => u.Z.can(d.Plq.MANAGE_MESSAGES, t) && n, [t, n]) || null == e.reactions || 0 === e.reactions.length || e.isPoll() && !(0, s.eQ)(e) ? null : <o.sNh id={"remove-reactions"} label={f.intl.string(f.t.ZbtGBg)} action={_} color={"danger"} />
}