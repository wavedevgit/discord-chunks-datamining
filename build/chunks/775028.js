...
function A(e) {
  let {
    ...
    channel: l,
    onCategoryClick: a
  } = e, o = (0, O.Mf)(t.id, l.id, l.id), s = (0, O.t4)(t.id, l.id, l.id);
  return (0, r.jsxs)("div", {
...
let R = l.memo(function() {
  ...
  W = l.memo(function(e) {
    let {
    ...
    } = (0, p.Z)(t.id), W = (0, O.Mf)(a.id, t.id, l.id), L = (0, O.t4)(a.id, t.id, l.id), M = (0, O.EH)(a.id, l.id), H = (0, o.e7)([N.Z], () => N.Z.getActiveThreadCount(a.id, t.id)), U = (0, o.e7)([_.Z], () => _.Z.shouldIndicateNewChannel(a.id, t.id)), G = e => {
      ...
      let n = [];
      return Z.TPd.GUILD_THREADS_ONLY.has(e.type) && t >= 1 && n.push((0, r.jsx)(d.Text, {
        variant: "text-xs/normal",
        className: E.channelSubtitle,
        children: P.NW.format(P.t.z0qMLy, {
          count: t
        })
      }, "thread-count")), B.has(e.type) || n.push((0, r.jsx)(d.Text, {
        variant: "text-xs/normal",
        className: E.channelSubtitle,
        children: (0, v.qw)(e.id)
      }, "active")), null != e.topic && e.topic.length > 0 && n.push((0, r.jsx)(m.Z, {
        children: (0, r.jsx)(d.Text, {
          className: E.topic,
          variant: "text-xs/normal",
      ...
      }, "topic")), [n.map((e, t) => [e, (0, r.jsx)(D, {
        index: t
      }, "subtitle-separator-".concat(t))])].flat(2).slice(0, -1)
    }(t, H), q = e => ((e.stopPropagation(), T.has(t.type) || e.shiftKey) ? (0, C.XU)(a.id, t.id) : t.isGuildStageVoice() || t.isGuildVoice() ? (0, j.Cq)(t) : b.Z.openChannelAsSidebar({
      guildId: t.guild_id,
      channelId: t.id,
...
function L(e) {
  let {
    ...
    onChannelClick: u
  } = (0, y.Z)(n.id), m = (0, h.wE)(s.z.CHANNEL_BROWSER_NUX) ? 0 : -1, p = l.useCallback(e => {
    let {
      section: l
    } = e;
  ...
  }, [t, n, m, c, u]), g = (0, I.q)(n.id), x = (0, v.tn)(n.id, t, 64, g);
