  ...
  L = r.memo(function(e) {
    let {
      ...
      n.isGuildVocal() ? (0, u.jW)(e, async () => {
        let {
          default: e
        } = await Promise.all([t.e("26881"), t.e("18320"), t.e("83331"), t.e("81070")]).then(t.bind(t, 213202));
        return t => (0, l.jsx)(e, T(S({}, t), {
          channel: n,
          guild: i
        }))
        ...
        let {
          default: e
        } = await Promise.all([t.e("26881"), t.e("18320"), t.e("44011")]).then(t.bind(t, 373651));
        return t => (0, l.jsx)(e, T(S({}, t), {
          channel: n,
          guild: i
        }))
...
function M(e) {
  let {
    ...
    onChannelClick: u
  } = (0, O.Z)(t.id), m = (0, h.wE)(s.z.CHANNEL_BROWSER_NUX) ? 0 : -1, p = r.useCallback(e => {
    let {
      section: r
    } = e;
