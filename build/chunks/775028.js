...
function A(e) {
  let {
    ...
    channel: r,
    onCategoryClick: a
  } = e, o = (0, O.Mf)(n.id, r.id, r.id), s = (0, O.t4)(n.id, r.id, r.id);
  return (0, l.jsxs)("div", {
...
let R = r.memo(function() {
  ...
  W = r.memo(function(e) {
    ...
    } = (0, p.Z)(n.id), W = (0, O.Mf)(a.id, n.id, r.id), L = (0, O.t4)(a.id, n.id, r.id), M = (0, O.EH)(a.id, r.id), H = (0, o.e7)([v.Z], () => v.Z.getActiveThreadCount(a.id, n.id)), U = (0, o.e7)([_.Z], () => _.Z.shouldIndicateNewChannel(a.id, n.id)), G = e => {
      if (!L) return e.stopPropagation(), y(a.id, n.id, r.id), !0
    }, F = e => {
...
function L(e) {
  let {
    ...
    onChannelClick: u
  } = (0, y.Z)(t.id), m = (0, h.wE)(s.z.CHANNEL_BROWSER_NUX) ? 0 : -1, p = r.useCallback(e => {
    let {
      section: r
    } = e;
    ...
    if (0 === r && -1 === m) return (0, l.jsx)(I.Z, {
      guild: t
    });
    let i = n._categories[r + m],
      o = n[i.channel.id][a];
    return null == o ? null : (0, l.jsx)(W, {
      category: i.channel,
      channel: o.channel,
      guild: t,
      isFirstChannel: 0 === a,
