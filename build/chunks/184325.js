...
function B(e) {
  ...
  } = (0, S.KZ)(), Z = y.default.getCurrentUser(), H = (0, v.yd)(null == Z ? void 0 : Z.premiumType, w.p9.TIER_2), Y = (0, f.Z)({
    ...
    children: n.map((e, t) => {
      ...
      let i = e.id === E.l.ORB_PROFILE_BADGE,
        ...
        y = t => {
          ...
          if (f) {
            if (t.preventDefault(), O.default.track(P.rMx.TIERED_TENURE_BADGE_CLICKED, {
                badge: e.id,
                premium_type: H,
                viewed_user_id: null == b ? void 0 : b.userId
              }), H) {
              (null == b ? void 0 : b.userId) === (null == Z ? void 0 : Z.id) ? (0, g.uL)(P.Z5c.NITRO_HOME) : (0, _.k)({
                analyticsLocations: B,
                displayProfile: b
              }), null == k || k();
              return
        ...
        v = () => {
          e.id === A.i && O.default.track(P.rMx.QUEST_CONTENT_VIEWED, U(M({}, (0, p.mH)(m.jn.QUEST_BADGE)), {
