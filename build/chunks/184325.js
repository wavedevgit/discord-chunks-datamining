...
function j(e) {
  ...
  } = (0, y.KZ)(), F = g.default.getCurrentUser(), V = (0, b.yd)(null == F ? void 0 : F.premiumType, C.p9.TIER_2), Z = (0, S.Of)(null !== (t = null == F ? void 0 : F.id) && void 0 !== t ? t : null), H = (0, I.Z)(Z).some(e => e.id === m.l.ORB_PROFILE_BADGE);
  return (0, r.jsx)("div", {
        ...
        c = n => {
          ...
          if (i) {
            ...
            if ((null == D ? void 0 : D.userId) === (null == F ? void 0 : F.id)) {
              let t = null != e.link ? (0, s.default)(e.link, {
                analyticsLocations: U
              }) : null;
              if (null == t) return;
              return null == L || L(), t(n)
