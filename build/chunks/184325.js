...
function B(e) {
  ...
  } = (0, T.KZ)(), H = b.default.getCurrentUser(), Y = (0, v.yd)(null == H ? void 0 : H.premiumType, w.p9.TIER_2), W = (0, N.Of)(null != (t = null == H ? void 0 : H.id) ? t : null), K = (0, A.Z)(W).some(e => e.id === g.l.ORB_PROFILE_BADGE);
  return (0, r.jsx)("div", {
    ...
    children: n.map((e, t) => {
      ...
      let i = e.id === g.l.ORB_PROFILE_BADGE,
        ...
        v = t => {
          ...
          if (b) {
            if (t.preventDefault(), y.default.track(R.rMx.TIERED_TENURE_BADGE_CLICKED, {
                badge: e.id,
                premium_type: Y,
      ...
      return (0, r.jsx)(o.DY3, {
        ...
        children: (0, r.jsx)(o.eee, {
          ...
          href: e.link,
          style: {
            filter: B && null != u ? "drop-shadow(0 0 5px ".concat(u.glowColor, ")") : void 0
          },
