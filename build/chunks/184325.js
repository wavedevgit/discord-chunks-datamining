...
function B(e) {
  ...
  } = (0, I.KZ)(), Z = b.default.getCurrentUser(), H = (0, O.yd)(null == Z ? void 0 : Z.premiumType, w.p9.TIER_2), Y = T.X.useExperiment({
    location: "UserProfileBadgeList"
  }), W = (0, N.Of)(null != (t = null == Z ? void 0 : Z.id) ? t : null), K = (0, A.Z)(W).some(e => e.id === g.l.ORB_PROFILE_BADGE);
  return (0, r.jsx)("div", {
    ...
    children: n.map((e, t) => {
      ...
      let i = e.id === g.l.ORB_PROFILE_BADGE,
        ...
        O = t => {
          ...
          if (b) {
            if (t.preventDefault(), y.default.track(P.rMx.TIERED_TENURE_BADGE_CLICKED, {
                badge: e.id,
                premium_type: H,
                viewed_user_id: null == E ? void 0 : E.userId
              }), H) {
              (null == E ? void 0 : E.userId) === (null == Z ? void 0 : Z.id) ? (0, m.uL)(P.Z5c.NITRO_HOME) : (0, f.k)({
                analyticsLocations: B,
                displayProfile: E
              }), null == k || k();
              return
        ...
        I = () => {
          e.id === A.i && y.default.track(P.rMx.QUEST_CONTENT_VIEWED, U(M({}, (0, _.mH)(h.jn.QUEST_BADGE)), {
      ...
      return (0, r.jsx)(a.DY3, {
        ...
        children: (0, r.jsx)(a.eee, {
          ...
          href: e.link,
          style: {
            filter: N ? "drop-shadow(0 0 5px ".concat(c.glowColor, ")") : void 0
          },
