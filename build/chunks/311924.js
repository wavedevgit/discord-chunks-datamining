...
function C() {
  ...
  let [{
    ...
    sourceType: O,
    resolution: I
  }, Z] = (0, h.E_)(), w = (0, m.Z)(), N = (0, l.e7)([a.default], () => a.default.getCurrentUser()), [T, E] = null != (e = (0, g.Z)(_.tI.PRESET_VIDEO)) ? e : [_.LY.RESOLUTION_720, _.ws.FPS_30], [P, R] = null != (t = (0, g.Z)(_.tI.PRESET_DOCUMENTS)) ? t : [_.LY.RESOLUTION_SOURCE, _.ws.FPS_15], [A, M] = null != (n = (0, g.Z)(C)) ? n : [I, y], k = i.useMemo(() => C === _.tI.PRESET_VIDEO ? T : C === _.tI.PRESET_DOCUMENTS ? P : I, [C, T, P, I]), L = i.useMemo(() => C === _.tI.PRESET_VIDEO ? E : C === _.tI.PRESET_DOCUMENTS ? R : y, [C, E, R, y]), D = C === _.tI.PRESET_DOCUMENTS, B = p.Vf.map(e => {
    let {
      value: t
