...
function C() {
  ...
  let [{
    ...
    sourceType: O,
    resolution: Z
  }, w] = (0, h.E_)(), I = (0, m.Z)(), N = (0, l.e7)([a.default], () => a.default.getCurrentUser()), [E, T] = null != (e = (0, g.Z)(_.tI.PRESET_VIDEO)) ? e : [_.LY.RESOLUTION_720, _.ws.FPS_30], [P, R] = null != (t = (0, g.Z)(_.tI.PRESET_DOCUMENTS)) ? t : [_.LY.RESOLUTION_SOURCE, _.ws.FPS_15], [A, k] = null != (n = (0, g.Z)(C)) ? n : [Z, y], M = i.useMemo(() => C === _.tI.PRESET_VIDEO ? E : C === _.tI.PRESET_DOCUMENTS ? P : Z, [C, E, P, Z]), L = i.useMemo(() => C === _.tI.PRESET_VIDEO ? T : C === _.tI.PRESET_DOCUMENTS ? R : y, [C, T, R, y]), D = C === _.tI.PRESET_DOCUMENTS, B = p.Vf.map(e => {
    let {
      value: t
