...
class H extends i.PureComponent {
  ...
  render() {
    ...
    else if (_) switch (null == y ? void 0 : y.applicationStatus) {
      case b.wB.SUBMITTED:
  ...
  constructor(...e) {
    super(...e), B(this, "state", {
      ...
      (0, s.ZDy)(async () => {
        let {
          default: e
        } = await Promise.all([n.e("76540"), n.e("17078")]).then(n.bind(n, 607018));
...
function V(e) {
  ...
  }), C = !!(0, _.Dc)(s), j = (0, o.e7)([y.Z], () => y.Z.shouldShowPopout(a)), O = (0, o.e7)([A.Z], () => A.Z.can(k.Plq.SEND_MESSAGES, i)), E = (0, o.e7)([x.Z], () => x.Z.getRequest(a)), I = F(G({}, c), {
    guild: s,
    isLurking: h,
    isFollowable: u,
    shouldShowLurkerModeSuccessPopout: j,
