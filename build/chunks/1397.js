...
class z extends i.PureComponent {
  ...
  constructor(...e) {
    super(...e), F(this, "state", {
      ...
      null != e && (0, s.h7j)(t => (0, r.jsx)(s.ConfirmModal, V(H({
      ...
      null != t && (0, s.h7j)(e => (0, r.jsx)(s.ConfirmModal, V(H({}, e), {
      ...
      return (0, m.EJ)(e) ? (0, r.jsx)(s.u_l, {
        renderModal: t => (0, r.jsx)(g.default, V(H({}, t), {
          onAccept: i,
          guildId: e.id
        })),
        onCloseRequest: i
      }) : (0, r.jsx)(s.u_l, {
        renderModal: t => (0, r.jsx)(j.Z, V(H({}, t), {
          onAccept: i,
          guildName: e.name
        })),
        onCloseRequest: i
...
function Y(e) {
  ...
  }), N = !!(0, x.Dc)(c), I = (j || u.notClaimed) && N, P = (0, a.e7)([O.Z], () => O.Z.shouldShowPopout(s)), S = (0, a.e7)([k.Z], () => k.Z.can(W.Plq.SEND_MESSAGES, l)), D = (0, a.e7)([v.Z], () => v.Z.getRequest(s)), [U, B] = (0, f.L_)(s), G = (0, f.Cc)(s), F = (null == D ? void 0 : D.applicationStatus) === C.wB.APPROVED, Y = i.useRef(B);
  i.useEffect(() => {
    Y.current = B
  }), i.useEffect(() => {
    !(0, m.EJ)(c) || !F || (0, _.d3)(D) || null == G && Y.current()
  }, [c, F, D, G]);
  let q = V(H({}, u), {
    guild: c,
    isLurking: g,
