...
class H extends i.PureComponent {
  ...
  render() {
    ...
    if (e && !h) {
      if (j.message = D.intl.string(D.t.Hl0Mqq), null != f && f >= 1e3) {
        let e = 1e3 * Math.floor(f / 1e3);
        j.subtitle = D.intl.formatToPlainString(D.t.C5bgrK, {
...
function V(e) {
  ...
  }), C = !!(0, _.Dc)(s), j = (0, o.e7)([x.Z], () => x.Z.shouldShowPopout(a)), O = (0, o.e7)([A.Z], () => A.Z.can(M.Plq.SEND_MESSAGES, i)), E = (0, o.e7)([y.Z], () => y.Z.getRequest(a)), I = G(F({}, c), {
    guild: s,
    isLurking: h,
    isFollowable: u,
