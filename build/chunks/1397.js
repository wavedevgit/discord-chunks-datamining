  ...
  render() {
    ...
    if (e && !f) {
      ...
      S.buttonText = F.intl.string(F.t["3aOv+v"]), S.onButtonClick = this.handleFollowAnnouncement, t && (S.onSecondaryButtonClick = this.handleJoinServer, S.secondaryButtonText = F.intl.string(F.t["RLch7+"]))
        ...
        var P;
        S.imageSrc = null != (P = j.getIconURL(U.Si.SMALL)) ? P : void 0, S.message = F.intl.format(F.t.EvDn1N, {
          name: j.name
...
function Y(e) {
  ...
  }), b = !!(0, y.Dc)(s), x = (0, o.e7)([v.Z], () => v.Z.shouldShowPopout(a)), O = (0, o.e7)([w.Z], () => w.Z.can(L.Plq.SEND_MESSAGES, i)), E = (0, o.e7)([C.Z], () => C.Z.getRequest(a)), {
