...
function V(e) {
  ...
  }), y = !!(0, _.Dc)(s), j = (g || c.notClaimed) && y, O = (0, a.e7)([C.Z], () => C.Z.shouldShowPopout(o)), E = (0, a.e7)([A.Z], () => A.Z.can(M.Plq.SEND_MESSAGES, i)), I = (0, a.e7)([x.Z], () => x.Z.getRequest(o)), k = F(G({}, c), {
    guild: s,
    isLurking: h,
    isFollowable: u,
