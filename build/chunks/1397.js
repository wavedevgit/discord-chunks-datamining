  ...
  render() {
    ...
    if (e && !m) {
      ...
      case _.wB.REJECTED:
        ...
        break;
      default:
        E.message = U.intl.string(U.t.rEBKvr), E.buttonText = U.intl.string(U.t["r8/DT0"]), E.buttonColor = c.Ttl.BRAND, E.onButtonClick = this.handleShowMemberVerification, E.animationSrc = () => n.e("43841").then(n.t.bind(n, 737848, 19)).then(e => {
          let {
            default: t
          } = e;
          return t
        })
    } else l && !x ? (E.message = U.intl.string(U.t["2dThMD"]), E.buttonText = U.intl.string(U.t["50gfOj"]), E.onButtonClick = this.handleVerifyPhone, E.imageSrc = n(98063)) : a ? (E.message = U.intl.string(U.t.FkGPS0), E.buttonText = U.intl.string(U.t.lm1UKi), E.onButtonClick = this.handleResendVerification, E.imageSrc = n(102811)) : o ? (E.message = U.intl.formatToPlainString(U.t.IH7RMD, {
