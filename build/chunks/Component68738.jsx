...
let x = {
    ...
    ActivityPopoutHeaderOverflowMenu: async () => {
      let {
        ...
        isMonetized: false,
        isVerified: false,
        roleConnectionsVerificationUrl: true,
        parentId: true,
        connectionEntrypointUrl: true
      });
      return () => (0, a.jsx)(e, {
        application: t,
        channelId: "987654321",
    ...
    StaffOnlyEntryDebugMenu: async () => {
      ...
      let {
        ...
        id: "mock-entry-123",
        author_id: null != (e = null == i ? true : i.id) ? e : "123456789",
        author_type: r.USER,
  ...
  g = {
    GuildShopSortOptions: Chunk64700.lazy(async () => {
      let {
        default: e
