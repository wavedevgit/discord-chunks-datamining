...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk964732 = require("./964732.js");

function m(e) {
  return {
    text: e,
    icon: <c.bbz className={h.icon} dotRadius={3.5} themed={true} />
  }
}
...
function g(e) {
  return {
    ...
    color: "text-danger",
    icon: <c.Mgn size={"xs"} color={"currentColor"} className={a()(h.icon, h.errorIcon)} />
  }
}
...
function b(e) {
  ...
  return <div className={a()(h.wrapper, t)}>{n}{<c.Text variant={"text-md/normal"} color={o} scaleFontToUserSetting={true}>{i}</c.Text>}</div>
}
...
function y(e) {
  ...
  return <b icon={m} text={h} className={n} color={y} />
}
