...
let N = function(e) {
  let {
    ...
    onFieldsSave: O,
    onDescriptionSave: C
  } = e, I = i.useRef(!1), [E, S] = i.useState(null), [T, P] = i.useState(e.formFields);
  ...
  let w = i.useRef(e.formFields),
    ...
    H = i.useCallback(async (e, t, n) => {
      let r = T.indexOf(e),
        i = [...T];
      if (null != t && t !== r && (i.splice(r, 1), i.splice(t, 0, e), P(i)), n) try {
