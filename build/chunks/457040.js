...
let Z = (0, O.Mg)(c.Z.STICKERS_CONSTANTS_STICKER_PICKER_BREAKPOINT_SMALL),
  ...
  er = i.forwardRef(function(e, t) {
    ...
    let el = (0, N.Sd)(c),
      ...
      ev = eE.length + eb.length,
      ey = i.useCallback(e => {
        "" === eo ? (0, T.On)(e) : (0, T.Yk)(e, eo, ev), O(e.sticker, C.V0.STICKER_PICKER)
      }, [O, eo, ev]),
      eO = null != eu && eu > Z,
      {
        rowCount: eI,
        ...
        switch (e.type) {
          case C.al.CREATE_STICKER:
            y.default.track(j.rMx.OPEN_MODAL, {
              ...
              let {
                default: t
              } = await Promise.all([n.e("93626"), n.e("47690")]).then(n.bind(n, 136735));
    ...
    i.useEffect(() => {
      ...
      0 === ev ? et(eo) : en(eo, ev, ea)
    }, [eo, ev, ea]), i.useLayoutEffect(() => {
      var e;
