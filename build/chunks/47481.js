...
function d(e) {
  ...
  return h.forEach(e => {
    ...
    (null !== N && ([P, S] = (E = v = S, null == v || v.type !== N ? (O = {
      type: N,
      content: [],
      key: e.id
    }, _.push(O)) : E = (O = v).content[O.content.length - 1], [O, E])), f === e.id && null != C) ? (null != S && S.type === u.ys_.DIVIDER ? S.unreadId = e.id : null !== P ? (j = P, e.isFirstMessageInForumPost(p) || j.content.push({
      type: u.ys_.DIVIDER,
      unreadId: e.id
