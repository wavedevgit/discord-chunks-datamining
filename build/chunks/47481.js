...
function p(e) {
  ...
  return h.forEach(e => {
    ...
    L && e.id === x && null != D && (w.flashKey = D), h.jumpTargetId === e.id && (w.jumpTarget = !0), null != b && e.id === b.startId && b.count > 1 && y.push({
      type: u.ys_.DIVIDER,
      content: b.topic,
      contentKey: b.startId,
      isSummaryDivider: !0
    }), null !== A ? (A.content.push(w), w.jumpTarget && (A.hasJumpTarget = !0)) : y.push(w), e.isFirstMessageInForumPost(p) && y.push({
