...
function d(e) {
  ...
  return f.forEach(e => {
    ...
    (null !== T && ([I, P] = (S = x = P, null == x || x.type !== T ? (j = {
      type: T,
      content: [],
      key: e.id
    }, C.push(j)) : S = (j = x).content[j.content.length - 1], [j, S])), h === e.id && null != v) ? (null != P && P.type === u.ys_.DIVIDER ? P.unreadId = e.id : null !== I ? (E = I, e.isFirstMessageInForumPost(p) || E.content.push({
      type: u.ys_.DIVIDER,
      unreadId: e.id
