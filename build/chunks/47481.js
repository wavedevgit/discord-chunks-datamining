...
function d(e) {
  ...
  return h.forEach(e => {
    ...
    (null !== T && ([I, P] = (E = v = P, null == v || v.type !== T ? (O = {
      type: T,
      content: [],
      key: e.id
    }, y.push(O)) : E = (O = v).content[O.content.length - 1], [O, E])), f === e.id && null != C) ? (null != P && P.type === u.ys_.DIVIDER ? P.unreadId = e.id : null !== I ? (j = I, e.isFirstMessageInForumPost(p) || j.content.push({
      type: u.ys_.DIVIDER,
      unreadId: e.id
    ...
    M && e.id === k && null != R && (w.flashKey = R), h.jumpTargetId === e.id && (w.jumpTarget = true), null != b && e.id === b.startId && b.count > 1 && y.push({
      type: u.ys_.DIVIDER,
      content: b.topic,
