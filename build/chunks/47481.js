...
function f(e, t, n, r) {
  ...
  return null == r || r.type !== n ? (i = {
    ...
    content: [],
    key: t.id
  }, e.push(i)) : a = (i = r).content[i.content.length - 1], [i, a]
}
...
function p(e) {
  ...
  return h.forEach(e => {
    ...
    null !== C && ([A, S] = f(y, e, C, S)), m === e.id && null != v ? (null != S && S.type === u.ys_.DIVIDER ? S.unreadId = e.id : null !== A ? _(A, p, e) : e.isFirstMessageInForumPost(p) || y.push({
      type: u.ys_.DIVIDER,
      unreadId: e.id
    }), v = null) : null != v && o.default.extractTimestamp(e.id) > v && (e.isFirstMessageInForumPost(p) || y.push({
      type: u.ys_.DIVIDER,
      unreadId: e.id
    }), v = null);
    let w = (0, c.f)(e, p);
    ...
    L && e.id === x && null != D && (P.flashKey = D), h.jumpTargetId === e.id && (P.jumpTarget = !0), null != b && e.id === b.startId && b.count > 1 && y.push({
      type: u.ys_.DIVIDER,
      content: b.topic,
      contentKey: b.startId,
      isSummaryDivider: !0
    }), null !== A ? (A.content.push(P), P.jumpTarget && (A.hasJumpTarget = !0)) : y.push(P), e.isFirstMessageInForumPost(p) && y.push({
