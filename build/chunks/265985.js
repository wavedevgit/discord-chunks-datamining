...
let C = e => {
    ...
    return (0, r.jsxs)("div", {
      className: l()(j.headerContainer, {
        [j.headerEmpty]: d || null == m
      }),
      children: [m, (() => {
  ...
  _ = e => {
    let {
      ...
      listing: n,
      guildId: i
    } = e, l = (0, a.e7)([d.Z], () => d.Z.getGuild(i), [i]), c = (0, h.Z)(i).filter(e => e.roles.includes(n.role_id)), u = n.role_benefits.benefits.filter(m.rC).slice(0, null === c.length ? 4 : 3), p = (0, g.Z)(u).slice(0, null === c.length ? 4 : 3);
    return (0, r.jsxs)("div", {
