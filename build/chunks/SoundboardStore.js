...
function w(e) {
  let {
    sound: t
  } = e, n = E.get(t.guildId), r = null == n ? true : n.findIndex(e => e.soundId === t.soundId);
  null != n && null != r && false !== r ? (n[r] = t, E.set(t.guildId, [...n])) : null != n && (null == n || n.push(t), E.set(t.guildId, [...n]))
}
...
function L(e) {
  let {
    soundId: t,
    guildId: n
  } = e, r = E.get(n), i = null == r ? true : r.findIndex(e => e.soundId === t);
...
class H extends(r = Chunk442837.ZP.Store) {
  initialize() {
    this.waitFor(Chunk581883.Z), B(Chunk581883.Z.settings)
  }
