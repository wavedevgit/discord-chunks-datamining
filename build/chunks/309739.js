...
function R(e) {
  let t = () => {
    T.SE.updateSetting(e ? j.Z.getGuildIds() : [])
  };
  (0, m.h7j)(e => {
    var n, r;
        ...
        children: [(0, i.jsxs)(m.xJW, {
          ...
          children: [(0, i.jsx)(m.Text, {
            ...
            children: y.intl.format(y.t.aUxRra, {
              helpdeskArticle: O.Z.getArticleURL(I.BhN.ACTIVITY_STATUS_SETTINGS)
            })
          }), (0, i.jsx)(m.q4e, {
            options: o,
            value: t,
...
let k = e => {
  switch (e.type) {
    case I.ABu.SPOTIFY:
      return y.intl.format(y.t["5sYPnp"], {
        name: e.name
      });
    case I.ABu.CRUNCHYROLL:
      return y.intl.format(y.t.Ge29Z2, {
        name: e.name
      });
    default:
      return y.intl.format(y.t.nmMsys, {
        game: e.name
      })
  }
};
...
function L(e) {
  let {
    account: t
  } = e, [n, s] = r.useState(t.showActivity), l = (0, g.ZP)();
  r.useEffect(() => {
    s(t.showActivity)
  }, [t]);
