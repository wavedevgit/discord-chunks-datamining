...
let k = () => (0, Chunk255367.jsx)("div", {
  ...
  G = e => {
    ...
    let {
      ...
      e && (null == o || o(), null != a && a(L.L.PRIMARY), null != u && ((0, w.Yk)({
        isPersisted: true,
        themeName: c.Us[u.id],
        analyticsLocations: s
      }), (0, _.ZI)({
  ...
  B = e => {
    let {
      ...
      isPreview: true
    }, () => M.intl.string(M.t["dqH+qq"])).otherwise(() => M.intl.string(M.t.Olc2Ky)), m = a ? j.editorFooterV2 : j.editorFooter;
    return (0, r.jsxs)("div", {
      className: m,
