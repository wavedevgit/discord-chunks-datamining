...
let _ = () => {
  ...
  return <Chunk667202.I graphic={{
      type: "image",
      src: A ? Chunk234286 : Chunk997892
    }} gradientColor={A ? "nitro-pink" : "nitro-green"} transitionState={module} title={null != _.canceledAt ? Chunk388032.intl.string(Chunk388032.t["2Otztr"]) : "".concat(Chunk388032.intl.format(Chunk388032.t.q9Vxu7, {
      percent: C.discount.amount
    }))} actions={P} onClose={async () => exports()}>{<div className={Chunk735912.offerDetailContainer}><Chunk10508.o userDiscountOffer={C} offerState={Chunk10508.w.CONFIRMING} /></div>}{<div className={Chunk735912.legalContainer}><Chunk481060.Text variant={"text-xs/medium"} color={"text-secondary"}>{null != _.canceledAt ? Chunk388032.intl.format(Chunk388032.t.mY3ysL, {
          discountedPrice: O,
        ...
        })}</Chunk481060.Text></div>}{I ? <Chunk434333.k>{Chunk388032.intl.string(Chunk388032.t["5mlOCQ"])}</Chunk434333.k> : null}</Chunk667202.I>
}