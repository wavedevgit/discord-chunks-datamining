...
function g(e, t, n, r, a, o) {
  let [s, c] = i.useState(o), u = i.useMemo(() => {
    var i, o;
    return "change" !== e ? null : null === t || "" === t ? null : null != t ? t : s ? null != r && (null != (i = null == n ? void 0 : n.length) ? i : 0) < r ? l.intl.formatToPlainString(l.t["62rk1N"], {
      minLength: r
    }) : null != a && (null != (o = null == n ? void 0 : n.length) ? o : 0) > a ? l.intl.formatToPlainString(l.t.ICT5S0, {
      maxLength: a
    }) : null : null
  }, [e, t, s, r, null == n ? void 0 : n.length, a]), d = null != t && "" !== t || null != u;
  return {
    errorMessage: u,
    hasError: d,
    setShouldValidate: c
...
function E(e) {
  ...
  let {
    ...
    trailing: A,
    validateOn: N = "change"
  } = e, C = p(e, ["disabled", "editable", "inputRef", "focusProps", "name", "type", "placeholder", "maxLength", "value", "defaultValue", "minLength", "error", "defaultDirty", "leading", "trailing", "validateOn"]), R = m(y, O), {
    errorMessage: P,
    hasError: w,
    setShouldValidate: D
  } = g(N, I, y, v, b, T), L = e => {
