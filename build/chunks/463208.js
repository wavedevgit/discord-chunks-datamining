  ...
  constructor(e) {
    ...
    super(e), m(this, "hasError", () => null != this.props.error && this.props.error.length > 0 || !1 !== this.state.dirty && (this.getIsUnderFlowing() || this.getIsOverFlowing())), m(this, "getError", () => {
      let {
        ...
        minLength: t,
        maxLength: n
      } = this.props, r = this.getIsUnderFlowing() ? p.intl.formatToPlainString(p.t["62rk1N"], {
        minLength: t
      }) : null, i = this.getIsOverFlowing() ? p.intl.formatToPlainString(p.t.ICT5S0, {
        maxLength: n
      }) : null;
...
m(S, "Sizes", v), m(S, "contextType", u.q3), m(S, "defaultProps", {
  name: "",
  size: v.DEFAULT,
  disabled: !1,
  type: "text",
