...
class J extends s.Component {
  ...
  get firstHeaderText() {
    ...
    if (t && !i)
      if (!e) return B.intl.formatToPlainString(B.t.xHzRub, {
        recipientDisplayName: G.ZP.getName(R.default.getCurrentUser())
      });
      else {
        let t = R.default.getUser(n.userId),
          e = G.ZP.getName(t);
        return r === a.Z.AVATAR_DECORATION ? B.intl.formatToPlainString(B.t.SKduys, {
          sender: e
        }) : r === a.Z.PROFILE_EFFECT ? B.intl.formatToPlainString(B.t["1w42T0"], {
          sender: e
  ...
  get secondHeaderText() {
    ...
    return B.intl.formatToPlainString(B.t.DDO4W1, {
  ...
  render() {
    let {
      ...
      soundId: h,
      isThemeDark: f
    } = this.props, g = R.default.getUser(s.userId), {
      isCustomGift: m,
      isCollectiblesGift: b,
      accepted: O,
      opened: y,
      emojiURL: S
    } = this.state, v = R.default.getCurrentUser(), P = this.step === H.wZ8.ERROR, x = (null == s ? void 0 : s.userId) != null && null != v && (null == v ? void 0 : v.id) != null && s.userId === v.id;
    switch (this.step) {
      case H.wZ8.ERROR:
        null == c || c(s, !1);
        break;
    ...
    return (0, n.jsxs)("div", {
      ...
      children: [(0, n.jsxs)(u.Y0X, {
        ...
        children: [null != s.giftStyle && !m && !b && (0, n.jsx)(M.Z, {
          ...
          children: [!b && (null == s.giftStyle || m && O) && (0, n.jsx)(Z.Z, {
          ...
          }), m && !b && null != s.giftStyle && !O && (0, n.jsx)(M.Z, {
            defaultAnimationState: this.getDefaultAnimationStatus(),
            idleAnimationState: this.getIdleAnimationStatus(),
            className: q.giftAnimation,
            giftStyle: s.giftStyle
          }), this.state.opened && !P && (0, n.jsx)(j.Z, {
            giftCode: s
          }), P && (0, n.jsx)(u.Text, {
            className: q.body,
            variant: "text-md/normal",
            children: this.errorMessage
          }), m && this.state.opened && !this.state.accepted && !P && null != d && "" !== d && !x && (0, n.jsxs)(n.Fragment, {
            children: [(0, n.jsx)(u.vwX, {
              children: B.intl.format(B.t.DDO4W1, {
      ...
      }), null != s.giftStyle && !o && this.step !== H.wZ8.ERROR && !O && !e && y && (null == p || null == S ? (0, n.jsx)(Y, {
        openedGift: y && !O && !e
      }) : (0, n.jsx)(F.Z, {
        confettiTarget: this.modalRef.current,
        emojiURL: S
      })), !O && !e && y && null != h && (0, n.jsx)(K, {
        soundId: h,
        step: this.step
      })]
    })
  ...
  constructor(...t) {
    super(...t), W(this, "state", {
      ...
      step: void 0,
      emojiURL: void 0
    }), W(this, "modalRef", s.createRef()), W(this, "handleOpen", () => {
      this.setState({
        opened: !0
      })
    ...
    }), W(this, "getDefaultAnimationStatus", () => this.step === H.wZ8.OPEN ? L.SR.IDLE : L.SR.ACTION), W(this, "getIdleAnimationStatus", () => {
...
let Q = o.ZP.connectStores([T.Z, E.Z, b.Z, C.Z, A.Z, h.Z], t => {
    let {
      giftCode: e
    } = t, i = E.Z.get(e.skuId), n = null != i ? b.Z.getApplication(i.applicationId) : null, s = h.Z.useReducedMotion;
    return {
      sku: i,
