...
class J extends r.Component {
  ...
  get firstHeaderText() {
    ...
    if (t && !n)
      if (!e) return V.intl.formatToPlainString(V.t.xHzRub, {
        recipientDisplayName: G.ZP.getName(R.default.getCurrentUser())
      });
      else {
        let t = R.default.getUser(i.userId),
          e = G.ZP.getName(t);
        return s === o.Z.AVATAR_DECORATION ? V.intl.formatToPlainString(V.t.SKduys, {
          sender: e
        }) : s === o.Z.PROFILE_EFFECT ? V.intl.formatToPlainString(V.t["1w42T0"], {
          sender: e
  ...
  get secondHeaderText() {
    ...
    return V.intl.formatToPlainString(V.t.DDO4W1, {
  ...
  render() {
    let {
      ...
      soundId: f,
      isThemeDark: h
    } = this.props, m = R.default.getUser(r.userId), {
      isCustomGift: g,
      isCollectiblesGift: y,
      accepted: b,
      opened: O,
      emojiURL: v
    } = this.state, P = R.default.getCurrentUser(), S = this.step === H.wZ8.ERROR, w = (null == r ? void 0 : r.userId) != null && null != P && (null == P ? void 0 : P.id) != null && r.userId === P.id;
    switch (this.step) {
      case H.wZ8.ERROR:
        null == c || c(r, !1);
        break;
    ...
    return (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsxs)(u.Y0X, {
        ...
        children: [null != r.giftStyle && !g && !y && (0, i.jsx)(F.Z, {
          ...
          children: [!y && (null == r.giftStyle || g && b) && (0, i.jsx)(x.Z, {
          ...
          }), g && !y && null != r.giftStyle && !b && (0, i.jsx)(F.Z, {
            defaultAnimationState: this.getDefaultAnimationStatus(),
            idleAnimationState: this.getIdleAnimationStatus(),
            className: B.giftAnimation,
            giftStyle: r.giftStyle
          }), this.state.opened && !S && (0, i.jsx)(j.Z, {
            giftCode: r
          }), S && (0, i.jsx)(u.Text, {
            className: B.body,
            variant: "text-md/normal",
            children: this.errorMessage
          }), g && this.state.opened && !this.state.accepted && !S && null != d && "" !== d && !w && (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsx)(u.vwX, {
              children: V.intl.format(V.t.DDO4W1, {
                sender: G.ZP.getName(m)
              })
            }), (0, i.jsx)(u.X6q, {
              id: s,
      ...
      }), null != r.giftStyle && !a && this.step !== H.wZ8.ERROR && !b && !e && O && (null == p || null == v ? (0, i.jsx)(X, {
        openedGift: O && !b && !e
      }) : (0, i.jsx)(M.Z, {
        confettiTarget: this.modalRef.current,
        emojiURL: v
      })), !b && !e && O && null != f && (0, i.jsx)(Y, {
        soundId: f,
        step: this.step
      })]
    })
  ...
  constructor(...t) {
    ...
    }), q(this, "getDefaultAnimationStatus", () => this.step === H.wZ8.OPEN ? L.SR.IDLE : L.SR.ACTION), q(this, "getIdleAnimationStatus", () => {
...
let Q = a.ZP.connectStores([T.Z, A.Z, y.Z, I.Z, E.Z, f.Z], t => {
    let {
      giftCode: e
    } = t, n = A.Z.get(e.skuId), i = null != n ? y.Z.getApplication(n.applicationId) : null, r = f.Z.useReducedMotion;
    return {
      sku: n,
  ...
  $ = t => {
    ...
    let y = (0, S.Dt)(),
      ...
      {
        product: x
      } = (0, O.T)(null == b ? void 0 : b.skuId);
    return null == b ? null : (0, i.jsx)(Q, (e = function(t) {
