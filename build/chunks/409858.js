...
class J extends n.Component {
  ...
  get firstHeaderText() {
    ...
    if (t && !s)
      if (!e) return z.NW.formatToPlainString(z.t.xHzRub, {
        recipientDisplayName: G.ZP.getName(R.default.getCurrentUser())
      });
      else {
        let t = R.default.getUser(i.userId),
          e = G.ZP.getName(t);
        return r === a.Z.AVATAR_DECORATION ? z.NW.formatToPlainString(z.t.SKduys, {
          sender: e
        }) : r === a.Z.PROFILE_EFFECT ? z.NW.formatToPlainString(z.t["1w42T0"], {
          sender: e
  ...
  get secondHeaderText() {
    ...
    return z.NW.formatToPlainString(z.t.DDO4W1, {
  ...
  render() {
    let {
      ...
      soundId: h,
      isThemeDark: f
    } = this.props, g = R.default.getUser(n.userId), {
      isCustomGift: m,
      isCollectiblesGift: b,
      accepted: O,
      opened: y,
      emojiURL: S
    } = this.state, v = R.default.getCurrentUser(), P = this.step === W.wZ8.ERROR, x = (null == n ? void 0 : n.userId) != null && null != v && (null == v ? void 0 : v.id) != null && n.userId === v.id;
    switch (this.step) {
      case W.wZ8.ERROR:
        null == c || c(n, !1);
        break;
    ...
    return (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsxs)(u.Y0X, {
        ...
        className: B.modal,
        "aria-labelledby": r,
        children: [null != n.giftStyle && !m && !b && (0, i.jsx)(M.Z, {
          ...
          children: [!b && (null == n.giftStyle || m && O) && (0, i.jsx)(Z.Z, {
          ...
          }), m && !b && null != n.giftStyle && !O && (0, i.jsx)(M.Z, {
            defaultAnimationState: this.getDefaultAnimationStatus(),
            idleAnimationState: this.getIdleAnimationStatus(),
            className: B.giftAnimation,
            giftStyle: n.giftStyle
          }), this.state.opened && !P && (0, i.jsx)(j.Z, {
            giftCode: n
          }), P && (0, i.jsx)(u.Text, {
            className: B.body,
            variant: "text-md/normal",
            children: this.errorMessage
          }), m && this.state.opened && !this.state.accepted && !P && null != d && "" !== d && !x && (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsx)(u.vwX, {
              children: z.NW.format(z.t.DDO4W1, {
      ...
      }), null != n.giftStyle && !o && this.step !== W.wZ8.ERROR && !O && !e && y && (null == p || null == S ? (0, i.jsx)(Y, {
        openedGift: y && !O && !e
      }) : (0, i.jsx)(F.Z, {
        confettiTarget: this.modalRef.current,
        emojiURL: S
      })), !O && !e && y && null != h && (0, i.jsx)(K, {
        soundId: h,
        step: this.step
      })]
    })
  ...
  constructor(...t) {
    super(...t), X(this, "state", {
      ...
      step: void 0,
      emojiURL: void 0
    }), X(this, "modalRef", n.createRef()), X(this, "handleOpen", () => {
      this.setState({
        opened: !0
      })
    ...
    }), X(this, "getDefaultAnimationStatus", () => this.step === W.wZ8.OPEN ? L.SR.IDLE : L.SR.ACTION), X(this, "getIdleAnimationStatus", () => {
...
let Q = o.ZP.connectStores([T.Z, A.Z, b.Z, C.Z, N.Z, h.Z], t => {
    let {
      giftCode: e
    } = t, s = A.Z.get(e.skuId), i = null != s ? b.Z.getApplication(s.applicationId) : null, n = h.Z.useReducedMotion;
    return {
      sku: s,
