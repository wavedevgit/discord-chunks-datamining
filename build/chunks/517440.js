...
function h(t) {
  let e = l.C.useExperiment({
    ...
    S = function(t, e) {
      let [n, r] = a.useState(!1), i = a.useCallback(async () => {
        if (!n) {
    ...
    j = function(t, e) {
      let [r, l] = a.useState(!1), p = (0, i.e7)([u.default], () => u.default.locale), f = a.useCallback(async (n, s) => {
        if (r) return;
        let a = null != n ? n : p;
        l(!0);
        let i = null != s ? s : a;
  ...
  return "" !== y.trim() && (null == e ? void 0 : e.enableAIFeatures) ? (0, s.jsxs)(s.Fragment, {
    children: [S, j]
  }) : null
}