...
function y(t) {
  let e = c.C.useExperiment({
    ...
    j = function(t, e) {
      let [n, i] = a.useState(!1), r = a.useCallback(async () => {
        if (!n) {
    ...
    T = function(t, e) {
      let [i, c] = a.useState(!1), d = (0, r.e7)([u.default], () => u.default.locale), b = a.useCallback(async (n, l) => {
        if (i) return;
        let a = null != n ? n : d;
        c(!0);
        let r = null != l ? l : a;
  ...
  return "" !== m.trim() && (null == e ? void 0 : e.enableAIFeatures) ? (0, l.jsxs)(l.Fragment, {
    children: [j, T]
  }) : null
}