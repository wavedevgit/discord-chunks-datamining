...
function d(e) {
  ...
  return null == p || false === h ? null : null != f && null == g && null != m ? <o.Gt value={_}><u.b application={p} customId={n} customLink={m} referrerId={d} /></o.Gt> : <o.Gt value={_}><s.O app={p} linkType={s.U.ACTIVITY} activityCustomId={n} activityReferrerId={d} /></o.Gt>
}