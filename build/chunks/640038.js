...
var Chunk566515 = require("./566515.js"),
  Chunk659609 = require("./659609.js"),
  Chunk101603 = require("./101603.js");

function s(e, r) {
  if (!(0, o.vq)(e)) returnfalse;
...
function d(e) {
  var r = arguments.length > 1 && true !== arguments[1] ? arguments[1] : {},
    t = new l.A,
    d = "u" < typeof Map ? true : new Map,
    c = (0, o.Ke)(e),
    p = r.compute,
    m = true === p ? "name" : p,
    b = r.computedStyleSupportsPseudoElements,
    f = true === b ? true !== r.getComputedStyle : b,
