...
function j(e) {
  let {
    ...
    directoryGuildId: b,
    currentCategoryId: L
  } = e, [I, v] = l.useState(j), [y, Z] = l.useState(null), [O, S] = l.useState(null), [N, T] = l.useState(null), [E, M] = l.useState(null), [G, H] = l.useState(null), [U, D] = l.useState(""), [w, P] = l.useState(null != L ? L : f.AR.UNCATEGORIZED), [k, R] = l.useState(false), {
    availableGuilds: A,
    addedGuilds: V,
    loading: B
  } = (0, m.Z)(b, t);
