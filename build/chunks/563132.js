...
function z(e) {
  ...
  let {
    ...
    children: q,
    defaultPlanId: Q,
    purchaseType: X = G.GZQ.SUBSCRIPTION,
    applicationId: J,
    referralCode: $,
    repeatPurchase: ee = !1,
    excludeSubscriptionPlansBySKU: et = !1
  } = e, en = (0, j.Z)(), er = (0, h.Q)(), ei = (0, P.Z)(), ea = K[0], eo = (0, c.e7)([O.Z], () => O.Z.get(ea), [ea]), es = null == eo ? void 0 : eo.eligiblePaymentGateways, {
    paymentSources: el,
  ...
  } = (0, N.Z)(), [eF, eV] = (0, c.Wu)([b.Z], () => [b.Z.purchaseTokenAuthState, b.Z.purchaseTokenHash]), [eZ, eH, eY, eW] = (0, c.Wu)([U.Z], () => [U.Z.browserCheckoutState, U.Z.loadId, U.Z.skuId, U.Z.planId]), [eK, ez] = i.useState(null), [eq, eQ] = i.useState(null), [eX, eJ] = i.useState(null), [e$, e0] = i.useState(null), [e1, e2] = i.useState(null), [e3, e4] = i.useState(void 0), [e5, e6] = i.useState([]), e8 = i.useMemo(() => null == eM || (0, T.PV)(eM.id), [eM]), e7 = i.useRef(null != F ? F.planId : null);
  i.useEffect(() => {
  ...
  let {
    ...
    isGift: z
  }), ta = tt[null != ek ? ek : ""], to = null != ek ? ti[ek] : null, [ts, tl] = i.useState(to), tc = i.useMemo(() => {
    if (null == ek) return null;
    let e = tr[ek];
    return null == e ? null : e[null != eu ? eu : y.c]
  }, [ek, tr, eu]), {
    data: tu
  } = (0, p.IX)(J), td = E.Sb.useSetting(), tf = (0, c.e7)([d.Z], () => d.Z.getFetchState());
  i.useEffect(() => {
  ...
  let t_ = (0, S.yE)(null != (t = null == tu ? void 0 : tu.flags) ? t : 0, G.udG.EMBEDDED) && (0, S.yE)(null != (n = null == tu ? void 0 : tu.flags) ? n : 0, G.udG.EMBEDDED_IAP),
    tp = (0, c.e7)([_.ZP], () => Array.from(_.ZP.getSelfEmbeddedActivities().values()).find(e => {
      let {
        applicationId: t
      } = e;
      return t === J
