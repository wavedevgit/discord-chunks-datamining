...
function q(e) {
  ...
  } = (0, N.Z)(), [eF, eZ] = (0, c.Wu)([b.Z], () => [b.Z.purchaseTokenAuthState, b.Z.purchaseTokenHash]), [eH, eY, eW, eK] = (0, c.Wu)([U.Z], () => [U.Z.browserCheckoutState, U.Z.loadId, U.Z.skuId, U.Z.planId]), [ez, eq] = i.useState(null), [eX, eQ] = i.useState(null), [eJ, e$] = i.useState(null), [e0, e1] = i.useState(null), [e2, e3] = i.useState(null), [e4, e5] = i.useState(void 0), [e6, e8] = i.useState([]), e7 = i.useMemo(() => null == ej || (0, S.PV)(ej.id), [ej]), e9 = i.useRef(null != F ? F.planId : null);
  i.useEffect(() => {
    null == e9.current && null != F && (e9.current = F.planId)
  }, [F]);
  let {
    endsAt: te
  } = (0, m.Z)({
  ...
  let {
    ...
    data: td
  } = (0, p.IX)($), t_ = E.Sb.useSetting(), tf = (0, c.e7)([d.Z], () => d.Z.getFetchState());
  i.useEffect(() => {
  ...
  let tp = (0, T.yE)(null != (t = null == td ? void 0 : td.flags) ? t : 0, G.udG.EMBEDDED) && (0, T.yE)(null != (n = null == td ? void 0 : td.flags) ? n : 0, G.udG.EMBEDDED_IAP),
    th = (0, c.e7)([f.ZP], () => Array.from(f.ZP.getSelfEmbeddedActivities().values()).find(e => {
      let {
        applicationId: t
      } = e;
      return t === $
    ...
    tv = tO ? V.premiumRebrandBackground : void 0;
