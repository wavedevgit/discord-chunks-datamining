...
function Q(e) {
  ...
  let {
    ...
    children: J,
    defaultPlanId: $,
    purchaseType: ee = V.GZQ.SUBSCRIPTION,
    applicationId: et,
    referralCode: en,
    excludeSubscriptionPlansBySKU: er = !1,
    excludeSKUPurchasePreviews: ei = !1
  } = e, ea = (0, G.Z)(), eo = (0, h.Q)(), es = (0, w.Z)(), el = X[0], ec = (0, c.e7)([v.Z], () => v.Z.get(el), [el]), eu = null == ec ? void 0 : ec.eligiblePaymentGateways, {
    paymentSources: ed,
  ...
  }), tl = ti[null != eU ? eU : ""], tc = null != eU ? ts[eU] : null, [tu, td] = i.useState(tc), t_ = i.useMemo(() => {
  ...
  let tm = (0, S.yE)(null != (t = null == tf ? void 0 : tf.flags) ? t : 0, V.udG.EMBEDDED) && (0, S.yE)(null != (n = null == tf ? void 0 : tf.flags) ? n : 0, V.udG.EMBEDDED_IAP),
    tg = (0, c.e7)([f.ZP], () => Array.from(f.ZP.getSelfEmbeddedActivities().values()).find(e => {
      let {
        applicationId: t
      } = e;
      return t === et
