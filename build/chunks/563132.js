...
function K(e) {
  ...
  let {
    ...
    children: z,
    defaultPlanId: q,
    purchaseType: Q = U.GZQ.SUBSCRIPTION,
    applicationId: X,
    referralCode: J,
    repeatPurchase: $ = !1
  } = e, ee = (0, M.Z)(), et = (0, h.Q)(), en = (0, C.Z)(), er = W[0], ei = (0, c.e7)([y.Z], () => y.Z.get(er), [er]), eo = null == ei ? void 0 : ei.eligiblePaymentGateways, {
    paymentSources: ea,
  ...
  let {
    ...
    data: tl
  } = (0, p.IX)(X), tc = g.Sb.useSetting(), tu = (0, c.e7)([d.Z], () => d.Z.getFetchState());
  i.useEffect(() => {
  ...
  let td = (0, I.yE)(null != (t = null == tl ? void 0 : tl.flags) ? t : 0, U.udG.EMBEDDED) && (0, I.yE)(null != (n = null == tl ? void 0 : tl.flags) ? n : 0, U.udG.EMBEDDED_IAP),
    tf = (0, c.e7)([_.ZP], () => Array.from(_.ZP.getSelfEmbeddedActivities().values()).find(e => {
      let {
        applicationId: t
      } = e;
      return t === X
