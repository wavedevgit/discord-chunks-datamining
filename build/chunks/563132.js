...
function K(e) {
  ...
  let {
    ...
    data: tc
  } = (0, p.IX)(X), tu = g.Sb.useSetting(), td = (0, c.e7)([d.Z], () => d.Z.getFetchState());
  i.useEffect(() => {
  ...
  let tf = (0, I.yE)(null != (t = null == tc ? void 0 : tc.flags) ? t : 0, U.udG.EMBEDDED) && (0, I.yE)(null != (n = null == tc ? void 0 : tc.flags) ? n : 0, U.udG.EMBEDDED_IAP),
    t_ = (0, c.e7)([_.ZP], () => Array.from(_.ZP.getSelfEmbeddedActivities().values()).find(e => {
      let {
        applicationId: t
      } = e;
      return t === X
