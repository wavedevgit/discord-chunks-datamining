...
function T(e) {
  let {
    ...
    channel: n,
    userId: a
  } = e, c = (0, d.IX)(t.application_id).data, f = (0, o.e7)([g.Z], () => null != g.Z.getPendingRequestForUser(a)), [_, p] = i.useState(!1), [m, E] = i.useState(!1), T = (0, o.e7)([h.Z], () => h.Z.getChannelId() !== n.id);
  async function S() {
    E(!0);
    try {
...
function S(e) {
  let {
    userId: t,
    channel: n
  } = e, l = (0, o.e7)([m.default], () => m.default.getUser(t)), u = (0, o.e7)([p.Z], () => p.Z.getActivities(t, n.getGuildId())), d = (0, o.e7)([p.Z], () => p.Z.getStatus(t, n.getGuildId())), h = (0, _.Z)(n, null != l ? l : null), g = (0, E.Z)(n.id), y = i.useMemo(() => a.uniqBy(u.filter(e => e.type === b.IIU.PLAYING), e => e.application_id), [u]);
