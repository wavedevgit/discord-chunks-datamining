...
function T(e) {
  let {
    ...
    channel: n,
    userId: o
  } = e, c = (0, d.IX)(t.application_id).data, f = (0, a.e7)([g.Z], () => null != g.Z.getPendingRequestForUser(o)), [_, p] = i.useState(!1), [m, E] = i.useState(!1), T = (0, a.e7)([h.Z], () => h.Z.getChannelId() !== n.id);
  async function S() {
    E(!0);
    try {
