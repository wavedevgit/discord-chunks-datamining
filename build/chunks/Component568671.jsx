...
function p() {
  let e = (0, Chunk546791.nE)(Chunk388032.intl.string(Chunk225753.default.Ta9byS), Chunk388032.intl.string(Chunk225753.default["8SLtqb"])),
    t = () => {
      (0, Chunk481060.ZDy)(async () => {
        let {
          default: e
        } = await Promise.all([require.e("97012"), require.e("48168")]).then(require.bind(require, 978305));
