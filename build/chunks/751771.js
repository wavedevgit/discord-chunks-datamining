...
function O(e) {
  ...
  let i = new Set;
  return o === _.Iq.EMBEDDED_APPLICATION && m.Z.getChannelHistory().map(e => I.Z.getChannel(e)).filter(v.lm).filter(e => e.type === j.d4z.GUILD_TEXT).filter(e => f.Z.can(j.Plq.SEND_MESSAGES, e)).slice(0, 3).forEach(e => i.add(e.id)), (0, x.an)({
    query: e,
    omitUserIds: E,
    suggestedUserIds: t,
...
let P = new C(g.Z, {
  LOAD_INVITE_SUGGESTIONS: function(e) {
    ...
    r = null != u ? n : null, s = u, a = d, o = c, E = new Set([...t, ...N.Z.getBlockedOrIgnoredIDs(), ...(0, x.Sz)({
      channel: s,
      applicationId: a,
      inviteTargetType: c
    })]), i = !1;
