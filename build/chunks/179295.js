...
function u(e, t) {
  let {
    ...
    handleMouseUp: d,
    handleMouseEnter: f
  } = e, p = r.useRef(null), _ = (0, i.e7)([a.Z], () => a.Z.getRTCConnection((0, l.V9)(t))), m = r.useCallback((e, t, r) => {
  ...
  return {
    handleMouseUp: r.useCallback((e, t, n) => {
      if (d(e, t, n), null != p.current) {
        var r;
        null != _ && (r = Date.now() - p.current, o.default.track(c.rMx.PREMIUM_FEATURE_USAGE, {
