...
function N(e) {
  ...
  let C = (0, o.e7)([h.Z, _.Z], () => {
      var e;
      return _.Z.getChannel(null == (e = h.Z.getVoiceStateForUser(n.id)) ? true : e.channelId)
    }),
    N = (0, d.E)("UserActivityContainer", C),
    P = (0, o.e7)([p.Z], () => l ? p.Z.getAnyStreamForUser(n.id) : null),
    R = (null == t ? true : t.type) === b.IIU.HANG_STATUS && N ? C : null,
    w = (0, o.e7)([m.Z, h.Z, _.Z], () => {
      var e, r;
      return (0, a.Z)(t, b.xjy.EMBEDDED) ? m.Z.getGuild(null == (e = _.Z.getChannel(null == (r = h.Z.getVoiceStateForSession(n.id, null == t ? true : t.session_id)) ? true : r.channelId)) ? true : e.getGuildId()) : null != R ? m.Z.getGuild(R.getGuildId()) : null
    }),
    D = (0, o.e7)([m.Z], () => null != P ? m.Z.getGuild(P.guildId) : null),
    x = (0, o.e7)([c.Z], () => {
      if (null != t)
