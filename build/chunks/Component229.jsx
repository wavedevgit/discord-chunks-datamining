...
require.d(exports, {
  A: () => ea
}), require("./747238.js"), require("./812715.js"), require("./733351.js"), require("./896048.js"), require("./801541.js");
...
var Chunk491509 = require("./491509.js"),
  ...
  Chunk926451 = require("./926451.jsx"),
  ...
  Chunk68729 = require("./68729.js");
require("./436317.js");
var Chunk771016 = require("./771016.js");
require("./789622.js");
var Chunk985018 = require("./985018.jsx"),
  Chunk246313 = require("./246313.js"),
...
class el extends(r = Chunk64700.PureComponent) {
  ...
  componentDidMount() {
    ...
    }, null != e ? (0, I.A)(e, false, false) : {}), {
      flush: true
    }), null == this.props.consentRequired && g.A.getLocationMetadata(), (0, G.d)("register")
  }
  ...
  async handleRegister() {
    ...
    } = this.props, d = null != l ? l.code : null, h = null != o ? o.skuId : null, f = b.mZ.getState(), p = (0, Q.uJ)(u) ? null : t === u;
    H._.dispatch(X.jej.WAVE_EMPHASIZE), this.setState({
      registering: true,
      apiErrors: {}
    });
    try {
      this.inGuildOrChannelInviteFlow() ? await (0, j.Ay)({
        consent: i,
        invite: d,
        giftCodeSKUId: h,
  ...
  renderInviteResolving() {
    ...
    return (0, i.jsxs)(y.Ay, {
      className: e,
      children: [(0, i.jsx)(q.M, {}), (0, i.jsxs)(y.eB, {
        className: ee.y0,
  ...
  renderInviteHeader() {
    ...
    return (null == e ? true : e.guild_scheduled_event) != null ? (0, i.jsx)(S.X, {
      channel: e.channel,
  ...
  renderErrorMessage() {
    ...
    return "string" != typeof e ? null : (0, i.jsx)(y.ME, {
  ...
  renderFull(e, t) {
    let {
    ...
    } = this.props, C = this.renderErrorMessage(), R = (0, i.jsx)(f.m, {
      ...
      children: e()
    }, "custom-header") : (0, i.jsx)(y.hE, {
      children: $.intl.string($.t.wC4TlR)
    }, "title"), U = (0, i.jsxs)(y.eB, {
      className: et.QX,
      children: [(0, i.jsx)(y.pd, {
        autoFocus: true,
        className: et.SX,
      ...
      }), (0, i.jsx)(N.A, {}), this.renderConsentComponent(), R, C, (0, i.jsx)("div", {
        className: et.QX,
        children: (0, i.jsx)(p.QWc, {
          text: $.intl.string($.t["1lWxux"]),
          textVariant: "text-sm/normal",
  ...
  render() {
    ...
    return null != r && t ? r.state === X.elq.RESOLVING ? this.renderInviteResolving() : this.renderInvite() : null != s ? this.renderFull(() => (0, i.jsx)(T.A, {
      guildTemplate: s
    }), true) : null != n ? this.renderFull(() => (0, i.jsx)(z.A, {
      giftCode: n
  ...
  constructor(e) {
    var t;
    super(e), en(this, "emailRef", true), en(this, "usernameRef", true), en(this, "globalNameRef", true), en(this, "passwordRef", true), en(this, "dateOfBirthRef", s.createRef()), en(this, "_retryTimer", new h.Ep), en(this, "handleGotoLogin", e => {
      let t, {
          email: n
        } = this.state,
        {
...
function eo(e) {
  ...
  return t = u ? (0, c.YW)(o).with({
    ...
    show: u && (null == o ? true : o.type) === k.q.ERROR || l,
    top: false,
    bottom: 20,
    children: t
  })
