...
function j(e) {
  ...
  let {
    subscription: j,
    onUpdated: g
  } = e, [_, y] = r.useState(!1), [C, O] = r.useState(!1), [E, N] = r.useState(null), T = e => (null == e && (e = j.status), e in f) ? f[e] : "Unknown status ".concat(e), S = e => {
    let t = new Date(e);
    ...
    g()
  }, k = (null == (t = h.GP[j.planIdFromItems]) ? void 0 : t.premiumType) === h.p9.TIER_0, I = null == (n = j.metadata) ? void 0 : n.ended_at, R = null != I ? new Date(I).toISOString().substring(0, 10) : "";
  return (0, a.jsxs)("div", {
    ...
    children: [(0, a.jsxs)(s.Text, {
      ...
      variant: "text-md/normal",
      children: ["ID: ", j.id, " "]
    }), j.status !== x.O0b.ACTIVE && (0, a.jsxs)(s.Text, {
      variant: "text-md/normal",
