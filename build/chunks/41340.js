...
function g(e) {
  ...
  let {
    subscription: g,
    onUpdated: j
  } = e, [_, y] = r.useState(!1), [C, O] = r.useState(!1), [N, E] = r.useState(null), T = e => (null == e && (e = g.status), e in f) ? f[e] : "Unknown status ".concat(e), S = e => {
    let t = new Date(e);
  ...
  return (0, a.jsxs)("div", {
    ...
    children: [(0, a.jsxs)(o.Text, {
      ...
      variant: "text-md/normal",
      children: ["ID: ", g.id, " "]
    }), g.status !== x.O0b.ACTIVE && (0, a.jsxs)(o.Text, {
      variant: "text-md/normal",
