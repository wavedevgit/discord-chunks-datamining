...
function j(e) {
  ...
  let {
    subscription: j,
    onUpdated: g
  } = e, [_, y] = r.useState(!1), [C, O] = r.useState(!1), [N, E] = r.useState(null), T = e => (null == e && (e = j.status), e in f) ? f[e] : "Unknown status ".concat(e), S = e => {
    let t = new Date(e);
  ...
  return (0, a.jsxs)("div", {
    ...
    children: [(0, a.jsxs)(o.Text, {
      ...
      variant: "text-md/normal",
      children: ["ID: ", j.id, " "]
    }), j.status !== x.O0b.ACTIVE && (0, a.jsxs)(o.Text, {
      variant: "text-md/normal",
