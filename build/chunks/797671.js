...
function k(e) {
  ...
  let {
    ...
    onSubmit: S,
    onClose: D
  } = e, W = (0, p.Dt)(), T = (0, p.Dt)(), R = (0, p.Dt)(), M = (0, p.Dt)(), [P, z] = r.useState(v.Sc2), [G, H] = r.useState(v.d4z.GUILD_TEXT), [Z, A] = r.useState(""), [U, O] = r.useState(!1), V = (0, o.e7)([g.Z], () => g.Z.getGuild(k), [k]), F = (0, f.m)(k), X = (0, b.W3)(k), q = (0, m.Ui)(V), J = r.useMemo(() => (function(e) {
    let {
  ...
  }), [F, X, q]), Y = (0, o.e7)([I.Z], () => I.Z.getCategories(k)._categories, [k]), K = r.useMemo(() => Y.map(e => {
    let {
      channel: t
    } = e;
    return {
  ...
  }), [Y]), Q = null != (n = null == (t = J.find(e => e.value === G)) ? void 0 : t.channelIcon) ? n : L.Vq, $ = "" !== Z;
  return (0, a.jsx)("form", {
    onSubmit: function(e) {
      ...
      children: [(0, a.jsxs)(s.xBx, {
        ...
        children: [(0, a.jsx)(s.zxk, {
          ...
          children: [(0, a.jsx)(j.Z, {
            direction: j.Z.Directions.LEFT
          }), w.intl.string(w.t["13/7kZ"])]
        })]
      })]
    })
  })
