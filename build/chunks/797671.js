...
function E(e) {
  ...
  let {
    ...
    onSubmit: B,
    onClose: S
  } = e, w = (0, _.Dt)(), W = (0, _.Dt)(), G = (0, _.Dt)(), [T, A] = a.useState(C.Sc2), [M, U] = a.useState(C.d4z.GUILD_TEXT), [k, H] = a.useState(""), [O, P] = a.useState(!1), Z = (0, o.e7)([g.Z], () => g.Z.getGuild(E), [E]), V = (0, f.m)(E), R = (0, h.Ui)(Z), z = a.useMemo(() => (function(e) {
    let {
  ...
  }), [F]), q = null != (n = null == (t = z.find(e => e.value === M)) ? void 0 : t.channelIcon) ? n : j.Vq, J = "" !== k;
  return (0, i.jsx)("form", {
    onSubmit: function(e) {
