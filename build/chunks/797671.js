...
function E(e) {
  ...
  let {
    ...
    onSubmit: B,
    onClose: W
  } = e, D = (0, u.Dt)(), T = (0, u.Dt)(), k = (0, u.Dt)(), [R, M] = r.useState(w.Sc2), [P, G] = r.useState(w.d4z.GUILD_TEXT), [A, H] = r.useState(""), [U, O] = r.useState(!1), Z = (0, o.e7)([g.Z], () => g.Z.getGuild(E), [E]), V = (0, x.m)(E), z = (0, b.W3)(E), F = (0, m.Ui)(Z), X = r.useMemo(() => (function(e) {
    let {
  ...
  }), [V, z, F]), q = (0, o.e7)([I.Z], () => I.Z.getCategories(E)._categories, [E]), J = r.useMemo(() => q.map(e => {
    let {
      channel: t
    } = e;
    return {
  ...
  }), [q]), K = null != (n = null == (t = X.find(e => e.value === P)) ? void 0 : t.channelIcon) ? n : C.Vq, Y = "" !== A;
  return (0, a.jsx)("form", {
    onSubmit: function(e) {
