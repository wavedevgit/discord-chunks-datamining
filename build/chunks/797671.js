...
function S(e) {
  ...
  let {
    ...
    onSubmit: B,
    onClose: D
  } = e, E = (0, p.Dt)(), T = (0, p.Dt)(), R = (0, p.Dt)(), [M, W] = r.useState(w.Sc2), [G, k] = r.useState(w.d4z.GUILD_TEXT), [A, H] = r.useState(""), [U, O] = r.useState(!1), P = (0, o.e7)([g.Z], () => g.Z.getGuild(S), [S]), Z = (0, m.m)(S), V = (0, h.Ui)(P), z = r.useMemo(() => (function(e) {
    let {
  ...
  }), [F]), q = null != (a = null == (t = z.find(e => e.value === G)) ? void 0 : t.channelIcon) ? a : C.Vq, J = "" !== A;
  return (0, n.jsx)("form", {
    onSubmit: function(e) {
