...
a.d(t, {
  default: () => j
}), a(539854), a(953529), a(388685), a(457542);
var n = a(255367),
  r = a(73800),
  i = a(990547),
  o = a(442837),
...
function j(e) {
  ...
  let {
    ...
    onSubmit: D,
    onClose: E
  } = e, T = (0, p.Dt)(), R = (0, p.Dt)(), M = (0, p.Dt)(), [W, G] = r.useState(C.Sc2), [k, A] = r.useState(C.d4z.GUILD_TEXT), [H, U] = r.useState(""), [O, P] = r.useState(!1), Z = (0, o.e7)([I.Z], () => I.Z.getGuild(j), [j]), V = (0, x.m)(j), z = (0, b.W3)(j), F = (0, m.Ui)(Z), X = r.useMemo(() => (function(e) {
    let {
  ...
  }), [V, z, F]), q = (0, o.e7)([g.Z], () => g.Z.getCategories(j)._categories, [j]), J = r.useMemo(() => q.map(e => {
    let {
      channel: t
    } = e;
    return {
  ...
  }), [q]), K = null != (a = null == (t = X.find(e => e.value === k)) ? void 0 : t.channelIcon) ? a : N.Vq, Y = "" !== H;
  return (0, n.jsx)("form", {
    onSubmit: function(e) {
