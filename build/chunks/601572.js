...
function S(e) {
  let {
    ...
    onEnable: S,
    onClose: y
  } = e, N = T.Z.getCameraComponent(), P = (0, _.Dt)(), R = (0, b.Z)(), v = p.qF.useSetting(), [L, k] = r.useState((0, m.P)(I.default.getCurrentUser())), w = (0, l.O)(), {
    analyticsLocations: D
  } = (0, u.ZP)(s.Z.CAMERA_PREVIEW), x = r.useRef(null);
  r.useEffect(() => {
      ...
      children: (0, a.jsxs)(i.Y0X, {
        ...
        children: [(0, a.jsxs)(i.hzk, {
          ...
          children: [(() => {
            ...
            value: v,
            onChange: () => {
              p.qF.updateSetting(!v), C.default.track(h.rMx.UPDATE_USER_SETTINGS_LOCAL, {
