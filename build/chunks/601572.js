...
function I(e) {
  let {
    ...
    onEnable: I,
    onClose: y
  } = e, P = h.Z.getCameraComponent(), k = (0, u.Dt)(), B = (0, m.Z)(), w = b.qF.useSetting(), [A, E] = a.useState((0, f.P)(S.default.getCurrentUser())), L = (0, l.O)(), {
    analyticsLocations: N
  } = (0, _.ZP)(s.Z.CAMERA_PREVIEW), j = a.useRef(null);
  a.useEffect(() => {
      ...
      children: (0, o.jsxs)(r.Y0X, {
        ...
        children: [(0, o.jsxs)(r.hzk, {
          ...
          children: [(() => {
            ...
            value: w,
            onChange: () => {
              b.qF.updateSetting(!w), v.default.track(x.rMx.UPDATE_USER_SETTINGS_LOCAL, {
