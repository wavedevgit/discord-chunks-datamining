...
function w(e) {
  let {
    ...
    onEnable: w,
    onClose: D
  } = e, A = y.Z.getCameraComponent(), j = (0, f.Dt)(), L = (0, S.Z)(), T = b.qF.useSetting(), [N, R] = a.useState((0, O.P)(E.default.getCurrentUser())), I = (0, c.O)(), {
    analyticsLocations: Z
  } = (0, s.ZP)(u.Z.CAMERA_PREVIEW), C = a.useRef(null);
  a.useEffect(() => {
      ...
      children: (0, n.jsxs)(l.Y0X, {
        ...
        children: [(0, n.jsxs)(l.hzk, {
          ...
          children: [(() => {
            ...
            value: T,
            onChange: () => {
              b.qF.updateSetting(!T), P.default.track(_.rMx.UPDATE_USER_SETTINGS_LOCAL, {
