...
function I(e) {
  let {
    ...
    onEnable: I,
    onClose: P
  } = e, E = y.Z.getCameraComponent(), x = (0, _.Dt)(), A = (0, f.Z)(), w = p.qF.useSetting(), [L, D] = r.useState((0, g.P)(S.default.getCurrentUser())), k = (0, l.O)(), {
    analyticsLocations: R
  } = (0, u.ZP)(s.Z.CAMERA_PREVIEW), M = r.useRef(null);
  r.useEffect(() => {
      ...
      children: (0, a.jsxs)(o.Y0X, {
        ...
        children: [(0, a.jsxs)(o.hzk, {
          ...
          children: [(() => {
            ...
            value: w,
            onChange: () => {
              p.qF.updateSetting(!w), h.default.track(C.rMx.UPDATE_USER_SETTINGS_LOCAL, {
