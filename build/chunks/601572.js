...
function w(e) {
  let {
    ...
    onEnable: w,
    onClose: D
  } = e, j = y.Z.getCameraComponent(), R = (0, f.Dt)(), Z = (0, S.Z)(), A = g.qF.useSetting(), [L, T] = i.useState((0, O.P)(_.default.getCurrentUser())), I = (0, u.O)(), {
    analyticsLocations: C
  } = (0, s.ZP)(c.Z.CAMERA_PREVIEW), U = i.useRef(null);
  i.useEffect(() => {
      ...
      children: (0, r.jsxs)(l.Y0X, {
        ...
        children: [(0, r.jsxs)(l.hzk, {
          ...
          children: [(() => {
            ...
            value: A,
            onChange: () => {
              g.qF.updateSetting(!A), v.default.track(m.rMx.UPDATE_USER_SETTINGS_LOCAL, {
