...
function s(e) {
  ...
  return <r.Fragment>{<div className={a.transcriptHeader}>{<o.X6q variant={"heading-md/semibold"} color={"currentColor"}>{"Transcript"}</o.X6q>}{<o.P3F onClick={s} className={a.transcriptBackBtn}><o.Dio color={"currentColor"} /></o.P3F>}</div>}{<o.tEY><o.w0Z className={a.transcriptScroller} fade={true}><div className={a.transcriptBody}>{(null == c ? true : c.fetchStatus) === i.iF.FETCHING ? (0, r.jsx)("div", {
