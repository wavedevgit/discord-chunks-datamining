...
function f(e) {
  ...
  return (f > c || _ > u) && (f > _ ? (p = c, h = c * _ / f) : (p = u * f / _, h = u)), <iframe className={o()(s.embedAmazonMusic, t)} src={l} style={{
      width: p,
      height: h
    }} frameBorder={0} sandbox={"allow-forms allow-modals allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"} />
}