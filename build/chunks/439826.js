...
function I(e) {
  ...
  let {
    ...
    ref: c,
    height: p = 0
  } = (0, d.ZP)([s]), f = (null == (t = n.userStatus) ? void 0 : t.completedAt) != null, g = (0, h.z)(n), {
    type: x,
    hints: b
  } = o.useMemo(() => f || g ? {
    type: 2,
    ...
    type: 2,
    hints: []
  }, [s, f, g, a]), j = 2 !== x, v = (0, u.q_F)({
    opacity: +!!j,
    height: j ? p : 0,
    config: N.Y
  }), y = 0 === x ? u.P4T : u.d3s, O = (0, m.Lq)(A.Ilk.RED_345), C = 0 === x ? O : l ? u.TVs.colors.TEXT_NORMAL : u.TVs.colors.WHITE;
...
function D(e) {
  let {
    ...
    isHovering: n,
    showAssets: s
  } = e, i = o.useRef(null), c = o.useRef(n), u = o.useContext(l.S).reducedMotion.enabled, d = o.useMemo(() => (0, y.fh)(t, y.eC.HERO_IMAGE), [t]), p = o.useMemo(() => (0, y.fh)(t, y.eC.HERO_VIDEO), [t]), m = (0, v.h)(t, T.dr.QUEST_HOME_DESKTOP), {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [s && null != d && (0, r.jsx)(C.Fl, {
      id: "QuestTileBanner",
      children: e => (0, r.jsx)("img", {
        ref: e,
        alt: "".concat(t.config.messages.questName),
        className: a()(k.heroAsset, {
          [k.hidden]: x
        }),
        src: d.url,
        onLoad: g
      })
    }), s && null != p && !m && (0, r.jsx)(C.Fl, {
      id: "QuestTileBanner_heroAnimated",
      children: e => {
        var t;
        return null != e.current && (i.current = e.current), (0, r.jsx)(f.Z, {
          ref: e,
          autoPlay: !1,
          loop: !0,
          muted: !0,
...
function M(e) {
  ...
  let {
    ...
    onCtxMenuOpen: C,
    onCtxMenuSelect: T
  } = e, N = (0, j.q8)(d), M = (0, p.ZP)(), L = ((0, c.wj)(M) ? A.BRd.DARK : A.BRd.LIGHT) === A.BRd.DARK, W = (0, h.tP)(d), Z = (null == (t = d.userStatus) ? void 0 : t.claimedAt) != null, V = (0, h.B6)(d.config.expiresAt, {
    month: "numeric",
    day: "numeric"
  }), Q = (null == (n = d.userStatus) ? void 0 : n.enrolledAt) != null, H = (null == (s = d.userStatus) ? void 0 : s.completedAt) != null, {
    onAssetLoadComplete: U
  } = o.useContext(P.k), z = o.useCallback(() => {
    N && ((0, j.zi)(d) || Q || (0, x.AH)(d.id, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [d.preview && (0, r.jsx)("div", {
            ...
            children: e => (0, r.jsx)(u.P3F, q(B({}, e), {
          ...
          children: [(0, r.jsx)(u.Text, {
            ...
            children: R.intl.format(R.t.buEvBw, {
              brandName: null != (l = null == (i = d.config.cosponsorMetadata) ? void 0 : i.name) ? l : d.config.messages.gamePublisher
            })
          }), W || Z ? null : (0, r.jsx)(u.Text, {
            variant: "text-sm/medium",
            color: L ? "text-muted" : "always-white",
