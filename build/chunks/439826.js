...
function I(e) {
  ...
  let {
    ...
    ref: f,
    height: g = 0
  } = (0, d.ZP)([o]), x = (null == (t = n.userStatus) ? void 0 : t.completedAt) != null, b = (0, h.z)(n), {
    type: j,
    hints: _
  } = s.useMemo(() => x || b ? {
    type: 2,
    ...
    type: 2,
    hints: []
  }, [o, x, b, a]), v = 2 !== j, y = (0, u.q_F)({
    opacity: +!!v,
    height: v ? g : 0,
    config: P.Y
  }), O = 0 === j ? u.Mgn : u.d3s, E = (0, m.Lq)(A.Ilk.RED_345), S = 0 === j ? E : l ? u.TVs.colors.TEXT_DEFAULT : u.TVs.colors.WHITE;
...
function q(e) {
  let {
    ...
    isHovering: n,
    showAssets: o
  } = e, a = s.useMemo(() => (0, _.fh)(t, _.eC.HERO_IMAGE), [t]), i = s.useMemo(() => (0, _.fh)(t, _.eC.HERO_VIDEO), [t]), l = (0, j.h)(t, T.dr.QUEST_HOME_DESKTOP), {
