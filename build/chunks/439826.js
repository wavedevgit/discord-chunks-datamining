...
function I(e) {
  ...
  let {
    ...
    height: j ? p : 0,
    config: N.Y
  }), y = 0 === x ? d.P4T : d.d3s, _ = (0, m.Lq)(A.Ilk.RED_345), C = 0 === x ? _ : l ? d.TVs.colors.TEXT_NORMAL : d.TVs.colors.WHITE;
...
function D(e) {
  let {
    quest: t,
    isHovering: n
  } = e, s = o.useRef(null), i = o.useRef(n), c = o.useContext(l.S).reducedMotion.enabled, d = o.useMemo(() => (0, y.fh)(t, y.eC.HERO_IMAGE), [t]), u = o.useMemo(() => {
    let e = (0, y.fh)(t, y.eC.HERO);
    return e.isAnimated ? e : (0, _.z)(_.i.QUEST_HOME_VIDEO, t)
  }, [t]), p = (0, v.h)(t, T.dr.QUEST_HOME_DESKTOP), {
...
function M(e) {
  ...
  let {
    ...
    onCtxMenuOpen: _,
    onCtxMenuSelect: O
  } = e, w = (0, j.q8)(u), T = (0, p.ZP)(), N = ((0, c.wj)(T) ? A.BRd.DARK : A.BRd.LIGHT) === A.BRd.DARK, M = (0, h.tP)(u), L = (null == (t = u.userStatus) ? void 0 : t.claimedAt) != null, W = (0, h.B6)(u.config.expiresAt, {
    month: "numeric",
    day: "numeric"
  }), Z = (null == (n = u.userStatus) ? void 0 : n.enrolledAt) != null, V = (null == (s = u.userStatus) ? void 0 : s.completedAt) != null, {
    onAssetLoadComplete: Q
  } = o.useContext(E.k), U = o.useCallback(() => {
    w && ((0, j.zi)(u) || Z || (0, x.AH)(u.id, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [u.preview && (0, r.jsx)("div", {
            ...
            children: e => (0, r.jsx)(d.P3F, q(B({}, e), {
