...
function D(e) {
  ...
  let {
    ...
    height: j ? p : 0,
    config: A.Y
  }), _ = 0 === x ? d.P4T : d.d3s, y = (0, m.Lq)(R.Ilk.RED_345), O = 0 === x ? y : l ? d.TVs.colors.TEXT_NORMAL : d.TVs.colors.WHITE;
...
function M(e) {
  let {
    ...
    isHovering: n,
    showAssets: s
  } = e, i = o.useRef(null), c = o.useRef(n), d = o.useContext(l.S).reducedMotion.enabled, u = o.useMemo(() => (0, _.fh)(t, _.eC.HERO_IMAGE), [t]), p = o.useMemo(() => {
    let e = (0, _.fh)(t, _.eC.HERO);
    return e.isAnimated ? e : (0, y.z)(y.i.QUEST_HOME_VIDEO, t)
  }, [t]), m = (0, v.h)(t, N.dr.QUEST_HOME_DESKTOP), {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [s && null != u && (0, r.jsx)(w.Fl, {
      id: "QuestTileBanner",
...
function L(e) {
  ...
  let {
    ...
    onCtxMenuOpen: C,
    onCtxMenuSelect: w
  } = e, N = (0, j.q8)(u), A = (0, p.ZP)(), L = ((0, c.wj)(A) ? R.BRd.DARK : R.BRd.LIGHT) === R.BRd.DARK, Z = (0, h.tP)(u), W = (null == (t = u.userStatus) ? void 0 : t.claimedAt) != null, V = (0, h.B6)(u.config.expiresAt, {
    month: "numeric",
    day: "numeric"
  }), Q = (null == (n = u.userStatus) ? void 0 : n.enrolledAt) != null, U = (null == (s = u.userStatus) ? void 0 : s.completedAt) != null, {
    onAssetLoadComplete: H
  } = o.useContext(E.k), z = o.useCallback(() => {
    N && ((0, j.zi)(u) || Q || (0, x.AH)(u.id, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [u.preview && (0, r.jsx)("div", {
            ...
            children: e => (0, r.jsx)(d.P3F, I(q({}, e), {
          ...
          children: [(0, r.jsx)(d.Text, {
            ...
            color: L ? "text-muted" : "always-white",
            children: B.intl.format(B.t.buEvBw, {
            ...
            variant: "text-sm/medium",
            color: L ? "text-muted" : "always-white",
            children: B.intl.format(B.t["7D8r4O"], {
              expiryDate: V
            })
          })]
        })]
