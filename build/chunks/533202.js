...
function f(e) {
  let {
    ...
    directoryGuildId: b,
    currentCategoryId: L
  } = e, [N, I] = s.useState(f), [y, v] = s.useState(null), [Z, S] = s.useState(null), [E, T] = s.useState(null), [O, B] = s.useState(null), [M, k] = s.useState(null), [H, D] = s.useState(""), [G, w] = s.useState(null != L ? L : p.AR.UNCATEGORIZED), [U, R] = s.useState(!1), {
    availableGuilds: A,
    addedGuilds: P,
    loading: V
  } = (0, u.Z)(b, t);
