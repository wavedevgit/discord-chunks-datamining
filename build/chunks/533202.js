...
function f(e) {
  let {
    ...
    directoryGuildId: b,
    currentCategoryId: L
  } = e, [N, I] = s.useState(f), [y, v] = s.useState(null), [Z, S] = s.useState(null), [T, E] = s.useState(null), [k, O] = s.useState(null), [B, M] = s.useState(null), [H, D] = s.useState(""), [w, G] = s.useState(null != L ? L : g.AR.UNCATEGORIZED), [U, R] = s.useState(!1), {
    availableGuilds: A,
    addedGuilds: P,
    loading: V
  } = (0, u.Z)(b, t);
