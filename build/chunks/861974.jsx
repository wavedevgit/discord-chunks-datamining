...
function f(e) {
  ...
  return <div className={o()(l.container, _, i)}>{<div className={l.iconDiv}>{f && (0, r.jsx)(f, {
        className: l.icon,
        color: "currentColor"
      })}</div>}{<s.x className={l.text} color={a} variant={c}>{t}</s.x>}</div>
}