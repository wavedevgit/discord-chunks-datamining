...
let g = {
  ...
  _ = e => {
    ...
    return t.size > 0 || n.size > 0 || "" !== r.trim() ? h : l.size > 0 ? m : g
  },
  b = (0, Chunk663042.U)((0, Chunk690775.XR)((e, t) => f(d({}, C), {
    ...
    onSetSearchQuery: t => {
      e(e => {
        ...
        return "" !== t.trim() ? (n.sort = h, n.userHasSelectedSort = false) : e.userHasSelectedSort || (n.sort = _(n)), n
      })
    },
    setQueryPageSize: t => {
      e({
