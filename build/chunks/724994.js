...
let s = (e, t) => {
    ...
    switch (null == t ? void 0 : t.type) {
      case a.Z.BUNDLE:
        return {
          isPurchased: i || s.length > 0 && c.length === s.length, isPartiallyOwnedBundle: c.length > 0 && c.length < s.length, isPartiallyOwnedVariantsGroup: !1
        };
      ...
      default:
        return {
          isPurchased: i, isPartiallyOwnedBundle: !1, isPartiallyOwnedVariantsGroup: !1
        }
    }
  },
