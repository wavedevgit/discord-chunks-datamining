...
function P(e) {
  ...
  } = e, Z = null == a || (0, f.AB)(a) ? null : a, L = (0, l.e7)([I.Z], () => I.Z.isInChannel(Z) || !1), j = (0, l.e7)([s.Z], () => null != Z && s.Z.getParticipantsListOpen(Z)), {
    enabled: k,
    inInbox: x
  } = d.Z.useExperiment({
    location: "HeaderBar"
  ...
  return (0, r.jsx)(S.ZP, {
    ...
    toolbar: function() {
      ...
      return i.tq ? C : (0, r.jsxs)(r.Fragment, {
        children: [P, e ? (0, r.jsx)(E.Z, {
          className: m.search
        }, null != p ? p : a) : null, M && (0, r.jsx)(S.ZP.Divider, {}), k && !x ? (0, r.jsx)(_.Z, {}) : null, F && L && null != Z && !j && c === N.d4z.GROUP_DM && (0, r.jsxs)("div", {
          className: m.controlButtonWrapper,
          children: [(0, r.jsx)(S.ZP.Divider, {}), (0, r.jsx)(O.Z, {
            onClick: () => o.Z.toggleParticipantsList(Z, !j)
          })]
        })]
      })
    }(),
