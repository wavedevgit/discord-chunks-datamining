...
function j(e) {
  let {
    ...
    transitionState: n,
    onClose: l
  } = e, [j, b] = i.useState([]), [g, m] = i.useState(), O = [{
  ...
  return null == t ? (l(), null) : (0, r.jsxs)(c.Y0X, {
    transitionState: n,
    size: c.CgR.MEDIUM,
    ...
    children: [(0, r.jsx)(c.xBx, {
      ...
      children: (0, r.jsx)("div", {
        ...
        children: O.map(e => {
          ...
          return (0, r.jsxs)("div", {
            className: s()(p.optionContainer, {
              [p.optionContainerOther]: n === u.C2.OTHER
            }),
            ...
            }), n === u.C2.OTHER && j.includes(u.C2.OTHER) && (0, r.jsx)("div", {
