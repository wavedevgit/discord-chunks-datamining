...
function c(e) {
  ...
  let {
    ...
    image: u
  } = e, d = null == u ? void 0 : u.emoji, f = (null == u || null == (t = u.mediaAttachmentState) ? void 0 : t.status) === o._.PREPARING, m = (0, a.e7)([i.Z], () => i.Z.getUpload(c, s, l.d.Poll)), [p, b] = r.useState(), [g, O] = r.useState("");
  return r.useEffect(() => {
    var e;
    if ((null == m || null == (e = m.item) ? void 0 : e.file) == null) return;
    let t = URL.createObjectURL(m.item.file);
    return b(t), O(m.item.file.name), () => {
