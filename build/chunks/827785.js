...
let x = require("./743361.js").A,
  ...
  k = [...x, {
    ...
    execute: async (e, t) => {
      ...
      d.A.sendMessage(l.id, _.Ay.parse(l, o), true, {
    ...
    execute: (e, t) => {
      ...
      (async () => {
        await c.A.openPrivateChannel({
          ...
          i()(null != t, "Newly created PrivateChannel is null"), d.A.sendMessage(t.id, _.Ay.parse(t, o), true, {
