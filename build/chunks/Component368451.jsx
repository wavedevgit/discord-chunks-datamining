...
function T(e) {
  ...
  let {
    ...
    type: t,
    values: T
  } : true), D = null != S.modal, w = s > 1, x = N === p.gH.LOADING, [L, M] = i.useState(false), [j, k] = i.useState(() => new Set(n.filter(e => e.default).map(e => e.value))), [U, G] = i.useState(j), B = i.useMemo(() => n.some(e => null != e.emoji), [n]);
  i.useEffect(() => {
