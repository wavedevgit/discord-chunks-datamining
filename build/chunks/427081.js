...
function P(e) {
  for (let r of E.Z.quests.values()) {
    var t, n;
    let a = (0, y.Mo)(r);
    if (null != r && (0, y.Rt)(r) && r.config.features.includes(i.S.ACTIVITY_QUEST_AUTO_ENROLLMENT) && !(0, y.zi)(r) && a === e && a !== v.Ts && (null == (t = r.userStatus) ? true : t.completedAt) == null && (null == (n = r.userStatus) ? true : n.enrolledAt) == null) return void(0, h.AH)(r.id, {
  ...
  getActivelyProgressingPlayOnDesktopQuests() {
    ...
    for (let t of Object.keys(Chunk754700)) {
      ...
      for (let r of require.values()) {
        ...
        }) : R(require, Chunk670081) && module.set(Chunk754700.id, {
  ...
  constructor(...e) {
    super(...e), S(this, "heartbeats", {
      ...
      let {
        progressSeconds: n,
        targetSeconds: i
      } = (0, y.il)(t, r.T.DESKTOP), a = Math.max(0, (i - n) * _.Z.Millis.SECOND);
      return a <= I ? a + A : I
      ...
      let a = () => {
        ...
        if (o.has(e)) {
          ...
          if (t === r.X.STREAM_ON_DESKTOP) {
            ...
            let r = (0, l.V9)(n);
            C.log("~ initiateHeartbeat -> Sending heartbeat for questId: ".concat(e)), (0, h.m0)({
              questId: e,
              streamKey: r,
              applicationId: u
            })
          } else C.log("~ initiateHeartbeat -> Sending heartbeat for questId: ".concat(e)), (0, h.m0)({
            questId: e,
            applicationId: u
          });
      ...
      if (null != i) {
        ...
        let t = r.get(e);
        null != t && N(t) && (C.log("~ terminateHeartbeat -> Sending terminal heartbeat for questId: ".concat(e)), (0, h.m0)({
          questId: e,
          terminal: true
        }))
      }
