...
class T extends i.Z {
  ...
  getActivelyProgressingPlayOnDesktopQuestIds() {
    ...
    for (let t of r)
      for (let r of n.values()) I(r) && (0, h.Nj)({
        quest: r
  ...
  getActivelyProgressingStreamOnDesktopQuestIds() {
    ...
    let r = n.id;
    if (null == r) return e;
    for (let t of p.Z.quests.values()) I(t) && (0, h.Dr)({
      quest: t
  ...
  getActivelyProgressingActivityQuestIds() {
    ...
    let r = p.Z.quests;
    for (let n of t.keys())
      for (let t of r.values()) I(t) && (0, h.pO)(t) && t.config.application.id === n && e.add(t.id);
  ...
  constructor(...e) {
    super(...e), E(this, "heartbeats", {
      ...
      let {
        progressSeconds: n,
        targetSeconds: i
      } = (0, h.il)(t, r.T.DESKTOP), a = Math.max(0, (i - n) * d.Z.Millis.SECOND);
      return a <= b ? a + O : b
