...
class I extends i.Z {
  ...
  getActivelyProgressingPlayOnDesktopQuestIds() {
    let e = new Set,
      ...
      n = _.Z.quests;
    for (let r of (v.log("~ getActivelyProgressingPlayOnDesktopQuestIds -> Running games: ", t), t))
      if (null != r.id)
  ...
  constructor(...e) {
    super(...e), g(this, "heartbeats", {
      ...
      if (null != i) {
        ...
        let t = r.get(e);
        null != t && O(t) && (v.log("~ terminateHeartbeat -> Sending terminal heartbeat for questId: ".concat(e)), (0, f.m0)({
          questId: e,
          terminal: !0
        }))
      }
