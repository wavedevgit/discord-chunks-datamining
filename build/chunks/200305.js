...
let M = e => {
  ...
  D = e => {
    ...
    return (0, s.jsxs)("div", {
      ...
      children: [(0, s.jsx)("img", {
        ...
        variant: "heading-xl/semibold",
        className: k.header,
        children: C.NW.format(C.t.v01XgI, {
          email: l
        })
      }), (0, s.jsx)(o.Text, {
        variant: "text-sm/normal",
  ...
  z = () => l.e("43841").then(l.t.bind(l, 737848, 19)).then(e => {
    let {
      default: t
    } = e;
    return t
  ...
  X = e => {
    ...
    let {
      ...
      onComplete: S,
      isPreview: I = !1
    } = e, T = null == r ? void 0 : r.guild, R = (0, O.N0)(E, T, I), z = null == r ? void 0 : r.formFields.some(e => e.field_type !== b.QJ.TERMS), X = (0, a.e7)([v.default], () => v.default.getCurrentUser()), _ = null == X ? void 0 : X.verified, B = null == X ? void 0 : X.isPhoneVerified(), A = (0, a.e7)([x.ZP], () => x.ZP.getGuildEmoji(E)), {
      storeMemberCount: V,
      storeOnlineCount: H
    } = (0, a.cj)([g.Z], () => ({
      storeMemberCount: g.Z.getMemberCount(E),
      storeOnlineCount: g.Z.getOnlineCount(E)
    })), [q, G] = n.useState(null != (t = null == r ? void 0 : r.formFields) ? t : []), [U, J] = n.useState(!1), [K, Y] = n.useState(null), [Q, $] = n.useState(""), [ee, et] = n.useState(""), [el, es] = n.useState(null), [en, er] = n.useState(null), ei = null != (l = null == R ? void 0 : R.hasFeature(w.oNc.CLAN)) && l, {
      emojisToRender: ea,
      remainingEmojis: eo,
      numGuildEmoji: ec
    } = n.useMemo(() => {
      ...
      let t = [...null != (e = 0 === A.length ? null == T ? void 0 : T.emojis : A) ? e : []].reverse(),
        l = 0,
        s = t.length;
      return s > 12 && null != t && (l = Math.min(s - (t = t.slice(0, 11)).length, 99)), {
        emojisToRender: t,
        remainingEmojis: l,
        numGuildEmoji: s
      }
    }, [T, A]), ed = null != V ? V : null == T ? void 0 : T.approximate_member_count, eu = null != H ? H : null == T ? void 0 : T.approximate_presence_count, em = null != z && z, {
      currentStep: ex,
      setCurrentStep: eh
    } = (0, O.k3)(X, em);
    (0, O.lk)(q), n.useEffect(() => {
      null != r && G(r.formFields)
    }, [r]), n.useEffect(() => {
      null != E && N.default.track(w.rMx.OPEN_MODAL, {
        type: W.N4,
        guild_id: E
      })
    }, [E]);
    ...
    let ev = async () => {
      ...
      try {
        await (null == S ? void 0 : S(Z(F({}, null != r ? r : p.t), {
          formFields: q
        }))), null == P || P(!0)
      } catch (s) {
        var t, l;
      ...
      children: [(0, s.jsxs)(m.Z, {
        ...
        children: [(0, s.jsxs)("div", {
          children: [(0, s.jsx)(h.Z, {
            guild: R,
            active: !0,
            className: i()(k.guildIcon, {
              [k.guildIconNoIcon]: null == R.icon
            })
          }), (0, s.jsx)(o.X6q, {
          ...
          }), null != ea && ea.length > 0 ? (0, s.jsxs)(s.Fragment, {
            children: [(0, s.jsx)("hr", {
              className: k.divider
            }), (0, s.jsx)(o.vwX, {
              children: C.NW.format(C.t.KHLg5e, {
                emojis: ec
              })
            }), (0, s.jsxs)("div", {
              ...
              children: [ea.map(e => {
                ...
                return (0, s.jsx)(o.ua7, {
                  text: ":".concat(e.name, ":"),
                  children: e => (0, s.jsx)("img", Z(F({}, e), {
                    width: 24,
                    height: 24,
                    src: t,
                    className: k.emoji,
          ...
          children: [null != eu && (0, s.jsxs)(m.Z, {
            align: m.Z.Align.CENTER,
            className: k.onlineCount,
            children: [(0, s.jsx)("div", {
              className: k.dotOnline
            }), (0, s.jsx)(o.Text, {
              variant: "text-sm/normal",
              children: C.NW.format(C.t["Oj3M6+"], {
                membersOnline: eu
              })
            })]
          }), null != ed && (0, s.jsxs)(m.Z, {
            align: m.Z.Align.CENTER,
            children: [(0, s.jsx)("div", {
              className: k.dotMembers
            }), (0, s.jsx)(o.Text, {
              variant: "text-sm/normal",
              children: C.NW.format(C.t.LM4ufX, {
                members: ed
              })
            })]
          })]
        ...
        children: [(0, s.jsx)(o.hzk, {
          ...
          children: (0, s.jsx)(o.qBt, {
            className: i()(k.sequencer, {
              [k.centerContent]: 2 !== ex
            }),
            steps: [0, 1, 2],
            step: ex,
            children: (() => {
          ...
          switch (ex) {
            ...
            case 2:
              return (0, s.jsxs)(o.mzw, {
                ...
                }), null != K && (0, s.jsx)(o.Text, {
                  variant: "text-xs/normal",
                  color: "text-danger",
                  children: K
                }), null == K && z && (0, s.jsxs)("div", {
