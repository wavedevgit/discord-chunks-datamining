...
let w = e => {
  ...
  M = e => {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)("img", {
        ...
        variant: "heading-xl/semibold",
        className: S.header,
        children: F.intl.format(F.t.v01XgI, {
          email: n
        })
      }), (0, r.jsx)(o.Text, {
        variant: "text-sm/normal",
  ...
  k = e => {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(o.X6q, {
        ...
        className: S.header,
        children: a ? F.intl.format(F.t.cgX47e, {
          guildName: s
  ...
  D = e => {
    ...
    let {
      ...
      onComplete: L,
      isPreview: z = !1
    } = e, Z = (0, N.N0)(A, null == T ? void 0 : T.guild, z), {
      guildProfile: q,
      fetchGuildProfile: B
    } = (0, f.u)(A), H = (0, m.h)(), U = (0, l.e7)([x.ZP, b.default], () => x.ZP.isMember(A, b.default.getId())), [G, V] = i.useState(!1);
    i.useEffect(() => {
    ...
    i.useEffect(() => {
      ...
      null != A && v.default.track(P.rMx.OPEN_MODAL, {
        type: I.N4,
        guild_id: A
      })
    }, [A]);
    ...
    let eb = null == ef ? void 0 : ef.verified,
      ...
      eO = i.useRef(null),
      eC = function(e) {
        let t = null != e ? _.ZP.getGuildIconURL({
    ...
    let eN = async () => {
      ...
      try {
        await (0, a.S2)({
          email: ee,
          password: en
        }), Y(!1), ep(N.KJ.EMAIL_CONFIRMATION)
      } catch (n) {
        var e, t;
