...
let w = e => {
  ...
  M = e => {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)("img", {
        ...
        variant: "heading-xl/semibold",
        className: S.header,
        children: F.NW.format(F.t.v01XgI, {
          email: n
        })
      }), (0, r.jsx)(o.Text, {
        variant: "text-sm/normal",
  ...
  A = e => {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(o.X6q, {
        ...
        className: S.header,
        children: a ? F.NW.format(F.t.cgX47e, {
          guildName: s
        }) : F.NW.string(F.t.DrEECw)
      }), (0, r.jsx)(o.Text, {
        variant: "text-sm/normal",
        color: "header-secondary",
  ...
  k = e => {
    ...
    let {
      ...
      onComplete: D,
      isPreview: L = !1
    } = e, z = (0, y.N0)(W, null == T ? void 0 : T.guild, L), {
      guildProfile: Z,
      fetchGuildProfile: q
    } = (0, f.u)(W), B = (0, m.h)(), H = (0, l.e7)([x.ZP, b.default], () => x.ZP.isMember(W, b.default.getId())), [U, G] = i.useState(!1);
    i.useEffect(() => {
    ...
    i.useEffect(() => {
      ...
      null != W && v.default.track(P.rMx.OPEN_MODAL, {
        type: I.N4,
        guild_id: W
      })
    }, [W]);
    ...
    let eb = null == ef ? void 0 : ef.verified,
      ...
      e_ = i.useRef(null),
      eO = function(e) {
        let t = null != e ? N.ZP.getGuildIconURL({
    ...
    let ey = async () => {
      ...
      try {
        await (0, a.S2)({
          email: ee,
          password: en
        }), Y(!1), ep(y.KJ.EMAIL_CONFIRMATION)
      } catch (n) {
        var e, t;
