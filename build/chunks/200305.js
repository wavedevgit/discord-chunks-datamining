...
let w = e => {
  ...
  D = e => {
    ...
    let {
      ...
      onComplete: D,
      isPreview: L = !1
    } = e, q = (0, y.N0)(T, null == E ? void 0 : E.guild, L), {
      guildProfile: Z,
      fetchGuildProfile: z
    } = (0, m.u)(T), B = (0, l.e7)([g.ZP, p.default], () => g.ZP.isMember(T, p.default.getId())), [U, H] = i.useState(!1);
    i.useEffect(() => {
    ...
    i.useEffect(() => {
      ...
      null != T && j.default.track(P.rMx.OPEN_MODAL, {
        type: I.N4,
        guild_id: T
      })
    }, [T]);
