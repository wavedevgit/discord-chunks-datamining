...
let P = e => {
  ...
  R = e => {
    ...
    return (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsx)("img", {
        ...
        variant: "heading-xl/semibold",
        className: T.header,
        children: w.NW.format(w.t.v01XgI, {
          email: n
        })
      }), (0, i.jsx)(s.Text, {
        variant: "text-sm/normal",
  ...
  M = () => n.e("43841").then(n.t.bind(n, 737848, 19)).then(e => {
    let {
      default: t
    } = e;
    return t
  ...
  D = e => {
    ...
    let {
      ...
      onComplete: W,
      isPreview: B = !1
    } = e, E = null == l ? void 0 : l.guild, q = (0, C.N0)(y, E, B), M = null == l ? void 0 : l.formFields.some(e => e.field_type !== v.QJ.TERMS), D = (0, a.e7)([f.default], () => f.default.getCurrentUser()), L = null == D ? void 0 : D.verified, z = null == D ? void 0 : D.isPhoneVerified(), A = (0, a.e7)([x.ZP], () => x.ZP.getGuildEmoji(y)), {
      storeMemberCount: X,
      storeOnlineCount: V
    } = (0, a.cj)([b.Z], () => ({
      storeMemberCount: b.Z.getMemberCount(y),
      storeOnlineCount: b.Z.getOnlineCount(y)
    })), [H, G] = r.useState(null != (t = null == l ? void 0 : l.formFields) ? t : []), [U, J] = r.useState(!1), [K, Q] = r.useState(null), [Y, $] = r.useState(""), [ee, et] = r.useState(""), [en, ei] = r.useState(null), [er, el] = r.useState(null), eo = null != (n = null == q ? void 0 : q.hasFeature(k.oNc.CLAN)) && n, {
      emojisToRender: ea,
      remainingEmojis: es,
      numGuildEmoji: ec
    } = r.useMemo(() => {
      ...
      let t = [...null != (e = 0 === A.length ? null == E ? void 0 : E.emojis : A) ? e : []].reverse(),
        n = 0,
        i = t.length;
      return i > 12 && null != t && (n = Math.min(i - (t = t.slice(0, 11)).length, 99)), {
        emojisToRender: t,
        remainingEmojis: n,
        numGuildEmoji: i
      }
    }, [E, A]), ed = null != X ? X : null == E ? void 0 : E.approximate_member_count, eu = null != V ? V : null == E ? void 0 : E.approximate_presence_count, em = null != M && M, {
      currentStep: ex,
      setCurrentStep: eh
    } = (0, C.k3)(D, em);
    (0, C.lk)(H), r.useEffect(() => {
      null != l && G(l.formFields)
    }, [l]), r.useEffect(() => {
      null != y && p.default.track(k.rMx.OPEN_MODAL, {
        type: I.N4,
        guild_id: y
      })
    }, [y]);
    ...
    let ef = async () => {
      ...
      try {
        await (null == W ? void 0 : W(F(S({}, null != l ? l : _.t), {
          formFields: H
        }))), null == O || O(!0)
      } catch (i) {
        var t, n;
      ...
      children: [(0, i.jsxs)(m.Z, {
        ...
        children: [(0, i.jsxs)("div", {
          children: [(0, i.jsx)(h.Z, {
            guild: q,
            active: !0,
            className: o()(T.guildIcon, {
              [T.guildIconNoIcon]: null == q.icon
            })
          }), (0, i.jsx)(s.X6q, {
          ...
          }), null != ea && ea.length > 0 ? (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsx)("hr", {
              className: T.divider
            }), (0, i.jsx)(s.vwX, {
              children: w.NW.format(w.t.KHLg5e, {
                emojis: ec
              })
            }), (0, i.jsxs)("div", {
          ...
          children: [null != eu && (0, i.jsxs)(m.Z, {
            ...
            children: [(0, i.jsx)("div", {
              ...
              variant: "text-sm/normal",
              children: w.NW.format(w.t["Oj3M6+"], {
                membersOnline: eu
              })
            })]
          }), null != ed && (0, i.jsxs)(m.Z, {
            align: m.Z.Align.CENTER,
            children: [(0, i.jsx)("div", {
              className: T.dotMembers
            }), (0, i.jsx)(s.Text, {
              variant: "text-sm/normal",
              children: w.NW.format(w.t.LM4ufX, {
                members: ed
              })
            })]
          })]
        ...
        children: [(0, i.jsx)(s.hzk, {
          ...
          children: (0, i.jsx)(s.qBt, {
            className: o()(T.sequencer, {
              [T.centerContent]: 2 !== ex
            }),
            steps: [0, 1, 2],
            step: ex,
            children: (() => {
          ...
          switch (ex) {
            ...
            case 2:
              return (0, i.jsxs)(s.mzw, {
                ...
                }), null != K && (0, i.jsx)(s.Text, {
                  variant: "text-xs/normal",
                  color: "text-danger",
                  children: K
                }), null == K && M && (0, i.jsxs)("div", {
