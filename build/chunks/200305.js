...
let F = e => {
  ...
  G = e => {
    ...
    let {
      ...
      onComplete: A,
      isPreview: P = !1
    } = e, D = null == r ? void 0 : r.guild, V = (0, x.N0)(S, D, P), M = null == r ? void 0 : r.formFields.some(e => e.field_type !== j.QJ.TERMS), G = (0, a.e7)([N.default], () => N.default.getCurrentUser()), B = null == G ? void 0 : G.verified, k = null == G ? void 0 : G.isPhoneVerified(), W = (0, a.e7)([f.ZP], () => f.ZP.getGuildEmoji(S)), {
      storeMemberCount: U,
      storeOnlineCount: z
    } = (0, a.cj)([g.Z], () => ({
      storeMemberCount: g.Z.getMemberCount(S),
      storeOnlineCount: g.Z.getOnlineCount(S)
    })), [H, q] = l.useState(null != (t = null == r ? void 0 : r.formFields) ? t : []), [J, Y] = l.useState(!1), [X, K] = l.useState(null), [Q, $] = l.useState(""), [ee, et] = l.useState(""), [ei, en] = l.useState(null), [el, er] = l.useState(null), es = null != (i = null == V ? void 0 : V.hasFeature(b.oNc.CLAN)) && i, {
      emojisToRender: ea,
      remainingEmojis: eo,
      numGuildEmoji: eu
    } = l.useMemo(() => {
    ...
    }, [D, W]), ec = null != U ? U : null == D ? void 0 : D.approximate_member_count, ed = null != z ? z : null == D ? void 0 : D.approximate_presence_count, em = null != M && M, {
      currentStep: ef,
      setCurrentStep: eE
    } = (0, x.k3)(G, em);
    (0, x.lk)(H), l.useEffect(() => {
      null != r && q(r.formFields)
    }, [r]), l.useEffect(() => {
      null != S && I.default.track(b.rMx.OPEN_MODAL, {
        type: y.N4,
        guild_id: S
      })
    }, [S]);
    ...
    let eN = async () => {
      ...
      try {
        await (null == A ? void 0 : A(R(L({}, null != r ? r : p.t), {
          formFields: H
        }))), null == C || C(!0)
      } catch (n) {
        var t, i;
