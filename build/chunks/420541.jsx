...
let d = () => {
    ...
    return (0, Chunk317568.Z)(), <div className={Chunk992472.canvasWrapper} id={"simple-confetti-canvas"}><Chunk597846.z playing={require.playing} size={exports} useClockOptions={{
  ...
  f = () => (0, Chunk111810.kf)("ConfettiCanvasComponent") ? <d /> : null