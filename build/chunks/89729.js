...
function p(e, t) {
  ...
  let p = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : u.O.NORMAL,
    ...
    j = e.getReaction(t),
    v = p === u.O.BURST,
    O = r()(Array.from(null != (n = null == g ? void 0 : g.values()) ? n : [])).reject(e => a.Z.isBlockedOrIgnored(e.id)).take(3).map(e => c.ZP.getName(b, null == f ? void 0 : f.id, e)).value();
  if (0 === O.length) return "";
  let y = v ? h.burst : h.standard,
    x = Math.max(0, (null != (i = v ? null == j ? void 0 : j.burst_count : null == j ? void 0 : j.count) ? i : 0) - O.length),
    S = (0, l.Lh)(t);
  if (1 === O.length)
    if (!(x > 0)) return d.intl.formatToPlainString(y.reactionTooltip1, {
      a: O[0],
      emojiName: S
    });
  ...
  if (2 === O.length)
    if (!(x > 0)) return d.intl.formatToPlainString(y.reactionTooltip2, {
      a: O[0],
      b: O[1],
      emojiName: S
    });
  ...
  return 3 !== O.length ? null != m ? d.intl.format(y.reactionTooltipNInteractive, {
    ...
    n: x,
    emojiName: S
  }) : x > 0 ? null != m ? d.intl.format(y.reactionTooltip3NInteractive, {
    a: O[0],
    b: O[1],
    c: O[2],
    n: x,
