...
function g(e) {
  ...
  } = (0, s.ZP)(l.Z.GO_LIVE_MODAL_V2), j = (0, c.N)(), S = (0, a.Ng)(), b = (null == j || null == (t = j.subscription_trial) ? void 0 : t.sku_id) === m.Si.TIER_2 || (0, a.Wp)(S, m.Si.TIER_2), C = p.intl.string(h.default["+f+cqq"]);
  return b && (null != j ? C = (0, u.Rt)({
  ...
  }) : null != S && (C = p.intl.formatToPlainString(p.t.bkQ4bG, {
