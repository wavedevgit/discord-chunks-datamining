...
function g(e) {
  ...
  } = (0, s.ZP)(i.Z.GO_LIVE_MODAL_V2), j = (0, c.N)(), b = (0, a.Ng)(), S = (null == j || null == (t = j.subscription_trial) ? void 0 : t.sku_id) === m.Si.TIER_2 || (0, a.Wp)(b, m.Si.TIER_2), C = p.intl.string(h.default["+f+cqq"]);
  return S && (null != j ? C = (0, u.Rt)({
  ...
  }) : null != b && (C = p.intl.formatToPlainString(p.t.bkQ4bG, {
