...
let x = new Set,
  M = new Chunk626584.A("MessageStore"),
  j = false;
...
function z(e) {
  ...
  if (!a.ready) returnfalse;
  null != r.nonce && r.state !== D.cmJ.SENDING && x.has(r.nonce) && (a = a.remove(r.nonce), x.delete(r.nonce)), a = a.receiveMessage(r, true === A.A.isAtBottom(t)), u.A.commit(a)
}
...
function q(e) {
  ...
  let a = i.get(n, true);
  i = (null == a ? true : a.isPoll()) === true ? i.remove(n) : i.update(n, e => ((e = e.set("state", D.cmJ.SEND_FAILED)).isCommandType() ? e = (e = e.set("interactionError", null != r ? r : "")).set("flags", (0, o.UI)(e.flags, D.pr7.EPHEMERAL)) : null != r && (e = e.set("interactionError", null != r ? r : "")), e)), u.A.commit(i)
}
...
function eo(e) {
  ...
  if (null == s || !(0, E.vp)(e)) returnfalse;
...
function el(e) {
  ...
  s = s.update(i, e => {
    var n;
    return (null == (n = e.embeds) ? true : n.filter(_._).length) > 0 && (e = e.set("embeds", [])), "MESSAGE_SEND_FAILED_AUTOMOD" === t && (e = e.set("flags", (0, o.UI)(e.flags, D.pr7.EPHEMERAL))), e
  }), u.A.commit(s)
}
