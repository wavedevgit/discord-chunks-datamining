...
function y(e) {
  ...
  return <a.Modal onClose={p} actions={j} transitionState={b} title={d.intl.string(d.t["yJeV5+"])}>{<s.Text variant={"text-md/normal"}>{d.intl.format(d.t.fq3Sw8, {
      ...
      })}</s.Text>}{<div className={u.soundWheel}><l.Z width={372} height={316} guildId={t} channel={y} interactive={false} keepOpen={true} onClose={() => {}} analyticsSource={"education modal"} /></div>}</a.Modal>
}