...
function V(e) {
  ...
  return null != o && null != o.paymentSourceId && (a = o.paymentSourceId), Z(e, n, r, {
    paymentSourceId: a,
    currency: i
  })
}
...
function z(e, t, n) {
  ...
  for (let r of e) {
    let e;
    i = C.Z1.has(r.planId) ? l : !C.dJ.has(r.planId) && s, e = void 0 === n ? V(r.planId, i, !1, t) : Z(r.planId, i, !1, {
      paymentSourceId: n,
      currency: t
...
function J(e, t, n) {
  ...
  if (t || n) switch (e) {
    case C.rV.MONTH:
      let o = R.intl.formatToPlainString(a === C.p9.TIER_0 ? R.t.NPKsLy : R.t.poEovb, {
        timeInterval: R.intl.string(R.t.FPybU1)
      });
      return i ? o : R.intl.string(R.t.Mh9bTk);
    case C.rV.YEAR:
      let s = R.intl.formatToPlainString(a === C.p9.TIER_0 ? R.t.NPKsLy : R.t.poEovb, {
        timeInterval: R.intl.string(R.t.tfqrho)
      });
  ...
  switch (e) {
    case C.rV.MONTH:
      if (1 !== r) return R.intl.formatToPlainString(R.t["0UlZnJ"], {
        intervalCount: r
      });
...
function et(e) {
  ...
  switch (e) {
    case C.Xh.PREMIUM_MONTH_TIER_0:
      return t ? R.intl.format(R.t.TZXHNj, {
        duration: r
      }) : n ? R.intl.string(R.t["81iAgo"]) : R.intl.string(R.t["0efVPz"]);
    case C.Xh.PREMIUM_YEAR_TIER_0:
      return t ? R.intl.format(R.t.eqRhCw, {
        duration: r
      }) : n ? R.intl.string(R.t.UvzqY2) : R.intl.string(R.t.eoVuBg);
    ...
    case C.Xh.PREMIUM_MONTH_TIER_2:
      return t ? R.intl.format(R.t.aI6QX1, {
        duration: r
      }) : n ? R.intl.string(R.t.SmVbHR) : R.intl.string(R.t.FKYNCw);
    case C.Xh.PREMIUM_YEAR_TIER_2:
      return t ? R.intl.format(R.t["1wBcPj"], {
        duration: r
      }) : n ? R.intl.string(R.t.JIq4Oz) : R.intl.string(R.t["cfu/5e"]);
...
function es(e) {
  ...
  } = e, I = C.GP[h], S = tA(V(I.id), I.interval), T = ej(p) || null == p.paymentSourceId && !p.isPurchasedExternally && !(null == (t = _.default.getCurrentUser()) ? void 0 : t.hasFreePremium()), N = null != m && null == p.paymentGateway, P = p.status === A.O0b.UNPAID && null !== p.latestInvoice && (null == (n = p.latestInvoice) ? void 0 : n.status) === A.hUK.OPEN, w = T ? A.O0b.CANCELED : P ? A.O0b.UNPAID : p.status, D = null == (a = null != (i = null == O ? void 0 : O.taxInclusive) ? i : null == (r = p.latestInvoice) ? void 0 : r.taxInclusive) || a, L = C.cb + (g ? em(p.additionalPlans) : 0), x = N ? D ? R.intl.format(R.t["cd+hqK"], {
    price: m
  }) : R.intl.format(R.t.NUkcpK, {
    price: m
  }) : R.intl.string(R.t.zYx3Y2), k = N ? D ? R.intl.format(R.t.VsKcFB, {
    price: m
  }) : R.intl.format(R.t.hJ5xER, {
    price: m
  }) : R.intl.string(R.t["8rSipK"]), M = N ? D ? R.intl.format(R.t["jRy6/P"], {
    price: m,
    num: L
  }) : R.intl.format(R.t.tTNE8P, {
    price: m,
    num: L
  }) : R.intl.format(R.t["U+z/HB"], {
    num: L
  });
  switch (h) {
    case C.Xh.PREMIUM_MONTH_TIER_0:
    case C.Xh.PREMIUM_YEAR_TIER_0:
      switch (w) {
        case A.O0b.CANCELED:
          return N ? D ? R.intl.format(R.t["USi/nZ"], {
            price: m
          }) : R.intl.format(R.t["FS//l5"], {
            price: m
          }) : R.intl.string(R.t.JshLzs);
        case A.O0b.ACCOUNT_HOLD:
          return N ? D ? R.intl.format(R.t["5mv+2t"], {
            price: m
          }) : R.intl.format(R.t.nkAEfX, {
            price: m
          }) : R.intl.format(R.t.SsLIXV, {});
        case A.O0b.UNPAID:
        ...
        case A.O0b.PAUSE_PENDING:
          ...
          return null != j ? R.intl.format(R.t.WUfODw, {
            pauseDate: p.currentPeriodEnd,
            pauseDuration: j
          }) : R.intl.format(R.t.VlWufn, {
            pauseDate: p.currentPeriodEnd
          });
        case A.O0b.PAUSED:
          if (v) return x;
          return R.intl.format(R.t["6RTdZG"], {
    ...
    case C.Xh.PREMIUM_YEAR_TIER_1:
      switch (w) {
        case A.O0b.CANCELED:
          return N ? D ? R.intl.format(R.t.cXy8Bg, {
            price: m
          }) : R.intl.format(R.t["C/XsHh"], {
            price: m
          }) : R.intl.string(R.t.K6tYFR);
        case A.O0b.ACCOUNT_HOLD:
          return N ? D ? R.intl.format(R.t.HBkIBg, {
            price: m
          }) : R.intl.format(R.t.ZsO1S0, {
            price: m
          }) : R.intl.format(R.t["0+/WHx"], {});
        case A.O0b.UNPAID:
          return R.intl.format(R.t.McIzws, {});
        case A.O0b.PAUSE_PENDING:
          let U = null != p.pauseEndsAt ? o()(p.pauseEndsAt).diff(p.currentPeriodEnd, "days") : null;
          return null != U ? R.intl.format(R.t.WUfODw, {
            pauseDate: p.currentPeriodEnd,
            pauseDuration: U
          }) : R.intl.format(R.t.VlWufn, {
            pauseDate: p.currentPeriodEnd
    ...
    case C.Xh.PREMIUM_6_MONTH_TIER_2:
      switch (w) {
        case A.O0b.CANCELED:
          return N ? D ? R.intl.format(R.t.xoFgRk, {
            price: m,
            num: L
          }) : R.intl.format(R.t.nXdbKi, {
            price: m,
            num: L
          }) : R.intl.format(R.t.EcSdRE, {
            num: L
          });
        case A.O0b.ACCOUNT_HOLD:
          return N ? D ? R.intl.format(R.t["5C/0QE"], {
            price: m,
            num: L
          }) : R.intl.format(R.t.xfYkho, {
            price: m,
            num: L
          }) : R.intl.format(R.t.ivjxcn, {
            num: L
          });
        case A.O0b.UNPAID:
          return R.intl.format(R.t["0HopYW"], {
            num: L
          });
        case A.O0b.PAUSE_PENDING:
          let G = null != p.pauseEndsAt ? o()(p.pauseEndsAt).diff(p.currentPeriodEnd, "days") : null;
          return null != G ? R.intl.format(R.t.WUfODw, {
            pauseDate: p.currentPeriodEnd,
            pauseDuration: G
          }) : R.intl.format(R.t.VlWufn, {
            pauseDate: p.currentPeriodEnd
        ...
        case A.O0b.BILLING_RETRY:
          return R.intl.format(R.t["IlJ/HR"], {
            endDate: o()(p.currentPeriodStart).add(C.A5, "days").toDate()
          });
        case A.O0b.PAST_DUE:
          return R.intl.format(R.t["d+0vws"], {
            endDate: (0, b.vc)(ev(p).expiresDate, "LL"),
        ...
        default:
          return E ? h === C.Xh.PREMIUM_YEAR_TIER_2 ? R.intl.format(R.t["+qqh6u"], {
            percent: null != (l = null == y ? void 0 : y.percentage) ? l : C.Bo,
            regularPrice: S
          }) : D ? R.intl.formatToPlainString(R.t["3Ziutb"], {
...
function ec(e) {
  let {
    planId: t,
    additionalPlans: n
  } = e, r = (0, f.Q0)(t) ? null : et(t), i = null == n ? void 0 : n.find(e => {
    let {
      planId: t
    } = e;
    return C.Z1.has(t)
  }), a = (null == i ? void 0 : i.planId) === C.Xh.PREMIUM_MONTH_GUILD || (null == i ? void 0 : i.planId) === C.Xh.PREMIUM_YEAR_GUILD ? R.t.Pi5yMD : null, o = null != a ? R.intl.formatToPlainString(a, {
    num: null == i ? void 0 : i.quantity
  }) : void 0;
  if (null != r && null != o) return R.intl.formatToPlainString(R.t.FN5T9v, {
...
function eI(e, t) {
  let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
    ...
    i = n ? (0, T.T4)(t.invoiceItems.filter(e => C.UD.has(e.subscriptionPlanId)).map(e => e.amount).reduce((e, t) => t + e, 0), t.currency) : (0, T.T4)(t.total, t.currency);
  if (null != e.trialId && C.h8.includes(e.trialId) && null == e.paymentSourceId) return R.intl.format(R.t["7ZS2m5"], {
    trialEnd: e.currentPeriodEnd
  });
  if (e.status === A.O0b.CANCELED) return R.intl.format(R.t["Whp/qq"], {
    endDate: t.subscriptionPeriodStart
  });
  if (e.status === A.O0b.PAUSE_PENDING) return R.intl.format(R.t.uBLUGR, {
    pauseDate: e.currentPeriodEnd,
    resumeDate: e.pauseEndsAt
  });
  if (e.status === A.O0b.PAUSED) return r.fractionalState !== C.a$.NONE ? R.intl.format(R.t.Q18lRE, {
    renewalDate: r.endsAt.toDate(),
    price: i
  }) : null == e.pauseEndsAt ? n ? R.intl.format(R.t.KTYQCg, {
    planName: R.intl.string(R.t.Ipxkoq),
    price: i
  }) : R.intl.string(R.t.fMz6Li) : n ? R.intl.format(R.t.zcgtzc, {
    planName: R.intl.string(R.t.Ipxkoq),
    resumeDate: e.pauseEndsAt,
    price: i
  }) : R.intl.format(R.t["V8+l6u"], {
    resumeDate: e.pauseEndsAt
  });
  if (e.status === A.O0b.PAST_DUE) {
    var a, s;
    let t = ev(e).expiresDate;
    return (e.isPurchasedViaGoogle && (null == (a = e.metadata) ? void 0 : a.google_grace_period_expires_date) != null && (t = o()(e.metadata.google_grace_period_expires_date)), e.isPurchasedViaApple && (null == (s = e.metadata) ? void 0 : s.apple_grace_period_expires_date) != null && (t = o()(e.metadata.apple_grace_period_expires_date)), e.isPurchasedExternally) ? R.intl.format(R.t.U2hb3d, {
      endDate: t.toDate(),
    ...
    if (e.status === A.O0b.BILLING_RETRY) return R.intl.format(R.t.EMTLOT, {
      endDate: o()(e.currentPeriodStart).add(C.A5, "days").toDate(),
      price: i
    });
    if (e.status === A.O0b.ACCOUNT_HOLD) return e.isPurchasedViaGoogle && !(0, v.isAndroid)() ? R.intl.format(R.t.dtcxw8, {
    ...
    if (eC(e)) return R.intl.format(R.t.awpB0N, {
      prepaidEndDate: e.currentPeriodEnd
    });
    if (e.status === A.O0b.UNPAID) return R.intl.format(R.t.CzTKoq, {
      maxProcessingTimeInDays: C.Rg
    });
    if (e.isPurchasedExternally) return R.intl.format(R.t.ZlWXgY, {
      renewalDate: t.subscriptionPeriodStart,
      paymentGatewayName: P.Vz[e.paymentGateway],
      subscriptionManagementLink: ez(e.paymentGateway, "SUBSCRIPTION_MANAGEMENT")
    });
    let a = new Date(t.subscriptionPeriodStart);
    return e.isBoostOnly || (a = eS(a, r.unactivatedUnits)), n ? R.intl.format(R.t.Vl3cEB, {
      planName: R.intl.string(R.t.Ipxkoq),
      renewalDate: a,
      price: i
...
function eD(e) {
  ...
  if (ew(a)) return a.isPurchasedViaGoogle ? R.intl.format(R.t["3/WTrK"], {
    quantity: _
  }) : h ? R.intl.format(R.t["0ozBSE"], {
    quantity: _,
  ...
  switch (a.status) {
    case A.O0b.ACCOUNT_HOLD:
      return a.isPurchasedViaGoogle ? R.intl.format(R.t.Nlf3nZ, {
        quantity: _,
        boostQuantity: _
      }) : h ? R.intl.format(R.t.oiRy7u, {
        quantity: _,
        boostQuantity: _,
        rate: (0, T.og)(s, f.interval, f.intervalCount)
    ...
    case A.O0b.PAUSED:
      ...
      return R.intl.format(R.t["5iud9v"], {
        quantity: _
      });
    default:
      return a.isPurchasedViaGoogle ? R.intl.format(R.t["5iud9v"], {
        quantity: _
      }) : h ? R.intl.format(R.t.eDwrLC, {
        quantity: _,
        rate: (0, T.og)(s, f.interval, f.intervalCount)
...
function eV(e, t, n) {
  ...
  switch (r) {
    ...
    case C.Xh.PREMIUM_3_MONTH_TIER_2:
    case C.Xh.PREMIUM_6_MONTH_TIER_2:
      return R.intl.formatToPlainString(R.t.BCD4fX, {
        intervalCount: t.intervalCount
      });
...
function eH(e) {
  let {
    intervalType: t = C.rV.MONTH,
    intervalCount: n = 1,
    capitalize: r = !1
  } = e;
  switch (t) {
    case C.rV.DAY:
      if (n >= 7 && n % 7 == 0) return r ? R.intl.formatToPlainString(R.t.fRNBRU, {
        weeks: n / 7
      }) : R.intl.formatToPlainString(R.t.EIpHEh, {
        weeks: n / 7
      });
      return r ? R.intl.formatToPlainString(R.t["6Cdzo6"], {
        days: n
      }) : R.intl.formatToPlainString(R.t["kbBj/v"], {
        days: n
      });
    case C.rV.MONTH:
      return r ? R.intl.formatToPlainString(R.t.x5Mgxc, {
        months: n
      }) : R.intl.formatToPlainString(R.t["4SEnCQ"], {
        months: n
      });
    case C.rV.YEAR:
      return r ? R.intl.formatToPlainString(R.t["h+63ys"], {
        years: n
      }) : R.intl.formatToPlainString(R.t["9DFiHh"], {
        years: n
      });
    default:
...
function eY(e) {
  ...
  switch (t) {
    case C.rV.DAY:
      if (n >= 7 && n % 7 == 0) return R.intl.formatToPlainString(R.t["8awlzM"], {
        weeks: n / 7
      });
      return R.intl.formatToPlainString(R.t.ZsgnLC, {
        days: n
      });
    case C.rV.MONTH:
      return R.intl.formatToPlainString(R.t.Y0HCVV, {
        months: n
      });
    case C.rV.YEAR:
      return R.intl.formatToPlainString(R.t.ns1zkZ, {
        years: n
      });
    default:
      throw Error("Unsupported interval duration.")
...
function eK(e) {
  ...
  switch (t) {
    case C.rV.DAY:
      if (n >= 7 && n % 7 == 0) return r ? R.intl.formatToPlainString(R.t.iVZYys, {
        weeks: n / 7
      }) : R.intl.formatToPlainString(R.t.EmoBDw, {
        weeks: n / 7
      });
      return r ? R.intl.formatToPlainString(R.t.jzH70d, {
        days: n
      }) : R.intl.formatToPlainString(R.t.k2UNz8, {
        days: n
      });
    case C.rV.MONTH:
      return r ? R.intl.formatToPlainString(R.t.erUSmJ, {
        months: n
      }) : R.intl.formatToPlainString(R.t.kridzM, {
        months: n
      });
    case C.rV.YEAR:
      return r ? R.intl.formatToPlainString(R.t.IfYQVF, {
        years: n
      }) : R.intl.formatToPlainString(R.t.PClsr6, {
        years: n
      });
    default:
      throw Error("Unsupported interval duration.")
...
function eJ(e, t, n, r) {
  ...
  let s = !1,
    l = (null != (o = null == (a = e.renewalMutations) ? void 0 : a.items) ? o : e.items).map(e => r.has(e.planId) ? (s = !0, x(D({}, e), {
      quantity: n,
      planId: t
    })) : e);
  if (!s) {
...
function e1(e) {
  ...
  if (null != n) {
    ...
    i()(null != t, "Missing plan"), e = e.map(e => {
      ...
      return i()(null != a, "Missing planForInterval"), x(D({}, e), {
        planId: a.id
      })
    })
  }
