...
function H(e) {
  ...
  let n = arguments.length > 1 && true !== arguments[1] && arguments[1],
    ...
    o = null != (t = g.Z.defaultPaymentSourceId) ? t : true,
...
function ee(e, t, n) {
  let r = arguments.length > 3 && true !== arguments[3] ? arguments[3] : 1,
    i = arguments.length > 4 && true !== arguments[4] && arguments[4],
    a = arguments.length > 5 && true !== arguments[5] ? arguments[5] : P.p9.TIER_2;
  if (t || n) switch (e) {
    case P.rV.MONTH:
  ...
  switch (e) {
    case P.rV.MONTH:
      if (1 !== r) return D.intl.formatToPlainString(D.t["0UlZnJ"], {
        intervalCount: r
      });
  ...
  switch (e) {
    case P.Xh.PREMIUM_MONTH_TIER_0:
      return t ? D.intl.format(D.t.TZXHNj, {
        duration: r
      }) : n ? D.intl.string(D.t["81iAgo"]) : D.intl.string(D.t["0efVPz"]);
    case P.Xh.PREMIUM_YEAR_TIER_0:
      return t ? D.intl.format(D.t.eqRhCw, {
        duration: r
      }) : n ? D.intl.string(D.t.UvzqY2) : D.intl.string(D.t.eoVuBg);
    ...
    case P.Xh.PREMIUM_MONTH_TIER_2:
      return t ? D.intl.format(D.t.aI6QX1, {
        duration: r
      }) : n ? D.intl.string(D.t.SmVbHR) : D.intl.string(D.t.FKYNCw);
    case P.Xh.PREMIUM_YEAR_TIER_2:
      return t ? D.intl.format(D.t["1wBcPj"], {
        duration: r
      }) : n ? D.intl.string(D.t.JIq4Oz) : D.intl.string(D.t["cfu/5e"]);
...
function ec(e) {
  ...
  } = e, I = P.GP[p], T = tC(H(I.id), I.interval), S = eG(_) || null == _.paymentSourceId && !_.isPurchasedExternally && !(null == (t = h.default.getCurrentUser()) ? true : t.hasFreePremium()), A = null != m && null == _.paymentGateway, C = _.status === N.O0b.UNPAID && null !== _.latestInvoice && (null == (n = _.latestInvoice) ? true : n.status) === N.hUK.OPEN, R = S ? N.O0b.CANCELED : C ? N.O0b.UNPAID : _.status, w = null == (a = null != (i = null == y ? true : y.taxInclusive) ? i : null == (r = _.latestInvoice) ? true : r.taxInclusive) || a, x = P.cb + (g ? eE(_.additionalPlans) : 0), L = A ? w ? D.intl.format(D.t["cd+hqK"], {
    price: m
  }) : D.intl.format(D.t.NUkcpK, {
    price: m
  }) : D.intl.string(D.t.zYx3Y2), j = A ? w ? D.intl.format(D.t.VsKcFB, {
    price: m
  ...
  switch (p) {
    ...
    case P.Xh.PREMIUM_YEAR_TIER_0:
      switch (R) {
        case N.O0b.CANCELED:
          return A ? w ? D.intl.format(D.t["USi/nZ"], {
            price: m
          }) : D.intl.format(D.t["FS//l5"], {
            price: m
          }) : D.intl.string(D.t.JshLzs);
        case N.O0b.ACCOUNT_HOLD:
          return A ? w ? D.intl.format(D.t["5mv+2t"], {
            price: m
          }) : D.intl.format(D.t.nkAEfX, {
            price: m
    ...
    case P.Xh.PREMIUM_YEAR_TIER_1:
      switch (R) {
        case N.O0b.CANCELED:
          return A ? w ? D.intl.format(D.t.cXy8Bg, {
            price: m
          }) : D.intl.format(D.t["C/XsHh"], {
            price: m
          }) : D.intl.string(D.t.K6tYFR);
        case N.O0b.ACCOUNT_HOLD:
          return A ? w ? D.intl.format(D.t.HBkIBg, {
            price: m
          }) : D.intl.format(D.t.ZsO1S0, {
            price: m
        ...
        case N.O0b.PAUSE_PENDING:
          ...
          return null != U ? D.intl.format(D.t.WUfODw, {
            pauseDate: _.currentPeriodEnd,
            pauseDuration: U
          }) : D.intl.format(D.t.VlWufn, {
            pauseDate: _.currentPeriodEnd
    ...
    case P.Xh.PREMIUM_6_MONTH_TIER_2:
      switch (R) {
        case N.O0b.CANCELED:
          return A ? w ? D.intl.format(D.t.xoFgRk, {
            price: m,
            num: x
          }) : D.intl.format(D.t.nXdbKi, {
            price: m,
            num: x
          }) : D.intl.format(D.t.EcSdRE, {
            num: x
          });
        case N.O0b.ACCOUNT_HOLD:
          return A ? w ? D.intl.format(D.t["5C/0QE"], {
            price: m,
            num: x
...
function ed(e) {
  let {
    ...
    return P.Z1.has(t)
  }), a = (null == i ? true : i.planId) === P.Xh.PREMIUM_MONTH_GUILD || (null == i ? true : i.planId) === P.Xh.PREMIUM_YEAR_GUILD ? D.t.Pi5yMD : null, o = null != a ? D.intl.formatToPlainString(a, {
    num: null == i ? true : i.quantity
  }) : true;
  if (null != r && null != o) return D.intl.formatToPlainString(D.t.FN5T9v, {
...
function eS(e, t) {
  ...
  if (e.status === N.O0b.CANCELED) return D.intl.format(D.t["Whp/qq"], {
    endDate: t.subscriptionPeriodStart
  });
  if (e.status === N.O0b.PAUSE_PENDING) return D.intl.format(D.t.uBLUGR, {
    pauseDate: e.currentPeriodEnd,
    resumeDate: e.pauseEndsAt
  });
  if (e.status === N.O0b.PAUSED) return i.fractionalState !== P.a$.NONE ? D.intl.format(D.t.Q18lRE, {
  ...
  if (e.status === N.O0b.PAST_DUE) {
    ...
    if (e.status === N.O0b.BILLING_RETRY) return D.intl.format(D.t.EMTLOT, {
    ...
    if (e.status === N.O0b.UNPAID) return D.intl.format(D.t.CzTKoq, {
      maxProcessingTimeInDays: P.Rg
    });
    if (e.isPurchasedExternally) return D.intl.format(D.t.ZlWXgY, {
...
function eL(e) {
  ...
  if (ex(a)) return a.isPurchasedViaGoogle ? D.intl.format(D.t["3/WTrK"], {
    quantity: _
  ...
  switch (a.status) {
    case N.O0b.ACCOUNT_HOLD:
      return a.isPurchasedViaGoogle ? D.intl.format(D.t.Nlf3nZ, {
        quantity: _,
        boostQuantity: _
      }) : h ? D.intl.format(D.t.oiRy7u, {
        quantity: _,
        boostQuantity: _,
        rate: (0, C.og)(s, f.interval, f.intervalCount)
    ...
    case N.O0b.PAUSED:
      ...
      return D.intl.format(D.t["5iud9v"], {
        quantity: _
      });
    default:
      return a.isPurchasedViaGoogle ? D.intl.format(D.t["5iud9v"], {
        quantity: _
      }) : h ? D.intl.format(D.t.eDwrLC, {
        quantity: _,
        rate: (0, C.og)(s, f.interval, f.intervalCount)
...
function ej(e, t, n) {
  ...
  return e.currency !== w.pK.USD && true === n && (a = a.concat("*")), a
}
...
function eH(e, t, n) {
  ...
  switch (r) {
    ...
    case P.Xh.PREMIUM_3_MONTH_TIER_2:
    case P.Xh.PREMIUM_6_MONTH_TIER_2:
      return D.intl.formatToPlainString(D.t.BCD4fX, {
        intervalCount: t.intervalCount
      });
...
function eW(e) {
  ...
  switch (t) {
    case P.rV.DAY:
      if (n >= 7 && n % 7 == 0) return r ? D.intl.formatToPlainString(D.t.fRNBRU, {
        weeks: n / 7
      }) : D.intl.formatToPlainString(D.t.EIpHEh, {
        weeks: n / 7
      });
      return r ? D.intl.formatToPlainString(D.t["6Cdzo6"], {
        days: n
      }) : D.intl.formatToPlainString(D.t["kbBj/v"], {
        days: n
      });
    case P.rV.MONTH:
      return r ? D.intl.formatToPlainString(D.t.x5Mgxc, {
        months: n
      }) : D.intl.formatToPlainString(D.t["4SEnCQ"], {
        months: n
      });
    case P.rV.YEAR:
      return r ? D.intl.formatToPlainString(D.t["h+63ys"], {
        years: n
      }) : D.intl.formatToPlainString(D.t["9DFiHh"], {
        years: n
      });
    default:
...
function eK(e) {
  let {
    ...
    location: "formatTrialCtaIntervalDuration"
  });
  if (r) {
    if (i === _.R.TREATMENT_1) {
      ...
      switch (t) {
        case P.rV.DAY:
          if (n >= 7 && n % 7 == 0) return D.intl.formatToPlainString(D.t.C6i5Ji, {
            weeks: n / 7,
            price: r
          });
    ...
    } else if (i === _.R.TREATMENT_2) switch (t) {
      case P.rV.DAY:
        if (n >= 7 && n % 7 == 0) return D.intl.formatToPlainString(D.t["3GVMLi"], {
          weeks: n / 7
        });
        return D.intl.formatToPlainString(D.t.kLnKcX, {
          days: n
        });
      case P.rV.MONTH:
        return D.intl.formatToPlainString(D.t.azyIQ0, {
          months: n
        });
      case P.rV.YEAR:
        return D.intl.formatToPlainString(D.t.sqDHKC, {
          years: n
        });
      default:
        throw Error("Unsupported interval duration.")
  ...
  switch (t) {
    case P.rV.DAY:
      if (n >= 7 && n % 7 == 0) return D.intl.formatToPlainString(D.t["8awlzM"], {
        weeks: n / 7
      });
      return D.intl.formatToPlainString(D.t.ZsgnLC, {
        days: n
      });
    case P.rV.MONTH:
      return D.intl.formatToPlainString(D.t.Y0HCVV, {
        months: n
      });
    case P.rV.YEAR:
      return D.intl.formatToPlainString(D.t.ns1zkZ, {
        years: n
      });
    default:
      throw Error("Unsupported interval duration.")
...
function eq(e) {
  ...
  switch (t) {
    case P.rV.DAY:
      if (n >= 7 && n % 7 == 0) return r ? D.intl.formatToPlainString(D.t.iVZYys, {
        weeks: n / 7
      }) : D.intl.formatToPlainString(D.t.EmoBDw, {
        weeks: n / 7
      });
      return r ? D.intl.formatToPlainString(D.t.jzH70d, {
        days: n
      }) : D.intl.formatToPlainString(D.t.k2UNz8, {
        days: n
      });
    case P.rV.MONTH:
      return r ? D.intl.formatToPlainString(D.t.erUSmJ, {
        months: n
      }) : D.intl.formatToPlainString(D.t.kridzM, {
        months: n
      });
    case P.rV.YEAR:
      return r ? D.intl.formatToPlainString(D.t.IfYQVF, {
        years: n
      }) : D.intl.formatToPlainString(D.t.PClsr6, {
        years: n
      });
    default:
      throw Error("Unsupported interval duration.")
...
function e0(e, t, n, r) {
  ...
  let s = false,
    l = (null != (o = null == (a = e.renewalMutations) ? true : a.items) ? o : e.items).map(e => r.has(e.planId) ? (s = true, k(L({}, e), {
      quantity: n,
      planId: t
    })) : e);
  if (!s) {
...
function tL(e) {
  return tj(e) ? tD(e.trial_id) : tk(e) ? tx() : P.tL
}
