...
function V(e) {
  ...
  return null != a && null != a.paymentSourceId && (i = a.paymentSourceId), F(e, n, r, {
    paymentSourceId: i
  })
}
...
function z(e, t, n) {
  ...
  if (t || n) switch (e) {
    case N.rV.MONTH:
      let o = R.intl.formatToPlainString(a === N.p9.TIER_0 ? R.t.NPKsLy : R.t.poEovb, {
        timeInterval: R.intl.string(R.t.FPybU1)
      });
      return i ? o : R.intl.string(R.t.Mh9bTk);
    case N.rV.YEAR:
      let s = R.intl.formatToPlainString(a === N.p9.TIER_0 ? R.t.NPKsLy : R.t.poEovb, {
...
function er(e) {
  ...
  let {
    ...
    hasDiscountApplied: b,
    activeDiscountInfo: y,
    renewalInvoicePreview: O,
    hasFractionalPremiumWithSub: v
  } = e, I = N.GP[h], S = tv(V(I.id), I.interval), A = eL(p) || null == p.paymentSourceId && !p.isPurchasedExternally && !(null == (t = f.default.getCurrentUser()) ? void 0 : t.hasFreePremium()), C = null != m && null == p.paymentGateway, P = p.status === T.O0b.UNPAID && null !== p.latestInvoice && (null == (n = p.latestInvoice) ? void 0 : n.status) === T.hUK.OPEN, w = A ? T.O0b.CANCELED : P ? T.O0b.UNPAID : p.status, D = null == (a = null != (i = null == O ? void 0 : O.taxInclusive) ? i : null == (r = p.latestInvoice) ? void 0 : r.taxInclusive) || a, L = N.cb + (g ? ef(p.additionalPlans) : 0), x = C ? D ? R.intl.format(R.t["cd+hqK"], {
    price: m
  }) : R.intl.format(R.t.NUkcpK, {
    price: m
  }) : R.intl.string(R.t.zYx3Y2), M = C ? D ? R.intl.format(R.t.VsKcFB, {
    price: m
  }) : R.intl.format(R.t.hJ5xER, {
    price: m
  }) : R.intl.string(R.t["8rSipK"]), k = C ? D ? R.intl.format(R.t["jRy6/P"], {
    price: m,
    num: L
  ...
  switch (h) {
    ...
    case N.Xh.PREMIUM_YEAR_TIER_0:
      switch (w) {
        case T.O0b.CANCELED:
          return C ? D ? R.intl.format(R.t["USi/nZ"], {
            price: m
          }) : R.intl.format(R.t["FS//l5"], {
            price: m
          }) : R.intl.string(R.t.JshLzs);
        case T.O0b.ACCOUNT_HOLD:
          return C ? D ? R.intl.format(R.t["5mv+2t"], {
            price: m
    ...
    case N.Xh.PREMIUM_YEAR_TIER_1:
      switch (w) {
        case T.O0b.CANCELED:
          return C ? D ? R.intl.format(R.t.cXy8Bg, {
            price: m
          }) : R.intl.format(R.t["C/XsHh"], {
            price: m
          }) : R.intl.string(R.t.K6tYFR);
        case T.O0b.ACCOUNT_HOLD:
          return C ? D ? R.intl.format(R.t.HBkIBg, {
            price: m
    ...
    case N.Xh.PREMIUM_6_MONTH_TIER_2:
      switch (w) {
        case T.O0b.CANCELED:
          return C ? D ? R.intl.format(R.t.xoFgRk, {
            price: m,
            num: L
        ...
        case T.O0b.ACCOUNT_HOLD:
          return C ? D ? R.intl.format(R.t["5C/0QE"], {
            price: m,
            num: L
        ...
        case T.O0b.BILLING_RETRY:
          return R.intl.format(R.t["IlJ/HR"], {
            endDate: o()(p.currentPeriodStart).add(N.A5, "days").toDate()
          });
        case T.O0b.PAST_DUE:
          return R.intl.format(R.t["d+0vws"], {
            endDate: (0, E.vc)(eE(p).expiresDate, "LL"),
        ...
        default:
          return b ? h === N.Xh.PREMIUM_YEAR_TIER_2 ? R.intl.format(R.t["+qqh6u"], {
...
function ea(e) {
  let {
    ...
    return N.Z1.has(t)
  }), a = (null == i ? void 0 : i.planId) === N.Xh.PREMIUM_MONTH_GUILD || (null == i ? void 0 : i.planId) === N.Xh.PREMIUM_YEAR_GUILD ? R.t.Pi5yMD : null, o = null != a ? R.intl.formatToPlainString(a, {
...
function eb(e, t) {
  let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
    ...
    i = n ? (0, S.T4)(t.invoiceItems.filter(e => N.UD.has(e.subscriptionPlanId)).map(e => e.amount).reduce((e, t) => t + e, 0), t.currency) : (0, S.T4)(t.total, t.currency);
  if (null != e.trialId && N.h8.includes(e.trialId) && null == e.paymentSourceId) return R.intl.format(R.t["7ZS2m5"], {
    trialEnd: e.currentPeriodEnd
  });
  if (e.status === T.O0b.CANCELED) return R.intl.format(R.t["Whp/qq"], {
    endDate: t.subscriptionPeriodStart
  });
  if (e.status === T.O0b.PAUSE_PENDING) return R.intl.format(R.t.uBLUGR, {
    pauseDate: e.currentPeriodEnd,
    resumeDate: e.pauseEndsAt
  });
  if (e.status === T.O0b.PAUSED) return r.fractionalState !== N.a$.NONE ? R.intl.format(R.t.Q18lRE, {
  ...
  if (e.status === T.O0b.PAST_DUE) {
    ...
    if (e.status === T.O0b.BILLING_RETRY) return R.intl.format(R.t.EMTLOT, {
      endDate: o()(e.currentPeriodStart).add(N.A5, "days").toDate(),
      price: i
    });
    if (e.status === T.O0b.ACCOUNT_HOLD) return e.isPurchasedViaGoogle && !(0, O.isAndroid)() ? R.intl.format(R.t.dtcxw8, {
    ...
    if (eS(e)) return R.intl.format(R.t.awpB0N, {
      prepaidEndDate: e.currentPeriodEnd
    });
    if (e.status === T.O0b.UNPAID) return R.intl.format(R.t.CzTKoq, {
      maxProcessingTimeInDays: N.Rg
    });
    ...
    return e.isBoostOnly || (a = ey(a, r.unactivatedUnits)), n ? R.intl.format(R.t.Vl3cEB, {
      planName: R.intl.string(R.t.Ipxkoq),
      renewalDate: a,
      price: i
...
function eC(e) {
  ...
  if (eN(a)) return a.isPurchasedViaGoogle ? R.intl.format(R.t["3/WTrK"], {
    quantity: _
  }) : m ? R.intl.format(R.t["0ozBSE"], {
    quantity: _,
...
function eW(e, t) {
  ...
  return null != a && i.push(a), i.push(...t), i.map(t => {
    for (let n of e.items)
      if (t.planId === n.planId) return w({}, n, t);
    return t
  })
}
...
function ez(e, t, n, r) {
  ...
  let s = !1,
    l = (null != (o = null == (a = e.renewalMutations) ? void 0 : a.items) ? o : e.items).map(e => r.has(e.planId) ? (s = !0, L(w({}, e), {
      quantity: n,
      planId: t
    })) : e);
  if (!s) {
...
function eX(e) {
  ...
  if (null != n) {
    ...
    i()(null != t, "Missing plan"), e = e.map(e => {
      ...
      return i()(null != a, "Missing planForInterval"), L(w({}, e), {
        planId: a.id
      })
    })
  }
