...
function $(e, t, n) {
  ...
  for (let r of e) {
    let e;
    i = R.Z1.has(r.planId) ? l : !R.dJ.has(r.planId) && s, e = void 0 === n ? H(r.planId, i, !1, t) : Y(r.planId, i, !1, {
      paymentSourceId: n,
      currency: t
...
function ee(e, t, n) {
  ...
  if (t || n) switch (e) {
    case R.rV.MONTH:
      let o = D.intl.formatToPlainString(a === R.p9.TIER_0 ? D.t.NPKsLy : D.t.poEovb, {
        timeInterval: D.intl.string(D.t.FPybU1)
      });
      return i ? o : D.intl.string(D.t.Mh9bTk);
    case R.rV.YEAR:
      let s = D.intl.formatToPlainString(a === R.p9.TIER_0 ? D.t.NPKsLy : D.t.poEovb, {
...
function ec(e) {
  ...
  } = e, I = R.GP[p], T = tw(H(I.id), I.interval), S = eG(_) || null == _.paymentSourceId && !_.isPurchasedExternally && !(null == (t = h.default.getCurrentUser()) ? void 0 : t.hasFreePremium()), A = null != m && null == _.paymentGateway, N = _.status === C.O0b.UNPAID && null !== _.latestInvoice && (null == (n = _.latestInvoice) ? void 0 : n.status) === C.hUK.OPEN, w = S ? C.O0b.CANCELED : N ? C.O0b.UNPAID : _.status, P = null == (a = null != (i = null == y ? void 0 : y.taxInclusive) ? i : null == (r = _.latestInvoice) ? void 0 : r.taxInclusive) || a, L = R.cb + (g ? eE(_.additionalPlans) : 0), x = A ? P ? D.intl.format(D.t["cd+hqK"], {
    price: m
  }) : D.intl.format(D.t.NUkcpK, {
    price: m
  }) : D.intl.string(D.t.zYx3Y2), k = A ? P ? D.intl.format(D.t.VsKcFB, {
    price: m
  }) : D.intl.format(D.t.hJ5xER, {
    price: m
  }) : D.intl.string(D.t["8rSipK"]), j = A ? P ? D.intl.format(D.t["jRy6/P"], {
    price: m,
    num: L
  ...
  switch (p) {
    ...
    case R.Xh.PREMIUM_YEAR_TIER_0:
      switch (w) {
        case C.O0b.CANCELED:
          return A ? P ? D.intl.format(D.t["USi/nZ"], {
            price: m
          }) : D.intl.format(D.t["FS//l5"], {
            price: m
          }) : D.intl.string(D.t.JshLzs);
        case C.O0b.ACCOUNT_HOLD:
          return A ? P ? D.intl.format(D.t["5mv+2t"], {
            price: m
    ...
    case R.Xh.PREMIUM_YEAR_TIER_1:
      switch (w) {
        case C.O0b.CANCELED:
          return A ? P ? D.intl.format(D.t.cXy8Bg, {
            price: m
          }) : D.intl.format(D.t["C/XsHh"], {
            price: m
          }) : D.intl.string(D.t.K6tYFR);
        case C.O0b.ACCOUNT_HOLD:
          return A ? P ? D.intl.format(D.t.HBkIBg, {
            price: m
    ...
    case R.Xh.PREMIUM_6_MONTH_TIER_2:
      switch (w) {
        case C.O0b.CANCELED:
          return A ? P ? D.intl.format(D.t.xoFgRk, {
            price: m,
            num: L
        ...
        case C.O0b.ACCOUNT_HOLD:
          return A ? P ? D.intl.format(D.t["5C/0QE"], {
            price: m,
            num: L
        ...
        default:
          return E ? p === R.Xh.PREMIUM_YEAR_TIER_2 ? D.intl.format(D.t["+qqh6u"], {
            percent: null != (s = null == b ? void 0 : b.percentage) ? s : R.Bo,
            regularPrice: T
          }) : P ? D.intl.formatToPlainString(D.t["3Ziutb"], {
...
function ed(e) {
  let {
    ...
    return R.Z1.has(t)
  }), a = (null == i ? void 0 : i.planId) === R.Xh.PREMIUM_MONTH_GUILD || (null == i ? void 0 : i.planId) === R.Xh.PREMIUM_YEAR_GUILD ? D.t.Pi5yMD : null, o = null != a ? D.intl.formatToPlainString(a, {
...
function eS(e, t) {
  let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
    ...
    s = r ? (0, N.T4)(a.invoiceItems.filter(e => R.UD.has(e.subscriptionPlanId)).map(e => e.amount).reduce((e, t) => t + e, 0), a.currency) : (0, N.T4)(a.total, a.currency);
  if (null != e.trialId && R.h8.includes(e.trialId) && null == e.paymentSourceId) return D.intl.format(D.t["7ZS2m5"], {
    trialEnd: e.currentPeriodEnd
  });
  if (e.status === C.O0b.CANCELED) return D.intl.format(D.t["Whp/qq"], {
    endDate: t.subscriptionPeriodStart
  });
  if (e.status === C.O0b.PAUSE_PENDING) return D.intl.format(D.t.uBLUGR, {
    pauseDate: e.currentPeriodEnd,
    resumeDate: e.pauseEndsAt
  });
  if (e.status === C.O0b.PAUSED) return i.fractionalState !== R.a$.NONE ? D.intl.format(D.t.Q18lRE, {
  ...
  if (e.status === C.O0b.PAST_DUE) {
    ...
    if (eR(e)) return D.intl.format(D.t.awpB0N, {
      prepaidEndDate: e.currentPeriodEnd
    });
    if (e.status === C.O0b.UNPAID) return D.intl.format(D.t.CzTKoq, {
...
function ex(e) {
  ...
  if (eL(a)) return a.isPurchasedViaGoogle ? D.intl.format(D.t["3/WTrK"], {
    quantity: _
...
function e0(e, t, n, r) {
  ...
  let s = !1,
    l = (null != (o = null == (a = e.renewalMutations) ? void 0 : a.items) ? o : e.items).map(e => r.has(e.planId) ? (s = !0, j(x({}, e), {
      quantity: n,
      planId: t
    })) : e);
  if (!s) {
