...
function er(e) {
  ...
  } = e, I = N.GP[h], S = tO(V(I.id), I.interval), A = eL(p) || null == p.paymentSourceId && !p.isPurchasedExternally && !(null == (t = f.default.getCurrentUser()) ? void 0 : t.hasFreePremium()), C = null != m && null == p.paymentGateway, P = p.status === T.O0b.UNPAID && null !== p.latestInvoice && (null == (n = p.latestInvoice) ? void 0 : n.status) === T.hUK.OPEN, w = A ? T.O0b.CANCELED : P ? T.O0b.UNPAID : p.status, D = null == (a = null != (i = null == v ? void 0 : v.taxInclusive) ? i : null == (r = p.latestInvoice) ? void 0 : r.taxInclusive) || a, L = N.cb + (g ? ef(p.additionalPlans) : 0), x = C ? D ? R.intl.format(R.t["cd+hqK"], {
    price: m
...
function eb(e, t) {
  ...
  if (e.status === T.O0b.PAST_DUE) {
    ...
    if (e.status === T.O0b.ACCOUNT_HOLD) return e.isPurchasedViaGoogle && !(0, v.isAndroid)() ? R.intl.format(R.t.dtcxw8, {
