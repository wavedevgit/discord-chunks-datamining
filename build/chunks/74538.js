...
function Z(e) {
  ...
  return null != o && null != o.paymentSourceId && (a = o.paymentSourceId), H(e, n, r, {
    paymentSourceId: a,
    currency: i
  })
}
...
function q(e, t, n) {
  ...
  for (let r of e) {
    let e;
    i = R.Z1.has(r.planId) ? l : !R.dJ.has(r.planId) && s, e = void 0 === n ? Z(r.planId, i, !1, t) : H(r.planId, i, !1, {
      paymentSourceId: n,
      currency: t
...
function el(e) {
  ...
  } = e, I = R.GP[h], T = tN(Z(I.id), I.interval), S = eU(_) || null == _.paymentSourceId && !_.isPurchasedExternally && !(null == (t = p.default.getCurrentUser()) ? void 0 : t.hasFreePremium()), A = null != m && null == _.paymentGateway, C = _.status === N.O0b.UNPAID && null !== _.latestInvoice && (null == (n = _.latestInvoice) ? void 0 : n.status) === N.hUK.OPEN, P = S ? N.O0b.CANCELED : C ? N.O0b.UNPAID : _.status, D = null == (a = null != (i = null == O ? void 0 : O.taxInclusive) ? i : null == (r = _.latestInvoice) ? void 0 : r.taxInclusive) || a, L = R.cb + (g ? eg(_.additionalPlans) : 0), x = A ? D ? w.intl.format(w.t["cd+hqK"], {
    price: m
  }) : w.intl.format(w.t.NUkcpK, {
    price: m
  }) : w.intl.string(w.t.zYx3Y2), k = A ? D ? w.intl.format(w.t.VsKcFB, {
    price: m
...
function eu(e) {
  let {
    planId: t,
    additionalPlans: n
  } = e, r = (0, _.Q0)(t) ? null : en(t), i = null == n ? void 0 : n.find(e => {
    let {
      planId: t
    } = e;
    return R.Z1.has(t)
  }), a = (null == i ? void 0 : i.planId) === R.Xh.PREMIUM_MONTH_GUILD || (null == i ? void 0 : i.planId) === R.Xh.PREMIUM_YEAR_GUILD ? w.t.Pi5yMD : null, o = null != a ? w.intl.formatToPlainString(a, {
...
function eT(e, t) {
  let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
    ...
    i = n ? (0, A.T4)(t.invoiceItems.filter(e => R.UD.has(e.subscriptionPlanId)).map(e => e.amount).reduce((e, t) => t + e, 0), t.currency) : (0, A.T4)(t.total, t.currency);
  ...
  if (e.status === N.O0b.CANCELED) return w.intl.format(w.t["Whp/qq"], {
    endDate: t.subscriptionPeriodStart
  });
  if (e.status === N.O0b.PAUSE_PENDING) return w.intl.format(w.t.uBLUGR, {
    pauseDate: e.currentPeriodEnd,
    resumeDate: e.pauseEndsAt
  });
  if (e.status === N.O0b.PAUSED) return r.fractionalState !== R.a$.NONE ? w.intl.format(w.t.Q18lRE, {
    renewalDate: r.endsAt.toDate(),
    price: i
  }) : null == e.pauseEndsAt ? n ? w.intl.format(w.t.KTYQCg, {
    planName: w.intl.string(w.t.Ipxkoq),
    price: i
  }) : w.intl.string(w.t.fMz6Li) : n ? w.intl.format(w.t.zcgtzc, {
    planName: w.intl.string(w.t.Ipxkoq),
    resumeDate: e.pauseEndsAt,
    price: i
  ...
  if (e.status === N.O0b.PAST_DUE) {
    ...
    return (e.isPurchasedViaGoogle && (null == (a = e.metadata) ? void 0 : a.google_grace_period_expires_date) != null && (t = o()(e.metadata.google_grace_period_expires_date)), e.isPurchasedViaApple && (null == (s = e.metadata) ? void 0 : s.apple_grace_period_expires_date) != null && (t = o()(e.metadata.apple_grace_period_expires_date)), e.isPurchasedExternally) ? w.intl.format(w.t.U2hb3d, {
      endDate: t.toDate(),
    ...
    if (e.status === N.O0b.BILLING_RETRY) return w.intl.format(w.t.EMTLOT, {
      endDate: o()(e.currentPeriodStart).add(R.A5, "days").toDate(),
      price: i
    });
    if (e.status === N.O0b.ACCOUNT_HOLD) return e.isPurchasedViaGoogle && !(0, I.isAndroid)() ? w.intl.format(w.t.dtcxw8, {
    ...
    if (e.status === N.O0b.UNPAID) return w.intl.format(w.t.CzTKoq, {
    ...
    return e.isBoostOnly || (a = eS(a, r.unactivatedUnits)), n ? w.intl.format(w.t.Vl3cEB, {
      planName: w.intl.string(w.t.Ipxkoq),
      renewalDate: a,
      price: i
...
function eW(e) {
  ...
  switch (t) {
    case R.rV.DAY:
      if (n >= 7 && n % 7 == 0) return w.intl.formatToPlainString(w.t["8awlzM"], {
        weeks: n / 7
      });
      return w.intl.formatToPlainString(w.t.ZsgnLC, {
        days: n
      });
    case R.rV.MONTH:
      return w.intl.formatToPlainString(w.t.Y0HCVV, {
        months: n
      });
    case R.rV.YEAR:
      return w.intl.formatToPlainString(w.t.ns1zkZ, {
        years: n
      });
    default:
      throw Error("Unsupported interval duration.")
...
function e$(e, t, n, r) {
  ...
  let s = !1,
    l = (null != (o = null == (a = e.renewalMutations) ? void 0 : a.items) ? o : e.items).map(e => r.has(e.planId) ? (s = !0, k(L({}, e), {
      quantity: n,
      planId: t
    })) : e);
  if (!s) {
...
function e2(e) {
  ...
  if (null != n) {
    ...
    i()(null != t, "Missing plan"), e = e.map(e => {
      ...
      return i()(null != a, "Missing planForInterval"), k(L({}, e), {
        planId: a.id
      })
    })
  }
