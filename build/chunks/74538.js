...
function K(e, t, n) {
  ...
  if (t || n) switch (e) {
    case A.rV.MONTH:
      let o = C.intl.formatToPlainString(a === A.p9.TIER_0 ? C.t.NPKsLy : C.t.poEovb, {
        timeInterval: C.intl.string(C.t.FPybU1)
      });
      return i ? o : C.intl.string(C.t.Mh9bTk);
    case A.rV.YEAR:
      let s = C.intl.formatToPlainString(a === A.p9.TIER_0 ? C.t.NPKsLy : C.t.poEovb, {
        timeInterval: C.intl.string(C.t.tfqrho)
      });
  ...
  switch (e) {
    case A.rV.MONTH:
      if (1 !== r) return C.intl.formatToPlainString(C.t["0UlZnJ"], {
        intervalCount: r
      });
...
function Q(e) {
  ...
  switch (e) {
    case A.Xh.PREMIUM_MONTH_TIER_0:
      return t ? C.intl.format(C.t.TZXHNj, {
        duration: r
      }) : n ? C.intl.string(C.t["81iAgo"]) : C.intl.string(C.t["0efVPz"]);
    case A.Xh.PREMIUM_YEAR_TIER_0:
      return t ? C.intl.format(C.t.eqRhCw, {
        duration: r
      }) : n ? C.intl.string(C.t.UvzqY2) : C.intl.string(C.t.eoVuBg);
    ...
    case A.Xh.PREMIUM_MONTH_TIER_2:
      return t ? C.intl.format(C.t.aI6QX1, {
        duration: r
      }) : n ? C.intl.string(C.t.SmVbHR) : C.intl.string(C.t.FKYNCw);
    case A.Xh.PREMIUM_YEAR_TIER_2:
      return t ? C.intl.format(C.t["1wBcPj"], {
        duration: r
      }) : n ? C.intl.string(C.t.JIq4Oz) : C.intl.string(C.t["cfu/5e"]);
    ...
    case A.Xh.PREMIUM_YEAR_TIER_0:
      switch (w) {
        ...
        case S.O0b.PAUSE_PENDING:
          ...
          return null != j ? C.intl.format(C.t.WUfODw, {
            pauseDate: p.currentPeriodEnd,
            pauseDuration: j
          }) : C.intl.format(C.t.VlWufn, {
            pauseDate: p.currentPeriodEnd
          });
        case S.O0b.PAUSED:
          if (O) return x;
          return C.intl.format(C.t["6RTdZG"], {
      ...
      switch (w) {
        ...
        case S.O0b.ACCOUNT_HOLD:
          return R ? D ? C.intl.format(C.t["5C/0QE"], {
            ...
            price: m,
            num: L
          }) : C.intl.format(C.t.ivjxcn, {
            num: L
          });
        case S.O0b.UNPAID:
          return C.intl.format(C.t["0HopYW"], {
            num: L
          });
        case S.O0b.PAUSE_PENDING:
          let G = null != p.pauseEndsAt ? o()(p.pauseEndsAt).diff(p.currentPeriodEnd, "days") : null;
          return null != G ? C.intl.format(C.t.WUfODw, {
            pauseDate: p.currentPeriodEnd,
            pauseDuration: G
          }) : C.intl.format(C.t.VlWufn, {
            pauseDate: p.currentPeriodEnd
        ...
        case S.O0b.BILLING_RETRY:
          return C.intl.format(C.t["IlJ/HR"], {
            endDate: o()(p.currentPeriodStart).add(A.A5, "days").toDate()
          });
        case S.O0b.PAST_DUE:
          return C.intl.format(C.t["d+0vws"], {
            endDate: (0, g.vc)(eg(p).expiresDate, "LL"),
        ...
        default:
          return b ? h === A.Xh.PREMIUM_YEAR_TIER_2 ? C.intl.format(C.t["+qqh6u"], {
            percent: null != (l = null == y ? void 0 : y.percentage) ? l : A.Bo,
            regularPrice: T
          }) : D ? C.intl.formatToPlainString(C.t["3Ziutb"], {
...
function ei(e) {
  let {
    ...
    return A.Z1.has(t)
  }), a = (null == i ? void 0 : i.planId) === A.Xh.PREMIUM_MONTH_GUILD || (null == i ? void 0 : i.planId) === A.Xh.PREMIUM_YEAR_GUILD ? C.t.Pi5yMD : null, o = null != a ? C.intl.formatToPlainString(a, {
    num: null == i ? void 0 : i.quantity
  }) : void 0;
  if (null != r && null != o) return C.intl.formatToPlainString(C.t.FN5T9v, {
...
function eE(e, t) {
  ...
  if (null != e.trialId && A.h8.includes(e.trialId) && null == e.paymentSourceId) return C.intl.format(C.t["7ZS2m5"], {
    trialEnd: e.currentPeriodEnd
  });
  if (e.status === S.O0b.CANCELED) return C.intl.format(C.t["Whp/qq"], {
    endDate: t.subscriptionPeriodStart
  });
  if (e.status === S.O0b.PAUSE_PENDING) return C.intl.format(C.t.uBLUGR, {
    pauseDate: e.currentPeriodEnd,
    resumeDate: e.pauseEndsAt
  });
  if (e.status === S.O0b.PAUSED) return r.fractionalState !== A.a$.NONE ? C.intl.format(C.t.Q18lRE, {
    renewalDate: r.endsAt.toDate(),
    price: i
  }) : null == e.pauseEndsAt ? n ? C.intl.format(C.t.KTYQCg, {
    planName: C.intl.string(C.t.Ipxkoq),
    price: i
  }) : C.intl.string(C.t.fMz6Li) : n ? C.intl.format(C.t.zcgtzc, {
    planName: C.intl.string(C.t.Ipxkoq),
    resumeDate: e.pauseEndsAt,
    price: i
  }) : C.intl.format(C.t["V8+l6u"], {
    resumeDate: e.pauseEndsAt
  });
  if (e.status === S.O0b.PAST_DUE) {
    var a, s;
    let t = eg(e).expiresDate;
    return (e.isPurchasedViaGoogle && (null == (a = e.metadata) ? void 0 : a.google_grace_period_expires_date) != null && (t = o()(e.metadata.google_grace_period_expires_date)), e.isPurchasedViaApple && (null == (s = e.metadata) ? void 0 : s.apple_grace_period_expires_date) != null && (t = o()(e.metadata.apple_grace_period_expires_date)), e.isPurchasedExternally) ? C.intl.format(C.t.U2hb3d, {
      endDate: t.toDate(),
    ...
    if (e.status === S.O0b.BILLING_RETRY) return C.intl.format(C.t.EMTLOT, {
      endDate: o()(e.currentPeriodStart).add(A.A5, "days").toDate(),
      price: i
    });
    if (e.status === S.O0b.ACCOUNT_HOLD) return e.isPurchasedViaGoogle && !(0, y.isAndroid)() ? C.intl.format(C.t.dtcxw8, {
    ...
    if (eI(e)) return C.intl.format(C.t.awpB0N, {
      prepaidEndDate: e.currentPeriodEnd
    });
    if (e.status === S.O0b.UNPAID) return C.intl.format(C.t.CzTKoq, {
      maxProcessingTimeInDays: A.Rg
    });
    if (e.isPurchasedExternally) return C.intl.format(C.t.ZlWXgY, {
      renewalDate: t.subscriptionPeriodStart,
      paymentGatewayName: N.Vz[e.paymentGateway],
      subscriptionManagementLink: eZ(e.paymentGateway, "SUBSCRIPTION_MANAGEMENT")
    });
    let a = new Date(t.subscriptionPeriodStart);
    return e.isBoostOnly || (a = eb(a, r.unactivatedUnits)), n ? C.intl.format(C.t.Vl3cEB, {
      planName: C.intl.string(C.t.Ipxkoq),
      renewalDate: a,
      price: i
...
function eN(e) {
  ...
  if (eA(a)) return a.isPurchasedViaGoogle ? C.intl.format(C.t["3/WTrK"], {
    quantity: _
  }) : m ? C.intl.format(C.t["0ozBSE"], {
    quantity: _,
  ...
  switch (a.status) {
    case S.O0b.ACCOUNT_HOLD:
      return a.isPurchasedViaGoogle ? C.intl.format(C.t.Nlf3nZ, {
        quantity: _,
        boostQuantity: _
      }) : m ? C.intl.format(C.t.oiRy7u, {
        quantity: _,
        boostQuantity: _,
        rate: (0, I.og)(s, f.interval, f.intervalCount)
    ...
    case S.O0b.PAUSED:
      ...
      return C.intl.format(C.t["5iud9v"], {
        quantity: _
      });
    default:
      return a.isPurchasedViaGoogle ? C.intl.format(C.t["5iud9v"], {
        quantity: _
      }) : m ? C.intl.format(C.t.eDwrLC, {
        quantity: _,
        rate: (0, I.og)(s, f.interval, f.intervalCount)
...
function ej(e, t, n) {
  ...
  switch (r) {
    ...
    case A.Xh.PREMIUM_3_MONTH_TIER_2:
    case A.Xh.PREMIUM_6_MONTH_TIER_2:
      return C.intl.formatToPlainString(C.t.BCD4fX, {
        intervalCount: t.intervalCount
      });
...
function eG(e) {
  ...
  switch (t) {
    case A.rV.DAY:
      if (n >= 7 && n % 7 == 0) return r ? C.intl.formatToPlainString(C.t.fRNBRU, {
        weeks: n / 7
      }) : C.intl.formatToPlainString(C.t.EIpHEh, {
        weeks: n / 7
      });
      return r ? C.intl.formatToPlainString(C.t["6Cdzo6"], {
        days: n
      }) : C.intl.formatToPlainString(C.t["kbBj/v"], {
        days: n
      });
    case A.rV.MONTH:
      return r ? C.intl.formatToPlainString(C.t.x5Mgxc, {
        months: n
      }) : C.intl.formatToPlainString(C.t["4SEnCQ"], {
        months: n
      });
    case A.rV.YEAR:
      return r ? C.intl.formatToPlainString(C.t["h+63ys"], {
        years: n
      }) : C.intl.formatToPlainString(C.t["9DFiHh"], {
        years: n
      });
    default:
...
function eB(e) {
  ...
  switch (t) {
    case A.rV.DAY:
      if (n >= 7 && n % 7 == 0) return C.intl.formatToPlainString(C.t["8awlzM"], {
        weeks: n / 7
      });
      return C.intl.formatToPlainString(C.t.ZsgnLC, {
        days: n
      });
    case A.rV.MONTH:
      return C.intl.formatToPlainString(C.t.Y0HCVV, {
        months: n
      });
    case A.rV.YEAR:
      return C.intl.formatToPlainString(C.t.ns1zkZ, {
        years: n
      });
    default:
      throw Error("Unsupported interval duration.")
...
function eV(e) {
  ...
  switch (t) {
    case A.rV.DAY:
      if (n >= 7 && n % 7 == 0) return r ? C.intl.formatToPlainString(C.t.iVZYys, {
        weeks: n / 7
      }) : C.intl.formatToPlainString(C.t.EmoBDw, {
        weeks: n / 7
      });
      return r ? C.intl.formatToPlainString(C.t.jzH70d, {
        days: n
      }) : C.intl.formatToPlainString(C.t.k2UNz8, {
        days: n
      });
    case A.rV.MONTH:
      return r ? C.intl.formatToPlainString(C.t.erUSmJ, {
        months: n
      }) : C.intl.formatToPlainString(C.t.kridzM, {
        months: n
      });
    case A.rV.YEAR:
      return r ? C.intl.formatToPlainString(C.t.IfYQVF, {
        years: n
      }) : C.intl.formatToPlainString(C.t.PClsr6, {
        years: n
      });
    default:
      throw Error("Unsupported interval duration.")
