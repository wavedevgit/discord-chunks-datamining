...
function J(e, t, n) {
  ...
  if (t || n) switch (e) {
    case C.rV.MONTH:
      let o = P.intl.formatToPlainString(a === C.p9.TIER_0 ? P.t.NPKsLy : P.t.poEovb, {
        timeInterval: P.intl.string(P.t.FPybU1)
      });
      return i ? o : P.intl.string(P.t.Mh9bTk);
    case C.rV.YEAR:
      let s = P.intl.formatToPlainString(a === C.p9.TIER_0 ? P.t.NPKsLy : P.t.poEovb, {
        timeInterval: P.intl.string(P.t.tfqrho)
      });
  ...
  switch (e) {
    case C.rV.MONTH:
      if (1 !== r) return P.intl.formatToPlainString(P.t["0UlZnJ"], {
        intervalCount: r
      });
...
function et(e) {
  ...
  switch (e) {
    case C.Xh.PREMIUM_MONTH_TIER_0:
      return t ? P.intl.format(P.t.TZXHNj, {
        duration: r
      }) : n ? P.intl.string(P.t["81iAgo"]) : P.intl.string(P.t["0efVPz"]);
    case C.Xh.PREMIUM_YEAR_TIER_0:
      return t ? P.intl.format(P.t.eqRhCw, {
        duration: r
      }) : n ? P.intl.string(P.t.UvzqY2) : P.intl.string(P.t.eoVuBg);
    ...
    case C.Xh.PREMIUM_MONTH_TIER_2:
      return t ? P.intl.format(P.t.aI6QX1, {
        duration: r
      }) : n ? P.intl.string(P.t.SmVbHR) : P.intl.string(P.t.FKYNCw);
    case C.Xh.PREMIUM_YEAR_TIER_2:
      return t ? P.intl.format(P.t["1wBcPj"], {
        duration: r
      }) : n ? P.intl.string(P.t.JIq4Oz) : P.intl.string(P.t["cfu/5e"]);
...
function es(e) {
  ...
  } = e, I = C.GP[h], T = tA(V(I.id), I.interval), S = ej(p) || null == p.paymentSourceId && !p.isPurchasedExternally && !(null == (t = _.default.getCurrentUser()) ? void 0 : t.hasFreePremium()), N = null != m && null == p.paymentGateway, R = p.status === A.O0b.UNPAID && null !== p.latestInvoice && (null == (n = p.latestInvoice) ? void 0 : n.status) === A.hUK.OPEN, w = S ? A.O0b.CANCELED : R ? A.O0b.UNPAID : p.status, D = null == (a = null != (i = null == O ? void 0 : O.taxInclusive) ? i : null == (r = p.latestInvoice) ? void 0 : r.taxInclusive) || a, L = C.cb + (g ? em(p.additionalPlans) : 0), x = N ? D ? P.intl.format(P.t["cd+hqK"], {
    price: m
  ...
  switch (h) {
    ...
    case C.Xh.PREMIUM_YEAR_TIER_0:
      switch (w) {
        case A.O0b.CANCELED:
          return N ? D ? P.intl.format(P.t["USi/nZ"], {
            price: m
          }) : P.intl.format(P.t["FS//l5"], {
            price: m
          }) : P.intl.string(P.t.JshLzs);
        case A.O0b.ACCOUNT_HOLD:
          return N ? D ? P.intl.format(P.t["5mv+2t"], {
            price: m
          }) : P.intl.format(P.t.nkAEfX, {
            price: m
          }) : P.intl.format(P.t.SsLIXV, {});
        case A.O0b.UNPAID:
        ...
        case A.O0b.PAUSE_PENDING:
          ...
          return null != j ? P.intl.format(P.t.WUfODw, {
            pauseDate: p.currentPeriodEnd,
            pauseDuration: j
          }) : P.intl.format(P.t.VlWufn, {
            pauseDate: p.currentPeriodEnd
          });
        case A.O0b.PAUSED:
          if (v) return x;
    ...
    case C.Xh.PREMIUM_YEAR_TIER_1:
      switch (w) {
        case A.O0b.CANCELED:
          return N ? D ? P.intl.format(P.t.cXy8Bg, {
            price: m
          }) : P.intl.format(P.t["C/XsHh"], {
            price: m
          }) : P.intl.string(P.t.K6tYFR);
        case A.O0b.ACCOUNT_HOLD:
          return N ? D ? P.intl.format(P.t.HBkIBg, {
            price: m
          }) : P.intl.format(P.t.ZsO1S0, {
            price: m
          }) : P.intl.format(P.t["0+/WHx"], {});
        case A.O0b.UNPAID:
          return P.intl.format(P.t.McIzws, {});
        case A.O0b.PAUSE_PENDING:
          let U = null != p.pauseEndsAt ? o()(p.pauseEndsAt).diff(p.currentPeriodEnd, "days") : null;
          return null != U ? P.intl.format(P.t.WUfODw, {
            pauseDate: p.currentPeriodEnd,
            pauseDuration: U
          }) : P.intl.format(P.t.VlWufn, {
            pauseDate: p.currentPeriodEnd
    ...
    case C.Xh.PREMIUM_6_MONTH_TIER_2:
      switch (w) {
        case A.O0b.CANCELED:
          return N ? D ? P.intl.format(P.t.xoFgRk, {
            price: m,
            num: L
          }) : P.intl.format(P.t.nXdbKi, {
            price: m,
            num: L
          }) : P.intl.format(P.t.EcSdRE, {
            num: L
          });
        case A.O0b.ACCOUNT_HOLD:
          return N ? D ? P.intl.format(P.t["5C/0QE"], {
            price: m,
            num: L
          }) : P.intl.format(P.t.xfYkho, {
            price: m,
            num: L
          }) : P.intl.format(P.t.ivjxcn, {
            num: L
          });
        case A.O0b.UNPAID:
          return P.intl.format(P.t["0HopYW"], {
            num: L
          });
        case A.O0b.PAUSE_PENDING:
          let G = null != p.pauseEndsAt ? o()(p.pauseEndsAt).diff(p.currentPeriodEnd, "days") : null;
          return null != G ? P.intl.format(P.t.WUfODw, {
            pauseDate: p.currentPeriodEnd,
            pauseDuration: G
          }) : P.intl.format(P.t.VlWufn, {
            pauseDate: p.currentPeriodEnd
        ...
        case A.O0b.BILLING_RETRY:
          return P.intl.format(P.t["IlJ/HR"], {
        ...
        default:
          return E ? h === C.Xh.PREMIUM_YEAR_TIER_2 ? P.intl.format(P.t["+qqh6u"], {
            percent: null != (l = null == y ? void 0 : y.percentage) ? l : C.Bo,
            regularPrice: T
          }) : D ? P.intl.formatToPlainString(P.t["3Ziutb"], {
...
function ec(e) {
  let {
    ...
    return C.Z1.has(t)
  }), a = (null == i ? void 0 : i.planId) === C.Xh.PREMIUM_MONTH_GUILD || (null == i ? void 0 : i.planId) === C.Xh.PREMIUM_YEAR_GUILD ? P.t.Pi5yMD : null, o = null != a ? P.intl.formatToPlainString(a, {
    num: null == i ? void 0 : i.quantity
  }) : void 0;
  if (null != r && null != o) return P.intl.formatToPlainString(P.t.FN5T9v, {
...
function eI(e, t) {
  let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
    ...
    i = n ? (0, S.T4)(t.invoiceItems.filter(e => C.UD.has(e.subscriptionPlanId)).map(e => e.amount).reduce((e, t) => t + e, 0), t.currency) : (0, S.T4)(t.total, t.currency);
  if (null != e.trialId && C.h8.includes(e.trialId) && null == e.paymentSourceId) return P.intl.format(P.t["7ZS2m5"], {
    trialEnd: e.currentPeriodEnd
  });
  if (e.status === A.O0b.CANCELED) return P.intl.format(P.t["Whp/qq"], {
    endDate: t.subscriptionPeriodStart
  });
  if (e.status === A.O0b.PAUSE_PENDING) return P.intl.format(P.t.uBLUGR, {
    pauseDate: e.currentPeriodEnd,
    resumeDate: e.pauseEndsAt
  });
  if (e.status === A.O0b.PAUSED) return r.fractionalState !== C.a$.NONE ? P.intl.format(P.t.Q18lRE, {
    renewalDate: r.endsAt.toDate(),
    price: i
  }) : null == e.pauseEndsAt ? n ? P.intl.format(P.t.KTYQCg, {
    planName: P.intl.string(P.t.Ipxkoq),
    price: i
  }) : P.intl.string(P.t.fMz6Li) : n ? P.intl.format(P.t.zcgtzc, {
    planName: P.intl.string(P.t.Ipxkoq),
    resumeDate: e.pauseEndsAt,
    price: i
  }) : P.intl.format(P.t["V8+l6u"], {
    resumeDate: e.pauseEndsAt
  });
  if (e.status === A.O0b.PAST_DUE) {
    var a, s;
    let t = ev(e).expiresDate;
    return (e.isPurchasedViaGoogle && (null == (a = e.metadata) ? void 0 : a.google_grace_period_expires_date) != null && (t = o()(e.metadata.google_grace_period_expires_date)), e.isPurchasedViaApple && (null == (s = e.metadata) ? void 0 : s.apple_grace_period_expires_date) != null && (t = o()(e.metadata.apple_grace_period_expires_date)), e.isPurchasedExternally) ? P.intl.format(P.t.U2hb3d, {
      endDate: t.toDate(),
    ...
    if (e.status === A.O0b.BILLING_RETRY) return P.intl.format(P.t.EMTLOT, {
      endDate: o()(e.currentPeriodStart).add(C.A5, "days").toDate(),
      price: i
    });
    if (e.status === A.O0b.ACCOUNT_HOLD) return e.isPurchasedViaGoogle && !(0, v.isAndroid)() ? P.intl.format(P.t.dtcxw8, {
    ...
    if (eC(e)) return P.intl.format(P.t.awpB0N, {
      prepaidEndDate: e.currentPeriodEnd
    });
    if (e.status === A.O0b.UNPAID) return P.intl.format(P.t.CzTKoq, {
      maxProcessingTimeInDays: C.Rg
    });
    if (e.isPurchasedExternally) return P.intl.format(P.t.ZlWXgY, {
      renewalDate: t.subscriptionPeriodStart,
      paymentGatewayName: R.Vz[e.paymentGateway],
      subscriptionManagementLink: ez(e.paymentGateway, "SUBSCRIPTION_MANAGEMENT")
    });
    let a = new Date(t.subscriptionPeriodStart);
    return e.isBoostOnly || (a = eT(a, r.unactivatedUnits)), n ? P.intl.format(P.t.Vl3cEB, {
      planName: P.intl.string(P.t.Ipxkoq),
      renewalDate: a,
      price: i
...
function eD(e) {
  ...
  if (ew(a)) return a.isPurchasedViaGoogle ? P.intl.format(P.t["3/WTrK"], {
    quantity: _
  }) : h ? P.intl.format(P.t["0ozBSE"], {
    quantity: _,
  ...
  switch (a.status) {
    case A.O0b.ACCOUNT_HOLD:
      return a.isPurchasedViaGoogle ? P.intl.format(P.t.Nlf3nZ, {
        quantity: _,
        boostQuantity: _
      }) : h ? P.intl.format(P.t.oiRy7u, {
        quantity: _,
        boostQuantity: _,
        rate: (0, S.og)(s, f.interval, f.intervalCount)
    ...
    case A.O0b.PAUSED:
      ...
      return P.intl.format(P.t["5iud9v"], {
        quantity: _
      });
    default:
      return a.isPurchasedViaGoogle ? P.intl.format(P.t["5iud9v"], {
        quantity: _
      }) : h ? P.intl.format(P.t.eDwrLC, {
        quantity: _,
        rate: (0, S.og)(s, f.interval, f.intervalCount)
...
function eV(e, t, n) {
  ...
  switch (r) {
    ...
    case C.Xh.PREMIUM_3_MONTH_TIER_2:
    case C.Xh.PREMIUM_6_MONTH_TIER_2:
      return P.intl.formatToPlainString(P.t.BCD4fX, {
        intervalCount: t.intervalCount
      });
...
function eH(e) {
  ...
  switch (t) {
    case C.rV.DAY:
      if (n >= 7 && n % 7 == 0) return r ? P.intl.formatToPlainString(P.t.fRNBRU, {
        weeks: n / 7
      }) : P.intl.formatToPlainString(P.t.EIpHEh, {
        weeks: n / 7
      });
      return r ? P.intl.formatToPlainString(P.t["6Cdzo6"], {
        days: n
      }) : P.intl.formatToPlainString(P.t["kbBj/v"], {
        days: n
      });
    case C.rV.MONTH:
      return r ? P.intl.formatToPlainString(P.t.x5Mgxc, {
        months: n
      }) : P.intl.formatToPlainString(P.t["4SEnCQ"], {
        months: n
      });
    case C.rV.YEAR:
      return r ? P.intl.formatToPlainString(P.t["h+63ys"], {
        years: n
      }) : P.intl.formatToPlainString(P.t["9DFiHh"], {
        years: n
      });
    default:
...
function eY(e) {
  ...
  switch (t) {
    case C.rV.DAY:
      if (n >= 7 && n % 7 == 0) return P.intl.formatToPlainString(P.t["8awlzM"], {
        weeks: n / 7
      });
      return P.intl.formatToPlainString(P.t.ZsgnLC, {
        days: n
      });
    case C.rV.MONTH:
      return P.intl.formatToPlainString(P.t.Y0HCVV, {
        months: n
      });
    case C.rV.YEAR:
      return P.intl.formatToPlainString(P.t.ns1zkZ, {
        years: n
      });
    default:
      throw Error("Unsupported interval duration.")
...
function eK(e) {
  ...
  switch (t) {
    case C.rV.DAY:
      if (n >= 7 && n % 7 == 0) return r ? P.intl.formatToPlainString(P.t.iVZYys, {
        weeks: n / 7
      }) : P.intl.formatToPlainString(P.t.EmoBDw, {
        weeks: n / 7
      });
      return r ? P.intl.formatToPlainString(P.t.jzH70d, {
        days: n
      }) : P.intl.formatToPlainString(P.t.k2UNz8, {
        days: n
      });
    case C.rV.MONTH:
      return r ? P.intl.formatToPlainString(P.t.erUSmJ, {
        months: n
      }) : P.intl.formatToPlainString(P.t.kridzM, {
        months: n
      });
    case C.rV.YEAR:
      return r ? P.intl.formatToPlainString(P.t.IfYQVF, {
        years: n
      }) : P.intl.formatToPlainString(P.t.PClsr6, {
        years: n
      });
    default:
      throw Error("Unsupported interval duration.")
