...
function es(e) {
  ...
  } = e, I = C.GP[h], S = tA(V(I.id), I.interval), T = ej(p) || null == p.paymentSourceId && !p.isPurchasedExternally && !(null == (t = _.default.getCurrentUser()) ? void 0 : t.hasFreePremium()), N = null != m && null == p.paymentGateway, R = p.status === A.O0b.UNPAID && null !== p.latestInvoice && (null == (n = p.latestInvoice) ? void 0 : n.status) === A.hUK.OPEN, w = T ? A.O0b.CANCELED : R ? A.O0b.UNPAID : p.status, D = null == (a = null != (i = null == O ? void 0 : O.taxInclusive) ? i : null == (r = p.latestInvoice) ? void 0 : r.taxInclusive) || a, L = C.cb + (g ? em(p.additionalPlans) : 0), x = N ? D ? P.intl.format(P.t["cd+hqK"], {
    price: m
...
function eI(e, t) {
  ...
  if (e.status === A.O0b.PAST_DUE) {
    ...
    return e.isBoostOnly || (a = eS(a, r.unactivatedUnits)), n ? P.intl.format(P.t.Vl3cEB, {
      planName: P.intl.string(P.t.Ipxkoq),
      renewalDate: a,
      price: i
