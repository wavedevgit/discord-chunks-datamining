...
function C(e) {
  ...
  return (null == c ? true : c.id) === t.id || t.bot || 0 === d.length || h.Z.isBlockedOrIgnored(t.id) ? null : <a.sNh id={"invite-to-server"} label={b.intl.string(b.t.Sd8Ix8)}>{d.map(e => y[e.id] ? (0, r.jsx)(a.sNh, {
      id: e.id,
      disabled: true,
