    ...
    e.binaryType = "arraybuffer", e.onopen = () => {
      ...
      switch (t) {
        ...
        case 27:
          ...
          break;
        case 29: {
          let e = new DataView(r.buffer, r.byteOffset, T).getUint16(0, false),
            t = r.slice(T);
