...
function A(e) {
  ...
  let {
    ...
    } = e, s = "channel" === t.type ? t.channel : void 0, d = (0, m.Hs)(s, [c.yU.CHAT]).hasBaseAccessPermissions, u = (0, p.em)(t, d, l), f = (0, p.PL)(d, l), h = i.useCallback(e => {
        ...
        return i => {
          ...
          if (!(i.applicationId in n)) {
            let {
              ...
              isGuildInstalled: s,
              isUserInstalled: c
            } = (0, p.If)(e, i.applicationId), d = (null == r ? void 0 : r.guild_id) != null ? f.ML(null == t ? void 0 : t.permissions, r.guild_id, l, a, o) : null, u = (null == r ? void 0 : r.guild_id) != null ? f.ZJ(null == t ? void 0 : t.permissions, r, r.guild_id) : null;
            n[i.applicationId] = {
              descriptor: t,
      ...
      filterPredicates: [function(e) {
        ...
        return n => {
          let {
            ...
            isGuildInstalled: c,
            isUserInstalled: d
          } = (0, p.If)(e, n.id), u = (null == i ? void 0 : i.guild_id) != null ? f.ML(null == o ? void 0 : o.permissions, i.guild_id, r, l, a) : null, m = (null == i ? void 0 : i.guild_id) != null ? f.ZJ(null == o ? void 0 : o.permissions, i, i.guild_id) : null;
  ...
  }, [s, h, a, t, n, A, I]), L = S.length > 0, w = T.length > 0;
  return {
    commandResults: S,
    hasCommandResults: L,
...
function I(e) {
  ...
  let {
    ...
    var i, r;
    return null != (r = null == (i = x.Z.getSearchResults({
      query: n,
      guildId: u,
      page: t + 1,
      integrationType: a.Y.USER_INSTALL,
