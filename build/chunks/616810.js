...
class s extends Chunk928801.Z {
  ...
  constructor(e) {
    super(false), o(this, "socket", true), o(this, "switchingAccounts", true), o(this, "didCommit", true), this.socket = e, this.switchingAccounts = false, this.didCommit = (0, i.Z)(5, 2e4, this.emitPresenceUpdate.bind(this))
  }
}