...
class k extends(r = Chunk473749.Component) {
  ...
  renderTooltip() {
    ...
    } = this.props, g = (Chunk873546.tq || Chunk873546.Em) && true === Chunk846519 && Chunk377527, E = false !== Chunk205120 && !Chunk314910 || true === Chunk205120, b = this.shouldShowTooltip(this.props, this.state) && this.hasDomElement, y = null;
