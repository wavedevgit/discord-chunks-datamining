...
class k extends(r = Chunk473749.Component) {
  ...
  renderTooltip() {
    ...
    } = this.props, g = (Chunk873546.tq || Chunk873546.Em) && true === Chunk846519 && Chunk377527, E = false !== Chunk706619 && !Chunk314910 || true === Chunk706619, b = this.shouldShowTooltip(this.props, this.state) && this.hasDomElement, y = null;
