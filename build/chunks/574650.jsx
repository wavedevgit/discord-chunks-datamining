...
let A = () => {
  ...
  let C = () => {
    ...
    R = () => {
      (0, Chunk481060.h7j)(e => <c.ConfirmModal{...S(I({
  ...
  return <div className={o()(...M)}>{<Chunk481060.Text className={Chunk246752.header} variant={"text-sm/normal"}>{D}</Chunk481060.Text>}{<Chunk481060.zxk variant={"overlay-primary"} size={"sm"} onClick={x} text={L} />}</div>
}