...
var Chunk627968 = require("./627968.js"),
  ...
  Chunk525113 = require("./525113.jsx"),
  ...
  Chunk542210 = require("./542210.jsx"),
  Chunk780679 = require("./780679.jsx"),
  Chunk411335 = require("./411335.js"),
  Chunk985018 = require("./985018.jsx"),
  Chunk985681 = require("./985681.js");
...
function A(e) {
  let {
    rule: t,
    triggerType: n
  } = e, l = i.useMemo(() => null == t ? (0, g.J6)(n).map(e => (0, r.jsx)(p.A, {
    actionType: e,
    triggerType: n
  }, e)) : (0, g.J6)(n).reduce((e, i) => {
    var l;
    ...
    return null == s || e.push((0, r.jsx)(p.A, {
      actionType: i,
      action: s,
...
function S(e) {
  return (0, g.ub)(e, g.H2.ALPHA) ? (0, r.jsx)(o.A, {
    className: O.n0
  }) : (0, g.ub)(e, g.H2.BETA) ? (0, r.jsx)(d.A, {
    className: O.n0
  }) : null
}
...
function T(e) {
  let {
    ...
    isDefaultRule: n,
    onContextMenu: c
  } = e, o = (0, m.l)(t.triggerType, t), {
    isLoading: d,
    saveRule: g
  } = (0, b.S)(), {
    updateRule: p
  } = (0, f.wP)(t.guildId), [x, h] = i.useState(t.enabled), _ = (0, l.throttle)(async () => {
    if (!d) {
      let e = v(y({}, t), {
        enabled: !x
      });
...
function C(e) {
  let {
    ...
    null != t && (e.preventDefault(), e.stopPropagation(), (0, c.L3)(e, async () => {
      let {
        default: e
