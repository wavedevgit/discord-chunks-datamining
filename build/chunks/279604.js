  ...
  (0, o.ZDy)(async () => {
    switch (t.type) {
      ...
      case f.Us.PERK: {
        let {
          default: i
        } = await Promise.all([n.e("67649"), n.e("6397")]).then(n.bind(n, 326055));
        return n => (0, r.jsx)(i, m({
          guildId: e,
          powerup: t
        }, n))
...
function O(e, t) {
  ...
  }(t, S) : [], [t, S]), P = Math.max((null != (b = null == x ? void 0 : x.premiumSubscriberCount) ? b : 0) - E, 0), N = i.useCallback(n => {
    let r = n ? h.H6 : h.Th;
  ...
  }, [N, t, P, O, x, I]), Z = i.useCallback(e => (e.stopPropagation(), N(!1)), [N]);
  return {
    isLoading: y,
    error: C,
    onActivate: w,
