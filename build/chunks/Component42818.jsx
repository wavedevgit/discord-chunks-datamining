...
function M(e, t, n, r) {
  ...
  switch (e.subscriptionPlanId) {
    ...
    case I.Xh.PREMIUM_MONTH_GUILD:
      return N.intl.format(N.t["3BYyip"], {
        num: e.quantity
      });
    case I.Xh.PREMIUM_YEAR_GUILD:
      return N.intl.format(N.t.JVW4UN, {
        num: e.quantity
      })
  }
  switch (t.interval) {
    case I.rV.MONTH:
      if (1 === t.intervalCount) return N.intl.formatToPlainString(N.t["6oq128"], {
        planName: t.name
      });
    ...
    case I.rV.YEAR:
      return N.intl.formatToPlainString(N.t.V6UFQM, {
        planName: t.name
      })
  }
...
function k(e) {
  ...
  let {
    ...
    inTrialPeriod: p
  } = e, m = (0, c.e7)([_.Z], () => _.Z.get(n.subscriptionPlanId)), h = null == (t = (0, O.N)(f)) ? true : t.subscription_trial;
  l()(null != m, "Missing subscriptionPlan");
  let b = M(n, m, d, (0, g.if)({
    intervalType: null == h ? true : h.interval,
    intervalCount: null == h ? true : h.interval_count
  }));
  true === o && (b = (0, r.jsxs)("div", {
...
function G(e) {
  ...
  } = e, i = (0, y.j)(t.invoiceItems), o = i.find(e => !(0, g.Z8)(e.subscriptionPlanId) && e.amount >= 0), a = i.find(e => (0, g.Z8)(e.subscriptionPlanId) && e.amount >= 0), s = (0, c.e7)([_.Z], () => null != a ? _.Z.get(a.subscriptionPlanId) : null), l = null != a ? a.amount : 0, u = (0, E.T4)(l, t.currency), d = null != s ? (0, E.og)(u, s.interval, s.intervalCount) : 0;
  return (0, r.jsxs)(r.Fragment, {
    children: [null != o ? (0, r.jsx)(k, {
      invoiceItem: o,
      currency: t.currency,
      isPrepaidPaymentSource: n
    }) : null, 0 !== l && null != a && null != s ? (0, r.jsx)(v.B1, {
...
function Z(e) {
  ...
  let c = a.find(e => !(0, g.Z8)(e.subscriptionPlanId) && e.amount < 0),
    ...
    h = a.filter(e => e.subscriptionPlanId === I.Xh.PREMIUM_MONTH_GUILD || e.subscriptionPlanId === I.Xh.PREMIUM_YEAR_GUILD).reduce((e, t) => e + t.amount, 0);
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(k, {
      invoiceItem: s,
      currency: t.currency,
...
function V(e) {
  ...
  return (0, r.jsx)("div", {
    ...
    children: N.intl.format(N.t.JWWD4E, {
      renewalDate: c
    })
  })
}
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(v.UN, {
      ...
      return (0, r.jsx)(k, {
        ...
        className: a()({
          [P.subscriptionAddedInvoiceItem]: !t || n
        })
      }, e.id)
    }), (0, r.jsx)(S.Z, {
      invoice: i
...
function Y(e) {
  ...
  if (o) {
    let e = (0, g.if)({
      ...
      t = (null == c ? true : c.interval) === I.rV.DAY && (null == c ? true : c.interval_count) < 28 ? 2 : 7;
...
function W(e) {
  let {
    ...
    isTrial: l = false,
    priceOptions: c,
    isPrepaidPaymentSource: d = false,
    trialFooterMessageOverride: _,
    hideSubscriptionDetails: h = false
  } = e, {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [d ? null : (0, r.jsx)(v.P7, {
      ...
      children: [(0, r.jsxs)(u.P3F, {
        ...
        children: [O ? N.intl.string(N.t.aBcRbK) : N.intl.string(N.t.X6duqp), (0, r.jsx)(m.Z, {
...
function K(e) {
  let t, {
      plan: n,
      className: i,
      isPrepaidPaymentSource: o = false,
    ...
    _ = (0, E.T4)(p, d),
    m = (0, E.T4)(f, d);
  return t = a ? (0, g.L7)(n.interval, true, true, true, true, (0, g.Rd)(n.id)) : N.intl.formatToPlainString(N.t.LQLxkW, {
    planName: (0, g.Gf)(n.id, false, o)
  }), (0, r.jsxs)("div", {
    className: i,
...
function z(e) {
  ...
  return l()(null != o, "newPlanInvoiceItem can not be null"), i.interval === I.rV.MONTH ? t = n.taxInclusive ? N.t.v9QeON : N.t.FALkO5 : i.interval === I.rV.YEAR ? t = n.taxInclusive ? N.t.ECT4A5 : N.t["0HQxKW"] : l()(false, "Invalid interval type"), (0, r.jsx)(u.Text, {
    variant: "text-md/normal",
    children: N.intl.format(t, {
