...
function L(e, t, n, r) {
  ...
  switch (e.subscriptionPlanId) {
    ...
    case S.Xh.PREMIUM_MONTH_GUILD:
      return A.intl.format(A.t["3BYyio"], {
        num: e.quantity
      });
    case S.Xh.PREMIUM_YEAR_GUILD:
      return A.intl.format(A.t.JVW4UF, {
        num: e.quantity
      })
  }
  switch (t.interval) {
    case S.rV.MONTH:
      if (1 === t.intervalCount) return A.intl.formatToPlainString(A.t["6oq129"], {
        planName: t.name
      });
    ...
    case S.rV.YEAR:
      return A.intl.formatToPlainString(A.t.V6UFQE, {
        planName: t.name
      })
  }
...
function j(e) {
  ...
  let {
    ...
    inTrialPeriod: _
  } = e, h = (0, c.e7)([p.Z], () => p.Z.get(n.subscriptionPlanId)), m = null == (t = (0, O.N)(f)) ? true : t.subscription_trial;
  l()(null != h, "Missing subscriptionPlan");
  let b = L(n, h, d, (0, g.if)({
...
function Z(e) {
  ...
  return (0, r.jsx)("div", {
    ...
    children: A.intl.format(A.t.JWWD4O, {
      renewalDate: c
    })
  })
}
...
function F(e) {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(v.UN, {
      ...
      }), B(G((0, y.j)(n.invoiceItems))).map(e => (0, r.jsx)(j, {
        invoiceItem: e,
        currency: n.currency,
        inTrialPeriod: a
      }, e.id)), (0, r.jsx)(v.UN, {
...
function V(e) {
  ...
  if (a) {
    let e = (0, g.if)({
      ...
      t = (null == c ? true : c.interval) === S.rV.DAY && (null == c ? true : c.interval_count) < 28 ? 2 : 7;
    return null != l ? l : A.intl.format(A.t["2FvcjI"], {
      duration: e,
      days: t,
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [d ? null : (0, r.jsx)(v.P7, {
      ...
      children: [(0, r.jsxs)(u.P3F, {
        ...
        children: [O ? A.intl.string(A.t.aBcRbG) : A.intl.string(A.t.X6duqq), (0, r.jsx)(h.Z, {
...
function Y(e) {
  let t, {
    ...
    p = (0, E.T4)(_, d),
    h = (0, E.T4)(f, d);
  return t = o ? (0, g.L7)(n.interval, true, true, true, true, (0, g.Rd)(n.id)) : A.intl.formatToPlainString(A.t.LQLxkZ, {
...
function W(e) {
  ...
  return l()(null != a, "newPlanInvoiceItem can not be null"), i.interval === S.rV.MONTH ? t = n.taxInclusive ? A.t.v9QeOD : A.t.FALkOz : i.interval === S.rV.YEAR ? t = n.taxInclusive ? A.t.ECT4Aw : A.t["0HQxKS"] : l()(false, "Invalid interval type"), (0, r.jsx)(u.Text, {
    variant: "text-md/normal",
