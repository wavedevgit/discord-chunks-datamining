...
function en() {
  ...
  let t = r.useMemo(() => {
      ...
      return h.Z.isDeveloper && (e.push({
        ...
        group: J.v0.DEVELOPMENT,
        render: () => (0, a.jsx)(w.Z, {
          devSettingsCategory: v.zU.OVERLAYS
        })
      }), e.push({
        id: "messaging",
        name: "Messaging",
        ...
        group: J.v0.EXPERIMENTS,
        render: () => (0, a.jsx)(w.Z, {
          devSettingsCategory: v.zU.REPORTING
        })
      }), e.push({
        id: "permissions",
        name: "Permissions",
...
function er() {
  return (0, o.e7)([f.Z], () => f.Z.displayTools) ? (0, a.jsx)("div", {
