...
let y = new i.Yd("OverlayActionCreators"),
  O = {
    ...
    setNotificationDisabledSetting(e, t) {
      e === l.OverlayNotificationDisabledSetting.GAME_ACTIVITY && this.track(h.rMx.OVERLAY_GAME_INVITE_SETTINGS_UPDATED, {
        muted: t
      }), a.Z.dispatch({
    ...
    setPinChat(e) {
      ...
      if ((0, s.JS)(h.Odu.TEXT, {
          pinned: e
        }), 0 === n.length || null == i || null == a || null == o || null == l || null == u || null == m) return;
      ...
      if (n.forEach(e => {
        ...
        e -= u.minSize.width;
        let [n, i] = (0, f.o4)(I, b(g({}, T), {
          width: u.minSize.width
        }), E), [a, o] = (0, f.uq)(I, b(g({}, T), {
          width: e
        }), E, {
          x: 10,
          y: 10
        ...
        let [n, i] = (0, f.o4)(O, {
          height: v.height,
          width: e
        }, E), a = c.Z.getWidgetDefaultSettings(h.Odu.GUILDS_TEXT);
    ...
    updateOverlayMethod: (e, t) => a.Z.dispatch({
