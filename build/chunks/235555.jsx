...
class O extends Chunk73800.PureComponent {
  ...
  render() {
    ...
    return this.hasParty(require) && null != module ? <Chunk824138.Z currentUser={module} host={exports} party={require} renderOverflowPopout={this.renderOverflowPopout} onStopListening={this.handleStopListening} onUserContextMenu={this.handleUserContextMenu} /> : null
  }
  constructor(...e) {
    super(...e), _(this, "handleUserContextMenu", (e, t) => {
      ...
      return <c.Z party={e} header={b.intl.formatToPlainString(b.t.I9et19, {
          count: e.length
        })} />
    })
  }
