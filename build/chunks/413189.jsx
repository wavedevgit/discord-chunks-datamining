...
function T(e) {
  ...
  return (i.useEffect(() => {
    ...
    learnMoreLink: _.Z.getArticleURL(y.BhN.DM_WALLPAPERS)
  }) : N = v.intl.string(v.t["6JSOu7"]), (null == B ? true : B.isViewable) && Z && !V && (C = <div className={I.action}><a.z variant={"primary"} text={v.intl.string(Y ? v.t.o6850d : v.t["/ubFp6"])} loading={U} onClick={() => {
        g.X(P, D, {
          shouldClear: !Y,
          onError: () => {
      ...
      }} /></div>), <b.Z channel={P} content={A} subtitle={N} action={C} compact={w} message={R} />)
}