...
let S = (e, t, n, r) => {
  ...
  N = e => {
    ...
    return <b.yR>{<b.wG onClickTitle={k} onClickSubtitle={j} onClickThumbnail={k} channel={t} entry={n} headerIcons={N === a.p.SPOTIFY ? (0, r.jsx)(y.Z, {
          onClick: M,
          Icon: u.Z,
          "aria-label": I.intl.string(I.t["0ZB/XF"])
        }) : null} userDescription={I.t.CcVI1d} title={T} subtitle={R} badges={(0, r.jsx)(E.Gk, {
          location: E.Gt.POPOUT,
          children: g.Ho.map((e, t) => (0, r.jsx)(e, {
            entry: n
          }, t))
        })} />}{<b.St><b.WT onReaction={o} onVoiceChannelPreview={f} user={P} channel={t} generateReactionImage={x} reactionImageAltText={A(n, P)} entry={n} /></b.St>}</b.yR>
  }