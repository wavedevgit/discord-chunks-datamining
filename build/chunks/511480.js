      ...
      children: [(0, r.jsxs)(a.hjN, {
        ...
        children: [(0, r.jsxs)("div", {
          children: [(0, r.jsx)(a.vwX, {
            ...
            buttonCTA: k.NW.string(k.t.yG2pUl),
            size: a.zxk.Sizes.SMALL,
...
let B = s.ZP.connectStores([v.Z, f.Z, C.ZP, p.ZP, b.default, h.Z], () => {
  let {
    guild: e,
    errors: t,
    submitting: n,
    guildMetadata: r
  } = v.Z.getProps(), i = f.Z.can(Z.Plq.MANAGE_GUILD, e), s = f.Z.can(Z.Plq.ADMINISTRATOR, e), a = null != e ? C.ZP.getDiscoveryChecklist(e.id) : null, l = null != e ? p.ZP.getChannels(e.id) : null, o = [];
  return null != l && l[p.sH].forEach(e => {
    ...
    t.type === Z.d4z.GUILD_TEXT && o.push({
      value: t.id,
      label: (0, c.F6)(t, b.default, h.Z, !0)
    })
  }), {
    guild: e,
    errors: t,
