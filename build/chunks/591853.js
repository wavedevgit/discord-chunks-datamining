...
function ev(e) {
  let {
    ...
    embeddedActivity: D
  } = (0, ee.Z)(p), x = eC(D), M = null != w && 0 === h.length ? [w] : h, k = M.length > 0, j = M.length >= 2, [G, F] = i.useState(!k), V = z.ZP.getName(null == t ? void 0 : t.guild_id, null == t ? void 0 : t.id, n), Z = null != t && E ? ec.intl.formatToPlainString(ec.t["8lzR/f"], {
