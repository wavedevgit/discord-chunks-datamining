...
function eE(e) {
  let {
  ...
  } = e, [m, g] = i.useState(!1), [E, y] = i.useState(null), O = (0, c.e7)([U.Z], () => null != t && eo.TPd.CONTENT_ENTRY_EMBEDS.has(t.type) && U.Z.can(eo.Plq.SEND_MESSAGES, t)), [I, T] = i.useState(!1), [S, A] = i.useState(!1), {
    voiceBar: N,
    joinVoiceButton: C
  } = eA({
    channel: t,
    ...
    embeddedActivity: R
  } = (0, J.Z)(o), P = eS(R), w = null != C && 0 === s.length ? [C] : s, D = w.length > 0, L = w.length >= 2, [x, M] = i.useState(!D), j = W.ZP.getName(null == t ? void 0 : t.guild_id, null == t ? void 0 : t.id, n), G = null != t && m ? es.intl.formatToPlainString(es.t["8lzR/f"], {
    channel: "#".concat(t.name)
  }) : es.intl.formatToPlainString(es.t["4c+CAw"], {
    channel: "@".concat(j)
  }), B = m ? es.intl.string(es.t.Z2CUgo) : es.intl.string(es.t.XLGiTE), V = async e => {
    let r, {
      emoji: i
    } = e;
    if (null != i) {
    ...
    if ((0, v.EW)(u.z.CONTENT_INVENTORY_ONE_CLICK_REPLY_COACHTIP), m) l()(null != t, "shareToChannelMode should only be true if a valid channel is passed"), r = t;
      ...
      let e = await f.Z.openPrivateChannel({
          recipientIds: n.id
        }),
        t = k.Z.getChannel(e);
    ...
    children: [(0, r.jsx)(ei.Z, {
      ...
      children: [(0, r.jsx)(b.A7, {
        ...
        renderAttachButton: O ? () => (0, r.jsx)(_.ua7, {
          text: B,
          children: e => (0, r.jsx)(_.P3F, e_(eu({}, e), {
...
function ey(e) {
  ...
  } = (0, $.Z)(i, 3), h = (0, c.e7)([V.default], () => V.default.getUser(i.author_id)), {
    streamPreviewUrl: m
  } = (0, ee.Z)(i), g = null != m, E = [d, f];
  return (0, r.jsxs)("div", {
...
function eT(e) {
  var {
    ...
    children: n,
    className: i
  } = e, a = ef(e, ["IconComponent", "children", "className"]);
  return (0, r.jsx)(_.zxk, e_(eu({}, a), {
...
function eA(e) {
  ...
  } = (0, w.Z)(null == t ? void 0 : t.id), u = (0, c.e7)([j.Z], () => null != s ? j.Z.getGuild(s.guild_id) : void 0), f = (0, c.Wu)([Z.ZP], () => null != s ? Z.ZP.getVoiceStatesForChannel(s) : [], [s]), h = (0, c.e7)([F.Z], () => F.Z.isInChannel(null == s ? void 0 : s.id)), m = i.useMemo(() => {
    for (let e of f) {
    ...
    voiceBar: (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(O, {
          ...
          children: e => (0, r.jsxs)(_.P3F, e_(eu({}, e), {
