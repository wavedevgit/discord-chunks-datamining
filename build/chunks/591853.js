...
function eE(e) {
  let {
    ...
    embeddedActivity: R
  } = (0, J.Z)(o), P = eS(R), w = null != C && 0 === s.length ? [C] : s, D = w.length > 0, L = w.length >= 2, [x, k] = i.useState(!D), j = W.ZP.getName(null == t ? void 0 : t.guild_id, null == t ? void 0 : t.id, n), G = null != t && m ? es.intl.formatToPlainString(es.t["8lzR/f"], {
...
function eA(e) {
  ...
  } = (0, w.Z)(null == t ? void 0 : t.id), u = (0, c.e7)([j.Z], () => null != s ? j.Z.getGuild(s.guild_id) : void 0), _ = (0, c.Wu)([Z.ZP], () => null != s ? Z.ZP.getVoiceStatesForChannel(s) : [], [s]), h = (0, c.e7)([F.Z], () => F.Z.isInChannel(null == s ? void 0 : s.id)), m = i.useMemo(() => {
    for (let e of _) {
