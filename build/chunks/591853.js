...
function ev(e) {
  let {
    ...
    reactionImageAltText: o,
    onReaction: s,
    entry: p,
    buttons: h = [],
    header: m,
    onVoiceChannelPreview: g
  } = e, [E, v] = i.useState(!1), [O, S] = i.useState(null), T = (0, c.e7)([B.Z], () => null != t && el.TPd.CONTENT_ENTRY_EMBEDS.has(t.type) && B.Z.can(el.Plq.SEND_MESSAGES, t)), [A, N] = i.useState(!1), [C, R] = i.useState(!1), {
    voiceBar: P,
    joinVoiceButton: w
  } = eR({
    channel: t,
    ...
    embeddedActivity: D
  } = (0, ee.Z)(p), x = eC(D), M = null != w && 0 === h.length ? [w] : h, k = M.length > 0, j = M.length >= 2, [G, V] = i.useState(!k), F = z.ZP.getName(null == t ? void 0 : t.guild_id, null == t ? void 0 : t.id, n), Z = null != t && E ? ec.intl.formatToPlainString(ec.t["8lzR/f"], {
    ...
    if (null != e) {
      if (W.default.track(el.rMx.CONTENT_POPOUT_EMOJI_CLICKED, {
        ...
        }), (0, I.EW)(u.z.CONTENT_INVENTORY_ONE_CLICK_REPLY_COACHTIP), N(!0), R(!1), E) l()(null != t, "shareToChannelMode should only be true if a valid channel is passed"), r = t;
      else {
        var i;
    ...
    if (null == O || O.focus(), (0, L.Io)("ContentPopout Reactor")) await (0, $.p)({
      channel: n,
      content: t,
      entry: p,
      whenReady: s
      ...
      l()(null != e, "Reaction image must be defined"), await (0, y.B)({
        file: e,
        channel: n,
        altText: o,
        reply: t
  ...
  return i.useEffect(() => {
    ...
    children: [(0, r.jsx)(eo.Z, {
      ...
      children: [(0, r.jsx)(b.A7, {
        ...
        renderAttachButton: T ? () => (0, r.jsx)(f.ua7, {
          text: H,
          children: e => (0, r.jsx)(f.P3F, ep(ef({}, e), {
            className: eu.shareToChannelButton,
            onClick: () => v(e => !e),
            children: E ? (0, r.jsx)(f.VL1, {
              size: "custom",
              width: 20,
              height: 20
            }) : (0, r.jsx)(f.lOy, {
...
let eO = e => {
  ...
  let s = !!g.Z.keyboardModeEnabled && !a,
    l = (0, S.wC)(null == t ? void 0 : t.guild_id).slice(0, 5).map(e => null == e.id ? {
      emoji: e,
      url: e.url
    } : {
      emoji: e,
...
function eI(e) {
  ...
  } = (0, et.Z)(i, 3), h = (0, c.e7)([Z.default], () => Z.default.getUser(i.author_id)), {
    streamPreviewUrl: m
...
function eN(e) {
  var {
    ...
    children: n,
    className: i
  } = e, a = eh(e, ["IconComponent", "children", "className"]);
  return (0, r.jsx)(f.zxk, ep(ef({}, a), {
...
function eR(e) {
  ...
  } = (0, D.Z)(null == t ? void 0 : t.id), u = (0, c.e7)([G.Z], () => null != s ? G.Z.getGuild(s.guild_id) : void 0), _ = (0, c.Wu)([Y.ZP], () => null != s ? Y.ZP.getVoiceStatesForChannel(s) : [], [s]), h = (0, c.e7)([H.Z], () => H.Z.isInChannel(null == s ? void 0 : s.id)), m = i.useMemo(() => {
    for (let e of _) {
    ...
    voiceBar: (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(y, {
          ...
          children: e => (0, r.jsxs)(f.P3F, ep(ef({}, e), {
