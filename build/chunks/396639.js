...
let L = e => {
  ...
  F = e => {
    var {
      ...
      submitting: s,
      onClick: i
    } = e, l = R(e, ["orbBalance", "orbPriceAmount", "submitting", "onClick"]);
    ...
    return null === r ? (0, n.jsx)(o.ua7, {
      ...
      children: e => (0, n.jsx)(o.zxk, W(B({}, e, c), {
        disabled: !0
      }))
  ...
  U = e => {
    ...
    }), i = s[r], l = (0, u.ed)("OrbCheckoutPurchaseDetails");
  ...
  M = e => {
    ...
    if (null == t) return;
    let r = "";
    return r = t.code === c.SM.VIRTUAL_CURRENCY_INSUFFICIENT_BALANCE ? T.NW.string(T.t.keFvXF) : t.code === c.SM.ALREADY_PURCHASED ? T.NW.string(T.t.m371Mz) : T.NW.string(T.t.fqJZ19), (0, n.jsx)("div", {
  ...
  X = e => {
    ...
    } = (0, _.C)(), y = (0, I.c)(), f = (0, s.useRef)(y), g = (0, i.e7)([v.default], () => N.ZP.canUseCollectibles(v.default.getCurrentUser()));
    (0, s.useEffect)(() => {
      l === h.A.COMPLETED && t()
    }, [l, t]);
  ...
  V = e => {
    ...
    } = e, o = R(e, ["skuId", "loadId", "onCheckoutSuccess", "analyticsLocations"]);
