...
function et(e) {
  let {
    ...
    disabled: l,
    shouldShowUpsell: a
  } = e, o = e => l || a && [D.g.HOLOGRAPHIC, D.g.GRADIENT].includes(e), d = ei(z.intl.string(z.t.Mi9KbW)), h = (0, f.ZP)(), b = (0, O.oC)(n, t), j = {
    dark: {
      src: Y,
      name: t.name
    },
...
function el(e) {
  ...
  let {
  ...
  } = e, u = ei(z.intl.string(z.t.Mi9KbW)), p = {
    ...
    src: K,
    name: a.name
  }, x = (0, O.oC)(o, a), b = (0, _.Q3)("RolePreview") ? [B.BRd.DARK, B.BRd.DARKER, B.BRd.MIDNIGHT, B.BRd.LIGHT] : [B.BRd.DARK, B.BRd.LIGHT];
  return (0, r.jsx)(g.Rny, {
    children: (0, r.jsx)("div", {
      className: s()(W.previewContainer, {
        [W.disableInteraction]: d
      }),
      "aria-hidden": !0,
      children: b.map(e => (0, r.jsx)(g.f6W, {
        ...
        children: t => (0, r.jsxs)("div", {
          ...
          }), e === B.BRd.LIGHT && c !== D.g.SOLID && (0, r.jsx)(g.Text, {
            variant: "text-xs/medium",
...
function ea(e) {
  ...
  } = e, a = (0, E.Z)(t.id, "GuildSettingsRolesEditDisplay"), o = (0, d.e7)([D.Z], () => D.Z.getRoleStyleData(n.id)), c = null != o && a ? o.currentStyle : D.g.SOLID, u = (0, I.Ek)(t.id, "GuildSettingsRolesEditDisplay") && !t.hasFeature(B.oNc.ENHANCED_ROLE_COLORS), m = (0, b.pM)(null == t ? void 0 : t.id, n.id), p = i || m, f = (0, d.e7)([w.Z], () => w.Z.canImpersonateRole(t, n)), {
    headerHeight: h,
    headerRef: x
  } = (0, k.Z)(0), {
    scrolledToTop: j,
