...
function et(e) {
  let {
    ...
    disabled: s,
    shouldShowUpsell: a
  } = e, o = e => s || a && [D.g.HOLOGRAPHIC, D.g.GRADIENT].includes(e), d = ei(F.NW.string(F.t.Mi9KbW)), f = (0, h.ZP)(), x = (0, _.oC)(n, t), b = {
    dark: {
      src: Y,
      name: t.name
    },
  ...
  return (0, r.jsxs)(g.xJW, {
    children: [(0, r.jsxs)(g.vwX, {
      ...
      children: [(0, r.jsx)("div", {
        children: F.NW.string(F.t["9wVJRE"])
      }), (0, r.jsx)(N.ZP, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(g.Text, {
          ...
          children: F.NW.format(z.Z.VpEDJS, {
            magical: (0, r.jsx)(en, {})
          })
        }), (0, r.jsx)(g.Text, {
  ...
  let e = (0, d.e7)([f.Z], () => f.Z.useReducedMotion),
    {
      text: t,
      gradient: n
    } = (0, g.JUn)((0, c.Rf)(B.SK.primary_color), (0, c.Rf)(B.SK.secondary_color), (0, c.Rf)(B.SK.tertiary_color), e, "username");
  return (0, r.jsx)("span", {
...
function es(e) {
  ...
  let {
  ...
  } = e, d = ei(F.NW.string(F.t.Mi9KbW)), u = {
    nick: d.author.username,
    colorStrings: {
    ...
    src: K,
    name: a.name
  }, f = (0, _.oC)(o, a), x = (0, j.Q3)("RolePreview") ? [U.BRd.LIGHT, U.BRd.DARK, U.BRd.DARKER, U.BRd.MIDNIGHT] : [U.BRd.LIGHT, U.BRd.DARK];
  return (0, r.jsx)(g.Rny, {
    children: (0, r.jsx)("div", {
      className: l()(H.previewContainer, {
        [H.disableInteraction]: c
      }),
      "aria-hidden": !0,
...
function ea(e) {
  ...
  } = e, a = (0, S.Z)(t.id, "GuildSettingsRolesEditDisplay"), o = (0, d.e7)([D.Z], () => D.Z.getRoleStyleData(n.id)), c = null != o && a ? o.currentStyle : D.g.SOLID, u = (0, I.Ek)(t.id, "GuildSettingsRolesEditDisplay") && (0, y.QZ)("GuildSettingsRolesEditDisplay") && !(0, y.OC)(t.id, "GuildSettingsRolesEditDisplay"), m = (0, x.pM)(null == t ? void 0 : t.id, n.id), p = i || m, h = (0, d.e7)([w.Z], () => w.Z.canImpersonateRole(t, n)), {
    headerHeight: f,
    headerRef: b
  } = (0, A.Z)(0), {
    scrolledToTop: j,
  ...
  return (0, r.jsx)(g.yWw, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)("div", {
        className: l()(V.header, V.stickyHeader, {
          [V.stickyHeaderElevated]: !j
        }),
        ref: b,
        ...
        className: H.divider
      }), (a || u) && null != c && (0, r.jsx)(et, {
        role: n,
        guildId: t.id,
        selectedStyle: c,
        disabled: p,
        shouldShowUpsell: u
      }), c !== D.g.HOLOGRAPHIC && null != c && (0, r.jsx)(er, {
        role: n,
        disabled: p,
        currentStyle: c,
        hasEnhancedRoleColors: a
      }), c === D.g.HOLOGRAPHIC && (0, r.jsx)(T.Z, {
