...
function ee(e) {
  let {
    ...
    disabled: l,
    shouldShowUpsell: a
  } = e, o = e => l || a && [Z.g.HOLOGRAPHIC, Z.g.GRADIENT].includes(e), d = er(F.intl.string(F.t.Mi9KbW)), x = (0, h.ZP)(), j = (0, O.oC)(n, t), _ = {
    dark: {
      src: W,
      name: t.name
    },
...
function ei(e) {
  ...
  let {
  ...
  } = e, u = er(F.intl.string(F.t.Mi9KbW)), g = {
    ...
    src: Y,
    name: a.name
  }, x = (0, O.oC)(o, a), b = [U.BRd.DARK, U.BRd.DARKER, U.BRd.MIDNIGHT, U.BRd.LIGHT];
  return (0, r.jsx)(p.Rny, {
    children: (0, r.jsx)("div", {
      ...
      "aria-hidden": !0,
      children: b.map(e => (0, r.jsx)(p.f6W, {
        theme: e,
        ...
        children: t => (0, r.jsxs)("div", {
          ...
          }), e === U.BRd.LIGHT && c !== Z.g.SOLID && (0, r.jsx)(p.Text, {
            variant: "text-xs/medium",
...
function es(e) {
  ...
  } = e, a = (0, I.yH)(t.id, n), o = (0, d.e7)([Z.Z], () => Z.Z.getRoleStyleData(n.id)), c = null != o && a ? o.currentStyle : Z.g.SOLID, u = !a, m = (0, j.pM)(null == t ? void 0 : t.id, n.id), g = i || m, f = (0, d.e7)([P.Z], () => P.Z.canImpersonateRole(t, n)), {
    headerHeight: h,
    headerRef: x
  } = (0, D.Z)(0), {
    scrolledToTop: b,
