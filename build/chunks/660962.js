...
function ee(e) {
  let {
    ...
    disabled: l,
    shouldShowUpsell: a
  } = e, o = e => l || a && [Z.g.HOLOGRAPHIC, Z.g.GRADIENT].includes(e), d = er(F.intl.string(F.t.Mi9KbW)), h = (0, f.ZP)(), b = (0, v.oC)(n, t), j = {
    dark: {
      src: V,
      name: t.name
    },
  ...
  return (0, r.jsxs)(g.xJW, {
    children: [(0, r.jsxs)(g.vwX, {
      ...
      children: [(0, r.jsx)("div", {
        children: F.intl.string(F.t["9wVJRE"])
      }), (0, r.jsx)(_.ZP, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(g.Text, {
          ...
          children: F.intl.format(z.default.VpEDJS, {
            magical: (0, r.jsx)(et, {})
          })
        }), (0, r.jsx)(g.Text, {
...
function er(e) {
  return i.useMemo(() => {
    ...
    return r.author = new T.Z({
      id: "313337",
      username: F.intl.string(F.t.cqpybG),
      discriminator: "0000",
      bot: !1
    }), r.author.getAvatarURL = () => K.Z, r
  }, [e])
}
...
function ei(e) {
  ...
  let {
  ...
  } = e, u = er(F.intl.string(F.t.Mi9KbW)), p = {
    ...
    src: Y,
    name: a.name
  }, x = (0, v.oC)(o, a), b = [U.BRd.DARK, U.BRd.DARKER, U.BRd.MIDNIGHT, U.BRd.LIGHT];
  return (0, r.jsx)(g.Rny, {
    children: (0, r.jsx)("div", {
      className: s()(H.previewContainer, {
        [H.disableInteraction]: d
      }),
      "aria-hidden": !0,
      children: b.map(e => (0, r.jsx)(g.f6W, {
        ...
        children: t => (0, r.jsxs)("div", {
          ...
          }), e === U.BRd.LIGHT && c !== Z.g.SOLID && (0, r.jsx)(g.Text, {
            variant: "text-xs/medium",
...
function es(e) {
  ...
  } = e, a = (0, I.Z)(t.id, "GuildSettingsRolesEditDisplay"), o = (0, d.e7)([Z.Z], () => Z.Z.getRoleStyleData(n.id)), c = null != o && a ? o.currentStyle : Z.g.SOLID, u = (0, N.Ek)(t.id, "GuildSettingsRolesEditDisplay") && !t.hasFeature(U.oNc.ENHANCED_ROLE_COLORS), m = (0, b.pM)(null == t ? void 0 : t.id, n.id), p = i || m, f = (0, d.e7)([P.Z], () => P.Z.canImpersonateRole(t, n)), {
    headerHeight: h,
    headerRef: x
  } = (0, D.Z)(0), {
    scrolledToTop: j,
  ...
  return (0, r.jsx)(g.yWw, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)("div", {
        className: s()(W.header, W.stickyHeader, {
          [W.stickyHeaderElevated]: !j
        }),
        ref: x,
        ...
        className: H.divider
      }), (a || u) && null != c && (0, r.jsx)(ee, {
        role: n,
        guildId: t.id,
        selectedStyle: c,
        disabled: p,
        shouldShowUpsell: u
      }), c !== Z.g.HOLOGRAPHIC && null != c && (0, r.jsx)(en, {
        role: n,
        disabled: p,
        currentStyle: c,
        hasEnhancedRoleColors: a
      }), c === Z.g.HOLOGRAPHIC && (0, r.jsx)(S.Z, {
