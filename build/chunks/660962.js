...
function en(e) {
  let {
    ...
    disabled: l,
    shouldShowUpsell: a
  } = e, o = e => l || a && [k.g.HOLOGRAPHIC, k.g.GRADIENT].includes(e), u = el(H.intl.string(H.t.Mi9KbW)), f = (0, h.ZP)(), b = (0, O.oC)(n, t), j = {
    dark: {
      src: K,
      name: t.name
    },
    ...
    children: [(0, r.jsxs)(g.vwX, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(g.Text, {
          ...
          children: H.intl.format(W.default.VpEDJS, {
            magical: (0, r.jsx)(er, {})
          })
        }), (0, r.jsx)(g.Text, {
...
function el(e) {
  return i.useMemo(() => {
    ...
    return r.author = new w.Z({
      id: "313337",
      username: H.intl.string(H.t.cqpybG),
      discriminator: "0000",
      bot: !1
    }), r.author.getAvatarURL = () => q.Z, r
  }, [e])
}
...
function es(e) {
  ...
  let {
    ...
    src: X,
    name: a.name
  }, f = (0, O.oC)(o, a), x = (0, _.Q3)("RolePreview") ? [F.BRd.LIGHT, F.BRd.DARK, F.BRd.DARKER, F.BRd.MIDNIGHT] : [F.BRd.LIGHT, F.BRd.DARK];
...
function eo(e) {
  ...
  } = e, a = (0, T.Z)(t.id, "GuildSettingsRolesEditDisplay"), o = (0, u.e7)([k.Z], () => k.Z.getRoleStyleData(n.id)), c = null != o && a ? o.currentStyle : k.g.SOLID, d = (0, E.Ek)(t.id, "GuildSettingsRolesEditDisplay") && (0, I.QZ)("GuildSettingsRolesEditDisplay") && !(0, I.OC)(t.id, "GuildSettingsRolesEditDisplay"), m = (0, b.pM)(null == t ? void 0 : t.id, n.id), p = i || m, h = (0, u.e7)([R.Z], () => R.Z.canImpersonateRole(t, n)), {
    headerHeight: f,
    headerRef: x
  } = (0, A.Z)(0), {
    scrolledToTop: j,
  ...
  return (0, r.jsx)(g.yWw, {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)("div", {
        className: s()(Y.header, Y.stickyHeader, {
          [Y.stickyHeaderElevated]: !j
        }),
        ref: x,
        ...
        className: V.divider
      }), (a || d) && null != c && (0, r.jsx)(en, {
        role: n,
        guildId: t.id,
        selectedStyle: c,
        disabled: p,
        shouldShowUpsell: d
      }), c !== k.g.HOLOGRAPHIC && null != c && (0, r.jsx)(ei, {
        role: n,
        disabled: p,
        currentStyle: c,
        hasEnhancedRoleColors: a
      }), c === k.g.HOLOGRAPHIC && (0, r.jsx)(P.Z, {
