...
function ee(e) {
  let {
    ...
    disabled: l,
    shouldShowUpsell: a
  } = e, o = e => l || a && [Z.g.HOLOGRAPHIC, Z.g.GRADIENT].includes(e), d = er(F.intl.string(F.t.Mi9KbW)), h = (0, x.ZP)(), b = (0, C.oC)(n, t), _ = {
    dark: {
      src: W,
      name: t.name
    },
    ...
    children: [(0, r.jsxs)(p.vwX, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(p.Text, {
          ...
          children: F.intl.format(H.default.VpEDJS, {
            magical: (0, r.jsx)(et, {})
          })
        }), (0, r.jsx)(p.Text, {
...
function ei(e) {
  ...
  let {
    ...
    src: Y,
    name: a.name
  }, x = (0, C.oC)(o, a), b = [U.BRd.DARK, U.BRd.DARKER, U.BRd.MIDNIGHT, U.BRd.LIGHT];
  return (0, r.jsx)(p.Rny, {
    children: (0, r.jsx)("div", {
      className: s()(z.previewContainer, {
        [z.disableInteraction]: d
      }),
      "aria-hidden": !0,
...
function es(e) {
  ...
  } = e, a = (0, E.yH)(t.id, n), o = (0, d.e7)([Z.Z], () => Z.Z.getRoleStyleData(n.id)), c = null != o && a ? o.currentStyle : Z.g.SOLID, u = !a, m = (0, _.pM)(null == t ? void 0 : t.id, n.id), g = i || m, f = (0, d.e7)([w.Z], () => w.Z.canImpersonateRole(t, n)), {
    headerHeight: h,
    headerRef: x
  } = (0, D.Z)(0), {
    scrolledToTop: b,
