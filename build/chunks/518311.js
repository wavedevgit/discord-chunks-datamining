...
function eb(e) {
  ...
  return (0, i.jsxs)(P.Z, {
    ...
    children: [(0, i.jsx)("div", {
      className: s()(ea.errorStateIcon, eo.marginBottom20)
    }), n]
  })
}
let ey = e => {
    ...
    let {
      channel: n,
      onClose: r
    } = e, a = null != (t = (0, R.ZP)(n)) ? t : "", o = (0, f.e7)([H.ZP], () => {
      var e;
  ...
  eO = e => {
    ...
    return (0, i.jsxs)(p.ConfirmModal, eu(el({
      ...
      children: [(0, i.jsx)(p.Text, {
        ...
        children: a.filter(X.lm).sort((e, t) => {
          var n, r;
...
class ev extends(r = a.PureComponent) {
  ...
  componentDidMount() {
    ...
    let t = (0, N.v_)(e);
    z.default.track(er.rMx.OPEN_POPOUT, eu(el({}, t), {
      type: this._getAnalyticsEntryPoint().entryPointType,
      source: this._getAnalyticsEntryPoint().entryPointSource,
      is_friend: !this.isNotFriends()
    })), $.S.subscribe(er.CkL.SCROLL_PAGE_UP, this.scrollPageUp), $.S.subscribe(er.CkL.SCROLL_PAGE_DOWN, this.scrollPageDown)
  }
  ...
  renderCreateGroupButton() {
    let {
      channel: e,
      selectedUsers: t
    } = this.props, n = this.getRemaining(), r = null != e && 0 === t.size || n < 0, a = t.size > 1 || null != e ? ei.intl.string(ei.t.ZGMNAw) : ei.intl.string(ei.t["6Urw1t"]);
  ...
  renderSubtitle() {
    ...
    return (0, i.jsx)(p.Text, {
      ...
      className: s()(ea.subtitle, {
        [ea.subtitleWarning]: e < 0
      }, eo.marginTop4),
      children: t
    })
  }
  ...
  renderHeader() {
    ...
    return (0, i.jsxs)(p.xBx, {
      ...
      className: ea.header,
      separator: e,
      children: [d.tq ? this.renderMobileCloseButton() : null, (0, i.jsx)(p.X6q, {
        id: em,
        variant: "heading-lg/semibold",
        children: t
      }), this.renderSubtitle(), (0, i.jsx)(p.olH, {
  ...
  renderBody() {
    ...
    return t ? this.isPartyFull() ? (0, i.jsxs)(eb, {
  ...
  renderFooter() {
    ...
    if (null == t) return (0, i.jsxs)(p.mzw, {
      className: ea.footer,
      children: [n.size > 1 && (0, i.jsx)(eI, {
    ...
    if (null != r) return (0, i.jsx)(p.mzw, {
      className: ea.footer,
      children: r
    })
  }
  ...
  constructor(...e) {
    super(...e), es(this, "state", {
      ...
      newChannelName: "",
      previewIcon: void 0
    }), es(this, "copyTimeout", void 0), es(this, "scrollerRef", a.createRef()), es(this, "searchBarRef", a.createRef()), es(this, "_mobileCloseRef", a.createRef()), es(this, "_searchCounter", 0), es(this, "_existingTimeout", null), es(this, "scrollPageUp", () => {
      var e;
      ...
      let {
        user: c,
        comparator: u
      } = l, d = a.has(c.id), f = !d && 0 >= this.getRemaining();
      return (0, i.jsx)(en.Z, {
        row: n,
        user: c,
        hideDiscriminator: s,
...
function eS(e) {
  ...
  let {
    ...
    location: m
  } = e, g = null != l ? l : null == r ? p.kL_ : p.ejJ, E = (0, L.a)(m), b = "channel-invite-modal-".concat(null == r ? void 0 : r.id), y = (0, p.VXO)(b), O = a.useCallback(() => (0, p.ZDy)(() => Promise.resolve(e => (0, i.jsx)(eT, eu(el({}, e), {
    channel: r,
    inBornThisNamedExperiment: E
  }))), {
    modalKey: b
  }), [r, b, E]), v = a.useRef(null), [I, S] = a.useState(null != r && r.isGroupDM() && 0 === r.recipients.length), A = a.useCallback(() => {
    let e = () => y ? (0, p.Mr3)(b) : O(),
      t = () => S(e => !e);
    return E ? e() : t()
  }, [E, y, b, O]);
  a.useEffect(() => (h && $.S.subscribe(er.CkL.TOGGLE_DM_CREATE, A), () => {
    $.S.unsubscribe(er.CkL.TOGGLE_DM_CREATE, A)
  }), [h, A, E]);
  let N = (0, f.e7)([K.default], () => K.default.getUser(null == r ? void 0 : r.getRecipientId())),
    C = e => (0, i.jsx)(eT, eu(el({}, e), {
  ...
  return ((0, T.ZP)(() => {
    (0, M._)()
  }), null != (t = null == N ? void 0 : N.bot) && t || null != (n = null == N ? void 0 : N.isProvisional) && n) ? null : E ? (0, i.jsx)(et.ZP.Icon, {
    ref: v,
    onClick: O,
    icon: g,
    className: s,
...
function eA(e) {
  ...
  let o = (0, L.a)("PrivateChannelRecipientsInviteTextButton"),
    ...
    d = e => (0, i.jsx)(eT, eu(el({}, e), {
      onClose: e.closePopout,
      channel: t,
      inBornThisNamedExperiment: o
    })),
    f = a.useCallback(() => (0, p.ZDy)(() => Promise.resolve(e => (0, i.jsx)(eT, eu(el({}, e), {
      channel: t,
      inBornThisNamedExperiment: o
    })))), [t, o]);
  return o ? (0, i.jsx)(p.zxk, {
    onClick: f,
    variant: "primary",
    buttonRef: s,
    ...
    ignoreModalClicks: !0,
    clickTrap: !0,
    children: e => (0, i.jsx)(p.zxk, eu(el({}, e), {
      onClick: u,
      variant: "primary",
      buttonRef: s,
      text: ei.intl.string(ei.t["6Qgren"]),
