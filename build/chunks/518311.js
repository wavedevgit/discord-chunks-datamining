...
function ep(e) {
  ...
  return (0, i.jsxs)(N.Z, {
    ...
    children: [(0, i.jsx)("div", {
      className: a()(ei.errorStateIcon, el.marginBottom20)
    }), n]
  })
}
let eh = e => {
    ...
    let {
      channel: n,
      onClose: r
    } = e, l = null != (t = (0, Z.ZP)(n)) ? t : "", o = (0, p.e7)([G.ZP], () => {
      var e;
  ...
  ef = e => {
    var {
      onConfirm: t,
      channelIds: n
    } = e, r = ec(e, ["onConfirm", "channelIds"]);
    let l = (0, p.Wu)([U.Z], () => Array.from(n).map(U.Z.getChannel), [n]);
    return (0, i.jsxs)(h.ConfirmModal, es(ea({
      ...
      children: [(0, i.jsx)(h.Text, {
        ...
        children: l.filter(X.lm).sort((e, t) => {
          var n, r;
...
class em extends(r = l.PureComponent) {
  ...
  componentDidMount() {
    ...
    let t = (0, S.v_)(e);
    Y.default.track(en.rMx.OPEN_POPOUT, es(ea({}, t), {
      type: this._getAnalyticsEntryPoint().entryPointType,
      source: this._getAnalyticsEntryPoint().entryPointSource,
      is_friend: !this.isNotFriends()
    })), K.S.subscribe(en.CkL.SCROLL_PAGE_UP, this.scrollPageUp), K.S.subscribe(en.CkL.SCROLL_PAGE_DOWN, this.scrollPageDown)
  }
  ...
  renderCreateGroupButton() {
    let {
      channel: e,
      selectedUsers: t
    } = this.props, n = this.getRemaining(), r = null != e && 0 === t.size || n < 0, l = t.size > 1 || null != e ? er.intl.string(er.t.ZGMNAw) : er.intl.string(er.t["6Urw1t"]);
  ...
  renderSubtitle() {
    ...
    let e = this.getRemaining(),
      t = e <= 0 ? er.intl.formatToPlainString(er.t.xYr009, {
        number: this.getMaxParticipants()
      }) : er.intl.formatToPlainString(er.t.HrSDPD, {
        number: e
      });
    return (0, i.jsx)(h.Text, {
      variant: "text-xs/normal",
      className: a()(ei.subtitle, {
  ...
  renderSearchBar() {
    ...
    return o.forEach(e => {
      ...
      children: [(0, i.jsx)(v.ZP, {
        ...
        autoFocus: !0,
        placeholder: 0 === o.size ? er.intl.string(er.t.Wxnb6u) : "",
  ...
  renderHeader() {
    ...
    return (0, i.jsxs)(h.xBx, {
      ...
      className: ei.header,
      separator: e,
      children: [d.tq ? this.renderMobileCloseButton() : null, (0, i.jsx)(h.X6q, {
        id: eu,
        variant: "heading-lg/semibold",
        children: t
      }), this.renderSubtitle(), (0, i.jsx)(h.olH, {
  ...
  renderBody() {
    ...
    if (this.isNotFriends()) {
      ...
      return (0, i.jsxs)(ep, {
        ...
        children: [(0, i.jsx)(h.Text, {
          ...
          children: er.intl.format(er.t["eg+R9/"], {
            username: r
          })
        }), (0, i.jsx)(h.zxk, {
          disabled: l,
    ...
    return t ? this.isPartyFull() ? (0, i.jsxs)(ep, {
      className: ei.partyFull,
      children: [(0, i.jsx)("div", {
        children: er.intl.string(er.t.OtTQDw)
      }), (0, i.jsx)("div", {
        children: er.intl.format(er.t.xYr009, {
          number: this.getMaxParticipants()
        })
      })]
    }) : 0 === n.length ? (0, i.jsx)(ep, {
      className: a()(ei.noResults, el.marginBottom20),
      children: (0, i.jsx)("div", {
        children: er.intl.string(er.t.SV4DJy)
      })
    }) : (0, i.jsx)(h.aVo, {
      ...
      children: [(0, i.jsx)("div", {
        children: er.intl.string(er.t["7orY6O"])
      }), (0, i.jsx)(h.zxk, {
        autoFocus: !0,
        fullWidth: !0,
        size: h.zxk.Sizes.SMALL,
  ...
  renderInviteLink() {
    ...
    return (0, i.jsxs)(l.Fragment, {
      children: [(0, i.jsx)(h.vwX, {
        ...
        value: s ? n ? er.intl.string(er.t["6HzNgY"]) : o : "",
      ...
      }), o.length > 0 ? (0, i.jsx)(h.Text, {
        variant: "text-xs/normal",
        className: a()(el.marginTop8, ei.footerText),
        children: er.intl.format(er.t.ZVdJMz, {
          numHours: "".concat(24)
        })
      }) : null]
    })
  ...
  renderFooter() {
    ...
    if (null == t) return (0, i.jsxs)(h.mzw, {
      className: ei.footer,
      children: [n.size > 1 && (0, i.jsx)(eg, {
    ...
    if (null != r) return (0, i.jsx)(h.mzw, {
      className: ei.footer,
      children: r
    })
  }
  ...
  constructor(...e) {
    super(...e), eo(this, "state", {
      ...
      newChannelName: "",
      previewIcon: void 0
    }), eo(this, "copyTimeout", void 0), eo(this, "scrollerRef", l.createRef()), eo(this, "searchBarRef", l.createRef()), eo(this, "_mobileCloseRef", l.createRef()), eo(this, "_searchCounter", 0), eo(this, "_existingTimeout", null), eo(this, "scrollPageUp", () => {
      var e;
      ...
      y.Z.search(e, null == t ? void 0 : t.id), null != this._existingTimeout && clearTimeout(this._existingTimeout), this._existingTimeout = setTimeout(() => {
        Y.default.track(en.rMx.SEARCH_USER_LIST_STARTED, es(ea({}, n), {
      ...
      let t = this._searchCounter,
        ...
        r = (0, S.v_)(n),
        i = !0;
      1 === e.length && (i = null == g.Z._openCachedDMChannel(e[0])), Y.default.track(en.rMx.CREATE_DM_USER_LIST_CLICKED, es(ea({}, r), {
        is_new_dm: i,
        entry_point_type: this._getAnalyticsEntryPoint().entryPointType,
        entry_point_source: this._getAnalyticsEntryPoint().entryPointSource,
        recipient_ids: e,
        ...
        let t = {};
        "" !== this.state.newChannelName && (t.name = this.state.newChannelName), null != this.state.previewIcon && (t.icon = this.state.previewIcon), (null != t.name || null != t.icon) && g.Z.updateChannel(e, t, E.Z.NEW_GROUP_DM_INVITE_MODAL), Y.default.track(en.rMx.GDM_EDIT_INTERACTED, {
          channel_id: e,
      ...
      }), Y.default.track(en.rMx.CREATE_DM_USER_LIST_CLICKED, es(ea({}, r), {
        is_new_dm: !0,
        entry_point_type: this._getAnalyticsEntryPoint().entryPointType,
        entry_point_source: this._getAnalyticsEntryPoint().entryPointSource,
        recipient_ids: t,
      ...
      }, 1e3), Y.default.track(en.rMx.COPY_INSTANT_INVITE, {
        server: null,
...
function eg(e) {
  ...
  } = (0, I.ZP)(E.Z.NEW_GROUP_DM_INVITE_MODAL);
...
function eb(e) {
  ...
  let r = (0, p.cj)([F.Z, B.Z, z.Z], () => {
    let e;
    return null != t && null != (e = B.Z.getInvite(t.id)) && e.isExpired() && (e = null), es(ea({}, F.Z.getState()), {
      invite: e,
      hideDiscriminator: z.Z.hidePersonalInformation,
      hideInstantInvites: z.Z.hideInstantInvites
    })
  });
  return (0, i.jsx)(em, ea({
    channel: t
  }, n, r))
}
...
function e_(e) {
  ...
  let {
    ...
    location: g
  } = e, b = null != s ? s : null == r ? h.kL_ : h.ejJ, _ = (0, A.a)(g), y = "channel-invite-modal-".concat(null == r ? void 0 : r.id), C = (0, h.VXO)(y), x = l.useCallback(() => (0, h.ZDy)(() => Promise.resolve(e => (0, i.jsx)(eb, es(ea({}, e), {
    channel: r,
    inBornThisNamedExperiment: _
  }))), {
    modalKey: y
  }), [r, y, _]), v = l.useRef(null), [O, E] = l.useState(null != r && r.isGroupDM() && 0 === r.recipients.length), S = l.useCallback(() => _ ? C ? (0, h.Mr3)(y) : x() : E(e => !e), [_, C, y, x]);
  l.useEffect(() => (m && K.S.subscribe(en.CkL.TOGGLE_DM_CREATE, S), () => {
    K.S.unsubscribe(en.CkL.TOGGLE_DM_CREATE, S)
  }), [m, S, _]);
  let I = (0, p.e7)([W.default], () => W.default.getUser(null == r ? void 0 : r.getRecipientId()));
  return ((0, j.ZP)(() => {
    (0, M._)()
  }), null != (t = null == I ? void 0 : I.bot) && t || null != (n = null == I ? void 0 : I.isProvisional) && n) ? null : _ ? (0, i.jsx)(ee.ZP.Icon, {
    ref: v,
    onClick: x,
    icon: b,
    className: a,
    ...
    targetElementRef: v,
    renderPopout: e => (0, i.jsx)(eb, es(ea({}, e), {
    ...
    ignoreModalClicks: !0,
    clickTrap: !0,
    children: e => (0, i.jsx)(ee.ZP.Icon, es(ea({}, e), {
      ref: v,
      onClick: S,
      icon: b,
      className: a,
...
function ey(e) {
  ...
  let a = (0, A.a)("PrivateChannelRecipientsInviteTextButton"),
    ...
    p = l.useCallback(() => (0, h.ZDy)(() => Promise.resolve(e => (0, i.jsx)(eb, es(ea({}, e), {
      channel: t,
      inBornThisNamedExperiment: a
    })))), [t, a]);
  return a ? (0, i.jsx)(h.zxk, {
    onClick: p,
    ...
    ignoreModalClicks: !0,
    clickTrap: !0,
    children: e => (0, i.jsx)(h.zxk, es(ea({}, e), {
      look: h.zxk.Looks.OUTLINED,
      buttonRef: s,
      size: h.PhG.MEDIUM,
      onClick: d,
...
function eC(e) {
  let t = ex(e);
  return new Set((0, s.chain)(U.Z.getMutablePrivateChannels()).values().filter(e => (0, L.bc)(e.type)).filter(e => ex(e.recipients) === t).map(e => e.id).value())
}
