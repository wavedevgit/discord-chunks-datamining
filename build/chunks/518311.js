  ...
  renderHeader() {
    ...
    return (0, i.jsxs)(f.xBx, {
      ...
      children: [d.tq ? this.renderMobileCloseButton() : null, (0, i.jsx)(f.X6q, {
        ...
        children: t
      }), this.renderSubtitle(), (0, i.jsx)(f.olH, {
...
function ey(e) {
  ...
  let {
    ...
    location: g
  } = e, b = null != s ? s : null == r ? f.kL_ : f.ejJ, _ = (0, w.a)(g), y = "channel-invite-modal-".concat(null == r ? void 0 : r.id), C = (0, f.VXO)(y), x = l.useCallback(() => (0, f.ZDy)(() => Promise.resolve(e => (0, i.jsx)(e_, ec(es({}, e), {
    channel: r,
...
function eC(e) {
  ...
  let a = (0, w.a)("PrivateChannelRecipientsInviteTextButton"),
    ...
    d = l.useCallback(() => (0, f.ZDy)(() => Promise.resolve(e => (0, i.jsx)(e_, ec(es({}, e), {
      channel: t,
      inBornThisNamedExperiment: a
    })))), [t, a]);
  return a ? (0, i.jsx)(f.zxk, {
    onClick: d,
    variant: "primary",
    buttonRef: o,
...
function ex(e) {
  let t = ev(e);
  return new Set((0, s.chain)(B.Z.getMutablePrivateChannels()).values().filter(e => (0, U.bc)(e.type)).filter(e => ev(e.recipients) === t).map(e => e.id).value())
}
