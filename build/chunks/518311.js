...
let ef = e => {
    ...
    let {
      channel: n,
      onClose: r
    } = e, l = null != (t = (0, N.ZP)(n)) ? t : "", a = (0, h.e7)([V.ZP], () => {
      var e;
    ...
    return (0, i.jsx)(f.P3F, {
      ...
      children: (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(f.qEK, {
          ...
          children: d()(J.default.extractTimestamp(a)).fromNow()
        })]
      })
    })
  },
  em = e => {
    ...
    let l = (0, h.Wu)([B.Z], () => Array.from(n).map(B.Z.getChannel), [n]);
...
class eg extends(r = l.PureComponent) {
  ...
  getMaxParticipants() {
    let {
      channel: e
    } = this.props, t = Y.default.getCurrentUser();
  ...
  renderCreateGroupButton() {
    let {
      channel: e,
      selectedUsers: t
    } = this.props, n = this.getRemaining(), r = null != e && 0 === t.size || n < 0, l = t.size > 1 ? ei.intl.string(ei.t.ZGMNAw) : ei.intl.string(ei.t["6Urw1t"]);
  ...
  renderAddUsersButton() {
    ...
    return (0, i.jsx)("div", {
      ...
      children: (0, i.jsx)(f.zxk, {
        ...
        disabled: r,
        onClick: this.handleInviteUsers,
        children: ei.intl.string(ei.t.OYkgVl)
      })
    })
  }
  renderSubtitle() {
    ...
    let e = this.getRemaining(),
      t = e <= 0 ? ei.intl.formatToPlainString(ei.t.xYr009, {
        number: this.getMaxParticipants()
      }) : ei.intl.formatToPlainString(ei.t.HrSDPD, {
        number: e
      });
    return (0, i.jsx)(f.Text, {
      variant: "text-xs/normal",
      className: o()(el.subtitle, {
        [el.subtitleWarning]: e < 0
      }, ea.marginTop4),
      children: t
    })
  }
  renderSearchBar() {
    ...
    return a.forEach(e => {
      ...
      children: [(0, i.jsx)(j.ZP, {
        ...
        autoFocus: !0,
        placeholder: 0 === a.size ? ei.intl.string(ei.t.Wxnb6u) : void 0,
    ...
    if (this.isNotFriends()) {
      ...
      return (0, i.jsxs)(eh, {
        ...
        children: [(0, i.jsx)(f.Text, {
          ...
          children: ei.intl.format(ei.t["eg+R9/"], {
            username: r
          })
        }), (0, i.jsx)(f.zxk, {
          disabled: l,
          ...
          children: l ? ei.intl.string(ei.t.xMH6vL) : ei.intl.string(ei.t["PMsq/f"])
        })]
      })
    }
    return t ? this.isPartyFull() ? (0, i.jsxs)(eh, {
      className: el.partyFull,
      children: [(0, i.jsx)("div", {
        children: ei.intl.string(ei.t.OtTQDw)
      }), (0, i.jsx)("div", {
        children: ei.intl.format(ei.t.xYr009, {
          number: this.getMaxParticipants()
        })
      })]
    }) : 0 === n.length ? (0, i.jsx)(eh, {
      className: o()(el.noResults, ea.marginBottom20),
      children: (0, i.jsx)("div", {
        children: ei.intl.string(ei.t.SV4DJy)
      })
    }) : (0, i.jsx)(f.aVo, {
      ...
      children: [(0, i.jsx)("div", {
        children: ei.intl.string(ei.t["7orY6O"])
      }), (0, i.jsx)(f.zxk, {
        autoFocus: !0,
        fullWidth: !0,
        size: f.zxk.Sizes.SMALL,
        ...
        className: ea.marginTop20,
        children: ei.intl.string(ei.t.w5uwoK)
      })]
    })
  }
  renderSection() {
  ...
  renderInviteLink() {
    ...
    return (0, i.jsxs)(l.Fragment, {
      children: [(0, i.jsx)(f.vwX, {
        ...
        children: ei.intl.format(ei.t.ZVdJMz, {
          numHours: "".concat(24)
        })
      }) : null]
    })
  ...
  constructor(...e) {
    super(...e), eo(this, "state", {
      ...
      1 === e.length && (i = null == b.Z._openCachedDMChannel(e[0])), q.default.track(er.rMx.CREATE_DM_USER_LIST_CLICKED, ec(es({}, r), {
        ...
        "" !== this.state.newChannelName && b.Z.setName(e, this.state.newChannelName), null != this.state.previewIcon && b.Z.setIcon(e, this.state.previewIcon, I.Z.NEW_GROUP_DM_INVITE_MODAL), q.default.track(er.rMx.GDM_EDIT_INTERACTED, {
          channel_id: e,
          channel_type: er.d4z.GROUP_DM,
          location: I.Z.NEW_GROUP_DM_INVITE_MODAL,
...
function eb(e) {
  ...
  } = (0, S.ZP)(I.Z.NEW_GROUP_DM_INVITE_MODAL);
  if (!(0, w.a)(I.Z.NEW_GROUP_DM_INVITE_MODAL)) return null;
...
function e_(e) {
  ...
  let r = (0, h.cj)([F.Z, G.Z, W.Z], () => {
    let e;
    return null != t && null != (e = G.Z.getInvite(t.id)) && e.isExpired() && (e = null), ec(es({}, F.Z.getState()), {
      invite: e,
...
function ex(e) {
  ...
  let P = (0, h.e7)([Y.default], () => Y.default.getUser(null == r ? void 0 : r.getRecipientId()));
  return ((0, O.ZP)(() => {
    (0, L._)()
...
function eC(e) {
  ...
  return l.useCallback(() => (0, f.ZDy)(() => Promise.resolve(e => (0, i.jsx)(e_, ec(es({}, e), {
    channel: t
  })))), [t]), o && (f.zxk, f.zxk.Looks.OUTLINED, f.PhG.MEDIUM, ei.intl.string(ei.t["6Qgren"])), (0, i.jsx)(f.yRy, {
    targetElementRef: s,
    renderPopout: e => (0, i.jsx)(e_, ec(es({}, e), {
      onClose: e.closePopout,
      channel: t
    ...
    ignoreModalClicks: !0,
    clickTrap: !0,
    children: e => (0, i.jsx)(f.zxk, ec(es({}, e), {
...
function ey(e) {
  let t = ev(e);
  return new Set(c()(B.Z.getMutablePrivateChannels()).values().filter(e => (0, U.bc)(e.type)).filter(e => ev(e.recipients) === t).map(e => e.id).value())
}
