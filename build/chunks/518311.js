...
class ev extends(r = o.PureComponent) {
  ...
  componentWillUnmount() {
    X.S.unsubscribe(er.CkL.SCROLL_PAGE_UP, this.scrollPageUp), X.S.unsubscribe(er.CkL.SCROLL_PAGE_DOWN, this.scrollPageDown), null != this.copyTimeout && clearTimeout(this.copyTimeout), h.Z.wait(() => y.Z.close())
  }
  isNotFriends() {
    let {
      channel: e
  ...
  renderCreateGroupButton() {
    let {
      channel: e,
      selectedUsers: t
    } = this.props, n = this.getRemaining(), r = null != e && 0 === t.size || n < 0, o = t.size > 1 || null != e ? ei.intl.string(ei.t.ZGMNAw) : ei.intl.string(ei.t["6Urw1t"]);
  ...
  renderSubtitle() {
    ...
    return (0, i.jsx)(p.Text, {
      ...
      className: s()(eo.subtitle, {
        [eo.subtitleWarning]: e < 0
      }, ea.marginTop4),
      children: t
    })
  }
  ...
  constructor(...e) {
    super(...e), es(this, "state", {
      ...
      newChannelName: "",
      previewIcon: void 0
    }), es(this, "copyTimeout", void 0), es(this, "scrollerRef", o.createRef()), es(this, "searchBarRef", o.createRef()), es(this, "_mobileCloseRef", o.createRef()), es(this, "_searchCounter", 0), es(this, "_existingTimeout", null), es(this, "scrollPageUp", () => {
      var e;
...
function eS(e) {
  ...
  let {
    ...
    location: m
  } = e, g = null != l ? l : null == r ? p.kL_ : p.ejJ, E = (0, L.a)(m), b = "channel-invite-modal-".concat(null == r ? void 0 : r.id), y = (0, p.VXO)(b), O = o.useCallback(() => (0, p.ZDy)(() => Promise.resolve(e => (0, i.jsx)(eT, eu(el({}, e), {
    channel: r,
...
function eA(e) {
  ...
  let a = (0, L.a)("PrivateChannelRecipientsInviteTextButton"),
    ...
    f = o.useCallback(() => (0, p.ZDy)(() => Promise.resolve(e => (0, i.jsx)(eT, eu(el({}, e), {
      channel: t,
      inBornThisNamedExperiment: a
    })))), [t, a]);
  return a ? (0, i.jsx)(p.zxk, {
    onClick: f,
    variant: "primary",
    buttonRef: s,
