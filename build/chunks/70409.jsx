...
function u(e) {
  ...
  return <l.Z header={c.intl.string(c.t.zT9Sxc)} text={c.intl.formatToPlainString(c.t.OKqEAQ, {
      level: g,
      numAdditional: (0, a.Je)(g)
    })} headerColor={"header-primary"} textColor={"text-default"} buttonProps={h} guild={t} analyticsLocation={{
