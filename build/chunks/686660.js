...
function c(e) {
  return (0, r.EQ)(e).with("all_messages", () => o.NW.string(o.t.hZrr6u)).with("mentions", () => o.NW.string(o.t.y59NJi)).with("nothing", () => o.NW.string(o.t["pGn/bG"])).with("custom", () => o.NW.string(o.t["32yow8"])).exhaustive()
}