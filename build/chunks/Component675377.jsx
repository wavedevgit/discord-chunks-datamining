...
function Y(e) {
  ...
  let L = i.useCallback(() => {
      null != O && (0, N.openUserProfileModal)({
        userId: O.id,
        guildId: o.id,
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [P ? (0, r.jsx)(p.Z, {
      ...
      children: [(0, r.jsx)(m.P3F, {
        ...
        onClick: function(e) {
          e.stopPropagation(), (0, m.h7j)(e => (0, r.jsx)(m.ConfirmModal, U(M({
