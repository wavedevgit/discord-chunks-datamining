...
function p(e) {
  ...
  return <i.v2r navId={"progress-bar-context"} onClose={d.Zy} aria-label={u.intl.string(u.t["m85s/v"])} onSelect={s}><i.S89 id={"progress-bar-enabled"} label={u.intl.string(u.t["0CJWPz"])} checked={p} disabled={h} action={m} /></i.v2r>
}