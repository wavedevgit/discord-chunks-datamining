...
let eK = {},
  ...
  tE = !1,
  tb = !1;
q.Z.hasPermission(ey.Eu.AUDIO, {
  showAuthorizationError: !1
}), q.Z.hasPermission(ey.Eu.CAMERA, {
  showAuthorizationError: !1
});
let ty = !1,
  tO = new Set,
...
function tB() {
  eW.on(b.aB.Connection, e => {
    ...
    let o = ep.Z.getGuildId(),
      {
        ...
        skipEncode: c
      } = (null != o ? G.Z : U.Z).getCurrentConfig(eA({
    ...
    s && e.setExperimentFlag(eI.V8.MUTE_BEFORE_PROCESSING, !0), l && e.setExperimentFlag(eI.V8.PTT_BEFORE_PROCESSING, !0), c && e.setExperimentFlag(eI.V8.SKIP_ENCODE, !0), null != o && F.Z.getCurrentConfig({
      location: "setupMediaEngine",
      guildId: o
    }, {
      autoTrackExposure: !0
    ...
    e.on(b.Sh.Speaking, (t, n) => {
      ...
      (null == a ? void 0 : a.desktopSource) != null && en.default.track(eE.rMx.VIDEOHOOK_INITIALIZED, eA({
        backend: e,
        format: t,
...
function t4() {
  ...
  for (let e of Object.keys(r)) {
    ...
    for (let [e, t] of Object.entries(o)) null == (0, J.Ky)(i, e) && (t.muted ? s[e] = !0 : delete s[e], t.volume !== a ? l[e] = t.volume : delete l[e], eW.eachConnection(n => {
      n.setLocalVolume(e, t.volume), n.setLocalMute(e, t.muted)
    }, i));
    if (n)
      for (let e of new Set([...Object.keys(s), ...Object.keys(l)])) null == o[e] && (delete s[e], delete l[e], eW.eachConnection(t => {
...
function t8(e) {
  i = e.sessionId, e2 = !1, e5 = !1, (0, ea.isWeb)() || (H.Z.subscribe({
...
function nl(e) {
  ...
  if (I[c] === eE.ZUi.AUTO_PROBING && u === eE.ZUi.AUTO_ENABLED && (0, z.Z)(c, p ? eI.fC.AUTO_DISABLE : eI.fC.AUTO_ENABLE, E), I[c] = u, tz({
      videoToggleStateMap: I
    }, l, d), u === eE.ZUi.AUTO_PROBING ? null == (n = ep.Z.getRTCConnection()) || n.pauseStatsCollectionForUser(c, !0) : null == (r = ep.Z.getRTCConnection()) || r.pauseStatsCollectionForUser(c, !1), tv || (eR.info("isAutoDisableAllowed=".concat(tv, " - disabling VideoHealthManager")), null == (a = ep.Z.getRTCConnection()) || null == (i = a.getVideoHealthManager()) || i.disable()), O) {
    if (!p && !g || p && !tv) return;
...
async function nQ() {
  try {
    ...
    tc = !0, s = null == (e = a.getSdkVersion) ? void 0 : e.call(a), l = null != (i = null == (t = a.getSuppressionLevel) ? void 0 : t.call(a)) ? i : 100, null == (n = a.getNcModels) || n.call(a).then(e => {
      tu = e, r.emitChange()
    }), r.emitChange()
  } catch (t) {
...
function n$() {
  !nJ() || __OVERLAY__ || tl || tc ? (0, ea.isWeb)() && eW.supports(eI.AN.NOISE_CANCELLATION) ? (tc = !0, r.emitChange()) : (0, ea.isWeb)() && tz({
    noiseCancellation: !1
  }) : (tl = !0, nQ())
}
...
class ry extends(u = E.ZP.Store) {
  ...
  fetchAsyncResources() {
    ...
    return (0, ea.isWeb)() && (e.fetchDave = Z.N.getCurrentConfig({
