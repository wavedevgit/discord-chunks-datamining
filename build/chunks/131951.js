  ...
  ej.on(m.aB.Connection, e => {
    ...
    e.on(m.Sh.SoundshareTrace, e => {
      ...
      ey.warn("voiceactivitydetectorerror event: ".concat(e)), (0, N.kr)({
        ...
        mode: ed.pM4.VOICE_ACTIVITY,
        options: ev(eE({}, tb(eh.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: !1
        })
      }), b.Z.dispatch({
    ...
    (0, N.kr)(t === N.u.VIDEO_ENCODE_ERROR ? ev(eE({
      type: t
    }, n), {
...
function tK(e) {
  i = e.sessionId, eY = !1, eq = !1, (0, X.isWeb)() || (G.Z.subscribe({
    ...
    !e.sidechainAvailable && t.sidechainCompression ? (tx({
      sidechainCompressionSettingVersion: 0
    }), nf(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eN && (tx({
...
function t4(e) {
  ...
  v && !p && tc.delete(u), p ? h[u] = !0 : delete h[u], tx({
    disabledLocalVideos: h
...
function t9(e) {
  ...
  tx({
    mode: n,
    modeOptions: r
  }, t), ej.eachConnection(tv), tD.update()
}
