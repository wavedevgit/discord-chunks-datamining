...
let eG = {},
  ...
  eH = performance.now(),
  eW = {
    [eh.w5]: tB("No Input Devices")
  },
  eY = {
    [eh.w5]: tB("No Output Devices")
  },
  eK = {
    [eh.w5]: tB("No Video Devices")
  },
  ez = !1,
  eq = !1,
  eQ = !1,
...
function tq(e) {
  i = e.sessionId, ez = !1, eX = !1, (0, X.isWeb)() || (G.Z.subscribe({
    location: "handleConnectionOpen"
  }, e => {
    let t = tv();
    !e.sidechainAvailable && t.sidechainCompression ? (tk({
      sidechainCompressionSettingVersion: 0
    }), np(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eA && (tk({
      sidechainCompressionSettingVersion: eA
    }), np(e.sidechainEnabled))
  }), nm());
  let t = tv();
  tL() && (t.automaticAudioSubsystem && nH(), t.audioSubsystemSettingVersion < eC && (tk({
    audioSubsystemSettingVersion: eC
  }), t.automaticAudioSubsystem || eU.getAudioSubsystem() === eh.iA.LEGACY || nZ(eh.iA.AUTOMATIC))), (0, K.wt)({
    location: "MediaEngineStore",
    autoTrackExposure: !1
  }) && null !== t.mostRecentlyRequestedVoiceFilter && (0, Y.J_)(), tY()
}
...
function t6(e) {
  ...
  if (I[u] === ed.ZUi.AUTO_PROBING && d === ed.ZUi.AUTO_ENABLED && (0, F.Z)(u, p ? eh.fC.AUTO_DISABLE : eh.fC.AUTO_ENABLE, E), I[u] = d, tk({
      videoToggleStateMap: I
    }, l, f), d === ed.ZUi.AUTO_PROBING ? null == (n = es.ZP.getRTCConnection()) || n.pauseStatsCollectionForUser(u, !0) : null == (r = es.ZP.getRTCConnection()) || r.pauseStatsCollectionForUser(u, !1), tf || (ev.info("isAutoDisableAllowed=".concat(tf, " - disabling VideoHealthManager")), null == (o = es.ZP.getRTCConnection()) || null == (i = o.getVideoHealthManager()) || i.disable()), v) {
    if (!p && !g || p && !tf) return;
  ...
  y && !p && td.delete(u), p ? h[u] = !0 : delete h[u], tk({
    disabledLocalVideos: h
...
function nt(e) {
  ...
  tk({
    mode: n,
    modeOptions: r
  }, t), eU.eachConnection(tO), tx.update()
}
...
function ni(e) {
  ...
  t = tF(eW, t), eH = performance.now(), tk({
    inputDeviceId: t
  }), eU.setAudioInputDevice(t)
}
...
function nj() {
  !nk() || __OVERLAY__ || te || tt ? (0, X.isWeb)() && eU.supports(eh.AN.NOISE_CANCELLATION) ? (tt = !0, r.emitChange()) : (0, X.isWeb)() && tk({
    noiseCancellation: !1
  }) : (te = !0, nM())
}
...
function n$(e) {
  ...
  if ((null == o ? void 0 : o.desktopSettings) != null) {
    ...
    X.isPlatformEmbedded && !0 === a && ({
      soundshareId: e,
      soundshareSession: r
    } = tK(c), null != e && tz(e, r)), tT(s), tN(s === eh.Yn.STREAM && eJ, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
