...
function tR() {
  eU.on(m.aB.Connection, e => {
    ...
    e.on(m.Sh.SoundshareTrace, e => {
      ...
      ev.warn("noisecancellererror event: ".concat(e)), (0, N.kr)({
      ...
      ev.warn("voiceactivitydetectorerror event: ".concat(e)), (0, N.kr)({
        type: N.u.NOISE_CANCELLER_ERROR,
        underlyingError: tC(e)
        ...
        mode: ed.pM4.VOICE_ACTIVITY,
        options: ey(eE({}, tv(eh.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: !1
        })
      }), b.Z.dispatch({
...
function tk() {
  ...
  null != t && (g.K.set(eO, {
    [eh.Yn.DEFAULT]: t
  }), g.K.remove("audio")), eG = null != (e = g.K.get(eO)) ? e : {}, d().each(eG, e => {
...
function t8(e) {
  ...
  if (I[u] === ed.ZUi.AUTO_PROBING && d === ed.ZUi.AUTO_ENABLED && (0, F.Z)(u, p ? eh.fC.AUTO_DISABLE : eh.fC.AUTO_ENABLE, E), I[u] = d, tj({
      videoToggleStateMap: I
    }, l, f), d === ed.ZUi.AUTO_PROBING ? null == (n = es.Z.getRTCConnection()) || n.pauseStatsCollectionForUser(u, !0) : null == (r = es.Z.getRTCConnection()) || r.pauseStatsCollectionForUser(u, !1), tf || (ev.info("isAutoDisableAllowed=".concat(tf, " - disabling VideoHealthManager")), null == (a = es.Z.getRTCConnection()) || null == (i = a.getVideoHealthManager()) || i.disable()), v) {
    if (!p && !g || p && !tf) return;
...
function nn(e) {
  ...
  tj({
    mode: n,
    modeOptions: r
  }, t), eU.eachConnection(tO), tM.update()
}
