...
let eH = {},
  ...
  eq = performance.now(),
  eX = {
    [ey.w5]: tq("No Input Devices")
  },
  eQ = {
    [ey.w5]: tq("No Output Devices")
  },
  eJ = {
    [ey.w5]: tq("No Video Devices")
  },
  e$ = !1,
  e0 = !1,
  e1 = !1,
...
function tx(e, t, n, r) {
  ...
  o && tT[a].add(t), (null == t || o) && J.default.track(eh.rMx.SOUNDSHARE_FAILED, eI({
...
function tj() {
  eZ.on(b.aB.Connection, e => {
    ...
    }), e.context === ey.Yn.DEFAULT && (e6 = !1, e8 = !1, e.on(b.Sh.SpeakingWhileMuted, () => {
      e6 = !0, e8 = !0, r.emitChange(), e7.stop(), e7.start(eG, () => {
        e8 = !1, r.emitChange()
      })
    ...
    e.on(b.Sh.SoundshareTrace, e => {
      switch (e.type) {
        ...
        case "soundshare_recv_failed":
          let t = e.reason,
            n = e.code,
            r = e.retry;
          (null == a ? void 0 : a.desktopSource) != null && (tx(null == a ? void 0 : a.desktopSource, n, t, r), r || (_.stop(), v.Z.wait(() => v.Z.dispatch({
            type: "MEDIA_ENGINE_SOUNDSHARE_FAILED",
            errorMessage: t,
            errorCode: n
          }))));
      ...
      }), t_ = !0, J.default.track(eh.rMx.VOICE_PROCESSING, {
      ...
      eA.warn("voiceactivitydetectorerror event: ".concat(e)), (0, P.kr)({
        ...
        mode: eh.pM4.VOICE_ACTIVITY,
        options: eS(eI({}, tC(ey.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: !1
        })
      }), v.Z.dispatch({
...
let tZ = new class {
  ...
  stop() {
    this.started && (this.started = !1, null != this.stateChangeTimeout && (clearTimeout(this.stateChangeTimeout), this.stateChangeTimeout = null), eZ.removeListener(b.aB.Silence, this.handleSilence), v.Z.dispatch({
...
function tH() {
  ...
  null != t && (y.K.set(eN, {
    [ey.Yn.DEFAULT]: t
  }), y.K.remove("audio")), eH = null != (e = y.K.get(eN)) ? e : {}, p().each(eH, e => {
...
function tz() {
  eW || eZ.enable().then(() => v.Z.dispatch({
...
function t1() {
  ...
  for (let e of Object.keys(r)) {
    ...
    for (let [e, t] of Object.entries(o)) null == (0, z.Ky)(i, e) && (t.muted ? s[e] = !0 : delete s[e], t.volume !== a ? l[e] = t.volume : delete l[e], eZ.eachConnection(n => {
      n.setLocalVolume(e, t.volume), n.setLocalMute(e, t.muted)
    }, i));
    if (n)
      for (let e of new Set([...Object.keys(s), ...Object.keys(l)])) null == o[e] && (delete s[e], delete l[e], eZ.eachConnection(t => {
...
function t4(e) {
  i = e.sessionId, e$ = !1, e2 = !1, (0, et.isWeb)() || (V.Z.subscribe({
    location: "handleConnectionOpen"
  }, e => {
    let t = tC();
    !e.sidechainAvailable && t.sidechainCompression ? (tY({
      sidechainCompressionSettingVersion: 0
    }), nT(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eD && (tY({
      sidechainCompressionSettingVersion: eD
    }), nT(e.sidechainEnabled))
  }), nA());
  let t = tC();
...
function ni(e) {
  ...
  r[n] ? delete r[n] : r[n] = !0, tY({
    localMutes: r
  }, t), eZ.eachConnection(e => e.setLocalMute(n, r[n] || !1), t)
}
...
function na(e) {
  ...
  if (I[c] === eh.ZUi.AUTO_PROBING && u === eh.ZUi.AUTO_ENABLED && (0, Y.Z)(c, p ? ey.fC.AUTO_DISABLE : ey.fC.AUTO_ENABLE, E), I[c] = u, tY({
      videoToggleStateMap: I
    }, l, d), u === eh.ZUi.AUTO_PROBING ? null == (n = ed.Z.getRTCConnection()) || n.pauseStatsCollectionForUser(c, !0) : null == (r = ed.Z.getRTCConnection()) || r.pauseStatsCollectionForUser(c, !1), tE || (eA.info("isAutoDisableAllowed=".concat(tE, " - disabling VideoHealthManager")), null == (a = ed.Z.getRTCConnection()) || null == (i = a.getVideoHealthManager()) || i.disable()), O) {
    if (!p && !g || p && !tE) return;
  ...
  y && !p && tg.delete(c), p ? h[c] = !0 : delete h[c], tY({
    disabledLocalVideos: h
...
function nu(e) {
  ...
  tY({
    mode: n,
    modeOptions: r
  }, t), eZ.eachConnection(tR), tZ.update()
}
...
function nm(e) {
  ...
  }), eZ.setAudioInputBypassSystemProcessing(n.bypassSystemInputProcessing), tZ.update(), nN()
}
...
function nL(e) {
  ...
  }), eZ.setH264Enabled(i.hardwareEncoding || i.openH264), eZ.setAv1Enabled(null == (t = i.hardwareEncoding) || t), eZ.setH265Enabled(null == (n = i.hardwareEncoding) || n)
}
...
async function nK() {
  try {
    ...
    to = !0, s = null == (e = a.getSdkVersion) ? void 0 : e.call(a), l = null != (i = null == (t = a.getSuppressionLevel) ? void 0 : t.call(a)) ? i : 100, null == (n = a.getNcModels) || n.call(a).then(e => {
      ts = e, r.emitChange()
    }), r.emitChange()
  } catch (t) {
...
function nq() {
  !nz() || __OVERLAY__ || ta || to ? (0, et.isWeb)() && eZ.supports(ey.AN.NOISE_CANCELLATION) ? (to = !0, r.emitChange()) : (0, et.isWeb)() && tY({
    noiseCancellation: !1
  }) : (ta = !0, nK())
}
...
function n0(e) {
  ...
  }), eZ.setAudioInputBypassSystemProcessing(t), ny(e.location)
}
...
function rn(e) {
  ...
  if ((null == a ? void 0 : a.desktopSettings) != null) {
    ...
    et.isPlatformEmbedded && !0 === o && ({
      soundshareId: e,
      soundshareSession: r
    } = t2(c), null != e && t3(e, r)), tD(s), tL(s === ey.Yn.STREAM && e3, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
...
function ra(e) {
  ...
  eZ.setH264Enabled(n.hardwareEncoding || n.openH264), eZ.eachConnection(e => {
    var t;
...
class rm extends(u = E.ZP.Store) {
  ...
  fetchAsyncResources() {
    ...
    return (0, et.isWeb)() && (e.fetchDave = B.N.getCurrentConfig({
      location: "MediaEngineStore fetchAsyncResources"
    }).loadWasmModule), eZ.fetchAsyncResources(e)
  }
