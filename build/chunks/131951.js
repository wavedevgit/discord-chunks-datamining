...
let eY = {},
  ...
  eX = performance.now(),
  eQ = {
    [eO.w5]: tX("No Input Devices")
  },
  eJ = {
    [eO.w5]: tX("No Output Devices")
  },
  e$ = {
    [eO.w5]: tX("No Video Devices")
  },
  e0 = !1,
  e1 = !1,
  e2 = !1,
...
function tM(e, t, n, r) {
  ...
  o && tS[a].add(t), (null == t || o) && $.default.track(em.rMx.SOUNDSHARE_FAILED, eT({
...
function tU() {
  eH.on(b.aB.Connection, e => {
    ...
    e.on(b.Sh.SoundshareTrace, e => {
      ...
      (null == a ? void 0 : a.desktopSource) != null && $.default.track(em.rMx.VIDEOHOOK_INITIALIZED, eT({
        backend: e,
        format: t,
      ...
      eN.warn("voiceactivitydetectorerror event: ".concat(e)), (0, P.kr)({
        ...
        mode: em.pM4.VOICE_ACTIVITY,
        options: eA(eT({}, tR(eO.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: !1
        })
      }), v.Z.dispatch({
      ...
      _.stop()
    }), e.setBitRate(el.Z.bitrate), e.applyVideoQualityMode(eh.Z.mode)
    ...
    eN.warn("Watchdog timeout, report submission status: ".concat(null != e ? e : 200)), $.default.track(em.rMx.VOICE_WATCHDOG_TIMEOUT, {
...
function t2() {
  ...
  let n = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
    r = null != (e = X.Z.settings.audioContextSettings) ? e : {
      user: {},
      stream: {}
    };
  for (let e of Object.keys(r)) {
    ...
    for (let [e, t] of Object.entries(o)) null == (0, q.Ky)(i, e) && (t.muted ? s[e] = !0 : delete s[e], t.volume !== a ? l[e] = t.volume : delete l[e], eH.eachConnection(n => {
...
function t5(e) {
  i = e.sessionId, e0 = !1, e3 = !1, (0, en.isWeb)() || (F.Z.subscribe({
    location: "handleConnectionOpen"
  }, e => {
    let t = tR();
    !e.sidechainAvailable && t.sidechainCompression ? (tW({
      sidechainCompressionSettingVersion: 0
    }), nS(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eL && (tW({
      sidechainCompressionSettingVersion: eL
    }), nS(e.sidechainEnabled))
  }), nN());
  let t = tR();
  if (tF() && (tZ() ? n3(eO.iA.AUTOMATIC) : t.automaticAudioSubsystem && n4()), eH.supports(eO.AN.OFFLOAD_ADM_CONTROLS)) {
    ...
    autoTrackExposure: !1
  }) && null !== t.mostRecentlyRequestedVoiceFilter && (0, en.isDesktop)() && (J.Z.getLastInitAttemptMayHaveCrashed() ? (v.Z.dispatch({
...
function no(e) {
  ...
  if (I[c] === em.ZUi.AUTO_PROBING && u === em.ZUi.AUTO_ENABLED && (0, W.Z)(c, p ? eO.fC.AUTO_DISABLE : eO.fC.AUTO_ENABLE, E), I[c] = u, tW({
      videoToggleStateMap: I
    }, l, d), u === em.ZUi.AUTO_PROBING ? null == (n = ef.Z.getRTCConnection()) || n.pauseStatsCollectionForUser(c, !0) : null == (r = ef.Z.getRTCConnection()) || r.pauseStatsCollectionForUser(c, !1), tb || (eN.info("isAutoDisableAllowed=".concat(tb, " - disabling VideoHealthManager")), null == (a = ef.Z.getRTCConnection()) || null == (i = a.getVideoHealthManager()) || i.disable()), O) {
    if (!p && !g || p && !tb) return;
  ...
  y && !p && tE.delete(c), p ? h[c] = !0 : delete h[c], tW({
    disabledLocalVideos: h
...
function nd(e) {
  ...
  tW({
    mode: n,
    modeOptions: r
  }, t), eH.eachConnection(tP), tH.update()
}
...
function np(e) {
  ...
  t = tJ(eQ, t), eX = performance.now(), tW({
    inputDeviceId: t
  }), eH.setAudioInputDevice(t)
}
...
function ng(e) {
  ...
  }), eH.setAudioInputBypassSystemProcessing(n.bypassSystemInputProcessing), tH.update(), nC()
}
...
function nX() {
  !nq() || __OVERLAY__ || to || ts ? (0, en.isWeb)() && eH.supports(eO.AN.NOISE_CANCELLATION) ? (ts = !0, r.emitChange()) : (0, en.isWeb)() && tW({
    noiseCancellation: !1
  }) : (to = !0, nz())
}
...
function n1(e) {
  ...
  }), eH.setAudioInputBypassSystemProcessing(t), nO(e.location)
}
...
function rr(e) {
  ...
  if ((null == a ? void 0 : a.desktopSettings) != null) {
    ...
    en.isPlatformEmbedded && !0 === o && ({
      soundshareId: e,
      soundshareSession: r
    } = t3(c), null != e && t4(e, r)), tL(s), tx(s === eO.Yn.STREAM && e4, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
...
class rg extends(u = E.ZP.Store) {
  ...
  fetchAsyncResources() {
    ...
    return (0, en.isWeb)() && (e.fetchDave = V.N.getCurrentConfig({
