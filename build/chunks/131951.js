...
let eG = {},
  ...
  eZ = eh.Yn.STREAM,
  eH = {
    [eh.w5]: tG("No Input Devices")
  },
  eW = {
    [eh.w5]: tG("No Output Devices")
  },
  eY = {
    [eh.w5]: tG("No Video Devices")
  },
  eK = !1,
  ez = !1,
  eq = !1,
...
function tN(e, t, n, r) {
  ...
  a && tg[o].add(t), (null == t || a) && z.default.track(ed.rMx.SOUNDSHARE_FAILED, eE({
...
function tR() {
  eU.on(m.aB.Connection, e => {
    ...
    }), e.context === eh.Yn.DEFAULT && (e0 = !1, e1 = !1, e.on(m.Sh.SpeakingWhileMuted, () => {
      e0 = !0, e1 = !0, r.emitChange(), e2.stop(), e2.start(eM, () => {
        e1 = !1, r.emitChange()
      })
    ...
    e.on(m.Sh.SoundshareTrace, e => {
      ...
      }), ta = !0, z.default.track(ed.rMx.VOICE_PROCESSING, {
      ...
      ev.warn("voiceactivitydetectorerror event: ".concat(e)), (0, A.kr)({
        ...
        mode: ed.pM4.VOICE_ACTIVITY,
        options: ey(eE({}, ty(eh.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: !1
        })
      }), b.Z.dispatch({
...
function tz(e) {
  i = e.sessionId, eK = !1, eQ = !1, (0, X.isWeb)() || (G.Z.subscribe({
    location: "handleConnectionOpen"
  }, e => {
    let t = ty();
    !e.sidechainAvailable && t.sidechainCompression ? (tM({
      sidechainCompressionSettingVersion: 0
    }), n_(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eA && (tM({
      sidechainCompressionSettingVersion: eA
    }), n_(e.sidechainEnabled))
  }), nh());
  let t = ty();
  tD() && (t.automaticAudioSubsystem && nZ(), t.audioSubsystemSettingVersion < eC && (tM({
    audioSubsystemSettingVersion: eC
  }), t.automaticAudioSubsystem || eU.getAudioSubsystem() === eh.iA.LEGACY || nF(eh.iA.AUTOMATIC))), (0, K.wt)({
    location: "MediaEngineStore",
    autoTrackExposure: !1
  }) && null !== t.mostRecentlyRequestedVoiceFilter && (0, Y.J_)(), tW()
}
...
function t5(e) {
  ...
  if (I[u] === ed.ZUi.AUTO_PROBING && d === ed.ZUi.AUTO_ENABLED && (0, F.Z)(u, p ? eh.fC.AUTO_DISABLE : eh.fC.AUTO_ENABLE, E), I[u] = d, tM({
      videoToggleStateMap: I
    }, l, f), d === ed.ZUi.AUTO_PROBING ? null == (n = es.ZP.getRTCConnection()) || n.pauseStatsCollectionForUser(u, !0) : null == (r = es.ZP.getRTCConnection()) || r.pauseStatsCollectionForUser(u, !1), td || (ev.info("isAutoDisableAllowed=".concat(td, " - disabling VideoHealthManager")), null == (o = es.ZP.getRTCConnection()) || null == (i = o.getVideoHealthManager()) || i.disable()), v) {
    if (!p && !g || p && !td) return;
  ...
  y && !p && tu.delete(u), p ? h[u] = !0 : delete h[u], tM({
    disabledLocalVideos: h
...
function ne(e) {
  ...
  tM({
    mode: n,
    modeOptions: r
  }, t), eU.eachConnection(tv), tL.update()
}
...
function nk() {
  !nM() || __OVERLAY__ || e9 || te ? (0, X.isWeb)() && eU.supports(eh.AN.NOISE_CANCELLATION) ? (te = !0, r.emitChange()) : (0, X.isWeb)() && tM({
    noiseCancellation: !1
  }) : (e9 = !0, nx())
}
...
function nJ(e) {
  ...
  if ((null == o ? void 0 : o.desktopSettings) != null) {
    ...
    X.isPlatformEmbedded && !0 === a && ({
      soundshareId: e,
      soundshareSession: r
    } = tY(c), null != e && tK(e, r)), tS(s), tT(s === eh.Yn.STREAM && eX, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
