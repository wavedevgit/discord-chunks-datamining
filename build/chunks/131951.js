...
function tN() {
  ej.on(m.aB.Connection, e => {
    ...
    e.on(m.Sh.Speaking, (t, n) => {
      ...
      (null == o ? void 0 : o.desktopSource) != null && (z.default.track(ed.rMx.SOUNDSHARE_TRANSMITTING, (0, w.Z)(null == o ? void 0 : o.desktopSource)), null != ea.Z.getHookError(ed.K3D.SOUND) && v.Z.wait(() => v.Z.dispatch({
      ...
      switch (e.type) {
        ...
        case "soundshare_recv_failed":
          let t = e.reason,
            n = e.code,
            r = e.retry;
          (null == o ? void 0 : o.desktopSource) == null || (tS(null == o ? void 0 : o.desktopSource, n, t, r), r || (h.stop(), v.Z.wait(() => v.Z.dispatch({
            type: "MEDIA_ENGINE_SOUNDSHARE_FAILED",
            errorMessage: t,
            errorCode: n
          }))));
...
let tP = new class {
  ...
  stop() {
    this.started && (this.started = !1, null != this.stateChangeTimeout && (clearTimeout(this.stateChangeTimeout), this.stateChangeTimeout = null), ej.removeListener(m.aB.Silence, this.handleSilence), v.Z.dispatch({
...
function t2(e) {
  ...
  if (I[u] === ed.ZUi.AUTO_PROBING && d === ed.ZUi.AUTO_ENABLED && (0, F.Z)(u, p ? eh.fC.AUTO_DISABLE : eh.fC.AUTO_ENABLE, E), I[u] = d, tD({
      videoToggleStateMap: I
  ...
  b && !p && tc.delete(u), p ? h[u] = !0 : delete h[u], tD({
    disabledLocalVideos: h
...
class n8 extends(s = h.ZP.Store) {
  initialize() {
    ...
    }, this.waitFor(en.default, ei.Z, eo.Z, ea.Z, es.Z, P.ZP, Z.Z.storage, W.Z, C.Z, I.Z), (0, A.U)()
  }
  supports(e) {
