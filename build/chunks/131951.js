...
let eG = {},
  ...
  eH = performance.now(),
  eY = {
    [eh.w5]: tV("No Input Devices")
  },
  eW = {
    [eh.w5]: tV("No Output Devices")
  },
  eK = {
    [eh.w5]: tV("No Video Devices")
  },
  ez = !1,
  eq = !1,
  eQ = !1,
...
function tN(e, t, n, r) {
  ...
  o && tE[a].add(t), (null == t || o) && z.default.track(ed.rMx.SOUNDSHARE_FAILED, eE({
...
function tP() {
  eU.on(m.aB.Connection, e => {
    ...
    let o = es.Z.getGuildId(),
      {
        ...
        skipEncode: c
      } = (null != o ? x.Z : L.Z).getCurrentConfig(eE({
    ...
    e.on(m.Sh.Speaking, (t, n) => {
    ...
    }), e.context === eh.Yn.DEFAULT && (e1 = !1, e2 = !1, e.on(m.Sh.SpeakingWhileMuted, () => {
      e1 = !0, e2 = !0, r.emitChange(), e3.stop(), e3.start(eM, () => {
        e2 = !1, r.emitChange()
      })
      ...
      (null == a ? void 0 : a.desktopSource) != null && (z.default.track(ed.rMx.SOUNDSHARE_TRANSMITTING, (0, w.Z)(null == a ? void 0 : a.desktopSource)), null != eo.Z.getHookError(ed.K3D.SOUND) && b.Z.wait(() => b.Z.dispatch({
    ...
    e.on(m.Sh.SoundshareTrace, e => {
      switch (e.type) {
        ...
        case "soundshare_recv_failed":
          let t = e.reason,
            n = e.code,
            r = e.retry;
          (null == a ? void 0 : a.desktopSource) != null && (tN(null == a ? void 0 : a.desktopSource, n, t, r), r || (_.stop(), b.Z.wait(() => b.Z.dispatch({
            type: "MEDIA_ENGINE_SOUNDSHARE_FAILED",
            errorMessage: t,
            errorCode: n
          }))));
      ...
      (null == a ? void 0 : a.desktopSource) != null && z.default.track(ed.rMx.VIDEOHOOK_INITIALIZED, eE({
        backend: e,
        format: t,
      ...
      eO.warn("noisecancellererror event: ".concat(e)), (0, N.kr)({
      ...
      eO.warn("voiceactivitydetectorerror event: ".concat(e)), (0, N.kr)({
        type: N.u.NOISE_CANCELLER_ERROR,
        underlyingError: tC(e)
        ...
        mode: ed.pM4.VOICE_ACTIVITY,
        options: ey(eE({}, tO(eh.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: !1
        })
      }), b.Z.dispatch({
    ...
    eO.warn("Watchdog timeout, report submission status: ".concat(null != e ? e : 200)), z.default.track(ed.rMx.VOICE_WATCHDOG_TIMEOUT, {
    ...
    (0, N.kr)(t === N.u.VIDEO_ENCODE_ERROR ? ey(eE({
      type: t
    }, n), {
...
function tk() {
  ...
  null != t && (g.K.set(ev, {
    [eh.Yn.DEFAULT]: t
  }), g.K.remove("audio")), eG = null != (e = g.K.get(ev)) ? e : {}, d().each(eG, e => {
...
function tB() {
  eV || eU.enable().then(() => b.Z.dispatch({
...
function tQ(e) {
  i = e.sessionId, ez = !1, eX = !1, (0, X.isWeb)() || (U.Z.subscribe({
    ...
    let t = tO();
    !e.sidechainAvailable && t.sidechainCompression ? (tj({
      sidechainCompressionSettingVersion: 0
    }), nh(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eN && (tj({
      sidechainCompressionSettingVersion: eN
    }), nh(e.sidechainEnabled))
  }), ng());
  let t = tO();
  tx() && (t.automaticAudioSubsystem && nY(), t.audioSubsystemSettingVersion < eC && (tj({
    audioSubsystemSettingVersion: eC
  }), t.automaticAudioSubsystem || eU.getAudioSubsystem() === eh.iA.LEGACY || nH(eh.iA.AUTOMATIC))), (0, K.wt)({
    location: "MediaEngineStore",
    autoTrackExposure: !1
  }) && null !== t.mostRecentlyRequestedVoiceFilter && (0, W.J_)(), tK()
}
...
function t8(e) {
  ...
  if (I[u] === ed.ZUi.AUTO_PROBING && d === ed.ZUi.AUTO_ENABLED && (0, F.Z)(u, p ? eh.fC.AUTO_DISABLE : eh.fC.AUTO_ENABLE, E), I[u] = d, tj({
      videoToggleStateMap: I
    }, l, f), d === ed.ZUi.AUTO_PROBING ? null == (n = es.Z.getRTCConnection()) || n.pauseStatsCollectionForUser(u, !0) : null == (r = es.Z.getRTCConnection()) || r.pauseStatsCollectionForUser(u, !1), tf || (eO.info("isAutoDisableAllowed=".concat(tf, " - disabling VideoHealthManager")), null == (a = es.Z.getRTCConnection()) || null == (i = a.getVideoHealthManager()) || i.disable()), O) {
    if (!p && !g || p && !tf) return;
  ...
  y && !p && td.delete(u), p ? h[u] = !0 : delete h[u], tj({
    disabledLocalVideos: h
...
function nn(e) {
  ...
  tj({
    mode: n,
    modeOptions: r
  }, t), eU.eachConnection(tv), tM.update()
}
...
function na(e) {
  ...
  t = tZ(eY, t), eH = performance.now(), tj({
    inputDeviceId: t
  }), eU.setAudioInputDevice(t)
}
...
function nU() {
  !nj() || __OVERLAY__ || te || tt ? (0, X.isWeb)() && eU.supports(eh.AN.NOISE_CANCELLATION) ? (tt = !0, r.emitChange()) : (0, X.isWeb)() && tj({
    noiseCancellation: !1
  }) : (te = !0, nk())
}
...
function n0(e) {
  ...
  if ((null == a ? void 0 : a.desktopSettings) != null) {
    ...
    X.isPlatformEmbedded && !0 === o && ({
      soundshareId: e,
      soundshareSession: r
    } = tz(c), null != e && tq(e, r)), tT(s), tA(s === eh.Yn.STREAM && eJ, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
