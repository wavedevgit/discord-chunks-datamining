...
let eG = {},
  ...
  eH = performance.now(),
  eW = {
    [eh.w5]: tF("No Input Devices")
  },
  eY = {
    [eh.w5]: tF("No Output Devices")
  },
  eK = {
    [eh.w5]: tF("No Video Devices")
  },
  ez = !1,
  eq = !1,
  eQ = !1,
...
function tP() {
  eU.on(m.aB.Connection, e => {
    ...
    e.on(m.Sh.SoundshareTrace, e => {
      switch (e.type) {
        ...
        case "soundshare_recv_failed":
          let t = e.reason,
            n = e.code,
            r = e.retry;
          (null == a ? void 0 : a.desktopSource) != null && (tA(null == a ? void 0 : a.desktopSource, n, t, r), r || (_.stop(), b.Z.wait(() => b.Z.dispatch({
            type: "MEDIA_ENGINE_SOUNDSHARE_FAILED",
            errorMessage: t,
            errorCode: n
          }))));
      ...
      ev.warn("noisecancellererror event: ".concat(e)), (0, A.kr)({
      ...
      ev.warn("voiceactivitydetectorerror event: ".concat(e)), (0, A.kr)({
        type: A.u.NOISE_CANCELLER_ERROR,
        underlyingError: tC(e)
    ...
    (0, A.kr)(t === A.u.VIDEO_ENCODE_ERROR ? ey(eE({
      type: t
    }, n), {
...
function tK() {
  ...
  let n = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
    r = null != (e = W.Z.settings.audioContextSettings) ? e : {
      user: {},
      stream: {}
    };
...
function tQ(e) {
  i = e.sessionId, ez = !1, eX = !1, (0, X.isWeb)() || (U.Z.subscribe({
    ...
    !e.sidechainAvailable && t.sidechainCompression ? (tj({
      sidechainCompressionSettingVersion: 0
    }), nh(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eA && (tj({
      sidechainCompressionSettingVersion: eA
    }), nh(e.sidechainEnabled))
  }), ng());
  let t = tv();
  tx() && (t.automaticAudioSubsystem && nW(), t.audioSubsystemSettingVersion < eC && (tj({
    ...
    autoTrackExposure: !1
  }) && null !== t.mostRecentlyRequestedVoiceFilter && (0, Y.J_)(), tK()
}
...
function t8(e) {
  ...
  if (I[u] === ed.ZUi.AUTO_PROBING && d === ed.ZUi.AUTO_ENABLED && (0, V.Z)(u, p ? eh.fC.AUTO_DISABLE : eh.fC.AUTO_ENABLE, E), I[u] = d, tj({
      videoToggleStateMap: I
...
function na(e) {
  ...
  t = tZ(eW, t), eH = performance.now(), tj({
    inputDeviceId: t
  }), eU.setAudioInputDevice(t)
}
...
function n0(e) {
  ...
  if ((null == a ? void 0 : a.desktopSettings) != null) {
    ...
    X.isPlatformEmbedded && !0 === o && ({
      soundshareId: e,
      soundshareSession: r
    } = tz(c), null != e && tq(e, r)), tT(s), tN(s === eh.Yn.STREAM && eJ, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
