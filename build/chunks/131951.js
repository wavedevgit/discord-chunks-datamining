...
let eW = {},
  ...
  eQ = performance.now(),
  eJ = {
    [ev.w5]: tJ("No Input Devices")
  },
  e$ = {
    [ev.w5]: tJ("No Output Devices")
  },
  e0 = {
    [ev.w5]: tJ("No Video Devices")
  },
  e1 = !1,
  e2 = !1,
  e3 = !1,
  ...
  tg = !1,
  tE = !1;
z.Z.hasPermission(eb.Eu.AUDIO, {
  showAuthorizationError: !1
}), z.Z.hasPermission(eb.Eu.CAMERA, {
  showAuthorizationError: !1
});
let tb = !1,
  ty = new Set,
...
function tj(e, t, n, r) {
  ...
  o && tN[a].add(t), (null == t || o) && ee.default.track(eg.rMx.SOUNDSHARE_FAILED, eS({
...
function tB() {
  eY.on(b.aB.Connection, e => {
    ...
    let o = e_.Z.getGuildId(),
      {
        ...
        skipEncode: c
      } = (null != o ? U.Z : j.Z).getCurrentConfig(eS({
    ...
    s && e.setExperimentFlag(ev.V8.MUTE_BEFORE_PROCESSING, !0), l && e.setExperimentFlag(ev.V8.PTT_BEFORE_PROCESSING, !0), c && e.setExperimentFlag(ev.V8.SKIP_ENCODE, !0), null != o && V.Z.getCurrentConfig({
      location: "setupMediaEngine",
      guildId: o
    }, {
      autoTrackExposure: !0
    }).enabled && e.setExperimentFlag(ev.V8.SIGNAL_RED, !0);
    let u = !1,
      d = !0;
    ...
    e.on(b.Sh.Speaking, (t, n) => {
    ...
    }), e.context === ev.Yn.DEFAULT && (e7 = !1, e9 = !1, e.on(b.Sh.SpeakingWhileMuted, () => {
      e7 = !0, e9 = !0, r.emitChange(), te.stop(), te.start(eV, () => {
        e9 = !1, r.emitChange()
      })
      ...
      (null == a ? void 0 : a.desktopSource) != null && (ee.default.track(eg.rMx.SOUNDSHARE_TRANSMITTING, (0, x.Z)(null == a ? void 0 : a.desktopSource)), null != ef.Z.getHookError(eg.K3D.SOUND) && v.Z.wait(() => v.Z.dispatch({
    ...
    e.on(b.Sh.SoundshareTrace, e => {
      switch (e.type) {
        ...
        case "soundshare_recv_failed":
          let t = e.reason,
            n = e.code,
            r = e.retry;
          (null == a ? void 0 : a.desktopSource) != null && (tj(null == a ? void 0 : a.desktopSource, n, t, r), r || (_.stop(), v.Z.wait(() => v.Z.dispatch({
            type: "MEDIA_ENGINE_SOUNDSHARE_FAILED",
            errorMessage: t,
            errorCode: n
          }))));
      ...
      (null == a ? void 0 : a.desktopSource) != null && ee.default.track(eg.rMx.VIDEOHOOK_INITIALIZED, eS({
        backend: e,
        format: t,
      ...
      }), tm = !0, ee.default.track(eg.rMx.VOICE_PROCESSING, {
      ...
      eC.warn("voiceactivitydetectorerror event: ".concat(e)), (0, P.kr)({
        ...
        mode: eg.pM4.VOICE_ACTIVITY,
        options: eN(eS({}, tw(ev.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: !1
        })
      }), v.Z.dispatch({
      ...
      _.stop()
    }), e.setBitRate(ec.Z.bitrate), e.applyVideoQualityMode(em.Z.mode)
    ...
    eC.warn("Watchdog timeout, report submission status: ".concat(null != e ? e : 200)), ee.default.track(eg.rMx.VOICE_WATCHDOG_TIMEOUT, {
...
let tW = new class {
  ...
  stop() {
    this.started && (this.started = !1, null != this.stateChangeTimeout && (clearTimeout(this.stateChangeTimeout), this.stateChangeTimeout = null), eY.removeListener(b.aB.Silence, this.handleSilence), v.Z.dispatch({
  ...
  constructor() {
    eT(this, "stateChangeTimeout", void 0), eT(this, "noVoiceTimeout", 5e3), eT(this, "voiceTimeout", 1500), eT(this, "started", !1), eT(this, "handleSilence", e => {
      let t = !e;
...
function tK() {
  ...
  null != t && (y.K.set(eR, {
    [ev.Yn.DEFAULT]: t
  }), y.K.remove("audio")), eW = null != (e = y.K.get(eR)) ? e : {}, p().each(eW, e => {
...
function tQ() {
  ez || eY.enable().then(() => v.Z.dispatch({
...
function t4() {
  ...
  for (let e of Object.keys(r)) {
    ...
    for (let [e, t] of Object.entries(o)) null == (0, X.Ky)(i, e) && (t.muted ? s[e] = !0 : delete s[e], t.volume !== a ? l[e] = t.volume : delete l[e], eY.eachConnection(n => {
      n.setLocalVolume(e, t.volume), n.setLocalMute(e, t.muted)
    }, i));
    if (n)
      for (let e of new Set([...Object.keys(s), ...Object.keys(l)])) null == o[e] && (delete s[e], delete l[e], eY.eachConnection(t => {
...
function t8(e) {
  i = e.sessionId, e1 = !1, e4 = !1, (0, er.isWeb)() || (Z.Z.subscribe({
    location: "handleConnectionOpen"
  }, e => {
    let t = tw();
    !e.sidechainAvailable && t.sidechainCompression ? (tz({
      sidechainCompressionSettingVersion: 0
    }), nN(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < ex && (tz({
...
function ns(e) {
  ...
  r[n] ? delete r[n] : r[n] = !0, tz({
    localMutes: r
  }, t), eY.eachConnection(e => e.setLocalMute(n, r[n] || !1), t)
}
...
function nl(e) {
  ...
  if (I[c] === eg.ZUi.AUTO_PROBING && u === eg.ZUi.AUTO_ENABLED && (0, K.Z)(c, p ? ev.fC.AUTO_DISABLE : ev.fC.AUTO_ENABLE, E), I[c] = u, tz({
      videoToggleStateMap: I
    }, l, d), u === eg.ZUi.AUTO_PROBING ? null == (n = e_.Z.getRTCConnection()) || n.pauseStatsCollectionForUser(c, !0) : null == (r = e_.Z.getRTCConnection()) || r.pauseStatsCollectionForUser(c, !1), tO || (eC.info("isAutoDisableAllowed=".concat(tO, " - disabling VideoHealthManager")), null == (a = e_.Z.getRTCConnection()) || null == (i = a.getVideoHealthManager()) || i.disable()), O) {
    if (!p && !g || p && !tO) return;
  ...
  y && !p && ty.delete(c), p ? h[c] = !0 : delete h[c], tz({
    disabledLocalVideos: h
...
function n_(e) {
  ...
  tz({
    mode: n,
    modeOptions: r
  }, t), eY.eachConnection(tD), tW.update()
}
...
function nm(e) {
  ...
  t = t0(eJ, t), eQ = performance.now(), tz({
    inputDeviceId: t
  }), eY.setAudioInputDevice(t)
}
...
function nb(e) {
  ...
  }), eY.setAudioInputBypassSystemProcessing(n.bypassSystemInputProcessing), tW.update(), nP()
}
...
async function nQ() {
  try {
    ...
    tl = !0, s = null == (e = a.getSdkVersion) ? void 0 : e.call(a), l = null != (i = null == (t = a.getSuppressionLevel) ? void 0 : t.call(a)) ? i : 100, null == (n = a.getNcModels) || n.call(a).then(e => {
      tc = e, r.emitChange()
    }), r.emitChange()
  } catch (t) {
...
function n$() {
  !nJ() || __OVERLAY__ || ts || tl ? (0, er.isWeb)() && eY.supports(ev.AN.NOISE_CANCELLATION) ? (tl = !0, r.emitChange()) : (0, er.isWeb)() && tz({
    noiseCancellation: !1
  }) : (ts = !0, nQ())
}
...
function n4(e) {
  ...
  }), eY.setAudioInputBypassSystemProcessing(t), nI(e.location)
}
...
function ro(e) {
  ...
  if ((null == a ? void 0 : a.desktopSettings) != null) {
    ...
    er.isPlatformEmbedded && !0 === o && ({
      soundshareId: e,
      soundshareSession: r
    } = t5(c), null != e && t6(e, r)), tk(s), tM(s === ev.Yn.STREAM && e5, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
...
class ry extends(u = E.ZP.Store) {
  ...
  getVideoStreamParameters() {
    ...
    return this.isSimulcastSupported() && (e === ev.Yn.DEFAULT || this.goLiveSimulcastEnabled()) && t.push({
      rid: "50",
      type: e === ev.Yn.DEFAULT ? ev.Tr.VIDEO : ev.Tr.SCREEN,
      quality: ev.LD
    }), t
  ...
  fetchAsyncResources() {
    ...
    }).loadWasmModule), eY.fetchAsyncResources(e)
  }
