...
let eF = {},
  ...
  eW = performance.now(),
  eK = {
    [eE.w5]: tY("No Input Devices")
  },
  ez = {
    [eE.w5]: tY("No Output Devices")
  },
  eq = {
    [eE.w5]: tY("No Video Devices")
  },
  eQ = !1,
  eX = !1,
  eJ = !1,
  ...
  tu = !1,
  td = !1;
H.Z.hasPermission(eh.Eu.AUDIO, {
  showAuthorizationError: !1
}), H.Z.hasPermission(eh.Eu.CAMERA, {
  showAuthorizationError: !1
});
let tf = !1,
  t_ = new Set,
...
function tS() {
  ...
  return eI(eO({}, i, a), {
    modeOptions: eO({}, null != (t = i.modeOptions) ? t : {}, null != (n = a.modeOptions) ? n : {})
  })
}
...
function tR(e, t, n, r) {
  ...
  o && ty[a].add(t), (null == t || o) && Q.default.track(e_.rMx.SOUNDSHARE_FAILED, eO({
...
function tL() {
  eB.on(E.aB.Connection, e => {
    ...
    let o = ec.Z.getGuildId(),
      {
        ...
        skipEncode: c
      } = (null != o ? M.Z : k.Z).getCurrentConfig(eO({
    ...
    if (e.setRemoteAudioHistory(1e3 * !!f), (0, A.Z)(r)) {
    ...
    e.on(E.Sh.Speaking, (t, n) => {
    ...
    }), e.context === eE.Yn.DEFAULT && (e3 = !1, e4 = !1, e.on(E.Sh.SpeakingWhileMuted, () => {
      e3 = !0, e4 = !0, r.emitChange(), e5.stop(), e5.start(eM, () => {
        e4 = !1, r.emitChange()
      })
      ...
      (null == a ? void 0 : a.desktopSource) != null && (Q.default.track(e_.rMx.SOUNDSHARE_TRANSMITTING, (0, L.Z)(null == a ? void 0 : a.desktopSource)), null != el.Z.getHookError(e_.K3D.SOUND) && O.Z.wait(() => O.Z.dispatch({
    ...
    e.on(E.Sh.SoundshareTrace, e => {
      switch (e.type) {
        ...
        case "soundshare_recv_failed":
          let t = e.reason,
            n = e.code,
            r = e.retry;
          (null == a ? void 0 : a.desktopSource) != null && (tR(null == a ? void 0 : a.desktopSource, n, t, r), r || (_.stop(), O.Z.wait(() => O.Z.dispatch({
            type: "MEDIA_ENGINE_SOUNDSHARE_FAILED",
            errorMessage: t,
            errorCode: n
          }))));
        ...
        case "soundshare_state_transition":
          4 === e.newState && (_.stop(), O.Z.wait(() => O.Z.dispatch({
            type: "MEDIA_ENGINE_SOUNDSHARE_TRANSMITTING"
          })))
      }
      ...
      (null == a ? void 0 : a.desktopSource) != null && Q.default.track(e_.rMx.VIDEOHOOK_INITIALIZED, eO({
        backend: e,
        format: t,
      ...
      eS.warn("noisecancellererror event: ".concat(e)), (0, P.kr)({
        type: P.u.NOISE_CANCELLER_ERROR,
        underlyingError: tw(e)
      }), tc = !0, Q.default.track(e_.rMx.VOICE_PROCESSING, {
      ...
      eS.warn("voiceactivitydetectorerror event: ".concat(e)), (0, P.kr)({
        type: P.u.NOISE_CANCELLER_ERROR,
        underlyingError: tw(e)
        ...
        mode: e_.pM4.VOICE_ACTIVITY,
        options: eI(eO({}, tS(eE.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: !1
        })
      }), O.Z.dispatch({
      ...
      _.stop()
    }), e.setBitRate(ea.Z.bitrate), e.applyVideoQualityMode(ef.Z.mode)
    ...
    let e;
    try {
      await X.Z.submitLiveCrashReport({
        message: {
    ...
    eS.warn("Watchdog timeout, report submission status: ".concat(null != e ? e : 200)), Q.default.track(e_.rMx.VOICE_WATCHDOG_TIMEOUT, {
    ...
    (0, P.kr)(t === P.u.VIDEO_ENCODE_ERROR ? eI(eO({
      type: t
    }, n), {
...
let tG = new class {
  ...
  stop() {
    this.started && (this.started = !1, null != this.stateChangeTimeout && (clearTimeout(this.stateChangeTimeout), this.stateChangeTimeout = null), eB.removeListener(E.aB.Silence, this.handleSilence), O.Z.dispatch({
  ...
  constructor() {
    ey(this, "stateChangeTimeout", void 0), ey(this, "noVoiceTimeout", 5e3), ey(this, "voiceTimeout", 1500), ey(this, "started", !1), ey(this, "handleSilence", e => {
      let t = !e;
      null != this.stateChangeTimeout && clearTimeout(this.stateChangeTimeout), this.stateChangeTimeout = setTimeout(() => {
        this.stateChangeTimeout = null, this.started && (O.Z.dispatch({
          type: "AUDIO_INPUT_DETECTED",
          inputDetected: t
        }), e && (te = !0))
...
function tB() {
  ...
  null != t && (b.K.set(eT, {
    [eE.Yn.DEFAULT]: t
  }), b.K.remove("audio")), eF = null != (e = b.K.get(eT)) ? e : {}, _().each(eF, e => {
...
function tH() {
  eZ || eB.enable().then(() => O.Z.dispatch({
...
function tX() {
  ...
  let n = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
    r = null != (e = K.Z.settings.audioContextSettings) ? e : {
      user: {},
      stream: {}
    };
  for (let e of Object.keys(r)) {
    ...
    for (let [e, t] of Object.entries(o)) null == (0, W.Ky)(i, e) && (t.muted ? s[e] = !0 : delete s[e], t.volume !== a ? l[e] = t.volume : delete l[e], eB.eachConnection(n => {
      n.setLocalVolume(e, t.volume), n.setLocalMute(e, t.muted)
    }, i));
    if (n)
      for (let e of new Set([...Object.keys(s), ...Object.keys(l)])) null == o[e] && (delete s[e], delete l[e], eB.eachConnection(t => {
...
function tJ(e) {
  if (null == r) return eS.info("Error: trying to get soundshare id before MediaEngineStore is instantiated."), {
    soundshareId: null,
    soundshareSession: ""
  };
  {
    let t = r.getExperimentalSoundshare() ? e : X.Z.getAudioPid(e),
      n = "";
    return null != t && (n = X.Z.generateSessionFromPid(t)), {
      soundshareId: t,
      soundshareSession: n
    }
  }
...
function t$(e, t) {
  (0, $.isWindows)() && I.YT(e, {
    ...
    null == t || D.ZP.shouldContinueWithoutElevatedProcessForPID(e) || O.Z.wait(() => {
      O.Z.dispatch({
        type: "MEDIA_ENGINE_SOUNDSHARE_FAILED",
        errorMessage: t
      })
...
function t0(e) {
  i = e.sessionId, eQ = !1, e$ = !1, (0, $.isWeb)() || (G.Z.subscribe({
    location: "handleConnectionOpen"
  }, e => {
    let t = tS();
    !e.sidechainAvailable && t.sidechainCompression ? (tF({
      sidechainCompressionSettingVersion: 0
    }), ny(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eR && (tF({
      sidechainCompressionSettingVersion: eR
    }), ny(e.sidechainEnabled))
  }), nv());
  let t = tS();
  tj() && (tU() ? nX(eE.iA.AUTOMATIC) : t.automaticAudioSubsystem && nJ()), (0, z.wt)({
    location: "MediaEngineStore",
    autoTrackExposure: !1
  }) && null !== t.mostRecentlyRequestedVoiceFilter && (0, $.isDesktop)() && (q.Z.getLastInitAttemptMayHaveCrashed() ? (O.Z.dispatch({
...
function ne(e) {
  ...
  r[n] ? delete r[n] : r[n] = !0, tF({
    localMutes: r
  }, t), eB.eachConnection(e => e.setLocalMute(n, r[n] || !1), t)
}
...
function nt(e) {
  ...
  if (I[c] === e_.ZUi.AUTO_PROBING && u === e_.ZUi.AUTO_ENABLED && (0, Z.Z)(c, p ? eE.fC.AUTO_DISABLE : eE.fC.AUTO_ENABLE, E), I[c] = u, tF({
      videoToggleStateMap: I
    }, l, f), u === e_.ZUi.AUTO_PROBING ? null == (n = ec.Z.getRTCConnection()) || n.pauseStatsCollectionForUser(c, !0) : null == (r = ec.Z.getRTCConnection()) || r.pauseStatsCollectionForUser(c, !1), tp || (eS.info("isAutoDisableAllowed=".concat(tp, " - disabling VideoHealthManager")), null == (a = ec.Z.getRTCConnection()) || null == (i = a.getVideoHealthManager()) || i.disable()), O) {
    if (!p && !g || p && !tp) return;
  ...
  y && !p && t_.delete(c), p ? h[c] = !0 : delete h[c], tF({
    disabledLocalVideos: h
  }, l, f), eB.eachConnection(e => {
    var t;
...
function ni(e) {
  ...
  r === i ? delete a[n] : a[n] = r, tF({
    localVolumes: a
  }, t), eB.eachConnection(e => e.setLocalVolume(n, r), t)
}
...
function na(e) {
  ...
  a[n] = {
    ...
    localPans: a
  }, t), eB.eachConnection(e => e.setLocalPan(n, r, i), t)
}
...
function no(e) {
  ...
  tF({
    mode: n,
    modeOptions: r
  }, t), eB.eachConnection(tT), tG.update()
}
...
function nc(e) {
  ...
  t = tK(eK, t), eW = performance.now(), tF({
    inputDeviceId: t
  }), eB.setAudioInputDevice(t)
}
...
function nf(e) {
  ...
  }), eB.setAudioInputBypassSystemProcessing(n.bypassSystemInputProcessing), tG.update(), nI()
}
...
function nC(e) {
  ...
  }), eB.setH264Enabled(i.hardwareEncoding || i.openH264), eB.setAv1Enabled(null == (t = i.hardwareEncoding) || t), eB.setH265Enabled(null == (n = i.hardwareEncoding) || n)
}
...
function nM(e) {
  ...
  tF({
    qos: t
  }), eB.eachConnection(e => e.setQoS(t))
}
...
function nH() {
  !nZ() || __OVERLAY__ || tn || tr ? (0, $.isWeb)() && eB.supports(eE.AN.NOISE_CANCELLATION) ? (tr = !0, r.emitChange()) : (0, $.isWeb)() && tF({
    noiseCancellation: !1
  }) : (tn = !0, nV())
}
...
function nW(e) {
  ...
  }), eB.eachConnection(e => e.setVoiceFilterId(t))
}
...
function nq(e) {
  ...
  }), eB.setAudioInputBypassSystemProcessing(t), nm(e.location)
}
...
function nX(e) {
  e === eE.iA.AUTOMATIC ? (tF({
    automaticAudioSubsystem: !0
  }), nJ()) : (tF({
    automaticAudioSubsystem: !1
  }), eB.setAudioSubsystem(e))
}
...
function n5(e) {
  let {
    ...
    applicationName: n,
    quality: i
  } = e, a = T.Z.isDecoupledGameClippingEnabled(), s = T.Z.getSettings().decoupledClipsEnabled;
...
function n8(e) {
  ...
  if ((null == a ? void 0 : a.desktopSettings) != null) {
    ...
    $.isPlatformEmbedded && !0 === o && ({
      soundshareId: e,
      soundshareSession: r
    } = tJ(c), null != e && t$(e, r)), tC(s), tP(s === eE.Yn.STREAM && e0, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
...
function re(e) {
  ...
  eB.setH264Enabled(n.hardwareEncoding || n.openH264), eB.eachConnection(e => {
    var t;
...
class rd extends(c = g.ZP.Store) {
  ...
  getVideoStreamParameters() {
    ...
    return this.isSimulcastSupported() && (e === eE.Yn.DEFAULT || this.goLiveSimulcastEnabled()) && t.push({
      rid: "50",
      type: e === eE.Yn.DEFAULT ? eE.Tr.VIDEO : eE.Tr.SCREEN,
      quality: eE.LD
    }), t
