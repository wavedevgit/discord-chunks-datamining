...
function tN() {
  ej.on(m.aB.Connection, e => {
    ...
    }(0, X.isWindows)() ? (null == t_ ? void 0 : t_.startsWith("NVIDIA")) ? e.setExperimentFlag(eh.V8.SIGNAL_AV1, !0): (null == t_ ? void 0 : t_.startsWith("AMD")) && parseInt(null !== (a = null === (i = t_.match(/\d+/)) || void 0 === i ? void 0 : i.at(0)) && void 0 !== a ? a : "0", 10) >= 9e3 && D.Z.getCurrentConfig({
      location: "setupMediaEngine"
    }, {
      autoTrackExposure: !0
    }).signalAV1Support ? e.setExperimentFlag(eh.V8.SIGNAL_AV1, !0) : e.setExperimentFlag(eh.V8.SIGNAL_AV1_DECODE, !0): ((0, X.isMac)() || (0, X.isLinux)()) && e.setExperimentFlag(eh.V8.SIGNAL_AV1_DECODE, !0), (0, X.isWindows)() && e.setExperimentFlag(eh.V8.SIGNAL_AV1_HARDWARE_DECODE, !0), ej.setHasFullbandPerformance((0, N.Z)());
    ...
    e.on(m.Sh.SoundshareTrace, e => {
      switch (e.type) {
        ...
        case "soundshare_recv_failed":
          let t = e.reason,
            n = e.code,
            r = e.retry;
          (null == o ? void 0 : o.desktopSource) == null || (tS(null == o ? void 0 : o.desktopSource, n, t, r), r || (h.stop(), b.Z.wait(() => b.Z.dispatch({
            type: "MEDIA_ENGINE_SOUNDSHARE_FAILED",
            errorMessage: t,
            errorCode: n
          }))));
      ...
      ey.warn("voiceactivitydetectorerror event: ".concat(e)), (0, A.kr)(A.u.NOISE_CANCELLER_ERROR, {
        ...
        mode: ed.pM4.VOICE_ACTIVITY,
        options: ev(eE({}, tE(eh.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: !1
        })
      }), b.Z.dispatch({
...
function tW(e) {
  ...
  let t = tE();
  tR() && (t.automaticAudioSubsystem && nG(), t.audioSubsystemSettingVersion < eC && (tD({
...
function t2(e) {
  ...
  if (I[u] === ed.ZUi.AUTO_PROBING && d === ed.ZUi.AUTO_ENABLED && (0, V.Z)(u, p ? eh.fC.AUTO_DISABLE : eh.fC.AUTO_ENABLE, E), I[u] = d, tD({
      videoToggleStateMap: I
  ...
  v && !p && tc.delete(u), p ? h[u] = !0 : delete h[u], tD({
    disabledLocalVideos: h
...
function t7(e) {
  ...
  tD({
    mode: n,
    modeOptions: r
  }, t), ej.eachConnection(tb), tP.update()
}
...
function nD() {
  !nw() || __OVERLAY__ || e8 || e9 ? (0, X.isWeb)() && ej.supports(eh.AN.NOISE_CANCELLATION) ? (e9 = !0, r.emitChange()) : (0, X.isWeb)() && tD({
    noiseCancellation: !1
  }) : (e8 = !0, nP())
}
...
function nz(e) {
  ...
  if ((null == o ? void 0 : o.desktopSettings) != null) {
    ...
    X.isPlatformEmbedded && !0 === a && ({
      soundshareId: e,
      soundshareSession: r
    } = tZ(c), null != e && tH(e, r)), tO(s), tI(s === eh.Yn.STREAM && eQ, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
