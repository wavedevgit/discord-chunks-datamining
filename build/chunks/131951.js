...
function tA(e, t, n, r) {
  ...
  o && tg[a].add(t), (null == t || o) && z.default.track(ed.rMx.SOUNDSHARE_FAILED, eE({
...
function tP() {
  ej.on(g.aB.Connection, e => {
    ...
    let o = es.Z.getGuildId(),
      {
        ...
        skipEncode: c
      } = (null != o ? k.Z : x.Z).getCurrentConfig(eE({
    ...
    }), e.context === eh.Yn.DEFAULT && (e0 = !1, e1 = !1, e.on(g.Sh.SpeakingWhileMuted, () => {
      e0 = !0, e1 = !0, r.emitChange(), e2.stop(), e2.start(ex, () => {
        e1 = !1, r.emitChange()
      })
    ...
    e.on(g.Sh.SoundshareTrace, e => {
      switch (e.type) {
        ...
        case "soundshare_recv_failed":
          let t = e.reason,
            n = e.code,
            r = e.retry;
          (null == a ? void 0 : a.desktopSource) != null && (tA(null == a ? void 0 : a.desktopSource, n, t, r), r || (_.stop(), y.Z.wait(() => y.Z.dispatch({
            type: "MEDIA_ENGINE_SOUNDSHARE_FAILED",
            errorMessage: t,
            errorCode: n
          }))));
      ...
      eO.warn("noisecancellererror event: ".concat(e)), (0, C.kr)({
      ...
      eO.warn("voiceactivitydetectorerror event: ".concat(e)), (0, C.kr)({
        type: C.u.NOISE_CANCELLER_ERROR,
        underlyingError: tN(e)
    ...
    (0, C.kr)(t === C.u.VIDEO_ENCODE_ERROR ? ey(eE({
      type: t
    }, n), {
...
let tk = new class {
  ...
  stop() {
    this.started && (this.started = !1, null != this.stateChangeTimeout && (clearTimeout(this.stateChangeTimeout), this.stateChangeTimeout = null), ej.removeListener(g.aB.Silence, this.handleSilence), y.Z.dispatch({
...
function tM() {
  ...
  null != t && (E.K.set(ev, {
    [eh.Yn.DEFAULT]: t
  }), E.K.remove("audio")), eU = null != (e = E.K.get(ev)) ? e : {}, f().each(eU, e => {
...
function tB() {
  eB || ej.enable().then(() => y.Z.dispatch({
...
function tK() {
  ...
  for (let e of Object.keys(r)) {
    ...
    for (let [e, t] of Object.entries(o)) null == (0, H.Ky)(i, e) && (t.muted ? s[e] = !0 : delete s[e], t.volume !== a ? l[e] = t.volume : delete l[e], ej.eachConnection(n => {
      n.setLocalVolume(e, t.volume), n.setLocalMute(e, t.muted)
    }, i));
    if (n)
      for (let e of new Set([...Object.keys(s), ...Object.keys(l)])) null == o[e] && (delete s[e], delete l[e], ej.eachConnection(t => {
...
function tQ(e) {
  i = e.sessionId, eK = !1, eQ = !1, (0, X.isWeb)() || (U.Z.subscribe({
  ...
  let t = ty();
  tL() && (tx() ? nY(eh.iA.AUTOMATIC) : t.automaticAudioSubsystem && nW()), (0, K.wt)({
...
function t6(e) {
  ...
  r[n] ? delete r[n] : r[n] = !0, tj({
    localMutes: r
  }, t), ej.eachConnection(e => e.setLocalMute(n, r[n] || !1), t)
}
...
function t8(e) {
  ...
  if (I[c] === ed.ZUi.AUTO_PROBING && d === ed.ZUi.AUTO_ENABLED && (0, V.Z)(c, p ? eh.fC.AUTO_DISABLE : eh.fC.AUTO_ENABLE, E), I[c] = d, tj({
      videoToggleStateMap: I
    }, l, f), d === ed.ZUi.AUTO_PROBING ? null == (n = es.Z.getRTCConnection()) || n.pauseStatsCollectionForUser(c, !0) : null == (r = es.Z.getRTCConnection()) || r.pauseStatsCollectionForUser(c, !1), td || (eO.info("isAutoDisableAllowed=".concat(td, " - disabling VideoHealthManager")), null == (a = es.Z.getRTCConnection()) || null == (i = a.getVideoHealthManager()) || i.disable()), O) {
    if (!p && !g || p && !td) return;
  ...
  y && !p && tu.delete(c), p ? h[c] = !0 : delete h[c], tj({
    disabledLocalVideos: h
...
function nn(e) {
  ...
  tj({
    mode: n,
    modeOptions: r
  }, t), ej.eachConnection(tO), tk.update()
}
...
function na(e) {
  ...
  t = tZ(eH, t), eZ = performance.now(), tj({
    inputDeviceId: t
  }), ej.setAudioInputDevice(t)
}
...
function nI(e) {
  ...
  }), ej.setH264Enabled(i.hardwareEncoding || i.openH264), ej.setAv1Enabled(null == (t = i.hardwareEncoding) || t), ej.setH265Enabled(null == (n = i.hardwareEncoding) || n)
}
...
function nU() {
  !nj() || __OVERLAY__ || e9 || te ? (0, X.isWeb)() && ej.supports(eh.AN.NOISE_CANCELLATION) ? (te = !0, r.emitChange()) : (0, X.isWeb)() && tj({
    noiseCancellation: !1
  }) : (e9 = !0, nM())
}
...
function nZ(e) {
  ...
  }), ej.setAudioInputBypassSystemProcessing(t), nd(e.location)
}
...
function n1(e) {
  ...
  if ((null == a ? void 0 : a.desktopSettings) != null) {
    ...
    X.isPlatformEmbedded && !0 === o && ({
      soundshareId: e,
      soundshareSession: r
    } = tz(c), null != e && tq(e, r)), tS(s), tT(s === eh.Yn.STREAM && eX, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
...
function n4(e) {
  ...
  ej.setH264Enabled(n.hardwareEncoding || n.openH264), ej.eachConnection(e => {
    var t;
