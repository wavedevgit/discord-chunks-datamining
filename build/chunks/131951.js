...
let eG = {},
  ...
  eH = performance.now(),
  eY = {
    [em.w5]: tZ("No Input Devices")
  },
  eW = {
    [em.w5]: tZ("No Output Devices")
  },
  eK = {
    [em.w5]: tZ("No Video Devices")
  },
  ez = !1,
  eq = !1,
  eQ = !1,
  ...
  tl = !1,
  tc = !1;
Z.Z.hasPermission(e_.Eu.AUDIO, {
  showAuthorizationError: !1
}), Z.Z.hasPermission(e_.Eu.CAMERA, {
  showAuthorizationError: !1
});
let tu = !1,
  td = new Set,
...
function tv() {
  ...
  return eO(eb({}, i, a), {
    modeOptions: eb({}, null != (t = i.modeOptions) ? t : {}, null != (n = a.modeOptions) ? n : {})
  })
}
...
function tN() {
  ...
  if ((null == s ? void 0 : s.desktopSource) != null && s.desktopSource.id !== (null == o || null == (e = o.desktopSource) ? void 0 : e.id) && (null != s.desktopSource.soundshareId && (0, X.isWindows)() && v.pn(s.desktopSource.soundshareId), eU.setGoLiveSource(null, eZ)), (null == s ? void 0 : s.cameraSource) != null && (s.cameraSource.videoDeviceGuid !== (null == o || null == (t = o.cameraSource) ? void 0 : t.videoDeviceGuid) || s.cameraSource.audioDeviceGuid !== (null == o || null == (n = o.cameraSource) ? void 0 : n.audioDeviceGuid)) && eU.setGoLiveSource(null, eZ), (eJ || i) && (e$ = (eJ = i) ? tY(eK, tv().videoDeviceId) : em.Av, eU.setVideoInputDevice(e$)), a = o, null != o) {
    ...
    null != o.cameraSource && eU.setGoLiveSource({
      cameraDescription: {
...
function tC(e, t, n, r) {
  ...
  o && tE[a].add(t), (null == t || o) && z.default.track(ed.rMx.SOUNDSHARE_FAILED, eb({
...
function tw() {
  eU.on(g.aB.Connection, e => {
    ...
    let o = es.Z.getGuildId(),
      {
        ...
        skipEncode: c
      } = (null != o ? k.Z : x.Z).getCurrentConfig(eb({
    ...
    if (e.setRemoteAudioHistory(1e3 * !!f), (0, T.Z)(r)) {
    ...
    e.on(g.Sh.Speaking, (t, n) => {
      ...
      (null == a ? void 0 : a.desktopSource) != null && (z.default.track(ed.rMx.SOUNDSHARE_TRANSMITTING, (0, D.Z)(null == a ? void 0 : a.desktopSource)), null != eo.Z.getHookError(ed.K3D.SOUND) && y.Z.wait(() => y.Z.dispatch({
    ...
    e.on(g.Sh.SoundshareTrace, e => {
      switch (e.type) {
        ...
        case "soundshare_recv_failed":
          let t = e.reason,
            n = e.code,
            r = e.retry;
          (null == a ? void 0 : a.desktopSource) != null && (tC(null == a ? void 0 : a.desktopSource, n, t, r), r || (_.stop(), y.Z.wait(() => y.Z.dispatch({
            type: "MEDIA_ENGINE_SOUNDSHARE_FAILED",
            errorMessage: t,
            errorCode: n
          }))));
        ...
        case "soundshare_state_transition":
          4 === e.newState && (_.stop(), y.Z.wait(() => y.Z.dispatch({
            type: "MEDIA_ENGINE_SOUNDSHARE_TRANSMITTING"
          })))
      }
      ...
      (null == a ? void 0 : a.desktopSource) != null && z.default.track(ed.rMx.VIDEOHOOK_INITIALIZED, eb({
        backend: e,
        format: t,
      ...
      ev.warn("noisecancellererror event: ".concat(e)), (0, C.kr)({
        type: C.u.NOISE_CANCELLER_ERROR,
        underlyingError: tP(e)
      }), ts = !0, z.default.track(ed.rMx.VOICE_PROCESSING, {
      ...
      ev.warn("voiceactivitydetectorerror event: ".concat(e)), (0, C.kr)({
        type: C.u.NOISE_CANCELLER_ERROR,
        underlyingError: tP(e)
        ...
        mode: ed.pM4.VOICE_ACTIVITY,
        options: eO(eb({}, tv(em.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: !1
        })
      }), y.Z.dispatch({
    ...
    ev.warn("Watchdog timeout, report submission status: ".concat(null != e ? e : 200)), z.default.track(ed.rMx.VOICE_WATCHDOG_TIMEOUT, {
    ...
    (0, C.kr)(t === C.u.VIDEO_ENCODE_ERROR ? eO(eb({
      type: t
    }, n), {
    ...
    y.Z.wait(() => y.Z.dispatch({
      type: "VIDEO_SIZE_UPDATE",
      streamId: e,
      width: t,
      height: n
    }))
  }), tj.reset(), (0, el.q)().then(e => {
...
let tj = new class {
  ...
  stop() {
    this.started && (this.started = !1, null != this.stateChangeTimeout && (clearTimeout(this.stateChangeTimeout), this.stateChangeTimeout = null), eU.removeListener(g.aB.Silence, this.handleSilence), y.Z.dispatch({
  ...
  constructor() {
    eE(this, "stateChangeTimeout", void 0), eE(this, "noVoiceTimeout", 5e3), eE(this, "voiceTimeout", 1500), eE(this, "started", !1), eE(this, "handleSilence", e => {
      ...
      null != this.stateChangeTimeout && clearTimeout(this.stateChangeTimeout), this.stateChangeTimeout = setTimeout(() => {
        this.stateChangeTimeout = null, this.started && (y.Z.dispatch({
          type: "AUDIO_INPUT_DETECTED",
          inputDetected: t
        }), e && (e7 = !0))
...
function tU() {
  ...
  null != t && (E.K.set(eI, {
    [em.Yn.DEFAULT]: t
  }), E.K.remove("audio")), eG = null != (e = E.K.get(eI)) ? e : {}, f().each(eG, e => {
...
function tV() {
  eF || eU.enable().then(() => y.Z.dispatch({
...
function tq() {
  ...
  for (let e of Object.keys(r)) {
    ...
    for (let [e, t] of Object.entries(o)) null == (0, H.Ky)(i, e) && (t.muted ? s[e] = !0 : delete s[e], t.volume !== a ? l[e] = t.volume : delete l[e], eU.eachConnection(n => {
      n.setLocalVolume(e, t.volume), n.setLocalMute(e, t.muted)
    }, i));
    if (n)
      for (let e of new Set([...Object.keys(s), ...Object.keys(l)])) null == o[e] && (delete s[e], delete l[e], eU.eachConnection(t => {
...
function tX(e, t) {
  (0, X.isWindows)() && v.YT(e, {
    ...
    null == t || w.ZP.shouldContinueWithoutElevatedProcessForPID(e) || y.Z.wait(() => {
      y.Z.dispatch({
        type: "MEDIA_ENGINE_SOUNDSHARE_FAILED",
        errorMessage: t
      })
...
function tJ(e) {
  i = e.sessionId, ez = !1, eX = !1, (0, X.isWeb)() || (U.Z.subscribe({
    location: "handleConnectionOpen"
  }, e => {
    let t = tv();
    !e.sidechainAvailable && t.sidechainCompression ? (tG({
      sidechainCompressionSettingVersion: 0
    }), nE(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eC && (tG({
      sidechainCompressionSettingVersion: eC
    }), nE(e.sidechainEnabled))
  }), ny());
  let t = tv();
  tk() && (tM() ? nz(em.iA.AUTOMATIC) : t.automaticAudioSubsystem && nq()), (0, W.wt)({
    location: "MediaEngineStore",
    autoTrackExposure: !1
  }) && null !== t.mostRecentlyRequestedVoiceFilter && (0, X.isDesktop)() && (K.Z.getLastInitAttemptMayHaveCrashed() ? (y.Z.dispatch({
...
function t9(e) {
  ...
  if (I[c] === ed.ZUi.AUTO_PROBING && d === ed.ZUi.AUTO_ENABLED && (0, V.Z)(c, p ? em.fC.AUTO_DISABLE : em.fC.AUTO_ENABLE, E), I[c] = d, tG({
      videoToggleStateMap: I
    }, l, f), d === ed.ZUi.AUTO_PROBING ? null == (n = es.Z.getRTCConnection()) || n.pauseStatsCollectionForUser(c, !0) : null == (r = es.Z.getRTCConnection()) || r.pauseStatsCollectionForUser(c, !1), tf || (ev.info("isAutoDisableAllowed=".concat(tf, " - disabling VideoHealthManager")), null == (a = es.Z.getRTCConnection()) || null == (i = a.getVideoHealthManager()) || i.disable()), O) {
    if (!p && !g || p && !tf) return;
  ...
  y && !p && td.delete(c), p ? h[c] = !0 : delete h[c], tG({
    disabledLocalVideos: h
...
function ni(e) {
  ...
  tG({
    mode: n,
    modeOptions: r
  }, t), eU.eachConnection(tI), tj.update()
}
...
function ns(e) {
  ...
  t = tY(eY, t), eH = performance.now(), tG({
    inputDeviceId: t
  }), eU.setAudioInputDevice(t)
}
...
function nu(e) {
  ...
  }), eU.setAudioInputBypassSystemProcessing(n.bypassSystemInputProcessing), tj.update(), nO()
}
...
function nA(e) {
  ...
  }), eU.setH264Enabled(i.hardwareEncoding || i.openH264), eU.setAv1Enabled(null == (t = i.hardwareEncoding) || t), eU.setH265Enabled(null == (n = i.hardwareEncoding) || n)
}
...
function nF() {
  !nB() || __OVERLAY__ || te || tt ? (0, X.isWeb)() && eU.supports(em.AN.NOISE_CANCELLATION) ? (tt = !0, r.emitChange()) : (0, X.isWeb)() && tG({
    noiseCancellation: !1
  }) : (te = !0, nG())
}
...
function nW(e) {
  ...
  }), eU.setAudioInputBypassSystemProcessing(t), np(e.location)
}
...
function n2(e) {
  let {
    ...
    applicationName: n,
    quality: i
  } = e, a = S.Z.isDecoupledGameClippingEnabled(), s = S.Z.getSettings().decoupledClipsEnabled;
...
function n4(e) {
  ...
  if ((null == a ? void 0 : a.desktopSettings) != null) {
    ...
    X.isPlatformEmbedded && !0 === o && ({
      soundshareId: e,
      soundshareSession: r
    } = tQ(c), null != e && tX(e, r)), tA(s), tN(s === em.Yn.STREAM && eJ, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
