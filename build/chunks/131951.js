...
let eY = {},
  ...
  eX = performance.now(),
  eQ = {
    [eO.w5]: tz("No Input Devices")
  },
  eJ = {
    [eO.w5]: tz("No Output Devices")
  },
  e$ = {
    [eO.w5]: tz("No Video Devices")
  },
  e0 = !1,
  e1 = !1,
  e2 = !1,
  ...
  tm = !1,
  tg = !1;
z.Z.hasPermission(eE.Eu.AUDIO, {
  showAuthorizationError: !1
}), z.Z.hasPermission(eE.Eu.CAMERA, {
  showAuthorizationError: !1
});
let tE = !1,
  tb = new Set,
...
function tC() {
  ...
  return eA(eT({}, i, a), {
    modeOptions: eT({}, null != (t = i.modeOptions) ? t : {}, null != (n = a.modeOptions) ? n : {})
  })
}
...
function tL() {
  ...
  if ((null == s ? void 0 : s.desktopSource) != null && s.desktopSource.id !== (null == o || null == (e = o.desktopSource) ? void 0 : e.id) && (null != s.desktopSource.soundshareId && (0, er.isWindows)() && T.pn(s.desktopSource.soundshareId), eH.setGoLiveSource(null, eq)), (null == s ? void 0 : s.cameraSource) != null && (s.cameraSource.videoDeviceGuid !== (null == o || null == (t = o.cameraSource) ? void 0 : t.videoDeviceGuid) || s.cameraSource.audioDeviceGuid !== (null == o || null == (n = o.cameraSource) ? void 0 : n.audioDeviceGuid)) && eH.setGoLiveSource(null, eq), (e4 || i) && (e5 = (e4 = i) ? tX(e$, tC().videoDeviceId) : eO.Av, eH.setVideoInputDevice(e5)), a = o, null != o) {
    ...
    null != o.cameraSource && eH.setGoLiveSource({
      cameraDescription: {
...
function tM() {
  eH.on(b.aB.Connection, e => {
    ...
    let o = ef.Z.getGuildId(),
      {
        ...
        skipEncode: c
      } = (null != o ? U.Z : j.Z).getCurrentConfig(eT({
    ...
    s && e.setExperimentFlag(eO.V8.MUTE_BEFORE_PROCESSING, !0), l && e.setExperimentFlag(eO.V8.PTT_BEFORE_PROCESSING, !0), c && e.setExperimentFlag(eO.V8.SKIP_ENCODE, !0), null != o && V.Z.getCurrentConfig({
      location: "setupMediaEngine",
      guildId: o
    }, {
      autoTrackExposure: !0
    }).enabled && e.setExperimentFlag(eO.V8.SIGNAL_RED, !0);
    let u = !1,
      d = !0;
    ...
    e.on(b.Sh.Speaking, (t, n) => {
    ...
    }), e.context === eO.Yn.DEFAULT && (e8 = !1, e7 = !1, e.on(b.Sh.SpeakingWhileMuted, () => {
      e8 = !0, e7 = !0, r.emitChange(), e9.stop(), e9.start(eB, () => {
        e7 = !1, r.emitChange()
      })
      ...
      (null == a ? void 0 : a.desktopSource) != null && ee.default.track(em.rMx.VIDEOHOOK_INITIALIZED, eT({
        backend: e,
        format: t,
      ...
      }), th = !0, ee.default.track(em.rMx.VOICE_PROCESSING, {
      ...
      eN.warn("voiceactivitydetectorerror event: ".concat(e)), (0, P.kr)({
        ...
        mode: em.pM4.VOICE_ACTIVITY,
        options: eA(eT({}, tC(eO.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: !1
        })
      }), v.Z.dispatch({
    ...
    }), e.setBitRate(ec.Z.bitrate), e.applyVideoQualityMode(eh.Z.mode)
    ...
    let e;
    try {
      await et.Z.submitLiveCrashReport({
        message: {
    ...
    eN.warn("Watchdog timeout, report submission status: ".concat(null != e ? e : 200)), ee.default.track(em.rMx.VOICE_WATCHDOG_TIMEOUT, {
    ...
    (0, P.kr)(t === P.u.VIDEO_ENCODE_ERROR ? eA(eT({
      type: t
    }, n), {
...
let tF = new class {
  ...
  stop() {
    this.started && (this.started = !1, null != this.stateChangeTimeout && (clearTimeout(this.stateChangeTimeout), this.stateChangeTimeout = null), eH.removeListener(b.aB.Silence, this.handleSilence), v.Z.dispatch({
  ...
  constructor() {
    eI(this, "stateChangeTimeout", void 0), eI(this, "noVoiceTimeout", 5e3), eI(this, "voiceTimeout", 1500), eI(this, "started", !1), eI(this, "handleSilence", e => {
      let t = !e;
...
function tZ() {
  ...
  null != t && (y.K.set(eC, {
    [eO.Yn.DEFAULT]: t
  }), y.K.remove("audio")), eY = null != (e = y.K.get(eC)) ? e : {}, p().each(eY, e => {
...
function tK() {
  eK || eH.enable().then(() => v.Z.dispatch({
...
function t0() {
  ...
  for (let e of Object.keys(r)) {
    ...
    for (let [e, t] of Object.entries(o)) null == (0, X.Ky)(i, e) && (t.muted ? s[e] = !0 : delete s[e], t.volume !== a ? l[e] = t.volume : delete l[e], eH.eachConnection(n => {
      n.setLocalVolume(e, t.volume), n.setLocalMute(e, t.muted)
    }, i));
    if (n)
      for (let e of new Set([...Object.keys(s), ...Object.keys(l)])) null == o[e] && (delete s[e], delete l[e], eH.eachConnection(t => {
...
function t1(e) {
  ...
  };
  {
    let t = r.getExperimentalSoundshare() ? e : et.Z.getAudioPid(e),
      n = "";
    return null != t && (n = et.Z.generateSessionFromPid(t)), {
      soundshareId: t,
      soundshareSession: n
    }
  }
...
function t3(e) {
  i = e.sessionId, e0 = !1, e3 = !1, (0, er.isWeb)() || (Z.Z.subscribe({
    location: "handleConnectionOpen"
  }, e => {
    let t = tC();
    !e.sidechainAvailable && t.sidechainCompression ? (tH({
      sidechainCompressionSettingVersion: 0
    }), nI(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eL && (tH({
      sidechainCompressionSettingVersion: eL
  ...
  if (tB() && (tV() ? n2(eO.iA.AUTOMATIC) : t.automaticAudioSubsystem && n3()), eH.supports(eO.AN.OFFLOAD_ADM_CONTROLS)) {
    ...
    autoTrackExposure: !1
  }) && null !== t.mostRecentlyRequestedVoiceFilter && (0, er.isDesktop)() && ($.Z.getLastInitAttemptMayHaveCrashed() ? (v.Z.dispatch({
...
function nr(e) {
  ...
  r[n] ? delete r[n] : r[n] = !0, tH({
    localMutes: r
  }, t), eH.eachConnection(e => e.setLocalMute(n, r[n] || !1), t)
}
...
function ni(e) {
  ...
  if (I[c] === em.ZUi.AUTO_PROBING && u === em.ZUi.AUTO_ENABLED && (0, K.Z)(c, p ? eO.fC.AUTO_DISABLE : eO.fC.AUTO_ENABLE, E), I[c] = u, tH({
      videoToggleStateMap: I
    }, l, d), u === em.ZUi.AUTO_PROBING ? null == (n = ef.Z.getRTCConnection()) || n.pauseStatsCollectionForUser(c, !0) : null == (r = ef.Z.getRTCConnection()) || r.pauseStatsCollectionForUser(c, !1), ty || (eN.info("isAutoDisableAllowed=".concat(ty, " - disabling VideoHealthManager")), null == (a = ef.Z.getRTCConnection()) || null == (i = a.getVideoHealthManager()) || i.disable()), O) {
    if (!p && !g || p && !ty) return;
  ...
  y && !p && tb.delete(c), p ? h[c] = !0 : delete h[c], tH({
    disabledLocalVideos: h
  }, l, d), eH.eachConnection(e => {
    var t;
...
function ns(e) {
  ...
  r === i ? delete a[n] : a[n] = r, tH({
    localVolumes: a
  }, t), eH.eachConnection(e => e.setLocalVolume(n, r), t)
}
...
function nl(e) {
  ...
  a[n] = {
    ...
    localPans: a
  }, t), eH.eachConnection(e => e.setLocalPan(n, r, i), t)
}
...
function nc(e) {
  ...
  tH({
    mode: n,
    modeOptions: r
  }, t), eH.eachConnection(tR), tF.update()
}
...
function nf(e) {
  ...
  t = tX(eQ, t), eX = performance.now(), tH({
    inputDeviceId: t
  }), eH.setAudioInputDevice(t)
}
...
function nh(e) {
  ...
  }), eH.setAudioInputBypassSystemProcessing(n.bypassSystemInputProcessing), tF.update(), nA()
}
...
async function nK() {
  try {
    ...
    ts = !0, s = null == (e = a.getSdkVersion) ? void 0 : e.call(a), l = null != (i = null == (t = a.getSuppressionLevel) ? void 0 : t.call(a)) ? i : 100, null == (n = a.getNcModels) || n.call(a).then(e => {
      tl = e, r.emitChange()
    }), r.emitChange()
  } catch (t) {
...
function nq() {
  !nz() || __OVERLAY__ || to || ts ? (0, er.isWeb)() && eH.supports(eO.AN.NOISE_CANCELLATION) ? (ts = !0, r.emitChange()) : (0, er.isWeb)() && tH({
    noiseCancellation: !1
  }) : (to = !0, nK())
}
...
function nQ(e) {
  ...
  }), eH.eachConnection(e => e.setVoiceFilterId(t))
}
...
function n0(e) {
  ...
  }), eH.setAudioInputBypassSystemProcessing(t), nb(e.location)
}
...
function n2(e) {
  e === eO.iA.AUTOMATIC ? (tH({
    automaticAudioSubsystem: !0
  }), n3()) : (tH({
    automaticAudioSubsystem: !1
  }), eH.setAudioSubsystem(e))
}
...
function rn(e) {
  ...
  if ((null == a ? void 0 : a.desktopSettings) != null) {
    ...
    er.isPlatformEmbedded && !0 === o && ({
      soundshareId: e,
      soundshareSession: r
    } = t1(c), null != e && t2(e, r)), tD(s), tL(s === eO.Yn.STREAM && e4, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
...
function ra(e) {
  ...
  eH.setH264Enabled(n.hardwareEncoding || n.openH264), eH.eachConnection(e => {
    var t;
...
class rm extends(u = E.ZP.Store) {
  ...
  getVideoStreamParameters() {
    ...
    return this.isSimulcastSupported() && (e === eO.Yn.DEFAULT || this.goLiveSimulcastEnabled()) && t.push({
      rid: "50",
      type: e === eO.Yn.DEFAULT ? eO.Tr.VIDEO : eO.Tr.SCREEN,
      quality: eO.LD
    }), t
  ...
  fetchAsyncResources() {
    ...
    return (0, er.isWeb)() && (e.fetchDave = F.N.getCurrentConfig({
      location: "MediaEngineStore fetchAsyncResources"
    }).loadWasmModule), eH.fetchAsyncResources(e)
  }
