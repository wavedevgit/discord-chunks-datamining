...
let eK = {},
  ...
  eJ = performance.now(),
  e$ = {
    [eI.w5]: tJ("No Input Devices")
  },
  e0 = {
    [eI.w5]: tJ("No Output Devices")
  },
  e1 = {
    [eI.w5]: tJ("No Video Devices")
  },
  e2 = !1,
  e3 = !1,
  e5 = !1,
  ...
  tE = !1,
  tb = !1;
X.Z.hasPermission(ey.Eu.AUDIO, {
  showAuthorizationError: !1
}), X.Z.hasPermission(ey.Eu.CAMERA, {
  showAuthorizationError: !1
});
let ty = !1,
  tO = new Set,
...
function tC() {
  var e, t;
  return null != (t = null == (e = em.default.getCurrentUser()) ? void 0 : e.isStaff()) && t ? "always" : ea.Z === g.R.CANARY ? "permittedDevicesOnly" : "never"
}
...
function tL(e) {
  let t = tP(e.context),
    n = !eq || t.mute || t.deaf;
  e.context === eI.Yn.DEFAULT ? n = n || e2 || e3 || e5 || !X.Z.didHavePermission(ey.Eu.AUDIO) : e.context === eI.Yn.STREAM && (n = !0), e.setSelfMute(n), e.setSelfDeaf(t.deaf), e.context === eI.Yn.DEFAULT && S.Z.updateNativeMute()
}
...
function tM() {
  ...
  let i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : e6,
    ...
    s = o;
  if ((null == s ? void 0 : s.desktopSource) != null && s.desktopSource.id !== (null == a || null == (e = a.desktopSource) ? void 0 : e.id) && (null != s.desktopSource.soundshareId && (0, eo.isWindows)() && T.pn(s.desktopSource.soundshareId), eW.setGoLiveSource(null, eQ)), (null == s ? void 0 : s.cameraSource) != null && (s.cameraSource.videoDeviceGuid !== (null == a || null == (t = a.cameraSource) ? void 0 : t.videoDeviceGuid) || s.cameraSource.audioDeviceGuid !== (null == a || null == (n = a.cameraSource) ? void 0 : n.audioDeviceGuid)) && eW.setGoLiveSource(null, eQ), (e6 || i) && (e8 = (e6 = i) ? t0(e1, tP().videoDeviceId) : eI.Av, eW.setVideoInputDevice(e8)), o = a, null != a) {
    let e = {
...
function tB() {
  eW.on(b.aB.Connection, e => {
    ...
    s && e.setExperimentFlag(eI.V8.MUTE_BEFORE_PROCESSING, !0), l && e.setExperimentFlag(eI.V8.PTT_BEFORE_PROCESSING, !0), c && e.setExperimentFlag(eI.V8.SKIP_ENCODE, !0), null != a && V.Z.getCurrentConfig({
      location: "setupMediaEngine",
      guildId: a
    }, {
      autoTrackExposure: !0
    }).enabled && e.setExperimentFlag(eI.V8.SIGNAL_RED, !0);
    let u = !1,
      d = !0;
    ...
    }(0, eo.isWindows)() ? (null == tS ? void 0 : tS.startsWith("NVIDIA")) || (null == tS ? void 0 : tS.startsWith("AMD")) ? e.setExperimentFlag(eI.V8.SIGNAL_AV1, !0): e.setExperimentFlag(eI.V8.SIGNAL_AV1_DECODE, !0): ((0, eo.isMac)() || (0, eo.isLinux)()) && e.setExperimentFlag(eI.V8.SIGNAL_AV1_DECODE, !0), (0, eo.isWindows)() && e.setExperimentFlag(eI.V8.SIGNAL_AV1_HARDWARE_DECODE, !0), eW.setHasFullbandPerformance((0, R.Z)());
    ...
    e.on(b.Sh.Speaking, (t, n) => {
    ...
    }), e.context === eI.Yn.DEFAULT && (e9 = !1, te = !1, e.on(b.Sh.SpeakingWhileMuted, () => {
      e9 = !0, te = !0, r.emitChange(), tt.stop(), tt.start(eF, () => {
        te = !1, r.emitChange()
      })
      ...
      (null == o ? void 0 : o.desktopSource) != null && en.default.track(eE.rMx.VIDEOHOOK_INITIALIZED, eA({
        backend: e,
        format: t,
      ...
      }), tg = !0, en.default.track(eE.rMx.VOICE_PROCESSING, {
    ...
    let e;
    try {
      await er.Z.submitLiveCrashReport({
        message: {
    ...
    eR.warn("Watchdog timeout, report submission status: ".concat(null != e ? e : 200)), en.default.track(eE.rMx.VOICE_WATCHDOG_TIMEOUT, {
...
function tV() {
  return (0, eo.isMac)() && eW.supports(eI.AN.SCREEN_CAPTURE_KIT) && m().satisfies(null === I.Z || void 0 === I.Z ? void 0 : I.Z.os.release, eb.C7)
}

function tH() {
  return (0, eo.isWindows)() && eW.supports(eI.AN.AUTOMATIC_AUDIO_SUBSYSTEM) && eW.supports(eI.AN.AUDIO_SUBSYSTEM_DEFERRED_SWITCH)
}
...
let tW = new class {
  ...
  stop() {
    this.started && (this.started = !1, null != this.stateChangeTimeout && (clearTimeout(this.stateChangeTimeout), this.stateChangeTimeout = null), eW.removeListener(b.aB.Silence, this.handleSilence), v.Z.dispatch({
  ...
  update() {
    let e = tP();
    !to && ep.Z.getState() === eE.hes.RTC_CONNECTED && e.mode === eE.pM4.VOICE_ACTIVITY && e.silenceWarning ? this.start() : this.stop()
  }
  reset() {
...
function tK() {
  ...
  null != t && (y.K.set(eP, {
    [eI.Yn.DEFAULT]: t
  }), y.K.remove("audio")), eK = null != (e = y.K.get(eP)) ? e : {}, p().each(eK, e => {
    ...
    }(0, eo.isWeb)() ? e.ncUseKrispjsSettingVersion !== eL && (e.ncUseKrispjsSettingVersion = eL, e.noiseSuppression = !1, e.noiseCancellation = !0): e.ncUseKrispSettingVersion !== eD && (e.ncUseKrispSettingVersion = eD, e.noiseSuppression = !1, e.noiseCancellation = !0), e.hardwareEnabledVersion !== ex && (e.hardwareH264 = !0, e.hardwareEnabledVersion = ex), null == e.hardwareEncoding && (e.hardwareEncoding = e.hardwareH264)
  }), tX()
}
...
function tQ() {
  eq || eW.enable().then(() => v.Z.dispatch({
...
function t5() {
  ...
  let n = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
    r = null != (e = $.Z.settings.audioContextSettings) ? e : {
      user: {},
      stream: {}
    };
  for (let e of Object.keys(r)) {
    ...
    for (let [e, t] of Object.entries(a)) null == (0, J.Ky)(i, e) && (t.muted ? s[e] = !0 : delete s[e], t.volume !== o ? l[e] = t.volume : delete l[e], eW.eachConnection(n => {
      n.setLocalVolume(e, t.volume), n.setLocalMute(e, t.muted)
    }, i));
    if (n)
      for (let e of new Set([...Object.keys(s), ...Object.keys(l)])) null == a[e] && (delete s[e], delete l[e], eW.eachConnection(t => {
...
function t8(e) {
  i = e.sessionId, e2 = !1, e4 = !1, (0, eo.isWeb)() || (Y.Z.subscribe({
    location: "handleConnectionOpen"
  }, e => {
    let t = tP();
    !e.sidechainAvailable && t.sidechainCompression ? (tz({
      sidechainCompressionSettingVersion: 0
    }), nN(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eM && (tz({
...
function nt(e) {
  ...
  return t.reduce((e, t) => i === t.sessionId ? (e2 = t.mute || t.suppress, e4 = t.deaf, eW.eachConnection(tL), tM((null == t.guildId || null == t.channelId || null == tm || tm === t.channelId) && e6), tm = t.channelId, !0) : (__OVERLAY__ || t.userId !== eu.default.getId() || null != ep.Z.getChannelId() || tM(!1, null), e), !1)
}
...
function ns(e) {
  ...
  r[n] ? delete r[n] : r[n] = !0, tz({
    localMutes: r
  }, t), eW.eachConnection(e => e.setLocalMute(n, r[n] || !1), t)
}
...
function nl(e) {
  ...
  if (I[c] === eE.ZUi.AUTO_PROBING && u === eE.ZUi.AUTO_ENABLED && (0, q.Z)(c, p ? eI.fC.AUTO_DISABLE : eI.fC.AUTO_ENABLE, E), I[c] = u, tz({
      videoToggleStateMap: I
    }, l, d), u === eE.ZUi.AUTO_PROBING ? null == (n = ep.Z.getRTCConnection()) || n.pauseStatsCollectionForUser(c, !0) : null == (r = ep.Z.getRTCConnection()) || r.pauseStatsCollectionForUser(c, !1), tv || (eR.info("isAutoDisableAllowed=".concat(tv, " - disabling VideoHealthManager")), null == (o = ep.Z.getRTCConnection()) || null == (i = o.getVideoHealthManager()) || i.disable()), O) {
    if (!p && !g || p && !tv) return;
    (0, q.Z)(c, p ? eI.fC.AUTO_DISABLE : eI.fC.AUTO_ENABLE, E), p ? tO.add(c) : tO.delete(c)
  } else v && (g && !p ? (eR.info("disallowing auto-disable for this session because of manual override by user"), tv = !1, null == (s = ep.Z.getRTCConnection()) || null == (a = s.getVideoHealthManager()) || a.disable(), (0, q.Z)(c, eI.fC.MANUAL_REENABLE, E)) : (0, q.Z)(c, p ? eI.fC.MANUAL_DISABLE : eI.fC.MANUAL_ENABLE, E));
  y && !p && tO.delete(c), p ? h[c] = !0 : delete h[c], tz({
    disabledLocalVideos: h
...
function nc() {
  ...
  tO.forEach(n => {
    f()(t[n], "If you are auto-disabled, then you are also disabled."), delete t[n], eW.eachConnection(e => e.setLocalVideoDisabled(n, !1), e)
  }), tO.clear(), tz({
    disabledLocalVideos: t
  }, e, !1)
}
...
async function nQ() {
  try {
    ...
    tc = !0, s = null == (e = o.getSdkVersion) ? void 0 : e.call(o), l = null != (i = null == (t = o.getSuppressionLevel) ? void 0 : t.call(o)) ? i : 100, null == (n = o.getNcModels) || n.call(o).then(e => {
      tu = e, r.emitChange()
    }), r.emitChange()
  } catch (t) {
...
function n$() {
  !nJ() || __OVERLAY__ || tl || tc ? (0, eo.isWeb)() && eW.supports(eI.AN.NOISE_CANCELLATION) ? (tc = !0, r.emitChange()) : (0, eo.isWeb)() && tz({
    noiseCancellation: !1
  }) : (tl = !0, nQ())
}
...
class ry extends(u = E.ZP.Store) {
  ...
  isSelfMute() {
    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : eI.Yn.DEFAULT;
    return !this.isEnabled() || tP(e).mute || !X.Z.didHavePermission(ey.Eu.AUDIO) || this.isSelfDeaf(e) || e === eI.Yn.DEFAULT && e5
  }
  ...
  supportsExperimentalSoundshare() {
    return eW.supports(eI.AN.EXPERIMENTAL_SOUNDSHARE) && m().satisfies(null === I.Z || void 0 === I.Z ? void 0 : I.Z.os.release, eb.T6)
  }
  supportsHookSoundshare() {
    return (0, eo.isWindows)() && eW.supports(eI.AN.SOUNDSHARE) && m().satisfies(null === I.Z || void 0 === I.Z ? void 0 : I.Z.os.release, eb.sA)
  }
  getUseSystemScreensharePicker() {
    let e = this.supportsSystemScreensharePicker(),
      t = tP().useSystemScreensharePicker,
      n = (0, eo.isLinux)() || (0, eo.isMac)() && m().satisfies(null === I.Z || void 0 === I.Z ? void 0 : I.Z.os.release, eb.jR);
    return e && (null != t ? t : n)
  }
  ...
  supportsScreenSoundshare() {
    return (0, eo.isMac)() ? eW.supports(eI.AN.SOUNDSHARE) && m().satisfies(null === I.Z || void 0 === I.Z ? void 0 : I.Z.os.release, eb.yG) && tV() : (0, eo.isWindows)() ? eW.supports(eI.AN.SCREEN_SOUNDSHARE) && this.getExperimentalSoundshare() : !!(0, eo.isLinux)() && eW.supports(eI.AN.SCREEN_SOUNDSHARE)
  }
  getVideoStreamParameters() {
    ...
    return this.isSimulcastSupported() && (e === eI.Yn.DEFAULT || this.goLiveSimulcastEnabled()) && t.push({
      rid: "50",
      type: e === eI.Yn.DEFAULT ? eI.Tr.VIDEO : eI.Tr.SCREEN,
      quality: eI.LD
    }), t
  ...
  fetchAsyncResources() {
    ...
    return (0, eo.isWeb)() && (e.fetchDave = H.N.getCurrentConfig({
      location: "MediaEngineStore fetchAsyncResources"
    }).loadWasmModule), eW.fetchAsyncResources(e)
  }
