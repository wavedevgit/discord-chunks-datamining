...
let ez = {},
  ...
  e$ = performance.now(),
  e0 = {
    [eT.w5]: t$("No Input Devices")
  },
  e1 = {
    [eT.w5]: t$("No Output Devices")
  },
  e2 = {
    [eT.w5]: t$("No Video Devices")
  },
  e3 = !1,
  e5 = !1,
  e4 = !1,
  ...
  tb = !1,
  ty = !1;
X.Z.hasPermission(eO.Eu.AUDIO, {
  showAuthorizationError: !1
}), X.Z.hasPermission(eO.Eu.CAMERA, {
  showAuthorizationError: !1
});
let tO = !1,
  tv = new Set,
...
function tD(e) {
  ...
  e.setInputMode(n.mode, {
    ...
    vadUseKrisp: n.modeOptions.vadUseKrisp && nQ() && !J.M.getCurrentConfig({
...
function tZ() {
  eK.on(b.aB.Connection, e => {
    ...
    let a = eh.Z.getGuildId(),
      {
        ...
        skipEncode: c
      } = (null != a ? B.Z : G.Z).getCurrentConfig(eN({
    ...
    s && e.setExperimentFlag(eT.V8.MUTE_BEFORE_PROCESSING, !0), l && e.setExperimentFlag(eT.V8.PTT_BEFORE_PROCESSING, !0), c && e.setExperimentFlag(eT.V8.SKIP_ENCODE, !0), null != a && V.Z.getCurrentConfig({
      location: "setupMediaEngine",
      guildId: a
    }, {
      autoTrackExposure: !0
    ...
    e.on(b.Sh.Speaking, (t, n) => {
      ...
      (null == o ? void 0 : o.desktopSource) != null && er.default.track(eb.rMx.VIDEOHOOK_INITIALIZED, eN({
        backend: e,
        format: t,
    ...
    eP.warn("Watchdog timeout, report submission status: ".concat(null != e ? e : 200)), er.default.track(eb.rMx.VOICE_WATCHDOG_TIMEOUT, {
...
function tz() {
  ...
  null != t && (y.K.set(ew, {
    [eT.Yn.DEFAULT]: t
  }), y.K.remove("audio")), ez = null != (e = y.K.get(ew)) ? e : {}, p().each(ez, e => {
...
function tJ() {
  eX || eK.enable().then(() => v.Z.dispatch({
...
function t4() {
  ...
  for (let e of Object.keys(r)) {
    ...
    for (let [e, t] of Object.entries(a)) null == (0, $.Ky)(i, e) && (t.muted ? s[e] = !0 : delete s[e], t.volume !== o ? l[e] = t.volume : delete l[e], eK.eachConnection(n => {
...
function t7(e) {
  i = e.sessionId, e3 = !1, e6 = !1, (0, ea.isWeb)() || (Y.Z.subscribe({
    location: "handleConnectionOpen"
  }, e => {
    let t = tw();
    !e.sidechainAvailable && t.sidechainCompression ? (tq({
      sidechainCompressionSettingVersion: 0
    }), nC(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < ek && (tq({
  ...
  if (tY() && (tW() ? n8(eT.iA.AUTOMATIC) : t.automaticAudioSubsystem && n7()), eK.supports(eT.AN.OFFLOAD_ADM_CONTROLS)) {
    ...
    autoTrackExposure: !1
  }) && null !== t.mostRecentlyRequestedVoiceFilter && (0, ea.isDesktop)() && (en.Z.getLastInitAttemptMayHaveCrashed() ? (v.Z.dispatch({
...
function nc(e) {
  ...
  if (I[c] === eb.ZUi.AUTO_PROBING && u === eb.ZUi.AUTO_ENABLED && (0, q.Z)(c, p ? eT.fC.AUTO_DISABLE : eT.fC.AUTO_ENABLE, E), I[c] = u, tq({
      videoToggleStateMap: I
    }, l, d), u === eb.ZUi.AUTO_PROBING ? null == (n = eh.Z.getRTCConnection()) || n.pauseStatsCollectionForUser(c, !0) : null == (r = eh.Z.getRTCConnection()) || r.pauseStatsCollectionForUser(c, !1), tI || (eP.info("isAutoDisableAllowed=".concat(tI, " - disabling VideoHealthManager")), null == (o = eh.Z.getRTCConnection()) || null == (i = o.getVideoHealthManager()) || i.disable()), O) {
    if (!p && !g || p && !tI) return;
...
function ng(e) {
  ...
  t = t1(e0, t), e$ = performance.now(), tq({
    inputDeviceId: t
  }), eK.setAudioInputDevice(t)
}
...
function ny(e) {
  ...
  }), eK.setAudioInputBypassSystemProcessing(n.bypassSystemInputProcessing), tK.update(), nw()
}
...
async function nJ() {
  try {
    ...
    tu = !0, s = null == (e = o.getSdkVersion) ? void 0 : e.call(o), l = null != (i = null == (t = o.getSuppressionLevel) ? void 0 : t.call(o)) ? i : 100, null == (n = o.getNcModels) || n.call(o).then(e => {
      td = e, r.emitChange()
    }), r.emitChange()
  } catch (t) {
...
function n0() {
  !n$() || __OVERLAY__ || tc || tu ? (0, ea.isWeb)() && eK.supports(eT.AN.NOISE_CANCELLATION) ? (tu = !0, r.emitChange()) : (0, ea.isWeb)() && tq({
    noiseCancellation: !1
  }) : (tc = !0, nJ())
}
...
function rs(e) {
  ...
  if ((null == o ? void 0 : o.desktopSettings) != null) {
    ...
    ea.isPlatformEmbedded && !0 === a && ({
      soundshareId: e,
      soundshareSession: r
    } = t6(c), null != e && t8(e, r)), tM(s), tk(s === eT.Yn.STREAM && e8, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
...
class rO extends(u = E.ZP.Store) {
  ...
  fetchAsyncResources() {
    ...
    return (0, ea.isWeb)() && (e.fetchDave = H.N.getCurrentConfig({
