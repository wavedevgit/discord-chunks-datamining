...
let eY = {},
  ...
  eX = performance.now(),
  eQ = {
    [eO.w5]: tQ("No Input Devices")
  },
  eJ = {
    [eO.w5]: tQ("No Output Devices")
  },
  e$ = {
    [eO.w5]: tQ("No Video Devices")
  },
  e0 = !1,
  e1 = !1,
  e2 = !1,
...
function tM(e, t, n, r) {
  ...
  o && tA[a].add(t), (null == t || o) && $.default.track(em.rMx.SOUNDSHARE_FAILED, eT({
...
function tG() {
  eH.on(b.aB.Connection, e => {
    ...
    e.on(b.Sh.SoundshareTrace, e => {
      ...
      }), th = !0, $.default.track(em.rMx.VOICE_PROCESSING, {
      ...
      eN.warn("voiceactivitydetectorerror event: ".concat(e)), (0, P.kr)({
        ...
        mode: em.pM4.VOICE_ACTIVITY,
        options: eA(eT({}, tP(eO.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: !1
        })
      }), v.Z.dispatch({
...
function t6(e) {
  i = e.sessionId, e0 = !1, e3 = !1, (0, en.isWeb)() || (F.Z.subscribe({
    ...
    !e.sidechainAvailable && t.sidechainCompression ? (tK({
      sidechainCompressionSettingVersion: 0
    }), nA(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eL && (tK({
...
function ns(e) {
  ...
  if (I[c] === em.ZUi.AUTO_PROBING && u === em.ZUi.AUTO_ENABLED && (0, W.Z)(c, p ? eO.fC.AUTO_DISABLE : eO.fC.AUTO_ENABLE, E), I[c] = u, tK({
      videoToggleStateMap: I
  ...
  y && !p && tb.delete(c), p ? h[c] = !0 : delete h[c], tK({
    disabledLocalVideos: h
...
function nf(e) {
  ...
  tK({
    mode: n,
    modeOptions: r
  }, t), eH.eachConnection(tw), tY.update()
}
...
function nh(e) {
  ...
  t = t$(eQ, t), eX = performance.now(), tK({
    inputDeviceId: t
  }), eH.setAudioInputDevice(t)
}
...
function nE(e) {
  ...
  }), eH.setAudioInputBypassSystemProcessing(n.bypassSystemInputProcessing), tY.update(), nR()
}
...
function nJ() {
  !nQ() || __OVERLAY__ || to || ts ? (0, en.isWeb)() && eH.supports(eO.AN.NOISE_CANCELLATION) ? (ts = !0, r.emitChange()) : (0, en.isWeb)() && tK({
    noiseCancellation: !1
  }) : (to = !0, nX())
}
...
function n3(e) {
  ...
  }), eH.setAudioInputBypassSystemProcessing(t), nv(e.location)
}
