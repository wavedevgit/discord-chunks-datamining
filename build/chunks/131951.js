...
let eW = {},
  ...
  eQ = performance.now(),
  eJ = {
    [ev.w5]: tq("No Input Devices")
  },
  e$ = {
    [ev.w5]: tq("No Output Devices")
  },
  e0 = {
    [ev.w5]: tq("No Video Devices")
  },
  e1 = !1,
  e2 = !1,
  e3 = !1,
...
function tP(e) {
  ...
  e.setInputMode(n.mode, {
    ...
    vadUseKrisp: n.modeOptions.vadUseKrisp && nK() && !X.M.getCurrentConfig({
...
function tj() {
  eY.on(b.aB.Connection, e => {
    ...
    e.on(b.Sh.Speaking, (t, n) => {
      ...
      (null == a ? void 0 : a.desktopSource) != null && et.default.track(eg.rMx.VIDEOHOOK_INITIALIZED, eS({
        backend: e,
        format: t,
      ...
      }), tm = !0, et.default.track(eg.rMx.VOICE_PROCESSING, {
    ...
    let e;
    try {
      await en.Z.submitLiveCrashReport({
        message: {
    ...
    eC.warn("Watchdog timeout, report submission status: ".concat(null != e ? e : 200)), et.default.track(eg.rMx.VOICE_WATCHDOG_TIMEOUT, {
...
function t1() {
  ...
  let n = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
    r = null != (e = J.Z.settings.audioContextSettings) ? e : {
      user: {},
      stream: {}
    };
  for (let e of Object.keys(r)) {
    ...
    for (let [e, t] of Object.entries(o)) null == (0, Q.Ky)(i, e) && (t.muted ? s[e] = !0 : delete s[e], t.volume !== a ? l[e] = t.volume : delete l[e], eY.eachConnection(n => {
...
function t4(e) {
  i = e.sessionId, e1 = !1, e4 = !1, (0, ei.isWeb)() || (Z.Z.subscribe({
    location: "handleConnectionOpen"
  }, e => {
    let t = tR();
    !e.sidechainAvailable && t.sidechainCompression ? (tY({
      sidechainCompressionSettingVersion: 0
    }), nT(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < ex && (tY({
...
function na(e) {
  ...
  if (I[c] === eg.ZUi.AUTO_PROBING && u === eg.ZUi.AUTO_ENABLED && (0, K.Z)(c, p ? ev.fC.AUTO_DISABLE : ev.fC.AUTO_ENABLE, E), I[c] = u, tY({
      videoToggleStateMap: I
    }, l, d), u === eg.ZUi.AUTO_PROBING ? null == (n = ef.Z.getRTCConnection()) || n.pauseStatsCollectionForUser(c, !0) : null == (r = ef.Z.getRTCConnection()) || r.pauseStatsCollectionForUser(c, !1), tO || (eC.info("isAutoDisableAllowed=".concat(tO, " - disabling VideoHealthManager")), null == (a = ef.Z.getRTCConnection()) || null == (i = a.getVideoHealthManager()) || i.disable()), O) {
    if (!p && !g || p && !tO) return;
  ...
  y && !p && ty.delete(c), p ? h[c] = !0 : delete h[c], tY({
    disabledLocalVideos: h
...
function nu(e) {
  ...
  tY({
    mode: n,
    modeOptions: r
  }, t), eY.eachConnection(tP), tZ.update()
}
...
function nf(e) {
  ...
  t = tQ(eJ, t), eQ = performance.now(), tY({
    inputDeviceId: t
  }), eY.setAudioInputDevice(t)
}
...
function nm(e) {
  ...
  }), eY.setAudioInputBypassSystemProcessing(n.bypassSystemInputProcessing), tZ.update(), nN()
}
...
function nX() {
  !nq() || __OVERLAY__ || ts || tl ? (0, ei.isWeb)() && eY.supports(ev.AN.NOISE_CANCELLATION) ? (tl = !0, r.emitChange()) : (0, ei.isWeb)() && tY({
    noiseCancellation: !1
  }) : (ts = !0, nz())
}
...
function n1(e) {
  ...
  }), eY.setAudioInputBypassSystemProcessing(t), ny(e.location)
}
...
function rr(e) {
  ...
  if ((null == a ? void 0 : a.desktopSettings) != null) {
    ...
    ei.isPlatformEmbedded && !0 === o && ({
      soundshareId: e,
      soundshareSession: r
    } = t2(c), null != e && t3(e, r)), tL(s), tx(s === ev.Yn.STREAM && e5, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
...
class rg extends(u = E.ZP.Store) {
  ...
  fetchAsyncResources() {
    ...
    return (0, ei.isWeb)() && (e.fetchDave = F.N.getCurrentConfig({
