...
function tN(e, t, n, r) {
  ...
  a && tE[o].add(t), (null == t || a) && z.default.track(ed.rMx.SOUNDSHARE_FAILED, eE({
...
function tP() {
  eU.on(m.aB.Connection, e => {
    ...
    let a = es.Z.getGuildId(),
      {
        ...
        skipEncode: c
      } = (null != a ? x.Z : L.Z).getCurrentConfig(eE({
    ...
    e.on(m.Sh.Speaking, (t, n) => {
      ...
      (null == o ? void 0 : o.desktopSource) != null && (z.default.track(ed.rMx.SOUNDSHARE_TRANSMITTING, (0, w.Z)(null == o ? void 0 : o.desktopSource)), null != ea.Z.getHookError(ed.K3D.SOUND) && b.Z.wait(() => b.Z.dispatch({
      ...
      switch (e.type) {
        ...
        case "soundshare_recv_failed":
          let t = e.reason,
            n = e.code,
            r = e.retry;
          (null == o ? void 0 : o.desktopSource) != null && (tN(null == o ? void 0 : o.desktopSource, n, t, r), r || (_.stop(), b.Z.wait(() => b.Z.dispatch({
            type: "MEDIA_ENGINE_SOUNDSHARE_FAILED",
            errorMessage: t,
            errorCode: n
          }))));
...
function t8(e) {
  ...
  if (I[u] === ed.ZUi.AUTO_PROBING && d === ed.ZUi.AUTO_ENABLED && (0, F.Z)(u, p ? eh.fC.AUTO_DISABLE : eh.fC.AUTO_ENABLE, E), I[u] = d, tj({
      videoToggleStateMap: I
    }, l, f), d === ed.ZUi.AUTO_PROBING ? null == (n = es.Z.getRTCConnection()) || n.pauseStatsCollectionForUser(u, !0) : null == (r = es.Z.getRTCConnection()) || r.pauseStatsCollectionForUser(u, !1), tf || (eO.info("isAutoDisableAllowed=".concat(tf, " - disabling VideoHealthManager")), null == (o = es.Z.getRTCConnection()) || null == (i = o.getVideoHealthManager()) || i.disable()), O) {
    if (!p && !g || p && !tf) return;
