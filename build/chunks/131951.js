...
n.d(t, {
  Z: () => rn
}), n(388685), n(953529), n(457542), n(539854), n(337869);
var s, l = n(512722),
  c = n.n(l),
  u = n(392711),
  d = n.n(u),
...
let eU = {},
  ...
  eF = eh.Yn.STREAM,
  eZ = {
    [eh.w5]: tU("No Input Devices")
  },
  eH = {
    [eh.w5]: tU("No Output Devices")
  },
  eW = {
    [eh.w5]: tU("No Video Devices")
  },
  eY = !1,
  eK = !1,
  ez = !1,
...
function tT(e, t, n, r) {
  ...
  a && tm[o].add(t), (null == t || a) && z.default.track(ed.rMx.SOUNDSHARE_FAILED, eE({
  ...
  ej.on(m.aB.Connection, e => {
    ...
    e.on(m.Sh.SoundshareTrace, e => {
      ...
      ev.warn("voiceactivitydetectorerror event: ".concat(e)), (0, A.kr)({
        ...
        mode: ed.pM4.VOICE_ACTIVITY,
        options: ey(eE({}, tb(eh.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: !1
        })
      }), b.Z.dispatch({
...
let tD = new class {
  ...
  stop() {
    this.started && (this.started = !1, null != this.stateChangeTimeout && (clearTimeout(this.stateChangeTimeout), this.stateChangeTimeout = null), ej.removeListener(m.aB.Silence, this.handleSilence), b.Z.dispatch({
...
function tL() {
  ...
  null != t && (g.K.set(eO, {
    [eh.Yn.DEFAULT]: t
  }), g.K.remove("audio")), eU = null != (e = g.K.get(eO)) ? e : {}, d().each(eU, e => {
...
function tj() {
  eB || ej.enable().then(() => b.Z.dispatch({
...
function tK(e) {
  i = e.sessionId, eY = !1, eq = !1, (0, X.isWeb)() || (G.Z.subscribe({
    location: "handleConnectionOpen"
  }, e => {
    let t = tb();
    !e.sidechainAvailable && t.sidechainCompression ? (tx({
      sidechainCompressionSettingVersion: 0
    }), nf(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eA && (tx({
      sidechainCompressionSettingVersion: eA
    }), nf(e.sidechainEnabled))
  }), np());
  let t = tb();
  tw() && (t.automaticAudioSubsystem && nF(), t.audioSubsystemSettingVersion < eC && (tx({
    audioSubsystemSettingVersion: eC
  }), t.automaticAudioSubsystem || ej.getAudioSubsystem() === eh.iA.LEGACY || nV(eh.iA.AUTOMATIC))), (0, K.wt)({
    location: "MediaEngineStore",
    autoTrackExposure: !1
  }) && null !== t.mostRecentlyRequestedVoiceFilter && (0, Y.J_)(), tH()
}
...
function t4(e) {
  ...
  if (I[u] === ed.ZUi.AUTO_PROBING && d === ed.ZUi.AUTO_ENABLED && (0, F.Z)(u, p ? eh.fC.AUTO_DISABLE : eh.fC.AUTO_ENABLE, E), I[u] = d, tx({
      videoToggleStateMap: I
...
function t9(e) {
  ...
  tx({
    mode: n,
    modeOptions: r
  }, t), ej.eachConnection(ty), tD.update()
}
...
function nM() {
  !nx() || __OVERLAY__ || e7 || e9 ? (0, X.isWeb)() && ej.supports(eh.AN.NOISE_CANCELLATION) ? (e9 = !0, r.emitChange()) : (0, X.isWeb)() && tx({
    noiseCancellation: !1
  }) : (e7 = !0, nL())
}
...
function nX(e) {
  ...
  if ((null == o ? void 0 : o.desktopSettings) != null) {
    ...
    X.isPlatformEmbedded && !0 === a && ({
      soundshareId: e,
      soundshareSession: r
    } = tW(c), null != e && tY(e, r)), tI(s), tS(s === eh.Yn.STREAM && eQ, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
