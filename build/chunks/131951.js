...
function tA() {
  eU.on(m.aB.Connection, e => {
    ...
    let l = el.Z.getGuildId(),
      {
        ...
        skipEncode: d
      } = (null != l ? k.Z : M.Z).getCurrentConfig(eb({
    ...
    }(0, J.isWindows)() ? (null == tp ? void 0 : tp.startsWith("NVIDIA")) ? e.setExperimentFlag(em.V8.SIGNAL_AV1, !0): (null == tp ? void 0 : tp.startsWith("AMD")) && parseInt(null !== (a = null === (i = tp.match(/\d+/)) || void 0 === i ? void 0 : i.at(0)) && void 0 !== a ? a : "0", 10) >= 9e3 && L.Z.getCurrentConfig({
      location: "setupMediaEngine"
    }, {
      autoTrackExposure: !0
    }).signalAV1Support ? e.setExperimentFlag(em.V8.SIGNAL_AV1, !0) : e.setExperimentFlag(em.V8.SIGNAL_AV1_DECODE, !0): ((0, J.isMac)() || (0, J.isLinux)()) && e.setExperimentFlag(em.V8.SIGNAL_AV1_DECODE, !0), (0, J.isWindows)() && e.setExperimentFlag(em.V8.SIGNAL_AV1_HARDWARE_DECODE, !0), eU.setHasFullbandPerformance((0, N.Z)());
    ...
    e.on(m.Sh.Speaking, (t, n) => {
      ...
      (null == o ? void 0 : o.desktopSource) != null && (q.default.track(ef.rMx.SOUNDSHARE_TRANSMITTING, (0, D.Z)(null == o ? void 0 : o.desktopSource)), null != es.Z.getHookError(ef.K3D.SOUND) && b.Z.wait(() => b.Z.dispatch({
    ...
    e.on(m.Sh.SoundshareTrace, e => {
      ...
      eO.warn("noisecancellererror event: ".concat(e)), (0, A.kr)(A.u.NOISE_CANCELLER_ERROR, {
      ...
      eO.warn("voiceactivitydetectorerror event: ".concat(e)), (0, A.kr)(A.u.NOISE_CANCELLER_ERROR, {
        underlyingError: "NoiseCancellerError.".concat(em.H3[e])
...
function tW(e, t) {
  (0, J.isWindows)() && y.YT(e, {
    ...
    null == t || w.ZP.shouldContinueWithoutElevatedProcessForPID(e) || b.Z.wait(() => {
      b.Z.dispatch({
        type: "MEDIA_ENGINE_SOUNDSHARE_FAILED",
        errorMessage: t
      })
...
function tY(e) {
  i = e.sessionId, eK = !1, eQ = !1, (0, J.isWeb)() || F.Z.subscribe({
  ...
  let t = tb();
  tP() && (t.automaticAudioSubsystem && nB(), t.audioSubsystemSettingVersion < eR && (tL({
    audioSubsystemSettingVersion: eR
  }), t.automaticAudioSubsystem || eU.getAudioSubsystem() === em.iA.LEGACY || nG(em.iA.AUTOMATIC))), (0, z.wt)({
...
function nL() {
  !nD() || __OVERLAY__ || e9 || te ? (0, J.isWeb)() && eU.supports(em.AN.NOISE_CANCELLATION) ? (te = !0, r.emitChange()) : (0, J.isWeb)() && tL({
    noiseCancellation: !1
  }) : (e9 = !0, nw())
}
...
class n9 extends(s = h.ZP.Store) {
  initialize() {
    ...
    }, this.waitFor(er.default, eo.Z, ea.Z, es.Z, el.Z, w.ZP, H.Z.storage, Y.Z, R.Z, I.Z), (0, C.U)()
  }
  supports(e) {
  ...
  getUseSystemScreensharePicker() {
    let e = this.supportsSystemScreensharePicker(),
      ...
      n = (0, J.isLinux)() || U.Z.getCurrentConfig({
  ...
  getSupportedSecureFramesProtocolVersion(e) {
    ...
    let n = eU.getSupportedSecureFramesProtocolVersion(),
      r = B.m.getCurrentConfig({
        location: "MediaEngineStore"
      }),
      i = null != e ? B.N.getCurrentConfig({
        guildId: e,
        location: "MediaEngineStore"
      }) : null,
