...
let eB = {},
  ...
  eY = performance.now(),
  eW = {
    [em.w5]: tH("No Input Devices")
  },
  eK = {
    [em.w5]: tH("No Output Devices")
  },
  ez = {
    [em.w5]: tH("No Video Devices")
  },
  eq = !1,
  eQ = !1,
  eX = !1,
...
function tP(e, t, n, r) {
  ...
  o && tb[a].add(t), (null == t || o) && z.default.track(ed.rMx.SOUNDSHARE_FAILED, eb({
...
function tD() {
  eG.on(g.aB.Connection, e => {
    ...
    e.on(g.Sh.SoundshareTrace, e => {
      switch (e.type) {
        ...
        case "soundshare_recv_failed":
          let t = e.reason,
            n = e.code,
            r = e.retry;
          (null == a ? void 0 : a.desktopSource) != null && (tP(null == a ? void 0 : a.desktopSource, n, t, r), r || (_.stop(), y.Z.wait(() => y.Z.dispatch({
            type: "MEDIA_ENGINE_SOUNDSHARE_FAILED",
            errorMessage: t,
            errorCode: n
          }))));
      ...
      }), tl = !0, z.default.track(ed.rMx.VOICE_PROCESSING, {
      ...
      ev.warn("voiceactivitydetectorerror event: ".concat(e)), (0, C.kr)({
        ...
        mode: ed.pM4.VOICE_ACTIVITY,
        options: eO(eb({}, tI(em.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: !1
        })
      }), y.Z.dispatch({
...
let tU = new class {
  ...
  stop() {
    this.started && (this.started = !1, null != this.stateChangeTimeout && (clearTimeout(this.stateChangeTimeout), this.stateChangeTimeout = null), eG.removeListener(g.aB.Silence, this.handleSilence), y.Z.dispatch({
...
function tG() {
  ...
  null != t && (E.K.set(eI, {
    [em.Yn.DEFAULT]: t
  }), E.K.remove("audio")), eB = null != (e = E.K.get(eI)) ? e : {}, f().each(eB, e => {
...
function tZ() {
  eV || eG.enable().then(() => y.Z.dispatch({
...
function tQ() {
  ...
  for (let e of Object.keys(r)) {
    ...
    for (let [e, t] of Object.entries(o)) null == (0, H.Ky)(i, e) && (t.muted ? s[e] = !0 : delete s[e], t.volume !== a ? l[e] = t.volume : delete l[e], eG.eachConnection(n => {
...
function t$(e) {
  i = e.sessionId, eq = !1, eJ = !1, (0, X.isWeb)() || (U.Z.subscribe({
    location: "handleConnectionOpen"
  }, e => {
    let t = tI();
    !e.sidechainAvailable && t.sidechainCompression ? (tB({
      sidechainCompressionSettingVersion: 0
    }), nb(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eC && (tB({
      sidechainCompressionSettingVersion: eC
    }), nb(e.sidechainEnabled))
  }), nO());
  let t = tI();
  tM() && (tj() ? nq(em.iA.AUTOMATIC) : t.automaticAudioSubsystem && nQ()), (0, K.wt)({
...
function ne(e) {
  ...
  if (I[c] === ed.ZUi.AUTO_PROBING && d === ed.ZUi.AUTO_ENABLED && (0, V.Z)(c, p ? em.fC.AUTO_DISABLE : em.fC.AUTO_ENABLE, E), I[c] = d, tB({
      videoToggleStateMap: I
    }, l, f), d === ed.ZUi.AUTO_PROBING ? null == (n = es.Z.getRTCConnection()) || n.pauseStatsCollectionForUser(c, !0) : null == (r = es.Z.getRTCConnection()) || r.pauseStatsCollectionForUser(c, !1), t_ || (ev.info("isAutoDisableAllowed=".concat(t_, " - disabling VideoHealthManager")), null == (a = es.Z.getRTCConnection()) || null == (i = a.getVideoHealthManager()) || i.disable()), O) {
    if (!p && !g || p && !t_) return;
  ...
  y && !p && tf.delete(c), p ? h[c] = !0 : delete h[c], tB({
    disabledLocalVideos: h
...
function na(e) {
  ...
  tB({
    mode: n,
    modeOptions: r
  }, t), eG.eachConnection(tS), tU.update()
}
...
function nl(e) {
  ...
  t = tW(eW, t), eY = performance.now(), tB({
    inputDeviceId: t
  }), eG.setAudioInputDevice(t)
}
...
function nd(e) {
  ...
  }), eG.setAudioInputBypassSystemProcessing(n.bypassSystemInputProcessing), tU.update(), nv()
}
...
function nV() {
  !nF() || __OVERLAY__ || tt || tn ? (0, X.isWeb)() && eG.supports(em.AN.NOISE_CANCELLATION) ? (tn = !0, r.emitChange()) : (0, X.isWeb)() && tB({
    noiseCancellation: !1
  }) : (tt = !0, nB())
}
...
function nK(e) {
  ...
  }), eG.setAudioInputBypassSystemProcessing(t), nh(e.location)
}
...
function n5(e) {
  ...
  if ((null == a ? void 0 : a.desktopSettings) != null) {
    ...
    X.isPlatformEmbedded && !0 === o && ({
      soundshareId: e,
      soundshareSession: r
    } = tX(c), null != e && tJ(e, r)), tN(s), tC(s === em.Yn.STREAM && e$, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
