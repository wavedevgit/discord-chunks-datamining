...
let eG = {},
  ...
  eZ = em.Yn.STREAM,
  eH = {
    [em.w5]: tj("No Input Devices")
  },
  eW = {
    [em.w5]: tj("No Output Devices")
  },
  eY = {
    [em.w5]: tj("No Video Devices")
  },
  eK = !1,
  ez = !1,
  eq = !1,
  ...
  ts = !1,
  tl = !1;
H.Z.hasPermission(ep.Eu.AUDIO, {
  showAuthorizationError: !1
}), H.Z.hasPermission(ep.Eu.CAMERA, {
  showAuthorizationError: !1
});
let tc = !1,
  tu = new Set,
...
function tS() {
  ...
  if ((null == s ? void 0 : s.desktopSource) != null && s.desktopSource.id !== (null == a ? void 0 : null === (e = a.desktopSource) || void 0 === e ? void 0 : e.id) && (null != s.desktopSource.soundshareId && (0, J.isWindows)() && y.pn(s.desktopSource.soundshareId), eU.setGoLiveSource(null, eZ)), (null == s ? void 0 : s.cameraSource) != null && (s.cameraSource.videoDeviceGuid !== (null == a ? void 0 : null === (t = a.cameraSource) || void 0 === t ? void 0 : t.videoDeviceGuid) || s.cameraSource.audioDeviceGuid !== (null == a ? void 0 : null === (n = a.cameraSource) || void 0 === n ? void 0 : n.audioDeviceGuid)) && eU.setGoLiveSource(null, eZ), (eX || i) && (eJ = (eX = i) ? tG(eY, tb().videoDeviceId) : em.Av, eU.setVideoInputDevice(eJ)), o = a, null != a) {
    ...
    null != a.cameraSource && eU.setGoLiveSource({
      cameraDescription: {
...
function tT(e, t, n, r) {
  ...
  a && tm[o].add(t), (null == t || a) && q.default.track(ef.rMx.SOUNDSHARE_FAILED, eb({
...
function tN() {
  eU.on(m.aB.Connection, e => {
    ...
    let l = el.ZP.getGuildId(),
      {
        muteBeforeProcessing: c,
        pttBeforeProcessing: u,
        skipEncode: d
      } = (null != l ? M.Z : x.Z).getCurrentConfig(eb({
    ...
    }(0, J.isWindows)() ? (null == tp ? void 0 : tp.startsWith("NVIDIA")) ? e.setExperimentFlag(em.V8.SIGNAL_AV1, !0): (null == tp ? void 0 : tp.startsWith("AMD")) && parseInt(null !== (a = null === (i = tp.match(/\d+/)) || void 0 === i ? void 0 : i.at(0)) && void 0 !== a ? a : "0", 10) >= 9e3 && D.Z.getCurrentConfig({
      location: "setupMediaEngine"
    }, {
      autoTrackExposure: !0
    }).signalAV1Support ? e.setExperimentFlag(em.V8.SIGNAL_AV1, !0) : e.setExperimentFlag(em.V8.SIGNAL_AV1_DECODE, !0): ((0, J.isMac)() || (0, J.isLinux)()) && e.setExperimentFlag(em.V8.SIGNAL_AV1_DECODE, !0), (0, J.isWindows)() && e.setExperimentFlag(em.V8.SIGNAL_AV1_HARDWARE_DECODE, !0), eU.setHasFullbandPerformance((0, A.Z)());
    ...
    e.on(m.Sh.Speaking, (t, n) => {
    ...
    }), e.context === em.Yn.DEFAULT && (e0 = !1, e1 = !1, e.on(m.Sh.SpeakingWhileMuted, () => {
      e0 = !0, e1 = !0, r.emitChange(), e2.stop(), e2.start(ek, () => {
        e1 = !1, r.emitChange()
      })
      ...
      (null == o ? void 0 : o.desktopSource) != null && (q.default.track(ef.rMx.SOUNDSHARE_TRANSMITTING, (0, w.Z)(null == o ? void 0 : o.desktopSource)), null != es.Z.getHookError(ef.K3D.SOUND) && b.Z.wait(() => b.Z.dispatch({
    ...
    e.on(m.Sh.SoundshareTrace, e => {
      switch (e.type) {
        ...
        case "soundshare_recv_failed":
          let t = e.reason,
            n = e.code,
            r = e.retry;
          (null == o ? void 0 : o.desktopSource) == null || (tT(null == o ? void 0 : o.desktopSource, n, t, r), r || (h.stop(), b.Z.wait(() => b.Z.dispatch({
            type: "MEDIA_ENGINE_SOUNDSHARE_FAILED",
            errorMessage: t,
            errorCode: n
          }))));
        ...
        case "soundshare_state_transition":
          4 === e.newState && (h.stop(), b.Z.wait(() => b.Z.dispatch({
            type: "MEDIA_ENGINE_SOUNDSHARE_TRANSMITTING"
          })))
      }
      ...
      (null == o ? void 0 : o.desktopSource) != null && q.default.track(ef.rMx.VIDEOHOOK_INITIALIZED, eb({
        backend: e,
        format: t,
      ...
      eO.warn("noisecancellererror event: ".concat(e)), (0, N.kr)(N.u.NOISE_CANCELLER_ERROR, {
        underlyingError: "NoiseCancellerError.".concat(em.H3[e])
      }), ta = !0, q.default.track(ef.rMx.VOICE_PROCESSING, {
      ...
      eO.warn("voiceactivitydetectorerror event: ".concat(e)), (0, N.kr)(N.u.NOISE_CANCELLER_ERROR, {
        underlyingError: "NoiseCancellerError.".concat(em.H3[e])
        ...
        mode: ef.pM4.VOICE_ACTIVITY,
        options: ey(eb({}, tb(em.Yn.DEFAULT).modeOptions), {
          vadUseKrisp: !1
        })
      }), b.Z.dispatch({
      ...
      h.stop()
    }), e.setBitRate(ei.Z.bitrate), e.applyVideoQualityMode(ed.Z.mode)
    ...
    eO.warn("Watchdog timeout, report submission status: ".concat(null != e ? e : 200)), q.default.track(ef.rMx.VOICE_WATCHDOG_TIMEOUT, {
    ...
    q.default.track(ef.rMx.VIDEO_INPUT_INITIALIZED, {
      ...
      activity: e.entropy,
      media_session_id: el.ZP.getMediaSessionId(),
      rtc_connection_id: el.ZP.getRTCConnectionId()
    })
...
let tw = new class {
  ...
  stop() {
    this.started && (this.started = !1, null != this.stateChangeTimeout && (clearTimeout(this.stateChangeTimeout), this.stateChangeTimeout = null), eU.removeListener(m.aB.Silence, this.handleSilence), b.Z.dispatch({
  ...
  update() {
    let e = tb();
    !e5 && el.ZP.getState() === ef.hes.RTC_CONNECTED && e.mode === ef.pM4.VOICE_ACTIVITY && e.silenceWarning ? this.start() : this.stop()
  }
  reset() {
    this.stop(), this.update()
  }
  constructor() {
    eE(this, "stateChangeTimeout", void 0), eE(this, "noVoiceTimeout", 5e3), eE(this, "voiceTimeout", 1500), eE(this, "started", !1), eE(this, "handleSilence", e => {
      let t = !e;
      null != this.stateChangeTimeout && clearTimeout(this.stateChangeTimeout), this.stateChangeTimeout = setTimeout(() => {
        this.stateChangeTimeout = null, this.started && (b.Z.dispatch({
          type: "AUDIO_INPUT_DETECTED",
          inputDetected: t
        }), e && (e7 = !0))
...
function tD() {
  ...
  null != t && (g.K.set(eI, {
    [em.Yn.DEFAULT]: t
  }), g.K.remove("audio")), eG = null !== (e = g.K.get(eI)) && void 0 !== e ? e : {}, d().each(eG, e => {
    ...
    }(0, J.isWeb)() ? e.ncUseKrispjsSettingVersion !== eA && (e.ncUseKrispjsSettingVersion = eA, e.noiseSuppression = !1, e.noiseCancellation = !0): e.ncUseKrispSettingVersion !== eT && (e.ncUseKrispSettingVersion = eT, e.noiseSuppression = !1, e.noiseCancellation = !0), e.hardwareEnabledVersion !== eN && (e.hardwareH264 = !0, e.hardwareEnabledVersion = eN), null == e.hardwareEncoding && (e.hardwareEncoding = e.hardwareH264)
  }), tM()
}
...
function tk() {
  eF || eU.enable().then(() => b.Z.dispatch({
...
function tZ() {
  ...
  let n = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
    r = null !== (e = Y.Z.settings.audioContextSettings) && void 0 !== e ? e : {
      user: {},
      stream: {}
    };
  for (let e of Object.keys(r)) {
    ...
    for (let [e, t] of Object.entries(a)) null == (0, W.Ky)(i, e) && (t.muted ? s[e] = !0 : delete s[e], t.volume !== o ? l[e] = t.volume : delete l[e], eU.eachConnection(n => {
      n.setLocalVolume(e, t.volume), n.setLocalMute(e, t.muted)
    }, i));
    if (n)
      for (let e of new Set([...Object.keys(s), ...Object.keys(l)])) null == a[e] && (delete s[e], delete l[e], eU.eachConnection(t => {
...
function tH(e) {
  if (null == r) return eO.info("Error: trying to get soundshare id before MediaEngineStore is instantiated."), {
    soundshareId: null,
    soundshareSession: ""
  };
  {
...
function tY(e) {
  i = e.sessionId, eK = !1, eQ = !1, (0, J.isWeb)() || (B.Z.subscribe({
    location: "handleConnectionOpen"
  }, e => {
    let t = tb();
    !e.sidechainAvailable && t.sidechainCompression ? (tL({
      sidechainCompressionSettingVersion: 0
    }), nd(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < eC && (tL({
      sidechainCompressionSettingVersion: eC
    }), nd(e.sidechainEnabled))
  }), n_());
  let t = tb();
  tP() && (t.automaticAudioSubsystem && nF(), t.audioSubsystemSettingVersion < eR && (tL({
    audioSubsystemSettingVersion: eR
  }), t.automaticAudioSubsystem || eU.getAudioSubsystem() === em.iA.LEGACY || nB(em.iA.AUTOMATIC))), (0, z.wt)({
    location: "MediaEngineStore",
    autoTrackExposure: !1
  }) && null !== t.mostRecentlyRequestedVoiceFilter && (0, K.J_)(), tZ()
}
...
function tQ(e) {
  ...
  return t.reduce((e, t) => i === t.sessionId ? (eK = t.mute || t.suppress, eQ = t.deaf, eU.eachConnection(tO), tS((null == t.guildId || null == t.channelId || null == to || to === t.channelId) && eX), to = t.channelId, !0) : (__OVERLAY__ || t.userId !== er.default.getId() || null != el.ZP.getChannelId() || tS(!1, null), e), !1)
}
...
function t2(e) {
  ...
  r[n] ? delete r[n] : r[n] = !0, tL({
    localMutes: r
  }, t), eU.eachConnection(e => e.setLocalMute(n, r[n] || !1), t)
}
...
function t3(e) {
  ...
  if (I[u] === ef.ZUi.AUTO_PROBING && d === ef.ZUi.AUTO_ENABLED && (0, Z.Z)(u, p ? em.fC.AUTO_DISABLE : em.fC.AUTO_ENABLE, E), I[u] = d, tL({
      videoToggleStateMap: I
    }, l, f), d === ef.ZUi.AUTO_PROBING ? null === (n = el.ZP.getRTCConnection()) || void 0 === n || n.pauseStatsCollectionForUser(u, !0) : null === (r = el.ZP.getRTCConnection()) || void 0 === r || r.pauseStatsCollectionForUser(u, !1), td || (eO.info("isAutoDisableAllowed=".concat(td, " - disabling VideoHealthManager")), null === (o = el.ZP.getRTCConnection()) || void 0 === o || null === (i = o.getVideoHealthManager()) || void 0 === i || i.disable()), y) {
    if (!p && !g || p && !td) return;
    (0, Z.Z)(u, p ? em.fC.AUTO_DISABLE : em.fC.AUTO_ENABLE, E), p ? tu.add(u) : tu.delete(u)
  } else O && (g && !p ? (eO.info("disallowing auto-disable for this session because of manual override by user"), td = !1, null === (s = el.ZP.getRTCConnection()) || void 0 === s || null === (a = s.getVideoHealthManager()) || void 0 === a || a.disable(), (0, Z.Z)(u, em.fC.MANUAL_REENABLE, E)) : (0, Z.Z)(u, p ? em.fC.MANUAL_DISABLE : em.fC.MANUAL_ENABLE, E));
  v && !p && tu.delete(u), p ? h[u] = !0 : delete h[u], tL({
    disabledLocalVideos: h
  }, l, f), eU.eachConnection(e => {
    var t;
...
function t5(e) {
  ...
  r === i ? delete o[n] : o[n] = r, tL({
    localVolumes: o
  }, t), eU.eachConnection(e => e.setLocalVolume(n, r), t)
}
...
function t7(e) {
  ...
  o[n] = {
    ...
    localPans: o
  }, t), eU.eachConnection(e => e.setLocalPan(n, r, i), t)
}
...
function t8(e) {
  ...
  tL({
    mode: n,
    modeOptions: r
  }, t), eU.eachConnection(tv), tw.update()
}
...
function nb(e) {
  ...
  }), eU.setH264Enabled(i.hardwareEncoding || i.openH264), eU.setAv1Enabled(null === (t = i.hardwareEncoding) || void 0 === t || t), eU.setH265Enabled(null === (n = i.hardwareEncoding) || void 0 === n || n)
}
...
function nA(e) {
  ...
  tL({
    qos: t
  }), eU.eachConnection(e => e.setQoS(t))
}
...
function nx() {
  !nL() || __OVERLAY__ || e9 || te ? (0, J.isWeb)() && eU.supports(em.AN.NOISE_CANCELLATION) ? (te = !0, r.emitChange()) : (0, J.isWeb)() && tL({
    noiseCancellation: !1
  }) : (e9 = !0, nD())
}
...
function nk(e) {
  ...
  }), eU.eachConnection(e => e.setVoiceFilterId(t))
}
...
function nB(e) {
  e === em.iA.AUTOMATIC ? (tL({
    automaticAudioSubsystem: !0
  }), nF()) : (tL({
    automaticAudioSubsystem: !1
  }), eU.setAudioSubsystem(e))
}
...
function nz(e) {
  let {
    ...
    applicationName: n,
    quality: i
  } = e, o = I.Z.isDecoupledGameClippingEnabled(), s = I.Z.getSettings().decoupledClipsEnabled;
...
function nQ(e) {
  ...
  if ((null == o ? void 0 : o.desktopSettings) != null) {
    ...
    J.isPlatformEmbedded && !0 === a && ({
      soundshareId: e,
      soundshareSession: r
    } = tH(c), null != e && tW(e, r)), tI(s), tS(s === em.Yn.STREAM && eX, {
      desktopSource: {
        id: i,
        sourcePid: c,
        soundshareId: e,
...
function n$(e) {
  ...
  eU.setH264Enabled(n.hardwareEncoding || n.openH264), eU.eachConnection(e => {
    var t;
...
function n3() {
  if (!eX && null == o || null != el.ZP.getRTCConnectionId()) return !1;
  tS(!1, null)
}
...
class re extends(s = h.ZP.Store) {
  initialize() {
    ...
    }, this.waitFor(er.default, eo.Z, ea.Z, es.Z, el.ZP, P.ZP, H.Z.storage, Y.Z, C.Z, I.Z)
  }
  supports(e) {
  ...
  getUseSystemScreensharePicker() {
    let e = this.supportsSystemScreensharePicker(),
      ...
      n = (0, J.isLinux)() || j.Z.getCurrentConfig({
  ...
  getVideoStreamParameters() {
    ...
    return this.isSimulcastSupported() && (e === em.Yn.DEFAULT || this.goLiveSimulcastEnabled()) && t.push({
      rid: "50",
      type: e === em.Yn.DEFAULT ? em.Tr.VIDEO : em.Tr.SCREEN,
      quality: em.LD
    }), t
