...
function M(e) {
  ...
  }, "activity")), S === w.YE.XBOX || j === A.wR.XBOX ? M.push((0, r.jsx)("div", {
    className: _.iconSpacing,
...
let U = l.forwardRef(function(e, t) {
  ...
  let {
    ...
    location: "VoiceUser"
  }), el = (0, a.e7)([j.default, E.Z], () => E.Z.isInChannel($, j.default.getId())), [ei, eo] = l.useState(!1);
  return l.useEffect(() => {
    let e = !1,
      t = () => {
      ...
      children: [R && !F ? (0, r.jsx)(s.ua7, {
        ...
        children: e => (0, r.jsx)("div", L({
          className: o()(_.iconPriortySpeaker, {
            [_.iconPriortySpeakerSpeaking]: !Y && !B && V
          })
        }, e))
      }) : null, (0, r.jsx)("div", {
        ...
        style: {
          backgroundImage: "url(".concat(Q.getAvatarURL(G, d === N.ipw.LARGE ? 38 : 24), ")")
        }
      }), function() {
        var e, t;
        let n = (0, r.jsxs)("div", {
...
function R(e) {
  ...
  return l.useEffect(() => {
    d && f.ZP.trackWithMetadata(N.rMx.VOICE_CHANNEL_GAME_ACTIVITY_INDICATOR_VIEWED, {
      channel_id: a,
      guild_id: i,
      user_id: u
    })
