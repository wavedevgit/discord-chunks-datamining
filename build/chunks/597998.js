...
function V(e) {
  ...
  }, "activity")), O === Z.YE.XBOX || S === D.wR.XBOX ? H.push((0, r.jsx)("div", {
    className: k.iconSpacing,
    children: (0, r.jsx)(C.Z, {
      className: a()(k.icon, _)
    })
  }, "xbox")) : (O === Z.YE.PLAYSTATION || S === D.wR.PLAYSTATION) && H.push((0, r.jsx)("div", {
    className: k.iconSpacing,
  ...
  let J = null != I && !(0, T.yE)(I.flags, w.udG.EMBEDDED),
    K = null == A && J;
  return 0 !== H.length || null != Y || M || K ? (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: K ? (0, r.jsx)(G, {
        application: I,
        iconClassName: _,
        guildId: j,
        channelId: x,
        userId: E.id
      }, "".concat(E.id, "-game")) : (0, r.jsx)(U, {
        hangStatusActivity: A,
        iconClassName: _,
        isSelf: R
      })
...
let F = i.forwardRef(function(e, t) {
  ...
  } = (0, m.ZP)(), et = (0, u.bp)(), en = null != $ ? j.Z.getChannel($) : null, er = (0, o.e7)([I.default, x.Z], () => x.Z.isInChannel($, I.default.getId())), {
    enabled: ei
  } = A.P.useExperiment({
    location: "VoiceUser"
  }), [el, ea] = i.useState(!1);
  return i.useEffect(() => {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [U && !F ? (0, r.jsx)(s.ua7, {
        ...
        style: {
          backgroundImage: "url(".concat(Q.getAvatarURL(W, d === w.ipw.LARGE ? 38 : 24), ")")
        }
      }), function() {
        var e, t;
        let n = (0, r.jsxs)("div", {
            ...
            children: [null != H ? H : N.ZP.getName(Q), Y ? (0, r.jsxs)("span", {
        ...
        return !F || b ? (0, r.jsx)(_.Z, (e = M({}, i), t = t = {
          children: n
        ...
        children: (0, r.jsx)(s.P3F, {
          ...
          onClick: function(e) {
            null != W && null != en && ((0, g.v)(ee, g.d.MORE), ea(!0), (0, S.D)(e, Q, en, {
              context: et
            }, (e, t) => {
              (0, h.o)({
                menuName: e,
