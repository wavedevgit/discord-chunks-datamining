...
function M(e) {
  ...
  }, "activity")), S === w.YE.XBOX || j === N.wR.XBOX ? M.push((0, r.jsx)("div", {
    className: D.iconSpacing,
    children: (0, r.jsx)(x.Z, {
      className: o()(D.icon, y)
    })
  }, "xbox")) : (S === w.YE.PLAYSTATION || j === N.wR.PLAYSTATION) && M.push((0, r.jsx)("div", {
    className: D.iconSpacing,
  ...
  return 0 !== M.length || null != U || Y ? (0, r.jsxs)("div", {
...
let U = l.forwardRef(function(e, t) {
  var n, {
      avatarContainerClass: i = D.avatarContainer,
      userNameClassName: c = D.usernameFont,
      size: d = A.ipw.SMALL,
      selected: p = !1,
      disabled: f = !1,
      isOverlay: O = !1
  ...
  let {
    ...
    location: "VoiceUser"
  }), el = (0, a.e7)([j.default, I.Z], () => I.Z.isInChannel($, j.default.getId())), [ei, eo] = l.useState(!1);
  return l.useEffect(() => {
    let e = !1,
      t = () => {
    ...
    children: (0, r.jsxs)("div", {
      ...
      children: [R && !F ? (0, r.jsx)(s.ua7, {
        text: _.intl.string(_.t.BVK71t),
        children: e => (0, r.jsx)("div", L({
          className: o()(D.iconPriortySpeaker, {
            [D.iconPriortySpeakerSpeaking]: !Y && !B && V
          })
        }, e))
      }) : null, (0, r.jsx)("div", {
        ...
        style: {
          backgroundImage: "url(".concat(q.getAvatarURL(G, d === A.ipw.LARGE ? 38 : 24), ")")
        }
      }), function() {
        var e, t;
        let n = (0, r.jsxs)("div", {
          ...
          l = {
            ...
            profileViewedAnalytics: {
              source: O ? A.jXE.OVERLAY : A.Sbl.VOICE_PANEL
            }
          };
        ...
        className: o()(D.optionsButtonContainer, {
          [D.optionsContainerActive]: ei
        }),
        children: (0, r.jsx)(s.P3F, {
          className: o()(D.optionsButton, {
            [D.optionsActive]: ei
          }),
          onClick: function(e) {
...
function R(e) {
  ...
  return l.useEffect(() => {
    ...
    text: _.intl.formatToPlainString(_.t.Sq9xJy, {
      game: t.name
    }),
    "aria-label": _.intl.formatToPlainString(_.t.Sq9xJy, {
      game: t.name
    }),
    className: D.iconSpacing,
