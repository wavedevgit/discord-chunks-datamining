...
function Y(e) {
  ...
  }, "activity")), O === x.YE.XBOX || v === L.wR.XBOX ? F.push((0, r.jsx)("div", {
    className: j.iconSpacing,
    children: (0, r.jsx)(C.Z, {
      className: o()(j.icon, b)
    })
  }, "xbox")) : (O === x.YE.PLAYSTATION || v === L.wR.PLAYSTATION) && F.push((0, r.jsx)("div", {
    className: j.iconSpacing,
  ...
  let W = null != I && !(0, w.yE)(I.flags, D.udG.EMBEDDED),
    K = null == P && W;
  return 0 !== F.length || null != H || M || K ? (0, r.jsxs)("div", {
...
function W(e, t) {
  var n, {
      avatarContainerClass: a = j.avatarContainer,
  ...
  } = (0, p.ZP)(), er = (0, u.bp)(), ei = null != et ? T.Z.getChannel(et) : null, ea = (0, s.e7)([I.default, S.Z], () => S.Z.isInChannel(et, I.default.getId())), {
    enabled: eo
  } = P.P.useExperiment({
    location: "VoiceUser"
  }), [es, el] = i.useState(!1);
  ...
  function ep() {
    return M && !F ? (0, r.jsx)(l.ua7, {
      text: k.intl.string(k.t.BVK71t),
      children: e => (0, r.jsx)("div", U({
        className: o()(j.iconPriortySpeaker, {
          [j.iconPriortySpeakerSpeaking]: !V && !H && G
        })
      }, e))
    }) : null
  }
  ...
  function eh() {
    return (0, r.jsx)("div", {
      ...
      style: {
        backgroundImage: "url(".concat(ee.getAvatarURL(W, d === D.ipw.LARGE ? 38 : 24), ")")
      }
    })
  }
  ...
  function em() {
    let e = (0, r.jsxs)("div", {
        ...
        children: [null != K ? K : R.ZP.getName(ee), z ? (0, r.jsxs)("span", {
      ...
      t = {
        ...
        profileViewedAnalytics: {
          source: g ? D.jXE.OVERLAY : D.Sbl.VOICE_PANEL
        }
      };
    return !F || g ? (0, r.jsx)(b.Z, B(U({}, t), {
      children: e
    })) : null
  }
  ...
  function eE(e) {
    null != W && null != ei && ((0, h.v)(en, h.d.MORE), el(!0), (0, v.D)(e, ee, ei, {
      context: er
    }, (e, t) => {
      (0, m.o)({
        menuName: e,
  ...
  function eb() {
    return F || !ea || eo ? null : (0, r.jsx)(l.DY3, {
      text: k.intl.string(k.t["+1H47u"]),
      className: o()(j.optionsButtonContainer, {
        [j.optionsContainerActive]: es
      }),
      children: (0, r.jsx)(l.P3F, {
        className: o()(j.optionsButton, {
          [j.optionsActive]: es
        }),
        onClick: eE,
...
function z(e) {
  let {
    ...
    channelId: s,
    userId: u
  } = e, [d, f] = i.useState(!1), p = (0, c.O)(e => f(e));
  i.useEffect(() => {
    d && _.ZP.trackWithMetadata(D.rMx.VOICE_CHANNEL_GAME_ACTIVITY_INDICATOR_VIEWED, {
      channel_id: s,
      guild_id: a,
      user_id: u
    })
