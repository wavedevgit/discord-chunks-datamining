...
function Y(e) {
  ...
  let W = null != I && !(0, R.yE)(I.flags, D.udG.EMBEDDED),
    K = null == w && W;
  return 0 !== F.length || null != H || j || K ? (0, r.jsxs)("div", {
...
function W(e, t) {
  ...
  } = (0, p.ZP)(), er = (0, u.bp)(), ei = null != et ? T.Z.getChannel(et) : null, eo = (0, s.e7)([I.default, S.Z], () => S.Z.isInChannel(et, I.default.getId())), {
    enabled: ea
  } = w.P.useExperiment({
    location: "VoiceUser"
  }), [es, el] = i.useState(!1);
  ...
  function em() {
    let e = (0, r.jsxs)("div", {
        ...
        children: [null != K ? K : P.ZP.getName(ee), z ? (0, r.jsxs)("span", {
...
function q(e) {
  ...
  if (n) {
    let e, n = () => i ? M.intl.string(M.t.Q8Uzoa) : o ? M.intl.string(M.t.uLddbW) : M.intl.string(M.t.tjtv3N);
    e = o || i ? l.v0G : l.nRN;
    let s = (0, r.jsx)(e, {
