...
let E = e => {
  let {
    ...
    sortedCategories: y,
    setCategoryRef: x
  } = e, j = (0, c.FF)("CollectiblesBrowse"), T = l.useRef(null), P = (0, u.S)(e => e.hasDefaultFilters()), {
    handlePageChange: L,
    currentPage: k
  } = (0, h.h)({
    scrollerRef: S,
      ...
      children: [j && (0, n.jsxs)("div", {
        ...
        children: [(0, n.jsx)("div", {
          ...
          className: o()(O.controlsRightSide, {
            [O.controlsRightSideResponsive]: r
          }),
          children: [(0, n.jsxs)("div", {
            className: O.sortBy,
