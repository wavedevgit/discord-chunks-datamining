...
function d(e) {
  let {
    children: t
  } = e, [n, d] = i.useState(null), [_, f] = i.useState(null), p = i.useRef(new Set), [h, m] = i.useState(!1), g = (0, o.e7)([s.Z], () => s.Z.getCurrentlySelectedChannelId()), E = i.useCallback(e => {
