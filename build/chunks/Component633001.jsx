...
let J = Chunk647438.memo(function(e) {
    let {
      trackedGame: t
    } = e, n = (0, d.e7)([f.ZP], () => f.ZP.getGameOrTransformedSubgameForPID(t.pid)), r = (0, d.e7)([k.Z], () => k.Z.getGameForPID(t.pid)), i = (0, d.e7)([f.ZP], () => null == n ? null : f.ZP.getGameOverlayStatus(n));
    return (0, a.jsxs)("div", {
