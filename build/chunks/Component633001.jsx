...
let $ = Chunk647438.memo(function(e) {
  ...
  ee = Chunk647438.memo(function(e) {
    let {
      pid: t
    } = e, n = (0, d.cj)([k.default], () => k.default.getOverlayPIDStatuses()), r = (0, d.cj)([C.default], () => C.default.getTrackedGames()), i = (0, d.e7)([k.default], () => k.default.isInputLocked(t), [t]), l = (0, d.e7)([k.default], () => k.default.DEV_isInputLockedV3(t), [t]), s = (0, d.e7)([k.default], () => k.default.DEV_isInputLocked(t), [t]), o = (0, d.e7)([k.default], () => k.default.isReady(t), [t]);
    return (0, a.jsxs)("div", {
      className: W.panelGroup,
      children: [(0, a.jsx)(m.Text, {
          ...
          children: [0 === Object.keys(e).length && (0, a.jsx)(m.Text, {
            ...
            children: [(0, a.jsx)(ea, {
              ...
              return (0, a.jsx)(m.Text, {
                ...
                color: "text-default",
                children: "".concat(n, ":").concat((0, E.sS)(n), " @ ").concat(en(r))
...
function e_() {
  let {
    ref: e,
    height: t
  } = (0, Chunk393238.ZP)(), n = (0, Chunk442837.e7)([Chunk610394.ZP], () => Chunk610394.ZP.DEV_isOverlayModuleLoggingEnabled()), [i, s] = Chunk647438.useState(require), [o, c] = Chunk647438.useState(false), [u, p] = Chunk647438.useState(null), [h, f] = Chunk647438.useState(Object.keys(em)), [g, v] = (0, Chunk442837.e7)([Chunk610394.ZP], () => Chunk610394.ZP.DEV_getOverlayLoggingBreadcrumbs(), [], Chunk136015.Q), [j, _] = Chunk647438.useState(null), y = null != Chunk984370 ? Chunk984370 : Chunk600164, C = null != Chunk984370 ? false : Chunk594190;
  ...
  let [E, T] = Chunk647438.useState(""), O = Chunk647438.useMemo(() => 0 === Chunk371651 ? [] : Chunk837268.filter(e => {
    ...
    returnfalse
  }), [Chunk837268, Chunk765250, Chunk755721, o, Chunk371651]), [P, I] = Chunk647438.useState(Chunk886118), [w, k] = Chunk647438.useState(null), A = Chunk647438.useMemo(() => Chunk837268.find(e => e.key === w), [Chunk837268, Chunk449224]), Z = Chunk647438.useCallback(e => {
    I(e)
  }, []), {
    renderSelectedTab: M
  } = (0, Chunk621060.ZP)({
...
function eE() {
  return (0, Chunk951288.jsx)(Chunk481060.w0Z, {
    children: (0, Chunk951288.jsxs)("div", {
      ...
      children: [(0, Chunk951288.jsx)(eo, {}), (0, Chunk951288.jsx)(ed, {}), (0, Chunk951288.jsx)(ec, {}), (0, Chunk951288.jsx)(es, {}), (0, Chunk951288.jsx)(er, {}), (0, Chunk951288.jsx)(el, {}), (0, Chunk951288.jsx)(ey, {}), (0, Chunk951288.jsx)(eC, {})]
    })
  })
}
...
function eS() {
  ...
  return Chunk647438.useEffect(() => (Chunk570140.Z.dispatch({
    ...
    }), "state" === module && (0, Chunk951288.jsx)(eE, {}), "logging" === module && (0, Chunk951288.jsx)(e_, {})]
  })
}