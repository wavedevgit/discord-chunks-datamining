...
function eR(e, t) {
  ...
  if (M.Xb.trackExposure({
      location: "populateInitialFrecencyData"
    }), o().isEmpty(e) && o().isEmpty(q.pendingUsages) && v.Z.hasLoaded(F.yP.FRECENCY_AND_FAVORITES_SETTINGS))
  ...
  if ((n || r) && o().isEmpty(t) && o().isEmpty(q.emojiReactionPendingUsages) && v.Z.hasLoaded(F.yP.FRECENCY_AND_FAVORITES_SETTINGS))
