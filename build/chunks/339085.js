...
n.d(t, {
  De: () => ep,
  ZP: () => eV
}), n(388685), n(825670), n(413496), n(433524), n(35282), n(539854), n(642613), n(804061), n(704826);
var r, i = n(392711),
  a = n.n(i),
  o = n(913527),
  s = n.n(o),
...
let z = "original",
  q = [F.UX.TOP_GUILD_EMOJI.toString(), F.UX.FAVORITES.toString(), F.UX.RECENT.toString(), F.UX.CUSTOM.toString()].concat(M.ZP.getCategories()),
  $ = {
    pendingUsages: [],
...
let Q = 42,
  J = L.default.fromTimestamp(Date.now() - 60 * w.Z.Millis.DAY),
  ee = [],
  et = [],
  en = 3,
  er = [...q],
...
function eu() {
  if (ed(), null == ea)
    for (let e in ea = {}, ei)
      for (let t of ei[e].rawEmojis) ea[t.id] = e;
  return ea
}
async function ed() {
  if (0 !== en) return;
...
class ep {
  ...
  getFrequentlyUsedEmojisWithoutFetchingLatest() {
    ...
    let e = eh.frequently.map(e => null != e.id ? this.getById(e.id) : M.ZP.getByName(e.name)).filter(P.lm),
      t = (0, G.Z)(e);
  ...
  getFrequentlyUsedReactionEmojisWithoutFetchingLatest() {
    ...
    let e = em.frequently.map(e => null != e.id ? this.getById(e.id) : M.ZP.getByName(e.name)).filter(P.lm),
      t = (0, G.Z)(e);
  ...
  rebuildFavoriteEmojisWithoutFetchingLatest() {
    ...
    let n = (null != (t = null == (e = v.Z.frecencyWithoutFetchingLatest.favoriteEmojis) ? void 0 : e.emojis) ? t : []).map(e => {
        var t;
  ...
  getTopEmojiWithoutFetchingLatest(e) {
    if (this.ensureDisambiguated(), null == this.topEmojis) {
      ...
      let i = (null != (t = null == n ? void 0 : n.emojiIds) ? t : r).map(e => {
          var t;
          return null != (t = this.getById(e)) ? t : M.ZP.getByName(M.ZP.convertSurrogateToName(e, !1))
        }),
        a = [];
      i.forEach(e => {
        null != e && a.push(e)
  ...
  _buildDisambiguatedCustomEmoji() {
    ...
    let n = t => {
        ...
        if (this.emojisByName[t.name] = t, "names" in t && (null == (r = t.names) || r.slice(1).forEach(e => this.unicodeAliases[e] = t.name)), null != t.id) {
          let e, n;
          this.emojisById[t.id] = t, this.customEmojis[t.name] = t, t.type === x.B.GUILD && (e = t.guildId, n = !0), null != e && (null != this.groupedCustomEmojis[e] ? this.groupedCustomEmojis[e].push(t) : this.groupedCustomEmojis[e] = [t], n && L.default.compare(t.id, J) >= 0 && (null != this.newlyAddedEmoji[e] ? this.newlyAddedEmoji[e].push(t) : this.newlyAddedEmoji[e] = [t]))
        }
  ...
  constructor(e) {
    H(this, "guildId", void 0), H(this, "emoticonRegex", null), H(this, "frequentlyUsed", null), H(this, "favorites", null), H(this, "favoriteNamesAndIds", null), H(this, "topEmojis", null), H(this, "escapedEmoticonNames", null), H(this, "disambiguatedEmoji", null), H(this, "customEmojis", void 0), H(this, "groupedCustomEmojis", void 0), H(this, "emoticonsByName", void 0), H(this, "emojisByName", void 0), H(this, "emojisById", void 0), H(this, "unicodeAliases", void 0), H(this, "newlyAddedEmoji", null), H(this, "frequentlyUsedReactionEmojis", null), H(this, "isFavoriteEmojiWithoutFetchingLatest", e => {
      var t;
      if (null == e) return !1;
      let {
...
function eR(e) {
  ...
  let t = null != e.emoji.id && "0" !== e.emoji.id ? e.emoji : M.ZP.getByName(M.ZP.convertSurrogateToName(e.emoji.name, !1));
  if (null == t) return !1;
  eM([t]), ej([t])
}
...
function eP(e, t) {
  ...
  if (j.Xb.trackExposure({
      location: "populateInitialFrecencyData"
    }), a().isEmpty(e) && a().isEmpty($.pendingUsages) && v.Z.hasLoaded(V.yP.FRECENCY_AND_FAVORITES_SETTINGS))
  ...
  if ((n || r) && a().isEmpty(t) && a().isEmpty($.emojiReactionPendingUsages) && v.Z.hasLoaded(V.yP.FRECENCY_AND_FAVORITES_SETTINGS))
...
function eD() {
  ...
  null != s && M.ZP.setDefaultDiversitySurrogate(s), ep.reset();
  ...
  eh.overwriteHistory(a().mapValues(c, e => K(Y({}, e), {
    recentUses: e.recentUses.map(Number).filter(e => e > 0)
  })), $.pendingUsages), em.overwriteHistory(a().mapValues(u, e => K(Y({}, e), {
    recentUses: e.recentUses.map(Number).filter(e => e > 0)
  })), $.emojiReactionPendingUsages), eP(c, u)
}
...
function eL(e) {
  ...
  if (h.Z.setEmojiLocale(O.default.locale), t !== V.yP.FRECENCY_AND_FAVORITES_SETTINGS || !n) return !1;
  $.pendingUsages = [], $.emojiReactionPendingUsages = []
}
...
function ej(e) {
  ...
  for (let r of e) {
    ...
    null != e && (eh.track(e), $.pendingUsages.push({
      key: e,
      timestamp: Date.now()
    }))
  }
...
function eM(e) {
  ...
  for (let r of e) {
    var t, n;
    let e = null != (n = null != (t = r.id) ? t : r.uniqueName) ? n : r.name;
    null != e && (em.track(e), $.emojiReactionPendingUsages.push({
      key: e,
      timestamp: Date.now()
    }))
  }
...
function eG(e) {
  let {
    guildId: t
  } = e, n = new Set($.expandedSectionsByGuildIds);
  $.expandedSectionsByGuildIds.has(t) ? n.delete(t) : n.add(t), $ = K(Y({}, $), {
...
class eF extends(r = c.ZP.PersistedStore) {
  initialize(e) {
    this.waitFor(f.Z, T.Z, I.ZP, A.Z, O.default, b.Z, U.Z, C.default, m.Z, S.Z), null != e && (null != e.pendingUsages && ($.pendingUsages = e.pendingUsages), null != e.emojiReactionPendingUsages && ($.emojiReactionPendingUsages = e.emojiReactionPendingUsages), null != e.expandedSectionsByGuildIds && ($.expandedSectionsByGuildIds = new Set(e.expandedSectionsByGuildIds))), this.syncWith([v.Z], eD), this.syncWith([m.Z], ex)
  }
  getState() {
    return $
  }
  ...
  get diversitySurrogate() {
    var e;
    return null != (e = M.ZP.getDefaultDiversitySurrogate()) ? e : ""
  }
