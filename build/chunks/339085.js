...
function ec() {
  if (eu(), null == ei)
    for (let e in ei = {}, er)
      for (let t of er[e].rawEmojis) ei[t.id] = e;
  return ei
}
async function eu() {
  if (0 !== et) return;
...
H(ef, "_lastInstance", null);
let ep = e_(ef.resetFrequentlyUsed),
  eh = e_(ef.resetFrequentlyUsedReactionEmojis);

function em() {
  er = {}, ei = {}, ef.reset(), eo.clear(), et = 3
}
...
function eE() {
  ei = null, ef.reset(), (3 === et || 1 === et) && (ep.compute(), eh.compute())
}
...
function eP(e, t) {
  ...
  if (k.Xb.trackExposure({
      location: "populateInitialFrecencyData"
    }), a().isEmpty(e) && a().isEmpty(X.pendingUsages) && v.Z.hasLoaded(Z.yP.FRECENCY_AND_FAVORITES_SETTINGS))
  ...
  if ((n || r) && a().isEmpty(t) && a().isEmpty(X.emojiReactionPendingUsages) && v.Z.hasLoaded(Z.yP.FRECENCY_AND_FAVORITES_SETTINGS))
...
function ew() {
  ...
  null != s && j.ZP.setDefaultDiversitySurrogate(s), ef.reset();
  ...
  ep.overwriteHistory(a().mapValues(c, e => K(Y({}, e), {
    recentUses: e.recentUses.map(Number).filter(e => e > 0)
  })), X.pendingUsages), eh.overwriteHistory(a().mapValues(u, e => K(Y({}, e), {
    recentUses: e.recentUses.map(Number).filter(e => e > 0)
  })), X.emojiReactionPendingUsages), eP(c, u)
}
...
function eM(e) {
  ...
  for (let r of e) {
    ...
    null != e && (ep.track(e), X.pendingUsages.push({
      key: e,
      timestamp: Date.now()
    }))
  }
...
function ek(e) {
  ...
  for (let r of e) {
    var t, n;
    let e = null != (n = null != (t = r.id) ? t : r.uniqueName) ? n : r.name;
    null != e && (eh.track(e), X.emojiReactionPendingUsages.push({
      key: e,
      timestamp: Date.now()
    }))
  }
...
class eV extends(r = c.ZP.PersistedStore) {
  ...
  searchWithoutFetchingLatest(e) {
    ...
    let d = null != n ? n.getGuildId() : null,
      _ = ef.get(d).nameMatchesChain(t).reduce((e, t) => {
  ...
  getTopEmoji(e) {
    return null == e ? ee : (eu(), ef.get(e).getTopEmojiWithoutFetchingLatest(e))
  }
  getNewlyAddedEmoji(e) {
    return null == e ? ee : (eu(), ef.get(e).getNewlyAddedEmojiForGuild(e))
  }
