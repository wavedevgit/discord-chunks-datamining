...
function v(e) {
  ...
  if (null == a) return 0;
  let s = r[null !== (n = null === (t = a.channel) || void 0 === t ? void 0 : t.id) && void 0 !== n ? n : "null"];
...
function b(e) {
  ...
  return U.NW.formatToPlainString(U.t["8N0BHR"], {
    timeAgo: i()(f.default.extractTimestamp(null !== (t = O.ZP.lastMessageId(e)) && void 0 !== t ? t : e)).fromNow()
  })
}