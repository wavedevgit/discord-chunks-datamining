...
function S(e, t, n, i) {
  i = i.toLowerCase();
  let a = (0, g.g)(e),
    s = r.useCallback((e, t) => !(a && e.channel.hasFlag(j.zZ.IS_GUILD_RESOURCE_CHANNEL)) && e.channel.type !== y.d4z.GUILD_DIRECTORY && (0 === t.length || l()(t, e.channel.name.toLowerCase()) || e.channel.topic.toLowerCase().includes(t)), [a]);
  return r.useMemo(() => {
    let e = {
      null: [],
      _categories: []
