...
function Q(A, e, t, r) {
  ...
  return n.useMemo(() => {
    ...
    }), A._categories = e._categories.filter(e => "null" === e.channel.id || 0 === r.length || A[e.channel.id].length > 0), (0, f.Z)(A._categories, A).forEach(b), A
  }, [e, t, s, r])
}

function O(A) {
  let e = A.getSections(!1);
  if (e[h.wZ] > 0) switch (A.getGuildActionSection().getRow(0)) {
    case I.z.GUILD_HOME:
...
function V(A, e, t, n) {
  let r = (0, c.Nj)(o.z.CHANNEL_BROWSER_NUX),
    l = (0, a.cj)([d.Z], () => {
      let e = {},
...
function T(A) {
  ...
  return H.intl.formatToPlainString(H.t["8N0BHR"], {
    timeAgo: s()(w.default.extractTimestamp(null != (e = B.ZP.lastMessageId(A)) ? e : A)).fromNow()
  })
}