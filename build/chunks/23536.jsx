...
function y(e) {
  ...
  return <s.VqE aria-label={m.intl.string(m.t["mp1N//"])}><f.ZP channel={t} onFetch={v} messages={j} loading={_ === h.M.LOADING} hasMore={_ === h.M.LOADED_HAS_MORE} analyticsName={"Channel Pins"} renderEmptyState={function() {
      ...
      }} onJump={y} loadMore={C} getProTip={function() {
