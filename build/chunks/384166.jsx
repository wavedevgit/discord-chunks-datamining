...
function h() {
  ...
  return require ? <div className={a()(Chunk900365.container, {
      [Chunk900365.visible]: require
    })} role={"status"}><div className={a()(Chunk900365.content, {
        [Chunk900365.emphasized]: module
      })}>{<div className={Chunk900365.message}><Chunk481060.Text variant={"text-md/medium"} color={"text-primary"}>{Chunk388032.intl.string(Chunk388032.t["/lQiX1"])}</Chunk481060.Text></div>}{<div className={Chunk900365.actions}>{<Chunk481060.zxk size={"sm"} variant={"secondary"} text={Chunk388032.intl.string(Chunk388032.t.yBZMsb)} onClick={m} />}{<Chunk481060.zxk size={"sm"} variant={"primary"} text={Chunk388032.intl.string(Chunk388032.t.R3BPHx)} onClick={h} />}</div>}</div></div> : null
}