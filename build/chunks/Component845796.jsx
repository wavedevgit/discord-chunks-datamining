...
let b = () => {
  ...
  } = (0, Chunk501431.S)(), i = (0, Chunk381585.sp)(), b = (0, Chunk811847.B)("CollectiblesSortSelect"), v = require(), E = Chunk473749.useMemo(() => Chunk215023.aP.filter(e => e.sortType !== a.E.RELEVANCE || v), [v]), S = Chunk473749.useCallback(e => {
    let {
      sortType: t,
      sortDirection: n
    } = e;
