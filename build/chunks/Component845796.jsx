...
let b = () => {
  ...
  } = (0, Chunk501431.S)(), i = (0, Chunk381585.sp)(), b = (0, Chunk811847.B)("CollectiblesSortSelect"), v = require(), x = Chunk473749.useMemo(() => Chunk215023.aP.filter(e => e.sortType !== o.E.RELEVANCE || v), [v]), E = Chunk473749.useCallback(e => {
    let {
      sortType: t,
      sortDirection: n
    } = e;
