...
let O = Chunk647438.memo(function(e) {
  ...
  let {
    guild: O
  } = e, _ = (0, o.e7)([c.Z], () => c.Z.getNewMemberActions(O.id), [O.id]), y = (0, o.e7)([u.Z], () => u.Z.getCompletedActions(O.id)), j = i.useMemo(() => {
    if (null == _ || null == y) return 0;
    let e = 0;
    return _.forEach(t => {
      null != y[t.channelId] && e++
    }), e
  }, [y, _]), v = null == _ ? 0 : _.length, C = (0, l.JA)("progress-bar-".concat(O.id));
  return (0, r.jsxs)("li", {
