...
function u(t) {
  ...
  let a = _(t),
    ...
    h = (0, r.p2)(t),
    N = L === c.bL.NULL && t.isGuildStageVoice() ? o.intl.format(o.t.L2hmY2, {}) : null == (e = S(t, h)) || null == (i = e.find(t => {
      let {
        setting: i
      } = t;
      return i === g
    })) ? void 0 : i.label;
  return null != a ? (0, n.jsx)(l.sNh, {
