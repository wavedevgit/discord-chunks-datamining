  ...
  return null == N ? null : (0, i.jsxs)(i.Fragment, {
    children: [t.isForumLikeChannel() ? (0, i.jsxs)(i.Fragment, {
      ...
      return (0, i.jsx)(l.k5B, {
        ...
        id: "".concat(a),
        label: d,
        subtext: a === o.bL.NULL ? function(t, e) {
        ...
        action: () => {
          null != e && r.Z.updateChannelOverrideSettings(e, n, {
            message_notifications: a
          }, g.UE.notifications(a))
        },
        checked: a === h
      }, a)
    })]
...
function S(t) {
  ...
  let r = _(t),
    ...
    h = (0, a.p2)(t),
    E = L === o.bL.NULL && t.isGuildStageVoice() ? c.intl.format(c.t.L2hmY2, {}) : null == (n = u(t, h)) || null == (e = n.find(t => {
      let {
        setting: e
      } = t;
      return e === g
    })) ? void 0 : e.label;
  return null != r ? (0, i.jsx)(l.sNh, {
