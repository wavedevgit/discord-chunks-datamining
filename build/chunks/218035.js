...
function _(t) {
  ...
  return null == L ? null : (0, i.jsxs)(i.Fragment, {
    children: [t.isForumLikeChannel() ? (0, i.jsxs)(i.Fragment, {
      ...
      return (0, i.jsx)(r.k5B, {
        group: "channel-notifications",
        id: "".concat(a),
        label: o,
        subtext: a === u.bL.NULL ? function(t, e) {
...
function S(t) {
  ...
  let s = _(t),
    ...
    h = (0, a.p2)(t),
    E = f === u.bL.NULL && t.isGuildStageVoice() ? c.intl.format(c.t.L2hmY2, {}) : null == (n = g(t, h)) || null == (e = n.find(t => {
      let {
        setting: e
      } = t;
      return e === d
    })) ? void 0 : e.label;
  return null != s ? (0, i.jsx)(r.sNh, {
