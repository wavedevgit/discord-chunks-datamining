...
let W = (0, S.Mg)(s.Z.STICKERS_CONSTANTS_STICKER_PICKER_BREAKPOINT_SMALL),
  ...
  eh = e => {
    let {
      ...
      ownedStickerPacks: S,
      channel: T
    } = e, A = (0, u.O)(), N = (0, o.e7)([O.default], () => O.default.getCurrentUser()), {
  ...
  em = i.forwardRef(function(e, t) {
    let {
      ...
      stickersGrid: S,
      channel: T
    } = e, A = i.useRef(!1), N = i.useRef(null), [C, R] = h.ZN.useStore(e => [e.activeCategoryIndex, e.inspectedExpressionPosition], a.X), {
      analyticsLocations: w
    } = (0, f.ZP)(d.Z.STICKER_PICKER), D = (0, m.Iu)(e => e.searchQuery), L = (0, o.e7)([P.Z], () => P.Z.getPremiumPacks()), {
      renderRow: M,
      renderSection: k,
