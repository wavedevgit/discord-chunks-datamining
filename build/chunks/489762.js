...
let W = (0, S.Mg)(s.Z.STICKERS_CONSTANTS_STICKER_PICKER_BREAKPOINT_SMALL),
  ...
  ep = e => {
    ...
    return {
      ...
      handleSelect: i.useCallback((e, i) => {
        ...
        if (i) return void((0, w.gM)(c.id) ? (0, N.hW)(c.id) : ((0, C.cQ)({
          sticker: c,
          location: Y(Z({}, u), {
  ...
  eh = e => {
    let {
      ...
      ownedStickerPacks: S,
      channel: T
    } = e, A = (0, u.O)(), N = (0, a.e7)([v.default], () => v.default.getCurrentUser()), {
      ...
      channel: T,
      currentUser: N
    }), [M, F] = i.useState(!1), V = i.useCallback(e => {
    ...
    }, [m, s, c, d, f, _, h, C, x, n, S, T, N]), H = i.useCallback((e, t) => (0, r.jsx)("div", {
      children: t
      ...
      switch (n.type) {
        case R.Ih.FAVORITE:
          return (0, r.jsx)(b.Z, {
            className: B.packHeader,
            "aria-label": G.intl.formatToPlainString(G.t["7lLCjY"], {
              categoryName: n.name
            }),
            icon: (0, r.jsx)(l.r7p, {
              size: "xs",
    ...
    return {
      ...
      renderSectionFooter: i.useCallback(e => {
        let n = g[e],
          i = t.has(n.id);
        return n.type !== R.Ih.EMPTY_GUILD_UPSELL || null != E || i ? null : (0, r.jsx)(L.Z, {
  ...
  em = i.forwardRef(function(e, t) {
    let {
      ...
      stickersGrid: S,
      channel: T
    } = e, A = i.useRef(!1), N = i.useRef(null), [C, R] = h.ZN.useStore(e => [e.activeCategoryIndex, e.inspectedExpressionPosition], o.X), {
      analyticsLocations: w
    } = (0, f.ZP)(d.Z.STICKER_PICKER), D = (0, m.Iu)(e => e.searchQuery), L = (0, a.e7)([P.Z], () => P.Z.getPremiumPacks()), {
      renderRow: k,
      renderSection: M,
    ...
    return (0, E.Xs)({
      ...
      getListDimensions: function() {
        ...
        return null != (t = null == (e = N.current) ? void 0 : e.getListDimensions(...r)) ? t : {
          height: -1,
          totalHeight: -1
        }
      }
