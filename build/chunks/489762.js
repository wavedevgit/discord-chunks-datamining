...
let Y = (0, S.Mg)(s.Z.STICKERS_CONSTANTS_STICKER_PICKER_BREAKPOINT_SMALL),
  ...
  ep = e => {
    ...
    return {
      ...
      handleSelect: i.useCallback((e, i) => {
        ...
        if (i) return void((0, w.gM)(c.id) ? (0, A.hW)(c.id) : ((0, C.cQ)({
          sticker: c,
          location: W(Z({}, u), {
  ...
  eh = e => {
    ...
    }, [m, s, c, d, f, _, h, C, x, n, S, T, A]), H = i.useCallback((e, t) => (0, r.jsx)("div", {
      children: t
  ...
  em = i.forwardRef(function(e, t) {
    let {
      ...
      stickersGrid: S,
      channel: T
    } = e, N = i.useRef(!1), A = i.useRef(null), [C, R] = h.ZN.useStore(e => [e.activeCategoryIndex, e.inspectedExpressionPosition], o.X), {
    ...
    return (0, E.Xs)({
      ...
      getListDimensions: function() {
        ...
        return null != (t = null == (e = A.current) ? void 0 : e.getListDimensions(...r)) ? t : {
          height: -1,
          totalHeight: -1
        }
      }
