...
let P = (0, Chunk468194.Mg)(Chunk477690.Z.LIVE_INDICATOR_BORDER_RADIUS),
  ...
  U = e => {
    ...
    let Z = <f.ua7 text={B()} position={"bottom"} color={f.ua7.Colors.GREY}>{e => (0, r.jsxs)(f.P3F, R(N({}, e), {
        onClick: G,
    ...
    return <f.IGR text={Z} className={a()(P, S.qualityIndicatorBadge, {
        [S.qualityIndicatorBadgePremium]: M && w
      })} color={u.Z.unsafe_rawColors.PRIMARY_500.css} shape={h.eE[d]} />
  },
  G = e => {
    let {
      participant: t,
