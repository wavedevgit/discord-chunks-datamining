...
function h(e, t, n) {
  ...
  return [<l.sNh id={"spotify-play-".concat(e.session_id)} action={() => (0, d.Z)(h, p.kG.USER_ACTIVITY_PLAY, n)} label={f.intl.string(f.t.rRffNz)} subtext={g ? (0, s.Z)(h, p.kG.USER_ACTIVITY_PLAY) : true} disabled={g} />, h.canPlaySpotify ? <l.sNh id={"spotify-sync-".concat(e.session_id)} action={() => (0, u.Z)(h, p.kG.USER_ACTIVITY_SYNC, n)} label={f.intl.string(f.t.eU3inJ)} subtext={m ? (0, s.Z)(h, p.kG.USER_ACTIVITY_SYNC) : true} disabled={m} /> : null]
}