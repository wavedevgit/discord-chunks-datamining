...
function A(e) {
  ...
  return null != n ? R = m.intl.string(m.t["6VQaqa"]) : null != i && (R = m.intl.string(m.t["OzOM/v"])), <r.Fragment>{<c.zx{...O(b({
      ...
      children: R
    })} />}{<f.Z channel={a} stream={n} appContext={p} className={o()(E, g.iconButton)} exitFullScreen={u} analyticsLocation={h} guildScheduledEvent={C} />}</r.Fragment>
}