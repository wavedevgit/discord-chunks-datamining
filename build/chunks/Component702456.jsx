...
function w(e) {
  ...
  let {
    ...
    let e = _.Z.getDMFromUserId(i.id);
    ...
    let e = _.Z.getDMFromUserId(i.id);
    null != e && (0, h.yw)(j.rMx.CHANNEL_OPENED, Z(A({}, (0, h.$H)(e)), {
      location: "".concat(g.Z.FREQUENT_FRIENDS_ROW, " ").concat(l + 1)
    }))
...
function L() {
  ...
  }), [d, g] = Chunk473749.useState({
    scrollLeft: 0,
    scrollWidth: 0,
    clientWidth: 0
  }), h = Chunk473749.useRef(null), E = (0, Chunk442837.e7)([Chunk351402.Z], () => Chunk351402.Z.ipCountryCode), _ = (0, Chunk81643.gD)(), v = Chunk473749.useCallback(() => {
    var e;
