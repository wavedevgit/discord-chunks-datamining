...
function p(e) {
  ...
  return <div className={u.titleWrapper}><a.Text variant={"text-xs/semibold"} color={"header-primary"}>{t}</a.Text></div>
}
...
function g(e) {
  ...
  return <a.ua7 text={n} aria-label={n}>{e => (0, r.jsx)(a.P3F, f(d({}, e), {
      className: u.button,
      onClick: t,
...
function m(e) {
  ...
  return <a.ua7 text={i} aria-label={i}>{e => (0, r.jsx)(a.P3F, f(d({}, e), {
