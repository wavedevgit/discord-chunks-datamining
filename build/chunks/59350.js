...
function ee(e) {
  ...
  let {
    prompt: n,
    guild: i
  } = e, [s, d] = r.useState(null), [u, m] = r.useState(new Set), h = null == n || null == (t = n.options) ? void 0 : t.filter(e => u.has(e.id)), p = (0, B.L6)(h), f = (0, B.dX)(h), x = (0, o.Wu)([k.Z], () => k.Z.getOnboardingResponsesForPrompt(i.id, n.id)), {
    helpText: _,
    ...
    children: [n.isNew && (0, l.jsx)(c.IGR, {
      ...
      children: [n.title, n.required ? (0, l.jsx)("span", {
        className: a()(X.required, {
          [X.error]: (null == s ? void 0 : s.type) === K
        }),
        children: "*"
      }) : null]
    }), (0, l.jsx)(U.Z, {
...
function en(e) {
  ...
  }, [null == m ? void 0 : m.id, C]), r.useEffect(() => {
    if ((null == m ? void 0 : m.id) != null && !x.Z.isFullServerPreview(m.id)) return () => {
