...
function ee(e) {
  ...
  }), C = (0, d.e7)([I.ZP], () => I.ZP.getSelfMember(a.id)), b = (0, d.Wu)([I.ZP], () => I.ZP.getMemberRoleWithPendingUpdates(a.id, o.id)), N = (0, d.e7)([Z.Z], () => Z.Z.getRoles(a.id)), w = s()(b).filter(e => N.hasOwnProperty(e)).map(e => N[e]).orderBy("position", "desc").value(), P = (0, v.ZP)(o.id, a.id);
  (0, f.ZP)(() => {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(m.X6q, {
      ...
      children: [(0, r.jsx)("div", (n = K({}, h), l = l = {
        children: (0, r.jsx)(T, {
          src: u,
          avatarDecoration: g,
          size: Q,
...
function et(e) {
  ...
  let {
    prompt: n,
    guild: a
  } = e, [o, s] = l.useState(null), [c, u] = l.useState(new Set), h = null == n || null == (t = n.options) ? void 0 : t.filter(e => c.has(e.id)), p = (0, R.L6)(h), f = (0, R.dX)(h), g = (0, d.Wu)([A.Z], () => A.Z.getOnboardingResponsesForPrompt(a.id, n.id)), {
    helpText: x,
  ...
  } = (0, D.Z)(a.id), j = n.options.map(e => K({
    value: e.id
...
function en(e) {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [n.isNew && (0, r.jsx)(m.IGR, {
      ...
      children: n.options.map(e => (0, r.jsx)(H.Z, {
        hideMemberCount: !0,
        guildId: a.id,
        option: e,
        onSelect: t => j(e, t),
...
function er(e) {
  let {
    guildId: t,
    onBrowseChannels: n
  } = e, a = (0, u.wj)((0, g.ZP)()), o = (0, d.e7)([Z.Z], () => Z.Z.getGuild(t)), s = (0, d.e7)([P.default], () => P.default.getCurrentUser()), c = (0, p.Z)("(min-width: 1344px)") && null != s, f = l.useCallback(() => {
    (0, N.uL)(F.Z5c.CHANNEL(t, z.oC.CHANNEL_BROWSER)), null == n || n()
  }, [t, n]), x = (0, d.e7)([w.ZP], () => w.ZP.hasUnread(t, q.W.GUILD_ONBOARDING_QUESTION)), {
  ...
  return (0, r.jsxs)(m.Den, {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      children: [(j.length > 0 || v.length > 0) && (0, r.jsxs)(r.Fragment, {
