...
function C(e) {
  ...
  let q = (0, g.M)(),
    ...
    eo = i.useRef(false);
  i.useEffect(() => {
    true === C && (eo.current = true, l.u.announce(null != D ? D : m.intl.string(m.t.A11Y_LOADING_STARTED))), false === C && true === eo.current && (l.u.announce(null != L ? L : m.intl.string(m.t.A11Y_LOADING_FINISHED)), eo.current = false)
  }, [C, D, L]);
  let ea = (0, r.jsxs)("div", {
