...
class A extends i.PureComponent {
  ...
  componentWillUnmount() {
    C.S.unsubscribe(y.CkL.SCROLL_PAGE_UP, this.scrollPageUp), C.S.unsubscribe(y.CkL.SCROLL_PAGE_DOWN, this.scrollPageDown), window.removeEventListener("keydown", this.handleKeyDown, {
      capture: !0
  ...
  constructor(...e) {
    super(...e), N(this, "state", {
      ...
      animating: !1
    }), N(this, "scrollerRef", i.createRef()), N(this, "lastInputedKeys", []), N(this, "scrollPageUp", () => {
