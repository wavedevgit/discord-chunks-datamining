...
let v = function(e) {
  let {
    ...
    reducedMotion: I
  } = i.useContext(c.S), T = i.useRef(null), [S, A] = i.useState(!1), N = (0, f.Q3)("Switch"), C = (0, d.d)(N ? l.Z.colors.INTERACTIVE_MUTED : l.Z.unsafe_rawColors.PRIMARY_400).spring(), R = (0, d.d)(N ? l.Z.colors.REDESIGN_INPUT_CONTROL_SELECTED : l.Z.unsafe_rawColors.GREEN_360).spring(), {
    state: P,
    opacity: w
  } = (0, _.q_F)({
    config: b,
