...
function X(e) {
  ...
  }(l, Y), v = 0 === u.length || u.every(e => 0 === e.userIds.length);
  if (i.useEffect(() => {
    ...
    }, [t.guild_id, t.id, t.type]), v) return (0, r.jsx)(J, {
    channel: t
  });
