...
function X(e) {
  ...
  } = (0, y.ZP)(b.Z.MEMBER_LIST), u = (0, C.D)(t.id, n), f = u.filter(e => e.userIds.length > 0).reverse()[0], {
    navigator: g,
    listRef: _
  } = function(e, t) {
  ...
  }(l, Y), O = 0 === u.length || u.every(e => 0 === e.userIds.length);
  if (i.useEffect(() => {
