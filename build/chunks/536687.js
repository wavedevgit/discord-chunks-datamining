...
function L(e) {
  ...
  } = e, F = (0, v.il)(T), Z = (0, g.tP)(T), q = (0, a.e7)([m.Z], () => m.Z.getState().theme), U = (0, s.wj)(q) ? N.BRd.DARK : N.BRd.LIGHT, Q = (0, a.e7)([d.Z], () => d.Z.useReducedMotion), G = (0, p.aM)(), [Y, z] = l.useState(F.progressSeconds), [H, K] = l.useState(!1), {
    completedRatio: X,
    completedRatioDisplay: W
  } = (0, g.I)(T), [$, J] = (0, _.G6)(k.intl.string(k.t.RDE0SU), k.intl.string(k.t["+5kSoa"]), 1700), ee = null != (0, v.LM)(T.config), et = (null == (t = T.userStatus) ? void 0 : t.claimedAt) != null ? ee ? k.intl.string(k.t.WYchdX) : k.intl.string(k.t.vTgCW1) : k.intl.string(k.t.cfY4PD), en = l.useCallback(() => {
    (0, v.f2)(T.id, {
