...
function V(e) {
  ...
  let {
  ...
  } = e, Q = (0, O.il)(Z), z = (0, b.tP)(Z), G = (0, u.e7)([v.Z], () => v.Z.getState().theme), K = (0, d.wj)(G) ? k.BRd.DARK : k.BRd.LIGHT, W = (0, u.e7)([f.Z], () => f.Z.useReducedMotion), X = (0, g.aM)(), [$, J] = l.useState(Q.progressSeconds), [ee, et] = l.useState(!1), {
    completedRatio: en,
    completedRatioDisplay: er
  } = (0, b.I)(Z), [el, eo] = (0, D.G6)(A.intl.string(A.t.RDE0SU), A.intl.string(A.t["+5kSoa"]), 1700), ei = null != (0, O.LM)(Z.config), [ea, es] = l.useState(!1), ec = l.useRef(null), eu = (null == (t = Z.userStatus) ? void 0 : t.claimedAt) != null ? ei ? A.intl.string(A.t.WYchdX) : A.intl.string(A.t.vTgCW1) : A.intl.string(A.t.cfY4PD), ed = l.useCallback(() => {
    (0, O.f2)(Z.id, {
    ...
    (0, O.f2)(Z.id, {
      ...
      impressionId: X,
      sourceQuestContent: H
    }), (0, p.showToast)((0, p.createToast)(A.intl.string(A.t["+5kSoa"]), p.ToastType.SUCCESS)), es(!0), null != ec.current && clearTimeout(ec.current), ec.current = setTimeout(() => {
      es(!1)
    }, 1700)
  }, [X, Z.id, H]);
  l.useEffect(() => () => {
          ...
          children: [(0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)(m.zx, {
              ...
              children: [(0, r.jsx)(m.zx, {
                ...
                quest: Z,
                useReducedMotion: W,
                isExpanded: (null == (x = Z.userStatus) ? void 0 : x.completedAt) != null,
                disabled: (null == (N = Z.userStatus) ? void 0 : N.completedAt) == null,
                ctaLabel: eu,
                onClick: ef,
                questContent: S.jn.VIDEO_MODAL,
                sourceQuestContent: H
