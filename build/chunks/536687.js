...
function L(e) {
  ...
  } = e, B = (0, b.il)(T), F = (0, p.tP)(T), Z = (0, a.e7)([d.Z], () => d.Z.getState().theme), q = (0, s.wj)(Z) ? N.BRd.DARK : N.BRd.LIGHT, U = (0, a.e7)([u.Z], () => u.Z.useReducedMotion), Q = (0, f.aM)(), G = (0, E.up)(P.dr.VIDEO_MODAL), [Y, z] = l.useState(B.progressSeconds), [H, K] = l.useState(!1), {
    completedRatio: X,
    completedRatioDisplay: W
  } = (0, p.I)(T), [$, J] = (0, _.G6)(k.intl.string(k.t.RDE0SU), k.intl.string(k.t["+5kSoa"]), 1700), ee = null != (0, b.LM)(T.config), et = (null == (t = T.userStatus) ? void 0 : t.claimedAt) != null ? ee ? k.intl.string(k.t.WYchdX) : k.intl.string(k.t.vTgCW1) : G, en = l.useCallback(() => {
    (0, b.f2)(T.id, {
