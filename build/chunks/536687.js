...
function L(e) {
  ...
  } = e, F = (0, b.il)(T), Z = (0, p.tP)(T), q = (0, a.e7)([d.Z], () => d.Z.getState().theme), U = (0, s.wj)(q) ? N.BRd.DARK : N.BRd.LIGHT, Q = (0, a.e7)([u.Z], () => u.Z.useReducedMotion), G = (0, f.aM)(), Y = (0, E.up)(P.dr.VIDEO_MODAL), [z, H] = l.useState(F.progressSeconds), [K, X] = l.useState(!1), {
    completedRatio: W,
    completedRatioDisplay: $
  } = (0, p.I)(T), [J, ee] = (0, _.G6)(k.intl.string(k.t.RDE0SU), k.intl.string(k.t["+5kSoa"]), 1700), et = null != (0, b.LM)(T.config), en = (null == (t = T.userStatus) ? void 0 : t.claimedAt) != null ? et ? k.intl.string(k.t.WYchdX) : k.intl.string(k.t.vTgCW1) : Y, er = l.useCallback(() => {
    (0, b.f2)(T.id, {
  ...
  }, eo = l.useMemo(() => C.r.build(T.config).defaultRewardName, [T]), ei = k.intl.formatToPlainString(k.t["12IWPz"], {
    rewardName: eo
  });
