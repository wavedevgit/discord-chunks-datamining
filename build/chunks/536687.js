...
function R(e) {
  ...
  } = e, Z = (0, E.il)(P), q = (0, v.tP)(P), U = (0, a.e7)([m.Z], () => m.Z.getState().theme), Q = (0, s.wj)(U) ? k.BRd.DARK : k.BRd.LIGHT, G = (0, a.e7)([d.Z], () => d.Z.useReducedMotion), Y = (0, p.aM)(), z = (0, O.up)(N.dr.VIDEO_MODAL), [H, K] = l.useState(Z.progressSeconds), [X, W] = l.useState(!1), {
    completedRatio: $,
    completedRatioDisplay: J
  } = (0, v.I)(P), [ee, et] = (0, x.G6)(I.intl.string(I.t.RDE0SU), I.intl.string(I.t["+5kSoa"]), 1700), en = null != (0, E.LM)(P.config), er = (null == (t = P.userStatus) ? void 0 : t.claimedAt) != null ? en ? I.intl.string(I.t.WYchdX) : I.intl.string(I.t.vTgCW1) : z, el = l.useCallback(() => {
    (0, E.f2)(P.id, {
  ...
  }, ei = l.useMemo(() => h.r.build(P.config).defaultRewardName, [P]), ea = I.intl.formatToPlainString(I.t["12IWPz"], {
    rewardName: ei
  });
