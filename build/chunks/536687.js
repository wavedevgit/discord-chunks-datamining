...
function I(e) {
  ...
  } = e, V = (0, b.il)(D), B = (0, a.e7)([d.Z], () => d.Z.getState().theme), F = (0, s.wj)(B) ? T.BRd.DARK : T.BRd.LIGHT, Z = (0, a.e7)([u.Z], () => u.Z.useReducedMotion), U = (0, p.aM)(), [q, Y] = l.useState(V.progressSeconds), [Q, G] = l.useState(!1), {
    completedRatio: z,
    completedRatioDisplay: H
  } = (0, f.I)(D), [K, W] = (0, y.G6)(N.intl.string(N.t.RDE0SU), N.intl.string(N.t["+5kSoa"]), 1700), X = null != (0, b.LM)(D.config), $ = (null == (t = D.userStatus) ? void 0 : t.claimedAt) != null ? X ? N.intl.string(N.t.WYchdX) : N.intl.string(N.t.vTgCW1) : N.intl.string(N.t.cfY4PD), J = l.useCallback(() => {
    (0, b.f2)(D.id, {
      content: g.jn.VIDEO_MODAL,
      ctaContent: m.jZ.COPY_QUEST_URL,
      impressionId: U
    }), W()
  }, [U, D.id, W]), ee = l.useMemo(() => O.r.build(D.config).defaultReward.messages.name, [D]), et = N.intl.formatToPlainString(N.t["12IWPz"], {
    rewardName: ee
  });
