...
function L(e) {
  ...
  } = e, B = (0, b.il)(T), F = (0, p.tP)(T), Z = (0, a.e7)([d.Z], () => d.Z.getState().theme), q = (0, s.wj)(Z) ? N.BRd.DARK : N.BRd.LIGHT, U = (0, a.e7)([u.Z], () => u.Z.useReducedMotion), Q = (0, f.aM)(), G = (0, E.up)(P.dr.VIDEO_MODAL), [Y, H] = l.useState(B.progressSeconds), [z, K] = l.useState(!1), {
    completedRatio: W,
