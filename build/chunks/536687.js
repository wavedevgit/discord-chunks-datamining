...
function V(e) {
  ...
  } = e, Q = (0, O.il)(F), z = (0, b.tP)(F), G = (0, u.e7)([v.Z], () => v.Z.getState().theme), K = (0, d.wj)(G) ? k.BRd.DARK : k.BRd.LIGHT, X = (0, u.e7)([f.Z], () => f.Z.useReducedMotion), W = (0, g.aM)(), [$, J] = l.useState(Q.progressSeconds), [ee, et] = l.useState(!1), {
    completedRatio: en,
  ...
  }, ev = l.useMemo(() => _.r.build(F.config).defaultRewardName, [F]), eE = A.intl.formatToPlainString(A.t["12IWPz"], {
    rewardName: ev
