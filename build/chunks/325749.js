...
function M(e) {
  let {
    applicationId: t,
    channelId: n
  } = e, i = (0, c.e7)([p.Z], () => p.Z.getApplication(t)), M = (0, c.e7)([E.ZP], () => E.ZP.getSelfEmbeddedActivities().get(t)), K = (0, c.e7)([_.Z], () => _.Z.getChannel(n)), W = j.Sb.useSetting(), V = (0, c.Wu)([C.ZP], () => {
    var e;
  ...
  }, [J]), X = null == M ? void 0 : M.userIds, F = (0, c.Wu)([I.default], () => Array.from(null != X ? X : []).map(e => I.default.getUser(e)).filter(e => null != e), [X]), H = m.Z.useExperiment({
    ...
    return o.useEffect(() => (null == t || t.addEventListener(k.NO, c), () => {
