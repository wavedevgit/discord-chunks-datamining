...
function M(e) {
  let {
    applicationId: t,
    channelId: n
  } = e, i = (0, a.e7)([d.Z], () => d.Z.getApplication(t)), M = (0, a.e7)([E.ZP], () => E.ZP.getSelfEmbeddedActivities().get(t)), z = (0, a.e7)([_.Z], () => _.Z.getChannel(n)), W = h.Sb.useSetting(), K = (0, a.Wu)([I.ZP], () => {
    var e;
  ...
  }, [V]), F = null == M ? void 0 : M.userIds, G = (0, a.Wu)([Z.default], () => Array.from(null != F ? F : []).map(e => Z.default.getUser(e)).filter(e => null != e), [F]), H = f.Z.useExperiment({
    location: "activity_popout_overflow_menu"
  }, {
    autoTrackExposure: !0
  }).enabled, X = o.useCallback(() => {
    let e = (0, N.getPID)();
    ...
    let {
      ...
      currentDocument: t,
      rootNode: n
    } = (0, D.Z)(), [r, i] = o.useState(!1), l = o.useCallback(() => {
      null != n && r && (i(!1), (0, T.Pr)(n, t))
    }, [n, t, r]), a = o.useCallback(() => {
      null != n && (r ? l() : (i(!0), (0, T.Dj)(n)))
    }, [n, r, l]), c = o.useCallback(() => {
      null != n && !(0, T.rB)(n, t) && r && a()
    }, [n, t, r, a]);
    return o.useEffect(() => (null == t || t.addEventListener(T.NO, c), () => {
        ...
        children: [(0, r.jsx)("div", {
          ...
          children: [(0, r.jsx)(g.Z, {
            ...
            children: (e, t) => {
              ...
              return (0, o.createElement)(O.Z, (n = function(e) {
