...
function G(e) {
  let {
    applicationId: t,
    channelId: n
  } = e, i = (0, c.e7)([f.Z], () => f.Z.getApplication(t)), G = (0, c.e7)([U.ZP], () => U.ZP.getSelfEmbeddedActivities().get(t)), H = (0, c.e7)([Z.Z], () => Z.Z.getChannel(n)), X = y.Sb.useSetting(), F = (0, c.Wu)([w.ZP], () => {
    var e;
  ...
  }, [q]), Q = null == G ? void 0 : G.userIds, ee = (0, c.Wu)([S.default], () => Array.from(null != Q ? Q : []).map(e => S.default.getUser(e)).filter(e => null != e), [Q]), et = b.Z.useExperiment({
    location: "activity_popout_overflow_menu"
  }, {
    autoTrackExposure: !0
  }).enabled, en = o.useCallback(() => {
    let e = (0, A.getPID)();
    ...
    let {
      ...
      currentDocument: t,
      rootNode: n
    } = (0, M.Z)(), [r, i] = o.useState(!1), l = o.useCallback(() => {
    ...
    return o.useEffect(() => (null == t || t.addEventListener(E.NO, c), () => {
        ...
        children: [(0, r.jsx)("div", {
          ...
          children: [(0, r.jsx)(_.Z, {
            ...
            children: (e, t) => {
              ...
              return (0, o.createElement)(P.Z, (n = function(e) {
