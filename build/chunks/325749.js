...
function J(e) {
  let {
    applicationId: t,
    channelId: n
  } = e, i = (0, a.e7)([p.Z], () => p.Z.getApplication(t)), J = (0, a.e7)([A.ZP], () => A.ZP.getSelfEmbeddedActivities().get(t)), G = (0, a.e7)([Z.Z], () => Z.Z.getChannel(n)), H = j.Sb.useSetting(), F = (0, a.Wu)([C.ZP], () => {
    var e;
  ...
  }, [X]), $ = null == J ? void 0 : J.userIds, Q = (0, a.Wu)([w.default], () => Array.from(null != $ ? $ : []).map(e => w.default.getUser(e)).filter(e => null != e), [$]), ee = m.Z.useExperiment({
    location: "activity_popout_overflow_menu"
  }, {
    autoTrackExposure: !0
  }).enabled, et = o.useCallback(() => {
    let e = (0, E.getPID)();
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)("div", {
          ...
          children: [(0, r.jsx)(g.Z, {
            ...
            onOpenPopout: () => {},
            onClosePopout: () => {
              (0, s.yw)(z.rMx.ACTIVITY_POPOUT_POP_IN_BUTTON_CLICKED), (0, R.Z)({
                onConfirm: () => {
                  D.Z.popInActivity()
                }
              })
