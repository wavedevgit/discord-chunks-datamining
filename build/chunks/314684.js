...
function P(e) {
  let {
    showAnimations: t
  } = e, n = (0, l.e7)([c.Z], () => c.Z.useReducedMotion), i = A();
  if (null == i) return;
  let {
    redeemableInDays: r = 0,
    tenureRewardSkuId: s
  } = i, a = T.Ft.FREE_AVATAR_DECO_1_MONTH === s ? T.jW : null;
  if (null == a) return;
  let o = Math.min(a, Math.max(a - r, 0)),
    d = 100 * o / a;
  return {
    initialPercentage: t && !n ? 100 * Math.max(o - .25 * a, 0) / a : d,
    percentage: d
  }
}
let R = new Set,
  ...
  k = () => {
    ...
    return i.useCallback(() => {
      null != e && !0 === e.showNotification && (n === a.z.TENURE_REWARD_REDEEMABLE || n === a.z.TENURE_REWARD_PENDING) && ((0, g.EW)(n), n === a.z.TENURE_REWARD_PENDING && !1 === r.current && (_.default.track(N.rMx.USER_NITRO_TENURE_REWARD_ACKNOWLEDGED, {
...
function M(e) {
  ...
  }, [s, a, n, r]), null != (t = null == s ? void 0 : s.get(e)) ? t : null
}