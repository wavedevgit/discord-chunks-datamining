...
function I(e) {
  let {
    showAnimations: t
  } = e, n = (0, r.e7)([a.Z], () => a.Z.useReducedMotion), i = N();
  if (null == i) return;
  let {
  ...
  let c = Math.min(o, Math.max(o - s, 0)),
    d = 100 * c / o;
  return {
    initialPercentage: t && !n ? 100 * Math.max(c - .25 * o, 0) / o : d,
    percentage: d
  }
}
let y = new Set,
  ...
  D = () => {
    ...
    return i.useCallback(() => {
      null != e && !0 === e.showNotification && (n === s.z.TENURE_REWARD_REDEEMABLE || n === s.z.TENURE_REWARD_PENDING) && ((0, u.EW)(n), n === s.z.TENURE_REWARD_PENDING && !1 === r.current && (f.default.track(S.rMx.USER_NITRO_TENURE_REWARD_ACKNOWLEDGED, {
...
function k(e) {
  ...
  }, [l, a, n, s]), null != (t = null == l ? void 0 : l.get(e)) ? t : null
}