    ...
    super(...e), S(this, "maybeOpenServerDriveAnnouncementModal", async (e, t) => {
      ...
      if (null != i) {
        if (!1 === t) {
          ...
          } else if ((null == i ? void 0 : i.contentIdentifier) === "Q1_MARKETING_MOMENT_ANNOUNCEMENT_CONTENT_IDENTIFIER" && !1 === (0, I.M)({
              location: "OfferAnnouncementManager"
            })) return !1
        }
        return (0, a.Mr3)(N), (0, a.ZDy)(async () => {
          let {
            default: e
      ...
      if ((0, p.I5)(e)) return {};
      let t = [C.hs, C.RU, C.rB, C.ih].map(e => d.Z.getUserDiscountOffer(e)).filter(e => null != e && !(0, _.kA)(e)).shift();
      if (null != t) return {
        userDiscountOffer: t
      };
      let n = (0, f.J0)();
