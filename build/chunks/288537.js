...
function ea(e) {
  ...
  do {
    if (o = e.window_size - e.lookahead - e.strstart, e.strstart >= s + (s - M)) {
...
function es(e, t) {
  for (var n, r;;) {
    ...
    if (n = 0, e.lookahead >= j && (e.ins_h = (e.ins_h << e.hash_shift ^ e.window[e.strstart + j - 1]) & e.hash_mask, n = e.prev[e.strstart & e.w_mask] = e.head[e.ins_h], e.head[e.ins_h] = e.strstart), 0 !== n && e.strstart - n <= e.w_size - M && (e.match_length = eo(e, n)), e.match_length >= j)
...
function ep(e) {
  var t;
  return e && e.state ? (e.total_in = e.total_out = 0, e.data_type = S, (t = e.state).pending = 0, t.pending_out = 0, t.wrap < 0 && (t.wrap = -t.wrap), t.status = t.wrap ? G : H, e.adler = +(2 !== t.wrap), t.last_flush = c, o._tr_init(t), p) : Q(e, m)
}
...
function eg(e, t, n, r, o, a) {
  if (!e) return m;
  var s = 1;
  if (t === b && (t = 6), r < 0 ? (s = 0, r = -r) : r > 15 && (s = 2, r -= 16), o < 1 || o > C || n !== A || r < 8 || r > 15 || t < 0 || t > 9 || a < 0 || a > I) return Q(e, m);
  8 === r && (r = 9);
  var l = new e_;
...
function eE(e, t) {
  if (!e || !e.state || t > _ || t < 0) return e ? Q(e, m) : m;
  if (i = e.state, !e.output || !e.input && 0 !== e.avail_in || i.status === Y && t !== f) return Q(e, 0 === e.avail_out ? E : m);
  ...
  if (0 !== e.avail_in || 0 !== i.lookahead || t !== c && i.status !== Y) {
    ...
    if ((y === z || y === q) && (i.status = Y), y === W || y === z) return 0 === e.avail_out && (i.last_flush = false), p;
    if (y === K && (t === u ? o._tr_align(i) : t !== _ && (o._tr_stored_block(i, 0, 0, false), t === d && ($(i.head), 0 === i.lookahead && (i.strstart = 0, i.block_start = 0, i.insert = 0))), ee(e), 0 === e.avail_out)) return i.last_flush = false, p
  }
...
function ey(e, t) {
  ...
  return n.strstart += n.lookahead, n.block_start = n.strstart, n.insert = n.lookahead, n.lookahead = 0, n.match_length = n.prev_length = j - 1, n.match_available = 0, e.next_in = c, e.input = u, e.avail_in = l, n.wrap = s, p
}
r = [new ed(0, 0, 0, 0, function(e, t) {
  ...
  for (65535 > e.pending_buf_size - 5 && (n = e.pending_buf_size - 5);;) {
    ...
    if ((0 === e.strstart || e.strstart >= r) && (e.lookahead = e.strstart - r, e.strstart = r, et(e, false), 0 === e.strm.avail_out) || e.strstart - e.block_start >= e.w_size - M && (et(e, false), 0 === e.strm.avail_out)) return W
  }
