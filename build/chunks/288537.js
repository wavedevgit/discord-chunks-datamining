...
function es(e, t) {
  for (var n, r;;) {
    ...
    if (n = 0, e.lookahead >= j && (e.ins_h = (e.ins_h << e.hash_shift ^ e.window[e.strstart + j - 1]) & e.hash_mask, n = e.prev[e.strstart & e.w_mask] = e.head[e.ins_h], e.head[e.ins_h] = e.strstart), 0 !== n && e.strstart - n <= e.w_size - M && (e.match_length = ea(e, n)), e.match_length >= j)
...
function eg(e, t, n, r, a, o) {
  if (!e) return m;
  var s = 1;
  if (t === b && (t = 6), r < 0 ? (s = 0, r = -r) : r > 15 && (s = 2, r -= 16), a < 1 || a > C || n !== A || r < 8 || r > 15 || t < 0 || t > 9 || o < 0 || o > I) return Q(e, m);
  8 === r && (r = 9);
  var l = new e_;
...
function eE(e, t) {
  ...
  if (0 !== e.avail_in || 0 !== i.lookahead || t !== c && i.status !== Y) {
    ...
    if (y === K && (t === u ? a._tr_align(i) : t !== _ && (a._tr_stored_block(i, 0, 0, false), t === d && ($(i.head), 0 === i.lookahead && (i.strstart = 0, i.block_start = 0, i.insert = 0))), ee(e), 0 === e.avail_out)) return i.last_flush = false, p
  }
