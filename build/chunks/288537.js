...
function ep(e) {
  var t;
  return e && e.state ? (e.total_in = e.total_out = 0, e.data_type = T, (t = e.state).pending = 0, t.pending_out = 0, t.wrap < 0 && (t.wrap = -t.wrap), t.status = t.wrap ? G : H, e.adler = +(2 !== t.wrap), t.last_flush = c, a._tr_init(t), p) : X(e, m)
}
...
function eE(e, t) {
  ...
  if (0 !== e.avail_in || 0 !== i.lookahead || t !== c && i.status !== Y) {
    ...
    if (y === K && (t === u ? a._tr_align(i) : t !== _ && (a._tr_stored_block(i, 0, 0, !1), t === d && ($(i.head), 0 === i.lookahead && (i.strstart = 0, i.block_start = 0, i.insert = 0))), ee(e), 0 === e.avail_out)) return i.last_flush = -1, p
  }
...
function ey(e, t) {
  ...
  for (1 === s && (e.adler = o(e.adler, t, f, 0)), n.wrap = 0, f >= n.w_size && (0 === s && ($(n.head), n.strstart = 0, n.block_start = 0, n.insert = 0), d = new i.Buf8(n.w_size), i.arraySet(d, t, f - n.w_size, n.w_size, 0), t = d, f = n.w_size), l = e.avail_in, c = e.next_in, u = e.input, e.avail_in = f, e.next_in = 0, e.input = t, eo(n); n.lookahead >= k;) {
