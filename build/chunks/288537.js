...
function ev(e, t) {
  ...
  if (0 !== e.avail_in || 0 !== i.lookahead || t !== c && i.status !== W) {
    ...
    if ((b === z || b === q) && (i.status = W), b === Y || b === z) return 0 === e.avail_out && (i.last_flush = -1), p;
    if (b === K && (t === u ? o._tr_align(i) : t !== _ && (o._tr_stored_block(i, 0, 0, !1), t === d && ($(i.head), 0 === i.lookahead && (i.strstart = 0, i.block_start = 0, i.insert = 0))), ee(e), 0 === e.avail_out)) return i.last_flush = -1, p
  }
...
function eb(e) {
  var t;
  return e && e.state ? (t = e.state.status) !== G && t !== B && t !== F && t !== V && t !== Z && t !== H && t !== W ? X(e, g) : (e.state = null, t === H ? X(e, m) : p) : g
}
...
r = [new ed(0, 0, 0, 0, function(e, t) {
  ...
  for (65535 > e.pending_buf_size - 5 && (n = e.pending_buf_size - 5);;) {
    ...
    if ((0 === e.strstart || e.strstart >= r) && (e.lookahead = e.strstart - r, e.strstart = r, et(e, !1), 0 === e.strm.avail_out) || e.strstart - e.block_start >= e.w_size - k && (et(e, !1), 0 === e.strm.avail_out)) return Y
  }
