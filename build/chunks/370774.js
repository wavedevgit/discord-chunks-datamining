...
function T(t) {
  let {
    id: n
  } = t, e = (0, i.default)(new Date, p.default.extractTimestamp(n));
...
function U(t) {
  d.Z.open(c.oAB.NOTIFICATIONS, void 0, {
...
function L() {
  ...
  return {
    unreadRecentMentionsCount: (0, r.e7)([u.ZP, _.Z, s.Z], () => {
      var t, n;
