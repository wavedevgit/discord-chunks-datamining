...
class p {
  calculateFps(e, t, n) {
    ...
    if (n < this.prevTimestamp[e] + _) return NaN;
  ...
  reenableVideo(e) {
    return e in this.perUserFpsWindow && (this.logger.info("reenableVideo called for user ".concat(e, " - time = ").concat((0, i.zO)())), this.stateCleanupBeforeEnable(e), this.currentVideoAutoToggleState[e] = l.ZUi.AUTO_PROBING, this.probingUserId = e, (0, o.Z)(e, l.ZUi.AUTO_PROBING), !0)
  }
  elapsedSeconds(e, t) {
    return (e - t) / 1e3
  }
  ...
  createUser(e) {
    this.logger.info("VideoHealthManager::createUser ".concat(e)), e in this.perUserFpsWindow || (this.perUserFpsWindow[e] = [], this.prevFramesCodec[e] = -1, this.currentVideoAutoToggleState[e] = l.ZUi.NONE, this.retryBackoffCache[e] = {
