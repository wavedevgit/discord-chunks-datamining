...
let v = e => {
    let {
      transitionState: t,
      onClose: r
    } = e, [E, v] = s.useState(true), [b, j] = s.useState([]), [I, N] = s.useState("selection"), y = (0, a.e7)([f.default], () => f.default.isAuthenticated()), S = (0, a.e7)([u.Z], () => u.Z.hasLoadedExperiments), C = s.useCallback(() => {
      (0, h.Jj)().then(e => {
        let {
          body: {
            capabilities: t
