...
let C = e => {
    let {
      ...
      product: u,
      purchase: d
    } = e, p = (0, i.e7)([O.default], () => O.default.getCurrentUser()), m = (0, i.e7)([l.Z], () => l.Z.getProduct(null == r ? void 0 : r.skuId)), g = (0, i.e7)([b.default], () => b.default.locale), h = v.ZP.canUseCollectibles(p), j = (0, s.qS)(d), x = (0, s.G1)(u), y = !h && j, E = (null == d ? void 0 : d.expiresAt) != null ? (0, P.TD)(Date.now(), d.expiresAt) : null, C = (0, a.a)(d), S = (0, c.k)(m), w = (0, f.M)(!x || h), Z = I(y, x, h, w);
  ...
  S = e => {
    ...
    }, null != b ? u.Z.getAllPending() : y.Z.getAllPending())), A = v.ZP.isPremium(l), T = v.ZP.canUsePremiumProfileCustomization(l), B = (0, h.ZP)(l.id), G = !!(null == B ? void 0 : B.getPreviewBio(I).value), R = {
      user: l,
      guild: b,
      pendingGlobalName: O,
      pendingNickname: P,
