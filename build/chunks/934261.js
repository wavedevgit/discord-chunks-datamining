...
let I = e => {
    let {
      ...
      product: d,
      purchase: f
    } = e, m = (0, l.e7)([P.default], () => P.default.getCurrentUser()), g = (0, l.e7)([s.Z], () => s.Z.getProduct(null == r ? void 0 : r.skuId)), h = (0, l.e7)([x.default], () => x.default.locale), b = _.ZP.canUseCollectibles(m), j = (0, c.qS)(f), O = (0, c.G1)(d), y = !b && j, w = (null == f ? void 0 : f.expiresAt) != null ? (0, v.TD)(Date.now(), f.expiresAt) : null, I = (0, u.a)(f), N = (0, a.k)(g), Z = (0, p.M)(!O || b), k = S(y, O, b, Z);
  ...
  N = e => {
    ...
    return (0, n.jsxs)("div", {
      ...
      children: [(0, n.jsx)(m.Z, (r = w({}, R), i = i = {
        disabledInputs: !0,
        hideCustomStatus: !0
