...
let I = e => {
    let {
      ...
      product: d,
      purchase: f
    } = e, m = (0, l.e7)([O.default], () => O.default.getCurrentUser()), g = (0, l.e7)([s.Z], () => s.Z.getProduct(null == r ? void 0 : r.skuId)), h = (0, l.e7)([j.default], () => j.default.locale), b = _.ZP.canUseCollectibles(m), y = (0, c.qS)(f), x = (0, c.G1)(d), v = !b && y, C = (null == f ? void 0 : f.expiresAt) != null ? (0, P.TD)(Date.now(), f.expiresAt) : null, I = (0, u.a)(f), Z = (0, a.k)(g), N = (0, p.M)(!x || b), D = w(v, x, b, N);
  ...
  Z = e => {
    ...
    }, null != p ? d.Z.getAllPending() : v.Z.getAllPending())), A = _.ZP.isPremium(o), T = _.ZP.canUsePremiumProfileCustomization(o), R = (0, b.ZP)(o.id), G = !!(null == R ? void 0 : R.getPreviewBio(E).value), U = {
      user: o,
      guild: p,
      pendingGlobalName: j,
      pendingNickname: O,
