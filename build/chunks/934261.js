...
let I = e => {
    let {
      ...
      product: d,
      purchase: f
    } = e, m = (0, c.P)("ProfileEffectDescription"), g = (0, i.e7)([O.default], () => O.default.getCurrentUser()), h = (0, i.e7)([l.Z], () => l.Z.getProduct(null == r ? void 0 : r.skuId)), b = (0, i.e7)([j.default], () => j.default.locale), x = _.ZP.canUseCollectibles(g), P = (0, s.qS)(f), y = (0, s.G1)(d), C = !x && P, I = (null == f ? void 0 : f.expiresAt) != null ? (0, v.TD)(Date.now(), f.expiresAt) : null, w = (0, u.a)(f), Z = (0, a.k)(h), k = (0, p.M)(!y || x), D = S(C, y, x, k);
  ...
  w = e => {
    ...
    }, null != p ? d.Z.getAllPending() : y.Z.getAllPending())), A = _.ZP.isPremium(l), T = _.ZP.canUsePremiumProfileCustomization(l), B = (0, b.ZP)(l.id), G = !!(null == B ? void 0 : B.getPreviewBio(N).value), R = {
      user: l,
      guild: p,
      pendingGlobalName: j,
      pendingNickname: O,
    ...
    return (0, n.jsxs)("div", {
      ...
      children: [(0, n.jsx)(m.Z, (r = C({}, R), o = o = {
        disabledInputs: !0,
        hideCustomStatus: !0
