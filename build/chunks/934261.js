...
let S = e => {
    let {
      ...
      product: d,
      purchase: f
    } = e, m = (0, c.P)("ProfileEffectDescription"), g = (0, i.e7)([O.default], () => O.default.getCurrentUser()), h = (0, i.e7)([o.Z], () => o.Z.getProduct(null == r ? void 0 : r.skuId)), b = (0, i.e7)([j.default], () => j.default.locale), x = _.ZP.canUseCollectibles(g), P = (0, s.qS)(f), y = (0, s.G1)(d), I = !x && P, S = (null == f ? void 0 : f.expiresAt) != null ? (0, v.TD)(Date.now(), f.expiresAt) : null, N = (0, u.a)(f), Z = (0, a.k)(h), k = (0, p.M)(!y || x), D = w(I, y, x, k);
    return null != r ? (0, n.jsx)("div", {
      ...
      children: (0, n.jsxs)("div", {
        ...
        children: [(0, n.jsx)(l.Text, {
          ...
          children: E.intl.format(E.t.Io7ozs, {
            days: S.days.toString()
          })
        }), null != f && (0, n.jsxs)(l.Text, {
          variant: "text-xxs/normal",
          color: "text-muted",
          className: C.effectPurchasedAt,
          children: [E.intl.format(E.t.gW9R4O, {
            date: f.purchasedAt.toLocaleDateString(b, {
              month: "long",
              year: "numeric"
            })
          }), null != f.expiresAt && (0, n.jsxs)(n.Fragment, {
            children: [(0, n.jsx)("br", {}), E.intl.format(E.t.eZSTa2, {
  ...
  N = e => {
    ...
    }, null != p ? d.Z.getAllPending() : y.Z.getAllPending())), A = _.ZP.isPremium(o), T = _.ZP.canUsePremiumProfileCustomization(o), B = (0, b.ZP)(o.id), G = !!(null == B ? void 0 : B.getPreviewBio(E).value), R = {
      user: o,
      guild: p,
      pendingGlobalName: j,
      pendingNickname: O,
    ...
    return (0, n.jsxs)("div", {
      ...
      children: [(0, n.jsx)(m.Z, (r = I({}, R), l = l = {
        disabledInputs: !0,
        hideCustomStatus: !0
