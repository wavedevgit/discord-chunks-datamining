...
function G() {
  C = [], r = null, I = null, T = new Set, S = Chunk683860.z.LATEST_ACTIVITY, A = Chunk697988.z.MATCH_SOME, N = 0, P = [], w = a().chain(O), D = a().chain(O), x.clear(), L.clear()
}
...
function F(e) {
  ...
  (null == e ? true : e.refreshThreadIds) && (P = Object.values(f.Z.getThreadsForParent(t.guild_id, t.id)).map(e => {
    ...
    return t
  }), N = 0, R = true), 0 !== L.size && (P = P.filter(e => !L.has(e)), L.clear()), 0 !== x.size && (P = Array.from(new Set([...P, ...x])), x.clear()), ((null == e ? true : e.refreshThreadIds) || (null == e ? true : e.sortThreadIds)) && (D = a().chain(P).sort(j(l.z.LATEST_ACTIVITY)), w = a().chain(P).sort(j(l.z.CREATION_DATE)));
