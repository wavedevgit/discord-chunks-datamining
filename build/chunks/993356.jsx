...
function p(e) {
  ...
  let f = function(e) {
      ...
      return <i.Fragment>{<l.kSQ>{b().map(e => {
            let {
              setting: t,
              label: n
            } = e;
          ...
          })}</l.kSQ>}{null != y && <l.kSQ>{y}</l.kSQ>}{<l.kSQ>{<l.S89 id={"suppress-everyone"} label={g.intl.format(g.t.OWiWAg, {})} action={() => h({
              suppress_everyone: !t
            }, u.UE.suppressEveryone(!t))} checked={t} />}{<l.S89 id={"suppress-roles"} label={g.intl.string(g.t["O/QdoK"])} action={() => h({
              suppress_roles: !n
            }, u.UE.suppressRoles(!n))} checked={n} />}{<l.S89 id={"suppress-highlights"} label={g.intl.string(g.t.gPuteH)} action={() => {
              h({
                notify_highlights: O ? d.gLR.ENABLED : d.gLR.DISABLED
              }, u.UE.highlights(O))
            }} checked={O} />}{E}</l.kSQ>}{<l.kSQ><l.S89 id={"mobile-push"} label={g.intl.string(g.t["h1DL6+"])} action={() => h({
              mobile_push: !p
            }, u.UE.mobilePush(!p))} checked={p} /></l.kSQ>}</i.Fragment>
    }(e),
    ...
    E = (0, a.U)();
  return null != f ? <l.sNh id={"guild-notifications"} label={(0, i.jsxs)(i.Fragment, {
      children: [E, g.intl.string(g.t.h850Sk)]
    })} subtext={O} action={() => (0, l.ZDy)(async () => {
      let {
        default: t
