...
function V(e) {
  ...
  return (0, r.jsxs)("div", {
    className: o()(k.audienceContainer, {
...
function H(e) {
  ...
  let {
    ...
    e && (eN.cancel(), ev(!1))
  }, eR = () => ee && (0, y.p9)(j, P.Z, C.Z, w.Z, g.Z)[0], eP = () => {
    if (!eR()) return;
    let e = {
    ...
    userId: _.id,
    channel: j
  }), ek = () => (0, p.dl)() && (0, p.zd)(j.id) ? null : (0, r.jsx)(v.Z, {
    user: _,
    channel: j,
    onWatch: eP,
    previewIsOpen: es,
      ...
      return (0, r.jsx)(l.ua7, {
        ...
        children: e => {
          var {
            onClick: t,
            onContextMenu: i
          } = e, a = B(e, ["onClick", "onContextMenu"]);
          return (0, r.jsx)(A.ZP, M({
            ref: eE
          }, n, a))
        }
      })
    ...
    let s = () => null;
    return eg && eO ? s = eL : ee ? s = ek : eI && _.id !== N.default.getId() && (s = ex), (0, r.jsx)(l.yRy, {
      targetElementRef: eE,
      position: "right",
      renderPopout: s,
      shouldShow: eo && !eb,
