...
function M(e) {
  let {
    numAudience: t,
    collapsed: n
  } = e, i = n ? t : T.NW.formatToPlainString(T.t["+v2pNz"], {
    count: t
  });
  return (0, r.jsxs)("div", {
    className: o()(A.audienceContainer, {
      [A.audienceContainerCollapsed]: n
    }),
...
let L = (0, p.$)(function(e) {
  ...
  let {
    ...
    showPreview: ee,
    hidePreview: et,
    shouldShowPreview: en,
    previewIsOpen: er,
    otherClientSessionType: ei,
    voicePlatform: el,
    isSelfOnOtherClient: eo = !1,
    tabIndex: ea,
    location: es,
    isSelf: ec,
    application: eu
  } = e, ed = i.useRef(null), [ep, eh] = i.useState(!1), ef = (0, x.ic)({
    location: "VoiceUser"
  }), em = () => {
    eh(!ep)
  }, eg = () => {
    X && (null == et || et(p.id))
  }, eb = () => X && (0, _.p9)(k, P.Z, E.Z, N.Z, m.Z)[0], e_ = () => {
    if (!eb()) return;
    let e = {
    ...
    (0, c.jW)(e, async () => {
      ...
      return t => (0, r.jsx)(e, R(w({}, t), {
        ...
        onInteraction: (0, f.u)("GuildChannelUserContextMenu", h.Z.VOICE_USER, {
          targetUserId: p.id
        })
      }))
    })
