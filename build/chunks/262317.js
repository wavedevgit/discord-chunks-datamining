...
function k(e) {
  let {
    numAudience: t,
    collapsed: n
  } = e, i = n ? t : Z.NW.formatToPlainString(Z.t["+v2pNz"], {
    count: t
  });
  return (0, r.jsxs)("div", {
...
let M = (0, p.$)(function(e) {
  ...
  let {
    ...
    K && (null == ee || ee(p.id))
  }, em = () => K && (0, y.p9)(R, I.Z, O.Z, E.Z, m.Z)[0], eg = () => {
    if (!em()) return;
    let e = {
    ...
    j.default.getId() !== p.id && u.default.selectVoiceChannel(R.id), X ? ((0, _.Z)(e), s.Z.selectParticipant(e.channelId, (0, b.V9)(e))) : (0, d.iV)(e), null == ee || ee(p.id)
  }, eb = e => {
    (0, c.jW)(e, async () => {
      let {
        default: e
