...
function L(e) {
  let {
    numAudience: t,
    collapsed: n
  } = e, i = n ? t : w.intl.formatToPlainString(w.t["+v2pNz"], {
    count: t
  });
  return (0, r.jsxs)("div", {
...
let U = (0, h.$)(function(e) {
  ...
  let {
    ...
    showHangStatus: ef
  } = e, em = i.useRef(null), [eg, eb] = i.useState(!1), [e_, ey] = i.useState(!1), eC = () => {
    eb(!eg)
  }, ex = () => {
    (J || ef) && (null == er || er(h.id))
  }, ev = i.useMemo(() => new o.sW(500, () => {
    ey(!0)
  }), []), ej = e => {
