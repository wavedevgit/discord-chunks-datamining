...
function k(e) {
  let {
    numAudience: t,
    collapsed: n
  } = e, i = n ? t : A.intl.formatToPlainString(A.t["+v2pNz"], {
    count: t
  });
  return (0, r.jsxs)("div", {
...
let L = (0, h.$)(function(e) {
  ...
  let {
    ...
    showHangStatus: eh
  } = e, ef = i.useRef(null), [em, eg] = i.useState(!1), [eb, e_] = i.useState(!1), ey = () => {
    eg(!em)
  }, eC = () => {
    (Q || eh) && (null == en || en(h.id))
  }, ex = i.useMemo(() => new o.sW(500, () => {
    e_(!0)
  }), []), ev = e => {
    e && ei ? ex.delay() : !e && ex.isDelayed() && ex.cancel()
  }, ej = e => {
    e && (ex.cancel(), e_(!1))
  }, eO = () => Q && (0, y.p9)(D, Z.Z, S.Z, I.Z, g.Z)[0], eE = () => {
    if (!eO()) return;
    let e = {
