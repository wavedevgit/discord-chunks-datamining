...
let B = (0, h.$)(function(e) {
  ...
  let {
    ...
    showHangStatus: eg
  } = e, eb = i.useRef(null), [e_, ey] = i.useState(!1), [eC, ex] = i.useState(!1), ev = null != em, ej = () => {
    ey(!e_)
  }, eO = () => {
    ...
    e && (eE.cancel(), ex(!1))
  }, eI = () => $ && (0, C.p9)(L, N.Z, I.Z, Z.Z, b.Z)[0], eZ = () => {
    if (!eI()) return;
    let e = {
    ...
    userId: h.id,
    channel: L
  }), ew = () => (0, f.dl)() && (0, f.zd)(L.id) ? null : (0, r.jsx)(v.Z, {
    user: h,
    channel: L,
    onWatch: eZ,
    previewIsOpen: ea,
    ...
    let o = () => null;
    return eg && eC ? o = eN : $ ? o = ew : ev && h.id !== P.default.getId() && (o = eA), (0, r.jsx)(s.yRy, {
      targetElementRef: eb,
      position: "right",
      renderPopout: o,
      shouldShow: el && !e_,
