...
function p(e) {
  let {
    ...
    onClose: j,
    canBulkBan: C = !1
  } = e, [f, W] = n.useState(k), [v, z] = n.useState(""), [S, _] = n.useState(0), [L, R] = n.useState(!1), Z = (0, i.sE)(t, {
    location: p,
    ...
    Z(i.jQ.BAN), j()
  }, [N, Z, j, h, C, L, v, t, f, c]), w = n.useCallback(e => {
    W(e)
  }, []), y = n.useCallback(e => {
    let {
      value: t
    ...
    if (null != N && null != h) return x.NW.formatToPlainString(x.t.HVJexc, {
      count: null == h ? void 0 : h.size
    });
    if (null == c) return "";
    let e = u.ZP.getName(t, null, c);
    return x.NW.formatToPlainString(x.t.jeKpoq, {
      username: "@".concat(e)
    })
  })();
