...
function g(e) {
  let {
    ...
    canBulkBan: C = !1,
    modReportId: S
  } = e, [h, A] = i.useState(m), [v, M] = i.useState(""), [j, O] = i.useState(0), [I, N] = i.useState(!1), R = (0, o.sE)(t, {
    location: g,
    ...
    R(o.jQ.BAN), E()
  }, [f, R, E, k, C, I, v, t, h, c, S]), T = i.useCallback(e => {
    A(e)
  }, []), y = i.useCallback(e => {
    let {
      value: t
    ...
    if (null != f && null != k) return _.intl.formatToPlainString(_.t.HVJexc, {
      count: null == k ? void 0 : k.size
    });
    if (null == c) return "";
    let e = u.ZP.getName(t, null, c);
    return _.intl.formatToPlainString(_.t.jeKpoq, {
      username: "@".concat(e)
    })
  })();
