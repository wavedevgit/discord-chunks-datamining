...
function C(e) {
  let {
    ...
    canBulkBan: S = !1,
    modReportId: _
  } = e, [P, w] = r.useState(null != _ ? y : f), [Z, I] = r.useState(""), [N, T] = r.useState(null), {
    isModReportClosed: z,
    isModReport: R
  } = (0, a.cj)([m.Z], () => {
  ...
  }), [K, M] = r.useState(!1), [D, Y] = r.useState(!1), E = (0, u.sE)(t, {
    location: i,
    ...
    E(u.jQ.BAN), O()
  }, [N, Z, C, E, O, x, S, K, t, P, n, _, D]), A = r.useCallback(e => {
    w(e)
  }, []), L = r.useCallback(e => {
    let {
      value: t
    ...
    if (null != C && null != x) return g.intl.formatToPlainString(g.t.HVJexc, {
      count: null == x ? void 0 : x.size
    });
    if (null == n) return "";
    let e = p.ZP.getName(t, null, n);
    return g.intl.formatToPlainString(null != _ ? g.t.WDR8XV : g.t.jeKpoq, {
      username: "@".concat(e)
    })
