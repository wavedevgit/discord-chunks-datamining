...
function k(e) {
  let {
    ...
    canBulkBan: S = !1,
    modReportId: _
  } = e, [P, w] = r.useState(null != _ ? y : f), [Z, I] = r.useState(""), [N, T] = r.useState(null), z = (0, o.e7)([m.Z], () => {
    var e;
    return null == (e = m.Z.getChannel(_)) ? void 0 : e.isArchivedThread()
  }), [K, D] = r.useState(!1), [Y, E] = r.useState(!1), R = (0, u.sE)(t, {
    location: i,
    ...
    R(u.jQ.BAN), O()
  }, [N, Z, k, R, O, x, S, K, t, P, n, _, Y]), A = r.useCallback(e => {
    w(e)
  }, []), L = r.useCallback(e => {
    let {
      value: t
    ...
    if (null != k && null != x) return p.intl.formatToPlainString(p.t.HVJexc, {
      count: null == x ? void 0 : x.size
    });
    if (null == n) return "";
    let e = b.ZP.getName(t, null, n);
    return p.intl.formatToPlainString(null != _ ? p.t.WDR8XV : p.t.jeKpoq, {
      username: "@".concat(e)
    })
