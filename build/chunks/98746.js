...
function g(e) {
  let {
    ...
    if (null != N && null != p) return w ? m.NW.formatToPlainString(m.t.HVJexc, {
      count: null == p ? void 0 : p.size
    }) : m.NW.formatToPlainString(m.t.Ka68TE, {
      count: null == p ? void 0 : p.size
    });
    if (null == u) return "";
    let e = d.ZP.getName(t, null, u);
    return w ? m.NW.formatToPlainString(m.t.jeKpoq, {
      username: "@".concat(e)
    }) : m.NW.formatToPlainString(m.t.Qd6w7e, {
      username: "@".concat(e)
    })
  })();
  return (0, s.jsxs)(a.Y0X, {
    transitionState: f,
    children: [(0, s.jsx)(a.xBx, {
      separator: !1,
      children: w ? (0, s.jsx)(a.X6q, {
