...
function h(e) {
  let {
    ...
    canBulkBan: v = !1,
    modReportId: z
  } = e, [S, _] = s.useState(null != z ? p : k), [N, L] = s.useState(""), [R, Z] = s.useState(0), [I, w] = s.useState(!1), y = (0, a.sE)(t, {
    location: h,
    ...
    y(a.jQ.BAN), f()
  }, [j, y, f, g, v, I, N, t, S, c, z]), Y = s.useCallback(e => {
    _(e)
  }, []), A = s.useCallback(e => {
    let {
      value: t
    ...
    if (null != j && null != g) return x.intl.formatToPlainString(x.t.HVJexc, {
      count: null == g ? void 0 : g.size
    });
    if (null == c) return "";
    let e = u.ZP.getName(t, null, c);
    return x.intl.formatToPlainString(x.t.jeKpoq, {
      username: "@".concat(e)
    })
  })();
