...
function C(t) {
  let {
    ...
    canBulkBan: S = !1,
    modReportId: _
  } = t, [w, P] = r.useState(null != _ ? y : f), [Z, T] = r.useState(""), [N, I] = r.useState(null), {
    isModReportClosed: K,
    isModReport: D
  } = (0, o.cj)([m.Z], () => {
    ...
    if (null != C && null != p) return g.intl.formatToPlainString(g.t.HVJexc, {
      count: null == p ? void 0 : p.size
    });
    if (null == n) return "";
