...
function y(e) {
  let {
    ...
    canBulkBan: S = !1,
    modReportId: _
  } = e, [P, w] = r.useState(null != _ ? k : f), [Z, I] = r.useState(""), [N, T] = r.useState(null), z = (0, o.e7)([m.Z], () => {
    var e;
    return null == (e = m.Z.getChannel(_)) ? void 0 : e.isArchivedThread()
  }), [K, D] = r.useState(!1), [Y, E] = r.useState(!1), R = (0, c.sE)(t, {
    location: i,
    ...
    R(c.jQ.BAN), O()
  }, [N, Z, y, R, O, x, S, K, t, P, n, _, Y]), A = r.useCallback(e => {
    w(e)
  }, []), L = r.useCallback(e => {
    let {
      value: t
    ...
    if (null != y && null != x) return h.intl.formatToPlainString(h.t.HVJexc, {
      count: null == x ? void 0 : x.size
    });
    if (null == n) return "";
    let e = b.ZP.getName(t, null, n);
    return h.intl.formatToPlainString(null != _ ? h.t.WDR8XV : h.t.jeKpoq, {
      username: "@".concat(e)
    })
  ...
  return (0, l.jsxs)(s.Y0X, {
    ...
    children: [(0, l.jsx)(s.xBx, {
      ...
      className: v.footer,
      children: [null != _ && !z && (0, l.jsx)(s.XZJ, {
        value: Y,
        onChange: (e, t) => E(t),
