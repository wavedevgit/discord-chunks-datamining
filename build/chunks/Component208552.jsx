/** Chunk was on 46746 **/
/** chunk id: 208552, original params: e,t,n (module,exports,require) **/
require.d(exports, {
  Z: () => S
}), require("./388685.js");
...
function C(e) {
  ...
  return null == t ? (0, r.jsx)(c.hGI, {
    ...
    game: n,
    pid: t.pid
  }) : null == t.icon || "" === t.icon ? (0, r.jsx)(c.hGI, {
    className: w.screenArrowIcon,
    size: "md",
    color: "currentColor"
  }) : (0, r.jsx)("img", {
...
function S() {
  ...
  }), T = P.concat(N), [R, M] = null != (n = (0, Chunk226372.Z)(Chunk728345)) ? require : [Chunk925329, Chunk556389], A = (0, Chunk672811.L)(Chunk728345), L = (0, Chunk891180.M)(R), U = Z === Chunk268146.vA.CAMERA, D = null != I, G = null != I ? null == I || null == (e = I.id) ? true : module.startsWith(Chunk268146.vA.CAMERA) : U, H = Chunk728345 === Chunk37113.tI.PRESET_AUTO, B = D ? true : Chunk728345 === Chunk37113.tI.PRESET_VIDEO ? Chunk388032.intl.string(Chunk715689.default.MuHUFe) : Chunk728345 === Chunk37113.tI.PRESET_DOCUMENTS ? Chunk388032.intl.string(Chunk715689.default.y0JuYR) : Chunk728345 === Chunk37113.tI.PRESET_AUTO ? Chunk388032.intl.string(Chunk715689.default.m4jtlc) : true, k = (0, Chunk442837.e7)([Chunk131951.Z], () => Chunk131951.Z.getUseSystemScreensharePicker() && (0, Chunk358085.isLinux)());
  return (0, Chunk54381.jsxs)("div", {
    className: Chunk879293.root,
    children: [D && (0, Chunk54381.jsx)(C, {
      source: I
      ...
      children: [(0, Chunk54381.jsx)(Chunk481060.Text, {
        ...
        color: "text-strong",
        children: D ? null != (i = null == I ? true : I.name) ? Chunk120356 : Chunk388032.intl.string(Chunk715689.default["hJMA+x"]) : A
      }), (0, Chunk54381.jsxs)(Chunk481060.Text, {
        className: Chunk879293.summaryDetail,
        variant: "text-xs/medium",
        color: "text-muted",
        children: [D && (0, Chunk54381.jsxs)(Chunk54381.Fragment, {
        ...
        }), !S && !G && k && (0, Chunk54381.jsxs)(Chunk54381.Fragment, {
