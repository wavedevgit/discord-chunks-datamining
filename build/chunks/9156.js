...
class eh extends(r = o.ZP.PersistedStore) {
  initialize(e) {
    if (this.waitFor(g.default, m.Z, c.Z, d.Z), null != e) {
      var t, n;
      C = null != (t = e.useNewNotifications) && t, "userGuildSettings" in e && (N = e.userGuildSettings, k = a().mapValues(null != (n = e.optedInChannelsByGuild) ? n : {}, e => new Set(e)), a().forEach(N, (e, t) => {
        M[t] = ef(e)
      }))
    }
  }
