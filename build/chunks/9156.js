...
class eh extends(r = a.ZP.PersistedStore) {
  initialize(e) {
    if (this.waitFor(g.default, m.Z, c.Z, d.Z), null != e) {
      var t, n;
      C = null != (t = e.useNewNotifications) && t, "userGuildSettings" in e && (A = e.userGuildSettings, M = o().mapValues(null != (n = e.optedInChannelsByGuild) ? n : {}, e => new Set(e)), o().forEach(A, (e, t) => {
        k[t] = ef(e)
      }))
    }
  }
