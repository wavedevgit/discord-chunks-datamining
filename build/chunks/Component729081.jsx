...
function C(e) {
  ...
  let N = (0, o.bG)([c.A], () => c.A.getApplication(O.XR)),
    ...
    M = l.useMemo(() => {
      ...
      return D.map(t => {
        var n, l;
        let i = null != (n = null == (l = L[t.skuId]) ? true : l.filter(t => t.reason === b.G.WISHLIST && e.has(t.userId)).map(e => e.userId).filter(f.Vq)) ? n : [];
        return (0, r.jsx)(y.A, {
      ...
      children: (0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(a.DZT, {
          ...
          children: _.intl.format(_.t["+SqhBF"], {
            applicationName: null != (t = null == N ? true : N.name) ? t : _.intl.string(_.t["/1hhto"])
          })
        }), (0, r.jsx)("div", {
          className: v.Xb,
