...
let _ = "vc-gifting-".concat((0, Chunk835245.A)());
...
function C(e) {
  ...
  let N = (0, o.bG)([c.A], () => c.A.getApplication(O.XR)),
    ...
    L = l.useMemo(() => {
      ...
      return D.map(t => {
        var n, l;
        let i = null != (n = null == (l = M[t.skuId]) ? true : l.filter(t => t.reason === m.G.WISHLIST && e.has(t.userId)).map(e => e.userId).filter(b.Vq)) ? n : [];
        return (0, r.jsx)(y.A, {
  ...
  return l.useEffect(() => {
    0 !== D.length && h.default.track(j.HAw.COMMERCE_SHOP_VC_GIFT_BUTTON_VIEWED, {
      guild_id: I.guild_id,
      channel_id: I.id,
      sku_ids: D.map(e => e.skuId)
    })
  }, [I.id, I.guild_id, D]), (0, r.jsx)(f.A, {
    children: (0, r.jsx)(s.lGe, {
      ...
      children: (0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(s.DZT, {
          ...
          className: E.Xb,
          children: "loading" === R || 0 === D.length ? (0, r.jsx)(s.y$y, {
            className: E.Lq
          }) : L
        })]
      })
