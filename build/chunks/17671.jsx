...
var Chunk709054 = require("./709054.js"),
  ...
  Chunk710679 = require("./710679.js"),
  Chunk74562 = require("./74562.js"),
  Chunk576749 = require("./576749.js"),
  Chunk765305 = require("./765305.js"),
  Chunk981631 = require("./981631.js"),
  Chunk490897 = require("./490897.js"),
  Chunk388032 = require("./388032.js"),
  Chunk781324 = require("./781324.js");
...
function T(e) {
  ...
  return r.useEffect(() => {
    ...
    null != T && (0, s.Ju)(T, w.W.GUILD_EVENT)
  }, [T]), <a.Y0X size={a.CgR.MEDIUM} transitionState={n} aria-labelledby={_} parentComponent={"GuildEventsModal"} data-migration-pending={true}>{<a.xBx className={S.header} data-migration-pending={true}>{<a.Que size={"md"} color={"currentColor"} className={S.icon} />}{<a.X6q id={_} variant={"heading-md/semibold"}>{L.length > 0 ? I.intl.formatToPlainString(I.t.IBdqSk, {
          number: L.length
        }) : I.intl.string(I.t.tlopTE)}</a.X6q>}{G && <i.Fragment>{<div className={S.divider}>{"|"}</div>}{<a.zxk variant={"primary"} size={"sm"} onClick={() => {
            (0, a.ZDy)(async () => {
              let {
                default: e
          ...
          }} text={I.intl.string(I.t["60lJ0N"])} />}</i.Fragment>}{<a.P3F onClick={l} className={S.iconButton} aria-label={I.intl.string(I.t.cpT0Cg)}><a.Dio size={"md"} color={"currentColor"} className={S.icon} /></a.P3F>}</a.xBx>}{<a.hzk className={S.content} data-migration-pending={true}>{L.length > 0 ? L.map(e => (0, i.jsx)(C.Z, {
        guildEvent: e,
        guildId: T,
        onActionTaken: l,
