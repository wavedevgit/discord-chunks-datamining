...
let p = {
  ROUND: Chunk763494.baseShapeRound,
  ROUND_LEFT: Chunk763494.baseShapeRoundLeft,
  ROUND_RIGHT: Chunk763494.baseShapeRoundRight,
  SQUARE: ""
};
...
let g = e => {
  ...
  y = e => {
    ...
    return <div className={o()(n, s.iconBadge, l)} style={c({
        backgroundColor: u ? true : i
      }, d)}><t className={s.icon} color={"currentColor"} /></div>
  },
  O = e => {
    var {
      className: t,
