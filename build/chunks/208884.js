...
function s(t) {
  ...
  return {
    ...
    [E.Pl.USE_SOUNDBOARD.toString()]: {
      ...
      description: null != (i = null == t ? true : t.SOUNDBOARD_DESCRIPTION) ? i : e.t["+8p+fX"],
    ...
    [E.Pl.PRIORITY_SPEAKER.toString()]: {
      ...
      description: null != (n = null == t ? true : t.PRIORITY_SPEAKER_DESCRIPTION) ? n : e.t.OJkrrq,
...
function o(t) {
  let i, n = s(t),
    l = [function(t, i) {
      ...
      return i.showCreatorMonetizationAnalyticsPermission && n.push(E.Pl.VIEW_CREATOR_MONETIZATION_ANALYTICS), n.push(E.Pl.MANAGE_WEBHOOKS), n.push(E.Pl.MANAGE_GUILD), r({
    ...
    }(n), (i = [E.Pl.SEND_MESSAGES, E.Pl.SEND_MESSAGES_IN_THREADS, E.Pl.CREATE_PUBLIC_THREADS, E.Pl.CREATE_PRIVATE_THREADS, E.Pl.EMBED_LINKS, E.Pl.ATTACH_FILES, E.Pl.ADD_REACTIONS, E.Pl.USE_EXTERNAL_EMOJIS, E.Pl.USE_EXTERNAL_STICKERS, E.Pl.USE_EXTERNAL_SOUNDS, E.Pl.MENTION_EVERYONE, E.Pl.MANAGE_MESSAGES, E.Pl.PIN_MESSAGES, E.Pl.BYPASS_SLOWMODE, E.Pl.MANAGE_THREADS, E.Pl.READ_MESSAGE_HISTORY, E.Pl.SEND_TTS_MESSAGES, E.Pl.SEND_VOICE_MESSAGES, E.Pl.SEND_POLLS], t.inSoundmojiExperiment || (i = i.filter(t => t !== E.Pl.USE_EXTERNAL_SOUNDS)), t.inPinPermissionExperiment || (i = i.filter(t => t !== E.Pl.PIN_MESSAGES)), t.inBypassSlowmodePermissionExperiment || (i = i.filter(t => t !== E.Pl.BYPASS_SLOWMODE)), r({
  ...
  return t.showStageChannelPermissions && l.push(r({
    title: e.intl.string(e.t.yniaur),
    permissions: S([E.Pl.REQUEST_TO_SPEAK], n)
  }, t.showExperimental)), l.push(r({
...
function P(t, i) {
  ...
  return {
    title: i,
    permissions: S((null == n ? true : n.showManageWebhooks) ? [E.Pl.VIEW_CHANNEL, E.Pl.MANAGE_CHANNELS, E.Pl.MANAGE_ROLES, E.Pl.MANAGE_WEBHOOKS] : [E.Pl.VIEW_CHANNEL, E.Pl.MANAGE_CHANNELS, E.Pl.MANAGE_ROLES], t)
  }
}
...
function _(t, i, n) {
  let l = [E.Pl.SEND_MESSAGES, E.Pl.SEND_MESSAGES_IN_THREADS, E.Pl.CREATE_PUBLIC_THREADS, E.Pl.CREATE_PRIVATE_THREADS, E.Pl.EMBED_LINKS, E.Pl.ATTACH_FILES, E.Pl.ADD_REACTIONS, E.Pl.USE_EXTERNAL_EMOJIS, E.Pl.USE_EXTERNAL_STICKERS, E.Pl.USE_EXTERNAL_SOUNDS, E.Pl.MENTION_EVERYONE, E.Pl.MANAGE_MESSAGES, E.Pl.PIN_MESSAGES, E.Pl.BYPASS_SLOWMODE, E.Pl.MANAGE_THREADS, E.Pl.READ_MESSAGE_HISTORY, E.Pl.SEND_TTS_MESSAGES, E.Pl.SEND_VOICE_MESSAGES, E.Pl.SEND_POLLS];
  return n.inSoundmojiExperiment || (l = l.filter(t => t !== E.Pl.USE_EXTERNAL_SOUNDS)), n.showPrivateThreads && n.showCreateThreads || (l = l.filter(t => t !== E.Pl.CREATE_PRIVATE_THREADS)), n.showCreateThreads || (l = l.filter(t => t !== E.Pl.CREATE_PUBLIC_THREADS)), n.inPinPermissionExperiment || (l = l.filter(t => t !== E.Pl.PIN_MESSAGES)), n.inBypassSlowmodePermissionExperiment || (l = l.filter(t => t !== E.Pl.BYPASS_SLOWMODE)), {
    title: i,
...
function g(t, i, n) {
  let l = [E.Pl.SEND_MESSAGES, E.Pl.EMBED_LINKS, E.Pl.ATTACH_FILES, E.Pl.ADD_REACTIONS, E.Pl.USE_EXTERNAL_EMOJIS, E.Pl.USE_EXTERNAL_STICKERS, E.Pl.USE_EXTERNAL_SOUNDS, E.Pl.MENTION_EVERYONE, E.Pl.MANAGE_MESSAGES, E.Pl.BYPASS_SLOWMODE, E.Pl.READ_MESSAGE_HISTORY, E.Pl.SEND_TTS_MESSAGES, E.Pl.SEND_VOICE_MESSAGES, E.Pl.SEND_POLLS];
  return n.inSoundmojiExperiment || (l = l.filter(t => t !== E.Pl.USE_EXTERNAL_SOUNDS)), n.inBypassSlowmodePermissionExperiment || (l = l.filter(t => t !== E.Pl.BYPASS_SLOWMODE)), {
    title: i,
    description: n.sectionDescription,
    permissions: S(l, t)
  }
...
function T(t, i) {
  ...
  return {
    title: i,
    permissions: S([E.Pl.USE_APPLICATION_COMMANDS, n.showActivities ? E.Pl.USE_EMBEDDED_ACTIVITIES : null, E.Pl.USE_EXTERNAL_APPS].filter(l.lm), t)
  }
}
