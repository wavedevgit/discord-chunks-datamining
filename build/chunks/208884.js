...
function s(t) {
  ...
  return {
    ...
    [l.Pl.PRIORITY_SPEAKER.toString()]: {
      ...
      description: null != (E = null == t ? true : t.PRIORITY_SPEAKER_DESCRIPTION) ? E : S.t.OJkrro,
...
function A(t) {
  ...
  return t.showStageChannelPermissions && n.push(r({
    title: S.intl.string(S.t.yniauk),
    permissions: e([l.Pl.REQUEST_TO_SPEAK], E)
  }, t.showExperimental)), n.push(r({
...
function g(t, i, E) {
  let n = [l.Pl.SEND_MESSAGES, l.Pl.EMBED_LINKS, l.Pl.ATTACH_FILES, l.Pl.ADD_REACTIONS, l.Pl.USE_EXTERNAL_EMOJIS, l.Pl.USE_EXTERNAL_STICKERS, l.Pl.USE_EXTERNAL_SOUNDS, l.Pl.MENTION_EVERYONE, l.Pl.MANAGE_MESSAGES, l.Pl.BYPASS_SLOWMODE, l.Pl.READ_MESSAGE_HISTORY, l.Pl.SEND_TTS_MESSAGES, l.Pl.SEND_VOICE_MESSAGES, l.Pl.SEND_POLLS];
  return E.inSoundmojiExperiment || (n = n.filter(t => t !== l.Pl.USE_EXTERNAL_SOUNDS)), E.inBypassSlowmodePermissionExperiment || (n = n.filter(t => t !== l.Pl.BYPASS_SLOWMODE)), {
    title: i,
    description: E.sectionDescription,
    permissions: e(n, t)
  }
...
function a(t, i) {
  return i ? t === l.Pl.MANAGE_CHANNELS || t === l.Pl.MANAGE_THREADS ? S.intl.string(S.t.Han3PH) : t === l.Pl.MANAGE_MESSAGES ? S.intl.string(S.t.zSc2tb) : null : t === l.Pl.MANAGE_MESSAGES ? S.intl.string(S.t["2XIdPp"]) : null
}