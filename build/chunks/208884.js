...
function s(t) {
  ...
  return {
    ...
    [l.Pl.USE_SOUNDBOARD.toString()]: {
      ...
      description: null != (i = null == t ? true : t.SOUNDBOARD_DESCRIPTION) ? i : r.t["+8p+fX"],
    ...
    [l.Pl.PRIORITY_SPEAKER.toString()]: {
      ...
      description: null != (n = null == t ? true : t.PRIORITY_SPEAKER_DESCRIPTION) ? n : r.t.OJkrrq,
...
function A(t, i) {
  ...
  return {
    title: i,
    permissions: S((null == n ? true : n.showManageWebhooks) ? [l.Pl.VIEW_CHANNEL, l.Pl.MANAGE_CHANNELS, l.Pl.MANAGE_ROLES, l.Pl.MANAGE_WEBHOOKS] : [l.Pl.VIEW_CHANNEL, l.Pl.MANAGE_CHANNELS, l.Pl.MANAGE_ROLES], t)
  }
}
...
function _(t, i, n) {
  ...
  return n.inSoundmojiExperiment || (E = E.filter(t => t !== l.Pl.USE_EXTERNAL_SOUNDS)), n.showPrivateThreads && n.showCreateThreads || (E = E.filter(t => t !== l.Pl.CREATE_PRIVATE_THREADS)), n.showCreateThreads || (E = E.filter(t => t !== l.Pl.CREATE_PUBLIC_THREADS)), n.inPinPermissionExperiment || (E = E.filter(t => t !== l.Pl.PIN_MESSAGES)), {
    title: i,
