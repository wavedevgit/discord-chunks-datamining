...
function s(t) {
  ...
  return t.showStageChannelPermissions && s.push(r({
    title: l.intl.string(l.t.yniaur),
    permissions: e([E.Pl.REQUEST_TO_SPEAK], n)
  }, t.showExperimental)), s.push(r({
...
function P(t, i, n) {
  ...
  return n.inSoundmojiExperiment || (l = l.filter(t => t !== E.Pl.USE_EXTERNAL_SOUNDS)), n.showPrivateThreads && n.showCreateThreads || (l = l.filter(t => t !== E.Pl.CREATE_PRIVATE_THREADS)), n.showCreateThreads || (l = l.filter(t => t !== E.Pl.CREATE_PUBLIC_THREADS)), n.showClydeAIPermissions || (l = l.filter(t => t !== E.Pl.USE_CLYDE_AI)), {
    title: i,
...
function N(t, i, n) {
  ...
  return n.inSoundmojiExperiment || (l = l.filter(t => t !== E.Pl.USE_EXTERNAL_SOUNDS)), {
    title: i,
    description: n.sectionDescription,
    permissions: e(l, t)
  }
