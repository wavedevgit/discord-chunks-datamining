...
let W = (0, a.Z)((0, d.Z)(function(e) {
  let {
    ...
    channelId: J,
    showGuildProfile: !0
  }), ee = (0, R.Z)(l, t, B), el = (0, U.Z)(l.id, B), et = (0, q.Z)(l.id), en = (0, v.Z)({
    user: l,
    context: B
  }), er = (0, M.Z)({
    user: l,
    ...
    user: l
  }), es = (0, w.Z)(l.id), ed = (0, T.Z)(l.id), ea = (0, f.B)({
    userId: l.id,
    channelId: J,
    ...
    channelId: J,
    location: "GuildChannelUserContextMenu"
  }), ef = (0, m.Z)(l, t, J), eN = (0, L.Z)(l.id, t), eO = (0, _.Z)(l, t), ep = (0, N.Z)({
    id: l.id,
    label: Q.NW.string(Q.t["/AXYnJ"])
  }), eb = (0, y.Z)(l.id, J), ej = (0, g.Z)(l.id), eE = (0, Z.Z)(J), eP = (0, p.Z)(l), eC = (0, b.Z)(l, t, J), eM = (0, r.e7)([j.Z], () => null != X ? j.Z.getChannel(X) : null), em = (0, x.Z)({
    ...
    onHeightUpdate: K,
    context: B
  }), ex = (0, h.Z)(l.id), eS = (0, r.e7)([E.Z], () => E.Z.getVoiceChannelId()), ev = (0, k.Z)(l, eS), ey = l.isNonUserBot();
  return (0, n.jsxs)(i.v2r, {
    ...
    onSelect: F,
    onInteraction: Y,
    children: [!ey && (0, n.jsxs)(n.Fragment, {
      children: [(0, n.jsxs)(i.kSQ, {
        children: [eP, H && eC]
      }), (0, n.jsxs)(i.kSQ, {
