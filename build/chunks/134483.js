...
function z(e) {
  ...
  } = e, H = (0, j.O5)(), [W, G] = s.useState(!1), F = s.useCallback(() => G(!0), []), K = s.useCallback(() => G(!1), []), $ = (0, u.e7)([A.default], () => A.default.getCurrentUser()), J = (0, u.e7)([m.Z], () => m.Z.getState().theme), X = (0, o.wj)(J) ? M.BRd.DARK : M.BRd.LIGHT, {
    isCurrentUserStreamingQuestApplication: Y,
    isQuestInQuestBar: ee
  } = (0, u.cj)([p.Z, c.Z, x.Z], () => {
    var e;
    let t = c.Z.getParticipants(Z),
      l = null != z && null != $ && (e = p.Z, t.some(t => {
  ...
  }, [Z, $, z]), et = null != z ? L.r.build(z.config) : null, el = null == et ? void 0 : et.application.id, en = (0, u.e7)([d.ZP, p.Z], () => {
  ...
  }, [z, el, $]), es = !0 === B || Y || en, er = (0, u.e7)([x.Z], () => null != z && x.Z.isEnrolling(z.id), [z]), ei = (0, u.e7)([c.Z], () => ((null == $ ? void 0 : $.id) == null ? null : c.Z.getParticipant(Z, $.id)) != null, [Z, $]), eu = (0, f.B6)(null == z ? void 0 : z.config.expiresAt), eo = (0, f.B6)(null == et ? void 0 : et.rewardsExpireAt), ea = s.useCallback(() => {
    (0, T.AH)(z.id, {
  ...
  }), em = (0, v.up)(P.dr.QUEST_CHANNEL_CALL_HEADER), eS = s.useMemo(() => (0, h.T)({
    quest: z,
    location: P.dr.QUEST_CHANNEL_CALL_HEADER
  }), [z]), ep = (0, f.tP)(z), eA = (null == (t = z.userStatus) ? void 0 : t.enrolledAt) != null, ej = (null == (l = z.userStatus) ? void 0 : l.completedAt) != null, eT = null != z.userStatus && (0, _.zE)(z.userStatus, C.jn.QUEST_LIVE_STREAM), ef = null != z.userStatus && (0, _.zE)(z.userStatus, C.jn.QUEST_BAR), ex = ee && !ef;
  eS.info({
  ...
  return (0, n.jsxs)("div", {
    ...
    children: [!eA && (0, n.jsxs)("div", {
      ...
      children: [(0, n.jsxs)("div", {
        ...
        children: [eA && es ? eh : (0, n.jsx)("img", {
          ...
          children: [(0, n.jsxs)("div", {
            ...
            children: [(0, n.jsx)(a.X6q, {
              ...
              children: e => (0, n.jsx)(a.P3F, w(D({}, e), {
            ...
            children: ej ? Q.intl.formatToPlainString(Q.t.APddvL, {
              expirationDate: eo
        ...
        }), eA && !ej && es && (0, n.jsx)(N.Z, {
          color: a.TVs.colors.BG_BRAND,
          quest: z
        }), eA && !ej && !es && (0, n.jsx)(a.zxk, {
          className: U.cta,
          color: a.zxk.Colors.BRAND,
          fullWidth: !0,
          onClick: ec,
...
let V = function(e) {
          ...
          for (let n of e)
            if (!(0, I.I)(n))
              for (let e of l.getActivities(n.user.id)) {
                let l = (0, _.ZZ)(t, e);
                if (null != l && (null == (r = l.userStatus) ? void 0 : r.claimedAt) == null && ((0, _.Nj)({
                    quest: l
                  }) || (0, _.$J)(l))) return l
              }
        }
  ...
  return null == r || l ? null : (0, n.jsx)(Z.A, {
    questOrQuests: r,
    overrideVisibility: !t,
    questContent: C.jn.QUEST_LIVE_STREAM,
    children: () => (0, n.jsx)(z, w(D({}, e), {
      quest: r
    }))
  })
}