...
function k(e) {
  ...
  let {
  ...
  } = e, W = (0, _.O5)(), [G, F] = s.useState(!1), K = s.useCallback(() => F(!0), []), $ = s.useCallback(() => F(!1), []), J = (0, u.e7)([j.default], () => j.default.getCurrentUser()), X = (0, u.e7)([T.Z], () => T.Z.getState().theme), Y = (0, o.wj)(X) ? y.BRd.DARK : y.BRd.LIGHT, {
    isCurrentUserStreamingQuestApplication: ee,
    isQuestInQuestBar: et
  } = (0, u.cj)([A.Z, d.Z, C.Z], () => {
    var e;
    let t = d.Z.getParticipants(Q),
      n = null != k && null != J && (e = A.Z, t.some(t => {
  ...
  }, [Q, J, k]), en = null != k ? b.r.build(k.config) : null, el = null == en ? void 0 : en.application.id, es = (0, u.e7)([E.ZP, A.Z], () => {
  ...
  }, [k, el, J]), er = !0 === H || ee || es, ei = (0, u.e7)([C.Z], () => null != k && C.Z.isEnrolling(k.id), [k]), eu = (0, u.e7)([d.Z], () => ((null == J ? void 0 : J.id) == null ? null : d.Z.getParticipant(Q, J.id)) != null, [Q, J]), eo = (0, p.B6)(null == k ? void 0 : k.config.expiresAt), ea = (0, p.B6)(null == en ? void 0 : en.rewardsExpireAt), ec = s.useCallback(() => {
    (0, f.AH)(k.id, {
    ...
    questContent: x.jn.QUEST_LIVE_STREAM,
    sourceQuestContent: x.jn.QUEST_LIVE_STREAM
  }), eT = (0, g.up)(O.dr.QUEST_CHANNEL_CALL_HEADER), em = s.useMemo(() => (0, L.T)({
    quest: k,
    location: O.dr.QUEST_CHANNEL_CALL_HEADER
  }), [k]), eA = (0, p.tP)(k), ej = (null == (t = k.userStatus) ? void 0 : t.enrolledAt) != null, e_ = (null == (n = k.userStatus) ? void 0 : n.completedAt) != null, ef = null != k.userStatus && (0, v.zE)(k.userStatus, x.jn.QUEST_LIVE_STREAM), ep = null != k.userStatus && (0, v.zE)(k.userStatus, x.jn.QUEST_BAR), eC = et && !ep;
  em.info({
  ...
  return (0, l.jsxs)("div", {
    ...
    children: [!ej && (0, l.jsxs)("div", {
      ...
      children: [(0, l.jsxs)("div", {
        ...
        children: [ej && er ? eL : (0, l.jsx)("img", {
          ...
          children: [(0, l.jsxs)("div", {
            ...
            children: [(0, l.jsx)(c.X6q, {
              ...
              children: e => (0, l.jsx)(c.P3F, z(w({}, e), {
        ...
        }), ej && !e_ && er && (0, l.jsx)(R.Z, {
          color: c.TVs.colors.BG_BRAND,
          quest: k
        }), ej && !e_ && !er && (0, l.jsx)(a.zx, {
          className: V.cta,
          color: a.zx.Colors.BRAND,
          fullWidth: !0,
          onClick: ed,
...
let B = function(e) {
          ...
          for (let l of e)
            if (!(0, P.I)(l))
              for (let e of n.getActivities(l.user.id)) {
                let n = (0, v.ZZ)(t, e);
                if (null != n && (null == (r = n.userStatus) ? void 0 : r.claimedAt) == null && ((0, v.Nj)({
                    quest: n
                  }) || (0, v.$J)(n))) return n
              }
        }
  ...
  return null == r || n ? null : (0, l.jsx)(Q.A, {
    questOrQuests: r,
    overrideVisibility: !t,
    questContent: x.jn.QUEST_LIVE_STREAM,
    sourceQuestContent: x.jn.QUEST_LIVE_STREAM,
    children: () => (0, l.jsx)(k, z(w({}, e), {
      quest: r
    }))
  })
}