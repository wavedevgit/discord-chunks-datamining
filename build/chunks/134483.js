...
function z(e) {
  ...
  } = e, H = (0, p.O5)(), [W, G] = s.useState(!1), F = s.useCallback(() => G(!0), []), K = s.useCallback(() => G(!1), []), X = (0, u.e7)([f.default], () => f.default.getCurrentUser()), Y = (0, u.e7)([m.Z], () => m.Z.getState().theme), $ = (0, o.wj)(Y) ? O.BRd.DARK : O.BRd.LIGHT, J = (0, u.e7)([d.Z], () => d.Z.getParticipants(e.channelId), [e.channelId]), ee = (0, u.e7)([C.Z], () => (0, x.PM)(C.Z.quests, C.Z.questToDeliverForPlacement, v.Ok.DESKTOP_ACCOUNT_PANEL_AREA), []), {
  ...
  }, [X, z, J, ee]), el = null != z ? L.r.build(z.config) : null, es = null == el ? void 0 : el.application.id, er = (0, u.e7)([E.ZP, A.Z], () => {
  ...
  }, [z, es, X]), ei = !0 === B || et || er, eu = (0, u.e7)([C.Z], () => null != z && C.Z.isEnrolling(z.id), [z]), eo = (0, u.e7)([d.Z], () => ((null == X ? void 0 : X.id) == null ? null : d.Z.getParticipant(b, X.id)) != null, [b, X]), ea = (0, _.B6)(null == z ? void 0 : z.config.expiresAt), ec = (0, _.B6)(null == el ? void 0 : el.rewardsExpireAt), ed = s.useCallback(() => {
    (0, j.AH)(z.id, {
  ...
  }), [z]), eA = (0, _.tP)(z), ef = (null == (t = z.userStatus) ? void 0 : t.enrolledAt) != null, ep = (null == (n = z.userStatus) ? void 0 : n.completedAt) != null, ej = null != z.userStatus && (0, x.zE)(z.userStatus, v.jn.QUEST_LIVE_STREAM), e_ = null != z.userStatus && (0, x.zE)(z.userStatus, v.jn.QUEST_BAR), eC = en && !e_;
  eT.info({
