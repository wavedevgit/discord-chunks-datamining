...
function w(e) {
  ...
  } = e, B = (0, A.O5)(), [H, W] = s.useState(!1), G = s.useCallback(() => W(!0), []), F = s.useCallback(() => W(!1), []), K = (0, o.e7)([j.default], () => j.default.getCurrentUser()), $ = (0, o.e7)([E.Z], () => E.Z.getState().theme), J = (0, u.wj)($) ? k.BRd.DARK : k.BRd.LIGHT, {
    isCurrentUserStreamingQuestApplication: X,
    isQuestInQuestBar: Y
  } = (0, o.cj)([p.Z, c.Z, x.Z], () => {
    var e;
    let t = c.Z.getParticipants(L),
      l = null != w && null != K && (e = p.Z, t.some(t => {
  ...
  }, [L, K, w]), ee = null != w ? g.r.build(w.config) : null, et = null == ee ? void 0 : ee.application.id, el = (0, o.e7)([d.ZP, p.Z], () => {
  ...
  }, [w, et, K]), en = !0 === V || X || el, es = (0, o.e7)([x.Z], () => null != w && x.Z.isEnrolling(w.id), [w]), er = (0, o.e7)([c.Z], () => ((null == K ? void 0 : K.id) == null ? null : c.Z.getParticipant(L, K.id)) != null, [L, K]), ei = (0, T.B6)(null == w ? void 0 : w.config.expiresAt), eo = (0, T.B6)(null == ee ? void 0 : ee.rewardsExpireAt), eu = s.useCallback(() => {
    (0, f.AH)(w.id, {
  ...
  }), [w]), eE = (0, T.tP)(w), eS = (null == (t = w.userStatus) ? void 0 : t.enrolledAt) != null, ep = (null == (l = w.userStatus) ? void 0 : l.completedAt) != null, ej = null != w.userStatus && (0, v.zE)(w.userStatus, h.jn.QUEST_LIVE_STREAM), eA = null != w.userStatus && (0, v.zE)(w.userStatus, h.jn.QUEST_BAR), ef = Y && !eA;
  em.info({
  ...
  return (0, n.jsxs)("div", {
    className: i()(D.wrapper, {
      [D.wrapperAccepted]: eS
    }),
    onFocus: G,
    onMouseEnter: G,
    onBlur: F,
    onMouseLeave: F,
    children: [!eS && (0, n.jsxs)("div", {
      className: D.rewardTileWrapper,
      children: [eh, (0, n.jsx)(b.Z, {
        bgOpacity: .32,
      ...
      children: [(0, n.jsxs)("div", {
          ...
          children: [(0, n.jsxs)("div", {
            ...
            children: [(0, n.jsx)(a.X6q, {
              ...
              children: en ? (0, v.AV)({
                quest: w,
                taskDetails: ex
              }) : I.intl.formatToPlainString(I.t.EQa7oq, {
              ...
              children: e => (0, n.jsx)(a.P3F, U(Q({}, e), {
            ...
            children: ep ? I.intl.formatToPlainString(I.t.APddvL, {
              expirationDate: eo
        ...
        }), eS && !ep && en && (0, n.jsx)(Z.Z, {
          color: a.TVs.colors.BG_BRAND,
          quest: w
        }), eS && !ep && !en && (0, n.jsx)(a.zxk, {
          className: D.cta,
          color: a.zxk.Colors.BRAND,
          fullWidth: !0,
          onClick: ea,
...
let z = function(e) {
          ...
          for (let n of e)
            if (!(0, M.I)(n))
              for (let e of l.getActivities(n.user.id)) {
                let l = (0, v.ZZ)(t, e);
                if (null != l && (null == (r = l.userStatus) ? void 0 : r.claimedAt) == null && ((0, v.Nj)({
                    quest: l
                  }) || (0, v.$J)(l))) return l
              }
        }
  ...
  return null == r || l ? null : (0, n.jsx)(L.A, {
    questOrQuests: r,
    overrideVisibility: !t,
    questContent: h.jn.QUEST_LIVE_STREAM,
    children: () => (0, n.jsx)(w, U(Q({}, e), {
      quest: r
    }))
  })
}