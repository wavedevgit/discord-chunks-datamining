...
function W(e) {
  ...
  }), [q, N, J, $]), en = null != N ? A.r.build(N.config) : null, er = null == en ? void 0 : en.application.id, ei = (0, s.e7)([f.ZP, m.Z], () => {
  ...
  }, [N, er, q]), eo = !0 === B || ee || ei, ea = (0, s.e7)([v.Z], () => null != N && v.Z.isEnrolling(N.id), [N]), es = (0, s.e7)([d.Z], () => ((null == q ? void 0 : q.id) == null ? null : d.Z.getParticipant(h, q.id)) != null, [h, q]), el = (0, O.B6)(null == N ? void 0 : N.config.expiresAt), ec = (0, O.B6)(null == en ? void 0 : en.rewardsExpireAt), eu = i.useCallback(() => {
    (0, y.AH)(N.id, {
