...
function W(e) {
  ...
  } = e, F = (0, E.O5)(), [H, W] = i.useState(!1), K = i.useCallback(() => W(!0), []), z = i.useCallback(() => W(!1), []), q = (0, s.e7)([g.default], () => g.default.getCurrentUser()), $ = (0, s.e7)([p.Z], () => p.Z.getState().theme), X = (0, l.wj)($) ? j.BRd.DARK : j.BRd.LIGHT, Q = (0, s.e7)([d.Z], () => d.Z.getParticipants(e.channelId), [e.channelId]), J = (0, s.e7)([v.Z], () => (0, b.PM)(v.Z.quests, v.Z.questToDeliverForPlacement, I.Ok.DESKTOP_ACCOUNT_PANEL_AREA), []), {
  ...
  }), [q, N, Q, J]), en = null != N ? A.r.build(N.config) : null, er = null == en ? void 0 : en.application.id, ei = (0, s.e7)([f.ZP, m.Z], () => {
  ...
  }, [N, er, q]), ea = !0 === B || ee || ei, eo = (0, s.e7)([v.Z], () => null != N && v.Z.isEnrolling(N.id), [N]), es = (0, s.e7)([d.Z], () => ((null == q ? void 0 : q.id) == null ? null : d.Z.getParticipant(h, q.id)) != null, [h, q]), el = (0, O.B6)(null == N ? void 0 : N.config.expiresAt), ec = (0, O.B6)(null == en ? void 0 : en.rewardsExpireAt), eu = i.useCallback(() => {
    (0, y.AH)(N.id, {
  ...
  }), [N]), eh = (0, O.tP)(N), em = (null == (t = N.userStatus) ? void 0 : t.enrolledAt) != null, eg = (null == (n = N.userStatus) ? void 0 : n.completedAt) != null, eE = null != N.userStatus && (0, b.zE)(N.userStatus, I.jn.QUEST_LIVE_STREAM), eb = null != N.userStatus && (0, b.zE)(N.userStatus, I.jn.QUEST_BAR), ey = et && !eb;
  ep.info({
