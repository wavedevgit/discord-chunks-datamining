...
function k(e) {
  ...
  } = e, W = (0, _.O5)(), [G, F] = s.useState(!1), K = s.useCallback(() => F(!0), []), X = s.useCallback(() => F(!1), []), $ = (0, u.e7)([j.default], () => j.default.getCurrentUser()), J = (0, u.e7)([T.Z], () => T.Z.getState().theme), Y = (0, o.wj)(J) ? y.BRd.DARK : y.BRd.LIGHT, {
    isCurrentUserStreamingQuestApplication: ee,
    isQuestInQuestBar: et
  } = (0, u.cj)([A.Z, d.Z, C.Z], () => {
    var e;
    let t = d.Z.getParticipants(Q),
      n = null != k && null != $ && (e = A.Z, t.some(t => {
  ...
  }, [Q, $, k]), en = null != k ? b.r.build(k.config) : null, el = null == en ? void 0 : en.application.id, es = (0, u.e7)([E.ZP, A.Z], () => {
  ...
  }, [k, el, $]), er = !0 === H || ee || es, ei = (0, u.e7)([C.Z], () => null != k && C.Z.isEnrolling(k.id), [k]), eu = (0, u.e7)([d.Z], () => ((null == $ ? void 0 : $.id) == null ? null : d.Z.getParticipant(Q, $.id)) != null, [Q, $]), eo = (0, p.B6)(null == k ? void 0 : k.config.expiresAt), ea = (0, p.B6)(null == en ? void 0 : en.rewardsExpireAt), ec = s.useCallback(() => {
    (0, f.AH)(k.id, {
