...
function z(e) {
  ...
  } = e, H = (0, p.O5)(), [W, G] = s.useState(!1), F = s.useCallback(() => G(!0), []), K = s.useCallback(() => G(!1), []), X = (0, u.e7)([f.default], () => f.default.getCurrentUser()), Y = (0, u.e7)([m.Z], () => m.Z.getState().theme), $ = (0, o.wj)(Y) ? O.BRd.DARK : O.BRd.LIGHT, J = (0, u.e7)([d.Z], () => d.Z.getParticipants(e.channelId), [e.channelId]), ee = (0, u.e7)([v.Z], () => (0, j.PM)(v.Z.quests, v.Z.questToDeliverForPlacement, x.Ok.DESKTOP_ACCOUNT_PANEL_AREA), []), {
  ...
  }, [z, es, X]), ei = !0 === B || et || er, eu = (0, u.e7)([v.Z], () => null != z && v.Z.isEnrolling(z.id), [z]), eo = (0, u.e7)([d.Z], () => ((null == X ? void 0 : X.id) == null ? null : d.Z.getParticipant(b, X.id)) != null, [b, X]), ea = (0, C.B6)(null == z ? void 0 : z.config.expiresAt), ec = (0, C.B6)(null == el ? void 0 : el.rewardsExpireAt), ed = s.useCallback(() => {
    (0, _.AH)(z.id, {
  ...
  }), [z]), eA = (0, C.tP)(z), ef = (null == (t = z.userStatus) ? void 0 : t.enrolledAt) != null, ep = (null == (n = z.userStatus) ? void 0 : n.completedAt) != null, ej = null != z.userStatus && (0, j.zE)(z.userStatus, x.jn.QUEST_LIVE_STREAM), e_ = null != z.userStatus && (0, j.zE)(z.userStatus, x.jn.QUEST_BAR), eC = en && !e_;
  eT.info({
