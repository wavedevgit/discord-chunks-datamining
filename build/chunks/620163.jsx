...
var Chunk990547 = require("./990547.js"),
  ...
  Chunk795594 = require("./795594.js"),
  Chunk443702 = require("./443702.jsx"),
  Chunk327192 = require("./327192.jsx"),
  Chunk949493 = require("./949493.js"),
  Chunk675047 = require("./675047.js"),
  Chunk177508 = require("./177508.jsx"),
  Chunk956699 = require("./956699.js"),
...
let e3 = () => {
  ...
  e1 = () => {
    ...
    return exports === Chunk704215.z.CLIENT_THEMES_SETTINGS_BADGE || exports === Chunk704215.z.DEKSTOP_CUSTOM_APP_ICON_BADGE ? <Chunk481060.lBU text={Chunk388032.intl.string(Chunk388032.t.y2b7CA)} /> : exports === Chunk704215.z.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE ? <Chunk481060.IGR text={Chunk388032.intl.string(Chunk388032.t.y2b7CA)} /> : null
  },
  e8 = () => {
    let e = [];
  ...
  e6 = () => {
    let e = e8(),
      [t] = (0, Chunk243778.US)(module);
    return exports === Chunk704215.z.NAMEPLATE_USER_SETTINGS_MENU_NEW_BADGE ? <Chunk158947.Z /> : exports === Chunk704215.z.RECENT_AVATARS_SETTINGS_MENU_NEW_BADGE || exports === Chunk704215.z.DISPLAY_NAME_STYLES_NEW_BADGE ? <Chunk481060.IGR text={Chunk388032.intl.string(Chunk388032.t.y2b7CA)} /> : null
  },
  e2 = Chunk200645.Z,
  e5 = e => {
    let {
    ...
    return Object.freeze({
      ...
      [ez.s6.PRIVACY_FAMILY_CENTER]: {
        ...
        element: ej.Z,
        badgeCount: N,
        newIndicator: <l.IGR text={eX.intl.string(eX.t.y2b7CA)} color={S.Z.BG_BRAND} />,
      ...
      [ez.s6.SUBSCRIPTIONS]: {
        ...
        element: k.Z,
        icon: E ? <l.Mgn size={"xs"} color={a.Z.unsafe_rawColors.YELLOW_300.css} /> : null
      },
      ...
      [ez.s6.CLICKER_GAME]: {
        ...
        icon: <img alt={""} src={n(186542)} className={e0.clickerGameIcon} />
      },
      [ez.s6.POGGERMODE]: {
        ...
        icon: <img alt={""} src={n(348621)} className={e0.poggermodeIcon} />
      },
      [ez.s6.CHAT]: {
        section: eY.oAB.TEXT,
      ...
      [ez.s6.LOGOUT]: {
        ...
        icon: <l.PBZ size={"xs"} color={"currentColor"} />,
        variant: "destructive"
      },
      [ez.s6.SOCIAL_LINKS]: {
        section: p.ID.CUSTOM,
