...
class U extends Chunk73800.Component {
  _getEditorWindow() {
    var e, t, n, r, i;
    let o = null == (i = this.ref) || null == (r = Chunk73800.current) || null == (n = Chunk255367.getSlateEditor) || null == (t = require.call(Chunk255367)) || null == (e = exports.windowContext) ? true : module.renderWindow;
  ...
  render() {
    ...
    return <Chunk255367.Fragment>{<Chunk459273.d9 event={Chunk981631.CkL.INSERT_TEXT} handler={this.handleInsertText} />}{<Chunk459273.d9 event={Chunk981631.CkL.CLEAR_TEXT} handler={this.handleClearText} />}{F}</Chunk255367.Fragment>
  }
  constructor(e) {
    var t;
