...
function z(t) {
  let {
    transitionState: e,
    source: o
  } = t, l = (0, u.e7)([E.default], () => E.default.getCurrentUser()), z = (0, u.e7)([_.Z, x.Z], () => x.Z.getChannel(_.Z.getChannelId())), [w, L] = i.useState(null), [k, I] = i.useState(null), [O, M] = i.useState(!1), [G, P] = i.useState(0), F = i.useRef(null), U = i.useRef(null), Y = (0, p.Dt)(), D = (0, Z.Kt)() && o !== S.L0.FAMILY_CENTER, {
    verifyAgreementButtonText: V,
    verifyGateDescription: B
  } = (0, Z.a1)(o), q = o === S.L0.NSFW_SERVER || o === S.L0.NSFW_SERVER_INVITE || o === S.L0.NSFW_SERVER_INVITE_EMBED, W = null != w ? s()().diff(w, "years") : null;
  ...
  async function X() {
    ...
    try {
      ...
      if (null != e.body && null != e.body.date_of_birth)(0, A.C8)(o, e.body.date_of_birth);
        ...
        var t;
        (null == e || null == (t = e.body) ? void 0 : t.username) != null ? I(R.intl.string(R.t["TGg/2t"])) : I(null == e ? void 0 : e.body.message), M(!1)
      }
    }
  }
  async function Q() {
        ...
        switch (o) {
          ...
          case S.L0.DEEP_LINK_PROMPT:
            return R.intl.format(R.t.iyhg2t, {
              helpURL: v.Z.getArticleURL(C.BhN.AGE_GATE)
            });
          default:
    ...
    children: [(0, r.jsx)(d.hzk, {
      children: (0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(d.X6q, {
          ...
          id: Y,
          children: R.intl.format(R.t.wumolZ, {
            age: W
          })
        }), (0, r.jsx)(d.Text, {
          color: "header-secondary",
