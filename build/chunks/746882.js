...
function k(e) {
  let {
    transitionState: t,
    source: a
  } = e, s = (0, d.e7)([N.default], () => N.default.getCurrentUser()), k = (0, d.e7)([b.Z, g.Z], () => g.Z.getChannel(b.Z.getChannelId())), [v, G] = r.useState(null), [I, M] = r.useState(null), [w, F] = r.useState(!1), [Y, Z] = r.useState(0), U = r.useRef(null), D = r.useRef(null), P = (0, E.Dt)(), V = (0, R.Kt)() && a !== z.L0.FAMILY_CENTER, {
    verifyAgreementButtonText: B,
    verifyGateDescription: q
  } = (0, R.a1)(a), W = a === z.L0.NSFW_SERVER || a === z.L0.NSFW_SERVER_INVITE || a === z.L0.NSFW_SERVER_INVITE_EMBED, K = null != v ? o()().diff(v, "years") : null;
        ...
        switch (a) {
          ...
          case z.L0.DEEP_LINK_PROMPT:
            return S.intl.format(S.t.iyhg2t, {
              helpURL: p.Z.getArticleURL(L.BhN.AGE_GATE)
            });
          default:
