...
function v(e) {
  let {
    transitionState: t,
    source: l
  } = e, s = (0, d.e7)([k.default], () => k.default.getCurrentUser()), v = (0, d.e7)([E.Z, b.Z], () => b.Z.getChannel(E.Z.getChannelId())), [S, p] = r.useState(null), [M, G] = r.useState(null), [w, I] = r.useState(!1), [Z, Y] = r.useState(0), D = r.createRef(), F = r.createRef(), P = (0, _.Dt)(), U = (0, z.Kt)(), {
    verifyAgreementButtonText: B,
    verifyGateDescription: q
  } = (0, z.a1)(), K = null != S ? o()().diff(S, "years") : null;
        ...
        switch (l) {
          ...
          case j.L0.DEEP_LINK_PROMPT:
            return R.intl.format(R.t.iyhg2t, {
              helpURL: A.Z.getArticleURL(L.BhN.AGE_GATE)
            });
          default:
