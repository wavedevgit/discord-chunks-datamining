...
function C(t) {
  let {
    transitionState: e,
    source: o
  } = t, l = (0, u.e7)([x.default], () => x.default.getCurrentUser()), C = (0, u.e7)([p.Z, _.Z], () => _.Z.getChannel(p.Z.getChannelId())), [I, z] = i.useState(null), [w, k] = i.useState(null), [M, G] = i.useState(!1), [O, F] = i.useState(0), V = i.useRef(null), P = i.useRef(null), U = (0, h.Dt)(), D = (0, A.Kt)() && o !== j.L0.FAMILY_CENTER, {
  ...
  async function X() {
    ...
    try {
      ...
      if (null != e.body && null != e.body.date_of_birth)(0, S.C8)(o, e.body.date_of_birth);
        ...
        var t;
        (null == e || null == (t = e.body) ? void 0 : t.username) != null ? k(L.intl.string(L.t["TGg/2t"])) : k(null == e ? void 0 : e.body.message), G(!1)
      }
    }
  }
  async function J() {
