...
function T(e) {
  let {
    transitionState: t,
    source: r
  } = e, a = (0, d.e7)([N.default], () => N.default.getCurrentUser()), T = (0, d.e7)([b.Z, E.Z], () => E.Z.getChannel(b.Z.getChannelId())), [p, v] = l.useState(null), [M, I] = l.useState(null), [G, w] = l.useState(!1), [F, Y] = l.useState(0), Z = l.useRef(null), D = l.useRef(null), B = (0, x.Dt)(), P = (0, y.Kt)() && r !== L.L0.FAMILY_CENTER, {
    verifyAgreementButtonText: U,
    verifyGateDescription: V
  } = (0, y.a1)(r), q = r === L.L0.NSFW_SERVER || r === L.L0.NSFW_SERVER_INVITE || r === L.L0.NSFW_SERVER_INVITE_EMBED, W = null != p ? o()().diff(p, "years") : null;
        ...
        switch (r) {
          ...
          case L.L0.DEEP_LINK_PROMPT:
            return j.intl.format(j.t.iyhg2t, {
              helpURL: k.Z.getArticleURL(z.BhN.AGE_GATE)
            });
          default:
