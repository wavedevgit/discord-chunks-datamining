...
function S(e) {
  let {
    transitionState: t,
    source: l
  } = e, a = (0, d.e7)([b.default], () => b.default.getCurrentUser()), S = (0, d.e7)([g.Z, E.Z], () => E.Z.getChannel(g.Z.getChannelId())), [T, v] = r.useState(null), [G, M] = r.useState(null), [I, w] = r.useState(!1), [F, Y] = r.useState(0), Z = r.useRef(null), D = r.useRef(null), P = (0, _.Dt)(), U = (0, R.Kt)() && l !== y.L0.FAMILY_CENTER, {
    verifyAgreementButtonText: B,
    verifyGateDescription: V
  } = (0, R.a1)(l), q = l === y.L0.NSFW_SERVER || l === y.L0.NSFW_SERVER_INVITE || l === y.L0.NSFW_SERVER_INVITE_EMBED, W = null != T ? o()().diff(T, "years") : null;
        ...
        switch (l) {
          ...
          case y.L0.DEEP_LINK_PROMPT:
            return z.intl.format(z.t.iyhg2t, {
              helpURL: k.Z.getArticleURL(L.BhN.AGE_GATE)
            });
          default:
