...
function S(e) {
  let {
    transitionState: t,
    source: s
  } = e, l = (0, d.e7)([b.default], () => b.default.getCurrentUser()), S = (0, d.e7)([E.Z, N.Z], () => N.Z.getChannel(E.Z.getChannelId())), [T, p] = i.useState(null), [W, M] = i.useState(null), [G, w] = i.useState(!1), [I, Z] = i.useState(0), Y = i.createRef(), D = i.createRef(), F = (0, _.Dt)(), P = (0, j.Kt)(), U = null != T ? o()().diff(T, "years") : null;
        ...
        switch (s) {
          ...
          case C.L0.DEEP_LINK_PROMPT:
            return L.NW.format(L.t.iyhg2t, {
              helpURL: k.Z.getArticleURL(R.BhN.AGE_GATE)
            });
          default:
