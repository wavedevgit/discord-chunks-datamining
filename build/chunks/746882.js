...
function T(e) {
  let {
    transitionState: t,
    source: l
  } = e, s = (0, d.e7)([N.default], () => N.default.getCurrentUser()), T = (0, d.e7)([b.Z, E.Z], () => E.Z.getChannel(b.Z.getChannelId())), [p, v] = r.useState(null), [M, I] = r.useState(null), [G, w] = r.useState(!1), [F, Y] = r.useState(0), Z = r.createRef(), D = r.createRef(), B = (0, x.Dt)(), P = (0, y.Kt)() && l !== L.L0.FAMILY_CENTER, {
    verifyAgreementButtonText: U,
    verifyGateDescription: V
  } = (0, y.a1)(l), q = l === L.L0.NSFW_SERVER || l === L.L0.NSFW_SERVER_INVITE || l === L.L0.NSFW_SERVER_INVITE_EMBED, W = null != p ? o()().diff(p, "years") : null;
