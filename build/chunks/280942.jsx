...
function g(e) {
  ...
  let j = r.useMemo(() => f.isPausedOrPausePending && x === c.a$.NONE ? <s.sNh id={"manage-subscription"} label={d.intl.string(d.t.obRG6e)} action={() => a.Z.open(o.oAB.SUBSCRIPTIONS)} iconLeft={s.WGR} className={u.manageSubscription} /> : null, [x, f]);
  return <s.v2r onSelect={b} navId={"subscription-context"} variant={"fixed"} aria-label={d.intl.string(d.t.ogxXGh)} onClose={g}>{<s.sNh id={"apply"} label={_.transfer.label} subtext={_.transfer.subtext} action={function() {
        (0, s.ZDy)(async () => {
          let {
            default: e
      ...
      }} disabled={_.transfer.disabled} />}{(0, l.tl)(t) ? <s.sNh id={"uncancel"} label={_.uncancel.label} subtext={_.uncancel.subtext} action={function() {
        (0, s.ZDy)(async () => {
          let {
            default: e
      ...
      }} disabled={_.uncancel.disabled} /> : <s.sNh id={"cancel"} label={_.cancel.label} subtext={_.cancel.subtext} action={function() {
        (0, s.ZDy)(async () => {
          let {
            default: e
      ...
      }} disabled={_.cancel.disabled} color={"danger"} />}{j}</s.v2r>
}