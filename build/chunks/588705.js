...
let S = () => (0, i.jsxs)(l.Fragment, {
    children: [(0, i.jsx)(s.qE, {
      ...
      children: v.NW.string(v.t["3rE1Pz"])
    }), (0, i.jsx)(s.Dx, {
  ...
  A = e => {
    ...
    let R = null != c.guild ? new N.ZP(c.guild) : null,
      ...
      M = null,
      k = !1;
    if (null != R) M = null == z ? v.NW.string(v.t["3rE1Pz"]) : v.NW.formatToPlainString(v.t["5u47vb"], {
      username: h.ZP.getFormattedName(z)
    }), c.target_type === f.Iq.STREAM && null != c.target_user && (M = v.NW.formatToPlainString(v.t.x2L32d, {
      username: h.ZP.getFormattedName(c.target_user)
    })), c.target_type === f.Iq.EMBEDDED_APPLICATION && null != c.target_application && (M = null != z ? v.NW.formatToPlainString(v.t.UW1Cam, {
      username: h.ZP.getFormattedName(z)
    }) : v.NW.string(v.t.ENSuNz)), D && null == Z && (t = (0, i.jsx)(s.Vj, {
      className: j.icon,
      guild: R,
      ...
      null != W.name && "" !== W.name ? (M = v.NW.formatToPlainString(v.t["5u47vb"], {
        username: e
      ...
      l = v.NW.formatToPlainString(v.t["4aF92d"], {
        username: e
      }), k = !0, o = null != A ? null : (0, i.jsx)(s.DK, {
        className: j.directInviteSubTitle,
        children: L ? v.NW.format(v.t["6r4JiY"], {
          username: e
        }) : v.NW.format(v.t.Quj7HR, {
          username: e
        })
      })
    }
    return (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsx)(C, {
        ...
        children: [(0, i.jsx)(s.DK, {
          children: v.NW.string(v.t.mDFGFh)
        }), (0, i.jsx)(s.Dx, {
          children: A
        })]
      }) : (0, i.jsxs)(i.Fragment, {
      ...
      }), o, null != Z || k || (null == c || null == (n = c.guild) ? void 0 : n.id) === I.fQ ? null : (0, i.jsx)(s.EJ, {
