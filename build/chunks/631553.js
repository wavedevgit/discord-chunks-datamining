...
class eE extends o.Component {
    ...
    if (t) {
      ...
      if (!e.locked && this.props.locked) {
        if (window.addEventListener("contextmenu", eO, !1), null != ey) {
          let e = Date.now() - ey;
          v.Z.track(ep.rMx.OVERLAY_LOCKED, {
            unlocked_duration: e
          }), ey = null
        }
  ...
  initialSetup() {
    ...
    if (h ? p = {
      ...
      }, 128), window.addEventListener("resize", this.handleWindowResize), t && window.addEventListener("contextmenu", eO, !1), J.isPlatformEmbedded) {
      let e = (0, F.M)();
      if (null == e) return;
  ...
  render() {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(es.Z, {}), l && (0, r.jsx)("header", {
        ...
        isPreviewingInGame: l
      }), (0, ee.validResolution)(c) ? (0, r.jsx)(el.Z, {
        className: s()({
          [eg.layoutLocked]: e,
          [eg.layoutUnlocked]: !e
        })
      }) : e ? null : this.renderInvalidSizeMessage(), (0, r.jsx)(ec.Z, {}), null != d && null != u && (0, r.jsx)(ea.Z, {
        streamerId: m,
        guildId: d.id,
        channelId: u
      }), h && (0, r.jsx)(ed.Z, {
  ...
  constructor(e) {
    super(e), em(this, "handleWindowResize", () => {
      H.default.isFocusedPidOutOfProcess() ? this.forceUpdate() : u()(() => {
        this.forceUpdate()
      }, 500)
    }), em(this, "activeKeyEventShapes", []), em(this, "lockEventShape", (0, $.d2)(this.props.keybindKeyCodes)), em(this, "getActiveKeyEventIndex", e => this.activeKeyEventShapes.findIndex(t => p()(t, e))), em(this, "onKeyDownGlobal", e => {
      let t = eb(e),
...
function eS() {
  ...
  })), l = (0, f.e7)([K.Z], () => K.Z.windowSize()), s = (0, f.e7)([G.ZP], () => G.ZP.getOverlayKeybind()), a = (0, f.e7)([V.Z], () => V.Z.getVoiceChannelId()), c = (0, f.e7)([A.Z], () => A.Z.getChannel(a)), d = (0, f.e7)([L.Z], () => null != c ? L.Z.getGuild(c.guild_id) : null), u = (0, f.e7)([P.ZP, U.Z], () => (0, N.Z)(P.ZP, U.Z)), h = (0, f.e7)([z.Z], () => (0, w.Z)(z.Z)), p = (0, f.e7)([k.Z], () => null != k.Z.getCurrentUserActiveStream()), {
    analyticsLocations: g
  } = (0, j.ZP)(C.Z.OVERLAY), {
    showKeybindIndicators: m,
    dismissKeybindNotification: y
  } = (0, er.K)(), O = (0, en.o4)("ipOverlay").overlayV3UI;
  return (0, r.jsx)(j.Gt, {
    value: g,
    children: (0, r.jsx)(eE, {
      locked: e,
