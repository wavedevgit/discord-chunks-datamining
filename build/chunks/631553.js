...
class eS extends s.Component {
    ...
    if (t) {
      ...
      if (!e.locked && this.props.locked) {
        if (window.addEventListener("contextmenu", eO, !1), null != e_) {
          let e = Date.now() - e_;
          _.Z.track(ef.rMx.OVERLAY_LOCKED, {
            unlocked_duration: e
          }), e_ = null
        }
  ...
  initialSetup() {
    ...
    if (h ? p = {
      ...
      }, 128), window.addEventListener("resize", this.handleWindowResize), t && window.addEventListener("contextmenu", eO, !1), Q.isPlatformEmbedded) {
      let e = (0, K.M)();
      if (null == e) return;
      ...
      $.ZP.on("REQUEST_OPEN_EXTERNAL_URL", (e, t) => {
        X.default.getDisableExternalLinkAlert() || t === B.Z.getLastURL() ? $.ZP.send("OPEN_EXTERNAL_URL", t) : y.Z.show({
  ...
  render() {
    ...
    return (0, r.jsxs)("div", {
      ...
      }), i, (!e || a.has(ef.O0n.TEXT_WIDGET)) && (0, r.jsx)(ex, {
        locked: e,
        keybind: t,
  ...
  constructor(e) {
    ...
    }), ev(this, "activeKeyEventShapes", []), ev(this, "lockEventShape", (0, et.d2)(this.props.keybindKeyCodes)), ev(this, "getActiveKeyEventIndex", e => this.activeKeyEventShapes.findIndex(t => p()(t, e))), ev(this, "onKeyDownGlobal", e => {
      let t = eE(e),
...
function eC() {
  ...
  })), o = (0, f.e7)([J.Z], () => J.Z.windowSize()), l = (0, f.e7)([H.ZP], () => H.ZP.getOverlayKeybind()), a = (0, f.e7)([U.Z], () => U.Z.getVoiceChannelId()), c = (0, f.e7)([M.Z], () => M.Z.getChannel(a)), d = (0, f.e7)([z.Z], () => null != c ? z.Z.getGuild(c.guild_id) : null), u = (0, f.e7)([N.ZP, G.Z], () => (0, k.Z)(N.ZP, G.Z)), h = (0, w.Ns)(null == u ? void 0 : u.id), p = (0, f.e7)([j.Z], () => null != j.Z.getLastFeedFetchDate(eg.YN.GAME_PROFILE_FEED)), g = (0, f.e7)([W.Z], () => (0, T.Z)(W.Z)), m = (0, f.e7)([R.Z], () => null != R.Z.getCurrentUserActiveStream()), {
    analyticsLocations: y
  } = (0, Z.ZP)(C.Z.OVERLAY), {
    showKeybindIndicators: v,
    dismissKeybindNotification: _
  } = (0, eo.K)(), O = (0, er.o4)("ipOverlay").overlayV3UI;
  return (0, r.jsx)(Z.Gt, {
    value: y,
    children: (0, r.jsx)(eS, {
      locked: e,
