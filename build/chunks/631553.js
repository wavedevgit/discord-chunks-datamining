...
class eC extends o.Component {
  ...
  render() {
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(ec.Z, {}), l && (0, r.jsx)("header", {
        className: eO.previewingInGameHeader,
        children: ey.intl.string(ey.t.iOq96u)
      }), i, (!e || a.has(eg.O0n.TEXT_WIDGET)) && (0, r.jsx)(eS, {
        locked: e,
        keybind: t,
...
function eZ() {
  ...
  })), l = (0, f.e7)([J.Z], () => J.Z.windowSize()), s = (0, f.e7)([H.ZP], () => H.ZP.getOverlayKeybind()), a = (0, f.e7)([U.Z], () => U.Z.getVoiceChannelId()), c = (0, f.e7)([M.Z], () => M.Z.getChannel(a)), d = (0, f.e7)([z.Z], () => null != c ? z.Z.getGuild(c.guild_id) : null), u = (0, f.e7)([w.ZP, G.Z], () => (0, k.Z)(w.ZP, G.Z)), h = (0, N.Ns)(null == u ? void 0 : u.id), p = (0, f.e7)([j.Z], () => null != j.Z.getLastFeedFetchDate(em.YN.GAME_PROFILE_FEED)), g = (0, f.e7)([W.Z], () => (0, T.Z)(W.Z)), m = (0, f.e7)([A.Z], () => null != A.Z.getCurrentUserActiveStream()), {
    analyticsLocations: y
  } = (0, Z.ZP)(C.Z.OVERLAY), {
    showKeybindIndicators: O,
    dismissKeybindNotification: v
  } = (0, el.K)(), _ = (0, er.o4)("ipOverlay").overlayV3UI;
  return (0, r.jsx)(Z.Gt, {
    value: y,
    children: (0, r.jsx)(eC, {
      locked: e,
