...
function L(e) {
  ...
  let n = (0, a.e7)([b.Z], () => b.Z.questDeliveryOverride, []),
    ...
    U = i.useCallback(() => {
      if (e.quest.id === I.V6) return void window.open(_.Z.getArticleURL(S.BhN.VIRTUAL_CURRENCY_LEARN_MORE));
      (0, m.nc)(e.quest, {
    ...
    q = i.useMemo(() => {
      var e;
      return (null == (e = d.default.getCurrentUser()) ? true : e.isStaff()) === true
    }, []),
    X = i.useMemo(() => (0, r.jsx)(o.S89, {
      id: "delivery",
