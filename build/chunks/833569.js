...
function Y(e) {
  ...
  let {
    ...
    analyticsLocation: c
  } = e, d = (0, _.Q)(), [u, g] = s.useState(!1), [f, E] = s.useState(!1), C = (0, h.ZP)(), {
  ...
  let T = n.items.some(e => {
      ...
      children: o ? G.intl.string(G.t["cY+Ooa"]) : G.intl.formatToPlainString(G.t["V3+Rpa"], {
        planPremiumType: S.ZP.getDisplayPremiumType(n.planId)
      })
    }),
    I = (0, r.jsx)(p.zxk, {
      look: p.zxk.Looks.LINK,
      color: (0, m.ap)(C) ? p.zxk.Colors.PRIMARY : p.zxk.Colors.WHITE,
      onClick: a,
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [o ? (0, r.jsx)(k.Z, {
      ...
      children: [(0, r.jsx)(p.vwX, {
        tag: p.RB0.H4,
        children: G.intl.format(G.t.ZpiGy8, {
          planPremiumType: S.ZP.getDisplayPremiumType(n.planId)
        })
      }), (0, r.jsx)(p.olH, {
        onClick: a
...
function K(e) {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)("div", {
      ...
      children: 0 !== l.total ? G.intl.format(G.t.ycyeBw, {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(k.Z, {
      ...
      children: [(0, r.jsx)(p.zxk, {
        ...
        children: G.intl.format(G.t["V3+Rpa"], {
...
function J(e) {
  ...
  let {
    ...
    return [i, c, l, o]
  }(g, i, c), [ee, et] = s.useState(null);
  (0, L.w)(i, a, !1);
  let en = e => {
      a(), C.default.track(V.rMx.CANCELLATION_FLOW_STEP, H({
        from_step: Q[e],
        to_step: null,
