...
function H(e) {
  ...
  switch (n.status) {
    ...
    default:
      switch (i) {
        case L.p9.TIER_0:
          v = d ? M.intl.format(M.t["l+A50N"], {
            date: n.currentPeriodEnd,
            helpdeskArticle: O.Z.getArticleURL(B.BhN.BLOCKED_PAYMENTS)
          }) : M.intl.format(M.t.Y6Wfa2, {
            date: n.currentPeriodEnd
          });
          break;
        case L.p9.TIER_1:
          v = d ? M.intl.format(M.t.QN7eIi, {
            date: n.currentPeriodEnd,
            helpdeskArticle: O.Z.getArticleURL(B.BhN.BLOCKED_PAYMENTS)
          }) : M.intl.format(M.t.X7i9Dw, {
            date: n.currentPeriodEnd
          });
          break;
        default:
          v = d ? M.intl.format(M.t.vuSNho, {
            date: n.currentPeriodEnd,
            helpdeskArticle: O.Z.getArticleURL(B.BhN.BLOCKED_PAYMENTS)
          }) : M.intl.format(M.t.fCdmNj, {
            date: n.currentPeriodEnd
          })
      }
  }
  let T = n.items.some(e => {
      ...
      children: o ? M.intl.string(M.t["cY+Ooa"]) : M.intl.formatToPlainString(M.t["V3+Rpa"], {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [o ? (0, r.jsx)(w.Z, {
      ...
      children: [(0, r.jsx)(g.vwX, {
        tag: g.RB0.H4,
        children: M.intl.format(M.t.ZpiGy8, {
          planPremiumType: S.ZP.getDisplayPremiumType(n.planId)
        })
      }), (0, r.jsx)(g.olH, {
        onClick: a
...
function z(e) {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)("div", {
      ...
      children: 0 !== l.total ? M.intl.format(M.t.ycyeBw, {
  ...
  return (0, r.jsxs)(r.Fragment, {
    children: [(0, r.jsx)(w.Z, {
      ...
      children: [(0, r.jsx)(g.zxk, {
        ...
        children: M.intl.format(M.t["V3+Rpa"], {
...
function q(e) {
  ...
  let {
    ...
    let [i, r] = s.useState(e), [l, a] = s.useState(Date.now()), [o] = s.useState(Date.now()), c = s.useCallback(e => {
      j.default.track(B.rMx.CANCELLATION_FLOW_STEP, V({
        from_step: K[i],
        to_step: K[e],
    ...
    return [i, c, l, o]
  }(p, i, c), [z, q] = s.useState(null);
  (0, k.w)(i, a, !1);
  let X = e => {
      a(), j.default.track(B.rMx.CANCELLATION_FLOW_STEP, V({
        from_step: K[e],
        to_step: null,
