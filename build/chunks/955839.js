...
let u = e => {
  let {
    ...
    selectedUsers: n,
    limit: i
  } = e, u = (0, a.e7)([c.Z], () => c.Z.getRecipientStatus()), d = (0, a.e7)([c.Z], () => c.Z.getReferralsRemaining()), [f, _] = r.useState(0), [p, h] = r.useState([]), [m, g] = r.useState(false), [E, b] = r.useState(false), [y, O] = r.useState(new Map);
