...
let C = e => {
  let {
    ...
    selectedUsers: r,
    limit: s
  } = e, C = (0, n.e7)([d.Z], () => d.Z.getRecipientStatus()), c = (0, n.e7)([d.Z], () => d.Z.getReferralsRemaining()), [u, p] = a.useState(0), [h, f] = a.useState([]), [x, g] = a.useState(!1), [m, _] = a.useState(!1), [j, y] = a.useState(new Map);
  i()(null != c, "Referrals remaining should not be null");
  let L = async (e, a) => {
    if (!x && !m && null != e && 0 !== c) try {
      g(!0);
      let s = [...j.values()];
      for (let [e, t] of C)
