...
function K(e, t, n) {
  ...
  let [a, s] = i;
  for (let n of ((0, _.ZP)(a), 0 !== t && (H += 1), G.add(e), f.Z.restored(e), o.Z.mark("❗", "loaded guild channels (guild: ".concat(e, ")"), s), a)) Object.hasOwn(P, n.id) || et((0, g._H)(n));
...
function ei(e) {
  let t = w;
  for (let n of (k = {}, P = {}, w = {}, x = {}, j = {}, F = {}, B = {}, V = Date.now(), L = e.initialPrivateChannels, e.initialPrivateChannels.forEach($), e.guilds)) "partial" === n.dataMode && (a().forEach(t[n.id], et), C.fileOnly("Restoring guild channels for ".concat(n.id, " #:").concat(eL(n.id)))), ea(n);
  eP()
}
...
function el(e) {
  for (let {
    ...
    of e.channels)
    for (let e of (C.fileOnly("Lazy loaded guild channels for ".concat(t)), (0, _.ZP)(n), G.add(t), f.Z.restored(t), n)) Object.hasOwn(P, e.id) || et((0, g._H)(e));
  return !1
}

function ec() {
  C.fileOnly("initializeClear()"), k = {}, P = {}, w = {}, j = {}, D = {}, F = {}, x = {}, G = new Set, B = {}, V = Date.now()
}
