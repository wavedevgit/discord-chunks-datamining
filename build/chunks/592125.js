  ...
  static loadGuildIds(e) {
    ...
    return (0, u.gs)("loadChannels", async () => {
      let e = t.map(e => {
          ...
          let t = d.Z.getAsync(n, e).then(t => (R.fileOnly("Lazy loaded channels for ".concat(e, " #:").concat(t.length)), {
            guildId: e,
            channels: t
          }));
          return V[e] = t, {
...
function eo(e) {
  if (null != e.channels)
    for (let t of (R.fileOnly("GuildCreate contained full channels for ".concat(e.id, " #:").concat(e.channels.length)), X(e.id), B.add(e.id), _.Z.restored(e.id), e.channels)) en(t);
...
function ec(e) {
  for (let {
    ...
    of e.channels)
    for (let e of (R.fileOnly("Lazy loaded guild channels for ".concat(t)), (0, f.ZP)(n), B.add(t), _.Z.restored(t), n)) Object.hasOwn(w, e.id) || en((0, E._H)(e));
  return !1
}
...
function ed(e) {
  ...
  for (let e of [n, r])
    for (let t of e) $((0, f.d7)((0, E._H)(t)));
...
function ef(e) {
  for (let [t, n] of(W = !0, e.guildChannels))
    for (let e of (R.fileOnly("Lazy cache contained full guild channels for ".concat(t, " #:").concat(n.length)), B.add(t), n)) $((0, E._H)(e))
}
...
function em(e) {
  ...
  if (null == r) return !1;
  $(r.set("permissionOverwrites", C(A({}, r.permissionOverwrites), {
    [n.id]: n
  })))
}
...
function eI(e) {
  ...
  let {
    channel: r
  } = e, i = null != (n = null != (t = w[r.id]) ? t : L[r.id]) ? n : M[r.id];
  if (null == i) return !1;
  ev(i), eO(i)
}
...
class eL extends(r = s.ZP.Store) {
  ...
  getSortedPrivateChannels() {
    return a()(L).values().sort((e, t) => y.default.compare(e.lastMessageId, t.lastMessageId)).reverse().value()
  }
  getDMFromUserId(e) {
  ...
  getAllThreadsForGuild(e) {
    return a().values(M).filter(t => t.guild_id === e)
  }
  ...
  getDebugInfo() {
    return {
      ...
      guildSizes: Object.keys(D).sort(y.default.compare).map(e => "".concat(e, ": ").concat(ex(e)))
    }
  }
}
