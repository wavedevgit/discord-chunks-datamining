  ...
  static loadGuildIds(e) {
    ...
    return (0, u.gs)("loadChannels", async () => {
      let e = t.map(e => {
          ...
          if (null != V[e]) return C.fileOnly("Skipping loading ".concat(e, " because a load is pending")), null;
      ...
      try {
        ...
        for (let n of (C.error("Failed to load channels from disk for " + e.map(e => e.guildId), t), e)) delete V[n.guildId];
        throw t
      }
      return null
    })
...
function z(e, t, n) {
  ...
  if (null == i) {
    B.add(e), _.Z.restored(e), C.log("load returned null; early returning (guild: ".concat(e, ", database: ").concat(r, ")"));
    return
  }
  let [a, s] = i;
  for (let n of ((0, f.ZP)(a), 0 !== t && (Y += 1), B.add(e), _.Z.restored(e), o.Z.mark("❗", "loaded guild channels (guild: ".concat(e, ")"), s), a)) Object.hasOwn(P, n.id) || en((0, g._H)(n));
...
function Q(e) {
  var t, n, r, i;
  return q(e, 0, "getBasicChannel"), null != (i = null != (r = null != (n = null != (t = P[e]) ? t : D[e]) ? n : x[e]) ? r : G[e]) ? i : _.Z.getBasicChannel(e)
}

function J(e) {
  var t, n, r, i;
  return q(e, 1, "getChannel"), null != (i = null != (r = null != (n = null != (t = P[e]) ? t : D[e]) ? n : x[e]) ? r : G[e]) ? i : Z[e]
}

function $(e) {
  e.isPrivate() ? (delete Z[e.id], ee(e)) : e.isThread() ? et(e) : g.oj.has(e.type) && er(e)
}
...
function eo(e) {
  ...
  switch (n.op) {
    case "full_sync":
      for (let e of (C.fileOnly("ConnectionOpen contained full channels for ".concat(t, " #:").concat(n.items.length)), X(t), B.add(t), _.Z.restored(t), n.items)) en(e);
      break;
    case "update":
      for (let e of ((n.writes.length > 0 || n.deletes.length > 0) && _.Z.invalidate(t), n.deletes)) ev(P[e]);
...
function el(e) {
  ...
  P = {}, w = {}, U = {}, M = {}, t.forEach(e => {
    ...
    } else C.fileOnly("BG sync contained full channels for ".concat(e.id, " #:").concat(e.channels.length)), X(e.id), B.add(e.id), _.Z.restored(e.id), e.channels.forEach(t => en((0, g.q_)(t, e.id)))
  })
}
...
function ec(e) {
  for (let {
    ...
    of e.channels)
    for (let e of (C.fileOnly("Lazy loaded guild channels for ".concat(t)), (0, f.ZP)(n), B.add(t), _.Z.restored(t), n)) Object.hasOwn(P, e.id) || en((0, g._H)(e));
  return !1
}
...
function eS(e) {
  C.fileOnly("GuildDelete of ".concat(e.guild.id)), X(e.guild.id), B.delete(e.guild.id), _.Z.invalidate(e.guild.id)
}
...
function eR(e) {
  ...
  for (let e of t)
    for (let t of e) eP(t.thread);
  n.forEach(eP), null == r || r.forEach(e => {
    let t = (0, g.q_)(e),
      n = null != J(e.id),
      r = null != Z[e.id];
...
class eL extends(r = s.ZP.Store) {
  initialize() {
    this.waitFor(_.Z, v.default, O.Z, m.Z), this.syncWith([m.Z], ew)
  }
  hasChannel(e) {
    return null != Q(e)
  }
  ...
  getChannelIds(e) {
    var t, n;
    return (z(e, 0, "getChannelIds"), null == e) ? b.default.keys(D) : b.default.keys(null != (n = null != (t = _.Z.getGuildBasicChannels(e)) ? t : w[e]) ? n : R)
  }
  ...
  getMutableBasicGuildChannelsForGuild(e) {
    var t, n;
    return z(e, 0, "getMutableBasicGuildChannelsForGuild"), null != (n = null != (t = _.Z.getGuildBasicChannels(e)) ? t : w[e]) ? n : R
  }
  ...
  getDebugInfo() {
    return {
      ...
      pendingGuildLoads: Object.keys(V).sort(b.default.compare),
