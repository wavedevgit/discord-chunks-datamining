...
function X(e) {
  var t, n, r, i;
  return z(e, 1, "getChannel"), null != (i = null != (r = null != (n = null != (t = R[e]) ? t : D[e]) ? n : x[e]) ? r : U[e]) ? i : F[e]
}
...
function ei(e) {
  let t = w;
  for (let n of (M = {}, R = {}, w = {}, x = {}, j = {}, F = {}, B = {}, V = Date.now(), L = e.initialPrivateChannels, e.initialPrivateChannels.forEach($), e.guilds)) "partial" === n.dataMode && (a().forEach(t[n.id], et), C.fileOnly("Restoring guild channels for ".concat(n.id, " #:").concat(eL(n.id)))), ea(n);
  eR()
}
...
function ea(e) {
  ...
  if (null != e.channelUpdates) {
    ...
    for (let n of ((t.writes.length > 0 || t.deletes.length > 0) && f.Z.invalidate(e.id), t.deletes)) ev(R[n]);
...
function es(e) {
  ...
  R = {}, w = {}, j = {}, t.forEach(e => {
    if ("unavailable" === e.data_mode) C.fileOnly("Restoring guild channels b/c unavailable in bg sync, for ".concat(e.id, " #:").concat(eL(e.id))), a().forEach(n[e.id], et);
      ...
      i.length > 0 && (K(e.id, 1, "handleBackgroundSync"), i.forEach(e => ev(R[e]))), null == (t = e.partial_updates.channels) || t.forEach(t => et((0, g.q_)(t, e.id)))
...
function ec() {
  C.fileOnly("initializeClear()"), M = {}, R = {}, w = {}, j = {}, D = {}, F = {}, x = {}, G = new Set, B = {}, V = Date.now()
}
...
class eD extends(r = s.ZP.Store) {
  initialize() {
    this.waitFor(f.Z, O.default, v.Z, m.Z), this.syncWith([m.Z], eR)
  }
  hasChannel(e) {
    return null != Q(e)
  }
