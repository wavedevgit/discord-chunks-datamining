...
function f(e) {
  ...
  return <div ref={y} className={d.calendarPicker}><l() calendarClassName={f} selected={m} onChange={h} autoFocus={_} fixedHeight={true} inline={true} locale={b} maxDate={g} minDate={E} onKeyDown={O} onClickOutside={p} /></div>
}
let _ = f