/** Chunk was on web.js **/
/** chunk id: 755712, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  BU: () => tz,
  CX: () => tR,
...
var y = new WeakMap,
  ...
  eo = parseInt(Chunk647438.version.split(".")[0], 10) >= 17,
  ...
  eC = eE ? Chunk647438.useLayoutEffect : Chunk647438.useEffect,
  eN = e => {
    var {
      isLast: t,
      leaf: n,
      parent: r,
      text: i
    } = e, o = ex(), a = ey.findPath(o, i), s = d.y$.parent(a), l = true === n[F];
  ...
  eP = (0, Chunk647438.memo)((0, Chunk647438.forwardRef)((e, t) => c.createElement("span", {
  ...
  eD = (0, Chunk647438.createContext)(null),
  ex = () => {
    var e = (0, Chunk647438.useContext)(eD);
  ...
  ej = Chunk647438.memo(eL, (e, t) => t.parent === e.parent && t.isLast === e.isLast && t.renderLeaf === e.renderLeaf && t.renderPlaceholder === e.renderPlaceholder && t.text === e.text && d.xv.equals(t.leaf, e.leaf) && t.leaf[Z] === e.leaf[Z]),
  ek = e => {
    var {
      attributes: t,
      children: n
  ...
  eM = e => {
    for (var {
        ...
        renderLeaf: o,
        text: a
      } = e, s = ex(), l = (0, c.useRef)(null), u = d.xv.decorations(a, t), f = ey.findKey(s, a), _ = [], p = 0; p < u.length; p++) {
      var h = u[p];
      _.push(c.createElement(ej, {
  ...
  eU = Chunk647438.memo(eM, (e, t) => t.parent === e.parent && t.isLast === e.isLast && t.renderLeaf === e.renderLeaf && t.renderPlaceholder === e.renderPlaceholder && t.text === e.text && eA(t.decorations, e.decorations)),
  eG = e => {
    var {
      decorations: t,
      element: n,
  ...
  eK = (0, Chunk647438.createContext)(false),
  ez = () => (0, Chunk647438.useContext)(eK),
  eq = (0, Chunk647438.createContext)(null),
  eX = () => {
    var e = (0, Chunk647438.useContext)(eq);
...
class e8 extends Chunk647438.Component {
  constructor() {
...
function th(e) {
  var {
    ...
    k.set(t, t.marks), t_("flush", U.get(t), M.get(t));
    for (var o = y(); l = null == (_ = M.get(t)) ? true : _[0];) {
      var l, _, p, h = j.get(t);
      true !== h && (j.delete(t), t.marks = h), h && false === c && (c = null);
      var m = tr(l);
      t.selection && d.e6.equals(t.selection, m) || d.YR.select(t, m), l.diff.text ? d.ML.insertText(t, l.diff.text) : d.ML.deleteFragment(t), M.set(t, null == (p = M.get(t)) ? true : p.filter(e => {
        var {
          id: t
        } = e;
        return t !== l.id
      })), e5(t, l) || (o = false, U.delete(t), k.delete(t), i = "action", G.delete(t), n.cancel(), r.cancel(), null == e || e.unref())
    }
...
function tm() {
  var e = (0, Chunk647438.useRef)(false);
  return (0, Chunk647438.useEffect)(() => (module.current = true, () => {
...
function tI() {
  var e = ex(),
    ...
    n = (0, Chunk647438.useRef)(0),
    r = (0, Chunk647438.useCallback)(() => {
      if (!exports.current) {
  ...
  return (0, Chunk647438.useEffect)(() => () => cancelAnimationFrame(require.current), []), {
...
var tN = e => c.createElement(c.Fragment, null, eW(e)),
  tR = e => {
    ...
    eC(() => {
      M.current && (e = H(M.current)) ? (v.set(N, e), I.set(N, M.current), A.set(N, M.current), S.set(M.current, N)) : A.delete(N);
      var e, {
          selection: t
        } = N,
    ...
    var $ = (0, c.useCallback)(e => {
        if (G(), !_ && ey.hasEditableTarget(N, e.target) && !tL(e, u)) {
          ...
          if (!(i && ey.isComposing(N))) {
            ...
            if ("insertText" === n && t && d.e6.isCollapsed(t) && e.data && 1 === e.data.length && /[a-z ]/i.test(e.data) && 0 !== t.anchor.offset) {
              ...
              var {
                anchor: a
              } = t, [s, l] = ey.toDOMPoint(N, a), c = null == (h = s.parentElement) ? true : h.closest("a"), f = ey.getWindow(N);
      ...
      ee = (0, c.useCallback)(e => {
        null == e ? (q.cancel(), Q.cancel(), I.delete(N), A.delete(N), M.current && eb && M.current.removeEventListener("beforeinput", $)) : eb && e.addEventListener("beforeinput", $), M.current = e
      }, [M, $, q, Q]);
    eC(() => {
    ...
    if (z.hasMarkPlaceholder = false, N.selection && d.e6.isCollapsed(N.selection) && er) {
      var {
        anchor: ei
      } = N.selection, eo = d.NB.leaf(N, ei.path), es = g(eo, tS);
    ...
    return c.createElement(eK.Provider, {
      ...
      onCompositionEnd: (0, c.useCallback)(e => {
        if (ey.hasSelectableTarget(N, e.target) && (ey.isComposing(N) && (L(false), w.set(N, false)), null == J || J.handleCompositionEnd(e), !tx(e, C.onCompositionEnd) && !el && !eu && !eh && !ea && !eg && !em) && e.data) {
          var t = j.get(N);
          j.delete(N), true !== t && (k.set(N, N.marks), N.marks = t), d.ML.insertText(N, e.data);
          var n = k.get(N);
  ...
  tj = (0, Chunk647438.createContext)(false),
  tk = () => (0, Chunk647438.useContext)(tj);

function tM(e) {
  return e instanceof Error
}
var tU = (0, Chunk647438.createContext)({}),
  tG = (e, t) => e === t;
...
var tz = function(e) {
    ...
    return N.set(n, new WeakMap), n.addMark = (e, t) => {
      var r, i;
      null == (r = L.get(n)) || r(), !j.get(n) && null != (i = M.get(n)) && i.length && j.set(n, null), k.delete(n), a(e, t)
    }, n.removeMark = e => {
      var t;
      !j.get(n) && null != (t = M.get(n)) && t.length && j.set(n, null), k.delete(n), s(e)
    }, n.deleteBackward = e => {
