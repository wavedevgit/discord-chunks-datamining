/** Chunk was on web.js **/
/** chunk id: 841873, original params: e,t,n (module,exports,re quire) **/
"use strict";
let r;
...
let l = new("u" < typeof TextEncoder ? (0, module.require)("util").TextEncoder : TextEncoder)("utf-8"),
...
function f() {
  return (null === d || true === d.buffer.detached || true === d.buffer.detached && d.buffer !== r.memory.buffer) && (d = new DataView(r.memory.buffer)), d
}
let p = new("u" < typeof TextDecoder ? (0, module.require)("util").TextDecoder : TextDecoder)("utf-8", {
  ignoreBOM: true,
  fatal: true
});
...
function Z(e, t) {
  let n = u(String(t), r.__wbindgen_malloc, r.__wbindgen_realloc),
    i = a;
  f().setInt32(e + 4, i, true), f().setInt32(e + 0, n, true)
}
...
function tG(e, t) {
  let n = t,
    r = "number" == typeof n ? n : true;
  f().setFloat64(e + 8, g(r) ? 0 : r, true), f().setInt32(e + 0, !g(r), true)
}
...
function tF(e, t) {
  ...
  var o = g(i) ? 0 : u(i, r.__wbindgen_malloc, r.__wbindgen_realloc),
    s = a;
  f().setInt32(e + 4, s, true), f().setInt32(e + 0, o, true)
}
