...
let x = [{
  ...
  N = [{
    ...
    duration: 3 * u.Z.Millis.DAY,
    label: () => h.NW.formatToPlainString(h.t.GBLpQ0, {
      days: 3
    })
  }, {
    duration: void 0,
...
function _(e) {
  ...
  }), h = o && t !== p.Skl.ONLINE, [b, _] = i.useState(null), E = null != b && t === n, j = (0, r.jsx)(r.Fragment, {
    children: x.map(e => {
      let {
        duration: i,
        label: s
...
function E(e) {
  ...
  let i = b(t, r);
  return n ? h.NW.formatToPlainString(h.t.ZxxHIC, {
    timeString: h.NW.data.formatTime(t, {
      format: "short"
    })
  }) : h.NW.formatToPlainString(h.t["9OFjSU"], {
    dateString: i ? h.NW.data.formatRelativeTime(1, "day", {
      numeric: "auto"
    }) : h.NW.data.formatDate(t, {
      dateStyle: "short"
    }),
    timeString: h.NW.data.formatTime(t, {
      format: "short"
      ...
      children: [(0, r.jsx)(a.Clw, {}, "menu-separator-statuses"), (0, r.jsx)(a.sNh, {
        ...
        label: () => (0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(a.owu, {
            ...
            children: [h.NW.string(h.t.gJRnwM), (0, r.jsx)(a.IGR, {
            ...
            className: f.description,
            children: i && null != m && "0" !== m ? h.NW.formatToPlainString(h.t.BWD8fn, {
