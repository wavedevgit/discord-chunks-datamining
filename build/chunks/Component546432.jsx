...
let B = function(e) {
  ...
  let {
    ...
    height: b,
    type: y
  } = n, I = s(n, (0, _.v)(a)), [T, A] = i.useState(null != I), C = (0, d.JO)(I), R = c === v.hV.MOSAIC, D = !R && (null != E && E < x || null != b && b < L), k = M(y), j = (0, O.R_)(y), B = u && null != I && (0, d.yf)(E, b), [Z, F] = i.useState(false), V = () => {
    F(true)
  }, H = () => {
    F(false)
  }, Y = function() {
