...
let B = function(e) {
  var {
    ...
    footer: p,
    displayGridItem: h
  } = e, g = D(e, ["className", "item", "message", "getObscureReason", "useFullWidth", "mediaLayoutType", "isSingleMosaicItem", "footer", "displayGridItem"]);
  let {
    width: E,
    height: b,
    type: y
  } = n, I = s(n, (0, _.v)(a)), [T, A] = i.useState(null != I), C = (0, d.JO)(I), R = c === v.hV.MOSAIC, w = !R && (null != E && E < L || null != b && b < x), j = M(y), k = (0, O.R_)(y), B = u && null != I && (0, d.yf)(E, b), [Z, F] = i.useState(false), V = () => {
    F(true)
  }, H = () => {
    F(false)
  }, Y = function() {
