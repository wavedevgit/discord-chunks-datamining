...
let B = function(e) {
  ...
  let {
    ...
    height: b,
    type: y
  } = n, I = s(n, (0, p.v)(a)), [T, A] = i.useState(null != I), C = (0, f.JO)(I), R = c === v.hV.MOSAIC, w = !R && (null != E && E < L || null != b && b < x), k = M(y), j = (0, O.R_)(y), B = d && null != I && (0, f.yf)(E, b), [Z, F] = i.useState(false), V = () => {
    F(true)
  }, H = () => {
    F(false)
  }, Y = function() {
