  ...
  g = {
    ...
    searchReplace: {
      ...
      action(e, t) {
        ...
        let g = f.includes("g") ? o.content.replaceAll(c, u) : o.content.replace(c, u);
        return (null == g || "" === g.trim()) && 0 === o.attachments.length ? a.Z.deleteMessage(l.id, o.id) : g !== o.content && a.Z.editMessage(l.id, o.id, {
          content: g
        }), {
          content: ""
        }
