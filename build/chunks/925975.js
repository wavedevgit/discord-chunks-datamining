...
n.d(t, {
  g: () => g
}), n(781311), n(388685), n(35282), n(704826), n(804061);
var r = n(159635),
  i = n.n(r),
  a = n(969812),
  o = n(904245),
  ...
  h = {
    ...
    nick: {
      action(e, t) {
        ...
        if (null != n.guild_id) return a.Z.changeNickname(n.guild_id, n.id, _.ME, e), {
          content: ""
        }
      }
    },
    reaction: {
      ...
      action(e, t) {
        ...
        let a = l.ZP.getDisambiguatedEmojiContext(r.guild_id).getByName(e.trim().slice(2, -1));
        if (null != a) return (0, c.rU)(r.id, i.id, (0, u.g1)(a)), {
          content: ""
        }
      }
    },
    searchReplace: {
      ...
      action(e, t) {
        ...
        if (i) return;
        let s = f.Z.getLastEditableMessage(a.id);
        if (null == s || null == s.id) return {
          content: ""
        };
        let [l, c, u, d] = Array.from(null != (n = e.match(this.match.regex)) ? n : []), _ = null != (r = null == d ? void 0 : d.split("")) ? r : [];
        c = c.replace(p, (e, t) => t), u = u.replace(p, (e, t) => t);
        let h = _.includes("g") ? s.content.replaceAll(c, u) : s.content.replace(c, u);
        return (null == h || "" === h.trim()) && 0 === s.attachments.length ? o.Z.deleteMessage(a.id, s.id) : h !== s.content && o.Z.editMessage(a.id, s.id, {
          content: h
        }), {
          content: ""
        }
