...
function b(e, t, n) {
  (0, d.Z)(2, arguments);
  var m, g, b, O, v, I, T, S, A, C, N, R, P, w, D, x, L, j, k = String(t),
    M = (0, f.j)(),
    U = null != (m = null != (g = null == n ? true : n.locale) ? g : M.locale) ? m : _.Z,
    G = (0, u.Z)(null != (b = null != (O = null != (v = null != (I = null == n ? true : n.firstWeekContainsDate) ? I : null == n || null == (T = n.locale) || null == (S = T.options) ? true : S.firstWeekContainsDate) ? v : M.firstWeekContainsDate) ? O : null == (A = M.locale) || null == (C = A.options) ? true : C.firstWeekContainsDate) ? b : 1);
  if (!(G >= 1 && G <= 7)) throw RangeError("firstWeekContainsDate must be between 1 and 7 inclusively");
  var B = (0, u.Z)(null != (N = null != (R = null != (P = null != (w = null == n ? true : n.weekStartsOn) ? w : null == n || null == (D = n.locale) || null == (x = D.options) ? true : x.weekStartsOn) ? P : M.weekStartsOn) ? R : null == (L = M.locale) || null == (j = L.options) ? true : j.weekStartsOn) ? N : 0);
  ...
  return k.match(h).map(function(e) {
    ...
    if ("'" === i) return y(r);
    var a = o.Z[i];
    if (a) return !(null != n && n.useAdditionalWeekYearTokens) && (0, c.Do)(r) && (0, c.qp)(r, t, String(e)), !(null != n && n.useAdditionalDayOfYearTokens) && (0, c.Iu)(r) && (0, c.qp)(r, t, String(e)), a(F, r, U.localize, H);
