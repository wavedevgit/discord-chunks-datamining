...
function b(e, t, n) {
  (0, d.Z)(2, arguments);
  var m, g, b, O, v, I, T, S, A, C, N, R, P, w, D, L, x, M, j = String(t),
    k = (0, f.j)(),
  ...
  var B = (0, u.Z)(null != (N = null != (R = null != (P = null != (w = null == n ? true : n.weekStartsOn) ? w : null == n || null == (D = n.locale) || null == (L = D.options) ? true : L.weekStartsOn) ? P : k.weekStartsOn) ? R : null == (x = k.locale) || null == (M = x.options) ? true : M.weekStartsOn) ? N : 0);
