...
function p(e) {
  ...
  return <d.ZP startDateLabel={g} endDateLabel={x} afterDate={p} beforeDate={f} selectedOption={h} isCustomDateRange={j} menuName={"joined-date"} accessibilityLabel={C.intl.string(C.t.XMVinZ)} onClose={n} onSelectDateOption={function(e, n) {
