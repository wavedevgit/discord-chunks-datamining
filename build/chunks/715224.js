...
function f(e) {
  ...
  }, [n.systemChannelFlags]), j = i.useCallback(e => b(d.xmn.SUPPRESS_JOIN_NOTIFICATIONS, !e), [b]), _ = i.useCallback(e => b(d.xmn.SUPPRESS_PREMIUM_SUBSCRIPTIONS, !e), [b]), v = i.useCallback(e => b(d.xmn.SUPPRESS_GUILD_REMINDER_NOTIFICATIONS, !e), [b]), O = i.useCallback(e => b(d.xmn.SUPPRESS_JOIN_NOTIFICATION_REPLIES, !e), [b]), C = i.useCallback(e => b(d.xmn.SUPPRESS_ROLE_SUBSCRIPTION_PURCHASE_NOTIFICATIONS, !e), [b]), y = i.useCallback(e => b(d.xmn.SUPPRESS_CHANNEL_PROMPT_DEADCHAT, !e), [b]), N = i.useCallback(e => b(d.xmn.SUPPRESS_ROLE_SUBSCRIPTION_PURCHASE_NOTIFICATION_REPLIES, !e), [b]), I = null != (t = n.systemChannelId) ? t : p, E = (0, o.eI)(n), S = E || (0, c.yE)(n.systemChannelFlags, d.xmn.SUPPRESS_ROLE_SUBSCRIPTION_PURCHASE_NOTIFICATIONS), T = E || (0, c.yE)(n.systemChannelFlags, d.xmn.SUPPRESS_ROLE_SUBSCRIPTION_PURCHASE_NOTIFICATION_REPLIES);
