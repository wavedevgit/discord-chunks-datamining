...
let I = {
  ...
  O = e => {
    let {
      ...
      let t = async () => {
        await (0, g.yL)(i, e)
      }, s = async t => await (0, g.RV)(i, e, t), a = e => {
  ...
  S = () => {
    let [e, t] = i.useState(!0), [n, l] = i.useState([]), h = (0, s.e7)([f.default], () => f.default.isAuthenticated()), p = (0, s.e7)([d.Z], () => d.Z.hasLoadedExperiments), v = () => {
      (0, g.Jj)().then(e => {
        let {
          body: {
            capabilities: n
    ...
    return i.useEffect(() => {
      ...
      children: [(0, r.jsx)(u.Dx, {
        ...
        children: n.map(e => null == I[e] ? null : (0, r.jsx)(O, {
