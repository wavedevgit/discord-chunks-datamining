...
let I = {
  ...
  S = () => {
    let [e, t] = i.useState(!0), [n, l] = i.useState([]), h = (0, s.e7)([m.default], () => m.default.isAuthenticated()), g = (0, s.e7)([d.Z], () => d.Z.hasLoadedExperiments), v = () => {
      (0, p.Jj)().then(e => {
        let {
          body: {
            capabilities: n
    ...
    return i.useEffect(() => {
      ...
      children: [(0, r.jsx)(u.Dx, {
        ...
        children: n.map(e => null == I[e] ? null : (0, r.jsx)(j, {
