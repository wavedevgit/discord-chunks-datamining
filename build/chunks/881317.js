...
let O = {
  ...
  N = () => {
    let [e, t] = i.useState(!0), [n, l] = i.useState([]), h = (0, a.e7)([m.default], () => m.default.isAuthenticated()), p = (0, a.e7)([d.Z], () => d.Z.hasLoadedExperiments), v = () => {
      (0, g.Jj)().then(e => {
        let {
          body: {
            capabilities: n
    ...
    return i.useEffect(() => {
      ...
      children: [(0, r.jsx)(u.Dx, {
        ...
        className: b.marginBottom8,
        children: E.intl.format(E.t["532l+v"], {
