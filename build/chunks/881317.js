...
let O = {
  ...
  N = e => {
    let {
      ...
      let t = async () => {
        await (0, f.yL)(i, e)
      }, s = async t => await (0, f.RV)(i, e, t), c = e => {
  ...
  S = () => {
    let [e, t] = i.useState(!0), [n, l] = i.useState([]), o = (0, s.e7)([g.default], () => g.default.isAuthenticated()), p = (0, s.e7)([h.Z], () => h.Z.hasLoadedExperiments), m = () => {
      (0, f.Jj)().then(e => {
        let {
          body: {
            capabilities: n
    ...
    return i.useEffect(() => {
    ...
    }) : null != n && n.length > 0 && (0, r.jsxs)(d.ZP, {
      children: [(0, r.jsx)(d.Dx, {
        ...
        children: n.map(e => null == O[e] ? null : (0, r.jsx)(N, {
