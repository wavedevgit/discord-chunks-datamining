...
let j = {
  ...
  I = e => {
    let {
      ...
      let t = async () => {
        await (0, g.yL)(i, e)
      }, l = async t => await (0, g.RV)(i, e, t), a = e => {
  ...
  O = () => {
    let [e, t] = i.useState(!0), [n, s] = i.useState([]), h = (0, l.e7)([f.default], () => f.default.isAuthenticated()), p = (0, l.e7)([d.Z], () => d.Z.hasLoadedExperiments), E = () => {
      (0, g.Jj)().then(e => {
        let {
          body: {
            capabilities: n
    ...
    return i.useEffect(() => {
      ...
      children: [(0, r.jsx)(u.Dx, {
        ...
        className: b.marginBottom8,
        children: N.NW.format(N.t["532l+v"], {
          supportURL: m.Z.getArticleURL(_.BhN.COPYRIGHT_AND_IP_POLICY)
        })
      }), (0, r.jsx)("div", {
        className: x.container,
        children: n.map(e => null == j[e] ? null : (0, r.jsx)(I, {
