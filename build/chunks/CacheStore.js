...
function G() {
  return M = true, U = true, false
}

function B() {
  return M = false, U = true, false
}
...
function H(e) {
  w.log("Clearing cache store"), j = Date.now(), a.K.remove(R.FsG), a.K.remove(R.ihW), a.K.remove(R.O42), L = "no-cache", "CLEAR_CACHES" === e.type && e.preventWritingCachesAgainThisSession && (x = true)
}

function Y() {
  w.verbose("Writing cache now"), j = Date.now(), k = true, Chunk433517.K.remove(Chunk981631.FsG), Chunk433517.K.remove(Chunk981631.O42), Chunk433517.K.remove(Chunk981631.ihW)
}

function W(e) {
  null != e.channels && (0, C.ZP)(e.channels), null != e.privateChannels && (0, C.ZP)(e.privateChannels), null != e.guildChannels && (0, C._$)(e.guildChannels)
}
...
async function z(e, t, n) {
  ...
  let u = null != (r = T.Z.getGuildId()) ? r : null,
    d = null != (a = I.Z.getChannelId()) ? a : null,
    f = performance.now(),
...
async function Q(e, t) {
  ...
  let o = null != (r = (await _.Z.getCommittedVersions()).initial_guild_id) ? r : t.guildId;
...
async function ee(e, t, n, r) {
  ...
  et(() => {
    ...
    if (null == a || null == f || null == _) {
      (0, N.Z)("database:load_failed"), w.log("couldn't load database item (\n          database: ".concat(null != e, "\n          basic_channels: ").concat(null != f, "\n          guild_channels: ").concat(null != _, "\n          guilds: ").concat(null != a, "\n        )")), s.Z.dispatch({
        type: "CLEAR_CACHES",
    ...
    if (null == o && (a.length > 0 || f.all.length > 0)) {
      (0, N.Z)("database:versionless"), w.log("kv_cache was not ok (null version with values)"), s.Z.dispatch({
        type: "CLEAR_CACHES",
    ...
    if (M) {
      (0, N.Z)("already_connected"), w.log("Skipping lazy cache; already connected."), s.Z.dispatch({
        type: "CACHE_LOADED_LAZY_NO_CACHE"
      });
      return
    }
    ...
    O.Z.deserializeCache.measure(() => W(l)), O.Z.dispatchLazyCache.measure(() => s.Z.dispatch(l)), w.verbose("late lazy cache loaded (ok: true, took: ".concat(performance.now() - i, "ms)")), p.addAnalytics({
...
function et(e) {
  ...
  o.ZP.Emitter.batched(() => {
    try {
      ...
      n = true, O.Z.loadLazyCache.recordEnd(), w.verbose("Processing First Queued Dispatch"), t.dispatcher.processFirstQueuedDispatch(new Set(["READY", "INITIAL_GUILD"])), setTimeout(() => {
        w.verbose("Unpausing Dispatch Queue"), t.dispatcher.unpauseDispatchQueue()
      }, 100)
    } catch (e) {
...
class en extends(r = Chunk442837.ZP.Store) {
  ...
  async loadCacheAsync(e, t) {
    let n = (0, A.h)(t);
    if ("initializing" !== L) {
      (0, N.Z)("cache:lazy_cache_not_initializing"), n(), setTimeout(() => {
        var e, t;
    ...
    try {
      let t = v.default.getId(),
        ...
        [i, o, a] = await O.Z.loadMiniCache.measureAsync(() => z(r, t, e));
      i ? (n(), await ee(r, t, o, a)) : (n(), await q())
    } catch (e) {
      w.error("clearing cache. exception encountered while loading cache.", e, e.stack), (0, N.Z)("cache:exception"), n(), s.Z.dispatch({
        type: "RESET_SOCKET",
        args: {
          error: e,
...
P(en, "displayName", "CacheStore"), new en(Chunk570140.Z, D ? {
  CONNECTION_OPEN: G,
  LOGOUT: H,
  CONNECTION_CLOSED: B,
  CACHE_LOADED: Z,
