...
function z(e) {
  L.log("Clearing cache store"), G = Date.now(), o.K.remove(D.FsG), o.K.remove(D.ihW), o.K.remove(D.O42), U = "no-cache", "CLEAR_CACHES" === e.type && e.preventWritingCachesAgainThisSession && (k = true)
}
