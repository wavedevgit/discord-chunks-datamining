...
function j(e) {
  let {
    ...
    windowId: f
  } = i.useContext(d.ZP), [h] = i.useState(() => new E({
    messages: t,
    channel: n,
    compact: r,
    hasUnreads: l,
