...
function X(e) {
  ...
  let d = (0, i.A)();
  if (!u && (null == (t = n.userStatus) ? true : t.enrolledAt) == null && !(0, I.Ic)(n)) {
...
function er(e) {
  if ((0, T.vA)(e)) return e.config.features.includes(R.Li.CLOUD_GAMING_ACTIVITY) ? o.hpF : o._xR
}