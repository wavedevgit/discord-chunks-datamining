...
function Z(e) {
  ...
  } = (0, b.KZ)(), y = (0, c.e7)([p.Z], () => p.Z.getGuild(i)), O = (0, c.e7)([u.ZP], () => u.ZP.getMember(i, t.id)), _ = null == O ? true : O.roles, Z = (0, c.Wu)([f.Z], () => f.Z.getManyRoles(i, null != _ ? _ : []).sort(j.Z), [_, i]), [N] = (0, c.Wu)([m.Z], () => [m.Z.can(h.Plq.MANAGE_ROLES, y), m.Z.getGuildVersion(i)]), S = l.useCallback(e => {
    var n, r;
    a({
      action: "REMOVE_ROLE"
    });
