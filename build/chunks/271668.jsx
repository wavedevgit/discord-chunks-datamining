...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk342687 = require("./342687.js"),
  Chunk826298 = require("./826298.js"),
  Chunk689079 = require("./689079.js"),
  Chunk981631 = require("./981631.js"),
  Chunk388032 = require("./388032.js"),
  Chunk702854 = require("./702854.js"),
...
let D = 512,
  ...
  Z = Chunk73800.forwardRef(function(e, t) {
    ...
    let ec = i.useCallback(e => {
        ...
        let i = (0, A.ky)(t),
          o = <i channel={n} section={t} width={16} height={16} padding={0} />;
        return <E.Z className={P.categoryHeader} icon={o}>{t.name}</E.Z>
      }, [n, q]),
      eu = i.useCallback((e, t) => {
        ...
        return <ul role={"group"} aria-label={i.name} className={a()(P.categorySection, {
            [P.categorySectionLast]: n
          })}>{t}{0 === o.length && <c.Z message={R.intl.format(R.t.WoQXT0, {
              applicationName: i.name
            })} noResultsImageURL={w} className={P.noSearchResults} />}</ul>
      }, [q, X]),
      ed = i.useCallback((e, t) => {
        ...
        if (null == a || o.section.id !== a.applicationId && o.section.id !== N.bi.FRECENCY || a.inputType === v.iw.PLACEHOLDER) return <S.Z />;
        let l = z.find(e => e.id === a.applicationId);
        return <f.ZP.NewCommand index={e} command={a} channel={n} className={P.itemWrapper} selected={Z === e} showImage={o.section.id !== a.applicationId} section={l} onClick={() => el(a, l, (0, I.tI)(o.section))} onHover={() => {
            V(null), W(false)
          }} />
      }, [n, X, el, z, Z]),
      ef = (0, h.Dt)();
    return (0, _.KR)(ef, true, (0, f.DJ)(Z)), i.useEffect(() => () => {
      (0, _.sJ)()
    }, []), <f.ZP id={ef} className={P.outerWrapper} innerClassName={P.wrapper} onMouseDown={F}>{<T.Z className={P.rail} channel={n} sections={z} filteredSectionId={$} activeCategoryIndex={K} onSectionClick={es} applicationCommandListRef={H} />}{<p.Z role={"listbox"} className={P.list} listPadding={G} onScroll={er} renderRow={ed} renderSection={eu} renderSectionHeader={ec} rowCount={q.length} rowCountBySection={ea} rowHeight={x} sectionHeaderHeight={k} sectionMarginBottom={eo} ref={H} stickyHeaders={true} />}</f.ZP>
  });
