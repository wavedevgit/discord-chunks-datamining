...
class C extends Chunk73800.PureComponent {
  ...
  renderCaption() {
    ...
    return <Chunk481060.R94 className={Chunk283806.micTestCaption} type={Chunk481060.R94.Types.DESCRIPTION}>{require ? Chunk73800 ? module : exports : null}</Chunk481060.R94>
  }
  render() {
    let {
      isVoiceConnected: e,
    ...
    return <div className={Chunk283806.container}>{<Chunk481060.vwX tag={Chunk481060.RB0.H5} className={Chunk283806.title}>{exports}</Chunk481060.vwX>}{null != require && <Chunk481060.R94 type={Chunk481060.R94.Types.DESCRIPTION} className={Chunk283806.description}>{require}</Chunk481060.R94>}{<div className={Chunk283806.micTest}>{<div className={Chunk283806.buttonSizer} aria-hidden={true}>{<Chunk755721.zx buttonRef={Chunk393238} grow={true} size={Chunk755721.zx.Sizes.SMALL} className={Chunk442837} color={Chunk46973}>{Chunk981631}</Chunk755721.zx>}{<div className={Chunk283806.buttonSizerSpacer} />}</div>}{<Chunk481060.ua7 text={Chunk626135}>{e => {
            let {
              onMouseEnter: t,
              onMouseLeave: n
            } = e;
          ...
          }}</Chunk481060.ua7>}{<Chunk794347.Z progress={Chunk131951 ? Chunk19780 + 100 : 0} notchBackground={Chunk73800}>{this.renderCaption()}</Chunk794347.Z>}</div>}</div>
  }
  constructor(...e) {
