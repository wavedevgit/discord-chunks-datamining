...
function I(e) {
  ...
  }, w = () => null == I ? g.intl.string(g.t.eg5qtb) : C || S ? N ? A ? true : g.intl.string(g.t.U4URzM) : g.intl.string(g.t.wSS1yM) : g.intl.string(g.t.aRifJS), D = i.useCallback(e => <a.xmR{...v(y({}, e), {
    color: "currentColor"
  })} />, []);
  return <d.Z className={E.actionBarButton} onClick={P} disabled={R} iconComponent={D} label={w()} grow={false} />
}