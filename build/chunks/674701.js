...
function x(e) {
  ...
  let V = () => t === N.hX.FRIEND_ANNIVERSARY ? P.intl.formatToPlainString(P.t.BWJvAA, {
      friendUserName: v.ZP.getName(a)
    }) : (0, I.Ou)(t),
    H = () => t === N.hX.FRIEND_ANNIVERSARY ? P.intl.formatToPlainString(P.t.S3fdq6, {
      numberOfYears: F
    }) : (0, I.Ou)(t),
    Y = () => {
      switch (G) {
    ...
    W = () => t === N.hX.FRIEND_ANNIVERSARY ? P.intl.formatToPlainString(P.t["L2s/Nz"], {
      numberOfYears: F
    }) : (0, I.Ou)(t),
    K = e => {
      e.stopPropagation();
    ...
    z = e => {
      e.stopPropagation(), O.default.track(C.rMx.GIFT_INTENT_CARD_SECONDARY_CTA_CLICKED, {
        ...
        explicit: !0
      }) : G === N.X2.SEND_MESSAGE && ((0, T.PV)(a.id), f.Z.openPrivateChannel({
        recipientIds: a.id
      }).then(() => {
        setTimeout(() => {
