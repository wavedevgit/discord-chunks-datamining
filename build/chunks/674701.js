...
function D(e) {
  let {
    ...
    analyticsSection: k,
    glow: U,
    giftIntentSecondaryAction: F
  } = e, B = (0, c.e7)([C.default], () => C.default.getCurrentUser()), {
    analyticsLocations: G
  } = (0, g.ZP)(), H = (0, c.e7)([S.Z], () => S.Z.getFriendAnniversaryYears(r.id));
  l.useEffect(() => {
    (0, h.h)({
  ...
  let V = () => t === N.hX.FRIEND_ANNIVERSARY ? Z.intl.formatToPlainString(Z.t["L2s/Nz"], {
      numberOfYears: H
    }) : (0, j.Ou)(t),
    z = "coachmark" === n,
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: [(0, i.jsxs)("div", {
          ...
          children: [(0, i.jsx)(p.Text, {
            ...
            lineClamp: 3,
            children: t === N.hX.FRIEND_ANNIVERSARY ? Z.intl.formatToPlainString(Z.t.BWJvAA, {
              friendUserName: O.ZP.getName(r)
            }) : (0, j.Ou)(t)
          }), (0, i.jsx)(p.Text, {
            className: X,
            variant: "text-sm/normal",
            children: t === N.hX.FRIEND_ANNIVERSARY ? Z.intl.formatToPlainString(Z.t.S3fdq6, {
              numberOfYears: H
            }) : (0, j.Ou)(t)
          })]
        })]
        ...
        children: [null != F && (0, i.jsx)(d.zx, {
          className: o()(R.button, $),
          onClick: e => {
            e.stopPropagation(), v.default.track(P.rMx.GIFT_INTENT_CARD_SECONDARY_CTA_CLICKED, {
              gift_intent_type: t,
              cta_type: F
            }), F === N.X2.VIEW_ALL ? ((0, x.uL)(P.Z5c.FRIENDS), f.Z.setSection(P.pJs.ALL)) : F === N.X2.SEND_MESSAGE && ((0, I.PV)(r.id), m.Z.openPrivateChannel({
              recipientIds: r.id
            }).then(() => {
              setTimeout(() => {
                (0, E.PG)(w.X1.GIF, b.Ie.NORMAL), setTimeout(() => {
