...
e = n.nmd(e), (function() {
  ...
  function I(e) {
    ...
    }), (t = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(D)) && !/\bi686\b/i.test(D) ? (F && (F.architecture = 64, F.family = F.family.replace(RegExp(" *" + t), "")), U && (/\bWOW64\b/i.test(e) || k && /\w(?:86|32)$/.test(a.cpuClass || a.platform) && !/\bWin64; x64\b/i.test(e)) && L.unshift("32-bit")) : F && /^OS X/.test(F.family) && "Chrome" == U && parseFloat(M) >= 39 && (F.architecture = 64), e || (e = null);
    var q = {};
    return q.description = e, q.layout = j && j[0], q.manufacturer = B, q.name = U, q.prerelease = x, q.product = G, q.ua = e, q.version = U && M, q.os = F || {
      architecture: null,
      family: null,
      version: null,
      toString: function() {
    ...
    }, q.parse = I, q.toString = z, q.version && L.unshift(M), q.name && L.unshift(U), F && U && !(F == String(F).split(" ")[0] && (F == U.split(" ")[0] || G)) && L.push(G ? "(" + F + ")" : "on " + F), L.length && (q.description = L.join(" ")), q
  }
  var S = I();
