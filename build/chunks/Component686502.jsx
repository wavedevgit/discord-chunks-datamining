...
function I(e) {
  ...
  l.useEffect(() => {
    O.default.track(_.HAw.VC_TILE_ACTIVITIES_ENTRY_POINT_VIEWED, {
    ...
    (0, u.mMO)(async () => {
      ...
      return n => {
        ...
        return (0, r.jsx)(e, (l = function(e) {
          ...
          guild: i,
          channel: t,
          source: _.PE1.ACTIVITY_ENTRY_POINT_TILE
  ...
  return (0, r.jsx)(f.f5, {
    ...
    children: (0, r.jsxs)(j.A, {
      ...
      children: [o > 300 ? (0, r.jsx)(u.Text, {
        ...
        className: v.HI,
        onClick: function() {
          O.default.track(_.HAw.VC_TILE_ACTIVITIES_ENTRY_POINT_CLOSED, {
            tile_type: "activity suggestion",
