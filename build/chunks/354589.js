...
let W = (0, a.Z)((0, l.Z)(function(e) {
  ...
  let {
  ...
  }), V = K ? null == H ? void 0 : H.id : l.id, $ = (0, D.Z)(r, V), ee = (0, S.Z)(r.id, a), en = (0, C.Z)({
    user: r,
    context: a
  }), er = (0, I.Z)({
    user: r,
    ...
    guildId: void 0,
    onHeightUpdate: F
  }), eO = (0, k.Z)(r, l), eI = r.isNonUserBot(), ew = l.isManaged(), ey = null == (n = l.recipients) ? void 0 : n.includes(r.id);
