...
function K(e) {
  ...
  }), l = (0, s.e7)([d.Z], () => d.Z.useReducedMotion), o = i.useRef(null);
  if (i.useEffect(() => {
      var e, t, n, r;
...
let q = function() {
  let {
    ...
    location: G.dr.QUEST_HOME_DESKTOP
  }) ? R.Z : R.j, j = (0, D.z)(e => e.registerAssetLoad), z = i.useRef(d);
  i.useEffect(() => {
    z.current = d
  }), i.useEffect(() => {
    let {
  ...
  return (0, r.jsx)(k.k.Provider, {
    ...
    children: (0, r.jsx)("div", {
      ...
      children: W ? (0, r.jsx)(M.t.Provider, {
        value: J,
