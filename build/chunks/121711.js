...
function Y(e) {
  ...
  }), l = (0, s.e7)([u.Z], () => u.Z.useReducedMotion), o = i.useRef(null);
  if (i.useEffect(() => {
      var e, t, n, r;
...
let K = function() {
  let {
    ...
    onScroll: l,
    scrollPosition: s
  } = (0, m.M)(), u = x.Z.getState().getUtmCurrentContext(), g = (0, Z._)({
    location: U.dr.QUEST_HOME_DESKTOP
  }) ? w.Z : w.j, P = (0, R.z)(e => e.registerAssetLoad), F = i.useRef(u);
  i.useEffect(() => {
    F.current = u
  }), i.useEffect(() => {
    let {
  ...
  (0, f.Tt)({
    location: V.intl.string(V.t.JALI2N)
  });
  ...
  return (0, r.jsx)(D.k.Provider, {
    value: {
      onAssetLoadComplete: P
    },
    children: (0, r.jsx)("div", {
      className: H.container,
      children: z ? (0, r.jsx)(k.t.Provider, {
        value: X,
        children: (0, r.jsxs)(v.Z, {
          ...
          children: [(0, r.jsx)(I.a, {
            ...
            className: a()(H.bannerContainer, {
              [H.orbsContainer]: z
            }),
            children: [(0, r.jsx)("div", {
              className: a()(H.bannerGradient, {
                [H.orbsGradient]: z
              })
            }), (0, r.jsx)(Y, {
              onLoadComplete: P
            ...
            children: e === A.e5.CLAIMED ? (0, r.jsx)(g, {
              onSelectTab: t
            }) : (0, r.jsx)(L.Z, {})
          })]
        })
