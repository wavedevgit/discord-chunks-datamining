...
let H = function() {
  let {
    ...
    onScroll: l,
    scrollPosition: s
  } = (0, m.M)(), u = Z.Z.getState().getUtmCurrentContext(), g = (0, j._)({
    location: R.dr.QUEST_HOME_DESKTOP
  }) ? L.Z : L.j, P = i.useRef(u);
  i.useEffect(() => {
    P.current = u
  }), i.useEffect(() => {
    let {
  ...
  (0, f.Tt)({
    location: M.NW.string(M.t.JALI2N)
  });
  ...
  return (0, r.jsx)("div", {
    ...
    children: A ? (0, r.jsxs)(I.Z, {
      ...
      children: [(0, r.jsx)(y.a, {
        ...
        children: e === T.e5.CLAIMED ? (0, r.jsx)(g, {
          onSelectTab: t
        }) : (0, r.jsx)(x.Z, {})
      })]
    }) : (0, r.jsxs)(r.Fragment, {
