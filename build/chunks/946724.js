...
function H() {
  ...
  let e = u()(h.Z.getRoles(l.id)).values().sortBy(e => {
    let {
      position: t
    } = e;
    return t
...
function q() {
  ...
  l = O.Z.getProps().guild, A = !1, m = !1, o = void 0, P.clear(), Z.clear(), G = T.QZA.OPEN, b = [...v = null != l ? u()(h.Z.getRoles(l.id)).values().sortBy(e => {
    let {
      position: t
    } = e;
    return t
  }).reverse().value() : []], k(null == l ? void 0 : l.id, b), U = !1, e && (w.clear(), x.forEach((e, t) => {
    w.set(t, [...e])
  }))
}
...
let K = u().debounce(() => {
  let e = !1;
  m && ((m = H().length > 0) || (e = !0)), [...P].forEach(t => {
    var r;
    u().isEqual(B(t), (r = t, b.find(e => {
      let {
        id: t
      } = e;
      return t === r
    }))) && (P.delete(t), e = !0)
  }), 0 === P.size && (A = !1), U && u().isEqual(x, w) && (e = !0, U = !1), e && W.emitChange()
}, 500);
...
function X(e) {
  ...
  let r = [];
  null != l && (r = u()(h.Z.getRoles(l.id)).values().sortBy(e => {
    let {
      position: t
    } = e;
    return t
    ...
    null == r.find((t, r) => {
      ...
      if (n === e) return l = r, !0
    }) || null == t ? P.delete(e) : r[l] = t
  }), 0 === P.size && (A = !1);
  let n = new Map;
  P.forEach(e => {
    let t = Z.get(e);
    null != t && n.set(e, t)
  }), Z.clear(), k(t, r), n.forEach((e, t) => {
    Z.set(t, e)
  }), m = !1, v = [...r]
}
...
let W = new z(f.Z, __OVERLAY__ ? {} : {
    ...
    GUILD_SETTINGS_ROLES_UPDATE_PERMISSIONS: function(e) {
      ...
      return F(n, {
        permissions: o = l ? c.IH(o, r) : c.Od(o, r)
      })
    },
    ...
    GUILD_SETTINGS_ROLES_UPDATE_COLORS: function(e) {
      ...
      let o = (0, S.DX)(r),
        i = Z.get(t);
      return null != i && (i.styleColors[l] = r, i.currentStyle = l, Z.set(t, D({}, i)), F(n, {
