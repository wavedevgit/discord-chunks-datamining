...
function Z() {
  ...
  r = j.Z.getProps().guild, C = !1, O = !1, s = void 0, v.clear(), y = N.QZA.OPEN, E = [...I = null != r ? o()(h.Z.getRoles(r.id)).values().sortBy(e => {
    let {
      position: t
    } = e;
    return t
...
let A = o().debounce(() => {
  let e = !1;
  O && ((O = R().length > 0) || (e = !0)), [...v].forEach(t => {
    var n;
