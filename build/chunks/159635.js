  ...
  var e = /\r\n?/g,
    ...
    o = function(e, t) {
      ...
      var d = function(t, r) {
          var i = [];
          for (n = r = r || n; t;) {
            for (var l = null, c = null, u = null, f = false, p = 1e5, _ = [a.get(t.charCodeAt(0)), s], m = 0; m < _.length; m++) {
              var h = _[m];
              if (null != h)
                for (var g = 0; g < h.length; g++) {
                  ...
                  var O = null == r.prevCapture ? "" : r.prevCapture[0],
                    v = b.match(t, r, O);
                  if (v) {
                    var S = b.quality ? b.quality(v, r, O) : 0;
                    (y < p || S > f) && (l = E, c = b, u = v, f = S, p = y)
                  }
                }
            }
    ...
    d = function(e, t, n, r) {
      ...
      for (var o in n = n || {}) {
        var a = n[o];
        Object.prototype.hasOwnProperty.call(n, o) && a && (i += " " + h(o) + '="' + h(a) + '"')
      }
      var s = "<" + e + i + ">";
      return r ? s + t + "</" + e + ">" : s
    },
