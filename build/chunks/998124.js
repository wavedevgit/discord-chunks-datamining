/** Chunk was on 79255 **/
/** chunk id: 998124, original params: e,t,r (module,exports,require) **/
"use strict";
require.d(exports, {
  JT: () => c,
  M$: () => d,
...
var Chunk639443 = require("./639443.js");
...
s(c, "empty", {
  dispose: Chunk639443.ZT
});
var u = function() {
    function e() {
      o(this, module), s(this, "isDisposed", false), s(this, "disposables", true);
      for (var t = arguments.length, r = Array(exports), n = 0; Chunk639443 < exports; Chunk639443++) require[Chunk639443] = arguments[Chunk639443];
    ...
    return a(module, [{
      ...
      value: function() {
        if (!this.isDisposed) {
          ...
          this.disposables = [];
          for (var n = 0; Chunk639443 < module; Chunk639443++) exports[Chunk639443].dispose()
        }
      }
    }, {
      key: "dispose",
