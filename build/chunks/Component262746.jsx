...
function g(e) {
  let {
    ...
    user: g,
    guild: b
  } = e, y = (0, l.e7)([p.Z], () => null != g && p.Z.isUserBanned(g.id)), _ = null != g && null == y, [C, x] = i.useState(_), v = (0, l.e7)([d.Z], () => null != g && null != b && (0, u.lD)(g, b, [d.Z]));
  if ((0, c.ZP)(() => {
      _ && s.Z.searchGuildBans(t.guild_id, true, [null == g ? true : g.id]).finally(() => x(false))
    }), !v) return null;
