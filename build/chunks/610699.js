...
function L(e) {
  ...
  let b = i.useCallback(() => {
    ...
    U = i.useCallback(() => {
      (0, d.r$)(a, "accept", D), d.ZP.acceptInviteAndTransitionToInviteChannel({
        inviteKey: a.code,
  ...
  let G = B && !k || B && v;
  return (B && v && (l = Z.NW.string(Z.t.wJNK8P)), k || (l = Z.NW.string(Z.t.hHGrW1)), null == a.code || "" === a.code || null == E) ? null : (0, r.jsx)(f.Gt, {
    value: D,
    children: (0, r.jsx)(M, {
      app: E,
      invite: a,
...
function M(e) {
  ...
  let {
    ...
    bot: j,
    icon: C
  } = l, S = T.ZP.getApplicationIconURL({
    id: l.id,
    icon: C,
    bot: j
  }), I = (0, x.z)(l), P = (0, b.E)(l), A = o.length, w = i.useMemo(() => {
    let e = [{
