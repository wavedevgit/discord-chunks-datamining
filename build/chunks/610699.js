...
function M(e) {
  ...
  let E = i.useCallback(() => {
    ...
    L = v.Z.getChannel(null == (n = a.channel) ? void 0 : n.id),
  ...
  let V = H && !D || H && T;
  return (H && T && (l = Z.intl.string(Z.t.wJNK8P)), D || (l = Z.intl.string(Z.t.hHGrW1)), null == a.code || "" === a.code || null == x) ? null : (0, r.jsx)(f.Gt, {
    value: M,
    children: (0, r.jsx)(k, {
      app: x,
      invite: a,
...
function k(e) {
  ...
  let {
    ...
    icon: I,
    bot: j
  }), N = (0, E.G)(l), P = (0, b.E)(l), A = o.length, w = i.useMemo(() => [{
