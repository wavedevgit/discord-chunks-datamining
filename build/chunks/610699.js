...
function L(e) {
  ...
  let x = i.useCallback(() => {
    ...
    v = (0, c.e7)([C.Z], () => null != a.guild ? C.Z.getGuild(a.guild.id) : null, [a]),
    E = (0, y.Z)([b.id])[0],
    T = (0, c.e7)([p.ZP], () => {
      var e;
  ...
  let V = H && !D || H && T;
  return (H && T && (l = Z.intl.string(Z.t.wJNK8P)), D || (l = Z.intl.string(Z.t.hHGrW1)), null == a.code || "" === a.code || null == E) ? null : (0, r.jsx)(f.Gt, {
    value: L,
    children: (0, r.jsx)(M, {
      app: E,
      invite: a,
