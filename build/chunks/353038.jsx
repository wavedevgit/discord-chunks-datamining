...
class C extends(i = Chunk73800.Component) {
  ...
  renderResizeHandles() {
    ...
    return <Chunk255367.Fragment>{module ? <Chunk255367.Fragment>{<div className={s()(Chunk524468.resizeNorth, {
            [Chunk524468.resizeNSCursor]: require
          })} onMouseDown={e => this.handleResizeMouseDown(e, "RESIZE_NORTH")} />}{<div className={s()(Chunk524468.resizeSouth, {
            [Chunk524468.resizeNSCursor]: require
          })} onMouseDown={e => this.handleResizeMouseDown(e, "RESIZE_SOUTH")} />}</Chunk255367.Fragment> : null}{exports ? <Chunk255367.Fragment>{<div className={s()(Chunk524468.resizeEast, {
            [Chunk524468.resizeEWCursor]: require
          })} onMouseDown={e => this.handleResizeMouseDown(e, "RESIZE_EAST")} />}{<div className={s()(Chunk524468.resizeWest, {
            [Chunk524468.resizeEWCursor]: require
          })} onMouseDown={e => this.handleResizeMouseDown(e, "RESIZE_WEST")} />}</Chunk255367.Fragment> : null}{exports && module ? <Chunk255367.Fragment>{<div className={s()(Chunk524468.resizeNorthWest, {
            [Chunk524468.resizeNWSECursor]: require
          })} onMouseDown={e => this.handleResizeMouseDown(e, "RESIZE_NORTH_WEST")} />}{<div className={s()(Chunk524468.resizeNorthEast, {
            [Chunk524468.resizeNESWCursor]: require
          })} onMouseDown={e => this.handleResizeMouseDown(e, "RESIZE_NORTH_EAST")} />}{<div className={s()(Chunk524468.resizeSouthWest, {
            [Chunk524468.resizeNESWCursor]: require
          })} onMouseDown={e => this.handleResizeMouseDown(e, "RESIZE_SOUTH_WEST")} />}{<div className={s()(Chunk524468.resizeSouthEast, {
            [Chunk524468.resizeNWSECursor]: require
          })} onMouseDown={e => this.handleResizeMouseDown(e, "RESIZE_SOUTH_EAST")} />}</Chunk255367.Fragment> : null}</Chunk255367.Fragment>
  }
  renderExtras() {
    let {
      props: {
  ...
  render() {
    ...
    return <Chunk126663.animated.div ref={this.ref} style={this.getInlineStyles()} className={s()({
        [Chunk524468.wrapper]: true,
        [Chunk524468.operation]: r,
        [Chunk524468.unlocked]: !require,
        [Chunk524468.lockExtras]: Chunk73800
      }, i)} onMouseDown={this.handleMouseDown} onClick={null != module ? () => module(exports) : true}>{this.renderChildren()}{this.renderResizeHandles()}{this.renderExtras()}</Chunk126663.animated.div>
  }
  constructor(e) {
