...
function W(e) {
  let {
    ...
    hasUnreads: d
  } = (0, T.X5)(t), u = (0, o.bG)([C.A], () => C.A.can(F.xBc.MANAGE_MESSAGES, t)), m = _.kt.useSetting(), h = _.gs.useSetting(), g = (0, b.A)(h, u), f = (0, N.no)(n, s, false), x = t.isMediaPost(), [p, j] = (0, I.tm)(a.width - 2 * I.IZ, x ? I.PL.SIXTEEN_BY_NINE : I.PL.THREE_BY_TWO);
  return (null == n ? true : n.blocked) || null == (null != i ? i : c) ? (0, r.jsx)(Z, {
    channel: t,
    firstMessage: n,
    isFirstMessageLoaded: l,
    containerWidth: a.width,
...
function q(e) {
  let {
    ...
    facepileRef: n,
    firstMessage: l
  } = e, i = (0, m.m)(t.id), a = (null == l ? true : l.reactions) != null && l.reactions.length > 0;
  return (0, r.jsxs)("div", {
    className: G.GD,
    children: [(0, r.jsxs)("div", {
      className: G.QW,
