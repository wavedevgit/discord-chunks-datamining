...
require("./73800.js");
var Chunk693789 = require("./693789.js"),
...
let P = {
  ...
  renderResults(e) {
    let {
      ...
      onHover: l,
      onClick: c
    } = e, u = (0, h.hV)(o, a), d = s.commands === y.L8.OLD_BUILT_INS;
    return (0, b.HI)({
      query: u.text,
      selectedIndex: n,
      autocompletes: t,
      ...
      headerTrailingContent: d ? <i.zx type={"button"} look={i.zx.Looks.LINK} color={i.zx.Colors.BRAND} size={i.zx.Sizes.MIN} onClick={C}>{I.intl.string(I.t["8a0P09"])}</i.zx> : null
    })
  },
  onSelect(e) {
    let {
