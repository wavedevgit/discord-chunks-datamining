...
let j = (0, N.Mg)(s.Z.MEMBER_LIST_ITEM_AVATAR_DECORATION_PADDING),
  ...
  B = i.memo(function(e) {
    ...
    return null == t ? null : (0, r.jsx)(l.ua7, {
      text: w.NW.formatToPlainString(w.t.IWkAq6, {
        date: t
      }),
  ...
  H = i.memo(function(e) {
    let {
      ...
      typingRef: p,
      currentUser: h
    } = e, m = o === C.Skl.OFFLINE, g = n ? l.Xo$ : l.qEK, E = (0, c.Z)(i) ? C.Skl.STREAMING : o;
    return E = m ? void 0 : E, (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsx)(g, k(x({}, a), {
        size: l.EFr.SIZE_32,
        src: s,
        isMobile: u,
        isTyping: d,
  ...
  Y = i.memo(function(e) {
    ...
    let {
      ...
      tabIndex: eo,
      itemProps: ea
    } = e, es = null == b ? void 0 : b.id, el = A.ZP.useName(b), ec = (null == (t = S.default.getCurrentUser()) ? void 0 : t.id) === es, eu = i.useRef(null), [ed, ef] = i.useState(!1), [e_, ep] = i.useState(null), {
      voiceChannel: eh
    } = (0, f.Z)({
      userId: es,
      guildId: G
    }), {
      voiceActivityStatusEnabled: em
    } = (0, u.U)({
      ...
      animateOnHover: !(n || ed),
      guildId: G
    }), ev = (0, y.X)(G, s), [eO, eI] = i.useState(!1);
    i.useEffect(() => {
      n && eI(!1)
    }, [n]);
    let eS = (0, v.Fr)(N),
      ...
      eR = i.useCallback(e => (0, r.jsx)(O.Z, k(x({
        quest: eS,
