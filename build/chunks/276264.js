...
let G = (0, C.Mg)(l.Z.MEMBER_LIST_ITEM_AVATAR_DECORATION_PADDING),
  ...
  W = i.memo(function(e) {
    let {
      ...
      typingRef: p,
      currentUser: h
    } = e, m = o === P.Skl.OFFLINE, g = n ? c.Xo$ : c.qEK, E = (0, u.Z)(i) ? P.Skl.STREAMING : o;
    return E = m ? void 0 : E, (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsx)(g, U(k({}, a), {
        size: c.EFr.SIZE_32,
        src: s,
        isMobile: l,
        isTyping: d,
  ...
  z = i.memo(function(e) {
    ...
    let {
      ...
      tabIndex: el,
      itemProps: ec
    } = e, eu = null == y ? void 0 : y.id, ed = R.ZP.useName(y), ef = (null == (t = A.default.getCurrentUser()) ? void 0 : t.id) === eu, e_ = i.useRef(null), [ep, eh] = i.useState(!1), [em, eg] = i.useState(null), {
      voiceChannel: eE
    } = (0, _.Z)({
      userId: eu,
      guildId: V
      ...
      animateOnHover: !(n || ep),
      guildId: V
    }), eS = (0, O.X)(V, l), eT = (0, s.e7)([I.Z], () => null != I.Z.questEnrollmentBlockedUntil, []), [eA, eN] = i.useState(!1);
    i.useEffect(() => {
      n && eN(!1)
    }, [n]);
    let eC = (0, v.fN)(C),
