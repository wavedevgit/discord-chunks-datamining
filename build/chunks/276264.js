...
let G = (0, C.Mg)(l.Z.MEMBER_LIST_ITEM_AVATAR_DECORATION_PADDING),
  ...
  W = i.memo(function(e) {
    let {
      ...
      typingRef: p,
      currentUser: h
    } = e, m = o === R.Skl.OFFLINE, g = n ? c.Xo$ : c.qEK, E = (0, u.Z)(i) ? R.Skl.STREAMING : o;
    return E = m ? void 0 : E, (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsx)(g, U(M({}, a), {
        size: c.EFr.SIZE_32,
        src: s,
        isMobile: l,
        isTyping: d,
  ...
  K = i.memo(function(e) {
    let {
      ...
      activity: null == o ? void 0 : o.find(e => {
        let {
          type: t
        } = e;
  ...
  z = i.memo(function(e) {
    ...
    let {
      ...
      tabIndex: el,
      itemProps: ec
    } = e, eu = null == y ? void 0 : y.id, ed = P.ZP.useName(y), ef = (null == (t = A.default.getCurrentUser()) ? void 0 : t.id) === eu, e_ = i.useRef(null), [ep, eh] = i.useState(!1), [em, eg] = i.useState(null), {
      voiceChannel: eE
    } = (0, _.Z)({
      userId: eu,
      guildId: F
      ...
      animateOnHover: !(n || ep),
      guildId: F
    }), eS = (0, O.X)(F, l), eT = (0, s.e7)([I.Z], () => null != I.Z.questEnrollmentBlockedUntil, []), [eA, eN] = i.useState(!1);
    i.useEffect(() => {
      n && eN(!1)
    }, [n]);
    let eC = (0, v.fN)(C),
      ...
      eL = i.useCallback(e => (0, r.jsx)(S.Z, U(M({
        name: null != b ? b : ed,
        quest: eC,
