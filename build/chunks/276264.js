...
let V = (0, C.Mg)(l.Z.MEMBER_LIST_ITEM_AVATAR_DECORATION_PADDING),
  ...
  X = i.memo(function(e) {
    ...
    let {
      ...
      itemProps: ec,
      ref: eu
    } = e, ed = null == y ? void 0 : y.id, e_ = R.ZP.useName(y), ef = (null == (t = A.default.getCurrentUser()) ? void 0 : t.id) === ed, ep = i.useRef(null), eh = null != eu ? eu : ep, [em, eg] = i.useState(!1), [eE, eb] = i.useState(!1), [ey, eO] = i.useState(null), {
      voiceChannel: ev
    } = (0, f.Z)({
      userId: ed,
      guildId: V
      ...
      onFocus: eR
    } = eC, eP = G(eC, ["onFocus"]), ew = (0, O.X)(V, l), eD = (0, s.e7)([I.Z], () => null != I.Z.questEnrollmentBlockedUntil, []), [eL, ex] = i.useState(!1);
    i.useEffect(() => {
      n && ex(!1)
    }, [n]);
    let eM = (0, v.fN)(C),
      ...
      eF = i.useCallback(e => (0, r.jsx)(T.Z, U(k({
        name: null != b ? b : e_,
        quest: eM,
