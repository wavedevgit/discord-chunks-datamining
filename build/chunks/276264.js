...
let j = (0, A.Mg)(s.Z.MEMBER_LIST_ITEM_AVATAR_DECORATION_PADDING),
  ...
  B = i.memo(function(e) {
    ...
    return null == t ? null : (0, r.jsx)(l.ua7, {
      text: w.intl.formatToPlainString(w.t.IWkAq6, {
        date: t
      }),
  ...
  H = i.memo(function(e) {
    let {
      ...
      typingRef: p,
      currentUser: h
    } = e, m = a === C.Skl.OFFLINE, g = n ? l.Xo$ : l.qEK, E = (0, c.Z)(i) ? C.Skl.STREAMING : a;
    return E = m ? void 0 : E, (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsx)(g, k(x({}, o), {
        size: l.EFr.SIZE_32,
        src: s,
        isMobile: u,
        isTyping: d,
  ...
  W = i.memo(function(e) {
    ...
    let {
      ...
      tabIndex: ea,
      itemProps: eo
    } = e, es = null == b ? void 0 : b.id, el = N.ZP.useName(b), ec = (null == (t = S.default.getCurrentUser()) ? void 0 : t.id) === es, eu = i.useRef(null), [ed, ef] = i.useState(!1), [e_, ep] = i.useState(null), {
      voiceChannel: eh
    } = (0, f.Z)({
      userId: es,
      guildId: G
