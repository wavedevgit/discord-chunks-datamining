...
function m(e) {
  ...
  return <i.hjN title={d.intl.string(d.t.ofmOzc)}><div className={u.paymentInfoGroup}>{<o.H>{<s.Z label={d.intl.string(d.t.iY1jW1)} value={(0, a.T4)(null != n ? n : 0, c.pKx.USD)} additionalContent={(0, r.jsx)(l.H, {
            value: m,
            isPercent: true
          })} />}{<s.Z label={g} value={p} additionalContent={(0, r.jsx)(l.H, {
            value: h,
            isPercent: f
          })} />}</o.H>}{t}</div></i.hjN>
}