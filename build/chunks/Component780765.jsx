...
function R(e) {
  let t, {
    ...
    }, [l.role_id]),
    {
      ...
      var e, t, n, i, r;
      let a = null != (e = null == (n = x.A.get(l.type)) || null == (t = n.getPlatformUserUrl) ? true : t.call(n, {
        id: l.account.id,
        name: l.account.name
      })) ? e : "";
      switch (l.type) {
    ...
    Z = (0, p.bG)([v.A], () => null != l.role_id ? v.A.getRole(n.id, l.role_id) : true),
    {
      roleLink: X,
      syncDescriptionText: $
    } = r.useMemo(() => {
  ...
  if (r.useEffect(() => {
      (null == s ? true : s.id) === l.id && (null == s ? true : s.enabled) === true && U(false)
