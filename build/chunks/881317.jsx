...
let I = {
  ...
  O = e => {
    ...
    return <s.P3F className={b.reportButton} onClick={() => o()}>{<s.Text variant={"text-md/medium"}>{t}</s.Text>}{<s.LJT size={"sm"} color={"currentColor"} />}</s.P3F>
  },
  S = () => {
    ...
    }, [Chunk726521]), module || !Chunk726521 ? <Chunk388905.ZP><Chunk481060.$jN /></Chunk388905.ZP> : null != require && require.length > 0 && <Chunk388905.ZP>{<Chunk388905.Dx className={Chunk20493.marginBottom8}>{Chunk388032.intl.string(Chunk388032.t.Z11w19)}</Chunk388905.Dx>}{<Chunk388905.DK className={Chunk20493.marginBottom8}>{Chunk388032.intl.format(Chunk388032.t["532l+v"], {
          supportURL: Chunk63063.Z.getArticleURL(Chunk981631.BhN.COPYRIGHT_AND_IP_POLICY)
        })}</Chunk388905.DK>}{<div className={Chunk793613.container}>{require.map(e => null == I[e] ? null : (0, r.jsx)(O, {
          title: x.intl.string(I[e]),
          menuType: e
        }, e))}</div>}</Chunk388905.ZP>
  }