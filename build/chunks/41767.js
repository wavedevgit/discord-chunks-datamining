...
let j = t => {
  ...
  let {
    duration: e,
    onSelectDuration: l
  } = t, a = (0, c.tr)(), s = a.find(t => t.value === e);
...
function A(t) {
  let {
    ...
    onClose: _,
    transitionState: N
  } = t, S = (0, s.Dt)(), [C, h] = l.useState(() => null != n.metadata.durationSeconds && n.metadata.durationSeconds > 0 ? n.metadata.durationSeconds : c.UK.DURATION_60_SEC), I = (0, u.c)(n.type, n, e);
