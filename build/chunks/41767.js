...
let N = t => {
  ...
  let {
    duration: n,
    onSelectDuration: l
  } = t, s = (0, u.tr)(), i = s.find(t => t.value === n);
...
function d(t) {
  let {
    ...
    onClose: A,
    transitionState: E
  } = t, _ = (0, s.Dt)(), [S, C] = l.useState(() => null != e.metadata.durationSeconds && e.metadata.durationSeconds > 0 ? e.metadata.durationSeconds : u.UK.DURATION_60_SEC), h = (0, i.c)(e.type, e, n);
