...
let d = t => {
  ...
  let {
    duration: e,
    onSelectDuration: l
  } = t, i = (0, u.tr)(), s = i.find(t => t.value === e);
...
function j(t) {
  let {
    ...
    onClose: E,
    transitionState: N
  } = t, _ = (0, i.Dt)(), [S, C] = l.useState(() => null != n.metadata.durationSeconds && n.metadata.durationSeconds > 0 ? n.metadata.durationSeconds : u.UK.DURATION_60_SEC), h = (0, s.c)(n.type, n, e);
