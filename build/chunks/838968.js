...
function f(e) {
  ...
  let {
    ...
    powerup: c,
    className: f
  } = e, x = (0, s.Z)(l, c), b = x.type !== d.A3.LEVEL_ACTIVATED, v = b ? m.labelContainer : m.labelContainerEnd, g = x.type === d.A3.LEVEL_ACTIVATED ? p.intl.formatToPlainString(u.default.WRRYUV, {
    perkName: null != (i = null == (t = x.sourcePowerup) ? void 0 : t.title) ? i : p.intl.string(p.t.BfF6EB)
  }) : x.type === d.A3.POWERUP_ACTIVATED ? p.intl.string(u.default.FFLkm5) : void 0;
  return (0, r.jsxs)("div", {
    className: o()(v, f),
...
function x(e) {
  ...
  let {
    ...
    onHover: u,
    children: p
  } = e, _ = (0, s.Z)(n, i), f = _.type !== d.A3.INACTIVE, x = (null == (t = _.sourceEntitlement) ? void 0 : t.ends_at) != null, {
    onShowMore: b
  } = (0, c.ZP)(n, i);
  return (0, r.jsx)("div", {
