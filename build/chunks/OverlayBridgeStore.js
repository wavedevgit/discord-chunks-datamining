...
function eM(e) {
  ...
  n.append("build_id", "13417aa6def4ae7e4e020b1a866d82b533119ce5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
