...
function ej(e) {
  ...
  n.append("build_id", "9a2f97eecaf3efd9c7e26a60805cad1cd3acf15f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
