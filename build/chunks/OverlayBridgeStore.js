...
function eM(e) {
  ...
  n.append("build_id", "a73e3232066e1ec07cabef2027838ac26ec62629"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
