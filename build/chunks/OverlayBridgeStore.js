...
function ej(e) {
  ...
  n.append("build_id", "01f5518a044222fa105bdc9fb944aac0953ebd7f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
