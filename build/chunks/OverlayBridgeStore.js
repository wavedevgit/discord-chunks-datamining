...
function ek(e) {
  ...
  n.append("build_id", "656963326413a238e1f5b050736691e16ecc3471"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
