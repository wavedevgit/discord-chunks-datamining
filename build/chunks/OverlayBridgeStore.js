...
function eM(e) {
  ...
  n.append("build_id", "a5fc448702e05c7542336dfa62188eb0984522b3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
