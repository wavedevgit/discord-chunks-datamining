...
function eM(e) {
  ...
  n.append("build_id", "74e087e2c8e7ff88256c891be299abb66550b778"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
