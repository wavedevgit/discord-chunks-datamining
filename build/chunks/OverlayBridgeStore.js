...
function ej(e) {
  ...
  n.append("build_id", "d98fee613e464f38efd8dbe5ea599c2edf5ab81f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
