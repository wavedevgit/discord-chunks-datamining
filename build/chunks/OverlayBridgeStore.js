...
function ej(e) {
  ...
  n.append("build_id", "7a67eacf88860369088826783ee30ed71068a31d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
