...
function ek(e) {
  ...
  n.append("build_id", "358ce6722e8a5a9e47b35432fedac34441abfd00"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
