...
function eM(e) {
  ...
  n.append("build_id", "b7fc68fb83ddda0aefbe52b5995642349fcbbe22"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
