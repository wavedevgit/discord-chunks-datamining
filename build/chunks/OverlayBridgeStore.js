...
function ek(e) {
  ...
  n.append("build_id", "4eb538828a9a2f072164f6d7b4edd6c05a2a0393"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
