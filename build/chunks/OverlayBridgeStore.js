...
function eM(e) {
  ...
  n.append("build_id", "22cf9a060180e45403d60df85fec2545d2ce1b12"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
