...
function eM(e) {
  ...
  n.append("build_id", "a72e879ebbb05227fd3c96bcabf14ae605160d6c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
