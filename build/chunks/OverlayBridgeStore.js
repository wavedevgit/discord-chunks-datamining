...
function ej(e) {
  ...
  n.append("build_id", "d7d3d8ac7e7e9b5aeac3b439670ad6edc44c846c"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
