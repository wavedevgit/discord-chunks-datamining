...
function ek(e) {
  ...
  n.append("build_id", "ef7e1e9b725afbdcf9e7f1a332c75f4182f24256"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
