...
function ej(e) {
  ...
  n.append("build_id", "c754876718385037fb4cf06a160abd188016bcdd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
