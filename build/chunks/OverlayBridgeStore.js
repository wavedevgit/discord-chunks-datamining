...
function ek(e) {
  ...
  n.append("build_id", "535c28c3977140a141a61c2f0e4797d04177c094"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
