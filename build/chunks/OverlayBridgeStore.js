...
function eM(e) {
  ...
  n.append("build_id", "454abec2514f2eacaeda8b5f5bc8601a664b460d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
