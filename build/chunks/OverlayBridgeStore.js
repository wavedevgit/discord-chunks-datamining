...
function eM(e) {
  ...
  n.append("build_id", "b686c97c23647ac98310cb5c3ffdc18d800d12c3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
