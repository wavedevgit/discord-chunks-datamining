...
function ek(e) {
  ...
  n.append("build_id", "ad20727f33b7c65d5395136b3616d54598d57add"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
