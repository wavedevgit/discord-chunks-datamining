...
function ej(e) {
  ...
  n.append("build_id", "3712981201a096aed415b503551e940719af0744"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
