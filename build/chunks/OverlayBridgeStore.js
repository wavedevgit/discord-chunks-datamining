...
function eM(e) {
  ...
  n.append("build_id", "a443b0a818cf8bacbed913dcc6372d21861ddbc8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
