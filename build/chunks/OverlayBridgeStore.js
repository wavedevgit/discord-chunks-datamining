...
function ej(e) {
  ...
  n.append("build_id", "9b20079dd78f6ed930327f6df9998c726843f5b3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
