...
function ej(e) {
  ...
  n.append("build_id", "bd7869c4904645ccb9e9a9db235d563d5205ed56"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
