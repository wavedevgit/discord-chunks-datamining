...
function ej(e) {
  ...
  n.append("build_id", "88b419ed9bce09414f2f81d1ab35888579f1e6de"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
