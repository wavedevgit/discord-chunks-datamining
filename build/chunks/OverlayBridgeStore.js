...
function eM(e) {
  ...
  n.append("build_id", "d24551d7b2d23170815c2a25e57d2d9ef42eb369"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
