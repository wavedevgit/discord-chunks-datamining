...
function eM(e) {
  ...
  n.append("build_id", "253501e529f8235ff1bfd1b195607f27a508dd2b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
