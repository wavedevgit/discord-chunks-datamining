...
function ej(e) {
  ...
  n.append("build_id", "bcb63db1f3410cf69a8d555a5ad6d7c2d32a33a8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
