...
function ek(e) {
  ...
  n.append("build_id", "fcdfd8d1f8033111dc9ab2caa6b7ca83fa4fdb38"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
