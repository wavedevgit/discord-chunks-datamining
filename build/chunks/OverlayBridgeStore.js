...
function ej(e) {
  ...
  n.append("build_id", "79601325a2a2affd63daa4db8116319bf635f059"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
