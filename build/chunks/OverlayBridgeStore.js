...
function ej(e) {
  ...
  n.append("build_id", "000816c7ce53bad94a42d6e468eb022876912c3f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
