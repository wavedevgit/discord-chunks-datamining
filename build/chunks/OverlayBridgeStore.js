...
function ek(e) {
  ...
  n.append("build_id", "a758a684b16d9fac2a8ebec19afc34c7c25859ea"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
