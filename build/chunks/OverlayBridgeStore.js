...
function eM(e) {
  ...
  n.append("build_id", "9a4dbf37b4d7c3791267ccd6e890fcdebd7574ed"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
