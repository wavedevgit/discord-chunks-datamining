...
function ej(e) {
  ...
  n.append("build_id", "637017ebceb75a4bdd115578fa29fd6a094e428d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
