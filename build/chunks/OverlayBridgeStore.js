...
function ek(e) {
  ...
  n.append("build_id", "8023481b2e753babeedcd00960c82f31bb74db5f"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
