...
function eM(e) {
  ...
  n.append("build_id", "6182084586d9e7a0755dc0bf61754d6bea651b6d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
