...
function eM(e) {
  ...
  n.append("build_id", "ac4c64956dacc32d383d14d05018ddb6a49ce69f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
