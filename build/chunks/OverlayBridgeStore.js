...
function ej(e) {
  ...
  n.append("build_id", "2929ed5a235ef0a302a739c2959f0d24244b44d0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
