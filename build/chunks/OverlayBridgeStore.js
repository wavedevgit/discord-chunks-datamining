...
function ek(e) {
  ...
  n.append("build_id", "462bce8fd2141bf852a87a0bd8d0a19d5ac985d9"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
