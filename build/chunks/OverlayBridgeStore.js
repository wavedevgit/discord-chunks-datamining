...
function eM(e) {
  ...
  n.append("build_id", "ec47814a922b7d66b539d0eb643b48325351b3de"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
