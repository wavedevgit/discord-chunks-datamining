...
function ej(e) {
  ...
  n.append("build_id", "dce8642d7e276fb7d320a8adbf0b16e880bdbe41"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
