...
function ej(e) {
  ...
  n.append("build_id", "e79971d98cc845362973ca0c127fa8781837727f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
