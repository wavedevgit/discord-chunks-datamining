...
function ej(e) {
  ...
  n.append("build_id", "0a14da9f87f6fa0e04c8214f509afe462bf8aadb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
