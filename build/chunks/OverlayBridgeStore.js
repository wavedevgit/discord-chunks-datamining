...
function ej(e) {
  ...
  n.append("build_id", "7de24834f1730b3df8b064d7da962aa7aee9a4ae"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
