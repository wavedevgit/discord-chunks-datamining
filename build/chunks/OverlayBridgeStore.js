...
function eM(e) {
  ...
  n.append("build_id", "5234814b8790e4a0b359d2ad8b5a64242a181f93"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
