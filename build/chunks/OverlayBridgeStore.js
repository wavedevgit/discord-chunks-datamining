...
function ej(e) {
  ...
  n.append("build_id", "e2ad2a05d9f26c9586c74f50876252748a63adbc"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
