...
function ej(e) {
  ...
  n.append("build_id", "688048e60e8334d0f5a7795354426f6d5dc24b3f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
