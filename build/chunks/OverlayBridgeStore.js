...
function ej(e) {
  ...
  n.append("build_id", "45013cdd800b440250d5414a1afd2b7fdae18ca0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
