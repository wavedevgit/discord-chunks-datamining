...
function ek(e) {
  ...
  n.append("build_id", "83bf7ba7d74cffd2363fc07731fcbd2f3a2171f4"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
