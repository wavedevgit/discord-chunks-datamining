...
function eM(e) {
  ...
  n.append("build_id", "8ddfcafcfb76366e44c01b555a2658307f24028d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
