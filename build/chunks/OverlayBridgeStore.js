...
function ek(e) {
  ...
  n.append("build_id", "fe806bbd643ccfdba8ee36fc22640ccbe9de891c"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
