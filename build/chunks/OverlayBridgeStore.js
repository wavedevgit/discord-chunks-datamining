...
function ej(e) {
  ...
  n.append("build_id", "991fef03dad638d7d0b32933a7e32866f5cf05ec"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
