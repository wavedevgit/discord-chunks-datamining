...
function ek(e) {
  ...
  n.append("build_id", "6b3e8723cbde023a4777131b81aadd1f89b6b47e"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
