...
function eM(e) {
  ...
  n.append("build_id", "705c604ef017cdc1916b447b005b8bb7840445be"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
