...
function eM(e) {
  ...
  n.append("build_id", "cd8651ebe81e096baba9712cc31519467b39e212"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
