...
function ej(e) {
  ...
  n.append("build_id", "d22d8a1d7fe6ef5e2f50f07206dbadcdce42186d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
