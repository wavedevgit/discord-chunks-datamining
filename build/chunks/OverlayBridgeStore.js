...
function ek(e) {
  ...
  n.append("build_id", "99afca5bb80f6b36292e4eaff63fe6c3492afe6f"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
