...
function ej(e) {
  ...
  n.append("build_id", "d0f585e7847fefa38fd41c4533674102b529df0b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
