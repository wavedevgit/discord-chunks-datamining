...
function ej(e) {
  ...
  n.append("build_id", "9ce681cab77875dec227c36c3bc02dde23ea529f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
