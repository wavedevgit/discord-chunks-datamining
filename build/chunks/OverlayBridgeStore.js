...
function eM(e) {
  ...
  n.append("build_id", "c9d331287e13b62b7a19e9ba05dd9dc7a710b7a4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
