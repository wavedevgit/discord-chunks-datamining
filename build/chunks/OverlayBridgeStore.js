...
function eM(e) {
  ...
  n.append("build_id", "389355a6e488939feb6b791914811cc66fcf3280"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
