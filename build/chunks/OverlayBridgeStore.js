...
function ej(e) {
  ...
  n.append("build_id", "74c53fc7ca32ab69f95f173575eff31d705ae68c"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
