...
function ej(e) {
  ...
  n.append("build_id", "b0b49db67dc2674531c8328f225ca4a0401e0bce"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
