...
function ej(e) {
  ...
  n.append("build_id", "7db13b2578a258a64c04e9a069d53663eea0cfe6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
