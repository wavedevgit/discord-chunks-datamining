...
function ek(e) {
  ...
  n.append("build_id", "23728e54bf66d83304ce420355c7d860574b1e46"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
