...
function eM(e) {
  ...
  n.append("build_id", "9869996f514811121e8b45fb0604ab172b8b5cfe"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
