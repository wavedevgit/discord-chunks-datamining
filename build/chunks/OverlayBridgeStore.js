...
function ej(e) {
  ...
  n.append("build_id", "1b5e5644293d7c3d7afde85eb1a22550e949323f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
