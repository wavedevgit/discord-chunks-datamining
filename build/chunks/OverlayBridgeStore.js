...
function eM(e) {
  ...
  n.append("build_id", "23b3e4a447273a56b10f10b696f35eb3e8fff947"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
