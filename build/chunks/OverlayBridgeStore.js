...
function ej(e) {
  ...
  n.append("build_id", "6572f95a922fce8a8a8728e8e9a896fb0ab26088"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
