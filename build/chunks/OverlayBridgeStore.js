...
function ek(e) {
  ...
  n.append("build_id", "b6e5b425b1886483592853dbe08698cd10e350cd"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
