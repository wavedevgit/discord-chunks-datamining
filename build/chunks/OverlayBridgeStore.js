...
function ej(e) {
  ...
  n.append("build_id", "e0910a1ba4dbfeeee18caf36ef4ded43f72de2e8"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
