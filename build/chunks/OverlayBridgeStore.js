...
function ej(e) {
  ...
  n.append("build_id", "06b44826df6584a7ac6f585f6aea5440380890df"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
