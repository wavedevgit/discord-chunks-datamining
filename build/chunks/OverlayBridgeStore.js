...
function eM(e) {
  ...
  n.append("build_id", "41495769850d0990f54ebcba72f8dcc7d01856e5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
