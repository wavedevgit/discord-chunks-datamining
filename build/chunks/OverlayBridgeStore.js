...
function ej(e) {
  ...
  n.append("build_id", "e1a6e0b083aabba187c6a6139cbb9af84649f5ea"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
