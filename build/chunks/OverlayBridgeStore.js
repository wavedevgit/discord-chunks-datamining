...
function ek(e) {
  ...
  n.append("build_id", "5106745e6645734f90eccc1863507f5fef7b5554"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
