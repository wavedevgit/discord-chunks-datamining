...
function ej(e) {
  ...
  n.append("build_id", "dfa2102c17f4e54fe49c1e2dbce78f962926d46a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
