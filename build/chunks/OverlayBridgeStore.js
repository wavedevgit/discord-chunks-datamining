...
function ej(e) {
  ...
  n.append("build_id", "4c899eb8885f013851c409e5bc5f61253be6d821"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
