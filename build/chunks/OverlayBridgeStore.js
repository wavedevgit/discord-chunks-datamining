...
function ek(e) {
  ...
  n.append("build_id", "196026ccbe465502ac3659e8c8c83c3138792436"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
