...
function ej(e) {
  ...
  n.append("build_id", "49b9b5f3fb5750e64e22e5ccca19cddf579b609b"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
