...
function ej(e) {
  ...
  n.append("build_id", "06118287e313738b3002f26945b60ee26d9f2938"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
