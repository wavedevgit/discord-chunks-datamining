...
function ej(e) {
  ...
  n.append("build_id", "837b3eeaf46242dd230340e595df5723a8b72b1e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
