...
function ej(e) {
  ...
  n.append("build_id", "d114e59799d1bd2be2e0e9e6ee4799d38be22cef"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
