...
function ek(e) {
  ...
  n.append("build_id", "15231023a751eb2505fb22f831b6bf57f200d967"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
