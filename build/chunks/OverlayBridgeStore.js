...
function ej(e) {
  ...
  n.append("build_id", "42e350542cf381bfd888e17890805ccdaa7828ea"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
