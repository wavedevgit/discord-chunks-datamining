...
function eM(e) {
  ...
  n.append("build_id", "11105f81f40273e468aa48498fffe0b7da7393a0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
