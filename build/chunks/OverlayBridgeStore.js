...
function ej(e) {
  ...
  n.append("build_id", "a3750d7ccda36ed4cf6864a0cdd4e4a245eca013"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
