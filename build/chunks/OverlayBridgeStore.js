...
function eM(e) {
  ...
  n.append("build_id", "90d00c860404470cba5fe355d0592e4b47e6b430"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
