...
function ek(e) {
  ...
  n.append("build_id", "a196008c5718d9ef453a852bb5aeaf0eff918eb4"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
