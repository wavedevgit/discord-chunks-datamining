...
function ej(e) {
  ...
  n.append("build_id", "104fc00ced32278d626577f939d945498184abe5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
