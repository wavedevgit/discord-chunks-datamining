...
function ej(e) {
  ...
  n.append("build_id", "8f46f5dec0a672b7908698a1b83e00c557022c3e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
