...
function eM(e) {
  ...
  n.append("build_id", "f8b9ef87f00d503f639455a127194589b630e817"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
