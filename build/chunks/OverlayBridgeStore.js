...
function ej(e) {
  ...
  n.append("build_id", "85535ce50f7789197a7cf2dbc63612eb41fbe787"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
