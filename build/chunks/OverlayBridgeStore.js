...
function ej(e) {
  ...
  n.append("build_id", "393e0128c6e1bb88a188ee0308c7d6e1f4037bd1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
