...
function ek(e) {
  ...
  n.append("build_id", "10eaccbaa725ab1f55a297055f0f118749d0d487"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
