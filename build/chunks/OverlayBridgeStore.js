...
function ej(e) {
  ...
  n.append("build_id", "d99e7cd54e4d493b80a15cd4ccd1b9f64685307a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
