...
function ej(e) {
  ...
  n.append("build_id", "b2e4220e5d166711db9af00e3fee9818fd2ae12a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
