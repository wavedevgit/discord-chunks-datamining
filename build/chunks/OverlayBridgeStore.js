...
function eM(e) {
  ...
  n.append("build_id", "3bed1f7a974cf43fc9900900379610da60e2f959"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
