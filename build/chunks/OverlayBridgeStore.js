...
function ek(e) {
  ...
  n.append("build_id", "b7dd8722f402a665a8ed7088aecbede5799689bf"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
