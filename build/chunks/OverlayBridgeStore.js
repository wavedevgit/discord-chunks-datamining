...
function ej(e) {
  ...
  n.append("build_id", "9fc8a5e5a212050af9ffe2d760e0d465fb6d57e4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
