...
function ej(e) {
  ...
  n.append("build_id", "742d4ae681032ea5bba58ae1e374cd230590e356"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
