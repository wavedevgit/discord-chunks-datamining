...
function eM(e) {
  ...
  n.append("build_id", "ab7a39cb6d15a30441acc0733a4976772340451c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
