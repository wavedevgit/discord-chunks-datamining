...
function ej(e) {
  ...
  n.append("build_id", "b8dccdebd1b224c4780262a51423a72dc01afa9d"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
