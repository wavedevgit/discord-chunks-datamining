...
function ek(e) {
  ...
  n.append("build_id", "76ae63f7649338a8f990003ef0473fda208b2fdb"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
