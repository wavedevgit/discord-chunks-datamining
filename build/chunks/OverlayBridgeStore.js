...
function ej(e) {
  ...
  n.append("build_id", "3d417745687c06ab1043da6570d74f110e55ecc4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
