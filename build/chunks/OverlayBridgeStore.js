...
function ej(e) {
  ...
  n.append("build_id", "a93ff73c2fc8c5ba6ddf3e2773bdcfdfcb2c56ad"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
