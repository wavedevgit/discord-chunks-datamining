...
function ej(e) {
  ...
  n.append("build_id", "61d483e41e84882bff4ba4a211d2ab1fa2291d7a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
