...
function ek(e) {
  ...
  n.append("build_id", "41cd33aab8f011e34a62dfeaa2c587eac03c3409"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
