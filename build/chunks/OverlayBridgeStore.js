...
function eM(e) {
  ...
  n.append("build_id", "a5b1a1fe92b891127b9ce4b3b53530a27b24ccd2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
