...
function ej(e) {
  ...
  n.append("build_id", "be458a6bac991a345c3310248b5b5d367a235ac4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
