...
function ej(e) {
  ...
  n.append("build_id", "264f32dc7016bb81fbfb30232fb7f4a706f3731b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
