...
function ej(e) {
  ...
  n.append("build_id", "4a1ca5670c17d1140453a0e87b62315a0f29b2b2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
