...
function eM(e) {
  ...
  n.append("build_id", "fe274a9b1b1278b0d40c317d42472c5fff9b34ce"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
