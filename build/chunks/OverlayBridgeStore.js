...
function ek(e) {
  ...
  n.append("build_id", "e5a86b24275bf61d29892d9f8a0fad0703f72e8a"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
