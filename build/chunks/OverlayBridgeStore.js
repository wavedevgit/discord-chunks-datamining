...
function eM(e) {
  ...
  n.append("build_id", "902b39c4b02b3796c529698f9be18595810774cd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
