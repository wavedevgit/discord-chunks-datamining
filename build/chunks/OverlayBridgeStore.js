...
async function eb(e) {
  ...
  try {
    ...
    e !== j.DEV_PID && (ef = "detach.cancelAttachToProcess", await h.pn(e), await (0, s._v)(16), ef = "detach.disconnectProcess", await t.disconnectProcess(e)), ef = "detach.transitionOverlayPIDStatus", em(e, null), ef = "detach.reconcileHostProcess", await eg(t)
  } catch (t) {
...
function eA(e, t, n) {
  ...
  eu(e, Z({}, o)), (0, d.te)(j.OVERLAY_LAYOUT_ID, w.Z.getDefaultLayout(j.OVERLAY_LAYOUT_ID), G.bv, {
...
function eR(e) {
  switch (eo && es.info("[app data received]", e), e.type) {
    case U.BmY.CONNECT:
      ...
      if (null == t) break;
      (0, d.te)(j.OVERLAY_LAYOUT_ID, w.Z.getDefaultLayout(j.OVERLAY_LAYOUT_ID), G.bv), Promise.all([(0, T.Z)(t, e.pid), o.ZP.PersistedStore.getAllStates()]).then(t => {
        let [n, r] = t, {
          pid: i,
          token: a
        } = e;
        m.lW({
          ...
          token: a,
          payloads: [n]
        }), em(i, "READY"), (0, j.setPID)(i), f.Z.overlayReady(i);
        let o = ec(i);
        eu(i, V(Z({}, o), {
...
function ej(e) {
  ...
  n.append("build_id", "db63a83de0a2f667273c2d1d9858e7f2a752b946"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
