...
function ek(e) {
  ...
  n.append("build_id", "a8207fc95ccf8d19d323868bd431bc142c6192cf"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
