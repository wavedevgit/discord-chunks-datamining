...
function ej(e) {
  ...
  n.append("build_id", "0fd72ea765365df6adb020318f6ce9ca29663e5c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
