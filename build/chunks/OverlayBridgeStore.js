...
function ej(e) {
  ...
  n.append("build_id", "059bba311778e418a6c096622f4f81c7c65f94d6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
