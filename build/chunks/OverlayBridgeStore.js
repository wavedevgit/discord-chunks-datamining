...
function ek(e) {
  ...
  n.append("build_id", "b8ffaaaf2c5cb547062cc5d546156c5bce502b00"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
