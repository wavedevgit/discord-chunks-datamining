...
function ek(e) {
  ...
  n.append("build_id", "dcdf07fc7a4b1c6f76380e63008455fea8250e9c"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
