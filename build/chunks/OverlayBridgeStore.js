...
function eM(e) {
  ...
  n.append("build_id", "0752fc1832fd7bbb0b2bc2de4b5f681cbf2a4ffb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
