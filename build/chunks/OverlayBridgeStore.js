...
function ej(e) {
  ...
  n.append("build_id", "2116a08e0c14b39269324b966b1236b88fc368e5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
