...
function ej(e) {
  ...
  n.append("build_id", "14129a42cccc21ad945eab26a6608853520025ce"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
