...
function ej(e) {
  ...
  n.append("build_id", "8610040eae64b4a3dc31cc218bb51252c8228b2f"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
