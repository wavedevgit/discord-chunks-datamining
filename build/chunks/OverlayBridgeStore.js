...
function eM(e) {
  ...
  n.append("build_id", "2b6e87fe0dfdfa331917138dbfb21c5186a76fe7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
