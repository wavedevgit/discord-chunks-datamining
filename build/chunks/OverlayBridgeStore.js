...
function eM(e) {
  ...
  n.append("build_id", "c2accf3b0d2ddedbd99f94dd40c74f03a0aea736"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
