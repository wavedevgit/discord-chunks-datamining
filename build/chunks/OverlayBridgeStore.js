...
function ek(e) {
  ...
  n.append("build_id", "ee98ee9bff131c6bc18478a993aaf9138fbd83f3"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
