...
function eM(e) {
  ...
  n.append("build_id", "596cd05800462ffc1430184adb4f55bdcf9b6ba5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
