...
function ej(e) {
  ...
  n.append("build_id", "1e3bd13eb47a3cd146bd9713bf67dd930b8ef017"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
