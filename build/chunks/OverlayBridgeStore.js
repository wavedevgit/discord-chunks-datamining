...
function ej(e) {
  ...
  n.append("build_id", "91c1b8516636fc6ec3d0af839dc1736b40533aae"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
