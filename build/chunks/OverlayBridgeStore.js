...
function ej(e) {
  ...
  n.append("build_id", "0d1066f01864f49c33342a4cf0d280cc505d8de4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
