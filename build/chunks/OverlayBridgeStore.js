...
function eM(e) {
  ...
  n.append("build_id", "ba2f29cdddd73b5b7fb2247f2d6194b17b82c9ef"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
