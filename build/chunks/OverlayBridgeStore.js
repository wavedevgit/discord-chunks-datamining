...
function ek(e) {
  ...
  n.append("build_id", "79d48d4b730727432024e16fc827c7aa5a797fb3"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
