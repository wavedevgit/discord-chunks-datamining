...
function ej(e) {
  ...
  n.append("build_id", "d05f281fec88c133a37268165f2ee011be750f0d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
