...
function ej(e) {
  ...
  n.append("build_id", "95ab6eceecc39937cdb72ca862cd0a610fca121c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
