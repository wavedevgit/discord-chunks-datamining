...
function ek(e) {
  ...
  n.append("build_id", "5fc6a43925e019eee4a03efbc7454f5270ff997c"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
