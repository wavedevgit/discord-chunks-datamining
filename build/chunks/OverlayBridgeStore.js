...
function ej(e) {
  ...
  n.append("build_id", "90f4fe4cf22885e97ac4e84457bcf257d07268b0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
