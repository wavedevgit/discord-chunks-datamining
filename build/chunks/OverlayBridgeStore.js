...
function ek(e) {
  ...
  n.append("build_id", "f8bf44c3eb0148ddec0cd68cefce54cce3f4f224"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
