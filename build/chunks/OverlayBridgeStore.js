...
function eM(e) {
  ...
  n.append("build_id", "369953d8070b89ba5ab47ebd2fda307a40a73a81"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
