...
function ek(e) {
  ...
  n.append("build_id", "4cf96dffa7fc5bf86ab8a42faf86279566e6eeb9"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
