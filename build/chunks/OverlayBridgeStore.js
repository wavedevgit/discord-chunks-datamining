...
function ej(e) {
  ...
  n.append("build_id", "9d0fb77081668278db8656113277e7a01d7ded75"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
