...
function eM(e) {
  ...
  n.append("build_id", "93cc1bdb9ac133c596edd786ffe3ee38157aeeb9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
