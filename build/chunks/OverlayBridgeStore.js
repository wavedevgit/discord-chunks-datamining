...
function ek(e) {
  ...
  n.append("build_id", "519b4d7ecb6247703887f45cb9c37040df94dc97"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
