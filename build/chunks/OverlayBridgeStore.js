...
function eM(e) {
  ...
  n.append("build_id", "bbdca7f88c9f2fbe11ccc33351952cf2055cc2ae"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
