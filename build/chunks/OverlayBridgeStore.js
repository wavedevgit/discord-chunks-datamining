...
function ek(e) {
  ...
  n.append("build_id", "3513976a73674e1f0cd96d230fa0f5052d7f9600"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
