...
function ek(e) {
  ...
  n.append("build_id", "b0b167c96641eed7849c3f6a4512aaa721de942a"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
