...
function ej(e) {
  ...
  n.append("build_id", "65c60eb1e9d6b6a1d8a7e92366a51791bf37c3f2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
