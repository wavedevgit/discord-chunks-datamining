...
function ek(e) {
  ...
  n.append("build_id", "01703991df738a2e6d7ac49864db13a931bd318c"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
