...
function ek(e) {
  ...
  n.append("build_id", "1f186a3a50541dbb9f0aaed32e921a0e771bc070"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
