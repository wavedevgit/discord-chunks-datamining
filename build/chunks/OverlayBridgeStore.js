...
function eM(e) {
  ...
  n.append("build_id", "d8b8afbbdb0fbccbabc2b2ed30e29aa64c18a29f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
