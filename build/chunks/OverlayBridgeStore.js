...
function ek(e) {
  ...
  n.append("build_id", "72e8943761230532f8f88c837e0e7469ceb8cd21"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
