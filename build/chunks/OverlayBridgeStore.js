...
function ej(e) {
  ...
  n.append("build_id", "478a0867d321bd8510b77648c2f744a3d1a12db3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
