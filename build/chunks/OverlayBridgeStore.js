...
function ej(e) {
  ...
  n.append("build_id", "625f7c8580decd79be9bf54e54ef3dc0f3f938b4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
