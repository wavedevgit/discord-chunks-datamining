...
function ej(e) {
  ...
  n.append("build_id", "edc0154435582e53e3622a43fa63cb7a477326ce"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
