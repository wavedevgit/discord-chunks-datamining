...
function ej(e) {
  ...
  n.append("build_id", "490820dc9d556eca52670e1a9f86606c8e7c0a3f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
