...
function ej(e) {
  ...
  n.append("build_id", "d6879b7fdae465a7d4cad9be9ec3009c2885a95c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
