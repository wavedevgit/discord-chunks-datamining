...
function ej(e) {
  ...
  n.append("build_id", "5722ef54a30789bfebd6a41ffaf0be60d2e13b82"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
