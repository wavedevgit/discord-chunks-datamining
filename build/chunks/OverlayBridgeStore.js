...
function ej(e) {
  ...
  n.append("build_id", "ebebadaecd3ccf8670bb06fb9586fa6bc9ba5148"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
