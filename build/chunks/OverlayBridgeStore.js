...
function ej(e) {
  ...
  n.append("build_id", "102eaff00fa35f7a1bfc58f8024226ad2da9530d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
