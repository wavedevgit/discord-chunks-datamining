...
function ej(e) {
  ...
  n.append("build_id", "fdeb9011267da8e0d6d05534e0cb19044b0cde1f"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
