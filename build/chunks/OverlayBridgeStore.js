...
function ek(e) {
  ...
  n.append("build_id", "d995be2033aa385a8361a3f2b953dd9eeabf8aeb"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
