...
function ej(e) {
  ...
  n.append("build_id", "a27920291de8a7f004adc67de96fa5184cf3f7f4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
