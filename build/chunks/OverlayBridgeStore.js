...
function ej(e) {
  ...
  n.append("build_id", "10a4f6b8a55761b3d18d6ef49db8bf242db8042a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
