...
function ek(e) {
  ...
  n.append("build_id", "abb24427f2388018a85cab4099fe92c09b3cef1c"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
