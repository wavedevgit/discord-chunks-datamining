...
function ej(e) {
  ...
  n.append("build_id", "670184daaaa6329b0ac2b6bf9648a81047870f6f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
