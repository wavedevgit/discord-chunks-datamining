...
function ej(e) {
  ...
  n.append("build_id", "d7e7da27b73dca308fb7d7f9d5f292e101631d62"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
