...
function ek(e) {
  ...
  n.append("build_id", "15de5600d7beacfd5ec23e204a5b788030105e63"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
