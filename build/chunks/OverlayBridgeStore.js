...
function eM(e) {
  ...
  n.append("build_id", "e2b0b662a013a6542c0efd1d32507379ef7fa5ba"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
