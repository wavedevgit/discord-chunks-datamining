...
function eM(e) {
  ...
  n.append("build_id", "ce1b7ff466cc4ef5928310efe1713626a86b2d5c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
