...
function eM(e) {
  ...
  n.append("build_id", "908b676ec540f1639afc5977f4992384218f899c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
