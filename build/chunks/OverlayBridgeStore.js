...
function eM(e) {
  ...
  n.append("build_id", "e9da1ccd5ad591d0c9e930c542bb03fb794db7f9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
