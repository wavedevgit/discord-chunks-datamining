...
function ej(e) {
  ...
  n.append("build_id", "10447bad5eed8a48fde8e9ed9cec9b0404550fc6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
