...
function ej(e) {
  ...
  n.append("build_id", "f90f215e48bf413c394ddaaa3ef2c4366eb69b12"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
