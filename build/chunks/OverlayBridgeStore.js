...
function eM(e) {
  ...
  n.append("build_id", "ee7d43fc827a3f943d31fefdf07c8b5dc287a6e2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
