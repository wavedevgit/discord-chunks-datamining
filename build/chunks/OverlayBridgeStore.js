...
function ej(e) {
  ...
  n.append("build_id", "f586718c76eb6f42f6f8666cf5c0844a334bbd40"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
