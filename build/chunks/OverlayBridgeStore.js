...
function ej(e) {
  ...
  n.append("build_id", "c8a30032aecabe13f9b4dc680fe22992e719a46a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
