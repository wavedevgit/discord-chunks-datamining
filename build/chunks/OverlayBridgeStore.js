...
function ek(e) {
  ...
  n.append("build_id", "e4ae5fde0ef8d3a55667328842dae6f2254581e4"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
