...
function eM(e) {
  ...
  n.append("build_id", "843551c3a576fb6ce48cd37907cc13a372d0027e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
