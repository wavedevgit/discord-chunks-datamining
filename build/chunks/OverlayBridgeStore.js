...
function eM(e) {
  ...
  n.append("build_id", "a9d1552e72cade435295ad3a3a02de995c54b03d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
