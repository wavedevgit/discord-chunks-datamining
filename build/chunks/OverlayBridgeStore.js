...
function eM(e) {
  ...
  n.append("build_id", "48b3bbbbc040c14a155011a87f921a874170b6d8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
