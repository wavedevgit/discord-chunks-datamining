...
function ej(e) {
  ...
  n.append("build_id", "02e1050a4ffd4fcad56792d21ef32811ae85b7ce"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
