...
function ek(e) {
  ...
  n.append("build_id", "893e0183d3afeada800362ffca9bfcf01938e231"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
