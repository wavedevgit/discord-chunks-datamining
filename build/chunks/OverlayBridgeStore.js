...
function eM(e) {
  ...
  n.append("build_id", "150963e70d2ef8daebc088d1939a49418ababb15"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
