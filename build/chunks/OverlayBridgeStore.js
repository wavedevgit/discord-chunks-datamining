...
function ek(e) {
  ...
  n.append("build_id", "8974993198b5c5f096cbee44151f45d1a18bbd5e"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
