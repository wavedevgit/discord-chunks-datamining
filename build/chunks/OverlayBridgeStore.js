...
function ej(e) {
  ...
  n.append("build_id", "b21f605eede32f9927d7929dba2352d755e94e6e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
