...
function ej(e) {
  ...
  n.append("build_id", "b7505285d52a5a9b7be9fb37f5255f794ff0b3d1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
