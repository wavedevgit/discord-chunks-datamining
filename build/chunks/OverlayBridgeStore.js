...
function ej(e) {
  ...
  n.append("build_id", "68c1280b4ac8ea799a3cc1b1999ad334e5476341"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
