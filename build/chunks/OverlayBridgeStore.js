...
function ek(e) {
  ...
  n.append("build_id", "3108c14153418295751a0845ce743d98e4833f4f"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
