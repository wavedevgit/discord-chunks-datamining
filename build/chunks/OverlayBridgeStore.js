...
function ek(e) {
  ...
  n.append("build_id", "d7647aedb94aa6354454dfafb306e7847454f7a0"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
