...
function ej(e) {
  ...
  n.append("build_id", "d0fbba3d517dc6186aa3f8d6b32176be3b2d4fea"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
