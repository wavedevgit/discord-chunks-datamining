...
function eM(e) {
  ...
  n.append("build_id", "c064271a526c94533c94d9fab6d329566670a32f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
