...
function eM(e) {
  ...
  n.append("build_id", "9895339b605480157d6806d717b9b7a80e875b80"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
