...
function ek(e) {
  ...
  n.append("build_id", "616091773a2cde6bcb7d9f658106463ca3b3cb01"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
