...
function ej(e) {
  ...
  n.append("build_id", "853149cad4812a508ff8c6d5d6d08758ac77946e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
