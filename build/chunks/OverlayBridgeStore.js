...
function ek(e) {
  ...
  n.append("build_id", "2403356b4b32f593bcc070130b9d0ff44919390b"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
