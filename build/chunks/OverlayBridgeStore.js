...
function ek(e) {
  ...
  n.append("build_id", "09e3d859907505175d27bc0116467222f58865ba"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
