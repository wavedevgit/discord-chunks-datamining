...
function eM(e) {
  ...
  n.append("build_id", "f8738018563b5341b992d064514d00517bfe364f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
