...
function eM(e) {
  ...
  n.append("build_id", "c502ef646e88860cff1b0d19b6b192285cd34428"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
