...
function eM(e) {
  ...
  n.append("build_id", "8718bdb24c061dc00988376d37683ba8c88750a6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
