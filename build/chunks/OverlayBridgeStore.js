...
function ej(e) {
  ...
  n.append("build_id", "dbcb6459f8ac92a8f871b366bbd86d6193a8796c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
