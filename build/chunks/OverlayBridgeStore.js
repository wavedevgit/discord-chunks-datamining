...
function ek(e) {
  ...
  n.append("build_id", "110cc84e65dae205852d0d12130c6a5a7eeceb42"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
