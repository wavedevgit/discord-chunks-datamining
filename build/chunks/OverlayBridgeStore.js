...
function ej(e) {
  ...
  n.append("build_id", "8aab42981cf915d2e1e1a0d4f44b1f15aa31617b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
