...
function ek(e) {
  ...
  n.append("build_id", "223dab829d5e66f871466d20b08ac02c8e9565f2"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
