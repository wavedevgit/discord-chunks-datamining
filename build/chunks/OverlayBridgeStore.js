...
function ej(e) {
  ...
  n.append("build_id", "c3aeb532c38a0eb389c98808052cddc20c5fb219"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
