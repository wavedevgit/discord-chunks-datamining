...
function ej(e) {
  ...
  n.append("build_id", "a632b40429daaa14a53dddf9657790583db86d59"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
