...
function ej(e) {
  ...
  n.append("build_id", "03a9ff8a856e1b13db6889ec1a619bcf3e437322"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
