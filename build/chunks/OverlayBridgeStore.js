...
function ej(e) {
  ...
  n.append("build_id", "88f4cf72852ac5085a8a4d8a682a11b5d5e3d235"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
