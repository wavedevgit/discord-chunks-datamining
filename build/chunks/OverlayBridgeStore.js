...
function eM(e) {
  ...
  n.append("build_id", "119f263bd765a67babaad4f27e21a802fee9c6cf"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
