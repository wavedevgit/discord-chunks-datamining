...
function eM(e) {
  ...
  n.append("build_id", "ed71fe77e44dba30569895947659267dac5bd7ff"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
