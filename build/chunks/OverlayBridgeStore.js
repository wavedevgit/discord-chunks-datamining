...
function ej(e) {
  ...
  n.append("build_id", "a8db4d535fe165f3a7559534b5df507854b1636d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
