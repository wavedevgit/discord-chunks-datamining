...
function ej(e) {
  ...
  n.append("build_id", "41ca090c711fb2763091ca1e7dfe1152dfa302ec"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
