...
function ek(e) {
  ...
  n.append("build_id", "ff9dacb5d053b8d597a4f2be270dcdedcb59f83b"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
