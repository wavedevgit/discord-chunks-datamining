...
function eM(e) {
  ...
  n.append("build_id", "3b1867787be537376accdeb425d1d27d870ef278"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
