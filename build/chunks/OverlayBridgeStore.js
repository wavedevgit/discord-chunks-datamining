...
function eM(e) {
  ...
  n.append("build_id", "b59bdd942b71eda3b444be528ba862182eb1e731"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
