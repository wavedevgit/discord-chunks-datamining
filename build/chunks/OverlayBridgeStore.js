...
function ej(e) {
  ...
  n.append("build_id", "2ba74f2bcedec66d8fe64b865b686bd289329d6f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
