...
function ej(e) {
  ...
  n.append("build_id", "70d44c00d3b7375924f2a983337fc42bc1acf408"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
