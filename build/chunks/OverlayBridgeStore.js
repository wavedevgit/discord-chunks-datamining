...
function ej(e) {
  ...
  n.append("build_id", "dce70ecd53b3ef904507918aad598fa4f19fb126"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
