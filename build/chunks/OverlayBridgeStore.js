...
function ek(e) {
  ...
  n.append("build_id", "e0febf1f93630b16020dd59379ee33a6edf140c8"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
