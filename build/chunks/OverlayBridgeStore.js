...
function ek(e) {
  ...
  n.append("build_id", "158227c235676d73e353b42024306212e6c47f51"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
