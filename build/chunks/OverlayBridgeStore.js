...
function ej(e) {
  ...
  n.append("build_id", "a7d55529e872df3381d01fb85d8fd784bcf591da"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
