...
function ek(e) {
  ...
  n.append("build_id", "4f870d0d4214edcf8247395d1669c472b6096072"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
