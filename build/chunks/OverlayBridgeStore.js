...
function ej(e) {
  ...
  n.append("build_id", "2a9e7e1adc1c1b3665e400acdea005eec6e49e3d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
