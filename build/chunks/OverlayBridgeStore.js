...
function ej(e) {
  ...
  n.append("build_id", "ac313ef8bdda1c350037a3b5efee75ce6cfbf54b"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
