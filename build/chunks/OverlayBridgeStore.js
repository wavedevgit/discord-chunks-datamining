...
function ej(e) {
  ...
  n.append("build_id", "8ea91a3e994729c3e15b0cb676fcb2d69710fd7d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
