...
function ej(e) {
  ...
  n.append("build_id", "d6ea0916d241d343d414b2177d6c99744e4000f1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
