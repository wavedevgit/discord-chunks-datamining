...
function eM(e) {
  ...
  n.append("build_id", "24ed087a5fd0bc4c567192f6435381379ef908c7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
