...
function ej(e) {
  ...
  n.append("build_id", "22cd28a8de8624cdaf9356839df2eed73b73c4b6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
