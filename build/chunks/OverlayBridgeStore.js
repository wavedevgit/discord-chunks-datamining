...
function ej(e) {
  ...
  n.append("build_id", "bade034605a1dae8a2876d6463f637a4348845bb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
