...
function eM(e) {
  ...
  n.append("build_id", "240382d1e4ab3b80f0b122a2f34b7a708ecb0dd3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
