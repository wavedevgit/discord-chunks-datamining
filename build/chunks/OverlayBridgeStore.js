...
function ej(e) {
  ...
  n.append("build_id", "51163552cdec8ce447aeec2e7d4b8b116026d55d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
