...
function ej(e) {
  ...
  n.append("build_id", "fb308ef8cda5bc3ddcdeeb3897286f6223376ae0"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
