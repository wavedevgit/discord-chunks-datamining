...
function ej(e) {
  ...
  n.append("build_id", "fa5d4dbd96585483dc8d93160d1f53f2f68a0751"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
