...
function ek(e) {
  ...
  n.append("build_id", "995686e208beabd26effda1cc696657deacafd94"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
