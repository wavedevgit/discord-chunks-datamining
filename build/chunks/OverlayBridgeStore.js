...
function eM(e) {
  ...
  n.append("build_id", "0cb55d78ffe2be506661a12bc209797fb4669d9f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
