...
function eM(e) {
  ...
  n.append("build_id", "73c45804bd06736e609020822b108596bec3eb8c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
