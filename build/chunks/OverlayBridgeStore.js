...
function eM(e) {
  ...
  n.append("build_id", "0323992e6ad8a0b1eb75458858d46d1e9cc7108c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
