...
function ej(e) {
  ...
  n.append("build_id", "ad31756f0e53eb48520d8a2be8cd01b53627eddd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
