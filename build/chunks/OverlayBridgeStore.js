...
function ek(e) {
  ...
  n.append("build_id", "400ae2f7a96a691fa19bccaf9a17447a38b55aba"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
