...
function ej(e) {
  ...
  n.append("build_id", "fee89294d3304efcc20df54b7fabed77be5c8345"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
