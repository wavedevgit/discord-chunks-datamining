...
function eM(e) {
  ...
  n.append("build_id", "d7a6ec77dc2bf53afd313ea61d718aa9b45860fb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
