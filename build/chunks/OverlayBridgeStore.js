...
function ej(e) {
  ...
  n.append("build_id", "78edd575c6fab2f797a873850a2977519e6d3ca1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
