...
function ej(e) {
  ...
  n.append("build_id", "4a1ce920e22db4870e6b684b8164da756fefe15e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
