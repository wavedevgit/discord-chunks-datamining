...
function ej(e) {
  ...
  n.append("build_id", "cdef7f6081f17004f80661922c609ad5f06e987c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
