...
function ek(e) {
  ...
  n.append("build_id", "e7d9e3bceae4d511bc1b66686104e0b4d962df87"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
