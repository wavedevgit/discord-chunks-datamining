...
function eM(e) {
  ...
  n.append("build_id", "dd9a6ce45c8bf616ab1767f5e6e2e15b72726261"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
