...
function ej(e) {
  ...
  n.append("build_id", "91b6feebcc8e0b096bae8776656f8a1df6fcf83c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
