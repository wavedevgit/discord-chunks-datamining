...
function ej(e) {
  ...
  n.append("build_id", "9d2f7fa4610664914ed87831ba8dc1d9f38372c4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
