...
function eM(e) {
  ...
  n.append("build_id", "394732d3eb8d417cc51572b899a0990cf6ddb601"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
