...
function eM(e) {
  ...
  n.append("build_id", "2e33d76cdf30cbef00ce9009113257dc18183fe9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
