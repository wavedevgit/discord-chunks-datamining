...
function ej(e) {
  ...
  n.append("build_id", "9ef5b5ba61ee9d357191b863f6cae8a230c7522d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
