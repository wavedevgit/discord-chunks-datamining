...
function eM(e) {
  ...
  n.append("build_id", "99e34230971b246ea128b6e184237b6b7aeeead5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
