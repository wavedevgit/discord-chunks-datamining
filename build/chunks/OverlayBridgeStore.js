...
function eM(e) {
  ...
  n.append("build_id", "43f9b485280bb85ed6f636df001cf0e0a1e5c858"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
