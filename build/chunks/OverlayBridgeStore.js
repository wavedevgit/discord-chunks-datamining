...
function ek(e) {
  ...
  n.append("build_id", "4d3c3485db631c28007277733bba1736ce71bcdc"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
