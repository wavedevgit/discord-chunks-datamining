...
function ej(e) {
  ...
  n.append("build_id", "c804270a10f590b036df2d9246c836601b6b5e5e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
