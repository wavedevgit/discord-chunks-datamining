...
function eM(e) {
  ...
  n.append("build_id", "1fd157a952655ef8beaebb052365ea0d67068597"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
