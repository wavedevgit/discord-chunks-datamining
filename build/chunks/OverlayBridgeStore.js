...
function eM(e) {
  ...
  n.append("build_id", "6d29cfc1afc99c0bcd674b6a82e4dd12753bd3ce"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
