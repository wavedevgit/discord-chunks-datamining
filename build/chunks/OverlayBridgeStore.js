...
function eM(e) {
  ...
  n.append("build_id", "d0a5ad14404cf7cdafcb88bf09561eb542bea8d7"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
