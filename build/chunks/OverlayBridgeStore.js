...
function ej(e) {
  ...
  n.append("build_id", "d328892a95097f03072cbde2fae1e55904ccf17c"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
