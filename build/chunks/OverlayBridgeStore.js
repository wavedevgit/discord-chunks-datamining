...
function ej(e) {
  ...
  n.append("build_id", "6ddf61479a39445898aad2a2c23b781c2533c51b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
