...
function eM(e) {
  ...
  n.append("build_id", "ffe9ee1a02ff440e7f740a19cfa140273e5f8ff0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
