...
function ej(e) {
  ...
  n.append("build_id", "80d6ce72ec56280cd12453764d69803909efa1ff"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
