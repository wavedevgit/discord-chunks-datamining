...
function ej(e) {
  ...
  n.append("build_id", "54974f68f80887a7e0fff68741a1bdc59f34ad6d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
