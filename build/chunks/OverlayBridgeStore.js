...
function ej(e) {
  ...
  n.append("build_id", "f8bbd84545380d292acfb4fa5e8dfa74733e95a8"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
