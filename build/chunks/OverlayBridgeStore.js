...
function ej(e) {
  ...
  n.append("build_id", "d08b5f4401d113facefa202f353718d6de9facd2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
