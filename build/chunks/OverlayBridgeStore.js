...
function ej(e) {
  ...
  n.append("build_id", "f040cd70956892ba6cfa86586ab31c2212fc7c60"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
