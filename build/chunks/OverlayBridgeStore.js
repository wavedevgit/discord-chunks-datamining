...
function ej(e) {
  ...
  n.append("build_id", "2033d4ad810cc42cddca754f7d1378b69ff165c9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
