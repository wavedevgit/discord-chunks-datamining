...
function ej(e) {
  ...
  n.append("build_id", "506cf7780036c4ffd7816ab235d2d1123f8fe672"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
