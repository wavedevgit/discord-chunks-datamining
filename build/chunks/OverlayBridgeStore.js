...
function ej(e) {
  ...
  n.append("build_id", "e9c80e4eb128cdcf170d1e948d1b62fdcee5e1bb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
