...
function ej(e) {
  ...
  n.append("build_id", "298182ab0f254c11ab77c967937c06659f52c713"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
