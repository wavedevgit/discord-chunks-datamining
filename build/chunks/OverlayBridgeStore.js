...
function ej(e) {
  ...
  n.append("build_id", "0982abd1f907fb2f891484f0aad5eb96297586ea"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
