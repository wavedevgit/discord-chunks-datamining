...
function eM(e) {
  ...
  n.append("build_id", "2912406b2b4bac798663472ebf2d757e5e59a88a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
