...
function ej(e) {
  ...
  n.append("build_id", "f22176371b14add4d4423d08465e4d3d8fc8b3d0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
