...
function ej(e) {
  ...
  n.append("build_id", "5d2b4e63b7d763d2b2bf2aeab34bf204202278ad"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
