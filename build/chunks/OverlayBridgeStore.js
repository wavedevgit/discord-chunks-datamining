...
function ek(e) {
  ...
  n.append("build_id", "e70a570bb38db2057bb2ce2ea69342ce20557f24"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
