...
function ej(e) {
  ...
  n.append("build_id", "8957c9b3ec879509bea18cb69650c7e274419bdd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
