...
function ej(e) {
  ...
  n.append("build_id", "42fb22f7b28b10b524ae69507319ed5645031afb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
