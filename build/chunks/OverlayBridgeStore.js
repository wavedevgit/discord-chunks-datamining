...
function eM(e) {
  ...
  n.append("build_id", "f4cdd0b80d398d1525c4771c954668eca0b83d13"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
