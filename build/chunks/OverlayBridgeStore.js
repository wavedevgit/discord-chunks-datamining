...
function ek(e) {
  ...
  n.append("build_id", "e9d75cc993661ed600ea0380d62f506e08e989a4"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
