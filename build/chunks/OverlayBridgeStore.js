...
function ek(e) {
  ...
  n.append("build_id", "c37fa078d4a47a8d634a63a70285f6cff04339c8"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
