...
function ej(e) {
  ...
  n.append("build_id", "2df0343d94adda70576d00516c4041dfad2c8939"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
