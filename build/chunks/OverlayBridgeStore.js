...
function ek(e) {
  ...
  n.append("build_id", "3c0813b224af52d9d66651e5824116edafc591e2"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
