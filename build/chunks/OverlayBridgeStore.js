...
function ek(e) {
  ...
  n.append("build_id", "e1db70633bf18a2188611d17cfd2acdba6699ac1"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
