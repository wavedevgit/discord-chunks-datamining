...
function ek(e) {
  ...
  n.append("build_id", "afa857bf824cdc32306e0227dc126278ab0be483"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
