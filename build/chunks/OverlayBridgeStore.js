...
function ej(e) {
  ...
  n.append("build_id", "d037623e26a6ecb694afc257ece9cf7c00a03ad4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
