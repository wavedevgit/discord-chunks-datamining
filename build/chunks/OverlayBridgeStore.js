...
function ej(e) {
  ...
  n.append("build_id", "abcfe8571143db061404f316f9b4796ac17c9800"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
