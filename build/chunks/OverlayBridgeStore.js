...
function ej(e) {
  ...
  n.append("build_id", "26dfcf060e7e0bc4a2672cfe3e825ca88d1aa57a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
