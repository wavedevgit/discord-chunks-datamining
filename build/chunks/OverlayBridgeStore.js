...
function ej(e) {
  ...
  n.append("build_id", "e4958029630d3f140befdf3cc4eedb70109a3063"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
