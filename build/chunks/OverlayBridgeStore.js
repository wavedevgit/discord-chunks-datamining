...
function ek(e) {
  ...
  n.append("build_id", "e7198921fe1f1ab7509492591187d2e24c5d9daf"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
