...
function eM(e) {
  ...
  n.append("build_id", "326056fcd16460a3d072c767b2c050a52faf301a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
