...
function eM(e) {
  ...
  n.append("build_id", "6460722111c0c895bdd57729630aa5403950e671"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
