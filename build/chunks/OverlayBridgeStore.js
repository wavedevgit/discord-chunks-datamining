...
function eM(e) {
  ...
  n.append("build_id", "964f2ebf5ea563ffb8f521fa36ab88f9368d8bff"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
