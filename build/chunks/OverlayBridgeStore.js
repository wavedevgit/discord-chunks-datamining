...
function eM(e) {
  ...
  n.append("build_id", "7dbec523b65111dab799241305a097a5fc7a9bcc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
