...
function ej(e) {
  ...
  n.append("build_id", "1b307816e8135f665db4183fed3c0654bd76dfae"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
