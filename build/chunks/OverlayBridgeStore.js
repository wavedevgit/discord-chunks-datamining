...
function ej(e) {
  ...
  n.append("build_id", "1a661a7b03fa34fb5cd8ec4f3dbdc8969944b111"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
