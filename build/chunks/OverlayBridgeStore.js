...
function ej(e) {
  ...
  n.append("build_id", "24be05cf5816a090d6acbf3931d1879d831a778f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
