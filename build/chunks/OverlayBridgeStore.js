...
function eM(e) {
  ...
  n.append("build_id", "a730e721054eb4629b2134745ccd61d1e5d2b9d3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
