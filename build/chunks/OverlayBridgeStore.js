...
function eM(e) {
  ...
  n.append("build_id", "ae067ef85ec8489bd32b9c20431e88dea64e871c"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
