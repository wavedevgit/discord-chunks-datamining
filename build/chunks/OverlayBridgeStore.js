...
function ej(e) {
  ...
  n.append("build_id", "101548d0c014f5b9bcecbe0d56cb257193891a41"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
