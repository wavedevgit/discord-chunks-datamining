...
function ek(e) {
  ...
  n.append("build_id", "1aa9b3517652c2646cb521279e709dc3ba2e70d6"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
