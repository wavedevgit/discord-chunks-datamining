...
function ek(e) {
  ...
  n.append("build_id", "4237c237719edad701114eff3f4610cc1ec2231c"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
