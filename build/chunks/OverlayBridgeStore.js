...
function eM(e) {
  ...
  n.append("build_id", "32c00f3107e0fd8da96a43c02b9e261131fa45d7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
