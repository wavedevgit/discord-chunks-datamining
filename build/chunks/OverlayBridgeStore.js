...
function ek(e) {
  ...
  n.append("build_id", "e7ee0efdb4659bcc980666da65dfc715528bbac2"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
