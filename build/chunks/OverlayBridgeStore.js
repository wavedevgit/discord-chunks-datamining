...
function ek(e) {
  ...
  n.append("build_id", "9c4e8d4b9cf35b93509b8da4cd5990928cc8ac88"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
