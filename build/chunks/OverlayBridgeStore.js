...
function ej(e) {
  ...
  n.append("build_id", "cf894c078969481e3b67108f609b6b0679b7d133"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
