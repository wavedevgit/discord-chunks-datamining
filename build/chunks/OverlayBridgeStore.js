...
function ej(e) {
  ...
  n.append("build_id", "02db1f01047afac38033ad03a8455ff7dda6127a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
