...
function eM(e) {
  ...
  n.append("build_id", "8e6ec28683e0c9276f1c719c15f6ceb3285487fd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
