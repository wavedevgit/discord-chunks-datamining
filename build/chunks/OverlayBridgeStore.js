...
function ej(e) {
  ...
  n.append("build_id", "2abc40124383dcdd45b9812248f00643b28db4bc"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
