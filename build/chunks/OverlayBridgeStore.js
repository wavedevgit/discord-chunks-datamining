...
function eM(e) {
  ...
  n.append("build_id", "854ebcffd2378c4181e84dbbab362890dc1de82b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
