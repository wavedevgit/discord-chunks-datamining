...
function eM(e) {
  ...
  n.append("build_id", "f7acc0aa8b3acf022e8e809eb41a6c01bf519d14"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
