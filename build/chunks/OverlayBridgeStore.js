...
function ej(e) {
  ...
  n.append("build_id", "4a41102b99e899248215b3b07caec026a54ed8fe"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
