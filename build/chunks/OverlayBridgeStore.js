...
function ej(e) {
  ...
  n.append("build_id", "4de2e842c525d47ed2452bd603cf2d89a4e52f7a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
