...
function ek(e) {
  ...
  n.append("build_id", "0d50945cd60c513bf27f4d96489cfd71f2ba5ebd"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
