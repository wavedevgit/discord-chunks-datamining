...
function ek(e) {
  ...
  n.append("build_id", "c3a93d84447b3aae07bdabac9f5fe8cc674fbbcb"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
