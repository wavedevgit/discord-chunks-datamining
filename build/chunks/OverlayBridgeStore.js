...
function ej(e) {
  ...
  n.append("build_id", "f675a3803f0b83878c8df06ed434a42585f2162b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
