...
function ej(e) {
  ...
  n.append("build_id", "b561338efa96ab071c3458af6cf1d712c86060d8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
