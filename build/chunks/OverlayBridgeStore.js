...
function ej(e) {
  ...
  n.append("build_id", "a8ac611fa0d148015a46eef0b9eeb4e9920e8c55"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
