...
function ej(e) {
  ...
  n.append("build_id", "c487b2aaac8653c76c12655b8cd03c697c99e89c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
