...
function ek(e) {
  ...
  n.append("build_id", "a87ad8c3db26c0601d67e14003e525c734a392ac"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
