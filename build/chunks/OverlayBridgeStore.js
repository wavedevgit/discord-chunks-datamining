...
function eM(e) {
  ...
  n.append("build_id", "726414163f8e8f27b1853ec256b2aa2783a9b25e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
