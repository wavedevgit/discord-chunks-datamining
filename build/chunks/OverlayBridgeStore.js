...
function ej(e) {
  ...
  n.append("build_id", "d5c3e3fba2a675d3b36c676632670e460513e452"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
