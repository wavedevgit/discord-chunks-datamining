...
function ej(e) {
  ...
  n.append("build_id", "ba76468271b29596dab51971d6a80d1a97441019"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
