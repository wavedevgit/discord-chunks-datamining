...
function ek(e) {
  ...
  n.append("build_id", "473751a178a07d11b218484867757b25a405724e"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
