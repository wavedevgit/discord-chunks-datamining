...
function ej(e) {
  ...
  n.append("build_id", "d94f866cd5c605fecceaadc727cd8fe0ace94661"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
