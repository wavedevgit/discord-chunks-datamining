...
function ek(e) {
  ...
  n.append("build_id", "b7d7b65869b911591cd3f203a34453db3e6679a4"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
