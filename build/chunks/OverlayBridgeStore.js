...
function eM(e) {
  ...
  n.append("build_id", "0210b9044926cfd2be20d5c3b20b15648160db63"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
