...
function ej(e) {
  ...
  n.append("build_id", "0c4dcef60649ec821261b2a9be5569ffda758ccc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
