...
function ek(e) {
  ...
  n.append("build_id", "145d0fa441eb4dc8412587102b42e8b223adc075"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
