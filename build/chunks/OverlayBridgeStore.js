...
function eM(e) {
  ...
  n.append("build_id", "dfc155c20b05b81ff44174553028a3ba1db519a5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
