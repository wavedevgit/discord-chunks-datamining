...
function ej(e) {
  ...
  n.append("build_id", "85df54d1bce52ac7bc63ebc7399524c4fe2aeeaa"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
