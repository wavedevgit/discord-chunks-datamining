...
function ej(e) {
  ...
  n.append("build_id", "83087f90dcef1f0501cc05c84907f87a8ec25a87"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
