...
function eM(e) {
  ...
  n.append("build_id", "0daf7db5e7adaad7f4f160bddc0df0bcb21289ea"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
