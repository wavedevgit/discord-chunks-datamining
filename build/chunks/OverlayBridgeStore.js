...
function eM(e) {
  ...
  n.append("build_id", "e3eca3144a08dc39468f098e60bb7a2f652cf61d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
