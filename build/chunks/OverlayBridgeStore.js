...
function ek(e) {
  ...
  n.append("build_id", "63dc0a4ab7c1592228b36bcc8d0c7a8d2d8d395a"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
