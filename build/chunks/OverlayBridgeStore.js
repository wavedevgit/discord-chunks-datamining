...
function ej(e) {
  ...
  n.append("build_id", "35d254a41a1393de608fb9b9e168a4b867069bdc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
