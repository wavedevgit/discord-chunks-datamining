...
function ek(e) {
  ...
  n.append("build_id", "7fb4f32ddd6a86074c727baa45936edcd811422a"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
