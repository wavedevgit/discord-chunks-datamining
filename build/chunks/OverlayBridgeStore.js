...
function ej(e) {
  ...
  n.append("build_id", "862196c63d834c9e7bc81a53774a1cd3f55f0147"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
