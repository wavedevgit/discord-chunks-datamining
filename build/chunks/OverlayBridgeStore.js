...
function eM(e) {
  ...
  n.append("build_id", "daffc5e38d3dcd48ab3beefe65ea495b6910e5b8"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
