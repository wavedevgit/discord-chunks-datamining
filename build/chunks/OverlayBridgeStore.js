...
function eM(e) {
  ...
  n.append("build_id", "532c3aea08bd9a0d19cc03ead3bdb93d4fde9fd7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
