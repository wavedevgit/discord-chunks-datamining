...
function eM(e) {
  ...
  n.append("build_id", "a0b6a21910c732b4f3b23fe187bbb23d8fb07081"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
