...
function ej(e) {
  ...
  n.append("build_id", "879ef052c86a9c7a83b572923200058f8d842a4f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
