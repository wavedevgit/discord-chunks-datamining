...
function ej(e) {
  ...
  n.append("build_id", "b07d2e825425cee21adc2fb0fabe7294a0655f98"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
