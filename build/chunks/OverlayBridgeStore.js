...
function ek(e) {
  ...
  n.append("build_id", "64c2c7c57efa1877a9e4a19358c24e08d510fd99"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
