...
function ek(e) {
  ...
  n.append("build_id", "1d16539760b179409f31422a388dcfa226bc2f2d"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
