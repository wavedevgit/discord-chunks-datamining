...
function eM(e) {
  ...
  n.append("build_id", "2c571c5da4eea25822edda12c949a75cecebf7c5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
