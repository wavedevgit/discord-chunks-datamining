...
function ej(e) {
  ...
  n.append("build_id", "98e7a9d9d98ac2cadd4645be7b9d1e7fa31db70f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
