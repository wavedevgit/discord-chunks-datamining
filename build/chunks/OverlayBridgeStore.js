...
function eM(e) {
  ...
  n.append("build_id", "d7f063d1c3936bd2773670817a9d2a641465982c"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
