...
function eM(e) {
  ...
  n.append("build_id", "705e422b1f5682184700f2029e1d292b67bd02d4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
