...
function ej(e) {
  ...
  n.append("build_id", "9e5392072f0652d2bc1f0ce85d4bcee80827dfbb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
