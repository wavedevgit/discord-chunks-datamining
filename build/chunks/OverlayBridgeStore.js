...
function ej(e) {
  ...
  n.append("build_id", "c08798de5f9b5775b3c162ec2ab71191bdf7f5a0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
