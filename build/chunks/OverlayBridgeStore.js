...
function ej(e) {
  ...
  n.append("build_id", "6515948dedd45060ba5c8cffac65aa0ba97475f0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
