...
function ej(e) {
  ...
  n.append("build_id", "83c3e6f1e6c081dc042571f6adf3c6d306f57d13"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
