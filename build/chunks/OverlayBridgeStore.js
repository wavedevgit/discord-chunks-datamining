...
function ej(e) {
  ...
  n.append("build_id", "58c9aa4be5056a33f9ecee5b228db2e2593342fc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
