...
function eM(e) {
  ...
  n.append("build_id", "0590f8dd213aa14b508da02c3311388906113c5c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
