...
function ek(e) {
  ...
  n.append("build_id", "e089d68f581938b68195baf788d1a22b87213db0"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
