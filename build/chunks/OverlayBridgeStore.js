...
function ej(e) {
  ...
  n.append("build_id", "8f3e837f4399008370e759aabfe44c89700d85c8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
