...
function ek(e) {
  ...
  n.append("build_id", "8459a8859e8ffdfc4f4f782bc24c97fc7c39c616"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
