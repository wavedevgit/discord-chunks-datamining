...
function ej(e) {
  ...
  n.append("build_id", "d005dcbbbd2571f7dfd1e9029a6b18d7e564d1d5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
