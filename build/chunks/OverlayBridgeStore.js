...
function ej(e) {
  ...
  n.append("build_id", "d3aef3061850940e651547bbf2136ed450d65c54"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
