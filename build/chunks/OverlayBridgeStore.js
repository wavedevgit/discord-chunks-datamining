...
function ek(e) {
  ...
  n.append("build_id", "f45d8eeb15b920be59ce24e11d608055b4fc9820"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
