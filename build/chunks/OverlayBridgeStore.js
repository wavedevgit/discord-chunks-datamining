...
function ej(e) {
  ...
  n.append("build_id", "a411598d9dfa7a3afcf7ff91eed189289f6840a9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
