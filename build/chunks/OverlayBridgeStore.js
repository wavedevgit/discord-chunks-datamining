...
function ek(e) {
  ...
  n.append("build_id", "f7350702be44b95ee691424cbf7a0a691054b946"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
