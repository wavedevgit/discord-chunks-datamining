...
function ek(e) {
  ...
  n.append("build_id", "76ae36ab02742f97960483096748ba1a34779f44"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
