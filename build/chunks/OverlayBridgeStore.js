...
function ej(e) {
  ...
  n.append("build_id", "7135ddcf2ac78092ed8dbcfb8e1540a90dbaf19b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
