...
function ek(e) {
  ...
  n.append("build_id", "72fae37ffd4246b9b672cba92c4a0999f4e4ab78"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
