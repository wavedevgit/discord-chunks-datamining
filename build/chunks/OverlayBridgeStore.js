...
function ej(e) {
  ...
  n.append("build_id", "4862a09468ff0019aabbcae59ab6bc39a547fab1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
