...
function ej(e) {
  ...
  n.append("build_id", "be64a94b739015f78011b0734160a405b3f129d4"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
