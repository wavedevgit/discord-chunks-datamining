...
function ek(e) {
  ...
  n.append("build_id", "441a4ca8256f52e3a063eba52e1fae40f2682174"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
