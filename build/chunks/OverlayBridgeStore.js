...
function ek(e) {
  ...
  n.append("build_id", "f80c6810794e078c3f478a7d7824d5f95a6b4115"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
