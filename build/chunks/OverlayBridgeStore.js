...
function ej(e) {
  ...
  n.append("build_id", "dc065c0017c433fbfcbdbf6348357583818192a1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
