...
function ej(e) {
  ...
  n.append("build_id", "7983d567c1b96dd34ce1ed8fedb847c036c1aa48"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
