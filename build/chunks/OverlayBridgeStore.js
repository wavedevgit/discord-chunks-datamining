...
function ej(e) {
  ...
  n.append("build_id", "300232adabe5cb66409c79678330282b8c01b4e6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
