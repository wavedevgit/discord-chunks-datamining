...
function ek(e) {
  ...
  n.append("build_id", "c7ef36a5de69fbab84272a5d765f37c10e1db7e6"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
