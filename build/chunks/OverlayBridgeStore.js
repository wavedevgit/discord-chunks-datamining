...
function eM(e) {
  ...
  n.append("build_id", "0efb423bc56108d756029763d06051736ee4ac24"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
