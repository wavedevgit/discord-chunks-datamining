...
function ej(e) {
  ...
  n.append("build_id", "30096595d9ef68c20edaa7be879dd7343a04dae7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
