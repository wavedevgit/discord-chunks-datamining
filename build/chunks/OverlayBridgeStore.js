...
function ek(e) {
  ...
  n.append("build_id", "db4ad56fb92c8734fc2d70968b3e1986643c9ed7"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
