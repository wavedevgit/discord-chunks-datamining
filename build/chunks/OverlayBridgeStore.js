...
function eM(e) {
  ...
  n.append("build_id", "da95134f2bd5df1f35bdb62747dd03c77e3b0648"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
