...
function ek(e) {
  ...
  n.append("build_id", "505c10b68d2acfa4fc75577e0f20bd0c3d47591b"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
