...
function ej(e) {
  ...
  n.append("build_id", "08711a3220b837836f5deeb1bcf077d54adeee4b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
