...
function ek(e) {
  ...
  n.append("build_id", "ede1b77cf210340977fbadf7646a0ff3fc1ccdea"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
