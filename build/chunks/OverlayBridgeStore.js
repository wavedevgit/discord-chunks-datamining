...
function ej(e) {
  ...
  n.append("build_id", "7ce7167de2f0ac951b2b76146b2df72ae54708d4"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
