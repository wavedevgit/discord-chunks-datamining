...
function ek(e) {
  ...
  n.append("build_id", "7880bb3e68f146c28cdc485f134f6cfa98352ef0"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
