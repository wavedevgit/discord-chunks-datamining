...
function ej(e) {
  ...
  n.append("build_id", "b8ac83c6ea8bdf25f05024658cd6c51990b6d204"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
