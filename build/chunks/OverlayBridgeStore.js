...
function ej(e) {
  ...
  n.append("build_id", "d7339c2303cc43e932cb444e7d5a047af3e91adb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
