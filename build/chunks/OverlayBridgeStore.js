...
function ej(e) {
  ...
  n.append("build_id", "dd44c264f412a1ea5e12c75f09823f57767fb43c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
