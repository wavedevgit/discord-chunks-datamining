...
function ek(e) {
  ...
  n.append("build_id", "eac408d635489fd82085bd0a382ca605dd4f7b87"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
