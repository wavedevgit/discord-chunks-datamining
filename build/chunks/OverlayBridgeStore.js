...
function ej(e) {
  ...
  n.append("build_id", "69c11e9dcfd1dcbb95808bd0fc93ded83c606c4e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
