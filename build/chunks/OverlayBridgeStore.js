...
function ej(e) {
  ...
  n.append("build_id", "5dc3f7d034b9ab80327e12dae403a5fbbc05ee07"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
