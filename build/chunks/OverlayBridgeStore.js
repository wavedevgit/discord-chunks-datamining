...
function ej(e) {
  ...
  n.append("build_id", "9bd822539a5d2373c5ca71f71a76692d0ab6bc36"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
