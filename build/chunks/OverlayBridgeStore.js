...
function eM(e) {
  ...
  n.append("build_id", "957ecab1531ea2f46013ca5a0cbfb0490d79701a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
