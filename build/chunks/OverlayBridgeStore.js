...
function eM(e) {
  ...
  n.append("build_id", "99ca10f9288b393ecad766a573c5a7605e048e75"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
