...
function eM(e) {
  ...
  n.append("build_id", "7fad26c8d2b0a7693e436514430855aec9057272"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
