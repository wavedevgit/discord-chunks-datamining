...
function ej(e) {
  ...
  n.append("build_id", "8dc29719e3b042c9145cd367c84b2de2c72deb6f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
