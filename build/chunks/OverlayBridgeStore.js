...
function ej(e) {
  ...
  n.append("build_id", "046ceb1b8ebdef0126b39d7e0cc0753c1f38aed6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
