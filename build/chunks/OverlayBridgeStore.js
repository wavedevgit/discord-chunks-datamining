...
function eM(e) {
  ...
  n.append("build_id", "8577077f4e2e8547034246b174b9bea4a3be7e83"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
