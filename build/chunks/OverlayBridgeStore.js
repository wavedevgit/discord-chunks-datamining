...
function ej(e) {
  ...
  n.append("build_id", "507dc4d2955993a4c499a60057e1a8f1ac36c948"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
