...
function ej(e) {
  ...
  n.append("build_id", "be04b2b04d19002741a0fa52a9c1efaffb08fca5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
