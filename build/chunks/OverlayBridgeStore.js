...
function ej(e) {
  ...
  n.append("build_id", "80dde82f80e15ef794335587b5629601934ec206"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
