...
function eM(e) {
  ...
  n.append("build_id", "24acf6562daede06353def84f57e8e8d9f4b0d51"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
