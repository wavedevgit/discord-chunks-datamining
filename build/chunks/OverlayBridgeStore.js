...
function ej(e) {
  ...
  n.append("build_id", "701a4ceb5323f1f9412934e24b47482af878d500"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
