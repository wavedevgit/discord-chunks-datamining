...
function eM(e) {
  ...
  n.append("build_id", "e079e9467d3d935b5410d067b2011d1578db38cc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
