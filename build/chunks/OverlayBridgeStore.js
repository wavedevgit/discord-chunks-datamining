...
function ek(e) {
  ...
  n.append("build_id", "52b121a4abbf9f5f89dc16fb416a545cb93380df"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
