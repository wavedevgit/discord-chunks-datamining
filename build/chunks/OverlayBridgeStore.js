...
function ek(e) {
  ...
  n.append("build_id", "1a81cde5e0a9d21743deb5a4b07ac22930fbec70"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
