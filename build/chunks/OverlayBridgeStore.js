...
function ej(e) {
  ...
  n.append("build_id", "b1195381ab95114b085f68f5e13a410ee7b7eae8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
