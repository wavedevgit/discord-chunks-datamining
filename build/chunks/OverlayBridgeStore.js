...
function ej(e) {
  ...
  n.append("build_id", "64883c3ef33638887959b0570a4038437932a414"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
