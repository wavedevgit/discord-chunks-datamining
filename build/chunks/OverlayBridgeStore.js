...
function ek(e) {
  ...
  n.append("build_id", "d013322ec4fe6745dae8d866cbf84393622fc13b"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
