...
function ek(e) {
  ...
  n.append("build_id", "b4deb2972122b4c8818695f6db99ad01ab6f11c8"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
