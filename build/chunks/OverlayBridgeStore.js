...
function ek(e) {
  ...
  n.append("build_id", "86da2e45daf8b4bcef512b17ad9fe07100fd2d41"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
