...
function ej(e) {
  ...
  n.append("build_id", "2d6425c642b6eef055fa2906aea42afe190217b1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
