...
function ek(e) {
  ...
  n.append("build_id", "fc4743a7cc3587a80d2a426ba00033598a7214c8"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
