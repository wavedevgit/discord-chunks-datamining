...
function ej(e) {
  ...
  n.append("build_id", "ef0fa83feeea28abcb04d2e16417b66d04923b39"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
