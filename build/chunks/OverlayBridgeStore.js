...
function ej(e) {
  ...
  n.append("build_id", "9a0703b0d6f22962c476ee229d05f1965c4a59dc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
