...
function ej(e) {
  ...
  n.append("build_id", "bd9e7a4c0a9db812aa7b5baf0248b19913f0a4bd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
