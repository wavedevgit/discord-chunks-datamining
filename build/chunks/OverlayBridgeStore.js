...
function ej(e) {
  ...
  n.append("build_id", "dc9b5155ff626d52dcf07d9618e25c6944202837"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
