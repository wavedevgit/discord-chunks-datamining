...
function ej(e) {
  ...
  n.append("build_id", "bd214fa0b2d5ed0f3924a4933415c5f45581d36d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
