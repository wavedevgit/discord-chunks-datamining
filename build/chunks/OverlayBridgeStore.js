...
function ej(e) {
  ...
  n.append("build_id", "bf4beea803cfd54fb087a3fdca9bcc66b4ba9f4a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
