...
function ej(e) {
  ...
  n.append("build_id", "9b4ce7906c4ead2b705e2bbeb00f2a797b00725b"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
