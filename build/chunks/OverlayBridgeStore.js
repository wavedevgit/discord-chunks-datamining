...
function ej(e) {
  ...
  n.append("build_id", "b491aeda97d8035803414fbe7becb758e9043243"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
