...
function ek(e) {
  ...
  n.append("build_id", "53d2e7f34618016b65fd8be0fdcb5b8fbed5d6e8"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
