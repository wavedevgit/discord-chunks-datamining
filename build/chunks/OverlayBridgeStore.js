...
function ej(e) {
  ...
  n.append("build_id", "ab64a71c9e1e444b34f1acc317a96961931cfc31"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
