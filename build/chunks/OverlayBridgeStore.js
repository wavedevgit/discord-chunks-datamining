...
function ej(e) {
  ...
  n.append("build_id", "d55668a0d6c15e2072786f09097a9628f56accec"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
