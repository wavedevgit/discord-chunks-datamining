...
function ej(e) {
  ...
  n.append("build_id", "2e4638926ed13bc4520232eeae0ea3b267c1cf20"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
