...
function ej(e) {
  ...
  n.append("build_id", "f02426f75889846f2d280620bf6a52a08789c76e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
