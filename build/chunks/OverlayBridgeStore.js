...
function ek(e) {
  ...
  n.append("build_id", "7c99d570754fabadfadd443342f451bc4d8d2e5e"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
