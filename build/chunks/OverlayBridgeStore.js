...
function ej(e) {
  ...
  n.append("build_id", "2d1f6be21584c2e8a2c6ef5cae162ffd260a5f07"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
