...
function ej(e) {
  ...
  n.append("build_id", "9158b8cf5bfea299c5abe598c79beb378c4fc0ef"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
