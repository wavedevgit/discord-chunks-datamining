...
function eM(e) {
  ...
  n.append("build_id", "3119c47bfa9441e2520302c857fa7d1fefa82d4a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
