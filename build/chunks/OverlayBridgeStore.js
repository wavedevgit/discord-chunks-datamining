...
function eM(e) {
  ...
  n.append("build_id", "65178401905912083a0b2f316c87cd6e949fbecf"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
