...
function eM(e) {
  ...
  n.append("build_id", "e6e04f8242eba0f447860a83144098e520726f2c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
