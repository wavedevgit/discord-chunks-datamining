...
function ej(e) {
  ...
  n.append("build_id", "3643eddb0421d328165199f3a134a1f35e0c83c3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
