...
function eM(e) {
  ...
  n.append("build_id", "86e42b5a827b3428285894243445539e88db00bf"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
