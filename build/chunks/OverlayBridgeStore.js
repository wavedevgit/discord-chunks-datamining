...
function ej(e) {
  ...
  n.append("build_id", "e106bbe470f97584a1cb30b0bdabfa262160a1a6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
