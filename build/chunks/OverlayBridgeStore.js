...
function eM(e) {
  ...
  n.append("build_id", "44c1c0cdbb51ed01394ca2fe5bd1a6ae415ff694"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
