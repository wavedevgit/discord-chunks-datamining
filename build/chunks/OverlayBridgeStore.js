...
function ek(e) {
  ...
  n.append("build_id", "dbc62fee32833516b431b860edfbf31157ec672e"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
