...
function eM(e) {
  ...
  n.append("build_id", "75dca3f7e6f120133ae0f310ef4ad3328df144df"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
