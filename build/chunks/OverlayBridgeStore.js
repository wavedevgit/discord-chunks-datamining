...
function ek(e) {
  ...
  n.append("build_id", "1b3a3455d3acf1cc48a369441d9317ce8e2b5b0f"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
