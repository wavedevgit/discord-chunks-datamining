...
function eM(e) {
  ...
  n.append("build_id", "bbe5548d54f0e2536e4f36157846ba4ef2d659af"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
