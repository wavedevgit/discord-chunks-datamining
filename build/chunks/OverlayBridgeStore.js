...
function eM(e) {
  ...
  n.append("build_id", "c8034b4dc86ab03be2ccd057da1e19fce137f9de"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
