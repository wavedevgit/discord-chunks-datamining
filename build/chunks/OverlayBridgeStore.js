...
function ek(e) {
  ...
  n.append("build_id", "240de53f1deef58244f82071a4b24fbbd6fd3e6e"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
