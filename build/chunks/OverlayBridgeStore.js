...
function eM(e) {
  ...
  n.append("build_id", "fe537c7161d9fe57cb24cbcd856c9b957a1150b0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
