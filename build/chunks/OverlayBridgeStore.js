...
function ej(e) {
  ...
  n.append("build_id", "3953c0bccb202c9bdec88867a70f636841cc36d3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
