...
function ej(e) {
  ...
  n.append("build_id", "23fdc51bd563f71128773e16337d9628fb0fe896"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
