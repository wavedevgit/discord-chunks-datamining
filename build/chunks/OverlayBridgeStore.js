...
function ej(e) {
  ...
  n.append("build_id", "6e36c4034d23dd17eb4fb182a090562ef2cab65e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
