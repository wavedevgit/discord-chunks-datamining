...
function ej(e) {
  ...
  n.append("build_id", "3009d1ba4601a4e6f6f65094a3f11807ef3c361a"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
