...
function ej(e) {
  ...
  n.append("build_id", "166920693bec877ee373dce62e9f0db939333c3a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
