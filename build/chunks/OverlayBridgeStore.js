...
function ej(e) {
  ...
  n.append("build_id", "68e88fe9cdea1e8227695856716ecaaa49c467fb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
