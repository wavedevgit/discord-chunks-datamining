...
function eM(e) {
  ...
  n.append("build_id", "c8d5a39594890f329c6c8405e3b320259065b158"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
