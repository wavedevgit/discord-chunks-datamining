...
function ej(e) {
  ...
  n.append("build_id", "f17906c009f13b1af4595113d3200f59d6be00c3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
