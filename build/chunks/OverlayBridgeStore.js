...
function ej(e) {
  ...
  n.append("build_id", "c9c44023d5420343a2a8d7724169d78b76d64cc4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
