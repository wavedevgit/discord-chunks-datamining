...
function eM(e) {
  ...
  n.append("build_id", "deee738044b814c7a8e0ab114666321e733ff0bf"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
