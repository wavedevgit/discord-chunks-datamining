...
function ej(e) {
  ...
  n.append("build_id", "ac47f59552e5f18ef80514042056568ddd5d3db2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
