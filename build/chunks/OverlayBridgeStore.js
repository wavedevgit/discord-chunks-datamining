...
function ej(e) {
  ...
  n.append("build_id", "f4c355b532b38c0a34829d0482dee9b4f8233804"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
