...
function ej(e) {
  ...
  n.append("build_id", "269e6ff4720129b7b058b159e8d4f81a8d0c3eb4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
