...
function ej(e) {
  ...
  n.append("build_id", "8d36ebb2047712f1917856d296827e9c39ecabac"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
