...
function ek(e) {
  ...
  n.append("build_id", "9869545117b2adefc15c2f7d0f53fa4a663748aa"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
