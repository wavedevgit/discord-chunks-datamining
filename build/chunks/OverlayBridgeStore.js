...
function eM(e) {
  ...
  n.append("build_id", "67ecc936c226bcf5429e9d7526e23b625c2d2791"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
