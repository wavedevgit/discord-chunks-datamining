...
function ej(e) {
  ...
  n.append("build_id", "c3eca69905bd2fdacd02a206cebb096bd8924bd0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
