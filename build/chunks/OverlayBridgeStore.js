...
function eM(e) {
  ...
  n.append("build_id", "8bd741450f33612e29ae7d21cc8ab0672c903cb8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
