...
function ek(e) {
  ...
  n.append("build_id", "42c4546bda4452fea9bc8497f8416a0a6d7cc26f"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
