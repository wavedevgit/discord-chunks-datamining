...
function ek(e) {
  ...
  n.append("build_id", "d332ace009648e8093fe90906dba850546172bc1"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
