...
function ej(e) {
  ...
  n.append("build_id", "8410eb6c850360287b8fa932d642131528c0e389"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
