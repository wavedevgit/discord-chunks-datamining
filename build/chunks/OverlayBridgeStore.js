...
function ej(e) {
  ...
  n.append("build_id", "64a9cc04df5e2b378703848fcffb268b7b2b557a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
