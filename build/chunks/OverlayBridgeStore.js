...
function ej(e) {
  ...
  n.append("build_id", "dfe98fdbe1b2ed756986cbccaca14ad391f53a54"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
