...
function eM(e) {
  ...
  n.append("build_id", "cd853bec5daeb5a4f09dc89954477d9d3879eb1a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
