...
function eM(e) {
  ...
  n.append("build_id", "947b380086db408631a26b2478ea5e7d1d6c8385"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
