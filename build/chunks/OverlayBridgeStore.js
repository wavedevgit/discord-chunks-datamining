...
function ek(e) {
  ...
  n.append("build_id", "3220359b7eae8f80edef540248462299a6f5fa13"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
