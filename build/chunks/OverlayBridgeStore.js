...
function ek(e) {
  ...
  n.append("build_id", "8febde6980c8798fed1abde0c727fab7ff340cc2"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
