...
function ek(e) {
  ...
  n.append("build_id", "15f334d22fe1ca998946a1f66207463f6bc85d0e"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
