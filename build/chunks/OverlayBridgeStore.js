...
function eM(e) {
  ...
  n.append("build_id", "e701890c41786bf546624959f02b422dd336999f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
