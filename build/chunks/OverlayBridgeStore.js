...
function ej(e) {
  ...
  n.append("build_id", "3f1be993a2f37aff0cbcb18953eb1533cf36c974"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
