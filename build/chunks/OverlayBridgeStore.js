...
function eM(e) {
  ...
  n.append("build_id", "b700ae2c89791d278e05cf9b7f6dbaeccd62d06e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
