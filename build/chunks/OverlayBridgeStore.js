...
function ej(e) {
  ...
  n.append("build_id", "8e637b283adf9fc296fc57cb7c1397b0532813b0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
