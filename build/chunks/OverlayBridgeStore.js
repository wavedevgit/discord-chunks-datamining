...
function ej(e) {
  ...
  n.append("build_id", "b3e1628863896869c094e33db91f7956df9e6b0c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
