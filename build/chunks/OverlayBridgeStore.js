...
function ej(e) {
  ...
  n.append("build_id", "2715ed91ac203ceb040ecbe166acab02749d6c3f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
