...
function eM(e) {
  ...
  n.append("build_id", "73cc261f37efaa2715bfdd69dfedecf55a13e1c9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
