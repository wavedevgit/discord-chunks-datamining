...
function ej(e) {
  ...
  n.append("build_id", "9421c683ff75857b98b24d4d40fc917777305460"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
