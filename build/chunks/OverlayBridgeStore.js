...
function ek(e) {
  ...
  n.append("build_id", "3f7af77fd0373f74d65c399ad9d445df016ca1e8"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
