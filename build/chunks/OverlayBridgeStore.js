...
function ek(e) {
  ...
  n.append("build_id", "9b14260fa6071844d14202d2be99f5034dd3637d"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
