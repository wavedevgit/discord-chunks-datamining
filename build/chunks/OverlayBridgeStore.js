...
function ej(e) {
  ...
  n.append("build_id", "a1db42c2007e85422e4687b8ecdb831733d4788a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
