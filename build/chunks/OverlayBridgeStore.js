...
function ek(e) {
  ...
  n.append("build_id", "1243d6a162c0c9266dd65590f73ed860d6f2b34d"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
