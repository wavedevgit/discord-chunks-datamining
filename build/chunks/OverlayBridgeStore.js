...
function ej(e) {
  ...
  n.append("build_id", "ba6cb670a06303fce98172cac9e26708b717a6ab"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
