...
function ej(e) {
  ...
  n.append("build_id", "e62773eec1aaaa49db3290fc71f3caa003e6ec17"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
