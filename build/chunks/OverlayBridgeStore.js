...
function ej(e) {
  ...
  n.append("build_id", "ab86281a3e549902563c0ae2197118fe1b33fae3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
