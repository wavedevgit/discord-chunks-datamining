...
function eM(e) {
  ...
  n.append("build_id", "8e2f64fe46a131afb8f4a00089521f289885cbcd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
