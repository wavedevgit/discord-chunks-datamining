...
function eM(e) {
  ...
  n.append("build_id", "5e7da79871da848ce440b9c23caff0ceb4134fc8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
