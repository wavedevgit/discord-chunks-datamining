...
function ek(e) {
  ...
  n.append("build_id", "cedb6b8834bfe162b89497690b23956868973007"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
