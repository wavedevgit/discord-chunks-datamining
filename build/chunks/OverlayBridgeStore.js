...
function ek(e) {
  ...
  n.append("build_id", "edb7131d411dbc64e4657de33b90e4a8b2c0f4c8"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
