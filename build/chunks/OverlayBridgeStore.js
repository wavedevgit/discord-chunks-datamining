...
function ej(e) {
  ...
  n.append("build_id", "6a40912fd5f534c702de21c74b8aede2aafef1e9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
