...
function ej(e) {
  ...
  n.append("build_id", "07d5b35b570cc1f35ca152c7ebdb7b5676b4b3bb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
