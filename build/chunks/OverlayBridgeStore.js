...
function ej(e) {
  ...
  n.append("build_id", "ea44471a3cff4457ea24ca5e7e241612fc3cf93a"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
