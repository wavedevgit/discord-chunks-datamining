...
function ek(e) {
  ...
  n.append("build_id", "26c27a6afdf69789a23296698aecd35a4f2901ac"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
