...
function eM(e) {
  ...
  n.append("build_id", "ea263c44c9646354e5b0ec6680e0a072a8dffd3e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
