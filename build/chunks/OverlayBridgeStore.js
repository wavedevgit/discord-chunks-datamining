...
function ek(e) {
  ...
  n.append("build_id", "772da25dbfaf92d66f32e0a3f930eb68236fd0f9"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
