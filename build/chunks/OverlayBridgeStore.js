...
function ej(e) {
  ...
  n.append("build_id", "605cfe5ffd33f44b2306cf49edd386706454223c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
