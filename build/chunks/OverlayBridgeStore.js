...
function eM(e) {
  ...
  n.append("build_id", "c3c493b150b0117edd7b78c970e1e10224bf075b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
