...
function ej(e) {
  ...
  n.append("build_id", "075049b4f9af0e4f8b7abdee5515a3da4743646f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
