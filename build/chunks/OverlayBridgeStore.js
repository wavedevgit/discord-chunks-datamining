...
function ek(e) {
  ...
  n.append("build_id", "356a6e8ad22c41b09d66a9bb99e70748371720de"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
