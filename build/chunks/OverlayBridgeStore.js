...
function ej(e) {
  ...
  n.append("build_id", "b89fd666b5a0e927df4c2f9ab0acaba0ea20a087"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
