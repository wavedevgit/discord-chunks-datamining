...
function ej(e) {
  ...
  n.append("build_id", "8616b8df3ddffd82acc7923bda1861d9aa020a0a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
