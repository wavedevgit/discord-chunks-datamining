...
function ej(e) {
  ...
  n.append("build_id", "d47ba9d0a0c978edc7e40620089de9dce48cb4b1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
