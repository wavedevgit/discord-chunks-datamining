...
function ej(e) {
  ...
  n.append("build_id", "2643571de76278bd2e510ecfab5911c64197d02d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
