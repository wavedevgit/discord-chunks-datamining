...
function eM(e) {
  ...
  n.append("build_id", "44133fa9c23a3c6e612f92138eeb7cd78d972efa"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
