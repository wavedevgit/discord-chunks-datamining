...
function ej(e) {
  ...
  n.append("build_id", "b6674c83ef6144885bff9522d4076519d94f458a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
