...
function ej(e) {
  ...
  n.append("build_id", "422ae286870e8a6eb20e6ca470961d4edb849e4d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
