...
function ek(e) {
  ...
  n.append("build_id", "dfcb1ce893620ab2f5cc8c0c78ddd684e99bc40f"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
