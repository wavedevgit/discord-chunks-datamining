...
function ej(e) {
  ...
  n.append("build_id", "06b60a284dbb7ca114cec43198efb32acfba6340"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
