...
function ej(e) {
  ...
  n.append("build_id", "bfa4732be863af852bb5557a4eba8792335561fd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
