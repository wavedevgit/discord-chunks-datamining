...
function ek(e) {
  ...
  n.append("build_id", "0c3d7a2d71d30683d3343674a2ebcde7171433f9"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
