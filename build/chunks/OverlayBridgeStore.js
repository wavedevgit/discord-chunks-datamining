...
function ej(e) {
  ...
  n.append("build_id", "b96de9b54ec7647c4b63591f51eabea8a4a0187f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
