...
function ek(e) {
  ...
  n.append("build_id", "9258ae86525847954be4a22e87b64d9c2a0e9729"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
