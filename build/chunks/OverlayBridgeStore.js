...
function eM(e) {
  ...
  n.append("build_id", "8e49fd2266067859181594b4d9c19b0e20526fe5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
