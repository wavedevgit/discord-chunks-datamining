...
function eM(e) {
  ...
  n.append("build_id", "b16c05b1d42695190ddfea5bf92b3198640851ff"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
