...
function ej(e) {
  ...
  n.append("build_id", "88215c3d01396cfabfae8d52214714ada59f60c9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
