...
function ej(e) {
  ...
  n.append("build_id", "668bc4f1bee2838b89cfef87087d2cdb2a0bf358"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
