...
function ek(e) {
  ...
  n.append("build_id", "23654507435b8d814405422b8178f1711bf28f11"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
