...
function ej(e) {
  ...
  n.append("build_id", "6b4fc4dbb8f9e0f1535224a3700b58cee183f57a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
