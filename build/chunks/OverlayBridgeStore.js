...
function ej(e) {
  ...
  n.append("build_id", "f6ea9bd3cec417b75556fd639544baef7d14f74d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
