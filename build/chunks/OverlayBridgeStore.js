...
function ej(e) {
  ...
  n.append("build_id", "e3ed60a663680f57f2876d50f427760a5357cd8f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
