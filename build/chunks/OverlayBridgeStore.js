...
function ej(e) {
  ...
  n.append("build_id", "ae65eea84c27be2e5798ce3005957672905390ad"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
