...
function ej(e) {
  ...
  n.append("build_id", "02d9058fdd09500206b92def147c041adfa3bf47"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
