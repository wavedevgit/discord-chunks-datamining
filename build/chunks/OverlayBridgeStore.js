...
function eM(e) {
  ...
  n.append("build_id", "821fc2230dce4a0ec06485266e14ed80b4a0b79e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
