...
function ej(e) {
  ...
  n.append("build_id", "cef8913b010bd1dda6e9e0cead560abd0428f3ce"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
