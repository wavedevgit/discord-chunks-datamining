...
function ej(e) {
  ...
  n.append("build_id", "b2d3e8fd11f708adf963f7c91ae5fc9c020bce6d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
