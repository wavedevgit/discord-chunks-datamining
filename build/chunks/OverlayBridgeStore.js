...
function ej(e) {
  ...
  n.append("build_id", "cf3243a4915f198d8b670630d85579d4e186cccd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
