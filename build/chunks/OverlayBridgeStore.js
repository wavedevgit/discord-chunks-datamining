...
function ej(e) {
  ...
  n.append("build_id", "1d82a06746e4b674add3a5464716515af3ca609f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
