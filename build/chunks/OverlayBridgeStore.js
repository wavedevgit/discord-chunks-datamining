...
function eM(e) {
  ...
  n.append("build_id", "0c086054edb0e7a5d100001a72dc1f0b26bb4cd9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
