...
function ek(e) {
  ...
  n.append("build_id", "4ed573906362170287182dd297e5f0e1d7d5e6bb"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
