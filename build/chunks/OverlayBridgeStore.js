...
function ej(e) {
  ...
  n.append("build_id", "02dbbb077a972b495e0cd81b905a084f97115e71"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
