...
function ej(e) {
  ...
  n.append("build_id", "a9e1ddceaf60221a8dc60da15089a07cc8952750"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
