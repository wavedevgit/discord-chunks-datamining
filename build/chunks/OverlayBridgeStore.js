...
function ej(e) {
  ...
  n.append("build_id", "3eee2f6a50664afeef8eea3275761ebedfabdcdc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
