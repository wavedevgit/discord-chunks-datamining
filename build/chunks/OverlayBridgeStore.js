...
function ej(e) {
  ...
  n.append("build_id", "d0a6387bb84fc63a1eb2004bd33b11cc678dac1f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
