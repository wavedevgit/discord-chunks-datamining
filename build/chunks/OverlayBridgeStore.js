...
function eM(e) {
  ...
  n.append("build_id", "9279f6a6dd30976394d199c493955489d0830700"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
