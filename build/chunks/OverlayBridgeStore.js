...
function ek(e) {
  ...
  n.append("build_id", "3a5df87cd540f37b5fc065092731e1de8279d948"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
