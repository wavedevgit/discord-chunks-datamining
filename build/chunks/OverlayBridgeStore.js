...
function ek(e) {
  ...
  n.append("build_id", "b62efc69fb4e1fabb4004ba3b5f4e54f134d1951"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
