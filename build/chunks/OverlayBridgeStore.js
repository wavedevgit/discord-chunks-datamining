...
function ej(e) {
  ...
  n.append("build_id", "d106c85dea04e66912a562431d8b85fc33271d25"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
