...
function ej(e) {
  ...
  n.append("build_id", "0245b27ee1b53bfd6638665f20f068c6a592046b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
