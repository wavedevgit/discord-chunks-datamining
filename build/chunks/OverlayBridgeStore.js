...
function eM(e) {
  ...
  n.append("build_id", "a5811842ed3b56b01de103a714f90aea4aec4578"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
