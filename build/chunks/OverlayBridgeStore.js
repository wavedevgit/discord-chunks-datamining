...
function eM(e) {
  ...
  n.append("build_id", "5e010a594cb10769a6e472dc7f09dfdf15909013"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
