...
function ej(e) {
  ...
  n.append("build_id", "ca75a0980dcd468cd273e4e6a9dda34a11f9ddfe"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
