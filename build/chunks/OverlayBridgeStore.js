...
function ek(e) {
  ...
  n.append("build_id", "693af7ac6cdf2104032c42cded7b6a4987ea52fd"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
