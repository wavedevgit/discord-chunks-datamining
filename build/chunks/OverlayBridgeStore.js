...
function ej(e) {
  ...
  n.append("build_id", "70f180b18603c0fbcf22ea4e1881645ac8f53033"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
