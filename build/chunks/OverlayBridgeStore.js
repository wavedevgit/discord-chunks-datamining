...
function eM(e) {
  ...
  n.append("build_id", "ccebb32eb5b2ca58755d77ee1101d3fc6d0e0a65"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
