...
function eM(e) {
  ...
  n.append("build_id", "565d157bb2857276601c162cf874407da65bfaef"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
