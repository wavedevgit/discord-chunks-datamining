...
function eM(e) {
  ...
  n.append("build_id", "f89590df5412d5c6bf7dab79b57ab5c5753572a5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
