...
function ej(e) {
  ...
  n.append("build_id", "c38294069f8e6594eb585f6258130fb6666730c4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
