...
function ej(e) {
  ...
  n.append("build_id", "5d654b75dfd2e1bbcede801fb5657e4069f653c1"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
