...
function ek(e) {
  ...
  n.append("build_id", "731212877d0e6b3602217a86ea08017fdc5eb3a2"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
