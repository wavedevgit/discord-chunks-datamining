...
function ek(e) {
  ...
  n.append("build_id", "d8d992bede62457ddd8210b1970257351d95cfe6"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
