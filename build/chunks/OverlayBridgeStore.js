...
function eS(e, t, n) {
  ...
  let s = el(e);
  w.default.track(k.rMx.OVERLAY_HOOK_RESULT, s), ea.info("Overlay connection to ".concat(e, " ").concat(t ? "succeeded" : "failed"), s), t ? eh(e, "CONNECTED", "CONNECTING") : eh(e, "CONNECT_FAILED", "CONNECTING")
}
...
function ej(e) {
  ...
  n.append("build_id", "4dbc8aebdc0a0291cdadf03245a56adc47810941"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
