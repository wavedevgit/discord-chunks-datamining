...
function ej(e) {
  ...
  n.append("build_id", "aeaf4c000cd99accafa75895cdb607d24f6cb8ee"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
