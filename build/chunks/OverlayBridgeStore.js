...
function ej(e) {
  ...
  n.append("build_id", "aaab6b865afe1eb6118b92b83b39915c343152a9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
