...
function eM(e) {
  ...
  n.append("build_id", "7fc0374e4dfa247197ec8cc8a6810149239010bd"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
