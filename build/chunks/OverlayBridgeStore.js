...
function ek(e) {
  ...
  n.append("build_id", "c842ba325775ebb0f039d4a5c647618e1fb5959b"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
