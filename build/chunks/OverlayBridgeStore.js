...
function ek(e) {
  ...
  n.append("build_id", "24299641aa67998d086de7aa14f3afb6a4300f45"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
