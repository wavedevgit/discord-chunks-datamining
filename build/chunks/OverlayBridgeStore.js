...
function ej(e) {
  ...
  n.append("build_id", "9eeb4c63536d7c00355918a637eda794436d61a6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
