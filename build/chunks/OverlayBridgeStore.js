...
function ek(e) {
  ...
  n.append("build_id", "fb673ca81ba439313d970933f33c964790277ebe"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
