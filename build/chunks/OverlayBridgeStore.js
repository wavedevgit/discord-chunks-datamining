...
function ek(e) {
  ...
  n.append("build_id", "deab20614b9b72e2b0b20332b42f0cb0944d4388"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
