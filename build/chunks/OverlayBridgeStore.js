...
function ej(e) {
  ...
  n.append("build_id", "2371f56faeb30f2ca79bdcd100cfa5b51e32c451"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
