...
function ej(e) {
  ...
  n.append("build_id", "fde1b625402d3f792f3a529d70df30a9418d5eed"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
