...
function ek(e) {
  ...
  n.append("build_id", "cba019a630877123f3fd0906c2df29e9b6094fcf"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
