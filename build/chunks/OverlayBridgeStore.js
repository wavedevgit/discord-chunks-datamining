...
function ej(e) {
  ...
  n.append("build_id", "8f0a943c866041a752b150b276ec19f92679516d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
