...
function ej(e) {
  ...
  n.append("build_id", "00194888d8ad7adbdf22a89346d21d2bf0b9f84b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
