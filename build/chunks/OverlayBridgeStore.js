...
function eM(e) {
  ...
  n.append("build_id", "cec91ed4b12c74d537109b01d027465bf54215e2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
