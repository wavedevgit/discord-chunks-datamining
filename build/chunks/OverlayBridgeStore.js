...
function eM(e) {
  ...
  n.append("build_id", "c4233d10b5eabcba8ea6138a17b00c7e9714f8ae"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
