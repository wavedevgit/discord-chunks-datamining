...
function ej(e) {
  ...
  n.append("build_id", "af3172fda6fa286649f2b2af02cd23cfd1235e82"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
