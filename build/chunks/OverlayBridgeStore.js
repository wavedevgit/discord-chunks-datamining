...
function ej(e) {
  ...
  n.append("build_id", "5ae29fc48a509014de82a7dfaa4da0df977296df"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
