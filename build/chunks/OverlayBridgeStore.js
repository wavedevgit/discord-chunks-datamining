...
function ej(e) {
  ...
  n.append("build_id", "a153e7c026153fa41b7b8db5f75b83ea8f44216b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
