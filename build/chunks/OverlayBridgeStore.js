...
function ej(e) {
  ...
  n.append("build_id", "30d311618df9870aad0034ea6e8f7d39624455db"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
