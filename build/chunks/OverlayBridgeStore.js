...
function ej(e) {
  ...
  n.append("build_id", "849d61ef9e814fff8516cc098c568e752111add8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
