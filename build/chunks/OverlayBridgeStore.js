...
function ek(e) {
  ...
  n.append("build_id", "ab953131dbf607f16519f31247806a31351eff58"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
