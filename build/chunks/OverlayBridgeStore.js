...
function ej(e) {
  ...
  n.append("build_id", "f0fd74062b54fb8b4414824d333f562818f65137"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
