...
function ej(e) {
  ...
  n.append("build_id", "78f27980dcdb2e2574e614f2d578b2acbc72b6fc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
