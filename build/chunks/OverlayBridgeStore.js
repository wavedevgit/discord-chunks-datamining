...
function ek(e) {
  ...
  n.append("build_id", "667c2ff1edbfde78432a9f6acc21616dc9468e0c"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
