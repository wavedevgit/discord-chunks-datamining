...
function ek(e) {
  ...
  n.append("build_id", "b5e6a92b67fba991cbf29074264944953cdbfc7c"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
