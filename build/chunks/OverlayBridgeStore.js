...
function eM(e) {
  ...
  n.append("build_id", "9957bd4d5bdb65527b14c18a41743d2e7e8cfa52"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
