...
function ej(e) {
  ...
  n.append("build_id", "8ffcb91edd08ef02ab4f881c9506cab4d1f9dde8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
