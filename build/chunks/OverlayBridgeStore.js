...
function ek(e) {
  ...
  n.append("build_id", "58033257bee061a204081f8c66f3ed7a0481778b"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
