...
function ej(e) {
  ...
  n.append("build_id", "640ff05e55730a0e8c045a42086dabb5a9d00d79"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
