...
function ek(e) {
  ...
  n.append("build_id", "f21d6a16d1def5dd9aa7c8a93a15303c6fa659f3"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
