...
function ej(e) {
  ...
  n.append("build_id", "ac950a453ccb59d7b526b2873a3d953cd6cdd428"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
