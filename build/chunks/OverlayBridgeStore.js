...
function ej(e) {
  ...
  n.append("build_id", "758172c301b81983bfb4f7df4f714005a576e5d6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
