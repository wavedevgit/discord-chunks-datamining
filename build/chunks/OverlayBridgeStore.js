...
function ek(e) {
  ...
  n.append("build_id", "75ac32924747a8516689a6755ff3b8947af33cd0"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
