...
function ek(e) {
  ...
  n.append("build_id", "0bd05d92570321918717eef03a12821dcdea5d96"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
