...
function eM(e) {
  ...
  n.append("build_id", "7ffad88f64080938bf6bae0f5629689f5b541a27"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
