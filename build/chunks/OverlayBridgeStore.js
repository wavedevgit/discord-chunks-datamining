...
function ek(e) {
  ...
  n.append("build_id", "ac3333a419276c56a1888409f55bfef122cf01f5"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
