...
function ek(e) {
  ...
  n.append("build_id", "47db4cf3943627d32b01fd587a301c48fed88e1f"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
