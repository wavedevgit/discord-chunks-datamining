...
function ek(e) {
  ...
  n.append("build_id", "e6e52bc5b589688affec618604619ee61d3f88f9"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
