...
function ej(e) {
  ...
  n.append("build_id", "afabd4b12372e0ba25c1dfa00435f611f72ae9a1"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
