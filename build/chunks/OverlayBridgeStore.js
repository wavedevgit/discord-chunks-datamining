...
function eM(e) {
  ...
  n.append("build_id", "851b99e98577948864ceef76f79c347c660f367c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
