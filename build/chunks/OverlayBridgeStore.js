...
function ej(e) {
  ...
  n.append("build_id", "f61cce28d0c5ce0de389cb6e2e8be0acfd4552dc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
