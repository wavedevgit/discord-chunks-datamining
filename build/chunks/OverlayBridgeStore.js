...
function ej(e) {
  ...
  n.append("build_id", "2cc6e9e94bbea6734b6a67f2df620b21125c3aa9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
...
class eQ extends(i = Chunk442837.ZP.Store) {
  ...
  isInputLocked(e) {
    return S.default.isOverlayOOPEnabledForPid(e) ? A.ZP.isInputLocked(e) : !ee.has(e)
  }
