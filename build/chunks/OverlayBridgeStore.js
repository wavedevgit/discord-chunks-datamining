...
function eM(e) {
  ...
  n.append("build_id", "33cef3966892aa7d7a0044fbc033eec0150fc8c6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
