...
function ej(e) {
  ...
  n.append("build_id", "096833ffbe70551b9a9a403b3c545dc48d4723d2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
