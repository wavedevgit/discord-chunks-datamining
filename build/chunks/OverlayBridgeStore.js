...
function ek(e) {
  ...
  n.append("build_id", "73b20e27344fb20ab7bbaa5bbfce537803202dde"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
