...
function ej(e) {
  ...
  n.append("build_id", "4d9fe15689660dc8257755cbda94583a69e1dde7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
