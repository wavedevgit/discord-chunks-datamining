...
function ek(e) {
  ...
  n.append("build_id", "e32bcaa3e067a20e9fc80fff8f074c4fb7fd2678"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
