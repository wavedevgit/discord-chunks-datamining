...
function ej(e) {
  ...
  n.append("build_id", "df07bbcf4bb6bbb5a8e91f30dcca2d95564f0d6f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
