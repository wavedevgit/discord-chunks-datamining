...
function eM(e) {
  ...
  n.append("build_id", "4fe7a279d904e64e53210becda3892276132cc35"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
