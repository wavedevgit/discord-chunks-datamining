...
function ej(e) {
  ...
  n.append("build_id", "988100965d91a371660d174bcce0953db9b82275"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
