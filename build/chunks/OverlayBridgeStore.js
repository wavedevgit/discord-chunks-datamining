...
function ej(e) {
  ...
  n.append("build_id", "a65d50330bfe5201f4f1da9a66cd8cbfe64fac93"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
