...
function ej(e) {
  ...
  n.append("build_id", "3b61d70eb73303c0ac7a88d3f451f4d9ebe0509d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
