...
function ej(e) {
  ...
  n.append("build_id", "f26ff784015687074669f26ff38f28345053540f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
