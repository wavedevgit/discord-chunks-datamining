...
function ej(e) {
  ...
  n.append("build_id", "038ff288c843a74b9bc197c4b66e7e6f69e7f76f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
