...
function eM(e) {
  ...
  n.append("build_id", "404c142030e072fdad1db18db0be42a1cec92b7a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
