...
function ej(e) {
  ...
  n.append("build_id", "b9de1cddb040c5809a11cf3e621567067226f727"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
