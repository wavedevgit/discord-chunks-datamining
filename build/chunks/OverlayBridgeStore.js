...
function ej(e) {
  ...
  n.append("build_id", "fa8c1b3c09158cac6c89dfea37ec68cc9b3ef10a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
