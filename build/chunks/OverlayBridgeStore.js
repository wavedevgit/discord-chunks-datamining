...
function eM(e) {
  ...
  n.append("build_id", "4b9b7ccf90b535dba617b0802271fcbf2a6692a5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
