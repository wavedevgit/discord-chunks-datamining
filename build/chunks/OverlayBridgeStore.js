...
function eM(e) {
  ...
  n.append("build_id", "4342d48d14b18c1db8215255ff8eb79ddb19855a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
