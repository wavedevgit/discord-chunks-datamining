...
function eM(e) {
  ...
  n.append("build_id", "8246311103d0ec10ab22abd3c7360c28827cec7f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
