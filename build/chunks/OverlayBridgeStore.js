...
function eM(e) {
  ...
  n.append("build_id", "db45b869c32239054f2b0fdff4cd6272328edb76"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
