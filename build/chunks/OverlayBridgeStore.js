...
function ej(e) {
  ...
  n.append("build_id", "54ffc69f371c1cde1df335aa21042e4ba636045b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
