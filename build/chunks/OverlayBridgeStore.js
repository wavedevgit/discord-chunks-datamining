...
function eM(e) {
  ...
  n.append("build_id", "b8e23a8c7259609fab6456b0193c77483ac10009"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
