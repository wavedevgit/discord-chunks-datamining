...
function ej(e) {
  ...
  n.append("build_id", "0d911121a9947471784a348c08a34be0b606b4c0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
