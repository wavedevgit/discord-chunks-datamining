...
function ej(e) {
  ...
  n.append("build_id", "a5fd3f62fcc475fd3a00efc2be62bd7b56e5f1b7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
