...
function ek(e) {
  ...
  n.append("build_id", "1429f491c5ef15ba6d99dbdb0a7e8ee83c6ed919"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
