...
function eM(e) {
  ...
  n.append("build_id", "78b364f9ae0e633c26526c99230697e737b22449"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
