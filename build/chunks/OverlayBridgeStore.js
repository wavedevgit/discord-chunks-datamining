...
function eM(e) {
  ...
  n.append("build_id", "daa73ed607ca80436b1a1e5c9ed36a66a0a711cd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
