...
function ej(e) {
  ...
  n.append("build_id", "540678779692ad8336714e9e5708bad75ae5dbff"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
