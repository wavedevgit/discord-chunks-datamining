...
function ej(e) {
  ...
  n.append("build_id", "808d7a75c1d100447e721871c0137a9d5888c1bd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
