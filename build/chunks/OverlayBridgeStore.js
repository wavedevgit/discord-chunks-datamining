...
function ej(e) {
  ...
  n.append("build_id", "b11972ef01d24bba6ca0be94cd4ae24be9d650e7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
