...
function ek(e) {
  ...
  n.append("build_id", "6a92b6f7781e3d27c29d4df6f6a01fef95c9a067"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
