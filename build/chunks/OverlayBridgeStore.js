...
function eM(e) {
  ...
  n.append("build_id", "a375bea6e37fc6c174c157774852d08ba2eb4328"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
