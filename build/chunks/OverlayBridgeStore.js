...
function eM(e) {
  ...
  n.append("build_id", "044e4394457bb416f8fd021b92067fe111689a59"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
