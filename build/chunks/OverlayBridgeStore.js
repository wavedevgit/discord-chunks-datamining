...
function ej(e) {
  ...
  n.append("build_id", "d8e12d52a7195ffd86260f13263a59691b96e031"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
