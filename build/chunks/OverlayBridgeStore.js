...
function ek(e) {
  ...
  n.append("build_id", "05ea398c5e1ff64d242556c30bcaa02b964dc07f"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
