...
function ek(e) {
  ...
  n.append("build_id", "ef2a9944bcf78776dedfd3696ed6367bb2d093a7"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
