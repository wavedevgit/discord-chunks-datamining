...
function eM(e) {
  ...
  n.append("build_id", "d1a82767ac8b4f89442d369f651d0ad6ae59842c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
