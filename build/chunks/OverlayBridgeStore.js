...
function ek(e) {
  ...
  n.append("build_id", "ef61cbd6316faad9be98a4fe5ad07874aec4fcae"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
