...
function eM(e) {
  ...
  n.append("build_id", "b52928e95bca321159d1f89f649432d50d0eb4cd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
