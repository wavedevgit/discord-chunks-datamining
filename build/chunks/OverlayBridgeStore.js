...
function eM(e) {
  ...
  n.append("build_id", "a681bafc29b48bc90ee4ef695aa390eacd846800"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
