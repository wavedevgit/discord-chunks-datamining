...
function ej(e) {
  ...
  n.append("build_id", "13be24b88e9ce731c705cae8a37f3261027c7caa"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
