...
function ej(e) {
  ...
  n.append("build_id", "b891682901525e05cdf34f3f6a1abca3199030ec"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
