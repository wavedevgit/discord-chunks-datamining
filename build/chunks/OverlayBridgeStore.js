...
function ej(e) {
  ...
  n.append("build_id", "c50d9b1c475ef3e0bd4e8997572397c91dd8e622"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
