...
function ek(e) {
  ...
  n.append("build_id", "6812ea4cc136275253cd60342fab49a8b58e2519"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
