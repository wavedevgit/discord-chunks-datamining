...
function ek(e) {
  ...
  n.append("build_id", "4b46c3df7916bccd58c87942abfaf0e3a9aef93d"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
