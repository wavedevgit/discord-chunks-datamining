...
function eM(e) {
  ...
  n.append("build_id", "9e6eb8aa54dcf21003dd20eb7a56bfed0160d49a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
