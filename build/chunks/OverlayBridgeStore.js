...
function eM(e) {
  ...
  n.append("build_id", "8fd2575bcc946dcf606aed7a56a4dd8ca55aef93"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
