...
function eM(e) {
  ...
  n.append("build_id", "8fda7b38a716c7062ff00577a7d970ae91ca0c6b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
