...
function ej(e) {
  ...
  n.append("build_id", "a44c7d3d6ed4689127de2b6f6ac5b46185b226fb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
