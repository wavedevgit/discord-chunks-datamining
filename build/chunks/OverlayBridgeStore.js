...
function eM(e) {
  ...
  n.append("build_id", "1f75ba06678a764006a663f7130ae92c7a24e0fe"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
