...
function ej(e) {
  ...
  n.append("build_id", "3e192c52844a023140a09ee980dade542a38cdde"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
