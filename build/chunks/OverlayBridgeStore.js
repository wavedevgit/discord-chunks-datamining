...
function ej(e) {
  ...
  n.append("build_id", "e6d056f5773504d82b663eab28e441c55ae4d49f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
