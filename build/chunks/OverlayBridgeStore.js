...
function ej(e) {
  ...
  n.append("build_id", "db89734dcc123a0601180dd6dd260eb6a9da0b2f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
