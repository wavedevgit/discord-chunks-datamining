...
function ek(e) {
  ...
  n.append("build_id", "7a6f040c97c987eb73ede27882cd4d324c70223f"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
