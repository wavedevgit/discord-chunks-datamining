...
function ej(e) {
  ...
  n.append("build_id", "cacf694e3add0af6375ae9105355862bdcdf627e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
