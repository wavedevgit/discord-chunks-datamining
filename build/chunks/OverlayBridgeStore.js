...
function ej(e) {
  ...
  n.append("build_id", "0717bf2e752bc7a3c76abacfbfe1521f131aec06"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
