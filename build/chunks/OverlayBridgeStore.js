...
function ej(e) {
  ...
  n.append("build_id", "33c2db6b55869bb8db0ba689351e29d0b74415b7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
