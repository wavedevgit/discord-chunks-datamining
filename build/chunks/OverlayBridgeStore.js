...
function ej(e) {
  ...
  n.append("build_id", "64772944d540632960acf74409758ea2653c15fe"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
