...
function ek(e) {
  ...
  n.append("build_id", "b4322798f3f5789517c383e2483bfeff172e7768"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
