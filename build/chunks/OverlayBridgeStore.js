...
function eM(e) {
  ...
  n.append("build_id", "d1bfd598c6bbddad3e344a5bef4ed636d9f6ab1b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
