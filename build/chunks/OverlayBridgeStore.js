...
function ej(e) {
  ...
  n.append("build_id", "0fe2befb76bcf57ca21d499aa9127a6d25a134d3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
