...
function ek(e) {
  ...
  n.append("build_id", "ede5a2609206a905224fd3e40757f7c09ad30a19"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
