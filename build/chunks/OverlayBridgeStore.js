...
function ej(e) {
  ...
  n.append("build_id", "0183f24d522340977ee42b3425da858b2f7452df"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
