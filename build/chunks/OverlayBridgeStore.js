...
function eM(e) {
  ...
  n.append("build_id", "658ce2782445c38a22c060fbf85ef56544c1f169"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
