...
function ej(e) {
  ...
  n.append("build_id", "012121b78c90cfa5da507927127cc87fef65ef56"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
