...
function ej(e) {
  ...
  n.append("build_id", "470a28d16a7eac231c06bab562a7a1797bcc6e4f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
