...
function ej(e) {
  ...
  n.append("build_id", "993851b868e1786ca57c6b7adcd88616316cda5d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
