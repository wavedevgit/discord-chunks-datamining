...
function ej(e) {
  ...
  n.append("build_id", "7bf91189080eb5bd4d9e82be9f67913f6d5f04a7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
