...
function ek(e) {
  ...
  n.append("build_id", "80b87ff964f6b155b24a198172a7f0e58a84f2be"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
