...
function eM(e) {
  ...
  n.append("build_id", "67409ec2d777351beafc680700ca09e535bb4b06"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
