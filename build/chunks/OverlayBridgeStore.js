...
function ek(e) {
  ...
  n.append("build_id", "b98e13e9aece4e6a88524e66285e96e3fc580968"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
