...
function eM(e) {
  ...
  n.append("build_id", "972437a6a12d88d01bea4e32e73064cad2e11603"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
