...
function ej(e) {
  ...
  n.append("build_id", "61017c14778c84cf1844fb4a9e26dc9801d94adb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
