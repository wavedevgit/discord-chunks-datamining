...
function eM(e) {
  ...
  n.append("build_id", "a6349316a2a99d821a7f5307bb6d847ef95887d3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
