...
function eM(e) {
  ...
  n.append("build_id", "a6937ea63b4e050480e9b11561ad488c789bd969"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
