...
function ej(e) {
  ...
  n.append("build_id", "348968636a5ab313540e80d7692b5e7a7d188524"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
