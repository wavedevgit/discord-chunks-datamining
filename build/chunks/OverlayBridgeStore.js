...
function eM(e) {
  ...
  n.append("build_id", "c89ad53757832c1a055ff3dcf6648eeb55aa5ed7"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
