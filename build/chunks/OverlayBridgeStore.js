...
function ej(e) {
  ...
  n.append("build_id", "78252817012aed04b8b937a1cb85b5cb3902a2e4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
