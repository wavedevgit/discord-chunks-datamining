...
function ek(e) {
  ...
  n.append("build_id", "abc93228bc9a4144f27320f08388da37236afe62"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
