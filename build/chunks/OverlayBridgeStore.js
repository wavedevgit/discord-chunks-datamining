...
function ej(e) {
  ...
  n.append("build_id", "abddce1d9b3b3998c6466bf3502355402f18601c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
