...
function ej(e) {
  ...
  n.append("build_id", "f3a9d71531f453d4a4c7dc7cfd7ad0fcef1ac8af"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
