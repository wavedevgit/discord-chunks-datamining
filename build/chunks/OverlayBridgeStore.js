...
function eM(e) {
  ...
  n.append("build_id", "157f10271e3ce1f0b48e7c4b7feaa5edef3bd3cd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
