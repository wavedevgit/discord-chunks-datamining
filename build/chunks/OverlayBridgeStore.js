...
function ej(e) {
  ...
  n.append("build_id", "03ab438b553baa7cff4aaa24ad5a5fa87a11acc9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
