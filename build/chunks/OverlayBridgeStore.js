...
function eM(e) {
  ...
  n.append("build_id", "8e81cbdbe3b2ef95f7960f1cdcfce87215d14eeb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
