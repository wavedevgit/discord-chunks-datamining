...
function ej(e) {
  ...
  n.append("build_id", "3671fbfbbc90623abb96d6b66cb2edfa3215511e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
