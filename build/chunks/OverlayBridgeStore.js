...
function ek(e) {
  ...
  n.append("build_id", "bde24be843667e75b13ecfbc5f847902675ff7be"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
