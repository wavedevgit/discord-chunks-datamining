...
function ek(e) {
  ...
  n.append("build_id", "69b77b3463fe855bdbaed2042fb2f17b2e21ad8c"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
