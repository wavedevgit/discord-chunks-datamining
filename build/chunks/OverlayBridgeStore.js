...
function ej(e) {
  ...
  n.append("build_id", "b57f0dab4cf071bfba33596fbf7dbfacbdc895f3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
