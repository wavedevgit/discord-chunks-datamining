...
function eM(e) {
  ...
  n.append("build_id", "6899a0e1cc548e9c1459f27b8a32d9b6d07749b3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
