...
function ej(e) {
  ...
  n.append("build_id", "46435db445eee0c77b36aa5b958d309566ddcb5c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
