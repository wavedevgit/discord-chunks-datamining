...
function ej(e) {
  ...
  n.append("build_id", "7ac3d7b835a277dfed1e69ac75adf1b5e12e490f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
