...
function ej(e) {
  ...
  n.append("build_id", "d0908bcd86ce7eb1ff1e06eb06d92b8a564caf4f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
