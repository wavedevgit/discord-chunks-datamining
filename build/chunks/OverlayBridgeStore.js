...
function ej(e) {
  ...
  n.append("build_id", "f34d0a8185863d12527e531267ecc55ad421ef2b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
