...
function ek(e) {
  ...
  n.append("build_id", "87aa9bbb309775680c847295a07d829f0c00a1f4"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
