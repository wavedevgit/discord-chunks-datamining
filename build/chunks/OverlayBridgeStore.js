...
function ej(e) {
  ...
  n.append("build_id", "e98738b70d9f18708f8cd5fdb2b2c9dcf6b9534f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
