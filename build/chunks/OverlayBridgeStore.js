...
function ej(e) {
  ...
  n.append("build_id", "839416d378f1dc97805c435c09d543edc35b9099"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
