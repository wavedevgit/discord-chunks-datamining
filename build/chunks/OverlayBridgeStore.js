...
function ej(e) {
  ...
  n.append("build_id", "b80c5e7cd8162d263b4ae564eceab2c936bebee6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
