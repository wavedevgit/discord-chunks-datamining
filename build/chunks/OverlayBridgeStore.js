...
function eM(e) {
  ...
  n.append("build_id", "e147bf1a6afda72bf510437a4b530f186886813e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
