...
function ek(e) {
  ...
  n.append("build_id", "d404a6f48b6e24e079f738934cf21093a21ad15a"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
