...
function ek(e) {
  ...
  n.append("build_id", "4ef3f6dc028935bc58e2697610087a308e3ee9a2"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
