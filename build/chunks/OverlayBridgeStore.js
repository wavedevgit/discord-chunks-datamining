...
function ek(e) {
  ...
  n.append("build_id", "35178aeabec007bffb81b9b251bb6c2413e25588"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
