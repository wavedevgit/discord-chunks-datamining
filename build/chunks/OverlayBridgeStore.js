...
function ej(e) {
  ...
  n.append("build_id", "b1bf8f3cf1b2256b95ca95047be3938ab77bc5e4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
