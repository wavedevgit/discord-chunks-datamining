...
function ek(e) {
  ...
  n.append("build_id", "e3ed051fbd952fdfe9c0f577af17ba31735f346f"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
