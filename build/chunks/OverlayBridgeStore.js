...
function ej(e) {
  ...
  n.append("build_id", "33a9fdaa4115f3811341cf344d0b6fa14901731b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
