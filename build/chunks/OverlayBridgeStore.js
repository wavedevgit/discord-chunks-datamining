...
function ek(e) {
  ...
  n.append("build_id", "d135fb7e7790281e9467bb40ebd560c17781d86b"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
