...
function eM(e) {
  ...
  n.append("build_id", "9946ec3e64da78349503dae082c916cfd1ab6d8a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
