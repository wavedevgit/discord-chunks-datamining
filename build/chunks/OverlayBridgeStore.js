...
function eM(e) {
  ...
  n.append("build_id", "1d7d43ed850e9820351e66135cb4e4ad9b9a3bd7"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
