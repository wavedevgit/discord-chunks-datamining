...
function ej(e) {
  ...
  n.append("build_id", "03820cede34798dcb71bcec8327a6f9640764c87"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
