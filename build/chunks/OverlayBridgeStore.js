...
function ek(e) {
  ...
  n.append("build_id", "e8c6453b6420627aed9ed79d06d922eec330d3a4"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
