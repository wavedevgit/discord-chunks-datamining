...
function ej(e) {
  ...
  n.append("build_id", "b13140c5a7afd99f6b55243f8c3fb2be5986ba4a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
