...
function ej(e) {
  ...
  n.append("build_id", "acdb9f469cf95c00f1b168f4da5a75a3b15f2e89"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
