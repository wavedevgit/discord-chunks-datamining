...
function ej(e) {
  ...
  n.append("build_id", "e7a5f6d01aa96923664dcbd1825474ae3236c072"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
