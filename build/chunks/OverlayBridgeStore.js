...
function ek(e) {
  ...
  n.append("build_id", "a64a3f2becccd89dd068d0ed0ea98b3fa3b6bf71"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
