...
function ej(e) {
  ...
  n.append("build_id", "8155934871dd909e9571c1388631b9c13ab9fecc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
