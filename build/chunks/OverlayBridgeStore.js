...
function ej(e) {
  ...
  n.append("build_id", "9055ca6d46e06a08169d4fce01a86e9497b2a7be"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
