...
function ej(e) {
  ...
  n.append("build_id", "b361324f93379b7e748370ec9d158143e5a7449f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
