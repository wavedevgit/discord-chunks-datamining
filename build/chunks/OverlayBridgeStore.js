...
function eM(e) {
  ...
  n.append("build_id", "c399ebc34cbaf599bbd5e7b6c700c96b754f6a04"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
