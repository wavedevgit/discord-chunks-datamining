...
function ej(e) {
  ...
  n.append("build_id", "f7fb8cf3b3397936037ec1bb40a32ecef77c1900"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
