...
function eM(e) {
  ...
  n.append("build_id", "ce80bd99361f9f14386025dbc884b6d32493d3cf"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
