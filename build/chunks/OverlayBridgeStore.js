...
function ej(e) {
  ...
  n.append("build_id", "06c4489895dbecd4dd34f2e1ad64a976092f5fc5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
