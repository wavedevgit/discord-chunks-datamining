...
function ej(e) {
  ...
  n.append("build_id", "3fb7b5418dee5183cc5d47f3b3207a590283a8a0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
