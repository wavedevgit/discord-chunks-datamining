...
function eM(e) {
  ...
  n.append("build_id", "1656db5f2f11f80ae0c3feacc101201d4a1b66ce"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
