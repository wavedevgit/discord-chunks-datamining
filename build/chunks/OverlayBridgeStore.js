...
function ek(e) {
  ...
  n.append("build_id", "57a6632def3e267bc03addbf80f4a6f334aecff2"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
