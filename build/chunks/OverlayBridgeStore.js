...
function ej(e) {
  ...
  n.append("build_id", "18cd2f7210a13628db2a48e18ca111814b34c09c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
