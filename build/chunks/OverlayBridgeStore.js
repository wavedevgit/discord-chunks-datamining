...
function ek(e) {
  ...
  n.append("build_id", "0758db4a6ea1774b3a17013f159640f3d411d9a9"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
