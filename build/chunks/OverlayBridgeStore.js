...
function ej(e) {
  ...
  n.append("build_id", "1fee360387475825db069fdc40dfc8ea6bf69f87"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
