...
function ek(e) {
  ...
  n.append("build_id", "95caec1b73c208f2dc5eac38774529f541419c12"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
