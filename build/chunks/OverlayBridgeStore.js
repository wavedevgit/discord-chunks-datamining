...
function ej(e) {
  ...
  n.append("build_id", "a91a4c21106f49567ccca288e233457b019fd4f4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
