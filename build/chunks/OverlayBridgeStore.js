...
function ej(e) {
  ...
  n.append("build_id", "0afd376e4d8e64958bba7fb251cfce81fed95fe2"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
