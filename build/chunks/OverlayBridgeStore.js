...
function ej(e) {
  ...
  n.append("build_id", "3b43b7f51502c6256026d20acd331c3eedbcc08e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
