...
function eS(e, t, n) {
  ...
  ec(e, B({}, a)), (0, d.te)(M.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(M.OVERLAY_LAYOUT_ID), U.bv, {
...
function eC(e) {
  switch (eo && ea.info("[app data received]", e), e.type) {
    case k.BmY.CONNECT:
      ...
      if (null == t) break;
      (0, d.te)(M.OVERLAY_LAYOUT_ID, P.Z.getDefaultLayout(M.OVERLAY_LAYOUT_ID), U.bv), Promise.all([(0, I.Z)(t, e.pid), a.ZP.PersistedStore.getAllStates()]).then(t => {
        let [n, r] = t, {
          pid: i,
          token: o
        } = e;
...
function eM(e) {
  ...
  n.append("build_id", "3c4d4a79b89a56e8b75792230108987a0f18b93b"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
...
class eQ extends(i = Chunk442837.ZP.Store) {
  initialize() {
    !(0, Chunk145597.supportsLegacy)() || __OVERLAY__ || (this.waitFor(Chunk594190.ZP, Chunk353926.Z, Chunk314897.default, Chunk610394.ZP, Chunk371651.default), this.syncWith([Chunk353926.Z], ez), Chunk490029.sr(eC, eN), Chunk314897.default.addChangeListener(eA), Chunk570140.Z.addInterceptor(en.queueDispatch))
  }
