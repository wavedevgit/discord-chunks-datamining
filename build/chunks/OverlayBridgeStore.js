...
function ej(e) {
  ...
  n.append("build_id", "8dedcce44cac9d269ec37b52843d000ede238ea4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
