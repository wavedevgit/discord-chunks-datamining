...
function eM(e) {
  ...
  n.append("build_id", "ad21d700f866f7fa6888ee33bf5b8fb75c57a57a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
