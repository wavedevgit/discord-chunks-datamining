...
function ek(e) {
  ...
  n.append("build_id", "f6fc3335d0055ba1942594672752e39706c070c1"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
