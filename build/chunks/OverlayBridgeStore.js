...
function ek(e) {
  ...
  n.append("build_id", "f5bdd7168afb055f9dc77ab9f51e81310cd278be"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
