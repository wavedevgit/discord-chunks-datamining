...
function ej(e) {
  ...
  n.append("build_id", "e0ee2acfd16be05b182cfea1c104cbbee43b5aa5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
