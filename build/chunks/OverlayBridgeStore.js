...
function eM(e) {
  ...
  n.append("build_id", "8b6c67b0d0d3581b6ced9052ef930fb54cc1ffd5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
