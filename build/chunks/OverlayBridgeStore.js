...
function ek(e) {
  ...
  n.append("build_id", "85a2476455a2118e49ce98aa542fa05affee218f"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
