...
function ej(e) {
  ...
  n.append("build_id", "dcb57147cfd23c8bb9bd1e65e5faff5942d4b666"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
