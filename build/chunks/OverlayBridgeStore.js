...
function ej(e) {
  ...
  n.append("build_id", "0822387df50c54c8cbd8d80fff1bd574eca21a15"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
