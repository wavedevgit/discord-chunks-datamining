...
function eM(e) {
  ...
  n.append("build_id", "d24a33589d069bcbc560bdb63ecae0e853352afd"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
