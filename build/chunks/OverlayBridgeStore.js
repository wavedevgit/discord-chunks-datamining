...
function ek(e) {
  ...
  n.append("build_id", "1b4a4225212609b70ea55b6ebd1dbdfab293b54d"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
