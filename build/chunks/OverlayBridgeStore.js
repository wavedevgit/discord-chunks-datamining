...
function ek(e) {
  ...
  n.append("build_id", "1965f28628c9270fe572a7b2fa093b3214f3a8b2"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
