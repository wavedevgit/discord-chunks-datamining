...
function eM(e) {
  ...
  n.append("build_id", "c397a48e0b95f629f871923f42a19e5c5816ec60"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
