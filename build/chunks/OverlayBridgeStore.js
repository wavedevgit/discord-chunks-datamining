...
function eM(e) {
  ...
  n.append("build_id", "3115c14605b6e61cbe6127bb31759d815f84d08a"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
