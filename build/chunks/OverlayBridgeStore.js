...
function ej(e) {
  ...
  n.append("build_id", "2a678d4275777f616fa655c2d852de2eb26cd480"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
