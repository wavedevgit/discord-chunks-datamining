...
function ej(e) {
  ...
  n.append("build_id", "a307ae7f892149570dad12a4fc59f31404b32fca"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
