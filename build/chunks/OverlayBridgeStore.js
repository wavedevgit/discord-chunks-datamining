...
function eM(e) {
  ...
  n.append("build_id", "65fceca49b214280f3193ed57bf64d3f85e2fb21"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
