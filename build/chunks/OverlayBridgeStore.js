...
function ej(e) {
  ...
  n.append("build_id", "8522bfd905c77b2e0d4a37d007f6add0ba82689f"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
