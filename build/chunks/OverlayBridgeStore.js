...
function eM(e) {
  ...
  n.append("build_id", "f65c5448429bcd8284d23b8ab1d2be198d354b71"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
