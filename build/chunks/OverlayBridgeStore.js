...
function eM(e) {
  ...
  n.append("build_id", "e11b57f8f84d466f92b1a8ac819f52a0b92d7a4e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
