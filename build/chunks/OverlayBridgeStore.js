...
function ej(e) {
  ...
  n.append("build_id", "492aeac1238f0a2f9db09a8575e58f8045c49e52"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
