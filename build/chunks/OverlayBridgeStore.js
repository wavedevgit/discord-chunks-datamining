...
function eM(e) {
  ...
  n.append("build_id", "95896961c0a5a28f246261301d6d70bf6495617c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
