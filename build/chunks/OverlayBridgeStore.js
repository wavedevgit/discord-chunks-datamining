...
function eM(e) {
  ...
  n.append("build_id", "16562d205626878b888106f821c216a48cbddaeb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
