...
function ej(e) {
  ...
  n.append("build_id", "d3f7ef5cdca1e27320689a6dfafa79fb782182ce"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
