...
function eM(e) {
  ...
  n.append("build_id", "623900b6fec2584a5365c41784462a4ed5d992bf"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
