...
function ej(e) {
  ...
  n.append("build_id", "969f049e11b8551e7d51eb40dfe51d6ecbc46fe4"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
