...
function eM(e) {
  ...
  n.append("build_id", "d58098e289ef4c988b610af07ff632d6db44c1d0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
