...
function ek(e) {
  ...
  n.append("build_id", "40ef5df9f12193fbdd0a91a77933ea1e0f270e00"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
