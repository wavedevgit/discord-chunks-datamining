...
function ej(e) {
  ...
  n.append("build_id", "0adf8ae927a675f4fb60def2ec3ded8562062b44"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
