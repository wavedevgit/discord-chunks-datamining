...
function ek(e) {
  ...
  n.append("build_id", "19cbeaf7cb7016299cfbf423a91e32baf83bd099"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
