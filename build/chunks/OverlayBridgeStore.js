...
function ej(e) {
  ...
  n.append("build_id", "23217b8659d154fd980fb2d54366b8ac1c8735b4"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
