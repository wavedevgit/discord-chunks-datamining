...
function eM(e) {
  ...
  n.append("build_id", "6db7363de058b321bac2d3eea68a1a245655db99"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
