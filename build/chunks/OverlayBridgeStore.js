...
function ek(e) {
  ...
  n.append("build_id", "d93bff513039b25e45d7a660a3b351fdac24173c"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
