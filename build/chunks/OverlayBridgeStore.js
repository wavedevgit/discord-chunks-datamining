...
function ek(e) {
  ...
  n.append("build_id", "d88587412aefc46928b0f72ba2bcf97eccb5db09"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
