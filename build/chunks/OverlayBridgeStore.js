...
function ej(e) {
  ...
  n.append("build_id", "e21c8cdfec435e70c67862f228edb3b9a5c6fbad"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
