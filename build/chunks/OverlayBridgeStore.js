...
function ej(e) {
  ...
  n.append("build_id", "d880be9750d4b2d524dcdb19ddc75f383746e342"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
