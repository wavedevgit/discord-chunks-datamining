...
function ej(e) {
  ...
  n.append("build_id", "0b58f4d71a1b72964a10bfab369ef136b4bf517f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
