...
function ej(e) {
  ...
  n.append("build_id", "959f6260965d2c2198c0d1a42d0dc81322c0fbeb"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
