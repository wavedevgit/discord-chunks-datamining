...
function eM(e) {
  ...
  n.append("build_id", "a00d1ceb5ede4d801fb5b4258fc819c3b0def7db"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
