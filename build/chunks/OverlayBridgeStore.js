...
function ej(e) {
  ...
  n.append("build_id", "fd9418ae378f669288eb6aeba7151d56efa9eb5e"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
