...
function eM(e) {
  ...
  n.append("build_id", "c2cf1e8082152d58db92085178f79dcb4a678404"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
