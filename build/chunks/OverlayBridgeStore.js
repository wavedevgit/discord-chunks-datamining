...
function ek(e) {
  ...
  n.append("build_id", "9e813fca90aeb84409b399b6dce6342f9b3d9d7c"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
