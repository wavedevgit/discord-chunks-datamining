...
function eM(e) {
  ...
  n.append("build_id", "4bc0ca72cdcaffc3119a8d7e78d0d5dec24519a5"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
