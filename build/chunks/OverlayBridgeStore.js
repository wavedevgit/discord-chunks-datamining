...
function ej(e) {
  ...
  n.append("build_id", "b0d209ae127b6a4b5f79e24e5d2220b9a7f486ca"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
