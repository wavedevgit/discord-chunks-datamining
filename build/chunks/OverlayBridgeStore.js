...
function ej(e) {
  ...
  n.append("build_id", "f25c2cb36406041045da6318171a1ca070c74108"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
