...
function ek(e) {
  ...
  n.append("build_id", "2cbf142a0c9942606d0671bdb7a8e7a1086b7923"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
