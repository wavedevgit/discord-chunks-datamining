...
function eM(e) {
  ...
  n.append("build_id", "d890960a0b363e960ae43b47f674d3b8cf2ccf9c"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
