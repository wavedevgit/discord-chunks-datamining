...
function eM(e) {
  ...
  n.append("build_id", "73ec723e7a20674479faf03c68768f1d834e8992"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
