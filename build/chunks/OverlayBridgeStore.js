...
function ej(e) {
  ...
  n.append("build_id", "502abb8f900570de8577a6d6a488d100efcee022"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
