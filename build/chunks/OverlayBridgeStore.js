...
function ej(e) {
  ...
  n.append("build_id", "06de15a5ae8d3311a6e50458b3a02f8c3fc72e10"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
