...
function ej(e) {
  ...
  n.append("build_id", "8e06554c93c027b0cf87f5b63c670ef603ce8cf9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
