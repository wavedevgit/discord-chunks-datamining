...
function ek(e) {
  ...
  n.append("build_id", "c9a2a49ff13d320c752406d63265d0531fe0df3a"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
