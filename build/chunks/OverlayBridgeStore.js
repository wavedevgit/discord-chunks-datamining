...
function eM(e) {
  ...
  n.append("build_id", "4dfab876a5dc1795d3e6e361155ff0f1acfcd83f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
