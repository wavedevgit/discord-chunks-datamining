...
function ek(e) {
  ...
  n.append("build_id", "8cf2424b037e000c74881f439c00627c734518a2"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
