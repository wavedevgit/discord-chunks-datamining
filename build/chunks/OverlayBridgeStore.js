...
function eM(e) {
  ...
  n.append("build_id", "3d5ccbc94a1f60239a454159f3a6b05262fd6b02"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
