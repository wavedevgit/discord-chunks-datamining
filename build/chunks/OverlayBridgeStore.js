...
function eM(e) {
  ...
  n.append("build_id", "ce7ee8ec03756b30cbc1186a337c1862d004c8d8"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
