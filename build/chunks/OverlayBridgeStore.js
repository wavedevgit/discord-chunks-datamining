...
function ek(e) {
  ...
  n.append("build_id", "5cfd925869b3c0f7e04e62d06085f35826db243c"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
