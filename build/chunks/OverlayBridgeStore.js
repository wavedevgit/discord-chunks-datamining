...
function ek(e) {
  ...
  n.append("build_id", "4f109a278443e5ab19885fa243611744d156ff3b"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
