...
function ej(e) {
  ...
  n.append("build_id", "1cbe6d58aae5c3dbd94f3e57e6efea922643e129"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
