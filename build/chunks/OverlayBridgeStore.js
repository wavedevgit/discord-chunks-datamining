...
function ej(e) {
  ...
  n.append("build_id", "8b5461e6a0b8a207415b7da33d7edd6e6b3ec93f"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
