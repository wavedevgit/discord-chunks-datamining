...
function ej(e) {
  ...
  n.append("build_id", "0a28a1f79a3ea046aa906ae1595a635dfadfd00d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
