...
function ek(e) {
  ...
  n.append("build_id", "866af11127804a830c7fba64c72047466a1caa18"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
