...
function ej(e) {
  ...
  n.append("build_id", "a7b65ef0f7a65e1200118cfcbf1c1646e0f20cfc"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
