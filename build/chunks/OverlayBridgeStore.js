...
function ej(e) {
  ...
  n.append("build_id", "e8e11ef6e583eddb712ec6b067f180ec738b44da"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
