...
function eM(e) {
  ...
  n.append("build_id", "71759c19ab0baa3816f894952c45e9acb1c25c61"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
