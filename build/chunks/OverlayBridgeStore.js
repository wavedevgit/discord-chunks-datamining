...
function ej(e) {
  ...
  n.append("build_id", "5df75f2e065796ab45bce3be2433b3ecfb3c8cbe"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
