...
function ek(e) {
  ...
  n.append("build_id", "5645b766171a0bdeabe53c7c77c8a0f0acd5b709"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
