...
function ek(e) {
  ...
  n.append("build_id", "0f790c66b11fa398c52a4d25d5e97a5b56781ef4"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
