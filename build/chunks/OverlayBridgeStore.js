...
function ek(e) {
  ...
  n.append("build_id", "d0b19333adb85fa165f60dfde5cdf36be7395669"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
