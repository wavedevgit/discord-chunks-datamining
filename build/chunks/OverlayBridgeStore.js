...
function ej(e) {
  ...
  n.append("build_id", "066ac9535c43a85cbca01b239108fef95b310e50"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
