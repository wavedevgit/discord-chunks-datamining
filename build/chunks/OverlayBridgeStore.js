...
function ek(e) {
  ...
  n.append("build_id", "b947fc3861f4daf0e59225a69d43789f912a7dd7"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
