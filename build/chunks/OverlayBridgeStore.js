...
function ek(e) {
  ...
  n.append("build_id", "735baa6dd8a1eb09588b901d411d4f88c50d1d09"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
