...
function ek(e) {
  ...
  n.append("build_id", "f89a35b3d90c35d61cdba95ffe8db67264a8e1bd"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
