...
function ej(e) {
  ...
  n.append("build_id", "6b276dcdb2be70c0afbb46e9f293cd06d5c11d7a"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
