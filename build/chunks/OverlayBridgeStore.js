...
function ej(e) {
  ...
  n.append("build_id", "7b75ec166832104fd155dcd7ee7232eac88360ef"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
