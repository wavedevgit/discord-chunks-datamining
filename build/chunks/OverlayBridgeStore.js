...
function ek(e) {
  ...
  n.append("build_id", "04818bfa000cd5bd1231f565e00080a056213265"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
