...
function eM(e) {
  ...
  n.append("build_id", "b3144f0be7e734b5371c2bf61c21f08243fb749f"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
