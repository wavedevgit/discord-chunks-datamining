...
function ej(e) {
  ...
  n.append("build_id", "c8dc4fe5cb47ddbd0cd6714f29ea5b9df38df4be"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
