...
function ej(e) {
  ...
  n.append("build_id", "b9cc4bc601b3ffb2187284a6b5a64b11cf57fe30"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
