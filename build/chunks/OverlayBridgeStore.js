...
function eM(e) {
  ...
  n.append("build_id", "156a397d6652d4b4adea898f913de160bf61bcc0"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
