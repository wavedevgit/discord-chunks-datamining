...
function ek(e) {
  ...
  n.append("build_id", "007db0d255c7764826e98ba1e34698f1a0f9ef5f"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
