...
function ek(e) {
  ...
  n.append("build_id", "0b4a2af804c2e4e0f89808a6f7aa3834f24eccb1"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
