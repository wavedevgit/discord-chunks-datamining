...
function ek(e) {
  ...
  n.append("build_id", "524a1aa957452f9bf4569f6689b177cf38d2f5a4"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
