...
function ek(e) {
  ...
  n.append("build_id", "6800f67e0b331984a7fd7223583863f2a109a509"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
