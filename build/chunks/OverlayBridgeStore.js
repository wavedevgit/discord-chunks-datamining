...
function ej(e) {
  ...
  n.append("build_id", "b604c89917616b29f3b904be0115f8ff3dbac6f9"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
