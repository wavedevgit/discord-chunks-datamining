...
function eM(e) {
  ...
  n.append("build_id", "2df641bc22d2153d82ddb34537418ee915cc71e6"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
