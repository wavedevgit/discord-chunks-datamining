...
function ek(e) {
  ...
  n.append("build_id", "b90ef4a7bc591053c69602041abb4ffb3f7e9cfc"), n.append("rpc", String(t)), n.append("rpc_auth_token", et), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
