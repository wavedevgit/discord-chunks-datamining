...
function eM(e) {
  ...
  n.append("build_id", "79c58cfc19ce6680a609def9ebf294f1497a014e"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
