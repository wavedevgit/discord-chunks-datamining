...
function eM(e) {
  ...
  n.append("build_id", "41b72f73a62c98c7e0ea0353bd2f98658514526d"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
