...
function ej(e) {
  ...
  n.append("build_id", "4b76cec7d0536bc901cb4bcf6015106c7260ef09"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
