...
function ej(e) {
  ...
  n.append("build_id", "f1e05e4259c9364538294b713be6334194e014c3"), n.append("rpc", String(t)), n.append("rpc_auth_token", $), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
