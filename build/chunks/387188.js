  ...
  return null == d ? null : (0, r.jsx)(c.P3F, {
    ...
    children: (0, r.jsx)(c.Text, {
      ...
      children: h.intl.format(h.t.z5Rnl5, {
        renderedEmoji: null == d ? null : (0, r.jsx)(u.Z, {
          emojiName: d.name,
          size: "default",
          emojiId: d.id,
          animated: d.animated,
...
function C(e) {
  ...
  let {
    ...
    compact: a,
    usernameHook: s
  } = e, [m, _] = i.useState(!1), E = (0, d.ZP)(n), x = s(E), C = y(n.content), v = i.useCallback(() => {
    null != C && f.S.dispatchToLastSubscribed(g.CkL.INSERT_TEXT, {
