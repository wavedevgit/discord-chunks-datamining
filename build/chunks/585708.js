...
function b(e, t, n, b) {
  ...
  return {
    ...
    onNotificationShow: () => {
      b && (0, c.GN)(u.Ay, u.yk), N()
    },
    onNotificationClick: () => {
      let n = (0, h.getPID)();
      (0, l.In)(e.id, !0, !0, t.id, {
        section: y.jXE.OVERLAY
      }), f.ZP.isInputLocked(n) ? (C("unlock"), r.Z.setInputLocked(!1, n)) : (C("jump"), (0, s.uL)(y.Z5c.CHANNEL(e.guild_id, e.id, t.id)), d.isPlatformEmbedded && p.ZP.focus())
    },
    onDismissClick: () => {
      C("dismiss")
    }
