...
function b(e, t, n, b) {
  ...
  return {
    ...
    maxBodyLines: 2,
    renderFooter: (n, r, o) => n && !o ? (0, i.jsx)(f.Z, {
      id: r,
    ...
    onNotificationClick: () => {
      ...
      }), h.default.isInputLocked(n) ? (C("unlock"), r.Z.setInputLocked(!1, n)) : (C("jump"), (0, c.uL)(O.Z5c.CHANNEL(e.guild_id, e.id, t.id)), u.isPlatformEmbedded && d.ZP.focus())
    },
    onDismissClick: () => {
      C("dismiss")
    }
