...
let b = e => {
  let {
    ...
    success_node_id: y,
    fail_node_id: Z
  } = n, [O, I] = l.useState(N), [C, P] = l.useState(void 0), [S, T] = l.useState(void 0), [k, E] = l.useState([]), [w, W] = l.useState(void 0), [D, R] = l.useState(void 0), A = e => {
    var n, r, l;
    let {
      destination: a
    } = e, [, s] = a, u = j[s];
  ...
  return (0, r.jsx)(a.Y0X, {
    ...
    children: (0, r.jsx)(a.MyZ, {
      ...
      activeSlide: O,
      centered: !1,
      children: B.map(e => (0, r.jsx)(a.Mi4, {
        id: e.id,
