...
let g = e => {
  let {
    ...
    success_node_id: y,
    fail_node_id: I
  } = n, [O, T] = a.useState(C), [Z, N] = a.useState(void 0), [S, P] = a.useState(void 0), [k, E] = a.useState([]), [M, w] = a.useState(void 0), [A, D] = a.useState(void 0), R = e => {
    var n, r, a;
    let {
      destination: l
    } = e, [, s] = l, u = j[s];
  ...
  return (0, r.jsx)(l.Y0X, {
    ...
    children: (0, r.jsx)(l.MyZ, {
      ...
      activeSlide: O,
      centered: !1,
      children: z.map(e => (0, r.jsx)(l.Mi4, {
        id: e.id,
