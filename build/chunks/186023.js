...
let g = e => {
  let {
    ...
    success_node_id: y,
    fail_node_id: O
  } = n, [I, T] = a.useState(C), [Z, S] = a.useState(void 0), [N, P] = a.useState(void 0), [k, E] = a.useState([]), [M, w] = a.useState(void 0), [R, D] = a.useState(void 0), A = e => {
    var n, r, a;
    let {
      destination: o
    } = e, [, s] = o, u = j[s];
