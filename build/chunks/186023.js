...
let x = e => {
  let {
    ...
    success_node_id: O,
    fail_node_id: Z
  } = n, [I, C] = l.useState(y), [S, N] = l.useState(void 0), [T, P] = l.useState(void 0), [E, k] = l.useState([]), [D, R] = l.useState(void 0), [w, M] = l.useState(void 0), A = e => {
    var n, r, l;
    let {
      destination: a
    } = e, [, o] = a, u = j[o];
  ...
  return (0, r.jsx)(a.Y0X, {
    ...
    children: (0, r.jsx)(a.MyZ, {
      ...
      activeSlide: I,
      centered: !1,
      children: U.map(e => (0, r.jsx)(a.Mi4, {
        id: e.id,
