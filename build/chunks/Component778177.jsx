...
let q = (e, t, n) => {
    ...
    let c = T.default.getUser(s.id),
      ...
      p = null != (o = null != (i = y.ZP.getNick(d, s.id)) ? i : _) ? o : C.ZP.getName(s),
...
class er extends Chunk647438.PureComponent {
  componentDidUpdate(e, t) {
    ...
    null != i.filter && null == o.mode.filter && r > 0 ? this.setSelectedIndex(0) : i.type === M.Sap.FILTER_ALL && o.mode.type !== i.type ? this.setSelectedIndex(false) : this.keepCurrentOptionSelected(e, t)
  }
  setSelectedIndex(e) {
    this.setState({
      selectedIndex: e
