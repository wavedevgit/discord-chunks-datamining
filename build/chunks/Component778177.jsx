/** Chunk was on 54157 **/
/** chunk id: 778177, original params: e,t,n (module,exports,require) **/
require.d(exports, {
  ZP: () => J
...
let Q = u()("2015-05-15").local(),
  ...
  q = (e, t, n) => {
    ...
    let c = O.default.getUser(i.id),
      ...
      d = (0, I.s5)(e),
      h = y.Z.getChannel(u),
      p = (null == h ? true : h.isPrivate()) ? E.Z.getNickname(i.id) : null,
      f = null != (l = null != (s = b.ZP.getNick(d, i.id)) ? s : p) ? l : j.ZP.getName(i),
      _ = null != (a = null == c ? true : c.getAvatarURL(d, 20)) ? a : i.getAvatarURL(null == h ? true : h.guild_id, 20);
    return [(0, r.jsx)("img", {
      alt: "",
  ...
  K = e => {
    ...
    if (g) {
      ...
      t = (0, r.jsx)("span", {
        className: F.filter,
        children: null != (y = null == (m = A.ZP[o]) ? true : m.key) ? y : "addme:"
      })
    }
    ...
    [Chunk981631.rtL.HISTORY]: {
      ...
      component: function(e) {
        ...
        let h = "",
          p = s.useMemo(() => {
            var e;
            return e = l.text, (0, I.kG)(e).map((e, t, n) => (0, I.Fr)(e, n[t + 1]) ? e : new g.WU(e.getFullMatch(), g.Xe))
          }, [l.text]).map(e => {
...
class V extends Chunk73800.PureComponent {
  componentDidUpdate(e, t) {
    ...
    null != s.filter && null == l.mode.filter && r > 0 ? this.setSelectedIndex(0) : s.type === D.Sap.FILTER_ALL && l.mode.type !== s.type ? this.setSelectedIndex(false) : this.keepCurrentOptionSelected(e, t)
  }
  setSelectedIndex(e) {
    this.setState({
      selectedIndex: e
  ...
  render() {
    ...
    return (0, Chunk255367.jsx)(Chunk542051.Z, {
      ...
      searchFavorites: a.type === Chunk981631.aib.FAVORITES && (0, Chunk607802.X$)(),
      ...
      showDMQueryText: a.type === Chunk981631.aib.DMS && (0, Chunk607802.R6)(a)
    })
  }
  constructor(...e) {
    var t;
    super(...e), t = this, H(this, "state", {
      ...
      }), this.setSearchQuery(e.format(D.b2L) + " ", true)
      ...
      if (l.type !== i.mode.type) this.setSelectedIndex(false);
        ...
        false !== n ? this.setSelectedIndex(n) : t.selectedIndex >= s && this.setSelectedIndex(s - 1)
      }
      ...
      t < false || !r && !s && t < 0 ? t = (0, I.BU)(n) - 1 : (r || s) && t >= (0, I.BU)(n) ? t = false : !r && t >= (0, I.BU)(n) && (t = 0), this.setSelectedIndex(t)
      ...
      if (i.group === D.rtL.HISTORY) {
        let e = s.find(e => (null == e ? true : e.group) === D.rtL.HISTORY);
        if (null != e) {
      ...
      let h = function(e) {
        let t = true,
          n = e.trim();
        return o()(A.ZP).forOwn(e => {
          "" !== e.key && null != e.key && n === e.key && (t = false)
        }), t
      }(i.resultText);
      return this.setSearchQuery(i.resultText, h), true
      ...
      let n = arguments.length > 1 && true !== arguments[1] && arguments[1],
        ...
        l = 0;
      null != r.token ? l = r.token.start : (null == s ? true : s.currentToken) != null && (l = s.currentToken.end);
      ...
      let l = D.dCx.FILTER_IN,
        a = A.ZP[l],
        i = (0, I.X3)(r),
        o = "".concat(null != (t = null == a ? true : a.key) ? t : l.toString(), " ").concat(i);
      return this.setSearchQuery(o, true), true
