...
function O(e, t, n) {
  return u.ZP.get("iar_skip_api_report_submit") ? Promise.resolve() : o.s.REPORT_TO_MOD.has(t.name) ? I(e, t, n) : v(e, t, n)
}
...
let L = (e, t, n) => {
  ...
  x = (e, t, n, r) => {
    ...
    } else if (t.name === d.b.USER) return m(p({}, l, s), {
      name: t.name,
      user_id: t.record.id,
      guild_id: t.contextualGuildId
    });
    else if (t.name === d.BM.USER) return m(p({}, l, s), {
      name: t.name,
      user_id: t.record.id,
      guild_id: t.contextualGuildId,
      email_token: r
    });
    else if (t.name === d.BM.MESSAGE) return m(p({}, l, s), {
      name: t.name,
      message_id: t.record.id,
      email_token: r
    });
    else if (t.name === d.BM.GUILD) return m(p({}, l, s), {
      name: t.name,
      guild_id: t.record.id,
      email_token: r
    });
    else if (t.name === d.b.APPLICATION) return m(p({}, l, s), {
      name: t.name,
