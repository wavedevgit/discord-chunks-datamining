...
let E = e => {
  ...
  let {
    channel: a
  } = e, h = (0, u.ZP)(), E = (0, c.wj)(h), R = (0, o.e7)([j.Z], () => j.Z.getGuild(a.guild_id)), k = (0, o.e7)([m.Z], () => m.Z.useReducedMotion), M = (0, o.e7)([g.Z], () => g.Z.hasHidden(a.id)), Z = (0, p.C)({
    guildId: a.guild_id,
    channelId: a.id
  }), {
    transitions: A,
    setVisible: L
  } = (0, _.H)(), F = i.useCallback(() => {
        ...
        children: [(0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)("div", {
            ...
            children: [(0, r.jsxs)(d.Text, {
              ...
              children: [y.intl.string(y.t.NChGw8), " ", (0, r.jsx)("span", {
                role: "img",
                "aria-label": "",
                children: "\uD83D\uDD25"
              })]
