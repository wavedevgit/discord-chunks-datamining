...
let E = e => {
  ...
  let {
    channel: l
  } = e, h = (0, u.ZP)(), E = (0, c.wj)(h), k = (0, o.e7)([j.Z], () => j.Z.getGuild(l.guild_id)), R = (0, o.e7)([m.Z], () => m.Z.useReducedMotion), Z = (0, o.e7)([g.Z], () => g.Z.hasHidden(l.id)), M = (0, p.C)({
    guildId: l.guild_id,
    channelId: l.id
  }), {
    transitions: A,
    setVisible: L
  } = (0, C.H)(), F = i.useCallback(() => {
