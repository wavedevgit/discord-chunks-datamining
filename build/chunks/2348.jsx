...
function y(e) {
  ...
  return "null" === i.id ? <div className={a()(v.categoryRow, v.uncategorized)}><o.Text className={v.categoryText} color={"text-muted"} variant={"text-xs/semibold"} lineClamp={1}>{i.name}</o.Text></div> : <o.P3F className={a()(v.categoryRow, {
      [v.uncategorized]: "null" === i.id
    })} onContextMenu={e => {
      (0, c.jW)(e, async () => {
        let {
          default: e
        } = await Promise.all([n.e("8965"), n.e("23899")]).then(n.bind(n, 139035));
    ...
    }), true)}>{<o.Text className={v.categoryText} color={"text-muted"} variant={"text-xs/semibold"} lineClamp={1}>{i.name}</o.Text>}{<o.XZJ aria-checked={l} value={l} type={o.XZJ.Types.INVERTED} className={v.checkbox} displayOnly={true} />}</o.P3F>
}
let C = Chunk73800.memo(function() {
    return <div className={Chunk448021.separator} />
  }),
  N = Chunk73800.memo(function(e) {
    let {
      index: t
    } = e;
    return <o.Text variant={"text-xs/normal"} className={v.subtitleSeparator}>{"\xb7"}</o.Text>
  }),
  I = Chunk73800.memo(function(e) {
    let {
      ...
      t.isGuildVocal() ? (0, c.jW)(e, async () => {
        let {
          default: e
        } = await Promise.all([n.e("79695"), n.e("18320"), n.e("83331"), n.e("5442")]).then(n.bind(n, 213202));
        return n => <e{...O(_({}, n), {
          channel: t,
          guild: l
        })} />
        ...
        let {
          default: e
        } = await Promise.all([n.e("79695"), n.e("25548"), n.e("46154"), n.e("91315"), n.e("16459"), n.e("49152"), n.e("18320"), n.e("14826")]).then(n.bind(n, 373651));
        return n => <e{...O(_({}, n), {
          channel: t,
          guild: l
        })} />
    ...
    return <r.Fragment>{<o.ua7 text={null != T ? T : P} delay={500} position={I}>{e => (0, r.jsxs)(o.P3F, O(_({
...
function E(e) {
  let {
    ...
    return <y channel={i.channel} guild={n} />
  }, [t, n]), o = i.useCallback((e, i) => {
    let l = t._categories[e],
      s = t[l.channel.id][i];
    return null == s ? null : <I category={l.channel} channel={s.channel} guild={n} isFirstChannel={0 === i} isLastChannel={t[l.channel.id].length - 1 === i} tooltipDirection={a ? "right" : "top"} />
  }, [t, n, a]), c = (0, p.tn)(n.id, t, 64);
  return <div className={l}>{c.map((e, t) => {
      let n = s(t),
        i = [],
        l = e.rowCount;
      if (0 === l) return null;
