...
function r(e) {
  let t = function(e) {
    ...
    let {
      ...
      return o
    }, x = I(h, m, (s >> 18 & 31) / 31), P = I(3, 3, (u >> 3 & 63) / 63 * 1.25), S = I(3, 3, (u >> 9 & 63) / 63 * 1.25), C = p && I(5, 5, w), j = (n = (t = e)[3], r = 128 & t[2], ((o = 128 & t[4]) ? r ? 5 : 7 : 7 & n) / (o ? 7 & n : r ? 5 : 7)), T = d(j > 1 ? 32 : 32 * j), k = d(j > 1 ? 32 / j : 32), W = new Uint8Array(T * k * 4), D = [], B = [];
    for (let e = 0, t = 0; e < k; e++)
      for (let n = 0; n < T; n++, t += 4) {
        let r = _,
          ...
          d = b,
          s = v;
        for (let e = 0, t = a(h, p ? 5 : 3); e < t; e++) D[e] = l(c / T * (n + .5) * e);
        for (let t = 0, n = a(m, p ? 5 : 3); t < n; t++) B[t] = l(c / k * (e + .5) * t);
        for (let e = 0, t = 0; e < m; e++)
          for (let n = +!e, o = 2 * B[e]; n * m < h * (m - e); n++, t++) r += x[t] * D[n] * o;
        for (let e = 0, t = 0; e < 3; e++)
          for (let n = +!e, r = 2 * B[e]; n < 3 - e; n++, t++) {
            let e = D[n] * r;
            o += P[t] * e, d += S[t] * e
          }
        if (p)
          for (let e = 0, t = 0; e < 5; e++)
            for (let n = +!e, r = 2 * B[e]; n < 5 - e; n++, t++) s += C[t] * D[n] * r;
        let u = r - 2 / 3 * o,
          g = (3 * r - u + d) / 2,
          w = g - d;
