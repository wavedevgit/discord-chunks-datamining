...
function r(e) {
  let t = function(e) {
    ...
    let {
      ...
      cos: a,
      round: c
    } = Math, d = e[0] | e[1] << 8 | e[2] << 16, u = e[3] | e[4] << 8, f = (63 & d) / 63, m = (d >> 6 & 63) / 31.5 - 1, h = (d >> 12 & 63) / 31.5 - 1, x = d >> 23, g = u >> 15, p = o(3, g ? x ? 5 : 7 : 7 & u), _ = o(3, g ? 7 & u : x ? 5 : 7), v = x ? (15 & e[5]) / 15 : 1, j = (e[5] >> 4) / 15, b = x ? 6 : 5, C = 0, S = (t, n, r) => {
      let l = [];
      for (let i = 0; i < n; i++)
