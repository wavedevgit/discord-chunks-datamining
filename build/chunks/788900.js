  ...
  let t = function(e) {
    ...
    let n, r, i, {
      ...
      y = (t, n, r) => {
        let i = [];
        for (let l = 0; l < n; l++)
          for (let s = +!l; s * n < t * (n - l); s++) i.push(((e[_ + (S >> 1)] >> ((1 & S++) << 2) & 15) / 7.5 - 1) * r);
        return i
      },
      C = y(x, v, (d >> 18 & 31) / 31),
      ...
      Z = m && y(5, 5, j),
      P = (n = (t = e)[3], r = 128 & t[2], ((i = 128 & t[4]) ? r ? 5 : 7 : 7 & n) / (i ? 7 & n : r ? 5 : 7)),
      I = c(P > 1 ? 32 : 32 * P),
      E = c(P > 1 ? 32 / P : 32),
    ...
    for (let e = 0, t = 0; e < E; e++)
      for (let n = 0; n < I; n++, t += 4) {
        ...
        for (let t = 0, n = o(v, m ? 5 : 3); t < n; t++) A[t] = a(l / E * (e + .5) * t);
        for (let e = 0, t = 0; e < v; e++)
          for (let n = +!e, i = 2 * A[e]; n * v < x * (v - e); n++, t++) r += C[t] * N[n] * i;
