  ...
  let t = function(e) {
    ...
    let r, n, l, {
      ...
      j = (t, r, n) => {
        let l = [];
        for (let o = 0; o < r; o++)
          for (let i = +!o; i * r < t * (r - o); i++) l.push(((e[w + (P >> 1)] >> ((1 & P++) << 2) & 15) / 7.5 - 1) * n);
        return l
      },
      S = j(h, m, (c >> 18 & 31) / 31),
      D = j(3, 3, (d >> 3 & 63) / 63 * 1.25),
      I = j(3, 3, (d >> 9 & 63) / 63 * 1.25),
      E = v && j(5, 5, y),
    ...
    for (let e = 0, t = 0; e < C; e++)
      for (let r = 0; r < k; r++, t += 4) {
        let n = f,
          ...
          s = b,
          c = O;
        for (let e = 0, t = u(h, v ? 5 : 3); e < t; e++) M[e] = a(o / k * (r + .5) * e);
        for (let t = 0, r = u(m, v ? 5 : 3); t < r; t++) R[t] = a(o / C * (e + .5) * t);
        for (let e = 0, t = 0; e < m; e++)
          for (let r = +!e, l = 2 * R[e]; r * m < h * (m - e); r++, t++) n += S[t] * M[r] * l;
