...
class E extends(r = o.PureComponent) {
  ...
  constructor(e) {
    super(e), s(this, "draggableRef", o.createRef()), s(this, "_dragStart", {
      ...
      2 === s && O !== this.state.horizontalOrientation && (this._offsetX = I - this._offsetX, v = !0), 2 === a && y !== this.state.verticalOrientation && (this._offsetY = T - this._offsetY, v = !0), this.setDOMPositions(S), b || null == u || u(S, r), null == f || f(S, r), v && (null == h || h([y, O])), this.setState({
        dragging: E,
        verticalOrientation: y,
        horizontalOrientation: O,
        atTopEdge: 0 === S.top
