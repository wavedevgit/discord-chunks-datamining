...
class E extends(r = o.PureComponent) {
  ...
  constructor(e) {
    super(e), s(this, "draggableRef", o.createRef()), s(this, "_dragStart", {
      ...
      2 === s && O !== this.state.horizontalOrientation && (this._offsetX = I - this._offsetX, v = !0), 2 === a && y !== this.state.verticalOrientation && (this._offsetY = S - this._offsetY, v = !0), this.setDOMPositions(T), b || null == u || u(T, r), null == f || f(T, r), v && (null == h || h([y, O])), this.setState({
        dragging: E,
        verticalOrientation: y,
        horizontalOrientation: O,
        atTopEdge: 0 === T.top
