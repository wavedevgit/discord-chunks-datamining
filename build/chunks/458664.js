...
function z(e) {
  var t;
  return {
    releasePhase: null == e || null == (t = e.activity) ? true : t.client_platform_config[(0, M.A)((0, A.getOS)())].release_phase
  }
}
...
function $(e) {
  ...
  let w = E.A.getMediaSessionId(),
    ...
    P = null == w && (null == T ? true : T.isVocal()) === true && (null == T ? true : T.isPrivate()) === false;
  if (null == R || P) return;
  let D = (0, i.A)(),
    L = "location" in c ? 2 : 1,
  ...
  Y[r] = Z;
  let Q = W[r];
  (0, I.uJ)(y.nonce) || y.nonce === (null == Q ? true : Q.nonce) || (Q = true), O.default.track(V.HAw.ACTIVITY_SESSION_JOINED, {
    channel_id: v,
    guild_id: A,
    ...
    is_activity_start: o,
    release_phase: H,
    shelf_rank: null == F || null == (t = F.activity) ? true : t.shelf_rank,
    ...
    raw_thermal_state: K,
    is_activity_start: o,
    shelf_rank: null == F || null == (n = F.activity) ? true : n.shelf_rank,
    shelf_sorted_rank: B > 0 ? B : null,
...
class et extends Chunk272355.A {
  _initialize() {
  ...
  constructor(...e) {
    super(...e), B(this, "handleSelectedChannelUpdate", () => {
      ...
      if (!(0, j.A)(null == d || null == (r = d.embedded_activity_config) ? true : r.supported_platforms)) return void this.showLaunchErrorModal(F.intl.string(F.t.uGDCcw));
      ...
      (null != (n = null == E ? true : E.userIds.size) ? n : 0) > 0 ? await (0, R.E)({
        channelId: i,
        applicationId: a,
