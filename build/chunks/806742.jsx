...
let j = function(e) {
  ...
  return (0, c.pw)(l) ? <o.zxk variant={"primary"} size={"sm"} text={h.intl.string(h.t["9Z+aEB"])} onClick={j} /> : <o.P3F className={f.editWelcomeSection} onClick={j}>{<d.Z guildId={t} welcomeMessage={{
        authorIds: l.authorIds.length > 0 ? l.authorIds : [v],
        message: l.message
      }} />}{<o.ua7 text={h.intl.string(h.t.bt75u7)}>{e => (0, r.jsxs)("div", x(b({}, e), {
