...
function A(e) {
  ...
  } = e, L = (0, c.e7)([v.default], () => {
    let e = v.default.getCurrentUser();
    return o()(null != e, "StreamSettings: user cannot be undefined"), e
  }), D = (0, c.e7)([j.Z, _.Z], () => _.Z.getChannel(j.Z.getVoiceChannelId())), G = b.ZP.canStreamQuality(b.U2.MID, L), {
    location: B
  } = (0, f.O)(), U = (0, m.Zq)({
    autoTrackExposure: !1
  }), z = (0, p.B4)(), W = v.default.getUser(null == D ? void 0 : D.hdStreamingBuyerId), F = null != D && null != D.hdStreamingUntil && new Date(D.hdStreamingUntil) > new Date && null != W, H = !G && !U, [V, Y] = l.useState(!1), J = M ? y.z8 : y.WC, X = E(T({}, B), {
  ...
  }], $ = n === y.tI.PRESET_DOCUMENTS ? (0, r.jsxs)(r.Fragment, {
