...
function A(e) {
  let {
    ...
    autoTrackExposure: !1
  }), W = (0, x.B4)(), z = j.default.getUser(null == D ? void 0 : D.hdStreamingBuyerId), F = null != D && null != D.hdStreamingUntil && new Date(D.hdStreamingUntil) > new Date && null != z, H = !B && !G, [V, Y] = l.useState(!1), J = M ? y.z8 : y.WC, X = T(E({}, U), {
