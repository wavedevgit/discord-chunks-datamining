...
function k(e) {
  ...
  return o ? (t = (0, r.jsx)(u.DY3, {
    ...
    children: (0, r.jsx)(u.Text, {
      ...
      className: s()(N.selectorText, {
        [N.enhancedSelectorNitroText]: a
      }),
      children: p
    })
  }), n = () => d(h)), {
...
function M(e) {
  let {
  ...
  } = e, D = (0, c.e7)([b.default], () => {
    let e = b.default.getCurrentUser();
    return a()(null != e, "StreamSettings: user cannot be undefined"), e
  }), B = (0, c.e7)([j.Z, v.Z], () => v.Z.getChannel(j.Z.getVoiceChannelId())), U = S.ZP.canStreamQuality(S.U2.MID, D), {
    location: G
  } = (0, m.O)(), W = (0, h.Zq)({
    autoTrackExposure: !1
  }), F = (0, g.B4)(), z = b.default.getUser(null == B ? void 0 : B.hdStreamingBuyerId), H = null != B && null != B.hdStreamingUntil && new Date(B.hdStreamingUntil) > new Date && null != z, V = !U && !W, [Y, X] = i.useState(!1), J = L ? O.z8 : O.WC, K = P(E({}, G), {
  ...
  }], ee = n === O.tI.PRESET_DOCUMENTS ? (0, r.jsxs)(r.Fragment, {
    ...
    }) : null, F && (0, r.jsx)(y.c, {}), H && null != B.hdStreamingUntil && (0, r.jsx)(_.Z, {
