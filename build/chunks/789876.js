...
! function(t) {
  ...
  } else o.requestIdleCallback = A, o.cancelIdleCallback = C, o.document && document.addEventListener && (o.addEventListener("scroll", O, true), o.addEventListener("resize", O), document.addEventListener("focus", O, true), document.addEventListener("mouseover", O, true), ["click", "keypress", "touchstart", "mousedown"].forEach(function(e) {
