...
function j(e) {
  ...
  let I = o === C.gq.SOCIAL_LAYER_INTEGRATION_LINKED_CHANNEL ? p.intl.formatToPlainString(p.t["2VQq2t"], {
    channelName: null != d ? d : p.intl.string(p.t.zLZPmp)
  }) : o === C.gq.BOT ? p.intl.string(p.t["2ByN2t"]) : p.intl.string(p.t.azhY2t);
