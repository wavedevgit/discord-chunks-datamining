...
let b = Chunk73800.memo(function() {
    return (0, Chunk255367.jsx)(Chunk481060.ua7, {
      ...
      children: e => (0, r.jsx)(o.Text, D(v({}, e), {
...
function P(e) {
  ...
  } = e, E = (0, a.e7)([m.Z], () => m.Z.getChannel(c)), _ = (0, d.ZP)(E, true), A = !!n && (u === R.gq.SOCIAL_LAYER_INTEGRATION_LINKED_CHANNEL || null != i), T = l.useMemo(() => u === R.gq.SOCIAL_LAYER_INTEGRATION_LINKED_CHANNEL ? (0, r.jsx)(M, {
    channel: E
  }) : (0, r.jsx)(U, {
    guildId: s,
    inviterUser: i,
...
let w = Chunk73800.memo(function(e) {
  ...
  return (I === R.gq.INVITE || I === R.gq.VANITY_URL || I === R.gq.MANUAL_MEMBER_VERIFICATION && null != m) && A ? (0, r.jsx)(L, {}) : (0, r.jsx)(P, {
    hasTooltip: C && !o,
    inviterUser: null != _ ? _ : null,
    guildId: i,
    joinSourceType: I,
    joinSourceChannelId: N,
    children: e => (0, r.jsx)(y, v({
      sourceInviteCode: m,
      joinSourceType: I,
      joinSourceApplicationId: h,
      joinSourceChannelId: N,
