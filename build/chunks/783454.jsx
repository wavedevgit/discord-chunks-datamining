...
function g(e) {
  ...
  return <div className={m.container}>{<d.Z className={a()(m.header, {
      ...
      }}</d.Z>}{p && <div id={b}>{null != l && <s.R94 type={s.R94.Types.DESCRIPTION} className={m.description}>{l}</s.R94>}{<div className={m.divider} />}{<div className={m.content}>{g}</div>}</div>}</div>
}