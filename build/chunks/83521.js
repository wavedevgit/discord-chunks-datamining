...
function b(e) {
  ...
  let {
    ...
    transitionState: N,
    onClose: P
  } = e, y = (0, i.e7)([s.Z], () => s.Z.getGuild(b), [b]), C = (0, d.Cc)(null != b ? b : null), w = (0, i.e7)([c.default], () => c.default.getCurrentUser(), []), [_, S] = t.useState(!0), k = (0, o.ZP)(), O = t.useCallback(async () => {
    _ && await (0, u.nE)(b, !0, x.Sbl.CLAN_ADOPT_IDENTITY_MODAL), P(v.L.PRIMARY)
  }, [_, P, b]), T = t.useCallback(() => {
    P(v.L.DISMISS)
  }, [P]);
  t.useEffect(() => ((null == y || null == w) && P(v.L.AUTO_DISMISS), () => {}), [w, y, b, P]);
  let I = (0, m.nP)(null == C || null == (n = C.branding) ? void 0 : n.primaryColor, [a.TVs.colors.BG_BRAND, .7]),
  ...
  let z = M ? j.NW.format(j.t["hyP/19"], {
      guildName: y.name
    }) : j.NW.format(j.t.h1CclZ, {
      guildName: y.name
    }),
    A = M ? j.NW.formatToPlainString(j.t["x+B7c3"], {
      guildName: y.name
