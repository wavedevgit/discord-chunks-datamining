...
function b(e) {
  ...
  let {
    ...
    transitionState: N,
    onClose: P
  } = e, y = (0, i.e7)([o.Z], () => o.Z.getGuild(b), [b]), C = (0, d.Cc)(null != b ? b : null), w = (0, i.e7)([c.default], () => c.default.getCurrentUser(), []), [_, k] = r.useState(!0), S = (0, s.ZP)(), O = r.useCallback(async () => {
