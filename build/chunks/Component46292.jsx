...
let x = e => {
  ...
  let h = C === f.PremiumTypes.TIER_0,
    [v, O] = n.useState(m.g.CONFIRM),
    w = n.useCallback(() => {
      switch (v) {
        case m.g.CONFIRM:
          return (0, a.jsx)(u.m, S(g({}, e), {
            setStep: O
          }));
        case m.g.SUCCESS:
          return (0, a.jsx)(y.B, S(g({}, e), {
            premiumType: C
          }));
        default:
          return (0, a.jsx)(u.m, S(g({}, e), {
  ...
  return (0, a.jsx)(l.f5, {
    ...
    children: (0, a.jsx)(s.PaymentContextProvider, {
      ...
      children: (0, a.jsx)(c.Mq, {
        children: (0, a.jsx)(b.A, {
          isConfirmationStep: v === m.g.SUCCESS,
