...
function M(e) {
  ...
  let {
    ...
    channel: m,
    width: g
  } = e, b = g > 400 ? 2 : +(g > 300), [E] = g > 400 ? [c.EFr.SIZE_56, 56] : g > 300 ? [c.EFr.SIZE_32, 32] : [c.EFr.SIZE_24, 24], v = (0, o.Wu)([P.default, j.default], () => Array.from(l).map(e => (0, f.J)(e, j.default) ? null : P.default.getUser(e.userId)).filter(x.lm)), h = (0, o.e7)([u.ZP], () => {
    var e;
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsx)(D, {
      ...
      children: v.length > 1 ? T.intl.formatToPlainString(T.t.cpe6CK, {
        username: C,
        count: v.length - 1
