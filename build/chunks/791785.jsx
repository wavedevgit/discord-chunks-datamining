...
function J(e) {
  ...
  return <c.UkV className={Y.shaker} isShaking={ed && eb === x.A.PURCHASING} intensity={X}><c.Y0X data-migration-pending={true} className={a()(Y.root, eG, {
        [Y.withHeader]: null != e3
      })} transitionState={N} hideShadow={ep} returnRef={eh} size={eW} parentComponent={"PaymentModal"}><Z.ZP{...K({
        header: e3,
...
function $(e) {
  ...
  }, [c, u, f, C, n, S, o, t, E, b, T, y, v, I]), S) ? <B.Z /> : f ? <m.Vq onClose={s} /> : null
}
