...
function U(e) {
  ...
  } = e, p = (0, o.e7)([y.Z], () => y.Z.getChannel(n.parent_id)), j = n.id, v = a.useRef(null), P = (0, o.e7)([_.ZP], () => _.ZP.getCurrentSidebarChannelId(n.parent_id) === n.id), {
    firstMessage: E,
    loaded: B
  } = (0, S.cl)(n), {
    firstMedia: H
    ...
    children: [(0, r.jsx)(d.P3F, z({
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: (0, r.jsx)(d.X6q, {
          ...
          style: {
            width: "".concat(h.width - 2 * I.I8, "px")
          },
          children: ei
        })
      })]
...
function V(e) {
  let {
    ...
    facepileRef: n,
    firstMessage: a
  } = e, l = (0, m.Q)(t.id), i = (null == a ? void 0 : a.reactions) != null && a.reactions.length > 0;
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      className: D.controlsGroup,
      children: [i || null == a ? null : (0, r.jsx)(T.kZ, {
        firstMessage: a,
        channel: t
      }), null == a ? null : (0, r.jsx)(T.au, {
        firstMessage: a,
        channel: t
      })]
    })]
...
let G = e => e.preventDefault(),
  ...
  W = a.memo(function(e) {
    let {
      ...
      containsVideo: u,
      containsGif: m
    } = a.useMemo(() => (0, N.cp)(t), [t]), b = a.useMemo(() => t.slice(E.$x, E.GV), [t]), j = (0, E.tu)({
      ...
      containerWidth: l,
      containerHeight: s
    }), C = (0, f.kh)(g.n.GUILD), _ = a.useMemo(() => b.map((e, t) => {
      var a;
      let [l, s] = (0, p.As)(e, !n, C), g = (0, p.MC)(s), f = B(z({}, v[t]), {
        src: e.src,
        width: e.width,
        height: e.height,
      ...
      }), b = (0, x.d$)(e.src) ? "".concat(e.src, "?format=png") : e.src, _ = o && !l ? e.src : b;
      return (0, r.jsxs)("div", {
...
function K(e) {
  let {
    ...
    width: u,
    height: m
  }), [u, m]), x = o ? D.textContentUnread : D.textContentRead;
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      className: i()(D.textContentFooter, {
        [D.noTags]: !g
      }),
