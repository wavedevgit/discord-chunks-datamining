...
function U(e) {
  ...
  } = e, p = (0, o.e7)([y.Z], () => y.Z.getChannel(n.parent_id)), j = n.id, v = i.useRef(null), T = (0, o.e7)([C.ZP], () => C.ZP.getCurrentSidebarChannelId(n.parent_id) === n.id), {
    firstMessage: E,
    loaded: B
  } = (0, S.cl)(n), {
    firstMedia: H
...
function V(e) {
  let {
    ...
    facepileRef: n,
    firstMessage: i
  } = e, a = (0, m.Q)(t.id), l = (null == i ? void 0 : i.reactions) != null && i.reactions.length > 0;
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      className: D.controlsGroup,
      children: [l || null == i ? null : (0, r.jsx)(P.kZ, {
        firstMessage: i,
        channel: t
...
let G = e => e.preventDefault(),
  ...
  W = i.memo(function(e) {
    let {
      ...
      containsVideo: u,
      containsGif: m
    } = i.useMemo(() => (0, N.cp)(t), [t]), b = i.useMemo(() => t.slice(E.$x, E.GV), [t]), j = (0, E.tu)({
...
function K(e) {
  let {
    ...
    containerWidth: s,
    hasUnreads: o
  } = e, c = _.jU.useSetting(), [u, m] = (0, I.rI)(s - 2 * I.LT), {
    content: h
  } = (0, w.mX)({
    firstMessage: n,
    formatInline: !1,
