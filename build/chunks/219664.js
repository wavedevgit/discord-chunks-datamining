...
function U(e) {
  ...
  return (0, r.jsxs)("div", {
    ...
    children: [(0, r.jsxs)("div", {
      ...
      className: F.controlsGroup,
      children: [a || null == l ? null : (0, r.jsx)(P.kZ, {
        firstMessage: l,
        channel: t
      }), null == l ? null : (0, r.jsx)(P.au, {
        firstMessage: l,
        channel: t
      })]
    })]
...
let V = e => e.preventDefault(),
  ...
  q = l.memo(function(e) {
    let {
      ...
      containerWidth: i,
      containerHeight: s
    }), v = (0, g.m)(), C = l.useMemo(() => p.map((e, t) => {
      var l;
      let [i, s] = (0, x.As)(e, !n, v), g = (0, x.MC)(s), p = z(D({}, j[t]), {
        src: e.src,
        width: e.width,
        height: e.height,
