...
function M(e) {
  let {
    channel: t
  } = e, [n, l] = i.useState(!1), o = (0, m.ZP)(t, !0), M = t.guild_id, D = (0, d.e7)([v.Z], () => null != M ? v.Z.getRoles(M) : void 0), k = (0, d.e7)([E.default, O.Z], () => {
    var e;
  ...
  }, [t, k]), F = j.Z.can(N.Plq.MANAGE_CHANNELS, t) || j.Z.can(N.Plq.MANAGE_ROLES, t), H = i.useCallback(() => l(!1), []);
