...
function R(e) {
  let {
    channel: t
  } = e, [n, l] = i.useState(!1), o = (0, f.ZP)(t, !0), R = t.guild_id, M = (0, u.e7)([x.Z], () => null != R ? x.Z.getSortedRoles(R) : void 0), D = (0, u.e7)([O.default, v.Z], () => {
    var e;
    return O.default.getUser(null == (e = v.Z.getGuild(R)) ? void 0 : e.ownerId)
  }), k = i.useMemo(() => null != M ? M.filter(e => !(0, C.fI)(e)) : [], [M]), L = i.useMemo(() => s()(k).filter(e => {
    if (null == R) return !1;
    let n = E.I0({
      forceRoles: {
        [e.id]: e
  ...
  }).value(), [t, R, k]), U = (0, u.Wu)([O.default], () => {
    let e = {};
  ...
  }, [t, D]), B = j.Z.can(T.Plq.MANAGE_CHANNELS, t) || j.Z.can(T.Plq.MANAGE_ROLES, t), F = i.useCallback(() => l(!1), []);
