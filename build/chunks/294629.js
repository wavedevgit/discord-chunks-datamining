...
function u(e) {
  ...
  let {
    ...
    permissionStore: _ = s.Z,
    impersonateStore: f = i.Z
  } = e, p = null != n ? u.getVoiceState(n.getGuildId(), r.getId()) : null, h = d.isSelfMute() || d.isSelfMutedTemporarily(), m = null == n ? void 0 : n.getGuildId(), g = f.isViewingRoles(m) && !_.can(c.Plq.SPEAK, n);
  return {
    selfMute: h,
