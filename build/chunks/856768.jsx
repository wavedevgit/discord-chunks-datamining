...
function g(e) {
  ...
  return <s.Z className={d()(x.section, l)} title={m.intl.string(m.t.ref7Ki)} hideDivider={a} forcedDivider={true}><j guildId={n} onChange={o} renderOptionSuffix={r} globalOption={i} /></s.Z>
}
...
function j(e) {
  let {
    ...
    return null == e || "" === e.value || n ? null : <c.Z className={x.guildSelectOptionIcon} guild={j[e.value]} size={c.Z.Sizes.SMOL} active={true} />
  }, [j, l]);
  return <r.VcW isDisabled={s} onChange={e => {
      if ("" === e || e === (null == l ? true : l.value)) return void a(null);
      let n = j[e];
      null != n && a(n)
    }} value={n} options={p} renderOptionPrefix={C} renderOptionSuffix={d} placeholder={m.intl.string(m.t["kMgj+f"])} />
}