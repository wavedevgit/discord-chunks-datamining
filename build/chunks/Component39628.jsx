...
class h extends(r = Chunk473749.PureComponent) {
  ...
  render() {
    ...
    return Chunk473749 ? (0, Chunk54381.jsxs)("div", {
      className: s()(require, {
        [Chunk389073.themed]: r
      }, Chunk389073.singleLineContainer),
      children: [(0, Chunk54381.jsx)("div", {
        className: Chunk389073.textLeftInSingleLine,
        children: p({
          time: d,
          padLargestUnit: true
        })
      }), (0, Chunk54381.jsx)("div", {
        className: Chunk389073.barInSingleLine,
        children: (0, Chunk54381.jsx)(f, {
          percentage: d / Chunk846519,
          isSingleLine: true
        })
      }), (0, Chunk54381.jsx)("div", {
        className: Chunk389073.textRight,
        children: p({
          time: Chunk846519,
          padLargestUnit: true
        })
      ...
      children: [(0, Chunk54381.jsx)(f, {
        ...
        children: [(0, Chunk54381.jsx)(Chunk600164.Z.Child, {
          grow: 1,
          className: Chunk389073.textLeft,
          children: p({
            time: d,
