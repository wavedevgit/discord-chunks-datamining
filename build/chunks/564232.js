...
function I(e) {
  ...
  let S = (0, c.e7)([p.ZP], () => p.ZP.getMembers(r.id)),
    v = i.useMemo(() => l()(S).filter(e => !!k.includes(e.userId) && null != g.default.getUser(e.userId)).sortBy(e => {
      var r;
          ...
          return (0, n.jsx)(d.Z, x({
            ...
            onContextMenu: e => {
              (0, u.jW)(e, async () => {
                let {
                  default: e
                } = await Promise.all([t.e("79695"), t.e("26976"), t.e("88606")]).then(t.bind(t, 415118));
                return t => {
                  var s, l;
                  return (0, n.jsx)(e, (s = x({}, t), l = l = {
                    user: i,
                    guildId: r.id,
                    showMediaItems: !0
                  }, Object.getOwnPropertyDescriptors ? Object.defineProperties(s, Object.getOwnPropertyDescriptors(l)) : (function(e, r) {
                    var t = Object.keys(e);
  ...
  return (0, n.jsxs)(o.Y0X, {
    ...
    children: [(0, n.jsxs)(o.xBx, {
      ...
      className: w.content,
      children: [N && (0, n.jsx)(o.$jN, {}), (0, n.jsx)(o.Ttm, {
        children: v
      })]
    })]
  })
