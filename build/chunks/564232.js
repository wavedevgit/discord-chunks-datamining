...
function k(e) {
  ...
  let N = (0, c.e7)([f.ZP], () => f.ZP.getMembers(r.id)),
    Z = i.useMemo(() => l()(N).filter(e => !!v.includes(e.userId) && null != j.default.getUser(e.userId)).sortBy(e => {
      var r;
      ...
      return (0, n.jsx)(o.yRy, {
        preload: () => (0, b.Z)(i.id, i.getAvatarURL(r.id, 80), {
          guildId: r.id
        }),
        renderPopout: t => (0, n.jsx)(m.Z, P(I({}, t), {
          userId: e.userId,
          guildId: r.id
        })),
        spacing: 14,
  ...
  return (0, n.jsxs)(o.Y0X, {
    ...
    children: [(0, n.jsxs)(o.xBx, {
      ...
      className: x.content,
      children: [E && (0, n.jsx)(o.$jN, {}), (0, n.jsx)(o.Ttm, {
        children: Z
      })]
    })]
  })
