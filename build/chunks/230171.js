...
function I(e) {
  let {
    ...
    name: b,
    bot: C
  } = t = (0, O.O)(t), I = null == C ? void 0 : C.id, P = (0, p.ye)(t), A = _.ZP.getApplicationIconURL({
    id: t.id,
    icon: t.icon,
    bot: C
  }), {
    ...
    videoBannerSrc: Z,
    bannerAspectRatio: k
  } = (0, E.E)(t), R = (0, o.e7)([g.default], () => null != h ? h : g.default.getId(), [h]), {
    analyticsLocations: D
  } = (0, u.ZP)(d.Z.APP_MESSAGE_EMBED), L = i.useCallback(e => {
    (0, x.KX)(t.id, a, e, R, l)
  }, [l, R, t.id, a]), M = i.useCallback(() => {
    (0, x.GF)(t.id, a, R, l)
  }, [l, R, t.id, a]), W = i.useCallback(() => {
    (0, x.Yu)(t.id, a)
  }, [t.id, a]), {
    currentChannelId: F,
    instanceId: U,
    isCurrentlyInInstance: B,
    canLaunchInChannel: G
  } = (0, v.c)(t.id), H = (0, c.Z)(), V = (0, f.ms)({
    context: {
      type: "contextless"
    },
    applicationId: t.id,
    botUserId: null == C ? void 0 : C.id
  }), z = null != I && P && V, K = (0, j.z)(t, L), Y = i.useMemo(() => {
    let e = [];
    return G && e.push({
  ...
  }, [l, D, t.id, I, z, G, F, H, U, B, R, L, K]), X = P ? (0, r.jsx)(T, {
    app: t
  }) : (0, r.jsx)(S, {
    app: t
  });
...
function T(e) {
  let {
    ...
    tags: n,
    maxParticipants: i
  } = t, a = null != i ? N.NW.format(N.t.z8EAJS, {
    count: i
  }) : N.NW.string(N.t.RjceQU);
  return (0, r.jsxs)(r.Fragment, {
