...
function j(e) {
  let {
    ...
    name: g,
    bot: O
  } = t = (0, v.O)(t), j = null == O ? void 0 : O.id, I = (0, d.ye)(t), S = h.ZP.getApplicationIconURL({
    id: t.id,
    icon: t.icon,
    bot: O
  }), {
    ...
    videoBannerSrc: P,
    bannerAspectRatio: A
  } = (0, y.E)(t), w = (0, o.e7)([f.default], () => null != m ? m : f.default.getId(), [m]), {
    analyticsLocations: Z
  } = (0, c.ZP)(s.Z.APP_MESSAGE_EMBED), k = i.useCallback(e => {
    (0, b.KX)(t.id, a, e, w, l)
  }, [l, w, t.id, a]), R = i.useCallback(() => {
    (0, b.GF)(t.id, a, w, l)
  }, [l, w, t.id, a]), D = i.useCallback(() => {
    (0, b.Yu)(t.id, a)
  }, [t.id, a]), L = (0, p.ms)({
    context: {
      type: "contextless"
  ...
  }), M = null != j && I && L, W = (0, x.z)(t, k), F = i.useMemo(() => {
    let e = [];
    return M && e.push({
  ...
  }, [l, w, Z, t.id, j, M, k, W]), U = I ? (0, r.jsx)(C, {
    app: t
  }) : (0, r.jsx)(N, {
    app: t
  });
...
function N(e) {
  ...
  let {
    ...
    return 0 === r ? null : E.NW.format(E.t["6IW6Wl"], {
...
function C(e) {
  let {
    ...
    tags: n,
    maxParticipants: i
  } = t, a = null != i ? E.NW.format(E.t.z8EAJS, {
    count: i
  }) : E.NW.string(E.t.RjceQU);
  return (0, r.jsxs)(r.Fragment, {
