...
function k(e) {
  ...
  } = (0, p.ZP)(u.Z.APP_MESSAGE_EMBED), {
    currentChannelId: M,
    instanceId: W,
    isCurrentlyInInstance: F,
    canLaunchInChannel: U
  } = (0, N.c)(t.id), B = (0, d.Z)(), G = (0, h.ms)({
    context: {
      type: "contextless"
    },
    applicationId: t.id,
    botUserId: null == b ? void 0 : b.id
  }), H = null != y && x && G, V = U && x && G, z = (0, A.z)(t), K = i.useMemo(() => {
    let e = [];
    return V && e.push({
  ...
  }, [V, H, z, W, F, M, t.id, B, o, k, L, y]), Y = x ? (0, r.jsx)(D, {
    app: t
  }) : (0, r.jsx)(R, {
    app: t
  });
...
function R(e) {
  ...
  }) && null != c.integrationTypesConfig && a.Y.GUILD_INSTALL in c.integrationTypesConfig, u = (0, l.e7)([b.default], () => b.default.locale, []), p = i.useMemo(() => {
    var e, t;
    if (!d) return null;
  ...
  }, [null === (t = c.directoryEntry) || void 0 === t ? void 0 : t.guild_count, d, u]), m = null === (o = c.categories) || void 0 === o ? void 0 : null === (n = o.at(0)) || void 0 === n ? void 0 : n.name;
...
function D(e) {
  let {
    ...
    if (u.length > 0) return (0, r.jsx)(I.K, {
      activityUsers: u,
      guildId: c,
      activityText: w.NW.string(w.t["IJa+4+"])
    });
    if (d.some(e => (0, g.ig)(e) === o.o.GLOBAL)) return (0, r.jsxs)(r.Fragment, {
