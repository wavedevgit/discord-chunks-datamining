...
function x(e) {
  let {
    ...
    name: g,
    bot: E
  } = t = (0, R.O)(t), y = null == E ? void 0 : E.id, O = (0, p.ye)(t), v = I.ZP.getApplicationIconURL({
    id: t.id,
    icon: t.icon,
    bot: E
  }), {
...
function M(e) {
  ...
  }, [null == (t = c.directoryEntry) ? void 0 : t.guild_count, u, d]), _ = null == (a = c.categories) || null == (n = a.at(0)) ? void 0 : n.name;
