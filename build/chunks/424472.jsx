...
function p(e) {
  ...
  return null == t.categories || 0 === t.categories.length ? null : <div className={n}>{<i.X6q variant={"heading-sm/semibold"} color={"header-primary"}>{d.intl.string(d.t.s7ialZ)}</i.X6q>}{<div className={u.categories}>{t.categories.map(e => (0, r.jsx)(i.P3F, {
