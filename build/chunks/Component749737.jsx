...
class ea extends Chunk64700.Component {
  ...
  render() {
    ...
    let a = !n && !t && this.getAvailableProjects().length > 0,
      s = er(null != i ? i : {}) && "stable" !== window.GLOBAL_ENV.RELEASE_CHANNEL ? (0, r.jsx)(h.Text, {
        color: "text-feedback-critical",
  ...
  constructor(...e) {
    super(...e), Q(this, "state", {
      ...
      let {
        buildOverrides: n
      } = this.state, r = $({}, null != n ? n[e] : {}, t), i = ee($({}, this.state.buildOverrides), {
        [e]: r
      });
      this.setState({
        buildOverrides: i
...
function eo() {
  ...
  } = (0, T.O)(), s = i.useMemo(() => Array.from({
    length: n + 1
  }, (e, t) => t), [n]), o = i.useMemo(() => Array.from({
    length: a + 1
  }, (e, t) => t), [a]), {
  ...
  })), u = (0, N.A)("highlight_void_toggleables"), f = (0, N.A)("highlight_mana_components");
...
function el() {
  ...
  })), u = (0, P.A)("go_back_to_regular_input"), f = V.HZ.useSetting();
  return (0, r.jsxs)(h.nVY, {
...
function em() {
  return (0, r.jsxs)(h.BJc, {
    gap: 24,
    children: [(0, r.jsx)(ea, {}), (0, r.jsx)(c.cGx, {}), (0, r.jsx)(ep, {}), (0, r.jsx)(c.cGx, {}), (0, r.jsx)(e_, {}), (0, r.jsx)(c.cGx, {}), (0, r.jsx)(eh, {})]
  })
}
let eg = function() {
  return (0, r.jsx)(B.R, {
