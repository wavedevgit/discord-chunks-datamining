...
let E = {
  fetchGuildJoinRequest: async e => {
    let t = await i.tn.get({
        url: h.ANM.GUILD_JOIN_REQUEST_BY_ID(e),
        rejectWithError: !1
      }),
      n = (0, u.j)(t.body);
    return r.Z.dispatch({
  ...
  fetchGuildJoinRequests: async e => {
    let {
      guildId: t,
      status: n = d.wB.SUBMITTED,
      before: l,
      after: o,
      limit: s = d.tB,
      force: a = !1
    } = e, _ = a || !c.Z.hasFetched(t);
    if (!c.Z.isFetching() && _) {
      r.Z.dispatch({
      ...
      try {
        ...
        let e = await i.tn.get({
            url: h.ANM.GUILD_JOIN_REQUESTS(t),
            query: {
              status: n,
              limit: s,
              before: l,
  ...
  ackUserGuildJoinRequest: async (e, t) => {
    try {
      return await i.tn.post({
        url: h.ANM.GUILD_JOIN_REQUEST_ACK(e, t),
        rejectWithError: !1
      })
    } catch (e) {} finally {
      r.Z.dispatch({
  ...
  updateGuildJoinRequest: async function(e, t, n) {
    ...
    let c = await i.tn.patch({
      url: h.ANM.GUILD_JOIN_REQUEST_ID(e, n),
      body: {
        action: o,
        rejection_reason: s
      },
      rejectWithError: !1
    }).catch(e => (e && e.body && e.body.code === h.evJ.REQUEST_TO_JOIN_USER_INELIGIBLE && l.Z.show({
  ...
  actionAllPendingJoinRequests: async (e, t) => {
    let n = await i.tn.patch({
      url: h.ANM.GUILD_JOIN_REQUESTS(e),
      body: {
        action: t
      },
      rejectWithError: !1
  ...
  fetchRequestToJoinGuilds: async () => {
    let e = await i.tn.get({
      url: h.ANM.USER_JOIN_REQUEST_GUILDS,
      rejectWithError: !1
    });
    r.Z.dispatch({
  ...
  createOrEnterJoinRequestInterview: async function(e) {
    let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1],
      n = await i.tn.post({
        url: h.ANM.GUILD_JOIN_REQUEST_INTERVIEW(e),
        rejectWithError: !1
      }),
      l = (0, s.q_)(n.body);
    return r.Z.dispatch({
  ...
  fetchJoinRequestCooldown: async e => {
    try {
      let t = await i.tn.get({
        url: h.ANM.GUILD_MEMBER_JOIN_REQUEST_COOLDOWN(e),
        rejectWithError: !1
      });
      return r.Z.dispatch({
