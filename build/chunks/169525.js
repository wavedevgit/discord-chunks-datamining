...
function y(e) {
  switch (e.type) {
    case s.Ah.EMBED:
      return {
        type: a.lJ.Embed, media: e
      };
    case s.Ah.ATTACHMENT:
      return {
        type: a.lJ.Attachment, media: e
      };
    case s.Ah.COMPONENT:
      return {
        type: a.lJ.GenericMedia, media: e.srcUnfurledMediaItem
      };
    default:
      return null
  }
...
function v(e) {
  let {
    channel: t,
    media: n
  } = e, i = (0, r.e7)([d.Z], () => null != t && d.Z.can(p.Plq.MANAGE_MESSAGES, t)), a = c.cC.useSetting(), s = (0, o.m)();
