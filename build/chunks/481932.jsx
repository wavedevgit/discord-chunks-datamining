...
function f(e) {
  ...
  if (h === d.OGo.NONE && b) return n === u.lY.MODAL ? null : <l.k9 type={"banner"} user={t} gameFriends={m} hasOutgoingPendingGameFriends={g} hasIncomingPendingGameFriends={E} analyticsLocation={_} shouldShowTooltip={f} />;
  switch (h) {
    case d.OGo.FRIEND:
    case d.OGo.PENDING_INCOMING:
    case d.OGo.PENDING_OUTGOING:
      if (n === u.lY.MODAL && h !== d.OGo.FRIEND) return null;
      return <l.g type={"banner"} user={t} relationshipType={h} analyticsLocation={_} shouldShowTooltip={f} />;
    default:
      if (n === u.lY.MODAL) return null;
      return <l.Z7 type={"banner"} userId={t.id} shouldShowTooltip={f} analyticsLocation={_} />
  }
}