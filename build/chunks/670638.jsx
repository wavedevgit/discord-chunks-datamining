...
function P(e) {
  ...
  let n = (0, o.e7)([g.Z], () => g.Z.questDeliveryOverride, []),
    ...
    H = false,
    Y = i.useMemo(() => <a.S89 id={"delivery"} label={"Show in Quest Bar"} checked={(null == n ? true : n.id) === e.quest.id} action={D} />, [D, e.quest.id, null == n ? true : n.id]),
    W = e.shouldShowDisclosure && e.quest.id !== y.V6;
  return <a.v2r variant={"fixed"} onSelect={U} navId={"quests-entry"} aria-label={I.intl.string(I.t.ogxXGh)} onClose={null != (t = null == e ? true : e.onClose) ? t : v.dG}>{<a.kSQ>{<a.sNh id={"play-game"} label={N} action={x} icon={a.zFc} />}{true === e.showShareLink && <a.sNh id={"share-link"} label={I.intl.string(I.t.RDE0SU)} action={M} icon={a.TIy} />}{H && Y}</a.kSQ>}{<a.kSQ>{!e.hideLearnMore && <a.sNh id={"learn-more"} label={I.intl.string(I.t.Ws2Bl5)} action={j} icon={a.qDn} />}{W && <a.sNh id={"display-disclosure"} label={I.intl.string(I.t.GcsZKC)} action={k} />}{c && <a.sNh id={"hide-entrypoint"} label={I.intl.string(I.t.NN79Ex)} action={G} subtext={I.intl.string(I.t["1u3YPD"])} />}</a.kSQ>}{e.quest.preview && <a.kSQ label={"Preview Controls"}>{!H && Y}{<a.sNh id={"dismiss"} label={"Reset Dismissibility"} action={P} />}{<a.sNh id={"enrollment"} label={"Reset Quest"} action={V} />}{<a.sNh id={"progress"} label={"Set Random Quest Progress"} action={L} />}{<a.sNh id={"complete"} label={"Complete Quest"} action={C} />}{(0, p.$J)(e.quest) && <a.sNh id={"console"} label={"Console Heartbeat"}>{<a.sNh disabled={true} id={"status"} label={"Status: ".concat((0, p.Bz)(e.quest) ? "alive" : "dead")} />}{<a.sNh id={"start"} label={"Start heartbeat (cheatmode)"} action={Z} />}{<a.sNh id={"stop"} label={"Stop heartbeat"} action={F} />}</a.sNh>}{<a.sNh id={"copy-quest-id"} label={"Copy Quest ID"} action={() => {
          (0, u.JG)(e.quest.id)
        }} />}</a.kSQ>}</a.v2r>
}
...
function w(e) {
  ...
  return <a.yRy targetElementRef={m} onRequestOpen={g} onRequestClose={o} renderPopout={e => {
      let {
        closePopout: t
      } = e;
    ...
    }} animation={a.yRy.Animation.NONE}>{e => (0, r.jsx)("div", {
      ref: m,
      children: t(e)
    })}</a.yRy>
}