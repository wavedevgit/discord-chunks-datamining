...
function ey(e) {
  let {
    ...
    embeddedActivity: R
  } = (0, $.Z)(o), P = eA(R), w = null != N && 0 === s.length ? [N] : s, D = w.length > 0, x = w.length >= 2, [L, j] = i.useState(!D), M = K.ZP.getName(null == t ? true : t.guild_id, null == t ? true : t.id, n), U = null != t && m ? ec.intl.formatToPlainString(ec.t["8lzR/f"], {
