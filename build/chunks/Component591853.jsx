...
function ey(e) {
  let {
    ...
    embeddedActivity: D
  } = (0, $.Z)(o), w = eA(D), x = null != P && 0 === s.length ? [P] : s, L = x.length > 0, M = x.length >= 2, [j, U] = i.useState(!L), B = K.ZP.getName(null == t ? true : t.guild_id, null == t ? true : t.id, n), Z = null != t && g ? ec.intl.formatToPlainString(ec.t["8lzR/R"], {
