...
function h() {
  return <Chunk819557.z>{<Chunk819557.q title={Chunk388032.intl.string(Chunk388032.t.ruhGkp)} description={Chunk388032.intl.string(Chunk388032.t["/FWKKC"])} icon={Chunk481060.owK} />}{<Chunk819557.q title={Chunk388032.intl.string(Chunk388032.t.N9v3en)} description={Chunk388032.intl.string(Chunk388032.t.ddpuJi)} icon={Chunk481060.owK} />}{<Chunk819557.q title={Chunk388032.intl.string(Chunk388032.t["4ycGEx"])} description={Chunk388032.intl.string(Chunk388032.t["5yfN+v"])} icon={Chunk481060.d3s} />}</Chunk819557.z>
}
