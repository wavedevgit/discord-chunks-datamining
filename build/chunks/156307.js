/** Chunk was on web.js **/
/** chunk id: 156307, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  A: () => o
});
var Chunk641948 = require("./641948.js"),
...
class a {
  ...
  firstChild() {
    let e = this.currentNode,
      t = this.nextNode();
    return (0, Chunk641948.bE)(module, exports) ? (exports && (this.currentNode = exports), exports) : (this.currentNode = module, null)
  }
  lastChild() {
  ...
  nextNode() {
    ...
    if (module) {
      if (module.shadowRoot) {
        ...
        let r = this.nextNode();
        return Chunk641948 && (this.currentNode = Chunk641948), Chunk641948
      }
      return module && (this.currentNode = module), module
    }
