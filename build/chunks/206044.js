...
let I = (0, a.animated)(u.CJ0),
  ...
  A = e => {
    ...
    let {
      ...
      ref: B,
      height: U
    } = (0, d.ZP)(), [Q, W] = s.useState(null), [G, z] = s.useState(null), F = (0, p.Z)(e => {
      let t = e.target;
      W(t.offsetWidth), z(t.scrollWidth)
    }), H = (0, m.y)(F), X = s.useMemo(() => (0, C.fh)(c, C.eC.HERO_IMAGE), [c]), Y = s.useRef(null), V = (0, E.uq)(x), K = x === j.jn.QUESTS_EMBED, J = (0, f.t5)(c, q.dr.QUESTS_CARD, x), $ = (null == (t = c.userStatus) ? void 0 : t.completedAt) != null, ee = (0, h.O5)(), et = (0, f.B6)(c.config.expiresAt, {
      year: "numeric",
      month: "long",
      day: "numeric"
      ...
      month: "long",
      day: "numeric"
    }), er = s.useMemo(() => null != c.config.cosponsorMetadata, [c]), es = e => {
      e.stopPropagation(), e.currentTarget.blur(), L(), ee({
        questId: c.id,
        questContent: x,
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [X.isAnimated ? (0, r.jsx)(D, {
        style: {
          opacity: b.to({
            range: [0, 1],
            output: [.25, 1]
        ...
        children: [(0, r.jsxs)(a.animated.div, {
          ...
          children: [V && (0, r.jsx)(a.animated.div, {
            ...
            children: [(0, r.jsxs)("div", {
              ...
              children: [(0, r.jsxs)("div", {
                ...
                children: [ei, K ? null : (0, r.jsx)(O.Z, {
                  color: "always-white"
                })]
              }), (0, r.jsxs)("div", {
                ...
                children: [(0, r.jsx)(u.ua7, {
                  ...
                  color: "always-white",
                  children: $ ? P.intl.formatToPlainString(P.t.APddvL, {
                    expirationDate: en
                  }) : i ? P.intl.formatToPlainString(P.t.v7xMw8, {
                    expirationDate: et
