...
let _ = (0, a.animated)(u.CJ0),
  D = e => {
    ...
    let [l, d] = s.useState(!1), m = s.useRef(new c.V7), x = (0, h.O5)();
    s.useEffect(() => {
      let e = m.current;
      return function() {
        e.stop()
  ...
  I = e => {
    ...
    let {
      ...
      ref: Z,
      height: L
    } = (0, d.ZP)(), [B, U] = s.useState(null), [W, z] = s.useState(null), G = (0, x.Z)(e => {
      let t = e.target;
      U(t.offsetWidth), z(t.scrollWidth)
    }), F = (0, m.y)(G), H = (0, T.uq)(c), X = c === j.jn.QUESTS_EMBED, Y = (0, g.t5)(o, E.dr.QUESTS_CARD, c, Q), V = (null == (t = o.userStatus) ? void 0 : t.completedAt) != null, K = (0, h.O5)(), J = (0, g.B6)(o.config.expiresAt), $ = (0, g.B6)(C.r.build(o.config).rewardsExpireAt), ee = s.useMemo(() => null != o.config.cosponsorMetadata, [o]), et = e => {
      e.stopPropagation(), e.currentTarget.blur(), k(), K({
        questId: o.id,
        questContent: c,
          ...
          children: [H && (0, r.jsx)(a.animated.div, {
            ...
            children: [(0, r.jsxs)("div", {
              ...
              children: [(0, r.jsxs)("div", {
                ...
                children: [en, X ? null : (0, r.jsx)(v.Z, {
                  color: "always-white"
                })]
              }), (0, r.jsxs)("div", {
