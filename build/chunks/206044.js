...
let _ = (0, l.animated)(u.CJ0),
  I = e => {
    ...
    let [a, d] = s.useState(!1), m = s.useRef(new c.V7), p = (0, x.O5)();
    s.useEffect(() => {
      let e = m.current;
      return function() {
        e.stop()
  ...
  D = e => {
    ...
    let {
      ...
      ref: Z,
      height: L
    } = (0, d.ZP)(), [B, U] = s.useState(null), [G, W] = s.useState(null), F = (0, p.Z)(e => {
      let t = e.target;
      U(t.offsetWidth), W(t.scrollWidth)
    }), z = (0, m.y)(F), X = (0, T.uq)(c), H = c === j.jn.QUESTS_EMBED, Y = (0, g.t5)(o, E.dr.QUESTS_CARD, c, Q), V = (null == (t = o.userStatus) ? void 0 : t.completedAt) != null, J = (0, x.O5)(), K = (0, g.B6)(o.config.expiresAt), $ = (0, g.B6)(f.r.build(o.config).rewardsExpireAt), ee = s.useMemo(() => null != o.config.cosponsorMetadata, [o]), et = e => {
      e.stopPropagation(), e.currentTarget.blur(), A(), J({
        questId: o.id,
        questContent: c,
    ...
    return (0, r.jsxs)("div", {
      ...
      children: [(0, r.jsx)(O.Z, {
        ...
        children: [(0, r.jsxs)(l.animated.div, {
          ...
          children: [X && (0, r.jsx)(l.animated.div, {
            ...
            children: [(0, r.jsxs)("div", {
              ...
              children: [(0, r.jsxs)("div", {
                ...
                children: [en, H ? null : (0, r.jsx)(v.Z, {
                  color: "always-white"
                })]
              }), (0, r.jsxs)("div", {
                ...
                children: [(0, r.jsx)(u.ua7, {
                  ...
                  color: "always-white",
                  children: V ? S.intl.formatToPlainString(S.t.APddvL, {
                    expirationDate: $
