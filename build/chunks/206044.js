...
let _ = (0, a.animated)(u.CJ0),
  D = e => {
    ...
    let [a, l] = s.useState(!1), d = s.useRef(new c.V7), m = (0, p.O5)();
    s.useEffect(() => {
      let e = d.current;
      return function() {
        e.stop()
  ...
  I = e => {
    ...
    }), G = (0, m.y)(z), F = (0, N.uq)(c), H = c === j.jn.QUESTS_EMBED, X = (0, h.t5)(i, E.dr.QUESTS_CARD, c), Y = (null == (t = i.userStatus) ? void 0 : t.completedAt) != null, V = (0, p.O5)(), K = (0, h.B6)(i.config.expiresAt, {
      year: "numeric",
      month: "long",
      day: "numeric"
