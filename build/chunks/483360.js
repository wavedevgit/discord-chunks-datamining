...
function eD(e) {
  ...
  for (; h < p;) {
    ...
    if (null != r && (null == i || i(r))) {
      ...
      o && t === r.id || n.substring(0, c.length) === c || i.substring(0, c.length) === c || (null == e ? void 0 : e.substring(0, c.length)) === c || (null == l ? void 0 : l.substring(0, c.length)) === c || (null == p ? void 0 : p.substring(0, c.length)) === c || (null == h ? void 0 : h.substring(0, c.length)) === c ? f.push({
        type: J.h8.USER,
        record: r,
        score: el,
      ...
      }) : m < ey && (a()(c, i) || a()(u, s) || null != l && a()(c, l) || null != d && a()(u, d) || null != h && a()(c, h) || null != g && a()(u, g)) && (_.push({
        type: J.h8.USER,
        record: r,
        score: ef,
...
let eF = {
  ...
  queryChannelUsers(e) {
    ...
    if (u.isPrivate()) {
      ...
      t = x.ZP.getMembers(u.guild_id).filter(ew), a && W.Z.requestMembers(u.guild_id, r, i)
    }
    return eD({
      query: r,
      members: t,
  ...
  queryChannels(e) {
    let t, {
      ...
      h = ek(n, c);
    t = null != r ? s()(L.ZP.getChannels(r)[l]).map(e => e.channel).concat(A.Z.computeAllActiveJoinedThreads(r)).value() : s()(w.Z.loadAllGuildAndPrivateChannelsFromDisk()).values().concat(A.Z.computeAllActiveJoinedThreads()).value();
    let m = {},
      g = [],
      E = D.Z.getMaxScore();
    for (let e of t) {
      ...
      if (0 !== c) {
        ...
        0 !== c && !(t.length > 1) && (1 !== t.length || t[0].isFullMatch || s) && (eM(l, e.type) && (c = Math.max(c - e_, ef / 2)), c = Math.min(c + Math.min(null != (b = D.Z.getScoreWithoutFetchingLatest(e.id)) ? b : 0 / E, 1) * ep, c >= ec ? el : ec), g.push({
  ...
  queryInAppNavigations(e) {
    ...
    return ea.getState().options.forEach(e => {
      ...
      let n = [e.title].concat(e.searchableTitles),
        i = null != (t = (0, o.max)(n.map(e => eA(eP(e.toLocaleLowerCase(), a, r))))) ? t : 0;
      i > 0 && l.push({
        type: J.h8.IN_APP_NAVIGATION,
  ...
  queryMentionResults(e) {
    ...
    let y = [];
    return !n.isPrivate() && r && c && (g < _ && a()(E, eS().test) && (y.push(eS()), g += 1), i && g < _ && a()(E, eT().test) && y.push(eT())), {
      users: m,
      globals: y,
      roles: b
    }
  ...
  queryGuildMentionResults(e) {
    ...
    let p = [];
    return r && o && (u < X.rnv && a()(d, eS().test) && (p.push(eS()), u += 1), u < X.rnv && a()(d, eT().test) && p.push(eT())), {
      users: c,
      globals: p,
      roles: f
    }
  ...
  queryStaticRouteChannels(e) {
    let {
      ...
      queryLower: r
    }, a = (0, E.s)(n.id) && !n.hasFeature(X.oNc.HUB), o = n.hasFeature(X.oNc.COMMUNITY), s = (0, g.t)(n) && n.hasFeature(X.oNc.COMMUNITY), l = [{
      id: $.HY.SERVER_GUIDE,
    ...
    for (let s of (C.DZ.loadIfNecessary(), e)) {
      ...
      i.forEach((i, s) => {
        ...
        for (let n of i) {
          ...
          t ? i === e ? o = el * a : u.test(i) ? o = ec * a : (r === N.MO.GUILD_NAME || r === N.MO.PACK_NAME || r === N.MO.STICKER_NAME) && d.test(i) && (o = eu * a) : i === e && (o = el * a, f = i), o > c && (c = o, f = i)
        }
  ...
  querySoundmoji(e, t) {
    ...
    let r = Array.from(v.Z.getSounds().values()).reduce((e, n) => (n.forEach(n => {
