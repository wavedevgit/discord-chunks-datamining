...
function eL(e) {
  ...
  let r = L.Z.getFrequentlyWithoutFetchingLatest(),
    i = r.reduce((e, t) => {
      let {
        id: n
      } = t, r = L.Z.getScoreWithoutFetchingLatest(n);
      return r > e ? r : e
    }, 0),
    a = [];
  switch (e) {
  ...
  for (let e of V.Z.getFriendIDs()) o[e] = (null != (t = o[e]) ? t : 1) + eI;
  for (let e of D.Z.getDMUserIds()) o[e] = (null != (n = o[e]) ? n : 1) + eT;
  return o
}
let ex = [x.sH, x.Zb, ee.d4z.GUILD_CATEGORY];
...
function eU(e) {
  let {
    ...
    allowSnowflake: o,
    boosters: s
  } = e, l = H.default.getUsers(), c = Z.Z.getGuildId(), u = t.toLocaleLowerCase(), f = (0, J.Fv)(u), _ = [], p = [], h = n.length, m = 0, g = 0;
  for (; m < h;) {
    ...
    if (null != r && (null == i || i(r))) {
      ...
      o && t === r.id || n.substring(0, u.length) === u || i.substring(0, u.length) === u || (null == e ? void 0 : e.substring(0, u.length)) === u || (null == c ? void 0 : c.substring(0, u.length)) === u || (null == h ? void 0 : h.substring(0, u.length)) === u || (null == m ? void 0 : m.substring(0, u.length)) === u ? _.push({
        type: et.h8.USER,
        record: r,
        score: eD(ed, null == s ? void 0 : s[r.id]),
        comparator: null != (O = null != h ? h : e) ? O : n,
        sortable: null != (v = null != m ? m : c) ? v : i
      }) : l.substring(0, f.length) === f || (null == d ? void 0 : d.substring(0, f.length)) === f || (null == E ? void 0 : E.substring(0, f.length)) === f ? _.push({
        type: et.h8.USER,
        record: r,
        score: eD(eh, null == s ? void 0 : s[r.id]),
        comparator: null != (I = null != h ? h : e) ? I : n,
        sortable: null != (T = null != m ? m : c) ? T : i
      }) : g < eS && (a()(u, i) || a()(f, l) || null != c && a()(u, c) || null != d && a()(f, d) || null != m && a()(u, m) || null != E && a()(f, E)) && (p.push({
        type: et.h8.USER,
        record: r,
        score: eD(eh, null == s ? void 0 : s[r.id]),
...
function eW(e, t) {
  ...
  return null == e || null == n ? [] : s()(U.Z.getMessages(e).toArray()).reverse().uniqBy(e => e.author.id).map(e => H.default.getUser(e.author.id)).filter(e => {
    if (null == e || e.isNonUserBot()) return !1;
    let t = n.getGuildId();
    return null == t || ej(k.ZP.getMember(t, e.id))
  }).map(e => {
    var t;
    let r = n.getGuildId(),
...
let eK = (0, W.oH)((e, t, n) => {
    let r = new Map,
      i = new Map,
      a = [];
    return s()(D.Z.getMutablePrivateChannels()).values().value().forEach(e => {
      if (e.isDM()) {
  ...
  ez = {
    queryFriends(e) {
      ...
      return eU({
        query: t,
        members: V.Z.getFriendIDs().map(e => H.default.getUser(e)).filter(K.lm),
        limit: n,
        filter: i
      })
    },
    queryDMUsers(e) {
      ...
      return eU({
        query: t,
        members: D.Z.getDMUserIds().map(e => H.default.getUser(e)).filter(K.lm),
        limit: n,
        filter: r
      })
    },
    ...
    queryGuildUsers(e) {
      ...
      if (0 === n.length && a) {
        let e = eW(F.Z.getChannelId(t), r);
        if (e.length > 0) return e
      }
      let l = k.ZP.getMembers(t).filter(ej);
      return i && n.length > 0 && z.Z.requestMembers(t, n, r), eU({
        query: n,
        members: l,
        limit: r,
        filter: o,
    ...
    queryUsers(e) {
      ...
      return n && e.length > 0 && z.Z.requestMembers(null, e, t), eU({
        query: e,
        members: s()(H.default.getUsers()).values().value(),
        limit: t,
        filter: r
      })
    },
    queryChannels(e) {
      let t, {
        ...
        h = eF(n, c);
      t = null != r ? s()(x.ZP.getChannels(r)[l]).map(e => e.channel).concat(N.Z.computeAllActiveJoinedThreads(r)).value() : s()(D.Z.loadAllGuildAndPrivateChannelsFromDisk()).values().concat(N.Z.computeAllActiveJoinedThreads()).value();
      let m = {},
        g = [],
        E = L.Z.getMaxScore();
      for (let e of t) {
        var b;
        if (!eB(l, e.type, null != r) || (0, R.Km)(e.type) && !G.Z.can(u ? e.accessPermissions : ee.Plq.VIEW_CHANNEL, e) || !o(e)) continue;
        let t = [...h],
        ...
        if (0 !== c) {
          ...
          0 !== c && !(t.length > 1) && (1 !== t.length || t[0].isFullMatch || s) && (eV(l, e.type) && (c = Math.max(c - em, eh / 2)), c = Math.min(c + Math.min(null != (b = L.Z.getScoreWithoutFetchingLatest(e.id)) ? b : 0 / E, 1) * eg, c >= ef ? ed : ef), g.push({
            type: (0, R.bw)(e.type) ? et.h8.VOICE_CHANNEL : et.h8.TEXT_CHANNEL,
            record: e,
            score: eD(c, _[e.id]),
            comparator: (0, f.F6)(e, H.default, V.Z),
            sortable: i
          }))
        }
      }
    ...
    queryDMChannels(e) {
      let {
        ...
        recipientsById: a,
        recipients: o
      } = eK(D.Z.getPrivateChannelsVersion(), V.Z.getVersion(), H.default.getUserStoreVersion()), s = eU({
        query: t,
        members: o,
        limit: o.length,
        boosters: r
    ...
    queryGroupDMs(e) {
      let {
        ...
        filter: i = eA,
        boosters: a = {}
      } = e, o = (0, J._I)((0, J.Fv)(t.toLocaleLowerCase())), l = {
        exactQuery: RegExp("^".concat(X.Z.escape(o)), "i"),
        containQuery: RegExp(X.Z.escape(o), "i"),
        queryLower: o
      ...
      for (let e of c) {
        ...
        let t = (0, f.F6)(e, H.default, V.Z).toLocaleLowerCase(),
          n = (0, J._I)((0, J.Fv)(t)),
          o = eM(n, l, r);
        if ("" !== e.name) {
          let t = (0, f.on)(e, H.default, V.Z).toLocaleLowerCase();
          o = Math.max(o, eM((0, J._I)((0, J.Fv)(t)), l, r))
        }
        o > 0 && u.push({
          type: et.h8.GROUP_DM,
          record: e,
    ...
    queryInAppNavigations(e) {
      ...
      return el.getState().options.forEach(e => {
        var t;
        let n = [e.title].concat(e.searchableTitles),
          i = null != (t = (0, o.max)(n.map(e => eD(eM(e.toLocaleLowerCase(), a, r))))) ? t : 0;
        i > 0 && l.push({
          type: et.h8.IN_APP_NAVIGATION,
    ...
    querySKUs(e) {
      let {
        ...
        containQuery: RegExp(X.Z.escape(a), "i"),
        queryLower: a
      }, l = s()(Y.Z.getSKUs()).values().value(), c = [];
      for (let e of l)
    ...
    queryMentionResults(e) {
      ...
      }) : [], g = m.length, E = t.toLowerCase(), b = [];
      if (g < _ && c) {
        let e = n.getGuildId(),
          i = j.Z.getGuild(e);
        if (null != i) {
          let n = s()(M.Z.getRoles(i.id)).filter(t => {
            let {
              mentionable: n,
              name: i,
              id: o
          ...
          b = (0, l.Lu)(n, t, {
            keys: ["name"]
          }).slice(0, _ - g), g += b.length
        }
      }
      let y = [];
      return !n.isPrivate() && r && c && (g < _ && a()(E, eR().test) && (y.push(eR()), g += 1), i && g < _ && a()(E, eP().test) && y.push(eP())), {
        users: m,
        globals: y,
        roles: b
      }
    ...
    queryGuildMentionResults(e) {
      ...
      if (u < ee.rnv && o) {
        ...
        null != e && (s()(M.Z.getRoles(e.id)).filter(e => {
          let {
            mentionable: t,
            name: i,
            id: o
        ...
        }).take(ee.rnv - u).forEach(e => {
          f.push(e)
        }), u += f.length)
      }
      let p = [];
      return r && o && (u < ee.rnv && a()(d, eR().test) && (p.push(eR()), u += 1), u < ee.rnv && a()(d, eP().test) && p.push(eP())), {
        users: c,
        globals: p,
        roles: f
      }
    ...
    queryChoice(e) {
      let {
        ...
        limit: r = 10,
        fuzzy: i = !0
      } = e, a = t.toLocaleLowerCase(), o = RegExp("^".concat(X.Z.escape(a)), "i"), l = RegExp(X.Z.escape(a), "i"), c = s()(n).map((e, t) => {
        let n = eM(e.displayName.toLocaleLowerCase(), {
          exactQuery: o,
          containQuery: l,
          queryLower: a
        }, i);
      ...
      }).filter(K.lm).sortBy(e => -1 * e.score);
    ...
    queryStaticRouteChannels(e) {
      ...
      for (let e of l)(e.id !== en.HY.SERVER_GUIDE || a) && (e.id !== en.HY.CHANNEL_BROWSER || o) && (e.id !== en.HY.CUSTOMIZE_COMMUNITY || s) && eM(e.name.toLocaleLowerCase(), i, !1) > 0 && c.push(new R.nl({
        id: e.id,
        name: e.name,
        type: ee.d4z.UNKNOWN,
        guild_id: n.id
    ...
    queryApplicationCommandChannelResults(e) {
      ...
      let o = [];
      for (let e of ex) o = o.concat(this.queryChannels({
        query: t,
        guildId: n.guild_id,
        limit: i,
        fuzzy: !0,
    ...
    queryStickers(e) {
      ...
      for (let s of (C.DZ.loadIfNecessary(), e)) {
        ...
        i.forEach((i, s) => {
          ...
          null != p && (c *= p / 100), c > 0 && null != f && !o.has(_.id) && (o.add(_.id), l.push({
            sticker: _,
            comparator: f,
            score: c
          }))
      ...
      return 0 === (l = s()(l).sortBy(e => -1 * e.score).value()).length && (l = eC), l
    },
    querySoundmoji(e, t) {
      let n = H.default.getCurrentUser();
      O.Z.isFetching() || O.Z.hasFetchedAllSounds() || (0, y.w)(), C.DZ.loadIfNecessary();
      let r = Array.from(O.Z.getSounds().values()).reduce((e, n) => (n.forEach(n => {
    ...
    hasSameRoleAsUsername(e, t) {
      ...
      for (let {
        ...
        of Object.values(null != n ? M.Z.getRoles(n.id) : {}))
