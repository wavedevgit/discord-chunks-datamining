...
let e5 = (0, J.oH)((e, t, n) => {
  ...
  e6 = {
    ...
    queryMentionResults(e) {
      ...
      let O = [];
      return !n.isPrivate() && r && c && (g < _ && a()(E, eG().test) && (O.push(eG()), g += 1), i && g < _ && a()(E, eB().test) && (O.push(eB()), g += 1)), b.N.getCurrentConfig({
        guildId: n.guild_id,
        location: "mention autocomplete"
      }, {
        autoTrackExposure: !0
      }).enabled && null != eV && g < _ && a()(E, eV().test) && (O.push(eV()), g += 1), {
        users: m,
        globals: O,
        roles: y
      }
