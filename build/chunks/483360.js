...
function eD(e) {
  let {
    ...
    filter: i,
    allowSnowflake: a
  } = e, s = V.default.getUsers(), l = F.Z.getGuildId(), c = t.toLocaleLowerCase(), u = (0, q.Fv)(c), f = [], _ = [], p = n.length, h = 0, m = 0;
  for (; h < p;) {
    var g, E, b, v, y, O, I, S, T;
    let e, r;
    let d = n[h];
    d instanceof P.Z ? (r = d, e = null === (E = x.ZP.getNick(l, r.id)) || void 0 === E ? void 0 : E.toLocaleLowerCase()) : (e = null === (b = d.nick) || void 0 === b ? void 0 : b.toLocaleLowerCase(), r = s[d.userId]);
    let p = null === (g = Q.ZP.getGlobalName(r)) || void 0 === g ? void 0 : g.toLocaleLowerCase();
    if (null != r && (null == i || i(r))) {
      ...
      a && t === r.id || n.substring(0, c.length) === c || i.substring(0, c.length) === c || (null == e ? void 0 : e.substring(0, c.length)) === c || (null == l ? void 0 : l.substring(0, c.length)) === c || (null == p ? void 0 : p.substring(0, c.length)) === c || (null == h ? void 0 : h.substring(0, c.length)) === c ? f.push({
        ...
        record: r,
        score: el,
        comparator: null !== (v = null != p ? p : e) && void 0 !== v ? v : n,
        sortable: null !== (y = null != h ? h : l) && void 0 !== y ? y : i
      }) : s.substring(0, u.length) === u || (null == d ? void 0 : d.substring(0, u.length)) === u || (null == g ? void 0 : g.substring(0, u.length)) === u ? f.push({
        type: J.h8.USER,
        record: r,
        score: ef,
        comparator: null !== (O = null != p ? p : e) && void 0 !== O ? O : n,
        sortable: null !== (I = null != h ? h : l) && void 0 !== I ? I : i
      }) : m < ev && (o()(c, i) || o()(u, s) || null != l && o()(c, l) || null != d && o()(u, d) || null != h && o()(c, h) || null != g && o()(u, g)) && (_.push({
        type: J.h8.USER,
        record: r,
        score: ef,
...
function eG(e, t) {
  ...
  if (null == n) {
    var r;
    n = t[e.parent_id] = null === (r = w.Z.getChannel(e.parent_id)) || void 0 === r ? void 0 : r.name.toLocaleLowerCase()
  }
  return n
}
...
function eB(e, t) {
  ...
  return null == e || null == n ? [] : s()(k.Z.getMessages(e).toArray()).reverse().uniqBy(e => e.author.id).map(e => V.default.getUser(e.author.id)).filter(e => {
...
let eF = {
  queryFriends(e) {
    ...
    return eD({
      query: t,
      members: G.Z.getFriendIDs().map(e => V.default.getUser(e)).filter(H.lm),
      limit: n,
      filter: i
    })
  },
  queryDMUsers(e) {
    ...
    return eD({
      query: t,
      members: w.Z.getDMUserIds().map(e => V.default.getUser(e)).filter(H.lm),
      limit: n,
      filter: r
    })
  },
  queryChannelUsers(e) {
    ...
    if (u.isPrivate()) {
      t = u.recipients.map(e => {
        ...
        return {
          userId: e,
          nick: null !== (t = G.Z.getNickname(e)) && void 0 !== t ? t : null
        }
      });
  ...
  queryGuildUsers(e) {
    ...
    return i && n.length > 0 && W.Z.requestMembers(t, n, r), eD({
      query: n,
      members: l,
      limit: r,
      filter: a,
  ...
  queryUsers(e) {
    ...
    return n && e.length > 0 && W.Z.requestMembers(null, e, t), eD({
      query: e,
  ...
  queryChannels(e) {
    ...
    for (let e of t) {
      ...
      if (0 !== c) {
        ...
        0 !== c && !(t.length > 1) && (1 !== t.length || t[0].isFullMatch || s) && (eM(l, e.type) && (c = Math.max(c - e_, ef / 2)), c = Math.min(c + Math.min(null !== (b = D.Z.getScoreWithoutFetchingLatest(e.id)) && void 0 !== b ? b : 0 / E, 1) * ep, c >= ec ? el : ec), g.push({
  ...
  queryGroupDMs(e) {
    let {
      ...
      filter: i = ey,
      boosters: o = {}
    } = e, a = (0, q._I)((0, q.Fv)(t.toLocaleLowerCase())), l = {
      exactQuery: RegExp("^".concat(K.Z.escape(a)), "i"),
      containQuery: RegExp(K.Z.escape(a), "i"),
      queryLower: a
  ...
  queryInAppNavigations(e) {
    ...
    return eo.getState().options.forEach(e => {
      var t;
      let n = [e.title].concat(e.searchableTitles),
        i = null !== (t = (0, a.max)(n.map(e => eN(eP(e.toLocaleLowerCase(), o, r))))) && void 0 !== t ? t : 0;
      i > 0 && l.push({
        type: J.h8.IN_APP_NAVIGATION,
  ...
  queryMentionResults(e) {
    ...
    let v = [];
    return !n.isPrivate() && r && c && (g < _ && o()(E, eS().test) && (v.push(eS()), g += 1), i && g < _ && o()(E, eT().test) && v.push(eT())), {
      users: m,
      globals: v,
      roles: b
    }
  ...
  queryGuildMentionResults(e) {
    ...
    if (u < X.rnv && a) {
      ...
      }).take(X.rnv - u).forEach(e => {
        f.push(e)
      }), u += f.length)
    }
    let p = [];
    return r && a && (u < X.rnv && o()(d, eS().test) && (p.push(eS()), u += 1), u < X.rnv && o()(d, eT().test) && p.push(eT())), {
      users: c,
      globals: p,
      roles: f
    }
  ...
  queryChoice(e) {
    let {
      ...
      limit: r = 10,
      fuzzy: i = !0
    } = e, o = t.toLocaleLowerCase(), a = RegExp("^".concat(K.Z.escape(o)), "i"), l = RegExp(K.Z.escape(o), "i"), c = s()(n).map((e, t) => {
  ...
  queryStaticRouteChannels(e) {
    let {
      ...
      queryLower: r
    }, o = (0, E.s)(n.id) && !n.hasFeature(X.oNc.HUB), a = n.hasFeature(X.oNc.COMMUNITY), s = (0, g.t)(n) && n.hasFeature(X.oNc.COMMUNITY), l = [{
      id: $.HY.SERVER_GUIDE,
    ...
    for (let e of l)(e.id !== $.HY.SERVER_GUIDE || o) && (e.id !== $.HY.CHANNEL_BROWSER || a) && (e.id !== $.HY.CUSTOMIZE_COMMUNITY || s) && eP(e.name.toLocaleLowerCase(), i, !1) > 0 && c.push(new R.nl({
      id: e.id,
      name: e.name,
      type: X.d4z.UNKNOWN,
      guild_id: n.id
  ...
  queryApplicationCommandChannelResults(e) {
    ...
    let a = [];
    for (let e of eC) a = a.concat(this.queryChannels({
      query: t,
      guildId: n.guild_id,
      limit: i,
      fuzzy: !0,
  ...
  queryStickers(e) {
    let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1],
      [n, r] = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : [null, ey],
      {
        stickerMetadata: i
      } = T.Z,
    ...
    for (let s of (C.DZ.loadIfNecessary(), e)) {
      ...
      i.forEach((i, s) => {
        ...
        for (let n of i) {
          ...
          t ? i === e ? a = el * o : u.test(i) ? a = ec * o : (r === A.MO.GUILD_NAME || r === A.MO.PACK_NAME || r === A.MO.STICKER_NAME) && d.test(i) && (a = eu * o) : i === e && (a = el * o, f = i), a > c && (c = a, f = i)
        }
