...
function eW(e, t) {
  ...
  return null == e || null == n ? [] : s()(U.Z.getMessages(e).toArray()).reverse().uniqBy(e => e.author.id).map(e => H.default.getUser(e.author.id)).filter(e => {
    ...
    let t = n.getGuildId();
    return null == t || ej(M.ZP.getMember(t, e.id))
  }).map(e => {
    var t;
    let r = n.getGuildId(),
  ...
  ez = {
    ...
    queryChannelUsers(e) {
      ...
      if (u.isPrivate()) {
        ...
        t = M.ZP.getMembers(u.guild_id).filter(ej), a && z.Z.requestMembers(u.guild_id, r, i)
      }
      return eU({
        query: r,
        members: t,
    ...
    queryGuildUsers(e) {
      ...
      let l = M.ZP.getMembers(t).filter(ej);
    ...
    queryMentionResults(e) {
      ...
      if (g < _ && c) {
        let e = n.getGuildId(),
          i = j.Z.getGuild(e);
        if (null != i) {
          let n = s()(k.Z.getRoles(i.id)).filter(t => {
            let {
              mentionable: n,
              name: i,
              id: o
    ...
    queryGuildMentionResults(e) {
      ...
      if (u < ee.rnv && o) {
        ...
        null != e && (s()(k.Z.getRoles(e.id)).filter(e => {
          let {
            mentionable: t,
            name: i,
            id: o
    ...
    queryStaticRouteChannels(e) {
      ...
      for (let e of l)(e.id !== en.HY.SERVER_GUIDE || a) && (e.id !== en.HY.CHANNEL_BROWSER || o) && (e.id !== en.HY.CUSTOMIZE_COMMUNITY || s) && ek(e.name.toLocaleLowerCase(), i, !1) > 0 && c.push(new R.nl({
        id: e.id,
        name: e.name,
        type: ee.d4z.UNKNOWN,
        guild_id: n.id
    ...
    hasSameRoleAsUsername(e, t) {
      ...
      for (let {
        ...
        of Object.values(null != n ? k.Z.getRoles(n.id) : {}))
