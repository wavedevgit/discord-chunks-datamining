...
function eK() {
  ...
  return eM * module * (null != exports ? exports : 1)
}
...
function e2(e, t, n) {
  return e === t || (!!n || !!(0, x.Km)(t)) && (e === Z.sH ? (0, x.r8)(t) || (0, x.bw)(t) : e === Z.Zb && (0, x.bw)(t))
}
...
let te = (0, Chunk251625.oH)((e, t, n) => {
  ...
  tt = {
    queryFriends(e) {
      ...
      return e0({
        query: t,
        members: z.Z.getFriendIDs().map(e => Q.default.getUser(e)).filter(et.lm),
        limit: n,
        filter: i
      })
    },
    queryDMUsers(e) {
      ...
      return e0({
        query: t,
        members: U.Z.getDMUserIds().map(e => Q.default.getUser(e)).filter(et.lm),
        limit: n,
        filter: r
      })
    },
    ...
    queryAllUsers(e) {
      ...
      return a && t.length > 0 && er.Z.requestMembers(null, t, i), this.queryUsers({
        query: t,
        limit: i,
        request: a,
        filter: n,
    ...
    queryChannels(e) {
      ...
      for (let e of t) {
        ...
        if (0 !== c) {
          ...
          0 !== c && !(t.length > 1) && (1 !== t.length || t[0].isFullMatch || s) && (e4(l, e.type) && (c = Math.max(c - eC, eA / 2)), e.isThread() && (e.isActiveThread() || (c -= eN), w.Z.hasJoined(e.id) || (c -= eR)), c = Math.min(c + Math.min(null != (O = G.Z.getScoreWithoutFetchingLatest(e.id)) ? O : 0 / y, 1) * eP, c >= eI ? eO : eI), b.push({
    ...
    queryDMChannels(e) {
      let {
        ...
        recipientsById: a,
        recipients: o
      } = te(U.Z.getPrivateChannelsVersion(), z.Z.getVersion(), Q.default.getUserStoreVersion()), s = e0({
        query: t,
        members: o,
        limit: o.length,
        boosters: r
    ...
    queryGroupDMs(e) {
      let {
        ...
        filter: i = eG,
        boosters: a = {}
      } = e, o = (0, es._I)((0, es.Fv)(t.toLocaleLowerCase())), l = {
    ...
    queryInAppNavigations(e) {
      let {
        ...
        [d.Ky.SHOP_ORBS_TAB]: [e_.intl.string(e_.t.ElYQFS), e_.intl.string(e_.t.pWG4ze), e_.intl.string(e_.t.EBYkzk)],
        [d.Ky.QUEST_ORBS]: [e_.intl.string(e_.t.ElYQFS), e_.intl.string(e_.t["v/R2aC"]), e_.intl.string(e_.t.qQR4tn)],
      ...
      if (l) {
        ...
        for (let t of e.flatMap(e => e.collections)) {
          var _;
          for (let e of ["".concat(t.name, " Playground"), "".concat(t.name, " Components"), "".concat(t.name, " Design System"), t.name, ...null != (_ = t.tags) ? _ : []]) {
            let n = e.toLocaleLowerCase(),
              r = eQ(n, s, i);
            if (r > 0) {
              u.push({
    ...
    queryMentionResults(e) {
      let {
        ...
        checkRecentlyTalkedOnEmptyQuery: _ = true,
        limit: h = ec.rnv,
        request: m,
    ...
    queryGuildMentionResults(e) {
      ...
      if (u < ec.rnv && o) {
        ...
        null != e && (s()(V.Z.getSortedRoles(e.id)).filter(e => (e.mentionable || r || l) && a()(d, e.name.toLowerCase()) && !(0, M.fI)(e)).take(ec.rnv - u).forEach(e => {
          f.push(e)
        }), u += f.length)
      }
      let _ = [];
      return r && o && (u < ec.rnv && a()(d, eF().test) && (_.push(eF()), u += 1), u < ec.rnv && a()(d, eV().test) && _.push(eV())), {
        users: c,
        globals: _,
        roles: f
      }
    ...
    queryChoice(e) {
      let {
        ...
        limit: r = 10,
        fuzzy: i = true
      } = e, a = t.toLocaleLowerCase(), o = RegExp("^".concat(ea.Z.escape(a)), "i"), l = RegExp(ea.Z.escape(a), "i"), c = s()(n).map((e, t) => {
    ...
    queryStaticRouteChannels(e) {
      let {
        ...
        queryLower: r
      }, a = (0, O.s)(n.id) && !n.features.has(ec.GuildFeatures.HUB), o = n.features.has(ec.GuildFeatures.COMMUNITY), s = (0, y.t)(n) && n.features.has(ec.GuildFeatures.COMMUNITY), l = [{
      ...
      for (let e of l)(e.id !== ed.HY.SERVER_GUIDE || a) && (e.id !== ed.HY.CHANNEL_BROWSER || o) && (e.id !== ed.HY.CUSTOMIZE_COMMUNITY || s) && eQ(e.name.toLocaleLowerCase(), i, false) > 0 && c.push(new x.nl({
        id: e.id,
        name: e.name,
        type: ec.d4z.UNKNOWN,
        guild_id: n.id
    ...
    queryApplicationCommandChannelResults(e) {
      ...
      let o = [];
      for (let e of eq) o = o.concat(this.queryChannels({
        query: t,
        guildId: n.guild_id,
        limit: i,
        fuzzy: true,
    ...
    queryStickers(e) {
      ...
      return 0 === (o = s()(o).sortBy(e => false * e.score).value()).length && (o = eZ), o
    },
    querySoundmoji(e, t) {
