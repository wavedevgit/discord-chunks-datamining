...
function eV(e) {
  let {
    ...
    allowSnowflake: o,
    boosters: s
  } = e, l = H.default.getUsers(), c = Z.Z.getGuildId(), u = t.toLocaleLowerCase(), _ = (0, $.Fv)(u), f = [], p = [], h = n.length, m = 0, g = 0;
  for (; m < h;) {
    ...
    if (null != r && (null == i || i(r))) {
      ...
      }) : l.substring(0, _.length) === _ || (null == d ? void 0 : d.substring(0, _.length)) === _ || (null == E ? void 0 : E.substring(0, _.length)) === _ ? f.push({
        type: en.h8.USER,
        record: r,
        score: eM(em, null == s ? void 0 : s[r.id]),
        comparator: null != (I = null != h ? h : e) ? I : n,
        sortable: null != (T = null != m ? m : c) ? T : i
      }) : g < eC && (a()(u, i) || a()(_, l) || null != c && a()(u, c) || null != d && a()(_, d) || null != m && a()(u, m) || null != E && a()(_, E)) && (p.push({
        type: en.h8.USER,
        record: r,
        score: eM(em, null == s ? void 0 : s[r.id]),
...
let eQ = (0, W.oH)((e, t, n) => {
  ...
  eJ = {
    ...
    queryGuildUsers(e) {
      ...
      return i && n.length > 0 && q.Z.requestMembers(t, n, r), eV({
        query: n,
        members: l,
        limit: r,
        filter: o,
    ...
    queryAllUsers(e) {
      ...
      return a && t.length > 0 && q.Z.requestMembers(null, t, i), this.queryUsers({
        query: t,
        limit: i,
        request: a,
        filter: n,
    ...
    queryChannels(e) {
      let t, {
        ...
        m = eW(n, c),
        g = eZ(l);
      t = null != r ? s()(x.ZP.getChannels(r)[l]).map(e => e.channel).concat(g ? h ? D.Z.getAllThreadsForGuild(r) : N.Z.computeAllActiveJoinedThreads(r) : []).value() : s()(D.Z.loadAllGuildAndPrivateChannelsFromDisk()).values().concat(g ? N.Z.computeAllActiveJoinedThreads() : []).value();
      let E = {},
        b = [],
        y = L.Z.getMaxScore();
      for (let e of t) {
        ...
        if (0 !== c) {
          ...
          0 !== c && !(t.length > 1) && (1 !== t.length || t[0].isFullMatch || s) && (eY(l, e.type) && (c = Math.max(c - eg, em / 2)), e.isThread() && (e.isActiveThread() || (c -= eE), C.Z.hasJoined(e.id) || (c -= eb)), c = Math.min(c + Math.min(null != (O = L.Z.getScoreWithoutFetchingLatest(e.id)) ? O : 0 / y, 1) * ey, c >= ef ? e_ : ef), b.push({
    ...
    queryDMChannels(e) {
      let {
        ...
        recipientsById: a,
        recipients: o
      } = eQ(D.Z.getPrivateChannelsVersion(), V.Z.getVersion(), H.default.getUserStoreVersion()), s = eV({
        query: t,
        members: o,
        limit: o.length,
        boosters: r
    ...
    queryGroupDMs(e) {
      let {
        ...
        filter: i = eR,
        boosters: a = {}
      } = e, o = (0, $._I)((0, $.Fv)(t.toLocaleLowerCase())), l = {
        exactQuery: RegExp("^".concat(Q.Z.escape(o)), "i"),
        containQuery: RegExp(Q.Z.escape(o), "i"),
        queryLower: o
    ...
    queryInAppNavigations(e) {
      ...
      return ec.getState().options.forEach(e => {
        var t;
    ...
    queryMentionResults(e) {
      ...
      let y = [];
      return !n.isPrivate() && r && c && (g < f && a()(E, eD().test) && (y.push(eD()), g += 1), i && g < f && a()(E, eL().test) && y.push(eL())), {
        users: m,
        globals: y,
        roles: b
      }
    ...
    queryGuildMentionResults(e) {
      ...
      if (u < et.rnv && o) {
        ...
        }).take(et.rnv - u).forEach(e => {
          _.push(e)
        }), u += _.length)
      }
      let p = [];
      return r && o && (u < et.rnv && a()(d, eD().test) && (p.push(eD()), u += 1), u < et.rnv && a()(d, eL().test) && p.push(eL())), {
        users: c,
        globals: p,
        roles: _
      }
    ...
    queryChoice(e) {
      let {
        ...
        limit: r = 10,
        fuzzy: i = !0
      } = e, a = t.toLocaleLowerCase(), o = RegExp("^".concat(Q.Z.escape(a)), "i"), l = RegExp(Q.Z.escape(a), "i"), c = s()(n).map((e, t) => {
        let n = eG(e.displayName.toLocaleLowerCase(), {
          exactQuery: o,
          containQuery: l,
          queryLower: a
        }, i);
    ...
    queryStaticRouteChannels(e) {
      let {
        ...
        queryLower: r
      }, a = (0, E.s)(n.id) && !n.features.has(et.oNc.HUB), o = n.features.has(et.oNc.COMMUNITY), s = (0, g.t)(n) && n.features.has(et.oNc.COMMUNITY), l = [{
      ...
      for (let e of l)(e.id !== er.HY.SERVER_GUIDE || a) && (e.id !== er.HY.CHANNEL_BROWSER || o) && (e.id !== er.HY.CUSTOMIZE_COMMUNITY || s) && eG(e.name.toLocaleLowerCase(), i, !1) > 0 && c.push(new P.nl({
        id: e.id,
        name: e.name,
        type: et.d4z.UNKNOWN,
        guild_id: n.id
    ...
    queryApplicationCommandChannelResults(e) {
      ...
      let o = [];
      for (let e of ej) o = o.concat(this.queryChannels({
        query: t,
        guildId: n.guild_id,
        limit: i,
        fuzzy: !0,
    ...
    queryStickers(e) {
      ...
      return 0 === (l = s()(l).sortBy(e => -1 * e.score).value()).length && (l = ew), l
    },
    querySoundmoji(e, t) {
