...
function ej(e) {
  let {
    ...
    allowSnowflake: o,
    boosters: s
  } = e, l = Z.default.getUsers(), c = F.Z.getGuildId(), u = t.toLocaleLowerCase(), f = (0, Q.Fv)(u), _ = [], p = [], h = n.length, m = 0, g = 0;
  for (; m < h;) {
    ...
    if (null != r && (null == i || i(r))) {
      ...
      }) : g < eT && (a()(u, i) || a()(f, l) || null != c && a()(u, c) || null != d && a()(f, d) || null != m && a()(u, m) || null != E && a()(f, E)) && (p.push({
        type: ee.h8.USER,
        record: r,
        score: ew(ep, null == s ? void 0 : s[r.id]),
...
let eW = (0, Y.oH)((e, t, n) => {
  ...
  eK = {
    ...
    queryDMUsers(e) {
      ...
      return ej({
        query: t,
        members: D.Z.getDMUserIds().map(e => Z.default.getUser(e)).filter(W.lm),
        limit: n,
        filter: r
      })
    },
    ...
    queryGuildUsers(e) {
      ...
      return i && n.length > 0 && K.Z.requestMembers(t, n, r), ej({
        query: n,
        members: l,
        limit: r,
        filter: o,
    ...
    queryUsers(e) {
      ...
      return n && e.length > 0 && K.Z.requestMembers(null, e, t), ej({
        query: e,
    ...
    queryChannels(e) {
      ...
      for (let e of t) {
        ...
        if (0 !== c) {
          ...
          0 !== c && !(t.length > 1) && (1 !== t.length || t[0].isFullMatch || s) && (eB(l, e.type) && (c = Math.max(c - eh, ep / 2)), c = Math.min(c + Math.min(null != (b = L.Z.getScoreWithoutFetchingLatest(e.id)) ? b : 0 / E, 1) * em, c >= ed ? eu : ed), g.push({
    ...
    queryDMChannels(e) {
      let {
        ...
        recipientsById: a,
        recipients: o
      } = eW(D.Z.getPrivateChannelsVersion(), B.Z.getVersion(), Z.default.getUserStoreVersion()), s = ej({
        query: t,
        members: o,
        limit: o.length,
        boosters: r
    ...
    queryInAppNavigations(e) {
      ...
      return es.getState().options.forEach(e => {
        var t;
    ...
    queryMentionResults(e) {
      ...
      let y = [];
      return !n.isPrivate() && r && c && (g < _ && a()(E, eC().test) && (y.push(eC()), g += 1), i && g < _ && a()(E, eR().test) && y.push(eR())), {
        users: m,
        globals: y,
        roles: b
      }
    ...
    queryGuildMentionResults(e) {
      ...
      if (u < $.rnv && o) {
        ...
        }).take($.rnv - u).forEach(e => {
          f.push(e)
        }), u += f.length)
      }
      let p = [];
      return r && o && (u < $.rnv && a()(d, eC().test) && (p.push(eC()), u += 1), u < $.rnv && a()(d, eR().test) && p.push(eR())), {
        users: c,
        globals: p,
        roles: f
      }
    ...
    queryStaticRouteChannels(e) {
      let {
        ...
        queryLower: r
      }, a = (0, E.s)(n.id) && !n.hasFeature($.oNc.HUB), o = n.hasFeature($.oNc.COMMUNITY), s = (0, g.t)(n) && n.hasFeature($.oNc.COMMUNITY), l = [{
      ...
      for (let e of l)(e.id !== et.HY.SERVER_GUIDE || a) && (e.id !== et.HY.CHANNEL_BROWSER || o) && (e.id !== et.HY.CUSTOMIZE_COMMUNITY || s) && ek(e.name.toLocaleLowerCase(), i, !1) > 0 && c.push(new R.nl({
        id: e.id,
        name: e.name,
        type: $.d4z.UNKNOWN,
        guild_id: n.id
    ...
    queryApplicationCommandChannelResults(e) {
      ...
      let o = [];
      for (let e of eL) o = o.concat(this.queryChannels({
        query: t,
        guildId: n.guild_id,
        limit: i,
        fuzzy: !0,
    ...
    queryStickers(e) {
      ...
      return 0 === (l = s()(l).sortBy(e => -1 * e.score).value()).length && (l = eN), l
    },
    querySoundmoji(e, t) {
