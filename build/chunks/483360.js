...
n.d(t, {
  ...
  gF: () => eo,
  k1: () => eC
}), n(35282), n(413496), n(433524), n(539854), n(642613), n(290780), n(704826), n(388685), n(583741);
var i = n(658722),
  a = n.n(i),
  o = n(392711),
  s = n.n(o),
...
let es = new h.Z("AutocompleteUtils"),
  ...
  ev = /(\t|\s)/,
  eI = [],
  eT = (r = n(786074).Z).MENTION_EVERYONE,
  eS = r.MENTION_HERE,
...
function eD(e) {
  let {
    ...
    filter: i,
    allowSnowflake: o
  } = e, s = F.default.getUsers(), l = V.Z.getGuildId(), c = t.toLocaleLowerCase(), u = (0, q.Fv)(c), _ = [], f = [], p = n.length, h = 0, m = 0;
  for (; h < p;) {
    var g, E, b, y, O, v, I, T, S;
    let e, r, d = n[h];
    ...
    if (null != r && (null == i || i(r))) {
      ...
      o && t === r.id || n.substring(0, c.length) === c || i.substring(0, c.length) === c || (null == e ? void 0 : e.substring(0, c.length)) === c || (null == l ? void 0 : l.substring(0, c.length)) === c || (null == p ? void 0 : p.substring(0, c.length)) === c || (null == h ? void 0 : h.substring(0, c.length)) === c ? _.push({
        type: J.h8.USER,
        record: r,
        score: el,
        comparator: null != (y = null != p ? p : e) ? y : n,
        sortable: null != (O = null != h ? h : l) ? O : i
      }) : s.substring(0, u.length) === u || (null == d ? void 0 : d.substring(0, u.length)) === u || (null == g ? void 0 : g.substring(0, u.length)) === u ? _.push({
        type: J.h8.USER,
        record: r,
        score: e_,
        comparator: null != (v = null != p ? p : e) ? v : n,
        sortable: null != (I = null != h ? h : l) ? I : i
      }) : m < ey && (a()(c, i) || a()(u, s) || null != l && a()(c, l) || null != d && a()(u, d) || null != h && a()(c, h) || null != g && a()(u, g)) && (f.push({
        type: J.h8.USER,
        record: r,
        score: e_,
        comparator: null != (T = null != p ? p : e) ? T : n,
        sortable: null != (S = null != h ? h : l) ? S : i
      }), m += 1)
    }
    h += 1
  }
  return _.sort(d.Z), _.length < r && (f.sort(d.Z), _ = _.concat(f.slice(0, Math.max(0, r - _.length)))), _.length > r && (_.length = r), _
}
...
function eB(e, t) {
  ...
  return null == e || null == n ? [] : s()(k.Z.getMessages(e).toArray()).reverse().uniqBy(e => e.author.id).map(e => F.default.getUser(e.author.id)).filter(e => {
...
let eV = {
  queryFriends(e) {
    ...
    return eD({
      query: t,
      members: G.Z.getFriendIDs().map(e => F.default.getUser(e)).filter(H.lm),
      limit: n,
      filter: i
    })
  },
  queryDMUsers(e) {
    ...
    return eD({
      query: t,
      members: w.Z.getDMUserIds().map(e => F.default.getUser(e)).filter(H.lm),
      limit: n,
      filter: r
    })
  },
  ...
  queryGuildUsers(e) {
    ...
    return i && n.length > 0 && Y.Z.requestMembers(t, n, r), eD({
      query: n,
      members: l,
      limit: r,
      filter: o,
  ...
  queryUsers(e) {
    ...
    return n && e.length > 0 && Y.Z.requestMembers(null, e, t), eD({
      query: e,
  ...
  queryChannels(e) {
    let t, {
      ...
      h = ek(n, c);
    t = null != r ? s()(L.ZP.getChannels(r)[l]).map(e => e.channel).concat(N.Z.computeAllActiveJoinedThreads(r)).value() : s()(w.Z.loadAllGuildAndPrivateChannelsFromDisk()).values().concat(N.Z.computeAllActiveJoinedThreads()).value();
    let m = {},
      g = [],
      E = D.Z.getMaxScore();
    for (let e of t) {
      ...
      if (0 !== c) {
        ...
        0 !== c && !(t.length > 1) && (1 !== t.length || t[0].isFullMatch || s) && (eM(l, e.type) && (c = Math.max(c - ef, e_ / 2)), c = Math.min(c + Math.min(null != (b = D.Z.getScoreWithoutFetchingLatest(e.id)) ? b : 0 / E, 1) * ep, c >= ec ? el : ec), g.push({
          type: (0, R.bw)(e.type) ? J.h8.VOICE_CHANNEL : J.h8.TEXT_CHANNEL,
          record: e,
          score: eN(c, f[e.id]),
          comparator: (0, _.F6)(e, F.default, G.Z),
          sortable: i
        }))
      }
    }
  ...
  queryGroupDMs(e) {
    let {
      ...
      filter: i = eO,
      boosters: a = {}
    } = e, o = (0, q._I)((0, q.Fv)(t.toLocaleLowerCase())), l = {
      exactQuery: RegExp("^".concat(K.Z.escape(o)), "i"),
      containQuery: RegExp(K.Z.escape(o), "i"),
      queryLower: o
    }, c = s()(w.Z.getMutablePrivateChannels()).values().value(), u = [];
    for (let e of c) {
      if (!e.isMultiUserDM() || !i(e)) continue;
      let t = (0, _.F6)(e, F.default, G.Z).toLocaleLowerCase(),
        n = (0, q._I)((0, q.Fv)(t)),
        o = eP(n, l, r);
      o > 0 && u.push({
        type: J.h8.GROUP_DM,
  ...
  queryInAppNavigations(e) {
    ...
    return ea.getState().options.forEach(e => {
      var t;
  ...
  queryMentionResults(e) {
    ...
    if (g < f && c) {
      ...
      if (null != i) {
        ...
        b = (0, l.Lu)(n, t, {
          keys: ["name"]
        }).slice(0, f - g), g += b.length
      }
    }
    let y = [];
    return !n.isPrivate() && r && c && (g < f && a()(E, eT().test) && (y.push(eT()), g += 1), i && g < f && a()(E, eS().test) && y.push(eS())), {
      users: m,
      globals: y,
      roles: b
    }
  ...
  queryGuildMentionResults(e) {
    let {
      ...
      status: U.Z.getStatus(e.record.id)
    ...
    let p = [];
    return r && o && (u < Q.rnv && a()(d, eT().test) && (p.push(eT()), u += 1), u < Q.rnv && a()(d, eS().test) && p.push(eS())), {
      users: c,
      globals: p,
      roles: _
    }
  ...
  queryChoice(e) {
    let {
      ...
      limit: r = 10,
      fuzzy: i = !0
    } = e, a = t.toLocaleLowerCase(), o = RegExp("^".concat(K.Z.escape(a)), "i"), l = RegExp(K.Z.escape(a), "i"), c = s()(n).map((e, t) => {
      let n = eP(e.displayName.toLocaleLowerCase(), {
        exactQuery: o,
        containQuery: l,
        queryLower: a
      }, i);
    ...
    }).filter(H.lm).sortBy(e => -1 * e.score);
  ...
  queryStaticRouteChannels(e) {
    let {
      ...
      queryLower: r
    }, a = (0, E.s)(n.id) && !n.hasFeature(Q.oNc.HUB), o = n.hasFeature(Q.oNc.COMMUNITY), s = (0, g.t)(n) && n.hasFeature(Q.oNc.COMMUNITY), l = [{
      id: $.HY.SERVER_GUIDE,
    ...
    for (let e of l)(e.id !== $.HY.SERVER_GUIDE || a) && (e.id !== $.HY.CHANNEL_BROWSER || o) && (e.id !== $.HY.CUSTOMIZE_COMMUNITY || s) && eP(e.name.toLocaleLowerCase(), i, !1) > 0 && c.push(new R.nl({
      id: e.id,
      name: e.name,
      type: Q.d4z.UNKNOWN,
      guild_id: n.id
  ...
  queryApplicationCommandChannelResults(e) {
    ...
    let o = [];
    for (let e of eC) o = o.concat(this.queryChannels({
      query: t,
      guildId: n.guild_id,
      limit: i,
      fuzzy: !0,
  ...
  queryStickers(e) {
    ...
    for (let s of (C.DZ.loadIfNecessary(), e)) {
      ...
      i.forEach((i, s) => {
        ...
        for (let n of i) {
          ...
          t ? i === e ? o = el * a : u.test(i) ? o = ec * a : (r === A.MO.GUILD_NAME || r === A.MO.PACK_NAME || r === A.MO.STICKER_NAME) && d.test(i) && (o = eu * a) : i === e && (o = el * a, _ = i), o > c && (c = o, _ = i)
        }
    ...
    return 0 === (l = s()(l).sortBy(e => -1 * e.score).value()).length && (l = eI), l
  },
  querySoundmoji(e, t) {
