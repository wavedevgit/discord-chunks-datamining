...
function e0(e) {
  let {
    ...
    allowSnowflake: o,
    boosters: s
  } = e, l = Q.default.getUsers(), c = X.Z.getGuildId(), u = t.toLocaleLowerCase(), d = (0, es.Fv)(u), p = [], _ = [], m = n.length, h = 0, g = 0;
  for (; h < m;) {
  ...
  tt = {
    ...
    queryChannels(e) {
      ...
      for (let e of t) {
        ...
        if (0 !== c) {
          ...
          0 !== c && !(t.length > 1) && (1 !== t.length || t[0].isFullMatch || s) && (e4(l, e.type) && (c = Math.max(c - eC, eA / 2)), e.isThread() && (e.isActiveThread() || (c -= eN), D.Z.hasJoined(e.id) || (c -= eP)), c = Math.min(c + Math.min(null != (O = G.Z.getScoreWithoutFetchingLatest(e.id)) ? O : 0 / y, 1) * eR, c >= eS ? eO : eS), b.push({
            type: (0, L.bw)(e.type) ? eu.h8.VOICE_CHANNEL : eu.h8.TEXT_CHANNEL,
            record: e,
            score: eK(c, d[e.id]),
            comparator: (0, p.F6)(e, Q.default, z.Z),
            sortable: i
          }))
        }
      }
    ...
    queryGroupDMs(e) {
      ...
      for (let e of c) {
        ...
        let t = (0, p.F6)(e, Q.default, z.Z).toLocaleLowerCase(),
          n = (0, es._I)((0, es.Fv)(t)),
          o = eQ(n, l, r),
          s = [];
        ...
        for (let e of s) {
          let t = Math.min(eI, eQ((0, es._I)((0, es.Fv)(e.toLocaleLowerCase())), l, r));
          t > o && (o = t)
        }
        o > 0 && u.push({
          type: eu.h8.GROUP_DM,
    ...
    queryGuildMentionResults(e) {
      ...
      if (u < ec.rnv && o) {
        ...
        null != e && (s()(V.Z.getSortedRoles(e.id)).filter(e => (e.mentionable || r || l) && a()(d, e.name.toLowerCase()) && !(0, j.fI)(e)).take(ec.rnv - u).forEach(e => {
          f.push(e)
        }), u += f.length)
      }
      let p = [];
    ...
    queryStaticRouteChannels(e) {
      ...
      for (let e of l)(e.id !== ed.HY.SERVER_GUIDE || a) && (e.id !== ed.HY.CHANNEL_BROWSER || o) && (e.id !== ed.HY.CUSTOMIZE_COMMUNITY || s) && eQ(e.name.toLocaleLowerCase(), i, false) > 0 && c.push(new L.nl({
        id: e.id,
        name: e.name,
        type: ec.d4z.UNKNOWN,
        guild_id: n.id
    ...
    queryMentionSuggestionResults(e) {
      ...
      }) : F.ZP.getMembers(n.guild_id).filter(eJ), s = k.default.getId(), l = Q.default.getUsers(), c = X.Z.getGuildId(), u = t.toLocaleLowerCase(), d = (0, es.Fv)(u), p = [];
      c: for (let e of o) {
        var _, m, h, g;
        let t, o;
        if (p.length >= r) break;
