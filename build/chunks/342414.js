...
let L = e => {
    ...
    let {
      ...
      headingText: c,
      headingTop: d
    } = V(), u = g.default.getCurrentUser(), p = (0, a.e7)([h.Z], () => h.Z.getPremiumTypeSubscription()), f = (0, E.N)(), b = (0, O.Ng)(), x = (0, O.Wp)(b, P.Si.TIER_2) ? P.Si.TIER_2 : void 0, _ = null != p && p.status !== R.O0b.ACCOUNT_HOLD && p.hasAnyPremiumNitro, j = (0, m.Z)(), v = (0, C.C)("nitro-home", u) && j.isFractionalPremiumActive && !_;
    return (0, i.jsxs)("div", {
  ...
  G = e => {
    ...
    a || l ? (O = D.intl.string(D.t.ifwQZW), C = (0, i.jsx)(M, {
      isEligibleForBogoPromotion: l
    })) : f && (h = D.intl.string(D.t.qYKftb), O = D.intl.string(D.t.ifwQZW), C = (0, i.jsx)(B, {}));
    let N = null;
