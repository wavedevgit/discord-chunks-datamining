...
let L = e => {
    ...
    let {
      ...
      headingText: c,
      headingTop: d
    } = V(), u = g.default.getCurrentUser(), p = (0, a.e7)([h.Z], () => h.Z.getPremiumTypeSubscription()), f = (0, E.N)(), b = (0, C.Ng)(), x = (0, C.Wp)(b, P.Si.TIER_2) ? P.Si.TIER_2 : void 0, _ = null != p && p.status !== R.O0b.ACCOUNT_HOLD && p.hasAnyPremiumNitro, j = (0, m.Z)(), v = (0, O.C)("nitro-home", u) && j.isFractionalPremiumActive && !_;
    return (0, i.jsxs)("div", {
  ...
  G = e => {
    ...
    a || l ? (C = D.intl.string(D.t.ifwQZW), O = (0, i.jsx)(M, {
      isEligibleForBogoPromotion: l
    })) : f && (h = D.intl.string(D.t.qYKftb), C = D.intl.string(D.t.ifwQZW), O = (0, i.jsx)(B, {}));
    let N = null;
    if (E === P.a$.NONE || a) N = (0, i.jsx)(I.Cy, {
