...
let Z = e => {
    ...
    let {
      ...
      headingText: o,
      headingTop: c
    } = B(), d = g.default.getCurrentUser(), m = (0, l.e7)([p.ZP], () => p.ZP.getPremiumTypeSubscription()), h = (0, j.N)(), f = null != m && m.status !== y.O0b.ACCOUNT_HOLD && m.hasAnyPremiumNitro, b = (0, u.Z)(), _ = (0, x.C)("nitro-home", d) && b.isFractionalPremiumActive && !f;
    return (0, i.jsxs)("div", {
  ...
  M = e => {
    ...
    } = (0, c.ZP)(o.Z.PREMIUM_MARKETING_HERO_CTA), l = (0, _.W)(), g = (0, b._O)(), p = A.intl.string(A.t.qYKftb), h = (0, C.b)(n), x = (0, i.jsx)(Z, {
      className: t
    }), E = A.intl.string(A.t.ifwQZW), {
      fractionalState: j,
      endsAt: O
    } = (0, u.Z)(), v = (0, d.Z)(O, d.a.CREDITS_ENDS_IN);
    l ? (E = A.intl.string(A.t.ifwQZW), x = (0, i.jsx)(k, {})) : h && (p = A.intl.string(A.t.qYKftb), E = A.intl.string(A.t.ifwQZW), x = (0, i.jsx)(w, {
      location: n
    }));
    let T = null;
    if (j === N.a$.NONE || l) T = (0, i.jsx)(S.Cy, {
      className: s()(P.trialPill, {
        [P.hidden]: !g
      }),
      text: p,
      ...
      let e = (0, i.jsx)("div", {
        ...
        t = A.intl.format(A.t["yR+oDA"], {
          helpCenterLink: f.Z.getArticleURL(y.BhN.FRACTIONAL_PREMIUM_ABOUT)
        });
      T = (0, i.jsx)(m.Z, {
        text: t,
