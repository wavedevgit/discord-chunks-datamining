...
function ep(e) {
  ...
  } = e, a = G.Z.getGuild(t), s = (0, v.K2)(t, "invite") ? null == a ? void 0 : a.hasFeature($.oNc.MEMBER_VERIFICATION_MANUAL_APPROVAL) : (null == a ? void 0 : a.hasFeature($.oNc.MEMBER_VERIFICATION_MANUAL_APPROVAL)) && !(null == a ? void 0 : a.hasFeature($.oNc.PREVIEW_ENABLED)), {
    targetUserId: l,
    targetType: c,
...
let ev = {
  ...
  openApp(e, t, n, r, o) {
    ...
    if (f.Z.dispatch({
        ...
        code: e
      }), null != i().ua && i().ua.toLowerCase().indexOf("googlebot") > -1) return void f.Z.dispatch({
