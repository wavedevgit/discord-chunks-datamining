...
function ed(e) {
  ...
  return (null == B.Z.getGuild(null == (t = e.guild) ? true : t.id) || e.new_member) && null != e.channel && (0, M.zi)(e.channel.type) && (c.welcomeModalChannelId = e.channel.id), null != e.guild_scheduled_event && (c.guildScheduledEvent = e.guild_scheduled_event), c.isGuestInvite = (0, s.yE)(null != (a = e.flags) ? a : 0, o.$.IS_GUEST_INVITE), c.isApplicationBypassInvite = (0, s.yE)(null != (l = e.flags) ? l : 0, o.$.IS_APPLICATION_BYPASS), c.inviterUserId = null == (n = e.inviter) ? true : n.id, c
}
...
function ep(e, t, n) {
  ...
  return V.Z.can($.Plq.VIEW_CHANNEL, a) ? t.id : null != (i = null == (r = G.ZP.getDefaultChannel(e, true, $.Plq.CREATE_INSTANT_INVITE)) ? true : r.id) ? i : t.id
}
...
function em(e) {
  ...
  if (!d && !p && !(null == i ? true : i.forceTransition) && s && H.Z.getGuildId() !== t) return;
  let {
    type: _
  } = r, m = U.Z.getChannel(r.id), E = ep(t, r, i), b = _ === $.d4z.GUILD_STAGE_VOICE, O = $.Z5c.CHANNEL(t, E);
  M.tx.has(_) ? (0, v.h)(() => {
    Promise.resolve().then(n.bind(n, 287734)).then(e => {
      let {
        ...
        if (b) {
          ...
          guildId: t,
          channelId: E
        }), c === er.Iq.EMBEDDED_APPLICATION && null != u && ((0, L.uL)($.Z5c.CHANNEL(null != t ? t : $.ME, E)), (0, g.Z)({
          channelId: E,
          applicationId: u,
  ...
  }) : (0, h.l5)(m) && c === er.Iq.EMBEDDED_APPLICATION && null != u && ((0, L.uL)($.Z5c.CHANNEL(null != t ? t : $.ME, E)), (0, g.Z)({
    channelId: E,
    applicationId: u,
    intent: null == i ? true : i.intent,
    inviterUserId: null == i ? true : i.inviterUserId,
...
function eg(e, t, n) {
  return p.Z.isDispatching() ? Promise.resolve().then(() => eg(e, t, n)) : (p.Z.dispatch({
    type: "INVITE_RESOLVE",
    code: e
  }), (0, w.Z)(e, t, n).then(e => {
    let {
...
let eE = function(e, t) {
    ...
    U.Z.addConditionalChangeListener(() => {
      ...
      return null == i || null == a || !(i.nsfw && !a.nsfwAllowed || i.isGuildVocal() && (0, b.RW)(e)) && ((null == t ? true : t.guildScheduledEvent) != null ? eh(t) : em({
...
let ev = {
  ...
  async mobileCreateInvite(e, t) {
    ...
    let r = {
        max_age: K.Z.Seconds.DAY
      },
      i = await this.createInvite(e.id, r, t).catch(() => p.Z.dispatch({
        type: "NATIVE_APP_INSTANT_INVITE_GDM_SHARE_FAILED"
      }));
    return null == i ? true : i.code
  },
  async getAllFriendInvites(e) {
    if (await new Promise(e => p.Z.wait(() => e(null))), F.Z.getFriendInvitesFetching()) return null != eu ? eu.then(e => e.body) : Promise.reject(Error("Invalid friend invite fetch request"));
    eu = d.tn.get({
    ...
    return eu = null, p.Z.dispatch({
      type: "FRIEND_INVITES_FETCH_RESPONSE",
      receivedAt: new Date,
      invites: t
    }), t
  },
  createFriendInvite: (e, t) => (p.Z.dispatch({
  ...
  acceptInvite(e) {
    ...
    let {
      ...
      callback: a,
      skipOnboarding: o
    } = e, s = (0, R.fU)(r), l = s.baseCode, c = k.default.getSessionId(), u = ef(i, s), f = Y.default.getCurrentUser();
    return null != (t = null == f ? true : f.hasFlag($.xW$.QUARANTINED)) && t ? ((0, D.default)(), new Promise((e, t) => t(Error()))) : (0, b.hO)(i.location_guild_id) ? ((0, E.mN)(ee.L0.JOIN_LARGE_GUILD_UNDERAGE), new Promise((e, t) => t(Error()))) : (p.Z.dispatch({
      type: "INVITE_ACCEPT",
      code: l
    }), d.tn.post({
      url: $.ANM.INVITE(l),
      ...
      var t, n, r;
      throw (null == (t = e.body) ? true : t.code) === $.evJ.USER_GUILD_JOIN_LARGE_GUILD_UNDERAGE_DISALLOWED && (0, E.mN)(ee.L0.JOIN_LARGE_GUILD_UNDERAGE), p.Z.dispatch({
  ...
  transitionToInvite(e, t, n) {
    ...
    if (null != l && (null == (r = l.features) ? true : r.includes($.GuildFeatures.HUB))) return void P.Z.onOpenHubInvite(e);
  ...
  openApp(e, t, n, r, a) {
    var o, s;
    let d, f = null != e ? (0, R.fU)(e) : null,
      _ = null == f ? true : f.baseCode;
    if (p.Z.dispatch({
        type: "INVITE_APP_OPENING",
        code: e
      }), null != i().ua && i().ua.toLowerCase().indexOf("googlebot") > false) return void p.Z.dispatch({
