...
function ef(e) {
  ...
  } = e, o = G.Z.getGuild(t), s = null == o ? void 0 : o.features.has(J.oNc.MEMBER_VERIFICATION_MANUAL_APPROVAL), {
    targetUserId: l,
    targetType: c,
    ...
    Promise.resolve().then(n.bind(n, 287734)).then(e => {
      let {
        ...
        if (I) {
          ...
          return
        }(null == i ? void 0 : i.muteOnJoinVoiceChannel) && q.Z.setSelfMute(d.Yn.DEFAULT, !0), n.selectVoiceChannel(b), c === et.Iq.STREAM && null != l && Q.iV({
...
function eh(e, t, n) {
  return _.Z.isDispatching() ? Promise.resolve().then(() => eh(e, t, n)) : (_.Z.dispatch({
    type: "INVITE_RESOLVE",
    code: e
  }), (0, R.Z)(e, t, n).then(e => {
    let {
...
let em = function(e, t) {
    ...
    k.Z.addConditionalChangeListener(() => {
      ...
      return null == i || null == a || !(i.nsfw && !a.nsfwAllowed || i.isGuildVocal() && (0, g.RW)(e)) && ((null == t ? void 0 : t.guildScheduledEvent) != null ? ep(t) : ef({
...
let ey = {
  ...
  acceptInvite(e) {
    ...
    let {
      ...
      callback: a,
      skipOnboarding: o
    } = e, s = (0, C.fU)(r), l = s.baseCode, c = M.default.getSessionId(), d = eu(i, s), f = Z.default.getCurrentUser();
    return null != (t = null == f ? void 0 : f.hasFlag(J.xW$.QUARANTINED)) && t ? ((0, P.default)(), new Promise((e, t) => t(Error()))) : (_.Z.dispatch({
      type: "INVITE_ACCEPT",
      code: l
    }), u.tn.post({
      url: J.ANM.INVITE(l),
