...
function e_(e) {
  ...
  } = e, o = U.Z.getGuild(t), s = null == o ? void 0 : o.hasFeature(J.oNc.MEMBER_VERIFICATION_MANUAL_APPROVAL), {
    targetUserId: l,
    targetType: c,
    ...
    Promise.resolve().then(n.bind(n, 287734)).then(e => {
      let {
        ...
        if (I) {
          ...
          return
        }(null == i ? void 0 : i.muteOnJoinVoiceChannel) && q.Z.setSelfMute(d.Yn.DEFAULT, !0), n.selectVoiceChannel(O), c === et.Iq.STREAM && null != l && X.iV({
          streamType: ee.lo.GUILD,
          ownerId: l,
          guildId: t,
          channelId: O
        }), c === et.Iq.EMBEDDED_APPLICATION && null != u && ((0, w.uL)(J.Z5c.CHANNEL(null != t ? t : J.ME, O)), (0, m.Z)({
          channelId: O,
          applicationId: u,
  ...
  }) : (0, h.l5)(E) && c === et.Iq.EMBEDDED_APPLICATION && null != u && ((0, w.uL)(J.Z5c.CHANNEL(null != t ? t : J.ME, O)), (0, m.Z)({
    channelId: O,
    applicationId: u,
    intent: null == i ? void 0 : i.intent,
    inviterUserId: null == i ? void 0 : i.inviterUserId,
...
let em = function(e, t) {
    ...
    M.Z.addConditionalChangeListener(() => {
      ...
      return null == i || null == a || (!i.nsfw || !!a.nsfwAllowed) && ((null == t ? void 0 : t.guildScheduledEvent) != null ? ep(t) : e_({
...
let ey = {
  ...
  acceptInvite(e) {
    ...
    let {
      ...
      callback: a,
      skipOnboarding: o
    } = e, s = (0, A.fU)(r), l = s.baseCode, c = x.default.getSessionId(), d = eu(i, s), _ = Z.default.getCurrentUser();
