...
function ef(e) {
  ...
  }) : (0, _.l5)(g) && c === ee.Iq.EMBEDDED_APPLICATION && null != u && ((0, w.uL)(X.Z5c.CHANNEL(null != t ? t : X.ME, O)), (0, h.Z)({
    channelId: O,
    applicationId: u,
    intent: null == i ? void 0 : i.intent,
    inviterUserId: null == i ? void 0 : i.inviterUserId,
  ...
  em = async e => {
    ...
    acceptInvite(e) {
      ...
      let {
        ...
        callback: o,
        skipOnboarding: a
      } = e, s = (0, A.fU)(r), l = s.baseCode, c = L.default.getSessionId(), f = ec(i, s), _ = V.default.getCurrentUser();
