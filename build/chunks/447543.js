...
function e_(e, t) {
  ...
  } = null != t ? t : {}, a = n === $.d4z.GUILD_STAGE_VOICE, s = {
...
function ep(e) {
  ...
  } = e, a = G.Z.getGuild(t), s = (0, y.K2)(t, "invite") ? null == a ? void 0 : a.hasFeature($.oNc.MEMBER_VERIFICATION_MANUAL_APPROVAL) : (null == a ? void 0 : a.hasFeature($.oNc.MEMBER_VERIFICATION_MANUAL_APPROVAL)) && !(null == a ? void 0 : a.hasFeature($.oNc.PREVIEW_ENABLED)), {
    targetUserId: l,
    targetType: c,
  ...
  let {
    type: p
  } = r, E = k.Z.getChannel(r.id), I = ef(t, r, i), S = p === $.d4z.GUILD_STAGE_VOICE, T = $.Z5c.CHANNEL(t, I);
  x.tx.has(p) ? (0, b.h)(() => {
    Promise.resolve().then(n.bind(n, 287734)).then(e => {
      let {
        ...
        if (S) {
          ...
          return
        }(null == i ? void 0 : i.muteOnJoinVoiceChannel) && Q.Z.setSelfMute(d.Yn.DEFAULT, !0), n.selectVoiceChannel(I), c === en.Iq.STREAM && null != l && J.iV({
          streamType: et.lo.GUILD,
          ownerId: l,
          guildId: t,
          channelId: I
        }), c === en.Iq.EMBEDDED_APPLICATION && null != u && ((0, D.uL)($.Z5c.CHANNEL(null != t ? t : $.ME, I)), (0, m.Z)({
          channelId: I,
          applicationId: u,
  ...
  }) : (0, h.l5)(E) && c === en.Iq.EMBEDDED_APPLICATION && null != u && ((0, D.uL)($.Z5c.CHANNEL(null != t ? t : $.ME, I)), (0, m.Z)({
    channelId: I,
    applicationId: u,
    intent: null == i ? void 0 : i.intent,
    inviterUserId: null == i ? void 0 : i.inviterUserId,
...
let eg = function(e, t) {
    ...
    k.Z.addConditionalChangeListener(() => {
      ...
      return null == i || null == o || (!i.nsfw || !!o.nsfwAllowed) && ((null == t ? void 0 : t.guildScheduledEvent) != null ? eh(t) : ep({
...
let ey = {
  ...
  acceptInvite(e) {
    ...
    return null !== (t = null == _ ? void 0 : _.hasFlag($.xW$.QUARANTINED)) && void 0 !== t && t ? ((0, P.default)(), new Promise((e, t) => t(Error()))) : (f.Z.dispatch({
      type: "INVITE_ACCEPT",
      code: l
    }), u.tn.post({
      url: $.ANM.INVITE(l),
  ...
  transitionToInvite(e, t, n) {
    ...
    if (null == o) return;
    let c = eu(e);
    null != t && (c.transitionTo = t), null != n && (c.muteOnJoinVoiceChannel = n), ep({
  ...
  transitionToInviteSync(e, t, n) {
    if (null != e.channel) {
      let r = eu(e);
      this.transitionToInviteChannelSync(e.channel.id, es(eo({}, r), {
        intent: n,
        transitionTo: t,
        forceTransition: !0
      }))
