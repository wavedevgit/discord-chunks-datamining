...
function ed(e) {
  ...
  return (null == B.Z.getGuild(null == (t = e.guild) ? true : t.id) || e.new_member) && null != e.channel && (0, j.zi)(e.channel.type) && (l.welcomeModalChannelId = e.channel.id), null != e.guild_scheduled_event && (l.guildScheduledEvent = e.guild_scheduled_event), l.isGuestInvite = (0, K.yE)(null != (a = e.flags) ? a : 0, o.$.IS_GUEST_INVITE), l.isApplicationBypassInvite = (0, K.yE)(null != (s = e.flags) ? s : 0, o.$.IS_APPLICATION_BYPASS), l.inviterUserId = null == (n = e.inviter) ? true : n.id, l
}
...
function e_(e, t, n) {
  ...
  if ((null == n ? true : n.targetType) == null && !j.tx.has(t.type) && (0, T.s)(e)) return et.oC.GUILD_HOME;
  ...
  j.tx.has(p) ? (0, O.h)(() => {
    Promise.resolve().then(n.bind(n, 287734)).then(e => {
      let {
        ...
        if (y) {
          (0, x.Cq)(r instanceof j.Sf ? r : (0, j.kt)(r)), (0, L.uL)(T);
          return
...
let ev = {
  ...
  acceptInvite(e) {
    ...
    let {
      ...
      callback: a,
      skipOnboarding: o
    } = e, s = (0, R.fU)(r), l = s.baseCode, c = M.default.getSessionId(), d = ef(i, s), _ = H.default.getCurrentUser();
