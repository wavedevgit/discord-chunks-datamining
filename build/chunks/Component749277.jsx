...
let P = e => {
  let {
    ...
    noticeType: N
  } = e, P = (0, i.e7)([E.default], () => E.default.getCurrentUser()), w = (0, i.e7)([g.Z], () => g.Z.getGuildId());
  return (0, r.jsx)(O.ZP, {
    contentTypes: [t],
      ...
      switch (t) {
        case o.z.NAGBAR_NOTICE_DOWNLOAD:
          return (0, r.jsxs)(a.qXd, {
            ...
            children: [(0, r.jsx)(a.RyX, {
              ...
              noticeType: N
            }), A.intl.string(A.t["+xn1o6"]), (0, r.jsx)("i", {
              className: C.iconApple
            }), (0, r.jsx)("i", {
              className: C.iconAndroid
            }), (0, r.jsx)("i", {
              className: C.iconWindows
            }), (0, r.jsx)(a.NoS, {
              noticeType: N,
              onClick: () => {
                (0, a.ZDy)(async () => {
        ...
        case o.z.NAGBAR_NOTICE_CONNECT_SPOTIFY:
          return (0, r.jsxs)(a.qXd, {
            ...
            }), A.intl.string(A.t["5NUVHB"]), (0, r.jsx)(a.NoS, {
              onClick: () => (0, d.Z)({
        ...
        case o.z.NAGBAR_NOTICE_CONNECT_PLAYSTATION:
          return (0, r.jsxs)(a.qXd, {
            ...
            }), A.intl.string(A.t.WHWgoa), (0, r.jsx)(a.EyT, {
              onClick: () => (0, d.Z)({
        ...
        case o.z.NAGBAR_NOTICE_MFA_SMS_BACKUP:
          return (0, r.jsxs)(a.qXd, {
            ...
            children: [(0, r.jsx)(a.RyX, {
              onClick: () => i(v.L.UNKNOWN),
              noticeType: N
            }), A.intl.string(A.t.B2hnhY), (0, r.jsx)(a.NoS, {
        ...
        case o.z.NAGBAR_NOTICE_PREMIUM_PROMO:
          return (0, r.jsxs)(a.qXd, {
            ...
            children: [(0, r.jsx)("span", {
              ...
              onClick: () => {
                i(v.L.UNKNOWN), (0, s.mB)(I.xW$.PREMIUM_PROMO_DISMISSED, true)
              },
              noticeType: N
            })]
          });
        ...
        case o.z.NAGBAR_NOTICE_PREMIUM_REACTIVATE:
          return (0, r.jsxs)(a.qXd, {
            ...
            children: [(0, r.jsx)(a.RyX, {
              noticeType: N,
              onClick: () => i(v.L.UNKNOWN)
            }), A.intl.string(A.t["0KFB2N"]), (0, r.jsx)(a.NoS, {
              noticeType: N,
              onClick: () => {
        ...
        case o.z.NAGBAR_BOUNCED_EMAIL_NOTICE:
          return (0, r.jsxs)(a.qXd, {
            ...
            children: [(0, r.jsx)(a.RyX, {
              onClick: () => i(v.L.UNKNOWN),
              noticeType: N
            }), A.intl.string(A.t["7490vb"]), (0, r.jsx)(a.NoS, {
              noticeType: N,
              onClick: () => {
        ...
        case o.z.NAGBAR_ACTIVATE_SERVER_SUBSCRIPTION:
          ...
          return (0, r.jsxs)(a.qXd, {
            ...
            children: [(0, r.jsx)(a.RyX, {
              onClick: () => i(v.L.UNKNOWN),
              noticeType: N
            }), A.intl.string(A.t.pJ4hJC), (0, r.jsx)(a.NoS, {
              noticeType: N,
              onClick: () => {
                i(v.L.PRIMARY), (0, m.uL)(1 === g.length ? I.Z5c.GUILD_SETTINGS(g[0], "role-subscriptions") : I.Z5c.PICK_GUILD_SETTINGS("role-subscriptions", true, "server-subscriptions-finish-setting-up"))
              },
        ...
        case o.z.NAGBAR_NOTICE_POMELO:
          return (0, r.jsxs)(a.qXd, {
            ...
            children: [(0, r.jsx)(a.RyX, {
              onClick: () => i(v.L.UNKNOWN),
              noticeType: N
            }), A.intl.format(A.t.pdYZys, {}), (0, r.jsx)(a.NoS, {
        ...
        case o.z.CHECKOUT_RECOVERY_NAGBAR:
          return (0, r.jsxs)(a.qXd, {
            ...
            children: [(0, r.jsx)(a.RyX, {
              onClick: () => i(v.L.UNKNOWN),
              noticeType: N
            }), A.intl.string(A.t["O9GI+v"]), (0, r.jsx)(a.NoS, {
              onClick: () => {
                (0, _.Z)({
                  subscriptionTier: S.Si.TIER_2,
        ...
        case o.z.REPORT_TO_MOD_SURVEY_NOTICE:
          return (0, r.jsxs)(a.qXd, {
            ...
            }), A.intl.string(A.t["Aa+l7e"]), (0, r.jsx)(a.NoS, {
              onClick: () => {
                window.open("https://discord.sjc1.qualtrics.com/jfe/form/SV_5uP0NWTpoXsYSUu?user_id=".concat(null == P ? true : P.id, "&guild_id=").concat(w), "_blank"), i(v.L.TAKE_ACTION)
              },
              noticeType: I.kVF.REPORT_TO_MOD_SURVEY,
