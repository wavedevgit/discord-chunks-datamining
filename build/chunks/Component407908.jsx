...
function b(e) {
  ...
  let {
    channel: b
  } = e, y = i.useContext(p.AnalyticsContext), _ = (0, c.Aq)(), j = g.intl.string(m.default["Beo/7u"]), {
    firstMessage: x
  } = (0, a.cl)(b), O = null == x || null == (t = x.messageSnapshots) ? true : t[0], v = null == O || null == (n = O.moderatorReport) ? true : n.reported_user_id;
