/** Chunk was on web.js **/
/** chunk id: 539541, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  A: () => p
});
...
function p(e) {
  ...
  let m = i.useCallback(() => {
    ...
    let {
      width: i,
      height: a
    } = h.current, s = null != (e = null == (n = _.current) ? true : n.videoWidth) ? e : 0, o = null != (t = null == (r = _.current) ? true : r.videoHeight) ? t : 0;
    if (i !== s || a !== o) {
      let e = {
        width: s,
        height: o
