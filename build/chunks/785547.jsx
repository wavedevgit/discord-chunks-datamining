...
class M extends(r = Chunk73800.Component) {
  ...
  renderPlayButton() {
    ...
    return <Chunk701560.Z applicationId={module.id} libraryApplication={module} fullWidth={exports} size={require} color={r} customDisabledColor={Chunk73800} isShiny={Chunk442837} onDropdownOpen={Chunk692547} onDropdownClose={Chunk755721} analyticsListSort={Chunk481060} analyticsListIndex={Chunk58642} />
  }
  renderDisabledButton(e, t) {
    ...
    return <div className={A.disabledButtonWrapper}>{<l.zx className={n} fullWidth={r} size={o} color={null != a ? a : A.disabledButtonColor} disabled={true}>{this.getText(e)}{this.renderProgressBar()}</l.zx>}{<c.ua7 text={t} position={s}>{e => (0, i.jsx)("div", C({
  ...
  renderProgressBar() {
    ...
    return <Chunk481060.Exd percent={r} size={Chunk481060.Exd.Sizes.XSMALL} foregroundColor={require.paused ? Chunk692547.Z.unsafe_rawColors.PRIMARY_500.css : Chunk692547.Z.unsafe_rawColors.GREEN_360.css} backgroundColor={Chunk692547.Z.unsafe_rawColors.TRANSPARENT.css} className={Chunk207178.progress} />
  }
  renderActionButton(e, t) {
    ...
    return <l.zx className={n} fullWidth={r} size={o} color={null != a ? a : l.zx.Colors.GREEN} submitting={"uninstalling" === e || s} onClick={e => this.handleClick(e, t)}>{this.getText(e)}{this.renderProgressBar()}</l.zx>
  }
  render() {
    let {
      hasNoBuild: e,
