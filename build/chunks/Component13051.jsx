...
function D(e) {
  let t, {
    ...
    F = r.useCallback(() => {
      l.syncing || (0, g.h7j)(e => {
        if (!H && l.expire_behavior === c.l.KICK) return (0, i.jsx)(g.VoidConfirmModal, A(k({}, e), {
        ...
        return (0, i.jsx)(g.VoidConfirmModal, A(k({}, e), {
          header: w.intl.string(w.t.emx3lN),
          confirmText: t,
    ...
    X = (0, m.e7)([y.Z], () => null != l.role_id ? y.Z.getRole(n.id, l.role_id) : true),
    {
      roleLink: $,
      syncDescriptionText: ee
    } = r.useMemo(() => {
      let e;
      e = null != X ? (0, i.jsx)(g.eee, {
        onClick: z,
        children: X.name
    ...
    children: [(0, i.jsx)(g.izJ, {
      ...
      return (0, i.jsxs)(x.Z, {
        ...
        children: [(0, i.jsx)("div", {
          ...
          children: n.map((e, t) => (0, i.jsx)(p.u, {
            text: e.name,
