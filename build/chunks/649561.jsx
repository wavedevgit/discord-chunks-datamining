...
class T extends Chunk73800.PureComponent {
  ...
  render() {
    ...
    return null == Chunk73800 ? null : <Chunk692546.Z contentDomRef={this.contentDomRef} observe={false}><Chunk481060.f6W theme={Chunk981631.BRd.DARK}>{r => (0, i.jsxs)(h.P3F, {
...
class k extends Chunk73800.PureComponent {
  ...
  render() {
    ...
    return null != require ? <T error={require} info={Chunk73800} /> : <div className={exports}>{module}</div>
  }
  constructor(...e) {
    super(...e), P(this, "state", {
      error: null,
