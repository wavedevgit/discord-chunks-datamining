...
function S(e) {
  ...
  }, [n, t]), D) ? x || null == b || null == L ? <div className={i()(R.sidebarContainer, R.loadingContainer, S)} style={v}><o.$jN animated={true} type={x ? o.$jN.Type.SPINNING_CIRCLE : o.$jN.Type.CHASING_DOTS} /></div> : <A.Gt value={j}><div className={i()(R.sidebarContainer, S)} style={v}><g.Z user={b} displayProfile={y} themeType={null} themeOverride={w} forceShowPremium={true} className={R.profileThemedContainer}><div className={R.innerContainer}>{<p.ZP userId={t} guildId={n} onClose={s} />}{<O.Z userId={t} guildId={n} onClose={s} className={C} />}</div></g.Z></div></A.Gt> : null
}