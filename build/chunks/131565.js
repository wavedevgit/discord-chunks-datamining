...
function _(e) {
  ...
  }), _ = u.qM.useExperiment({
    location: "channel_chat_wallpaper"
  }).enabled, [y, C] = i.useState(p);
  return (i.useEffect(() => {
  ...
  }, [n, p]), t.isViewable) ? (0, r.jsxs)(r.Fragment, {
...
function y(e) {
  ...
  return null == n || !n.isViewable || !t.isDM() && !t.isMultiUserDM() && !t.isGroupDM() || p.t(t) && !n.isPreview ? null : (0, r.jsx)(_, {
