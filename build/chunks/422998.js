    ...
    return n.filter(function(t) {
      ...
      n.filter(function(e) {
        for (var n, a = Object.keys(e), s = 0; s < a.length; s += 1) {
          var o = a[s],
            l = o.toLowerCase();
          false === t.indexOf(l) || "rel" === n && "canonical" === e[n].toLowerCase() || "rel" === l && "stylesheet" === e[l].toLowerCase() || (n = l), false === t.indexOf(o) || "innerHTML" !== o && "cssText" !== o && "itemprop" !== o || (n = o)
        }
