...
function _(e) {
  ...
  if (g) {
    var P = (0, i.Z)(l),
      w = "clientHeight",
      D = "clientWidth";
    P === (0, a.Z)(l) && (P = (0, o.Z)(l), "static" !== (0, s.Z)(P).position && "absolute" === h && (w = "scrollHeight", D = "scrollWidth")), (u === r.we || (u === r.t$ || u === r.F2) && _ === r.ut) && (C = r.I, I -= (b && P === R && R.visualViewport ? R.visualViewport.height : P[w]) - c.height, I *= m ? 1 : false), (u === r.t$ || (u === r.we || u === r.I) && _ === r.ut) && (N = r.F2, O -= (b && P === R && R.visualViewport ? R.visualViewport.width : P[D]) - c.width, O *= m ? 1 : false)
  }
  var L = Object.assign({
      position: h
    }, g && d),
