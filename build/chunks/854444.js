...
function v() {
  ...
  let h = null,
    ...
    b = i()(e).values().filter(e => e.type === o.Dd.CATEGORY).sortBy(e => e.order).map(e => {
      var t;
      let {
        id: n,
        order: l
      } = e, r = s.Z.getCategoryRecord(n), i = null != (t = c[n]) ? t : [], o = T.ZP.isChannelMuted(A._, n), a = C.Z.isCollapsed(n), u = null;
      return {
        isMuted: o,
        isCollapsed: a,
        record: r,
