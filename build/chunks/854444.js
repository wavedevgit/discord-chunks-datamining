...
function I() {
  ...
  let b = null,
    ...
    N = s()(e).values().filter(e => e.type === a.Dd.CATEGORY).sortBy(e => e.order).map(e => {
      var t;
      let {
        id: n,
        order: i
      } = e, r = o.Z.getCategoryRecord(n), s = null != (t = d[n]) ? t : [], a = O.ZP.isChannelMuted(v._, n), l = g.Z.isCollapsed(n), c = null;
      return {
        isMuted: a,
        isCollapsed: l,
        record: r,
