...
function I() {
  ...
  let b = null,
    ...
    N = s()(e).values().filter(e => e.type === l.Dd.CATEGORY).sortBy(e => e.order).map(e => {
      var t;
      let {
        id: n,
        order: i
      } = e, r = o.Z.getCategoryRecord(n), s = null != (t = d[n]) ? t : [], l = C.ZP.isChannelMuted(S._, n), a = p.Z.isCollapsed(n), c = null;
      return {
        isMuted: l,
        isCollapsed: a,
        record: r,
