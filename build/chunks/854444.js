...
function I() {
  ...
  let b = null,
    ...
    T = s()(e).values().filter(e => e.type === a.Dd.CATEGORY).sortBy(e => e.order).map(e => {
      var t;
      let {
        id: n,
        order: r
      } = e, i = o.Z.getCategoryRecord(n), s = null != (t = d[n]) ? t : [], a = E.ZP.isChannelMuted(O._, n), l = p.Z.isCollapsed(n), c = null;
      return {
        isMuted: a,
        isCollapsed: l,
        record: i,
