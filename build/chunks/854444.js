...
function v() {
  ...
  let _ = null,
    ...
    P = i()(e).values().filter(e => e.type === o.Dd.CATEGORY).sortBy(e => e.order).map(e => {
      var t;
      let {
        id: n,
        order: l
      } = e, r = s.Z.getCategoryRecord(n), i = null != (t = u[n]) ? t : [], o = T.ZP.isChannelMuted(m._, n), a = C.Z.isCollapsed(n), c = null;
      return {
        isMuted: o,
        isCollapsed: a,
        record: r,
