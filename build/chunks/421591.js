...
function S(e) {
  let {
    ...
    type: u.gc.HOME
  }]), [s, l] = i.useState({}), c = o[o.length - 1], [d, f] = i.useState(!1), _ = i.useCallback(e => {
    a(t => [...t, e])
  }, []), p = i.useCallback(() => {
    let e = null;
    a(t => t.length <= 1 ? t : (e = t[t.length - 1], t.slice(0, -1))), l(t => null == e ? t : y(E({}, t), {
      [e.type]: e
    }))
  }, []), h = i.useCallback(e => {
    var t;
...
function N(e) {
  let [t, n] = i.useState(null), [r, o] = i.useState(!1), a = i.useRef(0);
  return i.useEffect(() => {
