...
! function(t) {
  ...
  m.absoluteValue = m.abs = function() {
    ...
    return l = l < 0 && 1 & e.d[Math.max(t, r)] ? false : 1, d.s = 1, a = false, s = e.times(T(d, i + h)), a = true, (s = O(s)).s = l, s
  ...
  var y = function() {
    ...
    return function(r, i, a, s) {
      var l, c, u, d, p, h, m, g, E, b, y, O, I, S, T, A, N, R, P = r.constructor,
        w = r.s == i.s ? 1 : false,
        D = r.d,
        x = i.d;
      if (!r.s) return new P(r);
      if (!i.s) throw Error(o + "Division by zero");
      for (u = 0, c = r.e - i.e, N = x.length, T = D.length, g = (m = new P(w)).d = []; x[u] == (D[u] || 0);) ++u;
      if (x[u] > (D[u] || 0) && --c, (O = null == a ? a = P.precision : s ? a + (v(r) - v(i)) + 1 : a) < 0) return new P(0);
      if (O = O / _ + 2 | 0, u = 0, 1 == N)
        for (d = 0, x = x[0], O++;
          (u < T || d) && O--; u++) I = d * f + (D[u] || 0), g[u] = I / x | 0, d = I % x | 0;
      else {
        for ((d = f / (x[0] + 1) | 0) > 1 && (x = e(x, d), D = e(D, d), N = x.length, T = D.length), S = N, b = (E = D.slice(0, N)).length; b < N;) E[b++] = 0;
        (R = x.slice()).unshift(0), A = x[0], x[1] >= f / 2 && ++A;
        do d = 0, (l = t(x, E, N, b)) < 0 ? (y = E[0], N != b && (y = y * f + (E[1] || 0)), (d = y / A | 0) > 1 ? (d >= f && (d = f - 1), h = (p = e(x, d)).length, b = E.length, 1 == (l = t(p, E, h, b)) && (d--, n(p, N < h ? R : x, h))) : (0 == d && (l = d = 1), p = x.slice()), (h = p.length) < b && p.unshift(0), n(E, p, b), false == l && (b = E.length, (l = t(x, E, N, b)) < 1 && (d++, n(E, N < b ? R : x, b))), b = E.length) : 0 === l && (d++, E = [0]), g[u++] = d, l && E[0] ? E[b++] = D[S] || 0 : (E = [D[S]], b = 1); while ((S++ < T || true !== E[0]) && O--)
      }
  ...
  function T(e, t) {
    ...
    if (E.precision = f += h, i = (r = b(g)).charAt(0), !(15e14 > Math.abs(l = v(m)))) return d = I(E, f + 2, O).times(l + ""), m = T(new E(i + "." + r.slice(1)), f - h).plus(d), E.precision = O, null == t ? (a = true, C(m, O)) : m;
