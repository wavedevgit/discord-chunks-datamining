/** Chunk was on web.js **/ ! function(t) {
  ...
  var y = function() {
    ...
    return function(r, i, o, s) {
      var l, c, u, d, p, h, m, g, E, b, y, O, I, S, T, A, C, R, P = r.constructor,
        w = r.s == i.s ? 1 : -1,
        D = r.d,
        L = i.d;
      ...
      if (O = O / _ + 2 | 0, u = 0, 1 == C)
        ...
        do d = 0, (l = t(L, E, C, b)) < 0 ? (y = E[0], C != b && (y = y * f + (E[1] || 0)), (d = y / A | 0) > 1 ? (d >= f && (d = f - 1), h = (p = e(L, d)).length, b = E.length, 1 == (l = t(p, E, h, b)) && (d--, n(p, C < h ? R : L, h))) : (0 == d && (l = d = 1), p = L.slice()), (h = p.length) < b && p.unshift(0), n(E, p, b), -1 == l && (b = E.length, (l = t(L, E, C, b)) < 1 && (d++, n(E, C < b ? R : L, b))), b = E.length) : 0 === l && (d++, E = [0]), g[u++] = d, l && E[0] ? E[b++] = D[S] || 0 : (E = [D[S]], b = 1); while ((S++ < T || void 0 !== E[0]) && O--)
      }
