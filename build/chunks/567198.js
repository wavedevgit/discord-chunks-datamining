/** Chunk was on web.js **/ ! function(t) {
  ...
  var b = function() {
    ...
    return function(r, i, o, s) {
      var l, c, u, d, p, h, m, g, E, v, b, y, S, I, T, N, C, R, P = r.constructor,
        w = r.s == i.s ? 1 : -1,
        D = r.d,
        L = i.d;
      ...
      if (y = y / _ + 2 | 0, u = 0, 1 == C)
        ...
        do d = 0, (l = t(L, E, C, v)) < 0 ? (b = E[0], C != v && (b = b * f + (E[1] || 0)), (d = b / N | 0) > 1 ? (d >= f && (d = f - 1), h = (p = e(L, d)).length, v = E.length, 1 == (l = t(p, E, h, v)) && (d--, n(p, C < h ? R : L, h))) : (0 == d && (l = d = 1), p = L.slice()), (h = p.length) < v && p.unshift(0), n(E, p, v), -1 == l && (v = E.length, (l = t(L, E, C, v)) < 1 && (d++, n(E, C < v ? R : L, v))), v = E.length) : 0 === l && (d++, E = [0]), g[u++] = d, l && E[0] ? E[v++] = D[I] || 0 : (E = [D[I]], v = 1); while ((I++ < T || void 0 !== E[0]) && y--)
      }
