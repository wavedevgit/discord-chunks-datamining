...
let e6 = [Chunk981631.hBH.GIFV],
  ...
  te = e => () => {
    let {
      ...
      height: a,
      flags: o
    } = e, s = (0, eO.yE)(o, W.hR.IS_ANIMATED);
...
class tn extends(r = Chunk647438.Component) {
  ...
  renderCodedLinks(e) {
    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
      ...
      if (n === T.g.INVITE) return this.shouldRenderInvite(r) ? (0, i.jsx)(ej.Z, {
        code: r,
        message: e,
  ...
  renderSafetyPolicyNotice(e) {
    return 1 === e.embeds.length && e.embeds[0].type === eq.hBH.SAFETY_POLICY_NOTICE ? (0, i.jsx)(er.i, {
      message: e
    }) : null
  }
  renderSafetySystemNotification(e) {
    return 1 === e.embeds.length && e.embeds[0].type === eq.hBH.SAFETY_SYSTEM_NOTIFICATION ? (0, i.jsx)(ei.g, {
      embed: e.embeds[0]
    }) : null
  }
  ...
  render() {
    ...
    return null == Chunk442837 && null == Chunk902704 && null == Chunk637374 && null == Chunk626799 && null == Chunk624367 && null == Chunk377108 && null == Chunk183431 && null == Chunk421474 && null == Chunk603270 && null == Chunk234431 && null == Chunk162297 && null == Chunk446411 && null == Chunk222709 && null == Chunk960904 && null == Chunk161314 && null != Chunk36129 && null == Chunk262777 && null == Chunk761538 && null == Chunk674611 && null == Chunk294734 ? null : (0, Chunk951288.jsxs)("div", {
      ...
      children: [Chunk674611, Chunk761538, Chunk222709, Chunk262777, Chunk294734, Chunk442837, Chunk377108, Chunk960904, Chunk902704, Chunk481060, Chunk637374, Chunk629710, Chunk626799, Chunk603270, Chunk162297, Chunk446411, Chunk36129, Chunk904245, Chunk275726, Chunk624367, Chunk183431, Chunk421474, Chunk647438 && this.renderSuppressConfirmModal(), Chunk120356 && this.renderRemoveAttachmentConfirmModal(), Chunk234431, Chunk161314, Chunk247206]
    })
  }
  constructor(...e) {
...
function tr(e) {
  ...
  }), [p, n]), y = (0, M.ux)(n.guild_id), [, O] = (0, j.AB)(n.guild_id), v = (0, el.$R)(n), I = (s === r.author.id || b) && r.author.id !== eq.LAt && false !== a && !(0, eO.yE)(r.flags, eq.iLy.EPHEMERAL) && v && 1 === (0, eR.Z)(r), S = s === r.author.id && v && !o, T = r.author.id === s, A = r.isFirstMessageInForumPost(n), N = (0, ew.Z)({
    channel: n,
    canChat: p,
    renderReactions: f,
    canAddNewReactions: E,
...
let ti = e => {
  var t, {
    ...
    u = e4(e, ["message", "channel", "disableReactionReads", "renderThreadAccessory", "disableReactionCreates", "disableReactionUpdates", "disableComponentInteractivity"]);
  let d = eu.x4.useSetting(),
    f = eu.RS.useSetting(),
    _ = eu.NA.useSetting(),
    p = eu.QK.useSetting(),
    h = (0, H.A)((null != (t = n.editedTimestamp) ? t : n.timestamp).valueOf()),
    m = (0, z.Z)(null == r ? true : r.id),
    g = (0, R.v)(n),
