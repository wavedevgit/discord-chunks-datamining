...
var r, Chunk54381 = require("./54381.js"),
  ...
  Chunk614118 = require("./614118.jsx"),
...
let e3 = [Chunk981631.hBH.GIFV],
  ...
  e5 = e => () => {
    let {
      ...
      height: a,
      flags: o
    } = e, s = (0, c.yE)(o, K.hR.IS_ANIMATED);
    return null != r && null != a && (z.uo.test(n) || s && (z.YG.test(n) || z.FH.test(n))) ? (0, i.jsx)(ex.Z, {
      width: r,
      height: a,
      src: n,
      url: t,
...
class e6 extends(r = Chunk473749.Component) {
  ...
  shouldComponentUpdate(e, t) {
    ...
    return !(0, f.Z)(this.state, t) || !(0, f.Z)(this.props, e, ["message", "channel"]) || n.type !== a.type || s !== i || o.codedLinks !== r.codedLinks || o.flags !== r.flags || o.giftCodes !== r.giftCodes || o.attachments !== r.attachments || o.embeds !== r.embeds || o.components !== r.components || o.activity !== r.activity || !e8(o.reactions, r.reactions)
  }
  renderCtaButton() {
    let {
      message: e,
  ...
  renderCodedLinks(e) {
    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
      ...
      if (n === C.g.INVITE) return this.shouldRenderInvite(r) ? (0, i.jsx)(eL.Z, {
        code: r,
        message: e,
      ...
      } else if (n === C.g.QUESTS_EMBED) return (0, i.jsx)(ee.Z, {
        questId: r
      }, r);
  ...
  renderEmbeds(e) {
    ...
    return 0 === e.embeds.length || !t || n ? null : e.embeds.map((t, n) => {
      if (eW.b.has(t.type) || (0, ey.l3)(t) || (0, F.b)(t) && !(0, B.M)(e) || (0, ey.jz)(t) || (0, ey.HK)(t)) return null;
      let r = {
  ...
  renderPublishBump(e) {
    return this.props.channel.type !== eK.d4z.GUILD_ANNOUNCEMENT || this.props.isMessageSnapshot ? null : (0, i.jsx)(S.Z, {
      channelId: e.channel_id,
      messageId: e.id
    })
  }
  renderEphemeralAccessories(e) {
    return (0, eT.Pv)(e) ? (0, i.jsx)(eD.Z, {
      message: e,
      onDeleteMessage: () => {
  ...
  renderStickersAccessories(e) {
    ...
    return 0 === t.length ? null : t.map(e => (0, i.jsx)(es.Z, {
      channel: n,
      isInteracting: r,
      renderableSticker: e
    }, e.id))
  ...
  renderThreadAccessories(e) {
    if (e.hasFlag(eK.iLy.HAS_THREAD) && false !== this.props.renderThreadAccessory) return (0, i.jsx)(ec.Z, {
      message: e,
      compact: this.props.compact
    })
  }
  renderThreadRoleMentionWarning(e) {
    if (e.hasFlag(eK.iLy.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) && this.props.isCurrentUser && !(Date.now() - eO.default.extractTimestamp(e.id) >= e2)) return (0, i.jsx)("div", {
  ...
  renderInteractionPremiumUpsell(e) {
    ...
    return e.type !== l.u.INTERACTION_PREMIUM_UPSELL || null == t ? null : (0, i.jsx)(eZ.Z, {
      applicationId: t,
  ...
  renderEmbeddedApplicationInstanceEmbed(e) {
    ...
    return null == t || null == n ? null : (0, i.jsx)(eR.Z, {
      application: t,
  ...
  renderMediaPostEmbeds(e) {
    return e.embeds.flatMap(t => t.type !== eK.hBH.POST_PREVIEW || null == t.url ? [] : (0, i.jsx)(Q.Z, {
      embedUrl: t.url,
      message: e,
  ...
  renderSafetyPolicyNotice(e) {
    return 1 === e.embeds.length && e.embeds[0].type === eK.hBH.SAFETY_POLICY_NOTICE ? (0, i.jsx)(er.i, {
      message: e
    }) : null
  }
  renderSafetySystemNotification(e) {
    return 1 === e.embeds.length && e.embeds[0].type === eK.hBH.SAFETY_SYSTEM_NOTIFICATION ? (0, i.jsx)(ei.g, {
      embed: e.embeds[0]
    }) : null
  }
  renderMediaObscureNotice(e) {
    return (0 !== e.attachments.length || 0 !== e.embeds.length) && (0, P.kC)(e) ? (0, i.jsx)(R.Z, {
      message: e
    }) : null
  }
  renderPoll(e, t) {
  ...
  renderForwardedMessage(e) {
    if (e.messageSnapshots.length > 0 && !(0, et.Gi)(e, this.props.channel)) return (0, i.jsx)(x.Z, {
      message: e
    })
  }
  renderEditedTag(e, t) {
  ...
  render() {
    ...
    return null == c && null == d && null == p && null == _ && null == h && null == u && null == m && null == g && null == E && null == b && null == y && null == v && null == O && null == I && null == T && null != S && null == N && null == P && null == w && null == R ? null : (0, i.jsxs)("div", {
      id: (0, eM.bX)(t),
      className: s()(e, eq.container),
      children: [w, P, O, N, R, c, u, I, d, f, p, A, _, E, y, v, S, l, h, m, g, a && this.renderSuppressConfirmModal(), o && this.renderRemoveAttachmentConfirmModal(), b, T, C]
    })
  }
  constructor(...e) {
    super(...e), eQ(this, "state", {
      ...
      let {
        ...
        shouldAgeVerify: _
      } = this.props, h = (0, eI.BP)(e, r, f, p);
      if (e.type === eK.hBH.GIFT) return null;
      let m = e3.includes(e.type) ? e.url : null != (l = null == (a = e.image) ? true : a.url) ? l : null == (o = e.video) ? true : o.url;
      return (0, i.jsx)(L.h.Provider, {
        value: (0, eY.P)(m, e.image, e.video, e.thumbnail, null == (s = e.provider) ? true : s.name),
        children: (0, i.jsx)(I.ZP, eX({
          embed: e,
    ...
    }), eQ(this, "renderEmbedTitle", (e, t) => e.type !== eK.hBH.RICH ? t : (null != e.url && "" !== e.url ? W.Z.parseEmbedTitleWithoutLinks : W.Z.parseEmbedTitle)(t, true, {
      channelId: this.props.channel.id
    })), eQ(this, "renderEmbedDescription", (e, t, n) => e.type === eK.hBH.RICH ? W.Z.parse(t, true, {
      channelId: this.props.channel.id,
      allowLinks: true,
...
function e7(e) {
  ...
  let {
    ...
    isMessageSnapshot: o
  } = e, s = (0, u.e7)([ef.default], () => ef.default.getId()), l = eu.x4.useSetting(), d = eu.RS.useSetting(), f = eu.NA.useSetting() && !(0, eN.Z)(e.message), p = eu.nc.useSetting() && false !== e.renderReactions, _ = eu.QK.useSetting(), h = (0, u.e7)([e_.Z], () => null == n.guild_id || e_.Z.canChatInGuild(n.guild_id), [n]), m = (0, u.e7)([H.Z], () => null != n.guild_id && H.Z.isLurking(n.guild_id), [n]), g = (0, u.e7)([ep.ZP], () => ep.ZP.isCurrentUserGuest(n.guild_id), [n]), E = (0, u.e7)([ep.ZP, em.default], () => {
    var e, t;
    ...
    canAddNewReactions: h && eh.Z.can(eK.Plq.ADD_REACTIONS, n),
    canManageMessages: eh.Z.can(eK.Plq.MANAGE_MESSAGES, n)
  }), [h, n]), O = (0, M.ux)(n.guild_id), [, v] = (0, k.AB)(n.guild_id), S = (0, el.$R)(n), I = (s === r.author.id || y) && r.author.id !== eK.LAt && false !== a && !(0, c.yE)(r.flags, eK.iLy.EPHEMERAL) && S && (0, eA.Z)(r) >= 1, T = s === r.author.id && S && !o, C = r.author.id === s, A = r.isFirstMessageInForumPost(n), P = (0, eP.Z)({
    channel: n,
    canChat: h,
    renderReactions: p,
    canAddNewReactions: b,
  ...
  }), R = (0, Y.A)((null != (t = r.editedTimestamp) ? t : r.timestamp).valueOf()), D = (0, q.Z)(null == n ? true : n.id), x = (0, J.Z)(r), L = (0, w.v)(r), j = (0, eC._)(n), U = (0, eS.ro)(r.id, r.channel_id), G = (0, N.m8)();
  return (0, i.jsx)(e6, e$(eX(e$(eX({
    canSuppressEmbeds: I,
...
let e9 = e => {
  var t, {
    ...
    u = e0(e, ["message", "channel", "disableReactionReads", "renderThreadAccessory", "disableReactionCreates", "disableReactionUpdates", "disableComponentInteractivity"]);
