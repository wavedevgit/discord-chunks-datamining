...
let e7 = [Chunk981631.hBH.GIFV],
  ...
  tt = e => () => {
    ...
    return null != r && null != o && (K.uo.test(n) || s && (K.YG.test(n) || K.FH.test(n))) ? (0, i.jsx)(ek.Z, {
      width: r,
      height: o,
      src: n,
      url: t,
...
function ti(e) {
  ...
  }), [p, n]), y = (0, j.ux)(n.guild_id), [, O] = (0, k.AB)(n.guild_id), v = (0, ec.$R)(n), I = (s === r.author.id || b) && r.author.id !== eX.LAt && false !== o && !(0, ev.yE)(r.flags, eX.iLy.EPHEMERAL) && v && 1 === (0, eP.Z)(r), T = s === r.author.id && v && !a, S = r.author.id === s, A = r.isFirstMessageInForumPost(n), N = (0, eD.Z)({
    channel: n,
    canChat: p,
    renderReactions: f,
    canAddNewReactions: E,
