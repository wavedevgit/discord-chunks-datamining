...
let e5 = [Chunk981631.hBH.GIFV],
  e7 = 15 * Chunk70956.Z.Millis.MINUTE,
  ...
  te = e => () => {
    let {
      ...
      height: a,
      flags: o
    } = e, s = (0, eO.yE)(o, Y.hR.IS_ANIMATED);
    return null != r && null != a && (W.uo.test(n) || s && (W.YG.test(n) || W.FH.test(n))) ? (0, i.jsx)(ej.Z, {
      width: r,
      height: a,
      src: n,
      url: t,
...
class tn extends(r = Chunk647438.Component) {
  ...
  shouldComponentUpdate(e, t) {
    ...
    return !(0, d.Z)(this.state, t) || !(0, d.Z)(this.props, e, ["message", "channel"]) || n.type !== a.type || s !== i || o.codedLinks !== r.codedLinks || o.flags !== r.flags || o.giftCodes !== r.giftCodes || o.attachments !== r.attachments || o.embeds !== r.embeds || o.components !== r.components || o.activity !== r.activity || !tt(o.reactions, r.reactions)
  }
  renderCtaButton() {
    let {
      message: e,
  ...
  renderCodedLinks(e) {
    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
      ...
      if (n === T.g.CHANNEL_LINK) return (0, i.jsx)(eD.Z, {
        code: r,
        message: e
      }, r);
      ...
      } else if (n === T.g.GUILD_PRODUCT) return (0, i.jsx)(M.Z, {
        code: r
      }, r);
      else if (n === T.g.SERVER_SHOP) return (0, i.jsx)(S.Z, {
        guildId: r
      }, r);
      else if (n === T.g.QUESTS_EMBED) return (0, i.jsx)(et.Z, {
        questId: r
      }, r);
  ...
  renderReferralTrial(e) {
    ...
    } = this.props, a = $.ZP.getCurrentConfig({
      location: "isSystemMessage"
    }).cohort !== $.FZ.Control;
    return n !== l.u.PREMIUM_REFERRAL || null == t || a ? null : (0, i.jsx)("div", {
  ...
  renderPublishBump(e) {
    return this.props.channel.type !== eq.d4z.GUILD_ANNOUNCEMENT || this.props.isMessageSnapshot ? null : (0, i.jsx)(v.Z, {
  ...
  renderThreadAccessories(e) {
    if (e.hasFlag(eq.iLy.HAS_THREAD) && false !== this.props.renderThreadAccessory) return (0, i.jsx)(ec.Z, {
      message: e,
  ...
  renderMediaPostEmbeds(e) {
    return e.embeds.flatMap(t => t.type !== eq.hBH.POST_PREVIEW || null == t.url ? [] : (0, i.jsx)(z.Z, {
      embedUrl: t.url,
      message: e,
  ...
  renderSafetyPolicyNotice(e) {
    return 1 === e.embeds.length && e.embeds[0].type === eq.hBH.SAFETY_POLICY_NOTICE ? (0, i.jsx)(ei.i, {
      message: e
    }) : null
  }
  renderSafetySystemNotification(e) {
    return 1 === e.embeds.length && e.embeds[0].type === eq.hBH.SAFETY_SYSTEM_NOTIFICATION ? (0, i.jsx)(ea.g, {
      embed: e.embeds[0]
    }) : null
  }
  renderMediaObscureNotice(e) {
    return (0 !== e.attachments.length || 0 !== e.embeds.length) && (0, C.kC)(e) ? (0, i.jsx)(R.Z, {
      message: e
    }) : null
  }
  renderPoll(e, t) {
  ...
  renderForwardedMessage(e) {
    if (e.messageSnapshots.length > 0 && !(0, en.Gi)(e, this.props.channel)) return (0, i.jsx)(w.Z, {
      message: e
    })
  }
  renderEditedTag(e, t) {
  ...
  constructor(...e) {
    ...
    }), e0(this, "renderEmbedTitle", (e, t) => e.type === eq.hBH.RICH ? H.Z.parseEmbedTitle(t, true, {
      channelId: this.props.channel.id
    }) : t), e0(this, "renderEmbedDescription", (e, t, n) => e.type === eq.hBH.RICH ? H.Z.parse(t, true, {
      channelId: this.props.channel.id,
      allowLinks: true,
...
function tr(e) {
  ...
  let {
    ...
    isMessageSnapshot: o
  } = e, s = (0, c.e7)([ef.default], () => ef.default.getId()), l = eu.x4.useSetting(), u = eu.RS.useSetting(), d = eu.NA.useSetting() && !(0, eP.Z)(e.message), f = eu.nc.useSetting() && false !== e.renderReactions, _ = eu.QK.useSetting(), p = (0, c.e7)([ep.Z], () => null == n.guild_id || ep.Z.canChatInGuild(n.guild_id), [n]), h = (0, c.e7)([V.Z], () => null != n.guild_id && V.Z.isLurking(n.guild_id), [n]), m = (0, c.e7)([e_.ZP], () => e_.ZP.isCurrentUserGuest(n.guild_id), [n]), g = (0, c.e7)([e_.ZP, em.default], () => {
    var e, t;
    let r = em.default.getCurrentUser();
    return null != (t = null != n.guild_id && null != r ? null == (e = e_.ZP.getMember(n.guild_id, r.id)) ? true : e.isPending : null) && t
  }), {
  ...
  }), [p, n]), y = (0, L.ux)(n.guild_id), [, O] = (0, j.AB)(n.guild_id), v = (0, el.$R)(n), I = (s === r.author.id || b) && r.author.id !== eq.LAt && false !== a && !(0, eO.yE)(r.flags, eq.iLy.EPHEMERAL) && v && 1 === (0, eR.Z)(r), T = s === r.author.id && v && !o, S = r.author.id === s, C = r.isFirstMessageInForumPost(n), R = (0, ew.Z)({
    channel: n,
    canChat: p,
    renderReactions: f,
    canAddNewReactions: E,
  ...
  }), P = (0, F.A)((null != (t = r.editedTimestamp) ? t : r.timestamp).valueOf()), w = (0, K.Z)(null == n ? true : n.id), D = (0, X.Z)(r), x = (0, N.v)(r), M = (0, eN._)(n), k = (0, eT.ro)(r.id, r.channel_id), U = (0, A.m8)();
...
let ti = e => {
  var t, {
    ...
    d = e4(e, ["message", "channel", "disableReactionReads", "renderThreadAccessory", "disableReactionCreates", "disableReactionUpdates", "disableComponentInteractivity", "isSearchResult"]);
