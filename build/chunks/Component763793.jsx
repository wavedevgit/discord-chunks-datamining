...
let k = 16 / 9,
  ...
  V = e => {
    ...
    return (0, r.jsx)(P.A, {
      participant: n,
      aspectRatio: k,
      fit: n.type === D.lp.USER ? _.$.COVER : true,
      blocked: b,
      ignored: j,
      channel: i,
      className: L.V,
  ...
  B = Chunk64700.memo(function(e) {
    ...
    let {
      user: _
    } = l, v = (0, o.bG)([m.A], () => m.A.getParticipant(i.id, l.id), [i.id, l.id]), E = (0, o.bG)([T.Ay], () => T.Ay.isModerator(_.id, i.id), [i.id, _.id]);
    ...
    let S = e => {
      ...
      I = (e, t, l, s) => {
        switch (e.type) {
          ...
          case D.lp.USER:
          default:
            if (S(D.qs.USER), l) return (0, x.r)(t, _, i, {
              context: A
            }, (e, t) => (0, b.Y)({
              menuName: e,
              menuItemProps: t,
