...
let L = e => {
    ...
    let {
      ...
      onClose: i,
      trackOptionClick: o
    } = e, d = (0, s.e7)([N.Z], () => N.Z.getChannel(n.channel_id)), m = (0, s.e7)([C.Z], () => null != d && C.Z.can(I.Pl.VIEW_CHANNEL, d)), j = (0, s.e7)([u.ZP], () => null != n.emoji_id ? u.ZP.getCustomEmojiById(n.emoji_id) : null, [n.emoji_id]), x = null != n.emoji_name ? h.ZP.getByName(h.ZP.convertSurrogateToName(n.emoji_name, !1)) : null, _ = null != (l = (0, r.KS)(d)) ? l : t.VL1;
  ...
  T = e => {
    ...
    i.useEffect(() => {
      ...
      !0 !== u && E.default.track(v.rMx.OPEN_MODAL, {
        type: f._,
        guild_id: r
      })
    }, [r, u]);
    ...
    return null == h ? null : null == p ? (0, a.jsx)(t.Y0X, {
      ...
      children: [(0, a.jsx)(t.olH, {
        ...
        className: P.options,
        children: null == (l = p.welcome_channels) ? void 0 : l.map((e, l) => (0, a.jsx)(L, {
          channelData: e,
