...
let P = e => {
    ...
    let {
      ...
      onClose: i,
      trackOptionClick: r
    } = e, d = (0, s.e7)([p.Z], () => p.Z.getChannel(n.channel_id)), h = (0, s.e7)([_.Z], () => null != d && _.Z.can(v.Pl.VIEW_CHANNEL, d)), j = (0, s.e7)([m.ZP], () => null != n.emoji_id ? m.ZP.getCustomEmojiById(n.emoji_id) : null, [n.emoji_id]), N = null != n.emoji_name ? u.ZP.getByName(u.ZP.convertSurrogateToName(n.emoji_name, !1)) : null, g = null != (l = (0, c.KS)(d)) ? l : o.VL1;
    return null != d && h ? (0, a.jsxs)(o.P3F, {
      className: S.optionContainer,
      onClick: () => {
        r(), i(), (0, x.XU)(d.guild_id, d.id)
      },
      children: [null != j || null != N ? (0, a.jsx)(t.Z, {
  ...
  L = e => {
    ...
    let v = i.useCallback(e => {
      ...
      let n = [],
        a = [],
        i = !1;
      null == (l = x.welcome_channels) || l.forEach(e => {
    ...
    return null == u ? null : null == x ? (0, a.jsx)(o.Y0X, {
      transitionState: t,
      className: S.main,
      ...
      children: [(0, a.jsx)(o.olH, {
      ...
      }), null != x.description ? (0, a.jsx)(o.Text, {
        ...
        className: S.options,
        children: null == (l = x.welcome_channels) ? void 0 : l.map((e, l) => (0, a.jsx)(P, {
          channelData: e,
