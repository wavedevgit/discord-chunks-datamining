...
let P = e => {
    ...
    let {
      ...
      onClose: n,
      trackOptionClick: r
    } = e, d = (0, s.e7)([N.Z], () => N.Z.getChannel(i.channel_id)), h = (0, s.e7)([_.Z], () => null != d && _.Z.can(v.Pl.VIEW_CHANNEL, d)), j = (0, s.e7)([m.ZP], () => null != i.emoji_id ? m.ZP.getCustomEmojiById(i.emoji_id) : null, [i.emoji_id]), p = null != i.emoji_name ? u.ZP.getByName(u.ZP.convertSurrogateToName(i.emoji_name, !1)) : null, g = null != (l = (0, c.KS)(d)) ? l : o.VL1;
    return null != d && h ? (0, a.jsxs)(o.P3F, {
      className: S.optionContainer,
      onClick: () => {
        r(), n(), (0, x.XU)(d.guild_id, d.id)
      },
      children: [null != j || null != p ? (0, a.jsx)(t.Z, {
