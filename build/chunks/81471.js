...
let I = i.memo(function(e) {
  let {
    ...
    content: j
  } = i.useMemo(() => (null == I ? void 0 : I.content) != null && "" !== I.content ? (0, p.ZP)(I, {
    formatInline: !0,
  ...
  if (l) A = (0, r.jsx)(s.Text, {
    ...
    if (null != I && C) A = (0, r.jsx)(s.Text, {
      className: N.messageReplacement,
      variant: "text-sm/normal",
      color: "text-muted",
      children: O.NW.string(O.t["WPe+xM"])
    });
    else if (null != I && S) A = (0, r.jsx)(s.Text, {
    className: N.messageReplacement,
    variant: "text-sm/normal",
    color: "text-muted",
    ...
    let {
      ...
      renderedContent: t
    } = (0, h.f)(I, j, C, S, a()(N.messageContent, y.inlineFormat), {
