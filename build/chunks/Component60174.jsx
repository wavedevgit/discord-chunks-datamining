...
class C extends Chunk647438.Component {
  render() {
    ...
    let l = Chunk647438 ? Chunk639543 : Chunk487111,
      c = {
        size: "sm",
        color: "currentColor",
        className: l.icon
      };
    return module.type === Chunk981631.uaV.EMOJI_ADDED && 0 === module.reactions.length ? (0, Chunk951288.jsx)(Chunk387188.e, {
      message: module,
