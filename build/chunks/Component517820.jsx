...
function H(e) {
  ...
  let {
    message: n,
    compact: a
  } = e, o = C.default.getUser((0, b.Sw)(n)), s = null == (t = T.Z.getBasicChannel(n.channel_id)) ? true : t.guild_id, c = null != s && null != o ? A.ZP.getMember(s, o.id) : null, {
    avatarSrc: u,
...
function Y(e) {
  ...
  let {
    ...
    raidType: h,
    resolvedReason: m
  } = (0, b.FL)(n), O = (0, f.e7)([T.Z], () => T.Z.getChannel(n.channel_id), [n.channel_id]), v = null != (t = null == O ? true : O.guild_id) ? t : null, {
    shouldShowIncidentActions: I
  } = (0, g.mI)(v), S = (0, R.sR)(n.author.id, n.channel_id), A = e => {
    S(e)
  }, C = i.useCallback(() => {
