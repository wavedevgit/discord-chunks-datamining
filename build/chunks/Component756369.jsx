...
let e$ = [Chunk652215.Auw.GIFV],
  e0 = 15 * Chunk927813.A.Millis.MINUTE,
...
class e7 extends(r = Chunk64700.Component) {
  ...
  renderThreadAccessories(e) {
    if (e.hasFlag(eY.pr7.HAS_THREAD) && false !== this.props.renderThreadAccessory) return (0, i.jsx)(ec.A, {
      message: e,
  ...
  constructor(...e) {
    super(...e), eQ(this, "state", {
      ...
      let _ = e$.includes(e.type) ? e.url : null != (l = null == (a = e.image) ? true : a.url) ? l : null == (s = e.video) ? true : s.url;
      return (0, i.jsx)(D.G.Provider, {
        value: (0, eW.b)(_, e.image, e.video, e.thumbnail, null == (o = e.provider) ? true : o.name),
    ...
    }), eQ(this, "renderEmbedTitle", (e, t) => e.type !== eY.Auw.RICH ? t : (null != e.url && "" !== e.url ? K.A.parseEmbedTitleWithoutLinks : K.A.parseEmbedTitle)(t, true, {
      channelId: this.props.channel.id
    })), eQ(this, "renderEmbedDescription", (e, t, n) => e.type === eY.Auw.RICH ? K.A.parse(t, true, {
      channelId: this.props.channel.id,
      allowLinks: true,
...
function e9(e) {
  ...
  let {
    ...
    isMessageSnapshot: a
  } = e, s = (0, u.bG)([ep.default], () => ep.default.getId()), o = eu.X6.useSetting(), d = eu.hD.useSetting(), p = eu.rs.useSetting() && !(0, eS.A)(e.message), m = eu.jW.useSetting() && false !== e.renderReactions, f = eu.kt.useSetting(), g = (0, u.bG)([ef.A], () => null == n.guild_id || ef.A.canChatInGuild(n.guild_id), [n]), _ = (0, u.bG)([z.A], () => null != n.guild_id && z.A.isLurking(n.guild_id), [n]), h = (0, u.bG)([em.Ay, e_.default], () => {
    var e, t;
  ...
  }), [g, n]), A = (0, M.ix)(n.guild_id), [, v] = (0, k.c)(n.guild_id), O = (0, eo.Id)(n), x = (s === r.author.id || y) && r.author.id !== eY.oIV && false !== l && !(0, c.Lt)(r.flags, eY.pr7.EPHEMERAL) && O && (0, eI.A)(r) >= 1, E = s === r.author.id && O && !a, j = r.author.id === s, C = r.isFirstMessageInForumPost(n), I = (0, eT.A)({
    channel: n,
    canChat: g,
    renderReactions: m,
    canAddNewReactions: b,
  ...
  }), T = (0, W.S)((null != (t = r.editedTimestamp) ? t : r.timestamp).valueOf()), P = (0, J.A)(null == n ? true : n.id), w = (0, Z.A)(r), R = (0, N.P)(r), D = (0, eC.z)(n), L = (0, ex._f)(r.id, r.channel_id), U = (0, S._R)();
