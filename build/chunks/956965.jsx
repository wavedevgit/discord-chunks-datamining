...
function b(e) {
  ...
  return "loading" === m.state ? null : j ? <r.Fragment>{b ? <x isHovered={n} url={f} animatedUrl={true} /> : <p.Z src={h} className={l()(g.bannerImage, g.bannerContent)} muted={true} />}{<v isHovered={n} url={h} isVideo={true} />}</r.Fragment> : b ? <x isHovered={n} url={f} animatedUrl={_} /> : <C iconURL={o} />
}
...
function x(e) {
  ...
  return <r.Fragment>{<img src={n} alt={""} className={l()(g.bannerImage, g.bannerContent, {
        [g.loaded]: s
      })} onLoad={() => o(true)} />}{null != i ? <v isHovered={t} url={i} isVideo={false} /> : null}</r.Fragment>
}
...
function v(e) {
  ...
  return (a.useEffect(() => {
    t && d(true)
  }, [t]), c) ? <div className={l()(g.bannerAnimatedContainer, {
      [g.videoFadeOut]: !t,
      [g.videoFadeIn]: t && s
    })} onAnimationEnd={() => t ? null : d(false)}>{i ? (0, r.jsx)(p.Z, {
      src: n,
      loop: true,
      autoPlay: true,
      muted: true,
...
function C(e) {
  ...
  return <div className={l()(g.bannerContent, g.bannerGradient, {
      [g.loaded]: a
    })} style={{
      backgroundImage: n
    }} />
...
let j = function(e) {
  ...
  return <div className={g.bannerContainer} style={{
      aspectRatio: "card" === n ? f : _
    }} onMouseEnter={p} onFocus={p} onMouseLeave={h} onBlur={h}>{"card" === n && v ? (0, r.jsx)(b, {
      application: t,
      isHovered: c,
