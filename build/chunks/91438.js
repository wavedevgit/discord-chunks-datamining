/** Chunk was on 85468 (89f0c1c6bf52959e.js) **/
var t;
t = function() {
  var e;
  return (function e(t, n, r) {
    ...
    99: [function(e, t, n) {
      ...
      t.exports = function(e, t) {
        var n, s, c, d, l;
        return e.data && !e.errors ? (s = e, c = t, d = {
          ...
          venmo: "off"
        }, l.supportedFeatures && (d.graphQL = {
          url: c._graphQL._config.url,
          features: l.supportedFeatures.map(function(e) {
            return e.toLowerCase()
          })
        }), l.braintreeApi && (d.braintreeApi = l.braintreeApi), l.applePayWeb && (d.applePayWeb = l.applePayWeb, d.applePayWeb.supportedNetworks = a(l.applePayWeb.supportedCardBrands, o.applePayWeb), delete d.applePayWeb.supportedCardBrands), l.fastlane && (d.fastlane = l.fastlane), l.ideal && (d.ideal = l.ideal), l.kount && (d.kount = {
          kountMerchantId: l.kount.merchantId
        }), l.creditCard ? (d.challenges = l.creditCard.challenges.map(function(e) {
          return e.toLowerCase()
        }), d.creditCards = {
    ...
    100: [function(e, t, n) {
      ...
      t.exports = function(e) {
        var t, n, s, c, d, l, u;
        return e.data && !e.errors ? (l = (d = (c = e.data.tokenizeCreditCardForPayPalConnect).paymentMethod.details).last4 ? d.last4.substr(2, 4) : "", (u = d.binData) && (["commercial", "debit", "durbinRegulated", "healthcare", "payroll", "prepaid"].forEach(function(e) {
        ...
        }, c.authenticationInsight && (s = c.authenticationInsight.customerAuthenticationRegulationEnvironment, n.creditCards[0].authenticationInsight = {
    ...
    101: [function(e, t, n) {
      ...
      t.exports = function(e) {
        var t, n, s, c, d, l, u;
        return e.data && !e.errors ? (l = (d = (c = e.data.tokenizeCreditCard).creditCard).last4 ? d.last4.substr(2, 4) : "", (u = d.binData) && (["commercial", "debit", "durbinRegulated", "healthcare", "payroll", "prepaid"].forEach(function(e) {
          u[e] ? u[e] = o[u[e]] : u[e] = "Unknown"
        }), ["issuingBank", "countryOfIssuance", "productId"].forEach(function(e) {
          u[e] || (u[e] = "Unknown")
        })), n = {
    ...
    102: [function(e, t, n) {
      ...
      t.exports = function(e) {
        ...
        return "VALIDATION" === a ? 0 === (i = (n = (t = e).errors, r = [], n.forEach(function(e) {
    ...
    104: [function(e, t, n) {
      ...
      t.exports = function(e) {
        ...
        return {
          ...
          }), o && (d.input.creditCard.billingAddress = o), d.input = (l = t, u = d.input, l.creditCard && l.creditCard.options && "boolean" == typeof l.creditCard.options.validate ? p = l.creditCard.options.validate : l.authorizationFingerprint && l.tokenizationKey || l.authorizationFingerprint ? p = !0 : l.tokenizationKey && (p = !1), "boolean" == typeof p && (u.options = r({
            validate: p
          }, u.options)), u), d).input, {
            email: y,
            optIn: A,
    ...
    105: [function(e, t, n) {
      ...
      t.exports = function(e) {
        ...
        return {
          ...
          }), c && (p.input.creditCard.billingAddress = c), p.input = (t = e, n = p.input, t.creditCard && t.creditCard.options && "boolean" == typeof t.creditCard.options.validate ? i = t.creditCard.options.validate : t.authorizationFingerprint && t.tokenizationKey || t.authorizationFingerprint ? i = !0 : t.tokenizationKey && (i = !1), "boolean" == typeof i && (n.options = r({
            validate: i
          }, n.options)), n), p),
    ...
    116: [function(t, n, r) {
      ...
      d.cipher.aes = function(e) {
        ...
        randomWords: function(e, t) {
          ...
          if (n & this.A) {
            n = !(n & this.w), i = [];
            var i, o, a = 0;
            for (o = 0, this.L = i[0] = new Date().valueOf() + this.P; 16 > o; o++) i.push(0x100000000 * Math.random() | 0);
      ...
      void 0 !== n && n.exports && (n.exports = d), "function" == typeof e && e([], function() {
        return d
      })
    }, {
      crypto: void 0
    ...
    149: [function(e, t, n) {
      ...
      t.exports = function(e) {
        ...
        return /^[a-zA-Z0-9]+_[a-zA-Z0-9]+_[a-zA-Z0-9_]+$/.test(e) ? (n = (t = e.split("_"))[0], a = {
          merchantId: t.slice(2).join("_"),
          environment: n
        }, s.environment = a.environment, s.attrs.tokenizationKey = e, s.configUrl = i[a.environment] + "/merchants/" + a.merchantId + "/client_api/v1/configuration") : (o = JSON.parse(r(e)), s.environment = o.environment, s.attrs.authorizationFingerprint = o.authorizationFingerprint, s.configUrl = o.configUrl, s.graphQL = o.graphQL), s
      }
    }, {
      "../lib/constants": 145,
    ...
    157: [function(e, t, n) {
      ...
      function y(e) {
        ...
        })(e), this._serviceId = l().replace(/-/g, ""), this._options = {
        ...
        return (O._isRedirectFlow ? e.redirectUrl = O._redirectUrl : T = O._frameService._serviceId, t = function(e) {
          ...
          if (y(e)) {
            if ("pay_upon_invoice" === (o = e.paymentType || "").toLowerCase())
              ...
              } else if ("blik" === o.toLowerCase()) return function(e) {
                var t, n, r, i = e.blikOptions || {};
                for (e.redirectUrl || E.REQUIRED_OPTIONS_FOR_BLIK_SEAMLESS_PAYMENT_TYPE.push("onPaymentStart"), t = 0; t < E.REQUIRED_OPTIONS_FOR_BLIK_SEAMLESS_PAYMENT_TYPE.length; t++)
                  if (n = E.REQUIRED_OPTIONS_FOR_BLIK_SEAMLESS_PAYMENT_TYPE[t], !e.hasOwnProperty(n)) return n;
                if (i.hasOwnProperty("level_0")) {
                  for (t = 0; t < E.REQUIRED_OPTIONS_FOR_BLIK_OPTIONS_LEVEL_0.length; t++)
                    if (n = E.REQUIRED_OPTIONS_FOR_BLIK_OPTIONS_LEVEL_0[t], !i.level_0.hasOwnProperty(n)) return "blikOptions.level_0." + n
                } else if (i.hasOwnProperty("oneClick")) {
                  if ((r = i.oneClick || {}).hasOwnProperty("aliasKey")) {
                    for (t = 0; t < E.REQUIRED_OPTIONS_FOR_BLIK_OPTIONS_ONE_CLICK_SUBSEQUENT.length; t++)
                      if (n = E.REQUIRED_OPTIONS_FOR_BLIK_OPTIONS_ONE_CLICK_SUBSEQUENT[t], !r.hasOwnProperty(n)) return "blikOptions.oneClick." + n
                  } else
                    for (t = 0; t < E.REQUIRED_OPTIONS_FOR_BLIK_OPTIONS_ONE_CLICK_FIRST.length; t++)
                      if (n = E.REQUIRED_OPTIONS_FOR_BLIK_OPTIONS_ONE_CLICK_FIRST[t], !r.hasOwnProperty(n)) return "blikOptions.oneClick." + n
                }
                return !1
              }(e)
          } else {
      ...
      p.createChild(A), A.prototype._constructDefaultSupportedPaymentMethods = function() {
        ...
        return new Promise(function(n, i) {
          t._bus.emit(h.PAYMENT_REQUEST_INITIALIZED, {
            ...
            r.sendEvent(t._client, "payment-request.tokenize.succeeded"), n({
              nonce: a.nonce,
              type: a.type,
    ...
    198: [function(e, t, n) {
      ...
      s.suppressUnhandledPromiseMessage = !0, N.prototype._initialize = function(e) {
        ...
        return this._configuration && (o["client-metadata-id"] = o["client-metadata-id"] ? o["client-metadata-id"] : this._configuration.analyticsMetadata.sessionId), a || (a = this._authorizationInformation.fingerprint && this._authorizationInformation.fingerprint.split("?")[0]), this._paypalScript = document.createElement("script"), e = i({}, {
          components: "buttons"
      ...
      h.suppressUnhandledPromiseMessage = !0, O.prototype._createVenmoPaymentContext = function(e, t) {
        ...
        return (e = e || {}, !0 === this._tokenizationInProgress) ? Promise.reject(new _(s.VENMO_TOKENIZATION_REQUEST_ACTIVE)) : (this._tokenizationInProgress = !0, (this._useDesktopQRFlow ? this._tokenizeForDesktopQRFlow(e) : this._useAllowDesktopWebLogin ? this._tokenizeWebLoginWithRedirect() : this._cannotHaveReturnUrls ? this._tokenizeForMobileWithManualReturn() : this._tokenizeForMobileWithHashChangeListeners(e)).then(function(e) {
          return n._createPromise.then(function(e) {
            ...
            }, t.payerInfo && (r.details.payerInfo = t.payerInfo, r.details.payerInfo.userName = P(t.payerInfo.userName)), r
          })
        }).catch(function(e) {
          return n._createPromise.then(function(e) {
            return n._createVenmoPaymentContext(e)
        ...
        return r.sendEvent(this._createPromise, "venmo.tokenize.desktop.start"), this._tokenizePromise = new h, this._createPromise.then(function() {
          ...
          e._tokenizePromise.reject(new _({
