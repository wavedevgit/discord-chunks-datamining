...
function S(e) {
  ...
  null == P && w();
  let [N, A] = (0, s.useState)(o), R = (0, g.KX)(), k = (0, m.O5)(), B = null == (t = (0, f.WD)()) ? void 0 : t.getId(), q = (0, i.e7)([u.Z], () => u.Z.useReducedMotion), I = (0, j.g2)({
    useReducedMotion: q,
    className: y.colorTransition
  }), D = N.filter(e => ["xbox", "playstation"].includes(e.connected_account_type)), Q = (0, h.Bz)(P), L = (0, i.e7)([p.Z], () => p.Z.getState().theme), V = (0, l.wj)(L) ? _.BRd.DARK : _.BRd.LIGHT, {
    startConsoleQuest: M,
    ...
    children: [(0, r.jsxs)(c.xBx, {
      ...
      children: [(0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(c.Text, {
          ...
          onClick: M,
          children: [I.render(), (0, r.jsx)(c.Text, {
            variant: "text-sm/medium",
            color: "currentColor",
            className: y.colorTransition,
