...
function m(e) {
  ...
  return i.useEffect(() => ((0, o.waitForAllDefaultIntlMessagesLoaded)().then(() => (0, f.d1)()), p.intl.onLocaleChange(() => (0, f.d1)()), window.addEventListener("keydown", h), () => window.removeEventListener("keydown", h)), []), <l.Sfi.Provider value={u}>{t}</l.Sfi.Provider>
}