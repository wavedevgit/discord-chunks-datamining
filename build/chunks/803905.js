...
let U = new _(r.q.INCREASED_GUILD_LIMIT),
  ...
  F = Object.freeze({
    [c.Si.TIER_0]: new l.Z(c.Si.TIER_0, [p, h, m, S, j, B, V, A]),
    [c.Si.TIER_1]: new l.Z(c.Si.TIER_1, [p, h, b, y, S, R, w, x, B, V, A]),
    [c.Si.TIER_2]: new l.Z(c.Si.TIER_2, [p, h, m, g, E, b, y, O, S, I, C, R, P, w, D, x, M, k, j, U, G, B, V, A, T, L, v, N])
  });
