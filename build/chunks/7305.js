...
function k(e) {
  ...
  let {
    ...
    giftMessage: B,
    giftRecipient: G
  } = (0, x.wD)(), D = H && (0, p.pO)(G) && F === j.h8.PLAN_SELECT;
...
let R = [{
  ...
  key: j.h8.CONFIRM,
  renderStep: e => (0, i.jsx)(S.b, A({}, e))
}, {
  key: j.h8.SELECT_FREE_SKU,
  renderStep: e => (0, i.jsx)(E.S, A({}, e)),
  options: {
...
function F(e) {
  let n = (0, s.e7)([u.ZP], () => u.ZP.getPremiumTypeSubscription()),
    {
