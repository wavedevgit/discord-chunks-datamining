...
function k(e) {
  ...
  i.useEffect(() => {
    u.Z.isLoadedForPremiumSKUs() || l.Z.wait(() => (0, a.Y2)())
  }, []);
  let {
    step: F,
    ...
    giftMessage: D,
    giftRecipient: W
  } = (0, f.wD)(), Y = H && (0, _.pO)(W) && F === x.h8.PLAN_SELECT;
  return (0, n.jsx)(S.Z, {
    isWowMomentConfirmationEligible: G,
...
function B(e) {
  ...
  return (0, n.jsx)(L.J, (t = N({}, e), r = r = {
    breadcrumbSteps: U,
    onReturn: () => {
      let e = Object.values(a),
        t = e.length < 1 && null == i ? x.h8.PLAN_SELECT : x.h8.REVIEW;
      _ && (t = x.h8.REVIEW), h && e.length < 1 && (t = x.h8.SELECT_FREE_SKU), o(t, {
