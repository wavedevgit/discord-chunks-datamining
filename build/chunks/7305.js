...
function A(e) {
  ...
  let {
    ...
    giftMessage: H,
    giftRecipient: W
  } = (0, _.wD)(), G = B && (0, p.pO)(W) && F === f.h8.PLAN_SELECT;
...
function R(e) {
  ...
  return (0, r.jsx)(j.J, (t = w({}, e), n = n = {
    breadcrumbSteps: k,
    onReturn: () => {
      let e = Object.values(o),
        t = e.length < 1 && null == i ? f.h8.PLAN_SELECT : f.h8.REVIEW;
      p && (t = f.h8.REVIEW), h && e.length < 1 && (t = f.h8.SELECT_FREE_SKU), l(t, {
...
let F = [{
  ...
  options: {
    renderHeader: !0,
    useBreadcrumbLabel: e => U(e) ? null : Z.NW.string(Z.t["r+SebW"])
  }
}, {
  ...
  options: {
    renderHeader: !0,
    useBreadcrumbLabel: e => U(e) ? null : Z.NW.string(Z.t.Sb6wIy)
  }
}, {
  ...
  options: {
    renderHeader: !0,
    useBreadcrumbLabel: e => U(e) ? Z.NW.string(Z.t.UKbp1N) : Z.NW.string(Z.t.QBnNHh)
  }
}, {
  key: f.h8.CONFIRM,
