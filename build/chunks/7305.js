...
function U(e) {
  ...
  let {
    ...
    giftMessage: H,
    giftRecipient: W
  } = (0, _.wD)(), G = B && (0, p.pO)(W) && F === h.h8.PLAN_SELECT;
...
function R(e) {
  ...
  return (0, r.jsx)(m.J, (t = A({}, e), n = n = {
    breadcrumbSteps: k,
    onReturn: () => {
      let e = Object.values(o),
        t = e.length < 1 && null == i ? h.h8.PLAN_SELECT : h.h8.REVIEW;
      p && (t = h.h8.REVIEW), f && e.length < 1 && (t = h.h8.SELECT_FREE_SKU), l(t, {
...
let F = [{
  ...
  renderStep: e => (0, r.jsx)(N.x, A({}, e)),
  options: {
    renderHeader: !0,
    useBreadcrumbLabel: e => w(e) ? null : Z.NW.string(Z.t["r+SebW"])
  }
}, {
  ...
  options: {
    renderHeader: !0,
    useBreadcrumbLabel: e => w(e) ? null : Z.NW.string(Z.t.Sb6wIy)
  }
}, {
  ...
  options: {
    renderHeader: !0,
    useBreadcrumbLabel: e => w(e) ? Z.NW.string(Z.t.UKbp1N) : Z.NW.string(Z.t.QBnNHh)
  }
}, {
  key: h.h8.CONFIRM,
...
function B(e) {
  let t = (0, l.e7)([u.ZP], () => u.ZP.getPremiumTypeSubscription()),
    ...
    } = (0, C.ZP)(e.analyticsLocations, a.Z.PREMIUM_PAYMENT_MODAL),
    {
  ...
  if (null != S && !Object.values(O.Si).includes(S)) throw Error("subscriptionTier must be a premium subscription");
  return (0, r.jsx)(C.Gt, {
    value: n,
