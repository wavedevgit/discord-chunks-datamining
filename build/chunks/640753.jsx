...
var Chunk255367 = require("./255367.js"),
  ...
  Chunk981341 = require("./981341.js"),
  Chunk994648 = require("./994648.js");
...
function m(e) {
  let {
    ...
    key: O,
    messageId: n
  }), [E, O, m, t, n]), [T, S] = i.useState(false), A = (0, o.e7)([s.Z], () => s.Z.useReducedMotion), N = c.Yk.useSetting(), C = i.useCallback(() => {
    a.Z.dispatch({
  ...
  }, [N, t, b, m, m.name, T, n, A]), null == O) ? null : <f.Z className={v.effect} effect={I} onComplete={C} emojiSize={y} />
}
let g = Chunk73800.memo(m)