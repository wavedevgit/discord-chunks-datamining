  ...
  joinGuild: async function(e) {
    ...
    try {
      ...
      if ((null == (i = t.body) ? true : i.code) === C.evJ.TOO_MANY_USER_GUILDS) {
        ...
        S.ZP.canUseIncreasedGuildCap(e) || (null == e ? true : e.isStaff()) ? j(C.tHP) : j(C.DZw)
      }
      throw (null == (s = t.body) ? true : s.code) === C.evJ.GUILD_AT_CAPACITY && U(), h && (null == (l = t.body) ? true : l.code) === C.evJ.UNKNOWN_GUILD && k(e), t
    }
  },
  waitForGuild: G,
