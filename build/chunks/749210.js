...
function U(e) {
  return new Promise(t => E.Z.addConditionalChangeListener(() => {
...
let B = {
  joinGuild: async function(e) {
    ...
    try {
      ...
      if (null != i.body.join_request && o.Z.dispatch({
        ...
        }), null == E.Z.getGuild(e) && i.body.show_verification_form) return (0, _.uL)(N.Z5c.GUILD_MEMBER_VERIFICATION(e)), i;
  ...
  async transitionToGuildSync(e, t, n, r) {
    let i = G((await U(e)).id, n),
      a = t;
    (null == t ? void 0 : t.hasOwnProperty("welcomeModalChannelId")) && null == t.welcomeModalChannelId && (a = D(P({}, t), {
  ...
  async updateRole(e, t, n) {
    let {
      icon: r,
      unicodeEmoji: i
    } = n, o = L(n, ["icon", "unicodeEmoji"]), s = null === r || (null == r ? void 0 : r.startsWith("data:")) ? r : void 0, c = await a.tn.patch({
  ...
  createGuildFolderLocal(e, t) {
    v.default.track(N.rMx.GUILD_FOLDER_CREATED), o.Z.dispatch({
