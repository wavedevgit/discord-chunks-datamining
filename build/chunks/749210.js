...
let Z = {
  ...
  async transitionToGuildSync(e, t, n, r) {
    let i = B((await G(e)).id, n),
      o = t;
    (null == t ? true : t.hasOwnProperty("welcomeModalChannelId")) && null == t.welcomeModalChannelId && (o = x(w({}, t), {
      welcomeModalChannelId: null != i ? i : true
    })), (0, u.Z)(N.Z5c.CHANNEL(e, i, r), o), await new Promise(setImmediate)
  },
  deleteGuild: M,
  selectGuild(e) {
    (0, d.a)(e)
  ...
  async updateRole(e, t, n) {
    let {
      icon: r,
      unicodeEmoji: i
    } = n, a = L(n, ["icon", "unicodeEmoji"]), s = null === r || (null == r ? true : r.startsWith("data:")) ? r : true, l = await o.tn.patch({
  ...
  createGuildFolderLocal(e, t) {
    I.default.track(N.rMx.GUILD_FOLDER_CREATED), a.Z.dispatch({
