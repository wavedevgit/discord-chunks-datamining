...
let j = e => {
  ...
  let {
    ...
    let e = m.Z.getCurrentCategoryId(j.id),
      ...
      n = m.Z.getDirectoryCategoryCounts(j.id);
    return {
      currentCategoryId: e,
      directoryEntries: t,
      categoryCounts: n,
      allEntriesCount: m.Z.getDirectoryAllEntriesCount(j.id),
  ...
  let T = i.useMemo(() => null != P ? (0, y.v)(Object.values(P), S) : null, [P, S]),
    {
      mostRecentQuery: A,
      searchFetching: w,
      searchResults: R
