...
let C = e => {
  ...
  let F = (0, m.G)(C) ? () => {
    ...
    B = e => {
      0 !== D.trim().length && e.charCode === x.yXg.ENTER && (p.Rq(C.id, D), u.default.track(x.rMx.GUILD_DIRECTORY_SEARCH, {
        directory_channel_id: C.id,
        directory_guild_id: E.id
      }))
    },
  ...
  return M ? (0, r.jsx)(j.Z, {
    ...
    searchResults: A,
    searchFetching: R
  }) : null == N && null == Z ? (0, r.jsx)("div", {
    className: v.pageContainer,
    children: (0, r.jsx)(a.$jN, {
      className: v.spinner
    })
  }) : (null == N ? void 0 : N.length) === 0 && null == Z ? (0, r.jsx)("div", {
    className: v.pageContainer,
