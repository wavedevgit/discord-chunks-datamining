...
function k(e) {
  let {
    ...
    snapshot: n,
    index: p
  } = e, f = i.useMemo(() => new u.r(t, n, p), [t, n, p]), h = (0, a.e7)([C.Z, P.default, T.Z, N.Z, I.Z, m.Z], () => f.getForwardInfo(C.Z, P.default, T.Z, N.Z, I.Z, m.Z).footerInfo, [f], o.Z), g = i.useCallback(() => {
    (0, d.Z)(t)
  }, [t]);
  return null == h ? null : (0, r.jsxs)(c.P3F, {
    className: R.footerContainer,
    onClick: g,
    children: [null != h.originIconUrl ? (0, r.jsx)("img", {
...
function L(e) {
  ...
  let {
    ...
    snapshot: o,
    index: u
  } = e, d = i.useMemo(() => (0, p.Z)(n, o), [n, o]), m = j.RS.useSetting(), h = j.NA.useSetting(), g = (0, a.e7)([S.Z], () => S.Z.isDeveloper), _ = (0, f.A)((null != (t = d.editedTimestamp) ? t : d.timestamp).valueOf()), {
    content: b,
    hasSpoilerEmbeds: x
  } = (0, v.Z)(d, {
    ...
    allowDevLinks: g,
    previewLinkTarget: !0
  }), E = (0, a.e7)([C.Z], () => C.Z.getChannel(n.channel_id)), y = j.jU.useSetting();
...
function M(e) {
  ...
  return (0, r.jsx)(r.Fragment, {
    children: t.messageSnapshots.map((e, n) => (0, r.jsx)(L, {
      message: t,
      snapshot: e,
      index: n
    }, n))
