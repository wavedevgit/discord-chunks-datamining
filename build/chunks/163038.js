...
function B(e) {
  let {
    ...
    snapshot: n,
    index: u
  } = e, f = i.useMemo(() => new d.r(t, n, u), [t, n, u]), p = (0, o.e7)([C.Z, x.default, D.Z, P.Z, R.Z, _.Z], () => f.getForwardInfo(C.Z, x.default, D.Z, P.Z, R.Z, _.Z).footerInfo, [f], s.Z), h = i.useCallback(() => {
    var e, n;
    ...
    null == r || null == i || l || null == a || (S.Z.openModReportAsSidebar({
      ...
      baseChannelId: a,
      guildId: r.guild_id
    }), (0, T.Kh)(a), k.default.track(M.rMx.MODERATOR_REPORT_ORIGINAL_MESSAGE_LINK_CLICKED, {
...
function V(e) {
  ...
  let {
    ...
    snapshot: l,
    index: c
  } = e, [d, _] = i.useState(void 0);
  i.useEffect(() => {
    var e;
    (null == l || null == (e = l.moderatorReport) ? void 0 : e.reported_user_id) != null && (0, u.PR)(l.moderatorReport.reported_user_id).then(e => {
      _(e)
    }).catch(() => {})
