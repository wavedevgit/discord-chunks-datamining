...
function f(e) {
  ...
  }, [j, t]), O = <s.Z image={t.banner} makeURL={e => null != e ? o.ZP.getGuildBannerURL({
      id: t.id,
      banner: e
    }, b) : null} disabled={!x} onChange={v} hint={p.intl.string(p.t.uPvxqK)} onOpenImageSelectModal={() => (0, c.mw)({
  ...
  return f ? O : <l.P3F aria-hidden={true} tabIndex={false} className={h.upsell} onClick={_}>{O}</l.P3F>
}