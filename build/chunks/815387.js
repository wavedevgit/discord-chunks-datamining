...
let eL = Object.freeze({
    ...
    [eN.uaV.CALL]: function(e) {
      let {
        ...
        id: o,
        author: s
      } = t, u = D.default.getId(), d = t.getChannelId(), p = (0, l.e7)([M.Z], () => M.Z.isCallActive(d, o), [d, o]), m = (0, l.e7)([z.Z], () => z.Z.getVoiceState(eN.ME, u)), f = !p && null != t.call && !t.call.participants.includes(u), h = p && (null == m || m.channelId !== d), g = i.useCallback(() => c.default.selectVoiceChannel(d), [d]), _ = (0, et.l)({
        user: s,
        channelId: d,
        guildId: a.guild_id,
        messageId: t.id
    ...
    [eN.uaV.GUILD_STREAM]: function(e) {
      let {
        ...
        messageReference: c
      } = t, d = t.getChannelId(), p = (0, l.e7)([G.Z], () => G.Z.findActivity(s, e => e.type === eN.IIU.PLAYING), [s]), m = (0, l.e7)([U.Z], () => null != c ? U.Z.getChannel(c.channel_id) : null, [c]), f = null == c ? void 0 : c.guild_id, h = (0, et.l)({
        user: o,
        channelId: d,
        guildId: a.guild_id,
        messageId: t.id
    ...
    [eN.uaV.STAGE_RAISE_HAND]: function(e) {
      ...
      let {
        ...
        guildId: o.guild_id,
        messageId: i.id
      }), d = (0, l.e7)([B.Z], () => B.Z.can(eN.Plq.MUTE_MEMBERS, o)), p = (0, l.e7)([w.Z], () => w.Z.getParticipant(o.id, i.author.id)), m = new Date(q.default.extractTimestamp(i.id)).toISOString() === new Date(null != (n = null == p || null == (t = p.voiceState) ? void 0 : t.requestToSpeakTimestamp) ? n : 0).toISOString(), f = d && (null == p ? void 0 : p.rtsState) === Z.xO.REQUESTED_TO_SPEAK && m;
      return (0, r.jsxs)(r.Fragment, {
