...
function eZ(e) {
  let {
    ...
    guild_id: s
  } = n, c = t.getChannelId(), u = (0, l.e7)([U.Z], () => U.Z.getGuild(s), [s]), d = i.useCallback(() => {
    null != u && (0, b.f)({
      guildId: u.id,
      location: {
...
let ek = Object.freeze({
    ...
    [eT.uaV.RECIPIENT_ADD]: function(e) {
      let {
        ...
        author: a
      } = t, o = t.getChannelId(), s = (0, l.e7)([H.default], () => H.default.getUser(t.mentions[0]), [t]), c = W.ZP.getName(null, o, s), u = (0, ee.l)({
        user: a,
        channelId: o,
        guildId: n.guild_id,
        messageId: t.id
    ...
    [eT.uaV.RECIPIENT_REMOVE]: function(e) {
      let {
        ...
        author: a
      } = t, o = t.getChannelId(), s = (0, l.e7)([H.default], () => H.default.getUser(t.mentions[0]), [t]), c = (0, ee.l)({
        user: a,
        channelId: o,
        guildId: n.guild_id,
        messageId: t.id
    ...
    [eT.uaV.CALL]: function(e) {
      let {
        ...
        id: o,
        author: s
      } = t, u = L.default.getId(), d = t.getChannelId(), p = (0, l.e7)([D.Z], () => D.Z.isCallActive(d, o), [d, o]), m = (0, l.e7)([V.Z], () => V.Z.getVoiceState(eT.ME, u)), f = !p && null != t.call && !t.call.participants.includes(u), h = p && (null == m || m.channelId !== d), g = i.useCallback(() => c.default.selectVoiceChannel(d), [d]), _ = (0, ee.l)({
        user: s,
        channelId: d,
        guildId: a.guild_id,
        messageId: t.id
    ...
    [eT.uaV.GUILD_STREAM]: function(e) {
      let {
        ...
        messageReference: c
      } = t, d = t.getChannelId(), p = (0, l.e7)([B.Z], () => B.Z.findActivity(s, e => e.type === eT.IIU.PLAYING), [s]), m = (0, l.e7)([M.Z], () => null != c ? M.Z.getChannel(c.channel_id) : null, [c]), f = null == c ? void 0 : c.guild_id, h = (0, ee.l)({
        user: o,
        channelId: d,
        guildId: a.guild_id,
        messageId: t.id
      ...
      return null != c && null != m && null != c.guild_id ? (0, r.jsx)(ep.Z, {
        message: t,
        compact: n,
        channel: m,
        playingActivity: p,
    ...
    [eT.uaV.GUILD_INVITE_REMINDER]: function(e) {
      let {
        ...
        channel: n,
        compact: i
      } = e, a = (0, l.e7)([H.default], () => H.default.getCurrentUser()), o = (0, l.e7)([U.Z], () => {
        var e, t;
    ...
    [eT.uaV.STAGE_START]: function(e) {
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(ey.Z, {
          ...
          compact: i,
          usernameHook: a
        }), null != o && o.name === t.content ? (0, r.jsx)(C.Z, {
    ...
    [eT.uaV.STAGE_RAISE_HAND]: function(e) {
      ...
      let {
        ...
        guildId: o.guild_id,
        messageId: i.id
      }), d = (0, l.e7)([F.Z], () => F.Z.can(eT.Plq.MUTE_MEMBERS, o)), p = (0, l.e7)([A.Z], () => A.Z.getParticipant(o.id, i.author.id)), m = new Date(Y.default.extractTimestamp(i.id)).toISOString() === new Date(null != (n = null == p || null == (t = p.voiceState) ? void 0 : t.requestToSpeakTimestamp) ? n : 0).toISOString(), f = d && (null == p ? void 0 : p.rtsState) === w.xO.REQUESTED_TO_SPEAK && m;
      return (0, r.jsxs)(r.Fragment, {
