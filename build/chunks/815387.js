...
let ek = Object.freeze({
    ...
    [eN.uaV.STAGE_RAISE_HAND]: function(e) {
      ...
      let {
        ...
        guildId: o.guild_id,
        messageId: i.id
      }), d = (0, l.e7)([F.Z], () => F.Z.can(eN.Plq.MUTE_MEMBERS, o)), p = (0, l.e7)([A.Z], () => A.Z.getParticipant(o.id, i.author.id)), m = new Date(Y.default.extractTimestamp(i.id)).toISOString() === new Date(null != (n = null == p || null == (t = p.voiceState) ? void 0 : t.requestToSpeakTimestamp) ? n : 0).toISOString(), f = d && (null == p ? void 0 : p.rtsState) === w.xO.REQUESTED_TO_SPEAK && m;
      return (0, r.jsxs)(r.Fragment, {
