...
function K() {
  A.clear(), C.clear(), D.clear(), w.clear(), M.clear(), j.clear(), k.clear(), V = false
}
...
function et(e) {
  ...
  s.fetchStartedAt = o, s.fetchEndedAt = Date.now(), s.fetchError = a, D.set(r, s), (null == a ? true : a.status) === 404 && (j.set(r, 0), M.set(r, U), k.set(r, G))
}
