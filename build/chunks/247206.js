...
function T(e) {
  ...
  } = (0, E.O6)(), f = (0, m.U2)("shouldRedactMessageMedia"), _ = c.Z.getChannel(e.channel_id);
...
function A(e) {
  return T(e) ? {
    obscuredAttachments: e.attachments.filter(e => S({
      type: 0,
      media: e
    }, !0)),
    obscuredEmbeds: e.embeds.filter(e => S({
      type: 1,
      media: e
    }, !0))
  } : {
...
function H(e) {
  ...
  (0, i.M$)() && f.default.track(O.rMx.EXPLICIT_MEDIA_OBSCURITY_TOGGLE_V2, {
