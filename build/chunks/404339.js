...
let h = e => {
    ...
    return r && i ? (0, s.jsxs)(s.Fragment, {
      ...
      children: [f.NW.format(f.t["J/ZBu7"], {
        n: t
      }), (0, s.jsx)("br", {}), f.NW.string(f.t.tFvYm5)]
    }) : i ? (0, s.jsxs)(s.Fragment, {
      children: [f.NW.format(f.t["8mtcq6"], {
        n: n
      }), (0, s.jsx)("br", {}), f.NW.string(f.t.Z21Rp6)]
    }) : null
  },
  N = e => {
    let {
      ...
      blockedUsers: n,
      ignoredUsers: r
    } = e, _ = o.Z.getChannel(t), c = n.length > 0, d = r.length > 0, l = [{
      icon: (0, s.jsx)("div", {
        className: p.icon,
...
function x(e) {
  let {
    ...
    onClose: o,
    onJoin: u
  } = e, p = Array.from(n).map(e => _.default.getUser(e)).filter(e => null !== e), x = Array.from(i).map(e => _.default.getUser(e)).filter(e => null !== e);
  return 0 === p.length && 0 === x.length ? null : (0, s.jsx)(l.Z, {
    ...
    onDismissAndStay: () => {
      u(), o(), (0, d.g6)(t), c.default.track(m.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
    ...
    onDismissAndLeave: () => {
      o(), c.default.track(m.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
