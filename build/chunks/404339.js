...
let I = e => {
  ...
  g = e => {
    let {
      ...
      blockedUsers: r,
      ignoredUsers: s
    } = e, o = l.Z.getChannel(t), c = r.length > 0, u = s.length > 0, d = [{
      icon: (0, n.jsx)("div", {
        className: m.icon,
...
function h(e) {
  ...
  return 0 === m.length && 0 === h.length ? null : (0, n.jsx)(d.Z, {
    ...
    onDismissAndStay: () => {
      _(), l(), (0, u.dI)(r.union(i)), c.default.track(A.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
    ...
    onDismissAndLeave: () => {
      l(), c.default.track(A.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
