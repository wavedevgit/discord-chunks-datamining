...
function L(e) {
  ...
  }), (ec || !G) && z) ? null : ec && !z ? Y ? z ? null : <E.E emptyText={j.intl.string(j.t["T6+rX1"])} icon={l.hGI} absolute={true} /> : null : <div className={C.goLiveGridContainer} style={{
      opacity: W
    }} ref={ee}><_.ZP widgetId={D} tileWidth={ep} tileHeight={ef} locked={z} layout={eu} activeStreams={el} streamParticipants={eo} participantsVersion={ea} pinned={G} padding={U} sizeOffset={Q} /></div>
}