...
class d extends Chunk73800.Component {
  ...
  render() {
    ...
    return this.state.focused ? e = {
      visibility: "hidden",
      pointerEvents: "none"
    } : c.opacity = 0, <div className={a()(Chunk516459.outer, exports)}><div className={Chunk516459.container}>{<input type={"text"} className={Chunk516459.input} ref={this.inputRef} style={c} value={this.state.value} name={require} maxLength={Chunk120356} autoComplete={Chunk73800} onKeyPress={this.handleKeyPress} onChange={this.handleChange} onFocus={this.handleFocus} onBlur={this.handleBlur} onMouseEnter={this.handleMouseEnter} disabled={Chunk981631} />}{<div className={Chunk516459.input} style={module}>{this.state.value}</div>}</div></div>
  }
  constructor(...e) {
...
function u() {
  ...
  return (null == exports.minLen || !(Chunk255367.length < exports.minLen)) && (null == exports.maxLen || !(Chunk255367.length > exports.maxLen))
}