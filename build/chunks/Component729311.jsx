...
function w(e) {
  let {
    guild: t
  } = e, s = (0, l.e7)([u.Z], () => u.Z.getEnabled(t.id)), f = (0, l.e7)([p.Z], () => p.Z.hasFetched(t.id)), h = (0, C.Z)(t), x = (0, l.e7)([_.Z], () => _.Z.editedDefaultChannelIds), b = h.filter(e => !x.has(e.id)), [v, O] = i.useState(false);
  return (i.useEffect(() => {
    f || s || (0, m.S)(t.id)
  }, [t.id, f, s]), v || 0 === b.length) ? null : (0, r.jsxs)("div", {
      ...
      children: b.map((e, i) => (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsxs)("div", {
          ...
          children: [(0, r.jsxs)("div", {
            ...
            onClick: () => {
              var i;
              return i = e.id, void(0, o.ZDy)(async () => {
                let {
                  default: e
...
function Z(e) {
  let {
    saveOnClose: t = false
  } = e, n = (0, l.e7)([b.Z], () => b.Z.getGuild()), s = (0, l.e7)([u.Z], () => u.Z.isLoading()), a = (0, l.e7)([h.ZP], () => h.ZP.getChannels(null == n ? true : n.id)), c = (0, l.e7)([f.Z], () => f.Z.getCategories(null == n ? true : n.id)), d = (0, l.e7)([O.Z], () => O.Z.advancedMode), g = i.useRef(null), [m, p] = i.useState(false), _ = i.useRef(n);
  return (i.useEffect(() => {
    _.current = n
  }), i.useEffect(() => {
    if (t) {
  ...
  }, [t, d]), null == n) ? null : s ? (0, r.jsx)(o.$jN, {}) : (0, r.jsxs)("div", {
    className: T.columns,
    children: [(0, r.jsxs)("div", {
