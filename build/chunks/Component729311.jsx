...
function w(e) {
  let {
    guild: t
  } = e, s = (0, l.e7)([d.Z], () => d.Z.getEnabled(t.id)), h = (0, l.e7)([p.Z], () => p.Z.hasFetched(t.id)), f = (0, y.Z)(t), b = (0, l.e7)([_.Z], () => _.Z.editedDefaultChannelIds), x = f.filter(e => !b.has(e.id)), [v, O] = i.useState(false);
  return (i.useEffect(() => {
    h || s || (0, g.S)(t.id)
  }, [t.id, h, s]), v || 0 === x.length) ? null : (0, r.jsxs)("div", {
...
function R(e) {
  let {
    saveOnClose: t = false
  } = e, n = (0, l.e7)([x.Z], () => x.Z.getGuild()), s = (0, l.e7)([d.Z], () => d.Z.isLoading()), o = (0, l.e7)([f.ZP], () => f.ZP.getChannels(null == n ? true : n.id)), c = (0, l.e7)([h.Z], () => h.Z.getCategories(null == n ? true : n.id)), u = (0, l.e7)([O.Z], () => O.Z.advancedMode), m = i.useRef(null), [g, p] = i.useState(false), _ = i.useRef(n);
  return (i.useEffect(() => {
    _.current = n
  }), i.useEffect(() => {
    if (t) {
