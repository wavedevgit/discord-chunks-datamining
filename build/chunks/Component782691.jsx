...
let S = {
  ...
  C = e => {
    let {
      ...
      upsertConfig: n
    } = (0, h.n6)(), o = (0, s.e7)([_.default], () => _.default.getCurrentUser()), [O, I] = i.useState(true), C = i.useRef(null), [N, R] = i.useState(false), [P, w] = i.useState(false), [D, x] = i.useState([]), [L, j] = i.useState(S), k = i.useRef([]), [M, U] = i.useState(t.name), G = M.toLowerCase().replace(/\s+/g, "_"), B = i.useMemo(() => ({
      id: A,
      skuId: A,
      title: A,
      description: A,
