...
function b(e) {
  ...
  } = e, b = null == t ? true : t.filter(e => null != (0, d.zK)(e)), y = (0, i.useRef)(new Map), v = (0, i.useRef)(null), x = (0, i.useRef)(null), [h, P] = (0, i.useState)(0), [w, S] = (0, i.useState)(false), {
    trackUserProfileAction: E
  } = (0, o.KZ)(), I = r && !c && (0, s.M8)(l), _ = j(v, x, b, y, P);
  if ((0, i.useEffect)(() => (_(), window.addEventListener("resize", _), () => {
  ...
  let T = w ? b : b.slice(0, b.length - h);
  return (0, n.jsxs)("div", {
    className: g.tagListContainer,
    children: [(0, n.jsx)("ul", {
      className: g.tagList,
