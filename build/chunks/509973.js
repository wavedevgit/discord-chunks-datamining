/** Chunk was on web.js **/
/** chunk id: 509973, original params: e,t,n (module,exports,re quire) **/
var r = require("./105953.js").RBTree;
...
i.prototype.reset = function() {
  ...
  if (!this.compressing) {
    var e = this.toArray();
    for (this.reset(), this.compressing = true; e.length > 0;) this.push_centroid(o(e));
