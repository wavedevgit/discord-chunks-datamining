...
function l(e, t, n, a, u, d = {}, f, _) {
  ...
  for (let g of t) {
    ...
    let m = g[1];
    if (!(m in d) && !o(m)) throw new s(m, _, t);
    let E = d[m];
    switch (t) {
      ...
      case i.FormatJsNodeType.Tag: {
        ...
        if (o(m)) e.pushRichTextTag(m, i, s);
        else {
          if ("function" != typeof E) throw `expected a function type for a Tag formatting value, ${m}. got ${typeof E}: ${E}`;
          let t = E(i, `${h++}`);
      ...
      case i.FormatJsNodeType.Select: {
        ...
        if (null == i) throw `${t} is not a known option for select value ${m}. Valid options are ${Object.keys(r).join(", ")}`;
        l(e, i, n, a, u, d);
        break
      }
      case i.FormatJsNodeType.Plural: {
        ...
        if (null == o) throw `${E} is not a known option for plural value ${m}. Valid options are ${Object.keys(t).join(", ")}`;
