...
let Z = e => {
  let {
    ...
    disabled: a,
    entityType: s
  } = e, o = n === O.d4z.GUILD_STAGE_VOICE, x = (0, y.Q)(r, s), m = (0, f.sR)(t, n);
...
function w(e) {
  let {
    ...
    entityType: o,
    channelId: u
  } = n, x = (0, s.e7)([d.Z], () => d.Z.getChannel(u), [u]), m = r.useRef(null);
  r.useEffect(() => {
  ...
  let g = e => {
    ...
    p = (0, b.xC)(o),
    f = (0, h.xt)(n);
  return null == o || o === N.WX.NONE ? null : o === N.WX.EXTERNAL ? (0, l.jsx)(c.xJW, {
...
function D(e) {
  let {
    ...
    guildEvent: n,
    onChange: i
  } = e, a = (0, s.e7)([x.Z], () => x.Z.getGuild(t), [t]), u = (0, p.Z)(t, true), d = (0, p.Z)(t, O.d4z.GUILD_VOICE), m = (0, p.Z)(t, O.d4z.GUILD_STAGE_VOICE), g = (0, f.sR)(t, O.d4z.GUILD_VOICE), v = (0, j.q)(a), y = null == a ? true : a.features.has(O.oNc.COMMUNITY), b = (0, h.xt)(n), E = P(i, n), Z = r.useMemo(() => {
    let e = [T({
      name: C.intl.string(C.t.BVZqJi),
      value: N.WX.VOICE,
      desc: C.intl.string(C.t["EV//4e"]),
      icon: c.gj8
    }, I(N.WX.VOICE, b, d, g.length)), T({
    ...
    return y ? [T({
      ...
      icon: c.ewx
    }, I(N.WX.STAGE_INSTANCE, b, m, v.length)), ...e] : e
...
function R(e) {
  let {
    ...
    entityType: u
  } = r, d = (0, s.e7)([x.Z], () => x.Z.getGuild(t), [t]), g = (0, j.q)(d), v = (0, s.e7)([m.Z], () => m.Z.can(O.Plq.MANAGE_CHANNELS, d)), h = null == d ? true : d.features.has(O.oNc.COMMUNITY), p = P(a, r), f = h && u !== N.WX.EXTERNAL && 0 === g.length && v && null != u;
  return (0, l.jsxs)("div", {
    ...
    children: [(0, l.jsx)(c.X6q, {
      ...
      onClick: () => {
        p({
          ...
          let {
            default: e
          } = await Promise.all([n.e("33285"), n.e("38697"), n.e("45094"), n.e("93154")]).then(n.bind(n, 218613));
          return n => {
            var r, i;
