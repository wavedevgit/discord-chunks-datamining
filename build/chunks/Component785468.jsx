...
let T = e => {
  let {
    ...
    disabled: a,
    entityType: s
  } = e, d = n === N.d4z.GUILD_STAGE_VOICE, x = (0, j.Q)(r, s), v = (0, p.sR)(t, n);
...
function P(e) {
  ...
  let g = e => {
    ...
    p = (0, y.xC)(c),
    f = (0, v.xt)(n);
  return null == c || c === E.WX.NONE ? null : c === E.WX.EXTERNAL ? (0, l.jsx)(o.xJW, {
...
function w(e) {
  let {
    ...
    guildEvent: n,
    onChange: i
  } = e, a = (0, s.e7)([d.Z], () => d.Z.getGuild(t), [t]), c = (0, h.Z)(t, true), u = (0, h.Z)(t, N.d4z.GUILD_VOICE), x = (0, h.Z)(t, N.d4z.GUILD_STAGE_VOICE), m = (0, p.sR)(t, N.d4z.GUILD_VOICE), g = (0, f.q)(a), j = null == a ? true : a.features.has(N.oNc.COMMUNITY), y = (0, v.xt)(n), b = I(i, n), T = r.useMemo(() => {
    let e = [S({
...
function D(e) {
  let {
    ...
    entityType: u
  } = r, m = (0, s.e7)([d.Z], () => d.Z.getGuild(t), [t]), g = (0, f.q)(m), v = (0, s.e7)([x.Z], () => x.Z.can(N.Plq.MANAGE_CHANNELS, m)), h = null == m ? true : m.features.has(N.oNc.COMMUNITY), p = I(a, r), j = h && u !== E.WX.EXTERNAL && 0 === g.length && v && null != u;
  return (0, l.jsxs)("div", {
    ...
    children: [(0, l.jsx)(o.X6q, {
      ...
      onClick: () => {
        p({
          ...
          let {
            default: e
          } = await Promise.all([n.e("7590"), n.e("38697"), n.e("67325"), n.e("46786"), n.e("45094"), n.e("88572")]).then(n.bind(n, 218613));
          return n => {
            var r, i;
