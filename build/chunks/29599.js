...
let k = function() {
  ...
  } = (0, E.lG)(), L = _.length + j.length > 0, M = x.g.useExperiment({
    location: "EntitlementGifts"
  }, {
    autoTrackExposure: !1,
    disable: s
  }).enabled && L;
  return d && b ? (0, i.jsxs)(i.Fragment, {
    children: [function() {
      var e;
      let t = n.find(e => e.giftCodeBatchId === R.m8 && !e.consumed),
        ...
        m = M ? (0, i.jsxs)("div", {
          ...
          children: [(0, i.jsx)(u.SrA, {
            ...
            textOptions: {
              textOverride: D.intl.string(D.t.mr4K7O)
            }
          })]
        }) : null;
      return (0, i.jsxs)("div", {
        className: Z.marginContainer,
        children: [d, L ? (0, i.jsx)(u.$i$, {
          className: Z.divider
        }) : null, (0, i.jsx)(v.Z, {
          ...
          children: (0, i.jsxs)(u.hjN, {
            ...
            }, (0, N.Bg)(t.skuId, t.subscriptionPlanId)) : null, l.length > 0 ? (0, i.jsx)(A.Z, {
              className: Z.skuCard,
              skuId: l[0].skuId,
              subscriptionPlanId: l[0].subscriptionPlanId,
              entitlements: l,
              giftCodeBatchId: R.rX
            }, (0, N.Bg)(l[0].skuId, l[0].subscriptionPlanId)) : null, c.length > 0 ? (0, i.jsx)(A.Z, {
              className: Z.skuCard,
              skuId: c[0].skuId,
      ...
      children: (0, i.jsxs)(u.y5t, {
        ...
        children: [(0, i.jsx)(u.$i$, {
          className: Z.divider
        }), 0 === Object.keys(l).length ? (0, i.jsxs)("div", {
