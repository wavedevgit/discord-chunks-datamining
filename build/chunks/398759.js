...
function s(e, t) {
  ...
  return R ? (R = 1 / R, e[0] = (s * P - l * N + c * C) * R, e[1] = (i * N - r * P - a * C) * R, e[2] = (m * S - h * v + g * O) * R, e[3] = (f * v - d * S - p * O) * R, e[4] = (l * A - o * P - c * T) * R, e[5] = (n * P - i * A + a * T) * R, e[6] = (h * y - _ * S - g * b) * R, e[7] = (u * S - f * y + p * b) * R, e[8] = (o * N - s * A + c * I) * R, e[9] = (r * A - n * N - a * I) * R, e[10] = (_ * v - m * y + g * E) * R, e[11] = (d * y - u * v - p * E) * R, e[12] = (s * T - o * C - l * I) * R, e[13] = (n * C - r * T + i * I) * R, e[14] = (m * b - _ * O - h * E) * R, e[15] = (u * O - d * b + f * E) * R, e) : null
}
...
function c(e, t, n) {
  var r = Math.sin(n),
    ...
    d = t[10],
    f = t[11];
  return t !== e && (e[0] = t[0], e[1] = t[1], e[2] = t[2], e[3] = t[3], e[12] = t[12], e[13] = t[13], e[14] = t[14], e[15] = t[15]), e[4] = a * i + c * r, e[5] = o * i + u * r, e[6] = s * i + d * r, e[7] = l * i + f * r, e[8] = c * i - a * r, e[9] = u * i - o * r, e[10] = d * i - s * r, e[11] = f * i - l * r, e
}
...
function u(e, t, n) {
  var r = Math.sin(n),
    ...
    d = t[10],
    f = t[11];
  return t !== e && (e[4] = t[4], e[5] = t[5], e[6] = t[6], e[7] = t[7], e[12] = t[12], e[13] = t[13], e[14] = t[14], e[15] = t[15]), e[0] = a * i - c * r, e[1] = o * i - u * r, e[2] = s * i - d * r, e[3] = l * i - f * r, e[8] = a * r + c * i, e[9] = o * r + u * i, e[10] = s * r + d * i, e[11] = l * r + f * i, e
}
