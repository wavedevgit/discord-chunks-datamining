...
let I = e => {
  let {
    ...
    onClose: r,
    trackClick: i
  } = e, a = (0, c.e7)([m.Z], () => m.Z.getApplication(t.applicationId));
  return (0, n.jsx)(u.ua7, {
    text: t.name,
    children: e => {
      var l, s;
      return (0, n.jsx)(u.P3F, (l = b({}, e), s = s = {
        className: j.similarGameImageClickable,
        onClick: async () => {
          i(f.as.ClickSimilarGame, t.applicationId), (0, u.ZDy)(() => Promise.resolve(e => (0, n.jsx)(h.default, b({
...
function y(e) {
  let {
    ...
    return e || r
  }), E = (0, c.Wu)([g.Z], () => s.map(e => g.Z.getGame(e)).filter(e => null != e).filter(e => (0, O.z6)(e.applicationId)).slice(0, 5));
  return (i.useEffect(() => {
