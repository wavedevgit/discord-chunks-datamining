...
function v(e) {
  ...
  return ((0, d.Z)({
    ...
    disableTrack: S
  }, [t.id]), S) ? null : <div className={o()(O.themed, O.chatHeaderBar)}>{<div className={O.chatHeaderBarInfo}>{<p.ZP className={O.mask} mask={p.QS.SQUIRCLE} width={24} height={24}>{null == T ? (0, r.jsx)("div", {
        ...
        })}</p.ZP>}{<c.Text className={O.chatHeaderBarText} variant={"text-md/medium"} color={"header-secondary"}>{y.intl.format(y.t.f2tNxM, {
        ...
        })}</c.Text>}</div>}{<I channelId={n.id} recipientUserId={t.id} isUserRinging={h} />}</div>
}
...
function I(e) {
  ...
  return <l.z variant={o} size={"sm"} text={a} iconPosition={"start"} icon={c.gj8} onClick={s} />
}