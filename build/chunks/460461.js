...
let T = "https:" + window.GLOBAL_ENV.MARKETING_ENDPOINT + "/servers/",
  ...
  w = () => {
    ...
    let {
      ...
      let t = Object.entries(O.z).filter(e => !B.includes(e[1].presentation)).map(e => ({
                ...
                children: [(0, r.jsxs)(l.hjN, {
                  ...
                  children: [(0, r.jsxs)(l.R94, {
                    ...
                    if (null != d) return (0, r.jsxs)(r.Fragment, {
                      ...
                      }), (null == V ? void 0 : V.discovery_splash) != null ? (0, r.jsx)(l.Text, {
                        color: "text-danger",
                        variant: "text-sm/normal",
                    ...
                    return (0, r.jsxs)(l.hjN, {
                      ...
                      }), (null == V ? void 0 : V.reasons_to_join) != null ? (0, r.jsx)(l.Text, {
                        color: "text-danger",
                        variant: "text-sm/normal",
                  ...
                  }), (null == V ? void 0 : V.is_published) != null ? (0, r.jsx)(l.Text, {
                    color: "text-danger",
                    variant: "text-sm/normal",
