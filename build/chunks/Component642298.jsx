...
function S(t) {
  ...
  let g = null == S ? true : S.verified,
    p = g ? d.Ax.CONFIRM_START : d.Ax.EMAIL_AND_PASSWORD,
    [f, m] = i.useState(p),
    [v, y] = i.useState(null),
    [h, M] = i.useState(null),
    [T, I] = i.useState(""),
    [R, O] = i.useState();
  switch (f) {
    case d.Ax.CONFIRM_START:
      return (0, r.jsx)(A.Z, {
        onNext: () => m(d.Ax.CONFIRM_CODE),
        onClose: e,
        transitionState: n
      });
    case d.Ax.CONFIRM_CODE:
      return (0, r.jsx)(E.Z, {
        error: h,
        setError: M,
        setEmailToken: y,
        onNext: () => m(d.Ax.CHANGE_EMAIL_REASONS),
        transitionState: n,
        onClose: e
      });
    case d.Ax.CHANGE_EMAIL_REASONS:
      return (0, r.jsx)(c.Z, {
        onNext: () => (o.default.track(x.rMx.USER_ACCOUNT_EMAIL_CHANGE_REASON_CONTINUE, {
          change_email_reason_enum: R
        }), null != R && N.Mr.has(R) ? m(d.Ax.CHANGE_EMAIL_WARNING) : m(d.Ax.EMAIL_AND_PASSWORD)),
        transitionState: n,
        onClose: e,
        reason: R,
        onReasonChange: O
      });
    case d.Ax.CHANGE_EMAIL_WARNING:
      return (0, r.jsx)(C.Z, {
        onNext: () => {
          o.default.track(x.rMx.USER_ACCOUNT_EMAIL_CHANGE_WARNING_CONTINUE, {
            change_email_reason_enum: R
          }), m(d.Ax.EMAIL_AND_PASSWORD)
        },
        onClose: e,
        transitionState: n
      });
    case d.Ax.EMAIL_AND_PASSWORD:
      return (0, r.jsx)(_.Z, {
        emailToken: v,
        onBack: g ? () => m(null != R && N.Mr.has(R) ? d.Ax.CHANGE_EMAIL_WARNING : d.Ax.CHANGE_EMAIL_REASONS) : null,
        onNext: t => {
