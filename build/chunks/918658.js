...
function M() {
  ...
  let M = function(e) {
    ...
    k = e => {
      ...
      null != t && (f.Z.isFullServerPreview(t) && (0, p.uL)(m.Z5c.CHANNEL(t)), _.ZP.shouldShowOnboarding(t) && (u.Z.finishOnboarding(t), (0, h.EI)(t)), (0, N.mL)(t), n && I.Z.open(t, o), o === m.pNK.ROLE_SUBSCRIPTIONS && (0, E.GN)(t))
    };
  return (0, i.jsxs)(d.qXd, {
    ...
    children: [(0, i.jsxs)(v, {
      ...
      children: [(0, i.jsx)("div", {
        className: D.noticeText,
        children: c ? b.intl.formatToPlainString(b.t["0PHahI"], {
    ...
    }), c || o === m.pNK.ROLE_SUBSCRIPTIONS ? null : (0, i.jsx)(U, {
      onClick: () => k({
        backToSettings: !1
      })
    })]
...
function L(e) {
  ...
  return (0, s.e7)([f.Z], () => f.Z.isViewingRoles(t)) ? (0, i.jsx)("div", {
