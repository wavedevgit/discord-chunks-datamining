...
function m(e) {
  let {
    locked: t
  } = e, n = (0, p.II)(), m = null == n ? true : n.id, g = null == n ? true : n.altId, O = (0, l.e7)([u.default], () => u.default.getCurrentUser()), y = null != g ? g : m, [v, E] = r.useState(new Set), [S, b] = r.useState(new Set), x = r.useCallback((e, t, n) => {
    E(n => {
      if (t) {
        if (n.has(e)) return n;
        n.add(e)
