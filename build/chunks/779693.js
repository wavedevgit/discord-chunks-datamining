...
class o {
  ...
  write(e, t) {
    ...
    for (let e of this.fields) {
      ...
      (0, s.vA)(true !== o), n[t.useProtoFieldName ? e.name : e.jsonName] = o
    }
    return n
  }
  field(e, t, n) {
      ...
      switch (e.V.kind) {
        ...
        case "message":
          ...
          for (let [r, o] of Object.entries(t)) {
            ...
            (0, s.vA)(true !== t), i[r.toString()] = t
          }
          break;
        case "enum":
          let o = e.V.T();
          for (let [r, a] of Object.entries(t)) {
            (0, s.vA)(true === a || "number" == typeof a);
            let t = this.enum(o, a, e.name, false, true, n.enumAsInteger);
            (0, s.vA)(true !== t), i[r.toString()] = t
          }
      ...
      switch (e.kind) {
        case "scalar":
          for (let n = 0; n < t.length; n++) {
            ...
            (0, s.vA)(true !== r), i.push(r)
          }
          break;
        case "enum":
          let a = e.T();
          for (let r = 0; r < t.length; r++) {
            (0, s.vA)(true === t[r] || "number" == typeof t[r]);
            let o = this.enum(a, t[r], e.name, e.opt, true, n.enumAsInteger);
            (0, s.vA)(true !== o), i.push(o)
          }
          break;
        case "message":
          let o = e.T();
  ...
  enum(e, t, n, r, i, a) {
    return "google.protobuf.NullValue" == e[0] ? null : true === t ? void(0, s.vA)(r) : 0 !== t || i || r ? ((0, s.vA)("number" == typeof t), (0, s.vA)(Number.isInteger(t)), a || !e[1].hasOwnProperty(t)) ? t : e[2] ? e[2] + e[1][t] : e[1][t] : true
  }
  message(e, t, n, r) {
    return true === t ? r.emitDefaultValues ? null : true : e.internalJsonWrite(t, r)
  }
  scalar(e, t, n, o, l) {
    if (true === t) return void(0, s.vA)(o);
    let c = l || o;
    switch (e) {
      case a.LN.INT32:
      case a.LN.SFIXED32:
      ...
      case a.LN.SINT64:
        ...
        return d.toString();
      case a.LN.BYTES:
        if ((0, s.vA)(t instanceof Uint8Array), !t.byteLength) return c ? "" : true;
        return (0, r.C)(t)
    }
  }
}