...
function S(e) {
  ...
  return <r.Fragment>{<div className={v.container}>{T((e, t) => null == t ? null : (0, r.jsx)(p.Z, {
        targetElementRef: N,
        position: "bottom",
        align: "left",
        userId: t.user.id,
      ...
      }))}</div>}{<_.Or popoutPosition={"bottom"} popoutAlign={"left"}>{(e, i, l, a) => (0, r.jsx)(d.JO, C(I({}, l), {
        ref: a,
        className: t,
        onClick: e,
        icon: o.iFz,
