...
function v(e) {
  let {
    ...
    (0, a.ZDy)(async () => {
      ...
      return n => {
        ...
        return <e transitionState={i} onClose={o} channelId={t} warningId={v} senderId={I} description={O.intl.string(O.t["/uid3t"])} safetyTipRows={T.map((e, t) => (0, r.jsx)(u.q, {
            listType: "numbered",
            index: t,
            title: e.title,
            description: e.description
          }, t))} actionRows={[(0, r.jsx)(d.JZ, {
          ...
          }, "likely-ato-mute")]} learnMore={(0, r.jsx)(a.P3F, {
            onClick: () => (0, p.qc)({
              channelId: t,
              warningId: v,
              senderId: I,
  ...
  }, [t, v, I, A]), A) ? <h.Q channelId={t} warningId={v} senderId={I} warningType={_.pj.LIKELY_ATO} header={O.intl.string(O.t.R8UsiI)} description={O.intl.string(O.t.lI8nQk)} onDismiss={S} buttons={[{
