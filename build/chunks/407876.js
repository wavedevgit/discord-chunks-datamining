/** Chunk was on web.js **/
/** chunk id: 407876, original params: e,t,n (module,exports,re quire) **/
"use strict";
require.d(exports, {
  A: () => g
...
let m = new Chunk626584.A("UploaderBase.tsx");
class g extends Chunk143236.EventEmitter {
  ...
  async compressAndCheckFileSize() {
    var e, t;
    let n = (0, l.B)(null == (t = this.files[0]) || null == (e = t.item) ? true : e.target);
