  ...
  constructor(e, t, n) {
    if (i(this, f, {
        ...
        if ("u" > typeof window) {
          ...
          A.isSetUp = true, s(this, E).call(this, window), s(this, _)[s(this, f)].instance.setup()
        }
      }), o(this, "teardown", () => {
        "u" > typeof window && (A.isSetUp = false, s(this, y).call(this, window), s(this, _)[s(this, f)].instance.teardown())
