...
function tn(e) {
  ...
  return t ? (0, r.jsx)("section", e9(e6({}, n), {
    role: "complementary"
  })) : (0, r.jsx)("main", e6({}, n))
}
let tr = i.forwardRef((e, t) => (0, r.jsx)(ti, e9(e6({}, e), {
  ref: t
})));
...
class ti extends i.PureComponent {
  ...
  render() {
    ...
    return (0, r.jsx)(p.yRy, {
      ...
      renderPopout: e => {
        ...
        return s()(null != y, "ChannelTextAreaForm > Popout > renderPopout: contentWarningProps cannot be null"), (0, r.jsx)(C.Z, e6({
          onClose: t
        }, y))
      },
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, e4(this, "isFirstChange", !0), e4(this, "editorRef", null), e4(this, "state", e9(e6({}, (0, F.eK)(eT.Z.getDraft(this.props.channel.id, eT.d.ChannelMessage))), {
      contentWarningProps: null
      ...
      switch (e.which) {
        ...
        case e2.yXg.ARROW_UP:
          if (i || l) return;
          if (e.preventDefault(), t) eD.Z.getUploadCount(r.id, eT.d.ChannelMessage) > 0 ? eG.S.dispatchToLastSubscribed(e2.CkL.FOCUS_ATTACHMENT_AREA) : eG.S.dispatchToLastSubscribed(e2.CkL.FOCUS_MESSAGES, {
            atEnd: !0
          });
          else {
            let {
      ...
      return (0, eV.v)({
        ...
        if (!m)
          if (_ === e2.zYc.SLOWMODE_COOLDOWN) return eG.S.dispatch(e2.CkL.SHAKE_APP, {
            duration: 200,
            intensity: 2
        ...
        if (x.location = e3.dy.CHAT_INPUT, o) return f.Z.sendMessage(c.id, C, void 0, x), (0, ey.A6)(c.id), {
          shouldClear: !1,
          shouldRefocus: !0
        };
        if ((0, eu.L)("ChannelChat")) {
          if (null != n && n.length > 0) {
            ...
            x.eagerDispatch = !1, x.attachmentsToUpload = n, x.onAttachmentUploadError = (e, r, i) => {
              (0, eo.A)({
                file: e,
                ...
                code: r,
                reason: i
              }) && ("" !== t && "" === eT.Z.getDraft(c.id, eT.d.ChannelMessage) && h.Z.saveDraft(c.id, t, eT.d.ChannelMessage), 0 === eD.Z.getUploadCount(c.id, eT.d.ChannelMessage) && g.Z.setUploads({
                channelId: c.id,
                uploads: n,
        ...
        } else if (null != x.scheduledTimestamp) try {
          await (0, ev.PV)({
            channelId: c.id,
            scheduledTimestamp: x.scheduledTimestamp,
            messageSendData: {
        ...
        return this.setState((0, F.H2)()), (0, ey.A6)(c.id), (0, eE.qB)(c.id, d.drafts.type), {
          shouldClear: !0,
          shouldRefocus: !0
        }
      })
    ...
    }), e4(this, "renderAttachButton", (e, t) => (0, r.jsx)(H.Z, {
      className: t,
    ...
    })), e4(this, "renderApplicationCommandIcon", (e, t, n) => (0, r.jsx)(G.Z, {
      className: n,
      command: e,
      section: t,
      channel: this.props.channel
...
class tl extends i.PureComponent {
        ...
        children: (0, r.jsx)(el.BV, {
          children: (0, r.jsxs)(eF.I3, {
            ...
            children: [(0, r.jsx)(eF.d9, {
              ...
              "aria-label": e7.intl.formatToPlainString(n, {
                channelName: i.name
              }),
              ...
              children: [(0, r.jsx)(q.Z, {
                ...
                component: (0, r.jsx)(p.nn4, {
                  children: (0, r.jsx)(p.H, {
                    children: e7.intl.format(e7.t.eTzKk5, {
                      channelName: i.name
                    })
                  })
                }),
                children: [(0, r.jsx)(ep.Z, {
                  ...
                  onSubmit: te,
                  className: a()(e8.form, {
                    [e8.formWithLoadedChatInput]: !U
                  }),
                  children: [x && (0, r.jsx)(eg.Z, {
                    channelId: i.id
  ...
  constructor(...e) {
    super(...e), e4(this, "containerDomRef", i.createRef()), e4(this, "refToChannelTextAreaFormComponent", i.createRef()), e4(this, "inputFormRef", i.createRef()), e4(this, "state", {
      textAreaFocused: !1,
      textAreaHighlighted: !1,
      currentChannelId: this.props.channel.id
    }), e4(this, "dispatchGroupRef", i.createRef()), e4(this, "appIconAnimateRef", i.createRef()), e4(this, "handleRequestFocus", e => {
      ...
      if (t) switch (e.which) {
        ...
        case e2.yXg.ARROW_RIGHT:
          n === B.Ie.NORMAL && eG.S.dispatch(e2.CkL.FOCUS_CHANNEL_TEXT_AREA, {
...
let ta = i.memo(function(e) {
  let {
    ...
    channel: t
  }), c = (0, e_.S)(eL.default.getCurrentUser(), t), [u] = (0, en.AB)(null == n ? void 0 : n.id), h = (0, $.Ux)(null == n ? void 0 : n.id), f = (0, d.e7)([eL.default], () => eL.default.getCurrentUser()), m = (0, d.e7)([ew.ZP], () => {
    var e, t, r;
    return null != f && null != (r = null == (e = ew.ZP.getMember(null != (t = null == n ? void 0 : n.id) ? t : e2.lds, null == f ? void 0 : f.id)) ? void 0 : e.isPending) && r
  }), g = (0, d.e7)([ef.Z], () => ef.Z.isEnabled()), b = (0, eb.Z)(t.id), y = (0, ei.Z)(t.id), C = (0, N.R)({
    channel: t,
    chatInputType: l
  }), v = (0, L.h9)(t.id), O = (0, ej.k)(t.id), P = (0, x.ZP)(), Z = (0, X.Z)(t.id), T = (0, K.Z)(null == Z ? void 0 : Z.wallpaperId), {
    isInitialLoading: A,
