  ...
  render() {
    ...
    return (0, r.jsx)(p.yRy, {
      ...
      renderPopout: e => {
        ...
        return s()(null != C, "ChannelTextAreaForm > Popout > renderPopout: contentWarningProps cannot be null"), (0, r.jsx)(v.Z, e0({
          onClose: t
        }, C))
      },
  ...
  constructor(...e) {
    ...
    super(...e), t = this, e$(this, "isFirstChange", !0), e$(this, "editorRef", null), e$(this, "state", e1(e0({}, (0, U.eK)(eO.Z.getDraft(this.props.channel.id, eO.d.ChannelMessage))), {
      ...
      if (null != l) {
        ...
        if (e === k.bB.APPLICATION_LAUNCHER || e === k.bB.IMAGE_RECS_MENU || e === k.bB.IMAGE_RECS_SUBMENU) {
          ...
          let {
            location: t,
            sectionName: n
          } = null !== (h = (0, eF._U)(l)) && void 0 !== h ? h : {}, r = e === k.bB.APPLICATION_LAUNCHER ? I.Z.lastShownEntrypoint() : P._b.TEXT;
          if (!await (0, S.L)({
      ...
      return (0, eL.v)({
        ...
        if (a) return f.Z.sendMessage(c.id, C, void 0, v), (0, eh.A6)(c.id), {
          shouldClear: !1,
          shouldRefocus: !0
        };
