...
function tn(e) {
  ...
  return t ? (0, r.jsx)("section", e6(e4({}, n), {
    role: "complementary"
  })) : (0, r.jsx)("main", e4({}, n))
}
let tr = e => {
...
class ti extends i.PureComponent {
  ...
  render() {
    ...
    return (0, r.jsx)(p.yRy, {
      ...
      onRequestClose: () => {
        var e;
        null == x || null == (e = x.onCancel) || e.call(x), this.setState({
      ...
      renderPopout: e => {
        ...
        return s()(null != x, "ChannelTextAreaForm > Popout > renderPopout: contentWarningProps cannot be null"), (0, r.jsx)(y.Z, e4({
          onClose: t
        }, x))
      },
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, e5(this, "isFirstChange", !0), e5(this, "editorRef", null), e5(this, "state", e6(e4({}, (0, G.eK)(eT.Z.getDraft(this.props.channel.id, eT.d.ChannelMessage))), {
      contentWarningProps: null
      ...
      switch (e.which) {
        ...
        case e2.yXg.ARROW_UP:
          if (i || l) return;
          if (e.preventDefault(), t) eL.Z.getUploadCount(r.id, eT.d.ChannelMessage) > 0 ? eF.S.dispatchToLastSubscribed(e2.CkL.FOCUS_ATTACHMENT_AREA) : eF.S.dispatchToLastSubscribed(e2.CkL.FOCUS_MESSAGES, {
            atEnd: !0
          });
          else {
            let {
      ...
      this.isFirstChange = !1, a && this.state.textValue.length < t.length && this.handleIncrementCombo(), a ? m.Z.startTyping(i) : "" === t && m.Z.stopTyping(i), l && r && (0, v.rf)(), this.setState({
        textValue: t,
        richValue: n
      })
      ...
      if (null != l) {
        if (l.inputType === k.iw.BUILT_IN_INTEGRATION) return eF.S.dispatch(e2.CkL.SHAKE_APP, {
          duration: 200,
          intensity: 2
        }), Promise.resolve({
          shouldClear: !1,
      ...
      return (0, eV.v)({
        ...
        if (!m)
          if (_ === e2.zYc.SLOWMODE_COOLDOWN) return eF.S.dispatch(e2.CkL.SHAKE_APP, {
            duration: 200,
            intensity: 2
        ...
        if (o) return f.Z.sendMessage(c.id, y, void 0, C), (0, ex.A6)(c.id), {
          shouldClear: !1,
          shouldRefocus: !0
        };
        if ((0, eu.L)("ChannelChat")) {
          if (null != n && n.length > 0) {
            let e = (0, eW.KZ)(n);
            if ((0, eW.Bf)(e, null == s ? void 0 : s.id)) return (0, ez.G)(c, e), {
              shouldClear: !1,
              shouldRefocus: !1
            };
            C.eagerDispatch = !1, C.attachmentsToUpload = n, C.onAttachmentUploadError = (e, r, i) => {
              (0, eo.A)({
                ...
                code: r,
                reason: i
              }) && ("" !== t && "" === eT.Z.getDraft(c.id, eT.d.ChannelMessage) && h.Z.saveDraft(c.id, t, eT.d.ChannelMessage), 0 === eL.Z.getUploadCount(c.id, eT.d.ChannelMessage) && g.Z.setUploads({
                channelId: c.id,
                uploads: n,
          ...
          if (null != C.scheduledTimestamp) try {
            await (0, ev.PV)({
              channelId: c.id,
        ...
        return this.setState((0, G.H2)()), (0, ex.A6)(c.id), (0, eE.qB)(c.id, d.drafts.type), {
          shouldClear: !0,
          shouldRefocus: !0
        }
      })
    ...
    }), e5(this, "renderAttachButton", (e, t) => (0, r.jsx)(H.Z, {
      className: t,
    ...
    })), e5(this, "renderApplicationCommandIcon", (e, t, n) => (0, r.jsx)(F.Z, {
      className: n,
      command: e,
      section: t,
      channel: this.props.channel
...
class tl extends i.PureComponent {
        ...
        children: (0, r.jsx)(el.BV, {
          children: (0, r.jsxs)(eG.I3, {
            ...
            children: [(0, r.jsx)(eG.d9, {
              ...
              "aria-label": e3.intl.formatToPlainString(n, {
                channelName: i.name
              }),
              ...
              children: [(0, r.jsx)(Y.Z, {
                ...
                component: (0, r.jsx)(p.nn4, {
                  children: (0, r.jsx)(p.H, {
                    children: e3.intl.format(e3.t.eTzKk5, {
                      channelName: i.name
                    })
                  })
                }),
                children: [(0, r.jsx)(ep.Z, {
                  ...
                  onSubmit: te,
                  className: a()(e7.form, {
                    [e7.formWithLoadedChatInput]: !G
                  }),
                  children: [C && (0, r.jsx)(eg.Z, {
                    channelId: i.id
                  }), i.isPrivate() ? (0, r.jsx)(e$.Z, {
                    channel: i,
                    children: F
                  }) : (0, r.jsx)(e0.Z, {
                    channel: i,
  ...
  constructor(...e) {
    super(...e), e5(this, "channelTextAreaFormRef", i.createRef()), e5(this, "inputFormRef", i.createRef()), e5(this, "state", {
      textAreaFocused: !1,
      textAreaHighlighted: !1,
      currentChannelId: this.props.channel.id
    }), e5(this, "dispatchGroupRef", i.createRef()), e5(this, "appIconAnimateRef", i.createRef()), e5(this, "handleRequestFocus", e => {
      ...
      if (t) switch (e.which) {
        case e2.yXg.ARROW_LEFT:
          n === B.Ie.SIDEBAR && eF.S.dispatch(e2.CkL.FOCUS_CHANNEL_TEXT_AREA, {
            channelId: eM.Z.getChannelId()
          });
          return;
        case e2.yXg.ARROW_RIGHT:
          n === B.Ie.NORMAL && eF.S.dispatch(e2.CkL.FOCUS_CHANNEL_TEXT_AREA, {
      ...
      return t.type === e2.d4z.DM && n ? (0, r.jsx)(e_.Z, {}) : t.isModeratorReportChannel() && t.isArchivedThread() ? (0, r.jsx)(eC.Z, {
        channelId: t.id
...
let ta = i.memo(function(e) {
  let {
    ...
    channel: t
  }), c = (0, e_.S)(eD.default.getCurrentUser(), t), [u] = (0, en.AB)(null == n ? void 0 : n.id), h = (0, $.Ux)(null == n ? void 0 : n.id), f = (0, d.e7)([eD.default], () => eD.default.getCurrentUser()), m = (0, d.e7)([ew.ZP], () => {
    var e, t, r;
    return null != f && null != (r = null == (e = ew.ZP.getMember(null != (t = null == n ? void 0 : n.id) ? t : e2.lds, null == f ? void 0 : f.id)) ? void 0 : e.isPending) && r
  }), g = (0, d.e7)([ef.Z], () => ef.Z.isEnabled()), b = (0, eb.Z)(t.id), _ = (0, ei.Z)(t.id), x = (0, N.R)({
    channel: t,
    chatInputType: l
  }), y = (0, D.h9)(t.id), v = (0, ej.k)(t.id), O = (0, C.ZP)(), P = (0, K.Z)(t.id), Z = (0, q.Z)(null == P ? void 0 : P.wallpaperId), {
    isInitialLoading: T,
