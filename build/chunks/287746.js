...
let tl = i.forwardRef((e, t) => (0, r.jsx)(ta, tt(te({}, e), {
  ref: t
})));
...
class ta extends i.PureComponent {
  ...
  render() {
    ...
    } = this.state, v = e.type === e7.d4z.GUILD_ANNOUNCEMENT && C ? (0, r.jsx)(F.Z, {
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, e9(this, "isFirstChange", !0), e9(this, "editorRef", null), e9(this, "state", tt(te({}, (0, B.eK)(eN.Z.getDraft(this.props.channel.id, eN.d.ChannelMessage))), {
      contentWarningProps: null
      ...
      switch (e.which) {
        ...
        case e7.yXg.ARROW_UP:
          if (i || l) return;
          if (e.preventDefault(), t) ek.Z.getUploadCount(r.id, eN.d.ChannelMessage) > 0 ? eH.S.dispatchToLastSubscribed(e7.CkL.FOCUS_ATTACHMENT_AREA) : eH.S.dispatchToLastSubscribed(e7.CkL.FOCUS_MESSAGES, {
            atEnd: !0
          });
          else {
            let {
      ...
      if (null != l) {
        if (l.inputType === R.iw.BUILT_IN_INTEGRATION) return eH.S.dispatch(e7.CkL.SHAKE_APP, {
          duration: 200,
          intensity: 2
        }), Promise.resolve({
          shouldClear: !1,
        ...
        if (null == e || e === R.bB.CHAT) {
          ...
          let {
            location: t,
            sectionName: n
          } = null != (_ = (0, eQ._U)(l)) ? _ : {}, r = e === R.bB.APPLICATION_LAUNCHER ? P.Z.lastShownEntrypoint() : I._b.TEXT, {
            isAuthorized: i
          } = await (0, k.L)({
            applicationId: l.applicationId,
            channel: d,
      ...
      return (0, ez.v)({
        ...
        if (null != n && n.length > 0) {
          let e = (0, eY.KZ)(n);
          if ((0, eY.Bf)(e, null == u ? void 0 : u.id)) return (0, eW.G)(d, e), {
            shouldClear: !1,
            shouldRefocus: !1
          };
          j.eagerDispatch = !1, j.attachmentsToUpload = n, j.onAttachmentUploadError = (e, r, i) => {
            (0, es.A)({
              file: e,
              ...
              code: r,
              reason: i
            }) && ("" !== t && "" === eN.Z.getDraft(d.id, eN.d.ChannelMessage) && h.Z.saveDraft(d.id, t, eN.d.ChannelMessage), 0 === ek.Z.getUploadCount(d.id, eN.d.ChannelMessage) && g.Z.setUploads({
              channelId: d.id,
              uploads: n,
...
class to extends i.PureComponent {
  ...
  constructor(...e) {
    super(...e), e9(this, "containerDomRef", i.createRef()), e9(this, "refToChannelTextAreaFormComponent", i.createRef()), e9(this, "inputFormRef", i.createRef()), e9(this, "state", {
      ...
      return t.type === e7.d4z.DM && n ? (0, r.jsx)(e_.Z, {}) : t.isModeratorReportChannel() && t.isArchivedThread() ? (0, r.jsx)(ex.Z, {
        channelId: t.id
...
let ts = i.memo(function(e) {
  let {
    ...
    channel: t
  }), c = (0, e_.S)(eL.default.getCurrentUser(), t), [u] = (0, er.AB)(null == n ? void 0 : n.id), h = (0, ee.Ux)(null == n ? void 0 : n.id), f = (0, d.e7)([eL.default], () => eL.default.getCurrentUser()), m = (0, d.e7)([ew.ZP], () => {
    var e, t, r;
    return null != f && null != (r = null == (e = ew.ZP.getMember(null != (t = null == n ? void 0 : n.id) ? t : e7.lds, null == f ? void 0 : f.id)) ? void 0 : e.isPending) && r
  }), g = (0, d.e7)([ef.Z], () => ef.Z.isEnabled()), _ = (0, eb.Z)(t.id), y = (0, el.Z)(t.id), x = (0, Z.R)({
    channel: t,
    chatInputType: l
  }), j = (0, L.Q)(t.id), S = (0, ej.k)(t.id), I = (0, C.ZP)(), T = (0, Q.Z)(t.id), N = (0, X.Z)(null == T ? void 0 : T.wallpaperId), {
    isInitialLoading: A,
