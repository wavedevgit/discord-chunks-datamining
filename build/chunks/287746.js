...
class te extends i.PureComponent {
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, e3(this, "isFirstChange", !0), e3(this, "editorRef", null), e3(this, "state", e8(e7({}, (0, G.eK)(eP.Z.getDraft(this.props.channel.id, eP.d.ChannelMessage))), {
      contentWarningProps: null
...
let tn = i.memo(function(e) {
  let {
    ...
    channel: t,
    chatInputType: l
  }), x = (0, D.h9)(t.id), v = (0, ex.k)(t.id), O = (0, C.ZP)(), S = (0, K.Z)(t.id), Z = (0, q.Z)(null == S ? void 0 : S.wallpaperId), {
    isInitialLoading: T,
