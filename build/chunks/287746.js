  ...
  constructor(...e) {
    ...
    super(...e), t = this, e$(this, "isFirstChange", !0), e$(this, "editorRef", null), e$(this, "state", e1(e0({}, (0, U.eK)(eO.Z.getDraft(this.props.channel.id, eO.d.ChannelMessage))), {
      ...
      if (null != l) {
        ...
        if (e === M.bB.APPLICATION_LAUNCHER || e === M.bB.IMAGE_RECS_MENU || e === M.bB.IMAGE_RECS_SUBMENU) {
          ...
          let {
            location: t,
            sectionName: n
          } = null != (h = (0, eH._U)(l)) ? h : {}, r = e === M.bB.APPLICATION_LAUNCHER ? I.Z.lastShownEntrypoint() : P._b.TEXT;
          if (!await (0, S.L)({
      ...
      return (0, eL.v)({
        ...
        if (!h)
          if (m === eK.zYc.SLOWMODE_COOLDOWN) return eM.S.dispatch(eK.CkL.SHAKE_APP, {
            duration: 200,
            intensity: 2
