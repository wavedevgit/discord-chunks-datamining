...
function e6(e) {
  ...
  return t ? (0, r.jsx)("section", e8(e7({}, n), {
    role: "complementary"
  })) : (0, r.jsx)("main", e7({}, n))
}
let e9 = i.forwardRef((e, t) => (0, r.jsx)(te, e8(e7({}, e), {
  refInstance: t
})));
...
class te extends i.PureComponent {
  ...
  render() {
    ...
    return (0, r.jsx)(p.yRy, {
      ...
      renderPopout: e => {
        ...
        return s()(null != y, "ChannelTextAreaForm > Popout > renderPopout: contentWarningProps cannot be null"), (0, r.jsx)(x.Z, e7({
          onClose: t
        }, y))
      },
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, e3(this, "isFirstChange", !0), e3(this, "editorRef", null), e3(this, "state", e8(e7({}, (0, G.eK)(eS.Z.getDraft(this.props.channel.id, eS.d.ChannelMessage))), {
      contentWarningProps: null
      ...
      switch (e.which) {
        ...
        case e$.yXg.ARROW_UP:
          ...
          if (e.preventDefault(), t) eR.Z.getUploadCount(r.id, eS.d.ChannelMessage) > 0 ? eU.S.dispatchToLastSubscribed(e$.CkL.FOCUS_ATTACHMENT_AREA) : eU.S.dispatchToLastSubscribed(e$.CkL.FOCUS_MESSAGES, {
            ...
            let {
              channel: e
            } = this.props, t = eT.Z.getLastChatCommandMessage(e.id), n = eT.Z.getLastEditableMessage(e.id);
      ...
      if (null != l) {
        if (l.inputType === k.iw.BUILT_IN_INTEGRATION) return eU.S.dispatch(e$.CkL.SHAKE_APP, {
          duration: 200,
          intensity: 2
        }), Promise.resolve({
          shouldClear: !1,
      ...
      return (0, eG.v)({
        ...
        if (!h)
          if (m === e$.zYc.SLOWMODE_COOLDOWN) return eU.S.dispatch(e$.CkL.SHAKE_APP, {
            duration: 200,
            intensity: 2
        ...
        if (a) return f.Z.sendMessage(c.id, y, void 0, x), (0, eb.A6)(c.id), {
          shouldClear: !1,
          shouldRefocus: !0
        };
        if (null != n && n.length > 0) {
          let e = (0, eH.KZ)(n);
          if ((0, eH.Bf)(e, null == s ? void 0 : s.id)) return (0, eF.G)(c, e), {
            shouldClear: !1,
            shouldRefocus: !1
          };
          ...
          return (0, eC.wW)(e.message), {
            shouldClear: !1,
            shouldRefocus: !1
          }
        } else null != r && r.length > 0 && "" === t ? f.Z.sendStickers(c.id, r, t, x, y.tts) : f.Z.sendMessage(c.id, y, void 0, x);
        return this.setState((0, G.H2)()), (0, eb.A6)(c.id), (0, ev.qB)(c.id, d.drafts.type), {
          shouldClear: !0,
          shouldRefocus: !0
        }
      })
...
class tt extends i.PureComponent {
        ...
        children: (0, r.jsx)(el.BV, {
          children: (0, r.jsxs)(eD.I3, {
            ...
            children: [(0, r.jsx)(eD.d9, {
              ...
              "aria-label": e0.intl.formatToPlainString(n, {
                channelName: i.name
              }),
              ...
              children: [(0, r.jsx)(Y.Z, {
                ...
                component: (0, r.jsx)(p.nn4, {
                  children: (0, r.jsx)(p.H, {
                    children: e0.intl.format(e0.t.eTzKk5, {
                      channelName: i.name
                    })
                  })
                }),
                children: [(0, r.jsx)(eu.Z, {
                  ...
                  onSubmit: e5,
                  className: o()(e1.form, {
                    [e1.formWithLoadedChatInput]: !G
                  }),
                  children: [C && (0, r.jsx)(ef.Z, {
                    channelId: i.id
                  }), i.isPrivate() ? (0, r.jsx)(eX.Z, {
                    channel: i,
                    children: F
                  }) : (0, r.jsx)(eQ.Z, {
                    channel: i,
  ...
  constructor(...e) {
    super(...e), e3(this, "channelTextAreaFormRef", i.createRef()), e3(this, "inputFormRef", i.createRef()), e3(this, "state", {
      textAreaFocused: !1,
      ...
      if (t) switch (e.which) {
        case e$.yXg.ARROW_LEFT:
          n === B.Ie.SIDEBAR && eU.S.dispatch(e$.CkL.FOCUS_CHANNEL_TEXT_AREA, {
            channelId: ew.Z.getChannelId()
          });
          return;
        case e$.yXg.ARROW_RIGHT:
          n === B.Ie.NORMAL && eU.S.dispatch(e$.CkL.FOCUS_CHANNEL_TEXT_AREA, {
      ...
      return t.type === e$.d4z.DM && n ? (0, r.jsx)(eg.Z, {}) : null != l && (0, et.J)(l) && null != i && !eA.Z.can(e$.Plq.ADMINISTRATOR, i) ? (0, r.jsx)(er.T, {
        guild: i,
        disabledUntil: l
      }) : o ? (0, r.jsx)(ee.h, {
        guild: i
...
let tn = i.memo(function(e) {
  let {
    ...
    channel: t
  }), c = (0, eg.S)(ek.default.getCurrentUser(), t), [u] = (0, en.AB)(null == n ? void 0 : n.id), h = (0, $.Ux)(null == n ? void 0 : n.id), f = (0, d.e7)([ek.default], () => ek.default.getCurrentUser()), m = (0, d.e7)([eN.ZP], () => {
    var e, t, r;
    ...
    channel: t,
    chatInputType: l
  }), x = (0, D.h9)(t.id), v = (0, ex.k)(t.id), O = (0, C.ZP)(), P = (0, K.Z)(t.id), Z = (0, q.Z)(null == P ? void 0 : P.wallpaperId), {
    isInitialLoading: T,
