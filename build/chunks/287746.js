...
let tl = i.forwardRef((e, t) => (0, r.jsx)(tc, tn(te({}, e), {
  ref: t
})));
...
class tc extends i.PureComponent {
  ...
  render() {
    ...
    } = this.state, v = e.type === e5.d4z.GUILD_ANNOUNCEMENT && y ? (0, r.jsx)(Z.Z, {
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, e9(this, "isFirstChange", !0), e9(this, "editorRef", null), e9(this, "state", tn(te({}, (0, B.eK)(eP.Z.getDraft(this.props.channel.id, eP.d.ChannelMessage))), {
      contentWarningProps: null
      ...
      let {
        ...
        onKeyDown: n,
        channel: r
      } = this.props, i = e.shiftKey || e.altKey || e.ctrlKey || e.metaKey, a = 0 !== this.state.textValue.length;
      switch (e.which) {
        case e5.yXg.DELETE:
        ...
        case e5.yXg.ARROW_UP:
          if (i || a) return;
          if (e.preventDefault(), t) eM.Z.getUploadCount(r.id, eP.d.ChannelMessage) > 0 ? eF.S.dispatchToLastSubscribed(e5.CkL.FOCUS_ATTACHMENT_AREA) : eF.S.dispatchToLastSubscribed(e5.CkL.FOCUS_MESSAGES, {
            atEnd: !0
          });
          else {
            let {
      ...
      this.isFirstChange = !1, o && this.state.textValue.length < t.length && this.handleIncrementCombo(), o ? h.Z.startTyping(i) : "" === t && h.Z.stopTyping(i), a && r && (0, O.rf)(), this.setState({
        textValue: t,
        richValue: n
      })
      ...
      if (null != a) {
        if (a.inputType === k.iw.BUILT_IN_INTEGRATION) return eF.S.dispatch(e5.CkL.SHAKE_APP, {
          duration: 200,
          intensity: 2
        }), Promise.resolve({
          shouldClear: !1,
        ...
        if (null == e || e === k.bB.CHAT) {
          ...
          let {
            location: t,
            sectionName: n
          } = null != (E = (0, eX._U)(a)) ? E : {}, r = e === k.bB.APPLICATION_LAUNCHER ? C.Z.lastShownEntrypoint() : w._b.TEXT, {
            isAuthorized: i
          } = await (0, U.L)({
            applicationId: a.applicationId,
            channel: d,
        ...
        if (a.inputType !== k.iw.BUILT_IN_TEXT) return Promise.resolve({
          shouldClear: !0,
          shouldRefocus: !0
        });
      ...
      return (0, eY.v)({
        ...
        if (I.location = e4.dy.CHAT_INPUT, null != c && (I.announcementSendOptions = c), null != l && (I.flags = (0, eV.pj)(null != (E = I.flags) ? E : 0, e5.iLy.IS_COMPONENTS_V2)), s) return p.Z.sendMessage(d.id, v, void 0, I), (0, eb.A6)(d.id), {
          shouldClear: !1,
          shouldRefocus: !0
        };
        if (null != n && n.length > 0) {
          let e = (0, eK.KZ)(n);
          if ((0, eK.Bf)(e, null == u ? void 0 : u.id)) return (0, eW.G)(d, e), {
            shouldClear: !1,
            shouldRefocus: !1
          };
          I.eagerDispatch = !1, I.attachmentsToUpload = n, I.onAttachmentUploadError = (e, r, i) => {
            (0, el.A)({
              file: e,
              ...
              code: r,
              reason: i
            }) && ("" !== t && "" === eP.Z.getDraft(d.id, eP.d.ChannelMessage) && _.Z.saveDraft(d.id, t, eP.d.ChannelMessage), 0 === eM.Z.getUploadCount(d.id, eP.d.ChannelMessage) && m.Z.setUploads({
              channelId: d.id,
              uploads: n,
...
class tu extends i.PureComponent {
        ...
        children: (0, r.jsx)(eo.BV, {
          children: (0, r.jsxs)(eZ.I3, {
            ...
            children: [(0, r.jsx)(eZ.d9, {
              ...
              "aria-label": e6.intl.formatToPlainString(n, {
                channelName: i.name
              }),
              ...
              children: [(0, r.jsx)(q.Z, {
                ...
                component: (0, r.jsx)(f.nn4, {
                  children: (0, r.jsx)(f.H, {
                    children: e6.intl.format(e6.t.eTzKk5, {
                      channelName: i.name
                    })
                  })
                }),
                children: [(0, r.jsx)(ef.Z, {
                  ...
                  children: [O && (0, r.jsx)(em.Z, {
                    channelId: i.id
                  }), i.isPrivate() ? (0, r.jsx)(e1.Z, {
                    channel: i,
                    children: H
                  }) : (0, r.jsx)(e2.Z, {
                    channel: i,
  ...
  constructor(...e) {
    super(...e), e9(this, "containerDomRef", i.createRef()), e9(this, "refToChannelTextAreaFormComponent", i.createRef()), e9(this, "inputFormRef", i.createRef()), e9(this, "state", {
      ...
      if (t) switch (e.which) {
        ...
        case e5.yXg.ARROW_RIGHT:
          n === G.Ie.NORMAL && eF.S.dispatch(e5.CkL.FOCUS_CHANNEL_TEXT_AREA, {
            channelId: ew.ZP.getCurrentSidebarChannelId(r.id)
          })
      }
      ...
      return N.__(w._b.TEXT, this.props.chatInputType, {
        applicationId: t
      })
      ...
      return t.type === e5.d4z.DM && n ? (0, r.jsx)(eE.Z, {}) : t.isModeratorReportChannel() && t.isArchivedThread() ? (0, r.jsx)(eO.Z, {
        channelId: t.id
      }) : null != a && (0, en.J)(a) && null != i && !ek.Z.can(e5.Plq.ADMINISTRATOR, i) ? (0, r.jsx)(ei.T, {
        guild: i,
        disabledUntil: a
      }) : o ? (0, r.jsx)(et.h, {
        guild: i
...
let td = i.memo(function(e) {
  let {
    ...
    channel: t
  }), c = (0, eE.S)(eU.default.getCurrentUser(), t), [u] = (0, er.AB)(null == n ? void 0 : n.id), _ = (0, ee.Ux)(null == n ? void 0 : n.id), p = (0, d.e7)([eU.default], () => eU.default.getCurrentUser()), h = (0, d.e7)([eL.ZP], () => {
    var e, t, r;
    return null != p && null != (r = null == (e = eL.ZP.getMember(null != (t = null == n ? void 0 : n.id) ? t : e5.lds, null == p ? void 0 : p.id)) ? void 0 : e.isPending) && r
  }), m = _ && !h, E = (0, d.e7)([ep.Z], () => ep.Z.isEnabled()), b = (0, eg.Z)(t.id), O = (0, ea.Z)(t.id), I = (0, R.R)({
    channel: t,
    chatInputType: a
  }), N = (0, A.Z)(t), w = (0, eI.k)(t.id), P = (0, y.ZP)(), D = (0, X.Z)(t.id), L = (0, $.Z)(null == D ? void 0 : D.wallpaperId), {
    isInitialLoading: x,
