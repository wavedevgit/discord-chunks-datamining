    ...
    super(...e), t = this, e4(this, "isFirstChange", !0), e4(this, "editorRef", null), e4(this, "state", e9(e6({}, (0, F.eK)(eT.Z.getDraft(this.props.channel.id, eT.d.ChannelMessage))), {
      ...
      switch (e.which) {
        ...
        case e2.yXg.ARROW_UP:
          if (i || l) return;
          if (e.preventDefault(), t) eL.Z.getUploadCount(r.id, eT.d.ChannelMessage) > 0 ? eG.S.dispatchToLastSubscribed(e2.CkL.FOCUS_ATTACHMENT_AREA) : eG.S.dispatchToLastSubscribed(e2.CkL.FOCUS_MESSAGES, {
            atEnd: !0
          });
          else {
            let {
...
class ta extends i.PureComponent {
  ...
  constructor(...e) {
    super(...e), e4(this, "channelTextAreaFormRef", i.createRef()), e4(this, "inputFormRef", i.createRef()), e4(this, "state", {
      textAreaFocused: !1,
...
let to = i.memo(function(e) {
  let {
    ...
    channel: t,
    chatInputType: l
  }), v = (0, D.h9)(t.id), O = (0, ej.k)(t.id), P = (0, x.ZP)(), Z = (0, X.Z)(t.id), T = (0, K.Z)(null == Z ? void 0 : Z.wallpaperId), {
    isInitialLoading: A,
