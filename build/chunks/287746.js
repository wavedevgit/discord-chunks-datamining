  ...
  render() {
    ...
    return (0, r.jsx)(p.yRy, {
      ...
      renderPopout: e => {
        ...
        return s()(null != x, "ChannelTextAreaForm > Popout > renderPopout: contentWarningProps cannot be null"), (0, r.jsx)(C.Z, e8({
          onClose: t
        }, x))
      },
    ...
    super(...e), t = this, e7(this, "isFirstChange", !0), e7(this, "editorRef", null), e7(this, "state", e5(e8({}, (0, G.eK)(eZ.Z.getDraft(this.props.channel.id, eZ.d.ChannelMessage))), {
      ...
      switch (e.which) {
        ...
        case e0.yXg.ARROW_UP:
          if (i || l) return;
          if (e.preventDefault(), t) eM.Z.getUploadCount(r.id, eZ.d.ChannelMessage) > 0 ? eB.S.dispatchToLastSubscribed(e0.CkL.FOCUS_ATTACHMENT_AREA) : eB.S.dispatchToLastSubscribed(e0.CkL.FOCUS_MESSAGES, {
            atEnd: !0
          });
          else {
            let {
      ...
      if (null != l) {
        if (l.inputType === M.iw.BUILT_IN_INTEGRATION) return eB.S.dispatch(e0.CkL.SHAKE_APP, {
          duration: 200,
          intensity: 2
        }), Promise.resolve({
          shouldClear: !1,
      ...
      return (0, eF.v)({
        ...
        if (o) return f.Z.sendMessage(c.id, x, void 0, C), (0, eb.A6)(c.id), {
          shouldClear: !1,
          shouldRefocus: !0
        };
...
let ti = i.memo(function(e) {
  let {
    ...
    channel: t
  }), c = (0, eg.S)(ek.default.getCurrentUser(), t), [u] = (0, en.AB)(null == n ? void 0 : n.id), h = (0, $.Ux)(null == n ? void 0 : n.id), f = (0, d.e7)([ek.default], () => ek.default.getCurrentUser()), m = (0, d.e7)([eT.ZP], () => {
    var e, t, r;
    ...
    channel: t,
    chatInputType: l
  }), C = (0, D.h9)(t.id), v = (0, ey.k)(t.id), O = (0, y.ZP)(), P = (0, K.Z)(t.id), Z = (0, q.Z)(null == P ? void 0 : P.wallpaperId), {
    isInitialLoading: T,
