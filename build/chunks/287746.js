...
function e7(e) {
  ...
  return t ? (0, r.jsx)("section", e1(e0({}, n), {
    role: "complementary"
  })) : (0, r.jsx)("main", e0({}, n))
}
...
class e6 extends i.PureComponent {
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, e$(this, "isFirstChange", !0), e$(this, "editorRef", null), e$(this, "state", e1(e0({}, (0, B.eK)(eO.Z.getDraft(this.props.channel.id, eO.d.ChannelMessage))), {
      contentWarningProps: null
      ...
      switch (e.which) {
        ...
        case eK.yXg.ARROW_UP:
          if (i || l) return;
          if (e.preventDefault(), t) eN.Z.getUploadCount(r.id, eO.d.ChannelMessage) > 0 ? ek.S.dispatchToLastSubscribed(eK.CkL.FOCUS_ATTACHMENT_AREA) : ek.S.dispatchToLastSubscribed(eK.CkL.FOCUS_MESSAGES, {
            atEnd: !0
          });
          else {
            let {
              channel: e
            } = this.props, t = eS.Z.getLastChatCommandMessage(e.id), n = eS.Z.getLastEditableMessage(e.id);
      ...
      if (null != l) {
        if (l.inputType === R.iw.BUILT_IN_INTEGRATION) return ek.S.dispatch(eK.CkL.SHAKE_APP, {
          duration: 200,
          intensity: 2
        }), Promise.resolve({
          shouldClear: !1,
        ...
        if (null == e || e === R.bB.CHAT) {
          ...
          let {
            location: t,
            sectionName: n
          } = null != (h = (0, eF._U)(l)) ? h : {}, r = e === R.bB.APPLICATION_LAUNCHER ? S.Z.lastShownEntrypoint() : P._b.TEXT, {
            isAuthorized: i
          } = await (0, D.L)({
            applicationId: l.applicationId,
            channel: c,
      ...
      return (0, eL.v)({
        ...
        if (!h)
          if (m === eK.zYc.SLOWMODE_COOLDOWN) return ek.S.dispatch(eK.CkL.SHAKE_APP, {
            duration: 200,
            intensity: 2
        ...
        if (null != n && n.length > 0) {
          let e = (0, eU.KZ)(n);
          if ((0, eU.Bf)(e, null == s ? void 0 : s.id)) return (0, eD.G)(c, e), {
            shouldClear: !1,
            shouldRefocus: !1
          };
        ...
        return this.setState((0, B.H2)()), (0, eh.A6)(c.id), (0, e_.qB)(c.id, d.drafts.type), {
          shouldClear: !0,
          shouldRefocus: !0
        }
      })
    ...
    })), e$(this, "renderApplicationCommandIcon", (e, t, n) => (0, r.jsx)(G.Z, {
      className: n,
      command: e,
      section: t,
      channel: this.props.channel
...
class e8 extends i.PureComponent {
  ...
  render() {
    ...
    let k = (0, r.jsx)("div", {
      ...
      M = (0, r.jsxs)("div", {
        ...
        }), S ? null : this.renderAppLauncherButton(), I ? null : this.renderAppCommandButton()]
      }),
      L = O && E,
      D = L && E ? k : M,
      B = o()({
        ...
        children: (0, r.jsx)(et.BV, {
          children: (0, r.jsxs)(eR.I3, {
            ...
            children: [(0, r.jsx)(eR.d9, {
              ...
              isSidebar: R,
              className: o()(eQ.chatContent, {
                [eQ.hasWallpaper]: null == T ? void 0 : T.isViewable
              }),
              ...
              children: [(0, r.jsx)(z.Z, {
                ...
                component: (0, r.jsx)(p.nn4, {
                  children: (0, r.jsx)(p.H, {
                    children: eX.intl.format(eX.t.eTzKk5, {
                      channelName: n.name
                    })
                  })
                }),
                children: [(0, r.jsx)(eo.Z, {
                  ...
                  onSubmit: e2,
                  className: o()(eQ.form, {
                    [eQ.formWithLoadedChatInput]: !L
                  }),
                  children: [C && (0, r.jsx)(eu.Z, {
                    channelId: n.id
                  }), n.isPrivate() ? (0, r.jsx)(eW.Z, {
                    channel: n,
                    children: D
                  }) : (0, r.jsx)(eY.Z, {
                    channel: n,
  ...
  constructor(...e) {
    super(...e), e$(this, "channelTextAreaFormRef", i.createRef()), e$(this, "inputFormRef", i.createRef()), e$(this, "state", {
      textAreaFocused: !1,
      textAreaHighlighted: !1,
      currentChannelId: this.props.channel.id
    }), e$(this, "dispatchGroupRef", i.createRef()), e$(this, "appIconAnimateRef", i.createRef()), e$(this, "handleRequestFocus", e => {
      ...
      if (t) switch (e.which) {
        case eK.yXg.ARROW_LEFT:
          n === U.Ie.SIDEBAR && ek.S.dispatch(eK.CkL.FOCUS_CHANNEL_TEXT_AREA, {
            channelId: eZ.Z.getChannelId()
          });
          return;
        case eK.yXg.ARROW_RIGHT:
          n === U.Ie.NORMAL && ek.S.dispatch(eK.CkL.FOCUS_CHANNEL_TEXT_AREA, {
      ...
      return I.__(P._b.TEXT, this.props.chatInputType, {
        applicationId: t
      })
      ...
      return t.type === eK.d4z.DM && n ? (0, r.jsx)(ep.Z, {}) : null != l && (0, Q.J)(l) && null != i && !eP.Z.can(eK.Plq.ADMINISTRATOR, i) ? (0, r.jsx)($.T, {
        guild: i,
        disabledUntil: l
      }) : o ? (0, r.jsx)(X.h, {
        guild: i
...
let e5 = i.memo(function(e) {
  let {
    ...
    channel: t
  }), c = (0, ep.S)(eT.default.getCurrentUser(), t), [u] = (0, J.AB)(null == n ? void 0 : n.id), h = (0, K.Ux)(null == n ? void 0 : n.id), f = (0, d.e7)([eT.default], () => eT.default.getCurrentUser()), m = (0, d.e7)([eI.ZP], () => {
    var e, t, r;
    return null != f && null != (r = null == (e = eI.ZP.getMember(null != (t = null == n ? void 0 : n.id) ? t : eK.lds, null == f ? void 0 : f.id)) ? void 0 : e.isPending) && r
  }), g = (0, d.e7)([es.Z], () => es.Z.isEnabled()), b = (0, ed.Z)(t.id), _ = (0, ee.Z)(t.id), y = (0, Z.R)({
    channel: t,
    chatInputType: l
  }), C = (0, L.h9)(t.id), x = (0, eg.k)(t.id), j = (0, W.Z)(t.id), {
    isInitialLoading: I,
