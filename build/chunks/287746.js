...
class tn extends i.PureComponent {
  ...
  render() {
    ...
    return (0, r.jsx)(p.yRy, {
      ...
      renderPopout: e => {
        ...
        return s()(null != C, "ChannelTextAreaForm > Popout > renderPopout: contentWarningProps cannot be null"), (0, r.jsx)(y.Z, e5({
          onClose: t
        }, C))
      },
  ...
  constructor(...e) {
      ...
      if (null != l) {
        ...
        if (null == e || e === R.bB.CHAT) {
          ...
          let {
            location: t,
            sectionName: n
          } = null != (m = (0, eY._U)(l)) ? m : {}, r = e === R.bB.APPLICATION_LAUNCHER ? P.Z.lastShownEntrypoint() : S._b.TEXT, {
            isAuthorized: i
          } = await (0, D.L)({
            applicationId: l.applicationId,
            channel: c,
        ...
        if (null != n && n.length > 0) {
          ...
          C.eagerDispatch = !1, C.attachmentsToUpload = n, C.onAttachmentUploadError = (e, r, i) => {
            (0, ea.A)({
              ...
              code: r,
              reason: i
            }) && ("" !== t && "" === eZ.Z.getDraft(c.id, eZ.d.ChannelMessage) && h.Z.saveDraft(c.id, t, eZ.d.ChannelMessage), 0 === ek.Z.getUploadCount(c.id, eZ.d.ChannelMessage) && g.Z.setUploads({
              channelId: c.id,
              uploads: n,
    ...
    }), e8(this, "renderAttachButton", (e, t) => (0, r.jsx)(G.Z, {
      className: t,
...
let ti = i.memo(function(e) {
  let {
    ...
    channel: t
  }), c = (0, eg.S)(eM.default.getCurrentUser(), t), [u] = (0, et.AB)(null == n ? void 0 : n.id), h = (0, J.Ux)(null == n ? void 0 : n.id), f = (0, d.e7)([eM.default], () => eM.default.getCurrentUser()), m = (0, d.e7)([eT.ZP], () => {
    var e, t, r;
    ...
    channel: t,
    chatInputType: l
  }), j = (0, L.h9)(t.id), I = (0, ex.k)(t.id), S = (0, C.ZP)(), N = (0, K.Z)(t.id), T = (0, q.Z)(null == N ? void 0 : N.wallpaperId), {
    isInitialLoading: A,
