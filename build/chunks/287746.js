...
let e7 = i.forwardRef((e, t) => (0, r.jsx)(e4, e0(e$({}, e), {
  refInstance: t
})));
...
class e4 extends i.PureComponent {
  ...
  render() {
    ...
    return (0, r.jsx)(p.yRy, {
      ...
      renderPopout: e => {
        ...
        return s()(null != C, "ChannelTextAreaForm > Popout > renderPopout: contentWarningProps cannot be null"), (0, r.jsx)(y.Z, e$({
          onClose: t
        }, C))
      },
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, eJ(this, "isFirstChange", !0), eJ(this, "editorRef", null), eJ(this, "state", e0(e$({}, (0, U.eK)(ej.Z.getDraft(this.props.channel.id, ej.d.ChannelMessage))), {
      contentWarningProps: null
      ...
      switch (e.which) {
        ...
        case eq.yXg.ARROW_UP:
          if (i || l) return;
          if (e.preventDefault(), t) eP.Z.getUploadCount(r.id, ej.d.ChannelMessage) > 0 ? eR.S.dispatchToLastSubscribed(eq.CkL.FOCUS_ATTACHMENT_AREA) : eR.S.dispatchToLastSubscribed(eq.CkL.FOCUS_MESSAGES, {
            atEnd: !0
          });
          else {
            let {
              channel: e
            } = this.props, t = eN.Z.getLastChatCommandMessage(e.id), n = eN.Z.getLastEditableMessage(e.id);
      ...
      if (null != l) {
        if (l.inputType === k.iw.BUILT_IN_INTEGRATION) return eR.S.dispatch(eq.CkL.SHAKE_APP, {
          duration: 200,
          intensity: 2
        }), Promise.resolve({
          shouldClear: !1,
        ...
        if (e === k.bB.APPLICATION_LAUNCHER || e === k.bB.IMAGE_RECS_MENU || e === k.bB.IMAGE_RECS_SUBMENU) {
          ...
          let {
            location: t,
            sectionName: n
          } = null != (h = (0, eB._U)(l)) ? h : {}, r = e === k.bB.APPLICATION_LAUNCHER ? I.Z.lastShownEntrypoint() : S._b.TEXT;
          if (!await (0, P.L)({
      ...
      return (0, eM.v)({
        ...
        if (!h)
          if (m === eq.zYc.SLOWMODE_COOLDOWN) return eR.S.dispatch(eq.CkL.SHAKE_APP, {
            duration: 200,
            intensity: 2
        ...
        if (a) return f.Z.sendMessage(c.id, C, void 0, y), (0, ep.A6)(c.id), {
          shouldClear: !1,
          shouldRefocus: !0
        };
        if (null != n && n.length > 0) {
          let e = (0, eD.KZ)(n);
          if ((0, eD.Bf)(e, null == s ? void 0 : s.id)) return (0, eL.G)(c, e), {
            shouldClear: !1,
            shouldRefocus: !1
          };
    ...
    }), eJ(this, "renderAttachButton", (e, t) => (0, r.jsx)(H.Z, {
      className: t,
    ...
    })), eJ(this, "renderApplicationCommandIcon", (e, t, n) => (0, r.jsx)(B.Z, {
      className: n,
      command: e,
      section: t,
      channel: this.props.channel
...
class e6 extends i.PureComponent {
        ...
        children: (0, r.jsx)(ee.BV, {
          children: (0, r.jsxs)(ew.I3, {
            ...
            children: [(0, r.jsx)(ew.d9, {
              ...
              "aria-label": eK.NW.formatToPlainString(t, {
                channelName: n.name
              }),
              ...
              children: [(0, r.jsx)(V.Z, {
                ...
                component: (0, r.jsx)(p.nn4, {
                  children: (0, r.jsx)(p.H, {
                    children: eK.NW.format(eK.t.eTzKk5, {
                      channelName: n.name
                    })
                  })
                }),
                children: [(0, r.jsx)(el.Z, {
                  ...
                  onSubmit: e1,
                  className: o()(eX.form, {
                    [eX.formWithLoadedChatInput]: !M
                  }),
                  children: [y && (0, r.jsx)(ec.Z, {
                    channelId: n.id
                  }), n.isPrivate() ? (0, r.jsx)(eV.Z, {
                    channel: n,
                    children: L
                  }) : (0, r.jsx)(ez.Z, {
                    channel: n,
  ...
  constructor(...e) {
    super(...e), eJ(this, "channelTextAreaFormRef", i.createRef()), eJ(this, "inputFormRef", i.createRef()), eJ(this, "state", {
      textAreaFocused: !1,
      textAreaHighlighted: !1,
      currentChannelId: this.props.channel.id
    }), eJ(this, "dispatchGroupRef", i.createRef()), eJ(this, "appIconAnimateRef", i.createRef()), eJ(this, "handleRequestFocus", e => {
      ...
      if (t) switch (e.which) {
        case eq.yXg.ARROW_LEFT:
          n === W.Ie.SIDEBAR && eR.S.dispatch(eq.CkL.FOCUS_CHANNEL_TEXT_AREA, {
            channelId: eS.Z.getChannelId()
          });
          return;
        case eq.yXg.ARROW_RIGHT:
          n === W.Ie.NORMAL && eR.S.dispatch(eq.CkL.FOCUS_CHANNEL_TEXT_AREA, {
      ...
      return N.__(S._b.TEXT, this.props.chatInputType, {
        applicationId: t
      })
      ...
      return t.type === eq.d4z.DM && n ? (0, r.jsx)(ed.Z, {}) : null != l && (0, X.J)(l) && null != i && !eI.Z.can(eq.Plq.ADMINISTRATOR, i) ? (0, r.jsx)(J.T, {
        guild: i,
        disabledUntil: l
      }) : o ? (0, r.jsx)(K.h, {
        guild: i
...
let e8 = i.memo(function(e) {
  let {
    ...
    channel: t
  }), c = (0, ed.S)(eZ.default.getCurrentUser(), t), [u] = (0, Q.AB)(null == n ? void 0 : n.id), h = (0, q.Ux)(null == n ? void 0 : n.id), f = (0, d.e7)([eZ.default], () => eZ.default.getCurrentUser()), m = (0, d.e7)([eE.ZP], () => {
    var e, t, r;
