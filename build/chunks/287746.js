      ...
      if (null != l) {
        ...
        if (null == e || e === M.bB.CHAT) {
          ...
          let {
            location: t,
            sectionName: n
          } = null != (_ = (0, eQ._U)(l)) ? _ : {}, r = e === M.bB.APPLICATION_LAUNCHER ? I.Z.lastShownEntrypoint() : Z._b.TEXT, {
            isAuthorized: i
          } = await (0, L.L)({
            applicationId: l.applicationId,
            channel: d,
...
let ts = i.memo(function(e) {
  let {
    ...
    channel: t,
    chatInputType: l
  }), j = (0, S.Z)(t), P = (0, ej.k)(t.id), Z = (0, C.ZP)(), N = (0, Q.Z)(t.id), A = (0, X.Z)(null == N ? void 0 : N.wallpaperId), {
    isInitialLoading: w,
