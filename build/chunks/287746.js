...
class tc extends i.PureComponent {
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, e9(this, "isFirstChange", !0), e9(this, "editorRef", null), e9(this, "state", tn(te({}, (0, B.eK)(ew.Z.getDraft(this.props.channel.id, ew.d.ChannelMessage))), {
      contentWarningProps: null
      ...
      this.isFirstChange = !1, a && this.state.textValue.length < t.length && this.handleIncrementCombo(), a ? h.Z.startTyping(i) : "" === t && h.Z.stopTyping(i), o && r && (0, O.rf)(), this.setState({
        textValue: t,
        richValue: n
      })
...
let td = i.memo(function(e) {
  let {
    ...
    channel: t,
    chatInputType: o
  }), N = (0, A.Z)(t), R = (0, eI.k)(t.id), w = (0, y.ZP)(), D = (0, Q.Z)(t.id), L = (0, X.Z)(null == D ? void 0 : D.wallpaperId), {
    isInitialLoading: x,
