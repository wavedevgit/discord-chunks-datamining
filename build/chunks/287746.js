    ...
    super(...e), t = this, eJ(this, "isFirstChange", !0), eJ(this, "editorRef", null), eJ(this, "state", e0(e$({}, (0, U.eK)(ej.Z.getDraft(this.props.channel.id, ej.d.ChannelMessage))), {
      ...
      switch (e.which) {
        ...
        case eq.yXg.ARROW_UP:
          if (i || l) return;
          if (e.preventDefault(), t) eS.Z.getUploadCount(r.id, ej.d.ChannelMessage) > 0 ? eR.S.dispatchToLastSubscribed(eq.CkL.FOCUS_ATTACHMENT_AREA) : eR.S.dispatchToLastSubscribed(eq.CkL.FOCUS_MESSAGES, {
            atEnd: !0
          });
          else {
            let {
      ...
      if (null != l) {
        ...
        if (e === k.bB.APPLICATION_LAUNCHER || e === k.bB.IMAGE_RECS_MENU || e === k.bB.IMAGE_RECS_SUBMENU) {
          ...
          let {
            location: t,
            sectionName: n
          } = null != (h = (0, eB._U)(l)) ? h : {}, r = e === k.bB.APPLICATION_LAUNCHER ? I.Z.lastShownEntrypoint() : P._b.TEXT;
          if (!await (0, S.L)({
