...
let te = i.forwardRef((e, t) => (0, r.jsx)(tt, e5(e8({}, e), {
  refInstance: t
})));
  ...
  constructor(...e) {
    ...
    super(...e), t = this, e7(this, "isFirstChange", !0), e7(this, "editorRef", null), e7(this, "state", e5(e8({}, (0, G.eK)(eZ.Z.getDraft(this.props.channel.id, eZ.d.ChannelMessage))), {
      ...
      if (null != l) {
        ...
        if (null == e || e === k.bB.CHAT) {
          ...
          let {
            location: t,
            sectionName: n
          } = null != (h = (0, eY._U)(l)) ? h : {}, r = e === k.bB.APPLICATION_LAUNCHER ? P.Z.lastShownEntrypoint() : Z._b.TEXT, {
            isAuthorized: i
          } = await (0, U.L)({
            applicationId: l.applicationId,
            channel: c,
      ...
      return (0, eF.v)({
        ...
        if (a) return f.Z.sendMessage(c.id, x, void 0, y), (0, eb.A6)(c.id), {
          shouldClear: !1,
          shouldRefocus: !0
        };
...
let tr = i.memo(function(e) {
  let {
    ...
    channel: t,
    chatInputType: l
  }), y = (0, D.h9)(t.id), v = (0, eC.k)(t.id), O = (0, C.ZP)(), S = (0, K.Z)(t.id), Z = (0, q.Z)(null == S ? void 0 : S.wallpaperId), {
    isInitialLoading: T,
