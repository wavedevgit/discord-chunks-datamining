      ...
      if (null != l) {
        ...
        if (null == e || e === R.bB.CHAT) {
          ...
          let {
            location: t,
            sectionName: n
          } = null != (h = (0, eF._U)(l)) ? h : {}, r = e === R.bB.APPLICATION_LAUNCHER ? P.Z.lastShownEntrypoint() : S._b.TEXT, {
            isAuthorized: i
          } = await (0, D.L)({
            applicationId: l.applicationId,
            channel: c,
...
class e8 extends i.PureComponent {
  ...
  render() {
    ...
    let k = (0, r.jsx)("div", {
      ...
      M = (0, r.jsxs)("div", {
        ...
        }), P ? null : this.renderAppLauncherButton(), I ? null : this.renderAppCommandButton()]
      }),
      L = O && E,
      D = L && E ? k : M,
      B = o()({
  ...
  constructor(...e) {
    super(...e), e$(this, "channelTextAreaFormRef", i.createRef()), e$(this, "inputFormRef", i.createRef()), e$(this, "state", {
      ...
      return I.__(S._b.TEXT, this.props.chatInputType, {
        applicationId: t
      })
      ...
      return t.type === eK.d4z.DM && n ? (0, r.jsx)(ep.Z, {}) : null != l && (0, Q.J)(l) && null != i && !eS.Z.can(eK.Plq.ADMINISTRATOR, i) ? (0, r.jsx)($.T, {
        guild: i,
        disabledUntil: l
      }) : o ? (0, r.jsx)(X.h, {
        guild: i
