...
let E = e => {
  let {
    location: t
  } = e, n = (0, l.e7)([p.default], () => p.default.isAuthenticated()), E = (0, l.e7)([d.Z], () => d.Z.hasLoadedExperiments), v = (0, g.oK)("RSL - Landing Page"), [b, j] = i.useState(false), [I, N] = i.useState(_.intl.string(_.t["9exy+V"])), [S, O] = i.useState(true), y = e => {
    switch (e) {
  ...
  return i.useEffect(() => {
    ...
    let e = async e => {
      ...
      try {
        ...
        null != n ? N(_.intl.string(_.t.e6mZMt)) : y(null == (t = n.body) ? true : t.code)
      } catch (e) {
