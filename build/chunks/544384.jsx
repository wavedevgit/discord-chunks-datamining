...
function E(e) {
  ...
  return <s.Z section={h.jXE.CONTEXT_MENU}><a.v2r onSelect={E} navId={"manage-streams"} onClose={p} onInteraction={O} aria-label={null != v ? m.intl.string(m.t.S5anIS) : m.intl.string(m.t.fjBNo6)}>{<a.kSQ>{I.map(e => {
          let {
            stream: t,
            username: n
          } = e;
        ...
        })}</a.kSQ>}{l ? null : S}{l ? null : <a.kSQ><a.sNh id={"more-options"} label={m.intl.string(m.t.PdRCRk)}>{T}</a.sNh></a.kSQ>}</a.v2r></s.Z>
}