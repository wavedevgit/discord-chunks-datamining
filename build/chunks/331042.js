...
let ed = 880,
  ef = e => null != e ? ea.intl.format(ea.t["4kp0AA"], {
    itemName: e
  }) : null,
  e_ = e => {
    let {
      product: t,
      pairedProduct: n
    } = e, [i] = t.items, a = null == n ? void 0 : n.items[0], o = (0, f.e7)([P.default], () => {
    ...
    })).with(u.Z.AVATAR_DECORATION, () => (s()(i.type === u.Z.AVATAR_DECORATION, "ts-match already checked the type"), null != a && a.type === u.Z.AVATAR_DECORATION) ? (0, r.jsxs)("div", {
  ...
  eh = e => {
    ...
    return null != t ? (0, r.jsx)(ep, eu(el({}, e), {
      displayOptions: t
    })) : (0, r.jsx)(e_, el({}, e))
  },
  em = e => {
    let {
      ...
      itemConsumed: y = !0,
      purchaseType: I = et.o8.FIAT
    } = e, T = (0, j.o)("CollectiblesCollectedModal"), S = (0, J.W)(t, h), N = (0, f.e7)([P.default], () => {
      var e, t;
    ...
    function U() {
      ...
      if (S.skuId === d.a.PREMIUM_TIER_2_3_DAY) {
        let e = ea.intl.formatToPlainString(ea.t["Cz1G9/"], {
          days: 3
        });
        return y ? (0, r.jsx)(A.j, {
          duration: e,
          onClose: n
        }) : (0, r.jsx)(A.h, {
          duration: e,
  ...
  eE = e => {
    ...
    } = e, _ = (0, U.ed)("CollectiblesCollectedModal"), h = (0, B.k)(n), m = (0, B.k)(a), g = null != a, E = (0, v.Z)(), b = null == E || null == (t = E.giftPurchaseConfirmation) ? void 0 : t.rewardCollectedText(), {
      handleUseNow: y,
      isApplying: O
    } = (0, G.W)({
      product: n,
    ...
    let A = i.useMemo(() => null != l ? l : et.Vt.ORB_PROFILE_BADGE === n.skuId ? ea.intl.string(ei.default.nvaTQk) : g ? ea.intl.format(new Date < et.a$ ? ea.t.BhGU09 : ea.t.Jfv5Qk, {
        purchased_item: h,
        suggested_item: m
      }) : _ && !f ? ea.intl.string(ea.t.IMffmp) : ea.intl.format(ea.t.YNaxMj, {
        itemName: h
      }), [l, n.skuId, g, _, f, h, m]),
      P = i.useMemo(() => null != d ? d : et.Vt.ORB_PROFILE_BADGE === n.skuId ? ea.intl.string(ei.default.UnPGio) : g ? ea.intl.format(new Date < et.a$ ? ea.t["1jBC0t"] : ea.t.qSrp39, {
        purchased_item: h,
        suggested_item: m
      ...
      }).with(u.Z.AVATAR_DECORATION, () => f && null != b ? b : ef(h)).otherwise(() => ef(h)), [d, n, g, h, m, f, b]),
      w = i.useMemo(() => et.Vt.ORB_PROFILE_BADGE === n.skuId ? (0, r.jsxs)(p.hE2, {
        fullWidth: !0,
  ...
  eb = e => {
    ...
    } = e, o = (0, U.hv)("CollectiblesShopGiftButton"), s = i.useCallback(e => {
      e.stopPropagation(), (0, y.Z)({
        skuId: n.skuId,
        isGift: !0,
  ...
  ey = e => {
    let {
      ...
      if (n(), (0, h.xf)(), c(), t.type === u.Z.AVATAR_DECORATION) {
        s()(d.type === u.Z.AVATAR_DECORATION, "product type and item type are the same"), (0, b.ps)({
  ...
  eO = e => {
    ...
    }, [T, b.skuId, b.items, S]), (0, r.jsxs)(r.Fragment, {
