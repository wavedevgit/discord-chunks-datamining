...
var r = n(255367),
  ...
  ee = n(854402);
let et = 880,
  en = e => null != e ? $.intl.format($.t["4kp0AA"], {
    itemName: e
  }) : null,
  er = e => {
    let {
      ...
      itemConsumed: v = !0,
      purchaseType: I = q.o8.FIAT
    } = e, S = (0, x.o)("CollectiblesCollectedModal"), A = (0, W.W)(t, E), C = (0, d.e7)([N.default], () => {
      var e, t;
      ...
      confettiColors: w
    } = (0, G.Z)(A.styles), D = (0, d.e7)([p.Z], () => p.Z.useReducedMotion), L = i.useRef(null), {
      analyticsLocations: k
    } = (0, m.ZP)([...l, h.Z.COLLECTIBLES_COLLECTED_MODAL]), {
    ...
    function U() {
      ...
      if (A.skuId === u.a.PREMIUM_TIER_2_3_DAY) {
        let e = $.intl.formatToPlainString($.t["Cz1G9/"], {
          days: 3
        });
  ...
  ea = e => {
    ...
    } = e, p = (0, k.ed)("CollectiblesCollectedModal"), h = (0, j.k)(n), m = (0, j.k)(a), g = null != a, E = (0, y.Z)(), b = null == E || null == (t = E.giftPurchaseConfirmation) ? void 0 : t.rewardCollectedText(), {
      handleUseNow: O,
      isApplying: v
    } = (0, M.W)({
      product: n,
    ...
    } = (0, U.Rj)(n), C = (0, L.x6)(n) ? null != T && null != N : null != T || null != N || n.type === c.Z.NAMEPLATE;
    i.useEffect(() => {
    ...
    let P = i.useMemo(() => null != u ? u : q.Vt.ORB_PROFILE_BADGE === n.skuId ? $.intl.string(J.default.nvaTQk) : g ? $.intl.format(new Date < q.a$ ? $.t.BhGU09 : $.t.Jfv5Qk, {
      ...
      w = i.useMemo(() => null != d ? d : q.Vt.ORB_PROFILE_BADGE === n.skuId ? $.intl.string(J.default.UnPGio) : g ? $.intl.format(new Date < q.a$ ? $.t["1jBC0t"] : $.t.qSrp39, {
        purchased_item: h,
        suggested_item: m
      }) : (0, l.EQ)(null == n ? void 0 : n.type).with(c.Z.BUNDLE, () => {
        let {
          itemOneName: e,
          itemTwoName: t
        } = (0, U.Ws)(n);
  ...
  eo = e => {
    ...
    } = e, o = (0, k.hv)("CollectiblesShopGiftButton"), s = i.useCallback(e => {
  ...
  es = e => {
    let {
      ...
      t.type === c.Z.PROFILE_EFFECT && (0, v.H)({
  ...
  el = e => {
    ...
    } = (0, m.ZP)([...s, h.Z.COLLECTIBLES_COLLECTED_MODAL]), S = i.useMemo(() => (0, L.jm)(b.type, b.skuId), [b.type, b.skuId]);
    return i.useEffect(() => {
