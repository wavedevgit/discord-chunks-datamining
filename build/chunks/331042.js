...
let X = 880,
  J = e => {
    let {
      product: t,
      pairedProduct: n
    } = e, [i] = t.items, o = null == n ? void 0 : n.items[0], a = (0, d.e7)([I.default], () => {
  ...
  et = e => {
    ...
    } = e, b = (0, C.o)("CollectiblesCollectedModal"), y = (0, V.W)(n, E), O = (0, d.e7)([I.default], () => {
      var e, t;
  ...
  en = e => {
    ...
    } = (0, L.R)(n), T = (0, A.x6)(n) ? null != I && null != S : null != I || null != S, N = i.useMemo(() => null != l ? l : g ? W.NW.format(new Date < Z.a$ ? W.t.BhGU09 : W.t.Jfv5Qk, {
      purchased_item: h,
      suggested_item: m
