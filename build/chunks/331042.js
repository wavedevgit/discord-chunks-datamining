...
let ea = 880,
  ...
  eu = e => {
    let {
      ...
      confettiColors: R
    } = (0, j.Z)(I.styles), P = (0, f.e7)([h.Z], () => h.Z.useReducedMotion), w = i.useRef(null), {
      analyticsLocations: L
  ...
  ed = e => {
    ...
    } = (0, k.R)(n), N = (0, w.x6)(n) ? null != I && null != S : null != I || null != S || n.type === u.Z.NAMEPLATE, C = i.useMemo(() => null != l ? l : Q.Vt.ORB_PROFILE_BADGE === n.skuId ? ee.NW.string($.Z.nvaTQk) : g ? ee.NW.format(new Date < Q.a$ ? ee.t.BhGU09 : ee.t.Jfv5Qk, {
      purchased_item: h,
      suggested_item: m
    }) : p && !f ? ee.NW.string(ee.t["1xr2SU"]) : ee.NW.format(ee.t.YNaxMj, {
      itemName: h
    }), [l, n.skuId, g, p, f, h, m]), R = i.useMemo(() => null != d ? d : Q.Vt.ORB_PROFILE_BADGE === n.skuId ? ee.NW.string($.Z.UnPGio) : g ? ee.NW.format(new Date < Q.a$ ? ee.t["1jBC0t"] : ee.t.qSrp39, {
      purchased_item: h,
      suggested_item: m
    }) : (0, c.EQ)(null == n ? void 0 : n.type).with(u.Z.BUNDLE, () => ee.NW.string(ee.t.zJPoLy)).with(u.Z.PROFILE_EFFECT, () => ee.NW.string(ee.t.f9M1YG)).with(u.Z.NAMEPLATE, () => ee.NW.string(ee.t.lvwvIi)).otherwise(() => f && null != b ? b : ee.NW.string(ee.t["44b50t"])), [d, n.skuId, null == n ? void 0 : n.type, g, h, m, f, b]), P = i.useMemo(() => Q.Vt.ORB_PROFILE_BADGE === n.skuId ? (0, r.jsxs)("div", {
      className: et.buttonRows,
      children: [(0, r.jsx)(_.zxk, {
        color: _.Ttl.BRAND,
        onClick: () => {
          a(), A.S.dispatch(X.CkL.SHOW_ACCOUNT_PROFILE_POPOUT, {
  ...
  ef = e => {
    ...
    } = e, a = (0, L.hv)("CollectiblesShopGiftButton"), s = i.useCallback(e => {
