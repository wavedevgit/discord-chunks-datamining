...
let ec = 880,
  eu = e => {
    let {
      product: t,
      pairedProduct: n
    } = e, [i] = t.items, a = null == n ? void 0 : n.items[0], o = (0, f.e7)([C.default], () => {
  ...
  ef = e => {
    ...
    return null != t ? (0, r.jsx)(ed, el(eo({}, e), {
      displayOptions: t
    })) : (0, r.jsx)(eu, eo({}, e))
  },
  e_ = e => {
    let {
      ...
      itemConsumed: y = !0,
      purchaseType: O = $.o8.FIAT
    } = e, v = (0, M.o)("CollectiblesCollectedModal"), I = (0, Q.W)(t, E), T = (0, f.e7)([C.default], () => {
      var e, t;
  ...
  eh = e => {
    ...
    } = e, p = (0, k.ed)("CollectiblesCollectedModal"), h = (0, U.k)(n), m = (0, U.k)(a), g = null != a, E = (0, y.Z)(), b = null == E || null == (t = E.giftPurchaseConfirmation) ? void 0 : t.rewardCollectedText(), {
      handleUseNow: O,
      isApplying: v
    } = (0, j.W)({
      product: n,
  ...
  eE = e => {
    let {
      ...
      itemConsumed: d,
      purchaseType: p = $.o8.FIAT
    } = e, h = (0, f.e7)([D.Z], () => D.Z.purchases), E = (0, L.o)(n, h), b = (0, Q.W)(n, E), y = i.useRef(new a.qA), [O, v] = i.useState(null), I = (0, J.UY)({
      purchaseType: p,
      skuId: b.skuId
    }), {
      analyticsLocations: S
