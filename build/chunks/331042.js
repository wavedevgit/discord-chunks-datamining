...
let el = 880,
  ...
  ed = e => {
    ...
    return null != t ? (0, r.jsx)(eu, es(eo({}, e), {
      displayOptions: t
    })) : (0, r.jsx)(ec, eo({}, e))
  },
  ef = e => {
    let {
      ...
      itemConsumed: y = !0,
      purchaseType: v = J.o8.FIAT
    } = e, O = (0, x.o)("CollectiblesCollectedModal"), I = (0, q.W)(t, E), T = (0, f.e7)([A.default], () => {
      var e, t;
    ...
    function M() {
      if (I.skuId === d.a.PREMIUM_TIER_2_3_DAY) {
        let e = en.NW.formatToPlainString(en.t.fYmir6, {
          days: 3
        });
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsxs)("div", {
          ...
          children: [b ? (0, r.jsx)("div", {
            className: er.promotionalBanner
          }) : (0, r.jsx)(V.Z, {
            asset: L,
            size: (0, F.ML)(el),
  ...
  ep = e => {
    ...
    } = e, p = (0, M.ed)("CollectiblesCollectedModal"), h = (0, j.k)(n), m = (0, j.k)(o), g = null != o, E = (0, y.Z)(), b = null == E || null == (t = E.giftPurchaseConfirmation) ? void 0 : t.rewardCollectedText(), {
      handleUseNow: v,
      isApplying: O
    } = (0, k.W)({
      product: n,
    ...
    } = (0, U.R)(n), A = (0, L.x6)(n) ? null != I && null != S : null != I || null != S || n.type === u.Z.NAMEPLATE;
    i.useEffect(() => {
      J.Vt.ORB_PROFILE_BADGE === n.skuId && (0, N.Ls)([(0, W.X2)()], e_)
    }, [n.skuId]);
    let C = i.useMemo(() => null != l ? l : J.Vt.ORB_PROFILE_BADGE === n.skuId ? en.NW.string(et.Z.nvaTQk) : g ? en.NW.format(new Date < J.a$ ? en.t.BhGU09 : en.t.Jfv5Qk, {
        purchased_item: h,
        suggested_item: m
      ...
      w = i.useMemo(() => J.Vt.ORB_PROFILE_BADGE === n.skuId ? (0, r.jsxs)("div", {
  ...
  eh = e => {
    ...
    } = e, a = (0, M.hv)("CollectiblesShopGiftButton"), s = i.useCallback(e => {
  ...
  eg = e => {
    let {
      ...
      itemConsumed: d,
      purchaseType: p = J.o8.FIAT
    } = e, h = (0, f.e7)([w.Z], () => w.Z.purchases), E = (0, D.o)(n, h), b = (0, q.W)(n, E), y = i.useRef(new o.qA), [v, O] = i.useState(null), I = (0, X.UY)({
      purchaseType: p,
      skuId: b.skuId
    }), {
      analyticsLocations: S
    } = (0, g.ZP)([...s, m.Z.COLLECTIBLES_COLLECTED_MODAL]), T = i.useMemo(() => (0, L.jm)(b.type, b.skuId), [b.type, b.skuId]);
    return i.useEffect(() => {
