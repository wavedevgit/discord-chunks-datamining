...
let ec = 880,
  eu = e => {
    let {
      product: t,
      pairedProduct: n
    } = e, [i] = t.items, o = null == n ? void 0 : n.items[0], a = (0, f.e7)([C.default], () => {
  ...
  e_ = e => {
    ...
    function x() {
      if (I.skuId === d.a.PREMIUM_TIER_2_3_DAY) {
        let e = er.NW.formatToPlainString(er.t.fYmir6, {
          days: 3
        });
  ...
  eh = e => {
    ...
    } = e, p = (0, k.ed)("CollectiblesCollectedModal"), h = (0, U.k)(n), m = (0, U.k)(o), g = null != o, E = (0, y.Z)(), b = null == E || null == (t = E.giftPurchaseConfirmation) ? void 0 : t.rewardCollectedText(), {
      handleUseNow: v,
      isApplying: O
    } = (0, j.W)({
      product: n,
    ...
    let P = i.useMemo(() => null != l ? l : $.Vt.ORB_PROFILE_BADGE === n.skuId ? er.NW.string(en.Z.nvaTQk) : g ? er.NW.format(new Date < $.a$ ? er.t.BhGU09 : er.t.Jfv5Qk, {
        purchased_item: h,
        suggested_item: m
  ...
  em = e => {
    ...
    } = e, a = (0, k.hv)("CollectiblesShopGiftButton"), s = i.useCallback(e => {
  ...
  eE = e => {
    ...
    } = e, h = (0, f.e7)([D.Z], () => D.Z.purchases), E = (0, L.o)(n, h), b = (0, Q.W)(n, E), y = i.useRef(new o.qA), [v, O] = i.useState(null), I = (0, J.UY)({
      purchaseType: p,
      skuId: b.skuId
    }), {
      analyticsLocations: S
