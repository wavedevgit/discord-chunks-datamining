...
let es = 880,
  ...
  eu = e => {
    ...
    return null != t ? (0, r.jsx)(ec, ea(ei({}, e), {
      displayOptions: t
    })) : (0, r.jsx)(el, ei({}, e))
  },
  ed = e => {
    let {
      ...
      confettiColors: C
    } = (0, U.Z)(I.styles), P = (0, f.e7)([h.Z], () => h.Z.useReducedMotion), w = i.useRef(null), {
      analyticsLocations: D
    } = (0, g.ZP)([...l, m.Z.COLLECTIBLES_COLLECTED_MODAL]), {
      collectedModalBackground: x
    } = (0, q.Ac)(I);

    function M() {
      if (I.skuId === d.a.PREMIUM_TIER_2_3_DAY) {
        let e = et.NW.formatToPlainString(et.t.fYmir6, {
          days: 3
        });
      ...
      return (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsxs)("div", {
          ...
          children: [b ? (0, r.jsx)("div", {
            className: en.promotionalBanner
          }) : (0, r.jsx)(B.Z, {
            asset: x,
            size: (0, V.ML)(es),
  ...
  e_ = e => {
    ...
    } = e, p = (0, x.ed)("CollectiblesCollectedModal"), h = (0, k.k)(n), m = (0, k.k)(o), g = null != o, E = (0, y.Z)(), b = null == E || null == (t = E.giftPurchaseConfirmation) ? void 0 : t.rewardCollectedText(), {
      handleUseNow: v,
      isApplying: O
    } = (0, M.W)({
      product: n,
    ...
    } = (0, j.R)(n), A = (0, D.x6)(n) ? null != I && null != S : null != I || null != S || n.type === u.Z.NAMEPLATE;
    i.useEffect(() => {
      X.Vt.ORB_PROFILE_BADGE === n.skuId && (0, N.Ls)([(0, H.X2)()], ef)
    }, [n.skuId]);
    let R = i.useMemo(() => null != l ? l : X.Vt.ORB_PROFILE_BADGE === n.skuId ? et.NW.string(ee.Z.nvaTQk) : g ? et.NW.format(new Date < X.a$ ? et.t.BhGU09 : et.t.Jfv5Qk, {
        purchased_item: h,
        suggested_item: m
      }) : p && !f ? et.NW.string(et.t["1xr2SU"]) : et.NW.format(et.t.YNaxMj, {
        itemName: h
      }), [l, n.skuId, g, p, f, h, m]),
      P = i.useMemo(() => null != d ? d : X.Vt.ORB_PROFILE_BADGE === n.skuId ? et.NW.string(ee.Z.UnPGio) : g ? et.NW.format(new Date < X.a$ ? et.t["1jBC0t"] : et.t.qSrp39, {
        purchased_item: h,
        suggested_item: m
      }) : (0, c.EQ)(null == n ? void 0 : n.type).with(u.Z.BUNDLE, () => et.NW.string(et.t.zJPoLy)).with(u.Z.PROFILE_EFFECT, () => et.NW.string(et.t.f9M1YG)).with(u.Z.NAMEPLATE, () => et.NW.string(et.t.lvwvIi)).otherwise(() => f && null != b ? b : et.NW.string(et.t["44b50t"])), [d, n.skuId, null == n ? void 0 : n.type, g, h, m, f, b]),
      w = i.useMemo(() => X.Vt.ORB_PROFILE_BADGE === n.skuId ? (0, r.jsxs)("div", {
  ...
  ep = e => {
    ...
    } = e, a = (0, x.hv)("CollectiblesShopGiftButton"), s = i.useCallback(e => {
  ...
  em = e => {
    let {
      ...
      itemConsumed: d,
      purchaseType: p = X.o8.FIAT
    } = e, h = (0, f.e7)([P.Z], () => P.Z.purchases), m = (0, w.o)(n, h), g = (0, z.W)(n, m), E = i.useRef(new o.qA), [b, y] = i.useState(null), v = (0, Q.UY)({
      purchaseType: p,
      skuId: g.skuId
    });
    return (0, r.jsxs)(r.Fragment, {
