...
function x(e) {
  let {
    ...
    transitionState: x,
    onClose: C
  } = e, I = (0, i.e7)([c.Z], () => c.Z.isBlocked(t)), b = (0, i.e7)([a.Z], () => a.Z.getChannel(n));
  ...
  return (0, s.jsx)(l.Z, {
    ...
    infoRows: E,
    onDismissAndStay: () => {
      C(), (0, g.g6)(n), u.default.track(m.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
    ...
    onDismissAndLeave: () => {
      C(), r.default.disconnect(), u.default.track(m.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
