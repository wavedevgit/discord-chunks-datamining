...
function m(e) {
  let {
    ...
    transitionState: m,
    onClose: S
  } = e, h = (0, i.e7)([c.Z], () => c.Z.isBlocked(r)), x = (0, i.e7)([l.Z], () => l.Z.getChannel(t));
  ...
  return (0, n.jsx)(A.Z, {
    ...
    onDismissAndLeave: () => {
      S(), o.default.disconnect(), _.default.track(I.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
