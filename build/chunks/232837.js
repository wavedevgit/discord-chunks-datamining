...
function I(e) {
  let {
    ...
    transitionState: I,
    onClose: x
  } = e, C = (0, o.e7)([c.Z], () => c.Z.isBlocked(t)), b = (0, o.e7)([a.Z], () => a.Z.getChannel(n));
  ...
  return (0, s.jsx)(l.Z, {
    ...
    infoRows: E,
    onDismissAndStay: () => {
      x(), (0, g.g6)(n), u.default.track(m.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
    ...
    onDismissAndLeave: () => {
      x(), r.default.disconnect(), u.default.track(m.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
