...
function E(e) {
  let {
    ...
    transitionState: E,
    onClose: C
  } = e, k = s.useRef(!1), v = (0, a.e7)([u.Z], () => u.Z.isBlocked(t)), O = (0, a.e7)([d.Z], () => d.Z.getChannel(n));
  if ((0, c.zq)(() => {
      k.current || (0, x.nC)(t)
  ...
  return (0, r.jsx)(f.Z, {
    ...
    infoRows: I,
    onDismissAndStay: () => {
      k.current = !0, C(), (0, x.nC)(t), m.default.track(N.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
    ...
    onDismissAndLeave: () => {
      k.current = !0, C(), l.default.disconnect(), m.default.track(N.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
