...
function m(e) {
  let {
    ...
    transitionState: m,
    onClose: S
  } = e, h = (0, i.e7)([c.Z], () => c.Z.isBlocked(n)), x = (0, i.e7)([o.Z], () => o.Z.getChannel(t));
  ...
  return (0, r.jsx)(A.Z, {
    ...
    infoRows: p,
    onDismissAndStay: () => {
      S(), (0, d.g6)(t), _.default.track(I.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
    ...
    onDismissAndLeave: () => {
      S(), l.default.disconnect(), _.default.track(I.rMx.VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT, {
