...
function b(e, t) {
  let n = (0, f.p$)(),
    ...
    x = (0, i.e7)([a.Z], () => null != b && (null == b ? void 0 : b.channelId) != null && a.Z.isChannelGated(b.guildId, b.channelId), [b]),
  ...
  return r.useEffect(() => {
    if ((null == b ? void 0 : b.threadId) != null) {
      ...
      !0 !== n || e !== h.M.NOT_FETCHED || v && !1 === x || !v && y || (0, m.xP)(null == b ? void 0 : b.threadId)
    }
  }, [b, n, v, x, y]), S
}