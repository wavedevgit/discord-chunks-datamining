...
function O(e) {
  let {
    guildId: t,
    prompts: n
  } = e, a = (0, l.e7)([m.Z], () => m.Z.editedDefaultChannelIds), [c, d] = (0, u.dF)(t, n, [...a]), g = c.length, p = c.length + d.length, h = g / p * 100, f = Math.max(Math.ceil(85 * p / 100) - g, 0), [x, b] = i.useState(!1), j = x ? s.CJ0 : s.u04;
  return (0, r.jsxs)("div", {
...
function y(e) {
  let {
    guild: t,
    saveOnClose: n
  } = e, a = (0, l.e7)([c.Z], () => c.Z.isLoading()), o = (0, l.e7)([h.Z], () => h.Z.editedOnboardingPrompts), u = (0, l.e7)([h.Z], () => h.Z.advancedMode), d = i.useRef(!1);
  i.useEffect(() => {
