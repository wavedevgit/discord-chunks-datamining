...
function x(e) {
  let {
    ...
    ready: x,
    token: E
  } = e, [b, v] = i.useState(!1), [O, I] = i.useState(null), [j, S] = i.useState(null), [N, y] = i.useState(""), C = i.useRef(null);
  return i.useEffect(() => {
    if (x) {
      var e;
      ...
      children: [(0, r.jsx)(u.II, {
        ...
        onClick: () => {
          if (!b) {
            ...
            return null != j && S(null), null != O && I(null), t(""), v(!0), h.Z.post({
