...
function O(e) {
  ...
  } = (0, c.Ay)(), E = n === y.BRT.POPOUT, _ = l.useRef(null), {
    currentLayout: C,
    mode: S
  } = (0, i.cf)([u.A], () => {
  ...
  }, [t, n]), I = (0, i.bG)([h.A], () => h.A.getVoiceChannelId() === t.id, [t.id]);
  l.useEffect(() => {
    _.current = S
  });
  let N = l.useRef(C),
    ...
    R = S === y._Of.VIDEO && I && !w,
    D = l.useCallback((e, r) => {
      r !== e && (s.A.updateLayout(t.id, r, n), r === y.DUB.FULL_SCREEN && t.isPrivate() && g._.dispatch(y.jej.TEXTAREA_BLUR))
    }, [n, t]),
    M = l.useCallback(e => {
    ...
    L = l.useCallback(e => () => {
      null != P && ((0, d.X)(x, d.O.FULL_SCREEN, e !== y.DUB.FULL_SCREEN), e !== y.DUB.FULL_SCREEN ? (N.current = e, D(e, y.DUB.FULL_SCREEN), (0, A.tl)(P)) : M(e))
    }, [D, M, P, x]);
  l.useEffect(() => {
    let e = () => {
  ...
  return (l.useEffect(() => {
    ...
    return b.default.track(y.HAw.VIDEO_LAYOUT_TOGGLED, function(e) {
