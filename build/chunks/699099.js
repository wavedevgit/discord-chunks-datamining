...
let R = e => {
  ...
  A = e => {
    ...
    }), a = null == r ? void 0 : r.guild_id, n = null == r ? void 0 : r.id, c = S.ZP.useName(a, n, s), o = E.ZP.useName(s);
    return (0, l.jsxs)("div", {
      className: k.result,
      children: [(0, l.jsx)(i.qEK, {
...
class I extends r.Component {
  render() {
    ...
    return s = t.sent ? (0, l.jsx)(c.zx, {
      ...
      className: n()(k.resultWrapper, {
        [k.resultWrapperSelected]: r
      }),
...
function P(e) {
  ...
  }), []), [h, _] = r.useState(n), [x, p] = r.useState(0), [g, C] = r.useState([]), [S, E] = r.useState(!1), f = r.useRef(null), R = r.useCallback(() => {
    var e;
