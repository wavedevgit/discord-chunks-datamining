...
function Q(e) {
  let t = C({}, x);
  x = o().defaults(o().pick(e, ["guildFilter", "roleFilter", "everyoneFilter"]), x), s.K.set(A, x);
...
function et(e) {
  ...
  N = o().filter(N, e => e.channel_id !== t.id || (delete R[e.id], n.push(e), false)), U({
    deletedMessages: n
  })
}
...
T(eo, "displayName", "RecentMentionsStore");
