...
function B(e) {
  let {
    ...
    var e;
    return null == (e = R.Z.getGuild(o)) ? true : e.ownerId
  }, [o]), _ = (0, l.e7)([P.default], () => P.default.getUser(t.userId), [t.userId]), p = (0, l.e7)([A.Z], () => A.Z.getChannel(a), [a]);
  return null == _ || null == p ? null : <T.Z targetElementRef={c} userId={t.userId} guildId={o} channelId={a} roleId={s.id} spacing={14} clickTrap={true}>{(e, i) => {
      let {
        isShown: a
      } = i;
...
function Z(e) {
  ...
  let f = (0, b.Z)(o),
    ...
    h = (0, l.Wu)([N.ZP, P.default], () => {
      ...
      return a()(t).filter(e => null != P.default.getUser(e.userId)).sortBy(e => {
        var t;
    ...
    y = i.useMemo(() => null != m ? h.map(e => <B member={e} guildId={o} channelId={s} role={m} />) : [], [s, o, m, h]);
  if (null == m) return null;
  let O = null == E ? m.name : D.intl.formatToPlainString(D.t.CuAQkJ, {
    title: m.name,
    count: E
  });
  return <c.d.Provider value={true}><div{...U(k({
...
function F(e) {
  ...
  } = (0, m.ZP)(h.Z.ROLE_MENTION), _ = (0, l.e7)([p.Z], () => p.Z.roleStyle), g = (0, l.e7)([C.Z], () => null == a || null == t ? null : C.Z.getRole(a, t)), E = (0, I.yH)(a, g), b = !d && null != g && !(0, v.Gr)(g), T = b && "dot" === _, S = b && "username" === _, A = E && null != g ? g.colorStrings : null, N = i.useRef(null), R = e => <O.Z{...U(k({
    ref: N,
  ...
  return !P || d || null == n || null == a || null == t && "@everyone" !== o ? <m.Gt value={f}>{R()}</m.Gt> : <m.Gt value={f}><u.yRy targetElementRef={N} preload={async () => {
