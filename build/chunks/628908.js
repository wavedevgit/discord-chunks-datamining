...
class A extends o.PureComponent {
  renderSMSSection() {
    let {
      currentUser: e
    } = this.props, t = null != this.props.currentUser.phone, n = e.hasFlag(b.xW$.MFA_SMS), o = e.hasFlag(b.xW$.PARTNER) || e.hasFlag(b.xW$.STAFF);
    return t ? (0, r.jsxs)(C, {
      ...
      children: [(0, r.jsxs)(c.Text, {
        ...
        children: [(0, r.jsx)("strong", {
          ...
          children: O.intl.format(O.t.PXVoEB, {
            phoneNumber: e.phone
          })
        }), (0, r.jsx)(l.zx, {
  ...
  renderTotp() {
    ...
    return (0, r.jsxs)(c.Y0X, {
      ...
      children: [this.renderHeader(O.intl.string(O.t["681MPT"]), O.intl.format(O.t.pQioMz, {})), (0, r.jsxs)(c.hzk, {
        className: g.modalInner,
        children: [this.renderSMSSection(), (0, r.jsx)(c.$i$, {
          className: g.divider
  ...
  renderWebAuthn() {
    ...
    return (0, r.jsxs)(c.Y0X, {
      ...
      className: g.modal,
      parentComponent: "MFAEnableSuccess",
      children: [this.renderHeader(O.intl.string(O.t.x6ielJ), O.intl.format(O.t.Xb5JGh, {})), (0, r.jsx)(c.hzk, {
        className: g.modalInner,
