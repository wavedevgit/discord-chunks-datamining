...
var v = ((o = {})[o.DIDNT_VIOLATE_POLICY = 0] = "DIDNT_VIOLATE_POLICY", o[o.TOO_STRICT_UNFAIR = 1] = "TOO_STRICT_UNFAIR", o[o.DONT_AGREE_PENALTY = 2] = "DONT_AGREE_PENALTY", o[o.SOMETHING_ELSE = 3] = "SOMETHING_ELSE", o);
let x = [0, 1, 2, 3],
  y = 372,
  E = 279,
  O = {
...
var N = ((l = {}).SPEED_BUMP = "speed-bump", l.COLLECT_SIGNAL = "collect-signal", l.CONFIRM_SUBMISSION = "confirm-submission", l.REQUEST_SENT = "request-sent", l.THANKS = "thanks", l);
let j = {
  "speed-bump": {
    next: "collect-signal",
    prev: null
